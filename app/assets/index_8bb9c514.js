(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const lo="modulepreload",co=function(e){return"/"+e},sa={},J=function(t,a,n){let o=Promise.resolve();if(a&&a.length>0){let l=function(c){return Promise.all(c.map(v=>Promise.resolve(v).then(y=>({status:"fulfilled",value:y}),y=>({status:"rejected",reason:y}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),i=r?.nonce||r?.getAttribute("nonce");o=l(a.map(c=>{if(c=co(c),c in sa)return;sa[c]=!0;const v=c.endsWith(".css"),y=v?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${y}`))return;const m=document.createElement("link");if(m.rel=v?"stylesheet":lo,v||(m.as="script"),m.crossOrigin="",m.href=c,i&&m.setAttribute("nonce",i),document.head.appendChild(m),v)return new Promise((w,C)=>{m.addEventListener("load",w),m.addEventListener("error",()=>C(new Error(`Unable to preload CSS for ${c}`)))})}))}function s(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return o.then(r=>{for(const i of r||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})};var po=/([:*])(\w+)/g,uo="([^/]+)",mo=/\*/g,go="?(?:.*)",ho=/\/\?/g,fo="/?([^/]+|)",vo="(?:/^|^)",_o="";function en(e){return e===void 0&&(e="/"),Jt()?location.pathname+location.search+location.hash:e}function H(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function rt(e){return typeof e=="string"}function bo(e){return typeof e=="function"}function it(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function yo(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(a,n,o){return a===null&&(a={}),a[t[o]]=decodeURIComponent(n),a},null)}function lt(e){var t=H(e).split(/\?(.*)?$/);return[H(t[0]),t.slice(1).join("")]}function Kt(e){for(var t={},a=e.split("&"),n=0;n<a.length;n++){var o=a[n].split("=");if(o[0]!==""){var s=decodeURIComponent(o[0]);t[s]?(Array.isArray(t[s])||(t[s]=[t[s]]),t[s].push(decodeURIComponent(o[1]||""))):t[s]=decodeURIComponent(o[1]||"")}}return t}function tn(e,t){var a=lt(H(e.currentLocationPath)),n=a[0],o=a[1],s=o===""?null:Kt(o),r=[],i;if(rt(t.path)){if(i=vo+H(t.path).replace(po,function(y,m,w){return r.push(w),uo}).replace(mo,go).replace(ho,fo)+"$",H(t.path)===""&&H(n)==="")return{url:n,queryString:o,hashString:it(e.to),route:t,data:null,params:s}}else i=t.path;var l=new RegExp(i,_o),c=n.match(l);if(c){var v=rt(t.path)?yo(c,r):c.groups?c.groups:c.slice(1);return{url:H(n.replace(new RegExp("^"+e.instance.root),"")),queryString:o,hashString:it(e.to),route:t,data:v,params:s}}return!1}function an(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function Ne(e,t){return typeof e[t]>"u"||e[t]===!0}function wo(e){if(!e)return{};var t=e.split(","),a={},n;return t.forEach(function(o){var s=o.split(":").map(function(r){return r.replace(/(^ +| +$)/g,"")});switch(s[0]){case"historyAPIMethod":a.historyAPIMethod=s[1];break;case"resolveOptionsStrategy":n||(n={}),n.strategy=s[1];break;case"resolveOptionsHash":n||(n={}),n.hash=s[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":a[s[0]]=s[1]==="true";break}}),n&&(a.resolveOptions=n),a}function Jt(){return typeof window<"u"}function xo(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(a){return a}).forEach(function(a){["before","after","already","leave"].forEach(function(n){a[n]&&(t[n]||(t[n]=[]),t[n].push(a[n]))})}),t}function me(e,t,a){var n=t||{},o=0;(function s(){if(!e[o]){a&&a(n);return}Array.isArray(e[o])?(e.splice.apply(e,[o,1].concat(e[o][0](n)?e[o][1]:e[o][2])),s()):e[o](n,function(r){typeof r>"u"||r===!0?(o+=1,s()):a&&a(n)})})()}me.if=function(e,t,a){return Array.isArray(t)||(t=[t]),Array.isArray(a)||(a=[a]),[e,t,a]};function ra(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=en(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function At(e,t){for(var a=0;a<e.instance.routes.length;a++){var n=e.instance.routes[a],o=tn(e,n);if(o&&(e.matches||(e.matches=[]),e.matches.push(o),e.resolveOptions.strategy==="ONE")){t();return}}t()}function Eo(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function So(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var ia=Jt(),Ao=an();function ko(e,t){if(Ne(e.navigateOptions,"updateBrowserURL")){var a=("/"+e.to).replace(/\/\//g,"/"),n=ia&&e.resolveOptions&&e.resolveOptions.hash===!0;Ao?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",n?"#"+a:a),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!n){var o=location.hash;location.hash="",location.hash=o}e.instance.__freezeListening=!1},1))):ia&&(window.location.href=e.to)}t()}function nn(e,t){var a=e.instance;if(!a.lastResolved()){t();return}me(a.lastResolved().map(function(n){return function(o,s){if(!n.route.hooks||!n.route.hooks.leave){s();return}var r=!1,i=e.instance.matchLocation(n.route.path,e.currentLocationPath,!1);if(n.route.path!=="*")r=!i;else{var l=e.matches?e.matches.find(function(c){return n.route.path===c.route.path}):!1;r=!l}if(Ne(e.navigateOptions,"callHooks")&&r){me(n.route.hooks.leave.map(function(c){return function(v,y){return c(function(m){m===!1?e.instance.__markAsClean(e):y()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return s()}]));return}else s()}}),{},function(){return t()})}function To(e,t){e.match.route.hooks&&e.match.route.hooks.before&&Ne(e.navigateOptions,"callHooks")?me(e.match.route.hooks.before.map(function(a){return function(o,s){return a(function(r){r===!1?e.instance.__markAsClean(e):s()},e.match)}}).concat([function(){return t()}])):t()}function Co(e,t){Ne(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function Io(e,t){e.match.route.hooks&&e.match.route.hooks.after&&Ne(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(a){return a(e.match)}),t()}function Lo(e,t){var a=e.instance.lastResolved();if(a&&a[0]&&a[0].route===e.match.route&&a[0].url===e.match.url&&a[0].queryString===e.match.queryString){a.forEach(function(n){n.route.hooks&&n.route.hooks.already&&Ne(e.navigateOptions,"callHooks")&&n.route.hooks.already.forEach(function(o){return o(e.match)})}),t(!1);return}t()}function No(e,t){var a=e.instance._notFoundRoute;if(a){e.notFoundHandled=!0;var n=lt(e.currentLocationPath),o=n[0],s=n[1],r=it(e.to);a.path=H(o);var i={url:a.path,queryString:s,hashString:r,data:null,route:a,params:s!==""?Kt(s):null};e.matches=[i],e.match=i}t()}function $o(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function Oo(e,t){e.instance._setCurrent(null),t()}function on(e,t){Ne(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var sn=[Lo,To,Co,Io],la=[nn,No,me.if(function(e){var t=e.notFoundHandled;return t},sn.concat([on]),[$o,Oo])];function Ot(){return Ot=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},Ot.apply(this,arguments)}function ca(e,t){var a=0;function n(){if(a===e.matches.length){on(e,t);return}me(sn,Ot({},e,{match:e.matches[a]}),function(){a+=1,n()})}nn(e,n)}function kt(e){e.instance.__markAsClean(e)}function Rt(){return Rt=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},Rt.apply(this,arguments)}var da="[data-navigo]";function Ro(e,t){var a=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:da},n=this,o="/",s=null,r=[],i=!1,l,c=an(),v=Jt();e?o=H(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function y(u){return u.indexOf("#")>=0&&(a.hash===!0?u=u.split("#")[1]||"/":u=u.split("#")[0]),u}function m(u){return H(o+"/"+H(u))}function w(u,_,N,P){return u=rt(u)?m(u):u,{name:P||H(String(u)),path:u,handler:_,hooks:xo(N)}}function C(u,_,N){var P=this;return typeof u=="object"&&!(u instanceof RegExp)?(Object.keys(u).forEach(function(R){if(typeof u[R]=="function")P.on(R,u[R]);else{var ae=u[R],G=ae.uses,Xe=ae.as,Re=ae.hooks;r.push(w(R,G,[l,Re],Xe))}}),this):(typeof u=="function"&&(N=_,_=u,u=o),r.push(w(u,_,[l,N])),this)}function g(u,_){if(n.__dirty){n.__waiting.push(function(){return n.resolve(u,_)});return}else n.__dirty=!0;u=u?H(o)+"/"+H(u):void 0;var N={instance:n,to:u,currentLocationPath:u,navigateOptions:{},resolveOptions:Rt({},a,_)};return me([ra,At,me.if(function(P){var R=P.matches;return R&&R.length>0},ca,la)],N,kt),N.matches?N.matches:!1}function h(u,_){if(n.__dirty){n.__waiting.push(function(){return n.navigate(u,_)});return}else n.__dirty=!0;u=H(o)+"/"+H(u);var N={instance:n,to:u,navigateOptions:_||{},resolveOptions:_&&_.resolveOptions?_.resolveOptions:a,currentLocationPath:y(u)};me([Eo,So,At,me.if(function(P){var R=P.matches;return R&&R.length>0},ca,la),ko,kt],N,kt)}function f(u,_,N){var P=he(u,_);return P!==null?(h(P.replace(new RegExp("^/?"+o),""),N),!0):!1}function E(u){return this.routes=r=r.filter(function(_){return rt(u)?H(_.path)!==H(u):bo(u)?u!==_.handler:String(_.path)!==String(u)}),this}function L(){c&&(this.__popstateListener=function(){n.__freezeListening||g()},window.addEventListener("popstate",this.__popstateListener))}function F(){this.routes=r=[],c&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=i=!0}function W(u,_){return n._notFoundRoute=w("*",u,[l,_],"__NOT_FOUND__"),this}function j(){if(v)return te().forEach(function(u){if(u.getAttribute("data-navigo")==="false"||u.getAttribute("target")==="_blank"){u.hasListenerAttached&&u.removeEventListener("click",u.navigoHandler);return}u.hasListenerAttached||(u.hasListenerAttached=!0,u.navigoHandler=function(_){if((_.ctrlKey||_.metaKey)&&_.target.tagName.toLowerCase()==="a")return!1;var N=u.getAttribute("href");if(typeof N>"u"||N===null)return!1;if(N.match(/^(http|https)/)&&typeof URL<"u")try{var P=new URL(N);N=P.pathname+P.search}catch{}var R=wo(u.getAttribute("data-navigo-options"));i||(_.preventDefault(),_.stopPropagation(),n.navigate(H(N),R))},u.addEventListener("click",u.navigoHandler))}),n}function te(){return v?[].slice.call(document.querySelectorAll(a.linksSelector||da)):[]}function ce(u){return"/"+o+"/"+H(u)}function Q(u){return l=u,this}function ve(){return s}function he(u,_,N){var P=r.find(function(G){return G.name===u}),R=null;if(P){if(R=P.path,_)for(var ae in _)R=R.replace(":"+ae,_[ae]);R=R.match(/^\//)?R:"/"+R}return R&&N&&!N.includeRoot&&(R=R.replace(new RegExp("^/"+o),"")),R}function x(u){return u.getAttribute("href")}function $(u){var _=lt(H(u)),N=_[0],P=_[1],R=P===""?null:Kt(P),ae=it(u),G=w(N,function(){},[l],N);return{url:N,queryString:P,hashString:ae,route:G,data:null,params:R}}function de(){return $(H(en(o)).replace(new RegExp("^"+o),""))}function Je(u){var _={instance:n,currentLocationPath:u,to:u,resolveOptions:a};return At(_,function(){}),_.matches?_.matches:!1}function St(u,_,N){typeof _<"u"&&(typeof N>"u"||N)&&(_=m(_));var P={instance:n,to:_,currentLocationPath:_};ra(P,function(){}),typeof u=="string"&&(u=typeof N>"u"||N?m(u):u);var R=tn(P,{name:String(u),path:u,handler:function(){},hooks:{}});return R||!1}function Oe(u,_,N){return typeof _=="string"&&(_=I(_)),_?(_.hooks[u]||(_.hooks[u]=[]),_.hooks[u].push(N),function(){_.hooks[u]=_.hooks[u].filter(function(P){return P!==N})}):(console.warn("Route doesn't exists: "+_),function(){})}function I(u){return typeof u=="string"?r.find(function(_){return _.name===m(u)}):r.find(function(_){return _.handler===u})}function Y(u){u.instance.__dirty=!1,u.instance.__waiting.length>0&&u.instance.__waiting.shift()()}this.root=o,this.routes=r,this.destroyed=i,this.current=s,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=Y,this.on=C,this.off=E,this.resolve=g,this.navigate=h,this.navigateByName=f,this.destroy=F,this.notFound=W,this.updatePageLinks=j,this.link=ce,this.hooks=Q,this.extractGETParameters=function(u){return lt(y(u))},this.lastResolved=ve,this.generate=he,this.getLinkPath=x,this.match=Je,this.matchLocation=St,this.getCurrentLocation=de,this.addBeforeHook=Oe.bind(this,"before"),this.addAfterHook=Oe.bind(this,"after"),this.addAlreadyHook=Oe.bind(this,"already"),this.addLeaveHook=Oe.bind(this,"leave"),this.getRoute=I,this._pathToMatchObject=$,this._clean=H,this._checkForAHash=y,this._setCurrent=function(u){return s=n.current=u},L.call(this),j.call(this)}var Mo=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Fo(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Ve={exports:{}},Po=Ve.exports,pa;function Do(){return pa||(pa=1,(function(e,t){(function(a,n){var o={};a.PubSub?(o=a.PubSub,console.warn("PubSub already loaded, using existing version")):(a.PubSub=o,n(o)),e!==void 0&&e.exports&&(t=e.exports=o),t.PubSub=o,e.exports=t=o})(typeof window=="object"&&window||Po||Mo,function(a){var n={},o=-1,s="*";function r(g){var h;for(h in g)if(Object.prototype.hasOwnProperty.call(g,h))return!0;return!1}function i(g){return function(){throw g}}function l(g,h,f){try{g(h,f)}catch(E){setTimeout(i(E),0)}}function c(g,h,f){g(h,f)}function v(g,h,f,E){var L=n[h],F=E?c:l,W;if(Object.prototype.hasOwnProperty.call(n,h))for(W in L)Object.prototype.hasOwnProperty.call(L,W)&&F(L[W],g,f)}function y(g,h,f){return function(){var L=String(g),F=L.lastIndexOf(".");for(v(g,g,h,f);F!==-1;)L=L.substr(0,F),F=L.lastIndexOf("."),v(g,L,h,f);v(g,s,h,f)}}function m(g){var h=String(g),f=!!(Object.prototype.hasOwnProperty.call(n,h)&&r(n[h]));return f}function w(g){for(var h=String(g),f=m(h)||m(s),E=h.lastIndexOf(".");!f&&E!==-1;)h=h.substr(0,E),E=h.lastIndexOf("."),f=m(h);return f}function C(g,h,f,E){g=typeof g=="symbol"?g.toString():g;var L=y(g,h,E),F=w(g);return F?(f===!0?L():setTimeout(L,0),!0):!1}a.publish=function(g,h){return C(g,h,!1,a.immediateExceptions)},a.publishSync=function(g,h){return C(g,h,!0,a.immediateExceptions)},a.subscribe=function(g,h){if(typeof h!="function")return!1;g=typeof g=="symbol"?g.toString():g,Object.prototype.hasOwnProperty.call(n,g)||(n[g]={});var f="uid_"+String(++o);return n[g][f]=h,f},a.subscribeAll=function(g){return a.subscribe(s,g)},a.subscribeOnce=function(g,h){var f=a.subscribe(g,function(){a.unsubscribe(f),h.apply(this,arguments)});return a},a.clearAllSubscriptions=function(){n={}},a.clearSubscriptions=function(h){var f;for(f in n)Object.prototype.hasOwnProperty.call(n,f)&&f.indexOf(h)===0&&delete n[f]},a.countSubscriptions=function(h){var f,E,L=0;for(f in n)if(Object.prototype.hasOwnProperty.call(n,f)&&f.indexOf(h)===0){for(E in n[f])L++;break}return L},a.getSubscriptions=function(h){var f,E=[];for(f in n)Object.prototype.hasOwnProperty.call(n,f)&&f.indexOf(h)===0&&E.push(f);return E},a.unsubscribe=function(g){var h=function(ce){var Q;for(Q in n)if(Object.prototype.hasOwnProperty.call(n,Q)&&Q.indexOf(ce)===0)return!0;return!1},f=typeof g=="string"&&(Object.prototype.hasOwnProperty.call(n,g)||h(g)),E=!f&&typeof g=="string",L=typeof g=="function",F=!1,W,j,te;if(f){a.clearSubscriptions(g);return}for(W in n)if(Object.prototype.hasOwnProperty.call(n,W)){if(j=n[W],E&&j[g]){delete j[g],F=g;break}if(L)for(te in j)Object.prototype.hasOwnProperty.call(j,te)&&j[te]===g&&(delete j[te],F=!0)}return F}})})(Ve,Ve.exports)),Ve.exports}var Bo=Do();const d=Fo(Bo),p=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV.GO",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN.GO",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP.GO",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT.GO",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT.GO",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH.GO",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",AUTH_SCOPE_LOADED:"AUTH.SCOPE.LOADED",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",M5T_SIDE_NAV:"M5T_SIDE_NAV",M5T_SIDE_NAV_TAP:"M5T_SIDE_NAV.TAP",M5T_SIDE_NAV_COLLAPSE:"M5T_SIDE_NAV.COLLAPSE",M5T_SIDE_NAV_LOGO_TAP:"M5T_SIDE_NAV.LOGO_TAP",M5T_SIDE_NAV_ORG_SWITCH:"M5T_SIDE_NAV.ORG_SWITCH",M5T_SIDE_NAV_FOOTER_ACTION:"M5T_SIDE_NAV.FOOTER_ACTION",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL",MESSAGE:"MESSAGE",MESSAGE_CREATE:"MESSAGE.CREATE",MESSAGE_CREATED:"MESSAGE.CREATED",MESSAGE_EDIT:"MESSAGE.EDIT",MESSAGE_UPDATED:"MESSAGE.UPDATED",MESSAGE_DELETE:"MESSAGE.DELETE",MESSAGE_DELETED:"MESSAGE.DELETED",MESSAGE_REFRESH:"MESSAGE.REFRESH"}),Tt={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://machfivemagnet-saas.onrender.com"};var Ct={};const U=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_USER_PREFS:"mvv_user_prefs",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_LS_LAST_ROUTE:"mvv_last_route",FF_SSE_API_DEBUG_LOGGING:!1,FF_SSE_API_TIMEOUT:3e4,FF_SSE_API_MAX_RETRIES:3,FF_SSE_API_CACHE_ENABLED:!0,FF_SSE_AUTH_TOKEN_EXPIRY_HOURS:6,FF_SSE_AUTH_AUTO_REFRESH:!1,FF_SSE_AUTH_SESSION_WARNING_MINUTES:5,FF_SSE_AUTH_REMEMBER_ME:!0,FF_SSE_AUTH_MAX_LOGIN_ATTEMPTS:5,FF_SSE_UI_TOAST_ENABLED:!0,FF_SSE_UI_TOAST_DURATION:5e3,FF_SSE_UI_LOADING_SPINNERS:!0,FF_SSE_UI_DARK_MODE:!1,FF_SSE_UI_ANIMATIONS:!0,FF_SSE_FEATURE_SIGNUP_ENABLED:!0,FF_SSE_FEATURE_PASSWORD_RESET_ENABLED:!0,FF_SSE_FEATURE_EMAIL_VERIFICATION_ENABLED:!0,FF_SSE_FEATURE_PROFILE_EDIT_ENABLED:!0,FF_SSE_FEATURE_ANALYTICS_ENABLED:!1,FF_SSE_CACHE_TTL_MS:3e5,FF_SSE_COMPRESSION_ENABLED:!0,FF_SSE_MAX_PAYLOAD_SIZE_MB:50,FF_SSE_DEBUG_VERBOSE:!1,FF_SSE_DEBUG_REDUX_DEVTOOLS:!1,FF_SSE_DEBUG_PERFORMANCE:!1,FF_SSE_DEBUG_BYPASS_AUTH:!1,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_BUILD_MODE:"LOCAL",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel"});function rn(e,t=null){if(e in U)return U[e];if(typeof process<"u"&&Ct&&Ct[e]){const a=Ct[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}if(typeof import.meta<"u"&&Tt&&Tt[e]){const a=Tt[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}return t}function Uo(e){return rn(e,!1)===!0}function Ho(){return{...U}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:U,getFlag:rn,isEnabled:Uo,getAllFlags:Ho});function zo(){const e=t=>a=>{const n=a.detail?.pubsubTopic;n&&d.publish(n,a.detail)};document.addEventListener("nav-select",e()),document.addEventListener("logo-click",e()),document.addEventListener("nav-hover",e()),document.addEventListener("nav-double-tap",e()),document.addEventListener("nav-long-tap",e()),document.addEventListener("message-sent",e())}function Go(){console.log("[AppEvents] Initializing event listeners..."),d.subscribe(p.APP_READY,(a,n)=>{console.log("[AppEvents] APP_READY:",n)}),d.subscribe(p.APP_ERROR,(a,n)=>{console.error("[AppEvents] APP_ERROR:",n)}),d.subscribe(p.APP_SIGNOUT,(a,n)=>{console.log("[AppEvents] APP_SIGNOUT:",n)}),d.subscribe(p.ROUTE_NAV_BEFORE,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",n),d.publish(p.UI_LOADING_START)}),d.subscribe(p.ROUTE_NAV_AFTER,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",n),d.publish(p.UI_LOADING_END)}),d.subscribe(p.ROUTE_NAV_ERROR,(a,n)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",n),d.publish(p.APP_ERROR,{message:"Navigation error",details:n})}),d.subscribe(p.AUTH_SIGNIN_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",n)}),d.subscribe(p.AUTH_SIGNIN_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",n),d.publish(p.UI_TOAST,{message:n.message||"Sign in failed",type:"danger"})}),d.subscribe(p.AUTH_SIGNUP_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",n),d.publish(p.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"}),d.publish(p.AUTH_VERIFY_LINK)}),d.subscribe(p.AUTH_VERIFY_LINK,(a,n)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),d.subscribe(p.AUTH_SIGNUP_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",n),d.publish(p.UI_TOAST,{message:n.message||"Sign up failed",type:"danger"})}),d.subscribe(p.AUTH_SIGNOUT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",n),d.publish(p.UI_TOAST,{message:"Signed out successfully",type:"info"})}),d.subscribe(p.AUTH_SIGNUP,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),d.subscribe(p.AUTH_FORGOT,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),d.subscribe(p.AUTH_FORGOT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",n),d.publish(p.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),d.subscribe(p.AUTH_RESETHASH_NAV,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),d.subscribe(p.AUTH_RESETHASH_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",n),d.publish(p.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),d.subscribe(p.AUTH_TOKEN_EXPIRED,(a,n)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",n),d.publish(p.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),d.subscribe(p.I18N_SET_LANG,(a,n)=>{console.log("[AppEvents] I18N_SET_LANG:",n);const{langCode:o}=n;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),d.publish(p.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(s){console.error("[AppEvents] Error changing language:",s),d.publish(p.UI_TOAST,{message:`Failed to change language: ${s.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),d.subscribe("CONVERSATION.PROMPT",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",n.message),It(n.message,"user",n.timestamp),d.publish(p.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Agent prompt (no implementation):",n.message);break;case"AGENT_CANVAS":console.log("[AppEvents] Display message in canvas:",n.message),It(n.message,"user",n.timestamp),d.publish(p.CANVAS_DO_SCROLL);break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),d.subscribe("CONVERSATION.RESPONSE",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",n.message),It(n.message,"assistant",n.timestamp,n.streaming);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),d.subscribe(p.UI_LOADING_START,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),d.subscribe(p.UI_LOADING_END,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),d.subscribe(p.UI_TOAST,(a,n)=>{console.log("[AppEvents] UI_TOAST:",n)}),d.subscribe(p.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const a="0.1",n=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${a} 8/3/2026, 12:05:51 PM|© ${n} Mach Five Tech`,"night")}),zo(),d.subscribe("M5T_PRIMARY_NAV",(a,n)=>{const o=a.split(".")[1];switch(o){case"TAP":e(n);break;case"LOGO_TAP":t();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function e(a){const{token:n,level:o,primaryToken:s}=a;switch(n){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),d.publish(p.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${n}`,{primaryToken:s});break}}function t(a){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 8/3/2026, 12:05:51 PM|© ${o} Mach Five Tech`,"night",5e3)}d.subscribe(p.AUTH_SIGNOUT,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(U.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function It(e,t="user",a=null,n=!1){const o=document.getElementById("chat-messages");if(!o){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}if(a||(a=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})),n&&t==="assistant"){const r=o.firstElementChild;if(r&&r.tagName.toLowerCase()==="m5t-chat-response"){r.setAttribute("message",e),console.log(`[AppEvents] Updated streaming ${t} bubble (${e.length} chars)`);return}}let s;t==="user"||t==="prompt"?s=document.createElement("m5t-chat-prompt"):s=document.createElement("m5t-chat-response"),s.setAttribute("message",e),s.setAttribute("timestamp",a),o.prepend(s),console.log(`[AppEvents] Added ${t} bubble to canvas (${e.length} chars)`)}const Vo=Object.freeze({admin_root_role:{value:100,desc:"Administrator superuser infrastructure architecture"},admin_business_role:{value:90,desc:"Administrator financial oversight"},admin_support_role:{value:80,desc:"Administrator maintenance and configuration"},admin_readonly_role:{value:70,desc:"Administrator information help desk"},client_tier_3_role:{value:30,desc:"Client paid tier 3"},client_tier_2_role:{value:20,desc:"Client paid tier 2"},client_tier_1_role:{value:10,desc:"Client paid tier 1"},client_standard_role:{value:0,desc:"Client free tier 0"}});function qo(e){return Vo[e]||null}function jo(e){return e>=50}const qe=Object.freeze({owner:{value:"owner",rank:30,label:"Owner"},admin:{value:"admin",rank:20,label:"Admin"},member:{value:"member",rank:10,label:"Member"},viewer:{value:"viewer",rank:0,label:"Viewer"}}),Yo=Object.freeze({VIEW_DASHBOARD:"view_dashboard",VIEW_MAGNETS:"view_magnets",PROVISION_MAGNETS:"provision_magnets",MANAGE_MAGNETS:"manage_magnets",VIEW_CONVERSATIONS:"view_conversations",VIEW_STATS:"view_stats",VIEW_AD_METRICS:"view_ad_metrics",CONNECT_AD_ACCOUNTS:"connect_ad_accounts",CREATE_CLIENT_ACCOUNTS:"create_client_accounts",MANAGE_TEAM:"manage_team",VIEW_BILLING:"view_billing",MANAGE_BILLING:"manage_billing"}),A=Yo,ln=Object.freeze(Object.values(A)),Ee=Object.freeze([A.VIEW_DASHBOARD,A.VIEW_MAGNETS,A.VIEW_CONVERSATIONS,A.VIEW_STATS,A.VIEW_AD_METRICS]),Wo=Object.freeze({reseller_org:{owner:ln,admin:[A.VIEW_DASHBOARD,A.VIEW_MAGNETS,A.PROVISION_MAGNETS,A.MANAGE_MAGNETS,A.VIEW_CONVERSATIONS,A.VIEW_STATS,A.VIEW_AD_METRICS,A.CONNECT_AD_ACCOUNTS,A.CREATE_CLIENT_ACCOUNTS,A.MANAGE_TEAM,A.VIEW_BILLING],member:[A.VIEW_DASHBOARD,A.VIEW_MAGNETS,A.PROVISION_MAGNETS,A.MANAGE_MAGNETS,A.VIEW_CONVERSATIONS,A.VIEW_STATS,A.VIEW_AD_METRICS],viewer:Ee},managed_client:{owner:[...Ee,A.VIEW_BILLING],admin:[...Ee,A.VIEW_BILLING],member:Ee,viewer:Ee},saas_org:{owner:[A.VIEW_DASHBOARD,A.VIEW_MAGNETS,A.PROVISION_MAGNETS,A.MANAGE_MAGNETS,A.VIEW_CONVERSATIONS,A.VIEW_STATS,A.VIEW_AD_METRICS,A.CONNECT_AD_ACCOUNTS,A.MANAGE_TEAM,A.VIEW_BILLING,A.MANAGE_BILLING],admin:[A.VIEW_DASHBOARD,A.VIEW_MAGNETS,A.PROVISION_MAGNETS,A.MANAGE_MAGNETS,A.VIEW_CONVERSATIONS,A.VIEW_STATS,A.VIEW_AD_METRICS,A.CONNECT_AD_ACCOUNTS,A.MANAGE_TEAM,A.VIEW_BILLING],member:[A.VIEW_DASHBOARD,A.VIEW_MAGNETS,A.PROVISION_MAGNETS,A.MANAGE_MAGNETS,A.VIEW_CONVERSATIONS,A.VIEW_STATS],viewer:Ee}});function Ko(e){const t=qo(e);return!!t&&jo(t.value)}function Jo({entityClass:e,orgChannel:t,memberRole:a}={}){if(Ko(e))return e==="admin_readonly_role"?[...Ee,A.VIEW_BILLING]:[...ln];const n=Wo[t],o=n&&n[a];return o?[...o]:[]}function Xo(e,t){const a=qe[e]?.rank??-1,n=qe[t]?.rank??1/0;return a>=qe.admin.rank&&a>=n}class S{static CONFIG={BASE_URL:"https://machfivemagnet-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink",SCOPE:"sse_session_scope",ACTIVE_ORG:"sse_active_org"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",ME:"/m5t/v5/acctEntity/me",PING:"/ping"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#o=null;static#a=null;static#n=!1;static#s=null;static#i=null;static async init({BASE_URL:t,navigateFunction:a,customConfig:n={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(a&&typeof a=="function")this.#i=a;else throw new Error("navigateFunction is required and must be a function");return t&&(this.CONFIG.BASE_URL=t),n&&Object.keys(n).length>0&&(this.CONFIG={...this.CONFIG,...n}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#m(),this.#p(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#p(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((t=null)=>{if(t){if((window.location.hash||"").startsWith("#/accept-invite")&&(t==="splash"||t==="signin")){console.log("[AuthController] Ignoring mvvLegit redirect to",t,"— keeping invitee on accept-invite");return}console.log("[AuthController] mvvLegit navigation to:",t),this.#r(t)}}).setOnState((t=null)=>{if(t)switch(console.log("[AuthController] Auth state changed:",t),t){case"AUTH":case 4:this.#_();break;case"UNAUTH":case 1:this.#b();break;case"UNVERF":case 2:this.#y();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#r(t){if(!this.#i){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",t);const a=t.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",a),this.#i(a)}static#l(){if(window.__m5tActiveOrgFetch)return;const t=window.fetch.bind(window);window.fetch=(a,n)=>{try{const o=typeof a=="string"?a:a?.url||"",s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);if(s&&o.startsWith(this.CONFIG.BASE_URL)){const r=new Headers(n&&n.headers||(a instanceof Request?a.headers:void 0));r.set("X-Active-Org",s),n={...n||{},headers:r}}}catch{}return t(a,n)},window.__m5tActiveOrgFetch=!0,console.log("[AuthController] Active-org fetch header installed")}static#m(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);t&&(this.#o=JSON.parse(t),console.log("[AuthController] Entity state loaded:",this.#o?.email))}catch(t){console.error("[AuthController] Error loading entity state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#o=null}this.#s=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.SCOPE);t&&(this.#a=JSON.parse(t),console.log("[AuthController] Scope state loaded (cached):",this.#a?.uiMode))}catch(t){console.error("[AuthController] Error loading scope state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE),this.#a=null}}static#c(t){try{this.#o=t,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(t)),console.log("[AuthController] Entity state saved")}catch(a){console.error("[AuthController] Error saving entity state:",a)}}static#d(){this.#o=null,this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#u)}catch{}}static getEntity(){return this.#o}static#v(t){try{this.#a=t,localStorage.setItem(this.CONFIG.LS_KEYS.SCOPE,JSON.stringify(t))}catch(a){console.error("[AuthController] Error saving scope state:",a)}}static async fetchScope(){if(typeof mvvLegit>"u"||!this.isAuthenticated())return console.log("[AuthController] fetchScope skipped — not authenticated"),this.#a;if(this.#n)return this.#a;this.#n=!0;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),a=t?`?org=${encodeURIComponent(t)}`:"",n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.ME}${a}`);if(n.status===401||n.status===403)return console.warn("[AuthController] /me unauthorized — signing out"),this.doSignout(!0),null;if(!n.ok)return console.warn(`[AuthController] /me failed (${n.status}) — using cached scope`),this.#a;const o=await n.json();if(!o?.ok)return console.warn("[AuthController] /me returned not-ok — using cached scope"),this.#a;try{const s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);s&&o.activeOrg?.guid!==s&&(console.warn("[AuthController] Stored active org not honored by /me — clearing"),localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG))}catch{}return this.#v(o),d.publish(p.AUTH_SCOPE_LOADED,o),console.log(`[AuthController] Scope loaded: ${o.uiMode} (${o.memberships?.length||0} org(s), ${o.managedClients?.length||0} client(s))`),o}catch(t){return console.error("[AuthController] fetchScope error:",t),this.#a}finally{this.#n=!1}}static async setActiveOrg(t){try{t?localStorage.setItem(this.CONFIG.LS_KEYS.ACTIVE_ORG,t):localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}return this.fetchScope()}static getScope(){return this.#a}static getCapabilities(){return this.isPreviewingAsClient()?Jo({orgChannel:"managed_client",memberRole:"owner"}):this.#a?.capabilities||[]}static getUiMode(){return this.isPreviewingAsClient()?"managed":this.#a?.uiMode||"self_serve"}static getActiveOrg(){return this.#a?.activeOrg||null}static getMemberships(){return this.#a?.memberships||[]}static getManagedClients(){return this.#a?.managedClients||[]}static getStoredActiveOrg(){try{return localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{return null}}static#u="m5m_preview_as_client";static isPreviewingAsClient(){try{return sessionStorage.getItem(this.#u)==="1"&&!!this.#a?.activeOrg?.viaSubtree}catch{return!1}}static setPreviewAsClient(t){try{t?sessionStorage.setItem(this.#u,"1"):sessionStorage.removeItem(this.#u)}catch{}this.#a&&d.publish(p.AUTH_SCOPE_LOADED,this.#a)}static async doSignin(t,a){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a})}),o=await n.json();if(n.status===303)return console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#c(o.entity)),setTimeout(()=>{this.#r(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o};if(n.ok&&o.accessToken){console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#c(o.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#u)}catch{}return this.fetchScope(),console.log("[AuthController] Explicitly navigating to home"),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}}return{ok:!1,error:o.error||"Sign in failed",data:o}}catch(n){return console.error("[AuthController] Signin error:",n),{ok:!1,error:n.message}}}static async doSignout(t=!1){console.log("[AuthController] doSignout called, serverInitiated:",t);try{const a=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!a),!t&&a){const n=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(a)}`;if(console.log("[AuthController] Sending signout beacon to:",n),navigator.sendBeacon){const o=navigator.sendBeacon(n);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else a||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#d(),console.log("[AuthController] Stopping auth ping..."),this.#h(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(a){console.error("[AuthController] Signout error:",a),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(t){try{const a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await a.json();return a.ok&&n.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#c(n.entity),{ok:!0,data:n}):{ok:!1,error:n.error||"Sign up failed",data:n}}catch(a){return console.error("[AuthController] Signup error:",a),{ok:!1,error:a.message}}}static async doResetHash(t,a){try{const n=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a,modified_by:t})}),s=await o.json();return o.ok&&s.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:s}):{ok:!1,error:s.error||"Password reset failed",data:s}}catch(n){return console.error("[AuthController] Reset password error:",n),{ok:!1,error:n.message}}}static#g(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#f()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#h(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#f(){try{const t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);t.ok?console.log("[AuthController] Ping success"):(t.status===401||t.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(t){console.error("[AuthController] Ping error:",t)}}static setDeepLinkGuid(t){this.#s=t,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,t),console.log("[AuthController] Deep-link GUID stored:",t)}static getDeepLinkGuid(){return this.#s}static clearDeepLink(){this.#s=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#_(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.fetchScope()}static#b(){console.log("[AuthController] User unauthenticated"),this.#h()}static#y(){console.log("[AuthController] User unverified")}static getAuthState(){try{const t=mvvLegit.getConf()?.LSKEY||"mvv",a=localStorage.getItem(t);if(!a)return"UNAUTH";if(typeof LZString>"u")return null;const n=LZString.decompressFromUTF16(a),s=JSON.parse(n)?.state;return s===1?"UNAUTH":s===2?"UNVERF":s===4?"AUTH":s===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(t){this.#r(t)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#f()}}class T{static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_dashboard:"Dashboard",nav_dashboard_tagline:"Overview of your activity",nav_magnets:"Your Magnets",nav_magnets_tagline:"Manage your conversational magnets",nav_templates:"Templates",nav_templates_tagline:"Start from a magnet template",nav_conversations:"Conversations",nav_conversations_tagline:"Captured lead conversations",nav_ab_testing:"A/B Testing",nav_ab_testing_tagline:"Experiment and optimize",nav_analytics:"Analytics",nav_analytics_tagline:"Performance and ad metrics",nav_ad_accounts:"Ad Accounts",nav_ad_accounts_tagline:"Connect advertising accounts",nav_clients:"Clients",nav_clients_tagline:"Manage your client accounts",nav_team:"Team",nav_team_tagline:"Invite and manage teammates",nav_billing:"Billing",nav_billing_tagline:"Plan, usage, and invoices",nav_settings:"Settings",nav_settings_tagline:"Account and workspace settings",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Rollers",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Rollers",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"滚动器",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:t,product:a,whitelabel:n,lang:o}){t&&(this.#t.buildMode=t),a&&(this.#t.product=a),n&&(this.#t.whitelabel=n),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{const l=this.#e[o]?.[s]?.[r]?.[i]?.[t];return l?Array.isArray(l)?l[Math.floor(Math.random()*l.length)]:l:(console.warn(`[MicrocopyManager] Token not found: ${t} (${o}/${s}/${r}/${i})`),null)}catch(l){return console.error(`[MicrocopyManager] Error retrieving token: ${t}`,l),null}}static getAll(t={}){const a={...this.#t,...t},{buildMode:n,product:o,whitelabel:s,lang:r}=a;try{return this.#e[n]?.[o]?.[s]?.[r]||null}catch(i){return console.error("[MicrocopyManager] Error retrieving all tokens",i),null}}static has(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return!!this.#e[o]?.[s]?.[r]?.[i]?.[t]}catch{return!1}}static getAvailableLanguages(){const{buildMode:t,product:a,whitelabel:n}=this.#t;try{return Object.keys(this.#e[t]?.[a]?.[n]||{})}catch{return[]}}static update(t,a,n={}){const o={...this.#t,...n},{buildMode:s,product:r,whitelabel:i,lang:l}=o;try{return this.#e[s]||(this.#e[s]={}),this.#e[s][r]||(this.#e[s][r]={}),this.#e[s][r][i]||(this.#e[s][r][i]={}),this.#e[s][r][i][l]||(this.#e[s][r][i][l]={}),this.#e[s][r][i][l][t]=a,!0}catch(c){return console.error(`[MicrocopyManager] Error updating token: ${t}`,c),!1}}static delete(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return delete this.#e[o]?.[s]?.[r]?.[i]?.[t],!0}catch(l){return console.error(`[MicrocopyManager] Error deleting token: ${t}`,l),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(t){try{return this.#e=t,!0}catch(a){return console.error("[MicrocopyManager] Error importing data",a),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:T});class ge{static#e=!1;static#t=null;static#o=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const t=this.#n();T.setContext(t),console.log("[I18nController] Initialized with context:",t),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#s(),this.#p(),this.#e=!0,this.refresh()}static#a(t){const a={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},n=t.toLowerCase();return a[n]||"DEV"}static#n(){const a=this.#a("production"),n=localStorage.getItem(U.FF_SSE_LS_WHITELABEL)||U.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(U.FF_SSE_LS_USER_LANG)||U.FF_SSE_I18N_LANG;return{buildMode:a,product:U.FF_SSE_I18N_PRODUCT,whitelabel:n,lang:o}}static#s(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((t,a,n)=>{U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",n),this.#t=n,setTimeout(()=>{this.refresh()},U.FF_SSE_I18N_APPLY_DELAY_MS)},U.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#i())}static#i(){setInterval(()=>{const a=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");a&&a!==this.#t&&(this.#t=a,this.refresh())},500)}static#p(){this.#o||(this.#o=new MutationObserver(t=>{let a=!1;for(const n of t){for(const o of n.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){a=!0;break}if(a)break}a&&(U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#o.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#r(document.body),this.#l(document.body),U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#r(t){const a=t.querySelectorAll("[data-meta-copywrite-i118n]");U.FF_SSE_I18N_DEBUG&&a.length>0&&console.log(`[I18nController] Processing ${a.length} elements`),a.forEach(n=>{try{const o=n.getAttribute("data-meta-copywrite-i118n"),s=JSON.parse(o);if(!s.token){console.warn("[I18nController] Missing token in config:",s);return}const r=s.attribute||"textContent",i=T.get(s.token);if(i===null){console.warn(`[I18nController] Microcopy not found for token: ${s.token}`);return}r==="textContent"?n.textContent=i:r==="innerHTML"?n.innerHTML=i:n.setAttribute(r,i),U.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${i}" to ${r} for token: ${s.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,n)}})}static#l(t){t.querySelectorAll("*").forEach(n=>{n.shadowRoot&&(this.#r(n.shadowRoot),this.#l(n.shadowRoot))})}static setLanguage(t){const a=T.getAvailableLanguages();if(!a.includes(t)){console.error(`[I18nController] Language not available: ${t}. Available:`,a);return}localStorage.setItem(U.FF_SSE_LS_USER_LANG,t),T.setContext({lang:t}),console.log("[I18nController] Language changed to:",t);const n=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:t}});document.dispatchEvent(n),this.refresh()}static setWhitelabel(t){localStorage.setItem(U.FF_SSE_LS_WHITELABEL,t),T.setContext({whitelabel:t}),U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",t),this.refresh()}static getLanguage(){return T.getContext().lang}static getAvailableLanguages(){return T.getAvailableLanguages()}static getContext(){return T.getContext()}static destroy(){this.#o&&(this.#o.disconnect(),this.#o=null),this.#e=!1,this.#t=null,U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{ge.initialize()}):ge.initialize());class Xt{static _initialized=!1;static _debug=!1;static init(t={}){if(this._initialized)return console.warn("[MachVive] Already initialized, skipping duplicate initialization"),this;if(this._debug=t.debug||!1,!window.mvvSSEther)return console.error("[MachVive] mvvSSEther not found - cannot initialize bridge"),console.error("[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()"),this;console.log("[MachVive] Initializing SSE to PubSub bridge...");const a=n=>{this._handleSSEMessage(n)};return window.mvvSSEther.onmessage(a),this._initialized=!0,console.log("[MachVive] ✓ SSE to PubSub bridge initialized successfully"),console.log("[MachVive] ✓ Bound callback to mvvSSEther.onmessage"),this}static _handleSSEMessage(t){try{this._debug&&console.log("[MachVive] SSE message received:",t);const a=t?.data;if(!a){this._debug&&console.log("[MachVive] No data in message, skipping");return}const n=a.data||a.package||a;if(!n){this._debug&&console.log("[MachVive] No package found in message, skipping");return}let o=n.cfg;const s=n.msg;if(this._debug&&(console.log("[MachVive] cfg (raw):",o,"type:",typeof o,"length:",o?.length),console.log("[MachVive] msg (raw):",s)),typeof o=="string"){if(o.trim()===""){this._debug&&console.log("[MachVive] cfg is empty string, skipping");return}try{o=JSON.parse(o),console.log("[MachVive] cfg (parsed):",o)}catch(i){console.warn("[MachVive] Failed to parse cfg as JSON:",{cfg:o,cfgLength:o.length,error:i.message});return}}else if(!o){this._debug&&console.log("[MachVive] cfg is empty/null, skipping");return}const r=o?.topic;if(!r){this._debug&&console.log("[MachVive] No topic found in cfg, skipping");return}if(console.log("[MachVive] Extracted topic:",r),!this._isValidTopic(r)){console.warn(`[MachVive] Topic '${r}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(r,s,t,a)}catch(a){console.error("[MachVive] Error handling SSE message:",a)}}static _isValidTopic(t){return!p||!p.hasOwnProperty(t)?(console.warn(`[MachVive] Topic '${t}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(t,a,n,o){try{if(!window.PubSub&&typeof PubSub>"u"){console.error("[MachVive] PubSub not available");return}const s=window.PubSub||PubSub,r={message:a,metadata:{source:"sse",sseEventId:n.id,timestamp:n.timestamp,appGuid:o.app_guid,channelGuid:o.channel_guid,eventAction:o.event_action,status:o.status,class:o.class,raw:o}};console.log(`[MachVive] Publishing to topic '${t}':`,r);const i=p[t];console.log(`[MachVive] AppBroadcast.${t} = '${i}'`),s.publish(i,r),console.log(`[MachVive] ✓ Published SSE message to topic: ${t}`)}catch(s){console.error(`[MachVive] Error publishing to topic '${t}':`,s)}}static debug(t){return this._debug=t,console.log(`[MachVive] Debug mode ${t?"enabled":"disabled"}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log("[MachVive] Reset complete"),this}}typeof module<"u"&&module.exports&&(module.exports=Xt);typeof window<"u"&&(window.MachVive=Xt);const ua="m5t_sidenav_collapsed",Qo={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};class Zo extends HTMLElement{static get observedAttributes(){return["data-active-token","data-collapsed"]}constructor(){super(),this.attachShadow({mode:"open"}),this.items=[],this.orgs=[],this.activeOrgGuid=null,this.activeToken=null,this.footerBadge=null,this.loading=!1,this.lastFocus=null}#e=null;#t=t=>{if(this.getAttribute("data-open")==="true"){if(t.key==="Escape"){t.preventDefault(),this.closeDrawer();return}if(t.key==="Tab"){const a=this.#c();if(a.length<2)return;const n=a[0],o=a[a.length-1],s=this.shadowRoot.activeElement;t.shiftKey&&s===n?(t.preventDefault(),o.focus()):!t.shiftKey&&s===o&&(t.preventDefault(),n.focus())}}};#o=()=>{this.closeDrawer(),this.#d()};connectedCallback(){if(!this.hasAttribute("data-collapsed"))try{localStorage.getItem(ua)==="true"&&this.setAttribute("data-collapsed","true")}catch{}this.activeToken=this.getAttribute("data-active-token")||null,this.render(),this.#l(),this.addEventListener("keydown",this.#t),this.#e=window.matchMedia("(max-width: 768px)"),this.#e.addEventListener("change",this.#o),this.#d()}disconnectedCallback(){this.removeEventListener("keydown",this.#t),this.#e?.removeEventListener("change",this.#o)}attributeChangedCallback(t,a,n){a===n||!this.shadowRoot||(t==="data-active-token"?(this.activeToken=n,this.#m()):t==="data-collapsed"&&this.shadowRoot.firstChild&&(this.render(),this.#l()))}setState({buttons:t,orgs:a,activeOrg:n,footerBadge:o,loading:s}={}){t!==void 0&&(this.items=Array.isArray(t)?t:this.#a(t)||[]),a!==void 0&&(this.orgs=Array.isArray(a)?a:this.#a(a)||[]),n!==void 0&&(this.activeOrgGuid=n||null),o!==void 0&&(this.footerBadge=o||null),s!==void 0&&(this.loading=!!s),this.shadowRoot&&(this.render(),this.#l())}setButtons(t){this.setState({buttons:t})}setOrgs(t){this.setState({orgs:t})}setActiveOrgGuid(t){this.setState({activeOrg:t})}setFooterBadge(t){this.setState({footerBadge:t})}setActiveToken(t){this.activeToken=t||null,this.#m()}toggleCollapsed(t){const a=typeof t=="boolean"?t:this.getAttribute("data-collapsed")!=="true";this.setAttribute("data-collapsed",String(a));try{localStorage.setItem(ua,String(a))}catch{}this.dispatchEvent(new CustomEvent("nav-collapse",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_SIDE_NAV.COLLAPSE",collapsed:a,timestamp:Date.now()}}))}openDrawer(){this.lastFocus=this.shadowRoot.activeElement||document.activeElement,this.setAttribute("data-open","true"),this.shadowRoot.querySelector(".hamburger")?.setAttribute("aria-expanded","true"),this.#d(),(this.#c()[0]||this.shadowRoot.querySelector(".sidenav"))?.focus?.()}closeDrawer(){if(this.getAttribute("data-open")!=="true")return;this.removeAttribute("data-open");const t=this.shadowRoot.querySelector(".hamburger");t?.setAttribute("aria-expanded","false"),this.#d(),t&&this.#e?.matches?t.focus():this.lastFocus?.focus?.()}toggleDrawer(){this.getAttribute("data-open")==="true"?this.closeDrawer():this.openDrawer()}#a(t){try{return t?JSON.parse(t):null}catch(a){return console.error("[M5TSideNav] bad JSON:",a),null}}#n(t){return String(t??"").replace(/[&<>"']/g,a=>Qo[a])}#s(t){return t?`<span class="ms" aria-hidden="true">${this.#n(t)}</span>`:""}#i(t){if(!t||!t.token)return"";const a=t.token===this.activeToken,n=t.route||"#",o=n.startsWith("#")?n:`#${n}`,s=typeof t.count=="number"&&t.count>0?`<span class="badge">${t.count}</span>`:"";return`
    ...
    <div class="ocb" role="status">
    ...
    </div>`,t.querySelector('[data-ocb="preview"]')?.addEventListener("click",()=>{S.setPreviewAsClient(!S.isPreviewingAsClient()),cn()}),t.querySelector('[data-ocb="portfolio"]')?.addEventListener("click",()=>{S.setPreviewAsClient(!1),S.setActiveOrg(null)})}function pn(e){const t=document.getElementById("m5t-side-nav"),a=je[`/${e}`]||je[e]||null;t?.setActiveToken(a?.sectionToken||null),os(a)}function os(e){const t=document.getElementById("m5t-sub-nav"),a=document.getElementById("app-shell");if(!t)return;const n=e?.children;t.hidden=!1,n&&n.length>1?(t.updateButtons(n.map(o=>({token:o.token,caption:o.caption,enabled:!0,selected:o.token===e.childToken}))),a?.classList.add("has-sub-nav")):(t.updateButtons([]),a?.classList.remove("has-sub-nav"))}function ss(){const e=ge.getAvailableLanguages&&ge.getAvailableLanguages()||[];if(e.length<2){d.publish(p.UI_TOAST,{message:"Only one language is available",type:"info"});return}const t=localStorage.getItem(U.FF_SSE_LS_USER_LANG)||U.FF_SSE_I18N_LANG||e[0],a=e[(e.indexOf(t)+1)%e.length];ge.setLanguage(a),d.publish(p.UI_TOAST,{message:`Language: ${a}`,type:"info"})}function rs(){const e=document.getElementById("m5t-side-nav");if(!e)return;_t.setAppToken("client-saas"),document.getElementById("app-shell")?.classList.toggle("nav-collapsed",e.getAttribute("data-collapsed")==="true"),e.addEventListener("nav-select",o=>{const s=o.detail?.route;s&&D.navigate(s.startsWith("/")?s:`/${s}`)}),e.addEventListener("logo-click",()=>D.navigate("/home")),e.addEventListener("nav-collapse",o=>{document.getElementById("app-shell")?.classList.toggle("nav-collapsed",!!o.detail?.collapsed)}),e.addEventListener("org-switch",o=>{const s=o.detail?.orgGuid;s&&S.setActiveOrg(s===Ft?null:s)}),e.addEventListener("footer-action",o=>{switch(o.detail?.action){case"account":D.navigate("/settings");break;case"signout":D.navigate("/signout");break;case"lang":ss();break}}),document.getElementById("m5t-sub-nav")?.addEventListener("nav-select",o=>{const s=Mt[o.detail?.token];s&&D.navigate(s)}),document.addEventListener("language-changed",()=>Lt()),Lt(),d.subscribe(p.AUTH_SCOPE_LOADED,()=>Lt());const a=()=>{const o=S.getScope();return[o?.uiMode,o?.activeOrg?.guid,(o?.managedClients||[]).length,(o?.capabilities||[]).join(",")].join("|")};let n=a();d.subscribe(p.AUTH_SCOPE_LOADED,()=>{const o=a();o!==n&&(n=o,Te&&!Qt.has(Te)&&cn())})}function is(e){Te=e;const t=document.getElementById("m5t-side-nav"),a=document.getElementById("app-shell");if(!t||!a)return;const n=!Qt.has(e);if(t.hidden=!n,a.classList.toggle("has-side-nav",n),n)pn(e);else{const o=document.getElementById("m5t-sub-nav");o&&(o.hidden=!0),a.classList.remove("has-sub-nav")}dn()}d.subscribe(p.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&is(t.route)});const un=()=>{console.log("[Router] Route: splash"),d.publish(p.ROUTE_NAV_BEFORE,{route:"splash"});const e=new URLSearchParams(window.location.search||""),t=!!(e.get("uid")&&e.get("token"));J(t?()=>Promise.resolve().then(()=>ms):()=>Promise.resolve().then(()=>fs),void 0).then(n=>{const o=document.getElementById("app");o.innerHTML=n.render(),n.init&&n.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"splash"})}).catch(n=>{console.error("[Router] Error loading splash route:",n),d.publish(p.ROUTE_NAV_ERROR,{route:"splash",error:n})})};D.on("/",un);D.on("/splash",un);D.on("/signin",()=>{console.log("[Router] Route: /signin"),d.publish(p.ROUTE_NAV_BEFORE,{route:"signin"}),J(()=>Promise.resolve().then(()=>xs),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"signin"})}).catch(e=>{console.error("[Router] Error loading signin route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"signin",error:e})})});D.on("/signup",()=>{console.log("[Router] Route: /signup"),d.publish(p.ROUTE_NAV_BEFORE,{route:"signup"}),J(()=>Promise.resolve().then(()=>Is),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"signup"})}).catch(e=>{console.error("[Router] Error loading signup route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"signup",error:e})})});D.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),d.publish(p.ROUTE_NAV_BEFORE,{route:"verf-link"}),J(()=>Promise.resolve().then(()=>$s),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(e=>{console.error("[Router] Error loading verf-link route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"verf-link",error:e})})});D.on("/forgot",()=>{console.log("[Router] Route: /forgot"),d.publish(p.ROUTE_NAV_BEFORE,{route:"forgot"}),J(()=>Promise.resolve().then(()=>Us),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(e=>{console.error("[Router] Error loading forgot route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"forgot",error:e})})});D.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!le("resethash")){ee("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"resethash"}),J(()=>Promise.resolve().then(()=>Gs),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(e=>{console.error("[Router] Error loading resethash route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"resethash",error:e})})});D.on("/home",()=>{if(console.log("[Router] Route: /home"),!le("home")){ee("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"home"}),J(()=>Promise.resolve().then(()=>ar),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"home"})}).catch(e=>{console.error("[Router] Error loading home route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"home",error:e})})});D.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!le("signout")){ee("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"signout"}),J(()=>Promise.resolve().then(()=>sr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"signout"})}).catch(e=>{console.error("[Router] Error loading signout route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"signout",error:e})})});const ls=[{path:"/templates",name:"templates",title:"Templates",icon:"content_copy"},{path:"/analytics",name:"analytics",title:"Analytics",icon:"monitoring"},{path:"/ad-accounts",name:"ad-accounts",title:"Ad Accounts",icon:"ads_click"},{path:"/billing",name:"billing",title:"Billing",icon:"receipt_long"},{path:"/settings",name:"settings",title:"Settings",icon:"settings"},{path:"/magnets/drafts",name:"magnets/drafts",title:"Magnets · Drafts",icon:"widgets"},{path:"/magnets/archived",name:"magnets/archived",title:"Magnets · Archived",icon:"widgets"},{path:"/analytics/conversions",name:"analytics/conversions",title:"Analytics · Conversions",icon:"monitoring"},{path:"/settings/workspace",name:"settings/workspace",title:"Settings · Workspace",icon:"settings"},{path:"/settings/integrations",name:"settings/integrations",title:"Settings · Integrations",icon:"settings"},{path:"/settings/security",name:"settings/security",title:"Settings · Security",icon:"settings"}];ls.forEach(({path:e,name:t,title:a,icon:n})=>{D.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!le("home")){ee("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:t}),J(()=>Promise.resolve().then(()=>lr),void 0).then(o=>{const s=document.getElementById("app");s.innerHTML=o.render({title:a,icon:n,name:t}),o.init&&o.init({name:t}),d.publish(p.ROUTE_NAV_AFTER,{route:t})}).catch(o=>{console.error(`[Router] Error loading section route (${t}):`,o),d.publish(p.ROUTE_NAV_ERROR,{route:t,error:o})})})});D.on("/conversations",()=>{if(console.log("[Router] Route: /conversations"),!le("home")){ee("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"conversations"}),J(()=>Promise.resolve().then(()=>_r),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"conversations"})}).catch(e=>{console.error("[Router] Error loading conversations route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"conversations",error:e})})});D.on("/ab-testing",()=>{if(console.log("[Router] Route: /ab-testing"),!le("home")){ee("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"ab-testing"}),J(()=>Promise.resolve().then(()=>$r),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"ab-testing"})}).catch(e=>{console.error("[Router] Error loading ab-testing route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"ab-testing",error:e})})});D.on("/magnets",()=>{if(console.log("[Router] Route: /magnets"),!le("home")){ee("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"magnets"}),J(()=>Promise.resolve().then(()=>wi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"magnets"})}).catch(e=>{console.error("[Router] Error loading magnets route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"magnets",error:e})})});D.on("/leads",()=>{if(console.log("[Router] Route: /leads"),!le("home")){ee("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"leads"}),J(()=>Promise.resolve().then(()=>Mi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"leads"})}).catch(e=>{console.error("[Router] Error loading leads route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"leads",error:e})})});D.on("/analytics/ad-performance",()=>{if(console.log("[Router] Route: /analytics/ad-performance"),!le("home")){ee("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"analytics/ad-performance"}),J(()=>Promise.resolve().then(()=>zi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"analytics/ad-performance"})}).catch(e=>{console.error("[Router] Error loading ad-performance route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"analytics/ad-performance",error:e})})});D.on("/clients",()=>{if(console.log("[Router] Route: /clients"),!le("home")){ee("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"clients"}),J(()=>Promise.resolve().then(()=>Zi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"clients"})}).catch(e=>{console.error("[Router] Error loading clients route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"clients",error:e})})});D.on("/team",()=>{if(console.log("[Router] Route: /team"),!le("home")){ee("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"team"}),J(()=>Promise.resolve().then(()=>ll),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"team"})}).catch(e=>{console.error("[Router] Error loading team route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"team",error:e})})});D.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),ee("splash")});d.subscribe(p.ROUTE_NAV,(e,t)=>{console.log("[Router] ROUTE_NAV event received:",t),t?.route&&ee(t.route)});function ma(){console.log("[App] Waiting for Neodigm 55 library...");let e=0;const t=100,a=setInterval(()=>{e++,e%10===0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(a),cs()):e>=t&&(clearInterval(a),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
      ...
      `,d.publish(p.APP_ERROR,{message:"Failed to load authentication library"}))},100)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ma):ma();async function cs(){if(console.log("[App] Neodigm 55 loaded, initializing..."),Go(),ge.initialize(),console.log("[App] I18n Controller initialized"),!await S.init({BASE_URL:"https://machfivemagnet-saas.onrender.com",navigateFunction:a=>{console.log("[AuthController] Navigation requested:",a),ee(a)}})){console.error("[App] AuthController initialization failed");return}const t=S.getEntity();t&&(console.log("[App] Session restored for:",t.email),d.publish(p.APP_USER_LOADED,{entity:t}),S.isAuthenticated()&&S.fetchScope()),d.publish(p.APP_READY,{timestamp:new Date().toISOString(),sessionUser:t}),rs(),D.resolve(),window.AuthController=S,window.I18nController=ge,window.MachVive=Xt,console.log("[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)")}d.subscribe(p.ROUTE_NAV_AFTER,(e,t)=>{typeof ge<"u"&&ge.refresh&&setTimeout(()=>{ge.refresh()},100)});let ga=!1;function ds(){if(ga)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
    .accept-invite-page {
  ...
  `}function hs(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const e=localStorage.getItem(U.FF_SSE_LS_TOKEN),t=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!e,hasMvvTs:!!t});const a=document.getElementById("splash-loader"),n=document.getElementById("splash-actions");e?(console.log("[SplashRoute] Auth token found → HOME"),d.publish(p.ROUTE_NAV,{route:"home"})):t?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),d.publish(p.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),a&&(a.style.display="none"),n&&(n.style.display="flex"),document.querySelectorAll("[data-route]").forEach(s=>{s.addEventListener("click",()=>{const r=s.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${r}`),d.publish(p.ROUTE_NAV,{route:r})})}))},4e3)}const fs=Object.freeze(Object.defineProperty({__proto__:null,init:hs,render:gs},Symbol.toStringTag,{value:"Module"}));function vs(){return`
  ...
  `}function _s(){console.log("[SigninRoute] Initialized");const e=document.getElementById("loginForm"),t=document.getElementById("email"),a=document.getElementById("password");document.getElementById("togglePassword")?.addEventListener("click",()=>{const s=a.type==="password"?"text":"password";a.type=s}),e?.addEventListener("submit",async s=>{s.preventDefault();const r=t.value.trim(),i=a.value;bs(r,t)&&ys(i,a)&&await ws(r,i)}),document.getElementById("link--uc__underline")?.addEventListener("click",s=>{s.preventDefault(),d.publish(p.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",s=>{s.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),d.publish(p.ROUTE_NAV,{route:"signup"})})}function bs(e,t){if(!e)return ct(t,T.get("validation_email_required")),!1;const a=(e.match(/@/g)||[]).length,n=(e.match(/\./g)||[]).length;return a!==1||n<1?(ct(t,T.get("validation_email_invalid")),!1):!0}function ys(e,t){return e?e.length<10?(ct(t,T.get("validation_password_min_length")),!1):!0:(ct(t,T.get("validation_password_required")),!1)}function ct(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}async function ws(e,t){const a=document.querySelector(".btn");a.disabled=!0,a.textContent=T.get("loading_signing_in");try{const n=await S.doSignin(e,t);n.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(T.get("success_welcome_back"),"success"),d.publish(p.AUTH_SIGNIN_SUCCESS,{entity:S.getEntity()})):n.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q(T.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(n.error||T.get("error_signin_failed"),"danger"),a.disabled=!1,a.textContent=T.get("sign_in").toUpperCase())}catch(n){console.error("[SigninRoute] Sign in error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||T.get("error_network"),"danger"),a.disabled=!1,a.textContent=T.get("sign_in").toUpperCase(),d.publish(p.AUTH_SIGNIN_FAIL,{message:n.message})}}const xs=Object.freeze(Object.defineProperty({__proto__:null,init:_s,render:vs},Symbol.toStringTag,{value:"Module"}));function hn(e){const t=[];return e.length<10&&t.push("at least 10 characters"),/[a-z]/.test(e)||t.push("1 lowercase"),/[A-Z]/.test(e)||t.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(e)||t.push("1 special character"),/[^\x00-\x7F]/.test(e)&&t.push("ASCII characters only"),t}function fn(e){return e.length===0?"":e.includes("ASCII characters only")?"Password cannot contain emoji|or special unicode characters":e.includes("at least 10 characters")?"Password must have at least|10 characters":"Password must have: Uppercase,|Lowercase, and Special Character"}const Es="2026-07-15";function Ss(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="/m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function As(){console.log("[SignupRoute] Initialized");const e=document.getElementById("signupForm"),t=e.querySelector('button[type="submit"]');ha("togglePassword","password","eyeIcon"),ha("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),d.publish(p.ROUTE_NAV,{route:"signin"})}),e.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),s=document.getElementById("last").value.trim(),r=document.getElementById("email").value.trim(),i=document.getElementById("company").value.trim(),l=document.getElementById("phone").value.trim(),c=document.getElementById("password").value,v=document.getElementById("confirmPassword").value,y=document.getElementById("first"),m=document.getElementById("last"),w=document.getElementById("email"),C=document.getElementById("password"),g=document.getElementById("confirmPassword");if(!fa(o,y,T.get("validation_first_name_required"))||!fa(s,m,T.get("validation_last_name_required"))||!ks(r,w)||!Ts(c,C))return;if(c!==v){Ce(g,T.get("validation_password_mismatch"));return}const h=document.getElementById("acceptTerms");if(!h.checked){Ce(h,"Please accept the Terms of Service and Privacy Policy to continue.");return}t.disabled=!0,t.textContent=T.get("loading_creating_account"),await Cs(o,s,r,i,l,c)})}function ha(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function fa(e,t,a){return e?!0:(Ce(t,a),!1)}function ks(e,t){if(!e)return Ce(t,T.get("validation_email_required")),!1;const a=(e.match(/@/g)||[]).length,n=(e.match(/\./g)||[]).length;return a!==1||n<1?(Ce(t,T.get("validation_email_invalid")),!1):!0}function Ts(e,t){if(!e)return Ce(t,T.get("validation_password_required")),!1;const a=hn(e);return a.length>0?(Ce(t,fn(a)),!1):!0}function Ce(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}async function Cs(e,t,a,n,o,s){const r=document.querySelector('button[type="submit"]');try{const i={email:a,password:s,first:e,last:t};n&&(i.company=n),o&&(i.phone=o),i.terms_accepted=!0,i.legal_version=Es;const l=await S.doSignup(i);if(l.ok)d.publish(p.AUTH_SIGNUP_SUCCESS,{email:a}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const c=l.error||l.message||T.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(c,"danger"),r.disabled=!1,r.textContent=T.get("create_account").toUpperCase(),d.publish(p.AUTH_SIGNUP_FAIL,{message:c})}}catch(i){console.error("[SignupRoute] Sign up error:",i),typeof neodigmToast<"u"&&neodigmToast.q(i.message||T.get("error_network"),"danger"),r.disabled=!1,r.textContent=T.get("create_account").toUpperCase(),d.publish(p.AUTH_SIGNUP_FAIL,{message:i.message})}}const Is=Object.freeze(Object.defineProperty({__proto__:null,init:As,render:Ss},Symbol.toStringTag,{value:"Module"}));function Ls(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="/m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function Ps(){console.log("[ForgotRoute] Initialized");const e=document.getElementById("forgot-form"),t=document.getElementById("email");e?.addEventListener("submit",async a=>{a.preventDefault();const n=t.value.trim();Ds(n,t)&&await Bs(n)})}function Ds(e,t){if(!e)return va(t,T.get("validation_email_required")),!1;const a=(e.match(/@/g)||[]).length,n=(e.match(/\./g)||[]).length;return a!==1||n<1?(va(t,T.get("validation_email_invalid")),!1):!0}function va(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}async function Bs(e){const t=document.querySelector(".btn");t.disabled=!0,t.textContent="SENDING...";try{const a=await Ms.forgotPassword(e);a.ok&&a.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q(T.get("success_reset_link_sent"),"success"),d.publish(p.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(a.data.error||T.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=T.get("send_reset_link").toUpperCase())}catch(a){console.error("[ForgotRoute] Forgot password error:",a),typeof neodigmToast<"u"&&neodigmToast.q(a.message||T.get("error_network"),"danger"),t.disabled=!1,t.textContent=T.get("send_reset_link").toUpperCase()}}const Us=Object.freeze(Object.defineProperty({__proto__:null,init:Ps,render:Fs},Symbol.toStringTag,{value:"Module"}));function Hs(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function zs(){console.log("[ResethashRoute] Initialized");const e=document.getElementById("resethash-form"),t=e.querySelector('button[type="submit"]');_a("toggleNewPassword","new-password","eyeIconNew"),_a("toggleConfirmPassword","confirm-password","eyeIconConfirm"),e?.addEventListener("submit",async a=>{a.preventDefault();const n=e.email.value.trim(),o=e.newPassword.value,s=e.confirmPassword.value,r=document.getElementById("new-password"),i=document.getElementById("confirm-password");if(!o){Me(r,T.get("validation_new_password_required"));return}const l=hn(o);if(l.length>0){Me(r,fn(l));return}if(!s){Me(i,T.get("validation_new_password_required"));return}if(o!==s){Me(i,T.get("validation_password_mismatch"));return}t.disabled=!0,t.textContent=T.get("loading_resetting_password");try{const c=await S.doResetHash(n,o);c.ok?(typeof neodigmToast<"u"&&neodigmToast.q(T.get("success_password_reset"),"success"),d.publish(p.AUTH_RESETHASH_SUCCESS,{email:n})):(Me(r,c.error||T.get("error_signin_failed")),t.disabled=!1,t.textContent=T.get("update_password").toUpperCase())}catch(c){console.error("[ResethashRoute] Reset password error:",c),Me(r,c.message||T.get("error_network")),t.disabled=!1,t.textContent=T.get("update_password").toUpperCase()}})}function _a(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function Me(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}const Gs=Object.freeze(Object.defineProperty({__proto__:null,init:zs,render:Hs},Symbol.toStringTag,{value:"Module"})),se=()=>S.getManagedClients().length>0&&!S.getStoredActiveOrg(),ye=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),Vs={reseller_org:"Your org",managed_client:"Client",saas_org:"Org"};let ba=!1;function bt(){if(ba)return;const e=document.createElement("style");e.id="m5t-portfolio-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ba=!0}const ya=e=>e.toISOString().slice(0,10);async function qs(e,{days:t=30}={}){const a=new Date,n=ya(new Date(a.getTime()-(t-1)*864e5)),o=ya(a),s=await fetch(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${o}&group_by=owner`);if(!s.ok)throw new Error(`HTTP ${s.status}`);const r=await s.json();if(!r.ok)throw new Error("stats not ok");return r.by_owner||[]}function vn(e,t){return`<div class="dash-clients-scroll"><table class="dash-clients">
    <thead><tr>
    ...
    <tbody>${e.map(a=>`
      <tr data-org="${ye(a.owner_guid)}" tabindex="0" role="button"
        ...
        <td><span class="dc-name">${ye(a.name||a.owner_guid)}
          <span class="dc-chip">${ye(Vs[a.channel]||a.channel||"")}</span></span></td>
        ${t.map(n=>`<td>${n.td(a)}</td>`).join("")}
        <td><span class="dc-view">View →</span></td>
      </tr>`).join("")}</tbody>
  </table></div>`}function _n(e){if(!e)return;const t=a=>{const n=a?.dataset?.org;n&&S.setActiveOrg(n)};e.querySelectorAll("tbody tr[data-org]").forEach(a=>{a.addEventListener("click",()=>t(a)),a.addEventListener("keydown",n=>{(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),t(a))})})}const Pt=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Zt({section:e,title:t,description:a}){return bt(),`
    ...
    </div>`}async function yt(e,t,{emptyMsg:a}={}){const n=document.getElementById("pf-picker-body");if(n)try{const o=await qs(e);if(!o.length){n.innerHTML=Pt("groups",a||"No client orgs yet. Create one under Clients first.");return}n.innerHTML=vn(o,t),_n(n)}catch(o){console.warn("[portfolio] picker load failed:",o),n.innerHTML=Pt("error","Could not load your clients. Please refresh.")}}function bn(){const e={};return S.getManagedClients().forEach(t=>{e[t.orgGuid]=t.name}),S.getMemberships().forEach(t=>{t.orgGuid&&!e[t.orgGuid]&&(e[t.orgGuid]=t.name||"")}),e}const yn=e=>e?`<span class="pf-client-chip">${ye(e)}</span>`:"",ne=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,ie=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),V=e=>Number(e||0).toLocaleString(),wn=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",js=e=>(wn(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function Ys(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric"})}catch{return""}}function Ws(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}let wa=!1;function Ks(){if(wa)return;const e=document.createElement("style");e.id="m5t-dash-recent-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),wa=!0}function Js(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${ie(js(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${ie(wn(e))}</span>
      <span class="recent-lead__sub">${ie(e.email||e.phone||"")}</span>
    </span>
    <span class="recent-lead__badge" data-s="${ie(e.status)}">${ie(e.status)}</span>
    <span class="recent-lead__time">${ie(Ys(e))}</span>
  </a>`}const Qe=({icon:e,label:t,valueId:a,value:n="—",subId:o,sub:s=""})=>`
  <div class="stat-card">
  ...
  </div>`,Ze=(e,t,a,{wide:n=!1,full:o=!1,controls:s=!1}={})=>`
  <div class="dashboard-card${n?" chart-card-wide":""}${o?" chart-card-full":""}">
  ...
  </div>`;let Dt=30;function xn(){Ks(),bt();const e=se();return`
    <div class="page-shell" data-section="home">
      ...
      <div class="stats-grid">
        ${Qe({icon:"widgets",label:"Active Magnets",valueId:"stat-active-magnets",subId:"stat-active-magnets-sub",sub:"Loading…"})}
        ${Qe({icon:"ads_click",label:"Magnet Opens",valueId:"stat-opens",subId:"stat-opens-sub",sub:"Loading…"})}
        ${Qe({icon:"person_add",label:"Leads Captured",valueId:"stat-leads",subId:"stat-leads-sub",sub:"Loading…"})}
        ${Qe({icon:"check_circle",label:"Completion Rate",valueId:"stat-completion",subId:"stat-completion-sub",sub:"Loading…"})}
      </div>

      <div class="charts-section">
        ${Ze("show_chart","Opens & Leads","dash-trend",{wide:!0,controls:!0})}
        <div class="charts-grid">
          ${Ze("filter_alt","Completion Funnel","dash-funnel")}
          ${Ze("source","Top Campaigns","dash-campaigns")}
          ${Ze("touch_app","CTA Usage","dash-routes",{full:!0})}
        </div>
      </div>
      ...
      <div class="content-grid">
    ...
    </div>`}async function En(){const e=S.getConfig?.().BASE_URL||"";document.getElementById("dash-periods")?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(Dt=Number(a.dataset.days)||30,document.querySelectorAll("#dash-periods .chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===Dt)),Ea(e))}),await Promise.all([Ea(e),Zs(e)])}const pe=(e,t)=>{const a=document.getElementById(e);a&&(a.textContent=t)},Fe=(e,t)=>{const a=document.getElementById(e);a&&(a.innerHTML=t)},xa=e=>e.toISOString().slice(0,10);async function Ea(e){const t=new Date,a=xa(new Date(t.getTime()-(Dt-1)*864e5)),n=xa(t),o=se();let s;try{const E=await fetch(`${e}/m5t/v5/dashboard/stats?from=${a}&to=${n}${o?"&group_by=owner":""}`);if(!E.ok)throw new Error(`HTTP ${E.status}`);if(s=await E.json(),!s.ok)throw new Error("stats not ok")}catch(f){console.warn("[dashboard] stats fetch failed:",f),["stat-active-magnets","stat-opens","stat-leads","stat-completion"].forEach(E=>pe(E,"—")),["stat-active-magnets-sub","stat-opens-sub","stat-leads-sub","stat-completion-sub"].forEach(E=>pe(E,"Unavailable")),["dash-trend","dash-funnel","dash-campaigns","dash-routes","dash-interactions","dash-portfolio"].forEach(E=>Fe(E,ne("error","Could not load. Please refresh.")));return}o&&Xs(s.by_owner||[]),pe("stat-active-magnets",V(s.magnets.active)),pe("stat-active-magnets-sub",s.magnets.total>s.magnets.active?`${V(s.magnets.total-s.magnets.active)} paused`:s.magnets.active?"All running":"No magnets yet");const r=s.funnel||{};pe("stat-opens",r.opens?V(r.opens):"—"),pe("stat-opens-sub",r.opens?r.engagement_rate!=null?`${r.engagement_rate}% engage`:`${V(r.engaged)} engaged`:"No opens in this range yet");const i=s.leads||{};pe("stat-leads",V(i.total));const l=(i.this_week||0)-(i.prev_week||0);pe("stat-leads-sub",i.total?`${V(i.this_week)} this week (${l>=0?"+":""}${V(l)} vs last)`:"No leads yet"),pe("stat-completion",r.completion_rate!=null?`${r.completion_rate}%`:"—"),pe("stat-completion-sub",r.opens?`${V(r.completions)} completed of ${V(r.opens)} opens`:"Appears once magnets get opened");const c=s.by_day||[],v=c.some(f=>f.opens||f.leads);Fe("dash-trend",v?er(c):ne("show_chart","No activity in this range yet. Opens and leads chart here as visitors engage your magnets.")),Fe("dash-funnel",r.opens?Qs(r):ne("filter_alt","The funnel fills in once your magnets record opens."));const y=s.top_campaigns||[];Fe("dash-campaigns",y.length?`<div class="dash-list">${y.map(f=>`
        ...
        </div>`).join("")}</div>`:ne("source","No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here."));const m={book:["event","Book"],chat:["chat","Chat"],call:["phone_in_talk","Call"],email:["mail","Email"],support:["support_agent","Support"]},w=Object.entries(r.routes||{}).sort((f,E)=>E[1]-f[1]),C=w.length?w[0][1]:0;Fe("dash-routes",w.length?`<div class="dash-funnel">${w.map(([f,E])=>{const[L,F]=m[f]||["touch_app",f];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${L}</span> ${ie(F)}</span><span class="dash-funnel__val">${V(E)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${C?Math.max(4,Math.round(E/C*100)):0}%"></div></div>
        </div>`}).join("")}</div>`:ne("touch_app","CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar."));const g={open:["visibility","Magnet opened"],engage:["touch_app","Visitor engaged"],route:["alt_route","Picked a channel"],complete:["check_circle","Completed: lead captured"]},h=s.recent_events||[];Fe("dash-interactions",h.length?`<div class="dash-list">${h.map(f=>{const[E,L]=g[f.event]||["sensors",f.event],F=f.event==="route"&&f.detail?` · ${ie(f.detail)}`:"";return`<div class="dash-list__row">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">${E}</span></span>
          <span class="dash-list__main">${L}${F}</span>
          ${f.display_mode?`<span class="dash-list__mode">${ie(f.display_mode)}</span>`:""}
          <span class="dash-list__time">${ie(Ws(f.at))}</span>
        </div>`}).join("")}</div>`:ne("sensors","No interactions yet. They'll stream in as visitors engage your magnets."))}function Xs(e){const t=document.getElementById("dash-portfolio");if(!t)return;if(!e.length){t.innerHTML=ne("groups","No client orgs yet. Create one under Clients to see its numbers here.");return}const a=e.some(s=>s.ad),n=s=>{const r=(s.leads.this_week||0)-(s.leads.prev_week||0);return!s.leads.this_week&&!s.leads.prev_week?"":` <span class="${r>=0?"dc-delta-up":"dc-delta-down"}">(${r>=0?"+":""}${V(r)})</span>`},o=[{h:"Magnets",td:s=>`${V(s.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${V(s.magnets.total)}</span>`},{h:"Leads · wk",td:s=>`${V(s.leads.this_week)}${n(s)}`},{h:"Leads · total",td:s=>V(s.leads.total)},{h:"Opens",td:s=>V(s.opens)},{h:"Compl.",td:s=>s.completion_rate!=null?`${s.completion_rate}%`:"—"},...a?[{h:"Spend",td:s=>s.ad?`$${V(s.ad.spend)}`:"—"},{h:"CPL",td:s=>s.ad?.cost_per_lead!=null?`$${V(s.ad.cost_per_lead)}`:"—"}]:[]];t.innerHTML=vn(e,o),_n(t)}function Qs(e){const t=[["Opened",e.opens,""],["Engaged",e.engaged," dash-funnel__bar--mid"],["Completed",e.completions," dash-funnel__bar--end"]],a=Math.max(1,e.opens||0);return`<div class="dash-funnel">${t.map(([n,o,s])=>`
    ...
    </div>`).join("")}</div>`}async function Zs(e){const t=document.getElementById("recent-leads-body");if(t)try{const a=await fetch(`${e}/m5t/v5/m5mLead`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json(),o=(Array.isArray(n?.data)?n.data:[]).filter(s=>!["DELETED","ARCHIVED"].includes(s.status));t.innerHTML=o.length?o.slice(0,5).map(Js).join(""):ne("contacts","No leads captured yet. Publish a magnet to start collecting.")}catch(a){console.warn("[dashboard] Leads fetch failed:",a),t.innerHTML=ne("error","Could not load recent leads.")}}function Sa(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}const Aa=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e));function er(e){const w=e.length||1,C=Sa(Math.max(1,...e.map(x=>x.opens||0))),g=Sa(Math.max(1,...e.map(x=>x.leads||0))),h=748/w,f=Math.min(22,h*.55),E=x=>46+h*(x+.5),L=x=>266-x/C*248,F=x=>266-x/g*248,W=[0,.5,1].map(x=>{const $=266-x*248;return`<line x1="46" y1="${$.toFixed(1)}" x2="794" y2="${$.toFixed(1)}" stroke="#EAF0F7"/><text x="38" y="${($+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${Aa(C*x)}</text><text x="802" y="${($+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${Aa(g*x)}</text>`}).join(""),j=e.map((x,$)=>{const de=L(x.opens||0);return`<rect x="${(E($)-f/2).toFixed(1)}" y="${de.toFixed(1)}" width="${f.toFixed(1)}" height="${Math.max(0,266-de).toFixed(1)}" rx="3" fill="#0072BA" opacity="0.85"><title>${x.date}: ${x.opens} opens</title></rect>`}).join(""),te=e.map((x,$)=>`${E($).toFixed(1)},${F(x.leads||0).toFixed(1)}`).join(" "),ce=w>1?`<polyline points="${te}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",Q=e.map((x,$)=>`<circle cx="${E($).toFixed(1)}" cy="${F(x.leads||0).toFixed(1)}" r="3.2" fill="#009473"><title>${x.date}: ${x.leads} leads</title></circle>`).join(""),ve=Math.max(1,Math.ceil(w/6)),he=e.map((x,$)=>$%ve===0||$===w-1?`<text x="${E($).toFixed(1)}" y="288" text-anchor="middle" class="dash-ax">${x.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="dash-chart" viewBox="0 0 840 300" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Magnet opens versus leads over time">
      ${W}${j}${ce}${Q}${he}
    </svg>`}const tr={render:xn,init:En},ar=Object.freeze(Object.defineProperty({__proto__:null,default:tr,init:En,render:xn},Symbol.toStringTag,{value:"Module"}));function nr(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/home" aria-label="Mach Five Magnet">
          <img src="/m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function or(){console.log("[SignoutRoute] Initialized");const e=document.getElementById("confirm-signout-btn");e?.addEventListener("click",async()=>{e.disabled=!0,e.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await S.doSignout()})}const sr=Object.freeze(Object.defineProperty({__proto__:null,init:or,render:nr},Symbol.toStringTag,{value:"Module"}));let ka=!1;function rr(){if(ka)return;const e=document.createElement("style");e.id="m5t-section-page-styles",e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),ka=!0}function Sn({title:e="Section",icon:t="widgets",name:a=""}={}){return rr(),`
    ...
    </section>`}function An(){}const ir={render:Sn,init:An},lr=Object.freeze(Object.defineProperty({__proto__:null,default:ir,init:An,render:Sn},Symbol.toStringTag,{value:"Module"})),cr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},q=e=>String(e??"").replace(/[&<>"']/g,t=>cr[t]),Bt=()=>S.getConfig?.().BASE_URL||"",Nt=e=>Number(e||0).toLocaleString(),B={conversations:[],counts:{},magnetNames:{},filter:"ALL",book:!1,magnetOwnerNames:{}},Ta={COMPLETED:{label:"Completed",icon:"check_circle"},IN_PROGRESS:{label:"In progress",icon:"pending"},ABANDONED:{label:"Abandoned",icon:"highlight_off"}},Ut={book:"Book",chat:"Chat",call:"Call",email:"Email",support:"Support"};function kn(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email)||null}function Tn(e){return(e.split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase()}function Cn(e){try{return new Date(e).toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return""}}function dr(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function In(e){return e==null?"—":e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,"0")}s`}let Ca=!1;function pr(){if(Ca)return;const e=document.createElement("style");e.id="m5t-convs-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ca=!0}const wt=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Ln(){return pr(),bt(),`
    <div class="page-shell" data-section="conversations">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="convs-body">
          ${wt("hourglass_empty","Loading journeys…")}
        </div>
      </div>
    </div>`}async function Nn(){await ur()}async function ur(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${Bt()}/m5t/v5/conversations`),fetch(`${Bt()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(B.conversations=n.conversations||[],B.counts=n.counts||{},B.book=se(),a){const o=await a.json().catch(()=>({}));B.magnetNames={},B.magnetOwnerNames={};const s=B.book?bn():{};(o.magnets||[]).forEach(r=>{B.magnetNames[r.guid]=r.name,B.book&&(B.magnetOwnerNames[r.guid]=r.owner_name||s[r.owner_guid]||"")})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=wt("error","Could not load journeys. Please try again.");return}$n()}}function mr(){return B.filter==="ALL"?B.conversations:B.conversations.filter(e=>e.status===B.filter)}function gr(e){const t=kn(e.lead),a=B.magnetNames[e.magnet_guid]||"—",n=Ta[e.status]||Ta.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,s=(e.routes||[]).map(r=>Ut[r]||r).join(", ");return`
    <tr class="convs-row" data-session="${q(e.session)}">
      <td>
        <span class="convs-who">
          <span class="convs-ava${t?"":" anon"}">${t?q(Tn(t)):'<span class="material-symbols-outlined" style="font-size:16px">person_off</span>'}</span>
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${q(Cn(e.started_at))}">${q(dr(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${q(In(e.duration_s))}</td>
    </tr>`}function $n(){const e=document.getElementById("convs-body");if(!e)return;if(!B.conversations.length){e.innerHTML=wt("route","No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.");return}const t=mr(),a=[["ALL","All"],["COMPLETED","Completed"],["IN_PROGRESS","In progress"],["ABANDONED","Abandoned"]];e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${a.map(([n,o])=>`<button data-filter="${n}" class="${B.filter===n?"active":""}">${o}${n!=="ALL"&&B.counts[n]?` (${Nt(B.counts[n])})`:""}</button>`).join("")}
      </div>
      <span class="convs-count">${Nt(t.length)} of ${Nt(B.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(gr).join("")||`<tr><td colspan="${B.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${B.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(B.filter=o.dataset.filter,$n())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&fr(o.dataset.session)})}const hr={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${Ut[e]||e}`:""}`,route:e=>`Picked ${Ut[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function fr(e){const t=B.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${Bt()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=kn(t.lead),o=B.magnetNames[t.magnet_guid]||"—",r=(a?.events||[]).filter((c,v,y)=>c.event!=="step"||!(y[v+1]&&y[v+1].event==="step")).map(c=>`
    <div class="convs-tl__item${c.event==="complete"?" done":""}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${q((hr[c.event]||(()=>c.event))(c.detail))}</div>
      <div class="convs-tl__time">${q(Cn(c.at))}${c.variant?` · Variant ${q(c.variant)}`:""}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      ...
      <div class="convs-drawer__body">
        ${n?`<a class="convs-drawer__lead" href="#/leads">
              <span class="convs-ava">${q(Tn(n))}</span>
        ...
        <div class="convs-sub" style="margin-bottom:6px">${q(o)} · ${q(In(t.duration_s))}${t.variant?` · Variant ${q(t.variant)}`:""}</div>
        ${r?`<div class="convs-tl">${r}</div>`:wt("timeline","No timeline available for this journey.")}
      </div>
    </aside>`,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("open"),i.querySelector(".convs-drawer").classList.add("open")});const l=()=>{i.classList.remove("open"),setTimeout(()=>i.remove(),220)};i.querySelector(".convs-drawer__close").addEventListener("click",l),i.addEventListener("click",c=>{c.target===i&&l()})}const vr={render:Ln,init:Nn},_r=Object.freeze(Object.defineProperty({__proto__:null,default:vr,init:Nn,render:Ln},Symbol.toStringTag,{value:"Module"})),br={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ke=e=>String(e??"").replace(/[&<>"']/g,t=>br[t]),Ia=(e,t="info")=>{try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}},nt=()=>S.getConfig?.().BASE_URL||"",He=e=>Number(e||0).toLocaleString(),we={magnets:[],stats:{},canManage:!1},yr={mag_title:"header title",mag_subtitle:"subtitle",mag_welcome:"welcome message",mag_theme_color:"color",mag_launcher_label:"launcher label"};let La=!1;function wr(){if(La)return;const e=document.createElement("style");e.id="m5t-abt-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),La=!0}const ea=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function On(){return se()?Zt({section:"ab-testing",title:"A/B Testing",description:"Pick a client to view their experiments."}):(wr(),`
    <div class="page-shell" data-section="ab-testing">
      ...
      <div id="abt-body">${ea("hourglass_empty","Loading tests…")}</div>
    </div>`)}async function ta(){if(se())return yt(nt(),[{h:"Running",td:t=>He(t.ab_tests?.running)},{h:"Completed",td:t=>He(t.ab_tests?.completed)},{h:"Compl. %",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Experiments appear per client once you have one."});const e=document.getElementById("abt-body");try{const t=new Date,a=new Date(t.getTime()-89*864e5).toISOString().slice(0,10),n=t.toISOString().slice(0,10),[o,s]=await Promise.all([fetch(`${nt()}/m5t/v5/magnets`),fetch(`${nt()}/m5t/v5/magnets/stats?from=${a}&to=${n}`)]),r=await o.json().catch(()=>({}));if(!r.ok)throw new Error(r.message||"Failed to load");we.magnets=r.magnets||[],we.canManage=!!r.canManage;const i=await s.json().catch(()=>({}));we.stats=i?.stats||{}}catch(t){console.warn("[ab-testing] load failed:",t),e&&(e.innerHTML=ea("error","Could not load your tests. Please try again."));return}xr()}function xr(){const e=document.getElementById("abt-body");if(!e)return;const t=we.magnets.filter(n=>n.ab?.enabled),a=we.magnets.filter(n=>!n.ab?.enabled&&n.ab?.declared);if(!t.length&&!a.length){e.innerHTML=ea("science","No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.");return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(kr).join("")}`:"")+(a.length?`<div class="abt-sect">Completed Tests</div>${a.map(Tr).join("")}`:""),e.querySelectorAll("[data-declare]").forEach(n=>n.addEventListener("click",()=>Cr(n.dataset.declare,n.dataset.winner)))}function Er(e){const t=we.stats[e.guid]?.variants||{},a={opens:0,engaged:0,completions:0,rate:null,...t.A||{}},n={opens:0,engaged:0,completions:0,rate:null,...t.B||{}};return{A:a,B:n}}function Sr(e){const t=Object.keys(e?.b||{}).map(a=>yr[a]||a);return t.length?`Changes: ${t.join(", ")}`:""}function Ar(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function Na(e,t,a,n,o,s){return`
    <div class="abt-variant${o?" leader":""}">
      ...
      <div class="abt-mrow"><span class="k">Visitors</span><span class="v">${He(n.opens)}</span></div>
      <div class="abt-mrow"><span class="k">Completions</span><span class="v">${He(n.completions)}</span></div>
    ...
    </div>`}function kr(e){const t=e.ab,{A:a,B:n}=Er(e),o=(n.rate??-1)>(a.rate??-1)?"B":(a.rate??-1)>(n.rate??-1)?"A":null,s=o&&a.rate!=null&&n.rate!=null?`+${Math.round(Math.abs(n.rate-a.rate)*10)/10}%`:"",r=Ir(a,n),i=t.started_tz?Ar(t.started_tz):null,l=(a.opens||0)+(n.opens||0),c=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
      ...
      <div class="abt-meta">
        ...
        <span><span class="material-symbols-outlined" aria-hidden="true">visibility</span>${He(l)} total visitors</span>
      ...
      <div class="abt-compare">
        ${Na("Variant A","Control","The magnet as configured",a,o==="A",o==="A"?s:"")}
        <div class="abt-vs">VS</div>
        ${Na("Variant B",o==="B"?"Leading":"Challenger",Sr(t),n,o==="B",o==="B"?s:"")}
      </div>
      <div class="abt-sig">
    ...
    <div class="abt-card">
      ...
      <div class="abt-summary">
        ...
        <span><span class="k">Total Visitors:</span><span class="v">${He(r)}</span></span>
      </div>
    </div>`}async function Cr(e,t){const a=we.magnets.find(n=>n.guid===e);if(a&&window.confirm(`Declare Variant ${t} the winner for “${a.name}”?

${t==="B"?"Variant B’s changes become the magnet’s configuration for everyone.":"The magnet keeps its current configuration."} The experiment ends and moves to Completed.`))try{const o=await(await fetch(`${nt()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Declare failed");Ia(`Variant ${t} declared the winner`,"success"),await ta()}catch(n){Ia(n.message||"Could not declare a winner","danger")}}function Ir(e,t){const a=e.opens||0,n=t.opens||0,o=e.completions||0,s=t.completions||0;if(a<30||n<30||o+s<5)return null;const r=o/a,i=s/n,l=(o+s)/(a+n),c=Math.sqrt(l*(1-l)*(1/a+1/n));if(!c)return null;const v=Math.abs(i-r)/c;return Math.round(2*(Lr(v)-.5)*1e3)/10}function Lr(e){const t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}const Nr={render:On,init:ta},$r=Object.freeze(Object.defineProperty({__proto__:null,default:Nr,init:ta,render:On},Symbol.toStringTag,{value:"Module"})),Or={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},X=e=>String(e??"").replace(/[&<>"']/g,t=>Or[t]),Rr=()=>S.getConfig?.().BASE_URL||"",Ht={single_select:{label:"Multiple choice",icon:"quiz",color:"#0072BA"},multi_select:{label:"Select all",icon:"checklist",color:"#0E6BA8"},scheduler:{label:"Scheduler",icon:"event",color:"#915E8B"},text:{label:"Short text",icon:"short_text",color:"#5B54C6"},email:{label:"Email",icon:"mail",color:"#0E8F86"},phone:{label:"Phone",icon:"call",color:"#2E8B57"},message:{label:"Message",icon:"chat",color:"#B4791F"}},Rn=["single_select","multi_select","scheduler","text","email","phone","message"],Mn={chat:"Chat / default",book:"Book (scheduler)",support:"Support (intake)"},aa=e=>Ht[e]||Ht.single_select,$e=e=>e==="single_select"||e==="multi_select",xt=e=>e!=="message",Ke=e=>e==="scheduler",dt=e=>e==="email"?"email":e==="phone"?"phone":e==="scheduler"?"preferred_time":"",Ie=()=>({meeting_label:"",start:"09:00",end:"17:00",mins:30,days:14}),Mr=["first_name","last_name","email","phone","company","product_interest","budget","timeline","message"],Fr=[["","No icon"],["event","Calendar"],["schedule","Clock"],["mail","Email"],["sms","Text"],["phone","Phone"],["chat","Chat"],["description","Document"],["help","Question"],["place","Location"],["person","Person"],["bolt","Quick"],["check_circle","Check"],["star","Star"],["home","Home"],["build","Service"]];function Pr(e,t){const a=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||"").trim());return a?`rgba(${parseInt(a[1],16)},${parseInt(a[2],16)},${parseInt(a[3],16)},${t})`:`rgba(0,114,186,${t})`}let $a=!1;function Dr(){if($a)return;const e=document.createElement("style");e.id="m5t-flow-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),$a=!0}let O=[],fe=null,Br=0,be=null,Se=null,Ae="chat",oe={},ot=[],Fn=null,zt=null;const ze=()=>"f"+ ++Br;function na(e="single_select"){return{_uid:ze(),id:"",step_type:e,step_prompts:[""],step_options:$e(e)?[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]:[],step_columns:dt(e)?[dt(e)]:[],step_description:"",step_config:Ke(e)?Ie():null}}function Ur(e){return(Array.isArray(e)?e:[]).map(t=>({_uid:ze(),id:t.id!=null?String(t.id):"",step_type:Ht[t.step_type]?t.step_type:"single_select",step_prompts:Array.isArray(t.step_prompts)?t.step_prompts.map(String):[],step_options:(Array.isArray(t.step_options)?t.step_options:[]).map(a=>({label:a&&a.label!=null?String(a.label):"",goto:a&&a.goto!=null?String(a.goto):"",icon:a&&a.icon!=null?String(a.icon):""})),step_columns:Array.isArray(t.step_columns)?t.step_columns.map(String):[],step_description:t.step_description!=null?String(t.step_description):"",step_config:t.step_config&&typeof t.step_config=="object"?{...Ie(),...t.step_config}:t.step_type==="scheduler"?Ie():null}))}function Oa(){return[{_uid:ze(),id:"",step_type:"text",step_prompts:["Great, and your name?"],step_options:[],step_columns:["first_name"],step_description:"",step_config:null},{_uid:ze(),id:"",step_type:"email",step_prompts:["The best email to reach you?"],step_options:[],step_columns:["email"],step_description:"",step_config:null}]}function Hr(e,t){if(e==="book")return[{_uid:ze(),id:"",step_type:"scheduler",step_prompts:["When works best for you?"],step_options:[],step_columns:["preferred_time"],step_description:"",step_config:Ie()},...Oa()];if(e==="support"){const a=(t.actions||[]).find(s=>s&&s.type==="support"),n=a&&a.config&&Array.isArray(a.config.options)?a.config.options:[],o=n.length?n.map(s=>({label:s&&s.label||String(s),goto:"",icon:s&&s.icon||""})):["Sales enquiry","Support","Billing","Something else"].map(s=>({label:s,goto:"",icon:""}));return[{_uid:ze(),id:"",step_type:"multi_select",step_prompts:["How can we help you today?"],step_options:o,step_columns:["support_topics"],step_description:"Select all that apply",step_config:null},...Oa()]}return[na("single_select")]}function Pn(e,t){const a=e==="chat"?t.steps:t.routes&&t.routes[e],n=Ur(a);return n.length?n:e==="chat"?[na("single_select")]:Hr(e,t)}function zr(e){$e(e.step_type)?e.step_options.length||(e.step_options=[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]):e.step_options=[],xt(e.step_type)?!e.step_columns.length&&dt(e.step_type)&&(e.step_columns=[dt(e.step_type)]):e.step_columns=[],e.step_config=Ke(e.step_type)?e.step_config||Ie():null}function Gr(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${X(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${Fr.map(([a,n])=>`<option value="${X(a)}"${a===e.icon?" selected":""}>${X(n)}</option>`).join("")}</select>
  ...
  </div>`}function Vr(e){const t=Rn.map(n=>`<option value="${n}"${n===e.step_type?" selected":""}>${X(aa(n).label)}</option>`).join(""),a=e.step_options.length<=1;return`<div class="flow-node__body">
...
`))}</textarea>
    ...
    <div class="flow-opts">${e.step_options.map(n=>Gr(n,a)).join("")}</div>
  ...
  </div>`}function qr(e){const t=e.step_prompts.find(o=>String(o).trim()!=="")||"",a=t?`<div class="flow-node__prompt">“${X(t)}”</div>`:`<div class="flow-node__prompt is-empty">${e.step_type==="message"?"No message yet":"No question yet"}</div>`;let n="";if($e(e.step_type)){const o=e.step_options.map(s=>String(s.label).trim()).filter(Boolean);if(o.length){const s=o.slice(0,4).map(i=>`<span class="flow-node__chip">${X(i)}</span>`).join(""),r=o.length>4?`<span class="flow-node__chip">+${o.length-4}</span>`:"";n=`<div class="flow-node__chips">${s}${r}</div>`}}else xt(e.step_type)&&e.step_columns[0]&&(n=`<div class="flow-node__meta">Saves to <b>${X(e.step_columns[0])}</b></div>`);return`<div class="flow-node__preview">${a}${n}</div>`}function jr(e,t,a){const n=aa(e.step_type),o=e._uid===fe,s=`--nc:${n.color};--nct:${Pr(n.color,.14)}`;return`<div class="flow-node${o?" flow-node--open":""}" data-uid="${e._uid}" style="${s}"${o?"":' draggable="true"'}>
    ...
    ${o?Vr(e):qr(e)}
  </div>`}const Ra='<div class="flow-conn"><span class="flow-conn__line"></span><span class="material-symbols-outlined" aria-hidden="true">expand_more</span></div>';function re(){const e=document.getElementById("flow-nodes");if(!e)return;const t=O.length,a=['<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>',Ra];O.forEach((n,o)=>{a.push(jr(n,o,t)),o<t-1&&a.push(Ra)}),e.innerHTML=a.join("")}function ue(){const e=document.querySelector(".flow-node--open");if(!e)return;const t=O.find(s=>s._uid===e.dataset.uid);if(!t)return;const a=e.querySelector(".flow-f-type");a&&(t.step_type=a.value);const n=e.querySelector(".flow-f-prompts");n&&(t.step_prompts=n.value.split(`
`));const o=e.querySelector(".flow-f-field");if(t.step_columns=o&&o.value.trim()?[o.value.trim()]:[],$e(t.step_type)){const s=t.step_options,r=[];e.querySelectorAll(".flow-opt").forEach((i,l)=>{r.push({label:i.querySelector(".flow-o-label")?.value??"",icon:i.querySelector(".flow-o-icon")?.value??"",goto:s[l]&&s[l].goto||""})}),t.step_options=r}else t.step_options=[];if(Ke(t.step_type)){const s=e.querySelector(".flow-f-mtlabel"),r=e.querySelector(".flow-f-start"),i=e.querySelector(".flow-f-end"),l=e.querySelector(".flow-f-mins");t.step_config={...t.step_config||Ie(),...s?{meeting_label:s.value.trim()}:{},...r&&r.value?{start:r.value}:{},...i&&i.value?{end:i.value}:{},...l?{mins:parseInt(l.value,10)||30}:{}}}else t.step_config=null}function Dn(){document.querySelectorAll(".flow-node.drop-before, .flow-node.drop-after").forEach(e=>e.classList.remove("drop-before","drop-after"))}function Ge(){Dn(),document.querySelectorAll(".flow-node.dragging").forEach(e=>e.classList.remove("dragging")),be=null,Se=null}function Yr(e=O){if(!e.length)return"Add at least one step.";for(let t=0;t<e.length;t++){const a=e[t],n=t+1;if(!a.step_prompts.some(o=>String(o).trim()!==""))return`Step ${n}: add what the magnet should say.`;if($e(a.step_type)&&!a.step_options.some(o=>String(o.label).trim()!==""))return`Step ${n}: add at least one choice.`;if(xt(a.step_type)&&!a.step_columns.length)return`Step ${n}: choose which field this answer saves to.`}return""}function Gt(e=O){let t=0;return e.forEach(a=>{const n=parseInt(a.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(a=>{const n=a.id&&String(a.id).trim()?String(a.id):String(++t),o=$e(a.step_type)?a.step_options.map(r=>{const i={label:String(r.label).trim(),goto:String(r.goto||"")};return r.icon&&(i.icon=String(r.icon)),i}).filter(r=>r.label!==""):[],s={id:n,step_type:a.step_type,step_prompts:a.step_prompts.map(r=>String(r)).filter(r=>r.trim()!==""),step_options:o,step_columns:a.step_columns.slice(),step_description:a.step_description||""};return Ke(a.step_type)&&a.step_config&&(s.step_config={...Ie(),...a.step_config}),s})}function Wr(e,t,a){Dr(),Fn=t,zt=typeof a=="function"?a:null,ot=["chat",...["book","support"].filter(n=>(t.actions||[]).some(o=>o&&o.type===n))],oe={chat:Pn("chat",t)},Ae="chat",O=oe.chat,fe=O.length===1?O[0]._uid:null,be=null,Se=null,e.innerHTML=`
    ...
    ${ot.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${ot.map(n=>`<option value="${n}">${X(Mn[n]||n)}</option>`).join("")}</select></div>`:""}
    <datalist id="flow-fields">${Mr.map(n=>`<option value="${X(n)}"></option>`).join("")}</datalist>
...
<body>
  ...
  <\/script>
  <script>${a}<\/script>
</body></html>`}let Fa=!1;function Un(){if(Fa)return;const e=document.createElement("style");e.id="m5t-preview-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Fa=!0}function Hn(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function zn(e){const t=e.querySelector("[data-pv-info]"),a=e.querySelector("[data-pv-info-pop]");t&&a&&t.addEventListener("click",()=>{a.hidden=!a.hidden})}function ei(e,t){Un(),e.innerHTML=`
    <div class="pv-pane">
    ...
    <div class="pv-modal" role="dialog" aria-modal="true" aria-label="Magnet preview">
      ...
      <div class="pv-body">
        <div>
          ...
          ${Hn("Live render of the actual widget. Capture is disabled, so no test leads are created.")}
        </div>
      </div>
    </div>`,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("open")),zn(a);const n=a.querySelector(".pv-frame"),o=a.querySelector(".pv-stage"),s=()=>{try{n.srcdoc=Bn(e())}catch{}};s();const r=()=>{a.classList.remove("open"),setTimeout(()=>a.remove(),180)};return a.querySelector('[data-x="close"]').addEventListener("click",r),a.querySelector('[data-x="refresh"]').addEventListener("click",s),a.addEventListener("click",i=>{i.target===a&&r()}),a.querySelector(".pv-seg").addEventListener("click",i=>{const l=i.target.closest("button[data-device]");!l||l.dataset.device===t||(t=l.dataset.device,a.querySelectorAll(".pv-seg button").forEach(c=>c.classList.toggle("is-on",c.dataset.device===t)),o.dataset.device=t,s())}),{close:r,rebuild:s}}let Pa=!1;const K={magnets:[],owners:[],canProvision:!1,canManage:!1,primaryOrgGuid:null,stats:{}},ti={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},k=e=>String(e??"").replace(/[&<>"']/g,t=>ti[t]),Le=(e,t="info")=>{try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}},xe=()=>S.getConfig?.().BASE_URL||"",Vn=e=>`<script src="${xe()}/m5t/v5/coreSnippet?appguid=${e}" async><\/script>`,ai={chat:"Chat bubble",right_slide:"Slide-in panel",modal:"Modal",inline:"Inline"},ni={chat:"chat",right_slide:"vertical_split",modal:"web_asset",inline:"view_agenda"},oi=[{value:"inline",icon:"view_agenda",label:"Inline"},{value:"chat",icon:"chat",label:"Chat"},{value:"right_slide",icon:"vertical_split",label:"Slide"},{value:"modal",icon:"web_asset",label:"Modal"}],si=[{value:"auto",icon:"brightness_auto",label:"Auto"},{value:"light",icon:"light_mode",label:"Light"},{value:"dark",icon:"dark_mode",label:"Dark"}],ri=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],qn={book:{label:"Book",icon:"event",kind:"book"},chat:{label:"Chat",icon:"chat",kind:"flow"},call:{label:"Call",icon:"phone",kind:"value",placeholder:"Phone number"},email:{label:"Email",icon:"mail",kind:"value",placeholder:"Email address"},support:{label:"Support",icon:"support_agent",kind:"support"}},ii=["book","chat","call","email","support"];function Da(e,t,a){return`<div class="mag-seg" role="radiogroup" aria-label="${k(e)}">${a.map(n=>`
    <label><input type="radio" name="${k(e)}" value="${k(n.value)}"${n.value===t?" checked":""}>
      <span><span class="material-symbols-outlined" aria-hidden="true">${k(n.icon)}</span>${k(n.label)}</span></label>`).join("")}</div>`}function li(e,t){const a=qn[e],n=!!t,o=n?"":" disabled";let s="";if(a.kind==="value")s=`<input class="mag-modal__input mag-cta__val" type="text" placeholder="${k(a.placeholder)}" value="${k(t?.value||"")}"${o}>`;else if(a.kind==="book"){const i=t?.config?.meeting_label||t?.value||"";s=`<input class="mag-modal__input mag-cta__val" type="text" placeholder="Meeting label (e.g. 15 minute call), or paste a booking link" value="${k(i)}"${o}>`}else s=`<span class="mag-cta__note">${a.kind==="support"?"Multi-select intake":"Opens your conversation flow"}</span>`;let r="";if(a.kind==="support"){const i=(t?.config?.options||[]).map(l=>l&&l.label||l).filter(Boolean);r=`<textarea class="mag-modal__input mag-cta__opts" rows="3" placeholder="Support options, one per line (e.g. Sales&#10;Support&#10;Billing)"${o}>${k(i.join(`
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${a.kind}">
    ...
    ${r}
  </div>`}function ci(){if(Pa)return;const e=document.createElement("style");e.id="m5t-magnets-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Pa=!0}function qt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function di(e){const t=K.stats[e];if(!t||!t.opens&&!t.leads)return'<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>';const a=n=>Number(n||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function pi(e){const t=K.owners.length>1||S.getMemberships().length>1,a=(e.domains||[]).filter(Boolean),n=K.canManage;return`
    <div class="mag-card" data-guid="${k(e.guid)}">
      ...
      <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${ni[e.display_mode]||"chat"}</span>${k(ai[e.display_mode]||"Chat bubble")}${e.ab?.enabled?'&nbsp;&nbsp;<span class="mag-ab-chip"><span class="material-symbols-outlined" aria-hidden="true">science</span>A/B</span>':""}</span>
      ${di(e.guid)}
      <div class="mag-domains">${a.length?a.map(o=>k(o)).join(", "):"<span>No domains set. Add yours to go live.</span>"}</div>
      <div class="mag-embed">
        <input type="text" readonly value="${k(Vn(e.guid))}" aria-label="Embed snippet">
    ...
    </div>`}function ui(){return se()?Zt({section:"magnets",title:"Your Magnets",description:"Pick a client to view and manage their magnets."}):(ci(),`
    ...
    </div>`)}async function mi(){if(se()){const t=a=>Number(a||0).toLocaleString();return yt(xe(),[{h:"Magnets",td:a=>`${t(a.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${t(a.magnets.total)}</span>`},{h:"Leads · wk",td:a=>t(a.leads.this_week)},{h:"Leads · total",td:a=>t(a.leads.total)}],{emptyMsg:"No client orgs yet. Create one under Clients, then provision its magnets here."})}document.getElementById("mag-new-btn")?.addEventListener("click",()=>jt(null)),document.getElementById("mag-body")?.addEventListener("click",gi),await Et()}async function Et(){const e=document.getElementById("mag-body");if(!e)return;try{const[a,n]=await Promise.all([fetch(`${xe()}/m5t/v5/magnets`),fetch(`${xe()}/m5t/v5/magnets/stats`).catch(()=>null)]),o=await a.json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Failed to load");K.magnets=o.magnets||[],K.owners=o.owners||[],K.canProvision=!!o.canProvision,K.canManage=!!o.canManage,K.primaryOrgGuid=o.primaryOrgGuid||null;const s=n?await n.json().catch(()=>({})):{};K.stats=s?.stats||{}}catch{e.innerHTML=qt("error","Could not load your magnets. Please try again.");return}const t=document.getElementById("mag-new-btn");if(t&&(t.style.display=K.canProvision?"":"none"),!K.magnets.length){e.innerHTML=qt("widgets",K.canProvision?"No magnets yet. Click “New magnet” to create your first.":"No magnets yet.");return}e.innerHTML=`<div class="mag-grid">${K.magnets.map(pi).join("")}</div>`}function gi(e){const t=e.target.closest("[data-action]");if(!t)return;const a=t.dataset.guid,n=K.magnets.find(s=>s.guid===a),o=t.dataset.action;if(o==="copy")return hi(a);if(n){if(o==="preview")return Gn(()=>Vt(n));if(o==="edit")return jt(n);if(o==="flow")return jt(n,"flow");if(o==="toggle")return fi(n);if(o==="delete")return vi(n)}}async function hi(e){try{await navigator.clipboard.writeText(Vn(e)),Le("Embed snippet copied","success")}catch{Le("Copy failed","danger")}}async function fi(e){const t=e.status==="ENABLED"?"DISABLED":"ENABLED";try{if(!(await(await fetch(`${xe()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw new Error;Le(t==="ENABLED"?"Magnet enabled":"Magnet disabled","success"),await Et()}catch{Le("Update failed","danger")}}async function vi(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`))try{if(!(await(await fetch(`${xe()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"})).json().catch(()=>({}))).ok)throw new Error;Le("Magnet deleted","success"),await Et()}catch{Le("Delete failed","danger")}}function $t(e){const t=[];return e.querySelectorAll(".mag-cta").forEach(a=>{if(!a.querySelector(".mag-cta__on").checked)return;const n=a.dataset.type,o=a.dataset.kind,s=a.querySelector(".mag-cta__val"),r=s?s.value.trim():"";if(o==="value")r&&t.push({type:n,value:r});else if(o==="book"){const i={type:n};r&&(/^https?:\/\//i.test(r)?i.value=r:i.config={meeting_label:r}),t.push(i)}else if(o==="support"){const i=(a.querySelector(".mag-cta__opts")?.value||"").split(`
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:jn(e),actions:t,font:e.querySelector("#mag-f-font").value.trim(),theme_vars:_i(e),inline_width:e.querySelector("#mag-f-inline-w").value.trim(),inline_height:e.querySelector("#mag-f-inline-h").value.trim(),hide_launcher:e.querySelector("#mag-f-hide-launcher").checked,input_placeholder:e.querySelector("#mag-f-input-ph").value,summary_confirm_label:e.querySelector("#mag-f-summary-confirm").value.trim(),success_title:e.querySelector("#mag-f-success-title").value.trim(),success_text:e.querySelector("#mag-f-success-text").value,success_cta:bi(e)}}function _i(e){return e.querySelector("#mag-f-surface-on")?.checked?{surface:e.querySelector("#mag-f-sv-surface").value,surface_2:e.querySelector("#mag-f-sv-surface2").value,border:e.querySelector("#mag-f-sv-border").value,text:e.querySelector("#mag-f-sv-text").value,text_sub:e.querySelector("#mag-f-sv-textsub").value}:{}}function bi(e){const t=e.querySelector("#mag-f-success-cta-label").value.trim(),a=e.querySelector("#mag-f-success-cta-url").value.trim();return t&&a?{label:t,url:a}:{}}function jn(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",s=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==s.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}const Ba=[{label:"Web fonts (loaded for you)",opts:[["Inter, sans-serif","Inter"],["Poppins, sans-serif","Poppins"],["Montserrat, sans-serif","Montserrat"],["Roboto, sans-serif","Roboto"],['"Open Sans", sans-serif',"Open Sans"],["Lato, sans-serif","Lato"],["Nunito, sans-serif","Nunito"],["Raleway, sans-serif","Raleway"],['"Work Sans", sans-serif',"Work Sans"],["Oswald, sans-serif","Oswald"],["Merriweather, serif","Merriweather (serif)"]]},{label:"System / always available",opts:[["system-ui, sans-serif","System UI"],["Georgia, serif","Georgia (serif)"],['"Times New Roman", Times, serif',"Times (serif)"],["Arial, Helvetica, sans-serif","Arial / Helvetica"],["Verdana, Geneva, sans-serif","Verdana"],['"Courier New", monospace',"Courier (mono)"]]}];function yi(e){const t=String(e||""),a=new Set(Ba.flatMap(s=>s.opts.map(([r])=>r))),n=s=>s===t?" selected":"";let o=`<option value=""${t===""?" selected":""}>System default</option>`;t&&!a.has(t)&&(o+=`<option value="${k(t)}" selected>Current: ${k(t)}</option>`);for(const s of Ba)o+=`<optgroup label="${k(s.label)}">`+s.opts.map(([r,i])=>`<option value="${k(r)}"${n(r)}>${k(i)}</option>`).join("")+"</optgroup>";return o}function jt(e,t){const a=!!e,n=!a&&K.owners.length>1,o=e?.display_mode||"chat",s=e?.theme_mode||"auto",r={};(e?.actions||[]).forEach(I=>{I&&I.type&&(r[I.type]=I)});const i=a?!!e.home:!0,l=a?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",c=e?.theme_vars&&typeof e.theme_vars=="object"?e.theme_vars:{},v=Object.keys(c).length>0,y=(I,Y)=>k(/^#[0-9a-fA-F]{6}$/.test(c[I]||"")?c[I]:Y),m=document.createElement("div");m.className="mag-modal-scrim",m.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${a?"Edit magnet":"New magnet"}">
      ...
      <div class="mag-modal__main">
        ...
        <select class="mag-modal__select" id="mag-f-owner">
          ${K.owners.map(I=>`<option value="${k(I.guid)}"${I.guid===K.primaryOrgGuid?" selected":""}>${k(I.name||I.guid)}</option>`).join("")}
        </select>`:""}
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${ri.map(I=>`<option value="${I.value}"${(e?e.trigger||"none":"on_load")===I.value?" selected":""}>${k(I.label)}</option>`).join("")}
        </select>
        ...
        <div class="mag-modal__sec">
          ...
          <select class="mag-modal__select" id="mag-f-font">${yi(e?.font||"")}</select>
    ...
    </div>`,document.body.appendChild(m),requestAnimationFrame(()=>{m.classList.add("open"),m.querySelector(".mag-modal").classList.add("open")});const w=[...m.querySelectorAll(".mag-modal__navitem")],C=[...m.querySelectorAll(".mag-tab")],g=I=>{w.forEach(Y=>Y.classList.toggle("is-active",Y.dataset.tab===I)),C.forEach(Y=>{Y.hidden=Y.dataset.tab!==I}),m.querySelector(".mag-modal__body").scrollTop=0};w.forEach(I=>I.addEventListener("click",()=>g(I.dataset.tab)));const h=()=>Vt({...e,...$t(m),...a?{steps:Ma()}:{}}),f=m.querySelector("#mag-preview-pane"),E=()=>window.matchMedia("(min-width: 1200px)").matches;let L=null;const F=()=>{if(!L&&E())try{L=ei(f,h)}catch{}};let W=null;const j=()=>{E()&&(F(),L&&(clearTimeout(W),W=setTimeout(()=>{try{L.refresh()}catch{}},300)))},te=window.matchMedia("(min-width: 1200px)"),ce=()=>{E()&&(F(),j())};te.addEventListener("change",ce);let Q=!1;const ve=m.querySelector(".mag-modal__main");ve.addEventListener("input",()=>{Q=!0,j()}),ve.addEventListener("change",()=>{Q=!0,j()});const he=()=>{clearTimeout(W),te.removeEventListener("change",ce),L&&L.destroy&&L.destroy(),m.classList.remove("open"),setTimeout(()=>m.remove(),180),document.removeEventListener("keydown",$)},x=()=>{Q&&!confirm("Discard your changes to this magnet?")||he()};function $(I){I.key==="Escape"&&(I.preventDefault(),x())}document.addEventListener("keydown",$),m.querySelector(".mag-modal__close").addEventListener("click",x),m.querySelector('[data-x="cancel"]').addEventListener("click",x),m.querySelector("#mag-f-name").focus();const de=m.querySelector("#mag-flow-panel");a?Wr(de,e,()=>{Q=!0,j()}):de.innerHTML='<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>',t&&g(t),F(),m.querySelectorAll(".mag-cta").forEach(I=>{const Y=I.querySelector(".mag-cta__on"),u=I.querySelector(".mag-cta__val"),_=I.querySelector(".mag-cta__opts");Y.addEventListener("change",()=>{u&&(u.disabled=!Y.checked),_&&(_.disabled=!Y.checked),Y.checked&&(u||_)?.focus()}),u&&u.addEventListener("input",()=>{u.value.trim()&&!Y.checked&&(Y.checked=!0,_&&(_.disabled=!1))})});const Je=m.querySelector("#mag-f-surface-on"),St=m.querySelector("#mag-f-surface");Je.addEventListener("change",()=>St.hidden=!Je.checked);const Oe=m.querySelector("#mag-f-inline-size");m.querySelectorAll('input[name="mag-display"]').forEach(I=>I.addEventListener("change",()=>{Oe.hidden=m.querySelector('input[name="mag-display"]:checked')?.value!=="inline"})),m.querySelector('[data-x="preview"]')?.addEventListener("click",()=>Gn(()=>Vt({...e,...$t(m),...a?{steps:Ma()}:{}}))),m.querySelector('[data-x="save"]').addEventListener("click",async I=>{const Y=I.currentTarget,u=m.querySelector("#mag-f-error"),_=m.querySelector("#mag-f-name").value.trim();if(!_){g("basics"),u.textContent="Please give your magnet a name.";return}const N=m.querySelector("#mag-f-domains").value.split(",").map(G=>G.trim()).filter(Boolean);let P="";if(m.querySelectorAll(".mag-cta").forEach(G=>{if(G.dataset.kind!=="value")return;const Xe=G.querySelector(".mag-cta__on").checked,Re=G.querySelector(".mag-cta__val").value.trim();Xe&&!Re&&(P=P||`Add a target for the ${qn[G.dataset.type].label} button, or uncheck it.`)}),P){g("welcome"),u.textContent=P;return}const R=jn(m);if(R.enabled&&!Object.keys(R.b).length){g("ab"),u.textContent="Give variant B at least one change (title, welcome, or color), or untick the A/B test.";return}if(a){const G=Jr();if(G){g("flow"),Xr(G.route,G.message);return}}const ae={name:_,domains:N,...$t(m)};n&&(ae.owner_guid=m.querySelector("#mag-f-owner").value),Y.disabled=!0,u.textContent="";try{const G=a?`${xe()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${xe()}/m5t/v5/magnets`,Re=await(await fetch(G,{method:a?"PATCH":"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(ae)})).json().catch(()=>({}));if(!Re.ok)throw new Error(Re.message||"Save failed");a&&await Qr(e.guid),Le(a?"Magnet updated":"Magnet created","success"),he(),await Et()}catch(G){Y.disabled=!1,u.textContent=G.message||"Something went wrong."}})}const wi=Object.freeze(Object.defineProperty({__proto__:null,init:mi,render:ui},Symbol.toStringTag,{value:"Module"}));let Ua=!1;const b={leads:[],magnetNames:{},filter:"ALL",canManage:!1,book:!1,ownerNames:{},clientFilter:"ALL",search:"",shown:100,selectedId:null},Ye=100,Yt=["NEW","WORKING","QUALIFIED","UNQUALIFIED","CONVERTED","EXPORTED"],xi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},M=e=>String(e??"").replace(/[&<>"']/g,t=>xi[t]),pt=(e,t="info")=>{try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}},ut=()=>S.getConfig?.().BASE_URL||"",mt=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",Yn=e=>(mt(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase(),oa=e=>e.created?.created_tz||"";function Be(e){const t=oa(e);if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric"})}catch{return""}}function Ei(e){const t=oa(e);if(!t)return"";try{const a=Date.now()-new Date(t).getTime();if(a<0)return Be(e);const n=a/36e5;return n<1?`${Math.max(1,Math.floor(a/6e4))}m ago`:n<24?`${Math.floor(n)}h ago`:n<48?"Yesterday":Be(e)}catch{return Be(e)}}const Si=e=>{const t=oa(e);if(!t)return!1;try{return Date.now()-new Date(t).getTime()<24*36e5}catch{return!1}};function Ai(){if(Ua)return;const e=document.createElement("style");e.id="m5t-leads-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ua=!0}function We(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function ki(e){return`<select class="leads-status" data-id="${M(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${Yt.map(t=>`<option value="${t}" ${e.status===t?"selected":""}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join("")}
  </select>`}function Ti(e){const t=b.magnetNames[e.magnet_guid]||e.lead_source||"—",a=e.phone?String(e.phone).replace(/[^\d+]/g,""):"";return`
    <tr class="leads-row${String(e.id)===b.selectedId?" selected":""}" data-id="${M(e.id)}" tabindex="0" role="button" aria-label="Open lead ${M(mt(e))}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${M(Yn(e))}</span>
          <span><span class="leads-name">${M(mt(e))}</span>${e.company?`<span class="leads-sub">${M(e.company)}</span>`:""}</span>
        </span>
      </td>
      ${b.book?`<td>${yn(b.ownerNames[e.owner_guid]||"")||'<span class="leads-muted">—</span>'}</td>`:""}
      <td>
      ...
      <td class="num leads-muted" style="white-space:nowrap" title="${M(Be(e))}">${Si(e)?'<span class="leads-fresh" title="Captured in the last 24 hours"></span>':""}${M(Ei(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}const Wn=e=>b.clientFilter==="ALL"||e.owner_guid===b.clientFilter;function Ci(e){const t=b.search.trim().toLowerCase();if(!t)return!0;const a=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,b.magnetNames[e.magnet_guid],b.book?b.ownerNames[e.owner_guid]:""].filter(Boolean).join(" ").toLowerCase();return t.split(/\s+/).every(n=>a.includes(n))}function Kn(){return b.leads.filter(e=>(b.filter==="ALL"||e.status===b.filter)&&Wn(e)&&Ci(e))}const Jn=()=>We("touch_app","Click to see lead information.");function Ii(){Ai(),bt();const e=se();return`
    <div class="page-shell" data-section="leads">
      ...
      <div class="dashboard-card" style="margin-bottom:24px">
        ...
        <div class="card-body" id="pf-picker-body">${We("hourglass_empty","Loading…")}</div>
      </div>`:""}
      <div class="page-header">
        <div class="page-header-text">
      ...
      <div class="leads-layout">
        <div class="dashboard-card">
          <div class="card-body" id="leads-body">
            ${We("hourglass_empty","Loading leads…")}
          </div>
        </div>
        <aside class="dashboard-card leads-panel" aria-label="Lead detail">
          <div class="card-body" id="leads-panel-body">${Jn()}</div>
        </aside>
      </div>
    </div>`}async function Li(){if(document.getElementById("leads-export")?.addEventListener("click",Ri),se()){const e=t=>Number(t||0).toLocaleString();yt(ut(),[{h:"Leads · wk",td:t=>e(t.leads.this_week)},{h:"Leads · total",td:t=>e(t.leads.total)},{h:"Compl.",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Ni()}async function Ni(){const e=document.getElementById("leads-body");if(e){try{const[t,a]=await Promise.all([fetch(`${ut()}/m5t/v5/m5mLead`),fetch(`${ut()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(b.leads=(n.data||[]).filter(o=>!["DELETED","ARCHIVED"].includes(o.status)),b.book=se(),b.ownerNames=b.book?bn():{},a){const o=await a.json().catch(()=>({}));b.magnetNames={},(o.magnets||[]).forEach(s=>{b.magnetNames[s.guid]=s.name,s.owner_guid&&s.owner_name&&!b.ownerNames[s.owner_guid]&&(b.ownerNames[s.owner_guid]=s.owner_name)}),b.canManage=!!o.canManage}}catch{e.innerHTML=We("error","Could not load your leads. Please try again.");return}gt()}}const $i=()=>`
  <colgroup>
    <col style="width:23%">
  ...
  </colgroup>`;function gt(){const e=document.getElementById("leads-body"),t=document.getElementById("leads-export");if(!e)return;if(t&&(t.style.display=b.leads.length?"":"none"),!b.leads.length){e.innerHTML=We("inbox","No leads captured yet. Publish a magnet and share it to start collecting.");return}const a=b.leads.filter(Wn),n={ALL:a.length};Yt.forEach(s=>{n[s]=a.filter(r=>r.status===s).length});const o=b.book?[...new Set(b.leads.map(s=>s.owner_guid).filter(Boolean))].map(s=>({guid:s,name:b.ownerNames[s]||s})).sort((s,r)=>s.name.localeCompare(r.name)):[];e.innerHTML=`
    <div class="leads-bar">
      <div class="leads-filter">
        ${["ALL",...Yt].map(s=>`<button data-filter="${s}" class="${b.filter===s?"active":""}">${s==="ALL"?"All":s[0]+s.slice(1).toLowerCase()}${n[s]?`<span class="leads-pillnum">${n[s]}</span>`:""}</button>`).join("")}
      </div>
      ${b.book&&o.length>1?`
    ...
    <div id="leads-tablezone"></div>`,e.querySelector(".leads-filter")?.addEventListener("click",s=>{const r=s.target.closest("[data-filter]");r&&(b.filter=r.dataset.filter,b.shown=Ye,gt())}),e.querySelector("#leads-clientsel")?.addEventListener("change",s=>{b.clientFilter=s.target.value,b.shown=Ye,gt()}),e.querySelector("#leads-search")?.addEventListener("input",s=>{b.search=s.target.value,b.shown=Ye,Wt()}),Wt()}function Wt(){const e=document.getElementById("leads-tablezone"),t=document.getElementById("leads-countlbl");if(!e)return;const a=Kn(),n=a.slice(0,b.shown),o=b.book?8:7;t&&(t.textContent=`${a.length} of ${b.leads.length}`),e.innerHTML=`
    <div class="leads-tablewrap">
      <table class="leads-table">
        ...
        <tbody id="leads-tbody">${n.map(Ti).join("")||`<tr><td colspan="${o}"><div class="leads-muted" style="padding:14px 4px">${b.search.trim()?"No leads match your search.":`No ${b.filter.toLowerCase()} leads.`}</div></td></tr>`}</tbody>
      </table>
    </div>
    ${a.length>b.shown?`<button class="leads-more" type="button" id="leads-more">Show ${Math.min(Ye,a.length-b.shown)} more (${a.length-b.shown} remaining)</button>`:""}`,e.querySelector("#leads-more")?.addEventListener("click",()=>{b.shown+=Ye,Wt()}),e.querySelector("#leads-tbody")?.addEventListener("change",Oi),e.querySelector("#leads-tbody")?.addEventListener("click",s=>{if(s.target.closest(".leads-status, a.leads-contactlink"))return;const r=s.target.closest(".leads-row");r&&Ha(r.dataset.id)}),e.querySelector("#leads-tbody")?.addEventListener("keydown",s=>{if(s.key!=="Enter"&&s.key!==" ")return;const r=s.target.closest(".leads-row");r&&s.target===r&&(s.preventDefault(),Ha(r.dataset.id))})}async function Oi(e){const t=e.target.closest(".leads-status");if(!t)return;const a=t.dataset.id,n=b.leads.find(r=>String(r.id)===String(a)),o=t.value,s=n?.status;try{if(!(await(await fetch(`${ut()}/m5t/v5/m5mLead/${encodeURIComponent(a)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:o})})).json().catch(()=>({}))).ok)throw new Error;n&&(n.status=o),pt(`Marked ${o[0]}${o.slice(1).toLowerCase()}`,"success"),String(a)===b.selectedId&&Xn(),b.filter!=="ALL"&&gt()}catch{t.value=s||"NEW",pt("Could not update status","danger")}}function Ha(e){b.selectedId=String(e),document.querySelectorAll(".leads-row").forEach(t=>t.classList.toggle("selected",t.dataset.id===b.selectedId)),Xn()}function Xn(){const e=document.getElementById("leads-panel-body");if(!e)return;const t=b.leads.find(o=>String(o.id)===b.selectedId);if(!t){e.innerHTML=Jn();return}const a=b.magnetNames[t.magnet_guid]||t.lead_source||"—",n=(o,s)=>s?`<div class="leads-det__field"><span class="leads-det__k">${M(o)}</span><span class="leads-det__v">${M(s)}</span></div>`:"";e.innerHTML=`
    <div class="leads-det__head">
      <span class="leads-avatar leads-det__ava">${M(Yn(t))}</span>
      <div>
        <div class="leads-det__name">${M(mt(t))}</div>
    ...
    ${t.description?`<div class="leads-det__notes">${M(t.description)}</div>`:""}`}function Ri(){const e=Kn();if(!e.length){pt("Nothing to export","info");return}const t=["first_name","last_name","email","phone","company","product_interest","lead_source","utm_source","utm_medium","utm_campaign","gclid","status"],a=l=>`"${String(l??"").replace(/"/g,'""')}"`,o=[[...b.book?["client"]:[],...t,"magnet","captured"].join(",")];for(const l of e)o.push([...b.book?[a(b.ownerNames[l.owner_guid]||"")]:[],...t.map(c=>a(l[c])),a(b.magnetNames[l.magnet_guid]||l.lead_source||""),a(Be(l))].join(","));const s=new Blob([o.join(`
`)],{type:"text/csv"}),r=URL.createObjectURL(s),i=document.createElement("a");i.href=r,i.download=`leads-${b.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r),pt(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const Mi=Object.freeze(Object.defineProperty({__proto__:null,init:Li,render:Ii},Symbol.toStringTag,{value:"Module"})),Qn=()=>S.getConfig?.().BASE_URL||"",za=e=>e.toISOString().slice(0,10),Ga=e=>e==null?"—":"$"+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),De=e=>Number(e||0).toLocaleString(),Fi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},et=e=>String(e??"").replace(/[&<>"']/g,t=>Fi[t]);let Va=!1;function Pi(){if(Va)return;const e=document.createElement("style");e.id="m5t-adperf-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Va=!0}const Ue=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,tt=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
  ...
  </div>`,Di=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let ht=30;function Zn(){return se()?Zt({section:"ad-performance",title:"Ad Performance",description:"Pick a client to view their spend and lead performance."}):(Pi(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${Di.map(e=>`<button class="chart-period-btn${e.d===ht?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>

      <div class="stats-grid">
        ${tt("payments","Ad Spend","adperf-spend")}
        ${tt("ads_click","Clicks","adperf-clicks")}
        ${tt("person_add","Magnet Leads","adperf-leads")}
        ${tt("request_quote","Cost / Lead","adperf-cpl")}
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-body">
          ${Ue("hourglass_empty","Loading ad performance…")}
        </div>
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-sources">
          ${Ue("hourglass_empty","Loading…")}
        </div>
      </div>
    </div>`)}async function eo(){if(se()){const t=a=>Number(a||0).toLocaleString();return yt(Qn(),[{h:"Spend",td:a=>a.ad?`$${t(a.ad.spend)}`:"—"},{h:"Clicks",td:a=>a.ad?t(a.ad.clicks):"—"},{h:"Leads",td:a=>t(a.leads.window??a.leads.total)},{h:"CPL",td:a=>a.ad?.cost_per_lead!=null?`$${t(a.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see spend here."})}const e=document.getElementById("adperf-periods");e?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(ht=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===ht)),qa())}),await qa()}async function qa(){const e=Qn(),t=document.getElementById("adperf-body"),a=document.getElementById("adperf-range"),n=new Date,o=za(n),s=za(new Date(n.getTime()-(ht-1)*864e5));a&&(a.textContent=`${s} → ${o}`);let r,i=[],l=null;try{const[v,y,m]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${s}&to=${o}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${s}&to=${o}`)]);if(!v.ok)throw new Error(`HTTP ${v.status}`);r=await v.json(),i=((await y.json().catch(()=>({})))?.data||[]).filter(C=>C.status!=="DELETED"),l=await m.json().catch(()=>null)}catch(v){console.warn("[ad-performance] load failed:",v),t&&(t.innerHTML=Ue("error","Could not load ad performance. Please try again."));return}const c=r.totals||{};if(at("adperf-spend",Ga(c.spend)),at("adperf-clicks",De(c.clicks)),at("adperf-leads",De(c.magnet_leads)),at("adperf-cpl",Ga(c.cost_per_lead)),Bi(l),!i.length){t.innerHTML=Ue("link_off","No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.");return}if(!r.connected){t.innerHTML=Ue("cloud_sync","Account connected. No ad data for this range yet. Metrics appear here once they sync.");return}t.innerHTML=Ui(r.rows||[])}function Bi(e){const t=document.getElementById("adperf-sources"),a=document.getElementById("adperf-src-summary");if(!t)return;const n=e&&Array.isArray(e.rows)?e.rows:[];if(!n.length){a&&(a.textContent=""),t.innerHTML=Ue("search_off","No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.");return}const o=e.total_leads||n.reduce((i,l)=>i+(l.leads||0),0),s=e.tracked_leads||0;a&&(a.textContent=`${De(s)} of ${De(o)} leads tagged to a source`);const r=i=>i.campaign&&i.campaign!=="(none)"?et(i.campaign):i.source&&i.source!=="(direct)"?et(i.source):'<span class="adperf-src-untracked">Untracked / direct</span>';t.innerHTML=`
    ...
    </div>`}function at(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}function ja(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}function Ya(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e)}function Ui(e){const w=e.length||1,C=ja(Math.max(1,...e.map(x=>x.spend||0))),g=ja(Math.max(1,...e.map(x=>x.magnet_leads||0))),h=738/w,f=Math.min(24,h*.55),E=x=>56+h*(x+.5),L=x=>304-x/C*282,F=x=>304-x/g*282,W=[0,.25,.5,.75,1].map(x=>{const $=304-x*282;return`<line x1="56" y1="${$.toFixed(1)}" x2="794" y2="${$.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${($+3.5).toFixed(1)}" text-anchor="end" class="ax">$${Ya(C*x)}</text><text x="802" y="${($+3.5).toFixed(1)}" text-anchor="start" class="ax">${Ya(g*x)}</text>`}).join(""),j=e.map((x,$)=>{const de=L(x.spend||0);return`<rect x="${(E($)-f/2).toFixed(1)}" y="${de.toFixed(1)}" width="${f.toFixed(1)}" height="${Math.max(0,304-de).toFixed(1)}" rx="3" fill="#0072BA"><title>${x.date}: $${x.spend} spend</title></rect>`}).join(""),te=e.map((x,$)=>`${E($).toFixed(1)},${F(x.magnet_leads||0).toFixed(1)}`).join(" "),ce=w>1?`<polyline points="${te}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",Q=e.map((x,$)=>`<circle cx="${E($).toFixed(1)}" cy="${F(x.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${x.date}: ${x.magnet_leads} leads</title></circle>`).join(""),ve=Math.max(1,Math.ceil(w/6)),he=e.map((x,$)=>$%ve===0||$===w-1?`<text x="${E($).toFixed(1)}" y="326" text-anchor="middle" class="ax">${x.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="adperf-chart" viewBox="0 0 840 340" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Ad spend versus magnet leads over time">
      ${W}${j}${ce}${Q}${he}
    </svg>`}const Hi={render:Zn,init:eo},zi=Object.freeze(Object.defineProperty({__proto__:null,default:Hi,init:eo,render:Zn},Symbol.toStringTag,{value:"Module"})),Wa="reseller_org",to="managed_client";let Ka=!1;const Gi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},z=e=>String(e??"").replace(/[&<>"']/g,t=>Gi[t]);function ft(e,t="info"){try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}}function Vi(){const e=S.getActiveOrg();if(e&&e.channel===Wa)return{guid:e.guid,name:e.name};const t=S.getMemberships().find(a=>a.channel===Wa);return t?{guid:t.orgGuid,name:t.name}:null}function qi(e){const t=e?.created_tz;if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function ji(){if(Ka)return;const e=document.createElement("style");e.id="m5t-clients-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ka=!0}const Yi=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function st(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Wi(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
    <div class="client-row">
      <span class="client-row__avatar">${z(Yi(t))}</span>
      <span class="client-row__main">
        <div class="client-row__name" title="${z(t)}">${z(t)}</div>
        <div class="client-row__meta">Added ${z(qi(e.created))||"—"}</div>
      </span>
    ...
    </div>`}async function no(){const e=Vi();document.getElementById("clients-add-btn")?.addEventListener("click",()=>Ki(e)),await oo(e)}async function oo(e){const t=document.getElementById("clients-body"),a=document.getElementById("clients-count");if(t){if(!e?.guid){t.innerHTML=st("info","Client provisioning is available to reseller / agency accounts."),a&&(a.textContent="");return}try{const n=S.getConfig?.().BASE_URL||"",o=await fetch(`${n}/m5t/v5/acctGroup`);if(!o.ok)throw new Error(`HTTP ${o.status}`);const s=await o.json(),i=(Array.isArray(s?.data)?s.data:[]).filter(l=>l.class===to&&(!l.parent||l.parent===e.guid));if(!i.length){t.innerHTML=st("group_off","No clients yet. Add your first client to start managing magnets on their behalf."),a&&(a.textContent="");return}t.innerHTML=`<div class="client-list">${i.map(Wi).join("")}</div>`,a&&(a.textContent=`${i.length} client${i.length===1?"":"s"}`),t.querySelectorAll(".client-card__invite").forEach(l=>{l.addEventListener("click",()=>{l.dataset.action==="adaccounts"?Ji(l.dataset.clientGuid,l.dataset.clientName):Xi(l.dataset.clientGuid,l.dataset.clientName)})})}catch(n){console.warn("[clients] load failed:",n),t.innerHTML=st("error","Couldn’t load clients. Please try again."),a&&(a.textContent="")}}}function Ki(e){if(!e?.guid){ft("Only reseller / agency accounts can add clients.","error");return}const t=document.createElement("div");t.className="client-modal-scrim";const a=document.createElement("div");a.className="client-modal",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
    ...
    <div class="client-modal__body" id="invite-body">
      ...
      <div class="client-modal__actions">
        ...
        </div>`;const f=n.querySelector("#inv-link");n.querySelector("#inv-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(f.value),n.querySelector("#inv-copy").textContent="Copied!"}catch{f.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",o)}catch(C){console.warn("[clients] invite failed:",C),i.textContent=C.message||"Something went wrong. Please try again.",l.disabled=!1,l.innerHTML=w}})}const Qi={render:ao,init:no},Zi=Object.freeze(Object.defineProperty({__proto__:null,default:Qi,init:no,render:ao},Symbol.toStringTag,{value:"Module"})),Xa="managed_client";let Qa=!1;const el={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Z=e=>String(e??"").replace(/[&<>"']/g,t=>el[t]),Za=(e,t="info")=>{try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}},tl=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function al(){const e=S.getActiveOrg();let t=e&&e.channel!==Xa?e:null;if(!t){const n=S.getMemberships().find(o=>o.channel!==Xa);n&&(t={guid:n.orgGuid,channel:n.channel,memberRole:n.memberRole})}if(!t)return null;const a=S.getMemberships().find(n=>n.orgGuid===t.guid)?.name;return{...t,name:a}}function nl(e){return Object.values(qe).filter(t=>Xo(e,t.value)).sort((t,a)=>a.rank-t.rank)}function ol(){if(Qa)return;const e=document.createElement("style");e.id="m5t-team-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Qa=!0}function vt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function sl(e){const t=e.member_role||"member";return`
    <div class="team-row">
      <span class="team-avatar">${Z(tl(e.name||e.email))}</span>
      ...
      <span class="team-role" data-role="${Z(t)}">${Z(qe[t]?.label||t)}</span>
    </div>`}function so(){return ol(),`
    <div class="page-shell" data-section="team">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="team-body">
          ${vt("hourglass_empty","Loading team…")}
        </div>
      </div>
    </div>`}async function ro(){const e=al(),t=document.getElementById("team-invite-btn");if(!e){t&&(t.style.display="none"),document.getElementById("team-body").innerHTML=vt("info","Team management is available for agency and workspace accounts.");return}t?.addEventListener("click",()=>rl(e)),await io(e)}async function io(e){const t=document.getElementById("team-body"),a=document.getElementById("team-count");if(t)try{const n=S.getConfig?.().BASE_URL||"",[o,s]=await Promise.all([fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/members`),fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/invites`)]),r=(await o.json().catch(()=>({}))).members||[],i=(await s.json().catch(()=>({}))).invites||[],l=i.length?`
    ...
    <div class="team-modal__body" id="team-invite-body">
      ...
      <div class="team-modal__actions">
        ...
        </div>`;const h=n.querySelector("#tm-link");n.querySelector("#tm-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(h.value),n.querySelector("#tm-copy").textContent="Copied!"}catch{h.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",()=>{o(),io(e)})}catch(w){console.warn("[team] invite failed:",w),r.textContent=w.message||"Something went wrong. Please try again.",i.disabled=!1,i.innerHTML=m}})}const il={render:so,init:ro},ll=Object.freeze(Object.defineProperty({__proto__:null,default:il,init:ro,render:so},Symbol.toStringTag,{value:"Module"}));
