...
`,t)}function fr(){if(!ra())return ba.stubThis(new Promise(t=>t(!1)));const e=globalThis.PublicKeyCredential;return e?.isConditionalMediationAvailable===void 0?ba.stubThis(new Promise(t=>t(!1))):ba.stubThis(e.isConditionalMediationAvailable())}const ba={stubThis:e=>e};function rd({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new fe({message:"Authentication ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else{if(e.name==="NotAllowedError")return new fe({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if(gr(n)){if(a.rpId!==n)return new fe({message:`The RP ID "${a.rpId}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new fe({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="UnknownError")return new fe({message:"The authenticator was unable to process the specified options, or could not create a new assertion signature",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}async function id(e){!e.optionsJSON&&e.challenge&&(console.warn("startAuthentication() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useBrowserAutofill:a=!1,verifyBrowserAutofillInput:n=!0}=e;if(!ra())throw new Error("WebAuthn is not supported in this browser");let o;t.allowCredentials?.length!==0&&(o=t.allowCredentials?.map(mr));const s={...t,challenge:ea(t.challenge),allowCredentials:o},r={};if(a){if(!await fr())throw Error("Browser does not support WebAuthn autofill");if(document.querySelectorAll("input[autocomplete$='webauthn']").length<1&&n)throw Error('No <input> with "webauthn" as the only or last value in its `autocomplete` attribute was detected');r.mediation="conditional",s.allowCredentials=[]}r.publicKey=s,r.signal=Kn.createNewAbortSignal();let i;try{i=await navigator.credentials.get(r)}catch(g){throw rd({error:g,options:r})}if(!i)throw new Error("Authentication was not completed");const{id:l,rawId:c,response:u,type:b}=i;let d;return u.userHandle&&(d=Fe(u.userHandle)),{id:l,rawId:Fe(c),response:{authenticatorData:Fe(u.authenticatorData),clientDataJSON:Fe(u.clientDataJSON),signature:Fe(u.signature),userHandle:d},type:b,clientExtensionResults:i.getClientExtensionResults(),authenticatorAttachment:hr(i.authenticatorAttachment)}}function ld(){return ra()?PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable():new Promise(e=>e(!1))}const vr=Object.freeze(Object.defineProperty({__proto__:null,WebAuthnAbortService:Kn,WebAuthnError:fe,_browserSupportsWebAuthnAutofillInternals:ba,_browserSupportsWebAuthnInternals:ur,base64URLStringToBuffer:ea,browserSupportsWebAuthn:ra,browserSupportsWebAuthnAutofill:fr,bufferToBase64URLString:Fe,platformAuthenticatorIsAvailable:ld,startAuthentication:id,startRegistration:sd},Symbol.toStringTag,{value:"Module"}));let Io=!1;function cd(){if(Io)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Io=!0}function dd(){const e=new URLSearchParams(window.location.search||"");let t=e.get("uid")||"",a=e.get("token")||"";if(!t||!a){const n=window.location.hash||"",o=n.includes("?")?n.slice(n.indexOf("?")+1):"",s=new URLSearchParams(o);if(t=t||s.get("uid")||"",a=a||s.get("token")||"",!t||!a){const r=n.replace(/^#\/?/,"").split("?")[0].split("/").filter(Boolean);t=t||r[1]||"",a=a||r[2]||""}}try{return{uid:decodeURIComponent(t),token:decodeURIComponent(a)}}catch{return{uid:t,token:a}}}function br(){return cd(),`
    ...
    </a>`}const bd={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},we=e=>String(e??"").replace(/[&<>"']/g,t=>bd[t]);function Ye(e){if(!e)return"";try{return new Date(e).toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}catch{return String(e)}}function _d(e,t={}){const a=t[e.id];if(e.type==="checkbox_group"){const n=Array.isArray(a)?a:[];return n.length?we(n.join(", ")):""}return a?we(a):""}function Jn(e,{emptyLabel:t="(blank)",renderAnswer:a=null}={}){const n=e?.questionnaire?.sections||[],o=e?.answers||{};return n.length?n.map(s=>`
  ...
  `,document.head.appendChild(e),Xn(),No=!0}function Er(){return E.getConfig?.().BASE_URL||""}function Ed(e){const t=`qf-${e.id}`;if(e.type==="checkbox_group"){const a=Array.isArray(e.options)?e.options:[];return`
    ...
    </div></div>`;const u=[...e.querySelectorAll(".qf-section[data-step]")],b=[...e.querySelectorAll(".qf-dot")],d=document.getElementById("qf-back"),g=document.getElementById("qf-next"),f=document.getElementById("qf-submit"),p=document.getElementById("qf-progress-label");let v=0;function x(I,j=1){v=Math.max(0,Math.min(s.length-1,I)),u.forEach((Q,ae)=>{Q.hidden=ae!==v,Q.classList.remove("qf-enter")});const J=u[v];J&&(J.style.setProperty("--qf-dx",`${j>=0?14:-14}px`),J.offsetWidth,J.classList.add("qf-enter")),b.forEach((Q,ae)=>{ae===v?Q.setAttribute("aria-current","step"):Q.removeAttribute("aria-current")}),p&&(p.textContent=`Section ${v+1} of ${s.length}`),d.style.visibility=v===0?"hidden":"",g.style.display=v===s.length-1?"none":"",f.style.display=v===s.length-1?"":"none",e.querySelector(".qf-card")?.scrollIntoView({block:"start"})}d.addEventListener("click",()=>x(v-1,-1)),g.addEventListener("click",()=>x(v+1,1)),b.forEach(I=>I.addEventListener("click",()=>{const j=Number(I.dataset.step)||0;x(j,j>=v?1:-1)})),x(0),e.querySelectorAll("[data-question-id]").forEach(I=>{const j=I.dataset.questionId,J=I.dataset.questionType,Q=r[j];if(Q!=null)if(J==="checkbox_group"){const ae=Array.isArray(Q)?Q:[];I.querySelectorAll('input[type="checkbox"]').forEach(ge=>{ge.checked=ae.includes(ge.value)})}else{const ae=I.querySelector("input,textarea");ae&&(ae.value=Q)}});const w=document.getElementById("qf-form"),$=document.getElementById("qf-submit"),O=document.getElementById("qf-msg"),U=(I,j="error")=>{O.textContent=I,O.className=`qf-msg ${j}`};w.addEventListener("submit",async I=>{I.preventDefault();const j=xr(e),J=`${Er()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(a.guid)}`,Q=o?`${J}?token=${encodeURIComponent(a.token)}`:`${J}/submit?token=${encodeURIComponent(a.token)}`;$.disabled=!0,U(o?"Saving…":"Submitting…","ok");let ae;try{ae=await fetch(Q,{method:o?"PUT":"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({answers:j})});const ge=await ae.json().catch(()=>({}));if(!ae.ok||!ge.ok){if(ae.status===423){U(ge.error||"These answers are now locked.","error"),await ja();return}const B=ae.status===409?o?"This questionnaire is not open for changes.":"This questionnaire has already been submitted.":ae.status===404?"This link is invalid or has expired.":ge.error||`Could not ${o?"save":"submit"} (HTTP ${ae.status}).`;U(B),$.disabled=!1;return}Td(e,o,ge.data?.editability?.deadline)}catch(ge){console.error(`[questionnaire-fill] ${o?"edit":"submit"} error:`,ge),U("Something went wrong. Please try again."),$.disabled=!1}})}function Td(e,t,a){const n=a?` until ${Ye(a)}`:"";e.innerHTML=`
    <div class="qf-page"><div class="qf-card"><div class="qf-state">
    ...
    <tbody>${e.map(a=>`
      <tr data-org="${Qe(a.owner_guid)}" tabindex="0" role="button"
        ...
        <td><span class="dc-name">${Qe(a.name||a.owner_guid)}
          <span class="dc-chip">${Qe(rp[a.channel]||a.channel||"")}</span></span></td>
  ...
  `,document.head.appendChild(e),Ko=!0}const La=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Jo=(e,t,a)=>`
  <div class="settings-section__head">
    ...
    <div class="page-shell" data-section="settings-workspace">
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ${Jo("apartment","Organization","Name and details.")}
      ...
      ${a}
      <div style="margin-top:12px">${Qo()}</div>`;return}e.innerHTML=`
    <div class="settings-field">
    ...
    ${o?'<div class="ws-team-actions"><a class="btn btn-secondary" href="#/team">Manage team</a></div>':""}`}const Jp={render:Vr,init:Wr},Qp=Object.freeze(Object.defineProperty({__proto__:null,default:Jp,init:Wr,render:Vr},Symbol.toStringTag,{value:"Module"})),Xp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Pe=e=>String(e??"").replace(/[&<>"']/g,t=>Xp[t]),Se=(e,t="info")=>{try{m.publish(h.UI_TOAST,{message:e,type:t})}catch{}},_t=()=>E.getConfig?.().BASE_URL||"",Zp=e=>or(e),ta=5,Ee={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},Tn=()=>E.getActiveOrg()?.guid||E.getMemberships()[0]?.orgGuid||null;let Zo=!1;function eu(){if(Zo)return;const e=document.createElement("style");e.id="m5t-notif-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Zo=!0}const ao=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Yr(){return eu(),xt(),ie()?Et({section:"settings-notifications",title:"Notifications",description:"Pick a client to manage their lead alerts."}):`
    ...
    </div>`}async function Kr(){if(ie()){const e=t=>Number(t||0).toLocaleString();return nt(_t(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Promise.all([tu(),Jr()])}async function Jr(){const e=Tn();if(e)try{const t=await fetch(`${_t()}/m5t/v5/acctGroup/${encodeURIComponent(e)}/webhook`);if(t.status===403){Ee.webhookAllowed=!1;return}const a=await t.json().catch(()=>({}));if(!a.ok)return;Ee.webhook=a.webhook,Qr()}catch{}}function es(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function Qr(){const e=document.getElementById("ntf-wh-card"),t=document.getElementById("ntf-wh-body");if(!e||!t)return;e.style.display="";const a=Ee.webhook,n=a?.last_delivery;t.innerHTML=`
    <div class="ntf-wh">
    ...
    </div>`,t.querySelector("#ntf-wh-save")?.addEventListener("click",async()=>{const o=t.querySelector("#ntf-wh-url")?.value.trim()||"",s=t.querySelector("#ntf-wh-secret")?.value??"",r={uri:o};s.trim()!==""&&(r.secret=s.trim());try{const i=await fetch(`${_t()}/m5t/v5/acctGroup/${encodeURIComponent(Tn())}/webhook`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),l=await i.json().catch(()=>({}));if(!i.ok||!l.ok)throw new Error(l.error||`Failed (HTTP ${i.status})`);Ee.webhook=l.webhook,Se(o?"Webhook saved":"Webhook removed","success"),Qr()}catch(i){Se(i.message||"Could not save","danger")}}),t.querySelector("#ntf-wh-test")?.addEventListener("click",async o=>{const s=o.currentTarget;s.disabled=!0;try{const r=await fetch(`${_t()}/m5t/v5/acctGroup/${encodeURIComponent(Tn())}/webhook-test`,{method:"POST"}),i=await r.json().catch(()=>({}));r.ok&&i.ok?Se("Test delivery sent","success"):Se(i.error||"Could not deliver the test","danger")}catch{Se("Could not deliver the test","danger")}finally{s.disabled=!1}try{await Jr()}catch(r){console.warn("[notifications] loadWebhook refresh failed:",r)}})}async function tu(){const e=document.getElementById("ntf-body");if(e){try{const a=await(await fetch(`${_t()}/m5t/v5/magnets`)).json().catch(()=>({}));if(!a.ok)throw new Error(a.message||"Failed to load");Ee.magnets=(a.magnets||[]).filter(n=>n.status!=="ARCHIVED"),Ee.canManage=!!a.canManage}catch(t){console.warn("[notifications] load failed:",t),e.innerHTML=ao("error","Could not load your magnets. Please try again.");return}Xr()}}function au(e){const t=Array.isArray(e.notify_emails)?e.notify_emails:[],a=t.length>0;return`
  ...
  `,document.head.appendChild(e),ss=!0}function ai(){return Ja(),xt(),ie()?Et({section:"settings-integrations",title:"Integrations",description:"Pick a client to manage their connections."}):`
  ...
  `,document.head.appendChild(e),cs=!0}const Qa=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function gi(){return am(),xt(),`
    <div class="page-shell" data-section="conversations">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="convs-body">
          ${Qa("hourglass_empty","Loading journeys…")}
        </div>
      </div>
    </div>`}async function hi(){await nm()}async function nm(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${In()}/m5t/v5/conversations`),fetch(`${In()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(X.conversations=n.conversations||[],X.counts=n.counts||{},X.book=ie(),a){const o=await a.json().catch(()=>({}));X.magnetNames={},X.magnetOwnerNames={};const s=X.book?Tr():{};(o.magnets||[]).forEach(r=>{X.magnetNames[r.guid]=r.name,X.book&&(X.magnetOwnerNames[r.guid]=r.owner_name||s[r.owner_guid]||"")})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=Qa("error","Could not load journeys. Please try again.");return}fi()}}function om(){return X.filter==="ALL"?X.conversations:X.conversations.filter(e=>e.status===X.filter)}function sm(e){const t=di(e.lead),a=X.magnetNames[e.magnet_guid]||"—",n=ls[e.status]||ls.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,s=(e.routes||[]).map(r=>Rn[r]||r).join(", ");return`
    <tr class="convs-row" data-session="${ue(e.session)}">
      ...
      ${X.book?`<td>${$r(X.magnetOwnerNames[e.magnet_guid]||"")||'<span class="convs-muted">—</span>'}</td>`:""}
    ...
    </tr>`}function fi(){const e=document.getElementById("convs-body");if(!e)return;if(!X.conversations.length){e.innerHTML=Qa("route","No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.");return}const t=om(),a=[["ALL","All"],["COMPLETED","Completed"],["IN_PROGRESS","In progress"],["ABANDONED","Abandoned"]];e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${a.map(([n,o])=>`<button data-filter="${n}" class="${X.filter===n?"active":""}">${o}${n!=="ALL"&&X.counts[n]?` (${fn(X.counts[n])})`:""}</button>`).join("")}
      </div>
      <span class="convs-count">${fn(t.length)} of ${fn(X.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(sm).join("")||`<tr><td colspan="${X.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${X.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(X.filter=o.dataset.filter,fi())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&im(o.dataset.session)})}const rm={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${Rn[e]||e}`:""}`,route:e=>`Picked ${Rn[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function im(e){const t=X.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${In()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=di(t.lead),o=X.magnetNames[t.magnet_guid]||"—",r=(a?.events||[]).filter((c,u,b)=>c.event!=="step"||!(b[u+1]&&b[u+1].event==="step")).map(c=>`
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      ...
      <div class="convs-drawer__body">
        ...
        ${r?`<div class="convs-tl">${r}</div>`:Qa("timeline","No timeline available for this journey.")}
      </div>
...
<body>
  ...
  `,document.head.appendChild(e),bs=!0}function Ti(e){return`<div class="pv-hintwrap">
    ...
    </div>`}const Jm=300*1e3;function Qm(e){to(bt.MAGNET_TEMPLATE,{id:e,at:Date.now()})}function Ri(e){if(!e)return null;if(typeof e=="string")return at.find(n=>n.id===e)||null;const{id:t,at:a}=e;return typeof a=="number"&&Date.now()-a>=Jm?null:at.find(n=>n.id===t)||null}function Xm(){return Ri(An(bt.MAGNET_TEMPLATE))}function Zm(){return Ri(cp(bt.MAGNET_TEMPLATE))}let ys=!1;function Ni(){if(ys)return;const e=document.createElement("style");e.id="m5t-mag-template-styles",e.textContent=`
...
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:Wi(e),actions:t,font:e.querySelector("#mag-f-font").value.trim(),theme_vars:qg(e),inline_width:e.querySelector("#mag-f-inline-w").value.trim(),inline_height:e.querySelector("#mag-f-inline-h").value.trim(),hide_launcher:e.querySelector("#mag-f-hide-launcher").checked,input_placeholder:e.querySelector("#mag-f-input-ph").value,summary_confirm_label:e.querySelector("#mag-f-summary-confirm").value.trim(),success_title:e.querySelector("#mag-f-success-title").value.trim(),success_text:e.querySelector("#mag-f-success-text").value,success_cta:Ug(e)}}const Mg=512,Pg=new Set(["image/png","image/jpeg","image/gif","image/webp"]),Fg=8*1024*1024;function Dg(e){return new Promise((t,a)=>{const n=new Image,o=new FileReader;o.onerror=()=>a(new Error("Could not read that file.")),o.onload=()=>{n.onerror=()=>a(new Error("That file isn’t a readable image.")),n.onload=()=>{const s=Math.min(1,Mg/Math.max(n.naturalWidth,n.naturalHeight)),r=Math.max(1,Math.round(n.naturalWidth*s)),i=Math.max(1,Math.round(n.naturalHeight*s)),l=document.createElement("canvas");l.width=r,l.height=i,l.getContext("2d").drawImage(n,0,0,r,i),t(l.toDataURL("image/png"))},n.src=o.result},o.readAsDataURL(e)})}function Bg(e,t){const a=e.querySelector("#mag-logo-drop");if(!a)return;const n=e.querySelector("#mag-f-logo-file"),o=e.querySelector("#mag-logo-browse"),s=e.querySelector("#mag-logo-remove"),r=e.querySelector("#mag-logo-preview"),i=e.querySelector("#mag-logo-status"),l=e.querySelector("#mag-f-logo"),c=(g,f)=>{i.textContent=g,i.style.color=f?"var(--color-danger, #DD4124)":""},u=g=>{r.innerHTML=g?`<img src="${_(g)}" alt="">`:'<span class="material-symbols-outlined" aria-hidden="true">image</span>',s.hidden=!g},b=g=>{l.value=g,l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))};async function d(g){if(!Pg.has(g.type)){c("PNG, JPEG, GIF, or WEBP only.",!0);return}if(g.size>Fg){c("That file is too large (8MB max before resizing).",!0);return}c("Uploading…",!1);try{const f=await Dg(g),p=await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({image:f})}),v=await p.json().catch(()=>({}));if(!p.ok||!v.ok)throw new Error(v.error||`Upload failed (${p.status})`);const x=`${W()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;b(x),u(x),c("Logo updated.",!1)}catch(f){c(f.message||"Upload failed.",!0)}}n.addEventListener("change",()=>{n.files[0]&&d(n.files[0]),n.value=""}),a.addEventListener("click",g=>{g.target===s||s.contains(g.target)||g.target!==o&&n.click()}),o.addEventListener("click",()=>n.click()),["dragenter","dragover"].forEach(g=>a.addEventListener(g,f=>{f.preventDefault(),a.classList.add("is-dragover")})),["dragleave","drop"].forEach(g=>a.addEventListener(g,f=>{f.preventDefault(),a.classList.remove("is-dragover")})),a.addEventListener("drop",g=>{const f=g.dataTransfer?.files?.[0];f&&d(f)}),s.addEventListener("click",async g=>{g.stopPropagation(),c("Removing…",!1);try{const f=await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"DELETE"}),p=await f.json().catch(()=>({}));if(!f.ok||!p.ok)throw new Error(p.error||`Remove failed (${f.status})`);b(""),u(""),c("Logo removed.",!1)}catch(f){c(f.message||"Remove failed.",!0)}})}function qg(e){return e.querySelector("#mag-f-surface-on")?.checked?{surface:e.querySelector("#mag-f-sv-surface").value,surface_2:e.querySelector("#mag-f-sv-surface2").value,border:e.querySelector("#mag-f-sv-border").value,text:e.querySelector("#mag-f-sv-text").value,text_sub:e.querySelector("#mag-f-sv-textsub").value}:{}}function Ug(e){const t=e.querySelector("#mag-f-success-cta-label").value.trim(),a=e.querySelector("#mag-f-success-cta-url").value.trim();return t&&a?{label:t,url:a}:{}}function Wi(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",s=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==s.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}const Pn=[{label:"Web fonts (loaded for you)",opts:[["Inter, sans-serif","Inter"],["Poppins, sans-serif","Poppins"],["Montserrat, sans-serif","Montserrat"],["Roboto, sans-serif","Roboto"],['"Open Sans", sans-serif',"Open Sans"],["Lato, sans-serif","Lato"],["Nunito, sans-serif","Nunito"],["Raleway, sans-serif","Raleway"],['"Work Sans", sans-serif',"Work Sans"],["Oswald, sans-serif","Oswald"],["Merriweather, serif","Merriweather (serif)"]]},{label:"System / always available",opts:[["system-ui, sans-serif","System UI"],["Georgia, serif","Georgia (serif)"],['"Times New Roman", Times, serif',"Times (serif)"],["Arial, Helvetica, sans-serif","Arial / Helvetica"],["Verdana, Geneva, sans-serif","Verdana"],['"Courier New", monospace',"Courier (mono)"]]}];function zg(e){const t=String(e||""),a=new Set(Pn.flatMap(s=>s.opts.map(([r])=>r))),n=s=>s===t?" selected":"";let o=`<option value=""${t===""?" selected":""}>System default</option>`;t&&!a.has(t)&&(o+=`<option value="${_(t)}" selected>Current: ${_(t)}</option>`);for(const s of Pn)o+=`<optgroup label="${_(s.label)}">`+s.opts.map(([r,i])=>`<option value="${_(r)}"${n(r)}>${_(i)}</option>`).join("")+"</optgroup>";return o}function Ma(e,t,a={}){const{freshDraft:n=!1}=a,o=!!e,s=o?null:crypto.randomUUID(),r=!o&&T.owners.length>1,i=e?.display_mode||"chat",l=e?.theme_mode||"auto",c={};(e?.actions||[]).forEach(S=>{S&&S.type&&(c[S.type]=S)});const u=o?!!e.home:!0,b=o?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",d=e?.theme_vars&&typeof e.theme_vars=="object"?e.theme_vars:{},g=Object.keys(d).length>0,f=(S,V)=>_(/^#[0-9a-fA-F]{6}$/.test(d[S]||"")?d[S]:V),p=document.createElement("div");p.className="mag-modal-scrim",p.innerHTML=`
  ...
  `,document.head.appendChild(e),Ss=!0}function Yi(){Yg();const e=Vg();return`
    ...
    </div>`}function Ki(){const e=document.getElementById("tpl-grid");document.getElementById("tpl-filters")?.addEventListener("click",t=>{const a=t.target.closest("[data-cat]");if(!a)return;a.parentElement.querySelectorAll("[data-cat]").forEach(o=>{o.setAttribute("aria-pressed",String(o===a))});const n=a.dataset.cat;e?.querySelectorAll(".mag-tpl-card").forEach(o=>{o.hidden=!(n==="all"||o.dataset.cat===n)})}),e?.addEventListener("click",t=>{const a=t.target.closest("[data-preview]");if(a){const o=at.find(s=>s.id===a.dataset.preview);o&&co(()=>Na({...o.appearance,steps:o.steps,name:o.name}));return}const n=t.target.closest("[data-tpl]");n&&(Qm(n.dataset.tpl),window.location.hash="#/magnets")})}const Kg={render:Yi,init:Ki},Jg=Object.freeze(Object.defineProperty({__proto__:null,default:Kg,init:Ki,render:Yi},Symbol.toStringTag,{value:"Module"})),Qg={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Me=e=>String(e??"").replace(/[&<>"']/g,t=>Qg[t]),Fn=()=>E.getConfig?.().BASE_URL||"",Cs=(e,t="info")=>{try{m.publish(h.UI_TOAST,{message:e,type:t})}catch{}},Xg="managed_client",Dn=[["ALL","All"],["NOT_SENT","Not sent"],["DRAFT","Awaiting response"],["SUBMITTED","Submitted"],["CANCELLED","Cancelled"]],Ji=Object.fromEntries(Dn),ve={clients:[],responses:[],filter:"ALL",search:"",openGuid:null};let Ts=!1;function Zg(){if(Xn(),Ts)return;const e=document.createElement("style");e.id="m5t-questionnaires-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ts=!0}const oa=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function ho(){return ve.clients.map(e=>{const t=ve.responses.filter(n=>n.owner_guid===e.guid),a=t[0]||null;return{guid:e.guid,name:e.caption||e.name||e.guid,latest:a,earlier:Math.max(0,t.length-1),status:a?a.status:"NOT_SENT"}})}function Qi(){const e=ve.search.trim().toLowerCase();return ho().filter(t=>(ve.filter==="ALL"||t.status===ve.filter)&&(!e||t.name.toLowerCase().includes(e)))}const $s=(e,t)=>e?.latest?.[t]?Ye(e.latest[t]):"—";function Xi(e){const t=e.status==="SUBMITTED",a=e.status==="SUBMITTED"?`<button class="qz-act" type="button" data-act="open" data-guid="${Me(e.latest.guid)}">Read answers</button>`:e.status==="DRAFT"?`<button class="qz-act" type="button" data-act="copy" data-url="${Me(e.latest.url||"")}">Copy link</button>`:'<a class="qz-act" href="#/clients">Go to client</a>';return`<tr class="${t?"qz-row--open":""}"${t?` data-open-guid="${Me(e.latest.guid)}"`:""}>
    ...
    </div>`}async function el(){await eh()}async function eh(){const e=document.getElementById("qz-body");if(e){try{const[t,a]=await Promise.all([fetch(`${Fn()}/m5t/v5/acctGroup`),fetch(`${Fn()}/m5t/v5/m5mQuestionnaireResponse`)]),n=await t.json().catch(()=>({})),o=await a.json().catch(()=>({}));if(!t.ok||!a.ok)throw new Error("load failed");ve.clients=(n.data||[]).filter(s=>s.class===Xg&&!["DELETED","ARCHIVED"].includes(s.status)).sort((s,r)=>String(s.caption||"").localeCompare(String(r.caption||""))),ve.responses=o.data||[]}catch{e.innerHTML=oa("error","Could not load questionnaires. Please try again.");return}tl()}}function tl(){const e=document.getElementById("qz-body");if(!e)return;if(!ve.clients.length){e.innerHTML=oa("groups","No clients yet. Add a client first, then send them a kickoff questionnaire.");return}const t=ho(),a={ALL:t.length};Dn.slice(1).forEach(([o])=>{a[o]=t.filter(s=>s.status===o).length});const n=Qi();e.innerHTML=`
    <div class="qz-bar">
      <div class="qz-filter">
    ...
    <div class="qz-tablewrap">
      <table class="qz-table">
        ...
        <tbody id="qz-tbody">${n.length?n.map(Xi).join(""):`<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">${ve.search.trim()?"No clients match your search.":`No clients with status “${Me(Ji[ve.filter]||ve.filter)}”.`}</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".qz-filter")?.addEventListener("click",o=>{const s=o.target.closest("[data-filter]");s&&(ve.filter=s.dataset.filter,tl())}),e.querySelector("#qz-search")?.addEventListener("input",o=>{ve.search=o.target.value,th()}),e.querySelector("#qz-tbody")?.addEventListener("click",ah)}function th(){const e=document.getElementById("qz-tbody");if(!e)return;const t=Qi();e.innerHTML=t.length?t.map(Xi).join(""):'<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">No clients match your search.</div></td></tr>';const a=document.querySelector(".qz-count");a&&(a.textContent=`${t.length} of ${ho().length}`)}function ah(e){const t=e.target.closest('[data-act="copy"]');if(t){e.stopPropagation();const s=t.dataset.url;if(!s){Cs("No link on this questionnaire yet.","warning");return}navigator.clipboard?.writeText(s).then(()=>{t.textContent="Copied!",setTimeout(()=>{t.textContent="Copy link"},1500)},()=>Cs("Could not copy the link.","error"));return}const a=e.target.closest('[data-act="open"]'),n=e.target.closest("[data-open-guid]"),o=a?.dataset.guid||n?.dataset.openGuid;o&&nh(o)}async function nh(e){ve.openGuid=e;const t=document.createElement("div");t.className="qz-drawer-scrim";const a=document.createElement("aside");a.className="qz-drawer",a.setAttribute("role","dialog"),a.setAttribute("aria-label","Questionnaire answers"),a.innerHTML=`
  ...
  <colgroup>
    ...
    <div id="leads-tablezone"></div>`,e.querySelector(".leads-filter")?.addEventListener("click",s=>{const r=s.target.closest("[data-filter]");r&&(k.filter=r.dataset.filter,k.shown=ut,Jt())}),e.querySelector("#leads-clientsel")?.addEventListener("change",s=>{k.clientFilter=s.target.value,k.shown=ut,Jt()}),e.querySelector("#leads-dayclear")?.addEventListener("click",()=>{k.day="",k.shown=ut,Jt()}),e.querySelector("#leads-search")?.addEventListener("input",s=>{k.search=s.target.value,k.shown=ut,qn()}),qn()}function qn(){const e=document.getElementById("leads-tablezone"),t=document.getElementById("leads-countlbl");if(!e)return;const a=ol(),n=a.slice(0,k.shown),o=k.book?8:7;t&&(t.textContent=`${a.length} of ${k.leads.length}`),e.innerHTML=`
...
`)],{type:"text/csv"}),r=URL.createObjectURL(s),i=document.createElement("a");i.href=r,i.download=`leads-${k.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r),Pa(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const wh=Object.freeze(Object.defineProperty({__proto__:null,init:fh,render:hh},Symbol.toStringTag,{value:"Module"})),cl=()=>E.getConfig?.().BASE_URL||"",Ns=e=>e.toISOString().slice(0,10),We=e=>Number(e||0).toLocaleString(),xh={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ga=e=>String(e??"").replace(/[&<>"']/g,t=>xh[t]),Qt=e=>e==null?"—":`${e}%`,Eh=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let Ba=30,Os=!1;function dl(){if(Os)return;const e=document.createElement("style");e.id="m5t-analytics-styles",e.textContent=`
  ...
  <div class="stat-card">
    ...
    <td>${We(e.opens)}</td>
    <td>${Qt(e.engagement_rate)}</td>
    <td>${Qt(e.completion_rate)}</td>
    <td>${Qt(e.lead_rate)}</td>
    <td>${s}</td>
  ...
  `,document.head.appendChild(e),zs=!0}function hl(){return ie()?Et({section:"ad-accounts",title:"Ad Accounts",description:"Pick a client to see their connected ad accounts."}):(qh(),Ja(),`
...
`||u==="\r"?(u==="\r"&&e[c+1]===`
`&&c++,a.push(n),n="",a.some(b=>b.trim()!=="")&&t.push(a),a=[]):n+=u}if(a.push(n),a.some(c=>c.trim()!=="")&&t.push(a),t.length<2)return[];const s=t[0].map(c=>c.trim().toLowerCase()),r=s.findIndex(c=>/e-?mail/.test(c)),i=s.findIndex(c=>/phone|mobile|tel/.test(c)),l=s.findIndex(c=>/date|time|booked|appointment|start/.test(c));return r<0&&i<0?[]:t.slice(1).map(c=>({email:r>=0?(c[r]||"").trim():"",phone:i>=0?(c[i]||"").trim():"",at:l>=0?(c[l]||"").trim():""})).filter(c=>c.email||c.phone).slice(0,5e3)}function _l(e,t){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),o=document.createElement("a");o.href=n,o.download=t,document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(n),4e3)}const Jh={render:hl,init:fl},Qh=Object.freeze(Object.defineProperty({__proto__:null,default:Jh,init:fl,parseBookingCsv:bl,render:hl},Symbol.toStringTag,{value:"Module"})),js="reseller_org",yl="managed_client";let Gs=!1;const Xh={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},D=e=>String(e??"").replace(/[&<>"']/g,t=>Xh[t]);function Ze(e,t="info"){try{m.publish(h.UI_TOAST,{message:e,type:t})}catch{}}function Zh(){const e=E.getActiveOrg();if(e&&e.channel===js)return{guid:e.guid,name:e.name};const t=E.getMemberships().find(a=>a.channel===js);return t?{guid:t.orgGuid,name:t.name}:null}function ef(e){const t=e?.created_tz;if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function tf(){if(Gs)return;const e=document.createElement("style");e.id="m5t-clients-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Xn(),Gs=!0}const af=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Xt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function nf(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
