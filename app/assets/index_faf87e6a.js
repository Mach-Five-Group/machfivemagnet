(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const el="modulepreload",tl=function(e,t){return new URL(e,t).href},no={},j=function(t,a,n){let o=Promise.resolve();if(a&&a.length>0){let c=function(u){return Promise.all(u.map(v=>Promise.resolve(v).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};const r=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");o=c(a.map(u=>{if(u=tl(u,n),u in no)return;no[u]=!0;const v=u.endsWith(".css"),h=v?'[rel="stylesheet"]':"";if(n)for(let f=r.length-1;f>=0;f--){const p=r[f];if(p.href===u&&(!v||p.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${u}"]${h}`))return;const d=document.createElement("link");if(d.rel=v?"stylesheet":el,v||(d.as="script"),d.crossOrigin="",d.href=u,l&&d.setAttribute("nonce",l),document.head.appendChild(d),v)return new Promise((f,p)=>{d.addEventListener("load",f),d.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${u}`)))})}))}function s(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return o.then(r=>{for(const i of r||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})};var al=/([:*])(\w+)/g,nl="([^/]+)",ol=/\*/g,sl="?(?:.*)",rl=/\/\?/g,il="/?([^/]+|)",ll="(?:/^|^)",cl="";function Is(e){return e===void 0&&(e="/"),In()?location.pathname+location.search+location.hash:e}function Z(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function fa(e){return typeof e=="string"}function dl(e){return typeof e=="function"}function va(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function pl(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(a,n,o){return a===null&&(a={}),a[t[o]]=decodeURIComponent(n),a},null)}function ba(e){var t=Z(e).split(/\?(.*)?$/);return[Z(t[0]),t.slice(1).join("")]}function Ln(e){for(var t={},a=e.split("&"),n=0;n<a.length;n++){var o=a[n].split("=");if(o[0]!==""){var s=decodeURIComponent(o[0]);t[s]?(Array.isArray(t[s])||(t[s]=[t[s]]),t[s].push(decodeURIComponent(o[1]||""))):t[s]=decodeURIComponent(o[1]||"")}}return t}function Rs(e,t){var a=ba(Z(e.currentLocationPath)),n=a[0],o=a[1],s=o===""?null:Ln(o),r=[],i;if(fa(t.path)){if(i=ll+Z(t.path).replace(al,function(v,h,d){return r.push(d),nl}).replace(ol,sl).replace(rl,il)+"$",Z(t.path)===""&&Z(n)==="")return{url:n,queryString:o,hashString:va(e.to),route:t,data:null,params:s}}else i=t.path;var l=new RegExp(i,cl),c=n.match(l);if(c){var u=fa(t.path)?pl(c,r):c.groups?c.groups:c.slice(1);return{url:Z(n.replace(new RegExp("^"+e.instance.root),"")),queryString:o,hashString:va(e.to),route:t,data:u,params:s}}return!1}function Ns(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function vt(e,t){return typeof e[t]>"u"||e[t]===!0}function ul(e){if(!e)return{};var t=e.split(","),a={},n;return t.forEach(function(o){var s=o.split(":").map(function(r){return r.replace(/(^ +| +$)/g,"")});switch(s[0]){case"historyAPIMethod":a.historyAPIMethod=s[1];break;case"resolveOptionsStrategy":n||(n={}),n.strategy=s[1];break;case"resolveOptionsHash":n||(n={}),n.hash=s[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":a[s[0]]=s[1]==="true";break}}),n&&(a.resolveOptions=n),a}function In(){return typeof window<"u"}function ml(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(a){return a}).forEach(function(a){["before","after","already","leave"].forEach(function(n){a[n]&&(t[n]||(t[n]=[]),t[n].push(a[n]))})}),t}function De(e,t,a){var n=t||{},o=0;(function s(){if(!e[o]){a&&a(n);return}Array.isArray(e[o])?(e.splice.apply(e,[o,1].concat(e[o][0](n)?e[o][1]:e[o][2])),s()):e[o](n,function(r){typeof r>"u"||r===!0?(o+=1,s()):a&&a(n)})})()}De.if=function(e,t,a){return Array.isArray(t)||(t=[t]),Array.isArray(a)||(a=[a]),[e,t,a]};function oo(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=Is(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function Ga(e,t){for(var a=0;a<e.instance.routes.length;a++){var n=e.instance.routes[a],o=Rs(e,n);if(o&&(e.matches||(e.matches=[]),e.matches.push(o),e.resolveOptions.strategy==="ONE")){t();return}}t()}function gl(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function hl(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var so=In(),fl=Ns();function vl(e,t){if(vt(e.navigateOptions,"updateBrowserURL")){var a=("/"+e.to).replace(/\/\//g,"/"),n=so&&e.resolveOptions&&e.resolveOptions.hash===!0;fl?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",n?"#"+a:a),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!n){var o=location.hash;location.hash="",location.hash=o}e.instance.__freezeListening=!1},1))):so&&(window.location.href=e.to)}t()}function Os(e,t){var a=e.instance;if(!a.lastResolved()){t();return}De(a.lastResolved().map(function(n){return function(o,s){if(!n.route.hooks||!n.route.hooks.leave){s();return}var r=!1,i=e.instance.matchLocation(n.route.path,e.currentLocationPath,!1);if(n.route.path!=="*")r=!i;else{var l=e.matches?e.matches.find(function(c){return n.route.path===c.route.path}):!1;r=!l}if(vt(e.navigateOptions,"callHooks")&&r){De(n.route.hooks.leave.map(function(c){return function(u,v){return c(function(h){h===!1?e.instance.__markAsClean(e):v()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return s()}]));return}else s()}}),{},function(){return t()})}function bl(e,t){e.match.route.hooks&&e.match.route.hooks.before&&vt(e.navigateOptions,"callHooks")?De(e.match.route.hooks.before.map(function(a){return function(o,s){return a(function(r){r===!1?e.instance.__markAsClean(e):s()},e.match)}}).concat([function(){return t()}])):t()}function _l(e,t){vt(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function yl(e,t){e.match.route.hooks&&e.match.route.hooks.after&&vt(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(a){return a(e.match)}),t()}function wl(e,t){var a=e.instance.lastResolved();if(a&&a[0]&&a[0].route===e.match.route&&a[0].url===e.match.url&&a[0].queryString===e.match.queryString){a.forEach(function(n){n.route.hooks&&n.route.hooks.already&&vt(e.navigateOptions,"callHooks")&&n.route.hooks.already.forEach(function(o){return o(e.match)})}),t(!1);return}t()}function xl(e,t){var a=e.instance._notFoundRoute;if(a){e.notFoundHandled=!0;var n=ba(e.currentLocationPath),o=n[0],s=n[1],r=va(e.to);a.path=Z(o);var i={url:a.path,queryString:s,hashString:r,data:null,route:a,params:s!==""?Ln(s):null};e.matches=[i],e.match=i}t()}function El(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function kl(e,t){e.instance._setCurrent(null),t()}function Ms(e,t){vt(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var Ps=[wl,bl,_l,yl],ro=[Os,xl,De.if(function(e){var t=e.notFoundHandled;return t},Ps.concat([Ms]),[El,kl])];function sn(){return sn=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},sn.apply(this,arguments)}function io(e,t){var a=0;function n(){if(a===e.matches.length){Ms(e,t);return}De(Ps,sn({},e,{match:e.matches[a]}),function(){a+=1,n()})}Os(e,n)}function ja(e){e.instance.__markAsClean(e)}function rn(){return rn=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},rn.apply(this,arguments)}var lo="[data-navigo]";function Al(e,t){var a=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:lo},n=this,o="/",s=null,r=[],i=!1,l,c=Ns(),u=In();e?o=Z(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function v(_){return _.indexOf("#")>=0&&(a.hash===!0?_=_.split("#")[1]||"/":_=_.split("#")[0]),_}function h(_){return Z(o+"/"+Z(_))}function d(_,S,N,V){return _=fa(_)?h(_):_,{name:V||Z(String(_)),path:_,handler:S,hooks:ml(N)}}function f(_,S,N){var V=this;return typeof _=="object"&&!(_ instanceof RegExp)?(Object.keys(_).forEach(function(B){if(typeof _[B]=="function")V.on(B,_[B]);else{var ke=_[B],at=ke.uses,C=ke.as,H=ke.hooks;r.push(d(B,at,[l,H],C))}}),this):(typeof _=="function"&&(N=S,S=_,_=o),r.push(d(_,S,[l,N])),this)}function p(_,S){if(n.__dirty){n.__waiting.push(function(){return n.resolve(_,S)});return}else n.__dirty=!0;_=_?Z(o)+"/"+Z(_):void 0;var N={instance:n,to:_,currentLocationPath:_,navigateOptions:{},resolveOptions:rn({},a,S)};return De([oo,Ga,De.if(function(V){var B=V.matches;return B&&B.length>0},io,ro)],N,ja),N.matches?N.matches:!1}function b(_,S){if(n.__dirty){n.__waiting.push(function(){return n.navigate(_,S)});return}else n.__dirty=!0;_=Z(o)+"/"+Z(_);var N={instance:n,to:_,navigateOptions:S||{},resolveOptions:S&&S.resolveOptions?S.resolveOptions:a,currentLocationPath:v(_)};De([gl,hl,Ga,De.if(function(V){var B=V.matches;return B&&B.length>0},io,ro),vl,ja],N,ja)}function y(_,S,N){var V=Be(_,S);return V!==null?(b(V.replace(new RegExp("^/?"+o),""),N),!0):!1}function w(_){return this.routes=r=r.filter(function(S){return fa(_)?Z(S.path)!==Z(_):dl(_)?_!==S.handler:String(S.path)!==String(_)}),this}function A(){c&&(this.__popstateListener=function(){n.__freezeListening||p()},window.addEventListener("popstate",this.__popstateListener))}function R(){this.routes=r=[],c&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=i=!0}function z(_,S){return n._notFoundRoute=d("*",_,[l,S],"__NOT_FOUND__"),this}function Q(){if(u)return ge().forEach(function(_){if(_.getAttribute("data-navigo")==="false"||_.getAttribute("target")==="_blank"){_.hasListenerAttached&&_.removeEventListener("click",_.navigoHandler);return}_.hasListenerAttached||(_.hasListenerAttached=!0,_.navigoHandler=function(S){if((S.ctrlKey||S.metaKey)&&S.target.tagName.toLowerCase()==="a")return!1;var N=_.getAttribute("href");if(typeof N>"u"||N===null)return!1;if(N.match(/^(http|https)/)&&typeof URL<"u")try{var V=new URL(N);N=V.pathname+V.search}catch{}var B=ul(_.getAttribute("data-navigo-options"));i||(S.preventDefault(),S.stopPropagation(),n.navigate(Z(N),B))},_.addEventListener("click",_.navigoHandler))}),n}function ge(){return u?[].slice.call(document.querySelectorAll(a.linksSelector||lo)):[]}function $e(_){return"/"+o+"/"+Z(_)}function he(_){return l=_,this}function Ve(){return s}function Be(_,S,N){var V=r.find(function(at){return at.name===_}),B=null;if(V){if(B=V.path,S)for(var ke in S)B=B.replace(":"+ke,S[ke]);B=B.match(/^\//)?B:"/"+B}return B&&N&&!N.includeRoot&&(B=B.replace(new RegExp("^/"+o),"")),B}function D(_){return _.getAttribute("href")}function ae(_){var S=ba(Z(_)),N=S[0],V=S[1],B=V===""?null:Ln(V),ke=va(_),at=d(N,function(){},[l],N);return{url:N,queryString:V,hashString:ke,route:at,data:null,params:B}}function q(){return ae(Z(Is(o)).replace(new RegExp("^"+o),""))}function Y(_){var S={instance:n,currentLocationPath:_,to:_,resolveOptions:a};return Ga(S,function(){}),S.matches?S.matches:!1}function et(_,S,N){typeof S<"u"&&(typeof N>"u"||N)&&(S=h(S));var V={instance:n,to:S,currentLocationPath:S};oo(V,function(){}),typeof _=="string"&&(_=typeof N>"u"||N?h(_):_);var B=Rs(V,{name:String(_),path:_,handler:function(){},hooks:{}});return B||!1}function tt(_,S,N){return typeof S=="string"&&(S=Nt(S)),S?(S.hooks[_]||(S.hooks[_]=[]),S.hooks[_].push(N),function(){S.hooks[_]=S.hooks[_].filter(function(V){return V!==N})}):(console.warn("Route doesn't exists: "+S),function(){})}function Nt(_){return typeof _=="string"?r.find(function(S){return S.name===h(_)}):r.find(function(S){return S.handler===_})}function za(_){_.instance.__dirty=!1,_.instance.__waiting.length>0&&_.instance.__waiting.shift()()}this.root=o,this.routes=r,this.destroyed=i,this.current=s,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=za,this.on=f,this.off=w,this.resolve=p,this.navigate=b,this.navigateByName=y,this.destroy=R,this.notFound=z,this.updatePageLinks=Q,this.link=$e,this.hooks=he,this.extractGETParameters=function(_){return ba(v(_))},this.lastResolved=Ve,this.generate=Be,this.getLinkPath=D,this.match=Y,this.matchLocation=et,this.getCurrentLocation=q,this.addBeforeHook=tt.bind(this,"before"),this.addAfterHook=tt.bind(this,"after"),this.addAlreadyHook=tt.bind(this,"already"),this.addLeaveHook=tt.bind(this,"leave"),this.getRoute=Nt,this._pathToMatchObject=ae,this._clean=Z,this._checkForAHash=v,this._setCurrent=function(_){return s=n.current=_},A.call(this),Q.call(this)}var Sl=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Cl(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Ft={exports:{}},Tl=Ft.exports,co;function $l(){return co||(co=1,(function(e,t){(function(a,n){var o={};a.PubSub?(o=a.PubSub,console.warn("PubSub already loaded, using existing version")):(a.PubSub=o,n(o)),e!==void 0&&e.exports&&(t=e.exports=o),t.PubSub=o,e.exports=t=o})(typeof window=="object"&&window||Tl||Sl,function(a){var n={},o=-1,s="*";function r(p){var b;for(b in p)if(Object.prototype.hasOwnProperty.call(p,b))return!0;return!1}function i(p){return function(){throw p}}function l(p,b,y){try{p(b,y)}catch(w){setTimeout(i(w),0)}}function c(p,b,y){p(b,y)}function u(p,b,y,w){var A=n[b],R=w?c:l,z;if(Object.prototype.hasOwnProperty.call(n,b))for(z in A)Object.prototype.hasOwnProperty.call(A,z)&&R(A[z],p,y)}function v(p,b,y){return function(){var A=String(p),R=A.lastIndexOf(".");for(u(p,p,b,y);R!==-1;)A=A.substr(0,R),R=A.lastIndexOf("."),u(p,A,b,y);u(p,s,b,y)}}function h(p){var b=String(p),y=!!(Object.prototype.hasOwnProperty.call(n,b)&&r(n[b]));return y}function d(p){for(var b=String(p),y=h(b)||h(s),w=b.lastIndexOf(".");!y&&w!==-1;)b=b.substr(0,w),w=b.lastIndexOf("."),y=h(b);return y}function f(p,b,y,w){p=typeof p=="symbol"?p.toString():p;var A=v(p,b,w),R=d(p);return R?(y===!0?A():setTimeout(A,0),!0):!1}a.publish=function(p,b){return f(p,b,!1,a.immediateExceptions)},a.publishSync=function(p,b){return f(p,b,!0,a.immediateExceptions)},a.subscribe=function(p,b){if(typeof b!="function")return!1;p=typeof p=="symbol"?p.toString():p,Object.prototype.hasOwnProperty.call(n,p)||(n[p]={});var y="uid_"+String(++o);return n[p][y]=b,y},a.subscribeAll=function(p){return a.subscribe(s,p)},a.subscribeOnce=function(p,b){var y=a.subscribe(p,function(){a.unsubscribe(y),b.apply(this,arguments)});return a},a.clearAllSubscriptions=function(){n={}},a.clearSubscriptions=function(b){var y;for(y in n)Object.prototype.hasOwnProperty.call(n,y)&&y.indexOf(b)===0&&delete n[y]},a.countSubscriptions=function(b){var y,w,A=0;for(y in n)if(Object.prototype.hasOwnProperty.call(n,y)&&y.indexOf(b)===0){for(w in n[y])A++;break}return A},a.getSubscriptions=function(b){var y,w=[];for(y in n)Object.prototype.hasOwnProperty.call(n,y)&&y.indexOf(b)===0&&w.push(y);return w},a.unsubscribe=function(p){var b=function($e){var he;for(he in n)if(Object.prototype.hasOwnProperty.call(n,he)&&he.indexOf($e)===0)return!0;return!1},y=typeof p=="string"&&(Object.prototype.hasOwnProperty.call(n,p)||b(p)),w=!y&&typeof p=="string",A=typeof p=="function",R=!1,z,Q,ge;if(y){a.clearSubscriptions(p);return}for(z in n)if(Object.prototype.hasOwnProperty.call(n,z)){if(Q=n[z],w&&Q[p]){delete Q[p],R=p;break}if(A)for(ge in Q)Object.prototype.hasOwnProperty.call(Q,ge)&&Q[ge]===p&&(delete Q[ge],R=!0)}return R}})})(Ft,Ft.exports)),Ft.exports}var Ll=$l();const m=Cl(Ll),g=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV.GO",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN.GO",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP.GO",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT.GO",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT.GO",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH.GO",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",AUTH_SCOPE_LOADED:"AUTH.SCOPE.LOADED",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",M5T_SIDE_NAV:"M5T_SIDE_NAV",M5T_SIDE_NAV_TAP:"M5T_SIDE_NAV.TAP",M5T_SIDE_NAV_COLLAPSE:"M5T_SIDE_NAV.COLLAPSE",M5T_SIDE_NAV_LOGO_TAP:"M5T_SIDE_NAV.LOGO_TAP",M5T_SIDE_NAV_ORG_SWITCH:"M5T_SIDE_NAV.ORG_SWITCH",M5T_SIDE_NAV_FOOTER_ACTION:"M5T_SIDE_NAV.FOOTER_ACTION",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_THEME_CHANGED:"UI.THEME.CHANGED",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL",MESSAGE:"MESSAGE",MESSAGE_CREATE:"MESSAGE.CREATE",MESSAGE_CREATED:"MESSAGE.CREATED",MESSAGE_EDIT:"MESSAGE.EDIT",MESSAGE_UPDATED:"MESSAGE.UPDATED",MESSAGE_DELETE:"MESSAGE.DELETE",MESSAGE_DELETED:"MESSAGE.DELETED",MESSAGE_REFRESH:"MESSAGE.REFRESH"}),Va={BASE_URL:"./",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://machfivemagnet-saas.onrender.com"};var Wa={};const U=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_UI_DARK_MODE:!0,FF_SSE_UI_ANIMATIONS:!0,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel",FF_API_RATELIMIT_SIGNIN_ENFORCE:!1,FF_API_RATELIMIT_SIGNIN_IP_LIMIT:20,FF_API_RATELIMIT_SIGNIN_EMAIL_LIMIT:10,FF_API_RATELIMIT_FORGOT_ENFORCE:!1,FF_API_RATELIMIT_FORGOT_IP_LIMIT:15,FF_API_RATELIMIT_FORGOT_EMAIL_LIMIT:5,FF_API_RATELIMIT_CAPTURE_ENFORCE:!1,FF_API_RATELIMIT_CAPTURE_LIMIT:30,FF_API_RATELIMIT_EVENT_ENFORCE:!1,FF_API_RATELIMIT_EVENT_LIMIT:600,FF_API_RATELIMIT_CSP_PING_ENFORCE:!1,FF_API_RATELIMIT_CSP_PING_LIMIT:30,FF_API_RATELIMIT_WEBAUTHN_AUTH_ENFORCE:!1,FF_API_RATELIMIT_WEBAUTHN_AUTH_IP_LIMIT:20,FF_API_RATELIMIT_INTEGRATIONS_ENFORCE:!1,FF_API_RATELIMIT_INTEGRATIONS_LIMIT:60,FF_API_RATELIMIT_QUESTIONNAIRE_ENFORCE:!1,FF_API_RATELIMIT_QUESTIONNAIRE_LIMIT:30,FF_API_RATELIMIT_AUTHENTICATED_ENFORCE:!1,FF_API_RATELIMIT_AUTHENTICATED_LIMIT:600,FF_API_MAGNET_REQUIRE_ORIGIN_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_LIMIT:2e3});function Fs(e,t=null){if(e in U)return U[e];if(typeof process<"u"&&Wa&&Wa[e]){const a=Wa[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}if(typeof import.meta<"u"&&Va&&Va[e]){const a=Va[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}return t}function Rn(e){return Fs(e,!1)===!0}function Il(){return{...U}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:U,getFlag:Fs,isEnabled:Rn,getAllFlags:Il});const po={success:{border:"var(--color-success, #009473)",bg:"var(--color-success-soft, rgba(0,148,115,0.10))",icon:"check_circle"},danger:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},error:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},warning:{border:"var(--color-warning, #D97706)",bg:"var(--color-warning-soft, #FEF3C7)",icon:"warning"},info:{border:"var(--color-info, #0D9488)",bg:"var(--color-info-soft, #CCFBF1)",icon:"info"}},Rl=4500,ln=220;let Ue=null,uo=!1;function Nl(){if(uo)return;const e=document.createElement("style");e.id="m5t-toast-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),uo=!0}function Ol(){return Ue&&document.body.contains(Ue)||(Ue=document.createElement("div"),Ue.className="m5t-toast-stack",Ue.setAttribute("role","status"),Ue.setAttribute("aria-live","polite"),document.body.appendChild(Ue)),Ue}function Ml(e){const t=e&&e.message;if(!t)return;Nl();const a=po[e.type]||po.info,n=document.createElement("div");n.className="m5t-toast",n.style.borderColor=a.border,n.style.background=a.bg,n.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true" style="color:${a.border}">${a.icon}</span><span class="m5t-toast__msg"></span><button type="button" class="m5t-toast__close" aria-label="Dismiss"><span class="material-symbols-outlined" aria-hidden="true">close</span></button>`,n.querySelector(".m5t-toast__msg").textContent=String(t),Ol().appendChild(n),requestAnimationFrame(()=>n.classList.add("is-in"));let s=!1;const r=()=>{s||(s=!0,clearTimeout(i),n.classList.remove("is-in"),n.classList.add("is-out"),setTimeout(()=>n.remove(),ln))},i=setTimeout(r,Rl);n.querySelector(".m5t-toast__close").addEventListener("click",r)}function Pl(){const e=t=>a=>{const n=a.detail?.pubsubTopic;n&&m.publish(n,a.detail)};document.addEventListener("nav-select",e()),document.addEventListener("logo-click",e()),document.addEventListener("nav-hover",e()),document.addEventListener("nav-double-tap",e()),document.addEventListener("nav-long-tap",e()),document.addEventListener("message-sent",e())}function Fl(){console.log("[AppEvents] Initializing event listeners..."),m.subscribe(g.APP_READY,(a,n)=>{console.log("[AppEvents] APP_READY:",n)}),m.subscribe(g.APP_ERROR,(a,n)=>{console.error("[AppEvents] APP_ERROR:",n)}),m.subscribe(g.APP_SIGNOUT,(a,n)=>{console.log("[AppEvents] APP_SIGNOUT:",n)}),m.subscribe(g.ROUTE_NAV_BEFORE,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",n),m.publish(g.UI_LOADING_START)}),m.subscribe(g.ROUTE_NAV_AFTER,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",n),m.publish(g.UI_LOADING_END)}),m.subscribe(g.ROUTE_NAV_ERROR,(a,n)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",n),m.publish(g.APP_ERROR,{message:"Navigation error",details:n})}),m.subscribe(g.AUTH_SIGNIN_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",n)}),m.subscribe(g.AUTH_SIGNIN_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",n),m.publish(g.UI_TOAST,{message:n.message||"Sign in failed",type:"danger"})}),m.subscribe(g.AUTH_SIGNUP_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",n),m.publish(g.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"}),m.publish(g.AUTH_VERIFY_LINK)}),m.subscribe(g.AUTH_VERIFY_LINK,(a,n)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),m.subscribe(g.AUTH_SIGNUP_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",n),m.publish(g.UI_TOAST,{message:n.message||"Sign up failed",type:"danger"})}),m.subscribe(g.AUTH_SIGNOUT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",n),m.publish(g.UI_TOAST,{message:"Signed out successfully",type:"info"})}),m.subscribe(g.AUTH_SIGNUP,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),m.subscribe(g.AUTH_FORGOT,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),m.subscribe(g.AUTH_FORGOT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",n),m.publish(g.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),m.subscribe(g.AUTH_RESETHASH_NAV,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),m.subscribe(g.AUTH_RESETHASH_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",n),m.publish(g.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),m.subscribe(g.AUTH_TOKEN_EXPIRED,(a,n)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",n),m.publish(g.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),m.subscribe(g.I18N_SET_LANG,(a,n)=>{console.log("[AppEvents] I18N_SET_LANG:",n);const{langCode:o}=n;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),m.publish(g.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(s){console.error("[AppEvents] Error changing language:",s),m.publish(g.UI_TOAST,{message:`Failed to change language: ${s.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),m.subscribe("CONVERSATION.PROMPT",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",n.message),Ya(n.message,"user",n.timestamp),m.publish(g.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Agent prompt (no implementation):",n.message);break;case"AGENT_CANVAS":console.log("[AppEvents] Display message in canvas:",n.message),Ya(n.message,"user",n.timestamp),m.publish(g.CANVAS_DO_SCROLL);break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),m.subscribe("CONVERSATION.RESPONSE",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",n.message),Ya(n.message,"assistant",n.timestamp,n.streaming);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),m.subscribe(g.UI_LOADING_START,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),m.subscribe(g.UI_LOADING_END,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),m.subscribe(g.UI_TOAST,(a,n)=>{Ml(n)}),m.subscribe(g.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const a="0.1",n=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${a} 8/11/2026, 6:51:14 PM|© ${n} Mach Five Tech`,"night")}),Pl(),m.subscribe("M5T_PRIMARY_NAV",(a,n)=>{const o=a.split(".")[1];switch(o){case"TAP":e(n);break;case"LOGO_TAP":t();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function e(a){const{token:n,level:o,primaryToken:s}=a;switch(n){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),m.publish(g.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${n}`,{primaryToken:s});break}}function t(a){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 8/11/2026, 6:51:14 PM|© ${o} Mach Five Tech`,"night",5e3)}m.subscribe(g.AUTH_SIGNOUT,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(U.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function Ya(e,t="user",a=null,n=!1){const o=document.getElementById("chat-messages");if(!o){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}if(a||(a=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})),n&&t==="assistant"){const r=o.firstElementChild;if(r&&r.tagName.toLowerCase()==="m5t-chat-response"){r.setAttribute("message",e),console.log(`[AppEvents] Updated streaming ${t} bubble (${e.length} chars)`);return}}let s;t==="user"||t==="prompt"?s=document.createElement("m5t-chat-prompt"):s=document.createElement("m5t-chat-response"),s.setAttribute("message",e),s.setAttribute("timestamp",a),o.prepend(s),console.log(`[AppEvents] Added ${t} bubble to canvas (${e.length} chars)`)}function Dl(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("uid")&&t.get("token"))}function Bl(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("qr")&&t.get("token"))}function ql(e=window.location.search){const t=new URLSearchParams(e||""),a=t.get("qr"),n=t.get("token");return a&&n?{guid:a,token:n}:null}const Ul=Object.freeze([Object.freeze({name:"invite",matches:Dl}),Object.freeze({name:"questionnaire",matches:Bl})]);function Ds(e=window.location.search){return Ul.find(t=>t.matches(e))||null}function zl(e=window.location.search){return Ds(e)!==null}const Hl=e=>String(e||"").replace(/_route$/,"").replace(/_/g,"-");function Gl(e,t=window.location.search){const a=Hl(e);return zl(t)&&(a==="splash"||a==="signin")}const jl=Object.freeze({admin_root_role:{value:100,desc:"Administrator superuser infrastructure architecture"},admin_business_role:{value:90,desc:"Administrator financial oversight"},admin_support_role:{value:80,desc:"Administrator maintenance and configuration"},admin_readonly_role:{value:70,desc:"Administrator information help desk"},client_tier_4_role:{value:40,desc:"Client paid tier 4 - Partner"},client_tier_3_role:{value:30,desc:"Client paid tier 3"},client_tier_2_role:{value:20,desc:"Client paid tier 2"},client_tier_1_role:{value:10,desc:"Client paid tier 1"},client_standard_role:{value:0,desc:"Client free tier 0"}});function Vl(e){return jl[e]||null}function Wl(e){return e>=50}const Ut=Object.freeze({owner:{value:"owner",rank:30,label:"Owner"},admin:{value:"admin",rank:20,label:"Admin"},member:{value:"member",rank:10,label:"Member"},viewer:{value:"viewer",rank:0,label:"Viewer"}}),Yl=Object.freeze({VIEW_DASHBOARD:"view_dashboard",VIEW_MAGNETS:"view_magnets",PROVISION_MAGNETS:"provision_magnets",MANAGE_MAGNETS:"manage_magnets",VIEW_CONVERSATIONS:"view_conversations",VIEW_STATS:"view_stats",VIEW_AD_METRICS:"view_ad_metrics",CONNECT_AD_ACCOUNTS:"connect_ad_accounts",CREATE_CLIENT_ACCOUNTS:"create_client_accounts",MANAGE_TEAM:"manage_team",VIEW_BILLING:"view_billing",MANAGE_BILLING:"manage_billing"}),T=Yl,Bs=Object.freeze(Object.values(T)),st=Object.freeze([T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS]),Kl=Object.freeze({reseller_org:{owner:Bs,admin:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.CREATE_CLIENT_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING],member:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS],viewer:st},managed_client:{owner:[...st,T.VIEW_BILLING],admin:[...st,T.VIEW_BILLING],member:st,viewer:st},saas_org:{owner:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING,T.MANAGE_BILLING],admin:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING],member:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS],viewer:st}});function Jl(e){const t=Vl(e);return!!t&&Wl(t.value)}function Ql({entityClass:e,orgChannel:t,memberRole:a}={}){if(Jl(e))return e==="admin_readonly_role"?[...st,T.VIEW_BILLING]:[...Bs];const n=Kl[t],o=n&&n[a];return o?[...o]:[]}function Xl(e,t){const a=Ut[e]?.rank??-1,n=Ut[t]?.rank??1/0;return a>=Ut.admin.rank&&a>=n}const Nn=[{value:"name",label:"Full name (splits into first + last automatically)"},{value:"first_name",label:"First name"},{value:"last_name",label:"Last name"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"mobile",label:"Mobile phone"},{value:"company",label:"Company"},{value:"title",label:"Job title"},{value:"city",label:"City"},{value:"state",label:"State / province"},{value:"product_interest",label:"Product interest"},{value:"lead_source",label:"Lead source"},{value:"rating",label:"Rating (Hot / Warm / Cold)"},{value:"description",label:"Notes / description"},{value:"salutation",label:"Salutation (Mr. / Ms. / Dr.)"},{value:"street",label:"Street address"},{value:"zip",label:"Postal / ZIP code"},{value:"country",label:"Country"},{value:"url",label:"Website URL"},{value:"industry",label:"Industry"},{value:"annual_revenue",label:"Annual revenue (number)"},{value:"employees",label:"Number of employees (whole number)"},{value:"is_primary",label:"Primary contact (Yes / No)"},{value:"current_generators",label:"Current generator(s)"},{value:"number_of_locations",label:"Number of locations (whole number)"}];new Set(Nn.map(e=>e.value));const On=[{value:"single_select",label:"Multiple choice"},{value:"multi_select",label:"Select all"},{value:"scheduler",label:"Scheduler"},{value:"text",label:"Short text"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"message",label:"Message"}];new Set(On.map(e=>e.value));const Zl=[{value:"inline",label:"Inline"},{value:"chat",label:"Chat"},{value:"right_slide",label:"Slide"},{value:"modal",label:"Modal"}],ec=[{value:"auto",label:"Auto"},{value:"light",label:"Light"},{value:"dark",label:"Dark"}],tc=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],ac=[{value:"book",label:"Book"},{value:"call",label:"Call"},{value:"email",label:"Email"},{value:"chat",label:"Chat"},{value:"support",label:"Support"}];Zl.map(e=>e.value);ec.map(e=>e.value);tc.map(e=>e.value);ac.map(e=>e.value);class E{static CONFIG={BASE_URL:"https://machfivemagnet-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink",SCOPE:"sse_session_scope",ACTIVE_ORG:"sse_active_org",REMEMBERED_EMAIL:"sse_remembered_email"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",ME:"/m5t/v5/acctEntity/me",PING:"/ping",WEBAUTHN_AUTH_OPTIONS:"/m5t/v5/webauthn/authenticate/options",WEBAUTHN_AUTH_VERIFY:"/m5t/v5/webauthn/authenticate/verify"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#o=null;static#a=null;static#n=null;static#s=null;static#i=null;static async init({BASE_URL:t,navigateFunction:a,customConfig:n={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(a&&typeof a=="function")this.#i=a;else throw new Error("navigateFunction is required and must be a function");return t&&(this.CONFIG.BASE_URL=t),n&&Object.keys(n).length>0&&(this.CONFIG={...this.CONFIG,...n}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#m(),this.#u(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#u(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((t=null)=>{if(t){if(Gl(t)){console.log("[AuthController] Ignoring mvvLegit redirect to",t,"— keeping visitor on their public landing page");return}console.log("[AuthController] mvvLegit navigation to:",t),this.#r(t)}}).setOnState((t=null)=>{if(t)switch(console.log("[AuthController] Auth state changed:",t),t){case"AUTH":case 4:this.#_();break;case"UNAUTH":case 1:this.#y();break;case"UNVERF":case 2:this.#w();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#r(t){if(!this.#i){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",t);const a=t.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",a),this.#i(a)}static#l(){if(window.__m5tActiveOrgFetch)return;const t=window.fetch.bind(window);window.fetch=(a,n)=>{try{const o=typeof a=="string"?a:a?.url||"",s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);if(s&&o.startsWith(this.CONFIG.BASE_URL)){const r=new Headers(n&&n.headers||(a instanceof Request?a.headers:void 0));r.set("X-Active-Org",s),n={...n||{},headers:r}}}catch{}return t(a,n)},window.__m5tActiveOrgFetch=!0,console.log("[AuthController] Active-org fetch header installed")}static#m(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);t&&(this.#o=JSON.parse(t),console.log("[AuthController] Entity state loaded; hasEmail:",!!this.#o?.email))}catch(t){console.error("[AuthController] Error loading entity state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#o=null}this.#s=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.SCOPE);t&&(this.#a=JSON.parse(t),console.log("[AuthController] Scope state loaded (cached):",this.#a?.uiMode))}catch(t){console.error("[AuthController] Error loading scope state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE),this.#a=null}}static#c(t){try{this.#o=t,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(t)),console.log("[AuthController] Entity state saved")}catch(a){console.error("[AuthController] Error saving entity state:",a)}}static#d(){this.#o=null,this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}}static getEntity(){return this.#o}static#v(t){try{this.#a=t,localStorage.setItem(this.CONFIG.LS_KEYS.SCOPE,JSON.stringify(t))}catch(a){console.error("[AuthController] Error saving scope state:",a)}}static async fetchScope(){return typeof mvvLegit>"u"||!this.isAuthenticated()?(console.log("[AuthController] fetchScope skipped — not authenticated"),this.#a):this.#n?this.#n:(this.#n=this.#b().finally(()=>{this.#n=null}),this.#n)}static async#b(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),a=t?`?org=${encodeURIComponent(t)}`:"",n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.ME}${a}`);if(n.status===401||n.status===403)return console.warn("[AuthController] /me unauthorized — signing out"),this.doSignout(!0),null;if(!n.ok)return console.warn(`[AuthController] /me failed (${n.status}) — using cached scope`),this.#a;const o=await n.json();if(!o?.ok)return console.warn("[AuthController] /me returned not-ok — using cached scope"),this.#a;try{const s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);s&&o.activeOrg?.guid!==s&&(console.warn(`[AuthController] Stored active org not honored by /me${o.activeOrgError?" (activeOrgError)":""} — clearing`),localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG))}catch{}return this.#v(o),m.publish(g.AUTH_SCOPE_LOADED,o),console.log(`[AuthController] Scope loaded: ${o.uiMode} (${o.memberships?.length||0} org(s), ${o.managedClients?.length||0} client(s))`),o}catch(t){return console.error("[AuthController] fetchScope error:",t),this.#a}}static async setActiveOrg(t){try{t?localStorage.setItem(this.CONFIG.LS_KEYS.ACTIVE_ORG,t):localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}return this.fetchScope()}static getScope(){return this.#a}static getCapabilities(){return this.isPreviewingAsClient()?Ql({orgChannel:"managed_client",memberRole:"owner"}):this.#a?.capabilities||[]}static getUiMode(){return this.isPreviewingAsClient()?"managed":this.#a?.uiMode||"self_serve"}static getActiveOrg(){return this.#a?.activeOrg||null}static getMemberships(){return this.#a?.memberships||[]}static getManagedClients(){return this.#a?.managedClients||[]}static getStoredActiveOrg(){try{return localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{return null}}static#p="m5m_preview_as_client";static isPreviewingAsClient(){try{return sessionStorage.getItem(this.#p)==="1"&&!!this.#a?.activeOrg?.viaSubtree}catch{return!1}}static setPreviewAsClient(t){try{t?sessionStorage.setItem(this.#p,"1"):sessionStorage.removeItem(this.#p)}catch{}this.#a&&m.publish(g.AUTH_SCOPE_LOADED,this.#a)}static async doSignin(t,a){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a})}),o=await n.json();if(n.status===303)return console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#c(o.entity)),setTimeout(()=>{this.#r(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o};if(n.ok&&o.accessToken){console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#c(o.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),console.log("[AuthController] Explicitly navigating to home"),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}}return{ok:!1,error:o.error||"Sign in failed",data:o}}catch(n){return console.error("[AuthController] Signin error:",n),{ok:!1,error:n.message}}}static async doPasskeySignin(){if(!window.PublicKeyCredential)return{ok:!1,error:"Passkeys are not supported in this browser"};try{const{startAuthentication:t}=await j(async()=>{const{startAuthentication:i}=await Promise.resolve().then(()=>Qs);return{startAuthentication:i}},void 0,import.meta.url),a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_OPTIONS}`,{method:"POST"}),n=await a.json();if(!a.ok||!n.ok)return{ok:!1,error:n.error||"Could not start passkey sign-in"};let o;try{o=await t({optionsJSON:n.options})}catch(i){const l=i?.name==="NotAllowedError";return l||console.error("[AuthController] Passkey ceremony error:",i),{ok:!1,canceled:l,error:l?"Passkey sign-in was canceled":i.message||"Passkey sign-in failed"}}const s=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_VERIFY}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o})}),r=await s.json();if(!s.ok||!r.ok||!r.accessToken)return{ok:!1,error:r.error||"Passkey sign-in failed",data:r};mvvLegit.doSignin(r.accessToken),this.#c(r.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:r}}catch(t){return console.error("[AuthController] Passkey signin error:",t),{ok:!1,error:t.message}}}static async doSignout(t=!1){console.log("[AuthController] doSignout called, serverInitiated:",t);try{const a=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!a),!t&&a){const n=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(a)}`;if(console.log("[AuthController] Sending signout beacon to:",n),navigator.sendBeacon){const o=navigator.sendBeacon(n);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else a||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#d(),console.log("[AuthController] Stopping auth ping..."),this.#h(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(a){console.error("[AuthController] Signout error:",a),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(t){try{const a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await a.json();return a.ok&&n.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#c(n.entity),{ok:!0,data:n}):{ok:!1,error:n.error||"Sign up failed",data:n}}catch(a){return console.error("[AuthController] Signup error:",a),{ok:!1,error:a.message}}}static async doResetHash(t,a){try{const n=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a,modified_by:t})}),s=await o.json();return o.ok&&s.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:s}):{ok:!1,error:s.error||"Password reset failed",data:s}}catch(n){return console.error("[AuthController] Reset password error:",n),{ok:!1,error:n.message}}}static#g(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#f()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#h(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#f(){try{const t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);t.ok?console.log("[AuthController] Ping success"):(t.status===401||t.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(t){console.error("[AuthController] Ping error:",t)}}static setDeepLinkGuid(t){this.#s=t,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,t),console.log("[AuthController] Deep-link GUID stored:",t)}static getDeepLinkGuid(){return this.#s}static clearDeepLink(){this.#s=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#_(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),queueMicrotask(()=>this.fetchScope())}static#y(){console.log("[AuthController] User unauthenticated"),this.#h()}static#w(){console.log("[AuthController] User unverified")}static getAuthState(){try{const t=mvvLegit.getConf()?.LSKEY||"mvv",a=localStorage.getItem(t);if(!a)return"UNAUTH";if(typeof LZString>"u")return null;const n=LZString.decompressFromUTF16(a),s=JSON.parse(n)?.state;return s===1?"UNAUTH":s===2?"UNVERF":s===4?"AUTH":s===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(t){this.#r(t)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#f()}}class ${static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",remember_email:"Remember my email",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_dashboard:"Dashboard",nav_dashboard_tagline:"Overview of your activity",nav_magnets:"Your Magnets",nav_magnets_tagline:"Manage your conversational magnets",nav_templates:"Templates",nav_templates_tagline:"Start from a magnet template",nav_conversations:"Conversations",nav_conversations_tagline:"Captured lead conversations",nav_ab_testing:"A/B Testing",nav_ab_testing_tagline:"Experiment and optimize",nav_analytics:"Analytics",nav_analytics_tagline:"Performance and ad metrics",nav_ad_accounts:"Ad Accounts",nav_ad_accounts_tagline:"Connect advertising accounts",nav_clients:"Clients",nav_clients_tagline:"Manage your client accounts",nav_team:"Team",nav_team_tagline:"Invite and manage teammates",nav_billing:"Billing",nav_billing_tagline:"Plan, usage, and invoices",nav_settings:"Settings",nav_settings_tagline:"Account and workspace settings",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Rollers",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",remember_email:"Recordar mi correo electrónico",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Rollers",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",remember_email:"记住我的邮箱",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"滚动器",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:t,product:a,whitelabel:n,lang:o}){t&&(this.#t.buildMode=t),a&&(this.#t.product=a),n&&(this.#t.whitelabel=n),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{let l=this.#e[o]?.[s]?.[r]?.[i]?.[t],c=o;return!l&&o!=="LOCAL"&&(l=this.#e.LOCAL?.[s]?.[r]?.[i]?.[t],c="LOCAL (fallback)"),l?(c==="LOCAL (fallback)"&&console.warn(`[MicrocopyManager] Token '${t}' missing from ${o} — served from LOCAL instead. Backfill ${o}'s block if this is intentionally different copy.`),Array.isArray(l)?l[Math.floor(Math.random()*l.length)]:l):(console.warn(`[MicrocopyManager] Token not found: ${t} (${o}/${s}/${r}/${i}, LOCAL fallback also missing it)`),null)}catch(l){return console.error(`[MicrocopyManager] Error retrieving token: ${t}`,l),null}}static getAll(t={}){const a={...this.#t,...t},{buildMode:n,product:o,whitelabel:s,lang:r}=a;try{return this.#e[n]?.[o]?.[s]?.[r]||null}catch(i){return console.error("[MicrocopyManager] Error retrieving all tokens",i),null}}static has(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return!!this.#e[o]?.[s]?.[r]?.[i]?.[t]}catch{return!1}}static getAvailableLanguages(){const{buildMode:t,product:a,whitelabel:n}=this.#t;try{return Object.keys(this.#e[t]?.[a]?.[n]||{})}catch{return[]}}static update(t,a,n={}){const o={...this.#t,...n},{buildMode:s,product:r,whitelabel:i,lang:l}=o;try{return this.#e[s]||(this.#e[s]={}),this.#e[s][r]||(this.#e[s][r]={}),this.#e[s][r][i]||(this.#e[s][r][i]={}),this.#e[s][r][i][l]||(this.#e[s][r][i][l]={}),this.#e[s][r][i][l][t]=a,!0}catch(c){return console.error(`[MicrocopyManager] Error updating token: ${t}`,c),!1}}static delete(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return delete this.#e[o]?.[s]?.[r]?.[i]?.[t],!0}catch(l){return console.error(`[MicrocopyManager] Error deleting token: ${t}`,l),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(t){try{return this.#e=t,!0}catch(a){return console.error("[MicrocopyManager] Error importing data",a),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:$});class Ce{static#e=!1;static#t=null;static#o=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const t=this.#n();$.setContext(t),console.log("[I18nController] Initialized with context:",t),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#s(),this.#u(),this.#e=!0,this.refresh()}static#a(t){const a={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},n=t.toLowerCase();return a[n]||"DEV"}static#n(){const a=this.#a("production"),n=localStorage.getItem(U.FF_SSE_LS_WHITELABEL)||U.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(U.FF_SSE_LS_USER_LANG)||U.FF_SSE_I18N_LANG;return{buildMode:a,product:U.FF_SSE_I18N_PRODUCT,whitelabel:n,lang:o}}static#s(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((t,a,n)=>{U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",n),this.#t=n,setTimeout(()=>{this.refresh()},U.FF_SSE_I18N_APPLY_DELAY_MS)},U.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#i())}static#i(){setInterval(()=>{const a=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");a&&a!==this.#t&&(this.#t=a,this.refresh())},500)}static#u(){this.#o||(this.#o=new MutationObserver(t=>{let a=!1;for(const n of t){for(const o of n.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){a=!0;break}if(a)break}a&&(U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#o.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#r(document.body),this.#l(document.body),U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#r(t){const a=t.querySelectorAll("[data-meta-copywrite-i118n]");U.FF_SSE_I18N_DEBUG&&a.length>0&&console.log(`[I18nController] Processing ${a.length} elements`),a.forEach(n=>{try{const o=n.getAttribute("data-meta-copywrite-i118n"),s=JSON.parse(o);if(!s.token){console.warn("[I18nController] Missing token in config:",s);return}const r=s.attribute||"textContent",i=$.get(s.token);if(i===null){console.warn(`[I18nController] Microcopy not found for token: ${s.token}`);return}r==="textContent"?n.textContent=i:r==="innerHTML"?n.innerHTML=i:n.setAttribute(r,i),U.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${i}" to ${r} for token: ${s.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,n)}})}static#l(t){t.querySelectorAll("*").forEach(n=>{n.shadowRoot&&(this.#r(n.shadowRoot),this.#l(n.shadowRoot))})}static setLanguage(t){const a=$.getAvailableLanguages();if(!a.includes(t)){console.error(`[I18nController] Language not available: ${t}. Available:`,a);return}localStorage.setItem(U.FF_SSE_LS_USER_LANG,t),$.setContext({lang:t}),console.log("[I18nController] Language changed to:",t);const n=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:t}});document.dispatchEvent(n),this.refresh()}static setWhitelabel(t){localStorage.setItem(U.FF_SSE_LS_WHITELABEL,t),$.setContext({whitelabel:t}),U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",t),this.refresh()}static getLanguage(){return $.getContext().lang}static getAvailableLanguages(){return $.getAvailableLanguages()}static getContext(){return $.getContext()}static destroy(){this.#o&&(this.#o.disconnect(),this.#o=null),this.#e=!1,this.#t=null,U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{Ce.initialize()}):Ce.initialize());class Mn{static _initialized=!1;static _debug=!1;static init(t={}){if(this._initialized)return console.warn("[MachVive] Already initialized, skipping duplicate initialization"),this;if(this._debug=t.debug||!1,!window.mvvSSEther)return console.error("[MachVive] mvvSSEther not found - cannot initialize bridge"),console.error("[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()"),this;console.log("[MachVive] Initializing SSE to PubSub bridge...");const a=n=>{this._handleSSEMessage(n)};return window.mvvSSEther.onmessage(a),this._initialized=!0,console.log("[MachVive] ✓ SSE to PubSub bridge initialized successfully"),console.log("[MachVive] ✓ Bound callback to mvvSSEther.onmessage"),this}static _handleSSEMessage(t){try{this._debug&&console.log("[MachVive] SSE message received:",t);const a=t?.data;if(!a){this._debug&&console.log("[MachVive] No data in message, skipping");return}const n=a.data||a.package||a;if(!n){this._debug&&console.log("[MachVive] No package found in message, skipping");return}let o=n.cfg;const s=n.msg;if(this._debug&&(console.log("[MachVive] cfg (raw):",o,"type:",typeof o,"length:",o?.length),console.log("[MachVive] msg (raw):",s)),typeof o=="string"){if(o.trim()===""){this._debug&&console.log("[MachVive] cfg is empty string, skipping");return}try{o=JSON.parse(o),console.log("[MachVive] cfg (parsed):",o)}catch(i){console.warn("[MachVive] Failed to parse cfg as JSON:",{cfg:o,cfgLength:o.length,error:i.message});return}}else if(!o){this._debug&&console.log("[MachVive] cfg is empty/null, skipping");return}const r=o?.topic;if(!r){this._debug&&console.log("[MachVive] No topic found in cfg, skipping");return}if(console.log("[MachVive] Extracted topic:",r),!this._isValidTopic(r)){console.warn(`[MachVive] Topic '${r}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(r,s,t,a)}catch(a){console.error("[MachVive] Error handling SSE message:",a)}}static _isValidTopic(t){return!g||!g.hasOwnProperty(t)?(console.warn(`[MachVive] Topic '${t}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(t,a,n,o){try{if(!window.PubSub&&typeof PubSub>"u"){console.error("[MachVive] PubSub not available");return}const s=window.PubSub||PubSub,r={message:a,metadata:{source:"sse",sseEventId:n.id,timestamp:n.timestamp,appGuid:o.app_guid,channelGuid:o.channel_guid,eventAction:o.event_action,status:o.status,class:o.class,raw:o}};console.log(`[MachVive] Publishing to topic '${t}':`,r);const i=g[t];console.log(`[MachVive] AppBroadcast.${t} = '${i}'`),s.publish(i,r),console.log(`[MachVive] ✓ Published SSE message to topic: ${t}`)}catch(s){console.error(`[MachVive] Error publishing to topic '${t}':`,s)}}static debug(t){return this._debug=t,console.log(`[MachVive] Debug mode ${t?"enabled":"disabled"}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log("[MachVive] Reset complete"),this}}typeof module<"u"&&module.exports&&(module.exports=Mn);typeof window<"u"&&(window.MachVive=Mn);const mo="m5t_sidenav_collapsed",nc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};class oc extends HTMLElement{static get observedAttributes(){return["data-active-token","data-collapsed"]}constructor(){super(),this.attachShadow({mode:"open"}),this.items=[],this.orgs=[],this.activeOrgGuid=null,this.activeToken=null,this.footerBadge=null,this.loading=!1,this.lastFocus=null}#e=null;#t=t=>{if(this.getAttribute("data-open")==="true"){if(t.key==="Escape"){t.preventDefault(),this.closeDrawer();return}if(t.key==="Tab"){const a=this.#c();if(a.length<2)return;const n=a[0],o=a[a.length-1],s=this.shadowRoot.activeElement;t.shiftKey&&s===n?(t.preventDefault(),o.focus()):!t.shiftKey&&s===o&&(t.preventDefault(),n.focus())}}};#o=()=>{this.closeDrawer(),this.#d()};connectedCallback(){if(!this.hasAttribute("data-collapsed"))try{localStorage.getItem(mo)==="true"&&this.setAttribute("data-collapsed","true")}catch{}this.activeToken=this.getAttribute("data-active-token")||null,this.render(),this.#l(),this.addEventListener("keydown",this.#t),this.#e=window.matchMedia("(max-width: 768px)"),this.#e.addEventListener("change",this.#o),this.#d()}disconnectedCallback(){this.removeEventListener("keydown",this.#t),this.#e?.removeEventListener("change",this.#o)}attributeChangedCallback(t,a,n){a===n||!this.shadowRoot||(t==="data-active-token"?(this.activeToken=n,this.#m()):t==="data-collapsed"&&this.shadowRoot.firstChild&&(this.render(),this.#l()))}setState({buttons:t,orgs:a,activeOrg:n,footerBadge:o,loading:s}={}){t!==void 0&&(this.items=Array.isArray(t)?t:this.#a(t)||[]),a!==void 0&&(this.orgs=Array.isArray(a)?a:this.#a(a)||[]),n!==void 0&&(this.activeOrgGuid=n||null),o!==void 0&&(this.footerBadge=o||null),s!==void 0&&(this.loading=!!s),this.shadowRoot&&(this.render(),this.#l())}setButtons(t){this.setState({buttons:t})}setOrgs(t){this.setState({orgs:t})}setActiveOrgGuid(t){this.setState({activeOrg:t})}setFooterBadge(t){this.setState({footerBadge:t})}setActiveToken(t){this.activeToken=t||null,this.#m()}toggleCollapsed(t){const a=typeof t=="boolean"?t:this.getAttribute("data-collapsed")!=="true";this.setAttribute("data-collapsed",String(a));try{localStorage.setItem(mo,String(a))}catch{}this.dispatchEvent(new CustomEvent("nav-collapse",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_SIDE_NAV.COLLAPSE",collapsed:a,timestamp:Date.now()}}))}openDrawer(){this.lastFocus=this.shadowRoot.activeElement||document.activeElement,this.setAttribute("data-open","true"),this.shadowRoot.querySelector(".hamburger")?.setAttribute("aria-expanded","true"),this.#d(),(this.#c()[0]||this.shadowRoot.querySelector(".sidenav"))?.focus?.()}closeDrawer(){if(this.getAttribute("data-open")!=="true")return;this.removeAttribute("data-open");const t=this.shadowRoot.querySelector(".hamburger");t?.setAttribute("aria-expanded","false"),this.#d(),t&&this.#e?.matches?t.focus():this.lastFocus?.focus?.()}toggleDrawer(){this.getAttribute("data-open")==="true"?this.closeDrawer():this.openDrawer()}#a(t){try{return t?JSON.parse(t):null}catch(a){return console.error("[M5TSideNav] bad JSON:",a),null}}#n(t){return String(t??"").replace(/[&<>"']/g,a=>nc[a])}#s(t){return t?`<span class="ms" aria-hidden="true">${this.#n(t)}</span>`:""}#i(t){if(!t||!t.token)return"";const a=t.token===this.activeToken,n=t.route||"#",o=n.startsWith("#")?n:`#${n}`,s=typeof t.count=="number"&&t.count>0?`<span class="badge">${t.count}</span>`:"";return`
    ...
    `}attachEventListeners(){this.shadowRoot.querySelectorAll(".nav-button").forEach(n=>{const o=n.getAttribute("data-token"),s=n.getAttribute("data-level");n.addEventListener("click",r=>{o&&!r.currentTarget.disabled&&!this.longTapFired&&(s==="primary"?this.selectPrimaryButton(o):this.selectSecondaryButton(o)),this.longTapFired=!1}),n.addEventListener("dblclick",r=>{if(o&&!r.currentTarget.disabled){const i=this.getButtonData(o,s);console.log("[M5TPrimaryNav] Button double-clicked:",o),this.dispatchEvent(new CustomEvent("nav-double-tap",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.DOUBLE_TAP",token:o,level:s,caption:i.caption,tagline:i.tagline,timestamp:Date.now()}}))}}),n.addEventListener("mouseenter",r=>{if(o&&!r.currentTarget.disabled){const i=this.getButtonData(o,s);this.dispatchEvent(new CustomEvent("nav-hover",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.HOVER",token:o,level:s,caption:i.caption,tagline:i.tagline,action:"enter",timestamp:Date.now()}}))}}),n.addEventListener("mouseleave",r=>{if(o&&!r.currentTarget.disabled){const i=this.getButtonData(o,s);this.dispatchEvent(new CustomEvent("nav-hover",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.HOVER",token:o,level:s,caption:i.caption,tagline:i.tagline,action:"leave",timestamp:Date.now()}}))}}),n.addEventListener("mousedown",r=>{o&&!r.currentTarget.disabled&&(this.longTapActive=!0,this.longTapFired=!1,this.longTapTimer=setTimeout(()=>{const i=this.getButtonData(o,s);console.log("[M5TPrimaryNav] Button long-tap:",o),this.longTapFired=!0,this.dispatchEvent(new CustomEvent("nav-long-tap",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.LONG_TAP",token:o,level:s,caption:i.caption,tagline:i.tagline,timestamp:Date.now()}}))},this.longTapDelay))}),n.addEventListener("mouseup",r=>{this.longTapTimer&&(clearTimeout(this.longTapTimer),this.longTapTimer=null),this.longTapActive=!1}),n.addEventListener("mouseleave",r=>{this.longTapTimer&&(clearTimeout(this.longTapTimer),this.longTapTimer=null),this.longTapActive=!1})});const a=this.shadowRoot.querySelector(".logo");a&&a.addEventListener("click",()=>{console.log("[M5TPrimaryNav] Logo clicked"),this.logoTopic&&window.m5t?.pubsub?(console.log(`[M5TPrimaryNav] Publishing to topic: ${this.logoTopic}`),window.m5t.pubsub.publish(this.logoTopic,{timestamp:Date.now()})):this.logoTopic&&!window.m5t?.pubsub&&console.warn("[M5TPrimaryNav] Logo topic configured but window.m5t.pubsub not found"),this.dispatchEvent(new CustomEvent("logo-click",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.LOGO_TAP",timestamp:Date.now()}}))})}selectPrimaryButton(t){const a=this.buttons.find(o=>o.token===t),n=this.getButtonData(t,"primary");this.dispatchEvent(new CustomEvent("nav-select",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.TAP",token:t,level:"primary",caption:n.caption,tagline:n.tagline,hasSecondary:(a?.secondary?.length||0)>0,timestamp:Date.now()}})),this.selectedPrimaryToken!==t&&(this.selectedPrimaryToken=t,this.render(),this.attachEventListeners())}selectSecondaryButton(t){const a=this.getButtonData(t,"secondary");this.dispatchEvent(new CustomEvent("nav-select",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.TAP",token:t,primaryToken:this.selectedPrimaryToken,level:"secondary",caption:a.caption,tagline:a.tagline,timestamp:Date.now()}}))}updateButtons(t){this.setAttribute("data-buttons",JSON.stringify(t)),this.parseButtons(),this.render(),this.attachEventListeners()}updateCount(t,a,n="primary"){let o;n==="primary"?o=this.buttons.find(s=>s.token===t):o=this.getSecondaryButtons().find(r=>r.token===t),o&&(o.count=a,this.render(),this.attachEventListeners())}getSelection(){return{primary:this.selectedPrimaryToken,secondary:null}}}customElements.define("m5t-primary-nav",sc);const xt=()=>E.getConfig?.().BASE_URL||"",rc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},nt=e=>String(e??"").replace(/[&<>"']/g,t=>rc[t]),ic=300*1e3;function lc(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function cc(e){const t=`
      <div class="m5t-notif-title">${nt(e.title)}</div>
      ${e.body?`<div class="m5t-notif-body">${nt(e.body)}</div>`:""}
      <div class="m5t-notif-time">${nt(lc(e.created_tz))}</div>`;return`<div class="m5t-notif-item" data-guid="${nt(e.guid)}" data-read="${e.read}" role="menuitem">
    ${e.link?`<a class="m5t-notif-main m5t-notif-link" href="${nt(e.link)}">${t}</a>`:`<div class="m5t-notif-main">${t}</div>`}
    <button class="m5t-notif-dismiss" type="button" aria-label="Clear “${nt(e.title)}”" data-dismiss="${nt(e.guid)}">Clear</button>
  </div>`}const dc='<div class="m5t-notif-skel"><span></span><span></span><span></span></div>'.repeat(3),Ka=e=>e.dataset.open==="true",cn=(e,t)=>{e.dataset.open=t?"true":"false"};function pc(e){const t=document.getElementById("m5t-notif-bell");if(t&&(t.hidden=!e),!e){const a=document.getElementById("m5t-notif-panel");a&&cn(a,!1)}}const uc=14;let Ja=null,Qa=null;function mc(e){if(typeof ResizeObserver>"u"||!e)return;const t=document.getElementById("m5t-notif-bell"),a=document.getElementById("m5t-notif-bell-btn");if(!t||!a)return;const n=()=>{const o=e.hidden?null:e.querySelector(".ocb-btn");if(!o){t.style.top=`${uc}px`;return}const s=a.getBoundingClientRect().height;if(!s)return;const r=o.getBoundingClientRect();t.style.top=`${Math.round(r.top+(r.height-s)/2)}px`};Ja?.disconnect(),Ja=new ResizeObserver(n),Ja.observe(e),Qa?.disconnect(),Qa=new MutationObserver(n),Qa.observe(t,{attributes:!0,attributeFilter:["hidden"]}),n()}let go=null,aa=null,na=null;function gc(){const e=document.getElementById("m5t-notif-bell-btn"),t=document.getElementById("m5t-notif-badge"),a=document.getElementById("m5t-notif-panel");if(!e||!t||!a)return;const n=h=>{t.textContent=h>99?"99+":String(h),t.hidden=!h},o=async()=>{try{const h=await fetch(`${xt()}/m5t/v5/notifications/unread-count`),d=await h.json().catch(()=>({}));h.ok&&d.ok&&n(d.count||0)}catch{}},s=50,r=h=>{if(h.length>=s){o();return}n(h.filter(d=>!d.read).length)},i=(h="")=>`<div class="m5t-notif-head">Notifications${h?`<span class="m5t-notif-head__actions">${h}</span>`:""}</div>`,l=()=>{a.querySelectorAll(".m5t-notif-item, .m5t-notif-empty").forEach(h=>h.remove()),a.querySelector(".m5t-notif-head__actions")?.remove(),a.insertAdjacentHTML("beforeend",'<div class="m5t-notif-empty">You’re all caught up.</div>')},c=async()=>{a.innerHTML=i()+dc;try{const h=await fetch(`${xt()}/m5t/v5/notifications`),d=await h.json().catch(()=>({}));if(!h.ok||!d.ok)throw new Error;const f=d.notifications||[],p=[f.some(b=>!b.read)?'<button class="m5t-notif-markall" type="button">Mark all read</button>':"",f.length?'<button class="m5t-notif-clearall" type="button">Clear all</button>':""].join("");a.innerHTML=i(p)+(f.length?f.map(cc).join(""):'<div class="m5t-notif-empty">You’re all caught up.</div>'),r(f)}catch{a.innerHTML=i()+'<div class="m5t-notif-empty">Could not load. Try again.</div>'}},u=()=>{cn(a,!1),e.setAttribute("aria-expanded","false")},v=async()=>{cn(a,!0),e.setAttribute("aria-expanded","true"),await c()};e.addEventListener("click",h=>{h.stopPropagation(),Ka(a)?u():v()}),na&&document.removeEventListener("visibilitychange",na),na=()=>{document.visibilityState==="visible"&&o()},document.addEventListener("visibilitychange",na),aa&&document.removeEventListener("click",aa),aa=h=>{Ka(a)&&!a.contains(h.target)&&h.target!==e&&u()},document.addEventListener("click",aa),document.addEventListener("keydown",h=>{h.key==="Escape"&&Ka(a)&&(u(),e.focus())}),a.addEventListener("click",async h=>{const d=h.target.closest("[data-dismiss]");if(d){h.preventDefault(),h.stopPropagation();const y=d.closest(".m5t-notif-item"),w=d.dataset.dismiss,A=y?.dataset.read==="false";y?.setAttribute("data-leaving","true");try{await fetch(`${xt()}/m5t/v5/notifications/${encodeURIComponent(w)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:"DISMISSED"})})}catch{}setTimeout(()=>{y?.remove(),a.querySelector(".m5t-notif-item")||l()},180),A&&o();return}const f=h.target.closest(".m5t-notif-clearall");if(f){h.preventDefault(),f.disabled=!0,a.querySelectorAll(".m5t-notif-item").forEach(y=>y.setAttribute("data-leaving","true"));try{await fetch(`${xt()}/m5t/v5/notifications/dismiss-all`,{method:"PATCH"})}catch{}setTimeout(l,180),o();return}const p=h.target.closest(".m5t-notif-item");if(p&&p.dataset.read==="false"){const y=p.dataset.guid;p.dataset.read="true";try{await fetch(`${xt()}/m5t/v5/notifications/${encodeURIComponent(y)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({read:!0})}),o()}catch{}return}const b=h.target.closest(".m5t-notif-markall");if(b){h.preventDefault(),a.querySelectorAll(".m5t-notif-item").forEach(y=>{y.dataset.read="true"}),b.remove();try{await fetch(`${xt()}/m5t/v5/notifications/read-all`,{method:"PATCH"})}catch{}o()}}),o(),clearInterval(go),go=setInterval(o,ic)}function Ra(){return Rn("FF_SSE_UI_DARK_MODE")}function hc(e=Ra()){return e&&localStorage.getItem(U.FF_SSE_LS_THEME)==="dark"?"dark":"light"}function fc(e=Rn("FF_SSE_UI_ANIMATIONS")){return!e}function vc(e,t=Ra()){!e||t||e.shadowRoot?.querySelector('.footer-action[data-action="theme"]')?.remove()}function qs(e){document.documentElement.setAttribute("data-theme",e)}function bc(){qs(hc())}function Vt(){return document.documentElement.getAttribute("data-theme")==="dark"?"dark":"light"}function Us(e,{quiet:t=!1}={}){if(!Ra())return;const a=e==="dark"?"dark":"light";a!==Vt()&&(qs(a),localStorage.setItem(U.FF_SSE_LS_THEME,a),t||m.publish(g.UI_TOAST,{message:a==="dark"?"Dark mode on":"Dark mode off",type:"info"}),m.publish(g.UI_THEME_CHANGED,{theme:a}))}function _c(){Us(Vt()==="dark"?"light":"dark")}window.m5t=Object.create(null);window.m5t.pubsub=m;console.log("StreamSyncEngage SaaS Client - Starting...");console.log("Environment:","production");console.log("Document readyState:",document.readyState);console.log("window.mvvLegit:",typeof window.mvvLegit);console.log("globalThis.mvvLegit:",typeof globalThis.mvvLegit);try{console.log("mvvLegit (direct):",typeof mvvLegit)}catch(e){console.log("mvvLegit (direct): ReferenceError -",e.message)}const yc=Object.keys(window).filter(e=>e.toLowerCase().includes("mvv")||e.toLowerCase().includes("neodigm")||e.toLowerCase().includes("legit"));console.log("Possible Neodigm globals:",yc);const P=new Al("/",{hash:!0});window.router=P;function ie(e){const t=e?`${e.replace(/-/g,"_")}_route`:"splash_route";return console.log(`[Router] Checking access: ${e} -> ${t}`),mvvLegit.isRouteAllowed(t)?!0:(console.warn(`[Router] Access denied to route: ${t}`),m.publish(g.UI_TOAST,{message:"Please sign in to access this page",type:"warning"}),!1)}function te(e){console.log("[Router] Navigating to:",e),P.navigate(`/${e}`)}const Pn=new Set(["splash","signin","signup","forgot","resethash","verf-link","accept-invite","signout"]);let zt={},dn={},gt=null;const wc={admin:{caption:"Platform Admin",icon:"shield_person"},reseller:{caption:"Reseller",icon:"handshake"},managed:{caption:"Managed",icon:"visibility"},self_serve:{caption:"Self-Serve",icon:"rocket_launch"}},pn="__portfolio__";function zs(){try{P._setCurrent(null)}catch{}P.resolve()}function Xa(){const e=document.getElementById("m5t-side-nav");if(!e)return;const t=!E.getScope()&&E.isAuthenticated(),a=E.getCapabilities(),n=E.getUiMode(),o=Ia.getSideNav(a,{uiMode:n});zt={},dn={};const s=h=>{h.route&&(zt[h.route]={sectionToken:h.token,childToken:null,children:h.children||null},Array.isArray(h.children)&&h.children.forEach(d=>{d.route&&(dn[d.token]=d.route,zt[d.route]={sectionToken:h.token,childToken:d.token,children:h.children})}))},r=h=>h.forEach(d=>{d.group&&Array.isArray(d.items)?r(d.items):s(d)});r(o);const i=E.getMemberships(),l=E.getActiveOrg(),c=E.getManagedClients(),u=E.getStoredActiveOrg(),v=c.length?[{guid:pn,name:"Portfolio (all clients)"},...i.map(h=>({guid:h.orgGuid,name:h.name||h.channel,channel:h.channel,group:"Your organization"})),...c.map(h=>({guid:h.orgGuid,name:h.name||h.orgGuid,channel:h.channel,group:"Clients"}))]:i.map(h=>({guid:h.orgGuid,name:h.name||h.channel,channel:h.channel}));e.setState({buttons:o,orgs:v,activeOrg:c.length?u||pn:l?.guid||null,footerBadge:wc[n]||null,loading:t}),Hs(),gt&&Gs(gt)}const xc=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]);function Hs(){const e=document.getElementById("app-content");if(!e)return;let t=document.getElementById("org-context-banner");t||(t=document.createElement("div"),t.id="org-context-banner",e.insertBefore(t,e.firstChild),mc(t));const a=E.getActiveOrg(),n=E.isPreviewingAsClient(),o=!!a?.viaSubtree&&!!gt&&!Pn.has(gt);if(t.hidden=!o,!o){t.innerHTML="";return}const s=xc(a.name||"Client");t.innerHTML=`
    <style>
    ...
    <div class="ocb" role="status">
    ...
    </div>`,t.querySelector('[data-ocb="preview"]')?.addEventListener("click",()=>{E.setPreviewAsClient(!E.isPreviewingAsClient()),zs()}),t.querySelector('[data-ocb="portfolio"]')?.addEventListener("click",()=>{E.setPreviewAsClient(!1),E.setActiveOrg(null)})}function Gs(e){const t=document.getElementById("m5t-side-nav"),a=zt[`/${e}`]||zt[e]||null;t?.setActiveToken(a?.sectionToken||null),Ec(a)}function Ec(e){const t=document.getElementById("m5t-sub-nav"),a=document.getElementById("app-shell");if(!t)return;const n=e?.children;t.hidden=!1,n&&n.length>1?(t.updateButtons(n.map(o=>({token:o.token,caption:o.caption,enabled:!0,selected:o.token===e.childToken}))),a?.classList.add("has-sub-nav")):(t.updateButtons([]),a?.classList.remove("has-sub-nav"))}function kc(){const e=Ce.getAvailableLanguages&&Ce.getAvailableLanguages()||[];if(e.length<2){m.publish(g.UI_TOAST,{message:"Only one language is available",type:"info"});return}const t=localStorage.getItem(U.FF_SSE_LS_USER_LANG)||U.FF_SSE_I18N_LANG||e[0],a=e[(e.indexOf(t)+1)%e.length];Ce.setLanguage(a),m.publish(g.UI_TOAST,{message:`Language: ${a}`,type:"info"})}function Ac(){document.documentElement.classList.toggle("ff-no-animations",fc())}function Sc(){const e=document.getElementById("m5t-side-nav");if(!e)return;Ia.setAppToken("client-saas"),vc(e),document.getElementById("app-shell")?.classList.toggle("nav-collapsed",e.getAttribute("data-collapsed")==="true"),e.addEventListener("nav-select",o=>{const s=o.detail?.route;s&&P.navigate(s.startsWith("/")?s:`/${s}`)}),e.addEventListener("logo-click",()=>P.navigate("/home")),e.addEventListener("nav-collapse",o=>{document.getElementById("app-shell")?.classList.toggle("nav-collapsed",!!o.detail?.collapsed)}),e.addEventListener("org-switch",o=>{const s=o.detail?.orgGuid;s&&E.setActiveOrg(s===pn?null:s)}),e.addEventListener("footer-action",o=>{switch(o.detail?.action){case"account":P.navigate("/settings");break;case"signout":P.navigate("/signout");break;case"lang":kc();break;case"theme":_c();break}}),document.getElementById("m5t-sub-nav")?.addEventListener("nav-select",o=>{const s=dn[o.detail?.token];s&&P.navigate(s)}),document.addEventListener("language-changed",()=>Xa()),Xa(),m.subscribe(g.AUTH_SCOPE_LOADED,()=>Xa());const a=()=>{const o=E.getScope();return[o?.uiMode,o?.activeOrg?.guid,(o?.managedClients||[]).length,(o?.capabilities||[]).join(","),E.getStoredActiveOrg()].join("|")};let n=a();m.subscribe(g.AUTH_SCOPE_LOADED,()=>{const o=a();o!==n&&(n=o,gt&&!Pn.has(gt)&&zs())})}function Cc(e){gt=e;const t=document.getElementById("m5t-side-nav"),a=document.getElementById("app-shell");if(!t||!a)return;const n=!Pn.has(e);if(t.hidden=!n,a.classList.toggle("has-side-nav",n),pc(n),n)Gs(e);else{const o=document.getElementById("m5t-sub-nav");o&&(o.hidden=!0),a.classList.remove("has-sub-nav")}Hs()}m.subscribe(g.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&Cc(t.route)});const js=()=>{console.log("[Router] Route: splash"),m.publish(g.ROUTE_NAV_BEFORE,{route:"splash"});const e=Ds()?.name;(e==="invite"?j(()=>Promise.resolve().then(()=>qc),void 0,import.meta.url):e==="questionnaire"?j(()=>Promise.resolve().then(()=>Gc),void 0,import.meta.url):j(()=>Promise.resolve().then(()=>Wc),void 0,import.meta.url)).then(a=>{const n=document.getElementById("app");n.innerHTML=a.render(),a.init&&a.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"splash"})}).catch(a=>{console.error("[Router] Error loading splash route:",a),m.publish(g.ROUTE_NAV_ERROR,{route:"splash",error:a})})};P.on("/",js);P.on("/splash",js);P.on("/signin",()=>{console.log("[Router] Route: /signin"),m.publish(g.ROUTE_NAV_BEFORE,{route:"signin"}),j(()=>Promise.resolve().then(()=>ed),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"signin"})}).catch(e=>{console.error("[Router] Error loading signin route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"signin",error:e})})});P.on("/signup",()=>{console.log("[Router] Route: /signup"),m.publish(g.ROUTE_NAV_BEFORE,{route:"signup"}),j(()=>Promise.resolve().then(()=>rd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"signup"})}).catch(e=>{console.error("[Router] Error loading signup route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"signup",error:e})})});P.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),m.publish(g.ROUTE_NAV_BEFORE,{route:"verf-link"}),j(()=>Promise.resolve().then(()=>cd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(e=>{console.error("[Router] Error loading verf-link route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"verf-link",error:e})})});P.on("/forgot",()=>{console.log("[Router] Route: /forgot"),m.publish(g.ROUTE_NAV_BEFORE,{route:"forgot"}),j(()=>Promise.resolve().then(()=>fd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(e=>{console.error("[Router] Error loading forgot route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"forgot",error:e})})});P.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!ie("resethash")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"resethash"}),j(()=>Promise.resolve().then(()=>_d),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(e=>{console.error("[Router] Error loading resethash route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"resethash",error:e})})});P.on("/home",()=>{if(console.log("[Router] Route: /home"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"home"}),j(()=>Promise.resolve().then(()=>Od),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"home"})}).catch(e=>{console.error("[Router] Error loading home route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"home",error:e})})});P.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!ie("signout")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"signout"}),j(()=>Promise.resolve().then(()=>Fd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"signout"})}).catch(e=>{console.error("[Router] Error loading signout route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"signout",error:e})})});const Tc=[{path:"/analytics",name:"analytics",title:"Analytics",icon:"monitoring"},{path:"/billing",name:"billing",title:"Billing",icon:"receipt_long"},{path:"/magnets/drafts",name:"magnets/drafts",title:"Magnets · Drafts",icon:"widgets"},{path:"/magnets/archived",name:"magnets/archived",title:"Magnets · Archived",icon:"widgets"},{path:"/analytics/conversions",name:"analytics/conversions",title:"Analytics · Conversions",icon:"monitoring"}];Tc.forEach(({path:e,name:t,title:a,icon:n})=>{P.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:t}),j(()=>Promise.resolve().then(()=>qd),void 0,import.meta.url).then(o=>{const s=document.getElementById("app");s.innerHTML=o.render({title:a,icon:n,name:t}),o.init&&o.init({name:t}),m.publish(g.ROUTE_NAV_AFTER,{route:t})}).catch(o=>{console.error(`[Router] Error loading section route (${t}):`,o),m.publish(g.ROUTE_NAV_ERROR,{route:t,error:o})})})});P.on("/settings",()=>{if(console.log("[Router] Route: /settings"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"settings"}),j(()=>Promise.resolve().then(()=>Xd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"settings"})}).catch(e=>{console.error("[Router] Error loading settings-general route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"settings",error:e})})});P.on("/settings/workspace",()=>{if(console.log("[Router] Route: /settings/workspace"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"settings/workspace"}),j(()=>Promise.resolve().then(()=>pp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"settings/workspace"})}).catch(e=>{console.error("[Router] Error loading settings-workspace route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"settings/workspace",error:e})})});P.on("/settings/notifications",()=>{if(console.log("[Router] Route: /settings/notifications"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"settings/notifications"}),j(()=>Promise.resolve().then(()=>_p),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"settings/notifications"})}).catch(e=>{console.error("[Router] Error loading settings-notifications route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"settings/notifications",error:e})})});P.on("/settings/integrations",()=>{if(console.log("[Router] Route: /settings/integrations"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),j(()=>Promise.resolve().then(()=>Hp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(e=>{console.error("[Router] Error loading settings-integrations route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"settings/integrations",error:e})})});P.on("/settings/integrations/:provider",e=>{const t=e?.data?.provider||"";if(console.log("[Router] Route: /settings/integrations/"+t),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),j(()=>Promise.resolve().then(()=>au),void 0,import.meta.url).then(a=>{const n=document.getElementById("app");n.innerHTML=a.render({provider:t}),a.init&&a.init({provider:t}),m.publish(g.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(a=>{console.error("[Router] Error loading integration detail route:",a),m.publish(g.ROUTE_NAV_ERROR,{route:"settings/integrations",error:a})})});P.on("/settings/security",()=>{if(console.log("[Router] Route: /settings/security"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"settings/security"}),j(()=>Promise.resolve().then(()=>mu),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"settings/security"})}).catch(e=>{console.error("[Router] Error loading settings-security route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"settings/security",error:e})})});P.on("/conversations",()=>{if(console.log("[Router] Route: /conversations"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"conversations"}),j(()=>Promise.resolve().then(()=>Eu),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"conversations"})}).catch(e=>{console.error("[Router] Error loading conversations route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"conversations",error:e})})});P.on("/ab-testing",()=>{if(console.log("[Router] Route: /ab-testing"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"ab-testing"}),j(()=>Promise.resolve().then(()=>Fu),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"ab-testing"})}).catch(e=>{console.error("[Router] Error loading ab-testing route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"ab-testing",error:e})})});P.on("/magnets",()=>{if(console.log("[Router] Route: /magnets"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"magnets"}),j(()=>Promise.resolve().then(()=>Hm),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"magnets"})}).catch(e=>{console.error("[Router] Error loading magnets route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"magnets",error:e})})});P.on("/templates",()=>{if(console.log("[Router] Route: /templates"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"templates"}),j(()=>Promise.resolve().then(()=>Jm),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"templates"})}).catch(e=>{console.error("[Router] Error loading templates route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"templates",error:e})})});P.on("/questionnaires",()=>{if(console.log("[Router] Route: /questionnaires"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"questionnaires"}),j(()=>Promise.resolve().then(()=>ig),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"questionnaires"})}).catch(e=>{console.error("[Router] Error loading questionnaires route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"questionnaires",error:e})})});P.on("/leads",()=>{if(console.log("[Router] Route: /leads"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"leads"}),j(()=>Promise.resolve().then(()=>Eg),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"leads"})}).catch(e=>{console.error("[Router] Error loading leads route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"leads",error:e})})});P.on("/analytics/ad-performance",()=>{if(console.log("[Router] Route: /analytics/ad-performance"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"analytics/ad-performance"}),j(()=>Promise.resolve().then(()=>Rg),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"analytics/ad-performance"})}).catch(e=>{console.error("[Router] Error loading ad-performance route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"analytics/ad-performance",error:e})})});P.on("/ad-accounts",()=>{if(console.log("[Router] Route: /ad-accounts"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"ad-accounts"}),j(()=>Promise.resolve().then(()=>Vg),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"ad-accounts"})}).catch(e=>{console.error("[Router] Error loading ad-accounts route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"ad-accounts",error:e})})});P.on("/clients",()=>{if(console.log("[Router] Route: /clients"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"clients"}),j(()=>Promise.resolve().then(()=>oh),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"clients"})}).catch(e=>{console.error("[Router] Error loading clients route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"clients",error:e})})});P.on("/team",()=>{if(console.log("[Router] Route: /team"),!ie("home")){te("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"team"}),j(()=>Promise.resolve().then(()=>mh),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"team"})}).catch(e=>{console.error("[Router] Error loading team route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"team",error:e})})});P.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),te("splash")});m.subscribe(g.ROUTE_NAV,(e,t)=>{console.log("[Router] ROUTE_NAV event received:",t),t?.route&&te(t.route)});function ho(){console.log("[App] Waiting for Neodigm 55 library...");let e=0;const t=100,a=setInterval(()=>{e++,e%10===0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(a),$c()):e>=t&&(clearInterval(a),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
      ...
      `,m.publish(g.APP_ERROR,{message:"Failed to load authentication library"}))},100)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ho):ho();async function $c(){if(console.log("[App] Neodigm 55 loaded, initializing..."),bc(),Ac(),Fl(),Ce.initialize(),console.log("[App] I18n Controller initialized"),!await E.init({BASE_URL:"https://machfivemagnet-saas.onrender.com",navigateFunction:a=>{console.log("[AuthController] Navigation requested:",a),te(a)}})){console.error("[App] AuthController initialization failed");return}const t=E.getEntity();t&&(console.log("[App] Session restored for:",t.email),m.publish(g.APP_USER_LOADED,{entity:t}),E.isAuthenticated()&&(localStorage.getItem(E.CONFIG.LS_KEYS.ACTIVE_ORG)?await E.fetchScope():E.fetchScope())),m.publish(g.APP_READY,{timestamp:new Date().toISOString(),sessionUser:t}),Sc(),gc(),P.resolve(),window.AuthController=E,window.I18nController=Ce,window.MachVive=Mn,console.log("[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)")}m.subscribe(g.ROUTE_NAV_AFTER,(e,t)=>{typeof Ce<"u"&&Ce.refresh&&setTimeout(()=>{Ce.refresh()},100)});function Re(e){const t=new Uint8Array(e);let a="";for(const o of t)a+=String.fromCharCode(o);return btoa(a).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"")}function Wt(e){const t=e.replace(/-/g,"+").replace(/_/g,"/"),a=(4-t.length%4)%4,n=t.padEnd(t.length+a,"="),o=atob(n),s=new ArrayBuffer(o.length),r=new Uint8Array(s);for(let i=0;i<o.length;i++)r[i]=o.charCodeAt(i);return s}function Zt(){return Vs.stubThis(globalThis?.PublicKeyCredential!==void 0&&typeof globalThis.PublicKeyCredential=="function")}const Vs={stubThis:e=>e};function Ws(e){const{id:t}=e;return{...e,id:Wt(t),transports:e.transports}}function Ys(e){return e==="localhost"||/^((xn--[a-z0-9-]+|[a-z0-9]+(-[a-z0-9]+)*)\.)+([a-z]{2,}|xn--[a-z0-9-]+)$/i.test(e)}class ce extends Error{constructor({message:t,code:a,cause:n,name:o}){super(t,{cause:n}),Object.defineProperty(this,"code",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),this.name=o??n.name,this.code=a}}function Lc({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new ce({message:"Registration ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else if(e.name==="ConstraintError"){if(a.authenticatorSelection?.requireResidentKey===!0)return new ce({message:"Discoverable credentials were required but no available authenticator supported it",code:"ERROR_AUTHENTICATOR_MISSING_DISCOVERABLE_CREDENTIAL_SUPPORT",cause:e});if(t.mediation==="conditional"&&a.authenticatorSelection?.userVerification==="required")return new ce({message:"User verification was required during automatic registration but it could not be performed",code:"ERROR_AUTO_REGISTER_USER_VERIFICATION_FAILURE",cause:e});if(a.authenticatorSelection?.userVerification==="required")return new ce({message:"User verification was required but no available authenticator supported it",code:"ERROR_AUTHENTICATOR_MISSING_USER_VERIFICATION_SUPPORT",cause:e})}else{if(e.name==="InvalidStateError")return new ce({message:"The authenticator was previously registered",code:"ERROR_AUTHENTICATOR_PREVIOUSLY_REGISTERED",cause:e});if(e.name==="NotAllowedError")return new ce({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="NotSupportedError")return a.pubKeyCredParams.filter(o=>o.type==="public-key").length===0?new ce({message:'No entry in pubKeyCredParams was of type "public-key"',code:"ERROR_MALFORMED_PUBKEYCREDPARAMS",cause:e}):new ce({message:"No available authenticator supported any of the specified pubKeyCredParams algorithms",code:"ERROR_AUTHENTICATOR_NO_SUPPORTED_PUBKEYCREDPARAMS_ALG",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if(Ys(n)){if(a.rp.id!==n)return new ce({message:`The RP ID "${a.rp.id}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new ce({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="TypeError"){if(a.user.id.byteLength<1||a.user.id.byteLength>64)return new ce({message:"User ID was not between 1 and 64 characters",code:"ERROR_INVALID_USER_ID_LENGTH",cause:e})}else if(e.name==="UnknownError")return new ce({message:"The authenticator was unable to process the specified options, or could not create a new credential",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}class Ic{constructor(){Object.defineProperty(this,"controller",{enumerable:!0,configurable:!0,writable:!0,value:void 0})}createNewAbortSignal(){if(this.controller){const a=new Error("Cancelling existing WebAuthn API call for new one");a.name="AbortError",this.controller.abort(a)}const t=new AbortController;return this.controller=t,t.signal}cancelCeremony(){if(this.controller){const t=new Error("Manually cancelling existing WebAuthn API call");t.name="AbortError",this.controller.abort(t),this.controller=void 0}}}const Fn=new Ic,Rc=["cross-platform","platform"];function Ks(e){if(e&&!(Rc.indexOf(e)<0))return e}async function Nc(e){!e.optionsJSON&&e.challenge&&(console.warn("startRegistration() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useAutoRegister:a=!1}=e;if(!Zt())throw new Error("WebAuthn is not supported in this browser");const n={...t,challenge:Wt(t.challenge),user:{...t.user,id:Wt(t.user.id)},excludeCredentials:t.excludeCredentials?.map(Ws)},o={};a&&(o.mediation="conditional"),o.publicKey=n,o.signal=Fn.createNewAbortSignal();let s;try{s=await navigator.credentials.create(o)}catch(f){throw Lc({error:f,options:o})}if(!s)throw new Error("Registration was not completed");const{id:r,rawId:i,response:l,type:c}=s;let u;typeof l.getTransports=="function"&&(u=l.getTransports());let v;if(typeof l.getPublicKeyAlgorithm=="function")try{v=l.getPublicKeyAlgorithm()}catch(f){Za("getPublicKeyAlgorithm()",f)}let h;if(typeof l.getPublicKey=="function")try{const f=l.getPublicKey();f!==null&&(h=Re(f))}catch(f){Za("getPublicKey()",f)}let d;if(typeof l.getAuthenticatorData=="function")try{d=Re(l.getAuthenticatorData())}catch(f){Za("getAuthenticatorData()",f)}return{id:r,rawId:Re(i),response:{attestationObject:Re(l.attestationObject),clientDataJSON:Re(l.clientDataJSON),transports:u,publicKeyAlgorithm:v,publicKey:h,authenticatorData:d},type:c,clientExtensionResults:s.getClientExtensionResults(),authenticatorAttachment:Ks(s.authenticatorAttachment)}}function Za(e,t){console.warn(`The browser extension that intercepted this WebAuthn API call incorrectly implemented ${e}. You should report this error to them.
`,t)}function Js(){if(!Zt())return da.stubThis(new Promise(t=>t(!1)));const e=globalThis.PublicKeyCredential;return e?.isConditionalMediationAvailable===void 0?da.stubThis(new Promise(t=>t(!1))):da.stubThis(e.isConditionalMediationAvailable())}const da={stubThis:e=>e};function Oc({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new ce({message:"Authentication ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else{if(e.name==="NotAllowedError")return new ce({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if(Ys(n)){if(a.rpId!==n)return new ce({message:`The RP ID "${a.rpId}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new ce({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="UnknownError")return new ce({message:"The authenticator was unable to process the specified options, or could not create a new assertion signature",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}async function Mc(e){!e.optionsJSON&&e.challenge&&(console.warn("startAuthentication() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useBrowserAutofill:a=!1,verifyBrowserAutofillInput:n=!0}=e;if(!Zt())throw new Error("WebAuthn is not supported in this browser");let o;t.allowCredentials?.length!==0&&(o=t.allowCredentials?.map(Ws));const s={...t,challenge:Wt(t.challenge),allowCredentials:o},r={};if(a){if(!await Js())throw Error("Browser does not support WebAuthn autofill");if(document.querySelectorAll("input[autocomplete$='webauthn']").length<1&&n)throw Error('No <input> with "webauthn" as the only or last value in its `autocomplete` attribute was detected');r.mediation="conditional",s.allowCredentials=[]}r.publicKey=s,r.signal=Fn.createNewAbortSignal();let i;try{i=await navigator.credentials.get(r)}catch(d){throw Oc({error:d,options:r})}if(!i)throw new Error("Authentication was not completed");const{id:l,rawId:c,response:u,type:v}=i;let h;return u.userHandle&&(h=Re(u.userHandle)),{id:l,rawId:Re(c),response:{authenticatorData:Re(u.authenticatorData),clientDataJSON:Re(u.clientDataJSON),signature:Re(u.signature),userHandle:h},type:v,clientExtensionResults:i.getClientExtensionResults(),authenticatorAttachment:Ks(i.authenticatorAttachment)}}function Pc(){return Zt()?PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable():new Promise(e=>e(!1))}const Qs=Object.freeze(Object.defineProperty({__proto__:null,WebAuthnAbortService:Fn,WebAuthnError:ce,_browserSupportsWebAuthnAutofillInternals:da,_browserSupportsWebAuthnInternals:Vs,base64URLStringToBuffer:Wt,browserSupportsWebAuthn:Zt,browserSupportsWebAuthnAutofill:Js,bufferToBase64URLString:Re,platformAuthenticatorIsAvailable:Pc,startAuthentication:Mc,startRegistration:Nc},Symbol.toStringTag,{value:"Module"}));let fo=!1;function Fc(){if(fo)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
    .accept-invite-page {
  ...
  `,document.head.appendChild(e),fo=!0}function Dc(){const e=new URLSearchParams(window.location.search||"");let t=e.get("uid")||"",a=e.get("token")||"";if(!t||!a){const n=window.location.hash||"",o=n.includes("?")?n.slice(n.indexOf("?")+1):"",s=new URLSearchParams(o);if(t=t||s.get("uid")||"",a=a||s.get("token")||"",!t||!a){const r=n.replace(/^#\/?/,"").split("?")[0].split("/").filter(Boolean);t=t||r[1]||"",a=a||r[2]||""}}try{return{uid:decodeURIComponent(t),token:decodeURIComponent(a)}}catch{return{uid:t,token:a}}}function Xs(){return Fc(),`
    ...
    </div>`}function Zs(){const{uid:e,token:t}=Dc(),a=document.getElementById("accept-invite-form"),n=document.getElementById("ai-pass"),o=document.getElementById("ai-confirm"),s=document.getElementById("ai-submit"),r=document.getElementById("ai-msg");if(!a)return;const i=(l,c="error")=>{r.textContent=l,r.className=`accept-invite-msg ${c}`};if(!e||!t){i("This invitation link is invalid or incomplete. Please use the link from your email."),s.disabled=!0;return}a.addEventListener("submit",async l=>{l.preventDefault();const c=n.value||"",u=o.value||"";if(c.length<8){i("Password must be at least 8 characters.");return}if(c!==u){i("Passwords do not match.");return}s.disabled=!0,i("Setting up your account…","ok");try{const v=E.getConfig?.().BASE_URL||"",h=await fetch(`${v}/m5t/v5/acctEntity/acceptInvite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({uid:e,token:t,password:c})}),d=await h.json().catch(()=>({}));if(!h.ok||!d.ok){const p=h.status===410?"This invitation has expired. Ask for a new one.":h.status===409?"This invitation has already been used. Try signing in.":d.error||`Could not accept the invitation (HTTP ${h.status}).`;i(p),s.disabled=!1;return}try{window.history.replaceState({},"",window.location.pathname+window.location.hash)}catch{}i("Welcome! Signing you in…","ok"),(await E.doSignin(d.entity.email,c))?.ok||(i("Your account is ready. Please sign in.","ok"),setTimeout(()=>{window.location.hash="#/signin"},1200))}catch(v){console.error("[accept-invite] error:",v),i("Something went wrong. Please try again."),s.disabled=!1}})}const Bc={render:Xs,init:Zs},qc=Object.freeze(Object.defineProperty({__proto__:null,default:Bc,init:Zs,render:Xs},Symbol.toStringTag,{value:"Module"}));let vo=!1;function Uc(){if(vo)return;const e=document.createElement("style");e.id="m5t-questionnaire-fill-styles",e.textContent=`
    .qf-page {
  ...
  `,document.head.appendChild(e),vo=!0}function bo(){return E.getConfig?.().BASE_URL||""}function zc(e){const t=`qf-${e.id}`;if(e.type==="checkbox_group"){const a=Array.isArray(e.options)?e.options:[];return`
    ...
    </div>`}function He(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Dt(e,t,a){return`
    <div class="qf-page"><div class="qf-card"><div class="qf-state">
      <span class="material-symbols-outlined">${e}</span>
      <h1>${He(t)}</h1>
      <p class="qf-sub">${He(a)}</p>
    </div></div></div>`}function er(){return Uc(),`<div id="qf-root">${Dt("hourglass_top","Loading your questionnaire…","One moment.")}</div>`}async function tr(){const e=document.getElementById("qf-root");if(!e)return;const t=ql();if(!t){e.innerHTML=Dt("error","Invalid link","This link is missing required information. Please use the link exactly as sent.");return}let a;try{const c=await fetch(`${bo()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(t.guid)}?token=${encodeURIComponent(t.token)}`),u=await c.json().catch(()=>({}));if(!c.ok||!u.ok){const v=c.status===404?u.error||"This link is invalid or has expired.":"Something went wrong loading your questionnaire. Please try again shortly.";e.innerHTML=Dt("error","Cannot open this questionnaire",v);return}a=u.data}catch(c){console.error("[questionnaire-fill] load error:",c),e.innerHTML=Dt("wifi_off","Connection problem","Could not reach the server. Please check your connection and try again.");return}const n=a.questionnaire?.sections||[],o=a.answers||{};e.innerHTML=`
      ...
      <form id="qf-form" novalidate>
        ${n.map(c=>`
          <div class="qf-section">
            <h2>${He(c.title)}</h2>
            ${(c.questions||[]).map(zc).join("")}
          </div>`).join("")}
        <button class="qf-btn" type="submit" id="qf-submit">Submit questionnaire</button>
        <p class="qf-msg" id="qf-msg" role="status"></p>
      </form>
    </div></div>`,e.querySelectorAll("[data-question-id]").forEach(c=>{const u=c.dataset.questionId,v=c.dataset.questionType,h=o[u];if(h!=null)if(v==="checkbox_group"){const d=Array.isArray(h)?h:[];c.querySelectorAll('input[type="checkbox"]').forEach(f=>{f.checked=d.includes(f.value)})}else{const d=c.querySelector("input,textarea");d&&(d.value=h)}});const s=document.getElementById("qf-form"),r=document.getElementById("qf-submit"),i=document.getElementById("qf-msg"),l=(c,u="error")=>{i.textContent=c,i.className=`qf-msg ${u}`};s.addEventListener("submit",async c=>{c.preventDefault();const u={};e.querySelectorAll("[data-question-id]").forEach(v=>{const h=v.dataset.questionId;if(v.dataset.questionType==="checkbox_group"){const f=[...v.querySelectorAll('input[type="checkbox"]:checked')].map(p=>p.value);f.length&&(u[h]=f)}else{const f=(v.querySelector("input,textarea")?.value||"").trim();f&&(u[h]=f)}}),r.disabled=!0,l("Submitting…","ok");try{const v=await fetch(`${bo()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(t.guid)}/submit?token=${encodeURIComponent(t.token)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({answers:u})}),h=await v.json().catch(()=>({}));if(!v.ok||!h.ok){const d=v.status===409?"This questionnaire has already been submitted.":v.status===404?"This link is invalid or has expired.":h.error||`Could not submit (HTTP ${v.status}).`;l(d),r.disabled=!1;return}e.innerHTML=Dt("check_circle","Thank you!","Your answers have been submitted. Your account manager will be in touch.")}catch(v){console.error("[questionnaire-fill] submit error:",v),l("Something went wrong. Please try again."),r.disabled=!1}})}const Hc={render:er,init:tr},Gc=Object.freeze(Object.defineProperty({__proto__:null,default:Hc,init:tr,render:er},Symbol.toStringTag,{value:"Module"}));function jc(){return`
  ...
  `}function Vc(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const e=localStorage.getItem(U.FF_SSE_LS_TOKEN),t=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!e,hasMvvTs:!!t});const a=document.getElementById("splash-loader"),n=document.getElementById("splash-actions");e?(console.log("[SplashRoute] Auth token found → HOME"),m.publish(g.ROUTE_NAV,{route:"home"})):t?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),m.publish(g.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),a&&(a.style.display="none"),n&&(n.style.display="flex"),document.querySelectorAll("[data-route]").forEach(s=>{s.addEventListener("click",()=>{const r=s.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${r}`),m.publish(g.ROUTE_NAV,{route:r})})}))},4e3)}const Wc=Object.freeze(Object.defineProperty({__proto__:null,init:Vc,render:jc},Symbol.toStringTag,{value:"Module"}));function me(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}const Yc=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;function Dn(e,t){return e?Yc.test(e)?!0:(me(t,$.get("validation_email_invalid")),!1):(me(t,$.get("validation_email_required")),!1)}function Kc(){return`
  ...
  `}function Jc(){console.log("[SigninRoute] Initialized");const e=document.getElementById("loginForm"),t=document.getElementById("email"),a=document.getElementById("password"),n=document.getElementById("togglePassword"),o=document.getElementById("rememberEmail"),s=localStorage.getItem(E.CONFIG.LS_KEYS.REMEMBERED_EMAIL);s&&t&&o&&(t.value=s,o.checked=!0,a?.focus()),n?.addEventListener("click",()=>{const u=a.type==="password"?"text":"password";a.type=u});const r=document.getElementById("passkeySigninBtn"),i=document.getElementById("passkeyDivider"),l=document.getElementById("passkeyHint");window.PublicKeyCredential&&r&&i&&(r.style.display="",i.style.display="",l&&(l.style.display=""),r.addEventListener("click",()=>Zc())),e?.addEventListener("submit",async u=>{u.preventDefault();const v=t.value.trim(),h=a.value;Dn(v,t)&&Qc(h,a)&&(o?.checked?localStorage.setItem(E.CONFIG.LS_KEYS.REMEMBERED_EMAIL,v):localStorage.removeItem(E.CONFIG.LS_KEYS.REMEMBERED_EMAIL),await Xc(v,h))}),document.getElementById("link--uc__underline")?.addEventListener("click",u=>{u.preventDefault(),m.publish(g.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",u=>{u.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),m.publish(g.ROUTE_NAV,{route:"signup"})})}function Qc(e,t){return e?e.length<10?(me(t,$.get("validation_password_min_length")),!1):!0:(me(t,$.get("validation_password_required")),!1)}async function Xc(e,t){const a=document.querySelector(".btn");a.disabled=!0,a.textContent=$.get("loading_signing_in");try{const n=await E.doSignin(e,t);n.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q($.get("success_welcome_back"),"success"),m.publish(g.AUTH_SIGNIN_SUCCESS,{entity:E.getEntity()})):n.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q($.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(n.error||$.get("error_signin_failed"),"danger"),a.disabled=!1,a.textContent=($.get("sign_in")||"Sign in").toUpperCase())}catch(n){console.error("[SigninRoute] Sign in error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||$.get("error_network"),"danger"),a.disabled=!1,a.textContent=($.get("sign_in")||"Sign in").toUpperCase(),m.publish(g.AUTH_SIGNIN_FAIL,{message:n.message})}}async function Zc(){const e=document.getElementById("passkeySigninBtn");e.disabled=!0;try{const t=await E.doPasskeySignin();t.ok?(console.log("[SigninRoute] Passkey signin successful"),typeof neodigmToast<"u"&&neodigmToast.q($.get("success_welcome_back"),"success"),m.publish(g.AUTH_SIGNIN_SUCCESS,{entity:E.getEntity()})):t.canceled||typeof neodigmToast<"u"&&neodigmToast.q(t.error||$.get("error_signin_failed"),"danger")}catch(t){console.error("[SigninRoute] Passkey signin error:",t),typeof neodigmToast<"u"&&neodigmToast.q(t.message||$.get("error_network"),"danger")}finally{e.disabled=!1}}const ed=Object.freeze(Object.defineProperty({__proto__:null,init:Jc,render:Kc},Symbol.toStringTag,{value:"Module"}));function Bn(e){const t=[];return e.length<12&&t.push("at least 12 characters"),e.length>1024&&t.push("at most 1024 characters"),/[a-z]/.test(e)||t.push("1 lowercase"),/[A-Z]/.test(e)||t.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(e)||t.push("1 special character"),/[^\x00-\x7F]/.test(e)&&t.push("ASCII characters only"),t}function ar(e){if(e.length===0)return"";if(e.includes("ASCII characters only"))return"Password cannot contain emoji|or special unicode characters";const t=e.find(a=>/^at (?:least|most) \d+ characters$/.test(a));return t?`Password must have ${t.replace(/ (\d+ characters)$/,"|$1")}`:"Password must have: Uppercase,|Lowercase, and Special Character"}const td="2026-07-15";function ad(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function nd(){console.log("[SignupRoute] Initialized");const e=document.getElementById("signupForm"),t=e.querySelector('button[type="submit"]');_o("togglePassword","password","eyeIcon"),_o("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),m.publish(g.ROUTE_NAV,{route:"signin"})}),e.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),s=document.getElementById("last").value.trim(),r=document.getElementById("email").value.trim(),i=document.getElementById("company").value.trim(),l=document.getElementById("phone").value.trim(),c=document.getElementById("password").value,u=document.getElementById("confirmPassword").value,v=document.getElementById("first"),h=document.getElementById("last"),d=document.getElementById("email"),f=document.getElementById("password"),p=document.getElementById("confirmPassword");if(!yo(o,v,$.get("validation_first_name_required"))||!yo(s,h,$.get("validation_last_name_required"))||!Dn(r,d)||!od(c,f))return;if(c!==u){me(p,$.get("validation_password_mismatch"));return}const b=document.getElementById("acceptTerms");if(!b.checked){me(b,"Please accept the Terms of Service and Privacy Policy to continue.");return}t.disabled=!0,t.textContent=$.get("loading_creating_account"),await sd(o,s,r,i,l,c)})}function _o(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function yo(e,t,a){return e?!0:(me(t,a),!1)}function od(e,t){if(!e)return me(t,$.get("validation_password_required")),!1;const a=Bn(e);return a.length>0?(me(t,ar(a)),!1):!0}async function sd(e,t,a,n,o,s){const r=document.querySelector('button[type="submit"]');try{const i={email:a,password:s,first:e,last:t};n&&(i.company=n),o&&(i.phone=o),i.terms_accepted=!0,i.legal_version=td;const l=await E.doSignup(i);if(l.ok)m.publish(g.AUTH_SIGNUP_SUCCESS,{email:a}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const c=l.error||l.message||$.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(c,"danger"),r.disabled=!1,r.textContent=($.get("create_account")||"Create account").toUpperCase(),m.publish(g.AUTH_SIGNUP_FAIL,{message:c})}}catch(i){console.error("[SignupRoute] Sign up error:",i),typeof neodigmToast<"u"&&neodigmToast.q(i.message||$.get("error_network"),"danger"),r.disabled=!1,r.textContent=($.get("create_account")||"Create account").toUpperCase(),m.publish(g.AUTH_SIGNUP_FAIL,{message:i.message})}}const rd=Object.freeze(Object.defineProperty({__proto__:null,init:nd,render:ad},Symbol.toStringTag,{value:"Module"}));function id(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function ld(){console.log("[VerfLinkRoute] Initialized");const e=7200,t=Date.now(),a=document.getElementById("countdown-display");function n(){const s=Date.now()-t,r=Math.floor(s/1e3),i=Math.max(0,e-r),l=Math.floor(i/3600),c=Math.floor(i%3600/60),u=i%60,v=`${String(l).padStart(2,"0")}:${String(c).padStart(2,"0")}:${String(u).padStart(2,"0")}`;a&&(a.textContent=v,i<600&&(a.style.color="#ef4444",a.style.textShadow=`
          0 0 10px rgba(239, 68, 68, 0.9),
          0 0 20px rgba(239, 68, 68, 0.7),
          0 0 30px rgba(239, 68, 68, 0.5)
        `),i===0&&(a.style.color="#7f1d1d",a.style.textShadow="none")),i===0&&(clearInterval(o),console.log("[VerfLinkRoute] Countdown expired"),window.neodigmWired4Sound&&window.neodigmWired4Sound.sound(14),setTimeout(()=>{window.router&&window.router.navigate("/splash")},600))}n();const o=setInterval(n,1e3);window.addEventListener("beforeunload",()=>{clearInterval(o)})}const cd=Object.freeze(Object.defineProperty({__proto__:null,init:ld,render:id},Symbol.toStringTag,{value:"Module"})),dd="https://machfivemagnet-saas.onrender.com";class pd{constructor(){this.baseUrl=dd}async request(t,a={}){const n=`${this.baseUrl}${t}`,o={"Content-Type":"application/json",...a.headers};try{const s=await fetch(n,{...a,headers:o});if(s.status===401||s.status===403){m.publish(g.AUTH_TOKEN_EXPIRED,{status:s.status,endpoint:t});const i=await s.json().catch(()=>({}));throw new Error(i.error||"Authentication failed")}const r=await s.json();return{ok:s.ok,status:s.status,data:r}}catch(s){throw console.error("API Request Error:",s),m.publish(g.APP_ERROR,{message:s.message,endpoint:t}),s}}async get(t){return this.request(t,{method:"GET"})}async post(t,a){return this.request(t,{method:"POST",body:JSON.stringify(a)})}async put(t,a){return this.request(t,{method:"PUT",body:JSON.stringify(a)})}async delete(t){return this.request(t,{method:"DELETE"})}async signin(t,a){return this.post("/api/acctEntity/signin",{email:t,hash:a})}async signup(t){return this.post("/api/acctEntity/signup",t)}async signout(){return this.post("/api/acctEntity/signout",{})}async forgotPassword(t){return this.get(`/m5t/v5/acctEntity/forgot?CODE=${encodeURIComponent(t)}`)}async resetHash(t,a){return this.post("/api/acctEntity/resethash",{email:t,hash:a})}async verifyAccount(t){return this.get(`/api/acctEntity/verify?CODE=${t}`)}async getAccounts(){return this.get("/api/acctEntity")}async getAccount(t){return this.get(`/api/acctEntity/${t}`)}async updateAccount(t,a){return this.put(`/api/acctEntity/${t}`,a)}async deleteAccount(t){return this.delete(`/api/acctEntity/${t}`)}async ping(){return this.get("/ping")}}const ud=new pd;function md(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function gd(){console.log("[ForgotRoute] Initialized");const e=document.getElementById("forgot-form"),t=document.getElementById("email");e?.addEventListener("submit",async a=>{a.preventDefault();const n=t.value.trim();Dn(n,t)&&await hd(n)})}async function hd(e){const t=document.querySelector(".btn");t.disabled=!0,t.textContent="SENDING...";try{const a=await ud.forgotPassword(e);a.ok&&a.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q($.get("success_reset_link_sent"),"success"),m.publish(g.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(a.data.error||$.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=($.get("send_reset_link")||"Send reset link").toUpperCase())}catch(a){console.error("[ForgotRoute] Forgot password error:",a),typeof neodigmToast<"u"&&neodigmToast.q(a.message||$.get("error_network"),"danger"),t.disabled=!1,t.textContent=($.get("send_reset_link")||"Send reset link").toUpperCase()}}const fd=Object.freeze(Object.defineProperty({__proto__:null,init:gd,render:md},Symbol.toStringTag,{value:"Module"}));function vd(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function bd(){console.log("[ResethashRoute] Initialized");const e=document.getElementById("resethash-form"),t=e.querySelector('button[type="submit"]');wo("toggleNewPassword","new-password","eyeIconNew"),wo("toggleConfirmPassword","confirm-password","eyeIconConfirm"),e?.addEventListener("submit",async a=>{a.preventDefault();const n=e.email.value.trim(),o=e.newPassword.value,s=e.confirmPassword.value,r=document.getElementById("new-password"),i=document.getElementById("confirm-password");if(!o){me(r,$.get("validation_new_password_required"));return}const l=Bn(o);if(l.length>0){me(r,ar(l));return}if(!s){me(i,$.get("validation_new_password_required"));return}if(o!==s){me(i,$.get("validation_password_mismatch"));return}t.disabled=!0,t.textContent=$.get("loading_resetting_password");try{const c=await E.doResetHash(n,o);c.ok?(typeof neodigmToast<"u"&&neodigmToast.q($.get("success_password_reset"),"success"),m.publish(g.AUTH_RESETHASH_SUCCESS,{email:n})):(me(r,c.error||$.get("error_signin_failed")),t.disabled=!1,t.textContent=($.get("update_password")||"Update password").toUpperCase())}catch(c){console.error("[ResethashRoute] Reset password error:",c),me(r,c.message||$.get("error_network")),t.disabled=!1,t.textContent=($.get("update_password")||"Update password").toUpperCase()}})}function wo(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}const _d=Object.freeze(Object.defineProperty({__proto__:null,init:bd,render:vd},Symbol.toStringTag,{value:"Module"})),oe=()=>E.getManagedClients().length>0&&!E.getStoredActiveOrg(),Ke=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),yd={reseller_org:"Your org",managed_client:"Client",saas_org:"Org"};let xo=!1;function bt(){if(xo)return;const e=document.createElement("style");e.id="m5t-portfolio-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),xo=!0}const Eo=e=>e.toISOString().slice(0,10);async function wd(e,{days:t=30}={}){const a=new Date,n=Eo(new Date(a.getTime()-(t-1)*864e5)),o=Eo(a),s=await fetch(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${o}&group_by=owner`);if(!s.ok)throw new Error(`HTTP ${s.status}`);const r=await s.json();if(!r.ok)throw new Error("stats not ok");return r.by_owner||[]}function nr(e,t){return`<div class="dash-clients-scroll"><table class="dash-clients">
    <thead><tr>
      <th>Client</th>${t.map(a=>`<th>${a.h}</th>`).join("")}<th></th>
    </tr></thead>
    <tbody>${e.map(a=>`
      <tr data-org="${Ke(a.owner_guid)}" tabindex="0" role="button"
          aria-label="Open ${Ke(a.name||"client")}">
        <td><span class="dc-name">${Ke(a.name||a.owner_guid)}
          <span class="dc-chip">${Ke(yd[a.channel]||a.channel||"")}</span></span></td>
        ${t.map(n=>`<td>${n.td(a)}</td>`).join("")}
        <td><span class="dc-view">View →</span></td>
      </tr>`).join("")}</tbody>
  </table></div>`}function xd(e){let t=e.querySelector(".pf-access-error");t||(t=document.createElement("div"),t.className="pf-access-error",e.prepend(t)),t.textContent="You don't have direct access to manage this org. Use the admin console to act on its behalf."}function or(e){if(!e)return;const t=async a=>{const n=a?.dataset?.org;if(!n)return;(await E.setActiveOrg(n))?.activeOrgError&&xd(e)};e.querySelectorAll("tbody tr[data-org]").forEach(a=>{a.addEventListener("click",()=>t(a)),a.addEventListener("keydown",n=>{(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),t(a))})})}const un=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Lt({section:e,title:t,description:a}){return bt(),`
    <div class="page-shell" data-section="${Ke(e)}">
      <div class="page-header">
        <div class="page-header-text">
          <h1 class="page-title">${Ke(t)}</h1>
          <p class="page-description">${Ke(a)}</p>
        </div>
      </div>
      <div class="dashboard-card">
        ...
        <div class="card-body" id="pf-picker-body">${un("hourglass_empty","Loading…")}</div>
      </div>
    </div>`}async function _t(e,t,{emptyMsg:a}={}){const n=document.getElementById("pf-picker-body");if(n)try{const o=await wd(e);if(!o.length){n.innerHTML=un("groups",a||"No client orgs yet. Create one under Clients first.");return}n.innerHTML=nr(o,t),or(n)}catch(o){console.warn("[portfolio] picker load failed:",o),n.innerHTML=un("error","Could not load your clients. Please refresh.")}}function sr(){const e={};return E.getManagedClients().forEach(t=>{e[t.orgGuid]=t.name}),E.getMemberships().forEach(t=>{t.orgGuid&&!e[t.orgGuid]&&(e[t.orgGuid]=t.name||"")}),e}const rr=e=>e?`<span class="pf-client-chip">${Ke(e)}</span>`:"",ht=Object.freeze({MAGNET_TEMPLATE:"magnet_template",LEADS_SEARCH:"leads_search",LEADS_DAY:"leads_day"}),At=new Map;function qn(e,t){At.set(e,t)}function mn(e){if(!At.has(e))return null;const t=At.get(e);return At.delete(e),t}function Ed(e){return At.has(e)?At.get(e):null}const _e=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,ue=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),J=e=>Number(e||0).toLocaleString(),ir=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",kd=e=>(ir(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function Ad(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric"})}catch{return""}}function Sd(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}let ko=!1;function Cd(){if(ko)return;const e=document.createElement("style");e.id="m5t-dash-recent-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ko=!0}function Td(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${ue(kd(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${ue(ir(e))}</span>
    ...
    <span class="recent-lead__time">${ue(Ad(e))}</span>
  </a>`}const Bt=({icon:e,label:t,valueId:a,value:n="—",subId:o,sub:s="",href:r,trendId:i})=>{const l=r?"a":"div",c=r?` href="${ue(r)}" class="stat-card stat-card--link"`:' class="stat-card"';return`
  <${l}${c}>
  ...
  </${l}>`},oa=(e,t,a,{wide:n=!1,full:o=!1,controls:s=!1}={})=>`
  <div class="dashboard-card${n?" chart-card-wide":""}${o?" chart-card-full":""}">
  ...
  </div>`;let gn=30;function lr(){Cd(),bt();const e=oe();return`
    <div class="page-shell" data-section="home">
      ...
      <div class="stats-grid">
        ${Bt({icon:"widgets",label:"Active Magnets",valueId:"stat-active-magnets",subId:"stat-active-magnets-sub",sub:"Loading…",href:"#/magnets"})}
        ${Bt({icon:"ads_click",label:"Magnet Opens",valueId:"stat-opens",subId:"stat-opens-sub",sub:"Loading…"})}
        ${Bt({icon:"person_add",label:"Leads Captured",valueId:"stat-leads",subId:"stat-leads-sub",sub:"Loading…",href:"#/leads",trendId:"stat-leads-trend"})}
        ${Bt({icon:"check_circle",label:"Completion Rate",valueId:"stat-completion",subId:"stat-completion-sub",sub:"Loading…"})}
      </div>

      <div class="charts-section">
        ${oa("show_chart","Opens & Leads","dash-trend",{wide:!0,controls:!0})}
        <div class="charts-grid">
          ${oa("filter_alt","Completion Funnel","dash-funnel")}
          ${oa("source","Top Campaigns","dash-campaigns")}
          ${oa("touch_app","CTA Usage","dash-routes",{full:!0})}
        </div>
      </div>
    ...
    </div>`}async function cr(){const e=E.getConfig?.().BASE_URL||"";document.getElementById("dash-periods")?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(gn=Number(a.dataset.days)||30,document.querySelectorAll("#dash-periods .chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===gn)),So(e))}),document.getElementById("dash-campaigns")?.addEventListener("click",t=>{const a=t.target.closest("[data-campaign]");a&&qn(ht.LEADS_SEARCH,a.dataset.campaign)}),await Promise.all([So(e),Rd(e)])}const Oe=(e,t)=>{const a=document.getElementById(e);a&&(a.textContent=t)},Et=(e,t)=>{const a=document.getElementById(e);a&&(a.innerHTML=t)},Ao=e=>e.toISOString().slice(0,10),$d=()=>typeof window.matchMedia=="function"?window.matchMedia("(hover: hover)").matches:!0;async function So(e){const t=new Date,a=Ao(new Date(t.getTime()-(gn-1)*864e5)),n=Ao(t),o=oe();let s;try{const A=await fetch(`${e}/m5t/v5/dashboard/stats?from=${a}&to=${n}${o?"&group_by=owner":""}`);if(!A.ok)throw new Error(`HTTP ${A.status}`);if(s=await A.json(),!s.ok)throw new Error("stats not ok")}catch(w){console.warn("[dashboard] stats fetch failed:",w),["stat-active-magnets","stat-opens","stat-leads","stat-completion"].forEach(R=>Oe(R,"—")),["stat-active-magnets-sub","stat-opens-sub","stat-leads-sub","stat-completion-sub"].forEach(R=>Oe(R,"Unavailable"));const A=document.getElementById("stat-leads-trend");A&&(A.className="stat-trend",A.innerHTML=""),["dash-trend","dash-funnel","dash-campaigns","dash-routes","dash-interactions","dash-portfolio"].forEach(R=>Et(R,_e("error","Could not load. Please refresh.")));return}o&&Ld(s.by_owner||[]),Oe("stat-active-magnets",J(s.magnets.active)),Oe("stat-active-magnets-sub",s.magnets.total>s.magnets.active?`${J(s.magnets.total-s.magnets.active)} paused`:s.magnets.active?"All running":"No magnets yet");const r=s.funnel||{};Oe("stat-opens",r.opens?J(r.opens):"—"),Oe("stat-opens-sub",r.opens?r.engagement_rate!=null?`${r.engagement_rate}% engage`:`${J(r.engaged)} engaged`:"No opens in this range yet");const i=s.leads||{};Oe("stat-leads",J(i.total));const l=(i.this_week||0)-(i.prev_week||0);Oe("stat-leads-sub",i.total?`${J(i.this_week)} this week`:"No leads yet");const c=document.getElementById("stat-leads-trend");if(c)if((i.prev_week||0)>0){const w=l>0?"positive":l<0?"negative":"neutral",A=l>0?"trending_up":l<0?"trending_down":"trending_flat";c.className=`stat-trend ${w}`,c.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">${A}</span>${l>0?"+":""}${J(l)}`}else c.className="stat-trend",c.innerHTML="";Oe("stat-completion",r.completion_rate!=null?`${r.completion_rate}%`:"—"),Oe("stat-completion-sub",r.opens?`${J(r.completions)} completed of ${J(r.opens)} opens`:"Appears once magnets get opened");const u=s.by_day||[],v=u.some(w=>w.opens||w.leads);Et("dash-trend",v?dr(u):_e("show_chart","No activity in this range yet. Opens and leads chart here as visitors engage your magnets.")),v&&pr(u),Et("dash-funnel",r.opens?Id(r):_e("filter_alt","The funnel fills in once your magnets record opens."));const h=s.top_campaigns||[];Et("dash-campaigns",h.length?`<div class="dash-list">${h.map(w=>`
    ...
    </div>`).join("")}</div>`}async function Rd(e){const t=document.getElementById("recent-leads-body");if(t)try{const a=await fetch(`${e}/m5t/v5/m5mLead`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json(),o=(Array.isArray(n?.data)?n.data:[]).filter(s=>!["DELETED","ARCHIVED"].includes(s.status));t.innerHTML=o.length?o.slice(0,5).map(Td).join(""):_e("contacts","No leads captured yet. Publish a magnet to start collecting.")}catch(a){console.warn("[dashboard] Leads fetch failed:",a),t.innerHTML=_e("error","Could not load recent leads.")}}function Co(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}const To=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e));function dr(e){const d=e.length||1,f=Co(Math.max(1,...e.map(q=>q.opens||0))),p=Co(Math.max(1,...e.map(q=>q.leads||0))),b=748/d,y=Math.min(22,b*.55),w=q=>46+b*(q+.5),A=q=>266-q/f*248,R=q=>266-q/p*248,z=[0,.5,1].map(q=>{const Y=266-q*248;return`<line x1="46" y1="${Y.toFixed(1)}" x2="794" y2="${Y.toFixed(1)}" class="dash-grid"/><text x="38" y="${(Y+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${To(f*q)}</text><text x="802" y="${(Y+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${To(p*q)}</text>`}).join(""),Q=e.map((q,Y)=>{const et=A(q.opens||0);return`<rect class="dash-bar" data-i="${Y}" x="${(w(Y)-y/2).toFixed(1)}" y="${et.toFixed(1)}" width="${y.toFixed(1)}" height="${Math.max(0,266-et).toFixed(1)}" rx="3"/>`}).join(""),ge=e.map((q,Y)=>`${w(Y).toFixed(1)},${R(q.leads||0).toFixed(1)}`).join(" "),$e=d>1?`<polyline class="dash-line" points="${ge}" fill="none" stroke-width="2.5"/>`:"",he=e.map((q,Y)=>`<circle class="dash-dot" data-i="${Y}" cx="${w(Y).toFixed(1)}" cy="${R(q.leads||0).toFixed(1)}" r="3.2"/>`).join(""),Ve='<line class="dash-crosshair" x1="0" y1="18" x2="0" y2="266" pointer-events="none"/>',Be=Math.max(1,Math.ceil(d/6)),D=e.map((q,Y)=>Y%Be===0||Y===d-1?`<text x="${w(Y).toFixed(1)}" y="288" text-anchor="middle" class="dash-ax">${q.date.slice(5)}</text>`:"").join(""),ae=e.map((q,Y)=>`<rect class="dash-hit" data-i="${Y}" data-day="${ue(q.date)}" data-leads="${Number(q.leads||0)}" x="${(46+b*Y).toFixed(1)}" y="18" width="${b.toFixed(1)}" height="${248 .toFixed(1)}" fill="transparent"/>`).join("");return`
    ...
    <div class="dash-chart-wrap">
      ...
      ${Number(v.leads||0)>0?'<div class="dash-chart-tip__go">Click to see them →</div>':""}`;const h=u.getBoundingClientRect(),d=t.getBoundingClientRect();a.style.left=`${h.left-d.left+h.width/2}px`,a.style.top=`${h.top-d.top}px`,a.hidden=!1,r(c,u)},l=()=>{a.hidden=!0,s()};t.querySelectorAll(".dash-hit").forEach(c=>{const u=Number(c.dataset.i);c.addEventListener("mouseenter",()=>i(u,c)),c.addEventListener("mousemove",()=>i(u,c)),c.addEventListener("mouseleave",l),c.addEventListener("click",()=>{const v=c.classList.contains("dash-hit--on");i(u,c),Number(c.dataset.leads||0)&&(!$d()&&!v||(qn(ht.LEADS_DAY,c.dataset.day),window.location.hash="#/leads"))})})}const Nd={render:lr,init:cr},Od=Object.freeze(Object.defineProperty({__proto__:null,default:Nd,init:cr,render:lr,statCard:Bt,svgTrendChart:dr,wireTrendTooltip:pr},Symbol.toStringTag,{value:"Module"}));function Md(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/home" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function Pd(){console.log("[SignoutRoute] Initialized");const e=document.getElementById("confirm-signout-btn");e?.addEventListener("click",async()=>{e.disabled=!0,e.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await E.doSignout()})}const Fd=Object.freeze(Object.defineProperty({__proto__:null,init:Pd,render:Md},Symbol.toStringTag,{value:"Module"}));let $o=!1;function Dd(){if($o)return;const e=document.createElement("style");e.id="m5t-section-page-styles",e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),$o=!0}function ur({title:e="Section",icon:t="widgets",name:a=""}={}){return Dd(),`
    ...
    </section>`}function mr(){}const Bd={render:ur,init:mr},qd=Object.freeze(Object.defineProperty({__proto__:null,default:Bd,init:mr,render:ur},Symbol.toStringTag,{value:"Module"})),Ud={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},rt=e=>String(e??"").replace(/[&<>"']/g,t=>Ud[t]),Lo=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},zd=()=>E.getConfig?.().BASE_URL||"",gr=()=>`${zd()}/m5t/v5/acctEntity/profile`,hn={profile:null};let Io=!1;function Hd(){if(Io)return;const e=document.createElement("style");e.id="m5t-settings-general-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Io=!0}const hr=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function fr(){try{return Ce.getAvailableLanguages()||[]}catch{return[]}}function Gd(){const e=fr(),t=e.includes(U.FF_SSE_I18N_LANG)?U.FF_SSE_I18N_LANG:e[0]||U.FF_SSE_I18N_LANG;try{const a=localStorage.getItem(U.FF_SSE_LS_USER_LANG);return a&&e.includes(a)?a:t}catch{return t}}function jd(e){try{const t=new Intl.DisplayNames([e],{type:"language"}).of(e);if(t&&t!==e)return t.charAt(0).toUpperCase()+t.slice(1)}catch{}return e}function Vd(){const e=Ra(),t=fr(),a=t.length>1;if(!e&&!a)return"";const n=Gd();return`
        ...
        <div class="settings-item" id="gen-dark-item">
          ...
          <div class="settings-item__control">
            <label class="m5t-switch">
              <input type="checkbox" role="switch" id="gen-dark" aria-label="Dark mode" ${Vt()==="dark"?"checked":""} />
        ...
        <div class="settings-item" id="gen-lang-item">
          ...
          <div class="settings-item__control">
            <select class="settings-select" id="gen-lang" aria-label="Language">
              ${t.map(o=>`<option value="${rt(o)}" ${o===n?"selected":""}>${rt(jd(o))}</option>`).join("")}
            </select>
          </div>
        </div>`:""}
      </div>
    </div>`}function vr(){return Hd(),`
    ...
    </div>`}async function br(){Jd(),await Yd()}function Wd(e){return`
    <div class="settings-grid-2">
      <div class="settings-field">
        <label class="settings-label" for="gen-first">First name</label>
        <input class="settings-input" id="gen-first" type="text" autocomplete="given-name" value="${rt(e.first)}" />
        <p class="settings-error" id="gen-first-error" role="alert" hidden></p>
      </div>
      <div class="settings-field">
        <label class="settings-label" for="gen-last">Last name</label>
        <input class="settings-input" id="gen-last" type="text" autocomplete="family-name" value="${rt(e.last)}" />
        <p class="settings-error" id="gen-last-error" role="alert" hidden></p>
      </div>
    </div>
    <div class="settings-field">
      <label class="settings-label" for="gen-company">Company</label>
      <input class="settings-input" id="gen-company" type="text" autocomplete="organization" value="${rt(e.company)}" />
    </div>
    <div class="settings-field">
      <label class="settings-label" for="gen-phone">Phone</label>
      <input class="settings-input" id="gen-phone" type="tel" autocomplete="tel" value="${rt(e.phone)}" />
    </div>
    <div class="settings-field">
      <label class="settings-label" for="gen-email">Sign-in email</label>
      <input class="settings-input" id="gen-email" type="email" value="${rt(e.email)}" readonly />
    ...
    </div>`}async function Yd(){const e=document.getElementById("gen-profile-body");if(e){try{const t=await fetch(gr()),a=await t.json().catch(()=>({}));if(!t.ok||!a.ok||!a.data)throw new Error(a.error||"Failed to load");hn.profile=a.data}catch(t){console.warn("[settings-general] profile load failed:",t),e.innerHTML=hr("error","Could not load your profile. Please try again.");return}e.innerHTML=Wd(hn.profile),e.querySelector("#gen-save")?.addEventListener("click",Kd)}}function Ro(e,t){const a=document.getElementById(`${e}-error`);a&&(a.textContent=t||"",a.hidden=!t);const n=document.getElementById(e);n&&n.setAttribute("aria-invalid",t?"true":"false")}async function Kd(){const e=document.getElementById("gen-save"),t=n=>(document.getElementById(n)?.value??"").trim(),a={first:t("gen-first"),last:t("gen-last"),company:t("gen-company"),phone:t("gen-phone")};if(Ro("gen-first",a.first?"":"First name is required."),Ro("gen-last",a.last?"":"Last name is required."),!(!a.first||!a.last)){e&&(e.disabled=!0);try{const n=await fetch(gr(),{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}),o=await n.json().catch(()=>({}));if(!n.ok||!o.ok)throw new Error(o.error||"Could not save.");o.data&&(hn.profile=o.data),Lo("Profile updated.","success")}catch(n){console.warn("[settings-general] profile save failed:",n),Lo(n.message||"Could not save.","error")}finally{e&&(e.disabled=!1)}}}function Jd(){const e=document.getElementById("gen-dark");if(e){e.addEventListener("change",()=>{Us(e.checked?"dark":"light"),e.checked=Vt()==="dark"});const a=m.subscribe(g.UI_THEME_CHANGED,()=>{if(!e.isConnected){m.unsubscribe(a);return}e.checked=Vt()==="dark"})}const t=document.getElementById("gen-lang");t&&t.addEventListener("change",()=>{try{Ce.setLanguage(t.value)}catch(a){console.warn("[settings-general] setLanguage failed:",a)}})}const Qd={render:vr,init:br},Xd=Object.freeze(Object.defineProperty({__proto__:null,default:Qd,init:br,render:vr},Symbol.toStringTag,{value:"Module"})),Zd={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ge=e=>String(e??"").replace(/[&<>"']/g,t=>Zd[t]),No=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},_a=()=>E.getConfig?.().BASE_URL||"",ep=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?",_r="managed_client",yr={reseller_org:"Your organization",managed_client:"Client workspace",saas_org:"Organization"},tp=6,Qe={org:null},wr=()=>E.getActiveOrg()?.guid||E.getMemberships()[0]?.orgGuid||null,Na=()=>E.getActiveOrg()?.channel||E.getMemberships()[0]?.channel||null,xr=()=>E.getCapabilities().includes("manage_team");let Oo=!1;function ap(){if(Oo)return;const e=document.createElement("style");e.id="m5t-workspace-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Oo=!0}const ya=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Mo=(e,t,a)=>`
  <div class="settings-section__head">
  ...
  </div>`;function Er(){ap();const e=yr[Na()];return`
    <div class="page-shell" data-section="settings-workspace">
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ${Mo("apartment","Organization","Name and details.")}
          <div id="ws-org-body">${ya("hourglass_empty","Loading…")}</div>
        </div>
      </div>

      <div class="dashboard-card" id="ws-team-card" style="margin-top:24px; display:none">
        <div class="card-body">
          ${Mo("group","Team","Who has access.")}
          <div id="ws-team-body"></div>
        </div>
      </div>
    </div>`}async function kr(){Qe.org=null,await np(),await rp()}async function np(){const e=document.getElementById("ws-org-body");if(!e)return;const t=wr();if(!t){e.innerHTML=ya("apartment","No workspace on this account yet.");return}try{const a=await fetch(`${_a()}/m5t/v5/acctGroup`),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||`Failed (HTTP ${a.status})`);if(Qe.org=(n.data||[]).find(o=>o.guid===t)||null,!Qe.org)throw new Error("Org row not in scope")}catch(a){console.warn("[settings-workspace] load failed:",a),e.innerHTML=ya("error","Could not load your workspace. Please try again.");return}op()}function Po(){const e=yr[Na()]||"",t=Qe.org?.created?.created_tz;let a="";if(t){const o=new Date(t);Number.isNaN(o.getTime())||(a=`Created ${o.toLocaleDateString()}`)}const n=[e,a].filter(Boolean);return n.length?`<p class="settings-help">${Ge(n.join(" · "))}</p>`:""}function op(){const e=document.getElementById("ws-org-body");if(!e)return;const t=Qe.org||{};if(!xr()){const a=Na()===_r?'<div class="settings-note"><span class="material-symbols-outlined" aria-hidden="true">info</span> This workspace is managed for you.</div>':"";e.innerHTML=`
      ...
      ${a}
      <div style="margin-top:12px">${Po()}</div>`;return}e.innerHTML=`
    <div class="settings-field">
    ...
    </div>`,document.getElementById("ws-save")?.addEventListener("click",sp)}async function sp(){const e=document.getElementById("ws-save"),t=document.getElementById("ws-org-error"),a=(document.getElementById("ws-name")?.value||"").trim(),n=(document.getElementById("ws-desc")?.value||"").trim();if(t&&(t.textContent=""),!a){t&&(t.textContent="Organization name is required.");return}e&&(e.disabled=!0);try{const o=await fetch(`${_a()}/m5t/v5/acctGroup/${encodeURIComponent(Qe.org.id)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({caption:a,description:n})}),s=await o.json().catch(()=>({}));if(!o.ok||!s.ok)throw new Error(s.message||s.error||`Failed (HTTP ${o.status})`);Qe.org={...Qe.org,caption:a,description:n},No("Workspace updated.","success")}catch(o){console.warn("[settings-workspace] save failed:",o),No(o.message||"Could not save","danger"),e&&(e.disabled=!1);return}e&&(e.disabled=!1);try{await E.fetchScope?.()}catch(o){console.warn("[settings-workspace] fetchScope after save failed:",o)}}function Fo(){document.getElementById("ws-team-card")?.remove()}async function rp(){const e=document.getElementById("ws-team-card");if(!e)return;const t=wr();if(!t||!xr()){Fo();return}let a=[],n=[];try{const[o,s]=await Promise.all([fetch(`${_a()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/members`),fetch(`${_a()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/invites`)]);if(o.status===403||s.status===403){Fo();return}const[r,i]=await Promise.all([o.json().catch(()=>({})),s.json().catch(()=>({}))]);if(!o.ok||!s.ok)throw new Error(`members: ${o.status}, invites: ${s.status}`);a=r.members||[],n=i.invites||[]}catch(o){console.warn("[settings-workspace] team load failed:",o),e.style.display="";const s=document.getElementById("ws-team-body");s&&(s.innerHTML=ya("error","Could not load your team. Please try again."));return}cp(a,n)}function ip(e){if(!e.length)return"";const t=e.slice(0,tp),a=e.length-t.length;return`
    ...
    </div>`}function lp(e,t){const a=`${e.length} member${e.length===1?"":"s"}`;return t.length?`${a} · ${t.length} pending invite${t.length===1?"":"s"}`:a}function cp(e,t){const a=document.getElementById("ws-team-card"),n=document.getElementById("ws-team-body");if(!a||!n)return;a.style.display="";const o=Na()!==_r;n.innerHTML=`
    ${ip(e)}
    <p class="ws-counts">${Ge(lp(e,t))}</p>
    ${o?'<div class="ws-team-actions"><a class="btn btn-secondary" href="#/team">Manage team</a></div>':""}`}const dp={render:Er,init:kr},pp=Object.freeze(Object.defineProperty({__proto__:null,default:dp,init:kr,render:Er},Symbol.toStringTag,{value:"Module"})),up={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ie=e=>String(e??"").replace(/[&<>"']/g,t=>up[t]),ye=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},ft=()=>E.getConfig?.().BASE_URL||"",mp=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,Yt=5,ve={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},fn=()=>E.getActiveOrg()?.guid||E.getMemberships()[0]?.orgGuid||null;let Do=!1;function gp(){if(Do)return;const e=document.createElement("style");e.id="m5t-notif-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Do=!0}const Un=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Ar(){return gp(),bt(),oe()?Lt({section:"settings-notifications",title:"Notifications",description:"Pick a client to manage their lead alerts."}):`
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Email sent the moment a magnet captures a lead. Up to ${Yt} recipients per magnet.</p>
            </div>
          </div>
          <div id="ntf-body">${Un("hourglass_empty","Loading…")}</div>
        </div>
      </div>
    ...
    </div>`}async function Sr(){if(oe()){const e=t=>Number(t||0).toLocaleString();return _t(ft(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Promise.all([hp(),Cr()])}async function Cr(){const e=fn();if(e)try{const t=await fetch(`${ft()}/m5t/v5/acctGroup/${encodeURIComponent(e)}/webhook`);if(t.status===403){ve.webhookAllowed=!1;return}const a=await t.json().catch(()=>({}));if(!a.ok)return;ve.webhook=a.webhook,Tr()}catch{}}function Bo(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function Tr(){const e=document.getElementById("ntf-wh-card"),t=document.getElementById("ntf-wh-body");if(!e||!t)return;e.style.display="";const a=ve.webhook,n=a?.last_delivery;t.innerHTML=`
    <div class="ntf-wh">
      ...
      <div class="ntf-wh__row">
        ...
        <span class="ntf-wh__status">${n?n.ok?`Last delivery: <span class="ok">delivered</span> ${Ie(Bo(n.tz))}`:`Last delivery: <span class="bad">failed</span> ${Ie(Bo(n.tz))} (${Ie(n.error||"")})`:""}</span>
      </div>
    </div>`,t.querySelector("#ntf-wh-save")?.addEventListener("click",async()=>{const o=t.querySelector("#ntf-wh-url")?.value.trim()||"",s=t.querySelector("#ntf-wh-secret")?.value??"",r={uri:o};s.trim()!==""&&(r.secret=s.trim());try{const i=await fetch(`${ft()}/m5t/v5/acctGroup/${encodeURIComponent(fn())}/webhook`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),l=await i.json().catch(()=>({}));if(!i.ok||!l.ok)throw new Error(l.error||`Failed (HTTP ${i.status})`);ve.webhook=l.webhook,ye(o?"Webhook saved":"Webhook removed","success"),Tr()}catch(i){ye(i.message||"Could not save","danger")}}),t.querySelector("#ntf-wh-test")?.addEventListener("click",async o=>{const s=o.currentTarget;s.disabled=!0;try{const r=await fetch(`${ft()}/m5t/v5/acctGroup/${encodeURIComponent(fn())}/webhook-test`,{method:"POST"}),i=await r.json().catch(()=>({}));r.ok&&i.ok?ye("Test delivery sent","success"):ye(i.error||"Could not deliver the test","danger")}catch{ye("Could not deliver the test","danger")}finally{s.disabled=!1}try{await Cr()}catch(r){console.warn("[notifications] loadWebhook refresh failed:",r)}})}async function hp(){const e=document.getElementById("ntf-body");if(e){try{const a=await(await fetch(`${ft()}/m5t/v5/magnets`)).json().catch(()=>({}));if(!a.ok)throw new Error(a.message||"Failed to load");ve.magnets=(a.magnets||[]).filter(n=>n.status!=="ARCHIVED"),ve.canManage=!!a.canManage}catch(t){console.warn("[notifications] load failed:",t),e.innerHTML=Un("error","Could not load your magnets. Please try again.");return}$r()}}function fp(e){const t=Array.isArray(e.notify_emails)?e.notify_emails:[],a=t.length>0;return`
    <div class="ntf-row" data-guid="${Ie(e.guid)}">
      ...
      <div class="ntf-config">
        ...
        <div class="ntf-addrow">
          <input class="ntf-input" type="email" placeholder="name@business.com" aria-label="Add alert email" ${t.length>=Yt?"disabled":""} />
          <button class="ntf-btn" type="button" data-add ${t.length>=Yt?"disabled":""}>
    ...
    </div>`}function $r(){const e=document.getElementById("ntf-body");if(e){if(!ve.magnets.length){e.innerHTML=Un("widgets","No magnets yet. Create one under Your Magnets first.");return}e.innerHTML=ve.magnets.map(fp).join(""),e.querySelectorAll(".ntf-row").forEach(t=>{const a=t.dataset.guid,n=t.querySelector(".ntf-input"),o=()=>{const s=(n?.value||"").trim().toLowerCase();if(!s)return;if(!mp.test(s)){ye("That does not look like an email address","danger");return}const i=[...ve.magnets.find(l=>l.guid===a).notify_emails||[]];if(i.includes(s)){ye("Already added","info");return}if(i.length>=Yt){ye(`Up to ${Yt} emails per magnet`,"info");return}qo(a,[...i,s])};t.querySelector("[data-add]")?.addEventListener("click",o),n?.addEventListener("keydown",s=>{s.key==="Enter"&&o()}),t.querySelectorAll("[data-remove]").forEach(s=>s.addEventListener("click",()=>{const r=ve.magnets.find(i=>i.guid===a);qo(a,(r.notify_emails||[]).filter(i=>i!==s.dataset.remove))})),t.querySelector("[data-test]")?.addEventListener("click",()=>vp(a,t.querySelector("[data-test]")))})}}async function qo(e,t){try{const a=await fetch(`${ft()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({notify_emails:t})}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||n.message||`Failed (HTTP ${a.status})`);const o=ve.magnets.find(s=>s.guid===e);o&&(o.notify_emails=t),ye("Alert emails updated","success")}catch(a){console.warn("[notifications] save failed:",a),ye(a.message||"Could not save","danger");return}try{$r()}catch(a){console.error("[notifications] renderBody after save failed:",a)}}async function vp(e,t){t&&(t.disabled=!0);try{const a=await fetch(`${ft()}/m5t/v5/magnets/${encodeURIComponent(e)}/notify-test`,{method:"POST"}),n=await a.json().catch(()=>({}));a.ok&&n.ok?ye("Test alert sent","success"):ye(n.error||"Could not send the test","danger")}catch{ye("Could not send the test","danger")}finally{t&&(t.disabled=!1)}}const bp={render:Ar,init:Sr},_p=Object.freeze(Object.defineProperty({__proto__:null,default:bp,init:Sr,render:Ar},Symbol.toStringTag,{value:"Module"}));function yp({label:e="",content:t="",size:a="",onClose:n=null}={}){const o=document.activeElement,s=document.createElement("div");s.className="m5t-modal-scrim",s.innerHTML=`
    <div class="m5t-modal${a==="wide"?" m5t-modal--wide":""}" role="dialog" aria-modal="true" aria-label="${wp(e)}" tabindex="-1">
    ...
    </span>`}function Oa(e,t){const a=kp(),n=e?.[t]||[];return n.find(o=>o.owner_guid===a)||n[0]||null}function Ma(e,t,a){return e.connect&&!a?"unavailable":t?t.connect_status==="ACTIVE"?"connected":"broken":"idle"}function Pa(e,t){return e==="unavailable"?'<span class="intg-state">Not available yet</span>':e==="idle"?'<span class="intg-state">Not connected</span>':e==="connected"?'<span class="intg-state on"><span class="material-symbols-outlined" aria-hidden="true">check</span>Connected</span>':`<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>${I(t?.connect_status==="NEEDS_REAUTH"?"Reconnect needed":"Connection error")}</span>`}async function Fa(){const e=await fetch(`${ee()}/m5t/v5/integrations`);if(e.status===403)return{denied:!0};const t=await e.json();if(!t.ok)throw new Error(t.error||"load failed");return{providers:t.data.providers,configured:t.data.configured}}async function Tp(e){if(!we.busy){we.busy=!0;try{const a=await(await fetch(`${ee()}/m5t/v5/integrations/${e.slug}/connect`)).json();if(!a.ok||!a.data?.url)throw new Error(a.error||"connect failed");window.location.href=a.data.url}catch(t){be(t.message||e.connect.fallbackError,"error"),we.busy=!1}}}async function $p(e,{refresh:t}={}){if(we.busy)return;we.busy=!0;const a=document.getElementById(e.card.ids.sync);a&&(a.disabled=!0);try{const o=await(await fetch(`${ee()}/m5t/v5/integrations/${e.slug}/sync`,{method:"POST"})).json();if(!o.ok)throw new Error(o.error||"sync failed");const r=(o.data?.connections?.[0]?.[e.sync.itemsField]||[]).filter(i=>i.error).length;be(r?e.sync.failedToast(r):"Metrics synced.",r?"warning":"success")}catch{be("Sync failed.","error")}finally{we.busy=!1,a&&(a.disabled=!1),t?.()}}async function Lp(e,{refresh:t}={}){if(we.busy)return;we.busy=!0;let a=!1;try{a=await Lr({title:`Disconnect ${e.label}?`,message:e.disconnect.confirm,confirmLabel:"Disconnect",danger:!0})}finally{a||(we.busy=!1)}if(a)try{const o=await(await fetch(`${ee()}/m5t/v5/integrations/${e.slug}`,{method:"DELETE"})).json().catch(()=>({}));if(!o.ok)throw new Error(o.error||"disconnect failed");be(e.disconnect.toast,"success")}catch{be("Disconnect failed.","error")}finally{we.busy=!1,t?.()}}async function Rr(e,{refresh:t}={}){const a=e.picker,n=document.getElementById(e.card.ids.panel);if(n){n.style.display="",n.innerHTML=xe(a.loading);try{const s=await(await fetch(`${ee()}/m5t/v5/integrations/${e.slug}/${a.path}`)).json();if(!s.ok)throw new Error(s.error||"load failed");Ip(e,s.data[a.itemsField]||[],new Set(s.data.linked||[]),{refresh:t})}catch{n.innerHTML=xe(a.loadError,"error")}}}function Ip(e,t,a,{refresh:n}={}){const o=e.picker,s=document.getElementById(e.card.ids.panel);if(!s)return;const r=t.map(i=>{const l=o.rowDisabled(i),c=o.rowBadge(i),u=a.has(i.id)&&!l;return`
      <label class="intg-acct${l?" disabled":""}">
        <input type="checkbox" data-${o.dataAttr}="${I(i.id)}" ${u?"checked":""} ${l?"disabled":""}>
    ...
    </div>`,document.getElementById(o.ids.cancel)?.addEventListener("click",()=>{s.style.display="none"}),document.getElementById(o.ids.save)?.addEventListener("click",()=>Rp(e,{refresh:n}))}async function Rp(e,{refresh:t}={}){const a=e.picker,n=document.getElementById(e.card.ids.panel),o=[...n?.querySelectorAll(`input[data-${a.dataAttr}]:checked`)||[]].map(r=>r.dataset[a.datasetKey]),s=document.getElementById(a.ids.save);s&&(s.disabled=!0);try{const i=await(await fetch(`${ee()}/m5t/v5/integrations/${e.slug}/${a.path}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({[a.saveField]:o})})).json();if(!i.ok)throw new Error(i.error||"save failed");be(a.savedToast(i.data.linked),"success"),n&&(n.style.display="none"),t?.()}catch{be(a.saveError,"error"),s&&(s.disabled=!1)}}function zo({refresh:e,replaceKey:t=!1}={}){const a=document.getElementById(Se.callrail.card.ids.setup);a&&(a.style.display="",a.innerHTML=`
    <div class="intg-picker">
    ...
    </div>`,document.getElementById("intg-r-cancel")?.addEventListener("click",()=>{a.style.display="none"}),document.getElementById("intg-r-continue")?.addEventListener("click",()=>Np({refresh:e})),document.getElementById("intg-r-key")?.focus())}const Ye=e=>{const t=document.getElementById("intg-r-status");t&&(t.textContent=e)};async function Np({refresh:e}={}){const t=document.getElementById("intg-r-continue"),a=document.getElementById("intg-r-key")?.value.trim()||"",n=document.getElementById("intg-r-pickers");if(!a){Ye("Paste an API key first.");return}if(n&&!n.hidden)return Op(a,{refresh:e});t&&(t.disabled=!0),Ye("Checking the key with CallRail…");try{const s=await(await fetch(`${ee()}/m5t/v5/integrations/callrail/validate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:a})})).json();if(!s.ok){Ye(s.error||"CallRail rejected that key.");return}const r=s.data.accounts||[],i=document.getElementById("intg-r-account");i&&(i.innerHTML=r.map(l=>`<option value="${I(l.id)}">${I(l.name)}</option>`).join(""),i.onchange=()=>Ho(a,i.value)),n&&(n.hidden=!1),t&&(t.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">save</span>Save'),Ye(""),await Ho(a,r[0]?.id)}catch{Ye("Could not reach CallRail. Try again.")}finally{t&&(t.disabled=!1)}}async function Ho(e,t){const a=document.getElementById("intg-r-company");if(!(!a||!t)){a.innerHTML='<option value="">Loading companies…</option>';try{const o=await(await fetch(`${ee()}/m5t/v5/integrations/callrail/companies`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:t})})).json(),s=o.ok?o.data.companies||[]:[];a.innerHTML=s.length?s.map(r=>`<option value="${I(r.id)}">${I(r.name)}</option>`).join(""):'<option value="">No active companies in this account</option>'}catch{a.innerHTML='<option value="">Could not load companies</option>'}}}async function Op(e,{refresh:t}={}){const a=document.getElementById("intg-r-continue"),n=document.getElementById("intg-r-account")?.value||"",o=document.getElementById("intg-r-company")?.value||"";if(!o){Ye("Pick the company this workspace tracks.");return}a&&(a.disabled=!0),Ye("Connecting…");try{const r=await(await fetch(`${ee()}/m5t/v5/integrations/callrail`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:n,company_id:o})})).json();if(!r.ok)throw new Error(r.error||"connect failed");be(r.data?.webhook_state==="active"?"CallRail connected. Call sync is on.":"CallRail connected. Call sync setup needs attention; see below.","success"),t?.()}catch{Ye("Could not connect. Check the key and try again."),a&&(a.disabled=!1)}}async function Mp({refresh:e}={}){if(we.busy)return;we.busy=!0;const t=document.getElementById(Se.callrail.card.ids.sync);t&&(t.disabled=!0);try{const n=await(await fetch(`${ee()}/m5t/v5/integrations/callrail/sync?days=7`,{method:"POST"})).json();if(!n.ok)throw new Error(n.error||"sync failed");const o=n.data?.connections?.[0]||{};be(o.error?"Sync finished with errors.":`Sync done. ${o.processed||0} new call${(o.processed||0)===1?"":"s"} recorded.`,o.error?"warning":"success")}catch{be("Sync failed.","error")}finally{we.busy=!1,t&&(t.disabled=!1),e?.()}}let Go=!1;function Da(){if(Go)return;const e=document.createElement("style");e.id="m5t-intg-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Go=!0}function Nr(){return Da(),bt(),oe()?Lt({section:"settings-integrations",title:"Integrations",description:"Pick a client to manage their connections."}):`
    ...
    </div>`}async function Or(){if(oe()){const e=t=>Number(t||0).toLocaleString();return _t(ee(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}Pp()||await Fp()}const sa=Object.fromEntries(Object.values(Se).filter(e=>e.connect).map(e=>[e.slug,e.label]));function Pp(){try{const e=new URLSearchParams(window.location.search),t=e.get("connected"),a=e.get("error")?e.get("provider")||"google_ads":null;let n=null;if(t&&Object.hasOwn(sa,t))be(`${sa[t]} connected.`,"success"),Ap({slug:t,connected:!0}),n=Object.hasOwn(Se,t)?Se[t]:null;else if(a){const o=Object.hasOwn(sa,a)?sa[a]:a;be(`${o} connection failed (${e.get("error")}).`,"error"),n=Object.hasOwn(Se,a)?Se[a]:null}else return!1;return window.history.replaceState(null,"",window.location.pathname+window.location.hash),n?(window.router?.navigate(`/settings/integrations/${n.urlSlug}`),!0):!1}catch{return!1}}async function Fp(){const e=document.getElementById("intg-body");try{const{denied:t,providers:a,configured:n}=await Fa();if(t){e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ne("lock","Integrations are managed by workspace admins.")}</div></div>`);return}e&&(e.innerHTML=Up(a,n))}catch{e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ne("error","Could not load integrations.")}</div></div>`)}}function Dp(e,t,a){const n=Ma(e,t,a);return`
    ...
    </div>`}function Up(e,t){const a=Object.values(Se).map(o=>Dp(o,Oa(e,o.slug),!!t?.[o.slug])).join(""),n=Uo.length?`<div class="intg-grid__soon-label">Coming soon</div>${Uo.map(qp).join("")}`:"";return`<div class="intg-grid">${a}${n}</div>`}const zp={render:Nr,init:Or},Hp=Object.freeze(Object.defineProperty({__proto__:null,default:zp,init:Or,render:Nr},Symbol.toStringTag,{value:"Module"})),L={provider:null,conn:null,configured:!1,status:"idle"};function Mr({provider:e}={}){Da(),bt();const t=Ir[e];if(!t||oe())return'<div class="page-shell"></div>';const a=Se[t];return L.provider=a,`
    <div class="page-shell" data-section="settings-integrations">
    ...
    </div>`}async function Pr({provider:e}={}){const t=Ir[e];if(!t||oe()){window.router?.navigate("/settings/integrations",{historyAPIMethod:"replaceState"});return}await bn();const a=Sp();a?.connected&&a.slug===t&&L.provider?.picker&&Te()&&Rr(L.provider,{refresh:bn})}async function bn(){const e=document.getElementById("intg-detail");if(!(!e||!L.provider))try{const{denied:t,providers:a,configured:n}=await Fa();if(t){e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ne("lock","Integrations are managed by workspace admins.")}</div></div>`;return}L.conn=Oa(a,L.provider.slug),L.configured=!!n?.[L.provider.slug],L.status=Ma(L.provider,L.conn,L.configured),e.innerHTML=Gp(),Qp()}catch{e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ne("error","Could not load this integration.")}</div></div>`}}function Gp(){const e=L.provider;return[Vp(e),Wp(e),Yp(e),Kp(e),Jp(e)].filter(Boolean).join("")}function jp(e){const t=L.conn?.external_account||{};if(L.status!=="connected")return e.card.sub;if(e.slug==="calendly"){const n=[t.name,t.email&&`(${t.email})`].filter(Boolean).join(" ");return n?`Connected as ${n}.`:"Connected."}if(e.slug==="callrail"){const n=[t.account_name,t.company_name].filter(Boolean).join(" · ");return n?`Connected to ${n}.`:"Connected."}const a=e.card.reachableCount(t);return a?`${a} reachable ${e.slug==="google_analytics"?a===1?"property":"properties":a===1?"account":"accounts"}.`:"Connected."}function Vp(e){let t="";Te()&&(e.connect&&(L.status==="idle"||L.status==="broken")&&L.configured&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${L.status==="broken"?"Reconnect":"Connect"}</button>`),e.slug==="callrail"&&L.status!=="connected"&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${L.status==="broken"?"Reconnect":"Connect"}</button>`));let a;return L.status==="unavailable"?a=`${e.label} is being set up for this platform.`:L.status==="broken"?a=e.card.brokenDesc:L.status==="idle"?a=Te()?e.card.idleDesc:e.card.sub:a=jp(e),`
    ...
    </div>`}function Wp(e){const t=Cp[e.slug];if(!t)return"";if(L.status==="connected"||L.status==="unavailable"||!Te())return`
      <div class="dashboard-card intg-card">
        <div class="card-body">
    ...
    <div class="dashboard-card intg-card">
    ...
    </div>`}function Yp(e){if(L.status!=="connected")return"";const t=Te();if(e.picker){const a=e.card.reachableCount(L.conn?.external_account);return`
      <div class="dashboard-card intg-card">
        <div class="card-body">
      ...
      </div>`:""}function tn(e){if(!e)return"";try{return new Date(e).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric"})}catch{return String(e).slice(0,10)}}function Kp(e){if(!L.conn)return"";const t=L.conn.webhook||{},a=[];a.push(["Status",L.status==="connected"?"Active":L.conn.connect_status==="NEEDS_REAUTH"?"Needs reconnecting":"Error"]),e.slug==="calendly"&&(a.push(["Booking sync",t.state==="active"?"On":"Off (paid Calendly plan required)"]),t.last_received_tz&&a.push(["Last booking received",tn(t.last_received_tz)])),e.slug==="callrail"&&(a.push(["Call sync",t.state==="active"?"On":"Needs attention"]),t.cookie_capture&&a.push(["Session capture",t.cookie_capture==="active"?"On":"Needs attention"]),t.last_received_tz&&a.push(["Last call received",tn(t.last_received_tz)])),L.conn.created?.created_tz&&a.push(["Connected on",tn(L.conn.created.created_tz)]);const n=e.slug==="calendly"&&L.status==="connected"&&t.state!=="active"?xe("Booking sync is off: webhooks need a paid Calendly plan. Visitors can still book in the magnet; bookings just will not appear on the lead automatically. Reconnect after upgrading to turn it on.","error"):e.slug==="callrail"&&L.status==="connected"&&t.state!=="active"?xe("Automatic call sync could not be set up in CallRail. Calls still arrive via the daily sweep and Sync now. Reconnect to retry the setup.","error"):"";return`
    <div class="dashboard-card intg-card">
      <div class="card-body">
    ...
    </div>`}function Jp(e){return L.status!=="connected"&&L.status!=="broken"||!Te()?"":`
    ...
    </div>`}function Qp(){const e=L.provider;if(!e)return;const t=bn;e.connect&&document.getElementById(e.card.ids.connect)?.addEventListener("click",()=>Tp(e)),e.slug==="callrail"&&(document.getElementById(e.card.ids.connect)?.addEventListener("click",()=>zo({refresh:t})),document.getElementById("intg-r-replace")?.addEventListener("click",()=>zo({refresh:t,replaceKey:!0})),document.getElementById(e.card.ids.sync)?.addEventListener("click",()=>Mp({refresh:t})),L.status==="connected"&&Te()&&eu()),e.picker&&(document.getElementById(e.card.ids.choose)?.addEventListener("click",()=>Rr(e,{refresh:t})),document.getElementById(e.card.ids.sync)?.addEventListener("click",()=>$p(e,{refresh:t}))),e.slug==="google_ads"&&L.status==="connected"&&Te()&&Xp(),e.slug==="calendly"&&L.status==="connected"&&Te()&&Zp(),document.getElementById(e.card.ids.disconnect)?.addEventListener("click",()=>Lp(e,{refresh:t}))}async function Xp(){const e=document.getElementById("intg-g-convactions");if(e)try{const a=await(await fetch(`${ee()}/m5t/v5/integrations/google_ads/conversion_actions`)).json();if(!a.ok)throw new Error(a.error||"load failed");const n=a.data.actions||[],o=new Set(a.data.selected||[]);if(!n.length){e.innerHTML=xe("No enabled conversion actions in the linked accounts.");return}e.innerHTML=`
  ...
  `,document.head.appendChild(e),jo=!0}const Hn=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Fr(){return ou(),`
    <div class="page-shell" data-section="settings-security">
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Signing in as ${qt(cu())}. You stay signed in on this device after a change.</p>
            </div>
          </div>
          <div class="settings-grid-2">
            <div class="settings-field">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="pk-body">${Hn("hourglass_empty","Loading…")}</div>
      </div>
    </div>`}async function Dr(){document.getElementById("pw-save")?.addEventListener("click",pu);const e=document.getElementById("pk-add-btn");e&&window.PublicKeyCredential&&(e.style.display="",e.addEventListener("click",iu)),await Br()}async function Br(){const e=document.getElementById("pk-body");if(e){try{const t=await fetch(`${Jt()}/m5t/v5/webauthn`),a=await t.json().catch(()=>({}));if(!t.ok||!a.ok)throw new Error(a.error||"Failed to load");Ct.passkeys=a.passkeys||[],Ct.loaded=!0}catch(t){console.warn("[settings-security] load failed:",t),e.innerHTML=Hn("error","Could not load your passkeys. Please try again.");return}qr()}}function Vo(e){if(!e)return null;try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return null}}function su(e){const t=Vo(e.last_used_time),a=e.created?.created_tz,n=Vo(a),o=[e.device_type==="multiDevice"?"Syncs across devices":"This device only",t?`Last used ${t}`:"Never used to sign in yet",n?`Added ${n}`:null].filter(Boolean).join(" · ");return`
    <div class="pk-row" data-guid="${qt(e.guid)}">
      <span class="pk-icon"><span class="material-symbols-outlined" aria-hidden="true">passkey</span></span>
      <div class="pk-info">
        <div class="pk-name">${qt(e.device_label||"Passkey")}</div>
        <div class="pk-meta">${qt(o)}</div>
      </div>
      <button class="pk-btn pk-btn--danger" type="button" data-remove="${qt(e.guid)}">
        <span class="material-symbols-outlined" aria-hidden="true">delete</span> Remove
      </button>
    </div>`}function qr(){const e=document.getElementById("pk-body");if(e){if(!window.PublicKeyCredential){e.innerHTML=`<p class="pk-unsupported">This browser doesn't support passkeys. Your password sign-in still works as usual.</p>`;return}if(!Ct.passkeys.length){e.innerHTML=Hn("passkey","No passkeys yet. Add one for a faster, phishing-resistant sign-in.");return}e.innerHTML=Ct.passkeys.map(su).join(""),e.querySelectorAll("[data-remove]").forEach(t=>{t.addEventListener("click",()=>lu(t.dataset.remove,t))})}}function ru(){try{const e=navigator.userAgent||"",t=/iPhone/.test(e)?"iPhone":/iPad/.test(e)?"iPad":/Android/.test(e)?"Android":/Mac OS X/.test(e)?"Mac":/Windows/.test(e)?"Windows":/Linux/.test(e)?"Linux":"device",a=/Edg\//.test(e)?"Edge":/Chrome\//.test(e)?"Chrome":/Firefox\//.test(e)?"Firefox":/Safari\//.test(e)?"Safari":"";return a?`${a} on ${t}`:t}catch{return"Passkey"}}async function iu(){const e=document.getElementById("pk-add-btn");e&&(e.disabled=!0);try{const{startRegistration:t}=await j(async()=>{const{startRegistration:i}=await Promise.resolve().then(()=>Qs);return{startRegistration:i}},void 0,import.meta.url),a=await fetch(`${Jt()}/m5t/v5/webauthn/register/options`,{method:"POST"}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||"Could not start passkey registration");let o;try{o=await t({optionsJSON:n.options})}catch(i){if(i?.name==="NotAllowedError")return;throw i}const s=await fetch(`${Jt()}/m5t/v5/webauthn/register/verify`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o,deviceLabel:ru()})}),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.error||"Could not register this passkey");Kt("Passkey added","success"),await Br()}catch(t){console.warn("[settings-security] addPasskey failed:",t),Kt(t.message||"Could not add a passkey","danger")}finally{e&&(e.disabled=!1)}}async function lu(e,t){if(await Lr({title:"Remove this passkey?",message:"You can always add it back later.",confirmLabel:"Remove",danger:!0})){t&&(t.disabled=!0);try{const n=await fetch(`${Jt()}/m5t/v5/webauthn/${encodeURIComponent(e)}`,{method:"DELETE"}),o=await n.json().catch(()=>({}));if(!n.ok||!o.ok)throw new Error(o.error||"Could not remove this passkey");Ct.passkeys=Ct.passkeys.filter(s=>s.guid!==e),Kt("Passkey removed","success"),qr()}catch(n){console.warn("[settings-security] removePasskey failed:",n),Kt(n.message||"Could not remove this passkey","danger"),t&&(t.disabled=!1)}}}function cu(){try{return E.getScope()?.entity?.email||E.getEntity?.()?.email||"your account"}catch{return"your account"}}const ra=e=>{const t=document.getElementById("pw-error");t&&(t.textContent=e||"",t.hidden=!e)},du=e=>e.length<=1?String(e[0]??""):e.length===2?`${e[0]} and ${e[1]}`:`${e.slice(0,-1).join(", ")}, and ${e[e.length-1]}`;async function pu(){const e=document.getElementById("pw-new"),t=document.getElementById("pw-confirm"),a=document.getElementById("pw-save"),n=e?.value||"",o=t?.value||"",s=Bn(n);if(s.length){ra(`Password needs: ${du(s)}.`);return}if(n!==o){ra("Passwords do not match.");return}ra(""),a&&(a.disabled=!0);try{const r=await fetch(`${Jt()}/m5t/v5/acctEntity/resetHash`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({password:n})}),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok)throw new Error(i.error||"Could not update your password");Kt("Password updated","success"),e&&(e.value=""),t&&(t.value="")}catch(r){ra(r.message||"Could not update your password.")}finally{a&&(a.disabled=!1)}}const uu={render:Fr,init:Dr},mu=Object.freeze(Object.defineProperty({__proto__:null,default:uu,init:Dr,render:Fr},Symbol.toStringTag,{value:"Module"})),gu={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},re=e=>String(e??"").replace(/[&<>"']/g,t=>gu[t]),_n=()=>E.getConfig?.().BASE_URL||"",an=e=>Number(e||0).toLocaleString(),W={conversations:[],counts:{},magnetNames:{},filter:"ALL",book:!1,magnetOwnerNames:{}},Wo={COMPLETED:{label:"Completed",icon:"check_circle"},IN_PROGRESS:{label:"In progress",icon:"pending"},ABANDONED:{label:"Abandoned",icon:"highlight_off"}},yn={book:"Book",chat:"Chat",call:"Call",email:"Email",support:"Support"};function Ur(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email)||null}function zr(e){return(e.split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase()}function Hr(e){try{return new Date(e).toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return""}}function hu(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function Gr(e){return e==null?"—":e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,"0")}s`}let Yo=!1;function fu(){if(Yo)return;const e=document.createElement("style");e.id="m5t-convs-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Yo=!0}const Ba=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function jr(){return fu(),bt(),`
    <div class="page-shell" data-section="conversations">
      <div class="page-header">
        <div class="page-header-text">
          <h1 class="page-title">Conversations</h1>
          <p class="page-description">${oe()?"All conversations across your clients.":"Every visitor journey through your magnets: completed, in progress, or abandoned."}</p>
        </div>
      </div>
      <div class="dashboard-card">
        <div class="card-body" id="convs-body">
          ${Ba("hourglass_empty","Loading journeys…")}
        </div>
      </div>
    </div>`}async function Vr(){await vu()}async function vu(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${_n()}/m5t/v5/conversations`),fetch(`${_n()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(W.conversations=n.conversations||[],W.counts=n.counts||{},W.book=oe(),a){const o=await a.json().catch(()=>({}));W.magnetNames={},W.magnetOwnerNames={};const s=W.book?sr():{};(o.magnets||[]).forEach(r=>{W.magnetNames[r.guid]=r.name,W.book&&(W.magnetOwnerNames[r.guid]=r.owner_name||s[r.owner_guid]||"")})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=Ba("error","Could not load journeys. Please try again.");return}Wr()}}function bu(){return W.filter==="ALL"?W.conversations:W.conversations.filter(e=>e.status===W.filter)}function _u(e){const t=Ur(e.lead),a=W.magnetNames[e.magnet_guid]||"—",n=Wo[e.status]||Wo.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,s=(e.routes||[]).map(r=>yn[r]||r).join(", ");return`
    <tr class="convs-row" data-session="${re(e.session)}">
      <td>
        <span class="convs-who">
          <span class="convs-ava${t?"":" anon"}">${t?re(zr(t)):'<span class="material-symbols-outlined" style="font-size:16px">person_off</span>'}</span>
          <span><span class="convs-name">${t?re(t):'<span class="convs-muted">Anonymous visitor</span>'}</span>
            ${e.lead?.email?`<div class="convs-sub">${re(e.lead.email)}</div>`:s?`<div class="convs-sub">Picked: ${re(s)}</div>`:""}</span>
        </span>
      </td>
      ${W.book?`<td>${rr(W.magnetOwnerNames[e.magnet_guid]||"")||'<span class="convs-muted">—</span>'}</td>`:""}
      <td><span class="convs-sub">${re(a)}</span></td>
      <td><span class="convs-badge" data-s="${re(e.status)}"><span class="material-symbols-outlined" aria-hidden="true">${n.icon}</span>${n.label}</span></td>
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${re(Hr(e.started_at))}">${re(hu(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${re(Gr(e.duration_s))}</td>
    </tr>`}function Wr(){const e=document.getElementById("convs-body");if(!e)return;if(!W.conversations.length){e.innerHTML=Ba("route","No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.");return}const t=bu(),a=[["ALL","All"],["COMPLETED","Completed"],["IN_PROGRESS","In progress"],["ABANDONED","Abandoned"]];e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${a.map(([n,o])=>`<button data-filter="${n}" class="${W.filter===n?"active":""}">${o}${n!=="ALL"&&W.counts[n]?` (${an(W.counts[n])})`:""}</button>`).join("")}
      </div>
      <span class="convs-count">${an(t.length)} of ${an(W.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(_u).join("")||`<tr><td colspan="${W.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${W.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(W.filter=o.dataset.filter,Wr())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&wu(o.dataset.session)})}const yu={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${yn[e]||e}`:""}`,route:e=>`Picked ${yn[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function wu(e){const t=W.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${_n()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=Ur(t.lead),o=W.magnetNames[t.magnet_guid]||"—",r=(a?.events||[]).filter((c,u,v)=>c.event!=="step"||!(v[u+1]&&v[u+1].event==="step")).map(c=>`
    <div class="convs-tl__item${c.event==="complete"?" done":""}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${re((yu[c.event]||(()=>c.event))(c.detail))}</div>
      <div class="convs-tl__time">${re(Hr(c.at))}${c.variant?` · Variant ${re(c.variant)}`:""}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      <div class="convs-drawer__head">
        <span class="convs-drawer__title">${n?re(n):"Anonymous visitor"}</span>
      ...
      <div class="convs-drawer__body">
        ${n?`<a class="convs-drawer__lead" href="#/leads">
              <span class="convs-ava">${re(zr(n))}</span>
              <span><div class="convs-name">${re(n)}</div><div class="convs-sub">${re(t.lead?.email||t.lead?.phone||"")}</div></span>
        ...
        <div class="convs-sub" style="margin-bottom:6px">${re(o)} · ${re(Gr(t.duration_s))}${t.variant?` · Variant ${re(t.variant)}`:""}</div>
        ${r?`<div class="convs-tl">${r}</div>`:Ba("timeline","No timeline available for this journey.")}
      </div>
    </aside>`,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("open"),i.querySelector(".convs-drawer").classList.add("open")});const l=()=>{i.classList.remove("open"),setTimeout(()=>i.remove(),220)};i.querySelector(".convs-drawer__close").addEventListener("click",l),i.addEventListener("click",c=>{c.target===i&&l()})}const xu={render:jr,init:Vr},Eu=Object.freeze(Object.defineProperty({__proto__:null,default:xu,init:Vr,render:jr},Symbol.toStringTag,{value:"Module"})),ku={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},pt=e=>String(e??"").replace(/[&<>"']/g,t=>ku[t]),Ko=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},pa=()=>E.getConfig?.().BASE_URL||"",Tt=e=>Number(e||0).toLocaleString(),Xe={magnets:[],stats:{},canManage:!1},Au={mag_title:"header title",mag_subtitle:"subtitle",mag_welcome:"welcome message",mag_theme_color:"color",mag_launcher_label:"launcher label"};let Jo=!1;function Su(){if(Jo)return;const e=document.createElement("style");e.id="m5t-abt-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Jo=!0}const Gn=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Yr(){return oe()?Lt({section:"ab-testing",title:"A/B Testing",description:"Pick a client to view their experiments."}):(Su(),`
    <div class="page-shell" data-section="ab-testing">
      ...
      <div id="abt-body">${Gn("hourglass_empty","Loading tests…")}</div>
    </div>`)}async function jn(){if(oe())return _t(pa(),[{h:"Running",td:t=>Tt(t.ab_tests?.running)},{h:"Completed",td:t=>Tt(t.ab_tests?.completed)},{h:"Compl. %",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Experiments appear per client once you have one."});const e=document.getElementById("abt-body");try{const t=new Date,a=new Date(t.getTime()-89*864e5).toISOString().slice(0,10),n=t.toISOString().slice(0,10),[o,s]=await Promise.all([fetch(`${pa()}/m5t/v5/magnets`),fetch(`${pa()}/m5t/v5/magnets/stats?from=${a}&to=${n}`)]),r=await o.json().catch(()=>({}));if(!r.ok)throw new Error(r.message||"Failed to load");Xe.magnets=r.magnets||[],Xe.canManage=!!r.canManage;const i=await s.json().catch(()=>({}));Xe.stats=i?.stats||{}}catch(t){console.warn("[ab-testing] load failed:",t),e&&(e.innerHTML=Gn("error","Could not load your tests. Please try again."));return}Cu()}function Cu(){const e=document.getElementById("abt-body");if(!e)return;const t=Xe.magnets.filter(n=>n.ab?.enabled),a=Xe.magnets.filter(n=>!n.ab?.enabled&&n.ab?.declared);if(!t.length&&!a.length){e.innerHTML=Gn("science","No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.");return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(Iu).join("")}`:"")+(a.length?`<div class="abt-sect">Completed Tests</div>${a.map(Ru).join("")}`:""),e.querySelectorAll("[data-declare]").forEach(n=>n.addEventListener("click",()=>Nu(n.dataset.declare,n.dataset.winner)))}function Tu(e){const t=Xe.stats[e.guid]?.variants||{},a={opens:0,engaged:0,completions:0,rate:null,...t.A||{}},n={opens:0,engaged:0,completions:0,rate:null,...t.B||{}};return{A:a,B:n}}function $u(e){const t=Object.keys(e?.b||{}).map(a=>Au[a]||a);return t.length?`Changes: ${t.join(", ")}`:""}function Lu(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function Qo(e,t,a,n,o,s){return`
    <div class="abt-variant${o?" leader":""}">
      <div class="abt-vhead"><span class="abt-vname">${pt(e)}</span><span class="abt-vtag${o?" win":""}">${pt(t)}</span></div>
      ${a?`<div class="abt-vdesc">${pt(a)}</div>`:""}
      <div class="abt-mrow"><span class="k">Visitors</span><span class="v">${Tt(n.opens)}</span></div>
      <div class="abt-mrow"><span class="k">Completions</span><span class="v">${Tt(n.completions)}</span></div>
    ...
    </div>`}function Iu(e){const t=e.ab,{A:a,B:n}=Tu(e),o=(n.rate??-1)>(a.rate??-1)?"B":(a.rate??-1)>(n.rate??-1)?"A":null,s=o&&a.rate!=null&&n.rate!=null?`+${Math.round(Math.abs(n.rate-a.rate)*10)/10}%`:"",r=Ou(a,n),i=t.started_tz?Lu(t.started_tz):null,l=(a.opens||0)+(n.opens||0),c=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
        <h2 class="abt-name">${pt(e.name)}</h2>
        <span class="abt-status running"><span class="pulse-dot"></span>Running</span>
        <div class="abt-actions">
          ${Xe.canManage&&o?`<button class="btn btn-primary" type="button" data-declare="${pt(e.guid)}" data-winner="${o}"><span class="material-symbols-outlined" aria-hidden="true">emoji_events</span>Declare Winner</button>`:""}
        </div>
      </div>
      <div class="abt-meta">
        ${i!=null?`<span><span class="material-symbols-outlined" aria-hidden="true">schedule</span>Started ${i===0?"today":`${i} day${i===1?"":"s"} ago`}</span>`:""}
        <span><span class="material-symbols-outlined" aria-hidden="true">visibility</span>${Tt(l)} total visitors</span>
      ...
      <div class="abt-compare">
        ${Qo("Variant A","Control","The magnet as configured",a,o==="A",o==="A"?s:"")}
        <div class="abt-vs">VS</div>
        ${Qo("Variant B",o==="B"?"Leading":"Challenger",$u(t),n,o==="B",o==="B"?s:"")}
      </div>
      <div class="abt-sig">
    ...
    <div class="abt-card">
      ...
      <div class="abt-summary">
        <span><span class="k">Winner:</span><span class="v">Variant ${pt(t.winner)}</span></span>
        ...
        <span><span class="k">Total Visitors:</span><span class="v">${Tt(r)}</span></span>
      </div>
    </div>`}async function Nu(e,t){const a=Xe.magnets.find(n=>n.guid===e);if(a&&window.confirm(`Declare Variant ${t} the winner for “${a.name}”?

${t==="B"?"Variant B’s changes become the magnet’s configuration for everyone.":"The magnet keeps its current configuration."} The experiment ends and moves to Completed.`)){try{const o=await(await fetch(`${pa()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Declare failed");Ko(`Variant ${t} declared the winner`,"success")}catch(n){Ko(n.message||"Could not declare a winner","danger");return}try{await jn()}catch(n){console.warn("[ab-testing] refresh after declare failed:",n)}}}function Ou(e,t){const a=e.opens||0,n=t.opens||0,o=e.completions||0,s=t.completions||0;if(a<30||n<30||o+s<5)return null;const r=o/a,i=s/n,l=(o+s)/(a+n),c=Math.sqrt(l*(1-l)*(1/a+1/n));if(!c)return null;const u=Math.abs(i-r)/c;return Math.round(2*(Mu(u)-.5)*1e3)/10}function Mu(e){const t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}const Pu={render:Yr,init:jn},Fu=Object.freeze(Object.defineProperty({__proto__:null,default:Pu,init:jn,render:Yr},Symbol.toStringTag,{value:"Module"})),Du={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},le=e=>String(e??"").replace(/[&<>"']/g,t=>Du[t]),Kr=()=>E.getConfig?.().BASE_URL||"",Bu={single_select:{icon:"quiz",color:"#0072BA",darkColor:"#38BDF8"},multi_select:{icon:"checklist",color:"#0E6BA8",darkColor:"#22D3EE"},scheduler:{icon:"event",color:"#915E8B",darkColor:"#E879F9"},text:{icon:"short_text",color:"#5B54C6",darkColor:"#A78BFA"},email:{icon:"mail",color:"#0E8F86",darkColor:"#2DD4BF"},phone:{icon:"call",color:"#2E8B57",darkColor:"#4ADE80"},message:{icon:"chat",color:"#B4791F",darkColor:"#FBBF24"}},wa={};On.forEach(e=>{wa[e.value]={label:e.label,...Bu[e.value]||{icon:"quiz",color:"#0072BA",darkColor:"#38BDF8"}}});const Jr=On.map(e=>e.value),Qr={chat:"Chat / default",book:"Book (scheduler)",support:"Support (intake)"},Vn=e=>{const t=wa[e]||wa.single_select;return document.documentElement.getAttribute("data-theme")==="dark"?{...t,color:t.darkColor}:t},yt=e=>e==="single_select"||e==="multi_select",qa=e=>e!=="message",It=e=>e==="scheduler",ea=e=>e==="message",xa=e=>e==="email"?"email":e==="phone"?"phone":"",Rt=()=>({meeting_label:"",start:"09:00",end:"17:00",mins:30,days:14}),qu=["meeting_label","start","end","mins","days"],Xo=["terminal","cta"];function wn(e,t){const a={};return Object.keys(e&&typeof e=="object"?e:{}).forEach(n=>{t.includes(n)||(a[n]=e[n])}),Object.keys(a).length?a:null}function Xr(e){return wn(e,qu)}const Uu=[["","No icon"],["event","Calendar"],["schedule","Clock"],["mail","Email"],["sms","Text"],["phone","Phone"],["chat","Chat"],["description","Document"],["help","Question"],["place","Location"],["person","Person"],["bolt","Quick"],["check_circle","Check"],["star","Star"],["home","Home"],["build","Service"]];function zu(e,t){const a=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||"").trim());return a?`rgba(${parseInt(a[1],16)},${parseInt(a[2],16)},${parseInt(a[3],16)},${t})`:`rgba(0,114,186,${t})`}let Zo=!1;function Hu(){if(Zo)return;const e=document.createElement("style");e.id="m5t-flow-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Zo=!0}let F=[],Me=null,Gu=0,We=null,it=null,lt="chat",Ee={},ua=[],Zr=null,xn=null,ma="";const $t=()=>"f"+ ++Gu;function Wn(e="single_select"){return{_uid:$t(),id:"",step_type:e,step_prompts:[""],step_options:yt(e)?[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]:[],step_columns:xa(e)?[xa(e)]:[],step_description:"",step_config:It(e)?Rt():null}}function ju(e){return(Array.isArray(e)?e:[]).map(t=>({_uid:$t(),id:t.id!=null?String(t.id):"",step_type:wa[t.step_type]?t.step_type:"single_select",step_prompts:Array.isArray(t.step_prompts)?t.step_prompts.map(String):[],step_options:(Array.isArray(t.step_options)?t.step_options:[]).map(a=>({label:a&&a.label!=null?String(a.label):"",goto:a&&a.goto!=null?String(a.goto):"",icon:a&&a.icon!=null?String(a.icon):""})),step_columns:Array.isArray(t.step_columns)?t.step_columns.map(String):[],step_description:t.step_description!=null?String(t.step_description):"",step_config:It(t.step_type)?{...Rt(),...t.step_config&&typeof t.step_config=="object"?t.step_config:{}}:t.step_config&&typeof t.step_config=="object"?{...t.step_config}:null}))}function es(){return[{_uid:$t(),id:"",step_type:"text",step_prompts:["Great, and your name?"],step_options:[],step_columns:["first_name"],step_description:"",step_config:null},{_uid:$t(),id:"",step_type:"email",step_prompts:["The best email to reach you?"],step_options:[],step_columns:["email"],step_description:"",step_config:null}]}function Vu(e,t){if(e==="book")return[{_uid:$t(),id:"",step_type:"scheduler",step_prompts:["When works best for you?"],step_options:[],step_columns:[],step_description:"",step_config:Rt()},...es()];if(e==="support"){const a=(t.actions||[]).find(s=>s&&s.type==="support"),n=a&&a.config&&Array.isArray(a.config.options)?a.config.options:[],o=n.length?n.map(s=>({label:s&&s.label||String(s),goto:"",icon:s&&s.icon||""})):["Sales enquiry","Support","Billing","Something else"].map(s=>({label:s,goto:"",icon:""}));return[{_uid:$t(),id:"",step_type:"multi_select",step_prompts:["How can we help you today?"],step_options:o,step_columns:[],step_description:"Select all that apply",step_config:null},...es()]}return[Wn("single_select")]}function ei(e,t){const a=e==="chat"?t.steps:t.routes&&t.routes[e],n=ju(a);return n.length?n:e==="chat"?[Wn("single_select")]:Vu(e,t)}function Wu(e){yt(e.step_type)?e.step_options.length||(e.step_options=[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]):e.step_options=[],qa(e.step_type)?!e.step_columns.length&&xa(e.step_type)&&(e.step_columns=[xa(e.step_type)]):e.step_columns=[],e.step_config=It(e.step_type)?{...Rt(),...e.step_config||{}}:Xr(e.step_config)}function Yu(e,t){return`<div class="flow-opt">
  ...
  </div>`}function Ku(e){const t=Jr.map(n=>`<option value="${n}"${n===e.step_type?" selected":""}>${le(Vn(n).label)}</option>`).join(""),a=e.step_options.length<=1;return`<div class="flow-node__body">
...
`))}</textarea>
    ...
    <select class="mag-modal__select flow-f-field">
      ...
      ${Nn.map(n=>`<option value="${le(n.value)}"${n.value===e.step_columns[0]?" selected":""}>${le(n.label)}</option>`).join("")}
    </select>
    ...
    <div class="flow-opts">${e.step_options.map(n=>Yu(n,a)).join("")}</div>
  ...
  </div>`}function Ju(e){const t=e.step_prompts.find(o=>String(o).trim()!=="")||"",a=t?`<div class="flow-node__prompt">“${le(t)}”</div>`:`<div class="flow-node__prompt is-empty">${e.step_type==="message"?"No message yet":"No question yet"}</div>`;let n="";if(yt(e.step_type)){const o=e.step_options.map(s=>String(s.label).trim()).filter(Boolean);if(o.length){const s=o.slice(0,4).map(i=>`<span class="flow-node__chip">${le(i)}</span>`).join(""),r=o.length>4?`<span class="flow-node__chip">+${o.length-4}</span>`:"";n=`<div class="flow-node__chips">${s}${r}</div>`}}else if(qa(e.step_type)&&e.step_columns[0]){const o=Nn.find(s=>s.value===e.step_columns[0])?.label||e.step_columns[0];n=`<div class="flow-node__meta">Saves to <b>${le(o)}</b></div>`}else if(ea(e.step_type)&&e.step_config?.terminal){const o=String(e.step_config?.cta?.label||"").trim();n=`<div class="flow-node__meta">Ends the conversation${o?` — link: <b>${le(o)}</b>`:""}</div>`}return`<div class="flow-node__preview">${a}${n}</div>`}function Qu(e,t,a){const n=Vn(e.step_type),o=e._uid===Me,s=`--nc:${n.color};--nct:${zu(n.color,.14)}`;return`<div class="flow-node${o?" flow-node--open":""}" data-uid="${e._uid}" style="${s}"${o?"":' draggable="true"'}>
    ...
    ${o?Ku(e):Ju(e)}
  </div>`}const ts='<div class="flow-conn"><span class="flow-conn__line"></span><span class="material-symbols-outlined" aria-hidden="true">expand_more</span></div>';function Ae(){const e=document.getElementById("flow-nodes");if(!e)return;const t=F.length,a=['<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>',ts];F.forEach((n,o)=>{a.push(Qu(n,o,t)),o<t-1&&a.push(ts)}),e.innerHTML=a.join("")}function Pe(){const e=document.querySelector(".flow-node--open");if(!e)return;const t=F.find(s=>s._uid===e.dataset.uid);if(!t)return;const a=e.querySelector(".flow-f-type");a&&(t.step_type=a.value);const n=e.querySelector(".flow-f-prompts");n&&(t.step_prompts=n.value.split(`
`));const o=e.querySelector(".flow-f-field");if(t.step_columns=o&&o.value.trim()?[o.value.trim()]:[],yt(t.step_type)){const s=t.step_options,r=[];e.querySelectorAll(".flow-opt").forEach((i,l)=>{r.push({label:i.querySelector(".flow-o-label")?.value??"",icon:i.querySelector(".flow-o-icon")?.value??"",goto:s[l]&&s[l].goto||""})}),t.step_options=r}else t.step_options=[];if(It(t.step_type)){const s=e.querySelector(".flow-f-mtlabel"),r=e.querySelector(".flow-f-start"),i=e.querySelector(".flow-f-end"),l=e.querySelector(".flow-f-mins");t.step_config={...t.step_config||Rt(),...s?{meeting_label:s.value.trim()}:{},...r&&r.value?{start:r.value}:{},...i&&i.value?{end:i.value}:{},...l?{mins:parseInt(l.value,10)||30}:{}}}else if(ea(t.step_type)){const s=e.querySelector(".flow-f-terminal");if(s){const r=e.querySelector(".flow-f-cta-label"),i=e.querySelector(".flow-f-cta-url"),l=wn(t.step_config,Xo)||{};t.step_config=s.checked?{...l,terminal:!0,cta:{label:r?r.value:"",url:i?i.value:""}}:wn(t.step_config,Xo)}}else t.step_config=Xr(t.step_config)}function ti(){document.querySelectorAll(".flow-node.drop-before, .flow-node.drop-after").forEach(e=>e.classList.remove("drop-before","drop-after"))}function Pt(){ti(),document.querySelectorAll(".flow-node.dragging").forEach(e=>e.classList.remove("dragging")),We=null,it=null}function Xu(e=F){if(!e.length)return{message:"Add at least one step.",uid:null,field:null};for(let t=0;t<e.length;t++){const a=e[t],n=t+1,o=(s,r=null)=>({message:s,uid:a._uid,field:r});if(!a.step_prompts.some(s=>String(s).trim()!==""))return o(`Step ${n}: add what the magnet should say.`,"prompts");if(yt(a.step_type)&&!a.step_options.some(s=>String(s.label).trim()!==""))return o(`Step ${n}: add at least one choice.`,"options");if(qa(a.step_type)&&!a.step_columns.length)return o(`Step ${n}: choose which field this answer saves to.`,"field");if(ea(a.step_type)&&a.step_config?.terminal){const s=String(a.step_config.cta?.label||"").trim(),r=String(a.step_config.cta?.url||"").trim();if(!!s!=!!r)return o(`Step ${n}: fill in both the link label and URL, or leave both blank.`,"cta")}}return null}function ai(e){if(!e)return;const t=e.querySelector(".flow-f-cta-label"),a=e.querySelector(".flow-f-cta-url");if(!t||!a)return;const n=t.value.trim()!=="",o=a.value.trim()!=="",s=n||o,r=n!==o;e.querySelectorAll(".flow-cta-req").forEach(l=>{l.textContent=s?"required":"optional",l.classList.toggle("flow-sub--req",s)}),t.classList.toggle("flow-f-invalid",r&&!n),a.classList.toggle("flow-f-invalid",r&&!o);const i=e.querySelector(".flow-cta-warn");i&&(i.hidden=!r)}function En(e=F){let t=0;return e.forEach(a=>{const n=parseInt(a.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(a=>{const n=a.id&&String(a.id).trim()?String(a.id):String(++t),o=yt(a.step_type)?a.step_options.map(r=>{const i={label:String(r.label).trim(),goto:String(r.goto||"")};return r.icon&&(i.icon=String(r.icon)),i}).filter(r=>r.label!==""):[],s={id:n,step_type:a.step_type,step_prompts:a.step_prompts.map(r=>String(r)).filter(r=>r.trim()!==""),step_options:o,step_columns:a.step_columns.slice(),step_description:a.step_description||""};if(It(a.step_type))a.step_config&&(s.step_config={...Rt(),...a.step_config});else if(a.step_config&&Object.keys(a.step_config).length){const r={...a.step_config};if(ea(a.step_type)&&r.terminal){const i=String(r.cta?.label??"").trim(),l=String(r.cta?.url??"").trim();i&&l?r.cta={label:i,url:l}:delete r.cta}s.step_config=r}return s})}function Zu(e,t,a){Hu(),Zr=t,xn=typeof a=="function"?a:null,ma=t?.modified_tz||"",ua=["chat",...["book","support"].filter(n=>(t.actions||[]).some(o=>o&&o.type===n))],Ee={chat:ei("chat",t)},lt="chat",F=Ee.chat,Me=F.length===1?F[0]._uid:null,We=null,it=null,e.innerHTML=`
    ...
    ${ua.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${ua.map(n=>`<option value="${n}">${le(Qr[n]||n)}</option>`).join("")}</select></div>`:""}
...
<body>
  ...
  <\/script>
  <script>${a}<\/script>
</body></html>`}let ns=!1;function oi(){if(ns)return;const e=document.createElement("style");e.id="m5t-preview-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ns=!0}function si(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function ri(e){const t=e.querySelector("[data-pv-info]"),a=e.querySelector("[data-pv-info-pop]");t&&a&&t.addEventListener("click",()=>{a.hidden=!a.hidden})}function rm(e,t){oi(),e.innerHTML=`
    <div class="pv-pane">
      ...
      ${si("Live render of the real widget. Capture is disabled, so no test leads.")}
    </div>`,ri(e);const a=e.querySelector(".pv-pane__frame"),n=e.querySelector(".pv-pane__badge");let o=null,s=0;const r=450,i=()=>{const c=(typeof performance<"u"?performance.now():Date.now())-s;clearTimeout(o),c<r?o=setTimeout(()=>{n.hidden=!0},r-c):n.hidden=!0};a.addEventListener("load",i);const l=()=>{let c;try{c=ni(t())}catch{return}s=typeof performance<"u"?performance.now():Date.now(),n.hidden=!1,a.srcdoc=c,clearTimeout(o),o=setTimeout(()=>{n.hidden=!0},1500)};return e.querySelector(".pv-pane__seg").addEventListener("click",c=>{const u=c.target.closest("button[data-device]");!u||u.dataset.device===a.dataset.device||(e.querySelectorAll(".pv-pane__seg button").forEach(v=>v.classList.toggle("is-on",v===u)),a.dataset.device=u.dataset.device)}),l(),{refresh:l,destroy(){clearTimeout(o)}}}function Yn(e){oi();let t="desktop";const a=document.createElement("div");a.className="pv-scrim",a.innerHTML=`
    ...
    <div class="mag-tpl-card${s}"${r}>${i}${l}
      ...
      ${a?`<div class="mag-tpl-card__actions">${u}${v}</div>`:u}
    </div>`}const dm=300*1e3;function pm(e){qn(ht.MAGNET_TEMPLATE,{id:e,at:Date.now()})}function ci(e){if(!e)return null;if(typeof e=="string")return Ze.find(n=>n.id===e)||null;const{id:t,at:a}=e;return typeof a=="number"&&Date.now()-a>=dm?null:Ze.find(n=>n.id===t)||null}function um(){return ci(mn(ht.MAGNET_TEMPLATE))}function mm(){return ci(Ed(ht.MAGNET_TEMPLATE))}let ss=!1;function di(){if(ss)return;const e=document.createElement("style");e.id="m5t-mag-template-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ss=!0}function gm(e){di();const t=document.createElement("div");t.className="mag-modal-scrim mag-tpl-modal",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(o){o.key==="Escape"&&(o.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.querySelectorAll("[data-tpl]").forEach(o=>{o.addEventListener("click",()=>{const s=Ze.find(r=>r.id===o.dataset.tpl);s&&(t.querySelectorAll("[data-tpl]").forEach(r=>{r.disabled=!0}),a(),e(s))})})}let rs=!1;const G={magnets:[],owners:[],canProvision:!1,canManage:!1,primaryOrgGuid:null,stats:{}},hm={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},x=e=>String(e??"").replace(/[&<>"']/g,t=>hm[t]),je=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},ne=()=>E.getConfig?.().BASE_URL||"",pi=e=>`<script src="${ne()}/m5t/v5/coreSnippet?appguid=${e}" async><\/script>`,ui=()=>`<details class="mag-csp-note" open>
  ...
  <div class="mag-csp-note__body">
    <p>A strict CSP can silently block the widget — it just never appears, no visible error. Allowlist <code>${x(ne())}</code> under all three directives. Copy-paste ready for your CSP header/meta tag:</p>
    <pre class="mag-csp-note__snippet"><code>script-src 'self' ${x(ne())};
connect-src 'self' ${x(ne())};
img-src 'self' ${x(ne())};</code></pre>
    <ul>
...
</details>`,mi={chat:"Chat bubble",right_slide:"Slide-in panel",modal:"Modal",inline:"Inline"},fm={chat:"chat",right_slide:"vertical_split",modal:"web_asset",inline:"view_agenda"},gi=[{value:"inline",icon:"view_agenda",label:"Inline"},{value:"chat",icon:"chat",label:"Chat"},{value:"right_slide",icon:"vertical_split",label:"Slide"},{value:"modal",icon:"web_asset",label:"Modal"}],hi=[{value:"auto",icon:"brightness_auto",label:"Auto"},{value:"light",icon:"light_mode",label:"Light"},{value:"dark",icon:"dark_mode",label:"Dark"}],fi=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],Kn={book:{label:"Book",icon:"event",kind:"book"},chat:{label:"Chat",icon:"chat",kind:"flow"},call:{label:"Call",icon:"phone",kind:"value",placeholder:"Phone number"},email:{label:"Email",icon:"mail",kind:"value",placeholder:"Email address"},support:{label:"Support",icon:"support_agent",kind:"support"}},vi=["book","chat","call","email","support"];let ga=null;async function vm(){if(ga)return ga;let e;try{const t=await fetch(`${ne()}/m5t/v5/integrations/calendly/event_types`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.event_types||[],scheduling_url:a.data.scheduling_url||""}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(ga=e),e}async function bm(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved Calendly event";e.innerHTML=`<option value="${x(t)}">${t?x(a):"Loading event types"}</option>`;const n=await vm();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${x(t)}" selected>${x(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect Calendly under Settings, Integrations first":"Could not load event types"}</option>`;return}const o=[];n.scheduling_url&&o.push({url:n.scheduling_url,label:"Full scheduling page (visitor picks the event)"}),n.list.forEach(s=>o.push({url:s.scheduling_url,label:s.duration?`${s.name} (${s.duration} min)`:s.name})),t&&!o.some(s=>s.url===t)&&o.unshift({url:t,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${x(s.url)}"${s.url===(t||o[0].url)?" selected":""}>${x(s.label)}</option>`).join(""):'<option value="">No active event types</option>'}let ha=null;async function _m(){if(ha)return ha;let e;try{const t=await fetch(`${ne()}/m5t/v5/integrations/callrail/trackers`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.trackers||[]}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(ha=e),e}async function ym(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved tracking number";e.innerHTML=`<option value="${x(t)}">${t?x(a):"Loading tracking numbers"}</option>`;const n=await _m();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${x(t)}" selected>${x(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect CallRail under Settings, Integrations first":"Could not load tracking numbers"}</option>`;return}const o=n.list.map(s=>({number:s.number,id:s.id,name:s.name,label:`${s.name} · ${s.number}${s.type==="session"?" (number pool)":""}`}));t&&!o.some(s=>s.number===t)&&o.unshift({number:t,id:e.dataset.savedId||"",name:a,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${x(s.number)}" data-tracker-id="${x(s.id)}" data-tracker-name="${x(s.name)}"${s.number===(t||o[0].number)?" selected":""}>${x(s.label)}</option>`).join(""):'<option value="">No active tracking numbers in this company</option>'}function is(e,t,a){return`<div class="mag-seg" role="radiogroup" aria-label="${x(e)}">${a.map(n=>`
    <label><input type="radio" name="${x(e)}" value="${x(n.value)}"${n.value===t?" checked":""}>
      <span><span class="material-symbols-outlined" aria-hidden="true">${x(n.icon)}</span>${x(n.label)}</span></label>`).join("")}</div>`}function wm(e,t){const a=Kn[e],n=!!t,o=n?"":" disabled";let s="";if(a.kind==="value"&&e==="call"){const i=t?.config?.source==="callrail",l=i&&t?.value||"",c=i?t?.config?.tracker_name||"Saved tracking number":"";s=`
      ...
      </select>`}else if(a.kind==="value")s=`<input class="mag-modal__input mag-cta__val" type="text" placeholder="${x(a.placeholder)}" value="${x(t?.value||"")}"${o}>`;else if(a.kind==="book"){const i=t?.config?.meeting_label||t?.value||"",l=t?.config?.source==="calendly",c=l&&t?.config?.calendly_url||"",u=l?t?.config?.event_name||"Saved Calendly event":"";s=`
      ...
      <select class="mag-modal__select mag-cta__calevent" data-saved="${x(c)}" data-saved-name="${x(u)}"${o}${l?"":" hidden"}>
        ${c?`<option value="${x(c)}" selected>${x(u)}</option>`:""}
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${a.kind}">
    ...
    ${r}
  </div>`}function xm(){if(rs)return;const e=document.createElement("style");e.id="m5t-magnets-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),rs=!0}function ka(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Em(e){const t=G.stats[e];if(!t||!t.opens&&!t.leads)return'<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>';const a=n=>Number(n||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function Jn(e){const t=G.owners.length>1||E.getMemberships().length>1,a=(e.domains||[]).filter(Boolean),n=G.canManage;return`
    <div class="mag-card" data-guid="${x(e.guid)}">
      ...
      <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${fm[e.display_mode]||"chat"}</span>${x(mi[e.display_mode]||"Chat bubble")}${e.ab?.enabled?'&nbsp;&nbsp;<span class="mag-ab-chip"><span class="material-symbols-outlined" aria-hidden="true">science</span>A/B</span>':""}${(e.notify_emails||[]).length?`&nbsp;&nbsp;<a class="mag-alert-chip" href="#/settings/notifications" title="Lead alerts to ${(e.notify_emails||[]).length} email${(e.notify_emails||[]).length===1?"":"s"}. Manage in Settings."><span class="material-symbols-outlined" aria-hidden="true">notifications_active</span>${(e.notify_emails||[]).length}</a>`:""}</span>
      ${Em(e.guid)}
      <div class="mag-domains">${a.length?a.map(o=>x(o)).join(", "):"<span>No domains set. Add yours to go live.</span>"}</div>
      <div class="mag-embed">
        <input type="text" readonly value="${x(pi(e.guid))}" aria-label="Embed snippet">
    ...
    </div>`}function km(){return oe()?Lt({section:"magnets",title:"Your Magnets",description:"Pick a client to view and manage their magnets."}):(xm(),`
    <div class="page-shell" data-section="magnets">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="mag-body">
          ${ka("hourglass_empty","Loading magnets…")}
        </div>
      </div>
    </div>`)}async function Am(){if(oe()){const a=mm();if(a){const o=document.querySelector(".page-shell .page-header-text .page-description");o&&(o.textContent=`Template picked: ${a.name}. Choose the client to build it for.`)}const n=o=>Number(o||0).toLocaleString();return _t(ne(),[{h:"Magnets",td:o=>`${n(o.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${n(o.magnets.total)}</span>`},{h:"Leads · wk",td:o=>n(o.leads.this_week)},{h:"Leads · total",td:o=>n(o.leads.total)}],{emptyMsg:"No client orgs yet. Create one under Clients, then provision its magnets here."})}ga=null,ha=null,document.getElementById("mag-new-btn")?.addEventListener("click",Tm),document.getElementById("mag-template-btn")?.addEventListener("click",$m),document.getElementById("mag-body")?.addEventListener("click",Lm),await ta();const t=um();t&&G.canProvision&&_i(t)}async function ta(){const e=document.getElementById("mag-body");if(!e)return;try{const[n,o]=await Promise.all([fetch(`${ne()}/m5t/v5/magnets`),fetch(`${ne()}/m5t/v5/magnets/stats`).catch(()=>null)]),s=await n.json().catch(()=>({}));if(!s.ok)throw new Error(s.message||"Failed to load");G.magnets=s.magnets||[],G.owners=s.owners||[],G.canProvision=!!s.canProvision,G.canManage=!!s.canManage,G.primaryOrgGuid=s.primaryOrgGuid||null;const r=o?await o.json().catch(()=>({})):{};G.stats=r?.stats||{}}catch{e.innerHTML=ka("error","Could not load your magnets. Please try again.");return}const t=document.getElementById("mag-new-btn");t&&(t.style.display=G.canProvision?"":"none");const a=document.getElementById("mag-template-btn");if(a&&(a.style.display=G.canProvision?"":"none"),!G.magnets.length){e.innerHTML=ka("widgets",G.canProvision?"No magnets yet. Click “New magnet” to create your first.":"No magnets yet.");return}e.innerHTML=`<div class="mag-grid">${G.magnets.map(Jn).join("")}</div>`}async function Sm(e){const t={"Content-Type":"application/json","Idempotency-Key":crypto.randomUUID()},a={status:"DRAFT"};e&&(a.owner_guid=e);const n=await fetch(`${ne()}/m5t/v5/magnets`,{method:"POST",headers:t,body:JSON.stringify(a)});let o={};try{o=await n.json()}catch{}if(!n.ok||!o.ok)throw new Error(o.message||`Could not start a new magnet (${n.status})`);return o.magnet}async function Cm(e,t){const a=await fetch(`${ne()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t.name,...t.appearance,steps:t.steps})});let n={};try{n=await a.json()}catch{}if(!a.ok||!n.ok)throw new Error(n.message||`Could not apply the ${t.name} template (${a.status})`)}async function Qn(e,t){const a=document.getElementById("mag-new-btn"),n=document.getElementById("mag-template-btn");a&&(a.disabled=!0),n&&(n.disabled=!0);let o=null;try{let s=await Sm(e);if(o=s.guid,t)await Cm(s.guid,t),await ta(),s=G.magnets.find(r=>r.guid===s.guid)||s;else{G.magnets=[s,...G.magnets];const r=document.getElementById("mag-body");r&&(r.innerHTML=`<div class="mag-grid">${G.magnets.map(Jn).join("")}</div>`)}Aa(s,void 0,{freshDraft:!0})}catch(s){o&&fetch(`${ne()}/m5t/v5/magnets/${encodeURIComponent(o)}`,{method:"DELETE"}).catch(()=>{}),je(s.message||"Could not start a new magnet","danger")}finally{a&&(a.disabled=!1),n&&(n.disabled=!1)}}function bi(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="Choose client" style="max-width:420px">
      ...
      <div class="mag-modal__body" style="padding:20px">
        ...
        <select class="mag-modal__select" id="mag-owner-pick">
          ${G.owners.map(o=>`<option value="${x(o.guid)}"${o.guid===G.primaryOrgGuid?" selected":""}>${x(o.name||o.guid)}</option>`).join("")}
        </select>
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(o){o.key==="Escape"&&(o.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.querySelector('[data-x="cancel"]').addEventListener("click",a),t.querySelector('[data-x="continue"]').addEventListener("click",()=>{const o=t.querySelector("#mag-owner-pick").value;a(),Qn(o,e)})}function Tm(){if(G.owners.length>1){bi();return}Qn(null)}function _i(e){if(G.owners.length>1){bi(e);return}Qn(null,e)}function $m(){gm(_i)}function Lm(e){const t=e.target.closest("[data-action]");if(!t)return;const a=t.dataset.guid,n=G.magnets.find(s=>s.guid===a),o=t.dataset.action;if(o==="copy")return Im(a);if(n){if(o==="preview")return Yn(()=>Ea(n));if(o==="funnel")return Rm(n);if(o==="edit")return Aa(n);if(o==="flow")return Aa(n,"flow");if(o==="toggle")return Nm(n);if(o==="delete")return Om(n)}}async function Im(e){try{await navigator.clipboard.writeText(pi(e)),je("Embed snippet copied","success")}catch{je("Copy failed","danger")}}function yi(e){const t=Number(e?.total_steps)||0,a={};if((Array.isArray(e?.funnel)?e.funnel:[]).forEach(s=>{a[s.position]=Number(s.reached)||0}),!t||!Object.keys(a).length)return'<p class="mag-modal__hint" style="margin:0">No step activity yet in this window. As visitors answer questions, drop-off by step will appear here.</p>';const n=Math.max(1,a[1]||0),o=[];for(let s=1;s<=t;s++){const r=a[s]||0,i=Math.min(100,Math.round(r/n*100));o.push(`
      ...
      </div>`)}return`<div class="mag-funnel">${o.join("")}</div>`}async function Rm(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal mag-funnel-modal" role="dialog" aria-modal="true" aria-label="Step funnel for ${x(e.name)}">
      ...
      <div class="mag-modal__body" style="padding:20px">
        ...
        <div id="mag-funnel-body">${ka("hourglass_empty","Loading…")}</div>
      </div>
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(s){s.key==="Escape"&&(s.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.addEventListener("click",s=>{s.target===t&&a()});const o=t.querySelector("#mag-funnel-body");try{const s=await fetch(`${ne()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/step-funnel`),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.message||`Failed (${s.status})`);o.innerHTML=yi(r)}catch{o.innerHTML='<p class="mag-modal__hint" style="margin:0">Could not load the funnel. Please try again.</p>'}}async function Nm(e){if(e.status==="DRAFT"){je("Open Edit and Save to publish a draft magnet.","info");return}const t=e.status==="ENABLED"?"DISABLED":"ENABLED";try{if(!(await(await fetch(`${ne()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw new Error;je(t==="ENABLED"?"Magnet enabled":"Magnet disabled","success")}catch{je("Update failed","danger");return}try{await ta()}catch(a){console.warn("[magnets] refresh after status toggle failed:",a)}}async function Om(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`)){try{if(!(await(await fetch(`${ne()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"})).json().catch(()=>({}))).ok)throw new Error;je("Magnet deleted","success")}catch{je("Delete failed","danger");return}try{await ta()}catch(t){console.warn("[magnets] refresh after delete failed:",t)}}}function nn(e){const t=[];return e.querySelectorAll(".mag-cta").forEach(a=>{if(!a.querySelector(".mag-cta__on").checked)return;const n=a.dataset.type,o=a.dataset.kind,s=a.querySelector(".mag-cta__val"),r=s?s.value.trim():"";if(o==="value")if(n==="call"&&a.querySelector(".mag-cta__callsrc")?.value==="callrail"){const i=a.querySelector(".mag-cta__crtracker"),l=i?.value||"",c=i?.selectedOptions?.[0];l&&t.push({type:n,value:l,config:{source:"callrail",...c?.dataset?.trackerId?{tracker_id:c.dataset.trackerId}:{},...c?.dataset?.trackerName?{tracker_name:c.dataset.trackerName}:{}}})}else r&&t.push({type:n,value:r});else if(o==="book")if(a.querySelector(".mag-cta__booksrc")?.value==="calendly"){const i=a.querySelector(".mag-cta__calevent"),l=i?.value||"",c=(i?.selectedOptions?.[0]?.textContent||"").trim();t.push({type:n,config:{source:"calendly",...l?{calendly_url:l}:{},...l&&c?{event_name:c}:{}}})}else{const i={type:n};r&&(/^https?:\/\//i.test(r)?i.value=r:i.config={meeting_label:r}),t.push(i)}else if(o==="support"){const i=(a.querySelector(".mag-cta__opts")?.value||"").split(`
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:wi(e),actions:t,font:e.querySelector("#mag-f-font").value.trim(),theme_vars:qm(e),inline_width:e.querySelector("#mag-f-inline-w").value.trim(),inline_height:e.querySelector("#mag-f-inline-h").value.trim(),hide_launcher:e.querySelector("#mag-f-hide-launcher").checked,input_placeholder:e.querySelector("#mag-f-input-ph").value,summary_confirm_label:e.querySelector("#mag-f-summary-confirm").value.trim(),success_title:e.querySelector("#mag-f-success-title").value.trim(),success_text:e.querySelector("#mag-f-success-text").value,success_cta:Um(e)}}const Mm=512,Pm=new Set(["image/png","image/jpeg","image/gif","image/webp"]),Fm=8*1024*1024;function Dm(e){return new Promise((t,a)=>{const n=new Image,o=new FileReader;o.onerror=()=>a(new Error("Could not read that file.")),o.onload=()=>{n.onerror=()=>a(new Error("That file isn’t a readable image.")),n.onload=()=>{const s=Math.min(1,Mm/Math.max(n.naturalWidth,n.naturalHeight)),r=Math.max(1,Math.round(n.naturalWidth*s)),i=Math.max(1,Math.round(n.naturalHeight*s)),l=document.createElement("canvas");l.width=r,l.height=i,l.getContext("2d").drawImage(n,0,0,r,i),t(l.toDataURL("image/png"))},n.src=o.result},o.readAsDataURL(e)})}function Bm(e,t){const a=e.querySelector("#mag-logo-drop");if(!a)return;const n=e.querySelector("#mag-f-logo-file"),o=e.querySelector("#mag-logo-browse"),s=e.querySelector("#mag-logo-remove"),r=e.querySelector("#mag-logo-preview"),i=e.querySelector("#mag-logo-status"),l=e.querySelector("#mag-f-logo"),c=(d,f)=>{i.textContent=d,i.style.color=f?"var(--color-danger, #DD4124)":""},u=d=>{r.innerHTML=d?`<img src="${x(d)}" alt="">`:'<span class="material-symbols-outlined" aria-hidden="true">image</span>',s.hidden=!d},v=d=>{l.value=d,l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))};async function h(d){if(!Pm.has(d.type)){c("PNG, JPEG, GIF, or WEBP only.",!0);return}if(d.size>Fm){c("That file is too large (8MB max before resizing).",!0);return}c("Uploading…",!1);try{const f=await Dm(d),p=await fetch(`${ne()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({image:f})}),b=await p.json().catch(()=>({}));if(!p.ok||!b.ok)throw new Error(b.error||`Upload failed (${p.status})`);const y=`${ne()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;v(y),u(y),c("Logo updated.",!1)}catch(f){c(f.message||"Upload failed.",!0)}}n.addEventListener("change",()=>{n.files[0]&&h(n.files[0]),n.value=""}),a.addEventListener("click",d=>{d.target===s||s.contains(d.target)||d.target!==o&&n.click()}),o.addEventListener("click",()=>n.click()),["dragenter","dragover"].forEach(d=>a.addEventListener(d,f=>{f.preventDefault(),a.classList.add("is-dragover")})),["dragleave","drop"].forEach(d=>a.addEventListener(d,f=>{f.preventDefault(),a.classList.remove("is-dragover")})),a.addEventListener("drop",d=>{const f=d.dataTransfer?.files?.[0];f&&h(f)}),s.addEventListener("click",async d=>{d.stopPropagation(),c("Removing…",!1);try{const f=await fetch(`${ne()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"DELETE"}),p=await f.json().catch(()=>({}));if(!f.ok||!p.ok)throw new Error(p.error||`Remove failed (${f.status})`);v(""),u(""),c("Logo removed.",!1)}catch(f){c(f.message||"Remove failed.",!0)}})}function qm(e){return e.querySelector("#mag-f-surface-on")?.checked?{surface:e.querySelector("#mag-f-sv-surface").value,surface_2:e.querySelector("#mag-f-sv-surface2").value,border:e.querySelector("#mag-f-sv-border").value,text:e.querySelector("#mag-f-sv-text").value,text_sub:e.querySelector("#mag-f-sv-textsub").value}:{}}function Um(e){const t=e.querySelector("#mag-f-success-cta-label").value.trim(),a=e.querySelector("#mag-f-success-cta-url").value.trim();return t&&a?{label:t,url:a}:{}}function wi(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",s=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==s.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}const kn=[{label:"Web fonts (loaded for you)",opts:[["Inter, sans-serif","Inter"],["Poppins, sans-serif","Poppins"],["Montserrat, sans-serif","Montserrat"],["Roboto, sans-serif","Roboto"],['"Open Sans", sans-serif',"Open Sans"],["Lato, sans-serif","Lato"],["Nunito, sans-serif","Nunito"],["Raleway, sans-serif","Raleway"],['"Work Sans", sans-serif',"Work Sans"],["Oswald, sans-serif","Oswald"],["Merriweather, serif","Merriweather (serif)"]]},{label:"System / always available",opts:[["system-ui, sans-serif","System UI"],["Georgia, serif","Georgia (serif)"],['"Times New Roman", Times, serif',"Times (serif)"],["Arial, Helvetica, sans-serif","Arial / Helvetica"],["Verdana, Geneva, sans-serif","Verdana"],['"Courier New", monospace',"Courier (mono)"]]}];function zm(e){const t=String(e||""),a=new Set(kn.flatMap(s=>s.opts.map(([r])=>r))),n=s=>s===t?" selected":"";let o=`<option value=""${t===""?" selected":""}>System default</option>`;t&&!a.has(t)&&(o+=`<option value="${x(t)}" selected>Current: ${x(t)}</option>`);for(const s of kn)o+=`<optgroup label="${x(s.label)}">`+s.opts.map(([r,i])=>`<option value="${x(r)}"${n(r)}>${x(i)}</option>`).join("")+"</optgroup>";return o}function Aa(e,t,a={}){const{freshDraft:n=!1}=a,o=!!e,s=o?null:crypto.randomUUID(),r=!o&&G.owners.length>1,i=e?.display_mode||"chat",l=e?.theme_mode||"auto",c={};(e?.actions||[]).forEach(C=>{C&&C.type&&(c[C.type]=C)});const u=o?!!e.home:!0,v=o?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",h=e?.theme_vars&&typeof e.theme_vars=="object"?e.theme_vars:{},d=Object.keys(h).length>0,f=(C,H)=>x(/^#[0-9a-fA-F]{6}$/.test(h[C]||"")?h[C]:H),p=document.createElement("div");p.className="mag-modal-scrim",p.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${o?"Edit magnet":"New magnet"}">
      ...
      <div class="mag-modal__main">
        ...
        <select class="mag-modal__select" id="mag-f-owner">
          ${G.owners.map(C=>`<option value="${x(C.guid)}"${C.guid===G.primaryOrgGuid?" selected":""}>${x(C.name||C.guid)}</option>`).join("")}
        </select>`:""}
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${fi.map(C=>`<option value="${C.value}"${(e?e.trigger||"none":"on_load")===C.value?" selected":""}>${x(C.label)}</option>`).join("")}
        </select>
        ...
        <div class="mag-modal__sec">
          ...
          <select class="mag-modal__select" id="mag-f-font">${zm(e?.font||"")}</select>
    ...
    </div>`,document.body.appendChild(p),requestAnimationFrame(()=>{p.classList.add("open"),p.querySelector(".mag-modal").classList.add("open")});const b=[...p.querySelectorAll(".mag-modal__navitem")],y=[...p.querySelectorAll(".mag-tab")],w=C=>{b.forEach(H=>H.classList.toggle("is-active",H.dataset.tab===C)),y.forEach(H=>{H.hidden=H.dataset.tab!==C}),p.querySelector(".mag-modal__body").scrollTop=0};b.forEach(C=>C.addEventListener("click",()=>w(C.dataset.tab)));const A=()=>Ea({...e,...nn(p),...o?{steps:as()}:{}}),R=p.querySelector("#mag-preview-pane"),z=()=>window.matchMedia("(min-width: 1200px)").matches;let Q=null;const ge=()=>{if(!Q&&z())try{Q=rm(R,A)}catch{}};let $e=null;const he=()=>{z()&&(ge(),Q&&(clearTimeout($e),$e=setTimeout(()=>{try{Q.refresh()}catch{}},300)))},Ve=window.matchMedia("(min-width: 1200px)"),Be=()=>{z()&&(ge(),he())};Ve.addEventListener("change",Be);let D=!1,ae=!1;const q=p.querySelector("#mag-f-dirty"),Y=C=>{D=C,q&&(q.hidden=!C)},et=p.querySelector(".mag-modal__main");et.addEventListener("input",()=>Y(!0)),et.addEventListener("change",()=>{Y(!0),he()}),p.querySelector("#mag-f-color")?.addEventListener("input",()=>{Y(!0),he()});const tt=C=>{D&&(C.preventDefault(),C.returnValue="")};window.addEventListener("beforeunload",tt);let Nt=!0;const za=m.subscribe(g.ROUTE_NAV_BEFORE,()=>{if(Nt){if(D&&!confirm("Discard your changes to this magnet?")){window.router?.navigate("/magnets");return}_()}}),_=()=>{if(n&&!ae&&e&&e.status==="DRAFT"){fetch(`${ne()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"}).catch(()=>{}),G.magnets=G.magnets.filter(H=>H.guid!==e.guid);const C=document.getElementById("mag-body");C&&(C.innerHTML=`<div class="mag-grid">${G.magnets.map(Jn).join("")}</div>`)}Nt=!1,window.removeEventListener("beforeunload",tt),m.unsubscribe(za),clearTimeout($e),Ve.removeEventListener("change",Be),Q&&Q.destroy&&Q.destroy(),p.classList.remove("open"),setTimeout(()=>p.remove(),180),document.removeEventListener("keydown",N)},S=()=>{D&&!confirm("Discard your changes to this magnet?")||_()};function N(C){C.key==="Escape"&&(C.preventDefault(),S())}document.addEventListener("keydown",N),p.querySelector(".mag-modal__close").addEventListener("click",S),p.querySelector('[data-x="cancel"]').addEventListener("click",S),p.querySelector("[data-close-modal]")?.addEventListener("click",S),p.querySelector("#mag-f-name").focus();const V=p.querySelector("#mag-flow-panel");o?Zu(V,e,()=>{Y(!0),he()}):V.innerHTML='<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>',Bm(p,e),t&&w(t),ge(),p.querySelectorAll(".mag-cta").forEach(C=>{const H=C.querySelector(".mag-cta__on"),pe=C.querySelector(".mag-cta__val"),se=C.querySelector(".mag-cta__opts"),qe=C.querySelectorAll(".mag-cta__booksrc, .mag-cta__calevent, .mag-cta__callsrc, .mag-cta__crtracker");H.addEventListener("change",()=>{pe&&(pe.disabled=!H.checked),se&&(se.disabled=!H.checked),qe.forEach(K=>{K.disabled=!H.checked}),H.checked&&(pe||se)?.focus()}),pe&&pe.addEventListener("input",()=>{pe.value.trim()&&!H.checked&&(H.checked=!0,se&&(se.disabled=!1))})}),p.querySelectorAll('.mag-cta[data-kind="book"]').forEach(C=>{const H=C.querySelector(".mag-cta__booksrc"),pe=C.querySelector(".mag-cta__val"),se=C.querySelector(".mag-cta__calevent");if(!H||!se)return;const qe=()=>{const K=H.value==="calendly";pe.hidden=K,se.hidden=!K,K&&!se.dataset.listed&&(se.dataset.listed="1",bm(se))};H.addEventListener("change",()=>{const K=C.querySelector(".mag-cta__on");K.checked||(K.checked=!0,K.dispatchEvent(new Event("change"))),qe()}),qe()}),p.querySelectorAll('.mag-cta[data-type="call"]').forEach(C=>{const H=C.querySelector(".mag-cta__callsrc"),pe=C.querySelector(".mag-cta__val"),se=C.querySelector(".mag-cta__crtracker");if(!H||!se)return;const qe=()=>{const K=H.value==="callrail";pe.hidden=K,se.hidden=!K,K&&!se.dataset.listed&&(se.dataset.listed="1",ym(se))};H.addEventListener("change",()=>{const K=C.querySelector(".mag-cta__on");K.checked||(K.checked=!0,K.dispatchEvent(new Event("change"))),qe()}),qe()});const B=p.querySelector("#mag-f-surface-on"),ke=p.querySelector("#mag-f-surface");B.addEventListener("change",()=>ke.hidden=!B.checked);const at=p.querySelector("#mag-f-inline-size");p.querySelectorAll('input[name="mag-display"]').forEach(C=>C.addEventListener("change",()=>{at.hidden=p.querySelector('input[name="mag-display"]:checked')?.value!=="inline"})),p.querySelector('[data-x="preview"]')?.addEventListener("click",()=>Yn(()=>Ea({...e,...nn(p),...o?{steps:as()}:{}}))),p.querySelector('[data-x="save"]').addEventListener("click",async C=>{const H=C.currentTarget,pe=p.querySelector("#mag-f-error"),se=p.querySelector("#mag-f-name").value.trim();if(!se){w("basics"),pe.textContent="Please give your magnet a name.";return}const qe=p.querySelector("#mag-f-domains").value.split(",").map(X=>X.trim()).filter(Boolean);let K="";if(p.querySelectorAll(".mag-cta").forEach(X=>{const wt=X.querySelector(".mag-cta__on").checked;if(X.dataset.kind==="book"){const Mt=X.querySelector(".mag-cta__booksrc")?.value==="calendly";wt&&Mt&&!X.querySelector(".mag-cta__calevent")?.value&&(K=K||"Pick a Calendly event for the Book button, or switch it back to the built-in scheduler.");return}if(X.dataset.kind!=="value")return;if(X.dataset.type==="call"&&X.querySelector(".mag-cta__callsrc")?.value==="callrail"){wt&&!X.querySelector(".mag-cta__crtracker")?.value&&(K=K||"Pick a CallRail tracking number for the Call button, or switch it back to a phone number.");return}const Ot=X.querySelector(".mag-cta__val").value.trim();wt&&!Ot&&(K=K||`Add a target for the ${Kn[X.dataset.type].label} button, or uncheck it.`)}),K){w("welcome"),pe.textContent=K;return}const to=wi(p);if(to.enabled&&!Object.keys(to.b).length){w("ab"),pe.textContent="Give variant B at least one change (title, welcome, or color), or untick the A/B test.";return}if(o){const X=tm();if(X){w("flow"),pe.textContent=X.message,am(X.route,X.message,{uid:X.uid,field:X.field});return}}const Ha={name:se,domains:qe,...nn(p)};r&&(Ha.owner_guid=p.querySelector("#mag-f-owner").value);const ao=o&&e.status==="DRAFT";ao&&(Ha.status="ENABLED"),H.disabled=!0,pe.textContent="";try{const X=o?`${ne()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${ne()}/m5t/v5/magnets`,wt={"Content-Type":"application/json"};s&&(wt["Idempotency-Key"]=s);const Ot=await fetch(X,{method:o?"PATCH":"POST",headers:wt,body:JSON.stringify(Ha)});let Mt={};try{Mt=await Ot.json()}catch{}if(!Ot.ok||!Mt.ok)throw new Error(Mt.message||`Save failed (${Ot.status})`);o&&await om(e.guid),je(ao||!o?"Magnet created":"Magnet updated","success"),ae=!0,_(),await ta()}catch(X){H.disabled=!1,pe.textContent=X.message||"Something went wrong."}})}const Hm=Object.freeze(Object.defineProperty({__proto__:null,CTA_META:Kn,CTA_ORDER:vi,DISPLAY_OPTS:gi,FONT_GROUPS:kn,MODE_LABEL:mi,THEME_OPTS:hi,TRIGGER_OPTS:fi,cspNoteHTML:ui,init:Am,openModal:Aa,render:km,stepFunnelHTML:yi},Symbol.toStringTag,{value:"Module"})),Gm={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ls=e=>String(e??"").replace(/[&<>"']/g,t=>Gm[t]),jm=["provision_magnets","manage_magnets"],Vm=()=>E.getCapabilities().some(e=>jm.includes(e));function Wm(){const e=new Map;for(const t of Ze)e.set(t.category,(e.get(t.category)||0)+1);return Object.keys(ii).filter(t=>e.has(t)).map(t=>[t,e.get(t)])}const cs=(e,t,a,n)=>`<button class="m5t-chip--filter" type="button" data-cat="${ls(e)}" aria-pressed="${n}">${ls(t)}<span class="m5t-chip__count">${a}</span></button>`;let ds=!1;function Ym(){if(di(),ds)return;const e=document.createElement("style");e.id="m5t-templates-page-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ds=!0}function xi(){Ym();const e=Vm();return`
    <div class="page-shell" data-section="templates">
      ...
      <div class="m5t-chip-row tpl-filters" id="tpl-filters" role="group" aria-label="Filter templates by category">
        ${cs("all","All",Ze.length,"true")}
        ${Wm().map(([t,a])=>cs(t,ii[t],a,"false")).join("")}
      </div>

      <div class="mag-tpl-grid mag-tpl-grid--page" id="tpl-grid">
        ${Ze.map(t=>li(t,{detail:!0,gallery:!0,canUse:e})).join("")}
      </div>
    </div>`}function Ei(){const e=document.getElementById("tpl-grid");document.getElementById("tpl-filters")?.addEventListener("click",t=>{const a=t.target.closest("[data-cat]");if(!a)return;a.parentElement.querySelectorAll("[data-cat]").forEach(o=>{o.setAttribute("aria-pressed",String(o===a))});const n=a.dataset.cat;e?.querySelectorAll(".mag-tpl-card").forEach(o=>{o.hidden=!(n==="all"||o.dataset.cat===n)})}),e?.addEventListener("click",t=>{const a=t.target.closest("[data-preview]");if(a){const o=Ze.find(s=>s.id===a.dataset.preview);o&&Yn(()=>Ea({...o.appearance,steps:o.steps,name:o.name}));return}const n=t.target.closest("[data-tpl]");n&&(pm(n.dataset.tpl),window.location.hash="#/magnets")})}const Km={render:xi,init:Ei},Jm=Object.freeze(Object.defineProperty({__proto__:null,default:Km,init:Ei,render:xi},Symbol.toStringTag,{value:"Module"})),Qm={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Fe=e=>String(e??"").replace(/[&<>"']/g,t=>Qm[t]);function Xn(e){if(!e)return"";try{return new Date(e).toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}catch{return String(e)}}function Xm(e,t={}){const a=t[e.id];if(e.type==="checkbox_group"){const n=Array.isArray(a)?a:[];return n.length?Fe(n.join(", ")):""}return a?Fe(a):""}function ki(e,{emptyLabel:t="(blank)",renderAnswer:a=null}={}){const n=e?.questionnaire?.sections||[],o=e?.answers||{};return n.length?n.map(s=>`
    <div class="qm-section">
      <h3>${Fe(s.title)}</h3>
      ${(s.questions||[]).map(r=>`
        <div class="qm-qa" data-question-id="${Fe(r.id)}" data-question-type="${Fe(r.type)}">
          <div class="qm-qa__q">${Fe(r.label)}</div>
          <div class="qm-qa__a">${a?a(r,o):Xm(r,o)||`<span class="qm-qa__a--empty">${Fe(t)}</span>`}</div>
        </div>`).join("")}
    </div>`).join(""):'<p class="qm-qa__a qm-qa__a--empty">This questionnaire has no questions.</p>'}function Ai(e){const t=e?.recipient_email?`<p class="qm-recipient">Sent to ${Fe(e.recipient_email)}</p>`:"",a=e?.last_edited_tz?`<p class="qm-edited-marker">Last edited by ${Fe(e.last_edited_by_email||"a team member")} on ${Fe(Xn(e.last_edited_tz))}</p>`:"";return t+a}let ps=!1;function Si(){if(ps)return;const e=document.createElement("style");e.id="m5t-questionnaire-answer-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ps=!0}const Zm={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Le=e=>String(e??"").replace(/[&<>"']/g,t=>Zm[t]),An=()=>E.getConfig?.().BASE_URL||"",us=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},eg="managed_client",Sn=[["ALL","All"],["NOT_SENT","Not sent"],["DRAFT","Awaiting response"],["SUBMITTED","Submitted"],["CANCELLED","Cancelled"]],Ci=Object.fromEntries(Sn),de={clients:[],responses:[],filter:"ALL",search:"",openGuid:null};let ms=!1;function tg(){if(Si(),ms)return;const e=document.createElement("style");e.id="m5t-questionnaires-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ms=!0}const Qt=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Zn(){return de.clients.map(e=>{const t=de.responses.filter(n=>n.owner_guid===e.guid),a=t[0]||null;return{guid:e.guid,name:e.caption||e.name||e.guid,latest:a,earlier:Math.max(0,t.length-1),status:a?a.status:"NOT_SENT"}})}function Ti(){const e=de.search.trim().toLowerCase();return Zn().filter(t=>(de.filter==="ALL"||t.status===de.filter)&&(!e||t.name.toLowerCase().includes(e)))}const gs=(e,t)=>e?.latest?.[t]?Xn(e.latest[t]):"—";function $i(e){const t=e.status==="SUBMITTED",a=e.status==="SUBMITTED"?`<button class="qz-act" type="button" data-act="open" data-guid="${Le(e.latest.guid)}">Read answers</button>`:e.status==="DRAFT"?`<button class="qz-act" type="button" data-act="copy" data-url="${Le(e.latest.url||"")}">Copy link</button>`:'<a class="qz-act" href="#/clients">Go to client</a>';return`<tr class="${t?"qz-row--open":""}"${t?` data-open-guid="${Le(e.latest.guid)}"`:""}>
    <td><span class="qz-client">${Le(e.name)}</span>${e.earlier?`<span class="qz-earlier">${e.earlier} earlier</span>`:""}</td>
    <td><span class="qz-badge" data-s="${Le(e.status)}">${Le(Ci[e.status]||e.status)}</span></td>
    <td class="qz-when">${Le(gs(e,"created_tz"))}</td>
    <td class="qz-when">${Le(gs(e,"submitted_tz"))}</td>
    <td class="qz-actcell">${a}</td>
  </tr>`}function Li(){return tg(),`
    <div class="page-shell" data-section="questionnaires">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="qz-body">${Qt("hourglass_empty","Loading…")}</div>
      </div>
    </div>`}async function Ii(){await ag()}async function ag(){const e=document.getElementById("qz-body");if(e){try{const[t,a]=await Promise.all([fetch(`${An()}/m5t/v5/acctGroup`),fetch(`${An()}/m5t/v5/m5mQuestionnaireResponse`)]),n=await t.json().catch(()=>({})),o=await a.json().catch(()=>({}));if(!t.ok||!a.ok)throw new Error("load failed");de.clients=(n.data||[]).filter(s=>s.class===eg&&!["DELETED","ARCHIVED"].includes(s.status)).sort((s,r)=>String(s.caption||"").localeCompare(String(r.caption||""))),de.responses=o.data||[]}catch{e.innerHTML=Qt("error","Could not load questionnaires. Please try again.");return}Ri()}}function Ri(){const e=document.getElementById("qz-body");if(!e)return;if(!de.clients.length){e.innerHTML=Qt("groups","No clients yet. Add a client first, then send them a kickoff questionnaire.");return}const t=Zn(),a={ALL:t.length};Sn.slice(1).forEach(([o])=>{a[o]=t.filter(s=>s.status===o).length});const n=Ti();e.innerHTML=`
    <div class="qz-bar">
      <div class="qz-filter">
        ${Sn.map(([o,s])=>`<button data-filter="${o}" class="${de.filter===o?"active":""}">${Le(s)}${a[o]?`<span class="qz-pillnum">${a[o]}</span>`:""}</button>`).join("")}
      </div>
    ...
    <div class="qz-tablewrap">
      <table class="qz-table">
        ...
        <tbody id="qz-tbody">${n.length?n.map($i).join(""):`<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">${de.search.trim()?"No clients match your search.":`No clients with status “${Le(Ci[de.filter]||de.filter)}”.`}</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".qz-filter")?.addEventListener("click",o=>{const s=o.target.closest("[data-filter]");s&&(de.filter=s.dataset.filter,Ri())}),e.querySelector("#qz-search")?.addEventListener("input",o=>{de.search=o.target.value,ng()}),e.querySelector("#qz-tbody")?.addEventListener("click",og)}function ng(){const e=document.getElementById("qz-tbody");if(!e)return;const t=Ti();e.innerHTML=t.length?t.map($i).join(""):'<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">No clients match your search.</div></td></tr>';const a=document.querySelector(".qz-count");a&&(a.textContent=`${t.length} of ${Zn().length}`)}function og(e){const t=e.target.closest('[data-act="copy"]');if(t){e.stopPropagation();const s=t.dataset.url;if(!s){us("No link on this questionnaire yet.","warning");return}navigator.clipboard?.writeText(s).then(()=>{t.textContent="Copied!",setTimeout(()=>{t.textContent="Copy link"},1500)},()=>us("Could not copy the link.","error"));return}const a=e.target.closest('[data-act="open"]'),n=e.target.closest("[data-open-guid]"),o=a?.dataset.guid||n?.dataset.openGuid;o&&sg(o)}async function sg(e){de.openGuid=e;const t=document.createElement("div");t.className="qz-drawer-scrim";const a=document.createElement("aside");a.className="qz-drawer",a.setAttribute("role","dialog"),a.setAttribute("aria-label","Questionnaire answers"),a.innerHTML=`
    ...
    <div class="qz-drawer__body" id="qz-dbody">${Qt("hourglass_empty","Loading answers…")}</div>`,document.body.append(t,a),requestAnimationFrame(()=>{t.classList.add("open"),a.classList.add("open")});const n=()=>{de.openGuid=null,t.classList.remove("open"),a.classList.remove("open"),setTimeout(()=>{t.remove(),a.remove()},220),document.removeEventListener("keydown",o)};function o(s){s.key==="Escape"&&(s.preventDefault(),n())}document.addEventListener("keydown",o),t.addEventListener("click",n),a.querySelector(".qz-drawer__close").addEventListener("click",n);try{const s=await fetch(`${An()}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e)}`),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.error||"load failed");const i=r.data||{},l=de.clients.find(c=>c.guid===i.owner_guid)?.caption||"Client";a.querySelector("#qz-dtitle").textContent=l,a.querySelector("#qz-dsub").textContent=i.submitted_tz?`Submitted ${Xn(i.submitted_tz)}`:"Not yet submitted",a.querySelector("#qz-dbody").innerHTML=Ai(i)+ki(i,{emptyLabel:"Not answered"})}catch{a.querySelector("#qz-dbody").innerHTML=Qt("error","Could not load these answers. Please try again.")}}const rg={render:Li,init:Ii},ig=Object.freeze(Object.defineProperty({__proto__:null,default:rg,init:Ii,render:Li},Symbol.toStringTag,{value:"Module"}));let hs=!1;const k={leads:[],magnetNames:{},filter:"ALL",canManage:!1,book:!1,ownerNames:{},clientFilter:"ALL",search:"",shown:100,selectedId:null,day:""},ct=100,Cn=["NEW","WORKING","QUALIFIED","UNQUALIFIED","CONVERTED","EXPORTED"],lg={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},O=e=>String(e??"").replace(/[&<>"']/g,t=>lg[t]),Sa=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},Ca=()=>E.getConfig?.().BASE_URL||"",Ta=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",Ni=e=>(Ta(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase(),Ua=e=>e.created?.created_tz||"";function St(e){const t=Ua(e);if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric"})}catch{return""}}function cg(e){const t=Ua(e);if(!t)return"";try{const a=Date.now()-new Date(t).getTime();if(a<0)return St(e);const n=a/36e5;return n<1?`${Math.max(1,Math.floor(a/6e4))}m ago`:n<24?`${Math.floor(n)}h ago`:n<48?"Yesterday":St(e)}catch{return St(e)}}const dg=e=>{const t=Ua(e);if(!t)return!1;try{return Date.now()-new Date(t).getTime()<24*36e5}catch{return!1}};function pg(){if(hs)return;const e=document.createElement("style");e.id="m5t-leads-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),hs=!0}function Xt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function ug(e){return`<select class="leads-status" data-id="${O(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${Cn.map(t=>`<option value="${t}" ${e.status===t?"selected":""}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join("")}
  </select>`}function mg(e){const t=k.magnetNames[e.magnet_guid]||e.lead_source||"—",a=e.phone?String(e.phone).replace(/[^\d+]/g,""):"";return`
    <tr class="leads-row${String(e.id)===k.selectedId?" selected":""}" data-id="${O(e.id)}" tabindex="0" role="button" aria-label="Open lead ${O(Ta(e))}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${O(Ni(e))}</span>
          <span><span class="leads-name">${O(Ta(e))}</span>${e.company?`<span class="leads-sub">${O(e.company)}</span>`:""}</span>
        </span>
      </td>
      ${k.book?`<td>${rr(k.ownerNames[e.owner_guid]||"")||'<span class="leads-muted">—</span>'}</td>`:""}
      <td>
        ${e.email?`<a class="leads-contactlink" href="mailto:${O(e.email)}" title="Email ${O(e.email)}">${O(e.email)}</a>`:'<span class="leads-muted">—</span>'}
        ${e.phone?`<a class="leads-contactlink leads-sub" href="tel:${O(a)}" title="Call ${O(e.phone)}">${O(e.phone)}</a>`:""}
      </td>
      <td>${e.product_interest?O(e.product_interest):'<span class="leads-muted">—</span>'}</td>
      <td><span class="leads-sub">${O(t)}</span>${e.utm_campaign||e.utm_source?`<span class="leads-sub" title="Campaign / source">${O(e.utm_campaign||e.utm_source)}${e.gclid?' <span class="leads-badge" data-s="QUALIFIED" style="font-size:0.58rem;padding:1px 6px">Ads</span>':""}</span>`:""}</td>
      <td>${k.canManage?ug(e):`<span class="leads-badge" data-s="${O(e.status)}">${O(e.status)}</span>`}</td>
      <td class="num leads-muted" style="white-space:nowrap" title="${O(St(e))}">${dg(e)?'<span class="leads-fresh" title="Captured in the last 24 hours"></span>':""}${O(cg(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}const Oi=e=>k.clientFilter==="ALL"||e.owner_guid===k.clientFilter;function gg(e){const t=k.search.trim().toLowerCase();if(!t)return!0;const a=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,k.magnetNames[e.magnet_guid],k.book?k.ownerNames[e.owner_guid]:"",e.utm_campaign,e.utm_source].filter(Boolean).join(" ").toLowerCase();return t.split(/\s+/).every(n=>a.includes(n))}const hg=e=>!k.day||Ua(e).slice(0,10)===k.day;function Mi(){return k.leads.filter(e=>(k.filter==="ALL"||e.status===k.filter)&&Oi(e)&&gg(e)&&hg(e))}function fg(){if(!k.day)return"";let e=k.day;try{e=new Date(`${k.day}T00:00:00Z`).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric",timeZone:"UTC"})}catch{}return`<button class="leads-daychip" type="button" id="leads-dayclear" title="Show every day again">
    <span class="material-symbols-outlined" aria-hidden="true">event</span>${O(e)}
    <span class="material-symbols-outlined leads-daychip__x" aria-hidden="true">close</span>
  </button>`}const Pi=()=>Xt("touch_app","Click to see lead information.");function vg(){pg(),bt();const e=oe();return`
    <div class="page-shell" data-section="leads">
      ...
      <div class="dashboard-card" style="margin-bottom:24px">
        ...
        <div class="card-body" id="pf-picker-body">${Xt("hourglass_empty","Loading…")}</div>
      </div>`:""}
      <div class="page-header">
        <div class="page-header-text">
      ...
      <div class="leads-layout">
        <div class="dashboard-card">
          <div class="card-body" id="leads-body">
            ${Xt("hourglass_empty","Loading leads…")}
          </div>
        </div>
        <aside class="dashboard-card leads-panel" aria-label="Lead detail">
          <div class="card-body" id="leads-panel-body">${Pi()}</div>
        </aside>
      </div>
    </div>`}async function bg(){document.getElementById("leads-export")?.addEventListener("click",xg);const e=mn(ht.LEADS_SEARCH),t=mn(ht.LEADS_DAY);if((e||t)&&(k.search=e||"",k.day=t||"",k.filter="ALL",k.clientFilter="ALL",k.shown=ct),oe()){const a=n=>Number(n||0).toLocaleString();_t(Ca(),[{h:"Leads · wk",td:n=>a(n.leads.this_week)},{h:"Leads · total",td:n=>a(n.leads.total)},{h:"Compl.",td:n=>n.completion_rate!=null?`${n.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await _g()}async function _g(){const e=document.getElementById("leads-body");if(e){try{const[t,a]=await Promise.all([fetch(`${Ca()}/m5t/v5/m5mLead`),fetch(`${Ca()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(k.leads=(n.data||[]).filter(o=>!["DELETED","ARCHIVED"].includes(o.status)),k.book=oe(),k.ownerNames=k.book?sr():{},a){const o=await a.json().catch(()=>({}));k.magnetNames={},(o.magnets||[]).forEach(s=>{k.magnetNames[s.guid]=s.name,s.owner_guid&&s.owner_name&&!k.ownerNames[s.owner_guid]&&(k.ownerNames[s.owner_guid]=s.owner_name)}),k.canManage=!!o.canManage}}catch{e.innerHTML=Xt("error","Could not load your leads. Please try again.");return}Gt()}}const yg=()=>`
  <colgroup>
    <col style="width:22%">
  ...
  </colgroup>`;function Gt(){const e=document.getElementById("leads-body"),t=document.getElementById("leads-export");if(!e)return;if(t&&(t.style.display=k.leads.length?"":"none"),!k.leads.length){e.innerHTML=Xt("inbox","No leads captured yet. Publish a magnet and share it to start collecting.");return}const a=k.leads.filter(Oi),n={ALL:a.length};Cn.forEach(s=>{n[s]=a.filter(r=>r.status===s).length});const o=k.book?[...new Set(k.leads.map(s=>s.owner_guid).filter(Boolean))].map(s=>({guid:s,name:k.ownerNames[s]||s})).sort((s,r)=>s.name.localeCompare(r.name)):[];e.innerHTML=`
    <div class="leads-bar">
      <div class="leads-filter">
        ${["ALL",...Cn].map(s=>`<button data-filter="${s}" class="${k.filter===s?"active":""}">${s==="ALL"?"All":s[0]+s.slice(1).toLowerCase()}${n[s]?`<span class="leads-pillnum">${n[s]}</span>`:""}</button>`).join("")}
      </div>
      ${k.book&&o.length>1?`
      <select class="leads-clientsel" id="leads-clientsel" aria-label="Filter by client">
        <option value="ALL">All clients</option>
        ${o.map(s=>`<option value="${O(s.guid)}" ${k.clientFilter===s.guid?"selected":""}>${O(s.name)}</option>`).join("")}
      </select>`:""}
      ${fg()}
      <span class="leads-searchwrap">
        <span class="material-symbols-outlined" aria-hidden="true">search</span>
        <input class="leads-search" id="leads-search" type="search" placeholder="Search leads" value="${O(k.search)}" aria-label="Search leads" />
      </span>
      <span class="leads-count" id="leads-countlbl"></span>
    </div>
    <div id="leads-tablezone"></div>`,e.querySelector(".leads-filter")?.addEventListener("click",s=>{const r=s.target.closest("[data-filter]");r&&(k.filter=r.dataset.filter,k.shown=ct,Gt())}),e.querySelector("#leads-clientsel")?.addEventListener("change",s=>{k.clientFilter=s.target.value,k.shown=ct,Gt()}),e.querySelector("#leads-dayclear")?.addEventListener("click",()=>{k.day="",k.shown=ct,Gt()}),e.querySelector("#leads-search")?.addEventListener("input",s=>{k.search=s.target.value,k.shown=ct,Tn()}),Tn()}function Tn(){const e=document.getElementById("leads-tablezone"),t=document.getElementById("leads-countlbl");if(!e)return;const a=Mi(),n=a.slice(0,k.shown),o=k.book?8:7;t&&(t.textContent=`${a.length} of ${k.leads.length}`),e.innerHTML=`
    <div class="leads-tablewrap">
      <table class="leads-table${k.book?" leads-table--book":""}">
        ...
        <tbody id="leads-tbody">${n.map(mg).join("")||`<tr><td colspan="${o}"><div class="leads-muted" style="padding:14px 4px">${k.search.trim()?"No leads match your search.":`No ${k.filter.toLowerCase()} leads.`}</div></td></tr>`}</tbody>
      </table>
    </div>
    ${a.length>k.shown?`<button class="leads-more" type="button" id="leads-more">Show ${Math.min(ct,a.length-k.shown)} more (${a.length-k.shown} remaining)</button>`:""}`,e.querySelector("#leads-more")?.addEventListener("click",()=>{k.shown+=ct,Tn()}),e.querySelector("#leads-tbody")?.addEventListener("change",wg),e.querySelector("#leads-tbody")?.addEventListener("click",s=>{if(s.target.closest(".leads-status, a.leads-contactlink"))return;const r=s.target.closest(".leads-row");r&&fs(r.dataset.id)}),e.querySelector("#leads-tbody")?.addEventListener("keydown",s=>{if(s.key!=="Enter"&&s.key!==" ")return;const r=s.target.closest(".leads-row");r&&s.target===r&&(s.preventDefault(),fs(r.dataset.id))})}async function wg(e){const t=e.target.closest(".leads-status");if(!t)return;const a=t.dataset.id,n=k.leads.find(r=>String(r.id)===String(a)),o=t.value,s=n?.status;try{if(!(await(await fetch(`${Ca()}/m5t/v5/m5mLead/${encodeURIComponent(a)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:o})})).json().catch(()=>({}))).ok)throw new Error;n&&(n.status=o),Sa(`Marked ${o[0]}${o.slice(1).toLowerCase()}`,"success")}catch{t.value=s||"NEW",Sa("Could not update status","danger");return}try{String(a)===k.selectedId&&Bi(),k.filter!=="ALL"&&Gt()}catch(r){console.warn("[leads] re-render after status change failed:",r)}}function fs(e){k.selectedId=String(e),document.querySelectorAll(".leads-row").forEach(t=>t.classList.toggle("selected",t.dataset.id===k.selectedId)),Bi()}function ia(e,t){const a=Array.isArray(e.tags)?e.tags:[];for(let n=a.length-1;n>=0;n--)if(a[n]&&a[n].tag===t&&a[n].value!=null)return String(a[n].value);return""}function Fi(e){const t=ia(e,"appointment_start");if(!t)return null;const a=ia(e,"appointment_status")||"booked",n=ia(e,"appointment_timezone"),o=ia(e,"appointment_event_type"),s=new Date(t);let r=t;if(!Number.isNaN(s.getTime())){const i={weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"};try{r=new Intl.DateTimeFormat(void 0,n?{...i,timeZone:n}:i).format(s)}catch{r=new Intl.DateTimeFormat(void 0,i).format(s)}}return{when:r,status:a,type:o,start:t}}const vs={booked:["QUALIFIED","Booked"],rescheduled:["WORKING","Rescheduled"],canceled:["CANCELED","Canceled"]};function Di(e){const t=Array.isArray(e.tags)?e.tags:[];let a=null;for(const l of t)if(!(!l||!l.tag)){if(l.tag==="callrail_call_id"){a={};continue}a&&l.tag.indexOf("call_")===0&&l.value!=null&&(a[l.tag]=String(l.value))}if(!a||!a.call_started)return null;const n=a.call_started,o=new Date(n);let s=n;Number.isNaN(o.getTime())||(s=new Intl.DateTimeFormat(void 0,{weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"}).format(o));const r=Number(a.call_duration)||0,i=r?r<60?`${r}s`:`${Math.floor(r/60)}m ${r%60}s`:"";return{when:s,dur:i,source:a.call_source||"",answered:a.call_answered||"",recording:a.call_recording_player||"",started:n}}function Bi(){const e=document.getElementById("leads-panel-body");if(!e)return;const t=k.leads.find(l=>String(l.id)===k.selectedId);if(!t){e.innerHTML=Pi();return}const a=k.magnetNames[t.magnet_guid]||t.lead_source||"—",n=Fi(t),[o,s]=n?vs[n.status]||vs.booked:["",""],r=Di(t),i=(l,c)=>c?`<div class="leads-det__field"><span class="leads-det__k">${O(l)}</span><span class="leads-det__v">${O(c)}</span></div>`:"";e.innerHTML=`
    <div class="leads-det__head">
      <span class="leads-avatar leads-det__ava">${O(Ni(t))}</span>
      <div>
        <div class="leads-det__name">${O(Ta(t))}</div>
        <span class="leads-badge" data-s="${O(t.status)}">${O(t.status)}</span>
      </div>
    </div>
    <div class="leads-det__contact">
      ${t.email?`<a class="leads-det__cbtn" href="mailto:${O(t.email)}"><span class="material-symbols-outlined" aria-hidden="true">mail</span>Email</a>`:""}
      ${t.phone?`<a class="leads-det__cbtn" href="tel:${O(String(t.phone).replace(/[^\d+]/g,""))}"><span class="material-symbols-outlined" aria-hidden="true">call</span>Call</a>`:""}
    </div>
    ${i("Email",t.email)}
    ${i("Phone",t.phone)}
    ${i("Mobile",t.mobile)}
    ...
    ${i("Magnet",a)}
    ${i("Captured",St(t))}
    ${n?`<div class="leads-det__field"><span class="leads-det__k">Appointment</span><span class="leads-det__v">${O([n.when,n.type].filter(Boolean).join(" · "))} <span class="leads-badge" data-s="${O(o)}">${O(s)}</span></span></div>`:""}
    ${r?`<div class="leads-det__field"><span class="leads-det__k">Last call</span><span class="leads-det__v">${O([r.when,r.dur,r.source].filter(Boolean).join(" · "))} <span class="leads-badge" data-s="${r.answered==="no"?"WORKING":"QUALIFIED"}">${r.answered==="no"?"Missed":"Answered"}</span>${r.recording&&/^https:\/\//i.test(r.recording)?` <a href="${O(r.recording)}" target="_blank" rel="noopener">Recording</a>`:""}</span></div>`:""}
    ...
    ${t.description?`<div class="leads-det__notes">${O(t.description)}</div>`:""}`}function xg(){const e=Mi();if(!e.length){Sa("Nothing to export","info");return}const t=["first_name","last_name","email","phone","company","product_interest","lead_source","utm_source","utm_medium","utm_campaign","gclid","status"],a=l=>`"${String(l??"").replace(/"/g,'""')}"`,o=[[...k.book?["client"]:[],...t,"magnet","captured","appointment","last_call"].join(",")];for(const l of e){const c=Fi(l),u=Di(l);o.push([...k.book?[a(k.ownerNames[l.owner_guid]||"")]:[],...t.map(v=>a(l[v])),a(k.magnetNames[l.magnet_guid]||l.lead_source||""),a(St(l)),a(c?`${c.start} (${c.status})`:""),a(u?`${u.started} (${u.answered==="no"?"missed":"answered"})`:"")].join(","))}const s=new Blob([o.join(`
`)],{type:"text/csv"}),r=URL.createObjectURL(s),i=document.createElement("a");i.href=r,i.download=`leads-${k.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r),Sa(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const Eg=Object.freeze(Object.defineProperty({__proto__:null,init:bg,render:vg},Symbol.toStringTag,{value:"Module"})),qi=()=>E.getConfig?.().BASE_URL||"",bs=e=>e.toISOString().slice(0,10),$n=e=>e==null?"—":"$"+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),Je=e=>Number(e||0).toLocaleString(),kg={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},kt=e=>String(e??"").replace(/[&<>"']/g,t=>kg[t]);let _s=!1;function Ag(){if(_s)return;const e=document.createElement("style");e.id="m5t-adperf-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),_s=!0}const ut=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,la=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
  ...
  </div>`,Sg=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let $a=30;function Ui(){return oe()?Lt({section:"ad-performance",title:"Ad Performance",description:"Pick a client to view their spend and lead performance."}):(Ag(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${Sg.map(e=>`<button class="chart-period-btn${e.d===$a?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>

      <div class="stats-grid" id="adperf-stats">
        ${la("payments","Ad Spend","adperf-spend")}
        ${la("ads_click","Clicks","adperf-clicks")}
        ${la("person_add","Magnet Leads","adperf-leads")}
        ${la("request_quote","Cost / Lead","adperf-cpl")}
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-body">
          ${ut("hourglass_empty","Loading ad performance…")}
        </div>
      </div>
    ...
    </div>`)}async function zi(){if(oe()){const t=a=>Number(a||0).toLocaleString();return _t(qi(),[{h:"Spend",td:a=>a.ad?`$${t(a.ad.spend)}`:"—"},{h:"Clicks",td:a=>a.ad?t(a.ad.clicks):"—"},{h:"Leads",td:a=>t(a.leads.window??a.leads.total)},{h:"CPL",td:a=>a.ad?.cost_per_lead!=null?`$${t(a.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see spend here."})}const e=document.getElementById("adperf-periods");e?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&($a=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===$a)),ys())}),await ys()}async function ys(){const e=qi(),t=document.getElementById("adperf-body"),a=document.getElementById("adperf-range"),n=new Date,o=bs(n),s=bs(new Date(n.getTime()-($a-1)*864e5));a&&(a.textContent=`${s} → ${o}`);let r,i=[],l=null,c=null,u=null;try{const[h,d,f,p,b]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${s}&to=${o}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${s}&to=${o}`),Fa().catch(()=>null),fetch(`${e}/m5t/v5/coreAdMetrics/conversions?from=${s}&to=${o}`).then(w=>w.json()).catch(()=>null)]);if(!h.ok)throw new Error(`HTTP ${h.status}`);r=await h.json(),i=((await d.json().catch(()=>({})))?.data||[]).filter(w=>w.status!=="DELETED"),l=await f.json().catch(()=>null),c=p,u=b}catch(h){console.warn("[ad-performance] load failed:",h),t&&(t.innerHTML=ut("error","Could not load ad performance. Please try again."));return}Cg(c,i),Tg(u);const v=r.totals||{};if(ca("adperf-spend",$n(v.spend)),ca("adperf-clicks",Je(v.clicks)),ca("adperf-leads",Je(v.magnet_leads)),ca("adperf-cpl",$n(v.cost_per_lead)),$g(l),!i.length){t.innerHTML=ut("link_off","No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.");return}if(!r.connected){t.innerHTML=ut("cloud_sync","Account connected. No ad data for this range yet. Metrics appear here once they sync.");return}t.innerHTML=Lg(r.rows||[])}function Cg(e,t){const a=document.getElementById("adperf-conn");if(!a)return;if(!e||e.denied){a.innerHTML="";return}const n=Se.google_ads,o=Oa(e.providers,"google_ads"),s=Ma(n,o,!!e.configured?.google_ads),r=Te()?` <a href="#/settings/integrations/${n.urlSlug}">Manage</a>`:"";if(s==="connected"||s==="broken"){Da(),a.innerHTML=`<span>Google Ads</span> ${Pa(s,o)}${r}`;return}if(t.length){a.innerHTML=`<span>Google Ads</span> <span>${t.length} associated account${t.length===1?"":"s"}</span>`;return}a.innerHTML=""}function Tg(e){const t=document.getElementById("adperf-conv-card"),a=document.getElementById("adperf-conv-body"),n=document.getElementById("adperf-stats"),o=document.getElementById("adperf-conv-stat");if(o&&o.remove(),!t||!a)return;if(!e?.ok||!e.has_selection){t.style.display="none";return}if(n){const i=document.createElement("div");i.className="stat-card",i.id="adperf-conv-stat",i.innerHTML=`
      <div class="stat-header">
        <span class="material-symbols-outlined stat-icon" aria-hidden="true">flag</span>
        <span class="stat-label">Ads Conversions</span>
      </div>
      <div class="stat-value">${Je(e.totals?.conversions)}</div>
      <div class="stat-change"><span class="stat-sublabel">Reported by Google Ads</span></div>`,n.appendChild(i)}const s=e.actions||[];if(t.style.display="",!s.length){a.innerHTML=ut("search_off","No conversions in this range for the selected actions.");return}const r=s.some(i=>i.value>0);a.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${s.map(i=>`
          <tr>
            <td>${kt(i.name||i.id)}</td>
            <td class="adperf-src-sub">${kt(String(i.category||"").toLowerCase().replace(/_/g," ")||"—")}</td>
            <td class="num"><b>${Je(i.conversions)}</b></td>
            ${r?`<td class="num">${$n(i.value)}</td>`:""}
          </tr>`).join("")}
        </tbody>
      </table>
    </div>
    <p class="adperf-note">Counted actions are chosen on the Google Ads integration page. These are Google's own numbers and may overlap magnet leads, so they are never added together.</p>`}function $g(e){const t=document.getElementById("adperf-sources"),a=document.getElementById("adperf-src-summary");if(!t)return;const n=e&&Array.isArray(e.rows)?e.rows:[];if(!n.length){a&&(a.textContent=""),t.innerHTML=ut("search_off","No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.");return}const o=e.total_leads||n.reduce((i,l)=>i+(l.leads||0),0),s=e.tracked_leads||0;a&&(a.textContent=`${Je(s)} of ${Je(o)} leads tagged to a source`);const r=i=>i.campaign&&i.campaign!=="(none)"?kt(i.campaign):i.source&&i.source!=="(direct)"?kt(i.source):'<span class="adperf-src-untracked">Untracked / direct</span>';t.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${n.map(i=>`
          <tr>
            <td>${r(i)}</td>
            <td class="adperf-src-sub">${kt(i.source||"—")}${i.medium?` · ${kt(i.medium)}`:""}</td>
            <td class="num">${i.paid_clicks?Je(i.paid_clicks):'<span class="adperf-src-sub">—</span>'}</td>
            <td class="num"><b>${Je(i.leads)}</b></td>
          </tr>`).join("")}
        </tbody>
      </table>
    </div>`}function ca(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}function ws(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}function xs(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e)}function Lg(e){const d=e.length||1,f=ws(Math.max(1,...e.map(D=>D.spend||0))),p=ws(Math.max(1,...e.map(D=>D.magnet_leads||0))),b=738/d,y=Math.min(24,b*.55),w=D=>56+b*(D+.5),A=D=>304-D/f*282,R=D=>304-D/p*282,z=[0,.25,.5,.75,1].map(D=>{const ae=304-D*282;return`<line x1="56" y1="${ae.toFixed(1)}" x2="794" y2="${ae.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${(ae+3.5).toFixed(1)}" text-anchor="end" class="ax">$${xs(f*D)}</text><text x="802" y="${(ae+3.5).toFixed(1)}" text-anchor="start" class="ax">${xs(p*D)}</text>`}).join(""),Q=e.map((D,ae)=>{const q=A(D.spend||0);return`<rect x="${(w(ae)-y/2).toFixed(1)}" y="${q.toFixed(1)}" width="${y.toFixed(1)}" height="${Math.max(0,304-q).toFixed(1)}" rx="3" fill="#0072BA"><title>${D.date}: $${D.spend} spend</title></rect>`}).join(""),ge=e.map((D,ae)=>`${w(ae).toFixed(1)},${R(D.magnet_leads||0).toFixed(1)}`).join(" "),$e=d>1?`<polyline points="${ge}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",he=e.map((D,ae)=>`<circle cx="${w(ae).toFixed(1)}" cy="${R(D.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${D.date}: ${D.magnet_leads} leads</title></circle>`).join(""),Ve=Math.max(1,Math.ceil(d/6)),Be=e.map((D,ae)=>ae%Ve===0||ae===d-1?`<text x="${w(ae).toFixed(1)}" y="326" text-anchor="middle" class="ax">${D.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="adperf-chart" viewBox="0 0 840 340" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Ad spend versus magnet leads over time">
      ${z}${Q}${$e}${he}${Be}
    </svg>`}const Ig={render:Ui,init:zi},Rg=Object.freeze(Object.defineProperty({__proto__:null,default:Ig,init:zi,render:Ui},Symbol.toStringTag,{value:"Module"})),Ng={google_ads:"Google Ads",google_lsa:"Local Services Ads"},Og=e=>{const t=String(e||"").replace(/\D/g,"");return t.length===10?`${t.slice(0,3)}-${t.slice(3,6)}-${t.slice(6)}`:String(e||"")};let Es=!1;function Mg(){if(Es)return;const e=document.createElement("style");e.id="m5t-adacct-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Es=!0}function Hi(){return oe()?Lt({section:"ad-accounts",title:"Ad Accounts",description:"Pick a client to see their connected ad accounts."}):(Mg(),Da(),`
    ...
    </div>`)}async function Gi(){if(oe()){const e=t=>Number(t||0).toLocaleString();return _t(ee(),[{h:"Spend",td:t=>t.ad?`$${e(t.ad.spend)}`:"—"},{h:"Leads",td:t=>e(t.leads.window??t.leads.total)},{h:"CPL",td:t=>t.ad?.cost_per_lead!=null?`$${e(t.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see it here."})}await Pg()}async function Pg(){const[e,t,a]=await Promise.all([Fa().catch(()=>null),fetch(`${ee()}/m5t/v5/coreAdAccount`).then(n=>n.json()).catch(()=>null),fetch(`${ee()}/m5t/v5/coreAdMetrics/conversions`).then(n=>n.json()).catch(()=>null)]);Fg(e,a),Dg(t),Bg(t)}function Fg(e,t){const a=document.getElementById("adacct-conn");if(!a)return;const n=Se.google_ads;if(!e||e.denied){a.innerHTML=Ne("link_off","Connection status is not available for your role.");return}const o=Oa(e.providers,"google_ads"),s=Ma(n,o,!!e.configured?.google_ads),r=o?.external_account||{},i=n.card.reachableCount(r);let l;s==="connected"?l=i?`${i} reachable account${i===1?"":"s"}.`:"Connected.":s==="broken"?l=n.card.brokenDesc:s==="unavailable"?l="Google Ads is being set up for this platform.":l=Te()?"Not connected yet. Connect from Settings to pull spend and clicks.":"Not connected yet.";const c=Te()&&s!=="unavailable"?`<a class="adacct-manage" href="#/settings/integrations/${n.urlSlug}"><span class="material-symbols-outlined" aria-hidden="true">${s==="idle"?"link":"settings"}</span>${s==="idle"?"Connect":"Manage"}</a>`:"";let u="";if(t?.ok&&t.has_selection){const v=(t.actions||[]).map(d=>d.name||d.id),h=(t.selected_ids||[]).length-v.length;u=`
      <div class="adacct-chips">Counted in reporting:
        ${v.map(d=>`<span class="adacct-chip">${I(d)}</span>`).join("")}
        ${h>0?`<span class="adacct-chip">${h} more</span>`:""}
      </div>`}a.innerHTML=`
    <div class="adacct-conn">
      ${zn(n)}
      <div class="adacct-conn__titles">
        <span class="adacct-conn__name">${I(n.label)} ${Pa(s,o)}</span>
        <span class="adacct-conn__sub">${I(l)}</span>
      </div>
      <span class="adacct-conn__spacer"></span>
      ${c}
    </div>
    ${u}`}function Dg(e){const t=document.getElementById("adacct-list"),a=document.getElementById("adacct-count");if(!t)return;if(!e||e.ok===!1){t.innerHTML=Ne("error","Could not load ad accounts. Please try again.");return}const n=(e.data||[]).filter(s=>s.status!=="DELETED"),o=!!e.canConnect;if(a&&(a.textContent=n.length?`${n.length} account${n.length===1?"":"s"}`:""),!n.length){t.innerHTML=Ne("link_off",o?"No ad accounts associated yet.":"No ad accounts yet. Your agency connects these for you.")+(o?`<p class="adacct-note">Associate a client's Customer ID from the <a href="#/clients">Clients page</a>.</p>`:"");return}t.innerHTML=`
    <div class="adacct-wrap">
      <table class="adacct-table">
        <thead><tr><th>Platform</th><th>Customer ID</th><th>Status</th></tr></thead>
        <tbody>${n.map(s=>`
          <tr>
            <td>${I(Ng[s.provider]||s.provider)}</td>
            <td class="adacct-cid">${I(Og(s.external_customer_id))}</td>
            <td><span class="m5t-badge" data-tone="${s.status==="ACTIVE"?"success":"warning"}">${I(s.status==="ACTIVE"?"Active":s.status)}</span></td>
          </tr>`).join("")}
        </tbody>
      </table>
    </div>
    ${o?'<p class="adacct-note">Associations are managed per client from the <a href="#/clients">Clients page</a>.</p>':""}`}let dt=[],ks=null;function Bg(e){const t=document.getElementById("adacct-offline");if(t){if(!e?.canConnect){t.style.display="none";return}t.style.display="",document.getElementById("adacct-oc-dl")?.addEventListener("click",Hg),document.getElementById("adacct-oc-up")?.addEventListener("click",zg),document.getElementById("adacct-mc-file")?.addEventListener("change",Gg),qg()}}async function qg(){dt=[];try{const t=await(await fetch(`${ee()}/m5t/v5/integrations/google_ads/conversion_actions`)).json();if(!t.ok)return;const a=t.data.actions||[];if(dt=a.filter(o=>o.type==="UPLOAD_CLICKS"&&(o.account_ids||[]).length),!dt.length){if(a.length){const o=document.getElementById("adacct-oc-result");o&&(o.textContent="Direct upload needs an import type conversion action in Google Ads. The CSV works either way.")}return}const n=document.getElementById("adacct-oc-target");n&&(n.innerHTML=dt.map(o=>`<option value="${I(o.id)}">${I(o.name||o.id)}</option>`).join("")),document.getElementById("adacct-oc-target-wrap")?.style.setProperty("display",""),document.getElementById("adacct-oc-up")?.style.setProperty("display","")}catch{}}function Ug(){const e=document.getElementById("adacct-oc-target")?.value;return dt.find(t=>t.id===e)||dt[0]||null}async function ji(e,t){const a=Ug();if(!a){t&&(t.textContent="Pick an upload target first.");return}const n=document.getElementById("adacct-oc-value")?.value,o=n!==""&&n!=null&&Number.isFinite(Number(n))?Number(n):null;t&&(t.textContent=`Uploading ${e.length} conversion${e.length===1?"":"s"}…`);try{const r=await(await fetch(`${ee()}/m5t/v5/integrations/google_ads/upload_conversions`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({customer_id:a.account_ids[0],conversion_action_id:a.id,rows:e.map(l=>o!=null?{...l,value:o}:l)})})).json();if(!r.ok)throw new Error(r.error||"upload failed");const i=[`${r.data.uploaded} uploaded to Google Ads.`];r.data.failed&&i.push(`${r.data.failed} rejected${r.data.errors?.[0]?`: ${r.data.errors[0]}`:"."}`),t&&(t.textContent=i.join(" "))}catch(s){t&&(t.textContent=s.message==="upload failed"?"Upload failed. Please try again.":`Upload failed: ${s.message}`)}}async function zg(){const e=document.getElementById("adacct-oc-result"),t=Number(document.getElementById("adacct-oc-days")?.value)||90,a=[...document.querySelectorAll("#adacct-oc-statuses input:checked")].map(i=>i.value);if(!a.length){e&&(e.textContent="Pick at least one status.");return}const n=i=>i.toISOString().slice(0,10),o=n(new Date),s=n(new Date(Date.now()-(t-1)*864e5)),r=new URLSearchParams({from:s,to:o,statuses:a.join(","),format:"json"});try{const l=await(await fetch(`${ee()}/m5t/v5/coreAdMetrics/offline-conversions.csv?${r}`)).json();if(!l.ok)throw new Error;if(!l.rows.length){e&&(e.textContent="No leads with a click id in that window.");return}await ji(l.rows,e)}catch{e&&(e.textContent="Upload failed. Please try again.")}}async function Hg(){const e=document.getElementById("adacct-oc-result"),t=Number(document.getElementById("adacct-oc-days")?.value)||90,a=[...document.querySelectorAll("#adacct-oc-statuses input:checked")].map(c=>c.value);if(!a.length){e&&(e.textContent="Pick at least one status.");return}const n=document.getElementById("adacct-oc-name")?.value?.trim()||"M5M magnet lead",o=document.getElementById("adacct-oc-value")?.value,s=c=>c.toISOString().slice(0,10),r=s(new Date),i=s(new Date(Date.now()-(t-1)*864e5)),l=new URLSearchParams({from:i,to:r,statuses:a.join(","),name:n});o!==""&&o!=null&&Number.isFinite(Number(o))&&l.set("value",o),e&&(e.textContent="Building the export…");try{const c=await fetch(`${ee()}/m5t/v5/coreAdMetrics/offline-conversions.csv?${l}`);if(!c.ok)throw new Error(`HTTP ${c.status}`);const u=await c.text(),v=Math.max(0,u.trim().split(`
`).length-1);Wi(u,`google-ads-conversions-${i}-to-${r}.csv`),e&&(e.textContent=v?`${v} conversion${v===1?"":"s"} in the file.`:"No leads with a click id in that window. The file has headers only.")}catch{e&&(e.textContent="Export failed. Please try again.")}}async function Gg(e){const t=document.getElementById("adacct-mc-result"),a=e.target.files?.[0];if(!a)return;const n=await a.text(),o=Vi(n);if(!o.length){t&&(t.textContent="No usable rows found. The CSV needs an email or phone column.");return}t&&(t.textContent=`Matching ${o.length} row${o.length===1?"":"s"}…`);try{const r=await(await fetch(`${ee()}/m5t/v5/coreAdMetrics/offline-conversions/match`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({rows:o})})).json();if(!r.ok)throw new Error(r.error||"match failed");const i=[`${r.matched_count} of ${o.length} rows matched a magnet lead with a click id.`];if(r.unmatched_count&&i.push(`${r.unmatched_count} had no matching lead.`),r.no_click_count&&i.push(`${r.no_click_count} matched a lead without a click id.`),!r.matched_count){t&&(t.textContent=i.join(" "));return}const l=document.getElementById("adacct-oc-name")?.value?.trim()||"M5M magnet lead",c=document.getElementById("adacct-oc-value")?.value,u=c!==""&&c!=null&&Number.isFinite(Number(c))?Number(c):"",v=d=>`"${String(d??"").replace(/"/g,'""')}"`,h=["Google Click ID,Conversion Name,Conversion Time,Conversion Value,Conversion Currency",...r.matched.map(d=>[v(d.gclid),v(l),v(d.time),u,""].join(","))].join(`\r
`)+`\r
`;if(ks=r.matched.map(d=>({gclid:d.gclid,time:d.time})),t){t.innerHTML="";const d=document.createElement("span");d.textContent=i.join(" ")+" ";const f=document.createElement("button");if(f.type="button",f.className="adacct-manage",f.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">download</span>Download matched CSV',f.addEventListener("click",()=>Wi(h,`google-ads-conversions-matched-${new Date().toISOString().slice(0,10)}.csv`)),t.append(d,f),dt.length){const p=document.createElement("button");p.type="button",p.className="adacct-manage",p.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">cloud_upload</span>Upload to Google Ads',p.addEventListener("click",()=>ji(ks,t)),t.append(" ",p)}}}catch{t&&(t.textContent="Matching failed. Please try again.")}finally{e.target.value=""}}function Vi(e){const t=[];let a=[],n="",o=!1;for(let c=0;c<e.length;c++){const u=e[c];o?u==='"'&&e[c+1]==='"'?(n+='"',c++):u==='"'?o=!1:n+=u:u==='"'?o=!0:u===","?(a.push(n),n=""):u===`
`||u==="\r"?(u==="\r"&&e[c+1]===`
`&&c++,a.push(n),n="",a.some(v=>v.trim()!=="")&&t.push(a),a=[]):n+=u}if(a.push(n),a.some(c=>c.trim()!=="")&&t.push(a),t.length<2)return[];const s=t[0].map(c=>c.trim().toLowerCase()),r=s.findIndex(c=>/e-?mail/.test(c)),i=s.findIndex(c=>/phone|mobile|tel/.test(c)),l=s.findIndex(c=>/date|time|booked|appointment|start/.test(c));return r<0&&i<0?[]:t.slice(1).map(c=>({email:r>=0?(c[r]||"").trim():"",phone:i>=0?(c[i]||"").trim():"",at:l>=0?(c[l]||"").trim():""})).filter(c=>c.email||c.phone).slice(0,5e3)}function Wi(e,t){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),o=document.createElement("a");o.href=n,o.download=t,document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(n),4e3)}const jg={render:Hi,init:Gi},Vg=Object.freeze(Object.defineProperty({__proto__:null,default:jg,init:Gi,parseBookingCsv:Vi,render:Hi},Symbol.toStringTag,{value:"Module"})),As="reseller_org",Yi="managed_client";let Ss=!1;const Wg={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},M=e=>String(e??"").replace(/[&<>"']/g,t=>Wg[t]);function mt(e,t="info"){try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}}function Yg(){const e=E.getActiveOrg();if(e&&e.channel===As)return{guid:e.guid,name:e.name};const t=E.getMemberships().find(a=>a.channel===As);return t?{guid:t.orgGuid,name:t.name}:null}function Kg(e){const t=e?.created_tz;if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function Jg(){if(Ss)return;const e=document.createElement("style");e.id="m5t-clients-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Si(),Ss=!0}const Qg=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function jt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Xg(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
    <div class="client-row">
      <span class="client-row__avatar">${M(Qg(t))}</span>
      <span class="client-row__main">
        <div class="client-row__name" title="${M(t)}">${M(t)}</div>
        <div class="client-row__meta">Added ${M(Kg(e.created))||"—"}</div>
      </span>
      <span class="client-row__status" data-status="${M(a)}">${M(a)}</span>
      <div class="client-row__btns">
        <button class="client-card__invite" type="button" data-action="invite" data-client-guid="${M(e.guid)}" data-client-name="${M(t)}">
          <span class="material-symbols-outlined" aria-hidden="true">person_add</span> Invite user
        </button>
        <button class="client-card__invite" type="button" data-action="questionnaire" data-client-guid="${M(e.guid)}" data-client-name="${M(t)}">
        ...
        <button class="client-card__invite" type="button" data-action="adaccounts" data-client-guid="${M(e.guid)}" data-client-name="${M(t)}">
          <span class="material-symbols-outlined" aria-hidden="true">ads_click</span> Ad accounts
        </button>`:""}
      </div>
    </div>`}function Ki(){return Jg(),`
    ...
    </div>`}async function Ji(){const e=Yg();document.getElementById("clients-add-btn")?.addEventListener("click",()=>Zg(e)),await Qi(e)}async function Qi(e){const t=document.getElementById("clients-body"),a=document.getElementById("clients-count");if(t){if(!e?.guid){t.innerHTML=jt("info","Client provisioning is available to reseller / agency accounts."),a&&(a.textContent="");return}try{const n=E.getConfig?.().BASE_URL||"",o=await fetch(`${n}/m5t/v5/acctGroup`);if(!o.ok)throw new Error(`HTTP ${o.status}`);const s=await o.json(),i=(Array.isArray(s?.data)?s.data:[]).filter(l=>l.class===Yi&&(!l.parent||l.parent===e.guid));if(!i.length){t.innerHTML=jt("group_off","No clients yet. Add your first client to start managing magnets on their behalf."),a&&(a.textContent="");return}t.innerHTML=`<div class="client-list">${i.map(Xg).join("")}</div>`,a&&(a.textContent=`${i.length} client${i.length===1?"":"s"}`),t.querySelectorAll(".client-card__invite").forEach(l=>{l.addEventListener("click",()=>{l.dataset.action==="adaccounts"?eh(l.dataset.clientGuid,l.dataset.clientName):l.dataset.action==="questionnaire"?ah(l.dataset.clientGuid,l.dataset.clientName):th(l.dataset.clientGuid,l.dataset.clientName)})})}catch(n){console.warn("[clients] load failed:",n),t.innerHTML=jt("error","Couldn’t load clients. Please try again."),a&&(a.textContent="")}}}function Zg(e){if(!e?.guid){mt("Only reseller / agency accounts can add clients.","error");return}const t=document.createElement("div");t.className="client-modal-scrim";const a=document.createElement("div");a.className="client-modal",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
    ...
    <div class="client-modal__body">
      <p class="client-modal__sub">Creates a managed client under <strong>${M(e.name||"your agency")}</strong>. You'll manage their magnets and leads on their behalf.</p>
    ...
    </div>`,document.body.appendChild(t),document.body.appendChild(a),requestAnimationFrame(()=>{t.classList.add("open"),a.classList.add("open")});const n=a.querySelector("#client-name-input"),o=a.querySelector("#client-modal-error"),s=a.querySelector('[data-act="create"]');n?.focus();const r=()=>{t.classList.remove("open"),a.classList.remove("open"),document.removeEventListener("keydown",i),setTimeout(()=>{t.remove(),a.remove()},200)},i=c=>{c.key==="Escape"&&r()};document.addEventListener("keydown",i),t.addEventListener("click",r),a.querySelector(".client-modal__close")?.addEventListener("click",r),a.querySelector('[data-act="cancel"]')?.addEventListener("click",r);const l=async()=>{const c=(n?.value||"").trim();if(o.textContent="",!c){o.textContent="Please enter a client name.",n?.focus();return}s.disabled=!0;const u=s.innerHTML;s.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Adding…';try{const v=E.getConfig?.().BASE_URL||"",h=await fetch(`${v}/m5t/v5/acctGroup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({class:Yi,caption:c,parent:e.guid})}),d=await h.json().catch(()=>({}));if(!h.ok||!d?.ok){const f=h.status===403?"You are not authorized to add a client here.":d?.message||d?.error||`Failed (HTTP ${h.status})`;throw new Error(f)}mt(`Added client “${c}”`,"success"),r(),await Qi(e)}catch(v){console.warn("[clients] create failed:",v),o.textContent=v.message||"Something went wrong. Please try again.",s.disabled=!1,s.innerHTML=u}};s?.addEventListener("click",l),n?.addEventListener("keydown",c=>{c.key==="Enter"&&l()})}const Cs=e=>String(e||"").replace(/[^0-9]/g,"");async function eh(e,t){const a=E.getConfig?.().BASE_URL||"",n={};try{const f=await fetch(`${a}/m5t/v5/coreAdAccount?owner_guid=${encodeURIComponent(e)}`),p=await f.json().catch(()=>({}));if(!f.ok)throw new Error(`Failed to load ad accounts (${f.status})`);(p?.data||[]).forEach(b=>{n[b.provider]=b})}catch(f){console.warn("[clients] ad-accounts prefill failed:",f)}const o=n.google_ads,s=n.google_lsa,r=document.createElement("div");r.className="client-modal-scrim";const i=document.createElement("div");i.className="client-modal",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.innerHTML=`
    <div class="client-modal__head">
      <span class="client-modal__title">Ad accounts: ${M(t)}</span>
      <button class="client-modal__close" type="button" aria-label="Close">&times;</button>
    </div>
    <div class="client-modal__body">
      ...
      <input class="client-modal__input" id="aa-gads" type="text" inputmode="numeric" placeholder="123-456-7890" autocomplete="off" value="${M(o?.external_customer_id||"")}" />
      ...
      <input class="client-modal__input" id="aa-lsa" type="text" inputmode="numeric" placeholder="Optional" autocomplete="off" value="${M(s?.external_customer_id||"")}" />
    ...
    </div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add("open"),i.classList.add("open")});const l=i.querySelector("#aa-error"),c=i.querySelector('[data-act="save"]'),u=()=>{r.classList.remove("open"),i.classList.remove("open"),document.removeEventListener("keydown",v),setTimeout(()=>{r.remove(),i.remove()},200)},v=f=>{f.key==="Escape"&&u()};document.addEventListener("keydown",v),r.addEventListener("click",u),i.querySelector(".client-modal__close")?.addEventListener("click",u),i.querySelector('[data-act="cancel"]')?.addEventListener("click",u);const h=(f,p,b)=>{const y=`${a}/m5t/v5/coreAdAccount`;return p&&!b?fetch(y,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,provider:f,external_customer_id:p})}):p&&b&&p!==b.external_customer_id?fetch(`${y}/${encodeURIComponent(b.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({external_customer_id:p})}):!p&&b?fetch(`${y}/${encodeURIComponent(b.guid)}`,{method:"DELETE"}):null},d=async()=>{l.textContent="";const f=Cs(i.querySelector("#aa-gads").value),p=Cs(i.querySelector("#aa-lsa").value),b=[h("google_ads",f,o),h("google_lsa",p,s)].filter(Boolean);if(!b.length){u();return}c.disabled=!0;const y=c.innerHTML;c.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const w=await Promise.all(b);for(const A of w)if(!A.ok){const R=await A.json().catch(()=>({}));throw new Error(A.status===403?"You are not authorized to connect accounts for this client.":R?.error||R?.message||`Failed (HTTP ${A.status})`)}mt("Ad accounts updated","success"),u()}catch(w){l.textContent=w.message||"Something went wrong. Please try again.",c.disabled=!1,c.innerHTML=y}};c?.addEventListener("click",d)}function th(e,t){if(!e)return;const a=document.createElement("div");a.className="client-modal-scrim";const n=document.createElement("div");n.className="client-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="invite-body">
      ...
      <p class="client-modal__sub">Invite someone at <strong>${M(t||"this client")}</strong> to a read-only login for their account.</p>
      ...
      <div class="client-modal__actions">
    ...
    </div>`,document.body.appendChild(a),document.body.appendChild(n),requestAnimationFrame(()=>{a.classList.add("open"),n.classList.add("open")});const o=()=>{a.classList.remove("open"),n.classList.remove("open"),document.removeEventListener("keydown",s),setTimeout(()=>{a.remove(),n.remove()},200)},s=u=>{u.key==="Escape"&&o()};document.addEventListener("keydown",s),a.addEventListener("click",o),n.querySelector(".client-modal__close")?.addEventListener("click",o),n.querySelector('[data-act="cancel"]')?.addEventListener("click",o);const r=n.querySelector("#inv-email"),i=n.querySelector("#inv-error"),l=n.querySelector('[data-act="send"]');r?.focus();const c=u=>u.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(u.dataset.url),u.textContent="Copied!",setTimeout(()=>{u.textContent="Copy link"},1500)}catch{}});(async function(){const v=n.querySelector("#invite-pending");if(v)try{const h=E.getConfig?.().BASE_URL||"",d=await fetch(`${h}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invites`),f=await d.json().catch(()=>({})),p=d.ok&&f.ok&&Array.isArray(f.invites)?f.invites:[];if(!p.length){v.innerHTML="";return}v.innerHTML=`
        <div class="invite-pending">
          <div class="invite-pending__label">Pending invites</div>
          ${p.map(b=>`
            <div class="invite-pending__row">
              <span class="invite-pending__email${b.expired?" expired":""}" title="${M(b.email)}">${M(b.email)}${b.expired?" · expired":""}</span>
              <button class="client-modal__btn client-modal__btn--ghost invite-pending__copy" type="button" data-url="${M(b.inviteUrl)}">Copy link</button>
            </div>`).join("")}
        </div>`,v.querySelectorAll(".invite-pending__copy").forEach(c)}catch{v.innerHTML=""}})(),l?.addEventListener("click",async()=>{const u=(n.querySelector("#inv-email").value||"").trim(),v=(n.querySelector("#inv-first").value||"").trim(),h=(n.querySelector("#inv-last").value||"").trim();if(i.textContent="",!u||!v||!h){i.textContent="Email, first, and last name are required.";return}l.disabled=!0;const d=l.innerHTML;l.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Sending…';try{const f=E.getConfig?.().BASE_URL||"",p=await fetch(`${f}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:u,first:v,last:h})}),b=await p.json().catch(()=>({}));if(!p.ok||!b.ok){const w=p.status===409?"A user with that email already exists.":p.status===403?"You are not authorized to invite for this client.":b.message||b.error||`Failed (HTTP ${p.status})`;throw new Error(w)}mt(`Invite created for ${u}`,"success"),n.querySelector("#invite-body").innerHTML=`
        <div class="client-modal__result">
          ...
          <p>${b.emailQueued?`An invite email is on its way to <strong>${M(u)}</strong>.`:`Invite created for <strong>${M(u)}</strong>.`}</p>
          ...
          <div class="client-modal__linkrow">
            <input class="client-modal__input" id="inv-link" type="text" readonly value="${M(b.inviteUrl)}" />
        ...
        </div>`;const y=n.querySelector("#inv-link");n.querySelector("#inv-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(y.value),n.querySelector("#inv-copy").textContent="Copied!"}catch{y.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",o)}catch(f){console.warn("[clients] invite failed:",f),i.textContent=f.message||"Something went wrong. Please try again.",l.disabled=!1,l.innerHTML=d}})}function on(e){if(!e)return"";const t=new Date(e);return Number.isNaN(t.getTime())?"":t.toLocaleString(void 0,{year:"numeric",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}async function ah(e,t){if(!e)return;const a=E.getConfig?.().BASE_URL||"",n=document.createElement("div");n.className="client-modal-scrim";const o=document.createElement("div");o.className="client-modal",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),o.innerHTML=`
    <div class="client-modal__head">
      <span class="client-modal__title">Kickoff Questionnaire: ${M(t)}</span>
      <button class="client-modal__close" type="button" aria-label="Close">&times;</button>
    </div>
    <div class="client-modal__body" id="qm-body">${jt("hourglass_empty","Loading…")}</div>`,document.body.appendChild(n),document.body.appendChild(o),requestAnimationFrame(()=>{n.classList.add("open"),o.classList.add("open")});const s=()=>{n.classList.remove("open"),o.classList.remove("open"),document.removeEventListener("keydown",r),setTimeout(()=>{n.remove(),o.remove()},200)},r=d=>{d.key==="Escape"&&s()};document.addEventListener("keydown",r),n.addEventListener("click",s),o.querySelector(".client-modal__close")?.addEventListener("click",s);const i=o.querySelector("#qm-body");function l(){i.innerHTML=`
      <p class="client-modal__sub">Send a Client Kickoff Questionnaire to <strong>${M(t)}</strong>. They fill it out directly in their browser — no account needed. The link expires in 7 days.</p>
      ...
      </div>`,i.querySelector('[data-act="cancel"]')?.addEventListener("click",s);const d=i.querySelector('[data-act="send"]'),f=i.querySelector("#qm-error"),p=i.querySelector("#qm-email");p?.focus(),d?.addEventListener("click",async()=>{const b=(p?.value||"").trim();if(f.textContent="",!b){f.textContent="Enter the email address to send this to.",p?.focus();return}if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(b)){f.textContent="That does not look like a valid email address.",p?.focus();return}d.disabled=!0;const y=d.innerHTML;d.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Sending…';try{const w=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,recipient_email:b})}),A=await w.json().catch(()=>({}));if(!w.ok||!A.ok)throw new Error(A.error||A.message||`Failed (HTTP ${w.status})`);mt(A.data.emailQueued?`Questionnaire sent to ${b}`:"Link created — email could not be queued",A.data.emailQueued?"success":"info"),c({url:A.data.url,token_expiry:A.data.expires,recipient_email:A.data.recipient_email,emailQueued:A.data.emailQueued,guid:A.data.guid})}catch(w){f.textContent=w.message||"Something went wrong. Please try again.",d.disabled=!1,d.innerHTML=y}})}function c(d){const f=d.recipient_email?"Sent":"Link created",p=d.emailQueued===!1?"<strong>The email could not be queued.</strong> Share the link below directly instead:":d.recipient_email?`Emailed to <strong>${M(d.recipient_email)}</strong>. The link is also below — handy if it bounces, or to share via text or chat:`:"Share this link with your client — email, text, chat:";i.innerHTML=`
      <div class="qm-status" data-status="DRAFT"><span class="material-symbols-outlined" aria-hidden="true">hourglass_top</span> ${f} — awaiting response${d.token_expiry?`, link expires ${M(on(d.token_expiry))}`:""}</div>
      <p class="client-modal__hint">${p}</p>
      <div class="client-modal__linkrow">
        <input class="client-modal__input" id="qm-link" type="text" readonly value="${M(d.url||"")}" />
      ...
      </div>`;const b=i.querySelector("#qm-link");i.querySelector("#qm-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(b.value),i.querySelector("#qm-copy").textContent="Copied!"}catch{b.select()}}),i.querySelector('[data-act="done"]')?.addEventListener("click",s);const y=i.querySelector('[data-act="cancel-q"]');y?.addEventListener("click",async()=>{if(!window.confirm("Cancel this questionnaire? The link will stop working immediately. This cannot be undone — you would need to send a new one."))return;y.disabled=!0;const w=y.innerHTML;y.innerHTML="Cancelling…";try{const A=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(d.guid)}/cancel`,{method:"POST"}),R=await A.json().catch(()=>({}));if(!A.ok||!R.ok)throw new Error(R.error||R.message||`Failed (HTTP ${A.status})`);mt("Questionnaire cancelled","success"),u({...d,status:"CANCELLED",cancelled_tz:new Date().toISOString()})}catch(A){i.querySelector("#qm-cancel-error").textContent=A.message||"Something went wrong. Please try again.",y.disabled=!1,y.innerHTML=w}})}function u(d){i.innerHTML=`
      <div class="qm-status" data-status="CANCELLED"><span class="material-symbols-outlined" aria-hidden="true">block</span> Cancelled${d.cancelled_tz?` ${M(on(d.cancelled_tz))}`:""}${d.cancelled_by_email?` by ${M(d.cancelled_by_email)}`:""}</div>
      <p class="client-modal__sub">This link was revoked and no longer works.${d.recipient_email?` It had been emailed to <strong>${M(d.recipient_email)}</strong>.`:""}</p>
      <p class="client-modal__error" id="qm-error"></p>
      <div class="client-modal__actions">
        ...
        <label><input type="checkbox" value="${M(w)}" ${b.includes(w)?"checked":""}/> ${M(w)}</label>`).join("")}</div>`}return d.type==="textarea"?`<textarea>${M(p||"")}</textarea>`:`<input type="text" value="${M(p||"")}" />`}function h(d,f=!1){i.innerHTML=`
      <div class="qm-status" data-status="SUBMITTED"><span class="material-symbols-outlined" aria-hidden="true">task_alt</span> Submitted ${d.submitted_tz?M(on(d.submitted_tz)):""}</div>
      ${Ai(d)}
      <form id="qm-form">
        ${ki(d,f?{renderAnswer:v}:{})}
      </form>
      <p class="client-modal__error" id="qm-error"></p>
      <div class="client-modal__actions">
      ...
      </div>`,i.querySelector('[data-act="done"]')?.addEventListener("click",s),i.querySelector('[data-act="cancel-edit"]')?.addEventListener("click",()=>h(d,!1)),i.querySelector('[data-act="edit"]')?.addEventListener("click",()=>h(d,!0));const p=i.querySelector('[data-act="save"]');p?.addEventListener("click",async()=>{const b={};i.querySelectorAll("[data-question-id]").forEach(w=>{const A=w.dataset.questionId;if(w.dataset.questionType==="checkbox_group"){const z=[...w.querySelectorAll('input[type="checkbox"]:checked')].map(Q=>Q.value);z.length&&(b[A]=z)}else{const z=(w.querySelector("input,textarea")?.value||"").trim();z&&(b[A]=z)}}),p.disabled=!0;const y=p.innerHTML;p.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const w=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(d.guid)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({answers:b})}),A=await w.json().catch(()=>({}));if(!w.ok||!A.ok)throw new Error(A.error||A.message||`Failed (HTTP ${w.status})`);mt("Answers updated","success");const z=await(await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(d.guid)}`)).json().catch(()=>({}));h(z.ok?z.data:{...d,answers:b},!1)}catch(w){i.querySelector("#qm-error").textContent=w.message||"Something went wrong. Please try again.",p.disabled=!1,p.innerHTML=y}})}try{const d=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse?owner_guid=${encodeURIComponent(e)}`),f=await d.json().catch(()=>({}));if(!d.ok||!f.ok)throw new Error(f.error||`HTTP ${d.status}`);const p=(f.data||[])[0]||null;if(!p){l();return}if(p.status==="DRAFT"){c(p);return}if(p.status==="CANCELLED"){u(p);return}const b=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(p.guid)}`),y=await b.json().catch(()=>({}));if(!b.ok||!y.ok)throw new Error(y.error||`HTTP ${b.status}`);h(y.data)}catch(d){console.warn("[clients] questionnaire load failed:",d),i.innerHTML=`<p class="client-modal__error">Could not load questionnaire status. ${M(d.message||"")}</p>`}}const nh={render:Ki,init:Ji},oh=Object.freeze(Object.defineProperty({__proto__:null,default:nh,init:Ji,render:Ki},Symbol.toStringTag,{value:"Module"})),Ts="managed_client";let $s=!1;const sh={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},fe=e=>String(e??"").replace(/[&<>"']/g,t=>sh[t]),Ls=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},rh=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function ih(){const e=E.getActiveOrg();let t=e&&e.channel!==Ts?e:null;if(!t){const n=E.getMemberships().find(o=>o.channel!==Ts);n&&(t={guid:n.orgGuid,channel:n.channel,memberRole:n.memberRole})}if(!t)return null;const a=E.getMemberships().find(n=>n.orgGuid===t.guid)?.name;return{...t,name:a}}function lh(e){return Object.values(Ut).filter(t=>Xl(e,t.value)).sort((t,a)=>a.rank-t.rank)}function ch(){if($s)return;const e=document.createElement("style");e.id="m5t-team-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),$s=!0}function La(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function dh(e){const t=e.member_role||"member";return`
    <div class="team-row">
      <span class="team-avatar">${fe(rh(e.name||e.email))}</span>
      ...
      <span class="team-role" data-role="${fe(t)}">${fe(Ut[t]?.label||t)}</span>
    </div>`}function Xi(){return ch(),`
    <div class="page-shell" data-section="team">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="team-body">
          ${La("hourglass_empty","Loading team…")}
        </div>
      </div>
    </div>`}async function Zi(){const e=ih(),t=document.getElementById("team-invite-btn");if(!e){t&&(t.style.display="none"),document.getElementById("team-body").innerHTML=La("info","Team management is available for agency and workspace accounts.");return}t?.addEventListener("click",()=>ph(e)),await eo(e)}async function eo(e){const t=document.getElementById("team-body"),a=document.getElementById("team-count");if(t)try{const n=E.getConfig?.().BASE_URL||"",[o,s]=await Promise.all([fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/members`),fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/invites`)]),[r,i]=await Promise.all([o.json().catch(()=>({})),s.json().catch(()=>({}))]);if(!o.ok||!s.ok)throw new Error(`Failed to load team (members: ${o.status}, invites: ${s.status})`);const l=r.members||[],c=i.invites||[],u=c.length?`
    ...
    <div class="team-modal__body" id="team-invite-body">
      ...
      <div class="team-modal__actions">
        ...
        </div>`;const b=n.querySelector("#tm-link");n.querySelector("#tm-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(b.value),n.querySelector("#tm-copy").textContent="Copied!"}catch{b.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",()=>{o(),eo(e)})}catch(d){console.warn("[team] invite failed:",d),r.textContent=d.message||"Something went wrong. Please try again.",i.disabled=!1,i.innerHTML=h}})}const uh={render:Xi,init:Zi},mh=Object.freeze(Object.defineProperty({__proto__:null,default:uh,init:Zi,loadTeam:eo,render:Xi},Symbol.toStringTag,{value:"Module"}));
