...
<body>
  ...
  `,document.head.appendChild(e),Aa=!0}function Tn(e){return`<div class="pv-hintwrap">
    ...
    <div class="pv-pane">
      ...
      ${Tn("Live render of the real widget. Capture is disabled, so no test leads.")}
