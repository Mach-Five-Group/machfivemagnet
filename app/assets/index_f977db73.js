(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function a(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(o){if(o.ep)return;o.ep=!0;const r=a(o);fetch(o.href,r)}})();const Gn="modulepreload",Vn=function(e){return"/"+e},Jt={},J=function(t,a,n){let o=Promise.resolve();if(a&&a.length>0){let l=function(c){return Promise.all(c.map(f=>Promise.resolve(f).then(y=>({status:"fulfilled",value:y}),y=>({status:"rejected",reason:y}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),i=s?.nonce||s?.getAttribute("nonce");o=l(a.map(c=>{if(c=Vn(c),c in Jt)return;Jt[c]=!0;const f=c.endsWith(".css"),y=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${y}`))return;const m=document.createElement("link");if(m.rel=f?"stylesheet":Gn,f||(m.as="script"),m.crossOrigin="",m.href=c,i&&m.setAttribute("nonce",i),document.head.appendChild(m),f)return new Promise((b,k)=>{m.addEventListener("load",b),m.addEventListener("error",()=>k(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(s){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=s,window.dispatchEvent(i),!i.defaultPrevented)throw s}return o.then(s=>{for(const i of s||[])i.status==="rejected"&&r(i.reason);return t().catch(r)})};var qn=/([:*])(\w+)/g,jn="([^/]+)",Yn=/\*/g,Wn="?(?:.*)",Kn=/\/\?/g,Jn="/?([^/]+|)",Xn="(?:/^|^)",Qn="";function za(e){return e===void 0&&(e="/"),Bt()?location.pathname+location.search+location.hash:e}function D(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function Ze(e){return typeof e=="string"}function Zn(e){return typeof e=="function"}function et(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function eo(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(a,n,o){return a===null&&(a={}),a[t[o]]=decodeURIComponent(n),a},null)}function tt(e){var t=D(e).split(/\?(.*)?$/);return[D(t[0]),t.slice(1).join("")]}function Dt(e){for(var t={},a=e.split("&"),n=0;n<a.length;n++){var o=a[n].split("=");if(o[0]!==""){var r=decodeURIComponent(o[0]);t[r]?(Array.isArray(t[r])||(t[r]=[t[r]]),t[r].push(decodeURIComponent(o[1]||""))):t[r]=decodeURIComponent(o[1]||"")}}return t}function Ga(e,t){var a=tt(D(e.currentLocationPath)),n=a[0],o=a[1],r=o===""?null:Dt(o),s=[],i;if(Ze(t.path)){if(i=Xn+D(t.path).replace(qn,function(y,m,b){return s.push(b),jn}).replace(Yn,Wn).replace(Kn,Jn)+"$",D(t.path)===""&&D(n)==="")return{url:n,queryString:o,hashString:et(e.to),route:t,data:null,params:r}}else i=t.path;var l=new RegExp(i,Qn),c=n.match(l);if(c){var f=Ze(t.path)?eo(c,s):c.groups?c.groups:c.slice(1);return{url:D(n.replace(new RegExp("^"+e.instance.root),"")),queryString:o,hashString:et(e.to),route:t,data:f,params:r}}return!1}function Va(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function Ie(e,t){return typeof e[t]>"u"||e[t]===!0}function to(e){if(!e)return{};var t=e.split(","),a={},n;return t.forEach(function(o){var r=o.split(":").map(function(s){return s.replace(/(^ +| +$)/g,"")});switch(r[0]){case"historyAPIMethod":a.historyAPIMethod=r[1];break;case"resolveOptionsStrategy":n||(n={}),n.strategy=r[1];break;case"resolveOptionsHash":n||(n={}),n.hash=r[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":a[r[0]]=r[1]==="true";break}}),n&&(a.resolveOptions=n),a}function Bt(){return typeof window<"u"}function ao(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(a){return a}).forEach(function(a){["before","after","already","leave"].forEach(function(n){a[n]&&(t[n]||(t[n]=[]),t[n].push(a[n]))})}),t}function ue(e,t,a){var n=t||{},o=0;(function r(){if(!e[o]){a&&a(n);return}Array.isArray(e[o])?(e.splice.apply(e,[o,1].concat(e[o][0](n)?e[o][1]:e[o][2])),r()):e[o](n,function(s){typeof s>"u"||s===!0?(o+=1,r()):a&&a(n)})})()}ue.if=function(e,t,a){return Array.isArray(t)||(t=[t]),Array.isArray(a)||(a=[a]),[e,t,a]};function Xt(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=za(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function ht(e,t){for(var a=0;a<e.instance.routes.length;a++){var n=e.instance.routes[a],o=Ga(e,n);if(o&&(e.matches||(e.matches=[]),e.matches.push(o),e.resolveOptions.strategy==="ONE")){t();return}}t()}function no(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function oo(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var Qt=Bt(),ro=Va();function so(e,t){if(Ie(e.navigateOptions,"updateBrowserURL")){var a=("/"+e.to).replace(/\/\//g,"/"),n=Qt&&e.resolveOptions&&e.resolveOptions.hash===!0;ro?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",n?"#"+a:a),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!n){var o=location.hash;location.hash="",location.hash=o}e.instance.__freezeListening=!1},1))):Qt&&(window.location.href=e.to)}t()}function qa(e,t){var a=e.instance;if(!a.lastResolved()){t();return}ue(a.lastResolved().map(function(n){return function(o,r){if(!n.route.hooks||!n.route.hooks.leave){r();return}var s=!1,i=e.instance.matchLocation(n.route.path,e.currentLocationPath,!1);if(n.route.path!=="*")s=!i;else{var l=e.matches?e.matches.find(function(c){return n.route.path===c.route.path}):!1;s=!l}if(Ie(e.navigateOptions,"callHooks")&&s){ue(n.route.hooks.leave.map(function(c){return function(f,y){return c(function(m){m===!1?e.instance.__markAsClean(e):y()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return r()}]));return}else r()}}),{},function(){return t()})}function io(e,t){e.match.route.hooks&&e.match.route.hooks.before&&Ie(e.navigateOptions,"callHooks")?ue(e.match.route.hooks.before.map(function(a){return function(o,r){return a(function(s){s===!1?e.instance.__markAsClean(e):r()},e.match)}}).concat([function(){return t()}])):t()}function lo(e,t){Ie(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function co(e,t){e.match.route.hooks&&e.match.route.hooks.after&&Ie(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(a){return a(e.match)}),t()}function po(e,t){var a=e.instance.lastResolved();if(a&&a[0]&&a[0].route===e.match.route&&a[0].url===e.match.url&&a[0].queryString===e.match.queryString){a.forEach(function(n){n.route.hooks&&n.route.hooks.already&&Ie(e.navigateOptions,"callHooks")&&n.route.hooks.already.forEach(function(o){return o(e.match)})}),t(!1);return}t()}function uo(e,t){var a=e.instance._notFoundRoute;if(a){e.notFoundHandled=!0;var n=tt(e.currentLocationPath),o=n[0],r=n[1],s=et(e.to);a.path=D(o);var i={url:a.path,queryString:r,hashString:s,data:null,route:a,params:r!==""?Dt(r):null};e.matches=[i],e.match=i}t()}function mo(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function go(e,t){e.instance._setCurrent(null),t()}function ja(e,t){Ie(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var Ya=[po,io,lo,co],Zt=[qa,uo,ue.if(function(e){var t=e.notFoundHandled;return t},Ya.concat([ja]),[mo,go])];function Et(){return Et=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},Et.apply(this,arguments)}function ea(e,t){var a=0;function n(){if(a===e.matches.length){ja(e,t);return}ue(Ya,Et({},e,{match:e.matches[a]}),function(){a+=1,n()})}qa(e,n)}function ft(e){e.instance.__markAsClean(e)}function St(){return St=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},St.apply(this,arguments)}var ta="[data-navigo]";function ho(e,t){var a=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:ta},n=this,o="/",r=null,s=[],i=!1,l,c=Va(),f=Bt();e?o=D(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function y(u){return u.indexOf("#")>=0&&(a.hash===!0?u=u.split("#")[1]||"/":u=u.split("#")[0]),u}function m(u){return D(o+"/"+D(u))}function b(u,_,L,M){return u=Ze(u)?m(u):u,{name:M||D(String(u)),path:u,handler:_,hooks:ao(L)}}function k(u,_,L){var M=this;return typeof u=="object"&&!(u instanceof RegExp)?(Object.keys(u).forEach(function($){if(typeof u[$]=="function")M.on($,u[$]);else{var ne=u[$],H=ne.uses,qe=ne.as,Oe=ne.hooks;s.push(b($,H,[l,Oe],qe))}}),this):(typeof u=="function"&&(L=_,_=u,u=o),s.push(b(u,_,[l,L])),this)}function g(u,_){if(n.__dirty){n.__waiting.push(function(){return n.resolve(u,_)});return}else n.__dirty=!0;u=u?D(o)+"/"+D(u):void 0;var L={instance:n,to:u,currentLocationPath:u,navigateOptions:{},resolveOptions:St({},a,_)};return ue([Xt,ht,ue.if(function(M){var $=M.matches;return $&&$.length>0},ea,Zt)],L,ft),L.matches?L.matches:!1}function h(u,_){if(n.__dirty){n.__waiting.push(function(){return n.navigate(u,_)});return}else n.__dirty=!0;u=D(o)+"/"+D(u);var L={instance:n,to:u,navigateOptions:_||{},resolveOptions:_&&_.resolveOptions?_.resolveOptions:a,currentLocationPath:y(u)};ue([no,oo,ht,ue.if(function(M){var $=M.matches;return $&&$.length>0},ea,Zt),so,ft],L,ft)}function v(u,_,L){var M=ge(u,_);return M!==null?(h(M.replace(new RegExp("^/?"+o),""),L),!0):!1}function x(u){return this.routes=s=s.filter(function(_){return Ze(u)?D(_.path)!==D(u):Zn(u)?u!==_.handler:String(_.path)!==String(u)}),this}function I(){c&&(this.__popstateListener=function(){n.__freezeListening||g()},window.addEventListener("popstate",this.__popstateListener))}function R(){this.routes=s=[],c&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=i=!0}function W(u,_){return n._notFoundRoute=b("*",u,[l,_],"__NOT_FOUND__"),this}function V(){if(f)return ae().forEach(function(u){if(u.getAttribute("data-navigo")==="false"||u.getAttribute("target")==="_blank"){u.hasListenerAttached&&u.removeEventListener("click",u.navigoHandler);return}u.hasListenerAttached||(u.hasListenerAttached=!0,u.navigoHandler=function(_){if((_.ctrlKey||_.metaKey)&&_.target.tagName.toLowerCase()==="a")return!1;var L=u.getAttribute("href");if(typeof L>"u"||L===null)return!1;if(L.match(/^(http|https)/)&&typeof URL<"u")try{var M=new URL(L);L=M.pathname+M.search}catch{}var $=to(u.getAttribute("data-navigo-options"));i||(_.preventDefault(),_.stopPropagation(),n.navigate(D(L),$))},u.addEventListener("click",u.navigoHandler))}),n}function ae(){return f?[].slice.call(document.querySelectorAll(a.linksSelector||ta)):[]}function le(u){return"/"+o+"/"+D(u)}function Z(u){return l=u,this}function fe(){return r}function ge(u,_,L){var M=s.find(function(H){return H.name===u}),$=null;if(M){if($=M.path,_)for(var ne in _)$=$.replace(":"+ne,_[ne]);$=$.match(/^\//)?$:"/"+$}return $&&L&&!L.includeRoot&&($=$.replace(new RegExp("^/"+o),"")),$}function w(u){return u.getAttribute("href")}function N(u){var _=tt(D(u)),L=_[0],M=_[1],$=M===""?null:Dt(M),ne=et(u),H=b(L,function(){},[l],L);return{url:L,queryString:M,hashString:ne,route:H,data:null,params:$}}function ce(){return N(D(za(o)).replace(new RegExp("^"+o),""))}function Ve(u){var _={instance:n,currentLocationPath:u,to:u,resolveOptions:a};return ht(_,function(){}),_.matches?_.matches:!1}function gt(u,_,L){typeof _<"u"&&(typeof L>"u"||L)&&(_=m(_));var M={instance:n,to:_,currentLocationPath:_};Xt(M,function(){}),typeof u=="string"&&(u=typeof L>"u"||L?m(u):u);var $=Ga(M,{name:String(u),path:u,handler:function(){},hooks:{}});return $||!1}function Ne(u,_,L){return typeof _=="string"&&(_=C(_)),_?(_.hooks[u]||(_.hooks[u]=[]),_.hooks[u].push(L),function(){_.hooks[u]=_.hooks[u].filter(function(M){return M!==L})}):(console.warn("Route doesn't exists: "+_),function(){})}function C(u){return typeof u=="string"?s.find(function(_){return _.name===m(u)}):s.find(function(_){return _.handler===u})}function q(u){u.instance.__dirty=!1,u.instance.__waiting.length>0&&u.instance.__waiting.shift()()}this.root=o,this.routes=s,this.destroyed=i,this.current=r,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=q,this.on=k,this.off=x,this.resolve=g,this.navigate=h,this.navigateByName=v,this.destroy=R,this.notFound=W,this.updatePageLinks=V,this.link=le,this.hooks=Z,this.extractGETParameters=function(u){return tt(y(u))},this.lastResolved=fe,this.generate=ge,this.getLinkPath=w,this.match=Ve,this.matchLocation=gt,this.getCurrentLocation=ce,this.addBeforeHook=Ne.bind(this,"before"),this.addAfterHook=Ne.bind(this,"after"),this.addAlreadyHook=Ne.bind(this,"already"),this.addLeaveHook=Ne.bind(this,"leave"),this.getRoute=C,this._pathToMatchObject=N,this._clean=D,this._checkForAHash=y,this._setCurrent=function(u){return r=n.current=u},I.call(this),V.call(this)}var fo=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function vo(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Ue={exports:{}},_o=Ue.exports,aa;function bo(){return aa||(aa=1,(function(e,t){(function(a,n){var o={};a.PubSub?(o=a.PubSub,console.warn("PubSub already loaded, using existing version")):(a.PubSub=o,n(o)),e!==void 0&&e.exports&&(t=e.exports=o),t.PubSub=o,e.exports=t=o})(typeof window=="object"&&window||_o||fo,function(a){var n={},o=-1,r="*";function s(g){var h;for(h in g)if(Object.prototype.hasOwnProperty.call(g,h))return!0;return!1}function i(g){return function(){throw g}}function l(g,h,v){try{g(h,v)}catch(x){setTimeout(i(x),0)}}function c(g,h,v){g(h,v)}function f(g,h,v,x){var I=n[h],R=x?c:l,W;if(Object.prototype.hasOwnProperty.call(n,h))for(W in I)Object.prototype.hasOwnProperty.call(I,W)&&R(I[W],g,v)}function y(g,h,v){return function(){var I=String(g),R=I.lastIndexOf(".");for(f(g,g,h,v);R!==-1;)I=I.substr(0,R),R=I.lastIndexOf("."),f(g,I,h,v);f(g,r,h,v)}}function m(g){var h=String(g),v=!!(Object.prototype.hasOwnProperty.call(n,h)&&s(n[h]));return v}function b(g){for(var h=String(g),v=m(h)||m(r),x=h.lastIndexOf(".");!v&&x!==-1;)h=h.substr(0,x),x=h.lastIndexOf("."),v=m(h);return v}function k(g,h,v,x){g=typeof g=="symbol"?g.toString():g;var I=y(g,h,x),R=b(g);return R?(v===!0?I():setTimeout(I,0),!0):!1}a.publish=function(g,h){return k(g,h,!1,a.immediateExceptions)},a.publishSync=function(g,h){return k(g,h,!0,a.immediateExceptions)},a.subscribe=function(g,h){if(typeof h!="function")return!1;g=typeof g=="symbol"?g.toString():g,Object.prototype.hasOwnProperty.call(n,g)||(n[g]={});var v="uid_"+String(++o);return n[g][v]=h,v},a.subscribeAll=function(g){return a.subscribe(r,g)},a.subscribeOnce=function(g,h){var v=a.subscribe(g,function(){a.unsubscribe(v),h.apply(this,arguments)});return a},a.clearAllSubscriptions=function(){n={}},a.clearSubscriptions=function(h){var v;for(v in n)Object.prototype.hasOwnProperty.call(n,v)&&v.indexOf(h)===0&&delete n[v]},a.countSubscriptions=function(h){var v,x,I=0;for(v in n)if(Object.prototype.hasOwnProperty.call(n,v)&&v.indexOf(h)===0){for(x in n[v])I++;break}return I},a.getSubscriptions=function(h){var v,x=[];for(v in n)Object.prototype.hasOwnProperty.call(n,v)&&v.indexOf(h)===0&&x.push(v);return x},a.unsubscribe=function(g){var h=function(le){var Z;for(Z in n)if(Object.prototype.hasOwnProperty.call(n,Z)&&Z.indexOf(le)===0)return!0;return!1},v=typeof g=="string"&&(Object.prototype.hasOwnProperty.call(n,g)||h(g)),x=!v&&typeof g=="string",I=typeof g=="function",R=!1,W,V,ae;if(v){a.clearSubscriptions(g);return}for(W in n)if(Object.prototype.hasOwnProperty.call(n,W)){if(V=n[W],x&&V[g]){delete V[g],R=g;break}if(I)for(ae in V)Object.prototype.hasOwnProperty.call(V,ae)&&V[ae]===g&&(delete V[ae],R=!0)}return R}})})(Ue,Ue.exports)),Ue.exports}var yo=bo();const d=vo(yo),p=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV.GO",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN.GO",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP.GO",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT.GO",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT.GO",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH.GO",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",AUTH_SCOPE_LOADED:"AUTH.SCOPE.LOADED",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",M5T_SIDE_NAV:"M5T_SIDE_NAV",M5T_SIDE_NAV_TAP:"M5T_SIDE_NAV.TAP",M5T_SIDE_NAV_COLLAPSE:"M5T_SIDE_NAV.COLLAPSE",M5T_SIDE_NAV_LOGO_TAP:"M5T_SIDE_NAV.LOGO_TAP",M5T_SIDE_NAV_ORG_SWITCH:"M5T_SIDE_NAV.ORG_SWITCH",M5T_SIDE_NAV_FOOTER_ACTION:"M5T_SIDE_NAV.FOOTER_ACTION",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL",MESSAGE:"MESSAGE",MESSAGE_CREATE:"MESSAGE.CREATE",MESSAGE_CREATED:"MESSAGE.CREATED",MESSAGE_EDIT:"MESSAGE.EDIT",MESSAGE_UPDATED:"MESSAGE.UPDATED",MESSAGE_DELETE:"MESSAGE.DELETE",MESSAGE_DELETED:"MESSAGE.DELETED",MESSAGE_REFRESH:"MESSAGE.REFRESH"}),vt={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://machfivemagnet-saas.onrender.com"};var _t={};const P=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_USER_PREFS:"mvv_user_prefs",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_LS_LAST_ROUTE:"mvv_last_route",FF_SSE_API_DEBUG_LOGGING:!1,FF_SSE_API_TIMEOUT:3e4,FF_SSE_API_MAX_RETRIES:3,FF_SSE_API_CACHE_ENABLED:!0,FF_SSE_AUTH_TOKEN_EXPIRY_HOURS:6,FF_SSE_AUTH_AUTO_REFRESH:!1,FF_SSE_AUTH_SESSION_WARNING_MINUTES:5,FF_SSE_AUTH_REMEMBER_ME:!0,FF_SSE_AUTH_MAX_LOGIN_ATTEMPTS:5,FF_SSE_UI_TOAST_ENABLED:!0,FF_SSE_UI_TOAST_DURATION:5e3,FF_SSE_UI_LOADING_SPINNERS:!0,FF_SSE_UI_DARK_MODE:!1,FF_SSE_UI_ANIMATIONS:!0,FF_SSE_FEATURE_SIGNUP_ENABLED:!0,FF_SSE_FEATURE_PASSWORD_RESET_ENABLED:!0,FF_SSE_FEATURE_EMAIL_VERIFICATION_ENABLED:!0,FF_SSE_FEATURE_PROFILE_EDIT_ENABLED:!0,FF_SSE_FEATURE_ANALYTICS_ENABLED:!1,FF_SSE_CACHE_TTL_MS:3e5,FF_SSE_COMPRESSION_ENABLED:!0,FF_SSE_MAX_PAYLOAD_SIZE_MB:50,FF_SSE_DEBUG_VERBOSE:!1,FF_SSE_DEBUG_REDUX_DEVTOOLS:!1,FF_SSE_DEBUG_PERFORMANCE:!1,FF_SSE_DEBUG_BYPASS_AUTH:!1,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_BUILD_MODE:"LOCAL",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel"});function Wa(e,t=null){if(e in P)return P[e];if(typeof process<"u"&&_t&&_t[e]){const a=_t[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}if(typeof import.meta<"u"&&vt&&vt[e]){const a=vt[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}return t}function wo(e){return Wa(e,!1)===!0}function xo(){return{...P}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:P,getFlag:Wa,isEnabled:wo,getAllFlags:xo});function Eo(){const e=t=>a=>{const n=a.detail?.pubsubTopic;n&&d.publish(n,a.detail)};document.addEventListener("nav-select",e()),document.addEventListener("logo-click",e()),document.addEventListener("nav-hover",e()),document.addEventListener("nav-double-tap",e()),document.addEventListener("nav-long-tap",e()),document.addEventListener("message-sent",e())}function So(){console.log("[AppEvents] Initializing event listeners..."),d.subscribe(p.APP_READY,(a,n)=>{console.log("[AppEvents] APP_READY:",n)}),d.subscribe(p.APP_ERROR,(a,n)=>{console.error("[AppEvents] APP_ERROR:",n)}),d.subscribe(p.APP_SIGNOUT,(a,n)=>{console.log("[AppEvents] APP_SIGNOUT:",n)}),d.subscribe(p.ROUTE_NAV_BEFORE,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",n),d.publish(p.UI_LOADING_START)}),d.subscribe(p.ROUTE_NAV_AFTER,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",n),d.publish(p.UI_LOADING_END)}),d.subscribe(p.ROUTE_NAV_ERROR,(a,n)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",n),d.publish(p.APP_ERROR,{message:"Navigation error",details:n})}),d.subscribe(p.AUTH_SIGNIN_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",n)}),d.subscribe(p.AUTH_SIGNIN_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",n),d.publish(p.UI_TOAST,{message:n.message||"Sign in failed",type:"danger"})}),d.subscribe(p.AUTH_SIGNUP_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",n),d.publish(p.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"}),d.publish(p.AUTH_VERIFY_LINK)}),d.subscribe(p.AUTH_VERIFY_LINK,(a,n)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),d.subscribe(p.AUTH_SIGNUP_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",n),d.publish(p.UI_TOAST,{message:n.message||"Sign up failed",type:"danger"})}),d.subscribe(p.AUTH_SIGNOUT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",n),d.publish(p.UI_TOAST,{message:"Signed out successfully",type:"info"})}),d.subscribe(p.AUTH_SIGNUP,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),d.subscribe(p.AUTH_FORGOT,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),d.subscribe(p.AUTH_FORGOT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",n),d.publish(p.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),d.subscribe(p.AUTH_RESETHASH_NAV,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),d.subscribe(p.AUTH_RESETHASH_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",n),d.publish(p.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),d.subscribe(p.AUTH_TOKEN_EXPIRED,(a,n)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",n),d.publish(p.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),d.subscribe(p.I18N_SET_LANG,(a,n)=>{console.log("[AppEvents] I18N_SET_LANG:",n);const{langCode:o}=n;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),d.publish(p.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(r){console.error("[AppEvents] Error changing language:",r),d.publish(p.UI_TOAST,{message:`Failed to change language: ${r.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),d.subscribe("CONVERSATION.PROMPT",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",n.message),bt(n.message,"user",n.timestamp),d.publish(p.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Agent prompt (no implementation):",n.message);break;case"AGENT_CANVAS":console.log("[AppEvents] Display message in canvas:",n.message),bt(n.message,"user",n.timestamp),d.publish(p.CANVAS_DO_SCROLL);break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),d.subscribe("CONVERSATION.RESPONSE",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",n.message),bt(n.message,"assistant",n.timestamp,n.streaming);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),d.subscribe(p.UI_LOADING_START,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),d.subscribe(p.UI_LOADING_END,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),d.subscribe(p.UI_TOAST,(a,n)=>{console.log("[AppEvents] UI_TOAST:",n)}),d.subscribe(p.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const a="0.1",n=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${a} 7/27/2026, 12:02:24 PM|© ${n} Mach Five Tech`,"night")}),Eo(),d.subscribe("M5T_PRIMARY_NAV",(a,n)=>{const o=a.split(".")[1];switch(o){case"TAP":e(n);break;case"LOGO_TAP":t();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function e(a){const{token:n,level:o,primaryToken:r}=a;switch(n){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),d.publish(p.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${n}`,{primaryToken:r});break}}function t(a){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 7/27/2026, 12:02:24 PM|© ${o} Mach Five Tech`,"night",5e3)}d.subscribe(p.AUTH_SIGNOUT,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(P.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function bt(e,t="user",a=null,n=!1){const o=document.getElementById("chat-messages");if(!o){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}if(a||(a=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})),n&&t==="assistant"){const s=o.firstElementChild;if(s&&s.tagName.toLowerCase()==="m5t-chat-response"){s.setAttribute("message",e),console.log(`[AppEvents] Updated streaming ${t} bubble (${e.length} chars)`);return}}let r;t==="user"||t==="prompt"?r=document.createElement("m5t-chat-prompt"):r=document.createElement("m5t-chat-response"),r.setAttribute("message",e),r.setAttribute("timestamp",a),o.prepend(r),console.log(`[AppEvents] Added ${t} bubble to canvas (${e.length} chars)`)}const Ao=Object.freeze({admin_root_role:{value:100,desc:"Administrator superuser infrastructure architecture"},admin_business_role:{value:90,desc:"Administrator financial oversight"},admin_support_role:{value:80,desc:"Administrator maintenance and configuration"},admin_readonly_role:{value:70,desc:"Administrator information help desk"},client_tier_3_role:{value:30,desc:"Client paid tier 3"},client_tier_2_role:{value:20,desc:"Client paid tier 2"},client_tier_1_role:{value:10,desc:"Client paid tier 1"},client_standard_role:{value:0,desc:"Client free tier 0"}});function To(e){return Ao[e]||null}function ko(e){return e>=50}const He=Object.freeze({owner:{value:"owner",rank:30,label:"Owner"},admin:{value:"admin",rank:20,label:"Admin"},member:{value:"member",rank:10,label:"Member"},viewer:{value:"viewer",rank:0,label:"Viewer"}}),Co=Object.freeze({VIEW_DASHBOARD:"view_dashboard",VIEW_MAGNETS:"view_magnets",PROVISION_MAGNETS:"provision_magnets",MANAGE_MAGNETS:"manage_magnets",VIEW_CONVERSATIONS:"view_conversations",VIEW_STATS:"view_stats",VIEW_AD_METRICS:"view_ad_metrics",CONNECT_AD_ACCOUNTS:"connect_ad_accounts",CREATE_CLIENT_ACCOUNTS:"create_client_accounts",MANAGE_TEAM:"manage_team",VIEW_BILLING:"view_billing",MANAGE_BILLING:"manage_billing"}),E=Co,Ka=Object.freeze(Object.values(E)),ye=Object.freeze([E.VIEW_DASHBOARD,E.VIEW_MAGNETS,E.VIEW_CONVERSATIONS,E.VIEW_STATS,E.VIEW_AD_METRICS]),Io=Object.freeze({reseller_org:{owner:Ka,admin:[E.VIEW_DASHBOARD,E.VIEW_MAGNETS,E.PROVISION_MAGNETS,E.MANAGE_MAGNETS,E.VIEW_CONVERSATIONS,E.VIEW_STATS,E.VIEW_AD_METRICS,E.CONNECT_AD_ACCOUNTS,E.CREATE_CLIENT_ACCOUNTS,E.MANAGE_TEAM,E.VIEW_BILLING],member:[E.VIEW_DASHBOARD,E.VIEW_MAGNETS,E.PROVISION_MAGNETS,E.MANAGE_MAGNETS,E.VIEW_CONVERSATIONS,E.VIEW_STATS,E.VIEW_AD_METRICS],viewer:ye},managed_client:{owner:[...ye,E.VIEW_BILLING],admin:[...ye,E.VIEW_BILLING],member:ye,viewer:ye},saas_org:{owner:[E.VIEW_DASHBOARD,E.VIEW_MAGNETS,E.PROVISION_MAGNETS,E.MANAGE_MAGNETS,E.VIEW_CONVERSATIONS,E.VIEW_STATS,E.VIEW_AD_METRICS,E.CONNECT_AD_ACCOUNTS,E.MANAGE_TEAM,E.VIEW_BILLING,E.MANAGE_BILLING],admin:[E.VIEW_DASHBOARD,E.VIEW_MAGNETS,E.PROVISION_MAGNETS,E.MANAGE_MAGNETS,E.VIEW_CONVERSATIONS,E.VIEW_STATS,E.VIEW_AD_METRICS,E.CONNECT_AD_ACCOUNTS,E.MANAGE_TEAM,E.VIEW_BILLING],member:[E.VIEW_DASHBOARD,E.VIEW_MAGNETS,E.PROVISION_MAGNETS,E.MANAGE_MAGNETS,E.VIEW_CONVERSATIONS,E.VIEW_STATS],viewer:ye}});function Lo(e){const t=To(e);return!!t&&ko(t.value)}function No({entityClass:e,orgChannel:t,memberRole:a}={}){if(Lo(e))return e==="admin_readonly_role"?[...ye,E.VIEW_BILLING]:[...Ka];const n=Io[t],o=n&&n[a];return o?[...o]:[]}function Oo(e,t){const a=He[e]?.rank??-1,n=He[t]?.rank??1/0;return a>=He.admin.rank&&a>=n}class A{static CONFIG={BASE_URL:"https://machfivemagnet-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink",SCOPE:"sse_session_scope",ACTIVE_ORG:"sse_active_org"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",ME:"/m5t/v5/acctEntity/me",PING:"/ping"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#o=null;static#a=null;static#n=!1;static#r=null;static#i=null;static async init({BASE_URL:t,navigateFunction:a,customConfig:n={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(a&&typeof a=="function")this.#i=a;else throw new Error("navigateFunction is required and must be a function");return t&&(this.CONFIG.BASE_URL=t),n&&Object.keys(n).length>0&&(this.CONFIG={...this.CONFIG,...n}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#m(),this.#p(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#p(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((t=null)=>{if(t){if((window.location.hash||"").startsWith("#/accept-invite")&&(t==="splash"||t==="signin")){console.log("[AuthController] Ignoring mvvLegit redirect to",t,"— keeping invitee on accept-invite");return}console.log("[AuthController] mvvLegit navigation to:",t),this.#s(t)}}).setOnState((t=null)=>{if(t)switch(console.log("[AuthController] Auth state changed:",t),t){case"AUTH":case 4:this.#_();break;case"UNAUTH":case 1:this.#b();break;case"UNVERF":case 2:this.#y();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#s(t){if(!this.#i){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",t);const a=t.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",a),this.#i(a)}static#l(){if(window.__m5tActiveOrgFetch)return;const t=window.fetch.bind(window);window.fetch=(a,n)=>{try{const o=typeof a=="string"?a:a?.url||"",r=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);if(r&&o.startsWith(this.CONFIG.BASE_URL)){const s=new Headers(n&&n.headers||(a instanceof Request?a.headers:void 0));s.set("X-Active-Org",r),n={...n||{},headers:s}}}catch{}return t(a,n)},window.__m5tActiveOrgFetch=!0,console.log("[AuthController] Active-org fetch header installed")}static#m(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);t&&(this.#o=JSON.parse(t),console.log("[AuthController] Entity state loaded:",this.#o?.email))}catch(t){console.error("[AuthController] Error loading entity state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#o=null}this.#r=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.SCOPE);t&&(this.#a=JSON.parse(t),console.log("[AuthController] Scope state loaded (cached):",this.#a?.uiMode))}catch(t){console.error("[AuthController] Error loading scope state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE),this.#a=null}}static#c(t){try{this.#o=t,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(t)),console.log("[AuthController] Entity state saved")}catch(a){console.error("[AuthController] Error saving entity state:",a)}}static#d(){this.#o=null,this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#u)}catch{}}static getEntity(){return this.#o}static#v(t){try{this.#a=t,localStorage.setItem(this.CONFIG.LS_KEYS.SCOPE,JSON.stringify(t))}catch(a){console.error("[AuthController] Error saving scope state:",a)}}static async fetchScope(){if(typeof mvvLegit>"u"||!this.isAuthenticated())return console.log("[AuthController] fetchScope skipped — not authenticated"),this.#a;if(this.#n)return this.#a;this.#n=!0;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),a=t?`?org=${encodeURIComponent(t)}`:"",n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.ME}${a}`);if(n.status===401||n.status===403)return console.warn("[AuthController] /me unauthorized — signing out"),this.doSignout(!0),null;if(!n.ok)return console.warn(`[AuthController] /me failed (${n.status}) — using cached scope`),this.#a;const o=await n.json();if(!o?.ok)return console.warn("[AuthController] /me returned not-ok — using cached scope"),this.#a;try{const r=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);r&&o.activeOrg?.guid!==r&&(console.warn("[AuthController] Stored active org not honored by /me — clearing"),localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG))}catch{}return this.#v(o),d.publish(p.AUTH_SCOPE_LOADED,o),console.log(`[AuthController] Scope loaded: ${o.uiMode} (${o.memberships?.length||0} org(s), ${o.managedClients?.length||0} client(s))`),o}catch(t){return console.error("[AuthController] fetchScope error:",t),this.#a}finally{this.#n=!1}}static async setActiveOrg(t){try{t?localStorage.setItem(this.CONFIG.LS_KEYS.ACTIVE_ORG,t):localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}return this.fetchScope()}static getScope(){return this.#a}static getCapabilities(){return this.isPreviewingAsClient()?No({orgChannel:"managed_client",memberRole:"owner"}):this.#a?.capabilities||[]}static getUiMode(){return this.isPreviewingAsClient()?"managed":this.#a?.uiMode||"self_serve"}static getActiveOrg(){return this.#a?.activeOrg||null}static getMemberships(){return this.#a?.memberships||[]}static getManagedClients(){return this.#a?.managedClients||[]}static getStoredActiveOrg(){try{return localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{return null}}static#u="m5m_preview_as_client";static isPreviewingAsClient(){try{return sessionStorage.getItem(this.#u)==="1"&&!!this.#a?.activeOrg?.viaSubtree}catch{return!1}}static setPreviewAsClient(t){try{t?sessionStorage.setItem(this.#u,"1"):sessionStorage.removeItem(this.#u)}catch{}this.#a&&d.publish(p.AUTH_SCOPE_LOADED,this.#a)}static async doSignin(t,a){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,hash:a})}),o=await n.json();if(n.status===303)return console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#c(o.entity)),setTimeout(()=>{this.#s(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o};if(n.ok&&o.accessToken){console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#c(o.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#u)}catch{}return this.fetchScope(),console.log("[AuthController] Explicitly navigating to home"),this.#s(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}}return{ok:!1,error:o.error||"Sign in failed",data:o}}catch(n){return console.error("[AuthController] Signin error:",n),{ok:!1,error:n.message}}}static async doSignout(t=!1){console.log("[AuthController] doSignout called, serverInitiated:",t);try{const a=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!a),!t&&a){const n=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(a)}`;if(console.log("[AuthController] Sending signout beacon to:",n),navigator.sendBeacon){const o=navigator.sendBeacon(n);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else a||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#d(),console.log("[AuthController] Stopping auth ping..."),this.#h(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(a){console.error("[AuthController] Signout error:",a),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(t){try{const a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await a.json();return a.ok&&n.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#c(n.entity),{ok:!0,data:n}):{ok:!1,error:n.error||"Sign up failed",data:n}}catch(a){return console.error("[AuthController] Signup error:",a),{ok:!1,error:a.message}}}static async doResetHash(t,a){try{const n=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({email:t,hash:a,modified_by:t})}),r=await o.json();return o.ok&&r.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:r}):{ok:!1,error:r.error||"Password reset failed",data:r}}catch(n){return console.error("[AuthController] Reset password error:",n),{ok:!1,error:n.message}}}static#g(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#f()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#h(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#f(){try{const t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);t.ok?console.log("[AuthController] Ping success"):(t.status===401||t.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(t){console.error("[AuthController] Ping error:",t)}}static setDeepLinkGuid(t){this.#r=t,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,t),console.log("[AuthController] Deep-link GUID stored:",t)}static getDeepLinkGuid(){return this.#r}static clearDeepLink(){this.#r=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#_(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.fetchScope()}static#b(){console.log("[AuthController] User unauthenticated"),this.#h()}static#y(){console.log("[AuthController] User unverified")}static getAuthState(){try{const t=mvvLegit.getConf()?.LSKEY||"mvv",a=localStorage.getItem(t);if(!a)return"UNAUTH";if(typeof LZString>"u")return null;const n=LZString.decompressFromUTF16(a),r=JSON.parse(n)?.state;return r===1?"UNAUTH":r===2?"UNVERF":r===4?"AUTH":r===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(t){this.#s(t)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#f()}}class T{static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_dashboard:"Dashboard",nav_dashboard_tagline:"Overview of your activity",nav_magnets:"Your Magnets",nav_magnets_tagline:"Manage your conversational magnets",nav_templates:"Templates",nav_templates_tagline:"Start from a magnet template",nav_conversations:"Conversations",nav_conversations_tagline:"Captured lead conversations",nav_ab_testing:"A/B Testing",nav_ab_testing_tagline:"Experiment and optimize",nav_analytics:"Analytics",nav_analytics_tagline:"Performance and ad metrics",nav_ad_accounts:"Ad Accounts",nav_ad_accounts_tagline:"Connect advertising accounts",nav_clients:"Clients",nav_clients_tagline:"Manage your client accounts",nav_team:"Team",nav_team_tagline:"Invite and manage teammates",nav_billing:"Billing",nav_billing_tagline:"Plan, usage, and invoices",nav_settings:"Settings",nav_settings_tagline:"Account and workspace settings",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Rollers",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Rollers",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"滚动器",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:t,product:a,whitelabel:n,lang:o}){t&&(this.#t.buildMode=t),a&&(this.#t.product=a),n&&(this.#t.whitelabel=n),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(t,a={}){const n={...this.#t,...a},{buildMode:o,product:r,whitelabel:s,lang:i}=n;try{const l=this.#e[o]?.[r]?.[s]?.[i]?.[t];return l?Array.isArray(l)?l[Math.floor(Math.random()*l.length)]:l:(console.warn(`[MicrocopyManager] Token not found: ${t} (${o}/${r}/${s}/${i})`),null)}catch(l){return console.error(`[MicrocopyManager] Error retrieving token: ${t}`,l),null}}static getAll(t={}){const a={...this.#t,...t},{buildMode:n,product:o,whitelabel:r,lang:s}=a;try{return this.#e[n]?.[o]?.[r]?.[s]||null}catch(i){return console.error("[MicrocopyManager] Error retrieving all tokens",i),null}}static has(t,a={}){const n={...this.#t,...a},{buildMode:o,product:r,whitelabel:s,lang:i}=n;try{return!!this.#e[o]?.[r]?.[s]?.[i]?.[t]}catch{return!1}}static getAvailableLanguages(){const{buildMode:t,product:a,whitelabel:n}=this.#t;try{return Object.keys(this.#e[t]?.[a]?.[n]||{})}catch{return[]}}static update(t,a,n={}){const o={...this.#t,...n},{buildMode:r,product:s,whitelabel:i,lang:l}=o;try{return this.#e[r]||(this.#e[r]={}),this.#e[r][s]||(this.#e[r][s]={}),this.#e[r][s][i]||(this.#e[r][s][i]={}),this.#e[r][s][i][l]||(this.#e[r][s][i][l]={}),this.#e[r][s][i][l][t]=a,!0}catch(c){return console.error(`[MicrocopyManager] Error updating token: ${t}`,c),!1}}static delete(t,a={}){const n={...this.#t,...a},{buildMode:o,product:r,whitelabel:s,lang:i}=n;try{return delete this.#e[o]?.[r]?.[s]?.[i]?.[t],!0}catch(l){return console.error(`[MicrocopyManager] Error deleting token: ${t}`,l),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(t){try{return this.#e=t,!0}catch(a){return console.error("[MicrocopyManager] Error importing data",a),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:T});class me{static#e=!1;static#t=null;static#o=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const t=this.#n();T.setContext(t),console.log("[I18nController] Initialized with context:",t),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),P.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#r(),this.#p(),this.#e=!0,this.refresh()}static#a(t){const a={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},n=t.toLowerCase();return a[n]||"DEV"}static#n(){const a=this.#a("production"),n=localStorage.getItem(P.FF_SSE_LS_WHITELABEL)||P.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(P.FF_SSE_LS_USER_LANG)||P.FF_SSE_I18N_LANG;return{buildMode:a,product:P.FF_SSE_I18N_PRODUCT,whitelabel:n,lang:o}}static#r(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((t,a,n)=>{P.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",n),this.#t=n,setTimeout(()=>{this.refresh()},P.FF_SSE_I18N_APPLY_DELAY_MS)},P.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#i())}static#i(){setInterval(()=>{const a=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");a&&a!==this.#t&&(this.#t=a,this.refresh())},500)}static#p(){this.#o||(this.#o=new MutationObserver(t=>{let a=!1;for(const n of t){for(const o of n.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){a=!0;break}if(a)break}a&&(P.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#o.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#s(document.body),this.#l(document.body),P.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#s(t){const a=t.querySelectorAll("[data-meta-copywrite-i118n]");P.FF_SSE_I18N_DEBUG&&a.length>0&&console.log(`[I18nController] Processing ${a.length} elements`),a.forEach(n=>{try{const o=n.getAttribute("data-meta-copywrite-i118n"),r=JSON.parse(o);if(!r.token){console.warn("[I18nController] Missing token in config:",r);return}const s=r.attribute||"textContent",i=T.get(r.token);if(i===null){console.warn(`[I18nController] Microcopy not found for token: ${r.token}`);return}s==="textContent"?n.textContent=i:s==="innerHTML"?n.innerHTML=i:n.setAttribute(s,i),P.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${i}" to ${s} for token: ${r.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,n)}})}static#l(t){t.querySelectorAll("*").forEach(n=>{n.shadowRoot&&(this.#s(n.shadowRoot),this.#l(n.shadowRoot))})}static setLanguage(t){const a=T.getAvailableLanguages();if(!a.includes(t)){console.error(`[I18nController] Language not available: ${t}. Available:`,a);return}localStorage.setItem(P.FF_SSE_LS_USER_LANG,t),T.setContext({lang:t}),console.log("[I18nController] Language changed to:",t);const n=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:t}});document.dispatchEvent(n),this.refresh()}static setWhitelabel(t){localStorage.setItem(P.FF_SSE_LS_WHITELABEL,t),T.setContext({whitelabel:t}),P.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",t),this.refresh()}static getLanguage(){return T.getContext().lang}static getAvailableLanguages(){return T.getAvailableLanguages()}static getContext(){return T.getContext()}static destroy(){this.#o&&(this.#o.disconnect(),this.#o=null),this.#e=!1,this.#t=null,P.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{me.initialize()}):me.initialize());class Ut{static _initialized=!1;static _debug=!1;static init(t={}){if(this._initialized)return console.warn("[MachVive] Already initialized, skipping duplicate initialization"),this;if(this._debug=t.debug||!1,!window.mvvSSEther)return console.error("[MachVive] mvvSSEther not found - cannot initialize bridge"),console.error("[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()"),this;console.log("[MachVive] Initializing SSE to PubSub bridge...");const a=n=>{this._handleSSEMessage(n)};return window.mvvSSEther.onmessage(a),this._initialized=!0,console.log("[MachVive] ✓ SSE to PubSub bridge initialized successfully"),console.log("[MachVive] ✓ Bound callback to mvvSSEther.onmessage"),this}static _handleSSEMessage(t){try{this._debug&&console.log("[MachVive] SSE message received:",t);const a=t?.data;if(!a){this._debug&&console.log("[MachVive] No data in message, skipping");return}const n=a.data||a.package||a;if(!n){this._debug&&console.log("[MachVive] No package found in message, skipping");return}let o=n.cfg;const r=n.msg;if(this._debug&&(console.log("[MachVive] cfg (raw):",o,"type:",typeof o,"length:",o?.length),console.log("[MachVive] msg (raw):",r)),typeof o=="string"){if(o.trim()===""){this._debug&&console.log("[MachVive] cfg is empty string, skipping");return}try{o=JSON.parse(o),console.log("[MachVive] cfg (parsed):",o)}catch(i){console.warn("[MachVive] Failed to parse cfg as JSON:",{cfg:o,cfgLength:o.length,error:i.message});return}}else if(!o){this._debug&&console.log("[MachVive] cfg is empty/null, skipping");return}const s=o?.topic;if(!s){this._debug&&console.log("[MachVive] No topic found in cfg, skipping");return}if(console.log("[MachVive] Extracted topic:",s),!this._isValidTopic(s)){console.warn(`[MachVive] Topic '${s}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(s,r,t,a)}catch(a){console.error("[MachVive] Error handling SSE message:",a)}}static _isValidTopic(t){return!p||!p.hasOwnProperty(t)?(console.warn(`[MachVive] Topic '${t}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(t,a,n,o){try{if(!window.PubSub&&typeof PubSub>"u"){console.error("[MachVive] PubSub not available");return}const r=window.PubSub||PubSub,s={message:a,metadata:{source:"sse",sseEventId:n.id,timestamp:n.timestamp,appGuid:o.app_guid,channelGuid:o.channel_guid,eventAction:o.event_action,status:o.status,class:o.class,raw:o}};console.log(`[MachVive] Publishing to topic '${t}':`,s);const i=p[t];console.log(`[MachVive] AppBroadcast.${t} = '${i}'`),r.publish(i,s),console.log(`[MachVive] ✓ Published SSE message to topic: ${t}`)}catch(r){console.error(`[MachVive] Error publishing to topic '${t}':`,r)}}static debug(t){return this._debug=t,console.log(`[MachVive] Debug mode ${t?"enabled":"disabled"}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log("[MachVive] Reset complete"),this}}typeof module<"u"&&module.exports&&(module.exports=Ut);typeof window<"u"&&(window.MachVive=Ut);const na="m5t_sidenav_collapsed",$o={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};class Ro extends HTMLElement{static get observedAttributes(){return["data-active-token","data-collapsed"]}constructor(){super(),this.attachShadow({mode:"open"}),this.items=[],this.orgs=[],this.activeOrgGuid=null,this.activeToken=null,this.footerBadge=null,this.loading=!1,this.lastFocus=null}#e=null;#t=t=>{if(this.getAttribute("data-open")==="true"){if(t.key==="Escape"){t.preventDefault(),this.closeDrawer();return}if(t.key==="Tab"){const a=this.#c();if(a.length<2)return;const n=a[0],o=a[a.length-1],r=this.shadowRoot.activeElement;t.shiftKey&&r===n?(t.preventDefault(),o.focus()):!t.shiftKey&&r===o&&(t.preventDefault(),n.focus())}}};#o=()=>{this.closeDrawer(),this.#d()};connectedCallback(){if(!this.hasAttribute("data-collapsed"))try{localStorage.getItem(na)==="true"&&this.setAttribute("data-collapsed","true")}catch{}this.activeToken=this.getAttribute("data-active-token")||null,this.render(),this.#l(),this.addEventListener("keydown",this.#t),this.#e=window.matchMedia("(max-width: 768px)"),this.#e.addEventListener("change",this.#o),this.#d()}disconnectedCallback(){this.removeEventListener("keydown",this.#t),this.#e?.removeEventListener("change",this.#o)}attributeChangedCallback(t,a,n){a===n||!this.shadowRoot||(t==="data-active-token"?(this.activeToken=n,this.#m()):t==="data-collapsed"&&this.shadowRoot.firstChild&&(this.render(),this.#l()))}setState({buttons:t,orgs:a,activeOrg:n,footerBadge:o,loading:r}={}){t!==void 0&&(this.items=Array.isArray(t)?t:this.#a(t)||[]),a!==void 0&&(this.orgs=Array.isArray(a)?a:this.#a(a)||[]),n!==void 0&&(this.activeOrgGuid=n||null),o!==void 0&&(this.footerBadge=o||null),r!==void 0&&(this.loading=!!r),this.shadowRoot&&(this.render(),this.#l())}setButtons(t){this.setState({buttons:t})}setOrgs(t){this.setState({orgs:t})}setActiveOrgGuid(t){this.setState({activeOrg:t})}setFooterBadge(t){this.setState({footerBadge:t})}setActiveToken(t){this.activeToken=t||null,this.#m()}toggleCollapsed(t){const a=typeof t=="boolean"?t:this.getAttribute("data-collapsed")!=="true";this.setAttribute("data-collapsed",String(a));try{localStorage.setItem(na,String(a))}catch{}this.dispatchEvent(new CustomEvent("nav-collapse",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_SIDE_NAV.COLLAPSE",collapsed:a,timestamp:Date.now()}}))}openDrawer(){this.lastFocus=this.shadowRoot.activeElement||document.activeElement,this.setAttribute("data-open","true"),this.shadowRoot.querySelector(".hamburger")?.setAttribute("aria-expanded","true"),this.#d(),(this.#c()[0]||this.shadowRoot.querySelector(".sidenav"))?.focus?.()}closeDrawer(){if(this.getAttribute("data-open")!=="true")return;this.removeAttribute("data-open");const t=this.shadowRoot.querySelector(".hamburger");t?.setAttribute("aria-expanded","false"),this.#d(),t&&this.#e?.matches?t.focus():this.lastFocus?.focus?.()}toggleDrawer(){this.getAttribute("data-open")==="true"?this.closeDrawer():this.openDrawer()}#a(t){try{return t?JSON.parse(t):null}catch(a){return console.error("[M5TSideNav] bad JSON:",a),null}}#n(t){return String(t??"").replace(/[&<>"']/g,a=>$o[a])}#r(t){return t?`<span class="ms" aria-hidden="true">${this.#n(t)}</span>`:""}#i(t){if(!t||!t.token)return"";const a=t.token===this.activeToken,n=t.route||"#",o=n.startsWith("#")?n:`#${n}`,r=typeof t.count=="number"&&t.count>0?`<span class="badge">${t.count}</span>`:"";return`
    ...
    <div class="ocb" role="status">
      ...
      <span>${n?`Previewing as <strong>${r}</strong> sees it — read-only client view`:`Viewing client: <strong>${r}</strong>`}</span>
      ...
      <button type="button" class="ocb-btn" data-ocb="preview">
        ...
        ${n?"Exit preview":"Preview as client"}
      </button>
      <button type="button" class="ocb-btn" data-ocb="portfolio">
        <span class="ms" aria-hidden="true">arrow_back</span> Back to portfolio
      </button>
    </div>`,t.querySelector('[data-ocb="preview"]')?.addEventListener("click",()=>{A.setPreviewAsClient(!A.isPreviewingAsClient()),Ja()}),t.querySelector('[data-ocb="portfolio"]')?.addEventListener("click",()=>{A.setPreviewAsClient(!1),A.setActiveOrg(null)})}function Qa(e){const t=document.getElementById("m5t-side-nav"),a=ze[`/${e}`]||ze[e]||null;t?.setActiveToken(a?.sectionToken||null),Bo(a)}function Bo(e){const t=document.getElementById("m5t-sub-nav"),a=document.getElementById("app-shell");if(!t)return;const n=e?.children;t.hidden=!1,n&&n.length>1?(t.updateButtons(n.map(o=>({token:o.token,caption:o.caption,enabled:!0,selected:o.token===e.childToken}))),a?.classList.add("has-sub-nav")):(t.updateButtons([]),a?.classList.remove("has-sub-nav"))}function Uo(){const e=me.getAvailableLanguages&&me.getAvailableLanguages()||[];if(e.length<2){d.publish(p.UI_TOAST,{message:"Only one language is available",type:"info"});return}const t=localStorage.getItem(P.FF_SSE_LS_USER_LANG)||P.FF_SSE_I18N_LANG||e[0],a=e[(e.indexOf(t)+1)%e.length];me.setLanguage(a),d.publish(p.UI_TOAST,{message:`Language: ${a}`,type:"info"})}function Ho(){const e=document.getElementById("m5t-side-nav");if(!e)return;ct.setAppToken("client-saas"),document.getElementById("app-shell")?.classList.toggle("nav-collapsed",e.getAttribute("data-collapsed")==="true"),e.addEventListener("nav-select",o=>{const r=o.detail?.route;r&&F.navigate(r.startsWith("/")?r:`/${r}`)}),e.addEventListener("logo-click",()=>F.navigate("/home")),e.addEventListener("nav-collapse",o=>{document.getElementById("app-shell")?.classList.toggle("nav-collapsed",!!o.detail?.collapsed)}),e.addEventListener("org-switch",o=>{const r=o.detail?.orgGuid;r&&A.setActiveOrg(r===Tt?null:r)}),e.addEventListener("footer-action",o=>{switch(o.detail?.action){case"account":F.navigate("/settings");break;case"signout":F.navigate("/signout");break;case"lang":Uo();break}}),document.getElementById("m5t-sub-nav")?.addEventListener("nav-select",o=>{const r=At[o.detail?.token];r&&F.navigate(r)}),document.addEventListener("language-changed",()=>yt()),yt(),d.subscribe(p.AUTH_SCOPE_LOADED,()=>yt());const a=()=>{const o=A.getScope();return[o?.uiMode,o?.activeOrg?.guid,(o?.managedClients||[]).length,(o?.capabilities||[]).join(",")].join("|")};let n=a();d.subscribe(p.AUTH_SCOPE_LOADED,()=>{const o=a();o!==n&&(n=o,Se&&!Ht.has(Se)&&Ja())})}function zo(e){Se=e;const t=document.getElementById("m5t-side-nav"),a=document.getElementById("app-shell");if(!t||!a)return;const n=!Ht.has(e);if(t.hidden=!n,a.classList.toggle("has-side-nav",n),n)Qa(e);else{const o=document.getElementById("m5t-sub-nav");o&&(o.hidden=!0),a.classList.remove("has-sub-nav")}Xa()}d.subscribe(p.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&zo(t.route)});const Za=()=>{console.log("[Router] Route: splash"),d.publish(p.ROUTE_NAV_BEFORE,{route:"splash"});const e=new URLSearchParams(window.location.search||""),t=!!(e.get("uid")&&e.get("token"));J(t?()=>Promise.resolve().then(()=>Wo):()=>Promise.resolve().then(()=>Xo),void 0).then(n=>{const o=document.getElementById("app");o.innerHTML=n.render(),n.init&&n.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"splash"})}).catch(n=>{console.error("[Router] Error loading splash route:",n),d.publish(p.ROUTE_NAV_ERROR,{route:"splash",error:n})})};F.on("/",Za);F.on("/splash",Za);F.on("/signin",()=>{console.log("[Router] Route: /signin"),d.publish(p.ROUTE_NAV_BEFORE,{route:"signin"}),J(()=>Promise.resolve().then(()=>nr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"signin"})}).catch(e=>{console.error("[Router] Error loading signin route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"signin",error:e})})});F.on("/signup",()=>{console.log("[Router] Route: /signup"),d.publish(p.ROUTE_NAV_BEFORE,{route:"signup"}),J(()=>Promise.resolve().then(()=>dr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"signup"})}).catch(e=>{console.error("[Router] Error loading signup route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"signup",error:e})})});F.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),d.publish(p.ROUTE_NAV_BEFORE,{route:"verf-link"}),J(()=>Promise.resolve().then(()=>mr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(e=>{console.error("[Router] Error loading verf-link route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"verf-link",error:e})})});F.on("/forgot",()=>{console.log("[Router] Route: /forgot"),d.publish(p.ROUTE_NAV_BEFORE,{route:"forgot"}),J(()=>Promise.resolve().then(()=>wr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(e=>{console.error("[Router] Error loading forgot route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"forgot",error:e})})});F.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!ie("resethash")){te("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"resethash"}),J(()=>Promise.resolve().then(()=>Sr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(e=>{console.error("[Router] Error loading resethash route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"resethash",error:e})})});F.on("/home",()=>{if(console.log("[Router] Route: /home"),!ie("home")){te("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"home"}),J(()=>Promise.resolve().then(()=>Mr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"home"})}).catch(e=>{console.error("[Router] Error loading home route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"home",error:e})})});F.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!ie("signout")){te("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"signout"}),J(()=>Promise.resolve().then(()=>Dr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"signout"})}).catch(e=>{console.error("[Router] Error loading signout route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"signout",error:e})})});const Go=[{path:"/templates",name:"templates",title:"Templates",icon:"content_copy"},{path:"/analytics",name:"analytics",title:"Analytics",icon:"monitoring"},{path:"/ad-accounts",name:"ad-accounts",title:"Ad Accounts",icon:"ads_click"},{path:"/billing",name:"billing",title:"Billing",icon:"receipt_long"},{path:"/settings",name:"settings",title:"Settings",icon:"settings"},{path:"/magnets/drafts",name:"magnets/drafts",title:"Magnets · Drafts",icon:"widgets"},{path:"/magnets/archived",name:"magnets/archived",title:"Magnets · Archived",icon:"widgets"},{path:"/analytics/conversions",name:"analytics/conversions",title:"Analytics · Conversions",icon:"monitoring"},{path:"/settings/workspace",name:"settings/workspace",title:"Settings · Workspace",icon:"settings"},{path:"/settings/integrations",name:"settings/integrations",title:"Settings · Integrations",icon:"settings"},{path:"/settings/security",name:"settings/security",title:"Settings · Security",icon:"settings"}];Go.forEach(({path:e,name:t,title:a,icon:n})=>{F.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!ie("home")){te("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:t}),J(()=>Promise.resolve().then(()=>Hr),void 0).then(o=>{const r=document.getElementById("app");r.innerHTML=o.render({title:a,icon:n,name:t}),o.init&&o.init({name:t}),d.publish(p.ROUTE_NAV_AFTER,{route:t})}).catch(o=>{console.error(`[Router] Error loading section route (${t}):`,o),d.publish(p.ROUTE_NAV_ERROR,{route:t,error:o})})})});F.on("/conversations",()=>{if(console.log("[Router] Route: /conversations"),!ie("home")){te("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"conversations"}),J(()=>Promise.resolve().then(()=>Xr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"conversations"})}).catch(e=>{console.error("[Router] Error loading conversations route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"conversations",error:e})})});F.on("/ab-testing",()=>{if(console.log("[Router] Route: /ab-testing"),!ie("home")){te("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"ab-testing"}),J(()=>Promise.resolve().then(()=>ps),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"ab-testing"})}).catch(e=>{console.error("[Router] Error loading ab-testing route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"ab-testing",error:e})})});F.on("/magnets",()=>{if(console.log("[Router] Route: /magnets"),!ie("home")){te("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"magnets"}),J(()=>Promise.resolve().then(()=>ei),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"magnets"})}).catch(e=>{console.error("[Router] Error loading magnets route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"magnets",error:e})})});F.on("/leads",()=>{if(console.log("[Router] Route: /leads"),!ie("home")){te("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"leads"}),J(()=>Promise.resolve().then(()=>ui),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"leads"})}).catch(e=>{console.error("[Router] Error loading leads route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"leads",error:e})})});F.on("/analytics/ad-performance",()=>{if(console.log("[Router] Route: /analytics/ad-performance"),!ie("home")){te("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"analytics/ad-performance"}),J(()=>Promise.resolve().then(()=>yi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"analytics/ad-performance"})}).catch(e=>{console.error("[Router] Error loading ad-performance route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"analytics/ad-performance",error:e})})});F.on("/clients",()=>{if(console.log("[Router] Route: /clients"),!ie("home")){te("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"clients"}),J(()=>Promise.resolve().then(()=>Ni),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"clients"})}).catch(e=>{console.error("[Router] Error loading clients route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"clients",error:e})})});F.on("/team",()=>{if(console.log("[Router] Route: /team"),!ie("home")){te("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"team"}),J(()=>Promise.resolve().then(()=>Ui),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"team"})}).catch(e=>{console.error("[Router] Error loading team route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"team",error:e})})});F.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),te("splash")});d.subscribe(p.ROUTE_NAV,(e,t)=>{console.log("[Router] ROUTE_NAV event received:",t),t?.route&&te(t.route)});function oa(){console.log("[App] Waiting for Neodigm 55 library...");let e=0;const t=100,a=setInterval(()=>{e++,e%10===0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(a),Vo()):e>=t&&(clearInterval(a),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
      ...
      `,d.publish(p.APP_ERROR,{message:"Failed to load authentication library"}))},100)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",oa):oa();async function Vo(){if(console.log("[App] Neodigm 55 loaded, initializing..."),So(),me.initialize(),console.log("[App] I18n Controller initialized"),!await A.init({BASE_URL:"https://machfivemagnet-saas.onrender.com",navigateFunction:a=>{console.log("[AuthController] Navigation requested:",a),te(a)}})){console.error("[App] AuthController initialization failed");return}const t=A.getEntity();t&&(console.log("[App] Session restored for:",t.email),d.publish(p.APP_USER_LOADED,{entity:t}),A.isAuthenticated()&&A.fetchScope()),d.publish(p.APP_READY,{timestamp:new Date().toISOString(),sessionUser:t}),Ho(),F.resolve(),window.AuthController=A,window.I18nController=me,window.MachVive=Ut,console.log("[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)")}d.subscribe(p.ROUTE_NAV_AFTER,(e,t)=>{typeof me<"u"&&me.refresh&&setTimeout(()=>{me.refresh()},100)});function dt(e){return e=String(e),Math.abs(e.split("").reduce((t,a)=>(t<<5)-t+a.charCodeAt(0)|0,0))}let ra=!1;function qo(){if(ra)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
    .accept-invite-page {
  ...
  `,document.head.appendChild(e),ra=!0}function jo(){const e=new URLSearchParams(window.location.search||"");let t=e.get("uid")||"",a=e.get("token")||"";if(!t||!a){const n=window.location.hash||"",o=n.includes("?")?n.slice(n.indexOf("?")+1):"",r=new URLSearchParams(o);if(t=t||r.get("uid")||"",a=a||r.get("token")||"",!t||!a){const s=n.replace(/^#\/?/,"").split("?")[0].split("/").filter(Boolean);t=t||s[1]||"",a=a||s[2]||""}}try{return{uid:decodeURIComponent(t),token:decodeURIComponent(a)}}catch{return{uid:t,token:a}}}function en(){return qo(),`
    ...
    </div>`}function tn(){const{uid:e,token:t}=jo(),a=document.getElementById("accept-invite-form"),n=document.getElementById("ai-pass"),o=document.getElementById("ai-confirm"),r=document.getElementById("ai-submit"),s=document.getElementById("ai-msg");if(!a)return;const i=(l,c="error")=>{s.textContent=l,s.className=`accept-invite-msg ${c}`};if(!e||!t){i("This invitation link is invalid or incomplete. Please use the link from your email."),r.disabled=!0;return}a.addEventListener("submit",async l=>{l.preventDefault();const c=n.value||"",f=o.value||"";if(c.length<8){i("Password must be at least 8 characters.");return}if(c!==f){i("Passwords do not match.");return}r.disabled=!0,i("Setting up your account…","ok");const y=dt(c);try{const m=A.getConfig?.().BASE_URL||"",b=await fetch(`${m}/m5t/v5/acctEntity/acceptInvite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({uid:e,token:t,hash:y})}),k=await b.json().catch(()=>({}));if(!b.ok||!k.ok){const h=b.status===410?"This invitation has expired. Ask for a new one.":b.status===409?"This invitation has already been used. Try signing in.":k.error||`Could not accept the invitation (HTTP ${b.status}).`;i(h),r.disabled=!1;return}try{window.history.replaceState({},"",window.location.pathname+window.location.hash)}catch{}i("Welcome! Signing you in…","ok"),(await A.doSignin(k.entity.email,y))?.ok||(i("Your account is ready. Please sign in.","ok"),setTimeout(()=>{window.location.hash="#/signin"},1200))}catch(m){console.error("[accept-invite] error:",m),i("Something went wrong. Please try again."),r.disabled=!1}})}const Yo={render:en,init:tn},Wo=Object.freeze(Object.defineProperty({__proto__:null,default:Yo,init:tn,render:en},Symbol.toStringTag,{value:"Module"}));function Ko(){return`
  ...
  `}function Jo(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const e=localStorage.getItem(P.FF_SSE_LS_TOKEN),t=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!e,hasMvvTs:!!t});const a=document.getElementById("splash-loader"),n=document.getElementById("splash-actions");e?(console.log("[SplashRoute] Auth token found → HOME"),d.publish(p.ROUTE_NAV,{route:"home"})):t?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),d.publish(p.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),a&&(a.style.display="none"),n&&(n.style.display="flex"),document.querySelectorAll("[data-route]").forEach(r=>{r.addEventListener("click",()=>{const s=r.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${s}`),d.publish(p.ROUTE_NAV,{route:s})})}))},4e3)}const Xo=Object.freeze(Object.defineProperty({__proto__:null,init:Jo,render:Ko},Symbol.toStringTag,{value:"Module"}));function Qo(){return`
  ...
  `}function Zo(){console.log("[SigninRoute] Initialized");const e=document.getElementById("loginForm"),t=document.getElementById("email"),a=document.getElementById("password");document.getElementById("togglePassword")?.addEventListener("click",()=>{const r=a.type==="password"?"text":"password";a.type=r}),e?.addEventListener("submit",async r=>{r.preventDefault();const s=t.value.trim(),i=a.value;er(s,t)&&tr(i,a)&&await ar(s,i)}),document.getElementById("link--uc__underline")?.addEventListener("click",r=>{r.preventDefault(),d.publish(p.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",r=>{r.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),d.publish(p.ROUTE_NAV,{route:"signup"})})}function er(e,t){if(!e)return at(t,T.get("validation_email_required")),!1;const a=(e.match(/@/g)||[]).length,n=(e.match(/\./g)||[]).length;return a!==1||n<1?(at(t,T.get("validation_email_invalid")),!1):!0}function tr(e,t){return e?e.length<10?(at(t,T.get("validation_password_min_length")),!1):!0:(at(t,T.get("validation_password_required")),!1)}function at(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}async function ar(e,t){const a=document.querySelector(".btn");a.disabled=!0,a.textContent=T.get("loading_signing_in");try{const n=dt(t),o=await A.doSignin(e,n);o.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(T.get("success_welcome_back"),"success"),d.publish(p.AUTH_SIGNIN_SUCCESS,{entity:A.getEntity()})):o.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q(T.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(o.error||T.get("error_signin_failed"),"danger"),a.disabled=!1,a.textContent=T.get("sign_in").toUpperCase())}catch(n){console.error("[SigninRoute] Sign in error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||T.get("error_network"),"danger"),a.disabled=!1,a.textContent=T.get("sign_in").toUpperCase(),d.publish(p.AUTH_SIGNIN_FAIL,{message:n.message})}}const nr=Object.freeze(Object.defineProperty({__proto__:null,init:Zo,render:Qo},Symbol.toStringTag,{value:"Module"}));function an(e){const t=[];return e.length<10&&t.push("at least 10 characters"),/[a-z]/.test(e)||t.push("1 lowercase"),/[A-Z]/.test(e)||t.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(e)||t.push("1 special character"),/[^\x00-\x7F]/.test(e)&&t.push("ASCII characters only"),t}function nn(e){return e.length===0?"":e.includes("ASCII characters only")?"Password cannot contain emoji|or special unicode characters":e.includes("at least 10 characters")?"Password must have at least|10 characters":"Password must have: Uppercase,|Lowercase, and Special Character"}const or="2026-07-15";function rr(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="/m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function sr(){console.log("[SignupRoute] Initialized");const e=document.getElementById("signupForm"),t=e.querySelector('button[type="submit"]');sa("togglePassword","password","eyeIcon"),sa("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),d.publish(p.ROUTE_NAV,{route:"signin"})}),e.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),r=document.getElementById("last").value.trim(),s=document.getElementById("email").value.trim(),i=document.getElementById("company").value.trim(),l=document.getElementById("phone").value.trim(),c=document.getElementById("password").value,f=document.getElementById("confirmPassword").value,y=document.getElementById("first"),m=document.getElementById("last"),b=document.getElementById("email"),k=document.getElementById("password"),g=document.getElementById("confirmPassword");if(!ia(o,y,T.get("validation_first_name_required"))||!ia(r,m,T.get("validation_last_name_required"))||!ir(s,b)||!lr(c,k))return;if(c!==f){Ae(g,T.get("validation_password_mismatch"));return}const h=document.getElementById("acceptTerms");if(!h.checked){Ae(h,"Please accept the Terms of Service and Privacy Policy to continue.");return}t.disabled=!0,t.textContent=T.get("loading_creating_account"),await cr(o,r,s,i,l,c)})}function sa(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),r=document.getElementById(a);!n||!o||!r||n.addEventListener("click",()=>{const s=o.type==="password";o.type=s?"text":"password",s?r.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:r.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function ia(e,t,a){return e?!0:(Ae(t,a),!1)}function ir(e,t){if(!e)return Ae(t,T.get("validation_email_required")),!1;const a=(e.match(/@/g)||[]).length,n=(e.match(/\./g)||[]).length;return a!==1||n<1?(Ae(t,T.get("validation_email_invalid")),!1):!0}function lr(e,t){if(!e)return Ae(t,T.get("validation_password_required")),!1;const a=an(e);return a.length>0?(Ae(t,nn(a)),!1):!0}function Ae(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}async function cr(e,t,a,n,o,r){const s=document.querySelector('button[type="submit"]');try{const i=dt(r),l={email:a,hash:i,first:e,last:t};n&&(l.company=n),o&&(l.phone=o),l.terms_accepted=!0,l.legal_version=or;const c=await A.doSignup(l);if(c.ok)d.publish(p.AUTH_SIGNUP_SUCCESS,{email:a}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const f=c.error||c.message||T.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(f,"danger"),s.disabled=!1,s.textContent=T.get("create_account").toUpperCase(),d.publish(p.AUTH_SIGNUP_FAIL,{message:f})}}catch(i){console.error("[SignupRoute] Sign up error:",i),typeof neodigmToast<"u"&&neodigmToast.q(i.message||T.get("error_network"),"danger"),s.disabled=!1,s.textContent=T.get("create_account").toUpperCase(),d.publish(p.AUTH_SIGNUP_FAIL,{message:i.message})}}const dr=Object.freeze(Object.defineProperty({__proto__:null,init:sr,render:rr},Symbol.toStringTag,{value:"Module"}));function pr(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="/m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function _r(){console.log("[ForgotRoute] Initialized");const e=document.getElementById("forgot-form"),t=document.getElementById("email");e?.addEventListener("submit",async a=>{a.preventDefault();const n=t.value.trim();br(n,t)&&await yr(n)})}function br(e,t){if(!e)return la(t,T.get("validation_email_required")),!1;const a=(e.match(/@/g)||[]).length,n=(e.match(/\./g)||[]).length;return a!==1||n<1?(la(t,T.get("validation_email_invalid")),!1):!0}function la(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}async function yr(e){const t=document.querySelector(".btn");t.disabled=!0,t.textContent="SENDING...";try{const a=await fr.forgotPassword(e);a.ok&&a.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q(T.get("success_reset_link_sent"),"success"),d.publish(p.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(a.data.error||T.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=T.get("send_reset_link").toUpperCase())}catch(a){console.error("[ForgotRoute] Forgot password error:",a),typeof neodigmToast<"u"&&neodigmToast.q(a.message||T.get("error_network"),"danger"),t.disabled=!1,t.textContent=T.get("send_reset_link").toUpperCase()}}const wr=Object.freeze(Object.defineProperty({__proto__:null,init:_r,render:vr},Symbol.toStringTag,{value:"Module"}));function xr(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function Er(){console.log("[ResethashRoute] Initialized");const e=document.getElementById("resethash-form"),t=e.querySelector('button[type="submit"]');ca("toggleNewPassword","new-password","eyeIconNew"),ca("toggleConfirmPassword","confirm-password","eyeIconConfirm"),e?.addEventListener("submit",async a=>{a.preventDefault();const n=e.email.value.trim(),o=e.newPassword.value,r=e.confirmPassword.value,s=document.getElementById("new-password"),i=document.getElementById("confirm-password");if(!o){$e(s,T.get("validation_new_password_required"));return}const l=an(o);if(l.length>0){$e(s,nn(l));return}if(!r){$e(i,T.get("validation_new_password_required"));return}if(o!==r){$e(i,T.get("validation_password_mismatch"));return}t.disabled=!0,t.textContent=T.get("loading_resetting_password");try{const c=dt(o),f=await A.doResetHash(n,c);f.ok?(typeof neodigmToast<"u"&&neodigmToast.q(T.get("success_password_reset"),"success"),d.publish(p.AUTH_RESETHASH_SUCCESS,{email:n})):($e(s,f.error||T.get("error_signin_failed")),t.disabled=!1,t.textContent=T.get("update_password").toUpperCase())}catch(c){console.error("[ResethashRoute] Reset password error:",c),$e(s,c.message||T.get("error_network")),t.disabled=!1,t.textContent=T.get("update_password").toUpperCase()}})}function ca(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),r=document.getElementById(a);!n||!o||!r||n.addEventListener("click",()=>{const s=o.type==="password";o.type=s?"text":"password",s?r.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:r.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function $e(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}const Sr=Object.freeze(Object.defineProperty({__proto__:null,init:Er,render:xr},Symbol.toStringTag,{value:"Module"})),oe=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,X=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),z=e=>Number(e||0).toLocaleString(),on=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",Ar=e=>(on(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function Tr(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric"})}catch{return""}}function kr(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}let da=!1;function Cr(){if(da)return;const e=document.createElement("style");e.id="m5t-dash-recent-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),da=!0}function Ir(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${X(Ar(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${X(on(e))}</span>
      <span class="recent-lead__sub">${X(e.email||e.phone||"")}</span>
    </span>
    <span class="recent-lead__badge" data-s="${X(e.status)}">${X(e.status)}</span>
    <span class="recent-lead__time">${X(Tr(e))}</span>
  </a>`}const je=({icon:e,label:t,valueId:a,value:n="—",subId:o,sub:r=""})=>`
  <div class="stat-card">
  ...
  </div>`,Ye=(e,t,a,{wide:n=!1,full:o=!1,controls:r=!1}={})=>`
  <div class="dashboard-card${n?" chart-card-wide":""}${o?" chart-card-full":""}">
  ...
  </div>`;let kt=30;const rn=()=>A.getManagedClients().length>0&&!A.getStoredActiveOrg();function sn(){Cr();const e=rn();return`
    <div class="page-shell" data-section="home">
      <div class="page-header">
        <div class="page-header-text">
          <h1 class="page-title">${e?"Portfolio":"Dashboard"}</h1>
          <p class="page-description">${e?"Across your book — every client’s magnets and lead performance, side by side.":"Your magnets, conversations, and lead performance at a glance."}</p>
        </div>
      ...
      <div class="stats-grid">
        ${je({icon:"widgets",label:"Active Magnets",valueId:"stat-active-magnets",subId:"stat-active-magnets-sub",sub:"Loading…"})}
        ${je({icon:"ads_click",label:"Magnet Opens",valueId:"stat-opens",subId:"stat-opens-sub",sub:"Loading…"})}
        ${je({icon:"person_add",label:"Leads Captured",valueId:"stat-leads",subId:"stat-leads-sub",sub:"Loading…"})}
        ${je({icon:"check_circle",label:"Completion Rate",valueId:"stat-completion",subId:"stat-completion-sub",sub:"Loading…"})}
      </div>

      <div class="charts-section">
        ${Ye("show_chart","Opens & Leads","dash-trend",{wide:!0,controls:!0})}
        <div class="charts-grid">
          ${Ye("filter_alt","Completion Funnel","dash-funnel")}
          ${Ye("source","Top Campaigns","dash-campaigns")}
          ${Ye("touch_app","CTA Usage","dash-routes",{full:!0})}
        </div>
      </div>
      ...
      <div class="content-grid">
    ...
    </div>`}async function ln(){const e=A.getConfig?.().BASE_URL||"";document.getElementById("dash-periods")?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(kt=Number(a.dataset.days)||30,document.querySelectorAll("#dash-periods .chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===kt)),ua(e))}),await Promise.all([ua(e),Or(e)])}const de=(e,t)=>{const a=document.getElementById(e);a&&(a.textContent=t)},Re=(e,t)=>{const a=document.getElementById(e);a&&(a.innerHTML=t)},pa=e=>e.toISOString().slice(0,10);async function ua(e){const t=new Date,a=pa(new Date(t.getTime()-(kt-1)*864e5)),n=pa(t),o=rn();let r;try{const x=await fetch(`${e}/m5t/v5/dashboard/stats?from=${a}&to=${n}${o?"&group_by=owner":""}`);if(!x.ok)throw new Error(`HTTP ${x.status}`);if(r=await x.json(),!r.ok)throw new Error("stats not ok")}catch(v){console.warn("[dashboard] stats fetch failed:",v),["stat-active-magnets","stat-opens","stat-leads","stat-completion"].forEach(x=>de(x,"—")),["stat-active-magnets-sub","stat-opens-sub","stat-leads-sub","stat-completion-sub"].forEach(x=>de(x,"Unavailable")),["dash-trend","dash-funnel","dash-campaigns","dash-routes","dash-interactions","dash-portfolio"].forEach(x=>Re(x,oe("error","Could not load. Please refresh.")));return}o&&Lr(r.by_owner||[]),de("stat-active-magnets",z(r.magnets.active)),de("stat-active-magnets-sub",r.magnets.total>r.magnets.active?`${z(r.magnets.total-r.magnets.active)} paused`:r.magnets.active?"All running":"No magnets yet");const s=r.funnel||{};de("stat-opens",s.opens?z(s.opens):"—"),de("stat-opens-sub",s.opens?s.engagement_rate!=null?`${s.engagement_rate}% engage`:`${z(s.engaged)} engaged`:"No opens in this range yet");const i=r.leads||{};de("stat-leads",z(i.total));const l=(i.this_week||0)-(i.prev_week||0);de("stat-leads-sub",i.total?`${z(i.this_week)} this week (${l>=0?"+":""}${z(l)} vs last)`:"No leads yet"),de("stat-completion",s.completion_rate!=null?`${s.completion_rate}%`:"—"),de("stat-completion-sub",s.opens?`${z(s.completions)} completed of ${z(s.opens)} opens`:"Appears once magnets get opened");const c=r.by_day||[],f=c.some(v=>v.opens||v.leads);Re("dash-trend",f?$r(c):oe("show_chart","No activity in this range yet. Opens and leads chart here as visitors engage your magnets.")),Re("dash-funnel",s.opens?Nr(s):oe("filter_alt","The funnel fills in once your magnets record opens."));const y=r.top_campaigns||[];Re("dash-campaigns",y.length?`<div class="dash-list">${y.map(v=>`
        <div class="dash-list__row">
          ...
          <span class="dash-list__main" title="${X(v.campaign)}">${X(v.campaign)}</span>
          <span class="dash-list__num">${z(v.leads)}</span>
        </div>`).join("")}</div>`:oe("source","No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here."));const m={book:["event","Book"],chat:["chat","Chat"],call:["phone_in_talk","Call"],email:["mail","Email"],support:["support_agent","Support"]},b=Object.entries(s.routes||{}).sort((v,x)=>x[1]-v[1]),k=b.length?b[0][1]:0;Re("dash-routes",b.length?`<div class="dash-funnel">${b.map(([v,x])=>{const[I,R]=m[v]||["touch_app",v];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${I}</span> ${X(R)}</span><span class="dash-funnel__val">${z(x)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${k?Math.max(4,Math.round(x/k*100)):0}%"></div></div>
        </div>`}).join("")}</div>`:oe("touch_app","CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar."));const g={open:["visibility","Magnet opened"],engage:["touch_app","Visitor engaged"],route:["alt_route","Picked a channel"],complete:["check_circle","Completed: lead captured"]},h=r.recent_events||[];Re("dash-interactions",h.length?`<div class="dash-list">${h.map(v=>{const[x,I]=g[v.event]||["sensors",v.event],R=v.event==="route"&&v.detail?` · ${X(v.detail)}`:"";return`<div class="dash-list__row">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">${x}</span></span>
          <span class="dash-list__main">${I}${R}</span>
          ${v.display_mode?`<span class="dash-list__mode">${X(v.display_mode)}</span>`:""}
          <span class="dash-list__time">${X(kr(v.at))}</span>
        </div>`}).join("")}</div>`:oe("sensors","No interactions yet. They'll stream in as visitors engage your magnets."))}function Lr(e){const t=document.getElementById("dash-portfolio");if(!t)return;if(!e.length){t.innerHTML=oe("groups","No client orgs yet. Create one under Clients to see its numbers here.");return}const a=e.some(s=>s.ad),n={reseller_org:"Your org",managed_client:"Client",saas_org:"Org"},o=s=>{const i=(s.leads.this_week||0)-(s.leads.prev_week||0);return!s.leads.this_week&&!s.leads.prev_week?"":` <span class="${i>=0?"dc-delta-up":"dc-delta-down"}">(${i>=0?"+":""}${z(i)})</span>`};t.innerHTML=`<div class="dash-clients-scroll"><table class="dash-clients">
    <thead><tr>
      <th>Client</th><th>Magnets</th><th>Leads · wk</th><th>Leads · total</th>
      <th>Opens</th><th>Compl.</th>${a?"<th>Spend</th><th>CPL</th>":""}<th></th>
    </tr></thead>
    <tbody>${e.map(s=>`
      <tr data-org="${X(s.owner_guid)}" tabindex="0" role="button"
          aria-label="Open ${X(s.name||"client")} dashboard">
        <td><span class="dc-name">${X(s.name||s.owner_guid)}
          <span class="dc-chip">${X(n[s.channel]||s.channel||"")}</span></span></td>
        <td>${z(s.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${z(s.magnets.total)}</span></td>
        <td>${z(s.leads.this_week)}${o(s)}</td>
        <td>${z(s.leads.total)}</td>
        <td>${z(s.opens)}</td>
        <td>${s.completion_rate!=null?`${s.completion_rate}%`:"—"}</td>
        ${a?`<td>${s.ad?`$${z(s.ad.spend)}`:"—"}</td>
        <td>${s.ad?.cost_per_lead!=null?`$${z(s.ad.cost_per_lead)}`:"—"}</td>`:""}
        <td><span class="dc-view">View →</span></td>
      </tr>`).join("")}</tbody>
  </table></div>`;const r=s=>{const i=s?.dataset?.org;i&&A.setActiveOrg(i)};t.querySelectorAll("tbody tr").forEach(s=>{s.addEventListener("click",()=>r(s)),s.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),r(s))})})}function Nr(e){const t=[["Opened",e.opens,""],["Engaged",e.engaged," dash-funnel__bar--mid"],["Completed",e.completions," dash-funnel__bar--end"]],a=Math.max(1,e.opens||0);return`<div class="dash-funnel">${t.map(([n,o,r])=>`
    ...
    </div>`).join("")}</div>`}async function Or(e){const t=document.getElementById("recent-leads-body");if(t)try{const a=await fetch(`${e}/m5t/v5/m5mLead`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json(),o=(Array.isArray(n?.data)?n.data:[]).filter(r=>!["DELETED","ARCHIVED"].includes(r.status));t.innerHTML=o.length?o.slice(0,5).map(Ir).join(""):oe("contacts","No leads captured yet. Publish a magnet to start collecting.")}catch(a){console.warn("[dashboard] Leads fetch failed:",a),t.innerHTML=oe("error","Could not load recent leads.")}}function ma(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}const ga=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e));function $r(e){const b=e.length||1,k=ma(Math.max(1,...e.map(w=>w.opens||0))),g=ma(Math.max(1,...e.map(w=>w.leads||0))),h=748/b,v=Math.min(22,h*.55),x=w=>46+h*(w+.5),I=w=>266-w/k*248,R=w=>266-w/g*248,W=[0,.5,1].map(w=>{const N=266-w*248;return`<line x1="46" y1="${N.toFixed(1)}" x2="794" y2="${N.toFixed(1)}" stroke="#EAF0F7"/><text x="38" y="${(N+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${ga(k*w)}</text><text x="802" y="${(N+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${ga(g*w)}</text>`}).join(""),V=e.map((w,N)=>{const ce=I(w.opens||0);return`<rect x="${(x(N)-v/2).toFixed(1)}" y="${ce.toFixed(1)}" width="${v.toFixed(1)}" height="${Math.max(0,266-ce).toFixed(1)}" rx="3" fill="#0072BA" opacity="0.85"><title>${w.date}: ${w.opens} opens</title></rect>`}).join(""),ae=e.map((w,N)=>`${x(N).toFixed(1)},${R(w.leads||0).toFixed(1)}`).join(" "),le=b>1?`<polyline points="${ae}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",Z=e.map((w,N)=>`<circle cx="${x(N).toFixed(1)}" cy="${R(w.leads||0).toFixed(1)}" r="3.2" fill="#009473"><title>${w.date}: ${w.leads} leads</title></circle>`).join(""),fe=Math.max(1,Math.ceil(b/6)),ge=e.map((w,N)=>N%fe===0||N===b-1?`<text x="${x(N).toFixed(1)}" y="288" text-anchor="middle" class="dash-ax">${w.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="dash-chart" viewBox="0 0 840 300" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Magnet opens versus leads over time">
      ${W}${V}${le}${Z}${ge}
    </svg>`}const Rr={render:sn,init:ln},Mr=Object.freeze(Object.defineProperty({__proto__:null,default:Rr,init:ln,render:sn},Symbol.toStringTag,{value:"Module"}));function Fr(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/home" aria-label="Mach Five Magnet">
          <img src="/m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function Pr(){console.log("[SignoutRoute] Initialized");const e=document.getElementById("confirm-signout-btn");e?.addEventListener("click",async()=>{e.disabled=!0,e.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await A.doSignout()})}const Dr=Object.freeze(Object.defineProperty({__proto__:null,init:Pr,render:Fr},Symbol.toStringTag,{value:"Module"}));let ha=!1;function Br(){if(ha)return;const e=document.createElement("style");e.id="m5t-section-page-styles",e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),ha=!0}function cn({title:e="Section",icon:t="widgets",name:a=""}={}){return Br(),`
    ...
    </section>`}function dn(){}const Ur={render:cn,init:dn},Hr=Object.freeze(Object.defineProperty({__proto__:null,default:Ur,init:dn,render:cn},Symbol.toStringTag,{value:"Module"})),zr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},G=e=>String(e??"").replace(/[&<>"']/g,t=>zr[t]),Ct=()=>A.getConfig?.().BASE_URL||"",wt=e=>Number(e||0).toLocaleString(),Y={conversations:[],counts:{},magnetNames:{},filter:"ALL"},fa={COMPLETED:{label:"Completed",icon:"check_circle"},IN_PROGRESS:{label:"In progress",icon:"pending"},ABANDONED:{label:"Abandoned",icon:"highlight_off"}},It={book:"Book",chat:"Chat",call:"Call",email:"Email",support:"Support"};function pn(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email)||null}function un(e){return(e.split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase()}function mn(e){try{return new Date(e).toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return""}}function Gr(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function gn(e){return e==null?"—":e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,"0")}s`}let va=!1;function Vr(){if(va)return;const e=document.createElement("style");e.id="m5t-convs-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),va=!0}const pt=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function hn(){return Vr(),`
    <div class="page-shell" data-section="conversations">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="convs-body">
          ${pt("hourglass_empty","Loading journeys…")}
        </div>
      </div>
    </div>`}async function fn(){await qr()}async function qr(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${Ct()}/m5t/v5/conversations`),fetch(`${Ct()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(Y.conversations=n.conversations||[],Y.counts=n.counts||{},a){const o=await a.json().catch(()=>({}));Y.magnetNames={},(o.magnets||[]).forEach(r=>{Y.magnetNames[r.guid]=r.name})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=pt("error","Could not load journeys. Please try again.");return}vn()}}function jr(){return Y.filter==="ALL"?Y.conversations:Y.conversations.filter(e=>e.status===Y.filter)}function Yr(e){const t=pn(e.lead),a=Y.magnetNames[e.magnet_guid]||"—",n=fa[e.status]||fa.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,r=(e.routes||[]).map(s=>It[s]||s).join(", ");return`
    <tr class="convs-row" data-session="${G(e.session)}">
      <td>
        <span class="convs-who">
          <span class="convs-ava${t?"":" anon"}">${t?G(un(t)):'<span class="material-symbols-outlined" style="font-size:16px">person_off</span>'}</span>
          <span><span class="convs-name">${t?G(t):'<span class="convs-muted">Anonymous visitor</span>'}</span>
            ${e.lead?.email?`<div class="convs-sub">${G(e.lead.email)}</div>`:r?`<div class="convs-sub">Picked: ${G(r)}</div>`:""}</span>
        </span>
      </td>
      <td><span class="convs-sub">${G(a)}</span></td>
      <td><span class="convs-badge" data-s="${G(e.status)}"><span class="material-symbols-outlined" aria-hidden="true">${n.icon}</span>${n.label}</span></td>
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${G(mn(e.started_at))}">${G(Gr(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${G(gn(e.duration_s))}</td>
    </tr>`}function vn(){const e=document.getElementById("convs-body");if(!e)return;if(!Y.conversations.length){e.innerHTML=pt("route","No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.");return}const t=jr(),a=[["ALL","All"],["COMPLETED","Completed"],["IN_PROGRESS","In progress"],["ABANDONED","Abandoned"]];e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${a.map(([n,o])=>`<button data-filter="${n}" class="${Y.filter===n?"active":""}">${o}${n!=="ALL"&&Y.counts[n]?` (${wt(Y.counts[n])})`:""}</button>`).join("")}
      </div>
      <span class="convs-count">${wt(t.length)} of ${wt(Y.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(Yr).join("")||`<tr><td colspan="6"><div class="convs-muted" style="padding:14px 4px">No ${Y.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(Y.filter=o.dataset.filter,vn())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&Kr(o.dataset.session)})}const Wr={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${It[e]||e}`:""}`,route:e=>`Picked ${It[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function Kr(e){const t=Y.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${Ct()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=pn(t.lead),o=Y.magnetNames[t.magnet_guid]||"—",s=(a?.events||[]).filter((c,f,y)=>c.event!=="step"||!(y[f+1]&&y[f+1].event==="step")).map(c=>`
    <div class="convs-tl__item${c.event==="complete"?" done":""}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${G((Wr[c.event]||(()=>c.event))(c.detail))}</div>
      <div class="convs-tl__time">${G(mn(c.at))}${c.variant?` · Variant ${G(c.variant)}`:""}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      <div class="convs-drawer__head">
        <span class="convs-drawer__title">${n?G(n):"Anonymous visitor"}</span>
      ...
      <div class="convs-drawer__body">
        ${n?`<a class="convs-drawer__lead" href="#/leads">
              <span class="convs-ava">${G(un(n))}</span>
              <span><div class="convs-name">${G(n)}</div><div class="convs-sub">${G(t.lead?.email||t.lead?.phone||"")}</div></span>
        ...
        <div class="convs-sub" style="margin-bottom:6px">${G(o)} · ${G(gn(t.duration_s))}${t.variant?` · Variant ${G(t.variant)}`:""}</div>
        ${s?`<div class="convs-tl">${s}</div>`:pt("timeline","No timeline available for this journey.")}
      </div>
    </aside>`,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("open"),i.querySelector(".convs-drawer").classList.add("open")});const l=()=>{i.classList.remove("open"),setTimeout(()=>i.remove(),220)};i.querySelector(".convs-drawer__close").addEventListener("click",l),i.addEventListener("click",c=>{c.target===i&&l()})}const Jr={render:hn,init:fn},Xr=Object.freeze(Object.defineProperty({__proto__:null,default:Jr,init:fn,render:hn},Symbol.toStringTag,{value:"Module"})),Qr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ee=e=>String(e??"").replace(/[&<>"']/g,t=>Qr[t]),_a=(e,t="info")=>{try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Lt=()=>A.getConfig?.().BASE_URL||"",nt=e=>Number(e||0).toLocaleString(),be={magnets:[],stats:{},canManage:!1},Zr={mag_title:"header title",mag_subtitle:"subtitle",mag_welcome:"welcome message",mag_theme_color:"color",mag_launcher_label:"launcher label"};let ba=!1;function es(){if(ba)return;const e=document.createElement("style");e.id="m5t-abt-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ba=!0}const zt=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function _n(){return es(),`
    <div class="page-shell" data-section="ab-testing">
      ...
      <div id="abt-body">${zt("hourglass_empty","Loading tests…")}</div>
    </div>`}async function Gt(){const e=document.getElementById("abt-body");try{const t=new Date,a=new Date(t.getTime()-89*864e5).toISOString().slice(0,10),n=t.toISOString().slice(0,10),[o,r]=await Promise.all([fetch(`${Lt()}/m5t/v5/magnets`),fetch(`${Lt()}/m5t/v5/magnets/stats?from=${a}&to=${n}`)]),s=await o.json().catch(()=>({}));if(!s.ok)throw new Error(s.message||"Failed to load");be.magnets=s.magnets||[],be.canManage=!!s.canManage;const i=await r.json().catch(()=>({}));be.stats=i?.stats||{}}catch(t){console.warn("[ab-testing] load failed:",t),e&&(e.innerHTML=zt("error","Could not load your tests. Please try again."));return}ts()}function ts(){const e=document.getElementById("abt-body");if(!e)return;const t=be.magnets.filter(n=>n.ab?.enabled),a=be.magnets.filter(n=>!n.ab?.enabled&&n.ab?.declared);if(!t.length&&!a.length){e.innerHTML=zt("science","No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.");return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(rs).join("")}`:"")+(a.length?`<div class="abt-sect">Completed Tests</div>${a.map(ss).join("")}`:""),e.querySelectorAll("[data-declare]").forEach(n=>n.addEventListener("click",()=>is(n.dataset.declare,n.dataset.winner)))}function as(e){const t=be.stats[e.guid]?.variants||{},a={opens:0,engaged:0,completions:0,rate:null,...t.A||{}},n={opens:0,engaged:0,completions:0,rate:null,...t.B||{}};return{A:a,B:n}}function ns(e){const t=Object.keys(e?.b||{}).map(a=>Zr[a]||a);return t.length?`Changes: ${t.join(", ")}`:""}function os(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function ya(e,t,a,n,o,r){return`
    <div class="abt-variant${o?" leader":""}">
      <div class="abt-vhead"><span class="abt-vname">${Ee(e)}</span><span class="abt-vtag${o?" win":""}">${Ee(t)}</span></div>
      ${a?`<div class="abt-vdesc">${Ee(a)}</div>`:""}
    ...
    </div>`}function rs(e){const t=e.ab,{A:a,B:n}=as(e),o=(n.rate??-1)>(a.rate??-1)?"B":(a.rate??-1)>(n.rate??-1)?"A":null,r=o&&a.rate!=null&&n.rate!=null?`+${Math.round(Math.abs(n.rate-a.rate)*10)/10}%`:"",s=ls(a,n),i=t.started_tz?os(t.started_tz):null,l=(a.opens||0)+(n.opens||0),c=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
        <h2 class="abt-name">${Ee(e.name)}</h2>
        <span class="abt-status running"><span class="pulse-dot"></span>Running</span>
        <div class="abt-actions">
          ${be.canManage&&o?`<button class="btn btn-primary" type="button" data-declare="${Ee(e.guid)}" data-winner="${o}"><span class="material-symbols-outlined" aria-hidden="true">emoji_events</span>Declare Winner</button>`:""}
        </div>
      </div>
      <div class="abt-meta">
      ...
      <div class="abt-compare">
        ${ya("Variant A","Control","The magnet as configured",a,o==="A",o==="A"?r:"")}
        <div class="abt-vs">VS</div>
        ${ya("Variant B",o==="B"?"Leading":"Challenger",ns(t),n,o==="B",o==="B"?r:"")}
      </div>
      <div class="abt-sig">
    ...
    <div class="abt-card">
      ...
      <div class="abt-summary">
        <span><span class="k">Winner:</span><span class="v">Variant ${Ee(t.winner)}</span></span>
        ...
        <span><span class="k">Total Visitors:</span><span class="v">${nt(s)}</span></span>
      </div>
    </div>`}async function is(e,t){const a=be.magnets.find(n=>n.guid===e);if(a&&window.confirm(`Declare Variant ${t} the winner for “${a.name}”?

${t==="B"?"Variant B’s changes become the magnet’s configuration for everyone.":"The magnet keeps its current configuration."} The experiment ends and moves to Completed.`))try{const o=await(await fetch(`${Lt()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Declare failed");_a(`Variant ${t} declared the winner`,"success"),await Gt()}catch(n){_a(n.message||"Could not declare a winner","danger")}}function ls(e,t){const a=e.opens||0,n=t.opens||0,o=e.completions||0,r=t.completions||0;if(a<30||n<30||o+r<5)return null;const s=o/a,i=r/n,l=(o+r)/(a+n),c=Math.sqrt(l*(1-l)*(1/a+1/n));if(!c)return null;const f=Math.abs(i-s)/c;return Math.round(2*(cs(f)-.5)*1e3)/10}function cs(e){const t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}const ds={render:_n,init:Gt},ps=Object.freeze(Object.defineProperty({__proto__:null,default:ds,init:Gt,render:_n},Symbol.toStringTag,{value:"Module"})),us={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Q=e=>String(e??"").replace(/[&<>"']/g,t=>us[t]),ms=()=>A.getConfig?.().BASE_URL||"",Nt={single_select:{label:"Multiple choice",icon:"quiz",color:"#0072BA"},multi_select:{label:"Select all",icon:"checklist",color:"#0E6BA8"},scheduler:{label:"Scheduler",icon:"event",color:"#915E8B"},text:{label:"Short text",icon:"short_text",color:"#5B54C6"},email:{label:"Email",icon:"mail",color:"#0E8F86"},phone:{label:"Phone",icon:"call",color:"#2E8B57"},message:{label:"Message",icon:"chat",color:"#B4791F"}},bn=["single_select","multi_select","scheduler","text","email","phone","message"],yn={chat:"Chat / default",book:"Book (scheduler)",support:"Support (intake)"},Vt=e=>Nt[e]||Nt.single_select,Le=e=>e==="single_select"||e==="multi_select",ut=e=>e!=="message",Ge=e=>e==="scheduler",ot=e=>e==="email"?"email":e==="phone"?"phone":e==="scheduler"?"preferred_time":"",Te=()=>({meeting_label:"",start:"09:00",end:"17:00",mins:30,days:14}),gs=["first_name","last_name","email","phone","company","product_interest","budget","timeline","message"],hs=[["","No icon"],["event","Calendar"],["schedule","Clock"],["mail","Email"],["sms","Text"],["phone","Phone"],["chat","Chat"],["description","Document"],["help","Question"],["place","Location"],["person","Person"],["bolt","Quick"],["check_circle","Check"],["star","Star"],["home","Home"],["build","Service"]];function fs(e,t){const a=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||"").trim());return a?`rgba(${parseInt(a[1],16)},${parseInt(a[2],16)},${parseInt(a[3],16)},${t})`:`rgba(0,114,186,${t})`}let wa=!1;function vs(){if(wa)return;const e=document.createElement("style");e.id="m5t-flow-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),wa=!0}let O=[],he=null,_s=0,_e=null,we=null,xe="chat",re={},Xe=[],wn=null,Ot=null;const De=()=>"f"+ ++_s;function qt(e="single_select"){return{_uid:De(),id:"",step_type:e,step_prompts:[""],step_options:Le(e)?[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]:[],step_columns:ot(e)?[ot(e)]:[],step_description:"",step_config:Ge(e)?Te():null}}function bs(e){return(Array.isArray(e)?e:[]).map(t=>({_uid:De(),id:t.id!=null?String(t.id):"",step_type:Nt[t.step_type]?t.step_type:"single_select",step_prompts:Array.isArray(t.step_prompts)?t.step_prompts.map(String):[],step_options:(Array.isArray(t.step_options)?t.step_options:[]).map(a=>({label:a&&a.label!=null?String(a.label):"",goto:a&&a.goto!=null?String(a.goto):"",icon:a&&a.icon!=null?String(a.icon):""})),step_columns:Array.isArray(t.step_columns)?t.step_columns.map(String):[],step_description:t.step_description!=null?String(t.step_description):"",step_config:t.step_config&&typeof t.step_config=="object"?{...Te(),...t.step_config}:t.step_type==="scheduler"?Te():null}))}function xa(){return[{_uid:De(),id:"",step_type:"text",step_prompts:["Great, and your name?"],step_options:[],step_columns:["first_name"],step_description:"",step_config:null},{_uid:De(),id:"",step_type:"email",step_prompts:["The best email to reach you?"],step_options:[],step_columns:["email"],step_description:"",step_config:null}]}function ys(e,t){if(e==="book")return[{_uid:De(),id:"",step_type:"scheduler",step_prompts:["When works best for you?"],step_options:[],step_columns:["preferred_time"],step_description:"",step_config:Te()},...xa()];if(e==="support"){const a=(t.actions||[]).find(r=>r&&r.type==="support"),n=a&&a.config&&Array.isArray(a.config.options)?a.config.options:[],o=n.length?n.map(r=>({label:r&&r.label||String(r),goto:"",icon:r&&r.icon||""})):["Sales enquiry","Support","Billing","Something else"].map(r=>({label:r,goto:"",icon:""}));return[{_uid:De(),id:"",step_type:"multi_select",step_prompts:["How can we help you today?"],step_options:o,step_columns:["support_topics"],step_description:"Select all that apply",step_config:null},...xa()]}return[qt("single_select")]}function xn(e,t){const a=e==="chat"?t.steps:t.routes&&t.routes[e],n=bs(a);return n.length?n:e==="chat"?[qt("single_select")]:ys(e,t)}function ws(e){Le(e.step_type)?e.step_options.length||(e.step_options=[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]):e.step_options=[],ut(e.step_type)?!e.step_columns.length&&ot(e.step_type)&&(e.step_columns=[ot(e.step_type)]):e.step_columns=[],e.step_config=Ge(e.step_type)?e.step_config||Te():null}function xs(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${Q(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${hs.map(([a,n])=>`<option value="${Q(a)}"${a===e.icon?" selected":""}>${Q(n)}</option>`).join("")}</select>
  ...
  </div>`}function Es(e){const t=bn.map(n=>`<option value="${n}"${n===e.step_type?" selected":""}>${Q(Vt(n).label)}</option>`).join(""),a=e.step_options.length<=1;return`<div class="flow-node__body">
...
`))}</textarea>
    ...
    ${o?Es(e):Ss(e)}
  </div>`}const Ea='<div class="flow-conn"><span class="flow-conn__line"></span><span class="material-symbols-outlined" aria-hidden="true">expand_more</span></div>';function se(){const e=document.getElementById("flow-nodes");if(!e)return;const t=O.length,a=['<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>',Ea];O.forEach((n,o)=>{a.push(As(n,o,t)),o<t-1&&a.push(Ea)}),e.innerHTML=a.join("")}function pe(){const e=document.querySelector(".flow-node--open");if(!e)return;const t=O.find(r=>r._uid===e.dataset.uid);if(!t)return;const a=e.querySelector(".flow-f-type");a&&(t.step_type=a.value);const n=e.querySelector(".flow-f-prompts");n&&(t.step_prompts=n.value.split(`
`));const o=e.querySelector(".flow-f-field");if(t.step_columns=o&&o.value.trim()?[o.value.trim()]:[],Le(t.step_type)){const r=t.step_options,s=[];e.querySelectorAll(".flow-opt").forEach((i,l)=>{s.push({label:i.querySelector(".flow-o-label")?.value??"",icon:i.querySelector(".flow-o-icon")?.value??"",goto:r[l]&&r[l].goto||""})}),t.step_options=s}else t.step_options=[];if(Ge(t.step_type)){const r=e.querySelector(".flow-f-mtlabel"),s=e.querySelector(".flow-f-start"),i=e.querySelector(".flow-f-end"),l=e.querySelector(".flow-f-mins");t.step_config={...t.step_config||Te(),...r?{meeting_label:r.value.trim()}:{},...s&&s.value?{start:s.value}:{},...i&&i.value?{end:i.value}:{},...l?{mins:parseInt(l.value,10)||30}:{}}}else t.step_config=null}function En(){document.querySelectorAll(".flow-node.drop-before, .flow-node.drop-after").forEach(e=>e.classList.remove("drop-before","drop-after"))}function Be(){En(),document.querySelectorAll(".flow-node.dragging").forEach(e=>e.classList.remove("dragging")),_e=null,we=null}function Ts(e=O){if(!e.length)return"Add at least one step.";for(let t=0;t<e.length;t++){const a=e[t],n=t+1;if(!a.step_prompts.some(o=>String(o).trim()!==""))return`Step ${n}: add what the magnet should say.`;if(Le(a.step_type)&&!a.step_options.some(o=>String(o.label).trim()!==""))return`Step ${n}: add at least one choice.`;if(ut(a.step_type)&&!a.step_columns.length)return`Step ${n}: choose which field this answer saves to.`}return""}function $t(e=O){let t=0;return e.forEach(a=>{const n=parseInt(a.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(a=>{const n=a.id&&String(a.id).trim()?String(a.id):String(++t),o=Le(a.step_type)?a.step_options.map(s=>{const i={label:String(s.label).trim(),goto:String(s.goto||"")};return s.icon&&(i.icon=String(s.icon)),i}).filter(s=>s.label!==""):[],r={id:n,step_type:a.step_type,step_prompts:a.step_prompts.map(s=>String(s)).filter(s=>s.trim()!==""),step_options:o,step_columns:a.step_columns.slice(),step_description:a.step_description||""};return Ge(a.step_type)&&a.step_config&&(r.step_config={...Te(),...a.step_config}),r})}function ks(e,t,a){vs(),wn=t,Ot=typeof a=="function"?a:null,Xe=["chat",...["book","support"].filter(n=>(t.actions||[]).some(o=>o&&o.type===n))],re={chat:xn("chat",t)},xe="chat",O=re.chat,he=O.length===1?O[0]._uid:null,_e=null,we=null,e.innerHTML=`
    ...
    ${Xe.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${Xe.map(n=>`<option value="${n}">${Q(yn[n]||n)}</option>`).join("")}</select></div>`:""}
    <datalist id="flow-fields">${gs.map(n=>`<option value="${Q(n)}"></option>`).join("")}</datalist>
...
<body>
  ...
  <\/script>
  <script>${a}<\/script>
</body></html>`}let Aa=!1;function An(){if(Aa)return;const e=document.createElement("style");e.id="m5t-preview-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Aa=!0}function Tn(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function kn(e){const t=e.querySelector("[data-pv-info]"),a=e.querySelector("[data-pv-info-pop]");t&&a&&t.addEventListener("click",()=>{a.hidden=!a.hidden})}function $s(e,t){An(),e.innerHTML=`
    <div class="pv-pane">
      ...
      ${Tn("Live render of the real widget. Capture is disabled — no test leads.")}
    </div>`,kn(e);const a=e.querySelector(".pv-pane__frame"),n=e.querySelector(".pv-pane__badge");let o=null,r=0;const s=450,i=()=>{const c=(typeof performance<"u"?performance.now():Date.now())-r;clearTimeout(o),c<s?o=setTimeout(()=>{n.hidden=!0},s-c):n.hidden=!0};a.addEventListener("load",i);const l=()=>{let c;try{c=Sn(t())}catch{return}r=typeof performance<"u"?performance.now():Date.now(),n.hidden=!1,a.srcdoc=c,clearTimeout(o),o=setTimeout(()=>{n.hidden=!0},1500)};return e.querySelector(".pv-pane__seg").addEventListener("click",c=>{const f=c.target.closest("button[data-device]");!f||f.dataset.device===a.dataset.device||(e.querySelectorAll(".pv-pane__seg button").forEach(y=>y.classList.toggle("is-on",y===f)),a.dataset.device=f.dataset.device)}),l(),{refresh:l,destroy(){clearTimeout(o)}}}function Cn(e){An();let t="desktop";const a=document.createElement("div");a.className="pv-scrim",a.innerHTML=`
    <div class="pv-modal" role="dialog" aria-modal="true" aria-label="Magnet preview">
      ...
      <div class="pv-body">
        <div>
          ...
          ${Tn("Live render of the actual widget. Capture is disabled, so no test leads are created.")}
        </div>
      </div>
    </div>`,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("open")),kn(a);const n=a.querySelector(".pv-frame"),o=a.querySelector(".pv-stage"),r=()=>{try{n.srcdoc=Sn(e())}catch{}};r();const s=()=>{a.classList.remove("open"),setTimeout(()=>a.remove(),180)};return a.querySelector('[data-x="close"]').addEventListener("click",s),a.querySelector('[data-x="refresh"]').addEventListener("click",r),a.addEventListener("click",i=>{i.target===a&&s()}),a.querySelector(".pv-seg").addEventListener("click",i=>{const l=i.target.closest("button[data-device]");!l||l.dataset.device===t||(t=l.dataset.device,a.querySelectorAll(".pv-seg button").forEach(c=>c.classList.toggle("is-on",c.dataset.device===t)),o.dataset.device=t,r())}),{close:s,rebuild:r}}let Ta=!1;const K={magnets:[],owners:[],canProvision:!1,canManage:!1,primaryOrgGuid:null,stats:{}},Rs={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},S=e=>String(e??"").replace(/[&<>"']/g,t=>Rs[t]),ke=(e,t="info")=>{try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Ce=()=>A.getConfig?.().BASE_URL||"",In=e=>`<script src="${Ce()}/m5t/v5/coreSnippet?appguid=${e}" async><\/script>`,Ms={chat:"Chat bubble",right_slide:"Slide-in panel",modal:"Modal",inline:"Inline"},Fs={chat:"chat",right_slide:"vertical_split",modal:"web_asset",inline:"view_agenda"},Ps=[{value:"inline",icon:"view_agenda",label:"Inline"},{value:"chat",icon:"chat",label:"Chat"},{value:"right_slide",icon:"vertical_split",label:"Slide"},{value:"modal",icon:"web_asset",label:"Modal"}],Ds=[{value:"auto",icon:"brightness_auto",label:"Auto"},{value:"light",icon:"light_mode",label:"Light"},{value:"dark",icon:"dark_mode",label:"Dark"}],Bs=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],Ln={book:{label:"Book",icon:"event",kind:"book"},chat:{label:"Chat",icon:"chat",kind:"flow"},call:{label:"Call",icon:"phone",kind:"value",placeholder:"Phone number"},email:{label:"Email",icon:"mail",kind:"value",placeholder:"Email address"},support:{label:"Support",icon:"support_agent",kind:"support"}},Us=["book","chat","call","email","support"];function ka(e,t,a){return`<div class="mag-seg" role="radiogroup" aria-label="${S(e)}">${a.map(n=>`
    <label><input type="radio" name="${S(e)}" value="${S(n.value)}"${n.value===t?" checked":""}>
      <span><span class="material-symbols-outlined" aria-hidden="true">${S(n.icon)}</span>${S(n.label)}</span></label>`).join("")}</div>`}function Hs(e,t){const a=Ln[e],n=!!t,o=n?"":" disabled";let r="";if(a.kind==="value")r=`<input class="mag-modal__input mag-cta__val" type="text" placeholder="${S(a.placeholder)}" value="${S(t?.value||"")}"${o}>`;else if(a.kind==="book"){const i=t?.config?.meeting_label||t?.value||"";r=`<input class="mag-modal__input mag-cta__val" type="text" placeholder="Meeting label (e.g. 15 minute call), or paste a booking link" value="${S(i)}"${o}>`}else r=`<span class="mag-cta__note">${a.kind==="support"?"Multi-select intake":"Opens your conversation flow"}</span>`;let s="";if(a.kind==="support"){const i=(t?.config?.options||[]).map(l=>l&&l.label||l).filter(Boolean);s=`<textarea class="mag-modal__input mag-cta__opts" rows="3" placeholder="Support options, one per line (e.g. Sales&#10;Support&#10;Billing)"${o}>${S(i.join(`
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${a.kind}">
    ...
    ${s}
  </div>`}function zs(){if(Ta)return;const e=document.createElement("style");e.id="m5t-magnets-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ta=!0}function Mt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Gs(e){const t=K.stats[e];if(!t||!t.opens&&!t.leads)return'<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>';const a=n=>Number(n||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function Vs(e){const t=K.owners.length>1||A.getMemberships().length>1,a=(e.domains||[]).filter(Boolean),n=K.canManage;return`
    <div class="mag-card" data-guid="${S(e.guid)}">
      ...
      <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${Fs[e.display_mode]||"chat"}</span>${S(Ms[e.display_mode]||"Chat bubble")}${e.ab?.enabled?'&nbsp;&nbsp;<span class="mag-ab-chip"><span class="material-symbols-outlined" aria-hidden="true">science</span>A/B</span>':""}</span>
      ${Gs(e.guid)}
      <div class="mag-domains">${a.length?a.map(o=>S(o)).join(", "):"<span>No domains set. Add yours to go live.</span>"}</div>
      <div class="mag-embed">
        <input type="text" readonly value="${S(In(e.guid))}" aria-label="Embed snippet">
    ...
    </div>`}async function js(){document.getElementById("mag-new-btn")?.addEventListener("click",()=>Ft(null)),document.getElementById("mag-body")?.addEventListener("click",Ys),await mt()}async function mt(){const e=document.getElementById("mag-body");if(!e)return;try{const[a,n]=await Promise.all([fetch(`${Ce()}/m5t/v5/magnets`),fetch(`${Ce()}/m5t/v5/magnets/stats`).catch(()=>null)]),o=await a.json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Failed to load");K.magnets=o.magnets||[],K.owners=o.owners||[],K.canProvision=!!o.canProvision,K.canManage=!!o.canManage,K.primaryOrgGuid=o.primaryOrgGuid||null;const r=n?await n.json().catch(()=>({})):{};K.stats=r?.stats||{}}catch{e.innerHTML=Mt("error","Could not load your magnets. Please try again.");return}const t=document.getElementById("mag-new-btn");if(t&&(t.style.display=K.canProvision?"":"none"),!K.magnets.length){e.innerHTML=Mt("widgets",K.canProvision?"No magnets yet. Click “New magnet” to create your first.":"No magnets yet.");return}e.innerHTML=`<div class="mag-grid">${K.magnets.map(Vs).join("")}</div>`}function Ys(e){const t=e.target.closest("[data-action]");if(!t)return;const a=t.dataset.guid,n=K.magnets.find(r=>r.guid===a),o=t.dataset.action;if(o==="copy")return Ws(a);if(n){if(o==="preview")return Cn(()=>Rt(n));if(o==="edit")return Ft(n);if(o==="flow")return Ft(n,"flow");if(o==="toggle")return Ks(n);if(o==="delete")return Js(n)}}async function Ws(e){try{await navigator.clipboard.writeText(In(e)),ke("Embed snippet copied","success")}catch{ke("Copy failed","danger")}}async function Ks(e){const t=e.status==="ENABLED"?"DISABLED":"ENABLED";try{if(!(await(await fetch(`${Ce()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw new Error;ke(t==="ENABLED"?"Magnet enabled":"Magnet disabled","success"),await mt()}catch{ke("Update failed","danger")}}async function Js(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`))try{if(!(await(await fetch(`${Ce()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"})).json().catch(()=>({}))).ok)throw new Error;ke("Magnet deleted","success"),await mt()}catch{ke("Delete failed","danger")}}function xt(e){const t=[];return e.querySelectorAll(".mag-cta").forEach(a=>{if(!a.querySelector(".mag-cta__on").checked)return;const n=a.dataset.type,o=a.dataset.kind,r=a.querySelector(".mag-cta__val"),s=r?r.value.trim():"";if(o==="value")s&&t.push({type:n,value:s});else if(o==="book"){const i={type:n};s&&(/^https?:\/\//i.test(s)?i.value=s:i.config={meeting_label:s}),t.push(i)}else if(o==="support"){const i=(a.querySelector(".mag-cta__opts")?.value||"").split(`
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:Nn(e),actions:t,font:e.querySelector("#mag-f-font").value.trim(),theme_vars:Xs(e),inline_width:e.querySelector("#mag-f-inline-w").value.trim(),inline_height:e.querySelector("#mag-f-inline-h").value.trim(),hide_launcher:e.querySelector("#mag-f-hide-launcher").checked,input_placeholder:e.querySelector("#mag-f-input-ph").value,summary_confirm_label:e.querySelector("#mag-f-summary-confirm").value.trim(),success_title:e.querySelector("#mag-f-success-title").value.trim(),success_text:e.querySelector("#mag-f-success-text").value,success_cta:Qs(e)}}function Xs(e){return e.querySelector("#mag-f-surface-on")?.checked?{surface:e.querySelector("#mag-f-sv-surface").value,surface_2:e.querySelector("#mag-f-sv-surface2").value,border:e.querySelector("#mag-f-sv-border").value,text:e.querySelector("#mag-f-sv-text").value,text_sub:e.querySelector("#mag-f-sv-textsub").value}:{}}function Qs(e){const t=e.querySelector("#mag-f-success-cta-label").value.trim(),a=e.querySelector("#mag-f-success-cta-url").value.trim();return t&&a?{label:t,url:a}:{}}function Nn(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",r=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==r.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}const Ca=[{label:"Web fonts (loaded for you)",opts:[["Inter, sans-serif","Inter"],["Poppins, sans-serif","Poppins"],["Montserrat, sans-serif","Montserrat"],["Roboto, sans-serif","Roboto"],['"Open Sans", sans-serif',"Open Sans"],["Lato, sans-serif","Lato"],["Nunito, sans-serif","Nunito"],["Raleway, sans-serif","Raleway"],['"Work Sans", sans-serif',"Work Sans"],["Oswald, sans-serif","Oswald"],["Merriweather, serif","Merriweather (serif)"]]},{label:"System / always available",opts:[["system-ui, sans-serif","System UI"],["Georgia, serif","Georgia (serif)"],['"Times New Roman", Times, serif',"Times (serif)"],["Arial, Helvetica, sans-serif","Arial / Helvetica"],["Verdana, Geneva, sans-serif","Verdana"],['"Courier New", monospace',"Courier (mono)"]]}];function Zs(e){const t=String(e||""),a=new Set(Ca.flatMap(r=>r.opts.map(([s])=>s))),n=r=>r===t?" selected":"";let o=`<option value=""${t===""?" selected":""}>System default</option>`;t&&!a.has(t)&&(o+=`<option value="${S(t)}" selected>Current: ${S(t)}</option>`);for(const r of Ca)o+=`<optgroup label="${S(r.label)}">`+r.opts.map(([s,i])=>`<option value="${S(s)}"${n(s)}>${S(i)}</option>`).join("")+"</optgroup>";return o}function Ft(e,t){const a=!!e,n=!a&&K.owners.length>1,o=e?.display_mode||"chat",r=e?.theme_mode||"auto",s={};(e?.actions||[]).forEach(C=>{C&&C.type&&(s[C.type]=C)});const i=a?!!e.home:!0,l=a?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",c=e?.theme_vars&&typeof e.theme_vars=="object"?e.theme_vars:{},f=Object.keys(c).length>0,y=(C,q)=>S(/^#[0-9a-fA-F]{6}$/.test(c[C]||"")?c[C]:q),m=document.createElement("div");m.className="mag-modal-scrim",m.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${a?"Edit magnet":"New magnet"}">
      ...
      <div class="mag-modal__main">
        ...
        <select class="mag-modal__select" id="mag-f-owner">
          ${K.owners.map(C=>`<option value="${S(C.guid)}"${C.guid===K.primaryOrgGuid?" selected":""}>${S(C.name||C.guid)}</option>`).join("")}
        </select>`:""}
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${Bs.map(C=>`<option value="${C.value}"${(e?e.trigger||"none":"on_load")===C.value?" selected":""}>${S(C.label)}</option>`).join("")}
        </select>
        ...
        <div class="mag-modal__sec">
          ...
          <input class="mag-modal__input" id="mag-f-subtitle" type="text" placeholder="Typically replies in a few minutes" value="${S(l)}">
          ...
          <select class="mag-modal__select" id="mag-f-font">${Zs(e?.font||"")}</select>
          ...
          <div class="mag-tog-row" style="margin-top:12px">
            ...
            <label for="mag-f-hide-launcher">Hide the floating button — open only from your own button/link</label>
          </div>
    ...
    </div>`,document.body.appendChild(m),requestAnimationFrame(()=>{m.classList.add("open"),m.querySelector(".mag-modal").classList.add("open")});const b=[...m.querySelectorAll(".mag-modal__navitem")],k=[...m.querySelectorAll(".mag-tab")],g=C=>{b.forEach(q=>q.classList.toggle("is-active",q.dataset.tab===C)),k.forEach(q=>{q.hidden=q.dataset.tab!==C}),m.querySelector(".mag-modal__body").scrollTop=0};b.forEach(C=>C.addEventListener("click",()=>g(C.dataset.tab)));const h=()=>Rt({...e,...xt(m),...a?{steps:Sa()}:{}}),v=m.querySelector("#mag-preview-pane"),x=()=>window.matchMedia("(min-width: 1200px)").matches;let I=null;const R=()=>{if(!I&&x())try{I=$s(v,h)}catch{}};let W=null;const V=()=>{x()&&(R(),I&&(clearTimeout(W),W=setTimeout(()=>{try{I.refresh()}catch{}},300)))},ae=window.matchMedia("(min-width: 1200px)"),le=()=>{x()&&(R(),V())};ae.addEventListener("change",le);let Z=!1;const fe=m.querySelector(".mag-modal__main");fe.addEventListener("input",()=>{Z=!0,V()}),fe.addEventListener("change",()=>{Z=!0,V()});const ge=()=>{clearTimeout(W),ae.removeEventListener("change",le),I&&I.destroy&&I.destroy(),m.classList.remove("open"),setTimeout(()=>m.remove(),180),document.removeEventListener("keydown",N)},w=()=>{Z&&!confirm("Discard your changes to this magnet?")||ge()};function N(C){C.key==="Escape"&&(C.preventDefault(),w())}document.addEventListener("keydown",N),m.querySelector(".mag-modal__close").addEventListener("click",w),m.querySelector('[data-x="cancel"]').addEventListener("click",w),m.querySelector("#mag-f-name").focus();const ce=m.querySelector("#mag-flow-panel");a?ks(ce,e,()=>{Z=!0,V()}):ce.innerHTML='<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>',t&&g(t),R(),m.querySelectorAll(".mag-cta").forEach(C=>{const q=C.querySelector(".mag-cta__on"),u=C.querySelector(".mag-cta__val"),_=C.querySelector(".mag-cta__opts");q.addEventListener("change",()=>{u&&(u.disabled=!q.checked),_&&(_.disabled=!q.checked),q.checked&&(u||_)?.focus()}),u&&u.addEventListener("input",()=>{u.value.trim()&&!q.checked&&(q.checked=!0,_&&(_.disabled=!1))})});const Ve=m.querySelector("#mag-f-surface-on"),gt=m.querySelector("#mag-f-surface");Ve.addEventListener("change",()=>gt.hidden=!Ve.checked);const Ne=m.querySelector("#mag-f-inline-size");m.querySelectorAll('input[name="mag-display"]').forEach(C=>C.addEventListener("change",()=>{Ne.hidden=m.querySelector('input[name="mag-display"]:checked')?.value!=="inline"})),m.querySelector('[data-x="preview"]')?.addEventListener("click",()=>Cn(()=>Rt({...e,...xt(m),...a?{steps:Sa()}:{}}))),m.querySelector('[data-x="save"]').addEventListener("click",async C=>{const q=C.currentTarget,u=m.querySelector("#mag-f-error"),_=m.querySelector("#mag-f-name").value.trim();if(!_){g("basics"),u.textContent="Please give your magnet a name.";return}const L=m.querySelector("#mag-f-domains").value.split(",").map(H=>H.trim()).filter(Boolean);let M="";if(m.querySelectorAll(".mag-cta").forEach(H=>{if(H.dataset.kind!=="value")return;const qe=H.querySelector(".mag-cta__on").checked,Oe=H.querySelector(".mag-cta__val").value.trim();qe&&!Oe&&(M=M||`Add a target for the ${Ln[H.dataset.type].label} button, or uncheck it.`)}),M){g("welcome"),u.textContent=M;return}const $=Nn(m);if($.enabled&&!Object.keys($.b).length){g("ab"),u.textContent="Give variant B at least one change (title, welcome, or color), or untick the A/B test.";return}if(a){const H=Is();if(H){g("flow"),Ls(H.route,H.message);return}}const ne={name:_,domains:L,...xt(m)};n&&(ne.owner_guid=m.querySelector("#mag-f-owner").value),q.disabled=!0,u.textContent="";try{const H=a?`${Ce()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${Ce()}/m5t/v5/magnets`,Oe=await(await fetch(H,{method:a?"PATCH":"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(ne)})).json().catch(()=>({}));if(!Oe.ok)throw new Error(Oe.message||"Save failed");a&&await Ns(e.guid),ke(a?"Magnet updated":"Magnet created","success"),ge(),await mt()}catch(H){q.disabled=!1,u.textContent=H.message||"Something went wrong."}})}const ei=Object.freeze(Object.defineProperty({__proto__:null,init:js,render:qs},Symbol.toStringTag,{value:"Module"}));let Ia=!1;const B={leads:[],magnetNames:{},filter:"ALL",canManage:!1},On=["NEW","WORKING","QUALIFIED","UNQUALIFIED","CONVERTED","EXPORTED"],ti={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},j=e=>String(e??"").replace(/[&<>"']/g,t=>ti[t]),rt=(e,t="info")=>{try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Pt=()=>A.getConfig?.().BASE_URL||"",jt=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",ai=e=>(jt(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function Yt(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric"})}catch{return""}}function ni(){if(Ia)return;const e=document.createElement("style");e.id="m5t-leads-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ia=!0}function Wt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function oi(e){return`<select class="leads-status" data-id="${j(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${On.map(t=>`<option value="${t}" ${e.status===t?"selected":""}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join("")}
  </select>`}function ri(e){const t=B.magnetNames[e.magnet_guid]||e.lead_source||"—";return`
    <tr class="leads-row" data-id="${j(e.id)}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${j(ai(e))}</span>
          <span><span class="leads-name">${j(jt(e))}</span>${e.company?`<div class="leads-sub">${j(e.company)}</div>`:""}</span>
        </span>
      </td>
      <td>${e.email?j(e.email):'<span class="leads-muted">—</span>'}${e.phone?`<div class="leads-sub">${j(e.phone)}</div>`:""}</td>
      <td>${e.product_interest?j(e.product_interest):'<span class="leads-muted">—</span>'}</td>
      <td><span class="leads-sub">${j(t)}</span>${e.utm_campaign||e.utm_source?`<div class="leads-sub" title="Campaign / source">${j(e.utm_campaign||e.utm_source)}${e.gclid?' <span class="leads-badge" data-s="QUALIFIED" style="font-size:0.58rem;padding:1px 6px">Ads</span>':""}</div>`:""}</td>
      <td>${B.canManage?oi(e):`<span class="leads-badge" data-s="${j(e.status)}">${j(e.status)}</span>`}</td>
      <td class="leads-muted" style="white-space:nowrap">${j(Yt(e))}</td>
    </tr>`}function $n(){return B.filter==="ALL"?B.leads:B.leads.filter(e=>e.status===B.filter)}function si(){return ni(),`
    ...
    </div>`}async function ii(){document.getElementById("leads-export")?.addEventListener("click",pi),await li()}async function li(){const e=document.getElementById("leads-body");if(e){try{const[t,a]=await Promise.all([fetch(`${Pt()}/m5t/v5/m5mLead`),fetch(`${Pt()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(B.leads=(n.data||[]).filter(o=>!["DELETED","ARCHIVED"].includes(o.status)),a){const o=await a.json().catch(()=>({}));B.magnetNames={},(o.magnets||[]).forEach(r=>{B.magnetNames[r.guid]=r.name}),B.canManage=!!o.canManage}}catch{e.innerHTML=Wt("error","Could not load your leads. Please try again.");return}Kt()}}function Kt(){const e=document.getElementById("leads-body"),t=document.getElementById("leads-export");if(!e)return;if(t&&(t.style.display=B.leads.length?"":"none"),!B.leads.length){e.innerHTML=Wt("inbox","No leads captured yet. Publish a magnet and share it to start collecting.");return}const a=$n();e.innerHTML=`
    <div class="leads-bar">
      <div class="leads-filter">
        ${["ALL",...On].map(n=>`<button data-filter="${n}" class="${B.filter===n?"active":""}">${n==="ALL"?"All":n[0]+n.slice(1).toLowerCase()}</button>`).join("")}
      </div>
      <span class="leads-count">${a.length} of ${B.leads.length}</span>
    </div>
    <div class="leads-tablewrap">
      <table class="leads-table">
        ...
        <tbody id="leads-tbody">${a.map(ri).join("")||`<tr><td colspan="6"><div class="leads-muted" style="padding:14px 4px">No ${B.filter.toLowerCase()} leads.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".leads-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(B.filter=o.dataset.filter,Kt())}),e.querySelector("#leads-tbody")?.addEventListener("change",ci),e.querySelector("#leads-tbody")?.addEventListener("click",n=>{if(n.target.closest(".leads-status"))return;const o=n.target.closest(".leads-row");o&&di(o.dataset.id)})}async function ci(e){const t=e.target.closest(".leads-status");if(!t)return;const a=t.dataset.id,n=B.leads.find(s=>String(s.id)===String(a)),o=t.value,r=n?.status;try{if(!(await(await fetch(`${Pt()}/m5t/v5/m5mLead/${encodeURIComponent(a)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:o})})).json().catch(()=>({}))).ok)throw new Error;n&&(n.status=o),rt(`Marked ${o[0]}${o.slice(1).toLowerCase()}`,"success"),B.filter!=="ALL"&&Kt()}catch{t.value=r||"NEW",rt("Could not update status","danger")}}function di(e){const t=B.leads.find(s=>String(s.id)===String(e));if(!t)return;const a=B.magnetNames[t.magnet_guid]||t.lead_source||"—",n=(s,i)=>i?`<div class="leads-drawer__field"><span class="leads-drawer__k">${j(s)}</span><span class="leads-drawer__v">${j(i)}</span></div>`:"",o=document.createElement("div");o.className="leads-drawer-scrim",o.innerHTML=`
    <aside class="leads-drawer" role="dialog" aria-modal="true" aria-label="Lead detail">
      <div class="leads-drawer__head">
        <span class="leads-drawer__title">${j(jt(t))}</span>
      ...
      <div class="leads-drawer__body">
        <div class="leads-drawer__contact">
          ${t.email?`<a class="leads-drawer__cbtn" href="mailto:${j(t.email)}"><span class="material-symbols-outlined" aria-hidden="true">mail</span>Email</a>`:""}
          ${t.phone?`<a class="leads-drawer__cbtn" href="tel:${j(String(t.phone).replace(/[^\d+]/g,""))}"><span class="material-symbols-outlined" aria-hidden="true">call</span>Call</a>`:""}
        </div>
        ${n("Status",t.status)}
        ${n("Email",t.email)}
        ${n("Phone",t.phone)}
        ...
        ${t.description?`<div class="leads-drawer__notes">${j(t.description)}</div>`:""}
      </div>
    </aside>`,document.body.appendChild(o),requestAnimationFrame(()=>{o.classList.add("open"),o.querySelector(".leads-drawer").classList.add("open")});const r=()=>{o.classList.remove("open"),setTimeout(()=>o.remove(),220)};o.querySelector(".leads-drawer__close").addEventListener("click",r),o.addEventListener("click",s=>{s.target===o&&r()})}function pi(){const e=$n();if(!e.length){rt("Nothing to export","info");return}const t=["first_name","last_name","email","phone","company","product_interest","lead_source","utm_source","utm_medium","utm_campaign","gclid","status"],a=l=>`"${String(l??"").replace(/"/g,'""')}"`,o=[[...t,"magnet","captured"].join(",")];for(const l of e)o.push([...t.map(c=>a(l[c])),a(B.magnetNames[l.magnet_guid]||l.lead_source||""),a(Yt(l))].join(","));const r=new Blob([o.join(`
`)],{type:"text/csv"}),s=URL.createObjectURL(r),i=document.createElement("a");i.href=s,i.download=`leads-${B.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(s),rt(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const ui=Object.freeze(Object.defineProperty({__proto__:null,init:ii,render:si},Symbol.toStringTag,{value:"Module"})),mi=()=>A.getConfig?.().BASE_URL||"",La=e=>e.toISOString().slice(0,10),Na=e=>e==null?"—":"$"+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),Fe=e=>Number(e||0).toLocaleString(),gi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},We=e=>String(e??"").replace(/[&<>"']/g,t=>gi[t]);let Oa=!1;function hi(){if(Oa)return;const e=document.createElement("style");e.id="m5t-adperf-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Oa=!0}const Pe=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Ke=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
  ...
  </div>`,fi=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let st=30;function Rn(){return hi(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${fi.map(e=>`<button class="chart-period-btn${e.d===st?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>

      <div class="stats-grid">
        ${Ke("payments","Ad Spend","adperf-spend")}
        ${Ke("ads_click","Clicks","adperf-clicks")}
        ${Ke("person_add","Magnet Leads","adperf-leads")}
        ${Ke("request_quote","Cost / Lead","adperf-cpl")}
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-body">
          ${Pe("hourglass_empty","Loading ad performance…")}
        </div>
      </div>
    ...
    </div>`}async function Mn(){const e=document.getElementById("adperf-periods");e?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(st=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===st)),$a())}),await $a()}async function $a(){const e=mi(),t=document.getElementById("adperf-body"),a=document.getElementById("adperf-range"),n=new Date,o=La(n),r=La(new Date(n.getTime()-(st-1)*864e5));a&&(a.textContent=`${r} → ${o}`);let s,i=[],l=null;try{const[f,y,m]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${r}&to=${o}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${r}&to=${o}`)]);if(!f.ok)throw new Error(`HTTP ${f.status}`);s=await f.json(),i=((await y.json().catch(()=>({})))?.data||[]).filter(k=>k.status!=="DELETED"),l=await m.json().catch(()=>null)}catch(f){console.warn("[ad-performance] load failed:",f),t&&(t.innerHTML=Pe("error","Could not load ad performance. Please try again."));return}const c=s.totals||{};if(Je("adperf-spend",Na(c.spend)),Je("adperf-clicks",Fe(c.clicks)),Je("adperf-leads",Fe(c.magnet_leads)),Je("adperf-cpl",Na(c.cost_per_lead)),vi(l),!i.length){t.innerHTML=Pe("link_off","No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.");return}if(!s.connected){t.innerHTML=Pe("cloud_sync","Account connected. No ad data for this range yet. Metrics appear here once they sync.");return}t.innerHTML=_i(s.rows||[])}function vi(e){const t=document.getElementById("adperf-sources"),a=document.getElementById("adperf-src-summary");if(!t)return;const n=e&&Array.isArray(e.rows)?e.rows:[];if(!n.length){a&&(a.textContent=""),t.innerHTML=Pe("search_off","No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.");return}const o=e.total_leads||n.reduce((i,l)=>i+(l.leads||0),0),r=e.tracked_leads||0;a&&(a.textContent=`${Fe(r)} of ${Fe(o)} leads tagged to a source`);const s=i=>i.campaign&&i.campaign!=="(none)"?We(i.campaign):i.source&&i.source!=="(direct)"?We(i.source):'<span class="adperf-src-untracked">Untracked / direct</span>';t.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${n.map(i=>`
          <tr>
            <td>${s(i)}</td>
            <td class="adperf-src-sub">${We(i.source||"—")}${i.medium?` · ${We(i.medium)}`:""}</td>
            <td class="num">${i.paid_clicks?Fe(i.paid_clicks):'<span class="adperf-src-sub">—</span>'}</td>
            <td class="num"><b>${Fe(i.leads)}</b></td>
          </tr>`).join("")}
        </tbody>
      </table>
    </div>`}function Je(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}function Ra(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}function Ma(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e)}function _i(e){const b=e.length||1,k=Ra(Math.max(1,...e.map(w=>w.spend||0))),g=Ra(Math.max(1,...e.map(w=>w.magnet_leads||0))),h=738/b,v=Math.min(24,h*.55),x=w=>56+h*(w+.5),I=w=>304-w/k*282,R=w=>304-w/g*282,W=[0,.25,.5,.75,1].map(w=>{const N=304-w*282;return`<line x1="56" y1="${N.toFixed(1)}" x2="794" y2="${N.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${(N+3.5).toFixed(1)}" text-anchor="end" class="ax">$${Ma(k*w)}</text><text x="802" y="${(N+3.5).toFixed(1)}" text-anchor="start" class="ax">${Ma(g*w)}</text>`}).join(""),V=e.map((w,N)=>{const ce=I(w.spend||0);return`<rect x="${(x(N)-v/2).toFixed(1)}" y="${ce.toFixed(1)}" width="${v.toFixed(1)}" height="${Math.max(0,304-ce).toFixed(1)}" rx="3" fill="#0072BA"><title>${w.date}: $${w.spend} spend</title></rect>`}).join(""),ae=e.map((w,N)=>`${x(N).toFixed(1)},${R(w.magnet_leads||0).toFixed(1)}`).join(" "),le=b>1?`<polyline points="${ae}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",Z=e.map((w,N)=>`<circle cx="${x(N).toFixed(1)}" cy="${R(w.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${w.date}: ${w.magnet_leads} leads</title></circle>`).join(""),fe=Math.max(1,Math.ceil(b/6)),ge=e.map((w,N)=>N%fe===0||N===b-1?`<text x="${x(N).toFixed(1)}" y="326" text-anchor="middle" class="ax">${w.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="adperf-chart" viewBox="0 0 840 340" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Ad spend versus magnet leads over time">
      ${W}${V}${le}${Z}${ge}
    </svg>`}const bi={render:Rn,init:Mn},yi=Object.freeze(Object.defineProperty({__proto__:null,default:bi,init:Mn,render:Rn},Symbol.toStringTag,{value:"Module"})),Fa="reseller_org",Fn="managed_client";let Pa=!1;const wi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},U=e=>String(e??"").replace(/[&<>"']/g,t=>wi[t]);function it(e,t="info"){try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}}function xi(){const e=A.getActiveOrg();if(e&&e.channel===Fa)return{guid:e.guid,name:e.name};const t=A.getMemberships().find(a=>a.channel===Fa);return t?{guid:t.orgGuid,name:t.name}:null}function Ei(e){const t=e?.created_tz;if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function Si(){if(Pa)return;const e=document.createElement("style");e.id="m5t-clients-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Pa=!0}const Ai=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Qe(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Ti(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
    <div class="client-card">
      <span class="client-card__avatar">${U(Ai(t))}</span>
      <span class="client-card__main">
        <div class="client-card__name" title="${U(t)}">${U(t)}</div>
        <div class="client-card__meta">Added ${U(Ei(e.created))||"—"}</div>
    ...
    <div class="page-shell" data-section="clients">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="clients-body">
          ${Qe("hourglass_empty","Loading clients…")}
        </div>
      </div>
    </div>`}async function Dn(){const e=xi();document.getElementById("clients-add-btn")?.addEventListener("click",()=>ki(e)),await Bn(e)}async function Bn(e){const t=document.getElementById("clients-body"),a=document.getElementById("clients-count");if(t){if(!e?.guid){t.innerHTML=Qe("info","Client provisioning is available to reseller / agency accounts."),a&&(a.textContent="");return}try{const n=A.getConfig?.().BASE_URL||"",o=await fetch(`${n}/m5t/v5/acctGroup`);if(!o.ok)throw new Error(`HTTP ${o.status}`);const r=await o.json(),i=(Array.isArray(r?.data)?r.data:[]).filter(l=>l.class===Fn&&(!l.parent||l.parent===e.guid));if(!i.length){t.innerHTML=Qe("group_off","No clients yet. Add your first client to start managing magnets on their behalf."),a&&(a.textContent="");return}t.innerHTML=`<div class="clients-grid">${i.map(Ti).join("")}</div>`,a&&(a.textContent=`${i.length} client${i.length===1?"":"s"}`),t.querySelectorAll(".client-card__invite").forEach(l=>{l.addEventListener("click",()=>{l.dataset.action==="adaccounts"?Ci(l.dataset.clientGuid,l.dataset.clientName):Ii(l.dataset.clientGuid,l.dataset.clientName)})})}catch(n){console.warn("[clients] load failed:",n),t.innerHTML=Qe("error","Couldn’t load clients. Please try again."),a&&(a.textContent="")}}}function ki(e){if(!e?.guid){it("Only reseller / agency accounts can add clients.","error");return}const t=document.createElement("div");t.className="client-modal-scrim";const a=document.createElement("div");a.className="client-modal",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),document.body.appendChild(a),requestAnimationFrame(()=>{t.classList.add("open"),a.classList.add("open")});const n=a.querySelector("#client-name-input"),o=a.querySelector("#client-modal-error"),r=a.querySelector('[data-act="create"]');n?.focus();const s=()=>{t.classList.remove("open"),a.classList.remove("open"),document.removeEventListener("keydown",i),setTimeout(()=>{t.remove(),a.remove()},200)},i=c=>{c.key==="Escape"&&s()};document.addEventListener("keydown",i),t.addEventListener("click",s),a.querySelector(".client-modal__close")?.addEventListener("click",s),a.querySelector('[data-act="cancel"]')?.addEventListener("click",s);const l=async()=>{const c=(n?.value||"").trim();if(o.textContent="",!c){o.textContent="Please enter a client name.",n?.focus();return}r.disabled=!0;const f=r.innerHTML;r.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Adding…';try{const y=A.getConfig?.().BASE_URL||"",m=await fetch(`${y}/m5t/v5/acctGroup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({class:Fn,caption:c,parent:e.guid})}),b=await m.json().catch(()=>({}));if(!m.ok||!b?.ok){const k=m.status===403?"You are not authorized to add a client here.":b?.message||b?.error||`Failed (HTTP ${m.status})`;throw new Error(k)}it(`Added client “${c}”`,"success"),s(),await Bn(e)}catch(y){console.warn("[clients] create failed:",y),o.textContent=y.message||"Something went wrong. Please try again.",r.disabled=!1,r.innerHTML=f}};r?.addEventListener("click",l),n?.addEventListener("keydown",c=>{c.key==="Enter"&&l()})}const Da=e=>String(e||"").replace(/[^0-9]/g,"");async function Ci(e,t){const a=A.getConfig?.().BASE_URL||"",n={};try{((await(await fetch(`${a}/m5t/v5/coreAdAccount?owner_guid=${encodeURIComponent(e)}`)).json().catch(()=>({})))?.data||[]).forEach(h=>{n[h.provider]=h})}catch{}const o=n.google_ads,r=n.google_lsa,s=document.createElement("div");s.className="client-modal-scrim";const i=document.createElement("div");i.className="client-modal",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.innerHTML=`
    <div class="client-modal__head">
    ...
    </div>`,document.body.appendChild(s),document.body.appendChild(i),requestAnimationFrame(()=>{s.classList.add("open"),i.classList.add("open")});const l=i.querySelector("#aa-error"),c=i.querySelector('[data-act="save"]'),f=()=>{s.classList.remove("open"),i.classList.remove("open"),document.removeEventListener("keydown",y),setTimeout(()=>{s.remove(),i.remove()},200)},y=k=>{k.key==="Escape"&&f()};document.addEventListener("keydown",y),s.addEventListener("click",f),i.querySelector(".client-modal__close")?.addEventListener("click",f),i.querySelector('[data-act="cancel"]')?.addEventListener("click",f);const m=(k,g,h)=>{const v=`${a}/m5t/v5/coreAdAccount`;return g&&!h?fetch(v,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,provider:k,external_customer_id:g})}):g&&h&&g!==h.external_customer_id?fetch(`${v}/${encodeURIComponent(h.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({external_customer_id:g})}):!g&&h?fetch(`${v}/${encodeURIComponent(h.guid)}`,{method:"DELETE"}):null},b=async()=>{l.textContent="";const k=Da(i.querySelector("#aa-gads").value),g=Da(i.querySelector("#aa-lsa").value),h=[m("google_ads",k,o),m("google_lsa",g,r)].filter(Boolean);if(!h.length){f();return}c.disabled=!0;const v=c.innerHTML;c.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const x=await Promise.all(h);for(const I of x)if(!I.ok){const R=await I.json().catch(()=>({}));throw new Error(I.status===403?"You are not authorized to connect accounts for this client.":R?.error||R?.message||`Failed (HTTP ${I.status})`)}it("Ad accounts updated","success"),f()}catch(x){l.textContent=x.message||"Something went wrong. Please try again.",c.disabled=!1,c.innerHTML=v}};c?.addEventListener("click",b)}function Ii(e,t){if(!e)return;const a=document.createElement("div");a.className="client-modal-scrim";const n=document.createElement("div");n.className="client-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="invite-body">
      ...
      <div class="client-modal__actions">
    ...
    </div>`,document.body.appendChild(a),document.body.appendChild(n),requestAnimationFrame(()=>{a.classList.add("open"),n.classList.add("open")});const o=()=>{a.classList.remove("open"),n.classList.remove("open"),document.removeEventListener("keydown",r),setTimeout(()=>{a.remove(),n.remove()},200)},r=f=>{f.key==="Escape"&&o()};document.addEventListener("keydown",r),a.addEventListener("click",o),n.querySelector(".client-modal__close")?.addEventListener("click",o),n.querySelector('[data-act="cancel"]')?.addEventListener("click",o);const s=n.querySelector("#inv-email"),i=n.querySelector("#inv-error"),l=n.querySelector('[data-act="send"]');s?.focus();const c=f=>f.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(f.dataset.url),f.textContent="Copied!",setTimeout(()=>{f.textContent="Copy link"},1500)}catch{}});(async function(){const y=n.querySelector("#invite-pending");if(y)try{const m=A.getConfig?.().BASE_URL||"",k=await(await fetch(`${m}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invites`)).json().catch(()=>({})),g=k.ok&&Array.isArray(k.invites)?k.invites:[];if(!g.length){y.innerHTML="";return}y.innerHTML=`
        <div class="invite-pending">
          <div class="invite-pending__label">Pending invites</div>
          ${g.map(h=>`
            <div class="invite-pending__row">
              <span class="invite-pending__email${h.expired?" expired":""}" title="${U(h.email)}">${U(h.email)}${h.expired?" · expired":""}</span>
              <button class="client-modal__btn client-modal__btn--ghost invite-pending__copy" type="button" data-url="${U(h.inviteUrl)}">Copy link</button>
            </div>`).join("")}
        </div>`,y.querySelectorAll(".invite-pending__copy").forEach(c)}catch{y.innerHTML=""}})(),l?.addEventListener("click",async()=>{const f=(n.querySelector("#inv-email").value||"").trim(),y=(n.querySelector("#inv-first").value||"").trim(),m=(n.querySelector("#inv-last").value||"").trim();if(i.textContent="",!f||!y||!m){i.textContent="Email, first, and last name are required.";return}l.disabled=!0;const b=l.innerHTML;l.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Sending…';try{const k=A.getConfig?.().BASE_URL||"",g=await fetch(`${k}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:f,first:y,last:m})}),h=await g.json().catch(()=>({}));if(!g.ok||!h.ok){const x=g.status===409?"A user with that email already exists.":g.status===403?"You are not authorized to invite for this client.":h.message||h.error||`Failed (HTTP ${g.status})`;throw new Error(x)}it(`Invite created for ${f}`,"success"),n.querySelector("#invite-body").innerHTML=`
        <div class="client-modal__result">
          ...
          <p>${h.emailQueued?`An invite email is on its way to <strong>${U(f)}</strong>.`:`Invite created for <strong>${U(f)}</strong>.`}</p>
          ...
          <div class="client-modal__linkrow">
            <input class="client-modal__input" id="inv-link" type="text" readonly value="${U(h.inviteUrl)}" />
        ...
        </div>`;const v=n.querySelector("#inv-link");n.querySelector("#inv-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(v.value),n.querySelector("#inv-copy").textContent="Copied!"}catch{v.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",o)}catch(k){console.warn("[clients] invite failed:",k),i.textContent=k.message||"Something went wrong. Please try again.",l.disabled=!1,l.innerHTML=b}})}const Li={render:Pn,init:Dn},Ni=Object.freeze(Object.defineProperty({__proto__:null,default:Li,init:Dn,render:Pn},Symbol.toStringTag,{value:"Module"})),Ba="managed_client";let Ua=!1;const Oi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ee=e=>String(e??"").replace(/[&<>"']/g,t=>Oi[t]),Ha=(e,t="info")=>{try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}},$i=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Ri(){const e=A.getActiveOrg();let t=e&&e.channel!==Ba?e:null;if(!t){const n=A.getMemberships().find(o=>o.channel!==Ba);n&&(t={guid:n.orgGuid,channel:n.channel,memberRole:n.memberRole})}if(!t)return null;const a=A.getMemberships().find(n=>n.orgGuid===t.guid)?.name;return{...t,name:a}}function Mi(e){return Object.values(He).filter(t=>Oo(e,t.value)).sort((t,a)=>a.rank-t.rank)}function Fi(){if(Ua)return;const e=document.createElement("style");e.id="m5t-team-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ua=!0}function lt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Pi(e){const t=e.member_role||"member";return`
    <div class="team-row">
      <span class="team-avatar">${ee($i(e.name||e.email))}</span>
      ...
      <span class="team-role" data-role="${ee(t)}">${ee(He[t]?.label||t)}</span>
    </div>`}function Un(){return Fi(),`
    ...
    </div>`}async function Hn(){const e=Ri(),t=document.getElementById("team-invite-btn");if(!e){t&&(t.style.display="none"),document.getElementById("team-body").innerHTML=lt("info","Team management is available for agency and workspace accounts.");return}t?.addEventListener("click",()=>Di(e)),await zn(e)}async function zn(e){const t=document.getElementById("team-body"),a=document.getElementById("team-count");if(t)try{const n=A.getConfig?.().BASE_URL||"",[o,r]=await Promise.all([fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/members`),fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/invites`)]),s=(await o.json().catch(()=>({}))).members||[],i=(await r.json().catch(()=>({}))).invites||[],l=i.length?`
    ...
    <div class="team-modal__body" id="team-invite-body">
      ...
      <div class="team-modal__actions">
        ...
        </div>`;const h=n.querySelector("#tm-link");n.querySelector("#tm-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(h.value),n.querySelector("#tm-copy").textContent="Copied!"}catch{h.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",()=>{o(),zn(e)})}catch(b){console.warn("[team] invite failed:",b),s.textContent=b.message||"Something went wrong. Please try again.",i.disabled=!1,i.innerHTML=m}})}const Bi={render:Un,init:Hn},Ui=Object.freeze(Object.defineProperty({__proto__:null,default:Bi,init:Hn,render:Un},Symbol.toStringTag,{value:"Module"}));
