(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function a(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(o){if(o.ep)return;o.ep=!0;const r=a(o);fetch(o.href,r)}})();const An="modulepreload",Sn=function(e){return"/"+e},Ft={},q=function(t,a,n){let o=Promise.resolve();if(a&&a.length>0){let l=function(c){return Promise.all(c.map(g=>Promise.resolve(g).then(y=>({status:"fulfilled",value:y}),y=>({status:"rejected",reason:y}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),i=s?.nonce||s?.getAttribute("nonce");o=l(a.map(c=>{if(c=Sn(c),c in Ft)return;Ft[c]=!0;const g=c.endsWith(".css"),y=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${y}`))return;const h=document.createElement("link");if(h.rel=g?"stylesheet":An,g||(h.as="script"),h.crossOrigin="",h.href=c,i&&h.setAttribute("nonce",i),document.head.appendChild(h),g)return new Promise((v,b)=>{h.addEventListener("load",v),h.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(s){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=s,window.dispatchEvent(i),!i.defaultPrevented)throw s}return o.then(s=>{for(const i of s||[])i.status==="rejected"&&r(i.reason);return t().catch(r)})};var Tn=/([:*])(\w+)/g,kn="([^/]+)",Cn=/\*/g,Nn="?(?:.*)",In=/\/\?/g,Ln="/?([^/]+|)",On="(?:/^|^)",Rn="";function Na(e){return e===void 0&&(e="/"),Et()?location.pathname+location.search+location.hash:e}function P(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function ze(e){return typeof e=="string"}function $n(e){return typeof e=="function"}function Ve(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function Mn(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(a,n,o){return a===null&&(a={}),a[t[o]]=decodeURIComponent(n),a},null)}function qe(e){var t=P(e).split(/\?(.*)?$/);return[P(t[0]),t.slice(1).join("")]}function wt(e){for(var t={},a=e.split("&"),n=0;n<a.length;n++){var o=a[n].split("=");if(o[0]!==""){var r=decodeURIComponent(o[0]);t[r]?(Array.isArray(t[r])||(t[r]=[t[r]]),t[r].push(decodeURIComponent(o[1]||""))):t[r]=decodeURIComponent(o[1]||"")}}return t}function Ia(e,t){var a=qe(P(e.currentLocationPath)),n=a[0],o=a[1],r=o===""?null:wt(o),s=[],i;if(ze(t.path)){if(i=On+P(t.path).replace(Tn,function(y,h,v){return s.push(v),kn}).replace(Cn,Nn).replace(In,Ln)+"$",P(t.path)===""&&P(n)==="")return{url:n,queryString:o,hashString:Ve(e.to),route:t,data:null,params:r}}else i=t.path;var l=new RegExp(i,Rn),c=n.match(l);if(c){var g=ze(t.path)?Mn(c,s):c.groups?c.groups:c.slice(1);return{url:P(n.replace(new RegExp("^"+e.instance.root),"")),queryString:o,hashString:Ve(e.to),route:t,data:g,params:r}}return!1}function La(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function be(e,t){return typeof e[t]>"u"||e[t]===!0}function Fn(e){if(!e)return{};var t=e.split(","),a={},n;return t.forEach(function(o){var r=o.split(":").map(function(s){return s.replace(/(^ +| +$)/g,"")});switch(r[0]){case"historyAPIMethod":a.historyAPIMethod=r[1];break;case"resolveOptionsStrategy":n||(n={}),n.strategy=r[1];break;case"resolveOptionsHash":n||(n={}),n.hash=r[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":a[r[0]]=r[1]==="true";break}}),n&&(a.resolveOptions=n),a}function Et(){return typeof window<"u"}function Pn(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(a){return a}).forEach(function(a){["before","after","already","leave"].forEach(function(n){a[n]&&(t[n]||(t[n]=[]),t[n].push(a[n]))})}),t}function oe(e,t,a){var n=t||{},o=0;(function r(){if(!e[o]){a&&a(n);return}Array.isArray(e[o])?(e.splice.apply(e,[o,1].concat(e[o][0](n)?e[o][1]:e[o][2])),r()):e[o](n,function(s){typeof s>"u"||s===!0?(o+=1,r()):a&&a(n)})})()}oe.if=function(e,t,a){return Array.isArray(t)||(t=[t]),Array.isArray(a)||(a=[a]),[e,t,a]};function Pt(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=Na(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function nt(e,t){for(var a=0;a<e.instance.routes.length;a++){var n=e.instance.routes[a],o=Ia(e,n);if(o&&(e.matches||(e.matches=[]),e.matches.push(o),e.resolveOptions.strategy==="ONE")){t();return}}t()}function Dn(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function Un(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var Dt=Et(),Bn=La();function Hn(e,t){if(be(e.navigateOptions,"updateBrowserURL")){var a=("/"+e.to).replace(/\/\//g,"/"),n=Dt&&e.resolveOptions&&e.resolveOptions.hash===!0;Bn?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",n?"#"+a:a),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!n){var o=location.hash;location.hash="",location.hash=o}e.instance.__freezeListening=!1},1))):Dt&&(window.location.href=e.to)}t()}function Oa(e,t){var a=e.instance;if(!a.lastResolved()){t();return}oe(a.lastResolved().map(function(n){return function(o,r){if(!n.route.hooks||!n.route.hooks.leave){r();return}var s=!1,i=e.instance.matchLocation(n.route.path,e.currentLocationPath,!1);if(n.route.path!=="*")s=!i;else{var l=e.matches?e.matches.find(function(c){return n.route.path===c.route.path}):!1;s=!l}if(be(e.navigateOptions,"callHooks")&&s){oe(n.route.hooks.leave.map(function(c){return function(g,y){return c(function(h){h===!1?e.instance.__markAsClean(e):y()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return r()}]));return}else r()}}),{},function(){return t()})}function Gn(e,t){e.match.route.hooks&&e.match.route.hooks.before&&be(e.navigateOptions,"callHooks")?oe(e.match.route.hooks.before.map(function(a){return function(o,r){return a(function(s){s===!1?e.instance.__markAsClean(e):r()},e.match)}}).concat([function(){return t()}])):t()}function zn(e,t){be(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function Vn(e,t){e.match.route.hooks&&e.match.route.hooks.after&&be(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(a){return a(e.match)}),t()}function qn(e,t){var a=e.instance.lastResolved();if(a&&a[0]&&a[0].route===e.match.route&&a[0].url===e.match.url&&a[0].queryString===e.match.queryString){a.forEach(function(n){n.route.hooks&&n.route.hooks.already&&be(e.navigateOptions,"callHooks")&&n.route.hooks.already.forEach(function(o){return o(e.match)})}),t(!1);return}t()}function jn(e,t){var a=e.instance._notFoundRoute;if(a){e.notFoundHandled=!0;var n=qe(e.currentLocationPath),o=n[0],r=n[1],s=Ve(e.to);a.path=P(o);var i={url:a.path,queryString:r,hashString:s,data:null,route:a,params:r!==""?wt(r):null};e.matches=[i],e.match=i}t()}function Wn(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function Yn(e,t){e.instance._setCurrent(null),t()}function Ra(e,t){be(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var $a=[qn,Gn,zn,Vn],Ut=[Oa,jn,oe.if(function(e){var t=e.notFoundHandled;return t},$a.concat([Ra]),[Wn,Yn])];function pt(){return pt=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},pt.apply(this,arguments)}function Bt(e,t){var a=0;function n(){if(a===e.matches.length){Ra(e,t);return}oe($a,pt({},e,{match:e.matches[a]}),function(){a+=1,n()})}Oa(e,n)}function ot(e){e.instance.__markAsClean(e)}function ut(){return ut=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},ut.apply(this,arguments)}var Ht="[data-navigo]";function Kn(e,t){var a=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:Ht},n=this,o="/",r=null,s=[],i=!1,l,c=La(),g=Et();e?o=P(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function y(f){return f.indexOf("#")>=0&&(a.hash===!0?f=f.split("#")[1]||"/":f=f.split("#")[0]),f}function h(f){return P(o+"/"+P(f))}function v(f,x,N,M){return f=ze(f)?h(f):f,{name:M||P(String(f)),path:f,handler:x,hooks:Pn(N)}}function b(f,x,N){var M=this;return typeof f=="object"&&!(f instanceof RegExp)?(Object.keys(f).forEach(function(O){if(typeof f[O]=="function")M.on(O,f[O]);else{var ae=f[O],Ie=ae.uses,wn=ae.as,En=ae.hooks;s.push(v(O,Ie,[l,En],wn))}}),this):(typeof f=="function"&&(N=x,x=f,f=o),s.push(v(f,x,[l,N])),this)}function d(f,x){if(n.__dirty){n.__waiting.push(function(){return n.resolve(f,x)});return}else n.__dirty=!0;f=f?P(o)+"/"+P(f):void 0;var N={instance:n,to:f,currentLocationPath:f,navigateOptions:{},resolveOptions:ut({},a,x)};return oe([Pt,nt,oe.if(function(M){var O=M.matches;return O&&O.length>0},Bt,Ut)],N,ot),N.matches?N.matches:!1}function p(f,x){if(n.__dirty){n.__waiting.push(function(){return n.navigate(f,x)});return}else n.__dirty=!0;f=P(o)+"/"+P(f);var N={instance:n,to:f,navigateOptions:x||{},resolveOptions:x&&x.resolveOptions?x.resolveOptions:a,currentLocationPath:y(f)};oe([Dn,Un,nt,oe.if(function(M){var O=M.matches;return O&&O.length>0},Bt,Ut),Hn,ot],N,ot)}function _(f,x,N){var M=xe(f,x);return M!==null?(p(M.replace(new RegExp("^/?"+o),""),N),!0):!1}function w(f){return this.routes=s=s.filter(function(x){return ze(f)?P(x.path)!==P(f):$n(f)?f!==x.handler:String(x.path)!==String(f)}),this}function C(){c&&(this.__popstateListener=function(){n.__freezeListening||d()},window.addEventListener("popstate",this.__popstateListener))}function R(){this.routes=s=[],c&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=i=!0}function K(f,x){return n._notFoundRoute=v("*",f,[l,x],"__NOT_FOUND__"),this}function j(){if(g)return te().forEach(function(f){if(f.getAttribute("data-navigo")==="false"||f.getAttribute("target")==="_blank"){f.hasListenerAttached&&f.removeEventListener("click",f.navigoHandler);return}f.hasListenerAttached||(f.hasListenerAttached=!0,f.navigoHandler=function(x){if((x.ctrlKey||x.metaKey)&&x.target.tagName.toLowerCase()==="a")return!1;var N=f.getAttribute("href");if(typeof N>"u"||N===null)return!1;if(N.match(/^(http|https)/)&&typeof URL<"u")try{var M=new URL(N);N=M.pathname+M.search}catch{}var O=Fn(f.getAttribute("data-navigo-options"));i||(x.preventDefault(),x.stopPropagation(),n.navigate(P(N),O))},f.addEventListener("click",f.navigoHandler))}),n}function te(){return g?[].slice.call(document.querySelectorAll(a.linksSelector||Ht)):[]}function pe(f){return"/"+o+"/"+P(f)}function se(f){return l=f,this}function Ne(){return r}function xe(f,x,N){var M=s.find(function(Ie){return Ie.name===f}),O=null;if(M){if(O=M.path,x)for(var ae in x)O=O.replace(":"+ae,x[ae]);O=O.match(/^\//)?O:"/"+O}return O&&N&&!N.includeRoot&&(O=O.replace(new RegExp("^/"+o),"")),O}function E(f){return f.getAttribute("href")}function L(f){var x=qe(P(f)),N=x[0],M=x[1],O=M===""?null:wt(M),ae=Ve(f),Ie=v(N,function(){},[l],N);return{url:N,queryString:M,hashString:ae,route:Ie,data:null,params:O}}function ue(){return L(P(Na(o)).replace(new RegExp("^"+o),""))}function bn(f){var x={instance:n,currentLocationPath:f,to:f,resolveOptions:a};return nt(x,function(){}),x.matches?x.matches:!1}function yn(f,x,N){typeof x<"u"&&(typeof N>"u"||N)&&(x=h(x));var M={instance:n,to:x,currentLocationPath:x};Pt(M,function(){}),typeof f=="string"&&(f=typeof N>"u"||N?h(f):f);var O=Ia(M,{name:String(f),path:f,handler:function(){},hooks:{}});return O||!1}function Fe(f,x,N){return typeof x=="string"&&(x=Mt(x)),x?(x.hooks[f]||(x.hooks[f]=[]),x.hooks[f].push(N),function(){x.hooks[f]=x.hooks[f].filter(function(M){return M!==N})}):(console.warn("Route doesn't exists: "+x),function(){})}function Mt(f){return typeof f=="string"?s.find(function(x){return x.name===h(f)}):s.find(function(x){return x.handler===f})}function xn(f){f.instance.__dirty=!1,f.instance.__waiting.length>0&&f.instance.__waiting.shift()()}this.root=o,this.routes=s,this.destroyed=i,this.current=r,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=xn,this.on=b,this.off=w,this.resolve=d,this.navigate=p,this.navigateByName=_,this.destroy=R,this.notFound=K,this.updatePageLinks=j,this.link=pe,this.hooks=se,this.extractGETParameters=function(f){return qe(y(f))},this.lastResolved=Ne,this.generate=xe,this.getLinkPath=E,this.match=bn,this.matchLocation=yn,this.getCurrentLocation=ue,this.addBeforeHook=Fe.bind(this,"before"),this.addAfterHook=Fe.bind(this,"after"),this.addAlreadyHook=Fe.bind(this,"already"),this.addLeaveHook=Fe.bind(this,"leave"),this.getRoute=Mt,this._pathToMatchObject=L,this._clean=P,this._checkForAHash=y,this._setCurrent=function(f){return r=n.current=f},C.call(this),j.call(this)}var Jn=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Qn(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Le={exports:{}},Xn=Le.exports,Gt;function Zn(){return Gt||(Gt=1,(function(e,t){(function(a,n){var o={};a.PubSub?(o=a.PubSub,console.warn("PubSub already loaded, using existing version")):(a.PubSub=o,n(o)),e!==void 0&&e.exports&&(t=e.exports=o),t.PubSub=o,e.exports=t=o})(typeof window=="object"&&window||Xn||Jn,function(a){var n={},o=-1,r="*";function s(d){var p;for(p in d)if(Object.prototype.hasOwnProperty.call(d,p))return!0;return!1}function i(d){return function(){throw d}}function l(d,p,_){try{d(p,_)}catch(w){setTimeout(i(w),0)}}function c(d,p,_){d(p,_)}function g(d,p,_,w){var C=n[p],R=w?c:l,K;if(Object.prototype.hasOwnProperty.call(n,p))for(K in C)Object.prototype.hasOwnProperty.call(C,K)&&R(C[K],d,_)}function y(d,p,_){return function(){var C=String(d),R=C.lastIndexOf(".");for(g(d,d,p,_);R!==-1;)C=C.substr(0,R),R=C.lastIndexOf("."),g(d,C,p,_);g(d,r,p,_)}}function h(d){var p=String(d),_=!!(Object.prototype.hasOwnProperty.call(n,p)&&s(n[p]));return _}function v(d){for(var p=String(d),_=h(p)||h(r),w=p.lastIndexOf(".");!_&&w!==-1;)p=p.substr(0,w),w=p.lastIndexOf("."),_=h(p);return _}function b(d,p,_,w){d=typeof d=="symbol"?d.toString():d;var C=y(d,p,w),R=v(d);return R?(_===!0?C():setTimeout(C,0),!0):!1}a.publish=function(d,p){return b(d,p,!1,a.immediateExceptions)},a.publishSync=function(d,p){return b(d,p,!0,a.immediateExceptions)},a.subscribe=function(d,p){if(typeof p!="function")return!1;d=typeof d=="symbol"?d.toString():d,Object.prototype.hasOwnProperty.call(n,d)||(n[d]={});var _="uid_"+String(++o);return n[d][_]=p,_},a.subscribeAll=function(d){return a.subscribe(r,d)},a.subscribeOnce=function(d,p){var _=a.subscribe(d,function(){a.unsubscribe(_),p.apply(this,arguments)});return a},a.clearAllSubscriptions=function(){n={}},a.clearSubscriptions=function(p){var _;for(_ in n)Object.prototype.hasOwnProperty.call(n,_)&&_.indexOf(p)===0&&delete n[_]},a.countSubscriptions=function(p){var _,w,C=0;for(_ in n)if(Object.prototype.hasOwnProperty.call(n,_)&&_.indexOf(p)===0){for(w in n[_])C++;break}return C},a.getSubscriptions=function(p){var _,w=[];for(_ in n)Object.prototype.hasOwnProperty.call(n,_)&&_.indexOf(p)===0&&w.push(_);return w},a.unsubscribe=function(d){var p=function(pe){var se;for(se in n)if(Object.prototype.hasOwnProperty.call(n,se)&&se.indexOf(pe)===0)return!0;return!1},_=typeof d=="string"&&(Object.prototype.hasOwnProperty.call(n,d)||p(d)),w=!_&&typeof d=="string",C=typeof d=="function",R=!1,K,j,te;if(_){a.clearSubscriptions(d);return}for(K in n)if(Object.prototype.hasOwnProperty.call(n,K)){if(j=n[K],w&&j[d]){delete j[d],R=d;break}if(C)for(te in j)Object.prototype.hasOwnProperty.call(j,te)&&j[te]===d&&(delete j[te],R=!0)}return R}})})(Le,Le.exports)),Le.exports}var eo=Zn();const u=Qn(eo),m=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV.GO",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN.GO",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP.GO",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT.GO",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT.GO",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH.GO",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",AUTH_SCOPE_LOADED:"AUTH.SCOPE.LOADED",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",M5T_SIDE_NAV:"M5T_SIDE_NAV",M5T_SIDE_NAV_TAP:"M5T_SIDE_NAV.TAP",M5T_SIDE_NAV_COLLAPSE:"M5T_SIDE_NAV.COLLAPSE",M5T_SIDE_NAV_LOGO_TAP:"M5T_SIDE_NAV.LOGO_TAP",M5T_SIDE_NAV_ORG_SWITCH:"M5T_SIDE_NAV.ORG_SWITCH",M5T_SIDE_NAV_FOOTER_ACTION:"M5T_SIDE_NAV.FOOTER_ACTION",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL",MESSAGE:"MESSAGE",MESSAGE_CREATE:"MESSAGE.CREATE",MESSAGE_CREATED:"MESSAGE.CREATED",MESSAGE_EDIT:"MESSAGE.EDIT",MESSAGE_UPDATED:"MESSAGE.UPDATED",MESSAGE_DELETE:"MESSAGE.DELETE",MESSAGE_DELETED:"MESSAGE.DELETED",MESSAGE_REFRESH:"MESSAGE.REFRESH"}),rt={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://machfivemagnet-saas.onrender.com"};var st={};const F=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_USER_PREFS:"mvv_user_prefs",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_LS_LAST_ROUTE:"mvv_last_route",FF_SSE_API_DEBUG_LOGGING:!1,FF_SSE_API_TIMEOUT:3e4,FF_SSE_API_MAX_RETRIES:3,FF_SSE_API_CACHE_ENABLED:!0,FF_SSE_AUTH_TOKEN_EXPIRY_HOURS:6,FF_SSE_AUTH_AUTO_REFRESH:!1,FF_SSE_AUTH_SESSION_WARNING_MINUTES:5,FF_SSE_AUTH_REMEMBER_ME:!0,FF_SSE_AUTH_MAX_LOGIN_ATTEMPTS:5,FF_SSE_UI_TOAST_ENABLED:!0,FF_SSE_UI_TOAST_DURATION:5e3,FF_SSE_UI_LOADING_SPINNERS:!0,FF_SSE_UI_DARK_MODE:!1,FF_SSE_UI_ANIMATIONS:!0,FF_SSE_FEATURE_SIGNUP_ENABLED:!0,FF_SSE_FEATURE_PASSWORD_RESET_ENABLED:!0,FF_SSE_FEATURE_EMAIL_VERIFICATION_ENABLED:!0,FF_SSE_FEATURE_PROFILE_EDIT_ENABLED:!0,FF_SSE_FEATURE_ANALYTICS_ENABLED:!1,FF_SSE_CACHE_TTL_MS:3e5,FF_SSE_COMPRESSION_ENABLED:!0,FF_SSE_MAX_PAYLOAD_SIZE_MB:50,FF_SSE_DEBUG_VERBOSE:!1,FF_SSE_DEBUG_REDUX_DEVTOOLS:!1,FF_SSE_DEBUG_PERFORMANCE:!1,FF_SSE_DEBUG_BYPASS_AUTH:!1,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_BUILD_MODE:"LOCAL",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel"});function Ma(e,t=null){if(e in F)return F[e];if(typeof process<"u"&&st&&st[e]){const a=st[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}if(typeof import.meta<"u"&&rt&&rt[e]){const a=rt[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}return t}function to(e){return Ma(e,!1)===!0}function ao(){return{...F}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:F,getFlag:Ma,isEnabled:to,getAllFlags:ao});function no(){const e=t=>a=>{const n=a.detail?.pubsubTopic;n&&u.publish(n,a.detail)};document.addEventListener("nav-select",e()),document.addEventListener("logo-click",e()),document.addEventListener("nav-hover",e()),document.addEventListener("nav-double-tap",e()),document.addEventListener("nav-long-tap",e()),document.addEventListener("message-sent",e())}function oo(){console.log("[AppEvents] Initializing event listeners..."),u.subscribe(m.APP_READY,(a,n)=>{console.log("[AppEvents] APP_READY:",n)}),u.subscribe(m.APP_ERROR,(a,n)=>{console.error("[AppEvents] APP_ERROR:",n)}),u.subscribe(m.APP_SIGNOUT,(a,n)=>{console.log("[AppEvents] APP_SIGNOUT:",n)}),u.subscribe(m.ROUTE_NAV_BEFORE,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",n),u.publish(m.UI_LOADING_START)}),u.subscribe(m.ROUTE_NAV_AFTER,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",n),u.publish(m.UI_LOADING_END)}),u.subscribe(m.ROUTE_NAV_ERROR,(a,n)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",n),u.publish(m.APP_ERROR,{message:"Navigation error",details:n})}),u.subscribe(m.AUTH_SIGNIN_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",n)}),u.subscribe(m.AUTH_SIGNIN_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",n),u.publish(m.UI_TOAST,{message:n.message||"Sign in failed",type:"danger"})}),u.subscribe(m.AUTH_SIGNUP_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",n),u.publish(m.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"}),u.publish(m.AUTH_VERIFY_LINK)}),u.subscribe(m.AUTH_VERIFY_LINK,(a,n)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),u.subscribe(m.AUTH_SIGNUP_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",n),u.publish(m.UI_TOAST,{message:n.message||"Sign up failed",type:"danger"})}),u.subscribe(m.AUTH_SIGNOUT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",n),u.publish(m.UI_TOAST,{message:"Signed out successfully",type:"info"})}),u.subscribe(m.AUTH_SIGNUP,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),u.subscribe(m.AUTH_FORGOT,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),u.subscribe(m.AUTH_FORGOT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",n),u.publish(m.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),u.subscribe(m.AUTH_RESETHASH_NAV,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),u.subscribe(m.AUTH_RESETHASH_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",n),u.publish(m.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),u.subscribe(m.AUTH_TOKEN_EXPIRED,(a,n)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",n),u.publish(m.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),u.subscribe(m.I18N_SET_LANG,(a,n)=>{console.log("[AppEvents] I18N_SET_LANG:",n);const{langCode:o}=n;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),u.publish(m.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(r){console.error("[AppEvents] Error changing language:",r),u.publish(m.UI_TOAST,{message:`Failed to change language: ${r.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),u.subscribe("CONVERSATION.PROMPT",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",n.message),it(n.message,"user",n.timestamp),u.publish(m.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Agent prompt (no implementation):",n.message);break;case"AGENT_CANVAS":console.log("[AppEvents] Display message in canvas:",n.message),it(n.message,"user",n.timestamp),u.publish(m.CANVAS_DO_SCROLL);break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),u.subscribe("CONVERSATION.RESPONSE",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",n.message),it(n.message,"assistant",n.timestamp,n.streaming);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),u.subscribe(m.UI_LOADING_START,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),u.subscribe(m.UI_LOADING_END,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),u.subscribe(m.UI_TOAST,(a,n)=>{console.log("[AppEvents] UI_TOAST:",n)}),u.subscribe(m.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const a="0.1",n=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${a} 7/17/2026, 12:40:26 PM|© ${n} Mach Five Tech`,"night")}),no(),u.subscribe("M5T_PRIMARY_NAV",(a,n)=>{const o=a.split(".")[1];switch(o){case"TAP":e(n);break;case"LOGO_TAP":t();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function e(a){const{token:n,level:o,primaryToken:r}=a;switch(n){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),u.publish(m.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${n}`,{primaryToken:r});break}}function t(a){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 7/17/2026, 12:40:26 PM|© ${o} Mach Five Tech`,"night",5e3)}u.subscribe(m.AUTH_SIGNOUT,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(F.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function it(e,t="user",a=null,n=!1){const o=document.getElementById("chat-messages");if(!o){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}if(a||(a=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})),n&&t==="assistant"){const s=o.firstElementChild;if(s&&s.tagName.toLowerCase()==="m5t-chat-response"){s.setAttribute("message",e),console.log(`[AppEvents] Updated streaming ${t} bubble (${e.length} chars)`);return}}let r;t==="user"||t==="prompt"?r=document.createElement("m5t-chat-prompt"):r=document.createElement("m5t-chat-response"),r.setAttribute("message",e),r.setAttribute("timestamp",a),o.prepend(r),console.log(`[AppEvents] Added ${t} bubble to canvas (${e.length} chars)`)}class T{static CONFIG={BASE_URL:"https://machfivemagnet-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink",SCOPE:"sse_session_scope",ACTIVE_ORG:"sse_active_org"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",ME:"/m5t/v5/acctEntity/me",PING:"/ping"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#o=null;static#a=null;static#n=!1;static#r=null;static#i=null;static async init({BASE_URL:t,navigateFunction:a,customConfig:n={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(a&&typeof a=="function")this.#i=a;else throw new Error("navigateFunction is required and must be a function");return t&&(this.CONFIG.BASE_URL=t),n&&Object.keys(n).length>0&&(this.CONFIG={...this.CONFIG,...n}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#l(),this.#p(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#m(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#p(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((t=null)=>{if(t){if((window.location.hash||"").startsWith("#/accept-invite")&&(t==="splash"||t==="signin")){console.log("[AuthController] Ignoring mvvLegit redirect to",t,"— keeping invitee on accept-invite");return}console.log("[AuthController] mvvLegit navigation to:",t),this.#s(t)}}).setOnState((t=null)=>{if(t)switch(console.log("[AuthController] Auth state changed:",t),t){case"AUTH":case 4:this.#f();break;case"UNAUTH":case 1:this.#v();break;case"UNVERF":case 2:this.#_();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#s(t){if(!this.#i){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",t);const a=t.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",a),this.#i(a)}static#l(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);t&&(this.#o=JSON.parse(t),console.log("[AuthController] Entity state loaded:",this.#o?.email))}catch(t){console.error("[AuthController] Error loading entity state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#o=null}this.#r=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.SCOPE);t&&(this.#a=JSON.parse(t),console.log("[AuthController] Scope state loaded (cached):",this.#a?.uiMode))}catch(t){console.error("[AuthController] Error loading scope state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE),this.#a=null}}static#d(t){try{this.#o=t,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(t)),console.log("[AuthController] Entity state saved")}catch(a){console.error("[AuthController] Error saving entity state:",a)}}static#u(){this.#o=null,this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}}static getEntity(){return this.#o}static#c(t){try{this.#a=t,localStorage.setItem(this.CONFIG.LS_KEYS.SCOPE,JSON.stringify(t))}catch(a){console.error("[AuthController] Error saving scope state:",a)}}static async fetchScope(){if(typeof mvvLegit>"u"||!this.isAuthenticated())return console.log("[AuthController] fetchScope skipped — not authenticated"),this.#a;if(this.#n)return this.#a;this.#n=!0;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),a=t?`?org=${encodeURIComponent(t)}`:"",n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.ME}${a}`);if(n.status===401||n.status===403)return console.warn("[AuthController] /me unauthorized — signing out"),this.doSignout(!0),null;if(!n.ok)return console.warn(`[AuthController] /me failed (${n.status}) — using cached scope`),this.#a;const o=await n.json();return o?.ok?(this.#c(o),u.publish(m.AUTH_SCOPE_LOADED,o),console.log(`[AuthController] Scope loaded: ${o.uiMode} (${o.memberships?.length||0} org(s))`),o):(console.warn("[AuthController] /me returned not-ok — using cached scope"),this.#a)}catch(t){return console.error("[AuthController] fetchScope error:",t),this.#a}finally{this.#n=!1}}static async setActiveOrg(t){try{t?localStorage.setItem(this.CONFIG.LS_KEYS.ACTIVE_ORG,t):localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}return this.fetchScope()}static getScope(){return this.#a}static getCapabilities(){return this.#a?.capabilities||[]}static getUiMode(){return this.#a?.uiMode||"self_serve"}static getActiveOrg(){return this.#a?.activeOrg||null}static getMemberships(){return this.#a?.memberships||[]}static async doSignin(t,a){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,hash:a})}),o=await n.json();return n.status===303?(console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#d(o.entity)),setTimeout(()=>{this.#s(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o}):n.ok&&o.accessToken?(console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#d(o.entity),this.fetchScope(),console.log("[AuthController] Explicitly navigating to home"),this.#s(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}):{ok:!1,error:o.error||"Sign in failed",data:o}}catch(n){return console.error("[AuthController] Signin error:",n),{ok:!1,error:n.message}}}static async doSignout(t=!1){console.log("[AuthController] doSignout called, serverInitiated:",t);try{const a=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!a),!t&&a){const n=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(a)}`;if(console.log("[AuthController] Sending signout beacon to:",n),navigator.sendBeacon){const o=navigator.sendBeacon(n);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else a||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#u(),console.log("[AuthController] Stopping auth ping..."),this.#g(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(a){console.error("[AuthController] Signout error:",a),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(t){try{const a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await a.json();return a.ok&&n.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#d(n.entity),{ok:!0,data:n}):{ok:!1,error:n.error||"Sign up failed",data:n}}catch(a){return console.error("[AuthController] Signup error:",a),{ok:!1,error:a.message}}}static async doResetHash(t,a){try{const n=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({email:t,hash:a,modified_by:t})}),r=await o.json();return o.ok&&r.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:r}):{ok:!1,error:r.error||"Password reset failed",data:r}}catch(n){return console.error("[AuthController] Reset password error:",n),{ok:!1,error:n.message}}}static#m(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#h()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#g(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#h(){try{const t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);t.ok?console.log("[AuthController] Ping success"):(t.status===401||t.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(t){console.error("[AuthController] Ping error:",t)}}static setDeepLinkGuid(t){this.#r=t,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,t),console.log("[AuthController] Deep-link GUID stored:",t)}static getDeepLinkGuid(){return this.#r}static clearDeepLink(){this.#r=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#f(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#m(),this.fetchScope()}static#v(){console.log("[AuthController] User unauthenticated"),this.#g()}static#_(){console.log("[AuthController] User unverified")}static getAuthState(){try{const t=mvvLegit.getConf()?.LSKEY||"mvv",a=localStorage.getItem(t);if(!a)return"UNAUTH";if(typeof LZString>"u")return null;const n=LZString.decompressFromUTF16(a),r=JSON.parse(n)?.state;return r===1?"UNAUTH":r===2?"UNVERF":r===4?"AUTH":r===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(t){this.#s(t)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#h()}}class S{static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_dashboard:"Dashboard",nav_dashboard_tagline:"Overview of your activity",nav_magnets:"Your Magnets",nav_magnets_tagline:"Manage your conversational magnets",nav_templates:"Templates",nav_templates_tagline:"Start from a magnet template",nav_conversations:"Conversations",nav_conversations_tagline:"Captured lead conversations",nav_ab_testing:"A/B Testing",nav_ab_testing_tagline:"Experiment and optimize",nav_analytics:"Analytics",nav_analytics_tagline:"Performance and ad metrics",nav_ad_accounts:"Ad Accounts",nav_ad_accounts_tagline:"Connect advertising accounts",nav_clients:"Clients",nav_clients_tagline:"Manage your client accounts",nav_team:"Team",nav_team_tagline:"Invite and manage teammates",nav_billing:"Billing",nav_billing_tagline:"Plan, usage, and invoices",nav_settings:"Settings",nav_settings_tagline:"Account and workspace settings",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Rollers",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Rollers",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"滚动器",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:t,product:a,whitelabel:n,lang:o}){t&&(this.#t.buildMode=t),a&&(this.#t.product=a),n&&(this.#t.whitelabel=n),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(t,a={}){const n={...this.#t,...a},{buildMode:o,product:r,whitelabel:s,lang:i}=n;try{const l=this.#e[o]?.[r]?.[s]?.[i]?.[t];return l?Array.isArray(l)?l[Math.floor(Math.random()*l.length)]:l:(console.warn(`[MicrocopyManager] Token not found: ${t} (${o}/${r}/${s}/${i})`),null)}catch(l){return console.error(`[MicrocopyManager] Error retrieving token: ${t}`,l),null}}static getAll(t={}){const a={...this.#t,...t},{buildMode:n,product:o,whitelabel:r,lang:s}=a;try{return this.#e[n]?.[o]?.[r]?.[s]||null}catch(i){return console.error("[MicrocopyManager] Error retrieving all tokens",i),null}}static has(t,a={}){const n={...this.#t,...a},{buildMode:o,product:r,whitelabel:s,lang:i}=n;try{return!!this.#e[o]?.[r]?.[s]?.[i]?.[t]}catch{return!1}}static getAvailableLanguages(){const{buildMode:t,product:a,whitelabel:n}=this.#t;try{return Object.keys(this.#e[t]?.[a]?.[n]||{})}catch{return[]}}static update(t,a,n={}){const o={...this.#t,...n},{buildMode:r,product:s,whitelabel:i,lang:l}=o;try{return this.#e[r]||(this.#e[r]={}),this.#e[r][s]||(this.#e[r][s]={}),this.#e[r][s][i]||(this.#e[r][s][i]={}),this.#e[r][s][i][l]||(this.#e[r][s][i][l]={}),this.#e[r][s][i][l][t]=a,!0}catch(c){return console.error(`[MicrocopyManager] Error updating token: ${t}`,c),!1}}static delete(t,a={}){const n={...this.#t,...a},{buildMode:o,product:r,whitelabel:s,lang:i}=n;try{return delete this.#e[o]?.[r]?.[s]?.[i]?.[t],!0}catch(l){return console.error(`[MicrocopyManager] Error deleting token: ${t}`,l),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(t){try{return this.#e=t,!0}catch(a){return console.error("[MicrocopyManager] Error importing data",a),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:S});class re{static#e=!1;static#t=null;static#o=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const t=this.#n();S.setContext(t),console.log("[I18nController] Initialized with context:",t),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),F.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#r(),this.#p(),this.#e=!0,this.refresh()}static#a(t){const a={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},n=t.toLowerCase();return a[n]||"DEV"}static#n(){const a=this.#a("production"),n=localStorage.getItem(F.FF_SSE_LS_WHITELABEL)||F.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(F.FF_SSE_LS_USER_LANG)||F.FF_SSE_I18N_LANG;return{buildMode:a,product:F.FF_SSE_I18N_PRODUCT,whitelabel:n,lang:o}}static#r(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((t,a,n)=>{F.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",n),this.#t=n,setTimeout(()=>{this.refresh()},F.FF_SSE_I18N_APPLY_DELAY_MS)},F.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#i())}static#i(){setInterval(()=>{const a=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");a&&a!==this.#t&&(this.#t=a,this.refresh())},500)}static#p(){this.#o||(this.#o=new MutationObserver(t=>{let a=!1;for(const n of t){for(const o of n.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){a=!0;break}if(a)break}a&&(F.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#o.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#s(document.body),this.#l(document.body),F.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#s(t){const a=t.querySelectorAll("[data-meta-copywrite-i118n]");F.FF_SSE_I18N_DEBUG&&a.length>0&&console.log(`[I18nController] Processing ${a.length} elements`),a.forEach(n=>{try{const o=n.getAttribute("data-meta-copywrite-i118n"),r=JSON.parse(o);if(!r.token){console.warn("[I18nController] Missing token in config:",r);return}const s=r.attribute||"textContent",i=S.get(r.token);if(i===null){console.warn(`[I18nController] Microcopy not found for token: ${r.token}`);return}s==="textContent"?n.textContent=i:s==="innerHTML"?n.innerHTML=i:n.setAttribute(s,i),F.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${i}" to ${s} for token: ${r.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,n)}})}static#l(t){t.querySelectorAll("*").forEach(n=>{n.shadowRoot&&(this.#s(n.shadowRoot),this.#l(n.shadowRoot))})}static setLanguage(t){const a=S.getAvailableLanguages();if(!a.includes(t)){console.error(`[I18nController] Language not available: ${t}. Available:`,a);return}localStorage.setItem(F.FF_SSE_LS_USER_LANG,t),S.setContext({lang:t}),console.log("[I18nController] Language changed to:",t);const n=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:t}});document.dispatchEvent(n),this.refresh()}static setWhitelabel(t){localStorage.setItem(F.FF_SSE_LS_WHITELABEL,t),S.setContext({whitelabel:t}),F.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",t),this.refresh()}static getLanguage(){return S.getContext().lang}static getAvailableLanguages(){return S.getAvailableLanguages()}static getContext(){return S.getContext()}static destroy(){this.#o&&(this.#o.disconnect(),this.#o=null),this.#e=!1,this.#t=null,F.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{re.initialize()}):re.initialize());class At{static _initialized=!1;static _debug=!1;static init(t={}){if(this._initialized)return console.warn("[MachVive] Already initialized, skipping duplicate initialization"),this;if(this._debug=t.debug||!1,!window.mvvSSEther)return console.error("[MachVive] mvvSSEther not found - cannot initialize bridge"),console.error("[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()"),this;console.log("[MachVive] Initializing SSE to PubSub bridge...");const a=n=>{this._handleSSEMessage(n)};return window.mvvSSEther.onmessage(a),this._initialized=!0,console.log("[MachVive] ✓ SSE to PubSub bridge initialized successfully"),console.log("[MachVive] ✓ Bound callback to mvvSSEther.onmessage"),this}static _handleSSEMessage(t){try{this._debug&&console.log("[MachVive] SSE message received:",t);const a=t?.data;if(!a){this._debug&&console.log("[MachVive] No data in message, skipping");return}const n=a.data||a.package||a;if(!n){this._debug&&console.log("[MachVive] No package found in message, skipping");return}let o=n.cfg;const r=n.msg;if(this._debug&&(console.log("[MachVive] cfg (raw):",o,"type:",typeof o,"length:",o?.length),console.log("[MachVive] msg (raw):",r)),typeof o=="string"){if(o.trim()===""){this._debug&&console.log("[MachVive] cfg is empty string, skipping");return}try{o=JSON.parse(o),console.log("[MachVive] cfg (parsed):",o)}catch(i){console.warn("[MachVive] Failed to parse cfg as JSON:",{cfg:o,cfgLength:o.length,error:i.message});return}}else if(!o){this._debug&&console.log("[MachVive] cfg is empty/null, skipping");return}const s=o?.topic;if(!s){this._debug&&console.log("[MachVive] No topic found in cfg, skipping");return}if(console.log("[MachVive] Extracted topic:",s),!this._isValidTopic(s)){console.warn(`[MachVive] Topic '${s}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(s,r,t,a)}catch(a){console.error("[MachVive] Error handling SSE message:",a)}}static _isValidTopic(t){return!m||!m.hasOwnProperty(t)?(console.warn(`[MachVive] Topic '${t}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(t,a,n,o){try{if(!window.PubSub&&typeof PubSub>"u"){console.error("[MachVive] PubSub not available");return}const r=window.PubSub||PubSub,s={message:a,metadata:{source:"sse",sseEventId:n.id,timestamp:n.timestamp,appGuid:o.app_guid,channelGuid:o.channel_guid,eventAction:o.event_action,status:o.status,class:o.class,raw:o}};console.log(`[MachVive] Publishing to topic '${t}':`,s);const i=m[t];console.log(`[MachVive] AppBroadcast.${t} = '${i}'`),r.publish(i,s),console.log(`[MachVive] ✓ Published SSE message to topic: ${t}`)}catch(r){console.error(`[MachVive] Error publishing to topic '${t}':`,r)}}static debug(t){return this._debug=t,console.log(`[MachVive] Debug mode ${t?"enabled":"disabled"}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log("[MachVive] Reset complete"),this}}typeof module<"u"&&module.exports&&(module.exports=At);typeof window<"u"&&(window.MachVive=At);const zt="m5t_sidenav_collapsed",ro={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};class so extends HTMLElement{static get observedAttributes(){return["data-active-token","data-collapsed"]}constructor(){super(),this.attachShadow({mode:"open"}),this.items=[],this.orgs=[],this.activeOrgGuid=null,this.activeToken=null,this.footerBadge=null,this.loading=!1,this.lastFocus=null}#e=null;#t=t=>{if(this.getAttribute("data-open")==="true"){if(t.key==="Escape"){t.preventDefault(),this.closeDrawer();return}if(t.key==="Tab"){const a=this.#u();if(a.length<2)return;const n=a[0],o=a[a.length-1],r=this.shadowRoot.activeElement;t.shiftKey&&r===n?(t.preventDefault(),o.focus()):!t.shiftKey&&r===o&&(t.preventDefault(),n.focus())}}};#o=()=>{this.closeDrawer(),this.#c()};connectedCallback(){if(!this.hasAttribute("data-collapsed"))try{localStorage.getItem(zt)==="true"&&this.setAttribute("data-collapsed","true")}catch{}this.activeToken=this.getAttribute("data-active-token")||null,this.render(),this.#l(),this.addEventListener("keydown",this.#t),this.#e=window.matchMedia("(max-width: 768px)"),this.#e.addEventListener("change",this.#o),this.#c()}disconnectedCallback(){this.removeEventListener("keydown",this.#t),this.#e?.removeEventListener("change",this.#o)}attributeChangedCallback(t,a,n){a===n||!this.shadowRoot||(t==="data-active-token"?(this.activeToken=n,this.#d()):t==="data-collapsed"&&this.shadowRoot.firstChild&&(this.render(),this.#l()))}setState({buttons:t,orgs:a,activeOrg:n,footerBadge:o,loading:r}={}){t!==void 0&&(this.items=Array.isArray(t)?t:this.#a(t)||[]),a!==void 0&&(this.orgs=Array.isArray(a)?a:this.#a(a)||[]),n!==void 0&&(this.activeOrgGuid=n||null),o!==void 0&&(this.footerBadge=o||null),r!==void 0&&(this.loading=!!r),this.shadowRoot&&(this.render(),this.#l())}setButtons(t){this.setState({buttons:t})}setOrgs(t){this.setState({orgs:t})}setActiveOrgGuid(t){this.setState({activeOrg:t})}setFooterBadge(t){this.setState({footerBadge:t})}setActiveToken(t){this.activeToken=t||null,this.#d()}toggleCollapsed(t){const a=typeof t=="boolean"?t:this.getAttribute("data-collapsed")!=="true";this.setAttribute("data-collapsed",String(a));try{localStorage.setItem(zt,String(a))}catch{}this.dispatchEvent(new CustomEvent("nav-collapse",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_SIDE_NAV.COLLAPSE",collapsed:a,timestamp:Date.now()}}))}openDrawer(){this.lastFocus=this.shadowRoot.activeElement||document.activeElement,this.setAttribute("data-open","true"),this.shadowRoot.querySelector(".hamburger")?.setAttribute("aria-expanded","true"),this.#c(),(this.#u()[0]||this.shadowRoot.querySelector(".sidenav"))?.focus?.()}closeDrawer(){if(this.getAttribute("data-open")!=="true")return;this.removeAttribute("data-open");const t=this.shadowRoot.querySelector(".hamburger");t?.setAttribute("aria-expanded","false"),this.#c(),t&&this.#e?.matches?t.focus():this.lastFocus?.focus?.()}toggleDrawer(){this.getAttribute("data-open")==="true"?this.closeDrawer():this.openDrawer()}#a(t){try{return t?JSON.parse(t):null}catch(a){return console.error("[M5TSideNav] bad JSON:",a),null}}#n(t){return String(t??"").replace(/[&<>"']/g,a=>ro[a])}#r(t){return t?`<span class="ms" aria-hidden="true">${this.#n(t)}</span>`:""}#i(t){if(!t||!t.token)return"";const a=t.token===this.activeToken,n=t.route||"#",o=n.startsWith("#")?n:`#${n}`,r=typeof t.count=="number"&&t.count>0?`<span class="badge">${t.count}</span>`:"";return`
    ...
    `}attachEventListeners(){this.shadowRoot.querySelectorAll(".nav-button").forEach(n=>{const o=n.getAttribute("data-token"),r=n.getAttribute("data-level");n.addEventListener("click",s=>{o&&!s.currentTarget.disabled&&!this.longTapFired&&(r==="primary"?this.selectPrimaryButton(o):this.selectSecondaryButton(o)),this.longTapFired=!1}),n.addEventListener("dblclick",s=>{if(o&&!s.currentTarget.disabled){const i=this.getButtonData(o,r);console.log("[M5TPrimaryNav] Button double-clicked:",o),this.dispatchEvent(new CustomEvent("nav-double-tap",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.DOUBLE_TAP",token:o,level:r,caption:i.caption,tagline:i.tagline,timestamp:Date.now()}}))}}),n.addEventListener("mouseenter",s=>{if(o&&!s.currentTarget.disabled){const i=this.getButtonData(o,r);this.dispatchEvent(new CustomEvent("nav-hover",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.HOVER",token:o,level:r,caption:i.caption,tagline:i.tagline,action:"enter",timestamp:Date.now()}}))}}),n.addEventListener("mouseleave",s=>{if(o&&!s.currentTarget.disabled){const i=this.getButtonData(o,r);this.dispatchEvent(new CustomEvent("nav-hover",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.HOVER",token:o,level:r,caption:i.caption,tagline:i.tagline,action:"leave",timestamp:Date.now()}}))}}),n.addEventListener("mousedown",s=>{o&&!s.currentTarget.disabled&&(this.longTapActive=!0,this.longTapFired=!1,this.longTapTimer=setTimeout(()=>{const i=this.getButtonData(o,r);console.log("[M5TPrimaryNav] Button long-tap:",o),this.longTapFired=!0,this.dispatchEvent(new CustomEvent("nav-long-tap",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.LONG_TAP",token:o,level:r,caption:i.caption,tagline:i.tagline,timestamp:Date.now()}}))},this.longTapDelay))}),n.addEventListener("mouseup",s=>{this.longTapTimer&&(clearTimeout(this.longTapTimer),this.longTapTimer=null),this.longTapActive=!1}),n.addEventListener("mouseleave",s=>{this.longTapTimer&&(clearTimeout(this.longTapTimer),this.longTapTimer=null),this.longTapActive=!1})});const a=this.shadowRoot.querySelector(".logo");a&&a.addEventListener("click",()=>{console.log("[M5TPrimaryNav] Logo clicked"),this.logoTopic&&window.m5t?.pubsub?(console.log(`[M5TPrimaryNav] Publishing to topic: ${this.logoTopic}`),window.m5t.pubsub.publish(this.logoTopic,{timestamp:Date.now()})):this.logoTopic&&!window.m5t?.pubsub&&console.warn("[M5TPrimaryNav] Logo topic configured but window.m5t.pubsub not found"),this.dispatchEvent(new CustomEvent("logo-click",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.LOGO_TAP",timestamp:Date.now()}}))})}selectPrimaryButton(t){const a=this.buttons.find(o=>o.token===t),n=this.getButtonData(t,"primary");this.dispatchEvent(new CustomEvent("nav-select",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.TAP",token:t,level:"primary",caption:n.caption,tagline:n.tagline,hasSecondary:(a?.secondary?.length||0)>0,timestamp:Date.now()}})),this.selectedPrimaryToken!==t&&(this.selectedPrimaryToken=t,this.render(),this.attachEventListeners())}selectSecondaryButton(t){const a=this.getButtonData(t,"secondary");this.dispatchEvent(new CustomEvent("nav-select",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.TAP",token:t,primaryToken:this.selectedPrimaryToken,level:"secondary",caption:a.caption,tagline:a.tagline,timestamp:Date.now()}}))}updateButtons(t){this.setAttribute("data-buttons",JSON.stringify(t)),this.parseButtons(),this.render(),this.attachEventListeners()}updateCount(t,a,n="primary"){let o;n==="primary"?o=this.buttons.find(r=>r.token===t):o=this.getSecondaryButtons().find(s=>s.token===t),o&&(o.count=a,this.render(),this.attachEventListeners())}getSelection(){return{primary:this.selectedPrimaryToken,secondary:null}}}customElements.define("m5t-primary-nav",io);window.m5t=Object.create(null);window.m5t.pubsub=u;console.log("StreamSyncEngage SaaS Client - Starting...");console.log("Environment:","production");console.log("Document readyState:",document.readyState);console.log("window.mvvLegit:",typeof window.mvvLegit);console.log("globalThis.mvvLegit:",typeof globalThis.mvvLegit);try{console.log("mvvLegit (direct):",typeof mvvLegit)}catch(e){console.log("mvvLegit (direct): ReferenceError -",e.message)}const lo=Object.keys(window).filter(e=>e.toLowerCase().includes("mvv")||e.toLowerCase().includes("neodigm")||e.toLowerCase().includes("legit"));console.log("Possible Neodigm globals:",lo);const $=new Kn("/",{hash:!0});window.router=$;function ee(e){const t=e?`${e.replace(/-/g,"_")}_route`:"splash_route";return console.log(`[Router] Checking access: ${e} -> ${t}`),mvvLegit.isRouteAllowed(t)?!0:(console.warn(`[Router] Access denied to route: ${t}`),u.publish(m.UI_TOAST,{message:"Please sign in to access this page",type:"warning"}),!1)}function Y(e){console.log("[Router] Navigating to:",e),$.navigate(`/${e}`)}const co=new Set(["splash","signin","signup","forgot","resethash","verf-link","accept-invite","signout"]);let Oe={},mt={},gt=null;const po={admin:{caption:"Platform Admin",icon:"shield_person"},reseller:{caption:"Reseller",icon:"handshake"},managed:{caption:"Managed",icon:"visibility"},self_serve:{caption:"Self-Serve",icon:"rocket_launch"}};function lt(){const e=document.getElementById("m5t-side-nav");if(!e)return;const t=!T.getScope()&&T.isAuthenticated(),a=T.getCapabilities(),n=T.getUiMode(),o=Ze.getSideNav(a,{uiMode:n});Oe={},mt={};const r=c=>{c.route&&(Oe[c.route]={sectionToken:c.token,childToken:null,children:c.children||null},Array.isArray(c.children)&&c.children.forEach(g=>{g.route&&(mt[g.token]=g.route,Oe[g.route]={sectionToken:c.token,childToken:g.token,children:c.children})}))},s=c=>c.forEach(g=>{g.group&&Array.isArray(g.items)?s(g.items):r(g)});s(o);const i=T.getMemberships(),l=T.getActiveOrg();e.setState({buttons:o,orgs:i.map(c=>({guid:c.orgGuid,name:c.name||c.channel,channel:c.channel})),activeOrg:l?.guid||null,footerBadge:po[n]||null,loading:t}),gt&&Fa(gt)}function Fa(e){const t=document.getElementById("m5t-side-nav"),a=Oe[`/${e}`]||Oe[e]||null;t?.setActiveToken(a?.sectionToken||null),uo(a)}function uo(e){const t=document.getElementById("m5t-sub-nav"),a=document.getElementById("app-shell");if(!t)return;const n=e?.children;t.hidden=!1,n&&n.length>1?(t.updateButtons(n.map(o=>({token:o.token,caption:o.caption,enabled:!0,selected:o.token===e.childToken}))),a?.classList.add("has-sub-nav")):(t.updateButtons([]),a?.classList.remove("has-sub-nav"))}function mo(){const e=re.getAvailableLanguages&&re.getAvailableLanguages()||[];if(e.length<2){u.publish(m.UI_TOAST,{message:"Only one language is available",type:"info"});return}const t=localStorage.getItem(F.FF_SSE_LS_USER_LANG)||F.FF_SSE_I18N_LANG||e[0],a=e[(e.indexOf(t)+1)%e.length];re.setLanguage(a),u.publish(m.UI_TOAST,{message:`Language: ${a}`,type:"info"})}function go(){const e=document.getElementById("m5t-side-nav");if(!e)return;Ze.setAppToken("client-saas"),document.getElementById("app-shell")?.classList.toggle("nav-collapsed",e.getAttribute("data-collapsed")==="true"),e.addEventListener("nav-select",a=>{const n=a.detail?.route;n&&$.navigate(n.startsWith("/")?n:`/${n}`)}),e.addEventListener("logo-click",()=>$.navigate("/home")),e.addEventListener("nav-collapse",a=>{document.getElementById("app-shell")?.classList.toggle("nav-collapsed",!!a.detail?.collapsed)}),e.addEventListener("org-switch",a=>{const n=a.detail?.orgGuid;n&&T.setActiveOrg(n)}),e.addEventListener("footer-action",a=>{switch(a.detail?.action){case"account":$.navigate("/settings");break;case"signout":$.navigate("/signout");break;case"lang":mo();break}}),document.getElementById("m5t-sub-nav")?.addEventListener("nav-select",a=>{const n=mt[a.detail?.token];n&&$.navigate(n)}),document.addEventListener("language-changed",()=>lt()),lt(),u.subscribe(m.AUTH_SCOPE_LOADED,()=>lt())}function ho(e){gt=e;const t=document.getElementById("m5t-side-nav"),a=document.getElementById("app-shell");if(!t||!a)return;const n=!co.has(e);if(t.hidden=!n,a.classList.toggle("has-side-nav",n),n)Fa(e);else{const o=document.getElementById("m5t-sub-nav");o&&(o.hidden=!0),a.classList.remove("has-sub-nav")}}u.subscribe(m.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&ho(t.route)});const Pa=()=>{console.log("[Router] Route: splash"),u.publish(m.ROUTE_NAV_BEFORE,{route:"splash"});const e=new URLSearchParams(window.location.search||""),t=!!(e.get("uid")&&e.get("token"));q(t?()=>Promise.resolve().then(()=>xo):()=>Promise.resolve().then(()=>Ao),void 0).then(n=>{const o=document.getElementById("app");o.innerHTML=n.render(),n.init&&n.init(),u.publish(m.ROUTE_NAV_AFTER,{route:"splash"})}).catch(n=>{console.error("[Router] Error loading splash route:",n),u.publish(m.ROUTE_NAV_ERROR,{route:"splash",error:n})})};$.on("/",Pa);$.on("/splash",Pa);$.on("/signin",()=>{console.log("[Router] Route: /signin"),u.publish(m.ROUTE_NAV_BEFORE,{route:"signin"}),q(()=>Promise.resolve().then(()=>Io),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(m.ROUTE_NAV_AFTER,{route:"signin"})}).catch(e=>{console.error("[Router] Error loading signin route:",e),u.publish(m.ROUTE_NAV_ERROR,{route:"signin",error:e})})});$.on("/signup",()=>{console.log("[Router] Route: /signup"),u.publish(m.ROUTE_NAV_BEFORE,{route:"signup"}),q(()=>Promise.resolve().then(()=>Po),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(m.ROUTE_NAV_AFTER,{route:"signup"})}).catch(e=>{console.error("[Router] Error loading signup route:",e),u.publish(m.ROUTE_NAV_ERROR,{route:"signup",error:e})})});$.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),u.publish(m.ROUTE_NAV_BEFORE,{route:"verf-link"}),q(()=>Promise.resolve().then(()=>Bo),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(m.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(e=>{console.error("[Router] Error loading verf-link route:",e),u.publish(m.ROUTE_NAV_ERROR,{route:"verf-link",error:e})})});$.on("/forgot",()=>{console.log("[Router] Route: /forgot"),u.publish(m.ROUTE_NAV_BEFORE,{route:"forgot"}),q(()=>Promise.resolve().then(()=>Yo),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(m.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(e=>{console.error("[Router] Error loading forgot route:",e),u.publish(m.ROUTE_NAV_ERROR,{route:"forgot",error:e})})});$.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!ee("resethash")){Y("signin");return}u.publish(m.ROUTE_NAV_BEFORE,{route:"resethash"}),q(()=>Promise.resolve().then(()=>Qo),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(m.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(e=>{console.error("[Router] Error loading resethash route:",e),u.publish(m.ROUTE_NAV_ERROR,{route:"resethash",error:e})})});$.on("/home",()=>{if(console.log("[Router] Route: /home"),!ee("home")){Y("signin");return}u.publish(m.ROUTE_NAV_BEFORE,{route:"home"}),q(()=>Promise.resolve().then(()=>ir),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(m.ROUTE_NAV_AFTER,{route:"home"})}).catch(e=>{console.error("[Router] Error loading home route:",e),u.publish(m.ROUTE_NAV_ERROR,{route:"home",error:e})})});$.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!ee("signout")){Y("signin");return}u.publish(m.ROUTE_NAV_BEFORE,{route:"signout"}),q(()=>Promise.resolve().then(()=>dr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(m.ROUTE_NAV_AFTER,{route:"signout"})}).catch(e=>{console.error("[Router] Error loading signout route:",e),u.publish(m.ROUTE_NAV_ERROR,{route:"signout",error:e})})});const fo=[{path:"/templates",name:"templates",title:"Templates",icon:"content_copy"},{path:"/analytics",name:"analytics",title:"Analytics",icon:"monitoring"},{path:"/ad-accounts",name:"ad-accounts",title:"Ad Accounts",icon:"ads_click"},{path:"/billing",name:"billing",title:"Billing",icon:"receipt_long"},{path:"/settings",name:"settings",title:"Settings",icon:"settings"},{path:"/magnets/drafts",name:"magnets/drafts",title:"Magnets · Drafts",icon:"widgets"},{path:"/magnets/archived",name:"magnets/archived",title:"Magnets · Archived",icon:"widgets"},{path:"/analytics/conversions",name:"analytics/conversions",title:"Analytics · Conversions",icon:"monitoring"},{path:"/settings/workspace",name:"settings/workspace",title:"Settings · Workspace",icon:"settings"},{path:"/settings/integrations",name:"settings/integrations",title:"Settings · Integrations",icon:"settings"},{path:"/settings/security",name:"settings/security",title:"Settings · Security",icon:"settings"}];fo.forEach(({path:e,name:t,title:a,icon:n})=>{$.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!ee("home")){Y("signin");return}u.publish(m.ROUTE_NAV_BEFORE,{route:t}),q(()=>Promise.resolve().then(()=>mr),void 0).then(o=>{const r=document.getElementById("app");r.innerHTML=o.render({title:a,icon:n,name:t}),o.init&&o.init({name:t}),u.publish(m.ROUTE_NAV_AFTER,{route:t})}).catch(o=>{console.error(`[Router] Error loading section route (${t}):`,o),u.publish(m.ROUTE_NAV_ERROR,{route:t,error:o})})})});$.on("/conversations",()=>{if(console.log("[Router] Route: /conversations"),!ee("home")){Y("signin");return}u.publish(m.ROUTE_NAV_BEFORE,{route:"conversations"}),q(()=>Promise.resolve().then(()=>Er),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(m.ROUTE_NAV_AFTER,{route:"conversations"})}).catch(e=>{console.error("[Router] Error loading conversations route:",e),u.publish(m.ROUTE_NAV_ERROR,{route:"conversations",error:e})})});$.on("/ab-testing",()=>{if(console.log("[Router] Route: /ab-testing"),!ee("home")){Y("signin");return}u.publish(m.ROUTE_NAV_BEFORE,{route:"ab-testing"}),q(()=>Promise.resolve().then(()=>Pr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(m.ROUTE_NAV_AFTER,{route:"ab-testing"})}).catch(e=>{console.error("[Router] Error loading ab-testing route:",e),u.publish(m.ROUTE_NAV_ERROR,{route:"ab-testing",error:e})})});$.on("/magnets",()=>{if(console.log("[Router] Route: /magnets"),!ee("home")){Y("signin");return}u.publish(m.ROUTE_NAV_BEFORE,{route:"magnets"}),q(()=>Promise.resolve().then(()=>xs),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(m.ROUTE_NAV_AFTER,{route:"magnets"})}).catch(e=>{console.error("[Router] Error loading magnets route:",e),u.publish(m.ROUTE_NAV_ERROR,{route:"magnets",error:e})})});$.on("/leads",()=>{if(console.log("[Router] Route: /leads"),!ee("home")){Y("signin");return}u.publish(m.ROUTE_NAV_BEFORE,{route:"leads"}),q(()=>Promise.resolve().then(()=>Rs),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(m.ROUTE_NAV_AFTER,{route:"leads"})}).catch(e=>{console.error("[Router] Error loading leads route:",e),u.publish(m.ROUTE_NAV_ERROR,{route:"leads",error:e})})});$.on("/analytics/ad-performance",()=>{if(console.log("[Router] Route: /analytics/ad-performance"),!ee("home")){Y("signin");return}u.publish(m.ROUTE_NAV_BEFORE,{route:"analytics/ad-performance"}),q(()=>Promise.resolve().then(()=>Hs),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(m.ROUTE_NAV_AFTER,{route:"analytics/ad-performance"})}).catch(e=>{console.error("[Router] Error loading ad-performance route:",e),u.publish(m.ROUTE_NAV_ERROR,{route:"analytics/ad-performance",error:e})})});$.on("/clients",()=>{if(console.log("[Router] Route: /clients"),!ee("home")){Y("signin");return}u.publish(m.ROUTE_NAV_BEFORE,{route:"clients"}),q(()=>Promise.resolve().then(()=>Xs),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(m.ROUTE_NAV_AFTER,{route:"clients"})}).catch(e=>{console.error("[Router] Error loading clients route:",e),u.publish(m.ROUTE_NAV_ERROR,{route:"clients",error:e})})});$.on("/team",()=>{if(console.log("[Router] Route: /team"),!ee("home")){Y("signin");return}u.publish(m.ROUTE_NAV_BEFORE,{route:"team"}),q(()=>Promise.resolve().then(()=>di),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(m.ROUTE_NAV_AFTER,{route:"team"})}).catch(e=>{console.error("[Router] Error loading team route:",e),u.publish(m.ROUTE_NAV_ERROR,{route:"team",error:e})})});$.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),Y("splash")});u.subscribe(m.ROUTE_NAV,(e,t)=>{console.log("[Router] ROUTE_NAV event received:",t),t?.route&&Y(t.route)});function Vt(){console.log("[App] Waiting for Neodigm 55 library...");let e=0;const t=100,a=setInterval(()=>{e++,e%10===0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(a),vo()):e>=t&&(clearInterval(a),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
      ...
      `,u.publish(m.APP_ERROR,{message:"Failed to load authentication library"}))},100)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Vt):Vt();async function vo(){if(console.log("[App] Neodigm 55 loaded, initializing..."),oo(),re.initialize(),console.log("[App] I18n Controller initialized"),!await T.init({BASE_URL:"https://machfivemagnet-saas.onrender.com",navigateFunction:a=>{console.log("[AuthController] Navigation requested:",a),Y(a)}})){console.error("[App] AuthController initialization failed");return}const t=T.getEntity();t&&(console.log("[App] Session restored for:",t.email),u.publish(m.APP_USER_LOADED,{entity:t}),T.isAuthenticated()&&T.fetchScope()),u.publish(m.APP_READY,{timestamp:new Date().toISOString(),sessionUser:t}),go(),$.resolve(),window.AuthController=T,window.I18nController=re,window.MachVive=At,console.log("[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)")}u.subscribe(m.ROUTE_NAV_AFTER,(e,t)=>{typeof re<"u"&&re.refresh&&setTimeout(()=>{re.refresh()},100)});function et(e){return e=String(e),Math.abs(e.split("").reduce((t,a)=>(t<<5)-t+a.charCodeAt(0)|0,0))}let qt=!1;function _o(){if(qt)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
    .accept-invite-page {
  ...
  `,document.head.appendChild(e),qt=!0}function bo(){const e=new URLSearchParams(window.location.search||"");let t=e.get("uid")||"",a=e.get("token")||"";if(!t||!a){const n=window.location.hash||"",o=n.includes("?")?n.slice(n.indexOf("?")+1):"",r=new URLSearchParams(o);if(t=t||r.get("uid")||"",a=a||r.get("token")||"",!t||!a){const s=n.replace(/^#\/?/,"").split("?")[0].split("/").filter(Boolean);t=t||s[1]||"",a=a||s[2]||""}}try{return{uid:decodeURIComponent(t),token:decodeURIComponent(a)}}catch{return{uid:t,token:a}}}function Da(){return _o(),`
    ...
    </div>`}function Ua(){const{uid:e,token:t}=bo(),a=document.getElementById("accept-invite-form"),n=document.getElementById("ai-pass"),o=document.getElementById("ai-confirm"),r=document.getElementById("ai-submit"),s=document.getElementById("ai-msg");if(!a)return;const i=(l,c="error")=>{s.textContent=l,s.className=`accept-invite-msg ${c}`};if(!e||!t){i("This invitation link is invalid or incomplete. Please use the link from your email."),r.disabled=!0;return}a.addEventListener("submit",async l=>{l.preventDefault();const c=n.value||"",g=o.value||"";if(c.length<8){i("Password must be at least 8 characters.");return}if(c!==g){i("Passwords do not match.");return}r.disabled=!0,i("Setting up your account…","ok");const y=et(c);try{const h=T.getConfig?.().BASE_URL||"",v=await fetch(`${h}/m5t/v5/acctEntity/acceptInvite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({uid:e,token:t,hash:y})}),b=await v.json().catch(()=>({}));if(!v.ok||!b.ok){const p=v.status===410?"This invitation has expired. Ask for a new one.":v.status===409?"This invitation has already been used. Try signing in.":b.error||`Could not accept the invitation (HTTP ${v.status}).`;i(p),r.disabled=!1;return}try{window.history.replaceState({},"",window.location.pathname+window.location.hash)}catch{}i("Welcome! Signing you in…","ok"),(await T.doSignin(b.entity.email,y))?.ok||(i("Your account is ready. Please sign in.","ok"),setTimeout(()=>{window.location.hash="#/signin"},1200))}catch(h){console.error("[accept-invite] error:",h),i("Something went wrong. Please try again."),r.disabled=!1}})}const yo={render:Da,init:Ua},xo=Object.freeze(Object.defineProperty({__proto__:null,default:yo,init:Ua,render:Da},Symbol.toStringTag,{value:"Module"}));function wo(){return`
  ...
  `}function Ro(){console.log("[SignupRoute] Initialized");const e=document.getElementById("signupForm"),t=e.querySelector('button[type="submit"]');jt("togglePassword","password","eyeIcon"),jt("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),u.publish(m.ROUTE_NAV,{route:"signin"})}),e.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),r=document.getElementById("last").value.trim(),s=document.getElementById("email").value.trim(),i=document.getElementById("company").value.trim(),l=document.getElementById("phone").value.trim(),c=document.getElementById("password").value,g=document.getElementById("confirmPassword").value,y=document.getElementById("first"),h=document.getElementById("last"),v=document.getElementById("email"),b=document.getElementById("password"),d=document.getElementById("confirmPassword");if(!Wt(o,y,S.get("validation_first_name_required"))||!Wt(r,h,S.get("validation_last_name_required"))||!$o(s,v)||!Mo(c,b))return;if(c!==g){he(d,S.get("validation_password_mismatch"));return}const p=document.getElementById("acceptTerms");if(!p.checked){he(p,"Please accept the Terms of Service and Privacy Policy to continue.");return}t.disabled=!0,t.textContent=S.get("loading_creating_account"),await Fo(o,r,s,i,l,c)})}function jt(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),r=document.getElementById(a);!n||!o||!r||n.addEventListener("click",()=>{const s=o.type==="password";o.type=s?"text":"password",s?r.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:r.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function Wt(e,t,a){return e?!0:(he(t,a),!1)}function $o(e,t){if(!e)return he(t,S.get("validation_email_required")),!1;const a=(e.match(/@/g)||[]).length,n=(e.match(/\./g)||[]).length;return a!==1||n<1?(he(t,S.get("validation_email_invalid")),!1):!0}function Mo(e,t){if(!e)return he(t,S.get("validation_password_required")),!1;const a=Ba(e);return a.length>0?(he(t,Ha(a)),!1):!0}function he(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}async function Fo(e,t,a,n,o,r){const s=document.querySelector('button[type="submit"]');try{const i=et(r),l={email:a,hash:i,first:e,last:t};n&&(l.company=n),o&&(l.phone=o),l.terms_accepted=!0,l.legal_version=Lo;const c=await T.doSignup(l);if(c.ok)u.publish(m.AUTH_SIGNUP_SUCCESS,{email:a}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const g=c.error||c.message||S.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(g,"danger"),s.disabled=!1,s.textContent=S.get("create_account").toUpperCase(),u.publish(m.AUTH_SIGNUP_FAIL,{message:g})}}catch(i){console.error("[SignupRoute] Sign up error:",i),typeof neodigmToast<"u"&&neodigmToast.q(i.message||S.get("error_network"),"danger"),s.disabled=!1,s.textContent=S.get("create_account").toUpperCase(),u.publish(m.AUTH_SIGNUP_FAIL,{message:i.message})}}const Po=Object.freeze(Object.defineProperty({__proto__:null,init:Ro,render:Oo},Symbol.toStringTag,{value:"Module"}));function Do(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="/m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function Jo(){console.log("[ResethashRoute] Initialized");const e=document.getElementById("resethash-form"),t=e.querySelector('button[type="submit"]');Kt("toggleNewPassword","new-password","eyeIconNew"),Kt("toggleConfirmPassword","confirm-password","eyeIconConfirm"),e?.addEventListener("submit",async a=>{a.preventDefault();const n=e.email.value.trim(),o=e.newPassword.value,r=e.confirmPassword.value,s=document.getElementById("new-password"),i=document.getElementById("confirm-password");if(!o){we(s,S.get("validation_new_password_required"));return}const l=Ba(o);if(l.length>0){we(s,Ha(l));return}if(!r){we(i,S.get("validation_new_password_required"));return}if(o!==r){we(i,S.get("validation_password_mismatch"));return}t.disabled=!0,t.textContent=S.get("loading_resetting_password");try{const c=et(o),g=await T.doResetHash(n,c);g.ok?(typeof neodigmToast<"u"&&neodigmToast.q(S.get("success_password_reset"),"success"),u.publish(m.AUTH_RESETHASH_SUCCESS,{email:n})):(we(s,g.error||S.get("error_signin_failed")),t.disabled=!1,t.textContent=S.get("update_password").toUpperCase())}catch(c){console.error("[ResethashRoute] Reset password error:",c),we(s,c.message||S.get("error_network")),t.disabled=!1,t.textContent=S.get("update_password").toUpperCase()}})}function Kt(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),r=document.getElementById(a);!n||!o||!r||n.addEventListener("click",()=>{const s=o.type==="password";o.type=s?"text":"password",s?r.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:r.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function we(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}const Qo=Object.freeze(Object.defineProperty({__proto__:null,init:Jo,render:Ko},Symbol.toStringTag,{value:"Module"})),Z=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,X=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),Q=e=>Number(e||0).toLocaleString(),Ga=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",Xo=e=>(Ga(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function Zo(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric"})}catch{return""}}function er(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}let Jt=!1;function tr(){if(Jt)return;const e=document.createElement("style");e.id="m5t-dash-recent-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Jt=!0}function ar(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${X(Xo(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${X(Ga(e))}</span>
      <span class="recent-lead__sub">${X(e.email||e.phone||"")}</span>
    </span>
    <span class="recent-lead__badge" data-s="${X(e.status)}">${X(e.status)}</span>
    <span class="recent-lead__time">${X(Zo(e))}</span>
  </a>`}const Pe=({icon:e,label:t,valueId:a,value:n="—",subId:o,sub:r=""})=>`
  <div class="stat-card">
  ...
  </div>`,De=(e,t,a,{wide:n=!1,full:o=!1,controls:r=!1}={})=>`
  <div class="dashboard-card${n?" chart-card-wide":""}${o?" chart-card-full":""}">
  ...
  </div>`;let ht=30;function za(){return tr(),`
    <div class="page-shell" data-section="home">
      ...
      <div class="content-grid">
    ...
    </div>`}async function Va(){const e=T.getConfig?.().BASE_URL||"";document.getElementById("dash-periods")?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(ht=Number(a.dataset.days)||30,document.querySelectorAll("#dash-periods .chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===ht)),Xt(e))}),await Promise.all([Xt(e),or(e)])}const ne=(e,t)=>{const a=document.getElementById(e);a&&(a.textContent=t)},Ee=(e,t)=>{const a=document.getElementById(e);a&&(a.innerHTML=t)},Qt=e=>e.toISOString().slice(0,10);async function Xt(e){const t=new Date,a=Qt(new Date(t.getTime()-(ht-1)*864e5)),n=Qt(t);let o;try{const p=await fetch(`${e}/m5t/v5/dashboard/stats?from=${a}&to=${n}`);if(!p.ok)throw new Error(`HTTP ${p.status}`);if(o=await p.json(),!o.ok)throw new Error("stats not ok")}catch(p){console.warn("[dashboard] stats fetch failed:",p),["stat-active-magnets","stat-opens","stat-leads","stat-completion"].forEach(_=>ne(_,"—")),["stat-active-magnets-sub","stat-opens-sub","stat-leads-sub","stat-completion-sub"].forEach(_=>ne(_,"Unavailable")),["dash-trend","dash-funnel","dash-campaigns","dash-routes","dash-interactions"].forEach(_=>Ee(_,Z("error","Could not load. Please refresh.")));return}ne("stat-active-magnets",Q(o.magnets.active)),ne("stat-active-magnets-sub",o.magnets.total>o.magnets.active?`${Q(o.magnets.total-o.magnets.active)} paused`:o.magnets.active?"All running":"No magnets yet");const r=o.funnel||{};ne("stat-opens",r.opens?Q(r.opens):"—"),ne("stat-opens-sub",r.opens?r.engagement_rate!=null?`${r.engagement_rate}% engage`:`${Q(r.engaged)} engaged`:"No opens in this range yet");const s=o.leads||{};ne("stat-leads",Q(s.total));const i=(s.this_week||0)-(s.prev_week||0);ne("stat-leads-sub",s.total?`${Q(s.this_week)} this week (${i>=0?"+":""}${Q(i)} vs last)`:"No leads yet"),ne("stat-completion",r.completion_rate!=null?`${r.completion_rate}%`:"—"),ne("stat-completion-sub",r.opens?`${Q(r.completions)} completed of ${Q(r.opens)} opens`:"Appears once magnets get opened");const l=o.by_day||[],c=l.some(p=>p.opens||p.leads);Ee("dash-trend",c?rr(l):Z("show_chart","No activity in this range yet. Opens and leads chart here as visitors engage your magnets.")),Ee("dash-funnel",r.opens?nr(r):Z("filter_alt","The funnel fills in once your magnets record opens."));const g=o.top_campaigns||[];Ee("dash-campaigns",g.length?`<div class="dash-list">${g.map(p=>`
        <div class="dash-list__row">
          ...
          <span class="dash-list__main" title="${X(p.campaign)}">${X(p.campaign)}</span>
          <span class="dash-list__num">${Q(p.leads)}</span>
        </div>`).join("")}</div>`:Z("source","No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here."));const y={book:["event","Book"],chat:["chat","Chat"],call:["phone_in_talk","Call"],email:["mail","Email"],support:["support_agent","Support"]},h=Object.entries(r.routes||{}).sort((p,_)=>_[1]-p[1]),v=h.length?h[0][1]:0;Ee("dash-routes",h.length?`<div class="dash-funnel">${h.map(([p,_])=>{const[w,C]=y[p]||["touch_app",p];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${w}</span> ${X(C)}</span><span class="dash-funnel__val">${Q(_)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${v?Math.max(4,Math.round(_/v*100)):0}%"></div></div>
        </div>`}).join("")}</div>`:Z("touch_app","CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar."));const b={open:["visibility","Magnet opened"],engage:["touch_app","Visitor engaged"],route:["alt_route","Picked a channel"],complete:["check_circle","Completed: lead captured"]},d=o.recent_events||[];Ee("dash-interactions",d.length?`<div class="dash-list">${d.map(p=>{const[_,w]=b[p.event]||["sensors",p.event],C=p.event==="route"&&p.detail?` · ${X(p.detail)}`:"";return`<div class="dash-list__row">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">${_}</span></span>
          <span class="dash-list__main">${w}${C}</span>
          ${p.display_mode?`<span class="dash-list__mode">${X(p.display_mode)}</span>`:""}
          <span class="dash-list__time">${X(er(p.at))}</span>
        </div>`}).join("")}</div>`:Z("sensors","No interactions yet. They'll stream in as visitors engage your magnets."))}function nr(e){const t=[["Opened",e.opens,""],["Engaged",e.engaged," dash-funnel__bar--mid"],["Completed",e.completions," dash-funnel__bar--end"]],a=Math.max(1,e.opens||0);return`<div class="dash-funnel">${t.map(([n,o,r])=>`
    <div class="dash-funnel__row">
      <div class="dash-funnel__meta">
        <span class="dash-funnel__label">${n}</span>
        <span class="dash-funnel__val">${Q(o)} <span class="dash-funnel__pct">${Math.round((o||0)/a*100)}%</span></span>
      </div>
      <div class="dash-funnel__track"><div class="dash-funnel__bar${r}" style="width:${Math.max(2,Math.round((o||0)/a*100))}%"></div></div>
    </div>`).join("")}</div>`}async function or(e){const t=document.getElementById("recent-leads-body");if(t)try{const a=await fetch(`${e}/m5t/v5/m5mLead`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json(),o=(Array.isArray(n?.data)?n.data:[]).filter(r=>!["DELETED","ARCHIVED"].includes(r.status));t.innerHTML=o.length?o.slice(0,5).map(ar).join(""):Z("contacts","No leads captured yet. Publish a magnet to start collecting.")}catch(a){console.warn("[dashboard] Leads fetch failed:",a),t.innerHTML=Z("error","Could not load recent leads.")}}function Zt(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}const ea=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e));function rr(e){const v=e.length||1,b=Zt(Math.max(1,...e.map(E=>E.opens||0))),d=Zt(Math.max(1,...e.map(E=>E.leads||0))),p=748/v,_=Math.min(22,p*.55),w=E=>46+p*(E+.5),C=E=>266-E/b*248,R=E=>266-E/d*248,K=[0,.5,1].map(E=>{const L=266-E*248;return`<line x1="46" y1="${L.toFixed(1)}" x2="794" y2="${L.toFixed(1)}" stroke="#EAF0F7"/><text x="38" y="${(L+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${ea(b*E)}</text><text x="802" y="${(L+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${ea(d*E)}</text>`}).join(""),j=e.map((E,L)=>{const ue=C(E.opens||0);return`<rect x="${(w(L)-_/2).toFixed(1)}" y="${ue.toFixed(1)}" width="${_.toFixed(1)}" height="${Math.max(0,266-ue).toFixed(1)}" rx="3" fill="#0072BA" opacity="0.85"><title>${E.date}: ${E.opens} opens</title></rect>`}).join(""),te=e.map((E,L)=>`${w(L).toFixed(1)},${R(E.leads||0).toFixed(1)}`).join(" "),pe=v>1?`<polyline points="${te}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",se=e.map((E,L)=>`<circle cx="${w(L).toFixed(1)}" cy="${R(E.leads||0).toFixed(1)}" r="3.2" fill="#009473"><title>${E.date}: ${E.leads} leads</title></circle>`).join(""),Ne=Math.max(1,Math.ceil(v/6)),xe=e.map((E,L)=>L%Ne===0||L===v-1?`<text x="${w(L).toFixed(1)}" y="288" text-anchor="middle" class="dash-ax">${E.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="dash-chart" viewBox="0 0 840 300" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Magnet opens versus leads over time">
      ${K}${j}${pe}${se}${xe}
    </svg>`}const sr={render:za,init:Va},ir=Object.freeze(Object.defineProperty({__proto__:null,default:sr,init:Va,render:za},Symbol.toStringTag,{value:"Module"}));function lr(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/home" aria-label="Mach Five Magnet">
          <img src="/m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function cr(){console.log("[SignoutRoute] Initialized");const e=document.getElementById("confirm-signout-btn");e?.addEventListener("click",async()=>{e.disabled=!0,e.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await T.doSignout()})}const dr=Object.freeze(Object.defineProperty({__proto__:null,init:cr,render:lr},Symbol.toStringTag,{value:"Module"}));let ta=!1;function pr(){if(ta)return;const e=document.createElement("style");e.id="m5t-section-page-styles",e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),ta=!0}function qa({title:e="Section",icon:t="widgets",name:a=""}={}){return pr(),`
    ...
    </section>`}function ja(){}const ur={render:qa,init:ja},mr=Object.freeze(Object.defineProperty({__proto__:null,default:ur,init:ja,render:qa},Symbol.toStringTag,{value:"Module"})),gr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},B=e=>String(e??"").replace(/[&<>"']/g,t=>gr[t]),ft=()=>T.getConfig?.().BASE_URL||"",ct=e=>Number(e||0).toLocaleString(),G={conversations:[],counts:{},magnetNames:{},filter:"ALL"},aa={COMPLETED:{label:"Completed",icon:"check_circle"},IN_PROGRESS:{label:"In progress",icon:"pending"},ABANDONED:{label:"Abandoned",icon:"highlight_off"}},vt={book:"Book",chat:"Chat",call:"Call",email:"Email",support:"Support"};function Wa(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email)||null}function Ya(e){return(e.split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase()}function Ka(e){try{return new Date(e).toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return""}}function hr(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function Ja(e){return e==null?"—":e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,"0")}s`}let na=!1;function fr(){if(na)return;const e=document.createElement("style");e.id="m5t-convs-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),na=!0}const tt=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Qa(){return fr(),`
    ...
    </div>`}async function Xa(){await vr()}async function vr(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${ft()}/m5t/v5/conversations`),fetch(`${ft()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(G.conversations=n.conversations||[],G.counts=n.counts||{},a){const o=await a.json().catch(()=>({}));G.magnetNames={},(o.magnets||[]).forEach(r=>{G.magnetNames[r.guid]=r.name})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=tt("error","Could not load journeys. Please try again.");return}Za()}}function _r(){return G.filter==="ALL"?G.conversations:G.conversations.filter(e=>e.status===G.filter)}function br(e){const t=Wa(e.lead),a=G.magnetNames[e.magnet_guid]||"—",n=aa[e.status]||aa.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,r=(e.routes||[]).map(s=>vt[s]||s).join(", ");return`
    <tr class="convs-row" data-session="${B(e.session)}">
      <td>
        <span class="convs-who">
          ...
          <span><span class="convs-name">${t?B(t):'<span class="convs-muted">Anonymous visitor</span>'}</span>
            ${e.lead?.email?`<div class="convs-sub">${B(e.lead.email)}</div>`:r?`<div class="convs-sub">Picked: ${B(r)}</div>`:""}</span>
        </span>
      </td>
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${B(Ka(e.started_at))}">${B(hr(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${B(Ja(e.duration_s))}</td>
    </tr>`}function Za(){const e=document.getElementById("convs-body");if(!e)return;if(!G.conversations.length){e.innerHTML=tt("route","No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.");return}const t=_r(),a=[["ALL","All"],["COMPLETED","Completed"],["IN_PROGRESS","In progress"],["ABANDONED","Abandoned"]];e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${a.map(([n,o])=>`<button data-filter="${n}" class="${G.filter===n?"active":""}">${o}${n!=="ALL"&&G.counts[n]?` (${ct(G.counts[n])})`:""}</button>`).join("")}
      </div>
      <span class="convs-count">${ct(t.length)} of ${ct(G.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(br).join("")||`<tr><td colspan="6"><div class="convs-muted" style="padding:14px 4px">No ${G.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(G.filter=o.dataset.filter,Za())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&xr(o.dataset.session)})}const yr={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${vt[e]||e}`:""}`,route:e=>`Picked ${vt[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function xr(e){const t=G.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${ft()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=Wa(t.lead),o=G.magnetNames[t.magnet_guid]||"—",s=(a?.events||[]).filter((c,g,y)=>c.event!=="step"||!(y[g+1]&&y[g+1].event==="step")).map(c=>`
    <div class="convs-tl__item${c.event==="complete"?" done":""}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${B((yr[c.event]||(()=>c.event))(c.detail))}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      ...
      <div class="convs-drawer__body">
        ...
        ${s?`<div class="convs-tl">${s}</div>`:tt("timeline","No timeline available for this journey.")}
      </div>
    </aside>`,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("open"),i.querySelector(".convs-drawer").classList.add("open")});const l=()=>{i.classList.remove("open"),setTimeout(()=>i.remove(),220)};i.querySelector(".convs-drawer__close").addEventListener("click",l),i.addEventListener("click",c=>{c.target===i&&l()})}const wr={render:Qa,init:Xa},Er=Object.freeze(Object.defineProperty({__proto__:null,default:wr,init:Xa,render:Qa},Symbol.toStringTag,{value:"Module"})),Ar={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ge=e=>String(e??"").replace(/[&<>"']/g,t=>Ar[t]),oa=(e,t="info")=>{try{u.publish(m.UI_TOAST,{message:e,type:t})}catch{}},_t=()=>T.getConfig?.().BASE_URL||"",We=e=>Number(e||0).toLocaleString(),de={magnets:[],stats:{},canManage:!1},Sr={mag_title:"header title",mag_subtitle:"subtitle",mag_welcome:"welcome message",mag_theme_color:"color",mag_launcher_label:"launcher label"};let ra=!1;function Tr(){if(ra)return;const e=document.createElement("style");e.id="m5t-abt-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ra=!0}const St=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function en(){return Tr(),`
    ...
    </div>`}async function Tt(){const e=document.getElementById("abt-body");try{const t=new Date,a=new Date(t.getTime()-89*864e5).toISOString().slice(0,10),n=t.toISOString().slice(0,10),[o,r]=await Promise.all([fetch(`${_t()}/m5t/v5/magnets`),fetch(`${_t()}/m5t/v5/magnets/stats?from=${a}&to=${n}`)]),s=await o.json().catch(()=>({}));if(!s.ok)throw new Error(s.message||"Failed to load");de.magnets=s.magnets||[],de.canManage=!!s.canManage;const i=await r.json().catch(()=>({}));de.stats=i?.stats||{}}catch(t){console.warn("[ab-testing] load failed:",t),e&&(e.innerHTML=St("error","Could not load your tests. Please try again."));return}kr()}function kr(){const e=document.getElementById("abt-body");if(!e)return;const t=de.magnets.filter(n=>n.ab?.enabled),a=de.magnets.filter(n=>!n.ab?.enabled&&n.ab?.declared);if(!t.length&&!a.length){e.innerHTML=St("science","No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.");return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(Lr).join("")}`:"")+(a.length?`<div class="abt-sect">Completed Tests</div>${a.map(Or).join("")}`:""),e.querySelectorAll("[data-declare]").forEach(n=>n.addEventListener("click",()=>Rr(n.dataset.declare,n.dataset.winner)))}function Cr(e){const t=de.stats[e.guid]?.variants||{},a={opens:0,engaged:0,completions:0,rate:null,...t.A||{}},n={opens:0,engaged:0,completions:0,rate:null,...t.B||{}};return{A:a,B:n}}function Nr(e){const t=Object.keys(e?.b||{}).map(a=>Sr[a]||a);return t.length?`Changes: ${t.join(", ")}`:""}function Ir(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function sa(e,t,a,n,o,r){return`
    ...
    </div>`}function Lr(e){const t=e.ab,{A:a,B:n}=Cr(e),o=(n.rate??-1)>(a.rate??-1)?"B":(a.rate??-1)>(n.rate??-1)?"A":null,r=o&&a.rate!=null&&n.rate!=null?`+${Math.round(Math.abs(n.rate-a.rate)*10)/10}%`:"",s=$r(a,n),i=t.started_tz?Ir(t.started_tz):null,l=(a.opens||0)+(n.opens||0),c=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
      ...
      <div class="abt-compare">
        ${sa("Variant A","Control","The magnet as configured",a,o==="A",o==="A"?r:"")}
        <div class="abt-vs">VS</div>
        ${sa("Variant B",o==="B"?"Leading":"Challenger",Nr(t),n,o==="B",o==="B"?r:"")}
      </div>
      <div class="abt-sig">
...
<body>
  ...
  <\/script>
  <script>${a}<\/script>
</body></html>`}let ia=!1;function Br(){if(ia)return;const e=document.createElement("style");e.id="m5t-preview-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ia=!0}function Ct(e){Br();let t="desktop";const a=document.createElement("div");a.className="pv-scrim",a.innerHTML=`
    ...
    </div>`,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("open"));const n=a.querySelector(".pv-frame"),o=a.querySelector(".pv-stage"),r=()=>{try{n.srcdoc=Ur(e())}catch{}};r();const s=()=>{a.classList.remove("open"),setTimeout(()=>a.remove(),180)};return a.querySelector('[data-x="close"]').addEventListener("click",s),a.querySelector('[data-x="refresh"]').addEventListener("click",r),a.addEventListener("click",i=>{i.target===a&&s()}),a.querySelector(".pv-seg").addEventListener("click",i=>{const l=i.target.closest("button[data-device]");!l||l.dataset.device===t||(t=l.dataset.device,a.querySelectorAll(".pv-seg button").forEach(c=>c.classList.toggle("is-on",c.dataset.device===t)),o.dataset.device=t,r())}),{close:s,rebuild:r}}const Hr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},V=e=>String(e??"").replace(/[&<>"']/g,t=>Hr[t]),Gr=(e,t="info")=>{try{u.publish(m.UI_TOAST,{message:e,type:t})}catch{}},zr=()=>T.getConfig?.().BASE_URL||"",bt={single_select:{label:"Multiple choice",icon:"quiz",color:"#0072BA"},multi_select:{label:"Select all",icon:"checklist",color:"#0E6BA8"},scheduler:{label:"Scheduler",icon:"event",color:"#915E8B"},text:{label:"Short text",icon:"short_text",color:"#5B54C6"},email:{label:"Email",icon:"mail",color:"#0E8F86"},phone:{label:"Phone",icon:"call",color:"#2E8B57"},message:{label:"Message",icon:"chat",color:"#B4791F"}},tn=["single_select","multi_select","scheduler","text","email","phone","message"],la={chat:"Chat / default",book:"Book (scheduler)",support:"Support (intake)"},Nt=e=>bt[e]||bt.single_select,ye=e=>e==="single_select"||e==="multi_select",at=e=>e!=="message",$e=e=>e==="scheduler",Ye=e=>e==="email"?"email":e==="phone"?"phone":e==="scheduler"?"preferred_time":"",fe=()=>({meeting_label:"",start:"09:00",end:"17:00",mins:30,days:14}),Vr=["first_name","last_name","email","phone","company","product_interest","budget","timeline","message"],qr=[["","No icon"],["event","Calendar"],["schedule","Clock"],["mail","Email"],["sms","Text"],["phone","Phone"],["chat","Chat"],["description","Document"],["help","Question"],["place","Location"],["person","Person"],["bolt","Quick"],["check_circle","Check"],["star","Star"],["home","Home"],["build","Service"]];function jr(e,t){const a=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||"").trim());return a?`rgba(${parseInt(a[1],16)},${parseInt(a[2],16)},${parseInt(a[3],16)},${t})`:`rgba(0,114,186,${t})`}let ca=!1;function Wr(){if(ca)return;const e=document.createElement("style");e.id="m5t-flow-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ca=!0}let I=[],ie=null,Yr=0,ce=null,me=null;const Ce=()=>"f"+ ++Yr;function It(e="single_select"){return{_uid:Ce(),id:"",step_type:e,step_prompts:[""],step_options:ye(e)?[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]:[],step_columns:Ye(e)?[Ye(e)]:[],step_description:"",step_config:$e(e)?fe():null}}function Kr(e){return(Array.isArray(e)?e:[]).map(t=>({_uid:Ce(),id:t.id!=null?String(t.id):"",step_type:bt[t.step_type]?t.step_type:"single_select",step_prompts:Array.isArray(t.step_prompts)?t.step_prompts.map(String):[],step_options:(Array.isArray(t.step_options)?t.step_options:[]).map(a=>({label:a&&a.label!=null?String(a.label):"",goto:a&&a.goto!=null?String(a.goto):"",icon:a&&a.icon!=null?String(a.icon):""})),step_columns:Array.isArray(t.step_columns)?t.step_columns.map(String):[],step_description:t.step_description!=null?String(t.step_description):"",step_config:t.step_config&&typeof t.step_config=="object"?{...fe(),...t.step_config}:t.step_type==="scheduler"?fe():null}))}function da(){return[{_uid:Ce(),id:"",step_type:"text",step_prompts:["Great, and your name?"],step_options:[],step_columns:["first_name"],step_description:"",step_config:null},{_uid:Ce(),id:"",step_type:"email",step_prompts:["The best email to reach you?"],step_options:[],step_columns:["email"],step_description:"",step_config:null}]}function Jr(e,t){if(e==="book")return[{_uid:Ce(),id:"",step_type:"scheduler",step_prompts:["When works best for you?"],step_options:[],step_columns:["preferred_time"],step_description:"",step_config:fe()},...da()];if(e==="support"){const a=(t.actions||[]).find(r=>r&&r.type==="support"),n=a&&a.config&&Array.isArray(a.config.options)?a.config.options:[],o=n.length?n.map(r=>({label:r&&r.label||String(r),goto:"",icon:r&&r.icon||""})):["Sales enquiry","Support","Billing","Something else"].map(r=>({label:r,goto:"",icon:""}));return[{_uid:Ce(),id:"",step_type:"multi_select",step_prompts:["How can we help you today?"],step_options:o,step_columns:["support_topics"],step_description:"Select all that apply",step_config:null},...da()]}return[It("single_select")]}function pa(e,t){const a=e==="chat"?t.steps:t.routes&&t.routes[e],n=Kr(a);return n.length?n:e==="chat"?[It("single_select")]:Jr(e,t)}function Qr(e){ye(e.step_type)?e.step_options.length||(e.step_options=[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]):e.step_options=[],at(e.step_type)?!e.step_columns.length&&Ye(e.step_type)&&(e.step_columns=[Ye(e.step_type)]):e.step_columns=[],e.step_config=$e(e.step_type)?e.step_config||fe():null}function Xr(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${V(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${qr.map(([a,n])=>`<option value="${V(a)}"${a===e.icon?" selected":""}>${V(n)}</option>`).join("")}</select>
  ...
  </div>`}function Zr(e){const t=tn.map(n=>`<option value="${n}"${n===e.step_type?" selected":""}>${V(Nt(n).label)}</option>`).join(""),a=e.step_options.length<=1;return`<div class="flow-node__body">
...
`))}</textarea>
    ...
    <div class="flow-opts">${e.step_options.map(n=>Xr(n,a)).join("")}</div>
  ...
  </div>`}function es(e){const t=e.step_prompts.find(o=>String(o).trim()!=="")||"",a=t?`<div class="flow-node__prompt">“${V(t)}”</div>`:`<div class="flow-node__prompt is-empty">${e.step_type==="message"?"No message yet":"No question yet"}</div>`;let n="";if(ye(e.step_type)){const o=e.step_options.map(r=>String(r.label).trim()).filter(Boolean);if(o.length){const r=o.slice(0,4).map(i=>`<span class="flow-node__chip">${V(i)}</span>`).join(""),s=o.length>4?`<span class="flow-node__chip">+${o.length-4}</span>`:"";n=`<div class="flow-node__chips">${r}${s}</div>`}}else at(e.step_type)&&e.step_columns[0]&&(n=`<div class="flow-node__meta">Saves to <b>${V(e.step_columns[0])}</b></div>`);return`<div class="flow-node__preview">${a}${n}</div>`}function ts(e,t,a){const n=Nt(e.step_type),o=e._uid===ie,r=`--nc:${n.color};--nct:${jr(n.color,.14)}`;return`<div class="flow-node${o?" flow-node--open":""}" data-uid="${e._uid}" style="${r}"${o?"":' draggable="true"'}>
    ...
    ${o?Zr(e):es(e)}
  </div>`}const ua='<div class="flow-conn"><span class="flow-conn__line"></span><span class="material-symbols-outlined" aria-hidden="true">expand_more</span></div>';function J(){const e=document.getElementById("flow-nodes");if(!e)return;const t=I.length,a=['<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>',ua];I.forEach((n,o)=>{a.push(ts(n,o,t)),o<t-1&&a.push(ua)}),e.innerHTML=a.join("")}function le(){const e=document.querySelector(".flow-node--open");if(!e)return;const t=I.find(r=>r._uid===e.dataset.uid);if(!t)return;const a=e.querySelector(".flow-f-type");a&&(t.step_type=a.value);const n=e.querySelector(".flow-f-prompts");n&&(t.step_prompts=n.value.split(`
`));const o=e.querySelector(".flow-f-field");if(t.step_columns=o&&o.value.trim()?[o.value.trim()]:[],ye(t.step_type)){const r=t.step_options,s=[];e.querySelectorAll(".flow-opt").forEach((i,l)=>{s.push({label:i.querySelector(".flow-o-label")?.value??"",icon:i.querySelector(".flow-o-icon")?.value??"",goto:r[l]&&r[l].goto||""})}),t.step_options=s}else t.step_options=[];if($e(t.step_type)){const r=e.querySelector(".flow-f-mtlabel"),s=e.querySelector(".flow-f-start"),i=e.querySelector(".flow-f-end"),l=e.querySelector(".flow-f-mins");t.step_config={...t.step_config||fe(),...r?{meeting_label:r.value.trim()}:{},...s&&s.value?{start:s.value}:{},...i&&i.value?{end:i.value}:{},...l?{mins:parseInt(l.value,10)||30}:{}}}else t.step_config=null}function an(){document.querySelectorAll(".flow-node.drop-before, .flow-node.drop-after").forEach(e=>e.classList.remove("drop-before","drop-after"))}function Ae(){an(),document.querySelectorAll(".flow-node.dragging").forEach(e=>e.classList.remove("dragging")),ce=null,me=null}function as(e=I){if(!e.length)return"Add at least one step.";for(let t=0;t<e.length;t++){const a=e[t],n=t+1;if(!a.step_prompts.some(o=>String(o).trim()!==""))return`Step ${n}: add what the magnet should say.`;if(ye(a.step_type)&&!a.step_options.some(o=>String(o.label).trim()!==""))return`Step ${n}: add at least one choice.`;if(at(a.step_type)&&!a.step_columns.length)return`Step ${n}: choose which field this answer saves to.`}return""}function dt(e=I){let t=0;return e.forEach(a=>{const n=parseInt(a.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(a=>{const n=a.id&&String(a.id).trim()?String(a.id):String(++t),o=ye(a.step_type)?a.step_options.map(s=>{const i={label:String(s.label).trim(),goto:String(s.goto||"")};return s.icon&&(i.icon=String(s.icon)),i}).filter(s=>s.label!==""):[],r={id:n,step_type:a.step_type,step_prompts:a.step_prompts.map(s=>String(s)).filter(s=>s.trim()!==""),step_options:o,step_columns:a.step_columns.slice(),step_description:a.step_description||""};return $e(a.step_type)&&a.step_config&&(r.step_config={...fe(),...a.step_config}),r})}function ns(e,t){Wr();const a=["chat",...["book","support"].filter(h=>(e.actions||[]).some(v=>v&&v.type===h))],n={chat:pa("chat",e)};let o="chat";I=n.chat,ie=I.length===1?I[0]._uid:null,ce=null,me=null;const r=document.createElement("div");r.className="mag-modal-scrim",r.innerHTML=`
    <div class="mag-modal mag-flow" role="dialog" aria-modal="true" aria-label="Flow builder">
      ...
      <div class="mag-modal__body">
        ...
        <datalist id="flow-fields">${Vr.map(h=>`<option value="${V(h)}"></option>`).join("")}</datalist>
        ...
        <div class="flow-palette">
          ...
          <div class="flow-palette__grid" id="flow-palette">
            ${tn.map(h=>{const v=Nt(h);return`<button class="flow-palette__chip" type="button" data-type="${h}" style="--pc:${v.color}"><span class="material-symbols-outlined" aria-hidden="true">${v.icon}</span>${V(v.label)}</button>`}).join("")}
          </div>
        </div>
    ...
    </div>`,document.body.appendChild(r),J(),requestAnimationFrame(()=>{r.classList.add("open"),r.querySelector(".mag-modal").classList.add("open")});const s=r.querySelector("#flow-error"),i=r.querySelector("#flow-nodes"),l=()=>{s.textContent=""},c=()=>{Ae(),r.classList.remove("open"),setTimeout(()=>r.remove(),180)};r.querySelector(".mag-modal__close").addEventListener("click",c),r.querySelector('[data-x="cancel"]').addEventListener("click",c),r.addEventListener("click",h=>{h.target===r&&c()}),r.querySelector('[data-x="preview"]').addEventListener("click",()=>{le(),Ct(()=>kt({...e,home:!1,steps:dt(n[o])}))});const g=r.querySelector("#flow-route");g?.addEventListener("change",()=>{le(),o=g.value,n[o]||(n[o]=pa(o,e)),I=n[o],ie=I.length===1?I[0]._uid:null,l(),J()});const y=h=>{l(),le(),ie=ie===h?null:h,J()};i.addEventListener("click",h=>{const v=h.target.closest("button[data-x]"),b=h.target.closest(".flow-node");if(!b)return;const d=I.findIndex(p=>p._uid===b.dataset.uid);if(!(d<0)){if(v){const p=v.dataset.x;if(l(),le(),p==="up"&&d>0)[I[d-1],I[d]]=[I[d],I[d-1]],J();else if(p==="down"&&d<I.length-1)[I[d+1],I[d]]=[I[d],I[d+1]],J();else if(p==="del"&&I.length>1)ie===b.dataset.uid&&(ie=null),I.splice(d,1),J();else if(p==="addopt")I[d].step_options.push({label:"",goto:"",icon:""}),J();else if(p==="delopt"){const _=v.closest(".flow-opt"),w=Array.from(_.parentNode.children).indexOf(_);I[d].step_options.length>1&&w>=0&&(I[d].step_options.splice(w,1),J())}return}h.target.closest(".flow-node__body")||(h.target.closest(".flow-node__hd")||h.target.closest(".flow-node__preview"))&&y(b.dataset.uid)}}),i.addEventListener("change",h=>{if(!h.target.classList.contains("flow-f-type"))return;l(),le();const v=I.find(b=>b._uid===h.target.closest(".flow-node")?.dataset.uid);v&&Qr(v),J()}),i.addEventListener("dragstart",h=>{const v=h.target.closest(".flow-node");if(!(!v||v.getAttribute("draggable")!=="true")){ce=v.dataset.uid,h.dataTransfer.effectAllowed="move";try{h.dataTransfer.setData("text/plain",ce)}catch{}requestAnimationFrame(()=>v.classList.add("dragging"))}}),i.addEventListener("dragover",h=>{if(!ce)return;h.preventDefault(),h.dataTransfer.dropEffect="move";const v=h.target.closest(".flow-node");if(an(),!v||v.dataset.uid===ce){me=null;return}const b=v.getBoundingClientRect(),d=h.clientY>b.top+b.height/2;v.classList.add(d?"drop-after":"drop-before"),me={uid:v.dataset.uid,after:d}}),i.addEventListener("drop",h=>{if(!ce||!me){Ae();return}h.preventDefault(),l(),le();const v=I.findIndex(p=>p._uid===ce);if(v<0){Ae();return}const[b]=I.splice(v,1),d=I.findIndex(p=>p._uid===me.uid);if(d<0){I.splice(v,0,b),Ae();return}I.splice(me.after?d+1:d,0,b),Ae(),J()}),i.addEventListener("dragend",Ae),r.querySelector("#flow-palette").addEventListener("click",h=>{const v=h.target.closest("[data-type]");if(!v)return;l(),le();const b=It(v.dataset.type);I.push(b),ie=b._uid,J(),i.lastElementChild?.scrollIntoView({behavior:"smooth",block:"nearest"})}),r.querySelector('[data-x="save"]').addEventListener("click",async h=>{const v=h.currentTarget;le();const b=Object.keys(n);for(const d of b){const p=as(n[d]);if(p){d!==o&&(o=d,I=n[d],ie=null,g&&(g.value=d),J()),s.textContent=(b.length>1?`${la[d]||d}: `:"")+p;return}}v.disabled=!0,s.textContent="";try{for(const d of b){const p=d==="chat"?{steps:dt(n[d])}:{route:d,steps:dt(n[d])},w=await(await fetch(`${zr()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(p)})).json().catch(()=>({}));if(!w.ok)throw new Error(w.message||"Save failed")}Gr(b.length>1?"Flows saved":"Flow saved","success"),c(),typeof t=="function"&&t()}catch(d){v.disabled=!1,s.textContent=d.message||"Something went wrong."}})}let ma=!1;const z={magnets:[],owners:[],canProvision:!1,canManage:!1,primaryOrgGuid:null,stats:{}},os={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},k=e=>String(e??"").replace(/[&<>"']/g,t=>os[t]),ve=(e,t="info")=>{try{u.publish(m.UI_TOAST,{message:e,type:t})}catch{}},_e=()=>T.getConfig?.().BASE_URL||"",nn=e=>`<script src="${_e()}/m5t/v5/coreSnippet?appguid=${e}" async><\/script>`,rs={chat:"Chat bubble",right_slide:"Slide-in panel",modal:"Modal",inline:"Inline"},ss={chat:"chat",right_slide:"vertical_split",modal:"web_asset",inline:"view_agenda"},is=[{value:"inline",icon:"view_agenda",label:"Inline"},{value:"chat",icon:"chat",label:"Chat"},{value:"right_slide",icon:"vertical_split",label:"Slide"},{value:"modal",icon:"web_asset",label:"Modal"}],ls=[{value:"auto",icon:"brightness_auto",label:"Auto"},{value:"light",icon:"light_mode",label:"Light"},{value:"dark",icon:"dark_mode",label:"Dark"}],cs=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],on={book:{label:"Book",icon:"event",kind:"book"},chat:{label:"Chat",icon:"chat",kind:"flow"},call:{label:"Call",icon:"phone",kind:"value",placeholder:"Phone number"},email:{label:"Email",icon:"mail",kind:"value",placeholder:"Email address"},support:{label:"Support",icon:"support_agent",kind:"support"}},ds=["book","chat","call","email","support"];function ga(e,t,a){return`<div class="mag-seg" role="radiogroup" aria-label="${k(e)}">${a.map(n=>`
    <label><input type="radio" name="${k(e)}" value="${k(n.value)}"${n.value===t?" checked":""}>
      <span><span class="material-symbols-outlined" aria-hidden="true">${k(n.icon)}</span>${k(n.label)}</span></label>`).join("")}</div>`}function ps(e,t){const a=on[e],n=!!t,o=n?"":" disabled";let r="";if(a.kind==="value")r=`<input class="mag-modal__input mag-cta__val" type="text" placeholder="${k(a.placeholder)}" value="${k(t?.value||"")}"${o}>`;else if(a.kind==="book"){const i=t?.config?.meeting_label||t?.value||"";r=`<input class="mag-modal__input mag-cta__val" type="text" placeholder="Meeting label (e.g. 15 minute call), or paste a booking link" value="${k(i)}"${o}>`}else r=`<span class="mag-cta__note">${a.kind==="support"?"Multi-select intake":"Opens your conversation flow"}</span>`;let s="";if(a.kind==="support"){const i=(t?.config?.options||[]).map(l=>l&&l.label||l).filter(Boolean);s=`<textarea class="mag-modal__input mag-cta__opts" rows="3" placeholder="Support options, one per line (e.g. Sales&#10;Support&#10;Billing)"${o}>${k(i.join(`
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${a.kind}">
    ...
    ${s}
  </div>`}function us(){if(ma)return;const e=document.createElement("style");e.id="m5t-magnets-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ma=!0}function yt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function ms(e){const t=z.stats[e];if(!t||!t.opens&&!t.leads)return'<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>';const a=n=>Number(n||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function gs(e){const t=z.owners.length>1||T.getMemberships().length>1,a=(e.domains||[]).filter(Boolean),n=z.canManage;return`
    <div class="mag-card" data-guid="${k(e.guid)}">
      ...
      <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${ss[e.display_mode]||"chat"}</span>${k(rs[e.display_mode]||"Chat bubble")}${e.ab?.enabled?'&nbsp;&nbsp;<span class="mag-ab-chip"><span class="material-symbols-outlined" aria-hidden="true">science</span>A/B</span>':""}</span>
      ${ms(e.guid)}
    ...
    </div>`}async function fs(){document.getElementById("mag-new-btn")?.addEventListener("click",()=>sn(null)),document.getElementById("mag-body")?.addEventListener("click",vs),await Me()}async function Me(){const e=document.getElementById("mag-body");if(!e)return;try{const[a,n]=await Promise.all([fetch(`${_e()}/m5t/v5/magnets`),fetch(`${_e()}/m5t/v5/magnets/stats`).catch(()=>null)]),o=await a.json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Failed to load");z.magnets=o.magnets||[],z.owners=o.owners||[],z.canProvision=!!o.canProvision,z.canManage=!!o.canManage,z.primaryOrgGuid=o.primaryOrgGuid||null;const r=n?await n.json().catch(()=>({})):{};z.stats=r?.stats||{}}catch{e.innerHTML=yt("error","Could not load your magnets. Please try again.");return}const t=document.getElementById("mag-new-btn");if(t&&(t.style.display=z.canProvision?"":"none"),!z.magnets.length){e.innerHTML=yt("widgets",z.canProvision?"No magnets yet. Click “New magnet” to create your first.":"No magnets yet.");return}e.innerHTML=`<div class="mag-grid">${z.magnets.map(gs).join("")}</div>`}function vs(e){const t=e.target.closest("[data-action]");if(!t)return;const a=t.dataset.guid,n=z.magnets.find(r=>r.guid===a),o=t.dataset.action;if(o==="copy")return _s(a);if(n){if(o==="preview")return Ct(()=>kt(n));if(o==="edit")return sn(n);if(o==="flow")return ns(n,Me);if(o==="toggle")return bs(n);if(o==="delete")return ys(n)}}async function _s(e){try{await navigator.clipboard.writeText(nn(e)),ve("Embed snippet copied","success")}catch{ve("Copy failed","danger")}}async function bs(e){const t=e.status==="ENABLED"?"DISABLED":"ENABLED";try{if(!(await(await fetch(`${_e()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw new Error;ve(t==="ENABLED"?"Magnet enabled":"Magnet disabled","success"),await Me()}catch{ve("Update failed","danger")}}async function ys(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`))try{if(!(await(await fetch(`${_e()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"})).json().catch(()=>({}))).ok)throw new Error;ve("Magnet deleted","success"),await Me()}catch{ve("Delete failed","danger")}}function ha(e){const t=[];return e.querySelectorAll(".mag-cta").forEach(a=>{if(!a.querySelector(".mag-cta__on").checked)return;const n=a.dataset.type,o=a.dataset.kind,r=a.querySelector(".mag-cta__val"),s=r?r.value.trim():"";if(o==="value")s&&t.push({type:n,value:s});else if(o==="book"){const i={type:n};s&&(/^https?:\/\//i.test(s)?i.value=s:i.config={meeting_label:s}),t.push(i)}else if(o==="support"){const i=(a.querySelector(".mag-cta__opts")?.value||"").split(`
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:rn(e),actions:t}}function rn(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",r=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==r.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}function sn(e){const t=!!e,a=!t&&z.owners.length>1,n=e?.display_mode||"chat",o=e?.theme_mode||"auto",r={};(e?.actions||[]).forEach(g=>{g&&g.type&&(r[g.type]=g)});const s=t?!!e.home:!0,i=t?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",l=document.createElement("div");l.className="mag-modal-scrim",l.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${t?"Edit magnet":"New magnet"}">
      ...
      <div class="mag-modal__body">
        ...
        <select class="mag-modal__select" id="mag-f-owner">
          ${z.owners.map(g=>`<option value="${k(g.guid)}"${g.guid===z.primaryOrgGuid?" selected":""}>${k(g.name||g.guid)}</option>`).join("")}
        </select>`:""}
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${cs.map(g=>`<option value="${g.value}"${(e?e.trigger||"none":"on_load")===g.value?" selected":""}>${k(g.label)}</option>`).join("")}
        </select>
    ...
    </div>`,document.body.appendChild(l),requestAnimationFrame(()=>{l.classList.add("open"),l.querySelector(".mag-modal").classList.add("open")});const c=()=>{l.classList.remove("open"),setTimeout(()=>l.remove(),180)};l.querySelector(".mag-modal__close").addEventListener("click",c),l.querySelector('[data-x="cancel"]').addEventListener("click",c),l.addEventListener("click",g=>{g.target===l&&c()}),l.querySelector("#mag-f-name").focus(),l.querySelectorAll(".mag-cta").forEach(g=>{const y=g.querySelector(".mag-cta__on"),h=g.querySelector(".mag-cta__val"),v=g.querySelector(".mag-cta__opts");y.addEventListener("change",()=>{h&&(h.disabled=!y.checked),v&&(v.disabled=!y.checked),y.checked&&(h||v)?.focus()}),h&&h.addEventListener("input",()=>{h.value.trim()&&!y.checked&&(y.checked=!0,v&&(v.disabled=!1))})}),l.querySelector('[data-x="preview"]')?.addEventListener("click",()=>Ct(()=>kt({...e,...ha(l)}))),l.querySelector('[data-x="save"]').addEventListener("click",async g=>{const y=g.currentTarget,h=l.querySelector("#mag-f-error"),v=l.querySelector("#mag-f-name").value.trim();if(!v){h.textContent="Please give your magnet a name.";return}const b=l.querySelector("#mag-f-domains").value.split(",").map(w=>w.trim()).filter(Boolean);let d="";if(l.querySelectorAll(".mag-cta").forEach(w=>{if(w.dataset.kind!=="value")return;const C=w.querySelector(".mag-cta__on").checked,R=w.querySelector(".mag-cta__val").value.trim();C&&!R&&(d=d||`Add a target for the ${on[w.dataset.type].label} button, or uncheck it.`)}),d){h.textContent=d;return}const p=rn(l);if(p.enabled&&!Object.keys(p.b).length){h.textContent="Give variant B at least one change (title, welcome, or color), or untick the A/B test.";return}const _={name:v,domains:b,...ha(l)};a&&(_.owner_guid=l.querySelector("#mag-f-owner").value),y.disabled=!0,h.textContent="";try{const w=t?`${_e()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${_e()}/m5t/v5/magnets`,R=await(await fetch(w,{method:t?"PATCH":"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(_)})).json().catch(()=>({}));if(!R.ok)throw new Error(R.message||"Save failed");ve(t?"Magnet updated":"Magnet created","success"),c(),await Me()}catch(w){y.disabled=!1,h.textContent=w.message||"Something went wrong."}})}const xs=Object.freeze(Object.defineProperty({__proto__:null,init:fs,render:hs},Symbol.toStringTag,{value:"Module"}));let fa=!1;const D={leads:[],magnetNames:{},filter:"ALL",canManage:!1},ln=["NEW","WORKING","QUALIFIED","UNQUALIFIED","CONVERTED","EXPORTED"],ws={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},H=e=>String(e??"").replace(/[&<>"']/g,t=>ws[t]),Ke=(e,t="info")=>{try{u.publish(m.UI_TOAST,{message:e,type:t})}catch{}},xt=()=>T.getConfig?.().BASE_URL||"",Lt=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",Es=e=>(Lt(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function Ot(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric"})}catch{return""}}function As(){if(fa)return;const e=document.createElement("style");e.id="m5t-leads-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),fa=!0}function Rt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Ss(e){return`<select class="leads-status" data-id="${H(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${ln.map(t=>`<option value="${t}" ${e.status===t?"selected":""}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join("")}
  </select>`}function Ts(e){const t=D.magnetNames[e.magnet_guid]||e.lead_source||"—";return`
    <tr class="leads-row" data-id="${H(e.id)}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${H(Es(e))}</span>
      ...
      <td>${D.canManage?Ss(e):`<span class="leads-badge" data-s="${H(e.status)}">${H(e.status)}</span>`}</td>
      <td class="leads-muted" style="white-space:nowrap">${H(Ot(e))}</td>
    </tr>`}function cn(){return D.filter==="ALL"?D.leads:D.leads.filter(e=>e.status===D.filter)}function ks(){return As(),`
    ...
    </div>`}async function Cs(){document.getElementById("leads-export")?.addEventListener("click",Os),await Ns()}async function Ns(){const e=document.getElementById("leads-body");if(e){try{const[t,a]=await Promise.all([fetch(`${xt()}/m5t/v5/m5mLead`),fetch(`${xt()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(D.leads=(n.data||[]).filter(o=>!["DELETED","ARCHIVED"].includes(o.status)),a){const o=await a.json().catch(()=>({}));D.magnetNames={},(o.magnets||[]).forEach(r=>{D.magnetNames[r.guid]=r.name}),D.canManage=!!o.canManage}}catch{e.innerHTML=Rt("error","Could not load your leads. Please try again.");return}$t()}}function $t(){const e=document.getElementById("leads-body"),t=document.getElementById("leads-export");if(!e)return;if(t&&(t.style.display=D.leads.length?"":"none"),!D.leads.length){e.innerHTML=Rt("inbox","No leads captured yet. Publish a magnet and share it to start collecting.");return}const a=cn();e.innerHTML=`
    <div class="leads-bar">
    ...
    <div class="leads-tablewrap">
      <table class="leads-table">
        ...
        <tbody id="leads-tbody">${a.map(Ts).join("")||`<tr><td colspan="6"><div class="leads-muted" style="padding:14px 4px">No ${D.filter.toLowerCase()} leads.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".leads-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(D.filter=o.dataset.filter,$t())}),e.querySelector("#leads-tbody")?.addEventListener("change",Is),e.querySelector("#leads-tbody")?.addEventListener("click",n=>{if(n.target.closest(".leads-status"))return;const o=n.target.closest(".leads-row");o&&Ls(o.dataset.id)})}async function Is(e){const t=e.target.closest(".leads-status");if(!t)return;const a=t.dataset.id,n=D.leads.find(s=>String(s.id)===String(a)),o=t.value,r=n?.status;try{if(!(await(await fetch(`${xt()}/m5t/v5/m5mLead/${encodeURIComponent(a)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:o})})).json().catch(()=>({}))).ok)throw new Error;n&&(n.status=o),Ke(`Marked ${o[0]}${o.slice(1).toLowerCase()}`,"success"),D.filter!=="ALL"&&$t()}catch{t.value=r||"NEW",Ke("Could not update status","danger")}}function Ls(e){const t=D.leads.find(s=>String(s.id)===String(e));if(!t)return;const a=D.magnetNames[t.magnet_guid]||t.lead_source||"—",n=(s,i)=>i?`<div class="leads-drawer__field"><span class="leads-drawer__k">${H(s)}</span><span class="leads-drawer__v">${H(i)}</span></div>`:"",o=document.createElement("div");o.className="leads-drawer-scrim",o.innerHTML=`
    ...
    </aside>`,document.body.appendChild(o),requestAnimationFrame(()=>{o.classList.add("open"),o.querySelector(".leads-drawer").classList.add("open")});const r=()=>{o.classList.remove("open"),setTimeout(()=>o.remove(),220)};o.querySelector(".leads-drawer__close").addEventListener("click",r),o.addEventListener("click",s=>{s.target===o&&r()})}function Os(){const e=cn();if(!e.length){Ke("Nothing to export","info");return}const t=["first_name","last_name","email","phone","company","product_interest","lead_source","utm_source","utm_medium","utm_campaign","gclid","status"],a=l=>`"${String(l??"").replace(/"/g,'""')}"`,o=[[...t,"magnet","captured"].join(",")];for(const l of e)o.push([...t.map(c=>a(l[c])),a(D.magnetNames[l.magnet_guid]||l.lead_source||""),a(Ot(l))].join(","));const r=new Blob([o.join(`
`)],{type:"text/csv"}),s=URL.createObjectURL(r),i=document.createElement("a");i.href=s,i.download=`leads-${D.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(s),Ke(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const Rs=Object.freeze(Object.defineProperty({__proto__:null,init:Cs,render:ks},Symbol.toStringTag,{value:"Module"})),$s=()=>T.getConfig?.().BASE_URL||"",va=e=>e.toISOString().slice(0,10),_a=e=>e==null?"—":"$"+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),Te=e=>Number(e||0).toLocaleString(),Ms={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ue=e=>String(e??"").replace(/[&<>"']/g,t=>Ms[t]);let ba=!1;function Fs(){if(ba)return;const e=document.createElement("style");e.id="m5t-adperf-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ba=!0}const ke=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Be=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
  ...
  </div>`,Ps=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let Je=30;function dn(){return Fs(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${Ps.map(e=>`<button class="chart-period-btn${e.d===Je?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-body">
          ${ke("hourglass_empty","Loading ad performance…")}
        </div>
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-sources">
          ${ke("hourglass_empty","Loading…")}
        </div>
      </div>
    </div>`}async function pn(){const e=document.getElementById("adperf-periods");e?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(Je=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===Je)),ya())}),await ya()}async function ya(){const e=$s(),t=document.getElementById("adperf-body"),a=document.getElementById("adperf-range"),n=new Date,o=va(n),r=va(new Date(n.getTime()-(Je-1)*864e5));a&&(a.textContent=`${r} → ${o}`);let s,i=[],l=null;try{const[g,y,h]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${r}&to=${o}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${r}&to=${o}`)]);if(!g.ok)throw new Error(`HTTP ${g.status}`);s=await g.json(),i=((await y.json().catch(()=>({})))?.data||[]).filter(b=>b.status!=="DELETED"),l=await h.json().catch(()=>null)}catch(g){console.warn("[ad-performance] load failed:",g),t&&(t.innerHTML=ke("error","Could not load ad performance. Please try again."));return}const c=s.totals||{};if(He("adperf-spend",_a(c.spend)),He("adperf-clicks",Te(c.clicks)),He("adperf-leads",Te(c.magnet_leads)),He("adperf-cpl",_a(c.cost_per_lead)),Ds(l),!i.length){t.innerHTML=ke("link_off","No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.");return}if(!s.connected){t.innerHTML=ke("cloud_sync","Account connected. No ad data for this range yet. Metrics appear here once they sync.");return}t.innerHTML=Us(s.rows||[])}function Ds(e){const t=document.getElementById("adperf-sources"),a=document.getElementById("adperf-src-summary");if(!t)return;const n=e&&Array.isArray(e.rows)?e.rows:[];if(!n.length){a&&(a.textContent=""),t.innerHTML=ke("search_off","No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.");return}const o=e.total_leads||n.reduce((i,l)=>i+(l.leads||0),0),r=e.tracked_leads||0;a&&(a.textContent=`${Te(r)} of ${Te(o)} leads tagged to a source`);const s=i=>i.campaign&&i.campaign!=="(none)"?Ue(i.campaign):i.source&&i.source!=="(direct)"?Ue(i.source):'<span class="adperf-src-untracked">Untracked / direct</span>';t.innerHTML=`
      ...
      <table class="adperf-srctable">
        ...
        <tbody>${n.map(i=>`
          <tr>
            ...
            <td class="num">${i.paid_clicks?Te(i.paid_clicks):'<span class="adperf-src-sub">—</span>'}</td>
            <td class="num"><b>${Te(i.leads)}</b></td>
          </tr>`).join("")}
        </tbody>
      </table>
    </div>`}function He(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}function xa(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}function wa(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e)}function Us(e){const v=e.length||1,b=xa(Math.max(1,...e.map(E=>E.spend||0))),d=xa(Math.max(1,...e.map(E=>E.magnet_leads||0))),p=738/v,_=Math.min(24,p*.55),w=E=>56+p*(E+.5),C=E=>304-E/b*282,R=E=>304-E/d*282,K=[0,.25,.5,.75,1].map(E=>{const L=304-E*282;return`<line x1="56" y1="${L.toFixed(1)}" x2="794" y2="${L.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${(L+3.5).toFixed(1)}" text-anchor="end" class="ax">$${wa(b*E)}</text><text x="802" y="${(L+3.5).toFixed(1)}" text-anchor="start" class="ax">${wa(d*E)}</text>`}).join(""),j=e.map((E,L)=>{const ue=C(E.spend||0);return`<rect x="${(w(L)-_/2).toFixed(1)}" y="${ue.toFixed(1)}" width="${_.toFixed(1)}" height="${Math.max(0,304-ue).toFixed(1)}" rx="3" fill="#0072BA"><title>${E.date}: $${E.spend} spend</title></rect>`}).join(""),te=e.map((E,L)=>`${w(L).toFixed(1)},${R(E.magnet_leads||0).toFixed(1)}`).join(" "),pe=v>1?`<polyline points="${te}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",se=e.map((E,L)=>`<circle cx="${w(L).toFixed(1)}" cy="${R(E.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${E.date}: ${E.magnet_leads} leads</title></circle>`).join(""),Ne=Math.max(1,Math.ceil(v/6)),xe=e.map((E,L)=>L%Ne===0||L===v-1?`<text x="${w(L).toFixed(1)}" y="326" text-anchor="middle" class="ax">${E.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="adperf-chart" viewBox="0 0 840 340" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Ad spend versus magnet leads over time">
      ${K}${j}${pe}${se}${xe}
    </svg>`}const Bs={render:dn,init:pn},Hs=Object.freeze(Object.defineProperty({__proto__:null,default:Bs,init:pn,render:dn},Symbol.toStringTag,{value:"Module"})),Ea="reseller_org",un="managed_client";let Aa=!1;const Gs={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},U=e=>String(e??"").replace(/[&<>"']/g,t=>Gs[t]);function Qe(e,t="info"){try{u.publish(m.UI_TOAST,{message:e,type:t})}catch{}}function zs(){const e=T.getActiveOrg();if(e&&e.channel===Ea)return{guid:e.guid,name:e.name};const t=T.getMemberships().find(a=>a.channel===Ea);return t?{guid:t.orgGuid,name:t.name}:null}function Vs(e){const t=e?.created_tz;if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function qs(){if(Aa)return;const e=document.createElement("style");e.id="m5t-clients-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Aa=!0}const js=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Ge(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Ws(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
    <div class="client-card">
      <span class="client-card__avatar">${U(js(t))}</span>
      <span class="client-card__main">
        <div class="client-card__name" title="${U(t)}">${U(t)}</div>
        <div class="client-card__meta">Added ${U(Vs(e.created))||"—"}</div>
    ...
    <div class="page-shell" data-section="clients">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="clients-body">
          ${Ge("hourglass_empty","Loading clients…")}
        </div>
      </div>
    </div>`}async function gn(){const e=zs();document.getElementById("clients-add-btn")?.addEventListener("click",()=>Ys(e)),await hn(e)}async function hn(e){const t=document.getElementById("clients-body"),a=document.getElementById("clients-count");if(t){if(!e?.guid){t.innerHTML=Ge("info","Client provisioning is available to reseller / agency accounts."),a&&(a.textContent="");return}try{const n=T.getConfig?.().BASE_URL||"",o=await fetch(`${n}/m5t/v5/acctGroup`);if(!o.ok)throw new Error(`HTTP ${o.status}`);const r=await o.json(),i=(Array.isArray(r?.data)?r.data:[]).filter(l=>l.class===un&&(!l.parent||l.parent===e.guid));if(!i.length){t.innerHTML=Ge("group_off","No clients yet. Add your first client to start managing magnets on their behalf."),a&&(a.textContent="");return}t.innerHTML=`<div class="clients-grid">${i.map(Ws).join("")}</div>`,a&&(a.textContent=`${i.length} client${i.length===1?"":"s"}`),t.querySelectorAll(".client-card__invite").forEach(l=>{l.addEventListener("click",()=>{l.dataset.action==="adaccounts"?Ks(l.dataset.clientGuid,l.dataset.clientName):Js(l.dataset.clientGuid,l.dataset.clientName)})})}catch(n){console.warn("[clients] load failed:",n),t.innerHTML=Ge("error","Couldn’t load clients. Please try again."),a&&(a.textContent="")}}}function Ys(e){if(!e?.guid){Qe("Only reseller / agency accounts can add clients.","error");return}const t=document.createElement("div");t.className="client-modal-scrim";const a=document.createElement("div");a.className="client-modal",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),document.body.appendChild(a),requestAnimationFrame(()=>{t.classList.add("open"),a.classList.add("open")});const n=a.querySelector("#client-name-input"),o=a.querySelector("#client-modal-error"),r=a.querySelector('[data-act="create"]');n?.focus();const s=()=>{t.classList.remove("open"),a.classList.remove("open"),document.removeEventListener("keydown",i),setTimeout(()=>{t.remove(),a.remove()},200)},i=c=>{c.key==="Escape"&&s()};document.addEventListener("keydown",i),t.addEventListener("click",s),a.querySelector(".client-modal__close")?.addEventListener("click",s),a.querySelector('[data-act="cancel"]')?.addEventListener("click",s);const l=async()=>{const c=(n?.value||"").trim();if(o.textContent="",!c){o.textContent="Please enter a client name.",n?.focus();return}r.disabled=!0;const g=r.innerHTML;r.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Adding…';try{const y=T.getConfig?.().BASE_URL||"",h=await fetch(`${y}/m5t/v5/acctGroup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({class:un,caption:c,parent:e.guid})}),v=await h.json().catch(()=>({}));if(!h.ok||!v?.ok){const b=h.status===403?"You are not authorized to add a client here.":v?.message||v?.error||`Failed (HTTP ${h.status})`;throw new Error(b)}Qe(`Added client “${c}”`,"success"),s(),await hn(e)}catch(y){console.warn("[clients] create failed:",y),o.textContent=y.message||"Something went wrong. Please try again.",r.disabled=!1,r.innerHTML=g}};r?.addEventListener("click",l),n?.addEventListener("keydown",c=>{c.key==="Enter"&&l()})}const Sa=e=>String(e||"").replace(/[^0-9]/g,"");async function Ks(e,t){const a=T.getConfig?.().BASE_URL||"",n={};try{((await(await fetch(`${a}/m5t/v5/coreAdAccount?owner_guid=${encodeURIComponent(e)}`)).json().catch(()=>({})))?.data||[]).forEach(p=>{n[p.provider]=p})}catch{}const o=n.google_ads,r=n.google_lsa,s=document.createElement("div");s.className="client-modal-scrim";const i=document.createElement("div");i.className="client-modal",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.innerHTML=`
    <div class="client-modal__head">
    ...
    </div>`,document.body.appendChild(s),document.body.appendChild(i),requestAnimationFrame(()=>{s.classList.add("open"),i.classList.add("open")});const l=i.querySelector("#aa-error"),c=i.querySelector('[data-act="save"]'),g=()=>{s.classList.remove("open"),i.classList.remove("open"),document.removeEventListener("keydown",y),setTimeout(()=>{s.remove(),i.remove()},200)},y=b=>{b.key==="Escape"&&g()};document.addEventListener("keydown",y),s.addEventListener("click",g),i.querySelector(".client-modal__close")?.addEventListener("click",g),i.querySelector('[data-act="cancel"]')?.addEventListener("click",g);const h=(b,d,p)=>{const _=`${a}/m5t/v5/coreAdAccount`;return d&&!p?fetch(_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,provider:b,external_customer_id:d})}):d&&p&&d!==p.external_customer_id?fetch(`${_}/${encodeURIComponent(p.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({external_customer_id:d})}):!d&&p?fetch(`${_}/${encodeURIComponent(p.guid)}`,{method:"DELETE"}):null},v=async()=>{l.textContent="";const b=Sa(i.querySelector("#aa-gads").value),d=Sa(i.querySelector("#aa-lsa").value),p=[h("google_ads",b,o),h("google_lsa",d,r)].filter(Boolean);if(!p.length){g();return}c.disabled=!0;const _=c.innerHTML;c.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const w=await Promise.all(p);for(const C of w)if(!C.ok){const R=await C.json().catch(()=>({}));throw new Error(C.status===403?"You are not authorized to connect accounts for this client.":R?.error||R?.message||`Failed (HTTP ${C.status})`)}Qe("Ad accounts updated","success"),g()}catch(w){l.textContent=w.message||"Something went wrong. Please try again.",c.disabled=!1,c.innerHTML=_}};c?.addEventListener("click",v)}function Js(e,t){if(!e)return;const a=document.createElement("div");a.className="client-modal-scrim";const n=document.createElement("div");n.className="client-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="invite-body">
      ...
      <div class="client-modal__actions">
        ...
        </div>`;const _=n.querySelector("#inv-link");n.querySelector("#inv-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(_.value),n.querySelector("#inv-copy").textContent="Copied!"}catch{_.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",o)}catch(b){console.warn("[clients] invite failed:",b),i.textContent=b.message||"Something went wrong. Please try again.",l.disabled=!1,l.innerHTML=v}})}const Qs={render:mn,init:gn},Xs=Object.freeze(Object.defineProperty({__proto__:null,default:Qs,init:gn,render:mn},Symbol.toStringTag,{value:"Module"})),Re=Object.freeze({owner:{value:"owner",rank:30,label:"Owner"},admin:{value:"admin",rank:20,label:"Admin"},member:{value:"member",rank:10,label:"Member"},viewer:{value:"viewer",rank:0,label:"Viewer"}}),Zs=Object.freeze({VIEW_DASHBOARD:"view_dashboard",VIEW_MAGNETS:"view_magnets",PROVISION_MAGNETS:"provision_magnets",MANAGE_MAGNETS:"manage_magnets",VIEW_CONVERSATIONS:"view_conversations",VIEW_STATS:"view_stats",VIEW_AD_METRICS:"view_ad_metrics",CONNECT_AD_ACCOUNTS:"connect_ad_accounts",CREATE_CLIENT_ACCOUNTS:"create_client_accounts",MANAGE_TEAM:"manage_team",VIEW_BILLING:"view_billing",MANAGE_BILLING:"manage_billing"}),A=Zs,ei=Object.freeze(Object.values(A)),Se=Object.freeze([A.VIEW_DASHBOARD,A.VIEW_MAGNETS,A.VIEW_CONVERSATIONS,A.VIEW_STATS,A.VIEW_AD_METRICS]);Object.freeze({reseller_org:{owner:ei,admin:[A.VIEW_DASHBOARD,A.VIEW_MAGNETS,A.PROVISION_MAGNETS,A.MANAGE_MAGNETS,A.VIEW_CONVERSATIONS,A.VIEW_STATS,A.VIEW_AD_METRICS,A.CONNECT_AD_ACCOUNTS,A.CREATE_CLIENT_ACCOUNTS,A.MANAGE_TEAM,A.VIEW_BILLING],member:[A.VIEW_DASHBOARD,A.VIEW_MAGNETS,A.PROVISION_MAGNETS,A.MANAGE_MAGNETS,A.VIEW_CONVERSATIONS,A.VIEW_STATS,A.VIEW_AD_METRICS],viewer:Se},managed_client:{owner:[...Se,A.VIEW_BILLING],admin:[...Se,A.VIEW_BILLING],member:Se,viewer:Se},saas_org:{owner:[A.VIEW_DASHBOARD,A.VIEW_MAGNETS,A.PROVISION_MAGNETS,A.MANAGE_MAGNETS,A.VIEW_CONVERSATIONS,A.VIEW_STATS,A.VIEW_AD_METRICS,A.CONNECT_AD_ACCOUNTS,A.MANAGE_TEAM,A.VIEW_BILLING,A.MANAGE_BILLING],admin:[A.VIEW_DASHBOARD,A.VIEW_MAGNETS,A.PROVISION_MAGNETS,A.MANAGE_MAGNETS,A.VIEW_CONVERSATIONS,A.VIEW_STATS,A.VIEW_AD_METRICS,A.CONNECT_AD_ACCOUNTS,A.MANAGE_TEAM,A.VIEW_BILLING],member:[A.VIEW_DASHBOARD,A.VIEW_MAGNETS,A.PROVISION_MAGNETS,A.MANAGE_MAGNETS,A.VIEW_CONVERSATIONS,A.VIEW_STATS],viewer:Se}});function ti(e,t){const a=Re[e]?.rank??-1,n=Re[t]?.rank??1/0;return a>=Re.admin.rank&&a>=n}const Ta="managed_client";let ka=!1;const ai={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},W=e=>String(e??"").replace(/[&<>"']/g,t=>ai[t]),Ca=(e,t="info")=>{try{u.publish(m.UI_TOAST,{message:e,type:t})}catch{}},ni=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function oi(){const e=T.getActiveOrg();let t=e&&e.channel!==Ta?e:null;if(!t){const n=T.getMemberships().find(o=>o.channel!==Ta);n&&(t={guid:n.orgGuid,channel:n.channel,memberRole:n.memberRole})}if(!t)return null;const a=T.getMemberships().find(n=>n.orgGuid===t.guid)?.name;return{...t,name:a}}function ri(e){return Object.values(Re).filter(t=>ti(e,t.value)).sort((t,a)=>a.rank-t.rank)}function si(){if(ka)return;const e=document.createElement("style");e.id="m5t-team-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ka=!0}function Xe(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function ii(e){const t=e.member_role||"member";return`
    <div class="team-row">
      <span class="team-avatar">${W(ni(e.name||e.email))}</span>
