(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const ws="modulepreload",xs=function(e){return"/"+e},ja={},ee=function(t,a,n){let o=Promise.resolve();if(a&&a.length>0){let l=function(c){return Promise.all(c.map(g=>Promise.resolve(g).then(b=>({status:"fulfilled",value:b}),b=>({status:"rejected",reason:b}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),i=r?.nonce||r?.getAttribute("nonce");o=l(a.map(c=>{if(c=xs(c),c in ja)return;ja[c]=!0;const g=c.endsWith(".css"),b=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${b}`))return;const y=document.createElement("link");if(y.rel=g?"stylesheet":ws,g||(y.as="script"),y.crossOrigin="",y.href=c,i&&y.setAttribute("nonce",i),document.head.appendChild(y),g)return new Promise((_,w)=>{y.addEventListener("load",_),y.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${c}`)))})}))}function s(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return o.then(r=>{for(const i of r||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})};var Es=/([:*])(\w+)/g,Ss="([^/]+)",As=/\*/g,ks="?(?:.*)",Cs=/\/\?/g,Ts="/?([^/]+|)",Is="(?:/^|^)",$s="";function Zn(e){return e===void 0&&(e="/"),ka()?location.pathname+location.search+location.hash:e}function W(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function Mt(e){return typeof e=="string"}function Ls(e){return typeof e=="function"}function Ft(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function Ns(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(a,n,o){return a===null&&(a={}),a[t[o]]=decodeURIComponent(n),a},null)}function Pt(e){var t=W(e).split(/\?(.*)?$/);return[W(t[0]),t.slice(1).join("")]}function Aa(e){for(var t={},a=e.split("&"),n=0;n<a.length;n++){var o=a[n].split("=");if(o[0]!==""){var s=decodeURIComponent(o[0]);t[s]?(Array.isArray(t[s])||(t[s]=[t[s]]),t[s].push(decodeURIComponent(o[1]||""))):t[s]=decodeURIComponent(o[1]||"")}}return t}function eo(e,t){var a=Pt(W(e.currentLocationPath)),n=a[0],o=a[1],s=o===""?null:Aa(o),r=[],i;if(Mt(t.path)){if(i=Is+W(t.path).replace(Es,function(b,y,_){return r.push(_),Ss}).replace(As,ks).replace(Cs,Ts)+"$",W(t.path)===""&&W(n)==="")return{url:n,queryString:o,hashString:Ft(e.to),route:t,data:null,params:s}}else i=t.path;var l=new RegExp(i,$s),c=n.match(l);if(c){var g=Mt(t.path)?Ns(c,r):c.groups?c.groups:c.slice(1);return{url:W(n.replace(new RegExp("^"+e.instance.root),"")),queryString:o,hashString:Ft(e.to),route:t,data:g,params:s}}return!1}function to(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function Je(e,t){return typeof e[t]>"u"||e[t]===!0}function Os(e){if(!e)return{};var t=e.split(","),a={},n;return t.forEach(function(o){var s=o.split(":").map(function(r){return r.replace(/(^ +| +$)/g,"")});switch(s[0]){case"historyAPIMethod":a.historyAPIMethod=s[1];break;case"resolveOptionsStrategy":n||(n={}),n.strategy=s[1];break;case"resolveOptionsHash":n||(n={}),n.hash=s[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":a[s[0]]=s[1]==="true";break}}),n&&(a.resolveOptions=n),a}function ka(){return typeof window<"u"}function Rs(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(a){return a}).forEach(function(a){["before","after","already","leave"].forEach(function(n){a[n]&&(t[n]||(t[n]=[]),t[n].push(a[n]))})}),t}function ke(e,t,a){var n=t||{},o=0;(function s(){if(!e[o]){a&&a(n);return}Array.isArray(e[o])?(e.splice.apply(e,[o,1].concat(e[o][0](n)?e[o][1]:e[o][2])),s()):e[o](n,function(r){typeof r>"u"||r===!0?(o+=1,s()):a&&a(n)})})()}ke.if=function(e,t,a){return Array.isArray(t)||(t=[t]),Array.isArray(a)||(a=[a]),[e,t,a]};function Wa(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=Zn(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function ta(e,t){for(var a=0;a<e.instance.routes.length;a++){var n=e.instance.routes[a],o=eo(e,n);if(o&&(e.matches||(e.matches=[]),e.matches.push(o),e.resolveOptions.strategy==="ONE")){t();return}}t()}function Ms(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function Fs(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var Ya=ka(),Ps=to();function Ds(e,t){if(Je(e.navigateOptions,"updateBrowserURL")){var a=("/"+e.to).replace(/\/\//g,"/"),n=Ya&&e.resolveOptions&&e.resolveOptions.hash===!0;Ps?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",n?"#"+a:a),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!n){var o=location.hash;location.hash="",location.hash=o}e.instance.__freezeListening=!1},1))):Ya&&(window.location.href=e.to)}t()}function ao(e,t){var a=e.instance;if(!a.lastResolved()){t();return}ke(a.lastResolved().map(function(n){return function(o,s){if(!n.route.hooks||!n.route.hooks.leave){s();return}var r=!1,i=e.instance.matchLocation(n.route.path,e.currentLocationPath,!1);if(n.route.path!=="*")r=!i;else{var l=e.matches?e.matches.find(function(c){return n.route.path===c.route.path}):!1;r=!l}if(Je(e.navigateOptions,"callHooks")&&r){ke(n.route.hooks.leave.map(function(c){return function(g,b){return c(function(y){y===!1?e.instance.__markAsClean(e):b()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return s()}]));return}else s()}}),{},function(){return t()})}function Bs(e,t){e.match.route.hooks&&e.match.route.hooks.before&&Je(e.navigateOptions,"callHooks")?ke(e.match.route.hooks.before.map(function(a){return function(o,s){return a(function(r){r===!1?e.instance.__markAsClean(e):s()},e.match)}}).concat([function(){return t()}])):t()}function Us(e,t){Je(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function Hs(e,t){e.match.route.hooks&&e.match.route.hooks.after&&Je(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(a){return a(e.match)}),t()}function zs(e,t){var a=e.instance.lastResolved();if(a&&a[0]&&a[0].route===e.match.route&&a[0].url===e.match.url&&a[0].queryString===e.match.queryString){a.forEach(function(n){n.route.hooks&&n.route.hooks.already&&Je(e.navigateOptions,"callHooks")&&n.route.hooks.already.forEach(function(o){return o(e.match)})}),t(!1);return}t()}function Gs(e,t){var a=e.instance._notFoundRoute;if(a){e.notFoundHandled=!0;var n=Pt(e.currentLocationPath),o=n[0],s=n[1],r=Ft(e.to);a.path=W(o);var i={url:a.path,queryString:s,hashString:r,data:null,route:a,params:s!==""?Aa(s):null};e.matches=[i],e.match=i}t()}function qs(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function Vs(e,t){e.instance._setCurrent(null),t()}function no(e,t){Je(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var oo=[zs,Bs,Us,Hs],Ja=[ao,Gs,ke.if(function(e){var t=e.notFoundHandled;return t},oo.concat([no]),[qs,Vs])];function ca(){return ca=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},ca.apply(this,arguments)}function Ka(e,t){var a=0;function n(){if(a===e.matches.length){no(e,t);return}ke(oo,ca({},e,{match:e.matches[a]}),function(){a+=1,n()})}ao(e,n)}function aa(e){e.instance.__markAsClean(e)}function da(){return da=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},da.apply(this,arguments)}var Xa="[data-navigo]";function js(e,t){var a=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:Xa},n=this,o="/",s=null,r=[],i=!1,l,c=to(),g=ka();e?o=W(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function b(m){return m.indexOf("#")>=0&&(a.hash===!0?m=m.split("#")[1]||"/":m=m.split("#")[0]),m}function y(m){return W(o+"/"+W(m))}function _(m,E,$,H){return m=Mt(m)?y(m):m,{name:H||W(String(m)),path:m,handler:E,hooks:Rs($)}}function w(m,E,$){var H=this;return typeof m=="object"&&!(m instanceof RegExp)?(Object.keys(m).forEach(function(M){if(typeof m[M]=="function")H.on(M,m[M]);else{var be=m[M],He=be.uses,S=be.as,P=be.hooks;r.push(_(M,He,[l,P],S))}}),this):(typeof m=="function"&&($=E,E=m,m=o),r.push(_(m,E,[l,$])),this)}function d(m,E){if(n.__dirty){n.__waiting.push(function(){return n.resolve(m,E)});return}else n.__dirty=!0;m=m?W(o)+"/"+W(m):void 0;var $={instance:n,to:m,currentLocationPath:m,navigateOptions:{},resolveOptions:da({},a,E)};return ke([Wa,ta,ke.if(function(H){var M=H.matches;return M&&M.length>0},Ka,Ja)],$,aa),$.matches?$.matches:!1}function h(m,E){if(n.__dirty){n.__waiting.push(function(){return n.navigate(m,E)});return}else n.__dirty=!0;m=W(o)+"/"+W(m);var $={instance:n,to:m,navigateOptions:E||{},resolveOptions:E&&E.resolveOptions?E.resolveOptions:a,currentLocationPath:b(m)};ke([Ms,Fs,ta,ke.if(function(H){var M=H.matches;return M&&M.length>0},Ka,Ja),Ds,aa],$,aa)}function v(m,E,$){var H=Te(m,E);return H!==null?(h(H.replace(new RegExp("^/?"+o),""),$),!0):!1}function k(m){return this.routes=r=r.filter(function(E){return Mt(m)?W(E.path)!==W(m):Ls(m)?m!==E.handler:String(E.path)!==String(m)}),this}function N(){c&&(this.__popstateListener=function(){n.__freezeListening||d()},window.addEventListener("popstate",this.__popstateListener))}function U(){this.routes=r=[],c&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=i=!0}function ae(m,E){return n._notFoundRoute=_("*",m,[l,E],"__NOT_FOUND__"),this}function Y(){if(g)return le().forEach(function(m){if(m.getAttribute("data-navigo")==="false"||m.getAttribute("target")==="_blank"){m.hasListenerAttached&&m.removeEventListener("click",m.navigoHandler);return}m.hasListenerAttached||(m.hasListenerAttached=!0,m.navigoHandler=function(E){if((E.ctrlKey||E.metaKey)&&E.target.tagName.toLowerCase()==="a")return!1;var $=m.getAttribute("href");if(typeof $>"u"||$===null)return!1;if($.match(/^(http|https)/)&&typeof URL<"u")try{var H=new URL($);$=H.pathname+H.search}catch{}var M=Os(m.getAttribute("data-navigo-options"));i||(E.preventDefault(),E.stopPropagation(),n.navigate(W($),M))},m.addEventListener("click",m.navigoHandler))}),n}function le(){return g?[].slice.call(document.querySelectorAll(a.linksSelector||Xa)):[]}function we(m){return"/"+o+"/"+W(m)}function ce(m){return l=m,this}function Re(){return s}function Te(m,E,$){var H=r.find(function(He){return He.name===m}),M=null;if(H){if(M=H.path,E)for(var be in E)M=M.replace(":"+be,E[be]);M=M.match(/^\//)?M:"/"+M}return M&&$&&!$.includeRoot&&(M=M.replace(new RegExp("^/"+o),"")),M}function O(m){return m.getAttribute("href")}function I(m){var E=Pt(W(m)),$=E[0],H=E[1],M=H===""?null:Aa(H),be=Ft(m),He=_($,function(){},[l],$);return{url:$,queryString:H,hashString:be,route:He,data:null,params:M}}function V(){return I(W(Zn(o)).replace(new RegExp("^"+o),""))}function Ie(m){var E={instance:n,currentLocationPath:m,to:m,resolveOptions:a};return ta(E,function(){}),E.matches?E.matches:!1}function xt(m,E,$){typeof E<"u"&&(typeof $>"u"||$)&&(E=y(E));var H={instance:n,to:E,currentLocationPath:E};Wa(H,function(){}),typeof m=="string"&&(m=typeof $>"u"||$?y(m):m);var M=eo(H,{name:String(m),path:m,handler:function(){},hooks:{}});return M||!1}function Ue(m,E,$){return typeof E=="string"&&(E=lt(E)),E?(E.hooks[m]||(E.hooks[m]=[]),E.hooks[m].push($),function(){E.hooks[m]=E.hooks[m].filter(function(H){return H!==$})}):(console.warn("Route doesn't exists: "+E),function(){})}function lt(m){return typeof m=="string"?r.find(function(E){return E.name===y(m)}):r.find(function(E){return E.handler===m})}function Zt(m){m.instance.__dirty=!1,m.instance.__waiting.length>0&&m.instance.__waiting.shift()()}this.root=o,this.routes=r,this.destroyed=i,this.current=s,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=Zt,this.on=w,this.off=k,this.resolve=d,this.navigate=h,this.navigateByName=v,this.destroy=U,this.notFound=ae,this.updatePageLinks=Y,this.link=we,this.hooks=ce,this.extractGETParameters=function(m){return Pt(b(m))},this.lastResolved=Re,this.generate=Te,this.getLinkPath=O,this.match=Ie,this.matchLocation=xt,this.getCurrentLocation=V,this.addBeforeHook=Ue.bind(this,"before"),this.addAfterHook=Ue.bind(this,"after"),this.addAlreadyHook=Ue.bind(this,"already"),this.addLeaveHook=Ue.bind(this,"leave"),this.getRoute=lt,this._pathToMatchObject=I,this._clean=W,this._checkForAHash=b,this._setCurrent=function(m){return s=n.current=m},N.call(this),Y.call(this)}var Ws=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Ys(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var mt={exports:{}},Js=mt.exports,Qa;function Ks(){return Qa||(Qa=1,(function(e,t){(function(a,n){var o={};a.PubSub?(o=a.PubSub,console.warn("PubSub already loaded, using existing version")):(a.PubSub=o,n(o)),e!==void 0&&e.exports&&(t=e.exports=o),t.PubSub=o,e.exports=t=o})(typeof window=="object"&&window||Js||Ws,function(a){var n={},o=-1,s="*";function r(d){var h;for(h in d)if(Object.prototype.hasOwnProperty.call(d,h))return!0;return!1}function i(d){return function(){throw d}}function l(d,h,v){try{d(h,v)}catch(k){setTimeout(i(k),0)}}function c(d,h,v){d(h,v)}function g(d,h,v,k){var N=n[h],U=k?c:l,ae;if(Object.prototype.hasOwnProperty.call(n,h))for(ae in N)Object.prototype.hasOwnProperty.call(N,ae)&&U(N[ae],d,v)}function b(d,h,v){return function(){var N=String(d),U=N.lastIndexOf(".");for(g(d,d,h,v);U!==-1;)N=N.substr(0,U),U=N.lastIndexOf("."),g(d,N,h,v);g(d,s,h,v)}}function y(d){var h=String(d),v=!!(Object.prototype.hasOwnProperty.call(n,h)&&r(n[h]));return v}function _(d){for(var h=String(d),v=y(h)||y(s),k=h.lastIndexOf(".");!v&&k!==-1;)h=h.substr(0,k),k=h.lastIndexOf("."),v=y(h);return v}function w(d,h,v,k){d=typeof d=="symbol"?d.toString():d;var N=b(d,h,k),U=_(d);return U?(v===!0?N():setTimeout(N,0),!0):!1}a.publish=function(d,h){return w(d,h,!1,a.immediateExceptions)},a.publishSync=function(d,h){return w(d,h,!0,a.immediateExceptions)},a.subscribe=function(d,h){if(typeof h!="function")return!1;d=typeof d=="symbol"?d.toString():d,Object.prototype.hasOwnProperty.call(n,d)||(n[d]={});var v="uid_"+String(++o);return n[d][v]=h,v},a.subscribeAll=function(d){return a.subscribe(s,d)},a.subscribeOnce=function(d,h){var v=a.subscribe(d,function(){a.unsubscribe(v),h.apply(this,arguments)});return a},a.clearAllSubscriptions=function(){n={}},a.clearSubscriptions=function(h){var v;for(v in n)Object.prototype.hasOwnProperty.call(n,v)&&v.indexOf(h)===0&&delete n[v]},a.countSubscriptions=function(h){var v,k,N=0;for(v in n)if(Object.prototype.hasOwnProperty.call(n,v)&&v.indexOf(h)===0){for(k in n[v])N++;break}return N},a.getSubscriptions=function(h){var v,k=[];for(v in n)Object.prototype.hasOwnProperty.call(n,v)&&v.indexOf(h)===0&&k.push(v);return k},a.unsubscribe=function(d){var h=function(we){var ce;for(ce in n)if(Object.prototype.hasOwnProperty.call(n,ce)&&ce.indexOf(we)===0)return!0;return!1},v=typeof d=="string"&&(Object.prototype.hasOwnProperty.call(n,d)||h(d)),k=!v&&typeof d=="string",N=typeof d=="function",U=!1,ae,Y,le;if(v){a.clearSubscriptions(d);return}for(ae in n)if(Object.prototype.hasOwnProperty.call(n,ae)){if(Y=n[ae],k&&Y[d]){delete Y[d],U=d;break}if(N)for(le in Y)Object.prototype.hasOwnProperty.call(Y,le)&&Y[le]===d&&(delete Y[le],U=!0)}return U}})})(mt,mt.exports)),mt.exports}var Xs=Ks();const p=Ys(Xs),u=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV.GO",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN.GO",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP.GO",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT.GO",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT.GO",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH.GO",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",AUTH_SCOPE_LOADED:"AUTH.SCOPE.LOADED",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",M5T_SIDE_NAV:"M5T_SIDE_NAV",M5T_SIDE_NAV_TAP:"M5T_SIDE_NAV.TAP",M5T_SIDE_NAV_COLLAPSE:"M5T_SIDE_NAV.COLLAPSE",M5T_SIDE_NAV_LOGO_TAP:"M5T_SIDE_NAV.LOGO_TAP",M5T_SIDE_NAV_ORG_SWITCH:"M5T_SIDE_NAV.ORG_SWITCH",M5T_SIDE_NAV_FOOTER_ACTION:"M5T_SIDE_NAV.FOOTER_ACTION",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL",MESSAGE:"MESSAGE",MESSAGE_CREATE:"MESSAGE.CREATE",MESSAGE_CREATED:"MESSAGE.CREATED",MESSAGE_EDIT:"MESSAGE.EDIT",MESSAGE_UPDATED:"MESSAGE.UPDATED",MESSAGE_DELETE:"MESSAGE.DELETE",MESSAGE_DELETED:"MESSAGE.DELETED",MESSAGE_REFRESH:"MESSAGE.REFRESH"}),na={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://machfivemagnet-saas.onrender.com"};var oa={};const z=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_USER_PREFS:"mvv_user_prefs",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_LS_LAST_ROUTE:"mvv_last_route",FF_SSE_API_DEBUG_LOGGING:!1,FF_SSE_API_TIMEOUT:3e4,FF_SSE_API_MAX_RETRIES:3,FF_SSE_API_CACHE_ENABLED:!0,FF_SSE_AUTH_TOKEN_EXPIRY_HOURS:6,FF_SSE_AUTH_AUTO_REFRESH:!1,FF_SSE_AUTH_SESSION_WARNING_MINUTES:5,FF_SSE_AUTH_REMEMBER_ME:!0,FF_SSE_AUTH_MAX_LOGIN_ATTEMPTS:5,FF_SSE_UI_DARK_MODE:!0,FF_SSE_UI_ANIMATIONS:!0,FF_SSE_FEATURE_SIGNUP_ENABLED:!0,FF_SSE_FEATURE_PASSWORD_RESET_ENABLED:!0,FF_SSE_FEATURE_EMAIL_VERIFICATION_ENABLED:!0,FF_SSE_FEATURE_PROFILE_EDIT_ENABLED:!0,FF_SSE_FEATURE_ANALYTICS_ENABLED:!1,FF_SSE_CACHE_TTL_MS:3e5,FF_SSE_COMPRESSION_ENABLED:!0,FF_SSE_MAX_PAYLOAD_SIZE_MB:50,FF_SSE_DEBUG_VERBOSE:!1,FF_SSE_DEBUG_REDUX_DEVTOOLS:!1,FF_SSE_DEBUG_PERFORMANCE:!1,FF_SSE_DEBUG_BYPASS_AUTH:!1,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_BUILD_MODE:"LOCAL",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel",FF_API_RATELIMIT_SIGNIN_ENFORCE:!1,FF_API_RATELIMIT_SIGNIN_IP_LIMIT:20,FF_API_RATELIMIT_SIGNIN_EMAIL_LIMIT:10,FF_API_RATELIMIT_FORGOT_ENFORCE:!1,FF_API_RATELIMIT_FORGOT_IP_LIMIT:15,FF_API_RATELIMIT_FORGOT_EMAIL_LIMIT:5,FF_API_RATELIMIT_CAPTURE_ENFORCE:!1,FF_API_RATELIMIT_CAPTURE_LIMIT:30,FF_API_RATELIMIT_EVENT_ENFORCE:!1,FF_API_RATELIMIT_EVENT_LIMIT:600,FF_API_RATELIMIT_CSP_PING_ENFORCE:!1,FF_API_RATELIMIT_CSP_PING_LIMIT:30,FF_API_RATELIMIT_AUTHENTICATED_ENFORCE:!1,FF_API_RATELIMIT_AUTHENTICATED_LIMIT:600,FF_API_MAGNET_REQUIRE_ORIGIN_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_LIMIT:2e3});function so(e,t=null){if(e in z)return z[e];if(typeof process<"u"&&oa&&oa[e]){const a=oa[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}if(typeof import.meta<"u"&&na&&na[e]){const a=na[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}return t}function Ca(e){return so(e,!1)===!0}function Qs(){return{...z}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:z,getFlag:so,isEnabled:Ca,getAllFlags:Qs});const Za={success:{border:"var(--color-success, #009473)",bg:"var(--color-success-soft, rgba(0,148,115,0.10))",icon:"check_circle"},danger:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},error:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},warning:{border:"var(--color-warning-ink, #7a5e00)",bg:"var(--color-warning-tint, rgba(245,223,77,0.16))",icon:"warning"},info:{border:"var(--color-info, #7BC4C4)",bg:"var(--color-info-soft, rgba(123,196,196,0.12))",icon:"info"}},Zs=4500,pa=220;let Le=null,en=!1;function er(){if(en)return;const e=document.createElement("style");e.id="m5t-toast-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),en=!0}function tr(){return Le&&document.body.contains(Le)||(Le=document.createElement("div"),Le.className="m5t-toast-stack",Le.setAttribute("role","status"),Le.setAttribute("aria-live","polite"),document.body.appendChild(Le)),Le}function ar(e){const t=e&&e.message;if(!t)return;er();const a=Za[e.type]||Za.info,n=document.createElement("div");n.className="m5t-toast",n.style.borderColor=a.border,n.style.background=a.bg,n.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true" style="color:${a.border}">${a.icon}</span><span class="m5t-toast__msg"></span><button type="button" class="m5t-toast__close" aria-label="Dismiss"><span class="material-symbols-outlined" aria-hidden="true">close</span></button>`,n.querySelector(".m5t-toast__msg").textContent=String(t),tr().appendChild(n),requestAnimationFrame(()=>n.classList.add("is-in"));let s=!1;const r=()=>{s||(s=!0,clearTimeout(i),n.classList.remove("is-in"),n.classList.add("is-out"),setTimeout(()=>n.remove(),pa))},i=setTimeout(r,Zs);n.querySelector(".m5t-toast__close").addEventListener("click",r)}function nr(){const e=t=>a=>{const n=a.detail?.pubsubTopic;n&&p.publish(n,a.detail)};document.addEventListener("nav-select",e()),document.addEventListener("logo-click",e()),document.addEventListener("nav-hover",e()),document.addEventListener("nav-double-tap",e()),document.addEventListener("nav-long-tap",e()),document.addEventListener("message-sent",e())}function or(){console.log("[AppEvents] Initializing event listeners..."),p.subscribe(u.APP_READY,(a,n)=>{console.log("[AppEvents] APP_READY:",n)}),p.subscribe(u.APP_ERROR,(a,n)=>{console.error("[AppEvents] APP_ERROR:",n)}),p.subscribe(u.APP_SIGNOUT,(a,n)=>{console.log("[AppEvents] APP_SIGNOUT:",n)}),p.subscribe(u.ROUTE_NAV_BEFORE,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",n),p.publish(u.UI_LOADING_START)}),p.subscribe(u.ROUTE_NAV_AFTER,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",n),p.publish(u.UI_LOADING_END)}),p.subscribe(u.ROUTE_NAV_ERROR,(a,n)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",n),p.publish(u.APP_ERROR,{message:"Navigation error",details:n})}),p.subscribe(u.AUTH_SIGNIN_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",n)}),p.subscribe(u.AUTH_SIGNIN_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",n),p.publish(u.UI_TOAST,{message:n.message||"Sign in failed",type:"danger"})}),p.subscribe(u.AUTH_SIGNUP_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",n),p.publish(u.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"}),p.publish(u.AUTH_VERIFY_LINK)}),p.subscribe(u.AUTH_VERIFY_LINK,(a,n)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),p.subscribe(u.AUTH_SIGNUP_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",n),p.publish(u.UI_TOAST,{message:n.message||"Sign up failed",type:"danger"})}),p.subscribe(u.AUTH_SIGNOUT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",n),p.publish(u.UI_TOAST,{message:"Signed out successfully",type:"info"})}),p.subscribe(u.AUTH_SIGNUP,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),p.subscribe(u.AUTH_FORGOT,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),p.subscribe(u.AUTH_FORGOT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",n),p.publish(u.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),p.subscribe(u.AUTH_RESETHASH_NAV,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),p.subscribe(u.AUTH_RESETHASH_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",n),p.publish(u.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),p.subscribe(u.AUTH_TOKEN_EXPIRED,(a,n)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",n),p.publish(u.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),p.subscribe(u.I18N_SET_LANG,(a,n)=>{console.log("[AppEvents] I18N_SET_LANG:",n);const{langCode:o}=n;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),p.publish(u.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(s){console.error("[AppEvents] Error changing language:",s),p.publish(u.UI_TOAST,{message:`Failed to change language: ${s.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),p.subscribe("CONVERSATION.PROMPT",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",n.message),sa(n.message,"user",n.timestamp),p.publish(u.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Agent prompt (no implementation):",n.message);break;case"AGENT_CANVAS":console.log("[AppEvents] Display message in canvas:",n.message),sa(n.message,"user",n.timestamp),p.publish(u.CANVAS_DO_SCROLL);break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),p.subscribe("CONVERSATION.RESPONSE",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",n.message),sa(n.message,"assistant",n.timestamp,n.streaming);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),p.subscribe(u.UI_LOADING_START,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),p.subscribe(u.UI_LOADING_END,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),p.subscribe(u.UI_TOAST,(a,n)=>{ar(n)}),p.subscribe(u.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const a="0.1",n=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${a} 8/9/2026, 7:09:44 PM|© ${n} Mach Five Tech`,"night")}),nr(),p.subscribe("M5T_PRIMARY_NAV",(a,n)=>{const o=a.split(".")[1];switch(o){case"TAP":e(n);break;case"LOGO_TAP":t();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function e(a){const{token:n,level:o,primaryToken:s}=a;switch(n){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),p.publish(u.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${n}`,{primaryToken:s});break}}function t(a){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 8/9/2026, 7:09:44 PM|© ${o} Mach Five Tech`,"night",5e3)}p.subscribe(u.AUTH_SIGNOUT,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(z.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function sa(e,t="user",a=null,n=!1){const o=document.getElementById("chat-messages");if(!o){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}if(a||(a=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})),n&&t==="assistant"){const r=o.firstElementChild;if(r&&r.tagName.toLowerCase()==="m5t-chat-response"){r.setAttribute("message",e),console.log(`[AppEvents] Updated streaming ${t} bubble (${e.length} chars)`);return}}let s;t==="user"||t==="prompt"?s=document.createElement("m5t-chat-prompt"):s=document.createElement("m5t-chat-response"),s.setAttribute("message",e),s.setAttribute("timestamp",a),o.prepend(s),console.log(`[AppEvents] Added ${t} bubble to canvas (${e.length} chars)`)}function ro(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("uid")&&t.get("token"))}const sr=Object.freeze({admin_root_role:{value:100,desc:"Administrator superuser infrastructure architecture"},admin_business_role:{value:90,desc:"Administrator financial oversight"},admin_support_role:{value:80,desc:"Administrator maintenance and configuration"},admin_readonly_role:{value:70,desc:"Administrator information help desk"},client_tier_4_role:{value:40,desc:"Client paid tier 4 - Partner"},client_tier_3_role:{value:30,desc:"Client paid tier 3"},client_tier_2_role:{value:20,desc:"Client paid tier 2"},client_tier_1_role:{value:10,desc:"Client paid tier 1"},client_standard_role:{value:0,desc:"Client free tier 0"}});function rr(e){return sr[e]||null}function ir(e){return e>=50}const ht=Object.freeze({owner:{value:"owner",rank:30,label:"Owner"},admin:{value:"admin",rank:20,label:"Admin"},member:{value:"member",rank:10,label:"Member"},viewer:{value:"viewer",rank:0,label:"Viewer"}}),lr=Object.freeze({VIEW_DASHBOARD:"view_dashboard",VIEW_MAGNETS:"view_magnets",PROVISION_MAGNETS:"provision_magnets",MANAGE_MAGNETS:"manage_magnets",VIEW_CONVERSATIONS:"view_conversations",VIEW_STATS:"view_stats",VIEW_AD_METRICS:"view_ad_metrics",CONNECT_AD_ACCOUNTS:"connect_ad_accounts",CREATE_CLIENT_ACCOUNTS:"create_client_accounts",MANAGE_TEAM:"manage_team",VIEW_BILLING:"view_billing",MANAGE_BILLING:"manage_billing"}),C=lr,io=Object.freeze(Object.values(C)),ze=Object.freeze([C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS]),cr=Object.freeze({reseller_org:{owner:io,admin:[C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS,C.CONNECT_AD_ACCOUNTS,C.CREATE_CLIENT_ACCOUNTS,C.MANAGE_TEAM,C.VIEW_BILLING],member:[C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS],viewer:ze},managed_client:{owner:[...ze,C.VIEW_BILLING],admin:[...ze,C.VIEW_BILLING],member:ze,viewer:ze},saas_org:{owner:[C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS,C.CONNECT_AD_ACCOUNTS,C.MANAGE_TEAM,C.VIEW_BILLING,C.MANAGE_BILLING],admin:[C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS,C.CONNECT_AD_ACCOUNTS,C.MANAGE_TEAM,C.VIEW_BILLING],member:[C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS],viewer:ze}});function dr(e){const t=rr(e);return!!t&&ir(t.value)}function pr({entityClass:e,orgChannel:t,memberRole:a}={}){if(dr(e))return e==="admin_readonly_role"?[...ze,C.VIEW_BILLING]:[...io];const n=cr[t],o=n&&n[a];return o?[...o]:[]}function ur(e,t){const a=ht[e]?.rank??-1,n=ht[t]?.rank??1/0;return a>=ht.admin.rank&&a>=n}const Ta=[{value:"name",label:"Full name (splits into first + last automatically)"},{value:"first_name",label:"First name"},{value:"last_name",label:"Last name"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"mobile",label:"Mobile phone"},{value:"company",label:"Company"},{value:"title",label:"Job title"},{value:"city",label:"City"},{value:"state",label:"State / province"},{value:"product_interest",label:"Product interest"},{value:"lead_source",label:"Lead source"},{value:"rating",label:"Rating (Hot / Warm / Cold)"},{value:"description",label:"Notes / description"}];new Set(Ta.map(e=>e.value));const Ia=[{value:"single_select",label:"Multiple choice"},{value:"multi_select",label:"Select all"},{value:"scheduler",label:"Scheduler"},{value:"text",label:"Short text"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"message",label:"Message"}];new Set(Ia.map(e=>e.value));class x{static CONFIG={BASE_URL:"https://machfivemagnet-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink",SCOPE:"sse_session_scope",ACTIVE_ORG:"sse_active_org",REMEMBERED_EMAIL:"sse_remembered_email"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",ME:"/m5t/v5/acctEntity/me",PING:"/ping"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#o=null;static#a=null;static#n=!1;static#s=null;static#i=null;static async init({BASE_URL:t,navigateFunction:a,customConfig:n={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(a&&typeof a=="function")this.#i=a;else throw new Error("navigateFunction is required and must be a function");return t&&(this.CONFIG.BASE_URL=t),n&&Object.keys(n).length>0&&(this.CONFIG={...this.CONFIG,...n}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#m(),this.#p(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#p(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((t=null)=>{if(t){if(ro()&&(t==="splash"||t==="signin")){console.log("[AuthController] Ignoring mvvLegit redirect to",t,"— keeping invitee on accept-invite");return}console.log("[AuthController] mvvLegit navigation to:",t),this.#r(t)}}).setOnState((t=null)=>{if(t)switch(console.log("[AuthController] Auth state changed:",t),t){case"AUTH":case 4:this.#_();break;case"UNAUTH":case 1:this.#b();break;case"UNVERF":case 2:this.#y();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#r(t){if(!this.#i){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",t);const a=t.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",a),this.#i(a)}static#l(){if(window.__m5tActiveOrgFetch)return;const t=window.fetch.bind(window);window.fetch=(a,n)=>{try{const o=typeof a=="string"?a:a?.url||"",s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);if(s&&o.startsWith(this.CONFIG.BASE_URL)){const r=new Headers(n&&n.headers||(a instanceof Request?a.headers:void 0));r.set("X-Active-Org",s),n={...n||{},headers:r}}}catch{}return t(a,n)},window.__m5tActiveOrgFetch=!0,console.log("[AuthController] Active-org fetch header installed")}static#m(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);t&&(this.#o=JSON.parse(t),console.log("[AuthController] Entity state loaded:",this.#o?.email))}catch(t){console.error("[AuthController] Error loading entity state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#o=null}this.#s=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.SCOPE);t&&(this.#a=JSON.parse(t),console.log("[AuthController] Scope state loaded (cached):",this.#a?.uiMode))}catch(t){console.error("[AuthController] Error loading scope state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE),this.#a=null}}static#c(t){try{this.#o=t,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(t)),console.log("[AuthController] Entity state saved")}catch(a){console.error("[AuthController] Error saving entity state:",a)}}static#d(){this.#o=null,this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#u)}catch{}}static getEntity(){return this.#o}static#v(t){try{this.#a=t,localStorage.setItem(this.CONFIG.LS_KEYS.SCOPE,JSON.stringify(t))}catch(a){console.error("[AuthController] Error saving scope state:",a)}}static async fetchScope(){if(typeof mvvLegit>"u"||!this.isAuthenticated())return console.log("[AuthController] fetchScope skipped — not authenticated"),this.#a;if(this.#n)return this.#a;this.#n=!0;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),a=t?`?org=${encodeURIComponent(t)}`:"",n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.ME}${a}`);if(n.status===401||n.status===403)return console.warn("[AuthController] /me unauthorized — signing out"),this.doSignout(!0),null;if(!n.ok)return console.warn(`[AuthController] /me failed (${n.status}) — using cached scope`),this.#a;const o=await n.json();if(!o?.ok)return console.warn("[AuthController] /me returned not-ok — using cached scope"),this.#a;try{const s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);s&&o.activeOrg?.guid!==s&&(console.warn(`[AuthController] Stored active org not honored by /me${o.activeOrgError?" (activeOrgError)":""} — clearing`),localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG))}catch{}return this.#v(o),p.publish(u.AUTH_SCOPE_LOADED,o),console.log(`[AuthController] Scope loaded: ${o.uiMode} (${o.memberships?.length||0} org(s), ${o.managedClients?.length||0} client(s))`),o}catch(t){return console.error("[AuthController] fetchScope error:",t),this.#a}finally{this.#n=!1}}static async setActiveOrg(t){try{t?localStorage.setItem(this.CONFIG.LS_KEYS.ACTIVE_ORG,t):localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}return this.fetchScope()}static getScope(){return this.#a}static getCapabilities(){return this.isPreviewingAsClient()?pr({orgChannel:"managed_client",memberRole:"owner"}):this.#a?.capabilities||[]}static getUiMode(){return this.isPreviewingAsClient()?"managed":this.#a?.uiMode||"self_serve"}static getActiveOrg(){return this.#a?.activeOrg||null}static getMemberships(){return this.#a?.memberships||[]}static getManagedClients(){return this.#a?.managedClients||[]}static getStoredActiveOrg(){try{return localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{return null}}static#u="m5m_preview_as_client";static isPreviewingAsClient(){try{return sessionStorage.getItem(this.#u)==="1"&&!!this.#a?.activeOrg?.viaSubtree}catch{return!1}}static setPreviewAsClient(t){try{t?sessionStorage.setItem(this.#u,"1"):sessionStorage.removeItem(this.#u)}catch{}this.#a&&p.publish(u.AUTH_SCOPE_LOADED,this.#a)}static async doSignin(t,a){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a})}),o=await n.json();if(n.status===303)return console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#c(o.entity)),setTimeout(()=>{this.#r(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o};if(n.ok&&o.accessToken){console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#c(o.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#u)}catch{}return this.fetchScope(),console.log("[AuthController] Explicitly navigating to home"),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}}return{ok:!1,error:o.error||"Sign in failed",data:o}}catch(n){return console.error("[AuthController] Signin error:",n),{ok:!1,error:n.message}}}static async doSignout(t=!1){console.log("[AuthController] doSignout called, serverInitiated:",t);try{const a=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!a),!t&&a){const n=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(a)}`;if(console.log("[AuthController] Sending signout beacon to:",n),navigator.sendBeacon){const o=navigator.sendBeacon(n);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else a||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#d(),console.log("[AuthController] Stopping auth ping..."),this.#h(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(a){console.error("[AuthController] Signout error:",a),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(t){try{const a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await a.json();return a.ok&&n.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#c(n.entity),{ok:!0,data:n}):{ok:!1,error:n.error||"Sign up failed",data:n}}catch(a){return console.error("[AuthController] Signup error:",a),{ok:!1,error:a.message}}}static async doResetHash(t,a){try{const n=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a,modified_by:t})}),s=await o.json();return o.ok&&s.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:s}):{ok:!1,error:s.error||"Password reset failed",data:s}}catch(n){return console.error("[AuthController] Reset password error:",n),{ok:!1,error:n.message}}}static#g(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#f()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#h(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#f(){try{const t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);t.ok?console.log("[AuthController] Ping success"):(t.status===401||t.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(t){console.error("[AuthController] Ping error:",t)}}static setDeepLinkGuid(t){this.#s=t,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,t),console.log("[AuthController] Deep-link GUID stored:",t)}static getDeepLinkGuid(){return this.#s}static clearDeepLink(){this.#s=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#_(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.fetchScope()}static#b(){console.log("[AuthController] User unauthenticated"),this.#h()}static#y(){console.log("[AuthController] User unverified")}static getAuthState(){try{const t=mvvLegit.getConf()?.LSKEY||"mvv",a=localStorage.getItem(t);if(!a)return"UNAUTH";if(typeof LZString>"u")return null;const n=LZString.decompressFromUTF16(a),s=JSON.parse(n)?.state;return s===1?"UNAUTH":s===2?"UNVERF":s===4?"AUTH":s===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(t){this.#r(t)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#f()}}class T{static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",remember_email:"Remember my email",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_dashboard:"Dashboard",nav_dashboard_tagline:"Overview of your activity",nav_magnets:"Your Magnets",nav_magnets_tagline:"Manage your conversational magnets",nav_templates:"Templates",nav_templates_tagline:"Start from a magnet template",nav_conversations:"Conversations",nav_conversations_tagline:"Captured lead conversations",nav_ab_testing:"A/B Testing",nav_ab_testing_tagline:"Experiment and optimize",nav_analytics:"Analytics",nav_analytics_tagline:"Performance and ad metrics",nav_ad_accounts:"Ad Accounts",nav_ad_accounts_tagline:"Connect advertising accounts",nav_clients:"Clients",nav_clients_tagline:"Manage your client accounts",nav_team:"Team",nav_team_tagline:"Invite and manage teammates",nav_billing:"Billing",nav_billing_tagline:"Plan, usage, and invoices",nav_settings:"Settings",nav_settings_tagline:"Account and workspace settings",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Rollers",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",remember_email:"Recordar mi correo electrónico",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Rollers",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",remember_email:"记住我的邮箱",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"滚动器",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:t,product:a,whitelabel:n,lang:o}){t&&(this.#t.buildMode=t),a&&(this.#t.product=a),n&&(this.#t.whitelabel=n),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{let l=this.#e[o]?.[s]?.[r]?.[i]?.[t],c=o;return!l&&o!=="LOCAL"&&(l=this.#e.LOCAL?.[s]?.[r]?.[i]?.[t],c="LOCAL (fallback)"),l?(c==="LOCAL (fallback)"&&console.warn(`[MicrocopyManager] Token '${t}' missing from ${o} — served from LOCAL instead. Backfill ${o}'s block if this is intentionally different copy.`),Array.isArray(l)?l[Math.floor(Math.random()*l.length)]:l):(console.warn(`[MicrocopyManager] Token not found: ${t} (${o}/${s}/${r}/${i}, LOCAL fallback also missing it)`),null)}catch(l){return console.error(`[MicrocopyManager] Error retrieving token: ${t}`,l),null}}static getAll(t={}){const a={...this.#t,...t},{buildMode:n,product:o,whitelabel:s,lang:r}=a;try{return this.#e[n]?.[o]?.[s]?.[r]||null}catch(i){return console.error("[MicrocopyManager] Error retrieving all tokens",i),null}}static has(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return!!this.#e[o]?.[s]?.[r]?.[i]?.[t]}catch{return!1}}static getAvailableLanguages(){const{buildMode:t,product:a,whitelabel:n}=this.#t;try{return Object.keys(this.#e[t]?.[a]?.[n]||{})}catch{return[]}}static update(t,a,n={}){const o={...this.#t,...n},{buildMode:s,product:r,whitelabel:i,lang:l}=o;try{return this.#e[s]||(this.#e[s]={}),this.#e[s][r]||(this.#e[s][r]={}),this.#e[s][r][i]||(this.#e[s][r][i]={}),this.#e[s][r][i][l]||(this.#e[s][r][i][l]={}),this.#e[s][r][i][l][t]=a,!0}catch(c){return console.error(`[MicrocopyManager] Error updating token: ${t}`,c),!1}}static delete(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return delete this.#e[o]?.[s]?.[r]?.[i]?.[t],!0}catch(l){return console.error(`[MicrocopyManager] Error deleting token: ${t}`,l),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(t){try{return this.#e=t,!0}catch(a){return console.error("[MicrocopyManager] Error importing data",a),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:T});class Ce{static#e=!1;static#t=null;static#o=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const t=this.#n();T.setContext(t),console.log("[I18nController] Initialized with context:",t),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#s(),this.#p(),this.#e=!0,this.refresh()}static#a(t){const a={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},n=t.toLowerCase();return a[n]||"DEV"}static#n(){const a=this.#a("production"),n=localStorage.getItem(z.FF_SSE_LS_WHITELABEL)||z.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(z.FF_SSE_LS_USER_LANG)||z.FF_SSE_I18N_LANG;return{buildMode:a,product:z.FF_SSE_I18N_PRODUCT,whitelabel:n,lang:o}}static#s(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((t,a,n)=>{z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",n),this.#t=n,setTimeout(()=>{this.refresh()},z.FF_SSE_I18N_APPLY_DELAY_MS)},z.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#i())}static#i(){setInterval(()=>{const a=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");a&&a!==this.#t&&(this.#t=a,this.refresh())},500)}static#p(){this.#o||(this.#o=new MutationObserver(t=>{let a=!1;for(const n of t){for(const o of n.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){a=!0;break}if(a)break}a&&(z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#o.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#r(document.body),this.#l(document.body),z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#r(t){const a=t.querySelectorAll("[data-meta-copywrite-i118n]");z.FF_SSE_I18N_DEBUG&&a.length>0&&console.log(`[I18nController] Processing ${a.length} elements`),a.forEach(n=>{try{const o=n.getAttribute("data-meta-copywrite-i118n"),s=JSON.parse(o);if(!s.token){console.warn("[I18nController] Missing token in config:",s);return}const r=s.attribute||"textContent",i=T.get(s.token);if(i===null){console.warn(`[I18nController] Microcopy not found for token: ${s.token}`);return}r==="textContent"?n.textContent=i:r==="innerHTML"?n.innerHTML=i:n.setAttribute(r,i),z.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${i}" to ${r} for token: ${s.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,n)}})}static#l(t){t.querySelectorAll("*").forEach(n=>{n.shadowRoot&&(this.#r(n.shadowRoot),this.#l(n.shadowRoot))})}static setLanguage(t){const a=T.getAvailableLanguages();if(!a.includes(t)){console.error(`[I18nController] Language not available: ${t}. Available:`,a);return}localStorage.setItem(z.FF_SSE_LS_USER_LANG,t),T.setContext({lang:t}),console.log("[I18nController] Language changed to:",t);const n=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:t}});document.dispatchEvent(n),this.refresh()}static setWhitelabel(t){localStorage.setItem(z.FF_SSE_LS_WHITELABEL,t),T.setContext({whitelabel:t}),z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",t),this.refresh()}static getLanguage(){return T.getContext().lang}static getAvailableLanguages(){return T.getAvailableLanguages()}static getContext(){return T.getContext()}static destroy(){this.#o&&(this.#o.disconnect(),this.#o=null),this.#e=!1,this.#t=null,z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{Ce.initialize()}):Ce.initialize());class $a{static _initialized=!1;static _debug=!1;static init(t={}){if(this._initialized)return console.warn("[MachVive] Already initialized, skipping duplicate initialization"),this;if(this._debug=t.debug||!1,!window.mvvSSEther)return console.error("[MachVive] mvvSSEther not found - cannot initialize bridge"),console.error("[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()"),this;console.log("[MachVive] Initializing SSE to PubSub bridge...");const a=n=>{this._handleSSEMessage(n)};return window.mvvSSEther.onmessage(a),this._initialized=!0,console.log("[MachVive] ✓ SSE to PubSub bridge initialized successfully"),console.log("[MachVive] ✓ Bound callback to mvvSSEther.onmessage"),this}static _handleSSEMessage(t){try{this._debug&&console.log("[MachVive] SSE message received:",t);const a=t?.data;if(!a){this._debug&&console.log("[MachVive] No data in message, skipping");return}const n=a.data||a.package||a;if(!n){this._debug&&console.log("[MachVive] No package found in message, skipping");return}let o=n.cfg;const s=n.msg;if(this._debug&&(console.log("[MachVive] cfg (raw):",o,"type:",typeof o,"length:",o?.length),console.log("[MachVive] msg (raw):",s)),typeof o=="string"){if(o.trim()===""){this._debug&&console.log("[MachVive] cfg is empty string, skipping");return}try{o=JSON.parse(o),console.log("[MachVive] cfg (parsed):",o)}catch(i){console.warn("[MachVive] Failed to parse cfg as JSON:",{cfg:o,cfgLength:o.length,error:i.message});return}}else if(!o){this._debug&&console.log("[MachVive] cfg is empty/null, skipping");return}const r=o?.topic;if(!r){this._debug&&console.log("[MachVive] No topic found in cfg, skipping");return}if(console.log("[MachVive] Extracted topic:",r),!this._isValidTopic(r)){console.warn(`[MachVive] Topic '${r}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(r,s,t,a)}catch(a){console.error("[MachVive] Error handling SSE message:",a)}}static _isValidTopic(t){return!u||!u.hasOwnProperty(t)?(console.warn(`[MachVive] Topic '${t}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(t,a,n,o){try{if(!window.PubSub&&typeof PubSub>"u"){console.error("[MachVive] PubSub not available");return}const s=window.PubSub||PubSub,r={message:a,metadata:{source:"sse",sseEventId:n.id,timestamp:n.timestamp,appGuid:o.app_guid,channelGuid:o.channel_guid,eventAction:o.event_action,status:o.status,class:o.class,raw:o}};console.log(`[MachVive] Publishing to topic '${t}':`,r);const i=u[t];console.log(`[MachVive] AppBroadcast.${t} = '${i}'`),s.publish(i,r),console.log(`[MachVive] ✓ Published SSE message to topic: ${t}`)}catch(s){console.error(`[MachVive] Error publishing to topic '${t}':`,s)}}static debug(t){return this._debug=t,console.log(`[MachVive] Debug mode ${t?"enabled":"disabled"}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log("[MachVive] Reset complete"),this}}typeof module<"u"&&module.exports&&(module.exports=$a);typeof window<"u"&&(window.MachVive=$a);const tn="m5t_sidenav_collapsed",mr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};class gr extends HTMLElement{static get observedAttributes(){return["data-active-token","data-collapsed"]}constructor(){super(),this.attachShadow({mode:"open"}),this.items=[],this.orgs=[],this.activeOrgGuid=null,this.activeToken=null,this.footerBadge=null,this.loading=!1,this.lastFocus=null}#e=null;#t=t=>{if(this.getAttribute("data-open")==="true"){if(t.key==="Escape"){t.preventDefault(),this.closeDrawer();return}if(t.key==="Tab"){const a=this.#c();if(a.length<2)return;const n=a[0],o=a[a.length-1],s=this.shadowRoot.activeElement;t.shiftKey&&s===n?(t.preventDefault(),o.focus()):!t.shiftKey&&s===o&&(t.preventDefault(),n.focus())}}};#o=()=>{this.closeDrawer(),this.#d()};connectedCallback(){if(!this.hasAttribute("data-collapsed"))try{localStorage.getItem(tn)==="true"&&this.setAttribute("data-collapsed","true")}catch{}this.activeToken=this.getAttribute("data-active-token")||null,this.render(),this.#l(),this.addEventListener("keydown",this.#t),this.#e=window.matchMedia("(max-width: 768px)"),this.#e.addEventListener("change",this.#o),this.#d()}disconnectedCallback(){this.removeEventListener("keydown",this.#t),this.#e?.removeEventListener("change",this.#o)}attributeChangedCallback(t,a,n){a===n||!this.shadowRoot||(t==="data-active-token"?(this.activeToken=n,this.#m()):t==="data-collapsed"&&this.shadowRoot.firstChild&&(this.render(),this.#l()))}setState({buttons:t,orgs:a,activeOrg:n,footerBadge:o,loading:s}={}){t!==void 0&&(this.items=Array.isArray(t)?t:this.#a(t)||[]),a!==void 0&&(this.orgs=Array.isArray(a)?a:this.#a(a)||[]),n!==void 0&&(this.activeOrgGuid=n||null),o!==void 0&&(this.footerBadge=o||null),s!==void 0&&(this.loading=!!s),this.shadowRoot&&(this.render(),this.#l())}setButtons(t){this.setState({buttons:t})}setOrgs(t){this.setState({orgs:t})}setActiveOrgGuid(t){this.setState({activeOrg:t})}setFooterBadge(t){this.setState({footerBadge:t})}setActiveToken(t){this.activeToken=t||null,this.#m()}toggleCollapsed(t){const a=typeof t=="boolean"?t:this.getAttribute("data-collapsed")!=="true";this.setAttribute("data-collapsed",String(a));try{localStorage.setItem(tn,String(a))}catch{}this.dispatchEvent(new CustomEvent("nav-collapse",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_SIDE_NAV.COLLAPSE",collapsed:a,timestamp:Date.now()}}))}openDrawer(){this.lastFocus=this.shadowRoot.activeElement||document.activeElement,this.setAttribute("data-open","true"),this.shadowRoot.querySelector(".hamburger")?.setAttribute("aria-expanded","true"),this.#d(),(this.#c()[0]||this.shadowRoot.querySelector(".sidenav"))?.focus?.()}closeDrawer(){if(this.getAttribute("data-open")!=="true")return;this.removeAttribute("data-open");const t=this.shadowRoot.querySelector(".hamburger");t?.setAttribute("aria-expanded","false"),this.#d(),t&&this.#e?.matches?t.focus():this.lastFocus?.focus?.()}toggleDrawer(){this.getAttribute("data-open")==="true"?this.closeDrawer():this.openDrawer()}#a(t){try{return t?JSON.parse(t):null}catch(a){return console.error("[M5TSideNav] bad JSON:",a),null}}#n(t){return String(t??"").replace(/[&<>"']/g,a=>mr[a])}#s(t){return t?`<span class="ms" aria-hidden="true">${this.#n(t)}</span>`:""}#i(t){if(!t||!t.token)return"";const a=t.token===this.activeToken,n=t.route||"#",o=n.startsWith("#")?n:`#${n}`,s=typeof t.count=="number"&&t.count>0?`<span class="badge">${t.count}</span>`:"";return`
    ...
    `}attachEventListeners(){this.shadowRoot.querySelectorAll(".nav-button").forEach(n=>{const o=n.getAttribute("data-token"),s=n.getAttribute("data-level");n.addEventListener("click",r=>{o&&!r.currentTarget.disabled&&!this.longTapFired&&(s==="primary"?this.selectPrimaryButton(o):this.selectSecondaryButton(o)),this.longTapFired=!1}),n.addEventListener("dblclick",r=>{if(o&&!r.currentTarget.disabled){const i=this.getButtonData(o,s);console.log("[M5TPrimaryNav] Button double-clicked:",o),this.dispatchEvent(new CustomEvent("nav-double-tap",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.DOUBLE_TAP",token:o,level:s,caption:i.caption,tagline:i.tagline,timestamp:Date.now()}}))}}),n.addEventListener("mouseenter",r=>{if(o&&!r.currentTarget.disabled){const i=this.getButtonData(o,s);this.dispatchEvent(new CustomEvent("nav-hover",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.HOVER",token:o,level:s,caption:i.caption,tagline:i.tagline,action:"enter",timestamp:Date.now()}}))}}),n.addEventListener("mouseleave",r=>{if(o&&!r.currentTarget.disabled){const i=this.getButtonData(o,s);this.dispatchEvent(new CustomEvent("nav-hover",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.HOVER",token:o,level:s,caption:i.caption,tagline:i.tagline,action:"leave",timestamp:Date.now()}}))}}),n.addEventListener("mousedown",r=>{o&&!r.currentTarget.disabled&&(this.longTapActive=!0,this.longTapFired=!1,this.longTapTimer=setTimeout(()=>{const i=this.getButtonData(o,s);console.log("[M5TPrimaryNav] Button long-tap:",o),this.longTapFired=!0,this.dispatchEvent(new CustomEvent("nav-long-tap",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.LONG_TAP",token:o,level:s,caption:i.caption,tagline:i.tagline,timestamp:Date.now()}}))},this.longTapDelay))}),n.addEventListener("mouseup",r=>{this.longTapTimer&&(clearTimeout(this.longTapTimer),this.longTapTimer=null),this.longTapActive=!1}),n.addEventListener("mouseleave",r=>{this.longTapTimer&&(clearTimeout(this.longTapTimer),this.longTapTimer=null),this.longTapActive=!1})});const a=this.shadowRoot.querySelector(".logo");a&&a.addEventListener("click",()=>{console.log("[M5TPrimaryNav] Logo clicked"),this.logoTopic&&window.m5t?.pubsub?(console.log(`[M5TPrimaryNav] Publishing to topic: ${this.logoTopic}`),window.m5t.pubsub.publish(this.logoTopic,{timestamp:Date.now()})):this.logoTopic&&!window.m5t?.pubsub&&console.warn("[M5TPrimaryNav] Logo topic configured but window.m5t.pubsub not found"),this.dispatchEvent(new CustomEvent("logo-click",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.LOGO_TAP",timestamp:Date.now()}}))})}selectPrimaryButton(t){const a=this.buttons.find(o=>o.token===t),n=this.getButtonData(t,"primary");this.dispatchEvent(new CustomEvent("nav-select",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.TAP",token:t,level:"primary",caption:n.caption,tagline:n.tagline,hasSecondary:(a?.secondary?.length||0)>0,timestamp:Date.now()}})),this.selectedPrimaryToken!==t&&(this.selectedPrimaryToken=t,this.render(),this.attachEventListeners())}selectSecondaryButton(t){const a=this.getButtonData(t,"secondary");this.dispatchEvent(new CustomEvent("nav-select",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.TAP",token:t,primaryToken:this.selectedPrimaryToken,level:"secondary",caption:a.caption,tagline:a.tagline,timestamp:Date.now()}}))}updateButtons(t){this.setAttribute("data-buttons",JSON.stringify(t)),this.parseButtons(),this.render(),this.attachEventListeners()}updateCount(t,a,n="primary"){let o;n==="primary"?o=this.buttons.find(s=>s.token===t):o=this.getSecondaryButtons().find(r=>r.token===t),o&&(o.count=a,this.render(),this.attachEventListeners())}getSelection(){return{primary:this.selectedPrimaryToken,secondary:null}}}customElements.define("m5t-primary-nav",hr);const Et=()=>x.getConfig?.().BASE_URL||"",fr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},pt=e=>String(e??"").replace(/[&<>"']/g,t=>fr[t]),vr=300*1e3;function _r(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function br(e){const t=e.link?"a":"div",a=e.link?` href="${pt(e.link)}"`:"";return`<${t} class="m5t-notif-item" data-guid="${pt(e.guid)}" data-read="${e.read}"${a} role="menuitem">
    <div class="m5t-notif-title">${pt(e.title)}</div>
    ${e.body?`<div class="m5t-notif-body">${pt(e.body)}</div>`:""}
    <div class="m5t-notif-time">${pt(_r(e.created_tz))}</div>
  </${t}>`}function yr(e){const t=document.getElementById("m5t-notif-bell");if(t&&(t.hidden=!e),!e){const a=document.getElementById("m5t-notif-panel");a&&(a.hidden=!0)}}let an=null;function wr(){const e=document.getElementById("m5t-notif-bell-btn"),t=document.getElementById("m5t-notif-badge"),a=document.getElementById("m5t-notif-panel");if(!e||!t||!a)return;const n=l=>{t.textContent=l>99?"99+":String(l),t.hidden=!l},o=async()=>{try{const l=await fetch(`${Et()}/m5t/v5/notifications/unread-count`),c=await l.json().catch(()=>({}));l.ok&&c.ok&&n(c.count||0)}catch{}},s=async()=>{a.innerHTML='<div class="m5t-notif-head">Notifications</div><div class="m5t-notif-empty">Loading…</div>';try{const l=await fetch(`${Et()}/m5t/v5/notifications`),c=await l.json().catch(()=>({}));if(!l.ok||!c.ok)throw new Error;const g=c.notifications||[];a.innerHTML=`
        <div class="m5t-notif-head">
          Notifications
          ${g.some(b=>!b.read)?'<button class="m5t-notif-markall" type="button">Mark all read</button>':""}
        </div>
        ${g.length?g.map(br).join(""):'<div class="m5t-notif-empty">You’re all caught up.</div>'}`}catch{a.innerHTML='<div class="m5t-notif-head">Notifications</div><div class="m5t-notif-empty">Could not load. Try again.</div>'}},r=()=>{a.hidden=!0,e.setAttribute("aria-expanded","false")},i=async()=>{a.hidden=!1,e.setAttribute("aria-expanded","true"),await s()};e.addEventListener("click",l=>{l.stopPropagation(),a.hidden?i():r()}),document.addEventListener("click",l=>{!a.hidden&&!a.contains(l.target)&&l.target!==e&&r()}),a.addEventListener("click",async l=>{const c=l.target.closest(".m5t-notif-item");if(c&&c.dataset.read==="false"){const b=c.dataset.guid;c.dataset.read="true";try{await fetch(`${Et()}/m5t/v5/notifications/${encodeURIComponent(b)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({read:!0})}),o()}catch{}return}const g=l.target.closest(".m5t-notif-markall");if(g){l.preventDefault(),a.querySelectorAll(".m5t-notif-item").forEach(b=>{b.dataset.read="true"}),g.remove();try{await fetch(`${Et()}/m5t/v5/notifications/read-all`,{method:"PATCH"})}catch{}o()}}),o(),clearInterval(an),an=setInterval(o,vr)}function La(){return Ca("FF_SSE_UI_DARK_MODE")}function xr(e=La()){return e&&localStorage.getItem(z.FF_SSE_LS_THEME)==="dark"?"dark":"light"}function Er(e=Ca("FF_SSE_UI_ANIMATIONS")){return!e}function Sr(e,t=La()){!e||t||e.shadowRoot?.querySelector('.footer-action[data-action="theme"]')?.remove()}window.m5t=Object.create(null);window.m5t.pubsub=p;console.log("StreamSyncEngage SaaS Client - Starting...");console.log("Environment:","production");console.log("Document readyState:",document.readyState);console.log("window.mvvLegit:",typeof window.mvvLegit);console.log("globalThis.mvvLegit:",typeof globalThis.mvvLegit);try{console.log("mvvLegit (direct):",typeof mvvLegit)}catch(e){console.log("mvvLegit (direct): ReferenceError -",e.message)}const Ar=Object.keys(window).filter(e=>e.toLowerCase().includes("mvv")||e.toLowerCase().includes("neodigm")||e.toLowerCase().includes("legit"));console.log("Possible Neodigm globals:",Ar);const D=new js("/",{hash:!0});window.router=D;function _e(e){const t=e?`${e.replace(/-/g,"_")}_route`:"splash_route";return console.log(`[Router] Checking access: ${e} -> ${t}`),mvvLegit.isRouteAllowed(t)?!0:(console.warn(`[Router] Access denied to route: ${t}`),p.publish(u.UI_TOAST,{message:"Please sign in to access this page",type:"warning"}),!1)}function re(e){console.log("[Router] Navigating to:",e),D.navigate(`/${e}`)}const Na=new Set(["splash","signin","signup","forgot","resethash","verf-link","accept-invite","signout"]);let ft={},ua={},je=null;const kr={admin:{caption:"Platform Admin",icon:"shield_person"},reseller:{caption:"Reseller",icon:"handshake"},managed:{caption:"Managed",icon:"visibility"},self_serve:{caption:"Self-Serve",icon:"rocket_launch"}},ma="__portfolio__";function lo(){try{D._setCurrent(null)}catch{}D.resolve()}function ra(){const e=document.getElementById("m5t-side-nav");if(!e)return;const t=!x.getScope()&&x.isAuthenticated(),a=x.getCapabilities(),n=x.getUiMode(),o=Kt.getSideNav(a,{uiMode:n});ft={},ua={};const s=y=>{y.route&&(ft[y.route]={sectionToken:y.token,childToken:null,children:y.children||null},Array.isArray(y.children)&&y.children.forEach(_=>{_.route&&(ua[_.token]=_.route,ft[_.route]={sectionToken:y.token,childToken:_.token,children:y.children})}))},r=y=>y.forEach(_=>{_.group&&Array.isArray(_.items)?r(_.items):s(_)});r(o);const i=x.getMemberships(),l=x.getActiveOrg(),c=x.getManagedClients(),g=x.getStoredActiveOrg(),b=c.length?[{guid:ma,name:"Portfolio (all clients)"},...i.map(y=>({guid:y.orgGuid,name:y.name||y.channel,channel:y.channel,group:"Your organization"})),...c.map(y=>({guid:y.orgGuid,name:y.name||y.orgGuid,channel:y.channel,group:"Clients"}))]:i.map(y=>({guid:y.orgGuid,name:y.name||y.channel,channel:y.channel}));e.setState({buttons:o,orgs:b,activeOrg:c.length?g||ma:l?.guid||null,footerBadge:kr[n]||null,loading:t}),co(),je&&po(je)}const Cr=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]);function co(){const e=document.getElementById("app-content");if(!e)return;let t=document.getElementById("org-context-banner");t||(t=document.createElement("div"),t.id="org-context-banner",e.insertBefore(t,e.firstChild));const a=x.getActiveOrg(),n=x.isPreviewingAsClient(),o=!!a?.viaSubtree&&!!je&&!Na.has(je);if(t.hidden=!o,!o){t.innerHTML="";return}const s=Cr(a.name||"Client");t.innerHTML=`
    <style>
    ...
    <div class="ocb" role="status">
    ...
    </div>`,t.querySelector('[data-ocb="preview"]')?.addEventListener("click",()=>{x.setPreviewAsClient(!x.isPreviewingAsClient()),lo()}),t.querySelector('[data-ocb="portfolio"]')?.addEventListener("click",()=>{x.setPreviewAsClient(!1),x.setActiveOrg(null)})}function po(e){const t=document.getElementById("m5t-side-nav"),a=ft[`/${e}`]||ft[e]||null;t?.setActiveToken(a?.sectionToken||null),Tr(a)}function Tr(e){const t=document.getElementById("m5t-sub-nav"),a=document.getElementById("app-shell");if(!t)return;const n=e?.children;t.hidden=!1,n&&n.length>1?(t.updateButtons(n.map(o=>({token:o.token,caption:o.caption,enabled:!0,selected:o.token===e.childToken}))),a?.classList.add("has-sub-nav")):(t.updateButtons([]),a?.classList.remove("has-sub-nav"))}function Ir(){const e=Ce.getAvailableLanguages&&Ce.getAvailableLanguages()||[];if(e.length<2){p.publish(u.UI_TOAST,{message:"Only one language is available",type:"info"});return}const t=localStorage.getItem(z.FF_SSE_LS_USER_LANG)||z.FF_SSE_I18N_LANG||e[0],a=e[(e.indexOf(t)+1)%e.length];Ce.setLanguage(a),p.publish(u.UI_TOAST,{message:`Language: ${a}`,type:"info"})}function uo(e){document.documentElement.setAttribute("data-theme",e)}function $r(){uo(xr())}function Lr(){if(!La())return;const e=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";uo(e),localStorage.setItem(z.FF_SSE_LS_THEME,e),p.publish(u.UI_TOAST,{message:e==="dark"?"Dark mode on":"Dark mode off",type:"info"})}function Nr(){document.documentElement.classList.toggle("ff-no-animations",Er())}function Or(){const e=document.getElementById("m5t-side-nav");if(!e)return;Kt.setAppToken("client-saas"),Sr(e),document.getElementById("app-shell")?.classList.toggle("nav-collapsed",e.getAttribute("data-collapsed")==="true"),e.addEventListener("nav-select",o=>{const s=o.detail?.route;s&&D.navigate(s.startsWith("/")?s:`/${s}`)}),e.addEventListener("logo-click",()=>D.navigate("/home")),e.addEventListener("nav-collapse",o=>{document.getElementById("app-shell")?.classList.toggle("nav-collapsed",!!o.detail?.collapsed)}),e.addEventListener("org-switch",o=>{const s=o.detail?.orgGuid;s&&x.setActiveOrg(s===ma?null:s)}),e.addEventListener("footer-action",o=>{switch(o.detail?.action){case"account":D.navigate("/settings");break;case"signout":D.navigate("/signout");break;case"lang":Ir();break;case"theme":Lr();break}}),document.getElementById("m5t-sub-nav")?.addEventListener("nav-select",o=>{const s=ua[o.detail?.token];s&&D.navigate(s)}),document.addEventListener("language-changed",()=>ra()),ra(),p.subscribe(u.AUTH_SCOPE_LOADED,()=>ra());const a=()=>{const o=x.getScope();return[o?.uiMode,o?.activeOrg?.guid,(o?.managedClients||[]).length,(o?.capabilities||[]).join(","),x.getStoredActiveOrg()].join("|")};let n=a();p.subscribe(u.AUTH_SCOPE_LOADED,()=>{const o=a();o!==n&&(n=o,je&&!Na.has(je)&&lo())})}function Rr(e){je=e;const t=document.getElementById("m5t-side-nav"),a=document.getElementById("app-shell");if(!t||!a)return;const n=!Na.has(e);if(t.hidden=!n,a.classList.toggle("has-side-nav",n),yr(n),n)po(e);else{const o=document.getElementById("m5t-sub-nav");o&&(o.hidden=!0),a.classList.remove("has-sub-nav")}co()}p.subscribe(u.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&Rr(t.route)});const mo=()=>{console.log("[Router] Route: splash"),p.publish(u.ROUTE_NAV_BEFORE,{route:"splash"});const e=ro();ee(e?()=>Promise.resolve().then(()=>Ur):()=>Promise.resolve().then(()=>Gr),void 0).then(a=>{const n=document.getElementById("app");n.innerHTML=a.render(),a.init&&a.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"splash"})}).catch(a=>{console.error("[Router] Error loading splash route:",a),p.publish(u.ROUTE_NAV_ERROR,{route:"splash",error:a})})};D.on("/",mo);D.on("/splash",mo);D.on("/signin",()=>{console.log("[Router] Route: /signin"),p.publish(u.ROUTE_NAV_BEFORE,{route:"signin"}),ee(()=>Promise.resolve().then(()=>Jr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"signin"})}).catch(e=>{console.error("[Router] Error loading signin route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"signin",error:e})})});D.on("/signup",()=>{console.log("[Router] Route: /signup"),p.publish(u.ROUTE_NAV_BEFORE,{route:"signup"}),ee(()=>Promise.resolve().then(()=>ti),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"signup"})}).catch(e=>{console.error("[Router] Error loading signup route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"signup",error:e})})});D.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),p.publish(u.ROUTE_NAV_BEFORE,{route:"verf-link"}),ee(()=>Promise.resolve().then(()=>oi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(e=>{console.error("[Router] Error loading verf-link route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"verf-link",error:e})})});D.on("/forgot",()=>{console.log("[Router] Route: /forgot"),p.publish(u.ROUTE_NAV_BEFORE,{route:"forgot"}),ee(()=>Promise.resolve().then(()=>pi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(e=>{console.error("[Router] Error loading forgot route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"forgot",error:e})})});D.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!_e("resethash")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"resethash"}),ee(()=>Promise.resolve().then(()=>gi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(e=>{console.error("[Router] Error loading resethash route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"resethash",error:e})})});D.on("/home",()=>{if(console.log("[Router] Route: /home"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"home"}),ee(()=>Promise.resolve().then(()=>Ci),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"home"})}).catch(e=>{console.error("[Router] Error loading home route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"home",error:e})})});D.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!_e("signout")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"signout"}),ee(()=>Promise.resolve().then(()=>$i),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"signout"})}).catch(e=>{console.error("[Router] Error loading signout route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"signout",error:e})})});const Mr=[{path:"/templates",name:"templates",title:"Templates",icon:"content_copy"},{path:"/analytics",name:"analytics",title:"Analytics",icon:"monitoring"},{path:"/ad-accounts",name:"ad-accounts",title:"Ad Accounts",icon:"ads_click"},{path:"/billing",name:"billing",title:"Billing",icon:"receipt_long"},{path:"/settings",name:"settings",title:"Settings",icon:"settings"},{path:"/magnets/drafts",name:"magnets/drafts",title:"Magnets · Drafts",icon:"widgets"},{path:"/magnets/archived",name:"magnets/archived",title:"Magnets · Archived",icon:"widgets"},{path:"/analytics/conversions",name:"analytics/conversions",title:"Analytics · Conversions",icon:"monitoring"},{path:"/settings/workspace",name:"settings/workspace",title:"Settings · Workspace",icon:"settings"},{path:"/settings/integrations",name:"settings/integrations",title:"Settings · Integrations",icon:"settings"},{path:"/settings/security",name:"settings/security",title:"Settings · Security",icon:"settings"}];Mr.forEach(({path:e,name:t,title:a,icon:n})=>{D.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:t}),ee(()=>Promise.resolve().then(()=>Oi),void 0).then(o=>{const s=document.getElementById("app");s.innerHTML=o.render({title:a,icon:n,name:t}),o.init&&o.init({name:t}),p.publish(u.ROUTE_NAV_AFTER,{route:t})}).catch(o=>{console.error(`[Router] Error loading section route (${t}):`,o),p.publish(u.ROUTE_NAV_ERROR,{route:t,error:o})})})});D.on("/settings/notifications",()=>{if(console.log("[Router] Route: /settings/notifications"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"settings/notifications"}),ee(()=>Promise.resolve().then(()=>Hi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"settings/notifications"})}).catch(e=>{console.error("[Router] Error loading settings-notifications route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"settings/notifications",error:e})})});D.on("/settings/integrations",()=>{if(console.log("[Router] Route: /settings/integrations"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),ee(()=>Promise.resolve().then(()=>cl),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(e=>{console.error("[Router] Error loading settings-integrations route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"settings/integrations",error:e})})});D.on("/conversations",()=>{if(console.log("[Router] Route: /conversations"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"conversations"}),ee(()=>Promise.resolve().then(()=>bl),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"conversations"})}).catch(e=>{console.error("[Router] Error loading conversations route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"conversations",error:e})})});D.on("/ab-testing",()=>{if(console.log("[Router] Route: /ab-testing"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"ab-testing"}),ee(()=>Promise.resolve().then(()=>Ol),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"ab-testing"})}).catch(e=>{console.error("[Router] Error loading ab-testing route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"ab-testing",error:e})})});D.on("/magnets",()=>{if(console.log("[Router] Route: /magnets"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"magnets"}),ee(()=>Promise.resolve().then(()=>Pc),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"magnets"})}).catch(e=>{console.error("[Router] Error loading magnets route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"magnets",error:e})})});D.on("/leads",()=>{if(console.log("[Router] Route: /leads"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"leads"}),ee(()=>Promise.resolve().then(()=>Xc),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"leads"})}).catch(e=>{console.error("[Router] Error loading leads route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"leads",error:e})})});D.on("/analytics/ad-performance",()=>{if(console.log("[Router] Route: /analytics/ad-performance"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"analytics/ad-performance"}),ee(()=>Promise.resolve().then(()=>od),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"analytics/ad-performance"})}).catch(e=>{console.error("[Router] Error loading ad-performance route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"analytics/ad-performance",error:e})})});D.on("/clients",()=>{if(console.log("[Router] Route: /clients"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"clients"}),ee(()=>Promise.resolve().then(()=>hd),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"clients"})}).catch(e=>{console.error("[Router] Error loading clients route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"clients",error:e})})});D.on("/team",()=>{if(console.log("[Router] Route: /team"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"team"}),ee(()=>Promise.resolve().then(()=>Sd),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"team"})}).catch(e=>{console.error("[Router] Error loading team route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"team",error:e})})});D.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),re("splash")});p.subscribe(u.ROUTE_NAV,(e,t)=>{console.log("[Router] ROUTE_NAV event received:",t),t?.route&&re(t.route)});function nn(){console.log("[App] Waiting for Neodigm 55 library...");let e=0;const t=100,a=setInterval(()=>{e++,e%10===0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(a),Fr()):e>=t&&(clearInterval(a),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
      ...
      `,p.publish(u.APP_ERROR,{message:"Failed to load authentication library"}))},100)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",nn):nn();async function Fr(){if(console.log("[App] Neodigm 55 loaded, initializing..."),$r(),Nr(),or(),Ce.initialize(),console.log("[App] I18n Controller initialized"),!await x.init({BASE_URL:"https://machfivemagnet-saas.onrender.com",navigateFunction:a=>{console.log("[AuthController] Navigation requested:",a),re(a)}})){console.error("[App] AuthController initialization failed");return}const t=x.getEntity();t&&(console.log("[App] Session restored for:",t.email),p.publish(u.APP_USER_LOADED,{entity:t}),x.isAuthenticated()&&x.fetchScope()),p.publish(u.APP_READY,{timestamp:new Date().toISOString(),sessionUser:t}),Or(),wr(),D.resolve(),window.AuthController=x,window.I18nController=Ce,window.MachVive=$a,console.log("[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)")}p.subscribe(u.ROUTE_NAV_AFTER,(e,t)=>{typeof Ce<"u"&&Ce.refresh&&setTimeout(()=>{Ce.refresh()},100)});let on=!1;function Pr(){if(on)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
    .accept-invite-page {
  ...
  `,document.head.appendChild(e),on=!0}function Dr(){const e=new URLSearchParams(window.location.search||"");let t=e.get("uid")||"",a=e.get("token")||"";if(!t||!a){const n=window.location.hash||"",o=n.includes("?")?n.slice(n.indexOf("?")+1):"",s=new URLSearchParams(o);if(t=t||s.get("uid")||"",a=a||s.get("token")||"",!t||!a){const r=n.replace(/^#\/?/,"").split("?")[0].split("/").filter(Boolean);t=t||r[1]||"",a=a||r[2]||""}}try{return{uid:decodeURIComponent(t),token:decodeURIComponent(a)}}catch{return{uid:t,token:a}}}function go(){return Pr(),`
    ...
    </div>`}function ho(){const{uid:e,token:t}=Dr(),a=document.getElementById("accept-invite-form"),n=document.getElementById("ai-pass"),o=document.getElementById("ai-confirm"),s=document.getElementById("ai-submit"),r=document.getElementById("ai-msg");if(!a)return;const i=(l,c="error")=>{r.textContent=l,r.className=`accept-invite-msg ${c}`};if(!e||!t){i("This invitation link is invalid or incomplete. Please use the link from your email."),s.disabled=!0;return}a.addEventListener("submit",async l=>{l.preventDefault();const c=n.value||"",g=o.value||"";if(c.length<8){i("Password must be at least 8 characters.");return}if(c!==g){i("Passwords do not match.");return}s.disabled=!0,i("Setting up your account…","ok");try{const b=x.getConfig?.().BASE_URL||"",y=await fetch(`${b}/m5t/v5/acctEntity/acceptInvite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({uid:e,token:t,password:c})}),_=await y.json().catch(()=>({}));if(!y.ok||!_.ok){const d=y.status===410?"This invitation has expired. Ask for a new one.":y.status===409?"This invitation has already been used. Try signing in.":_.error||`Could not accept the invitation (HTTP ${y.status}).`;i(d),s.disabled=!1;return}try{window.history.replaceState({},"",window.location.pathname+window.location.hash)}catch{}i("Welcome! Signing you in…","ok"),(await x.doSignin(_.entity.email,c))?.ok||(i("Your account is ready. Please sign in.","ok"),setTimeout(()=>{window.location.hash="#/signin"},1200))}catch(b){console.error("[accept-invite] error:",b),i("Something went wrong. Please try again."),s.disabled=!1}})}const Br={render:go,init:ho},Ur=Object.freeze(Object.defineProperty({__proto__:null,default:Br,init:ho,render:go},Symbol.toStringTag,{value:"Module"}));function Hr(){return`
  ...
  `}function zr(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const e=localStorage.getItem(z.FF_SSE_LS_TOKEN),t=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!e,hasMvvTs:!!t});const a=document.getElementById("splash-loader"),n=document.getElementById("splash-actions");e?(console.log("[SplashRoute] Auth token found → HOME"),p.publish(u.ROUTE_NAV,{route:"home"})):t?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),p.publish(u.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),a&&(a.style.display="none"),n&&(n.style.display="flex"),document.querySelectorAll("[data-route]").forEach(s=>{s.addEventListener("click",()=>{const r=s.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${r}`),p.publish(u.ROUTE_NAV,{route:r})})}))},4e3)}const Gr=Object.freeze(Object.defineProperty({__proto__:null,init:zr,render:Hr},Symbol.toStringTag,{value:"Module"}));function ie(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}const qr=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;function Oa(e,t){return e?qr.test(e)?!0:(ie(t,T.get("validation_email_invalid")),!1):(ie(t,T.get("validation_email_required")),!1)}function Vr(){return`
  ...
  `}function jr(){console.log("[SigninRoute] Initialized");const e=document.getElementById("loginForm"),t=document.getElementById("email"),a=document.getElementById("password"),n=document.getElementById("togglePassword"),o=document.getElementById("rememberEmail"),s=localStorage.getItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL);s&&t&&o&&(t.value=s,o.checked=!0,a?.focus()),n?.addEventListener("click",()=>{const i=a.type==="password"?"text":"password";a.type=i}),e?.addEventListener("submit",async i=>{i.preventDefault();const l=t.value.trim(),c=a.value;Oa(l,t)&&Wr(c,a)&&(o?.checked?localStorage.setItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL,l):localStorage.removeItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL),await Yr(l,c))}),document.getElementById("link--uc__underline")?.addEventListener("click",i=>{i.preventDefault(),p.publish(u.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",i=>{i.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),p.publish(u.ROUTE_NAV,{route:"signup"})})}function Wr(e,t){return e?e.length<10?(ie(t,T.get("validation_password_min_length")),!1):!0:(ie(t,T.get("validation_password_required")),!1)}async function Yr(e,t){const a=document.querySelector(".btn");a.disabled=!0,a.textContent=T.get("loading_signing_in");try{const n=await x.doSignin(e,t);n.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(T.get("success_welcome_back"),"success"),p.publish(u.AUTH_SIGNIN_SUCCESS,{entity:x.getEntity()})):n.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q(T.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(n.error||T.get("error_signin_failed"),"danger"),a.disabled=!1,a.textContent=(T.get("sign_in")||"Sign in").toUpperCase())}catch(n){console.error("[SigninRoute] Sign in error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||T.get("error_network"),"danger"),a.disabled=!1,a.textContent=(T.get("sign_in")||"Sign in").toUpperCase(),p.publish(u.AUTH_SIGNIN_FAIL,{message:n.message})}}const Jr=Object.freeze(Object.defineProperty({__proto__:null,init:jr,render:Vr},Symbol.toStringTag,{value:"Module"}));function fo(e){const t=[];return e.length<12&&t.push("at least 12 characters"),e.length>1024&&t.push("at most 1024 characters"),/[a-z]/.test(e)||t.push("1 lowercase"),/[A-Z]/.test(e)||t.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(e)||t.push("1 special character"),/[^\x00-\x7F]/.test(e)&&t.push("ASCII characters only"),t}function vo(e){return e.length===0?"":e.includes("ASCII characters only")?"Password cannot contain emoji|or special unicode characters":e.includes("at least 10 characters")?"Password must have at least|10 characters":"Password must have: Uppercase,|Lowercase, and Special Character"}const Kr="2026-07-15";function Xr(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function Qr(){console.log("[SignupRoute] Initialized");const e=document.getElementById("signupForm"),t=e.querySelector('button[type="submit"]');sn("togglePassword","password","eyeIcon"),sn("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),p.publish(u.ROUTE_NAV,{route:"signin"})}),e.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),s=document.getElementById("last").value.trim(),r=document.getElementById("email").value.trim(),i=document.getElementById("company").value.trim(),l=document.getElementById("phone").value.trim(),c=document.getElementById("password").value,g=document.getElementById("confirmPassword").value,b=document.getElementById("first"),y=document.getElementById("last"),_=document.getElementById("email"),w=document.getElementById("password"),d=document.getElementById("confirmPassword");if(!rn(o,b,T.get("validation_first_name_required"))||!rn(s,y,T.get("validation_last_name_required"))||!Oa(r,_)||!Zr(c,w))return;if(c!==g){ie(d,T.get("validation_password_mismatch"));return}const h=document.getElementById("acceptTerms");if(!h.checked){ie(h,"Please accept the Terms of Service and Privacy Policy to continue.");return}t.disabled=!0,t.textContent=T.get("loading_creating_account"),await ei(o,s,r,i,l,c)})}function sn(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function rn(e,t,a){return e?!0:(ie(t,a),!1)}function Zr(e,t){if(!e)return ie(t,T.get("validation_password_required")),!1;const a=fo(e);return a.length>0?(ie(t,vo(a)),!1):!0}async function ei(e,t,a,n,o,s){const r=document.querySelector('button[type="submit"]');try{const i={email:a,password:s,first:e,last:t};n&&(i.company=n),o&&(i.phone=o),i.terms_accepted=!0,i.legal_version=Kr;const l=await x.doSignup(i);if(l.ok)p.publish(u.AUTH_SIGNUP_SUCCESS,{email:a}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const c=l.error||l.message||T.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(c,"danger"),r.disabled=!1,r.textContent=(T.get("create_account")||"Create account").toUpperCase(),p.publish(u.AUTH_SIGNUP_FAIL,{message:c})}}catch(i){console.error("[SignupRoute] Sign up error:",i),typeof neodigmToast<"u"&&neodigmToast.q(i.message||T.get("error_network"),"danger"),r.disabled=!1,r.textContent=(T.get("create_account")||"Create account").toUpperCase(),p.publish(u.AUTH_SIGNUP_FAIL,{message:i.message})}}const ti=Object.freeze(Object.defineProperty({__proto__:null,init:Qr,render:Xr},Symbol.toStringTag,{value:"Module"}));function ai(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function ci(){console.log("[ForgotRoute] Initialized");const e=document.getElementById("forgot-form"),t=document.getElementById("email");e?.addEventListener("submit",async a=>{a.preventDefault();const n=t.value.trim();Oa(n,t)&&await di(n)})}async function di(e){const t=document.querySelector(".btn");t.disabled=!0,t.textContent="SENDING...";try{const a=await ii.forgotPassword(e);a.ok&&a.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q(T.get("success_reset_link_sent"),"success"),p.publish(u.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(a.data.error||T.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=(T.get("send_reset_link")||"Send reset link").toUpperCase())}catch(a){console.error("[ForgotRoute] Forgot password error:",a),typeof neodigmToast<"u"&&neodigmToast.q(a.message||T.get("error_network"),"danger"),t.disabled=!1,t.textContent=(T.get("send_reset_link")||"Send reset link").toUpperCase()}}const pi=Object.freeze(Object.defineProperty({__proto__:null,init:ci,render:li},Symbol.toStringTag,{value:"Module"}));function ui(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function mi(){console.log("[ResethashRoute] Initialized");const e=document.getElementById("resethash-form"),t=e.querySelector('button[type="submit"]');ln("toggleNewPassword","new-password","eyeIconNew"),ln("toggleConfirmPassword","confirm-password","eyeIconConfirm"),e?.addEventListener("submit",async a=>{a.preventDefault();const n=e.email.value.trim(),o=e.newPassword.value,s=e.confirmPassword.value,r=document.getElementById("new-password"),i=document.getElementById("confirm-password");if(!o){ie(r,T.get("validation_new_password_required"));return}const l=fo(o);if(l.length>0){ie(r,vo(l));return}if(!s){ie(i,T.get("validation_new_password_required"));return}if(o!==s){ie(i,T.get("validation_password_mismatch"));return}t.disabled=!0,t.textContent=T.get("loading_resetting_password");try{const c=await x.doResetHash(n,o);c.ok?(typeof neodigmToast<"u"&&neodigmToast.q(T.get("success_password_reset"),"success"),p.publish(u.AUTH_RESETHASH_SUCCESS,{email:n})):(ie(r,c.error||T.get("error_signin_failed")),t.disabled=!1,t.textContent=(T.get("update_password")||"Update password").toUpperCase())}catch(c){console.error("[ResethashRoute] Reset password error:",c),ie(r,c.message||T.get("error_network")),t.disabled=!1,t.textContent=(T.get("update_password")||"Update password").toUpperCase()}})}function ln(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}const gi=Object.freeze(Object.defineProperty({__proto__:null,init:mi,render:ui},Symbol.toStringTag,{value:"Module"})),ne=()=>x.getManagedClients().length>0&&!x.getStoredActiveOrg(),Pe=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),hi={reseller_org:"Your org",managed_client:"Client",saas_org:"Org"};let cn=!1;function rt(){if(cn)return;const e=document.createElement("style");e.id="m5t-portfolio-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),cn=!0}const dn=e=>e.toISOString().slice(0,10);async function fi(e,{days:t=30}={}){const a=new Date,n=dn(new Date(a.getTime()-(t-1)*864e5)),o=dn(a),s=await fetch(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${o}&group_by=owner`);if(!s.ok)throw new Error(`HTTP ${s.status}`);const r=await s.json();if(!r.ok)throw new Error("stats not ok");return r.by_owner||[]}function _o(e,t){return`<div class="dash-clients-scroll"><table class="dash-clients">
    <thead><tr>
      <th>Client</th>${t.map(a=>`<th>${a.h}</th>`).join("")}<th></th>
    </tr></thead>
    <tbody>${e.map(a=>`
      <tr data-org="${Pe(a.owner_guid)}" tabindex="0" role="button"
          aria-label="Open ${Pe(a.name||"client")}">
        <td><span class="dc-name">${Pe(a.name||a.owner_guid)}
          <span class="dc-chip">${Pe(hi[a.channel]||a.channel||"")}</span></span></td>
        ${t.map(n=>`<td>${n.td(a)}</td>`).join("")}
        <td><span class="dc-view">View →</span></td>
      </tr>`).join("")}</tbody>
  </table></div>`}function vi(e){let t=e.querySelector(".pf-access-error");t||(t=document.createElement("div"),t.className="pf-access-error",e.prepend(t)),t.textContent="You don't have direct access to manage this org. Use the admin console to act on its behalf."}function bo(e){if(!e)return;const t=async a=>{const n=a?.dataset?.org;if(!n)return;(await x.setActiveOrg(n))?.activeOrgError&&vi(e)};e.querySelectorAll("tbody tr[data-org]").forEach(a=>{a.addEventListener("click",()=>t(a)),a.addEventListener("keydown",n=>{(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),t(a))})})}const ga=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function bt({section:e,title:t,description:a}){return rt(),`
    <div class="page-shell" data-section="${Pe(e)}">
      <div class="page-header">
        <div class="page-header-text">
          <h1 class="page-title">${Pe(t)}</h1>
          <p class="page-description">${Pe(a)}</p>
        </div>
      </div>
    ...
    </div>`}async function it(e,t,{emptyMsg:a}={}){const n=document.getElementById("pf-picker-body");if(n)try{const o=await fi(e);if(!o.length){n.innerHTML=ga("groups",a||"No client orgs yet. Create one under Clients first.");return}n.innerHTML=_o(o,t),bo(n)}catch(o){console.warn("[portfolio] picker load failed:",o),n.innerHTML=ga("error","Could not load your clients. Please refresh.")}}function yo(){const e={};return x.getManagedClients().forEach(t=>{e[t.orgGuid]=t.name}),x.getMemberships().forEach(t=>{t.orgGuid&&!e[t.orgGuid]&&(e[t.orgGuid]=t.name||"")}),e}const wo=e=>e?`<span class="pf-client-chip">${Pe(e)}</span>`:"",ge=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,he=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),j=e=>Number(e||0).toLocaleString(),xo=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",_i=e=>(xo(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function bi(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric"})}catch{return""}}function yi(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}let pn=!1;function wi(){if(pn)return;const e=document.createElement("style");e.id="m5t-dash-recent-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),pn=!0}function xi(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${he(_i(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${he(xo(e))}</span>
      <span class="recent-lead__sub">${he(e.email||e.phone||"")}</span>
    </span>
    <span class="recent-lead__badge" data-s="${he(e.status)}">${he(e.status)}</span>
    <span class="recent-lead__time">${he(bi(e))}</span>
  </a>`}const gt=({icon:e,label:t,valueId:a,value:n="—",subId:o,sub:s="",href:r})=>{const i=r?"a":"div",l=r?` href="${he(r)}" class="stat-card stat-card--link"`:' class="stat-card"';return`
  <${i}${l}>
  ...
  </${i}>`},St=(e,t,a,{wide:n=!1,full:o=!1,controls:s=!1}={})=>`
  <div class="dashboard-card${n?" chart-card-wide":""}${o?" chart-card-full":""}">
    ...
    <div class="card-body" id="${a}">${ge("hourglass_empty","Loading…")}</div>
  </div>`;let ha=30;function Eo(){wi(),rt();const e=ne();return`
    <div class="page-shell" data-section="home">
      ...
      <div class="dashboard-card" style="margin-bottom:24px">
        ...
        <div class="card-body" id="dash-portfolio">${ge("hourglass_empty","Loading…")}</div>
      </div>`:""}
      ...
      <div class="stats-grid">
        ...
        ${gt({icon:"person_add",label:"Leads Captured",valueId:"stat-leads",subId:"stat-leads-sub",sub:"Loading…"})}
        ${gt({icon:"check_circle",label:"Completion Rate",valueId:"stat-completion",subId:"stat-completion-sub",sub:"Loading…"})}
      </div>

      <div class="charts-section">
        ${St("show_chart","Opens & Leads","dash-trend",{wide:!0,controls:!0})}
        <div class="charts-grid">
          ${St("filter_alt","Completion Funnel","dash-funnel")}
          ${St("source","Top Campaigns","dash-campaigns")}
          ${St("touch_app","CTA Usage","dash-routes",{full:!0})}
        </div>
      </div>
      ...
      <div class="content-grid">
        ...
        <div class="dashboard-card">
          ...
          <div class="card-body" id="recent-leads-body">
            ${ge("hourglass_empty","Loading leads…")}
          </div>
        </div>
      </div>
    </div>`}async function So(){const e=x.getConfig?.().BASE_URL||"";document.getElementById("dash-periods")?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(ha=Number(a.dataset.days)||30,document.querySelectorAll("#dash-periods .chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===ha)),mn(e))}),await Promise.all([mn(e),Ai(e)])}const Ee=(e,t)=>{const a=document.getElementById(e);a&&(a.textContent=t)},Qe=(e,t)=>{const a=document.getElementById(e);a&&(a.innerHTML=t)},un=e=>e.toISOString().slice(0,10);async function mn(e){const t=new Date,a=un(new Date(t.getTime()-(ha-1)*864e5)),n=un(t),o=ne();let s;try{const k=await fetch(`${e}/m5t/v5/dashboard/stats?from=${a}&to=${n}${o?"&group_by=owner":""}`);if(!k.ok)throw new Error(`HTTP ${k.status}`);if(s=await k.json(),!s.ok)throw new Error("stats not ok")}catch(v){console.warn("[dashboard] stats fetch failed:",v),["stat-active-magnets","stat-opens","stat-leads","stat-completion"].forEach(k=>Ee(k,"—")),["stat-active-magnets-sub","stat-opens-sub","stat-leads-sub","stat-completion-sub"].forEach(k=>Ee(k,"Unavailable")),["dash-trend","dash-funnel","dash-campaigns","dash-routes","dash-interactions","dash-portfolio"].forEach(k=>Qe(k,ge("error","Could not load. Please refresh.")));return}o&&Ei(s.by_owner||[]),Ee("stat-active-magnets",j(s.magnets.active)),Ee("stat-active-magnets-sub",s.magnets.total>s.magnets.active?`${j(s.magnets.total-s.magnets.active)} paused`:s.magnets.active?"All running":"No magnets yet");const r=s.funnel||{};Ee("stat-opens",r.opens?j(r.opens):"—"),Ee("stat-opens-sub",r.opens?r.engagement_rate!=null?`${r.engagement_rate}% engage`:`${j(r.engaged)} engaged`:"No opens in this range yet");const i=s.leads||{};Ee("stat-leads",j(i.total));const l=(i.this_week||0)-(i.prev_week||0);Ee("stat-leads-sub",i.total?`${j(i.this_week)} this week (${l>=0?"+":""}${j(l)} vs last)`:"No leads yet"),Ee("stat-completion",r.completion_rate!=null?`${r.completion_rate}%`:"—"),Ee("stat-completion-sub",r.opens?`${j(r.completions)} completed of ${j(r.opens)} opens`:"Appears once magnets get opened");const c=s.by_day||[],g=c.some(v=>v.opens||v.leads);Qe("dash-trend",g?Ao(c):ge("show_chart","No activity in this range yet. Opens and leads chart here as visitors engage your magnets.")),g&&ko(c),Qe("dash-funnel",r.opens?Si(r):ge("filter_alt","The funnel fills in once your magnets record opens."));const b=s.top_campaigns||[];Qe("dash-campaigns",b.length?`<div class="dash-list">${b.map(v=>`
        <div class="dash-list__row">
          ...
          <span class="dash-list__num">${j(v.leads)}</span>
        </div>`).join("")}</div>`:ge("source","No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here."));const y={book:["event","Book"],chat:["chat","Chat"],call:["phone_in_talk","Call"],email:["mail","Email"],support:["support_agent","Support"]},_=Object.entries(r.routes||{}).sort((v,k)=>k[1]-v[1]),w=_.length?_[0][1]:0;Qe("dash-routes",_.length?`<div class="dash-funnel">${_.map(([v,k])=>{const[N,U]=y[v]||["touch_app",v];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${N}</span> ${he(U)}</span><span class="dash-funnel__val">${j(k)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${w?Math.max(4,Math.round(k/w*100)):0}%"></div></div>
        </div>`}).join("")}</div>`:ge("touch_app","CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar."));const d={open:["visibility","Magnet opened"],engage:["touch_app","Visitor engaged"],route:["alt_route","Picked a channel"],complete:["check_circle","Completed: lead captured"]},h=s.recent_events||[];Qe("dash-interactions",h.length?`<div class="dash-list">${h.map(v=>{const[k,N]=d[v.event]||["sensors",v.event],U=v.event==="route"&&v.detail?` · ${he(v.detail)}`:"";return`<div class="dash-list__row">
    ...
    </div>`).join("")}</div>`}async function Ai(e){const t=document.getElementById("recent-leads-body");if(t)try{const a=await fetch(`${e}/m5t/v5/m5mLead`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json(),o=(Array.isArray(n?.data)?n.data:[]).filter(s=>!["DELETED","ARCHIVED"].includes(s.status));t.innerHTML=o.length?o.slice(0,5).map(xi).join(""):ge("contacts","No leads captured yet. Publish a magnet to start collecting.")}catch(a){console.warn("[dashboard] Leads fetch failed:",a),t.innerHTML=ge("error","Could not load recent leads.")}}function gn(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}const hn=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e));function Ao(e){const _=e.length||1,w=gn(Math.max(1,...e.map(I=>I.opens||0))),d=gn(Math.max(1,...e.map(I=>I.leads||0))),h=748/_,v=Math.min(22,h*.55),k=I=>46+h*(I+.5),N=I=>266-I/w*248,U=I=>266-I/d*248,ae=[0,.5,1].map(I=>{const V=266-I*248;return`<line x1="46" y1="${V.toFixed(1)}" x2="794" y2="${V.toFixed(1)}" stroke="#EAF0F7"/><text x="38" y="${(V+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${hn(w*I)}</text><text x="802" y="${(V+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${hn(d*I)}</text>`}).join(""),Y=e.map((I,V)=>{const Ie=N(I.opens||0);return`<rect x="${(k(V)-v/2).toFixed(1)}" y="${Ie.toFixed(1)}" width="${v.toFixed(1)}" height="${Math.max(0,266-Ie).toFixed(1)}" rx="3" fill="#0072BA" opacity="0.85"/>`}).join(""),le=e.map((I,V)=>`${k(V).toFixed(1)},${U(I.leads||0).toFixed(1)}`).join(" "),we=_>1?`<polyline points="${le}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",ce=e.map((I,V)=>`<circle cx="${k(V).toFixed(1)}" cy="${U(I.leads||0).toFixed(1)}" r="3.2" fill="#009473"/>`).join(""),Re=Math.max(1,Math.ceil(_/6)),Te=e.map((I,V)=>V%Re===0||V===_-1?`<text x="${k(V).toFixed(1)}" y="288" text-anchor="middle" class="dash-ax">${I.date.slice(5)}</text>`:"").join(""),O=e.map((I,V)=>`<rect class="dash-hit" data-i="${V}" x="${(46+h*V).toFixed(1)}" y="18" width="${h.toFixed(1)}" height="${248 .toFixed(1)}" fill="transparent"/>`).join("");return`
    ...
    <div class="dash-chart-wrap">
      ...
      <div class="dash-chart-tip__row"><i style="background:#009473"></i>${j(i.leads||0)} leads</div>`;const l=r.getBoundingClientRect(),c=t.getBoundingClientRect();a.style.left=`${l.left-c.left+l.width/2}px`,a.style.top=`${l.top-c.top}px`,a.hidden=!1};t.querySelectorAll(".dash-hit").forEach(s=>{const r=Number(s.dataset.i);s.addEventListener("mouseenter",()=>o(r,s)),s.addEventListener("mousemove",()=>o(r,s)),s.addEventListener("mouseleave",()=>{a.hidden=!0}),s.addEventListener("click",()=>o(r,s))})}const ki={render:Eo,init:So},Ci=Object.freeze(Object.defineProperty({__proto__:null,default:ki,init:So,render:Eo,statCard:gt,svgTrendChart:Ao,wireTrendTooltip:ko},Symbol.toStringTag,{value:"Module"}));function Ti(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/home" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function Ii(){console.log("[SignoutRoute] Initialized");const e=document.getElementById("confirm-signout-btn");e?.addEventListener("click",async()=>{e.disabled=!0,e.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await x.doSignout()})}const $i=Object.freeze(Object.defineProperty({__proto__:null,init:Ii,render:Ti},Symbol.toStringTag,{value:"Module"}));let fn=!1;function Li(){if(fn)return;const e=document.createElement("style");e.id="m5t-section-page-styles",e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),fn=!0}function Co({title:e="Section",icon:t="widgets",name:a=""}={}){return Li(),`
    ...
    </section>`}function To(){}const Ni={render:Co,init:To},Oi=Object.freeze(Object.defineProperty({__proto__:null,default:Ni,init:To,render:Co},Symbol.toStringTag,{value:"Module"})),Ri={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},xe=e=>String(e??"").replace(/[&<>"']/g,t=>Ri[t]),fe=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},We=()=>x.getConfig?.().BASE_URL||"",Mi=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,Dt=5,pe={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},fa=()=>x.getActiveOrg()?.guid||x.getMemberships()[0]?.orgGuid||null;let vn=!1;function Fi(){if(vn)return;const e=document.createElement("style");e.id="m5t-notif-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),vn=!0}const Ra=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Io(){return Fi(),rt(),ne()?bt({section:"settings-notifications",title:"Notifications",description:"Pick a client to manage their lead alerts."}):`
    <div class="page-shell" data-section="settings-notifications">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="ntf-body">${Ra("hourglass_empty","Loading…")}</div>
      </div>
    ...
    </div>`}async function $o(){if(ne()){const e=t=>Number(t||0).toLocaleString();return it(We(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Promise.all([Pi(),Lo()])}async function Lo(){const e=fa();if(e)try{const t=await fetch(`${We()}/m5t/v5/acctGroup/${encodeURIComponent(e)}/webhook`);if(t.status===403){pe.webhookAllowed=!1;return}const a=await t.json().catch(()=>({}));if(!a.ok)return;pe.webhook=a.webhook,No()}catch{}}function _n(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function No(){const e=document.getElementById("ntf-wh-card"),t=document.getElementById("ntf-wh-body");if(!e||!t)return;e.style.display="";const a=pe.webhook,n=a?.last_delivery;t.innerHTML=`
    <div class="ntf-wh">
      ...
      <input class="ntf-input" id="ntf-wh-url" type="url" placeholder="https://hooks.zapier.com/hooks/catch/…" value="${xe(a?.uri||"")}" />
      ...
      <div class="ntf-wh__row">
        ...
        <span class="ntf-wh__status">${n?n.ok?`Last delivery: <span class="ok">delivered</span> ${xe(_n(n.tz))}`:`Last delivery: <span class="bad">failed</span> ${xe(_n(n.tz))} (${xe(n.error||"")})`:""}</span>
      </div>
    </div>`,t.querySelector("#ntf-wh-save")?.addEventListener("click",async()=>{const o=t.querySelector("#ntf-wh-url")?.value.trim()||"",s=t.querySelector("#ntf-wh-secret")?.value??"",r={uri:o};s.trim()!==""&&(r.secret=s.trim());try{const i=await fetch(`${We()}/m5t/v5/acctGroup/${encodeURIComponent(fa())}/webhook`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),l=await i.json().catch(()=>({}));if(!i.ok||!l.ok)throw new Error(l.error||`Failed (HTTP ${i.status})`);pe.webhook=l.webhook,fe(o?"Webhook saved":"Webhook removed","success"),No()}catch(i){fe(i.message||"Could not save","danger")}}),t.querySelector("#ntf-wh-test")?.addEventListener("click",async o=>{const s=o.currentTarget;s.disabled=!0;try{const r=await fetch(`${We()}/m5t/v5/acctGroup/${encodeURIComponent(fa())}/webhook-test`,{method:"POST"}),i=await r.json().catch(()=>({}));r.ok&&i.ok?fe("Test delivery sent","success"):fe(i.error||"Could not deliver the test","danger")}catch{fe("Could not deliver the test","danger")}finally{s.disabled=!1}try{await Lo()}catch(r){console.warn("[notifications] loadWebhook refresh failed:",r)}})}async function Pi(){const e=document.getElementById("ntf-body");if(e){try{const a=await(await fetch(`${We()}/m5t/v5/magnets`)).json().catch(()=>({}));if(!a.ok)throw new Error(a.message||"Failed to load");pe.magnets=(a.magnets||[]).filter(n=>n.status!=="ARCHIVED"),pe.canManage=!!a.canManage}catch(t){console.warn("[notifications] load failed:",t),e.innerHTML=Ra("error","Could not load your magnets. Please try again.");return}Oo()}}function Di(e){const t=Array.isArray(e.notify_emails)?e.notify_emails:[],a=t.length>0;return`
    <div class="ntf-row" data-guid="${xe(e.guid)}">
      <div class="ntf-magnet">
        <div class="ntf-name" title="${xe(e.name)}">${xe(e.name)}</div>
        <div class="ntf-meta">${xe((e.domains||[]).join(", ")||e.status)}</div>
      ...
      <div class="ntf-config">
        ${t.length?`<div class="ntf-chips">${t.map(n=>`
              <span class="ntf-chip">${xe(n)}${pe.canManage?`<button type="button" data-remove="${xe(n)}" aria-label="Remove ${xe(n)}">&times;</button>`:""}</span>`).join("")}</div>`:'<div class="ntf-none">No alert emails.</div>'}
        ${pe.canManage?`
        <div class="ntf-addrow">
          <input class="ntf-input" type="email" placeholder="name@business.com" aria-label="Add alert email" ${t.length>=Dt?"disabled":""} />
          <button class="ntf-btn" type="button" data-add ${t.length>=Dt?"disabled":""}>
    ...
    </div>`}function Oo(){const e=document.getElementById("ntf-body");if(e){if(!pe.magnets.length){e.innerHTML=Ra("widgets","No magnets yet. Create one under Your Magnets first.");return}e.innerHTML=pe.magnets.map(Di).join(""),e.querySelectorAll(".ntf-row").forEach(t=>{const a=t.dataset.guid,n=t.querySelector(".ntf-input"),o=()=>{const s=(n?.value||"").trim().toLowerCase();if(!s)return;if(!Mi.test(s)){fe("That does not look like an email address","danger");return}const i=[...pe.magnets.find(l=>l.guid===a).notify_emails||[]];if(i.includes(s)){fe("Already added","info");return}if(i.length>=Dt){fe(`Up to ${Dt} emails per magnet`,"info");return}bn(a,[...i,s])};t.querySelector("[data-add]")?.addEventListener("click",o),n?.addEventListener("keydown",s=>{s.key==="Enter"&&o()}),t.querySelectorAll("[data-remove]").forEach(s=>s.addEventListener("click",()=>{const r=pe.magnets.find(i=>i.guid===a);bn(a,(r.notify_emails||[]).filter(i=>i!==s.dataset.remove))})),t.querySelector("[data-test]")?.addEventListener("click",()=>Bi(a,t.querySelector("[data-test]")))})}}async function bn(e,t){try{const a=await fetch(`${We()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({notify_emails:t})}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||n.message||`Failed (HTTP ${a.status})`);const o=pe.magnets.find(s=>s.guid===e);o&&(o.notify_emails=t),fe("Alert emails updated","success")}catch(a){console.warn("[notifications] save failed:",a),fe(a.message||"Could not save","danger");return}try{Oo()}catch(a){console.error("[notifications] renderBody after save failed:",a)}}async function Bi(e,t){t&&(t.disabled=!0);try{const a=await fetch(`${We()}/m5t/v5/magnets/${encodeURIComponent(e)}/notify-test`,{method:"POST"}),n=await a.json().catch(()=>({}));a.ok&&n.ok?fe("Test alert sent","success"):fe(n.error||"Could not send the test","danger")}catch{fe("Could not send the test","danger")}finally{t&&(t.disabled=!1)}}const Ui={render:Io,init:$o},Hi=Object.freeze(Object.defineProperty({__proto__:null,default:Ui,init:$o,render:Io},Symbol.toStringTag,{value:"Module"})),zi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ue=e=>String(e??"").replace(/[&<>"']/g,t=>zi[t]),te=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},me=()=>x.getConfig?.().BASE_URL||"",F={providers:null,configured:null,denied:!1,busy:!1,autoOpenPicker:!1},Ma=()=>x.getActiveOrg()?.guid||x.getMemberships()[0]?.orgGuid||null;let yn=!1;function Gi(){if(yn)return;const e=document.createElement("style");e.id="m5t-intg-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),yn=!0}const va=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,nt=(e,t="")=>`<div class="intg-alert ${t}"><span class="material-symbols-outlined" aria-hidden="true">${t==="error"?"error":"info"}</span><span>${e}</span></div>`;function qi(){return Gi(),rt(),ne()?bt({section:"settings-integrations",title:"Integrations",description:"Pick a client to manage their connections."}):`
    <div class="page-shell" data-section="settings-integrations">
      ...
      <div id="intg-body">
        <div class="dashboard-card intg-card"><div class="card-body">${va("hourglass_empty","Loading…")}</div></div>
      </div>
    </div>`}async function Vi(){if(ne()){const e=t=>Number(t||0).toLocaleString();return it(me(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}ji(),await Be()}function ji(){try{const e=new URLSearchParams(window.location.search),t=e.get("provider")==="calendly"?"Calendly":"Google Ads";if(e.get("connected")==="google_ads")te("Google Ads connected.","success"),F.autoOpenPicker=!0;else if(e.get("connected")==="calendly")te("Calendly connected.","success");else if(e.get("error"))te(`${t} connection failed (${e.get("error")}).`,"error");else return;window.history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}}async function Be(){const e=document.getElementById("intg-body");try{const t=await fetch(`${me()}/m5t/v5/integrations`);if(t.status===403){F.denied=!0,e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${va("lock","Integrations are managed by workspace admins.")}</div></div>`);return}const a=await t.json();if(!a.ok)throw new Error(a.error||"load failed");F.providers=a.data.providers,F.configured=a.data.configured,Ki()}catch{e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${va("error","Could not load integrations.")}</div></div>`)}}function Wi(){const e=Ma(),t=F.providers?.google_ads||[],a=t.find(i=>i.owner_guid===e)||t[0]||null,n=!!F.configured?.google_ads;let o='<span class="intg-state">Not connected</span>',s="Connect a Google account with access to your ad accounts. Spend lines up against your magnet leads in Ad performance.",r="";if(!n)o='<span class="intg-state">Not available yet</span>',s="Google Ads reporting is being set up for this platform.";else if(!a)r='<button type="button" class="intg-btn primary" id="intg-g-connect"><span class="material-symbols-outlined" aria-hidden="true">link</span>Connect</button>';else{const i=a.external_account?.customer_ids?.length||0;a.connect_status==="ACTIVE"?(o='<span class="intg-state on"><span class="material-symbols-outlined" aria-hidden="true">check</span>Connected</span>',s=i?`This connection can reach <b>${i}</b> ad account${i===1?"":"s"}. Choose which ones feed reporting; metrics refresh daily in Ad performance.`:"Connected, but no ad accounts are reachable from this Google account. Reconnect with an account that has Google Ads access.",r=`
        ...
        <button type="button" class="intg-btn danger" id="intg-g-disconnect"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`):(o=`<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>${ue(a.connect_status==="NEEDS_REAUTH"?"Reconnect needed":"Connection error")}</span>`,s="The connection stopped working. Reconnect to resume daily metric refreshes.",r=`
    ...
    </div>`}function Yi(){const e=Ma(),t=F.providers?.calendly||[],a=t.find(l=>l.owner_guid===e)||t[0]||null,n=!!F.configured?.calendly;let o='<span class="intg-state">Not connected</span>',s="Connect Calendly and your magnets book real meetings: the Book button opens your calendar in the conversation, and confirmed bookings land on the lead automatically.",r="",i="";if(!n)o='<span class="intg-state">Not available yet</span>',s="Calendly booking is being set up for this platform.";else if(!a)r='<button type="button" class="intg-btn primary" id="intg-c-connect"><span class="material-symbols-outlined" aria-hidden="true">link</span>Connect</button>';else{const l=a.external_account||{};if(a.connect_status==="ACTIVE"){o='<span class="intg-state on"><span class="material-symbols-outlined" aria-hidden="true">check</span>Connected</span>',s=`Connected as <b>${[l.name,l.email&&`(${l.email})`].filter(Boolean).map(ue).join(" ")||"your Calendly account"}</b>. Turn on Calendly booking per magnet under Magnets, in the Book call-to-action.`,r=`
        <button type="button" class="intg-btn danger" id="intg-c-disconnect"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`;const b=a.webhook||{};if(b.state==="active"){const y=b.last_received_tz?` Last booking received ${ue(String(b.last_received_tz).slice(0,10))}.`:"";i=nt(`Booking sync is on. Confirmed and canceled meetings update the lead automatically.${y}`)}else i=nt("Booking sync is off: webhooks need a paid Calendly plan. Visitors can still book in the magnet; bookings just will not appear on the lead automatically. Reconnect after upgrading to turn it on.","error")}else o=`<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>${ue(a.connect_status==="NEEDS_REAUTH"?"Reconnect needed":"Connection error")}</span>`,s="The connection stopped working. Reconnect to resume booking sync.",r=`
    ...
    <div class="dashboard-card intg-card">
      <div class="card-body">
        ...
        <button type="button" class="intg-btn danger" id="intg-r-disconnect"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`;const g=a.webhook||{};if(g.state==="active"){const b=g.last_received_tz?` Last call received ${ue(String(g.last_received_tz).slice(0,10))}.`:"";r=nt(`Call sync is on. New calls appear within minutes; a daily sweep catches anything missed.${b}`)}else r=nt("Automatic call sync could not be set up in CallRail. Calls still arrive via the daily sweep and Sync now. Reconnect to retry the setup.","error")}else n='<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>Connection error</span>',o="The connection stopped working. Reconnect with a current CallRail API key.",s=`
    ...
    </div>`}function Ki(){const e=document.getElementById("intg-body");e&&(e.innerHTML=Wi()+Yi()+Ji(),document.getElementById("intg-g-connect")?.addEventListener("click",Zi),document.getElementById("intg-g-sync")?.addEventListener("click",el),document.getElementById("intg-g-disconnect")?.addEventListener("click",tl),document.getElementById("intg-g-accounts")?.addEventListener("click",wn),document.getElementById("intg-c-connect")?.addEventListener("click",al),document.getElementById("intg-c-disconnect")?.addEventListener("click",nl),document.getElementById("intg-r-connect")?.addEventListener("click",ol),document.getElementById("intg-r-sync")?.addEventListener("click",il),document.getElementById("intg-r-disconnect")?.addEventListener("click",ll),F.autoOpenPicker&&(F.autoOpenPicker=!1,document.getElementById("intg-g-accounts")&&wn()))}async function wn(){const e=document.getElementById("intg-g-picker");if(e){e.style.display="",e.innerHTML=nt("Loading your ad accounts…");try{const a=await(await fetch(`${me()}/m5t/v5/integrations/google_ads/accounts`)).json();if(!a.ok)throw new Error(a.error||"load failed");Xi(a.data.accounts||[],new Set(a.data.linked||[]))}catch{e.innerHTML=nt("Could not load your ad accounts. Try again, or reconnect if this keeps happening.","error")}}}function Xi(e,t){const a=document.getElementById("intg-g-picker");if(!a)return;const n=e.map(o=>{const s=o.manager||o.error,r=o.manager?"Manager":o.error?"Unavailable":o.currency||"",i=t.has(o.id)&&!s;return`
      <label class="intg-acct${s?" disabled":""}">
        <input type="checkbox" data-intg-acct="${ue(o.id)}" ${i?"checked":""} ${s?"disabled":""}>
        <span style="min-width:0">
          <span class="intg-acct__name">${ue(o.name||"Account "+o.id)}</span>
          <div class="intg-acct__id">${ue(o.id)}</div>
        </span>
        ${r?`<span class="intg-acct__badge">${ue(r)}</span>`:"<span></span>"}
    ...
    </div>`,document.getElementById("intg-picker-cancel")?.addEventListener("click",()=>{a.style.display="none"}),document.getElementById("intg-picker-save")?.addEventListener("click",Qi)}async function Qi(){const e=document.getElementById("intg-g-picker"),t=[...e?.querySelectorAll("input[data-intg-acct]:checked")||[]].map(n=>n.dataset.intgAcct),a=document.getElementById("intg-picker-save");a&&(a.disabled=!0);try{const o=await(await fetch(`${me()}/m5t/v5/integrations/google_ads/accounts`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({customer_ids:t})})).json();if(!o.ok)throw new Error(o.error||"save failed");te(`${o.data.linked} account${o.data.linked===1?"":"s"} linked. First sync is running.`,"success"),e&&(e.style.display="none"),Be()}catch{te("Could not save account selection.","error"),a&&(a.disabled=!1)}}async function Zi(){if(!F.busy){F.busy=!0;try{const t=await(await fetch(`${me()}/m5t/v5/integrations/google_ads/connect`)).json();if(!t.ok||!t.data?.url)throw new Error(t.error||"connect failed");window.location.href=t.data.url}catch{te("Could not start the Google connection.","error"),F.busy=!1}}}async function el(){if(F.busy)return;F.busy=!0;const e=document.getElementById("intg-g-sync");e&&(e.disabled=!0);try{const a=await(await fetch(`${me()}/m5t/v5/integrations/google_ads/sync`,{method:"POST"})).json();if(!a.ok)throw new Error(a.error||"sync failed");const o=(a.data?.connections?.[0]?.accounts||[]).filter(s=>s.error).length;te(o?`Sync finished with ${o} account error${o===1?"":"s"}.`:"Metrics synced.",o?"warning":"success")}catch{te("Sync failed.","error")}finally{F.busy=!1,e&&(e.disabled=!1),Be()}}async function tl(){if(!F.busy&&window.confirm("Disconnect Google Ads? Daily metric refreshes stop until reconnected.")){F.busy=!0;try{const t=await(await fetch(`${me()}/m5t/v5/integrations/google_ads`,{method:"DELETE"})).json().catch(()=>({}));if(!t.ok)throw new Error(t.error||"disconnect failed");te("Google Ads disconnected.","success")}catch{te("Disconnect failed.","error")}finally{F.busy=!1,Be()}}}async function al(){if(!F.busy){F.busy=!0;try{const t=await(await fetch(`${me()}/m5t/v5/integrations/calendly/connect`)).json();if(!t.ok||!t.data?.url)throw new Error(t.error||"connect failed");window.location.href=t.data.url}catch{te("Could not start the Calendly connection.","error"),F.busy=!1}}}async function nl(){if(!F.busy&&window.confirm("Disconnect Calendly? Magnet booking falls back to the built-in scheduler and booking sync stops.")){F.busy=!0;try{const t=await(await fetch(`${me()}/m5t/v5/integrations/calendly`,{method:"DELETE"})).json().catch(()=>({}));if(!t.ok)throw new Error(t.error||"disconnect failed");te("Calendly disconnected.","success")}catch{te("Disconnect failed.","error")}finally{F.busy=!1,Be()}}}function ol(){const e=document.getElementById("intg-r-setup");e&&(e.style.display="",e.innerHTML=`
    <div class="intg-picker">
    ...
    </div>`,document.getElementById("intg-r-cancel")?.addEventListener("click",()=>{e.style.display="none"}),document.getElementById("intg-r-continue")?.addEventListener("click",sl),document.getElementById("intg-r-key")?.focus())}const Fe=e=>{const t=document.getElementById("intg-r-status");t&&(t.textContent=e)};async function sl(){const e=document.getElementById("intg-r-continue"),t=document.getElementById("intg-r-key")?.value.trim()||"",a=document.getElementById("intg-r-pickers");if(!t){Fe("Paste an API key first.");return}if(a&&!a.hidden)return rl(t);e&&(e.disabled=!0),Fe("Checking the key with CallRail…");try{const o=await(await fetch(`${me()}/m5t/v5/integrations/callrail/validate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:t})})).json();if(!o.ok){Fe(o.error||"CallRail rejected that key.");return}const s=o.data.accounts||[],r=document.getElementById("intg-r-account");r&&(r.innerHTML=s.map(i=>`<option value="${ue(i.id)}">${ue(i.name)}</option>`).join(""),r.onchange=()=>xn(t,r.value)),a&&(a.hidden=!1),e&&(e.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">save</span>Save'),Fe(""),await xn(t,s[0]?.id)}catch{Fe("Could not reach CallRail. Try again.")}finally{e&&(e.disabled=!1)}}async function xn(e,t){const a=document.getElementById("intg-r-company");if(!(!a||!t)){a.innerHTML='<option value="">Loading companies…</option>';try{const o=await(await fetch(`${me()}/m5t/v5/integrations/callrail/companies`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:t})})).json(),s=o.ok?o.data.companies||[]:[];a.innerHTML=s.length?s.map(r=>`<option value="${ue(r.id)}">${ue(r.name)}</option>`).join(""):'<option value="">No active companies in this account</option>'}catch{a.innerHTML='<option value="">Could not load companies</option>'}}}async function rl(e){const t=document.getElementById("intg-r-continue"),a=document.getElementById("intg-r-account")?.value||"",n=document.getElementById("intg-r-company")?.value||"";if(!n){Fe("Pick the company this workspace tracks.");return}t&&(t.disabled=!0),Fe("Connecting…");try{const s=await(await fetch(`${me()}/m5t/v5/integrations/callrail`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:a,company_id:n})})).json();if(!s.ok)throw new Error(s.error||"connect failed");te(s.data?.webhook_state==="active"?"CallRail connected. Call sync is on.":"CallRail connected. Call sync setup needs attention; see the card.","success"),Be()}catch{Fe("Could not connect. Check the key and try again."),t&&(t.disabled=!1)}}async function il(){if(F.busy)return;F.busy=!0;const e=document.getElementById("intg-r-sync");e&&(e.disabled=!0);try{const a=await(await fetch(`${me()}/m5t/v5/integrations/callrail/sync?days=7`,{method:"POST"})).json();if(!a.ok)throw new Error(a.error||"sync failed");const n=a.data?.connections?.[0]||{};te(n.error?"Sync finished with errors.":`Sync done. ${n.processed||0} new call${(n.processed||0)===1?"":"s"} recorded.`,n.error?"warning":"success")}catch{te("Sync failed.","error")}finally{F.busy=!1,e&&(e.disabled=!1),Be()}}async function ll(){if(!F.busy&&window.confirm("Disconnect CallRail? Calls stop landing in your Leads inbox.")){F.busy=!0;try{const t=await(await fetch(`${me()}/m5t/v5/integrations/callrail`,{method:"DELETE"})).json().catch(()=>({}));if(!t.ok)throw new Error(t.error||"disconnect failed");te("CallRail disconnected.","success")}catch{te("Disconnect failed.","error")}finally{F.busy=!1,Be()}}}const cl=Object.freeze(Object.defineProperty({__proto__:null,init:Vi,render:qi},Symbol.toStringTag,{value:"Module"})),dl={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Z=e=>String(e??"").replace(/[&<>"']/g,t=>dl[t]),_a=()=>x.getConfig?.().BASE_URL||"",ia=e=>Number(e||0).toLocaleString(),G={conversations:[],counts:{},magnetNames:{},filter:"ALL",book:!1,magnetOwnerNames:{}},En={COMPLETED:{label:"Completed",icon:"check_circle"},IN_PROGRESS:{label:"In progress",icon:"pending"},ABANDONED:{label:"Abandoned",icon:"highlight_off"}},ba={book:"Book",chat:"Chat",call:"Call",email:"Email",support:"Support"};function Ro(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email)||null}function Mo(e){return(e.split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase()}function Fo(e){try{return new Date(e).toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return""}}function pl(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function Po(e){return e==null?"—":e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,"0")}s`}let Sn=!1;function ul(){if(Sn)return;const e=document.createElement("style");e.id="m5t-convs-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Sn=!0}const Xt=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Do(){return ul(),rt(),`
    <div class="page-shell" data-section="conversations">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="convs-body">
          ${Xt("hourglass_empty","Loading journeys…")}
        </div>
      </div>
    </div>`}async function Bo(){await ml()}async function ml(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${_a()}/m5t/v5/conversations`),fetch(`${_a()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(G.conversations=n.conversations||[],G.counts=n.counts||{},G.book=ne(),a){const o=await a.json().catch(()=>({}));G.magnetNames={},G.magnetOwnerNames={};const s=G.book?yo():{};(o.magnets||[]).forEach(r=>{G.magnetNames[r.guid]=r.name,G.book&&(G.magnetOwnerNames[r.guid]=r.owner_name||s[r.owner_guid]||"")})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=Xt("error","Could not load journeys. Please try again.");return}Uo()}}function gl(){return G.filter==="ALL"?G.conversations:G.conversations.filter(e=>e.status===G.filter)}function hl(e){const t=Ro(e.lead),a=G.magnetNames[e.magnet_guid]||"—",n=En[e.status]||En.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,s=(e.routes||[]).map(r=>ba[r]||r).join(", ");return`
    <tr class="convs-row" data-session="${Z(e.session)}">
      <td>
        <span class="convs-who">
          <span class="convs-ava${t?"":" anon"}">${t?Z(Mo(t)):'<span class="material-symbols-outlined" style="font-size:16px">person_off</span>'}</span>
          <span><span class="convs-name">${t?Z(t):'<span class="convs-muted">Anonymous visitor</span>'}</span>
            ${e.lead?.email?`<div class="convs-sub">${Z(e.lead.email)}</div>`:s?`<div class="convs-sub">Picked: ${Z(s)}</div>`:""}</span>
        </span>
      </td>
      ${G.book?`<td>${wo(G.magnetOwnerNames[e.magnet_guid]||"")||'<span class="convs-muted">—</span>'}</td>`:""}
      <td><span class="convs-sub">${Z(a)}</span></td>
      <td><span class="convs-badge" data-s="${Z(e.status)}"><span class="material-symbols-outlined" aria-hidden="true">${n.icon}</span>${n.label}</span></td>
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${Z(Fo(e.started_at))}">${Z(pl(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${Z(Po(e.duration_s))}</td>
    </tr>`}function Uo(){const e=document.getElementById("convs-body");if(!e)return;if(!G.conversations.length){e.innerHTML=Xt("route","No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.");return}const t=gl(),a=[["ALL","All"],["COMPLETED","Completed"],["IN_PROGRESS","In progress"],["ABANDONED","Abandoned"]];e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${a.map(([n,o])=>`<button data-filter="${n}" class="${G.filter===n?"active":""}">${o}${n!=="ALL"&&G.counts[n]?` (${ia(G.counts[n])})`:""}</button>`).join("")}
      </div>
      <span class="convs-count">${ia(t.length)} of ${ia(G.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(hl).join("")||`<tr><td colspan="${G.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${G.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(G.filter=o.dataset.filter,Uo())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&vl(o.dataset.session)})}const fl={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${ba[e]||e}`:""}`,route:e=>`Picked ${ba[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function vl(e){const t=G.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${_a()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=Ro(t.lead),o=G.magnetNames[t.magnet_guid]||"—",r=(a?.events||[]).filter((c,g,b)=>c.event!=="step"||!(b[g+1]&&b[g+1].event==="step")).map(c=>`
    <div class="convs-tl__item${c.event==="complete"?" done":""}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${Z((fl[c.event]||(()=>c.event))(c.detail))}</div>
      <div class="convs-tl__time">${Z(Fo(c.at))}${c.variant?` · Variant ${Z(c.variant)}`:""}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      <div class="convs-drawer__head">
        <span class="convs-drawer__title">${n?Z(n):"Anonymous visitor"}</span>
      ...
      <div class="convs-drawer__body">
        ${n?`<a class="convs-drawer__lead" href="#/leads">
              <span class="convs-ava">${Z(Mo(n))}</span>
              <span><div class="convs-name">${Z(n)}</div><div class="convs-sub">${Z(t.lead?.email||t.lead?.phone||"")}</div></span>
        ...
        <div class="convs-sub" style="margin-bottom:6px">${Z(o)} · ${Z(Po(t.duration_s))}${t.variant?` · Variant ${Z(t.variant)}`:""}</div>
        ${r?`<div class="convs-tl">${r}</div>`:Xt("timeline","No timeline available for this journey.")}
      </div>
    </aside>`,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("open"),i.querySelector(".convs-drawer").classList.add("open")});const l=()=>{i.classList.remove("open"),setTimeout(()=>i.remove(),220)};i.querySelector(".convs-drawer__close").addEventListener("click",l),i.addEventListener("click",c=>{c.target===i&&l()})}const _l={render:Do,init:Bo},bl=Object.freeze(Object.defineProperty({__proto__:null,default:_l,init:Bo,render:Do},Symbol.toStringTag,{value:"Module"})),yl={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ve=e=>String(e??"").replace(/[&<>"']/g,t=>yl[t]),An=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},It=()=>x.getConfig?.().BASE_URL||"",ot=e=>Number(e||0).toLocaleString(),De={magnets:[],stats:{},canManage:!1},wl={mag_title:"header title",mag_subtitle:"subtitle",mag_welcome:"welcome message",mag_theme_color:"color",mag_launcher_label:"launcher label"};let kn=!1;function xl(){if(kn)return;const e=document.createElement("style");e.id="m5t-abt-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),kn=!0}const Fa=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Ho(){return ne()?bt({section:"ab-testing",title:"A/B Testing",description:"Pick a client to view their experiments."}):(xl(),`
    <div class="page-shell" data-section="ab-testing">
      ...
      <div id="abt-body">${Fa("hourglass_empty","Loading tests…")}</div>
    </div>`)}async function Pa(){if(ne())return it(It(),[{h:"Running",td:t=>ot(t.ab_tests?.running)},{h:"Completed",td:t=>ot(t.ab_tests?.completed)},{h:"Compl. %",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Experiments appear per client once you have one."});const e=document.getElementById("abt-body");try{const t=new Date,a=new Date(t.getTime()-89*864e5).toISOString().slice(0,10),n=t.toISOString().slice(0,10),[o,s]=await Promise.all([fetch(`${It()}/m5t/v5/magnets`),fetch(`${It()}/m5t/v5/magnets/stats?from=${a}&to=${n}`)]),r=await o.json().catch(()=>({}));if(!r.ok)throw new Error(r.message||"Failed to load");De.magnets=r.magnets||[],De.canManage=!!r.canManage;const i=await s.json().catch(()=>({}));De.stats=i?.stats||{}}catch(t){console.warn("[ab-testing] load failed:",t),e&&(e.innerHTML=Fa("error","Could not load your tests. Please try again."));return}El()}function El(){const e=document.getElementById("abt-body");if(!e)return;const t=De.magnets.filter(n=>n.ab?.enabled),a=De.magnets.filter(n=>!n.ab?.enabled&&n.ab?.declared);if(!t.length&&!a.length){e.innerHTML=Fa("science","No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.");return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(Cl).join("")}`:"")+(a.length?`<div class="abt-sect">Completed Tests</div>${a.map(Tl).join("")}`:""),e.querySelectorAll("[data-declare]").forEach(n=>n.addEventListener("click",()=>Il(n.dataset.declare,n.dataset.winner)))}function Sl(e){const t=De.stats[e.guid]?.variants||{},a={opens:0,engaged:0,completions:0,rate:null,...t.A||{}},n={opens:0,engaged:0,completions:0,rate:null,...t.B||{}};return{A:a,B:n}}function Al(e){const t=Object.keys(e?.b||{}).map(a=>wl[a]||a);return t.length?`Changes: ${t.join(", ")}`:""}function kl(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function Cn(e,t,a,n,o,s){return`
    <div class="abt-variant${o?" leader":""}">
      <div class="abt-vhead"><span class="abt-vname">${Ve(e)}</span><span class="abt-vtag${o?" win":""}">${Ve(t)}</span></div>
      ${a?`<div class="abt-vdesc">${Ve(a)}</div>`:""}
    ...
    </div>`}function Cl(e){const t=e.ab,{A:a,B:n}=Sl(e),o=(n.rate??-1)>(a.rate??-1)?"B":(a.rate??-1)>(n.rate??-1)?"A":null,s=o&&a.rate!=null&&n.rate!=null?`+${Math.round(Math.abs(n.rate-a.rate)*10)/10}%`:"",r=$l(a,n),i=t.started_tz?kl(t.started_tz):null,l=(a.opens||0)+(n.opens||0),c=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
        <h2 class="abt-name">${Ve(e.name)}</h2>
        <span class="abt-status running"><span class="pulse-dot"></span>Running</span>
        <div class="abt-actions">
          ${De.canManage&&o?`<button class="btn btn-primary" type="button" data-declare="${Ve(e.guid)}" data-winner="${o}"><span class="material-symbols-outlined" aria-hidden="true">emoji_events</span>Declare Winner</button>`:""}
        </div>
      </div>
      <div class="abt-meta">
      ...
      <div class="abt-compare">
        ${Cn("Variant A","Control","The magnet as configured",a,o==="A",o==="A"?s:"")}
        <div class="abt-vs">VS</div>
        ${Cn("Variant B",o==="B"?"Leading":"Challenger",Al(t),n,o==="B",o==="B"?s:"")}
      </div>
      <div class="abt-sig">
    ...
    <div class="abt-card">
      ...
      <div class="abt-summary">
        <span><span class="k">Winner:</span><span class="v">Variant ${Ve(t.winner)}</span></span>
    ...
    </div>`}async function Il(e,t){const a=De.magnets.find(n=>n.guid===e);if(a&&window.confirm(`Declare Variant ${t} the winner for “${a.name}”?

${t==="B"?"Variant B’s changes become the magnet’s configuration for everyone.":"The magnet keeps its current configuration."} The experiment ends and moves to Completed.`)){try{const o=await(await fetch(`${It()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Declare failed");An(`Variant ${t} declared the winner`,"success")}catch(n){An(n.message||"Could not declare a winner","danger");return}try{await Pa()}catch(n){console.warn("[ab-testing] refresh after declare failed:",n)}}}function $l(e,t){const a=e.opens||0,n=t.opens||0,o=e.completions||0,s=t.completions||0;if(a<30||n<30||o+s<5)return null;const r=o/a,i=s/n,l=(o+s)/(a+n),c=Math.sqrt(l*(1-l)*(1/a+1/n));if(!c)return null;const g=Math.abs(i-r)/c;return Math.round(2*(Ll(g)-.5)*1e3)/10}function Ll(e){const t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}const Nl={render:Ho,init:Pa},Ol=Object.freeze(Object.defineProperty({__proto__:null,default:Nl,init:Pa,render:Ho},Symbol.toStringTag,{value:"Module"})),Rl={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},se=e=>String(e??"").replace(/[&<>"']/g,t=>Rl[t]),zo=()=>x.getConfig?.().BASE_URL||"",Ml={single_select:{icon:"quiz",color:"#0072BA"},multi_select:{icon:"checklist",color:"#0E6BA8"},scheduler:{icon:"event",color:"#915E8B"},text:{icon:"short_text",color:"#5B54C6"},email:{icon:"mail",color:"#0E8F86"},phone:{icon:"call",color:"#2E8B57"},message:{icon:"chat",color:"#B4791F"}},Bt={};Ia.forEach(e=>{Bt[e.value]={label:e.label,...Ml[e.value]||{icon:"quiz",color:"#0072BA"}}});const Go=Ia.map(e=>e.value),qo={chat:"Chat / default",book:"Book (scheduler)",support:"Support (intake)"},Da=e=>Bt[e]||Bt.single_select,Ke=e=>e==="single_select"||e==="multi_select",Qt=e=>e!=="message",yt=e=>e==="scheduler",Ut=e=>e==="email"?"email":e==="phone"?"phone":"",Ye=()=>({meeting_label:"",start:"09:00",end:"17:00",mins:30,days:14}),Fl=[["","No icon"],["event","Calendar"],["schedule","Clock"],["mail","Email"],["sms","Text"],["phone","Phone"],["chat","Chat"],["description","Document"],["help","Question"],["place","Location"],["person","Person"],["bolt","Quick"],["check_circle","Check"],["star","Star"],["home","Home"],["build","Service"]];function Pl(e,t){const a=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||"").trim());return a?`rgba(${parseInt(a[1],16)},${parseInt(a[2],16)},${parseInt(a[3],16)},${t})`:`rgba(0,114,186,${t})`}let Tn=!1;function Dl(){if(Tn)return;const e=document.createElement("style");e.id="m5t-flow-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Tn=!0}let R=[],Se=null,Bl=0,Me=null,Ge=null,qe="chat",ve={},$t=[],Vo=null,ya=null,Lt="";const st=()=>"f"+ ++Bl;function Ba(e="single_select"){return{_uid:st(),id:"",step_type:e,step_prompts:[""],step_options:Ke(e)?[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]:[],step_columns:Ut(e)?[Ut(e)]:[],step_description:"",step_config:yt(e)?Ye():null}}function Ul(e){return(Array.isArray(e)?e:[]).map(t=>({_uid:st(),id:t.id!=null?String(t.id):"",step_type:Bt[t.step_type]?t.step_type:"single_select",step_prompts:Array.isArray(t.step_prompts)?t.step_prompts.map(String):[],step_options:(Array.isArray(t.step_options)?t.step_options:[]).map(a=>({label:a&&a.label!=null?String(a.label):"",goto:a&&a.goto!=null?String(a.goto):"",icon:a&&a.icon!=null?String(a.icon):""})),step_columns:Array.isArray(t.step_columns)?t.step_columns.map(String):[],step_description:t.step_description!=null?String(t.step_description):"",step_config:t.step_config&&typeof t.step_config=="object"?{...Ye(),...t.step_config}:t.step_type==="scheduler"?Ye():null}))}function In(){return[{_uid:st(),id:"",step_type:"text",step_prompts:["Great, and your name?"],step_options:[],step_columns:["first_name"],step_description:"",step_config:null},{_uid:st(),id:"",step_type:"email",step_prompts:["The best email to reach you?"],step_options:[],step_columns:["email"],step_description:"",step_config:null}]}function Hl(e,t){if(e==="book")return[{_uid:st(),id:"",step_type:"scheduler",step_prompts:["When works best for you?"],step_options:[],step_columns:[],step_description:"",step_config:Ye()},...In()];if(e==="support"){const a=(t.actions||[]).find(s=>s&&s.type==="support"),n=a&&a.config&&Array.isArray(a.config.options)?a.config.options:[],o=n.length?n.map(s=>({label:s&&s.label||String(s),goto:"",icon:s&&s.icon||""})):["Sales enquiry","Support","Billing","Something else"].map(s=>({label:s,goto:"",icon:""}));return[{_uid:st(),id:"",step_type:"multi_select",step_prompts:["How can we help you today?"],step_options:o,step_columns:[],step_description:"Select all that apply",step_config:null},...In()]}return[Ba("single_select")]}function jo(e,t){const a=e==="chat"?t.steps:t.routes&&t.routes[e],n=Ul(a);return n.length?n:e==="chat"?[Ba("single_select")]:Hl(e,t)}function zl(e){Ke(e.step_type)?e.step_options.length||(e.step_options=[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]):e.step_options=[],Qt(e.step_type)?!e.step_columns.length&&Ut(e.step_type)&&(e.step_columns=[Ut(e.step_type)]):e.step_columns=[],e.step_config=yt(e.step_type)?e.step_config||Ye():null}function Gl(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${se(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${Fl.map(([a,n])=>`<option value="${se(a)}"${a===e.icon?" selected":""}>${se(n)}</option>`).join("")}</select>
  ...
  </div>`}function ql(e){const t=Go.map(n=>`<option value="${n}"${n===e.step_type?" selected":""}>${se(Da(n).label)}</option>`).join(""),a=e.step_options.length<=1;return`<div class="flow-node__body">
    ...
    <textarea class="mag-modal__input flow-f-prompts" rows="2" placeholder="${e.step_type==="message"?"Thanks! One moment…":"What can we help you with?"}">${se(e.step_prompts.join(`
`))}</textarea>
    ...
    <select class="mag-modal__select flow-f-field">
      ...
      ${Ta.map(n=>`<option value="${se(n.value)}"${n.value===e.step_columns[0]?" selected":""}>${se(n.label)}</option>`).join("")}
    </select>
    ...
    <div class="flow-opts">${e.step_options.map(n=>Gl(n,a)).join("")}</div>
    ...
    <input class="mag-modal__input flow-f-mtlabel" type="text" value="${se(e.step_config?.meeting_label||"")}" placeholder="e.g. 15 minute call">
    <div class="mag-modal__row" style="margin-top:8px">
      <div><label class="mag-modal__label">From</label><input class="mag-modal__input flow-f-start" type="time" value="${se(e.step_config?.start||"09:00")}"></div>
      <div><label class="mag-modal__label">To</label><input class="mag-modal__input flow-f-end" type="time" value="${se(e.step_config?.end||"17:00")}"></div>
  ...
  </div>`}function Vl(e){const t=e.step_prompts.find(o=>String(o).trim()!=="")||"",a=t?`<div class="flow-node__prompt">“${se(t)}”</div>`:`<div class="flow-node__prompt is-empty">${e.step_type==="message"?"No message yet":"No question yet"}</div>`;let n="";if(Ke(e.step_type)){const o=e.step_options.map(s=>String(s.label).trim()).filter(Boolean);if(o.length){const s=o.slice(0,4).map(i=>`<span class="flow-node__chip">${se(i)}</span>`).join(""),r=o.length>4?`<span class="flow-node__chip">+${o.length-4}</span>`:"";n=`<div class="flow-node__chips">${s}${r}</div>`}}else if(Qt(e.step_type)&&e.step_columns[0]){const o=Ta.find(s=>s.value===e.step_columns[0])?.label||e.step_columns[0];n=`<div class="flow-node__meta">Saves to <b>${se(o)}</b></div>`}return`<div class="flow-node__preview">${a}${n}</div>`}function jl(e,t,a){const n=Da(e.step_type),o=e._uid===Se,s=`--nc:${n.color};--nct:${Pl(n.color,.14)}`;return`<div class="flow-node${o?" flow-node--open":""}" data-uid="${e._uid}" style="${s}"${o?"":' draggable="true"'}>
    <div class="flow-node__hd">
      ...
      <span class="flow-node__type">${se(n.label)}</span>
    ...
    ${o?ql(e):Vl(e)}
  </div>`}const $n='<div class="flow-conn"><span class="flow-conn__line"></span><span class="material-symbols-outlined" aria-hidden="true">expand_more</span></div>';function ye(){const e=document.getElementById("flow-nodes");if(!e)return;const t=R.length,a=['<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>',$n];R.forEach((n,o)=>{a.push(jl(n,o,t)),o<t-1&&a.push($n)}),e.innerHTML=a.join("")}function Ae(){const e=document.querySelector(".flow-node--open");if(!e)return;const t=R.find(s=>s._uid===e.dataset.uid);if(!t)return;const a=e.querySelector(".flow-f-type");a&&(t.step_type=a.value);const n=e.querySelector(".flow-f-prompts");n&&(t.step_prompts=n.value.split(`
`));const o=e.querySelector(".flow-f-field");if(t.step_columns=o&&o.value.trim()?[o.value.trim()]:[],Ke(t.step_type)){const s=t.step_options,r=[];e.querySelectorAll(".flow-opt").forEach((i,l)=>{r.push({label:i.querySelector(".flow-o-label")?.value??"",icon:i.querySelector(".flow-o-icon")?.value??"",goto:s[l]&&s[l].goto||""})}),t.step_options=r}else t.step_options=[];if(yt(t.step_type)){const s=e.querySelector(".flow-f-mtlabel"),r=e.querySelector(".flow-f-start"),i=e.querySelector(".flow-f-end"),l=e.querySelector(".flow-f-mins");t.step_config={...t.step_config||Ye(),...s?{meeting_label:s.value.trim()}:{},...r&&r.value?{start:r.value}:{},...i&&i.value?{end:i.value}:{},...l?{mins:parseInt(l.value,10)||30}:{}}}else t.step_config=null}function Wo(){document.querySelectorAll(".flow-node.drop-before, .flow-node.drop-after").forEach(e=>e.classList.remove("drop-before","drop-after"))}function ut(){Wo(),document.querySelectorAll(".flow-node.dragging").forEach(e=>e.classList.remove("dragging")),Me=null,Ge=null}function Wl(e=R){if(!e.length)return"Add at least one step.";for(let t=0;t<e.length;t++){const a=e[t],n=t+1;if(!a.step_prompts.some(o=>String(o).trim()!==""))return`Step ${n}: add what the magnet should say.`;if(Ke(a.step_type)&&!a.step_options.some(o=>String(o.label).trim()!==""))return`Step ${n}: add at least one choice.`;if(Qt(a.step_type)&&!a.step_columns.length)return`Step ${n}: choose which field this answer saves to.`}return""}function wa(e=R){let t=0;return e.forEach(a=>{const n=parseInt(a.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(a=>{const n=a.id&&String(a.id).trim()?String(a.id):String(++t),o=Ke(a.step_type)?a.step_options.map(r=>{const i={label:String(r.label).trim(),goto:String(r.goto||"")};return r.icon&&(i.icon=String(r.icon)),i}).filter(r=>r.label!==""):[],s={id:n,step_type:a.step_type,step_prompts:a.step_prompts.map(r=>String(r)).filter(r=>r.trim()!==""),step_options:o,step_columns:a.step_columns.slice(),step_description:a.step_description||""};return yt(a.step_type)&&a.step_config&&(s.step_config={...Ye(),...a.step_config}),s})}function Yl(e,t,a){Dl(),Vo=t,ya=typeof a=="function"?a:null,Lt=t?.modified_tz||"",$t=["chat",...["book","support"].filter(n=>(t.actions||[]).some(o=>o&&o.type===n))],ve={chat:jo("chat",t)},qe="chat",R=ve.chat,Se=R.length===1?R[0]._uid:null,Me=null,Ge=null,e.innerHTML=`
    ...
    ${$t.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${$t.map(n=>`<option value="${n}">${se(qo[n]||n)}</option>`).join("")}</select></div>`:""}
...
<body>
  ...
  <\/script>
  <script>${a}<\/script>
</body></html>`}let Nn=!1;function Jo(){if(Nn)return;const e=document.createElement("style");e.id="m5t-preview-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Nn=!0}function Ko(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function Xo(e){const t=e.querySelector("[data-pv-info]"),a=e.querySelector("[data-pv-info-pop]");t&&a&&t.addEventListener("click",()=>{a.hidden=!a.hidden})}function tc(e,t){Jo(),e.innerHTML=`
    <div class="pv-pane">
      ...
      ${Ko("Live render of the real widget. Capture is disabled, so no test leads.")}
    </div>`,Xo(e);const a=e.querySelector(".pv-pane__frame"),n=e.querySelector(".pv-pane__badge");let o=null,s=0;const r=450,i=()=>{const c=(typeof performance<"u"?performance.now():Date.now())-s;clearTimeout(o),c<r?o=setTimeout(()=>{n.hidden=!0},r-c):n.hidden=!0};a.addEventListener("load",i);const l=()=>{let c;try{c=Yo(t())}catch{return}s=typeof performance<"u"?performance.now():Date.now(),n.hidden=!1,a.srcdoc=c,clearTimeout(o),o=setTimeout(()=>{n.hidden=!0},1500)};return e.querySelector(".pv-pane__seg").addEventListener("click",c=>{const g=c.target.closest("button[data-device]");!g||g.dataset.device===a.dataset.device||(e.querySelectorAll(".pv-pane__seg button").forEach(b=>b.classList.toggle("is-on",b===g)),a.dataset.device=g.dataset.device)}),l(),{refresh:l,destroy(){clearTimeout(o)}}}function Qo(e){Jo();let t="desktop";const a=document.createElement("div");a.className="pv-scrim",a.innerHTML=`
  ...
  `,document.head.appendChild(e),Rn=!0}function nc(e){ac();const t=document.createElement("div");t.className="mag-modal-scrim mag-tpl-modal",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(o){o.key==="Escape"&&(o.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.querySelectorAll("[data-tpl]").forEach(o=>{o.addEventListener("click",()=>{const s=On.find(r=>r.id===o.dataset.tpl);s&&(t.querySelectorAll("[data-tpl]").forEach(r=>{r.disabled=!0}),a(),e(s))})})}let Mn=!1;const B={magnets:[],owners:[],canProvision:!1,canManage:!1,primaryOrgGuid:null,stats:{}},oc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},f=e=>String(e??"").replace(/[&<>"']/g,t=>oc[t]),Oe=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},J=()=>x.getConfig?.().BASE_URL||"",Zo=e=>`<script src="${J()}/m5t/v5/coreSnippet?appguid=${e}" async><\/script>`,es=()=>`<details class="mag-csp-note" open>
  ...
  <div class="mag-csp-note__body">
    <p>A strict CSP can silently block the widget — it just never appears, no visible error. Allowlist <code>${f(J())}</code> under all three directives. Copy-paste ready for your CSP header/meta tag:</p>
    <pre class="mag-csp-note__snippet"><code>script-src 'self' ${f(J())};
connect-src 'self' ${f(J())};
img-src 'self' ${f(J())};</code></pre>
    <ul>
...
</details>`,sc={chat:"Chat bubble",right_slide:"Slide-in panel",modal:"Modal",inline:"Inline"},rc={chat:"chat",right_slide:"vertical_split",modal:"web_asset",inline:"view_agenda"},ic=[{value:"inline",icon:"view_agenda",label:"Inline"},{value:"chat",icon:"chat",label:"Chat"},{value:"right_slide",icon:"vertical_split",label:"Slide"},{value:"modal",icon:"web_asset",label:"Modal"}],lc=[{value:"auto",icon:"brightness_auto",label:"Auto"},{value:"light",icon:"light_mode",label:"Light"},{value:"dark",icon:"dark_mode",label:"Dark"}],cc=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],ts={book:{label:"Book",icon:"event",kind:"book"},chat:{label:"Chat",icon:"chat",kind:"flow"},call:{label:"Call",icon:"phone",kind:"value",placeholder:"Phone number"},email:{label:"Email",icon:"mail",kind:"value",placeholder:"Email address"},support:{label:"Support",icon:"support_agent",kind:"support"}},dc=["book","chat","call","email","support"];let Nt=null;async function pc(){if(Nt)return Nt;let e;try{const t=await fetch(`${J()}/m5t/v5/integrations/calendly/event_types`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.event_types||[],scheduling_url:a.data.scheduling_url||""}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(Nt=e),e}async function uc(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved Calendly event";e.innerHTML=`<option value="${f(t)}">${t?f(a):"Loading event types"}</option>`;const n=await pc();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${f(t)}" selected>${f(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect Calendly under Settings, Integrations first":"Could not load event types"}</option>`;return}const o=[];n.scheduling_url&&o.push({url:n.scheduling_url,label:"Full scheduling page (visitor picks the event)"}),n.list.forEach(s=>o.push({url:s.scheduling_url,label:s.duration?`${s.name} (${s.duration} min)`:s.name})),t&&!o.some(s=>s.url===t)&&o.unshift({url:t,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${f(s.url)}"${s.url===(t||o[0].url)?" selected":""}>${f(s.label)}</option>`).join(""):'<option value="">No active event types</option>'}let Ot=null;async function mc(){if(Ot)return Ot;let e;try{const t=await fetch(`${J()}/m5t/v5/integrations/callrail/trackers`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.trackers||[]}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(Ot=e),e}async function gc(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved tracking number";e.innerHTML=`<option value="${f(t)}">${t?f(a):"Loading tracking numbers"}</option>`;const n=await mc();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${f(t)}" selected>${f(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect CallRail under Settings, Integrations first":"Could not load tracking numbers"}</option>`;return}const o=n.list.map(s=>({number:s.number,id:s.id,name:s.name,label:`${s.name} · ${s.number}${s.type==="session"?" (number pool)":""}`}));t&&!o.some(s=>s.number===t)&&o.unshift({number:t,id:e.dataset.savedId||"",name:a,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${f(s.number)}" data-tracker-id="${f(s.id)}" data-tracker-name="${f(s.name)}"${s.number===(t||o[0].number)?" selected":""}>${f(s.label)}</option>`).join(""):'<option value="">No active tracking numbers in this company</option>'}function Fn(e,t,a){return`<div class="mag-seg" role="radiogroup" aria-label="${f(e)}">${a.map(n=>`
    <label><input type="radio" name="${f(e)}" value="${f(n.value)}"${n.value===t?" checked":""}>
      <span><span class="material-symbols-outlined" aria-hidden="true">${f(n.icon)}</span>${f(n.label)}</span></label>`).join("")}</div>`}function hc(e,t){const a=ts[e],n=!!t,o=n?"":" disabled";let s="";if(a.kind==="value"&&e==="call"){const i=t?.config?.source==="callrail",l=i&&t?.value||"",c=i?t?.config?.tracker_name||"Saved tracking number":"";s=`
      ...
      <input class="mag-modal__input mag-cta__val" type="text" placeholder="${f(a.placeholder)}" value="${f(i?"":t?.value||"")}"${o}${i?" hidden":""}>
      <select class="mag-modal__select mag-cta__crtracker" data-saved="${f(l)}" data-saved-name="${f(c)}" data-saved-id="${f(i&&t?.config?.tracker_id||"")}"${o}${i?"":" hidden"}>
        ${l?`<option value="${f(l)}" selected>${f(c)}</option>`:""}
      </select>`}else if(a.kind==="value")s=`<input class="mag-modal__input mag-cta__val" type="text" placeholder="${f(a.placeholder)}" value="${f(t?.value||"")}"${o}>`;else if(a.kind==="book"){const i=t?.config?.meeting_label||t?.value||"",l=t?.config?.source==="calendly",c=l&&t?.config?.calendly_url||"",g=l?t?.config?.event_name||"Saved Calendly event":"";s=`
      ...
      <input class="mag-modal__input mag-cta__val" type="text" placeholder="Meeting label (e.g. 15 minute call), or paste a booking link" value="${f(i)}"${o}${l?" hidden":""}>
      <select class="mag-modal__select mag-cta__calevent" data-saved="${f(c)}" data-saved-name="${f(g)}"${o}${l?"":" hidden"}>
        ${c?`<option value="${f(c)}" selected>${f(g)}</option>`:""}
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${a.kind}">
    ...
    ${r}
  </div>`}function fc(){if(Mn)return;const e=document.createElement("style");e.id="m5t-magnets-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Mn=!0}function Ht(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function vc(e){const t=B.stats[e];if(!t||!t.opens&&!t.leads)return'<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>';const a=n=>Number(n||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function Ua(e){const t=B.owners.length>1||x.getMemberships().length>1,a=(e.domains||[]).filter(Boolean),n=B.canManage;return`
    <div class="mag-card" data-guid="${f(e.guid)}">
      <div class="mag-card__top">
        <span class="mag-swatch" style="background:${f(e.theme_color||"#0072BA")}"></span>
        <span class="mag-card__hd">
          <div class="mag-name" title="${f(e.name)}">${f(e.name)}</div>
          ${t&&e.owner_name?`<div class="mag-owner">${f(e.owner_name)}</div>`:""}
        </span>
        <span class="mag-badge" data-s="${f(e.status)}">${f(e.status)}</span>
      </div>
      <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${rc[e.display_mode]||"chat"}</span>${f(sc[e.display_mode]||"Chat bubble")}${e.ab?.enabled?'&nbsp;&nbsp;<span class="mag-ab-chip"><span class="material-symbols-outlined" aria-hidden="true">science</span>A/B</span>':""}${(e.notify_emails||[]).length?`&nbsp;&nbsp;<a class="mag-alert-chip" href="#/settings/notifications" title="Lead alerts to ${(e.notify_emails||[]).length} email${(e.notify_emails||[]).length===1?"":"s"}. Manage in Settings."><span class="material-symbols-outlined" aria-hidden="true">notifications_active</span>${(e.notify_emails||[]).length}</a>`:""}</span>
      ${vc(e.guid)}
      <div class="mag-domains">${a.length?a.map(o=>f(o)).join(", "):"<span>No domains set. Add yours to go live.</span>"}</div>
      <div class="mag-embed">
        <input type="text" readonly value="${f(Zo(e.guid))}" aria-label="Embed snippet">
        <button class="mag-btn" data-action="copy" data-guid="${f(e.guid)}" title="Copy embed snippet"><span class="material-symbols-outlined" aria-hidden="true">content_copy</span></button>
      </div>
      ${es()}
      ...
      <div class="mag-actions">
        <button class="mag-btn" data-action="preview" data-guid="${f(e.guid)}"><span class="material-symbols-outlined" aria-hidden="true">visibility</span>Preview</button>
        <button class="mag-btn" data-action="funnel" data-guid="${f(e.guid)}" title="Which question loses the most visitors"><span class="material-symbols-outlined" aria-hidden="true">filter_alt</span>Funnel</button>
        ${n?`
        <button class="mag-btn mag-btn--primary" data-action="edit" data-guid="${f(e.guid)}"><span class="material-symbols-outlined" aria-hidden="true">tune</span>Edit</button>`:""}
      </div>
      ${n?`
      <div class="mag-actions mag-actions--sub">
        <button class="mag-btn" data-action="flow" data-guid="${f(e.guid)}" title="Edit the conversation flow"><span class="material-symbols-outlined" aria-hidden="true">account_tree</span>Flow</button>
        ${e.status==="DRAFT"?"":`
        <button class="mag-btn" data-action="toggle" data-guid="${f(e.guid)}">${e.status==="ENABLED"?'<span class="material-symbols-outlined" aria-hidden="true">pause</span>Disable':'<span class="material-symbols-outlined" aria-hidden="true">play_arrow</span>Enable'}</button>`}
        <button class="mag-btn danger" data-action="delete" data-guid="${f(e.guid)}"><span class="material-symbols-outlined" aria-hidden="true">delete</span></button>
      </div>`:""}
    </div>`}function _c(){return ne()?bt({section:"magnets",title:"Your Magnets",description:"Pick a client to view and manage their magnets."}):(fc(),`
    <div class="page-shell" data-section="magnets">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="mag-body">
          ${Ht("hourglass_empty","Loading magnets…")}
        </div>
      </div>
    </div>`)}async function bc(){if(ne()){const t=a=>Number(a||0).toLocaleString();return it(J(),[{h:"Magnets",td:a=>`${t(a.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${t(a.magnets.total)}</span>`},{h:"Leads · wk",td:a=>t(a.leads.this_week)},{h:"Leads · total",td:a=>t(a.leads.total)}],{emptyMsg:"No client orgs yet. Create one under Clients, then provision its magnets here."})}Nt=null,Ot=null,document.getElementById("mag-new-btn")?.addEventListener("click",xc),document.getElementById("mag-template-btn")?.addEventListener("click",Ec),document.getElementById("mag-body")?.addEventListener("click",Sc),await wt()}async function wt(){const e=document.getElementById("mag-body");if(!e)return;try{const[n,o]=await Promise.all([fetch(`${J()}/m5t/v5/magnets`),fetch(`${J()}/m5t/v5/magnets/stats`).catch(()=>null)]),s=await n.json().catch(()=>({}));if(!s.ok)throw new Error(s.message||"Failed to load");B.magnets=s.magnets||[],B.owners=s.owners||[],B.canProvision=!!s.canProvision,B.canManage=!!s.canManage,B.primaryOrgGuid=s.primaryOrgGuid||null;const r=o?await o.json().catch(()=>({})):{};B.stats=r?.stats||{}}catch{e.innerHTML=Ht("error","Could not load your magnets. Please try again.");return}const t=document.getElementById("mag-new-btn");t&&(t.style.display=B.canProvision?"":"none");const a=document.getElementById("mag-template-btn");if(a&&(a.style.display=B.canProvision?"":"none"),!B.magnets.length){e.innerHTML=Ht("widgets",B.canProvision?"No magnets yet. Click “New magnet” to create your first.":"No magnets yet.");return}e.innerHTML=`<div class="mag-grid">${B.magnets.map(Ua).join("")}</div>`}async function yc(e){const t={"Content-Type":"application/json","Idempotency-Key":crypto.randomUUID()},a={status:"DRAFT"};e&&(a.owner_guid=e);const n=await fetch(`${J()}/m5t/v5/magnets`,{method:"POST",headers:t,body:JSON.stringify(a)});let o={};try{o=await n.json()}catch{}if(!n.ok||!o.ok)throw new Error(o.message||`Could not start a new magnet (${n.status})`);return o.magnet}async function wc(e,t){const a=await fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t.name,...t.appearance,steps:t.steps})});let n={};try{n=await a.json()}catch{}if(!a.ok||!n.ok)throw new Error(n.message||`Could not apply the ${t.name} template (${a.status})`)}async function Ha(e,t){const a=document.getElementById("mag-new-btn"),n=document.getElementById("mag-template-btn");a&&(a.disabled=!0),n&&(n.disabled=!0);let o=null;try{let s=await yc(e);if(o=s.guid,t)await wc(s.guid,t),await wt(),s=B.magnets.find(r=>r.guid===s.guid)||s;else{B.magnets=[s,...B.magnets];const r=document.getElementById("mag-body");r&&(r.innerHTML=`<div class="mag-grid">${B.magnets.map(Ua).join("")}</div>`)}zt(s,void 0,{freshDraft:!0})}catch(s){o&&fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(o)}`,{method:"DELETE"}).catch(()=>{}),Oe(s.message||"Could not start a new magnet","danger")}finally{a&&(a.disabled=!1),n&&(n.disabled=!1)}}function as(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="Choose client" style="max-width:420px">
      <div class="mag-modal__head">
        <span class="mag-modal__title">${e?`New magnet from “${f(e.name)}”`:"New magnet"}</span>
        <button class="mag-modal__close" type="button" aria-label="Close">&times;</button>
      </div>
      <div class="mag-modal__body" style="padding:20px">
        ...
        <select class="mag-modal__select" id="mag-owner-pick">
          ${B.owners.map(o=>`<option value="${f(o.guid)}"${o.guid===B.primaryOrgGuid?" selected":""}>${f(o.name||o.guid)}</option>`).join("")}
        </select>
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(o){o.key==="Escape"&&(o.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.querySelector('[data-x="cancel"]').addEventListener("click",a),t.querySelector('[data-x="continue"]').addEventListener("click",()=>{const o=t.querySelector("#mag-owner-pick").value;a(),Ha(o,e)})}function xc(){if(B.owners.length>1){as();return}Ha(null)}function Ec(){nc(e=>{if(B.owners.length>1){as(e);return}Ha(null,e)})}function Sc(e){const t=e.target.closest("[data-action]");if(!t)return;const a=t.dataset.guid,n=B.magnets.find(s=>s.guid===a),o=t.dataset.action;if(o==="copy")return Ac(a);if(n){if(o==="preview")return Qo(()=>xa(n));if(o==="funnel")return kc(n);if(o==="edit")return zt(n);if(o==="flow")return zt(n,"flow");if(o==="toggle")return Cc(n);if(o==="delete")return Tc(n)}}async function Ac(e){try{await navigator.clipboard.writeText(Zo(e)),Oe("Embed snippet copied","success")}catch{Oe("Copy failed","danger")}}function ns(e){const t=Number(e?.total_steps)||0,a={};if((Array.isArray(e?.funnel)?e.funnel:[]).forEach(s=>{a[s.position]=Number(s.reached)||0}),!t||!Object.keys(a).length)return'<p class="mag-modal__hint" style="margin:0">No step activity yet in this window. As visitors answer questions, drop-off by step will appear here.</p>';const n=Math.max(1,a[1]||0),o=[];for(let s=1;s<=t;s++){const r=a[s]||0,i=Math.min(100,Math.round(r/n*100));o.push(`
      ...
      </div>`)}return`<div class="mag-funnel">${o.join("")}</div>`}async function kc(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal mag-funnel-modal" role="dialog" aria-modal="true" aria-label="Step funnel for ${f(e.name)}">
      <div class="mag-modal__head">
        <span class="mag-modal__title">Step funnel — ${f(e.name)}</span>
        <button class="mag-modal__close" type="button" aria-label="Close">&times;</button>
      </div>
      <div class="mag-modal__body" style="padding:20px">
        ...
        <div id="mag-funnel-body">${Ht("hourglass_empty","Loading…")}</div>
      </div>
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(s){s.key==="Escape"&&(s.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.addEventListener("click",s=>{s.target===t&&a()});const o=t.querySelector("#mag-funnel-body");try{const s=await fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/step-funnel`),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.message||`Failed (${s.status})`);o.innerHTML=ns(r)}catch{o.innerHTML='<p class="mag-modal__hint" style="margin:0">Could not load the funnel. Please try again.</p>'}}async function Cc(e){if(e.status==="DRAFT"){Oe("Open Edit and Save to publish a draft magnet.","info");return}const t=e.status==="ENABLED"?"DISABLED":"ENABLED";try{if(!(await(await fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw new Error;Oe(t==="ENABLED"?"Magnet enabled":"Magnet disabled","success")}catch{Oe("Update failed","danger");return}try{await wt()}catch(a){console.warn("[magnets] refresh after status toggle failed:",a)}}async function Tc(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`)){try{if(!(await(await fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"})).json().catch(()=>({}))).ok)throw new Error;Oe("Magnet deleted","success")}catch{Oe("Delete failed","danger");return}try{await wt()}catch(t){console.warn("[magnets] refresh after delete failed:",t)}}}function la(e){const t=[];return e.querySelectorAll(".mag-cta").forEach(a=>{if(!a.querySelector(".mag-cta__on").checked)return;const n=a.dataset.type,o=a.dataset.kind,s=a.querySelector(".mag-cta__val"),r=s?s.value.trim():"";if(o==="value")if(n==="call"&&a.querySelector(".mag-cta__callsrc")?.value==="callrail"){const i=a.querySelector(".mag-cta__crtracker"),l=i?.value||"",c=i?.selectedOptions?.[0];l&&t.push({type:n,value:l,config:{source:"callrail",...c?.dataset?.trackerId?{tracker_id:c.dataset.trackerId}:{},...c?.dataset?.trackerName?{tracker_name:c.dataset.trackerName}:{}}})}else r&&t.push({type:n,value:r});else if(o==="book")if(a.querySelector(".mag-cta__booksrc")?.value==="calendly"){const i=a.querySelector(".mag-cta__calevent"),l=i?.value||"",c=(i?.selectedOptions?.[0]?.textContent||"").trim();t.push({type:n,config:{source:"calendly",...l?{calendly_url:l}:{},...l&&c?{event_name:c}:{}}})}else{const i={type:n};r&&(/^https?:\/\//i.test(r)?i.value=r:i.config={meeting_label:r}),t.push(i)}else if(o==="support"){const i=(a.querySelector(".mag-cta__opts")?.value||"").split(`
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:os(e),actions:t,font:e.querySelector("#mag-f-font").value.trim(),theme_vars:Rc(e),inline_width:e.querySelector("#mag-f-inline-w").value.trim(),inline_height:e.querySelector("#mag-f-inline-h").value.trim(),hide_launcher:e.querySelector("#mag-f-hide-launcher").checked,input_placeholder:e.querySelector("#mag-f-input-ph").value,summary_confirm_label:e.querySelector("#mag-f-summary-confirm").value.trim(),success_title:e.querySelector("#mag-f-success-title").value.trim(),success_text:e.querySelector("#mag-f-success-text").value,success_cta:Mc(e)}}const Ic=512,$c=new Set(["image/png","image/jpeg","image/gif","image/webp"]),Lc=8*1024*1024;function Nc(e){return new Promise((t,a)=>{const n=new Image,o=new FileReader;o.onerror=()=>a(new Error("Could not read that file.")),o.onload=()=>{n.onerror=()=>a(new Error("That file isn’t a readable image.")),n.onload=()=>{const s=Math.min(1,Ic/Math.max(n.naturalWidth,n.naturalHeight)),r=Math.max(1,Math.round(n.naturalWidth*s)),i=Math.max(1,Math.round(n.naturalHeight*s)),l=document.createElement("canvas");l.width=r,l.height=i,l.getContext("2d").drawImage(n,0,0,r,i),t(l.toDataURL("image/png"))},n.src=o.result},o.readAsDataURL(e)})}function Oc(e,t){const a=e.querySelector("#mag-logo-drop");if(!a)return;const n=e.querySelector("#mag-f-logo-file"),o=e.querySelector("#mag-logo-browse"),s=e.querySelector("#mag-logo-remove"),r=e.querySelector("#mag-logo-preview"),i=e.querySelector("#mag-logo-status"),l=e.querySelector("#mag-f-logo"),c=(_,w)=>{i.textContent=_,i.style.color=w?"var(--color-danger, #DD4124)":""},g=_=>{r.innerHTML=_?`<img src="${f(_)}" alt="">`:'<span class="material-symbols-outlined" aria-hidden="true">image</span>',s.hidden=!_},b=_=>{l.value=_,l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))};async function y(_){if(!$c.has(_.type)){c("PNG, JPEG, GIF, or WEBP only.",!0);return}if(_.size>Lc){c("That file is too large (8MB max before resizing).",!0);return}c("Uploading…",!1);try{const w=await Nc(_),d=await fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({image:w})}),h=await d.json().catch(()=>({}));if(!d.ok||!h.ok)throw new Error(h.error||`Upload failed (${d.status})`);const v=`${J()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;b(v),g(v),c("Logo updated.",!1)}catch(w){c(w.message||"Upload failed.",!0)}}n.addEventListener("change",()=>{n.files[0]&&y(n.files[0]),n.value=""}),a.addEventListener("click",_=>{_.target===s||s.contains(_.target)||_.target!==o&&n.click()}),o.addEventListener("click",()=>n.click()),["dragenter","dragover"].forEach(_=>a.addEventListener(_,w=>{w.preventDefault(),a.classList.add("is-dragover")})),["dragleave","drop"].forEach(_=>a.addEventListener(_,w=>{w.preventDefault(),a.classList.remove("is-dragover")})),a.addEventListener("drop",_=>{const w=_.dataTransfer?.files?.[0];w&&y(w)}),s.addEventListener("click",async _=>{_.stopPropagation(),c("Removing…",!1);try{const w=await fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"DELETE"}),d=await w.json().catch(()=>({}));if(!w.ok||!d.ok)throw new Error(d.error||`Remove failed (${w.status})`);b(""),g(""),c("Logo removed.",!1)}catch(w){c(w.message||"Remove failed.",!0)}})}function Rc(e){return e.querySelector("#mag-f-surface-on")?.checked?{surface:e.querySelector("#mag-f-sv-surface").value,surface_2:e.querySelector("#mag-f-sv-surface2").value,border:e.querySelector("#mag-f-sv-border").value,text:e.querySelector("#mag-f-sv-text").value,text_sub:e.querySelector("#mag-f-sv-textsub").value}:{}}function Mc(e){const t=e.querySelector("#mag-f-success-cta-label").value.trim(),a=e.querySelector("#mag-f-success-cta-url").value.trim();return t&&a?{label:t,url:a}:{}}function os(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",s=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==s.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}const Pn=[{label:"Web fonts (loaded for you)",opts:[["Inter, sans-serif","Inter"],["Poppins, sans-serif","Poppins"],["Montserrat, sans-serif","Montserrat"],["Roboto, sans-serif","Roboto"],['"Open Sans", sans-serif',"Open Sans"],["Lato, sans-serif","Lato"],["Nunito, sans-serif","Nunito"],["Raleway, sans-serif","Raleway"],['"Work Sans", sans-serif',"Work Sans"],["Oswald, sans-serif","Oswald"],["Merriweather, serif","Merriweather (serif)"]]},{label:"System / always available",opts:[["system-ui, sans-serif","System UI"],["Georgia, serif","Georgia (serif)"],['"Times New Roman", Times, serif',"Times (serif)"],["Arial, Helvetica, sans-serif","Arial / Helvetica"],["Verdana, Geneva, sans-serif","Verdana"],['"Courier New", monospace',"Courier (mono)"]]}];function Fc(e){const t=String(e||""),a=new Set(Pn.flatMap(s=>s.opts.map(([r])=>r))),n=s=>s===t?" selected":"";let o=`<option value=""${t===""?" selected":""}>System default</option>`;t&&!a.has(t)&&(o+=`<option value="${f(t)}" selected>Current: ${f(t)}</option>`);for(const s of Pn)o+=`<optgroup label="${f(s.label)}">`+s.opts.map(([r,i])=>`<option value="${f(r)}"${n(r)}>${f(i)}</option>`).join("")+"</optgroup>";return o}function zt(e,t,a={}){const{freshDraft:n=!1}=a,o=!!e,s=o?null:crypto.randomUUID(),r=!o&&B.owners.length>1,i=e?.display_mode||"chat",l=e?.theme_mode||"auto",c={};(e?.actions||[]).forEach(S=>{S&&S.type&&(c[S.type]=S)});const g=o?!!e.home:!0,b=o?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",y=e?.theme_vars&&typeof e.theme_vars=="object"?e.theme_vars:{},_=Object.keys(y).length>0,w=(S,P)=>f(/^#[0-9a-fA-F]{6}$/.test(y[S]||"")?y[S]:P),d=document.createElement("div");d.className="mag-modal-scrim",d.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${o?"Edit magnet":"New magnet"}">
      ...
      <div class="mag-modal__main">
        ...
        <input class="mag-modal__input" id="mag-f-name" type="text" placeholder="e.g. Homepage quote magnet" value="${f(e?.name||"")}">

        ${r?`
        <label class="mag-modal__label" for="mag-f-owner">Client / workspace</label>
        <select class="mag-modal__select" id="mag-f-owner">
          ${B.owners.map(S=>`<option value="${f(S.guid)}"${S.guid===B.primaryOrgGuid?" selected":""}>${f(S.name||S.guid)}</option>`).join("")}
        </select>`:""}
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${cc.map(S=>`<option value="${S.value}"${(e?e.trigger||"none":"on_load")===S.value?" selected":""}>${f(S.label)}</option>`).join("")}
        </select>
        ...
        <input class="mag-modal__input" id="mag-f-domains" type="text" placeholder="example.com, www.example.com" value="${f((e?.domains||[]).join(", "))}">
        ...
        <div class="mag-modal__sec">
          ...
          <div class="mag-modal__row">
            <div>
              ...
              <input class="mag-modal__input" id="mag-f-title" type="text" placeholder="Chat with us" value="${f(e?.title||"")}">
            </div>
            <div style="flex:0 0 auto">
              <label class="mag-modal__label" for="mag-f-color">Color</label>
              <input class="mag-modal__color" id="mag-f-color" type="color" value="${f(/^#[0-9a-fA-F]{6}$/.test(e?.theme_color||"")?e.theme_color:"#0072BA")}">
            </div>
          </div>

          <label class="mag-modal__label" for="mag-f-subtitle">Subtitle</label>
          <input class="mag-modal__input" id="mag-f-subtitle" type="text" placeholder="Typically replies in a few minutes" value="${f(b)}">
          ...
          <input class="mag-modal__input" id="mag-f-launcher" type="text" placeholder="Defaults to the title" value="${f(e?.launcher_label||"")}">
          ...
          <div class="mag-logo-drop" id="mag-logo-drop">
            ...
            <div class="mag-logo-drop__preview" id="mag-logo-preview">${e?.logo_url?`<img src="${f(e.logo_url)}" alt="">`:'<span class="material-symbols-outlined" aria-hidden="true">image</span>'}</div>
          ...
          <input class="mag-modal__input" id="mag-f-logo" type="text" placeholder="https://…/logo.png" value="${f(e?.logo_url||"")}">
          ...
          <select class="mag-modal__select" id="mag-f-font">${Fc(e?.font||"")}</select>
          ...
          <div class="mag-tog-row" style="margin-top:12px">
            <input type="checkbox" id="mag-f-surface-on"${_?" checked":""}>
            <label for="mag-f-surface-on">Custom surface colors (match a branded dark or light page)</label>
          </div>
          <div id="mag-f-surface" class="mag-surface-grid"${_?"":" hidden"}>
          ...
          <div id="mag-f-inline-size"${i==="inline"?"":" hidden"}>
            <div class="mag-modal__row">
              <div>
                ...
                <input class="mag-modal__input" id="mag-f-inline-w" type="text" placeholder="640px" value="${f(e?.inline_width||"")}">
              </div>
              <div>
                <label class="mag-modal__label" for="mag-f-inline-h">Inline height</label>
                <input class="mag-modal__input" id="mag-f-inline-h" type="text" placeholder="min(520px, 80vh)" value="${f(e?.inline_height||"")}">
              </div>
            </div>
          ...
          <input class="mag-modal__input" id="mag-f-input-ph" type="text" placeholder="Type your answer…" value="${f(e?.input_placeholder||"")}">
        </div>
          </section>
        ...
        <div class="mag-modal__sec">
          ...
          <textarea class="mag-modal__input" id="mag-f-welcome" rows="2" placeholder="Welcome! Pick an option below and we’ll take it from there.">${f(e?.welcome||"")}</textarea>
        ...
        <div class="mag-modal__sec">
          ...
          <div class="mag-modal__row">
            <div>
              ...
              <input class="mag-modal__input" id="mag-f-ab-title" type="text" placeholder="(unchanged)" value="${f(e?.ab?.b?.mag_title||"")}">
            </div>
            <div style="flex:0 0 auto">
              <label class="mag-modal__label" for="mag-f-ab-color">B: Color</label>
              <input class="mag-modal__color" id="mag-f-ab-color" type="color" value="${f(/^#[0-9a-fA-F]{6}$/.test(e?.ab?.b?.mag_theme_color||"")?e.ab.b.mag_theme_color:e?.theme_color||"#0072BA")}">
            </div>
          </div>
          <label class="mag-modal__label" for="mag-f-ab-welcome">B: Welcome message</label>
          <textarea class="mag-modal__input" id="mag-f-ab-welcome" rows="2" placeholder="(unchanged)">${f(e?.ab?.b?.mag_welcome||"")}</textarea>
        ...
        <div class="mag-modal__sec">
          ...
          <input class="mag-modal__input" id="mag-f-summary-heading" type="text" placeholder="Here’s what we’ve got" value="${f(e?.summary_heading||"")}">
          <label class="mag-modal__label" for="mag-f-summary-confirm">Confirm button label</label>
          <input class="mag-modal__input" id="mag-f-summary-confirm" type="text" placeholder="Confirm &amp; send" value="${f(e?.summary_confirm_label||"")}">
        </div>
        ...
        <div class="mag-modal__sec">
          ...
          <input class="mag-modal__input" id="mag-f-success-title" type="text" placeholder="You’re all set!" value="${f(e?.success_title||"")}">
          <label class="mag-modal__label" for="mag-f-success-text">Success message</label>
          <textarea class="mag-modal__input" id="mag-f-success-text" rows="2" placeholder="Thanks! We’ve got your details and someone will be in touch shortly.">${f(e?.success_text||"")}</textarea>
          <div class="mag-modal__row">
            <div>
              <label class="mag-modal__label" for="mag-f-success-cta-label">Button label (optional)</label>
              <input class="mag-modal__input" id="mag-f-success-cta-label" type="text" placeholder="e.g. Visit our site" value="${f(e?.success_cta?.label||"")}">
            </div>
            <div>
              <label class="mag-modal__label" for="mag-f-success-cta-url">Button link</label>
              <input class="mag-modal__input" id="mag-f-success-cta-url" type="text" placeholder="https://…" value="${f(e?.success_cta?.url||"")}">
            </div>
          </div>
    ...
    </div>`,document.body.appendChild(d),requestAnimationFrame(()=>{d.classList.add("open"),d.querySelector(".mag-modal").classList.add("open")});const h=[...d.querySelectorAll(".mag-modal__navitem")],v=[...d.querySelectorAll(".mag-tab")],k=S=>{h.forEach(P=>P.classList.toggle("is-active",P.dataset.tab===S)),v.forEach(P=>{P.hidden=P.dataset.tab!==S}),d.querySelector(".mag-modal__body").scrollTop=0};h.forEach(S=>S.addEventListener("click",()=>k(S.dataset.tab)));const N=()=>xa({...e,...la(d),...o?{steps:Ln()}:{}}),U=d.querySelector("#mag-preview-pane"),ae=()=>window.matchMedia("(min-width: 1200px)").matches;let Y=null;const le=()=>{if(!Y&&ae())try{Y=tc(U,N)}catch{}};let we=null;const ce=()=>{ae()&&(le(),Y&&(clearTimeout(we),we=setTimeout(()=>{try{Y.refresh()}catch{}},300)))},Re=window.matchMedia("(min-width: 1200px)"),Te=()=>{ae()&&(le(),ce())};Re.addEventListener("change",Te);let O=!1,I=!1;const V=d.querySelector("#mag-f-dirty"),Ie=S=>{O=S,V&&(V.hidden=!S)},xt=d.querySelector(".mag-modal__main");xt.addEventListener("input",()=>Ie(!0)),xt.addEventListener("change",()=>{Ie(!0),ce()}),d.querySelector("#mag-f-color")?.addEventListener("input",()=>{Ie(!0),ce()});const Ue=S=>{O&&(S.preventDefault(),S.returnValue="")};window.addEventListener("beforeunload",Ue);let lt=!0;const Zt=p.subscribe(u.ROUTE_NAV_BEFORE,()=>{if(lt){if(O&&!confirm("Discard your changes to this magnet?")){window.router?.navigate("/magnets");return}m()}}),m=()=>{if(n&&!I&&e&&e.status==="DRAFT"){fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"}).catch(()=>{}),B.magnets=B.magnets.filter(P=>P.guid!==e.guid);const S=document.getElementById("mag-body");S&&(S.innerHTML=`<div class="mag-grid">${B.magnets.map(Ua).join("")}</div>`)}lt=!1,window.removeEventListener("beforeunload",Ue),p.unsubscribe(Zt),clearTimeout(we),Re.removeEventListener("change",Te),Y&&Y.destroy&&Y.destroy(),d.classList.remove("open"),setTimeout(()=>d.remove(),180),document.removeEventListener("keydown",$)},E=()=>{O&&!confirm("Discard your changes to this magnet?")||m()};function $(S){S.key==="Escape"&&(S.preventDefault(),E())}document.addEventListener("keydown",$),d.querySelector(".mag-modal__close").addEventListener("click",E),d.querySelector('[data-x="cancel"]').addEventListener("click",E),d.querySelector("[data-close-modal]")?.addEventListener("click",E),d.querySelector("#mag-f-name").focus();const H=d.querySelector("#mag-flow-panel");o?Yl(H,e,()=>{Ie(!0),ce()}):H.innerHTML='<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>',Oc(d,e),t&&k(t),le(),d.querySelectorAll(".mag-cta").forEach(S=>{const P=S.querySelector(".mag-cta__on"),oe=S.querySelector(".mag-cta__val"),X=S.querySelector(".mag-cta__opts"),$e=S.querySelectorAll(".mag-cta__booksrc, .mag-cta__calevent, .mag-cta__callsrc, .mag-cta__crtracker");P.addEventListener("change",()=>{oe&&(oe.disabled=!P.checked),X&&(X.disabled=!P.checked),$e.forEach(q=>{q.disabled=!P.checked}),P.checked&&(oe||X)?.focus()}),oe&&oe.addEventListener("input",()=>{oe.value.trim()&&!P.checked&&(P.checked=!0,X&&(X.disabled=!1))})}),d.querySelectorAll('.mag-cta[data-kind="book"]').forEach(S=>{const P=S.querySelector(".mag-cta__booksrc"),oe=S.querySelector(".mag-cta__val"),X=S.querySelector(".mag-cta__calevent");if(!P||!X)return;const $e=()=>{const q=P.value==="calendly";oe.hidden=q,X.hidden=!q,q&&!X.dataset.listed&&(X.dataset.listed="1",uc(X))};P.addEventListener("change",()=>{const q=S.querySelector(".mag-cta__on");q.checked||(q.checked=!0,q.dispatchEvent(new Event("change"))),$e()}),$e()}),d.querySelectorAll('.mag-cta[data-type="call"]').forEach(S=>{const P=S.querySelector(".mag-cta__callsrc"),oe=S.querySelector(".mag-cta__val"),X=S.querySelector(".mag-cta__crtracker");if(!P||!X)return;const $e=()=>{const q=P.value==="callrail";oe.hidden=q,X.hidden=!q,q&&!X.dataset.listed&&(X.dataset.listed="1",gc(X))};P.addEventListener("change",()=>{const q=S.querySelector(".mag-cta__on");q.checked||(q.checked=!0,q.dispatchEvent(new Event("change"))),$e()}),$e()});const M=d.querySelector("#mag-f-surface-on"),be=d.querySelector("#mag-f-surface");M.addEventListener("change",()=>be.hidden=!M.checked);const He=d.querySelector("#mag-f-inline-size");d.querySelectorAll('input[name="mag-display"]').forEach(S=>S.addEventListener("change",()=>{He.hidden=d.querySelector('input[name="mag-display"]:checked')?.value!=="inline"})),d.querySelector('[data-x="preview"]')?.addEventListener("click",()=>Qo(()=>xa({...e,...la(d),...o?{steps:Ln()}:{}}))),d.querySelector('[data-x="save"]').addEventListener("click",async S=>{const P=S.currentTarget,oe=d.querySelector("#mag-f-error"),X=d.querySelector("#mag-f-name").value.trim();if(!X){k("basics"),oe.textContent="Please give your magnet a name.";return}const $e=d.querySelector("#mag-f-domains").value.split(",").map(Q=>Q.trim()).filter(Boolean);let q="";if(d.querySelectorAll(".mag-cta").forEach(Q=>{const Xe=Q.querySelector(".mag-cta__on").checked;if(Q.dataset.kind==="book"){const dt=Q.querySelector(".mag-cta__booksrc")?.value==="calendly";Xe&&dt&&!Q.querySelector(".mag-cta__calevent")?.value&&(q=q||"Pick a Calendly event for the Book button, or switch it back to the built-in scheduler.");return}if(Q.dataset.kind!=="value")return;if(Q.dataset.type==="call"&&Q.querySelector(".mag-cta__callsrc")?.value==="callrail"){Xe&&!Q.querySelector(".mag-cta__crtracker")?.value&&(q=q||"Pick a CallRail tracking number for the Call button, or switch it back to a phone number.");return}const ct=Q.querySelector(".mag-cta__val").value.trim();Xe&&!ct&&(q=q||`Add a target for the ${ts[Q.dataset.type].label} button, or uncheck it.`)}),q){k("welcome"),oe.textContent=q;return}const qa=os(d);if(qa.enabled&&!Object.keys(qa.b).length){k("ab"),oe.textContent="Give variant B at least one change (title, welcome, or color), or untick the A/B test.";return}if(o){const Q=Kl();if(Q){k("flow"),Xl(Q.route,Q.message);return}}const ea={name:X,domains:$e,...la(d)};r&&(ea.owner_guid=d.querySelector("#mag-f-owner").value);const Va=o&&e.status==="DRAFT";Va&&(ea.status="ENABLED"),P.disabled=!0,oe.textContent="";try{const Q=o?`${J()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${J()}/m5t/v5/magnets`,Xe={"Content-Type":"application/json"};s&&(Xe["Idempotency-Key"]=s);const ct=await fetch(Q,{method:o?"PATCH":"POST",headers:Xe,body:JSON.stringify(ea)});let dt={};try{dt=await ct.json()}catch{}if(!ct.ok||!dt.ok)throw new Error(dt.message||`Save failed (${ct.status})`);o&&await Zl(e.guid),Oe(Va||!o?"Magnet created":"Magnet updated","success"),I=!0,m(),await wt()}catch(Q){P.disabled=!1,oe.textContent=Q.message||"Something went wrong."}})}const Pc=Object.freeze(Object.defineProperty({__proto__:null,cspNoteHTML:es,init:bc,openModal:zt,render:_c,stepFunnelHTML:ns},Symbol.toStringTag,{value:"Module"}));let Dn=!1;const A={leads:[],magnetNames:{},filter:"ALL",canManage:!1,book:!1,ownerNames:{},clientFilter:"ALL",search:"",shown:100,selectedId:null},vt=100,Ea=["NEW","WORKING","QUALIFIED","UNQUALIFIED","CONVERTED","EXPORTED"],Dc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},L=e=>String(e??"").replace(/[&<>"']/g,t=>Dc[t]),Gt=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},qt=()=>x.getConfig?.().BASE_URL||"",Vt=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",ss=e=>(Vt(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase(),za=e=>e.created?.created_tz||"";function tt(e){const t=za(e);if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric"})}catch{return""}}function Bc(e){const t=za(e);if(!t)return"";try{const a=Date.now()-new Date(t).getTime();if(a<0)return tt(e);const n=a/36e5;return n<1?`${Math.max(1,Math.floor(a/6e4))}m ago`:n<24?`${Math.floor(n)}h ago`:n<48?"Yesterday":tt(e)}catch{return tt(e)}}const Uc=e=>{const t=za(e);if(!t)return!1;try{return Date.now()-new Date(t).getTime()<24*36e5}catch{return!1}};function Hc(){if(Dn)return;const e=document.createElement("style");e.id="m5t-leads-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Dn=!0}function _t(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function zc(e){return`<select class="leads-status" data-id="${L(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${Ea.map(t=>`<option value="${t}" ${e.status===t?"selected":""}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join("")}
  </select>`}function Gc(e){const t=A.magnetNames[e.magnet_guid]||e.lead_source||"—",a=e.phone?String(e.phone).replace(/[^\d+]/g,""):"";return`
    <tr class="leads-row${String(e.id)===A.selectedId?" selected":""}" data-id="${L(e.id)}" tabindex="0" role="button" aria-label="Open lead ${L(Vt(e))}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${L(ss(e))}</span>
          <span><span class="leads-name">${L(Vt(e))}</span>${e.company?`<span class="leads-sub">${L(e.company)}</span>`:""}</span>
        </span>
      </td>
      ${A.book?`<td>${wo(A.ownerNames[e.owner_guid]||"")||'<span class="leads-muted">—</span>'}</td>`:""}
      <td>
      ...
      <td>${A.canManage?zc(e):`<span class="leads-badge" data-s="${L(e.status)}">${L(e.status)}</span>`}</td>
      <td class="num leads-muted" style="white-space:nowrap" title="${L(tt(e))}">${Uc(e)?'<span class="leads-fresh" title="Captured in the last 24 hours"></span>':""}${L(Bc(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}const rs=e=>A.clientFilter==="ALL"||e.owner_guid===A.clientFilter;function qc(e){const t=A.search.trim().toLowerCase();if(!t)return!0;const a=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,A.magnetNames[e.magnet_guid],A.book?A.ownerNames[e.owner_guid]:""].filter(Boolean).join(" ").toLowerCase();return t.split(/\s+/).every(n=>a.includes(n))}function is(){return A.leads.filter(e=>(A.filter==="ALL"||e.status===A.filter)&&rs(e)&&qc(e))}const ls=()=>_t("touch_app","Click to see lead information.");function Vc(){Hc(),rt();const e=ne();return`
    <div class="page-shell" data-section="leads">
      ...
      <div class="dashboard-card" style="margin-bottom:24px">
        ...
        <div class="card-body" id="pf-picker-body">${_t("hourglass_empty","Loading…")}</div>
      </div>`:""}
      <div class="page-header">
        <div class="page-header-text">
      ...
      <div class="leads-layout">
        ...
        <aside class="dashboard-card leads-panel" aria-label="Lead detail">
          <div class="card-body" id="leads-panel-body">${ls()}</div>
        </aside>
      </div>
    </div>`}async function jc(){if(document.getElementById("leads-export")?.addEventListener("click",Kc),ne()){const e=t=>Number(t||0).toLocaleString();it(qt(),[{h:"Leads · wk",td:t=>e(t.leads.this_week)},{h:"Leads · total",td:t=>e(t.leads.total)},{h:"Compl.",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Wc()}async function Wc(){const e=document.getElementById("leads-body");if(e){try{const[t,a]=await Promise.all([fetch(`${qt()}/m5t/v5/m5mLead`),fetch(`${qt()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(A.leads=(n.data||[]).filter(o=>!["DELETED","ARCHIVED"].includes(o.status)),A.book=ne(),A.ownerNames=A.book?yo():{},a){const o=await a.json().catch(()=>({}));A.magnetNames={},(o.magnets||[]).forEach(s=>{A.magnetNames[s.guid]=s.name,s.owner_guid&&s.owner_name&&!A.ownerNames[s.owner_guid]&&(A.ownerNames[s.owner_guid]=s.owner_name)}),A.canManage=!!o.canManage}}catch{e.innerHTML=_t("error","Could not load your leads. Please try again.");return}jt()}}const Yc=()=>`
  <colgroup>
    <col style="width:23%">
    ${A.book?'<col style="width:13%">':""}
    <col style="width:21%">
    <col style="width:14%">
    <col style="width:16%">
  ...
  </colgroup>`;function jt(){const e=document.getElementById("leads-body"),t=document.getElementById("leads-export");if(!e)return;if(t&&(t.style.display=A.leads.length?"":"none"),!A.leads.length){e.innerHTML=_t("inbox","No leads captured yet. Publish a magnet and share it to start collecting.");return}const a=A.leads.filter(rs),n={ALL:a.length};Ea.forEach(s=>{n[s]=a.filter(r=>r.status===s).length});const o=A.book?[...new Set(A.leads.map(s=>s.owner_guid).filter(Boolean))].map(s=>({guid:s,name:A.ownerNames[s]||s})).sort((s,r)=>s.name.localeCompare(r.name)):[];e.innerHTML=`
    <div class="leads-bar">
      <div class="leads-filter">
        ${["ALL",...Ea].map(s=>`<button data-filter="${s}" class="${A.filter===s?"active":""}">${s==="ALL"?"All":s[0]+s.slice(1).toLowerCase()}${n[s]?`<span class="leads-pillnum">${n[s]}</span>`:""}</button>`).join("")}
      </div>
      ${A.book&&o.length>1?`
      <select class="leads-clientsel" id="leads-clientsel" aria-label="Filter by client">
        <option value="ALL">All clients</option>
        ${o.map(s=>`<option value="${L(s.guid)}" ${A.clientFilter===s.guid?"selected":""}>${L(s.name)}</option>`).join("")}
      </select>`:""}
      <span class="leads-searchwrap">
        <span class="material-symbols-outlined" aria-hidden="true">search</span>
        <input class="leads-search" id="leads-search" type="search" placeholder="Search leads" value="${L(A.search)}" aria-label="Search leads" />
      </span>
      <span class="leads-count" id="leads-countlbl"></span>
    </div>
    <div id="leads-tablezone"></div>`,e.querySelector(".leads-filter")?.addEventListener("click",s=>{const r=s.target.closest("[data-filter]");r&&(A.filter=r.dataset.filter,A.shown=vt,jt())}),e.querySelector("#leads-clientsel")?.addEventListener("change",s=>{A.clientFilter=s.target.value,A.shown=vt,jt()}),e.querySelector("#leads-search")?.addEventListener("input",s=>{A.search=s.target.value,A.shown=vt,Sa()}),Sa()}function Sa(){const e=document.getElementById("leads-tablezone"),t=document.getElementById("leads-countlbl");if(!e)return;const a=is(),n=a.slice(0,A.shown),o=A.book?8:7;t&&(t.textContent=`${a.length} of ${A.leads.length}`),e.innerHTML=`
    <div class="leads-tablewrap">
      <table class="leads-table">
        ...
        <tbody id="leads-tbody">${n.map(Gc).join("")||`<tr><td colspan="${o}"><div class="leads-muted" style="padding:14px 4px">${A.search.trim()?"No leads match your search.":`No ${A.filter.toLowerCase()} leads.`}</div></td></tr>`}</tbody>
      </table>
    </div>
    ${a.length>A.shown?`<button class="leads-more" type="button" id="leads-more">Show ${Math.min(vt,a.length-A.shown)} more (${a.length-A.shown} remaining)</button>`:""}`,e.querySelector("#leads-more")?.addEventListener("click",()=>{A.shown+=vt,Sa()}),e.querySelector("#leads-tbody")?.addEventListener("change",Jc),e.querySelector("#leads-tbody")?.addEventListener("click",s=>{if(s.target.closest(".leads-status, a.leads-contactlink"))return;const r=s.target.closest(".leads-row");r&&Bn(r.dataset.id)}),e.querySelector("#leads-tbody")?.addEventListener("keydown",s=>{if(s.key!=="Enter"&&s.key!==" ")return;const r=s.target.closest(".leads-row");r&&s.target===r&&(s.preventDefault(),Bn(r.dataset.id))})}async function Jc(e){const t=e.target.closest(".leads-status");if(!t)return;const a=t.dataset.id,n=A.leads.find(r=>String(r.id)===String(a)),o=t.value,s=n?.status;try{if(!(await(await fetch(`${qt()}/m5t/v5/m5mLead/${encodeURIComponent(a)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:o})})).json().catch(()=>({}))).ok)throw new Error;n&&(n.status=o),Gt(`Marked ${o[0]}${o.slice(1).toLowerCase()}`,"success")}catch{t.value=s||"NEW",Gt("Could not update status","danger");return}try{String(a)===A.selectedId&&ps(),A.filter!=="ALL"&&jt()}catch(r){console.warn("[leads] re-render after status change failed:",r)}}function Bn(e){A.selectedId=String(e),document.querySelectorAll(".leads-row").forEach(t=>t.classList.toggle("selected",t.dataset.id===A.selectedId)),ps()}function At(e,t){const a=Array.isArray(e.tags)?e.tags:[];for(let n=a.length-1;n>=0;n--)if(a[n]&&a[n].tag===t&&a[n].value!=null)return String(a[n].value);return""}function cs(e){const t=At(e,"appointment_start");if(!t)return null;const a=At(e,"appointment_status")||"booked",n=At(e,"appointment_timezone"),o=At(e,"appointment_event_type"),s=new Date(t);let r=t;if(!Number.isNaN(s.getTime())){const i={weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"};try{r=new Intl.DateTimeFormat(void 0,n?{...i,timeZone:n}:i).format(s)}catch{r=new Intl.DateTimeFormat(void 0,i).format(s)}}return{when:r,status:a,type:o,start:t}}const Un={booked:["QUALIFIED","Booked"],rescheduled:["WORKING","Rescheduled"],canceled:["CANCELED","Canceled"]};function ds(e){const t=Array.isArray(e.tags)?e.tags:[];let a=null;for(const l of t)if(!(!l||!l.tag)){if(l.tag==="callrail_call_id"){a={};continue}a&&l.tag.indexOf("call_")===0&&l.value!=null&&(a[l.tag]=String(l.value))}if(!a||!a.call_started)return null;const n=a.call_started,o=new Date(n);let s=n;Number.isNaN(o.getTime())||(s=new Intl.DateTimeFormat(void 0,{weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"}).format(o));const r=Number(a.call_duration)||0,i=r?r<60?`${r}s`:`${Math.floor(r/60)}m ${r%60}s`:"";return{when:s,dur:i,source:a.call_source||"",answered:a.call_answered||"",recording:a.call_recording_player||"",started:n}}function ps(){const e=document.getElementById("leads-panel-body");if(!e)return;const t=A.leads.find(l=>String(l.id)===A.selectedId);if(!t){e.innerHTML=ls();return}const a=A.magnetNames[t.magnet_guid]||t.lead_source||"—",n=cs(t),[o,s]=n?Un[n.status]||Un.booked:["",""],r=ds(t),i=(l,c)=>c?`<div class="leads-det__field"><span class="leads-det__k">${L(l)}</span><span class="leads-det__v">${L(c)}</span></div>`:"";e.innerHTML=`
    <div class="leads-det__head">
      <span class="leads-avatar leads-det__ava">${L(ss(t))}</span>
      <div>
        <div class="leads-det__name">${L(Vt(t))}</div>
    ...
    ${t.description?`<div class="leads-det__notes">${L(t.description)}</div>`:""}`}function Kc(){const e=is();if(!e.length){Gt("Nothing to export","info");return}const t=["first_name","last_name","email","phone","company","product_interest","lead_source","utm_source","utm_medium","utm_campaign","gclid","status"],a=l=>`"${String(l??"").replace(/"/g,'""')}"`,o=[[...A.book?["client"]:[],...t,"magnet","captured","appointment","last_call"].join(",")];for(const l of e){const c=cs(l),g=ds(l);o.push([...A.book?[a(A.ownerNames[l.owner_guid]||"")]:[],...t.map(b=>a(l[b])),a(A.magnetNames[l.magnet_guid]||l.lead_source||""),a(tt(l)),a(c?`${c.start} (${c.status})`:""),a(g?`${g.started} (${g.answered==="no"?"missed":"answered"})`:"")].join(","))}const s=new Blob([o.join(`
`)],{type:"text/csv"}),r=URL.createObjectURL(s),i=document.createElement("a");i.href=r,i.download=`leads-${A.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r),Gt(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const Xc=Object.freeze(Object.defineProperty({__proto__:null,init:jc,render:Vc},Symbol.toStringTag,{value:"Module"})),us=()=>x.getConfig?.().BASE_URL||"",Hn=e=>e.toISOString().slice(0,10),zn=e=>e==null?"—":"$"+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),et=e=>Number(e||0).toLocaleString(),Qc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},kt=e=>String(e??"").replace(/[&<>"']/g,t=>Qc[t]);let Gn=!1;function Zc(){if(Gn)return;const e=document.createElement("style");e.id="m5t-adperf-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Gn=!0}const at=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Ct=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
  ...
  </div>`,ed=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let Wt=30;function ms(){return ne()?bt({section:"ad-performance",title:"Ad Performance",description:"Pick a client to view their spend and lead performance."}):(Zc(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${ed.map(e=>`<button class="chart-period-btn${e.d===Wt?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-body">
          ${at("hourglass_empty","Loading ad performance…")}
        </div>
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-sources">
          ${at("hourglass_empty","Loading…")}
        </div>
      </div>
    </div>`)}async function gs(){if(ne()){const t=a=>Number(a||0).toLocaleString();return it(us(),[{h:"Spend",td:a=>a.ad?`$${t(a.ad.spend)}`:"—"},{h:"Clicks",td:a=>a.ad?t(a.ad.clicks):"—"},{h:"Leads",td:a=>t(a.leads.window??a.leads.total)},{h:"CPL",td:a=>a.ad?.cost_per_lead!=null?`$${t(a.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see spend here."})}const e=document.getElementById("adperf-periods");e?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(Wt=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===Wt)),qn())}),await qn()}async function qn(){const e=us(),t=document.getElementById("adperf-body"),a=document.getElementById("adperf-range"),n=new Date,o=Hn(n),s=Hn(new Date(n.getTime()-(Wt-1)*864e5));a&&(a.textContent=`${s} → ${o}`);let r,i=[],l=null;try{const[g,b,y]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${s}&to=${o}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${s}&to=${o}`)]);if(!g.ok)throw new Error(`HTTP ${g.status}`);r=await g.json(),i=((await b.json().catch(()=>({})))?.data||[]).filter(w=>w.status!=="DELETED"),l=await y.json().catch(()=>null)}catch(g){console.warn("[ad-performance] load failed:",g),t&&(t.innerHTML=at("error","Could not load ad performance. Please try again."));return}const c=r.totals||{};if(Tt("adperf-spend",zn(c.spend)),Tt("adperf-clicks",et(c.clicks)),Tt("adperf-leads",et(c.magnet_leads)),Tt("adperf-cpl",zn(c.cost_per_lead)),td(l),!i.length){t.innerHTML=at("link_off","No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.");return}if(!r.connected){t.innerHTML=at("cloud_sync","Account connected. No ad data for this range yet. Metrics appear here once they sync.");return}t.innerHTML=ad(r.rows||[])}function td(e){const t=document.getElementById("adperf-sources"),a=document.getElementById("adperf-src-summary");if(!t)return;const n=e&&Array.isArray(e.rows)?e.rows:[];if(!n.length){a&&(a.textContent=""),t.innerHTML=at("search_off","No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.");return}const o=e.total_leads||n.reduce((i,l)=>i+(l.leads||0),0),s=e.tracked_leads||0;a&&(a.textContent=`${et(s)} of ${et(o)} leads tagged to a source`);const r=i=>i.campaign&&i.campaign!=="(none)"?kt(i.campaign):i.source&&i.source!=="(direct)"?kt(i.source):'<span class="adperf-src-untracked">Untracked / direct</span>';t.innerHTML=`
      ...
      <table class="adperf-srctable">
        ...
        <tbody>${n.map(i=>`
          <tr>
            ...
            <td class="num">${i.paid_clicks?et(i.paid_clicks):'<span class="adperf-src-sub">—</span>'}</td>
            <td class="num"><b>${et(i.leads)}</b></td>
          </tr>`).join("")}
        </tbody>
      </table>
    </div>`}function Tt(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}function Vn(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}function jn(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e)}function ad(e){const _=e.length||1,w=Vn(Math.max(1,...e.map(O=>O.spend||0))),d=Vn(Math.max(1,...e.map(O=>O.magnet_leads||0))),h=738/_,v=Math.min(24,h*.55),k=O=>56+h*(O+.5),N=O=>304-O/w*282,U=O=>304-O/d*282,ae=[0,.25,.5,.75,1].map(O=>{const I=304-O*282;return`<line x1="56" y1="${I.toFixed(1)}" x2="794" y2="${I.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${(I+3.5).toFixed(1)}" text-anchor="end" class="ax">$${jn(w*O)}</text><text x="802" y="${(I+3.5).toFixed(1)}" text-anchor="start" class="ax">${jn(d*O)}</text>`}).join(""),Y=e.map((O,I)=>{const V=N(O.spend||0);return`<rect x="${(k(I)-v/2).toFixed(1)}" y="${V.toFixed(1)}" width="${v.toFixed(1)}" height="${Math.max(0,304-V).toFixed(1)}" rx="3" fill="#0072BA"><title>${O.date}: $${O.spend} spend</title></rect>`}).join(""),le=e.map((O,I)=>`${k(I).toFixed(1)},${U(O.magnet_leads||0).toFixed(1)}`).join(" "),we=_>1?`<polyline points="${le}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",ce=e.map((O,I)=>`<circle cx="${k(I).toFixed(1)}" cy="${U(O.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${O.date}: ${O.magnet_leads} leads</title></circle>`).join(""),Re=Math.max(1,Math.ceil(_/6)),Te=e.map((O,I)=>I%Re===0||I===_-1?`<text x="${k(I).toFixed(1)}" y="326" text-anchor="middle" class="ax">${O.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="adperf-chart" viewBox="0 0 840 340" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Ad spend versus magnet leads over time">
      ${ae}${Y}${we}${ce}${Te}
    </svg>`}const nd={render:ms,init:gs},od=Object.freeze(Object.defineProperty({__proto__:null,default:nd,init:gs,render:ms},Symbol.toStringTag,{value:"Module"})),Wn="reseller_org",hs="managed_client";let Yn=!1;const sd={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},K=e=>String(e??"").replace(/[&<>"']/g,t=>sd[t]);function Yt(e,t="info"){try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}}function rd(){const e=x.getActiveOrg();if(e&&e.channel===Wn)return{guid:e.guid,name:e.name};const t=x.getMemberships().find(a=>a.channel===Wn);return t?{guid:t.orgGuid,name:t.name}:null}function id(e){const t=e?.created_tz;if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function ld(){if(Yn)return;const e=document.createElement("style");e.id="m5t-clients-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Yn=!0}const cd=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Rt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function dd(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
    <div class="client-row">
      <span class="client-row__avatar">${K(cd(t))}</span>
      <span class="client-row__main">
        <div class="client-row__name" title="${K(t)}">${K(t)}</div>
        <div class="client-row__meta">Added ${K(id(e.created))||"—"}</div>
      </span>
      <span class="client-row__status" data-status="${K(a)}">${K(a)}</span>
      <div class="client-row__btns">
        <button class="client-card__invite" type="button" data-action="invite" data-client-guid="${K(e.guid)}" data-client-name="${K(t)}">
        ...
        <button class="client-card__invite" type="button" data-action="adaccounts" data-client-guid="${K(e.guid)}" data-client-name="${K(t)}">
          <span class="material-symbols-outlined" aria-hidden="true">ads_click</span> Ad accounts
        </button>`:""}
      </div>
    </div>`}function fs(){return ld(),`
    <div class="page-shell" data-section="clients">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="clients-body">
          ${Rt("hourglass_empty","Loading clients…")}
        </div>
      </div>
    </div>`}async function vs(){const e=rd();document.getElementById("clients-add-btn")?.addEventListener("click",()=>pd(e)),await _s(e)}async function _s(e){const t=document.getElementById("clients-body"),a=document.getElementById("clients-count");if(t){if(!e?.guid){t.innerHTML=Rt("info","Client provisioning is available to reseller / agency accounts."),a&&(a.textContent="");return}try{const n=x.getConfig?.().BASE_URL||"",o=await fetch(`${n}/m5t/v5/acctGroup`);if(!o.ok)throw new Error(`HTTP ${o.status}`);const s=await o.json(),i=(Array.isArray(s?.data)?s.data:[]).filter(l=>l.class===hs&&(!l.parent||l.parent===e.guid));if(!i.length){t.innerHTML=Rt("group_off","No clients yet. Add your first client to start managing magnets on their behalf."),a&&(a.textContent="");return}t.innerHTML=`<div class="client-list">${i.map(dd).join("")}</div>`,a&&(a.textContent=`${i.length} client${i.length===1?"":"s"}`),t.querySelectorAll(".client-card__invite").forEach(l=>{l.addEventListener("click",()=>{l.dataset.action==="adaccounts"?ud(l.dataset.clientGuid,l.dataset.clientName):md(l.dataset.clientGuid,l.dataset.clientName)})})}catch(n){console.warn("[clients] load failed:",n),t.innerHTML=Rt("error","Couldn’t load clients. Please try again."),a&&(a.textContent="")}}}function pd(e){if(!e?.guid){Yt("Only reseller / agency accounts can add clients.","error");return}const t=document.createElement("div");t.className="client-modal-scrim";const a=document.createElement("div");a.className="client-modal",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
    ...
    <div class="client-modal__body">
      <p class="client-modal__sub">Creates a managed client under <strong>${K(e.name||"your agency")}</strong>. You'll manage their magnets and leads on their behalf.</p>
    ...
    <div class="client-modal__body">
      ...
      <input class="client-modal__input" id="aa-gads" type="text" inputmode="numeric" placeholder="123-456-7890" autocomplete="off" value="${K(o?.external_customer_id||"")}" />
      ...
      <input class="client-modal__input" id="aa-lsa" type="text" inputmode="numeric" placeholder="Optional" autocomplete="off" value="${K(s?.external_customer_id||"")}" />
    ...
    </div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add("open"),i.classList.add("open")});const l=i.querySelector("#aa-error"),c=i.querySelector('[data-act="save"]'),g=()=>{r.classList.remove("open"),i.classList.remove("open"),document.removeEventListener("keydown",b),setTimeout(()=>{r.remove(),i.remove()},200)},b=w=>{w.key==="Escape"&&g()};document.addEventListener("keydown",b),r.addEventListener("click",g),i.querySelector(".client-modal__close")?.addEventListener("click",g),i.querySelector('[data-act="cancel"]')?.addEventListener("click",g);const y=(w,d,h)=>{const v=`${a}/m5t/v5/coreAdAccount`;return d&&!h?fetch(v,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,provider:w,external_customer_id:d})}):d&&h&&d!==h.external_customer_id?fetch(`${v}/${encodeURIComponent(h.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({external_customer_id:d})}):!d&&h?fetch(`${v}/${encodeURIComponent(h.guid)}`,{method:"DELETE"}):null},_=async()=>{l.textContent="";const w=Jn(i.querySelector("#aa-gads").value),d=Jn(i.querySelector("#aa-lsa").value),h=[y("google_ads",w,o),y("google_lsa",d,s)].filter(Boolean);if(!h.length){g();return}c.disabled=!0;const v=c.innerHTML;c.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const k=await Promise.all(h);for(const N of k)if(!N.ok){const U=await N.json().catch(()=>({}));throw new Error(N.status===403?"You are not authorized to connect accounts for this client.":U?.error||U?.message||`Failed (HTTP ${N.status})`)}Yt("Ad accounts updated","success"),g()}catch(k){l.textContent=k.message||"Something went wrong. Please try again.",c.disabled=!1,c.innerHTML=v}};c?.addEventListener("click",_)}function md(e,t){if(!e)return;const a=document.createElement("div");a.className="client-modal-scrim";const n=document.createElement("div");n.className="client-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="invite-body">
      ...
      <p class="client-modal__sub">Invite someone at <strong>${K(t||"this client")}</strong> to a read-only login for their account.</p>
      ...
      <div class="client-modal__actions">
    ...
    </div>`,document.body.appendChild(a),document.body.appendChild(n),requestAnimationFrame(()=>{a.classList.add("open"),n.classList.add("open")});const o=()=>{a.classList.remove("open"),n.classList.remove("open"),document.removeEventListener("keydown",s),setTimeout(()=>{a.remove(),n.remove()},200)},s=g=>{g.key==="Escape"&&o()};document.addEventListener("keydown",s),a.addEventListener("click",o),n.querySelector(".client-modal__close")?.addEventListener("click",o),n.querySelector('[data-act="cancel"]')?.addEventListener("click",o);const r=n.querySelector("#inv-email"),i=n.querySelector("#inv-error"),l=n.querySelector('[data-act="send"]');r?.focus();const c=g=>g.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(g.dataset.url),g.textContent="Copied!",setTimeout(()=>{g.textContent="Copy link"},1500)}catch{}});(async function(){const b=n.querySelector("#invite-pending");if(b)try{const y=x.getConfig?.().BASE_URL||"",_=await fetch(`${y}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invites`),w=await _.json().catch(()=>({})),d=_.ok&&w.ok&&Array.isArray(w.invites)?w.invites:[];if(!d.length){b.innerHTML="";return}b.innerHTML=`
        <div class="invite-pending">
          <div class="invite-pending__label">Pending invites</div>
          ${d.map(h=>`
            <div class="invite-pending__row">
              <span class="invite-pending__email${h.expired?" expired":""}" title="${K(h.email)}">${K(h.email)}${h.expired?" · expired":""}</span>
              <button class="client-modal__btn client-modal__btn--ghost invite-pending__copy" type="button" data-url="${K(h.inviteUrl)}">Copy link</button>
            </div>`).join("")}
        </div>`,b.querySelectorAll(".invite-pending__copy").forEach(c)}catch{b.innerHTML=""}})(),l?.addEventListener("click",async()=>{const g=(n.querySelector("#inv-email").value||"").trim(),b=(n.querySelector("#inv-first").value||"").trim(),y=(n.querySelector("#inv-last").value||"").trim();if(i.textContent="",!g||!b||!y){i.textContent="Email, first, and last name are required.";return}l.disabled=!0;const _=l.innerHTML;l.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Sending…';try{const w=x.getConfig?.().BASE_URL||"",d=await fetch(`${w}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:g,first:b,last:y})}),h=await d.json().catch(()=>({}));if(!d.ok||!h.ok){const k=d.status===409?"A user with that email already exists.":d.status===403?"You are not authorized to invite for this client.":h.message||h.error||`Failed (HTTP ${d.status})`;throw new Error(k)}Yt(`Invite created for ${g}`,"success"),n.querySelector("#invite-body").innerHTML=`
        <div class="client-modal__result">
          ...
          <p>${h.emailQueued?`An invite email is on its way to <strong>${K(g)}</strong>.`:`Invite created for <strong>${K(g)}</strong>.`}</p>
          ...
          <div class="client-modal__linkrow">
            <input class="client-modal__input" id="inv-link" type="text" readonly value="${K(h.inviteUrl)}" />
        ...
        </div>`;const v=n.querySelector("#inv-link");n.querySelector("#inv-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(v.value),n.querySelector("#inv-copy").textContent="Copied!"}catch{v.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",o)}catch(w){console.warn("[clients] invite failed:",w),i.textContent=w.message||"Something went wrong. Please try again.",l.disabled=!1,l.innerHTML=_}})}const gd={render:fs,init:vs},hd=Object.freeze(Object.defineProperty({__proto__:null,default:gd,init:vs,render:fs},Symbol.toStringTag,{value:"Module"})),Kn="managed_client";let Xn=!1;const fd={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},de=e=>String(e??"").replace(/[&<>"']/g,t=>fd[t]),Qn=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},vd=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function _d(){const e=x.getActiveOrg();let t=e&&e.channel!==Kn?e:null;if(!t){const n=x.getMemberships().find(o=>o.channel!==Kn);n&&(t={guid:n.orgGuid,channel:n.channel,memberRole:n.memberRole})}if(!t)return null;const a=x.getMemberships().find(n=>n.orgGuid===t.guid)?.name;return{...t,name:a}}function bd(e){return Object.values(ht).filter(t=>ur(e,t.value)).sort((t,a)=>a.rank-t.rank)}function yd(){if(Xn)return;const e=document.createElement("style");e.id="m5t-team-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Xn=!0}function Jt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function wd(e){const t=e.member_role||"member";return`
    <div class="team-row">
      <span class="team-avatar">${de(vd(e.name||e.email))}</span>
      <span class="team-main">
        <div class="team-name">${de(e.name||e.email)}${e.verified?"":' · <span style="color:var(--color-text-subtle,#6C7C9A);font-weight:400;">pending verification</span>'}</div>
        <div class="team-email" title="${de(e.email)}">${de(e.email)}</div>
      </span>
      <span class="team-role" data-role="${de(t)}">${de(ht[t]?.label||t)}</span>
    </div>`}function bs(){return yd(),`
    ...
    <div class="team-modal__body" id="team-invite-body">
      <p class="team-modal__sub">They'll get a link to set a password and join <strong>${de(e.name||"your workspace")}</strong>.</p>
      ...
      <select class="team-modal__select" id="tm-role">
        ${t.map(l=>`<option value="${l.value}"${l.value==="member"?" selected":""}>${de(l.label)}</option>`).join("")}
      </select>
      ...
      <div class="team-modal__actions">
        ...
        </div>`;const h=n.querySelector("#tm-link");n.querySelector("#tm-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(h.value),n.querySelector("#tm-copy").textContent="Copied!"}catch{h.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",()=>{o(),Ga(e)})}catch(_){console.warn("[team] invite failed:",_),r.textContent=_.message||"Something went wrong. Please try again.",i.disabled=!1,i.innerHTML=y}})}const Ed={render:bs,init:ys},Sd=Object.freeze(Object.defineProperty({__proto__:null,default:Ed,init:ys,loadTeam:Ga,render:bs},Symbol.toStringTag,{value:"Module"}));
