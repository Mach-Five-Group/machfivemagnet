var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t,n)=>()=>{if(n)throw n[0];try{return e&&(t=e(e=0)),t}catch(e){throw n=[e],e}},s=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),c=(e,n)=>{let r={};for(var i in e)t(r,i,{get:e[i],enumerable:!0});return n||t(r,Symbol.toStringTag,{value:`Module`}),r},l=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},u=(n,r,o)=>(o=n==null?{}:e(i(n)),l(r||!n||!n.__esModule||!a.call(n,`default`)?t(o,`default`,{value:n,enumerable:!0}):o,n));(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var d=s(((e,t)=>{(function(n,r){typeof e==`object`&&typeof t==`object`?t.exports=r():typeof define==`function`&&define.amd?define(`Navigo`,[],r):typeof e==`object`?e.Navigo=r():n.Navigo=r()})(typeof self<`u`?self:e,(function(){return function(){var e={407:function(e,t,n){n.d(t,{default:function(){return me}});var r=/([:*])(\w+)/g,i=/\*/g,a=/\/\?/g;function o(e){return e===void 0&&(e=`/`),h()?location.pathname+location.search+location.hash:e}function s(e){return e.replace(/\/+$/,``).replace(/^\/+/,``)}function c(e){return typeof e==`string`}function l(e){return e&&e.indexOf(`#`)>=0&&e.split(`#`).pop()||``}function u(e){var t=s(e).split(/\?(.*)?$/);return[s(t[0]),t.slice(1).join(``)]}function d(e){for(var t={},n=e.split(`&`),r=0;r<n.length;r++){var i=n[r].split(`=`);if(i[0]!==``){var a=decodeURIComponent(i[0]);t[a]?(Array.isArray(t[a])||(t[a]=[t[a]]),t[a].push(decodeURIComponent(i[1]||``))):t[a]=decodeURIComponent(i[1]||``)}}return t}function f(e,t){var n,o=u(s(e.currentLocationPath)),f=o[0],p=o[1],m=p===``?null:d(p),h=[];if(c(t.path)){if(n=`(?:/^|^)`+s(t.path).replace(r,(function(e,t,n){return h.push(n),`([^/]+)`})).replace(i,`?(?:.*)`).replace(a,`/?([^/]+|)`)+`$`,s(t.path)===``&&s(f)===``)return{url:f,queryString:p,hashString:l(e.to),route:t,data:null,params:m}}else n=t.path;var g=new RegExp(n,``),_=f.match(g);if(_){var v=c(t.path)?function(e,t){return t.length===0?null:e?e.slice(1,e.length).reduce((function(e,n,r){return e===null&&(e={}),e[t[r]]=decodeURIComponent(n),e}),null):null}(_,h):_.groups?_.groups:_.slice(1);return{url:s(f.replace(RegExp(`^`+e.instance.root),``)),queryString:p,hashString:l(e.to),route:t,data:v,params:m}}return!1}function p(){return!(typeof window>`u`||!window.history||!window.history.pushState)}function m(e,t){return e[t]===void 0||!0===e[t]}function h(){return typeof window<`u`}function g(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter((function(e){return e})).forEach((function(e){[`before`,`after`,`already`,`leave`].forEach((function(n){e[n]&&(t[n]||(t[n]=[]),t[n].push(e[n]))}))})),t}function _(e,t,n){var r=t||{},i=0;(function t(){e[i]?Array.isArray(e[i])?(e.splice.apply(e,[i,1].concat(e[i][0](r)?e[i][1]:e[i][2])),t()):e[i](r,(function(e){e===void 0||!0===e?(i+=1,t()):n&&n(r)})):n&&n(r)})()}function v(e,t){e.currentLocationPath===void 0&&(e.currentLocationPath=e.to=o(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function y(e,t){for(var n=0;n<e.instance.routes.length;n++){var r=f(e,e.instance.routes[n]);if(r&&(e.matches||=[],e.matches.push(r),e.resolveOptions.strategy===`ONE`))return void t()}t()}function ee(e,t){e.navigateOptions&&(e.navigateOptions.shouldResolve!==void 0&&console.warn(`"shouldResolve" is deprecated. Please check the documentation.`),e.navigateOptions.silent!==void 0&&console.warn(`"silent" is deprecated. Please check the documentation.`)),t()}function te(e,t){!0===e.navigateOptions.force?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}_.if=function(e,t,n){return Array.isArray(t)||(t=[t]),Array.isArray(n)||(n=[n]),[e,t,n]};var ne=h(),re=p();function ie(e,t){if(m(e.navigateOptions,`updateBrowserURL`)){var n=(`/`+e.to).replace(/\/\//g,`/`),r=ne&&e.resolveOptions&&!0===e.resolveOptions.hash;re?(history[e.navigateOptions.historyAPIMethod||`pushState`](e.navigateOptions.stateObj||{},e.navigateOptions.title||``,r?`#`+n:n),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout((function(){if(!r){var t=location.hash;location.hash=``,location.hash=t}e.instance.__freezeListening=!1}),1))):ne&&(window.location.href=e.to)}t()}function ae(e,t){var n=e.instance;n.lastResolved()?_(n.lastResolved().map((function(t){return function(n,r){if(t.route.hooks&&t.route.hooks.leave){var i=!1,a=e.instance.matchLocation(t.route.path,e.currentLocationPath,!1);i=t.route.path===`*`?!(e.matches&&e.matches.find((function(e){return t.route.path===e.route.path}))):!a,m(e.navigateOptions,`callHooks`)&&i?_(t.route.hooks.leave.map((function(t){return function(n,r){return t((function(t){!1===t?e.instance.__markAsClean(e):r()}),e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}})).concat([function(){return r()}])):r()}else r()}})),{},(function(){return t()})):t()}function oe(e,t){m(e.navigateOptions,`updateState`)&&e.instance._setCurrent(e.matches),t()}var se=[function(e,t){var n=e.instance.lastResolved();if(n&&n[0]&&n[0].route===e.match.route&&n[0].url===e.match.url&&n[0].queryString===e.match.queryString)return n.forEach((function(t){t.route.hooks&&t.route.hooks.already&&m(e.navigateOptions,`callHooks`)&&t.route.hooks.already.forEach((function(t){return t(e.match)}))})),void t(!1);t()},function(e,t){e.match.route.hooks&&e.match.route.hooks.before&&m(e.navigateOptions,`callHooks`)?_(e.match.route.hooks.before.map((function(t){return function(n,r){return t((function(t){!1===t?e.instance.__markAsClean(e):r()}),e.match)}})).concat([function(){return t()}])):t()},function(e,t){m(e.navigateOptions,`callHandler`)&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()},function(e,t){e.match.route.hooks&&e.match.route.hooks.after&&m(e.navigateOptions,`callHooks`)&&e.match.route.hooks.after.forEach((function(t){return t(e.match)})),t()}],ce=[ae,function(e,t){var n=e.instance._notFoundRoute;if(n){e.notFoundHandled=!0;var r=u(e.currentLocationPath),i=r[0],a=r[1],o=l(e.to);n.path=s(i);var c={url:n.path,queryString:a,hashString:o,data:null,route:n,params:a===``?null:d(a)};e.matches=[c],e.match=c}t()},_.if((function(e){return e.notFoundHandled}),se.concat([oe]),[function(e,t){e.resolveOptions&&!1!==e.resolveOptions.noMatchWarning&&e.resolveOptions.noMatchWarning!==void 0||console.warn(`Navigo: "`+e.currentLocationPath+`" didn't match any of the registered routes.`),t()},function(e,t){e.instance._setCurrent(null),t()}])];function le(){return(le=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}function ue(e,t){var n=0;ae(e,(function r(){n===e.matches.length?oe(e,t):_(se,le({},e,{match:e.matches[n]}),(function(){n+=1,r()}))}))}function de(e){e.instance.__markAsClean(e)}function fe(){return(fe=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}var pe=`[data-navigo]`;function me(e,t){var n,r=t||{strategy:`ONE`,hash:!1,noMatchWarning:!1,linksSelector:pe},i=this,a=`/`,m=null,ne=[],re=!1,ae=p(),oe=h();function se(e){return e.indexOf(`#`)>=0&&(e=!0===r.hash?e.split(`#`)[1]||`/`:e.split(`#`)[0]),e}function le(e){return s(a+`/`+s(e))}function me(e,t,n,r){return e=c(e)?le(e):e,{name:r||s(String(e)),path:e,handler:t,hooks:g(n)}}function he(e,t){if(!i.__dirty){i.__dirty=!0,e=e?s(a)+`/`+s(e):void 0;var n={instance:i,to:e,currentLocationPath:e,navigateOptions:{},resolveOptions:fe({},r,t)};return _([v,y,_.if((function(e){var t=e.matches;return t&&t.length>0}),ue,ce)],n,de),!!n.matches&&n.matches}i.__waiting.push((function(){return i.resolve(e,t)}))}function ge(e,t){if(i.__dirty)i.__waiting.push((function(){return i.navigate(e,t)}));else{i.__dirty=!0,e=s(a)+`/`+s(e);var n={instance:i,to:e,navigateOptions:t||{},resolveOptions:t&&t.resolveOptions?t.resolveOptions:r,currentLocationPath:se(e)};_([ee,te,y,_.if((function(e){var t=e.matches;return t&&t.length>0}),ue,ce),ie,de],n,de)}}function _e(){if(oe)return(oe?[].slice.call(document.querySelectorAll(r.linksSelector||pe)):[]).forEach((function(e){e.getAttribute(`data-navigo`)!==`false`&&e.getAttribute(`target`)!==`_blank`?e.hasListenerAttached||(e.hasListenerAttached=!0,e.navigoHandler=function(t){if((t.ctrlKey||t.metaKey)&&t.target.tagName.toLowerCase()===`a`)return!1;var n=e.getAttribute(`href`);if(n==null)return!1;if(n.match(/^(http|https)/)&&typeof URL<`u`)try{var r=new URL(n);n=r.pathname+r.search}catch{}var a=function(e){if(!e)return{};var t,n=e.split(`,`),r={};return n.forEach((function(e){var n=e.split(`:`).map((function(e){return e.replace(/(^ +| +$)/g,``)}));switch(n[0]){case`historyAPIMethod`:r.historyAPIMethod=n[1];break;case`resolveOptionsStrategy`:t||={},t.strategy=n[1];break;case`resolveOptionsHash`:t||={},t.hash=n[1]===`true`;break;case`updateBrowserURL`:case`callHandler`:case`updateState`:case`force`:r[n[0]]=n[1]===`true`}})),t&&(r.resolveOptions=t),r}(e.getAttribute(`data-navigo-options`));re||(t.preventDefault(),t.stopPropagation(),i.navigate(s(n),a))},e.addEventListener(`click`,e.navigoHandler)):e.hasListenerAttached&&e.removeEventListener(`click`,e.navigoHandler)})),i}function ve(e,t,n){var r=ne.find((function(t){return t.name===e})),i=null;if(r){if(i=r.path,t)for(var o in t)i=i.replace(`:`+o,t[o]);i=i.match(/^\//)?i:`/`+i}return i&&n&&!n.includeRoot&&(i=i.replace(RegExp(`^/`+a),``)),i}function b(e){var t=u(s(e)),r=t[0],i=t[1],a=i===``?null:d(i);return{url:r,queryString:i,hashString:l(e),route:me(r,(function(){}),[n],r),data:null,params:a}}function ye(e,t,n){return typeof t==`string`&&(t=be(t)),t?(t.hooks[e]||(t.hooks[e]=[]),t.hooks[e].push(n),function(){t.hooks[e]=t.hooks[e].filter((function(e){return e!==n}))}):(console.warn(`Route doesn't exists: `+t),function(){})}function be(e){return typeof e==`string`?ne.find((function(t){return t.name===le(e)})):ne.find((function(t){return t.handler===e}))}e?a=s(e):console.warn(`Navigo requires a root path in its constructor. If not provided will use "/" as default.`),this.root=a,this.routes=ne,this.destroyed=re,this.current=m,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=function(e){e.instance.__dirty=!1,e.instance.__waiting.length>0&&e.instance.__waiting.shift()()},this.on=function(e,t,r){var i=this;return typeof e!=`object`||e instanceof RegExp?(typeof e==`function`&&(r=t,t=e,e=a),ne.push(me(e,t,[n,r])),this):(Object.keys(e).forEach((function(t){if(typeof e[t]==`function`)i.on(t,e[t]);else{var r=e[t],a=r.uses,o=r.as,s=r.hooks;ne.push(me(t,a,[n,s],o))}})),this)},this.off=function(e){return this.routes=ne=ne.filter((function(t){return c(e)?s(t.path)!==s(e):typeof e==`function`?e!==t.handler:String(t.path)!==String(e)})),this},this.resolve=he,this.navigate=ge,this.navigateByName=function(e,t,n){var r=ve(e,t);return r!==null&&(ge(r.replace(RegExp(`^/?`+a),``),n),!0)},this.destroy=function(){this.routes=ne=[],ae&&window.removeEventListener(`popstate`,this.__popstateListener),this.destroyed=re=!0},this.notFound=function(e,t){return i._notFoundRoute=me(`*`,e,[n,t],`__NOT_FOUND__`),this},this.updatePageLinks=_e,this.link=function(e){return`/`+a+`/`+s(e)},this.hooks=function(e){return n=e,this},this.extractGETParameters=function(e){return u(se(e))},this.lastResolved=function(){return m},this.generate=ve,this.getLinkPath=function(e){return e.getAttribute(`href`)},this.match=function(e){var t={instance:i,currentLocationPath:e,to:e,navigateOptions:{},resolveOptions:r};return y(t,(function(){})),!!t.matches&&t.matches},this.matchLocation=function(e,t,n){t===void 0||n!==void 0&&!n||(t=le(t));var r={instance:i,to:t,currentLocationPath:t};return v(r,(function(){})),typeof e==`string`&&(e=n===void 0||n?le(e):e),f(r,{name:String(e),path:e,handler:function(){},hooks:{}})||!1},this.getCurrentLocation=function(){return b(s(o(a)).replace(RegExp(`^`+a),``))},this.addBeforeHook=ye.bind(this,`before`),this.addAfterHook=ye.bind(this,`after`),this.addAlreadyHook=ye.bind(this,`already`),this.addLeaveHook=ye.bind(this,`leave`),this.getRoute=be,this._pathToMatchObject=b,this._clean=s,this._checkForAHash=se,this._setCurrent=function(e){return m=i.current=e},function(){ae&&(this.__popstateListener=function(){i.__freezeListening||he()},window.addEventListener(`popstate`,this.__popstateListener))}.call(this),_e.call(this)}}},t={};function n(r){if(t[r])return t[r].exports;var i=t[r]={exports:{}};return e[r](i,i.exports,n),i.exports}return n.d=function(e,t){for(var r in t)n.o(t,r)&&!n.o(e,r)&&Object.defineProperty(e,r,{enumerable:!0,get:t[r]})},n.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},n(407)}().default}))})),f=s(((e,t)=>{(function(n,r){var i={};n.PubSub?(i=n.PubSub,console.warn(`PubSub already loaded, using existing version`)):(n.PubSub=i,r(i)),typeof e==`object`?(t!==void 0&&t.exports&&(e=t.exports=i),e.PubSub=i,t.exports=e=i):typeof define==`function`&&define.amd&&define(function(){return i})})(typeof window==`object`&&window||e||global,function(e){var t={},n=-1,r=`*`;function i(e){for(var t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!0;return!1}function a(e){return function(){throw e}}function o(e,t,n){try{e(t,n)}catch(e){setTimeout(a(e),0)}}function s(e,t,n){e(t,n)}function c(e,n,r,i){var a=t[n],c=i?s:o,l;if(Object.prototype.hasOwnProperty.call(t,n))for(l in a)Object.prototype.hasOwnProperty.call(a,l)&&c(a[l],e,r)}function l(e,t,n){return function(){var i=String(e),a=i.lastIndexOf(`.`);for(c(e,e,t,n);a!==-1;)i=i.substr(0,a),a=i.lastIndexOf(`.`),c(e,i,t,n);c(e,r,t,n)}}function u(e){var n=String(e);return!!(Object.prototype.hasOwnProperty.call(t,n)&&i(t[n]))}function d(e){for(var t=String(e),n=u(t)||u(r),i=t.lastIndexOf(`.`);!n&&i!==-1;)t=t.substr(0,i),i=t.lastIndexOf(`.`),n=u(t);return n}function f(e,t,n,r){e=typeof e==`symbol`?e.toString():e;var i=l(e,t,r);return d(e)?(n===!0?i():setTimeout(i,0),!0):!1}e.publish=function(t,n){return f(t,n,!1,e.immediateExceptions)},e.publishSync=function(t,n){return f(t,n,!0,e.immediateExceptions)},e.subscribe=function(e,r){if(typeof r!=`function`)return!1;e=typeof e==`symbol`?e.toString():e,Object.prototype.hasOwnProperty.call(t,e)||(t[e]={});var i=`uid_`+String(++n);return t[e][i]=r,i},e.subscribeAll=function(t){return e.subscribe(r,t)},e.subscribeOnce=function(t,n){var r=e.subscribe(t,function(){e.unsubscribe(r),n.apply(this,arguments)});return e},e.clearAllSubscriptions=function(){t={}},e.clearSubscriptions=function(e){for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0&&delete t[n]},e.countSubscriptions=function(e){var n,r,i=0;for(n in t)if(Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0){for(r in t[n])i++;break}return i},e.getSubscriptions=function(e){var n,r=[];for(n in t)Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0&&r.push(n);return r},e.unsubscribe=function(n){var r=typeof n==`string`&&(Object.prototype.hasOwnProperty.call(t,n)||function(e){for(var n in t)if(Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0)return!0;return!1}(n)),i=!r&&typeof n==`string`,a=typeof n==`function`,o=!1,s,c,l;if(r){e.clearSubscriptions(n);return}for(s in t)if(Object.prototype.hasOwnProperty.call(t,s)){if(c=t[s],i&&c[n]){delete c[n],o=n;break}if(a)for(l in c)Object.prototype.hasOwnProperty.call(c,l)&&c[l]===n&&(delete c[l],o=!0)}return o}})})),p,m=o((()=>{p=Object.freeze({APP:`APP`,APP_READY:`APP.READY`,APP_ERROR:`APP.ERROR`,APP_SIGNOUT:`APP.SIGNOUT`,APP_AUTH:`APP.AUTH`,APP_USER_LOADED:`APP.USER.LOADED`,ROUTE_NAV:`ROUTE.NAV.GO`,ROUTE_NAV_BEFORE:`ROUTE.NAV.BEFORE`,ROUTE_NAV_AFTER:`ROUTE.NAV.AFTER`,ROUTE_NAV_ERROR:`ROUTE.NAV.ERROR`,AUTH_SIGNIN:`AUTH.SIGNIN.GO`,AUTH_SIGNIN_SUCCESS:`AUTH.SIGNIN.SUCCESS`,AUTH_SIGNIN_FAIL:`AUTH.SIGNIN.FAIL`,AUTH_SIGNUP:`AUTH.SIGNUP.GO`,AUTH_SIGNUP_SUCCESS:`AUTH.SIGNUP.SUCCESS`,AUTH_SIGNUP_FAIL:`AUTH.SIGNUP.FAIL`,AUTH_VERIFY_LINK:`AUTH.VERIFY.LINK`,AUTH_SIGNOUT:`AUTH.SIGNOUT.GO`,AUTH_SIGNOUT_SUCCESS:`AUTH.SIGNOUT.SUCCESS`,AUTH_FORGOT:`AUTH.FORGOT.GO`,AUTH_FORGOT_SUCCESS:`AUTH.FORGOT.SUCCESS`,AUTH_RESETHASH:`AUTH.RESETHASH.GO`,AUTH_RESETHASH_SUCCESS:`AUTH.RESETHASH.SUCCESS`,AUTH_RESETHASH_NAV:`AUTH.RESETHASH.NAV`,AUTH_TOKEN_EXPIRED:`AUTH.TOKEN.EXPIRED`,AUTH_TOKEN_INVALID:`AUTH.TOKEN.INVALID`,AUTH_SCOPE_LOADED:`AUTH.SCOPE.LOADED`,M5T_PRIMARY_NAV:`M5T_PRIMARY_NAV`,M5T_PRIMARY_NAV_LOGO_TAP:`M5T_PRIMARY_NAV.LOGO_TAP`,M5T_PRIMARY_NAV_HOVER:`M5T_PRIMARY_NAV.HOVER`,M5T_PRIMARY_NAV_TAP:`M5T_PRIMARY_NAV.TAP`,M5T_PRIMARY_NAV_DOUBLE_TAP:`M5T_PRIMARY_NAV.DOUBLE_TAP`,M5T_PRIMARY_NAV_LONG_TAP:`M5T_PRIMARY_NAV.LONG_TAP`,M5T_SIDE_NAV:`M5T_SIDE_NAV`,M5T_SIDE_NAV_TAP:`M5T_SIDE_NAV.TAP`,M5T_SIDE_NAV_COLLAPSE:`M5T_SIDE_NAV.COLLAPSE`,M5T_SIDE_NAV_LOGO_TAP:`M5T_SIDE_NAV.LOGO_TAP`,M5T_SIDE_NAV_ORG_SWITCH:`M5T_SIDE_NAV.ORG_SWITCH`,M5T_SIDE_NAV_FOOTER_ACTION:`M5T_SIDE_NAV.FOOTER_ACTION`,UI_LOADING_START:`UI.LOADING.START`,UI_LOADING_END:`UI.LOADING.END`,UI_TOAST:`UI.TOAST`,UI_MODAL_OPEN:`UI.MODAL.OPEN`,UI_MODAL_CLOSE:`UI.MODAL.CLOSE`,UI_THEME_CHANGED:`UI.THEME.CHANGED`,UI_WELCOME_BACK_CLICKED:`UI.WELCOME_BACK_CLICKED`,DATA_REFRESH:`DATA.REFRESH`,DATA_UPDATE:`DATA.UPDATE`,DATA_ERROR:`DATA.ERROR`,I18N:`I18N`,I18N_SET_LANG:`I18N.SET_LANG`,CONVERSATION:`CONVERSATION`,CONVERSATION_PROMPT:`CONVERSATION.PROMPT`,CONVERSATION_PROMPT_AGENT_CANVAS:`CONVERSATION.PROMPT.AGENT_CANVAS`,CONVERSATION_PROMPT_AGENT:`CONVERSATION.PROMPT.AGENT`,CONVERSATION_PROMPT_CANVAS:`CONVERSATION.PROMPT.CANVAS`,CONVERSATION_PROMPT_STAGE:`CONVERSATION.PROMPT.STAGE`,CONVERSATION_RESPONSE:`CONVERSATION.RESPONSE`,CONVERSATION_RESPONSE_CANVAS:`CONVERSATION.RESPONSE.CANVAS`,CONVERSATION_RESPONSE_WORKFLOW:`CONVERSATION.RESPONSE.WORKFLOW`,CANVAS:`CANVAS`,CANVAS_DO_SCROLL:`CANVAS.DO.SCROLL`,MESSAGE:`MESSAGE`,MESSAGE_CREATE:`MESSAGE.CREATE`,MESSAGE_CREATED:`MESSAGE.CREATED`,MESSAGE_EDIT:`MESSAGE.EDIT`,MESSAGE_UPDATED:`MESSAGE.UPDATED`,MESSAGE_DELETE:`MESSAGE.DELETE`,MESSAGE_DELETED:`MESSAGE.DELETED`,MESSAGE_REFRESH:`MESSAGE.REFRESH`})}));function h(e,t=null){if(e in v)return v[e];if(typeof process<`u`&&{}[e]){let t={}[e];return t===`true`?!0:t===`false`?!1:isNaN(t)?t:Number(t)}if({BASE_URL:`./`,DEV:!1,MODE:`production`,PROD:!0,SSR:!1,VITE_API_BASE_URL:`http://localhost:3333`}[e]){let t={BASE_URL:`./`,DEV:!1,MODE:`production`,PROD:!0,SSR:!1,VITE_API_BASE_URL:`http://localhost:3333`}[e];return t===`true`?!0:t===`false`?!1:isNaN(t)?t:Number(t)}return t}function g(e){return h(e,!1)===!0}function _(){return{...v}}var v,y=o((()=>{v=Object.freeze({FF_SSE_LS_SESSION_USER:`mvv_session_user`,FF_SSE_LS_TOKEN:`mvv`,FF_SSE_LS_THEME:`mvv_theme`,FF_SSE_UI_DARK_MODE:!0,FF_SSE_UI_ANIMATIONS:!0,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:`main_carousel_nav`,FF_CLIENT_LS_SESSION_ENTITY:`sse_entity`,FF_CLIENT_LS_DEEP_LINK:`sse_deeplink`,FF_CLIENT_ROUTE_SIGNIN:`signin_route`,FF_CLIENT_ROUTE_SIGNUP:`signup_route`,FF_CLIENT_ROUTE_HOME:`home_route`,FF_CLIENT_ROUTE_RESET_HASH:`resethash_route`,FF_CLIENT_ROUTE_RESET_FORGOT:`resetforgot_route`,FF_CLIENT_ROUTE_SIGNOUT:`signout_route`,FF_CLIENT_ROUTE_ERROR:`error_route`,FF_CLIENT_ROUTE_VERF_LINK:`verf_link_route`,FF_CLIENT_ROUTE_OFFLINE:`offline_route`,FF_CLIENT_PROTECTED_ROUTES:[`home_route`,`resethash_route`,`signout_route`,`user_management_route`],FF_CLIENT_ENDPOINT_SIGNIN:`/m5t/v5/acctEntity/signin`,FF_CLIENT_ENDPOINT_SIGNOUT:`/m5t/v5/acctEntity/signout`,FF_CLIENT_ENDPOINT_SIGNUP:`/m5t/v5/acctEntity/`,FF_CLIENT_ENDPOINT_RESET_HASH:`/m5t/v5/acctEntity/resetHash`,FF_CLIENT_ENDPOINT_RESET_FORGOT:`/m5t/v5/acctEntity/resetforgot`,FF_CLIENT_ENDPOINT_PING:`/ping`,FF_CLIENT_ENDPOINT_METER:`/m5t/v5/coreMeter/`,FF_CLIENT_METER_DEEP_LINK:`deep_link_access`,FF_CLIENT_METER_SIGNOUT_CLIENT:`signout_client_initiated`,FF_CLIENT_METER_SIGNOUT_SERVER:`signout_server_initiated`,FF_CLIENT_METER_PING_SUCCESS:`ping_auth_success`,FF_CLIENT_METER_PING_FAILURE:`ping_auth_failure`,FF_SSE_I18N_PRODUCT:`SSE`,FF_SSE_I18N_WHITELABEL:`M5T`,FF_SSE_I18N_LANG:`en`,FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:`mvv_user_lang`,FF_SSE_LS_WHITELABEL:`mvv_whitelabel`,FF_API_RATELIMIT_SIGNIN_ENFORCE:!0,FF_API_RATELIMIT_SIGNIN_IP_LIMIT:20,FF_API_RATELIMIT_SIGNIN_EMAIL_LIMIT:10,FF_API_RATELIMIT_FORGOT_ENFORCE:!0,FF_API_RATELIMIT_FORGOT_IP_LIMIT:15,FF_API_RATELIMIT_FORGOT_EMAIL_LIMIT:5,FF_API_RATELIMIT_RESET_ACCOUNT_LIMIT:5,FF_API_RATELIMIT_CAPTURE_ENFORCE:!0,FF_API_RATELIMIT_CAPTURE_LIMIT:30,FF_API_RATELIMIT_EVENT_ENFORCE:!0,FF_API_RATELIMIT_EVENT_LIMIT:600,FF_API_RATELIMIT_CSP_PING_ENFORCE:!0,FF_API_RATELIMIT_CSP_PING_LIMIT:30,FF_API_RATELIMIT_WEBAUTHN_AUTH_ENFORCE:!0,FF_API_RATELIMIT_WEBAUTHN_AUTH_IP_LIMIT:20,FF_API_RATELIMIT_INTEGRATIONS_ENFORCE:!0,FF_API_RATELIMIT_INTEGRATIONS_LIMIT:60,FF_API_RATELIMIT_QUESTIONNAIRE_ENFORCE:!0,FF_API_RATELIMIT_QUESTIONNAIRE_LIMIT:30,FF_API_RATELIMIT_DELIVERABLE_ENFORCE:!0,FF_API_RATELIMIT_DELIVERABLE_LIMIT:30,FF_API_RATELIMIT_PAIRING_ENFORCE:!0,FF_API_RATELIMIT_PAIRING_LIMIT:20,FF_API_RATELIMIT_SITE_OPS_ENFORCE:!0,FF_API_RATELIMIT_SITE_OPS_LIMIT:120,FF_API_RATELIMIT_AUTHENTICATED_ENFORCE:!0,FF_API_RATELIMIT_AUTHENTICATED_LIMIT:600,FF_API_MAGNET_REQUIRE_ORIGIN_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_ENFORCE:!0,FF_API_RATELIMIT_GLOBAL_LIMIT:2e3}),typeof module<`u`&&module.exports&&(module.exports={FEATURE_FLAGS:v,getFlag:h,isEnabled:g,getAllFlags:_})})),ee=u(d(),1),te=u(f(),1);m(),y();var ne={success:{border:`var(--color-success, #009473)`,bg:`var(--color-success-soft, rgba(0,148,115,0.10))`,icon:`check_circle`},danger:{border:`var(--color-danger, #DD4124)`,bg:`var(--color-danger-soft, rgba(221,65,36,0.09))`,icon:`error`},error:{border:`var(--color-danger, #DD4124)`,bg:`var(--color-danger-soft, rgba(221,65,36,0.09))`,icon:`error`},warning:{border:`var(--color-warning, #D97706)`,bg:`var(--color-warning-soft, #FEF3C7)`,icon:`warning`},info:{border:`var(--color-info, #0D9488)`,bg:`var(--color-info-soft, #CCFBF1)`,icon:`info`}},re=4500,ie=220,ae=null,oe=!1;function se(){if(oe)return;let e=document.createElement(`style`);e.id=`m5t-toast-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),oe=!0}function ce(){return ae&&document.body.contains(ae)?ae:(ae=document.createElement(`div`),ae.className=`m5t-toast-stack`,ae.setAttribute(`role`,`status`),ae.setAttribute(`aria-live`,`polite`),document.body.appendChild(ae),ae)}function le(e){let t=e&&e.message;if(!t)return;se();let n=ne[e.type]||ne.info,r=document.createElement(`div`);r.className=`m5t-toast`,r.style.borderColor=n.border,r.style.background=n.bg,r.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true" style="color:${n.border}">${n.icon}</span><span class="m5t-toast__msg"></span><button type="button" class="m5t-toast__close" aria-label="Dismiss"><span class="material-symbols-outlined" aria-hidden="true">close</span></button>`,r.querySelector(`.m5t-toast__msg`).textContent=String(t),ce().appendChild(r),requestAnimationFrame(()=>r.classList.add(`is-in`));let i=!1,a=()=>{i||(i=!0,clearTimeout(o),r.classList.remove(`is-in`),r.classList.add(`is-out`),setTimeout(()=>r.remove(),ie))},o=setTimeout(a,re);r.querySelector(`.m5t-toast__close`).addEventListener(`click`,a)}function ue(){return(typeof window<`u`&&window.location?window.location.hash:``)||`#/`}function de(e){return xe.add(e),()=>xe.delete(e)}function fe(){for(let e of xe)try{e()}catch(e){console.warn(`[navGeneration] discard handler threw:`,e)}}function pe(){Se||typeof window>`u`||(window.addEventListener(`hashchange`,fe),Se=!0)}function me(e){Ce=e}function he(e){Te=e,Ee=!1}async function ge(e){if(!e||e.status!==403)return!1;try{return(await e.clone().json())?.code===`invalid_active_org`}catch{return!1}}function _e(){return typeof window<`u`&&window.__m5tNativeFetch||fetch}function ve(e,t){let n=null;try{n=typeof mvvLegit<`u`&&mvvLegit.getConf?mvvLegit.getConf():null}catch{}let r=n?.BASE,i=String(typeof e==`string`?e:e?.url||``);if(!r||i.toUpperCase().indexOf(String(r).toUpperCase())===-1)return t;let a=new Headers(t.headers||void 0);try{let e=localStorage.getItem(n.LSKEY||`mvv`),t=e&&typeof LZString<`u`?JSON.parse(LZString.decompressFromUTF16(e)):null;t?.token&&a.set(`Authorization`,`Bearer ${t.token}`)}catch{}try{a.set(`machvive`,typeof neodigmUtils<`u`&&neodigmUtils?.ver||`Neodigm`);let e=localStorage.getItem(`mvvBrand`);e&&a.set(`x-m5t-brand`,e);let t=localStorage.getItem(`sse_active_org`);t&&a.set(`X-Active-Org`,t)}catch{}return{...t,headers:a}}async function b(e,t={}){return ye(e,t,!1)}async function ye(e,t,n){let r=ue(),i=new AbortController,a=t.signal&&typeof AbortSignal<`u`&&AbortSignal.any?AbortSignal.any([t.signal,i.signal]):t.signal??i.signal,o=String(t.method||`GET`).toUpperCase()===`GET`?de(()=>{ue()!==r&&i.abort()}):()=>{};try{let i=ve(e,{...t,signal:a}),o=await _e()(e,i);if(ue()!==r)return be;let s=(()=>{try{return new Headers(i.headers||void 0).has(`Authorization`)}catch{return!1}})();if(o.status===401&&s&&Te&&!Ee){Ee=!0;try{Te()}catch(e){console.warn(`[navGeneration] dead-session handler failed:`,e)}}let c=!n&&await ge(o);return c&&!Ce&&console.error(`[navGeneration] stale active-org 403 with NO recovery registered — setStaleContextRecovery() was never called (initAppEvents did not run?). This request will surface as a denial, which is wrong: the caller is entitled to this data under a different org context.`),c&&Ce?(we||=Promise.resolve().then(()=>Ce()).catch(e=>{console.warn(`[navGeneration] stale-context recovery failed:`,e)}).finally(()=>{we=null}),await we,ue()===r?ye(e,t,!0):be):o}catch(e){if(ue()!==r)return be;throw e}finally{o()}}var be,xe,Se,Ce,we,Te,Ee,x=o((()=>{be=new Promise(()=>{}),xe=new Set,Se=!1,pe(),Ce=null,we=null,Te=null,Ee=!1,Object.freeze([`Authorization`,`machvive`,`x-m5t-brand`])}));function De(e){return e?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(String(e)):!1}var Oe=o((()=>{})),ke=o((()=>{})),Ae=o((()=>{}));function je(e){return Ne[e]||null}function Me(e){return e>=50}var Ne,Pe=o((()=>{Ne=Object.freeze({admin_root_role:{value:100,label:`Administrator`,desc:`Mach Five platform staff — full access across every organization`},client_standard_role:{value:0,label:`Client`,desc:`Everyone else — what they can do comes from their organization membership, not this class`}})}));function Fe(e){let t=je(e);return!!t&&Me(t.value)}function Ie({entityClass:e,orgChannel:t,memberRole:n}={}){if(Fe(e))return[...Be];let r=He[t],i=r&&r[n];return i?[...i]:[]}function Le(e,t){let n=Re[e]?.rank??-1,r=Re[t]?.rank??1/0;return n>=Re.admin.rank&&n>=r}var Re,ze,S,Be,Ve,He,Ue=o((()=>{Pe(),Object.freeze({reseller_org:{value:`reseller_org`,label:`Reseller / Agency`,desc:`A Mach Five Marketing reseller. Creates and manages client accounts, provisions magnets on their behalf, monitors stats and ad numbers.`,uiMode:`reseller`,billable:!0,managesSubtree:!0},managed_client:{value:`managed_client`,label:`Managed Client`,desc:`A client account created by a reseller. Read-only: views its own active magnets, stats, and ad numbers. Does not provision.`,uiMode:`managed`,billable:!0,managesSubtree:!1,readOnly:!0},saas_org:{value:`saas_org`,label:`Self-Serve`,desc:`A self-serve SaaS customer. Provisions its own magnets and connects its own ad accounts — the full demo experience.`,uiMode:`self_serve`,billable:!0,managesSubtree:!1}}),Re=Object.freeze({owner:{value:`owner`,rank:30,label:`Owner`},admin:{value:`admin`,rank:20,label:`Admin`},account_manager:{value:`account_manager`,rank:15,label:`Account manager`},member:{value:`member`,rank:10,label:`Member`},viewer:{value:`viewer`,rank:0,label:`Viewer`}}),ze=Object.freeze({VIEW_DASHBOARD:`view_dashboard`,VIEW_MAGNETS:`view_magnets`,PROVISION_MAGNETS:`provision_magnets`,MANAGE_MAGNETS:`manage_magnets`,VIEW_CONVERSATIONS:`view_conversations`,VIEW_STATS:`view_stats`,VIEW_AD_METRICS:`view_ad_metrics`,CONNECT_AD_ACCOUNTS:`connect_ad_accounts`,CREATE_CLIENT_ACCOUNTS:`create_client_accounts`,MANAGE_TEAM:`manage_team`,MANAGE_DELIVERABLES:`manage_deliverables`,VIEW_BILLING:`view_billing`,MANAGE_BILLING:`manage_billing`}),S=ze,Be=Object.freeze(Object.values(S)),Ve=Object.freeze([S.VIEW_DASHBOARD,S.VIEW_MAGNETS,S.VIEW_CONVERSATIONS,S.VIEW_STATS,S.VIEW_AD_METRICS]),Object.freeze([S.PROVISION_MAGNETS,S.MANAGE_MAGNETS,S.CONNECT_AD_ACCOUNTS,S.CREATE_CLIENT_ACCOUNTS,S.MANAGE_TEAM,S.MANAGE_DELIVERABLES,S.MANAGE_BILLING]),Object.freeze([S.VIEW_DASHBOARD,S.VIEW_MAGNETS,S.VIEW_CONVERSATIONS,S.VIEW_STATS,S.VIEW_AD_METRICS,S.VIEW_BILLING]),He=Object.freeze({reseller_org:{owner:Be,admin:[S.VIEW_DASHBOARD,S.VIEW_MAGNETS,S.PROVISION_MAGNETS,S.MANAGE_MAGNETS,S.VIEW_CONVERSATIONS,S.VIEW_STATS,S.VIEW_AD_METRICS,S.CONNECT_AD_ACCOUNTS,S.CREATE_CLIENT_ACCOUNTS,S.MANAGE_TEAM,S.MANAGE_DELIVERABLES,S.VIEW_BILLING],account_manager:[S.VIEW_DASHBOARD,S.VIEW_MAGNETS,S.PROVISION_MAGNETS,S.MANAGE_MAGNETS,S.VIEW_CONVERSATIONS,S.VIEW_STATS,S.VIEW_AD_METRICS,S.CONNECT_AD_ACCOUNTS,S.MANAGE_DELIVERABLES],member:[S.VIEW_DASHBOARD,S.VIEW_MAGNETS,S.PROVISION_MAGNETS,S.MANAGE_MAGNETS,S.VIEW_CONVERSATIONS,S.VIEW_STATS,S.VIEW_AD_METRICS],viewer:Ve},managed_client:{owner:[...Ve,S.VIEW_BILLING],admin:[...Ve,S.VIEW_BILLING],member:Ve,viewer:Ve},saas_org:{owner:[S.VIEW_DASHBOARD,S.VIEW_MAGNETS,S.PROVISION_MAGNETS,S.MANAGE_MAGNETS,S.VIEW_CONVERSATIONS,S.VIEW_STATS,S.VIEW_AD_METRICS,S.CONNECT_AD_ACCOUNTS,S.MANAGE_TEAM,S.MANAGE_DELIVERABLES,S.VIEW_BILLING,S.MANAGE_BILLING],admin:[S.VIEW_DASHBOARD,S.VIEW_MAGNETS,S.PROVISION_MAGNETS,S.MANAGE_MAGNETS,S.VIEW_CONVERSATIONS,S.VIEW_STATS,S.VIEW_AD_METRICS,S.CONNECT_AD_ACCOUNTS,S.MANAGE_TEAM,S.MANAGE_DELIVERABLES,S.VIEW_BILLING],member:[S.VIEW_DASHBOARD,S.VIEW_MAGNETS,S.PROVISION_MAGNETS,S.MANAGE_MAGNETS,S.VIEW_CONVERSATIONS,S.VIEW_STATS],viewer:Ve}})})),We,Ge=o((()=>{We=[{value:`name`,label:`Full name (splits into first + last automatically)`},{value:`first_name`,label:`First name`},{value:`last_name`,label:`Last name`},{value:`email`,label:`Email`},{value:`phone`,label:`Phone`},{value:`mobile`,label:`Mobile phone`},{value:`company`,label:`Company`},{value:`title`,label:`Job title`},{value:`city`,label:`City`},{value:`state`,label:`State / province`},{value:`product_interest`,label:`Product interest`},{value:`lead_source`,label:`Lead source`},{value:`rating`,label:`Rating (Hot / Warm / Cold)`},{value:`description`,label:`Notes / description`},{value:`salutation`,label:`Salutation (Mr. / Ms. / Dr.)`},{value:`street`,label:`Street address`},{value:`zip`,label:`Postal / ZIP code`},{value:`country`,label:`Country`},{value:`url`,label:`Website URL`},{value:`industry`,label:`Industry`},{value:`annual_revenue`,label:`Annual revenue (number)`},{value:`employees`,label:`Number of employees (whole number)`},{value:`is_primary`,label:`Primary contact (Yes / No)`},{value:`current_generators`,label:`Current generator(s)`},{value:`number_of_locations`,label:`Number of locations (whole number)`}],new Set(We.map(e=>e.value))})),Ke,qe=o((()=>{Ke=[{value:`single_select`,label:`Multiple choice`},{value:`multi_select`,label:`Select all`},{value:`scheduler`,label:`Scheduler`},{value:`text`,label:`Short text`},{value:`email`,label:`Email`},{value:`phone`,label:`Phone`},{value:`message`,label:`Message`}],new Set(Ke.map(e=>e.value))})),Je,Ye,Xe,Ze,Qe=o((()=>{Je=[{value:`inline`,label:`Inline`},{value:`chat`,label:`Chat`},{value:`right_slide`,label:`Slide`},{value:`modal`,label:`Modal`}],Ye=[{value:`auto`,label:`Auto (visitor OS setting)`},{value:`sync`,label:`Sync (match the site's own dark mode)`},{value:`light`,label:`Light`},{value:`dark`,label:`Dark`}],Xe=[{value:`on_load`,label:`Immediately on page load`},{value:`on_8_seconds`,label:`After 8 seconds`},{value:`on_scroll_80_percent`,label:`At 80% scroll depth`},{value:`on_exit_intent`,label:`On exit intent (mouse leaves the page)`},{value:`none`,label:`Manual only (visitor clicks the launcher)`}],Ze=[{value:`book`,label:`Book`},{value:`call`,label:`Call`},{value:`email`,label:`Email`},{value:`chat`,label:`Chat`},{value:`support`,label:`Support`}],Je.map(e=>e.value),Ye.map(e=>e.value),Xe.map(e=>e.value),Object.freeze({manual:`none`}),Ze.map(e=>e.value)})),$e,et,tt=o((()=>{$e=Object.freeze([`chat`,`right_slide`,`modal`,`inline`]),et=Object.freeze({free:Object.freeze({key:`free`,label:`Free`,prices:Object.freeze({monthly:0,annual:0}),limits:Object.freeze({magnets:1,leads_mo:100,team_members:1}),features:Object.freeze({formats:Object.freeze([`chat`]),hub_scheduler:!1,ab_testing:!1,journeys:!1,attribution:!1,crm_sync:!1,booking:!1,webhooks:!1,csv_export:!1,ad_reporting:!1})}),pro:Object.freeze({key:`pro`,label:`Pro`,prices:Object.freeze({monthly:79,annual:63}),limits:Object.freeze({magnets:null,leads_mo:1e4,team_members:5}),features:Object.freeze({formats:$e,hub_scheduler:!0,ab_testing:!0,journeys:!0,attribution:!0,crm_sync:!0,booking:!0,webhooks:!0,csv_export:!0,ad_reporting:!1})}),enterprise:Object.freeze({key:`enterprise`,label:`Enterprise`,prices:Object.freeze({monthly:199,annual:159}),limits:Object.freeze({magnets:null,leads_mo:1e5,team_members:null}),features:Object.freeze({formats:$e,hub_scheduler:!0,ab_testing:!0,journeys:!0,attribution:!0,crm_sync:!0,booking:!0,webhooks:!0,csv_export:!0,ad_reporting:!0})}),grandfathered:Object.freeze({key:`grandfathered`,label:`Full access`,prices:null,limits:Object.freeze({magnets:null,leads_mo:null,team_members:null}),features:Object.freeze({formats:$e,hub_scheduler:!0,ab_testing:!0,journeys:!0,attribution:!0,crm_sync:!0,booking:!0,webhooks:!0,csv_export:!0,ad_reporting:!0})})})})),nt=o((()=>{Pe(),Ue(),Ge(),qe(),Qe(),tt()})),rt=o((()=>{Oe(),ke(),Ae(),nt()}));function it(e=window.location.search){let t=new URLSearchParams(e||``);return!!(t.get(`uid`)&&t.get(`token`))}var at=o((()=>{}));function ot(e=window.location.search){let t=new URLSearchParams(e||``);return!!(t.get(`qr`)&&t.get(`token`))}function st(e=window.location.search){let t=new URLSearchParams(e||``),n=t.get(`qr`),r=t.get(`token`);return n&&r?{guid:n,token:r}:null}var ct=o((()=>{}));function lt(e=window.location.search){let t=new URLSearchParams(e||``);return!!(t.get(`dl`)&&t.get(`token`))}function ut(e=window.location.search){let t=new URLSearchParams(e||``),n=t.get(`dl`),r=t.get(`token`);return n&&r?{guid:n,token:r}:null}var dt=o((()=>{}));function ft(e=window.location.search){return gt.find(t=>t.matches(e))||null}function pt(e=window.location.search){return ft(e)!==null}function mt(e=window.location.hash){return _t.some(t=>e===t||e.startsWith(t+`/`))}function ht(e,t=window.location.search,n=window.location.hash){return pt(t)||mt(n)}var gt,_t,vt=o((()=>{at(),ct(),dt(),gt=Object.freeze([Object.freeze({name:`invite`,matches:it}),Object.freeze({name:`questionnaire`,matches:ot}),Object.freeze({name:`deliverable`,matches:lt})]),_t=Object.freeze([`#/templates`,`#/signup`,`#/forgot`])})),yt,bt,xt,C,St=o((()=>{yt=`modulepreload`,bt=function(e,t){return new URL(e,t).href},xt={},C=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=bt(t,n),t=s(t),t in xt)return;xt[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:yt,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})}}));function Ct(e){let t=new Uint8Array(e),n=``;for(let e of t)n+=String.fromCharCode(e);return btoa(n).replace(/\+/g,`-`).replace(/\//g,`_`).replace(/=/g,``)}var wt=o((()=>{}));function Tt(e){let t=e.replace(/-/g,`+`).replace(/_/g,`/`),n=(4-t.length%4)%4,r=t.padEnd(t.length+n,`=`),i=atob(r),a=new ArrayBuffer(i.length),o=new Uint8Array(a);for(let e=0;e<i.length;e++)o[e]=i.charCodeAt(e);return a}var Et=o((()=>{}));function Dt(){return Ot.stubThis(globalThis?.PublicKeyCredential!==void 0&&typeof globalThis.PublicKeyCredential==`function`)}var Ot,kt=o((()=>{Ot={stubThis:e=>e}}));function At(e){let{id:t}=e;return{...e,id:Tt(t),transports:e.transports}}var jt=o((()=>{Et()}));function Mt(e){return e===`localhost`||/^((xn--[a-z0-9-]+|[a-z0-9]+(-[a-z0-9]+)*)\.)+([a-z]{2,}|xn--[a-z0-9-]+)$/i.test(e)}var Nt=o((()=>{})),Pt,Ft=o((()=>{Pt=class extends Error{constructor({message:e,code:t,cause:n,name:r}){super(e,{cause:n}),Object.defineProperty(this,"code",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),this.name=r??n.name,this.code=t}}}));function It({error:e,options:t}){let{publicKey:n}=t;if(!n)throw Error(`options was missing required publicKey property`);if(e.name===`AbortError`){if(t.signal instanceof AbortSignal)return new Pt({message:`Registration ceremony was sent an abort signal`,code:`ERROR_CEREMONY_ABORTED`,cause:e})}else if(e.name===`ConstraintError`){if(n.authenticatorSelection?.requireResidentKey===!0)return new Pt({message:`Discoverable credentials were required but no available authenticator supported it`,code:`ERROR_AUTHENTICATOR_MISSING_DISCOVERABLE_CREDENTIAL_SUPPORT`,cause:e});if(t.mediation===`conditional`&&n.authenticatorSelection?.userVerification===`required`)return new Pt({message:`User verification was required during automatic registration but it could not be performed`,code:`ERROR_AUTO_REGISTER_USER_VERIFICATION_FAILURE`,cause:e});if(n.authenticatorSelection?.userVerification===`required`)return new Pt({message:`User verification was required but no available authenticator supported it`,code:`ERROR_AUTHENTICATOR_MISSING_USER_VERIFICATION_SUPPORT`,cause:e})}else if(e.name===`InvalidStateError`)return new Pt({message:`The authenticator was previously registered`,code:`ERROR_AUTHENTICATOR_PREVIOUSLY_REGISTERED`,cause:e});else if(e.name===`NotAllowedError`)return new Pt({message:e.message,code:`ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY`,cause:e});else if(e.name===`NotSupportedError`)return n.pubKeyCredParams.filter(e=>e.type===`public-key`).length===0?new Pt({message:`No entry in pubKeyCredParams was of type "public-key"`,code:`ERROR_MALFORMED_PUBKEYCREDPARAMS`,cause:e}):new Pt({message:`No available authenticator supported any of the specified pubKeyCredParams algorithms`,code:`ERROR_AUTHENTICATOR_NO_SUPPORTED_PUBKEYCREDPARAMS_ALG`,cause:e});else if(e.name===`SecurityError`){let t=globalThis.location.hostname;if(!Mt(t))return new Pt({message:`${globalThis.location.hostname} is an invalid domain`,code:`ERROR_INVALID_DOMAIN`,cause:e});if(n.rp.id!==t)return new Pt({message:`The RP ID "${n.rp.id}" is invalid for this domain`,code:`ERROR_INVALID_RP_ID`,cause:e})}else if(e.name===`TypeError`){if(n.user.id.byteLength<1||n.user.id.byteLength>64)return new Pt({message:`User ID was not between 1 and 64 characters`,code:`ERROR_INVALID_USER_ID_LENGTH`,cause:e})}else if(e.name===`UnknownError`)return new Pt({message:`The authenticator was unable to process the specified options, or could not create a new credential`,code:`ERROR_AUTHENTICATOR_GENERAL_ERROR`,cause:e});return e}var Lt=o((()=>{Nt(),Ft()})),Rt,zt,Bt=o((()=>{Rt=class{constructor(){Object.defineProperty(this,"controller",{enumerable:!0,configurable:!0,writable:!0,value:void 0})}createNewAbortSignal(){if(this.controller){let e=Error(`Cancelling existing WebAuthn API call for new one`);e.name=`AbortError`,this.controller.abort(e)}let e=new AbortController;return this.controller=e,e.signal}cancelCeremony(){if(this.controller){let e=Error(`Manually cancelling existing WebAuthn API call`);e.name=`AbortError`,this.controller.abort(e),this.controller=void 0}}},zt=new Rt}));function Vt(e){if(e&&!(Ht.indexOf(e)<0))return e}var Ht,Ut=o((()=>{Ht=[`cross-platform`,`platform`]}));async function Wt(e){!e.optionsJSON&&e.challenge&&(console.warn(`startRegistration() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information.`),e={optionsJSON:e});let{optionsJSON:t,useAutoRegister:n=!1}=e;if(!Dt())throw Error(`WebAuthn is not supported in this browser`);let r={...t,challenge:Tt(t.challenge),user:{...t.user,id:Tt(t.user.id)},excludeCredentials:t.excludeCredentials?.map(At)},i={};n&&(i.mediation=`conditional`),i.publicKey=r,i.signal=zt.createNewAbortSignal();let a;try{a=await navigator.credentials.create(i)}catch(e){throw It({error:e,options:i})}if(!a)throw Error(`Registration was not completed`);let{id:o,rawId:s,response:c,type:l}=a,u;typeof c.getTransports==`function`&&(u=c.getTransports());let d;if(typeof c.getPublicKeyAlgorithm==`function`)try{d=c.getPublicKeyAlgorithm()}catch(e){Gt(`getPublicKeyAlgorithm()`,e)}let f;if(typeof c.getPublicKey==`function`)try{let e=c.getPublicKey();e!==null&&(f=Ct(e))}catch(e){Gt(`getPublicKey()`,e)}let p;if(typeof c.getAuthenticatorData==`function`)try{p=Ct(c.getAuthenticatorData())}catch(e){Gt(`getAuthenticatorData()`,e)}return{id:o,rawId:Ct(s),response:{attestationObject:Ct(c.attestationObject),clientDataJSON:Ct(c.clientDataJSON),transports:u,publicKeyAlgorithm:d,publicKey:f,authenticatorData:p},type:l,clientExtensionResults:a.getClientExtensionResults(),authenticatorAttachment:Vt(a.authenticatorAttachment)}}function Gt(e,t){console.warn(`The browser extension that intercepted this WebAuthn API call incorrectly implemented ${e}. You should report this error to them.\n`,t)}var Kt=o((()=>{wt(),Et(),kt(),jt(),Lt(),Bt(),Ut()}));function qt(){if(!Dt())return Jt.stubThis(new Promise(e=>e(!1)));let e=globalThis.PublicKeyCredential;return e?.isConditionalMediationAvailable===void 0?Jt.stubThis(new Promise(e=>e(!1))):Jt.stubThis(e.isConditionalMediationAvailable())}var Jt,Yt=o((()=>{kt(),Jt={stubThis:e=>e}}));function Xt({error:e,options:t}){let{publicKey:n}=t;if(!n)throw Error(`options was missing required publicKey property`);if(e.name===`AbortError`){if(t.signal instanceof AbortSignal)return new Pt({message:`Authentication ceremony was sent an abort signal`,code:`ERROR_CEREMONY_ABORTED`,cause:e})}else if(e.name===`NotAllowedError`)return new Pt({message:e.message,code:`ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY`,cause:e});else if(e.name===`SecurityError`){let t=globalThis.location.hostname;if(!Mt(t))return new Pt({message:`${globalThis.location.hostname} is an invalid domain`,code:`ERROR_INVALID_DOMAIN`,cause:e});if(n.rpId!==t)return new Pt({message:`The RP ID "${n.rpId}" is invalid for this domain`,code:`ERROR_INVALID_RP_ID`,cause:e})}else if(e.name===`UnknownError`)return new Pt({message:`The authenticator was unable to process the specified options, or could not create a new assertion signature`,code:`ERROR_AUTHENTICATOR_GENERAL_ERROR`,cause:e});return e}var Zt=o((()=>{Nt(),Ft()}));async function Qt(e){!e.optionsJSON&&e.challenge&&(console.warn(`startAuthentication() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information.`),e={optionsJSON:e});let{optionsJSON:t,useBrowserAutofill:n=!1,verifyBrowserAutofillInput:r=!0}=e;if(!Dt())throw Error(`WebAuthn is not supported in this browser`);let i;t.allowCredentials?.length!==0&&(i=t.allowCredentials?.map(At));let a={...t,challenge:Tt(t.challenge),allowCredentials:i},o={};if(n){if(!await qt())throw Error(`Browser does not support WebAuthn autofill`);if(document.querySelectorAll(`input[autocomplete$='webauthn']`).length<1&&r)throw Error('No <input> with "webauthn" as the only or last value in its `autocomplete` attribute was detected');o.mediation=`conditional`,a.allowCredentials=[]}o.publicKey=a,o.signal=zt.createNewAbortSignal();let s;try{s=await navigator.credentials.get(o)}catch(e){throw Xt({error:e,options:o})}if(!s)throw Error(`Authentication was not completed`);let{id:c,rawId:l,response:u,type:d}=s,f;return u.userHandle&&(f=Ct(u.userHandle)),{id:c,rawId:Ct(l),response:{authenticatorData:Ct(u.authenticatorData),clientDataJSON:Ct(u.clientDataJSON),signature:Ct(u.signature),userHandle:f},type:d,clientExtensionResults:s.getClientExtensionResults(),authenticatorAttachment:Vt(s.authenticatorAttachment)}}var $t=o((()=>{wt(),Et(),kt(),Yt(),jt(),Zt(),Bt(),Ut()}));function en(){return Dt()?PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable():new Promise(e=>e(!1))}var tn=o((()=>{kt()})),nn=o((()=>{})),rn=c({WebAuthnAbortService:()=>zt,WebAuthnError:()=>Pt,_browserSupportsWebAuthnAutofillInternals:()=>Jt,_browserSupportsWebAuthnInternals:()=>Ot,base64URLStringToBuffer:()=>Tt,browserSupportsWebAuthn:()=>Dt,browserSupportsWebAuthnAutofill:()=>qt,bufferToBase64URLString:()=>Ct,platformAuthenticatorIsAvailable:()=>en,startAuthentication:()=>Qt,startRegistration:()=>Wt}),an=o((()=>{Kt(),$t(),kt(),tn(),Yt(),Et(),wt(),Bt(),Ft(),nn()})),w,T=o((()=>{rt(),vt(),St(),w=class{static CONFIG={BASE_URL:`https://machfivemagnet-saas.onrender.com`,FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:`sse_session_user`,DEEP_LINK:`sse_deeplink`,SCOPE:`sse_session_scope`,ACTIVE_ORG:`sse_active_org`,REMEMBERED_EMAIL:`sse_remembered_email`},ROUTES:{SIGNIN:`signin`,SIGNUP:`signup`,HOME:`home`,RESET_HASH:`resethash`,FORGOT:`forgot`,SPLASH:`splash`},PROTECTED_ROUTES:[`home`,`resethash`],ENDPOINTS:{SIGNIN:`/m5t/v5/acctEntity/signin`,SIGNOUT:`/m5t/v5/acctEntity/signout`,SIGNUP:`/m5t/v5/acctEntity/`,RESET_HASH:`/m5t/v5/acctEntity/resetHash`,RESET_FORGOT:`/m5t/v5/acctEntity/resetforgot`,ME:`/m5t/v5/acctEntity/me`,PING:`/ping`,WEBAUTHN_AUTH_OPTIONS:`/m5t/v5/webauthn/authenticate/options`,WEBAUTHN_AUTH_VERIFY:`/m5t/v5/webauthn/authenticate/verify`},METER_CAPTIONS:{DEEP_LINK:`deep_link_access`,SIGNOUT_CLIENT:`signout_client_initiated`,SIGNOUT_SERVER:`signout_server_initiated`,PING_SUCCESS:`ping_auth_success`,PING_FAILURE:`ping_auth_failure`}};static#e=!1;static#t=null;static#n=null;static#r=null;static#i=null;static#a=null;static#o=null;static async init({BASE_URL:e,navigateFunction:t,customConfig:n={}}={}){if(this.#e)return console.warn(`[AuthController] Already initialized`),!0;try{if(t&&typeof t==`function`)this.#o=t;else throw Error(`navigateFunction is required and must be a function`);return e&&(this.CONFIG.BASE_URL=e),n&&Object.keys(n).length>0&&(this.CONFIG={...this.CONFIG,...n}),console.log(`[AuthController] Initializing with config:`,{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#u(),this.#s(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.#e=!0,console.log(`[AuthController] Initialized successfully`),!0}catch(e){return console.error(`[AuthController] Initialization failed:`,e),!1}}static#s(){if(typeof mvvLegit>`u`||!mvvLegit)throw Error(`mvvLegit is not available. Ensure neodigm55 library is loaded.`);mvvLegit.setNavConroller((e=null)=>{if(e){if(ht(e)){console.log(`[AuthController] Ignoring mvvLegit redirect to`,e,`— keeping visitor on their public landing page`);return}console.log(`[AuthController] mvvLegit navigation to:`,e),this.#c(e)}}).setOnState((e=null)=>{if(e)switch(console.log(`[AuthController] Auth state changed:`,e),e){case`AUTH`:case 4:this.#y();break;case`UNAUTH`:case 1:this.#b();break;case`UNVERF`:case 2:this.#x()}}).init({BASE:this.CONFIG.BASE_URL}),console.log(`[AuthController] mvvLegit initialized`)}static#c(e){if(!this.#o){console.error(`[AuthController] Navigate function not set`);return}console.log(`[AuthController] #navigate called with:`,e);let t=e.replace(/_route$/,``).replace(/_/g,`-`);console.log(`[AuthController] Navigating to path:`,t),this.#o(t)}static#l(){if(window.__m5tActiveOrgFetch)return;let e=window.fetch.bind(window);window.fetch=(t,n)=>{try{let e=typeof t==`string`?t:t?.url||``,r=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);if(r&&e.startsWith(this.CONFIG.BASE_URL)){let e=new Headers(n&&n.headers||(t instanceof Request?t.headers:void 0));e.set(`X-Active-Org`,r),n={...n||{},headers:e}}}catch{}return e(t,n)},window.__m5tActiveOrgFetch=!0,console.log(`[AuthController] Active-org fetch header installed`)}static#u(){try{let e=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);e&&(this.#n=JSON.parse(e),console.log(`[AuthController] Entity state loaded; hasEmail:`,!!this.#n?.email))}catch(e){console.error(`[AuthController] Error loading entity state:`,e),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#n=null}this.#a=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null;try{let e=localStorage.getItem(this.CONFIG.LS_KEYS.SCOPE);e&&(this.#r=JSON.parse(e),console.log(`[AuthController] Scope state loaded (cached):`,this.#r?.uiMode))}catch(e){console.error(`[AuthController] Error loading scope state:`,e),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE),this.#r=null}}static#d(e){try{this.#n=e,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(e)),console.log(`[AuthController] Entity state saved`)}catch(e){console.error(`[AuthController] Error saving entity state:`,e)}}static#f(){this.#n=null,this.#r=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#h)}catch{}}static getEntity(){return this.#n}static#p(e){try{this.#r=e,localStorage.setItem(this.CONFIG.LS_KEYS.SCOPE,JSON.stringify(e))}catch(e){console.error(`[AuthController] Error saving scope state:`,e)}}static async fetchScope(){return typeof mvvLegit>`u`||!this.isAuthenticated()?(console.log(`[AuthController] fetchScope skipped — not authenticated`),this.#r):(this.#i||=this.#m().finally(()=>{this.#i=null}),this.#i)}static async#m(){try{let e=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),t=e?`?org=${encodeURIComponent(e)}`:``,n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.ME}${t}`);if(n.status===401)return console.warn(`[AuthController] /me unauthorized — signing out`),this.doSignout(!0),null;if(!n.ok)return console.warn(`[AuthController] /me failed (${n.status}) — using cached scope`),this.#r;let r=await n.json();if(!r?.ok)return console.warn(`[AuthController] /me returned not-ok — using cached scope`),this.#r;try{let e=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);e&&r.activeOrg?.guid!==e&&(console.warn(`[AuthController] Stored active org not honored by /me${r.activeOrgError?` (activeOrgError)`:``} — clearing`),localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG))}catch{}return this.#p(r),te.default.publish(p.AUTH_SCOPE_LOADED,r),console.log(`[AuthController] Scope loaded: ${r.uiMode} (${r.memberships?.length||0} org(s), ${r.managedClients?.length||0} client(s))`),r}catch(e){return console.error(`[AuthController] fetchScope error:`,e),this.#r}}static async setActiveOrg(e){try{e?localStorage.setItem(this.CONFIG.LS_KEYS.ACTIVE_ORG,e):localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}return this.fetchScope()}static getScope(){return this.#r}static getCapabilities(){return this.isPreviewingAsClient()?Ie({orgChannel:`managed_client`,memberRole:`owner`}):this.#r?.capabilities||[]}static getUiMode(){return this.isPreviewingAsClient()?`managed`:this.#r?.uiMode||`self_serve`}static getActiveOrg(){return this.#r?.activeOrg||null}static getMemberships(){return this.#r?.memberships||[]}static getManagedClients(){return this.#r?.managedClients||[]}static isClientScopeRestricted(){return!!this.#r?.clientScopeRestricted}static getStoredActiveOrg(){try{return localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{return null}}static#h=`m5m_preview_as_client`;static isPreviewingAsClient(){try{return sessionStorage.getItem(this.#h)===`1`&&!!this.#r?.activeOrg?.viaSubtree}catch{return!1}}static setPreviewAsClient(e){try{e?sessionStorage.setItem(this.#h,`1`):sessionStorage.removeItem(this.#h)}catch{}this.#r&&te.default.publish(p.AUTH_SCOPE_LOADED,this.#r)}static async doSignin(e,t){try{let n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({email:e,password:t})}),r=await n.json();if(n.status===303)return console.warn(`[AuthController] Password reset required`),r.accessToken&&(mvvLegit.doSignin(r.accessToken),this.#d(r.entity)),setTimeout(()=>{this.#c(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:r};if(n.ok&&r.accessToken){console.log(`[AuthController] Signin successful, calling mvvLegit.doSignin()`),mvvLegit.doSignin(r.accessToken),this.#d(r.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#h)}catch{}return this.fetchScope(),console.log(`[AuthController] Explicitly navigating to home`),this.#c(this.CONFIG.ROUTES.HOME),{ok:!0,data:r}}return{ok:!1,error:r.error||`Sign in failed`,data:r}}catch(e){return console.error(`[AuthController] Signin error:`,e),{ok:!1,error:e.message}}}static async doPasskeySignin(){if(!window.PublicKeyCredential)return{ok:!1,error:`Passkeys are not supported in this browser`};try{let{startAuthentication:e}=await C(async()=>{let{startAuthentication:e}=await Promise.resolve().then(()=>(an(),rn));return{startAuthentication:e}},void 0,import.meta.url),t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_OPTIONS}`,{method:`POST`}),n=await t.json();if(!t.ok||!n.ok)return{ok:!1,error:n.error||`Could not start passkey sign-in`};let r;try{r=await e({optionsJSON:n.options})}catch(e){let t=e?.name===`NotAllowedError`;return t||console.error(`[AuthController] Passkey ceremony error:`,e),{ok:!1,canceled:t,error:t?`Passkey sign-in was canceled`:e.message||`Passkey sign-in failed`}}let i=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_VERIFY}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({response:r})}),a=await i.json();if(!i.ok||!a.ok||!a.accessToken)return{ok:!1,error:a.error||`Passkey sign-in failed`,data:a};mvvLegit.doSignin(a.accessToken),this.#d(a.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#h)}catch{}return this.fetchScope(),this.#c(this.CONFIG.ROUTES.HOME),{ok:!0,data:a}}catch(e){return console.error(`[AuthController] Passkey signin error:`,e),{ok:!1,error:e.message}}}static async doSignout(e=!1){console.log(`[AuthController] doSignout called, serverInitiated:`,e);try{let t=mvvLegit.getConf()?.token;if(console.log(`[AuthController] Token exists:`,!!t),!e&&t){let e=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(t)}`;if(console.log(`[AuthController] Sending signout beacon to:`,e),navigator.sendBeacon){let t=navigator.sendBeacon(e);console.log(`[AuthController] Beacon sent:`,t),t||console.warn(`[AuthController] Beacon failed - browser may be blocking it`)}else console.warn(`[AuthController] navigator.sendBeacon not supported, signout not metered`)}else t||console.warn(`[AuthController] No token found for signout request`);console.log(`[AuthController] Clearing mvvLegit state...`),mvvLegit.doSignout(),console.log(`[AuthController] Setting signout timestamp...`),localStorage.setItem(`mvv_ts`,Date.now().toString()),console.log(`[AuthController] Clearing entity state...`),this.#f(),console.log(`[AuthController] Stopping auth ping...`),this.#_(),setTimeout(()=>{console.log(`[AuthController] Performing hard refresh...`),typeof neodigmUtils<`u`&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(e){console.error(`[AuthController] Signout error:`,e),setTimeout(()=>{typeof neodigmUtils<`u`&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(e){try{let t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json();return t.ok&&n.accessToken?(console.log(`[AuthController] Signup successful - user needs to verify email`),this.#d(n.entity),{ok:!0,data:n}):{ok:!1,error:n.error||`Sign up failed`,data:n}}catch(e){return console.error(`[AuthController] Signup error:`,e),{ok:!1,error:e.message}}}static async doResetHash(e,t){try{let n=mvvLegit.getConf()?.token,r=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:`POST`,headers:{Authorization:`Bearer ${n}`,"Content-Type":`application/json`},body:JSON.stringify({email:e,password:t,modified_by:e})}),i=await r.json();return r.ok&&i.ok?(console.log(`[AuthController] Password reset successful`),await this.doSignout(),{ok:!0,data:i}):{ok:!1,error:i.error||`Password reset failed`,data:i}}catch(e){return console.error(`[AuthController] Reset password error:`,e),{ok:!1,error:e.message}}}static#g(){this.#t&&(console.log(`[AuthController] Clearing existing ping interval`),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#v()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#_(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log(`[AuthController] Auth ping stopped`))}static async#v(){try{let e=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);e.ok?console.log(`[AuthController] Ping success`):e.status===401&&(console.warn(`[AuthController] Auth ping failed - signing out`),this.doSignout(!0))}catch(e){console.error(`[AuthController] Ping error:`,e)}}static setDeepLinkGuid(e){this.#a=e,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,e),console.log(`[AuthController] Deep-link GUID stored:`,e)}static getDeepLinkGuid(){return this.#a}static clearDeepLink(){this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#y(){console.log(`[AuthController] User authenticated`),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),queueMicrotask(()=>this.fetchScope())}static#b(){console.log(`[AuthController] User unauthenticated`),this.#_()}static#x(){console.log(`[AuthController] User unverified`)}static getAuthState(){try{let e=mvvLegit.getConf()?.LSKEY||`mvv`,t=localStorage.getItem(e);if(!t)return`UNAUTH`;if(typeof LZString>`u`)return null;let n=LZString.decompressFromUTF16(t),r=JSON.parse(n)?.state;return r===1?`UNAUTH`:r===2?`UNVERF`:r===4?`AUTH`:r===5?`FORGOT`:null}catch{return null}}static isAuthenticated(){return this.getAuthState()===`AUTH`}static getConfig(){return this.CONFIG}static navigateTo(e){this.#c(e)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log(`[AuthController] DEBUG: Manually triggering ping...`),await this.#v()}}})),E=u(f(),1);m(),x(),T();function on(){let e=e=>e=>{let t=e.detail?.pubsubTopic;t&&E.default.publish(t,e.detail)};document.addEventListener(`nav-select`,e(`nav-select`)),document.addEventListener(`logo-click`,e(`logo-click`)),document.addEventListener(`nav-hover`,e(`nav-hover`)),document.addEventListener(`nav-double-tap`,e(`nav-double-tap`)),document.addEventListener(`nav-long-tap`,e(`nav-long-tap`)),document.addEventListener(`message-sent`,e(`message-sent`))}function sn(){console.log(`[AppEvents] Initializing event listeners...`),pe(),me(()=>w.fetchScope()),he(()=>w.doSignout()),E.default.subscribe(p.APP_READY,(e,t)=>{console.log(`[AppEvents] APP_READY:`,t)}),E.default.subscribe(p.APP_ERROR,(e,t)=>{console.error(`[AppEvents] APP_ERROR:`,t)}),E.default.subscribe(p.APP_SIGNOUT,(e,t)=>{console.log(`[AppEvents] APP_SIGNOUT:`,t)}),E.default.subscribe(p.ROUTE_NAV_BEFORE,(e,t)=>{console.log(`[AppEvents] ROUTE_NAV_BEFORE:`,t),E.default.publish(p.UI_LOADING_START)}),E.default.subscribe(p.ROUTE_NAV_AFTER,(e,t)=>{console.log(`[AppEvents] ROUTE_NAV_AFTER:`,t),E.default.publish(p.UI_LOADING_END)}),E.default.subscribe(p.ROUTE_NAV_ERROR,(e,t)=>{console.error(`[AppEvents] ROUTE_NAV_ERROR:`,t),E.default.publish(p.APP_ERROR,{message:`Navigation error`,details:t})}),E.default.subscribe(p.AUTH_SIGNIN_SUCCESS,(e,t)=>{console.log(`[AppEvents] AUTH_SIGNIN_SUCCESS:`,t)}),E.default.subscribe(p.AUTH_SIGNIN_FAIL,(e,t)=>{console.error(`[AppEvents] AUTH_SIGNIN_FAIL:`,t),E.default.publish(p.UI_TOAST,{message:t.message||`Sign in failed`,type:`danger`})}),E.default.subscribe(p.AUTH_SIGNUP_SUCCESS,(e,t)=>{console.log(`[AppEvents] AUTH_SIGNUP_SUCCESS:`,t),E.default.publish(p.UI_TOAST,{message:`Account created! Please check your email to verify.`,type:`success`}),E.default.publish(p.AUTH_VERIFY_LINK)}),E.default.subscribe(p.AUTH_VERIFY_LINK,(e,t)=>{console.log(`[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route`),window.router&&window.router.navigate(`/verf-link`)}),E.default.subscribe(p.AUTH_SIGNUP_FAIL,(e,t)=>{console.error(`[AppEvents] AUTH_SIGNUP_FAIL:`,t),E.default.publish(p.UI_TOAST,{message:t.message||`Sign up failed`,type:`danger`})}),E.default.subscribe(p.AUTH_SIGNOUT_SUCCESS,(e,t)=>{console.log(`[AppEvents] AUTH_SIGNOUT_SUCCESS:`,t),E.default.publish(p.UI_TOAST,{message:`Signed out successfully`,type:`info`})}),E.default.subscribe(p.AUTH_SIGNUP,(e,t)=>{console.log(`[AppEvents] AUTH_SIGNUP: Navigating to signup route`),window.router&&window.router.navigate(`/signup`)}),E.default.subscribe(p.AUTH_FORGOT,(e,t)=>{console.log(`[AppEvents] AUTH_FORGOT: Navigating to forgot route`),window.router&&window.router.navigate(`/forgot`)}),E.default.subscribe(p.AUTH_FORGOT_SUCCESS,(e,t)=>{console.log(`[AppEvents] AUTH_FORGOT_SUCCESS:`,t),E.default.publish(p.UI_TOAST,{message:`Password reset email sent!`,type:`success`})}),E.default.subscribe(p.AUTH_RESETHASH_NAV,(e,t)=>{console.log(`[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route`),window.router&&window.router.navigate(`/resethash`)}),E.default.subscribe(p.AUTH_RESETHASH_SUCCESS,(e,t)=>{console.log(`[AppEvents] AUTH_RESETHASH_SUCCESS:`,t),E.default.publish(p.UI_TOAST,{message:`Password reset successfully! Please sign in.`,type:`success`})}),E.default.subscribe(p.AUTH_TOKEN_EXPIRED,(e,t)=>{console.warn(`[AppEvents] AUTH_TOKEN_EXPIRED:`,t),E.default.publish(p.UI_TOAST,{message:`Session expired. Please sign in again.`,type:`warning`})}),E.default.subscribe(p.I18N_SET_LANG,(e,t)=>{console.log(`[AppEvents] I18N_SET_LANG:`,t);let{langCode:n}=t;if(!n){console.error(`[AppEvents] No langCode provided in I18N_SET_LANG event`);return}if(window.I18nController&&typeof window.I18nController.setLanguage==`function`)try{window.I18nController.setLanguage(n),console.log(`[AppEvents] Language changed successfully to:`,n),E.default.publish(p.UI_TOAST,{message:`Language changed to ${n}`,type:`success`})}catch(e){console.error(`[AppEvents] Error changing language:`,e),E.default.publish(p.UI_TOAST,{message:`Failed to change language: ${e.message}`,type:`danger`})}else console.error(`[AppEvents] I18nController not available`)}),E.default.subscribe(`CONVERSATION.PROMPT`,(e,t)=>{let n=e.split(`.`)[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${n}:`,t),!t||!t.message){console.warn(`[AppEvents] CONVERSATION.PROMPT received without message data`);return}switch(n){case`CANVAS`:console.log(`[AppEvents] Display prompt in canvas:`,t.message),cn(t.message,`user`,t.timestamp),E.default.publish(p.CANVAS_DO_SCROLL);break;case`AGENT`:console.log(`[AppEvents] Agent prompt (no implementation):`,t.message);break;case`AGENT_CANVAS`:console.log(`[AppEvents] Display message in canvas:`,t.message),cn(t.message,`user`,t.timestamp),E.default.publish(p.CANVAS_DO_SCROLL);break;case`STAGE`:console.log(`[AppEvents] Stage prompt for editing:`,t.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${n}`)}}),E.default.subscribe(`CONVERSATION.RESPONSE`,(e,t)=>{let n=e.split(`.`)[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${n}:`,t),!t||!t.message){console.warn(`[AppEvents] CONVERSATION.RESPONSE received without message data`);return}switch(n){case`CANVAS`:console.log(`[AppEvents] Display response in canvas:`,t.message),cn(t.message,`assistant`,t.timestamp,t.streaming);break;case`WORKFLOW`:console.log(`[AppEvents] Send response to workflow engine:`,t.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${n}`)}}),E.default.subscribe(p.UI_LOADING_START,(e,t)=>{let n=document.getElementById(`app-loader`);n&&n.classList.add(`active`)}),E.default.subscribe(p.UI_LOADING_END,(e,t)=>{let n=document.getElementById(`app-loader`);n&&n.classList.remove(`active`)}),E.default.subscribe(p.UI_TOAST,(e,t)=>{le(t)}),E.default.subscribe(p.UI_WELCOME_BACK_CLICKED,()=>{console.log(`[AppEvents] UI_WELCOME_BACK_CLICKED`);let e=new Date().getFullYear();typeof neodigmToast<`u`&&neodigmToast.q(`0.1 9/14/2026, 6:28:28 PM|© ${e} Mach Five Tech`,`night`)}),on(),E.default.subscribe(`M5T_PRIMARY_NAV`,(n,r)=>{let i=n.split(`.`)[1];switch(i){case`TAP`:e(r);break;case`LOGO_TAP`:t(r);break;case`HOVER`:break;case`DOUBLE_TAP`:break;case`LONG_TAP`:break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${i}`)}});function e(e){let{token:t,level:n,primaryToken:r}=e;switch(t){case`RESET_PASSWORD`:console.log(`[AppEvents] Password reset requested`),E.default.publish(p.AUTH_RESETHASH_NAV);break;case`SIGN_OUT`:console.log(`[AppEvents] Sign out requested`),window.router&&window.router.navigate(`/signout`);break;default:console.log(`[AppEvents] Navigation: ${n} -> ${t}`,{primaryToken:r})}}function t(e){let t=new Date().getFullYear();typeof neodigmToast<`u`&&neodigmToast.q(`0.1 9/14/2026, 6:28:28 PM|© ${t} Mach Five Tech`,`night`,5e3)}E.default.subscribe(p.AUTH_SIGNOUT,(e,t)=>{console.log(`[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage`),localStorage.removeItem(v.FF_SSE_LS_SESSION_USER)}),console.log(`[AppEvents] Event listeners initialized`)}function cn(e,t=`user`,n=null,r=!1){let i=document.getElementById(`chat-messages`);if(!i){console.warn(`[AppEvents] chat-messages element not found - may not be on home route`);return}if(n||=new Date().toLocaleTimeString(`en-US`,{hour:`numeric`,minute:`2-digit`}),r&&t===`assistant`){let n=i.firstElementChild;if(n&&n.tagName.toLowerCase()===`m5t-chat-response`){n.setAttribute(`message`,e),console.log(`[AppEvents] Updated streaming ${t} bubble (${e.length} chars)`);return}}let a;a=t===`user`||t===`prompt`?document.createElement(`m5t-chat-prompt`):document.createElement(`m5t-chat-response`),a.setAttribute(`message`,e),a.setAttribute(`timestamp`,n),i.prepend(a),console.log(`[AppEvents] Added ${t} bubble to canvas (${e.length} chars)`)}var D,ln=o((()=>{D=class{static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:`Welcome back`,please_enter_your_details:`Please enter your details`,email:`Email`,enter_your_email:`Enter your email`,password:`Password`,enter_your_password:`Enter your password`,enter_email_and_password:`Enter email and password`,sign_in:`Sign in`,forgot_password:`Forgot password?`,remember_email:`Remember my email`,dont_have_an_account:`START YOUR FREE ACCOUNT`,sign_up:`Sign up`,please_enter_your_details_to_get_started:`Please enter your details to get started`,already_have_an_account:`Already have an account?`,log_in:`Log in`,name:`Name`,enter_your_name:`Enter your name`,first_name:`First name`,last_name:`Last name`,company:`Company`,phone:`Phone`,confirm_password:`Confirm password`,create_account:`Create account`,home:`Home`,dashboard:`Dashboard`,correspondence:`Correspondence`,settings:`Settings`,sign_out:`Sign out`,reset_password:`Reset password`,new_password:`New password`,confirm_new_password:`Confirm new password`,enter_new_password:`Enter new password`,enter_company_name:`Enter your company name`,enter_phone_number:`Enter your phone number`,reenter_password:`Re-enter your password`,update_password:`Update password`,update_your_password:`Update your account password`,are_you_sure_sign_out:`Are you sure you want to sign out?`,enter_email_for_reset:`Please enter your email to receive a password reset link`,send_reset_link:`Send reset link`,remember_password:`Remember your password?`,cancel:`Cancel`,save:`Save`,delete:`Delete`,edit:`Edit`,loading:`Loading...`,error:`Error`,success:`Success`,refresh:`Refresh`,search:`Search`,filter:`Filter`,sort:`Sort`,view:`View`,close:`Close`,submit:`Submit`,back:`Back`,next:`Next`,previous:`Previous`,confirm:`Confirm`,yes:`Yes`,no:`No`,ok:`OK`,validation_email_required:`Please enter your email`,validation_email_invalid:`Please enter a valid email address`,validation_password_required:`Please enter your password`,validation_password_min_length:`Password must be at least 10 characters`,validation_password_mismatch:`Passwords do not match`,validation_first_name_required:`Please enter your first name`,validation_last_name_required:`Please enter your last name`,validation_new_password_required:`Please enter a new password`,success_welcome_back:`Welcome back!`,success_password_reset:`Password reset successfully`,success_signed_out:`Signed out successfully`,success_reset_link_sent:`Password reset link sent!|Please check your email`,error_signin_failed:`Sign in failed`,error_signup_failed:`Sign up failed`,error_network:`Network error - please try again`,error_password_reset_required:`Password reset required - redirecting...`,loading_signing_in:`SIGNING IN...`,loading_creating_account:`Creating account...`,loading_resetting_password:`Resetting password...`,nav_home:`Home`,nav_home_tagline:`Dashboard and overview`,nav_home_apps:`My Apps`,nav_home_apps_tagline:`Your applications and integrations`,nav_home_dash:`Dashboard`,nav_home_dash_tagline:`Main dashboard and analytics`,nav_engagements:`Engagements`,nav_engagements_tagline:`Customer engagement tools and interactions`,nav_develop:`Develop`,nav_develop_tagline:`Development tools and resources`,nav_profile:`Profile`,nav_profile_tagline:`Account settings and preferences`,nav_engagements_surveys:`Surveys`,nav_engagements_surveys_tagline:`Create and manage customer surveys`,nav_engagements_thumbs:`Feedback`,nav_engagements_thumbs_tagline:`Collect thumbs up/down feedback`,nav_engagements_voicemail:`Voicemail`,nav_engagements_voicemail_tagline:`Voice message collection`,nav_engagements_guidedtours:`Guided Tours`,nav_engagements_guidedtours_tagline:`Interactive product tours`,nav_engagements_slideshows:`Slideshows`,nav_engagements_slideshows_tagline:`Content slideshows and presentations`,nav_engagements_abtests:`A/B Tests`,nav_engagements_abtests_tagline:`A/B testing campaigns`,nav_engagements_questionnaires:`Questionnaires`,nav_engagements_questionnaires_tagline:`Detailed questionnaires and forms`,nav_develop_documentation:`Documentation`,nav_develop_documentation_tagline:`API and product documentation`,nav_develop_devtools:`Dev Tools`,nav_develop_devtools_tagline:`Developer tools and utilities`,nav_develop_kbase:`Knowledge Base`,nav_develop_kbase_tagline:`Technical knowledge base and articles`,nav_develop_hackathon:`Hackathon`,nav_develop_hackathon_tagline:`Hackathon events and challenges`,nav_develop_partner:`Partner`,nav_develop_partner_tagline:`Partner program and integrations`,nav_develop_certification:`Certification`,nav_develop_certification_tagline:`Developer certification programs`,nav_profile_aboutme:`About Me`,nav_profile_aboutme_tagline:`View and edit your personal information`,nav_profile_badges:`Badges`,nav_profile_badges_tagline:`View your earned badges and achievements`,nav_profile_language:`Language`,nav_profile_language_tagline:`Manage language settings and preferences`,nav_reset_password:`Reset Password`,nav_reset_password_tagline:`Change your account password`,nav_sign_out:`Sign Out`,nav_sign_out_tagline:`Sign out of your account`,nav_account:`Account`,nav_account_tagline:`Account management and support`,nav_account_contact:`Contact`,nav_account_contact_tagline:`Contact support and sales`,nav_account_pricetier:`Price Tier`,nav_account_pricetier_tagline:`View and manage pricing plans`,nav_account_helpfaq:`Help & FAQ`,nav_account_helpfaq_tagline:`Frequently asked questions and help`,nav_account_team:`Team`,nav_account_team_tagline:`Manage team members and permissions`,nav_account_terms:`Terms`,nav_account_terms_tagline:`Terms of service and legal agreements`,nav_dashboard:`Dashboard`,nav_dashboard_tagline:`Overview of your activity`,nav_magnets:`Your Magnets`,nav_magnets_tagline:`Manage your conversational magnets`,nav_templates:`Templates`,nav_templates_tagline:`Start from a magnet template`,nav_conversations:`Conversations`,nav_conversations_tagline:`Captured lead conversations`,nav_ab_testing:`A/B Testing`,nav_ab_testing_tagline:`Experiment and optimize`,nav_analytics:`Analytics`,nav_analytics_tagline:`Performance and ad metrics`,nav_ad_accounts:`Ad Accounts`,nav_ad_accounts_tagline:`Connect advertising accounts`,nav_clients:`Clients`,nav_clients_tagline:`Manage your client accounts`,nav_team:`Team`,nav_team_tagline:`Invite and manage teammates`,nav_billing:`Billing`,nav_billing_tagline:`Plan, usage, and invoices`,nav_settings:`Settings`,nav_settings_tagline:`Account and workspace settings`,nav_home:`Home`,nav_home_tagline:`Admin console home dashboard`,nav_entities:`Entities`,nav_entities_tagline:`Entity and account management`,nav_accounts:`Accounts`,nav_accounts_tagline:`User account management`,nav_groups:`Groups`,nav_groups_tagline:`Group and role management`,nav_invoices:`Invoices`,nav_invoices_tagline:`Invoice and billing management`,nav_ab_tests:`A/B Tests`,nav_ab_tests_tagline:`A/B testing campaigns`,nav_feedback:`Feedback`,nav_feedback_tagline:`User feedback collection`,nav_guided_tours:`Guided Tours`,nav_guided_tours_tagline:`Interactive product tours`,nav_questionnaires:`Questionnaires`,nav_questionnaires_tagline:`Detailed questionnaires and forms`,nav_slideshows:`Slideshows`,nav_slideshows_tagline:`Content slideshows and presentations`,nav_surveys:`Surveys`,nav_surveys_tagline:`Survey campaigns and analytics`,nav_voicemail:`Voicemail`,nav_voicemail_tagline:`Voice message management`,nav_ethercards:`EtherCards`,nav_ethercards_tagline:`EtherCards platform management`,nav_apps:`Apps`,nav_apps_tagline:`Application management`,nav_channels:`Channels`,nav_channels_tagline:`Communication channels`,nav_messages:`Messages`,nav_messages_tagline:`Message management and templates`,nav_content:`Content`,nav_content_tagline:`Content and asset management`,nav_rss:`RSS`,nav_rss_tagline:`RSS feed management and syndication`,nav_core_assets:`Core Assets`,nav_core_assets_tagline:`Manage core application assets and resources`,nav_deeplinks:`Deeplinks`,nav_deeplinks_tagline:`Deep link management and tracking`,nav_snippets:`Snippets`,nav_snippets_tagline:`Code and content snippet management`,nav_rollers:`Magnet Builder`,nav_rollers_tagline:`Rolling deployments and version management`,nav_support:`Support`,nav_support_tagline:`Support and monitoring tools`,nav_dialog:`Dialog`,nav_dialog_tagline:`Dialog and modal management`,nav_meter:`Meter`,nav_meter_tagline:`Usage metering and analytics`,nav_metadata:`Metadata`,nav_metadata_tagline:`Metadata and configuration`,nav_i18n:`I18N`,nav_i18n_tagline:`Internationalization maintenance`,nav_meta_maint:`Meta Maint`,nav_meta_maint_tagline:`Metadata maintenance and configuration`,nav_silos:`Silos`,nav_silos_tagline:`Data silo management`,nav_cache:`Cache`,nav_cache_tagline:`Cache management and statistics`,nav_lifecycle:`Lifecycle`,nav_lifecycle_tagline:`Data lifecycle and retention policies`,nav_notifications:`Notifications`,nav_notifications_tagline:`Notification management`,nav_bell_drawer:`Bell Drawer`,nav_bell_drawer_tagline:`Notification drawer configuration`,nav_web_hooks:`Web Hooks`,nav_web_hooks_tagline:`Webhook configuration and monitoring`,nav_language:`Language`,nav_language_tagline:`Change language preferences`},es:{welcome_back:`Bienvenido de nuevo`,please_enter_your_details:`Por favor ingrese sus datos`,email:`Correo electrónico`,enter_your_email:`Ingrese su correo electrónico`,password:`Contraseña`,enter_your_password:`Ingrese su contraseña`,enter_email_and_password:`Ingrese correo y contraseña`,sign_in:`Iniciar sesión`,forgot_password:`¿Olvidó su contraseña?`,remember_email:`Recordar mi correo electrónico`,dont_have_an_account:`¿No tiene una cuenta?`,sign_up:`Registrarse`,please_enter_your_details_to_get_started:`Ingrese sus datos para comenzar`,already_have_an_account:`¿Ya tiene una cuenta?`,log_in:`Iniciar sesión`,name:`Nombre`,enter_your_name:`Ingrese su nombre`,first_name:`Nombre`,last_name:`Apellido`,company:`Empresa`,phone:`Teléfono`,confirm_password:`Confirmar contraseña`,create_account:`Crear cuenta`,home:`Inicio`,dashboard:`Panel`,correspondence:`Correspondencia`,settings:`Configuración`,sign_out:`Cerrar sesión`,reset_password:`Restablecer contraseña`,new_password:`Nueva contraseña`,confirm_new_password:`Confirmar nueva contraseña`,enter_new_password:`Ingrese nueva contraseña`,enter_company_name:`Ingrese el nombre de su empresa`,enter_phone_number:`Ingrese su número de teléfono`,reenter_password:`Vuelva a ingresar su contraseña`,update_password:`Actualizar contraseña`,update_your_password:`Actualice la contraseña de su cuenta`,are_you_sure_sign_out:`¿Está seguro de que desea cerrar sesión?`,enter_email_for_reset:`Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña`,send_reset_link:`Enviar enlace de restablecimiento`,remember_password:`¿Recuerda su contraseña?`,cancel:`Cancelar`,save:`Guardar`,delete:`Eliminar`,edit:`Editar`,loading:`Cargando...`,error:`Error`,success:`Éxito`,refresh:`Actualizar`,search:`Buscar`,filter:`Filtrar`,sort:`Ordenar`,view:`Ver`,close:`Cerrar`,submit:`Enviar`,back:`Atrás`,next:`Siguiente`,previous:`Anterior`,confirm:`Confirmar`,yes:`Sí`,no:`No`,ok:`OK`,validation_email_required:`Por favor ingrese su correo electrónico`,validation_email_invalid:`Por favor ingrese una dirección de correo válida`,validation_password_required:`Por favor ingrese su contraseña`,validation_password_min_length:`La contraseña debe tener al menos 10 caracteres`,validation_password_mismatch:`Las contraseñas no coinciden`,validation_first_name_required:`Por favor ingrese su nombre`,validation_last_name_required:`Por favor ingrese su apellido`,validation_new_password_required:`Por favor ingrese una nueva contraseña`,success_welcome_back:`¡Bienvenido de nuevo!`,success_password_reset:`Contraseña restablecida exitosamente`,success_signed_out:`Sesión cerrada exitosamente`,success_reset_link_sent:`¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico`,error_signin_failed:`Error al iniciar sesión`,error_signup_failed:`Error al registrarse`,error_network:`Error de red - por favor intente de nuevo`,error_password_reset_required:`Restablecimiento de contraseña requerido - redirigiendo...`,loading_signing_in:`INICIANDO SESIÓN...`,loading_creating_account:`Creando cuenta...`,loading_resetting_password:`Restableciendo contraseña...`,nav_home:`Inicio`,nav_home_tagline:`Panel y resumen`,nav_home_apps:`Mis Aplicaciones`,nav_home_apps_tagline:`Sus aplicaciones e integraciones`,nav_home_dash:`Panel`,nav_home_dash_tagline:`Panel principal y análisis`,nav_engagements:`Compromisos`,nav_engagements_tagline:`Herramientas de interacción con clientes`,nav_develop:`Desarrollar`,nav_develop_tagline:`Herramientas y recursos de desarrollo`,nav_profile:`Perfil`,nav_profile_tagline:`Configuración y preferencias de cuenta`,nav_engagements_surveys:`Encuestas`,nav_engagements_surveys_tagline:`Crear y gestionar encuestas de clientes`,nav_engagements_thumbs:`Retroalimentación`,nav_engagements_thumbs_tagline:`Recopilar opiniones positivas y negativas`,nav_engagements_voicemail:`Buzón de voz`,nav_engagements_voicemail_tagline:`Recopilación de mensajes de voz`,nav_engagements_guidedtours:`Recorridos guiados`,nav_engagements_guidedtours_tagline:`Recorridos interactivos de productos`,nav_engagements_slideshows:`Presentaciones`,nav_engagements_slideshows_tagline:`Presentaciones y diapositivas de contenido`,nav_engagements_abtests:`Pruebas A/B`,nav_engagements_abtests_tagline:`Campañas de pruebas A/B`,nav_engagements_questionnaires:`Cuestionarios`,nav_engagements_questionnaires_tagline:`Cuestionarios y formularios detallados`,nav_develop_documentation:`Documentación`,nav_develop_documentation_tagline:`Documentación de API y productos`,nav_develop_devtools:`Herramientas Dev`,nav_develop_devtools_tagline:`Herramientas y utilidades de desarrollo`,nav_develop_kbase:`Base de Conocimientos`,nav_develop_kbase_tagline:`Base de conocimientos y artículos técnicos`,nav_develop_hackathon:`Hackathon`,nav_develop_hackathon_tagline:`Eventos y desafíos de hackathon`,nav_develop_partner:`Socio`,nav_develop_partner_tagline:`Programa de socios e integraciones`,nav_develop_certification:`Certificación`,nav_develop_certification_tagline:`Programas de certificación para desarrolladores`,nav_profile_aboutme:`Sobre Mí`,nav_profile_aboutme_tagline:`Ver y editar su información personal`,nav_profile_badges:`Insignias`,nav_profile_badges_tagline:`Ver sus insignias y logros obtenidos`,nav_profile_language:`Idioma`,nav_profile_language_tagline:`Gestionar configuración y preferencias de idioma`,nav_reset_password:`Restablecer Contraseña`,nav_reset_password_tagline:`Cambiar la contraseña de su cuenta`,nav_sign_out:`Cerrar Sesión`,nav_sign_out_tagline:`Cerrar sesión de su cuenta`,nav_account:`Cuenta`,nav_account_tagline:`Gestión de cuenta y soporte`,nav_account_contact:`Contacto`,nav_account_contact_tagline:`Contactar con soporte y ventas`,nav_account_pricetier:`Nivel de Precio`,nav_account_pricetier_tagline:`Ver y gestionar planes de precios`,nav_account_helpfaq:`Ayuda y FAQ`,nav_account_helpfaq_tagline:`Preguntas frecuentes y ayuda`,nav_account_team:`Equipo`,nav_account_team_tagline:`Gestionar miembros del equipo y permisos`,nav_account_terms:`Términos`,nav_account_terms_tagline:`Términos de servicio y acuerdos legales`,nav_home:`Inicio`,nav_home_tagline:`Panel de inicio de la consola de administración`,nav_silo_audits:`Auditorías de Silo`,nav_silo_audits_tagline:`Auditar e inspeccionar datos de silo`,nav_cache:`Caché`,nav_cache_tagline:`Gestión de caché y estadísticas`,nav_cache_stats:`Estadísticas`,nav_cache_stats_tagline:`Estadísticas de rendimiento de caché`,nav_dialog_links:`Enlaces de Diálogo`,nav_dialog_links_tagline:`Gestionar configuraciones de enlaces de diálogo y modal`,nav_i18n_maint:`Mant. I18n`,nav_i18n_maint_tagline:`Mantenimiento de internacionalización y gestión de microcopia`,nav_meta_maint:`Mant. Meta`,nav_meta_maint_tagline:`Mantenimiento de metadatos y configuración`,nav_bell_drawer:`Cajón de Campana`,nav_bell_drawer_tagline:`Gestión de notificaciones y configuración del cajón de campana`,nav_meter:`Medidor`,nav_meter_tagline:`Medición de uso y analíticas`,nav_deeplinks:`Enlaces Profundos`,nav_deeplinks_tagline:`Gestión y seguimiento de enlaces profundos`,nav_rss:`RSS`,nav_rss_tagline:`Gestión de feeds RSS y sindicación`,nav_core_assets:`Activos Principales`,nav_core_assets_tagline:`Gestionar activos y recursos principales de la aplicación`,nav_web_hooks:`Web Hooks`,nav_web_hooks_tagline:`Configuración y monitoreo de webhooks`,nav_snippets:`Fragmentos`,nav_snippets_tagline:`Gestión de fragmentos de código y contenido`,nav_snippets_sql:`SQL`,nav_snippets_sql_tagline:`Fragmentos y plantillas de consultas SQL`,nav_snippets_js:`JS`,nav_snippets_js_tagline:`Fragmentos de código JavaScript`,nav_rollers:`Magnet Builder`,nav_rollers_tagline:`Despliegues progresivos y gestión de versiones`,nav_rollers_primary_nav:`Nav Primaria`,nav_rollers_primary_nav_tagline:`Configuración del roller de navegación primaria`},"zh-Hans":{welcome_back:`欢迎回来`,please_enter_your_details:`请输入您的详细信息`,email:`电子邮件`,enter_your_email:`输入您的电子邮件`,password:`密码`,enter_your_password:`输入您的密码`,enter_email_and_password:`输入邮箱和密码`,sign_in:`登入`,forgot_password:`忘记密码？`,remember_email:`记住我的邮箱`,dont_have_an_account:`没有账户？`,sign_up:`报名`,please_enter_your_details_to_get_started:`请输入您的详细信息以开始`,already_have_an_account:`已有账户？`,log_in:`登录`,name:`姓名`,enter_your_name:`输入您的姓名`,first_name:`名字`,last_name:`姓氏`,company:`公司`,phone:`电话`,confirm_password:`确认密码`,create_account:`创建账户`,home:`首页`,dashboard:`仪表板`,correspondence:`信件`,settings:`设置`,sign_out:`登出`,reset_password:`重置密码`,new_password:`新密码`,confirm_new_password:`确认新密码`,enter_new_password:`输入新密码`,enter_company_name:`输入您的公司名称`,enter_phone_number:`输入您的电话号码`,reenter_password:`重新输入您的密码`,update_password:`更新密码`,update_your_password:`更新您的账户密码`,are_you_sure_sign_out:`您确定要登出吗？`,enter_email_for_reset:`请输入您的电子邮件以接收密码重置链接`,send_reset_link:`发送重置链接`,remember_password:`记得您的密码？`,cancel:`取消`,save:`保存`,delete:`删除`,edit:`编辑`,loading:`加载中...`,error:`错误`,success:`成功`,refresh:`刷新`,search:`搜索`,filter:`筛选`,sort:`排序`,view:`查看`,close:`关闭`,submit:`提交`,back:`返回`,next:`下一个`,previous:`上一个`,confirm:`确认`,yes:`是`,no:`否`,ok:`确定`,validation_email_required:`请输入您的电子邮件`,validation_email_invalid:`请输入有效的电子邮件地址`,validation_password_required:`请输入您的密码`,validation_password_min_length:`密码必须至少10个字符`,validation_password_mismatch:`密码不匹配`,validation_first_name_required:`请输入您的名字`,validation_last_name_required:`请输入您的姓氏`,validation_new_password_required:`请输入新密码`,success_welcome_back:`欢迎回来！`,success_password_reset:`密码重置成功`,success_signed_out:`成功登出`,success_reset_link_sent:`密码重置链接已发送！|请检查您的电子邮件`,error_signin_failed:`登录失败`,error_signup_failed:`注册失败`,error_network:`网络错误 - 请重试`,error_password_reset_required:`需要重置密码 - 正在重定向...`,loading_signing_in:`正在登录...`,loading_creating_account:`正在创建账户...`,loading_resetting_password:`正在重置密码...`,nav_home:`首页`,nav_home_tagline:`仪表板和概览`,nav_home_apps:`我的应用`,nav_home_apps_tagline:`您的应用程序和集成`,nav_home_dash:`仪表板`,nav_home_dash_tagline:`主仪表板和分析`,nav_engagements:`互动`,nav_engagements_tagline:`客户互动工具和交互`,nav_develop:`开发`,nav_develop_tagline:`开发工具和资源`,nav_profile:`个人资料`,nav_profile_tagline:`账户设置和偏好`,nav_engagements_surveys:`调查`,nav_engagements_surveys_tagline:`创建和管理客户调查`,nav_engagements_thumbs:`反馈`,nav_engagements_thumbs_tagline:`收集赞成和反对意见`,nav_engagements_voicemail:`语音信箱`,nav_engagements_voicemail_tagline:`语音留言收集`,nav_engagements_guidedtours:`引导式导览`,nav_engagements_guidedtours_tagline:`交互式产品导览`,nav_engagements_slideshows:`幻灯片`,nav_engagements_slideshows_tagline:`内容幻灯片和演示`,nav_engagements_abtests:`A/B测试`,nav_engagements_abtests_tagline:`A/B测试活动`,nav_engagements_questionnaires:`问卷`,nav_engagements_questionnaires_tagline:`详细问卷和表单`,nav_develop_documentation:`文档`,nav_develop_documentation_tagline:`API和产品文档`,nav_develop_devtools:`开发工具`,nav_develop_devtools_tagline:`开发者工具和实用程序`,nav_develop_kbase:`知识库`,nav_develop_kbase_tagline:`技术知识库和文章`,nav_develop_hackathon:`黑客马拉松`,nav_develop_hackathon_tagline:`黑客马拉松活动和挑战`,nav_develop_partner:`合作伙伴`,nav_develop_partner_tagline:`合作伙伴计划和集成`,nav_develop_certification:`认证`,nav_develop_certification_tagline:`开发者认证计划`,nav_profile_aboutme:`关于我`,nav_profile_aboutme_tagline:`查看和编辑您的个人信息`,nav_profile_badges:`徽章`,nav_profile_badges_tagline:`查看您获得的徽章和成就`,nav_profile_language:`语言`,nav_profile_language_tagline:`管理语言设置和偏好`,nav_reset_password:`重置密码`,nav_reset_password_tagline:`更改您的账户密码`,nav_sign_out:`登出`,nav_sign_out_tagline:`退出您的账户`,nav_account:`账户`,nav_account_tagline:`账户管理和支持`,nav_account_contact:`联系`,nav_account_contact_tagline:`联系支持和销售`,nav_account_pricetier:`价格等级`,nav_account_pricetier_tagline:`查看和管理定价计划`,nav_account_helpfaq:`帮助和常见问题`,nav_account_helpfaq_tagline:`常见问题和帮助`,nav_account_team:`团队`,nav_account_team_tagline:`管理团队成员和权限`,nav_account_terms:`条款`,nav_account_terms_tagline:`服务条款和法律协议`,nav_home:`主页`,nav_home_tagline:`管理控制台主页仪表板`,nav_silo_audits:`仓库审计`,nav_silo_audits_tagline:`审计和检查仓库数据`,nav_cache:`缓存`,nav_cache_tagline:`缓存管理和统计`,nav_cache_stats:`统计`,nav_cache_stats_tagline:`缓存性能统计`,nav_dialog_links:`对话框链接`,nav_dialog_links_tagline:`管理对话框和模态链接配置`,nav_i18n_maint:`国际化维护`,nav_i18n_maint_tagline:`国际化维护和微文案管理`,nav_meta_maint:`元数据维护`,nav_meta_maint_tagline:`元数据维护和配置`,nav_bell_drawer:`铃铛抽屉`,nav_bell_drawer_tagline:`通知管理和铃铛抽屉配置`,nav_meter:`计量器`,nav_meter_tagline:`使用计量和分析`,nav_deeplinks:`深层链接`,nav_deeplinks_tagline:`深层链接管理和跟踪`,nav_rss:`RSS`,nav_rss_tagline:`RSS订阅源管理和联合`,nav_core_assets:`核心资产`,nav_core_assets_tagline:`管理核心应用程序资产和资源`,nav_web_hooks:`网络钩子`,nav_web_hooks_tagline:`Webhook配置和监控`,nav_snippets:`代码片段`,nav_snippets_tagline:`代码和内容片段管理`,nav_snippets_sql:`SQL`,nav_snippets_sql_tagline:`SQL查询片段和模板`,nav_snippets_js:`JS`,nav_snippets_js_tagline:`JavaScript代码片段`,nav_rollers:`Magnet Builder`,nav_rollers_tagline:`滚动部署和版本管理`,nav_rollers_primary_nav:`主导航`,nav_rollers_primary_nav_tagline:`主导航滚动器配置`}}}},SIT:{SSE:{M5T:{en:{welcome_back:[`Welcome back`,`Good to see you again`,`Hello again`],please_enter_your_details:`Please enter your details`,email:`Email`,enter_your_email:`Enter your email`,password:`Password`,enter_your_password:`Enter your password`,sign_in:`Sign in`}}}},UAT:{SSE:{M5T:{en:{welcome_back:`Welcome back`,please_enter_your_details:`Please enter your details`,email:`Email`,enter_your_email:`Enter your email`,password:`Password`,enter_your_password:`Enter your password`,sign_in:`Sign in`}}}},QA:{SSE:{M5T:{en:{welcome_back:`Welcome back`,please_enter_your_details:`Please enter your details`,email:`Email`,enter_your_email:`Enter your email`,password:`Password`,enter_your_password:`Enter your password`,sign_in:`Sign in`}}}},PROD:{SSE:{M5T:{en:{welcome_back:`Welcome back`,please_enter_your_details:`Please enter your details`,email:`Email`,enter_your_email:`Enter your email`,password:`Password`,enter_your_password:`Enter your password`,sign_in:`Sign in`}}}}};static#t={buildMode:`DEV`,product:`SSE`,whitelabel:`M5T`,lang:`en`};static setContext({buildMode:e,product:t,whitelabel:n,lang:r}){e&&(this.#t.buildMode=e),t&&(this.#t.product=t),n&&(this.#t.whitelabel=n),r&&(this.#t.lang=r)}static getContext(){return{...this.#t}}static get(e,t={}){let{buildMode:n,product:r,whitelabel:i,lang:a}={...this.#t,...t};try{let t=this.#e[n]?.[r]?.[i]?.[a]?.[e],o=n;return!t&&n!==`LOCAL`&&(t=this.#e.LOCAL?.[r]?.[i]?.[a]?.[e],o=`LOCAL (fallback)`),t?(o===`LOCAL (fallback)`&&console.warn(`[MicrocopyManager] Token '${e}' missing from ${n} — served from LOCAL instead. Backfill ${n}'s block if this is intentionally different copy.`),Array.isArray(t)?t[Math.floor(Math.random()*t.length)]:t):(console.warn(`[MicrocopyManager] Token not found: ${e} (${n}/${r}/${i}/${a}, LOCAL fallback also missing it)`),null)}catch(t){return console.error(`[MicrocopyManager] Error retrieving token: ${e}`,t),null}}static getAll(e={}){let{buildMode:t,product:n,whitelabel:r,lang:i}={...this.#t,...e};try{return this.#e[t]?.[n]?.[r]?.[i]||null}catch(e){return console.error(`[MicrocopyManager] Error retrieving all tokens`,e),null}}static has(e,t={}){let{buildMode:n,product:r,whitelabel:i,lang:a}={...this.#t,...t};try{return!!this.#e[n]?.[r]?.[i]?.[a]?.[e]}catch{return!1}}static getAvailableLanguages(){let{buildMode:e,product:t,whitelabel:n}=this.#t;try{return Object.keys(this.#e[e]?.[t]?.[n]||{})}catch{return[]}}static update(e,t,n={}){let{buildMode:r,product:i,whitelabel:a,lang:o}={...this.#t,...n};try{return this.#e[r]||(this.#e[r]={}),this.#e[r][i]||(this.#e[r][i]={}),this.#e[r][i][a]||(this.#e[r][i][a]={}),this.#e[r][i][a][o]||(this.#e[r][i][a][o]={}),this.#e[r][i][a][o][e]=t,!0}catch(t){return console.error(`[MicrocopyManager] Error updating token: ${e}`,t),!1}}static delete(e,t={}){let{buildMode:n,product:r,whitelabel:i,lang:a}={...this.#t,...t};try{return delete this.#e[n]?.[r]?.[i]?.[a]?.[e],!0}catch(t){return console.error(`[MicrocopyManager] Error deleting token: ${e}`,t),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(e){try{return this.#e=e,!0}catch(e){return console.error(`[MicrocopyManager] Error importing data`,e),!1}}},typeof module<`u`&&module.exports&&(module.exports={MicrocopyManager:D})})),un,dn=o((()=>{ln(),y(),un=class{static#e=!1;static#t=null;static#n=null;static initialize(){if(this.#e){console.warn(`[I18nController] Already initialized`);return}let e=this.#i();D.setContext(e),console.log(`[I18nController] Initialized with context:`,e),console.log(`[I18nController] Available languages:`,this.getAvailableLanguages()),v.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Debug mode enabled`),this.#a(),this.#s(),this.#e=!0,this.refresh()}static#r(e){return{development:`LOCAL`,local:`LOCAL`,dev:`DEV`,sit:`SIT`,qa:`QA`,uat:`QA`,production:`PROD`,prod:`PROD`}[e.toLowerCase()]||`DEV`}static#i(){let e=this.#r(`production`),t=localStorage.getItem(v.FF_SSE_LS_WHITELABEL)||v.FF_SSE_I18N_WHITELABEL,n=localStorage.getItem(v.FF_SSE_LS_USER_LANG)||v.FF_SSE_I18N_LANG;return{buildMode:e,product:v.FF_SSE_I18N_PRODUCT,whitelabel:t,lang:n}}static#a(){typeof neodigmCarousel<`u`&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((e,t,n)=>{v.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Route changed:`,n),this.#t=n,setTimeout(()=>{this.refresh()},v.FF_SSE_I18N_APPLY_DELAY_MS)},v.FF_CLIENT_CAROUSEL_ID):(console.warn(`[I18nController] neodigmCarousel not found. Using fallback polling.`),this.#o())}static#o(){setInterval(()=>{let e=document.querySelector(`[data-n55-carousel-page-name]`)?.getAttribute(`data-n55-carousel-page-name`);e&&e!==this.#t&&(this.#t=e,this.refresh())},500)}static#s(){this.#n||(this.#n=new MutationObserver(e=>{let t=!1;for(let n of e){for(let e of n.addedNodes)if(e.nodeType===Node.ELEMENT_NODE&&(e.hasAttribute(`data-meta-copywrite-i118n`)||e.querySelector(`[data-meta-copywrite-i118n]`))){t=!0;break}if(t)break}t&&(v.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] DOM mutation detected, refreshing i18n`),this.refresh())}),this.#n.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn(`[I18nController] Not initialized. Call initialize() first.`);return}this.#c(document.body),this.#l(document.body),v.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Refresh complete`)}static#c(e){let t=e.querySelectorAll(`[data-meta-copywrite-i118n]`);v.FF_SSE_I18N_DEBUG&&t.length>0&&console.log(`[I18nController] Processing ${t.length} elements`),t.forEach(e=>{try{let t=e.getAttribute(`data-meta-copywrite-i118n`),n=JSON.parse(t);if(!n.token){console.warn(`[I18nController] Missing token in config:`,n);return}let r=n.attribute||`textContent`,i=D.get(n.token);if(i===null){console.warn(`[I18nController] Microcopy not found for token: ${n.token}`);return}r===`textContent`?e.textContent=i:r===`innerHTML`?e.innerHTML=i:e.setAttribute(r,i),v.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${i}" to ${r} for token: ${n.token}`)}catch(t){console.error(`[I18nController] Error processing element:`,t,e)}})}static#l(e){e.querySelectorAll(`*`).forEach(e=>{e.shadowRoot&&(this.#c(e.shadowRoot),this.#l(e.shadowRoot))})}static setLanguage(e){let t=D.getAvailableLanguages();if(!t.includes(e)){console.error(`[I18nController] Language not available: ${e}. Available:`,t);return}localStorage.setItem(v.FF_SSE_LS_USER_LANG,e),D.setContext({lang:e}),console.log(`[I18nController] Language changed to:`,e);let n=new CustomEvent(`language-changed`,{bubbles:!0,composed:!0,detail:{lang:e}});document.dispatchEvent(n),this.refresh()}static setWhitelabel(e){localStorage.setItem(v.FF_SSE_LS_WHITELABEL,e),D.setContext({whitelabel:e}),v.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Whitelabel changed to:`,e),this.refresh()}static getLanguage(){return D.getContext().lang}static getAvailableLanguages(){return D.getAvailableLanguages()}static getContext(){return D.getContext()}static destroy(){this.#n&&=(this.#n.disconnect(),null),this.#e=!1,this.#t=null,v.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Destroyed`)}},typeof window<`u`&&typeof document<`u`&&(document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,()=>{un.initialize()}):un.initialize())}));dn(),m();var fn=class{static _initialized=!1;static _debug=!1;static init(e={}){return this._initialized?(console.warn(`[MachVive] Already initialized, skipping duplicate initialization`),this):(this._debug=e.debug||!1,window.mvvSSEther?(console.log(`[MachVive] Initializing SSE to PubSub bridge...`),window.mvvSSEther.onmessage(e=>{this._handleSSEMessage(e)}),this._initialized=!0,console.log(`[MachVive] ✓ SSE to PubSub bridge initialized successfully`),console.log(`[MachVive] ✓ Bound callback to mvvSSEther.onmessage`),this):(console.error(`[MachVive] mvvSSEther not found - cannot initialize bridge`),console.error(`[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()`),this))}static _handleSSEMessage(e){try{this._debug&&console.log(`[MachVive] SSE message received:`,e);let t=e?.data;if(!t){this._debug&&console.log(`[MachVive] No data in message, skipping`);return}let n=t.data||t.package||t;if(!n){this._debug&&console.log(`[MachVive] No package found in message, skipping`);return}let r=n.cfg,i=n.msg;if(this._debug&&(console.log(`[MachVive] cfg (raw):`,r,`type:`,typeof r,`length:`,r?.length),console.log(`[MachVive] msg (raw):`,i)),typeof r==`string`){if(r.trim()===``){this._debug&&console.log(`[MachVive] cfg is empty string, skipping`);return}try{r=JSON.parse(r),console.log(`[MachVive] cfg (parsed):`,r)}catch(e){console.warn(`[MachVive] Failed to parse cfg as JSON:`,{cfg:r,cfgLength:r.length,error:e.message});return}}else if(!r){this._debug&&console.log(`[MachVive] cfg is empty/null, skipping`);return}let a=r?.topic;if(!a){this._debug&&console.log(`[MachVive] No topic found in cfg, skipping`);return}if(console.log(`[MachVive] Extracted topic:`,a),!this._isValidTopic(a)){console.warn(`[MachVive] Topic '${a}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(a,i,e,t)}catch(e){console.error(`[MachVive] Error handling SSE message:`,e)}}static _isValidTopic(e){return!p||!p.hasOwnProperty(e)?(console.warn(`[MachVive] Topic '${e}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(e,t,n,r){try{if(!window.PubSub&&typeof PubSub>`u`){console.error(`[MachVive] PubSub not available`);return}let i=window.PubSub||PubSub,a={message:t,metadata:{source:`sse`,sseEventId:n.id,timestamp:n.timestamp,appGuid:r.app_guid,channelGuid:r.channel_guid,eventAction:r.event_action,status:r.status,class:r.class,raw:r}};console.log(`[MachVive] Publishing to topic '${e}':`,a);let o=p[e];console.log(`[MachVive] AppBroadcast.${e} = '${o}'`),i.publish(o,a),console.log(`[MachVive] ✓ Published SSE message to topic: ${e}`)}catch(t){console.error(`[MachVive] Error publishing to topic '${e}':`,t)}}static debug(e){return this._debug=e,console.log(`[MachVive] Debug mode ${e?`enabled`:`disabled`}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log(`[MachVive] Reset complete`),this}};typeof module<`u`&&module.exports&&(module.exports=fn),typeof window<`u`&&(window.MachVive=fn);var pn=`m5t_sidenav_collapsed`,mn={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},hn=class extends HTMLElement{static get observedAttributes(){return[`data-active-token`,`data-collapsed`]}constructor(){super(),this.attachShadow({mode:`open`}),this.items=[],this.orgs=[],this.activeOrgGuid=null,this.activeToken=null,this.footerBadge=null,this.loading=!1,this.lastFocus=null}#e=null;#t=e=>{if(this.getAttribute(`data-open`)===`true`){if(e.key===`Escape`){e.preventDefault(),this.closeDrawer();return}if(e.key===`Tab`){let t=this.#d();if(t.length<2)return;let n=t[0],r=t[t.length-1],i=this.shadowRoot.activeElement;e.shiftKey&&i===n?(e.preventDefault(),r.focus()):!e.shiftKey&&i===r&&(e.preventDefault(),n.focus())}}};#n=()=>{this.closeDrawer(),this.#f()};connectedCallback(){if(!this.hasAttribute(`data-collapsed`))try{localStorage.getItem(pn)===`true`&&this.setAttribute(`data-collapsed`,`true`)}catch{}this.activeToken=this.getAttribute(`data-active-token`)||null,this.render(),this.#l(),this.addEventListener(`keydown`,this.#t),this.#e=window.matchMedia(`(max-width: 768px)`),this.#e.addEventListener(`change`,this.#n),this.#f()}disconnectedCallback(){this.removeEventListener(`keydown`,this.#t),this.#e?.removeEventListener(`change`,this.#n)}attributeChangedCallback(e,t,n){t===n||!this.shadowRoot||(e===`data-active-token`?(this.activeToken=n,this.#u()):e===`data-collapsed`&&this.shadowRoot.firstChild&&(this.render(),this.#l()))}setState({buttons:e,orgs:t,activeOrg:n,footerBadge:r,loading:i}={}){e!==void 0&&(this.items=Array.isArray(e)?e:this.#r(e)||[]),t!==void 0&&(this.orgs=Array.isArray(t)?t:this.#r(t)||[]),n!==void 0&&(this.activeOrgGuid=n||null),r!==void 0&&(this.footerBadge=r||null),i!==void 0&&(this.loading=!!i),this.shadowRoot&&(this.render(),this.#l())}setButtons(e){this.setState({buttons:e})}setOrgs(e){this.setState({orgs:e})}setActiveOrgGuid(e){this.setState({activeOrg:e})}setFooterBadge(e){this.setState({footerBadge:e})}setActiveToken(e){this.activeToken=e||null,this.#u()}toggleCollapsed(e){let t=typeof e==`boolean`?e:this.getAttribute(`data-collapsed`)!==`true`;this.setAttribute(`data-collapsed`,String(t));try{localStorage.setItem(pn,String(t))}catch{}this.dispatchEvent(new CustomEvent(`nav-collapse`,{bubbles:!0,composed:!0,detail:{pubsubTopic:`M5T_SIDE_NAV.COLLAPSE`,collapsed:t,timestamp:Date.now()}}))}openDrawer(){this.lastFocus=this.shadowRoot.activeElement||document.activeElement,this.setAttribute(`data-open`,`true`),this.shadowRoot.querySelector(`.hamburger`)?.setAttribute(`aria-expanded`,`true`),this.#f(),(this.#d()[0]||this.shadowRoot.querySelector(`.sidenav`))?.focus?.()}closeDrawer(){if(this.getAttribute(`data-open`)!==`true`)return;this.removeAttribute(`data-open`);let e=this.shadowRoot.querySelector(`.hamburger`);e?.setAttribute(`aria-expanded`,`false`),this.#f(),e&&this.#e?.matches?e.focus():this.lastFocus?.focus?.()}toggleDrawer(){this.getAttribute(`data-open`)===`true`?this.closeDrawer():this.openDrawer()}#r(e){try{return e?JSON.parse(e):null}catch(e){return console.error(`[M5TSideNav] bad JSON:`,e),null}}#i(e){return String(e??``).replace(/[&<>"']/g,e=>mn[e])}#a(e){return e?`<span class="ms" aria-hidden="true">${this.#i(e)}</span>`:``}#o(e){if(!e||!e.token)return``;let t=e.token===this.activeToken,n=e.route||`#`,r=n.startsWith(`#`)?n:`#${n}`,i=typeof e.count==`number`&&e.count>0?`<span class="badge">${e.count}</span>`:``;return`
      ...
      <div class="footer-actions">
        ...
        <!-- Language button removed 2026-09-14 (Nick's call): hidden for all
             users, functionality kept - main.js still handles the 'lang'
             action and the whole I18nController path stays live, so restoring
             the surface is reinserting this one button. -->
    ...
    </div>`}function Tn(e,{total:t=0,onSize:n}={}){let r=e?.querySelector?.(`[data-action="list-size"]`);if(!r||typeof n!=`function`)return()=>{};let i=e=>n(kn(e.target.value,t),e.target.value);return r.addEventListener(`change`,i),()=>r.removeEventListener(`change`,i)}function O(e,{rowSelector:t,cap:n=25,noun:r=``,controlHost:i,key:a}={}){if(!e||!t)return 0;e.querySelectorAll(`:scope > .m5t-list-size, .m5t-list-size`).forEach(e=>e.remove());let o=[...e.querySelectorAll(t)];if(o.forEach(e=>e.removeAttribute(`hidden`)),o.length<=n)return 0;let s=a||r||t,c=On.get(s)??n,l=kn(c,o.length),u=i||e,d=()=>{l=kn(c,o.length),o.forEach((e,t)=>{t<l?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``)}),u.querySelectorAll(`.m5t-list-size`).forEach(e=>e.remove());let e=wn({total:o.length,shown:l,size:c,noun:r});e&&(u.insertAdjacentHTML(`beforeend`,e),Tn(u,{total:o.length,onSize:(e,t)=>{c=t,On.set(s,t),d()}}))};return d(),Math.max(0,o.length-l)}function En(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}var Dn,On,kn,An=o((()=>{Dn=[25,50,100,`ALL`],On=new Map,kn=(e,t)=>e===`ALL`?t:Number(e)||25}));T(),An(),x();var jn=()=>w.getConfig?.().BASE_URL||``,Mn={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Nn=e=>String(e??``).replace(/[&<>"']/g,e=>Mn[e]),Pn=3e5;function Fn(e){try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return``}}function In(e){let t=`
      <div class="m5t-notif-title">${Nn(e.title)}</div>
      ${e.body?`<div class="m5t-notif-body">${Nn(e.body)}</div>`:``}
      <div class="m5t-notif-time">${Nn(Fn(e.created_tz))}</div>`;return`<div class="m5t-notif-item" data-guid="${Nn(e.guid)}" data-read="${e.read}" role="menuitem">
    ${e.link?`<a class="m5t-notif-main m5t-notif-link" href="${Nn(e.link)}">${t}</a>`:`<div class="m5t-notif-main">${t}</div>`}
    <button class="m5t-notif-dismiss" type="button" aria-label="Clear “${Nn(e.title)}”" data-dismiss="${Nn(e.guid)}">Clear</button>
  </div>`}var Ln=`<div class="m5t-notif-skel"><span></span><span></span><span></span></div>`.repeat(3),Rn=e=>e.dataset.open===`true`,zn=(e,t)=>{e.dataset.open=t?`true`:`false`};function Bn(e){let t=document.getElementById(`m5t-notif-bell`);if(t&&(t.hidden=!e),!e){let e=document.getElementById(`m5t-notif-panel`);e&&zn(e,!1)}}var Vn=14,Hn=null,Un=null;function Wn(e){if(typeof ResizeObserver>`u`||!e)return;let t=document.getElementById(`m5t-notif-bell`),n=document.getElementById(`m5t-notif-bell-btn`);if(!t||!n)return;let r=()=>{let r=e.hidden?null:e.querySelector(`.ocb-btn`);if(!r){t.style.top=`${Vn}px`;return}let i=n.getBoundingClientRect().height;if(!i)return;let a=r.getBoundingClientRect();t.style.top=`${Math.round(a.top+(a.height-i)/2)}px`};Hn?.disconnect(),Hn=new ResizeObserver(r),Hn.observe(e),Un?.disconnect(),Un=new MutationObserver(r),Un.observe(t,{attributes:!0,attributeFilter:[`hidden`]}),r()}var Gn=null,Kn=null,qn=null;function Jn(){let e=document.getElementById(`m5t-notif-bell-btn`),t=document.getElementById(`m5t-notif-badge`),n=document.getElementById(`m5t-notif-panel`);if(!e||!t||!n)return;let r=e=>{t.textContent=e>99?`99+`:String(e),t.hidden=!e},i=async()=>{try{let e=await b(`${jn()}/m5t/v5/notifications/unread-count`),t=await e.json().catch(()=>({}));e.ok&&t.ok&&r(t.count||0)}catch{}},a=e=>{if(e.length>=50){i();return}r(e.filter(e=>!e.read).length)},o=(e=``)=>`<div class="m5t-notif-head">Notifications${e?`<span class="m5t-notif-head__actions">${e}</span>`:``}</div>`,s=()=>{n.querySelectorAll(`.m5t-notif-item, .m5t-notif-empty`).forEach(e=>e.remove()),n.querySelector(`.m5t-notif-head__actions`)?.remove(),n.insertAdjacentHTML(`beforeend`,`<div class="m5t-notif-empty">You’re all caught up.</div>`)},c=async()=>{n.innerHTML=o()+Ln;try{let e=await b(`${jn()}/m5t/v5/notifications`),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error();let r=t.notifications||[],i=[r.some(e=>!e.read)?`<button class="m5t-notif-markall" type="button">Mark all read</button>`:``,r.length?`<button class="m5t-notif-clearall" type="button">Clear all</button>`:``].join(``);n.innerHTML=o(i)+(r.length?r.map(In).join(``):`<div class="m5t-notif-empty">You’re all caught up.</div>`),O(n,{rowSelector:`.m5t-notif-item`,noun:`notifications`}),a(r)}catch{n.innerHTML=o()+`<div class="m5t-notif-empty">Could not load. Try again.</div>`}},l=()=>{zn(n,!1),e.setAttribute(`aria-expanded`,`false`)},u=async()=>{zn(n,!0),e.setAttribute(`aria-expanded`,`true`),await c()};e.addEventListener(`click`,e=>{e.stopPropagation(),Rn(n)?l():u()}),qn&&document.removeEventListener(`visibilitychange`,qn),qn=()=>{document.visibilityState===`visible`&&i()},document.addEventListener(`visibilitychange`,qn),Kn&&document.removeEventListener(`click`,Kn),Kn=t=>{Rn(n)&&!n.contains(t.target)&&t.target!==e&&l()},document.addEventListener(`click`,Kn),document.addEventListener(`keydown`,t=>{t.key===`Escape`&&Rn(n)&&(l(),e.focus())}),n.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-dismiss]`);if(t){e.preventDefault(),e.stopPropagation();let r=t.closest(`.m5t-notif-item`),a=t.dataset.dismiss,o=r?.dataset.read===`false`;r?.setAttribute(`data-leaving`,`true`);try{await b(`${jn()}/m5t/v5/notifications/${encodeURIComponent(a)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:`DISMISSED`})})}catch{}setTimeout(()=>{r?.remove(),n.querySelector(`.m5t-notif-item`)||s()},180),o&&i();return}let r=e.target.closest(`.m5t-notif-clearall`);if(r){e.preventDefault(),r.disabled=!0,n.querySelectorAll(`.m5t-notif-item`).forEach(e=>e.setAttribute(`data-leaving`,`true`));try{await b(`${jn()}/m5t/v5/notifications/dismiss-all`,{method:`PATCH`})}catch{}setTimeout(s,180),i();return}let a=e.target.closest(`.m5t-notif-item`);if(a&&a.dataset.read===`false`){let e=a.dataset.guid;a.dataset.read=`true`;try{await b(`${jn()}/m5t/v5/notifications/${encodeURIComponent(e)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({read:!0})}),i()}catch{}return}let o=e.target.closest(`.m5t-notif-markall`);if(o){e.preventDefault(),n.querySelectorAll(`.m5t-notif-item`).forEach(e=>{e.dataset.read=`true`}),o.remove();try{await b(`${jn()}/m5t/v5/notifications/read-all`,{method:`PATCH`})}catch{}i()}}),i(),clearInterval(Gn),Gn=setInterval(i,Pn)}function Yn(){return g(`FF_SSE_UI_DARK_MODE`)}function Xn(e=Yn()){return e&&localStorage.getItem(v.FF_SSE_LS_THEME)===`dark`?`dark`:`light`}function Zn(e=g(`FF_SSE_UI_ANIMATIONS`)){return!e}function Qn(e,t=Yn()){!e||t||e.shadowRoot?.querySelector(`.footer-action[data-action="theme"]`)?.remove()}var $n=o((()=>{y()}));function er(e){document.documentElement.setAttribute(`data-theme`,e)}function tr(){er(Xn())}function nr(){return document.documentElement.getAttribute(`data-theme`)===`dark`?`dark`:`light`}function rr(e,{quiet:t=!1}={}){if(!Yn())return;let n=e===`dark`?`dark`:`light`;n!==nr()&&(er(n),localStorage.setItem(v.FF_SSE_LS_THEME,n),t||ar.default.publish(p.UI_TOAST,{message:n===`dark`?`Dark mode on`:`Dark mode off`,type:`info`}),ar.default.publish(p.UI_THEME_CHANGED,{theme:n}))}function ir(){rr(nr()===`dark`?`light`:`dark`)}var ar,or=o((()=>{ar=u(f(),1),m(),y(),$n()})),sr=c({fetchMyPlan:()=>cr,planAllowsClient:()=>lr,quotaState:()=>ur});function cr(){return fr||=(async()=>{try{let e=await b(`${dr()}/m5t/v5/billing/usage`);if(!e.ok)return null;let t=await e.json();return t?.ok?t:null}catch{return null}})(),fr}async function lr(e){let t=await cr();return!t?.plan?.features||t.plan.features[e]!==!1}async function ur(){return(await cr())?.quota||null}var dr,fr,pr=o((()=>{T(),x(),dr=()=>w.getConfig?.().BASE_URL||``,fr=null})),mr=c({default:()=>br,init:()=>vr,render:()=>_r});function hr(){if(yr)return;let e=document.createElement(`style`);e.id=`m5t-accept-invite-styles`,e.textContent=`
    .accept-invite-page {
  ...
  `,document.head.appendChild(e),yr=!0}function gr(){let e=new URLSearchParams(window.location.search||``),t=e.get(`uid`)||``,n=e.get(`token`)||``;if(!t||!n){let e=window.location.hash||``,r=e.includes(`?`)?e.slice(e.indexOf(`?`)+1):``,i=new URLSearchParams(r);if(t=t||i.get(`uid`)||``,n=n||i.get(`token`)||``,!t||!n){let r=e.replace(/^#\/?/,``).split(`?`)[0].split(`/`).filter(Boolean);t=t||r[1]||``,n=n||r[2]||``}}try{return{uid:decodeURIComponent(t),token:decodeURIComponent(n)}}catch{return{uid:t,token:n}}}function _r(){return hr(),`
    ...
    </div>`}function vr(){let{uid:e,token:t}=gr(),n=document.getElementById(`accept-invite-form`),r=document.getElementById(`ai-first`),i=document.getElementById(`ai-last`),a=document.getElementById(`ai-pass`),o=document.getElementById(`ai-confirm`),s=document.getElementById(`ai-submit`),c=document.getElementById(`ai-msg`);if(!n)return;let l=(e,t=`error`)=>{c.textContent=e,c.className=`accept-invite-msg ${t}`};if(!e||!t){l(`This invitation link is invalid or incomplete. Please use the link from your email.`),s.disabled=!0;return}n.addEventListener(`submit`,async n=>{n.preventDefault();let c=(r.value||``).trim(),u=(i.value||``).trim(),d=a.value||``,f=o.value||``;if(!c||!u){l(`Please enter your first and last name.`);return}if(d.length<8){l(`Password must be at least 8 characters.`);return}if(d!==f){l(`Passwords do not match.`);return}s.disabled=!0,l(`Setting up your account…`,`ok`);try{let n=await b(`${w.getConfig?.().BASE_URL||``}/m5t/v5/acctEntity/acceptInvite`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({uid:e,token:t,password:d,first:c,last:u})}),r=await n.json().catch(()=>({}));if(!n.ok||!r.ok){let e=n.status===410?`This invitation has expired. Ask for a new one.`:n.status===409?`This invitation has already been used. Try signing in.`:r.error||`Could not accept the invitation (HTTP ${n.status}).`;l(e),s.disabled=!1;return}try{window.history.replaceState({},``,window.location.pathname+window.location.hash)}catch{}l(`Welcome! Signing you in…`,`ok`),(await w.doSignin(r.entity.email,d))?.ok||(l(`Your account is ready. Please sign in.`,`ok`),setTimeout(()=>{window.location.hash=`#/signin`},1200))}catch(e){console.error(`[accept-invite] error:`,e),l(`Something went wrong. Please try again.`),s.disabled=!1}})}var yr,br,xr=o((()=>{T(),x(),yr=!1,br={render:_r,init:vr}})),Sr,Cr=o((()=>{Sr=``+new URL(`mfm-lockup-white.png`,import.meta.url).href})),wr,Tr=o((()=>{wr=``+new URL(`mfm-lockup-black.png`,import.meta.url).href})),Er,Dr=o((()=>{Er=``+new URL(`mfm-lockup-color.png`,import.meta.url).href})),Or,kr=o((()=>{Or=``+new URL(`m5mag-lockup.png`,import.meta.url).href}));function Ar(e=`#/splash`){return`
        <a class="auth-brand" href="${e}" aria-label="Mach Five Magnet">
          <img src="${Or}" alt="Mach Five Magnet" height="42" />
        </a>`}function jr(e=`panel`){let t=e===`light`;return`
    <a class="auth-cobrand${t?` auth-cobrand--light`:``}" href="${Mr}"
       target="_blank" rel="noopener" aria-label="From Mach Five Marketing">
      <span class="auth-cobrand__label">From</span>
      <img class="auth-cobrand__logo" src="${t?wr:Sr}"
           alt="Mach Five Marketing" height="26" loading="lazy" />
    </a>`}var Mr,Nr,Pr,Fr=o((()=>{Cr(),Tr(),Dr(),kr(),Mr=`https://www.machfivemarketing.com`,Nr=Or,Pr=Er}));function Ir(e){if(!e)return``;try{return new Date(e).toLocaleString([],{dateStyle:`medium`,timeStyle:`short`})}catch{return String(e)}}function Lr(e,t={}){let n=t[e.id];if(e.type===`checkbox_group`){let e=Array.isArray(n)?n:[];return e.length?Wr(e.join(`, `)):``}return n?Wr(n):``}function Rr(e,{emptyLabel:t=`(blank)`,renderAnswer:n=null}={}){let r=e?.questionnaire?.sections||[],i=e?.answers||{};return r.length?r.map(e=>`
    <div class="qm-section">
      <h3>${Wr(e.title)}</h3>
      ${(e.questions||[]).map(e=>`
        <div class="qm-qa" data-question-id="${Wr(e.id)}" data-question-type="${Wr(e.type)}">
          <div class="qm-qa__q">${Wr(e.label)}</div>
          <div class="qm-qa__a">${n?n(e,i):Lr(e,i)||`<span class="qm-qa__a--empty">${Wr(t)}</span>`}</div>
        </div>`).join(``)}
    </div>`).join(``):`<p class="qm-qa__a qm-qa__a--empty">This questionnaire has no questions.</p>`}function zr(e,t={}){let n=t[e.id];if(e.type===`checkbox_group`){let t=Array.isArray(n)?n:[];return`<div class="qm-checkbox-group">${(Array.isArray(e.options)?e.options:[]).map(e=>`
      <label><input type="checkbox" value="${Wr(e)}" ${t.includes(e)?`checked`:``}/> ${Wr(e)}</label>`).join(``)}</div>`}return e.type===`textarea`?`<textarea>${Wr(n||``)}</textarea>`:`<input type="text" value="${Wr(n||``)}" />`}function Br(e){let t={};return e&&e.querySelectorAll(`[data-question-id]`).forEach(e=>{let n=e.dataset.questionId;if(e.dataset.questionType===`checkbox_group`){let r=[...e.querySelectorAll(`input[type="checkbox"]:checked`)].map(e=>e.value);r.length&&(t[n]=r)}else{let r=(e.querySelector(`input,textarea`)?.value||``).trim();r&&(t[n]=r)}}),t}function Vr(e){let t=e?.recipient_email?`<p class="qm-recipient">Sent to ${Wr(e.recipient_email)}</p>`:``,n=e?.last_edited_tz?`<p class="qm-edited-marker">Last edited by ${Wr(e.last_edited_by_email||`a team member`)} on ${Wr(Ir(e.last_edited_tz))}</p>`:``,r=e?.client_edited_tz?`<p class="qm-edited-marker">Updated by the client on ${Wr(Ir(e.client_edited_tz))}</p>`:``;return t+n+r}function Hr(){if(Gr)return;let e=document.createElement(`style`);e.id=`m5t-questionnaire-answer-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Gr=!0}var Ur,Wr,Gr,Kr=o((()=>{Ur={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Wr=e=>String(e??``).replace(/[&<>"']/g,e=>Ur[e]),Gr=!1})),qr,Jr=o((()=>{qr=``+new URL(`auth-hero-sketch.jpg`,import.meta.url).href})),Yr=c({default:()=>li,init:()=>ni,render:()=>ti});function Xr(){if(ci)return;let e=document.createElement(`style`);e.id=`m5t-questionnaire-fill-styles`,e.textContent=`
    .qf-page {
    ...
    .qf-page::before {
      ...
      background: url("${qr}") center / cover no-repeat;
  ...
  `,document.head.appendChild(e),Hr(),ci=!0}function Zr(){return w.getConfig?.().BASE_URL||``}function Qr(e){let t=`qf-${e.id}`;if(e.type===`checkbox_group`){let n=Array.isArray(e.options)?e.options:[];return`
      <div class="qf-field" data-question-id="${e.id}" data-question-type="checkbox_group">
        <label>${$r(e.label)}</label>
        ${e.help?`<p class="qf-help">${$r(e.help)}</p>`:``}
        <div class="qf-checkbox-group">
          ${n.map((e,n)=>`
            <label class="qf-checkbox-row">
              <input type="checkbox" id="${t}-${n}" value="${$r(e)}" />
              ${$r(e)}
            </label>`).join(``)}
        </div>
      </div>`}return e.type===`textarea`?`
      <div class="qf-field" data-question-id="${e.id}" data-question-type="textarea">
        <label for="${t}">${$r(e.label)}</label>
        ${e.help?`<p class="qf-help">${$r(e.help)}</p>`:``}
    ...
    </div>`}function $r(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}function ei(e,t,n){return`
    <div class="qf-page"><div class="qf-card"><div class="qf-state">
      <span class="material-symbols-outlined">${e}</span>
      <h1>${$r(t)}</h1>
      <p class="qf-sub">${$r(n)}</p>
    </div></div></div>`}function ti(){return Xr(),`<div id="qf-root">${ei(`hourglass_top`,`Loading your questionnaire…`,`One moment.`)}</div>`}async function ni(){let e=document.getElementById(`qf-root`);if(!e)return;let t=st();if(!t){e.innerHTML=ei(`error`,`Invalid link`,`This link is missing required information. Please use the link exactly as sent.`);return}let n;try{let r=await b(`${Zr()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(t.guid)}?token=${encodeURIComponent(t.token)}`),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok){e.innerHTML=ei(`error`,`Cannot open this questionnaire`,r.status===404?i.error||`This link is invalid or has expired.`:`Something went wrong loading your questionnaire. Please try again shortly.`);return}n=i.data}catch(t){console.error(`[questionnaire-fill] load error:`,t),e.innerHTML=ei(`wifi_off`,`Connection problem`,`Could not reach the server. Please check your connection and try again.`);return}let r=ri(n);if(r===`locked`){ai(e,n);return}oi(e,n,t,r)}function ri(e){return e.status===`SUBMITTED`?(e.editability||{editable:!e.locked_tz}).editable?`edit`:`locked`:`fill`}function ii(e){let t=e.editability||{};return t.reason===`finalized`?`Your account manager has finalised these answers, so they can no longer be changed here.`:`Answers can be changed for 14 days after they are submitted.${t.deadline?` The window closed on ${Ir(t.deadline)}.`:``}`}function ai(e,t){e.innerHTML=`
    <div class="qf-page"><div class="qf-card">
      <img class="qf-brand" src="${Pr}" alt="Mach Five Marketing" height="34" />
      <h1>${$r(t.questionnaire?.name||`Kickoff Questionnaire`)}</h1>
      <p class="qf-sub">${t.submitted_tz?`Submitted ${$r(Ir(t.submitted_tz))}.`:`Submitted.`} Here is what you sent.</p>
      <div class="qf-note qf-note--locked">
        <span class="material-symbols-outlined" aria-hidden="true">lock</span>
        <span>${$r(ii(t))} To change anything now, contact your account manager.</span>
      </div>
      ${Vr(t)}
      ${Rr(t,{emptyLabel:`Left blank`})}
    </div></div>`}function oi(e,t,n,r){let i=r===`edit`,a=t.questionnaire?.sections||[],o=t.answers||{},s=t.editability?.deadline,c=i?`Change anything you need to, then save. Everything you sent before is already filled in.`:`Answer what applies. If a question doesn't apply to your business, leave it blank.`,l=i?`<div class="qf-note">
         <span class="material-symbols-outlined" aria-hidden="true">edit_note</span>
         <span>You already submitted this${t.submitted_tz?` on ${$r(Ir(t.submitted_tz))}`:``}.${s?` You can make changes until <strong>${$r(Ir(s))}</strong>.`:``}</span>
       </div>`:``;e.innerHTML=`
    <div class="qf-page"><div class="qf-card">
      <img class="qf-brand" src="${Pr}" alt="Mach Five Marketing" height="34" />
      <h1>${$r(t.questionnaire?.name||`Kickoff Questionnaire`)}</h1>
      <p class="qf-sub">${$r(c)}</p>
      ${l}
      <div class="qf-progress">
        ...
        <div class="qf-dots" role="group" aria-label="Sections">
          ${a.map((e,t)=>`<button type="button" class="qf-dot" data-step="${t}" aria-label="${$r(e.title)}"></button>`).join(``)}
        </div>
      </div>
    ...
    <div class="qf-page"><div class="qf-card"><div class="qf-state">
      ...
      <div class="qf-note qf-note--done">
        ...
        <span>Need to change something? This same link keeps working${$r(r)}. Keep the email we sent you and open it again any time before then.</span>
      </div>
      <button class="qf-btn" type="button" id="qf-again">Make another change</button>
    </div></div></div>`,document.getElementById(`qf-again`)?.addEventListener(`click`,()=>{ni()})}var ci,li,ui=o((()=>{T(),ct(),Fr(),Kr(),Jr(),x(),ci=!1,li={render:ti,init:ni}}));function di(e){return e&&typeof e.repeat==`string`&&e.repeat?e.repeat:null}function fi(e){let t=di(e);return t?(e.questions||[]).filter(e=>e.group===`${t}1`):[]}function pi(e,t,n){return(e||[]).map(e=>({...e,id:e.id.replace(`_${t}1_`,`_${t}${n}_`),group:`${t}${n}`,label:String(e.label||``).replace(/\b1\b/,String(n))}))}function mi(e,t){return RegExp(`^${_i(e).replace(`_${t}1_`,`_${t}(\\d+)_`)}$`)}function hi(e,...t){let n=di(e);if(!n)return 0;let r=fi(e).filter(e=>e.id&&e.id.includes(`_${n}1_`)).map(e=>mi(e.id,n)),i=1;for(let e of t)for(let t of Object.keys(e||{}))for(let e of r){let n=t.match(e);n&&(i=Math.max(i,parseInt(n[1],10)))}return Math.min(i,vi)}function gi(e,...t){return(Array.isArray(e)?e:[]).map(e=>{let n=di(e);if(!n)return e;let r=fi(e);if(!r.length)return e;let i=(e.questions||[]).filter(e=>e.group!==`${n}1`),a=hi(e,...t),o=[];for(let e=1;e<=a;e++)o.push(...pi(r,n,e));return{...e,questions:[...o,...i]}})}var _i,vi,yi=o((()=>{_i=e=>e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),vi=200})),bi=c({default:()=>Ri,init:()=>Ai,render:()=>ki});function xi(){if(Ii)return;let e=document.createElement(`style`);e.id=`m5t-deliverable-fill-styles`,e.textContent=`
    .dlf-page {
  ...
  `,document.head.appendChild(e),Hr(),Ii=!0}function Si(){return w.getConfig?.().BASE_URL||``}function k(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}function Ci(e,t){let n=t?.[e.id];return Array.isArray(n)?n.length>0:!!(n&&String(n).trim())}function wi(e,t){let n=(e.questions||[]).filter(e=>Li(e)&&Ci(e,t));return n.length?`<div class="dlf-plan">${n.map(e=>`
    <div class="dlf-plan__item">
      <div class="dlf-plan__label">${k(e.label)}</div>
      <div class="dlf-plan__value">${Lr(e,t)}</div>
    </div>`).join(``)}</div>`:``}function Ti(e){let t=`dlf-${e.id}`;if(e.type===`checkbox_group`){let n=Array.isArray(e.options)?e.options:[];return`
    ...
    <div class="dlf-field" data-question-id="${e.id}" data-question-type="text">
      ...
      ${e.help?`<p class="dlf-help">${k(e.help)}</p>`:``}
      <input type="text" id="${t}" />
    </div>`}function Ei(e,t){return`
    <div class="qm-qa">
      <div class="qm-qa__q">${k(e.label)}</div>
      <div class="qm-qa__a">${Lr(e,t)||`<span class="qm-qa__a--empty">Left blank</span>`}</div>
    </div>`}function Di(e,t,{readOnly:n=!1,answers:r={}}={}){let i=(e.questions||[]).filter(e=>!Li(e)),a=wi(e,t),o=i.map(e=>n?Ei(e,r):Ti(e)).join(``);return`
    ...
    </div></div></div>`}function ki(){return xi(),`<div id="dlf-root">${Oi(`hourglass_top`,`Loading your plan…`,`One moment.`)}</div>`}async function Ai(){let e=document.getElementById(`dlf-root`);if(!e)return;let t=ut();if(!t){e.innerHTML=Oi(`error`,`Invalid link`,`This link is missing required information. Please use the link exactly as sent.`);return}let n;try{let r=await b(`${Si()}/m5t/v5/m5mDeliverable/public/${encodeURIComponent(t.guid)}?token=${encodeURIComponent(t.token)}`),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok){e.innerHTML=Oi(`error`,`Cannot open this plan`,r.status===404?i.error||`This link is invalid or has expired.`:`Something went wrong loading your plan. Please try again shortly.`);return}n=i.data}catch(t){console.error(`[deliverable-fill] load error:`,t),e.innerHTML=Oi(`wifi_off`,`Connection problem`,`Could not reach the server. Please check your connection and try again.`);return}let r=ji(n);if(r===`locked`){Ni(e,n);return}Pi(e,n,t,r)}function ji(e){return e.status===`SUBMITTED`?(e.editability||{editable:!e.locked_tz}).editable?`edit`:`locked`:`fill`}function Mi(e){let t=e.editability||{};return t.reason===`finalized`?`Your account manager has finalised this plan, so the review can no longer be changed here.`:`A review can be changed for 14 days after it is submitted.${t.deadline?` The window closed on ${Ir(t.deadline)}.`:``}`}function Ni(e,t){let n=gi(t.template?.sections||[],t.content,t.answers);e.innerHTML=`
    <div class="dlf-page"><div class="dlf-card">
      <img class="dlf-brand" src="${Pr}" alt="Mach Five Marketing" height="34" />
      <h1>${k(t.template?.name||`Your Plan`)}</h1>
      <p class="dlf-sub">${t.submitted_tz?`Submitted ${k(Ir(t.submitted_tz))}.`:`Submitted.`} Here is the plan and your review.</p>
      <div class="dlf-note dlf-note--locked">
        <span class="material-symbols-outlined" aria-hidden="true">lock</span>
        <span>${k(Mi(t))} To change anything now, contact your account manager.</span>
      </div>
      ${n.map(e=>`
        <div class="dlf-section">
          <h2>${k(e.title)}</h2>
          ${Di(e,t.content||{},{readOnly:!0,answers:t.answers||{}})}
        </div>`).join(``)}
    </div></div>`}function Pi(e,t,n,r){let i=r===`edit`,a=gi(t.template?.sections||[],t.content,t.answers),o=t.answers||{},s=t.content||{},c=t.editability?.deadline,l=i?`Change anything you need to, then save. Everything you sent before is already filled in.`:`Review each section and mark it Approved, or note what you want changed.`,u=i?`<div class="dlf-note">
         <span class="material-symbols-outlined" aria-hidden="true">edit_note</span>
         <span>You already submitted this${t.submitted_tz?` on ${k(Ir(t.submitted_tz))}`:``}.${c?` You can make changes until <strong>${k(Ir(c))}</strong>.`:``}</span>
       </div>`:``;e.innerHTML=`
    <div class="dlf-page"><div class="dlf-card">
      <img class="dlf-brand" src="${Pr}" alt="Mach Five Marketing" height="34" />
      <h1>${k(t.template?.name||`Your Plan`)}</h1>
    ...
    </div></div>`;let d=[...e.querySelectorAll(`.dlf-section[data-step]`)],f=[...e.querySelectorAll(`.dlf-dot`)],p=document.getElementById(`dlf-back`),m=document.getElementById(`dlf-next`),h=document.getElementById(`dlf-submit`),g=document.getElementById(`dlf-progress-label`),_=0;function v(t,n=1){_=Math.max(0,Math.min(a.length-1,t)),d.forEach((e,t)=>{e.hidden=t!==_,e.classList.remove(`dlf-enter`)});let r=d[_];r&&(r.style.setProperty(`--dlf-dx`,`${n>=0?14:-14}px`),r.offsetWidth,r.classList.add(`dlf-enter`)),f.forEach((e,t)=>{t===_?e.setAttribute(`aria-current`,`step`):e.removeAttribute(`aria-current`)}),g&&(g.textContent=`Section ${_+1} of ${a.length}`),p.style.visibility=_===0?`hidden`:``,m.style.display=_===a.length-1?`none`:``,h&&(h.style.display=_===a.length-1?``:`none`),e.querySelector(`.dlf-card`)?.scrollIntoView({block:`start`})}p.addEventListener(`click`,()=>v(_-1,-1)),m.addEventListener(`click`,()=>v(_+1,1)),f.forEach(e=>e.addEventListener(`click`,()=>{let t=Number(e.dataset.step)||0;v(t,t>=_?1:-1)})),v(0),e.querySelectorAll(`[data-question-id]`).forEach(e=>{let t=e.dataset.questionId,n=e.dataset.questionType,r=o[t];if(r!=null){if(n===`checkbox_group`){let t=Array.isArray(r)?r:[];e.querySelectorAll(`input[type="checkbox"]`).forEach(e=>{e.checked=t.includes(e.value)})}else{let t=e.querySelector(`input,textarea`);t&&(t.value=r)}}});let y=`I have edits`,ee=[...e.querySelectorAll(`.dlf-field[data-question-type="checkbox_group"]`)].filter(e=>{let t=[...e.querySelectorAll(`input[type="checkbox"]`)].map(e=>e.value);return t.includes(`Approved`)&&t.includes(y)}),te=e.querySelector(`.dlf-field[data-question-id="cl_sign_approve"]`),ne=()=>{let e=!1;if(ee.forEach(t=>{let n=t.closest(`.dlf-section`),r=[...t.querySelectorAll(`input:checked`)].map(e=>e.value).includes(y);r&&(e=!0),n?.querySelectorAll(`.dlf-field`).forEach(e=>{e!==t&&(e.classList.toggle(`dlf-gated`,!r),e.querySelectorAll(`input,textarea`).forEach(e=>{e.disabled=!r}))})}),te&&ee.length){te.classList.toggle(`dlf-gated`,e),te.querySelectorAll(`input`).forEach(t=>{t.disabled=e,e&&(t.checked=!1)});let t=te.closest(`.dlf-section`),n=t?.querySelector(`#dlf-edits-note`);!n&&t&&(n=document.createElement(`div`),n.id=`dlf-edits-note`,n.className=`dlf-note`,n.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">forward_to_inbox</span><span>You marked sections with edits, so approval is off for this round. Use <strong>Send back with edits</strong> below and your account manager will follow up with a revised plan.</span>`,t.insertBefore(n,t.querySelector(`.dlf-field`))),n&&(n.hidden=!e);let r=document.getElementById(`dlf-submit`);r&&(r.textContent=i?`Save changes`:e?`Send back with edits`:`Submit review`)}};ee.forEach(e=>{e.querySelectorAll(`input[type="checkbox"]`).forEach(t=>{t.addEventListener(`change`,()=>{t.checked&&e.querySelectorAll(`input[type="checkbox"]`).forEach(e=>{e!==t&&(e.checked=!1)}),ne()})})}),ee.length&&ne();let re=document.getElementById(`dlf-form`),ie=document.getElementById(`dlf-submit`),ae=document.getElementById(`dlf-msg`),oe=(e,t=`error`)=>{ae.textContent=e,ae.className=`dlf-msg ${t}`};re.addEventListener(`submit`,async r=>{if(r.preventDefault(),ee.length){let e=ee.find(e=>!e.querySelector(`input:checked`));if(e){v(Number(e.closest(`.dlf-section`)?.dataset.step)||0),oe(`Mark each section Approved or I have edits.`);return}if(!ee.some(e=>[...e.querySelectorAll(`input:checked`)].some(e=>e.value===y))&&te&&!te.querySelector(`input:checked`)){v(a.length-1),oe(`To approve the plan, check I approve this plan.`);return}}let o=Br(e),s=`${Si()}/m5t/v5/m5mDeliverable/public/${encodeURIComponent(n.guid)}`,c=i?`${s}?token=${encodeURIComponent(n.token)}`:`${s}/submit?token=${encodeURIComponent(n.token)}`;ie.disabled=!0,oe(i?`Saving…`:`Submitting…`,`ok`);let l;try{l=await b(c,{method:i?`PUT`:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(i?{answers:o}:{answers:o,content_fingerprint:t.content_fingerprint||``})});let n=await l.json().catch(()=>({}));if(!l.ok||!n.ok){if(l.status===423){oe(n.error||`This review is now locked.`,`error`),await Ai();return}if(l.status===409&&n.reason===`content_changed`){await Ai();let e=document.getElementById(`dlf-msg`);e&&(e.textContent=n.error||`This plan was updated after you opened it. Review the latest version and submit again.`,e.className=`dlf-msg error`);return}let e=l.status===409?i?`This plan is not open for changes.`:`This plan has already been submitted.`:l.status===404?`This link is invalid or has expired.`:n.error||`Could not ${i?`save`:`submit`} (HTTP ${l.status}).`;oe(e),ie.disabled=!1;return}Fi(e,i,n.data?.editability?.deadline)}catch(e){console.error(`[deliverable-fill] ${i?`edit`:`submit`} error:`,e),oe(`Something went wrong. Please try again.`),ie.disabled=!1}})}function Fi(e,t,n){let r=n?` until ${Ir(n)}`:``;e.innerHTML=`
    <div class="dlf-page"><div class="dlf-card"><div class="dlf-state">
      <span class="material-symbols-outlined">check_circle</span>
      <h1>${t?`Changes saved`:`Thank you`}</h1>
    ...
    </div></div></div>`,document.getElementById(`dlf-again`)?.addEventListener(`click`,()=>{Ai()})}var Ii,Li,Ri,zi=o((()=>{T(),dt(),Fr(),Kr(),yi(),Jr(),x(),Ii=!1,Li=e=>e.audience===`am`,Ri={render:ki,init:Ai}})),Bi=c({init:()=>Hi,render:()=>Vi});function Vi(){return`
    <div class="auth-container splash">
      <div class="auth-left">
        <div class="splash-content">
          <h1 class="splash-mark"><img src="${Nr}" alt="Mach Five Magnet" height="88" /></h1>
  ...
  `}function Hi(){console.log(`[SplashRoute] Initialized - checking authentication state in 3.6 seconds...`),setTimeout(()=>{let e=localStorage.getItem(v.FF_SSE_LS_TOKEN),t=localStorage.getItem(`mvv_ts`);console.log(`[SplashRoute] localStorage check:`,{hasMvvToken:!!e,hasMvvTs:!!t});let n=document.getElementById(`splash-loader`),r=document.getElementById(`splash-actions`);e?(console.log(`[SplashRoute] Auth token found → HOME`),Ui.default.publish(p.ROUTE_NAV,{route:`home`})):t?(console.log(`[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN`),Ui.default.publish(p.ROUTE_NAV,{route:`signin`})):(console.log(`[SplashRoute] New user (no session history) → Showing buttons`),n&&(n.style.display=`none`),r&&(r.style.display=`flex`),document.querySelectorAll(`[data-route]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-route`);console.log(`[SplashRoute] Button clicked - navigating to: ${t}`),Ui.default.publish(p.ROUTE_NAV,{route:t})})}))},4e3)}var Ui,Wi=o((()=>{Ui=u(f(),1),Fr(),m(),y()}));function Gi(e,t){typeof neodigmToast<`u`&&neodigmToast.q(t,`danger`),typeof neodigmUtils<`u`?neodigmUtils.shake(`#${e.id}`):(e.classList.add(`shake`),setTimeout(()=>e.classList.remove(`shake`),300)),e.focus()}function Ki(e,t){return e?qi.test(e)?!0:(Gi(t,D.get(`validation_email_invalid`)),!1):(Gi(t,D.get(`validation_email_required`)),!1)}var qi,Ji=o((()=>{ln(),qi=/^[^\s@]+@[^\s@]+\.[^\s@]+$/})),Yi=c({init:()=>Zi,render:()=>Xi});function Xi(){return`
  ...
  `}function Zi(){console.log(`[SigninRoute] Initialized`);let e=document.getElementById(`loginForm`),t=document.getElementById(`email`),n=document.getElementById(`password`),r=document.getElementById(`togglePassword`),i=document.getElementById(`rememberEmail`),a=localStorage.getItem(w.CONFIG.LS_KEYS.REMEMBERED_EMAIL);a&&t&&i&&(t.value=a,i.checked=!0,n?.focus()),r?.addEventListener(`click`,()=>{let e=n.type===`password`?`text`:`password`;n.type=e});let o=document.getElementById(`passkeySigninBtn`),s=document.getElementById(`passkeyDivider`),c=document.getElementById(`passkeyHint`);window.PublicKeyCredential&&o&&s&&(o.style.display=``,s.style.display=``,c&&(o.title=c.textContent),o.addEventListener(`click`,()=>ea())),e?.addEventListener(`submit`,async e=>{e.preventDefault();let r=t.value.trim(),a=n.value;Ki(r,t)&&Qi(a,n)&&(i?.checked?localStorage.setItem(w.CONFIG.LS_KEYS.REMEMBERED_EMAIL,r):localStorage.removeItem(w.CONFIG.LS_KEYS.REMEMBERED_EMAIL),await $i(r,a))}),document.getElementById(`link--uc__underline`)?.addEventListener(`click`,e=>{e.preventDefault(),ta.default.publish(p.AUTH_FORGOT)}),document.querySelector(`.auth-switch a[href="#/signup"]`)?.addEventListener(`click`,e=>{e.preventDefault(),console.log(`[SigninRoute] Sign up link clicked - navigating to signup`),ta.default.publish(p.ROUTE_NAV,{route:`signup`})})}function Qi(e,t){return e?e.length<10?(Gi(t,D.get(`validation_password_min_length`)),!1):!0:(Gi(t,D.get(`validation_password_required`)),!1)}async function $i(e,t){let n=document.querySelector(`.btn`);n.disabled=!0,n.textContent=D.get(`loading_signing_in`);try{let r=await w.doSignin(e,t);r.ok?(console.log(`[SigninRoute] Signin successful`),typeof neodigmToast<`u`&&neodigmToast.q(D.get(`success_welcome_back`),`success`),ta.default.publish(p.AUTH_SIGNIN_SUCCESS,{entity:w.getEntity()})):r.resetRequired?(console.log(`[SigninRoute] Password reset required`),typeof neodigmToast<`u`&&neodigmToast.q(D.get(`error_password_reset_required`),`warning`)):(typeof neodigmToast<`u`&&neodigmToast.q(r.error||D.get(`error_signin_failed`),`danger`),n.disabled=!1,n.textContent=(D.get(`sign_in`)||`Sign in`).toUpperCase())}catch(e){console.error(`[SigninRoute] Sign in error:`,e),typeof neodigmToast<`u`&&neodigmToast.q(e.message||D.get(`error_network`),`danger`),n.disabled=!1,n.textContent=(D.get(`sign_in`)||`Sign in`).toUpperCase(),ta.default.publish(p.AUTH_SIGNIN_FAIL,{message:e.message})}}async function ea(){let e=document.getElementById(`passkeySigninBtn`);e.disabled=!0;try{let e=await w.doPasskeySignin();e.ok?(console.log(`[SigninRoute] Passkey signin successful`),typeof neodigmToast<`u`&&neodigmToast.q(D.get(`success_welcome_back`),`success`),ta.default.publish(p.AUTH_SIGNIN_SUCCESS,{entity:w.getEntity()})):document.getElementById(`passkeyHint`)?.style.removeProperty(`display`),!e.ok&&!e.canceled&&typeof neodigmToast<`u`&&neodigmToast.q(e.error||D.get(`error_signin_failed`),`danger`)}catch(e){console.error(`[SigninRoute] Passkey signin error:`,e),typeof neodigmToast<`u`&&neodigmToast.q(e.message||D.get(`error_network`),`danger`)}finally{e.disabled=!1}}var ta,na=o((()=>{ta=u(f(),1),Fr(),m(),T(),ln(),Ji()}));function ra(e){let t=[];return e.length<12&&t.push(`at least 12 characters`),e.length>1024&&t.push(`at most 1024 characters`),/[a-z]/.test(e)||t.push(`1 lowercase`),/[A-Z]/.test(e)||t.push(`1 uppercase`),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(e)||t.push(`1 special character`),/[^\x00-\x7F]/.test(e)&&t.push(`ASCII characters only`),t}function ia(e){if(e.length===0)return``;if(e.includes(`ASCII characters only`))return`Password cannot contain emoji|or special unicode characters`;let t=e.find(e=>/^at (?:least|most) \d+ characters$/.test(e));return t?`Password must have ${t.replace(/ (\d+ characters)$/,`|$1`)}`:`Password must have: Uppercase,|Lowercase, and Special Character`}var aa=o((()=>{})),oa=c({init:()=>ca,render:()=>sa});function sa(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Ar()}
  ...
  `}function ca(){console.log(`[SignupRoute] Initialized`);let e=document.getElementById(`signupForm`),t=e.querySelector(`button[type="submit"]`);la(`togglePassword`,`password`,`eyeIcon`),la(`toggleConfirmPassword`,`confirmPassword`,`eyeIconConfirm`),document.querySelector(`.auth-switch a[href="#/signin"]`)?.addEventListener(`click`,e=>{e.preventDefault(),console.log(`[SignupRoute] Sign in link clicked - navigating to signin`),pa.default.publish(p.ROUTE_NAV,{route:`signin`})}),e.addEventListener(`submit`,async e=>{e.preventDefault();let n=document.getElementById(`first`).value.trim(),r=document.getElementById(`last`).value.trim(),i=document.getElementById(`email`).value.trim(),a=document.getElementById(`company`).value.trim(),o=document.getElementById(`phone`).value.trim(),s=document.getElementById(`password`).value,c=document.getElementById(`confirmPassword`).value,l=document.getElementById(`first`),u=document.getElementById(`last`),d=document.getElementById(`email`),f=document.getElementById(`password`),p=document.getElementById(`confirmPassword`);if(!ua(n,l,D.get(`validation_first_name_required`))||!ua(r,u,D.get(`validation_last_name_required`))||!Ki(i,d)||!da(s,f))return;if(s!==c){Gi(p,D.get(`validation_password_mismatch`));return}let m=document.getElementById(`acceptTerms`);if(!m.checked){Gi(m,`Please accept the Terms of Service and Privacy Policy to continue.`);return}t.disabled=!0,t.textContent=D.get(`loading_creating_account`),await fa(n,r,i,a,o,s)})}function la(e,t,n){let r=document.getElementById(e),i=document.getElementById(t),a=document.getElementById(n);!r||!i||!a||r.addEventListener(`click`,()=>{let e=i.type===`password`;i.type=e?`text`:`password`,e?a.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:a.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function ua(e,t,n){return e?!0:(Gi(t,n),!1)}function da(e,t){if(!e)return Gi(t,D.get(`validation_password_required`)),!1;let n=ra(e);return n.length>0?(Gi(t,ia(n)),!1):!0}async function fa(e,t,n,r,i,a){let o=document.querySelector(`button[type="submit"]`);try{let s={email:n,password:a,first:e,last:t};r&&(s.company=r),i&&(s.phone=i),s.terms_accepted=!0,s.legal_version=ma;let c=await w.doSignup(s);if(c.ok)pa.default.publish(p.AUTH_SIGNUP_SUCCESS,{email:n}),typeof mvvLegit<`u`&&mvvLegit.doUNVERF();else{let e=c.error||c.message||D.get(`error_signup_failed`);typeof neodigmToast<`u`&&neodigmToast.q(e,`danger`),o.disabled=!1,o.textContent=(D.get(`create_account`)||`Create account`).toUpperCase(),pa.default.publish(p.AUTH_SIGNUP_FAIL,{message:e})}}catch(e){console.error(`[SignupRoute] Sign up error:`,e),typeof neodigmToast<`u`&&neodigmToast.q(e.message||D.get(`error_network`),`danger`),o.disabled=!1,o.textContent=(D.get(`create_account`)||`Create account`).toUpperCase(),pa.default.publish(p.AUTH_SIGNUP_FAIL,{message:e.message})}}var pa,ma,ha=o((()=>{pa=u(f(),1),Fr(),m(),T(),aa(),ln(),Ji(),ma=`2026-07-15`})),ga=c({init:()=>va,render:()=>_a});function _a(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Ar()}
  ...
  `}function va(){console.log(`[VerfLinkRoute] Initialized`);let e=Date.now(),t=document.getElementById(`countdown-display`);function n(){let n=Date.now()-e,i=Math.floor(n/1e3),a=Math.max(0,7200-i),o=Math.floor(a/3600),s=Math.floor(a%3600/60),c=a%60,l=`${String(o).padStart(2,`0`)}:${String(s).padStart(2,`0`)}:${String(c).padStart(2,`0`)}`;t&&(t.textContent=l,a<600&&(t.style.color=`#ef4444`,t.style.textShadow=`
          0 0 10px rgba(239, 68, 68, 0.9),
          0 0 20px rgba(239, 68, 68, 0.7),
          0 0 30px rgba(239, 68, 68, 0.5)
        `),a===0&&(t.style.color=`#7f1d1d`,t.style.textShadow=`none`)),a===0&&(clearInterval(r),console.log(`[VerfLinkRoute] Countdown expired`),window.neodigmWired4Sound&&window.neodigmWired4Sound.sound(14),setTimeout(()=>{window.router&&window.router.navigate(`/splash`)},600))}n();let r=setInterval(n,1e3);window.addEventListener(`beforeunload`,()=>{clearInterval(r)})}var ya=o((()=>{Fr()})),ba,xa,Sa,Ca,wa=o((()=>{ba=u(f(),1),m(),x(),xa=`https://machfivemagnet-saas.onrender.com`,Sa=class{constructor(){this.baseUrl=xa}async request(e,t={}){let n=`${this.baseUrl}${e}`,r={"Content-Type":`application/json`,...t.headers};try{let i=await b(n,{...t,headers:r});if(i.status===401){ba.default.publish(p.AUTH_TOKEN_EXPIRED,{status:i.status,endpoint:e});let t=await i.json().catch(()=>({}));throw Error(t.error||`Authentication failed`)}let a=await i.json();return{ok:i.ok,status:i.status,data:a}}catch(t){throw console.error(`API Request Error:`,t),ba.default.publish(p.APP_ERROR,{message:t.message,endpoint:e}),t}}async get(e){return this.request(e,{method:`GET`})}async post(e,t){return this.request(e,{method:`POST`,body:JSON.stringify(t)})}async put(e,t){return this.request(e,{method:`PUT`,body:JSON.stringify(t)})}async delete(e){return this.request(e,{method:`DELETE`})}async signin(e,t){return this.post(`/api/acctEntity/signin`,{email:e,hash:t})}async signup(e){return this.post(`/api/acctEntity/signup`,e)}async signout(){return this.post(`/api/acctEntity/signout`,{})}async forgotPassword(e){return this.get(`/m5t/v5/acctEntity/forgot?CODE=${encodeURIComponent(e)}`)}async resetHash(e,t){return this.post(`/api/acctEntity/resethash`,{email:e,hash:t})}async verifyAccount(e){return this.get(`/api/acctEntity/verify?CODE=${e}`)}async getAccounts(){return this.get(`/api/acctEntity`)}async getAccount(e){return this.get(`/api/acctEntity/${e}`)}async updateAccount(e,t){return this.put(`/api/acctEntity/${e}`,t)}async deleteAccount(e){return this.delete(`/api/acctEntity/${e}`)}async ping(){return this.get(`/ping`)}},Ca=new Sa})),Ta=c({init:()=>Da,render:()=>Ea});function Ea(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Ar(`#/signin`)}
  ...
  `}function Da(){console.log(`[ForgotRoute] Initialized`);let e=document.getElementById(`forgot-form`),t=document.getElementById(`email`);e?.addEventListener(`submit`,async e=>{e.preventDefault();let n=t.value.trim();Ki(n,t)&&await Oa(n)})}async function Oa(e){let t=document.querySelector(`.btn`);t.disabled=!0,t.textContent=`SENDING...`;try{let n=await Ca.forgotPassword(e);n.ok&&n.data.ok?(typeof neodigmToast<`u`&&neodigmToast.q(D.get(`success_reset_link_sent`),`success`),ka.default.publish(p.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate(`/verf-link`)},2e3)):(typeof neodigmToast<`u`&&neodigmToast.q(n.data.error||D.get(`error_signin_failed`),`danger`),t.disabled=!1,t.textContent=(D.get(`send_reset_link`)||`Send reset link`).toUpperCase())}catch(e){console.error(`[ForgotRoute] Forgot password error:`,e),typeof neodigmToast<`u`&&neodigmToast.q(e.message||D.get(`error_network`),`danger`),t.disabled=!1,t.textContent=(D.get(`send_reset_link`)||`Send reset link`).toUpperCase()}}var ka,Aa=o((()=>{ka=u(f(),1),Fr(),m(),wa(),ln(),Ji()})),ja=c({init:()=>Na,render:()=>Ma});function Ma(){let e=w.getEntity()?.email||``;return`
    <div class="auth-container">
      <div class="auth-left">
        ${Ar(`#/home`)}
  ...
  `}function Na(){console.log(`[ResethashRoute] Initialized`);let e=document.getElementById(`resethash-form`),t=e.querySelector(`button[type="submit"]`);Pa(`toggleNewPassword`,`new-password`,`eyeIconNew`),Pa(`toggleConfirmPassword`,`confirm-password`,`eyeIconConfirm`),e?.addEventListener(`submit`,async n=>{n.preventDefault();let r=e.email.value.trim(),i=e.newPassword.value,a=e.confirmPassword.value,o=document.getElementById(`new-password`),s=document.getElementById(`confirm-password`);if(!i){Gi(o,D.get(`validation_new_password_required`));return}let c=ra(i);if(c.length>0){Gi(o,ia(c));return}if(!a){Gi(s,D.get(`validation_new_password_required`));return}if(i!==a){Gi(s,D.get(`validation_password_mismatch`));return}t.disabled=!0,t.textContent=D.get(`loading_resetting_password`);try{let e=await w.doResetHash(r,i);e.ok?(typeof neodigmToast<`u`&&neodigmToast.q(D.get(`success_password_reset`),`success`),Fa.default.publish(p.AUTH_RESETHASH_SUCCESS,{email:r})):(Gi(o,e.error||D.get(`error_signin_failed`)),t.disabled=!1,t.textContent=(D.get(`update_password`)||`Update password`).toUpperCase())}catch(e){console.error(`[ResethashRoute] Reset password error:`,e),Gi(o,e.message||D.get(`error_network`)),t.disabled=!1,t.textContent=(D.get(`update_password`)||`Update password`).toUpperCase()}})}function Pa(e,t,n){let r=document.getElementById(e),i=document.getElementById(t),a=document.getElementById(n);!r||!i||!a||r.addEventListener(`click`,()=>{let e=i.type===`password`;i.type=e?`text`:`password`,e?a.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:a.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}var Fa,Ia=o((()=>{Fa=u(f(),1),Fr(),m(),T(),aa(),ln(),Ji()}));function La(){if(Ja)return;let e=document.createElement(`style`);e.id=`m5t-portfolio-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Ja=!0}async function Ra(e,{days:t=30}={}){let n=new Date,r=await b(`${e}/m5t/v5/dashboard/stats?from=${Ya(new Date(n.getTime()-(t-1)*864e5))}&to=${Ya(n)}&group_by=owner`);if(!r.ok)throw Error(`HTTP ${r.status}`);let i=await r.json();if(!i.ok)throw Error(`stats not ok`);return i.by_owner||[]}function za(e,t){let n=e;return`<div class="dash-clients-scroll"><table class="dash-clients">
    <thead><tr>
      <th>Client</th>${t.map(e=>`<th>${e.h}</th>`).join(``)}<th></th>
    </tr></thead>
    <tbody>${n.map(e=>`
      <tr data-org="${Ka(e.owner_guid)}" tabindex="0" role="button"
          aria-label="Open ${Ka(e.name||`client`)}">
        <td><span class="dc-name">${Ka(e.name||e.owner_guid)}
          <span class="dc-chip">${Ka(qa[e.channel]||e.channel||``)}</span></span></td>
        ${t.map(t=>`<td>${t.td(e)}</td>`).join(``)}
        <td><span class="dc-view">View →</span></td>
      </tr>`).join(``)}</tbody>
  </table></div>`}function Ba(e){let t=e.querySelector(`.pf-access-error`);t||(t=document.createElement(`div`),t.className=`pf-access-error`,e.prepend(t)),t.textContent=`You don't have direct access to manage this org. Use the admin console to act on its behalf.`}function Va(e){if(!e)return;O(e.querySelector(`.dash-clients tbody`)||e,{rowSelector:`tr[data-org]`,noun:`clients`,controlHost:e.querySelector(`.dash-clients-scroll`)||e});let t=async t=>{let n=t?.dataset?.org;n&&(await w.setActiveOrg(n))?.activeOrgError&&Ba(e)};e.querySelectorAll(`tbody tr[data-org]`).forEach(e=>{e.addEventListener(`click`,()=>t(e)),e.addEventListener(`keydown`,n=>{(n.key===`Enter`||n.key===` `)&&(n.preventDefault(),t(e))})})}function Ha({section:e,title:t,description:n}){return La(),`
    <div class="page-shell" data-section="${Ka(e)}">
      <div class="page-header">
        <div class="page-header-text">
          <h1 class="page-title">${Ka(t)}</h1>
          <p class="page-description">${Ka(n)}</p>
        </div>
      </div>
      <div class="dashboard-card">
        ...
        <div class="card-body" id="pf-picker-body">${Xa(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}function Ua(e){let t=w.getManagedClients().map(e=>({owner_guid:e.orgGuid,name:e.name,channel:`managed_client`}));return t.length?za(t,e.map(e=>({h:e.h,td:()=>`<span class="dc-skel" aria-hidden="true"></span>`}))):Xa(`hourglass_empty`,`Loading…`)}async function Wa(e,t,{emptyMsg:n}={}){let r=document.getElementById(`pf-picker-body`);if(r){r.innerHTML=Ua(t),Va(r);try{let i=await Ra(e);if(!i.length){r.innerHTML=Xa(`groups`,n||`No client orgs yet. Create one under Clients first.`);return}r.innerHTML=za(i,t),Va(r)}catch(e){console.warn(`[portfolio] picker load failed:`,e),r.innerHTML=Xa(`error`,`Could not load your clients. Please refresh.`)}}}function Ga(){let e={};return w.getManagedClients().forEach(t=>{e[t.orgGuid]=t.name}),w.getMemberships().forEach(t=>{t.orgGuid&&!e[t.orgGuid]&&(e[t.orgGuid]=t.name||``)}),e}var A,Ka,qa,Ja,Ya,Xa,Za,Qa=o((()=>{T(),An(),x(),A=()=>w.getManagedClients().length>0&&!w.getStoredActiveOrg(),Ka=e=>String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]),qa={reseller_org:`Your org`,managed_client:`Client`,saas_org:`Org`},Ja=!1,Ya=e=>e.toISOString().slice(0,10),Xa=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Za=e=>e?`<span class="pf-client-chip">${Ka(e)}</span>`:``}));function j(e,t=null){if(e&&e.ok)return e;let n=e?e.status:0,r=t&&(t.message||t.error)||`HTTP ${n}`;throw new to(n,r,t)}function $a(e){return!!e&&typeof e==`object`&&e.status===403}function eo(e=`You do not have access to this.`,{compact:t=!1}={}){let n=String(e).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]);return`<div class="m5t-empty m5t-empty--denied${t?` m5t-empty--denied-compact`:``}">${t?``:`<span class="material-symbols-outlined" aria-hidden="true">lock</span>`}<p>${n}</p></div>`}var to,no=o((()=>{to=class extends Error{constructor(e,t,n=null){super(t||`HTTP ${e}`),this.name=`HttpError`,this.status=e,this.body=n}}}));function ro(e,t){so.set(e,t)}function io(e){if(!so.has(e))return null;let t=so.get(e);return so.delete(e),t}function ao(e){return so.has(e)?so.get(e):null}var oo,so,co=o((()=>{oo=Object.freeze({MAGNET_TEMPLATE:`magnet_template`,LEADS_SEARCH:`leads_search`,LEADS_DAY:`leads_day`}),so=new Map}));function M({icon:e,label:t,valueId:n,value:r=`—`,subId:i,sub:a=``,href:o,trendId:s}={}){let c=o?`a`:`div`;return`
  <${c}${o?` href="${uo(o)}" class="stat-card stat-card--link"`:` class="stat-card"`}>
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${uo(e)}</span>
      <span class="stat-label">${uo(t)}</span>
      ${o?`<span class="stat-go material-symbols-outlined" aria-hidden="true">north_east</span>`:``}
    </div>
    <div class="stat-value"${n?` id="${uo(n)}"`:``}>${r}</div>
    <div class="stat-change">${s?`<span class="stat-trend" id="${uo(s)}"></span>`:``}<span class="stat-sublabel"${i?` id="${uo(i)}"`:``}>${a}</span></div>
  </${c}>`}var lo,uo,fo=o((()=>{lo={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},uo=e=>String(e??``).replace(/[&<>"']/g,e=>lo[e])}));function po(e){if(e<=0)return 1;let t=10**Math.floor(Math.log10(e)),n=e/t;return(n<=1?1:n<=2?2:n<=5?5:10)*t}function mo(){if(xo)return;let e=document.createElement(`style`);e.id=`m5c-chart-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),xo=!0}function ho({rows:e=[],xLabel:t=()=>``,left:n,right:r,ariaLabel:i=`Chart`,activatable:a=()=>!1,pointLabel:o=()=>``,hitData:s=()=>({})}){let c=e.length||1,l=n.fmt||bo,u=r.fmt||bo,d=po(Math.max(1,...e.map(e=>n.value(e)||0))),f=po(Math.max(1,...e.map(e=>r.value(e)||0))),p=738/c,m=Math.min(22,p*.55),h=e=>56+p*(e+.5),g=e=>266-e/d*248,_=e=>266-e/f*248,v=[0,.5,1].map(e=>{let t=266-e*248;return`<line x1="56" y1="${t.toFixed(1)}" x2="794" y2="${t.toFixed(1)}" class="m5c-grid"/><text x="48" y="${(t+3.5).toFixed(1)}" text-anchor="end" class="m5c-ax">${yo(l(d*e))}</text><text x="802" y="${(t+3.5).toFixed(1)}" text-anchor="start" class="m5c-ax">${yo(u(f*e))}</text>`}).join(``),y=e.map((e,t)=>{let r=g(n.value(e)||0);return`<rect class="m5c-bar" data-i="${t}" x="${(h(t)-m/2).toFixed(1)}" y="${r.toFixed(1)}" width="${m.toFixed(1)}" height="${Math.max(0,266-r).toFixed(1)}" rx="3"/>`}).join(``),ee=e.map((e,t)=>`${h(t).toFixed(1)},${_(r.value(e)||0).toFixed(1)}`).join(` `),te=c>1?`<polyline class="m5c-line" points="${ee}" fill="none" stroke-width="2.5"/>`:``,ne=e.map((e,t)=>`<circle class="m5c-dot" data-i="${t}" cx="${h(t).toFixed(1)}" cy="${_(r.value(e)||0).toFixed(1)}" r="3.2"/>`).join(``),re=Math.max(1,Math.ceil(c/6)),ie=e.map((e,n)=>n%re===0||n===c-1?`<text x="${h(n).toFixed(1)}" y="288" text-anchor="middle" class="m5c-ax">${yo(t(e,n))}</text>`:``).join(``),ae=e.map((e,t)=>{let n=!!a(e),r=Object.entries(s(e)||{}).map(([e,t])=>` data-${yo(e)}="${yo(t)}"`).join(``);return`<rect class="m5c-hit" data-i="${t}" data-activatable="${n}" tabindex="0" role="button" aria-label="${yo(o(e,t))}"${r} x="${(56+p*t).toFixed(1)}" y="18" width="${p.toFixed(1)}" height="${248 .toFixed(1)}" fill="transparent"/>`}).join(``);return`
    <div class="m5c-legend">
      <span><i class="m5c-sw m5c-sw--1"></i>${yo(n.label)}</span>
      <span><i class="m5c-sw m5c-sw--2"></i>${yo(r.label)}</span>
    </div>
    <div class="m5c-wrap">
      <svg class="m5c-chart" viewBox="0 0 840 300" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${yo(i)}">
        ${v}<line class="m5c-crosshair" x1="0" y1="18" x2="0" y2="266" pointer-events="none"/>${y}${te}${ne}${ie}${ae}
      </svg>
      <div class="m5c-tip" role="status" hidden></div>
    </div>`}function go(){try{return!window.matchMedia||window.matchMedia(`(hover: hover)`).matches}catch{return!0}}function _o(e,{rows:t=[],tipHTML:n,onActivate:r}={}){if(!e?.addEventListener||typeof n!=`function`)return()=>{};let i=()=>e.querySelector(`.m5c-wrap`),a=()=>e.querySelector(`.m5c-tip`),o=e=>{e.querySelectorAll(`.m5c-bar--on, .m5c-dot--on, .m5c-hit--on`).forEach(e=>e.classList.remove(`m5c-bar--on`,`m5c-dot--on`,`m5c-hit--on`)),e.querySelector(`.m5c-crosshair`)?.classList.remove(`m5c-crosshair--on`)},s=(e,t,n)=>{o(e),e.querySelector(`.m5c-bar[data-i="${t}"]`)?.classList.add(`m5c-bar--on`),e.querySelector(`.m5c-dot[data-i="${t}"]`)?.classList.add(`m5c-dot--on`),n.classList.add(`m5c-hit--on`);let r=e.querySelector(`.m5c-crosshair`);if(r){let e=Number(n.getAttribute(`x`))+Number(n.getAttribute(`width`))/2;r.setAttribute(`x1`,e),r.setAttribute(`x2`,e),r.classList.add(`m5c-crosshair--on`)}},c=(e,r)=>{let o=i(),c=a(),l=t[e];if(!o||!c||!l||!r)return;c.innerHTML=n(l,e);let u=r.getBoundingClientRect(),d=o.getBoundingClientRect(),f=u.left-d.left+u.width/2,p=(c.offsetWidth||0)/2;p&&(f=Math.min(Math.max(f,p+4),Math.max(p+4,d.width-p-4))),c.style.left=`${f}px`,c.style.top=`${u.top-d.top}px`,c.hidden=!1,s(o,e,r)},l=()=>{let e=i(),t=a();t&&(t.hidden=!0),e&&o(e)},u=t=>{let n=t.target.closest?.(`.m5c-hit`);return n&&e.contains(n)?n:null},d=e=>Number(e?.dataset?.i),f=e=>{let n=d(e),i=t[n];!i||e.dataset.activatable!==`true`||typeof r!=`function`||r(i,n)},p=e=>{let t=u(e);t&&c(d(t),t)},m=t=>{let n=t.relatedTarget;n&&e.contains(n)&&n.closest?.(`.m5c-hit`)||l()},h=e=>{let t=u(e);if(!t)return;let n=t.classList.contains(`m5c-hit--on`);c(d(t),t),!(!go()&&!n)&&f(t)},g=e=>{let t=u(e);t&&c(d(t),t)},_=t=>{let n=t.relatedTarget;n&&e.contains(n)&&n.closest?.(`.m5c-hit`)||l()},v=t=>{let n=u(t);if(!n)return;let r=[...e.querySelectorAll(`.m5c-hit`)],i=r.indexOf(n),a=e=>{let n=r[Math.max(0,Math.min(r.length-1,e))];n&&(t.preventDefault(),n.focus?.(),c(d(n),n))};switch(t.key){case`Enter`:case` `:case`Spacebar`:t.preventDefault(),f(n);break;case`ArrowRight`:a(i+1);break;case`ArrowLeft`:a(i-1);break;case`Home`:a(0);break;case`End`:a(r.length-1);break;case`Escape`:l(),n.blur?.()}};return e.addEventListener(`mouseover`,p),e.addEventListener(`mouseout`,m),e.addEventListener(`click`,h),e.addEventListener(`focusin`,g),e.addEventListener(`focusout`,_),e.addEventListener(`keydown`,v),()=>{e.removeEventListener(`mouseover`,p),e.removeEventListener(`mouseout`,m),e.removeEventListener(`click`,h),e.removeEventListener(`focusin`,g),e.removeEventListener(`focusout`,_),e.removeEventListener(`keydown`,v)}}var vo,yo,bo,xo,So=o((()=>{vo={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},yo=e=>String(e??``).replace(/[&<>"']/g,e=>vo[e]),bo=e=>{let t=Math.round(e);return t>=1e3?`${(t/1e3).toFixed(t%1e3==0?0:1)}k`:String(t)},xo=!1})),Co=c({default:()=>Jo,init:()=>ko,render:()=>Oo,statCard:()=>M,svgTrendChart:()=>Po,wireTrendTooltip:()=>Io});function wo(e){let t=e.created?.created_tz;if(!t)return``;try{return new Date(t).toLocaleDateString([],{month:`short`,day:`numeric`})}catch{return``}}function To(e){try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return``}}function Eo(){if(mo(),Ho)return;let e=document.createElement(`style`);e.id=`m5t-dash-recent-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Ho=!0}function Do(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${zo(Vo(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${zo(Bo(e))}</span>
      <span class="recent-lead__sub">${zo(e.email||e.phone||``)}</span>
    </span>
    <span class="m5t-badge recent-lead__badge" data-s="${zo(e.status)}">${zo(e.status)}</span>
    <span class="recent-lead__time">${zo(wo(e))}</span>
  </a>`}function Oo(){Eo(),La();let e=A();return`
    <div class="page-shell" data-section="home">
      ...
      <div class="dashboard-card dashboard-card--lead">
        ...
        <div class="card-body" id="dash-portfolio">${Ua(Lo)}</div>
      </div>`:``}

      <div class="stats-grid">
        ${M({icon:`widgets`,label:`Active Magnets`,valueId:`stat-active-magnets`,subId:`stat-active-magnets-sub`,sub:`Loading…`,href:`#/magnets`})}
        ${M({icon:`ads_click`,label:`Magnet Opens`,valueId:`stat-opens`,subId:`stat-opens-sub`,sub:`Loading…`,href:`#/analytics`})}
        ${M({icon:`person_add`,label:`Leads Captured`,valueId:`stat-leads`,subId:`stat-leads-sub`,sub:`Loading…`,href:`#/leads`,trendId:`stat-leads-trend`})}
        ${M({icon:`check_circle`,label:`Completion Rate`,valueId:`stat-completion`,subId:`stat-completion-sub`,sub:`Loading…`,href:`#/analytics`})}
      </div>

      <div class="charts-section">
        ${Uo(`show_chart`,`Opens & Leads`,`dash-trend`,{wide:!0,controls:!0})}
        <div class="charts-grid">
          ${Uo(`filter_alt`,`Completion Funnel`,`dash-funnel`)}
          ${Uo(`source`,`Top Campaigns`,`dash-campaigns`)}
          ${Uo(`touch_app`,`CTA Usage`,`dash-routes`,{full:!0})}
        </div>
      </div>
      ...
      <div class="content-grid">
        ...
        <div class="dashboard-card">
          ...
          <div class="card-body" id="recent-leads-body">
            ${Ro(`hourglass_empty`,`Loading leads…`)}
          </div>
        </div>
      </div>
    </div>`}async function ko(){let e=w.getConfig?.().BASE_URL||``;w.getUiMode?.()===`self_serve`&&Promise.all([ur(),cr()]).then(([e,t])=>{if(!e||e.leads_pct<80)return;let n=document.querySelector(`.page-shell[data-section="home"]`);if(!n||document.getElementById(`dash-quota-banner`))return;let r={free:`pro`,pro:`enterprise`}[t?.plan?.key]||null,i=r?et[r]:null,a=i?`<a href="#/billing">Upgrade to ${i.label}</a> for ${Number(i.limits.leads_mo).toLocaleString()} leads a month.`:`<a href="#/billing">See your plan</a> for a higher allowance.`,o=document.createElement(`div`);o.id=`dash-quota-banner`,o.style.cssText=`margin:0 0 16px;padding:12px 16px;border-radius:12px;border:1px solid var(--color-border, #D4DCE8);background:var(--color-surface, #F4F7FB);font-size:0.9rem;color:var(--color-text, #0B1220);`,o.innerHTML=e.over?`Your monthly lead allowance is used up. Every lead is still captured, none are lost. ${a}`:`You have used ${e.leads_pct} percent of this month's lead allowance. ${a}`,n.prepend(o)}).catch(()=>{}),A()&&Va(document.getElementById(`dash-portfolio`)),document.getElementById(`dash-periods`)?.addEventListener(`click`,t=>{let n=t.target.closest(`button[data-days]`);n&&(Wo=Number(n.dataset.days)||30,document.querySelectorAll(`#dash-periods .chart-period-btn`).forEach(e=>e.classList.toggle(`active`,Number(e.dataset.days)===Wo)),Ao(e))}),document.getElementById(`dash-campaigns`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-campaign]`);t&&ro(oo.LEADS_SEARCH,t.dataset.campaign)}),await Promise.all([Ao(e),No(e)])}async function Ao(e){let t=new Date,n=qo(new Date(t.getTime()-(Wo-1)*864e5)),r=qo(t),i=A(),a;try{let t=await b(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${r}${i?`&group_by=owner`:``}`);if(j(t),a=await t.json(),!a.ok)throw Error(`stats not ok`)}catch(e){console.warn(`[dashboard] stats fetch failed:`,e),[`stat-active-magnets`,`stat-opens`,`stat-leads`,`stat-completion`].forEach(e=>Go(e,`—`)),[`stat-active-magnets-sub`,`stat-opens-sub`,`stat-leads-sub`,`stat-completion-sub`].forEach(e=>Go(e,`Unavailable`));let t=document.getElementById(`stat-leads-trend`);t&&(t.className=`stat-trend`,t.innerHTML=``),[`dash-trend`,`dash-funnel`,`dash-campaigns`,`dash-routes`,`dash-interactions`,`dash-portfolio`].forEach(t=>Ko(t,$a(e)?eo(void 0,{compact:!0}):Ro(`error`,`Could not load. Please refresh.`)));return}i&&jo(a.by_owner||[]),Go(`stat-active-magnets`,N(a.magnets.active)),Go(`stat-active-magnets-sub`,a.magnets.total>a.magnets.active?`${N(a.magnets.total-a.magnets.active)} paused`:a.magnets.active?`All running`:`No magnets yet`);let o=a.funnel||{};Go(`stat-opens`,o.opens?N(o.opens):`—`),Go(`stat-opens-sub`,o.opens?o.engagement_rate==null?`${N(o.engaged)} engaged`:`${o.engagement_rate}% engage`:`No opens in this range yet`);let s=a.leads||{};Go(`stat-leads`,N(s.total));let c=(s.this_week||0)-(s.prev_week||0);Go(`stat-leads-sub`,s.total?`${N(s.this_week)} this week`:`No leads yet`);let l=document.getElementById(`stat-leads-trend`);if(l){if((s.prev_week||0)>0){let e=c>0?`positive`:c<0?`negative`:`neutral`,t=c>0?`trending_up`:c<0?`trending_down`:`trending_flat`;l.className=`stat-trend ${e}`,l.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">${t}</span>${c>0?`+`:``}${N(c)}`}else l.className=`stat-trend`,l.innerHTML=``}Go(`stat-completion`,o.completion_rate==null?`—`:`${o.completion_rate}%`),Go(`stat-completion-sub`,o.opens?`${N(o.completions)} completed of ${N(o.opens)} opens`:`Appears once magnets get opened`);let u=a.by_day||[],d=u.some(e=>e.opens||e.leads);Ko(`dash-trend`,d?Po(u):Ro(`show_chart`,`No activity in this range yet. Opens and leads chart here as visitors engage your magnets.`)),d&&Io(u),Ko(`dash-funnel`,o.opens?Mo(o):Ro(`filter_alt`,`The funnel fills in once your magnets record opens.`));let f=a.top_campaigns||[];Ko(`dash-campaigns`,f.length?`<div class="dash-list">${f.map(e=>`
        <a class="dash-list__row dash-list__row--link" href="#/leads" data-campaign="${zo(e.campaign)}" title="Show the leads from ${zo(e.campaign)}">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">campaign</span></span>
          <span class="dash-list__main">${zo(e.campaign)}</span>
          <span class="dash-list__num">${N(e.leads)}</span>
          <span class="dash-list__go material-symbols-outlined" aria-hidden="true">chevron_right</span>
        </a>`).join(``)}</div>`:Ro(`source`,`No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here.`));{let e=document.getElementById(`dash-campaigns`)?.querySelector(`.dash-list`);e&&O(e,{rowSelector:`.dash-list__row`,noun:`campaigns`})}let p={book:[`event`,`Book`],chat:[`chat`,`Chat`],call:[`phone_in_talk`,`Call`],email:[`mail`,`Email`],support:[`support_agent`,`Support`]},m=Object.entries(o.routes||{}).sort((e,t)=>t[1]-e[1]),h=m.length?m[0][1]:0;Ko(`dash-routes`,m.length?`<div class="dash-funnel">${m.map(([e,t])=>{let[n,r]=p[e]||[`touch_app`,e];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${n}</span> ${zo(r)}</span><span class="dash-funnel__val">${N(t)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${h?Math.max(4,Math.round(t/h*100)):0}%"></div></div>
        </div>`}).join(``)}</div>`:Ro(`touch_app`,`CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar.`));let g={open:[`visibility`,`Magnet opened`],engage:[`touch_app`,`Visitor engaged`],route:[`alt_route`,`Picked a channel`],complete:[`check_circle`,`Completed: lead captured`]},_=a.recent_events||[];Ko(`dash-interactions`,_.length?`<div class="dash-list">${_.map(e=>{let[t,n]=g[e.event]||[`sensors`,e.event];return`<div class="dash-list__row">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">${t}</span></span>
          <span class="dash-list__main">${n}${e.event===`route`&&e.detail?` · ${zo(e.detail)}`:``}</span>
          ${e.display_mode?`<span class="dash-list__mode">${zo(e.display_mode)}</span>`:``}
          <span class="dash-list__time">${zo(To(e.at))}</span>
        </div>`}).join(``)}</div>`:Ro(`sensors`,`No interactions yet. They'll stream in as visitors engage your magnets.`));{let e=document.getElementById(`dash-interactions`)?.querySelector(`.dash-list`);e&&O(e,{rowSelector:`.dash-list__row`,noun:`interactions`})}}function jo(e){let t=document.getElementById(`dash-portfolio`);if(!t)return;if(!e.length){t.innerHTML=Ro(`groups`,`No client orgs yet. Create one under Clients to see its numbers here.`);return}let n=e.some(e=>e.ad),r=e=>{let t=(e.leads.this_week||0)-(e.leads.prev_week||0);return!e.leads.this_week&&!e.leads.prev_week?``:` <span class="${t>=0?`dc-delta-up`:`dc-delta-down`}">(${t>=0?`+`:``}${N(t)})</span>`};t.innerHTML=za(e,[{h:`Magnets`,td:e=>`${N(e.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${N(e.magnets.total)}</span>`},{h:`Leads · wk`,td:e=>`${N(e.leads.this_week)}${r(e)}`},{h:`Leads · total`,td:e=>N(e.leads.total)},{h:`Opens`,td:e=>N(e.opens)},{h:`Compl.`,td:e=>e.completion_rate==null?`—`:`${e.completion_rate}%`},...e.some(e=>e.ab_tests?.running||e.ab_tests?.completed)?[{h:`A/B`,td:e=>e.ab_tests?.running?`${N(e.ab_tests.running)} <span class="dc-sub">running</span>`:e.ab_tests?.completed?`${N(e.ab_tests.completed)} <span class="dc-sub">done</span>`:`—`}]:[],...e.some(e=>e.booked)?[{h:`Booked`,td:e=>e.booked?N(e.booked):`—`}]:[],...e.some(e=>e.call_taps)?[{h:`Call taps`,td:e=>e.call_taps?N(e.call_taps):`—`}]:[],...e.some(e=>e.called)?[{h:`Called`,td:e=>e.called?N(e.called):`—`}]:[],...n?[{h:`Spend`,td:e=>e.ad?`$${N(e.ad.spend)}`:`—`},{h:`CPL`,td:e=>e.ad?.cost_per_lead==null?`—`:`$${N(e.ad.cost_per_lead)}`}]:[]]),Va(t)}function Mo(e){let t=[[`Opened`,e.opens,``],[`Engaged`,e.engaged,` dash-funnel__bar--mid`],[`Completed`,e.completions,` dash-funnel__bar--end`],...e.booked?[[`Booked`,e.booked,` dash-funnel__bar--end`]]:[],...e.call_taps?[[`Call taps`,e.call_taps,` dash-funnel__bar--end`]]:[],...e.called?[[`Called`,e.called,` dash-funnel__bar--end`]]:[]],n=Math.max(1,e.opens||0),r=e=>Math.min(100,Math.round((e||0)/n*100));return`<div class="dash-funnel">${t.map(([e,t,n])=>`
    <div class="dash-funnel__row">
      <div class="dash-funnel__meta">
        <span class="dash-funnel__label">${e}</span>
        <span class="dash-funnel__val">${N(t)} <span class="dash-funnel__pct">${r(t)}%</span></span>
      </div>
      <div class="dash-funnel__track"><div class="dash-funnel__bar${n}" style="width:${Math.max(2,r(t))}%"></div></div>
    </div>`).join(``)}</div>`}async function No(e){let t=document.getElementById(`recent-leads-body`);if(t)try{let n=await b(`${e}/m5t/v5/m5mLead?limit=5`);j(n);let r=await n.json(),i=(Array.isArray(r?.data)?r.data:[]).filter(e=>![`DELETED`,`ARCHIVED`].includes(e.status));t.innerHTML=i.length?i.slice(0,5).map(Do).join(``):Ro(`contacts`,`No leads captured yet. Publish a magnet to start collecting.`)}catch(e){console.warn(`[dashboard] Leads fetch failed:`,e),t.innerHTML=$a(e)?eo():Ro(`error`,`Could not load recent leads.`)}}function Po(e){return ho({rows:e,xLabel:e=>String(e.date||``).slice(5),left:{value:e=>e.opens||0,label:`Magnet Opens`},right:{value:e=>e.leads||0,label:`Leads`},ariaLabel:`Magnet opens versus leads over time`,activatable:e=>Number(e.leads||0)>0,pointLabel:e=>`${Fo(e.date)}: ${N(e.opens||0)} opens, ${N(e.leads||0)} leads`,hitData:e=>({day:e.date,leads:Number(e.leads||0)})})}function Fo(e){try{return new Date(`${e}T00:00:00`).toLocaleDateString(void 0,{month:`short`,day:`numeric`,year:`numeric`})}catch{return e}}function Io(e){let t=document.getElementById(`dash-trend`);return t?_o(t,{rows:e,tipHTML:e=>`
      <div class="m5c-tip__title">${Fo(e.date)}</div>
      <div class="m5c-tip__row"><i class="m5c-sw m5c-sw--1"></i>${N(e.opens||0)} opens</div>
      <div class="m5c-tip__row"><i class="m5c-sw m5c-sw--2"></i>${N(e.leads||0)} leads</div>
      ${Number(e.leads||0)>0?`<div class="m5c-tip__go">Open these leads →</div>`:``}`,onActivate:e=>{ro(oo.LEADS_DAY,e.date),window.location.hash=`#/leads`}}):()=>{}}var Lo,Ro,zo,N,Bo,Vo,Ho,Uo,Wo,Go,Ko,qo,Jo,Yo=o((()=>{T(),Qa(),x(),no(),co(),fo(),So(),An(),pr(),rt(),Lo=[{h:`Magnets`},{h:`Leads · wk`},{h:`Leads · total`},{h:`Opens`},{h:`Compl.`}],Ro=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,zo=e=>String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]),N=e=>Number(e||0).toLocaleString(),Bo=e=>[e.first_name,e.last_name].filter(Boolean).join(` `).trim()||e.email||`(no name)`,Vo=e=>(Bo(e).split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``)||`?`).toUpperCase(),Ho=!1,Uo=(e,t,n,{wide:r=!1,full:i=!1,controls:a=!1}={})=>`
  <div class="dashboard-card${r?` chart-card-wide`:``}${i?` chart-card-full`:``}">
    ...
    <div class="card-body" id="${n}">${Ro(`hourglass_empty`,`Loading…`)}</div>
  </div>`,Wo=30,Go=(e,t)=>{let n=document.getElementById(e);n&&(n.textContent=t)},Ko=(e,t)=>{let n=document.getElementById(e);n&&(n.innerHTML=t)},qo=e=>e.toISOString().slice(0,10),Jo={render:Oo,init:ko}})),Xo=c({init:()=>Qo,render:()=>Zo});function Zo(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Ar(`#/home`)}
  ...
  `}function Qo(){console.log(`[SignoutRoute] Initialized`);let e=document.getElementById(`confirm-signout-btn`);e?.addEventListener(`click`,async()=>{e.disabled=!0,e.textContent=`SIGNING OUT...`,console.log(`[SignoutRoute] User confirmed signout`),await w.doSignout()})}var $o=o((()=>{T(),Fr()})),es=c({default:()=>as,init:()=>rs,render:()=>ns});function ts(){if(is)return;let e=document.createElement(`style`);e.id=`m5t-section-page-styles`,e.textContent=`
    .section-page {
  ...
  `,document.head.appendChild(e),is=!0}function ns({title:e=`Section`,icon:t=`widgets`,name:n=``}={}){return ts(),`
    ...
    </section>`}function rs(){}var is,as,os=o((()=>{is=!1,as={render:ns,init:rs}})),ss=c({default:()=>ks,init:()=>ms,render:()=>ps});function cs(){if(Ds)return;let e=document.createElement(`style`);e.id=`m5t-settings-general-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Ds=!0}function ls(){try{return un.getAvailableLanguages()||[]}catch{return[]}}function us(){let e=ls(),t=e.includes(v.FF_SSE_I18N_LANG)?v.FF_SSE_I18N_LANG:e[0]||v.FF_SSE_I18N_LANG;try{let n=localStorage.getItem(v.FF_SSE_LS_USER_LANG);return n&&e.includes(n)?n:t}catch{return t}}function ds(e){try{let t=new Intl.DisplayNames([e],{type:`language`}).of(e);if(t&&t!==e)return t.charAt(0).toUpperCase()+t.slice(1)}catch{}return e}function fs(){let e=Yn(),t=ls(),n=t.length>1;if(!e&&!n)return``;let r=us();return`
        ...
        <div class="settings-item" id="gen-dark-item">
          ...
          <div class="settings-item__control">
            <label class="m5t-switch">
              <input type="checkbox" role="switch" id="gen-dark" aria-label="Dark mode" ${nr()===`dark`?`checked`:``} />
        ...
        <div class="settings-item" id="gen-lang-item">
          ...
          <div class="settings-item__control">
            <select class="settings-select" id="gen-lang" aria-label="Language">
              ${t.map(e=>`<option value="${Ss(e)}" ${e===r?`selected`:``}>${Ss(ds(e))}</option>`).join(``)}
            </select>
          </div>
        </div>`:``}
      </div>
    </div>`}function ps(){return cs(),`
    <div class="page-shell" data-section="settings-general">
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ...
          <div id="gen-profile-body">${Os(`hourglass_empty`,`Loading…`)}</div>
        </div>
      </div>
    ...
    </div>`}async function ms(){ys(),await gs()}function hs(e){return`
    <div class="settings-grid-2">
      <div class="settings-field">
        <label class="settings-label" for="gen-first">First name</label>
        <input class="settings-input" id="gen-first" type="text" autocomplete="given-name" value="${Ss(e.first)}" />
        <p class="settings-error" id="gen-first-error" role="alert" hidden></p>
      </div>
      <div class="settings-field">
        <label class="settings-label" for="gen-last">Last name</label>
        <input class="settings-input" id="gen-last" type="text" autocomplete="family-name" value="${Ss(e.last)}" />
        <p class="settings-error" id="gen-last-error" role="alert" hidden></p>
      </div>
    </div>
    <div class="settings-field">
      <label class="settings-label" for="gen-company">Company</label>
      <input class="settings-input" id="gen-company" type="text" autocomplete="organization" value="${Ss(e.company)}" />
    </div>
    <div class="settings-field">
      <label class="settings-label" for="gen-phone">Phone</label>
      <input class="settings-input" id="gen-phone" type="tel" autocomplete="tel" value="${Ss(e.phone)}" />
    </div>
    <div class="settings-field">
      <label class="settings-label" for="gen-email">Sign-in email</label>
      <input class="settings-input" id="gen-email" type="email" value="${Ss(e.email)}" readonly />
    ...
    </div>`}async function gs(){let e=document.getElementById(`gen-profile-body`);if(e){try{let e=await b(Ts()),t=await e.json().catch(()=>({}));if(j(e,t),!t.ok||!t.data)throw Error(t.error||`Failed to load`);Es.profile=t.data}catch(t){console.warn(`[settings-general] profile load failed:`,t),e.innerHTML=$a(t)?eo():Os(`error`,`Could not load your profile. Please try again.`);return}e.innerHTML=hs(Es.profile),e.querySelector(`#gen-save`)?.addEventListener(`click`,vs)}}function _s(e,t){let n=document.getElementById(`${e}-error`);n&&(n.textContent=t||``,n.hidden=!t);let r=document.getElementById(e);r&&r.setAttribute(`aria-invalid`,t?`true`:`false`)}async function vs(){let e=document.getElementById(`gen-save`),t=e=>(document.getElementById(e)?.value??``).trim(),n={first:t(`gen-first`),last:t(`gen-last`),company:t(`gen-company`),phone:t(`gen-phone`)};if(_s(`gen-first`,n.first?``:`First name is required.`),_s(`gen-last`,n.last?``:`Last name is required.`),!(!n.first||!n.last)){e&&(e.disabled=!0);try{let e=await b(Ts(),{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify(n)}),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(t.error||`Could not save.`);t.data&&(Es.profile=t.data),Cs(`Profile updated.`,`success`)}catch(e){console.warn(`[settings-general] profile save failed:`,e),Cs(e.message||`Could not save.`,`error`)}finally{e&&(e.disabled=!1)}}}function ys(){let e=document.getElementById(`gen-dark`);if(e){e.addEventListener(`change`,()=>{rr(e.checked?`dark`:`light`),e.checked=nr()===`dark`});let t=bs.default.subscribe(p.UI_THEME_CHANGED,()=>{if(!e.isConnected){bs.default.unsubscribe(t);return}e.checked=nr()===`dark`})}let t=document.getElementById(`gen-lang`);t&&t.addEventListener(`change`,()=>{try{un.setLanguage(t.value)}catch(e){console.warn(`[settings-general] setLanguage failed:`,e)}})}var bs,xs,Ss,Cs,ws,Ts,Es,Ds,Os,ks,As=o((()=>{T(),bs=u(f(),1),m(),y(),or(),$n(),x(),no(),xs={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Ss=e=>String(e??``).replace(/[&<>"']/g,e=>xs[e]),Cs=(e,t=`info`)=>{try{bs.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},ws=()=>w.getConfig?.().BASE_URL||``,Ts=()=>`${ws()}/m5t/v5/acctEntity/profile`,Es={profile:null},Ds=!1,Os=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,ks={render:ps,init:ms}})),js=c({default:()=>oc,init:()=>Ps,render:()=>Ns});function Ms(){if(rc)return;let e=document.createElement(`style`);e.id=`m5t-workspace-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),rc=!0}function Ns(){Ms();let e=Zs[tc()];return`
    <div class="page-shell" data-section="settings-workspace">
      <div class="page-header">
        <div class="page-header-text">
          <div class="ws-title-row">
            <h1 class="page-title">Workspace</h1>
            ${e?`<span class="m5t-chip">${Ks(e)}</span>`:``}
          </div>
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ${ac(`apartment`,`Organization`,`Name and details.`)}
          <div id="ws-org-body">${ic(`hourglass_empty`,`Loading…`)}</div>
        </div>
      </div>

      <div class="dashboard-card" id="ws-team-card" style="margin-top:24px; display:none">
        <div class="card-body">
          ${ac(`group`,`Team`,`Who has access.`)}
          <div id="ws-team-body"></div>
        </div>
      </div>
    </div>`}async function Ps(){$s.org=null,await Fs(),await Bs()}async function Fs(){let e=document.getElementById(`ws-org-body`);if(!e)return;let t=ec();if(!t){e.innerHTML=ic(`apartment`,`No workspace on this account yet.`);return}try{let e=await b(`${Js()}/m5t/v5/acctGroup`),n=await e.json().catch(()=>({}));if(j(e,n),!n.ok)throw Error(n.error||`Failed to load`);if($s.org=(n.data||[]).find(e=>e.guid===t)||null,!$s.org)throw Error(`Org row not in scope`)}catch(t){console.warn(`[settings-workspace] load failed:`,t),e.innerHTML=$a(t)?eo():ic(`error`,`Could not load your workspace. Please try again.`);return}Ls()}function Is(){let e=Zs[tc()]||``,t=$s.org?.created?.created_tz,n=``;if(t){let e=new Date(t);Number.isNaN(e.getTime())||(n=`Created ${e.toLocaleDateString()}`)}let r=[e,n].filter(Boolean);return r.length?`<p class="settings-help">${Ks(r.join(` · `))}</p>`:``}function Ls(){let e=document.getElementById(`ws-org-body`);if(!e)return;let t=$s.org||{},n=w.getUiMode?.()!==`self_serve`;if(!nc()){let r=tc()===Xs?`<div class="settings-note"><span class="material-symbols-outlined" aria-hidden="true">info</span> This workspace is managed for you.</div>`:``;e.innerHTML=`
      <div class="settings-item">
        <div class="settings-item__info">
          <div class="settings-item__title">Organization name</div>
          <div class="settings-item__desc">${Ks(t.caption||`Not set`)}</div>
        </div>
      </div>
      ${n?`
      <div class="settings-item">
        <div class="settings-item__info">
          ...
          <div class="settings-item__desc">${Ks(t.description||`Not set`)}</div>
        </div>
      </div>`:``}
      ${r}
      <div style="margin-top:12px">${Is()}</div>`;return}e.innerHTML=`
    <div class="settings-field">
      <label class="settings-label" for="ws-name">Organization name</label>
      <input class="settings-input" id="ws-name" type="text" required value="${Ks(t.caption||``)}" />
    </div>
    ${n?`
    <div class="settings-field">
      <label class="settings-label" for="ws-desc">Description</label>
      <textarea class="settings-input" id="ws-desc" rows="2">${Ks(t.description||``)}</textarea>
    </div>`:``}
    <p class="settings-error" id="ws-org-error"></p>
    <div class="settings-save-row">
      ${Is()}
      <button class="btn btn-primary" type="button" id="ws-save">Save</button>
    </div>`,document.getElementById(`ws-save`)?.addEventListener(`click`,Rs)}async function Rs(){let e=document.getElementById(`ws-save`),t=document.getElementById(`ws-org-error`),n=(document.getElementById(`ws-name`)?.value||``).trim(),r=document.getElementById(`ws-desc`);if(t&&(t.textContent=``),!n){t&&(t.textContent=`Organization name is required.`);return}e&&(e.disabled=!0);try{let e=await b(`${Js()}/m5t/v5/acctGroup/${encodeURIComponent($s.org.id)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({caption:n,...r?{description:r.value.trim()}:{}})}),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(t.message||t.error||`Failed (HTTP ${e.status})`);$s.org={...$s.org,caption:n,...r?{description:r.value.trim()}:{}},qs(`Workspace updated.`,`success`)}catch(t){console.warn(`[settings-workspace] save failed:`,t),qs(t.message||`Could not save`,`danger`),e&&(e.disabled=!1);return}e&&(e.disabled=!1);try{await w.fetchScope?.()}catch(e){console.warn(`[settings-workspace] fetchScope after save failed:`,e)}}function zs(){document.getElementById(`ws-team-card`)?.remove()}async function Bs(){let e=document.getElementById(`ws-team-card`);if(!e)return;let t=ec();if(!t||!nc()){zs();return}let n=[],r=[];try{let[e,i]=await Promise.all([b(`${Js()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/members`),b(`${Js()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/invites`)]);if(e.status===403||i.status===403){zs();return}let[a,o]=await Promise.all([e.json().catch(()=>({})),i.json().catch(()=>({}))]);if(!e.ok||!i.ok)throw Error(`members: ${e.status}, invites: ${i.status}`);n=a.members||[],r=o.invites||[]}catch(t){console.warn(`[settings-workspace] team load failed:`,t),e.style.display=``;let n=document.getElementById(`ws-team-body`);n&&(n.innerHTML=ic(`error`,`Could not load your team. Please try again.`));return}Us(n,r)}function Vs(e){if(!e.length)return``;let t=e.slice(0,Qs),n=e.length-t.length;return`
    <div class="ws-avatars">
      ${t.map(e=>`<span class="ws-avatar" title="${Ks(e.name||e.email)}">${Ks(Ys(e.name||e.email))}</span>`).join(``)}
      ${n>0?`<span class="ws-avatar ws-avatar--more">+${n}</span>`:``}
    </div>`}function Hs(e,t){let n=`${e.length} member${e.length===1?``:`s`}`;return t.length?`${n} · ${t.length} pending invite${t.length===1?``:`s`}`:n}function Us(e,t){let n=document.getElementById(`ws-team-card`),r=document.getElementById(`ws-team-body`);if(!n||!r)return;n.style.display=``;let i=tc()!==Xs;r.innerHTML=`
    ${Vs(e)}
    <p class="ws-counts">${Ks(Hs(e,t))}</p>
    ${i?`<div class="ws-team-actions"><a class="btn btn-secondary" href="#/team">Manage team</a></div>`:``}`}var Ws,Gs,Ks,qs,Js,Ys,Xs,Zs,Qs,$s,ec,tc,nc,rc,ic,ac,oc,sc=o((()=>{T(),Ws=u(f(),1),m(),x(),no(),Gs={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Ks=e=>String(e??``).replace(/[&<>"']/g,e=>Gs[e]),qs=(e,t=`info`)=>{try{Ws.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Js=()=>w.getConfig?.().BASE_URL||``,Ys=e=>String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``).toUpperCase()||`?`,Xs=`managed_client`,Zs={reseller_org:`Your organization`,managed_client:`Client workspace`,saas_org:`Organization`},Qs=6,$s={org:null},ec=()=>w.getActiveOrg()?.guid||w.getMemberships()[0]?.orgGuid||null,tc=()=>w.getActiveOrg()?.channel||w.getMemberships()[0]?.channel||null,nc=()=>w.getCapabilities().includes(`manage_team`),rc=!1,ic=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,ac=(e,t,n)=>`
  <div class="settings-section__head">
  ...
  </div>`,oc={render:Ns,init:Ps}})),cc=c({default:()=>Pc,init:()=>dc,render:()=>uc});function lc(){if(Mc)return;let e=document.createElement(`style`);e.id=`m5t-notif-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Mc=!0}function uc(){return lc(),La(),A()?Ha({section:`settings-notifications`,title:`Notifications`,description:`Pick a client to manage their lead alerts.`}):`
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Email sent the moment a magnet captures a lead. Up to ${Dc} recipients per magnet.</p>
            </div>
          </div>
          <div id="ntf-body">${Nc(`hourglass_empty`,`Loading…`)}</div>
        </div>
      </div>
      <div class="dashboard-card" id="ntf-wh-card" style="margin-top:24px; display:none">
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              <h2 class="settings-section__title">Lead delivery</h2>
              <p class="settings-section__desc">Each captured and qualified lead, sent to Slack, Microsoft Teams, or your own endpoint.</p>
            </div>
          </div>
          <div id="ntf-wh-body"></div>
        </div>
      </div>
    </div>`}async function dc(){if(A()){let e=e=>Number(e||0).toLocaleString();return Wa(Tc(),[{h:`Magnets`,td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:`Leads · wk`,td:t=>e(t.leads.this_week)}],{emptyMsg:`No client orgs yet. Create one under Clients first.`})}await Promise.all([gc(),fc()])}async function fc(){let e=Ac();if(!e||!jc()){Oc.webhookAllowed=!1;return}try{let t=await b(`${Tc()}/m5t/v5/acctGroup/${encodeURIComponent(e)}/webhook`);if(t.status===403){Oc.webhookAllowed=!1;return}let n=await t.json().catch(()=>({}));if(!n.ok)return;Oc.webhook=n.webhook,Oc.slack=n.slack||null,Oc.teams=n.teams||null,hc()}catch{}}function pc(e){try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return``}}function mc(e){return e===`generic`?Oc.webhook:Oc[e]}function hc(){let e=document.getElementById(`ntf-wh-card`),t=document.getElementById(`ntf-wh-body`);!e||!t||(e.style.display=``,t.innerHTML=kc.map(e=>{let t=mc(e.key),n=t?.last_delivery;return`
    <div class="ntf-wh" data-kind="${e.key}" style="margin-bottom:18px">
      <div class="settings-field" style="margin-bottom:0">
        <label class="settings-label" for="ntf-wh-url-${e.key}">
          <span class="material-symbols-outlined" aria-hidden="true" style="font-size:16px;vertical-align:-3px">${e.icon}</span>
          ${e.label}
        </label>
        <input class="ntf-input" id="ntf-wh-url-${e.key}" type="url" placeholder="${Cc(e.ph)}" value="${Cc(t?.uri||``)}" />
        <p class="settings-help">${Cc(e.help)}</p>
      </div>
      ${e.secret?`
      <div class="settings-field" style="margin-bottom:0">
        <label class="settings-label" for="ntf-wh-secret">Signing secret</label>
        <input class="ntf-input" id="ntf-wh-secret" type="text" autocomplete="off" placeholder="${t?.has_secret?`Signing secret saved. Type to replace.`:`Optional`}" />
        <p class="settings-help">Sent as an HMAC signature header so your endpoint can verify deliveries.</p>
      </div>`:``}
      <div class="ntf-wh__row">
        <button class="ntf-btn" type="button" data-wh-save="${e.key}"><span class="material-symbols-outlined" aria-hidden="true">save</span> Save</button>
        <button class="ntf-btn" type="button" data-wh-test="${e.key}" ${t?.uri?``:`disabled`}><span class="material-symbols-outlined" aria-hidden="true">send</span> Send test</button>
        <span class="ntf-wh__status">${n?n.ok?`Last delivery: <span class="ok">delivered</span> ${Cc(pc(n.tz))}`:`Last delivery: <span class="bad">failed</span> ${Cc(pc(n.tz))} (${Cc(n.error||``)})`:``}</span>
      </div>
    </div>`}).join(``),t.querySelectorAll(`[data-wh-save]`).forEach(e=>e.addEventListener(`click`,async()=>{let n=e.getAttribute(`data-wh-save`),r=t.querySelector(`#ntf-wh-url-${n}`)?.value.trim()||``,i={uri:r,kind:n};if(n===`generic`){let e=t.querySelector(`#ntf-wh-secret`)?.value??``;e.trim()!==``&&(i.secret=e.trim())}try{let e=await b(`${Tc()}/m5t/v5/acctGroup/${encodeURIComponent(Ac())}/webhook`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify(i)}),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(t.error||`Failed (HTTP ${e.status})`);n===`generic`?Oc.webhook=t.webhook:Oc[n]=t.webhook;let a=kc.find(e=>e.key===n)?.label||`Destination`;wc(r?`${a} saved`:`${a} removed`,`success`),hc()}catch(e){wc(e.message||`Could not save`,`danger`)}})),t.querySelectorAll(`[data-wh-test]`).forEach(e=>e.addEventListener(`click`,async()=>{let t=e.getAttribute(`data-wh-test`);e.disabled=!0;try{let e=await b(`${Tc()}/m5t/v5/acctGroup/${encodeURIComponent(Ac())}/webhook-test`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({kind:t})}),n=await e.json().catch(()=>({}));e.ok&&n.ok?wc(`Test delivery sent`,`success`):wc(n.error||`Could not deliver the test`,`danger`)}catch{wc(`Could not deliver the test`,`danger`)}finally{e.disabled=!1}try{await fc()}catch(e){console.warn(`[notifications] loadWebhook refresh failed:`,e)}})))}async function gc(){let e=document.getElementById(`ntf-body`);if(e){try{let e=await(await b(`${Tc()}/m5t/v5/magnets`)).json().catch(()=>({}));if(!e.ok)throw Error(e.message||`Failed to load`);Oc.magnets=(e.magnets||[]).filter(e=>e.status!==`ARCHIVED`),Oc.canManage=!!e.canManage}catch(t){console.warn(`[notifications] load failed:`,t),e.innerHTML=Nc(`error`,`Could not load your magnets. Please try again.`);return}vc()}}function _c(e){let t=Array.isArray(e.notify_emails)?e.notify_emails:[],n=t.length>0;return`
    <div class="ntf-row" data-guid="${Cc(e.guid)}">
      <div class="ntf-magnet">
        <div class="ntf-name" title="${Cc(e.name)}">${Cc(e.name)}</div>
        <div class="ntf-meta">${Cc((e.domains||[]).join(`, `)||e.status)}</div>
      ...
      <div class="ntf-config">
        ${t.length?`<div class="ntf-chips">${t.map(e=>`
              <span class="ntf-chip">${Cc(e)}${Oc.canManage?`<button type="button" data-remove="${Cc(e)}" aria-label="Remove ${Cc(e)}">&times;</button>`:``}</span>`).join(``)}</div>`:`<div class="ntf-none">No alert emails.</div>`}
        ${Oc.canManage?`
        <div class="ntf-addrow">
          <input class="ntf-input" type="email" placeholder="name@business.com" aria-label="Add alert email" ${t.length>=Dc?`disabled`:``} />
          <button class="ntf-btn" type="button" data-add ${t.length>=Dc?`disabled`:``}>
    ...
    </div>`}function vc(){let e=document.getElementById(`ntf-body`);if(e){if(!Oc.magnets.length){e.innerHTML=Nc(`widgets`,`No magnets yet. Create one under Your Magnets first.`);return}e.innerHTML=Oc.magnets.map(_c).join(``),O(e,{rowSelector:`.ntf-row`,noun:`magnets`}),e.querySelectorAll(`.ntf-row`).forEach(e=>{let t=e.dataset.guid,n=e.querySelector(`.ntf-input`),r=()=>{let e=(n?.value||``).trim().toLowerCase();if(!e)return;if(!Ec(e)){wc(`That does not look like an email address`,`danger`);return}let r=[...Oc.magnets.find(e=>e.guid===t).notify_emails||[]];if(r.includes(e)){wc(`Already added`,`info`);return}if(r.length>=Dc){wc(`Up to ${Dc} emails per magnet`,`info`);return}yc(t,[...r,e])};e.querySelector(`[data-add]`)?.addEventListener(`click`,r),n?.addEventListener(`keydown`,e=>{e.key===`Enter`&&r()}),e.querySelectorAll(`[data-remove]`).forEach(e=>e.addEventListener(`click`,()=>{let n=Oc.magnets.find(e=>e.guid===t);yc(t,(n.notify_emails||[]).filter(t=>t!==e.dataset.remove))})),e.querySelector(`[data-test]`)?.addEventListener(`click`,()=>bc(t,e.querySelector(`[data-test]`)))})}}async function yc(e,t){try{let n=await b(`${Tc()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({notify_emails:t})}),r=await n.json().catch(()=>({}));if(!n.ok||!r.ok)throw Error(r.error||r.message||`Failed (HTTP ${n.status})`);let i=Oc.magnets.find(t=>t.guid===e);i&&(i.notify_emails=t),wc(`Alert emails updated`,`success`)}catch(e){console.warn(`[notifications] save failed:`,e),wc(e.message||`Could not save`,`danger`);return}try{vc()}catch(e){console.error(`[notifications] renderBody after save failed:`,e)}}async function bc(e,t){t&&(t.disabled=!0);try{let t=await b(`${Tc()}/m5t/v5/magnets/${encodeURIComponent(e)}/notify-test`,{method:`POST`}),n=await t.json().catch(()=>({}));t.ok&&n.ok?wc(`Test alert sent`,`success`):wc(n.error||`Could not send the test`,`danger`)}catch{wc(`Could not send the test`,`danger`)}finally{t&&(t.disabled=!1)}}var xc,Sc,Cc,wc,Tc,Ec,Dc,Oc,kc,Ac,jc,Mc,Nc,Pc,Fc=o((()=>{T(),rt(),xc=u(f(),1),m(),Qa(),An(),x(),Sc={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Cc=e=>String(e??``).replace(/[&<>"']/g,e=>Sc[e]),wc=(e,t=`info`)=>{try{xc.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Tc=()=>w.getConfig?.().BASE_URL||``,Ec=e=>De(e),Dc=5,Oc={magnets:[],canManage:!1,webhook:null,slack:null,teams:null,webhookAllowed:!0},kc=[{key:`slack`,label:`Slack`,icon:`tag`,ph:`https://hooks.slack.com/services/…`,help:`Paste a Slack incoming webhook URL. In Slack: create an app, turn on Incoming Webhooks, add one to your channel.`},{key:`teams`,label:`Microsoft Teams`,icon:`groups`,ph:`https://….logic.azure.com/workflows/…`,help:`Paste a Teams workflow URL. In the channel: Workflows, then "Post to a channel when a webhook request is received".`},{key:`generic`,label:`Custom webhook`,icon:`webhook`,secret:!0,ph:`https://hooks.zapier.com/hooks/catch/…`,help:`Any endpoint that accepts JSON. Works with Zapier catch hooks and CRM endpoints.`}],Ac=()=>w.getActiveOrg()?.guid||w.getMemberships()[0]?.orgGuid||null,jc=()=>w.getCapabilities().includes(`manage_magnets`),Mc=!1,Nc=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Pc={render:uc,init:dc}}));function Ic({label:e=``,content:t=``,size:n=``,onClose:r=null}={}){let i=document.activeElement,a=document.createElement(`div`);a.className=`m5t-modal-scrim`,a.innerHTML=`
    <div class="m5t-modal${n===`wide`?` m5t-modal--wide`:``}" role="dialog" aria-modal="true" aria-label="${Lc(e)}" tabindex="-1">
    ...
    </span>`}function $c(e,t){let n=yl(),r=e?.[t]||[];return r.find(e=>e.owner_guid===n)||r[0]||null}function el(e,t,n){return e.connect&&!n?`unavailable`:t?t.connect_status===`ACTIVE`?`connected`:`broken`:`idle`}function tl(e,t){return e===`unavailable`?`<span class="intg-state">Not available yet</span>`:e===`idle`?`<span class="intg-state">Not connected</span>`:e===`connected`?`<span class="intg-state on"><span class="material-symbols-outlined" aria-hidden="true">check</span>Connected</span>`:`<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>${P(t?.connect_status===`NEEDS_REAUTH`?`Reconnect needed`:`Connection error`)}</span>`}async function nl(){let e=await b(`${I()}/m5t/v5/integrations`);if(e.status===403)return{denied:!0};let t=await e.json();if(!t.ok)throw Error(t.error||`load failed`);return{providers:t.data.providers,configured:t.data.configured}}async function rl(e){if(!Cl.busy){Cl.busy=!0;try{let t=await(await b(`${I()}/m5t/v5/integrations/${e.slug}/connect`)).json();if(!t.ok||!t.data?.url)throw Error(t.error||`connect failed`);window.location.href=t.data.url}catch(t){F(t.message||e.connect.fallbackError,`error`),Cl.busy=!1}}}async function il(e,{refresh:t}={}){if(Cl.busy)return;Cl.busy=!0;let n=document.getElementById(e.card.ids.sync);n&&(n.disabled=!0);try{let t=await(await b(`${I()}/m5t/v5/integrations/${e.slug}/sync`,{method:`POST`})).json();if(!t.ok)throw Error(t.error||`sync failed`);let n=(t.data?.connections?.[0]?.[e.sync.itemsField]||[]).filter(e=>e.error).length;F(n?e.sync.failedToast(n):`Metrics synced.`,n?`warning`:`success`)}catch{F(`Sync failed.`,`error`)}finally{Cl.busy=!1,n&&(n.disabled=!1),t?.()}}async function al(e,{refresh:t}={}){if(Cl.busy)return;Cl.busy=!0;let n=!1;try{n=await Bc({title:`Disconnect ${e.label}?`,message:e.disconnect.confirm,confirmLabel:`Disconnect`,danger:!0})}finally{n||(Cl.busy=!1)}if(n)try{let t=await(await b(`${I()}/m5t/v5/integrations/${e.slug}`,{method:`DELETE`})).json().catch(()=>({}));if(!t.ok)throw Error(t.error||`disconnect failed`);F(e.disconnect.toast,`success`)}catch{F(`Disconnect failed.`,`error`)}finally{Cl.busy=!1,t?.()}}async function ol(e,{refresh:t}={}){let n=e.picker,r=document.getElementById(e.card.ids.panel);if(r){r.style.display=``,r.innerHTML=Sl(n.loading);try{let r=await(await b(`${I()}/m5t/v5/integrations/${e.slug}/${n.path}`)).json();if(!r.ok)throw Error(r.error||`load failed`);sl(e,r.data[n.itemsField]||[],new Set(r.data.linked||[]),{refresh:t})}catch{r.innerHTML=Sl(n.loadError,`error`)}}}function sl(e,t,n,{refresh:r}={}){let i=e.picker,a=document.getElementById(e.card.ids.panel);if(!a)return;let o=t.map(e=>{let t=i.rowDisabled(e),r=i.rowBadge(e),a=n.has(e.id)&&!t;return`
      <label class="intg-acct${t?` disabled`:``}">
        <input type="checkbox" data-${i.dataAttr}="${P(e.id)}" ${a?`checked`:``} ${t?`disabled`:``}>
        <span style="min-width:0">
          <span class="intg-acct__name">${P(e.name||i.namePrefix+e.id)}</span>
          <div class="intg-acct__id">${P(e.id)}</div>
        </span>
        ${r?`<span class="intg-acct__badge">${P(r)}</span>`:`<span></span>`}
    ...
    </div>`,document.getElementById(i.ids.cancel)?.addEventListener(`click`,()=>{a.style.display=`none`}),document.getElementById(i.ids.save)?.addEventListener(`click`,()=>cl(e,{refresh:r}))}async function cl(e,{refresh:t}={}){let n=e.picker,r=document.getElementById(e.card.ids.panel),i=[...r?.querySelectorAll(`input[data-${n.dataAttr}]:checked`)||[]].map(e=>e.dataset[n.datasetKey]),a=document.getElementById(n.ids.save);a&&(a.disabled=!0);try{let a=await(await b(`${I()}/m5t/v5/integrations/${e.slug}/${n.path}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({[n.saveField]:i})})).json();if(!a.ok)throw Error(a.error||`save failed`);F(n.savedToast(a.data.linked),`success`),r&&(r.style.display=`none`),t?.()}catch{F(n.saveError,`error`),a&&(a.disabled=!1)}}function ll({refresh:e}={}){let t=document.getElementById(Gc.gohighlevel.card.ids.setup);if(!t)return;t.style.display=``,t.innerHTML=`
    <div class="intg-picker">
    ...
    </div>`;let n=e=>{let t=document.getElementById(`intg-gh-status`);t&&(t.textContent=e)};document.getElementById(`intg-gh-cancel`)?.addEventListener(`click`,()=>{t.style.display=`none`}),document.getElementById(`intg-gh-save`)?.addEventListener(`click`,async()=>{let r=document.getElementById(`intg-gh-save`),i=document.getElementById(`intg-gh-token`)?.value.trim()||``,a=document.getElementById(`intg-gh-location`)?.value.trim()||``;if(!i||!a){n(`Paste the token and the Location ID first.`);return}r.disabled=!0,n(`Checking with HighLevel…`);try{let n=await(await b(`${I()}/m5t/v5/integrations/gohighlevel/connect`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({token:i,location_id:a})})).json().catch(()=>({}));if(!n.ok)throw Error(n.error||`Could not connect HighLevel.`);F(`HighLevel connected${n.data.location_name?` to ${n.data.location_name}`:``}.`,`success`),t.style.display=`none`,e?.()}catch(e){n(e.message||`Could not connect HighLevel.`),r.disabled=!1}}),document.getElementById(`intg-gh-token`)?.focus()}function ul({refresh:e}={}){let t=document.getElementById(Gc.calcom.card.ids.setup);if(!t)return;t.style.display=``,t.innerHTML=`
    <div class="intg-picker">
    ...
    </div>`;let n=e=>{let t=document.getElementById(`intg-cc-status`);t&&(t.textContent=e)};document.getElementById(`intg-cc-cancel`)?.addEventListener(`click`,()=>{t.style.display=`none`}),document.getElementById(`intg-cc-save`)?.addEventListener(`click`,async()=>{let r=document.getElementById(`intg-cc-save`),i=document.getElementById(`intg-cc-key`)?.value.trim()||``;if(!i){n(`Paste an API key first.`);return}r.disabled=!0,n(`Checking the key with Cal.com…`);try{let n=await(await b(`${I()}/m5t/v5/integrations/calcom/connect`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({api_key:i})})).json().catch(()=>({}));if(!n.ok)throw Error(n.error||`Could not connect Cal.com.`);F(`Cal.com connected as ${n.data.username||`your account`}.`,`success`),t.style.display=`none`,e?.()}catch(e){n(e.message||`Could not connect Cal.com.`),r.disabled=!1}}),document.getElementById(`intg-cc-key`)?.focus()}function dl({refresh:e,replaceKey:t=!1}={}){let n=document.getElementById(Gc.callrail.card.ids.setup);n&&(n.style.display=``,n.innerHTML=`
    <div class="intg-picker">
    ...
    </div>`,document.getElementById(`intg-r-cancel`)?.addEventListener(`click`,()=>{n.style.display=`none`}),document.getElementById(`intg-r-continue`)?.addEventListener(`click`,()=>fl({refresh:e})),document.getElementById(`intg-r-key`)?.focus())}async function fl({refresh:e}={}){let t=document.getElementById(`intg-r-continue`),n=document.getElementById(`intg-r-key`)?.value.trim()||``,r=document.getElementById(`intg-r-pickers`);if(!n){El(`Paste an API key first.`);return}if(r&&!r.hidden)return ml(n,{refresh:e});t&&(t.disabled=!0),El(`Checking the key with CallRail…`);try{let e=await(await b(`${I()}/m5t/v5/integrations/callrail/validate`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({api_key:n})})).json();if(!e.ok){El(e.error||`CallRail rejected that key.`);return}let i=e.data.accounts||[],a=document.getElementById(`intg-r-account`);a&&(a.innerHTML=i.map(e=>`<option value="${P(e.id)}">${P(e.name)}</option>`).join(``),a.onchange=()=>pl(n,a.value)),r&&(r.hidden=!1),t&&(t.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">save</span>Save`),El(``),await pl(n,i[0]?.id)}catch{El(`Could not reach CallRail. Try again.`)}finally{t&&(t.disabled=!1)}}async function pl(e,t){let n=document.getElementById(`intg-r-company`);if(!(!n||!t)){n.innerHTML=`<option value="">Loading companies…</option>`;try{let r=await(await b(`${I()}/m5t/v5/integrations/callrail/companies`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({api_key:e,account_id:t})})).json(),i=r.ok&&r.data.companies||[];n.innerHTML=i.length?i.map(e=>`<option value="${P(e.id)}">${P(e.name)}</option>`).join(``):`<option value="">No active companies in this account</option>`}catch{n.innerHTML=`<option value="">Could not load companies</option>`}}}async function ml(e,{refresh:t}={}){let n=document.getElementById(`intg-r-continue`),r=document.getElementById(`intg-r-account`)?.value||``,i=document.getElementById(`intg-r-company`)?.value||``;if(!i){El(`Pick the company this workspace tracks.`);return}n&&(n.disabled=!0),El(`Connecting…`);try{let n=await(await b(`${I()}/m5t/v5/integrations/callrail`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({api_key:e,account_id:r,company_id:i})})).json();if(!n.ok)throw Error(n.error||`connect failed`);F(n.data?.webhook_state===`active`?`CallRail connected. Call sync is on.`:`CallRail connected. Call sync setup needs attention; see below.`,`success`),t?.()}catch{El(`Could not connect. Check the key and try again.`),n&&(n.disabled=!1)}}async function hl({refresh:e}={}){if(Cl.busy)return;Cl.busy=!0;let t=document.getElementById(Gc.callrail.card.ids.sync);t&&(t.disabled=!0);try{let e=await(await b(`${I()}/m5t/v5/integrations/callrail/sync?days=7`,{method:`POST`})).json();if(!e.ok)throw Error(e.error||`sync failed`);let t=e.data?.connections?.[0]||{};F(t.error?`Sync finished with errors.`:`Sync done. ${t.processed||0} new call${(t.processed||0)===1?``:`s`} recorded.`,t.error?`warning`:`success`)}catch{F(`Sync failed.`,`error`)}finally{Cl.busy=!1,t&&(t.disabled=!1),e?.()}}function gl(){if(Dl)return;let e=document.createElement(`style`);e.id=`m5t-intg-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Dl=!0}var _l,vl,P,F,I,yl,bl,xl,Sl,Cl,wl,Tl,El,Dl,Ol=o((()=>{T(),_l=u(f(),1),m(),Uc(),x(),Yc(),vl={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},P=e=>String(e??``).replace(/[&<>"']/g,e=>vl[e]),F=(e,t=`info`)=>{try{_l.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},I=()=>w.getConfig?.().BASE_URL||``,yl=()=>w.getActiveOrg()?.guid||w.getMemberships()[0]?.orgGuid||null,bl=()=>w.getCapabilities().includes(`manage_magnets`),xl=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Sl=(e,t=``)=>`<div class="intg-alert ${t}"><span class="material-symbols-outlined" aria-hidden="true">${t===`error`?`error`:`info`}</span><span>${e}</span></div>`,Cl={busy:!1},de(()=>{Cl.busy=!1}),wl=null,Tl=Object.fromEntries(Object.values(Gc).map(e=>[e.urlSlug,e.slug])),El=e=>{let t=document.getElementById(`intg-r-status`);t&&(t.textContent=e)},Dl=!1})),kl=c({default:()=>zl,init:()=>jl,render:()=>Al});function Al(){return gl(),La(),A()?Ha({section:`settings-integrations`,title:`Integrations`,description:`Pick a client to manage their connections.`}):`
    <div class="page-shell" data-section="settings-integrations">
      ...
      <div id="intg-body">
        <div class="dashboard-card intg-card"><div class="card-body">${xl(`hourglass_empty`,`Loading…`)}</div></div>
      </div>
    </div>`}async function jl(){if(A()){let e=e=>Number(e||0).toLocaleString();return Wa(I(),[{h:`Magnets`,td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:`Leads · wk`,td:t=>e(t.leads.this_week)}],{emptyMsg:`No client orgs yet. Create one under Clients first.`})}Ml()||await Nl()}function Ml(){try{let e=new URLSearchParams(window.location.search),t=e.get(`connected`),n=e.get(`error`)?e.get(`provider`)||`google_ads`:null,r=null;if(t&&Object.hasOwn(Rl,t)){let n=t===`ms_bookings`?e.get(`consent`):null;n===`granted`?F(`In-magnet booking approved for your organization.`,`success`):n===`declined`?F(`Microsoft Bookings is connected. In-magnet booking still needs the one-time approval, see step 2.`,`warning`):F(`${Rl[t]} connected.`,`success`),Xc({slug:t,connected:!0}),r=Object.hasOwn(Gc,t)?Gc[t]:null}else if(n){let t=Object.hasOwn(Rl,n)?Rl[n]:n;F(`${t} connection failed (${e.get(`error`)}).`,`error`),r=Object.hasOwn(Gc,n)?Gc[n]:null}else return!1;return window.history.replaceState(null,``,window.location.pathname+window.location.hash),r?(window.router?.navigate(`/settings/integrations/${r.urlSlug}`),!0):!1}catch{return!1}}async function Nl(){let e=document.getElementById(`intg-body`);try{let{denied:t,providers:n,configured:r}=await nl();if(t){e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${xl(`lock`,`Integrations are managed by workspace admins.`)}</div></div>`);return}e&&(e.innerHTML=Ll(n,r))}catch{e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${xl(`error`,`Could not load integrations.`)}</div></div>`)}}function Pl(e,t,n){let r=el(e,t,n);return`
    ...
    <a class="intg-tile" href="${P(e.href)}" data-provider="${P(e.key||`webhook`)}">
      <div class="intg-tile__head">
        ...
        <div class="intg-tile__titles">
          <div class="intg-tile__name">${P(e.label)}</div>
          <div class="intg-tile__sub">${P(e.sub)}</div>
        </div>
      </div>
      <p class="intg-tile__desc">${P(e.tile)}</p>
      <div class="intg-tile__foot">
        <span class="intg-state">Set up under Notifications</span>
        <span class="intg-tile__go material-symbols-outlined" aria-hidden="true">arrow_forward</span>
      </div>
    </a>`}function Ll(e,t){return Kc.map(n=>{let r=n.key===`automation`?qc.map(Il).join(``):Object.values(Gc).filter(e=>e.category===n.key).map(n=>Pl(n,$c(e,n.slug),!!t?.[n.slug])).join(``);return r?`
      <section class="intg-section" data-category="${P(n.key)}">
        <h2 class="intg-section__title">${P(n.title)}</h2>
        <p class="intg-section__intro">${P(n.intro)}</p>
        <div class="intg-grid">${r}</div>
      </section>`:``}).join(``)}var Rl,zl,Bl=o((()=>{Ol(),Qa(),Rl=Object.fromEntries(Object.values(Gc).filter(e=>e.connect).map(e=>[e.slug,e.label])),zl={render:Al,init:jl}})),Vl=c({default:()=>cu,init:()=>Ul,render:()=>Hl});function Hl({provider:e}={}){gl(),La();let t=Tl[e];if(!t||A())return`<div class="page-shell"></div>`;let n=Gc[t];return L.provider=n,`
    <div class="page-shell" data-section="settings-integrations">
    ...
    </div>`}async function Ul({provider:e}={}){let t=Tl[e];if(!t||A()){window.router?.navigate(`/settings/integrations`,{historyAPIMethod:`replaceState`});return}await Wl();let n=Zc();n?.connected&&n.slug===t&&L.provider?.picker&&bl()&&ol(L.provider,{refresh:Wl})}async function Wl(){let e=document.getElementById(`intg-detail`);if(!(!e||!L.provider))try{let{denied:t,providers:n,configured:r}=await nl();if(t){e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${xl(`lock`,`Integrations are managed by workspace admins.`)}</div></div>`;return}L.conn=$c(n,L.provider.slug),L.configured=!!r?.[L.provider.slug],L.status=el(L.provider,L.conn,L.configured),e.innerHTML=Gl(),tu()}catch{e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${xl(`error`,`Could not load this integration.`)}</div></div>`}}function Gl(){let e=L.provider;return[ql(e),Jl(e),Yl(e),$l(e),eu(e)].filter(Boolean).join(``)}function Kl(e){let t=L.conn?.external_account||{};if(L.status!==`connected`)return e.card.sub;if(e.slug===`calendly`){let e=[t.name,t.email&&`(${t.email})`].filter(Boolean).join(` `);return e?`Connected as ${e}.`:`Connected.`}if(e.slug===`callrail`){let e=[t.account_name,t.company_name].filter(Boolean).join(` · `);return e?`Connected to ${e}.`:`Connected.`}if(e.slug===`hubspot`)return t.hub_domain?`Connected to ${t.hub_domain}.`:`Connected.`;if(e.slug===`zoho`)return t.location?`Connected to Zoho CRM (${String(t.location).toUpperCase()} data center).`:`Connected to Zoho CRM.`;if(e.slug===`salesforce`)return t.username?`Connected as ${t.username}.`:`Connected.`;if(e.slug===`gohighlevel`)return t.location_name?`Connected to ${t.location_name}.`:`Connected.`;if(e.slug===`calcom`)return t.username?`Connected as ${t.username}.`:`Connected.`;if(e.slug===`ms_bookings`)return t.upn?`Connected as ${t.upn}.`:`Connected.`;let n=e.card.reachableCount(t);return n?`${n} reachable ${e.slug===`google_analytics`?n===1?`property`:`properties`:n===1?`account`:`accounts`}.`:`Connected.`}function ql(e){let t=``;bl()&&(e.connect&&(L.status===`idle`||L.status===`broken`)&&L.configured&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${L.status===`broken`?`Reconnect`:`Connect`}</button>`),(e.slug===`callrail`||e.slug===`calcom`||e.slug===`gohighlevel`)&&L.status!==`connected`&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${L.status===`broken`?`Reconnect`:`Connect`}</button>`));let n;return n=L.status===`unavailable`?`${e.label} is being set up for this platform.`:L.status===`broken`?e.card.brokenDesc:L.status===`idle`?bl()?e.card.idleDesc:e.card.sub:Kl(e),`
        ...
        <div class="intg-hero">
          ...
          <div class="intg-hero__meta">
            <div class="intg-hero__name-row">
              <span class="intg-hero__name">${P(e.label)}</span>
              ${tl(L.status,L.conn)}
            </div>
            <div class="intg-hero__sub">${P(e.card.sub)}</div>
          </div>
          <div class="intg-actions">${t}</div>
        </div>
        <p class="intg-desc">${P(n)}</p>
        ${(e.slug===`callrail`||e.slug===`calcom`||e.slug===`gohighlevel`)&&L.status!==`connected`?`<div id="${e.card.ids.setup}" style="display:none"></div>`:``}
      </div>
    </div>`}function Jl(e){let t=Wc[e.slug];return t?L.status===`connected`||L.status===`unavailable`||!bl()?`
      <div class="dashboard-card intg-card">
        <div class="card-body">
          <p class="intg-desc" style="margin-top:0">${P(t.what)}</p>
          <details class="intg-walkthrough">
            <summary>Setup guide</summary>
            <div class="intg-walkthrough__body">
              <ol>${t.steps.map(e=>`<li>${P(e)}</li>`).join(``)}</ol>
            </div>
          </details>
        </div>
      </div>`:`
    <div class="dashboard-card intg-card">
      <div class="card-body">
        <div class="card-title" style="margin-bottom:10px"><span class="material-symbols-outlined" aria-hidden="true">checklist</span> Set up ${P(e.label)}</div>
        <p class="intg-desc" style="margin:0 0 10px">${P(t.what)}</p>
        <ol class="intg-steps">
          ${t.steps.map((e,t)=>`
            <li class="intg-step${t===0?` intg-step--current`:``}">
              <span class="intg-step__num">${t+1}</span>
              <span class="intg-step__text">${P(e)}</span>
            </li>`).join(``)}
        </ol>
      </div>
    </div>`:``}function Yl(e){if(L.status!==`connected`)return``;let t=bl();if(e.picker){let n=e.card.reachableCount(L.conn?.external_account);return`
      <div class="dashboard-card intg-card">
        <div class="card-body">
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-g-convactions">${Sl(`Loading conversion actions…`)}</div>
        </div>
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-c-events">${Sl(`Loading event types…`)}</div>
        </div>
      </div>`:``:e.crm?t?`
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <p class="intg-desc" style="margin:0 0 6px">${P(e.crm.syncDesc)}</p>
          <div id="intg-crm-status">${Sl(`Loading sync status…`)}</div>
          <label class="intg-ca-row" style="margin-top:10px">
            <input type="checkbox" id="intg-crm-qualified">
            <span class="intg-ca-name">${P(e.crm.qualifiedToggle)}</span>
          </label>
          <div class="intg-actions" style="justify-content:flex-start;margin-top:12px">
            <button type="button" class="intg-btn" id="${e.card.ids.sync}"><span class="material-symbols-outlined" aria-hidden="true">sync</span>Sync now</button>
          </div>
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-mb-businesses">${Sl(`Loading booking pages…`)}</div>
          <div class="intg-actions" style="justify-content:flex-start;margin-top:12px">
            <button type="button" class="intg-btn" id="${e.card.ids.sync}"><span class="material-symbols-outlined" aria-hidden="true">sync</span>Sync now</button>
          </div>
        </div>
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-cc-events">${Sl(`Loading event types…`)}</div>
        </div>
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-r-trackers">${Sl(`Loading tracking numbers…`)}</div>
          <div class="intg-actions" style="justify-content:flex-start;margin-top:12px">
            <button type="button" class="intg-btn" id="${e.card.ids.sync}"><span class="material-symbols-outlined" aria-hidden="true">sync</span>Sync now</button>
      ...
      </div>`:``}function Xl(){let e=Wc.ms_bookings?.editor;return e?.steps?.length?`
    <details class="intg-walkthrough" style="margin-top:8px">
      <summary>${P(e.title)}</summary>
      <div class="intg-walkthrough__body">
        <ol>${e.steps.map(e=>`<li>${P(e)}</li>`).join(``)}</ol>
      </div>
    </details>`:``}function Zl(){let e=L.conn?.app_consent===!0,t=L.conn?.external_account?.upn||``,n=(e,t,n)=>`
    <li class="intg-step${e}">
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <ol class="intg-steps">
            ${n(` intg-step--done`,r,`<strong>Connect Microsoft Bookings.</strong> Done${t?`, connected as ${P(t)}`:``}.`)}
            ...
            ${n(e?` intg-step--current`:``,`3`,`<strong>Point a magnet at a page.</strong> Under <a href="#/magnets">Magnets</a>, add the Book call-to-action and pick your Bookings page and service.${Xl()}`)}
          </ol>
        </div>
      </div>`}function Ql(e){if(!e)return``;try{return new Date(e).toLocaleDateString([],{month:`short`,day:`numeric`,year:`numeric`})}catch{return String(e).slice(0,10)}}function $l(e){if(!L.conn)return``;let t=L.conn.webhook||{},n=[];n.push([`Status`,L.status===`connected`?`Active`:L.conn.connect_status===`NEEDS_REAUTH`?`Needs reconnecting`:`Error`]),e.slug===`calendly`&&(n.push([`Booking sync`,t.state===`active`?`On`:`Off (paid Calendly plan required)`]),t.last_received_tz&&n.push([`Last booking received`,Ql(t.last_received_tz)])),e.slug===`calcom`&&(n.push([`Booking sync`,t.state===`active`?`On`:`Needs attention`]),t.last_received_tz&&n.push([`Last booking received`,Ql(t.last_received_tz)])),e.slug===`ms_bookings`&&(n.push([`Booking sync`,`Every few minutes (polled)`]),t.last_swept_tz&&n.push([`Last sweep`,Ql(t.last_swept_tz)])),e.slug===`callrail`&&(n.push([`Call sync`,t.state===`active`?`On`:`Needs attention`]),t.cookie_capture&&n.push([`Session capture`,t.cookie_capture===`active`?`On`:`Needs attention`]),t.last_received_tz&&n.push([`Last call received`,Ql(t.last_received_tz)])),L.conn.created?.created_tz&&n.push([`Connected on`,Ql(L.conn.created.created_tz)]);let r=e.slug===`calendly`&&L.status===`connected`&&t.state!==`active`?Sl(`Booking sync is off: webhooks need a paid Calendly plan. Visitors can still book in the magnet; bookings just will not appear on the lead automatically. Reconnect after upgrading to turn it on.`,`error`):e.slug===`calcom`&&L.status===`connected`&&t.state!==`active`?Sl(`Booking sync could not be set up in Cal.com. Visitors can still book; bookings just will not appear on the lead automatically. Reconnect to retry the setup.`,`error`):e.slug===`callrail`&&L.status===`connected`&&t.state!==`active`?Sl(`Automatic call sync could not be set up in CallRail. Calls still arrive via the daily sweep and Sync now. Reconnect to retry the setup.`,`error`):``;return`
    <div class="dashboard-card intg-card">
      <div class="card-body">
        ...
        <dl class="intg-kv">
          ${n.map(([e,t])=>`<dt>${P(e)}</dt><dd>${P(t)}</dd>`).join(``)}
        </dl>
        ${r}
      </div>
    </div>`}function eu(e){return L.status!==`connected`&&L.status!==`broken`||!bl()?``:`
    <div class="dashboard-card intg-card settings-danger">
      <div class="card-body">
        <div class="settings-danger__action">
          <div>
            <div class="settings-item__title">Disconnect ${P(e.label)}</div>
            <div class="settings-item__desc">${P(e.disconnect.confirm)}</div>
          </div>
          <button type="button" class="settings-danger__btn" id="${e.card.ids.disconnect}">Disconnect</button>
        </div>
      </div>
    </div>`}function tu(){let e=L.provider;if(!e)return;let t=Wl;e.connect&&document.getElementById(e.card.ids.connect)?.addEventListener(`click`,()=>rl(e)),e.slug===`calcom`&&(document.getElementById(e.card.ids.connect)?.addEventListener(`click`,()=>ul({refresh:t})),L.status===`connected`&&bl()&&au()),e.slug===`gohighlevel`&&document.getElementById(e.card.ids.connect)?.addEventListener(`click`,()=>ll({refresh:t})),e.slug===`ms_bookings`&&L.status===`connected`&&bl()&&(document.getElementById(`intg-msb-consent`)?.addEventListener(`click`,async()=>{try{let e=await(await b(`${I()}/m5t/v5/integrations/ms_bookings/adminconsent`)).json();if(e.ok&&e.data?.url){window.location.href=e.data.url;return}throw Error()}catch{F(`Could not start Microsoft approval`,`danger`)}}),iu(),document.getElementById(e.card.ids.sync)?.addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0;try{let e=await(await b(`${I()}/m5t/v5/integrations/ms_bookings/sync/run`,{method:`POST`})).json();if(!e.ok)throw Error(e.error||`sync failed`);let t=e.data||{};F(t.errors?`Sync finished with ${t.errors} error${t.errors===1?``:`s`}.`:`Sync done. ${t.booked||0} booking${(t.booked||0)===1?``:`s`} recorded.`,t.errors?`warning`:`success`)}catch(e){F(e.message||`Sync failed.`,`error`)}finally{t.disabled=!1}})),e.slug===`callrail`&&(document.getElementById(e.card.ids.connect)?.addEventListener(`click`,()=>dl({refresh:t})),document.getElementById(`intg-r-replace`)?.addEventListener(`click`,()=>dl({refresh:t,replaceKey:!0})),document.getElementById(e.card.ids.sync)?.addEventListener(`click`,()=>hl({refresh:t})),L.status===`connected`&&bl()&&su()),e.picker&&(document.getElementById(e.card.ids.choose)?.addEventListener(`click`,()=>ol(e,{refresh:t})),document.getElementById(e.card.ids.sync)?.addEventListener(`click`,()=>il(e,{refresh:t}))),e.slug===`google_ads`&&L.status===`connected`&&bl()&&nu(),e.slug===`calendly`&&L.status===`connected`&&bl()&&ou(),e.crm&&L.status===`connected`&&bl()&&ru(e),document.getElementById(e.card.ids.disconnect)?.addEventListener(`click`,()=>al(e,{refresh:t}))}async function nu(){let e=document.getElementById(`intg-g-convactions`);if(e)try{let t=await(await b(`${I()}/m5t/v5/integrations/google_ads/conversion_actions`)).json();if(!t.ok)throw Error(t.error||`load failed`);let n=t.data.actions||[],r=new Set(t.data.selected||[]);if(!n.length){e.innerHTML=Sl(`No enabled conversion actions in the linked accounts.`);return}e.innerHTML=`
      <div class="intg-ca-list">
        ${n.map(e=>`
          <label class="intg-ca-row">
            <input type="checkbox" value="${P(e.id)}" ${r.has(e.id)?`checked`:``}>
            <span class="intg-ca-name">${P(e.name||e.id)}</span>
            ${e.category?`<span class="intg-ca-cat">${P(String(e.category).toLowerCase().replace(/_/g,` `))}</span>`:``}
          </label>`).join(``)}
      </div>
      <div class="intg-actions" style="justify-content:flex-start;margin-top:12px">
      ...
      </div>`,O(e.querySelector(`.intg-ca-list`),{rowSelector:`.intg-ca-row`,noun:`actions`}),document.getElementById(`intg-g-ca-save`)?.addEventListener(`click`,async()=>{let t=document.getElementById(`intg-g-ca-save`),n=[...e.querySelectorAll(`input[type="checkbox"]:checked`)].map(e=>e.value);t.disabled=!0;try{let e=await(await b(`${I()}/m5t/v5/integrations/google_ads/conversion_actions`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({conversion_action_ids:n})})).json();if(!e.ok)throw Error(e.error||`save failed`);F(n.length?`Counting ${n.length} conversion action${n.length===1?``:`s`} in reporting.`:`Conversion counting turned off.`,`success`)}catch(e){F(e.message||`Could not save the selection.`,`error`)}finally{t.disabled=!1}})}catch{e.innerHTML=Sl(`Could not load conversion actions. If this keeps happening, reconnect.`,`error`)}}async function ru(e){let t=document.getElementById(`intg-crm-status`),n=document.getElementById(`intg-crm-qualified`),r=document.getElementById(e.card.ids.sync),i=async()=>{if(t)try{let r=await(await b(`${I()}/m5t/v5/integrations/${e.slug}/status`)).json();if(!r.ok)throw Error(r.error||`load failed`);let i=r.data.counts||[],a=(e,t)=>i.find(n=>n.kind===e&&n.status===t)?.n||0,o=(e,t)=>{let n=[`${a(t,`SENT`)} synced`];return a(t,`QUEUE`)&&n.push(`${a(t,`QUEUE`)} queued`),a(t,`FAILED`)&&n.push(`${a(t,`FAILED`)} failed`),`
          <div class="intg-ev">
            <span class="intg-ev__name">${P(e)}</span>
            <span class="intg-ev__meta">${P(n.join(` · `))}</span>
          </div>`};t.innerHTML=o(e.crm.countLabels.contact,`contact`)+(r.data.qualified_sync?o(e.crm.countLabels.qualified,`qualified`):``),n&&(n.checked=!!r.data.qualified_sync)}catch{t.innerHTML=Sl(`Could not load sync status. If this keeps happening, reconnect.`,`error`)}};n?.addEventListener(`change`,async()=>{if(!n.checked&&!window.confirm(`Qualified leads will stop updating their status in ${e.label}. Turn this off?`)){n.checked=!0;return}n.disabled=!0;try{let t=await(await b(`${I()}/m5t/v5/integrations/${e.slug}/config`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({qualified_sync:n.checked})})).json();if(!t.ok)throw Error(t.error||`save failed`);F(n.checked?`Qualified leads now sync their status.`:`Qualified-lead sync turned off.`,`success`),i()}catch(e){n.checked=!n.checked,F(e.message||`Could not save the setting.`,`error`)}finally{n.disabled=!1}}),r?.addEventListener(`click`,async()=>{r.disabled=!0;try{let t=await(await b(`${I()}/m5t/v5/integrations/${e.slug}/sync/run`,{method:`POST`})).json();if(!t.ok)throw Error(t.error||`sync failed`);let n=t.data||{};F(n.failed?`Sync finished with ${n.failed} error${n.failed===1?``:`s`}.`:`Sync done. ${n.sent||0} lead${(n.sent||0)===1?``:`s`} pushed.`,n.failed?`warning`:`success`),i()}catch(e){F(e.message||`Sync failed.`,`error`)}finally{r.disabled=!1}}),i()}async function iu(e=``){let t=document.getElementById(`intg-mb-businesses`);if(t)try{let n=await(await b(`${I()}/m5t/v5/integrations/ms_bookings/businesses${e?`?q=${encodeURIComponent(e)}`:``}`)).json();if(!n.ok)throw Error(n.error||`load failed`);let r=n.data.businesses||[];t.innerHTML=r.length?r.map(e=>`
          <div class="intg-ev">
            <span class="intg-ev__name">${P(e.name)}</span>
            <span class="intg-ev__meta">${P(e.public_url||``)}</span>
          </div>`).join(``):Sl(`No shared Bookings pages found for this Microsoft account. Note: a Personal booking page ("Bookings with me") cannot connect anywhere, Microsoft has no API for it. Shared booking pages appear when the connected account is on their Staff list. Try the search below with the page’s exact name.`)+`<div class="intg-msb-search" style="display:flex;gap:8px;margin-top:10px"><input class="mag-modal__input" id="intg-msb-q" type="text" placeholder="Shared page name, e.g. Nicholas Krause"><button class="btn btn-secondary" type="button" id="intg-msb-search">Search</button></div>`,O(t,{rowSelector:`.intg-ev`,noun:`pages`}),document.getElementById(`intg-msb-search`)?.addEventListener(`click`,()=>{let e=document.getElementById(`intg-msb-q`)?.value.trim();e&&iu(e)})}catch{t.innerHTML=Sl(`Could not load booking pages. If this keeps happening, reconnect.`,`error`)}}async function au(){let e=document.getElementById(`intg-cc-events`);if(e)try{let t=await(await b(`${I()}/m5t/v5/integrations/calcom/event_types`)).json();if(!t.ok)throw Error(t.error||`load failed`);let n=t.data.event_types||[];e.innerHTML=n.length?n.map(e=>`
          <div class="intg-ev">
            <span class="intg-ev__name">${P(e.title)}</span>
            <span class="intg-ev__meta">${e.length?`${P(String(e.length))} min`:``}</span>
          </div>`).join(``):Sl(`No event types on this Cal.com account yet. Create one in Cal.com and it appears here.`),O(e,{rowSelector:`.intg-ev`,noun:`event types`})}catch{e.innerHTML=Sl(`Could not load event types. If this keeps happening, reconnect.`,`error`)}}async function ou(){let e=document.getElementById(`intg-c-events`);if(e)try{let t=await(await b(`${I()}/m5t/v5/integrations/calendly/event_types`)).json();if(!t.ok)throw Error(t.error||`load failed`);let n=t.data.event_types||[],r=t.data.scheduling_url?`<div class="intg-ev"><span class="intg-ev__name">Full scheduling page</span><span class="intg-ev__meta">${P(t.data.scheduling_url)}</span></div>`:``;e.innerHTML=n.length||r?`${r}${n.map(e=>`
          <div class="intg-ev">
            <span class="intg-ev__name">${P(e.name)}</span>
            <span class="intg-ev__meta">${e.duration?`${P(String(e.duration))} min`:``}</span>
          </div>`).join(``)}`:Sl(`No active event types on this Calendly account.`),O(e,{rowSelector:`.intg-ev`,noun:`event types`})}catch{e.innerHTML=Sl(`Could not load event types. If this keeps happening, reconnect.`,`error`)}}async function su(){let e=document.getElementById(`intg-r-trackers`);if(e)try{let t=await(await b(`${I()}/m5t/v5/integrations/callrail/trackers`)).json();if(!t.ok)throw Error(t.error||`load failed`);let n=t.data.trackers||[];e.innerHTML=n.length?n.map(e=>`
          <div class="intg-ev">
            <span class="intg-ev__name">${P(e.name)}</span>
            <span class="intg-ev__meta">${P(e.number)}${e.type===`session`?` · number pool`:``}</span>
          </div>`).join(``):Sl(`No active tracking numbers in this company yet. Create one in CallRail and it appears here.`),O(e,{rowSelector:`.intg-ev`,noun:`numbers`})}catch{e.innerHTML=Sl(`Could not load tracking numbers.`,`error`)}}var L,cu,lu=o((()=>{Ol(),Qa(),An(),x(),L={provider:null,conn:null,configured:!1,status:`idle`},cu={render:Hl,init:Ul}})),uu=c({default:()=>Nu,init:()=>pu,render:()=>fu});function du(){if(ku)return;let e=document.createElement(`style`);e.id=`m5t-security-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),ku=!0}function fu(){return du(),`
    <div class="page-shell" data-section="settings-security">
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Signing in as ${Tu(xu())}. You stay signed in on this device after a change.</p>
            </div>
          </div>
          <div class="settings-grid-2">
            <div class="settings-field">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="pk-body">${Au(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function pu(){document.getElementById(`pw-save`)?.addEventListener(`click`,Su);let e=document.getElementById(`pk-add-btn`);e&&window.PublicKeyCredential&&(e.style.display=``,e.addEventListener(`click`,yu)),await mu()}async function mu(){let e=document.getElementById(`pk-body`);if(e){try{let e=await b(`${Du()}/m5t/v5/webauthn`),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(t.error||`Failed to load`);Ou.passkeys=t.passkeys||[],Ou.loaded=!0}catch(t){console.warn(`[settings-security] load failed:`,t),e.innerHTML=Au(`error`,`Could not load your passkeys. Please try again.`);return}_u()}}function hu(e){if(!e)return null;try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return null}}function gu(e){let t=hu(e.last_used_time),n=e.created?.created_tz,r=hu(n),i=[e.device_type===`multiDevice`?`Syncs across devices`:`This device only`,t?`Last used ${t}`:`Never used to sign in yet`,r?`Added ${r}`:null].filter(Boolean).join(` · `);return`
    <div class="pk-row" data-guid="${Tu(e.guid)}">
      <span class="pk-icon"><span class="material-symbols-outlined" aria-hidden="true">passkey</span></span>
      <div class="pk-info">
        <div class="pk-name">${Tu(e.device_label||`Passkey`)}</div>
        <div class="pk-meta">${Tu(i)}</div>
      </div>
      <button class="pk-btn pk-btn--danger" type="button" data-remove="${Tu(e.guid)}">
        <span class="material-symbols-outlined" aria-hidden="true">delete</span> Remove
      </button>
    </div>`}function _u(){let e=document.getElementById(`pk-body`);if(e){if(!window.PublicKeyCredential){e.innerHTML=`<p class="pk-unsupported">This browser doesn't support passkeys. Your password sign-in still works as usual.</p>`;return}if(!Ou.passkeys.length){e.innerHTML=Au(`passkey`,`No passkeys yet. Add one for a faster, phishing-resistant sign-in.`);return}e.innerHTML=Ou.passkeys.map(gu).join(``),O(e,{rowSelector:`.pk-row`,noun:`passkeys`}),e.querySelectorAll(`[data-remove]`).forEach(e=>{e.addEventListener(`click`,()=>bu(e.dataset.remove,e))})}}function vu(){try{let e=navigator.userAgent||``,t=/iPhone/.test(e)?`iPhone`:/iPad/.test(e)?`iPad`:/Android/.test(e)?`Android`:/Mac OS X/.test(e)?`Mac`:/Windows/.test(e)?`Windows`:/Linux/.test(e)?`Linux`:`device`,n=/Edg\//.test(e)?`Edge`:/Chrome\//.test(e)?`Chrome`:/Firefox\//.test(e)?`Firefox`:/Safari\//.test(e)?`Safari`:``;return n?`${n} on ${t}`:t}catch{return`Passkey`}}async function yu(){let e=document.getElementById(`pk-add-btn`);e&&(e.disabled=!0);try{let{startRegistration:e}=await C(async()=>{let{startRegistration:e}=await Promise.resolve().then(()=>(an(),rn));return{startRegistration:e}},void 0,import.meta.url),t=await b(`${Du()}/m5t/v5/webauthn/register/options`,{method:`POST`}),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.error||`Could not start passkey registration`);let r;try{r=await e({optionsJSON:n.options})}catch(e){if(e?.name===`NotAllowedError`)return;throw e}let i=await b(`${Du()}/m5t/v5/webauthn/register/verify`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({response:r,deviceLabel:vu()})}),a=await i.json().catch(()=>({}));if(!i.ok||!a.ok)throw Error(a.error||`Could not register this passkey`);Eu(`Passkey added`,`success`),await mu()}catch(e){console.warn(`[settings-security] addPasskey failed:`,e),Eu(e.message||`Could not add a passkey`,`danger`)}finally{e&&(e.disabled=!1)}}async function bu(e,t){if(await Bc({title:`Remove this passkey?`,message:`You can always add it back later.`,confirmLabel:`Remove`,danger:!0})){t&&(t.disabled=!0);try{let t=await b(`${Du()}/m5t/v5/webauthn/${encodeURIComponent(e)}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.error||`Could not remove this passkey`);Ou.passkeys=Ou.passkeys.filter(t=>t.guid!==e),Eu(`Passkey removed`,`success`),_u()}catch(e){console.warn(`[settings-security] removePasskey failed:`,e),Eu(e.message||`Could not remove this passkey`,`danger`),t&&(t.disabled=!1)}}}function xu(){try{return w.getScope()?.entity?.email||w.getEntity?.()?.email||`your account`}catch{return`your account`}}async function Su(){let e=document.getElementById(`pw-new`),t=document.getElementById(`pw-confirm`),n=document.getElementById(`pw-save`),r=e?.value||``,i=t?.value||``,a=ra(r);if(a.length){ju(`Password needs: ${Mu(a)}.`);return}if(r!==i){ju(`Passwords do not match.`);return}ju(``),n&&(n.disabled=!0);try{let n=await b(`${Du()}/m5t/v5/acctEntity/resetHash`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({password:r})}),i=await n.json().catch(()=>({}));if(!n.ok||!i.ok)throw Error(i.error||`Could not update your password`);Eu(`Password updated`,`success`),e&&(e.value=``),t&&(t.value=``)}catch(e){ju(e.message||`Could not update your password.`)}finally{n&&(n.disabled=!1)}}var Cu,wu,Tu,Eu,Du,Ou,ku,Au,ju,Mu,Nu,Pu=o((()=>{T(),Cu=u(f(),1),m(),Uc(),aa(),An(),x(),St(),wu={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Tu=e=>String(e??``).replace(/[&<>"']/g,e=>wu[e]),Eu=(e,t=`info`)=>{try{Cu.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Du=()=>w.getConfig?.().BASE_URL||``,Ou={passkeys:[],loaded:!1},ku=!1,Au=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,ju=e=>{let t=document.getElementById(`pw-error`);t&&(t.textContent=e||``,t.hidden=!e)},Mu=e=>e.length<=1?String(e[0]??``):e.length===2?`${e[0]} and ${e[1]}`:`${e.slice(0,-1).join(`, `)}, and ${e[e.length-1]}`,Nu={render:fu,init:pu}})),Fu=c({default:()=>id,init:()=>Uu,render:()=>Hu});function Iu(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(` `).trim()||e.email)||null}function Lu(e){return(e.split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``)||`?`).toUpperCase()}function Ru(e){try{return new Date(e).toLocaleString([],{month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`})}catch{return``}}function zu(e){try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return``}}function Bu(e){return e==null?`—`:e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,`0`)}s`}function Vu(){if(td)return;let e=document.createElement(`style`);e.id=`m5t-convs-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),td=!0}function Hu(){return Vu(),La(),`
    <div class="page-shell" data-section="conversations">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="convs-body">
          ${nd(`hourglass_empty`,`Loading journeys…`)}
        </div>
      </div>
    </div>`}async function Uu(){await Wu()}async function Wu(){let e=document.getElementById(`convs-body`);if(e){try{let[e,t]=await Promise.all([b(`${Zu()}/m5t/v5/conversations`),b(`${Zu()}/m5t/v5/magnets`).catch(()=>null)]),n=await e.json().catch(()=>({}));if(j(e,n),!n.ok)throw Error(n.message||`Failed to load`);if(R.conversations=n.conversations||[],R.counts=n.counts||{},R.book=A(),t){let e=await t.json().catch(()=>({}));R.magnetNames={},R.magnetOwnerNames={};let n=R.book?Ga():{};(e.magnets||[]).forEach(e=>{R.magnetNames[e.guid]=e.name,R.book&&(R.magnetOwnerNames[e.guid]=e.owner_name||n[e.owner_guid]||``)})}}catch(t){console.warn(`[conversations] load failed:`,t),e.innerHTML=$a(t)?eo():nd(`error`,`Could not load journeys. Please try again.`);return}qu()}}function Gu(){return R.filter===`ALL`?R.conversations:R.conversations.filter(e=>e.status===R.filter)}function Ku(e){let t=Iu(e.lead),n=R.magnetNames[e.magnet_guid]||`—`,r=$u[e.status]||$u.ABANDONED,i=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,a=(e.routes||[]).map(e=>ed[e]||e).join(`, `);return`
    <tr class="convs-row" data-session="${Xu(e.session)}">
      <td>
        <span class="convs-who">
          <span class="convs-ava${t?``:` anon`}">${t?Xu(Lu(t)):`<span class="material-symbols-outlined" style="font-size:16px">person_off</span>`}</span>
          <span><span class="convs-name">${t?Xu(t):`<span class="convs-muted">Anonymous visitor</span>`}</span>
            ${e.lead?.email?`<div class="convs-sub">${Xu(e.lead.email)}</div>`:a?`<div class="convs-sub">Picked: ${Xu(a)}</div>`:``}</span>
        </span>
      </td>
      ${R.book?`<td>${Za(R.magnetOwnerNames[e.magnet_guid]||``)||`<span class="convs-muted">—</span>`}</td>`:``}
      <td><span class="convs-sub">${Xu(n)}</span></td>
      <td><span class="convs-badge" data-s="${Xu(e.status)}"><span class="material-symbols-outlined" aria-hidden="true">${r.icon}</span>${r.label}</span></td>
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${Xu(Ru(e.started_at))}">${Xu(zu(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${Xu(Bu(e.duration_s))}</td>
    </tr>`}function qu(){let e=document.getElementById(`convs-body`);if(!e)return;if(!R.conversations.length){e.innerHTML=nd(`route`,`No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.`);return}let t=Gu();e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${[[`ALL`,`All`],[`COMPLETED`,`Completed`],[`IN_PROGRESS`,`In progress`],[`ABANDONED`,`Abandoned`]].map(([e,t])=>`<button data-filter="${e}" class="${R.filter===e?`active`:``}">${t}${e!==`ALL`&&R.counts[e]?` (${Qu(R.counts[e])})`:``}</button>`).join(``)}
      </div>
      <span class="convs-count">${Qu(t.length)} of ${Qu(R.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(Ku).join(``)||`<tr><td colspan="${R.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${R.filter.toLowerCase().replace(`_`,` `)} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`;let n=e.querySelector(`#convs-tbody`);n&&O(n,{rowSelector:`tr.convs-row`,noun:`journeys`,controlHost:e.querySelector(`.convs-tablewrap`)||n.parentElement}),e.querySelector(`.convs-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(R.filter=t.dataset.filter,qu())}),e.querySelector(`#convs-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`.convs-row`);t&&Ju(t.dataset.session)})}async function Ju(e){let t=R.conversations.find(t=>t.session===e);if(!t)return;let n=null;try{n=await(await b(`${Zu()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),n?.ok||(n=null)}catch{n=null}let r=Iu(t.lead),i=R.magnetNames[t.magnet_guid]||`—`,a=(n?.events||[]).filter((e,t,n)=>e.event!==`step`||!(n[t+1]&&n[t+1].event===`step`)).map(e=>`
    <div class="convs-tl__item${e.event===`complete`?` done`:``}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${Xu((rd[e.event]||(()=>e.event))(e.detail))}</div>
      <div class="convs-tl__time">${Xu(Ru(e.at))}${e.variant?` · Variant ${Xu(e.variant)}`:``}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      <div class="convs-drawer__head">
        <span class="convs-drawer__title">${r?Xu(r):`Anonymous visitor`}</span>
      ...
      <div class="convs-drawer__body">
        ${r?`<a class="convs-drawer__lead" href="#/leads">
              <span class="convs-ava">${Xu(Lu(r))}</span>
              <span><div class="convs-name">${Xu(r)}</div><div class="convs-sub">${Xu(t.lead?.email||t.lead?.phone||``)}</div></span>
        ...
        <div class="convs-sub" style="margin-bottom:6px">${Xu(i)} · ${Xu(Bu(t.duration_s))}${t.variant?` · Variant ${Xu(t.variant)}`:``}</div>
        ${a?`<div class="convs-tl">${a}</div>`:nd(`timeline`,`No timeline available for this journey.`)}
      </div>
    </aside>`,document.body.appendChild(o),requestAnimationFrame(()=>{o.classList.add(`open`),o.querySelector(`.convs-drawer`).classList.add(`open`)});let s=()=>{o.classList.remove(`open`),setTimeout(()=>o.remove(),220)};o.querySelector(`.convs-drawer__close`).addEventListener(`click`,s),o.addEventListener(`click`,e=>{e.target===o&&s()})}var Yu,Xu,Zu,Qu,R,$u,ed,td,nd,rd,id,ad=o((()=>{T(),Qa(),An(),x(),no(),Yu={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Xu=e=>String(e??``).replace(/[&<>"']/g,e=>Yu[e]),Zu=()=>w.getConfig?.().BASE_URL||``,Qu=e=>Number(e||0).toLocaleString(),R={conversations:[],counts:{},magnetNames:{},filter:`ALL`,book:!1,magnetOwnerNames:{}},$u={COMPLETED:{label:`Completed`,icon:`check_circle`},IN_PROGRESS:{label:`In progress`,icon:`pending`},ABANDONED:{label:`Abandoned`,icon:`highlight_off`}},ed={book:`Book`,chat:`Chat`,call:`Call`,email:`Email`,support:`Support`},td=!1,nd=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,rd={open:()=>`Opened the magnet`,engage:e=>`First interaction${e?`: ${ed[e]||e}`:``}`,route:e=>`Picked ${ed[e]||e||`a channel`}`,step:e=>`Reached step ${e||``}`,complete:()=>`Completed: lead captured`},id={render:Hu,init:Uu}})),od=c({default:()=>Ad,init:()=>ld,render:()=>cd});function sd(){if(Od)return;let e=document.createElement(`style`);e.id=`m5t-abt-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Od=!0}function cd(){return A()?Ha({section:`ab-testing`,title:`A/B Testing`,description:`Pick a client to view their experiments.`}):(sd(),`
    <div class="page-shell" data-section="ab-testing">
      ...
      <div id="abt-body">${kd(`hourglass_empty`,`Loading tests…`)}</div>
    </div>`)}async function ld(){if(A())return Wa(wd(),[{h:`Running`,td:e=>Td(e.ab_tests?.running)},{h:`Completed`,td:e=>Td(e.ab_tests?.completed)},{h:`Compl. %`,td:e=>e.completion_rate==null?`—`:`${e.completion_rate}%`}],{emptyMsg:`No client orgs yet. Experiments appear per client once you have one.`});let e=document.getElementById(`abt-body`);try{let e=new Date,t=new Date(e.getTime()-76896e5).toISOString().slice(0,10),n=e.toISOString().slice(0,10),[r,i]=await Promise.all([b(`${wd()}/m5t/v5/magnets`),b(`${wd()}/m5t/v5/magnets/stats?from=${t}&to=${n}`)]),a=await r.json().catch(()=>({}));if(j(r,a),!a.ok)throw Error(a.message||`Failed to load`);Ed.magnets=a.magnets||[],Ed.canManage=!!a.canManage;let o=await i.json().catch(()=>({}));Ed.stats=o?.stats||{}}catch(t){console.warn(`[ab-testing] load failed:`,t),e&&(e.innerHTML=$a(t)?eo():kd(`error`,`Could not load your tests. Please try again.`));return}ud()}function ud(){let e=document.getElementById(`abt-body`);if(!e)return;let t=Ed.magnets.filter(e=>e.ab?.enabled),n=Ed.magnets.filter(e=>!e.ab?.enabled&&e.ab?.declared);if(!t.length&&!n.length){e.innerHTML=kd(`science`,`No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.`);return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(hd).join(``)}`:``)+(n.length?`<div class="abt-sect">Completed Tests</div>${n.map(gd).join(``)}`:``),O(e,{rowSelector:`.abt-card`,noun:`tests`}),e.querySelectorAll(`[data-declare]`).forEach(e=>e.addEventListener(`click`,()=>_d(e.dataset.declare,e.dataset.winner)))}function dd(e){let t=Ed.stats[e.guid]?.variants||{};return{A:{opens:0,engaged:0,completions:0,rate:null,...t.A||{}},B:{opens:0,engaged:0,completions:0,rate:null,...t.B||{}}}}function fd(e){let t=Object.keys(e?.b||{}).map(e=>Dd[e]||e);return t.length?`Changes: ${t.join(`, `)}`:``}function pd(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function md(e,t,n,r,i,a){return`
    <div class="abt-variant${i?` leader`:``}">
      <div class="abt-vhead"><span class="abt-vname">${Sd(e)}</span><span class="abt-vtag${i?` win`:``}">${Sd(t)}</span></div>
      ${n?`<div class="abt-vdesc">${Sd(n)}</div>`:``}
      <div class="abt-mrow"><span class="k">Visitors</span><span class="v">${Td(r.opens)}</span></div>
      <div class="abt-mrow"><span class="k">Completions</span><span class="v">${Td(r.completions)}</span></div>
    ...
    </div>`}function hd(e){let t=e.ab,{A:n,B:r}=dd(e),i=(r.rate??-1)>(n.rate??-1)?`B`:(n.rate??-1)>(r.rate??-1)?`A`:null,a=i&&n.rate!=null&&r.rate!=null?`+${Math.round(Math.abs(r.rate-n.rate)*10)/10}%`:``,o=vd(n,r),s=t.started_tz?pd(t.started_tz):null,c=(n.opens||0)+(r.opens||0),l=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
        <h2 class="abt-name">${Sd(e.name)}</h2>
        <span class="abt-status running"><span class="pulse-dot"></span>Running</span>
        <div class="abt-actions">
          ${Ed.canManage&&i?`<button class="btn btn-primary" type="button" data-declare="${Sd(e.guid)}" data-winner="${i}"><span class="material-symbols-outlined" aria-hidden="true">emoji_events</span>Declare Winner</button>`:``}
        </div>
      </div>
      <div class="abt-meta">
        ${s==null?``:`<span><span class="material-symbols-outlined" aria-hidden="true">schedule</span>Started ${s===0?`today`:`${s} day${s===1?``:`s`} ago`}</span>`}
        <span><span class="material-symbols-outlined" aria-hidden="true">visibility</span>${Td(c)} total visitors</span>
      ...
      <div class="abt-compare">
        ${md(`Variant A`,`Control`,`The magnet as configured`,n,i===`A`,i===`A`?a:``)}
        <div class="abt-vs">VS</div>
        ${md(`Variant B`,i===`B`?`Leading`:`Challenger`,fd(t),r,i===`B`,i===`B`?a:``)}
      </div>
      <div class="abt-sig">
    ...
    <div class="abt-card">
      ...
      <div class="abt-summary">
        <span><span class="k">Winner:</span><span class="v">Variant ${Sd(t.winner)}</span></span>
        ...
        <span><span class="k">Total Visitors:</span><span class="v">${Td(o)}</span></span>
      </div>
    </div>`}async function _d(e,t){let n=Ed.magnets.find(t=>t.guid===e);if(n&&window.confirm(`Declare Variant ${t} the winner for “${n.name}”?\n\n${t===`B`?`Variant B’s changes become the magnet’s configuration for everyone.`:`The magnet keeps its current configuration.`} The experiment ends and moves to Completed.`)){try{let n=await(await b(`${wd()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!n.ok)throw Error(n.message||`Declare failed`);Cd(`Variant ${t} declared the winner`,`success`)}catch(e){Cd(e.message||`Could not declare a winner`,`danger`);return}try{await ld()}catch(e){console.warn(`[ab-testing] refresh after declare failed:`,e)}}}function vd(e,t){let n=e.opens||0,r=t.opens||0,i=e.completions||0,a=t.completions||0;if(n<30||r<30||i+a<5)return null;let o=i/n,s=a/r,c=(i+a)/(n+r),l=Math.sqrt(c*(1-c)*(1/n+1/r));if(!l)return null;let u=Math.abs(s-o)/l;return Math.round(2*(yd(u)-.5)*1e3)/10}function yd(e){let t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}var bd,xd,Sd,Cd,wd,Td,Ed,Dd,Od,kd,Ad,jd=o((()=>{T(),bd=u(f(),1),m(),Qa(),An(),x(),no(),xd={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Sd=e=>String(e??``).replace(/[&<>"']/g,e=>xd[e]),Cd=(e,t=`info`)=>{try{bd.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},wd=()=>w.getConfig?.().BASE_URL||``,Td=e=>Number(e||0).toLocaleString(),Ed={magnets:[],stats:{},canManage:!1},Dd={mag_title:`header title`,mag_subtitle:`subtitle`,mag_welcome:`welcome message`,mag_theme_color:`color`,mag_launcher_label:`launcher label`},Od=!1,kd=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Ad={render:cd,init:ld}}));function Md(e,t){let n={};return Object.keys(e&&typeof e==`object`?e:{}).forEach(r=>{t.includes(r)||(n[r]=e[r])}),Object.keys(n).length?n:null}function Nd(e){return Md(e,wf)}function Pd(e,t){let n=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||``).trim());return n?`rgba(${parseInt(n[1],16)},${parseInt(n[2],16)},${parseInt(n[3],16)},${t})`:`rgba(0,114,186,${t})`}function Fd(){if(Df)return;let e=document.createElement(`style`);e.id=`m5t-flow-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Df=!0}function Id(e=`single_select`){return{_uid:Rf(),id:``,step_type:e,step_prompts:[``],step_options:vf(e)?[{label:``,goto:``,icon:``},{label:``,goto:``,icon:``}]:[],step_columns:Sf(e)?[Sf(e)]:[],step_description:``,step_config:bf(e)?Cf():null}}function Ld(e){return(Array.isArray(e)?e:[]).map(e=>({_uid:Rf(),id:e.id==null?``:String(e.id),step_type:mf[e.step_type]?e.step_type:`single_select`,step_prompts:Array.isArray(e.step_prompts)?e.step_prompts.map(String):[],step_options:(Array.isArray(e.step_options)?e.step_options:[]).map(e=>({label:e&&e.label!=null?String(e.label):``,goto:e&&e.goto!=null?String(e.goto):``,icon:e&&e.icon!=null?String(e.icon):``})),step_columns:Array.isArray(e.step_columns)?e.step_columns.map(String):[],step_description:e.step_description==null?``:String(e.step_description),step_config:bf(e.step_type)?{...Cf(),...e.step_config&&typeof e.step_config==`object`?e.step_config:{}}:e.step_config&&typeof e.step_config==`object`?{...e.step_config}:null}))}function Rd(){return[{_uid:Rf(),id:``,step_type:`text`,step_prompts:[`Great, and your name?`],step_options:[],step_columns:[`first_name`],step_description:``,step_config:null},{_uid:Rf(),id:``,step_type:`email`,step_prompts:[`The best email to reach you?`],step_options:[],step_columns:[`email`],step_description:``,step_config:null}]}function zd(e,t){if(e===`book`)return[{_uid:Rf(),id:``,step_type:`scheduler`,step_prompts:[`When works best for you?`],step_options:[],step_columns:[],step_description:``,step_config:Cf()},...Rd()];if(e===`support`){let e=(t.actions||[]).find(e=>e&&e.type===`support`),n=e&&e.config&&Array.isArray(e.config.options)?e.config.options:[],r=n.length?n.map(e=>({label:e&&e.label||String(e),goto:``,icon:e&&e.icon||``})):[`Sales enquiry`,`Support`,`Billing`,`Something else`].map(e=>({label:e,goto:``,icon:``}));return[{_uid:Rf(),id:``,step_type:`multi_select`,step_prompts:[`How can we help you today?`],step_options:r,step_columns:[],step_description:`Select all that apply`,step_config:null},...Rd()]}return[Id(`single_select`)]}function Bd(e,t){let n=Ld(e===`chat`?t.steps:t.routes&&t.routes[e]);return n.length?n:e===`chat`?[Id(`single_select`)]:zd(e,t)}function Vd(e){vf(e.step_type)?e.step_options.length||(e.step_options=[{label:``,goto:``,icon:``},{label:``,goto:``,icon:``}]):e.step_options=[],yf(e.step_type)?!e.step_columns.length&&Sf(e.step_type)&&(e.step_columns=[Sf(e.step_type)]):e.step_columns=[],e.step_config=bf(e.step_type)?{...Cf(),...e.step_config||{}}:Nd(e.step_config)}function Hd(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${df(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${Ef.map(([t,n])=>`<option value="${df(t)}"${t===e.icon?` selected`:``}>${df(n)}</option>`).join(``)}</select>
  ...
  </div>`}function Ud(e){let t=hf.map(t=>`<option value="${t}"${t===e.step_type?` selected`:``}>${df(_f(t).label)}</option>`).join(``),n=e.step_options.length<=1;return`<div class="flow-node__body">
    ...
    <textarea class="mag-modal__input flow-f-prompts" rows="2" placeholder="${e.step_type===`message`?`Thanks! One moment…`:`What can we help you with?`}">${df(e.step_prompts.join(`
`))}</textarea>
    ...
    <input class="mag-modal__input flow-f-cta-label" type="text" value="${df(e.step_config?.cta?.label||``)}" placeholder="e.g. Visit our site">
    <label class="mag-modal__label">Link URL <span class="flow-sub flow-cta-req">optional</span></label>
    <input class="mag-modal__input flow-f-cta-url" type="url" value="${df(e.step_config?.cta?.url||``)}" placeholder="https://example.com">
    ...
    <select class="mag-modal__select flow-f-field">
      ...
      ${We.map(t=>`<option value="${df(t.value)}"${t.value===e.step_columns[0]?` selected`:``}>${df(t.label)}</option>`).join(``)}
    </select>
    ...
    <div class="flow-opts">${e.step_options.map(e=>Hd(e,n)).join(``)}</div>
    ...
    <input class="mag-modal__input flow-f-mtlabel" type="text" value="${df(e.step_config?.meeting_label||``)}" placeholder="e.g. 15 minute call">
    <div class="mag-modal__row" style="margin-top:8px">
      <div><label class="mag-modal__label">From</label><input class="mag-modal__input flow-f-start" type="time" value="${df(e.step_config?.start||`09:00`)}"></div>
      <div><label class="mag-modal__label">To</label><input class="mag-modal__input flow-f-end" type="time" value="${df(e.step_config?.end||`17:00`)}"></div>
  ...
  </div>`}function Wd(e){let t=e.step_prompts.find(e=>String(e).trim()!==``)||``,n=t?`<div class="flow-node__prompt">“${df(t)}”</div>`:`<div class="flow-node__prompt is-empty">${e.step_type===`message`?`No message yet`:`No question yet`}</div>`,r=``;if(vf(e.step_type)){let t=e.step_options.map(e=>String(e.label).trim()).filter(Boolean);t.length&&(r=`<div class="flow-node__chips">${t.slice(0,4).map(e=>`<span class="flow-node__chip">${df(e)}</span>`).join(``)}${t.length>4?`<span class="flow-node__chip">+${t.length-4}</span>`:``}</div>`)}else if(yf(e.step_type)&&e.step_columns[0]){let t=We.find(t=>t.value===e.step_columns[0])?.label||e.step_columns[0];r=`<div class="flow-node__meta">Saves to <b>${df(t)}</b></div>`}else if(xf(e.step_type)&&e.step_config?.terminal){let t=String(e.step_config?.cta?.label||``).trim();r=`<div class="flow-node__meta">Ends the conversation${t?` — link: <b>${df(t)}</b>`:``}</div>`}return`<div class="flow-node__preview">${n}${r}</div>`}function Gd(e,t,n){let r=_f(e.step_type),i=e._uid===Of,a=`--nc:${r.color};--nct:${Pd(r.color,.14)}`;return`<div class="flow-node${i?` flow-node--open`:``}" data-uid="${e._uid}" style="${a}"${i?``:` draggable="true"`}>
    <div class="flow-node__hd">
      ...
      <span class="flow-node__type">${df(r.label)}</span>
    ...
    ${i?Ud(e):Wd(e)}
  </div>`}function Kd(){let e=document.getElementById(`flow-nodes`);if(!e)return;let t=z.length,n=[`<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>`,zf];z.forEach((e,r)=>{n.push(Gd(e,r,t)),r<t-1&&n.push(zf)}),e.innerHTML=n.join(``)}function qd(){let e=document.querySelector(`.flow-node--open`);if(!e)return;let t=z.find(t=>t._uid===e.dataset.uid);if(!t)return;let n=e.querySelector(`.flow-f-type`);n&&(t.step_type=n.value);let r=e.querySelector(`.flow-f-prompts`);r&&(t.step_prompts=r.value.split(`
`));let i=e.querySelector(`.flow-f-field`);if(t.step_columns=i&&i.value.trim()?[i.value.trim()]:[],vf(t.step_type)){let n=t.step_options,r=[];e.querySelectorAll(`.flow-opt`).forEach((e,t)=>{r.push({label:e.querySelector(`.flow-o-label`)?.value??``,icon:e.querySelector(`.flow-o-icon`)?.value??``,goto:n[t]&&n[t].goto||``})}),t.step_options=r}else t.step_options=[];if(bf(t.step_type)){let n=e.querySelector(`.flow-f-mtlabel`),r=e.querySelector(`.flow-f-start`),i=e.querySelector(`.flow-f-end`),a=e.querySelector(`.flow-f-mins`);t.step_config={...t.step_config||Cf(),...n?{meeting_label:n.value.trim()}:{},...r&&r.value?{start:r.value}:{},...i&&i.value?{end:i.value}:{},...a?{mins:parseInt(a.value,10)||30}:{}}}else if(xf(t.step_type)){let n=e.querySelector(`.flow-f-terminal`);if(n){let r=e.querySelector(`.flow-f-cta-label`),i=e.querySelector(`.flow-f-cta-url`),a=Md(t.step_config,Tf)||{};t.step_config=n.checked?{...a,terminal:!0,cta:{label:r?r.value:``,url:i?i.value:``}}:Md(t.step_config,Tf)}}else t.step_config=Nd(t.step_config)}function Jd(){document.querySelectorAll(`.flow-node.drop-before, .flow-node.drop-after`).forEach(e=>e.classList.remove(`drop-before`,`drop-after`))}function Yd(){Jd(),document.querySelectorAll(`.flow-node.dragging`).forEach(e=>e.classList.remove(`dragging`)),Af=null,jf=null}function Xd(e=z){if(!e.length)return{message:`Add at least one step.`,uid:null,field:null};for(let t=0;t<e.length;t++){let n=e[t],r=t+1,i=(e,t=null)=>({message:e,uid:n._uid,field:t});if(!n.step_prompts.some(e=>String(e).trim()!==``))return i(`Step ${r}: add what the magnet should say.`,`prompts`);if(vf(n.step_type)&&!n.step_options.some(e=>String(e.label).trim()!==``))return i(`Step ${r}: add at least one choice.`,`options`);if(yf(n.step_type)&&!n.step_columns.length)return i(`Step ${r}: choose which field this answer saves to.`,`field`);if(xf(n.step_type)&&n.step_config?.terminal){let e=String(n.step_config.cta?.label||``).trim(),t=String(n.step_config.cta?.url||``).trim();if(!!e!=!!t)return i(`Step ${r}: fill in both the link label and URL, or leave both blank.`,`cta`)}}return null}function Zd(e){if(!e)return;let t=e.querySelector(`.flow-f-cta-label`),n=e.querySelector(`.flow-f-cta-url`);if(!t||!n)return;let r=t.value.trim()!==``,i=n.value.trim()!==``,a=r||i,o=r!==i;e.querySelectorAll(`.flow-cta-req`).forEach(e=>{e.textContent=a?`required`:`optional`,e.classList.toggle(`flow-sub--req`,a)}),t.classList.toggle(`flow-f-invalid`,o&&!r),n.classList.toggle(`flow-f-invalid`,o&&!i);let s=e.querySelector(`.flow-cta-warn`);s&&(s.hidden=!o)}function Qd(e=z){let t=0;return e.forEach(e=>{let n=parseInt(e.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(e=>{let n=e.id&&String(e.id).trim()?String(e.id):String(++t),r=vf(e.step_type)?e.step_options.map(e=>{let t={label:String(e.label).trim(),goto:String(e.goto||``)};return e.icon&&(t.icon=String(e.icon)),t}).filter(e=>e.label!==``):[],i={id:n,step_type:e.step_type,step_prompts:e.step_prompts.map(e=>String(e)).filter(e=>e.trim()!==``),step_options:r,step_columns:e.step_columns.slice(),step_description:e.step_description||``};if(bf(e.step_type))e.step_config&&(i.step_config={...Cf(),...e.step_config});else if(e.step_config&&Object.keys(e.step_config).length){let t={...e.step_config};if(xf(e.step_type)&&t.terminal){let e=String(t.cta?.label??``).trim(),n=String(t.cta?.url??``).trim();e&&n?t.cta={label:e,url:n}:delete t.cta}i.step_config=t}return i})}function $d(e,t,n){Fd(),Ff=t,If=typeof n==`function`?n:null,Lf=t?.modified_tz||``,Pf=[`chat`,...[`book`,`support`].filter(e=>(t.actions||[]).some(t=>t&&t.type===e))],Nf={chat:Bd(`chat`,t)},Mf=`chat`,z=Nf.chat,Of=z.length===1?z[0]._uid:null,Af=null,jf=null,e.innerHTML=`
    ...
    ${Pf.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${Pf.map(e=>`<option value="${e}">${df(gf[e]||e)}</option>`).join(``)}</select></div>`:``}
...
<body>
  ...
  <\/script>
  <script>${n}<\/script>
</body></html>`}function Gf(){if(Xf)return;let e=document.createElement(`style`);e.id=`m5t-preview-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Xf=!0}function Kf(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function qf(e){let t=e.querySelector(`[data-pv-info]`),n=e.querySelector(`[data-pv-info-pop]`);t&&n&&t.addEventListener(`click`,()=>{n.hidden=!n.hidden})}function Jf(e,t){Gf(),e.innerHTML=`
    <div class="pv-pane">
      ...
      ${Kf(`Live render of the real widget. Capture is disabled, so no test leads.`)}
    </div>`,qf(e);let n=e.querySelector(`.pv-pane__frame`),r=e.querySelector(`.pv-pane__badge`),i=null,a=0;n.addEventListener(`load`,()=>{let e=(typeof performance<`u`?performance.now():Date.now())-a;clearTimeout(i),e<450?i=setTimeout(()=>{r.hidden=!0},450-e):r.hidden=!0});let o=()=>{let e;try{e=Wf(t())}catch{return}a=typeof performance<`u`?performance.now():Date.now(),r.hidden=!1,n.srcdoc=e,clearTimeout(i),i=setTimeout(()=>{r.hidden=!0},1500)};return e.querySelector(`.pv-pane__seg`).addEventListener(`click`,t=>{let r=t.target.closest(`button[data-device]`);!r||r.dataset.device===n.dataset.device||(e.querySelectorAll(`.pv-pane__seg button`).forEach(e=>e.classList.toggle(`is-on`,e===r)),n.dataset.device=r.dataset.device)}),o(),{refresh:o,destroy(){clearTimeout(i)}}}function Yf(e){Gf();let t=`desktop`,n=document.createElement(`div`);n.className=`pv-scrim`,n.innerHTML=`
    <div class="pv-modal" role="dialog" aria-modal="true" aria-label="Magnet preview">
      ...
      <div class="pv-body">
        <div>
          ...
          ${Kf(`Live render of the actual widget. Capture is disabled, so no test leads are created.`)}
        </div>
      </div>
    </div>`,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add(`open`)),qf(n);let r=n.querySelector(`.pv-frame`),i=n.querySelector(`.pv-stage`),a=()=>{try{r.srcdoc=Wf(e())}catch{}};a();let o=()=>{n.classList.remove(`open`),setTimeout(()=>n.remove(),180)};return n.querySelector(`[data-x="close"]`).addEventListener(`click`,o),n.querySelector(`[data-x="refresh"]`).addEventListener(`click`,a),n.addEventListener(`click`,e=>{e.target===n&&o()}),n.querySelector(`.pv-seg`).addEventListener(`click`,e=>{let r=e.target.closest(`button[data-device]`);!r||r.dataset.device===t||(t=r.dataset.device,n.querySelectorAll(`.pv-seg button`).forEach(e=>e.classList.toggle(`is-on`,e.dataset.device===t)),i.dataset.device=t,a())}),{close:o,rebuild:a}}var Xf,Zf=o((()=>{Hf(),Xf=!1}));function Qf(e,t){let n=rp(e),r=rp(t),i=tp.find(e=>rp(e.w)===n&&rp(e.h)===r);return i?i.id:`custom`}function $f(e){let t=tp.find(t=>t.id===e);return t?{w:t.w,h:t.h}:null}function ep(e,t){let n=String(e||``).trim();return n?n.length>40?`Keep it under 40 characters.`:!ip.test(n)&&!ap.test(n)?`That isn't a size the widget understands — use a CSS length like 720px or 80vh${t===`width`?` or 100%`:``}, or min()/max()/clamp().`:t===`height`&&/%\s*$/.test(n)?`A percentage height won’t work here — the card would collapse to its content. Use px or vh instead (720px, 80vh).`:``:``}var tp,np,rp,ip,ap,op=o((()=>{tp=Object.freeze([{id:`compact`,name:`Compact`,hint:`Sidebars and narrow slots`,w:`480px`,h:`440px`},{id:`standard`,name:`Standard`,hint:`The default fit`,w:``,h:``},{id:`tall`,name:`Tall`,hint:`Longer flows, content columns`,w:`640px`,h:`min(720px, 82vh)`},{id:`hero`,name:`Hero`,hint:`The magnet is the page`,w:`100%`,h:`min(80vh, 860px)`}]),np=Object.freeze({compact:{w:26,h:26},standard:{w:34,h:30},tall:{w:34,h:40},hero:{w:52,h:38}}),rp=e=>String(e||``).trim().replace(/\s+/g,` `).toLowerCase(),ip=/^\d+(\.\d+)?(px|rem|em|vh|vw|%)?$/,ap=/^(min|max|clamp)\(\s*[\d.\s,a-z%()+*/-]+\)$/i}));function sp(e){return{id:e.slug,name:e.name,description:e.description,icon:e.icon,category:e.category,tags:e.tags||[],featured:!!e.featured,appearance:e.appearance||{},steps:e.steps||[],appguid:e.appguid}}function cp(){return Cp||Sp}function lp(){return Cp?Promise.resolve(Cp):(wp||=b(`${Ca.baseUrl}/m5t/v5/templates`).then(e=>e.ok?e.json():null).then(e=>(e?.ok&&Array.isArray(e.templates)&&e.templates.length&&(Cp=e.templates.map(sp)),cp())).catch(()=>(wp=null,cp())),wp)}function up(e){let t=[];for(let n of e.steps||[])for(let e of n.step_columns||[])e&&!t.includes(e)&&t.push(e);return t}function dp(e){let t=(e.steps||[])[0]||{},n=(t.step_prompts||[])[0]||``,r=``;return t.step_type===`single_select`||t.step_type===`multi_select`?r=(t.step_options||[]).slice(0,3).map(e=>`<span class="mag-tpl-pv__btn">${bp(e?.label)}</span>`).join(``):Tp[t.step_type]?r=`<span class="mag-tpl-pv__input">${bp(Tp[t.step_type])}</span>`:t.step_type===`scheduler`&&(r=`<span class="mag-tpl-pv__cal"><span class="material-symbols-outlined" aria-hidden="true">calendar_month</span>Pick a time</span>`),`<div class="mag-tpl-card__preview" aria-hidden="true"><span class="mag-tpl-pv__bubble">${bp(n)}</span>${r}</div>`}function fp(e,{detail:t=!1,gallery:n=!1,canUse:r=!0}={}){let i=t?up(e):[],a=n?` mag-tpl-card--gallery`:``,o=n?` data-cat="${bp(e.category||``)}"`:``,s=n&&e.featured?`<span class="m5t-badge m5t-badge--featured m5t-featured-corner">Most popular</span>`:``,c=n?dp(e):``,l=n&&(e.tags||[]).length?`<div class="m5t-chip-row mag-tpl-card__tags">${e.tags.map(e=>`<span class="m5t-chip">${bp(e)}</span>`).join(``)}</div>`:``,u=r?`<button class="mag-tpl-card__btn" type="button" data-tpl="${e.id}">
    ...
    </div>`}function pp(e){ro(oo.MAGNET_TEMPLATE,{id:e,at:Date.now()})}function mp(e){if(!e)return null;if(typeof e==`string`)return cp().find(t=>t.id===e)||null;let{id:t,at:n}=e;return typeof n==`number`&&Date.now()-n>=Ep?null:cp().find(e=>e.id===t)||null}function hp(){return mp(io(oo.MAGNET_TEMPLATE))}function gp(){return mp(ao(oo.MAGNET_TEMPLATE))}function _p(){if(Dp)return;let e=document.createElement(`style`);e.id=`m5t-mag-template-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Dp=!0}function vp(e){lp(),_p();let t=document.createElement(`div`);t.className=`mag-modal-scrim mag-tpl-modal`,t.innerHTML=`
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${n.kind}">
    ...
    ${o}
  </div>`}function qp(){if(Zm)return;let e=document.createElement(`style`);e.id=`m5t-magnets-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Zm=!0}function Jp(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Yp(e){let t=B.stats[e];if(!t||!t.opens&&!t.leads)return`<div class="mag-statline mag-statline--empty">&mdash;</div><div class="mag-cellsub">No activity yet</div>`;let n=e=>Number(e||0).toLocaleString();return`<div class="mag-statline" title="Trailing 30 days"><b>${n(t.opens)}</b> opens &middot; <b>${n(t.leads)}</b> leads</div>
    ${t.completion_rate==null?``:`<div class="mag-cellsub">${t.completion_rate}% complete the conversation</div>`}`}function Xp(e){let t=B.install[e.guid];if(!t)return``;let n=t.unrecognized||[],r=(t.traffic?.opens||0)>0,i=e.can_manage===!0,a=n.length?`
    ...
    ${s}
    ${l}
  </div>`}async function Zp(){await Promise.all(B.magnets.map(async e=>{try{let t=await(await b(`${U()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity`)).json().catch(()=>({}));if(!t.ok)return;B.install[e.guid]=t,ym(e)}catch(t){console.warn(`[magnets] install activity failed:`,e.guid,t)}}))}function Qp(e){return e?e.status===`REVOKED`||e.status===`PENDING`&&e.codeLive===!1:!1}function $p(e,t){let n=t.status===`PENDING`&&t.codeLive===!1,r=(n?ph.EXPIRED:ph[t.status])||{label:t.status,icon:`help`,tone:`off`},i=t.lastSeen?new Date(t.lastSeen).toLocaleString():``,a=t.host?V(t.host):n||t.status===`REVOKED`?`Code was never used`:`Waiting for a site to use this code`,o=[t.siteName?V(t.siteName):``,i?`last seen ${V(i)}`:``].filter(Boolean).join(` — `);return`
    <div class="mag-conn__row" data-conn="${V(t.guid)}" data-state="${r.tone}">
      ...
      ${e.can_manage===!0?Qp(t)?`<button class="mag-btn" data-action="clear-connection" data-guid="${V(e.guid)}" data-conn="${V(t.guid)}"
    ...
    </div>`}function em(e){let t=B.pairing[e.guid];if(!t)return``;if(t.error)return`<div class="mag-conn__code" data-state="error">
  ...
  </div>`}function tm(e){let t=B.connections[e.guid];if(!t)return``;if(t.failed)return`<div class="mag-conn">
    ...
    </div>`;let n=t.connections||[],r=n.filter(t=>t.status!==`PENDING`||e.can_manage===!0),i=n.filter(e=>e.status===`ACTIVE`).length,a=em(e),o=r.filter(e=>!Qp(e)),s=r.filter(e=>Qp(e)),c=o.length?o.map(t=>$p(e,t)).join(``):`<p class="mag-install__hint">No sites connected yet. On WordPress, connecting a site pairs it without pasting the snippet by hand.</p>`,l=s.length?`
  ...
  </div>`}function nm(e){let t=document.querySelector(`.mag-card[data-guid="${CSS.escape(e.guid)}"] .mag-conn-slot`);t&&(t.innerHTML=tm(e))}async function rm(e){let t=await(await b(`${U()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/connections`)).json().catch(()=>({}));if(!t.ok)throw Error(t.error||`Could not load connected sites`);return t}async function im(){await Promise.all(B.magnets.map(async e=>{try{B.connections[e.guid]=await rm(e)}catch(t){console.warn(`[magnets] connections failed:`,e.guid,t),B.connections[e.guid]={failed:!0}}nm(e)}))}function am(){B.pairTimer&&(clearInterval(B.pairTimer),B.pairTimer=null)}function om(){am()}function sm(e){return!!document.querySelector(`.mag-card[data-guid="${CSS.escape(e)}"] .mag-conn-slot`)}function cm(){if(B.pairTimer)return;let e=0;B.pairTimer=setInterval(async()=>{for(let e of Object.keys(B.pairing))sm(e)||delete B.pairing[e];let t=Object.keys(B.pairing);if(!t.length){am();return}if(!t.some(e=>{let t=B.pairing[e];return!t.connected&&!t.error&&t.expiresAt-Date.now()>0})){t.forEach(e=>{let t=B.magnets.find(t=>t.guid===e);t&&nm(t)}),am();return}e+=1e3;let n=e>=fh;n&&(e=0);for(let e of t){let t=B.magnets.find(t=>t.guid===e),r=B.pairing[e];if(!t||!r)continue;let i=r.expiresAt-Date.now()<=0;if(n&&!r.connected&&!r.error&&!i)try{let n=await rm(t);B.connections[e]=n;let i=(n.connections||[]).find(e=>e.guid===r.connectionGuid&&e.status===`ACTIVE`);i&&(B.pairing[e]={connected:!0,connectionGuid:r.connectionGuid,connectedHost:i.host},H(`${i.host||`Your site`} connected`,`success`))}catch{}nm(t)}},1e3)}async function lm(e){try{let t=await b(`${U()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/pairing-code`,{method:`POST`,headers:{"Content-Type":`application/json`},body:`{}`}),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok){B.pairing[e.guid]={error:n.message||n.error||`Could not generate a pairing code`},nm(e);return}B.pairing[e.guid]={code:n.pairingCode,connectionGuid:n.connectionGuid,expiresAt:new Date(n.expiresAt).getTime()};try{B.connections[e.guid]=await rm(e)}catch{}nm(e),cm()}catch{B.pairing[e.guid]={error:`Could not reach the server. Try again.`},nm(e)}}async function um(e){let t=B.pairing[e.guid]?.code;if(t)try{await navigator.clipboard.writeText(t),H(`Pairing code copied`,`success`)}catch{H(`Copy failed — select the code and copy it manually`,`danger`)}}async function dm(e,t,n){if(window.confirm(`Clear the record for ${n||`this connection`}?\n\nIt is removed from this list for good. This only tidies up the history — the site is already disconnected, so nothing about access changes.`))try{let n=await b(`${U()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/connections/${encodeURIComponent(t)}`,{method:`DELETE`}),r=await n.json().catch(()=>({}));if(!n.ok||!r.ok){H(r.message||r.error||`Could not clear that record`,`danger`);return}H(`Record cleared`,`success`);try{B.connections[e.guid]=await rm(e)}catch{}nm(e)}catch{H(`Could not reach the server`,`danger`)}}async function fm(e,t){let n=(B.connections[e.guid]?.connections||[]).find(e=>e.guid===t),r=n?.status===`PENDING`,i=r?`Cancel this pairing code?`:`Disconnect ${n?.host||`this site`}?`,a=r?`The code stops working immediately.`:`Its key stops working immediately and the plugin will show as disconnected. The domain stays on the allow-list — remove it separately if you want the magnet off that site.`;if(window.confirm(`${i}\n\n${a}`))try{let n=await b(`${U()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/connections/${encodeURIComponent(t)}/revoke`,{method:`POST`,headers:{"Content-Type":`application/json`},body:`{}`}),i=await n.json().catch(()=>({}));if(!n.ok||!i.ok){H(i.message||i.error||`Could not disconnect`,`danger`);return}B.pairing[e.guid]?.connectionGuid===t&&delete B.pairing[e.guid],H(r?`Pairing code cancelled`:`Site disconnected`,`success`);try{B.connections[e.guid]=await rm(e)}catch{}nm(e)}catch{H(`Could not reach the server`,`danger`)}}function pm(e){if(e.status===`DRAFT`)return`draft`;if(e.status!==`ENABLED`)return`off`;let t=B.install[e.guid];return t?(t.traffic?.opens||0)>0?`live`:(t.unrecognized||[]).length?`seen`:`quiet`:`unknown`}function mm(e){let t=pm(e),n=B.install[e.guid],r=``,i=``;if(t===`draft`)r=`Draft`,i=`Not live yet`;else if(t===`off`)r=`Disabled`,i=`Hidden from visitors`;else if(t===`live`){let e=n.traffic?.last_open_at?new Date(n.traffic.last_open_at):null,t=e&&e.toDateString()===new Date().toDateString(),a=e?t?e.toLocaleTimeString([],{hour:`numeric`,minute:`2-digit`}):e.toLocaleDateString():``;r=`Live`,i=a?`Last visitor ${V(a)}`:`Serving visitors`}else t===`seen`?(r=`Needs review`,i=`Unrecognised domain`):t===`quiet`&&(r=`Not seen`,i=`No visitors in ${Number(n.window_days||30)} days`);return r?`<div class="mag-status" data-live="${t}"><span class="mag-dot" data-live="${t}" aria-hidden="true"></span>${r}</div>
          ${i?`<div class="mag-cellsub">${i}</div>`:``}`:``}function hm(e){let t=B.owners.length>1||w.getMemberships().length>1,n=(e.domains||[]).filter(Boolean),r=e.can_manage===!0,i=B.detailOpen[e.guid]===!0,a=[nh[e.display_mode]||`Chat bubble`,n.length?n.join(`, `):`No domains set. Add yours to go live.`,t&&e.owner_name?e.owner_name:``].filter(Boolean).join(` · `);return`
    <div class="mag-card${i?` is-open`:``}" data-guid="${V(e.guid)}">
      <div class="mag-line">
        ...
        <div class="mag-cell mag-cell--status">${mm(e)}</div>
        <div class="mag-cell mag-cell--stats">${Yp(e.guid)}</div>
      ...
      <div class="mag-detail" id="mag-detail-${V(e.guid)}" ${i?``:`hidden`}>
        ...
        <div class="mag-embed">
          <input type="text" readonly value="${V($m(e.guid))}" aria-label="Embed snippet">
        ...
        <div class="mag-install-slot">${Xp(e)}</div>
        <div class="mag-conn-slot">${tm(e)}</div>
      </div>
    </div>`}function gm(e,t){let n=typeof t==`boolean`?t:B.detailOpen[e]!==!0;B.detailOpen[e]=n;let r=document.querySelector(`.mag-card[data-guid="${CSS.escape(e)}"]`);if(!r)return;r.classList.toggle(`is-open`,n);let i=r.querySelector(`.mag-detail`);i&&(i.hidden=!n);let a=r.querySelector(`[data-action="install-toggle"][aria-controls]`);if(a){a.setAttribute(`aria-expanded`,String(n)),a.classList.toggle(`is-open`,n);let e=a.querySelector(`.material-symbols-outlined`);e&&(e.textContent=n?`expand_less`:`expand_more`)}}function _m(){mh||(mh=!0,document.addEventListener(`click`,e=>{e.target.closest?.(`.mag-more-wrap`)||vm()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&vm()}))}function vm(e){document.querySelectorAll(`.mag-menu`).forEach(t=>{if(t===e)return;t.hidden=!0;let n=t.parentElement?.querySelector(`[data-action="menu"]`);n&&n.setAttribute(`aria-expanded`,`false`)})}function ym(e){let t=document.querySelector(`.mag-card[data-guid="${CSS.escape(e.guid)}"]`);if(!t)return;let n=t.querySelector(`.mag-install-slot`);n&&(n.innerHTML=Xp(e));let r=pm(e),i=t.querySelector(`.mag-cell--status`);i&&(i.innerHTML=mm(e)),(r===`quiet`||r===`seen`)&&B.detailOpen[e.guid]===void 0&&gm(e.guid,!0)}function bm(){return A()?Ha({section:`magnets`,title:`Your Magnets`,description:`Pick a client to view and manage their magnets.`}):(qp(),`
    <div class="page-shell" data-section="magnets">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="mag-body">
          ${Jp(`hourglass_empty`,`Loading magnets…`)}
        </div>
      </div>
    </div>`)}async function xm(){if(A()){let e=gp();if(e){let t=document.querySelector(`.page-shell .page-header-text .page-description`);t&&(t.textContent=`Template picked: ${e.name}. Choose the client to build it for.`)}let t=e=>Number(e||0).toLocaleString();return Wa(U(),[{h:`Magnets`,td:e=>`${t(e.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${t(e.magnets.total)}</span>`},{h:`Leads · wk`,td:e=>t(e.leads.this_week)},{h:`Leads · total`,td:e=>t(e.leads.total)}],{emptyMsg:`No client orgs yet. Create one under Clients, then provision its magnets here.`})}ch=null,lh=null,uh=null,dh=null,document.getElementById(`mag-new-btn`)?.addEventListener(`click`,km),document.getElementById(`mag-template-btn`)?.addEventListener(`click`,jm),document.getElementById(`mag-body`)?.addEventListener(`click`,Mm),_m(),await Cm();let e=hp();e&&B.canProvision&&Am(e)}function Sm(e){e&&(e.innerHTML=`<div class="mag-grid">
    <div class="mag-head" aria-hidden="true"><span>Magnet</span><span>Status</span><span>Last 30 days</span><span></span></div>
    ${B.magnets.map(hm).join(``)}</div>`,O(e.querySelector(`.mag-grid`),{rowSelector:`.mag-card`,noun:`magnets`}))}async function Cm(){let e=document.getElementById(`mag-body`);if(!e)return;try{let[e,t]=await Promise.all([b(`${U()}/m5t/v5/magnets`),b(`${U()}/m5t/v5/magnets/stats`).catch(()=>null)]),n=await e.json().catch(()=>({}));if(j(e,n),!n.ok)throw Error(n.message||`Failed to load`);B.magnets=n.magnets||[],B.owners=n.owners||[],B.canProvision=!!n.canProvision,B.canManage=!!n.canManage,B.primaryOrgGuid=n.primaryOrgGuid||null;let r=t?await t.json().catch(()=>({})):{};B.stats=r?.stats||{}}catch(t){e.innerHTML=$a(t)?eo():Jp(`error`,`Could not load your magnets. Please try again.`);return}let t=document.getElementById(`mag-new-btn`);t&&(t.style.display=B.canProvision?``:`none`);let n=document.getElementById(`mag-template-btn`);if(n&&(n.style.display=B.canProvision?``:`none`),!B.magnets.length){e.innerHTML=Jp(`widgets`,B.canProvision?`Design your first magnet. Start from a template, or click “New magnet” and build from scratch.`:`No magnets yet.`);return}Sm(e),Zp(),im()}async function wm(e){let t={"Content-Type":`application/json`,"Idempotency-Key":crypto.randomUUID()},n={status:`DRAFT`};e&&(n.owner_guid=e);let r=await b(`${U()}/m5t/v5/magnets`,{method:`POST`,headers:t,body:JSON.stringify(n)}),i={};try{i=await r.json()}catch{}if(!r.ok||!i.ok)throw Error(i.message||`Could not start a new magnet (${r.status})`);return i.magnet}async function Tm(e,t){let n=await b(`${U()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({name:t.name,...t.appearance,steps:t.steps})}),r={};try{r=await n.json()}catch{}if(!n.ok||!r.ok)throw Error(r.message||`Could not apply the ${t.name} template (${n.status})`)}async function Em(e,t){let n=document.getElementById(`mag-new-btn`),r=document.getElementById(`mag-template-btn`);n&&(n.disabled=!0),r&&(r.disabled=!0);let i=null;try{let n=await wm(e);i=n.guid,t?(await Tm(n.guid,t),await Cm(),n=B.magnets.find(e=>e.guid===n.guid)||n):(B.magnets=[n,...B.magnets],Sm(document.getElementById(`mag-body`))),Ym(n,void 0,{freshDraft:!0})}catch(e){i&&b(`${U()}/m5t/v5/magnets/${encodeURIComponent(i)}`,{method:`DELETE`}).catch(()=>{}),H(e.message||`Could not start a new magnet`,`danger`)}finally{n&&(n.disabled=!1),r&&(r.disabled=!1)}}function Dm(e){let t=document.createElement(`div`);t.className=`mag-modal-scrim`,t.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="Choose client" style="max-width:420px">
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add(`open`),t.querySelector(`.mag-modal`).classList.add(`open`)});let n=()=>{t.classList.remove(`open`),setTimeout(()=>t.remove(),180),document.removeEventListener(`keydown`,r)};function r(e){e.key===`Escape`&&(e.preventDefault(),n())}document.addEventListener(`keydown`,r),t.querySelector(`.mag-modal__close`).addEventListener(`click`,n),t.querySelector(`[data-x="cancel"]`).addEventListener(`click`,n),t.querySelector(`[data-x="continue"]`).addEventListener(`click`,()=>{let r=t.querySelector(`#mag-owner-pick`).value;n(),Em(r,e)})}function Om(){return B.owners.length===1?B.owners[0].guid:null}function km(){if(B.owners.length>1){Dm();return}Em(Om())}function Am(e){if(B.owners.length>1){Dm(e);return}Em(Om(),e)}function jm(){vp(Am)}function Mm(e){let t=e.target.closest(`[data-action]`);if(!t){if(vm(),!e.target.closest(`a`)){let t=e.target.closest(`.mag-line`)?.closest(`.mag-card`);t?.dataset.guid&&gm(t.dataset.guid)}return}let n=t.dataset.guid,r=B.magnets.find(e=>e.guid===n),i=t.dataset.action;if(i===`menu`){let e=t.parentElement?.querySelector(`.mag-menu`);if(!e)return;let n=e.hidden;vm(e),e.hidden=!n,t.setAttribute(`aria-expanded`,String(n));return}if(vm(),i===`install-toggle`)return gm(n);if(i===`copy`)return Nm(n);if(r){if(i===`preview`)return Yf(()=>Uf(r));if(i===`funnel`)return Fm(r);if(i===`edit`)return Ym(r);if(i===`flow`)return Ym(r,`flow`);if(i===`allow-domain`)return Im(r,t.dataset.domain);if(i===`dismiss-domain`)return Lm(r,t.dataset.domain);if(i===`restore-domain`)return Rm(r,t.dataset.domain);if(i===`pair-start`)return lm(r);if(i===`copy-code`)return um(r);if(i===`revoke-connection`)return fm(r,t.dataset.conn);if(i===`clear-connection`)return dm(r,t.dataset.conn,t.dataset.label);if(i===`toggle`)return Bm(r);if(i===`delete`)return Vm(r)}}async function Nm(e){try{await navigator.clipboard.writeText($m(e)),H(`Embed snippet copied`,`success`)}catch{H(`Copy failed`,`danger`)}}function Pm(e){let t=Number(e?.total_steps)||0,n={};if((Array.isArray(e?.funnel)?e.funnel:[]).forEach(e=>{n[e.position]=Number(e.reached)||0}),!t||!Object.keys(n).length)return`<p class="mag-modal__hint" style="margin:0">No step activity yet in this window. As visitors answer questions, drop-off by step will appear here.</p>`;let r=Math.max(1,n[1]||0),i=[];for(let e=1;e<=t;e++){let a=n[e]||0,o=Math.min(100,Math.round(a/r*100));i.push(`
      ...
      </div>`)}return`<div class="mag-funnel">${i.join(``)}</div>`}async function Fm(e){let t=document.createElement(`div`);t.className=`mag-modal-scrim`,t.innerHTML=`
    <div class="mag-modal mag-funnel-modal" role="dialog" aria-modal="true" aria-label="Step funnel for ${V(e.name)}">
      ...
      <div class="mag-modal__body" style="padding:20px">
        ...
        <div id="mag-funnel-body">${Jp(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add(`open`),t.querySelector(`.mag-modal`).classList.add(`open`)});let n=()=>{t.classList.remove(`open`),setTimeout(()=>t.remove(),180),document.removeEventListener(`keydown`,r)};function r(e){e.key===`Escape`&&(e.preventDefault(),n())}document.addEventListener(`keydown`,r),t.querySelector(`.mag-modal__close`).addEventListener(`click`,n),t.addEventListener(`click`,e=>{e.target===t&&n()});let i=t.querySelector(`#mag-funnel-body`);try{let t=await b(`${U()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/step-funnel`),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.message||`Failed (${t.status})`);i.innerHTML=Pm(n)}catch{i.innerHTML=`<p class="mag-modal__hint" style="margin:0">Could not load the funnel. Please try again.</p>`}}async function Im(e,t){let n=String(t||``).trim().toLowerCase();if(!n||!window.confirm(`Allow ${n} to load this magnet?\n\nOnly do this for a site you recognise — anyone can put this magnet's embed code on a page.`))return;let r=[...new Set([...(e.domains||[]).filter(Boolean),n])];try{if(!(await(await b(`${U()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({domains:r})})).json().catch(()=>({}))).ok)throw Error();H(`${n} allowed`,`success`)}catch{H(`Could not allow that domain`,`danger`);return}try{await Cm()}catch(e){console.warn(`[magnets] refresh after allow-domain failed:`,e)}}async function Lm(e,t){let n=String(t||``).trim().toLowerCase();if(!n)return;let r=n.split(`.`),i=r.length>2?r.slice(-2).join(`.`):null,a=n;i&&window.confirm(`Hide ${n} from this list?\n\nOK — hide every domain under ${i} too (covers preview/staging URLs that change every deploy).\nCancel — hide only ${n}.`)&&(a=i);try{if(!(await(await b(`${U()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity/dismiss`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({domain:a})})).json().catch(()=>({}))).ok)throw Error();H(`${a} hidden from this list`,`success`)}catch{H(`Could not dismiss that domain`,`danger`);return}await zm(e)}async function Rm(e,t){let n=String(t||``).trim().toLowerCase();if(n){try{if(!(await(await b(`${U()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity/restore`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({domain:n})})).json().catch(()=>({}))).ok)throw Error();H(`${n} will show again`,`success`)}catch{H(`Could not restore that domain`,`danger`);return}await zm(e)}}async function zm(e){try{let t=await(await b(`${U()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity`)).json().catch(()=>({}));if(!t.ok)return;B.install[e.guid]=t,ym(e)}catch(e){console.warn(`[magnets] install refresh failed:`,e)}}async function Bm(e){if(e.status===`DRAFT`){H(`Open Edit and Save to publish a draft magnet.`,`info`);return}let t=e.status===`ENABLED`?`DISABLED`:`ENABLED`;try{if(!(await(await b(`${U()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw Error();H(t===`ENABLED`?`Magnet enabled`:`Magnet disabled`,`success`)}catch{H(`Update failed`,`danger`);return}try{await Cm()}catch(e){console.warn(`[magnets] refresh after status toggle failed:`,e)}}async function Vm(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`)){try{if(!(await(await b(`${U()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:`DELETE`})).json().catch(()=>({}))).ok)throw Error();H(`Magnet deleted`,`success`)}catch{H(`Delete failed`,`danger`);return}try{await Cm()}catch(e){console.warn(`[magnets] refresh after delete failed:`,e)}}}function Hm(e){let t=[];e.querySelectorAll(`.mag-cta`).forEach(e=>{if(!e.querySelector(`.mag-cta__on`).checked)return;let n=e.dataset.type,r=e.dataset.kind,i=e.querySelector(`.mag-cta__val`),a=i?i.value.trim():``;if(r===`value`){if(n===`call`&&e.querySelector(`.mag-cta__callsrc`)?.value===`callrail`){let r=e.querySelector(`.mag-cta__crtracker`),i=r?.value||``,a=r?.selectedOptions?.[0];i&&t.push({type:n,value:i,config:{source:`callrail`,...a?.dataset?.trackerId?{tracker_id:a.dataset.trackerId}:{},...a?.dataset?.trackerName?{tracker_name:a.dataset.trackerName}:{}}})}else a&&t.push({type:n,value:a})}else if(r===`book`){let r=e.querySelector(`.mag-cta__booksrc`)?.value;if(r===`calendly`){let r=e.querySelector(`.mag-cta__calevent`),i=r?.value||``,a=(r?.selectedOptions?.[0]?.textContent||``).trim();t.push({type:n,config:{source:`calendly`,...i?{calendly_url:i}:{},...i&&a?{event_name:a}:{}}})}else if(r===`calcom`||r===`ms_bookings`){let i=e.querySelector(r===`calcom`?`.mag-cta__ccevent`:`.mag-cta__mbevent`),a=i?.value||``,o=(i?.selectedOptions?.[0]?.textContent||``).trim(),s={source:r,...a&&o?{event_name:o}:{}};if(r===`ms_bookings`){let t=i?.selectedOptions?.[0]?.dataset?.id||``,n=e.querySelector(`.mag-cta__mbservice`),r=n?.value||``;if(t&&r){s.business_id=t,s.service_id=r;let e=(n.selectedOptions?.[0]?.textContent||``).replace(/ \(.*$/,``).trim();e&&(s.event_name=e)}}t.push({type:n,...a?{value:a}:{},config:s})}else{let e={type:n};a&&(/^https?:\/\//i.test(a)?e.value=a:e.config={meeting_label:a}),t.push(e)}}else if(r===`support`){let r=(e.querySelector(`.mag-cta__opts`)?.value||``).split(`
`).map(e=>e.trim()).filter(Boolean).map(e=>({label:e})),i={type:n};r.length&&(i.config={options:r}),t.push(i)}else t.push({type:n})});let n={display_mode:e.querySelector(`input[name="mag-display"]:checked`)?.value||`chat`,trigger:Np(e),theme_mode:e.querySelector(`input[name="mag-theme"]:checked`)?.value||`auto`,title:e.querySelector(`#mag-f-title`).value.trim(),theme_color:e.querySelector(`#mag-f-color`).value,subtitle:e.querySelector(`#mag-f-subtitle`).value,launcher_label:e.querySelector(`#mag-f-launcher`).value.trim(),logo_url:e.querySelector(`#mag-f-logo`).value.trim(),logo_fit:e.querySelector(`#mag-f-logo-fit`)?.value===`contain`?`contain`:`cover`,summary:e.querySelector(`#mag-f-summary`).checked,summary_heading:e.querySelector(`#mag-f-summary-heading`).value.trim(),home:e.querySelector(`#mag-f-home`).checked,welcome:e.querySelector(`#mag-f-welcome`).value,ab:qm(e),actions:t,font:e.querySelector(`#mag-f-font`).value.trim(),theme_vars:Gm(e),...(()=>{let t=$f(e.querySelector(`input[name="mag-size-preset"]:checked`)?.value||`standard`);return t?{inline_width:t.w,inline_height:t.h}:{inline_width:e.querySelector(`#mag-f-inline-w`).value.trim(),inline_height:e.querySelector(`#mag-f-inline-h`).value.trim()}})(),hide_launcher:e.querySelector(`#mag-f-hide-launcher`).checked,input_placeholder:e.querySelector(`#mag-f-input-ph`).value,summary_confirm_label:e.querySelector(`#mag-f-summary-confirm`).value.trim(),success_title:e.querySelector(`#mag-f-success-title`).value.trim(),success_text:e.querySelector(`#mag-f-success-text`).value,success_cta:Km(e)};return n.trigger===void 0&&delete n.trigger,n}function Um(e){return new Promise((t,n)=>{let r=new Image,i=new FileReader;i.onerror=()=>n(Error(`Could not read that file.`)),i.onload=()=>{r.onerror=()=>n(Error(`That file isn’t a readable image.`)),r.onload=()=>{let e=Math.min(1,hh/Math.max(r.naturalWidth,r.naturalHeight)),n=Math.max(1,Math.round(r.naturalWidth*e)),i=Math.max(1,Math.round(r.naturalHeight*e)),a=document.createElement(`canvas`);a.width=n,a.height=i,a.getContext(`2d`).drawImage(r,0,0,n,i),t(a.toDataURL(`image/png`))},r.src=i.result},i.readAsDataURL(e)})}function Wm(e,t){let n=e.querySelector(`#mag-logo-drop`);if(!n)return;let r=e.querySelector(`#mag-f-logo-file`),i=e.querySelector(`#mag-logo-browse`),a=e.querySelector(`#mag-logo-remove`),o=e.querySelector(`#mag-logo-preview`),s=e.querySelector(`#mag-logo-status`),c=e.querySelector(`#mag-f-logo`),l=(e,t)=>{s.textContent=e,s.style.color=t?`var(--color-danger, #DD4124)`:``},u=e=>{o.innerHTML=e?`<img src="${V(e)}" alt="">`:`<span class="material-symbols-outlined" aria-hidden="true">image</span>`,a.hidden=!e},d=e=>{c.value=e,c.dispatchEvent(new Event(`input`,{bubbles:!0})),c.dispatchEvent(new Event(`change`,{bubbles:!0}))};async function f(e){if(!gh.has(e.type)){l(`PNG, JPEG, GIF, or WEBP only.`,!0);return}if(e.size>_h){l(`That file is too large (8MB max before resizing).`,!0);return}l(`Uploading…`,!1);try{let n=await Um(e),r=await b(`${U()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({image:n})}),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok)throw Error(i.error||`Upload failed (${r.status})`);let a=`${U()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;d(a),u(a),l(`Logo updated.`,!1)}catch(e){l(e.message||`Upload failed.`,!0)}}r.addEventListener(`change`,()=>{r.files[0]&&f(r.files[0]),r.value=``}),n.addEventListener(`click`,e=>{e.target===a||a.contains(e.target)||e.target!==i&&r.click()}),i.addEventListener(`click`,()=>r.click()),[`dragenter`,`dragover`].forEach(e=>n.addEventListener(e,e=>{e.preventDefault(),n.classList.add(`is-dragover`)})),[`dragleave`,`drop`].forEach(e=>n.addEventListener(e,e=>{e.preventDefault(),n.classList.remove(`is-dragover`)})),n.addEventListener(`drop`,e=>{let t=e.dataTransfer?.files?.[0];t&&f(t)}),a.addEventListener(`click`,async e=>{e.stopPropagation(),l(`Removing…`,!1);try{let e=await b(`${U()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:`DELETE`}),n=await e.json().catch(()=>({}));if(!e.ok||!n.ok)throw Error(n.error||`Remove failed (${e.status})`);d(``),u(``),l(`Logo removed.`,!1)}catch(e){l(e.message||`Remove failed.`,!0)}})}function Gm(e){return e.querySelector(`#mag-f-surface-on`)?.checked?{surface:e.querySelector(`#mag-f-sv-surface`).value,surface_2:e.querySelector(`#mag-f-sv-surface2`).value,border:e.querySelector(`#mag-f-sv-border`).value,text:e.querySelector(`#mag-f-sv-text`).value,text_sub:e.querySelector(`#mag-f-sv-textsub`).value}:{}}function Km(e){let t=e.querySelector(`#mag-f-success-cta-label`).value.trim(),n=e.querySelector(`#mag-f-success-cta-url`).value.trim();return t&&n?{label:t,url:n}:{}}function qm(e){let t={},n=e.querySelector(`#mag-f-ab-title`)?.value.trim(),r=e.querySelector(`#mag-f-ab-welcome`)?.value.trim(),i=e.querySelector(`#mag-f-ab-color`)?.value||``,a=e.querySelector(`#mag-f-color`)?.value||``;return n&&(t.title=n),r&&(t.welcome=r),i&&i.toLowerCase()!==a.toLowerCase()&&(t.theme_color=i),{enabled:!!e.querySelector(`#mag-f-ab`)?.checked,split:Number(e.querySelector(`#mag-f-ab-split`)?.value)||50,b:t}}function Jm(e){let t=String(e||``),n=new Set(vh.flatMap(e=>e.opts.map(([e])=>e))),r=e=>e===t?` selected`:``,i=`<option value=""${t===``?` selected`:``}>System default</option>`;t&&!n.has(t)&&(i+=`<option value="${V(t)}" selected>Current: ${V(t)}</option>`);for(let e of vh)i+=`<optgroup label="${V(e.label)}">`+e.opts.map(([e,t])=>`<option value="${V(e)}"${r(e)}>${V(t)}</option>`).join(``)+`</optgroup>`;return i}function Ym(e,t,n={}){let{freshDraft:r=!1}=n,i=!!e,a=i?null:crypto.randomUUID(),o=!i&&B.owners.length>1,s=e?.display_mode||`chat`,c=e?.theme_mode||`auto`,l={};(e?.actions||[]).forEach(e=>{e&&e.type&&(l[e.type]=e)});let u=!i||!!e.home,d=i?e.subtitle==null?``:e.subtitle:`Typically replies in a few minutes`,f=e?.theme_vars&&typeof e.theme_vars==`object`?e.theme_vars:{},m=Object.keys(f).length>0,h=(e,t)=>V(/^#[0-9a-fA-F]{6}$/.test(f[e]||``)?f[e]:t),g=document.createElement(`div`);g.className=`mag-modal-scrim`,g.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${i?`Edit magnet`:`New magnet`}">
      ...
      <div class="mag-modal__main">
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${ah.map(t=>`<option value="${t.value}"${Ap(e)===t.value?` selected`:``}>${V(t.label)}</option>`).join(``)}
          <option value="__per_device"${Ap(e)===`__per_device`?` selected`:``}>Per device&hellip;</option>
        </select>
        <div class="mag-perdev" id="mag-f-perdev"${Ap(e)===`__per_device`?``:` hidden`}>
          <div class="mag-perdev__row">
            ...
            <select class="mag-modal__select" id="mag-f-trigger-desktop">
              ${ah.map(t=>`<option value="${t.value}"${jp(e,`desktop`)===t.value?` selected`:``}>${V(t.label)}</option>`).join(``)}
            </select>
          </div>
          <div class="mag-perdev__row">
            <label class="mag-modal__label" for="mag-f-trigger-mobile">Mobile</label>
            <select class="mag-modal__select" id="mag-f-trigger-mobile">
              ${ah.map(t=>`<option value="${t.value}"${jp(e,`mobile`)===t.value?` selected`:``}>${V(t.label)}</option>`).join(``)}
            </select>
          </div>
        ...
        <div class="mag-modal__sec">
          ...
          <select class="mag-modal__select" id="mag-f-font">${Jm(e?.font||``)}</select>
          ...
          <div id="mag-f-inline-size"${s===`inline`?``:` hidden`}>
            ...
            <div class="mag-size-grid" role="radiogroup" aria-label="Inline size">
              ${(()=>{let t=Qf(e?.inline_width,e?.inline_height),n=(e,n,r,i,a)=>`
                  ...
                  </label>`;return tp.map(e=>n(e.id,e.name,e.hint,np[e.id].w,np[e.id].h)).join(``)+n(`custom`,`Custom`,`Your own CSS sizes`,44,32)})()}
            </div>
            ...
            <div id="mag-f-inline-custom"${Qf(e?.inline_width,e?.inline_height)===`custom`?``:` hidden`}>
              <div class="mag-modal__row">
                <div>
    ...
    </div>`,document.body.appendChild(g),requestAnimationFrame(()=>{g.classList.add(`open`),g.querySelector(`.mag-modal`).classList.add(`open`)});let _=[...g.querySelectorAll(`.mag-modal__navitem`)],v=[...g.querySelectorAll(`.mag-tab`)],y=e=>{_.forEach(t=>t.classList.toggle(`is-active`,t.dataset.tab===e)),v.forEach(t=>{t.hidden=t.dataset.tab!==e}),g.querySelector(`.mag-modal__body`).scrollTop=0};_.forEach(e=>e.addEventListener(`click`,()=>y(e.dataset.tab)));let ee=()=>Uf({...e,...Hm(g),...i?{steps:lf()}:{}}),te=g.querySelector(`#mag-preview-pane`),ne=()=>window.matchMedia(`(min-width: 1200px)`).matches,re=null,ie=()=>{if(!re&&ne())try{re=Jf(te,ee)}catch{}},ae=null,oe=()=>{ne()&&(ie(),re&&(clearTimeout(ae),ae=setTimeout(()=>{try{re.refresh()}catch{}},300)))},se=window.matchMedia(`(min-width: 1200px)`),ce=()=>{ne()&&(ie(),oe())};se.addEventListener(`change`,ce);let le=!1,ue=!1,de=g.querySelector(`#mag-f-dirty`),fe=e=>{le=e,de&&(de.hidden=!e)},pe=g.querySelector(`.mag-modal__main`);pe.addEventListener(`input`,()=>fe(!0)),pe.addEventListener(`change`,()=>{fe(!0),Mp(g),oe()}),Mp(g),g.querySelector(`#mag-f-color`)?.addEventListener(`input`,()=>{fe(!0),oe()});let me=e=>{le&&(e.preventDefault(),e.returnValue=``)};window.addEventListener(`beforeunload`,me);let he=!0,ge=Xm.default.subscribe(p.ROUTE_NAV_BEFORE,()=>{if(he){if(le&&!confirm(`Discard your changes to this magnet?`)){window.router?.navigate(`/magnets`);return}_e()}}),_e=()=>{r&&!ue&&e&&e.status===`DRAFT`&&(b(`${U()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:`DELETE`}).catch(()=>{}),B.magnets=B.magnets.filter(t=>t.guid!==e.guid),Sm(document.getElementById(`mag-body`))),he=!1,window.removeEventListener(`beforeunload`,me),Xm.default.unsubscribe(ge),clearTimeout(ae),se.removeEventListener(`change`,ce),re&&re.destroy&&re.destroy(),g.classList.remove(`open`),setTimeout(()=>g.remove(),180),document.removeEventListener(`keydown`,ye)},ve=()=>{le&&!confirm(`Discard your changes to this magnet?`)||_e()};function ye(e){e.key===`Escape`&&(e.preventDefault(),ve())}document.addEventListener(`keydown`,ye),g.querySelector(`.mag-modal__close`).addEventListener(`click`,ve),g.querySelector(`[data-x="cancel"]`).addEventListener(`click`,ve),g.querySelector(`[data-close-modal]`)?.addEventListener(`click`,ve),g.querySelector(`#mag-f-name`).focus();let be=g.querySelector(`#mag-flow-panel`);i?$d(be,e,()=>{fe(!0),oe()}):be.innerHTML=`<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>`,Wm(g,e),t&&y(t),ie(),g.querySelectorAll(`.mag-cta`).forEach(e=>{let t=e.querySelector(`.mag-cta__on`),n=e.querySelector(`.mag-cta__val`),r=e.querySelector(`.mag-cta__opts`),i=e.querySelectorAll(`.mag-cta__booksrc, .mag-cta__calevent, .mag-cta__callsrc, .mag-cta__crtracker`);t.addEventListener(`change`,()=>{n&&(n.disabled=!t.checked),r&&(r.disabled=!t.checked),i.forEach(e=>{e.disabled=!t.checked}),t.checked&&(n||r)?.focus()}),n&&n.addEventListener(`input`,()=>{n.value.trim()&&!t.checked&&(t.checked=!0,r&&(r.disabled=!1))})}),g.querySelectorAll(`.mag-cta[data-kind="book"]`).forEach(e=>{let t=e.querySelector(`.mag-cta__booksrc`),n=e.querySelector(`.mag-cta__val`),r=e.querySelector(`.mag-cta__calevent`),i=e.querySelector(`.mag-cta__ccevent`),a=e.querySelector(`.mag-cta__mbevent`);if(!t||!r||!i||!a)return;let o=()=>{let o=t.value===`calendly`,s=t.value===`calcom`,c=t.value===`ms_bookings`;n.hidden=o||s||c,r.hidden=!o,i.hidden=!s,a.hidden=!c;let l=e.querySelector(`.mag-cta__mbservice`);l&&(l.hidden=!c),o&&!r.dataset.listed&&(r.dataset.listed=`1`,Hp(r)),s&&!i.dataset.listed&&(i.dataset.listed=`1`,Rp(i)),c&&!a.dataset.listed&&(a.dataset.listed=`1`,Bp(a))};t.addEventListener(`change`,()=>{let t=e.querySelector(`.mag-cta__on`);t.checked||(t.checked=!0,t.dispatchEvent(new Event(`change`))),o()}),o()}),g.querySelectorAll(`.mag-cta[data-type="call"]`).forEach(e=>{let t=e.querySelector(`.mag-cta__callsrc`),n=e.querySelector(`.mag-cta__val`),r=e.querySelector(`.mag-cta__crtracker`);if(!t||!r)return;let i=()=>{let e=t.value===`callrail`;n.hidden=e,r.hidden=!e,e&&!r.dataset.listed&&(r.dataset.listed=`1`,Wp(r))};t.addEventListener(`change`,()=>{let t=e.querySelector(`.mag-cta__on`);t.checked||(t.checked=!0,t.dispatchEvent(new Event(`change`))),i()}),i()});let xe=g.querySelector(`#mag-f-surface-on`),Se=g.querySelector(`#mag-f-surface`);xe.addEventListener(`change`,()=>Se.hidden=!xe.checked);let Ce=g.querySelector(`#mag-f-inline-size`);g.querySelectorAll(`input[name="mag-size-preset"]`).forEach(e=>e.addEventListener(`change`,()=>{g.querySelectorAll(`.mag-size-card`).forEach(e=>e.classList.toggle(`is-on`,e.querySelector(`input`).checked)),g.querySelector(`#mag-f-inline-custom`).hidden=e.value!==`custom`})),g.querySelectorAll(`input[name="mag-display"]`).forEach(e=>e.addEventListener(`change`,()=>{Ce.hidden=g.querySelector(`input[name="mag-display"]:checked`)?.value!==`inline`})),g.querySelector(`[data-x="preview"]`)?.addEventListener(`click`,()=>Yf(()=>Uf({...e,...Hm(g),...i?{steps:lf()}:{}}))),g.querySelector(`[data-x="save"]`).addEventListener(`click`,async t=>{let n=t.currentTarget,r=g.querySelector(`#mag-f-error`),s=g.querySelector(`#mag-f-name`).value.trim();if(!s){y(`basics`),r.textContent=`Please give your magnet a name.`;return}let c=g.querySelector(`#mag-f-domains`).value.split(`,`).map(e=>e.trim()).filter(Boolean);if((g.querySelector(`input[name="mag-size-preset"]:checked`)?.value||`standard`)===`custom`){let e=ep(g.querySelector(`#mag-f-inline-w`).value,`width`)||ep(g.querySelector(`#mag-f-inline-h`).value,`height`),t=g.querySelector(`#mag-f-inline-err`);if(t&&(t.textContent=e),e){y(`appearance`),r.textContent=`Check the inline size fields.`;return}}let l=``;if(g.querySelectorAll(`.mag-cta`).forEach(e=>{let t=e.querySelector(`.mag-cta__on`).checked;if(e.dataset.kind===`book`){let n=e.querySelector(`.mag-cta__booksrc`)?.value;t&&n===`calendly`&&!e.querySelector(`.mag-cta__calevent`)?.value&&(l||=`Pick a Calendly event for the Book button, or switch it back to the built-in scheduler.`),t&&n===`calcom`&&!e.querySelector(`.mag-cta__ccevent`)?.value&&(l||=`Pick a Cal.com event for the Book button, or switch it back to the built-in scheduler.`),t&&n===`ms_bookings`&&!e.querySelector(`.mag-cta__mbevent`)?.value&&(l||=`Pick a Bookings page for the Book button, or switch it back to the built-in scheduler.`);return}if(e.dataset.kind!==`value`)return;if(e.dataset.type===`call`&&e.querySelector(`.mag-cta__callsrc`)?.value===`callrail`){t&&!e.querySelector(`.mag-cta__crtracker`)?.value&&(l||=`Pick a CallRail tracking number for the Call button, or switch it back to a phone number.`);return}let n=e.querySelector(`.mag-cta__val`).value.trim();t&&!n&&(l||=`Add a target for the ${oh[e.dataset.type].label} button, or uncheck it.`)}),l){y(`welcome`),r.textContent=l;return}let u=qm(g);if(u.enabled&&!Object.keys(u.b).length){y(`ab`),r.textContent=`Give variant B at least one change (title, welcome, or color), or untick the A/B test.`;return}if(i){let e=rf();if(e){y(`flow`),r.textContent=e.message,af(e.route,e.message,{uid:e.uid,field:e.field});return}}let d={name:s,domains:c,...Hm(g)};o&&(d.owner_guid=g.querySelector(`#mag-f-owner`).value);let f=i&&e.status===`DRAFT`;f&&(d.status=`ENABLED`),n.disabled=!0,r.textContent=``;try{i&&await sf(e.guid);let t=i?`${U()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${U()}/m5t/v5/magnets`,n={"Content-Type":`application/json`};a&&(n[`Idempotency-Key`]=a);let r=await b(t,{method:i?`PATCH`:`POST`,headers:n,body:JSON.stringify(d)}),o={};try{o=await r.json()}catch{}if(!r.ok||!o.ok)throw Error(o.message||`Save failed (${r.status})`);i&&(of(o.modified_tz||``),await cf(e.guid)),H(f||!i?`Magnet created`:`Magnet updated`,`success`),ue=!0,_e(),await Cm()}catch(e){n.disabled=!1,r.textContent=e.message||`Something went wrong.`}})}var Xm,Zm,B,Qm,V,H,U,$m,eh,th,nh,rh,ih,ah,oh,sh,ch,lh,uh,dh,fh,ph,mh,hh,gh,_h,vh,yh=o((()=>{T(),Xm=u(f(),1),m(),Bf(),Zf(),op(),Qa(),Op(),An(),x(),no(),Zm=!1,B={magnets:[],owners:[],canProvision:!1,canManage:!1,primaryOrgGuid:null,stats:{},install:{},connections:{},pairing:{},pairTimer:null,detailOpen:{}},Qm={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},V=e=>String(e??``).replace(/[&<>"']/g,e=>Qm[e]),H=(e,t=`info`)=>{try{Xm.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},U=()=>w.getConfig?.().BASE_URL||``,$m=e=>`<script src="${U()}/m5t/v5/coreSnippet?appguid=${e}" async><\/script>`,eh=()=>`<details class="mag-csp-note">
...
</details>`,th=e=>{let t=V($m(e));return`<details class="mag-guide">
...
/&gt;</code></pre>
...
</details>`},nh={chat:`Chat bubble`,right_slide:`Slide-in panel`,modal:`Modal`,inline:`Inline`},rh=[{value:`inline`,icon:`view_agenda`,label:`Inline`},{value:`chat`,icon:`chat`,label:`Chat`},{value:`right_slide`,icon:`vertical_split`,label:`Slide`},{value:`modal`,icon:`web_asset`,label:`Modal`}],ih=[{value:`auto`,icon:`brightness_auto`,label:`Auto`},{value:`sync`,icon:`sync`,label:`Sync`},{value:`light`,icon:`light_mode`,label:`Light`},{value:`dark`,icon:`dark_mode`,label:`Dark`}],ah=[{value:`on_load`,label:`Immediately on page load`},{value:`on_8_seconds`,label:`After 8 seconds`},{value:`on_scroll_80_percent`,label:`At 80% scroll depth`},{value:`on_exit_intent`,label:`On exit intent (mouse leaves the page)`},{value:`none`,label:`Manual only (visitor clicks the launcher)`}],oh={book:{label:`Book`,icon:`event`,kind:`book`},chat:{label:`Chat`,icon:`chat`,kind:`flow`},call:{label:`Call`,icon:`phone`,kind:`value`,placeholder:`Phone number`},email:{label:`Email`,icon:`mail`,kind:`value`,placeholder:`Email address`},support:{label:`Support`,icon:`support_agent`,kind:`support`}},sh=[`book`,`chat`,`call`,`email`,`support`],ch=null,lh=null,uh=null,dh=null,fh=5e3,ph={ACTIVE:{label:`Connected`,icon:`check_circle`,tone:`live`},PENDING:{label:`Waiting to connect`,icon:`hourglass_empty`,tone:`pending`},REVOKED:{label:`Disconnected`,icon:`link_off`,tone:`off`},EXPIRED:{label:`Expired`,icon:`timer_off`,tone:`off`}},mh=!1,hh=512,gh=new Set([`image/png`,`image/jpeg`,`image/gif`,`image/webp`]),_h=8388608,vh=[{label:`Web fonts (loaded for you)`,opts:[[`Inter, sans-serif`,`Inter`],[`Poppins, sans-serif`,`Poppins`],[`Montserrat, sans-serif`,`Montserrat`],[`Roboto, sans-serif`,`Roboto`],[`"Open Sans", sans-serif`,`Open Sans`],[`Lato, sans-serif`,`Lato`],[`Nunito, sans-serif`,`Nunito`],[`Raleway, sans-serif`,`Raleway`],[`"Work Sans", sans-serif`,`Work Sans`],[`Oswald, sans-serif`,`Oswald`],[`Merriweather, serif`,`Merriweather (serif)`]]},{label:`System / always available`,opts:[[`system-ui, sans-serif`,`System UI`],[`Georgia, serif`,`Georgia (serif)`],[`"Times New Roman", Times, serif`,`Times (serif)`],[`Arial, Helvetica, sans-serif`,`Arial / Helvetica`],[`Verdana, Geneva, sans-serif`,`Verdana`],[`"Courier New", monospace`,`Courier (mono)`]]}]})),bh=c({default:()=>Ph,init:()=>Eh,render:()=>wh});function xh(){let e=new Map;for(let t of cp())e.set(t.category,(e.get(t.category)||0)+1);return Object.keys(xp).filter(t=>e.has(t)).map(t=>[t,e.get(t)])}function Sh(){if(_p(),Nh)return;let e=document.createElement(`style`);e.id=`m5t-templates-page-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Nh=!0}function Ch(){let e=jh()||Ah();return`
      <div class="m5t-chip-row tpl-filters" id="tpl-filters" role="group" aria-label="Filter templates by category">
        ${Mh(`all`,`All`,cp().length,`true`)}
        ${xh().map(([e,t])=>Mh(e,xp[e],t,`false`)).join(``)}
      </div>

      <div class="mag-tpl-grid mag-tpl-grid--page" id="tpl-grid">
        ${cp().map(t=>fp(t,{detail:!0,gallery:!0,canUse:e})).join(``)}
      </div>`}function wh(){Sh();let e=jh();return`
    <div class="page-shell" data-section="templates">
      ...
      ${e||Ah()?``:`<div class="settings-note" id="tpl-readonly-note">
        <span class="material-symbols-outlined" aria-hidden="true">lock</span>
        Setup managed by your provider.
      </div>`}

      <div id="tpl-gallery">${Ch()}</div>
    </div>`}function Th(){let e=document.getElementById(`tpl-grid`);document.getElementById(`tpl-filters`)?.addEventListener(`click`,t=>{let n=t.target.closest(`[data-cat]`);if(!n)return;n.parentElement.querySelectorAll(`[data-cat]`).forEach(e=>{e.setAttribute(`aria-pressed`,String(e===n))});let r=n.dataset.cat;e?.querySelectorAll(`.mag-tpl-card`).forEach(e=>{e.hidden=r!==`all`&&e.dataset.cat!==r})}),e?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-preview]`);if(t){let e=cp().find(e=>e.id===t.dataset.preview);e&&Yf(()=>Uf({...e.appearance,steps:e.steps,name:e.name}));return}let n=e.target.closest(`[data-tpl]`);n&&(pp(n.dataset.tpl),window.location.hash=jh()?`#/signup`:`#/magnets`)})}function Eh(){Th();let e=cp();lp().then(t=>{let n=document.getElementById(`tpl-gallery`);!n||t===e||(n.innerHTML=Ch(),Th())})}var Dh,Oh,kh,Ah,jh,Mh,Nh,Ph,Fh=o((()=>{T(),Zf(),Op(),Dh={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Oh=e=>String(e??``).replace(/[&<>"']/g,e=>Dh[e]),kh=[`provision_magnets`,`manage_magnets`],Ah=()=>w.getCapabilities().some(e=>kh.includes(e)),jh=()=>!w.isAuthenticated(),Mh=(e,t,n,r)=>`<button class="m5t-chip--filter" type="button" data-cat="${Oh(e)}" aria-pressed="${r}">${Oh(t)}<span class="m5t-chip__count">${n}</span></button>`,Nh=!1,Ph={render:wh,init:Eh}})),Ih=c({default:()=>sg,init:()=>Hh,render:()=>Vh});function Lh(){if(Hr(),ig)return;let e=document.createElement(`style`);e.id=`m5t-questionnaires-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),ig=!0}function Rh(){return rg.clients.map(e=>{let t=rg.responses.filter(t=>t.owner_guid===e.guid),n=t[0]||null;return{guid:e.guid,name:e.caption||e.name||e.guid,latest:n,earlier:Math.max(0,t.length-1),status:n?n.status:`NOT_SENT`}})}function zh(){let e=rg.search.trim().toLowerCase();return Rh().filter(t=>(rg.filter===`ALL`||t.status===rg.filter)&&(!e||t.name.toLowerCase().includes(e)))}function Bh(e){let t=e.status===`SUBMITTED`,n=e.status===`SUBMITTED`?`<button class="qz-act" type="button" data-act="open" data-guid="${Zh(e.latest.guid)}">Read answers</button>`:e.status===`DRAFT`?`<button class="qz-act" type="button" data-act="copy" data-url="${Zh(e.latest.url||``)}">Copy link</button>`:`<a class="qz-act" href="#/clients">Go to client</a>`;return`<tr class="qz-row${t?` qz-row--open`:``}"${t?` data-open-guid="${Zh(e.latest.guid)}"`:``}>
    <td><span class="qz-client">${Zh(e.name)}</span>${e.earlier?`<span class="qz-earlier">${e.earlier} earlier</span>`:``}</td>
    <td><span class="qz-badge" data-s="${Zh(e.status)}">${Zh(ng[e.status]||e.status)}</span></td>
    <td class="qz-when">${Zh(og(e,`created_tz`))}</td>
    <td class="qz-when">${Zh(og(e,`submitted_tz`))}</td>
    <td class="qz-actcell">${n}</td>
  </tr>`}function Vh(){return Lh(),`
    <div class="page-shell" data-section="questionnaires">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="qz-body">${ag(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function Hh(){await Uh()}async function Uh(){let e=document.getElementById(`qz-body`);if(e){try{let[e,t]=await Promise.all([b(`${Qh()}/m5t/v5/acctGroup`),b(`${Qh()}/m5t/v5/m5mQuestionnaireResponse`)]),n=await e.json().catch(()=>({})),r=await t.json().catch(()=>({}));j(e,n),j(t,r),rg.clients=(n.data||[]).filter(e=>e.class===eg&&![`DELETED`,`ARCHIVED`].includes(e.status)).sort((e,t)=>String(e.caption||``).localeCompare(String(t.caption||``))),rg.responses=r.data||[]}catch(t){e.innerHTML=$a(t)?eo():ag(`error`,`Could not load questionnaires. Please try again.`);return}Gh()}}function Wh(){let e=document.getElementById(`qz-tbody`);e&&O(e,{rowSelector:`tr.qz-row`,noun:`clients`,controlHost:e.closest(`.qz-tablewrap`)||e.parentElement})}function Gh(){let e=document.getElementById(`qz-body`);if(!e)return;if(!rg.clients.length){e.innerHTML=ag(`groups`,`No clients yet. Add a client first, then send them a kickoff questionnaire.`);return}let t=Rh(),n={ALL:t.length};tg.slice(1).forEach(([e])=>{n[e]=t.filter(t=>t.status===e).length});let r=zh();e.innerHTML=`
    <div class="qz-bar">
      <div class="qz-filter">
        ${tg.map(([e,t])=>`<button data-filter="${e}" class="${rg.filter===e?`active`:``}">${Zh(t)}${n[e]?`<span class="qz-pillnum">${n[e]}</span>`:``}</button>`).join(``)}
      </div>
      <span class="qz-searchwrap">
        <span class="material-symbols-outlined" aria-hidden="true">search</span>
        <input class="qz-search" id="qz-search" type="search" placeholder="Search clients" value="${Zh(rg.search)}" aria-label="Search clients" />
      </span>
    ...
    <div class="qz-tablewrap">
      <table class="qz-table">
        ...
        <tbody id="qz-tbody">${r.length?r.map(Bh).join(``):`<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">${rg.search.trim()?`No clients match your search.`:`No clients with status “${Zh(ng[rg.filter]||rg.filter)}”.`}</div></td></tr>`}</tbody>
      </table>
    </div>`,Wh(),e.querySelector(`.qz-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(rg.filter=t.dataset.filter,Gh())}),e.querySelector(`#qz-search`)?.addEventListener(`input`,e=>{rg.search=e.target.value,Kh()}),e.querySelector(`#qz-tbody`)?.addEventListener(`click`,qh)}function Kh(){let e=document.getElementById(`qz-tbody`);if(!e)return;let t=zh();e.innerHTML=t.length?t.map(Bh).join(``):`<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">No clients match your search.</div></td></tr>`,Wh();let n=document.querySelector(`.qz-count`);n&&(n.textContent=`${t.length} of ${Rh().length}`)}function qh(e){let t=e.target.closest(`[data-act="copy"]`);if(t){e.stopPropagation();let n=t.dataset.url;if(!n){$h(`No link on this questionnaire yet.`,`warning`);return}navigator.clipboard?.writeText(n).then(()=>{t.textContent=`Copied!`,setTimeout(()=>{t.textContent=`Copy link`},1500)},()=>$h(`Could not copy the link.`,`error`));return}let n=e.target.closest(`[data-act="open"]`),r=e.target.closest(`[data-open-guid]`),i=n?.dataset.guid||r?.dataset.openGuid;i&&Jh(i)}async function Jh(e){rg.openGuid=e;let t=document.createElement(`div`);t.className=`qz-drawer-scrim`;let n=document.createElement(`aside`);n.className=`qz-drawer`,n.setAttribute(`role`,`dialog`),n.setAttribute(`aria-label`,`Questionnaire answers`),n.innerHTML=`
    ...
    <div class="qz-drawer__body" id="qz-dbody">${ag(`hourglass_empty`,`Loading answers…`)}</div>`,document.body.append(t,n),requestAnimationFrame(()=>{t.classList.add(`open`),n.classList.add(`open`)});let r=()=>{rg.openGuid=null,t.classList.remove(`open`),n.classList.remove(`open`),setTimeout(()=>{t.remove(),n.remove()},220),document.removeEventListener(`keydown`,i)};function i(e){e.key===`Escape`&&(e.preventDefault(),r())}document.addEventListener(`keydown`,i),t.addEventListener(`click`,r),n.querySelector(`.qz-drawer__close`).addEventListener(`click`,r);try{let t=await b(`${Qh()}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e)}`),r=await t.json().catch(()=>({}));if(j(t,r),!r.ok)throw Error(r.error||`load failed`);let i=r.data||{},a=rg.clients.find(e=>e.guid===i.owner_guid)?.caption||`Client`;n.querySelector(`#qz-dtitle`).textContent=a;let o=i.submitted_tz?`Submitted ${Ir(i.submitted_tz)}`:`Not yet submitted`;n.querySelector(`#qz-dsub`).textContent=i.locked_tz?`${o} · Finalized`:o,n.querySelector(`#qz-dbody`).innerHTML=Vr(i)+Rr(i,{emptyLabel:`Not answered`})}catch(e){n.querySelector(`#qz-dbody`).innerHTML=$a(e)?eo():ag(`error`,`Could not load these answers. Please try again.`)}}var Yh,Xh,Zh,Qh,$h,eg,tg,ng,rg,ig,ag,og,sg,cg=o((()=>{T(),Yh=u(f(),1),m(),Kr(),An(),x(),no(),Xh={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Zh=e=>String(e??``).replace(/[&<>"']/g,e=>Xh[e]),Qh=()=>w.getConfig?.().BASE_URL||``,$h=(e,t=`info`)=>{try{Yh.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},eg=`managed_client`,tg=[[`ALL`,`All`],[`NOT_SENT`,`Not sent`],[`DRAFT`,`Awaiting response`],[`SUBMITTED`,`Submitted`],[`CANCELLED`,`Cancelled`]],ng=Object.fromEntries(tg),rg={clients:[],responses:[],filter:`ALL`,search:``,openGuid:null},ig=!1,ag=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,og=(e,t)=>e?.latest?.[t]?Ir(e.latest[t]):`—`,sg={render:Vh,init:Hh}})),lg=c({default:()=>Wg,init:()=>hg,render:()=>mg});function ug(){if(Hr(),Bg)return;let e=document.createElement(`style`);e.id=`m5t-deliverables-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Bg=!0}function dg(){let e=G.search.trim().toLowerCase();return G.rows.filter(t=>(G.filter===`ALL`||t.status===G.filter)&&(!e||String(t.owner_name||``).toLowerCase().includes(e)))}function fg(e){return e.status===`DRAFT`?`<button class="dz-act" type="button" data-act="open" data-guid="${W(e.guid)}">Edit</button>`:e.status===`SENT`?`<button class="dz-act" type="button" data-act="copy" data-url="${W(e.url||``)}">Copy link</button>`:e.status===`SUBMITTED`?`<button class="dz-act" type="button" data-act="open" data-guid="${W(e.guid)}">Read review</button>`:`<span class="dz-when">—</span>`}function pg(e){let t=e.status!==`CANCELLED`;return`<tr class="dz-row${t?` dz-row--open`:``}"${t?` data-open-guid="${W(e.guid)}"`:``}>
    ...
    <td><span class="dz-badge" data-s="${W(e.status)}">${W(zg[e.status]||e.status)}</span></td>
    <td class="dz-when">${e.sent_tz?W(Ir(e.sent_tz)):`—`}</td>
    <td class="dz-when">${e.submitted_tz?W(Ir(e.submitted_tz)):`—`}</td>
    <td class="dz-actcell">${fg(e)}</td>
  </tr>`}function mg(){return ug(),`
    <div class="page-shell" data-section="deliverables">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="dz-body">${Vg(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function hg(){document.getElementById(`dz-new`)?.addEventListener(`click`,Sg),await gg()}async function gg(){let e=document.getElementById(`dz-body`);if(e){try{let[e,t,n]=await Promise.all([b(`${Fg()}/m5t/v5/m5mDeliverable`),b(`${Fg()}/m5t/v5/acctGroup`),b(`${Fg()}/m5t/v5/m5mDeliverable/templates`)]),r=await e.json().catch(()=>({})),i=await t.json().catch(()=>({})),a=await n.json().catch(()=>({}));j(e,r),G.rows=r.data||[],G.clientsErr=t.ok?null:t.status===403?`denied`:`broken`,G.clients=t.ok?(i.data||[]).filter(e=>e.class===Lg&&![`DELETED`,`ARCHIVED`].includes(e.status)).sort((e,t)=>String(e.caption||``).localeCompare(String(t.caption||``))):null,G.templatesErr=n.ok?null:n.status===403?`denied`:`broken`,G.templates=n.ok?a.data||[]:null}catch(t){e.innerHTML=$a(t)?eo():Vg(`error`,`Could not load deliverables. Please try again.`);return}vg()}}function _g(){let e=document.getElementById(`dz-tbody`);e&&O(e,{rowSelector:`tr.dz-row`,noun:`deliverables`,controlHost:e.closest(`.dz-tablewrap`)||e.parentElement})}function vg(){let e=document.getElementById(`dz-body`);if(!e)return;if(G.clients?.length===0&&!G.rows.length){e.innerHTML=Vg(`groups`,`No clients yet. Add a client first, then author their first deliverable.`);return}if(!G.rows.length){e.innerHTML=Vg(`approval`,`No deliverables yet. Author the first one with New deliverable.`);return}let t={ALL:G.rows.length};Rg.slice(1).forEach(([e])=>{t[e]=G.rows.filter(t=>t.status===e).length});let n=dg();e.innerHTML=`
    <div class="dz-bar">
      <div class="dz-filter">
        ${Rg.map(([e,n])=>`<button data-filter="${e}" class="${G.filter===e?`active`:``}">${W(n)}${t[e]?`<span class="dz-pillnum">${t[e]}</span>`:``}</button>`).join(``)}
      </div>
    ...
    <div class="dz-tablewrap">
      <table class="dz-table">
        ...
        <tbody id="dz-tbody">${n.length?n.map(pg).join(``):`<tr><td colspan="6"><div class="dz-when" style="padding:14px 4px">${G.search.trim()?`No deliverables match your search.`:`No deliverables with status “${W(zg[G.filter]||G.filter)}”.`}</div></td></tr>`}</tbody>
      </table>
    </div>`,_g(),e.querySelector(`.dz-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(G.filter=t.dataset.filter,vg())}),e.querySelector(`#dz-search`)?.addEventListener(`input`,e=>{G.search=e.target.value,yg()}),e.querySelector(`#dz-tbody`)?.addEventListener(`click`,bg)}function yg(){let e=document.getElementById(`dz-tbody`);if(!e)return;let t=dg();e.innerHTML=t.length?t.map(pg).join(``):`<tr><td colspan="6"><div class="dz-when" style="padding:14px 4px">No deliverables match your search.</div></td></tr>`,_g();let n=document.querySelector(`.dz-count`);n&&(n.textContent=`${t.length} of ${G.rows.length}`)}function bg(e){let t=e.target.closest(`[data-act="copy"]`);if(t){e.stopPropagation();let n=t.dataset.url;if(!n){Ig(`No link on this deliverable yet.`,`warning`);return}navigator.clipboard?.writeText(n).then(()=>{t.textContent=`Copied!`,setTimeout(()=>{t.textContent=`Copy link`},1500)},()=>Ig(`Could not copy the link.`,`error`));return}let n=e.target.closest(`[data-act="open"]`),r=e.target.closest(`[data-open-guid]`),i=n?.dataset.guid||r?.dataset.openGuid;i&&Mg(i)}function xg(e){let t=document.createElement(`div`);t.className=`dz-drawer-scrim`;let n=document.createElement(`aside`);n.className=`dz-drawer`,n.setAttribute(`role`,`dialog`),n.setAttribute(`aria-label`,e),n.innerHTML=`
    ...
    <div class="dz-drawer__body" id="dz-dbody">${Vg(`hourglass_empty`,`Loading…`)}</div>
    <div class="dz-drawer__foot" id="dz-dfoot"></div>`,document.body.append(t,n),requestAnimationFrame(()=>{t.classList.add(`open`),n.classList.add(`open`)});let r=()=>{t.classList.remove(`open`),n.classList.remove(`open`),setTimeout(()=>{t.remove(),n.remove()},220),document.removeEventListener(`keydown`,i)};function i(e){e.key===`Escape`&&(e.preventDefault(),r())}return document.addEventListener(`keydown`,i),t.addEventListener(`click`,r),n.querySelector(`.dz-drawer__close`).addEventListener(`click`,r),{drawer:n,close:r}}function Sg(){if(G.clients===null){Ig(G.clientsErr===`denied`?`You do not have access to the client list, so a deliverable cannot be started here.`:`The client list could not be loaded. Refresh and try again.`,G.clientsErr===`denied`?`warning`:`error`);return}if(!G.clients.length){Ig(`Add a client first.`,`warning`);return}if(G.templates===null){Ig(G.templatesErr===`denied`?`You do not have access to deliverable templates.`:`Deliverable templates could not be loaded. Refresh and try again.`,G.templatesErr===`denied`?`warning`:`error`);return}if(!G.templates.length){Ig(`No deliverable templates are configured.`,`error`);return}let{drawer:e,close:t}=xg(`New deliverable`);e.querySelector(`#dz-dbody`).innerHTML=`
    <div class="dz-field">
    ...
    <div class="qm-qa" data-question-id="${W(e.id)}" data-question-type="${W(e.type)}">
      ...
      <div class="qm-qa__a">${zr(e,t)}</div>
    </div>`}function wg(e,t,n,{hidden:r=!1}={}){let i=`${t}: `,a=e[0]?.group||``;return`
      <div class="dz-cblock" data-group="${W(a)}" data-heading="${W(t)}"${r?` hidden`:``}>
        <h4 class="dz-cblock__title">${W(t)}</h4>
        ${e.map(e=>Cg(e,n,e.label.startsWith(i)?e.label.slice(i.length):e.label)).join(``)}
      </div>`}function Tg(e,t){let n=(e.questions||[]).filter(e=>e.audience===`am`),r=n.filter(e=>!e.group).map(e=>Cg(e,t)).join(``),i=di(e);if(i){let n=fi(e).filter(e=>e.audience===`am`);if(!n.length)return r;let a=hi(e,t);for(let e=1;e<=a;e++){let a=pi(n,i,e);r+=wg(a,Ug(a,`${i}${e}`),t)}let o=Ug(pi(n,i,a+1),`${i}${a+1}`);return r+=`<button class="dz-btn--ghost dz-addblock" type="button" data-repeat="${W(i)}" data-section-id="${W(e.id)}">+ Add ${W(o)}</button>`,r}let a=[...new Set(n.filter(e=>e.group).map(e=>e.group))];if(!a.length)return r;let o=null;return r+=a.map((e,r)=>{let i=n.filter(t=>t.group===e),a=Ug(i,e),s=r===0||Hg(i,t);return!s&&o===null&&(o={key:e,heading:a}),wg(i,a,t,{hidden:!s})}).join(``),r+=`<button class="dz-btn--ghost dz-addblock" type="button"${o?``:` hidden`}>${o?`+ Add ${W(o.heading)}`:``}</button>`,r}function Eg(e,t){let n=(e?.sections||[]).filter(e=>(e.questions||[]).some(e=>e.audience===`am`)),r=n.length>1;return`
    ${r?`
    ...
    ${r?`
      ...
      </div>`:``}`}function Dg(e,t,n){e.querySelectorAll(`.dz-addblock`).forEach(e=>{e.addEventListener(`click`,()=>{let n=e.parentElement;if(e.dataset.repeat){let r=fi((t?.sections||[]).find(t=>t.id===e.dataset.sectionId)).filter(e=>e.audience===`am`);if(!r.length)return;let i=e.dataset.repeat,a=n.querySelectorAll(`.dz-cblock`).length+1,o=pi(r,i,a);e.insertAdjacentHTML(`beforebegin`,wg(o,Ug(o,`${i}${a}`),{}));let s=pi(r,i,a+1);e.textContent=`+ Add ${Ug(s,`${i}${a+1}`)}`;return}let r=[...n.querySelectorAll(`.dz-cblock[hidden]`)],i=r[0];i&&(i.hidden=!1);let a=r[1];a?e.textContent=`+ Add ${a.dataset.heading}`:e.hidden=!0})});let r=[...e.querySelectorAll(`.dz-step`)];if(r.length<=1)return;let i=[...e.querySelectorAll(`.dz-dot`)],a=e.querySelector(`#dz-step-label`),o=e.querySelector(`#dz-step-back`),s=e.querySelector(`#dz-step-next`),c=e.querySelector(`#dz-step-prev`),l=e.querySelector(`#dz-step-fwd`),u=0,d=t=>{u=Math.max(0,Math.min(r.length-1,t)),r.forEach((e,t)=>{e.hidden=t!==u}),i.forEach((e,t)=>{t===u?e.setAttribute(`aria-current`,`step`):e.removeAttribute(`aria-current`)}),a&&(a.textContent=`Step ${u+1} of ${r.length} · ${r[u].querySelector(`h3`)?.textContent||``}`),o.style.visibility=u===0?`hidden`:``,s.style.visibility=u===r.length-1?`hidden`:``,c&&(c.disabled=u===0),l&&(l.disabled=u===r.length-1),e.scrollIntoView?.({block:`start`})},f=e=>{d(e),n?.()};o.addEventListener(`click`,()=>f(u-1)),s.addEventListener(`click`,()=>f(u+1)),c?.addEventListener(`click`,()=>f(u-1)),l?.addEventListener(`click`,()=>f(u+1)),i.forEach(e=>e.addEventListener(`click`,()=>f(Number(e.dataset.step)||0))),d(0)}function Og(e,t,n){return gi(e?.sections||[],t,n).map(e=>{let r=(e.questions||[]).filter(e=>{if(e.audience!==`am`)return!0;let n=t?.[e.id];return Array.isArray(n)?n.length>0:!!(n&&String(n).trim())});return r.length?`
      <div class="qm-section">
        <h3>${W(e.title)}</h3>
        ${r.map(e=>`
          <div class="qm-qa">
            <div class="qm-qa__q">${W(e.label)}</div>
            <div class="qm-qa__a">${e.audience===`am`?Lr(e,t):Lr(e,n)||`<span class="qm-qa__a--empty">Left blank</span>`}</div>
          </div>`).join(``)}
      </div>`:``}).join(``)}function kg(e,t){if(!t)return``;let n=(e?.sections||[]).flatMap(e=>(e.questions||[]).filter(e=>e.audience!==`am`)).map(e=>({q:e,val:Lr(e,t.answers||{})})).filter(({val:e})=>e);return`
    <div class="dz-feedback">
      <p class="dz-feedback__title">Round ${W(t.round)} feedback${t.submitted_tz?` · returned ${W(Ir(t.submitted_tz))}`:``}</p>
      ${n.length?n.map(({q:e,val:t})=>`
        <div class="qm-qa">
          <div class="qm-qa__q">${W(e.label)}</div>
          <div class="qm-qa__a">${t}</div>
        </div>`).join(``):`<div class="qm-qa__a qm-qa__a--empty">Returned without feedback.</div>`}
    </div>`}function Ag(e,t){let n=Array.isArray(t)&&t.length?t[t.length-1]:null;return n?kg(e,n):``}function jg(e,t){return(Array.isArray(t)?t.slice().reverse():[]).map(t=>kg(e,t)).join(``)}async function Mg(e){let{drawer:t,close:n}=xg(`Deliverable`),r=t.querySelector(`#dz-dbody`),i=t.querySelector(`#dz-dfoot`),a;try{let t=await b(`${Fg()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}`),n=await t.json().catch(()=>({}));if(j(t,n),!n.ok)throw Error(n.error||`load failed`);a=n.data||{}}catch(e){r.innerHTML=$a(e)?eo():Vg(`error`,`Could not load this deliverable. Please try again.`);return}let o=G.rows.find(t=>t.guid===e)?.owner_name||G.clients?.find(e=>e.guid===a.owner_guid)?.caption||`Client`;t.querySelector(`#dz-dtitle`).textContent=`${o} · ${a.template?.name||`Deliverable`}`;let s=a.status===`DRAFT`||a.status===`SENT`,c=Number(a.revision)>1?` · Rev ${a.revision}`:``,l=a.status===`SUBMITTED`?`Returned ${a.submitted_tz?Ir(a.submitted_tz):``}${a.locked_tz?` · Finalized`:``}${c}`:a.status===`SENT`?`Sent ${a.sent_tz?Ir(a.sent_tz):``} to ${a.recipient_email||``} · awaiting approval${c}`:`${zg[a.status]||a.status}${c}`;if(t.querySelector(`#dz-dsub`).textContent=l,!s){r.innerHTML=Vr(a)+Og(a.template,a.content||{},a.answers||{})+jg(a.template,a.rounds),a.status===`SUBMITTED`&&!a.locked_tz?(i.innerHTML=`<button class="dz-btn" type="button" id="dz-revise">Revise plan</button>
        <span class="dz-note" style="margin:0">Archives this review and reopens authoring. The client approves the revised plan on a fresh link.</span>`,i.querySelector(`#dz-revise`).addEventListener(`click`,async t=>{let r=t.target;r.disabled=!0;try{let t=await b(`${Fg()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}/revise`,{method:`POST`}),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`revise failed`);Ig(`Reopened for revision. The last review is pinned above the form.`,`success`),n(),await gg(),Mg(e)}catch(e){Ig(e.message||`Could not revise.`,`error`),r.disabled=!1}})):i.innerHTML=``;return}r.innerHTML=`
    ${Ag(a.template,a.rounds)}
    ${a.url?`
    ...
    <div id="dz-author-form">${Eg(a.template,a.content||{})}</div>`,i.innerHTML=`
    ...
    <button class="dz-btn--ghost dz-btn--danger" type="button" id="dz-cancel">Cancel deliverable</button>`,r.querySelector(`#dz-copylink`)?.addEventListener(`click`,e=>{let t=r.querySelector(`.dz-linkrow input`);navigator.clipboard?.writeText(t?.value||``).then(()=>{e.target.textContent=`Copied!`,setTimeout(()=>{e.target.textContent=`Copy link`},1500)},()=>Ig(`Could not copy the link.`,`error`))});let u=async()=>{let t=Br(r.querySelector(`#dz-author-form`)),i=await b(`${Fg()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({content:t})}),a=await i.json().catch(()=>({}));if(!i.ok||!a.ok){if(i.status===409)return Ig(a.error||`This deliverable is no longer editable.`,`warning`),n(),await gg(),!1;throw Error(a.error||`save failed`)}return!0};Dg(r.querySelector(`#dz-author-form`),a.template,()=>{u().catch(()=>Ig(`Autosave failed. Use Save draft.`,`warning`))}),i.querySelector(`#dz-preview`).addEventListener(`click`,async e=>{let t=e.target.closest(`button`);if(!a.url){Ig(`No link available for this deliverable.`,`warning`);return}t.disabled=!0;try{await u()&&window.open(a.url,`_blank`)}catch(e){Ig(e.message||`Could not save before previewing.`,`error`)}t.disabled=!1}),i.querySelector(`#dz-save`).addEventListener(`click`,async e=>{let t=e.target;t.disabled=!0;try{await u()&&Ig(`Draft saved.`,`success`)}catch(e){Ig(e.message||`Could not save.`,`error`)}t.disabled=!1}),i.querySelector(`#dz-send`).addEventListener(`click`,async t=>{let r=t.target,a=(i.querySelector(`#dz-email`)?.value||``).trim();if(!a){Ig(`Enter the recipient email first.`,`warning`);return}r.disabled=!0;try{if(!await u())return;let t=await b(`${Fg()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}/send`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({recipient_email:a})}),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`send failed`);Ig(r.data?.emailQueued?`Sent. ${a} will receive the review link.`:`Link created, but the email could not be queued. Copy the link and send it yourself.`,r.data?.emailQueued?`success`:`warning`),n(),await gg()}catch(e){Ig(e.message||`Could not send.`,`error`),r.disabled=!1}}),i.querySelector(`#dz-cancel`).addEventListener(`click`,async t=>{let r=t.target;r.disabled=!0;try{let t=await b(`${Fg()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}/cancel`,{method:`POST`}),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`cancel failed`);Ig(`Deliverable cancelled. Its link no longer works.`,`info`),n(),await gg()}catch(e){Ig(e.message||`Could not cancel.`,`error`),r.disabled=!1}})}var Ng,Pg,W,Fg,Ig,Lg,Rg,zg,G,Bg,Vg,Hg,Ug,Wg,Gg=o((()=>{T(),Ng=u(f(),1),m(),Kr(),yi(),An(),x(),no(),Pg={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},W=e=>String(e??``).replace(/[&<>"']/g,e=>Pg[e]),Fg=()=>w.getConfig?.().BASE_URL||``,Ig=(e,t=`info`)=>{try{Ng.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Lg=`managed_client`,Rg=[[`ALL`,`All`],[`DRAFT`,`In progress`],[`SENT`,`Awaiting approval`],[`SUBMITTED`,`Returned`],[`CANCELLED`,`Cancelled`]],zg=Object.fromEntries(Rg),G={rows:[],clients:null,templates:null,clientsErr:null,templatesErr:null,filter:`ALL`,search:``},Bg=!1,Vg=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Hg=(e,t)=>e.some(e=>{let n=t?.[e.id];return Array.isArray(n)?n.length>0:!!(n&&String(n).trim())}),Ug=(e,t)=>{let n=String(e[0]?.label||``).match(/^(.+?):\s/);return n?n[1]:t.toUpperCase()},Wg={render:mg,init:hg}})),Kg=c({default:()=>i_,init:()=>Qg,render:()=>Zg});function qg(e){return e.status===`SENT`?{key:`PENDING`,label:`Pending your review`}:e.status===`SUBMITTED`&&e.signed?{key:`APPROVED`,label:`Approved`}:e.status===`SUBMITTED`?{key:`RETURNED`,label:`Returned with edits`}:null}function Jg(){if(Hr(),n_)return;let e=document.createElement(`style`);e.id=`m5t-deliverables-client-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),n_=!0}function Yg(e,t){return!e.url&&t.key===`PENDING`?``:t.key===`PENDING`?`<button class="dc-act" type="button" data-url="${e_(e.url)}">Review</button>`:t.key!==`APPROVED`&&e.url&&e.editability?.editable?`<button class="dc-act" type="button" data-url="${e_(e.url)}">Update your review</button>`:``}function Xg(e){let t=qg(e);return`<tr>
    <td><span class="dc-name">${e_(e.template_name||e.kind||`Deliverable`)}</span>${Number(e.revision)>1?`<span class="dc-when" style="margin-left:6px">Rev ${e_(e.revision)}</span>`:``}</td>
    <td><span class="dc-badge" data-s="${e_(t.key)}">${e_(t.label)}</span></td>
    <td class="dc-when">${e.sent_tz?e_(Ir(e.sent_tz)):`—`}</td>
    <td class="dc-when">${e.submitted_tz?e_(Ir(e.submitted_tz)):`—`}</td>
    <td class="dc-actcell">${Yg(e,t)}</td>
  </tr>`}function Zg(){return Jg(),`
    <div class="page-shell" data-section="deliverables-client">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="dc-body">${r_(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function Qg(){let e=document.getElementById(`dc-body`);if(!e)return;let t;try{let e=await b(`${t_()}/m5t/v5/m5mDeliverable`),n=await e.json().catch(()=>({}));if(j(e,n),!n.ok)throw Error(`load failed`);t=(n.data||[]).filter(e=>qg(e))}catch(t){e.innerHTML=$a(t)?eo():r_(`error`,`Could not load your deliverables. Please try again.`);return}if(!t.length){e.innerHTML=r_(`approval`,`Nothing to review right now.`);return}e.innerHTML=`
    <div class="dc-tablewrap">
      <table class="dc-table">
        <thead><tr><th>Deliverable</th><th>Status</th><th>Received</th><th>Returned</th><th></th></tr></thead>
        <tbody id="dc-tbody">${t.map(Xg).join(``)}</tbody>
      </table>
    </div>`,e.querySelector(`#dc-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-url]`);t?.dataset.url&&window.open(t.dataset.url,`_blank`)})}var $g,e_,t_,n_,r_,i_,a_=o((()=>{T(),Kr(),x(),no(),$g={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},e_=e=>String(e??``).replace(/[&<>"']/g,e=>$g[e]),t_=()=>w.getConfig?.().BASE_URL||``,n_=!1,r_=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,i_={render:Zg,init:Qg}})),o_=c({init:()=>x_,render:()=>b_});function s_(e){let t=Y_(e);if(!t)return``;try{return new Date(t).toLocaleDateString([],{month:`short`,day:`numeric`,year:`numeric`})}catch{return``}}function c_(e){let t=Y_(e);if(!t)return``;try{let n=Date.now()-new Date(t).getTime();if(n<0)return s_(e);let r=n/36e5;return r<1?`${Math.max(1,Math.floor(n/6e4))}m ago`:r<24?`${Math.floor(r)}h ago`:r<48?`Yesterday`:s_(e)}catch{return s_(e)}}function l_(){if(L_)return;let e=document.createElement(`style`);e.id=`m5t-leads-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),L_=!0}function u_(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function d_(e){return`<select class="leads-status" data-id="${q(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${z_.map(t=>`<option value="${t}" ${e.status===t?`selected`:``}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join(``)}
  </select>`}function f_(e){let t=K_(e),n=e.phone?String(e.phone).replace(/[^\d+]/g,``):``;return`
    <tr class="leads-row${String(e.id)===K.selectedId?` selected`:``}" data-id="${q(e.id)}" tabindex="0" role="button" aria-label="Open lead ${q(U_(e))}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${J_(e)}</span>
          <span><span class="leads-name">${q(U_(e))}</span>${e.company?`<span class="leads-sub">${q(e.company)}</span>`:``}</span>
        </span>
      </td>
      ${K.book?`<td>${Za(K.ownerNames[e.owner_guid]||``)||`<span class="leads-muted">—</span>`}</td>`:``}
      <td>
      ...
      <td>${K.canManage?d_(e):`<span class="leads-badge" data-s="${q(e.status)}">${q(e.status)}</span>`}</td>
      <td class="num leads-muted" style="white-space:nowrap" title="${q(s_(e))}">${X_(e)?`<span class="leads-fresh" title="Captured in the last 24 hours"></span>`:``}${q(c_(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}function p_(e){let t=K.search.trim().toLowerCase();if(!t)return!0;let n=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,K.magnetNames[e.magnet_guid],K.book?K.ownerNames[e.owner_guid]:``,e.utm_campaign,e.utm_source].filter(Boolean).join(` `).toLowerCase();return t.split(/\s+/).every(e=>n.includes(e))}function m_(e){let t=tv[K.range];if(!t)return!0;let n=Y_(e);if(!n)return!1;let r=new Date(Date.now()-(t-1)*864e5).toISOString().slice(0,10);return n.slice(0,10)>=r}function h_(){return K.leads.filter(e=>(K.filter===`ALL`||e.status===K.filter)&&Z_(e)&&$_(e)&&ev(e)&&p_(e)&&Q_(e)&&m_(e))}function g_(){let e=h_(),t=rv[K.sort.key];if(!t)return e;let n=K.sort.dir===`asc`?1:-1;return e.slice().sort((e,r)=>{let i=t.value(e),a=t.value(r);return i===``&&a===``?0:i===``?1:a===``?-1:i===a?0:i<a?-n:n})}function __(e,t=``){let n=rv[e],r=K.sort.key===e,i=r?K.sort.dir:``;return`<th class="leads-th--sort${t?` ${t}`:``}${r?` is-sorted`:``}"
    ...
    </th>`}function v_(e){return rv[e]?(K.sort.key===e?K.sort.dir=K.sort.dir===`asc`?`desc`:`asc`:K.sort={key:e,dir:rv[e].dir},K.shown=R_(),!0):!1}function y_(){if(!K.day)return``;let e=K.day;try{e=new Date(`${K.day}T00:00:00Z`).toLocaleDateString([],{month:`short`,day:`numeric`,year:`numeric`,timeZone:`UTC`})}catch{}return`<button class="leads-daychip" type="button" id="leads-dayclear" title="Show every day again">
  ...
  </button>`}function b_(){l_(),La();let e=A();return`
    <div class="page-shell" data-section="leads">
      ...
      <div class="dashboard-card" style="margin-bottom:24px">
        ...
        <div class="card-body" id="pf-picker-body">${u_(`hourglass_empty`,`Loading…`)}</div>
      </div>`:``}
      <div class="page-header">
        <div class="page-header-text">
          <h1 class="page-title">Leads</h1>
          <p class="page-description">${e?`All leads across your clients.`:`All your leads.`}</p>
      ...
      <div class="leads-layout">
        <div class="dashboard-card">
          <div class="card-body" id="leads-body">
            ${u_(`hourglass_empty`,`Loading leads…`)}
          </div>
        </div>
        <aside class="dashboard-card leads-panel" aria-label="Lead detail">
          <div class="card-body" id="leads-panel-body">${iv()}</div>
        </aside>
      </div>
    </div>`}async function x_(){document.getElementById(`leads-export`)?.addEventListener(`click`,F_),lr(`csv_export`).then(e=>{e||document.getElementById(`leads-export`)?.remove()}).catch(()=>{});let e=io(oo.LEADS_SEARCH),t=io(oo.LEADS_DAY);if((e||t)&&(K.search=e||``,K.day=t||``,K.filter=`ALL`,K.clientFilter=`ALL`,K.magnetFilter=`ALL`,K.sourceFilter=`ALL`,K.range=`ALL`,K.shown=R_()),A()){let e=e=>Number(e||0).toLocaleString();Wa(H_(),[{h:`Leads · wk`,td:t=>e(t.leads.this_week)},{h:`Leads · total`,td:t=>e(t.leads.total)},{h:`Compl.`,td:e=>e.completion_rate==null?`—`:`${e.completion_rate}%`}],{emptyMsg:`No client orgs yet. Create one under Clients first.`})}await C_(),S_()}async function S_(){let e=document.getElementById(`leads-crm-slot`);if(e)try{let{denied:t,providers:n,configured:r}=await nl();if(t)return;let i=av.map(e=>{let t=Gc[e],i=$c(n,e);return{p:t,conn:i,status:el(t,i,!!r?.[e])}}),a=i.filter(e=>e.status===`connected`),o=i.find(e=>e.status===`broken`);if(a.length){let t=a.map(e=>e.p.label).join(` and `),n=a.length===1&&a[0].conn?.external_account?.hub_domain||``;e.innerHTML=`
        ...
        <a class="leads-crm-chip ghost" href="#/settings/integrations">
          ...
          Connect a CRM
        </a>`)}catch{}}async function C_(){let e=document.getElementById(`leads-body`);if(e){try{let[e,t]=await Promise.all([b(`${H_()}/m5t/v5/m5mLead`),b(`${H_()}/m5t/v5/magnets`).catch(()=>null)]),n=await e.json().catch(()=>({}));if(j(e,n),!n.ok)throw Error(n.message||`Failed to load`);if(K.leads=(n.data||[]).filter(e=>![`DELETED`,`ARCHIVED`].includes(e.status)),K.total=Number.isFinite(n.total)?n.total:K.leads.length,K.truncated=K.total>(n.data||[]).length,K.book=A(),K.ownerNames=K.book?Ga():{},t){let e=await t.json().catch(()=>({}));K.magnetNames={},(e.magnets||[]).forEach(e=>{K.magnetNames[e.guid]=e.name,e.owner_guid&&e.owner_name&&!K.ownerNames[e.owner_guid]&&(K.ownerNames[e.owner_guid]=e.owner_name)}),K.canManage=!!e.canManage}}catch(t){e.innerHTML=$a(t)?eo():u_(`error`,`Could not load your leads. Please try again.`);return}w_()}}function w_(){let e=document.getElementById(`leads-body`),t=document.getElementById(`leads-export`);if(!e)return;if(t&&(t.style.display=K.leads.length?``:`none`),!K.leads.length){e.innerHTML=u_(`inbox`,`No leads yet. Install a magnet on your site and leads land here the moment visitors respond.`),N_();return}let n=K.leads.filter(e=>Z_(e)&&$_(e)&&ev(e)&&m_(e)),r={ALL:n.length};z_.forEach(e=>{r[e]=n.filter(t=>t.status===e).length});let i=[...new Set(K.leads.map(e=>e.magnet_guid).filter(Boolean))].map(e=>({guid:e,name:K.magnetNames[e]||`(unnamed magnet)`})).sort((e,t)=>e.name.localeCompare(t.name)),a=K.leads.some(e=>e.lead_source===`Magnet`),o=[...new Set(K.leads.map(e=>e.lead_source).filter(e=>e&&e!==`Magnet`))].sort((e,t)=>(G_[e]||e).localeCompare(G_[t]||t)),s=+!!a+o.length,c=K.book?[...new Set(K.leads.map(e=>e.owner_guid).filter(Boolean))].map(e=>({guid:e,name:K.ownerNames[e]||e})).sort((e,t)=>e.name.localeCompare(t.name)):[];e.innerHTML=`
    <div class="leads-bar">
      <div class="leads-filter">
        ${[`ALL`,...z_].map(e=>`<button data-filter="${e}" class="${K.filter===e?`active`:``}">${e===`ALL`?`All`:e[0]+e.slice(1).toLowerCase()}${r[e]?`<span class="leads-pillnum">${r[e]}</span>`:``}</button>`).join(``)}
      </div>
      ${K.book&&c.length>1?`
      <select class="leads-clientsel" id="leads-clientsel" aria-label="Filter by client">
        <option value="ALL">All clients</option>
        ${c.map(e=>`<option value="${q(e.guid)}" ${K.clientFilter===e.guid?`selected`:``}>${q(e.name)}</option>`).join(``)}
      </select>`:``}
      ${i.length>1?`
      ...
      ${s>1?`
      <select class="leads-clientsel" id="leads-sourcesel" aria-label="Filter by source">
        <option value="ALL">All sources</option>
        ${a?`<option value="MAGNET" ${K.sourceFilter===`MAGNET`?`selected`:``}>Magnets</option>`:``}
        ${o.map(e=>`<option value="${q(e)}" ${K.sourceFilter===e?`selected`:``}>${q(G_[e]||e)}</option>`).join(``)}
      </select>`:``}
      <select class="leads-clientsel" id="leads-rangesel" aria-label="Filter by date captured">
        ${Object.keys(tv).map(e=>`<option value="${e}" ${K.range===e?`selected`:``}>${q(nv[e])}</option>`).join(``)}
      </select>
      ${y_()}
    ...
    <div id="leads-tablezone"></div>`,e.querySelector(`.leads-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(K.filter=t.dataset.filter,K.shown=R_(),w_())}),e.querySelector(`#leads-clientsel`)?.addEventListener(`change`,e=>{K.clientFilter=e.target.value,K.shown=R_(),w_()}),e.querySelector(`#leads-magnetsel`)?.addEventListener(`change`,e=>{K.magnetFilter=e.target.value,K.shown=R_(),w_()}),e.querySelector(`#leads-sourcesel`)?.addEventListener(`change`,e=>{K.sourceFilter=e.target.value,K.shown=R_(),w_()}),e.querySelector(`#leads-rangesel`)?.addEventListener(`change`,e=>{K.range=e.target.value,K.day=``,K.shown=R_(),w_()}),e.querySelector(`#leads-dayclear`)?.addEventListener(`click`,()=>{K.day=``,K.shown=R_(),w_()}),e.querySelector(`#leads-search`)?.addEventListener(`input`,e=>{K.search=e.target.value,K.shown=R_(),T_()}),T_()}function T_(){let e=document.getElementById(`leads-tablezone`),t=document.getElementById(`leads-countlbl`);if(!e)return;let n=g_(),r=n.slice(0,K.shown),i=K.book?8:7;t&&(t.textContent=`${n.length} of ${K.leads.length}`),e.innerHTML=`
    <div class="leads-tablewrap">
      <table class="leads-table${K.book?` leads-table--book`:``}">
        ${ov()}
        <thead><tr>${__(`name`)}${K.book?`<th>Client</th>`:``}${__(`contact`)}<th>Interest</th><th>Source</th><th>Status</th>${__(`captured`,`num`)}<th></th></tr></thead>
        <tbody id="leads-tbody">${r.map(f_).join(``)||`<tr><td colspan="${i}"><div class="leads-muted" style="padding:14px 4px">${K.search.trim()?`No leads match your search.`:`No ${K.filter.toLowerCase()} leads.`}</div></td></tr>`}</tbody>
      </table>
    </div>
    ${wn({total:n.length,shown:K.shown,size:K.pageSize,noun:`leads`})}
    ${K.truncated?`<div class="leads-muted" style="padding:10px 4px">Showing your ${K.leads.length.toLocaleString()} most recent leads of ${K.total.toLocaleString()}. Search and filters cover these; older leads aren't included yet.</div>`:``}`,e.querySelector(`thead`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-sort]`);t&&v_(t.dataset.sort)&&T_()}),Tn(e,{total:n.length,onSize:(e,t)=>{K.pageSize=t,K.shown=e,T_()}}),e.querySelector(`#leads-tbody`)?.addEventListener(`change`,E_),e.querySelector(`#leads-tbody`)?.addEventListener(`click`,e=>{if(e.target.closest(`.leads-status, a.leads-contactlink`))return;let t=e.target.closest(`.leads-row`);t&&D_(t.dataset.id)}),e.querySelector(`#leads-tbody`)?.addEventListener(`keydown`,e=>{if(e.key!==`Enter`&&e.key!==` `)return;let t=e.target.closest(`.leads-row`);t&&e.target===t&&(e.preventDefault(),D_(t.dataset.id))})}async function E_(e){let t=e.target.closest(`.leads-status`);if(!t)return;let n=t.dataset.id,r=K.leads.find(e=>String(e.id)===String(n)),i=t.value,a=r?.status;try{if(!(await(await b(`${H_()}/m5t/v5/m5mLead/${encodeURIComponent(n)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:i})})).json().catch(()=>({}))).ok)throw Error();r&&(r.status=i),V_(`Marked ${i[0]}${i.slice(1).toLowerCase()}`,`success`)}catch{t.value=a||`NEW`,V_(`Could not update status`,`danger`);return}try{String(n)===K.selectedId&&N_(),K.filter!==`ALL`&&w_()}catch(e){console.warn(`[leads] re-render after status change failed:`,e)}}function D_(e){K.selectedId=String(e),document.querySelectorAll(`.leads-row`).forEach(e=>e.classList.toggle(`selected`,e.dataset.id===K.selectedId)),N_()}function O_(e,t){let n=Array.isArray(e.tags)?e.tags:[];for(let e=n.length-1;e>=0;e--)if(n[e]&&n[e].tag===t&&n[e].value!=null)return String(n[e].value);return``}function k_(e){let t=O_(e,`appointment_start`);if(!t)return null;let n=O_(e,`appointment_status`)||`booked`,r=O_(e,`appointment_timezone`),i=O_(e,`appointment_event_type`),a=new Date(t),o=t;if(!Number.isNaN(a.getTime())){let e={weekday:`short`,month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`};try{o=new Intl.DateTimeFormat(void 0,r?{...e,timeZone:r}:e).format(a)}catch{o=new Intl.DateTimeFormat(void 0,e).format(a)}}return{when:o,status:n,type:i,start:t}}function A_(e){let t=Array.isArray(e.tags)?e.tags:[],n=null;for(let e of t)if(!(!e||!e.tag)){if(e.tag===`callrail_call_id`){n={};continue}n&&e.tag.indexOf(`call_`)===0&&e.value!=null&&(n[e.tag]=String(e.value))}if(!n||!n.call_started)return null;let r=n.call_started,i=new Date(r),a=r;Number.isNaN(i.getTime())||(a=new Intl.DateTimeFormat(void 0,{weekday:`short`,month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`}).format(i));let o=Number(n.call_duration)||0,s=o?o<60?`${o}s`:`${Math.floor(o/60)}m ${o%60}s`:``;return{when:a,dur:s,source:n.call_source||``,answered:n.call_answered||``,recording:n.call_recording_player||``,started:r}}function j_(e){let t=Array.isArray(e.tags)?e.tags:[],n=e=>{for(let n=t.length-1;n>=0;n--)if(t[n]&&t[n].tag===e&&t[n].value!=null)return String(t[n].value);return``};if(!n(`lsa_lead_id`))return null;let r=n(`lsa_dispute_candidate`);return{type:n(`lsa_lead_type`),category:n(`lsa_category`),status:n(`lsa_status`).toLowerCase(),charged:n(`lsa_charged`)===`yes`,email:n(`lsa_email`),missed:n(`lsa_missed`)===`yes`,dispute:r&&r!==`no`?r:``}}function M_(e){let t=Array.isArray(e.tags)?e.tags:[],n=e=>{for(let n=t.length-1;n>=0;n--)if(t[n]&&t[n].tag===e&&t[n].value!=null)return String(t[n].value);return``};return n(`ad_call_id`)?{missed:n(`ad_call_status`)===`missed`,dur:n(`ad_call_duration`),area:n(`ad_call_area_code`),campaign:n(`ad_call_campaign`)}:null}function N_(){let e=document.getElementById(`leads-panel-body`);if(!e)return;let t=K.leads.find(e=>String(e.id)===K.selectedId),n=document.querySelector(`.leads-layout`);if(n&&(n.dataset.hasSelection=t?`true`:`false`),!t){e.innerHTML=iv();return}let r=k_(t),[i,a]=r?sv[r.status]||sv.booked:[``,``],o=A_(t),s=j_(t),c=M_(t),l=(e,t)=>t?`<div class="leads-det__field"><span class="leads-det__k">${q(e)}</span><span class="leads-det__v">${q(t)}</span></div>`:``;e.innerHTML=`
    <div class="leads-det__head">
      <span class="leads-avatar leads-det__ava">${J_(t)}</span>
      <div>
        <div class="leads-det__name">${q(U_(t))}</div>
    ...
    ${l(`Source`,K_(t))}
    ${l(`Captured`,s_(t))}
    ${r?`<div class="leads-det__field"><span class="leads-det__k">Appointment</span><span class="leads-det__v">${q([r.when,r.type].filter(Boolean).join(` · `))} <span class="leads-badge" data-s="${q(i)}">${q(a)}</span></span></div>`:``}
    ${o?`<div class="leads-det__field"><span class="leads-det__k">Last call</span><span class="leads-det__v">${q([o.when,o.dur,o.source].filter(Boolean).join(` · `))} <span class="leads-badge" data-s="${o.answered===`no`?`WORKING`:`QUALIFIED`}">${o.answered===`no`?`Missed`:`Answered`}</span>${o.recording&&/^https:\/\//i.test(o.recording)?` <a href="${q(o.recording)}" target="_blank" rel="noopener">Recording</a>`:``}</span></div>`:``}
    ${s?`<div class="leads-det__field"><span class="leads-det__k">Local Services</span><span class="leads-det__v">${q([s.type,s.category,s.status].filter(Boolean).join(` · `)||`lead`)} <span class="leads-badge" data-s="${s.charged?`QUALIFIED`:`WORKING`}">${s.charged?`Charged`:`Not charged`}</span>${s.missed?` <span class="leads-badge" data-s="UNQUALIFIED">Missed call</span>`:``}${s.dispute?` <span class="leads-badge" data-s="WORKING">Dispute candidate</span>`:``}</span></div>`:``}
    ${s&&s.email&&!t.email?l(`LSA email`,s.email):``}
    ${c?`<div class="leads-det__field"><span class="leads-det__k">Ad call</span><span class="leads-det__v">${q([c.dur,c.area?`area code (${c.area})`:``].filter(Boolean).join(` · `)||`call`)} <span class="leads-badge" data-s="${c.missed?`UNQUALIFIED`:`QUALIFIED`}">${c.missed?`Missed`:`Answered`}</span></span></div>`:``}
    ${c&&c.campaign?l(`Campaign`,c.campaign):``}
    ...
    ${c?`<div class="leads-det__notes">Google shares the caller's area code only. The full number is in the Google Ads call details report.</div>`:t.description?`<div class="leads-det__notes">${q(t.description)}</div>`:``}
    ${K.canManage?`
      ...
      </div>`:``}`,e.querySelector(`[data-action="delete-lead"]`)?.addEventListener(`click`,P_)}async function P_(e){let t=e.currentTarget?.dataset?.id,n=K.leads.find(e=>String(e.id)===String(t));if(!n)return;let r=U_(n);if(!window.confirm(`Remove ${r} from your leads?\n\nThis takes the lead out of your dashboard, lists and exports. The record is kept in our system, and this address can be captured again if they come back through one of your magnets.`))return;let i=e.currentTarget;i.disabled=!0;try{let e=await b(`${H_()}/m5t/v5/m5mLead/${encodeURIComponent(t)}`,{method:`DELETE`}),n=await e.json().catch(()=>({}));if(!e.ok||!n.ok)throw Error(n.error||`HTTP ${e.status}`);K.leads=K.leads.filter(e=>String(e.id)!==String(t)),K.selectedId=null,V_(`${r} removed`,`success`),w_()}catch{i.disabled=!1,V_(`Could not remove that lead. Please try again.`,`danger`)}}function F_(){let e=g_();if(!e.length){V_(`Nothing to export`,`info`);return}let t=[`first_name`,`last_name`,`email`,`phone`,`company`,`product_interest`,`lead_source`,`utm_source`,`utm_medium`,`utm_campaign`,`gclid`,`status`],n=e=>`"${String(e??``).replace(/"/g,`""`)}"`,r=[[...K.book?[`client`]:[],...t,`magnet`,`captured`,`appointment`,`last_call`].join(`,`)];for(let i of e){let e=k_(i),a=A_(i);r.push([...K.book?[n(K.ownerNames[i.owner_guid]||``)]:[],...t.map(e=>n(i[e])),n(K.magnetNames[i.magnet_guid]||i.lead_source||``),n(s_(i)),n(e?`${e.start} (${e.status})`:``),n(a?`${a.started} (${a.answered===`no`?`missed`:`answered`})`:``)].join(`,`))}let i=new Blob([r.join(`
`)],{type:`text/csv`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.href=a,o.download=`leads-${K.filter.toLowerCase()}.csv`,document.body.appendChild(o),o.click(),o.remove(),URL.revokeObjectURL(a),V_(`Exported ${e.length} lead${e.length===1?``:`s`}`,`success`)}var I_,L_,K,R_,z_,B_,q,V_,H_,U_,W_,G_,K_,q_,J_,Y_,X_,Z_,Q_,$_,ev,tv,nv,rv,iv,av,ov,sv,cv=o((()=>{T(),I_=u(f(),1),m(),Qa(),co(),An(),Ol(),pr(),x(),no(),L_=!1,K={leads:[],magnetNames:{},filter:`ALL`,canManage:!1,book:!1,ownerNames:{},clientFilter:`ALL`,search:``,shown:25,selectedId:null,day:``,sort:{key:`captured`,dir:`desc`},magnetFilter:`ALL`,sourceFilter:`ALL`,range:`ALL`,pageSize:25,total:0,truncated:!1},R_=()=>K.pageSize===`ALL`?2**53-1:Number(K.pageSize)||25,z_=[`NEW`,`WORKING`,`QUALIFIED`,`UNQUALIFIED`,`CONVERTED`,`EXPORTED`],B_={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},q=e=>String(e??``).replace(/[&<>"']/g,e=>B_[e]),V_=(e,t=`info`)=>{try{I_.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},H_=()=>w.getConfig?.().BASE_URL||``,U_=e=>[e.first_name,e.last_name].filter(Boolean).join(` `).trim()||e.email||`(no name)`,W_=e=>(U_(e).split(/\s+/).map(e=>e.replace(/[^A-Za-z0-9]/g,``)).filter(Boolean).slice(0,2).map(e=>e[0]).join(``)||`?`).toUpperCase(),G_={"Google Ads call":`Ads call`,"Google LSA":`Local Services`},K_=e=>K.magnetNames[e.magnet_guid]||G_[e.lead_source]||e.lead_source||`—`,q_={"Google Ads call":`call`},J_=e=>{let t=!e.magnet_guid&&q_[e.lead_source];return t?`<span class="material-symbols-outlined" style="font-size:18px" aria-hidden="true">${t}</span>`:q(W_(e))},Y_=e=>e.captured_at||e.created?.created_tz||``,X_=e=>{let t=Y_(e);if(!t)return!1;try{return Date.now()-new Date(t).getTime()<864e5}catch{return!1}},Z_=e=>K.clientFilter===`ALL`||e.owner_guid===K.clientFilter,Q_=e=>!K.day||Y_(e).slice(0,10)===K.day,$_=e=>K.magnetFilter===`ALL`||e.magnet_guid===K.magnetFilter,ev=e=>K.sourceFilter===`ALL`||(K.sourceFilter===`MAGNET`?e.lead_source===`Magnet`:e.lead_source===K.sourceFilter),tv={ALL:null,7:7,30:30,90:90},nv={ALL:`All time`,7:`Last 7 days`,30:`Last 30 days`,90:`Last 90 days`},rv={name:{label:`Name`,dir:`asc`,value:e=>U_(e).toLowerCase()},contact:{label:`Contact`,dir:`asc`,value:e=>String(e.email||e.phone||``).toLowerCase()},captured:{label:`Captured`,dir:`desc`,value:e=>Y_(e)}},iv=()=>u_(`touch_app`,`Click to see lead information.`),av=[`hubspot`,`zoho`,`salesforce`,`gohighlevel`],ov=()=>`
  <colgroup>
    <col style="width:22%">
  ...
  </colgroup>`,sv={booked:[`QUALIFIED`,`Booked`],rescheduled:[`WORKING`,`Rescheduled`],canceled:[`CANCELED`,`Canceled`]}})),lv=c({init:()=>vv,render:()=>mv,tableHTML:()=>pv});function uv(){if(Ov)return;let e=document.createElement(`style`);e.id=`m5t-analytics-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Ov=!0}function dv(e,t){let n=t>0?Math.round(e/t*100):0,r=`${Sv(e)} of ${Sv(t)} leads for the busiest magnet`;return`<svg class="anl-bar" width="72" height="8" viewBox="0 0 72 8" role="img"
      aria-label="${wv(r)}">
      <title>${wv(r)}</title>
    ...
    </svg>`}function fv(e,t,n){let r=Av[e.status]?`<span class="anl-chip">${wv(Av[e.status])}</span>`:``,i=n&&e.owner_name?`<span class="anl-sub">${wv(e.owner_name)}</span>`:``,a=e.ab_tests&&(e.ab_tests.running||e.ab_tests.completed)?`${Sv(e.ab_tests.running)} / ${Sv(e.ab_tests.completed)}`:`—`;return`<tr data-guid="${wv(e.magnet_guid)}">
    <td><a class="anl-name" href="#/magnets">${wv(e.name)}</a>${r}${i}</td>
    <td>${dv(Number(e.leads?.window||0),t)}</td>
    <td>${Sv(e.leads?.window)}</td>
    <td>${Sv(e.opens)}</td>
    <td>${Tv(e.engagement_rate)}</td>
    <td>${Tv(e.completion_rate)}</td>
    <td>${Tv(e.lead_rate)}</td>
    <td>${a}</td>
  </tr>`}function pv(e,t){let n=e.reduce((e,t)=>Math.max(e,Number(t.leads?.window||0)),0);return`<div class="anl-wrap"><table class="anl-table">
    <thead><tr>
      <th>Magnet</th><th></th><th>Leads</th><th>Opens</th>
      <th>Engaged</th><th>Completed</th><th>Leads / Open</th><th>A/B run / done</th>
    </tr></thead>
    <tbody>${e.map(e=>fv(e,n,t)).join(``)}</tbody>
  </table></div>`}function mv(){return A()?Ha({section:`analytics`,title:`Analytics`,description:`Pick a client to see how their magnets are performing.`}):(uv(),mo(),`
    <div class="page-shell" data-section="analytics">
      <div class="page-header">
        ...
        <div class="chart-controls" id="anl-periods">
          ${Ev.map(e=>`<button class="chart-period-btn${e.d===Dv?` active`:``}" type="button" data-days="${e.d}">${e.label}</button>`).join(``)}
        </div>
      </div>

      <div class="stats-grid">
        ${M({icon:`person_add`,label:`Leads`,valueId:`anl-leads`,href:`#/leads`})}
        ${M({icon:`visibility`,label:`Opens`,valueId:`anl-opens`})}
        ${M({icon:`task_alt`,label:`Completion Rate`,valueId:`anl-completion`,href:`#/conversations`})}
        ${M({icon:`widgets`,label:`Active Magnets`,valueId:`anl-active`,href:`#/magnets`})}
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="anl-body">
          ${kv(`hourglass_empty`,`Loading magnet performance…`)}
        </div>
      </div>
    ...
    </div>`)}function hv(e){try{return new Date(`${e}T00:00:00`).toLocaleDateString(void 0,{month:`short`,day:`numeric`,year:`numeric`})}catch{return String(e||``)}}function gv(e){return ho({rows:e,xLabel:e=>String(e.date||``).slice(5),left:{value:e=>e.opens||0,label:`Magnet Opens`},right:{value:e=>e.leads||0,label:`Leads`},ariaLabel:`Magnet opens versus leads over time`,activatable:e=>Number(e.leads||0)>0,pointLabel:e=>`${hv(e.date)}: ${Sv(e.opens||0)} opens, ${Sv(e.leads||0)} leads`,hitData:e=>({day:e.date,leads:Number(e.leads||0)})})}function _v(e){let t=document.getElementById(`anl-trend`);return t?_o(t,{rows:e,tipHTML:e=>`
      <div class="m5c-tip__title">${hv(e.date)}</div>
      <div class="m5c-tip__row"><i class="m5c-sw m5c-sw--1"></i>${Sv(e.opens||0)} opens</div>
      <div class="m5c-tip__row"><i class="m5c-sw m5c-sw--2"></i>${Sv(e.leads||0)} leads</div>
      ${Number(e.leads||0)>0?`<div class="m5c-tip__go">Open these leads →</div>`:``}`,onActivate:e=>{ro(oo.LEADS_DAY,e.date),window.location.hash=`#/leads`}}):()=>{}}async function vv(){if(A())return Wa(bv(),[{h:`Leads`,td:e=>Sv(e.leads.window??e.leads.total)},{h:`Opens`,td:e=>Sv(e.opens)},{h:`Completed`,td:e=>Tv(e.completion_rate)}]);uv(),mo(),await yv();let e=document.getElementById(`anl-periods`);e&&e.addEventListener(`click`,t=>{let n=t.target.closest(`.chart-period-btn`);n&&(Dv=Number(n.dataset.days)||30,e.querySelectorAll(`.chart-period-btn`).forEach(e=>{e.classList.toggle(`active`,Number(e.dataset.days)===Dv)}),yv())})}async function yv(){let e=document.getElementById(`anl-body`),t=document.getElementById(`anl-range`);if(!e)return;e.innerHTML=kv(`hourglass_empty`,`Loading magnet performance…`);let n=new Date,r=xv(n),i=xv(new Date(n.getTime()-(Dv-1)*864e5));t&&(t.textContent=`${i} → ${r}`);let a;try{let e=await b(`${bv()}/m5t/v5/dashboard/stats?from=${i}&to=${r}&group_by=magnet`);if(a=await e.json(),j(e,a),!a?.ok)throw Error(a?.error||`Failed to load`)}catch(t){e.innerHTML=$a(t)?eo():kv(`cloud_off`,`Could not load analytics. Refresh to try again.`),console.error(`[analytics] load failed:`,t);return}let o=(e,t)=>{let n=document.getElementById(e);n&&(n.textContent=t)};o(`anl-leads`,Sv(a.by_day?.reduce((e,t)=>e+Number(t.leads||0),0))),o(`anl-opens`,Sv(a.funnel?.opens)),o(`anl-completion`,Tv(a.funnel?.completion_rate)),o(`anl-active`,Sv(a.magnets?.active));let s=Array.isArray(a.by_day)?a.by_day:[],c=document.getElementById(`anl-trend`);if(c){let e=s.some(e=>Number(e.opens||0)>0||Number(e.leads||0)>0);c.innerHTML=e?gv(s):kv(`show_chart`,`No activity in this range yet. Opens and leads chart here as visitors engage your magnets.`),e&&_v(s)}let l=Array.isArray(a.by_magnet)?a.by_magnet:[];if(!l.length){e.innerHTML=kv(`widgets`,`No magnets yet. Create one and its numbers will show up here.`);return}let u=l.some(e=>Number(e.opens||0)>0||Number(e.leads?.window||0)>0),d=new Set(l.map(e=>e.owner_guid)).size>1;e.innerHTML=(a.by_magnet_truncated?`<p class="anl-warn">Showing the top ${l.length} magnets by leads. You have more than that, so this list is not complete.</p>`:``)+(u?``:`<p class="anl-warn">No opens or leads for any magnet in this period. Try a longer range.</p>`)+pv(l,d);let f=e.querySelector(`.anl-table tbody`);f&&O(f,{rowSelector:`tr`,noun:`magnets`,controlHost:e.querySelector(`.anl-wrap`)||e})}var bv,xv,Sv,Cv,wv,Tv,Ev,Dv,Ov,kv,Av,jv=o((()=>{T(),Qa(),fo(),An(),So(),co(),x(),no(),bv=()=>w.getConfig?.().BASE_URL||``,xv=e=>e.toISOString().slice(0,10),Sv=e=>Number(e||0).toLocaleString(),Cv={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},wv=e=>String(e??``).replace(/[&<>"']/g,e=>Cv[e]),Tv=e=>e==null?`—`:`${e}%`,Ev=[{d:7,label:`7 Days`},{d:30,label:`30 Days`},{d:90,label:`90 Days`}],Dv=30,Ov=!1,kv=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Av={DRAFT:`Draft`,DISABLED:`Paused`}})),Mv=c({default:()=>uy,init:()=>Fv,render:()=>Pv});function Nv(){if(mo(),sy)return;let e=document.createElement(`style`);e.id=`m5t-conversions-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),sy=!0}function Pv(){return A()?Ha({section:`analytics-conversions`,title:`Conversions`,description:`Pick a client to view their conversion reporting.`}):(Nv(),J.canSave=bl(),`
    <div class="page-shell" data-section="analytics-conversions">
      <div class="page-header">
        ...
        <div class="chart-controls" id="conv-periods">
          ${ay.map(e=>`<button class="chart-period-btn${e.d===oy?` active`:``}" type="button" data-days="${e.d}">${e.label}</button>`).join(``)}
        </div>
      </div>

      <div class="stats-grid" id="conv-stats">
        ${M({icon:`payments`,label:`Ad Spend`,valueId:`conv-spend`,href:`#/ad-accounts`})}
        ${M({icon:`flag`,label:`Conversions`,valueId:`conv-count`,sub:`Reported by Google Ads`})}
        ${M({icon:`request_quote`,label:`Cost / Conversion`,valueId:`conv-cpc`})}
        ${M({icon:`universal_currency_alt`,label:`Conversion Value`,valueId:`conv-value`})}
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="conv-selector">
          ${cy(`hourglass_empty`,`Loading conversion actions.`)}
        </div>
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="conv-chart">
          ${cy(`hourglass_empty`,`Loading conversions.`)}
        </div>
      </div>
    ...
    </div>`)}async function Fv(){if(A()){let e=e=>Number(e||0).toLocaleString();return Wa(Jv(),[{h:`Spend`,td:t=>t.ad?`$${e(t.ad.spend)}`:Xv},{h:`Clicks`,td:t=>t.ad?e(t.ad.clicks):Xv},{h:`Leads`,td:t=>e(t.leads.window??t.leads.total)},{h:`CPL`,td:t=>t.ad?.cost_per_lead==null?Xv:`$${e(t.ad.cost_per_lead)}`}],{emptyMsg:`No client orgs yet. Connect a client ad account to see conversions here.`})}let e=document.getElementById(`conv-periods`);e?.addEventListener(`click`,t=>{let n=t.target.closest(`button[data-days]`);n&&(oy=Number(n.dataset.days)||30,e.querySelectorAll(`.chart-period-btn`).forEach(e=>e.classList.toggle(`active`,Number(e.dataset.days)===oy)),Iv())}),document.getElementById(`conv-selector`)?.addEventListener(`change`,e=>{let t=e.target.closest(`input[type="checkbox"][data-action-id]`);t&&(t.checked?J.selection.add(t.value):J.selection.delete(t.value),Uv(),Rv())}),await Iv()}async function Iv(){let e=new Date;J.to=Yv(e),J.from=Yv(new Date(e.getTime()-(oy-1)*864e5));let t=document.getElementById(`conv-range`);t&&(t.textContent=`${J.from} → ${J.to}`);let n=Jv(),r=`from=${J.from}&to=${J.to}`,i=null,a=null,o=null,s=[],c=null;try{let e=bl(),[t,l,u,d,f]=await Promise.all([b(`${n}/m5t/v5/coreAdMetrics/overlay?${r}`).then(e=>e.json()).catch(()=>null),b(`${n}/m5t/v5/coreAdMetrics/conversions?${r}`).then(e=>e.json()).catch(()=>null),b(`${n}/m5t/v5/coreAdMetrics/upload-ledger?${r}`).then(e=>e.json()).catch(()=>null),b(`${n}/m5t/v5/coreAdAccount`).then(e=>e.json()).catch(()=>null),e?b(`${n}/m5t/v5/integrations/google_ads/conversion_actions`).then(e=>e.json()).catch(()=>null):Promise.resolve(null)]);i=t,a=l,o=u,c=f,s=(d?.data||[]).filter(e=>e.status!==`DELETED`)}catch(e){console.warn(`[analytics-conversions] load failed:`,e),qv(`conv-chart`,cy(`error`,`Could not load conversions. Please try again.`));return}J.spend=i?.totals?.spend??null,J.overlayRows=i?.rows||[],J.canSave=bl();let l=s.filter(e=>e.provider===`google_ads`);J.universe=Lv({catalog:c,conv:a,accounts:l});let u=a?.has_selection&&Array.isArray(a.selected_ids)?a.selected_ids.map(String):[],d=J.universe.filter(e=>e.magnet).map(e=>e.id);if(J.selection=new Set(u.length?u:d),Gv(o),Hv({accounts:l}),Uv(),!l.length){Kv(`conv-spend`,Zv(J.spend)),qv(`conv-chart`,cy(`link_off`,`No ad account connected yet. Your agency can connect Google Ads to see conversions here.`)),qv(`conv-actions`,cy(`link_off`,`No ad account connected yet.`));return}u.length||!J.selection.size?(J.conv=a,zv()):await Rv()}function Lv({catalog:e,conv:t,accounts:n}){let r=new Map,i=(e,t)=>{let n=String(e||``);if(!n)return;let i=r.get(n)||{id:n,name:null,category:null,magnet:!1,kind:null};r.set(n,{...i,...Object.fromEntries(Object.entries(t).filter(([,e])=>e!=null&&e!==!1))})};(e?.data?.actions||[]).forEach(e=>i(e.id,{name:e.name,category:e.category})),(t?.actions||[]).forEach(e=>i(e.id,{name:e.name,category:e.category})),(t?.available||[]).forEach(e=>i(e.id,{name:e.name,category:e.category})),n.forEach(e=>{let t=e.account_config?.magnet_actions||{};Object.entries(t).forEach(([e,t])=>{t?.id&&i(t.id,{name:t.name,magnet:!0,kind:e})})}),r.forEach(e=>{!e.magnet&&e.name&&iy.has(e.name)&&(e.magnet=!0)});let a=[...r.values()],o=e=>e.magnet?ny.indexOf(e.kind):-1;return a.sort((e,t)=>{if(e.magnet!==t.magnet)return e.magnet?-1:1;if(e.magnet){let n=o(e),r=o(t);if(n!==r)return(n<0?99:n)-(r<0?99:r)}return String(e.name||e.id).localeCompare(String(t.name||t.id))})}async function Rv(){let e=[...J.selection],t=document.getElementById(`conv-chart`);t?.classList.add(`conv-busy`),J.busy=!0;try{if(!e.length)J.conv={ok:!0,has_selection:!1,rows:[],actions:[],totals:{conversions:0,value:0,all_conversions:0,all_value:0}};else{let t=await b(`${Jv()}/m5t/v5/coreAdMetrics/conversions?from=${J.from}&to=${J.to}&actions=${encodeURIComponent(e.join(`,`))}`),n=await t.json().catch(()=>({}));j(t,n),J.conv=n}zv()}catch(e){console.warn(`[analytics-conversions] recompute failed:`,e),qv(`conv-chart`,$a(e)?eo():cy(`error`,`Could not recompute for that selection. Please try again.`))}finally{J.busy=!1,t?.classList.remove(`conv-busy`)}}function zv(){let e=J.conv||{},t=e.totals||{conversions:0,value:0},n=Number(t.all_conversions??t.conversions??0);Kv(`conv-spend`,Zv(J.spend)),Kv(`conv-count`,Qv(n)),Kv(`conv-cpc`,Zv(ty(J.spend,n))),Kv(`conv-value`,Zv(t.all_value??t.value??0)),Bv(e.rows||[]),Vv(e.actions||[])}function Bv(e){let t=document.getElementById(`conv-chart`);if(!t)return;if(!J.selection.size){t.innerHTML=cy(`checklist`,`No actions counted. Tick a conversion action to see it here.`),J.rows=[];return}let n=new Map(e.map(e=>[String(e.date).slice(0,10),e])),r=J.overlayRows.length?J.overlayRows.map(e=>String(e.date).slice(0,10)):e.map(e=>String(e.date).slice(0,10)),i=new Map(J.overlayRows.map(e=>[String(e.date).slice(0,10),Number(e.spend||0)])),a=r.map(e=>({date:e,spend:i.get(e)||0,conversions:Number(n.get(e)?.all_conversions??n.get(e)?.conversions??0)}));if(J.rows=a,!a.length){t.innerHTML=cy(`search_off`,`No conversions in this range for the selected actions.`);return}t.innerHTML=ho({rows:a,xLabel:e=>String(e.date||``).slice(5),left:{value:e=>e.spend||0,label:`Ad Spend`,fmt:e=>`$${bo(e)}`},right:{value:e=>e.conversions||0,label:`Conversions`},ariaLabel:`Ad spend versus counted conversions over time`,pointLabel:e=>`${e.date}: ${Zv(e.spend||0)} spend, ${Qv(e.conversions||0)} conversions`,hitData:e=>({day:e.date})}),_o(t,{rows:a,tipHTML:e=>`
      <div class="m5c-tip__title">${ey(String(e.date||``))}</div>
      <div class="m5c-tip__row"><i class="m5c-sw m5c-sw--1"></i>${Zv(e.spend||0)} spend</div>
      <div class="m5c-tip__row"><i class="m5c-sw m5c-sw--2"></i>${Qv(e.conversions||0)} conversions</div>`})}function Vv(e){let t=document.getElementById(`conv-actions`);if(!t)return;let n=new Set(J.universe.filter(e=>e.magnet).map(e=>e.id)),r=e.filter(e=>J.selection.has(String(e.id)));if(!r.length){t.innerHTML=cy(`search_off`,J.selection.size?`No conversions in this range for the selected actions.`:`No actions counted. Tick a conversion action to see it here.`);return}t.innerHTML=`
    <div class="conv-wrap">
      <table class="conv-table">
        <thead><tr><th>Conversion action</th><th>Category</th><th class="num">All conv.</th><th class="num">Counted</th><th class="num">Value</th></tr></thead>
        <tbody>${r.map(e=>`
          <tr>
            <td><span class="conv-name">${ey(e.name||e.id)}</span>${n.has(String(e.id))?` <span class="conv-tag">Magnet</span>`:``}</td>
            <td class="sub">${ey(ly(e.category))}</td>
            <td class="num"><b>${Qv(e.all_conversions??e.conversions)}</b></td>
            <td class="num">${Qv(e.conversions)}</td>
            <td class="num">${Zv(e.all_value??e.value??0)}</td>
          </tr>`).join(``)}
        </tbody>
      </table>
    </div>`;let i=t.querySelector(`.conv-table tbody`);i&&O(i,{rowSelector:`tr`,noun:`actions`,controlHost:t.querySelector(`.conv-wrap`)||t})}function Hv({accounts:e}){let t=document.getElementById(`conv-selector`);if(!t)return;if(!e.length){t.innerHTML=cy(`link_off`,`No ad account connected yet. Your agency can connect Google Ads to see conversions here.`);return}if(!J.universe.length){t.innerHTML=`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">checklist</span>
    ...
    <label class="conv-row">
      <input type="checkbox" data-action-id="${ey(e.id)}" value="${ey(e.id)}"${J.selection.has(e.id)?` checked`:``}>
      <span class="conv-name">${ey(e.name||e.id)}</span>
      ${e.magnet?`<span class="conv-tag">Magnet</span>`:``}
      ${e.category?`<span class="conv-cat">${ey(ly(e.category))}</span>`:``}
    </label>`;t.innerHTML=`
    ...
    ${J.canSave?`
      ...
      </div>`:``}`;let a=t.querySelector(`#conv-list-other`);a&&O(a,{rowSelector:`.conv-row`,noun:`actions`}),document.getElementById(`conv-save`)?.addEventListener(`click`,Wv)}function Uv(){let e=document.getElementById(`conv-selcount`);if(!e)return;let t=J.selection.size;e.textContent=t?`${t} action${t===1?``:`s`} counted`:`No actions counted`}async function Wv(){let e=document.getElementById(`conv-save`),t=document.getElementById(`conv-savemsg`),n=[...J.selection];e&&(e.disabled=!0),t&&(t.classList.remove(`err`),t.textContent=`Saving.`);try{let e=await(await b(`${Jv()}/m5t/v5/integrations/google_ads/conversion_actions`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({conversion_action_ids:n})})).json().catch(()=>({}));if(!e.ok)throw Error(e.error||`save failed`);t&&(t.textContent=n.length?`Saved. ${n.length} action${n.length===1?``:`s`} counted by default.`:`Saved. No actions counted by default.`)}catch{t&&(t.classList.add(`err`),t.textContent=`Could not save the selection. Please try again.`)}finally{e&&(e.disabled=!1)}}function Gv(e){let t=document.getElementById(`conv-ledger`);if(!t)return;let n=e?.kinds||[];if(!n.length){t.innerHTML=cy(`upload`,`Nothing fed into Google Ads in this range yet.`);return}let r=e=>ry[e]||String(e||``).replace(/_/g,` `),i=e=>{let t=ny.indexOf(e.kind);return t<0?99:t};t.innerHTML=`
    <div class="conv-wrap">
      <table class="conv-table" id="conv-ledger-table">
        ...
        <tbody>${[...n].sort((e,t)=>i(e)-i(t)).map(e=>`
          <tr data-kind="${ey(e.kind)}">
            <td><span class="conv-name">${ey(r(e.kind))}</span></td>
            <td class="num"><b>${Qv(e.sent)}</b></td>
            <td class="num">${Qv(e.queued)}</td>
            <td class="num">${Qv(e.failed)}</td>
            <td class="num">${Qv(e.skipped)}</td>
          </tr>`).join(``)}
        </tbody>
      </table>
    </div>
    <p class="conv-note">What Magnet fed into Google Ads. Google's attributed numbers above are its own and are never added to these.</p>`}function Kv(e,t){let n=document.getElementById(e);n&&(n.textContent=t)}function qv(e,t){let n=document.getElementById(e);n&&(n.innerHTML=t)}var Jv,Yv,Xv,Zv,Qv,$v,ey,ty,ny,ry,iy,ay,oy,J,sy,cy,ly,uy,dy=o((()=>{T(),Qa(),Ol(),fo(),So(),An(),x(),no(),Jv=()=>w.getConfig?.().BASE_URL||``,Yv=e=>e.toISOString().slice(0,10),Xv=`—`,Zv=e=>e==null?Xv:`$`+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),Qv=e=>e==null?Xv:Number(e).toLocaleString(),$v={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},ey=e=>String(e??``).replace(/[&<>"']/g,e=>$v[e]),ty=(e,t)=>{let n=Number(e),r=Number(t);return!Number.isFinite(n)||!Number.isFinite(r)||r<=0?null:Math.round(n/r*100)/100},ny=[`magnet_fill`,`qualified_lead`,`call_dni`,`calls_from_ads`],ry={magnet_fill:`Magnet fills`,qualified_lead:`Qualified leads`,call_dni:`Website calls`,calls_from_ads:`Ad calls`},iy=new Set([`Magnet Lead`,`Magnet Qualified Lead`,`Magnet Phone Call (Website)`,`Ad Calls (Magnet reporting)`,`Calls from Ads (Magnet)`]),ay=[{d:7,label:`7 Days`},{d:30,label:`30 Days`},{d:90,label:`90 Days`}],oy=30,J={from:null,to:null,spend:null,universe:[],selection:new Set,conv:null,rows:[],overlayRows:[],canSave:!1,busy:!1},de(()=>{J.busy=!1}),sy=!1,cy=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,ly=e=>String(e||``).toLowerCase().replace(/_/g,` `)||Xv,uy={render:Pv,init:Fv}})),fy=c({init:()=>hy,render:()=>my});function py(){if(Ty)return;let e=document.createElement(`style`);e.id=`m5t-billing-styles`,e.textContent=`
    .page-shell .bill-plan { display: flex; align-items: center; gap: 14px; }
    .page-shell .bill-plan__name { font-size: 1.35rem; font-weight: 700; color: var(--color-text, #0B1220); }
    .page-shell .bill-plan__badge { font-size: 0.72rem; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase;
      padding: 4px 10px; border-radius: 999px; background: var(--color-primary-600, #0072BA); color: #fff; }
    .page-shell .bill-plan__sub { margin-top: 6px; font-size: 0.9rem; color: var(--color-text-muted, #4A5A78); }
    .page-shell .bill-meters { display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 16px; margin-top: 16px; }
    .page-shell .bill-meter { border: 1px solid var(--color-border, #D4DCE8); border-radius: var(--radius-lg, 16px); padding: 16px; background: var(--color-bg, #fff); }
    .page-shell .bill-meter__k { font-size: 0.78rem; font-weight: 700; letter-spacing: 0.05em; text-transform: uppercase; color: var(--color-text-subtle, #6C7C9A); }
    .page-shell .bill-meter__v { margin-top: 6px; font-size: 1.5rem; font-weight: 700; color: var(--color-text, #0B1220); }
    .page-shell .bill-meter__v small { font-size: 0.85rem; font-weight: 600; color: var(--color-text-subtle, #6C7C9A); }
    .page-shell .bill-bar { margin-top: 10px; height: 8px; border-radius: 999px; background: var(--color-surface-2, #EAF0F7); overflow: hidden; }
    .page-shell .bill-bar i { display: block; height: 100%; border-radius: 999px; background: var(--color-primary-600, #0072BA); }
    .page-shell .bill-bar i[data-warn="true"] { background: var(--color-danger, #DD4124); }
    .page-shell .bill-feats { display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 6px 18px; margin-top: 10px; }
    .page-shell .bill-feat { display: flex; align-items: center; gap: 8px; font-size: 0.88rem; color: var(--color-text-muted, #4A5A78); }
    .page-shell .bill-feat .material-symbols-outlined { font-size: 18px; color: var(--color-success, #009473); }
    .page-shell .bill-note { font-size: 0.76rem; color: var(--color-text-subtle, #6C7C9A); margin: 14px 2px 0; }
    .page-shell .bill-meter__hint { margin-top: 8px; font-size: 0.76rem; color: var(--color-text-subtle, #6C7C9A); }
    .page-shell .bill-plan__sub a { color: var(--color-primary-600, #0072BA); font-weight: 600; text-decoration: none; }
    .page-shell .bill-plan__sub a:hover { text-decoration: underline; }
    .page-shell .bill-feats__pro-label { margin-top: 18px; font-size: 0.72rem; font-weight: 700; letter-spacing: 0.05em; text-transform: uppercase; color: var(--color-text-subtle, #6C7C9A); }
    .page-shell .bill-feat--pro { color: var(--color-text-subtle, #6C7C9A); }
    .page-shell .bill-feat--pro .material-symbols-outlined { color: var(--color-text-subtle, #6C7C9A); }
    .page-shell .bill-btn { display: inline-flex; align-items: center; gap: 6px; border: 1px solid var(--color-border, #D4DCE8);
      background: var(--color-primary-600, #0072BA); color: #fff; border-radius: 10px; padding: 8px 14px;
      font-size: 0.85rem; font-weight: 600; cursor: pointer; }
    .page-shell .bill-btn[disabled] { opacity: 0.6; cursor: default; }
    .page-shell .bill-btn--quiet { background: var(--color-bg, #fff); color: var(--color-text, #0B1220); }
    .page-shell .bill-btn .material-symbols-outlined { font-size: 18px; }
    .page-shell .chart-period-btn { cursor: pointer; }
    .page-shell .chart-period-btn.active { background: var(--color-primary-600, #0072BA); color: #fff; }
  `,document.head.appendChild(e),Ty=!0}function my(){return py(),`
    <div class="page-shell" data-section="billing">
      <div class="page-header">
        <div class="page-header-text">
          <h1 class="page-title">Billing</h1>
          <p class="page-description">Your plan and usage.</p>
        </div>
      </div>
      <div class="dashboard-card">
        <div class="card-body" id="bill-plan-card">${Ey(`hourglass_empty`,`Loading your plan…`)}</div>
      </div>
      <div class="bill-meters" id="bill-meters"></div>
      <div class="dashboard-card" id="bill-upgrade-card" style="display:none; margin-top:16px">
        <div class="card-header">
          <h2 class="card-title"><span class="material-symbols-outlined" aria-hidden="true">upgrade</span> Upgrade</h2>
          <div class="chart-controls" id="bill-interval">
            <button class="chart-period-btn active" type="button" data-interval="monthly">Monthly</button>
            <button class="chart-period-btn" type="button" data-interval="annual">Annual</button>
          </div>
        </div>
        <div class="card-body" id="bill-upgrade"></div>
      </div>
      <div class="dashboard-card" id="bill-feat-card" style="display:none; margin-top:16px">
        <div class="card-header"><h2 class="card-title"><span class="material-symbols-outlined" aria-hidden="true">checklist</span> Included in your plan</h2></div>
        <div class="card-body" id="bill-feats"></div>
      </div>
      <p class="bill-note" id="bill-note"></p>
    </div>`}async function hy(){document.getElementById(`bill-interval`)?.addEventListener(`click`,e=>{let t=e.target.closest(`button[data-interval]`);t&&(Oy=t.dataset.interval,document.querySelectorAll(`#bill-interval .chart-period-btn`).forEach(e=>e.classList.toggle(`active`,e.dataset.interval===Oy)),ky&&gy(ky))}),document.getElementById(`bill-upgrade-card`)?.addEventListener(`click`,async e=>{let t=e.target.closest(`button[data-plan]`);if(t){t.disabled=!0;try{let e=await(await b(`${xy()}/m5t/v5/billing/checkout`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({plan:t.dataset.plan,interval:Oy})})).json();if(!e.ok||!e.data?.url)throw Error(e.error||`checkout failed`);window.location.href=e.data.url}catch(e){console.warn(`[billing] checkout failed:`,e),t.disabled=!1,t.textContent=`Could not start checkout. Try again.`}}}),document.getElementById(`bill-plan-card`)?.addEventListener(`click`,async e=>{let t=e.target.closest(`#bill-manage`);if(t){t.disabled=!0;try{let e=await(await b(`${xy()}/m5t/v5/billing/portal`,{method:`POST`,headers:{"Content-Type":`application/json`},body:`{}`})).json();if(!e.ok||!e.data?.url)throw Error(e.error||`portal failed`);window.location.href=e.data.url}catch(e){console.warn(`[billing] portal failed:`,e),t.disabled=!1}}}),await by()}function gy(e){let t=document.getElementById(`bill-upgrade-card`),n=document.getElementById(`bill-upgrade`);if(!t||!n)return;let r=e.plan?.key===`free`&&e.checkout_ready;if(t.style.display=r?``:`none`,!r)return;let i=e=>`
    <div class="bill-meter">
      <div class="bill-meter__k">${wy(e.label)}</div>
      <div class="bill-meter__v">$${e.prices[Oy]}<small>/month${Oy===`annual`?`, billed yearly`:``}</small></div>
      <div class="bill-plan__sub">${e.key===`pro`?`Unlimited magnets, all formats, 10,000 leads a month, integrations.`:`Everything in Pro, 100,000 leads a month, unlimited team, ad reporting.`}</div>
      <div style="margin-top:12px"><button type="button" class="bill-btn" data-plan="${e.key}"><span class="material-symbols-outlined" aria-hidden="true">arrow_forward</span>Choose ${wy(e.label)}</button></div>
    </div>`;n.innerHTML=`<div class="bill-meters" style="margin-top:0">${i(et.pro)}${i(et.enterprise)}</div>`}function _y(e,t=null){return e.key===`enterprise`&&!t?`Included with your program.`:e.key===`grandfathered`?`All features included.`:t&&e.prices?`${t.interval===`annual`?`$${e.prices.annual}/month, billed yearly`:`$${e.prices.monthly}/month`}.`:``}function vy(e){let t=`for every display format, integrations, and ${Sy(et.pro.limits.leads_mo)} leads a month.`,n=e?`<a href="#/billing" id="bill-up-link">Upgrade to Pro</a>`:`Upgrade to Pro`;return`${wy(`Design a free magnet for your business and track its leads.`)} ${n} ${wy(t)}`}function yy(e,t,n,{hint:r=``,consumption:i=!1}={}){let a=n==null,o=a?0:Math.min(100,Math.round(t/Math.max(1,n)*100)),s=i&&o>=80;return`
    <div class="bill-meter">
      <div class="bill-meter__k">${wy(e)}</div>
      <div class="bill-meter__v">${Sy(t)}${a?` <small>No limit</small>`:` <small>of ${Sy(n)}</small>`}</div>
      ${a?``:`<div class="bill-bar"><i style="width:${o}%" data-warn="${s}"></i></div>`}
      ${r?`<div class="bill-meter__hint">${wy(r)}</div>`:``}
    </div>`}async function by(){let e=document.getElementById(`bill-plan-card`),t;try{let e=await b(`${xy()}/m5t/v5/billing/usage`);if(t=await e.json(),j(e,t),!t.ok)throw Error(t.error||`load failed`)}catch(t){console.warn(`[billing] load failed:`,t),e&&(e.innerHTML=$a(t)?eo():Ey(`error`,`Could not load billing. Please try again.`));return}let n=t.plan||et.grandfathered,r=t.usage||{},i=t.subscription||null;if(ky=t,e){let r=i?.current_period_end?`${i.cancel_at_period_end?`Ends`:`Renews`} ${new Date(i.current_period_end).toLocaleDateString([],{month:`short`,day:`numeric`,year:`numeric`})}.`:``,a=i?.status===`PAST_DUE`?` <span class="bill-plan__badge" style="background: var(--color-danger, #DD4124)">Payment needed</span>`:``;e.innerHTML=`
      <div class="bill-plan">
        <span class="bill-plan__name">${wy(n.label)}</span>
        <span class="bill-plan__badge">Current plan</span>${a}
        ${i?`<span style="flex:1 1 auto"></span><button type="button" class="bill-btn bill-btn--quiet" id="bill-manage"><span class="material-symbols-outlined" aria-hidden="true">credit_card</span>Manage billing</button>`:``}
      </div>
      <div class="bill-plan__sub">${n.key===`free`?vy(!!t.checkout_ready):wy([_y(n,i),r].filter(Boolean).join(` `))}</div>`,e.querySelector(`#bill-up-link`)?.addEventListener(`click`,e=>{e.preventDefault(),document.getElementById(`bill-upgrade-card`)?.scrollIntoView({behavior:`smooth`,block:`start`})})}gy(t);let a=document.getElementById(`bill-meters`);if(a){let e=n.key===`free`;a.innerHTML=[yy(`Live magnets`,r.magnets,n.limits?.magnets??null,{hint:e?`Pro includes unlimited magnets.`:``}),yy(`Leads this month`,r.leads_month,n.limits?.leads_mo??null,{consumption:!0,hint:e?`Pro includes ${Sy(et.pro.limits.leads_mo)} a month.`:``}),yy(`Team members`,r.team_members,n.limits?.team_members??null,{hint:e?`Pro includes ${Sy(et.pro.limits.team_members)} seats.`:``})].join(``)}let o=document.getElementById(`bill-feat-card`),s=document.getElementById(`bill-feats`);if(o&&s){let e=[],t=n.features?.formats||[];e.push(`<div class="bill-feat"><span class="material-symbols-outlined" aria-hidden="true">check_circle</span>${t.length>=4?`All four display formats`:`Chat bubble format`}</div>`);for(let[t,r]of Dy)r&&n.features?.[t]&&e.push(`<div class="bill-feat"><span class="material-symbols-outlined" aria-hidden="true">check_circle</span>${wy(r)}</div>`);let r=``;if(n.key===`free`){let e=[];(n.features?.formats||[]).length<4&&(et.pro.features.formats||[]).length>=4&&e.push(`All four display formats`);for(let[t,r]of Dy)r&&!n.features?.[t]&&et.pro.features?.[t]&&e.push(r);e.length&&(r=`<div class="bill-feats__pro-label">Included with Pro</div>
          <div class="bill-feats">${e.map(e=>`<div class="bill-feat bill-feat--pro"><span class="material-symbols-outlined" aria-hidden="true">add_circle</span>${wy(e)}</div>`).join(``)}</div>`)}s.innerHTML=`<div class="bill-feats">${e.join(``)}</div>${r}`,o.style.display=``}let c=document.getElementById(`bill-note`);c&&(c.textContent=n.key===`enterprise`?`Usage is informational. Your program covers the platform.`:`Lead counts reset monthly. This period: ${t.period?.start||``} to ${t.period?.end||``}.`)}var xy,Sy,Cy,wy,Ty,Ey,Dy,Oy,ky,Ay=o((()=>{T(),rt(),x(),no(),xy=()=>w.getConfig?.().BASE_URL||``,Sy=e=>Number(e||0).toLocaleString(),Cy={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},wy=e=>String(e??``).replace(/[&<>"']/g,e=>Cy[e]),Ty=!1,Ey=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Dy=[[`formats`,null],[`hub_scheduler`,`Welcome hub and scheduler`],[`ab_testing`,`A/B testing`],[`journeys`,`Journeys`],[`attribution`,`Campaign attribution`],[`crm_sync`,`CRM sync`],[`booking`,`Booking integrations`],[`webhooks`,`Webhooks and Zapier`],[`csv_export`,`CSV export`],[`ad_reporting`,`Ad performance reporting`]],Oy=`monthly`,ky=null})),jy=c({init:()=>Py,render:()=>Ny});function My(){if(mo(),gl(),Ky)return;let e=document.createElement(`style`);e.id=`m5t-traffic-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Ky=!0}function Ny(){return A()?Ha({section:`traffic`,title:`Traffic`,description:`Pick a client to view their website traffic.`}):(My(),`
    <div class="page-shell" data-section="traffic">
      <div class="page-header">
        ...
        <div class="chart-controls" id="traffic-periods">
          ${Jy.map(e=>`<button class="chart-period-btn${e.d===Yy?` active`:``}" type="button" data-days="${e.d}">${e.label}</button>`).join(``)}
        </div>
      </div>

      <div class="stats-grid" id="traffic-stats">
        ${M({icon:`ssid_chart`,label:`Sessions`,valueId:`traffic-sessions`})}
        ${M({icon:`group`,label:`Visitors`,valueId:`traffic-users`})}
        ${M({icon:`description`,label:`Page Views`,valueId:`traffic-views`})}
        ${M({icon:`touch_app`,label:`Engagement Rate`,valueId:`traffic-engagement`})}
        ${M({icon:`person_add`,label:`Magnet Leads`,valueId:`traffic-leads`,href:`#/leads`})}
        ${M({icon:`percent`,label:`Session to Lead Rate`,valueId:`traffic-leadrate`})}
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="traffic-body">
          ${qy(`hourglass_empty`,`Loading traffic…`)}
        </div>
      </div>
    ...
    </div>`)}async function Py(){if(A()){let e=e=>Number(e||0).toLocaleString();return Wa(By(),[{h:`Leads`,td:t=>e(t.leads.window??t.leads.total)}],{emptyMsg:`No client orgs yet. Connect a client GA4 property to see traffic here.`})}let e=document.getElementById(`traffic-periods`);e?.addEventListener(`click`,t=>{let n=t.target.closest(`button[data-days]`);n&&(Yy=Number(n.dataset.days)||30,e.querySelectorAll(`.chart-period-btn`).forEach(e=>e.classList.toggle(`active`,Number(e.dataset.days)===Yy)),Fy())}),await Fy()}async function Fy(){let e=By(),t=document.getElementById(`traffic-body`),n=document.getElementById(`traffic-range`),r=new Date,i=Vy(r),a=Vy(new Date(r.getTime()-(Yy-1)*864e5));n&&(n.textContent=`${a} → ${i}`);let o,s=null;try{let[t,n]=await Promise.all([b(`${e}/m5t/v5/coreAnalyticsMetrics/overlay?from=${a}&to=${i}`),nl().catch(()=>null)]);j(t),o=await t.json(),s=n}catch(e){console.warn(`[traffic] load failed:`,e),t&&(t.innerHTML=$a(e)?eo():qy(`error`,`Could not load traffic. Please try again.`));return}Iy(s);let c=o.totals||{};if(Ly(`traffic-sessions`,Hy(c.sessions)),Ly(`traffic-users`,Hy(c.users)),Ly(`traffic-views`,Hy(c.page_views)),Ly(`traffic-engagement`,Uy(c.engagement_rate)),Ly(`traffic-leads`,Hy(c.magnet_leads)),Ly(`traffic-leadrate`,Uy(c.lead_rate)),!o.connected){t.innerHTML=s&&!s.denied&&$c(s.providers,`google_analytics`)?qy(`cloud_sync`,`GA4 connected. No traffic for this range yet. Metrics appear here once they sync.`):qy(`link_off`,`No GA4 property connected yet. Connect Google Analytics under Settings, Integrations to see traffic here.`);return}let l=o.rows||[];t.innerHTML=Ry(l),zy(l)}function Iy(e){let t=document.getElementById(`traffic-conn`);if(!t)return;if(!e||e.denied){t.innerHTML=``;return}let n=Gc.google_analytics,r=$c(e.providers,`google_analytics`);if(!r){t.innerHTML=``;return}let i=el(n,r,!!e.configured?.google_analytics);if(i!==`connected`&&i!==`broken`){t.innerHTML=``;return}let a=bl()?` <a href="#/settings/integrations/${n.urlSlug}">Manage</a>`:``;t.innerHTML=`<span>Google Analytics</span> ${tl(i,r)}${a}`}function Ly(e,t){let n=document.getElementById(e);n&&(n.textContent=t)}function Ry(e){return ho({rows:e,xLabel:e=>String(e.date||``).slice(5),left:{value:e=>e.sessions||0,label:`Sessions`,fmt:e=>bo(e)},right:{value:e=>e.magnet_leads||0,label:`Magnet Leads`},ariaLabel:`Website sessions versus magnet leads over time`,pointLabel:e=>`${e.date}: ${Hy(e.sessions||0)} sessions, ${Hy(e.magnet_leads||0)} leads`,hitData:e=>({day:e.date})})}function zy(e){let t=document.getElementById(`traffic-body`);return t?_o(t,{rows:e,tipHTML:e=>`
      <div class="m5c-tip__title">${Gy(String(e.date||``))}</div>
      <div class="m5c-tip__row"><i class="m5c-sw m5c-sw--1"></i>${Hy(e.sessions||0)} sessions</div>
      <div class="m5c-tip__row"><i class="m5c-sw m5c-sw--2"></i>${Hy(e.magnet_leads||0)} leads</div>`}):()=>{}}var By,Vy,Hy,Uy,Wy,Gy,Ky,qy,Jy,Yy,Xy=o((()=>{T(),Qa(),Ol(),fo(),So(),x(),no(),By=()=>w.getConfig?.().BASE_URL||``,Vy=e=>e.toISOString().slice(0,10),Hy=e=>Number(e||0).toLocaleString(),Uy=e=>e==null?`—`:`${e}%`,Wy={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Gy=e=>String(e??``).replace(/[&<>"']/g,e=>Wy[e]),Ky=!1,qy=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Jy=[{d:7,label:`7 Days`},{d:30,label:`30 Days`},{d:90,label:`90 Days`}],Yy=30})),Zy=c({default:()=>Cb,init:()=>eb,render:()=>$y});function Qy(){if(mo(),_b)return;let e=document.createElement(`style`);e.id=`m5t-adperf-styles`,e.textContent=`
    ...
    /* Scope select in the conversions card header (leads-route filter-select pattern). */
    .page-shell .adperf-convsel { font: inherit; font-size: 0.8rem; font-weight: 600; color: var(--color-text-muted, #4A5A78); background: var(--color-bg, #fff); border: 1px solid var(--color-border, #D4DCE8); border-radius: 8px; padding: 4px 8px; max-width: 240px; cursor: pointer; }
    .page-shell .adperf-convsel:focus-visible { outline: 2px solid var(--color-primary-600, #0072BA); outline-offset: 1px; }
  `,document.head.appendChild(e),_b=!0}function $y(){return A()?Ha({section:`ad-performance`,title:`Ad Performance`,description:`Pick a client to view their spend and lead performance.`}):(Qy(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${yb.map(e=>`<button class="chart-period-btn${e.d===bb?` active`:``}" type="button" data-days="${e.d}">${e.label}</button>`).join(``)}
        </div>
      </div>

      <div class="stats-grid" id="adperf-stats">
        ${M({icon:`payments`,label:`Ad Spend`,valueId:`adperf-spend`,href:`#/ad-accounts`})}
        ${M({icon:`ads_click`,label:`Clicks`,valueId:`adperf-clicks`,href:`#/ad-accounts`})}
        ${M({icon:`person_add`,label:`Magnet Leads`,valueId:`adperf-leads`,href:`#/leads`})}
        ${M({icon:`request_quote`,label:`Cost / Lead`,valueId:`adperf-cpl`})}
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-body">
          ${vb(`hourglass_empty`,`Loading ad performance…`)}
        </div>
      </div>
      ...
      <div class="dashboard-card" id="adperf-conv-card" style="display:none">
        <div class="card-header">
          ...
          <select id="adperf-conv-scope" class="adperf-convsel" aria-label="Conversion actions"></select>
          <span class="live-indicator">Reported by Google Ads</span>
        </div>
    ...
    </div>`)}async function eb(){if(A()){let e=e=>Number(e||0).toLocaleString();return Wa(db(),[{h:`Spend`,td:t=>t.ad?`$${e(t.ad.spend)}`:`—`},{h:`Clicks`,td:t=>t.ad?e(t.ad.clicks):`—`},{h:`Leads`,td:t=>e(t.leads.window??t.leads.total)},{h:`CPL`,td:t=>t.ad?.cost_per_lead==null?`—`:`$${e(t.ad.cost_per_lead)}`}],{emptyMsg:`No client orgs yet. Connect a client ad account to see spend here.`})}let e=document.getElementById(`adperf-periods`);e?.addEventListener(`click`,t=>{let n=t.target.closest(`button[data-days]`);n&&(bb=Number(n.dataset.days)||30,e.querySelectorAll(`.chart-period-btn`).forEach(e=>e.classList.toggle(`active`,Number(e.dataset.days)===bb)),tb())}),document.getElementById(`adperf-sources`)?.addEventListener(`click`,e=>{let t=e.target.closest(`tr[data-campaign]`);t&&(ro(oo.LEADS_SEARCH,t.dataset.campaign),!e.target.closest(`a`)&&(window.location.hash=`#/leads`))}),document.getElementById(`adperf-conv-scope`)?.addEventListener(`change`,e=>{xb=e.target.value||`all`,ib()}),document.getElementById(`adperf-lsa-card`)?.addEventListener(`click`,e=>{let t=e.target.closest(`tr[data-lsalead]`);t&&(ro(oo.LEADS_SEARCH,t.dataset.lsalead),!e.target.closest(`a`)&&(window.location.hash=`#/leads`))}),await tb()}async function tb(){let e=db(),t=document.getElementById(`adperf-body`),n=document.getElementById(`adperf-range`),r=new Date,i=fb(r),a=fb(new Date(r.getTime()-(bb-1)*864e5));n&&(n.textContent=`${a} → ${i}`);let o,s=[],c=null,l=null,u=null,d=null;try{let[t,n,r,f,p,m]=await Promise.all([b(`${e}/m5t/v5/coreAdMetrics/overlay?from=${a}&to=${i}`),b(`${e}/m5t/v5/coreAdAccount`),b(`${e}/m5t/v5/coreAdMetrics/by-source?from=${a}&to=${i}`),nl().catch(()=>null),b(`${e}/m5t/v5/coreAdMetrics/conversions?from=${a}&to=${i}${rb()}`).then(e=>e.json()).catch(()=>null),b(`${e}/m5t/v5/coreAdMetrics/lsa?from=${a}&to=${i}`).then(e=>e.json()).catch(()=>null)]);j(t),o=await t.json(),s=((await n.json().catch(()=>({})))?.data||[]).filter(e=>e.status!==`DELETED`),c=await r.json().catch(()=>null),l=f,u=p,d=m}catch(e){console.warn(`[ad-performance] load failed:`,e),t&&(t.innerHTML=$a(e)?eo():vb(`error`,`Could not load ad performance. Please try again.`));return}nb(l,s),Sb=o?.totals?.spend??null,ab(u,Sb),ob(d);let f=o.totals||{};if(cb(`adperf-spend`,pb(f.spend)),cb(`adperf-clicks`,mb(f.clicks)),cb(`adperf-leads`,mb(f.magnet_leads)),cb(`adperf-cpl`,pb(f.cost_per_lead)),sb(c),!s.length){t.innerHTML=vb(`link_off`,`No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.`);return}if(!o.connected){t.innerHTML=vb(`cloud_sync`,`Account connected. No ad data for this range yet. Metrics appear here once they sync.`);return}let p=o.rows||[];t.innerHTML=lb(p),ub(p)}function nb(e,t){let n=document.getElementById(`adperf-conn`);if(!n)return;if(!e||e.denied){n.innerHTML=``;return}let r=Gc.google_ads,i=$c(e.providers,`google_ads`),a=el(r,i,!!e.configured?.google_ads),o=bl()?` <a href="#/settings/integrations/${r.urlSlug}">Manage</a>`:``;if(a===`connected`||a===`broken`){gl(),n.innerHTML=`<span>Google Ads</span> ${tl(a,i)}${o}`;return}if(t.length){n.innerHTML=`<span>Google Ads</span> <span>${t.length} associated account${t.length===1?``:`s`}</span>`;return}n.innerHTML=``}function rb(){return xb===`saved`?``:`&actions=${encodeURIComponent(xb)}`}async function ib(){let e=db(),t=new Date,n=fb(t);ab(await b(`${e}/m5t/v5/coreAdMetrics/conversions?from=${fb(new Date(t.getTime()-(bb-1)*864e5))}&to=${n}${rb()}`).then(e=>e.json()).catch(()=>null),Sb)}function ab(e,t){let n=document.getElementById(`adperf-conv-card`),r=document.getElementById(`adperf-conv-body`),i=document.getElementById(`adperf-stats`),a=document.getElementById(`adperf-conv-stat`);a&&a.remove();let o=document.getElementById(`adperf-conv-cpc`);if(o&&o.remove(),!n||!r)return;let s=e?.available||[],c=e?.saved_ids||[],l=e?.actions||[];if(!e?.ok||!s.length&&!c.length&&!l.length){n.style.display=`none`;return}let u=document.getElementById(`adperf-conv-scope`);if(u){let e=[{v:`all`,label:`All conversion actions`}];c.length&&e.push({v:`saved`,label:`Counted actions`});for(let t of s)e.push({v:String(t.id),label:t.name||String(t.id)});e.some(e=>e.v===xb)||(xb=`all`),u.innerHTML=e.map(e=>`<option value="${gb(e.v)}"${e.v===xb?` selected`:``}>${gb(e.label)}</option>`).join(``)}let d=Number(e.totals?.all_conversions??e.totals?.conversions??0);if(i){let e=document.createElement(`div`);e.innerHTML=M({icon:`flag`,label:`Ads Conversions`,value:mb(d),sub:`Reported by Google Ads`,href:`#/settings/integrations/google-ads`});let n=e.firstElementChild;n.id=`adperf-conv-stat`,i.appendChild(n);let r=t!=null&&d>0?Math.round(Number(t)/d*100)/100:null,a=document.createElement(`div`);a.innerHTML=M({icon:`request_quote`,label:`Cost / Conversion`,value:pb(r),sub:`Against the selected actions`,href:`#/analytics/conversions`});let o=a.firstElementChild;o.id=`adperf-conv-cpc`,i.appendChild(o)}if(n.style.display=``,!l.length){r.innerHTML=vb(`search_off`,`No conversions in this range for the selected actions.`);return}let f=l.some(e=>(e.all_value??e.value)>0);r.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        <thead><tr><th>Conversion action</th><th>Category</th><th class="num">All conv.</th><th class="num">Counted</th>${f?`<th class="num">Value</th>`:``}</tr></thead>
        <tbody>${l.map(e=>`
          <tr>
            <td>${gb(e.name||e.id)}</td>
            <td class="adperf-src-sub">${gb(String(e.category||``).toLowerCase().replace(/_/g,` `)||`—`)}</td>
            <td class="num"><b>${mb(e.all_conversions??e.conversions)}</b></td>
            <td class="num">${mb(e.conversions)}</td>
            ${f?`<td class="num">${pb(e.all_value??e.value)}</td>`:``}
          </tr>`).join(``)}
        </tbody>
      </table>
    </div>
    <p class="adperf-note">Counted actions are chosen on the Google Ads integration page. All conv. counts every conversion action Google recorded, including actions outside the campaign bidding goals. These are Google's own numbers and may overlap magnet leads, so they are never added together.</p>`}function ob(e){let t=document.getElementById(`adperf-lsa-card`),n=document.getElementById(`adperf-lsa-body`);if(!t||!n)return;if(!e?.ok||!e.connected){t.style.display=`none`;return}t.style.display=``;let r=e.totals||{},i=e.leads||[],a=e.disputes||[],o=r.answer_rate==null?`No call outcomes yet`:r.missed>0?`${mb(r.missed)} missed call${r.missed===1?``:`s`}`:`Every call answered`;n.innerHTML=`
    ${`
    <div class="stats-grid" style="margin-bottom:16px">
      ${M({icon:`payments`,label:`LSA Spend`,value:pb(r.spend),sub:`Reported by Google`})}
      ${M({icon:`person_add`,label:`LSA Leads`,value:mb(r.leads),sub:`${mb(r.phone_calls)} calls · ${mb(r.messages)} messages`})}
      ${M({icon:`paid`,label:`Charged`,value:mb(r.charged),sub:`Leads Google billed for`})}
      ${M({icon:`request_quote`,label:`Cost / Charged Lead`,value:pb(r.cost_per_charged_lead)})}
      ${M({icon:`call`,label:`Answer Rate`,value:r.answer_rate==null?`—`:`${r.answer_rate}%`,sub:o})}
      ${M({icon:`event_available`,label:`Booked`,value:mb(r.booked),sub:`Google's lead status`})}
    </div>`}
    ${i.length?`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${i.map(e=>{let t=e.phone||e.name,n=e.captured_at?new Date(e.captured_at).toLocaleDateString([],{month:`short`,day:`numeric`}):`—`;return`
          <tr${t?` data-lsalead="${gb(t)}" class="adperf-srcrow--link"`:``}>
            <td>${t?`<a class="adperf-srclink" href="#/leads" title="Open this lead">${gb(e.name)}</a>`:gb(e.name)}</td>
            <td class="adperf-src-sub">${gb([e.phone,e.email].filter(Boolean).join(` · `)||`—`)}</td>
            <td>${gb(e.type||`—`)}${e.missed?` <span class="adperf-src-untracked">· missed</span>`:``}</td>
            <td class="adperf-src-sub">${gb(e.category||`—`)}</td>
            <td class="adperf-src-sub">${gb(String(e.lsa_status||`—`).toLowerCase())}${e.dispute?` <span class="adperf-src-untracked">· dispute candidate</span>`:``}</td>
            <td class="num">${e.charged?`<b>yes</b>`:`<span class="adperf-src-sub">no</span>`}</td>
            <td class="adperf-src-sub">${gb(n)}</td>
          </tr>`}).join(``)}
        </tbody>
      </table>
    </div>`:vb(`search_off`,`No Local Services leads in this range yet.`)}
    ${a.length?`
    <div class="card-header" style="padding:16px 0 0">
      ...
      <span class="live-indicator">${mb(a.length)} inside the 30 day credit window</span>
    </div>
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${a.map(e=>`
          <tr>
            <td>${gb(e.name)}${e.phone?` <span class="adperf-src-sub">${gb(e.phone)}</span>`:``}</td>
            <td class="adperf-src-sub">${gb(e.reason)}</td>
            <td class="num"><b>${mb(e.days_left)}</b></td>
          </tr>`).join(``)}
        </tbody>
      </table>
    </div>
    ...
    <p class="adperf-note">Numbers come from Google's Local Services feed. These leads land in your Leads inbox and do not flow through magnets.</p>`;let s=n.querySelector(`.adperf-srctable tbody`);s&&O(s,{rowSelector:`tr`,noun:`leads`,controlHost:n.querySelector(`.adperf-srcwrap`)||n})}function sb(e){let t=document.getElementById(`adperf-sources`),n=document.getElementById(`adperf-src-summary`);if(!t)return;let r=e&&Array.isArray(e.rows)?e.rows:[];if(!r.length){n&&(n.textContent=``),t.innerHTML=vb(`search_off`,`No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.`);return}let i=e.total_leads||r.reduce((e,t)=>e+(t.leads||0),0),a=e.tracked_leads||0;n&&(n.textContent=`${mb(a)} of ${mb(i)} leads tagged to a source`);let o=e=>e.campaign&&e.campaign!==`(none)`?gb(e.campaign):e.source&&e.source!==`(direct)`?gb(e.source):`<span class="adperf-src-untracked">Untracked / direct</span>`,s=e=>e.campaign&&e.campaign!==`(none)`?e.campaign:e.source&&e.source!==`(direct)`?e.source:``;t.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${r.map(e=>{let t=s(e);return`
          <tr${t?` data-campaign="${gb(t)}" class="adperf-srcrow--link"`:``}>
            <td>${t?`<a class="adperf-srclink" href="#/leads" title="Show the leads from ${gb(t)}">${o(e)}</a>`:o(e)}</td>
            <td class="adperf-src-sub">${gb(e.source||`—`)}${e.medium?` · ${gb(e.medium)}`:``}</td>
            <td class="num">${e.paid_clicks?mb(e.paid_clicks):`<span class="adperf-src-sub">—</span>`}</td>
            <td class="num"><b>${mb(e.leads)}</b></td>
          </tr>`}).join(``)}
        </tbody>
      </table>
    </div>`;let c=t.querySelector(`.adperf-srctable tbody`);c&&O(c,{rowSelector:`tr`,noun:`sources`,controlHost:t.querySelector(`.adperf-srcwrap`)||t})}function cb(e,t){let n=document.getElementById(e);n&&(n.textContent=t)}function lb(e){return ho({rows:e,xLabel:e=>String(e.date||``).slice(5),left:{value:e=>e.spend||0,label:`Ad Spend`,fmt:e=>`$${bo(e)}`},right:{value:e=>e.magnet_leads||0,label:`Magnet Leads`},ariaLabel:`Ad spend versus magnet leads over time`,pointLabel:e=>`${e.date}: ${pb(e.spend||0)} spend, ${mb(e.magnet_leads||0)} leads`,hitData:e=>({day:e.date})})}function ub(e){let t=document.getElementById(`adperf-body`);return t?_o(t,{rows:e,tipHTML:e=>`
      <div class="m5c-tip__title">${gb(String(e.date||``))}</div>
      <div class="m5c-tip__row"><i class="m5c-sw m5c-sw--1"></i>${pb(e.spend||0)} spend</div>
      <div class="m5c-tip__row"><i class="m5c-sw m5c-sw--2"></i>${mb(e.magnet_leads||0)} leads</div>`}):()=>{}}var db,fb,pb,mb,hb,gb,_b,vb,yb,bb,xb,Sb,Cb,wb=o((()=>{T(),Qa(),Ol(),fo(),So(),An(),co(),x(),no(),db=()=>w.getConfig?.().BASE_URL||``,fb=e=>e.toISOString().slice(0,10),pb=e=>e==null?`—`:`$`+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),mb=e=>Number(e||0).toLocaleString(),hb={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},gb=e=>String(e??``).replace(/[&<>"']/g,e=>hb[e]),_b=!1,vb=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,yb=[{d:7,label:`7 Days`},{d:30,label:`30 Days`},{d:90,label:`90 Days`}],bb=30,xb=`all`,Sb=null,Cb={render:$y,init:eb}})),Tb=c({default:()=>Jb,init:()=>kb,parseBookingCsv:()=>Vb,render:()=>Db});function Eb(){if(Gb)return;let e=document.createElement(`style`);e.id=`m5t-adacct-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Gb=!0}function Db(){return A()?Ha({section:`ad-accounts`,title:`Ad Accounts`,description:`Pick a client to see their connected ad accounts.`}):(Eb(),gl(),`
    ...
    </div>`)}async function Ob(e){let t=e.currentTarget,n=document.getElementById(`adacct-probe-result`);t.disabled=!0,n&&(n.textContent=`Asking Google to validate a test payload…`);try{let e=await(await b(`${I()}/m5t/v5/integrations/google_ads/conversion_probe`,{method:`POST`,headers:{"Content-Type":`application/json`},body:`{}`})).json();if(!e.ok)throw Error(e.error||`probe failed`);let t=e.data||{};n&&(n.textContent=t.ok?`Pass. Google validated the pipe end to end on account ${t.account}: connection, developer token, and the provisioned conversion actions all check out. Real conversions will upload the same way.`:`Stopped at ${t.stage}: ${t.message}`)}catch(e){n&&(n.textContent=e.message||`Probe failed. Please try again.`)}finally{t.disabled=!1}}async function kb(){if(A()){let e=e=>Number(e||0).toLocaleString();return Wa(I(),[{h:`Spend`,td:t=>t.ad?`$${e(t.ad.spend)}`:`—`},{h:`Leads`,td:t=>e(t.leads.window??t.leads.total)},{h:`CPL`,td:t=>t.ad?.cost_per_lead==null?`—`:`$${e(t.ad.cost_per_lead)}`}],{emptyMsg:`No client orgs yet. Connect a client ad account to see it here.`})}await Ab()}async function Ab(){let[e,t,n]=await Promise.all([nl().catch(()=>null),b(`${I()}/m5t/v5/coreAdAccount`).then(e=>e.json()).catch(()=>null),b(`${I()}/m5t/v5/coreAdMetrics/conversions`).then(e=>e.json()).catch(()=>null)]);jb(e,n),Mb(t),Pb(t)}function jb(e,t){let n=document.getElementById(`adacct-conn`);if(!n)return;let r=Gc.google_ads;if(e?.denied){n.innerHTML=xl(`link_off`,`Connection status is not available for your role.`);return}if(!e){n.innerHTML=xl(`error`,`Could not load the connection status. Please try again.`);return}let i=$c(e.providers,`google_ads`),a=el(r,i,!!e.configured?.google_ads),o=i?.external_account||{},s=r.card.reachableCount(o),c;c=a===`connected`?s?`${s} reachable account${s===1?``:`s`}.`:`Connected.`:a===`broken`?r.card.brokenDesc:a===`unavailable`?`Google Ads is being set up for this platform.`:bl()?`Not connected yet. Connect from Settings to pull spend and clicks.`:`Not connected yet.`;let l=bl()&&a!==`unavailable`?`<a class="adacct-manage" href="#/settings/integrations/${r.urlSlug}"><span class="material-symbols-outlined" aria-hidden="true">${a===`idle`?`link`:`settings`}</span>${a===`idle`?`Connect`:`Manage`}</a>`:``,u=``;if(t?.ok&&t.has_selection){let e=(t.actions||[]).map(e=>e.name||e.id),n=(t.selected_ids||[]).length-e.length;u=`
      <div class="adacct-chips">Counted in reporting:
        ${e.map(e=>`<span class="adacct-chip">${P(e)}</span>`).join(``)}
        ${n>0?`<span class="adacct-chip">${n} more</span>`:``}
      </div>`}n.innerHTML=`
    <div class="adacct-conn">
      ${Qc(r)}
      <div class="adacct-conn__titles">
        <span class="adacct-conn__name">${P(r.label)} ${tl(a,i)}</span>
        <span class="adacct-conn__sub">${P(c)}</span>
      </div>
      <span class="adacct-conn__spacer"></span>
      ${l}
    </div>
    ${u}`}function Mb(e){let t=document.getElementById(`adacct-list`),n=document.getElementById(`adacct-count`);if(!t)return;if(!e||e.ok===!1){t.innerHTML=xl(`error`,`Could not load ad accounts. Please try again.`);return}let r=(e.data||[]).filter(e=>e.status!==`DELETED`),i=!!e.canConnect;if(n&&(n.textContent=r.length?`${r.length} account${r.length===1?``:`s`}`:``),!r.length){t.innerHTML=xl(`link_off`,i?`No ad accounts associated yet.`:`No ad accounts yet. Your agency connects these for you.`)+(i?`<p class="adacct-note">Associate a client's Customer ID from the <a href="#/clients">Clients page</a>.</p>`:``);return}let a=e=>{let t=Object.keys(e.account_config?.magnet_actions||{}).length;if(!e.connection_guid)return`<span class="adacct-chip">Needs the account linked first</span>`;if(t>=4)return`<span class="m5t-badge" data-tone="success">${t} of 4 created</span>`;let n=t?`Generate missing (${t} of 4)`:`Generate`;return`${t?`<span class="m5t-badge" data-tone="warning">${t} of 4 created</span> `:`<span class="adacct-chip">Not created yet</span> `}`+(i?`<button type="button" class="adacct-manage" data-provision="${P(e.guid)}"><span class="material-symbols-outlined" aria-hidden="true">bolt</span>${n}</button>`:``)};t.innerHTML=`
    <div class="adacct-wrap">
      <table class="adacct-table">
        <thead><tr><th>Platform</th><th>Customer ID</th><th>Status</th><th>Conversion actions</th></tr></thead>
        <tbody>${r.map(e=>`
          <tr>
            <td>${P(Ub[e.provider]||e.provider)}</td>
            <td class="adacct-cid">${P(Wb(e.external_customer_id))}</td>
            <td><span class="m5t-badge" data-tone="${e.status===`ACTIVE`?`success`:`warning`}">${P(e.status===`ACTIVE`?`Active`:e.status)}</span></td>
            <td>${a(e)}</td>
          </tr>`).join(``)}
        </tbody>
      </table>
    </div>
    ${i?`<p class="adacct-note">Associations are managed per client from the <a href="#/clients">Clients page</a>. Generate creates the four Magnet conversion actions in that Google Ads account, under fixed names. Nothing is created until you press it.</p>`:``}`;let o=t.querySelector(`.adacct-table tbody`);o&&O(o,{rowSelector:`tr`,noun:`accounts`,controlHost:t.querySelector(`.adacct-wrap`)||t}),t.querySelectorAll(`button[data-provision]`).forEach(e=>e.addEventListener(`click`,()=>Nb(e)))}async function Nb(e){let t=e.dataset.provision;e.disabled=!0,e.textContent=`Creating in Google Ads…`;try{let e=await(await b(`${I()}/m5t/v5/integrations/google_ads/provision_actions`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({account_guid:t})})).json();if(!e.ok)throw Error(e.error||`provisioning failed`);let n=(e.accounts||[])[0]||{},r=(n.created||[]).length,i=(n.adopted||[]).length;F(`Done. ${r} action${r===1?``:`s`} created${i?`, ${i} already existed and were adopted`:``}. See them in Google Ads under Goals, then Conversions.`,`success`),Ab()}catch(t){F(`Could not create the actions: ${t.message}. Press Generate again to retry, anything already created is kept and adopted.`,`error`),e.disabled=!1,e.textContent=`Generate`}}function Pb(e){let t=document.getElementById(`adacct-offline`);if(t){if(!e?.canConnect){t.style.display=`none`;return}t.style.display=``,document.getElementById(`adacct-oc-dl`)?.addEventListener(`click`,zb),document.getElementById(`adacct-oc-up`)?.addEventListener(`click`,Rb),document.getElementById(`adacct-probe`)?.addEventListener(`click`,Ob),document.getElementById(`adacct-mc-file`)?.addEventListener(`change`,Bb),Fb()}}async function Fb(){Kb=[];try{let e=await(await b(`${I()}/m5t/v5/integrations/google_ads/conversion_actions`)).json();if(!e.ok)return;let t=e.data.actions||[];if(Kb=t.filter(e=>e.type===`UPLOAD_CLICKS`&&(e.account_ids||[]).length),!Kb.length){if(t.length){let e=document.getElementById(`adacct-oc-result`);e&&(e.textContent=`Direct upload needs an import type conversion action in Google Ads. The CSV works either way.`)}return}let n=document.getElementById(`adacct-oc-target`);n&&(n.innerHTML=Kb.map(e=>`<option value="${P(e.id)}">${P(e.name||e.id)}</option>`).join(``)),document.getElementById(`adacct-oc-target-wrap`)?.style.setProperty(`display`,``),document.getElementById(`adacct-oc-up`)?.style.setProperty(`display`,``)}catch{}}function Ib(){let e=document.getElementById(`adacct-oc-target`)?.value;return Kb.find(t=>t.id===e)||Kb[0]||null}async function Lb(e,t){let n=Ib();if(!n){t&&(t.textContent=`Pick an upload target first.`);return}let r=document.getElementById(`adacct-oc-value`)?.value,i=r!==``&&r!=null&&Number.isFinite(Number(r))?Number(r):null;t&&(t.textContent=`Uploading ${e.length} conversion${e.length===1?``:`s`}…`);try{let r=await(await b(`${I()}/m5t/v5/integrations/google_ads/upload_conversions`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({customer_id:n.account_ids[0],conversion_action_id:n.id,rows:e.map(e=>i==null?e:{...e,value:i})})})).json();if(!r.ok)throw Error(r.error||`upload failed`);let a=[`${r.data.uploaded} uploaded to Google Ads.`];r.data.failed&&a.push(`${r.data.failed} rejected${r.data.errors?.[0]?`: ${r.data.errors[0]}`:`.`}`),t&&(t.textContent=a.join(` `))}catch(e){t&&(t.textContent=e.message===`upload failed`?`Upload failed. Please try again.`:`Upload failed: ${e.message}`)}}async function Rb(){let e=document.getElementById(`adacct-oc-result`),t=Number(document.getElementById(`adacct-oc-days`)?.value)||90,n=[...document.querySelectorAll(`#adacct-oc-statuses input:checked`)].map(e=>e.value);if(!n.length){e&&(e.textContent=`Pick at least one status.`);return}let r=e=>e.toISOString().slice(0,10),i=r(new Date),a=r(new Date(Date.now()-(t-1)*864e5)),o=new URLSearchParams({from:a,to:i,statuses:n.join(`,`),format:`json`});try{let t=await(await b(`${I()}/m5t/v5/coreAdMetrics/offline-conversions.csv?${o}`)).json();if(!t.ok)throw Error();if(!t.rows.length){e&&(e.textContent=`No leads with a click id in that window.`);return}await Lb(t.rows,e)}catch{e&&(e.textContent=`Upload failed. Please try again.`)}}async function zb(){let e=document.getElementById(`adacct-oc-result`),t=Number(document.getElementById(`adacct-oc-days`)?.value)||90,n=[...document.querySelectorAll(`#adacct-oc-statuses input:checked`)].map(e=>e.value);if(!n.length){e&&(e.textContent=`Pick at least one status.`);return}let r=document.getElementById(`adacct-oc-name`)?.value?.trim()||`M5M magnet lead`,i=document.getElementById(`adacct-oc-value`)?.value,a=e=>e.toISOString().slice(0,10),o=a(new Date),s=a(new Date(Date.now()-(t-1)*864e5)),c=new URLSearchParams({from:s,to:o,statuses:n.join(`,`),name:r});i!==``&&i!=null&&Number.isFinite(Number(i))&&c.set(`value`,i),e&&(e.textContent=`Building the export…`);try{let t=await b(`${I()}/m5t/v5/coreAdMetrics/offline-conversions.csv?${c}`);if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.text(),r=Math.max(0,n.trim().split(`
`).length-1);Hb(n,`google-ads-conversions-${s}-to-${o}.csv`),e&&(e.textContent=r?`${r} conversion${r===1?``:`s`} in the file.`:`No leads with a click id in that window. The file has headers only.`)}catch{e&&(e.textContent=`Export failed. Please try again.`)}}async function Bb(e){let t=document.getElementById(`adacct-mc-result`),n=e.target.files?.[0];if(!n)return;let r=Vb(await n.text());if(!r.length){t&&(t.textContent=`No usable rows found. The CSV needs an email or phone column.`);return}t&&(t.textContent=`Matching ${r.length} row${r.length===1?``:`s`}…`);try{let e=await(await b(`${I()}/m5t/v5/coreAdMetrics/offline-conversions/match`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({rows:r})})).json();if(!e.ok)throw Error(e.error||`match failed`);let n=[`${e.matched_count} of ${r.length} rows matched a magnet lead with a click id.`];if(e.unmatched_count&&n.push(`${e.unmatched_count} had no matching lead.`),e.no_click_count&&n.push(`${e.no_click_count} matched a lead without a click id.`),!e.matched_count){t&&(t.textContent=n.join(` `));return}let i=document.getElementById(`adacct-oc-name`)?.value?.trim()||`M5M magnet lead`,a=document.getElementById(`adacct-oc-value`)?.value,o=a!==``&&a!=null&&Number.isFinite(Number(a))?Number(a):``,s=e=>`"${String(e??``).replace(/"/g,`""`)}"`,c=[`Google Click ID,Conversion Name,Conversion Time,Conversion Value,Conversion Currency`,...e.matched.map(e=>[s(e.gclid),s(i),s(e.time),o,``].join(`,`))].join(`\r
`)+`\r
`;if(qb=e.matched.map(e=>({gclid:e.gclid,time:e.time})),t){t.innerHTML=``;let e=document.createElement(`span`);e.textContent=n.join(` `)+` `;let r=document.createElement(`button`);if(r.type=`button`,r.className=`adacct-manage`,r.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">download</span>Download matched CSV`,r.addEventListener(`click`,()=>Hb(c,`google-ads-conversions-matched-${new Date().toISOString().slice(0,10)}.csv`)),t.append(e,r),Kb.length){let e=document.createElement(`button`);e.type=`button`,e.className=`adacct-manage`,e.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">cloud_upload</span>Upload to Google Ads`,e.addEventListener(`click`,()=>Lb(qb,t)),t.append(` `,e)}}}catch{t&&(t.textContent=`Matching failed. Please try again.`)}finally{e.target.value=``}}function Vb(e){let t=[],n=[],r=``,i=!1;for(let a=0;a<e.length;a++){let o=e[a];i?o===`"`&&e[a+1]===`"`?(r+=`"`,a++):o===`"`?i=!1:r+=o:o===`"`?i=!0:o===`,`?(n.push(r),r=``):o===`
`||o===`\r`?(o===`\r`&&e[a+1]===`
`&&a++,n.push(r),r=``,n.some(e=>e.trim()!==``)&&t.push(n),n=[]):r+=o}if(n.push(r),n.some(e=>e.trim()!==``)&&t.push(n),t.length<2)return[];let a=t[0].map(e=>e.trim().toLowerCase()),o=a.findIndex(e=>/e-?mail/.test(e)),s=a.findIndex(e=>/phone|mobile|tel/.test(e)),c=a.findIndex(e=>/date|time|booked|appointment|start/.test(e));return o<0&&s<0?[]:t.slice(1).map(e=>({email:o>=0?(e[o]||``).trim():``,phone:s>=0?(e[s]||``).trim():``,at:c>=0?(e[c]||``).trim():``})).filter(e=>e.email||e.phone).slice(0,5e3)}function Hb(e,t){let n=new Blob([e],{type:`text/csv;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,document.body.appendChild(i),i.click(),i.remove(),setTimeout(()=>URL.revokeObjectURL(r),4e3)}var Ub,Wb,Gb,Kb,qb,Jb,Yb=o((()=>{Qa(),An(),Ol(),x(),Ub={google_ads:`Google Ads`,google_lsa:`Local Services Ads`},Wb=e=>{let t=String(e||``).replace(/\D/g,``);return t.length===10?`${t.slice(0,3)}-${t.slice(3,6)}-${t.slice(6)}`:String(e||``)},Gb=!1,Kb=[],qb=null,Jb={render:Db,init:kb}})),Xb=c({default:()=>vx,init:()=>ix,openInviteModal:()=>cx,render:()=>rx});function Zb(e,t=`info`){try{dx.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}}function Qb(){let e=w.getActiveOrg();if(e&&e.channel===fx)return{guid:e.guid,name:e.name};let t=w.getMemberships().find(e=>e.channel===fx);return t?{guid:t.orgGuid,name:t.name}:null}function $b(e){let t=e?.created_tz;if(!t)return``;let n=new Date(t);return Number.isNaN(n.getTime())?``:n.toLocaleDateString(void 0,{year:`numeric`,month:`short`,day:`numeric`})}function ex(){if(mx)return;let e=document.createElement(`style`);e.id=`m5t-clients-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Hr(),mx=!0}function tx(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function nx(e){let t=e.caption||e.guid,n=e.status||`ENABLED`;return`
    <div class="client-row">
      <span class="client-row__avatar">${Y(gx(t))}</span>
      <span class="client-row__main">
        <div class="client-row__name" title="${Y(t)}">${Y(t)}</div>
        <div class="client-row__meta">Added ${Y($b(e.created))||`—`}</div>
      </span>
      ...
      <div class="client-row__btns">
        ...
        ${w.getCapabilities().includes(`connect_ad_accounts`)?`
    ...
    <div class="page-shell" data-section="clients">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="clients-body">
          ${tx(`hourglass_empty`,`Loading clients…`)}
        </div>
      </div>
    </div>`}async function ix(){let e=Qb();document.getElementById(`clients-add-btn`)?.addEventListener(`click`,()=>ox(e)),await ax(e)}async function ax(e){let t=document.getElementById(`clients-body`),n=document.getElementById(`clients-count`);if(t){if(!e?.guid){t.innerHTML=tx(`info`,`Client provisioning is available to reseller / agency accounts.`),n&&(n.textContent=``);return}try{let r=await b(`${w.getConfig?.().BASE_URL||``}/m5t/v5/acctGroup`);j(r);let i=await r.json(),a=(Array.isArray(i?.data)?i.data:[]).filter(t=>t.class===px&&(!t.parent||t.parent===e.guid));if(!a.length){t.innerHTML=tx(`group_off`,`No clients yet. Add your first client to start managing magnets on their behalf.`),n&&(n.textContent=``);return}t.innerHTML=`<div class="client-list">${a.map(nx).join(``)}</div>`,O(t.querySelector(`.client-list`),{rowSelector:`.client-row`,noun:`clients`}),n&&(n.textContent=`${a.length} client${a.length===1?``:`s`}`),t.querySelectorAll(`.client-card__invite`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.action===`adaccounts`?sx(e.dataset.clientGuid,e.dataset.clientName):e.dataset.action===`questionnaire`?ux(e.dataset.clientGuid,e.dataset.clientName):cx(e.dataset.clientGuid,e.dataset.clientName)})})}catch(e){console.warn(`[clients] load failed:`,e),t.innerHTML=$a(e)?eo():tx(`error`,`Couldn’t load clients. Please try again.`),n&&(n.textContent=``)}}}function ox(e){if(!e?.guid){Zb(`Only reseller / agency accounts can add clients.`,`error`);return}let t=document.createElement(`div`);t.className=`client-modal-scrim`;let n=document.createElement(`div`);n.className=`client-modal`,n.setAttribute(`role`,`dialog`),n.setAttribute(`aria-modal`,`true`),n.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),document.body.appendChild(n),requestAnimationFrame(()=>{t.classList.add(`open`),n.classList.add(`open`)});let r=n.querySelector(`#client-name-input`),i=n.querySelector(`#client-modal-error`),a=n.querySelector(`[data-act="create"]`);r?.focus();let o=()=>{t.classList.remove(`open`),n.classList.remove(`open`),document.removeEventListener(`keydown`,s),setTimeout(()=>{t.remove(),n.remove()},200)},s=e=>{e.key===`Escape`&&o()};document.addEventListener(`keydown`,s),t.addEventListener(`click`,o),n.querySelector(`.client-modal__close`)?.addEventListener(`click`,o),n.querySelector(`[data-act="cancel"]`)?.addEventListener(`click`,o);let c=async()=>{let t=(r?.value||``).trim();if(i.textContent=``,!t){i.textContent=`Please enter a client name.`,r?.focus();return}a.disabled=!0;let n=a.innerHTML;a.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Adding…`;try{let n=await b(`${w.getConfig?.().BASE_URL||``}/m5t/v5/acctGroup`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({class:px,caption:t,parent:e.guid})}),r=await n.json().catch(()=>({}));if(!n.ok||!r?.ok){let e=n.status===403?`You are not authorized to add a client here.`:r?.message||r?.error||`Failed (HTTP ${n.status})`;throw Error(e)}Zb(`Added client “${t}”`,`success`),o(),await ax(e)}catch(e){console.warn(`[clients] create failed:`,e),i.textContent=e.message||`Something went wrong. Please try again.`,a.disabled=!1,a.innerHTML=n}};a?.addEventListener(`click`,c),r?.addEventListener(`keydown`,e=>{e.key===`Enter`&&c()})}async function sx(e,t){let n=w.getConfig?.().BASE_URL||``,r={};try{let t=await b(`${n}/m5t/v5/coreAdAccount?owner_guid=${encodeURIComponent(e)}`),i=await t.json().catch(()=>({}));if(!t.ok)throw Error(`Failed to load ad accounts (${t.status})`);(i?.data||[]).forEach(e=>{r[e.provider]=e})}catch(e){console.warn(`[clients] ad-accounts prefill failed:`,e)}let i=r.google_ads,a=r.google_lsa,o=document.createElement(`div`);o.className=`client-modal-scrim`;let s=document.createElement(`div`);s.className=`client-modal`,s.setAttribute(`role`,`dialog`),s.setAttribute(`aria-modal`,`true`),s.innerHTML=`
    <div class="client-modal__head">
    ...
    </div>`,document.body.appendChild(o),document.body.appendChild(s),requestAnimationFrame(()=>{o.classList.add(`open`),s.classList.add(`open`)});let c=s.querySelector(`#aa-error`),l=s.querySelector(`[data-act="save"]`),u=()=>{o.classList.remove(`open`),s.classList.remove(`open`),document.removeEventListener(`keydown`,d),setTimeout(()=>{o.remove(),s.remove()},200)},d=e=>{e.key===`Escape`&&u()};document.addEventListener(`keydown`,d),o.addEventListener(`click`,u),s.querySelector(`.client-modal__close`)?.addEventListener(`click`,u),s.querySelector(`[data-act="cancel"]`)?.addEventListener(`click`,u);let f=(t,r,i)=>{let a=`${n}/m5t/v5/coreAdAccount`;return r&&!i?b(a,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({owner_guid:e,provider:t,external_customer_id:r})}):r&&i&&r!==i.external_customer_id?b(`${a}/${encodeURIComponent(i.guid)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({external_customer_id:r})}):!r&&i?b(`${a}/${encodeURIComponent(i.guid)}`,{method:`DELETE`}):null};l?.addEventListener(`click`,async()=>{c.textContent=``;let e=_x(s.querySelector(`#aa-gads`).value),t=_x(s.querySelector(`#aa-lsa`).value),n=[f(`google_ads`,e,i),f(`google_lsa`,t,a)].filter(Boolean);if(!n.length){u();return}l.disabled=!0;let r=l.innerHTML;l.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…`;try{let e=await Promise.all(n);for(let t of e)if(!t.ok){let e=await t.json().catch(()=>({}));throw Error(t.status===403?`You are not authorized to connect accounts for this client.`:e?.error||e?.message||`Failed (HTTP ${t.status})`)}Zb(`Ad accounts updated`,`success`),u()}catch(e){c.textContent=e.message||`Something went wrong. Please try again.`,l.disabled=!1,l.innerHTML=r}})}function cx(e,t){if(!e)return;let n=document.createElement(`div`);n.className=`client-modal-scrim`;let r=document.createElement(`div`);r.className=`client-modal`,r.setAttribute(`role`,`dialog`),r.setAttribute(`aria-modal`,`true`),r.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="invite-body">
      ...
      <div class="client-modal__actions">
        ...
        </div>`,t.querySelectorAll(`.invite-pending__copy`).forEach(l)}catch{t.innerHTML=``}})(),c?.addEventListener(`click`,async()=>{let t=(r.querySelector(`#inv-email`).value||``).trim(),n=(r.querySelector(`#inv-first`).value||``).trim(),a=(r.querySelector(`#inv-last`).value||``).trim();if(s.textContent=``,!t||!n||!a){s.textContent=`Email, first, and last name are required.`;return}c.disabled=!0;let o=c.innerHTML;c.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Sending…`;try{let o=await b(`${w.getConfig?.().BASE_URL||``}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invite`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({email:t,first:n,last:a,member_role:`viewer`})}),s=await o.json().catch(()=>({}));if(!o.ok||!s.ok){let e=o.status===409?`A user with that email already exists.`:o.status===403?`You are not authorized to invite for this client.`:s.message||s.error||`Failed (HTTP ${o.status})`;throw Error(e)}Zb(`Invite created for ${t}`,`success`),r.querySelector(`#invite-body`).innerHTML=`
        <div class="client-modal__result">
          ...
          <p>${s.emailQueued?`An invite email is on its way to <strong>${Y(t)}</strong>.`:`Invite created for <strong>${Y(t)}</strong>.`}</p>
          ...
          <div class="client-modal__linkrow">
            <input class="client-modal__input" id="inv-link" type="text" readonly value="${Y(s.inviteUrl)}" />
        ...
        </div>`;let c=r.querySelector(`#inv-link`);r.querySelector(`#inv-copy`)?.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(c.value),r.querySelector(`#inv-copy`).textContent=`Copied!`}catch{c.select()}}),r.querySelector(`[data-act="done"]`)?.addEventListener(`click`,i)}catch(e){console.warn(`[clients] invite failed:`,e),s.textContent=e.message||`Something went wrong. Please try again.`,c.disabled=!1,c.innerHTML=o}})}function lx(e){if(!e)return``;let t=new Date(e);return Number.isNaN(t.getTime())?``:t.toLocaleString(void 0,{year:`numeric`,month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`})}async function ux(e,t){if(!e)return;let n=w.getConfig?.().BASE_URL||``,r=document.createElement(`div`);r.className=`client-modal-scrim`;let i=document.createElement(`div`);i.className=`client-modal`,i.setAttribute(`role`,`dialog`),i.setAttribute(`aria-modal`,`true`),i.innerHTML=`
    <div class="client-modal__head">
      <span class="client-modal__title">Kickoff Questionnaire: ${Y(t)}</span>
      <button class="client-modal__close" type="button" aria-label="Close">&times;</button>
    </div>
    <div class="client-modal__body" id="qm-body">${tx(`hourglass_empty`,`Loading…`)}</div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add(`open`),i.classList.add(`open`)});let a=()=>{r.classList.remove(`open`),i.classList.remove(`open`),document.removeEventListener(`keydown`,o),setTimeout(()=>{r.remove(),i.remove()},200)},o=e=>{e.key===`Escape`&&a()};document.addEventListener(`keydown`,o),r.addEventListener(`click`,a),i.querySelector(`.client-modal__close`)?.addEventListener(`click`,a);let s=i.querySelector(`#qm-body`);function c(){s.innerHTML=`
      ...
      </div>`,s.querySelector(`[data-act="done"]`)?.addEventListener(`click`,a),s.querySelector(`[data-act="resend"]`)?.addEventListener(`click`,()=>c())}function d(e,t=!1){let r=e.editability||{editable:e.status===`SUBMITTED`&&!e.locked_tz,reason:e.locked_tz?`finalized`:null,deadline:null},i=!!r.editable,o=!i&&e.status===`SUBMITTED`?r.reason===`finalized`?`<div class="qm-status" data-status="LOCKED"><span class="material-symbols-outlined" aria-hidden="true">lock</span> Finalized${e.locked_tz?` ${Y(lx(e.locked_tz))}`:``}${e.locked_by_email?` by ${Y(e.locked_by_email)}`:``} — no further edits.</div>`:`<div class="qm-status" data-status="LOCKED"><span class="material-symbols-outlined" aria-hidden="true">lock_clock</span> Editing closed${r.deadline?` ${Y(lx(r.deadline))}`:``} — a response locks 14 days after it is submitted.</div>`:``,c=i&&r.deadline?`<p class="client-modal__sub qm-editable-hint">You can edit these answers until ${Y(lx(r.deadline))}.</p>`:``;s.innerHTML=`
      <div class="qm-status" data-status="SUBMITTED"><span class="material-symbols-outlined" aria-hidden="true">task_alt</span> Submitted ${e.submitted_tz?Y(lx(e.submitted_tz)):``}</div>
      ${o}
      ${Vr(e)}
      <form id="qm-form">
        ${Rr(e,t?{renderAnswer:zr}:{})}
      </form>
      ${t?``:c}
      <p class="client-modal__error" id="qm-error"></p>
      <div class="client-modal__actions">
      ...
      </div>`,s.querySelector(`[data-act="done"]`)?.addEventListener(`click`,a),s.querySelector(`[data-act="cancel-edit"]`)?.addEventListener(`click`,()=>d(e,!1)),s.querySelector(`[data-act="edit"]`)?.addEventListener(`click`,()=>d(e,!0));let l=s.querySelector(`[data-act="save"]`);l?.addEventListener(`click`,async()=>{let t=Br(s);l.disabled=!0;let r=l.innerHTML;l.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…`;let i;try{i=await b(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e.guid)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({answers:t})});let r=await i.json().catch(()=>({}));if(!i.ok||!r.ok)throw Error(r.error||r.message||`Failed (HTTP ${i.status})`);Zb(`Answers updated`,`success`);let a=await(await b(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e.guid)}`)).json().catch(()=>({}));d(a.ok?a.data:{...e,answers:t},!1)}catch(t){if(i&&i.status===423){Zb(t.message||`This questionnaire is now locked.`,`info`);let r=await(await b(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e.guid)}`)).json().catch(()=>({}));d(r.ok?r.data:e,!1);return}s.querySelector(`#qm-error`).textContent=t.message||`Something went wrong. Please try again.`,l.disabled=!1,l.innerHTML=r}})}try{let t=await b(`${n}/m5t/v5/m5mQuestionnaireResponse?owner_guid=${encodeURIComponent(e)}`),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`HTTP ${t.status}`);let i=(r.data||[])[0]||null;if(!i){c();return}if(i.status===`DRAFT`){l(i);return}if(i.status===`CANCELLED`){u(i);return}let a=await b(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(i.guid)}`),o=await a.json().catch(()=>({}));if(!a.ok||!o.ok)throw Error(o.error||`HTTP ${a.status}`);d(o.data)}catch(e){console.warn(`[clients] questionnaire load failed:`,e),s.innerHTML=`<p class="client-modal__error">Could not load questionnaire status. ${Y(e.message||``)}</p>`}}var dx,fx,px,mx,hx,Y,gx,_x,vx,yx=o((()=>{T(),rt(),dx=u(f(),1),m(),An(),Kr(),x(),no(),fx=`reseller_org`,px=`managed_client`,mx=!1,hx={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Y=e=>String(e??``).replace(/[&<>"']/g,e=>hx[e]),gx=e=>String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``).toUpperCase()||`?`,_x=e=>String(e||``).replace(/[^0-9]/g,``),vx={render:rx,init:ix}})),bx=c({default:()=>zx,init:()=>kx,loadTeam:()=>Ax,render:()=>Ox});function xx(){let e=w.getActiveOrg(),t=e&&e.channel!==Px?e:null;if(!t){let e=w.getMemberships().find(e=>e.channel!==Px);e&&(t={guid:e.orgGuid,channel:e.channel,memberRole:e.memberRole})}if(!t)return null;let n=w.getMemberships().find(e=>e.orgGuid===t.guid)?.name;return{...t,name:n}}function Sx(e){return Object.values(Re).filter(t=>Le(e,t.value)).sort((e,t)=>t.rank-e.rank)}function Cx(){if(Fx)return;let e=document.createElement(`style`);e.id=`m5t-team-styles`,e.textContent=`
    ...
    .page-shell .team-role[data-role="account_manager"] { background: var(--color-tip-soft, #D1FAE5); color: var(--color-tip-deep, #065F46); }

    /* Client-access modal list */
    .team-modal__radio { display: flex; align-items: flex-start; gap: 8px; padding: 8px 0; font-size: 0.9rem; cursor: pointer; }
    .team-modal__clients { margin: 8px 0 0 26px; display: none; }
    .team-modal__clients.open { display: block; }
    .team-modal__client { display: flex; align-items: center; gap: 8px; padding: 5px 0; font-size: 0.88rem; }
  ...
  `,document.head.appendChild(e),Fx=!0}function wx(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Tx(e,t,n){let r=e.member_role||`member`,i=e.entity_guid&&e.entity_guid===w.getEntity?.()?.guid,a=n&&!i&&Sx(t.memberRole).some(e=>e.value===r),o=t.channel===`reseller_org`&&a&&r!==`owner`;return`
    <div class="team-row">
      <span class="team-avatar">${X(Rx(e.name||e.email))}</span>
      ...
      <span class="team-role" data-role="${X(r)}">${X(Re[r]?.label||r)}</span>
      ${o?`<button class="team-modal__btn team-modal__btn--ghost team-scope" type="button" data-id="${X(e.id)}" data-name="${X(e.name||e.email)}">Client access</button>`:``}
    ...
    </div>`}async function Ex(e,t){let{uid:n,email:r}=e.dataset;if(window.confirm(`Revoke the invitation for ${r}?\n\nThe invitation link stops working immediately, including any copy already sent. You can invite this address again afterwards.`)){e.disabled=!0;try{let e=await b(`${w.getConfig?.().BASE_URL||``}/m5t/v5/acctGroup/${encodeURIComponent(t.guid)}/invites/${encodeURIComponent(n)}`,{method:`DELETE`}),i=await e.json().catch(()=>({}));if(!e.ok||!i.ok)throw Error(i.message||i.error||`HTTP ${e.status}`);Lx(`Invitation for ${r} revoked`,`success`)}catch(t){e.disabled=!1,Lx(t.message||`Could not revoke that invitation.`,`error`);return}try{await Ax(t)}catch{}}}async function Dx(e,t){let{id:n,name:r}=e.dataset;if(window.confirm(`Remove ${r} from the team?\n\nThey lose access to this workspace immediately. Their account itself is not deleted, and you can invite them again later.`)){e.disabled=!0;try{let e=await b(`${w.getConfig?.().BASE_URL||``}/m5t/v5/acctGroupMember/${encodeURIComponent(n)}`,{method:`DELETE`}),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(t.message||t.error||`HTTP ${e.status}`);Lx(`${r} removed from the team`,`success`)}catch(t){e.disabled=!1,Lx(t.message||`Could not remove that member.`,`error`);return}try{await Ax(t)}catch{}}}function Ox(){return Cx(),`
    <div class="page-shell" data-section="team">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="team-body">
          ${wx(`hourglass_empty`,`Loading team…`)}
        </div>
      </div>
    </div>`}async function kx(){let e=xx(),t=document.getElementById(`team-invite-btn`);if(!e){t&&(t.style.display=`none`),document.getElementById(`team-body`).innerHTML=wx(`info`,`Team management is available for agency and workspace accounts.`);return}t?.addEventListener(`click`,()=>jx(e)),await Ax(e)}async function Ax(e){let t=document.getElementById(`team-body`),n=document.getElementById(`team-count`);if(t)try{let r=w.getConfig?.().BASE_URL||``,[i,a]=await Promise.all([b(`${r}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/members`),b(`${r}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/invites`)]),[o,s]=await Promise.all([i.json().catch(()=>({})),a.json().catch(()=>({}))]);j(i,o),j(a,s);let c=o.members||[],l=s.invites||[],u=Sx(e.memberRole).length>0;t.innerHTML=(l.length?`
      ...
      </div>`:``)+(c.length?`<div class="team-list">${c.map(t=>Tx(t,e,u)).join(``)}</div>`:wx(`group`,`No members yet.`)),n&&(n.textContent=`${c.length} member${c.length===1?``:`s`}`),t.querySelectorAll(`.team-copy`).forEach(e=>e.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(e.dataset.url),e.textContent=`Copied!`,setTimeout(()=>{e.textContent=`Copy link`},1500)}catch{}})),t.querySelectorAll(`.team-revoke`).forEach(t=>t.addEventListener(`click`,()=>Ex(t,e))),t.querySelectorAll(`.team-remove`).forEach(t=>t.addEventListener(`click`,()=>Dx(t,e))),t.querySelectorAll(`.team-scope`).forEach(t=>t.addEventListener(`click`,()=>Mx(t.dataset.id,t.dataset.name,e)));let d=t.querySelector(`.team-list`);d&&O(d,{rowSelector:`.team-row`,noun:`members`});let f=t.querySelector(`.team-pending`);f&&O(f,{rowSelector:`.team-pending__row`,noun:`invites`})}catch(e){console.warn(`[team] load failed:`,e),t.innerHTML=$a(e)?eo():wx(`error`,`Couldn’t load the team. Please try again.`)}}function jx(e){let t=Sx(e.memberRole);if(!t.length){Lx(`You don’t have permission to invite teammates.`,`error`);return}let n=document.createElement(`div`);n.className=`team-modal-scrim`;let r=document.createElement(`div`);r.className=`team-modal`,r.setAttribute(`role`,`dialog`),r.setAttribute(`aria-modal`,`true`),r.innerHTML=`
    ...
    <div class="team-modal__body" id="team-invite-body">
      ...
      <div class="team-modal__actions">
    ...
    </div>`,document.body.appendChild(n),document.body.appendChild(r),requestAnimationFrame(()=>{n.classList.add(`open`),r.classList.add(`open`)});let i=()=>{n.classList.remove(`open`),r.classList.remove(`open`),document.removeEventListener(`keydown`,a),setTimeout(()=>{n.remove(),r.remove()},200)},a=e=>{e.key===`Escape`&&i()};document.addEventListener(`keydown`,a),n.addEventListener(`click`,i),r.querySelector(`.team-modal__close`)?.addEventListener(`click`,i),r.querySelector(`[data-act="cancel"]`)?.addEventListener(`click`,i),r.querySelector(`#tm-email`)?.focus();let o=r.querySelector(`#tm-error`),s=r.querySelector(`[data-act="send"]`);s?.addEventListener(`click`,async()=>{let t=(r.querySelector(`#tm-email`).value||``).trim(),n=(r.querySelector(`#tm-first`).value||``).trim(),a=(r.querySelector(`#tm-last`).value||``).trim(),c=r.querySelector(`#tm-role`).value;if(o.textContent=``,!t||!n||!a){o.textContent=`Email, first, and last name are required.`;return}s.disabled=!0;let l=s.innerHTML;s.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Sending…`;try{let o=await b(`${w.getConfig?.().BASE_URL||``}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/invite`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({email:t,first:n,last:a,member_role:c})}),s=await o.json().catch(()=>({}));if(!o.ok||!s.ok){let e=o.status===409?`A user with that email already exists.`:o.status===403?s.message||`You are not authorized to invite this role.`:s.message||s.error||`Failed (HTTP ${o.status})`;throw Error(e)}Lx(`Invite created for ${t}`,`success`),r.querySelector(`#team-invite-body`).innerHTML=`
        <div class="team-modal__result">
          <span class="material-symbols-outlined" aria-hidden="true" style="font-size:40px;color:var(--color-success,#009473);">mark_email_read</span>
          <p>${s.emailQueued?`An invite email is on its way to <strong>${X(t)}</strong>.`:`Invite created for <strong>${X(t)}</strong>.`}</p>
          <p class="team-modal__sub">Or share this link directly:</p>
          <div class="team-modal__linkrow">
            <input class="team-modal__input" id="tm-link" type="text" readonly value="${X(s.inviteUrl)}" />
        ...
        </div>`;let l=r.querySelector(`#tm-link`);r.querySelector(`#tm-copy`)?.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(l.value),r.querySelector(`#tm-copy`).textContent=`Copied!`}catch{l.select()}}),r.querySelector(`[data-act="done"]`)?.addEventListener(`click`,()=>{i(),Ax(e)})}catch(e){console.warn(`[team] invite failed:`,e),o.textContent=e.message||`Something went wrong. Please try again.`,s.disabled=!1,s.innerHTML=l}})}async function Mx(e,t,n){let r=w.getConfig?.().BASE_URL||``,i;try{let t=await b(`${r}/m5t/v5/acctGroupMember/${encodeURIComponent(e)}/client-scope`),n=await t.json().catch(()=>({}));j(t,n),i=n.data||{}}catch(e){console.warn(`[team] client-scope load failed:`,e),Lx(`Could not load client access. Please try again.`,`error`);return}if(!i.restrictable){Lx(`This member always sees all clients.`,`info`);return}let a=i.clients||[],o=new Set(i.allowed||[]),s=!!i.restricted,c=document.createElement(`div`);c.className=`team-modal-scrim`;let l=document.createElement(`div`);l.className=`team-modal`,l.setAttribute(`role`,`dialog`),l.setAttribute(`aria-modal`,`true`),l.innerHTML=`
    <div class="team-modal__head">
      <span class="team-modal__title">Client access</span>
      <button class="team-modal__close" type="button" aria-label="Close">&times;</button>
    </div>
    <div class="team-modal__body">
      <p class="team-modal__sub">Which clients <strong>${X(t||`this member`)}</strong> can see and work in.</p>
      <label class="team-modal__radio"><input type="radio" name="tm-scope" value="all"${s?``:` checked`} /> All clients</label>
      <label class="team-modal__radio"><input type="radio" name="tm-scope" value="assigned"${s?` checked`:``} /> Assigned clients only</label>
      <div class="team-modal__clients${s?` open`:``}" id="tm-clients">
        ${a.length?a.map(e=>`
          <label class="team-modal__client"><input type="checkbox" data-client="${X(e.guid)}"${o.has(e.guid)?` checked`:``} /> ${X(e.caption||e.guid)}</label>`).join(``):`<p class="team-modal__sub">No client accounts yet.</p>`}
      </div>
      <p class="team-modal__error" id="tm-scope-error"></p>
      <div class="team-modal__actions">
        <button class="team-modal__btn team-modal__btn--ghost" type="button" data-act="cancel">Cancel</button>
        <button class="team-modal__btn team-modal__btn--primary" type="button" data-act="save">Save</button>
      </div>
    </div>`,document.body.appendChild(c),document.body.appendChild(l),requestAnimationFrame(()=>{c.classList.add(`open`),l.classList.add(`open`)});let u=()=>{c.classList.remove(`open`),l.classList.remove(`open`),document.removeEventListener(`keydown`,d),setTimeout(()=>{c.remove(),l.remove()},200)},d=e=>{e.key===`Escape`&&u()};document.addEventListener(`keydown`,d),c.addEventListener(`click`,u),l.querySelector(`.team-modal__close`)?.addEventListener(`click`,u),l.querySelector(`[data-act="cancel"]`)?.addEventListener(`click`,u);let f=l.querySelector(`#tm-clients`);l.querySelectorAll(`input[name="tm-scope"]`).forEach(e=>e.addEventListener(`change`,()=>{f.classList.toggle(`open`,l.querySelector(`input[name="tm-scope"]:checked`)?.value===`assigned`)}));let p=l.querySelector(`#tm-scope-error`),m=l.querySelector(`[data-act="save"]`);m?.addEventListener(`click`,async()=>{p.textContent=``;let t=l.querySelector(`input[name="tm-scope"]:checked`)?.value,i=[...l.querySelectorAll(`input[data-client]:checked`)].map(e=>e.dataset.client);if(t===`assigned`&&!i.length){p.textContent=`Tick at least one client, or choose All clients.`;return}m.disabled=!0;try{let a=await b(`${r}/m5t/v5/acctGroupMember/${encodeURIComponent(e)}/client-scope`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({client_guids:t===`assigned`?i:[]})}),o=await a.json().catch(()=>({}));if(j(a,o),!o.ok)throw Error(o.message||o.error||`Save failed`);Lx(`Client access updated.`,`success`),u(),Ax(n)}catch(e){console.warn(`[team] client-scope save failed:`,e),p.textContent=e.message||`Something went wrong. Please try again.`,m.disabled=!1}})}var Nx,Px,Fx,Ix,X,Lx,Rx,zx,Bx=o((()=>{T(),Nx=u(f(),1),m(),rt(),An(),x(),no(),Px=`managed_client`,Fx=!1,Ix={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},X=e=>String(e??``).replace(/[&<>"']/g,e=>Ix[e]),Lx=(e,t=`info`)=>{try{Nx.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Rx=e=>String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``).toUpperCase()||`?`,zx={render:Ox,init:kx}}));m(),vt(),T(),dn(),y(),$n(),or(),St(),window.m5t=Object.create(null),window.m5t.pubsub=E.default,console.log(`StreamSyncEngage SaaS Client - Starting...`),console.log(`Environment:`,`production`),console.log(`Document readyState:`,document.readyState),console.log(`window.mvvLegit:`,typeof window.mvvLegit),console.log(`globalThis.mvvLegit:`,typeof globalThis.mvvLegit);try{console.log(`mvvLegit (direct):`,typeof mvvLegit)}catch(e){console.log(`mvvLegit (direct): ReferenceError -`,e.message)}var Vx=Object.keys(window).filter(e=>e.toLowerCase().includes(`mvv`)||e.toLowerCase().includes(`neodigm`)||e.toLowerCase().includes(`legit`));console.log(`Possible Neodigm globals:`,Vx);var Z=new ee.default(`/`,{hash:!0});window.router=Z;function Q(e){let t=e?`${e.replace(/-/g,`_`)}_route`:`splash_route`;return console.log(`[Router] Checking access: ${e} -> ${t}`),mvvLegit.isRouteAllowed(t)?!0:(console.warn(`[Router] Access denied to route: ${t}`),E.default.publish(p.UI_TOAST,{message:`Please sign in to access this page`,type:`warning`}),!1)}function $(e){console.log(`[Router] Navigating to:`,e),Z.navigate(`/${e}`)}var Hx=new Set([`splash`,`signin`,`signup`,`forgot`,`resethash`,`verf-link`,`accept-invite`,`signout`]),Ux={},Wx={},Gx=null,Kx={admin:{caption:`Platform Admin`,icon:`shield_person`},reseller:{caption:`Reseller`,icon:`handshake`},managed:{caption:`Managed`,icon:`visibility`},self_serve:{caption:`Self-Serve`,icon:`rocket_launch`}},qx={free:`rocket_launch`,pro:`workspace_premium`,enterprise:`diamond`,grandfathered:`all_inclusive`},Jx=null,Yx=!1;function Xx(){return Jx||(Yx||(Yx=!0,C(async()=>{let{fetchMyPlan:e}=await Promise.resolve().then(()=>(pr(),sr));return{fetchMyPlan:e}},void 0,import.meta.url).then(({fetchMyPlan:e})=>e()).then(e=>{let t=e?.plan;!t?.label||!t?.key||(Jx={caption:t.key===`grandfathered`?t.label:`${t.label} plan`,icon:qx[t.key]||`rocket_launch`},$x())}).catch(()=>{})),Kx.self_serve)}var Zx=`__portfolio__`;function Qx(){try{Z._setCurrent(null)}catch{}Z.resolve()}function $x(){let e=document.getElementById(`m5t-side-nav`);if(!e)return;let t=!w.getScope()&&w.isAuthenticated(),n=w.getCapabilities(),r=w.getUiMode(),i=gn.getSideNav(n,{uiMode:r});Ux={},Wx={};let a=e=>{e.route&&(Ux[e.route]={sectionToken:e.token,childToken:null,children:e.children||null},Array.isArray(e.children)&&e.children.forEach(t=>{t.route&&(Wx[t.token]=t.route,Ux[t.route]={sectionToken:e.token,childToken:t.token,children:e.children})}))},o=e=>e.forEach(e=>{e.group&&Array.isArray(e.items)?o(e.items):a(e)});o(i);let s=w.getMemberships(),c=w.getActiveOrg(),l=w.getManagedClients(),u=w.getStoredActiveOrg(),d=l.length?[{guid:Zx,name:Cn(w.isClientScopeRestricted?.())},...s.map(e=>({guid:e.orgGuid,name:e.name||e.channel,channel:e.channel,group:`Your organization`})),...l.map(e=>({guid:e.orgGuid,name:e.name||e.orgGuid,channel:e.channel,group:`Clients`}))]:s.map(e=>({guid:e.orgGuid,name:e.name||e.channel,channel:e.channel}));e.setState({buttons:i,orgs:d,activeOrg:l.length?u||Zx:c?.guid||null,footerBadge:r===`self_serve`?Xx():Kx[r]||null,loading:t}),tS(),Gx&&nS(Gx)}var eS=e=>String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]);function tS(){let e=document.getElementById(`app-content`);if(!e)return;let t=document.getElementById(`org-context-banner`);t||(t=document.createElement(`div`),t.id=`org-context-banner`,e.insertBefore(t,e.firstChild),Wn(t));let n=w.getActiveOrg(),r=w.isPreviewingAsClient(),i=!!n?.viaSubtree&&!!Gx&&!Hx.has(Gx);if(t.hidden=!i,!i){t.innerHTML=``;return}let a=eS(n.name||`Client`);t.innerHTML=`
    <style>
    ...
    <div class="ocb" role="status">
    ...
    </div>`,t.querySelector(`[data-ocb="preview"]`)?.addEventListener(`click`,()=>{w.setPreviewAsClient(!w.isPreviewingAsClient()),Qx()}),t.querySelector(`[data-ocb="portfolio"]`)?.addEventListener(`click`,()=>{w.setPreviewAsClient(!1),w.setActiveOrg(null)})}function nS(e){let t=document.getElementById(`m5t-side-nav`),n=Ux[`/${e}`]||Ux[e]||null;t?.setActiveToken(n?.sectionToken||null),rS(n)}function rS(e){let t=document.getElementById(`m5t-sub-nav`),n=document.getElementById(`app-shell`);if(!t)return;if(Hx.has(Gx)){t.hidden=!0,n?.classList.remove(`has-sub-nav`);return}let r=e?.children;t.hidden=!1,r&&r.length>1?(t.updateButtons(r.map(t=>({token:t.token,caption:t.caption,enabled:!0,selected:t.token===e.childToken}))),n?.classList.add(`has-sub-nav`)):(t.updateButtons([]),n?.classList.remove(`has-sub-nav`))}function iS(){let e=un.getAvailableLanguages&&un.getAvailableLanguages()||[];if(e.length<2){E.default.publish(p.UI_TOAST,{message:`Only one language is available`,type:`info`});return}let t=localStorage.getItem(v.FF_SSE_LS_USER_LANG)||v.FF_SSE_I18N_LANG||e[0],n=e[(e.indexOf(t)+1)%e.length];un.setLanguage(n),E.default.publish(p.UI_TOAST,{message:`Language: ${n}`,type:`info`})}function aS(){document.documentElement.classList.toggle(`ff-no-animations`,Zn())}function oS(){let e=document.getElementById(`m5t-side-nav`);if(!e)return;gn.setAppToken(`client-saas`),Qn(e),document.getElementById(`app-shell`)?.classList.toggle(`nav-collapsed`,e.getAttribute(`data-collapsed`)===`true`),e.addEventListener(`nav-select`,e=>{let t=e.detail?.route;t&&Z.navigate(t.startsWith(`/`)?t:`/${t}`)}),e.addEventListener(`logo-click`,()=>Z.navigate(`/home`)),e.addEventListener(`nav-collapse`,e=>{document.getElementById(`app-shell`)?.classList.toggle(`nav-collapsed`,!!e.detail?.collapsed)}),e.addEventListener(`org-switch`,e=>{let t=e.detail?.orgGuid;t&&w.setActiveOrg(t===Zx?null:t)}),e.addEventListener(`footer-action`,e=>{switch(e.detail?.action){case`account`:Z.navigate(`/settings`);break;case`signout`:Z.navigate(`/signout`);break;case`lang`:iS();break;case`theme`:ir()}}),document.getElementById(`m5t-sub-nav`)?.addEventListener(`nav-select`,e=>{let t=Wx[e.detail?.token];t&&Z.navigate(t)}),document.addEventListener(`language-changed`,()=>$x()),$x(),E.default.subscribe(p.AUTH_SCOPE_LOADED,()=>$x());let t=()=>{let e=w.getScope();return[e?.uiMode,e?.activeOrg?.guid,(e?.managedClients||[]).length,(e?.capabilities||[]).join(`,`),w.getStoredActiveOrg()].join(`|`)},n=t();E.default.subscribe(p.AUTH_SCOPE_LOADED,()=>{let e=t();e!==n&&(n=e,Gx&&!Hx.has(Gx)&&Qx())})}function sS(e){Gx=e;let t=document.getElementById(`m5t-side-nav`),n=document.getElementById(`app-shell`);if(!t||!n)return;let r=!Hx.has(e);if(t.hidden=!r,n.classList.toggle(`has-side-nav`,r),Bn(r),r)nS(e);else{let e=document.getElementById(`m5t-sub-nav`);e&&(e.hidden=!0),n.classList.remove(`has-sub-nav`)}tS()}E.default.subscribe(p.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&(bn(t.route),sS(t.route))});var cS=()=>{console.log(`[Router] Route: splash`),E.default.publish(p.ROUTE_NAV_BEFORE,{route:`splash`});let e=ft()?.name;C(e===`invite`?()=>Promise.resolve().then(()=>(xr(),mr)):e===`questionnaire`?()=>Promise.resolve().then(()=>(ui(),Yr)):e===`deliverable`?()=>Promise.resolve().then(()=>(zi(),bi)):()=>Promise.resolve().then(()=>(Wi(),Bi)),void 0,import.meta.url).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`splash`})}).catch(e=>{console.error(`[Router] Error loading splash route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`splash`,error:e})})};Z.on(`/`,cS),Z.on(`/splash`,cS),Z.on(`/signin`,()=>{console.log(`[Router] Route: /signin`),E.default.publish(p.ROUTE_NAV_BEFORE,{route:`signin`}),C(()=>Promise.resolve().then(()=>(na(),Yi)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`signin`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading signin route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`signin`,error:e})})}),Z.on(`/signup`,()=>{console.log(`[Router] Route: /signup`),E.default.publish(p.ROUTE_NAV_BEFORE,{route:`signup`}),C(()=>Promise.resolve().then(()=>(ha(),oa)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`signup`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading signup route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`signup`,error:e})})}),Z.on(`/verf-link`,()=>{console.log(`[Router] Route: /verf-link`),E.default.publish(p.ROUTE_NAV_BEFORE,{route:`verf-link`}),C(()=>Promise.resolve().then(()=>(ya(),ga)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`verf-link`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading verf-link route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`verf-link`,error:e})})}),Z.on(`/forgot`,()=>{console.log(`[Router] Route: /forgot`),E.default.publish(p.ROUTE_NAV_BEFORE,{route:`forgot`}),C(()=>Promise.resolve().then(()=>(Aa(),Ta)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`forgot`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading forgot route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`forgot`,error:e})})}),Z.on(`/resethash`,()=>{if(console.log(`[Router] Route: /resethash`),!Q(`resethash`)){$(`signin`);return}E.default.publish(p.ROUTE_NAV_BEFORE,{route:`resethash`}),C(()=>Promise.resolve().then(()=>(Ia(),ja)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`resethash`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading resethash route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`resethash`,error:e})})}),Z.on(`/home`,()=>{if(console.log(`[Router] Route: /home`),!Q(`home`)){$(`signin`);return}Sn(`/home`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`home`}),C(()=>Promise.resolve().then(()=>(Yo(),Co)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`home`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading home route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`home`,error:e})}))}),Z.on(`/signout`,()=>{if(console.log(`[Router] Route: /signout`),!Q(`signout`)){$(`signin`);return}E.default.publish(p.ROUTE_NAV_BEFORE,{route:`signout`}),C(()=>Promise.resolve().then(()=>($o(),Xo)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`signout`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading signout route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`signout`,error:e})})}),[{path:`/magnets/drafts`,name:`magnets/drafts`,title:`Magnets · Drafts`,icon:`widgets`},{path:`/magnets/archived`,name:`magnets/archived`,title:`Magnets · Archived`,icon:`widgets`}].forEach(({path:e,name:t,title:n,icon:r})=>{Z.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!Q(`home`)){$(`signin`);return}Sn(e)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:t}),C(()=>Promise.resolve().then(()=>(os(),es)).then(e=>{let i=document.getElementById(`app`);i.innerHTML=e.render({title:n,icon:r,name:t}),e.init&&e.init({name:t}),E.default.publish(p.ROUTE_NAV_AFTER,{route:t})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading section route (${t}):`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:t,error:e})}))})}),Z.on(`/settings`,()=>{if(console.log(`[Router] Route: /settings`),!Q(`home`)){$(`signin`);return}Sn(`/settings`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings`}),C(()=>Promise.resolve().then(()=>(As(),ss)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`settings`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-general route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`settings`,error:e})}))}),Z.on(`/settings/workspace`,()=>{if(console.log(`[Router] Route: /settings/workspace`),!Q(`home`)){$(`signin`);return}Sn(`/settings/workspace`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/workspace`}),C(()=>Promise.resolve().then(()=>(sc(),js)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/workspace`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-workspace route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/workspace`,error:e})}))}),Z.on(`/settings/notifications`,()=>{if(console.log(`[Router] Route: /settings/notifications`),!Q(`home`)){$(`signin`);return}Sn(`/settings/notifications`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/notifications`}),C(()=>Promise.resolve().then(()=>(Fc(),cc)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/notifications`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-notifications route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/notifications`,error:e})}))}),Z.on(`/settings/integrations`,()=>{if(console.log(`[Router] Route: /settings/integrations`),!Q(`home`)){$(`signin`);return}Sn(`/settings/integrations`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/integrations`}),C(()=>Promise.resolve().then(()=>(Bl(),kl)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/integrations`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-integrations route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/integrations`,error:e})}))}),Z.on(`/settings/integrations/:provider`,e=>{let t=e?.data?.provider||``;if(console.log(`[Router] Route: /settings/integrations/`+t),!Q(`home`)){$(`signin`);return}Sn(`/settings/integrations/:provider`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/integrations`}),C(()=>Promise.resolve().then(()=>(lu(),Vl)).then(e=>{let n=document.getElementById(`app`);n.innerHTML=e.render({provider:t}),e.init&&e.init({provider:t}),E.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/integrations`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading integration detail route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/integrations`,error:e})}))}),Z.on(`/settings/security`,()=>{if(console.log(`[Router] Route: /settings/security`),!Q(`home`)){$(`signin`);return}Sn(`/settings/security`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/security`}),C(()=>Promise.resolve().then(()=>(Pu(),uu)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/security`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-security route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/security`,error:e})}))}),Z.on(`/conversations`,()=>{if(console.log(`[Router] Route: /conversations`),!Q(`home`)){$(`signin`);return}Sn(`/conversations`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`conversations`}),C(()=>Promise.resolve().then(()=>(ad(),Fu)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`conversations`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading conversations route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`conversations`,error:e})}))}),Z.on(`/ab-testing`,()=>{if(console.log(`[Router] Route: /ab-testing`),!Q(`home`)){$(`signin`);return}Sn(`/ab-testing`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`ab-testing`}),C(()=>Promise.resolve().then(()=>(jd(),od)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`ab-testing`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading ab-testing route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`ab-testing`,error:e})}))}),Z.on(`/magnets`,()=>{if(console.log(`[Router] Route: /magnets`),!Q(`home`)){$(`signin`);return}Sn(`/magnets`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`magnets`}),C(()=>Promise.resolve().then(()=>(yh(),kp)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`magnets`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading magnets route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`magnets`,error:e})}))}),Z.on(`/templates`,()=>{console.log(`[Router] Route: /templates`),E.default.publish(p.ROUTE_NAV_BEFORE,{route:`templates`}),C(()=>Promise.resolve().then(()=>(Fh(),bh)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`templates`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading templates route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`templates`,error:e})})}),Z.on(`/questionnaires`,()=>{if(console.log(`[Router] Route: /questionnaires`),!Q(`home`)){$(`signin`);return}Sn(`/questionnaires`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`questionnaires`}),C(()=>Promise.resolve().then(()=>(cg(),Ih)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`questionnaires`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading questionnaires route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`questionnaires`,error:e})}))}),Z.on(`/deliverables`,()=>{if(console.log(`[Router] Route: /deliverables`),!Q(`home`)){$(`signin`);return}if(!Sn(`/deliverables`))return;E.default.publish(p.ROUTE_NAV_BEFORE,{route:`deliverables`});let e=w.getUiMode?.();C(e===`reseller`||e===`admin`?()=>Promise.resolve().then(()=>(Gg(),lg)):()=>Promise.resolve().then(()=>(a_(),Kg)),void 0,import.meta.url).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`deliverables`})}).catch(e=>{console.error(`[Router] Error loading deliverables route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`deliverables`,error:e})})}),Z.on(`/leads`,()=>{if(console.log(`[Router] Route: /leads`),!Q(`home`)){$(`signin`);return}Sn(`/leads`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`leads`}),C(()=>Promise.resolve().then(()=>(cv(),o_)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`leads`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading leads route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`leads`,error:e})}))}),Z.on(`/analytics`,()=>{if(console.log(`[Router] Route: /analytics`),!Q(`home`)){$(`signin`);return}Sn(`/analytics`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`analytics`}),C(()=>Promise.resolve().then(()=>(jv(),lv)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`analytics`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading analytics route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`analytics`,error:e})}))}),Z.on(`/analytics/conversions`,()=>{if(console.log(`[Router] Route: /analytics/conversions`),!Q(`home`)){$(`signin`);return}Sn(`/analytics/conversions`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`analytics/conversions`}),C(()=>Promise.resolve().then(()=>(dy(),Mv)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`analytics/conversions`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading conversions route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`analytics/conversions`,error:e})}))}),Z.on(`/billing`,()=>{if(console.log(`[Router] Route: /billing`),!Q(`home`)){$(`signin`);return}if(w.getUiMode?.()!==`self_serve`){window.location.hash=`#/home`;return}Sn(`/billing`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`billing`}),C(()=>Promise.resolve().then(()=>(Ay(),fy)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`billing`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading billing route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`billing`,error:e})}))}),Z.on(`/analytics/traffic`,()=>{if(console.log(`[Router] Route: /analytics/traffic`),!Q(`home`)){$(`signin`);return}Sn(`/analytics/traffic`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`analytics/traffic`}),C(()=>Promise.resolve().then(()=>(Xy(),jy)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`analytics/traffic`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading traffic route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`analytics/traffic`,error:e})}))}),Z.on(`/analytics/ad-performance`,()=>{if(console.log(`[Router] Route: /analytics/ad-performance`),!Q(`home`)){$(`signin`);return}Sn(`/analytics/ad-performance`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`analytics/ad-performance`}),C(()=>Promise.resolve().then(()=>(wb(),Zy)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`analytics/ad-performance`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading ad-performance route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`analytics/ad-performance`,error:e})}))}),Z.on(`/ad-accounts`,()=>{if(console.log(`[Router] Route: /ad-accounts`),!Q(`home`)){$(`signin`);return}Sn(`/ad-accounts`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`ad-accounts`}),C(()=>Promise.resolve().then(()=>(Yb(),Tb)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`ad-accounts`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading ad-accounts route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`ad-accounts`,error:e})}))}),Z.on(`/clients`,()=>{if(console.log(`[Router] Route: /clients`),!Q(`home`)){$(`signin`);return}Sn(`/clients`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`clients`}),C(()=>Promise.resolve().then(()=>(yx(),Xb)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`clients`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading clients route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`clients`,error:e})}))}),Z.on(`/team`,()=>{if(console.log(`[Router] Route: /team`),!Q(`home`)){$(`signin`);return}Sn(`/team`)&&(E.default.publish(p.ROUTE_NAV_BEFORE,{route:`team`}),C(()=>Promise.resolve().then(()=>(Bx(),bx)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),E.default.publish(p.ROUTE_NAV_AFTER,{route:`team`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading team route:`,e),E.default.publish(p.ROUTE_NAV_ERROR,{route:`team`,error:e})}))}),Z.notFound(()=>{console.log(`[Router] Route not found - redirecting to splash`),$(`splash`)}),E.default.subscribe(p.ROUTE_NAV,(e,t)=>{console.log(`[Router] ROUTE_NAV event received:`,t),t?.route&&$(t.route)});function lS(){console.log(`[App] Waiting for Neodigm 55 library...`);let e=0,t=setInterval(()=>{e++,e%10==0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<`u`,neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<`u`?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(t),uS()):e>=100&&(clearInterval(t),console.error(`[App] Failed to load Neodigm 55 library after 10 seconds`),console.error(`[App] Check browser console for CORS or network errors`),document.getElementById(`app`).innerHTML=`
      ...
      `,E.default.publish(p.APP_ERROR,{message:`Failed to load authentication library`}))},100)}document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,lS):lS();async function uS(){if(console.log(`[App] Neodigm 55 loaded, initializing...`),tr(),aS(),sn(),un.initialize(),console.log(`[App] I18n Controller initialized`),!await w.init({BASE_URL:`https://machfivemagnet-saas.onrender.com`,navigateFunction:e=>{console.log(`[AuthController] Navigation requested:`,e),$(e)}})){console.error(`[App] AuthController initialization failed`);return}let e=w.getEntity();e&&(console.log(`[App] Session restored for:`,e.email),E.default.publish(p.APP_USER_LOADED,{entity:e}),w.isAuthenticated()&&(localStorage.getItem(w.CONFIG.LS_KEYS.ACTIVE_ORG)?await w.fetchScope():w.fetchScope())),E.default.publish(p.APP_READY,{timestamp:new Date().toISOString(),sessionUser:e}),oS(),Jn(),Z.resolve(),window.AuthController=w,window.I18nController=un,window.MachVive=fn,console.log(`[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)`)}E.default.subscribe(p.ROUTE_NAV_AFTER,(e,t)=>{un!==void 0&&un.refresh&&setTimeout(()=>{un.refresh()},100)});
