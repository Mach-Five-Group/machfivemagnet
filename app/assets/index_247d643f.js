(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const $r="modulepreload",Ir=function(e,t){return new URL(e,t).href},En={},J=function(t,a,n){let o=Promise.resolve();if(a&&a.length>0){let c=function(p){return Promise.all(p.map(h=>Promise.resolve(h).then(b=>({status:"fulfilled",value:b}),b=>({status:"rejected",reason:b}))))};const r=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");o=c(a.map(p=>{if(p=Ir(p,n),p in En)return;En[p]=!0;const h=p.endsWith(".css"),b=h?'[rel="stylesheet"]':"";if(n)for(let u=r.length-1;u>=0;u--){const d=r[u];if(d.href===p&&(!h||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${p}"]${b}`))return;const v=document.createElement("link");if(v.rel=h?"stylesheet":$r,h||(v.as="script"),v.crossOrigin="",v.href=p,l&&v.setAttribute("nonce",l),document.head.appendChild(v),h)return new Promise((u,d)=>{v.addEventListener("load",u),v.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${p}`)))})}))}function s(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return o.then(r=>{for(const i of r||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})};var Lr=/([:*])(\w+)/g,Rr="([^/]+)",Nr=/\*/g,Or="?(?:.*)",Mr=/\/\?/g,Pr="/?([^/]+|)",Fr="(?:/^|^)",Dr="";function Mo(e){return e===void 0&&(e="/"),Qa()?location.pathname+location.search+location.hash:e}function Z(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function Kt(e){return typeof e=="string"}function Br(e){return typeof e=="function"}function Jt(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function Ur(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(a,n,o){return a===null&&(a={}),a[t[o]]=decodeURIComponent(n),a},null)}function Qt(e){var t=Z(e).split(/\?(.*)?$/);return[Z(t[0]),t.slice(1).join("")]}function Ja(e){for(var t={},a=e.split("&"),n=0;n<a.length;n++){var o=a[n].split("=");if(o[0]!==""){var s=decodeURIComponent(o[0]);t[s]?(Array.isArray(t[s])||(t[s]=[t[s]]),t[s].push(decodeURIComponent(o[1]||""))):t[s]=decodeURIComponent(o[1]||"")}}return t}function Po(e,t){var a=Qt(Z(e.currentLocationPath)),n=a[0],o=a[1],s=o===""?null:Ja(o),r=[],i;if(Kt(t.path)){if(i=Fr+Z(t.path).replace(Lr,function(h,b,v){return r.push(v),Rr}).replace(Nr,Or).replace(Mr,Pr)+"$",Z(t.path)===""&&Z(n)==="")return{url:n,queryString:o,hashString:Jt(e.to),route:t,data:null,params:s}}else i=t.path;var l=new RegExp(i,Dr),c=n.match(l);if(c){var p=Kt(t.path)?Ur(c,r):c.groups?c.groups:c.slice(1);return{url:Z(n.replace(new RegExp("^"+e.instance.root),"")),queryString:o,hashString:Jt(e.to),route:t,data:p,params:s}}return!1}function Fo(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function tt(e,t){return typeof e[t]>"u"||e[t]===!0}function qr(e){if(!e)return{};var t=e.split(","),a={},n;return t.forEach(function(o){var s=o.split(":").map(function(r){return r.replace(/(^ +| +$)/g,"")});switch(s[0]){case"historyAPIMethod":a.historyAPIMethod=s[1];break;case"resolveOptionsStrategy":n||(n={}),n.strategy=s[1];break;case"resolveOptionsHash":n||(n={}),n.hash=s[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":a[s[0]]=s[1]==="true";break}}),n&&(a.resolveOptions=n),a}function Qa(){return typeof window<"u"}function Hr(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(a){return a}).forEach(function(a){["before","after","already","leave"].forEach(function(n){a[n]&&(t[n]||(t[n]=[]),t[n].push(a[n]))})}),t}function Re(e,t,a){var n=t||{},o=0;(function s(){if(!e[o]){a&&a(n);return}Array.isArray(e[o])?(e.splice.apply(e,[o,1].concat(e[o][0](n)?e[o][1]:e[o][2])),s()):e[o](n,function(r){typeof r>"u"||r===!0?(o+=1,s()):a&&a(n)})})()}Re.if=function(e,t,a){return Array.isArray(t)||(t=[t]),Array.isArray(a)||(a=[a]),[e,t,a]};function An(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=Mo(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function ba(e,t){for(var a=0;a<e.instance.routes.length;a++){var n=e.instance.routes[a],o=Po(e,n);if(o&&(e.matches||(e.matches=[]),e.matches.push(o),e.resolveOptions.strategy==="ONE")){t();return}}t()}function zr(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function Gr(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var kn=Qa(),jr=Fo();function Vr(e,t){if(tt(e.navigateOptions,"updateBrowserURL")){var a=("/"+e.to).replace(/\/\//g,"/"),n=kn&&e.resolveOptions&&e.resolveOptions.hash===!0;jr?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",n?"#"+a:a),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!n){var o=location.hash;location.hash="",location.hash=o}e.instance.__freezeListening=!1},1))):kn&&(window.location.href=e.to)}t()}function Do(e,t){var a=e.instance;if(!a.lastResolved()){t();return}Re(a.lastResolved().map(function(n){return function(o,s){if(!n.route.hooks||!n.route.hooks.leave){s();return}var r=!1,i=e.instance.matchLocation(n.route.path,e.currentLocationPath,!1);if(n.route.path!=="*")r=!i;else{var l=e.matches?e.matches.find(function(c){return n.route.path===c.route.path}):!1;r=!l}if(tt(e.navigateOptions,"callHooks")&&r){Re(n.route.hooks.leave.map(function(c){return function(p,h){return c(function(b){b===!1?e.instance.__markAsClean(e):h()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return s()}]));return}else s()}}),{},function(){return t()})}function Wr(e,t){e.match.route.hooks&&e.match.route.hooks.before&&tt(e.navigateOptions,"callHooks")?Re(e.match.route.hooks.before.map(function(a){return function(o,s){return a(function(r){r===!1?e.instance.__markAsClean(e):s()},e.match)}}).concat([function(){return t()}])):t()}function Yr(e,t){tt(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function Kr(e,t){e.match.route.hooks&&e.match.route.hooks.after&&tt(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(a){return a(e.match)}),t()}function Jr(e,t){var a=e.instance.lastResolved();if(a&&a[0]&&a[0].route===e.match.route&&a[0].url===e.match.url&&a[0].queryString===e.match.queryString){a.forEach(function(n){n.route.hooks&&n.route.hooks.already&&tt(e.navigateOptions,"callHooks")&&n.route.hooks.already.forEach(function(o){return o(e.match)})}),t(!1);return}t()}function Qr(e,t){var a=e.instance._notFoundRoute;if(a){e.notFoundHandled=!0;var n=Qt(e.currentLocationPath),o=n[0],s=n[1],r=Jt(e.to);a.path=Z(o);var i={url:a.path,queryString:s,hashString:r,data:null,route:a,params:s!==""?Ja(s):null};e.matches=[i],e.match=i}t()}function Xr(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function Zr(e,t){e.instance._setCurrent(null),t()}function Bo(e,t){tt(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var Uo=[Jr,Wr,Yr,Kr],Sn=[Do,Qr,Re.if(function(e){var t=e.notFoundHandled;return t},Uo.concat([Bo]),[Xr,Zr])];function Ia(){return Ia=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},Ia.apply(this,arguments)}function Tn(e,t){var a=0;function n(){if(a===e.matches.length){Bo(e,t);return}Re(Uo,Ia({},e,{match:e.matches[a]}),function(){a+=1,n()})}Do(e,n)}function _a(e){e.instance.__markAsClean(e)}function La(){return La=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},La.apply(this,arguments)}var Cn="[data-navigo]";function ei(e,t){var a=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:Cn},n=this,o="/",s=null,r=[],i=!1,l,c=Fo(),p=Qa();e?o=Z(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function h(y){return y.indexOf("#")>=0&&(a.hash===!0?y=y.split("#")[1]||"/":y=y.split("#")[0]),y}function b(y){return Z(o+"/"+Z(y))}function v(y,k,R,H){return y=Kt(y)?b(y):y,{name:H||Z(String(y)),path:y,handler:k,hooks:Hr(R)}}function u(y,k,R){var H=this;return typeof y=="object"&&!(y instanceof RegExp)?(Object.keys(y).forEach(function(P){if(typeof y[P]=="function")H.on(P,y[P]);else{var we=y[P],je=we.uses,S=we.as,U=we.hooks;r.push(v(P,je,[l,U],S))}}),this):(typeof y=="function"&&(R=k,k=y,y=o),r.push(v(y,k,[l,R])),this)}function d(y,k){if(n.__dirty){n.__waiting.push(function(){return n.resolve(y,k)});return}else n.__dirty=!0;y=y?Z(o)+"/"+Z(y):void 0;var R={instance:n,to:y,currentLocationPath:y,navigateOptions:{},resolveOptions:La({},a,k)};return Re([An,ba,Re.if(function(H){var P=H.matches;return P&&P.length>0},Tn,Sn)],R,_a),R.matches?R.matches:!1}function f(y,k){if(n.__dirty){n.__waiting.push(function(){return n.navigate(y,k)});return}else n.__dirty=!0;y=Z(o)+"/"+Z(y);var R={instance:n,to:y,navigateOptions:k||{},resolveOptions:k&&k.resolveOptions?k.resolveOptions:a,currentLocationPath:h(y)};Re([zr,Gr,ba,Re.if(function(H){var P=H.matches;return P&&P.length>0},Tn,Sn),Vr,_a],R,_a)}function _(y,k,R){var H=Ae(y,k);return H!==null?(f(H.replace(new RegExp("^/?"+o),""),R),!0):!1}function E(y){return this.routes=r=r.filter(function(k){return Kt(y)?Z(k.path)!==Z(y):Br(y)?y!==k.handler:String(k.path)!==String(y)}),this}function C(){c&&(this.__popstateListener=function(){n.__freezeListening||d()},window.addEventListener("popstate",this.__popstateListener))}function $(){this.routes=r=[],c&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=i=!0}function W(y,k){return n._notFoundRoute=v("*",y,[l,k],"__NOT_FOUND__"),this}function D(){if(p)return Y().forEach(function(y){if(y.getAttribute("data-navigo")==="false"||y.getAttribute("target")==="_blank"){y.hasListenerAttached&&y.removeEventListener("click",y.navigoHandler);return}y.hasListenerAttached||(y.hasListenerAttached=!0,y.navigoHandler=function(k){if((k.ctrlKey||k.metaKey)&&k.target.tagName.toLowerCase()==="a")return!1;var R=y.getAttribute("href");if(typeof R>"u"||R===null)return!1;if(R.match(/^(http|https)/)&&typeof URL<"u")try{var H=new URL(R);R=H.pathname+H.search}catch{}var P=qr(y.getAttribute("data-navigo-options"));i||(k.preventDefault(),k.stopPropagation(),n.navigate(Z(R),P))},y.addEventListener("click",y.navigoHandler))}),n}function Y(){return p?[].slice.call(document.querySelectorAll(a.linksSelector||Cn)):[]}function se(y){return"/"+o+"/"+Z(y)}function ue(y){return l=y,this}function ce(){return s}function Ae(y,k,R){var H=r.find(function(je){return je.name===y}),P=null;if(H){if(P=H.path,k)for(var we in k)P=P.replace(":"+we,k[we]);P=P.match(/^\//)?P:"/"+P}return P&&R&&!R.includeRoot&&(P=P.replace(new RegExp("^/"+o),"")),P}function M(y){return y.getAttribute("href")}function ee(y){var k=Qt(Z(y)),R=k[0],H=k[1],P=H===""?null:Ja(H),we=Jt(y),je=v(R,function(){},[l],R);return{url:R,queryString:H,hashString:we,route:je,data:null,params:P}}function B(){return ee(Z(Mo(o)).replace(new RegExp("^"+o),""))}function j(y){var k={instance:n,currentLocationPath:y,to:y,resolveOptions:a};return ba(k,function(){}),k.matches?k.matches:!1}function ze(y,k,R){typeof k<"u"&&(typeof R>"u"||R)&&(k=b(k));var H={instance:n,to:k,currentLocationPath:k};An(H,function(){}),typeof y=="string"&&(y=typeof R>"u"||R?b(y):y);var P=Po(H,{name:String(y),path:y,handler:function(){},hooks:{}});return P||!1}function Ge(y,k,R){return typeof k=="string"&&(k=_t(k)),k?(k.hooks[y]||(k.hooks[y]=[]),k.hooks[y].push(R),function(){k.hooks[y]=k.hooks[y].filter(function(H){return H!==R})}):(console.warn("Route doesn't exists: "+k),function(){})}function _t(y){return typeof y=="string"?r.find(function(k){return k.name===b(y)}):r.find(function(k){return k.handler===y})}function fa(y){y.instance.__dirty=!1,y.instance.__waiting.length>0&&y.instance.__waiting.shift()()}this.root=o,this.routes=r,this.destroyed=i,this.current=s,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=fa,this.on=u,this.off=E,this.resolve=d,this.navigate=f,this.navigateByName=_,this.destroy=$,this.notFound=W,this.updatePageLinks=D,this.link=se,this.hooks=ue,this.extractGETParameters=function(y){return Qt(h(y))},this.lastResolved=ce,this.generate=Ae,this.getLinkPath=M,this.match=j,this.matchLocation=ze,this.getCurrentLocation=B,this.addBeforeHook=Ge.bind(this,"before"),this.addAfterHook=Ge.bind(this,"after"),this.addAlreadyHook=Ge.bind(this,"already"),this.addLeaveHook=Ge.bind(this,"leave"),this.getRoute=_t,this._pathToMatchObject=ee,this._clean=Z,this._checkForAHash=h,this._setCurrent=function(y){return s=n.current=y},C.call(this),D.call(this)}var ti=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function ai(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Et={exports:{}},ni=Et.exports,$n;function oi(){return $n||($n=1,(function(e,t){(function(a,n){var o={};a.PubSub?(o=a.PubSub,console.warn("PubSub already loaded, using existing version")):(a.PubSub=o,n(o)),e!==void 0&&e.exports&&(t=e.exports=o),t.PubSub=o,e.exports=t=o})(typeof window=="object"&&window||ni||ti,function(a){var n={},o=-1,s="*";function r(d){var f;for(f in d)if(Object.prototype.hasOwnProperty.call(d,f))return!0;return!1}function i(d){return function(){throw d}}function l(d,f,_){try{d(f,_)}catch(E){setTimeout(i(E),0)}}function c(d,f,_){d(f,_)}function p(d,f,_,E){var C=n[f],$=E?c:l,W;if(Object.prototype.hasOwnProperty.call(n,f))for(W in C)Object.prototype.hasOwnProperty.call(C,W)&&$(C[W],d,_)}function h(d,f,_){return function(){var C=String(d),$=C.lastIndexOf(".");for(p(d,d,f,_);$!==-1;)C=C.substr(0,$),$=C.lastIndexOf("."),p(d,C,f,_);p(d,s,f,_)}}function b(d){var f=String(d),_=!!(Object.prototype.hasOwnProperty.call(n,f)&&r(n[f]));return _}function v(d){for(var f=String(d),_=b(f)||b(s),E=f.lastIndexOf(".");!_&&E!==-1;)f=f.substr(0,E),E=f.lastIndexOf("."),_=b(f);return _}function u(d,f,_,E){d=typeof d=="symbol"?d.toString():d;var C=h(d,f,E),$=v(d);return $?(_===!0?C():setTimeout(C,0),!0):!1}a.publish=function(d,f){return u(d,f,!1,a.immediateExceptions)},a.publishSync=function(d,f){return u(d,f,!0,a.immediateExceptions)},a.subscribe=function(d,f){if(typeof f!="function")return!1;d=typeof d=="symbol"?d.toString():d,Object.prototype.hasOwnProperty.call(n,d)||(n[d]={});var _="uid_"+String(++o);return n[d][_]=f,_},a.subscribeAll=function(d){return a.subscribe(s,d)},a.subscribeOnce=function(d,f){var _=a.subscribe(d,function(){a.unsubscribe(_),f.apply(this,arguments)});return a},a.clearAllSubscriptions=function(){n={}},a.clearSubscriptions=function(f){var _;for(_ in n)Object.prototype.hasOwnProperty.call(n,_)&&_.indexOf(f)===0&&delete n[_]},a.countSubscriptions=function(f){var _,E,C=0;for(_ in n)if(Object.prototype.hasOwnProperty.call(n,_)&&_.indexOf(f)===0){for(E in n[_])C++;break}return C},a.getSubscriptions=function(f){var _,E=[];for(_ in n)Object.prototype.hasOwnProperty.call(n,_)&&_.indexOf(f)===0&&E.push(_);return E},a.unsubscribe=function(d){var f=function(se){var ue;for(ue in n)if(Object.prototype.hasOwnProperty.call(n,ue)&&ue.indexOf(se)===0)return!0;return!1},_=typeof d=="string"&&(Object.prototype.hasOwnProperty.call(n,d)||f(d)),E=!_&&typeof d=="string",C=typeof d=="function",$=!1,W,D,Y;if(_){a.clearSubscriptions(d);return}for(W in n)if(Object.prototype.hasOwnProperty.call(n,W)){if(D=n[W],E&&D[d]){delete D[d],$=d;break}if(C)for(Y in D)Object.prototype.hasOwnProperty.call(D,Y)&&D[Y]===d&&(delete D[Y],$=!0)}return $}})})(Et,Et.exports)),Et.exports}var si=oi();const m=ai(si),g=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV.GO",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN.GO",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP.GO",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT.GO",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT.GO",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH.GO",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",AUTH_SCOPE_LOADED:"AUTH.SCOPE.LOADED",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",M5T_SIDE_NAV:"M5T_SIDE_NAV",M5T_SIDE_NAV_TAP:"M5T_SIDE_NAV.TAP",M5T_SIDE_NAV_COLLAPSE:"M5T_SIDE_NAV.COLLAPSE",M5T_SIDE_NAV_LOGO_TAP:"M5T_SIDE_NAV.LOGO_TAP",M5T_SIDE_NAV_ORG_SWITCH:"M5T_SIDE_NAV.ORG_SWITCH",M5T_SIDE_NAV_FOOTER_ACTION:"M5T_SIDE_NAV.FOOTER_ACTION",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL",MESSAGE:"MESSAGE",MESSAGE_CREATE:"MESSAGE.CREATE",MESSAGE_CREATED:"MESSAGE.CREATED",MESSAGE_EDIT:"MESSAGE.EDIT",MESSAGE_UPDATED:"MESSAGE.UPDATED",MESSAGE_DELETE:"MESSAGE.DELETE",MESSAGE_DELETED:"MESSAGE.DELETED",MESSAGE_REFRESH:"MESSAGE.REFRESH"}),ya={BASE_URL:"./",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://machfivemagnet-saas.onrender.com"};var wa={};const z=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_UI_DARK_MODE:!0,FF_SSE_UI_ANIMATIONS:!0,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel",FF_API_RATELIMIT_SIGNIN_ENFORCE:!1,FF_API_RATELIMIT_SIGNIN_IP_LIMIT:20,FF_API_RATELIMIT_SIGNIN_EMAIL_LIMIT:10,FF_API_RATELIMIT_FORGOT_ENFORCE:!1,FF_API_RATELIMIT_FORGOT_IP_LIMIT:15,FF_API_RATELIMIT_FORGOT_EMAIL_LIMIT:5,FF_API_RATELIMIT_CAPTURE_ENFORCE:!1,FF_API_RATELIMIT_CAPTURE_LIMIT:30,FF_API_RATELIMIT_EVENT_ENFORCE:!1,FF_API_RATELIMIT_EVENT_LIMIT:600,FF_API_RATELIMIT_CSP_PING_ENFORCE:!1,FF_API_RATELIMIT_CSP_PING_LIMIT:30,FF_API_RATELIMIT_WEBAUTHN_AUTH_ENFORCE:!1,FF_API_RATELIMIT_WEBAUTHN_AUTH_IP_LIMIT:20,FF_API_RATELIMIT_INTEGRATIONS_ENFORCE:!1,FF_API_RATELIMIT_INTEGRATIONS_LIMIT:60,FF_API_RATELIMIT_QUESTIONNAIRE_ENFORCE:!1,FF_API_RATELIMIT_QUESTIONNAIRE_LIMIT:30,FF_API_RATELIMIT_AUTHENTICATED_ENFORCE:!1,FF_API_RATELIMIT_AUTHENTICATED_LIMIT:600,FF_API_MAGNET_REQUIRE_ORIGIN_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_LIMIT:2e3});function qo(e,t=null){if(e in z)return z[e];if(typeof process<"u"&&wa&&wa[e]){const a=wa[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}if(typeof import.meta<"u"&&ya&&ya[e]){const a=ya[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}return t}function Xa(e){return qo(e,!1)===!0}function ri(){return{...z}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:z,getFlag:qo,isEnabled:Xa,getAllFlags:ri});const In={success:{border:"var(--color-success, #009473)",bg:"var(--color-success-soft, rgba(0,148,115,0.10))",icon:"check_circle"},danger:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},error:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},warning:{border:"var(--color-warning, #D97706)",bg:"var(--color-warning-soft, #FEF3C7)",icon:"warning"},info:{border:"var(--color-info, #0D9488)",bg:"var(--color-info-soft, #CCFBF1)",icon:"info"}},ii=4500,Ra=220;let Me=null,Ln=!1;function li(){if(Ln)return;const e=document.createElement("style");e.id="m5t-toast-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ln=!0}function ci(){return Me&&document.body.contains(Me)||(Me=document.createElement("div"),Me.className="m5t-toast-stack",Me.setAttribute("role","status"),Me.setAttribute("aria-live","polite"),document.body.appendChild(Me)),Me}function di(e){const t=e&&e.message;if(!t)return;li();const a=In[e.type]||In.info,n=document.createElement("div");n.className="m5t-toast",n.style.borderColor=a.border,n.style.background=a.bg,n.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true" style="color:${a.border}">${a.icon}</span><span class="m5t-toast__msg"></span><button type="button" class="m5t-toast__close" aria-label="Dismiss"><span class="material-symbols-outlined" aria-hidden="true">close</span></button>`,n.querySelector(".m5t-toast__msg").textContent=String(t),ci().appendChild(n),requestAnimationFrame(()=>n.classList.add("is-in"));let s=!1;const r=()=>{s||(s=!0,clearTimeout(i),n.classList.remove("is-in"),n.classList.add("is-out"),setTimeout(()=>n.remove(),Ra))},i=setTimeout(r,ii);n.querySelector(".m5t-toast__close").addEventListener("click",r)}function pi(){const e=t=>a=>{const n=a.detail?.pubsubTopic;n&&m.publish(n,a.detail)};document.addEventListener("nav-select",e()),document.addEventListener("logo-click",e()),document.addEventListener("nav-hover",e()),document.addEventListener("nav-double-tap",e()),document.addEventListener("nav-long-tap",e()),document.addEventListener("message-sent",e())}function ui(){console.log("[AppEvents] Initializing event listeners..."),m.subscribe(g.APP_READY,(a,n)=>{console.log("[AppEvents] APP_READY:",n)}),m.subscribe(g.APP_ERROR,(a,n)=>{console.error("[AppEvents] APP_ERROR:",n)}),m.subscribe(g.APP_SIGNOUT,(a,n)=>{console.log("[AppEvents] APP_SIGNOUT:",n)}),m.subscribe(g.ROUTE_NAV_BEFORE,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",n),m.publish(g.UI_LOADING_START)}),m.subscribe(g.ROUTE_NAV_AFTER,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",n),m.publish(g.UI_LOADING_END)}),m.subscribe(g.ROUTE_NAV_ERROR,(a,n)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",n),m.publish(g.APP_ERROR,{message:"Navigation error",details:n})}),m.subscribe(g.AUTH_SIGNIN_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",n)}),m.subscribe(g.AUTH_SIGNIN_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",n),m.publish(g.UI_TOAST,{message:n.message||"Sign in failed",type:"danger"})}),m.subscribe(g.AUTH_SIGNUP_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",n),m.publish(g.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"}),m.publish(g.AUTH_VERIFY_LINK)}),m.subscribe(g.AUTH_VERIFY_LINK,(a,n)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),m.subscribe(g.AUTH_SIGNUP_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",n),m.publish(g.UI_TOAST,{message:n.message||"Sign up failed",type:"danger"})}),m.subscribe(g.AUTH_SIGNOUT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",n),m.publish(g.UI_TOAST,{message:"Signed out successfully",type:"info"})}),m.subscribe(g.AUTH_SIGNUP,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),m.subscribe(g.AUTH_FORGOT,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),m.subscribe(g.AUTH_FORGOT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",n),m.publish(g.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),m.subscribe(g.AUTH_RESETHASH_NAV,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),m.subscribe(g.AUTH_RESETHASH_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",n),m.publish(g.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),m.subscribe(g.AUTH_TOKEN_EXPIRED,(a,n)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",n),m.publish(g.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),m.subscribe(g.I18N_SET_LANG,(a,n)=>{console.log("[AppEvents] I18N_SET_LANG:",n);const{langCode:o}=n;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),m.publish(g.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(s){console.error("[AppEvents] Error changing language:",s),m.publish(g.UI_TOAST,{message:`Failed to change language: ${s.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),m.subscribe("CONVERSATION.PROMPT",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",n.message),xa(n.message,"user",n.timestamp),m.publish(g.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Agent prompt (no implementation):",n.message);break;case"AGENT_CANVAS":console.log("[AppEvents] Display message in canvas:",n.message),xa(n.message,"user",n.timestamp),m.publish(g.CANVAS_DO_SCROLL);break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),m.subscribe("CONVERSATION.RESPONSE",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",n.message),xa(n.message,"assistant",n.timestamp,n.streaming);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),m.subscribe(g.UI_LOADING_START,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),m.subscribe(g.UI_LOADING_END,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),m.subscribe(g.UI_TOAST,(a,n)=>{di(n)}),m.subscribe(g.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const a="0.1",n=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${a} 8/11/2026, 10:46:36 AM|© ${n} Mach Five Tech`,"night")}),pi(),m.subscribe("M5T_PRIMARY_NAV",(a,n)=>{const o=a.split(".")[1];switch(o){case"TAP":e(n);break;case"LOGO_TAP":t();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function e(a){const{token:n,level:o,primaryToken:s}=a;switch(n){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),m.publish(g.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${n}`,{primaryToken:s});break}}function t(a){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 8/11/2026, 10:46:36 AM|© ${o} Mach Five Tech`,"night",5e3)}m.subscribe(g.AUTH_SIGNOUT,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(z.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function xa(e,t="user",a=null,n=!1){const o=document.getElementById("chat-messages");if(!o){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}if(a||(a=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})),n&&t==="assistant"){const r=o.firstElementChild;if(r&&r.tagName.toLowerCase()==="m5t-chat-response"){r.setAttribute("message",e),console.log(`[AppEvents] Updated streaming ${t} bubble (${e.length} chars)`);return}}let s;t==="user"||t==="prompt"?s=document.createElement("m5t-chat-prompt"):s=document.createElement("m5t-chat-response"),s.setAttribute("message",e),s.setAttribute("timestamp",a),o.prepend(s),console.log(`[AppEvents] Added ${t} bubble to canvas (${e.length} chars)`)}function Ho(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("uid")&&t.get("token"))}function mi(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("qr")&&t.get("token"))}function gi(e=window.location.search){const t=new URLSearchParams(e||""),a=t.get("qr"),n=t.get("token");return a&&n?{guid:a,token:n}:null}const hi=Object.freeze({admin_root_role:{value:100,desc:"Administrator superuser infrastructure architecture"},admin_business_role:{value:90,desc:"Administrator financial oversight"},admin_support_role:{value:80,desc:"Administrator maintenance and configuration"},admin_readonly_role:{value:70,desc:"Administrator information help desk"},client_tier_4_role:{value:40,desc:"Client paid tier 4 - Partner"},client_tier_3_role:{value:30,desc:"Client paid tier 3"},client_tier_2_role:{value:20,desc:"Client paid tier 2"},client_tier_1_role:{value:10,desc:"Client paid tier 1"},client_standard_role:{value:0,desc:"Client free tier 0"}});function fi(e){return hi[e]||null}function vi(e){return e>=50}const St=Object.freeze({owner:{value:"owner",rank:30,label:"Owner"},admin:{value:"admin",rank:20,label:"Admin"},member:{value:"member",rank:10,label:"Member"},viewer:{value:"viewer",rank:0,label:"Viewer"}}),bi=Object.freeze({VIEW_DASHBOARD:"view_dashboard",VIEW_MAGNETS:"view_magnets",PROVISION_MAGNETS:"provision_magnets",MANAGE_MAGNETS:"manage_magnets",VIEW_CONVERSATIONS:"view_conversations",VIEW_STATS:"view_stats",VIEW_AD_METRICS:"view_ad_metrics",CONNECT_AD_ACCOUNTS:"connect_ad_accounts",CREATE_CLIENT_ACCOUNTS:"create_client_accounts",MANAGE_TEAM:"manage_team",VIEW_BILLING:"view_billing",MANAGE_BILLING:"manage_billing"}),T=bi,zo=Object.freeze(Object.values(T)),Ye=Object.freeze([T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS]),_i=Object.freeze({reseller_org:{owner:zo,admin:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.CREATE_CLIENT_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING],member:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS],viewer:Ye},managed_client:{owner:[...Ye,T.VIEW_BILLING],admin:[...Ye,T.VIEW_BILLING],member:Ye,viewer:Ye},saas_org:{owner:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING,T.MANAGE_BILLING],admin:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING],member:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS],viewer:Ye}});function yi(e){const t=fi(e);return!!t&&vi(t.value)}function wi({entityClass:e,orgChannel:t,memberRole:a}={}){if(yi(e))return e==="admin_readonly_role"?[...Ye,T.VIEW_BILLING]:[...zo];const n=_i[t],o=n&&n[a];return o?[...o]:[]}function xi(e,t){const a=St[e]?.rank??-1,n=St[t]?.rank??1/0;return a>=St.admin.rank&&a>=n}const Za=[{value:"name",label:"Full name (splits into first + last automatically)"},{value:"first_name",label:"First name"},{value:"last_name",label:"Last name"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"mobile",label:"Mobile phone"},{value:"company",label:"Company"},{value:"title",label:"Job title"},{value:"city",label:"City"},{value:"state",label:"State / province"},{value:"product_interest",label:"Product interest"},{value:"lead_source",label:"Lead source"},{value:"rating",label:"Rating (Hot / Warm / Cold)"},{value:"description",label:"Notes / description"},{value:"salutation",label:"Salutation (Mr. / Ms. / Dr.)"},{value:"street",label:"Street address"},{value:"zip",label:"Postal / ZIP code"},{value:"country",label:"Country"},{value:"url",label:"Website URL"},{value:"industry",label:"Industry"},{value:"annual_revenue",label:"Annual revenue (number)"},{value:"employees",label:"Number of employees (whole number)"},{value:"is_primary",label:"Primary contact (Yes / No)"},{value:"current_generators",label:"Current generator(s)"},{value:"number_of_locations",label:"Number of locations (whole number)"}];new Set(Za.map(e=>e.value));const en=[{value:"single_select",label:"Multiple choice"},{value:"multi_select",label:"Select all"},{value:"scheduler",label:"Scheduler"},{value:"text",label:"Short text"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"message",label:"Message"}];new Set(en.map(e=>e.value));const Ei=[{value:"inline",label:"Inline"},{value:"chat",label:"Chat"},{value:"right_slide",label:"Slide"},{value:"modal",label:"Modal"}],Ai=[{value:"auto",label:"Auto"},{value:"light",label:"Light"},{value:"dark",label:"Dark"}],ki=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],Si=[{value:"book",label:"Book"},{value:"call",label:"Call"},{value:"email",label:"Email"},{value:"chat",label:"Chat"},{value:"support",label:"Support"}];Ei.map(e=>e.value);Ai.map(e=>e.value);ki.map(e=>e.value);Si.map(e=>e.value);class x{static CONFIG={BASE_URL:"https://machfivemagnet-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink",SCOPE:"sse_session_scope",ACTIVE_ORG:"sse_active_org",REMEMBERED_EMAIL:"sse_remembered_email"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",ME:"/m5t/v5/acctEntity/me",PING:"/ping",WEBAUTHN_AUTH_OPTIONS:"/m5t/v5/webauthn/authenticate/options",WEBAUTHN_AUTH_VERIFY:"/m5t/v5/webauthn/authenticate/verify"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#o=null;static#a=null;static#n=null;static#s=null;static#i=null;static async init({BASE_URL:t,navigateFunction:a,customConfig:n={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(a&&typeof a=="function")this.#i=a;else throw new Error("navigateFunction is required and must be a function");return t&&(this.CONFIG.BASE_URL=t),n&&Object.keys(n).length>0&&(this.CONFIG={...this.CONFIG,...n}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#m(),this.#u(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#u(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((t=null)=>{if(t){if(Ho()&&(t==="splash"||t==="signin")){console.log("[AuthController] Ignoring mvvLegit redirect to",t,"— keeping invitee on accept-invite");return}console.log("[AuthController] mvvLegit navigation to:",t),this.#r(t)}}).setOnState((t=null)=>{if(t)switch(console.log("[AuthController] Auth state changed:",t),t){case"AUTH":case 4:this.#_();break;case"UNAUTH":case 1:this.#y();break;case"UNVERF":case 2:this.#w();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#r(t){if(!this.#i){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",t);const a=t.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",a),this.#i(a)}static#l(){if(window.__m5tActiveOrgFetch)return;const t=window.fetch.bind(window);window.fetch=(a,n)=>{try{const o=typeof a=="string"?a:a?.url||"",s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);if(s&&o.startsWith(this.CONFIG.BASE_URL)){const r=new Headers(n&&n.headers||(a instanceof Request?a.headers:void 0));r.set("X-Active-Org",s),n={...n||{},headers:r}}}catch{}return t(a,n)},window.__m5tActiveOrgFetch=!0,console.log("[AuthController] Active-org fetch header installed")}static#m(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);t&&(this.#o=JSON.parse(t),console.log("[AuthController] Entity state loaded; hasEmail:",!!this.#o?.email))}catch(t){console.error("[AuthController] Error loading entity state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#o=null}this.#s=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.SCOPE);t&&(this.#a=JSON.parse(t),console.log("[AuthController] Scope state loaded (cached):",this.#a?.uiMode))}catch(t){console.error("[AuthController] Error loading scope state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE),this.#a=null}}static#c(t){try{this.#o=t,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(t)),console.log("[AuthController] Entity state saved")}catch(a){console.error("[AuthController] Error saving entity state:",a)}}static#d(){this.#o=null,this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}}static getEntity(){return this.#o}static#v(t){try{this.#a=t,localStorage.setItem(this.CONFIG.LS_KEYS.SCOPE,JSON.stringify(t))}catch(a){console.error("[AuthController] Error saving scope state:",a)}}static async fetchScope(){return typeof mvvLegit>"u"||!this.isAuthenticated()?(console.log("[AuthController] fetchScope skipped — not authenticated"),this.#a):this.#n?this.#n:(this.#n=this.#b().finally(()=>{this.#n=null}),this.#n)}static async#b(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),a=t?`?org=${encodeURIComponent(t)}`:"",n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.ME}${a}`);if(n.status===401||n.status===403)return console.warn("[AuthController] /me unauthorized — signing out"),this.doSignout(!0),null;if(!n.ok)return console.warn(`[AuthController] /me failed (${n.status}) — using cached scope`),this.#a;const o=await n.json();if(!o?.ok)return console.warn("[AuthController] /me returned not-ok — using cached scope"),this.#a;try{const s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);s&&o.activeOrg?.guid!==s&&(console.warn(`[AuthController] Stored active org not honored by /me${o.activeOrgError?" (activeOrgError)":""} — clearing`),localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG))}catch{}return this.#v(o),m.publish(g.AUTH_SCOPE_LOADED,o),console.log(`[AuthController] Scope loaded: ${o.uiMode} (${o.memberships?.length||0} org(s), ${o.managedClients?.length||0} client(s))`),o}catch(t){return console.error("[AuthController] fetchScope error:",t),this.#a}}static async setActiveOrg(t){try{t?localStorage.setItem(this.CONFIG.LS_KEYS.ACTIVE_ORG,t):localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}return this.fetchScope()}static getScope(){return this.#a}static getCapabilities(){return this.isPreviewingAsClient()?wi({orgChannel:"managed_client",memberRole:"owner"}):this.#a?.capabilities||[]}static getUiMode(){return this.isPreviewingAsClient()?"managed":this.#a?.uiMode||"self_serve"}static getActiveOrg(){return this.#a?.activeOrg||null}static getMemberships(){return this.#a?.memberships||[]}static getManagedClients(){return this.#a?.managedClients||[]}static getStoredActiveOrg(){try{return localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{return null}}static#p="m5m_preview_as_client";static isPreviewingAsClient(){try{return sessionStorage.getItem(this.#p)==="1"&&!!this.#a?.activeOrg?.viaSubtree}catch{return!1}}static setPreviewAsClient(t){try{t?sessionStorage.setItem(this.#p,"1"):sessionStorage.removeItem(this.#p)}catch{}this.#a&&m.publish(g.AUTH_SCOPE_LOADED,this.#a)}static async doSignin(t,a){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a})}),o=await n.json();if(n.status===303)return console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#c(o.entity)),setTimeout(()=>{this.#r(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o};if(n.ok&&o.accessToken){console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#c(o.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),console.log("[AuthController] Explicitly navigating to home"),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}}return{ok:!1,error:o.error||"Sign in failed",data:o}}catch(n){return console.error("[AuthController] Signin error:",n),{ok:!1,error:n.message}}}static async doPasskeySignin(){if(!window.PublicKeyCredential)return{ok:!1,error:"Passkeys are not supported in this browser"};try{const{startAuthentication:t}=await J(async()=>{const{startAuthentication:i}=await Promise.resolve().then(()=>es);return{startAuthentication:i}},void 0,import.meta.url),a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_OPTIONS}`,{method:"POST"}),n=await a.json();if(!a.ok||!n.ok)return{ok:!1,error:n.error||"Could not start passkey sign-in"};let o;try{o=await t({optionsJSON:n.options})}catch(i){const l=i?.name==="NotAllowedError";return l||console.error("[AuthController] Passkey ceremony error:",i),{ok:!1,canceled:l,error:l?"Passkey sign-in was canceled":i.message||"Passkey sign-in failed"}}const s=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_VERIFY}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o})}),r=await s.json();if(!s.ok||!r.ok||!r.accessToken)return{ok:!1,error:r.error||"Passkey sign-in failed",data:r};mvvLegit.doSignin(r.accessToken),this.#c(r.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:r}}catch(t){return console.error("[AuthController] Passkey signin error:",t),{ok:!1,error:t.message}}}static async doSignout(t=!1){console.log("[AuthController] doSignout called, serverInitiated:",t);try{const a=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!a),!t&&a){const n=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(a)}`;if(console.log("[AuthController] Sending signout beacon to:",n),navigator.sendBeacon){const o=navigator.sendBeacon(n);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else a||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#d(),console.log("[AuthController] Stopping auth ping..."),this.#h(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(a){console.error("[AuthController] Signout error:",a),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(t){try{const a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await a.json();return a.ok&&n.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#c(n.entity),{ok:!0,data:n}):{ok:!1,error:n.error||"Sign up failed",data:n}}catch(a){return console.error("[AuthController] Signup error:",a),{ok:!1,error:a.message}}}static async doResetHash(t,a){try{const n=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a,modified_by:t})}),s=await o.json();return o.ok&&s.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:s}):{ok:!1,error:s.error||"Password reset failed",data:s}}catch(n){return console.error("[AuthController] Reset password error:",n),{ok:!1,error:n.message}}}static#g(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#f()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#h(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#f(){try{const t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);t.ok?console.log("[AuthController] Ping success"):(t.status===401||t.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(t){console.error("[AuthController] Ping error:",t)}}static setDeepLinkGuid(t){this.#s=t,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,t),console.log("[AuthController] Deep-link GUID stored:",t)}static getDeepLinkGuid(){return this.#s}static clearDeepLink(){this.#s=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#_(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),queueMicrotask(()=>this.fetchScope())}static#y(){console.log("[AuthController] User unauthenticated"),this.#h()}static#w(){console.log("[AuthController] User unverified")}static getAuthState(){try{const t=mvvLegit.getConf()?.LSKEY||"mvv",a=localStorage.getItem(t);if(!a)return"UNAUTH";if(typeof LZString>"u")return null;const n=LZString.decompressFromUTF16(a),s=JSON.parse(n)?.state;return s===1?"UNAUTH":s===2?"UNVERF":s===4?"AUTH":s===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(t){this.#r(t)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#f()}}class I{static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",remember_email:"Remember my email",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_dashboard:"Dashboard",nav_dashboard_tagline:"Overview of your activity",nav_magnets:"Your Magnets",nav_magnets_tagline:"Manage your conversational magnets",nav_templates:"Templates",nav_templates_tagline:"Start from a magnet template",nav_conversations:"Conversations",nav_conversations_tagline:"Captured lead conversations",nav_ab_testing:"A/B Testing",nav_ab_testing_tagline:"Experiment and optimize",nav_analytics:"Analytics",nav_analytics_tagline:"Performance and ad metrics",nav_ad_accounts:"Ad Accounts",nav_ad_accounts_tagline:"Connect advertising accounts",nav_clients:"Clients",nav_clients_tagline:"Manage your client accounts",nav_team:"Team",nav_team_tagline:"Invite and manage teammates",nav_billing:"Billing",nav_billing_tagline:"Plan, usage, and invoices",nav_settings:"Settings",nav_settings_tagline:"Account and workspace settings",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Rollers",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",remember_email:"Recordar mi correo electrónico",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Rollers",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",remember_email:"记住我的邮箱",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"滚动器",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:t,product:a,whitelabel:n,lang:o}){t&&(this.#t.buildMode=t),a&&(this.#t.product=a),n&&(this.#t.whitelabel=n),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{let l=this.#e[o]?.[s]?.[r]?.[i]?.[t],c=o;return!l&&o!=="LOCAL"&&(l=this.#e.LOCAL?.[s]?.[r]?.[i]?.[t],c="LOCAL (fallback)"),l?(c==="LOCAL (fallback)"&&console.warn(`[MicrocopyManager] Token '${t}' missing from ${o} — served from LOCAL instead. Backfill ${o}'s block if this is intentionally different copy.`),Array.isArray(l)?l[Math.floor(Math.random()*l.length)]:l):(console.warn(`[MicrocopyManager] Token not found: ${t} (${o}/${s}/${r}/${i}, LOCAL fallback also missing it)`),null)}catch(l){return console.error(`[MicrocopyManager] Error retrieving token: ${t}`,l),null}}static getAll(t={}){const a={...this.#t,...t},{buildMode:n,product:o,whitelabel:s,lang:r}=a;try{return this.#e[n]?.[o]?.[s]?.[r]||null}catch(i){return console.error("[MicrocopyManager] Error retrieving all tokens",i),null}}static has(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return!!this.#e[o]?.[s]?.[r]?.[i]?.[t]}catch{return!1}}static getAvailableLanguages(){const{buildMode:t,product:a,whitelabel:n}=this.#t;try{return Object.keys(this.#e[t]?.[a]?.[n]||{})}catch{return[]}}static update(t,a,n={}){const o={...this.#t,...n},{buildMode:s,product:r,whitelabel:i,lang:l}=o;try{return this.#e[s]||(this.#e[s]={}),this.#e[s][r]||(this.#e[s][r]={}),this.#e[s][r][i]||(this.#e[s][r][i]={}),this.#e[s][r][i][l]||(this.#e[s][r][i][l]={}),this.#e[s][r][i][l][t]=a,!0}catch(c){return console.error(`[MicrocopyManager] Error updating token: ${t}`,c),!1}}static delete(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return delete this.#e[o]?.[s]?.[r]?.[i]?.[t],!0}catch(l){return console.error(`[MicrocopyManager] Error deleting token: ${t}`,l),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(t){try{return this.#e=t,!0}catch(a){return console.error("[MicrocopyManager] Error importing data",a),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:I});class Ne{static#e=!1;static#t=null;static#o=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const t=this.#n();I.setContext(t),console.log("[I18nController] Initialized with context:",t),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#s(),this.#u(),this.#e=!0,this.refresh()}static#a(t){const a={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},n=t.toLowerCase();return a[n]||"DEV"}static#n(){const a=this.#a("production"),n=localStorage.getItem(z.FF_SSE_LS_WHITELABEL)||z.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(z.FF_SSE_LS_USER_LANG)||z.FF_SSE_I18N_LANG;return{buildMode:a,product:z.FF_SSE_I18N_PRODUCT,whitelabel:n,lang:o}}static#s(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((t,a,n)=>{z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",n),this.#t=n,setTimeout(()=>{this.refresh()},z.FF_SSE_I18N_APPLY_DELAY_MS)},z.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#i())}static#i(){setInterval(()=>{const a=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");a&&a!==this.#t&&(this.#t=a,this.refresh())},500)}static#u(){this.#o||(this.#o=new MutationObserver(t=>{let a=!1;for(const n of t){for(const o of n.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){a=!0;break}if(a)break}a&&(z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#o.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#r(document.body),this.#l(document.body),z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#r(t){const a=t.querySelectorAll("[data-meta-copywrite-i118n]");z.FF_SSE_I18N_DEBUG&&a.length>0&&console.log(`[I18nController] Processing ${a.length} elements`),a.forEach(n=>{try{const o=n.getAttribute("data-meta-copywrite-i118n"),s=JSON.parse(o);if(!s.token){console.warn("[I18nController] Missing token in config:",s);return}const r=s.attribute||"textContent",i=I.get(s.token);if(i===null){console.warn(`[I18nController] Microcopy not found for token: ${s.token}`);return}r==="textContent"?n.textContent=i:r==="innerHTML"?n.innerHTML=i:n.setAttribute(r,i),z.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${i}" to ${r} for token: ${s.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,n)}})}static#l(t){t.querySelectorAll("*").forEach(n=>{n.shadowRoot&&(this.#r(n.shadowRoot),this.#l(n.shadowRoot))})}static setLanguage(t){const a=I.getAvailableLanguages();if(!a.includes(t)){console.error(`[I18nController] Language not available: ${t}. Available:`,a);return}localStorage.setItem(z.FF_SSE_LS_USER_LANG,t),I.setContext({lang:t}),console.log("[I18nController] Language changed to:",t);const n=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:t}});document.dispatchEvent(n),this.refresh()}static setWhitelabel(t){localStorage.setItem(z.FF_SSE_LS_WHITELABEL,t),I.setContext({whitelabel:t}),z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",t),this.refresh()}static getLanguage(){return I.getContext().lang}static getAvailableLanguages(){return I.getAvailableLanguages()}static getContext(){return I.getContext()}static destroy(){this.#o&&(this.#o.disconnect(),this.#o=null),this.#e=!1,this.#t=null,z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{Ne.initialize()}):Ne.initialize());class tn{static _initialized=!1;static _debug=!1;static init(t={}){if(this._initialized)return console.warn("[MachVive] Already initialized, skipping duplicate initialization"),this;if(this._debug=t.debug||!1,!window.mvvSSEther)return console.error("[MachVive] mvvSSEther not found - cannot initialize bridge"),console.error("[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()"),this;console.log("[MachVive] Initializing SSE to PubSub bridge...");const a=n=>{this._handleSSEMessage(n)};return window.mvvSSEther.onmessage(a),this._initialized=!0,console.log("[MachVive] ✓ SSE to PubSub bridge initialized successfully"),console.log("[MachVive] ✓ Bound callback to mvvSSEther.onmessage"),this}static _handleSSEMessage(t){try{this._debug&&console.log("[MachVive] SSE message received:",t);const a=t?.data;if(!a){this._debug&&console.log("[MachVive] No data in message, skipping");return}const n=a.data||a.package||a;if(!n){this._debug&&console.log("[MachVive] No package found in message, skipping");return}let o=n.cfg;const s=n.msg;if(this._debug&&(console.log("[MachVive] cfg (raw):",o,"type:",typeof o,"length:",o?.length),console.log("[MachVive] msg (raw):",s)),typeof o=="string"){if(o.trim()===""){this._debug&&console.log("[MachVive] cfg is empty string, skipping");return}try{o=JSON.parse(o),console.log("[MachVive] cfg (parsed):",o)}catch(i){console.warn("[MachVive] Failed to parse cfg as JSON:",{cfg:o,cfgLength:o.length,error:i.message});return}}else if(!o){this._debug&&console.log("[MachVive] cfg is empty/null, skipping");return}const r=o?.topic;if(!r){this._debug&&console.log("[MachVive] No topic found in cfg, skipping");return}if(console.log("[MachVive] Extracted topic:",r),!this._isValidTopic(r)){console.warn(`[MachVive] Topic '${r}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(r,s,t,a)}catch(a){console.error("[MachVive] Error handling SSE message:",a)}}static _isValidTopic(t){return!g||!g.hasOwnProperty(t)?(console.warn(`[MachVive] Topic '${t}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(t,a,n,o){try{if(!window.PubSub&&typeof PubSub>"u"){console.error("[MachVive] PubSub not available");return}const s=window.PubSub||PubSub,r={message:a,metadata:{source:"sse",sseEventId:n.id,timestamp:n.timestamp,appGuid:o.app_guid,channelGuid:o.channel_guid,eventAction:o.event_action,status:o.status,class:o.class,raw:o}};console.log(`[MachVive] Publishing to topic '${t}':`,r);const i=g[t];console.log(`[MachVive] AppBroadcast.${t} = '${i}'`),s.publish(i,r),console.log(`[MachVive] ✓ Published SSE message to topic: ${t}`)}catch(s){console.error(`[MachVive] Error publishing to topic '${t}':`,s)}}static debug(t){return this._debug=t,console.log(`[MachVive] Debug mode ${t?"enabled":"disabled"}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log("[MachVive] Reset complete"),this}}typeof module<"u"&&module.exports&&(module.exports=tn);typeof window<"u"&&(window.MachVive=tn);const Rn="m5t_sidenav_collapsed",Ti={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};class Ci extends HTMLElement{static get observedAttributes(){return["data-active-token","data-collapsed"]}constructor(){super(),this.attachShadow({mode:"open"}),this.items=[],this.orgs=[],this.activeOrgGuid=null,this.activeToken=null,this.footerBadge=null,this.loading=!1,this.lastFocus=null}#e=null;#t=t=>{if(this.getAttribute("data-open")==="true"){if(t.key==="Escape"){t.preventDefault(),this.closeDrawer();return}if(t.key==="Tab"){const a=this.#c();if(a.length<2)return;const n=a[0],o=a[a.length-1],s=this.shadowRoot.activeElement;t.shiftKey&&s===n?(t.preventDefault(),o.focus()):!t.shiftKey&&s===o&&(t.preventDefault(),n.focus())}}};#o=()=>{this.closeDrawer(),this.#d()};connectedCallback(){if(!this.hasAttribute("data-collapsed"))try{localStorage.getItem(Rn)==="true"&&this.setAttribute("data-collapsed","true")}catch{}this.activeToken=this.getAttribute("data-active-token")||null,this.render(),this.#l(),this.addEventListener("keydown",this.#t),this.#e=window.matchMedia("(max-width: 768px)"),this.#e.addEventListener("change",this.#o),this.#d()}disconnectedCallback(){this.removeEventListener("keydown",this.#t),this.#e?.removeEventListener("change",this.#o)}attributeChangedCallback(t,a,n){a===n||!this.shadowRoot||(t==="data-active-token"?(this.activeToken=n,this.#m()):t==="data-collapsed"&&this.shadowRoot.firstChild&&(this.render(),this.#l()))}setState({buttons:t,orgs:a,activeOrg:n,footerBadge:o,loading:s}={}){t!==void 0&&(this.items=Array.isArray(t)?t:this.#a(t)||[]),a!==void 0&&(this.orgs=Array.isArray(a)?a:this.#a(a)||[]),n!==void 0&&(this.activeOrgGuid=n||null),o!==void 0&&(this.footerBadge=o||null),s!==void 0&&(this.loading=!!s),this.shadowRoot&&(this.render(),this.#l())}setButtons(t){this.setState({buttons:t})}setOrgs(t){this.setState({orgs:t})}setActiveOrgGuid(t){this.setState({activeOrg:t})}setFooterBadge(t){this.setState({footerBadge:t})}setActiveToken(t){this.activeToken=t||null,this.#m()}toggleCollapsed(t){const a=typeof t=="boolean"?t:this.getAttribute("data-collapsed")!=="true";this.setAttribute("data-collapsed",String(a));try{localStorage.setItem(Rn,String(a))}catch{}this.dispatchEvent(new CustomEvent("nav-collapse",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_SIDE_NAV.COLLAPSE",collapsed:a,timestamp:Date.now()}}))}openDrawer(){this.lastFocus=this.shadowRoot.activeElement||document.activeElement,this.setAttribute("data-open","true"),this.shadowRoot.querySelector(".hamburger")?.setAttribute("aria-expanded","true"),this.#d(),(this.#c()[0]||this.shadowRoot.querySelector(".sidenav"))?.focus?.()}closeDrawer(){if(this.getAttribute("data-open")!=="true")return;this.removeAttribute("data-open");const t=this.shadowRoot.querySelector(".hamburger");t?.setAttribute("aria-expanded","false"),this.#d(),t&&this.#e?.matches?t.focus():this.lastFocus?.focus?.()}toggleDrawer(){this.getAttribute("data-open")==="true"?this.closeDrawer():this.openDrawer()}#a(t){try{return t?JSON.parse(t):null}catch(a){return console.error("[M5TSideNav] bad JSON:",a),null}}#n(t){return String(t??"").replace(/[&<>"']/g,a=>Ti[a])}#s(t){return t?`<span class="ms" aria-hidden="true">${this.#n(t)}</span>`:""}#i(t){if(!t||!t.token)return"";const a=t.token===this.activeToken,n=t.route||"#",o=n.startsWith("#")?n:`#${n}`,s=typeof t.count=="number"&&t.count>0?`<span class="badge">${t.count}</span>`:"";return`
  ...
  </div>`}const Oi='<div class="m5t-notif-skel"><span></span><span></span><span></span></div>'.repeat(3),Ea=e=>e.dataset.open==="true",Na=(e,t)=>{e.dataset.open=t?"true":"false"};function Mi(e){const t=document.getElementById("m5t-notif-bell");if(t&&(t.hidden=!e),!e){const a=document.getElementById("m5t-notif-panel");a&&Na(a,!1)}}const Pi=14;let Aa=null;function Fi(e){if(typeof ResizeObserver>"u"||!e)return;const t=document.getElementById("m5t-notif-bell"),a=document.getElementById("m5t-notif-bell-btn");if(!t||!a)return;const n=()=>{const o=e.hidden?null:e.querySelector(".ocb-btn");if(o){const s=o.getBoundingClientRect(),r=a.getBoundingClientRect().height;t.style.top=`${Math.round(s.top+(s.height-r)/2)}px`}else t.style.top=`${Pi}px`};Aa?.disconnect(),Aa=new ResizeObserver(n),Aa.observe(e),n()}let Nn=null;function Di(){const e=document.getElementById("m5t-notif-bell-btn"),t=document.getElementById("m5t-notif-badge"),a=document.getElementById("m5t-notif-panel");if(!e||!t||!a)return;const n=p=>{t.textContent=p>99?"99+":String(p),t.hidden=!p},o=async()=>{try{const p=await fetch(`${ot()}/m5t/v5/notifications/unread-count`),h=await p.json().catch(()=>({}));p.ok&&h.ok&&n(h.count||0)}catch{}},s=(p="")=>`<div class="m5t-notif-head">Notifications${p?`<span class="m5t-notif-head__actions">${p}</span>`:""}</div>`,r=()=>{a.querySelectorAll(".m5t-notif-item, .m5t-notif-empty").forEach(p=>p.remove()),a.querySelector(".m5t-notif-head__actions")?.remove(),a.insertAdjacentHTML("beforeend",'<div class="m5t-notif-empty">You’re all caught up.</div>')},i=async()=>{a.innerHTML=s()+Oi;try{const p=await fetch(`${ot()}/m5t/v5/notifications`),h=await p.json().catch(()=>({}));if(!p.ok||!h.ok)throw new Error;const b=h.notifications||[],v=[b.some(u=>!u.read)?'<button class="m5t-notif-markall" type="button">Mark all read</button>':"",b.length?'<button class="m5t-notif-clearall" type="button">Clear all</button>':""].join("");a.innerHTML=s(v)+(b.length?b.map(Ni).join(""):'<div class="m5t-notif-empty">You’re all caught up.</div>')}catch{a.innerHTML=s()+'<div class="m5t-notif-empty">Could not load. Try again.</div>'}},l=()=>{Na(a,!1),e.setAttribute("aria-expanded","false")},c=async()=>{Na(a,!0),e.setAttribute("aria-expanded","true"),await i()};e.addEventListener("click",p=>{p.stopPropagation(),Ea(a)?l():c()}),document.addEventListener("click",p=>{Ea(a)&&!a.contains(p.target)&&p.target!==e&&l()}),document.addEventListener("keydown",p=>{p.key==="Escape"&&Ea(a)&&(l(),e.focus())}),a.addEventListener("click",async p=>{const h=p.target.closest("[data-dismiss]");if(h){p.preventDefault(),p.stopPropagation();const d=h.closest(".m5t-notif-item"),f=h.dataset.dismiss,_=d?.dataset.read==="false";d?.setAttribute("data-leaving","true");try{await fetch(`${ot()}/m5t/v5/notifications/${encodeURIComponent(f)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:"DISMISSED"})})}catch{}setTimeout(()=>{d?.remove(),a.querySelector(".m5t-notif-item")||r()},180),_&&o();return}const b=p.target.closest(".m5t-notif-clearall");if(b){p.preventDefault(),b.disabled=!0,a.querySelectorAll(".m5t-notif-item").forEach(d=>d.setAttribute("data-leaving","true"));try{await fetch(`${ot()}/m5t/v5/notifications/dismiss-all`,{method:"PATCH"})}catch{}setTimeout(r,180),o();return}const v=p.target.closest(".m5t-notif-item");if(v&&v.dataset.read==="false"){const d=v.dataset.guid;v.dataset.read="true";try{await fetch(`${ot()}/m5t/v5/notifications/${encodeURIComponent(d)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({read:!0})}),o()}catch{}return}const u=p.target.closest(".m5t-notif-markall");if(u){p.preventDefault(),a.querySelectorAll(".m5t-notif-item").forEach(d=>{d.dataset.read="true"}),u.remove();try{await fetch(`${ot()}/m5t/v5/notifications/read-all`,{method:"PATCH"})}catch{}o()}}),o(),clearInterval(Nn),Nn=setInterval(o,Li)}function an(){return Xa("FF_SSE_UI_DARK_MODE")}function Bi(e=an()){return e&&localStorage.getItem(z.FF_SSE_LS_THEME)==="dark"?"dark":"light"}function Ui(e=Xa("FF_SSE_UI_ANIMATIONS")){return!e}function qi(e,t=an()){!e||t||e.shadowRoot?.querySelector('.footer-action[data-action="theme"]')?.remove()}window.m5t=Object.create(null);window.m5t.pubsub=m;console.log("StreamSyncEngage SaaS Client - Starting...");console.log("Environment:","production");console.log("Document readyState:",document.readyState);console.log("window.mvvLegit:",typeof window.mvvLegit);console.log("globalThis.mvvLegit:",typeof globalThis.mvvLegit);try{console.log("mvvLegit (direct):",typeof mvvLegit)}catch(e){console.log("mvvLegit (direct): ReferenceError -",e.message)}const Hi=Object.keys(window).filter(e=>e.toLowerCase().includes("mvv")||e.toLowerCase().includes("neodigm")||e.toLowerCase().includes("legit"));console.log("Possible Neodigm globals:",Hi);const F=new ei("/",{hash:!0});window.router=F;function ge(e){const t=e?`${e.replace(/-/g,"_")}_route`:"splash_route";return console.log(`[Router] Checking access: ${e} -> ${t}`),mvvLegit.isRouteAllowed(t)?!0:(console.warn(`[Router] Access denied to route: ${t}`),m.publish(g.UI_TOAST,{message:"Please sign in to access this page",type:"warning"}),!1)}function le(e){console.log("[Router] Navigating to:",e),F.navigate(`/${e}`)}const nn=new Set(["splash","signin","signup","forgot","resethash","verf-link","accept-invite","signout"]);let Tt={},Oa={},Ze=null;const zi={admin:{caption:"Platform Admin",icon:"shield_person"},reseller:{caption:"Reseller",icon:"handshake"},managed:{caption:"Managed",icon:"visibility"},self_serve:{caption:"Self-Serve",icon:"rocket_launch"}},Ma="__portfolio__";function Go(){try{F._setCurrent(null)}catch{}F.resolve()}function ka(){const e=document.getElementById("m5t-side-nav");if(!e)return;const t=!x.getScope()&&x.isAuthenticated(),a=x.getCapabilities(),n=x.getUiMode(),o=ua.getSideNav(a,{uiMode:n});Tt={},Oa={};const s=b=>{b.route&&(Tt[b.route]={sectionToken:b.token,childToken:null,children:b.children||null},Array.isArray(b.children)&&b.children.forEach(v=>{v.route&&(Oa[v.token]=v.route,Tt[v.route]={sectionToken:b.token,childToken:v.token,children:b.children})}))},r=b=>b.forEach(v=>{v.group&&Array.isArray(v.items)?r(v.items):s(v)});r(o);const i=x.getMemberships(),l=x.getActiveOrg(),c=x.getManagedClients(),p=x.getStoredActiveOrg(),h=c.length?[{guid:Ma,name:"Portfolio (all clients)"},...i.map(b=>({guid:b.orgGuid,name:b.name||b.channel,channel:b.channel,group:"Your organization"})),...c.map(b=>({guid:b.orgGuid,name:b.name||b.orgGuid,channel:b.channel,group:"Clients"}))]:i.map(b=>({guid:b.orgGuid,name:b.name||b.channel,channel:b.channel}));e.setState({buttons:o,orgs:h,activeOrg:c.length?p||Ma:l?.guid||null,footerBadge:zi[n]||null,loading:t}),jo(),Ze&&Vo(Ze)}const Gi=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]);function jo(){const e=document.getElementById("app-content");if(!e)return;let t=document.getElementById("org-context-banner");t||(t=document.createElement("div"),t.id="org-context-banner",e.insertBefore(t,e.firstChild),Fi(t));const a=x.getActiveOrg(),n=x.isPreviewingAsClient(),o=!!a?.viaSubtree&&!!Ze&&!nn.has(Ze);if(t.hidden=!o,!o){t.innerHTML="";return}const s=Gi(a.name||"Client");t.innerHTML=`
    <style>
    ...
    <div class="ocb" role="status">
    ...
    </div>`,t.querySelector('[data-ocb="preview"]')?.addEventListener("click",()=>{x.setPreviewAsClient(!x.isPreviewingAsClient()),Go()}),t.querySelector('[data-ocb="portfolio"]')?.addEventListener("click",()=>{x.setPreviewAsClient(!1),x.setActiveOrg(null)})}function Vo(e){const t=document.getElementById("m5t-side-nav"),a=Tt[`/${e}`]||Tt[e]||null;t?.setActiveToken(a?.sectionToken||null),ji(a)}function ji(e){const t=document.getElementById("m5t-sub-nav"),a=document.getElementById("app-shell");if(!t)return;const n=e?.children;t.hidden=!1,n&&n.length>1?(t.updateButtons(n.map(o=>({token:o.token,caption:o.caption,enabled:!0,selected:o.token===e.childToken}))),a?.classList.add("has-sub-nav")):(t.updateButtons([]),a?.classList.remove("has-sub-nav"))}function Vi(){const e=Ne.getAvailableLanguages&&Ne.getAvailableLanguages()||[];if(e.length<2){m.publish(g.UI_TOAST,{message:"Only one language is available",type:"info"});return}const t=localStorage.getItem(z.FF_SSE_LS_USER_LANG)||z.FF_SSE_I18N_LANG||e[0],a=e[(e.indexOf(t)+1)%e.length];Ne.setLanguage(a),m.publish(g.UI_TOAST,{message:`Language: ${a}`,type:"info"})}function Wo(e){document.documentElement.setAttribute("data-theme",e)}function Wi(){Wo(Bi())}function Yi(){if(!an())return;const e=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";Wo(e),localStorage.setItem(z.FF_SSE_LS_THEME,e),m.publish(g.UI_TOAST,{message:e==="dark"?"Dark mode on":"Dark mode off",type:"info"})}function Ki(){document.documentElement.classList.toggle("ff-no-animations",Ui())}function Ji(){const e=document.getElementById("m5t-side-nav");if(!e)return;ua.setAppToken("client-saas"),qi(e),document.getElementById("app-shell")?.classList.toggle("nav-collapsed",e.getAttribute("data-collapsed")==="true"),e.addEventListener("nav-select",o=>{const s=o.detail?.route;s&&F.navigate(s.startsWith("/")?s:`/${s}`)}),e.addEventListener("logo-click",()=>F.navigate("/home")),e.addEventListener("nav-collapse",o=>{document.getElementById("app-shell")?.classList.toggle("nav-collapsed",!!o.detail?.collapsed)}),e.addEventListener("org-switch",o=>{const s=o.detail?.orgGuid;s&&x.setActiveOrg(s===Ma?null:s)}),e.addEventListener("footer-action",o=>{switch(o.detail?.action){case"account":F.navigate("/settings");break;case"signout":F.navigate("/signout");break;case"lang":Vi();break;case"theme":Yi();break}}),document.getElementById("m5t-sub-nav")?.addEventListener("nav-select",o=>{const s=Oa[o.detail?.token];s&&F.navigate(s)}),document.addEventListener("language-changed",()=>ka()),ka(),m.subscribe(g.AUTH_SCOPE_LOADED,()=>ka());const a=()=>{const o=x.getScope();return[o?.uiMode,o?.activeOrg?.guid,(o?.managedClients||[]).length,(o?.capabilities||[]).join(","),x.getStoredActiveOrg()].join("|")};let n=a();m.subscribe(g.AUTH_SCOPE_LOADED,()=>{const o=a();o!==n&&(n=o,Ze&&!nn.has(Ze)&&Go())})}function Qi(e){Ze=e;const t=document.getElementById("m5t-side-nav"),a=document.getElementById("app-shell");if(!t||!a)return;const n=!nn.has(e);if(t.hidden=!n,a.classList.toggle("has-side-nav",n),Mi(n),n)Vo(e);else{const o=document.getElementById("m5t-sub-nav");o&&(o.hidden=!0),a.classList.remove("has-sub-nav")}jo()}m.subscribe(g.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&Qi(t.route)});const Yo=()=>{console.log("[Router] Route: splash"),m.publish(g.ROUTE_NAV_BEFORE,{route:"splash"});const e=Ho(),t=!e&&mi();(e?J(()=>Promise.resolve().then(()=>dl),void 0,import.meta.url):t?J(()=>Promise.resolve().then(()=>gl),void 0,import.meta.url):J(()=>Promise.resolve().then(()=>vl),void 0,import.meta.url)).then(n=>{const o=document.getElementById("app");o.innerHTML=n.render(),n.init&&n.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"splash"})}).catch(n=>{console.error("[Router] Error loading splash route:",n),m.publish(g.ROUTE_NAV_ERROR,{route:"splash",error:n})})};F.on("/",Yo);F.on("/splash",Yo);F.on("/signin",()=>{console.log("[Router] Route: /signin"),m.publish(g.ROUTE_NAV_BEFORE,{route:"signin"}),J(()=>Promise.resolve().then(()=>Al),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"signin"})}).catch(e=>{console.error("[Router] Error loading signin route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"signin",error:e})})});F.on("/signup",()=>{console.log("[Router] Route: /signup"),m.publish(g.ROUTE_NAV_BEFORE,{route:"signup"}),J(()=>Promise.resolve().then(()=>Il),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"signup"})}).catch(e=>{console.error("[Router] Error loading signup route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"signup",error:e})})});F.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),m.publish(g.ROUTE_NAV_BEFORE,{route:"verf-link"}),J(()=>Promise.resolve().then(()=>Nl),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(e=>{console.error("[Router] Error loading verf-link route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"verf-link",error:e})})});F.on("/forgot",()=>{console.log("[Router] Route: /forgot"),m.publish(g.ROUTE_NAV_BEFORE,{route:"forgot"}),J(()=>Promise.resolve().then(()=>Ul),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(e=>{console.error("[Router] Error loading forgot route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"forgot",error:e})})});F.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!ge("resethash")){le("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"resethash"}),J(()=>Promise.resolve().then(()=>zl),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(e=>{console.error("[Router] Error loading resethash route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"resethash",error:e})})});F.on("/home",()=>{if(console.log("[Router] Route: /home"),!ge("home")){le("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"home"}),J(()=>Promise.resolve().then(()=>ac),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"home"})}).catch(e=>{console.error("[Router] Error loading home route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"home",error:e})})});F.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!ge("signout")){le("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"signout"}),J(()=>Promise.resolve().then(()=>sc),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"signout"})}).catch(e=>{console.error("[Router] Error loading signout route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"signout",error:e})})});const Xi=[{path:"/analytics",name:"analytics",title:"Analytics",icon:"monitoring"},{path:"/ad-accounts",name:"ad-accounts",title:"Ad Accounts",icon:"ads_click"},{path:"/billing",name:"billing",title:"Billing",icon:"receipt_long"},{path:"/settings",name:"settings",title:"Settings",icon:"settings"},{path:"/magnets/drafts",name:"magnets/drafts",title:"Magnets · Drafts",icon:"widgets"},{path:"/magnets/archived",name:"magnets/archived",title:"Magnets · Archived",icon:"widgets"},{path:"/analytics/conversions",name:"analytics/conversions",title:"Analytics · Conversions",icon:"monitoring"},{path:"/settings/workspace",name:"settings/workspace",title:"Settings · Workspace",icon:"settings"},{path:"/settings/integrations",name:"settings/integrations",title:"Settings · Integrations",icon:"settings"}];Xi.forEach(({path:e,name:t,title:a,icon:n})=>{F.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!ge("home")){le("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:t}),J(()=>Promise.resolve().then(()=>lc),void 0,import.meta.url).then(o=>{const s=document.getElementById("app");s.innerHTML=o.render({title:a,icon:n,name:t}),o.init&&o.init({name:t}),m.publish(g.ROUTE_NAV_AFTER,{route:t})}).catch(o=>{console.error(`[Router] Error loading section route (${t}):`,o),m.publish(g.ROUTE_NAV_ERROR,{route:t,error:o})})})});F.on("/settings/notifications",()=>{if(console.log("[Router] Route: /settings/notifications"),!ge("home")){le("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"settings/notifications"}),J(()=>Promise.resolve().then(()=>fc),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"settings/notifications"})}).catch(e=>{console.error("[Router] Error loading settings-notifications route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"settings/notifications",error:e})})});F.on("/settings/integrations",()=>{if(console.log("[Router] Route: /settings/integrations"),!ge("home")){le("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),J(()=>Promise.resolve().then(()=>Nc),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(e=>{console.error("[Router] Error loading settings-integrations route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"settings/integrations",error:e})})});F.on("/settings/security",()=>{if(console.log("[Router] Route: /settings/security"),!ge("home")){le("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"settings/security"}),J(()=>Promise.resolve().then(()=>qc),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"settings/security"})}).catch(e=>{console.error("[Router] Error loading settings-security route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"settings/security",error:e})})});F.on("/conversations",()=>{if(console.log("[Router] Route: /conversations"),!ge("home")){le("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"conversations"}),J(()=>Promise.resolve().then(()=>Qc),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"conversations"})}).catch(e=>{console.error("[Router] Error loading conversations route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"conversations",error:e})})});F.on("/ab-testing",()=>{if(console.log("[Router] Route: /ab-testing"),!ge("home")){le("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"ab-testing"}),J(()=>Promise.resolve().then(()=>pd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"ab-testing"})}).catch(e=>{console.error("[Router] Error loading ab-testing route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"ab-testing",error:e})})});F.on("/magnets",()=>{if(console.log("[Router] Route: /magnets"),!ge("home")){le("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"magnets"}),J(()=>Promise.resolve().then(()=>mp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"magnets"})}).catch(e=>{console.error("[Router] Error loading magnets route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"magnets",error:e})})});F.on("/templates",()=>{if(console.log("[Router] Route: /templates"),!ge("home")){le("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"templates"}),J(()=>Promise.resolve().then(()=>fp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"templates"})}).catch(e=>{console.error("[Router] Error loading templates route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"templates",error:e})})});F.on("/leads",()=>{if(console.log("[Router] Route: /leads"),!ge("home")){le("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"leads"}),J(()=>Promise.resolve().then(()=>Ip),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"leads"})}).catch(e=>{console.error("[Router] Error loading leads route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"leads",error:e})})});F.on("/analytics/ad-performance",()=>{if(console.log("[Router] Route: /analytics/ad-performance"),!ge("home")){le("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"analytics/ad-performance"}),J(()=>Promise.resolve().then(()=>Fp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"analytics/ad-performance"})}).catch(e=>{console.error("[Router] Error loading ad-performance route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"analytics/ad-performance",error:e})})});F.on("/clients",()=>{if(console.log("[Router] Route: /clients"),!ge("home")){le("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"clients"}),J(()=>Promise.resolve().then(()=>Kp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"clients"})}).catch(e=>{console.error("[Router] Error loading clients route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"clients",error:e})})});F.on("/team",()=>{if(console.log("[Router] Route: /team"),!ge("home")){le("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"team"}),J(()=>Promise.resolve().then(()=>ou),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"team"})}).catch(e=>{console.error("[Router] Error loading team route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"team",error:e})})});F.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),le("splash")});m.subscribe(g.ROUTE_NAV,(e,t)=>{console.log("[Router] ROUTE_NAV event received:",t),t?.route&&le(t.route)});function On(){console.log("[App] Waiting for Neodigm 55 library...");let e=0;const t=100,a=setInterval(()=>{e++,e%10===0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(a),Zi()):e>=t&&(clearInterval(a),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
      ...
      `,m.publish(g.APP_ERROR,{message:"Failed to load authentication library"}))},100)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",On):On();async function Zi(){if(console.log("[App] Neodigm 55 loaded, initializing..."),Wi(),Ki(),ui(),Ne.initialize(),console.log("[App] I18n Controller initialized"),!await x.init({BASE_URL:"https://machfivemagnet-saas.onrender.com",navigateFunction:a=>{console.log("[AuthController] Navigation requested:",a),le(a)}})){console.error("[App] AuthController initialization failed");return}const t=x.getEntity();t&&(console.log("[App] Session restored for:",t.email),m.publish(g.APP_USER_LOADED,{entity:t}),x.isAuthenticated()&&(localStorage.getItem(x.CONFIG.LS_KEYS.ACTIVE_ORG)?await x.fetchScope():x.fetchScope())),m.publish(g.APP_READY,{timestamp:new Date().toISOString(),sessionUser:t}),Ji(),Di(),F.resolve(),window.AuthController=x,window.I18nController=Ne,window.MachVive=tn,console.log("[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)")}m.subscribe(g.ROUTE_NAV_AFTER,(e,t)=>{typeof Ne<"u"&&Ne.refresh&&setTimeout(()=>{Ne.refresh()},100)});function Se(e){const t=new Uint8Array(e);let a="";for(const o of t)a+=String.fromCharCode(o);return btoa(a).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"")}function $t(e){const t=e.replace(/-/g,"+").replace(/_/g,"/"),a=(4-t.length%4)%4,n=t.padEnd(t.length+a,"="),o=atob(n),s=new ArrayBuffer(o.length),r=new Uint8Array(s);for(let i=0;i<o.length;i++)r[i]=o.charCodeAt(i);return s}function Lt(){return Ko.stubThis(globalThis?.PublicKeyCredential!==void 0&&typeof globalThis.PublicKeyCredential=="function")}const Ko={stubThis:e=>e};function Jo(e){const{id:t}=e;return{...e,id:$t(t),transports:e.transports}}function Qo(e){return e==="localhost"||/^((xn--[a-z0-9-]+|[a-z0-9]+(-[a-z0-9]+)*)\.)+([a-z]{2,}|xn--[a-z0-9-]+)$/i.test(e)}class re extends Error{constructor({message:t,code:a,cause:n,name:o}){super(t,{cause:n}),Object.defineProperty(this,"code",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),this.name=o??n.name,this.code=a}}function el({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new re({message:"Registration ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else if(e.name==="ConstraintError"){if(a.authenticatorSelection?.requireResidentKey===!0)return new re({message:"Discoverable credentials were required but no available authenticator supported it",code:"ERROR_AUTHENTICATOR_MISSING_DISCOVERABLE_CREDENTIAL_SUPPORT",cause:e});if(t.mediation==="conditional"&&a.authenticatorSelection?.userVerification==="required")return new re({message:"User verification was required during automatic registration but it could not be performed",code:"ERROR_AUTO_REGISTER_USER_VERIFICATION_FAILURE",cause:e});if(a.authenticatorSelection?.userVerification==="required")return new re({message:"User verification was required but no available authenticator supported it",code:"ERROR_AUTHENTICATOR_MISSING_USER_VERIFICATION_SUPPORT",cause:e})}else{if(e.name==="InvalidStateError")return new re({message:"The authenticator was previously registered",code:"ERROR_AUTHENTICATOR_PREVIOUSLY_REGISTERED",cause:e});if(e.name==="NotAllowedError")return new re({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="NotSupportedError")return a.pubKeyCredParams.filter(o=>o.type==="public-key").length===0?new re({message:'No entry in pubKeyCredParams was of type "public-key"',code:"ERROR_MALFORMED_PUBKEYCREDPARAMS",cause:e}):new re({message:"No available authenticator supported any of the specified pubKeyCredParams algorithms",code:"ERROR_AUTHENTICATOR_NO_SUPPORTED_PUBKEYCREDPARAMS_ALG",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if(Qo(n)){if(a.rp.id!==n)return new re({message:`The RP ID "${a.rp.id}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new re({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="TypeError"){if(a.user.id.byteLength<1||a.user.id.byteLength>64)return new re({message:"User ID was not between 1 and 64 characters",code:"ERROR_INVALID_USER_ID_LENGTH",cause:e})}else if(e.name==="UnknownError")return new re({message:"The authenticator was unable to process the specified options, or could not create a new credential",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}class tl{constructor(){Object.defineProperty(this,"controller",{enumerable:!0,configurable:!0,writable:!0,value:void 0})}createNewAbortSignal(){if(this.controller){const a=new Error("Cancelling existing WebAuthn API call for new one");a.name="AbortError",this.controller.abort(a)}const t=new AbortController;return this.controller=t,t.signal}cancelCeremony(){if(this.controller){const t=new Error("Manually cancelling existing WebAuthn API call");t.name="AbortError",this.controller.abort(t),this.controller=void 0}}}const on=new tl,al=["cross-platform","platform"];function Xo(e){if(e&&!(al.indexOf(e)<0))return e}async function nl(e){!e.optionsJSON&&e.challenge&&(console.warn("startRegistration() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useAutoRegister:a=!1}=e;if(!Lt())throw new Error("WebAuthn is not supported in this browser");const n={...t,challenge:$t(t.challenge),user:{...t.user,id:$t(t.user.id)},excludeCredentials:t.excludeCredentials?.map(Jo)},o={};a&&(o.mediation="conditional"),o.publicKey=n,o.signal=on.createNewAbortSignal();let s;try{s=await navigator.credentials.create(o)}catch(u){throw el({error:u,options:o})}if(!s)throw new Error("Registration was not completed");const{id:r,rawId:i,response:l,type:c}=s;let p;typeof l.getTransports=="function"&&(p=l.getTransports());let h;if(typeof l.getPublicKeyAlgorithm=="function")try{h=l.getPublicKeyAlgorithm()}catch(u){Sa("getPublicKeyAlgorithm()",u)}let b;if(typeof l.getPublicKey=="function")try{const u=l.getPublicKey();u!==null&&(b=Se(u))}catch(u){Sa("getPublicKey()",u)}let v;if(typeof l.getAuthenticatorData=="function")try{v=Se(l.getAuthenticatorData())}catch(u){Sa("getAuthenticatorData()",u)}return{id:r,rawId:Se(i),response:{attestationObject:Se(l.attestationObject),clientDataJSON:Se(l.clientDataJSON),transports:p,publicKeyAlgorithm:h,publicKey:b,authenticatorData:v},type:c,clientExtensionResults:s.getClientExtensionResults(),authenticatorAttachment:Xo(s.authenticatorAttachment)}}function Sa(e,t){console.warn(`The browser extension that intercepted this WebAuthn API call incorrectly implemented ${e}. You should report this error to them.
`,t)}function Zo(){if(!Lt())return Ht.stubThis(new Promise(t=>t(!1)));const e=globalThis.PublicKeyCredential;return e?.isConditionalMediationAvailable===void 0?Ht.stubThis(new Promise(t=>t(!1))):Ht.stubThis(e.isConditionalMediationAvailable())}const Ht={stubThis:e=>e};function ol({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new re({message:"Authentication ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else{if(e.name==="NotAllowedError")return new re({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if(Qo(n)){if(a.rpId!==n)return new re({message:`The RP ID "${a.rpId}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new re({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="UnknownError")return new re({message:"The authenticator was unable to process the specified options, or could not create a new assertion signature",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}async function sl(e){!e.optionsJSON&&e.challenge&&(console.warn("startAuthentication() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useBrowserAutofill:a=!1,verifyBrowserAutofillInput:n=!0}=e;if(!Lt())throw new Error("WebAuthn is not supported in this browser");let o;t.allowCredentials?.length!==0&&(o=t.allowCredentials?.map(Jo));const s={...t,challenge:$t(t.challenge),allowCredentials:o},r={};if(a){if(!await Zo())throw Error("Browser does not support WebAuthn autofill");if(document.querySelectorAll("input[autocomplete$='webauthn']").length<1&&n)throw Error('No <input> with "webauthn" as the only or last value in its `autocomplete` attribute was detected');r.mediation="conditional",s.allowCredentials=[]}r.publicKey=s,r.signal=on.createNewAbortSignal();let i;try{i=await navigator.credentials.get(r)}catch(v){throw ol({error:v,options:r})}if(!i)throw new Error("Authentication was not completed");const{id:l,rawId:c,response:p,type:h}=i;let b;return p.userHandle&&(b=Se(p.userHandle)),{id:l,rawId:Se(c),response:{authenticatorData:Se(p.authenticatorData),clientDataJSON:Se(p.clientDataJSON),signature:Se(p.signature),userHandle:b},type:h,clientExtensionResults:i.getClientExtensionResults(),authenticatorAttachment:Xo(i.authenticatorAttachment)}}function rl(){return Lt()?PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable():new Promise(e=>e(!1))}const es=Object.freeze(Object.defineProperty({__proto__:null,WebAuthnAbortService:on,WebAuthnError:re,_browserSupportsWebAuthnAutofillInternals:Ht,_browserSupportsWebAuthnInternals:Ko,base64URLStringToBuffer:$t,browserSupportsWebAuthn:Lt,browserSupportsWebAuthnAutofill:Zo,bufferToBase64URLString:Se,platformAuthenticatorIsAvailable:rl,startAuthentication:sl,startRegistration:nl},Symbol.toStringTag,{value:"Module"}));let Mn=!1;function il(){if(Mn)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
    .accept-invite-page {
  ...
  `,document.head.appendChild(e),Mn=!0}function ll(){const e=new URLSearchParams(window.location.search||"");let t=e.get("uid")||"",a=e.get("token")||"";if(!t||!a){const n=window.location.hash||"",o=n.includes("?")?n.slice(n.indexOf("?")+1):"",s=new URLSearchParams(o);if(t=t||s.get("uid")||"",a=a||s.get("token")||"",!t||!a){const r=n.replace(/^#\/?/,"").split("?")[0].split("/").filter(Boolean);t=t||r[1]||"",a=a||r[2]||""}}try{return{uid:decodeURIComponent(t),token:decodeURIComponent(a)}}catch{return{uid:t,token:a}}}function ts(){return il(),`
    ...
    </div>`}function as(){const{uid:e,token:t}=ll(),a=document.getElementById("accept-invite-form"),n=document.getElementById("ai-pass"),o=document.getElementById("ai-confirm"),s=document.getElementById("ai-submit"),r=document.getElementById("ai-msg");if(!a)return;const i=(l,c="error")=>{r.textContent=l,r.className=`accept-invite-msg ${c}`};if(!e||!t){i("This invitation link is invalid or incomplete. Please use the link from your email."),s.disabled=!0;return}a.addEventListener("submit",async l=>{l.preventDefault();const c=n.value||"",p=o.value||"";if(c.length<8){i("Password must be at least 8 characters.");return}if(c!==p){i("Passwords do not match.");return}s.disabled=!0,i("Setting up your account…","ok");try{const h=x.getConfig?.().BASE_URL||"",b=await fetch(`${h}/m5t/v5/acctEntity/acceptInvite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({uid:e,token:t,password:c})}),v=await b.json().catch(()=>({}));if(!b.ok||!v.ok){const d=b.status===410?"This invitation has expired. Ask for a new one.":b.status===409?"This invitation has already been used. Try signing in.":v.error||`Could not accept the invitation (HTTP ${b.status}).`;i(d),s.disabled=!1;return}try{window.history.replaceState({},"",window.location.pathname+window.location.hash)}catch{}i("Welcome! Signing you in…","ok"),(await x.doSignin(v.entity.email,c))?.ok||(i("Your account is ready. Please sign in.","ok"),setTimeout(()=>{window.location.hash="#/signin"},1200))}catch(h){console.error("[accept-invite] error:",h),i("Something went wrong. Please try again."),s.disabled=!1}})}const cl={render:ts,init:as},dl=Object.freeze(Object.defineProperty({__proto__:null,default:cl,init:as,render:ts},Symbol.toStringTag,{value:"Module"}));let Pn=!1;function pl(){if(Pn)return;const e=document.createElement("style");e.id="m5t-questionnaire-fill-styles",e.textContent=`
    .qf-page {
  ...
  `,document.head.appendChild(e),Pn=!0}function Fn(){return x.getConfig?.().BASE_URL||""}function ul(e){const t=`qf-${e.id}`;if(e.type==="checkbox_group"){const a=Array.isArray(e.options)?e.options:[];return`
    ...
    </div>`}function Fe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function At(e,t,a){return`
    <div class="qf-page"><div class="qf-card"><div class="qf-state">
      <span class="material-symbols-outlined">${e}</span>
      <h1>${Fe(t)}</h1>
      <p class="qf-sub">${Fe(a)}</p>
    </div></div></div>`}function ns(){return pl(),`<div id="qf-root">${At("hourglass_top","Loading your questionnaire…","One moment.")}</div>`}async function os(){const e=document.getElementById("qf-root");if(!e)return;const t=gi();if(!t){e.innerHTML=At("error","Invalid link","This link is missing required information. Please use the link exactly as sent.");return}let a;try{const c=await fetch(`${Fn()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(t.guid)}?token=${encodeURIComponent(t.token)}`),p=await c.json().catch(()=>({}));if(!c.ok||!p.ok){const h=c.status===404?p.error||"This link is invalid or has expired.":"Something went wrong loading your questionnaire. Please try again shortly.";e.innerHTML=At("error","Cannot open this questionnaire",h);return}a=p.data}catch(c){console.error("[questionnaire-fill] load error:",c),e.innerHTML=At("wifi_off","Connection problem","Could not reach the server. Please check your connection and try again.");return}const n=a.questionnaire?.sections||[],o=a.answers||{};e.innerHTML=`
    ...
    </div></div>`,e.querySelectorAll("[data-question-id]").forEach(c=>{const p=c.dataset.questionId,h=c.dataset.questionType,b=o[p];if(b!=null)if(h==="checkbox_group"){const v=Array.isArray(b)?b:[];c.querySelectorAll('input[type="checkbox"]').forEach(u=>{u.checked=v.includes(u.value)})}else{const v=c.querySelector("input,textarea");v&&(v.value=b)}});const s=document.getElementById("qf-form"),r=document.getElementById("qf-submit"),i=document.getElementById("qf-msg"),l=(c,p="error")=>{i.textContent=c,i.className=`qf-msg ${p}`};s.addEventListener("submit",async c=>{c.preventDefault();const p={};e.querySelectorAll("[data-question-id]").forEach(h=>{const b=h.dataset.questionId;if(h.dataset.questionType==="checkbox_group"){const u=[...h.querySelectorAll('input[type="checkbox"]:checked')].map(d=>d.value);u.length&&(p[b]=u)}else{const u=(h.querySelector("input,textarea")?.value||"").trim();u&&(p[b]=u)}}),r.disabled=!0,l("Submitting…","ok");try{const h=await fetch(`${Fn()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(t.guid)}/submit?token=${encodeURIComponent(t.token)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({answers:p})}),b=await h.json().catch(()=>({}));if(!h.ok||!b.ok){const v=h.status===409?"This questionnaire has already been submitted.":h.status===404?"This link is invalid or has expired.":b.error||`Could not submit (HTTP ${h.status}).`;l(v),r.disabled=!1;return}e.innerHTML=At("check_circle","Thank you!","Your answers have been submitted. Your account manager will be in touch.")}catch(h){console.error("[questionnaire-fill] submit error:",h),l("Something went wrong. Please try again."),r.disabled=!1}})}const ml={render:ns,init:os},gl=Object.freeze(Object.defineProperty({__proto__:null,default:ml,init:os,render:ns},Symbol.toStringTag,{value:"Module"}));function hl(){return`
  ...
  `}function fl(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const e=localStorage.getItem(z.FF_SSE_LS_TOKEN),t=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!e,hasMvvTs:!!t});const a=document.getElementById("splash-loader"),n=document.getElementById("splash-actions");e?(console.log("[SplashRoute] Auth token found → HOME"),m.publish(g.ROUTE_NAV,{route:"home"})):t?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),m.publish(g.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),a&&(a.style.display="none"),n&&(n.style.display="flex"),document.querySelectorAll("[data-route]").forEach(s=>{s.addEventListener("click",()=>{const r=s.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${r}`),m.publish(g.ROUTE_NAV,{route:r})})}))},4e3)}const vl=Object.freeze(Object.defineProperty({__proto__:null,init:fl,render:hl},Symbol.toStringTag,{value:"Module"}));function me(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}const bl=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;function sn(e,t){return e?bl.test(e)?!0:(me(t,I.get("validation_email_invalid")),!1):(me(t,I.get("validation_email_required")),!1)}function _l(){return`
  ...
  `}function yl(){console.log("[SigninRoute] Initialized");const e=document.getElementById("loginForm"),t=document.getElementById("email"),a=document.getElementById("password"),n=document.getElementById("togglePassword"),o=document.getElementById("rememberEmail"),s=localStorage.getItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL);s&&t&&o&&(t.value=s,o.checked=!0,a?.focus()),n?.addEventListener("click",()=>{const p=a.type==="password"?"text":"password";a.type=p});const r=document.getElementById("passkeySigninBtn"),i=document.getElementById("passkeyDivider"),l=document.getElementById("passkeyHint");window.PublicKeyCredential&&r&&i&&(r.style.display="",i.style.display="",l&&(l.style.display=""),r.addEventListener("click",()=>El())),e?.addEventListener("submit",async p=>{p.preventDefault();const h=t.value.trim(),b=a.value;sn(h,t)&&wl(b,a)&&(o?.checked?localStorage.setItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL,h):localStorage.removeItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL),await xl(h,b))}),document.getElementById("link--uc__underline")?.addEventListener("click",p=>{p.preventDefault(),m.publish(g.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",p=>{p.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),m.publish(g.ROUTE_NAV,{route:"signup"})})}function wl(e,t){return e?e.length<10?(me(t,I.get("validation_password_min_length")),!1):!0:(me(t,I.get("validation_password_required")),!1)}async function xl(e,t){const a=document.querySelector(".btn");a.disabled=!0,a.textContent=I.get("loading_signing_in");try{const n=await x.doSignin(e,t);n.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(I.get("success_welcome_back"),"success"),m.publish(g.AUTH_SIGNIN_SUCCESS,{entity:x.getEntity()})):n.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q(I.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(n.error||I.get("error_signin_failed"),"danger"),a.disabled=!1,a.textContent=(I.get("sign_in")||"Sign in").toUpperCase())}catch(n){console.error("[SigninRoute] Sign in error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||I.get("error_network"),"danger"),a.disabled=!1,a.textContent=(I.get("sign_in")||"Sign in").toUpperCase(),m.publish(g.AUTH_SIGNIN_FAIL,{message:n.message})}}async function El(){const e=document.getElementById("passkeySigninBtn");e.disabled=!0;try{const t=await x.doPasskeySignin();t.ok?(console.log("[SigninRoute] Passkey signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(I.get("success_welcome_back"),"success"),m.publish(g.AUTH_SIGNIN_SUCCESS,{entity:x.getEntity()})):t.canceled||typeof neodigmToast<"u"&&neodigmToast.q(t.error||I.get("error_signin_failed"),"danger")}catch(t){console.error("[SigninRoute] Passkey signin error:",t),typeof neodigmToast<"u"&&neodigmToast.q(t.message||I.get("error_network"),"danger")}finally{e.disabled=!1}}const Al=Object.freeze(Object.defineProperty({__proto__:null,init:yl,render:_l},Symbol.toStringTag,{value:"Module"}));function ss(e){const t=[];return e.length<12&&t.push("at least 12 characters"),e.length>1024&&t.push("at most 1024 characters"),/[a-z]/.test(e)||t.push("1 lowercase"),/[A-Z]/.test(e)||t.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(e)||t.push("1 special character"),/[^\x00-\x7F]/.test(e)&&t.push("ASCII characters only"),t}function rs(e){return e.length===0?"":e.includes("ASCII characters only")?"Password cannot contain emoji|or special unicode characters":e.includes("at least 10 characters")?"Password must have at least|10 characters":"Password must have: Uppercase,|Lowercase, and Special Character"}const kl="2026-07-15";function Sl(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function Tl(){console.log("[SignupRoute] Initialized");const e=document.getElementById("signupForm"),t=e.querySelector('button[type="submit"]');Dn("togglePassword","password","eyeIcon"),Dn("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),m.publish(g.ROUTE_NAV,{route:"signin"})}),e.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),s=document.getElementById("last").value.trim(),r=document.getElementById("email").value.trim(),i=document.getElementById("company").value.trim(),l=document.getElementById("phone").value.trim(),c=document.getElementById("password").value,p=document.getElementById("confirmPassword").value,h=document.getElementById("first"),b=document.getElementById("last"),v=document.getElementById("email"),u=document.getElementById("password"),d=document.getElementById("confirmPassword");if(!Bn(o,h,I.get("validation_first_name_required"))||!Bn(s,b,I.get("validation_last_name_required"))||!sn(r,v)||!Cl(c,u))return;if(c!==p){me(d,I.get("validation_password_mismatch"));return}const f=document.getElementById("acceptTerms");if(!f.checked){me(f,"Please accept the Terms of Service and Privacy Policy to continue.");return}t.disabled=!0,t.textContent=I.get("loading_creating_account"),await $l(o,s,r,i,l,c)})}function Dn(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function Bn(e,t,a){return e?!0:(me(t,a),!1)}function Cl(e,t){if(!e)return me(t,I.get("validation_password_required")),!1;const a=ss(e);return a.length>0?(me(t,rs(a)),!1):!0}async function $l(e,t,a,n,o,s){const r=document.querySelector('button[type="submit"]');try{const i={email:a,password:s,first:e,last:t};n&&(i.company=n),o&&(i.phone=o),i.terms_accepted=!0,i.legal_version=kl;const l=await x.doSignup(i);if(l.ok)m.publish(g.AUTH_SIGNUP_SUCCESS,{email:a}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const c=l.error||l.message||I.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(c,"danger"),r.disabled=!1,r.textContent=(I.get("create_account")||"Create account").toUpperCase(),m.publish(g.AUTH_SIGNUP_FAIL,{message:c})}}catch(i){console.error("[SignupRoute] Sign up error:",i),typeof neodigmToast<"u"&&neodigmToast.q(i.message||I.get("error_network"),"danger"),r.disabled=!1,r.textContent=(I.get("create_account")||"Create account").toUpperCase(),m.publish(g.AUTH_SIGNUP_FAIL,{message:i.message})}}const Il=Object.freeze(Object.defineProperty({__proto__:null,init:Tl,render:Sl},Symbol.toStringTag,{value:"Module"}));function Ll(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function Dl(){console.log("[ForgotRoute] Initialized");const e=document.getElementById("forgot-form"),t=document.getElementById("email");e?.addEventListener("submit",async a=>{a.preventDefault();const n=t.value.trim();sn(n,t)&&await Bl(n)})}async function Bl(e){const t=document.querySelector(".btn");t.disabled=!0,t.textContent="SENDING...";try{const a=await Pl.forgotPassword(e);a.ok&&a.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q(I.get("success_reset_link_sent"),"success"),m.publish(g.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(a.data.error||I.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=(I.get("send_reset_link")||"Send reset link").toUpperCase())}catch(a){console.error("[ForgotRoute] Forgot password error:",a),typeof neodigmToast<"u"&&neodigmToast.q(a.message||I.get("error_network"),"danger"),t.disabled=!1,t.textContent=(I.get("send_reset_link")||"Send reset link").toUpperCase()}}const Ul=Object.freeze(Object.defineProperty({__proto__:null,init:Dl,render:Fl},Symbol.toStringTag,{value:"Module"}));function ql(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function Hl(){console.log("[ResethashRoute] Initialized");const e=document.getElementById("resethash-form"),t=e.querySelector('button[type="submit"]');Un("toggleNewPassword","new-password","eyeIconNew"),Un("toggleConfirmPassword","confirm-password","eyeIconConfirm"),e?.addEventListener("submit",async a=>{a.preventDefault();const n=e.email.value.trim(),o=e.newPassword.value,s=e.confirmPassword.value,r=document.getElementById("new-password"),i=document.getElementById("confirm-password");if(!o){me(r,I.get("validation_new_password_required"));return}const l=ss(o);if(l.length>0){me(r,rs(l));return}if(!s){me(i,I.get("validation_new_password_required"));return}if(o!==s){me(i,I.get("validation_password_mismatch"));return}t.disabled=!0,t.textContent=I.get("loading_resetting_password");try{const c=await x.doResetHash(n,o);c.ok?(typeof neodigmToast<"u"&&neodigmToast.q(I.get("success_password_reset"),"success"),m.publish(g.AUTH_RESETHASH_SUCCESS,{email:n})):(me(r,c.error||I.get("error_signin_failed")),t.disabled=!1,t.textContent=(I.get("update_password")||"Update password").toUpperCase())}catch(c){console.error("[ResethashRoute] Reset password error:",c),me(r,c.message||I.get("error_network")),t.disabled=!1,t.textContent=(I.get("update_password")||"Update password").toUpperCase()}})}function Un(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}const zl=Object.freeze(Object.defineProperty({__proto__:null,init:Hl,render:ql},Symbol.toStringTag,{value:"Module"})),pe=()=>x.getManagedClients().length>0&&!x.getStoredActiveOrg(),qe=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),Gl={reseller_org:"Your org",managed_client:"Client",saas_org:"Org"};let qn=!1;function gt(){if(qn)return;const e=document.createElement("style");e.id="m5t-portfolio-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),qn=!0}const Hn=e=>e.toISOString().slice(0,10);async function jl(e,{days:t=30}={}){const a=new Date,n=Hn(new Date(a.getTime()-(t-1)*864e5)),o=Hn(a),s=await fetch(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${o}&group_by=owner`);if(!s.ok)throw new Error(`HTTP ${s.status}`);const r=await s.json();if(!r.ok)throw new Error("stats not ok");return r.by_owner||[]}function is(e,t){return`<div class="dash-clients-scroll"><table class="dash-clients">
    <thead><tr>
  ...
  </table></div>`}function Vl(e){let t=e.querySelector(".pf-access-error");t||(t=document.createElement("div"),t.className="pf-access-error",e.prepend(t)),t.textContent="You don't have direct access to manage this org. Use the admin console to act on its behalf."}function ls(e){if(!e)return;const t=async a=>{const n=a?.dataset?.org;if(!n)return;(await x.setActiveOrg(n))?.activeOrgError&&Vl(e)};e.querySelectorAll("tbody tr[data-org]").forEach(a=>{a.addEventListener("click",()=>t(a)),a.addEventListener("keydown",n=>{(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),t(a))})})}const Pa=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Rt({section:e,title:t,description:a}){return gt(),`
    ...
    </div>`}async function ht(e,t,{emptyMsg:a}={}){const n=document.getElementById("pf-picker-body");if(n)try{const o=await jl(e);if(!o.length){n.innerHTML=Pa("groups",a||"No client orgs yet. Create one under Clients first.");return}n.innerHTML=is(o,t),ls(n)}catch(o){console.warn("[portfolio] picker load failed:",o),n.innerHTML=Pa("error","Could not load your clients. Please refresh.")}}function cs(){const e={};return x.getManagedClients().forEach(t=>{e[t.orgGuid]=t.name}),x.getMemberships().forEach(t=>{t.orgGuid&&!e[t.orgGuid]&&(e[t.orgGuid]=t.name||"")}),e}const ds=e=>e?`<span class="pf-client-chip">${qe(e)}</span>`:"",ma=Object.freeze({MAGNET_TEMPLATE:"magnet_template",LEADS_SEARCH:"leads_search"}),zt=new Map;function ps(e,t){zt.set(e,t)}function us(e){if(!zt.has(e))return null;const t=zt.get(e);return zt.delete(e),t}const be=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,he=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),K=e=>Number(e||0).toLocaleString(),ms=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",Wl=e=>(ms(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function Yl(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric"})}catch{return""}}function Kl(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}let zn=!1;function Jl(){if(zn)return;const e=document.createElement("style");e.id="m5t-dash-recent-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),zn=!0}function Ql(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${he(Wl(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${he(ms(e))}</span>
      <span class="recent-lead__sub">${he(e.email||e.phone||"")}</span>
    </span>
    <span class="recent-lead__badge" data-s="${he(e.status)}">${he(e.status)}</span>
    <span class="recent-lead__time">${he(Yl(e))}</span>
  </a>`}const kt=({icon:e,label:t,valueId:a,value:n="—",subId:o,sub:s="",href:r})=>{const i=r?"a":"div",l=r?` href="${he(r)}" class="stat-card stat-card--link"`:' class="stat-card"';return`
  <${i}${l}>
  ...
  <div class="dashboard-card${n?" chart-card-wide":""}${o?" chart-card-full":""}">
  ...
  </div>`;let Fa=30;function gs(){Jl(),gt();const e=pe();return`
    <div class="page-shell" data-section="home">
      ...
      <div class="stats-grid">
        ${kt({icon:"widgets",label:"Active Magnets",valueId:"stat-active-magnets",subId:"stat-active-magnets-sub",sub:"Loading…",href:"#/magnets"})}
        ${kt({icon:"ads_click",label:"Magnet Opens",valueId:"stat-opens",subId:"stat-opens-sub",sub:"Loading…"})}
        ${kt({icon:"person_add",label:"Leads Captured",valueId:"stat-leads",subId:"stat-leads-sub",sub:"Loading…",href:"#/leads"})}
        ${kt({icon:"check_circle",label:"Completion Rate",valueId:"stat-completion",subId:"stat-completion-sub",sub:"Loading…"})}
      </div>
      ...
      <div class="content-grid">
    ...
    </div>`}async function hs(){const e=x.getConfig?.().BASE_URL||"";document.getElementById("dash-periods")?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(Fa=Number(a.dataset.days)||30,document.querySelectorAll("#dash-periods .chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===Fa)),jn(e))}),document.getElementById("dash-campaigns")?.addEventListener("click",t=>{const a=t.target.closest("[data-campaign]");a&&ps(ma.LEADS_SEARCH,a.dataset.campaign)}),await Promise.all([jn(e),ec(e)])}const Ce=(e,t)=>{const a=document.getElementById(e);a&&(a.textContent=t)},st=(e,t)=>{const a=document.getElementById(e);a&&(a.innerHTML=t)},Gn=e=>e.toISOString().slice(0,10);async function jn(e){const t=new Date,a=Gn(new Date(t.getTime()-(Fa-1)*864e5)),n=Gn(t),o=pe();let s;try{const E=await fetch(`${e}/m5t/v5/dashboard/stats?from=${a}&to=${n}${o?"&group_by=owner":""}`);if(!E.ok)throw new Error(`HTTP ${E.status}`);if(s=await E.json(),!s.ok)throw new Error("stats not ok")}catch(_){console.warn("[dashboard] stats fetch failed:",_),["stat-active-magnets","stat-opens","stat-leads","stat-completion"].forEach(E=>Ce(E,"—")),["stat-active-magnets-sub","stat-opens-sub","stat-leads-sub","stat-completion-sub"].forEach(E=>Ce(E,"Unavailable")),["dash-trend","dash-funnel","dash-campaigns","dash-routes","dash-interactions","dash-portfolio"].forEach(E=>st(E,be("error","Could not load. Please refresh.")));return}o&&Xl(s.by_owner||[]),Ce("stat-active-magnets",K(s.magnets.active)),Ce("stat-active-magnets-sub",s.magnets.total>s.magnets.active?`${K(s.magnets.total-s.magnets.active)} paused`:s.magnets.active?"All running":"No magnets yet");const r=s.funnel||{};Ce("stat-opens",r.opens?K(r.opens):"—"),Ce("stat-opens-sub",r.opens?r.engagement_rate!=null?`${r.engagement_rate}% engage`:`${K(r.engaged)} engaged`:"No opens in this range yet");const i=s.leads||{};Ce("stat-leads",K(i.total));const l=(i.this_week||0)-(i.prev_week||0);Ce("stat-leads-sub",i.total?`${K(i.this_week)} this week (${l>=0?"+":""}${K(l)} vs last)`:"No leads yet"),Ce("stat-completion",r.completion_rate!=null?`${r.completion_rate}%`:"—"),Ce("stat-completion-sub",r.opens?`${K(r.completions)} completed of ${K(r.opens)} opens`:"Appears once magnets get opened");const c=s.by_day||[],p=c.some(_=>_.opens||_.leads);st("dash-trend",p?fs(c):be("show_chart","No activity in this range yet. Opens and leads chart here as visitors engage your magnets.")),p&&vs(c),st("dash-funnel",r.opens?Zl(r):be("filter_alt","The funnel fills in once your magnets record opens."));const h=s.top_campaigns||[];st("dash-campaigns",h.length?`<div class="dash-list">${h.map(_=>`
        <a class="dash-list__row dash-list__row--link" href="#/leads" data-campaign="${he(_.campaign)}" title="Show the leads from ${he(_.campaign)}">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">campaign</span></span>
          <span class="dash-list__main">${he(_.campaign)}</span>
        ...
        </a>`).join("")}</div>`:be("source","No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here."));const b={book:["event","Book"],chat:["chat","Chat"],call:["phone_in_talk","Call"],email:["mail","Email"],support:["support_agent","Support"]},v=Object.entries(r.routes||{}).sort((_,E)=>E[1]-_[1]),u=v.length?v[0][1]:0;st("dash-routes",v.length?`<div class="dash-funnel">${v.map(([_,E])=>{const[C,$]=b[_]||["touch_app",_];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${C}</span> ${he($)}</span><span class="dash-funnel__val">${K(E)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${u?Math.max(4,Math.round(E/u*100)):0}%"></div></div>
        </div>`}).join("")}</div>`:be("touch_app","CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar."));const d={open:["visibility","Magnet opened"],engage:["touch_app","Visitor engaged"],route:["alt_route","Picked a channel"],complete:["check_circle","Completed: lead captured"]},f=s.recent_events||[];st("dash-interactions",f.length?`<div class="dash-list">${f.map(_=>{const[E,C]=d[_.event]||["sensors",_.event],$=_.event==="route"&&_.detail?` · ${he(_.detail)}`:"";return`<div class="dash-list__row">
    ...
    </div>`).join("")}</div>`}async function ec(e){const t=document.getElementById("recent-leads-body");if(t)try{const a=await fetch(`${e}/m5t/v5/m5mLead`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json(),o=(Array.isArray(n?.data)?n.data:[]).filter(s=>!["DELETED","ARCHIVED"].includes(s.status));t.innerHTML=o.length?o.slice(0,5).map(Ql).join(""):be("contacts","No leads captured yet. Publish a magnet to start collecting.")}catch(a){console.warn("[dashboard] Leads fetch failed:",a),t.innerHTML=be("error","Could not load recent leads.")}}function Vn(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}const Wn=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e));function fs(e){const v=e.length||1,u=Vn(Math.max(1,...e.map(B=>B.opens||0))),d=Vn(Math.max(1,...e.map(B=>B.leads||0))),f=748/v,_=Math.min(22,f*.55),E=B=>46+f*(B+.5),C=B=>266-B/u*248,$=B=>266-B/d*248,W=[0,.5,1].map(B=>{const j=266-B*248;return`<line x1="46" y1="${j.toFixed(1)}" x2="794" y2="${j.toFixed(1)}" stroke="#EAF0F7"/><text x="38" y="${(j+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${Wn(u*B)}</text><text x="802" y="${(j+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${Wn(d*B)}</text>`}).join(""),D=e.map((B,j)=>{const ze=C(B.opens||0);return`<rect class="dash-bar" data-i="${j}" x="${(E(j)-_/2).toFixed(1)}" y="${ze.toFixed(1)}" width="${_.toFixed(1)}" height="${Math.max(0,266-ze).toFixed(1)}" rx="3" fill="#0072BA"/>`}).join(""),Y=e.map((B,j)=>`${E(j).toFixed(1)},${$(B.leads||0).toFixed(1)}`).join(" "),se=v>1?`<polyline points="${Y}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",ue=e.map((B,j)=>`<circle class="dash-dot" data-i="${j}" cx="${E(j).toFixed(1)}" cy="${$(B.leads||0).toFixed(1)}" r="3.2" fill="#009473"/>`).join(""),ce='<line class="dash-crosshair" x1="0" y1="18" x2="0" y2="266" pointer-events="none"/>',Ae=Math.max(1,Math.ceil(v/6)),M=e.map((B,j)=>j%Ae===0||j===v-1?`<text x="${E(j).toFixed(1)}" y="288" text-anchor="middle" class="dash-ax">${B.date.slice(5)}</text>`:"").join(""),ee=e.map((B,j)=>`<rect class="dash-hit" data-i="${j}" x="${(46+f*j).toFixed(1)}" y="18" width="${f.toFixed(1)}" height="${248 .toFixed(1)}" fill="transparent"/>`).join("");return`
    ...
    <div class="dash-chart-wrap">
      ...
      <div class="dash-chart-tip__row"><i style="background:#009473"></i>${K(h.leads||0)} leads</div>`;const b=p.getBoundingClientRect(),v=t.getBoundingClientRect();a.style.left=`${b.left-v.left+b.width/2}px`,a.style.top=`${b.top-v.top}px`,a.hidden=!1,r(c,p)},l=()=>{a.hidden=!0,s()};t.querySelectorAll(".dash-hit").forEach(c=>{const p=Number(c.dataset.i);c.addEventListener("mouseenter",()=>i(p,c)),c.addEventListener("mousemove",()=>i(p,c)),c.addEventListener("mouseleave",l),c.addEventListener("click",()=>i(p,c))})}const tc={render:gs,init:hs},ac=Object.freeze(Object.defineProperty({__proto__:null,default:tc,init:hs,render:gs,statCard:kt,svgTrendChart:fs,wireTrendTooltip:vs},Symbol.toStringTag,{value:"Module"}));function nc(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/home" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function oc(){console.log("[SignoutRoute] Initialized");const e=document.getElementById("confirm-signout-btn");e?.addEventListener("click",async()=>{e.disabled=!0,e.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await x.doSignout()})}const sc=Object.freeze(Object.defineProperty({__proto__:null,init:oc,render:nc},Symbol.toStringTag,{value:"Module"}));let Yn=!1;function rc(){if(Yn)return;const e=document.createElement("style");e.id="m5t-section-page-styles",e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),Yn=!0}function bs({title:e="Section",icon:t="widgets",name:a=""}={}){return rc(),`
    ...
    </section>`}function _s(){}const ic={render:bs,init:_s},lc=Object.freeze(Object.defineProperty({__proto__:null,default:ic,init:_s,render:bs},Symbol.toStringTag,{value:"Module"})),cc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ke=e=>String(e??"").replace(/[&<>"']/g,t=>cc[t]),_e=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},et=()=>x.getConfig?.().BASE_URL||"",dc=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,Xt=5,ve={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},Da=()=>x.getActiveOrg()?.guid||x.getMemberships()[0]?.orgGuid||null;let Kn=!1;function pc(){if(Kn)return;const e=document.createElement("style");e.id="m5t-notif-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Kn=!0}const rn=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function ys(){return pc(),gt(),pe()?Rt({section:"settings-notifications",title:"Notifications",description:"Pick a client to manage their lead alerts."}):`
    <div class="page-shell" data-section="settings-notifications">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="ntf-body">${rn("hourglass_empty","Loading…")}</div>
      </div>
    ...
    </div>`}async function ws(){if(pe()){const e=t=>Number(t||0).toLocaleString();return ht(et(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Promise.all([uc(),xs()])}async function xs(){const e=Da();if(e)try{const t=await fetch(`${et()}/m5t/v5/acctGroup/${encodeURIComponent(e)}/webhook`);if(t.status===403){ve.webhookAllowed=!1;return}const a=await t.json().catch(()=>({}));if(!a.ok)return;ve.webhook=a.webhook,Es()}catch{}}function Jn(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function Es(){const e=document.getElementById("ntf-wh-card"),t=document.getElementById("ntf-wh-body");if(!e||!t)return;e.style.display="";const a=ve.webhook,n=a?.last_delivery;t.innerHTML=`
    <div class="ntf-wh">
      ...
      <div class="ntf-wh__row">
        ...
        <span class="ntf-wh__status">${n?n.ok?`Last delivery: <span class="ok">delivered</span> ${ke(Jn(n.tz))}`:`Last delivery: <span class="bad">failed</span> ${ke(Jn(n.tz))} (${ke(n.error||"")})`:""}</span>
      </div>
    </div>`,t.querySelector("#ntf-wh-save")?.addEventListener("click",async()=>{const o=t.querySelector("#ntf-wh-url")?.value.trim()||"",s=t.querySelector("#ntf-wh-secret")?.value??"",r={uri:o};s.trim()!==""&&(r.secret=s.trim());try{const i=await fetch(`${et()}/m5t/v5/acctGroup/${encodeURIComponent(Da())}/webhook`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),l=await i.json().catch(()=>({}));if(!i.ok||!l.ok)throw new Error(l.error||`Failed (HTTP ${i.status})`);ve.webhook=l.webhook,_e(o?"Webhook saved":"Webhook removed","success"),Es()}catch(i){_e(i.message||"Could not save","danger")}}),t.querySelector("#ntf-wh-test")?.addEventListener("click",async o=>{const s=o.currentTarget;s.disabled=!0;try{const r=await fetch(`${et()}/m5t/v5/acctGroup/${encodeURIComponent(Da())}/webhook-test`,{method:"POST"}),i=await r.json().catch(()=>({}));r.ok&&i.ok?_e("Test delivery sent","success"):_e(i.error||"Could not deliver the test","danger")}catch{_e("Could not deliver the test","danger")}finally{s.disabled=!1}try{await xs()}catch(r){console.warn("[notifications] loadWebhook refresh failed:",r)}})}async function uc(){const e=document.getElementById("ntf-body");if(e){try{const a=await(await fetch(`${et()}/m5t/v5/magnets`)).json().catch(()=>({}));if(!a.ok)throw new Error(a.message||"Failed to load");ve.magnets=(a.magnets||[]).filter(n=>n.status!=="ARCHIVED"),ve.canManage=!!a.canManage}catch(t){console.warn("[notifications] load failed:",t),e.innerHTML=rn("error","Could not load your magnets. Please try again.");return}As()}}function mc(e){const t=Array.isArray(e.notify_emails)?e.notify_emails:[],a=t.length>0;return`
    ...
    </div>`}function As(){const e=document.getElementById("ntf-body");if(e){if(!ve.magnets.length){e.innerHTML=rn("widgets","No magnets yet. Create one under Your Magnets first.");return}e.innerHTML=ve.magnets.map(mc).join(""),e.querySelectorAll(".ntf-row").forEach(t=>{const a=t.dataset.guid,n=t.querySelector(".ntf-input"),o=()=>{const s=(n?.value||"").trim().toLowerCase();if(!s)return;if(!dc.test(s)){_e("That does not look like an email address","danger");return}const i=[...ve.magnets.find(l=>l.guid===a).notify_emails||[]];if(i.includes(s)){_e("Already added","info");return}if(i.length>=Xt){_e(`Up to ${Xt} emails per magnet`,"info");return}Qn(a,[...i,s])};t.querySelector("[data-add]")?.addEventListener("click",o),n?.addEventListener("keydown",s=>{s.key==="Enter"&&o()}),t.querySelectorAll("[data-remove]").forEach(s=>s.addEventListener("click",()=>{const r=ve.magnets.find(i=>i.guid===a);Qn(a,(r.notify_emails||[]).filter(i=>i!==s.dataset.remove))})),t.querySelector("[data-test]")?.addEventListener("click",()=>gc(a,t.querySelector("[data-test]")))})}}async function Qn(e,t){try{const a=await fetch(`${et()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({notify_emails:t})}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||n.message||`Failed (HTTP ${a.status})`);const o=ve.magnets.find(s=>s.guid===e);o&&(o.notify_emails=t),_e("Alert emails updated","success")}catch(a){console.warn("[notifications] save failed:",a),_e(a.message||"Could not save","danger");return}try{As()}catch(a){console.error("[notifications] renderBody after save failed:",a)}}async function gc(e,t){t&&(t.disabled=!0);try{const a=await fetch(`${et()}/m5t/v5/magnets/${encodeURIComponent(e)}/notify-test`,{method:"POST"}),n=await a.json().catch(()=>({}));a.ok&&n.ok?_e("Test alert sent","success"):_e(n.error||"Could not send the test","danger")}catch{_e("Could not send the test","danger")}finally{t&&(t.disabled=!1)}}const hc={render:ys,init:ws},fc=Object.freeze(Object.defineProperty({__proto__:null,default:hc,init:ws,render:ys},Symbol.toStringTag,{value:"Module"})),vc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ie=e=>String(e??"").replace(/[&<>"']/g,t=>vc[t]),Ee=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},Te=()=>x.getConfig?.().BASE_URL||"",Q={providers:null,configured:null,denied:!1,busy:!1,autoOpenPicker:!1},ln=()=>x.getActiveOrg()?.guid||x.getMemberships()[0]?.orgGuid||null;let Xn=!1;function bc(){if(Xn)return;const e=document.createElement("style");e.id="m5t-intg-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Xn=!0}const Ba=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,dt=(e,t="")=>`<div class="intg-alert ${t}"><span class="material-symbols-outlined" aria-hidden="true">${t==="error"?"error":"info"}</span><span>${e}</span></div>`,_c={google_ads:{what:"See ad spend lined up next to the leads it generated, so you know which campaigns are actually working.",steps:["Click Connect and sign in with a Google account that has access to your Ads accounts.","Choose which ad accounts should feed reporting.","Metrics refresh automatically once a day — or click Sync now for an immediate pull."]},calendly:{what:"Let visitors book directly from a magnet conversation, and get notified the moment they do.",steps:["Click Connect and authorize your Calendly account.","Turn on Calendly booking for any magnet’s Book action, under Magnets.","Confirmed and canceled bookings sync back to the lead automatically. Webhooks need a paid Calendly plan — a free plan still lets visitors book, just without the automatic lead sync."]},callrail:{what:"Every tracked phone call becomes a lead automatically, complete with recording and source.",steps:["In CallRail, go to Integrations, then Data access, then API keys, and create a key. Read-only works for calls; Allow Writes lets us set up call sync automatically.","Paste the key here and pick the account and company this workspace tracks.","Calls start landing in your Leads inbox within minutes."]},google_analytics:{what:"See how visitors reach your site and behave once they get there — sessions, pageviews, and engagement — right alongside the leads your magnets capture.",steps:["Click Connect and sign in with a Google account that has access to your GA4 property.","Choose which GA4 properties should feed reporting.","Metrics refresh automatically once a day — or click Sync now for an immediate pull."]}},cn=e=>{const t=_c[e];return t?`
    ...
    </div>`}function yc(){return bc(),gt(),pe()?Rt({section:"settings-integrations",title:"Integrations",description:"Pick a client to manage their connections."}):`
    <div class="page-shell" data-section="settings-integrations">
      ...
      <div id="intg-body">
        <div class="dashboard-card intg-card"><div class="card-body">${Ba("hourglass_empty","Loading…")}</div></div>
      </div>
    </div>`}async function wc(){if(pe()){const e=t=>Number(t||0).toLocaleString();return ht(Te(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}xc(),await ft()}const Ta=Object.fromEntries(Object.values($e).filter(e=>e.connect).map(e=>[e.slug,e.label]));function xc(){try{const e=new URLSearchParams(window.location.search),t=e.get("connected"),a=e.get("error")?e.get("provider")||"google_ads":null;if(t&&Ta[t])Ee(`${Ta[t]} connected.`,"success"),$e[t]?.picker&&(Q.autoOpenPicker=t);else if(a)Ee(`${Ta[a]||a} connection failed (${e.get("error")}).`,"error");else return;window.history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}}async function ft(){const e=document.getElementById("intg-body");try{const t=await fetch(`${Te()}/m5t/v5/integrations`);if(t.status===403){Q.denied=!0,e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ba("lock","Integrations are managed by workspace admins.")}</div></div>`);return}const a=await t.json();if(!a.ok)throw new Error(a.error||"load failed");Q.providers=a.data.providers,Q.configured=a.data.configured,kc()}catch{e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ba("error","Could not load integrations.")}</div></div>`)}}function Zn(e){const t=e.card,a=ln(),n=Q.providers?.[e.slug]||[],o=n.find(c=>c.owner_guid===a)||n[0]||null,s=!!Q.configured?.[e.slug];let r='<span class="intg-state">Not connected</span>',i=t.idleDesc,l="";if(!s)r='<span class="intg-state">Not available yet</span>',i=`${e.label} reporting is being set up for this platform.`;else if(!o)l=`<button type="button" class="intg-btn primary" id="${t.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>Connect</button>`;else{const c=t.reachableCount(o.external_account);o.connect_status==="ACTIVE"?(r='<span class="intg-state on"><span class="material-symbols-outlined" aria-hidden="true">check</span>Connected</span>',i=c?t.reachDesc(c):t.noneDesc,l=`
        ...
        <button type="button" class="intg-btn danger" id="intg-r-disconnect"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`;const p=a.webhook||{};if(p.state==="active"){const h=p.last_received_tz?` Last call received ${ie(String(p.last_received_tz).slice(0,10))}.`:"";r=dt(`Call sync is on. New calls appear within minutes; a daily sweep catches anything missed.${h}`)}else r=dt("Automatic call sync could not be set up in CallRail. Calls still arrive via the daily sweep and Sync now. Reconnect to retry the setup.","error")}else n='<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>Connection error</span>',o="The connection stopped working. Reconnect with a current CallRail API key.",s=`
        ...
        <button type="button" class="intg-btn danger" id="intg-r-disconnect"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`}return dn({tint:"info",icon:"call",name:"CallRail",sub:"Calls in your leads inbox.",pill:n,actions:s,desc:o,extra:r,walkthrough:cn("callrail"),bodyExtra:'<div id="intg-r-setup" style="display:none"></div>'})}function eo(e){const t=e.card.ids;document.getElementById(t.connect)?.addEventListener("click",()=>Ss(e)),document.getElementById(t.sync)?.addEventListener("click",()=>Cc(e)),document.getElementById(t.disconnect)?.addEventListener("click",()=>Ua(e)),document.getElementById(t.choose)?.addEventListener("click",()=>ks(e))}function kc(){const e=document.getElementById("intg-body");if(!e)return;e.innerHTML=Zn($e.google_ads)+Ec()+Ac()+Zn($e.google_analytics),eo($e.google_ads),document.getElementById("intg-c-connect")?.addEventListener("click",()=>Ss($e.calendly)),document.getElementById("intg-c-disconnect")?.addEventListener("click",()=>Ua($e.calendly)),document.getElementById("intg-r-connect")?.addEventListener("click",$c),document.getElementById("intg-r-sync")?.addEventListener("click",Rc),document.getElementById("intg-r-disconnect")?.addEventListener("click",()=>Ua($e.callrail)),eo($e.google_analytics);const t=Q.autoOpenPicker?$e[Q.autoOpenPicker]:null;t?.picker&&document.getElementById(t.card.ids.choose)&&ks(t),Q.autoOpenPicker=!1}async function ks(e){const t=e.picker,a=document.getElementById(e.card.ids.panel);if(a){a.style.display="",a.innerHTML=dt(t.loading);try{const o=await(await fetch(`${Te()}/m5t/v5/integrations/${e.slug}/${t.path}`)).json();if(!o.ok)throw new Error(o.error||"load failed");Sc(e,o.data[t.itemsField]||[],new Set(o.data.linked||[]))}catch{a.innerHTML=dt(t.loadError,"error")}}}function Sc(e,t,a){const n=e.picker,o=document.getElementById(e.card.ids.panel);if(!o)return;const s=t.map(r=>{const i=n.rowDisabled(r),l=n.rowBadge(r),c=a.has(r.id)&&!i;return`
    ...
    </div>`,document.getElementById("intg-r-cancel")?.addEventListener("click",()=>{e.style.display="none"}),document.getElementById("intg-r-continue")?.addEventListener("click",Ic),document.getElementById("intg-r-key")?.focus())}const Ue=e=>{const t=document.getElementById("intg-r-status");t&&(t.textContent=e)};async function Ic(){const e=document.getElementById("intg-r-continue"),t=document.getElementById("intg-r-key")?.value.trim()||"",a=document.getElementById("intg-r-pickers");if(!t){Ue("Paste an API key first.");return}if(a&&!a.hidden)return Lc(t);e&&(e.disabled=!0),Ue("Checking the key with CallRail…");try{const o=await(await fetch(`${Te()}/m5t/v5/integrations/callrail/validate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:t})})).json();if(!o.ok){Ue(o.error||"CallRail rejected that key.");return}const s=o.data.accounts||[],r=document.getElementById("intg-r-account");r&&(r.innerHTML=s.map(i=>`<option value="${ie(i.id)}">${ie(i.name)}</option>`).join(""),r.onchange=()=>to(t,r.value)),a&&(a.hidden=!1),e&&(e.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">save</span>Save'),Ue(""),await to(t,s[0]?.id)}catch{Ue("Could not reach CallRail. Try again.")}finally{e&&(e.disabled=!1)}}async function to(e,t){const a=document.getElementById("intg-r-company");if(!(!a||!t)){a.innerHTML='<option value="">Loading companies…</option>';try{const o=await(await fetch(`${Te()}/m5t/v5/integrations/callrail/companies`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:t})})).json(),s=o.ok?o.data.companies||[]:[];a.innerHTML=s.length?s.map(r=>`<option value="${ie(r.id)}">${ie(r.name)}</option>`).join(""):'<option value="">No active companies in this account</option>'}catch{a.innerHTML='<option value="">Could not load companies</option>'}}}async function Lc(e){const t=document.getElementById("intg-r-continue"),a=document.getElementById("intg-r-account")?.value||"",n=document.getElementById("intg-r-company")?.value||"";if(!n){Ue("Pick the company this workspace tracks.");return}t&&(t.disabled=!0),Ue("Connecting…");try{const s=await(await fetch(`${Te()}/m5t/v5/integrations/callrail`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:a,company_id:n})})).json();if(!s.ok)throw new Error(s.error||"connect failed");Ee(s.data?.webhook_state==="active"?"CallRail connected. Call sync is on.":"CallRail connected. Call sync setup needs attention; see the card.","success"),ft()}catch{Ue("Could not connect. Check the key and try again."),t&&(t.disabled=!1)}}async function Rc(){if(Q.busy)return;Q.busy=!0;const e=document.getElementById("intg-r-sync");e&&(e.disabled=!0);try{const a=await(await fetch(`${Te()}/m5t/v5/integrations/callrail/sync?days=7`,{method:"POST"})).json();if(!a.ok)throw new Error(a.error||"sync failed");const n=a.data?.connections?.[0]||{};Ee(n.error?"Sync finished with errors.":`Sync done. ${n.processed||0} new call${(n.processed||0)===1?"":"s"} recorded.`,n.error?"warning":"success")}catch{Ee("Sync failed.","error")}finally{Q.busy=!1,e&&(e.disabled=!1),ft()}}const Nc=Object.freeze(Object.defineProperty({__proto__:null,init:wc,render:yc},Symbol.toStringTag,{value:"Module"})),Oc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Pt=e=>String(e??"").replace(/[&<>"']/g,t=>Oc[t]),Zt=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},ea=()=>x.getConfig?.().BASE_URL||"",pt={passkeys:[],loaded:!1};let ao=!1;function Mc(){if(ao)return;const e=document.createElement("style");e.id="m5t-security-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ao=!0}const pn=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Ts(){return Mc(),`
    <div class="page-shell" data-section="settings-security">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="pk-body">${pn("hourglass_empty","Loading…")}</div>
      </div>
    </div>`}async function Cs(){const e=document.getElementById("pk-add-btn");e&&window.PublicKeyCredential&&(e.style.display="",e.addEventListener("click",Dc)),await $s()}async function $s(){const e=document.getElementById("pk-body");if(e){try{const t=await fetch(`${ea()}/m5t/v5/webauthn`),a=await t.json().catch(()=>({}));if(!t.ok||!a.ok)throw new Error(a.error||"Failed to load");pt.passkeys=a.passkeys||[],pt.loaded=!0}catch(t){console.warn("[settings-security] load failed:",t),e.innerHTML=pn("error","Could not load your passkeys. Please try again.");return}Is()}}function no(e){if(!e)return null;try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return null}}function Pc(e){const t=no(e.last_used_time),a=e.created?.created_tz,n=no(a),o=[e.device_type==="multiDevice"?"Syncs across devices":"This device only",t?`Last used ${t}`:"Never used to sign in yet",n?`Added ${n}`:null].filter(Boolean).join(" · ");return`
    ...
    </div>`}function Is(){const e=document.getElementById("pk-body");if(e){if(!window.PublicKeyCredential){e.innerHTML=`<p class="pk-unsupported">This browser doesn't support passkeys. Your password sign-in still works as usual.</p>`;return}if(!pt.passkeys.length){e.innerHTML=pn("passkey","No passkeys yet. Add one for a faster, phishing-resistant sign-in.");return}e.innerHTML=pt.passkeys.map(Pc).join(""),e.querySelectorAll("[data-remove]").forEach(t=>{t.addEventListener("click",()=>Bc(t.dataset.remove,t))})}}function Fc(){try{const e=navigator.userAgent||"",t=/iPhone/.test(e)?"iPhone":/iPad/.test(e)?"iPad":/Android/.test(e)?"Android":/Mac OS X/.test(e)?"Mac":/Windows/.test(e)?"Windows":/Linux/.test(e)?"Linux":"device",a=/Edg\//.test(e)?"Edge":/Chrome\//.test(e)?"Chrome":/Firefox\//.test(e)?"Firefox":/Safari\//.test(e)?"Safari":"";return a?`${a} on ${t}`:t}catch{return"Passkey"}}async function Dc(){const e=document.getElementById("pk-add-btn");e&&(e.disabled=!0);try{const{startRegistration:t}=await J(async()=>{const{startRegistration:i}=await Promise.resolve().then(()=>es);return{startRegistration:i}},void 0,import.meta.url),a=await fetch(`${ea()}/m5t/v5/webauthn/register/options`,{method:"POST"}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||"Could not start passkey registration");let o;try{o=await t({optionsJSON:n.options})}catch(i){if(i?.name==="NotAllowedError")return;throw i}const s=await fetch(`${ea()}/m5t/v5/webauthn/register/verify`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o,deviceLabel:Fc()})}),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.error||"Could not register this passkey");Zt("Passkey added","success"),await $s()}catch(t){console.warn("[settings-security] addPasskey failed:",t),Zt(t.message||"Could not add a passkey","danger")}finally{e&&(e.disabled=!1)}}async function Bc(e,t){if(confirm("Remove this passkey? You can always add it back later.")){t&&(t.disabled=!0);try{const a=await fetch(`${ea()}/m5t/v5/webauthn/${encodeURIComponent(e)}`,{method:"DELETE"}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||"Could not remove this passkey");pt.passkeys=pt.passkeys.filter(o=>o.guid!==e),Zt("Passkey removed","success"),Is()}catch(a){console.warn("[settings-security] removePasskey failed:",a),Zt(a.message||"Could not remove this passkey","danger"),t&&(t.disabled=!1)}}}const Uc={render:Ts,init:Cs},qc=Object.freeze(Object.defineProperty({__proto__:null,default:Uc,init:Cs,render:Ts},Symbol.toStringTag,{value:"Module"})),Hc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ne=e=>String(e??"").replace(/[&<>"']/g,t=>Hc[t]),qa=()=>x.getConfig?.().BASE_URL||"",Ca=e=>Number(e||0).toLocaleString(),G={conversations:[],counts:{},magnetNames:{},filter:"ALL",book:!1,magnetOwnerNames:{}},oo={COMPLETED:{label:"Completed",icon:"check_circle"},IN_PROGRESS:{label:"In progress",icon:"pending"},ABANDONED:{label:"Abandoned",icon:"highlight_off"}},Ha={book:"Book",chat:"Chat",call:"Call",email:"Email",support:"Support"};function Ls(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email)||null}function Rs(e){return(e.split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase()}function Ns(e){try{return new Date(e).toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return""}}function zc(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function Os(e){return e==null?"—":e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,"0")}s`}let so=!1;function Gc(){if(so)return;const e=document.createElement("style");e.id="m5t-convs-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),so=!0}const ga=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Ms(){return Gc(),gt(),`
    ...
    </div>`}async function Ps(){await jc()}async function jc(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${qa()}/m5t/v5/conversations`),fetch(`${qa()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(G.conversations=n.conversations||[],G.counts=n.counts||{},G.book=pe(),a){const o=await a.json().catch(()=>({}));G.magnetNames={},G.magnetOwnerNames={};const s=G.book?cs():{};(o.magnets||[]).forEach(r=>{G.magnetNames[r.guid]=r.name,G.book&&(G.magnetOwnerNames[r.guid]=r.owner_name||s[r.owner_guid]||"")})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=ga("error","Could not load journeys. Please try again.");return}Fs()}}function Vc(){return G.filter==="ALL"?G.conversations:G.conversations.filter(e=>e.status===G.filter)}function Wc(e){const t=Ls(e.lead),a=G.magnetNames[e.magnet_guid]||"—",n=oo[e.status]||oo.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,s=(e.routes||[]).map(r=>Ha[r]||r).join(", ");return`
    <tr class="convs-row" data-session="${ne(e.session)}">
      ...
      ${G.book?`<td>${ds(G.magnetOwnerNames[e.magnet_guid]||"")||'<span class="convs-muted">—</span>'}</td>`:""}
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${ne(Ns(e.started_at))}">${ne(zc(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${ne(Os(e.duration_s))}</td>
    </tr>`}function Fs(){const e=document.getElementById("convs-body");if(!e)return;if(!G.conversations.length){e.innerHTML=ga("route","No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.");return}const t=Vc(),a=[["ALL","All"],["COMPLETED","Completed"],["IN_PROGRESS","In progress"],["ABANDONED","Abandoned"]];e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${a.map(([n,o])=>`<button data-filter="${n}" class="${G.filter===n?"active":""}">${o}${n!=="ALL"&&G.counts[n]?` (${Ca(G.counts[n])})`:""}</button>`).join("")}
      </div>
      <span class="convs-count">${Ca(t.length)} of ${Ca(G.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(Wc).join("")||`<tr><td colspan="${G.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${G.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(G.filter=o.dataset.filter,Fs())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&Kc(o.dataset.session)})}const Yc={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${Ha[e]||e}`:""}`,route:e=>`Picked ${Ha[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function Kc(e){const t=G.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${qa()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=Ls(t.lead),o=G.magnetNames[t.magnet_guid]||"—",r=(a?.events||[]).filter((c,p,h)=>c.event!=="step"||!(h[p+1]&&h[p+1].event==="step")).map(c=>`
    <div class="convs-tl__item${c.event==="complete"?" done":""}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${ne((Yc[c.event]||(()=>c.event))(c.detail))}</div>
    ...
    </aside>`,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("open"),i.querySelector(".convs-drawer").classList.add("open")});const l=()=>{i.classList.remove("open"),setTimeout(()=>i.remove(),220)};i.querySelector(".convs-drawer__close").addEventListener("click",l),i.addEventListener("click",c=>{c.target===i&&l()})}const Jc={render:Ms,init:Ps},Qc=Object.freeze(Object.defineProperty({__proto__:null,default:Jc,init:Ps,render:Ms},Symbol.toStringTag,{value:"Module"})),Xc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Qe=e=>String(e??"").replace(/[&<>"']/g,t=>Xc[t]),ro=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},Gt=()=>x.getConfig?.().BASE_URL||"",ut=e=>Number(e||0).toLocaleString(),He={magnets:[],stats:{},canManage:!1},Zc={mag_title:"header title",mag_subtitle:"subtitle",mag_welcome:"welcome message",mag_theme_color:"color",mag_launcher_label:"launcher label"};let io=!1;function ed(){if(io)return;const e=document.createElement("style");e.id="m5t-abt-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),io=!0}const un=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Ds(){return pe()?Rt({section:"ab-testing",title:"A/B Testing",description:"Pick a client to view their experiments."}):(ed(),`
    <div class="page-shell" data-section="ab-testing">
      ...
      <div id="abt-body">${un("hourglass_empty","Loading tests…")}</div>
    </div>`)}async function mn(){if(pe())return ht(Gt(),[{h:"Running",td:t=>ut(t.ab_tests?.running)},{h:"Completed",td:t=>ut(t.ab_tests?.completed)},{h:"Compl. %",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Experiments appear per client once you have one."});const e=document.getElementById("abt-body");try{const t=new Date,a=new Date(t.getTime()-89*864e5).toISOString().slice(0,10),n=t.toISOString().slice(0,10),[o,s]=await Promise.all([fetch(`${Gt()}/m5t/v5/magnets`),fetch(`${Gt()}/m5t/v5/magnets/stats?from=${a}&to=${n}`)]),r=await o.json().catch(()=>({}));if(!r.ok)throw new Error(r.message||"Failed to load");He.magnets=r.magnets||[],He.canManage=!!r.canManage;const i=await s.json().catch(()=>({}));He.stats=i?.stats||{}}catch(t){console.warn("[ab-testing] load failed:",t),e&&(e.innerHTML=un("error","Could not load your tests. Please try again."));return}td()}function td(){const e=document.getElementById("abt-body");if(!e)return;const t=He.magnets.filter(n=>n.ab?.enabled),a=He.magnets.filter(n=>!n.ab?.enabled&&n.ab?.declared);if(!t.length&&!a.length){e.innerHTML=un("science","No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.");return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(sd).join("")}`:"")+(a.length?`<div class="abt-sect">Completed Tests</div>${a.map(rd).join("")}`:""),e.querySelectorAll("[data-declare]").forEach(n=>n.addEventListener("click",()=>id(n.dataset.declare,n.dataset.winner)))}function ad(e){const t=He.stats[e.guid]?.variants||{},a={opens:0,engaged:0,completions:0,rate:null,...t.A||{}},n={opens:0,engaged:0,completions:0,rate:null,...t.B||{}};return{A:a,B:n}}function nd(e){const t=Object.keys(e?.b||{}).map(a=>Zc[a]||a);return t.length?`Changes: ${t.join(", ")}`:""}function od(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function lo(e,t,a,n,o,s){return`
    <div class="abt-variant${o?" leader":""}">
      ...
      <div class="abt-mrow"><span class="k">Visitors</span><span class="v">${ut(n.opens)}</span></div>
      <div class="abt-mrow"><span class="k">Completions</span><span class="v">${ut(n.completions)}</span></div>
    ...
    </div>`}function sd(e){const t=e.ab,{A:a,B:n}=ad(e),o=(n.rate??-1)>(a.rate??-1)?"B":(a.rate??-1)>(n.rate??-1)?"A":null,s=o&&a.rate!=null&&n.rate!=null?`+${Math.round(Math.abs(n.rate-a.rate)*10)/10}%`:"",r=ld(a,n),i=t.started_tz?od(t.started_tz):null,l=(a.opens||0)+(n.opens||0),c=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
        <h2 class="abt-name">${Qe(e.name)}</h2>
        <span class="abt-status running"><span class="pulse-dot"></span>Running</span>
        <div class="abt-actions">
          ${He.canManage&&o?`<button class="btn btn-primary" type="button" data-declare="${Qe(e.guid)}" data-winner="${o}"><span class="material-symbols-outlined" aria-hidden="true">emoji_events</span>Declare Winner</button>`:""}
        </div>
      </div>
      <div class="abt-meta">
        ${i!=null?`<span><span class="material-symbols-outlined" aria-hidden="true">schedule</span>Started ${i===0?"today":`${i} day${i===1?"":"s"} ago`}</span>`:""}
        <span><span class="material-symbols-outlined" aria-hidden="true">visibility</span>${ut(l)} total visitors</span>
      ...
      <div class="abt-compare">
        ${lo("Variant A","Control","The magnet as configured",a,o==="A",o==="A"?s:"")}
        <div class="abt-vs">VS</div>
        ${lo("Variant B",o==="B"?"Leading":"Challenger",nd(t),n,o==="B",o==="B"?s:"")}
      </div>
      <div class="abt-sig">
    ...
    <div class="abt-card">
      ...
      <div class="abt-summary">
        ...
        <span><span class="k">Total Visitors:</span><span class="v">${ut(r)}</span></span>
      </div>
    </div>`}async function id(e,t){const a=He.magnets.find(n=>n.guid===e);if(a&&window.confirm(`Declare Variant ${t} the winner for “${a.name}”?

${t==="B"?"Variant B’s changes become the magnet’s configuration for everyone.":"The magnet keeps its current configuration."} The experiment ends and moves to Completed.`)){try{const o=await(await fetch(`${Gt()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Declare failed");ro(`Variant ${t} declared the winner`,"success")}catch(n){ro(n.message||"Could not declare a winner","danger");return}try{await mn()}catch(n){console.warn("[ab-testing] refresh after declare failed:",n)}}}function ld(e,t){const a=e.opens||0,n=t.opens||0,o=e.completions||0,s=t.completions||0;if(a<30||n<30||o+s<5)return null;const r=o/a,i=s/n,l=(o+s)/(a+n),c=Math.sqrt(l*(1-l)*(1/a+1/n));if(!c)return null;const p=Math.abs(i-r)/c;return Math.round(2*(cd(p)-.5)*1e3)/10}function cd(e){const t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}const dd={render:Ds,init:mn},pd=Object.freeze(Object.defineProperty({__proto__:null,default:dd,init:mn,render:Ds},Symbol.toStringTag,{value:"Module"})),ud={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},oe=e=>String(e??"").replace(/[&<>"']/g,t=>ud[t]),Bs=()=>x.getConfig?.().BASE_URL||"",md={single_select:{icon:"quiz",color:"#0072BA",darkColor:"#38BDF8"},multi_select:{icon:"checklist",color:"#0E6BA8",darkColor:"#22D3EE"},scheduler:{icon:"event",color:"#915E8B",darkColor:"#E879F9"},text:{icon:"short_text",color:"#5B54C6",darkColor:"#A78BFA"},email:{icon:"mail",color:"#0E8F86",darkColor:"#2DD4BF"},phone:{icon:"call",color:"#2E8B57",darkColor:"#4ADE80"},message:{icon:"chat",color:"#B4791F",darkColor:"#FBBF24"}},ta={};en.forEach(e=>{ta[e.value]={label:e.label,...md[e.value]||{icon:"quiz",color:"#0072BA",darkColor:"#38BDF8"}}});const Us=en.map(e=>e.value),qs={chat:"Chat / default",book:"Book (scheduler)",support:"Support (intake)"},gn=e=>{const t=ta[e]||ta.single_select;return document.documentElement.getAttribute("data-theme")==="dark"?{...t,color:t.darkColor}:t},at=e=>e==="single_select"||e==="multi_select",ha=e=>e!=="message",vt=e=>e==="scheduler",Nt=e=>e==="message",aa=e=>e==="email"?"email":e==="phone"?"phone":"",bt=()=>({meeting_label:"",start:"09:00",end:"17:00",mins:30,days:14}),gd=["meeting_label","start","end","mins","days"],co=["terminal","cta"];function za(e,t){const a={};return Object.keys(e&&typeof e=="object"?e:{}).forEach(n=>{t.includes(n)||(a[n]=e[n])}),Object.keys(a).length?a:null}function Hs(e){return za(e,gd)}const hd=[["","No icon"],["event","Calendar"],["schedule","Clock"],["mail","Email"],["sms","Text"],["phone","Phone"],["chat","Chat"],["description","Document"],["help","Question"],["place","Location"],["person","Person"],["bolt","Quick"],["check_circle","Check"],["star","Star"],["home","Home"],["build","Service"]];function fd(e,t){const a=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||"").trim());return a?`rgba(${parseInt(a[1],16)},${parseInt(a[2],16)},${parseInt(a[3],16)},${t})`:`rgba(0,114,186,${t})`}let po=!1;function vd(){if(po)return;const e=document.createElement("style");e.id="m5t-flow-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),po=!0}let O=[],Ie=null,bd=0,Be=null,Ke=null,Je="chat",ye={},jt=[],zs=null,Ga=null,Vt="";const mt=()=>"f"+ ++bd;function hn(e="single_select"){return{_uid:mt(),id:"",step_type:e,step_prompts:[""],step_options:at(e)?[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]:[],step_columns:aa(e)?[aa(e)]:[],step_description:"",step_config:vt(e)?bt():null}}function _d(e){return(Array.isArray(e)?e:[]).map(t=>({_uid:mt(),id:t.id!=null?String(t.id):"",step_type:ta[t.step_type]?t.step_type:"single_select",step_prompts:Array.isArray(t.step_prompts)?t.step_prompts.map(String):[],step_options:(Array.isArray(t.step_options)?t.step_options:[]).map(a=>({label:a&&a.label!=null?String(a.label):"",goto:a&&a.goto!=null?String(a.goto):"",icon:a&&a.icon!=null?String(a.icon):""})),step_columns:Array.isArray(t.step_columns)?t.step_columns.map(String):[],step_description:t.step_description!=null?String(t.step_description):"",step_config:vt(t.step_type)?{...bt(),...t.step_config&&typeof t.step_config=="object"?t.step_config:{}}:t.step_config&&typeof t.step_config=="object"?{...t.step_config}:null}))}function uo(){return[{_uid:mt(),id:"",step_type:"text",step_prompts:["Great, and your name?"],step_options:[],step_columns:["first_name"],step_description:"",step_config:null},{_uid:mt(),id:"",step_type:"email",step_prompts:["The best email to reach you?"],step_options:[],step_columns:["email"],step_description:"",step_config:null}]}function yd(e,t){if(e==="book")return[{_uid:mt(),id:"",step_type:"scheduler",step_prompts:["When works best for you?"],step_options:[],step_columns:[],step_description:"",step_config:bt()},...uo()];if(e==="support"){const a=(t.actions||[]).find(s=>s&&s.type==="support"),n=a&&a.config&&Array.isArray(a.config.options)?a.config.options:[],o=n.length?n.map(s=>({label:s&&s.label||String(s),goto:"",icon:s&&s.icon||""})):["Sales enquiry","Support","Billing","Something else"].map(s=>({label:s,goto:"",icon:""}));return[{_uid:mt(),id:"",step_type:"multi_select",step_prompts:["How can we help you today?"],step_options:o,step_columns:[],step_description:"Select all that apply",step_config:null},...uo()]}return[hn("single_select")]}function Gs(e,t){const a=e==="chat"?t.steps:t.routes&&t.routes[e],n=_d(a);return n.length?n:e==="chat"?[hn("single_select")]:yd(e,t)}function wd(e){at(e.step_type)?e.step_options.length||(e.step_options=[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]):e.step_options=[],ha(e.step_type)?!e.step_columns.length&&aa(e.step_type)&&(e.step_columns=[aa(e.step_type)]):e.step_columns=[],e.step_config=vt(e.step_type)?{...bt(),...e.step_config||{}}:Hs(e.step_config)}function xd(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${oe(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${hd.map(([a,n])=>`<option value="${oe(a)}"${a===e.icon?" selected":""}>${oe(n)}</option>`).join("")}</select>
  ...
  </div>`}function Ed(e){const t=Us.map(n=>`<option value="${n}"${n===e.step_type?" selected":""}>${oe(gn(n).label)}</option>`).join(""),a=e.step_options.length<=1;return`<div class="flow-node__body">
...
`))}</textarea>
    ...
    <select class="mag-modal__select flow-f-field">
      ...
      ${Za.map(n=>`<option value="${oe(n.value)}"${n.value===e.step_columns[0]?" selected":""}>${oe(n.label)}</option>`).join("")}
    </select>
  ...
  </div>`}function Ad(e){const t=e.step_prompts.find(o=>String(o).trim()!=="")||"",a=t?`<div class="flow-node__prompt">“${oe(t)}”</div>`:`<div class="flow-node__prompt is-empty">${e.step_type==="message"?"No message yet":"No question yet"}</div>`;let n="";if(at(e.step_type)){const o=e.step_options.map(s=>String(s.label).trim()).filter(Boolean);if(o.length){const s=o.slice(0,4).map(i=>`<span class="flow-node__chip">${oe(i)}</span>`).join(""),r=o.length>4?`<span class="flow-node__chip">+${o.length-4}</span>`:"";n=`<div class="flow-node__chips">${s}${r}</div>`}}else if(ha(e.step_type)&&e.step_columns[0]){const o=Za.find(s=>s.value===e.step_columns[0])?.label||e.step_columns[0];n=`<div class="flow-node__meta">Saves to <b>${oe(o)}</b></div>`}else if(Nt(e.step_type)&&e.step_config?.terminal){const o=String(e.step_config?.cta?.label||"").trim();n=`<div class="flow-node__meta">Ends the conversation${o?` — link: <b>${oe(o)}</b>`:""}</div>`}return`<div class="flow-node__preview">${a}${n}</div>`}function kd(e,t,a){const n=gn(e.step_type),o=e._uid===Ie,s=`--nc:${n.color};--nct:${fd(n.color,.14)}`;return`<div class="flow-node${o?" flow-node--open":""}" data-uid="${e._uid}" style="${s}"${o?"":' draggable="true"'}>
    ...
    ${o?Ed(e):Ad(e)}
  </div>`}const mo='<div class="flow-conn"><span class="flow-conn__line"></span><span class="material-symbols-outlined" aria-hidden="true">expand_more</span></div>';function xe(){const e=document.getElementById("flow-nodes");if(!e)return;const t=O.length,a=['<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>',mo];O.forEach((n,o)=>{a.push(kd(n,o,t)),o<t-1&&a.push(mo)}),e.innerHTML=a.join("")}function Le(){const e=document.querySelector(".flow-node--open");if(!e)return;const t=O.find(s=>s._uid===e.dataset.uid);if(!t)return;const a=e.querySelector(".flow-f-type");a&&(t.step_type=a.value);const n=e.querySelector(".flow-f-prompts");n&&(t.step_prompts=n.value.split(`
`));const o=e.querySelector(".flow-f-field");if(t.step_columns=o&&o.value.trim()?[o.value.trim()]:[],at(t.step_type)){const s=t.step_options,r=[];e.querySelectorAll(".flow-opt").forEach((i,l)=>{r.push({label:i.querySelector(".flow-o-label")?.value??"",icon:i.querySelector(".flow-o-icon")?.value??"",goto:s[l]&&s[l].goto||""})}),t.step_options=r}else t.step_options=[];if(vt(t.step_type)){const s=e.querySelector(".flow-f-mtlabel"),r=e.querySelector(".flow-f-start"),i=e.querySelector(".flow-f-end"),l=e.querySelector(".flow-f-mins");t.step_config={...t.step_config||bt(),...s?{meeting_label:s.value.trim()}:{},...r&&r.value?{start:r.value}:{},...i&&i.value?{end:i.value}:{},...l?{mins:parseInt(l.value,10)||30}:{}}}else if(Nt(t.step_type)){const s=e.querySelector(".flow-f-terminal");if(s){const r=e.querySelector(".flow-f-cta-label"),i=e.querySelector(".flow-f-cta-url"),l=za(t.step_config,co)||{};t.step_config=s.checked?{...l,terminal:!0,cta:{label:r?r.value:"",url:i?i.value:""}}:za(t.step_config,co)}}else t.step_config=Hs(t.step_config)}function js(){document.querySelectorAll(".flow-node.drop-before, .flow-node.drop-after").forEach(e=>e.classList.remove("drop-before","drop-after"))}function xt(){js(),document.querySelectorAll(".flow-node.dragging").forEach(e=>e.classList.remove("dragging")),Be=null,Ke=null}function Sd(e=O){if(!e.length)return{message:"Add at least one step.",uid:null,field:null};for(let t=0;t<e.length;t++){const a=e[t],n=t+1,o=(s,r=null)=>({message:s,uid:a._uid,field:r});if(!a.step_prompts.some(s=>String(s).trim()!==""))return o(`Step ${n}: add what the magnet should say.`,"prompts");if(at(a.step_type)&&!a.step_options.some(s=>String(s.label).trim()!==""))return o(`Step ${n}: add at least one choice.`,"options");if(ha(a.step_type)&&!a.step_columns.length)return o(`Step ${n}: choose which field this answer saves to.`,"field");if(Nt(a.step_type)&&a.step_config?.terminal){const s=String(a.step_config.cta?.label||"").trim(),r=String(a.step_config.cta?.url||"").trim();if(!!s!=!!r)return o(`Step ${n}: fill in both the link label and URL, or leave both blank.`,"cta")}}return null}function Vs(e){if(!e)return;const t=e.querySelector(".flow-f-cta-label"),a=e.querySelector(".flow-f-cta-url");if(!t||!a)return;const n=t.value.trim()!=="",o=a.value.trim()!=="",s=n||o,r=n!==o;e.querySelectorAll(".flow-cta-req").forEach(l=>{l.textContent=s?"required":"optional",l.classList.toggle("flow-sub--req",s)}),t.classList.toggle("flow-f-invalid",r&&!n),a.classList.toggle("flow-f-invalid",r&&!o);const i=e.querySelector(".flow-cta-warn");i&&(i.hidden=!r)}function ja(e=O){let t=0;return e.forEach(a=>{const n=parseInt(a.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(a=>{const n=a.id&&String(a.id).trim()?String(a.id):String(++t),o=at(a.step_type)?a.step_options.map(r=>{const i={label:String(r.label).trim(),goto:String(r.goto||"")};return r.icon&&(i.icon=String(r.icon)),i}).filter(r=>r.label!==""):[],s={id:n,step_type:a.step_type,step_prompts:a.step_prompts.map(r=>String(r)).filter(r=>r.trim()!==""),step_options:o,step_columns:a.step_columns.slice(),step_description:a.step_description||""};if(vt(a.step_type))a.step_config&&(s.step_config={...bt(),...a.step_config});else if(a.step_config&&Object.keys(a.step_config).length){const r={...a.step_config};if(Nt(a.step_type)&&r.terminal){const i=String(r.cta?.label??"").trim(),l=String(r.cta?.url??"").trim();i&&l?r.cta={label:i,url:l}:delete r.cta}s.step_config=r}return s})}function Td(e,t,a){vd(),zs=t,Ga=typeof a=="function"?a:null,Vt=t?.modified_tz||"",jt=["chat",...["book","support"].filter(n=>(t.actions||[]).some(o=>o&&o.type===n))],ye={chat:Gs("chat",t)},Je="chat",O=ye.chat,Ie=O.length===1?O[0]._uid:null,Be=null,Ke=null,e.innerHTML=`
    ...
    ${jt.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${jt.map(n=>`<option value="${n}">${oe(qs[n]||n)}</option>`).join("")}</select></div>`:""}
...
<body>
  ...
  <\/script>
  <script>${a}<\/script>
</body></html>`}let ho=!1;function Ys(){if(ho)return;const e=document.createElement("style");e.id="m5t-preview-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ho=!0}function Ks(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function Js(e){const t=e.querySelector("[data-pv-info]"),a=e.querySelector("[data-pv-info-pop]");t&&a&&t.addEventListener("click",()=>{a.hidden=!a.hidden})}function Od(e,t){Ys(),e.innerHTML=`
    <div class="pv-pane">
    ...
    </div>`}function Pd(e){ps(ma.MAGNET_TEMPLATE,e)}function Fd(){const e=us(ma.MAGNET_TEMPLATE);return e&&na.find(t=>t.id===e)||null}let fo=!1;function Zs(){if(fo)return;const e=document.createElement("style");e.id="m5t-mag-template-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),fo=!0}function Dd(e){Zs();const t=document.createElement("div");t.className="mag-modal-scrim mag-tpl-modal",t.innerHTML=`
...
</details>`,ar={chat:"Chat bubble",right_slide:"Slide-in panel",modal:"Modal",inline:"Inline"},Ud={chat:"chat",right_slide:"vertical_split",modal:"web_asset",inline:"view_agenda"},nr=[{value:"inline",icon:"view_agenda",label:"Inline"},{value:"chat",icon:"chat",label:"Chat"},{value:"right_slide",icon:"vertical_split",label:"Slide"},{value:"modal",icon:"web_asset",label:"Modal"}],or=[{value:"auto",icon:"brightness_auto",label:"Auto"},{value:"light",icon:"light_mode",label:"Light"},{value:"dark",icon:"dark_mode",label:"Dark"}],sr=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],fn={book:{label:"Book",icon:"event",kind:"book"},chat:{label:"Chat",icon:"chat",kind:"flow"},call:{label:"Call",icon:"phone",kind:"value",placeholder:"Phone number"},email:{label:"Email",icon:"mail",kind:"value",placeholder:"Email address"},support:{label:"Support",icon:"support_agent",kind:"support"}},rr=["book","chat","call","email","support"];let Wt=null;async function qd(){if(Wt)return Wt;let e;try{const t=await fetch(`${te()}/m5t/v5/integrations/calendly/event_types`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.event_types||[],scheduling_url:a.data.scheduling_url||""}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(Wt=e),e}async function Hd(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved Calendly event";e.innerHTML=`<option value="${w(t)}">${t?w(a):"Loading event types"}</option>`;const n=await qd();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${w(t)}" selected>${w(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect Calendly under Settings, Integrations first":"Could not load event types"}</option>`;return}const o=[];n.scheduling_url&&o.push({url:n.scheduling_url,label:"Full scheduling page (visitor picks the event)"}),n.list.forEach(s=>o.push({url:s.scheduling_url,label:s.duration?`${s.name} (${s.duration} min)`:s.name})),t&&!o.some(s=>s.url===t)&&o.unshift({url:t,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${w(s.url)}"${s.url===(t||o[0].url)?" selected":""}>${w(s.label)}</option>`).join(""):'<option value="">No active event types</option>'}let Yt=null;async function zd(){if(Yt)return Yt;let e;try{const t=await fetch(`${te()}/m5t/v5/integrations/callrail/trackers`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.trackers||[]}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(Yt=e),e}async function Gd(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved tracking number";e.innerHTML=`<option value="${w(t)}">${t?w(a):"Loading tracking numbers"}</option>`;const n=await zd();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${w(t)}" selected>${w(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect CallRail under Settings, Integrations first":"Could not load tracking numbers"}</option>`;return}const o=n.list.map(s=>({number:s.number,id:s.id,name:s.name,label:`${s.name} · ${s.number}${s.type==="session"?" (number pool)":""}`}));t&&!o.some(s=>s.number===t)&&o.unshift({number:t,id:e.dataset.savedId||"",name:a,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${w(s.number)}" data-tracker-id="${w(s.id)}" data-tracker-name="${w(s.name)}"${s.number===(t||o[0].number)?" selected":""}>${w(s.label)}</option>`).join(""):'<option value="">No active tracking numbers in this company</option>'}function bo(e,t,a){return`<div class="mag-seg" role="radiogroup" aria-label="${w(e)}">${a.map(n=>`
    <label><input type="radio" name="${w(e)}" value="${w(n.value)}"${n.value===t?" checked":""}>
      <span><span class="material-symbols-outlined" aria-hidden="true">${w(n.icon)}</span>${w(n.label)}</span></label>`).join("")}</div>`}function jd(e,t){const a=fn[e],n=!!t,o=n?"":" disabled";let s="";if(a.kind==="value"&&e==="call"){const i=t?.config?.source==="callrail",l=i&&t?.value||"",c=i?t?.config?.tracker_name||"Saved tracking number":"";s=`
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${a.kind}">
    ...
    ${r}
  </div>`}function Vd(){if(vo)return;const e=document.createElement("style");e.id="m5t-magnets-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),vo=!0}function oa(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Wd(e){const t=q.stats[e];if(!t||!t.opens&&!t.leads)return'<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>';const a=n=>Number(n||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function vn(e){const t=q.owners.length>1||x.getMemberships().length>1,a=(e.domains||[]).filter(Boolean),n=q.canManage;return`
    <div class="mag-card" data-guid="${w(e.guid)}">
      ...
      <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${Ud[e.display_mode]||"chat"}</span>${w(ar[e.display_mode]||"Chat bubble")}${e.ab?.enabled?'&nbsp;&nbsp;<span class="mag-ab-chip"><span class="material-symbols-outlined" aria-hidden="true">science</span>A/B</span>':""}${(e.notify_emails||[]).length?`&nbsp;&nbsp;<a class="mag-alert-chip" href="#/settings/notifications" title="Lead alerts to ${(e.notify_emails||[]).length} email${(e.notify_emails||[]).length===1?"":"s"}. Manage in Settings."><span class="material-symbols-outlined" aria-hidden="true">notifications_active</span>${(e.notify_emails||[]).length}</a>`:""}</span>
      ${Wd(e.guid)}
    ...
    </div>`}function Yd(){return pe()?Rt({section:"magnets",title:"Your Magnets",description:"Pick a client to view and manage their magnets."}):(Vd(),`
    ...
    </div>`)}async function Kd(){if(pe()){const a=n=>Number(n||0).toLocaleString();return ht(te(),[{h:"Magnets",td:n=>`${a(n.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${a(n.magnets.total)}</span>`},{h:"Leads · wk",td:n=>a(n.leads.this_week)},{h:"Leads · total",td:n=>a(n.leads.total)}],{emptyMsg:"No client orgs yet. Create one under Clients, then provision its magnets here."})}Wt=null,Yt=null,document.getElementById("mag-new-btn")?.addEventListener("click",Xd),document.getElementById("mag-template-btn")?.addEventListener("click",Zd),document.getElementById("mag-body")?.addEventListener("click",ep),await Ot();const t=Fd();t&&q.canProvision&&lr(t)}async function Ot(){const e=document.getElementById("mag-body");if(!e)return;try{const[n,o]=await Promise.all([fetch(`${te()}/m5t/v5/magnets`),fetch(`${te()}/m5t/v5/magnets/stats`).catch(()=>null)]),s=await n.json().catch(()=>({}));if(!s.ok)throw new Error(s.message||"Failed to load");q.magnets=s.magnets||[],q.owners=s.owners||[],q.canProvision=!!s.canProvision,q.canManage=!!s.canManage,q.primaryOrgGuid=s.primaryOrgGuid||null;const r=o?await o.json().catch(()=>({})):{};q.stats=r?.stats||{}}catch{e.innerHTML=oa("error","Could not load your magnets. Please try again.");return}const t=document.getElementById("mag-new-btn");t&&(t.style.display=q.canProvision?"":"none");const a=document.getElementById("mag-template-btn");if(a&&(a.style.display=q.canProvision?"":"none"),!q.magnets.length){e.innerHTML=oa("widgets",q.canProvision?"No magnets yet. Click “New magnet” to create your first.":"No magnets yet.");return}e.innerHTML=`<div class="mag-grid">${q.magnets.map(vn).join("")}</div>`}async function Jd(e){const t={"Content-Type":"application/json","Idempotency-Key":crypto.randomUUID()},a={status:"DRAFT"};e&&(a.owner_guid=e);const n=await fetch(`${te()}/m5t/v5/magnets`,{method:"POST",headers:t,body:JSON.stringify(a)});let o={};try{o=await n.json()}catch{}if(!n.ok||!o.ok)throw new Error(o.message||`Could not start a new magnet (${n.status})`);return o.magnet}async function Qd(e,t){const a=await fetch(`${te()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t.name,...t.appearance,steps:t.steps})});let n={};try{n=await a.json()}catch{}if(!a.ok||!n.ok)throw new Error(n.message||`Could not apply the ${t.name} template (${a.status})`)}async function bn(e,t){const a=document.getElementById("mag-new-btn"),n=document.getElementById("mag-template-btn");a&&(a.disabled=!0),n&&(n.disabled=!0);let o=null;try{let s=await Jd(e);if(o=s.guid,t)await Qd(s.guid,t),await Ot(),s=q.magnets.find(r=>r.guid===s.guid)||s;else{q.magnets=[s,...q.magnets];const r=document.getElementById("mag-body");r&&(r.innerHTML=`<div class="mag-grid">${q.magnets.map(vn).join("")}</div>`)}sa(s,void 0,{freshDraft:!0})}catch(s){o&&fetch(`${te()}/m5t/v5/magnets/${encodeURIComponent(o)}`,{method:"DELETE"}).catch(()=>{}),De(s.message||"Could not start a new magnet","danger")}finally{a&&(a.disabled=!1),n&&(n.disabled=!1)}}function ir(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="Choose client" style="max-width:420px">
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(o){o.key==="Escape"&&(o.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.querySelector('[data-x="cancel"]').addEventListener("click",a),t.querySelector('[data-x="continue"]').addEventListener("click",()=>{const o=t.querySelector("#mag-owner-pick").value;a(),bn(o,e)})}function Xd(){if(q.owners.length>1){ir();return}bn(null)}function lr(e){if(q.owners.length>1){ir(e);return}bn(null,e)}function Zd(){Dd(lr)}function ep(e){const t=e.target.closest("[data-action]");if(!t)return;const a=t.dataset.guid,n=q.magnets.find(s=>s.guid===a),o=t.dataset.action;if(o==="copy")return tp(a);if(n){if(o==="preview")return Qs(()=>Va(n));if(o==="funnel")return ap(n);if(o==="edit")return sa(n);if(o==="flow")return sa(n,"flow");if(o==="toggle")return np(n);if(o==="delete")return op(n)}}async function tp(e){try{await navigator.clipboard.writeText(er(e)),De("Embed snippet copied","success")}catch{De("Copy failed","danger")}}function cr(e){const t=Number(e?.total_steps)||0,a={};if((Array.isArray(e?.funnel)?e.funnel:[]).forEach(s=>{a[s.position]=Number(s.reached)||0}),!t||!Object.keys(a).length)return'<p class="mag-modal__hint" style="margin:0">No step activity yet in this window. As visitors answer questions, drop-off by step will appear here.</p>';const n=Math.max(1,a[1]||0),o=[];for(let s=1;s<=t;s++){const r=a[s]||0,i=Math.min(100,Math.round(r/n*100));o.push(`
      ...
      </div>`)}return`<div class="mag-funnel">${o.join("")}</div>`}async function ap(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(s){s.key==="Escape"&&(s.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.addEventListener("click",s=>{s.target===t&&a()});const o=t.querySelector("#mag-funnel-body");try{const s=await fetch(`${te()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/step-funnel`),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.message||`Failed (${s.status})`);o.innerHTML=cr(r)}catch{o.innerHTML='<p class="mag-modal__hint" style="margin:0">Could not load the funnel. Please try again.</p>'}}async function np(e){if(e.status==="DRAFT"){De("Open Edit and Save to publish a draft magnet.","info");return}const t=e.status==="ENABLED"?"DISABLED":"ENABLED";try{if(!(await(await fetch(`${te()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw new Error;De(t==="ENABLED"?"Magnet enabled":"Magnet disabled","success")}catch{De("Update failed","danger");return}try{await Ot()}catch(a){console.warn("[magnets] refresh after status toggle failed:",a)}}async function op(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`)){try{if(!(await(await fetch(`${te()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"})).json().catch(()=>({}))).ok)throw new Error;De("Magnet deleted","success")}catch{De("Delete failed","danger");return}try{await Ot()}catch(t){console.warn("[magnets] refresh after delete failed:",t)}}}function $a(e){const t=[];return e.querySelectorAll(".mag-cta").forEach(a=>{if(!a.querySelector(".mag-cta__on").checked)return;const n=a.dataset.type,o=a.dataset.kind,s=a.querySelector(".mag-cta__val"),r=s?s.value.trim():"";if(o==="value")if(n==="call"&&a.querySelector(".mag-cta__callsrc")?.value==="callrail"){const i=a.querySelector(".mag-cta__crtracker"),l=i?.value||"",c=i?.selectedOptions?.[0];l&&t.push({type:n,value:l,config:{source:"callrail",...c?.dataset?.trackerId?{tracker_id:c.dataset.trackerId}:{},...c?.dataset?.trackerName?{tracker_name:c.dataset.trackerName}:{}}})}else r&&t.push({type:n,value:r});else if(o==="book")if(a.querySelector(".mag-cta__booksrc")?.value==="calendly"){const i=a.querySelector(".mag-cta__calevent"),l=i?.value||"",c=(i?.selectedOptions?.[0]?.textContent||"").trim();t.push({type:n,config:{source:"calendly",...l?{calendly_url:l}:{},...l&&c?{event_name:c}:{}}})}else{const i={type:n};r&&(/^https?:\/\//i.test(r)?i.value=r:i.config={meeting_label:r}),t.push(i)}else if(o==="support"){const i=(a.querySelector(".mag-cta__opts")?.value||"").split(`
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:dr(e),actions:t,font:e.querySelector("#mag-f-font").value.trim(),theme_vars:dp(e),inline_width:e.querySelector("#mag-f-inline-w").value.trim(),inline_height:e.querySelector("#mag-f-inline-h").value.trim(),hide_launcher:e.querySelector("#mag-f-hide-launcher").checked,input_placeholder:e.querySelector("#mag-f-input-ph").value,summary_confirm_label:e.querySelector("#mag-f-summary-confirm").value.trim(),success_title:e.querySelector("#mag-f-success-title").value.trim(),success_text:e.querySelector("#mag-f-success-text").value,success_cta:pp(e)}}const sp=512,rp=new Set(["image/png","image/jpeg","image/gif","image/webp"]),ip=8*1024*1024;function lp(e){return new Promise((t,a)=>{const n=new Image,o=new FileReader;o.onerror=()=>a(new Error("Could not read that file.")),o.onload=()=>{n.onerror=()=>a(new Error("That file isn’t a readable image.")),n.onload=()=>{const s=Math.min(1,sp/Math.max(n.naturalWidth,n.naturalHeight)),r=Math.max(1,Math.round(n.naturalWidth*s)),i=Math.max(1,Math.round(n.naturalHeight*s)),l=document.createElement("canvas");l.width=r,l.height=i,l.getContext("2d").drawImage(n,0,0,r,i),t(l.toDataURL("image/png"))},n.src=o.result},o.readAsDataURL(e)})}function cp(e,t){const a=e.querySelector("#mag-logo-drop");if(!a)return;const n=e.querySelector("#mag-f-logo-file"),o=e.querySelector("#mag-logo-browse"),s=e.querySelector("#mag-logo-remove"),r=e.querySelector("#mag-logo-preview"),i=e.querySelector("#mag-logo-status"),l=e.querySelector("#mag-f-logo"),c=(v,u)=>{i.textContent=v,i.style.color=u?"var(--color-danger, #DD4124)":""},p=v=>{r.innerHTML=v?`<img src="${w(v)}" alt="">`:'<span class="material-symbols-outlined" aria-hidden="true">image</span>',s.hidden=!v},h=v=>{l.value=v,l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))};async function b(v){if(!rp.has(v.type)){c("PNG, JPEG, GIF, or WEBP only.",!0);return}if(v.size>ip){c("That file is too large (8MB max before resizing).",!0);return}c("Uploading…",!1);try{const u=await lp(v),d=await fetch(`${te()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({image:u})}),f=await d.json().catch(()=>({}));if(!d.ok||!f.ok)throw new Error(f.error||`Upload failed (${d.status})`);const _=`${te()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;h(_),p(_),c("Logo updated.",!1)}catch(u){c(u.message||"Upload failed.",!0)}}n.addEventListener("change",()=>{n.files[0]&&b(n.files[0]),n.value=""}),a.addEventListener("click",v=>{v.target===s||s.contains(v.target)||v.target!==o&&n.click()}),o.addEventListener("click",()=>n.click()),["dragenter","dragover"].forEach(v=>a.addEventListener(v,u=>{u.preventDefault(),a.classList.add("is-dragover")})),["dragleave","drop"].forEach(v=>a.addEventListener(v,u=>{u.preventDefault(),a.classList.remove("is-dragover")})),a.addEventListener("drop",v=>{const u=v.dataTransfer?.files?.[0];u&&b(u)}),s.addEventListener("click",async v=>{v.stopPropagation(),c("Removing…",!1);try{const u=await fetch(`${te()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"DELETE"}),d=await u.json().catch(()=>({}));if(!u.ok||!d.ok)throw new Error(d.error||`Remove failed (${u.status})`);h(""),p(""),c("Logo removed.",!1)}catch(u){c(u.message||"Remove failed.",!0)}})}function dp(e){return e.querySelector("#mag-f-surface-on")?.checked?{surface:e.querySelector("#mag-f-sv-surface").value,surface_2:e.querySelector("#mag-f-sv-surface2").value,border:e.querySelector("#mag-f-sv-border").value,text:e.querySelector("#mag-f-sv-text").value,text_sub:e.querySelector("#mag-f-sv-textsub").value}:{}}function pp(e){const t=e.querySelector("#mag-f-success-cta-label").value.trim(),a=e.querySelector("#mag-f-success-cta-url").value.trim();return t&&a?{label:t,url:a}:{}}function dr(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",s=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==s.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}const Wa=[{label:"Web fonts (loaded for you)",opts:[["Inter, sans-serif","Inter"],["Poppins, sans-serif","Poppins"],["Montserrat, sans-serif","Montserrat"],["Roboto, sans-serif","Roboto"],['"Open Sans", sans-serif',"Open Sans"],["Lato, sans-serif","Lato"],["Nunito, sans-serif","Nunito"],["Raleway, sans-serif","Raleway"],['"Work Sans", sans-serif',"Work Sans"],["Oswald, sans-serif","Oswald"],["Merriweather, serif","Merriweather (serif)"]]},{label:"System / always available",opts:[["system-ui, sans-serif","System UI"],["Georgia, serif","Georgia (serif)"],['"Times New Roman", Times, serif',"Times (serif)"],["Arial, Helvetica, sans-serif","Arial / Helvetica"],["Verdana, Geneva, sans-serif","Verdana"],['"Courier New", monospace',"Courier (mono)"]]}];function up(e){const t=String(e||""),a=new Set(Wa.flatMap(s=>s.opts.map(([r])=>r))),n=s=>s===t?" selected":"";let o=`<option value=""${t===""?" selected":""}>System default</option>`;t&&!a.has(t)&&(o+=`<option value="${w(t)}" selected>Current: ${w(t)}</option>`);for(const s of Wa)o+=`<optgroup label="${w(s.label)}">`+s.opts.map(([r,i])=>`<option value="${w(r)}"${n(r)}>${w(i)}</option>`).join("")+"</optgroup>";return o}function sa(e,t,a={}){const{freshDraft:n=!1}=a,o=!!e,s=o?null:crypto.randomUUID(),r=!o&&q.owners.length>1,i=e?.display_mode||"chat",l=e?.theme_mode||"auto",c={};(e?.actions||[]).forEach(S=>{S&&S.type&&(c[S.type]=S)});const p=o?!!e.home:!0,h=o?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",b=e?.theme_vars&&typeof e.theme_vars=="object"?e.theme_vars:{},v=Object.keys(b).length>0,u=(S,U)=>w(/^#[0-9a-fA-F]{6}$/.test(b[S]||"")?b[S]:U),d=document.createElement("div");d.className="mag-modal-scrim",d.innerHTML=`
    ...
    </div>`,document.body.appendChild(d),requestAnimationFrame(()=>{d.classList.add("open"),d.querySelector(".mag-modal").classList.add("open")});const f=[...d.querySelectorAll(".mag-modal__navitem")],_=[...d.querySelectorAll(".mag-tab")],E=S=>{f.forEach(U=>U.classList.toggle("is-active",U.dataset.tab===S)),_.forEach(U=>{U.hidden=U.dataset.tab!==S}),d.querySelector(".mag-modal__body").scrollTop=0};f.forEach(S=>S.addEventListener("click",()=>E(S.dataset.tab)));const C=()=>Va({...e,...$a(d),...o?{steps:go()}:{}}),$=d.querySelector("#mag-preview-pane"),W=()=>window.matchMedia("(min-width: 1200px)").matches;let D=null;const Y=()=>{if(!D&&W())try{D=Od($,C)}catch{}};let se=null;const ue=()=>{W()&&(Y(),D&&(clearTimeout(se),se=setTimeout(()=>{try{D.refresh()}catch{}},300)))},ce=window.matchMedia("(min-width: 1200px)"),Ae=()=>{W()&&(Y(),ue())};ce.addEventListener("change",Ae);let M=!1,ee=!1;const B=d.querySelector("#mag-f-dirty"),j=S=>{M=S,B&&(B.hidden=!S)},ze=d.querySelector(".mag-modal__main");ze.addEventListener("input",()=>j(!0)),ze.addEventListener("change",()=>{j(!0),ue()}),d.querySelector("#mag-f-color")?.addEventListener("input",()=>{j(!0),ue()});const Ge=S=>{M&&(S.preventDefault(),S.returnValue="")};window.addEventListener("beforeunload",Ge);let _t=!0;const fa=m.subscribe(g.ROUTE_NAV_BEFORE,()=>{if(_t){if(M&&!confirm("Discard your changes to this magnet?")){window.router?.navigate("/magnets");return}y()}}),y=()=>{if(n&&!ee&&e&&e.status==="DRAFT"){fetch(`${te()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"}).catch(()=>{}),q.magnets=q.magnets.filter(U=>U.guid!==e.guid);const S=document.getElementById("mag-body");S&&(S.innerHTML=`<div class="mag-grid">${q.magnets.map(vn).join("")}</div>`)}_t=!1,window.removeEventListener("beforeunload",Ge),m.unsubscribe(fa),clearTimeout(se),ce.removeEventListener("change",Ae),D&&D.destroy&&D.destroy(),d.classList.remove("open"),setTimeout(()=>d.remove(),180),document.removeEventListener("keydown",R)},k=()=>{M&&!confirm("Discard your changes to this magnet?")||y()};function R(S){S.key==="Escape"&&(S.preventDefault(),k())}document.addEventListener("keydown",R),d.querySelector(".mag-modal__close").addEventListener("click",k),d.querySelector('[data-x="cancel"]').addEventListener("click",k),d.querySelector("[data-close-modal]")?.addEventListener("click",k),d.querySelector("#mag-f-name").focus();const H=d.querySelector("#mag-flow-panel");o?Td(H,e,()=>{j(!0),ue()}):H.innerHTML='<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>',cp(d,e),t&&E(t),Y(),d.querySelectorAll(".mag-cta").forEach(S=>{const U=S.querySelector(".mag-cta__on"),de=S.querySelector(".mag-cta__val"),ae=S.querySelector(".mag-cta__opts"),Oe=S.querySelectorAll(".mag-cta__booksrc, .mag-cta__calevent, .mag-cta__callsrc, .mag-cta__crtracker");U.addEventListener("change",()=>{de&&(de.disabled=!U.checked),ae&&(ae.disabled=!U.checked),Oe.forEach(V=>{V.disabled=!U.checked}),U.checked&&(de||ae)?.focus()}),de&&de.addEventListener("input",()=>{de.value.trim()&&!U.checked&&(U.checked=!0,ae&&(ae.disabled=!1))})}),d.querySelectorAll('.mag-cta[data-kind="book"]').forEach(S=>{const U=S.querySelector(".mag-cta__booksrc"),de=S.querySelector(".mag-cta__val"),ae=S.querySelector(".mag-cta__calevent");if(!U||!ae)return;const Oe=()=>{const V=U.value==="calendly";de.hidden=V,ae.hidden=!V,V&&!ae.dataset.listed&&(ae.dataset.listed="1",Hd(ae))};U.addEventListener("change",()=>{const V=S.querySelector(".mag-cta__on");V.checked||(V.checked=!0,V.dispatchEvent(new Event("change"))),Oe()}),Oe()}),d.querySelectorAll('.mag-cta[data-type="call"]').forEach(S=>{const U=S.querySelector(".mag-cta__callsrc"),de=S.querySelector(".mag-cta__val"),ae=S.querySelector(".mag-cta__crtracker");if(!U||!ae)return;const Oe=()=>{const V=U.value==="callrail";de.hidden=V,ae.hidden=!V,V&&!ae.dataset.listed&&(ae.dataset.listed="1",Gd(ae))};U.addEventListener("change",()=>{const V=S.querySelector(".mag-cta__on");V.checked||(V.checked=!0,V.dispatchEvent(new Event("change"))),Oe()}),Oe()});const P=d.querySelector("#mag-f-surface-on"),we=d.querySelector("#mag-f-surface");P.addEventListener("change",()=>we.hidden=!P.checked);const je=d.querySelector("#mag-f-inline-size");d.querySelectorAll('input[name="mag-display"]').forEach(S=>S.addEventListener("change",()=>{je.hidden=d.querySelector('input[name="mag-display"]:checked')?.value!=="inline"})),d.querySelector('[data-x="preview"]')?.addEventListener("click",()=>Qs(()=>Va({...e,...$a(d),...o?{steps:go()}:{}}))),d.querySelector('[data-x="save"]').addEventListener("click",async S=>{const U=S.currentTarget,de=d.querySelector("#mag-f-error"),ae=d.querySelector("#mag-f-name").value.trim();if(!ae){E("basics"),de.textContent="Please give your magnet a name.";return}const Oe=d.querySelector("#mag-f-domains").value.split(",").map(X=>X.trim()).filter(Boolean);let V="";if(d.querySelectorAll(".mag-cta").forEach(X=>{const nt=X.querySelector(".mag-cta__on").checked;if(X.dataset.kind==="book"){const wt=X.querySelector(".mag-cta__booksrc")?.value==="calendly";nt&&wt&&!X.querySelector(".mag-cta__calevent")?.value&&(V=V||"Pick a Calendly event for the Book button, or switch it back to the built-in scheduler.");return}if(X.dataset.kind!=="value")return;if(X.dataset.type==="call"&&X.querySelector(".mag-cta__callsrc")?.value==="callrail"){nt&&!X.querySelector(".mag-cta__crtracker")?.value&&(V=V||"Pick a CallRail tracking number for the Call button, or switch it back to a phone number.");return}const yt=X.querySelector(".mag-cta__val").value.trim();nt&&!yt&&(V=V||`Add a target for the ${fn[X.dataset.type].label} button, or uncheck it.`)}),V){E("welcome"),de.textContent=V;return}const wn=dr(d);if(wn.enabled&&!Object.keys(wn.b).length){E("ab"),de.textContent="Give variant B at least one change (title, welcome, or color), or untick the A/B test.";return}if(o){const X=$d();if(X){E("flow"),de.textContent=X.message,Id(X.route,X.message,{uid:X.uid,field:X.field});return}}const va={name:ae,domains:Oe,...$a(d)};r&&(va.owner_guid=d.querySelector("#mag-f-owner").value);const xn=o&&e.status==="DRAFT";xn&&(va.status="ENABLED"),U.disabled=!0,de.textContent="";try{const X=o?`${te()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${te()}/m5t/v5/magnets`,nt={"Content-Type":"application/json"};s&&(nt["Idempotency-Key"]=s);const yt=await fetch(X,{method:o?"PATCH":"POST",headers:nt,body:JSON.stringify(va)});let wt={};try{wt=await yt.json()}catch{}if(!yt.ok||!wt.ok)throw new Error(wt.message||`Save failed (${yt.status})`);o&&await Rd(e.guid),De(xn||!o?"Magnet created":"Magnet updated","success"),ee=!0,y(),await Ot()}catch(X){U.disabled=!1,de.textContent=X.message||"Something went wrong."}})}const mp=Object.freeze(Object.defineProperty({__proto__:null,CTA_META:fn,CTA_ORDER:rr,DISPLAY_OPTS:nr,FONT_GROUPS:Wa,MODE_LABEL:ar,THEME_OPTS:or,TRIGGER_OPTS:sr,cspNoteHTML:tr,init:Kd,openModal:sa,render:Yd,stepFunnelHTML:cr},Symbol.toStringTag,{value:"Module"}));let _o=!1;function gp(){if(Zs(),_o)return;const e=document.createElement("style");e.id="m5t-templates-page-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),_o=!0}function pr(){return gp(),`
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body">
          ...
          <div class="mag-tpl-grid mag-tpl-grid--page" id="tpl-grid">
            ${na.map(e=>Xs(e,{detail:!0})).join("")}
          </div>
        </div>
      </div>
    </div>`}function ur(){document.getElementById("tpl-grid")?.addEventListener("click",e=>{const t=e.target.closest("[data-tpl]");t&&(Pd(t.dataset.tpl),window.location.hash="#/magnets")})}const hp={render:pr,init:ur},fp=Object.freeze(Object.defineProperty({__proto__:null,default:hp,init:ur,render:pr},Symbol.toStringTag,{value:"Module"}));let yo=!1;const A={leads:[],magnetNames:{},filter:"ALL",canManage:!1,book:!1,ownerNames:{},clientFilter:"ALL",search:"",shown:100,selectedId:null},it=100,Ya=["NEW","WORKING","QUALIFIED","UNQUALIFIED","CONVERTED","EXPORTED"],vp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},N=e=>String(e??"").replace(/[&<>"']/g,t=>vp[t]),ra=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},ia=()=>x.getConfig?.().BASE_URL||"",la=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",mr=e=>(la(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase(),_n=e=>e.created?.created_tz||"";function lt(e){const t=_n(e);if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric"})}catch{return""}}function bp(e){const t=_n(e);if(!t)return"";try{const a=Date.now()-new Date(t).getTime();if(a<0)return lt(e);const n=a/36e5;return n<1?`${Math.max(1,Math.floor(a/6e4))}m ago`:n<24?`${Math.floor(n)}h ago`:n<48?"Yesterday":lt(e)}catch{return lt(e)}}const _p=e=>{const t=_n(e);if(!t)return!1;try{return Date.now()-new Date(t).getTime()<24*36e5}catch{return!1}};function yp(){if(yo)return;const e=document.createElement("style");e.id="m5t-leads-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),yo=!0}function It(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function wp(e){return`<select class="leads-status" data-id="${N(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${Ya.map(t=>`<option value="${t}" ${e.status===t?"selected":""}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join("")}
  </select>`}function xp(e){const t=A.magnetNames[e.magnet_guid]||e.lead_source||"—",a=e.phone?String(e.phone).replace(/[^\d+]/g,""):"";return`
    <tr class="leads-row${String(e.id)===A.selectedId?" selected":""}" data-id="${N(e.id)}" tabindex="0" role="button" aria-label="Open lead ${N(la(e))}">
      <td>
      ...
      ${A.book?`<td>${ds(A.ownerNames[e.owner_guid]||"")||'<span class="leads-muted">—</span>'}</td>`:""}
      <td>
      ...
      <td>${A.canManage?wp(e):`<span class="leads-badge" data-s="${N(e.status)}">${N(e.status)}</span>`}</td>
      <td class="num leads-muted" style="white-space:nowrap" title="${N(lt(e))}">${_p(e)?'<span class="leads-fresh" title="Captured in the last 24 hours"></span>':""}${N(bp(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}const gr=e=>A.clientFilter==="ALL"||e.owner_guid===A.clientFilter;function Ep(e){const t=A.search.trim().toLowerCase();if(!t)return!0;const a=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,A.magnetNames[e.magnet_guid],A.book?A.ownerNames[e.owner_guid]:"",e.utm_campaign,e.utm_source].filter(Boolean).join(" ").toLowerCase();return t.split(/\s+/).every(n=>a.includes(n))}function hr(){return A.leads.filter(e=>(A.filter==="ALL"||e.status===A.filter)&&gr(e)&&Ep(e))}const fr=()=>It("touch_app","Click to see lead information.");function Ap(){yp(),gt();const e=pe();return`
    <div class="page-shell" data-section="leads">
      ...
      <div class="dashboard-card" style="margin-bottom:24px">
        ...
        <div class="card-body" id="pf-picker-body">${It("hourglass_empty","Loading…")}</div>
      </div>`:""}
      <div class="page-header">
        <div class="page-header-text">
      ...
      <div class="leads-layout">
        <div class="dashboard-card">
          <div class="card-body" id="leads-body">
            ${It("hourglass_empty","Loading leads…")}
          </div>
        </div>
    ...
    </div>`}async function kp(){document.getElementById("leads-export")?.addEventListener("click",$p);const e=us(ma.LEADS_SEARCH);if(e&&(A.search=e,A.filter="ALL",A.clientFilter="ALL",A.shown=it),pe()){const t=a=>Number(a||0).toLocaleString();ht(ia(),[{h:"Leads · wk",td:a=>t(a.leads.this_week)},{h:"Leads · total",td:a=>t(a.leads.total)},{h:"Compl.",td:a=>a.completion_rate!=null?`${a.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Sp()}async function Sp(){const e=document.getElementById("leads-body");if(e){try{const[t,a]=await Promise.all([fetch(`${ia()}/m5t/v5/m5mLead`),fetch(`${ia()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(A.leads=(n.data||[]).filter(o=>!["DELETED","ARCHIVED"].includes(o.status)),A.book=pe(),A.ownerNames=A.book?cs():{},a){const o=await a.json().catch(()=>({}));A.magnetNames={},(o.magnets||[]).forEach(s=>{A.magnetNames[s.guid]=s.name,s.owner_guid&&s.owner_name&&!A.ownerNames[s.owner_guid]&&(A.ownerNames[s.owner_guid]=s.owner_name)}),A.canManage=!!o.canManage}}catch{e.innerHTML=It("error","Could not load your leads. Please try again.");return}ca()}}const Tp=()=>`
  <colgroup>
    <col style="width:23%">
  ...
  </colgroup>`;function ca(){const e=document.getElementById("leads-body"),t=document.getElementById("leads-export");if(!e)return;if(t&&(t.style.display=A.leads.length?"":"none"),!A.leads.length){e.innerHTML=It("inbox","No leads captured yet. Publish a magnet and share it to start collecting.");return}const a=A.leads.filter(gr),n={ALL:a.length};Ya.forEach(s=>{n[s]=a.filter(r=>r.status===s).length});const o=A.book?[...new Set(A.leads.map(s=>s.owner_guid).filter(Boolean))].map(s=>({guid:s,name:A.ownerNames[s]||s})).sort((s,r)=>s.name.localeCompare(r.name)):[];e.innerHTML=`
    <div class="leads-bar">
      <div class="leads-filter">
        ${["ALL",...Ya].map(s=>`<button data-filter="${s}" class="${A.filter===s?"active":""}">${s==="ALL"?"All":s[0]+s.slice(1).toLowerCase()}${n[s]?`<span class="leads-pillnum">${n[s]}</span>`:""}</button>`).join("")}
      </div>
      ${A.book&&o.length>1?`
      <select class="leads-clientsel" id="leads-clientsel" aria-label="Filter by client">
        <option value="ALL">All clients</option>
        ${o.map(s=>`<option value="${N(s.guid)}" ${A.clientFilter===s.guid?"selected":""}>${N(s.name)}</option>`).join("")}
      </select>`:""}
      <span class="leads-searchwrap">
        <span class="material-symbols-outlined" aria-hidden="true">search</span>
        <input class="leads-search" id="leads-search" type="search" placeholder="Search leads" value="${N(A.search)}" aria-label="Search leads" />
      </span>
      <span class="leads-count" id="leads-countlbl"></span>
    </div>
    <div id="leads-tablezone"></div>`,e.querySelector(".leads-filter")?.addEventListener("click",s=>{const r=s.target.closest("[data-filter]");r&&(A.filter=r.dataset.filter,A.shown=it,ca())}),e.querySelector("#leads-clientsel")?.addEventListener("change",s=>{A.clientFilter=s.target.value,A.shown=it,ca()}),e.querySelector("#leads-search")?.addEventListener("input",s=>{A.search=s.target.value,A.shown=it,Ka()}),Ka()}function Ka(){const e=document.getElementById("leads-tablezone"),t=document.getElementById("leads-countlbl");if(!e)return;const a=hr(),n=a.slice(0,A.shown),o=A.book?8:7;t&&(t.textContent=`${a.length} of ${A.leads.length}`),e.innerHTML=`
    <div class="leads-tablewrap">
      <table class="leads-table">
        ...
        <tbody id="leads-tbody">${n.map(xp).join("")||`<tr><td colspan="${o}"><div class="leads-muted" style="padding:14px 4px">${A.search.trim()?"No leads match your search.":`No ${A.filter.toLowerCase()} leads.`}</div></td></tr>`}</tbody>
      </table>
    </div>
    ${a.length>A.shown?`<button class="leads-more" type="button" id="leads-more">Show ${Math.min(it,a.length-A.shown)} more (${a.length-A.shown} remaining)</button>`:""}`,e.querySelector("#leads-more")?.addEventListener("click",()=>{A.shown+=it,Ka()}),e.querySelector("#leads-tbody")?.addEventListener("change",Cp),e.querySelector("#leads-tbody")?.addEventListener("click",s=>{if(s.target.closest(".leads-status, a.leads-contactlink"))return;const r=s.target.closest(".leads-row");r&&wo(r.dataset.id)}),e.querySelector("#leads-tbody")?.addEventListener("keydown",s=>{if(s.key!=="Enter"&&s.key!==" ")return;const r=s.target.closest(".leads-row");r&&s.target===r&&(s.preventDefault(),wo(r.dataset.id))})}async function Cp(e){const t=e.target.closest(".leads-status");if(!t)return;const a=t.dataset.id,n=A.leads.find(r=>String(r.id)===String(a)),o=t.value,s=n?.status;try{if(!(await(await fetch(`${ia()}/m5t/v5/m5mLead/${encodeURIComponent(a)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:o})})).json().catch(()=>({}))).ok)throw new Error;n&&(n.status=o),ra(`Marked ${o[0]}${o.slice(1).toLowerCase()}`,"success")}catch{t.value=s||"NEW",ra("Could not update status","danger");return}try{String(a)===A.selectedId&&_r(),A.filter!=="ALL"&&ca()}catch(r){console.warn("[leads] re-render after status change failed:",r)}}function wo(e){A.selectedId=String(e),document.querySelectorAll(".leads-row").forEach(t=>t.classList.toggle("selected",t.dataset.id===A.selectedId)),_r()}function Ft(e,t){const a=Array.isArray(e.tags)?e.tags:[];for(let n=a.length-1;n>=0;n--)if(a[n]&&a[n].tag===t&&a[n].value!=null)return String(a[n].value);return""}function vr(e){const t=Ft(e,"appointment_start");if(!t)return null;const a=Ft(e,"appointment_status")||"booked",n=Ft(e,"appointment_timezone"),o=Ft(e,"appointment_event_type"),s=new Date(t);let r=t;if(!Number.isNaN(s.getTime())){const i={weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"};try{r=new Intl.DateTimeFormat(void 0,n?{...i,timeZone:n}:i).format(s)}catch{r=new Intl.DateTimeFormat(void 0,i).format(s)}}return{when:r,status:a,type:o,start:t}}const xo={booked:["QUALIFIED","Booked"],rescheduled:["WORKING","Rescheduled"],canceled:["CANCELED","Canceled"]};function br(e){const t=Array.isArray(e.tags)?e.tags:[];let a=null;for(const l of t)if(!(!l||!l.tag)){if(l.tag==="callrail_call_id"){a={};continue}a&&l.tag.indexOf("call_")===0&&l.value!=null&&(a[l.tag]=String(l.value))}if(!a||!a.call_started)return null;const n=a.call_started,o=new Date(n);let s=n;Number.isNaN(o.getTime())||(s=new Intl.DateTimeFormat(void 0,{weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"}).format(o));const r=Number(a.call_duration)||0,i=r?r<60?`${r}s`:`${Math.floor(r/60)}m ${r%60}s`:"";return{when:s,dur:i,source:a.call_source||"",answered:a.call_answered||"",recording:a.call_recording_player||"",started:n}}function _r(){const e=document.getElementById("leads-panel-body");if(!e)return;const t=A.leads.find(l=>String(l.id)===A.selectedId);if(!t){e.innerHTML=fr();return}const a=A.magnetNames[t.magnet_guid]||t.lead_source||"—",n=vr(t),[o,s]=n?xo[n.status]||xo.booked:["",""],r=br(t),i=(l,c)=>c?`<div class="leads-det__field"><span class="leads-det__k">${N(l)}</span><span class="leads-det__v">${N(c)}</span></div>`:"";e.innerHTML=`
    ...
    ${t.description?`<div class="leads-det__notes">${N(t.description)}</div>`:""}`}function $p(){const e=hr();if(!e.length){ra("Nothing to export","info");return}const t=["first_name","last_name","email","phone","company","product_interest","lead_source","utm_source","utm_medium","utm_campaign","gclid","status"],a=l=>`"${String(l??"").replace(/"/g,'""')}"`,o=[[...A.book?["client"]:[],...t,"magnet","captured","appointment","last_call"].join(",")];for(const l of e){const c=vr(l),p=br(l);o.push([...A.book?[a(A.ownerNames[l.owner_guid]||"")]:[],...t.map(h=>a(l[h])),a(A.magnetNames[l.magnet_guid]||l.lead_source||""),a(lt(l)),a(c?`${c.start} (${c.status})`:""),a(p?`${p.started} (${p.answered==="no"?"missed":"answered"})`:"")].join(","))}const s=new Blob([o.join(`
`)],{type:"text/csv"}),r=URL.createObjectURL(s),i=document.createElement("a");i.href=r,i.download=`leads-${A.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r),ra(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const Ip=Object.freeze(Object.defineProperty({__proto__:null,init:kp,render:Ap},Symbol.toStringTag,{value:"Module"})),yr=()=>x.getConfig?.().BASE_URL||"",Eo=e=>e.toISOString().slice(0,10),Ao=e=>e==null?"—":"$"+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),rt=e=>Number(e||0).toLocaleString(),Lp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Dt=e=>String(e??"").replace(/[&<>"']/g,t=>Lp[t]);let ko=!1;function Rp(){if(ko)return;const e=document.createElement("style");e.id="m5t-adperf-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ko=!0}const ct=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Bt=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
  ...
  </div>`,Np=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let da=30;function wr(){return pe()?Rt({section:"ad-performance",title:"Ad Performance",description:"Pick a client to view their spend and lead performance."}):(Rp(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${Np.map(e=>`<button class="chart-period-btn${e.d===da?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>
    ...
    </div>`)}async function xr(){if(pe()){const t=a=>Number(a||0).toLocaleString();return ht(yr(),[{h:"Spend",td:a=>a.ad?`$${t(a.ad.spend)}`:"—"},{h:"Clicks",td:a=>a.ad?t(a.ad.clicks):"—"},{h:"Leads",td:a=>t(a.leads.window??a.leads.total)},{h:"CPL",td:a=>a.ad?.cost_per_lead!=null?`$${t(a.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see spend here."})}const e=document.getElementById("adperf-periods");e?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(da=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===da)),So())}),await So()}async function So(){const e=yr(),t=document.getElementById("adperf-body"),a=document.getElementById("adperf-range"),n=new Date,o=Eo(n),s=Eo(new Date(n.getTime()-(da-1)*864e5));a&&(a.textContent=`${s} → ${o}`);let r,i=[],l=null;try{const[p,h,b]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${s}&to=${o}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${s}&to=${o}`)]);if(!p.ok)throw new Error(`HTTP ${p.status}`);r=await p.json(),i=((await h.json().catch(()=>({})))?.data||[]).filter(u=>u.status!=="DELETED"),l=await b.json().catch(()=>null)}catch(p){console.warn("[ad-performance] load failed:",p),t&&(t.innerHTML=ct("error","Could not load ad performance. Please try again."));return}const c=r.totals||{};if(Ut("adperf-spend",Ao(c.spend)),Ut("adperf-clicks",rt(c.clicks)),Ut("adperf-leads",rt(c.magnet_leads)),Ut("adperf-cpl",Ao(c.cost_per_lead)),Op(l),!i.length){t.innerHTML=ct("link_off","No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.");return}if(!r.connected){t.innerHTML=ct("cloud_sync","Account connected. No ad data for this range yet. Metrics appear here once they sync.");return}t.innerHTML=Mp(r.rows||[])}function Op(e){const t=document.getElementById("adperf-sources"),a=document.getElementById("adperf-src-summary");if(!t)return;const n=e&&Array.isArray(e.rows)?e.rows:[];if(!n.length){a&&(a.textContent=""),t.innerHTML=ct("search_off","No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.");return}const o=e.total_leads||n.reduce((i,l)=>i+(l.leads||0),0),s=e.tracked_leads||0;a&&(a.textContent=`${rt(s)} of ${rt(o)} leads tagged to a source`);const r=i=>i.campaign&&i.campaign!=="(none)"?Dt(i.campaign):i.source&&i.source!=="(direct)"?Dt(i.source):'<span class="adperf-src-untracked">Untracked / direct</span>';t.innerHTML=`
      ...
      <table class="adperf-srctable">
        ...
        <tbody>${n.map(i=>`
          <tr>
            ...
            <td class="num">${i.paid_clicks?rt(i.paid_clicks):'<span class="adperf-src-sub">—</span>'}</td>
            <td class="num"><b>${rt(i.leads)}</b></td>
          </tr>`).join("")}
        </tbody>
      </table>
    </div>`}function Ut(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}function To(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}function Co(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e)}function Mp(e){const v=e.length||1,u=To(Math.max(1,...e.map(M=>M.spend||0))),d=To(Math.max(1,...e.map(M=>M.magnet_leads||0))),f=738/v,_=Math.min(24,f*.55),E=M=>56+f*(M+.5),C=M=>304-M/u*282,$=M=>304-M/d*282,W=[0,.25,.5,.75,1].map(M=>{const ee=304-M*282;return`<line x1="56" y1="${ee.toFixed(1)}" x2="794" y2="${ee.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${(ee+3.5).toFixed(1)}" text-anchor="end" class="ax">$${Co(u*M)}</text><text x="802" y="${(ee+3.5).toFixed(1)}" text-anchor="start" class="ax">${Co(d*M)}</text>`}).join(""),D=e.map((M,ee)=>{const B=C(M.spend||0);return`<rect x="${(E(ee)-_/2).toFixed(1)}" y="${B.toFixed(1)}" width="${_.toFixed(1)}" height="${Math.max(0,304-B).toFixed(1)}" rx="3" fill="#0072BA"><title>${M.date}: $${M.spend} spend</title></rect>`}).join(""),Y=e.map((M,ee)=>`${E(ee).toFixed(1)},${$(M.magnet_leads||0).toFixed(1)}`).join(" "),se=v>1?`<polyline points="${Y}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",ue=e.map((M,ee)=>`<circle cx="${E(ee).toFixed(1)}" cy="${$(M.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${M.date}: ${M.magnet_leads} leads</title></circle>`).join(""),ce=Math.max(1,Math.ceil(v/6)),Ae=e.map((M,ee)=>ee%ce===0||ee===v-1?`<text x="${E(ee).toFixed(1)}" y="326" text-anchor="middle" class="ax">${M.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="adperf-chart" viewBox="0 0 840 340" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Ad spend versus magnet leads over time">
      ${W}${D}${se}${ue}${Ae}
    </svg>`}const Pp={render:wr,init:xr},Fp=Object.freeze(Object.defineProperty({__proto__:null,default:Pp,init:xr,render:wr},Symbol.toStringTag,{value:"Module"})),$o="reseller_org",Er="managed_client";let Io=!1;const Dp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},L=e=>String(e??"").replace(/[&<>"']/g,t=>Dp[t]);function Xe(e,t="info"){try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}}function Bp(){const e=x.getActiveOrg();if(e&&e.channel===$o)return{guid:e.guid,name:e.name};const t=x.getMemberships().find(a=>a.channel===$o);return t?{guid:t.orgGuid,name:t.name}:null}function Up(e){const t=e?.created_tz;if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function qp(){if(Io)return;const e=document.createElement("style");e.id="m5t-clients-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Io=!0}const Hp=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Ct(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function zp(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
    <div class="client-row">
      <span class="client-row__avatar">${L(Hp(t))}</span>
      <span class="client-row__main">
        <div class="client-row__name" title="${L(t)}">${L(t)}</div>
        <div class="client-row__meta">Added ${L(Up(e.created))||"—"}</div>
      </span>
    ...
    </div>`}async function kr(){const e=Bp();document.getElementById("clients-add-btn")?.addEventListener("click",()=>Gp(e)),await Sr(e)}async function Sr(e){const t=document.getElementById("clients-body"),a=document.getElementById("clients-count");if(t){if(!e?.guid){t.innerHTML=Ct("info","Client provisioning is available to reseller / agency accounts."),a&&(a.textContent="");return}try{const n=x.getConfig?.().BASE_URL||"",o=await fetch(`${n}/m5t/v5/acctGroup`);if(!o.ok)throw new Error(`HTTP ${o.status}`);const s=await o.json(),i=(Array.isArray(s?.data)?s.data:[]).filter(l=>l.class===Er&&(!l.parent||l.parent===e.guid));if(!i.length){t.innerHTML=Ct("group_off","No clients yet. Add your first client to start managing magnets on their behalf."),a&&(a.textContent="");return}t.innerHTML=`<div class="client-list">${i.map(zp).join("")}</div>`,a&&(a.textContent=`${i.length} client${i.length===1?"":"s"}`),t.querySelectorAll(".client-card__invite").forEach(l=>{l.addEventListener("click",()=>{l.dataset.action==="adaccounts"?jp(l.dataset.clientGuid,l.dataset.clientName):l.dataset.action==="questionnaire"?Wp(l.dataset.clientGuid,l.dataset.clientName):Vp(l.dataset.clientGuid,l.dataset.clientName)})})}catch(n){console.warn("[clients] load failed:",n),t.innerHTML=Ct("error","Couldn’t load clients. Please try again."),a&&(a.textContent="")}}}function Gp(e){if(!e?.guid){Xe("Only reseller / agency accounts can add clients.","error");return}const t=document.createElement("div");t.className="client-modal-scrim";const a=document.createElement("div");a.className="client-modal",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),document.body.appendChild(a),requestAnimationFrame(()=>{t.classList.add("open"),a.classList.add("open")});const n=a.querySelector("#client-name-input"),o=a.querySelector("#client-modal-error"),s=a.querySelector('[data-act="create"]');n?.focus();const r=()=>{t.classList.remove("open"),a.classList.remove("open"),document.removeEventListener("keydown",i),setTimeout(()=>{t.remove(),a.remove()},200)},i=c=>{c.key==="Escape"&&r()};document.addEventListener("keydown",i),t.addEventListener("click",r),a.querySelector(".client-modal__close")?.addEventListener("click",r),a.querySelector('[data-act="cancel"]')?.addEventListener("click",r);const l=async()=>{const c=(n?.value||"").trim();if(o.textContent="",!c){o.textContent="Please enter a client name.",n?.focus();return}s.disabled=!0;const p=s.innerHTML;s.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Adding…';try{const h=x.getConfig?.().BASE_URL||"",b=await fetch(`${h}/m5t/v5/acctGroup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({class:Er,caption:c,parent:e.guid})}),v=await b.json().catch(()=>({}));if(!b.ok||!v?.ok){const u=b.status===403?"You are not authorized to add a client here.":v?.message||v?.error||`Failed (HTTP ${b.status})`;throw new Error(u)}Xe(`Added client “${c}”`,"success"),r(),await Sr(e)}catch(h){console.warn("[clients] create failed:",h),o.textContent=h.message||"Something went wrong. Please try again.",s.disabled=!1,s.innerHTML=p}};s?.addEventListener("click",l),n?.addEventListener("keydown",c=>{c.key==="Enter"&&l()})}const Lo=e=>String(e||"").replace(/[^0-9]/g,"");async function jp(e,t){const a=x.getConfig?.().BASE_URL||"",n={};try{const u=await fetch(`${a}/m5t/v5/coreAdAccount?owner_guid=${encodeURIComponent(e)}`),d=await u.json().catch(()=>({}));if(!u.ok)throw new Error(`Failed to load ad accounts (${u.status})`);(d?.data||[]).forEach(f=>{n[f.provider]=f})}catch(u){console.warn("[clients] ad-accounts prefill failed:",u)}const o=n.google_ads,s=n.google_lsa,r=document.createElement("div");r.className="client-modal-scrim";const i=document.createElement("div");i.className="client-modal",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.innerHTML=`
    <div class="client-modal__head">
    ...
    </div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add("open"),i.classList.add("open")});const l=i.querySelector("#aa-error"),c=i.querySelector('[data-act="save"]'),p=()=>{r.classList.remove("open"),i.classList.remove("open"),document.removeEventListener("keydown",h),setTimeout(()=>{r.remove(),i.remove()},200)},h=u=>{u.key==="Escape"&&p()};document.addEventListener("keydown",h),r.addEventListener("click",p),i.querySelector(".client-modal__close")?.addEventListener("click",p),i.querySelector('[data-act="cancel"]')?.addEventListener("click",p);const b=(u,d,f)=>{const _=`${a}/m5t/v5/coreAdAccount`;return d&&!f?fetch(_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,provider:u,external_customer_id:d})}):d&&f&&d!==f.external_customer_id?fetch(`${_}/${encodeURIComponent(f.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({external_customer_id:d})}):!d&&f?fetch(`${_}/${encodeURIComponent(f.guid)}`,{method:"DELETE"}):null},v=async()=>{l.textContent="";const u=Lo(i.querySelector("#aa-gads").value),d=Lo(i.querySelector("#aa-lsa").value),f=[b("google_ads",u,o),b("google_lsa",d,s)].filter(Boolean);if(!f.length){p();return}c.disabled=!0;const _=c.innerHTML;c.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const E=await Promise.all(f);for(const C of E)if(!C.ok){const $=await C.json().catch(()=>({}));throw new Error(C.status===403?"You are not authorized to connect accounts for this client.":$?.error||$?.message||`Failed (HTTP ${C.status})`)}Xe("Ad accounts updated","success"),p()}catch(E){l.textContent=E.message||"Something went wrong. Please try again.",c.disabled=!1,c.innerHTML=_}};c?.addEventListener("click",v)}function Vp(e,t){if(!e)return;const a=document.createElement("div");a.className="client-modal-scrim";const n=document.createElement("div");n.className="client-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="invite-body">
      ...
      <div class="client-modal__actions">
        ...
        <div class="client-modal__result">
          ...
          <p>${f.emailQueued?`An invite email is on its way to <strong>${L(p)}</strong>.`:`Invite created for <strong>${L(p)}</strong>.`}</p>
          ...
          <div class="client-modal__linkrow">
            <input class="client-modal__input" id="inv-link" type="text" readonly value="${L(f.inviteUrl)}" />
    ...
    <div class="client-modal__body" id="qm-body">${Ct("hourglass_empty","Loading…")}</div>`,document.body.appendChild(n),document.body.appendChild(o),requestAnimationFrame(()=>{n.classList.add("open"),o.classList.add("open")});const s=()=>{n.classList.remove("open"),o.classList.remove("open"),document.removeEventListener("keydown",r),setTimeout(()=>{n.remove(),o.remove()},200)},r=u=>{u.key==="Escape"&&s()};document.addEventListener("keydown",r),n.addEventListener("click",s),o.querySelector(".client-modal__close")?.addEventListener("click",s);const i=o.querySelector("#qm-body");function l(){i.innerHTML=`
      ...
      </div>`,i.querySelector('[data-act="done"]')?.addEventListener("click",s),i.querySelector('[data-act="resend"]')?.addEventListener("click",()=>l())}function h(u,d){const f=d[u.id];if(u.type==="checkbox_group"){const _=Array.isArray(f)?f:[];return _.length?L(_.join(", ")):""}return f?L(f):""}function b(u,d){const f=d[u.id];if(u.type==="checkbox_group"){const _=Array.isArray(f)?f:[];return`<div class="qm-checkbox-group">${(Array.isArray(u.options)?u.options:[]).map(C=>`
        <label><input type="checkbox" value="${L(C)}" ${_.includes(C)?"checked":""}/> ${L(C)}</label>`).join("")}</div>`}return u.type==="textarea"?`<textarea>${L(f||"")}</textarea>`:`<input type="text" value="${L(f||"")}" />`}function v(u,d=!1){const f=u.questionnaire?.sections||[],_=u.answers||{},E=u.recipient_email?`<p class="qm-recipient">Sent to ${L(u.recipient_email)}</p>`:"",C=u.last_edited_tz?`<p class="qm-edited-marker">Last edited by ${L(u.last_edited_by_email||"a team member")} on ${L(qt(u.last_edited_tz))}</p>`:"";i.innerHTML=`
      ...
      <form id="qm-form">
        ${f.map(W=>`
          <div class="qm-section">
            <h3>${L(W.title)}</h3>
            ${(W.questions||[]).map(D=>`
              <div class="qm-qa" data-question-id="${L(D.id)}" data-question-type="${L(D.type)}">
                <div class="qm-qa__q">${L(D.label)}</div>
                <div class="qm-qa__a">${d?b(D,_):h(D,_)||'<span class="qm-qa__a--empty">(blank)</span>'}</div>
              </div>`).join("")}
          </div>`).join("")}
      </form>
      <p class="client-modal__error" id="qm-error"></p>
      ...
      </div>`,i.querySelector('[data-act="done"]')?.addEventListener("click",s),i.querySelector('[data-act="cancel-edit"]')?.addEventListener("click",()=>v(u,!1)),i.querySelector('[data-act="edit"]')?.addEventListener("click",()=>v(u,!0));const $=i.querySelector('[data-act="save"]');$?.addEventListener("click",async()=>{const W={};i.querySelectorAll("[data-question-id]").forEach(Y=>{const se=Y.dataset.questionId;if(Y.dataset.questionType==="checkbox_group"){const ce=[...Y.querySelectorAll('input[type="checkbox"]:checked')].map(Ae=>Ae.value);ce.length&&(W[se]=ce)}else{const ce=(Y.querySelector("input,textarea")?.value||"").trim();ce&&(W[se]=ce)}}),$.disabled=!0;const D=$.innerHTML;$.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const Y=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(u.guid)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({answers:W})}),se=await Y.json().catch(()=>({}));if(!Y.ok||!se.ok)throw new Error(se.error||se.message||`Failed (HTTP ${Y.status})`);Xe("Answers updated","success");const ce=await(await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(u.guid)}`)).json().catch(()=>({}));v(ce.ok?ce.data:{...u,answers:W},!1)}catch(Y){i.querySelector("#qm-error").textContent=Y.message||"Something went wrong. Please try again.",$.disabled=!1,$.innerHTML=D}})}try{const u=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse?owner_guid=${encodeURIComponent(e)}`),d=await u.json().catch(()=>({}));if(!u.ok||!d.ok)throw new Error(d.error||`HTTP ${u.status}`);const f=(d.data||[])[0]||null;if(!f){l();return}if(f.status==="DRAFT"){c(f);return}if(f.status==="CANCELLED"){p(f);return}const _=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(f.guid)}`),E=await _.json().catch(()=>({}));if(!_.ok||!E.ok)throw new Error(E.error||`HTTP ${_.status}`);v(E.data)}catch(u){console.warn("[clients] questionnaire load failed:",u),i.innerHTML=`<p class="client-modal__error">Could not load questionnaire status. ${L(u.message||"")}</p>`}}const Yp={render:Ar,init:kr},Kp=Object.freeze(Object.defineProperty({__proto__:null,default:Yp,init:kr,render:Ar},Symbol.toStringTag,{value:"Module"})),Ro="managed_client";let No=!1;const Jp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},fe=e=>String(e??"").replace(/[&<>"']/g,t=>Jp[t]),Oo=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},Qp=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Xp(){const e=x.getActiveOrg();let t=e&&e.channel!==Ro?e:null;if(!t){const n=x.getMemberships().find(o=>o.channel!==Ro);n&&(t={guid:n.orgGuid,channel:n.channel,memberRole:n.memberRole})}if(!t)return null;const a=x.getMemberships().find(n=>n.orgGuid===t.guid)?.name;return{...t,name:a}}function Zp(e){return Object.values(St).filter(t=>xi(e,t.value)).sort((t,a)=>a.rank-t.rank)}function eu(){if(No)return;const e=document.createElement("style");e.id="m5t-team-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),No=!0}function pa(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function tu(e){const t=e.member_role||"member";return`
    <div class="team-row">
      <span class="team-avatar">${fe(Qp(e.name||e.email))}</span>
      ...
      <span class="team-role" data-role="${fe(t)}">${fe(St[t]?.label||t)}</span>
    </div>`}function Tr(){return eu(),`
