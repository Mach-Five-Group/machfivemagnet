var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t,n)=>()=>{if(n)throw n[0];try{return e&&(t=e(e=0)),t}catch(e){throw n=[e],e}},s=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),c=(e,n)=>{let r={};for(var i in e)t(r,i,{get:e[i],enumerable:!0});return n||t(r,Symbol.toStringTag,{value:`Module`}),r},l=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},u=(n,r,o)=>(o=n==null?{}:e(i(n)),l(r||!n||!n.__esModule||!a.call(n,`default`)?t(o,`default`,{value:n,enumerable:!0}):o,n));(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var d=s(((e,t)=>{(function(n,r){typeof e==`object`&&typeof t==`object`?t.exports=r():typeof define==`function`&&define.amd?define(`Navigo`,[],r):typeof e==`object`?e.Navigo=r():n.Navigo=r()})(typeof self<`u`?self:e,(function(){return function(){var e={407:function(e,t,n){n.d(t,{default:function(){return pe}});var r=/([:*])(\w+)/g,i=/\*/g,a=/\/\?/g;function o(e){return e===void 0&&(e=`/`),h()?location.pathname+location.search+location.hash:e}function s(e){return e.replace(/\/+$/,``).replace(/^\/+/,``)}function c(e){return typeof e==`string`}function l(e){return e&&e.indexOf(`#`)>=0&&e.split(`#`).pop()||``}function u(e){var t=s(e).split(/\?(.*)?$/);return[s(t[0]),t.slice(1).join(``)]}function d(e){for(var t={},n=e.split(`&`),r=0;r<n.length;r++){var i=n[r].split(`=`);if(i[0]!==``){var a=decodeURIComponent(i[0]);t[a]?(Array.isArray(t[a])||(t[a]=[t[a]]),t[a].push(decodeURIComponent(i[1]||``))):t[a]=decodeURIComponent(i[1]||``)}}return t}function f(e,t){var n,o=u(s(e.currentLocationPath)),f=o[0],p=o[1],m=p===``?null:d(p),h=[];if(c(t.path)){if(n=`(?:/^|^)`+s(t.path).replace(r,(function(e,t,n){return h.push(n),`([^/]+)`})).replace(i,`?(?:.*)`).replace(a,`/?([^/]+|)`)+`$`,s(t.path)===``&&s(f)===``)return{url:f,queryString:p,hashString:l(e.to),route:t,data:null,params:m}}else n=t.path;var g=new RegExp(n,``),_=f.match(g);if(_){var v=c(t.path)?function(e,t){return t.length===0?null:e?e.slice(1,e.length).reduce((function(e,n,r){return e===null&&(e={}),e[t[r]]=decodeURIComponent(n),e}),null):null}(_,h):_.groups?_.groups:_.slice(1);return{url:s(f.replace(RegExp(`^`+e.instance.root),``)),queryString:p,hashString:l(e.to),route:t,data:v,params:m}}return!1}function p(){return!(typeof window>`u`||!window.history||!window.history.pushState)}function m(e,t){return e[t]===void 0||!0===e[t]}function h(){return typeof window<`u`}function g(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter((function(e){return e})).forEach((function(e){[`before`,`after`,`already`,`leave`].forEach((function(n){e[n]&&(t[n]||(t[n]=[]),t[n].push(e[n]))}))})),t}function _(e,t,n){var r=t||{},i=0;(function t(){e[i]?Array.isArray(e[i])?(e.splice.apply(e,[i,1].concat(e[i][0](r)?e[i][1]:e[i][2])),t()):e[i](r,(function(e){e===void 0||!0===e?(i+=1,t()):n&&n(r)})):n&&n(r)})()}function v(e,t){e.currentLocationPath===void 0&&(e.currentLocationPath=e.to=o(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function y(e,t){for(var n=0;n<e.instance.routes.length;n++){var r=f(e,e.instance.routes[n]);if(r&&(e.matches||=[],e.matches.push(r),e.resolveOptions.strategy===`ONE`))return void t()}t()}function ee(e,t){e.navigateOptions&&(e.navigateOptions.shouldResolve!==void 0&&console.warn(`"shouldResolve" is deprecated. Please check the documentation.`),e.navigateOptions.silent!==void 0&&console.warn(`"silent" is deprecated. Please check the documentation.`)),t()}function b(e,t){!0===e.navigateOptions.force?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}_.if=function(e,t,n){return Array.isArray(t)||(t=[t]),Array.isArray(n)||(n=[n]),[e,t,n]};var te=h(),ne=p();function re(e,t){if(m(e.navigateOptions,`updateBrowserURL`)){var n=(`/`+e.to).replace(/\/\//g,`/`),r=te&&e.resolveOptions&&!0===e.resolveOptions.hash;ne?(history[e.navigateOptions.historyAPIMethod||`pushState`](e.navigateOptions.stateObj||{},e.navigateOptions.title||``,r?`#`+n:n),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout((function(){if(!r){var t=location.hash;location.hash=``,location.hash=t}e.instance.__freezeListening=!1}),1))):te&&(window.location.href=e.to)}t()}function ie(e,t){var n=e.instance;n.lastResolved()?_(n.lastResolved().map((function(t){return function(n,r){if(t.route.hooks&&t.route.hooks.leave){var i=!1,a=e.instance.matchLocation(t.route.path,e.currentLocationPath,!1);i=t.route.path===`*`?!(e.matches&&e.matches.find((function(e){return t.route.path===e.route.path}))):!a,m(e.navigateOptions,`callHooks`)&&i?_(t.route.hooks.leave.map((function(t){return function(n,r){return t((function(t){!1===t?e.instance.__markAsClean(e):r()}),e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}})).concat([function(){return r()}])):r()}else r()}})),{},(function(){return t()})):t()}function ae(e,t){m(e.navigateOptions,`updateState`)&&e.instance._setCurrent(e.matches),t()}var oe=[function(e,t){var n=e.instance.lastResolved();if(n&&n[0]&&n[0].route===e.match.route&&n[0].url===e.match.url&&n[0].queryString===e.match.queryString)return n.forEach((function(t){t.route.hooks&&t.route.hooks.already&&m(e.navigateOptions,`callHooks`)&&t.route.hooks.already.forEach((function(t){return t(e.match)}))})),void t(!1);t()},function(e,t){e.match.route.hooks&&e.match.route.hooks.before&&m(e.navigateOptions,`callHooks`)?_(e.match.route.hooks.before.map((function(t){return function(n,r){return t((function(t){!1===t?e.instance.__markAsClean(e):r()}),e.match)}})).concat([function(){return t()}])):t()},function(e,t){m(e.navigateOptions,`callHandler`)&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()},function(e,t){e.match.route.hooks&&e.match.route.hooks.after&&m(e.navigateOptions,`callHooks`)&&e.match.route.hooks.after.forEach((function(t){return t(e.match)})),t()}],se=[ie,function(e,t){var n=e.instance._notFoundRoute;if(n){e.notFoundHandled=!0;var r=u(e.currentLocationPath),i=r[0],a=r[1],o=l(e.to);n.path=s(i);var c={url:n.path,queryString:a,hashString:o,data:null,route:n,params:a===``?null:d(a)};e.matches=[c],e.match=c}t()},_.if((function(e){return e.notFoundHandled}),oe.concat([ae]),[function(e,t){e.resolveOptions&&!1!==e.resolveOptions.noMatchWarning&&e.resolveOptions.noMatchWarning!==void 0||console.warn(`Navigo: "`+e.currentLocationPath+`" didn't match any of the registered routes.`),t()},function(e,t){e.instance._setCurrent(null),t()}])];function ce(){return(ce=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}function le(e,t){var n=0;ie(e,(function r(){n===e.matches.length?ae(e,t):_(oe,ce({},e,{match:e.matches[n]}),(function(){n+=1,r()}))}))}function ue(e){e.instance.__markAsClean(e)}function de(){return(de=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}var fe=`[data-navigo]`;function pe(e,t){var n,r=t||{strategy:`ONE`,hash:!1,noMatchWarning:!1,linksSelector:fe},i=this,a=`/`,m=null,te=[],ne=!1,ie=p(),ae=h();function oe(e){return e.indexOf(`#`)>=0&&(e=!0===r.hash?e.split(`#`)[1]||`/`:e.split(`#`)[0]),e}function ce(e){return s(a+`/`+s(e))}function pe(e,t,n,r){return e=c(e)?ce(e):e,{name:r||s(String(e)),path:e,handler:t,hooks:g(n)}}function me(e,t){if(!i.__dirty){i.__dirty=!0,e=e?s(a)+`/`+s(e):void 0;var n={instance:i,to:e,currentLocationPath:e,navigateOptions:{},resolveOptions:de({},r,t)};return _([v,y,_.if((function(e){var t=e.matches;return t&&t.length>0}),le,se)],n,ue),!!n.matches&&n.matches}i.__waiting.push((function(){return i.resolve(e,t)}))}function he(e,t){if(i.__dirty)i.__waiting.push((function(){return i.navigate(e,t)}));else{i.__dirty=!0,e=s(a)+`/`+s(e);var n={instance:i,to:e,navigateOptions:t||{},resolveOptions:t&&t.resolveOptions?t.resolveOptions:r,currentLocationPath:oe(e)};_([ee,b,y,_.if((function(e){var t=e.matches;return t&&t.length>0}),le,se),re,ue],n,ue)}}function ge(){if(ae)return(ae?[].slice.call(document.querySelectorAll(r.linksSelector||fe)):[]).forEach((function(e){e.getAttribute(`data-navigo`)!==`false`&&e.getAttribute(`target`)!==`_blank`?e.hasListenerAttached||(e.hasListenerAttached=!0,e.navigoHandler=function(t){if((t.ctrlKey||t.metaKey)&&t.target.tagName.toLowerCase()===`a`)return!1;var n=e.getAttribute(`href`);if(n==null)return!1;if(n.match(/^(http|https)/)&&typeof URL<`u`)try{var r=new URL(n);n=r.pathname+r.search}catch{}var a=function(e){if(!e)return{};var t,n=e.split(`,`),r={};return n.forEach((function(e){var n=e.split(`:`).map((function(e){return e.replace(/(^ +| +$)/g,``)}));switch(n[0]){case`historyAPIMethod`:r.historyAPIMethod=n[1];break;case`resolveOptionsStrategy`:t||={},t.strategy=n[1];break;case`resolveOptionsHash`:t||={},t.hash=n[1]===`true`;break;case`updateBrowserURL`:case`callHandler`:case`updateState`:case`force`:r[n[0]]=n[1]===`true`}})),t&&(r.resolveOptions=t),r}(e.getAttribute(`data-navigo-options`));ne||(t.preventDefault(),t.stopPropagation(),i.navigate(s(n),a))},e.addEventListener(`click`,e.navigoHandler)):e.hasListenerAttached&&e.removeEventListener(`click`,e.navigoHandler)})),i}function _e(e,t,n){var r=te.find((function(t){return t.name===e})),i=null;if(r){if(i=r.path,t)for(var o in t)i=i.replace(`:`+o,t[o]);i=i.match(/^\//)?i:`/`+i}return i&&n&&!n.includeRoot&&(i=i.replace(RegExp(`^/`+a),``)),i}function ve(e){var t=u(s(e)),r=t[0],i=t[1],a=i===``?null:d(i);return{url:r,queryString:i,hashString:l(e),route:pe(r,(function(){}),[n],r),data:null,params:a}}function ye(e,t,n){return typeof t==`string`&&(t=be(t)),t?(t.hooks[e]||(t.hooks[e]=[]),t.hooks[e].push(n),function(){t.hooks[e]=t.hooks[e].filter((function(e){return e!==n}))}):(console.warn(`Route doesn't exists: `+t),function(){})}function be(e){return typeof e==`string`?te.find((function(t){return t.name===ce(e)})):te.find((function(t){return t.handler===e}))}e?a=s(e):console.warn(`Navigo requires a root path in its constructor. If not provided will use "/" as default.`),this.root=a,this.routes=te,this.destroyed=ne,this.current=m,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=function(e){e.instance.__dirty=!1,e.instance.__waiting.length>0&&e.instance.__waiting.shift()()},this.on=function(e,t,r){var i=this;return typeof e!=`object`||e instanceof RegExp?(typeof e==`function`&&(r=t,t=e,e=a),te.push(pe(e,t,[n,r])),this):(Object.keys(e).forEach((function(t){if(typeof e[t]==`function`)i.on(t,e[t]);else{var r=e[t],a=r.uses,o=r.as,s=r.hooks;te.push(pe(t,a,[n,s],o))}})),this)},this.off=function(e){return this.routes=te=te.filter((function(t){return c(e)?s(t.path)!==s(e):typeof e==`function`?e!==t.handler:String(t.path)!==String(e)})),this},this.resolve=me,this.navigate=he,this.navigateByName=function(e,t,n){var r=_e(e,t);return r!==null&&(he(r.replace(RegExp(`^/?`+a),``),n),!0)},this.destroy=function(){this.routes=te=[],ie&&window.removeEventListener(`popstate`,this.__popstateListener),this.destroyed=ne=!0},this.notFound=function(e,t){return i._notFoundRoute=pe(`*`,e,[n,t],`__NOT_FOUND__`),this},this.updatePageLinks=ge,this.link=function(e){return`/`+a+`/`+s(e)},this.hooks=function(e){return n=e,this},this.extractGETParameters=function(e){return u(oe(e))},this.lastResolved=function(){return m},this.generate=_e,this.getLinkPath=function(e){return e.getAttribute(`href`)},this.match=function(e){var t={instance:i,currentLocationPath:e,to:e,navigateOptions:{},resolveOptions:r};return y(t,(function(){})),!!t.matches&&t.matches},this.matchLocation=function(e,t,n){t===void 0||n!==void 0&&!n||(t=ce(t));var r={instance:i,to:t,currentLocationPath:t};return v(r,(function(){})),typeof e==`string`&&(e=n===void 0||n?ce(e):e),f(r,{name:String(e),path:e,handler:function(){},hooks:{}})||!1},this.getCurrentLocation=function(){return ve(s(o(a)).replace(RegExp(`^`+a),``))},this.addBeforeHook=ye.bind(this,`before`),this.addAfterHook=ye.bind(this,`after`),this.addAlreadyHook=ye.bind(this,`already`),this.addLeaveHook=ye.bind(this,`leave`),this.getRoute=be,this._pathToMatchObject=ve,this._clean=s,this._checkForAHash=oe,this._setCurrent=function(e){return m=i.current=e},function(){ie&&(this.__popstateListener=function(){i.__freezeListening||me()},window.addEventListener(`popstate`,this.__popstateListener))}.call(this),ge.call(this)}}},t={};function n(r){if(t[r])return t[r].exports;var i=t[r]={exports:{}};return e[r](i,i.exports,n),i.exports}return n.d=function(e,t){for(var r in t)n.o(t,r)&&!n.o(e,r)&&Object.defineProperty(e,r,{enumerable:!0,get:t[r]})},n.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},n(407)}().default}))})),f=s(((e,t)=>{(function(n,r){var i={};n.PubSub?(i=n.PubSub,console.warn(`PubSub already loaded, using existing version`)):(n.PubSub=i,r(i)),typeof e==`object`?(t!==void 0&&t.exports&&(e=t.exports=i),e.PubSub=i,t.exports=e=i):typeof define==`function`&&define.amd&&define(function(){return i})})(typeof window==`object`&&window||e||global,function(e){var t={},n=-1,r=`*`;function i(e){for(var t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!0;return!1}function a(e){return function(){throw e}}function o(e,t,n){try{e(t,n)}catch(e){setTimeout(a(e),0)}}function s(e,t,n){e(t,n)}function c(e,n,r,i){var a=t[n],c=i?s:o,l;if(Object.prototype.hasOwnProperty.call(t,n))for(l in a)Object.prototype.hasOwnProperty.call(a,l)&&c(a[l],e,r)}function l(e,t,n){return function(){var i=String(e),a=i.lastIndexOf(`.`);for(c(e,e,t,n);a!==-1;)i=i.substr(0,a),a=i.lastIndexOf(`.`),c(e,i,t,n);c(e,r,t,n)}}function u(e){var n=String(e);return!!(Object.prototype.hasOwnProperty.call(t,n)&&i(t[n]))}function d(e){for(var t=String(e),n=u(t)||u(r),i=t.lastIndexOf(`.`);!n&&i!==-1;)t=t.substr(0,i),i=t.lastIndexOf(`.`),n=u(t);return n}function f(e,t,n,r){e=typeof e==`symbol`?e.toString():e;var i=l(e,t,r);return d(e)?(n===!0?i():setTimeout(i,0),!0):!1}e.publish=function(t,n){return f(t,n,!1,e.immediateExceptions)},e.publishSync=function(t,n){return f(t,n,!0,e.immediateExceptions)},e.subscribe=function(e,r){if(typeof r!=`function`)return!1;e=typeof e==`symbol`?e.toString():e,Object.prototype.hasOwnProperty.call(t,e)||(t[e]={});var i=`uid_`+String(++n);return t[e][i]=r,i},e.subscribeAll=function(t){return e.subscribe(r,t)},e.subscribeOnce=function(t,n){var r=e.subscribe(t,function(){e.unsubscribe(r),n.apply(this,arguments)});return e},e.clearAllSubscriptions=function(){t={}},e.clearSubscriptions=function(e){for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0&&delete t[n]},e.countSubscriptions=function(e){var n,r,i=0;for(n in t)if(Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0){for(r in t[n])i++;break}return i},e.getSubscriptions=function(e){var n,r=[];for(n in t)Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0&&r.push(n);return r},e.unsubscribe=function(n){var r=typeof n==`string`&&(Object.prototype.hasOwnProperty.call(t,n)||function(e){for(var n in t)if(Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0)return!0;return!1}(n)),i=!r&&typeof n==`string`,a=typeof n==`function`,o=!1,s,c,l;if(r){e.clearSubscriptions(n);return}for(s in t)if(Object.prototype.hasOwnProperty.call(t,s)){if(c=t[s],i&&c[n]){delete c[n],o=n;break}if(a)for(l in c)Object.prototype.hasOwnProperty.call(c,l)&&c[l]===n&&(delete c[l],o=!0)}return o}})})),p,m=o((()=>{p=Object.freeze({APP:`APP`,APP_READY:`APP.READY`,APP_ERROR:`APP.ERROR`,APP_SIGNOUT:`APP.SIGNOUT`,APP_AUTH:`APP.AUTH`,APP_USER_LOADED:`APP.USER.LOADED`,ROUTE_NAV:`ROUTE.NAV.GO`,ROUTE_NAV_BEFORE:`ROUTE.NAV.BEFORE`,ROUTE_NAV_AFTER:`ROUTE.NAV.AFTER`,ROUTE_NAV_ERROR:`ROUTE.NAV.ERROR`,AUTH_SIGNIN:`AUTH.SIGNIN.GO`,AUTH_SIGNIN_SUCCESS:`AUTH.SIGNIN.SUCCESS`,AUTH_SIGNIN_FAIL:`AUTH.SIGNIN.FAIL`,AUTH_SIGNUP:`AUTH.SIGNUP.GO`,AUTH_SIGNUP_SUCCESS:`AUTH.SIGNUP.SUCCESS`,AUTH_SIGNUP_FAIL:`AUTH.SIGNUP.FAIL`,AUTH_VERIFY_LINK:`AUTH.VERIFY.LINK`,AUTH_SIGNOUT:`AUTH.SIGNOUT.GO`,AUTH_SIGNOUT_SUCCESS:`AUTH.SIGNOUT.SUCCESS`,AUTH_FORGOT:`AUTH.FORGOT.GO`,AUTH_FORGOT_SUCCESS:`AUTH.FORGOT.SUCCESS`,AUTH_RESETHASH:`AUTH.RESETHASH.GO`,AUTH_RESETHASH_SUCCESS:`AUTH.RESETHASH.SUCCESS`,AUTH_RESETHASH_NAV:`AUTH.RESETHASH.NAV`,AUTH_TOKEN_EXPIRED:`AUTH.TOKEN.EXPIRED`,AUTH_TOKEN_INVALID:`AUTH.TOKEN.INVALID`,AUTH_SCOPE_LOADED:`AUTH.SCOPE.LOADED`,M5T_PRIMARY_NAV:`M5T_PRIMARY_NAV`,M5T_PRIMARY_NAV_LOGO_TAP:`M5T_PRIMARY_NAV.LOGO_TAP`,M5T_PRIMARY_NAV_HOVER:`M5T_PRIMARY_NAV.HOVER`,M5T_PRIMARY_NAV_TAP:`M5T_PRIMARY_NAV.TAP`,M5T_PRIMARY_NAV_DOUBLE_TAP:`M5T_PRIMARY_NAV.DOUBLE_TAP`,M5T_PRIMARY_NAV_LONG_TAP:`M5T_PRIMARY_NAV.LONG_TAP`,M5T_SIDE_NAV:`M5T_SIDE_NAV`,M5T_SIDE_NAV_TAP:`M5T_SIDE_NAV.TAP`,M5T_SIDE_NAV_COLLAPSE:`M5T_SIDE_NAV.COLLAPSE`,M5T_SIDE_NAV_LOGO_TAP:`M5T_SIDE_NAV.LOGO_TAP`,M5T_SIDE_NAV_ORG_SWITCH:`M5T_SIDE_NAV.ORG_SWITCH`,M5T_SIDE_NAV_FOOTER_ACTION:`M5T_SIDE_NAV.FOOTER_ACTION`,UI_LOADING_START:`UI.LOADING.START`,UI_LOADING_END:`UI.LOADING.END`,UI_TOAST:`UI.TOAST`,UI_MODAL_OPEN:`UI.MODAL.OPEN`,UI_MODAL_CLOSE:`UI.MODAL.CLOSE`,UI_THEME_CHANGED:`UI.THEME.CHANGED`,UI_WELCOME_BACK_CLICKED:`UI.WELCOME_BACK_CLICKED`,DATA_REFRESH:`DATA.REFRESH`,DATA_UPDATE:`DATA.UPDATE`,DATA_ERROR:`DATA.ERROR`,I18N:`I18N`,I18N_SET_LANG:`I18N.SET_LANG`,CONVERSATION:`CONVERSATION`,CONVERSATION_PROMPT:`CONVERSATION.PROMPT`,CONVERSATION_PROMPT_AGENT_CANVAS:`CONVERSATION.PROMPT.AGENT_CANVAS`,CONVERSATION_PROMPT_AGENT:`CONVERSATION.PROMPT.AGENT`,CONVERSATION_PROMPT_CANVAS:`CONVERSATION.PROMPT.CANVAS`,CONVERSATION_PROMPT_STAGE:`CONVERSATION.PROMPT.STAGE`,CONVERSATION_RESPONSE:`CONVERSATION.RESPONSE`,CONVERSATION_RESPONSE_CANVAS:`CONVERSATION.RESPONSE.CANVAS`,CONVERSATION_RESPONSE_WORKFLOW:`CONVERSATION.RESPONSE.WORKFLOW`,CANVAS:`CANVAS`,CANVAS_DO_SCROLL:`CANVAS.DO.SCROLL`,MESSAGE:`MESSAGE`,MESSAGE_CREATE:`MESSAGE.CREATE`,MESSAGE_CREATED:`MESSAGE.CREATED`,MESSAGE_EDIT:`MESSAGE.EDIT`,MESSAGE_UPDATED:`MESSAGE.UPDATED`,MESSAGE_DELETE:`MESSAGE.DELETE`,MESSAGE_DELETED:`MESSAGE.DELETED`,MESSAGE_REFRESH:`MESSAGE.REFRESH`})}));function h(e,t=null){if(e in v)return v[e];if(typeof process<`u`&&{}[e]){let t={}[e];return t===`true`?!0:t===`false`?!1:isNaN(t)?t:Number(t)}if({BASE_URL:`./`,DEV:!1,MODE:`production`,PROD:!0,SSR:!1,VITE_API_BASE_URL:`http://localhost:3333`}[e]){let t={BASE_URL:`./`,DEV:!1,MODE:`production`,PROD:!0,SSR:!1,VITE_API_BASE_URL:`http://localhost:3333`}[e];return t===`true`?!0:t===`false`?!1:isNaN(t)?t:Number(t)}return t}function g(e){return h(e,!1)===!0}function _(){return{...v}}var v,y=o((()=>{v=Object.freeze({FF_SSE_LS_SESSION_USER:`mvv_session_user`,FF_SSE_LS_TOKEN:`mvv`,FF_SSE_LS_THEME:`mvv_theme`,FF_SSE_UI_DARK_MODE:!0,FF_SSE_UI_ANIMATIONS:!0,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:`main_carousel_nav`,FF_CLIENT_LS_SESSION_ENTITY:`sse_entity`,FF_CLIENT_LS_DEEP_LINK:`sse_deeplink`,FF_CLIENT_ROUTE_SIGNIN:`signin_route`,FF_CLIENT_ROUTE_SIGNUP:`signup_route`,FF_CLIENT_ROUTE_HOME:`home_route`,FF_CLIENT_ROUTE_RESET_HASH:`resethash_route`,FF_CLIENT_ROUTE_RESET_FORGOT:`resetforgot_route`,FF_CLIENT_ROUTE_SIGNOUT:`signout_route`,FF_CLIENT_ROUTE_ERROR:`error_route`,FF_CLIENT_ROUTE_VERF_LINK:`verf_link_route`,FF_CLIENT_ROUTE_OFFLINE:`offline_route`,FF_CLIENT_PROTECTED_ROUTES:[`home_route`,`resethash_route`,`signout_route`,`user_management_route`],FF_CLIENT_ENDPOINT_SIGNIN:`/m5t/v5/acctEntity/signin`,FF_CLIENT_ENDPOINT_SIGNOUT:`/m5t/v5/acctEntity/signout`,FF_CLIENT_ENDPOINT_SIGNUP:`/m5t/v5/acctEntity/`,FF_CLIENT_ENDPOINT_RESET_HASH:`/m5t/v5/acctEntity/resetHash`,FF_CLIENT_ENDPOINT_RESET_FORGOT:`/m5t/v5/acctEntity/resetforgot`,FF_CLIENT_ENDPOINT_PING:`/ping`,FF_CLIENT_ENDPOINT_METER:`/m5t/v5/coreMeter/`,FF_CLIENT_METER_DEEP_LINK:`deep_link_access`,FF_CLIENT_METER_SIGNOUT_CLIENT:`signout_client_initiated`,FF_CLIENT_METER_SIGNOUT_SERVER:`signout_server_initiated`,FF_CLIENT_METER_PING_SUCCESS:`ping_auth_success`,FF_CLIENT_METER_PING_FAILURE:`ping_auth_failure`,FF_SSE_I18N_PRODUCT:`SSE`,FF_SSE_I18N_WHITELABEL:`M5T`,FF_SSE_I18N_LANG:`en`,FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:`mvv_user_lang`,FF_SSE_LS_WHITELABEL:`mvv_whitelabel`,FF_API_RATELIMIT_SIGNIN_ENFORCE:!0,FF_API_RATELIMIT_SIGNIN_IP_LIMIT:20,FF_API_RATELIMIT_SIGNIN_EMAIL_LIMIT:10,FF_API_RATELIMIT_FORGOT_ENFORCE:!0,FF_API_RATELIMIT_FORGOT_IP_LIMIT:15,FF_API_RATELIMIT_FORGOT_EMAIL_LIMIT:5,FF_API_RATELIMIT_CAPTURE_ENFORCE:!0,FF_API_RATELIMIT_CAPTURE_LIMIT:30,FF_API_RATELIMIT_EVENT_ENFORCE:!0,FF_API_RATELIMIT_EVENT_LIMIT:600,FF_API_RATELIMIT_CSP_PING_ENFORCE:!0,FF_API_RATELIMIT_CSP_PING_LIMIT:30,FF_API_RATELIMIT_WEBAUTHN_AUTH_ENFORCE:!0,FF_API_RATELIMIT_WEBAUTHN_AUTH_IP_LIMIT:20,FF_API_RATELIMIT_INTEGRATIONS_ENFORCE:!0,FF_API_RATELIMIT_INTEGRATIONS_LIMIT:60,FF_API_RATELIMIT_QUESTIONNAIRE_ENFORCE:!0,FF_API_RATELIMIT_QUESTIONNAIRE_LIMIT:30,FF_API_RATELIMIT_DELIVERABLE_ENFORCE:!0,FF_API_RATELIMIT_DELIVERABLE_LIMIT:30,FF_API_RATELIMIT_PAIRING_ENFORCE:!0,FF_API_RATELIMIT_PAIRING_LIMIT:20,FF_API_RATELIMIT_SITE_OPS_ENFORCE:!0,FF_API_RATELIMIT_SITE_OPS_LIMIT:120,FF_API_RATELIMIT_AUTHENTICATED_ENFORCE:!0,FF_API_RATELIMIT_AUTHENTICATED_LIMIT:600,FF_API_MAGNET_REQUIRE_ORIGIN_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_ENFORCE:!0,FF_API_RATELIMIT_GLOBAL_LIMIT:2e3}),typeof module<`u`&&module.exports&&(module.exports={FEATURE_FLAGS:v,getFlag:h,isEnabled:g,getAllFlags:_})})),ee=u(d(),1),b=u(f(),1);m(),y();var te={success:{border:`var(--color-success, #009473)`,bg:`var(--color-success-soft, rgba(0,148,115,0.10))`,icon:`check_circle`},danger:{border:`var(--color-danger, #DD4124)`,bg:`var(--color-danger-soft, rgba(221,65,36,0.09))`,icon:`error`},error:{border:`var(--color-danger, #DD4124)`,bg:`var(--color-danger-soft, rgba(221,65,36,0.09))`,icon:`error`},warning:{border:`var(--color-warning, #D97706)`,bg:`var(--color-warning-soft, #FEF3C7)`,icon:`warning`},info:{border:`var(--color-info, #0D9488)`,bg:`var(--color-info-soft, #CCFBF1)`,icon:`info`}},ne=4500,re=220,ie=null,ae=!1;function oe(){if(ae)return;let e=document.createElement(`style`);e.id=`m5t-toast-styles`,e.textContent=`
  ...
  </div>`}var un=`<div class="m5t-notif-skel"><span></span><span></span><span></span></div>`.repeat(3),dn=e=>e.dataset.open===`true`,fn=(e,t)=>{e.dataset.open=t?`true`:`false`};function pn(e){let t=document.getElementById(`m5t-notif-bell`);if(t&&(t.hidden=!e),!e){let e=document.getElementById(`m5t-notif-panel`);e&&fn(e,!1)}}var mn=14,hn=null,gn=null;function _n(e){if(typeof ResizeObserver>`u`||!e)return;let t=document.getElementById(`m5t-notif-bell`),n=document.getElementById(`m5t-notif-bell-btn`);if(!t||!n)return;let r=()=>{let r=e.hidden?null:e.querySelector(`.ocb-btn`);if(!r){t.style.top=`${mn}px`;return}let i=n.getBoundingClientRect().height;if(!i)return;let a=r.getBoundingClientRect();t.style.top=`${Math.round(a.top+(a.height-i)/2)}px`};hn?.disconnect(),hn=new ResizeObserver(r),hn.observe(e),gn?.disconnect(),gn=new MutationObserver(r),gn.observe(t,{attributes:!0,attributeFilter:[`hidden`]}),r()}var vn=null,yn=null,bn=null;function xn(){let e=document.getElementById(`m5t-notif-bell-btn`),t=document.getElementById(`m5t-notif-badge`),n=document.getElementById(`m5t-notif-panel`);if(!e||!t||!n)return;let r=e=>{t.textContent=e>99?`99+`:String(e),t.hidden=!e},i=async()=>{try{let e=await fetch(`${rn()}/m5t/v5/notifications/unread-count`),t=await e.json().catch(()=>({}));e.ok&&t.ok&&r(t.count||0)}catch{}},a=e=>{if(e.length>=50){i();return}r(e.filter(e=>!e.read).length)},o=(e=``)=>`<div class="m5t-notif-head">Notifications${e?`<span class="m5t-notif-head__actions">${e}</span>`:``}</div>`,s=()=>{n.querySelectorAll(`.m5t-notif-item, .m5t-notif-empty`).forEach(e=>e.remove()),n.querySelector(`.m5t-notif-head__actions`)?.remove(),n.insertAdjacentHTML(`beforeend`,`<div class="m5t-notif-empty">You’re all caught up.</div>`)},c=async()=>{n.innerHTML=o()+un;try{let e=await fetch(`${rn()}/m5t/v5/notifications`),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error();let r=t.notifications||[],i=[r.some(e=>!e.read)?`<button class="m5t-notif-markall" type="button">Mark all read</button>`:``,r.length?`<button class="m5t-notif-clearall" type="button">Clear all</button>`:``].join(``);n.innerHTML=o(i)+(r.length?r.map(ln).join(``):`<div class="m5t-notif-empty">You’re all caught up.</div>`),en(n,{rowSelector:`.m5t-notif-item`,noun:`notifications`}),a(r)}catch{n.innerHTML=o()+`<div class="m5t-notif-empty">Could not load. Try again.</div>`}},l=()=>{fn(n,!1),e.setAttribute(`aria-expanded`,`false`)},u=async()=>{fn(n,!0),e.setAttribute(`aria-expanded`,`true`),await c()};e.addEventListener(`click`,e=>{e.stopPropagation(),dn(n)?l():u()}),bn&&document.removeEventListener(`visibilitychange`,bn),bn=()=>{document.visibilityState===`visible`&&i()},document.addEventListener(`visibilitychange`,bn),yn&&document.removeEventListener(`click`,yn),yn=t=>{dn(n)&&!n.contains(t.target)&&t.target!==e&&l()},document.addEventListener(`click`,yn),document.addEventListener(`keydown`,t=>{t.key===`Escape`&&dn(n)&&(l(),e.focus())}),n.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-dismiss]`);if(t){e.preventDefault(),e.stopPropagation();let r=t.closest(`.m5t-notif-item`),a=t.dataset.dismiss,o=r?.dataset.read===`false`;r?.setAttribute(`data-leaving`,`true`);try{await fetch(`${rn()}/m5t/v5/notifications/${encodeURIComponent(a)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:`DISMISSED`})})}catch{}setTimeout(()=>{r?.remove(),n.querySelector(`.m5t-notif-item`)||s()},180),o&&i();return}let r=e.target.closest(`.m5t-notif-clearall`);if(r){e.preventDefault(),r.disabled=!0,n.querySelectorAll(`.m5t-notif-item`).forEach(e=>e.setAttribute(`data-leaving`,`true`));try{await fetch(`${rn()}/m5t/v5/notifications/dismiss-all`,{method:`PATCH`})}catch{}setTimeout(s,180),i();return}let a=e.target.closest(`.m5t-notif-item`);if(a&&a.dataset.read===`false`){let e=a.dataset.guid;a.dataset.read=`true`;try{await fetch(`${rn()}/m5t/v5/notifications/${encodeURIComponent(e)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({read:!0})}),i()}catch{}return}let o=e.target.closest(`.m5t-notif-markall`);if(o){e.preventDefault(),n.querySelectorAll(`.m5t-notif-item`).forEach(e=>{e.dataset.read=`true`}),o.remove();try{await fetch(`${rn()}/m5t/v5/notifications/read-all`,{method:`PATCH`})}catch{}i()}}),i(),clearInterval(vn),vn=setInterval(i,sn)}function Sn(){return g(`FF_SSE_UI_DARK_MODE`)}function Cn(e=Sn()){return e&&localStorage.getItem(v.FF_SSE_LS_THEME)===`dark`?`dark`:`light`}function wn(e=g(`FF_SSE_UI_ANIMATIONS`)){return!e}function Tn(e,t=Sn()){!e||t||e.shadowRoot?.querySelector(`.footer-action[data-action="theme"]`)?.remove()}var En=o((()=>{y()}));function Dn(e){document.documentElement.setAttribute(`data-theme`,e)}function On(){Dn(Cn())}function kn(){return document.documentElement.getAttribute(`data-theme`)===`dark`?`dark`:`light`}function An(e,{quiet:t=!1}={}){if(!Sn())return;let n=e===`dark`?`dark`:`light`;n!==kn()&&(Dn(n),localStorage.setItem(v.FF_SSE_LS_THEME,n),t||Mn.default.publish(p.UI_TOAST,{message:n===`dark`?`Dark mode on`:`Dark mode off`,type:`info`}),Mn.default.publish(p.UI_THEME_CHANGED,{theme:n}))}function jn(){An(kn()===`dark`?`light`:`dark`)}var Mn,Nn=o((()=>{Mn=u(f(),1),m(),y(),En()})),Pn=c({default:()=>Bn,init:()=>Rn,render:()=>Ln});function Fn(){if(zn)return;let e=document.createElement(`style`);e.id=`m5t-accept-invite-styles`,e.textContent=`
    .accept-invite-page {
  ...
  `,document.head.appendChild(e),zn=!0}function In(){let e=new URLSearchParams(window.location.search||``),t=e.get(`uid`)||``,n=e.get(`token`)||``;if(!t||!n){let e=window.location.hash||``,r=e.includes(`?`)?e.slice(e.indexOf(`?`)+1):``,i=new URLSearchParams(r);if(t=t||i.get(`uid`)||``,n=n||i.get(`token`)||``,!t||!n){let r=e.replace(/^#\/?/,``).split(`?`)[0].split(`/`).filter(Boolean);t=t||r[1]||``,n=n||r[2]||``}}try{return{uid:decodeURIComponent(t),token:decodeURIComponent(n)}}catch{return{uid:t,token:n}}}function Ln(){return Fn(),`
    ...
    <a class="auth-cobrand${t?` auth-cobrand--light`:``}" href="${Qn}"
      ...
      <img class="auth-cobrand__logo" src="${t?Wn:Hn}"
           alt="Mach Five Marketing" height="26" loading="lazy" />
    </a>`}var Qn,$n,er,tr=o((()=>{Un(),Gn(),qn(),Yn(),Qn=`https://www.machfivemarketing.com`,$n=Jn,er=Kn}));function D(e){if(!e)return``;try{return new Date(e).toLocaleString([],{dateStyle:`medium`,timeStyle:`short`})}catch{return String(e)}}function nr(e,t={}){let n=t[e.id];if(e.type===`checkbox_group`){let e=Array.isArray(n)?n:[];return e.length?lr(e.join(`, `)):``}return n?lr(n):``}function rr(e,{emptyLabel:t=`(blank)`,renderAnswer:n=null}={}){let r=e?.questionnaire?.sections||[],i=e?.answers||{};return r.length?r.map(e=>`
    <div class="qm-section">
      <h3>${lr(e.title)}</h3>
      ${(e.questions||[]).map(e=>`
        <div class="qm-qa" data-question-id="${lr(e.id)}" data-question-type="${lr(e.type)}">
          <div class="qm-qa__q">${lr(e.label)}</div>
          <div class="qm-qa__a">${n?n(e,i):nr(e,i)||`<span class="qm-qa__a--empty">${lr(t)}</span>`}</div>
        </div>`).join(``)}
      ...
      <label><input type="checkbox" value="${lr(e)}" ${t.includes(e)?`checked`:``}/> ${lr(e)}</label>`).join(``)}</div>`}return e.type===`textarea`?`<textarea>${lr(n||``)}</textarea>`:`<input type="text" value="${lr(n||``)}" />`}function ar(e){let t={};return e&&e.querySelectorAll(`[data-question-id]`).forEach(e=>{let n=e.dataset.questionId;if(e.dataset.questionType===`checkbox_group`){let r=[...e.querySelectorAll(`input[type="checkbox"]:checked`)].map(e=>e.value);r.length&&(t[n]=r)}else{let r=(e.querySelector(`input,textarea`)?.value||``).trim();r&&(t[n]=r)}}),t}function or(e){let t=e?.recipient_email?`<p class="qm-recipient">Sent to ${lr(e.recipient_email)}</p>`:``,n=e?.last_edited_tz?`<p class="qm-edited-marker">Last edited by ${lr(e.last_edited_by_email||`a team member`)} on ${lr(D(e.last_edited_tz))}</p>`:``,r=e?.client_edited_tz?`<p class="qm-edited-marker">Updated by the client on ${lr(D(e.client_edited_tz))}</p>`:``;return t+n+r}function sr(){if(ur)return;let e=document.createElement(`style`);e.id=`m5t-questionnaire-answer-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),ur=!0}var cr,lr,ur,dr=o((()=>{cr={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},lr=e=>String(e??``).replace(/[&<>"']/g,e=>cr[e]),ur=!1})),fr,pr=o((()=>{fr=``+new URL(`auth-hero-sketch.jpg`,import.meta.url).href})),mr=c({default:()=>Dr,init:()=>br,render:()=>yr});function hr(){if(Er)return;let e=document.createElement(`style`);e.id=`m5t-questionnaire-fill-styles`,e.textContent=`
    .qf-page {
  ...
  `,document.head.appendChild(e),sr(),Er=!0}function gr(){return w.getConfig?.().BASE_URL||``}function _r(e){let t=`qf-${e.id}`;if(e.type===`checkbox_group`){let n=Array.isArray(e.options)?e.options:[];return`
    ...
    </div>`}function O(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}function vr(e,t,n){return`
    <div class="qf-page"><div class="qf-card"><div class="qf-state">
      <span class="material-symbols-outlined">${e}</span>
      <h1>${O(t)}</h1>
      <p class="qf-sub">${O(n)}</p>
    </div></div></div>`}function yr(){return hr(),`<div id="qf-root">${vr(`hourglass_top`,`Loading your questionnaire…`,`One moment.`)}</div>`}async function br(){let e=document.getElementById(`qf-root`);if(!e)return;let t=he();if(!t){e.innerHTML=vr(`error`,`Invalid link`,`This link is missing required information. Please use the link exactly as sent.`);return}let n;try{let r=await fetch(`${gr()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(t.guid)}?token=${encodeURIComponent(t.token)}`),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok){e.innerHTML=vr(`error`,`Cannot open this questionnaire`,r.status===404?i.error||`This link is invalid or has expired.`:`Something went wrong loading your questionnaire. Please try again shortly.`);return}n=i.data}catch(t){console.error(`[questionnaire-fill] load error:`,t),e.innerHTML=vr(`wifi_off`,`Connection problem`,`Could not reach the server. Please check your connection and try again.`);return}let r=xr(n);if(r===`locked`){Cr(e,n);return}wr(e,n,t,r)}function xr(e){return e.status===`SUBMITTED`?(e.editability||{editable:!e.locked_tz}).editable?`edit`:`locked`:`fill`}function Sr(e){let t=e.editability||{};return t.reason===`finalized`?`Your account manager has finalised these answers, so they can no longer be changed here.`:`Answers can be changed for 14 days after they are submitted.${t.deadline?` The window closed on ${D(t.deadline)}.`:``}`}function Cr(e,t){e.innerHTML=`
    <div class="qf-page"><div class="qf-card">
      ...
      <div class="qf-note qf-note--locked">
        ...
        <span>${O(Sr(t))} To change anything now, contact your account manager.</span>
      </div>
      ${or(t)}
      ${rr(t,{emptyLabel:`Left blank`})}
    </div></div>`}function wr(e,t,n,r){let i=r===`edit`,a=t.questionnaire?.sections||[],o=t.answers||{},s=t.editability?.deadline,c=i?`Change anything you need to, then save. Everything you sent before is already filled in.`:`Answer what applies. If a question doesn't apply to your business, leave it blank.`,l=i?`<div class="qf-note">
    ...
    </div></div></div>`,document.getElementById(`qf-again`)?.addEventListener(`click`,()=>{br()})}var Er,Dr,Or=o((()=>{T(),ge(),tr(),dr(),pr(),Er=!1,Dr={render:yr,init:br}}));function kr(e){return e&&typeof e.repeat==`string`&&e.repeat?e.repeat:null}function Ar(e){let t=kr(e);return t?(e.questions||[]).filter(e=>e.group===`${t}1`):[]}function jr(e,t,n){return(e||[]).map(e=>({...e,id:e.id.replace(`_${t}1_`,`_${t}${n}_`),group:`${t}${n}`,label:String(e.label||``).replace(/\b1\b/,String(n))}))}function Mr(e,t){return RegExp(`^${Fr(e).replace(`_${t}1_`,`_${t}(\\d+)_`)}$`)}function Nr(e,...t){let n=kr(e);if(!n)return 0;let r=Ar(e).filter(e=>e.id&&e.id.includes(`_${n}1_`)).map(e=>Mr(e.id,n)),i=1;for(let e of t)for(let t of Object.keys(e||{}))for(let e of r){let n=t.match(e);n&&(i=Math.max(i,parseInt(n[1],10)))}return Math.min(i,Ir)}function Pr(e,...t){return(Array.isArray(e)?e:[]).map(e=>{let n=kr(e);if(!n)return e;let r=Ar(e);if(!r.length)return e;let i=(e.questions||[]).filter(e=>e.group!==`${n}1`),a=Nr(e,...t),o=[];for(let e=1;e<=a;e++)o.push(...jr(r,n,e));return{...e,questions:[...o,...i]}})}var Fr,Ir,Lr=o((()=>{Fr=e=>e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),Ir=200})),Rr=c({default:()=>ri,init:()=>Jr,initPreview:()=>ei,render:()=>qr});function zr(){if(ti)return;let e=document.createElement(`style`);e.id=`m5t-deliverable-fill-styles`,e.textContent=`
    .dlf-page {
      min-height: 100vh; padding: 32px 20px 64px; position: relative;
  ...
  `,document.head.appendChild(e),sr(),ti=!0}function Br(){return w.getConfig?.().BASE_URL||``}function k(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}function Vr(e,t){let n=t?.[e.id];return Array.isArray(n)?n.length>0:!!(n&&String(n).trim())}function Hr(e,t){let n=(e.questions||[]).filter(e=>ni(e)&&Vr(e,t));return n.length?`<div class="dlf-plan">${n.map(e=>`
    <div class="dlf-plan__item">
      <div class="dlf-plan__label">${k(e.label)}</div>
      <div class="dlf-plan__value">${nr(e,t)}</div>
    </div>`).join(``)}</div>`:``}function Ur(e){let t=`dlf-${e.id}`;if(e.type===`checkbox_group`){let n=Array.isArray(e.options)?e.options:[];return`
    ...
    <div class="dlf-field" data-question-id="${e.id}" data-question-type="text">
      ...
      ${e.help?`<p class="dlf-help">${k(e.help)}</p>`:``}
      <input type="text" id="${t}" />
    </div>`}function Wr(e,t){return`
    <div class="qm-qa">
      <div class="qm-qa__q">${k(e.label)}</div>
      <div class="qm-qa__a">${nr(e,t)||`<span class="qm-qa__a--empty">Left blank</span>`}</div>
    </div>`}function Gr(e,t,{readOnly:n=!1,answers:r={}}={}){let i=(e.questions||[]).filter(e=>!ni(e)),a=Hr(e,t),o=a&&i.length?`<p class="dlf-review-label">Your review</p>`:``,s=i.map(e=>n?Wr(e,r):Ur(e)).join(``);return`
    ...
    </div></div></div>`}function qr(){return zr(),`<div id="dlf-root">${Kr(`hourglass_top`,`Loading your plan…`,`One moment.`)}</div>`}async function Jr(){let e=document.getElementById(`dlf-root`);if(!e)return;let t=ve();if(!t){e.innerHTML=Kr(`error`,`Invalid link`,`This link is missing required information. Please use the link exactly as sent.`);return}let n;try{let r=await fetch(`${Br()}/m5t/v5/m5mDeliverable/public/${encodeURIComponent(t.guid)}?token=${encodeURIComponent(t.token)}`),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok){e.innerHTML=Kr(`error`,`Cannot open this plan`,r.status===404?i.error||`This link is invalid or has expired.`:`Something went wrong loading your plan. Please try again shortly.`);return}n=i.data}catch(t){console.error(`[deliverable-fill] load error:`,t),e.innerHTML=Kr(`wifi_off`,`Connection problem`,`Could not reach the server. Please check your connection and try again.`);return}let r=Yr(n);if(r===`locked`){Zr(e,n);return}Qr(e,n,t,r)}function Yr(e){return e.status===`SUBMITTED`?(e.editability||{editable:!e.locked_tz}).editable?`edit`:`locked`:`fill`}function Xr(e){let t=e.editability||{};return t.reason===`finalized`?`Your account manager has finalised this plan, so the review can no longer be changed here.`:`A review can be changed for 14 days after it is submitted.${t.deadline?` The window closed on ${D(t.deadline)}.`:``}`}function Zr(e,t){let n=Pr(t.template?.sections||[],t.content,t.answers);e.innerHTML=`
    <div class="dlf-page"><div class="dlf-card">
      <img class="dlf-brand" src="${er}" alt="Mach Five Marketing" height="34" />
      ...
      <div class="dlf-note dlf-note--locked">
        <span class="material-symbols-outlined" aria-hidden="true">lock</span>
        <span>${k(Xr(t))} To change anything now, contact your account manager.</span>
      </div>
      ${n.map(e=>`
        <div class="dlf-section">
          <h2>${k(e.title)}</h2>
          ${Gr(e,t.content||{},{readOnly:!0,answers:t.answers||{}})}
        </div>`).join(``)}
    </div></div>`}function Qr(e,t,n,r){let i=r===`edit`,a=r===`preview`,o=Pr(t.template?.sections||[],t.content,t.answers),s=t.answers||{},c=t.content||{},l=t.editability?.deadline,u=i?`Change anything you need to, then save. Everything you sent before is already filled in.`:`Review each section and mark it Approved, or note what you want changed. Sign at the end. Nothing launches before your sign-off.`,d=a?`<div class="dlf-note">
         <span class="material-symbols-outlined" aria-hidden="true">visibility</span>
         <span>Preview. This is what your client sees. Nothing on this page saves or sends.</span>
       </div>`:i?`<div class="dlf-note">
           <span class="material-symbols-outlined" aria-hidden="true">edit_note</span>
           <span>You already submitted this${t.submitted_tz?` on ${k(D(t.submitted_tz))}`:``}.${l?` You can make changes until <strong>${k(D(l))}</strong>.`:``}</span>
         </div>`:``;e.innerHTML=`
    <div class="dlf-page"><div class="dlf-card">
      <img class="dlf-brand" src="${er}" alt="Mach Five Marketing" height="34" />
      <h1>${k(t.template?.name||`Your Plan`)}</h1>
      <p class="dlf-sub">${k(u)}</p>
      ${d}
      <div class="dlf-progress">
        ...
        <div class="dlf-dots" role="group" aria-label="Sections">
          ${o.map((e,t)=>`<button type="button" class="dlf-dot" data-step="${t}" aria-label="${k(e.title)}"></button>`).join(``)}
        </div>
      </div>
      <form id="dlf-form" novalidate>
        ...
        <div class="dlf-nav">
          ...
          ${a?``:`<button class="dlf-btn" type="submit" id="dlf-submit">${i?`Save changes`:`Submit review`}</button>`}
        </div>
        <p class="dlf-msg" id="dlf-msg" role="status"></p>
      </form>
    </div></div>`;let f=[...e.querySelectorAll(`.dlf-section[data-step]`)],p=[...e.querySelectorAll(`.dlf-dot`)],m=document.getElementById(`dlf-back`),h=document.getElementById(`dlf-next`),g=document.getElementById(`dlf-submit`),_=document.getElementById(`dlf-progress-label`),v=0;function y(t,n=1){v=Math.max(0,Math.min(o.length-1,t)),f.forEach((e,t)=>{e.hidden=t!==v,e.classList.remove(`dlf-enter`)});let r=f[v];r&&(r.style.setProperty(`--dlf-dx`,`${n>=0?14:-14}px`),r.offsetWidth,r.classList.add(`dlf-enter`)),p.forEach((e,t)=>{t===v?e.setAttribute(`aria-current`,`step`):e.removeAttribute(`aria-current`)}),_&&(_.textContent=`Section ${v+1} of ${o.length}`),m.style.visibility=v===0?`hidden`:``,h.style.display=v===o.length-1?`none`:``,g&&(g.style.display=v===o.length-1?``:`none`),e.querySelector(`.dlf-card`)?.scrollIntoView({block:`start`})}if(m.addEventListener(`click`,()=>y(v-1,-1)),h.addEventListener(`click`,()=>y(v+1,1)),p.forEach(e=>e.addEventListener(`click`,()=>{let t=Number(e.dataset.step)||0;y(t,t>=v?1:-1)})),y(0),e.querySelectorAll(`[data-question-id]`).forEach(e=>{let t=e.dataset.questionId,n=e.dataset.questionType,r=s[t];if(r!=null){if(n===`checkbox_group`){let t=Array.isArray(r)?r:[];e.querySelectorAll(`input[type="checkbox"]`).forEach(e=>{e.checked=t.includes(e.value)})}else{let t=e.querySelector(`input,textarea`);t&&(t.value=r)}}}),a)return;let ee=document.getElementById(`dlf-form`),b=document.getElementById(`dlf-submit`),te=document.getElementById(`dlf-msg`),ne=(e,t=`error`)=>{te.textContent=e,te.className=`dlf-msg ${t}`};ee.addEventListener(`submit`,async r=>{r.preventDefault();let a=ar(e),o=`${Br()}/m5t/v5/m5mDeliverable/public/${encodeURIComponent(n.guid)}`,s=i?`${o}?token=${encodeURIComponent(n.token)}`:`${o}/submit?token=${encodeURIComponent(n.token)}`;b.disabled=!0,ne(i?`Saving…`:`Submitting…`,`ok`);let c;try{c=await fetch(s,{method:i?`PUT`:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(i?{answers:a}:{answers:a,content_fingerprint:t.content_fingerprint||``})});let n=await c.json().catch(()=>({}));if(!c.ok||!n.ok){if(c.status===423){ne(n.error||`This review is now locked.`,`error`),await Jr();return}if(c.status===409&&n.reason===`content_changed`){await Jr();let e=document.getElementById(`dlf-msg`);e&&(e.textContent=n.error||`This plan was updated after you opened it. Review the latest version and submit again.`,e.className=`dlf-msg error`);return}let e=c.status===409?i?`This plan is not open for changes.`:`This plan has already been submitted.`:c.status===404?`This link is invalid or has expired.`:n.error||`Could not ${i?`save`:`submit`} (HTTP ${c.status}).`;ne(e),b.disabled=!1;return}$r(e,i,n.data?.editability?.deadline)}catch(e){console.error(`[deliverable-fill] ${i?`edit`:`submit`} error:`,e),ne(`Something went wrong. Please try again.`),b.disabled=!1}})}function $r(e,t,n){let r=n?` until ${D(n)}`:``;e.innerHTML=`
    <div class="dlf-page"><div class="dlf-card"><div class="dlf-state">
      <span class="material-symbols-outlined">check_circle</span>
      <h1>${t?`Changes saved`:`Thank you`}</h1>
    ...
    </div></div></div>`,document.getElementById(`dlf-again`)?.addEventListener(`click`,()=>{Jr()})}async function ei(e){let t=document.getElementById(`dlf-root`);if(!t)return;let n;try{let r=await fetch(`${Br()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}`),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok){t.innerHTML=Kr(`error`,`Cannot preview this deliverable`,i.error||`It may be out of your scope, or deleted.`);return}n=i.data}catch(e){console.error(`[deliverable-preview] load error:`,e),t.innerHTML=Kr(`wifi_off`,`Connection problem`,`Could not reach the server. Please check your connection and try again.`);return}Qr(t,{...n,answers:{}},null,`preview`)}var ti,ni,ri,ii=o((()=>{T(),ye(),tr(),dr(),Lr(),pr(),ti=!1,ni=e=>e.audience===`am`,ri={render:qr,init:Jr,initPreview:ei}})),ai=c({init:()=>si,render:()=>oi});function oi(){return`
    <div class="auth-container splash">
      <div class="auth-left">
        <div class="splash-content">
          <h1 class="splash-mark"><img src="${$n}" alt="Mach Five Magnet" height="88" /></h1>
  ...
  `}function Di(){console.log(`[SignupRoute] Initialized`);let e=document.getElementById(`signupForm`),t=e.querySelector(`button[type="submit"]`);Oi(`togglePassword`,`password`,`eyeIcon`),Oi(`toggleConfirmPassword`,`confirmPassword`,`eyeIconConfirm`),document.querySelector(`.auth-switch a[href="#/signin"]`)?.addEventListener(`click`,e=>{e.preventDefault(),console.log(`[SignupRoute] Sign in link clicked - navigating to signin`),Mi.default.publish(p.ROUTE_NAV,{route:`signin`})}),e.addEventListener(`submit`,async e=>{e.preventDefault();let n=document.getElementById(`first`).value.trim(),r=document.getElementById(`last`).value.trim(),i=document.getElementById(`email`).value.trim(),a=document.getElementById(`company`).value.trim(),o=document.getElementById(`phone`).value.trim(),s=document.getElementById(`password`).value,c=document.getElementById(`confirmPassword`).value,l=document.getElementById(`first`),u=document.getElementById(`last`),d=document.getElementById(`email`),f=document.getElementById(`password`),p=document.getElementById(`confirmPassword`);if(!ki(n,l,E.get(`validation_first_name_required`))||!ki(r,u,E.get(`validation_last_name_required`))||!di(i,d)||!Ai(s,f))return;if(s!==c){ui(p,E.get(`validation_password_mismatch`));return}let m=document.getElementById(`acceptTerms`);if(!m.checked){ui(m,`Please accept the Terms of Service and Privacy Policy to continue.`);return}t.disabled=!0,t.textContent=E.get(`loading_creating_account`),await ji(n,r,i,a,o,s)})}function Oi(e,t,n){let r=document.getElementById(e),i=document.getElementById(t),a=document.getElementById(n);!r||!i||!a||r.addEventListener(`click`,()=>{let e=i.type===`password`;i.type=e?`text`:`password`,e?a.innerHTML=`
      ...
      `:a.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function ki(e,t,n){return e?!0:(ui(t,n),!1)}function Ai(e,t){if(!e)return ui(t,E.get(`validation_password_required`)),!1;let n=Si(e);return n.length>0?(ui(t,Ci(n)),!1):!0}async function ji(e,t,n,r,i,a){let o=document.querySelector(`button[type="submit"]`);try{let s={email:n,password:a,first:e,last:t};r&&(s.company=r),i&&(s.phone=i),s.terms_accepted=!0,s.legal_version=Ni;let c=await w.doSignup(s);if(c.ok)Mi.default.publish(p.AUTH_SIGNUP_SUCCESS,{email:n}),typeof mvvLegit<`u`&&mvvLegit.doUNVERF();else{let e=c.error||c.message||E.get(`error_signup_failed`);typeof neodigmToast<`u`&&neodigmToast.q(e,`danger`),o.disabled=!1,o.textContent=(E.get(`create_account`)||`Create account`).toUpperCase(),Mi.default.publish(p.AUTH_SIGNUP_FAIL,{message:e})}}catch(e){console.error(`[SignupRoute] Sign up error:`,e),typeof neodigmToast<`u`&&neodigmToast.q(e.message||E.get(`error_network`),`danger`),o.disabled=!1,o.textContent=(E.get(`create_account`)||`Create account`).toUpperCase(),Mi.default.publish(p.AUTH_SIGNUP_FAIL,{message:e.message})}}var Mi,Ni,Pi=o((()=>{Mi=u(f(),1),tr(),m(),T(),wi(),Wt(),pi(),Ni=`2026-07-15`})),Fi=c({init:()=>Li,render:()=>Ii});function Ii(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Xn()}
  ...
  `}function Qi(){console.log(`[ResethashRoute] Initialized`);let e=document.getElementById(`resethash-form`),t=e.querySelector(`button[type="submit"]`);$i(`toggleNewPassword`,`new-password`,`eyeIconNew`),$i(`toggleConfirmPassword`,`confirm-password`,`eyeIconConfirm`),e?.addEventListener(`submit`,async n=>{n.preventDefault();let r=e.email.value.trim(),i=e.newPassword.value,a=e.confirmPassword.value,o=document.getElementById(`new-password`),s=document.getElementById(`confirm-password`);if(!i){ui(o,E.get(`validation_new_password_required`));return}let c=Si(i);if(c.length>0){ui(o,Ci(c));return}if(!a){ui(s,E.get(`validation_new_password_required`));return}if(i!==a){ui(s,E.get(`validation_password_mismatch`));return}t.disabled=!0,t.textContent=E.get(`loading_resetting_password`);try{let e=await w.doResetHash(r,i);e.ok?(typeof neodigmToast<`u`&&neodigmToast.q(E.get(`success_password_reset`),`success`),ea.default.publish(p.AUTH_RESETHASH_SUCCESS,{email:r})):(ui(o,e.error||E.get(`error_signin_failed`)),t.disabled=!1,t.textContent=(E.get(`update_password`)||`Update password`).toUpperCase())}catch(e){console.error(`[ResethashRoute] Reset password error:`,e),ui(o,e.message||E.get(`error_network`)),t.disabled=!1,t.textContent=(E.get(`update_password`)||`Update password`).toUpperCase()}})}function $i(e,t,n){let r=document.getElementById(e),i=document.getElementById(t),a=document.getElementById(n);!r||!i||!a||r.addEventListener(`click`,()=>{let e=i.type===`password`;i.type=e?`text`:`password`,e?a.innerHTML=`
      ...
      `:a.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}var ea,ta=o((()=>{ea=u(f(),1),tr(),m(),T(),wi(),Wt(),pi()}));function na(){if(fa)return;let e=document.createElement(`style`);e.id=`m5t-portfolio-styles`,e.textContent=`
  ...
  </${c}>`}var wa,Ta,Ea=o((()=>{wa={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Ta=e=>String(e??``).replace(/[&<>"']/g,e=>wa[e])})),Da=c({default:()=>$a,init:()=>Na,render:()=>Ma,statCard:()=>Ca,svgTrendChart:()=>za,wireTrendTooltip:()=>Ba});function Oa(e){let t=e.created?.created_tz;if(!t)return``;try{return new Date(t).toLocaleDateString([],{month:`short`,day:`numeric`})}catch{return``}}function ka(e){try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return``}}function Aa(){if(Ga)return;let e=document.createElement(`style`);e.id=`m5t-dash-recent-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Ga=!0}function ja(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${Ha(Wa(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${Ha(Ua(e))}</span>
      <span class="recent-lead__sub">${Ha(e.email||e.phone||``)}</span>
    </span>
    <span class="m5t-badge recent-lead__badge" data-s="${Ha(e.status)}">${Ha(e.status)}</span>
    <span class="recent-lead__time">${Ha(Oa(e))}</span>
  </a>`}function Ma(){Aa(),na();let e=A();return`
    <div class="page-shell" data-section="home">
      ...
      <div class="dashboard-card dashboard-card--lead">
        ...
        <div class="card-body" id="dash-portfolio">${Va(`hourglass_empty`,`Loading…`)}</div>
      </div>`:``}
      ...
      <div class="charts-section">
        ${Ka(`show_chart`,`Opens & Leads`,`dash-trend`,{wide:!0,controls:!0})}
        <div class="charts-grid">
          ${Ka(`filter_alt`,`Completion Funnel`,`dash-funnel`)}
          ${Ka(`source`,`Top Campaigns`,`dash-campaigns`)}
          ${Ka(`touch_app`,`CTA Usage`,`dash-routes`,{full:!0})}
        </div>
      </div>
      ...
      <div class="content-grid">
        ...
        <div class="dashboard-card">
          ...
          <div class="card-body" id="recent-leads-body">
            ${Va(`hourglass_empty`,`Loading leads…`)}
          </div>
        </div>
      </div>
    </div>`}async function Na(){let e=w.getConfig?.().BASE_URL||``;document.getElementById(`dash-periods`)?.addEventListener(`click`,t=>{let n=t.target.closest(`button[data-days]`);n&&(qa=Number(n.dataset.days)||30,document.querySelectorAll(`#dash-periods .chart-period-btn`).forEach(e=>e.classList.toggle(`active`,Number(e.dataset.days)===qa)),Pa(e))}),document.getElementById(`dash-campaigns`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-campaign]`);t&&_a(ba.LEADS_SEARCH,t.dataset.campaign)}),await Promise.all([Pa(e),La(e)])}async function Pa(e){let t=new Date,n=Xa(new Date(t.getTime()-(qa-1)*864e5)),r=Xa(t),i=A(),a;try{let t=await fetch(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${r}${i?`&group_by=owner`:``}`);if(!t.ok)throw Error(`HTTP ${t.status}`);if(a=await t.json(),!a.ok)throw Error(`stats not ok`)}catch(e){console.warn(`[dashboard] stats fetch failed:`,e),[`stat-active-magnets`,`stat-opens`,`stat-leads`,`stat-completion`].forEach(e=>Ja(e,`—`)),[`stat-active-magnets-sub`,`stat-opens-sub`,`stat-leads-sub`,`stat-completion-sub`].forEach(e=>Ja(e,`Unavailable`));let t=document.getElementById(`stat-leads-trend`);t&&(t.className=`stat-trend`,t.innerHTML=``),[`dash-trend`,`dash-funnel`,`dash-campaigns`,`dash-routes`,`dash-interactions`,`dash-portfolio`].forEach(e=>Ya(e,Va(`error`,`Could not load. Please refresh.`)));return}i&&Fa(a.by_owner||[]),Ja(`stat-active-magnets`,j(a.magnets.active)),Ja(`stat-active-magnets-sub`,a.magnets.total>a.magnets.active?`${j(a.magnets.total-a.magnets.active)} paused`:a.magnets.active?`All running`:`No magnets yet`);let o=a.funnel||{};Ja(`stat-opens`,o.opens?j(o.opens):`—`),Ja(`stat-opens-sub`,o.opens?o.engagement_rate==null?`${j(o.engaged)} engaged`:`${o.engagement_rate}% engage`:`No opens in this range yet`);let s=a.leads||{};Ja(`stat-leads`,j(s.total));let c=(s.this_week||0)-(s.prev_week||0);Ja(`stat-leads-sub`,s.total?`${j(s.this_week)} this week`:`No leads yet`);let l=document.getElementById(`stat-leads-trend`);if(l){if((s.prev_week||0)>0){let e=c>0?`positive`:c<0?`negative`:`neutral`,t=c>0?`trending_up`:c<0?`trending_down`:`trending_flat`;l.className=`stat-trend ${e}`,l.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">${t}</span>${c>0?`+`:``}${j(c)}`}else l.className=`stat-trend`,l.innerHTML=``}Ja(`stat-completion`,o.completion_rate==null?`—`:`${o.completion_rate}%`),Ja(`stat-completion-sub`,o.opens?`${j(o.completions)} completed of ${j(o.opens)} opens`:`Appears once magnets get opened`);let u=a.by_day||[],d=u.some(e=>e.opens||e.leads);Ya(`dash-trend`,d?za(u):Va(`show_chart`,`No activity in this range yet. Opens and leads chart here as visitors engage your magnets.`)),d&&Ba(u),Ya(`dash-funnel`,o.opens?Ia(o):Va(`filter_alt`,`The funnel fills in once your magnets record opens.`));let f=a.top_campaigns||[];Ya(`dash-campaigns`,f.length?`<div class="dash-list">${f.map(e=>`
        <a class="dash-list__row dash-list__row--link" href="#/leads" data-campaign="${Ha(e.campaign)}" title="Show the leads from ${Ha(e.campaign)}">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">campaign</span></span>
          <span class="dash-list__main">${Ha(e.campaign)}</span>
        ...
        </a>`).join(``)}</div>`:Va(`source`,`No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here.`));{let e=document.getElementById(`dash-campaigns`)?.querySelector(`.dash-list`);e&&en(e,{rowSelector:`.dash-list__row`,noun:`campaigns`})}let p={book:[`event`,`Book`],chat:[`chat`,`Chat`],call:[`phone_in_talk`,`Call`],email:[`mail`,`Email`],support:[`support_agent`,`Support`]},m=Object.entries(o.routes||{}).sort((e,t)=>t[1]-e[1]),h=m.length?m[0][1]:0;Ya(`dash-routes`,m.length?`<div class="dash-funnel">${m.map(([e,t])=>{let[n,r]=p[e]||[`touch_app`,e];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${n}</span> ${Ha(r)}</span><span class="dash-funnel__val">${j(t)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${h?Math.max(4,Math.round(t/h*100)):0}%"></div></div>
        </div>`}).join(``)}</div>`:Va(`touch_app`,`CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar.`));let g={open:[`visibility`,`Magnet opened`],engage:[`touch_app`,`Visitor engaged`],route:[`alt_route`,`Picked a channel`],complete:[`check_circle`,`Completed: lead captured`]},_=a.recent_events||[];Ya(`dash-interactions`,_.length?`<div class="dash-list">${_.map(e=>{let[t,n]=g[e.event]||[`sensors`,e.event];return`<div class="dash-list__row">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">${t}</span></span>
          <span class="dash-list__main">${n}${e.event===`route`&&e.detail?` · ${Ha(e.detail)}`:``}</span>
          ${e.display_mode?`<span class="dash-list__mode">${Ha(e.display_mode)}</span>`:``}
          <span class="dash-list__time">${Ha(ka(e.at))}</span>
        </div>`}).join(``)}</div>`:Va(`sensors`,`No interactions yet. They'll stream in as visitors engage your magnets.`));{let e=document.getElementById(`dash-interactions`)?.querySelector(`.dash-list`);e&&en(e,{rowSelector:`.dash-list__row`,noun:`interactions`})}}function Fa(e){let t=document.getElementById(`dash-portfolio`);if(!t)return;if(!e.length){t.innerHTML=Va(`groups`,`No client orgs yet. Create one under Clients to see its numbers here.`);return}let n=e.some(e=>e.ad),r=e=>{let t=(e.leads.this_week||0)-(e.leads.prev_week||0);return!e.leads.this_week&&!e.leads.prev_week?``:` <span class="${t>=0?`dc-delta-up`:`dc-delta-down`}">(${t>=0?`+`:``}${j(t)})</span>`};t.innerHTML=ia(e,[{h:`Magnets`,td:e=>`${j(e.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${j(e.magnets.total)}</span>`},{h:`Leads · wk`,td:e=>`${j(e.leads.this_week)}${r(e)}`},{h:`Leads · total`,td:e=>j(e.leads.total)},{h:`Opens`,td:e=>j(e.opens)},{h:`Compl.`,td:e=>e.completion_rate==null?`—`:`${e.completion_rate}%`},...e.some(e=>e.ab_tests?.running||e.ab_tests?.completed)?[{h:`A/B`,td:e=>e.ab_tests?.running?`${j(e.ab_tests.running)} <span class="dc-sub">running</span>`:e.ab_tests?.completed?`${j(e.ab_tests.completed)} <span class="dc-sub">done</span>`:`—`}]:[],...e.some(e=>e.booked)?[{h:`Booked`,td:e=>e.booked?j(e.booked):`—`}]:[],...e.some(e=>e.called)?[{h:`Called`,td:e=>e.called?j(e.called):`—`}]:[],...n?[{h:`Spend`,td:e=>e.ad?`$${j(e.ad.spend)}`:`—`},{h:`CPL`,td:e=>e.ad?.cost_per_lead==null?`—`:`$${j(e.ad.cost_per_lead)}`}]:[]]),oa(t)}function Ia(e){let t=[[`Opened`,e.opens,``],[`Engaged`,e.engaged,` dash-funnel__bar--mid`],[`Completed`,e.completions,` dash-funnel__bar--end`],...e.booked?[[`Booked`,e.booked,` dash-funnel__bar--end`]]:[],...e.called?[[`Called`,e.called,` dash-funnel__bar--end`]]:[]],n=Math.max(1,e.opens||0),r=e=>Math.min(100,Math.round((e||0)/n*100));return`<div class="dash-funnel">${t.map(([e,t,n])=>`
    ...
    </div>`).join(``)}</div>`}async function La(e){let t=document.getElementById(`recent-leads-body`);if(t)try{let n=await fetch(`${e}/m5t/v5/m5mLead?limit=5`);if(!n.ok)throw Error(`HTTP ${n.status}`);let r=await n.json(),i=(Array.isArray(r?.data)?r.data:[]).filter(e=>![`DELETED`,`ARCHIVED`].includes(e.status));t.innerHTML=i.length?i.slice(0,5).map(ja).join(``):Va(`contacts`,`No leads captured yet. Publish a magnet to start collecting.`)}catch(e){console.warn(`[dashboard] Leads fetch failed:`,e),t.innerHTML=Va(`error`,`Could not load recent leads.`)}}function Ra(e){if(e<=0)return 1;let t=10**Math.floor(Math.log10(e)),n=e/t;return(n<=1?1:n<=2?2:n<=5?5:10)*t}function za(e){let t=e.length||1,n=Ra(Math.max(1,...e.map(e=>e.opens||0))),r=Ra(Math.max(1,...e.map(e=>e.leads||0))),i=748/t,a=Math.min(22,i*.55),o=e=>46+i*(e+.5),s=e=>266-e/n*248,c=e=>266-e/r*248,l=[0,.5,1].map(e=>{let t=266-e*248;return`<line x1="46" y1="${t.toFixed(1)}" x2="794" y2="${t.toFixed(1)}" class="dash-grid"/><text x="38" y="${(t+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${Qa(n*e)}</text><text x="802" y="${(t+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${Qa(r*e)}</text>`}).join(``),u=e.map((e,t)=>{let n=s(e.opens||0);return`<rect class="dash-bar" data-i="${t}" x="${(o(t)-a/2).toFixed(1)}" y="${n.toFixed(1)}" width="${a.toFixed(1)}" height="${Math.max(0,266-n).toFixed(1)}" rx="3"/>`}).join(``),d=e.map((e,t)=>`${o(t).toFixed(1)},${c(e.leads||0).toFixed(1)}`).join(` `),f=t>1?`<polyline class="dash-line" points="${d}" fill="none" stroke-width="2.5"/>`:``,p=e.map((e,t)=>`<circle class="dash-dot" data-i="${t}" cx="${o(t).toFixed(1)}" cy="${c(e.leads||0).toFixed(1)}" r="3.2"/>`).join(``),m=Math.max(1,Math.ceil(t/6));return`
    ...
    <div class="dash-chart-wrap">
      ...
      ${Number(s.leads||0)>0?`<div class="dash-chart-tip__go">Click to see them →</div>`:``}`;let c=a.getBoundingClientRect(),l=t.getBoundingClientRect();n.style.left=`${c.left-l.left+c.width/2}px`,n.style.top=`${c.top-l.top}px`,n.hidden=!1,o(i,a)},c=()=>{n.hidden=!0,a()};t.querySelectorAll(`.dash-hit`).forEach(e=>{let t=Number(e.dataset.i);e.addEventListener(`mouseenter`,()=>s(t,e)),e.addEventListener(`mousemove`,()=>s(t,e)),e.addEventListener(`mouseleave`,c),e.addEventListener(`click`,()=>{let n=e.classList.contains(`dash-hit--on`);s(t,e),Number(e.dataset.leads||0)&&(!Za()&&!n||(_a(ba.LEADS_DAY,e.dataset.day),window.location.hash=`#/leads`))})})}var Va,Ha,j,Ua,Wa,Ga,Ka,qa,Ja,Ya,Xa,Za,Qa,$a,eo=o((()=>{T(),ga(),Sa(),Ea(),nn(),Va=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Ha=e=>String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]),j=e=>Number(e||0).toLocaleString(),Ua=e=>[e.first_name,e.last_name].filter(Boolean).join(` `).trim()||e.email||`(no name)`,Wa=e=>(Ua(e).split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``)||`?`).toUpperCase(),Ga=!1,Ka=(e,t,n,{wide:r=!1,full:i=!1,controls:a=!1}={})=>`
  <div class="dashboard-card${r?` chart-card-wide`:``}${i?` chart-card-full`:``}">
    ...
    <div class="card-body" id="${n}">${Va(`hourglass_empty`,`Loading…`)}</div>
  </div>`,qa=30,Ja=(e,t)=>{let n=document.getElementById(e);n&&(n.textContent=t)},Ya=(e,t)=>{let n=document.getElementById(e);n&&(n.innerHTML=t)},Xa=e=>e.toISOString().slice(0,10),Za=()=>typeof window.matchMedia!=`function`||window.matchMedia(`(hover: hover)`).matches,Qa=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3==0?0:1)+`k`:String(e)),$a={render:Ma,init:Na}})),to=c({init:()=>ro,render:()=>no});function no(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Xn(`#/home`)}
  ...
  `}function ro(){console.log(`[SignoutRoute] Initialized`);let e=document.getElementById(`confirm-signout-btn`);e?.addEventListener(`click`,async()=>{e.disabled=!0,e.textContent=`SIGNING OUT...`,console.log(`[SignoutRoute] User confirmed signout`),await w.doSignout()})}var io=o((()=>{T(),tr()})),ao=c({default:()=>uo,init:()=>co,render:()=>so});function oo(){if(lo)return;let e=document.createElement(`style`);e.id=`m5t-section-page-styles`,e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),lo=!0}function so({title:e=`Section`,icon:t=`widgets`,name:n=``}={}){return oo(),`
    ...
    </section>`}function co(){}var lo,uo,fo=o((()=>{lo=!1,uo={render:so,init:co}})),po=c({default:()=>Fo,init:()=>bo,render:()=>yo});function mo(){if(No)return;let e=document.createElement(`style`);e.id=`m5t-settings-general-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),No=!0}function ho(){try{return Gt.getAvailableLanguages()||[]}catch{return[]}}function go(){let e=ho(),t=e.includes(v.FF_SSE_I18N_LANG)?v.FF_SSE_I18N_LANG:e[0]||v.FF_SSE_I18N_LANG;try{let n=localStorage.getItem(v.FF_SSE_LS_USER_LANG);return n&&e.includes(n)?n:t}catch{return t}}function _o(e){try{let t=new Intl.DisplayNames([e],{type:`language`}).of(e);if(t&&t!==e)return t.charAt(0).toUpperCase()+t.slice(1)}catch{}return e}function vo(){let e=Sn(),t=ho(),n=t.length>1;if(!e&&!n)return``;let r=go();return`
        ...
        <div class="settings-item" id="gen-dark-item">
          ...
          <div class="settings-item__control">
            <label class="m5t-switch">
              <input type="checkbox" role="switch" id="gen-dark" aria-label="Dark mode" ${kn()===`dark`?`checked`:``} />
        ...
        <div class="settings-item" id="gen-lang-item">
          ...
          <div class="settings-item__control">
            <select class="settings-select" id="gen-lang" aria-label="Language">
              ${t.map(e=>`<option value="${Oo(e)}" ${e===r?`selected`:``}>${Oo(_o(e))}</option>`).join(``)}
            </select>
          </div>
        </div>`:``}
      </div>
    </div>`}function yo(){return mo(),`
    <div class="page-shell" data-section="settings-general">
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ...
          <div id="gen-profile-body">${Po(`hourglass_empty`,`Loading…`)}</div>
        </div>
      </div>
    ...
    </div>`}async function bo(){To(),await So()}function xo(e){return`
    <div class="settings-grid-2">
      <div class="settings-field">
        <label class="settings-label" for="gen-first">First name</label>
        <input class="settings-input" id="gen-first" type="text" autocomplete="given-name" value="${Oo(e.first)}" />
        <p class="settings-error" id="gen-first-error" role="alert" hidden></p>
      </div>
      <div class="settings-field">
        <label class="settings-label" for="gen-last">Last name</label>
        <input class="settings-input" id="gen-last" type="text" autocomplete="family-name" value="${Oo(e.last)}" />
        <p class="settings-error" id="gen-last-error" role="alert" hidden></p>
      </div>
    </div>
    <div class="settings-field">
      <label class="settings-label" for="gen-company">Company</label>
      <input class="settings-input" id="gen-company" type="text" autocomplete="organization" value="${Oo(e.company)}" />
    </div>
    <div class="settings-field">
      <label class="settings-label" for="gen-phone">Phone</label>
      <input class="settings-input" id="gen-phone" type="tel" autocomplete="tel" value="${Oo(e.phone)}" />
    </div>
    <div class="settings-field">
      <label class="settings-label" for="gen-email">Sign-in email</label>
      <input class="settings-input" id="gen-email" type="email" value="${Oo(e.email)}" readonly />
    ...
    </div>`}async function So(){let e=document.getElementById(`gen-profile-body`);if(e){try{let e=await fetch(jo()),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok||!t.data)throw Error(t.error||`Failed to load`);Mo.profile=t.data}catch(t){console.warn(`[settings-general] profile load failed:`,t),e.innerHTML=Po(`error`,`Could not load your profile. Please try again.`);return}e.innerHTML=xo(Mo.profile),e.querySelector(`#gen-save`)?.addEventListener(`click`,wo)}}function Co(e,t){let n=document.getElementById(`${e}-error`);n&&(n.textContent=t||``,n.hidden=!t);let r=document.getElementById(e);r&&r.setAttribute(`aria-invalid`,t?`true`:`false`)}async function wo(){let e=document.getElementById(`gen-save`),t=e=>(document.getElementById(e)?.value??``).trim(),n={first:t(`gen-first`),last:t(`gen-last`),company:t(`gen-company`),phone:t(`gen-phone`)};if(Co(`gen-first`,n.first?``:`First name is required.`),Co(`gen-last`,n.last?``:`Last name is required.`),!(!n.first||!n.last)){e&&(e.disabled=!0);try{let e=await fetch(jo(),{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify(n)}),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(t.error||`Could not save.`);t.data&&(Mo.profile=t.data),ko(`Profile updated.`,`success`)}catch(e){console.warn(`[settings-general] profile save failed:`,e),ko(e.message||`Could not save.`,`error`)}finally{e&&(e.disabled=!1)}}}function To(){let e=document.getElementById(`gen-dark`);if(e){e.addEventListener(`change`,()=>{An(e.checked?`dark`:`light`),e.checked=kn()===`dark`});let t=Eo.default.subscribe(p.UI_THEME_CHANGED,()=>{if(!e.isConnected){Eo.default.unsubscribe(t);return}e.checked=kn()===`dark`})}let t=document.getElementById(`gen-lang`);t&&t.addEventListener(`change`,()=>{try{Gt.setLanguage(t.value)}catch(e){console.warn(`[settings-general] setLanguage failed:`,e)}})}var Eo,Do,Oo,ko,Ao,jo,Mo,No,Po,Fo,Io=o((()=>{T(),Eo=u(f(),1),m(),y(),Nn(),En(),Do={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Oo=e=>String(e??``).replace(/[&<>"']/g,e=>Do[e]),ko=(e,t=`info`)=>{try{Eo.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Ao=()=>w.getConfig?.().BASE_URL||``,jo=()=>`${Ao()}/m5t/v5/acctEntity/profile`,Mo={profile:null},No=!1,Po=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Fo={render:yo,init:bo}})),Lo=c({default:()=>fs,init:()=>Bo,render:()=>zo});function Ro(){if(ls)return;let e=document.createElement(`style`);e.id=`m5t-workspace-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),ls=!0}function zo(){Ro();let e=rs[ss()];return`
    <div class="page-shell" data-section="settings-workspace">
      <div class="page-header">
        <div class="page-header-text">
          <div class="ws-title-row">
            <h1 class="page-title">Workspace</h1>
            ${e?`<span class="m5t-chip">${Qo(e)}</span>`:``}
          </div>
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ...
          <div id="ws-org-body">${us(`hourglass_empty`,`Loading…`)}</div>
        </div>
      </div>
    ...
    </div>`}async function Bo(){as.org=null,await Vo(),await Ko()}async function Vo(){let e=document.getElementById(`ws-org-body`);if(!e)return;let t=os();if(!t){e.innerHTML=us(`apartment`,`No workspace on this account yet.`);return}try{let e=await fetch(`${es()}/m5t/v5/acctGroup`),n=await e.json().catch(()=>({}));if(!e.ok||!n.ok)throw Error(n.error||`Failed (HTTP ${e.status})`);if(as.org=(n.data||[]).find(e=>e.guid===t)||null,!as.org)throw Error(`Org row not in scope`)}catch(t){console.warn(`[settings-workspace] load failed:`,t),e.innerHTML=us(`error`,`Could not load your workspace. Please try again.`);return}Uo()}function Ho(){let e=rs[ss()]||``,t=as.org?.created?.created_tz,n=``;if(t){let e=new Date(t);Number.isNaN(e.getTime())||(n=`Created ${e.toLocaleDateString()}`)}let r=[e,n].filter(Boolean);return r.length?`<p class="settings-help">${Qo(r.join(` · `))}</p>`:``}function Uo(){let e=document.getElementById(`ws-org-body`);if(!e)return;let t=as.org||{};if(!cs()){let n=ss()===ns?`<div class="settings-note"><span class="material-symbols-outlined" aria-hidden="true">info</span> This workspace is managed for you.</div>`:``;e.innerHTML=`
      <div class="settings-item">
        <div class="settings-item__info">
          <div class="settings-item__title">Organization name</div>
          <div class="settings-item__desc">${Qo(t.caption||`Not set`)}</div>
        </div>
      </div>
      <div class="settings-item">
        <div class="settings-item__info">
          <div class="settings-item__title">Description</div>
          <div class="settings-item__desc">${Qo(t.description||`Not set`)}</div>
        </div>
      </div>
      ${n}
      <div style="margin-top:12px">${Ho()}</div>`;return}e.innerHTML=`
    <div class="settings-field">
      <label class="settings-label" for="ws-name">Organization name</label>
      <input class="settings-input" id="ws-name" type="text" required value="${Qo(t.caption||``)}" />
    </div>
    <div class="settings-field">
      <label class="settings-label" for="ws-desc">Description</label>
      <textarea class="settings-input" id="ws-desc" rows="2">${Qo(t.description||``)}</textarea>
    </div>
    <p class="settings-error" id="ws-org-error"></p>
    <div class="settings-save-row">
      ${Ho()}
      <button class="btn btn-primary" type="button" id="ws-save">Save</button>
    </div>`,document.getElementById(`ws-save`)?.addEventListener(`click`,Wo)}async function Wo(){let e=document.getElementById(`ws-save`),t=document.getElementById(`ws-org-error`),n=(document.getElementById(`ws-name`)?.value||``).trim(),r=(document.getElementById(`ws-desc`)?.value||``).trim();if(t&&(t.textContent=``),!n){t&&(t.textContent=`Organization name is required.`);return}e&&(e.disabled=!0);try{let e=await fetch(`${es()}/m5t/v5/acctGroup/${encodeURIComponent(as.org.id)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({caption:n,description:r})}),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(t.message||t.error||`Failed (HTTP ${e.status})`);as.org={...as.org,caption:n,description:r},$o(`Workspace updated.`,`success`)}catch(t){console.warn(`[settings-workspace] save failed:`,t),$o(t.message||`Could not save`,`danger`),e&&(e.disabled=!1);return}e&&(e.disabled=!1);try{await w.fetchScope?.()}catch(e){console.warn(`[settings-workspace] fetchScope after save failed:`,e)}}function Go(){document.getElementById(`ws-team-card`)?.remove()}async function Ko(){let e=document.getElementById(`ws-team-card`);if(!e)return;let t=os();if(!t||!cs()){Go();return}let n=[],r=[];try{let[e,i]=await Promise.all([fetch(`${es()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/members`),fetch(`${es()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/invites`)]);if(e.status===403||i.status===403){Go();return}let[a,o]=await Promise.all([e.json().catch(()=>({})),i.json().catch(()=>({}))]);if(!e.ok||!i.ok)throw Error(`members: ${e.status}, invites: ${i.status}`);n=a.members||[],r=o.invites||[]}catch(t){console.warn(`[settings-workspace] team load failed:`,t),e.style.display=``;let n=document.getElementById(`ws-team-body`);n&&(n.innerHTML=us(`error`,`Could not load your team. Please try again.`));return}Yo(n,r)}function qo(e){if(!e.length)return``;let t=e.slice(0,is),n=e.length-t.length;return`
    <div class="ws-avatars">
      ${t.map(e=>`<span class="ws-avatar" title="${Qo(e.name||e.email)}">${Qo(ts(e.name||e.email))}</span>`).join(``)}
      ${n>0?`<span class="ws-avatar ws-avatar--more">+${n}</span>`:``}
    </div>`}function Jo(e,t){let n=`${e.length} member${e.length===1?``:`s`}`;return t.length?`${n} · ${t.length} pending invite${t.length===1?``:`s`}`:n}function Yo(e,t){let n=document.getElementById(`ws-team-card`),r=document.getElementById(`ws-team-body`);if(!n||!r)return;n.style.display=``;let i=ss()!==ns;r.innerHTML=`
    ${qo(e)}
    <p class="ws-counts">${Qo(Jo(e,t))}</p>
    ${i?`<div class="ws-team-actions"><a class="btn btn-secondary" href="#/team">Manage team</a></div>`:``}`}var Xo,Zo,Qo,$o,es,ts,ns,rs,is,as,os,ss,cs,ls,us,ds,fs,ps=o((()=>{T(),Xo=u(f(),1),m(),Zo={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Qo=e=>String(e??``).replace(/[&<>"']/g,e=>Zo[e]),$o=(e,t=`info`)=>{try{Xo.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},es=()=>w.getConfig?.().BASE_URL||``,ts=e=>String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``).toUpperCase()||`?`,ns=`managed_client`,rs={reseller_org:`Your organization`,managed_client:`Client workspace`,saas_org:`Organization`},is=6,as={org:null},os=()=>w.getActiveOrg()?.guid||w.getMemberships()[0]?.orgGuid||null,ss=()=>w.getActiveOrg()?.channel||w.getMemberships()[0]?.channel||null,cs=()=>w.getCapabilities().includes(`manage_team`),ls=!1,us=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,ds=(e,t,n)=>`
  <div class="settings-section__head">
  ...
  </div>`,fs={render:zo,init:Bo}})),ms=c({default:()=>Ls,init:()=>_s,render:()=>gs});function hs(){if(Fs)return;let e=document.createElement(`style`);e.id=`m5t-notif-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Fs=!0}function gs(){return hs(),na(),A()?sa({section:`settings-notifications`,title:`Notifications`,description:`Pick a client to manage their lead alerts.`}):`
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Email sent the moment a magnet captures a lead. Up to ${Ms} recipients per magnet.</p>
            </div>
          </div>
          <div id="ntf-body">${Is(`hourglass_empty`,`Loading…`)}</div>
        </div>
      </div>
    ...
    </div>`}async function _s(){if(A()){let e=e=>Number(e||0).toLocaleString();return ca(As(),[{h:`Magnets`,td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:`Leads · wk`,td:t=>e(t.leads.this_week)}],{emptyMsg:`No client orgs yet. Create one under Clients first.`})}await Promise.all([xs(),vs()])}async function vs(){let e=Ps();if(e)try{let t=await fetch(`${As()}/m5t/v5/acctGroup/${encodeURIComponent(e)}/webhook`);if(t.status===403){Ns.webhookAllowed=!1;return}let n=await t.json().catch(()=>({}));if(!n.ok)return;Ns.webhook=n.webhook,bs()}catch{}}function ys(e){try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return``}}function bs(){let e=document.getElementById(`ntf-wh-card`),t=document.getElementById(`ntf-wh-body`);if(!e||!t)return;e.style.display=``;let n=Ns.webhook,r=n?.last_delivery;t.innerHTML=`
    <div class="ntf-wh">
      <div class="settings-field" style="margin-bottom:0">
        <label class="settings-label" for="ntf-wh-url">Webhook URL</label>
        <input class="ntf-input" id="ntf-wh-url" type="url" placeholder="https://hooks.zapier.com/hooks/catch/…" value="${Os(n?.uri||``)}" />
      </div>
      <div class="settings-field" style="margin-bottom:0">
      ...
      <div class="ntf-wh__row">
        ...
        <span class="ntf-wh__status">${r?r.ok?`Last delivery: <span class="ok">delivered</span> ${Os(ys(r.tz))}`:`Last delivery: <span class="bad">failed</span> ${Os(ys(r.tz))} (${Os(r.error||``)})`:``}</span>
      </div>
    </div>`,t.querySelector(`#ntf-wh-save`)?.addEventListener(`click`,async()=>{let e=t.querySelector(`#ntf-wh-url`)?.value.trim()||``,n=t.querySelector(`#ntf-wh-secret`)?.value??``,r={uri:e};n.trim()!==``&&(r.secret=n.trim());try{let t=await fetch(`${As()}/m5t/v5/acctGroup/${encodeURIComponent(Ps())}/webhook`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify(r)}),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.error||`Failed (HTTP ${t.status})`);Ns.webhook=n.webhook,ks(e?`Webhook saved`:`Webhook removed`,`success`),bs()}catch(e){ks(e.message||`Could not save`,`danger`)}}),t.querySelector(`#ntf-wh-test`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0;try{let e=await fetch(`${As()}/m5t/v5/acctGroup/${encodeURIComponent(Ps())}/webhook-test`,{method:`POST`}),t=await e.json().catch(()=>({}));e.ok&&t.ok?ks(`Test delivery sent`,`success`):ks(t.error||`Could not deliver the test`,`danger`)}catch{ks(`Could not deliver the test`,`danger`)}finally{t.disabled=!1}try{await vs()}catch(e){console.warn(`[notifications] loadWebhook refresh failed:`,e)}})}async function xs(){let e=document.getElementById(`ntf-body`);if(e){try{let e=await(await fetch(`${As()}/m5t/v5/magnets`)).json().catch(()=>({}));if(!e.ok)throw Error(e.message||`Failed to load`);Ns.magnets=(e.magnets||[]).filter(e=>e.status!==`ARCHIVED`),Ns.canManage=!!e.canManage}catch(t){console.warn(`[notifications] load failed:`,t),e.innerHTML=Is(`error`,`Could not load your magnets. Please try again.`);return}Cs()}}function Ss(e){let t=Array.isArray(e.notify_emails)?e.notify_emails:[],n=t.length>0;return`
    <div class="ntf-row" data-guid="${Os(e.guid)}">
      <div class="ntf-magnet">
        <div class="ntf-name" title="${Os(e.name)}">${Os(e.name)}</div>
        <div class="ntf-meta">${Os((e.domains||[]).join(`, `)||e.status)}</div>
      ...
      <div class="ntf-config">
        ${t.length?`<div class="ntf-chips">${t.map(e=>`
              <span class="ntf-chip">${Os(e)}${Ns.canManage?`<button type="button" data-remove="${Os(e)}" aria-label="Remove ${Os(e)}">&times;</button>`:``}</span>`).join(``)}</div>`:`<div class="ntf-none">No alert emails.</div>`}
        ${Ns.canManage?`
        <div class="ntf-addrow">
          <input class="ntf-input" type="email" placeholder="name@business.com" aria-label="Add alert email" ${t.length>=Ms?`disabled`:``} />
          <button class="ntf-btn" type="button" data-add ${t.length>=Ms?`disabled`:``}>
    ...
    </div>`}function Cs(){let e=document.getElementById(`ntf-body`);if(e){if(!Ns.magnets.length){e.innerHTML=Is(`widgets`,`No magnets yet. Create one under Your Magnets first.`);return}e.innerHTML=Ns.magnets.map(Ss).join(``),en(e,{rowSelector:`.ntf-row`,noun:`magnets`}),e.querySelectorAll(`.ntf-row`).forEach(e=>{let t=e.dataset.guid,n=e.querySelector(`.ntf-input`),r=()=>{let e=(n?.value||``).trim().toLowerCase();if(!e)return;if(!js(e)){ks(`That does not look like an email address`,`danger`);return}let r=[...Ns.magnets.find(e=>e.guid===t).notify_emails||[]];if(r.includes(e)){ks(`Already added`,`info`);return}if(r.length>=Ms){ks(`Up to ${Ms} emails per magnet`,`info`);return}ws(t,[...r,e])};e.querySelector(`[data-add]`)?.addEventListener(`click`,r),n?.addEventListener(`keydown`,e=>{e.key===`Enter`&&r()}),e.querySelectorAll(`[data-remove]`).forEach(e=>e.addEventListener(`click`,()=>{let n=Ns.magnets.find(e=>e.guid===t);ws(t,(n.notify_emails||[]).filter(t=>t!==e.dataset.remove))})),e.querySelector(`[data-test]`)?.addEventListener(`click`,()=>Ts(t,e.querySelector(`[data-test]`)))})}}async function ws(e,t){try{let n=await fetch(`${As()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({notify_emails:t})}),r=await n.json().catch(()=>({}));if(!n.ok||!r.ok)throw Error(r.error||r.message||`Failed (HTTP ${n.status})`);let i=Ns.magnets.find(t=>t.guid===e);i&&(i.notify_emails=t),ks(`Alert emails updated`,`success`)}catch(e){console.warn(`[notifications] save failed:`,e),ks(e.message||`Could not save`,`danger`);return}try{Cs()}catch(e){console.error(`[notifications] renderBody after save failed:`,e)}}async function Ts(e,t){t&&(t.disabled=!0);try{let t=await fetch(`${As()}/m5t/v5/magnets/${encodeURIComponent(e)}/notify-test`,{method:`POST`}),n=await t.json().catch(()=>({}));t.ok&&n.ok?ks(`Test alert sent`,`success`):ks(n.error||`Could not send the test`,`danger`)}catch{ks(`Could not send the test`,`danger`)}finally{t&&(t.disabled=!1)}}var Es,Ds,Os,ks,As,js,Ms,Ns,Ps,Fs,Is,Ls,Rs=o((()=>{T(),Qe(),Es=u(f(),1),m(),ga(),nn(),Ds={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Os=e=>String(e??``).replace(/[&<>"']/g,e=>Ds[e]),ks=(e,t=`info`)=>{try{Es.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},As=()=>w.getConfig?.().BASE_URL||``,js=e=>Te(e),Ms=5,Ns={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},Ps=()=>w.getActiveOrg()?.guid||w.getMemberships()[0]?.orgGuid||null,Fs=!1,Is=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Ls={render:gs,init:_s}}));function zs({label:e=``,content:t=``,size:n=``,onClose:r=null}={}){let i=document.activeElement,a=document.createElement(`div`);a.className=`m5t-modal-scrim`,a.innerHTML=`
    <div class="m5t-modal${n===`wide`?` m5t-modal--wide`:``}" role="dialog" aria-modal="true" aria-label="${Bs(e)}" tabindex="-1">
    ...
    </span>`}function Xs(e,t){let n=hc(),r=e?.[t]||[];return r.find(e=>e.owner_guid===n)||r[0]||null}function Zs(e,t,n){return e.connect&&!n?`unavailable`:t?t.connect_status===`ACTIVE`?`connected`:`broken`:`idle`}function Qs(e,t){return e===`unavailable`?`<span class="intg-state">Not available yet</span>`:e===`idle`?`<span class="intg-state">Not connected</span>`:e===`connected`?`<span class="intg-state on"><span class="material-symbols-outlined" aria-hidden="true">check</span>Connected</span>`:`<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>${M(t?.connect_status===`NEEDS_REAUTH`?`Reconnect needed`:`Connection error`)}</span>`}async function $s(){let e=await fetch(`${N()}/m5t/v5/integrations`);if(e.status===403)return{denied:!0};let t=await e.json();if(!t.ok)throw Error(t.error||`load failed`);return{providers:t.data.providers,configured:t.data.configured}}async function ec(e){if(!yc.busy){yc.busy=!0;try{let t=await(await fetch(`${N()}/m5t/v5/integrations/${e.slug}/connect`)).json();if(!t.ok||!t.data?.url)throw Error(t.error||`connect failed`);window.location.href=t.data.url}catch(t){mc(t.message||e.connect.fallbackError,`error`),yc.busy=!1}}}async function tc(e,{refresh:t}={}){if(yc.busy)return;yc.busy=!0;let n=document.getElementById(e.card.ids.sync);n&&(n.disabled=!0);try{let t=await(await fetch(`${N()}/m5t/v5/integrations/${e.slug}/sync`,{method:`POST`})).json();if(!t.ok)throw Error(t.error||`sync failed`);let n=(t.data?.connections?.[0]?.[e.sync.itemsField]||[]).filter(e=>e.error).length;mc(n?e.sync.failedToast(n):`Metrics synced.`,n?`warning`:`success`)}catch{mc(`Sync failed.`,`error`)}finally{yc.busy=!1,n&&(n.disabled=!1),t?.()}}async function nc(e,{refresh:t}={}){if(yc.busy)return;yc.busy=!0;let n=!1;try{n=await Us({title:`Disconnect ${e.label}?`,message:e.disconnect.confirm,confirmLabel:`Disconnect`,danger:!0})}finally{n||(yc.busy=!1)}if(n)try{let t=await(await fetch(`${N()}/m5t/v5/integrations/${e.slug}`,{method:`DELETE`})).json().catch(()=>({}));if(!t.ok)throw Error(t.error||`disconnect failed`);mc(e.disconnect.toast,`success`)}catch{mc(`Disconnect failed.`,`error`)}finally{yc.busy=!1,t?.()}}async function rc(e,{refresh:t}={}){let n=e.picker,r=document.getElementById(e.card.ids.panel);if(r){r.style.display=``,r.innerHTML=vc(n.loading);try{let r=await(await fetch(`${N()}/m5t/v5/integrations/${e.slug}/${n.path}`)).json();if(!r.ok)throw Error(r.error||`load failed`);ic(e,r.data[n.itemsField]||[],new Set(r.data.linked||[]),{refresh:t})}catch{r.innerHTML=vc(n.loadError,`error`)}}}function ic(e,t,n,{refresh:r}={}){let i=e.picker,a=document.getElementById(e.card.ids.panel);if(!a)return;let o=t.map(e=>{let t=i.rowDisabled(e),r=i.rowBadge(e),a=n.has(e.id)&&!t;return`
    ...
    </div>`,document.getElementById(i.ids.cancel)?.addEventListener(`click`,()=>{a.style.display=`none`}),document.getElementById(i.ids.save)?.addEventListener(`click`,()=>ac(e,{refresh:r}))}async function ac(e,{refresh:t}={}){let n=e.picker,r=document.getElementById(e.card.ids.panel),i=[...r?.querySelectorAll(`input[data-${n.dataAttr}]:checked`)||[]].map(e=>e.dataset[n.datasetKey]),a=document.getElementById(n.ids.save);a&&(a.disabled=!0);try{let a=await(await fetch(`${N()}/m5t/v5/integrations/${e.slug}/${n.path}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({[n.saveField]:i})})).json();if(!a.ok)throw Error(a.error||`save failed`);mc(n.savedToast(a.data.linked),`success`),r&&(r.style.display=`none`),t?.()}catch{mc(n.saveError,`error`),a&&(a.disabled=!1)}}function oc({refresh:e,replaceKey:t=!1}={}){let n=document.getElementById(Sc.callrail.card.ids.setup);n&&(n.style.display=``,n.innerHTML=`
    <div class="intg-picker">
    ...
    </div>`,document.getElementById(`intg-r-cancel`)?.addEventListener(`click`,()=>{n.style.display=`none`}),document.getElementById(`intg-r-continue`)?.addEventListener(`click`,()=>sc({refresh:e})),document.getElementById(`intg-r-key`)?.focus())}async function sc({refresh:e}={}){let t=document.getElementById(`intg-r-continue`),n=document.getElementById(`intg-r-key`)?.value.trim()||``,r=document.getElementById(`intg-r-pickers`);if(!n){Tc(`Paste an API key first.`);return}if(r&&!r.hidden)return lc(n,{refresh:e});t&&(t.disabled=!0),Tc(`Checking the key with CallRail…`);try{let e=await(await fetch(`${N()}/m5t/v5/integrations/callrail/validate`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({api_key:n})})).json();if(!e.ok){Tc(e.error||`CallRail rejected that key.`);return}let i=e.data.accounts||[],a=document.getElementById(`intg-r-account`);a&&(a.innerHTML=i.map(e=>`<option value="${M(e.id)}">${M(e.name)}</option>`).join(``),a.onchange=()=>cc(n,a.value)),r&&(r.hidden=!1),t&&(t.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">save</span>Save`),Tc(``),await cc(n,i[0]?.id)}catch{Tc(`Could not reach CallRail. Try again.`)}finally{t&&(t.disabled=!1)}}async function cc(e,t){let n=document.getElementById(`intg-r-company`);if(!(!n||!t)){n.innerHTML=`<option value="">Loading companies…</option>`;try{let r=await(await fetch(`${N()}/m5t/v5/integrations/callrail/companies`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({api_key:e,account_id:t})})).json(),i=r.ok&&r.data.companies||[];n.innerHTML=i.length?i.map(e=>`<option value="${M(e.id)}">${M(e.name)}</option>`).join(``):`<option value="">No active companies in this account</option>`}catch{n.innerHTML=`<option value="">Could not load companies</option>`}}}async function lc(e,{refresh:t}={}){let n=document.getElementById(`intg-r-continue`),r=document.getElementById(`intg-r-account`)?.value||``,i=document.getElementById(`intg-r-company`)?.value||``;if(!i){Tc(`Pick the company this workspace tracks.`);return}n&&(n.disabled=!0),Tc(`Connecting…`);try{let n=await(await fetch(`${N()}/m5t/v5/integrations/callrail`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({api_key:e,account_id:r,company_id:i})})).json();if(!n.ok)throw Error(n.error||`connect failed`);mc(n.data?.webhook_state===`active`?`CallRail connected. Call sync is on.`:`CallRail connected. Call sync setup needs attention; see below.`,`success`),t?.()}catch{Tc(`Could not connect. Check the key and try again.`),n&&(n.disabled=!1)}}async function uc({refresh:e}={}){if(yc.busy)return;yc.busy=!0;let t=document.getElementById(Sc.callrail.card.ids.sync);t&&(t.disabled=!0);try{let e=await(await fetch(`${N()}/m5t/v5/integrations/callrail/sync?days=7`,{method:`POST`})).json();if(!e.ok)throw Error(e.error||`sync failed`);let t=e.data?.connections?.[0]||{};mc(t.error?`Sync finished with errors.`:`Sync done. ${t.processed||0} new call${(t.processed||0)===1?``:`s`} recorded.`,t.error?`warning`:`success`)}catch{mc(`Sync failed.`,`error`)}finally{yc.busy=!1,t&&(t.disabled=!1),e?.()}}function dc(){if(Ec)return;let e=document.createElement(`style`);e.id=`m5t-intg-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Ec=!0}var fc,pc,M,mc,N,hc,gc,_c,vc,yc,bc,xc,Sc,Cc,wc,Tc,Ec,Dc=o((()=>{T(),fc=u(f(),1),m(),Ks(),pc={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},M=e=>String(e??``).replace(/[&<>"']/g,e=>pc[e]),mc=(e,t=`info`)=>{try{fc.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},N=()=>w.getConfig?.().BASE_URL||``,hc=()=>w.getActiveOrg()?.guid||w.getMemberships()[0]?.orgGuid||null,gc=()=>w.getCapabilities().includes(`manage_magnets`),_c=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,vc=(e,t=``)=>`<div class="intg-alert ${t}"><span class="material-symbols-outlined" aria-hidden="true">${t===`error`?`error`:`info`}</span><span>${e}</span></div>`,yc={busy:!1},bc=null,xc={google_ads:{what:`See ad spend lined up next to the leads it generated, so you know which campaigns are actually working.`,steps:[`Click Connect and sign in with a Google account that has access to your Ads accounts.`,`Choose which ad accounts should feed reporting.`,`Metrics refresh automatically once a day. Click Sync now any time for an immediate pull.`]},calendly:{what:`Let visitors book directly from a magnet conversation, and get notified the moment they do.`,steps:[`Click Connect and authorize your Calendly account.`,`Turn on Calendly booking for any magnet’s Book action, under Magnets.`,`Confirmed and canceled bookings sync back to the lead automatically. Webhooks need a paid Calendly plan; a free plan still lets visitors book, just without the automatic lead sync.`]},callrail:{what:`Every tracked phone call becomes a lead automatically, complete with recording and source.`,steps:[`In CallRail, go to Integrations, then Data access, then API keys, and create a key. Read-only works for calls; Allow Writes lets us set up call sync automatically.`,`Paste the key here and pick the account and company this workspace tracks.`,`Calls start landing in your Leads inbox within minutes.`]},google_analytics:{what:`See how visitors reach your site and behave once they get there. Sessions, pageviews, and engagement, right alongside the leads your magnets capture.`,steps:[`Click Connect and sign in with a Google account that has access to your GA4 property.`,`Choose which GA4 properties should feed reporting.`,`Metrics refresh automatically once a day. Click Sync now any time for an immediate pull.`]}},Sc={google_ads:{slug:`google_ads`,urlSlug:`google-ads`,label:`Google Ads`,logo:`integrations/google-ads.svg`,connect:{fallbackError:`Could not start the Google connection.`},disconnect:{confirm:`Daily metric refreshes stop until reconnected.`,toast:`Google Ads disconnected.`},card:{tint:`primary`,icon:`ads_click`,sub:`Spend and clicks beside your leads.`,ids:{connect:`intg-g-connect`,choose:`intg-g-accounts`,sync:`intg-g-sync`,disconnect:`intg-g-disconnect`,panel:`intg-g-picker`},chooseLabel:`Choose accounts`,idleDesc:`Connect a Google account with access to your ad accounts. Spend lines up against your magnet leads in Ad performance.`,brokenDesc:`The connection stopped working. Reconnect to resume daily metric refreshes.`,reachDesc:e=>`This connection can reach <b>${e}</b> ad account${e===1?``:`s`}. Choose which ones feed reporting; metrics refresh daily in Ad performance.`,noneDesc:`Connected, but no ad accounts are reachable from this Google account. Reconnect with an account that has Google Ads access.`,reachableCount:e=>e?.customer_ids?.length||0},picker:{path:`accounts`,itemsField:`accounts`,saveField:`customer_ids`,dataAttr:`intg-acct`,datasetKey:`intgAcct`,ids:{cancel:`intg-picker-cancel`,save:`intg-picker-save`},loading:`Loading your ad accounts…`,loadError:`Could not load your ad accounts. Try again, or reconnect if this keeps happening.`,heading:`Accounts that feed reporting`,emptyMsg:`No ad accounts are reachable from this Google account.`,namePrefix:`Account `,rowDisabled:e=>!!(e.manager||e.error),rowBadge:e=>e.manager?`Manager`:e.error?`Unavailable`:e.currency||``,savedToast:e=>`${e} account${e===1?``:`s`} linked. First sync is running.`,saveError:`Could not save account selection.`},sync:{itemsField:`accounts`,failedToast:e=>`Sync finished with ${e} account error${e===1?``:`s`}.`}},google_analytics:{slug:`google_analytics`,urlSlug:`google-analytics`,label:`Google Analytics`,logo:`integrations/google-analytics.svg`,connect:{fallbackError:`Could not start the Google Analytics connection.`},disconnect:{confirm:`Daily metric refreshes stop until reconnected.`,toast:`Google Analytics disconnected.`},card:{tint:`success`,icon:`monitoring`,sub:`Traffic and engagement beside your leads.`,ids:{connect:`intg-a-connect`,choose:`intg-a-properties`,sync:`intg-a-sync`,disconnect:`intg-a-disconnect`,panel:`intg-a-picker`},chooseLabel:`Choose properties`,idleDesc:`Connect a Google account with access to your GA4 property. Traffic and engagement line up against your magnet leads.`,brokenDesc:`The connection stopped working. Reconnect to resume daily metric refreshes.`,reachDesc:e=>`This connection can reach <b>${e}</b> GA4 propert${e===1?`y`:`ies`}. Choose which ones feed reporting; metrics refresh daily.`,noneDesc:`Connected, but no GA4 properties are reachable from this Google account. Reconnect with an account that has Analytics access.`,reachableCount:e=>e?.properties?.length||0},picker:{path:`properties`,itemsField:`properties`,saveField:`property_ids`,dataAttr:`intg-prop`,datasetKey:`intgProp`,ids:{cancel:`intg-a-picker-cancel`,save:`intg-a-picker-save`},loading:`Loading your GA4 properties…`,loadError:`Could not load your GA4 properties. Try again, or reconnect if this keeps happening.`,heading:`Properties that feed reporting`,emptyMsg:`No GA4 properties are reachable from this Google account.`,namePrefix:`Property `,rowDisabled:()=>!1,rowBadge:e=>e.account||``,savedToast:e=>`${e} propert${e===1?`y`:`ies`} linked. First sync is running.`,saveError:`Could not save property selection.`},sync:{itemsField:`properties`,failedToast:e=>`Sync finished with ${e} property error${e===1?``:`s`}.`}},calendly:{slug:`calendly`,urlSlug:`calendly`,label:`Calendly`,logo:`integrations/calendly.svg`,connect:{fallbackError:`Could not start the Calendly connection.`},disconnect:{confirm:`Magnet booking falls back to the built-in scheduler and booking sync stops.`,toast:`Calendly disconnected.`},card:{tint:`accent`,icon:`event`,sub:`Bookings on your magnets.`,ids:{connect:`intg-c-connect`,disconnect:`intg-c-disconnect`},idleDesc:`Connect Calendly and your magnets book real meetings: the Book button opens your calendar in the conversation, and confirmed bookings land on the lead automatically.`,brokenDesc:`The connection stopped working. Reconnect to resume booking sync.`}},callrail:{slug:`callrail`,urlSlug:`callrail`,label:`CallRail`,logo:`integrations/callrail.svg`,disconnect:{confirm:`Calls stop landing in your Leads inbox.`,toast:`CallRail disconnected.`},card:{tint:`info`,icon:`call`,sub:`Calls in your leads inbox.`,ids:{connect:`intg-r-connect`,sync:`intg-r-sync`,disconnect:`intg-r-disconnect`,setup:`intg-r-setup`},idleDesc:`Paste a CallRail API key and tracked phone calls land in your Leads inbox, with the caller, source, and recording on the lead.`,brokenDesc:`The connection stopped working. Reconnect with a current CallRail API key.`}}},Cc=[{label:`HubSpot`,logo:`integrations/hubspot.svg`,icon:`hub`,sub:`Leads into your CRM.`},{label:`Zapier`,logo:`integrations/zapier.svg`,icon:`bolt`,sub:`Anything into anything.`}],wc=Object.fromEntries(Object.values(Sc).map(e=>[e.urlSlug,e.slug])),Tc=e=>{let t=document.getElementById(`intg-r-status`);t&&(t.textContent=e)},Ec=!1})),Oc=c({default:()=>Rc,init:()=>Ac,render:()=>kc});function kc(){return dc(),na(),A()?sa({section:`settings-integrations`,title:`Integrations`,description:`Pick a client to manage their connections.`}):`
    <div class="page-shell" data-section="settings-integrations">
      ...
      <div id="intg-body">
        <div class="dashboard-card intg-card"><div class="card-body">${_c(`hourglass_empty`,`Loading…`)}</div></div>
      </div>
    </div>`}async function Ac(){if(A()){let e=e=>Number(e||0).toLocaleString();return ca(N(),[{h:`Magnets`,td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:`Leads · wk`,td:t=>e(t.leads.this_week)}],{emptyMsg:`No client orgs yet. Create one under Clients first.`})}jc()||await Mc()}function jc(){try{let e=new URLSearchParams(window.location.search),t=e.get(`connected`),n=e.get(`error`)?e.get(`provider`)||`google_ads`:null,r=null;if(t&&Object.hasOwn(Lc,t))mc(`${Lc[t]} connected.`,`success`),qs({slug:t,connected:!0}),r=Object.hasOwn(Sc,t)?Sc[t]:null;else if(n){let t=Object.hasOwn(Lc,n)?Lc[n]:n;mc(`${t} connection failed (${e.get(`error`)}).`,`error`),r=Object.hasOwn(Sc,n)?Sc[n]:null}else return!1;return window.history.replaceState(null,``,window.location.pathname+window.location.hash),r?(window.router?.navigate(`/settings/integrations/${r.urlSlug}`),!0):!1}catch{return!1}}async function Mc(){let e=document.getElementById(`intg-body`);try{let{denied:t,providers:n,configured:r}=await $s();if(t){e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${_c(`lock`,`Integrations are managed by workspace admins.`)}</div></div>`);return}e&&(e.innerHTML=Ic(n,r))}catch{e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${_c(`error`,`Could not load integrations.`)}</div></div>`)}}function Nc(e,t,n){let r=Zs(e,t,n);return`
    ...
    </div>`}function Ic(e,t){return`<div class="intg-grid">${Object.values(Sc).map(n=>Nc(n,Xs(e,n.slug),!!t?.[n.slug])).join(``)}${Cc.length?`<div class="intg-grid__soon-label">Coming soon</div>${Cc.map(Fc).join(``)}`:``}</div>`}var Lc,Rc,zc=o((()=>{Dc(),ga(),Lc=Object.fromEntries(Object.values(Sc).filter(e=>e.connect).map(e=>[e.slug,e.label])),Rc={render:kc,init:Ac}})),Bc=c({default:()=>nl,init:()=>Hc,render:()=>Vc});function Vc({provider:e}={}){dc(),na();let t=wc[e];if(!t||A())return`<div class="page-shell"></div>`;let n=Sc[t];return P.provider=n,`
    <div class="page-shell" data-section="settings-integrations">
    ...
    </div>`}async function Hc({provider:e}={}){let t=wc[e];if(!t||A()){window.router?.navigate(`/settings/integrations`,{historyAPIMethod:`replaceState`});return}await Uc();let n=Js();n?.connected&&n.slug===t&&P.provider?.picker&&gc()&&rc(P.provider,{refresh:Uc})}async function Uc(){let e=document.getElementById(`intg-detail`);if(!(!e||!P.provider))try{let{denied:t,providers:n,configured:r}=await $s();if(t){e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${_c(`lock`,`Integrations are managed by workspace admins.`)}</div></div>`;return}P.conn=Xs(n,P.provider.slug),P.configured=!!r?.[P.provider.slug],P.status=Zs(P.provider,P.conn,P.configured),e.innerHTML=Wc(),Qc()}catch{e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${_c(`error`,`Could not load this integration.`)}</div></div>`}}function Wc(){let e=P.provider;return[Kc(e),qc(e),Jc(e),Xc(e),Zc(e)].filter(Boolean).join(``)}function Gc(e){let t=P.conn?.external_account||{};if(P.status!==`connected`)return e.card.sub;if(e.slug===`calendly`){let e=[t.name,t.email&&`(${t.email})`].filter(Boolean).join(` `);return e?`Connected as ${e}.`:`Connected.`}if(e.slug===`callrail`){let e=[t.account_name,t.company_name].filter(Boolean).join(` · `);return e?`Connected to ${e}.`:`Connected.`}let n=e.card.reachableCount(t);return n?`${n} reachable ${e.slug===`google_analytics`?n===1?`property`:`properties`:n===1?`account`:`accounts`}.`:`Connected.`}function Kc(e){let t=``;gc()&&(e.connect&&(P.status===`idle`||P.status===`broken`)&&P.configured&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${P.status===`broken`?`Reconnect`:`Connect`}</button>`),e.slug===`callrail`&&P.status!==`connected`&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${P.status===`broken`?`Reconnect`:`Connect`}</button>`));let n;return n=P.status===`unavailable`?`${e.label} is being set up for this platform.`:P.status===`broken`?e.card.brokenDesc:P.status===`idle`?gc()?e.card.idleDesc:e.card.sub:Gc(e),`
    ...
    </div>`}function qc(e){let t=xc[e.slug];return t?P.status===`connected`||P.status===`unavailable`||!gc()?`
      <div class="dashboard-card intg-card">
        <div class="card-body">
    ...
    <div class="dashboard-card intg-card">
    ...
    </div>`:``}function Jc(e){if(P.status!==`connected`)return``;let t=gc();if(e.picker){let n=e.card.reachableCount(P.conn?.external_account);return`
      <div class="dashboard-card intg-card">
        <div class="card-body">
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-g-convactions">${vc(`Loading conversion actions…`)}</div>
        </div>
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-c-events">${vc(`Loading event types…`)}</div>
        </div>
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-r-trackers">${vc(`Loading tracking numbers…`)}</div>
          <div class="intg-actions" style="justify-content:flex-start;margin-top:12px">
            <button type="button" class="intg-btn" id="${e.card.ids.sync}"><span class="material-symbols-outlined" aria-hidden="true">sync</span>Sync now</button>
      ...
      </div>`:``}function Yc(e){if(!e)return``;try{return new Date(e).toLocaleDateString([],{month:`short`,day:`numeric`,year:`numeric`})}catch{return String(e).slice(0,10)}}function Xc(e){if(!P.conn)return``;let t=P.conn.webhook||{},n=[];n.push([`Status`,P.status===`connected`?`Active`:P.conn.connect_status===`NEEDS_REAUTH`?`Needs reconnecting`:`Error`]),e.slug===`calendly`&&(n.push([`Booking sync`,t.state===`active`?`On`:`Off (paid Calendly plan required)`]),t.last_received_tz&&n.push([`Last booking received`,Yc(t.last_received_tz)])),e.slug===`callrail`&&(n.push([`Call sync`,t.state===`active`?`On`:`Needs attention`]),t.cookie_capture&&n.push([`Session capture`,t.cookie_capture===`active`?`On`:`Needs attention`]),t.last_received_tz&&n.push([`Last call received`,Yc(t.last_received_tz)])),P.conn.created?.created_tz&&n.push([`Connected on`,Yc(P.conn.created.created_tz)]);let r=e.slug===`calendly`&&P.status===`connected`&&t.state!==`active`?vc(`Booking sync is off: webhooks need a paid Calendly plan. Visitors can still book in the magnet; bookings just will not appear on the lead automatically. Reconnect after upgrading to turn it on.`,`error`):e.slug===`callrail`&&P.status===`connected`&&t.state!==`active`?vc(`Automatic call sync could not be set up in CallRail. Calls still arrive via the daily sweep and Sync now. Reconnect to retry the setup.`,`error`):``;return`
    <div class="dashboard-card intg-card">
      <div class="card-body">
    ...
    </div>`}function Zc(e){return P.status!==`connected`&&P.status!==`broken`||!gc()?``:`
    <div class="dashboard-card intg-card settings-danger">
    ...
    </div>`}function Qc(){let e=P.provider;if(!e)return;let t=Uc;e.connect&&document.getElementById(e.card.ids.connect)?.addEventListener(`click`,()=>ec(e)),e.slug===`callrail`&&(document.getElementById(e.card.ids.connect)?.addEventListener(`click`,()=>oc({refresh:t})),document.getElementById(`intg-r-replace`)?.addEventListener(`click`,()=>oc({refresh:t,replaceKey:!0})),document.getElementById(e.card.ids.sync)?.addEventListener(`click`,()=>uc({refresh:t})),P.status===`connected`&&gc()&&tl()),e.picker&&(document.getElementById(e.card.ids.choose)?.addEventListener(`click`,()=>rc(e,{refresh:t})),document.getElementById(e.card.ids.sync)?.addEventListener(`click`,()=>tc(e,{refresh:t}))),e.slug===`google_ads`&&P.status===`connected`&&gc()&&$c(),e.slug===`calendly`&&P.status===`connected`&&gc()&&el(),document.getElementById(e.card.ids.disconnect)?.addEventListener(`click`,()=>nc(e,{refresh:t}))}async function $c(){let e=document.getElementById(`intg-g-convactions`);if(e)try{let t=await(await fetch(`${N()}/m5t/v5/integrations/google_ads/conversion_actions`)).json();if(!t.ok)throw Error(t.error||`load failed`);let n=t.data.actions||[],r=new Set(t.data.selected||[]);if(!n.length){e.innerHTML=vc(`No enabled conversion actions in the linked accounts.`);return}e.innerHTML=`
      ...
      </div>`,en(e.querySelector(`.intg-ca-list`),{rowSelector:`.intg-ca-row`,noun:`actions`}),document.getElementById(`intg-g-ca-save`)?.addEventListener(`click`,async()=>{let t=document.getElementById(`intg-g-ca-save`),n=[...e.querySelectorAll(`input[type="checkbox"]:checked`)].map(e=>e.value);t.disabled=!0;try{let e=await(await fetch(`${N()}/m5t/v5/integrations/google_ads/conversion_actions`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({conversion_action_ids:n})})).json();if(!e.ok)throw Error(e.error||`save failed`);mc(n.length?`Counting ${n.length} conversion action${n.length===1?``:`s`} in reporting.`:`Conversion counting turned off.`,`success`)}catch(e){mc(e.message||`Could not save the selection.`,`error`)}finally{t.disabled=!1}})}catch{e.innerHTML=vc(`Could not load conversion actions. If this keeps happening, reconnect.`,`error`)}}async function el(){let e=document.getElementById(`intg-c-events`);if(e)try{let t=await(await fetch(`${N()}/m5t/v5/integrations/calendly/event_types`)).json();if(!t.ok)throw Error(t.error||`load failed`);let n=t.data.event_types||[],r=t.data.scheduling_url?`<div class="intg-ev"><span class="intg-ev__name">Full scheduling page</span><span class="intg-ev__meta">${M(t.data.scheduling_url)}</span></div>`:``;e.innerHTML=n.length||r?`${r}${n.map(e=>`
          <div class="intg-ev">
            <span class="intg-ev__name">${M(e.name)}</span>
            <span class="intg-ev__meta">${e.duration?`${M(String(e.duration))} min`:``}</span>
          </div>`).join(``)}`:vc(`No active event types on this Calendly account.`),en(e,{rowSelector:`.intg-ev`,noun:`event types`})}catch{e.innerHTML=vc(`Could not load event types. If this keeps happening, reconnect.`,`error`)}}async function tl(){let e=document.getElementById(`intg-r-trackers`);if(e)try{let t=await(await fetch(`${N()}/m5t/v5/integrations/callrail/trackers`)).json();if(!t.ok)throw Error(t.error||`load failed`);let n=t.data.trackers||[];e.innerHTML=n.length?n.map(e=>`
          <div class="intg-ev">
            <span class="intg-ev__name">${M(e.name)}</span>
            <span class="intg-ev__meta">${M(e.number)}${e.type===`session`?` · number pool`:``}</span>
          </div>`).join(``):vc(`No active tracking numbers in this company yet. Create one in CallRail and it appears here.`),en(e,{rowSelector:`.intg-ev`,noun:`numbers`})}catch{e.innerHTML=vc(`Could not load tracking numbers.`,`error`)}}var P,nl,rl=o((()=>{Dc(),ga(),nn(),P={provider:null,conn:null,configured:!1,status:`idle`},nl={render:Vc,init:Hc}})),il=c({default:()=>Dl,init:()=>sl,render:()=>ol});function al(){if(Cl)return;let e=document.createElement(`style`);e.id=`m5t-security-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Cl=!0}function ol(){return al(),`
    <div class="page-shell" data-section="settings-security">
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Signing in as ${yl(hl())}. You stay signed in on this device after a change.</p>
            </div>
          </div>
          <div class="settings-grid-2">
            <div class="settings-field">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="pk-body">${wl(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function sl(){document.getElementById(`pw-save`)?.addEventListener(`click`,gl);let e=document.getElementById(`pk-add-btn`);e&&window.PublicKeyCredential&&(e.style.display=``,e.addEventListener(`click`,pl)),await cl()}async function cl(){let e=document.getElementById(`pk-body`);if(e){try{let e=await fetch(`${xl()}/m5t/v5/webauthn`),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(t.error||`Failed to load`);Sl.passkeys=t.passkeys||[],Sl.loaded=!0}catch(t){console.warn(`[settings-security] load failed:`,t),e.innerHTML=wl(`error`,`Could not load your passkeys. Please try again.`);return}dl()}}function ll(e){if(!e)return null;try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return null}}function ul(e){let t=ll(e.last_used_time),n=e.created?.created_tz,r=ll(n),i=[e.device_type===`multiDevice`?`Syncs across devices`:`This device only`,t?`Last used ${t}`:`Never used to sign in yet`,r?`Added ${r}`:null].filter(Boolean).join(` · `);return`
    <div class="pk-row" data-guid="${yl(e.guid)}">
      <span class="pk-icon"><span class="material-symbols-outlined" aria-hidden="true">passkey</span></span>
      <div class="pk-info">
        <div class="pk-name">${yl(e.device_label||`Passkey`)}</div>
        <div class="pk-meta">${yl(i)}</div>
      </div>
      <button class="pk-btn pk-btn--danger" type="button" data-remove="${yl(e.guid)}">
        <span class="material-symbols-outlined" aria-hidden="true">delete</span> Remove
      </button>
    </div>`}function dl(){let e=document.getElementById(`pk-body`);if(e){if(!window.PublicKeyCredential){e.innerHTML=`<p class="pk-unsupported">This browser doesn't support passkeys. Your password sign-in still works as usual.</p>`;return}if(!Sl.passkeys.length){e.innerHTML=wl(`passkey`,`No passkeys yet. Add one for a faster, phishing-resistant sign-in.`);return}e.innerHTML=Sl.passkeys.map(ul).join(``),en(e,{rowSelector:`.pk-row`,noun:`passkeys`}),e.querySelectorAll(`[data-remove]`).forEach(e=>{e.addEventListener(`click`,()=>ml(e.dataset.remove,e))})}}function fl(){try{let e=navigator.userAgent||``,t=/iPhone/.test(e)?`iPhone`:/iPad/.test(e)?`iPad`:/Android/.test(e)?`Android`:/Mac OS X/.test(e)?`Mac`:/Windows/.test(e)?`Windows`:/Linux/.test(e)?`Linux`:`device`,n=/Edg\//.test(e)?`Edge`:/Chrome\//.test(e)?`Chrome`:/Firefox\//.test(e)?`Firefox`:/Safari\//.test(e)?`Safari`:``;return n?`${n} on ${t}`:t}catch{return`Passkey`}}async function pl(){let e=document.getElementById(`pk-add-btn`);e&&(e.disabled=!0);try{let{startRegistration:e}=await S(async()=>{let{startRegistration:e}=await Promise.resolve().then(()=>(Ht(),Vt));return{startRegistration:e}},void 0,import.meta.url),t=await fetch(`${xl()}/m5t/v5/webauthn/register/options`,{method:`POST`}),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.error||`Could not start passkey registration`);let r;try{r=await e({optionsJSON:n.options})}catch(e){if(e?.name===`NotAllowedError`)return;throw e}let i=await fetch(`${xl()}/m5t/v5/webauthn/register/verify`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({response:r,deviceLabel:fl()})}),a=await i.json().catch(()=>({}));if(!i.ok||!a.ok)throw Error(a.error||`Could not register this passkey`);bl(`Passkey added`,`success`),await cl()}catch(e){console.warn(`[settings-security] addPasskey failed:`,e),bl(e.message||`Could not add a passkey`,`danger`)}finally{e&&(e.disabled=!1)}}async function ml(e,t){if(await Us({title:`Remove this passkey?`,message:`You can always add it back later.`,confirmLabel:`Remove`,danger:!0})){t&&(t.disabled=!0);try{let t=await fetch(`${xl()}/m5t/v5/webauthn/${encodeURIComponent(e)}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.error||`Could not remove this passkey`);Sl.passkeys=Sl.passkeys.filter(t=>t.guid!==e),bl(`Passkey removed`,`success`),dl()}catch(e){console.warn(`[settings-security] removePasskey failed:`,e),bl(e.message||`Could not remove this passkey`,`danger`),t&&(t.disabled=!1)}}}function hl(){try{return w.getScope()?.entity?.email||w.getEntity?.()?.email||`your account`}catch{return`your account`}}async function gl(){let e=document.getElementById(`pw-new`),t=document.getElementById(`pw-confirm`),n=document.getElementById(`pw-save`),r=e?.value||``,i=t?.value||``,a=Si(r);if(a.length){Tl(`Password needs: ${El(a)}.`);return}if(r!==i){Tl(`Passwords do not match.`);return}Tl(``),n&&(n.disabled=!0);try{let n=await fetch(`${xl()}/m5t/v5/acctEntity/resetHash`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({password:r})}),i=await n.json().catch(()=>({}));if(!n.ok||!i.ok)throw Error(i.error||`Could not update your password`);bl(`Password updated`,`success`),e&&(e.value=``),t&&(t.value=``)}catch(e){Tl(e.message||`Could not update your password.`)}finally{n&&(n.disabled=!1)}}var _l,vl,yl,bl,xl,Sl,Cl,wl,Tl,El,Dl,Ol=o((()=>{T(),_l=u(f(),1),m(),Ks(),wi(),nn(),st(),vl={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},yl=e=>String(e??``).replace(/[&<>"']/g,e=>vl[e]),bl=(e,t=`info`)=>{try{_l.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},xl=()=>w.getConfig?.().BASE_URL||``,Sl={passkeys:[],loaded:!1},Cl=!1,wl=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Tl=e=>{let t=document.getElementById(`pw-error`);t&&(t.textContent=e||``,t.hidden=!e)},El=e=>e.length<=1?String(e[0]??``):e.length===2?`${e[0]} and ${e[1]}`:`${e.slice(0,-1).join(`, `)}, and ${e[e.length-1]}`,Dl={render:ol,init:sl}})),kl=c({default:()=>Zl,init:()=>Ll,render:()=>Il});function Al(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(` `).trim()||e.email)||null}function jl(e){return(e.split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``)||`?`).toUpperCase()}function Ml(e){try{return new Date(e).toLocaleString([],{month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`})}catch{return``}}function Nl(e){try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return``}}function Pl(e){return e==null?`—`:e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,`0`)}s`}function Fl(){if(Jl)return;let e=document.createElement(`style`);e.id=`m5t-convs-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Jl=!0}function Il(){return Fl(),na(),`
    <div class="page-shell" data-section="conversations">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="convs-body">
          ${Yl(`hourglass_empty`,`Loading journeys…`)}
        </div>
      </div>
    </div>`}async function Ll(){await Rl()}async function Rl(){let e=document.getElementById(`convs-body`);if(e){try{let[e,t]=await Promise.all([fetch(`${Wl()}/m5t/v5/conversations`),fetch(`${Wl()}/m5t/v5/magnets`).catch(()=>null)]),n=await e.json().catch(()=>({}));if(!n.ok)throw Error(n.message||`Failed to load`);if(I.conversations=n.conversations||[],I.counts=n.counts||{},I.book=A(),t){let e=await t.json().catch(()=>({}));I.magnetNames={},I.magnetOwnerNames={};let n=I.book?la():{};(e.magnets||[]).forEach(e=>{I.magnetNames[e.guid]=e.name,I.book&&(I.magnetOwnerNames[e.guid]=e.owner_name||n[e.owner_guid]||``)})}}catch(t){console.warn(`[conversations] load failed:`,t),e.innerHTML=Yl(`error`,`Could not load journeys. Please try again.`);return}Vl()}}function zl(){return I.filter===`ALL`?I.conversations:I.conversations.filter(e=>e.status===I.filter)}function Bl(e){let t=Al(e.lead),n=I.magnetNames[e.magnet_guid]||`—`,r=Kl[e.status]||Kl.ABANDONED,i=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,a=(e.routes||[]).map(e=>ql[e]||e).join(`, `);return`
    <tr class="convs-row" data-session="${F(e.session)}">
      <td>
        <span class="convs-who">
          <span class="convs-ava${t?``:` anon`}">${t?F(jl(t)):`<span class="material-symbols-outlined" style="font-size:16px">person_off</span>`}</span>
      ...
      ${I.book?`<td>${ha(I.magnetOwnerNames[e.magnet_guid]||``)||`<span class="convs-muted">—</span>`}</td>`:``}
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${F(Ml(e.started_at))}">${F(Nl(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${F(Pl(e.duration_s))}</td>
    </tr>`}function Vl(){let e=document.getElementById(`convs-body`);if(!e)return;if(!I.conversations.length){e.innerHTML=Yl(`route`,`No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.`);return}let t=zl();e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${[[`ALL`,`All`],[`COMPLETED`,`Completed`],[`IN_PROGRESS`,`In progress`],[`ABANDONED`,`Abandoned`]].map(([e,t])=>`<button data-filter="${e}" class="${I.filter===e?`active`:``}">${t}${e!==`ALL`&&I.counts[e]?` (${Gl(I.counts[e])})`:``}</button>`).join(``)}
      </div>
      <span class="convs-count">${Gl(t.length)} of ${Gl(I.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(Bl).join(``)||`<tr><td colspan="${I.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${I.filter.toLowerCase().replace(`_`,` `)} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`;let n=e.querySelector(`#convs-tbody`);n&&en(n,{rowSelector:`tr.convs-row`,noun:`journeys`,controlHost:e.querySelector(`.convs-tablewrap`)||n.parentElement}),e.querySelector(`.convs-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(I.filter=t.dataset.filter,Vl())}),e.querySelector(`#convs-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`.convs-row`);t&&Hl(t.dataset.session)})}async function Hl(e){let t=I.conversations.find(t=>t.session===e);if(!t)return;let n=null;try{n=await(await fetch(`${Wl()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),n?.ok||(n=null)}catch{n=null}let r=Al(t.lead),i=I.magnetNames[t.magnet_guid]||`—`,a=(n?.events||[]).filter((e,t,n)=>e.event!==`step`||!(n[t+1]&&n[t+1].event===`step`)).map(e=>`
    <div class="convs-tl__item${e.event===`complete`?` done`:``}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${F((Xl[e.event]||(()=>e.event))(e.detail))}</div>
      <div class="convs-tl__time">${F(Ml(e.at))}${e.variant?` · Variant ${F(e.variant)}`:``}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      ...
      <div class="convs-drawer__body">
        ${r?`<a class="convs-drawer__lead" href="#/leads">
              <span class="convs-ava">${F(jl(r))}</span>
        ...
        <div class="convs-sub" style="margin-bottom:6px">${F(i)} · ${F(Pl(t.duration_s))}${t.variant?` · Variant ${F(t.variant)}`:``}</div>
        ${a?`<div class="convs-tl">${a}</div>`:Yl(`timeline`,`No timeline available for this journey.`)}
      </div>
    </aside>`,document.body.appendChild(o),requestAnimationFrame(()=>{o.classList.add(`open`),o.querySelector(`.convs-drawer`).classList.add(`open`)});let s=()=>{o.classList.remove(`open`),setTimeout(()=>o.remove(),220)};o.querySelector(`.convs-drawer__close`).addEventListener(`click`,s),o.addEventListener(`click`,e=>{e.target===o&&s()})}var Ul,F,Wl,Gl,I,Kl,ql,Jl,Yl,Xl,Zl,Ql=o((()=>{T(),ga(),nn(),Ul={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},F=e=>String(e??``).replace(/[&<>"']/g,e=>Ul[e]),Wl=()=>w.getConfig?.().BASE_URL||``,Gl=e=>Number(e||0).toLocaleString(),I={conversations:[],counts:{},magnetNames:{},filter:`ALL`,book:!1,magnetOwnerNames:{}},Kl={COMPLETED:{label:`Completed`,icon:`check_circle`},IN_PROGRESS:{label:`In progress`,icon:`pending`},ABANDONED:{label:`Abandoned`,icon:`highlight_off`}},ql={book:`Book`,chat:`Chat`,call:`Call`,email:`Email`,support:`Support`},Jl=!1,Yl=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Xl={open:()=>`Opened the magnet`,engage:e=>`First interaction${e?`: ${ql[e]||e}`:``}`,route:e=>`Picked ${ql[e]||e||`a channel`}`,step:e=>`Reached step ${e||``}`,complete:()=>`Completed: lead captured`},Zl={render:Il,init:Ll}})),$l=c({default:()=>Cu,init:()=>nu,render:()=>tu});function eu(){if(xu)return;let e=document.createElement(`style`);e.id=`m5t-abt-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),xu=!0}function tu(){return A()?sa({section:`ab-testing`,title:`A/B Testing`,description:`Pick a client to view their experiments.`}):(eu(),`
    <div class="page-shell" data-section="ab-testing">
      ...
      <div id="abt-body">${Su(`hourglass_empty`,`Loading tests…`)}</div>
    </div>`)}async function nu(){if(A())return ca(_u(),[{h:`Running`,td:e=>vu(e.ab_tests?.running)},{h:`Completed`,td:e=>vu(e.ab_tests?.completed)},{h:`Compl. %`,td:e=>e.completion_rate==null?`—`:`${e.completion_rate}%`}],{emptyMsg:`No client orgs yet. Experiments appear per client once you have one.`});let e=document.getElementById(`abt-body`);try{let e=new Date,t=new Date(e.getTime()-76896e5).toISOString().slice(0,10),n=e.toISOString().slice(0,10),[r,i]=await Promise.all([fetch(`${_u()}/m5t/v5/magnets`),fetch(`${_u()}/m5t/v5/magnets/stats?from=${t}&to=${n}`)]),a=await r.json().catch(()=>({}));if(!a.ok)throw Error(a.message||`Failed to load`);yu.magnets=a.magnets||[],yu.canManage=!!a.canManage;let o=await i.json().catch(()=>({}));yu.stats=o?.stats||{}}catch(t){console.warn(`[ab-testing] load failed:`,t),e&&(e.innerHTML=Su(`error`,`Could not load your tests. Please try again.`));return}ru()}function ru(){let e=document.getElementById(`abt-body`);if(!e)return;let t=yu.magnets.filter(e=>e.ab?.enabled),n=yu.magnets.filter(e=>!e.ab?.enabled&&e.ab?.declared);if(!t.length&&!n.length){e.innerHTML=Su(`science`,`No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.`);return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(cu).join(``)}`:``)+(n.length?`<div class="abt-sect">Completed Tests</div>${n.map(lu).join(``)}`:``),en(e,{rowSelector:`.abt-card`,noun:`tests`}),e.querySelectorAll(`[data-declare]`).forEach(e=>e.addEventListener(`click`,()=>uu(e.dataset.declare,e.dataset.winner)))}function iu(e){let t=yu.stats[e.guid]?.variants||{};return{A:{opens:0,engaged:0,completions:0,rate:null,...t.A||{}},B:{opens:0,engaged:0,completions:0,rate:null,...t.B||{}}}}function au(e){let t=Object.keys(e?.b||{}).map(e=>bu[e]||e);return t.length?`Changes: ${t.join(`, `)}`:``}function ou(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function su(e,t,n,r,i,a){return`
    <div class="abt-variant${i?` leader`:``}">
      <div class="abt-vhead"><span class="abt-vname">${hu(e)}</span><span class="abt-vtag${i?` win`:``}">${hu(t)}</span></div>
      ${n?`<div class="abt-vdesc">${hu(n)}</div>`:``}
      <div class="abt-mrow"><span class="k">Visitors</span><span class="v">${vu(r.opens)}</span></div>
      <div class="abt-mrow"><span class="k">Completions</span><span class="v">${vu(r.completions)}</span></div>
    ...
    </div>`}function cu(e){let t=e.ab,{A:n,B:r}=iu(e),i=(r.rate??-1)>(n.rate??-1)?`B`:(n.rate??-1)>(r.rate??-1)?`A`:null,a=i&&n.rate!=null&&r.rate!=null?`+${Math.round(Math.abs(r.rate-n.rate)*10)/10}%`:``,o=du(n,r),s=t.started_tz?ou(t.started_tz):null,c=(n.opens||0)+(r.opens||0),l=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
        <h2 class="abt-name">${hu(e.name)}</h2>
        <span class="abt-status running"><span class="pulse-dot"></span>Running</span>
        <div class="abt-actions">
          ${yu.canManage&&i?`<button class="btn btn-primary" type="button" data-declare="${hu(e.guid)}" data-winner="${i}"><span class="material-symbols-outlined" aria-hidden="true">emoji_events</span>Declare Winner</button>`:``}
        </div>
      </div>
      <div class="abt-meta">
        ${s==null?``:`<span><span class="material-symbols-outlined" aria-hidden="true">schedule</span>Started ${s===0?`today`:`${s} day${s===1?``:`s`} ago`}</span>`}
        <span><span class="material-symbols-outlined" aria-hidden="true">visibility</span>${vu(c)} total visitors</span>
      ...
      <div class="abt-compare">
        ${su(`Variant A`,`Control`,`The magnet as configured`,n,i===`A`,i===`A`?a:``)}
        <div class="abt-vs">VS</div>
        ${su(`Variant B`,i===`B`?`Leading`:`Challenger`,au(t),r,i===`B`,i===`B`?a:``)}
      </div>
      <div class="abt-sig">
    ...
    <div class="abt-card">
      ...
      <div class="abt-summary">
        <span><span class="k">Winner:</span><span class="v">Variant ${hu(t.winner)}</span></span>
        ...
        <span><span class="k">Total Visitors:</span><span class="v">${vu(o)}</span></span>
      </div>
    </div>`}async function uu(e,t){let n=yu.magnets.find(t=>t.guid===e);if(n&&window.confirm(`Declare Variant ${t} the winner for “${n.name}”?\n\n${t===`B`?`Variant B’s changes become the magnet’s configuration for everyone.`:`The magnet keeps its current configuration.`} The experiment ends and moves to Completed.`)){try{let n=await(await fetch(`${_u()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!n.ok)throw Error(n.message||`Declare failed`);gu(`Variant ${t} declared the winner`,`success`)}catch(e){gu(e.message||`Could not declare a winner`,`danger`);return}try{await nu()}catch(e){console.warn(`[ab-testing] refresh after declare failed:`,e)}}}function du(e,t){let n=e.opens||0,r=t.opens||0,i=e.completions||0,a=t.completions||0;if(n<30||r<30||i+a<5)return null;let o=i/n,s=a/r,c=(i+a)/(n+r),l=Math.sqrt(c*(1-c)*(1/n+1/r));if(!l)return null;let u=Math.abs(s-o)/l;return Math.round(2*(fu(u)-.5)*1e3)/10}function fu(e){let t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}var pu,mu,hu,gu,_u,vu,yu,bu,xu,Su,Cu,wu=o((()=>{T(),pu=u(f(),1),m(),ga(),nn(),mu={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},hu=e=>String(e??``).replace(/[&<>"']/g,e=>mu[e]),gu=(e,t=`info`)=>{try{pu.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},_u=()=>w.getConfig?.().BASE_URL||``,vu=e=>Number(e||0).toLocaleString(),yu={magnets:[],stats:{},canManage:!1},bu={mag_title:`header title`,mag_subtitle:`subtitle`,mag_welcome:`welcome message`,mag_theme_color:`color`,mag_launcher_label:`launcher label`},xu=!1,Su=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Cu={render:tu,init:nu}}));function Tu(e,t){let n={};return Object.keys(e&&typeof e==`object`?e:{}).forEach(r=>{t.includes(r)||(n[r]=e[r])}),Object.keys(n).length?n:null}function Eu(e){return Tu(e,md)}function Du(e,t){let n=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||``).trim());return n?`rgba(${parseInt(n[1],16)},${parseInt(n[2],16)},${parseInt(n[3],16)},${t})`:`rgba(0,114,186,${t})`}function Ou(){if(_d)return;let e=document.createElement(`style`);e.id=`m5t-flow-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),_d=!0}function ku(e=`single_select`){return{_uid:Od(),id:``,step_type:e,step_prompts:[``],step_options:cd(e)?[{label:``,goto:``,icon:``},{label:``,goto:``,icon:``}]:[],step_columns:fd(e)?[fd(e)]:[],step_description:``,step_config:ud(e)?pd():null}}function Au(e){return(Array.isArray(e)?e:[]).map(e=>({_uid:Od(),id:e.id==null?``:String(e.id),step_type:id[e.step_type]?e.step_type:`single_select`,step_prompts:Array.isArray(e.step_prompts)?e.step_prompts.map(String):[],step_options:(Array.isArray(e.step_options)?e.step_options:[]).map(e=>({label:e&&e.label!=null?String(e.label):``,goto:e&&e.goto!=null?String(e.goto):``,icon:e&&e.icon!=null?String(e.icon):``})),step_columns:Array.isArray(e.step_columns)?e.step_columns.map(String):[],step_description:e.step_description==null?``:String(e.step_description),step_config:ud(e.step_type)?{...pd(),...e.step_config&&typeof e.step_config==`object`?e.step_config:{}}:e.step_config&&typeof e.step_config==`object`?{...e.step_config}:null}))}function ju(){return[{_uid:Od(),id:``,step_type:`text`,step_prompts:[`Great, and your name?`],step_options:[],step_columns:[`first_name`],step_description:``,step_config:null},{_uid:Od(),id:``,step_type:`email`,step_prompts:[`The best email to reach you?`],step_options:[],step_columns:[`email`],step_description:``,step_config:null}]}function Mu(e,t){if(e===`book`)return[{_uid:Od(),id:``,step_type:`scheduler`,step_prompts:[`When works best for you?`],step_options:[],step_columns:[],step_description:``,step_config:pd()},...ju()];if(e===`support`){let e=(t.actions||[]).find(e=>e&&e.type===`support`),n=e&&e.config&&Array.isArray(e.config.options)?e.config.options:[],r=n.length?n.map(e=>({label:e&&e.label||String(e),goto:``,icon:e&&e.icon||``})):[`Sales enquiry`,`Support`,`Billing`,`Something else`].map(e=>({label:e,goto:``,icon:``}));return[{_uid:Od(),id:``,step_type:`multi_select`,step_prompts:[`How can we help you today?`],step_options:r,step_columns:[],step_description:`Select all that apply`,step_config:null},...ju()]}return[ku(`single_select`)]}function Nu(e,t){let n=Au(e===`chat`?t.steps:t.routes&&t.routes[e]);return n.length?n:e===`chat`?[ku(`single_select`)]:Mu(e,t)}function Pu(e){cd(e.step_type)?e.step_options.length||(e.step_options=[{label:``,goto:``,icon:``},{label:``,goto:``,icon:``}]):e.step_options=[],ld(e.step_type)?!e.step_columns.length&&fd(e.step_type)&&(e.step_columns=[fd(e.step_type)]):e.step_columns=[],e.step_config=ud(e.step_type)?{...pd(),...e.step_config||{}}:Eu(e.step_config)}function Fu(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${L(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${gd.map(([t,n])=>`<option value="${L(t)}"${t===e.icon?` selected`:``}>${L(n)}</option>`).join(``)}</select>
  ...
  </div>`}function Iu(e){let t=ad.map(t=>`<option value="${t}"${t===e.step_type?` selected`:``}>${L(sd(t).label)}</option>`).join(``),n=e.step_options.length<=1;return`<div class="flow-node__body">
...
`))}</textarea>
    ...
    <div class="flow-opts">${e.step_options.map(e=>Fu(e,n)).join(``)}</div>
  ...
  </div>`}function Lu(e){let t=e.step_prompts.find(e=>String(e).trim()!==``)||``,n=t?`<div class="flow-node__prompt">“${L(t)}”</div>`:`<div class="flow-node__prompt is-empty">${e.step_type===`message`?`No message yet`:`No question yet`}</div>`,r=``;if(cd(e.step_type)){let t=e.step_options.map(e=>String(e.label).trim()).filter(Boolean);t.length&&(r=`<div class="flow-node__chips">${t.slice(0,4).map(e=>`<span class="flow-node__chip">${L(e)}</span>`).join(``)}${t.length>4?`<span class="flow-node__chip">+${t.length-4}</span>`:``}</div>`)}else if(ld(e.step_type)&&e.step_columns[0]){let t=He.find(t=>t.value===e.step_columns[0])?.label||e.step_columns[0];r=`<div class="flow-node__meta">Saves to <b>${L(t)}</b></div>`}else if(dd(e.step_type)&&e.step_config?.terminal){let t=String(e.step_config?.cta?.label||``).trim();r=`<div class="flow-node__meta">Ends the conversation${t?` — link: <b>${L(t)}</b>`:``}</div>`}return`<div class="flow-node__preview">${n}${r}</div>`}function Ru(e,t,n){let r=sd(e.step_type),i=e._uid===vd,a=`--nc:${r.color};--nct:${Du(r.color,.14)}`;return`<div class="flow-node${i?` flow-node--open`:``}" data-uid="${e._uid}" style="${a}"${i?``:` draggable="true"`}>
    ...
    ${i?Iu(e):Lu(e)}
  </div>`}function zu(){let e=document.getElementById(`flow-nodes`);if(!e)return;let t=R.length,n=[`<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>`,kd];R.forEach((e,r)=>{n.push(Ru(e,r,t)),r<t-1&&n.push(kd)}),e.innerHTML=n.join(``)}function Bu(){let e=document.querySelector(`.flow-node--open`);if(!e)return;let t=R.find(t=>t._uid===e.dataset.uid);if(!t)return;let n=e.querySelector(`.flow-f-type`);n&&(t.step_type=n.value);let r=e.querySelector(`.flow-f-prompts`);r&&(t.step_prompts=r.value.split(`
`));let i=e.querySelector(`.flow-f-field`);if(t.step_columns=i&&i.value.trim()?[i.value.trim()]:[],cd(t.step_type)){let n=t.step_options,r=[];e.querySelectorAll(`.flow-opt`).forEach((e,t)=>{r.push({label:e.querySelector(`.flow-o-label`)?.value??``,icon:e.querySelector(`.flow-o-icon`)?.value??``,goto:n[t]&&n[t].goto||``})}),t.step_options=r}else t.step_options=[];if(ud(t.step_type)){let n=e.querySelector(`.flow-f-mtlabel`),r=e.querySelector(`.flow-f-start`),i=e.querySelector(`.flow-f-end`),a=e.querySelector(`.flow-f-mins`);t.step_config={...t.step_config||pd(),...n?{meeting_label:n.value.trim()}:{},...r&&r.value?{start:r.value}:{},...i&&i.value?{end:i.value}:{},...a?{mins:parseInt(a.value,10)||30}:{}}}else if(dd(t.step_type)){let n=e.querySelector(`.flow-f-terminal`);if(n){let r=e.querySelector(`.flow-f-cta-label`),i=e.querySelector(`.flow-f-cta-url`),a=Tu(t.step_config,hd)||{};t.step_config=n.checked?{...a,terminal:!0,cta:{label:r?r.value:``,url:i?i.value:``}}:Tu(t.step_config,hd)}}else t.step_config=Eu(t.step_config)}function Vu(){document.querySelectorAll(`.flow-node.drop-before, .flow-node.drop-after`).forEach(e=>e.classList.remove(`drop-before`,`drop-after`))}function Hu(){Vu(),document.querySelectorAll(`.flow-node.dragging`).forEach(e=>e.classList.remove(`dragging`)),bd=null,xd=null}function Uu(e=R){if(!e.length)return{message:`Add at least one step.`,uid:null,field:null};for(let t=0;t<e.length;t++){let n=e[t],r=t+1,i=(e,t=null)=>({message:e,uid:n._uid,field:t});if(!n.step_prompts.some(e=>String(e).trim()!==``))return i(`Step ${r}: add what the magnet should say.`,`prompts`);if(cd(n.step_type)&&!n.step_options.some(e=>String(e.label).trim()!==``))return i(`Step ${r}: add at least one choice.`,`options`);if(ld(n.step_type)&&!n.step_columns.length)return i(`Step ${r}: choose which field this answer saves to.`,`field`);if(dd(n.step_type)&&n.step_config?.terminal){let e=String(n.step_config.cta?.label||``).trim(),t=String(n.step_config.cta?.url||``).trim();if(!!e!=!!t)return i(`Step ${r}: fill in both the link label and URL, or leave both blank.`,`cta`)}}return null}function Wu(e){if(!e)return;let t=e.querySelector(`.flow-f-cta-label`),n=e.querySelector(`.flow-f-cta-url`);if(!t||!n)return;let r=t.value.trim()!==``,i=n.value.trim()!==``,a=r||i,o=r!==i;e.querySelectorAll(`.flow-cta-req`).forEach(e=>{e.textContent=a?`required`:`optional`,e.classList.toggle(`flow-sub--req`,a)}),t.classList.toggle(`flow-f-invalid`,o&&!r),n.classList.toggle(`flow-f-invalid`,o&&!i);let s=e.querySelector(`.flow-cta-warn`);s&&(s.hidden=!o)}function Gu(e=R){let t=0;return e.forEach(e=>{let n=parseInt(e.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(e=>{let n=e.id&&String(e.id).trim()?String(e.id):String(++t),r=cd(e.step_type)?e.step_options.map(e=>{let t={label:String(e.label).trim(),goto:String(e.goto||``)};return e.icon&&(t.icon=String(e.icon)),t}).filter(e=>e.label!==``):[],i={id:n,step_type:e.step_type,step_prompts:e.step_prompts.map(e=>String(e)).filter(e=>e.trim()!==``),step_options:r,step_columns:e.step_columns.slice(),step_description:e.step_description||``};if(ud(e.step_type))e.step_config&&(i.step_config={...pd(),...e.step_config});else if(e.step_config&&Object.keys(e.step_config).length){let t={...e.step_config};if(dd(e.step_type)&&t.terminal){let e=String(t.cta?.label??``).trim(),n=String(t.cta?.url??``).trim();e&&n?t.cta={label:e,url:n}:delete t.cta}i.step_config=t}return i})}function Ku(e,t,n){Ou(),Td=t,Ed=typeof n==`function`?n:null,Dd=t?.modified_tz||``,wd=[`chat`,...[`book`,`support`].filter(e=>(t.actions||[]).some(t=>t&&t.type===e))],Cd={chat:Nu(`chat`,t)},Sd=`chat`,R=Cd.chat,vd=R.length===1?R[0]._uid:null,bd=null,xd=null,e.innerHTML=`
    ...
    ${wd.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${wd.map(e=>`<option value="${e}">${L(od[e]||e)}</option>`).join(``)}</select></div>`:``}
...
<body>
  ...
  <\/script>
  <script>${n}<\/script>
</body></html>`}function Fd(){if(Bd)return;let e=document.createElement(`style`);e.id=`m5t-preview-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Bd=!0}function Id(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function Ld(e){let t=e.querySelector(`[data-pv-info]`),n=e.querySelector(`[data-pv-info-pop]`);t&&n&&t.addEventListener(`click`,()=>{n.hidden=!n.hidden})}function Rd(e,t){Fd(),e.innerHTML=`
    <div class="pv-pane">
      ...
      ${Id(`Live render of the real widget. Capture is disabled, so no test leads.`)}
    </div>`,Ld(e);let n=e.querySelector(`.pv-pane__frame`),r=e.querySelector(`.pv-pane__badge`),i=null,a=0;n.addEventListener(`load`,()=>{let e=(typeof performance<`u`?performance.now():Date.now())-a;clearTimeout(i),e<450?i=setTimeout(()=>{r.hidden=!0},450-e):r.hidden=!0});let o=()=>{let e;try{e=Pd(t())}catch{return}a=typeof performance<`u`?performance.now():Date.now(),r.hidden=!1,n.srcdoc=e,clearTimeout(i),i=setTimeout(()=>{r.hidden=!0},1500)};return e.querySelector(`.pv-pane__seg`).addEventListener(`click`,t=>{let r=t.target.closest(`button[data-device]`);!r||r.dataset.device===n.dataset.device||(e.querySelectorAll(`.pv-pane__seg button`).forEach(e=>e.classList.toggle(`is-on`,e===r)),n.dataset.device=r.dataset.device)}),o(),{refresh:o,destroy(){clearTimeout(i)}}}function zd(e){Fd();let t=`desktop`,n=document.createElement(`div`);n.className=`pv-scrim`,n.innerHTML=`
    <div class="pv-modal" role="dialog" aria-modal="true" aria-label="Magnet preview">
      ...
      <div class="pv-body">
        <div>
          ...
          ${Id(`Live render of the actual widget. Capture is disabled, so no test leads are created.`)}
        </div>
      </div>
    </div>`,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add(`open`)),Ld(n);let r=n.querySelector(`.pv-frame`),i=n.querySelector(`.pv-stage`),a=()=>{try{r.srcdoc=Pd(e())}catch{}};a();let o=()=>{n.classList.remove(`open`),setTimeout(()=>n.remove(),180)};return n.querySelector(`[data-x="close"]`).addEventListener(`click`,o),n.querySelector(`[data-x="refresh"]`).addEventListener(`click`,a),n.addEventListener(`click`,e=>{e.target===n&&o()}),n.querySelector(`.pv-seg`).addEventListener(`click`,e=>{let r=e.target.closest(`button[data-device]`);!r||r.dataset.device===t||(t=r.dataset.device,n.querySelectorAll(`.pv-seg button`).forEach(e=>e.classList.toggle(`is-on`,e.dataset.device===t)),i.dataset.device=t,a())}),{close:o,rebuild:a}}var Bd,Vd=o((()=>{Md(),Bd=!1}));function Hd(e){let t=[];for(let n of e.steps||[])for(let e of n.step_columns||[])e&&!t.includes(e)&&t.push(e);return t}function Ud(e){let t=(e.steps||[])[0]||{},n=(t.step_prompts||[])[0]||``,r=``;return t.step_type===`single_select`||t.step_type===`multi_select`?r=(t.step_options||[]).slice(0,3).map(e=>`<span class="mag-tpl-pv__btn">${Qd(e?.label)}</span>`).join(``):tf[t.step_type]?r=`<span class="mag-tpl-pv__input">${Qd(tf[t.step_type])}</span>`:t.step_type===`scheduler`&&(r=`<span class="mag-tpl-pv__cal"><span class="material-symbols-outlined" aria-hidden="true">calendar_month</span>Pick a time</span>`),`<div class="mag-tpl-card__preview" aria-hidden="true"><span class="mag-tpl-pv__bubble">${Qd(n)}</span>${r}</div>`}function Wd(e,{detail:t=!1,gallery:n=!1,canUse:r=!0}={}){let i=t?Hd(e):[],a=n?` mag-tpl-card--gallery`:``,o=n?` data-cat="${Qd(e.category||``)}"`:``,s=n&&e.featured?`<span class="m5t-badge m5t-badge--featured m5t-featured-corner">Most popular</span>`:``,c=n?Ud(e):``,l=n&&(e.tags||[]).length?`<div class="m5t-chip-row mag-tpl-card__tags">${e.tags.map(e=>`<span class="m5t-chip">${Qd(e)}</span>`).join(``)}</div>`:``,u=r?`<button class="mag-tpl-card__btn" type="button" data-tpl="${e.id}">
    ...
    </div>`}function Gd(e){_a(ba.MAGNET_TEMPLATE,{id:e,at:Date.now()})}function Kd(e){if(!e)return null;if(typeof e==`string`)return ef.find(t=>t.id===e)||null;let{id:t,at:n}=e;return typeof n==`number`&&Date.now()-n>=nf?null:ef.find(e=>e.id===t)||null}function qd(){return Kd(va(ba.MAGNET_TEMPLATE))}function Jd(){return Kd(ya(ba.MAGNET_TEMPLATE))}function Yd(){if(rf)return;let e=document.createElement(`style`);e.id=`m5t-mag-template-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),rf=!0}function Xd(e){Yd();let t=document.createElement(`div`);t.className=`mag-modal-scrim mag-tpl-modal`,t.innerHTML=`
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${n.kind}">
    ...
    ${o}
  </div>`}function yf(){if(_p)return;let e=document.createElement(`style`);e.id=`m5t-magnets-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),_p=!0}function bf(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function xf(e){let t=z.stats[e];if(!t||!t.opens&&!t.leads)return`<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>`;let n=e=>Number(e||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function Sf(e){let t=z.install[e.guid];if(!t)return``;let n=t.unrecognized||[],r=(t.traffic?.opens||0)>0,i=e.can_manage===!0,a=n.length?`
    ...
    ${s}
    ${l}
  </div>`}async function Cf(){await Promise.all(z.magnets.map(async e=>{try{let t=await(await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity`)).json().catch(()=>({}));if(!t.ok)return;z.install[e.guid]=t;let n=document.querySelector(`.mag-card[data-guid="${CSS.escape(e.guid)}"] .mag-install-slot`);n&&(n.innerHTML=Sf(e))}catch(t){console.warn(`[magnets] install activity failed:`,e.guid,t)}}))}function wf(e){return e?e.status===`REVOKED`||e.status===`PENDING`&&e.codeLive===!1:!1}function Tf(e,t){let n=t.status===`PENDING`&&t.codeLive===!1,r=(n?Mp.EXPIRED:Mp[t.status])||{label:t.status,icon:`help`,tone:`off`},i=t.lastSeen?new Date(t.lastSeen).toLocaleString():``,a=t.host?B(t.host):n||t.status===`REVOKED`?`Code was never used`:`Waiting for a site to use this code`,o=[t.siteName?B(t.siteName):``,i?`last seen ${B(i)}`:``].filter(Boolean).join(` — `);return`
    <div class="mag-conn__row" data-conn="${B(t.guid)}" data-state="${r.tone}">
      ...
      ${e.can_manage===!0?wf(t)?`<button class="mag-btn" data-action="clear-connection" data-guid="${B(e.guid)}" data-conn="${B(t.guid)}"
    ...
    </div>`}function Ef(e){let t=z.pairing[e.guid];if(!t)return``;if(t.error)return`<div class="mag-conn__code" data-state="error">
  ...
  </div>`}function Df(e){let t=z.connections[e.guid];if(!t)return``;if(t.failed)return`<div class="mag-conn">
    ...
    </div>`;let n=t.connections||[],r=n.filter(t=>t.status!==`PENDING`||e.can_manage===!0),i=n.filter(e=>e.status===`ACTIVE`).length,a=Ef(e),o=r.filter(e=>!wf(e)),s=r.filter(e=>wf(e)),c=o.length?o.map(t=>Tf(e,t)).join(``):`<p class="mag-install__hint">No sites connected yet. On WordPress, connecting a site pairs it without pasting the snippet by hand.</p>`,l=s.length?`
  ...
  </div>`}function Of(e){let t=document.querySelector(`.mag-card[data-guid="${CSS.escape(e.guid)}"] .mag-conn-slot`);t&&(t.innerHTML=Df(e))}async function kf(e){let t=await(await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/connections`)).json().catch(()=>({}));if(!t.ok)throw Error(t.error||`Could not load connected sites`);return t}async function Af(){await Promise.all(z.magnets.map(async e=>{try{z.connections[e.guid]=await kf(e)}catch(t){console.warn(`[magnets] connections failed:`,e.guid,t),z.connections[e.guid]={failed:!0}}Of(e)}))}function jf(){z.pairTimer&&(clearInterval(z.pairTimer),z.pairTimer=null)}function Mf(){jf()}function Nf(e){return!!document.querySelector(`.mag-card[data-guid="${CSS.escape(e)}"] .mag-conn-slot`)}function Pf(){if(z.pairTimer)return;let e=0;z.pairTimer=setInterval(async()=>{for(let e of Object.keys(z.pairing))Nf(e)||delete z.pairing[e];let t=Object.keys(z.pairing);if(!t.length){jf();return}if(!t.some(e=>{let t=z.pairing[e];return!t.connected&&!t.error&&t.expiresAt-Date.now()>0})){t.forEach(e=>{let t=z.magnets.find(t=>t.guid===e);t&&Of(t)}),jf();return}e+=1e3;let n=e>=jp;n&&(e=0);for(let e of t){let t=z.magnets.find(t=>t.guid===e),r=z.pairing[e];if(!t||!r)continue;let i=r.expiresAt-Date.now()<=0;if(n&&!r.connected&&!r.error&&!i)try{let n=await kf(t);z.connections[e]=n;let i=(n.connections||[]).find(e=>e.guid===r.connectionGuid&&e.status===`ACTIVE`);i&&(z.pairing[e]={connected:!0,connectionGuid:r.connectionGuid,connectedHost:i.host},V(`${i.host||`Your site`} connected`,`success`))}catch{}Of(t)}},1e3)}async function Ff(e){try{let t=await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/pairing-code`,{method:`POST`,headers:{"Content-Type":`application/json`},body:`{}`}),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok){z.pairing[e.guid]={error:n.message||n.error||`Could not generate a pairing code`},Of(e);return}z.pairing[e.guid]={code:n.pairingCode,connectionGuid:n.connectionGuid,expiresAt:new Date(n.expiresAt).getTime()};try{z.connections[e.guid]=await kf(e)}catch{}Of(e),Pf()}catch{z.pairing[e.guid]={error:`Could not reach the server. Try again.`},Of(e)}}async function If(e){let t=z.pairing[e.guid]?.code;if(t)try{await navigator.clipboard.writeText(t),V(`Pairing code copied`,`success`)}catch{V(`Copy failed — select the code and copy it manually`,`danger`)}}async function Lf(e,t,n){if(window.confirm(`Clear the record for ${n||`this connection`}?\n\nIt is removed from this list for good. This only tidies up the history — the site is already disconnected, so nothing about access changes.`))try{let n=await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/connections/${encodeURIComponent(t)}`,{method:`DELETE`}),r=await n.json().catch(()=>({}));if(!n.ok||!r.ok){V(r.message||r.error||`Could not clear that record`,`danger`);return}V(`Record cleared`,`success`);try{z.connections[e.guid]=await kf(e)}catch{}Of(e)}catch{V(`Could not reach the server`,`danger`)}}async function Rf(e,t){let n=(z.connections[e.guid]?.connections||[]).find(e=>e.guid===t),r=n?.status===`PENDING`,i=r?`Cancel this pairing code?`:`Disconnect ${n?.host||`this site`}?`,a=r?`The code stops working immediately.`:`Its key stops working immediately and the plugin will show as disconnected. The domain stays on the allow-list — remove it separately if you want the magnet off that site.`;if(window.confirm(`${i}\n\n${a}`))try{let n=await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/connections/${encodeURIComponent(t)}/revoke`,{method:`POST`,headers:{"Content-Type":`application/json`},body:`{}`}),i=await n.json().catch(()=>({}));if(!n.ok||!i.ok){V(i.message||i.error||`Could not disconnect`,`danger`);return}z.pairing[e.guid]?.connectionGuid===t&&delete z.pairing[e.guid],V(r?`Pairing code cancelled`:`Site disconnected`,`success`);try{z.connections[e.guid]=await kf(e)}catch{}Of(e)}catch{V(`Could not reach the server`,`danger`)}}function zf(e){let t=z.owners.length>1||w.getMemberships().length>1,n=(e.domains||[]).filter(Boolean),r=e.can_manage===!0;return`
    <div class="mag-card" data-guid="${B(e.guid)}">
      ...
      <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${Cp[e.display_mode]||`chat`}</span>${B(Sp[e.display_mode]||`Chat bubble`)}${e.ab?.enabled?`&nbsp;&nbsp;<span class="mag-ab-chip"><span class="material-symbols-outlined" aria-hidden="true">science</span>A/B</span>`:``}${(e.notify_emails||[]).length?`&nbsp;&nbsp;<a class="mag-alert-chip" href="#/settings/notifications" title="Lead alerts to ${(e.notify_emails||[]).length} email${(e.notify_emails||[]).length===1?``:`s`}. Manage in Settings."><span class="material-symbols-outlined" aria-hidden="true">notifications_active</span>${(e.notify_emails||[]).length}</a>`:``}</span>
      ${xf(e.guid)}
      <div class="mag-domains">${n.length?n.map(e=>B(e)).join(`, `):`<span>No domains set. Add yours to go live.</span>`}</div>
      <div class="mag-install-slot">${Sf(e)}</div>
      <div class="mag-conn-slot">${Df(e)}</div>
      <div class="mag-embed">
      ...
      <div class="mag-actions">
        ...
        <button class="mag-btn" data-action="funnel" data-guid="${B(e.guid)}" title="Which question loses the most visitors"><span class="material-symbols-outlined" aria-hidden="true">filter_alt</span>Funnel</button>
        ${r?`
    ...
    </div>`}function Bf(){return A()?sa({section:`magnets`,title:`Your Magnets`,description:`Pick a client to view and manage their magnets.`}):(yf(),`
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add(`open`),t.querySelector(`.mag-modal`).classList.add(`open`)});let n=()=>{t.classList.remove(`open`),setTimeout(()=>t.remove(),180),document.removeEventListener(`keydown`,r)};function r(e){e.key===`Escape`&&(e.preventDefault(),n())}document.addEventListener(`keydown`,r),t.querySelector(`.mag-modal__close`).addEventListener(`click`,n),t.querySelector(`[data-x="cancel"]`).addEventListener(`click`,n),t.querySelector(`[data-x="continue"]`).addEventListener(`click`,()=>{let r=t.querySelector(`#mag-owner-pick`).value;n(),Kf(r,e)})}function Jf(){return z.owners.length===1?z.owners[0].guid:null}function Yf(){if(z.owners.length>1){qf();return}Kf(Jf())}function Xf(e){if(z.owners.length>1){qf(e);return}Kf(Jf(),e)}function Zf(){Xd(Xf)}function Qf(e){let t=e.target.closest(`[data-action]`);if(!t)return;let n=t.dataset.guid,r=z.magnets.find(e=>e.guid===n),i=t.dataset.action;if(i===`copy`)return $f(n);if(r){if(i===`preview`)return zd(()=>Nd(r));if(i===`funnel`)return tp(r);if(i===`edit`)return hp(r);if(i===`flow`)return hp(r,`flow`);if(i===`allow-domain`)return np(r,t.dataset.domain);if(i===`dismiss-domain`)return rp(r,t.dataset.domain);if(i===`restore-domain`)return ip(r,t.dataset.domain);if(i===`pair-start`)return Ff(r);if(i===`copy-code`)return If(r);if(i===`revoke-connection`)return Rf(r,t.dataset.conn);if(i===`clear-connection`)return Lf(r,t.dataset.conn,t.dataset.label);if(i===`toggle`)return op(r);if(i===`delete`)return sp(r)}}async function $f(e){try{await navigator.clipboard.writeText(yp(e)),V(`Embed snippet copied`,`success`)}catch{V(`Copy failed`,`danger`)}}function ep(e){let t=Number(e?.total_steps)||0,n={};if((Array.isArray(e?.funnel)?e.funnel:[]).forEach(e=>{n[e.position]=Number(e.reached)||0}),!t||!Object.keys(n).length)return`<p class="mag-modal__hint" style="margin:0">No step activity yet in this window. As visitors answer questions, drop-off by step will appear here.</p>`;let r=Math.max(1,n[1]||0),i=[];for(let e=1;e<=t;e++){let a=n[e]||0,o=Math.min(100,Math.round(a/r*100));i.push(`
    ...
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${i?`Edit magnet`:`New magnet`}">
      ...
      <div class="mag-modal__main">
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${Ep.map(t=>`<option value="${t.value}"${sf(e)===t.value?` selected`:``}>${B(t.label)}</option>`).join(``)}
          <option value="__per_device"${sf(e)===`__per_device`?` selected`:``}>Per device&hellip;</option>
        </select>
        <div class="mag-perdev" id="mag-f-perdev"${sf(e)===`__per_device`?``:` hidden`}>
          <div class="mag-perdev__row">
            ...
            <select class="mag-modal__select" id="mag-f-trigger-desktop">
              ${Ep.map(t=>`<option value="${t.value}"${cf(e,`desktop`)===t.value?` selected`:``}>${B(t.label)}</option>`).join(``)}
            </select>
          </div>
          <div class="mag-perdev__row">
            <label class="mag-modal__label" for="mag-f-trigger-mobile">Mobile</label>
            <select class="mag-modal__select" id="mag-f-trigger-mobile">
              ${Ep.map(t=>`<option value="${t.value}"${cf(e,`mobile`)===t.value?` selected`:``}>${B(t.label)}</option>`).join(``)}
            </select>
          </div>
...
/&gt;</code></pre>
  ...
  `,document.head.appendChild(e),Jp=!0}function Vp(){Bp();let e=Kp();return`
    <div class="page-shell" data-section="templates">
      ...
      <div class="m5t-chip-row tpl-filters" id="tpl-filters" role="group" aria-label="Filter templates by category">
        ${qp(`all`,`All`,ef.length,`true`)}
        ${zp().map(([e,t])=>qp(e,$d[e],t,`false`)).join(``)}
      </div>

      <div class="mag-tpl-grid mag-tpl-grid--page" id="tpl-grid">
        ${ef.map(t=>Wd(t,{detail:!0,gallery:!0,canUse:e})).join(``)}
      </div>
    </div>`}function Hp(){let e=document.getElementById(`tpl-grid`);document.getElementById(`tpl-filters`)?.addEventListener(`click`,t=>{let n=t.target.closest(`[data-cat]`);if(!n)return;n.parentElement.querySelectorAll(`[data-cat]`).forEach(e=>{e.setAttribute(`aria-pressed`,String(e===n))});let r=n.dataset.cat;e?.querySelectorAll(`.mag-tpl-card`).forEach(e=>{e.hidden=r!==`all`&&e.dataset.cat!==r})}),e?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-preview]`);if(t){let e=ef.find(e=>e.id===t.dataset.preview);e&&zd(()=>Nd({...e.appearance,steps:e.steps,name:e.name}));return}let n=e.target.closest(`[data-tpl]`);n&&(Gd(n.dataset.tpl),window.location.hash=`#/magnets`)})}var Up,Wp,Gp,Kp,qp,Jp,Yp,Xp=o((()=>{T(),Vd(),af(),Up={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Wp=e=>String(e??``).replace(/[&<>"']/g,e=>Up[e]),Gp=[`provision_magnets`,`manage_magnets`],Kp=()=>w.getCapabilities().some(e=>Gp.includes(e)),qp=(e,t,n,r)=>`<button class="m5t-chip--filter" type="button" data-cat="${Wp(e)}" aria-pressed="${r}">${Wp(t)}<span class="m5t-chip__count">${n}</span></button>`,Jp=!1,Yp={render:Vp,init:Hp}})),Zp=c({default:()=>xm,init:()=>rm,render:()=>nm});function Qp(){if(sr(),vm)return;let e=document.createElement(`style`);e.id=`m5t-questionnaires-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),vm=!0}function $p(){return U.clients.map(e=>{let t=U.responses.filter(t=>t.owner_guid===e.guid),n=t[0]||null;return{guid:e.guid,name:e.caption||e.name||e.guid,latest:n,earlier:Math.max(0,t.length-1),status:n?n.status:`NOT_SENT`}})}function em(){let e=U.search.trim().toLowerCase();return $p().filter(t=>(U.filter===`ALL`||t.status===U.filter)&&(!e||t.name.toLowerCase().includes(e)))}function tm(e){let t=e.status===`SUBMITTED`,n=e.status===`SUBMITTED`?`<button class="qz-act" type="button" data-act="open" data-guid="${fm(e.latest.guid)}">Read answers</button>`:e.status===`DRAFT`?`<button class="qz-act" type="button" data-act="copy" data-url="${fm(e.latest.url||``)}">Copy link</button>`:`<a class="qz-act" href="#/clients">Go to client</a>`;return`<tr class="qz-row${t?` qz-row--open`:``}"${t?` data-open-guid="${fm(e.latest.guid)}"`:``}>
    <td><span class="qz-client">${fm(e.name)}</span>${e.earlier?`<span class="qz-earlier">${e.earlier} earlier</span>`:``}</td>
    <td><span class="qz-badge" data-s="${fm(e.status)}">${fm(_m[e.status]||e.status)}</span></td>
    <td class="qz-when">${fm(bm(e,`created_tz`))}</td>
    <td class="qz-when">${fm(bm(e,`submitted_tz`))}</td>
    <td class="qz-actcell">${n}</td>
  </tr>`}function nm(){return Qp(),`
    <div class="page-shell" data-section="questionnaires">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="qz-body">${ym(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function rm(){await im()}async function im(){let e=document.getElementById(`qz-body`);if(e){try{let[e,t]=await Promise.all([fetch(`${pm()}/m5t/v5/acctGroup`),fetch(`${pm()}/m5t/v5/m5mQuestionnaireResponse`)]),n=await e.json().catch(()=>({})),r=await t.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(`load failed`);U.clients=(n.data||[]).filter(e=>e.class===hm&&![`DELETED`,`ARCHIVED`].includes(e.status)).sort((e,t)=>String(e.caption||``).localeCompare(String(t.caption||``))),U.responses=r.data||[]}catch{e.innerHTML=ym(`error`,`Could not load questionnaires. Please try again.`);return}om()}}function am(){let e=document.getElementById(`qz-tbody`);e&&en(e,{rowSelector:`tr.qz-row`,noun:`clients`,controlHost:e.closest(`.qz-tablewrap`)||e.parentElement})}function om(){let e=document.getElementById(`qz-body`);if(!e)return;if(!U.clients.length){e.innerHTML=ym(`groups`,`No clients yet. Add a client first, then send them a kickoff questionnaire.`);return}let t=$p(),n={ALL:t.length};gm.slice(1).forEach(([e])=>{n[e]=t.filter(t=>t.status===e).length});let r=em();e.innerHTML=`
    <div class="qz-bar">
      <div class="qz-filter">
        ${gm.map(([e,t])=>`<button data-filter="${e}" class="${U.filter===e?`active`:``}">${fm(t)}${n[e]?`<span class="qz-pillnum">${n[e]}</span>`:``}</button>`).join(``)}
      </div>
      <span class="qz-searchwrap">
        <span class="material-symbols-outlined" aria-hidden="true">search</span>
        <input class="qz-search" id="qz-search" type="search" placeholder="Search clients" value="${fm(U.search)}" aria-label="Search clients" />
      </span>
    ...
    <div class="qz-tablewrap">
      <table class="qz-table">
        ...
        <tbody id="qz-tbody">${r.length?r.map(tm).join(``):`<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">${U.search.trim()?`No clients match your search.`:`No clients with status “${fm(_m[U.filter]||U.filter)}”.`}</div></td></tr>`}</tbody>
      </table>
    </div>`,am(),e.querySelector(`.qz-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(U.filter=t.dataset.filter,om())}),e.querySelector(`#qz-search`)?.addEventListener(`input`,e=>{U.search=e.target.value,sm()}),e.querySelector(`#qz-tbody`)?.addEventListener(`click`,cm)}function sm(){let e=document.getElementById(`qz-tbody`);if(!e)return;let t=em();e.innerHTML=t.length?t.map(tm).join(``):`<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">No clients match your search.</div></td></tr>`,am();let n=document.querySelector(`.qz-count`);n&&(n.textContent=`${t.length} of ${$p().length}`)}function cm(e){let t=e.target.closest(`[data-act="copy"]`);if(t){e.stopPropagation();let n=t.dataset.url;if(!n){mm(`No link on this questionnaire yet.`,`warning`);return}navigator.clipboard?.writeText(n).then(()=>{t.textContent=`Copied!`,setTimeout(()=>{t.textContent=`Copy link`},1500)},()=>mm(`Could not copy the link.`,`error`));return}let n=e.target.closest(`[data-act="open"]`),r=e.target.closest(`[data-open-guid]`),i=n?.dataset.guid||r?.dataset.openGuid;i&&lm(i)}async function lm(e){U.openGuid=e;let t=document.createElement(`div`);t.className=`qz-drawer-scrim`;let n=document.createElement(`aside`);n.className=`qz-drawer`,n.setAttribute(`role`,`dialog`),n.setAttribute(`aria-label`,`Questionnaire answers`),n.innerHTML=`
    ...
    <div class="qz-drawer__body" id="qz-dbody">${ym(`hourglass_empty`,`Loading answers…`)}</div>`,document.body.append(t,n),requestAnimationFrame(()=>{t.classList.add(`open`),n.classList.add(`open`)});let r=()=>{U.openGuid=null,t.classList.remove(`open`),n.classList.remove(`open`),setTimeout(()=>{t.remove(),n.remove()},220),document.removeEventListener(`keydown`,i)};function i(e){e.key===`Escape`&&(e.preventDefault(),r())}document.addEventListener(`keydown`,i),t.addEventListener(`click`,r),n.querySelector(`.qz-drawer__close`).addEventListener(`click`,r);try{let t=await fetch(`${pm()}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e)}`),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`load failed`);let i=r.data||{},a=U.clients.find(e=>e.guid===i.owner_guid)?.caption||`Client`;n.querySelector(`#qz-dtitle`).textContent=a;let o=i.submitted_tz?`Submitted ${D(i.submitted_tz)}`:`Not yet submitted`;n.querySelector(`#qz-dsub`).textContent=i.locked_tz?`${o} · Finalized`:o,n.querySelector(`#qz-dbody`).innerHTML=or(i)+rr(i,{emptyLabel:`Not answered`})}catch{n.querySelector(`#qz-dbody`).innerHTML=ym(`error`,`Could not load these answers. Please try again.`)}}var um,dm,fm,pm,mm,hm,gm,_m,U,vm,ym,bm,xm,Sm=o((()=>{T(),um=u(f(),1),m(),dr(),nn(),dm={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},fm=e=>String(e??``).replace(/[&<>"']/g,e=>dm[e]),pm=()=>w.getConfig?.().BASE_URL||``,mm=(e,t=`info`)=>{try{um.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},hm=`managed_client`,gm=[[`ALL`,`All`],[`NOT_SENT`,`Not sent`],[`DRAFT`,`Awaiting response`],[`SUBMITTED`,`Submitted`],[`CANCELLED`,`Cancelled`]],_m=Object.fromEntries(gm),U={clients:[],responses:[],filter:`ALL`,search:``,openGuid:null},vm=!1,ym=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,bm=(e,t)=>e?.latest?.[t]?D(e.latest[t]):`—`,xm={render:nm,init:rm}})),Cm=c({default:()=>th,init:()=>km,render:()=>Om});function wm(){if(sr(),Zm)return;let e=document.createElement(`style`);e.id=`m5t-deliverables-styles`,e.textContent=`
    ...
    /* Section headings in drawer context: full ink, never faint gray. */
  ...
  `,document.head.appendChild(e),Zm=!0}function Tm(){let e=K.search.trim().toLowerCase();return K.rows.filter(t=>(K.filter===`ALL`||t.status===K.filter)&&(!e||String(t.owner_name||``).toLowerCase().includes(e)))}function Em(e){return e.status===`DRAFT`?`<button class="dz-act" type="button" data-act="open" data-guid="${W(e.guid)}">Edit</button>`:e.status===`SENT`?`<button class="dz-act" type="button" data-act="copy" data-url="${W(e.url||``)}">Copy link</button>`:e.status===`SUBMITTED`?`<button class="dz-act" type="button" data-act="open" data-guid="${W(e.guid)}">Read review</button>`:`<span class="dz-when">—</span>`}function Dm(e){let t=e.status!==`CANCELLED`;return`<tr class="dz-row${t?` dz-row--open`:``}"${t?` data-open-guid="${W(e.guid)}"`:``}>
    ...
    <td><span class="dz-badge" data-s="${W(e.status)}">${W(Xm[e.status]||e.status)}</span></td>
    <td class="dz-when">${e.sent_tz?W(D(e.sent_tz)):`—`}</td>
    <td class="dz-when">${e.submitted_tz?W(D(e.submitted_tz)):`—`}</td>
    <td class="dz-actcell">${Em(e)}</td>
  </tr>`}function Om(){return wm(),`
    <div class="page-shell" data-section="deliverables">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="dz-body">${Qm(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function km(){document.getElementById(`dz-new`)?.addEventListener(`click`,Im),await Am()}async function Am(){let e=document.getElementById(`dz-body`);if(e){try{let[e,t,n]=await Promise.all([fetch(`${qm()}/m5t/v5/m5mDeliverable`),fetch(`${qm()}/m5t/v5/acctGroup`),fetch(`${qm()}/m5t/v5/m5mDeliverable/templates`)]),r=await e.json().catch(()=>({})),i=await t.json().catch(()=>({})),a=await n.json().catch(()=>({}));if(!e.ok||!t.ok||!n.ok)throw Error(`load failed`);K.rows=r.data||[],K.clients=(i.data||[]).filter(e=>e.class===Jm&&![`DELETED`,`ARCHIVED`].includes(e.status)).sort((e,t)=>String(e.caption||``).localeCompare(String(t.caption||``))),K.templates=a.data||[]}catch{e.innerHTML=Qm(`error`,`Could not load deliverables. Please try again.`);return}Mm()}}function jm(){let e=document.getElementById(`dz-tbody`);e&&en(e,{rowSelector:`tr.dz-row`,noun:`deliverables`,controlHost:e.closest(`.dz-tablewrap`)||e.parentElement})}function Mm(){let e=document.getElementById(`dz-body`);if(!e)return;if(!K.clients.length&&!K.rows.length){e.innerHTML=Qm(`groups`,`No clients yet. Add a client first, then author their first deliverable.`);return}if(!K.rows.length){e.innerHTML=Qm(`approval`,`No deliverables yet. Author the first one with New deliverable.`);return}let t={ALL:K.rows.length};Ym.slice(1).forEach(([e])=>{t[e]=K.rows.filter(t=>t.status===e).length});let n=Tm();e.innerHTML=`
    <div class="dz-bar">
      <div class="dz-filter">
        ${Ym.map(([e,n])=>`<button data-filter="${e}" class="${K.filter===e?`active`:``}">${W(n)}${t[e]?`<span class="dz-pillnum">${t[e]}</span>`:``}</button>`).join(``)}
      </div>
    ...
    <div class="dz-tablewrap">
      <table class="dz-table">
        ...
        <tbody id="dz-tbody">${n.length?n.map(Dm).join(``):`<tr><td colspan="6"><div class="dz-when" style="padding:14px 4px">${K.search.trim()?`No deliverables match your search.`:`No deliverables with status “${W(Xm[K.filter]||K.filter)}”.`}</div></td></tr>`}</tbody>
      </table>
    </div>`,jm(),e.querySelector(`.dz-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(K.filter=t.dataset.filter,Mm())}),e.querySelector(`#dz-search`)?.addEventListener(`input`,e=>{K.search=e.target.value,Nm()}),e.querySelector(`#dz-tbody`)?.addEventListener(`click`,Pm)}function Nm(){let e=document.getElementById(`dz-tbody`);if(!e)return;let t=Tm();e.innerHTML=t.length?t.map(Dm).join(``):`<tr><td colspan="6"><div class="dz-when" style="padding:14px 4px">No deliverables match your search.</div></td></tr>`,jm();let n=document.querySelector(`.dz-count`);n&&(n.textContent=`${t.length} of ${K.rows.length}`)}function Pm(e){let t=e.target.closest(`[data-act="copy"]`);if(t){e.stopPropagation();let n=t.dataset.url;if(!n){G(`No link on this deliverable yet.`,`warning`);return}navigator.clipboard?.writeText(n).then(()=>{t.textContent=`Copied!`,setTimeout(()=>{t.textContent=`Copy link`},1500)},()=>G(`Could not copy the link.`,`error`));return}let n=e.target.closest(`[data-act="open"]`),r=e.target.closest(`[data-open-guid]`),i=n?.dataset.guid||r?.dataset.openGuid;i&&Wm(i)}function Fm(e){let t=document.createElement(`div`);t.className=`dz-drawer-scrim`;let n=document.createElement(`aside`);n.className=`dz-drawer`,n.setAttribute(`role`,`dialog`),n.setAttribute(`aria-label`,e),n.innerHTML=`
    ...
    </div>`}function Rm(e,t,n,{hidden:r=!1}={}){let i=`${t}: `,a=e[0]?.group||``;return`
      <div class="dz-cblock" data-group="${W(a)}" data-heading="${W(t)}"${r?` hidden`:``}>
        <h4 class="dz-cblock__title">${W(t)}</h4>
        ${e.map(e=>Lm(e,n,e.label.startsWith(i)?e.label.slice(i.length):e.label)).join(``)}
      </div>`}function zm(e,t){let n=(e.questions||[]).filter(e=>e.audience===`am`),r=n.filter(e=>!e.group).map(e=>Lm(e,t)).join(``),i=kr(e);if(i){let n=Ar(e).filter(e=>e.audience===`am`);if(!n.length)return r;let a=Nr(e,t);for(let e=1;e<=a;e++){let a=jr(n,i,e);r+=Rm(a,eh(a,`${i}${e}`),t)}let o=eh(jr(n,i,a+1),`${i}${a+1}`);return r+=`<button class="dz-btn--ghost dz-addblock" type="button" data-repeat="${W(i)}" data-section-id="${W(e.id)}">+ Add ${W(o)}</button>`,r}let a=[...new Set(n.filter(e=>e.group).map(e=>e.group))];if(!a.length)return r;let o=null;return r+=a.map((e,r)=>{let i=n.filter(t=>t.group===e),a=eh(i,e),s=r===0||$m(i,t);return!s&&o===null&&(o={key:e,heading:a}),Rm(i,a,t,{hidden:!s})}).join(``),r+=`<button class="dz-btn--ghost dz-addblock" type="button"${o?``:` hidden`}>${o?`+ Add ${W(o.heading)}`:``}</button>`,r}function Bm(e,t){let n=(e?.sections||[]).filter(e=>(e.questions||[]).some(e=>e.audience===`am`)),r=n.length>1;return`
    ${r?`
    ...
    ${r?`
      ...
      </div>`:``}).join(``)}function Um(e,t){let n=Array.isArray(t)&&t.length?t[t.length-1]:null;if(!n)return``;let r=(e?.sections||[]).flatMap(e=>(e.questions||[]).filter(e=>e.audience!==`am`)).map(e=>({q:e,val:nr(e,n.answers||{})})).filter(({val:e})=>e);return r.length?`
    <div class="dz-feedback">
      <p class="dz-feedback__title">Round ${W(n.round)} feedback${n.submitted_tz?` · returned ${W(D(n.submitted_tz))}`:``}</p>
      ${r.map(({q:e,val:t})=>`
        <div class="qm-qa">
          <div class="qm-qa__q">${W(e.label)}</div>
          <div class="qm-qa__a">${t}</div>
        </div>`).join(``)}
    </div>`:``}async function Wm(e){let{drawer:t,close:n}=Fm(`Deliverable`),r=t.querySelector(`#dz-dbody`),i=t.querySelector(`#dz-dfoot`),a;try{let t=await fetch(`${qm()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}`),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.error||`load failed`);a=n.data||{}}catch{r.innerHTML=Qm(`error`,`Could not load this deliverable. Please try again.`);return}let o=K.rows.find(t=>t.guid===e)?.owner_name||K.clients.find(e=>e.guid===a.owner_guid)?.caption||`Client`;t.querySelector(`#dz-dtitle`).textContent=`${o} · ${a.template?.name||`Deliverable`}`;let s=a.status===`DRAFT`||a.status===`SENT`,c=Number(a.revision)>1?` · Rev ${a.revision}`:``,l=a.status===`SUBMITTED`?`Returned ${a.submitted_tz?D(a.submitted_tz):``}${a.locked_tz?` · Finalized`:``}${c}`:a.status===`SENT`?`Sent ${a.sent_tz?D(a.sent_tz):``} to ${a.recipient_email||``} · awaiting approval${c}`:`${Xm[a.status]||a.status}${c}`;if(t.querySelector(`#dz-dsub`).textContent=l,!s){r.innerHTML=or(a)+Hm(a.template,a.content||{},a.answers||{}),a.status===`SUBMITTED`&&!a.locked_tz?(i.innerHTML=`<button class="dz-btn" type="button" id="dz-revise">Revise plan</button>
        <span class="dz-note" style="margin:0">Archives this review and reopens authoring. The client approves the revised plan on a fresh link.</span>`,i.querySelector(`#dz-revise`).addEventListener(`click`,async t=>{let r=t.target;r.disabled=!0;try{let t=await fetch(`${qm()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}/revise`,{method:`POST`}),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`revise failed`);G(`Reopened for revision. The last review is pinned above the form.`,`success`),n(),await Am(),Wm(e)}catch(e){G(e.message||`Could not revise.`,`error`),r.disabled=!1}})):i.innerHTML=``;return}r.innerHTML=`
    ${Um(a.template,a.rounds)}
    ${a.status===`SENT`&&a.url?`
      <div class="dz-linkrow">
        <input type="text" readonly value="${W(a.url)}" aria-label="Review link" />
    ...
    <div id="dz-author-form">${Bm(a.template,a.content||{})}</div>`,i.innerHTML=`
    ...
    <button class="dz-btn--ghost dz-btn--danger" type="button" id="dz-cancel">Cancel deliverable</button>`,r.querySelector(`#dz-copylink`)?.addEventListener(`click`,e=>{let t=r.querySelector(`.dz-linkrow input`);navigator.clipboard?.writeText(t?.value||``).then(()=>{e.target.textContent=`Copied!`,setTimeout(()=>{e.target.textContent=`Copy link`},1500)},()=>G(`Could not copy the link.`,`error`))});let u=async()=>{let t=ar(r.querySelector(`#dz-author-form`)),i=await fetch(`${qm()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({content:t})}),a=await i.json().catch(()=>({}));if(!i.ok||!a.ok){if(i.status===409)return G(a.error||`This deliverable is no longer editable.`,`warning`),n(),await Am(),!1;throw Error(a.error||`save failed`)}return!0};Vm(r.querySelector(`#dz-author-form`),a.template,()=>{u().catch(()=>G(`Autosave failed. Use Save draft.`,`warning`))}),i.querySelector(`#dz-preview`).addEventListener(`click`,async t=>{let n=t.target.closest(`button`);n.disabled=!0;try{await u()&&window.open(`#/deliverable-preview/${encodeURIComponent(e)}`,`_blank`)}catch(e){G(e.message||`Could not save before previewing.`,`error`)}n.disabled=!1}),i.querySelector(`#dz-save`).addEventListener(`click`,async e=>{let t=e.target;t.disabled=!0;try{await u()&&G(`Draft saved.`,`success`)}catch(e){G(e.message||`Could not save.`,`error`)}t.disabled=!1}),i.querySelector(`#dz-send`).addEventListener(`click`,async t=>{let r=t.target,a=(i.querySelector(`#dz-email`)?.value||``).trim();if(!a){G(`Enter the recipient email first.`,`warning`);return}r.disabled=!0;try{if(!await u())return;let t=await fetch(`${qm()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}/send`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({recipient_email:a})}),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`send failed`);G(r.data?.emailQueued?`Sent. ${a} will receive the review link.`:`Link created, but the email could not be queued. Copy the link and send it yourself.`,r.data?.emailQueued?`success`:`warning`),n(),await Am()}catch(e){G(e.message||`Could not send.`,`error`),r.disabled=!1}}),i.querySelector(`#dz-cancel`).addEventListener(`click`,async t=>{let r=t.target;r.disabled=!0;try{let t=await fetch(`${qm()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}/cancel`,{method:`POST`}),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`cancel failed`);G(`Deliverable cancelled. Its link no longer works.`,`info`),n(),await Am()}catch(e){G(e.message||`Could not cancel.`,`error`),r.disabled=!1}})}var Gm,Km,W,qm,G,Jm,Ym,Xm,K,Zm,Qm,$m,eh,th,nh=o((()=>{T(),Gm=u(f(),1),m(),dr(),Lr(),nn(),Km={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},W=e=>String(e??``).replace(/[&<>"']/g,e=>Km[e]),qm=()=>w.getConfig?.().BASE_URL||``,G=(e,t=`info`)=>{try{Gm.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Jm=`managed_client`,Ym=[[`ALL`,`All`],[`DRAFT`,`In progress`],[`SENT`,`Awaiting approval`],[`SUBMITTED`,`Returned`],[`CANCELLED`,`Cancelled`]],Xm=Object.fromEntries(Ym),K={rows:[],clients:[],templates:[],filter:`ALL`,search:``},Zm=!1,Qm=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,$m=(e,t)=>e.some(e=>{let n=t?.[e.id];return Array.isArray(n)?n.length>0:!!(n&&String(n).trim())}),eh=(e,t)=>{let n=String(e[0]?.label||``).match(/^(.+?):\s/);return n?n[1]:t.toUpperCase()},th={render:Om,init:km}})),rh=c({init:()=>mh,render:()=>ph});function ih(e){let t=Fh(e);if(!t)return``;try{return new Date(t).toLocaleDateString([],{month:`short`,day:`numeric`,year:`numeric`})}catch{return``}}function ah(e){let t=Fh(e);if(!t)return``;try{let n=Date.now()-new Date(t).getTime();if(n<0)return ih(e);let r=n/36e5;return r<1?`${Math.max(1,Math.floor(n/6e4))}m ago`:r<24?`${Math.floor(r)}h ago`:r<48?`Yesterday`:ih(e)}catch{return ih(e)}}function oh(){if(Dh)return;let e=document.createElement(`style`);e.id=`m5t-leads-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Dh=!0}function sh(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function ch(e){return`<select class="leads-status" data-id="${J(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${kh.map(t=>`<option value="${t}" ${e.status===t?`selected`:``}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join(``)}
  </select>`}function lh(e){let t=q.magnetNames[e.magnet_guid]||e.lead_source||`—`,n=e.phone?String(e.phone).replace(/[^\d+]/g,``):``;return`
    <tr class="leads-row${String(e.id)===q.selectedId?` selected`:``}" data-id="${J(e.id)}" tabindex="0" role="button" aria-label="Open lead ${J(Nh(e))}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${J(Ph(e))}</span>
          <span><span class="leads-name">${J(Nh(e))}</span>${e.company?`<span class="leads-sub">${J(e.company)}</span>`:``}</span>
        </span>
      </td>
      ...
      <td>${q.canManage?ch(e):`<span class="leads-badge" data-s="${J(e.status)}">${J(e.status)}</span>`}</td>
      <td class="num leads-muted" style="white-space:nowrap" title="${J(ih(e))}">${Ih(e)?`<span class="leads-fresh" title="Captured in the last 24 hours"></span>`:``}${J(ah(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}function uh(e){let t=q.search.trim().toLowerCase();if(!t)return!0;let n=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,q.magnetNames[e.magnet_guid],q.book?q.ownerNames[e.owner_guid]:``,e.utm_campaign,e.utm_source].filter(Boolean).join(` `).toLowerCase();return t.split(/\s+/).every(e=>n.includes(e))}function dh(){return q.leads.filter(e=>(q.filter===`ALL`||e.status===q.filter)&&Lh(e)&&uh(e)&&Rh(e))}function fh(){if(!q.day)return``;let e=q.day;try{e=new Date(`${q.day}T00:00:00Z`).toLocaleDateString([],{month:`short`,day:`numeric`,year:`numeric`,timeZone:`UTC`})}catch{}return`<button class="leads-daychip" type="button" id="leads-dayclear" title="Show every day again">
  ...
  </button>`}function ph(){oh(),na();let e=A();return`
    <div class="page-shell" data-section="leads">
      ...
      <div class="dashboard-card" style="margin-bottom:24px">
        ...
        <div class="card-body" id="pf-picker-body">${sh(`hourglass_empty`,`Loading…`)}</div>
      </div>`:``}
      <div class="page-header">
        <div class="page-header-text">
      ...
      <div class="leads-layout">
        <div class="dashboard-card">
          <div class="card-body" id="leads-body">
            ${sh(`hourglass_empty`,`Loading leads…`)}
          </div>
        </div>
        <aside class="dashboard-card leads-panel" aria-label="Lead detail">
          <div class="card-body" id="leads-panel-body">${zh()}</div>
        </aside>
      </div>
    </div>`}async function mh(){document.getElementById(`leads-export`)?.addEventListener(`click`,Th);let e=va(ba.LEADS_SEARCH),t=va(ba.LEADS_DAY);if((e||t)&&(q.search=e||``,q.day=t||``,q.filter=`ALL`,q.clientFilter=`ALL`,q.shown=Oh),A()){let e=e=>Number(e||0).toLocaleString();ca(Mh(),[{h:`Leads · wk`,td:t=>e(t.leads.this_week)},{h:`Leads · total`,td:t=>e(t.leads.total)},{h:`Compl.`,td:e=>e.completion_rate==null?`—`:`${e.completion_rate}%`}],{emptyMsg:`No client orgs yet. Create one under Clients first.`})}await hh()}async function hh(){let e=document.getElementById(`leads-body`);if(e){try{let[e,t]=await Promise.all([fetch(`${Mh()}/m5t/v5/m5mLead`),fetch(`${Mh()}/m5t/v5/magnets`).catch(()=>null)]),n=await e.json().catch(()=>({}));if(!n.ok)throw Error(n.message||`Failed to load`);if(q.leads=(n.data||[]).filter(e=>![`DELETED`,`ARCHIVED`].includes(e.status)),q.total=Number.isFinite(n.total)?n.total:q.leads.length,q.truncated=q.total>(n.data||[]).length,q.book=A(),q.ownerNames=q.book?la():{},t){let e=await t.json().catch(()=>({}));q.magnetNames={},(e.magnets||[]).forEach(e=>{q.magnetNames[e.guid]=e.name,e.owner_guid&&e.owner_name&&!q.ownerNames[e.owner_guid]&&(q.ownerNames[e.owner_guid]=e.owner_name)}),q.canManage=!!e.canManage}}catch{e.innerHTML=sh(`error`,`Could not load your leads. Please try again.`);return}gh()}}function gh(){let e=document.getElementById(`leads-body`),t=document.getElementById(`leads-export`);if(!e)return;if(t&&(t.style.display=q.leads.length?``:`none`),!q.leads.length){e.innerHTML=sh(`inbox`,`No leads captured yet. Publish a magnet and share it to start collecting.`),Ch();return}let n=q.leads.filter(Lh),r={ALL:n.length};kh.forEach(e=>{r[e]=n.filter(t=>t.status===e).length});let i=q.book?[...new Set(q.leads.map(e=>e.owner_guid).filter(Boolean))].map(e=>({guid:e,name:q.ownerNames[e]||e})).sort((e,t)=>e.name.localeCompare(t.name)):[];e.innerHTML=`
    <div class="leads-bar">
    ...
    <div id="leads-tablezone"></div>`,e.querySelector(`.leads-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(q.filter=t.dataset.filter,q.shown=Oh,gh())}),e.querySelector(`#leads-clientsel`)?.addEventListener(`change`,e=>{q.clientFilter=e.target.value,q.shown=Oh,gh()}),e.querySelector(`#leads-dayclear`)?.addEventListener(`click`,()=>{q.day=``,q.shown=Oh,gh()}),e.querySelector(`#leads-search`)?.addEventListener(`input`,e=>{q.search=e.target.value,q.shown=Oh,_h()}),_h()}function _h(){let e=document.getElementById(`leads-tablezone`),t=document.getElementById(`leads-countlbl`);if(!e)return;let n=dh(),r=n.slice(0,q.shown),i=q.book?8:7;t&&(t.textContent=`${n.length} of ${q.leads.length}`),e.innerHTML=`
    <div class="leads-tablewrap">
      <table class="leads-table${q.book?` leads-table--book`:``}">
        ...
        <tbody id="leads-tbody">${r.map(lh).join(``)||`<tr><td colspan="${i}"><div class="leads-muted" style="padding:14px 4px">${q.search.trim()?`No leads match your search.`:`No ${q.filter.toLowerCase()} leads.`}</div></td></tr>`}</tbody>
      </table>
    </div>
    ${$t({total:n.length,shown:q.shown,noun:`leads`})}
    ${q.truncated?`<div class="leads-muted" style="padding:10px 4px">Showing your ${q.leads.length.toLocaleString()} most recent leads of ${q.total.toLocaleString()}. Search and filters cover these; older leads aren't included yet.</div>`:``}`,e.querySelector(`[data-action="list-expand"]`)?.addEventListener(`click`,()=>{q.shown+=25,_h()}),e.querySelector(`#leads-tbody`)?.addEventListener(`change`,vh),e.querySelector(`#leads-tbody`)?.addEventListener(`click`,e=>{if(e.target.closest(`.leads-status, a.leads-contactlink`))return;let t=e.target.closest(`.leads-row`);t&&yh(t.dataset.id)}),e.querySelector(`#leads-tbody`)?.addEventListener(`keydown`,e=>{if(e.key!==`Enter`&&e.key!==` `)return;let t=e.target.closest(`.leads-row`);t&&e.target===t&&(e.preventDefault(),yh(t.dataset.id))})}async function vh(e){let t=e.target.closest(`.leads-status`);if(!t)return;let n=t.dataset.id,r=q.leads.find(e=>String(e.id)===String(n)),i=t.value,a=r?.status;try{if(!(await(await fetch(`${Mh()}/m5t/v5/m5mLead/${encodeURIComponent(n)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:i})})).json().catch(()=>({}))).ok)throw Error();r&&(r.status=i),jh(`Marked ${i[0]}${i.slice(1).toLowerCase()}`,`success`)}catch{t.value=a||`NEW`,jh(`Could not update status`,`danger`);return}try{String(n)===q.selectedId&&Ch(),q.filter!==`ALL`&&gh()}catch(e){console.warn(`[leads] re-render after status change failed:`,e)}}function yh(e){q.selectedId=String(e),document.querySelectorAll(`.leads-row`).forEach(e=>e.classList.toggle(`selected`,e.dataset.id===q.selectedId)),Ch()}function bh(e,t){let n=Array.isArray(e.tags)?e.tags:[];for(let e=n.length-1;e>=0;e--)if(n[e]&&n[e].tag===t&&n[e].value!=null)return String(n[e].value);return``}function xh(e){let t=bh(e,`appointment_start`);if(!t)return null;let n=bh(e,`appointment_status`)||`booked`,r=bh(e,`appointment_timezone`),i=bh(e,`appointment_event_type`),a=new Date(t),o=t;if(!Number.isNaN(a.getTime())){let e={weekday:`short`,month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`};try{o=new Intl.DateTimeFormat(void 0,r?{...e,timeZone:r}:e).format(a)}catch{o=new Intl.DateTimeFormat(void 0,e).format(a)}}return{when:o,status:n,type:i,start:t}}function Sh(e){let t=Array.isArray(e.tags)?e.tags:[],n=null;for(let e of t)if(!(!e||!e.tag)){if(e.tag===`callrail_call_id`){n={};continue}n&&e.tag.indexOf(`call_`)===0&&e.value!=null&&(n[e.tag]=String(e.value))}if(!n||!n.call_started)return null;let r=n.call_started,i=new Date(r),a=r;Number.isNaN(i.getTime())||(a=new Intl.DateTimeFormat(void 0,{weekday:`short`,month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`}).format(i));let o=Number(n.call_duration)||0,s=o?o<60?`${o}s`:`${Math.floor(o/60)}m ${o%60}s`:``;return{when:a,dur:s,source:n.call_source||``,answered:n.call_answered||``,recording:n.call_recording_player||``,started:r}}function Ch(){let e=document.getElementById(`leads-panel-body`);if(!e)return;let t=q.leads.find(e=>String(e.id)===q.selectedId),n=document.querySelector(`.leads-layout`);if(n&&(n.dataset.hasSelection=t?`true`:`false`),!t){e.innerHTML=zh();return}let r=q.magnetNames[t.magnet_guid]||t.lead_source||`—`,i=xh(t),[a,o]=i?Vh[i.status]||Vh.booked:[``,``],s=Sh(t),c=(e,t)=>t?`<div class="leads-det__field"><span class="leads-det__k">${J(e)}</span><span class="leads-det__v">${J(t)}</span></div>`:``;e.innerHTML=`
    <div class="leads-det__head">
      <span class="leads-avatar leads-det__ava">${J(Ph(t))}</span>
      <div>
        <div class="leads-det__name">${J(Nh(t))}</div>
    ...
    ${q.canManage?`
      ...
      </div>`:``}`,e.querySelector(`[data-action="delete-lead"]`)?.addEventListener(`click`,wh)}async function wh(e){let t=e.currentTarget?.dataset?.id,n=q.leads.find(e=>String(e.id)===String(t));if(!n)return;let r=Nh(n);if(!window.confirm(`Remove ${r} from your leads?\n\nThis takes the lead out of your dashboard, lists and exports. The record is kept in our system, and this address can be captured again if they come back through one of your magnets.`))return;let i=e.currentTarget;i.disabled=!0;try{let e=await fetch(`${Mh()}/m5t/v5/m5mLead/${encodeURIComponent(t)}`,{method:`DELETE`}),n=await e.json().catch(()=>({}));if(!e.ok||!n.ok)throw Error(n.error||`HTTP ${e.status}`);q.leads=q.leads.filter(e=>String(e.id)!==String(t)),q.selectedId=null,jh(`${r} removed`,`success`),gh()}catch{i.disabled=!1,jh(`Could not remove that lead. Please try again.`,`danger`)}}function Th(){let e=dh();if(!e.length){jh(`Nothing to export`,`info`);return}let t=[`first_name`,`last_name`,`email`,`phone`,`company`,`product_interest`,`lead_source`,`utm_source`,`utm_medium`,`utm_campaign`,`gclid`,`status`],n=e=>`"${String(e??``).replace(/"/g,`""`)}"`,r=[[...q.book?[`client`]:[],...t,`magnet`,`captured`,`appointment`,`last_call`].join(`,`)];for(let i of e){let e=xh(i),a=Sh(i);r.push([...q.book?[n(q.ownerNames[i.owner_guid]||``)]:[],...t.map(e=>n(i[e])),n(q.magnetNames[i.magnet_guid]||i.lead_source||``),n(ih(i)),n(e?`${e.start} (${e.status})`:``),n(a?`${a.started} (${a.answered===`no`?`missed`:`answered`})`:``)].join(`,`))}let i=new Blob([r.join(`
`)],{type:`text/csv`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.href=a,o.download=`leads-${q.filter.toLowerCase()}.csv`,document.body.appendChild(o),o.click(),o.remove(),URL.revokeObjectURL(a),jh(`Exported ${e.length} lead${e.length===1?``:`s`}`,`success`)}var Eh,Dh,q,Oh,kh,Ah,J,jh,Mh,Nh,Ph,Fh,Ih,Lh,Rh,zh,Bh,Vh,Hh=o((()=>{T(),Eh=u(f(),1),m(),ga(),Sa(),nn(),Dh=!1,q={leads:[],magnetNames:{},filter:`ALL`,canManage:!1,book:!1,ownerNames:{},clientFilter:`ALL`,search:``,shown:25,selectedId:null,day:``,total:0,truncated:!1},Oh=25,kh=[`NEW`,`WORKING`,`QUALIFIED`,`UNQUALIFIED`,`CONVERTED`,`EXPORTED`],Ah={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},J=e=>String(e??``).replace(/[&<>"']/g,e=>Ah[e]),jh=(e,t=`info`)=>{try{Eh.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Mh=()=>w.getConfig?.().BASE_URL||``,Nh=e=>[e.first_name,e.last_name].filter(Boolean).join(` `).trim()||e.email||`(no name)`,Ph=e=>(Nh(e).split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``)||`?`).toUpperCase(),Fh=e=>e.created?.created_tz||``,Ih=e=>{let t=Fh(e);if(!t)return!1;try{return Date.now()-new Date(t).getTime()<864e5}catch{return!1}},Lh=e=>q.clientFilter===`ALL`||e.owner_guid===q.clientFilter,Rh=e=>!q.day||Fh(e).slice(0,10)===q.day,zh=()=>sh(`touch_app`,`Click to see lead information.`),Bh=()=>`
  <colgroup>
    <col style="width:22%">
  ...
  </colgroup>`,Vh={booked:[`QUALIFIED`,`Booked`],rescheduled:[`WORKING`,`Rescheduled`],canceled:[`CANCELED`,`Canceled`]}})),Uh=c({init:()=>Yh,render:()=>Jh,tableHTML:()=>qh});function Wh(){if(ag)return;let e=document.createElement(`style`);e.id=`m5t-analytics-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),ag=!0}function Gh(e,t){let n=t>0?Math.round(e/t*100):0;return`<svg class="anl-bar" width="72" height="8" viewBox="0 0 72 8" role="img"
    ...
    </svg>`}function Kh(e,t,n){let r=sg[e.status]?`<span class="anl-chip">${tg(sg[e.status])}</span>`:``,i=n&&e.owner_name?`<span class="anl-sub">${tg(e.owner_name)}</span>`:``,a=e.ab_tests&&(e.ab_tests.running||e.ab_tests.completed)?`${$h(e.ab_tests.running)} / ${$h(e.ab_tests.completed)}`:`—`;return`<tr data-guid="${tg(e.magnet_guid)}">
    <td><a class="anl-name" href="#/magnets">${tg(e.name)}</a>${r}${i}</td>
    <td>${Gh(Number(e.leads?.window||0),t)}</td>
    <td>${$h(e.leads?.window)}</td>
    <td>${$h(e.opens)}</td>
    <td>${ng(e.engagement_rate)}</td>
    <td>${ng(e.completion_rate)}</td>
    <td>${ng(e.lead_rate)}</td>
    <td>${a}</td>
  </tr>`}function qh(e,t){let n=e.reduce((e,t)=>Math.max(e,Number(t.leads?.window||0)),0);return`<div class="anl-wrap"><table class="anl-table">
    <thead><tr>
      <th>Magnet</th><th></th><th>Leads</th><th>Opens</th>
      <th>Engaged</th><th>Completed</th><th>Leads / Open</th><th>A/B run / done</th>
    </tr></thead>
    <tbody>${e.map(e=>Kh(e,n,t)).join(``)}</tbody>
  </table></div>`}function Jh(){return A()?sa({section:`analytics`,title:`Analytics`,description:`Pick a client to see how their magnets are performing.`}):(Wh(),`
    <div class="page-shell" data-section="analytics">
      <div class="page-header">
        ...
        <div class="chart-controls" id="anl-periods">
          ${rg.map(e=>`<button class="chart-period-btn${e.d===ig?` active`:``}" type="button" data-days="${e.d}">${e.label}</button>`).join(``)}
        </div>
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="anl-body">
          ${og(`hourglass_empty`,`Loading magnet performance…`)}
        </div>
      </div>
    ...
    </div>`)}async function Yh(){if(A())return ca(Zh(),[{h:`Leads`,td:e=>$h(e.leads.window??e.leads.total)},{h:`Opens`,td:e=>$h(e.opens)},{h:`Completed`,td:e=>ng(e.completion_rate)}]);Wh(),await Xh();let e=document.getElementById(`anl-periods`);e&&e.addEventListener(`click`,t=>{let n=t.target.closest(`.chart-period-btn`);n&&(ig=Number(n.dataset.days)||30,e.querySelectorAll(`.chart-period-btn`).forEach(e=>{e.classList.toggle(`active`,Number(e.dataset.days)===ig)}),Xh())})}async function Xh(){let e=document.getElementById(`anl-body`),t=document.getElementById(`anl-range`);if(!e)return;e.innerHTML=og(`hourglass_empty`,`Loading magnet performance…`);let n=new Date,r=Qh(n),i=Qh(new Date(n.getTime()-(ig-1)*864e5));t&&(t.textContent=`${i} → ${r}`);let a;try{let e=await fetch(`${Zh()}/m5t/v5/dashboard/stats?from=${i}&to=${r}&group_by=magnet`);if(a=await e.json(),!e.ok||!a?.ok)throw Error(a?.error||`HTTP ${e.status}`)}catch(t){e.innerHTML=og(`cloud_off`,`Could not load analytics. Refresh to try again.`),console.error(`[analytics] load failed:`,t);return}let o=(e,t)=>{let n=document.getElementById(e);n&&(n.textContent=t)};o(`anl-leads`,$h(a.by_day?.reduce((e,t)=>e+Number(t.leads||0),0))),o(`anl-opens`,$h(a.funnel?.opens)),o(`anl-completion`,ng(a.funnel?.completion_rate)),o(`anl-active`,$h(a.magnets?.active));let s=Array.isArray(a.by_magnet)?a.by_magnet:[];if(!s.length){e.innerHTML=og(`widgets`,`No magnets yet. Create one and its numbers will show up here.`);return}let c=s.some(e=>Number(e.opens||0)>0||Number(e.leads?.window||0)>0),l=new Set(s.map(e=>e.owner_guid)).size>1;e.innerHTML=(a.by_magnet_truncated?`<p class="anl-warn">Showing the top ${s.length} magnets by leads. You have more than that, so this list is not complete.</p>`:``)+(c?``:`<p class="anl-warn">No opens or leads for any magnet in this period. Try a longer range.</p>`)+qh(s,l);let u=e.querySelector(`.anl-table tbody`);u&&en(u,{rowSelector:`tr`,noun:`magnets`,controlHost:e.querySelector(`.anl-wrap`)||e})}var Zh,Qh,$h,eg,tg,ng,rg,ig,ag,og,sg,cg=o((()=>{T(),ga(),Ea(),nn(),Zh=()=>w.getConfig?.().BASE_URL||``,Qh=e=>e.toISOString().slice(0,10),$h=e=>Number(e||0).toLocaleString(),eg={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},tg=e=>String(e??``).replace(/[&<>"']/g,e=>eg[e]),ng=e=>e==null?`—`:`${e}%`,rg=[{d:7,label:`7 Days`},{d:30,label:`30 Days`},{d:90,label:`90 Days`}],ig=30,ag=!1,og=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,sg={DRAFT:`Draft`,DISABLED:`Paused`}})),lg=c({default:()=>jg,init:()=>fg,render:()=>dg});function ug(){if(Dg)return;let e=document.createElement(`style`);e.id=`m5t-adperf-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Dg=!0}function dg(){return A()?sa({section:`ad-performance`,title:`Ad Performance`,description:`Pick a client to view their spend and lead performance.`}):(ug(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${kg.map(e=>`<button class="chart-period-btn${e.d===Ag?` active`:``}" type="button" data-days="${e.d}">${e.label}</button>`).join(``)}
        </div>
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-body">
          ${Og(`hourglass_empty`,`Loading ad performance…`)}
        </div>
      </div>
    ...
    </div>`)}async function fg(){if(A()){let e=e=>Number(e||0).toLocaleString();return ca(xg(),[{h:`Spend`,td:t=>t.ad?`$${e(t.ad.spend)}`:`—`},{h:`Clicks`,td:t=>t.ad?e(t.ad.clicks):`—`},{h:`Leads`,td:t=>e(t.leads.window??t.leads.total)},{h:`CPL`,td:t=>t.ad?.cost_per_lead==null?`—`:`$${e(t.ad.cost_per_lead)}`}],{emptyMsg:`No client orgs yet. Connect a client ad account to see spend here.`})}let e=document.getElementById(`adperf-periods`);e?.addEventListener(`click`,t=>{let n=t.target.closest(`button[data-days]`);n&&(Ag=Number(n.dataset.days)||30,e.querySelectorAll(`.chart-period-btn`).forEach(e=>e.classList.toggle(`active`,Number(e.dataset.days)===Ag)),pg())}),await pg()}async function pg(){let e=xg(),t=document.getElementById(`adperf-body`),n=document.getElementById(`adperf-range`),r=new Date,i=Sg(r),a=Sg(new Date(r.getTime()-(Ag-1)*864e5));n&&(n.textContent=`${a} → ${i}`);let o,s=[],c=null,l=null,u=null;try{let[t,n,r,d,f]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${a}&to=${i}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${a}&to=${i}`),$s().catch(()=>null),fetch(`${e}/m5t/v5/coreAdMetrics/conversions?from=${a}&to=${i}`).then(e=>e.json()).catch(()=>null)]);if(!t.ok)throw Error(`HTTP ${t.status}`);o=await t.json(),s=((await n.json().catch(()=>({})))?.data||[]).filter(e=>e.status!==`DELETED`),c=await r.json().catch(()=>null),l=d,u=f}catch(e){console.warn(`[ad-performance] load failed:`,e),t&&(t.innerHTML=Og(`error`,`Could not load ad performance. Please try again.`));return}mg(l,s),hg(u);let d=o.totals||{};if(_g(`adperf-spend`,Cg(d.spend)),_g(`adperf-clicks`,wg(d.clicks)),_g(`adperf-leads`,wg(d.magnet_leads)),_g(`adperf-cpl`,Cg(d.cost_per_lead)),gg(c),!s.length){t.innerHTML=Og(`link_off`,`No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.`);return}if(!o.connected){t.innerHTML=Og(`cloud_sync`,`Account connected. No ad data for this range yet. Metrics appear here once they sync.`);return}t.innerHTML=bg(o.rows||[])}function mg(e,t){let n=document.getElementById(`adperf-conn`);if(!n)return;if(!e||e.denied){n.innerHTML=``;return}let r=Sc.google_ads,i=Xs(e.providers,`google_ads`),a=Zs(r,i,!!e.configured?.google_ads),o=gc()?` <a href="#/settings/integrations/${r.urlSlug}">Manage</a>`:``;if(a===`connected`||a===`broken`){dc(),n.innerHTML=`<span>Google Ads</span> ${Qs(a,i)}${o}`;return}if(t.length){n.innerHTML=`<span>Google Ads</span> <span>${t.length} associated account${t.length===1?``:`s`}</span>`;return}n.innerHTML=``}function hg(e){let t=document.getElementById(`adperf-conv-card`),n=document.getElementById(`adperf-conv-body`),r=document.getElementById(`adperf-stats`),i=document.getElementById(`adperf-conv-stat`);if(i&&i.remove(),!t||!n)return;if(!e?.ok||!e.has_selection){t.style.display=`none`;return}if(r){let t=document.createElement(`div`);t.innerHTML=Ca({icon:`flag`,label:`Ads Conversions`,value:wg(e.totals?.conversions),sub:`Reported by Google Ads`,href:`#/settings/integrations/google-ads`});let n=t.firstElementChild;n.id=`adperf-conv-stat`,r.appendChild(n)}let a=e.actions||[];if(t.style.display=``,!a.length){n.innerHTML=Og(`search_off`,`No conversions in this range for the selected actions.`);return}let o=a.some(e=>e.value>0);n.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${a.map(e=>`
          <tr>
            <td>${Eg(e.name||e.id)}</td>
            <td class="adperf-src-sub">${Eg(String(e.category||``).toLowerCase().replace(/_/g,` `)||`—`)}</td>
            <td class="num"><b>${wg(e.conversions)}</b></td>
            ${o?`<td class="num">${Cg(e.value)}</td>`:``}
          </tr>`).join(``)}
        </tbody>
      </table>
    </div>
    <p class="adperf-note">Counted actions are chosen on the Google Ads integration page. These are Google's own numbers and may overlap magnet leads, so they are never added together.</p>`}function gg(e){let t=document.getElementById(`adperf-sources`),n=document.getElementById(`adperf-src-summary`);if(!t)return;let r=e&&Array.isArray(e.rows)?e.rows:[];if(!r.length){n&&(n.textContent=``),t.innerHTML=Og(`search_off`,`No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.`);return}let i=e.total_leads||r.reduce((e,t)=>e+(t.leads||0),0),a=e.tracked_leads||0;n&&(n.textContent=`${wg(a)} of ${wg(i)} leads tagged to a source`);let o=e=>e.campaign&&e.campaign!==`(none)`?Eg(e.campaign):e.source&&e.source!==`(direct)`?Eg(e.source):`<span class="adperf-src-untracked">Untracked / direct</span>`;t.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${r.map(e=>`
          <tr>
            <td>${o(e)}</td>
            <td class="adperf-src-sub">${Eg(e.source||`—`)}${e.medium?` · ${Eg(e.medium)}`:``}</td>
            <td class="num">${e.paid_clicks?wg(e.paid_clicks):`<span class="adperf-src-sub">—</span>`}</td>
            <td class="num"><b>${wg(e.leads)}</b></td>
          </tr>`).join(``)}
        </tbody>
      </table>
    </div>`;let s=t.querySelector(`.adperf-srctable tbody`);s&&en(s,{rowSelector:`tr`,noun:`sources`,controlHost:t.querySelector(`.adperf-srcwrap`)||t})}function _g(e,t){let n=document.getElementById(e);n&&(n.textContent=t)}function vg(e){if(e<=0)return 1;let t=10**Math.floor(Math.log10(e)),n=e/t;return(n<=1?1:n<=2?2:n<=5?5:10)*t}function yg(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3==0?0:1)+`k`:String(e)}function bg(e){let t=e.length||1,n=vg(Math.max(1,...e.map(e=>e.spend||0))),r=vg(Math.max(1,...e.map(e=>e.magnet_leads||0))),i=738/t,a=Math.min(24,i*.55),o=e=>56+i*(e+.5),s=e=>304-e/n*282,c=e=>304-e/r*282,l=[0,.25,.5,.75,1].map(e=>{let t=304-e*282;return`<line x1="56" y1="${t.toFixed(1)}" x2="794" y2="${t.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${(t+3.5).toFixed(1)}" text-anchor="end" class="ax">$${yg(n*e)}</text><text x="802" y="${(t+3.5).toFixed(1)}" text-anchor="start" class="ax">${yg(r*e)}</text>`}).join(``),u=e.map((e,t)=>{let n=s(e.spend||0);return`<rect x="${(o(t)-a/2).toFixed(1)}" y="${n.toFixed(1)}" width="${a.toFixed(1)}" height="${Math.max(0,304-n).toFixed(1)}" rx="3" fill="#0072BA"><title>${e.date}: $${e.spend} spend</title></rect>`}).join(``),d=e.map((e,t)=>`${o(t).toFixed(1)},${c(e.magnet_leads||0).toFixed(1)}`).join(` `),f=t>1?`<polyline points="${d}" fill="none" stroke="#009473" stroke-width="2.5"/>`:``,p=e.map((e,t)=>`<circle cx="${o(t).toFixed(1)}" cy="${c(e.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${e.date}: ${e.magnet_leads} leads</title></circle>`).join(``),m=Math.max(1,Math.ceil(t/6));return`
    ...
    </svg>`}var xg,Sg,Cg,wg,Tg,Eg,Dg,Og,kg,Ag,jg,Mg=o((()=>{T(),ga(),Dc(),Ea(),nn(),xg=()=>w.getConfig?.().BASE_URL||``,Sg=e=>e.toISOString().slice(0,10),Cg=e=>e==null?`—`:`$`+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),wg=e=>Number(e||0).toLocaleString(),Tg={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Eg=e=>String(e??``).replace(/[&<>"']/g,e=>Tg[e]),Dg=!1,Og=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,kg=[{d:7,label:`7 Days`},{d:30,label:`30 Days`},{d:90,label:`90 Days`}],Ag=30,jg={render:dg,init:fg}})),Ng=c({default:()=>e_,init:()=>Ig,parseBookingCsv:()=>qg,render:()=>Fg});function Pg(){if(Zg)return;let e=document.createElement(`style`);e.id=`m5t-adacct-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Zg=!0}function Fg(){return A()?sa({section:`ad-accounts`,title:`Ad Accounts`,description:`Pick a client to see their connected ad accounts.`}):(Pg(),dc(),`
    ...
    </div>`)}async function Ig(){if(A()){let e=e=>Number(e||0).toLocaleString();return ca(N(),[{h:`Spend`,td:t=>t.ad?`$${e(t.ad.spend)}`:`—`},{h:`Leads`,td:t=>e(t.leads.window??t.leads.total)},{h:`CPL`,td:t=>t.ad?.cost_per_lead==null?`—`:`$${e(t.ad.cost_per_lead)}`}],{emptyMsg:`No client orgs yet. Connect a client ad account to see it here.`})}await Lg()}async function Lg(){let[e,t,n]=await Promise.all([$s().catch(()=>null),fetch(`${N()}/m5t/v5/coreAdAccount`).then(e=>e.json()).catch(()=>null),fetch(`${N()}/m5t/v5/coreAdMetrics/conversions`).then(e=>e.json()).catch(()=>null)]);Rg(e,n),zg(t),Bg(t)}function Rg(e,t){let n=document.getElementById(`adacct-conn`);if(!n)return;let r=Sc.google_ads;if(!e||e.denied){n.innerHTML=_c(`link_off`,`Connection status is not available for your role.`);return}let i=Xs(e.providers,`google_ads`),a=Zs(r,i,!!e.configured?.google_ads),o=i?.external_account||{},s=r.card.reachableCount(o),c;c=a===`connected`?s?`${s} reachable account${s===1?``:`s`}.`:`Connected.`:a===`broken`?r.card.brokenDesc:a===`unavailable`?`Google Ads is being set up for this platform.`:gc()?`Not connected yet. Connect from Settings to pull spend and clicks.`:`Not connected yet.`;let l=gc()&&a!==`unavailable`?`<a class="adacct-manage" href="#/settings/integrations/${r.urlSlug}"><span class="material-symbols-outlined" aria-hidden="true">${a===`idle`?`link`:`settings`}</span>${a===`idle`?`Connect`:`Manage`}</a>`:``,u=``;if(t?.ok&&t.has_selection){let e=(t.actions||[]).map(e=>e.name||e.id),n=(t.selected_ids||[]).length-e.length;u=`
    ...
    <div class="adacct-conn">
      ...
      <div class="adacct-conn__titles">
        <span class="adacct-conn__name">${M(r.label)} ${Qs(a,i)}</span>
        <span class="adacct-conn__sub">${M(c)}</span>
      </div>
      <span class="adacct-conn__spacer"></span>
      ${l}
    </div>
    ${u}`}function zg(e){let t=document.getElementById(`adacct-list`),n=document.getElementById(`adacct-count`);if(!t)return;if(!e||e.ok===!1){t.innerHTML=_c(`error`,`Could not load ad accounts. Please try again.`);return}let r=(e.data||[]).filter(e=>e.status!==`DELETED`),i=!!e.canConnect;if(n&&(n.textContent=r.length?`${r.length} account${r.length===1?``:`s`}`:``),!r.length){t.innerHTML=_c(`link_off`,i?`No ad accounts associated yet.`:`No ad accounts yet. Your agency connects these for you.`)+(i?`<p class="adacct-note">Associate a client's Customer ID from the <a href="#/clients">Clients page</a>.</p>`:``);return}t.innerHTML=`
    <div class="adacct-wrap">
      <table class="adacct-table">
        <thead><tr><th>Platform</th><th>Customer ID</th><th>Status</th></tr></thead>
        <tbody>${r.map(e=>`
          <tr>
            <td>${M(Yg[e.provider]||e.provider)}</td>
            <td class="adacct-cid">${M(Xg(e.external_customer_id))}</td>
            <td><span class="m5t-badge" data-tone="${e.status===`ACTIVE`?`success`:`warning`}">${M(e.status===`ACTIVE`?`Active`:e.status)}</span></td>
          </tr>`).join(``)}
        </tbody>
      </table>
    </div>
    ${i?`<p class="adacct-note">Associations are managed per client from the <a href="#/clients">Clients page</a>.</p>`:``}`;let a=t.querySelector(`.adacct-table tbody`);a&&en(a,{rowSelector:`tr`,noun:`accounts`,controlHost:t.querySelector(`.adacct-wrap`)||t})}function Bg(e){let t=document.getElementById(`adacct-offline`);if(t){if(!e?.canConnect){t.style.display=`none`;return}t.style.display=``,document.getElementById(`adacct-oc-dl`)?.addEventListener(`click`,Gg),document.getElementById(`adacct-oc-up`)?.addEventListener(`click`,Wg),document.getElementById(`adacct-mc-file`)?.addEventListener(`change`,Kg),Vg()}}async function Vg(){Qg=[];try{let e=await(await fetch(`${N()}/m5t/v5/integrations/google_ads/conversion_actions`)).json();if(!e.ok)return;let t=e.data.actions||[];if(Qg=t.filter(e=>e.type===`UPLOAD_CLICKS`&&(e.account_ids||[]).length),!Qg.length){if(t.length){let e=document.getElementById(`adacct-oc-result`);e&&(e.textContent=`Direct upload needs an import type conversion action in Google Ads. The CSV works either way.`)}return}let n=document.getElementById(`adacct-oc-target`);n&&(n.innerHTML=Qg.map(e=>`<option value="${M(e.id)}">${M(e.name||e.id)}</option>`).join(``)),document.getElementById(`adacct-oc-target-wrap`)?.style.setProperty(`display`,``),document.getElementById(`adacct-oc-up`)?.style.setProperty(`display`,``)}catch{}}function Hg(){let e=document.getElementById(`adacct-oc-target`)?.value;return Qg.find(t=>t.id===e)||Qg[0]||null}async function Ug(e,t){let n=Hg();if(!n){t&&(t.textContent=`Pick an upload target first.`);return}let r=document.getElementById(`adacct-oc-value`)?.value,i=r!==``&&r!=null&&Number.isFinite(Number(r))?Number(r):null;t&&(t.textContent=`Uploading ${e.length} conversion${e.length===1?``:`s`}…`);try{let r=await(await fetch(`${N()}/m5t/v5/integrations/google_ads/upload_conversions`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({customer_id:n.account_ids[0],conversion_action_id:n.id,rows:e.map(e=>i==null?e:{...e,value:i})})})).json();if(!r.ok)throw Error(r.error||`upload failed`);let a=[`${r.data.uploaded} uploaded to Google Ads.`];r.data.failed&&a.push(`${r.data.failed} rejected${r.data.errors?.[0]?`: ${r.data.errors[0]}`:`.`}`),t&&(t.textContent=a.join(` `))}catch(e){t&&(t.textContent=e.message===`upload failed`?`Upload failed. Please try again.`:`Upload failed: ${e.message}`)}}async function Wg(){let e=document.getElementById(`adacct-oc-result`),t=Number(document.getElementById(`adacct-oc-days`)?.value)||90,n=[...document.querySelectorAll(`#adacct-oc-statuses input:checked`)].map(e=>e.value);if(!n.length){e&&(e.textContent=`Pick at least one status.`);return}let r=e=>e.toISOString().slice(0,10),i=r(new Date),a=r(new Date(Date.now()-(t-1)*864e5)),o=new URLSearchParams({from:a,to:i,statuses:n.join(`,`),format:`json`});try{let t=await(await fetch(`${N()}/m5t/v5/coreAdMetrics/offline-conversions.csv?${o}`)).json();if(!t.ok)throw Error();if(!t.rows.length){e&&(e.textContent=`No leads with a click id in that window.`);return}await Ug(t.rows,e)}catch{e&&(e.textContent=`Upload failed. Please try again.`)}}async function Gg(){let e=document.getElementById(`adacct-oc-result`),t=Number(document.getElementById(`adacct-oc-days`)?.value)||90,n=[...document.querySelectorAll(`#adacct-oc-statuses input:checked`)].map(e=>e.value);if(!n.length){e&&(e.textContent=`Pick at least one status.`);return}let r=document.getElementById(`adacct-oc-name`)?.value?.trim()||`M5M magnet lead`,i=document.getElementById(`adacct-oc-value`)?.value,a=e=>e.toISOString().slice(0,10),o=a(new Date),s=a(new Date(Date.now()-(t-1)*864e5)),c=new URLSearchParams({from:s,to:o,statuses:n.join(`,`),name:r});i!==``&&i!=null&&Number.isFinite(Number(i))&&c.set(`value`,i),e&&(e.textContent=`Building the export…`);try{let t=await fetch(`${N()}/m5t/v5/coreAdMetrics/offline-conversions.csv?${c}`);if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.text(),r=Math.max(0,n.trim().split(`
`).length-1);Jg(n,`google-ads-conversions-${s}-to-${o}.csv`),e&&(e.textContent=r?`${r} conversion${r===1?``:`s`} in the file.`:`No leads with a click id in that window. The file has headers only.`)}catch{e&&(e.textContent=`Export failed. Please try again.`)}}async function Kg(e){let t=document.getElementById(`adacct-mc-result`),n=e.target.files?.[0];if(!n)return;let r=qg(await n.text());if(!r.length){t&&(t.textContent=`No usable rows found. The CSV needs an email or phone column.`);return}t&&(t.textContent=`Matching ${r.length} row${r.length===1?``:`s`}…`);try{let e=await(await fetch(`${N()}/m5t/v5/coreAdMetrics/offline-conversions/match`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({rows:r})})).json();if(!e.ok)throw Error(e.error||`match failed`);let n=[`${e.matched_count} of ${r.length} rows matched a magnet lead with a click id.`];if(e.unmatched_count&&n.push(`${e.unmatched_count} had no matching lead.`),e.no_click_count&&n.push(`${e.no_click_count} matched a lead without a click id.`),!e.matched_count){t&&(t.textContent=n.join(` `));return}let i=document.getElementById(`adacct-oc-name`)?.value?.trim()||`M5M magnet lead`,a=document.getElementById(`adacct-oc-value`)?.value,o=a!==``&&a!=null&&Number.isFinite(Number(a))?Number(a):``,s=e=>`"${String(e??``).replace(/"/g,`""`)}"`,c=[`Google Click ID,Conversion Name,Conversion Time,Conversion Value,Conversion Currency`,...e.matched.map(e=>[s(e.gclid),s(i),s(e.time),o,``].join(`,`))].join(`\r
`)+`\r
`;if($g=e.matched.map(e=>({gclid:e.gclid,time:e.time})),t){t.innerHTML=``;let e=document.createElement(`span`);e.textContent=n.join(` `)+` `;let r=document.createElement(`button`);if(r.type=`button`,r.className=`adacct-manage`,r.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">download</span>Download matched CSV`,r.addEventListener(`click`,()=>Jg(c,`google-ads-conversions-matched-${new Date().toISOString().slice(0,10)}.csv`)),t.append(e,r),Qg.length){let e=document.createElement(`button`);e.type=`button`,e.className=`adacct-manage`,e.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">cloud_upload</span>Upload to Google Ads`,e.addEventListener(`click`,()=>Ug($g,t)),t.append(` `,e)}}}catch{t&&(t.textContent=`Matching failed. Please try again.`)}finally{e.target.value=``}}function qg(e){let t=[],n=[],r=``,i=!1;for(let a=0;a<e.length;a++){let o=e[a];i?o===`"`&&e[a+1]===`"`?(r+=`"`,a++):o===`"`?i=!1:r+=o:o===`"`?i=!0:o===`,`?(n.push(r),r=``):o===`
`||o===`\r`?(o===`\r`&&e[a+1]===`
`&&a++,n.push(r),r=``,n.some(e=>e.trim()!==``)&&t.push(n),n=[]):r+=o}if(n.push(r),n.some(e=>e.trim()!==``)&&t.push(n),t.length<2)return[];let a=t[0].map(e=>e.trim().toLowerCase()),o=a.findIndex(e=>/e-?mail/.test(e)),s=a.findIndex(e=>/phone|mobile|tel/.test(e)),c=a.findIndex(e=>/date|time|booked|appointment|start/.test(e));return o<0&&s<0?[]:t.slice(1).map(e=>({email:o>=0?(e[o]||``).trim():``,phone:s>=0?(e[s]||``).trim():``,at:c>=0?(e[c]||``).trim():``})).filter(e=>e.email||e.phone).slice(0,5e3)}function Jg(e,t){let n=new Blob([e],{type:`text/csv;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,document.body.appendChild(i),i.click(),i.remove(),setTimeout(()=>URL.revokeObjectURL(r),4e3)}var Yg,Xg,Zg,Qg,$g,e_,t_=o((()=>{ga(),nn(),Dc(),Yg={google_ads:`Google Ads`,google_lsa:`Local Services Ads`},Xg=e=>{let t=String(e||``).replace(/\D/g,``);return t.length===10?`${t.slice(0,3)}-${t.slice(3,6)}-${t.slice(6)}`:String(e||``)},Zg=!1,Qg=[],$g=null,e_={render:Fg,init:Ig}})),n_=c({default:()=>w_,init:()=>u_,openInviteModal:()=>m_,render:()=>l_});function r_(e,t=`info`){try{__.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}}function i_(){let e=w.getActiveOrg();if(e&&e.channel===v_)return{guid:e.guid,name:e.name};let t=w.getMemberships().find(e=>e.channel===v_);return t?{guid:t.orgGuid,name:t.name}:null}function a_(e){let t=e?.created_tz;if(!t)return``;let n=new Date(t);return Number.isNaN(n.getTime())?``:n.toLocaleDateString(void 0,{year:`numeric`,month:`short`,day:`numeric`})}function o_(){if(b_)return;let e=document.createElement(`style`);e.id=`m5t-clients-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),sr(),b_=!0}function s_(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function c_(e){let t=e.caption||e.guid,n=e.status||`ENABLED`;return`
    <div class="client-row">
      <span class="client-row__avatar">${Y(S_(t))}</span>
      <span class="client-row__main">
        <div class="client-row__name" title="${Y(t)}">${Y(t)}</div>
        <div class="client-row__meta">Added ${Y(a_(e.created))||`—`}</div>
      </span>
    ...
    <div class="page-shell" data-section="clients">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="clients-body">
          ${s_(`hourglass_empty`,`Loading clients…`)}
        </div>
      </div>
    </div>`}async function u_(){let e=i_();document.getElementById(`clients-add-btn`)?.addEventListener(`click`,()=>f_(e)),await d_(e)}async function d_(e){let t=document.getElementById(`clients-body`),n=document.getElementById(`clients-count`);if(t){if(!e?.guid){t.innerHTML=s_(`info`,`Client provisioning is available to reseller / agency accounts.`),n&&(n.textContent=``);return}try{let r=w.getConfig?.().BASE_URL||``,i=await fetch(`${r}/m5t/v5/acctGroup`);if(!i.ok)throw Error(`HTTP ${i.status}`);let a=await i.json(),o=(Array.isArray(a?.data)?a.data:[]).filter(t=>t.class===y_&&(!t.parent||t.parent===e.guid));if(!o.length){t.innerHTML=s_(`group_off`,`No clients yet. Add your first client to start managing magnets on their behalf.`),n&&(n.textContent=``);return}t.innerHTML=`<div class="client-list">${o.map(c_).join(``)}</div>`,en(t.querySelector(`.client-list`),{rowSelector:`.client-row`,noun:`clients`}),n&&(n.textContent=`${o.length} client${o.length===1?``:`s`}`),t.querySelectorAll(`.client-card__invite`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.action===`adaccounts`?p_(e.dataset.clientGuid,e.dataset.clientName):e.dataset.action===`questionnaire`?g_(e.dataset.clientGuid,e.dataset.clientName):m_(e.dataset.clientGuid,e.dataset.clientName)})})}catch(e){console.warn(`[clients] load failed:`,e),t.innerHTML=s_(`error`,`Couldn’t load clients. Please try again.`),n&&(n.textContent=``)}}}function f_(e){if(!e?.guid){r_(`Only reseller / agency accounts can add clients.`,`error`);return}let t=document.createElement(`div`);t.className=`client-modal-scrim`;let n=document.createElement(`div`);n.className=`client-modal`,n.setAttribute(`role`,`dialog`),n.setAttribute(`aria-modal`,`true`),n.innerHTML=`
    ...
    <div class="client-modal__body" id="qm-body">${s_(`hourglass_empty`,`Loading…`)}</div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add(`open`),i.classList.add(`open`)});let a=()=>{r.classList.remove(`open`),i.classList.remove(`open`),document.removeEventListener(`keydown`,o),setTimeout(()=>{r.remove(),i.remove()},200)},o=e=>{e.key===`Escape`&&a()};document.addEventListener(`keydown`,o),r.addEventListener(`click`,a),i.querySelector(`.client-modal__close`)?.addEventListener(`click`,a);let s=i.querySelector(`#qm-body`);function c(){s.innerHTML=`
      ...
      </div>`,s.querySelector(`[data-act="done"]`)?.addEventListener(`click`,a),s.querySelector(`[data-act="resend"]`)?.addEventListener(`click`,()=>c())}function d(e,t=!1){let r=e.editability||{editable:e.status===`SUBMITTED`&&!e.locked_tz,reason:e.locked_tz?`finalized`:null,deadline:null},i=!!r.editable,o=!i&&e.status===`SUBMITTED`?r.reason===`finalized`?`<div class="qm-status" data-status="LOCKED"><span class="material-symbols-outlined" aria-hidden="true">lock</span> Finalized${e.locked_tz?` ${Y(h_(e.locked_tz))}`:``}${e.locked_by_email?` by ${Y(e.locked_by_email)}`:``} — no further edits.</div>`:`<div class="qm-status" data-status="LOCKED"><span class="material-symbols-outlined" aria-hidden="true">lock_clock</span> Editing closed${r.deadline?` ${Y(h_(r.deadline))}`:``} — a response locks 14 days after it is submitted.</div>`:``,c=i&&r.deadline?`<p class="client-modal__sub qm-editable-hint">You can edit these answers until ${Y(h_(r.deadline))}.</p>`:``;s.innerHTML=`
      <div class="qm-status" data-status="SUBMITTED"><span class="material-symbols-outlined" aria-hidden="true">task_alt</span> Submitted ${e.submitted_tz?Y(h_(e.submitted_tz)):``}</div>
      ${o}
      ${or(e)}
      <form id="qm-form">
        ${rr(e,t?{renderAnswer:ir}:{})}
      </form>
      ${t?``:c}
      <p class="client-modal__error" id="qm-error"></p>
      <div class="client-modal__actions">
      ...
      </div>`,s.querySelector(`[data-act="done"]`)?.addEventListener(`click`,a),s.querySelector(`[data-act="cancel-edit"]`)?.addEventListener(`click`,()=>d(e,!1)),s.querySelector(`[data-act="edit"]`)?.addEventListener(`click`,()=>d(e,!0));let l=s.querySelector(`[data-act="save"]`);l?.addEventListener(`click`,async()=>{let t=ar(s);l.disabled=!0;let r=l.innerHTML;l.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…`;let i;try{i=await fetch(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e.guid)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({answers:t})});let r=await i.json().catch(()=>({}));if(!i.ok||!r.ok)throw Error(r.error||r.message||`Failed (HTTP ${i.status})`);r_(`Answers updated`,`success`);let a=await(await fetch(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e.guid)}`)).json().catch(()=>({}));d(a.ok?a.data:{...e,answers:t},!1)}catch(t){if(i&&i.status===423){r_(t.message||`This questionnaire is now locked.`,`info`);let r=await(await fetch(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e.guid)}`)).json().catch(()=>({}));d(r.ok?r.data:e,!1);return}s.querySelector(`#qm-error`).textContent=t.message||`Something went wrong. Please try again.`,l.disabled=!1,l.innerHTML=r}})}try{let t=await fetch(`${n}/m5t/v5/m5mQuestionnaireResponse?owner_guid=${encodeURIComponent(e)}`),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`HTTP ${t.status}`);let i=(r.data||[])[0]||null;if(!i){c();return}if(i.status===`DRAFT`){l(i);return}if(i.status===`CANCELLED`){u(i);return}let a=await fetch(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(i.guid)}`),o=await a.json().catch(()=>({}));if(!a.ok||!o.ok)throw Error(o.error||`HTTP ${a.status}`);d(o.data)}catch(e){console.warn(`[clients] questionnaire load failed:`,e),s.innerHTML=`<p class="client-modal__error">Could not load questionnaire status. ${Y(e.message||``)}</p>`}}var __,v_,y_,b_,x_,Y,S_,C_,w_,T_=o((()=>{T(),Qe(),__=u(f(),1),m(),nn(),dr(),v_=`reseller_org`,y_=`managed_client`,b_=!1,x_={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Y=e=>String(e??``).replace(/[&<>"']/g,e=>x_[e]),S_=e=>String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``).toUpperCase()||`?`,C_=e=>String(e||``).replace(/[^0-9]/g,``),w_={render:l_,init:u_}})),E_=c({default:()=>W_,init:()=>F_,loadTeam:()=>I_,render:()=>P_});function D_(){let e=w.getActiveOrg(),t=e&&e.channel!==z_?e:null;if(!t){let e=w.getMemberships().find(e=>e.channel!==z_);e&&(t={guid:e.orgGuid,channel:e.channel,memberRole:e.memberRole})}if(!t)return null;let n=w.getMemberships().find(e=>e.orgGuid===t.guid)?.name;return{...t,name:n}}function O_(e){return Object.values(Ie).filter(t=>Fe(e,t.value)).sort((e,t)=>t.rank-e.rank)}function k_(){if(B_)return;let e=document.createElement(`style`);e.id=`m5t-team-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),B_=!0}function A_(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function j_(e,t,n){let r=e.member_role||`member`,i=e.entity_guid&&e.entity_guid===w.getEntity?.()?.guid,a=n&&!i&&O_(t.memberRole).some(e=>e.value===r);return`
    <div class="team-row">
      <span class="team-avatar">${X(U_(e.name||e.email))}</span>
    ...
    </div>`}async function M_(e,t){let{uid:n,email:r}=e.dataset;if(window.confirm(`Revoke the invitation for ${r}?\n\nThe invitation link stops working immediately, including any copy already sent. You can invite this address again afterwards.`)){e.disabled=!0;try{let e=w.getConfig?.().BASE_URL||``,i=await fetch(`${e}/m5t/v5/acctGroup/${encodeURIComponent(t.guid)}/invites/${encodeURIComponent(n)}`,{method:`DELETE`}),a=await i.json().catch(()=>({}));if(!i.ok||!a.ok)throw Error(a.message||a.error||`HTTP ${i.status}`);H_(`Invitation for ${r} revoked`,`success`)}catch(t){e.disabled=!1,H_(t.message||`Could not revoke that invitation.`,`error`);return}try{await I_(t)}catch{}}}async function N_(e,t){let{id:n,name:r}=e.dataset;if(window.confirm(`Remove ${r} from the team?\n\nThey lose access to this workspace immediately. Their account itself is not deleted, and you can invite them again later.`)){e.disabled=!0;try{let e=w.getConfig?.().BASE_URL||``,t=await fetch(`${e}/m5t/v5/acctGroupMember/${encodeURIComponent(n)}`,{method:`DELETE`}),i=await t.json().catch(()=>({}));if(!t.ok||!i.ok)throw Error(i.message||i.error||`HTTP ${t.status}`);H_(`${r} removed from the team`,`success`)}catch(t){e.disabled=!1,H_(t.message||`Could not remove that member.`,`error`);return}try{await I_(t)}catch{}}}function P_(){return k_(),`
    <div class="page-shell" data-section="team">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="team-body">
          ${A_(`hourglass_empty`,`Loading team…`)}
        </div>
      </div>
    </div>`}async function F_(){let e=D_(),t=document.getElementById(`team-invite-btn`);if(!e){t&&(t.style.display=`none`),document.getElementById(`team-body`).innerHTML=A_(`info`,`Team management is available for agency and workspace accounts.`);return}t?.addEventListener(`click`,()=>L_(e)),await I_(e)}async function I_(e){let t=document.getElementById(`team-body`),n=document.getElementById(`team-count`);if(t)try{let r=w.getConfig?.().BASE_URL||``,[i,a]=await Promise.all([fetch(`${r}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/members`),fetch(`${r}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/invites`)]),[o,s]=await Promise.all([i.json().catch(()=>({})),a.json().catch(()=>({}))]);if(!i.ok||!a.ok)throw Error(`Failed to load team (members: ${i.status}, invites: ${a.status})`);let c=o.members||[],l=s.invites||[],u=O_(e.memberRole).length>0;t.innerHTML=(l.length?`
    ...
    <div class="team-modal__body" id="team-invite-body">
      ...
      <div class="team-modal__actions">
        ...
        </div>`;let u=r.querySelector(`#tm-link`);r.querySelector(`#tm-copy`)?.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(u.value),r.querySelector(`#tm-copy`).textContent=`Copied!`}catch{u.select()}}),r.querySelector(`[data-act="done"]`)?.addEventListener(`click`,()=>{i(),I_(e)})}catch(e){console.warn(`[team] invite failed:`,e),o.textContent=e.message||`Something went wrong. Please try again.`,s.disabled=!1,s.innerHTML=l}})}var R_,z_,B_,V_,X,H_,U_,W_,G_=o((()=>{T(),R_=u(f(),1),m(),Qe(),z_=`managed_client`,B_=!1,V_={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},X=e=>String(e??``).replace(/[&<>"']/g,e=>V_[e]),H_=(e,t=`info`)=>{try{R_.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},U_=e=>String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``).toUpperCase()||`?`,W_={render:P_,init:F_}}));m(),we(),T(),Kt(),y(),En(),Nn(),rt(),st(),$e(),window.m5t=Object.create(null),window.m5t.pubsub=b.default,console.log(`StreamSyncEngage SaaS Client - Starting...`),console.log(`Environment:`,`production`),console.log(`Document readyState:`,document.readyState),console.log(`window.mvvLegit:`,typeof window.mvvLegit),console.log(`globalThis.mvvLegit:`,typeof globalThis.mvvLegit);try{console.log(`mvvLegit (direct):`,typeof mvvLegit)}catch(e){console.log(`mvvLegit (direct): ReferenceError -`,e.message)}var K_=Object.keys(window).filter(e=>e.toLowerCase().includes(`mvv`)||e.toLowerCase().includes(`neodigm`)||e.toLowerCase().includes(`legit`));console.log(`Possible Neodigm globals:`,K_);var Z=new ee.default(`/`,{hash:!0});window.router=Z;function Q(e){let t=e?`${e.replace(/-/g,`_`)}_route`:`splash_route`;return console.log(`[Router] Checking access: ${e} -> ${t}`),mvvLegit.isRouteAllowed(t)?!0:(console.warn(`[Router] Access denied to route: ${t}`),b.default.publish(p.UI_TOAST,{message:`Please sign in to access this page`,type:`warning`}),!1)}function $(e){console.log(`[Router] Navigating to:`,e),Z.navigate(`/${e}`)}var q_=new Set([`splash`,`signin`,`signup`,`forgot`,`resethash`,`verf-link`,`accept-invite`,`signout`]),J_={},Y_={},X_=null,Z_={admin:{caption:`Platform Admin`,icon:`shield_person`},reseller:{caption:`Reseller`,icon:`handshake`},managed:{caption:`Managed`,icon:`visibility`},self_serve:{caption:`Self-Serve`,icon:`rocket_launch`}},Q_=`__portfolio__`;function $_(){try{Z._setCurrent(null)}catch{}Z.resolve()}function ev(){let e=document.getElementById(`m5t-side-nav`);if(!e)return;let t=!w.getScope()&&w.isAuthenticated(),n=w.getCapabilities(),r=w.getUiMode(),i=Zt.getSideNav(n,{uiMode:r});J_={},Y_={};let a=e=>{e.route&&(J_[e.route]={sectionToken:e.token,childToken:null,children:e.children||null},Array.isArray(e.children)&&e.children.forEach(t=>{t.route&&(Y_[t.token]=t.route,J_[t.route]={sectionToken:e.token,childToken:t.token,children:e.children})}))},o=e=>e.forEach(e=>{e.group&&Array.isArray(e.items)?o(e.items):a(e)});o(i);let s=w.getMemberships(),c=w.getActiveOrg(),l=w.getManagedClients(),u=w.getStoredActiveOrg(),d=l.length?[{guid:Q_,name:`Portfolio (all clients)`},...s.map(e=>({guid:e.orgGuid,name:e.name||e.channel,channel:e.channel,group:`Your organization`})),...l.map(e=>({guid:e.orgGuid,name:e.name||e.orgGuid,channel:e.channel,group:`Clients`}))]:s.map(e=>({guid:e.orgGuid,name:e.name||e.channel,channel:e.channel}));e.setState({buttons:i,orgs:d,activeOrg:l.length?u||Q_:c?.guid||null,footerBadge:Z_[r]||null,loading:t}),nv(),X_&&rv(X_)}var tv=e=>String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]);function nv(){let e=document.getElementById(`app-content`);if(!e)return;let t=document.getElementById(`org-context-banner`);t||(t=document.createElement(`div`),t.id=`org-context-banner`,e.insertBefore(t,e.firstChild),_n(t));let n=w.getActiveOrg(),r=w.isPreviewingAsClient(),i=!!n?.viaSubtree&&!!X_&&!q_.has(X_);if(t.hidden=!i,!i){t.innerHTML=``;return}let a=tv(n.name||`Client`);t.innerHTML=`
    <style>
    ...
    <div class="ocb" role="status">
    ...
    </div>`,t.querySelector(`[data-ocb="preview"]`)?.addEventListener(`click`,()=>{w.setPreviewAsClient(!w.isPreviewingAsClient()),$_()}),t.querySelector(`[data-ocb="portfolio"]`)?.addEventListener(`click`,()=>{w.setPreviewAsClient(!1),w.setActiveOrg(null)})}function rv(e){let t=document.getElementById(`m5t-side-nav`),n=J_[`/${e}`]||J_[e]||null;t?.setActiveToken(n?.sectionToken||null),iv(n)}function iv(e){let t=document.getElementById(`m5t-sub-nav`),n=document.getElementById(`app-shell`);if(!t)return;let r=e?.children;t.hidden=!1,r&&r.length>1?(t.updateButtons(r.map(t=>({token:t.token,caption:t.caption,enabled:!0,selected:t.token===e.childToken}))),n?.classList.add(`has-sub-nav`)):(t.updateButtons([]),n?.classList.remove(`has-sub-nav`))}function av(){let e=Gt.getAvailableLanguages&&Gt.getAvailableLanguages()||[];if(e.length<2){b.default.publish(p.UI_TOAST,{message:`Only one language is available`,type:`info`});return}let t=localStorage.getItem(v.FF_SSE_LS_USER_LANG)||v.FF_SSE_I18N_LANG||e[0],n=e[(e.indexOf(t)+1)%e.length];Gt.setLanguage(n),b.default.publish(p.UI_TOAST,{message:`Language: ${n}`,type:`info`})}function ov(){document.documentElement.classList.toggle(`ff-no-animations`,wn())}function sv(){let e=document.getElementById(`m5t-side-nav`);if(!e)return;Zt.setAppToken(`client-saas`),Tn(e),document.getElementById(`app-shell`)?.classList.toggle(`nav-collapsed`,e.getAttribute(`data-collapsed`)===`true`),e.addEventListener(`nav-select`,e=>{let t=e.detail?.route;t&&Z.navigate(t.startsWith(`/`)?t:`/${t}`)}),e.addEventListener(`logo-click`,()=>Z.navigate(`/home`)),e.addEventListener(`nav-collapse`,e=>{document.getElementById(`app-shell`)?.classList.toggle(`nav-collapsed`,!!e.detail?.collapsed)}),e.addEventListener(`org-switch`,e=>{let t=e.detail?.orgGuid;t&&w.setActiveOrg(t===Q_?null:t)}),e.addEventListener(`footer-action`,e=>{switch(e.detail?.action){case`account`:Z.navigate(`/settings`);break;case`signout`:Z.navigate(`/signout`);break;case`lang`:av();break;case`theme`:jn()}}),document.getElementById(`m5t-sub-nav`)?.addEventListener(`nav-select`,e=>{let t=Y_[e.detail?.token];t&&Z.navigate(t)}),document.addEventListener(`language-changed`,()=>ev()),ev(),b.default.subscribe(p.AUTH_SCOPE_LOADED,()=>ev());let t=()=>{let e=w.getScope();return[e?.uiMode,e?.activeOrg?.guid,(e?.managedClients||[]).length,(e?.capabilities||[]).join(`,`),w.getStoredActiveOrg()].join(`|`)},n=t();b.default.subscribe(p.AUTH_SCOPE_LOADED,()=>{let e=t();e!==n&&(n=e,X_&&!q_.has(X_)&&$_())})}function cv(e){X_=e;let t=document.getElementById(`m5t-side-nav`),n=document.getElementById(`app-shell`);if(!t||!n)return;let r=!q_.has(e);if(t.hidden=!r,n.classList.toggle(`has-side-nav`,r),pn(r),r)rv(e);else{let e=document.getElementById(`m5t-sub-nav`);e&&(e.hidden=!0),n.classList.remove(`has-sub-nav`)}nv()}b.default.subscribe(p.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&cv(t.route)});var lv=()=>{console.log(`[Router] Route: splash`),b.default.publish(p.ROUTE_NAV_BEFORE,{route:`splash`});let e=be()?.name;S(e===`invite`?()=>Promise.resolve().then(()=>(Vn(),Pn)):e===`questionnaire`?()=>Promise.resolve().then(()=>(Or(),mr)):e===`deliverable`?()=>Promise.resolve().then(()=>(ii(),Rr)):()=>Promise.resolve().then(()=>(li(),ai)),void 0,import.meta.url).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`splash`})}).catch(e=>{console.error(`[Router] Error loading splash route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`splash`,error:e})})};Z.on(`/`,lv),Z.on(`/splash`,lv),Z.on(`/signin`,()=>{console.log(`[Router] Route: /signin`),b.default.publish(p.ROUTE_NAV_BEFORE,{route:`signin`}),S(()=>Promise.resolve().then(()=>(xi(),mi)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`signin`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading signin route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`signin`,error:e})})}),Z.on(`/signup`,()=>{console.log(`[Router] Route: /signup`),b.default.publish(p.ROUTE_NAV_BEFORE,{route:`signup`}),S(()=>Promise.resolve().then(()=>(Pi(),Ti)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`signup`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading signup route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`signup`,error:e})})}),Z.on(`/verf-link`,()=>{console.log(`[Router] Route: /verf-link`),b.default.publish(p.ROUTE_NAV_BEFORE,{route:`verf-link`}),S(()=>Promise.resolve().then(()=>(Ri(),Fi)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`verf-link`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading verf-link route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`verf-link`,error:e})})}),Z.on(`/forgot`,()=>{console.log(`[Router] Route: /forgot`),b.default.publish(p.ROUTE_NAV_BEFORE,{route:`forgot`}),S(()=>Promise.resolve().then(()=>(Yi(),Wi)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`forgot`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading forgot route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`forgot`,error:e})})}),Z.on(`/resethash`,()=>{if(console.log(`[Router] Route: /resethash`),!Q(`resethash`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`resethash`}),S(()=>Promise.resolve().then(()=>(ta(),Xi)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`resethash`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading resethash route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`resethash`,error:e})})}),Z.on(`/home`,()=>{if(console.log(`[Router] Route: /home`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`home`}),S(()=>Promise.resolve().then(()=>(eo(),Da)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`home`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading home route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`home`,error:e})})}),Z.on(`/signout`,()=>{if(console.log(`[Router] Route: /signout`),!Q(`signout`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`signout`}),S(()=>Promise.resolve().then(()=>(io(),to)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`signout`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading signout route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`signout`,error:e})})}),[{path:`/billing`,name:`billing`,title:`Billing`,icon:`receipt_long`},{path:`/magnets/drafts`,name:`magnets/drafts`,title:`Magnets · Drafts`,icon:`widgets`},{path:`/magnets/archived`,name:`magnets/archived`,title:`Magnets · Archived`,icon:`widgets`},{path:`/analytics/conversions`,name:`analytics/conversions`,title:`Analytics · Conversions`,icon:`monitoring`}].forEach(({path:e,name:t,title:n,icon:r})=>{Z.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:t}),S(()=>Promise.resolve().then(()=>(fo(),ao)).then(e=>{let i=document.getElementById(`app`);i.innerHTML=e.render({title:n,icon:r,name:t}),e.init&&e.init({name:t}),b.default.publish(p.ROUTE_NAV_AFTER,{route:t})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading section route (${t}):`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:t,error:e})})})}),Z.on(`/settings`,()=>{if(console.log(`[Router] Route: /settings`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings`}),S(()=>Promise.resolve().then(()=>(Io(),po)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`settings`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-general route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`settings`,error:e})})}),Z.on(`/settings/workspace`,()=>{if(console.log(`[Router] Route: /settings/workspace`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/workspace`}),S(()=>Promise.resolve().then(()=>(ps(),Lo)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/workspace`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-workspace route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/workspace`,error:e})})}),Z.on(`/settings/notifications`,()=>{if(console.log(`[Router] Route: /settings/notifications`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/notifications`}),S(()=>Promise.resolve().then(()=>(Rs(),ms)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/notifications`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-notifications route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/notifications`,error:e})})}),Z.on(`/settings/integrations`,()=>{if(console.log(`[Router] Route: /settings/integrations`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/integrations`}),S(()=>Promise.resolve().then(()=>(zc(),Oc)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/integrations`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-integrations route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/integrations`,error:e})})}),Z.on(`/settings/integrations/:provider`,e=>{let t=e?.data?.provider||``;if(console.log(`[Router] Route: /settings/integrations/`+t),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/integrations`}),S(()=>Promise.resolve().then(()=>(rl(),Bc)).then(e=>{let n=document.getElementById(`app`);n.innerHTML=e.render({provider:t}),e.init&&e.init({provider:t}),b.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/integrations`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading integration detail route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/integrations`,error:e})})}),Z.on(`/settings/security`,()=>{if(console.log(`[Router] Route: /settings/security`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/security`}),S(()=>Promise.resolve().then(()=>(Ol(),il)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/security`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-security route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/security`,error:e})})}),Z.on(`/conversations`,()=>{if(console.log(`[Router] Route: /conversations`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`conversations`}),S(()=>Promise.resolve().then(()=>(Ql(),kl)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`conversations`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading conversations route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`conversations`,error:e})})}),Z.on(`/ab-testing`,()=>{if(console.log(`[Router] Route: /ab-testing`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`ab-testing`}),S(()=>Promise.resolve().then(()=>(wu(),$l)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`ab-testing`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading ab-testing route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`ab-testing`,error:e})})}),Z.on(`/magnets`,()=>{if(console.log(`[Router] Route: /magnets`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`magnets`}),S(()=>Promise.resolve().then(()=>(Lp(),of)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`magnets`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading magnets route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`magnets`,error:e})})}),Z.on(`/templates`,()=>{if(console.log(`[Router] Route: /templates`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`templates`}),S(()=>Promise.resolve().then(()=>(Xp(),Rp)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`templates`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading templates route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`templates`,error:e})})}),Z.on(`/questionnaires`,()=>{if(console.log(`[Router] Route: /questionnaires`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`questionnaires`}),S(()=>Promise.resolve().then(()=>(Sm(),Zp)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`questionnaires`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading questionnaires route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`questionnaires`,error:e})})}),Z.on(`/deliverables`,()=>{if(console.log(`[Router] Route: /deliverables`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`deliverables`}),S(()=>Promise.resolve().then(()=>(nh(),Cm)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`deliverables`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading deliverables route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`deliverables`,error:e})})}),Z.on(`/deliverable-preview/:guid`,e=>{if(console.log(`[Router] Route: /deliverable-preview`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`deliverable-preview`}),S(()=>Promise.resolve().then(()=>(ii(),Rr)).then(t=>{let n=document.getElementById(`app`);n.innerHTML=t.render(),t.initPreview(e.data.guid),b.default.publish(p.ROUTE_NAV_AFTER,{route:`deliverable-preview`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading deliverable preview route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`deliverable-preview`,error:e})})}),Z.on(`/leads`,()=>{if(console.log(`[Router] Route: /leads`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`leads`}),S(()=>Promise.resolve().then(()=>(Hh(),rh)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`leads`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading leads route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`leads`,error:e})})}),Z.on(`/analytics`,()=>{if(console.log(`[Router] Route: /analytics`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`analytics`}),S(()=>Promise.resolve().then(()=>(cg(),Uh)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`analytics`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading analytics route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`analytics`,error:e})})}),Z.on(`/analytics/ad-performance`,()=>{if(console.log(`[Router] Route: /analytics/ad-performance`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`analytics/ad-performance`}),S(()=>Promise.resolve().then(()=>(Mg(),lg)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`analytics/ad-performance`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading ad-performance route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`analytics/ad-performance`,error:e})})}),Z.on(`/ad-accounts`,()=>{if(console.log(`[Router] Route: /ad-accounts`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`ad-accounts`}),S(()=>Promise.resolve().then(()=>(t_(),Ng)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`ad-accounts`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading ad-accounts route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`ad-accounts`,error:e})})}),Z.on(`/clients`,()=>{if(console.log(`[Router] Route: /clients`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`clients`}),S(()=>Promise.resolve().then(()=>(T_(),n_)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`clients`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading clients route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`clients`,error:e})})}),Z.on(`/team`,()=>{if(console.log(`[Router] Route: /team`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`team`}),S(()=>Promise.resolve().then(()=>(G_(),E_)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`team`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading team route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`team`,error:e})})}),Z.notFound(()=>{console.log(`[Router] Route not found - redirecting to splash`),$(`splash`)}),b.default.subscribe(p.ROUTE_NAV,(e,t)=>{console.log(`[Router] ROUTE_NAV event received:`,t),t?.route&&$(t.route)});function uv(){console.log(`[App] Waiting for Neodigm 55 library...`);let e=0,t=setInterval(()=>{e++,e%10==0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<`u`,neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<`u`?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(t),dv()):e>=100&&(clearInterval(t),console.error(`[App] Failed to load Neodigm 55 library after 10 seconds`),console.error(`[App] Check browser console for CORS or network errors`),document.getElementById(`app`).innerHTML=`
      ...
      `,b.default.publish(p.APP_ERROR,{message:`Failed to load authentication library`}))},100)}document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,uv):uv();async function dv(){if(console.log(`[App] Neodigm 55 loaded, initializing...`),On(),ov(),ue(),Gt.initialize(),console.log(`[App] I18n Controller initialized`),!await w.init({BASE_URL:`https://machfivemagnet-saas.onrender.com`,navigateFunction:e=>{console.log(`[AuthController] Navigation requested:`,e),$(e)}})){console.error(`[App] AuthController initialization failed`);return}let e=w.getEntity();e&&(console.log(`[App] Session restored for:`,e.email),b.default.publish(p.APP_USER_LOADED,{entity:e}),w.isAuthenticated()&&(localStorage.getItem(w.CONFIG.LS_KEYS.ACTIVE_ORG)?await w.fetchScope():w.fetchScope())),b.default.publish(p.APP_READY,{timestamp:new Date().toISOString(),sessionUser:e}),sv(),xn(),Z.resolve(),window.AuthController=w,window.I18nController=Gt,window.MachVive=qt,console.log(`[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)`)}b.default.subscribe(p.ROUTE_NAV_AFTER,(e,t)=>{Gt!==void 0&&Gt.refresh&&setTimeout(()=>{Gt.refresh()},100)});
