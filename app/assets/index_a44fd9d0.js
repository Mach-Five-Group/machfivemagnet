...
`,t)}function ts(){if(!Nt())return Gt.stubThis(new Promise(t=>t(!1)));const e=globalThis.PublicKeyCredential;return e?.isConditionalMediationAvailable===void 0?Gt.stubThis(new Promise(t=>t(!1))):Gt.stubThis(e.isConditionalMediationAvailable())}const Gt={stubThis:e=>e};function ol({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new re({message:"Authentication ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else{if(e.name==="NotAllowedError")return new re({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if(Zo(n)){if(a.rpId!==n)return new re({message:`The RP ID "${a.rpId}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new re({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="UnknownError")return new re({message:"The authenticator was unable to process the specified options, or could not create a new assertion signature",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}async function sl(e){!e.optionsJSON&&e.challenge&&(console.warn("startAuthentication() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useBrowserAutofill:a=!1,verifyBrowserAutofillInput:n=!0}=e;if(!Nt())throw new Error("WebAuthn is not supported in this browser");let o;t.allowCredentials?.length!==0&&(o=t.allowCredentials?.map(Xo));const s={...t,challenge:Lt(t.challenge),allowCredentials:o},r={};if(a){if(!await ts())throw Error("Browser does not support WebAuthn autofill");if(document.querySelectorAll("input[autocomplete$='webauthn']").length<1&&n)throw Error('No <input> with "webauthn" as the only or last value in its `autocomplete` attribute was detected');r.mediation="conditional",s.allowCredentials=[]}r.publicKey=s,r.signal=rn.createNewAbortSignal();let i;try{i=await navigator.credentials.get(r)}catch(v){throw ol({error:v,options:r})}if(!i)throw new Error("Authentication was not completed");const{id:l,rawId:c,response:p,type:h}=i;let b;return p.userHandle&&(b=Se(p.userHandle)),{id:l,rawId:Se(c),response:{authenticatorData:Se(p.authenticatorData),clientDataJSON:Se(p.clientDataJSON),signature:Se(p.signature),userHandle:b},type:h,clientExtensionResults:i.getClientExtensionResults(),authenticatorAttachment:es(i.authenticatorAttachment)}}function rl(){return Nt()?PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable():new Promise(e=>e(!1))}const as=Object.freeze(Object.defineProperty({__proto__:null,WebAuthnAbortService:rn,WebAuthnError:re,_browserSupportsWebAuthnAutofillInternals:Gt,_browserSupportsWebAuthnInternals:Qo,base64URLStringToBuffer:Lt,browserSupportsWebAuthn:Nt,browserSupportsWebAuthnAutofill:ts,bufferToBase64URLString:Se,platformAuthenticatorIsAvailable:rl,startAuthentication:sl,startRegistration:nl},Symbol.toStringTag,{value:"Module"}));let Fn=!1;function il(){if(Fn)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Dn=!0}function Bn(){return E.getConfig?.().BASE_URL||""}function ul(e){const t=`qf-${e.id}`;if(e.type==="checkbox_group"){const a=Array.isArray(e.options)?e.options:[];return`
  ...
  `}function Hl(){console.log("[ResethashRoute] Initialized");const e=document.getElementById("resethash-form"),t=e.querySelector('button[type="submit"]');Hn("toggleNewPassword","new-password","eyeIconNew"),Hn("toggleConfirmPassword","confirm-password","eyeIconConfirm"),e?.addEventListener("submit",async a=>{a.preventDefault();const n=e.email.value.trim(),o=e.newPassword.value,s=e.confirmPassword.value,r=document.getElementById("new-password"),i=document.getElementById("confirm-password");if(!o){ge(r,I.get("validation_new_password_required"));return}const l=is(o);if(l.length>0){ge(r,ls(l));return}if(!s){ge(i,I.get("validation_new_password_required"));return}if(o!==s){ge(i,I.get("validation_password_mismatch"));return}t.disabled=!0,t.textContent=I.get("loading_resetting_password");try{const c=await E.doResetHash(n,o);c.ok?(typeof neodigmToast<"u"&&neodigmToast.q(I.get("success_password_reset"),"success"),m.publish(g.AUTH_RESETHASH_SUCCESS,{email:n})):(ge(r,c.error||I.get("error_signin_failed")),t.disabled=!1,t.textContent=(I.get("update_password")||"Update password").toUpperCase())}catch(c){console.error("[ResethashRoute] Reset password error:",c),ge(r,c.message||I.get("error_network")),t.disabled=!1,t.textContent=(I.get("update_password")||"Update password").toUpperCase()}})}function Hn(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}const zl=Object.freeze(Object.defineProperty({__proto__:null,init:Hl,render:ql},Symbol.toStringTag,{value:"Module"})),pe=()=>E.getManagedClients().length>0&&!E.getStoredActiveOrg(),qe=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),Gl={reseller_org:"Your org",managed_client:"Client",saas_org:"Org"};let zn=!1;function ht(){if(zn)return;const e=document.createElement("style");e.id="m5t-portfolio-styles",e.textContent=`
  ...
  <div class="dashboard-card${n?" chart-card-wide":""}${o?" chart-card-full":""}">
    ...
    <div class="page-shell" data-section="home">
      ...
      <div class="content-grid">
        ...
        </a>`).join("")}</div>`:be("source","No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here."));const b={book:["event","Book"],chat:["chat","Chat"],call:["phone_in_talk","Call"],email:["mail","Email"],support:["support_agent","Support"]},v=Object.entries(r.routes||{}).sort((_,A)=>A[1]-_[1]),u=v.length?v[0][1]:0;rt("dash-routes",v.length?`<div class="dash-funnel">${v.map(([_,A])=>{const[C,$]=b[_]||["touch_app",_];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${C}</span> ${me($)}</span><span class="dash-funnel__val">${K(A)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${u?Math.max(4,Math.round(A/u*100)):0}%"></div></div>
        </div>`}).join("")}</div>`:be("touch_app","CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar."));const d={open:["visibility","Magnet opened"],engage:["touch_app","Visitor engaged"],route:["alt_route","Picked a channel"],complete:["check_circle","Completed: lead captured"]},f=s.recent_events||[];rt("dash-interactions",f.length?`<div class="dash-list">${f.map(_=>{const[A,C]=d[_.event]||["sensors",_.event],$=_.event==="route"&&_.detail?` · ${me(_.detail)}`:"";return`<div class="dash-list__row">
    ...
    </div>`).join("")}</div>`}async function tc(e){const t=document.getElementById("recent-leads-body");if(t)try{const a=await fetch(`${e}/m5t/v5/m5mLead`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json(),o=(Array.isArray(n?.data)?n.data:[]).filter(s=>!["DELETED","ARCHIVED"].includes(s.status));t.innerHTML=o.length?o.slice(0,5).map(Ql).join(""):be("contacts","No leads captured yet. Publish a magnet to start collecting.")}catch(a){console.warn("[dashboard] Leads fetch failed:",a),t.innerHTML=be("error","Could not load recent leads.")}}function Yn(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}const Kn=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e));function fs(e){const v=e.length||1,u=Yn(Math.max(1,...e.map(F=>F.opens||0))),d=Yn(Math.max(1,...e.map(F=>F.leads||0))),f=748/v,_=Math.min(22,f*.55),A=F=>46+f*(F+.5),C=F=>266-F/u*248,$=F=>266-F/d*248,W=[0,.5,1].map(F=>{const j=266-F*248;return`<line x1="46" y1="${j.toFixed(1)}" x2="794" y2="${j.toFixed(1)}" stroke="#EAF0F7"/><text x="38" y="${(j+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${Kn(u*F)}</text><text x="802" y="${(j+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${Kn(d*F)}</text>`}).join(""),B=e.map((F,j)=>{const ze=C(F.opens||0);return`<rect class="dash-bar" data-i="${j}" x="${(A(j)-_/2).toFixed(1)}" y="${ze.toFixed(1)}" width="${_.toFixed(1)}" height="${Math.max(0,266-ze).toFixed(1)}" rx="3" fill="#0072BA"/>`}).join(""),Y=e.map((F,j)=>`${A(j).toFixed(1)},${$(F.leads||0).toFixed(1)}`).join(" "),se=v>1?`<polyline points="${Y}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",ue=e.map((F,j)=>`<circle class="dash-dot" data-i="${j}" cx="${A(j).toFixed(1)}" cy="${$(F.leads||0).toFixed(1)}" r="3.2" fill="#009473"/>`).join(""),ce='<line class="dash-crosshair" x1="0" y1="18" x2="0" y2="266" pointer-events="none"/>',Ae=Math.max(1,Math.ceil(v/6)),M=e.map((F,j)=>j%Ae===0||j===v-1?`<text x="${A(j).toFixed(1)}" y="288" text-anchor="middle" class="dash-ax">${F.date.slice(5)}</text>`:"").join(""),ee=e.map((F,j)=>`<rect class="dash-hit" data-i="${j}" data-day="${me(F.date)}" data-leads="${Number(F.leads||0)}" x="${(46+f*j).toFixed(1)}" y="18" width="${f.toFixed(1)}" height="${248 .toFixed(1)}" fill="transparent"/>`).join("");return`
  ...
  `,document.head.appendChild(e),Jn=!0}function bs({title:e="Section",icon:t="widgets",name:a=""}={}){return ic(),`
    ...
    </section>`}function _s(){}const lc={render:bs,init:_s},cc=Object.freeze(Object.defineProperty({__proto__:null,default:lc,init:_s,render:bs},Symbol.toStringTag,{value:"Module"})),dc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ke=e=>String(e??"").replace(/[&<>"']/g,t=>dc[t]),_e=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},tt=()=>E.getConfig?.().BASE_URL||"",pc=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,ea=5,ve={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},Ua=()=>E.getActiveOrg()?.guid||E.getMemberships()[0]?.orgGuid||null;let Qn=!1;function uc(){if(Qn)return;const e=document.createElement("style");e.id="m5t-notif-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),io=!0}const ga=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Ms(){return jc(),ht(),`
    ...
    </div>`}async function Ps(){await Vc()}async function Vc(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${za()}/m5t/v5/conversations`),fetch(`${za()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(G.conversations=n.conversations||[],G.counts=n.counts||{},G.book=pe(),a){const o=await a.json().catch(()=>({}));G.magnetNames={},G.magnetOwnerNames={};const s=G.book?ps():{};(o.magnets||[]).forEach(r=>{G.magnetNames[r.guid]=r.name,G.book&&(G.magnetOwnerNames[r.guid]=r.owner_name||s[r.owner_guid]||"")})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=ga("error","Could not load journeys. Please try again.");return}Fs()}}function Wc(){return G.filter==="ALL"?G.conversations:G.conversations.filter(e=>e.status===G.filter)}function Yc(e){const t=Ls(e.lead),a=G.magnetNames[e.magnet_guid]||"—",n=ro[e.status]||ro.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,s=(e.routes||[]).map(r=>Ga[r]||r).join(", ");return`
    <tr class="convs-row" data-session="${ne(e.session)}">
      ...
      ${G.book?`<td>${us(G.magnetOwnerNames[e.magnet_guid]||"")||'<span class="convs-muted">—</span>'}</td>`:""}
    ...
    <div class="convs-bar">
      <div class="convs-filter">
        ${a.map(([n,o])=>`<button data-filter="${n}" class="${G.filter===n?"active":""}">${o}${n!=="ALL"&&G.counts[n]?` (${$a(G.counts[n])})`:""}</button>`).join("")}
      </div>
      <span class="convs-count">${$a(t.length)} of ${$a(G.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(Yc).join("")||`<tr><td colspan="${G.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${G.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(G.filter=o.dataset.filter,Fs())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&Jc(o.dataset.session)})}const Kc={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${Ga[e]||e}`:""}`,route:e=>`Picked ${Ga[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function Jc(e){const t=G.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${za()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=Ls(t.lead),o=G.magnetNames[t.magnet_guid]||"—",r=(a?.events||[]).filter((c,p,h)=>c.event!=="step"||!(h[p+1]&&h[p+1].event==="step")).map(c=>`
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${a.kind}">
  ...
  </div>`}function yn(e){const t=q.owners.length>1||E.getMemberships().length>1,a=(e.domains||[]).filter(Boolean),n=q.canManage;return`
...
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:dr(e),actions:t,font:e.querySelector("#mag-f-font").value.trim(),theme_vars:pp(e),inline_width:e.querySelector("#mag-f-inline-w").value.trim(),inline_height:e.querySelector("#mag-f-inline-h").value.trim(),hide_launcher:e.querySelector("#mag-f-hide-launcher").checked,input_placeholder:e.querySelector("#mag-f-input-ph").value,summary_confirm_label:e.querySelector("#mag-f-summary-confirm").value.trim(),success_title:e.querySelector("#mag-f-success-title").value.trim(),success_text:e.querySelector("#mag-f-success-text").value,success_cta:up(e)}}const rp=512,ip=new Set(["image/png","image/jpeg","image/gif","image/webp"]),lp=8*1024*1024;function cp(e){return new Promise((t,a)=>{const n=new Image,o=new FileReader;o.onerror=()=>a(new Error("Could not read that file.")),o.onload=()=>{n.onerror=()=>a(new Error("That file isn’t a readable image.")),n.onload=()=>{const s=Math.min(1,rp/Math.max(n.naturalWidth,n.naturalHeight)),r=Math.max(1,Math.round(n.naturalWidth*s)),i=Math.max(1,Math.round(n.naturalHeight*s)),l=document.createElement("canvas");l.width=r,l.height=i,l.getContext("2d").drawImage(n,0,0,r,i),t(l.toDataURL("image/png"))},n.src=o.result},o.readAsDataURL(e)})}function dp(e,t){const a=e.querySelector("#mag-logo-drop");if(!a)return;const n=e.querySelector("#mag-f-logo-file"),o=e.querySelector("#mag-logo-browse"),s=e.querySelector("#mag-logo-remove"),r=e.querySelector("#mag-logo-preview"),i=e.querySelector("#mag-logo-status"),l=e.querySelector("#mag-f-logo"),c=(v,u)=>{i.textContent=v,i.style.color=u?"var(--color-danger, #DD4124)":""},p=v=>{r.innerHTML=v?`<img src="${w(v)}" alt="">`:'<span class="material-symbols-outlined" aria-hidden="true">image</span>',s.hidden=!v},h=v=>{l.value=v,l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))};async function b(v){if(!ip.has(v.type)){c("PNG, JPEG, GIF, or WEBP only.",!0);return}if(v.size>lp){c("That file is too large (8MB max before resizing).",!0);return}c("Uploading…",!1);try{const u=await cp(v),d=await fetch(`${te()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({image:u})}),f=await d.json().catch(()=>({}));if(!d.ok||!f.ok)throw new Error(f.error||`Upload failed (${d.status})`);const _=`${te()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;h(_),p(_),c("Logo updated.",!1)}catch(u){c(u.message||"Upload failed.",!0)}}n.addEventListener("change",()=>{n.files[0]&&b(n.files[0]),n.value=""}),a.addEventListener("click",v=>{v.target===s||s.contains(v.target)||v.target!==o&&n.click()}),o.addEventListener("click",()=>n.click()),["dragenter","dragover"].forEach(v=>a.addEventListener(v,u=>{u.preventDefault(),a.classList.add("is-dragover")})),["dragleave","drop"].forEach(v=>a.addEventListener(v,u=>{u.preventDefault(),a.classList.remove("is-dragover")})),a.addEventListener("drop",v=>{const u=v.dataTransfer?.files?.[0];u&&b(u)}),s.addEventListener("click",async v=>{v.stopPropagation(),c("Removing…",!1);try{const u=await fetch(`${te()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"DELETE"}),d=await u.json().catch(()=>({}));if(!u.ok||!d.ok)throw new Error(d.error||`Remove failed (${u.status})`);h(""),p(""),c("Logo removed.",!1)}catch(u){c(u.message||"Remove failed.",!0)}})}function pp(e){return e.querySelector("#mag-f-surface-on")?.checked?{surface:e.querySelector("#mag-f-sv-surface").value,surface_2:e.querySelector("#mag-f-sv-surface2").value,border:e.querySelector("#mag-f-sv-border").value,text:e.querySelector("#mag-f-sv-text").value,text_sub:e.querySelector("#mag-f-sv-textsub").value}:{}}function up(e){const t=e.querySelector("#mag-f-success-cta-label").value.trim(),a=e.querySelector("#mag-f-success-cta-url").value.trim();return t&&a?{label:t,url:a}:{}}function dr(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",s=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==s.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}const Ka=[{label:"Web fonts (loaded for you)",opts:[["Inter, sans-serif","Inter"],["Poppins, sans-serif","Poppins"],["Montserrat, sans-serif","Montserrat"],["Roboto, sans-serif","Roboto"],['"Open Sans", sans-serif',"Open Sans"],["Lato, sans-serif","Lato"],["Nunito, sans-serif","Nunito"],["Raleway, sans-serif","Raleway"],['"Work Sans", sans-serif',"Work Sans"],["Oswald, sans-serif","Oswald"],["Merriweather, serif","Merriweather (serif)"]]},{label:"System / always available",opts:[["system-ui, sans-serif","System UI"],["Georgia, serif","Georgia (serif)"],['"Times New Roman", Times, serif',"Times (serif)"],["Arial, Helvetica, sans-serif","Arial / Helvetica"],["Verdana, Geneva, sans-serif","Verdana"],['"Courier New", monospace',"Courier (mono)"]]}];function mp(e){const t=String(e||""),a=new Set(Ka.flatMap(s=>s.opts.map(([r])=>r))),n=s=>s===t?" selected":"";let o=`<option value=""${t===""?" selected":""}>System default</option>`;t&&!a.has(t)&&(o+=`<option value="${w(t)}" selected>Current: ${w(t)}</option>`);for(const s of Ka)o+=`<optgroup label="${w(s.label)}">`+s.opts.map(([r,i])=>`<option value="${w(r)}"${n(r)}>${w(i)}</option>`).join("")+"</optgroup>";return o}function ia(e,t,a={}){const{freshDraft:n=!1}=a,o=!!e,s=o?null:crypto.randomUUID(),r=!o&&q.owners.length>1,i=e?.display_mode||"chat",l=e?.theme_mode||"auto",c={};(e?.actions||[]).forEach(S=>{S&&S.type&&(c[S.type]=S)});const p=o?!!e.home:!0,h=o?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",b=e?.theme_vars&&typeof e.theme_vars=="object"?e.theme_vars:{},v=Object.keys(b).length>0,u=(S,U)=>w(/^#[0-9a-fA-F]{6}$/.test(b[S]||"")?b[S]:U),d=document.createElement("div");d.className="mag-modal-scrim",d.innerHTML=`
    ...
    </div>`,document.body.appendChild(d),requestAnimationFrame(()=>{d.classList.add("open"),d.querySelector(".mag-modal").classList.add("open")});const f=[...d.querySelectorAll(".mag-modal__navitem")],_=[...d.querySelectorAll(".mag-tab")],A=S=>{f.forEach(U=>U.classList.toggle("is-active",U.dataset.tab===S)),_.forEach(U=>{U.hidden=U.dataset.tab!==S}),d.querySelector(".mag-modal__body").scrollTop=0};f.forEach(S=>S.addEventListener("click",()=>A(S.dataset.tab)));const C=()=>Ya({...e,...Ia(d),...o?{steps:fo()}:{}}),$=d.querySelector("#mag-preview-pane"),W=()=>window.matchMedia("(min-width: 1200px)").matches;let B=null;const Y=()=>{if(!B&&W())try{B=Md($,C)}catch{}};let se=null;const ue=()=>{W()&&(Y(),B&&(clearTimeout(se),se=setTimeout(()=>{try{B.refresh()}catch{}},300)))},ce=window.matchMedia("(min-width: 1200px)"),Ae=()=>{W()&&(Y(),ue())};ce.addEventListener("change",Ae);let M=!1,ee=!1;const F=d.querySelector("#mag-f-dirty"),j=S=>{M=S,F&&(F.hidden=!S)},ze=d.querySelector(".mag-modal__main");ze.addEventListener("input",()=>j(!0)),ze.addEventListener("change",()=>{j(!0),ue()}),d.querySelector("#mag-f-color")?.addEventListener("input",()=>{j(!0),ue()});const Ge=S=>{M&&(S.preventDefault(),S.returnValue="")};window.addEventListener("beforeunload",Ge);let yt=!0;const va=m.subscribe(g.ROUTE_NAV_BEFORE,()=>{if(yt){if(M&&!confirm("Discard your changes to this magnet?")){window.router?.navigate("/magnets");return}y()}}),y=()=>{if(n&&!ee&&e&&e.status==="DRAFT"){fetch(`${te()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"}).catch(()=>{}),q.magnets=q.magnets.filter(U=>U.guid!==e.guid);const S=document.getElementById("mag-body");S&&(S.innerHTML=`<div class="mag-grid">${q.magnets.map(yn).join("")}</div>`)}yt=!1,window.removeEventListener("beforeunload",Ge),m.unsubscribe(va),clearTimeout(se),ce.removeEventListener("change",Ae),B&&B.destroy&&B.destroy(),d.classList.remove("open"),setTimeout(()=>d.remove(),180),document.removeEventListener("keydown",R)},k=()=>{M&&!confirm("Discard your changes to this magnet?")||y()};function R(S){S.key==="Escape"&&(S.preventDefault(),k())}document.addEventListener("keydown",R),d.querySelector(".mag-modal__close").addEventListener("click",k),d.querySelector('[data-x="cancel"]').addEventListener("click",k),d.querySelector("[data-close-modal]")?.addEventListener("click",k),d.querySelector("#mag-f-name").focus();const H=d.querySelector("#mag-flow-panel");o?Cd(H,e,()=>{j(!0),ue()}):H.innerHTML='<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>',dp(d,e),t&&A(t),Y(),d.querySelectorAll(".mag-cta").forEach(S=>{const U=S.querySelector(".mag-cta__on"),de=S.querySelector(".mag-cta__val"),ae=S.querySelector(".mag-cta__opts"),Oe=S.querySelectorAll(".mag-cta__booksrc, .mag-cta__calevent, .mag-cta__callsrc, .mag-cta__crtracker");U.addEventListener("change",()=>{de&&(de.disabled=!U.checked),ae&&(ae.disabled=!U.checked),Oe.forEach(V=>{V.disabled=!U.checked}),U.checked&&(de||ae)?.focus()}),de&&de.addEventListener("input",()=>{de.value.trim()&&!U.checked&&(U.checked=!0,ae&&(ae.disabled=!1))})}),d.querySelectorAll('.mag-cta[data-kind="book"]').forEach(S=>{const U=S.querySelector(".mag-cta__booksrc"),de=S.querySelector(".mag-cta__val"),ae=S.querySelector(".mag-cta__calevent");if(!U||!ae)return;const Oe=()=>{const V=U.value==="calendly";de.hidden=V,ae.hidden=!V,V&&!ae.dataset.listed&&(ae.dataset.listed="1",zd(ae))};U.addEventListener("change",()=>{const V=S.querySelector(".mag-cta__on");V.checked||(V.checked=!0,V.dispatchEvent(new Event("change"))),Oe()}),Oe()}),d.querySelectorAll('.mag-cta[data-type="call"]').forEach(S=>{const U=S.querySelector(".mag-cta__callsrc"),de=S.querySelector(".mag-cta__val"),ae=S.querySelector(".mag-cta__crtracker");if(!U||!ae)return;const Oe=()=>{const V=U.value==="callrail";de.hidden=V,ae.hidden=!V,V&&!ae.dataset.listed&&(ae.dataset.listed="1",jd(ae))};U.addEventListener("change",()=>{const V=S.querySelector(".mag-cta__on");V.checked||(V.checked=!0,V.dispatchEvent(new Event("change"))),Oe()}),Oe()});const P=d.querySelector("#mag-f-surface-on"),we=d.querySelector("#mag-f-surface");P.addEventListener("change",()=>we.hidden=!P.checked);const je=d.querySelector("#mag-f-inline-size");d.querySelectorAll('input[name="mag-display"]').forEach(S=>S.addEventListener("change",()=>{je.hidden=d.querySelector('input[name="mag-display"]:checked')?.value!=="inline"})),d.querySelector('[data-x="preview"]')?.addEventListener("click",()=>Qs(()=>Ya({...e,...Ia(d),...o?{steps:fo()}:{}}))),d.querySelector('[data-x="save"]').addEventListener("click",async S=>{const U=S.currentTarget,de=d.querySelector("#mag-f-error"),ae=d.querySelector("#mag-f-name").value.trim();if(!ae){A("basics"),de.textContent="Please give your magnet a name.";return}const Oe=d.querySelector("#mag-f-domains").value.split(",").map(X=>X.trim()).filter(Boolean);let V="";if(d.querySelectorAll(".mag-cta").forEach(X=>{const ot=X.querySelector(".mag-cta__on").checked;if(X.dataset.kind==="book"){const xt=X.querySelector(".mag-cta__booksrc")?.value==="calendly";ot&&xt&&!X.querySelector(".mag-cta__calevent")?.value&&(V=V||"Pick a Calendly event for the Book button, or switch it back to the built-in scheduler.");return}if(X.dataset.kind!=="value")return;if(X.dataset.type==="call"&&X.querySelector(".mag-cta__callsrc")?.value==="callrail"){ot&&!X.querySelector(".mag-cta__crtracker")?.value&&(V=V||"Pick a CallRail tracking number for the Call button, or switch it back to a phone number.");return}const wt=X.querySelector(".mag-cta__val").value.trim();ot&&!wt&&(V=V||`Add a target for the ${_n[X.dataset.type].label} button, or uncheck it.`)}),V){A("welcome"),de.textContent=V;return}const En=dr(d);if(En.enabled&&!Object.keys(En.b).length){A("ab"),de.textContent="Give variant B at least one change (title, welcome, or color), or untick the A/B test.";return}if(o){const X=Id();if(X){A("flow"),de.textContent=X.message,Ld(X.route,X.message,{uid:X.uid,field:X.field});return}}const ba={name:ae,domains:Oe,...Ia(d)};r&&(ba.owner_guid=d.querySelector("#mag-f-owner").value);const An=o&&e.status==="DRAFT";An&&(ba.status="ENABLED"),U.disabled=!0,de.textContent="";try{const X=o?`${te()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${te()}/m5t/v5/magnets`,ot={"Content-Type":"application/json"};s&&(ot["Idempotency-Key"]=s);const wt=await fetch(X,{method:o?"PATCH":"POST",headers:ot,body:JSON.stringify(ba)});let xt={};try{xt=await wt.json()}catch{}if(!wt.ok||!xt.ok)throw new Error(xt.message||`Save failed (${wt.status})`);o&&await Nd(e.guid),De(An||!o?"Magnet created":"Magnet updated","success"),ee=!0,y(),await Pt()}catch(X){U.disabled=!1,de.textContent=X.message||"Something went wrong."}})}const gp=Object.freeze(Object.defineProperty({__proto__:null,CTA_META:_n,CTA_ORDER:rr,DISPLAY_OPTS:nr,FONT_GROUPS:Ka,MODE_LABEL:ar,THEME_OPTS:or,TRIGGER_OPTS:sr,cspNoteHTML:tr,init:Jd,openModal:ia,render:Kd,stepFunnelHTML:cr},Symbol.toStringTag,{value:"Module"}));let wo=!1;function hp(){if(Zs(),wo)return;const e=document.createElement("style");e.id="m5t-templates-page-styles",e.textContent=`
...
`)],{type:"text/csv"}),r=URL.createObjectURL(s),i=document.createElement("a");i.href=r,i.download=`leads-${x.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r),la(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const Np=Object.freeze(Object.defineProperty({__proto__:null,init:Cp,render:Tp},Symbol.toStringTag,{value:"Module"})),yr=()=>E.getConfig?.().BASE_URL||"",ko=e=>e.toISOString().slice(0,10),So=e=>e==null?"—":"$"+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),it=e=>Number(e||0).toLocaleString(),Op={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ut=e=>String(e??"").replace(/[&<>"']/g,t=>Op[t]);let To=!1;function Mp(){if(To)return;const e=document.createElement("style");e.id="m5t-adperf-styles",e.textContent=`
  ...
  <div class="stat-card">
    ...
    </div>`}function Ht(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}function $o(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}function Io(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e)}function Dp(e){const v=e.length||1,u=$o(Math.max(1,...e.map(M=>M.spend||0))),d=$o(Math.max(1,...e.map(M=>M.magnet_leads||0))),f=738/v,_=Math.min(24,f*.55),A=M=>56+f*(M+.5),C=M=>304-M/u*282,$=M=>304-M/d*282,W=[0,.25,.5,.75,1].map(M=>{const ee=304-M*282;return`<line x1="56" y1="${ee.toFixed(1)}" x2="794" y2="${ee.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${(ee+3.5).toFixed(1)}" text-anchor="end" class="ax">$${Io(u*M)}</text><text x="802" y="${(ee+3.5).toFixed(1)}" text-anchor="start" class="ax">${Io(d*M)}</text>`}).join(""),B=e.map((M,ee)=>{const F=C(M.spend||0);return`<rect x="${(A(ee)-_/2).toFixed(1)}" y="${F.toFixed(1)}" width="${_.toFixed(1)}" height="${Math.max(0,304-F).toFixed(1)}" rx="3" fill="#0072BA"><title>${M.date}: $${M.spend} spend</title></rect>`}).join(""),Y=e.map((M,ee)=>`${A(ee).toFixed(1)},${$(M.magnet_leads||0).toFixed(1)}`).join(" "),se=v>1?`<polyline points="${Y}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",ue=e.map((M,ee)=>`<circle cx="${A(ee).toFixed(1)}" cy="${$(M.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${M.date}: ${M.magnet_leads} leads</title></circle>`).join(""),ce=Math.max(1,Math.ceil(v/6)),Ae=e.map((M,ee)=>ee%ce===0||ee===v-1?`<text x="${A(ee).toFixed(1)}" y="326" text-anchor="middle" class="ax">${M.date.slice(5)}</text>`:"").join("");return`
  ...
  `,document.head.appendChild(e),Ro=!0}const jp=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function It(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Vp(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
    ...
    </div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add("open"),i.classList.add("open")});const l=i.querySelector("#aa-error"),c=i.querySelector('[data-act="save"]'),p=()=>{r.classList.remove("open"),i.classList.remove("open"),document.removeEventListener("keydown",h),setTimeout(()=>{r.remove(),i.remove()},200)},h=u=>{u.key==="Escape"&&p()};document.addEventListener("keydown",h),r.addEventListener("click",p),i.querySelector(".client-modal__close")?.addEventListener("click",p),i.querySelector('[data-act="cancel"]')?.addEventListener("click",p);const b=(u,d,f)=>{const _=`${a}/m5t/v5/coreAdAccount`;return d&&!f?fetch(_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,provider:u,external_customer_id:d})}):d&&f&&d!==f.external_customer_id?fetch(`${_}/${encodeURIComponent(f.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({external_customer_id:d})}):!d&&f?fetch(`${_}/${encodeURIComponent(f.guid)}`,{method:"DELETE"}):null},v=async()=>{l.textContent="";const u=No(i.querySelector("#aa-gads").value),d=No(i.querySelector("#aa-lsa").value),f=[b("google_ads",u,o),b("google_lsa",d,s)].filter(Boolean);if(!f.length){p();return}c.disabled=!0;const _=c.innerHTML;c.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const A=await Promise.all(f);for(const C of A)if(!C.ok){const $=await C.json().catch(()=>({}));throw new Error(C.status===403?"You are not authorized to connect accounts for this client.":$?.error||$?.message||`Failed (HTTP ${C.status})`)}Ze("Ad accounts updated","success"),p()}catch(A){l.textContent=A.message||"Something went wrong. Please try again.",c.disabled=!1,c.innerHTML=_}};c?.addEventListener("click",v)}function Kp(e,t){if(!e)return;const a=document.createElement("div");a.className="client-modal-scrim";const n=document.createElement("div");n.className="client-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="invite-body">
      ...
      <div class="client-modal__actions">
        ...
        </div>`;const _=n.querySelector("#inv-link");n.querySelector("#inv-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(_.value),n.querySelector("#inv-copy").textContent="Copied!"}catch{_.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",o)}catch(u){console.warn("[clients] invite failed:",u),i.textContent=u.message||"Something went wrong. Please try again.",l.disabled=!1,l.innerHTML=v}})}function zt(e){if(!e)return"";const t=new Date(e);return Number.isNaN(t.getTime())?"":t.toLocaleString(void 0,{year:"numeric",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}async function Jp(e,t){if(!e)return;const a=E.getConfig?.().BASE_URL||"",n=document.createElement("div");n.className="client-modal-scrim";const o=document.createElement("div");o.className="client-modal",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),o.innerHTML=`
    <div class="client-modal__head">
