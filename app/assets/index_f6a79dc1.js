(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const Cl="modulepreload",Tl=function(e,t){return new URL(e,t).href},_o={},Y=function(t,a,n){let o=Promise.resolve();if(a&&a.length>0){let c=function(u){return Promise.all(u.map(b=>Promise.resolve(b).then(d=>({status:"fulfilled",value:d}),d=>({status:"rejected",reason:d}))))};const r=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");o=c(a.map(u=>{if(u=Tl(u,n),u in _o)return;_o[u]=!0;const b=u.endsWith(".css"),d=b?'[rel="stylesheet"]':"";if(n)for(let f=r.length-1;f>=0;f--){const p=r[f];if(p.href===u&&(!b||p.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${u}"]${d}`))return;const g=document.createElement("link");if(g.rel=b?"stylesheet":Cl,b||(g.as="script"),g.crossOrigin="",g.href=u,l&&g.setAttribute("nonce",l),document.head.appendChild(g),b)return new Promise((f,p)=>{g.addEventListener("load",f),g.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${u}`)))})}))}function s(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return o.then(r=>{for(const i of r||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})};var $l=/([:*])(\w+)/g,Ll="([^/]+)",Il=/\*/g,Rl="?(?:.*)",Nl=/\/\?/g,Ol="/?([^/]+|)",Ml="(?:/^|^)",Pl="";function Xs(e){return e===void 0&&(e="/"),Hn()?location.pathname+location.search+location.hash:e}function se(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function Sa(e){return typeof e=="string"}function Fl(e){return typeof e=="function"}function Ca(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function Dl(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(a,n,o){return a===null&&(a={}),a[t[o]]=decodeURIComponent(n),a},null)}function Ta(e){var t=se(e).split(/\?(.*)?$/);return[se(t[0]),t.slice(1).join("")]}function zn(e){for(var t={},a=e.split("&"),n=0;n<a.length;n++){var o=a[n].split("=");if(o[0]!==""){var s=decodeURIComponent(o[0]);t[s]?(Array.isArray(t[s])||(t[s]=[t[s]]),t[s].push(decodeURIComponent(o[1]||""))):t[s]=decodeURIComponent(o[1]||"")}}return t}function Js(e,t){var a=Ta(se(e.currentLocationPath)),n=a[0],o=a[1],s=o===""?null:zn(o),r=[],i;if(Sa(t.path)){if(i=Ml+se(t.path).replace($l,function(b,d,g){return r.push(g),Ll}).replace(Il,Rl).replace(Nl,Ol)+"$",se(t.path)===""&&se(n)==="")return{url:n,queryString:o,hashString:Ca(e.to),route:t,data:null,params:s}}else i=t.path;var l=new RegExp(i,Pl),c=n.match(l);if(c){var u=Sa(t.path)?Dl(c,r):c.groups?c.groups:c.slice(1);return{url:se(n.replace(new RegExp("^"+e.instance.root),"")),queryString:o,hashString:Ca(e.to),route:t,data:u,params:s}}return!1}function Qs(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function yt(e,t){return typeof e[t]>"u"||e[t]===!0}function Bl(e){if(!e)return{};var t=e.split(","),a={},n;return t.forEach(function(o){var s=o.split(":").map(function(r){return r.replace(/(^ +| +$)/g,"")});switch(s[0]){case"historyAPIMethod":a.historyAPIMethod=s[1];break;case"resolveOptionsStrategy":n||(n={}),n.strategy=s[1];break;case"resolveOptionsHash":n||(n={}),n.hash=s[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":a[s[0]]=s[1]==="true";break}}),n&&(a.resolveOptions=n),a}function Hn(){return typeof window<"u"}function ql(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(a){return a}).forEach(function(a){["before","after","already","leave"].forEach(function(n){a[n]&&(t[n]||(t[n]=[]),t[n].push(a[n]))})}),t}function ze(e,t,a){var n=t||{},o=0;(function s(){if(!e[o]){a&&a(n);return}Array.isArray(e[o])?(e.splice.apply(e,[o,1].concat(e[o][0](n)?e[o][1]:e[o][2])),s()):e[o](n,function(r){typeof r>"u"||r===!0?(o+=1,s()):a&&a(n)})})()}ze.if=function(e,t,a){return Array.isArray(t)||(t=[t]),Array.isArray(a)||(a=[a]),[e,t,a]};function yo(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=Xs(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function nn(e,t){for(var a=0;a<e.instance.routes.length;a++){var n=e.instance.routes[a],o=Js(e,n);if(o&&(e.matches||(e.matches=[]),e.matches.push(o),e.resolveOptions.strategy==="ONE")){t();return}}t()}function Ul(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function zl(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var wo=Hn(),Hl=Qs();function jl(e,t){if(yt(e.navigateOptions,"updateBrowserURL")){var a=("/"+e.to).replace(/\/\//g,"/"),n=wo&&e.resolveOptions&&e.resolveOptions.hash===!0;Hl?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",n?"#"+a:a),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!n){var o=location.hash;location.hash="",location.hash=o}e.instance.__freezeListening=!1},1))):wo&&(window.location.href=e.to)}t()}function Zs(e,t){var a=e.instance;if(!a.lastResolved()){t();return}ze(a.lastResolved().map(function(n){return function(o,s){if(!n.route.hooks||!n.route.hooks.leave){s();return}var r=!1,i=e.instance.matchLocation(n.route.path,e.currentLocationPath,!1);if(n.route.path!=="*")r=!i;else{var l=e.matches?e.matches.find(function(c){return n.route.path===c.route.path}):!1;r=!l}if(yt(e.navigateOptions,"callHooks")&&r){ze(n.route.hooks.leave.map(function(c){return function(u,b){return c(function(d){d===!1?e.instance.__markAsClean(e):b()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return s()}]));return}else s()}}),{},function(){return t()})}function Gl(e,t){e.match.route.hooks&&e.match.route.hooks.before&&yt(e.navigateOptions,"callHooks")?ze(e.match.route.hooks.before.map(function(a){return function(o,s){return a(function(r){r===!1?e.instance.__markAsClean(e):s()},e.match)}}).concat([function(){return t()}])):t()}function Vl(e,t){yt(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function Wl(e,t){e.match.route.hooks&&e.match.route.hooks.after&&yt(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(a){return a(e.match)}),t()}function Yl(e,t){var a=e.instance.lastResolved();if(a&&a[0]&&a[0].route===e.match.route&&a[0].url===e.match.url&&a[0].queryString===e.match.queryString){a.forEach(function(n){n.route.hooks&&n.route.hooks.already&&yt(e.navigateOptions,"callHooks")&&n.route.hooks.already.forEach(function(o){return o(e.match)})}),t(!1);return}t()}function Kl(e,t){var a=e.instance._notFoundRoute;if(a){e.notFoundHandled=!0;var n=Ta(e.currentLocationPath),o=n[0],s=n[1],r=Ca(e.to);a.path=se(o);var i={url:a.path,queryString:s,hashString:r,data:null,route:a,params:s!==""?zn(s):null};e.matches=[i],e.match=i}t()}function Xl(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function Jl(e,t){e.instance._setCurrent(null),t()}function er(e,t){yt(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var tr=[Yl,Gl,Vl,Wl],xo=[Zs,Kl,ze.if(function(e){var t=e.notFoundHandled;return t},tr.concat([er]),[Xl,Jl])];function bn(){return bn=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},bn.apply(this,arguments)}function Eo(e,t){var a=0;function n(){if(a===e.matches.length){er(e,t);return}ze(tr,bn({},e,{match:e.matches[a]}),function(){a+=1,n()})}Zs(e,n)}function on(e){e.instance.__markAsClean(e)}function _n(){return _n=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},_n.apply(this,arguments)}var ko="[data-navigo]";function Ql(e,t){var a=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:ko},n=this,o="/",s=null,r=[],i=!1,l,c=Qs(),u=Hn();e?o=se(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function b(y){return y.indexOf("#")>=0&&(a.hash===!0?y=y.split("#")[1]||"/":y=y.split("#")[0]),y}function d(y){return se(o+"/"+se(y))}function g(y,A,P,K){return y=Sa(y)?d(y):y,{name:K||se(String(y)),path:y,handler:A,hooks:ql(P)}}function f(y,A,P){var K=this;return typeof y=="object"&&!(y instanceof RegExp)?(Object.keys(y).forEach(function(z){if(typeof y[z]=="function")K.on(z,y[z]);else{var Le=y[z],rt=Le.uses,S=Le.as,V=Le.hooks;r.push(g(z,rt,[l,V],S))}}),this):(typeof y=="function"&&(P=A,A=y,y=o),r.push(g(y,A,[l,P])),this)}function p(y,A){if(n.__dirty){n.__waiting.push(function(){return n.resolve(y,A)});return}else n.__dirty=!0;y=y?se(o)+"/"+se(y):void 0;var P={instance:n,to:y,currentLocationPath:y,navigateOptions:{},resolveOptions:_n({},a,A)};return ze([yo,nn,ze.if(function(K){var z=K.matches;return z&&z.length>0},Eo,xo)],P,on),P.matches?P.matches:!1}function v(y,A){if(n.__dirty){n.__waiting.push(function(){return n.navigate(y,A)});return}else n.__dirty=!0;y=se(o)+"/"+se(y);var P={instance:n,to:y,navigateOptions:A||{},resolveOptions:A&&A.resolveOptions?A.resolveOptions:a,currentLocationPath:b(y)};ze([Ul,zl,nn,ze.if(function(K){var z=K.matches;return z&&z.length>0},Eo,xo),jl,on],P,on)}function x(y,A,P){var K=ge(y,A);return K!==null?(v(K.replace(new RegExp("^/?"+o),""),P),!0):!1}function w(y){return this.routes=r=r.filter(function(A){return Sa(y)?se(A.path)!==se(y):Fl(y)?y!==A.handler:String(A.path)!==String(y)}),this}function $(){c&&(this.__popstateListener=function(){n.__freezeListening||p()},window.addEventListener("popstate",this.__popstateListener))}function O(){this.routes=r=[],c&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=i=!0}function U(y,A){return n._notFoundRoute=g("*",y,[l,A],"__NOT_FOUND__"),this}function I(){if(u)return j().forEach(function(y){if(y.getAttribute("data-navigo")==="false"||y.getAttribute("target")==="_blank"){y.hasListenerAttached&&y.removeEventListener("click",y.navigoHandler);return}y.hasListenerAttached||(y.hasListenerAttached=!0,y.navigoHandler=function(A){if((A.ctrlKey||A.metaKey)&&A.target.tagName.toLowerCase()==="a")return!1;var P=y.getAttribute("href");if(typeof P>"u"||P===null)return!1;if(P.match(/^(http|https)/)&&typeof URL<"u")try{var K=new URL(P);P=K.pathname+K.search}catch{}var z=Bl(y.getAttribute("data-navigo-options"));i||(A.preventDefault(),A.stopPropagation(),n.navigate(se(P),z))},y.addEventListener("click",y.navigoHandler))}),n}function j(){return u?[].slice.call(document.querySelectorAll(a.linksSelector||ko)):[]}function X(y){return"/"+o+"/"+se(y)}function J(y){return l=y,this}function ae(){return s}function ge(y,A,P){var K=r.find(function(rt){return rt.name===y}),z=null;if(K){if(z=K.path,A)for(var Le in A)z=z.replace(":"+Le,A[Le]);z=z.match(/^\//)?z:"/"+z}return z&&P&&!P.includeRoot&&(z=z.replace(new RegExp("^/"+o),"")),z}function B(y){return y.getAttribute("href")}function le(y){var A=Ta(se(y)),P=A[0],K=A[1],z=K===""?null:zn(K),Le=Ca(y),rt=g(P,function(){},[l],P);return{url:P,queryString:K,hashString:Le,route:rt,data:null,params:z}}function H(){return le(se(Xs(o)).replace(new RegExp("^"+o),""))}function Z(y){var A={instance:n,currentLocationPath:y,to:y,resolveOptions:a};return nn(A,function(){}),A.matches?A.matches:!1}function ot(y,A,P){typeof A<"u"&&(typeof P>"u"||P)&&(A=d(A));var K={instance:n,to:A,currentLocationPath:A};yo(K,function(){}),typeof y=="string"&&(y=typeof P>"u"||P?d(y):y);var z=Js(K,{name:String(y),path:y,handler:function(){},hooks:{}});return z||!1}function st(y,A,P){return typeof A=="string"&&(A=qt(A)),A?(A.hooks[y]||(A.hooks[y]=[]),A.hooks[y].push(P),function(){A.hooks[y]=A.hooks[y].filter(function(K){return K!==P})}):(console.warn("Route doesn't exists: "+A),function(){})}function qt(y){return typeof y=="string"?r.find(function(A){return A.name===d(y)}):r.find(function(A){return A.handler===y})}function tn(y){y.instance.__dirty=!1,y.instance.__waiting.length>0&&y.instance.__waiting.shift()()}this.root=o,this.routes=r,this.destroyed=i,this.current=s,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=tn,this.on=f,this.off=w,this.resolve=p,this.navigate=v,this.navigateByName=x,this.destroy=O,this.notFound=U,this.updatePageLinks=I,this.link=X,this.hooks=J,this.extractGETParameters=function(y){return Ta(b(y))},this.lastResolved=ae,this.generate=ge,this.getLinkPath=B,this.match=Z,this.matchLocation=ot,this.getCurrentLocation=H,this.addBeforeHook=st.bind(this,"before"),this.addAfterHook=st.bind(this,"after"),this.addAlreadyHook=st.bind(this,"already"),this.addLeaveHook=st.bind(this,"leave"),this.getRoute=qt,this._pathToMatchObject=le,this._clean=se,this._checkForAHash=b,this._setCurrent=function(y){return s=n.current=y},$.call(this),I.call(this)}var Zl=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function ec(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var jt={exports:{}},tc=jt.exports,Ao;function ac(){return Ao||(Ao=1,(function(e,t){(function(a,n){var o={};a.PubSub?(o=a.PubSub,console.warn("PubSub already loaded, using existing version")):(a.PubSub=o,n(o)),e!==void 0&&e.exports&&(t=e.exports=o),t.PubSub=o,e.exports=t=o})(typeof window=="object"&&window||tc||Zl,function(a){var n={},o=-1,s="*";function r(p){var v;for(v in p)if(Object.prototype.hasOwnProperty.call(p,v))return!0;return!1}function i(p){return function(){throw p}}function l(p,v,x){try{p(v,x)}catch(w){setTimeout(i(w),0)}}function c(p,v,x){p(v,x)}function u(p,v,x,w){var $=n[v],O=w?c:l,U;if(Object.prototype.hasOwnProperty.call(n,v))for(U in $)Object.prototype.hasOwnProperty.call($,U)&&O($[U],p,x)}function b(p,v,x){return function(){var $=String(p),O=$.lastIndexOf(".");for(u(p,p,v,x);O!==-1;)$=$.substr(0,O),O=$.lastIndexOf("."),u(p,$,v,x);u(p,s,v,x)}}function d(p){var v=String(p),x=!!(Object.prototype.hasOwnProperty.call(n,v)&&r(n[v]));return x}function g(p){for(var v=String(p),x=d(v)||d(s),w=v.lastIndexOf(".");!x&&w!==-1;)v=v.substr(0,w),w=v.lastIndexOf("."),x=d(v);return x}function f(p,v,x,w){p=typeof p=="symbol"?p.toString():p;var $=b(p,v,w),O=g(p);return O?(x===!0?$():setTimeout($,0),!0):!1}a.publish=function(p,v){return f(p,v,!1,a.immediateExceptions)},a.publishSync=function(p,v){return f(p,v,!0,a.immediateExceptions)},a.subscribe=function(p,v){if(typeof v!="function")return!1;p=typeof p=="symbol"?p.toString():p,Object.prototype.hasOwnProperty.call(n,p)||(n[p]={});var x="uid_"+String(++o);return n[p][x]=v,x},a.subscribeAll=function(p){return a.subscribe(s,p)},a.subscribeOnce=function(p,v){var x=a.subscribe(p,function(){a.unsubscribe(x),v.apply(this,arguments)});return a},a.clearAllSubscriptions=function(){n={}},a.clearSubscriptions=function(v){var x;for(x in n)Object.prototype.hasOwnProperty.call(n,x)&&x.indexOf(v)===0&&delete n[x]},a.countSubscriptions=function(v){var x,w,$=0;for(x in n)if(Object.prototype.hasOwnProperty.call(n,x)&&x.indexOf(v)===0){for(w in n[x])$++;break}return $},a.getSubscriptions=function(v){var x,w=[];for(x in n)Object.prototype.hasOwnProperty.call(n,x)&&x.indexOf(v)===0&&w.push(x);return w},a.unsubscribe=function(p){var v=function(X){var J;for(J in n)if(Object.prototype.hasOwnProperty.call(n,J)&&J.indexOf(X)===0)return!0;return!1},x=typeof p=="string"&&(Object.prototype.hasOwnProperty.call(n,p)||v(p)),w=!x&&typeof p=="string",$=typeof p=="function",O=!1,U,I,j;if(x){a.clearSubscriptions(p);return}for(U in n)if(Object.prototype.hasOwnProperty.call(n,U)){if(I=n[U],w&&I[p]){delete I[p],O=p;break}if($)for(j in I)Object.prototype.hasOwnProperty.call(I,j)&&I[j]===p&&(delete I[j],O=!0)}return O}})})(jt,jt.exports)),jt.exports}var nc=ac();const m=ec(nc),h=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV.GO",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN.GO",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP.GO",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT.GO",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT.GO",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH.GO",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",AUTH_SCOPE_LOADED:"AUTH.SCOPE.LOADED",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",M5T_SIDE_NAV:"M5T_SIDE_NAV",M5T_SIDE_NAV_TAP:"M5T_SIDE_NAV.TAP",M5T_SIDE_NAV_COLLAPSE:"M5T_SIDE_NAV.COLLAPSE",M5T_SIDE_NAV_LOGO_TAP:"M5T_SIDE_NAV.LOGO_TAP",M5T_SIDE_NAV_ORG_SWITCH:"M5T_SIDE_NAV.ORG_SWITCH",M5T_SIDE_NAV_FOOTER_ACTION:"M5T_SIDE_NAV.FOOTER_ACTION",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_THEME_CHANGED:"UI.THEME.CHANGED",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL",MESSAGE:"MESSAGE",MESSAGE_CREATE:"MESSAGE.CREATE",MESSAGE_CREATED:"MESSAGE.CREATED",MESSAGE_EDIT:"MESSAGE.EDIT",MESSAGE_UPDATED:"MESSAGE.UPDATED",MESSAGE_DELETE:"MESSAGE.DELETE",MESSAGE_DELETED:"MESSAGE.DELETED",MESSAGE_REFRESH:"MESSAGE.REFRESH"}),sn={BASE_URL:"./",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://machfivemagnet-saas.onrender.com"};var rn={};const G=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_UI_DARK_MODE:!0,FF_SSE_UI_ANIMATIONS:!0,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel",FF_API_RATELIMIT_SIGNIN_ENFORCE:!0,FF_API_RATELIMIT_SIGNIN_IP_LIMIT:20,FF_API_RATELIMIT_SIGNIN_EMAIL_LIMIT:10,FF_API_RATELIMIT_FORGOT_ENFORCE:!0,FF_API_RATELIMIT_FORGOT_IP_LIMIT:15,FF_API_RATELIMIT_FORGOT_EMAIL_LIMIT:5,FF_API_RATELIMIT_CAPTURE_ENFORCE:!0,FF_API_RATELIMIT_CAPTURE_LIMIT:30,FF_API_RATELIMIT_EVENT_ENFORCE:!0,FF_API_RATELIMIT_EVENT_LIMIT:600,FF_API_RATELIMIT_CSP_PING_ENFORCE:!0,FF_API_RATELIMIT_CSP_PING_LIMIT:30,FF_API_RATELIMIT_WEBAUTHN_AUTH_ENFORCE:!0,FF_API_RATELIMIT_WEBAUTHN_AUTH_IP_LIMIT:20,FF_API_RATELIMIT_INTEGRATIONS_ENFORCE:!0,FF_API_RATELIMIT_INTEGRATIONS_LIMIT:60,FF_API_RATELIMIT_QUESTIONNAIRE_ENFORCE:!0,FF_API_RATELIMIT_QUESTIONNAIRE_LIMIT:30,FF_API_RATELIMIT_PAIRING_ENFORCE:!0,FF_API_RATELIMIT_PAIRING_LIMIT:20,FF_API_RATELIMIT_SITE_OPS_ENFORCE:!0,FF_API_RATELIMIT_SITE_OPS_LIMIT:120,FF_API_RATELIMIT_AUTHENTICATED_ENFORCE:!0,FF_API_RATELIMIT_AUTHENTICATED_LIMIT:600,FF_API_MAGNET_REQUIRE_ORIGIN_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_ENFORCE:!0,FF_API_RATELIMIT_GLOBAL_LIMIT:2e3});function ar(e,t=null){if(e in G)return G[e];if(typeof process<"u"&&rn&&rn[e]){const a=rn[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}if(typeof import.meta<"u"&&sn&&sn[e]){const a=sn[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}return t}function jn(e){return ar(e,!1)===!0}function oc(){return{...G}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:G,getFlag:ar,isEnabled:jn,getAllFlags:oc});const So={success:{border:"var(--color-success, #009473)",bg:"var(--color-success-soft, rgba(0,148,115,0.10))",icon:"check_circle"},danger:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},error:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},warning:{border:"var(--color-warning, #D97706)",bg:"var(--color-warning-soft, #FEF3C7)",icon:"warning"},info:{border:"var(--color-info, #0D9488)",bg:"var(--color-info-soft, #CCFBF1)",icon:"info"}},sc=4500,yn=220;let je=null,Co=!1;function rc(){if(Co)return;const e=document.createElement("style");e.id="m5t-toast-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Co=!0}function ic(){return je&&document.body.contains(je)||(je=document.createElement("div"),je.className="m5t-toast-stack",je.setAttribute("role","status"),je.setAttribute("aria-live","polite"),document.body.appendChild(je)),je}function lc(e){const t=e&&e.message;if(!t)return;rc();const a=So[e.type]||So.info,n=document.createElement("div");n.className="m5t-toast",n.style.borderColor=a.border,n.style.background=a.bg,n.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true" style="color:${a.border}">${a.icon}</span><span class="m5t-toast__msg"></span><button type="button" class="m5t-toast__close" aria-label="Dismiss"><span class="material-symbols-outlined" aria-hidden="true">close</span></button>`,n.querySelector(".m5t-toast__msg").textContent=String(t),ic().appendChild(n),requestAnimationFrame(()=>n.classList.add("is-in"));let s=!1;const r=()=>{s||(s=!0,clearTimeout(i),n.classList.remove("is-in"),n.classList.add("is-out"),setTimeout(()=>n.remove(),yn))},i=setTimeout(r,sc);n.querySelector(".m5t-toast__close").addEventListener("click",r)}function cc(){const e=t=>a=>{const n=a.detail?.pubsubTopic;n&&m.publish(n,a.detail)};document.addEventListener("nav-select",e()),document.addEventListener("logo-click",e()),document.addEventListener("nav-hover",e()),document.addEventListener("nav-double-tap",e()),document.addEventListener("nav-long-tap",e()),document.addEventListener("message-sent",e())}function dc(){console.log("[AppEvents] Initializing event listeners..."),m.subscribe(h.APP_READY,(a,n)=>{console.log("[AppEvents] APP_READY:",n)}),m.subscribe(h.APP_ERROR,(a,n)=>{console.error("[AppEvents] APP_ERROR:",n)}),m.subscribe(h.APP_SIGNOUT,(a,n)=>{console.log("[AppEvents] APP_SIGNOUT:",n)}),m.subscribe(h.ROUTE_NAV_BEFORE,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",n),m.publish(h.UI_LOADING_START)}),m.subscribe(h.ROUTE_NAV_AFTER,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",n),m.publish(h.UI_LOADING_END)}),m.subscribe(h.ROUTE_NAV_ERROR,(a,n)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",n),m.publish(h.APP_ERROR,{message:"Navigation error",details:n})}),m.subscribe(h.AUTH_SIGNIN_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",n)}),m.subscribe(h.AUTH_SIGNIN_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",n),m.publish(h.UI_TOAST,{message:n.message||"Sign in failed",type:"danger"})}),m.subscribe(h.AUTH_SIGNUP_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",n),m.publish(h.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"}),m.publish(h.AUTH_VERIFY_LINK)}),m.subscribe(h.AUTH_VERIFY_LINK,(a,n)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),m.subscribe(h.AUTH_SIGNUP_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",n),m.publish(h.UI_TOAST,{message:n.message||"Sign up failed",type:"danger"})}),m.subscribe(h.AUTH_SIGNOUT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",n),m.publish(h.UI_TOAST,{message:"Signed out successfully",type:"info"})}),m.subscribe(h.AUTH_SIGNUP,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),m.subscribe(h.AUTH_FORGOT,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),m.subscribe(h.AUTH_FORGOT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",n),m.publish(h.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),m.subscribe(h.AUTH_RESETHASH_NAV,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),m.subscribe(h.AUTH_RESETHASH_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",n),m.publish(h.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),m.subscribe(h.AUTH_TOKEN_EXPIRED,(a,n)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",n),m.publish(h.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),m.subscribe(h.I18N_SET_LANG,(a,n)=>{console.log("[AppEvents] I18N_SET_LANG:",n);const{langCode:o}=n;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),m.publish(h.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(s){console.error("[AppEvents] Error changing language:",s),m.publish(h.UI_TOAST,{message:`Failed to change language: ${s.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),m.subscribe("CONVERSATION.PROMPT",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",n.message),ln(n.message,"user",n.timestamp),m.publish(h.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Agent prompt (no implementation):",n.message);break;case"AGENT_CANVAS":console.log("[AppEvents] Display message in canvas:",n.message),ln(n.message,"user",n.timestamp),m.publish(h.CANVAS_DO_SCROLL);break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),m.subscribe("CONVERSATION.RESPONSE",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",n.message),ln(n.message,"assistant",n.timestamp,n.streaming);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),m.subscribe(h.UI_LOADING_START,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),m.subscribe(h.UI_LOADING_END,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),m.subscribe(h.UI_TOAST,(a,n)=>{lc(n)}),m.subscribe(h.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const a="0.1",n=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${a} 8/14/2026, 7:29:23 PM|© ${n} Mach Five Tech`,"night")}),cc(),m.subscribe("M5T_PRIMARY_NAV",(a,n)=>{const o=a.split(".")[1];switch(o){case"TAP":e(n);break;case"LOGO_TAP":t();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function e(a){const{token:n,level:o,primaryToken:s}=a;switch(n){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),m.publish(h.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${n}`,{primaryToken:s});break}}function t(a){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 8/14/2026, 7:29:23 PM|© ${o} Mach Five Tech`,"night",5e3)}m.subscribe(h.AUTH_SIGNOUT,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(G.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function ln(e,t="user",a=null,n=!1){const o=document.getElementById("chat-messages");if(!o){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}if(a||(a=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})),n&&t==="assistant"){const r=o.firstElementChild;if(r&&r.tagName.toLowerCase()==="m5t-chat-response"){r.setAttribute("message",e),console.log(`[AppEvents] Updated streaming ${t} bubble (${e.length} chars)`);return}}let s;t==="user"||t==="prompt"?s=document.createElement("m5t-chat-prompt"):s=document.createElement("m5t-chat-response"),s.setAttribute("message",e),s.setAttribute("timestamp",a),o.prepend(s),console.log(`[AppEvents] Added ${t} bubble to canvas (${e.length} chars)`)}function pc(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("uid")&&t.get("token"))}function uc(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("qr")&&t.get("token"))}function mc(e=window.location.search){const t=new URLSearchParams(e||""),a=t.get("qr"),n=t.get("token");return a&&n?{guid:a,token:n}:null}const gc=Object.freeze([Object.freeze({name:"invite",matches:pc}),Object.freeze({name:"questionnaire",matches:uc})]);function nr(e=window.location.search){return gc.find(t=>t.matches(e))||null}function hc(e=window.location.search){return nr(e)!==null}function fc(e,t=window.location.search){return hc(t)}function or(e){return e?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(String(e)):!1}const vc=Object.freeze({admin_root_role:{value:100,label:"Administrator",desc:"Mach Five platform staff — full access across every organization"},client_standard_role:{value:0,label:"Client",desc:"Everyone else — what they can do comes from their organization membership, not this class"}});function bc(e){return vc[e]||null}function _c(e){return e>=50}const Wt=Object.freeze({owner:{value:"owner",rank:30,label:"Owner"},admin:{value:"admin",rank:20,label:"Admin"},member:{value:"member",rank:10,label:"Member"},viewer:{value:"viewer",rank:0,label:"Viewer"}}),yc=Object.freeze({VIEW_DASHBOARD:"view_dashboard",VIEW_MAGNETS:"view_magnets",PROVISION_MAGNETS:"provision_magnets",MANAGE_MAGNETS:"manage_magnets",VIEW_CONVERSATIONS:"view_conversations",VIEW_STATS:"view_stats",VIEW_AD_METRICS:"view_ad_metrics",CONNECT_AD_ACCOUNTS:"connect_ad_accounts",CREATE_CLIENT_ACCOUNTS:"create_client_accounts",MANAGE_TEAM:"manage_team",VIEW_BILLING:"view_billing",MANAGE_BILLING:"manage_billing"}),C=yc,sr=Object.freeze(Object.values(C)),St=Object.freeze([C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS]);Object.freeze([C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.CONNECT_AD_ACCOUNTS,C.CREATE_CLIENT_ACCOUNTS,C.MANAGE_TEAM,C.MANAGE_BILLING]);Object.freeze([C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS,C.VIEW_BILLING]);const wc=Object.freeze({reseller_org:{owner:sr,admin:[C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS,C.CONNECT_AD_ACCOUNTS,C.CREATE_CLIENT_ACCOUNTS,C.MANAGE_TEAM,C.VIEW_BILLING],member:[C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS],viewer:St},managed_client:{owner:[...St,C.VIEW_BILLING],admin:[...St,C.VIEW_BILLING],member:St,viewer:St},saas_org:{owner:[C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS,C.CONNECT_AD_ACCOUNTS,C.MANAGE_TEAM,C.VIEW_BILLING,C.MANAGE_BILLING],admin:[C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS,C.CONNECT_AD_ACCOUNTS,C.MANAGE_TEAM,C.VIEW_BILLING],member:[C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS],viewer:St}});function xc(e){const t=bc(e);return!!t&&_c(t.value)}function Ec({entityClass:e,orgChannel:t,memberRole:a}={}){if(xc(e))return[...sr];const n=wc[t],o=n&&n[a];return o?[...o]:[]}function kc(e,t){const a=Wt[e]?.rank??-1,n=Wt[t]?.rank??1/0;return a>=Wt.admin.rank&&a>=n}const Gn=[{value:"name",label:"Full name (splits into first + last automatically)"},{value:"first_name",label:"First name"},{value:"last_name",label:"Last name"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"mobile",label:"Mobile phone"},{value:"company",label:"Company"},{value:"title",label:"Job title"},{value:"city",label:"City"},{value:"state",label:"State / province"},{value:"product_interest",label:"Product interest"},{value:"lead_source",label:"Lead source"},{value:"rating",label:"Rating (Hot / Warm / Cold)"},{value:"description",label:"Notes / description"},{value:"salutation",label:"Salutation (Mr. / Ms. / Dr.)"},{value:"street",label:"Street address"},{value:"zip",label:"Postal / ZIP code"},{value:"country",label:"Country"},{value:"url",label:"Website URL"},{value:"industry",label:"Industry"},{value:"annual_revenue",label:"Annual revenue (number)"},{value:"employees",label:"Number of employees (whole number)"},{value:"is_primary",label:"Primary contact (Yes / No)"},{value:"current_generators",label:"Current generator(s)"},{value:"number_of_locations",label:"Number of locations (whole number)"}];new Set(Gn.map(e=>e.value));const Vn=[{value:"single_select",label:"Multiple choice"},{value:"multi_select",label:"Select all"},{value:"scheduler",label:"Scheduler"},{value:"text",label:"Short text"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"message",label:"Message"}];new Set(Vn.map(e=>e.value));const Ac=[{value:"inline",label:"Inline"},{value:"chat",label:"Chat"},{value:"right_slide",label:"Slide"},{value:"modal",label:"Modal"}],Sc=[{value:"auto",label:"Auto"},{value:"light",label:"Light"},{value:"dark",label:"Dark"}],Cc=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],Tc=[{value:"book",label:"Book"},{value:"call",label:"Call"},{value:"email",label:"Email"},{value:"chat",label:"Chat"},{value:"support",label:"Support"}];Ac.map(e=>e.value);Sc.map(e=>e.value);Cc.map(e=>e.value);Tc.map(e=>e.value);class E{static CONFIG={BASE_URL:"https://machfivemagnet-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink",SCOPE:"sse_session_scope",ACTIVE_ORG:"sse_active_org",REMEMBERED_EMAIL:"sse_remembered_email"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",ME:"/m5t/v5/acctEntity/me",PING:"/ping",WEBAUTHN_AUTH_OPTIONS:"/m5t/v5/webauthn/authenticate/options",WEBAUTHN_AUTH_VERIFY:"/m5t/v5/webauthn/authenticate/verify"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#o=null;static#a=null;static#n=null;static#s=null;static#i=null;static async init({BASE_URL:t,navigateFunction:a,customConfig:n={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(a&&typeof a=="function")this.#i=a;else throw new Error("navigateFunction is required and must be a function");return t&&(this.CONFIG.BASE_URL=t),n&&Object.keys(n).length>0&&(this.CONFIG={...this.CONFIG,...n}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#m(),this.#u(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#u(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((t=null)=>{if(t){if(fc()){console.log("[AuthController] Ignoring mvvLegit redirect to",t,"— keeping visitor on their public landing page");return}console.log("[AuthController] mvvLegit navigation to:",t),this.#r(t)}}).setOnState((t=null)=>{if(t)switch(console.log("[AuthController] Auth state changed:",t),t){case"AUTH":case 4:this.#_();break;case"UNAUTH":case 1:this.#y();break;case"UNVERF":case 2:this.#w();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#r(t){if(!this.#i){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",t);const a=t.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",a),this.#i(a)}static#l(){if(window.__m5tActiveOrgFetch)return;const t=window.fetch.bind(window);window.fetch=(a,n)=>{try{const o=typeof a=="string"?a:a?.url||"",s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);if(s&&o.startsWith(this.CONFIG.BASE_URL)){const r=new Headers(n&&n.headers||(a instanceof Request?a.headers:void 0));r.set("X-Active-Org",s),n={...n||{},headers:r}}}catch{}return t(a,n)},window.__m5tActiveOrgFetch=!0,console.log("[AuthController] Active-org fetch header installed")}static#m(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);t&&(this.#o=JSON.parse(t),console.log("[AuthController] Entity state loaded; hasEmail:",!!this.#o?.email))}catch(t){console.error("[AuthController] Error loading entity state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#o=null}this.#s=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.SCOPE);t&&(this.#a=JSON.parse(t),console.log("[AuthController] Scope state loaded (cached):",this.#a?.uiMode))}catch(t){console.error("[AuthController] Error loading scope state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE),this.#a=null}}static#c(t){try{this.#o=t,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(t)),console.log("[AuthController] Entity state saved")}catch(a){console.error("[AuthController] Error saving entity state:",a)}}static#d(){this.#o=null,this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}}static getEntity(){return this.#o}static#v(t){try{this.#a=t,localStorage.setItem(this.CONFIG.LS_KEYS.SCOPE,JSON.stringify(t))}catch(a){console.error("[AuthController] Error saving scope state:",a)}}static async fetchScope(){return typeof mvvLegit>"u"||!this.isAuthenticated()?(console.log("[AuthController] fetchScope skipped — not authenticated"),this.#a):this.#n?this.#n:(this.#n=this.#b().finally(()=>{this.#n=null}),this.#n)}static async#b(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),a=t?`?org=${encodeURIComponent(t)}`:"",n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.ME}${a}`);if(n.status===401||n.status===403)return console.warn("[AuthController] /me unauthorized — signing out"),this.doSignout(!0),null;if(!n.ok)return console.warn(`[AuthController] /me failed (${n.status}) — using cached scope`),this.#a;const o=await n.json();if(!o?.ok)return console.warn("[AuthController] /me returned not-ok — using cached scope"),this.#a;try{const s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);s&&o.activeOrg?.guid!==s&&(console.warn(`[AuthController] Stored active org not honored by /me${o.activeOrgError?" (activeOrgError)":""} — clearing`),localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG))}catch{}return this.#v(o),m.publish(h.AUTH_SCOPE_LOADED,o),console.log(`[AuthController] Scope loaded: ${o.uiMode} (${o.memberships?.length||0} org(s), ${o.managedClients?.length||0} client(s))`),o}catch(t){return console.error("[AuthController] fetchScope error:",t),this.#a}}static async setActiveOrg(t){try{t?localStorage.setItem(this.CONFIG.LS_KEYS.ACTIVE_ORG,t):localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}return this.fetchScope()}static getScope(){return this.#a}static getCapabilities(){return this.isPreviewingAsClient()?Ec({orgChannel:"managed_client",memberRole:"owner"}):this.#a?.capabilities||[]}static getUiMode(){return this.isPreviewingAsClient()?"managed":this.#a?.uiMode||"self_serve"}static getActiveOrg(){return this.#a?.activeOrg||null}static getMemberships(){return this.#a?.memberships||[]}static getManagedClients(){return this.#a?.managedClients||[]}static getStoredActiveOrg(){try{return localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{return null}}static#p="m5m_preview_as_client";static isPreviewingAsClient(){try{return sessionStorage.getItem(this.#p)==="1"&&!!this.#a?.activeOrg?.viaSubtree}catch{return!1}}static setPreviewAsClient(t){try{t?sessionStorage.setItem(this.#p,"1"):sessionStorage.removeItem(this.#p)}catch{}this.#a&&m.publish(h.AUTH_SCOPE_LOADED,this.#a)}static async doSignin(t,a){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a})}),o=await n.json();if(n.status===303)return console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#c(o.entity)),setTimeout(()=>{this.#r(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o};if(n.ok&&o.accessToken){console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#c(o.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),console.log("[AuthController] Explicitly navigating to home"),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}}return{ok:!1,error:o.error||"Sign in failed",data:o}}catch(n){return console.error("[AuthController] Signin error:",n),{ok:!1,error:n.message}}}static async doPasskeySignin(){if(!window.PublicKeyCredential)return{ok:!1,error:"Passkeys are not supported in this browser"};try{const{startAuthentication:t}=await Y(async()=>{const{startAuthentication:i}=await Promise.resolve().then(()=>vr);return{startAuthentication:i}},void 0,import.meta.url),a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_OPTIONS}`,{method:"POST"}),n=await a.json();if(!a.ok||!n.ok)return{ok:!1,error:n.error||"Could not start passkey sign-in"};let o;try{o=await t({optionsJSON:n.options})}catch(i){const l=i?.name==="NotAllowedError";return l||console.error("[AuthController] Passkey ceremony error:",i),{ok:!1,canceled:l,error:l?"Passkey sign-in was canceled":i.message||"Passkey sign-in failed"}}const s=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_VERIFY}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o})}),r=await s.json();if(!s.ok||!r.ok||!r.accessToken)return{ok:!1,error:r.error||"Passkey sign-in failed",data:r};mvvLegit.doSignin(r.accessToken),this.#c(r.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:r}}catch(t){return console.error("[AuthController] Passkey signin error:",t),{ok:!1,error:t.message}}}static async doSignout(t=!1){console.log("[AuthController] doSignout called, serverInitiated:",t);try{const a=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!a),!t&&a){const n=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(a)}`;if(console.log("[AuthController] Sending signout beacon to:",n),navigator.sendBeacon){const o=navigator.sendBeacon(n);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else a||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#d(),console.log("[AuthController] Stopping auth ping..."),this.#h(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(a){console.error("[AuthController] Signout error:",a),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(t){try{const a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await a.json();return a.ok&&n.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#c(n.entity),{ok:!0,data:n}):{ok:!1,error:n.error||"Sign up failed",data:n}}catch(a){return console.error("[AuthController] Signup error:",a),{ok:!1,error:a.message}}}static async doResetHash(t,a){try{const n=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a,modified_by:t})}),s=await o.json();return o.ok&&s.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:s}):{ok:!1,error:s.error||"Password reset failed",data:s}}catch(n){return console.error("[AuthController] Reset password error:",n),{ok:!1,error:n.message}}}static#g(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#f()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#h(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#f(){try{const t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);t.ok?console.log("[AuthController] Ping success"):(t.status===401||t.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(t){console.error("[AuthController] Ping error:",t)}}static setDeepLinkGuid(t){this.#s=t,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,t),console.log("[AuthController] Deep-link GUID stored:",t)}static getDeepLinkGuid(){return this.#s}static clearDeepLink(){this.#s=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#_(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),queueMicrotask(()=>this.fetchScope())}static#y(){console.log("[AuthController] User unauthenticated"),this.#h()}static#w(){console.log("[AuthController] User unverified")}static getAuthState(){try{const t=mvvLegit.getConf()?.LSKEY||"mvv",a=localStorage.getItem(t);if(!a)return"UNAUTH";if(typeof LZString>"u")return null;const n=LZString.decompressFromUTF16(a),s=JSON.parse(n)?.state;return s===1?"UNAUTH":s===2?"UNVERF":s===4?"AUTH":s===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(t){this.#r(t)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#f()}}class L{static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",remember_email:"Remember my email",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_dashboard:"Dashboard",nav_dashboard_tagline:"Overview of your activity",nav_magnets:"Your Magnets",nav_magnets_tagline:"Manage your conversational magnets",nav_templates:"Templates",nav_templates_tagline:"Start from a magnet template",nav_conversations:"Conversations",nav_conversations_tagline:"Captured lead conversations",nav_ab_testing:"A/B Testing",nav_ab_testing_tagline:"Experiment and optimize",nav_analytics:"Analytics",nav_analytics_tagline:"Performance and ad metrics",nav_ad_accounts:"Ad Accounts",nav_ad_accounts_tagline:"Connect advertising accounts",nav_clients:"Clients",nav_clients_tagline:"Manage your client accounts",nav_team:"Team",nav_team_tagline:"Invite and manage teammates",nav_billing:"Billing",nav_billing_tagline:"Plan, usage, and invoices",nav_settings:"Settings",nav_settings_tagline:"Account and workspace settings",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Magnet Builder",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",remember_email:"Recordar mi correo electrónico",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Magnet Builder",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",remember_email:"记住我的邮箱",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"Magnet Builder",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:t,product:a,whitelabel:n,lang:o}){t&&(this.#t.buildMode=t),a&&(this.#t.product=a),n&&(this.#t.whitelabel=n),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{let l=this.#e[o]?.[s]?.[r]?.[i]?.[t],c=o;return!l&&o!=="LOCAL"&&(l=this.#e.LOCAL?.[s]?.[r]?.[i]?.[t],c="LOCAL (fallback)"),l?(c==="LOCAL (fallback)"&&console.warn(`[MicrocopyManager] Token '${t}' missing from ${o} — served from LOCAL instead. Backfill ${o}'s block if this is intentionally different copy.`),Array.isArray(l)?l[Math.floor(Math.random()*l.length)]:l):(console.warn(`[MicrocopyManager] Token not found: ${t} (${o}/${s}/${r}/${i}, LOCAL fallback also missing it)`),null)}catch(l){return console.error(`[MicrocopyManager] Error retrieving token: ${t}`,l),null}}static getAll(t={}){const a={...this.#t,...t},{buildMode:n,product:o,whitelabel:s,lang:r}=a;try{return this.#e[n]?.[o]?.[s]?.[r]||null}catch(i){return console.error("[MicrocopyManager] Error retrieving all tokens",i),null}}static has(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return!!this.#e[o]?.[s]?.[r]?.[i]?.[t]}catch{return!1}}static getAvailableLanguages(){const{buildMode:t,product:a,whitelabel:n}=this.#t;try{return Object.keys(this.#e[t]?.[a]?.[n]||{})}catch{return[]}}static update(t,a,n={}){const o={...this.#t,...n},{buildMode:s,product:r,whitelabel:i,lang:l}=o;try{return this.#e[s]||(this.#e[s]={}),this.#e[s][r]||(this.#e[s][r]={}),this.#e[s][r][i]||(this.#e[s][r][i]={}),this.#e[s][r][i][l]||(this.#e[s][r][i][l]={}),this.#e[s][r][i][l][t]=a,!0}catch(c){return console.error(`[MicrocopyManager] Error updating token: ${t}`,c),!1}}static delete(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return delete this.#e[o]?.[s]?.[r]?.[i]?.[t],!0}catch(l){return console.error(`[MicrocopyManager] Error deleting token: ${t}`,l),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(t){try{return this.#e=t,!0}catch(a){return console.error("[MicrocopyManager] Error importing data",a),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:L});class Ne{static#e=!1;static#t=null;static#o=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const t=this.#n();L.setContext(t),console.log("[I18nController] Initialized with context:",t),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#s(),this.#u(),this.#e=!0,this.refresh()}static#a(t){const a={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},n=t.toLowerCase();return a[n]||"DEV"}static#n(){const a=this.#a("production"),n=localStorage.getItem(G.FF_SSE_LS_WHITELABEL)||G.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(G.FF_SSE_LS_USER_LANG)||G.FF_SSE_I18N_LANG;return{buildMode:a,product:G.FF_SSE_I18N_PRODUCT,whitelabel:n,lang:o}}static#s(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((t,a,n)=>{G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",n),this.#t=n,setTimeout(()=>{this.refresh()},G.FF_SSE_I18N_APPLY_DELAY_MS)},G.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#i())}static#i(){setInterval(()=>{const a=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");a&&a!==this.#t&&(this.#t=a,this.refresh())},500)}static#u(){this.#o||(this.#o=new MutationObserver(t=>{let a=!1;for(const n of t){for(const o of n.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){a=!0;break}if(a)break}a&&(G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#o.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#r(document.body),this.#l(document.body),G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#r(t){const a=t.querySelectorAll("[data-meta-copywrite-i118n]");G.FF_SSE_I18N_DEBUG&&a.length>0&&console.log(`[I18nController] Processing ${a.length} elements`),a.forEach(n=>{try{const o=n.getAttribute("data-meta-copywrite-i118n"),s=JSON.parse(o);if(!s.token){console.warn("[I18nController] Missing token in config:",s);return}const r=s.attribute||"textContent",i=L.get(s.token);if(i===null){console.warn(`[I18nController] Microcopy not found for token: ${s.token}`);return}r==="textContent"?n.textContent=i:r==="innerHTML"?n.innerHTML=i:n.setAttribute(r,i),G.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${i}" to ${r} for token: ${s.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,n)}})}static#l(t){t.querySelectorAll("*").forEach(n=>{n.shadowRoot&&(this.#r(n.shadowRoot),this.#l(n.shadowRoot))})}static setLanguage(t){const a=L.getAvailableLanguages();if(!a.includes(t)){console.error(`[I18nController] Language not available: ${t}. Available:`,a);return}localStorage.setItem(G.FF_SSE_LS_USER_LANG,t),L.setContext({lang:t}),console.log("[I18nController] Language changed to:",t);const n=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:t}});document.dispatchEvent(n),this.refresh()}static setWhitelabel(t){localStorage.setItem(G.FF_SSE_LS_WHITELABEL,t),L.setContext({whitelabel:t}),G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",t),this.refresh()}static getLanguage(){return L.getContext().lang}static getAvailableLanguages(){return L.getAvailableLanguages()}static getContext(){return L.getContext()}static destroy(){this.#o&&(this.#o.disconnect(),this.#o=null),this.#e=!1,this.#t=null,G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{Ne.initialize()}):Ne.initialize());class Wn{static _initialized=!1;static _debug=!1;static init(t={}){if(this._initialized)return console.warn("[MachVive] Already initialized, skipping duplicate initialization"),this;if(this._debug=t.debug||!1,!window.mvvSSEther)return console.error("[MachVive] mvvSSEther not found - cannot initialize bridge"),console.error("[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()"),this;console.log("[MachVive] Initializing SSE to PubSub bridge...");const a=n=>{this._handleSSEMessage(n)};return window.mvvSSEther.onmessage(a),this._initialized=!0,console.log("[MachVive] ✓ SSE to PubSub bridge initialized successfully"),console.log("[MachVive] ✓ Bound callback to mvvSSEther.onmessage"),this}static _handleSSEMessage(t){try{this._debug&&console.log("[MachVive] SSE message received:",t);const a=t?.data;if(!a){this._debug&&console.log("[MachVive] No data in message, skipping");return}const n=a.data||a.package||a;if(!n){this._debug&&console.log("[MachVive] No package found in message, skipping");return}let o=n.cfg;const s=n.msg;if(this._debug&&(console.log("[MachVive] cfg (raw):",o,"type:",typeof o,"length:",o?.length),console.log("[MachVive] msg (raw):",s)),typeof o=="string"){if(o.trim()===""){this._debug&&console.log("[MachVive] cfg is empty string, skipping");return}try{o=JSON.parse(o),console.log("[MachVive] cfg (parsed):",o)}catch(i){console.warn("[MachVive] Failed to parse cfg as JSON:",{cfg:o,cfgLength:o.length,error:i.message});return}}else if(!o){this._debug&&console.log("[MachVive] cfg is empty/null, skipping");return}const r=o?.topic;if(!r){this._debug&&console.log("[MachVive] No topic found in cfg, skipping");return}if(console.log("[MachVive] Extracted topic:",r),!this._isValidTopic(r)){console.warn(`[MachVive] Topic '${r}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(r,s,t,a)}catch(a){console.error("[MachVive] Error handling SSE message:",a)}}static _isValidTopic(t){return!h||!h.hasOwnProperty(t)?(console.warn(`[MachVive] Topic '${t}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(t,a,n,o){try{if(!window.PubSub&&typeof PubSub>"u"){console.error("[MachVive] PubSub not available");return}const s=window.PubSub||PubSub,r={message:a,metadata:{source:"sse",sseEventId:n.id,timestamp:n.timestamp,appGuid:o.app_guid,channelGuid:o.channel_guid,eventAction:o.event_action,status:o.status,class:o.class,raw:o}};console.log(`[MachVive] Publishing to topic '${t}':`,r);const i=h[t];console.log(`[MachVive] AppBroadcast.${t} = '${i}'`),s.publish(i,r),console.log(`[MachVive] ✓ Published SSE message to topic: ${t}`)}catch(s){console.error(`[MachVive] Error publishing to topic '${t}':`,s)}}static debug(t){return this._debug=t,console.log(`[MachVive] Debug mode ${t?"enabled":"disabled"}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log("[MachVive] Reset complete"),this}}typeof module<"u"&&module.exports&&(module.exports=Wn);typeof window<"u"&&(window.MachVive=Wn);const To="m5t_sidenav_collapsed",$c={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};class Lc extends HTMLElement{static get observedAttributes(){return["data-active-token","data-collapsed"]}constructor(){super(),this.attachShadow({mode:"open"}),this.items=[],this.orgs=[],this.activeOrgGuid=null,this.activeToken=null,this.footerBadge=null,this.loading=!1,this.lastFocus=null}#e=null;#t=t=>{if(this.getAttribute("data-open")==="true"){if(t.key==="Escape"){t.preventDefault(),this.closeDrawer();return}if(t.key==="Tab"){const a=this.#c();if(a.length<2)return;const n=a[0],o=a[a.length-1],s=this.shadowRoot.activeElement;t.shiftKey&&s===n?(t.preventDefault(),o.focus()):!t.shiftKey&&s===o&&(t.preventDefault(),n.focus())}}};#o=()=>{this.closeDrawer(),this.#d()};connectedCallback(){if(!this.hasAttribute("data-collapsed"))try{localStorage.getItem(To)==="true"&&this.setAttribute("data-collapsed","true")}catch{}this.activeToken=this.getAttribute("data-active-token")||null,this.render(),this.#l(),this.addEventListener("keydown",this.#t),this.#e=window.matchMedia("(max-width: 768px)"),this.#e.addEventListener("change",this.#o),this.#d()}disconnectedCallback(){this.removeEventListener("keydown",this.#t),this.#e?.removeEventListener("change",this.#o)}attributeChangedCallback(t,a,n){a===n||!this.shadowRoot||(t==="data-active-token"?(this.activeToken=n,this.#m()):t==="data-collapsed"&&this.shadowRoot.firstChild&&(this.render(),this.#l()))}setState({buttons:t,orgs:a,activeOrg:n,footerBadge:o,loading:s}={}){t!==void 0&&(this.items=Array.isArray(t)?t:this.#a(t)||[]),a!==void 0&&(this.orgs=Array.isArray(a)?a:this.#a(a)||[]),n!==void 0&&(this.activeOrgGuid=n||null),o!==void 0&&(this.footerBadge=o||null),s!==void 0&&(this.loading=!!s),this.shadowRoot&&(this.render(),this.#l())}setButtons(t){this.setState({buttons:t})}setOrgs(t){this.setState({orgs:t})}setActiveOrgGuid(t){this.setState({activeOrg:t})}setFooterBadge(t){this.setState({footerBadge:t})}setActiveToken(t){this.activeToken=t||null,this.#m()}toggleCollapsed(t){const a=typeof t=="boolean"?t:this.getAttribute("data-collapsed")!=="true";this.setAttribute("data-collapsed",String(a));try{localStorage.setItem(To,String(a))}catch{}this.dispatchEvent(new CustomEvent("nav-collapse",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_SIDE_NAV.COLLAPSE",collapsed:a,timestamp:Date.now()}}))}openDrawer(){this.lastFocus=this.shadowRoot.activeElement||document.activeElement,this.setAttribute("data-open","true"),this.shadowRoot.querySelector(".hamburger")?.setAttribute("aria-expanded","true"),this.#d(),(this.#c()[0]||this.shadowRoot.querySelector(".sidenav"))?.focus?.()}closeDrawer(){if(this.getAttribute("data-open")!=="true")return;this.removeAttribute("data-open");const t=this.shadowRoot.querySelector(".hamburger");t?.setAttribute("aria-expanded","false"),this.#d(),t&&this.#e?.matches?t.focus():this.lastFocus?.focus?.()}toggleDrawer(){this.getAttribute("data-open")==="true"?this.closeDrawer():this.openDrawer()}#a(t){try{return t?JSON.parse(t):null}catch(a){return console.error("[M5TSideNav] bad JSON:",a),null}}#n(t){return String(t??"").replace(/[&<>"']/g,a=>$c[a])}#s(t){return t?`<span class="ms" aria-hidden="true">${this.#n(t)}</span>`:""}#i(t){if(!t||!t.token)return"";const a=t.token===this.activeToken,n=t.route||"#",o=n.startsWith("#")?n:`#${n}`,s=typeof t.count=="number"&&t.count>0?`<span class="badge">${t.count}</span>`:"";return`
    ...
    `}attachEventListeners(){this.shadowRoot.querySelectorAll(".nav-button").forEach(n=>{const o=n.getAttribute("data-token"),s=n.getAttribute("data-level");n.addEventListener("click",r=>{o&&!r.currentTarget.disabled&&!this.longTapFired&&(s==="primary"?this.selectPrimaryButton(o):this.selectSecondaryButton(o)),this.longTapFired=!1}),n.addEventListener("dblclick",r=>{if(o&&!r.currentTarget.disabled){const i=this.getButtonData(o,s);console.log("[M5TPrimaryNav] Button double-clicked:",o),this.dispatchEvent(new CustomEvent("nav-double-tap",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.DOUBLE_TAP",token:o,level:s,caption:i.caption,tagline:i.tagline,timestamp:Date.now()}}))}}),n.addEventListener("mouseenter",r=>{if(o&&!r.currentTarget.disabled){const i=this.getButtonData(o,s);this.dispatchEvent(new CustomEvent("nav-hover",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.HOVER",token:o,level:s,caption:i.caption,tagline:i.tagline,action:"enter",timestamp:Date.now()}}))}}),n.addEventListener("mouseleave",r=>{if(o&&!r.currentTarget.disabled){const i=this.getButtonData(o,s);this.dispatchEvent(new CustomEvent("nav-hover",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.HOVER",token:o,level:s,caption:i.caption,tagline:i.tagline,action:"leave",timestamp:Date.now()}}))}}),n.addEventListener("mousedown",r=>{o&&!r.currentTarget.disabled&&(this.longTapActive=!0,this.longTapFired=!1,this.longTapTimer=setTimeout(()=>{const i=this.getButtonData(o,s);console.log("[M5TPrimaryNav] Button long-tap:",o),this.longTapFired=!0,this.dispatchEvent(new CustomEvent("nav-long-tap",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.LONG_TAP",token:o,level:s,caption:i.caption,tagline:i.tagline,timestamp:Date.now()}}))},this.longTapDelay))}),n.addEventListener("mouseup",r=>{this.longTapTimer&&(clearTimeout(this.longTapTimer),this.longTapTimer=null),this.longTapActive=!1}),n.addEventListener("mouseleave",r=>{this.longTapTimer&&(clearTimeout(this.longTapTimer),this.longTapTimer=null),this.longTapActive=!1})});const a=this.shadowRoot.querySelector(".logo");a&&a.addEventListener("click",()=>{console.log("[M5TPrimaryNav] Logo clicked"),this.logoTopic&&window.m5t?.pubsub?(console.log(`[M5TPrimaryNav] Publishing to topic: ${this.logoTopic}`),window.m5t.pubsub.publish(this.logoTopic,{timestamp:Date.now()})):this.logoTopic&&!window.m5t?.pubsub&&console.warn("[M5TPrimaryNav] Logo topic configured but window.m5t.pubsub not found"),this.dispatchEvent(new CustomEvent("logo-click",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.LOGO_TAP",timestamp:Date.now()}}))})}selectPrimaryButton(t){const a=this.buttons.find(o=>o.token===t),n=this.getButtonData(t,"primary");this.dispatchEvent(new CustomEvent("nav-select",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.TAP",token:t,level:"primary",caption:n.caption,tagline:n.tagline,hasSecondary:(a?.secondary?.length||0)>0,timestamp:Date.now()}})),this.selectedPrimaryToken!==t&&(this.selectedPrimaryToken=t,this.render(),this.attachEventListeners())}selectSecondaryButton(t){const a=this.getButtonData(t,"secondary");this.dispatchEvent(new CustomEvent("nav-select",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.TAP",token:t,primaryToken:this.selectedPrimaryToken,level:"secondary",caption:a.caption,tagline:a.tagline,timestamp:Date.now()}}))}updateButtons(t){this.setAttribute("data-buttons",JSON.stringify(t)),this.parseButtons(),this.render(),this.attachEventListeners()}updateCount(t,a,n="primary"){let o;n==="primary"?o=this.buttons.find(s=>s.token===t):o=this.getSecondaryButtons().find(r=>r.token===t),o&&(o.count=a,this.render(),this.attachEventListeners())}getSelection(){return{primary:this.selectedPrimaryToken,secondary:null}}}customElements.define("m5t-primary-nav",Ic);const Ct=()=>E.getConfig?.().BASE_URL||"",Rc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},it=e=>String(e??"").replace(/[&<>"']/g,t=>Rc[t]),Nc=300*1e3;function Oc(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function Mc(e){const t=`
      <div class="m5t-notif-title">${it(e.title)}</div>
      ${e.body?`<div class="m5t-notif-body">${it(e.body)}</div>`:""}
      <div class="m5t-notif-time">${it(Oc(e.created_tz))}</div>`;return`<div class="m5t-notif-item" data-guid="${it(e.guid)}" data-read="${e.read}" role="menuitem">
    ${e.link?`<a class="m5t-notif-main m5t-notif-link" href="${it(e.link)}">${t}</a>`:`<div class="m5t-notif-main">${t}</div>`}
    <button class="m5t-notif-dismiss" type="button" aria-label="Clear “${it(e.title)}”" data-dismiss="${it(e.guid)}">Clear</button>
  </div>`}const Pc='<div class="m5t-notif-skel"><span></span><span></span><span></span></div>'.repeat(3),cn=e=>e.dataset.open==="true",wn=(e,t)=>{e.dataset.open=t?"true":"false"};function Fc(e){const t=document.getElementById("m5t-notif-bell");if(t&&(t.hidden=!e),!e){const a=document.getElementById("m5t-notif-panel");a&&wn(a,!1)}}const Dc=14;let dn=null,pn=null;function Bc(e){if(typeof ResizeObserver>"u"||!e)return;const t=document.getElementById("m5t-notif-bell"),a=document.getElementById("m5t-notif-bell-btn");if(!t||!a)return;const n=()=>{const o=e.hidden?null:e.querySelector(".ocb-btn");if(!o){t.style.top=`${Dc}px`;return}const s=a.getBoundingClientRect().height;if(!s)return;const r=o.getBoundingClientRect();t.style.top=`${Math.round(r.top+(r.height-s)/2)}px`};dn?.disconnect(),dn=new ResizeObserver(n),dn.observe(e),pn?.disconnect(),pn=new MutationObserver(n),pn.observe(t,{attributes:!0,attributeFilter:["hidden"]}),n()}let $o=null,la=null,ca=null;function qc(){const e=document.getElementById("m5t-notif-bell-btn"),t=document.getElementById("m5t-notif-badge"),a=document.getElementById("m5t-notif-panel");if(!e||!t||!a)return;const n=d=>{t.textContent=d>99?"99+":String(d),t.hidden=!d},o=async()=>{try{const d=await fetch(`${Ct()}/m5t/v5/notifications/unread-count`),g=await d.json().catch(()=>({}));d.ok&&g.ok&&n(g.count||0)}catch{}},s=50,r=d=>{if(d.length>=s){o();return}n(d.filter(g=>!g.read).length)},i=(d="")=>`<div class="m5t-notif-head">Notifications${d?`<span class="m5t-notif-head__actions">${d}</span>`:""}</div>`,l=()=>{a.querySelectorAll(".m5t-notif-item, .m5t-notif-empty").forEach(d=>d.remove()),a.querySelector(".m5t-notif-head__actions")?.remove(),a.insertAdjacentHTML("beforeend",'<div class="m5t-notif-empty">You’re all caught up.</div>')},c=async()=>{a.innerHTML=i()+Pc;try{const d=await fetch(`${Ct()}/m5t/v5/notifications`),g=await d.json().catch(()=>({}));if(!d.ok||!g.ok)throw new Error;const f=g.notifications||[],p=[f.some(v=>!v.read)?'<button class="m5t-notif-markall" type="button">Mark all read</button>':"",f.length?'<button class="m5t-notif-clearall" type="button">Clear all</button>':""].join("");a.innerHTML=i(p)+(f.length?f.map(Mc).join(""):'<div class="m5t-notif-empty">You’re all caught up.</div>'),r(f)}catch{a.innerHTML=i()+'<div class="m5t-notif-empty">Could not load. Try again.</div>'}},u=()=>{wn(a,!1),e.setAttribute("aria-expanded","false")},b=async()=>{wn(a,!0),e.setAttribute("aria-expanded","true"),await c()};e.addEventListener("click",d=>{d.stopPropagation(),cn(a)?u():b()}),ca&&document.removeEventListener("visibilitychange",ca),ca=()=>{document.visibilityState==="visible"&&o()},document.addEventListener("visibilitychange",ca),la&&document.removeEventListener("click",la),la=d=>{cn(a)&&!a.contains(d.target)&&d.target!==e&&u()},document.addEventListener("click",la),document.addEventListener("keydown",d=>{d.key==="Escape"&&cn(a)&&(u(),e.focus())}),a.addEventListener("click",async d=>{const g=d.target.closest("[data-dismiss]");if(g){d.preventDefault(),d.stopPropagation();const x=g.closest(".m5t-notif-item"),w=g.dataset.dismiss,$=x?.dataset.read==="false";x?.setAttribute("data-leaving","true");try{await fetch(`${Ct()}/m5t/v5/notifications/${encodeURIComponent(w)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:"DISMISSED"})})}catch{}setTimeout(()=>{x?.remove(),a.querySelector(".m5t-notif-item")||l()},180),$&&o();return}const f=d.target.closest(".m5t-notif-clearall");if(f){d.preventDefault(),f.disabled=!0,a.querySelectorAll(".m5t-notif-item").forEach(x=>x.setAttribute("data-leaving","true"));try{await fetch(`${Ct()}/m5t/v5/notifications/dismiss-all`,{method:"PATCH"})}catch{}setTimeout(l,180),o();return}const p=d.target.closest(".m5t-notif-item");if(p&&p.dataset.read==="false"){const x=p.dataset.guid;p.dataset.read="true";try{await fetch(`${Ct()}/m5t/v5/notifications/${encodeURIComponent(x)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({read:!0})}),o()}catch{}return}const v=d.target.closest(".m5t-notif-markall");if(v){d.preventDefault(),a.querySelectorAll(".m5t-notif-item").forEach(x=>{x.dataset.read="true"}),v.remove();try{await fetch(`${Ct()}/m5t/v5/notifications/read-all`,{method:"PATCH"})}catch{}o()}}),o(),clearInterval($o),$o=setInterval(o,Nc)}function Ha(){return jn("FF_SSE_UI_DARK_MODE")}function Uc(e=Ha()){return e&&localStorage.getItem(G.FF_SSE_LS_THEME)==="dark"?"dark":"light"}function zc(e=jn("FF_SSE_UI_ANIMATIONS")){return!e}function Hc(e,t=Ha()){!e||t||e.shadowRoot?.querySelector('.footer-action[data-action="theme"]')?.remove()}function rr(e){document.documentElement.setAttribute("data-theme",e)}function jc(){rr(Uc())}function Zt(){return document.documentElement.getAttribute("data-theme")==="dark"?"dark":"light"}function ir(e,{quiet:t=!1}={}){if(!Ha())return;const a=e==="dark"?"dark":"light";a!==Zt()&&(rr(a),localStorage.setItem(G.FF_SSE_LS_THEME,a),t||m.publish(h.UI_TOAST,{message:a==="dark"?"Dark mode on":"Dark mode off",type:"info"}),m.publish(h.UI_THEME_CHANGED,{theme:a}))}function Gc(){ir(Zt()==="dark"?"light":"dark")}window.m5t=Object.create(null);window.m5t.pubsub=m;console.log("StreamSyncEngage SaaS Client - Starting...");console.log("Environment:","production");console.log("Document readyState:",document.readyState);console.log("window.mvvLegit:",typeof window.mvvLegit);console.log("globalThis.mvvLegit:",typeof globalThis.mvvLegit);try{console.log("mvvLegit (direct):",typeof mvvLegit)}catch(e){console.log("mvvLegit (direct): ReferenceError -",e.message)}const Vc=Object.keys(window).filter(e=>e.toLowerCase().includes("mvv")||e.toLowerCase().includes("neodigm")||e.toLowerCase().includes("legit"));console.log("Possible Neodigm globals:",Vc);const M=new Ql("/",{hash:!0});window.router=M;function de(e){const t=e?`${e.replace(/-/g,"_")}_route`:"splash_route";return console.log(`[Router] Checking access: ${e} -> ${t}`),mvvLegit.isRouteAllowed(t)?!0:(console.warn(`[Router] Access denied to route: ${t}`),m.publish(h.UI_TOAST,{message:"Please sign in to access this page",type:"warning"}),!1)}function ne(e){console.log("[Router] Navigating to:",e),M.navigate(`/${e}`)}const Yn=new Set(["splash","signin","signup","forgot","resethash","verf-link","accept-invite","signout"]);let Yt={},xn={},vt=null;const Wc={admin:{caption:"Platform Admin",icon:"shield_person"},reseller:{caption:"Reseller",icon:"handshake"},managed:{caption:"Managed",icon:"visibility"},self_serve:{caption:"Self-Serve",icon:"rocket_launch"}},En="__portfolio__";function lr(){try{M._setCurrent(null)}catch{}M.resolve()}function un(){const e=document.getElementById("m5t-side-nav");if(!e)return;const t=!E.getScope()&&E.isAuthenticated(),a=E.getCapabilities(),n=E.getUiMode(),o=za.getSideNav(a,{uiMode:n});Yt={},xn={};const s=d=>{d.route&&(Yt[d.route]={sectionToken:d.token,childToken:null,children:d.children||null},Array.isArray(d.children)&&d.children.forEach(g=>{g.route&&(xn[g.token]=g.route,Yt[g.route]={sectionToken:d.token,childToken:g.token,children:d.children})}))},r=d=>d.forEach(g=>{g.group&&Array.isArray(g.items)?r(g.items):s(g)});r(o);const i=E.getMemberships(),l=E.getActiveOrg(),c=E.getManagedClients(),u=E.getStoredActiveOrg(),b=c.length?[{guid:En,name:"Portfolio (all clients)"},...i.map(d=>({guid:d.orgGuid,name:d.name||d.channel,channel:d.channel,group:"Your organization"})),...c.map(d=>({guid:d.orgGuid,name:d.name||d.orgGuid,channel:d.channel,group:"Clients"}))]:i.map(d=>({guid:d.orgGuid,name:d.name||d.channel,channel:d.channel}));e.setState({buttons:o,orgs:b,activeOrg:c.length?u||En:l?.guid||null,footerBadge:Wc[n]||null,loading:t}),cr(),vt&&dr(vt)}const Yc=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]);function cr(){const e=document.getElementById("app-content");if(!e)return;let t=document.getElementById("org-context-banner");t||(t=document.createElement("div"),t.id="org-context-banner",e.insertBefore(t,e.firstChild),Bc(t));const a=E.getActiveOrg(),n=E.isPreviewingAsClient(),o=!!a?.viaSubtree&&!!vt&&!Yn.has(vt);if(t.hidden=!o,!o){t.innerHTML="";return}const s=Yc(a.name||"Client");t.innerHTML=`
    <style>
    ...
    <div class="ocb" role="status">
    ...
    </div>`,t.querySelector('[data-ocb="preview"]')?.addEventListener("click",()=>{E.setPreviewAsClient(!E.isPreviewingAsClient()),lr()}),t.querySelector('[data-ocb="portfolio"]')?.addEventListener("click",()=>{E.setPreviewAsClient(!1),E.setActiveOrg(null)})}function dr(e){const t=document.getElementById("m5t-side-nav"),a=Yt[`/${e}`]||Yt[e]||null;t?.setActiveToken(a?.sectionToken||null),Kc(a)}function Kc(e){const t=document.getElementById("m5t-sub-nav"),a=document.getElementById("app-shell");if(!t)return;const n=e?.children;t.hidden=!1,n&&n.length>1?(t.updateButtons(n.map(o=>({token:o.token,caption:o.caption,enabled:!0,selected:o.token===e.childToken}))),a?.classList.add("has-sub-nav")):(t.updateButtons([]),a?.classList.remove("has-sub-nav"))}function Xc(){const e=Ne.getAvailableLanguages&&Ne.getAvailableLanguages()||[];if(e.length<2){m.publish(h.UI_TOAST,{message:"Only one language is available",type:"info"});return}const t=localStorage.getItem(G.FF_SSE_LS_USER_LANG)||G.FF_SSE_I18N_LANG||e[0],a=e[(e.indexOf(t)+1)%e.length];Ne.setLanguage(a),m.publish(h.UI_TOAST,{message:`Language: ${a}`,type:"info"})}function Jc(){document.documentElement.classList.toggle("ff-no-animations",zc())}function Qc(){const e=document.getElementById("m5t-side-nav");if(!e)return;za.setAppToken("client-saas"),Hc(e),document.getElementById("app-shell")?.classList.toggle("nav-collapsed",e.getAttribute("data-collapsed")==="true"),e.addEventListener("nav-select",o=>{const s=o.detail?.route;s&&M.navigate(s.startsWith("/")?s:`/${s}`)}),e.addEventListener("logo-click",()=>M.navigate("/home")),e.addEventListener("nav-collapse",o=>{document.getElementById("app-shell")?.classList.toggle("nav-collapsed",!!o.detail?.collapsed)}),e.addEventListener("org-switch",o=>{const s=o.detail?.orgGuid;s&&E.setActiveOrg(s===En?null:s)}),e.addEventListener("footer-action",o=>{switch(o.detail?.action){case"account":M.navigate("/settings");break;case"signout":M.navigate("/signout");break;case"lang":Xc();break;case"theme":Gc();break}}),document.getElementById("m5t-sub-nav")?.addEventListener("nav-select",o=>{const s=xn[o.detail?.token];s&&M.navigate(s)}),document.addEventListener("language-changed",()=>un()),un(),m.subscribe(h.AUTH_SCOPE_LOADED,()=>un());const a=()=>{const o=E.getScope();return[o?.uiMode,o?.activeOrg?.guid,(o?.managedClients||[]).length,(o?.capabilities||[]).join(","),E.getStoredActiveOrg()].join("|")};let n=a();m.subscribe(h.AUTH_SCOPE_LOADED,()=>{const o=a();o!==n&&(n=o,vt&&!Yn.has(vt)&&lr())})}function Zc(e){vt=e;const t=document.getElementById("m5t-side-nav"),a=document.getElementById("app-shell");if(!t||!a)return;const n=!Yn.has(e);if(t.hidden=!n,a.classList.toggle("has-side-nav",n),Fc(n),n)dr(e);else{const o=document.getElementById("m5t-sub-nav");o&&(o.hidden=!0),a.classList.remove("has-sub-nav")}cr()}m.subscribe(h.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&Zc(t.route)});const pr=()=>{console.log("[Router] Route: splash"),m.publish(h.ROUTE_NAV_BEFORE,{route:"splash"});const e=nr()?.name;(e==="invite"?Y(()=>Promise.resolve().then(()=>ud),void 0,import.meta.url):e==="questionnaire"?Y(()=>Promise.resolve().then(()=>Ld),void 0,import.meta.url):Y(()=>Promise.resolve().then(()=>Nd),void 0,import.meta.url)).then(a=>{const n=document.getElementById("app");n.innerHTML=a.render(),a.init&&a.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"splash"})}).catch(a=>{console.error("[Router] Error loading splash route:",a),m.publish(h.ROUTE_NAV_ERROR,{route:"splash",error:a})})};M.on("/",pr);M.on("/splash",pr);M.on("/signin",()=>{console.log("[Router] Route: /signin"),m.publish(h.ROUTE_NAV_BEFORE,{route:"signin"}),Y(()=>Promise.resolve().then(()=>qd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"signin"})}).catch(e=>{console.error("[Router] Error loading signin route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"signin",error:e})})});M.on("/signup",()=>{console.log("[Router] Route: /signup"),m.publish(h.ROUTE_NAV_BEFORE,{route:"signup"}),Y(()=>Promise.resolve().then(()=>Vd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"signup"})}).catch(e=>{console.error("[Router] Error loading signup route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"signup",error:e})})});M.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),m.publish(h.ROUTE_NAV_BEFORE,{route:"verf-link"}),Y(()=>Promise.resolve().then(()=>Kd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(e=>{console.error("[Router] Error loading verf-link route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"verf-link",error:e})})});M.on("/forgot",()=>{console.log("[Router] Route: /forgot"),m.publish(h.ROUTE_NAV_BEFORE,{route:"forgot"}),Y(()=>Promise.resolve().then(()=>ap),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(e=>{console.error("[Router] Error loading forgot route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"forgot",error:e})})});M.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!de("resethash")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"resethash"}),Y(()=>Promise.resolve().then(()=>sp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(e=>{console.error("[Router] Error loading resethash route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"resethash",error:e})})});M.on("/home",()=>{if(console.log("[Router] Route: /home"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"home"}),Y(()=>Promise.resolve().then(()=>yp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"home"})}).catch(e=>{console.error("[Router] Error loading home route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"home",error:e})})});M.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!de("signout")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"signout"}),Y(()=>Promise.resolve().then(()=>Ep),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"signout"})}).catch(e=>{console.error("[Router] Error loading signout route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"signout",error:e})})});const ed=[{path:"/ad-accounts",name:"ad-accounts",title:"Ad Accounts",icon:"ads_click"},{path:"/billing",name:"billing",title:"Billing",icon:"receipt_long"},{path:"/magnets/drafts",name:"magnets/drafts",title:"Magnets · Drafts",icon:"widgets"},{path:"/magnets/archived",name:"magnets/archived",title:"Magnets · Archived",icon:"widgets"},{path:"/analytics/conversions",name:"analytics/conversions",title:"Analytics · Conversions",icon:"monitoring"}];ed.forEach(({path:e,name:t,title:a,icon:n})=>{M.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:t}),Y(()=>Promise.resolve().then(()=>Sp),void 0,import.meta.url).then(o=>{const s=document.getElementById("app");s.innerHTML=o.render({title:a,icon:n,name:t}),o.init&&o.init({name:t}),m.publish(h.ROUTE_NAV_AFTER,{route:t})}).catch(o=>{console.error(`[Router] Error loading section route (${t}):`,o),m.publish(h.ROUTE_NAV_ERROR,{route:t,error:o})})})});M.on("/settings",()=>{if(console.log("[Router] Route: /settings"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"settings"}),Y(()=>Promise.resolve().then(()=>Dp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"settings"})}).catch(e=>{console.error("[Router] Error loading settings-general route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"settings",error:e})})});M.on("/settings/workspace",()=>{if(console.log("[Router] Route: /settings/workspace"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"settings/workspace"}),Y(()=>Promise.resolve().then(()=>Jp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"settings/workspace"})}).catch(e=>{console.error("[Router] Error loading settings-workspace route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"settings/workspace",error:e})})});M.on("/settings/notifications",()=>{if(console.log("[Router] Route: /settings/notifications"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"settings/notifications"}),Y(()=>Promise.resolve().then(()=>su),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"settings/notifications"})}).catch(e=>{console.error("[Router] Error loading settings-notifications route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"settings/notifications",error:e})})});M.on("/settings/integrations",()=>{if(console.log("[Router] Route: /settings/integrations"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),Y(()=>Promise.resolve().then(()=>$u),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(e=>{console.error("[Router] Error loading settings-integrations route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"settings/integrations",error:e})})});M.on("/settings/integrations/:provider",e=>{const t=e?.data?.provider||"";if(console.log("[Router] Route: /settings/integrations/"+t),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),Y(()=>Promise.resolve().then(()=>zu),void 0,import.meta.url).then(a=>{const n=document.getElementById("app");n.innerHTML=a.render({provider:t}),a.init&&a.init({provider:t}),m.publish(h.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(a=>{console.error("[Router] Error loading integration detail route:",a),m.publish(h.ROUTE_NAV_ERROR,{route:"settings/integrations",error:a})})});M.on("/settings/security",()=>{if(console.log("[Router] Route: /settings/security"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"settings/security"}),Y(()=>Promise.resolve().then(()=>Zu),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"settings/security"})}).catch(e=>{console.error("[Router] Error loading settings-security route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"settings/security",error:e})})});M.on("/conversations",()=>{if(console.log("[Router] Route: /conversations"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"conversations"}),Y(()=>Promise.resolve().then(()=>cm),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"conversations"})}).catch(e=>{console.error("[Router] Error loading conversations route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"conversations",error:e})})});M.on("/ab-testing",()=>{if(console.log("[Router] Route: /ab-testing"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"ab-testing"}),Y(()=>Promise.resolve().then(()=>Em),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"ab-testing"})}).catch(e=>{console.error("[Router] Error loading ab-testing route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"ab-testing",error:e})})});M.on("/magnets",()=>{if(console.log("[Router] Route: /magnets"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"magnets"}),Y(()=>Promise.resolve().then(()=>Hg),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"magnets"})}).catch(e=>{console.error("[Router] Error loading magnets route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"magnets",error:e})})});M.on("/templates",()=>{if(console.log("[Router] Route: /templates"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"templates"}),Y(()=>Promise.resolve().then(()=>Xg),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"templates"})}).catch(e=>{console.error("[Router] Error loading templates route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"templates",error:e})})});M.on("/questionnaires",()=>{if(console.log("[Router] Route: /questionnaires"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"questionnaires"}),Y(()=>Promise.resolve().then(()=>sh),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"questionnaires"})}).catch(e=>{console.error("[Router] Error loading questionnaires route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"questionnaires",error:e})})});M.on("/leads",()=>{if(console.log("[Router] Route: /leads"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"leads"}),Y(()=>Promise.resolve().then(()=>wh),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"leads"})}).catch(e=>{console.error("[Router] Error loading leads route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"leads",error:e})})});M.on("/analytics",()=>{if(console.log("[Router] Route: /analytics"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"analytics"}),Y(()=>Promise.resolve().then(()=>Th),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"analytics"})}).catch(e=>{console.error("[Router] Error loading analytics route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"analytics",error:e})})});M.on("/analytics/ad-performance",()=>{if(console.log("[Router] Route: /analytics/ad-performance"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"analytics/ad-performance"}),Y(()=>Promise.resolve().then(()=>Fh),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"analytics/ad-performance"})}).catch(e=>{console.error("[Router] Error loading ad-performance route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"analytics/ad-performance",error:e})})});M.on("/ad-accounts",()=>{if(console.log("[Router] Route: /ad-accounts"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"ad-accounts"}),Y(()=>Promise.resolve().then(()=>Jh),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"ad-accounts"})}).catch(e=>{console.error("[Router] Error loading ad-accounts route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"ad-accounts",error:e})})});M.on("/clients",()=>{if(console.log("[Router] Route: /clients"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"clients"}),Y(()=>Promise.resolve().then(()=>cf),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"clients"})}).catch(e=>{console.error("[Router] Error loading clients route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"clients",error:e})})});M.on("/team",()=>{if(console.log("[Router] Route: /team"),!de("home")){ne("signin");return}m.publish(h.ROUTE_NAV_BEFORE,{route:"team"}),Y(()=>Promise.resolve().then(()=>bf),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(h.ROUTE_NAV_AFTER,{route:"team"})}).catch(e=>{console.error("[Router] Error loading team route:",e),m.publish(h.ROUTE_NAV_ERROR,{route:"team",error:e})})});M.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),ne("splash")});m.subscribe(h.ROUTE_NAV,(e,t)=>{console.log("[Router] ROUTE_NAV event received:",t),t?.route&&ne(t.route)});function Lo(){console.log("[App] Waiting for Neodigm 55 library...");let e=0;const t=100,a=setInterval(()=>{e++,e%10===0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(a),td()):e>=t&&(clearInterval(a),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
      ...
      `,m.publish(h.APP_ERROR,{message:"Failed to load authentication library"}))},100)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Lo):Lo();async function td(){if(console.log("[App] Neodigm 55 loaded, initializing..."),jc(),Jc(),dc(),Ne.initialize(),console.log("[App] I18n Controller initialized"),!await E.init({BASE_URL:"https://machfivemagnet-saas.onrender.com",navigateFunction:a=>{console.log("[AuthController] Navigation requested:",a),ne(a)}})){console.error("[App] AuthController initialization failed");return}const t=E.getEntity();t&&(console.log("[App] Session restored for:",t.email),m.publish(h.APP_USER_LOADED,{entity:t}),E.isAuthenticated()&&(localStorage.getItem(E.CONFIG.LS_KEYS.ACTIVE_ORG)?await E.fetchScope():E.fetchScope())),m.publish(h.APP_READY,{timestamp:new Date().toISOString(),sessionUser:t}),Qc(),qc(),M.resolve(),window.AuthController=E,window.I18nController=Ne,window.MachVive=Wn,console.log("[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)")}m.subscribe(h.ROUTE_NAV_AFTER,(e,t)=>{typeof Ne<"u"&&Ne.refresh&&setTimeout(()=>{Ne.refresh()},100)});function Fe(e){const t=new Uint8Array(e);let a="";for(const o of t)a+=String.fromCharCode(o);return btoa(a).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"")}function ea(e){const t=e.replace(/-/g,"+").replace(/_/g,"/"),a=(4-t.length%4)%4,n=t.padEnd(t.length+a,"="),o=atob(n),s=new ArrayBuffer(o.length),r=new Uint8Array(s);for(let i=0;i<o.length;i++)r[i]=o.charCodeAt(i);return s}function ra(){return ur.stubThis(globalThis?.PublicKeyCredential!==void 0&&typeof globalThis.PublicKeyCredential=="function")}const ur={stubThis:e=>e};function mr(e){const{id:t}=e;return{...e,id:ea(t),transports:e.transports}}function gr(e){return e==="localhost"||/^((xn--[a-z0-9-]+|[a-z0-9]+(-[a-z0-9]+)*)\.)+([a-z]{2,}|xn--[a-z0-9-]+)$/i.test(e)}class fe extends Error{constructor({message:t,code:a,cause:n,name:o}){super(t,{cause:n}),Object.defineProperty(this,"code",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),this.name=o??n.name,this.code=a}}function ad({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new fe({message:"Registration ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else if(e.name==="ConstraintError"){if(a.authenticatorSelection?.requireResidentKey===!0)return new fe({message:"Discoverable credentials were required but no available authenticator supported it",code:"ERROR_AUTHENTICATOR_MISSING_DISCOVERABLE_CREDENTIAL_SUPPORT",cause:e});if(t.mediation==="conditional"&&a.authenticatorSelection?.userVerification==="required")return new fe({message:"User verification was required during automatic registration but it could not be performed",code:"ERROR_AUTO_REGISTER_USER_VERIFICATION_FAILURE",cause:e});if(a.authenticatorSelection?.userVerification==="required")return new fe({message:"User verification was required but no available authenticator supported it",code:"ERROR_AUTHENTICATOR_MISSING_USER_VERIFICATION_SUPPORT",cause:e})}else{if(e.name==="InvalidStateError")return new fe({message:"The authenticator was previously registered",code:"ERROR_AUTHENTICATOR_PREVIOUSLY_REGISTERED",cause:e});if(e.name==="NotAllowedError")return new fe({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="NotSupportedError")return a.pubKeyCredParams.filter(o=>o.type==="public-key").length===0?new fe({message:'No entry in pubKeyCredParams was of type "public-key"',code:"ERROR_MALFORMED_PUBKEYCREDPARAMS",cause:e}):new fe({message:"No available authenticator supported any of the specified pubKeyCredParams algorithms",code:"ERROR_AUTHENTICATOR_NO_SUPPORTED_PUBKEYCREDPARAMS_ALG",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if(gr(n)){if(a.rp.id!==n)return new fe({message:`The RP ID "${a.rp.id}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new fe({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="TypeError"){if(a.user.id.byteLength<1||a.user.id.byteLength>64)return new fe({message:"User ID was not between 1 and 64 characters",code:"ERROR_INVALID_USER_ID_LENGTH",cause:e})}else if(e.name==="UnknownError")return new fe({message:"The authenticator was unable to process the specified options, or could not create a new credential",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}class nd{constructor(){Object.defineProperty(this,"controller",{enumerable:!0,configurable:!0,writable:!0,value:void 0})}createNewAbortSignal(){if(this.controller){const a=new Error("Cancelling existing WebAuthn API call for new one");a.name="AbortError",this.controller.abort(a)}const t=new AbortController;return this.controller=t,t.signal}cancelCeremony(){if(this.controller){const t=new Error("Manually cancelling existing WebAuthn API call");t.name="AbortError",this.controller.abort(t),this.controller=void 0}}}const Kn=new nd,od=["cross-platform","platform"];function hr(e){if(e&&!(od.indexOf(e)<0))return e}async function sd(e){!e.optionsJSON&&e.challenge&&(console.warn("startRegistration() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useAutoRegister:a=!1}=e;if(!ra())throw new Error("WebAuthn is not supported in this browser");const n={...t,challenge:ea(t.challenge),user:{...t.user,id:ea(t.user.id)},excludeCredentials:t.excludeCredentials?.map(mr)},o={};a&&(o.mediation="conditional"),o.publicKey=n,o.signal=Kn.createNewAbortSignal();let s;try{s=await navigator.credentials.create(o)}catch(f){throw ad({error:f,options:o})}if(!s)throw new Error("Registration was not completed");const{id:r,rawId:i,response:l,type:c}=s;let u;typeof l.getTransports=="function"&&(u=l.getTransports());let b;if(typeof l.getPublicKeyAlgorithm=="function")try{b=l.getPublicKeyAlgorithm()}catch(f){mn("getPublicKeyAlgorithm()",f)}let d;if(typeof l.getPublicKey=="function")try{const f=l.getPublicKey();f!==null&&(d=Fe(f))}catch(f){mn("getPublicKey()",f)}let g;if(typeof l.getAuthenticatorData=="function")try{g=Fe(l.getAuthenticatorData())}catch(f){mn("getAuthenticatorData()",f)}return{id:r,rawId:Fe(i),response:{attestationObject:Fe(l.attestationObject),clientDataJSON:Fe(l.clientDataJSON),transports:u,publicKeyAlgorithm:b,publicKey:d,authenticatorData:g},type:c,clientExtensionResults:s.getClientExtensionResults(),authenticatorAttachment:hr(s.authenticatorAttachment)}}function mn(e,t){console.warn(`The browser extension that intercepted this WebAuthn API call incorrectly implemented ${e}. You should report this error to them.
`,t)}function fr(){if(!ra())return ba.stubThis(new Promise(t=>t(!1)));const e=globalThis.PublicKeyCredential;return e?.isConditionalMediationAvailable===void 0?ba.stubThis(new Promise(t=>t(!1))):ba.stubThis(e.isConditionalMediationAvailable())}const ba={stubThis:e=>e};function rd({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new fe({message:"Authentication ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else{if(e.name==="NotAllowedError")return new fe({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if(gr(n)){if(a.rpId!==n)return new fe({message:`The RP ID "${a.rpId}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new fe({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="UnknownError")return new fe({message:"The authenticator was unable to process the specified options, or could not create a new assertion signature",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}async function id(e){!e.optionsJSON&&e.challenge&&(console.warn("startAuthentication() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useBrowserAutofill:a=!1,verifyBrowserAutofillInput:n=!0}=e;if(!ra())throw new Error("WebAuthn is not supported in this browser");let o;t.allowCredentials?.length!==0&&(o=t.allowCredentials?.map(mr));const s={...t,challenge:ea(t.challenge),allowCredentials:o},r={};if(a){if(!await fr())throw Error("Browser does not support WebAuthn autofill");if(document.querySelectorAll("input[autocomplete$='webauthn']").length<1&&n)throw Error('No <input> with "webauthn" as the only or last value in its `autocomplete` attribute was detected');r.mediation="conditional",s.allowCredentials=[]}r.publicKey=s,r.signal=Kn.createNewAbortSignal();let i;try{i=await navigator.credentials.get(r)}catch(g){throw rd({error:g,options:r})}if(!i)throw new Error("Authentication was not completed");const{id:l,rawId:c,response:u,type:b}=i;let d;return u.userHandle&&(d=Fe(u.userHandle)),{id:l,rawId:Fe(c),response:{authenticatorData:Fe(u.authenticatorData),clientDataJSON:Fe(u.clientDataJSON),signature:Fe(u.signature),userHandle:d},type:b,clientExtensionResults:i.getClientExtensionResults(),authenticatorAttachment:hr(i.authenticatorAttachment)}}function ld(){return ra()?PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable():new Promise(e=>e(!1))}const vr=Object.freeze(Object.defineProperty({__proto__:null,WebAuthnAbortService:Kn,WebAuthnError:fe,_browserSupportsWebAuthnAutofillInternals:ba,_browserSupportsWebAuthnInternals:ur,base64URLStringToBuffer:ea,browserSupportsWebAuthn:ra,browserSupportsWebAuthnAutofill:fr,bufferToBase64URLString:Fe,platformAuthenticatorIsAvailable:ld,startAuthentication:id,startRegistration:sd},Symbol.toStringTag,{value:"Module"}));let Io=!1;function cd(){if(Io)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
    .accept-invite-page {
  ...
  `,document.head.appendChild(e),Io=!0}function dd(){const e=new URLSearchParams(window.location.search||"");let t=e.get("uid")||"",a=e.get("token")||"";if(!t||!a){const n=window.location.hash||"",o=n.includes("?")?n.slice(n.indexOf("?")+1):"",s=new URLSearchParams(o);if(t=t||s.get("uid")||"",a=a||s.get("token")||"",!t||!a){const r=n.replace(/^#\/?/,"").split("?")[0].split("/").filter(Boolean);t=t||r[1]||"",a=a||r[2]||""}}try{return{uid:decodeURIComponent(t),token:decodeURIComponent(a)}}catch{return{uid:t,token:a}}}function br(){return cd(),`
    ...
    </div>`}function _r(){const{uid:e,token:t}=dd(),a=document.getElementById("accept-invite-form"),n=document.getElementById("ai-first"),o=document.getElementById("ai-last"),s=document.getElementById("ai-pass"),r=document.getElementById("ai-confirm"),i=document.getElementById("ai-submit"),l=document.getElementById("ai-msg");if(!a)return;const c=(u,b="error")=>{l.textContent=u,l.className=`accept-invite-msg ${b}`};if(!e||!t){c("This invitation link is invalid or incomplete. Please use the link from your email."),i.disabled=!0;return}a.addEventListener("submit",async u=>{u.preventDefault();const b=(n.value||"").trim(),d=(o.value||"").trim(),g=s.value||"",f=r.value||"";if(!b||!d){c("Please enter your first and last name.");return}if(g.length<8){c("Password must be at least 8 characters.");return}if(g!==f){c("Passwords do not match.");return}i.disabled=!0,c("Setting up your account…","ok");try{const p=E.getConfig?.().BASE_URL||"",v=await fetch(`${p}/m5t/v5/acctEntity/acceptInvite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({uid:e,token:t,password:g,first:b,last:d})}),x=await v.json().catch(()=>({}));if(!v.ok||!x.ok){const $=v.status===410?"This invitation has expired. Ask for a new one.":v.status===409?"This invitation has already been used. Try signing in.":x.error||`Could not accept the invitation (HTTP ${v.status}).`;c($),i.disabled=!1;return}try{window.history.replaceState({},"",window.location.pathname+window.location.hash)}catch{}c("Welcome! Signing you in…","ok"),(await E.doSignin(x.entity.email,g))?.ok||(c("Your account is ready. Please sign in.","ok"),setTimeout(()=>{window.location.hash="#/signin"},1200))}catch(p){console.error("[accept-invite] error:",p),c("Something went wrong. Please try again."),i.disabled=!1}})}const pd={render:br,init:_r},ud=Object.freeze(Object.defineProperty({__proto__:null,default:pd,init:_r,render:br},Symbol.toStringTag,{value:"Module"})),md=""+new URL("mfm-lockup-white.png",import.meta.url).href,gd=""+new URL("mfm-lockup-black.png",import.meta.url).href,hd=""+new URL("mfm-lockup-color.png",import.meta.url).href,yr=""+new URL("m5mag-lockup.png",import.meta.url).href,fd="https://www.machfivemarketing.com",vd=yr,wr=hd;function Pt(e="#/splash"){return`
        <a class="auth-brand" href="${e}" aria-label="Mach Five Magnet">
          <img src="${yr}" alt="Mach Five Magnet" height="42" />
        </a>`}function wt(e="panel"){const t=e==="light";return`
    <a class="auth-cobrand${t?" auth-cobrand--light":""}" href="${fd}"
       target="_blank" rel="noopener" aria-label="From Mach Five Marketing">
      <span class="auth-cobrand__label">From</span>
      <img class="auth-cobrand__logo" src="${t?gd:md}"
           alt="Mach Five Marketing" height="26" loading="lazy" />
    </a>`}const bd={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},we=e=>String(e??"").replace(/[&<>"']/g,t=>bd[t]);function Ye(e){if(!e)return"";try{return new Date(e).toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}catch{return String(e)}}function _d(e,t={}){const a=t[e.id];if(e.type==="checkbox_group"){const n=Array.isArray(a)?a:[];return n.length?we(n.join(", ")):""}return a?we(a):""}function Xn(e,{emptyLabel:t="(blank)",renderAnswer:a=null}={}){const n=e?.questionnaire?.sections||[],o=e?.answers||{};return n.length?n.map(s=>`
    <div class="qm-section">
      <h3>${we(s.title)}</h3>
      ${(s.questions||[]).map(r=>`
        <div class="qm-qa" data-question-id="${we(r.id)}" data-question-type="${we(r.type)}">
          <div class="qm-qa__q">${we(r.label)}</div>
          <div class="qm-qa__a">${a?a(r,o):_d(r,o)||`<span class="qm-qa__a--empty">${we(t)}</span>`}</div>
        </div>`).join("")}
    </div>`).join(""):'<p class="qm-qa__a qm-qa__a--empty">This questionnaire has no questions.</p>'}function yd(e,t={}){const a=t[e.id];if(e.type==="checkbox_group"){const n=Array.isArray(a)?a:[];return`<div class="qm-checkbox-group">${(Array.isArray(e.options)?e.options:[]).map(s=>`
      <label><input type="checkbox" value="${we(s)}" ${n.includes(s)?"checked":""}/> ${we(s)}</label>`).join("")}</div>`}return e.type==="textarea"?`<textarea>${we(a||"")}</textarea>`:`<input type="text" value="${we(a||"")}" />`}function xr(e){const t={};return e&&e.querySelectorAll("[data-question-id]").forEach(a=>{const n=a.dataset.questionId;if(a.dataset.questionType==="checkbox_group"){const o=[...a.querySelectorAll('input[type="checkbox"]:checked')].map(s=>s.value);o.length&&(t[n]=o)}else{const o=(a.querySelector("input,textarea")?.value||"").trim();o&&(t[n]=o)}}),t}function Jn(e){const t=e?.recipient_email?`<p class="qm-recipient">Sent to ${we(e.recipient_email)}</p>`:"",a=e?.last_edited_tz?`<p class="qm-edited-marker">Last edited by ${we(e.last_edited_by_email||"a team member")} on ${we(Ye(e.last_edited_tz))}</p>`:"",n=e?.client_edited_tz?`<p class="qm-edited-marker">Updated by the client on ${we(Ye(e.client_edited_tz))}</p>`:"";return t+a+n}let Ro=!1;function Qn(){if(Ro)return;const e=document.createElement("style");e.id="m5t-questionnaire-answer-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ro=!0}const wd=""+new URL("auth-hero-sketch.jpg",import.meta.url).href;let No=!1;function xd(){if(No)return;const e=document.createElement("style");e.id="m5t-questionnaire-fill-styles",e.textContent=`
    .qf-page {
    ...
    .qf-page::before {
      ...
      background: url("${wd}") center / cover no-repeat;
  ...
  `,document.head.appendChild(e),Qn(),No=!0}function Er(){return E.getConfig?.().BASE_URL||""}function Ed(e){const t=`qf-${e.id}`;if(e.type==="checkbox_group"){const a=Array.isArray(e.options)?e.options:[];return`
      <div class="qf-field" data-question-id="${e.id}" data-question-type="checkbox_group">
        <label>${me(e.label)}</label>
        ${e.help?`<p class="qf-help">${me(e.help)}</p>`:""}
        <div class="qf-checkbox-group">
          ${a.map((n,o)=>`
            <label class="qf-checkbox-row">
              <input type="checkbox" id="${t}-${o}" value="${me(n)}" />
              ${me(n)}
            </label>`).join("")}
        </div>
      </div>`}return e.type==="textarea"?`
      <div class="qf-field" data-question-id="${e.id}" data-question-type="textarea">
        <label for="${t}">${me(e.label)}</label>
        ${e.help?`<p class="qf-help">${me(e.help)}</p>`:""}
    ...
    </div>`}function me(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function _a(e,t,a){return`
    <div class="qf-page"><div class="qf-card"><div class="qf-state">
      <span class="material-symbols-outlined">${e}</span>
      <h1>${me(t)}</h1>
      <p class="qf-sub">${me(a)}</p>
    </div></div></div>`}function kr(){return xd(),`<div id="qf-root">${_a("hourglass_top","Loading your questionnaire…","One moment.")}</div>`}async function ja(){const e=document.getElementById("qf-root");if(!e)return;const t=mc();if(!t){e.innerHTML=_a("error","Invalid link","This link is missing required information. Please use the link exactly as sent.");return}let a;try{const o=await fetch(`${Er()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(t.guid)}?token=${encodeURIComponent(t.token)}`),s=await o.json().catch(()=>({}));if(!o.ok||!s.ok){const r=o.status===404?s.error||"This link is invalid or has expired.":"Something went wrong loading your questionnaire. Please try again shortly.";e.innerHTML=_a("error","Cannot open this questionnaire",r);return}a=s.data}catch(o){console.error("[questionnaire-fill] load error:",o),e.innerHTML=_a("wifi_off","Connection problem","Could not reach the server. Please check your connection and try again.");return}const n=kd(a);if(n==="locked"){Sd(e,a);return}Cd(e,a,t,n)}function kd(e){return e.status!=="SUBMITTED"?"fill":(e.editability||{editable:!e.locked_tz}).editable?"edit":"locked"}function Ad(e){const t=e.editability||{};return t.reason==="finalized"?"Your account manager has finalised these answers, so they can no longer be changed here.":`Answers can be changed for 14 days after they are submitted.${t.deadline?` The window closed on ${Ye(t.deadline)}.`:""}`}function Sd(e,t){e.innerHTML=`
    <div class="qf-page"><div class="qf-card">
      <img class="qf-brand" src="${wr}" alt="Mach Five Marketing" height="34" />
      <h1>${me(t.questionnaire?.name||"Kickoff Questionnaire")}</h1>
      <p class="qf-sub">${t.submitted_tz?`Submitted ${me(Ye(t.submitted_tz))}.`:"Submitted."} Here is what you sent.</p>
      <div class="qf-note qf-note--locked">
        <span class="material-symbols-outlined" aria-hidden="true">lock</span>
        <span>${me(Ad(t))} To change anything now, contact your account manager.</span>
      </div>
      ${Jn(t)}
      ${Xn(t,{emptyLabel:"Left blank"})}
    </div></div>`}function Cd(e,t,a,n){const o=n==="edit",s=t.questionnaire?.sections||[],r=t.answers||{},i=t.editability?.deadline,l=o?"Change anything you need to, then save. Everything you sent before is already filled in.":"Answer what applies. If a question doesn't apply to your business, leave it blank.",c=o?`<div class="qf-note">
         <span class="material-symbols-outlined" aria-hidden="true">edit_note</span>
         <span>You already submitted this${t.submitted_tz?` on ${me(Ye(t.submitted_tz))}`:""}.${i?` You can make changes until <strong>${me(Ye(i))}</strong>.`:""}</span>
       </div>`:"";e.innerHTML=`
    <div class="qf-page"><div class="qf-card">
      <img class="qf-brand" src="${wr}" alt="Mach Five Marketing" height="34" />
      <h1>${me(t.questionnaire?.name||"Kickoff Questionnaire")}</h1>
      <p class="qf-sub">${me(l)}</p>
      ${c}
      <div class="qf-progress">
        ...
        <div class="qf-dots" role="group" aria-label="Sections">
          ${s.map((I,j)=>`<button type="button" class="qf-dot" data-step="${j}" aria-label="${me(I.title)}"></button>`).join("")}
        </div>
      </div>
      <form id="qf-form" novalidate>
        ${s.map((I,j)=>`
          <div class="qf-section" data-step="${j}" hidden>
            <h2>${me(I.title)}</h2>
            ${(I.questions||[]).map(Ed).join("")}
          </div>`).join("")}
        <div class="qf-nav">
          ...
          <button class="qf-btn" type="submit" id="qf-submit">${o?"Save changes":"Submit questionnaire"}</button>
        </div>
        <p class="qf-msg" id="qf-msg" role="status"></p>
      </form>
    </div></div>`;const u=[...e.querySelectorAll(".qf-section[data-step]")],b=[...e.querySelectorAll(".qf-dot")],d=document.getElementById("qf-back"),g=document.getElementById("qf-next"),f=document.getElementById("qf-submit"),p=document.getElementById("qf-progress-label");let v=0;function x(I,j=1){v=Math.max(0,Math.min(s.length-1,I)),u.forEach((J,ae)=>{J.hidden=ae!==v,J.classList.remove("qf-enter")});const X=u[v];X&&(X.style.setProperty("--qf-dx",`${j>=0?14:-14}px`),X.offsetWidth,X.classList.add("qf-enter")),b.forEach((J,ae)=>{ae===v?J.setAttribute("aria-current","step"):J.removeAttribute("aria-current")}),p&&(p.textContent=`Section ${v+1} of ${s.length}`),d.style.visibility=v===0?"hidden":"",g.style.display=v===s.length-1?"none":"",f.style.display=v===s.length-1?"":"none",e.querySelector(".qf-card")?.scrollIntoView({block:"start"})}d.addEventListener("click",()=>x(v-1,-1)),g.addEventListener("click",()=>x(v+1,1)),b.forEach(I=>I.addEventListener("click",()=>{const j=Number(I.dataset.step)||0;x(j,j>=v?1:-1)})),x(0),e.querySelectorAll("[data-question-id]").forEach(I=>{const j=I.dataset.questionId,X=I.dataset.questionType,J=r[j];if(J!=null)if(X==="checkbox_group"){const ae=Array.isArray(J)?J:[];I.querySelectorAll('input[type="checkbox"]').forEach(ge=>{ge.checked=ae.includes(ge.value)})}else{const ae=I.querySelector("input,textarea");ae&&(ae.value=J)}});const w=document.getElementById("qf-form"),$=document.getElementById("qf-submit"),O=document.getElementById("qf-msg"),U=(I,j="error")=>{O.textContent=I,O.className=`qf-msg ${j}`};w.addEventListener("submit",async I=>{I.preventDefault();const j=xr(e),X=`${Er()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(a.guid)}`,J=o?`${X}?token=${encodeURIComponent(a.token)}`:`${X}/submit?token=${encodeURIComponent(a.token)}`;$.disabled=!0,U(o?"Saving…":"Submitting…","ok");let ae;try{ae=await fetch(J,{method:o?"PUT":"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({answers:j})});const ge=await ae.json().catch(()=>({}));if(!ae.ok||!ge.ok){if(ae.status===423){U(ge.error||"These answers are now locked.","error"),await ja();return}const B=ae.status===409?o?"This questionnaire is not open for changes.":"This questionnaire has already been submitted.":ae.status===404?"This link is invalid or has expired.":ge.error||`Could not ${o?"save":"submit"} (HTTP ${ae.status}).`;U(B),$.disabled=!1;return}Td(e,o,ge.data?.editability?.deadline)}catch(ge){console.error(`[questionnaire-fill] ${o?"edit":"submit"} error:`,ge),U("Something went wrong. Please try again."),$.disabled=!1}})}function Td(e,t,a){const n=a?` until ${Ye(a)}`:"";e.innerHTML=`
    <div class="qf-page"><div class="qf-card"><div class="qf-state">
      ...
      <div class="qf-note qf-note--done">
        ...
        <span>Need to change something? This same link keeps working${me(n)}. Keep the email we sent you and open it again any time before then.</span>
      </div>
      <button class="qf-btn" type="button" id="qf-again">Make another change</button>
    </div></div></div>`,document.getElementById("qf-again")?.addEventListener("click",()=>{ja()})}const $d={render:kr,init:ja},Ld=Object.freeze(Object.defineProperty({__proto__:null,default:$d,init:ja,render:kr},Symbol.toStringTag,{value:"Module"}));function Id(){return`
    <div class="auth-container splash">
      <div class="auth-left">
        <div class="splash-content">
          <h1 class="splash-mark"><img src="${vd}" alt="Mach Five Magnet" height="88" /></h1>
  ...
  `}function Rd(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const e=localStorage.getItem(G.FF_SSE_LS_TOKEN),t=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!e,hasMvvTs:!!t});const a=document.getElementById("splash-loader"),n=document.getElementById("splash-actions");e?(console.log("[SplashRoute] Auth token found → HOME"),m.publish(h.ROUTE_NAV,{route:"home"})):t?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),m.publish(h.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),a&&(a.style.display="none"),n&&(n.style.display="flex"),document.querySelectorAll("[data-route]").forEach(s=>{s.addEventListener("click",()=>{const r=s.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${r}`),m.publish(h.ROUTE_NAV,{route:r})})}))},4e3)}const Nd=Object.freeze(Object.defineProperty({__proto__:null,init:Rd,render:Id},Symbol.toStringTag,{value:"Module"}));function ye(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}const Od=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;function Zn(e,t){return e?Od.test(e)?!0:(ye(t,L.get("validation_email_invalid")),!1):(ye(t,L.get("validation_email_required")),!1)}function Md(){return`
  ...
  `}function Pd(){console.log("[SigninRoute] Initialized");const e=document.getElementById("loginForm"),t=document.getElementById("email"),a=document.getElementById("password"),n=document.getElementById("togglePassword"),o=document.getElementById("rememberEmail"),s=localStorage.getItem(E.CONFIG.LS_KEYS.REMEMBERED_EMAIL);s&&t&&o&&(t.value=s,o.checked=!0,a?.focus()),n?.addEventListener("click",()=>{const u=a.type==="password"?"text":"password";a.type=u});const r=document.getElementById("passkeySigninBtn"),i=document.getElementById("passkeyDivider"),l=document.getElementById("passkeyHint");window.PublicKeyCredential&&r&&i&&(r.style.display="",i.style.display="",l&&(r.title=l.textContent),r.addEventListener("click",()=>Bd())),e?.addEventListener("submit",async u=>{u.preventDefault();const b=t.value.trim(),d=a.value;Zn(b,t)&&Fd(d,a)&&(o?.checked?localStorage.setItem(E.CONFIG.LS_KEYS.REMEMBERED_EMAIL,b):localStorage.removeItem(E.CONFIG.LS_KEYS.REMEMBERED_EMAIL),await Dd(b,d))}),document.getElementById("link--uc__underline")?.addEventListener("click",u=>{u.preventDefault(),m.publish(h.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",u=>{u.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),m.publish(h.ROUTE_NAV,{route:"signup"})})}function Fd(e,t){return e?e.length<10?(ye(t,L.get("validation_password_min_length")),!1):!0:(ye(t,L.get("validation_password_required")),!1)}async function Dd(e,t){const a=document.querySelector(".btn");a.disabled=!0,a.textContent=L.get("loading_signing_in");try{const n=await E.doSignin(e,t);n.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(L.get("success_welcome_back"),"success"),m.publish(h.AUTH_SIGNIN_SUCCESS,{entity:E.getEntity()})):n.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q(L.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(n.error||L.get("error_signin_failed"),"danger"),a.disabled=!1,a.textContent=(L.get("sign_in")||"Sign in").toUpperCase())}catch(n){console.error("[SigninRoute] Sign in error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||L.get("error_network"),"danger"),a.disabled=!1,a.textContent=(L.get("sign_in")||"Sign in").toUpperCase(),m.publish(h.AUTH_SIGNIN_FAIL,{message:n.message})}}async function Bd(){const e=document.getElementById("passkeySigninBtn");e.disabled=!0;try{const t=await E.doPasskeySignin();t.ok?(console.log("[SigninRoute] Passkey signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(L.get("success_welcome_back"),"success"),m.publish(h.AUTH_SIGNIN_SUCCESS,{entity:E.getEntity()})):document.getElementById("passkeyHint")?.style.removeProperty("display"),!t.ok&&!t.canceled&&typeof neodigmToast<"u"&&neodigmToast.q(t.error||L.get("error_signin_failed"),"danger")}catch(t){console.error("[SigninRoute] Passkey signin error:",t),typeof neodigmToast<"u"&&neodigmToast.q(t.message||L.get("error_network"),"danger")}finally{e.disabled=!1}}const qd=Object.freeze(Object.defineProperty({__proto__:null,init:Pd,render:Md},Symbol.toStringTag,{value:"Module"}));function eo(e){const t=[];return e.length<12&&t.push("at least 12 characters"),e.length>1024&&t.push("at most 1024 characters"),/[a-z]/.test(e)||t.push("1 lowercase"),/[A-Z]/.test(e)||t.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(e)||t.push("1 special character"),/[^\x00-\x7F]/.test(e)&&t.push("ASCII characters only"),t}function Ar(e){if(e.length===0)return"";if(e.includes("ASCII characters only"))return"Password cannot contain emoji|or special unicode characters";const t=e.find(a=>/^at (?:least|most) \d+ characters$/.test(a));return t?`Password must have ${t.replace(/ (\d+ characters)$/,"|$1")}`:"Password must have: Uppercase,|Lowercase, and Special Character"}const Ud="2026-07-15";function zd(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Pt()}
  ...
  `}function Hd(){console.log("[SignupRoute] Initialized");const e=document.getElementById("signupForm"),t=e.querySelector('button[type="submit"]');Oo("togglePassword","password","eyeIcon"),Oo("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),m.publish(h.ROUTE_NAV,{route:"signin"})}),e.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),s=document.getElementById("last").value.trim(),r=document.getElementById("email").value.trim(),i=document.getElementById("company").value.trim(),l=document.getElementById("phone").value.trim(),c=document.getElementById("password").value,u=document.getElementById("confirmPassword").value,b=document.getElementById("first"),d=document.getElementById("last"),g=document.getElementById("email"),f=document.getElementById("password"),p=document.getElementById("confirmPassword");if(!Mo(o,b,L.get("validation_first_name_required"))||!Mo(s,d,L.get("validation_last_name_required"))||!Zn(r,g)||!jd(c,f))return;if(c!==u){ye(p,L.get("validation_password_mismatch"));return}const v=document.getElementById("acceptTerms");if(!v.checked){ye(v,"Please accept the Terms of Service and Privacy Policy to continue.");return}t.disabled=!0,t.textContent=L.get("loading_creating_account"),await Gd(o,s,r,i,l,c)})}function Oo(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function Mo(e,t,a){return e?!0:(ye(t,a),!1)}function jd(e,t){if(!e)return ye(t,L.get("validation_password_required")),!1;const a=eo(e);return a.length>0?(ye(t,Ar(a)),!1):!0}async function Gd(e,t,a,n,o,s){const r=document.querySelector('button[type="submit"]');try{const i={email:a,password:s,first:e,last:t};n&&(i.company=n),o&&(i.phone=o),i.terms_accepted=!0,i.legal_version=Ud;const l=await E.doSignup(i);if(l.ok)m.publish(h.AUTH_SIGNUP_SUCCESS,{email:a}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const c=l.error||l.message||L.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(c,"danger"),r.disabled=!1,r.textContent=(L.get("create_account")||"Create account").toUpperCase(),m.publish(h.AUTH_SIGNUP_FAIL,{message:c})}}catch(i){console.error("[SignupRoute] Sign up error:",i),typeof neodigmToast<"u"&&neodigmToast.q(i.message||L.get("error_network"),"danger"),r.disabled=!1,r.textContent=(L.get("create_account")||"Create account").toUpperCase(),m.publish(h.AUTH_SIGNUP_FAIL,{message:i.message})}}const Vd=Object.freeze(Object.defineProperty({__proto__:null,init:Hd,render:zd},Symbol.toStringTag,{value:"Module"}));function Wd(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Pt()}
  ...
  `}function Yd(){console.log("[VerfLinkRoute] Initialized");const e=7200,t=Date.now(),a=document.getElementById("countdown-display");function n(){const s=Date.now()-t,r=Math.floor(s/1e3),i=Math.max(0,e-r),l=Math.floor(i/3600),c=Math.floor(i%3600/60),u=i%60,b=`${String(l).padStart(2,"0")}:${String(c).padStart(2,"0")}:${String(u).padStart(2,"0")}`;a&&(a.textContent=b,i<600&&(a.style.color="#ef4444",a.style.textShadow=`
          0 0 10px rgba(239, 68, 68, 0.9),
          0 0 20px rgba(239, 68, 68, 0.7),
          0 0 30px rgba(239, 68, 68, 0.5)
        `),i===0&&(a.style.color="#7f1d1d",a.style.textShadow="none")),i===0&&(clearInterval(o),console.log("[VerfLinkRoute] Countdown expired"),window.neodigmWired4Sound&&window.neodigmWired4Sound.sound(14),setTimeout(()=>{window.router&&window.router.navigate("/splash")},600))}n();const o=setInterval(n,1e3);window.addEventListener("beforeunload",()=>{clearInterval(o)})}const Kd=Object.freeze(Object.defineProperty({__proto__:null,init:Yd,render:Wd},Symbol.toStringTag,{value:"Module"})),Xd="https://machfivemagnet-saas.onrender.com";class Jd{constructor(){this.baseUrl=Xd}async request(t,a={}){const n=`${this.baseUrl}${t}`,o={"Content-Type":"application/json",...a.headers};try{const s=await fetch(n,{...a,headers:o});if(s.status===401||s.status===403){m.publish(h.AUTH_TOKEN_EXPIRED,{status:s.status,endpoint:t});const i=await s.json().catch(()=>({}));throw new Error(i.error||"Authentication failed")}const r=await s.json();return{ok:s.ok,status:s.status,data:r}}catch(s){throw console.error("API Request Error:",s),m.publish(h.APP_ERROR,{message:s.message,endpoint:t}),s}}async get(t){return this.request(t,{method:"GET"})}async post(t,a){return this.request(t,{method:"POST",body:JSON.stringify(a)})}async put(t,a){return this.request(t,{method:"PUT",body:JSON.stringify(a)})}async delete(t){return this.request(t,{method:"DELETE"})}async signin(t,a){return this.post("/api/acctEntity/signin",{email:t,hash:a})}async signup(t){return this.post("/api/acctEntity/signup",t)}async signout(){return this.post("/api/acctEntity/signout",{})}async forgotPassword(t){return this.get(`/m5t/v5/acctEntity/forgot?CODE=${encodeURIComponent(t)}`)}async resetHash(t,a){return this.post("/api/acctEntity/resethash",{email:t,hash:a})}async verifyAccount(t){return this.get(`/api/acctEntity/verify?CODE=${t}`)}async getAccounts(){return this.get("/api/acctEntity")}async getAccount(t){return this.get(`/api/acctEntity/${t}`)}async updateAccount(t,a){return this.put(`/api/acctEntity/${t}`,a)}async deleteAccount(t){return this.delete(`/api/acctEntity/${t}`)}async ping(){return this.get("/ping")}}const Qd=new Jd;function Zd(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Pt("#/signin")}
  ...
  `}function ep(){console.log("[ForgotRoute] Initialized");const e=document.getElementById("forgot-form"),t=document.getElementById("email");e?.addEventListener("submit",async a=>{a.preventDefault();const n=t.value.trim();Zn(n,t)&&await tp(n)})}async function tp(e){const t=document.querySelector(".btn");t.disabled=!0,t.textContent="SENDING...";try{const a=await Qd.forgotPassword(e);a.ok&&a.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q(L.get("success_reset_link_sent"),"success"),m.publish(h.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(a.data.error||L.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=(L.get("send_reset_link")||"Send reset link").toUpperCase())}catch(a){console.error("[ForgotRoute] Forgot password error:",a),typeof neodigmToast<"u"&&neodigmToast.q(a.message||L.get("error_network"),"danger"),t.disabled=!1,t.textContent=(L.get("send_reset_link")||"Send reset link").toUpperCase()}}const ap=Object.freeze(Object.defineProperty({__proto__:null,init:ep,render:Zd},Symbol.toStringTag,{value:"Module"}));function np(){const t=E.getEntity()?.email||"";return`
    <div class="auth-container">
      <div class="auth-left">
        ${Pt("#/home")}
  ...
  `}function op(){console.log("[ResethashRoute] Initialized");const e=document.getElementById("resethash-form"),t=e.querySelector('button[type="submit"]');Po("toggleNewPassword","new-password","eyeIconNew"),Po("toggleConfirmPassword","confirm-password","eyeIconConfirm"),e?.addEventListener("submit",async a=>{a.preventDefault();const n=e.email.value.trim(),o=e.newPassword.value,s=e.confirmPassword.value,r=document.getElementById("new-password"),i=document.getElementById("confirm-password");if(!o){ye(r,L.get("validation_new_password_required"));return}const l=eo(o);if(l.length>0){ye(r,Ar(l));return}if(!s){ye(i,L.get("validation_new_password_required"));return}if(o!==s){ye(i,L.get("validation_password_mismatch"));return}t.disabled=!0,t.textContent=L.get("loading_resetting_password");try{const c=await E.doResetHash(n,o);c.ok?(typeof neodigmToast<"u"&&neodigmToast.q(L.get("success_password_reset"),"success"),m.publish(h.AUTH_RESETHASH_SUCCESS,{email:n})):(ye(r,c.error||L.get("error_signin_failed")),t.disabled=!1,t.textContent=(L.get("update_password")||"Update password").toUpperCase())}catch(c){console.error("[ResethashRoute] Reset password error:",c),ye(r,c.message||L.get("error_network")),t.disabled=!1,t.textContent=(L.get("update_password")||"Update password").toUpperCase()}})}function Po(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}const sp=Object.freeze(Object.defineProperty({__proto__:null,init:op,render:np},Symbol.toStringTag,{value:"Module"})),ie=()=>E.getManagedClients().length>0&&!E.getStoredActiveOrg(),Je=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),rp={reseller_org:"Your org",managed_client:"Client",saas_org:"Org"};let Fo=!1;function xt(){if(Fo)return;const e=document.createElement("style");e.id="m5t-portfolio-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Fo=!0}const Do=e=>e.toISOString().slice(0,10);async function ip(e,{days:t=30}={}){const a=new Date,n=Do(new Date(a.getTime()-(t-1)*864e5)),o=Do(a),s=await fetch(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${o}&group_by=owner`);if(!s.ok)throw new Error(`HTTP ${s.status}`);const r=await s.json();if(!r.ok)throw new Error("stats not ok");return r.by_owner||[]}function Sr(e,t){return`<div class="dash-clients-scroll"><table class="dash-clients">
    <thead><tr>
    ...
    <tbody>${e.map(a=>`
      <tr data-org="${Je(a.owner_guid)}" tabindex="0" role="button"
        ...
        <td><span class="dc-name">${Je(a.name||a.owner_guid)}
          <span class="dc-chip">${Je(rp[a.channel]||a.channel||"")}</span></span></td>
        ${t.map(n=>`<td>${n.td(a)}</td>`).join("")}
        <td><span class="dc-view">View →</span></td>
      </tr>`).join("")}</tbody>
  </table></div>`}function lp(e){let t=e.querySelector(".pf-access-error");t||(t=document.createElement("div"),t.className="pf-access-error",e.prepend(t)),t.textContent="You don't have direct access to manage this org. Use the admin console to act on its behalf."}function Cr(e){if(!e)return;const t=async a=>{const n=a?.dataset?.org;if(!n)return;(await E.setActiveOrg(n))?.activeOrgError&&lp(e)};e.querySelectorAll("tbody tr[data-org]").forEach(a=>{a.addEventListener("click",()=>t(a)),a.addEventListener("keydown",n=>{(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),t(a))})})}const kn=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Et({section:e,title:t,description:a}){return xt(),`
    <div class="page-shell" data-section="${Je(e)}">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="pf-picker-body">${kn("hourglass_empty","Loading…")}</div>
      </div>
    </div>`}async function nt(e,t,{emptyMsg:a}={}){const n=document.getElementById("pf-picker-body");if(n)try{const o=await ip(e);if(!o.length){n.innerHTML=kn("groups",a||"No client orgs yet. Create one under Clients first.");return}n.innerHTML=Sr(o,t),Cr(n)}catch(o){console.warn("[portfolio] picker load failed:",o),n.innerHTML=kn("error","Could not load your clients. Please refresh.")}}function Tr(){const e={};return E.getManagedClients().forEach(t=>{e[t.orgGuid]=t.name}),E.getMemberships().forEach(t=>{t.orgGuid&&!e[t.orgGuid]&&(e[t.orgGuid]=t.name||"")}),e}const $r=e=>e?`<span class="pf-client-chip">${Je(e)}</span>`:"",bt=Object.freeze({MAGNET_TEMPLATE:"magnet_template",LEADS_SEARCH:"leads_search",LEADS_DAY:"leads_day"}),It=new Map;function to(e,t){It.set(e,t)}function An(e){if(!It.has(e))return null;const t=It.get(e);return It.delete(e),t}function cp(e){return It.has(e)?It.get(e):null}const Ae=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,_e=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),te=e=>Number(e||0).toLocaleString(),Lr=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",dp=e=>(Lr(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function pp(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric"})}catch{return""}}function up(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}let Bo=!1;function mp(){if(Bo)return;const e=document.createElement("style");e.id="m5t-dash-recent-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Bo=!0}function gp(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${_e(dp(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${_e(Lr(e))}</span>
      <span class="recent-lead__sub">${_e(e.email||e.phone||"")}</span>
    </span>
    <span class="m5t-badge recent-lead__badge" data-s="${_e(e.status)}">${_e(e.status)}</span>
    <span class="recent-lead__time">${_e(pp(e))}</span>
  </a>`}const Gt=({icon:e,label:t,valueId:a,value:n="—",subId:o,sub:s="",href:r,trendId:i})=>{const l=r?"a":"div",c=r?` href="${_e(r)}" class="stat-card stat-card--link"`:' class="stat-card"';return`
  <${l}${c}>
  ...
  </${l}>`},da=(e,t,a,{wide:n=!1,full:o=!1,controls:s=!1}={})=>`
  <div class="dashboard-card${n?" chart-card-wide":""}${o?" chart-card-full":""}">
    ...
    <div class="card-body" id="${a}">${Ae("hourglass_empty","Loading…")}</div>
  </div>`;let Sn=30;function Ir(){mp(),xt();const e=ie();return`
    <div class="page-shell" data-section="home">
      ...
      <div class="dashboard-card dashboard-card--lead">
        ...
        <div class="card-body" id="dash-portfolio">${Ae("hourglass_empty","Loading…")}</div>
      </div>`:""}

      <div class="stats-grid">
        ${Gt({icon:"widgets",label:"Active Magnets",valueId:"stat-active-magnets",subId:"stat-active-magnets-sub",sub:"Loading…",href:"#/magnets"})}
        ${Gt({icon:"ads_click",label:"Magnet Opens",valueId:"stat-opens",subId:"stat-opens-sub",sub:"Loading…"})}
        ${Gt({icon:"person_add",label:"Leads Captured",valueId:"stat-leads",subId:"stat-leads-sub",sub:"Loading…",href:"#/leads",trendId:"stat-leads-trend"})}
        ${Gt({icon:"check_circle",label:"Completion Rate",valueId:"stat-completion",subId:"stat-completion-sub",sub:"Loading…"})}
      </div>

      <div class="charts-section">
        ${da("show_chart","Opens & Leads","dash-trend",{wide:!0,controls:!0})}
        <div class="charts-grid">
          ${da("filter_alt","Completion Funnel","dash-funnel")}
          ${da("source","Top Campaigns","dash-campaigns")}
          ${da("touch_app","CTA Usage","dash-routes",{full:!0})}
        </div>
      </div>
      ...
      <div class="content-grid">
        ...
        <div class="dashboard-card">
          ...
          <div class="card-body" id="recent-leads-body">
            ${Ae("hourglass_empty","Loading leads…")}
          </div>
        </div>
      </div>
    </div>`}async function Rr(){const e=E.getConfig?.().BASE_URL||"";document.getElementById("dash-periods")?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(Sn=Number(a.dataset.days)||30,document.querySelectorAll("#dash-periods .chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===Sn)),Uo(e))}),document.getElementById("dash-campaigns")?.addEventListener("click",t=>{const a=t.target.closest("[data-campaign]");a&&to(bt.LEADS_SEARCH,a.dataset.campaign)}),await Promise.all([Uo(e),bp(e)])}const Be=(e,t)=>{const a=document.getElementById(e);a&&(a.textContent=t)},Tt=(e,t)=>{const a=document.getElementById(e);a&&(a.innerHTML=t)},qo=e=>e.toISOString().slice(0,10),hp=()=>typeof window.matchMedia=="function"?window.matchMedia("(hover: hover)").matches:!0;async function Uo(e){const t=new Date,a=qo(new Date(t.getTime()-(Sn-1)*864e5)),n=qo(t),o=ie();let s;try{const $=await fetch(`${e}/m5t/v5/dashboard/stats?from=${a}&to=${n}${o?"&group_by=owner":""}`);if(!$.ok)throw new Error(`HTTP ${$.status}`);if(s=await $.json(),!s.ok)throw new Error("stats not ok")}catch(w){console.warn("[dashboard] stats fetch failed:",w),["stat-active-magnets","stat-opens","stat-leads","stat-completion"].forEach(O=>Be(O,"—")),["stat-active-magnets-sub","stat-opens-sub","stat-leads-sub","stat-completion-sub"].forEach(O=>Be(O,"Unavailable"));const $=document.getElementById("stat-leads-trend");$&&($.className="stat-trend",$.innerHTML=""),["dash-trend","dash-funnel","dash-campaigns","dash-routes","dash-interactions","dash-portfolio"].forEach(O=>Tt(O,Ae("error","Could not load. Please refresh.")));return}o&&fp(s.by_owner||[]),Be("stat-active-magnets",te(s.magnets.active)),Be("stat-active-magnets-sub",s.magnets.total>s.magnets.active?`${te(s.magnets.total-s.magnets.active)} paused`:s.magnets.active?"All running":"No magnets yet");const r=s.funnel||{};Be("stat-opens",r.opens?te(r.opens):"—"),Be("stat-opens-sub",r.opens?r.engagement_rate!=null?`${r.engagement_rate}% engage`:`${te(r.engaged)} engaged`:"No opens in this range yet");const i=s.leads||{};Be("stat-leads",te(i.total));const l=(i.this_week||0)-(i.prev_week||0);Be("stat-leads-sub",i.total?`${te(i.this_week)} this week`:"No leads yet");const c=document.getElementById("stat-leads-trend");if(c)if((i.prev_week||0)>0){const w=l>0?"positive":l<0?"negative":"neutral",$=l>0?"trending_up":l<0?"trending_down":"trending_flat";c.className=`stat-trend ${w}`,c.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">${$}</span>${l>0?"+":""}${te(l)}`}else c.className="stat-trend",c.innerHTML="";Be("stat-completion",r.completion_rate!=null?`${r.completion_rate}%`:"—"),Be("stat-completion-sub",r.opens?`${te(r.completions)} completed of ${te(r.opens)} opens`:"Appears once magnets get opened");const u=s.by_day||[],b=u.some(w=>w.opens||w.leads);Tt("dash-trend",b?Nr(u):Ae("show_chart","No activity in this range yet. Opens and leads chart here as visitors engage your magnets.")),b&&Or(u),Tt("dash-funnel",r.opens?vp(r):Ae("filter_alt","The funnel fills in once your magnets record opens."));const d=s.top_campaigns||[];Tt("dash-campaigns",d.length?`<div class="dash-list">${d.map(w=>`
        <a class="dash-list__row dash-list__row--link" href="#/leads" data-campaign="${_e(w.campaign)}" title="Show the leads from ${_e(w.campaign)}">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">campaign</span></span>
          <span class="dash-list__main">${_e(w.campaign)}</span>
          <span class="dash-list__num">${te(w.leads)}</span>
          <span class="dash-list__go material-symbols-outlined" aria-hidden="true">chevron_right</span>
        </a>`).join("")}</div>`:Ae("source","No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here."));const g={book:["event","Book"],chat:["chat","Chat"],call:["phone_in_talk","Call"],email:["mail","Email"],support:["support_agent","Support"]},f=Object.entries(r.routes||{}).sort((w,$)=>$[1]-w[1]),p=f.length?f[0][1]:0;Tt("dash-routes",f.length?`<div class="dash-funnel">${f.map(([w,$])=>{const[O,U]=g[w]||["touch_app",w];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${O}</span> ${_e(U)}</span><span class="dash-funnel__val">${te($)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${p?Math.max(4,Math.round($/p*100)):0}%"></div></div>
        </div>`}).join("")}</div>`:Ae("touch_app","CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar."));const v={open:["visibility","Magnet opened"],engage:["touch_app","Visitor engaged"],route:["alt_route","Picked a channel"],complete:["check_circle","Completed: lead captured"]},x=s.recent_events||[];Tt("dash-interactions",x.length?`<div class="dash-list">${x.map(w=>{const[$,O]=v[w.event]||["sensors",w.event],U=w.event==="route"&&w.detail?` · ${_e(w.detail)}`:"";return`<div class="dash-list__row">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">${$}</span></span>
          <span class="dash-list__main">${O}${U}</span>
          ${w.display_mode?`<span class="dash-list__mode">${_e(w.display_mode)}</span>`:""}
          <span class="dash-list__time">${_e(up(w.at))}</span>
        </div>`}).join("")}</div>`:Ae("sensors","No interactions yet. They'll stream in as visitors engage your magnets."))}function fp(e){const t=document.getElementById("dash-portfolio");if(!t)return;if(!e.length){t.innerHTML=Ae("groups","No client orgs yet. Create one under Clients to see its numbers here.");return}const a=e.some(s=>s.ad),n=s=>{const r=(s.leads.this_week||0)-(s.leads.prev_week||0);return!s.leads.this_week&&!s.leads.prev_week?"":` <span class="${r>=0?"dc-delta-up":"dc-delta-down"}">(${r>=0?"+":""}${te(r)})</span>`},o=[{h:"Magnets",td:s=>`${te(s.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${te(s.magnets.total)}</span>`},{h:"Leads · wk",td:s=>`${te(s.leads.this_week)}${n(s)}`},{h:"Leads · total",td:s=>te(s.leads.total)},{h:"Opens",td:s=>te(s.opens)},{h:"Compl.",td:s=>s.completion_rate!=null?`${s.completion_rate}%`:"—"},...e.some(s=>s.ab_tests?.running||s.ab_tests?.completed)?[{h:"A/B",td:s=>s.ab_tests?.running?`${te(s.ab_tests.running)} <span class="dc-sub">running</span>`:s.ab_tests?.completed?`${te(s.ab_tests.completed)} <span class="dc-sub">done</span>`:"—"}]:[],...e.some(s=>s.booked)?[{h:"Booked",td:s=>s.booked?te(s.booked):"—"}]:[],...e.some(s=>s.called)?[{h:"Called",td:s=>s.called?te(s.called):"—"}]:[],...a?[{h:"Spend",td:s=>s.ad?`$${te(s.ad.spend)}`:"—"},{h:"CPL",td:s=>s.ad?.cost_per_lead!=null?`$${te(s.ad.cost_per_lead)}`:"—"}]:[]];t.innerHTML=Sr(e,o),Cr(t)}function vp(e){const t=[["Opened",e.opens,""],["Engaged",e.engaged," dash-funnel__bar--mid"],["Completed",e.completions," dash-funnel__bar--end"],...e.booked?[["Booked",e.booked," dash-funnel__bar--end"]]:[],...e.called?[["Called",e.called," dash-funnel__bar--end"]]:[]],a=Math.max(1,e.opens||0),n=o=>Math.min(100,Math.round((o||0)/a*100));return`<div class="dash-funnel">${t.map(([o,s,r])=>`
    <div class="dash-funnel__row">
      <div class="dash-funnel__meta">
        <span class="dash-funnel__label">${o}</span>
        <span class="dash-funnel__val">${te(s)} <span class="dash-funnel__pct">${n(s)}%</span></span>
      </div>
      <div class="dash-funnel__track"><div class="dash-funnel__bar${r}" style="width:${Math.max(2,n(s))}%"></div></div>
    </div>`).join("")}</div>`}async function bp(e){const t=document.getElementById("recent-leads-body");if(t)try{const a=await fetch(`${e}/m5t/v5/m5mLead`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json(),o=(Array.isArray(n?.data)?n.data:[]).filter(s=>!["DELETED","ARCHIVED"].includes(s.status));t.innerHTML=o.length?o.slice(0,5).map(gp).join(""):Ae("contacts","No leads captured yet. Publish a magnet to start collecting.")}catch(a){console.warn("[dashboard] Leads fetch failed:",a),t.innerHTML=Ae("error","Could not load recent leads.")}}function zo(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}const Ho=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e));function Nr(e){const g=e.length||1,f=zo(Math.max(1,...e.map(H=>H.opens||0))),p=zo(Math.max(1,...e.map(H=>H.leads||0))),v=748/g,x=Math.min(22,v*.55),w=H=>46+v*(H+.5),$=H=>266-H/f*248,O=H=>266-H/p*248,U=[0,.5,1].map(H=>{const Z=266-H*248;return`<line x1="46" y1="${Z.toFixed(1)}" x2="794" y2="${Z.toFixed(1)}" class="dash-grid"/><text x="38" y="${(Z+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${Ho(f*H)}</text><text x="802" y="${(Z+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${Ho(p*H)}</text>`}).join(""),I=e.map((H,Z)=>{const ot=$(H.opens||0);return`<rect class="dash-bar" data-i="${Z}" x="${(w(Z)-x/2).toFixed(1)}" y="${ot.toFixed(1)}" width="${x.toFixed(1)}" height="${Math.max(0,266-ot).toFixed(1)}" rx="3"/>`}).join(""),j=e.map((H,Z)=>`${w(Z).toFixed(1)},${O(H.leads||0).toFixed(1)}`).join(" "),X=g>1?`<polyline class="dash-line" points="${j}" fill="none" stroke-width="2.5"/>`:"",J=e.map((H,Z)=>`<circle class="dash-dot" data-i="${Z}" cx="${w(Z).toFixed(1)}" cy="${O(H.leads||0).toFixed(1)}" r="3.2"/>`).join(""),ae='<line class="dash-crosshair" x1="0" y1="18" x2="0" y2="266" pointer-events="none"/>',ge=Math.max(1,Math.ceil(g/6)),B=e.map((H,Z)=>Z%ge===0||Z===g-1?`<text x="${w(Z).toFixed(1)}" y="288" text-anchor="middle" class="dash-ax">${H.date.slice(5)}</text>`:"").join(""),le=e.map((H,Z)=>`<rect class="dash-hit" data-i="${Z}" data-day="${_e(H.date)}" data-leads="${Number(H.leads||0)}" x="${(46+v*Z).toFixed(1)}" y="18" width="${v.toFixed(1)}" height="${248 .toFixed(1)}" fill="transparent"/>`).join("");return`
    ...
    </div>`}function Or(e){const t=document.querySelector("#dash-trend .dash-chart-wrap"),a=document.querySelector("#dash-trend .dash-chart-tip");if(!t||!a)return;const n=c=>{try{return new Date(`${c}T00:00:00`).toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}catch{return c}},o=t.querySelector(".dash-crosshair"),s=()=>{t.querySelectorAll(".dash-bar--on, .dash-dot--on, .dash-hit--on").forEach(c=>c.classList.remove("dash-bar--on","dash-dot--on","dash-hit--on")),o&&o.classList.remove("dash-crosshair--on")},r=(c,u)=>{if(s(),t.querySelector(`.dash-bar[data-i="${c}"]`)?.classList.add("dash-bar--on"),t.querySelector(`.dash-dot[data-i="${c}"]`)?.classList.add("dash-dot--on"),u.classList.add("dash-hit--on"),o){const b=Number(u.getAttribute("x"))+Number(u.getAttribute("width"))/2;o.setAttribute("x1",b),o.setAttribute("x2",b),o.classList.add("dash-crosshair--on")}},i=(c,u)=>{const b=e[c];if(!b)return;a.innerHTML=`
      <div class="dash-chart-tip__date">${n(b.date)}</div>
      <div class="dash-chart-tip__row"><i class="dash-sw dash-sw--1"></i>${te(b.opens||0)} opens</div>
      <div class="dash-chart-tip__row"><i class="dash-sw dash-sw--2"></i>${te(b.leads||0)} leads</div>
      ${Number(b.leads||0)>0?'<div class="dash-chart-tip__go">Click to see them →</div>':""}`;const d=u.getBoundingClientRect(),g=t.getBoundingClientRect();a.style.left=`${d.left-g.left+d.width/2}px`,a.style.top=`${d.top-g.top}px`,a.hidden=!1,r(c,u)},l=()=>{a.hidden=!0,s()};t.querySelectorAll(".dash-hit").forEach(c=>{const u=Number(c.dataset.i);c.addEventListener("mouseenter",()=>i(u,c)),c.addEventListener("mousemove",()=>i(u,c)),c.addEventListener("mouseleave",l),c.addEventListener("click",()=>{const b=c.classList.contains("dash-hit--on");i(u,c),Number(c.dataset.leads||0)&&(!hp()&&!b||(to(bt.LEADS_DAY,c.dataset.day),window.location.hash="#/leads"))})})}const _p={render:Ir,init:Rr},yp=Object.freeze(Object.defineProperty({__proto__:null,default:_p,init:Rr,render:Ir,statCard:Gt,svgTrendChart:Nr,wireTrendTooltip:Or},Symbol.toStringTag,{value:"Module"}));function wp(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Pt("#/home")}
  ...
  `}function xp(){console.log("[SignoutRoute] Initialized");const e=document.getElementById("confirm-signout-btn");e?.addEventListener("click",async()=>{e.disabled=!0,e.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await E.doSignout()})}const Ep=Object.freeze(Object.defineProperty({__proto__:null,init:xp,render:wp},Symbol.toStringTag,{value:"Module"}));let jo=!1;function kp(){if(jo)return;const e=document.createElement("style");e.id="m5t-section-page-styles",e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),jo=!0}function Mr({title:e="Section",icon:t="widgets",name:a=""}={}){return kp(),`
    ...
    </section>`}function Pr(){}const Ap={render:Mr,init:Pr},Sp=Object.freeze(Object.defineProperty({__proto__:null,default:Ap,init:Pr,render:Mr},Symbol.toStringTag,{value:"Module"})),Cp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ct=e=>String(e??"").replace(/[&<>"']/g,t=>Cp[t]),Go=(e,t="info")=>{try{m.publish(h.UI_TOAST,{message:e,type:t})}catch{}},Tp=()=>E.getConfig?.().BASE_URL||"",Fr=()=>`${Tp()}/m5t/v5/acctEntity/profile`,Cn={profile:null};let Vo=!1;function $p(){if(Vo)return;const e=document.createElement("style");e.id="m5t-settings-general-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Vo=!0}const Dr=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Br(){try{return Ne.getAvailableLanguages()||[]}catch{return[]}}function Lp(){const e=Br(),t=e.includes(G.FF_SSE_I18N_LANG)?G.FF_SSE_I18N_LANG:e[0]||G.FF_SSE_I18N_LANG;try{const a=localStorage.getItem(G.FF_SSE_LS_USER_LANG);return a&&e.includes(a)?a:t}catch{return t}}function Ip(e){try{const t=new Intl.DisplayNames([e],{type:"language"}).of(e);if(t&&t!==e)return t.charAt(0).toUpperCase()+t.slice(1)}catch{}return e}function Rp(){const e=Ha(),t=Br(),a=t.length>1;if(!e&&!a)return"";const n=Lp();return`
        ...
        <div class="settings-item" id="gen-lang-item">
          ...
          <div class="settings-item__control">
            <select class="settings-select" id="gen-lang" aria-label="Language">
              ${t.map(o=>`<option value="${ct(o)}" ${o===n?"selected":""}>${ct(Ip(o))}</option>`).join("")}
            </select>
          </div>
        </div>`:""}
      </div>
    </div>`}function qr(){return $p(),`
    <div class="page-shell" data-section="settings-general">
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ...
          <div id="gen-profile-body">${Dr("hourglass_empty","Loading…")}</div>
        </div>
      </div>
    ...
    </div>`}async function Ur(){Pp(),await Op()}function Np(e){return`
    ...
    </div>`}async function Op(){const e=document.getElementById("gen-profile-body");if(e){try{const t=await fetch(Fr()),a=await t.json().catch(()=>({}));if(!t.ok||!a.ok||!a.data)throw new Error(a.error||"Failed to load");Cn.profile=a.data}catch(t){console.warn("[settings-general] profile load failed:",t),e.innerHTML=Dr("error","Could not load your profile. Please try again.");return}e.innerHTML=Np(Cn.profile),e.querySelector("#gen-save")?.addEventListener("click",Mp)}}function Wo(e,t){const a=document.getElementById(`${e}-error`);a&&(a.textContent=t||"",a.hidden=!t);const n=document.getElementById(e);n&&n.setAttribute("aria-invalid",t?"true":"false")}async function Mp(){const e=document.getElementById("gen-save"),t=n=>(document.getElementById(n)?.value??"").trim(),a={first:t("gen-first"),last:t("gen-last"),company:t("gen-company"),phone:t("gen-phone")};if(Wo("gen-first",a.first?"":"First name is required."),Wo("gen-last",a.last?"":"Last name is required."),!(!a.first||!a.last)){e&&(e.disabled=!0);try{const n=await fetch(Fr(),{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}),o=await n.json().catch(()=>({}));if(!n.ok||!o.ok)throw new Error(o.error||"Could not save.");o.data&&(Cn.profile=o.data),Go("Profile updated.","success")}catch(n){console.warn("[settings-general] profile save failed:",n),Go(n.message||"Could not save.","error")}finally{e&&(e.disabled=!1)}}}function Pp(){const e=document.getElementById("gen-dark");if(e){e.addEventListener("change",()=>{ir(e.checked?"dark":"light"),e.checked=Zt()==="dark"});const a=m.subscribe(h.UI_THEME_CHANGED,()=>{if(!e.isConnected){m.unsubscribe(a);return}e.checked=Zt()==="dark"})}const t=document.getElementById("gen-lang");t&&t.addEventListener("change",()=>{try{Ne.setLanguage(t.value)}catch(a){console.warn("[settings-general] setLanguage failed:",a)}})}const Fp={render:qr,init:Ur},Dp=Object.freeze(Object.defineProperty({__proto__:null,default:Fp,init:Ur,render:qr},Symbol.toStringTag,{value:"Module"})),Bp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ve=e=>String(e??"").replace(/[&<>"']/g,t=>Bp[t]),Yo=(e,t="info")=>{try{m.publish(h.UI_TOAST,{message:e,type:t})}catch{}},$a=()=>E.getConfig?.().BASE_URL||"",qp=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?",zr="managed_client",Hr={reseller_org:"Your organization",managed_client:"Client workspace",saas_org:"Organization"},Up=6,et={org:null},jr=()=>E.getActiveOrg()?.guid||E.getMemberships()[0]?.orgGuid||null,Ga=()=>E.getActiveOrg()?.channel||E.getMemberships()[0]?.channel||null,Gr=()=>E.getCapabilities().includes("manage_team");let Ko=!1;function zp(){if(Ko)return;const e=document.createElement("style");e.id="m5t-workspace-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ko=!0}const La=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Xo=(e,t,a)=>`
  <div class="settings-section__head">
    ...
    <div class="page-shell" data-section="settings-workspace">
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ${Xo("apartment","Organization","Name and details.")}
          <div id="ws-org-body">${La("hourglass_empty","Loading…")}</div>
        </div>
      </div>

      <div class="dashboard-card" id="ws-team-card" style="margin-top:24px; display:none">
        <div class="card-body">
          ${Xo("group","Team","Who has access.")}
          <div id="ws-team-body"></div>
        </div>
      </div>
    </div>`}async function Wr(){et.org=null,await Hp(),await Vp()}async function Hp(){const e=document.getElementById("ws-org-body");if(!e)return;const t=jr();if(!t){e.innerHTML=La("apartment","No workspace on this account yet.");return}try{const a=await fetch(`${$a()}/m5t/v5/acctGroup`),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||`Failed (HTTP ${a.status})`);if(et.org=(n.data||[]).find(o=>o.guid===t)||null,!et.org)throw new Error("Org row not in scope")}catch(a){console.warn("[settings-workspace] load failed:",a),e.innerHTML=La("error","Could not load your workspace. Please try again.");return}jp()}function Jo(){const e=Hr[Ga()]||"",t=et.org?.created?.created_tz;let a="";if(t){const o=new Date(t);Number.isNaN(o.getTime())||(a=`Created ${o.toLocaleDateString()}`)}const n=[e,a].filter(Boolean);return n.length?`<p class="settings-help">${Ve(n.join(" · "))}</p>`:""}function jp(){const e=document.getElementById("ws-org-body");if(!e)return;const t=et.org||{};if(!Gr()){const a=Ga()===zr?'<div class="settings-note"><span class="material-symbols-outlined" aria-hidden="true">info</span> This workspace is managed for you.</div>':"";e.innerHTML=`
      <div class="settings-item">
        <div class="settings-item__info">
          <div class="settings-item__title">Organization name</div>
          <div class="settings-item__desc">${Ve(t.caption||"Not set")}</div>
        </div>
      </div>
      <div class="settings-item">
        <div class="settings-item__info">
          <div class="settings-item__title">Description</div>
          <div class="settings-item__desc">${Ve(t.description||"Not set")}</div>
        </div>
      </div>
      ${a}
    ...
    <div class="settings-field">
      ...
      <input class="settings-input" id="ws-name" type="text" required value="${Ve(t.caption||"")}" />
    </div>
    <div class="settings-field">
      <label class="settings-label" for="ws-desc">Description</label>
      <textarea class="settings-input" id="ws-desc" rows="2">${Ve(t.description||"")}</textarea>
    </div>
    <p class="settings-error" id="ws-org-error"></p>
    <div class="settings-save-row">
      ${Jo()}
      <button class="btn btn-primary" type="button" id="ws-save">Save</button>
    </div>`,document.getElementById("ws-save")?.addEventListener("click",Gp)}async function Gp(){const e=document.getElementById("ws-save"),t=document.getElementById("ws-org-error"),a=(document.getElementById("ws-name")?.value||"").trim(),n=(document.getElementById("ws-desc")?.value||"").trim();if(t&&(t.textContent=""),!a){t&&(t.textContent="Organization name is required.");return}e&&(e.disabled=!0);try{const o=await fetch(`${$a()}/m5t/v5/acctGroup/${encodeURIComponent(et.org.id)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({caption:a,description:n})}),s=await o.json().catch(()=>({}));if(!o.ok||!s.ok)throw new Error(s.message||s.error||`Failed (HTTP ${o.status})`);et.org={...et.org,caption:a,description:n},Yo("Workspace updated.","success")}catch(o){console.warn("[settings-workspace] save failed:",o),Yo(o.message||"Could not save","danger"),e&&(e.disabled=!1);return}e&&(e.disabled=!1);try{await E.fetchScope?.()}catch(o){console.warn("[settings-workspace] fetchScope after save failed:",o)}}function Qo(){document.getElementById("ws-team-card")?.remove()}async function Vp(){const e=document.getElementById("ws-team-card");if(!e)return;const t=jr();if(!t||!Gr()){Qo();return}let a=[],n=[];try{const[o,s]=await Promise.all([fetch(`${$a()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/members`),fetch(`${$a()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/invites`)]);if(o.status===403||s.status===403){Qo();return}const[r,i]=await Promise.all([o.json().catch(()=>({})),s.json().catch(()=>({}))]);if(!o.ok||!s.ok)throw new Error(`members: ${o.status}, invites: ${s.status}`);a=r.members||[],n=i.invites||[]}catch(o){console.warn("[settings-workspace] team load failed:",o),e.style.display="";const s=document.getElementById("ws-team-body");s&&(s.innerHTML=La("error","Could not load your team. Please try again."));return}Kp(a,n)}function Wp(e){if(!e.length)return"";const t=e.slice(0,Up),a=e.length-t.length;return`
    <div class="ws-avatars">
      ${t.map(n=>`<span class="ws-avatar" title="${Ve(n.name||n.email)}">${Ve(qp(n.name||n.email))}</span>`).join("")}
      ${a>0?`<span class="ws-avatar ws-avatar--more">+${a}</span>`:""}
    </div>`}function Yp(e,t){const a=`${e.length} member${e.length===1?"":"s"}`;return t.length?`${a} · ${t.length} pending invite${t.length===1?"":"s"}`:a}function Kp(e,t){const a=document.getElementById("ws-team-card"),n=document.getElementById("ws-team-body");if(!a||!n)return;a.style.display="";const o=Ga()!==zr;n.innerHTML=`
    ${Wp(e)}
    <p class="ws-counts">${Ve(Yp(e,t))}</p>
    ${o?'<div class="ws-team-actions"><a class="btn btn-secondary" href="#/team">Manage team</a></div>':""}`}const Xp={render:Vr,init:Wr},Jp=Object.freeze(Object.defineProperty({__proto__:null,default:Xp,init:Wr,render:Vr},Symbol.toStringTag,{value:"Module"})),Qp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Pe=e=>String(e??"").replace(/[&<>"']/g,t=>Qp[t]),Se=(e,t="info")=>{try{m.publish(h.UI_TOAST,{message:e,type:t})}catch{}},_t=()=>E.getConfig?.().BASE_URL||"",Zp=e=>or(e),ta=5,Ee={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},Tn=()=>E.getActiveOrg()?.guid||E.getMemberships()[0]?.orgGuid||null;let Zo=!1;function eu(){if(Zo)return;const e=document.createElement("style");e.id="m5t-notif-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Zo=!0}const ao=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Yr(){return eu(),xt(),ie()?Et({section:"settings-notifications",title:"Notifications",description:"Pick a client to manage their lead alerts."}):`
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Email sent the moment a magnet captures a lead. Up to ${ta} recipients per magnet.</p>
            </div>
          </div>
          <div id="ntf-body">${ao("hourglass_empty","Loading…")}</div>
        </div>
      </div>
    ...
    </div>`}async function Kr(){if(ie()){const e=t=>Number(t||0).toLocaleString();return nt(_t(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Promise.all([tu(),Xr()])}async function Xr(){const e=Tn();if(e)try{const t=await fetch(`${_t()}/m5t/v5/acctGroup/${encodeURIComponent(e)}/webhook`);if(t.status===403){Ee.webhookAllowed=!1;return}const a=await t.json().catch(()=>({}));if(!a.ok)return;Ee.webhook=a.webhook,Jr()}catch{}}function es(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function Jr(){const e=document.getElementById("ntf-wh-card"),t=document.getElementById("ntf-wh-body");if(!e||!t)return;e.style.display="";const a=Ee.webhook,n=a?.last_delivery;t.innerHTML=`
    <div class="ntf-wh">
      <div class="settings-field" style="margin-bottom:0">
        <label class="settings-label" for="ntf-wh-url">Webhook URL</label>
        <input class="ntf-input" id="ntf-wh-url" type="url" placeholder="https://hooks.zapier.com/hooks/catch/…" value="${Pe(a?.uri||"")}" />
      </div>
      <div class="settings-field" style="margin-bottom:0">
      ...
      <div class="ntf-wh__row">
        ...
        <span class="ntf-wh__status">${n?n.ok?`Last delivery: <span class="ok">delivered</span> ${Pe(es(n.tz))}`:`Last delivery: <span class="bad">failed</span> ${Pe(es(n.tz))} (${Pe(n.error||"")})`:""}</span>
      </div>
    </div>`,t.querySelector("#ntf-wh-save")?.addEventListener("click",async()=>{const o=t.querySelector("#ntf-wh-url")?.value.trim()||"",s=t.querySelector("#ntf-wh-secret")?.value??"",r={uri:o};s.trim()!==""&&(r.secret=s.trim());try{const i=await fetch(`${_t()}/m5t/v5/acctGroup/${encodeURIComponent(Tn())}/webhook`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),l=await i.json().catch(()=>({}));if(!i.ok||!l.ok)throw new Error(l.error||`Failed (HTTP ${i.status})`);Ee.webhook=l.webhook,Se(o?"Webhook saved":"Webhook removed","success"),Jr()}catch(i){Se(i.message||"Could not save","danger")}}),t.querySelector("#ntf-wh-test")?.addEventListener("click",async o=>{const s=o.currentTarget;s.disabled=!0;try{const r=await fetch(`${_t()}/m5t/v5/acctGroup/${encodeURIComponent(Tn())}/webhook-test`,{method:"POST"}),i=await r.json().catch(()=>({}));r.ok&&i.ok?Se("Test delivery sent","success"):Se(i.error||"Could not deliver the test","danger")}catch{Se("Could not deliver the test","danger")}finally{s.disabled=!1}try{await Xr()}catch(r){console.warn("[notifications] loadWebhook refresh failed:",r)}})}async function tu(){const e=document.getElementById("ntf-body");if(e){try{const a=await(await fetch(`${_t()}/m5t/v5/magnets`)).json().catch(()=>({}));if(!a.ok)throw new Error(a.message||"Failed to load");Ee.magnets=(a.magnets||[]).filter(n=>n.status!=="ARCHIVED"),Ee.canManage=!!a.canManage}catch(t){console.warn("[notifications] load failed:",t),e.innerHTML=ao("error","Could not load your magnets. Please try again.");return}Qr()}}function au(e){const t=Array.isArray(e.notify_emails)?e.notify_emails:[],a=t.length>0;return`
    <div class="ntf-row" data-guid="${Pe(e.guid)}">
      <div class="ntf-magnet">
        <div class="ntf-name" title="${Pe(e.name)}">${Pe(e.name)}</div>
        <div class="ntf-meta">${Pe((e.domains||[]).join(", ")||e.status)}</div>
      ...
      <div class="ntf-config">
        ${t.length?`<div class="ntf-chips">${t.map(n=>`
              <span class="ntf-chip">${Pe(n)}${Ee.canManage?`<button type="button" data-remove="${Pe(n)}" aria-label="Remove ${Pe(n)}">&times;</button>`:""}</span>`).join("")}</div>`:'<div class="ntf-none">No alert emails.</div>'}
        ${Ee.canManage?`
        <div class="ntf-addrow">
          <input class="ntf-input" type="email" placeholder="name@business.com" aria-label="Add alert email" ${t.length>=ta?"disabled":""} />
          <button class="ntf-btn" type="button" data-add ${t.length>=ta?"disabled":""}>
    ...
    </div>`}function Qr(){const e=document.getElementById("ntf-body");if(e){if(!Ee.magnets.length){e.innerHTML=ao("widgets","No magnets yet. Create one under Your Magnets first.");return}e.innerHTML=Ee.magnets.map(au).join(""),e.querySelectorAll(".ntf-row").forEach(t=>{const a=t.dataset.guid,n=t.querySelector(".ntf-input"),o=()=>{const s=(n?.value||"").trim().toLowerCase();if(!s)return;if(!Zp(s)){Se("That does not look like an email address","danger");return}const i=[...Ee.magnets.find(l=>l.guid===a).notify_emails||[]];if(i.includes(s)){Se("Already added","info");return}if(i.length>=ta){Se(`Up to ${ta} emails per magnet`,"info");return}ts(a,[...i,s])};t.querySelector("[data-add]")?.addEventListener("click",o),n?.addEventListener("keydown",s=>{s.key==="Enter"&&o()}),t.querySelectorAll("[data-remove]").forEach(s=>s.addEventListener("click",()=>{const r=Ee.magnets.find(i=>i.guid===a);ts(a,(r.notify_emails||[]).filter(i=>i!==s.dataset.remove))})),t.querySelector("[data-test]")?.addEventListener("click",()=>nu(a,t.querySelector("[data-test]")))})}}async function ts(e,t){try{const a=await fetch(`${_t()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({notify_emails:t})}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||n.message||`Failed (HTTP ${a.status})`);const o=Ee.magnets.find(s=>s.guid===e);o&&(o.notify_emails=t),Se("Alert emails updated","success")}catch(a){console.warn("[notifications] save failed:",a),Se(a.message||"Could not save","danger");return}try{Qr()}catch(a){console.error("[notifications] renderBody after save failed:",a)}}async function nu(e,t){t&&(t.disabled=!0);try{const a=await fetch(`${_t()}/m5t/v5/magnets/${encodeURIComponent(e)}/notify-test`,{method:"POST"}),n=await a.json().catch(()=>({}));a.ok&&n.ok?Se("Test alert sent","success"):Se(n.error||"Could not send the test","danger")}catch{Se("Could not send the test","danger")}finally{t&&(t.disabled=!1)}}const ou={render:Yr,init:Kr},su=Object.freeze(Object.defineProperty({__proto__:null,default:ou,init:Kr,render:Yr},Symbol.toStringTag,{value:"Module"}));function ru({label:e="",content:t="",size:a="",onClose:n=null}={}){const o=document.activeElement,s=document.createElement("div");s.className="m5t-modal-scrim",s.innerHTML=`
    <div class="m5t-modal${a==="wide"?" m5t-modal--wide":""}" role="dialog" aria-modal="true" aria-label="${iu(e)}" tabindex="-1">
    ...
    </span>`}function Va(e,t){const a=du(),n=e?.[t]||[];return n.find(o=>o.owner_guid===a)||n[0]||null}function Wa(e,t,a){return e.connect&&!a?"unavailable":t?t.connect_status==="ACTIVE"?"connected":"broken":"idle"}function Ya(e,t){return e==="unavailable"?'<span class="intg-state">Not available yet</span>':e==="idle"?'<span class="intg-state">Not connected</span>':e==="connected"?'<span class="intg-state on"><span class="material-symbols-outlined" aria-hidden="true">check</span>Connected</span>':`<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>${N(t?.connect_status==="NEEDS_REAUTH"?"Reconnect needed":"Connection error")}</span>`}async function Ka(){const e=await fetch(`${re()}/m5t/v5/integrations`);if(e.status===403)return{denied:!0};const t=await e.json();if(!t.ok)throw new Error(t.error||"load failed");return{providers:t.data.providers,configured:t.data.configured}}async function gu(e){if(!Ce.busy){Ce.busy=!0;try{const a=await(await fetch(`${re()}/m5t/v5/integrations/${e.slug}/connect`)).json();if(!a.ok||!a.data?.url)throw new Error(a.error||"connect failed");window.location.href=a.data.url}catch(t){ke(t.message||e.connect.fallbackError,"error"),Ce.busy=!1}}}async function hu(e,{refresh:t}={}){if(Ce.busy)return;Ce.busy=!0;const a=document.getElementById(e.card.ids.sync);a&&(a.disabled=!0);try{const o=await(await fetch(`${re()}/m5t/v5/integrations/${e.slug}/sync`,{method:"POST"})).json();if(!o.ok)throw new Error(o.error||"sync failed");const r=(o.data?.connections?.[0]?.[e.sync.itemsField]||[]).filter(i=>i.error).length;ke(r?e.sync.failedToast(r):"Metrics synced.",r?"warning":"success")}catch{ke("Sync failed.","error")}finally{Ce.busy=!1,a&&(a.disabled=!1),t?.()}}async function fu(e,{refresh:t}={}){if(Ce.busy)return;Ce.busy=!0;let a=!1;try{a=await Zr({title:`Disconnect ${e.label}?`,message:e.disconnect.confirm,confirmLabel:"Disconnect",danger:!0})}finally{a||(Ce.busy=!1)}if(a)try{const o=await(await fetch(`${re()}/m5t/v5/integrations/${e.slug}`,{method:"DELETE"})).json().catch(()=>({}));if(!o.ok)throw new Error(o.error||"disconnect failed");ke(e.disconnect.toast,"success")}catch{ke("Disconnect failed.","error")}finally{Ce.busy=!1,t?.()}}async function ti(e,{refresh:t}={}){const a=e.picker,n=document.getElementById(e.card.ids.panel);if(n){n.style.display="",n.innerHTML=Te(a.loading);try{const s=await(await fetch(`${re()}/m5t/v5/integrations/${e.slug}/${a.path}`)).json();if(!s.ok)throw new Error(s.error||"load failed");vu(e,s.data[a.itemsField]||[],new Set(s.data.linked||[]),{refresh:t})}catch{n.innerHTML=Te(a.loadError,"error")}}}function vu(e,t,a,{refresh:n}={}){const o=e.picker,s=document.getElementById(e.card.ids.panel);if(!s)return;const r=t.map(i=>{const l=o.rowDisabled(i),c=o.rowBadge(i),u=a.has(i.id)&&!l;return`
      <label class="intg-acct${l?" disabled":""}">
        <input type="checkbox" data-${o.dataAttr}="${N(i.id)}" ${u?"checked":""} ${l?"disabled":""}>
    ...
    </div>`,document.getElementById(o.ids.cancel)?.addEventListener("click",()=>{s.style.display="none"}),document.getElementById(o.ids.save)?.addEventListener("click",()=>bu(e,{refresh:n}))}async function bu(e,{refresh:t}={}){const a=e.picker,n=document.getElementById(e.card.ids.panel),o=[...n?.querySelectorAll(`input[data-${a.dataAttr}]:checked`)||[]].map(r=>r.dataset[a.datasetKey]),s=document.getElementById(a.ids.save);s&&(s.disabled=!0);try{const i=await(await fetch(`${re()}/m5t/v5/integrations/${e.slug}/${a.path}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({[a.saveField]:o})})).json();if(!i.ok)throw new Error(i.error||"save failed");ke(a.savedToast(i.data.linked),"success"),n&&(n.style.display="none"),t?.()}catch{ke(a.saveError,"error"),s&&(s.disabled=!1)}}function ns({refresh:e,replaceKey:t=!1}={}){const a=document.getElementById(Re.callrail.card.ids.setup);a&&(a.style.display="",a.innerHTML=`
    <div class="intg-picker">
    ...
    </div>`,document.getElementById("intg-r-cancel")?.addEventListener("click",()=>{a.style.display="none"}),document.getElementById("intg-r-continue")?.addEventListener("click",()=>_u({refresh:e})),document.getElementById("intg-r-key")?.focus())}const Xe=e=>{const t=document.getElementById("intg-r-status");t&&(t.textContent=e)};async function _u({refresh:e}={}){const t=document.getElementById("intg-r-continue"),a=document.getElementById("intg-r-key")?.value.trim()||"",n=document.getElementById("intg-r-pickers");if(!a){Xe("Paste an API key first.");return}if(n&&!n.hidden)return yu(a,{refresh:e});t&&(t.disabled=!0),Xe("Checking the key with CallRail…");try{const s=await(await fetch(`${re()}/m5t/v5/integrations/callrail/validate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:a})})).json();if(!s.ok){Xe(s.error||"CallRail rejected that key.");return}const r=s.data.accounts||[],i=document.getElementById("intg-r-account");i&&(i.innerHTML=r.map(l=>`<option value="${N(l.id)}">${N(l.name)}</option>`).join(""),i.onchange=()=>os(a,i.value)),n&&(n.hidden=!1),t&&(t.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">save</span>Save'),Xe(""),await os(a,r[0]?.id)}catch{Xe("Could not reach CallRail. Try again.")}finally{t&&(t.disabled=!1)}}async function os(e,t){const a=document.getElementById("intg-r-company");if(!(!a||!t)){a.innerHTML='<option value="">Loading companies…</option>';try{const o=await(await fetch(`${re()}/m5t/v5/integrations/callrail/companies`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:t})})).json(),s=o.ok?o.data.companies||[]:[];a.innerHTML=s.length?s.map(r=>`<option value="${N(r.id)}">${N(r.name)}</option>`).join(""):'<option value="">No active companies in this account</option>'}catch{a.innerHTML='<option value="">Could not load companies</option>'}}}async function yu(e,{refresh:t}={}){const a=document.getElementById("intg-r-continue"),n=document.getElementById("intg-r-account")?.value||"",o=document.getElementById("intg-r-company")?.value||"";if(!o){Xe("Pick the company this workspace tracks.");return}a&&(a.disabled=!0),Xe("Connecting…");try{const r=await(await fetch(`${re()}/m5t/v5/integrations/callrail`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:n,company_id:o})})).json();if(!r.ok)throw new Error(r.error||"connect failed");ke(r.data?.webhook_state==="active"?"CallRail connected. Call sync is on.":"CallRail connected. Call sync setup needs attention; see below.","success"),t?.()}catch{Xe("Could not connect. Check the key and try again."),a&&(a.disabled=!1)}}async function wu({refresh:e}={}){if(Ce.busy)return;Ce.busy=!0;const t=document.getElementById(Re.callrail.card.ids.sync);t&&(t.disabled=!0);try{const n=await(await fetch(`${re()}/m5t/v5/integrations/callrail/sync?days=7`,{method:"POST"})).json();if(!n.ok)throw new Error(n.error||"sync failed");const o=n.data?.connections?.[0]||{};ke(o.error?"Sync finished with errors.":`Sync done. ${o.processed||0} new call${(o.processed||0)===1?"":"s"} recorded.`,o.error?"warning":"success")}catch{ke("Sync failed.","error")}finally{Ce.busy=!1,t&&(t.disabled=!1),e?.()}}let ss=!1;function Xa(){if(ss)return;const e=document.createElement("style");e.id="m5t-intg-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ss=!0}function ai(){return Xa(),xt(),ie()?Et({section:"settings-integrations",title:"Integrations",description:"Pick a client to manage their connections."}):`
    <div class="page-shell" data-section="settings-integrations">
      ...
      <div id="intg-body">
        <div class="dashboard-card intg-card"><div class="card-body">${De("hourglass_empty","Loading…")}</div></div>
      </div>
    </div>`}async function ni(){if(ie()){const e=t=>Number(t||0).toLocaleString();return nt(re(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}xu()||await Eu()}const pa=Object.fromEntries(Object.values(Re).filter(e=>e.connect).map(e=>[e.slug,e.label]));function xu(){try{const e=new URLSearchParams(window.location.search),t=e.get("connected"),a=e.get("error")?e.get("provider")||"google_ads":null;let n=null;if(t&&Object.hasOwn(pa,t))ke(`${pa[t]} connected.`,"success"),pu({slug:t,connected:!0}),n=Object.hasOwn(Re,t)?Re[t]:null;else if(a){const o=Object.hasOwn(pa,a)?pa[a]:a;ke(`${o} connection failed (${e.get("error")}).`,"error"),n=Object.hasOwn(Re,a)?Re[a]:null}else return!1;return window.history.replaceState(null,"",window.location.pathname+window.location.hash),n?(window.router?.navigate(`/settings/integrations/${n.urlSlug}`),!0):!1}catch{return!1}}async function Eu(){const e=document.getElementById("intg-body");try{const{denied:t,providers:a,configured:n}=await Ka();if(t){e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${De("lock","Integrations are managed by workspace admins.")}</div></div>`);return}e&&(e.innerHTML=Cu(a,n))}catch{e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${De("error","Could not load integrations.")}</div></div>`)}}function ku(e,t,a){const n=Wa(e,t,a);return`
    ...
    </div>`}function Cu(e,t){const a=Object.values(Re).map(o=>ku(o,Va(e,o.slug),!!t?.[o.slug])).join(""),n=as.length?`<div class="intg-grid__soon-label">Coming soon</div>${as.map(Su).join("")}`:"";return`<div class="intg-grid">${a}${n}</div>`}const Tu={render:ai,init:ni},$u=Object.freeze(Object.defineProperty({__proto__:null,default:Tu,init:ni,render:ai},Symbol.toStringTag,{value:"Module"})),R={provider:null,conn:null,configured:!1,status:"idle"};function oi({provider:e}={}){Xa(),xt();const t=ei[e];if(!t||ie())return'<div class="page-shell"></div>';const a=Re[t];return R.provider=a,`
    <div class="page-shell" data-section="settings-integrations">
    ...
    </div>`}async function si({provider:e}={}){const t=ei[e];if(!t||ie()){window.router?.navigate("/settings/integrations",{historyAPIMethod:"replaceState"});return}await Ln();const a=uu();a?.connected&&a.slug===t&&R.provider?.picker&&Oe()&&ti(R.provider,{refresh:Ln})}async function Ln(){const e=document.getElementById("intg-detail");if(!(!e||!R.provider))try{const{denied:t,providers:a,configured:n}=await Ka();if(t){e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${De("lock","Integrations are managed by workspace admins.")}</div></div>`;return}R.conn=Va(a,R.provider.slug),R.configured=!!n?.[R.provider.slug],R.status=Wa(R.provider,R.conn,R.configured),e.innerHTML=Lu(),Fu()}catch{e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${De("error","Could not load this integration.")}</div></div>`}}function Lu(){const e=R.provider;return[Ru(e),Nu(e),Ou(e),Mu(e),Pu(e)].filter(Boolean).join("")}function Iu(e){const t=R.conn?.external_account||{};if(R.status!=="connected")return e.card.sub;if(e.slug==="calendly"){const n=[t.name,t.email&&`(${t.email})`].filter(Boolean).join(" ");return n?`Connected as ${n}.`:"Connected."}if(e.slug==="callrail"){const n=[t.account_name,t.company_name].filter(Boolean).join(" · ");return n?`Connected to ${n}.`:"Connected."}const a=e.card.reachableCount(t);return a?`${a} reachable ${e.slug==="google_analytics"?a===1?"property":"properties":a===1?"account":"accounts"}.`:"Connected."}function Ru(e){let t="";Oe()&&(e.connect&&(R.status==="idle"||R.status==="broken")&&R.configured&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${R.status==="broken"?"Reconnect":"Connect"}</button>`),e.slug==="callrail"&&R.status!=="connected"&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${R.status==="broken"?"Reconnect":"Connect"}</button>`));let a;return R.status==="unavailable"?a=`${e.label} is being set up for this platform.`:R.status==="broken"?a=e.card.brokenDesc:R.status==="idle"?a=Oe()?e.card.idleDesc:e.card.sub:a=Iu(e),`
    ...
    </div>`}function Nu(e){const t=mu[e.slug];if(!t)return"";if(R.status==="connected"||R.status==="unavailable"||!Oe())return`
      <div class="dashboard-card intg-card">
        <div class="card-body">
    ...
    <div class="dashboard-card intg-card">
    ...
    </div>`}function Ou(e){if(R.status!=="connected")return"";const t=Oe();if(e.picker){const a=e.card.reachableCount(R.conn?.external_account);return`
      <div class="dashboard-card intg-card">
        <div class="card-body">
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-g-convactions">${Te("Loading conversion actions…")}</div>
        </div>
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-c-events">${Te("Loading event types…")}</div>
        </div>
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-r-trackers">${Te("Loading tracking numbers…")}</div>
          <div class="intg-actions" style="justify-content:flex-start;margin-top:12px">
            <button type="button" class="intg-btn" id="${e.card.ids.sync}"><span class="material-symbols-outlined" aria-hidden="true">sync</span>Sync now</button>
      ...
      </div>`:""}function hn(e){if(!e)return"";try{return new Date(e).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric"})}catch{return String(e).slice(0,10)}}function Mu(e){if(!R.conn)return"";const t=R.conn.webhook||{},a=[];a.push(["Status",R.status==="connected"?"Active":R.conn.connect_status==="NEEDS_REAUTH"?"Needs reconnecting":"Error"]),e.slug==="calendly"&&(a.push(["Booking sync",t.state==="active"?"On":"Off (paid Calendly plan required)"]),t.last_received_tz&&a.push(["Last booking received",hn(t.last_received_tz)])),e.slug==="callrail"&&(a.push(["Call sync",t.state==="active"?"On":"Needs attention"]),t.cookie_capture&&a.push(["Session capture",t.cookie_capture==="active"?"On":"Needs attention"]),t.last_received_tz&&a.push(["Last call received",hn(t.last_received_tz)])),R.conn.created?.created_tz&&a.push(["Connected on",hn(R.conn.created.created_tz)]);const n=e.slug==="calendly"&&R.status==="connected"&&t.state!=="active"?Te("Booking sync is off: webhooks need a paid Calendly plan. Visitors can still book in the magnet; bookings just will not appear on the lead automatically. Reconnect after upgrading to turn it on.","error"):e.slug==="callrail"&&R.status==="connected"&&t.state!=="active"?Te("Automatic call sync could not be set up in CallRail. Calls still arrive via the daily sweep and Sync now. Reconnect to retry the setup.","error"):"";return`
    <div class="dashboard-card intg-card">
      <div class="card-body">
    ...
    </div>`}function Pu(e){return R.status!=="connected"&&R.status!=="broken"||!Oe()?"":`
    <div class="dashboard-card intg-card settings-danger">
    ...
    </div>`}function Fu(){const e=R.provider;if(!e)return;const t=Ln;e.connect&&document.getElementById(e.card.ids.connect)?.addEventListener("click",()=>gu(e)),e.slug==="callrail"&&(document.getElementById(e.card.ids.connect)?.addEventListener("click",()=>ns({refresh:t})),document.getElementById("intg-r-replace")?.addEventListener("click",()=>ns({refresh:t,replaceKey:!0})),document.getElementById(e.card.ids.sync)?.addEventListener("click",()=>wu({refresh:t})),R.status==="connected"&&Oe()&&qu()),e.picker&&(document.getElementById(e.card.ids.choose)?.addEventListener("click",()=>ti(e,{refresh:t})),document.getElementById(e.card.ids.sync)?.addEventListener("click",()=>hu(e,{refresh:t}))),e.slug==="google_ads"&&R.status==="connected"&&Oe()&&Du(),e.slug==="calendly"&&R.status==="connected"&&Oe()&&Bu(),document.getElementById(e.card.ids.disconnect)?.addEventListener("click",()=>fu(e,{refresh:t}))}async function Du(){const e=document.getElementById("intg-g-convactions");if(e)try{const a=await(await fetch(`${re()}/m5t/v5/integrations/google_ads/conversion_actions`)).json();if(!a.ok)throw new Error(a.error||"load failed");const n=a.data.actions||[],o=new Set(a.data.selected||[]);if(!n.length){e.innerHTML=Te("No enabled conversion actions in the linked accounts.");return}e.innerHTML=`
      ...
      </div>`,document.getElementById("intg-g-ca-save")?.addEventListener("click",async()=>{const s=document.getElementById("intg-g-ca-save"),r=[...e.querySelectorAll('input[type="checkbox"]:checked')].map(i=>i.value);s.disabled=!0;try{const l=await(await fetch(`${re()}/m5t/v5/integrations/google_ads/conversion_actions`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({conversion_action_ids:r})})).json();if(!l.ok)throw new Error(l.error||"save failed");ke(r.length?`Counting ${r.length} conversion action${r.length===1?"":"s"} in reporting.`:"Conversion counting turned off.","success")}catch(i){ke(i.message||"Could not save the selection.","error")}finally{s.disabled=!1}})}catch{e.innerHTML=Te("Could not load conversion actions. If this keeps happening, reconnect.","error")}}async function Bu(){const e=document.getElementById("intg-c-events");if(e)try{const a=await(await fetch(`${re()}/m5t/v5/integrations/calendly/event_types`)).json();if(!a.ok)throw new Error(a.error||"load failed");const n=a.data.event_types||[],o=a.data.scheduling_url?`<div class="intg-ev"><span class="intg-ev__name">Full scheduling page</span><span class="intg-ev__meta">${N(a.data.scheduling_url)}</span></div>`:"";e.innerHTML=n.length||o?`${o}${n.map(s=>`
          <div class="intg-ev">
            <span class="intg-ev__name">${N(s.name)}</span>
            <span class="intg-ev__meta">${s.duration?`${N(String(s.duration))} min`:""}</span>
          </div>`).join("")}`:Te("No active event types on this Calendly account.")}catch{e.innerHTML=Te("Could not load event types. If this keeps happening, reconnect.","error")}}async function qu(){const e=document.getElementById("intg-r-trackers");if(e)try{const a=await(await fetch(`${re()}/m5t/v5/integrations/callrail/trackers`)).json();if(!a.ok)throw new Error(a.error||"load failed");const n=a.data.trackers||[];e.innerHTML=n.length?n.map(o=>`
          <div class="intg-ev">
            <span class="intg-ev__name">${N(o.name)}</span>
            <span class="intg-ev__meta">${N(o.number)}${o.type==="session"?" · number pool":""}</span>
          </div>`).join(""):Te("No active tracking numbers in this company yet. Create one in CallRail and it appears here.")}catch{e.innerHTML=Te("Could not load tracking numbers.","error")}}const Uu={render:oi,init:si},zu=Object.freeze(Object.defineProperty({__proto__:null,default:Uu,init:si,render:oi},Symbol.toStringTag,{value:"Module"})),Hu={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Vt=e=>String(e??"").replace(/[&<>"']/g,t=>Hu[t]),aa=(e,t="info")=>{try{m.publish(h.UI_TOAST,{message:e,type:t})}catch{}},na=()=>E.getConfig?.().BASE_URL||"",Nt={passkeys:[],loaded:!1};let rs=!1;function ju(){if(rs)return;const e=document.createElement("style");e.id="m5t-security-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),rs=!0}const oo=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function ri(){return ju(),`
    <div class="page-shell" data-section="settings-security">
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Signing in as ${Vt(Ku())}. You stay signed in on this device after a change.</p>
            </div>
          </div>
          <div class="settings-grid-2">
            <div class="settings-field">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="pk-body">${oo("hourglass_empty","Loading…")}</div>
      </div>
    </div>`}async function ii(){document.getElementById("pw-save")?.addEventListener("click",Ju);const e=document.getElementById("pk-add-btn");e&&window.PublicKeyCredential&&(e.style.display="",e.addEventListener("click",Wu)),await li()}async function li(){const e=document.getElementById("pk-body");if(e){try{const t=await fetch(`${na()}/m5t/v5/webauthn`),a=await t.json().catch(()=>({}));if(!t.ok||!a.ok)throw new Error(a.error||"Failed to load");Nt.passkeys=a.passkeys||[],Nt.loaded=!0}catch(t){console.warn("[settings-security] load failed:",t),e.innerHTML=oo("error","Could not load your passkeys. Please try again.");return}ci()}}function is(e){if(!e)return null;try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return null}}function Gu(e){const t=is(e.last_used_time),a=e.created?.created_tz,n=is(a),o=[e.device_type==="multiDevice"?"Syncs across devices":"This device only",t?`Last used ${t}`:"Never used to sign in yet",n?`Added ${n}`:null].filter(Boolean).join(" · ");return`
    <div class="pk-row" data-guid="${Vt(e.guid)}">
      <span class="pk-icon"><span class="material-symbols-outlined" aria-hidden="true">passkey</span></span>
      <div class="pk-info">
        <div class="pk-name">${Vt(e.device_label||"Passkey")}</div>
        <div class="pk-meta">${Vt(o)}</div>
      </div>
      <button class="pk-btn pk-btn--danger" type="button" data-remove="${Vt(e.guid)}">
        <span class="material-symbols-outlined" aria-hidden="true">delete</span> Remove
      </button>
    </div>`}function ci(){const e=document.getElementById("pk-body");if(e){if(!window.PublicKeyCredential){e.innerHTML=`<p class="pk-unsupported">This browser doesn't support passkeys. Your password sign-in still works as usual.</p>`;return}if(!Nt.passkeys.length){e.innerHTML=oo("passkey","No passkeys yet. Add one for a faster, phishing-resistant sign-in.");return}e.innerHTML=Nt.passkeys.map(Gu).join(""),e.querySelectorAll("[data-remove]").forEach(t=>{t.addEventListener("click",()=>Yu(t.dataset.remove,t))})}}function Vu(){try{const e=navigator.userAgent||"",t=/iPhone/.test(e)?"iPhone":/iPad/.test(e)?"iPad":/Android/.test(e)?"Android":/Mac OS X/.test(e)?"Mac":/Windows/.test(e)?"Windows":/Linux/.test(e)?"Linux":"device",a=/Edg\//.test(e)?"Edge":/Chrome\//.test(e)?"Chrome":/Firefox\//.test(e)?"Firefox":/Safari\//.test(e)?"Safari":"";return a?`${a} on ${t}`:t}catch{return"Passkey"}}async function Wu(){const e=document.getElementById("pk-add-btn");e&&(e.disabled=!0);try{const{startRegistration:t}=await Y(async()=>{const{startRegistration:i}=await Promise.resolve().then(()=>vr);return{startRegistration:i}},void 0,import.meta.url),a=await fetch(`${na()}/m5t/v5/webauthn/register/options`,{method:"POST"}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||"Could not start passkey registration");let o;try{o=await t({optionsJSON:n.options})}catch(i){if(i?.name==="NotAllowedError")return;throw i}const s=await fetch(`${na()}/m5t/v5/webauthn/register/verify`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o,deviceLabel:Vu()})}),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.error||"Could not register this passkey");aa("Passkey added","success"),await li()}catch(t){console.warn("[settings-security] addPasskey failed:",t),aa(t.message||"Could not add a passkey","danger")}finally{e&&(e.disabled=!1)}}async function Yu(e,t){if(await Zr({title:"Remove this passkey?",message:"You can always add it back later.",confirmLabel:"Remove",danger:!0})){t&&(t.disabled=!0);try{const n=await fetch(`${na()}/m5t/v5/webauthn/${encodeURIComponent(e)}`,{method:"DELETE"}),o=await n.json().catch(()=>({}));if(!n.ok||!o.ok)throw new Error(o.error||"Could not remove this passkey");Nt.passkeys=Nt.passkeys.filter(s=>s.guid!==e),aa("Passkey removed","success"),ci()}catch(n){console.warn("[settings-security] removePasskey failed:",n),aa(n.message||"Could not remove this passkey","danger"),t&&(t.disabled=!1)}}}function Ku(){try{return E.getScope()?.entity?.email||E.getEntity?.()?.email||"your account"}catch{return"your account"}}const ua=e=>{const t=document.getElementById("pw-error");t&&(t.textContent=e||"",t.hidden=!e)},Xu=e=>e.length<=1?String(e[0]??""):e.length===2?`${e[0]} and ${e[1]}`:`${e.slice(0,-1).join(", ")}, and ${e[e.length-1]}`;async function Ju(){const e=document.getElementById("pw-new"),t=document.getElementById("pw-confirm"),a=document.getElementById("pw-save"),n=e?.value||"",o=t?.value||"",s=eo(n);if(s.length){ua(`Password needs: ${Xu(s)}.`);return}if(n!==o){ua("Passwords do not match.");return}ua(""),a&&(a.disabled=!0);try{const r=await fetch(`${na()}/m5t/v5/acctEntity/resetHash`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({password:n})}),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok)throw new Error(i.error||"Could not update your password");aa("Password updated","success"),e&&(e.value=""),t&&(t.value="")}catch(r){ua(r.message||"Could not update your password.")}finally{a&&(a.disabled=!1)}}const Qu={render:ri,init:ii},Zu=Object.freeze(Object.defineProperty({__proto__:null,default:Qu,init:ii,render:ri},Symbol.toStringTag,{value:"Module"})),em={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ue=e=>String(e??"").replace(/[&<>"']/g,t=>em[t]),In=()=>E.getConfig?.().BASE_URL||"",fn=e=>Number(e||0).toLocaleString(),Q={conversations:[],counts:{},magnetNames:{},filter:"ALL",book:!1,magnetOwnerNames:{}},ls={COMPLETED:{label:"Completed",icon:"check_circle"},IN_PROGRESS:{label:"In progress",icon:"pending"},ABANDONED:{label:"Abandoned",icon:"highlight_off"}},Rn={book:"Book",chat:"Chat",call:"Call",email:"Email",support:"Support"};function di(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email)||null}function pi(e){return(e.split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase()}function ui(e){try{return new Date(e).toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return""}}function tm(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function mi(e){return e==null?"—":e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,"0")}s`}let cs=!1;function am(){if(cs)return;const e=document.createElement("style");e.id="m5t-convs-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),cs=!0}const Ja=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function gi(){return am(),xt(),`
    <div class="page-shell" data-section="conversations">
      <div class="page-header">
        <div class="page-header-text">
          <h1 class="page-title">Conversations</h1>
          <p class="page-description">${ie()?"All conversations across your clients.":"Every visitor journey through your magnets: completed, in progress, or abandoned."}</p>
        </div>
      </div>
      <div class="dashboard-card">
        <div class="card-body" id="convs-body">
          ${Ja("hourglass_empty","Loading journeys…")}
        </div>
      </div>
    </div>`}async function hi(){await nm()}async function nm(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${In()}/m5t/v5/conversations`),fetch(`${In()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(Q.conversations=n.conversations||[],Q.counts=n.counts||{},Q.book=ie(),a){const o=await a.json().catch(()=>({}));Q.magnetNames={},Q.magnetOwnerNames={};const s=Q.book?Tr():{};(o.magnets||[]).forEach(r=>{Q.magnetNames[r.guid]=r.name,Q.book&&(Q.magnetOwnerNames[r.guid]=r.owner_name||s[r.owner_guid]||"")})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=Ja("error","Could not load journeys. Please try again.");return}fi()}}function om(){return Q.filter==="ALL"?Q.conversations:Q.conversations.filter(e=>e.status===Q.filter)}function sm(e){const t=di(e.lead),a=Q.magnetNames[e.magnet_guid]||"—",n=ls[e.status]||ls.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,s=(e.routes||[]).map(r=>Rn[r]||r).join(", ");return`
    <tr class="convs-row" data-session="${ue(e.session)}">
      <td>
        <span class="convs-who">
          <span class="convs-ava${t?"":" anon"}">${t?ue(pi(t)):'<span class="material-symbols-outlined" style="font-size:16px">person_off</span>'}</span>
          <span><span class="convs-name">${t?ue(t):'<span class="convs-muted">Anonymous visitor</span>'}</span>
            ${e.lead?.email?`<div class="convs-sub">${ue(e.lead.email)}</div>`:s?`<div class="convs-sub">Picked: ${ue(s)}</div>`:""}</span>
        </span>
      </td>
      ${Q.book?`<td>${$r(Q.magnetOwnerNames[e.magnet_guid]||"")||'<span class="convs-muted">—</span>'}</td>`:""}
      <td><span class="convs-sub">${ue(a)}</span></td>
      <td><span class="convs-badge" data-s="${ue(e.status)}"><span class="material-symbols-outlined" aria-hidden="true">${n.icon}</span>${n.label}</span></td>
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${ue(ui(e.started_at))}">${ue(tm(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${ue(mi(e.duration_s))}</td>
    </tr>`}function fi(){const e=document.getElementById("convs-body");if(!e)return;if(!Q.conversations.length){e.innerHTML=Ja("route","No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.");return}const t=om(),a=[["ALL","All"],["COMPLETED","Completed"],["IN_PROGRESS","In progress"],["ABANDONED","Abandoned"]];e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${a.map(([n,o])=>`<button data-filter="${n}" class="${Q.filter===n?"active":""}">${o}${n!=="ALL"&&Q.counts[n]?` (${fn(Q.counts[n])})`:""}</button>`).join("")}
      </div>
      <span class="convs-count">${fn(t.length)} of ${fn(Q.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        <thead><tr><th>Visitor</th>${Q.book?"<th>Client</th>":""}<th>Magnet</th><th>Status</th><th>Progress</th><th>Started</th><th>Duration</th></tr></thead>
        <tbody id="convs-tbody">${t.map(sm).join("")||`<tr><td colspan="${Q.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${Q.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(Q.filter=o.dataset.filter,fi())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&im(o.dataset.session)})}const rm={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${Rn[e]||e}`:""}`,route:e=>`Picked ${Rn[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function im(e){const t=Q.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${In()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=di(t.lead),o=Q.magnetNames[t.magnet_guid]||"—",r=(a?.events||[]).filter((c,u,b)=>c.event!=="step"||!(b[u+1]&&b[u+1].event==="step")).map(c=>`
    <div class="convs-tl__item${c.event==="complete"?" done":""}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${ue((rm[c.event]||(()=>c.event))(c.detail))}</div>
      <div class="convs-tl__time">${ue(ui(c.at))}${c.variant?` · Variant ${ue(c.variant)}`:""}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      <div class="convs-drawer__head">
        <span class="convs-drawer__title">${n?ue(n):"Anonymous visitor"}</span>
      ...
      <div class="convs-drawer__body">
        ${n?`<a class="convs-drawer__lead" href="#/leads">
              <span class="convs-ava">${ue(pi(n))}</span>
              <span><div class="convs-name">${ue(n)}</div><div class="convs-sub">${ue(t.lead?.email||t.lead?.phone||"")}</div></span>
        ...
        <div class="convs-sub" style="margin-bottom:6px">${ue(o)} · ${ue(mi(t.duration_s))}${t.variant?` · Variant ${ue(t.variant)}`:""}</div>
        ${r?`<div class="convs-tl">${r}</div>`:Ja("timeline","No timeline available for this journey.")}
      </div>
    </aside>`,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("open"),i.querySelector(".convs-drawer").classList.add("open")});const l=()=>{i.classList.remove("open"),setTimeout(()=>i.remove(),220)};i.querySelector(".convs-drawer__close").addEventListener("click",l),i.addEventListener("click",c=>{c.target===i&&l()})}const lm={render:gi,init:hi},cm=Object.freeze(Object.defineProperty({__proto__:null,default:lm,init:hi,render:gi},Symbol.toStringTag,{value:"Module"})),dm={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},gt=e=>String(e??"").replace(/[&<>"']/g,t=>dm[t]),ds=(e,t="info")=>{try{m.publish(h.UI_TOAST,{message:e,type:t})}catch{}},ya=()=>E.getConfig?.().BASE_URL||"",Ot=e=>Number(e||0).toLocaleString(),tt={magnets:[],stats:{},canManage:!1},pm={mag_title:"header title",mag_subtitle:"subtitle",mag_welcome:"welcome message",mag_theme_color:"color",mag_launcher_label:"launcher label"};let ps=!1;function um(){if(ps)return;const e=document.createElement("style");e.id="m5t-abt-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ps=!0}const so=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function vi(){return ie()?Et({section:"ab-testing",title:"A/B Testing",description:"Pick a client to view their experiments."}):(um(),`
    <div class="page-shell" data-section="ab-testing">
      ...
      <div id="abt-body">${so("hourglass_empty","Loading tests…")}</div>
    </div>`)}async function ro(){if(ie())return nt(ya(),[{h:"Running",td:t=>Ot(t.ab_tests?.running)},{h:"Completed",td:t=>Ot(t.ab_tests?.completed)},{h:"Compl. %",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Experiments appear per client once you have one."});const e=document.getElementById("abt-body");try{const t=new Date,a=new Date(t.getTime()-89*864e5).toISOString().slice(0,10),n=t.toISOString().slice(0,10),[o,s]=await Promise.all([fetch(`${ya()}/m5t/v5/magnets`),fetch(`${ya()}/m5t/v5/magnets/stats?from=${a}&to=${n}`)]),r=await o.json().catch(()=>({}));if(!r.ok)throw new Error(r.message||"Failed to load");tt.magnets=r.magnets||[],tt.canManage=!!r.canManage;const i=await s.json().catch(()=>({}));tt.stats=i?.stats||{}}catch(t){console.warn("[ab-testing] load failed:",t),e&&(e.innerHTML=so("error","Could not load your tests. Please try again."));return}mm()}function mm(){const e=document.getElementById("abt-body");if(!e)return;const t=tt.magnets.filter(n=>n.ab?.enabled),a=tt.magnets.filter(n=>!n.ab?.enabled&&n.ab?.declared);if(!t.length&&!a.length){e.innerHTML=so("science","No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.");return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(vm).join("")}`:"")+(a.length?`<div class="abt-sect">Completed Tests</div>${a.map(bm).join("")}`:""),e.querySelectorAll("[data-declare]").forEach(n=>n.addEventListener("click",()=>_m(n.dataset.declare,n.dataset.winner)))}function gm(e){const t=tt.stats[e.guid]?.variants||{},a={opens:0,engaged:0,completions:0,rate:null,...t.A||{}},n={opens:0,engaged:0,completions:0,rate:null,...t.B||{}};return{A:a,B:n}}function hm(e){const t=Object.keys(e?.b||{}).map(a=>pm[a]||a);return t.length?`Changes: ${t.join(", ")}`:""}function fm(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function us(e,t,a,n,o,s){return`
    <div class="abt-variant${o?" leader":""}">
      ...
      <div class="abt-mrow"><span class="k">Visitors</span><span class="v">${Ot(n.opens)}</span></div>
      <div class="abt-mrow"><span class="k">Completions</span><span class="v">${Ot(n.completions)}</span></div>
    ...
    </div>`}function vm(e){const t=e.ab,{A:a,B:n}=gm(e),o=(n.rate??-1)>(a.rate??-1)?"B":(a.rate??-1)>(n.rate??-1)?"A":null,s=o&&a.rate!=null&&n.rate!=null?`+${Math.round(Math.abs(n.rate-a.rate)*10)/10}%`:"",r=ym(a,n),i=t.started_tz?fm(t.started_tz):null,l=(a.opens||0)+(n.opens||0),c=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
        <h2 class="abt-name">${gt(e.name)}</h2>
        <span class="abt-status running"><span class="pulse-dot"></span>Running</span>
        <div class="abt-actions">
          ${tt.canManage&&o?`<button class="btn btn-primary" type="button" data-declare="${gt(e.guid)}" data-winner="${o}"><span class="material-symbols-outlined" aria-hidden="true">emoji_events</span>Declare Winner</button>`:""}
        </div>
      </div>
      <div class="abt-meta">
        ${i!=null?`<span><span class="material-symbols-outlined" aria-hidden="true">schedule</span>Started ${i===0?"today":`${i} day${i===1?"":"s"} ago`}</span>`:""}
        <span><span class="material-symbols-outlined" aria-hidden="true">visibility</span>${Ot(l)} total visitors</span>
      ...
      <div class="abt-compare">
        ${us("Variant A","Control","The magnet as configured",a,o==="A",o==="A"?s:"")}
        <div class="abt-vs">VS</div>
        ${us("Variant B",o==="B"?"Leading":"Challenger",hm(t),n,o==="B",o==="B"?s:"")}
      </div>
      <div class="abt-sig">
    ...
    <div class="abt-card">
      ...
      <div class="abt-summary">
        ...
        <span><span class="k">Total Visitors:</span><span class="v">${Ot(r)}</span></span>
      </div>
    </div>`}async function _m(e,t){const a=tt.magnets.find(n=>n.guid===e);if(a&&window.confirm(`Declare Variant ${t} the winner for “${a.name}”?

${t==="B"?"Variant B’s changes become the magnet’s configuration for everyone.":"The magnet keeps its current configuration."} The experiment ends and moves to Completed.`)){try{const o=await(await fetch(`${ya()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Declare failed");ds(`Variant ${t} declared the winner`,"success")}catch(n){ds(n.message||"Could not declare a winner","danger");return}try{await ro()}catch(n){console.warn("[ab-testing] refresh after declare failed:",n)}}}function ym(e,t){const a=e.opens||0,n=t.opens||0,o=e.completions||0,s=t.completions||0;if(a<30||n<30||o+s<5)return null;const r=o/a,i=s/n,l=(o+s)/(a+n),c=Math.sqrt(l*(1-l)*(1/a+1/n));if(!c)return null;const u=Math.abs(i-r)/c;return Math.round(2*(wm(u)-.5)*1e3)/10}function wm(e){const t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}const xm={render:vi,init:ro},Em=Object.freeze(Object.defineProperty({__proto__:null,default:xm,init:ro,render:vi},Symbol.toStringTag,{value:"Module"})),km={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},he=e=>String(e??"").replace(/[&<>"']/g,t=>km[t]),bi=()=>E.getConfig?.().BASE_URL||"",Am={single_select:{icon:"quiz",color:"#0072BA",darkColor:"#38BDF8"},multi_select:{icon:"checklist",color:"#0E6BA8",darkColor:"#22D3EE"},scheduler:{icon:"event",color:"#915E8B",darkColor:"#E879F9"},text:{icon:"short_text",color:"#5B54C6",darkColor:"#A78BFA"},email:{icon:"mail",color:"#0E8F86",darkColor:"#2DD4BF"},phone:{icon:"call",color:"#2E8B57",darkColor:"#4ADE80"},message:{icon:"chat",color:"#B4791F",darkColor:"#FBBF24"}},Ia={};Vn.forEach(e=>{Ia[e.value]={label:e.label,...Am[e.value]||{icon:"quiz",color:"#0072BA",darkColor:"#38BDF8"}}});const _i=Vn.map(e=>e.value),yi={chat:"Chat / default",book:"Book (scheduler)",support:"Support (intake)"},io=e=>{const t=Ia[e]||Ia.single_select;return document.documentElement.getAttribute("data-theme")==="dark"?{...t,color:t.darkColor}:t},kt=e=>e==="single_select"||e==="multi_select",Qa=e=>e!=="message",Ft=e=>e==="scheduler",ia=e=>e==="message",Ra=e=>e==="email"?"email":e==="phone"?"phone":"",Dt=()=>({meeting_label:"",start:"09:00",end:"17:00",mins:30,days:14}),Sm=["meeting_label","start","end","mins","days"],ms=["terminal","cta"];function Nn(e,t){const a={};return Object.keys(e&&typeof e=="object"?e:{}).forEach(n=>{t.includes(n)||(a[n]=e[n])}),Object.keys(a).length?a:null}function wi(e){return Nn(e,Sm)}const Cm=[["","No icon"],["event","Calendar"],["schedule","Clock"],["mail","Email"],["sms","Text"],["phone","Phone"],["chat","Chat"],["description","Document"],["help","Question"],["place","Location"],["person","Person"],["bolt","Quick"],["check_circle","Check"],["star","Star"],["home","Home"],["build","Service"]];function Tm(e,t){const a=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||"").trim());return a?`rgba(${parseInt(a[1],16)},${parseInt(a[2],16)},${parseInt(a[3],16)},${t})`:`rgba(0,114,186,${t})`}let gs=!1;function $m(){if(gs)return;const e=document.createElement("style");e.id="m5t-flow-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),gs=!0}let q=[],qe=null,Lm=0,Ke=null,dt=null,pt="chat",$e={},wa=[],xi=null,On=null,xa="";const Mt=()=>"f"+ ++Lm;function lo(e="single_select"){return{_uid:Mt(),id:"",step_type:e,step_prompts:[""],step_options:kt(e)?[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]:[],step_columns:Ra(e)?[Ra(e)]:[],step_description:"",step_config:Ft(e)?Dt():null}}function Im(e){return(Array.isArray(e)?e:[]).map(t=>({_uid:Mt(),id:t.id!=null?String(t.id):"",step_type:Ia[t.step_type]?t.step_type:"single_select",step_prompts:Array.isArray(t.step_prompts)?t.step_prompts.map(String):[],step_options:(Array.isArray(t.step_options)?t.step_options:[]).map(a=>({label:a&&a.label!=null?String(a.label):"",goto:a&&a.goto!=null?String(a.goto):"",icon:a&&a.icon!=null?String(a.icon):""})),step_columns:Array.isArray(t.step_columns)?t.step_columns.map(String):[],step_description:t.step_description!=null?String(t.step_description):"",step_config:Ft(t.step_type)?{...Dt(),...t.step_config&&typeof t.step_config=="object"?t.step_config:{}}:t.step_config&&typeof t.step_config=="object"?{...t.step_config}:null}))}function hs(){return[{_uid:Mt(),id:"",step_type:"text",step_prompts:["Great, and your name?"],step_options:[],step_columns:["first_name"],step_description:"",step_config:null},{_uid:Mt(),id:"",step_type:"email",step_prompts:["The best email to reach you?"],step_options:[],step_columns:["email"],step_description:"",step_config:null}]}function Rm(e,t){if(e==="book")return[{_uid:Mt(),id:"",step_type:"scheduler",step_prompts:["When works best for you?"],step_options:[],step_columns:[],step_description:"",step_config:Dt()},...hs()];if(e==="support"){const a=(t.actions||[]).find(s=>s&&s.type==="support"),n=a&&a.config&&Array.isArray(a.config.options)?a.config.options:[],o=n.length?n.map(s=>({label:s&&s.label||String(s),goto:"",icon:s&&s.icon||""})):["Sales enquiry","Support","Billing","Something else"].map(s=>({label:s,goto:"",icon:""}));return[{_uid:Mt(),id:"",step_type:"multi_select",step_prompts:["How can we help you today?"],step_options:o,step_columns:[],step_description:"Select all that apply",step_config:null},...hs()]}return[lo("single_select")]}function Ei(e,t){const a=e==="chat"?t.steps:t.routes&&t.routes[e],n=Im(a);return n.length?n:e==="chat"?[lo("single_select")]:Rm(e,t)}function Nm(e){kt(e.step_type)?e.step_options.length||(e.step_options=[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]):e.step_options=[],Qa(e.step_type)?!e.step_columns.length&&Ra(e.step_type)&&(e.step_columns=[Ra(e.step_type)]):e.step_columns=[],e.step_config=Ft(e.step_type)?{...Dt(),...e.step_config||{}}:wi(e.step_config)}function Om(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${he(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${Cm.map(([a,n])=>`<option value="${he(a)}"${a===e.icon?" selected":""}>${he(n)}</option>`).join("")}</select>
  ...
  </div>`}function Mm(e){const t=_i.map(n=>`<option value="${n}"${n===e.step_type?" selected":""}>${he(io(n).label)}</option>`).join(""),a=e.step_options.length<=1;return`<div class="flow-node__body">
    ...
    <textarea class="mag-modal__input flow-f-prompts" rows="2" placeholder="${e.step_type==="message"?"Thanks! One moment…":"What can we help you with?"}">${he(e.step_prompts.join(`
`))}</textarea>
    ...
    <input class="mag-modal__input flow-f-cta-label" type="text" value="${he(e.step_config?.cta?.label||"")}" placeholder="e.g. Visit our site">
    <label class="mag-modal__label">Link URL <span class="flow-sub flow-cta-req">optional</span></label>
    <input class="mag-modal__input flow-f-cta-url" type="url" value="${he(e.step_config?.cta?.url||"")}" placeholder="https://example.com">
    ...
    <select class="mag-modal__select flow-f-field">
      ...
      ${Gn.map(n=>`<option value="${he(n.value)}"${n.value===e.step_columns[0]?" selected":""}>${he(n.label)}</option>`).join("")}
    </select>
    ...
    <div class="flow-opts">${e.step_options.map(n=>Om(n,a)).join("")}</div>
    ...
    <input class="mag-modal__input flow-f-mtlabel" type="text" value="${he(e.step_config?.meeting_label||"")}" placeholder="e.g. 15 minute call">
    <div class="mag-modal__row" style="margin-top:8px">
      <div><label class="mag-modal__label">From</label><input class="mag-modal__input flow-f-start" type="time" value="${he(e.step_config?.start||"09:00")}"></div>
      <div><label class="mag-modal__label">To</label><input class="mag-modal__input flow-f-end" type="time" value="${he(e.step_config?.end||"17:00")}"></div>
  ...
  </div>`}function Pm(e){const t=e.step_prompts.find(o=>String(o).trim()!=="")||"",a=t?`<div class="flow-node__prompt">“${he(t)}”</div>`:`<div class="flow-node__prompt is-empty">${e.step_type==="message"?"No message yet":"No question yet"}</div>`;let n="";if(kt(e.step_type)){const o=e.step_options.map(s=>String(s.label).trim()).filter(Boolean);if(o.length){const s=o.slice(0,4).map(i=>`<span class="flow-node__chip">${he(i)}</span>`).join(""),r=o.length>4?`<span class="flow-node__chip">+${o.length-4}</span>`:"";n=`<div class="flow-node__chips">${s}${r}</div>`}}else if(Qa(e.step_type)&&e.step_columns[0]){const o=Gn.find(s=>s.value===e.step_columns[0])?.label||e.step_columns[0];n=`<div class="flow-node__meta">Saves to <b>${he(o)}</b></div>`}else if(ia(e.step_type)&&e.step_config?.terminal){const o=String(e.step_config?.cta?.label||"").trim();n=`<div class="flow-node__meta">Ends the conversation${o?` — link: <b>${he(o)}</b>`:""}</div>`}return`<div class="flow-node__preview">${a}${n}</div>`}function Fm(e,t,a){const n=io(e.step_type),o=e._uid===qe,s=`--nc:${n.color};--nct:${Tm(n.color,.14)}`;return`<div class="flow-node${o?" flow-node--open":""}" data-uid="${e._uid}" style="${s}"${o?"":' draggable="true"'}>
    <div class="flow-node__hd">
      ...
      <span class="flow-node__type">${he(n.label)}</span>
    ...
    ${o?Mm(e):Pm(e)}
  </div>`}const fs='<div class="flow-conn"><span class="flow-conn__line"></span><span class="material-symbols-outlined" aria-hidden="true">expand_more</span></div>';function Ie(){const e=document.getElementById("flow-nodes");if(!e)return;const t=q.length,a=['<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>',fs];q.forEach((n,o)=>{a.push(Fm(n,o,t)),o<t-1&&a.push(fs)}),e.innerHTML=a.join("")}function Ue(){const e=document.querySelector(".flow-node--open");if(!e)return;const t=q.find(s=>s._uid===e.dataset.uid);if(!t)return;const a=e.querySelector(".flow-f-type");a&&(t.step_type=a.value);const n=e.querySelector(".flow-f-prompts");n&&(t.step_prompts=n.value.split(`
`));const o=e.querySelector(".flow-f-field");if(t.step_columns=o&&o.value.trim()?[o.value.trim()]:[],kt(t.step_type)){const s=t.step_options,r=[];e.querySelectorAll(".flow-opt").forEach((i,l)=>{r.push({label:i.querySelector(".flow-o-label")?.value??"",icon:i.querySelector(".flow-o-icon")?.value??"",goto:s[l]&&s[l].goto||""})}),t.step_options=r}else t.step_options=[];if(Ft(t.step_type)){const s=e.querySelector(".flow-f-mtlabel"),r=e.querySelector(".flow-f-start"),i=e.querySelector(".flow-f-end"),l=e.querySelector(".flow-f-mins");t.step_config={...t.step_config||Dt(),...s?{meeting_label:s.value.trim()}:{},...r&&r.value?{start:r.value}:{},...i&&i.value?{end:i.value}:{},...l?{mins:parseInt(l.value,10)||30}:{}}}else if(ia(t.step_type)){const s=e.querySelector(".flow-f-terminal");if(s){const r=e.querySelector(".flow-f-cta-label"),i=e.querySelector(".flow-f-cta-url"),l=Nn(t.step_config,ms)||{};t.step_config=s.checked?{...l,terminal:!0,cta:{label:r?r.value:"",url:i?i.value:""}}:Nn(t.step_config,ms)}}else t.step_config=wi(t.step_config)}function ki(){document.querySelectorAll(".flow-node.drop-before, .flow-node.drop-after").forEach(e=>e.classList.remove("drop-before","drop-after"))}function Ht(){ki(),document.querySelectorAll(".flow-node.dragging").forEach(e=>e.classList.remove("dragging")),Ke=null,dt=null}function Dm(e=q){if(!e.length)return{message:"Add at least one step.",uid:null,field:null};for(let t=0;t<e.length;t++){const a=e[t],n=t+1,o=(s,r=null)=>({message:s,uid:a._uid,field:r});if(!a.step_prompts.some(s=>String(s).trim()!==""))return o(`Step ${n}: add what the magnet should say.`,"prompts");if(kt(a.step_type)&&!a.step_options.some(s=>String(s.label).trim()!==""))return o(`Step ${n}: add at least one choice.`,"options");if(Qa(a.step_type)&&!a.step_columns.length)return o(`Step ${n}: choose which field this answer saves to.`,"field");if(ia(a.step_type)&&a.step_config?.terminal){const s=String(a.step_config.cta?.label||"").trim(),r=String(a.step_config.cta?.url||"").trim();if(!!s!=!!r)return o(`Step ${n}: fill in both the link label and URL, or leave both blank.`,"cta")}}return null}function Ai(e){if(!e)return;const t=e.querySelector(".flow-f-cta-label"),a=e.querySelector(".flow-f-cta-url");if(!t||!a)return;const n=t.value.trim()!=="",o=a.value.trim()!=="",s=n||o,r=n!==o;e.querySelectorAll(".flow-cta-req").forEach(l=>{l.textContent=s?"required":"optional",l.classList.toggle("flow-sub--req",s)}),t.classList.toggle("flow-f-invalid",r&&!n),a.classList.toggle("flow-f-invalid",r&&!o);const i=e.querySelector(".flow-cta-warn");i&&(i.hidden=!r)}function Mn(e=q){let t=0;return e.forEach(a=>{const n=parseInt(a.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(a=>{const n=a.id&&String(a.id).trim()?String(a.id):String(++t),o=kt(a.step_type)?a.step_options.map(r=>{const i={label:String(r.label).trim(),goto:String(r.goto||"")};return r.icon&&(i.icon=String(r.icon)),i}).filter(r=>r.label!==""):[],s={id:n,step_type:a.step_type,step_prompts:a.step_prompts.map(r=>String(r)).filter(r=>r.trim()!==""),step_options:o,step_columns:a.step_columns.slice(),step_description:a.step_description||""};if(Ft(a.step_type))a.step_config&&(s.step_config={...Dt(),...a.step_config});else if(a.step_config&&Object.keys(a.step_config).length){const r={...a.step_config};if(ia(a.step_type)&&r.terminal){const i=String(r.cta?.label??"").trim(),l=String(r.cta?.url??"").trim();i&&l?r.cta={label:i,url:l}:delete r.cta}s.step_config=r}return s})}function Bm(e,t,a){$m(),xi=t,On=typeof a=="function"?a:null,xa=t?.modified_tz||"",wa=["chat",...["book","support"].filter(n=>(t.actions||[]).some(o=>o&&o.type===n))],$e={chat:Ei("chat",t)},pt="chat",q=$e.chat,qe=q.length===1?q[0]._uid:null,Ke=null,dt=null,e.innerHTML=`
    ...
    ${wa.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${wa.map(n=>`<option value="${n}">${he(yi[n]||n)}</option>`).join("")}</select></div>`:""}
...
<body>
  ...
  <\/script>
  <script>${a}<\/script>
</body></html>`}let bs=!1;function Ci(){if(bs)return;const e=document.createElement("style");e.id="m5t-preview-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),bs=!0}function Ti(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function $i(e){const t=e.querySelector("[data-pv-info]"),a=e.querySelector("[data-pv-info-pop]");t&&a&&t.addEventListener("click",()=>{a.hidden=!a.hidden})}function Vm(e,t){Ci(),e.innerHTML=`
    <div class="pv-pane">
      ...
      ${Ti("Live render of the real widget. Capture is disabled, so no test leads.")}
    </div>`,$i(e);const a=e.querySelector(".pv-pane__frame"),n=e.querySelector(".pv-pane__badge");let o=null,s=0;const r=450,i=()=>{const c=(typeof performance<"u"?performance.now():Date.now())-s;clearTimeout(o),c<r?o=setTimeout(()=>{n.hidden=!0},r-c):n.hidden=!0};a.addEventListener("load",i);const l=()=>{let c;try{c=Si(t())}catch{return}s=typeof performance<"u"?performance.now():Date.now(),n.hidden=!1,a.srcdoc=c,clearTimeout(o),o=setTimeout(()=>{n.hidden=!0},1500)};return e.querySelector(".pv-pane__seg").addEventListener("click",c=>{const u=c.target.closest("button[data-device]");!u||u.dataset.device===a.dataset.device||(e.querySelectorAll(".pv-pane__seg button").forEach(b=>b.classList.toggle("is-on",b===u)),a.dataset.device=u.dataset.device)}),l(),{refresh:l,destroy(){clearTimeout(o)}}}function co(e){Ci();let t="desktop";const a=document.createElement("div");a.className="pv-scrim",a.innerHTML=`
    ...
    <div class="mag-tpl-card${s}"${r}>${i}${l}
      ...
      ${a?`<div class="mag-tpl-card__actions">${u}${b}</div>`:u}
    </div>`}const Xm=300*1e3;function Jm(e){to(bt.MAGNET_TEMPLATE,{id:e,at:Date.now()})}function Ri(e){if(!e)return null;if(typeof e=="string")return at.find(n=>n.id===e)||null;const{id:t,at:a}=e;return typeof a=="number"&&Date.now()-a>=Xm?null:at.find(n=>n.id===t)||null}function Qm(){return Ri(An(bt.MAGNET_TEMPLATE))}function Zm(){return Ri(cp(bt.MAGNET_TEMPLATE))}let ys=!1;function Ni(){if(ys)return;const e=document.createElement("style");e.id="m5t-mag-template-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ys=!0}function eg(e){Ni();const t=document.createElement("div");t.className="mag-modal-scrim mag-tpl-modal",t.innerHTML=`
  ...
  <div class="mag-csp-note__body">
    <p>A strict CSP can silently block the widget — it just never appears, no visible error. Allowlist <code>${_(W())}</code> under all three directives. Copy-paste ready for your CSP header/meta tag:</p>
    <pre class="mag-csp-note__snippet"><code>script-src 'self' ${_(W())};
connect-src 'self' ${_(W())};
img-src 'self' ${_(W())};</code></pre>
    <ul>
...
</details>`,Pi={chat:"Chat bubble",right_slide:"Slide-in panel",modal:"Modal",inline:"Inline"},ag={chat:"chat",right_slide:"vertical_split",modal:"web_asset",inline:"view_agenda"},Fi=[{value:"inline",icon:"view_agenda",label:"Inline"},{value:"chat",icon:"chat",label:"Chat"},{value:"right_slide",icon:"vertical_split",label:"Slide"},{value:"modal",icon:"web_asset",label:"Modal"}],Di=[{value:"auto",icon:"brightness_auto",label:"Auto"},{value:"light",icon:"light_mode",label:"Light"},{value:"dark",icon:"dark_mode",label:"Dark"}],Bi=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],po={book:{label:"Book",icon:"event",kind:"book"},chat:{label:"Chat",icon:"chat",kind:"flow"},call:{label:"Call",icon:"phone",kind:"value",placeholder:"Phone number"},email:{label:"Email",icon:"mail",kind:"value",placeholder:"Email address"},support:{label:"Support",icon:"support_agent",kind:"support"}},qi=["book","chat","call","email","support"];let Ea=null;async function ng(){if(Ea)return Ea;let e;try{const t=await fetch(`${W()}/m5t/v5/integrations/calendly/event_types`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.event_types||[],scheduling_url:a.data.scheduling_url||""}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(Ea=e),e}async function og(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved Calendly event";e.innerHTML=`<option value="${_(t)}">${t?_(a):"Loading event types"}</option>`;const n=await ng();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${_(t)}" selected>${_(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect Calendly under Settings, Integrations first":"Could not load event types"}</option>`;return}const o=[];n.scheduling_url&&o.push({url:n.scheduling_url,label:"Full scheduling page (visitor picks the event)"}),n.list.forEach(s=>o.push({url:s.scheduling_url,label:s.duration?`${s.name} (${s.duration} min)`:s.name})),t&&!o.some(s=>s.url===t)&&o.unshift({url:t,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${_(s.url)}"${s.url===(t||o[0].url)?" selected":""}>${_(s.label)}</option>`).join(""):'<option value="">No active event types</option>'}let ka=null;async function sg(){if(ka)return ka;let e;try{const t=await fetch(`${W()}/m5t/v5/integrations/callrail/trackers`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.trackers||[]}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(ka=e),e}async function rg(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved tracking number";e.innerHTML=`<option value="${_(t)}">${t?_(a):"Loading tracking numbers"}</option>`;const n=await sg();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${_(t)}" selected>${_(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect CallRail under Settings, Integrations first":"Could not load tracking numbers"}</option>`;return}const o=n.list.map(s=>({number:s.number,id:s.id,name:s.name,label:`${s.name} · ${s.number}${s.type==="session"?" (number pool)":""}`}));t&&!o.some(s=>s.number===t)&&o.unshift({number:t,id:e.dataset.savedId||"",name:a,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${_(s.number)}" data-tracker-id="${_(s.id)}" data-tracker-name="${_(s.name)}"${s.number===(t||o[0].number)?" selected":""}>${_(s.label)}</option>`).join(""):'<option value="">No active tracking numbers in this company</option>'}function xs(e,t,a){return`<div class="mag-seg" role="radiogroup" aria-label="${_(e)}">${a.map(n=>`
    <label><input type="radio" name="${_(e)}" value="${_(n.value)}"${n.value===t?" checked":""}>
      <span><span class="material-symbols-outlined" aria-hidden="true">${_(n.icon)}</span>${_(n.label)}</span></label>`).join("")}</div>`}function ig(e,t){const a=po[e],n=!!t,o=n?"":" disabled";let s="";if(a.kind==="value"&&e==="call"){const i=t?.config?.source==="callrail",l=i&&t?.value||"",c=i?t?.config?.tracker_name||"Saved tracking number":"";s=`
      ...
      <input class="mag-modal__input mag-cta__val" type="text" placeholder="${_(a.placeholder)}" value="${_(i?"":t?.value||"")}"${o}${i?" hidden":""}>
      <select class="mag-modal__select mag-cta__crtracker" data-saved="${_(l)}" data-saved-name="${_(c)}" data-saved-id="${_(i&&t?.config?.tracker_id||"")}"${o}${i?"":" hidden"}>
        ${l?`<option value="${_(l)}" selected>${_(c)}</option>`:""}
      </select>`}else if(a.kind==="value")s=`<input class="mag-modal__input mag-cta__val" type="text" placeholder="${_(a.placeholder)}" value="${_(t?.value||"")}"${o}>`;else if(a.kind==="book"){const i=t?.config?.meeting_label||t?.value||"",l=t?.config?.source==="calendly",c=l&&t?.config?.calendly_url||"",u=l?t?.config?.event_name||"Saved Calendly event":"";s=`
      ...
      <input class="mag-modal__input mag-cta__val" type="text" placeholder="Meeting label (e.g. 15 minute call), or paste a booking link" value="${_(i)}"${o}${l?" hidden":""}>
      <select class="mag-modal__select mag-cta__calevent" data-saved="${_(c)}" data-saved-name="${_(u)}"${o}${l?"":" hidden"}>
        ${c?`<option value="${_(c)}" selected>${_(u)}</option>`:""}
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${a.kind}">
    ...
    ${r}
  </div>`}function lg(){if(ws)return;const e=document.createElement("style");e.id="m5t-magnets-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ws=!0}function Oa(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function cg(e){const t=T.stats[e];if(!t||!t.opens&&!t.leads)return'<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>';const a=n=>Number(n||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function uo(e){const t=T.install[e.guid];if(!t)return"";const a=t.unrecognized||[],n=(t.traffic?.opens||0)>0,o=e.can_manage===!0,s=a.length?`
    <div class="mag-install__seen">
      ...
      ${a.map(u=>`
        <div class="mag-install__row">
          <span class="mag-install__dom" title="${_(u.domain)}">${_(u.domain)}</span>
          <span class="mag-install__hits">${Number(u.hits||0).toLocaleString()}&times;</span>
          ${o?`<button class="mag-btn" data-action="allow-domain" data-guid="${_(e.guid)}" data-domain="${_(u.domain)}">Allow</button>
          <button class="mag-btn" data-action="dismiss-domain" data-guid="${_(e.guid)}" data-domain="${_(u.domain)}" title="Stop showing this domain">Dismiss</button>`:""}
        </div>`).join("")}
      <p class="mag-install__hint">Only allow a domain you recognise — anyone can put this magnet's embed code on a site. Dismiss hides a domain from this list for good; it does not allow it.</p>
    </div>`:"",r=Number(t.no_referer?.hits||0),i=r?`
    <p class="mag-install__hint">
      ${r.toLocaleString()} request${r===1?"":"s"} in the last ${Number(t.window_days||30)} days arrived with no
    ...
    </p>`:"",l=t.dismissed||[],c=l.length?`
    <details class="mag-install__dismissed">
      <summary>Dismissed (${l.length})</summary>
      ${l.map(u=>`
        <div class="mag-install__row">
          <span class="mag-install__dom" title="${_(u)}">${_(u)}</span>
          ${o?`<button class="mag-btn" data-action="restore-domain" data-guid="${_(e.guid)}" data-domain="${_(u)}">Restore</button>`:""}
        </div>`).join("")}
    ...
    </details>`:"";if(n){const u=t.traffic.last_open_at?new Date(t.traffic.last_open_at).toLocaleString():"";return`<div class="mag-install" data-state="live">
      <div class="mag-install__hd"><span class="material-symbols-outlined" aria-hidden="true">check_circle</span>
        Live${u?` — last visitor ${_(u)}`:""}</div>
      ${s}
      ${i}
      ${c}
    </div>`}return a.length?`<div class="mag-install" data-state="seen">
    ...
    ${i}
    ${c}
  </div>`}async function dg(){await Promise.all(T.magnets.map(async e=>{try{const a=await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity`)).json().catch(()=>({}));if(!a.ok)return;T.install[e.guid]=a;const n=document.querySelector(`.mag-card[data-guid="${CSS.escape(e.guid)}"] .mag-install-slot`);n&&(n.innerHTML=uo(e))}catch(t){console.warn("[magnets] install activity failed:",e.guid,t)}}))}const pg=5e3,ug={ACTIVE:{label:"Connected",icon:"check_circle",tone:"live"},PENDING:{label:"Waiting to connect",icon:"hourglass_empty",tone:"pending"},REVOKED:{label:"Disconnected",icon:"link_off",tone:"off"}};function mg(e,t){const a=ug[t.status]||{label:t.status,icon:"help",tone:"off"},n=t.lastSeen?new Date(t.lastSeen).toLocaleString():"",o=t.host?_(t.host):"Waiting for a site to use this code",s=[t.siteName?_(t.siteName):"",n?`last seen ${_(n)}`:""].filter(Boolean).join(" — ");return`
    <div class="mag-conn__row" data-conn="${_(t.guid)}" data-state="${a.tone}">
      <span class="mag-conn__icon material-symbols-outlined" aria-hidden="true">${a.icon}</span>
      <span class="mag-conn__site">
        <span class="mag-conn__host">${o}</span>
        ${s?`<span class="mag-conn__sub">${s}</span>`:""}
      </span>
      <span class="mag-conn__status">${_(a.label)}</span>
      ${e.can_manage===!0&&t.status!=="REVOKED"?`<button class="mag-btn" data-action="revoke-connection" data-guid="${_(e.guid)}" data-conn="${_(t.guid)}"
    ...
    </div>`}function gg(e){const t=T.pairing[e.guid];if(!t)return"";if(t.error)return`<div class="mag-conn__code" data-state="error">
      <p class="mag-install__hint">${_(t.error)}</p>
      <button class="mag-btn" data-action="pair-start" data-guid="${_(e.guid)}">Try again</button>
      ...
      <div class="mag-conn__hd"><span class="material-symbols-outlined" aria-hidden="true">check_circle</span>
        Connected${t.connectedHost?` — ${_(t.connectedHost)}`:""}</div>
      <p class="mag-install__hint">The site is paired and its domain has been added to this magnet.</p>
    </div>`;const a=Math.max(0,Math.ceil((t.expiresAt-Date.now())/1e3));if(a<=0)return`<div class="mag-conn__code" data-state="expired">
      <p class="mag-install__hint">That code expired. Codes are shown once and can't be retrieved, so generate a new one.</p>
      <button class="mag-btn mag-btn--primary" data-action="pair-start" data-guid="${_(e.guid)}">Generate a new code</button>
    </div>`;const n=String(Math.floor(a/60)),o=String(a%60).padStart(2,"0");return`<div class="mag-conn__code" data-state="live">
    <div class="mag-conn__hd">Paste this into the MachFiveMagnet plugin on your site</div>
    <div class="mag-conn__codebox">
      <code data-x="code">${_(t.code)}</code>
      <button class="mag-btn" data-action="copy-code" data-guid="${_(e.guid)}" title="Copy pairing code">
        <span class="material-symbols-outlined" aria-hidden="true">content_copy</span>
      </button>
    </div>
    <p class="mag-conn__countdown">Expires in <strong data-x="countdown">${n}:${o}</strong>. Waiting for your site to connect&hellip;</p>
  ...
  </div>`}function Ui(e){const t=T.connections[e.guid];if(!t)return"";if(t.failed)return`<div class="mag-conn">
    ...
    </div>`;const a=t.connections||[],n=a.filter(i=>i.status!=="PENDING"||e.can_manage===!0),o=a.filter(i=>i.status==="ACTIVE").length,s=gg(e),r=n.length?n.map(i=>mg(e,i)).join(""):'<p class="mag-install__hint">No sites connected yet. On WordPress, the plugin connects a site without pasting the snippet by hand.</p>';return`<div class="mag-conn">
    <div class="mag-conn__hd">
    ...
    ${s}
    ${e.can_manage===!0&&!s?`
      <button class="mag-btn" data-action="pair-start" data-guid="${_(e.guid)}">
        <span class="material-symbols-outlined" aria-hidden="true">add_link</span>Connect a WordPress site
      </button>`:""}
  </div>`}function ht(e){const t=document.querySelector(`.mag-card[data-guid="${CSS.escape(e.guid)}"] .mag-conn-slot`);t&&(t.innerHTML=Ui(e))}async function Za(e){const a=await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/connections`)).json().catch(()=>({}));if(!a.ok)throw new Error(a.error||"Could not load connected sites");return a}async function hg(){await Promise.all(T.magnets.map(async e=>{try{T.connections[e.guid]=await Za(e)}catch(t){console.warn("[magnets] connections failed:",e.guid,t),T.connections[e.guid]={failed:!0}}ht(e)}))}function Es(){T.pairTimer&&(clearInterval(T.pairTimer),T.pairTimer=null)}function fg(e){return!!document.querySelector(`.mag-card[data-guid="${CSS.escape(e)}"] .mag-conn-slot`)}function vg(){if(T.pairTimer)return;let e=0;T.pairTimer=setInterval(async()=>{for(const o of Object.keys(T.pairing))fg(o)||delete T.pairing[o];const t=Object.keys(T.pairing);if(!t.length){Es();return}if(!t.some(o=>{const s=T.pairing[o];return!s.connected&&!s.error&&s.expiresAt-Date.now()>0})){t.forEach(o=>{const s=T.magnets.find(r=>r.guid===o);s&&ht(s)}),Es();return}e+=1e3;const n=e>=pg;n&&(e=0);for(const o of t){const s=T.magnets.find(l=>l.guid===o),r=T.pairing[o];if(!s||!r)continue;const i=r.expiresAt-Date.now()<=0;if(n&&!r.connected&&!r.error&&!i)try{const l=await Za(s);T.connections[o]=l;const c=(l.connections||[]).find(u=>u.guid===r.connectionGuid&&u.status==="ACTIVE");c&&(T.pairing[o]={connected:!0,connectionGuid:r.connectionGuid,connectedHost:c.host},ce(`${c.host||"Your site"} connected`,"success"))}catch{}ht(s)}},1e3)}async function bg(e){try{const t=await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/pairing-code`,{method:"POST",headers:{"Content-Type":"application/json"},body:"{}"}),a=await t.json().catch(()=>({}));if(!t.ok||!a.ok){T.pairing[e.guid]={error:a.message||a.error||"Could not generate a pairing code"},ht(e);return}T.pairing[e.guid]={code:a.pairingCode,connectionGuid:a.connectionGuid,expiresAt:new Date(a.expiresAt).getTime()};try{T.connections[e.guid]=await Za(e)}catch{}ht(e),vg()}catch{T.pairing[e.guid]={error:"Could not reach the server. Try again."},ht(e)}}async function _g(e){const t=T.pairing[e.guid]?.code;if(t)try{await navigator.clipboard.writeText(t),ce("Pairing code copied","success")}catch{ce("Copy failed — select the code and copy it manually","danger")}}async function yg(e,t){const a=(T.connections[e.guid]?.connections||[]).find(r=>r.guid===t),n=a?.status==="PENDING",o=n?"Cancel this pairing code?":`Disconnect ${a?.host||"this site"}?`,s=n?"The code stops working immediately.":"Its key stops working immediately and the plugin will show as disconnected. The domain stays on the allow-list — remove it separately if you want the magnet off that site.";if(window.confirm(`${o}

${s}`))try{const r=await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/connections/${encodeURIComponent(t)}/revoke`,{method:"POST",headers:{"Content-Type":"application/json"},body:"{}"}),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok){ce(i.message||i.error||"Could not disconnect","danger");return}T.pairing[e.guid]?.connectionGuid===t&&delete T.pairing[e.guid],ce(n?"Pairing code cancelled":"Site disconnected","success");try{T.connections[e.guid]=await Za(e)}catch{}ht(e)}catch{ce("Could not reach the server","danger")}}function mo(e){const t=T.owners.length>1||E.getMemberships().length>1,a=(e.domains||[]).filter(Boolean),n=e.can_manage===!0;return`
    <div class="mag-card" data-guid="${_(e.guid)}">
      <div class="mag-card__top">
        <span class="mag-swatch" style="background:${_(e.theme_color||"#0072BA")}"></span>
        <span class="mag-card__hd">
          <div class="mag-name" title="${_(e.name)}">${_(e.name)}</div>
          ${t&&e.owner_name?`<div class="mag-owner">${_(e.owner_name)}</div>`:""}
        </span>
        <span class="mag-badge" data-s="${_(e.status)}">${_(e.status)}</span>
      </div>
      <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${ag[e.display_mode]||"chat"}</span>${_(Pi[e.display_mode]||"Chat bubble")}${e.ab?.enabled?'&nbsp;&nbsp;<span class="mag-ab-chip"><span class="material-symbols-outlined" aria-hidden="true">science</span>A/B</span>':""}${(e.notify_emails||[]).length?`&nbsp;&nbsp;<a class="mag-alert-chip" href="#/settings/notifications" title="Lead alerts to ${(e.notify_emails||[]).length} email${(e.notify_emails||[]).length===1?"":"s"}. Manage in Settings."><span class="material-symbols-outlined" aria-hidden="true">notifications_active</span>${(e.notify_emails||[]).length}</a>`:""}</span>
      ${cg(e.guid)}
      <div class="mag-domains">${a.length?a.map(o=>_(o)).join(", "):"<span>No domains set. Add yours to go live.</span>"}</div>
      <div class="mag-install-slot">${uo(e)}</div>
      <div class="mag-conn-slot">${Ui(e)}</div>
      <div class="mag-embed">
        <input type="text" readonly value="${_(Oi(e.guid))}" aria-label="Embed snippet">
        <button class="mag-btn" data-action="copy" data-guid="${_(e.guid)}" title="Copy embed snippet"><span class="material-symbols-outlined" aria-hidden="true">content_copy</span></button>
      </div>
      ${Mi()}
      ...
      <div class="mag-actions">
        <button class="mag-btn" data-action="preview" data-guid="${_(e.guid)}"><span class="material-symbols-outlined" aria-hidden="true">visibility</span>Preview</button>
        <button class="mag-btn" data-action="funnel" data-guid="${_(e.guid)}" title="Which question loses the most visitors"><span class="material-symbols-outlined" aria-hidden="true">filter_alt</span>Funnel</button>
        ${n?`
        <button class="mag-btn mag-btn--primary" data-action="edit" data-guid="${_(e.guid)}"><span class="material-symbols-outlined" aria-hidden="true">tune</span>Edit</button>`:""}
      </div>
      ${n?`
      <div class="mag-actions mag-actions--sub">
        <button class="mag-btn" data-action="flow" data-guid="${_(e.guid)}" title="Edit the conversation flow"><span class="material-symbols-outlined" aria-hidden="true">account_tree</span>Flow</button>
        ${e.status==="DRAFT"?"":`
        <button class="mag-btn" data-action="toggle" data-guid="${_(e.guid)}">${e.status==="ENABLED"?'<span class="material-symbols-outlined" aria-hidden="true">pause</span>Disable':'<span class="material-symbols-outlined" aria-hidden="true">play_arrow</span>Enable'}</button>`}
        <button class="mag-btn danger" data-action="delete" data-guid="${_(e.guid)}"><span class="material-symbols-outlined" aria-hidden="true">delete</span></button>
      </div>`:""}
    </div>`}function wg(){return ie()?Et({section:"magnets",title:"Your Magnets",description:"Pick a client to view and manage their magnets."}):(lg(),`
    ...
    </div>`)}async function xg(){if(ie()){const a=Zm();if(a){const o=document.querySelector(".page-shell .page-header-text .page-description");o&&(o.textContent=`Template picked: ${a.name}. Choose the client to build it for.`)}const n=o=>Number(o||0).toLocaleString();return nt(W(),[{h:"Magnets",td:o=>`${n(o.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${n(o.magnets.total)}</span>`},{h:"Leads · wk",td:o=>n(o.leads.this_week)},{h:"Leads · total",td:o=>n(o.leads.total)}],{emptyMsg:"No client orgs yet. Create one under Clients, then provision its magnets here."})}Ea=null,ka=null,document.getElementById("mag-new-btn")?.addEventListener("click",Ag),document.getElementById("mag-template-btn")?.addEventListener("click",Sg),document.getElementById("mag-body")?.addEventListener("click",Cg),await Bt();const t=Qm();t&&T.canProvision&&ji(t)}async function Bt(){const e=document.getElementById("mag-body");if(!e)return;try{const[n,o]=await Promise.all([fetch(`${W()}/m5t/v5/magnets`),fetch(`${W()}/m5t/v5/magnets/stats`).catch(()=>null)]),s=await n.json().catch(()=>({}));if(!s.ok)throw new Error(s.message||"Failed to load");T.magnets=s.magnets||[],T.owners=s.owners||[],T.canProvision=!!s.canProvision,T.canManage=!!s.canManage,T.primaryOrgGuid=s.primaryOrgGuid||null;const r=o?await o.json().catch(()=>({})):{};T.stats=r?.stats||{}}catch{e.innerHTML=Oa("error","Could not load your magnets. Please try again.");return}const t=document.getElementById("mag-new-btn");t&&(t.style.display=T.canProvision?"":"none");const a=document.getElementById("mag-template-btn");if(a&&(a.style.display=T.canProvision?"":"none"),!T.magnets.length){e.innerHTML=Oa("widgets",T.canProvision?"No magnets yet. Click “New magnet” to create your first.":"No magnets yet.");return}e.innerHTML=`<div class="mag-grid">${T.magnets.map(mo).join("")}</div>`,dg(),hg()}async function Eg(e){const t={"Content-Type":"application/json","Idempotency-Key":crypto.randomUUID()},a={status:"DRAFT"};e&&(a.owner_guid=e);const n=await fetch(`${W()}/m5t/v5/magnets`,{method:"POST",headers:t,body:JSON.stringify(a)});let o={};try{o=await n.json()}catch{}if(!n.ok||!o.ok)throw new Error(o.message||`Could not start a new magnet (${n.status})`);return o.magnet}async function kg(e,t){const a=await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t.name,...t.appearance,steps:t.steps})});let n={};try{n=await a.json()}catch{}if(!a.ok||!n.ok)throw new Error(n.message||`Could not apply the ${t.name} template (${a.status})`)}async function go(e,t){const a=document.getElementById("mag-new-btn"),n=document.getElementById("mag-template-btn");a&&(a.disabled=!0),n&&(n.disabled=!0);let o=null;try{let s=await Eg(e);if(o=s.guid,t)await kg(s.guid,t),await Bt(),s=T.magnets.find(r=>r.guid===s.guid)||s;else{T.magnets=[s,...T.magnets];const r=document.getElementById("mag-body");r&&(r.innerHTML=`<div class="mag-grid">${T.magnets.map(mo).join("")}</div>`)}Ma(s,void 0,{freshDraft:!0})}catch(s){o&&fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(o)}`,{method:"DELETE"}).catch(()=>{}),ce(s.message||"Could not start a new magnet","danger")}finally{a&&(a.disabled=!1),n&&(n.disabled=!1)}}function zi(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="Choose client" style="max-width:420px">
      <div class="mag-modal__head">
        <span class="mag-modal__title">${e?`New magnet from “${_(e.name)}”`:"New magnet"}</span>
        <button class="mag-modal__close" type="button" aria-label="Close">&times;</button>
      </div>
      <div class="mag-modal__body" style="padding:20px">
        ...
        <select class="mag-modal__select" id="mag-owner-pick">
          ${T.owners.map(o=>`<option value="${_(o.guid)}"${o.guid===T.primaryOrgGuid?" selected":""}>${_(o.name||o.guid)}</option>`).join("")}
        </select>
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(o){o.key==="Escape"&&(o.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.querySelector('[data-x="cancel"]').addEventListener("click",a),t.querySelector('[data-x="continue"]').addEventListener("click",()=>{const o=t.querySelector("#mag-owner-pick").value;a(),go(o,e)})}function Hi(){return T.owners.length===1?T.owners[0].guid:null}function Ag(){if(T.owners.length>1){zi();return}go(Hi())}function ji(e){if(T.owners.length>1){zi(e);return}go(Hi(),e)}function Sg(){eg(ji)}function Cg(e){const t=e.target.closest("[data-action]");if(!t)return;const a=t.dataset.guid,n=T.magnets.find(s=>s.guid===a),o=t.dataset.action;if(o==="copy")return Tg(a);if(n){if(o==="preview")return co(()=>Na(n));if(o==="funnel")return $g(n);if(o==="edit")return Ma(n);if(o==="flow")return Ma(n,"flow");if(o==="allow-domain")return Lg(n,t.dataset.domain);if(o==="dismiss-domain")return Ig(n,t.dataset.domain);if(o==="restore-domain")return Rg(n,t.dataset.domain);if(o==="pair-start")return bg(n);if(o==="copy-code")return _g(n);if(o==="revoke-connection")return yg(n,t.dataset.conn);if(o==="toggle")return Ng(n);if(o==="delete")return Og(n)}}async function Tg(e){try{await navigator.clipboard.writeText(Oi(e)),ce("Embed snippet copied","success")}catch{ce("Copy failed","danger")}}function Gi(e){const t=Number(e?.total_steps)||0,a={};if((Array.isArray(e?.funnel)?e.funnel:[]).forEach(s=>{a[s.position]=Number(s.reached)||0}),!t||!Object.keys(a).length)return'<p class="mag-modal__hint" style="margin:0">No step activity yet in this window. As visitors answer questions, drop-off by step will appear here.</p>';const n=Math.max(1,a[1]||0),o=[];for(let s=1;s<=t;s++){const r=a[s]||0,i=Math.min(100,Math.round(r/n*100));o.push(`
      ...
      </div>`)}return`<div class="mag-funnel">${o.join("")}</div>`}async function $g(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal mag-funnel-modal" role="dialog" aria-modal="true" aria-label="Step funnel for ${_(e.name)}">
      <div class="mag-modal__head">
        <span class="mag-modal__title">Step funnel — ${_(e.name)}</span>
        <button class="mag-modal__close" type="button" aria-label="Close">&times;</button>
      </div>
      <div class="mag-modal__body" style="padding:20px">
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(s){s.key==="Escape"&&(s.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.addEventListener("click",s=>{s.target===t&&a()});const o=t.querySelector("#mag-funnel-body");try{const s=await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/step-funnel`),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.message||`Failed (${s.status})`);o.innerHTML=Gi(r)}catch{o.innerHTML='<p class="mag-modal__hint" style="margin:0">Could not load the funnel. Please try again.</p>'}}async function Lg(e,t){const a=String(t||"").trim().toLowerCase();if(!a||!window.confirm(`Allow ${a} to load this magnet?

Only do this for a site you recognise — anyone can put this magnet's embed code on a page.`))return;const n=[...new Set([...(e.domains||[]).filter(Boolean),a])];try{if(!(await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({domains:n})})).json().catch(()=>({}))).ok)throw new Error;ce(`${a} allowed`,"success")}catch{ce("Could not allow that domain","danger");return}try{await Bt()}catch(o){console.warn("[magnets] refresh after allow-domain failed:",o)}}async function Ig(e,t){const a=String(t||"").trim().toLowerCase();if(!a)return;const n=a.split("."),o=n.length>2?n.slice(-2).join("."):null;let s=a;o&&window.confirm(`Hide ${a} from this list?

OK — hide every domain under ${o} too (covers preview/staging URLs that change every deploy).
Cancel — hide only ${a}.`)&&(s=o);try{if(!(await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity/dismiss`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({domain:s})})).json().catch(()=>({}))).ok)throw new Error;ce(`${s} hidden from this list`,"success")}catch{ce("Could not dismiss that domain","danger");return}await Vi(e)}async function Rg(e,t){const a=String(t||"").trim().toLowerCase();if(a){try{if(!(await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity/restore`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({domain:a})})).json().catch(()=>({}))).ok)throw new Error;ce(`${a} will show again`,"success")}catch{ce("Could not restore that domain","danger");return}await Vi(e)}}async function Vi(e){try{const a=await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity`)).json().catch(()=>({}));if(!a.ok)return;T.install[e.guid]=a;const n=document.querySelector(`.mag-card[data-guid="${CSS.escape(e.guid)}"] .mag-install-slot`);n&&(n.innerHTML=uo(e))}catch(t){console.warn("[magnets] install refresh failed:",t)}}async function Ng(e){if(e.status==="DRAFT"){ce("Open Edit and Save to publish a draft magnet.","info");return}const t=e.status==="ENABLED"?"DISABLED":"ENABLED";try{if(!(await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw new Error;ce(t==="ENABLED"?"Magnet enabled":"Magnet disabled","success")}catch{ce("Update failed","danger");return}try{await Bt()}catch(a){console.warn("[magnets] refresh after status toggle failed:",a)}}async function Og(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`)){try{if(!(await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"})).json().catch(()=>({}))).ok)throw new Error;ce("Magnet deleted","success")}catch{ce("Delete failed","danger");return}try{await Bt()}catch(t){console.warn("[magnets] refresh after delete failed:",t)}}}function vn(e){const t=[];return e.querySelectorAll(".mag-cta").forEach(a=>{if(!a.querySelector(".mag-cta__on").checked)return;const n=a.dataset.type,o=a.dataset.kind,s=a.querySelector(".mag-cta__val"),r=s?s.value.trim():"";if(o==="value")if(n==="call"&&a.querySelector(".mag-cta__callsrc")?.value==="callrail"){const i=a.querySelector(".mag-cta__crtracker"),l=i?.value||"",c=i?.selectedOptions?.[0];l&&t.push({type:n,value:l,config:{source:"callrail",...c?.dataset?.trackerId?{tracker_id:c.dataset.trackerId}:{},...c?.dataset?.trackerName?{tracker_name:c.dataset.trackerName}:{}}})}else r&&t.push({type:n,value:r});else if(o==="book")if(a.querySelector(".mag-cta__booksrc")?.value==="calendly"){const i=a.querySelector(".mag-cta__calevent"),l=i?.value||"",c=(i?.selectedOptions?.[0]?.textContent||"").trim();t.push({type:n,config:{source:"calendly",...l?{calendly_url:l}:{},...l&&c?{event_name:c}:{}}})}else{const i={type:n};r&&(/^https?:\/\//i.test(r)?i.value=r:i.config={meeting_label:r}),t.push(i)}else if(o==="support"){const i=(a.querySelector(".mag-cta__opts")?.value||"").split(`
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:Wi(e),actions:t,font:e.querySelector("#mag-f-font").value.trim(),theme_vars:qg(e),inline_width:e.querySelector("#mag-f-inline-w").value.trim(),inline_height:e.querySelector("#mag-f-inline-h").value.trim(),hide_launcher:e.querySelector("#mag-f-hide-launcher").checked,input_placeholder:e.querySelector("#mag-f-input-ph").value,summary_confirm_label:e.querySelector("#mag-f-summary-confirm").value.trim(),success_title:e.querySelector("#mag-f-success-title").value.trim(),success_text:e.querySelector("#mag-f-success-text").value,success_cta:Ug(e)}}const Mg=512,Pg=new Set(["image/png","image/jpeg","image/gif","image/webp"]),Fg=8*1024*1024;function Dg(e){return new Promise((t,a)=>{const n=new Image,o=new FileReader;o.onerror=()=>a(new Error("Could not read that file.")),o.onload=()=>{n.onerror=()=>a(new Error("That file isn’t a readable image.")),n.onload=()=>{const s=Math.min(1,Mg/Math.max(n.naturalWidth,n.naturalHeight)),r=Math.max(1,Math.round(n.naturalWidth*s)),i=Math.max(1,Math.round(n.naturalHeight*s)),l=document.createElement("canvas");l.width=r,l.height=i,l.getContext("2d").drawImage(n,0,0,r,i),t(l.toDataURL("image/png"))},n.src=o.result},o.readAsDataURL(e)})}function Bg(e,t){const a=e.querySelector("#mag-logo-drop");if(!a)return;const n=e.querySelector("#mag-f-logo-file"),o=e.querySelector("#mag-logo-browse"),s=e.querySelector("#mag-logo-remove"),r=e.querySelector("#mag-logo-preview"),i=e.querySelector("#mag-logo-status"),l=e.querySelector("#mag-f-logo"),c=(g,f)=>{i.textContent=g,i.style.color=f?"var(--color-danger, #DD4124)":""},u=g=>{r.innerHTML=g?`<img src="${_(g)}" alt="">`:'<span class="material-symbols-outlined" aria-hidden="true">image</span>',s.hidden=!g},b=g=>{l.value=g,l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))};async function d(g){if(!Pg.has(g.type)){c("PNG, JPEG, GIF, or WEBP only.",!0);return}if(g.size>Fg){c("That file is too large (8MB max before resizing).",!0);return}c("Uploading…",!1);try{const f=await Dg(g),p=await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({image:f})}),v=await p.json().catch(()=>({}));if(!p.ok||!v.ok)throw new Error(v.error||`Upload failed (${p.status})`);const x=`${W()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;b(x),u(x),c("Logo updated.",!1)}catch(f){c(f.message||"Upload failed.",!0)}}n.addEventListener("change",()=>{n.files[0]&&d(n.files[0]),n.value=""}),a.addEventListener("click",g=>{g.target===s||s.contains(g.target)||g.target!==o&&n.click()}),o.addEventListener("click",()=>n.click()),["dragenter","dragover"].forEach(g=>a.addEventListener(g,f=>{f.preventDefault(),a.classList.add("is-dragover")})),["dragleave","drop"].forEach(g=>a.addEventListener(g,f=>{f.preventDefault(),a.classList.remove("is-dragover")})),a.addEventListener("drop",g=>{const f=g.dataTransfer?.files?.[0];f&&d(f)}),s.addEventListener("click",async g=>{g.stopPropagation(),c("Removing…",!1);try{const f=await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"DELETE"}),p=await f.json().catch(()=>({}));if(!f.ok||!p.ok)throw new Error(p.error||`Remove failed (${f.status})`);b(""),u(""),c("Logo removed.",!1)}catch(f){c(f.message||"Remove failed.",!0)}})}function qg(e){return e.querySelector("#mag-f-surface-on")?.checked?{surface:e.querySelector("#mag-f-sv-surface").value,surface_2:e.querySelector("#mag-f-sv-surface2").value,border:e.querySelector("#mag-f-sv-border").value,text:e.querySelector("#mag-f-sv-text").value,text_sub:e.querySelector("#mag-f-sv-textsub").value}:{}}function Ug(e){const t=e.querySelector("#mag-f-success-cta-label").value.trim(),a=e.querySelector("#mag-f-success-cta-url").value.trim();return t&&a?{label:t,url:a}:{}}function Wi(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",s=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==s.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}const Pn=[{label:"Web fonts (loaded for you)",opts:[["Inter, sans-serif","Inter"],["Poppins, sans-serif","Poppins"],["Montserrat, sans-serif","Montserrat"],["Roboto, sans-serif","Roboto"],['"Open Sans", sans-serif',"Open Sans"],["Lato, sans-serif","Lato"],["Nunito, sans-serif","Nunito"],["Raleway, sans-serif","Raleway"],['"Work Sans", sans-serif',"Work Sans"],["Oswald, sans-serif","Oswald"],["Merriweather, serif","Merriweather (serif)"]]},{label:"System / always available",opts:[["system-ui, sans-serif","System UI"],["Georgia, serif","Georgia (serif)"],['"Times New Roman", Times, serif',"Times (serif)"],["Arial, Helvetica, sans-serif","Arial / Helvetica"],["Verdana, Geneva, sans-serif","Verdana"],['"Courier New", monospace',"Courier (mono)"]]}];function zg(e){const t=String(e||""),a=new Set(Pn.flatMap(s=>s.opts.map(([r])=>r))),n=s=>s===t?" selected":"";let o=`<option value=""${t===""?" selected":""}>System default</option>`;t&&!a.has(t)&&(o+=`<option value="${_(t)}" selected>Current: ${_(t)}</option>`);for(const s of Pn)o+=`<optgroup label="${_(s.label)}">`+s.opts.map(([r,i])=>`<option value="${_(r)}"${n(r)}>${_(i)}</option>`).join("")+"</optgroup>";return o}function Ma(e,t,a={}){const{freshDraft:n=!1}=a,o=!!e,s=o?null:crypto.randomUUID(),r=!o&&T.owners.length>1,i=e?.display_mode||"chat",l=e?.theme_mode||"auto",c={};(e?.actions||[]).forEach(S=>{S&&S.type&&(c[S.type]=S)});const u=o?!!e.home:!0,b=o?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",d=e?.theme_vars&&typeof e.theme_vars=="object"?e.theme_vars:{},g=Object.keys(d).length>0,f=(S,V)=>_(/^#[0-9a-fA-F]{6}$/.test(d[S]||"")?d[S]:V),p=document.createElement("div");p.className="mag-modal-scrim",p.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${o?"Edit magnet":"New magnet"}">
      ...
      <div class="mag-modal__main">
        ...
        <input class="mag-modal__input" id="mag-f-name" type="text" placeholder="e.g. Homepage quote magnet" value="${_(e?.name||"")}">

        ${r?`
        <label class="mag-modal__label" for="mag-f-owner">Client / workspace</label>
        <select class="mag-modal__select" id="mag-f-owner">
          ${T.owners.map(S=>`<option value="${_(S.guid)}"${S.guid===T.primaryOrgGuid?" selected":""}>${_(S.name||S.guid)}</option>`).join("")}
        </select>`:""}
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${Bi.map(S=>`<option value="${S.value}"${(e?e.trigger||"none":"on_load")===S.value?" selected":""}>${_(S.label)}</option>`).join("")}
        </select>
        ...
        <input class="mag-modal__input" id="mag-f-domains" type="text" placeholder="example.com, www.example.com" value="${_((e?.domains||[]).join(", "))}">
        ...
        <div class="mag-modal__sec">
          ...
          <div class="mag-modal__row">
            <div>
              ...
              <input class="mag-modal__input" id="mag-f-title" type="text" placeholder="Chat with us" value="${_(e?.title||"")}">
            </div>
            <div style="flex:0 0 auto">
              <label class="mag-modal__label" for="mag-f-color">Color</label>
              <input class="mag-modal__color" id="mag-f-color" type="color" value="${_(/^#[0-9a-fA-F]{6}$/.test(e?.theme_color||"")?e.theme_color:"#0072BA")}">
            </div>
          </div>

          <label class="mag-modal__label" for="mag-f-subtitle">Subtitle</label>
          <input class="mag-modal__input" id="mag-f-subtitle" type="text" placeholder="Typically replies in a few minutes" value="${_(b)}">
          ...
          <input class="mag-modal__input" id="mag-f-launcher" type="text" placeholder="Defaults to the title" value="${_(e?.launcher_label||"")}">
          ...
          <div class="mag-logo-drop" id="mag-logo-drop">
            ...
            <div class="mag-logo-drop__preview" id="mag-logo-preview">${e?.logo_url?`<img src="${_(e.logo_url)}" alt="">`:'<span class="material-symbols-outlined" aria-hidden="true">image</span>'}</div>
          ...
          <input class="mag-modal__input" id="mag-f-logo" type="text" placeholder="https://…/logo.png" value="${_(e?.logo_url||"")}">
          ...
          <select class="mag-modal__select" id="mag-f-font">${zg(e?.font||"")}</select>
          ...
          <div class="mag-tog-row" style="margin-top:12px">
            <input type="checkbox" id="mag-f-surface-on"${g?" checked":""}>
            <label for="mag-f-surface-on">Custom surface colors (match a branded dark or light page)</label>
          </div>
          <div id="mag-f-surface" class="mag-surface-grid"${g?"":" hidden"}>
          ...
          <div id="mag-f-inline-size"${i==="inline"?"":" hidden"}>
            <div class="mag-modal__row">
              <div>
                ...
                <input class="mag-modal__input" id="mag-f-inline-w" type="text" placeholder="640px" value="${_(e?.inline_width||"")}">
              </div>
              <div>
                <label class="mag-modal__label" for="mag-f-inline-h">Inline height</label>
                <input class="mag-modal__input" id="mag-f-inline-h" type="text" placeholder="min(520px, 80vh)" value="${_(e?.inline_height||"")}">
              </div>
            </div>
          ...
          <input class="mag-modal__input" id="mag-f-input-ph" type="text" placeholder="Type your answer…" value="${_(e?.input_placeholder||"")}">
        </div>
          </section>
        ...
        <div class="mag-modal__sec">
          ...
          <textarea class="mag-modal__input" id="mag-f-welcome" rows="2" placeholder="Welcome! Pick an option below and we’ll take it from there.">${_(e?.welcome||"")}</textarea>
        ...
        <div class="mag-modal__sec">
          ...
          <div class="mag-modal__row">
            <div>
              ...
              <input class="mag-modal__input" id="mag-f-ab-title" type="text" placeholder="(unchanged)" value="${_(e?.ab?.b?.mag_title||"")}">
            </div>
            <div style="flex:0 0 auto">
              <label class="mag-modal__label" for="mag-f-ab-color">B: Color</label>
              <input class="mag-modal__color" id="mag-f-ab-color" type="color" value="${_(/^#[0-9a-fA-F]{6}$/.test(e?.ab?.b?.mag_theme_color||"")?e.ab.b.mag_theme_color:e?.theme_color||"#0072BA")}">
            </div>
          </div>
          <label class="mag-modal__label" for="mag-f-ab-welcome">B: Welcome message</label>
          <textarea class="mag-modal__input" id="mag-f-ab-welcome" rows="2" placeholder="(unchanged)">${_(e?.ab?.b?.mag_welcome||"")}</textarea>
        ...
        <div class="mag-modal__sec">
          ...
          <input class="mag-modal__input" id="mag-f-summary-heading" type="text" placeholder="Here’s what we’ve got" value="${_(e?.summary_heading||"")}">
          <label class="mag-modal__label" for="mag-f-summary-confirm">Confirm button label</label>
          <input class="mag-modal__input" id="mag-f-summary-confirm" type="text" placeholder="Confirm &amp; send" value="${_(e?.summary_confirm_label||"")}">
        </div>
        ...
        <div class="mag-modal__sec">
          ...
          <input class="mag-modal__input" id="mag-f-success-title" type="text" placeholder="You’re all set!" value="${_(e?.success_title||"")}">
          <label class="mag-modal__label" for="mag-f-success-text">Success message</label>
          <textarea class="mag-modal__input" id="mag-f-success-text" rows="2" placeholder="Thanks! We’ve got your details and someone will be in touch shortly.">${_(e?.success_text||"")}</textarea>
          <div class="mag-modal__row">
            <div>
              <label class="mag-modal__label" for="mag-f-success-cta-label">Button label (optional)</label>
              <input class="mag-modal__input" id="mag-f-success-cta-label" type="text" placeholder="e.g. Visit our site" value="${_(e?.success_cta?.label||"")}">
            </div>
            <div>
              <label class="mag-modal__label" for="mag-f-success-cta-url">Button link</label>
              <input class="mag-modal__input" id="mag-f-success-cta-url" type="text" placeholder="https://…" value="${_(e?.success_cta?.url||"")}">
            </div>
          </div>
    ...
    </div>`,document.body.appendChild(p),requestAnimationFrame(()=>{p.classList.add("open"),p.querySelector(".mag-modal").classList.add("open")});const v=[...p.querySelectorAll(".mag-modal__navitem")],x=[...p.querySelectorAll(".mag-tab")],w=S=>{v.forEach(V=>V.classList.toggle("is-active",V.dataset.tab===S)),x.forEach(V=>{V.hidden=V.dataset.tab!==S}),p.querySelector(".mag-modal__body").scrollTop=0};v.forEach(S=>S.addEventListener("click",()=>w(S.dataset.tab)));const $=()=>Na({...e,...vn(p),...o?{steps:vs()}:{}}),O=p.querySelector("#mag-preview-pane"),U=()=>window.matchMedia("(min-width: 1200px)").matches;let I=null;const j=()=>{if(!I&&U())try{I=Vm(O,$)}catch{}};let X=null;const J=()=>{U()&&(j(),I&&(clearTimeout(X),X=setTimeout(()=>{try{I.refresh()}catch{}},300)))},ae=window.matchMedia("(min-width: 1200px)"),ge=()=>{U()&&(j(),J())};ae.addEventListener("change",ge);let B=!1,le=!1;const H=p.querySelector("#mag-f-dirty"),Z=S=>{B=S,H&&(H.hidden=!S)},ot=p.querySelector(".mag-modal__main");ot.addEventListener("input",()=>Z(!0)),ot.addEventListener("change",()=>{Z(!0),J()}),p.querySelector("#mag-f-color")?.addEventListener("input",()=>{Z(!0),J()});const st=S=>{B&&(S.preventDefault(),S.returnValue="")};window.addEventListener("beforeunload",st);let qt=!0;const tn=m.subscribe(h.ROUTE_NAV_BEFORE,()=>{if(qt){if(B&&!confirm("Discard your changes to this magnet?")){window.router?.navigate("/magnets");return}y()}}),y=()=>{if(n&&!le&&e&&e.status==="DRAFT"){fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"}).catch(()=>{}),T.magnets=T.magnets.filter(V=>V.guid!==e.guid);const S=document.getElementById("mag-body");S&&(S.innerHTML=`<div class="mag-grid">${T.magnets.map(mo).join("")}</div>`)}qt=!1,window.removeEventListener("beforeunload",st),m.unsubscribe(tn),clearTimeout(X),ae.removeEventListener("change",ge),I&&I.destroy&&I.destroy(),p.classList.remove("open"),setTimeout(()=>p.remove(),180),document.removeEventListener("keydown",P)},A=()=>{B&&!confirm("Discard your changes to this magnet?")||y()};function P(S){S.key==="Escape"&&(S.preventDefault(),A())}document.addEventListener("keydown",P),p.querySelector(".mag-modal__close").addEventListener("click",A),p.querySelector('[data-x="cancel"]').addEventListener("click",A),p.querySelector("[data-close-modal]")?.addEventListener("click",A),p.querySelector("#mag-f-name").focus();const K=p.querySelector("#mag-flow-panel");o?Bm(K,e,()=>{Z(!0),J()}):K.innerHTML='<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>',Bg(p,e),t&&w(t),j(),p.querySelectorAll(".mag-cta").forEach(S=>{const V=S.querySelector(".mag-cta__on"),be=S.querySelector(".mag-cta__val"),pe=S.querySelector(".mag-cta__opts"),He=S.querySelectorAll(".mag-cta__booksrc, .mag-cta__calevent, .mag-cta__callsrc, .mag-cta__crtracker");V.addEventListener("change",()=>{be&&(be.disabled=!V.checked),pe&&(pe.disabled=!V.checked),He.forEach(ee=>{ee.disabled=!V.checked}),V.checked&&(be||pe)?.focus()}),be&&be.addEventListener("input",()=>{be.value.trim()&&!V.checked&&(V.checked=!0,pe&&(pe.disabled=!1))})}),p.querySelectorAll('.mag-cta[data-kind="book"]').forEach(S=>{const V=S.querySelector(".mag-cta__booksrc"),be=S.querySelector(".mag-cta__val"),pe=S.querySelector(".mag-cta__calevent");if(!V||!pe)return;const He=()=>{const ee=V.value==="calendly";be.hidden=ee,pe.hidden=!ee,ee&&!pe.dataset.listed&&(pe.dataset.listed="1",og(pe))};V.addEventListener("change",()=>{const ee=S.querySelector(".mag-cta__on");ee.checked||(ee.checked=!0,ee.dispatchEvent(new Event("change"))),He()}),He()}),p.querySelectorAll('.mag-cta[data-type="call"]').forEach(S=>{const V=S.querySelector(".mag-cta__callsrc"),be=S.querySelector(".mag-cta__val"),pe=S.querySelector(".mag-cta__crtracker");if(!V||!pe)return;const He=()=>{const ee=V.value==="callrail";be.hidden=ee,pe.hidden=!ee,ee&&!pe.dataset.listed&&(pe.dataset.listed="1",rg(pe))};V.addEventListener("change",()=>{const ee=S.querySelector(".mag-cta__on");ee.checked||(ee.checked=!0,ee.dispatchEvent(new Event("change"))),He()}),He()});const z=p.querySelector("#mag-f-surface-on"),Le=p.querySelector("#mag-f-surface");z.addEventListener("change",()=>Le.hidden=!z.checked);const rt=p.querySelector("#mag-f-inline-size");p.querySelectorAll('input[name="mag-display"]').forEach(S=>S.addEventListener("change",()=>{rt.hidden=p.querySelector('input[name="mag-display"]:checked')?.value!=="inline"})),p.querySelector('[data-x="preview"]')?.addEventListener("click",()=>co(()=>Na({...e,...vn(p),...o?{steps:vs()}:{}}))),p.querySelector('[data-x="save"]').addEventListener("click",async S=>{const V=S.currentTarget,be=p.querySelector("#mag-f-error"),pe=p.querySelector("#mag-f-name").value.trim();if(!pe){w("basics"),be.textContent="Please give your magnet a name.";return}const He=p.querySelector("#mag-f-domains").value.split(",").map(oe=>oe.trim()).filter(Boolean);let ee="";if(p.querySelectorAll(".mag-cta").forEach(oe=>{const At=oe.querySelector(".mag-cta__on").checked;if(oe.dataset.kind==="book"){const zt=oe.querySelector(".mag-cta__booksrc")?.value==="calendly";At&&zt&&!oe.querySelector(".mag-cta__calevent")?.value&&(ee=ee||"Pick a Calendly event for the Book button, or switch it back to the built-in scheduler.");return}if(oe.dataset.kind!=="value")return;if(oe.dataset.type==="call"&&oe.querySelector(".mag-cta__callsrc")?.value==="callrail"){At&&!oe.querySelector(".mag-cta__crtracker")?.value&&(ee=ee||"Pick a CallRail tracking number for the Call button, or switch it back to a phone number.");return}const Ut=oe.querySelector(".mag-cta__val").value.trim();At&&!Ut&&(ee=ee||`Add a target for the ${po[oe.dataset.type].label} button, or uncheck it.`)}),ee){w("welcome"),be.textContent=ee;return}const vo=Wi(p);if(vo.enabled&&!Object.keys(vo.b).length){w("ab"),be.textContent="Give variant B at least one change (title, welcome, or color), or untick the A/B test.";return}if(o){const oe=Um();if(oe){w("flow"),be.textContent=oe.message,zm(oe.route,oe.message,{uid:oe.uid,field:oe.field});return}}const an={name:pe,domains:He,...vn(p)};r&&(an.owner_guid=p.querySelector("#mag-f-owner").value);const bo=o&&e.status==="DRAFT";bo&&(an.status="ENABLED"),V.disabled=!0,be.textContent="";try{const oe=o?`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${W()}/m5t/v5/magnets`,At={"Content-Type":"application/json"};s&&(At["Idempotency-Key"]=s);const Ut=await fetch(oe,{method:o?"PATCH":"POST",headers:At,body:JSON.stringify(an)});let zt={};try{zt=await Ut.json()}catch{}if(!Ut.ok||!zt.ok)throw new Error(zt.message||`Save failed (${Ut.status})`);o&&await jm(e.guid),ce(bo||!o?"Magnet created":"Magnet updated","success"),le=!0,y(),await Bt()}catch(oe){V.disabled=!1,be.textContent=oe.message||"Something went wrong."}})}const Hg=Object.freeze(Object.defineProperty({__proto__:null,CTA_META:po,CTA_ORDER:qi,DISPLAY_OPTS:Fi,FONT_GROUPS:Pn,MODE_LABEL:Pi,THEME_OPTS:Di,TRIGGER_OPTS:Bi,cspNoteHTML:Mi,init:xg,openModal:Ma,render:wg,stepFunnelHTML:Gi},Symbol.toStringTag,{value:"Module"})),jg={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ks=e=>String(e??"").replace(/[&<>"']/g,t=>jg[t]),Gg=["provision_magnets","manage_magnets"],Vg=()=>E.getCapabilities().some(e=>Gg.includes(e));function Wg(){const e=new Map;for(const t of at)e.set(t.category,(e.get(t.category)||0)+1);return Object.keys(Li).filter(t=>e.has(t)).map(t=>[t,e.get(t)])}const As=(e,t,a,n)=>`<button class="m5t-chip--filter" type="button" data-cat="${ks(e)}" aria-pressed="${n}">${ks(t)}<span class="m5t-chip__count">${a}</span></button>`;let Ss=!1;function Yg(){if(Ni(),Ss)return;const e=document.createElement("style");e.id="m5t-templates-page-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ss=!0}function Yi(){Yg();const e=Vg();return`
    <div class="page-shell" data-section="templates">
      ...
      <div class="m5t-chip-row tpl-filters" id="tpl-filters" role="group" aria-label="Filter templates by category">
        ${As("all","All",at.length,"true")}
        ${Wg().map(([t,a])=>As(t,Li[t],a,"false")).join("")}
      </div>

      <div class="mag-tpl-grid mag-tpl-grid--page" id="tpl-grid">
        ${at.map(t=>Ii(t,{detail:!0,gallery:!0,canUse:e})).join("")}
      </div>
    </div>`}function Ki(){const e=document.getElementById("tpl-grid");document.getElementById("tpl-filters")?.addEventListener("click",t=>{const a=t.target.closest("[data-cat]");if(!a)return;a.parentElement.querySelectorAll("[data-cat]").forEach(o=>{o.setAttribute("aria-pressed",String(o===a))});const n=a.dataset.cat;e?.querySelectorAll(".mag-tpl-card").forEach(o=>{o.hidden=!(n==="all"||o.dataset.cat===n)})}),e?.addEventListener("click",t=>{const a=t.target.closest("[data-preview]");if(a){const o=at.find(s=>s.id===a.dataset.preview);o&&co(()=>Na({...o.appearance,steps:o.steps,name:o.name}));return}const n=t.target.closest("[data-tpl]");n&&(Jm(n.dataset.tpl),window.location.hash="#/magnets")})}const Kg={render:Yi,init:Ki},Xg=Object.freeze(Object.defineProperty({__proto__:null,default:Kg,init:Ki,render:Yi},Symbol.toStringTag,{value:"Module"})),Jg={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Me=e=>String(e??"").replace(/[&<>"']/g,t=>Jg[t]),Fn=()=>E.getConfig?.().BASE_URL||"",Cs=(e,t="info")=>{try{m.publish(h.UI_TOAST,{message:e,type:t})}catch{}},Qg="managed_client",Dn=[["ALL","All"],["NOT_SENT","Not sent"],["DRAFT","Awaiting response"],["SUBMITTED","Submitted"],["CANCELLED","Cancelled"]],Xi=Object.fromEntries(Dn),ve={clients:[],responses:[],filter:"ALL",search:"",openGuid:null};let Ts=!1;function Zg(){if(Qn(),Ts)return;const e=document.createElement("style");e.id="m5t-questionnaires-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ts=!0}const oa=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function ho(){return ve.clients.map(e=>{const t=ve.responses.filter(n=>n.owner_guid===e.guid),a=t[0]||null;return{guid:e.guid,name:e.caption||e.name||e.guid,latest:a,earlier:Math.max(0,t.length-1),status:a?a.status:"NOT_SENT"}})}function Ji(){const e=ve.search.trim().toLowerCase();return ho().filter(t=>(ve.filter==="ALL"||t.status===ve.filter)&&(!e||t.name.toLowerCase().includes(e)))}const $s=(e,t)=>e?.latest?.[t]?Ye(e.latest[t]):"—";function Qi(e){const t=e.status==="SUBMITTED",a=e.status==="SUBMITTED"?`<button class="qz-act" type="button" data-act="open" data-guid="${Me(e.latest.guid)}">Read answers</button>`:e.status==="DRAFT"?`<button class="qz-act" type="button" data-act="copy" data-url="${Me(e.latest.url||"")}">Copy link</button>`:'<a class="qz-act" href="#/clients">Go to client</a>';return`<tr class="${t?"qz-row--open":""}"${t?` data-open-guid="${Me(e.latest.guid)}"`:""}>
    <td><span class="qz-client">${Me(e.name)}</span>${e.earlier?`<span class="qz-earlier">${e.earlier} earlier</span>`:""}</td>
    <td><span class="qz-badge" data-s="${Me(e.status)}">${Me(Xi[e.status]||e.status)}</span></td>
    <td class="qz-when">${Me($s(e,"created_tz"))}</td>
    <td class="qz-when">${Me($s(e,"submitted_tz"))}</td>
    <td class="qz-actcell">${a}</td>
  </tr>`}function Zi(){return Zg(),`
    <div class="page-shell" data-section="questionnaires">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="qz-body">${oa("hourglass_empty","Loading…")}</div>
      </div>
    </div>`}async function el(){await eh()}async function eh(){const e=document.getElementById("qz-body");if(e){try{const[t,a]=await Promise.all([fetch(`${Fn()}/m5t/v5/acctGroup`),fetch(`${Fn()}/m5t/v5/m5mQuestionnaireResponse`)]),n=await t.json().catch(()=>({})),o=await a.json().catch(()=>({}));if(!t.ok||!a.ok)throw new Error("load failed");ve.clients=(n.data||[]).filter(s=>s.class===Qg&&!["DELETED","ARCHIVED"].includes(s.status)).sort((s,r)=>String(s.caption||"").localeCompare(String(r.caption||""))),ve.responses=o.data||[]}catch{e.innerHTML=oa("error","Could not load questionnaires. Please try again.");return}tl()}}function tl(){const e=document.getElementById("qz-body");if(!e)return;if(!ve.clients.length){e.innerHTML=oa("groups","No clients yet. Add a client first, then send them a kickoff questionnaire.");return}const t=ho(),a={ALL:t.length};Dn.slice(1).forEach(([o])=>{a[o]=t.filter(s=>s.status===o).length});const n=Ji();e.innerHTML=`
    <div class="qz-bar">
      <div class="qz-filter">
        ${Dn.map(([o,s])=>`<button data-filter="${o}" class="${ve.filter===o?"active":""}">${Me(s)}${a[o]?`<span class="qz-pillnum">${a[o]}</span>`:""}</button>`).join("")}
      </div>
      <span class="qz-searchwrap">
        <span class="material-symbols-outlined" aria-hidden="true">search</span>
        <input class="qz-search" id="qz-search" type="search" placeholder="Search clients" value="${Me(ve.search)}" aria-label="Search clients" />
      </span>
    ...
    <div class="qz-tablewrap">
      <table class="qz-table">
        ...
        <tbody id="qz-tbody">${n.length?n.map(Qi).join(""):`<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">${ve.search.trim()?"No clients match your search.":`No clients with status “${Me(Xi[ve.filter]||ve.filter)}”.`}</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".qz-filter")?.addEventListener("click",o=>{const s=o.target.closest("[data-filter]");s&&(ve.filter=s.dataset.filter,tl())}),e.querySelector("#qz-search")?.addEventListener("input",o=>{ve.search=o.target.value,th()}),e.querySelector("#qz-tbody")?.addEventListener("click",ah)}function th(){const e=document.getElementById("qz-tbody");if(!e)return;const t=Ji();e.innerHTML=t.length?t.map(Qi).join(""):'<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">No clients match your search.</div></td></tr>';const a=document.querySelector(".qz-count");a&&(a.textContent=`${t.length} of ${ho().length}`)}function ah(e){const t=e.target.closest('[data-act="copy"]');if(t){e.stopPropagation();const s=t.dataset.url;if(!s){Cs("No link on this questionnaire yet.","warning");return}navigator.clipboard?.writeText(s).then(()=>{t.textContent="Copied!",setTimeout(()=>{t.textContent="Copy link"},1500)},()=>Cs("Could not copy the link.","error"));return}const a=e.target.closest('[data-act="open"]'),n=e.target.closest("[data-open-guid]"),o=a?.dataset.guid||n?.dataset.openGuid;o&&nh(o)}async function nh(e){ve.openGuid=e;const t=document.createElement("div");t.className="qz-drawer-scrim";const a=document.createElement("aside");a.className="qz-drawer",a.setAttribute("role","dialog"),a.setAttribute("aria-label","Questionnaire answers"),a.innerHTML=`
    ...
    <div class="qz-drawer__body" id="qz-dbody">${oa("hourglass_empty","Loading answers…")}</div>`,document.body.append(t,a),requestAnimationFrame(()=>{t.classList.add("open"),a.classList.add("open")});const n=()=>{ve.openGuid=null,t.classList.remove("open"),a.classList.remove("open"),setTimeout(()=>{t.remove(),a.remove()},220),document.removeEventListener("keydown",o)};function o(s){s.key==="Escape"&&(s.preventDefault(),n())}document.addEventListener("keydown",o),t.addEventListener("click",n),a.querySelector(".qz-drawer__close").addEventListener("click",n);try{const s=await fetch(`${Fn()}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e)}`),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.error||"load failed");const i=r.data||{},l=ve.clients.find(u=>u.guid===i.owner_guid)?.caption||"Client";a.querySelector("#qz-dtitle").textContent=l;const c=i.submitted_tz?`Submitted ${Ye(i.submitted_tz)}`:"Not yet submitted";a.querySelector("#qz-dsub").textContent=i.locked_tz?`${c} · Finalized`:c,a.querySelector("#qz-dbody").innerHTML=Jn(i)+Xn(i,{emptyLabel:"Not answered"})}catch{a.querySelector("#qz-dbody").innerHTML=oa("error","Could not load these answers. Please try again.")}}const oh={render:Zi,init:el},sh=Object.freeze(Object.defineProperty({__proto__:null,default:oh,init:el,render:Zi},Symbol.toStringTag,{value:"Module"}));let Ls=!1;const k={leads:[],magnetNames:{},filter:"ALL",canManage:!1,book:!1,ownerNames:{},clientFilter:"ALL",search:"",shown:100,selectedId:null,day:""},ut=100,Bn=["NEW","WORKING","QUALIFIED","UNQUALIFIED","CONVERTED","EXPORTED"],rh={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},F=e=>String(e??"").replace(/[&<>"']/g,t=>rh[t]),Pa=(e,t="info")=>{try{m.publish(h.UI_TOAST,{message:e,type:t})}catch{}},Fa=()=>E.getConfig?.().BASE_URL||"",Da=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",al=e=>(Da(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase(),en=e=>e.created?.created_tz||"";function Rt(e){const t=en(e);if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric"})}catch{return""}}function ih(e){const t=en(e);if(!t)return"";try{const a=Date.now()-new Date(t).getTime();if(a<0)return Rt(e);const n=a/36e5;return n<1?`${Math.max(1,Math.floor(a/6e4))}m ago`:n<24?`${Math.floor(n)}h ago`:n<48?"Yesterday":Rt(e)}catch{return Rt(e)}}const lh=e=>{const t=en(e);if(!t)return!1;try{return Date.now()-new Date(t).getTime()<24*36e5}catch{return!1}};function ch(){if(Ls)return;const e=document.createElement("style");e.id="m5t-leads-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ls=!0}function sa(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function dh(e){return`<select class="leads-status" data-id="${F(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${Bn.map(t=>`<option value="${t}" ${e.status===t?"selected":""}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join("")}
  </select>`}function ph(e){const t=k.magnetNames[e.magnet_guid]||e.lead_source||"—",a=e.phone?String(e.phone).replace(/[^\d+]/g,""):"";return`
    <tr class="leads-row${String(e.id)===k.selectedId?" selected":""}" data-id="${F(e.id)}" tabindex="0" role="button" aria-label="Open lead ${F(Da(e))}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${F(al(e))}</span>
          <span><span class="leads-name">${F(Da(e))}</span>${e.company?`<span class="leads-sub">${F(e.company)}</span>`:""}</span>
        </span>
      </td>
      ${k.book?`<td>${$r(k.ownerNames[e.owner_guid]||"")||'<span class="leads-muted">—</span>'}</td>`:""}
      <td>
      ...
      <td>${k.canManage?dh(e):`<span class="leads-badge" data-s="${F(e.status)}">${F(e.status)}</span>`}</td>
      <td class="num leads-muted" style="white-space:nowrap" title="${F(Rt(e))}">${lh(e)?'<span class="leads-fresh" title="Captured in the last 24 hours"></span>':""}${F(ih(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}const nl=e=>k.clientFilter==="ALL"||e.owner_guid===k.clientFilter;function uh(e){const t=k.search.trim().toLowerCase();if(!t)return!0;const a=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,k.magnetNames[e.magnet_guid],k.book?k.ownerNames[e.owner_guid]:"",e.utm_campaign,e.utm_source].filter(Boolean).join(" ").toLowerCase();return t.split(/\s+/).every(n=>a.includes(n))}const mh=e=>!k.day||en(e).slice(0,10)===k.day;function ol(){return k.leads.filter(e=>(k.filter==="ALL"||e.status===k.filter)&&nl(e)&&uh(e)&&mh(e))}function gh(){if(!k.day)return"";let e=k.day;try{e=new Date(`${k.day}T00:00:00Z`).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric",timeZone:"UTC"})}catch{}return`<button class="leads-daychip" type="button" id="leads-dayclear" title="Show every day again">
  ...
  </button>`}const sl=()=>sa("touch_app","Click to see lead information.");function hh(){ch(),xt();const e=ie();return`
      ...
      <div class="leads-layout">
        <div class="dashboard-card">
          <div class="card-body" id="leads-body">
            ${sa("hourglass_empty","Loading leads…")}
          </div>
        </div>
        <aside class="dashboard-card leads-panel" aria-label="Lead detail">
          <div class="card-body" id="leads-panel-body">${sl()}</div>
        </aside>
      </div>
    </div>`}async function fh(){document.getElementById("leads-export")?.addEventListener("click",yh);const e=An(bt.LEADS_SEARCH),t=An(bt.LEADS_DAY);if((e||t)&&(k.search=e||"",k.day=t||"",k.filter="ALL",k.clientFilter="ALL",k.shown=ut),ie()){const a=n=>Number(n||0).toLocaleString();nt(Fa(),[{h:"Leads · wk",td:n=>a(n.leads.this_week)},{h:"Leads · total",td:n=>a(n.leads.total)},{h:"Compl.",td:n=>n.completion_rate!=null?`${n.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await vh()}async function vh(){const e=document.getElementById("leads-body");if(e){try{const[t,a]=await Promise.all([fetch(`${Fa()}/m5t/v5/m5mLead`),fetch(`${Fa()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(k.leads=(n.data||[]).filter(o=>!["DELETED","ARCHIVED"].includes(o.status)),k.book=ie(),k.ownerNames=k.book?Tr():{},a){const o=await a.json().catch(()=>({}));k.magnetNames={},(o.magnets||[]).forEach(s=>{k.magnetNames[s.guid]=s.name,s.owner_guid&&s.owner_name&&!k.ownerNames[s.owner_guid]&&(k.ownerNames[s.owner_guid]=s.owner_name)}),k.canManage=!!o.canManage}}catch{e.innerHTML=sa("error","Could not load your leads. Please try again.");return}Xt()}}const bh=()=>`
  <colgroup>
    <col style="width:22%">
  ...
  </colgroup>`;function Xt(){const e=document.getElementById("leads-body"),t=document.getElementById("leads-export");if(!e)return;if(t&&(t.style.display=k.leads.length?"":"none"),!k.leads.length){e.innerHTML=sa("inbox","No leads captured yet. Publish a magnet and share it to start collecting.");return}const a=k.leads.filter(nl),n={ALL:a.length};Bn.forEach(s=>{n[s]=a.filter(r=>r.status===s).length});const o=k.book?[...new Set(k.leads.map(s=>s.owner_guid).filter(Boolean))].map(s=>({guid:s,name:k.ownerNames[s]||s})).sort((s,r)=>s.name.localeCompare(r.name)):[];e.innerHTML=`
    <div class="leads-bar">
      ...
      <select class="leads-clientsel" id="leads-clientsel" aria-label="Filter by client">
        ...
        ${o.map(s=>`<option value="${F(s.guid)}" ${k.clientFilter===s.guid?"selected":""}>${F(s.name)}</option>`).join("")}
      </select>`:""}
      ${gh()}
      <span class="leads-searchwrap">
        <span class="material-symbols-outlined" aria-hidden="true">search</span>
        <input class="leads-search" id="leads-search" type="search" placeholder="Search leads" value="${F(k.search)}" aria-label="Search leads" />
      </span>
      <span class="leads-count" id="leads-countlbl"></span>
    </div>
    <div id="leads-tablezone"></div>`,e.querySelector(".leads-filter")?.addEventListener("click",s=>{const r=s.target.closest("[data-filter]");r&&(k.filter=r.dataset.filter,k.shown=ut,Xt())}),e.querySelector("#leads-clientsel")?.addEventListener("change",s=>{k.clientFilter=s.target.value,k.shown=ut,Xt()}),e.querySelector("#leads-dayclear")?.addEventListener("click",()=>{k.day="",k.shown=ut,Xt()}),e.querySelector("#leads-search")?.addEventListener("input",s=>{k.search=s.target.value,k.shown=ut,qn()}),qn()}function qn(){const e=document.getElementById("leads-tablezone"),t=document.getElementById("leads-countlbl");if(!e)return;const a=ol(),n=a.slice(0,k.shown),o=k.book?8:7;t&&(t.textContent=`${a.length} of ${k.leads.length}`),e.innerHTML=`
    <div class="leads-tablewrap">
      <table class="leads-table${k.book?" leads-table--book":""}">
        ...
        <tbody id="leads-tbody">${n.map(ph).join("")||`<tr><td colspan="${o}"><div class="leads-muted" style="padding:14px 4px">${k.search.trim()?"No leads match your search.":`No ${k.filter.toLowerCase()} leads.`}</div></td></tr>`}</tbody>
      </table>
    </div>
    ${a.length>k.shown?`<button class="leads-more" type="button" id="leads-more">Show ${Math.min(ut,a.length-k.shown)} more (${a.length-k.shown} remaining)</button>`:""}`,e.querySelector("#leads-more")?.addEventListener("click",()=>{k.shown+=ut,qn()}),e.querySelector("#leads-tbody")?.addEventListener("change",_h),e.querySelector("#leads-tbody")?.addEventListener("click",s=>{if(s.target.closest(".leads-status, a.leads-contactlink"))return;const r=s.target.closest(".leads-row");r&&Is(r.dataset.id)}),e.querySelector("#leads-tbody")?.addEventListener("keydown",s=>{if(s.key!=="Enter"&&s.key!==" ")return;const r=s.target.closest(".leads-row");r&&s.target===r&&(s.preventDefault(),Is(r.dataset.id))})}async function _h(e){const t=e.target.closest(".leads-status");if(!t)return;const a=t.dataset.id,n=k.leads.find(r=>String(r.id)===String(a)),o=t.value,s=n?.status;try{if(!(await(await fetch(`${Fa()}/m5t/v5/m5mLead/${encodeURIComponent(a)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:o})})).json().catch(()=>({}))).ok)throw new Error;n&&(n.status=o),Pa(`Marked ${o[0]}${o.slice(1).toLowerCase()}`,"success")}catch{t.value=s||"NEW",Pa("Could not update status","danger");return}try{String(a)===k.selectedId&&ll(),k.filter!=="ALL"&&Xt()}catch(r){console.warn("[leads] re-render after status change failed:",r)}}function Is(e){k.selectedId=String(e),document.querySelectorAll(".leads-row").forEach(t=>t.classList.toggle("selected",t.dataset.id===k.selectedId)),ll()}function ma(e,t){const a=Array.isArray(e.tags)?e.tags:[];for(let n=a.length-1;n>=0;n--)if(a[n]&&a[n].tag===t&&a[n].value!=null)return String(a[n].value);return""}function rl(e){const t=ma(e,"appointment_start");if(!t)return null;const a=ma(e,"appointment_status")||"booked",n=ma(e,"appointment_timezone"),o=ma(e,"appointment_event_type"),s=new Date(t);let r=t;if(!Number.isNaN(s.getTime())){const i={weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"};try{r=new Intl.DateTimeFormat(void 0,n?{...i,timeZone:n}:i).format(s)}catch{r=new Intl.DateTimeFormat(void 0,i).format(s)}}return{when:r,status:a,type:o,start:t}}const Rs={booked:["QUALIFIED","Booked"],rescheduled:["WORKING","Rescheduled"],canceled:["CANCELED","Canceled"]};function il(e){const t=Array.isArray(e.tags)?e.tags:[];let a=null;for(const l of t)if(!(!l||!l.tag)){if(l.tag==="callrail_call_id"){a={};continue}a&&l.tag.indexOf("call_")===0&&l.value!=null&&(a[l.tag]=String(l.value))}if(!a||!a.call_started)return null;const n=a.call_started,o=new Date(n);let s=n;Number.isNaN(o.getTime())||(s=new Intl.DateTimeFormat(void 0,{weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"}).format(o));const r=Number(a.call_duration)||0,i=r?r<60?`${r}s`:`${Math.floor(r/60)}m ${r%60}s`:"";return{when:s,dur:i,source:a.call_source||"",answered:a.call_answered||"",recording:a.call_recording_player||"",started:n}}function ll(){const e=document.getElementById("leads-panel-body");if(!e)return;const t=k.leads.find(l=>String(l.id)===k.selectedId);if(!t){e.innerHTML=sl();return}const a=k.magnetNames[t.magnet_guid]||t.lead_source||"—",n=rl(t),[o,s]=n?Rs[n.status]||Rs.booked:["",""],r=il(t),i=(l,c)=>c?`<div class="leads-det__field"><span class="leads-det__k">${F(l)}</span><span class="leads-det__v">${F(c)}</span></div>`:"";e.innerHTML=`
    <div class="leads-det__head">
      <span class="leads-avatar leads-det__ava">${F(al(t))}</span>
      <div>
        <div class="leads-det__name">${F(Da(t))}</div>
    ...
    ${t.description?`<div class="leads-det__notes">${F(t.description)}</div>`:""}`}function yh(){const e=ol();if(!e.length){Pa("Nothing to export","info");return}const t=["first_name","last_name","email","phone","company","product_interest","lead_source","utm_source","utm_medium","utm_campaign","gclid","status"],a=l=>`"${String(l??"").replace(/"/g,'""')}"`,o=[[...k.book?["client"]:[],...t,"magnet","captured","appointment","last_call"].join(",")];for(const l of e){const c=rl(l),u=il(l);o.push([...k.book?[a(k.ownerNames[l.owner_guid]||"")]:[],...t.map(b=>a(l[b])),a(k.magnetNames[l.magnet_guid]||l.lead_source||""),a(Rt(l)),a(c?`${c.start} (${c.status})`:""),a(u?`${u.started} (${u.answered==="no"?"missed":"answered"})`:"")].join(","))}const s=new Blob([o.join(`
`)],{type:"text/csv"}),r=URL.createObjectURL(s),i=document.createElement("a");i.href=r,i.download=`leads-${k.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r),Pa(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const wh=Object.freeze(Object.defineProperty({__proto__:null,init:fh,render:hh},Symbol.toStringTag,{value:"Module"})),cl=()=>E.getConfig?.().BASE_URL||"",Ns=e=>e.toISOString().slice(0,10),We=e=>Number(e||0).toLocaleString(),xh={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ga=e=>String(e??"").replace(/[&<>"']/g,t=>xh[t]),Jt=e=>e==null?"—":`${e}%`,Eh=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let Ba=30,Os=!1;function dl(){if(Os)return;const e=document.createElement("style");e.id="m5t-analytics-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Os=!0}const Aa=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,ha=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
  ...
  </div>`;function kh(e,t){const a=t>0?Math.round(e/t*100):0;return`<svg class="anl-bar" width="72" height="8" viewBox="0 0 72 8" role="img"
    ...
    </svg>`}const Ms={DRAFT:"Draft",DISABLED:"Paused"};function Ah(e,t,a){const n=Ms[e.status]?`<span class="anl-chip">${ga(Ms[e.status])}</span>`:"",o=a&&e.owner_name?`<span class="anl-sub">${ga(e.owner_name)}</span>`:"",s=e.ab_tests&&(e.ab_tests.running||e.ab_tests.completed)?`${We(e.ab_tests.running)} / ${We(e.ab_tests.completed)}`:"—";return`<tr data-guid="${ga(e.magnet_guid)}">
    <td><a class="anl-name" href="#/magnets">${ga(e.name)}</a>${n}${o}</td>
    <td>${kh(Number(e.leads?.window||0),t)}</td>
    <td>${We(e.leads?.window)}</td>
    <td>${We(e.opens)}</td>
    <td>${Jt(e.engagement_rate)}</td>
    <td>${Jt(e.completion_rate)}</td>
    <td>${Jt(e.lead_rate)}</td>
    <td>${s}</td>
  </tr>`}function pl(e,t){const a=e.reduce((n,o)=>Math.max(n,Number(o.leads?.window||0)),0);return`<div class="anl-wrap"><table class="anl-table">
    <thead><tr>
      <th>Magnet</th><th></th><th>Leads</th><th>Opens</th>
      <th>Engaged</th><th>Completed</th><th>Leads / Open</th><th>A/B run / done</th>
    </tr></thead>
    <tbody>${e.map(n=>Ah(n,a,t)).join("")}</tbody>
  </table></div>`}function Sh(){return ie()?Et({section:"analytics",title:"Analytics",description:"Pick a client to see how their magnets are performing."}):(dl(),`
    <div class="page-shell" data-section="analytics">
      <div class="page-header">
        ...
        <div class="chart-controls" id="anl-periods">
          ${Eh.map(e=>`<button class="chart-period-btn${e.d===Ba?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>

      <div class="stats-grid">
        ${ha("person_add","Leads","anl-leads")}
        ${ha("visibility","Opens","anl-opens")}
        ${ha("task_alt","Completion Rate","anl-completion")}
        ${ha("widgets","Active Magnets","anl-active")}
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="anl-body">
          ${Aa("hourglass_empty","Loading magnet performance…")}
        </div>
      </div>
    ...
    </div>`)}async function Ch(){if(ie())return nt(cl(),[{h:"Leads",td:t=>We(t.leads.window??t.leads.total)},{h:"Opens",td:t=>We(t.opens)},{h:"Completed",td:t=>Jt(t.completion_rate)}]);dl(),await Ps();const e=document.getElementById("anl-periods");e&&e.addEventListener("click",t=>{const a=t.target.closest(".chart-period-btn");a&&(Ba=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>{n.classList.toggle("active",Number(n.dataset.days)===Ba)}),Ps())})}async function Ps(){const e=document.getElementById("anl-body"),t=document.getElementById("anl-range");if(!e)return;e.innerHTML=Aa("hourglass_empty","Loading magnet performance…");const a=new Date,n=Ns(a),o=Ns(new Date(a.getTime()-(Ba-1)*864e5));t&&(t.textContent=`${o} → ${n}`);let s;try{const d=await fetch(`${cl()}/m5t/v5/dashboard/stats?from=${o}&to=${n}&group_by=magnet`);if(s=await d.json(),!d.ok||!s?.ok)throw new Error(s?.error||`HTTP ${d.status}`)}catch(d){e.innerHTML=Aa("cloud_off","Could not load analytics. Refresh to try again."),console.error("[analytics] load failed:",d);return}const r=(d,g)=>{const f=document.getElementById(d);f&&(f.textContent=g)};r("anl-leads",We(s.by_day?.reduce((d,g)=>d+Number(g.leads||0),0))),r("anl-opens",We(s.funnel?.opens)),r("anl-completion",Jt(s.funnel?.completion_rate)),r("anl-active",We(s.magnets?.active));const i=Array.isArray(s.by_magnet)?s.by_magnet:[];if(!i.length){e.innerHTML=Aa("widgets","No magnets yet. Create one and its numbers will show up here.");return}const l=i.some(d=>Number(d.opens||0)>0||Number(d.leads?.window||0)>0),c=new Set(i.map(d=>d.owner_guid)).size>1,u=s.by_magnet_truncated?`<p class="anl-warn">Showing the top ${i.length} magnets by leads. You have more than that, so this list is not complete.</p>`:"",b=l?"":'<p class="anl-warn">No opens or leads for any magnet in this period. Try a longer range.</p>';e.innerHTML=u+b+pl(i,c)}const Th=Object.freeze(Object.defineProperty({__proto__:null,init:Ch,render:Sh,tableHTML:pl},Symbol.toStringTag,{value:"Module"})),ul=()=>E.getConfig?.().BASE_URL||"",Fs=e=>e.toISOString().slice(0,10),Un=e=>e==null?"—":"$"+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),Qe=e=>Number(e||0).toLocaleString(),$h={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Lt=e=>String(e??"").replace(/[&<>"']/g,t=>$h[t]);let Ds=!1;function Lh(){if(Ds)return;const e=document.createElement("style");e.id="m5t-adperf-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ds=!0}const ft=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,fa=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
    ...
    <div class="stat-value" id="${a}">${n}</div>
  </div>`,Ih=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let qa=30;function ml(){return ie()?Et({section:"ad-performance",title:"Ad Performance",description:"Pick a client to view their spend and lead performance."}):(Lh(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${Ih.map(e=>`<button class="chart-period-btn${e.d===qa?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>

      <div class="stats-grid" id="adperf-stats">
        ${fa("payments","Ad Spend","adperf-spend")}
        ${fa("ads_click","Clicks","adperf-clicks")}
        ${fa("person_add","Magnet Leads","adperf-leads")}
        ${fa("request_quote","Cost / Lead","adperf-cpl")}
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-body">
          ${ft("hourglass_empty","Loading ad performance…")}
        </div>
      </div>
    ...
    </div>`)}async function gl(){if(ie()){const t=a=>Number(a||0).toLocaleString();return nt(ul(),[{h:"Spend",td:a=>a.ad?`$${t(a.ad.spend)}`:"—"},{h:"Clicks",td:a=>a.ad?t(a.ad.clicks):"—"},{h:"Leads",td:a=>t(a.leads.window??a.leads.total)},{h:"CPL",td:a=>a.ad?.cost_per_lead!=null?`$${t(a.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see spend here."})}const e=document.getElementById("adperf-periods");e?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(qa=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===qa)),Bs())}),await Bs()}async function Bs(){const e=ul(),t=document.getElementById("adperf-body"),a=document.getElementById("adperf-range"),n=new Date,o=Fs(n),s=Fs(new Date(n.getTime()-(qa-1)*864e5));a&&(a.textContent=`${s} → ${o}`);let r,i=[],l=null,c=null,u=null;try{const[d,g,f,p,v]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${s}&to=${o}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${s}&to=${o}`),Ka().catch(()=>null),fetch(`${e}/m5t/v5/coreAdMetrics/conversions?from=${s}&to=${o}`).then(w=>w.json()).catch(()=>null)]);if(!d.ok)throw new Error(`HTTP ${d.status}`);r=await d.json(),i=((await g.json().catch(()=>({})))?.data||[]).filter(w=>w.status!=="DELETED"),l=await f.json().catch(()=>null),c=p,u=v}catch(d){console.warn("[ad-performance] load failed:",d),t&&(t.innerHTML=ft("error","Could not load ad performance. Please try again."));return}Rh(c,i),Nh(u);const b=r.totals||{};if(va("adperf-spend",Un(b.spend)),va("adperf-clicks",Qe(b.clicks)),va("adperf-leads",Qe(b.magnet_leads)),va("adperf-cpl",Un(b.cost_per_lead)),Oh(l),!i.length){t.innerHTML=ft("link_off","No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.");return}if(!r.connected){t.innerHTML=ft("cloud_sync","Account connected. No ad data for this range yet. Metrics appear here once they sync.");return}t.innerHTML=Mh(r.rows||[])}function Rh(e,t){const a=document.getElementById("adperf-conn");if(!a)return;if(!e||e.denied){a.innerHTML="";return}const n=Re.google_ads,o=Va(e.providers,"google_ads"),s=Wa(n,o,!!e.configured?.google_ads),r=Oe()?` <a href="#/settings/integrations/${n.urlSlug}">Manage</a>`:"";if(s==="connected"||s==="broken"){Xa(),a.innerHTML=`<span>Google Ads</span> ${Ya(s,o)}${r}`;return}if(t.length){a.innerHTML=`<span>Google Ads</span> <span>${t.length} associated account${t.length===1?"":"s"}</span>`;return}a.innerHTML=""}function Nh(e){const t=document.getElementById("adperf-conv-card"),a=document.getElementById("adperf-conv-body"),n=document.getElementById("adperf-stats"),o=document.getElementById("adperf-conv-stat");if(o&&o.remove(),!t||!a)return;if(!e?.ok||!e.has_selection){t.style.display="none";return}if(n){const i=document.createElement("div");i.className="stat-card",i.id="adperf-conv-stat",i.innerHTML=`
      <div class="stat-header">
      ...
      <div class="stat-change"><span class="stat-sublabel">Reported by Google Ads</span></div>`,n.appendChild(i)}const s=e.actions||[];if(t.style.display="",!s.length){a.innerHTML=ft("search_off","No conversions in this range for the selected actions.");return}const r=s.some(i=>i.value>0);a.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${s.map(i=>`
          <tr>
            <td>${Lt(i.name||i.id)}</td>
            <td class="adperf-src-sub">${Lt(String(i.category||"").toLowerCase().replace(/_/g," ")||"—")}</td>
            <td class="num"><b>${Qe(i.conversions)}</b></td>
            ${r?`<td class="num">${Un(i.value)}</td>`:""}
          </tr>`).join("")}
        </tbody>
      </table>
    </div>
    <p class="adperf-note">Counted actions are chosen on the Google Ads integration page. These are Google's own numbers and may overlap magnet leads, so they are never added together.</p>`}function Oh(e){const t=document.getElementById("adperf-sources"),a=document.getElementById("adperf-src-summary");if(!t)return;const n=e&&Array.isArray(e.rows)?e.rows:[];if(!n.length){a&&(a.textContent=""),t.innerHTML=ft("search_off","No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.");return}const o=e.total_leads||n.reduce((i,l)=>i+(l.leads||0),0),s=e.tracked_leads||0;a&&(a.textContent=`${Qe(s)} of ${Qe(o)} leads tagged to a source`);const r=i=>i.campaign&&i.campaign!=="(none)"?Lt(i.campaign):i.source&&i.source!=="(direct)"?Lt(i.source):'<span class="adperf-src-untracked">Untracked / direct</span>';t.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
    ...
    </div>`}function va(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}function qs(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}function Us(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e)}function Mh(e){const g=e.length||1,f=qs(Math.max(1,...e.map(B=>B.spend||0))),p=qs(Math.max(1,...e.map(B=>B.magnet_leads||0))),v=738/g,x=Math.min(24,v*.55),w=B=>56+v*(B+.5),$=B=>304-B/f*282,O=B=>304-B/p*282,U=[0,.25,.5,.75,1].map(B=>{const le=304-B*282;return`<line x1="56" y1="${le.toFixed(1)}" x2="794" y2="${le.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${(le+3.5).toFixed(1)}" text-anchor="end" class="ax">$${Us(f*B)}</text><text x="802" y="${(le+3.5).toFixed(1)}" text-anchor="start" class="ax">${Us(p*B)}</text>`}).join(""),I=e.map((B,le)=>{const H=$(B.spend||0);return`<rect x="${(w(le)-x/2).toFixed(1)}" y="${H.toFixed(1)}" width="${x.toFixed(1)}" height="${Math.max(0,304-H).toFixed(1)}" rx="3" fill="#0072BA"><title>${B.date}: $${B.spend} spend</title></rect>`}).join(""),j=e.map((B,le)=>`${w(le).toFixed(1)},${O(B.magnet_leads||0).toFixed(1)}`).join(" "),X=g>1?`<polyline points="${j}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",J=e.map((B,le)=>`<circle cx="${w(le).toFixed(1)}" cy="${O(B.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${B.date}: ${B.magnet_leads} leads</title></circle>`).join(""),ae=Math.max(1,Math.ceil(g/6)),ge=e.map((B,le)=>le%ae===0||le===g-1?`<text x="${w(le).toFixed(1)}" y="326" text-anchor="middle" class="ax">${B.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="adperf-chart" viewBox="0 0 840 340" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Ad spend versus magnet leads over time">
      ${U}${I}${X}${J}${ge}
    </svg>`}const Ph={render:ml,init:gl},Fh=Object.freeze(Object.defineProperty({__proto__:null,default:Ph,init:gl,render:ml},Symbol.toStringTag,{value:"Module"})),Dh={google_ads:"Google Ads",google_lsa:"Local Services Ads"},Bh=e=>{const t=String(e||"").replace(/\D/g,"");return t.length===10?`${t.slice(0,3)}-${t.slice(3,6)}-${t.slice(6)}`:String(e||"")};let zs=!1;function qh(){if(zs)return;const e=document.createElement("style");e.id="m5t-adacct-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),zs=!0}function hl(){return ie()?Et({section:"ad-accounts",title:"Ad Accounts",description:"Pick a client to see their connected ad accounts."}):(qh(),Xa(),`
    ...
    </div>`)}async function fl(){if(ie()){const e=t=>Number(t||0).toLocaleString();return nt(re(),[{h:"Spend",td:t=>t.ad?`$${e(t.ad.spend)}`:"—"},{h:"Leads",td:t=>e(t.leads.window??t.leads.total)},{h:"CPL",td:t=>t.ad?.cost_per_lead!=null?`$${e(t.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see it here."})}await Uh()}async function Uh(){const[e,t,a]=await Promise.all([Ka().catch(()=>null),fetch(`${re()}/m5t/v5/coreAdAccount`).then(n=>n.json()).catch(()=>null),fetch(`${re()}/m5t/v5/coreAdMetrics/conversions`).then(n=>n.json()).catch(()=>null)]);zh(e,a),Hh(t),jh(t)}function zh(e,t){const a=document.getElementById("adacct-conn");if(!a)return;const n=Re.google_ads;if(!e||e.denied){a.innerHTML=De("link_off","Connection status is not available for your role.");return}const o=Va(e.providers,"google_ads"),s=Wa(n,o,!!e.configured?.google_ads),r=o?.external_account||{},i=n.card.reachableCount(r);let l;s==="connected"?l=i?`${i} reachable account${i===1?"":"s"}.`:"Connected.":s==="broken"?l=n.card.brokenDesc:s==="unavailable"?l="Google Ads is being set up for this platform.":l=Oe()?"Not connected yet. Connect from Settings to pull spend and clicks.":"Not connected yet.";const c=Oe()&&s!=="unavailable"?`<a class="adacct-manage" href="#/settings/integrations/${n.urlSlug}"><span class="material-symbols-outlined" aria-hidden="true">${s==="idle"?"link":"settings"}</span>${s==="idle"?"Connect":"Manage"}</a>`:"";let u="";if(t?.ok&&t.has_selection){const b=(t.actions||[]).map(g=>g.name||g.id),d=(t.selected_ids||[]).length-b.length;u=`
      <div class="adacct-chips">Counted in reporting:
        ${b.map(g=>`<span class="adacct-chip">${N(g)}</span>`).join("")}
        ${d>0?`<span class="adacct-chip">${d} more</span>`:""}
      </div>`}a.innerHTML=`
    <div class="adacct-conn">
      ${no(n)}
      <div class="adacct-conn__titles">
        <span class="adacct-conn__name">${N(n.label)} ${Ya(s,o)}</span>
        <span class="adacct-conn__sub">${N(l)}</span>
      </div>
      <span class="adacct-conn__spacer"></span>
      ${c}
    </div>
    ${u}`}function Hh(e){const t=document.getElementById("adacct-list"),a=document.getElementById("adacct-count");if(!t)return;if(!e||e.ok===!1){t.innerHTML=De("error","Could not load ad accounts. Please try again.");return}const n=(e.data||[]).filter(s=>s.status!=="DELETED"),o=!!e.canConnect;if(a&&(a.textContent=n.length?`${n.length} account${n.length===1?"":"s"}`:""),!n.length){t.innerHTML=De("link_off",o?"No ad accounts associated yet.":"No ad accounts yet. Your agency connects these for you.")+(o?`<p class="adacct-note">Associate a client's Customer ID from the <a href="#/clients">Clients page</a>.</p>`:"");return}t.innerHTML=`
    <div class="adacct-wrap">
      <table class="adacct-table">
        <thead><tr><th>Platform</th><th>Customer ID</th><th>Status</th></tr></thead>
        <tbody>${n.map(s=>`
          <tr>
            <td>${N(Dh[s.provider]||s.provider)}</td>
            <td class="adacct-cid">${N(Bh(s.external_customer_id))}</td>
            <td><span class="m5t-badge" data-tone="${s.status==="ACTIVE"?"success":"warning"}">${N(s.status==="ACTIVE"?"Active":s.status)}</span></td>
          </tr>`).join("")}
        </tbody>
      </table>
    </div>
    ${o?'<p class="adacct-note">Associations are managed per client from the <a href="#/clients">Clients page</a>.</p>':""}`}let mt=[],Hs=null;function jh(e){const t=document.getElementById("adacct-offline");if(t){if(!e?.canConnect){t.style.display="none";return}t.style.display="",document.getElementById("adacct-oc-dl")?.addEventListener("click",Yh),document.getElementById("adacct-oc-up")?.addEventListener("click",Wh),document.getElementById("adacct-mc-file")?.addEventListener("change",Kh),Gh()}}async function Gh(){mt=[];try{const t=await(await fetch(`${re()}/m5t/v5/integrations/google_ads/conversion_actions`)).json();if(!t.ok)return;const a=t.data.actions||[];if(mt=a.filter(o=>o.type==="UPLOAD_CLICKS"&&(o.account_ids||[]).length),!mt.length){if(a.length){const o=document.getElementById("adacct-oc-result");o&&(o.textContent="Direct upload needs an import type conversion action in Google Ads. The CSV works either way.")}return}const n=document.getElementById("adacct-oc-target");n&&(n.innerHTML=mt.map(o=>`<option value="${N(o.id)}">${N(o.name||o.id)}</option>`).join("")),document.getElementById("adacct-oc-target-wrap")?.style.setProperty("display",""),document.getElementById("adacct-oc-up")?.style.setProperty("display","")}catch{}}function Vh(){const e=document.getElementById("adacct-oc-target")?.value;return mt.find(t=>t.id===e)||mt[0]||null}async function vl(e,t){const a=Vh();if(!a){t&&(t.textContent="Pick an upload target first.");return}const n=document.getElementById("adacct-oc-value")?.value,o=n!==""&&n!=null&&Number.isFinite(Number(n))?Number(n):null;t&&(t.textContent=`Uploading ${e.length} conversion${e.length===1?"":"s"}…`);try{const r=await(await fetch(`${re()}/m5t/v5/integrations/google_ads/upload_conversions`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({customer_id:a.account_ids[0],conversion_action_id:a.id,rows:e.map(l=>o!=null?{...l,value:o}:l)})})).json();if(!r.ok)throw new Error(r.error||"upload failed");const i=[`${r.data.uploaded} uploaded to Google Ads.`];r.data.failed&&i.push(`${r.data.failed} rejected${r.data.errors?.[0]?`: ${r.data.errors[0]}`:"."}`),t&&(t.textContent=i.join(" "))}catch(s){t&&(t.textContent=s.message==="upload failed"?"Upload failed. Please try again.":`Upload failed: ${s.message}`)}}async function Wh(){const e=document.getElementById("adacct-oc-result"),t=Number(document.getElementById("adacct-oc-days")?.value)||90,a=[...document.querySelectorAll("#adacct-oc-statuses input:checked")].map(i=>i.value);if(!a.length){e&&(e.textContent="Pick at least one status.");return}const n=i=>i.toISOString().slice(0,10),o=n(new Date),s=n(new Date(Date.now()-(t-1)*864e5)),r=new URLSearchParams({from:s,to:o,statuses:a.join(","),format:"json"});try{const l=await(await fetch(`${re()}/m5t/v5/coreAdMetrics/offline-conversions.csv?${r}`)).json();if(!l.ok)throw new Error;if(!l.rows.length){e&&(e.textContent="No leads with a click id in that window.");return}await vl(l.rows,e)}catch{e&&(e.textContent="Upload failed. Please try again.")}}async function Yh(){const e=document.getElementById("adacct-oc-result"),t=Number(document.getElementById("adacct-oc-days")?.value)||90,a=[...document.querySelectorAll("#adacct-oc-statuses input:checked")].map(c=>c.value);if(!a.length){e&&(e.textContent="Pick at least one status.");return}const n=document.getElementById("adacct-oc-name")?.value?.trim()||"M5M magnet lead",o=document.getElementById("adacct-oc-value")?.value,s=c=>c.toISOString().slice(0,10),r=s(new Date),i=s(new Date(Date.now()-(t-1)*864e5)),l=new URLSearchParams({from:i,to:r,statuses:a.join(","),name:n});o!==""&&o!=null&&Number.isFinite(Number(o))&&l.set("value",o),e&&(e.textContent="Building the export…");try{const c=await fetch(`${re()}/m5t/v5/coreAdMetrics/offline-conversions.csv?${l}`);if(!c.ok)throw new Error(`HTTP ${c.status}`);const u=await c.text(),b=Math.max(0,u.trim().split(`
`).length-1);_l(u,`google-ads-conversions-${i}-to-${r}.csv`),e&&(e.textContent=b?`${b} conversion${b===1?"":"s"} in the file.`:"No leads with a click id in that window. The file has headers only.")}catch{e&&(e.textContent="Export failed. Please try again.")}}async function Kh(e){const t=document.getElementById("adacct-mc-result"),a=e.target.files?.[0];if(!a)return;const n=await a.text(),o=bl(n);if(!o.length){t&&(t.textContent="No usable rows found. The CSV needs an email or phone column.");return}t&&(t.textContent=`Matching ${o.length} row${o.length===1?"":"s"}…`);try{const r=await(await fetch(`${re()}/m5t/v5/coreAdMetrics/offline-conversions/match`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({rows:o})})).json();if(!r.ok)throw new Error(r.error||"match failed");const i=[`${r.matched_count} of ${o.length} rows matched a magnet lead with a click id.`];if(r.unmatched_count&&i.push(`${r.unmatched_count} had no matching lead.`),r.no_click_count&&i.push(`${r.no_click_count} matched a lead without a click id.`),!r.matched_count){t&&(t.textContent=i.join(" "));return}const l=document.getElementById("adacct-oc-name")?.value?.trim()||"M5M magnet lead",c=document.getElementById("adacct-oc-value")?.value,u=c!==""&&c!=null&&Number.isFinite(Number(c))?Number(c):"",b=g=>`"${String(g??"").replace(/"/g,'""')}"`,d=["Google Click ID,Conversion Name,Conversion Time,Conversion Value,Conversion Currency",...r.matched.map(g=>[b(g.gclid),b(l),b(g.time),u,""].join(","))].join(`\r
`)+`\r
`;if(Hs=r.matched.map(g=>({gclid:g.gclid,time:g.time})),t){t.innerHTML="";const g=document.createElement("span");g.textContent=i.join(" ")+" ";const f=document.createElement("button");if(f.type="button",f.className="adacct-manage",f.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">download</span>Download matched CSV',f.addEventListener("click",()=>_l(d,`google-ads-conversions-matched-${new Date().toISOString().slice(0,10)}.csv`)),t.append(g,f),mt.length){const p=document.createElement("button");p.type="button",p.className="adacct-manage",p.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">cloud_upload</span>Upload to Google Ads',p.addEventListener("click",()=>vl(Hs,t)),t.append(" ",p)}}}catch{t&&(t.textContent="Matching failed. Please try again.")}finally{e.target.value=""}}function bl(e){const t=[];let a=[],n="",o=!1;for(let c=0;c<e.length;c++){const u=e[c];o?u==='"'&&e[c+1]==='"'?(n+='"',c++):u==='"'?o=!1:n+=u:u==='"'?o=!0:u===","?(a.push(n),n=""):u===`
`||u==="\r"?(u==="\r"&&e[c+1]===`
`&&c++,a.push(n),n="",a.some(b=>b.trim()!=="")&&t.push(a),a=[]):n+=u}if(a.push(n),a.some(c=>c.trim()!=="")&&t.push(a),t.length<2)return[];const s=t[0].map(c=>c.trim().toLowerCase()),r=s.findIndex(c=>/e-?mail/.test(c)),i=s.findIndex(c=>/phone|mobile|tel/.test(c)),l=s.findIndex(c=>/date|time|booked|appointment|start/.test(c));return r<0&&i<0?[]:t.slice(1).map(c=>({email:r>=0?(c[r]||"").trim():"",phone:i>=0?(c[i]||"").trim():"",at:l>=0?(c[l]||"").trim():""})).filter(c=>c.email||c.phone).slice(0,5e3)}function _l(e,t){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),o=document.createElement("a");o.href=n,o.download=t,document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(n),4e3)}const Xh={render:hl,init:fl},Jh=Object.freeze(Object.defineProperty({__proto__:null,default:Xh,init:fl,parseBookingCsv:bl,render:hl},Symbol.toStringTag,{value:"Module"})),js="reseller_org",yl="managed_client";let Gs=!1;const Qh={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},D=e=>String(e??"").replace(/[&<>"']/g,t=>Qh[t]);function Ze(e,t="info"){try{m.publish(h.UI_TOAST,{message:e,type:t})}catch{}}function Zh(){const e=E.getActiveOrg();if(e&&e.channel===js)return{guid:e.guid,name:e.name};const t=E.getMemberships().find(a=>a.channel===js);return t?{guid:t.orgGuid,name:t.name}:null}function ef(e){const t=e?.created_tz;if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function tf(){if(Gs)return;const e=document.createElement("style");e.id="m5t-clients-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Qn(),Gs=!0}const af=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Qt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function nf(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
    <div class="client-row">
      <span class="client-row__avatar">${D(af(t))}</span>
      <span class="client-row__main">
        <div class="client-row__name" title="${D(t)}">${D(t)}</div>
        <div class="client-row__meta">Added ${D(ef(e.created))||"—"}</div>
      </span>
      <span class="client-row__status" data-status="${D(a)}">${D(a)}</span>
      <div class="client-row__btns">
        <button class="client-card__invite" type="button" data-action="invite" data-client-guid="${D(e.guid)}" data-client-name="${D(t)}">
          <span class="material-symbols-outlined" aria-hidden="true">person_add</span> Invite user
        </button>
        <button class="client-card__invite" type="button" data-action="questionnaire" data-client-guid="${D(e.guid)}" data-client-name="${D(t)}">
        ...
        <button class="client-card__invite" type="button" data-action="adaccounts" data-client-guid="${D(e.guid)}" data-client-name="${D(t)}">
          <span class="material-symbols-outlined" aria-hidden="true">ads_click</span> Ad accounts
        </button>`:""}
      </div>
    </div>`}function wl(){return tf(),`
    ...
    </div>`}async function xl(){const e=Zh();document.getElementById("clients-add-btn")?.addEventListener("click",()=>of(e)),await El(e)}async function El(e){const t=document.getElementById("clients-body"),a=document.getElementById("clients-count");if(t){if(!e?.guid){t.innerHTML=Qt("info","Client provisioning is available to reseller / agency accounts."),a&&(a.textContent="");return}try{const n=E.getConfig?.().BASE_URL||"",o=await fetch(`${n}/m5t/v5/acctGroup`);if(!o.ok)throw new Error(`HTTP ${o.status}`);const s=await o.json(),i=(Array.isArray(s?.data)?s.data:[]).filter(l=>l.class===yl&&(!l.parent||l.parent===e.guid));if(!i.length){t.innerHTML=Qt("group_off","No clients yet. Add your first client to start managing magnets on their behalf."),a&&(a.textContent="");return}t.innerHTML=`<div class="client-list">${i.map(nf).join("")}</div>`,a&&(a.textContent=`${i.length} client${i.length===1?"":"s"}`),t.querySelectorAll(".client-card__invite").forEach(l=>{l.addEventListener("click",()=>{l.dataset.action==="adaccounts"?sf(l.dataset.clientGuid,l.dataset.clientName):l.dataset.action==="questionnaire"?rf(l.dataset.clientGuid,l.dataset.clientName):kl(l.dataset.clientGuid,l.dataset.clientName)})})}catch(n){console.warn("[clients] load failed:",n),t.innerHTML=Qt("error","Couldn’t load clients. Please try again."),a&&(a.textContent="")}}}function of(e){if(!e?.guid){Ze("Only reseller / agency accounts can add clients.","error");return}const t=document.createElement("div");t.className="client-modal-scrim";const a=document.createElement("div");a.className="client-modal",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
    ...
    <div class="client-modal__body">
      <p class="client-modal__sub">Creates a managed client under <strong>${D(e.name||"your agency")}</strong>. You'll manage their magnets and leads on their behalf.</p>
    ...
    </div>`,document.body.appendChild(t),document.body.appendChild(a),requestAnimationFrame(()=>{t.classList.add("open"),a.classList.add("open")});const n=a.querySelector("#client-name-input"),o=a.querySelector("#client-modal-error"),s=a.querySelector('[data-act="create"]');n?.focus();const r=()=>{t.classList.remove("open"),a.classList.remove("open"),document.removeEventListener("keydown",i),setTimeout(()=>{t.remove(),a.remove()},200)},i=c=>{c.key==="Escape"&&r()};document.addEventListener("keydown",i),t.addEventListener("click",r),a.querySelector(".client-modal__close")?.addEventListener("click",r),a.querySelector('[data-act="cancel"]')?.addEventListener("click",r);const l=async()=>{const c=(n?.value||"").trim();if(o.textContent="",!c){o.textContent="Please enter a client name.",n?.focus();return}s.disabled=!0;const u=s.innerHTML;s.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Adding…';try{const b=E.getConfig?.().BASE_URL||"",d=await fetch(`${b}/m5t/v5/acctGroup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({class:yl,caption:c,parent:e.guid})}),g=await d.json().catch(()=>({}));if(!d.ok||!g?.ok){const f=d.status===403?"You are not authorized to add a client here.":g?.message||g?.error||`Failed (HTTP ${d.status})`;throw new Error(f)}Ze(`Added client “${c}”`,"success"),r(),await El(e)}catch(b){console.warn("[clients] create failed:",b),o.textContent=b.message||"Something went wrong. Please try again.",s.disabled=!1,s.innerHTML=u}};s?.addEventListener("click",l),n?.addEventListener("keydown",c=>{c.key==="Enter"&&l()})}const Vs=e=>String(e||"").replace(/[^0-9]/g,"");async function sf(e,t){const a=E.getConfig?.().BASE_URL||"",n={};try{const f=await fetch(`${a}/m5t/v5/coreAdAccount?owner_guid=${encodeURIComponent(e)}`),p=await f.json().catch(()=>({}));if(!f.ok)throw new Error(`Failed to load ad accounts (${f.status})`);(p?.data||[]).forEach(v=>{n[v.provider]=v})}catch(f){console.warn("[clients] ad-accounts prefill failed:",f)}const o=n.google_ads,s=n.google_lsa,r=document.createElement("div");r.className="client-modal-scrim";const i=document.createElement("div");i.className="client-modal",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.innerHTML=`
    <div class="client-modal__head">
      <span class="client-modal__title">Ad accounts: ${D(t)}</span>
      <button class="client-modal__close" type="button" aria-label="Close">&times;</button>
    </div>
    <div class="client-modal__body">
      ...
      <input class="client-modal__input" id="aa-gads" type="text" inputmode="numeric" placeholder="123-456-7890" autocomplete="off" value="${D(o?.external_customer_id||"")}" />
      ...
      <input class="client-modal__input" id="aa-lsa" type="text" inputmode="numeric" placeholder="Optional" autocomplete="off" value="${D(s?.external_customer_id||"")}" />
    ...
    </div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add("open"),i.classList.add("open")});const l=i.querySelector("#aa-error"),c=i.querySelector('[data-act="save"]'),u=()=>{r.classList.remove("open"),i.classList.remove("open"),document.removeEventListener("keydown",b),setTimeout(()=>{r.remove(),i.remove()},200)},b=f=>{f.key==="Escape"&&u()};document.addEventListener("keydown",b),r.addEventListener("click",u),i.querySelector(".client-modal__close")?.addEventListener("click",u),i.querySelector('[data-act="cancel"]')?.addEventListener("click",u);const d=(f,p,v)=>{const x=`${a}/m5t/v5/coreAdAccount`;return p&&!v?fetch(x,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,provider:f,external_customer_id:p})}):p&&v&&p!==v.external_customer_id?fetch(`${x}/${encodeURIComponent(v.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({external_customer_id:p})}):!p&&v?fetch(`${x}/${encodeURIComponent(v.guid)}`,{method:"DELETE"}):null},g=async()=>{l.textContent="";const f=Vs(i.querySelector("#aa-gads").value),p=Vs(i.querySelector("#aa-lsa").value),v=[d("google_ads",f,o),d("google_lsa",p,s)].filter(Boolean);if(!v.length){u();return}c.disabled=!0;const x=c.innerHTML;c.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const w=await Promise.all(v);for(const $ of w)if(!$.ok){const O=await $.json().catch(()=>({}));throw new Error($.status===403?"You are not authorized to connect accounts for this client.":O?.error||O?.message||`Failed (HTTP ${$.status})`)}Ze("Ad accounts updated","success"),u()}catch(w){l.textContent=w.message||"Something went wrong. Please try again.",c.disabled=!1,c.innerHTML=x}};c?.addEventListener("click",g)}function kl(e,t){if(!e)return;const a=document.createElement("div");a.className="client-modal-scrim";const n=document.createElement("div");n.className="client-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="invite-body">
      ...
      <p class="client-modal__sub">Invite someone at <strong>${D(t||"this client")}</strong> to a read-only login for their account.</p>
      ...
      <div class="client-modal__actions">
    ...
    </div>`,document.body.appendChild(a),document.body.appendChild(n),requestAnimationFrame(()=>{a.classList.add("open"),n.classList.add("open")});const o=()=>{a.classList.remove("open"),n.classList.remove("open"),document.removeEventListener("keydown",s),setTimeout(()=>{a.remove(),n.remove()},200)},s=u=>{u.key==="Escape"&&o()};document.addEventListener("keydown",s),a.addEventListener("click",o),n.querySelector(".client-modal__close")?.addEventListener("click",o),n.querySelector('[data-act="cancel"]')?.addEventListener("click",o);const r=n.querySelector("#inv-email"),i=n.querySelector("#inv-error"),l=n.querySelector('[data-act="send"]');r?.focus();const c=u=>u.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(u.dataset.url),u.textContent="Copied!",setTimeout(()=>{u.textContent="Copy link"},1500)}catch{}});(async function(){const b=n.querySelector("#invite-pending");if(b)try{const d=E.getConfig?.().BASE_URL||"",g=await fetch(`${d}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invites`),f=await g.json().catch(()=>({})),p=g.ok&&f.ok&&Array.isArray(f.invites)?f.invites:[];if(!p.length){b.innerHTML="";return}b.innerHTML=`
        <div class="invite-pending">
          <div class="invite-pending__label">Pending invites</div>
          ${p.map(v=>`
            <div class="invite-pending__row">
              <span class="invite-pending__email${v.expired?" expired":""}" title="${D(v.email)}">${D(v.email)}${v.expired?" · expired":""}</span>
              <button class="client-modal__btn client-modal__btn--ghost invite-pending__copy" type="button" data-url="${D(v.inviteUrl)}">Copy link</button>
            </div>`).join("")}
        </div>`,b.querySelectorAll(".invite-pending__copy").forEach(c)}catch{b.innerHTML=""}})(),l?.addEventListener("click",async()=>{const u=(n.querySelector("#inv-email").value||"").trim(),b=(n.querySelector("#inv-first").value||"").trim(),d=(n.querySelector("#inv-last").value||"").trim();if(i.textContent="",!u||!b||!d){i.textContent="Email, first, and last name are required.";return}l.disabled=!0;const g=l.innerHTML;l.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Sending…';try{const f=E.getConfig?.().BASE_URL||"",p=await fetch(`${f}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:u,first:b,last:d,member_role:"viewer"})}),v=await p.json().catch(()=>({}));if(!p.ok||!v.ok){const w=p.status===409?"A user with that email already exists.":p.status===403?"You are not authorized to invite for this client.":v.message||v.error||`Failed (HTTP ${p.status})`;throw new Error(w)}Ze(`Invite created for ${u}`,"success"),n.querySelector("#invite-body").innerHTML=`
        <div class="client-modal__result">
          ...
          <p>${v.emailQueued?`An invite email is on its way to <strong>${D(u)}</strong>.`:`Invite created for <strong>${D(u)}</strong>.`}</p>
          ...
          <div class="client-modal__linkrow">
            <input class="client-modal__input" id="inv-link" type="text" readonly value="${D(v.inviteUrl)}" />
        ...
        </div>`;const x=n.querySelector("#inv-link");n.querySelector("#inv-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(x.value),n.querySelector("#inv-copy").textContent="Copied!"}catch{x.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",o)}catch(f){console.warn("[clients] invite failed:",f),i.textContent=f.message||"Something went wrong. Please try again.",l.disabled=!1,l.innerHTML=g}})}function $t(e){if(!e)return"";const t=new Date(e);return Number.isNaN(t.getTime())?"":t.toLocaleString(void 0,{year:"numeric",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}async function rf(e,t){if(!e)return;const a=E.getConfig?.().BASE_URL||"",n=document.createElement("div");n.className="client-modal-scrim";const o=document.createElement("div");o.className="client-modal",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),o.innerHTML=`
    <div class="client-modal__head">
      <span class="client-modal__title">Kickoff Questionnaire: ${D(t)}</span>
      <button class="client-modal__close" type="button" aria-label="Close">&times;</button>
    </div>
    <div class="client-modal__body" id="qm-body">${Qt("hourglass_empty","Loading…")}</div>`,document.body.appendChild(n),document.body.appendChild(o),requestAnimationFrame(()=>{n.classList.add("open"),o.classList.add("open")});const s=()=>{n.classList.remove("open"),o.classList.remove("open"),document.removeEventListener("keydown",r),setTimeout(()=>{n.remove(),o.remove()},200)},r=d=>{d.key==="Escape"&&s()};document.addEventListener("keydown",r),n.addEventListener("click",s),o.querySelector(".client-modal__close")?.addEventListener("click",s);const i=o.querySelector("#qm-body");function l(){i.innerHTML=`
      <p class="client-modal__sub">Send a Kickoff Questionnaire to <strong>${D(t)}</strong>. They fill it out directly in their browser, no account needed. The link expires in 7 days.</p>
      ...
      </div>`,i.querySelector('[data-act="cancel"]')?.addEventListener("click",s);const d=i.querySelector('[data-act="send"]'),g=i.querySelector("#qm-error"),f=i.querySelector("#qm-email");f?.focus(),d?.addEventListener("click",async()=>{const p=(f?.value||"").trim();if(g.textContent="",!p){g.textContent="Enter the email address to send this to.",f?.focus();return}if(!or(p)){g.textContent="That does not look like a valid email address.",f?.focus();return}d.disabled=!0;const v=d.innerHTML;d.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Sending…';try{const x=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,recipient_email:p})}),w=await x.json().catch(()=>({}));if(!x.ok||!w.ok)throw new Error(w.error||w.message||`Failed (HTTP ${x.status})`);Ze(w.data.emailQueued?`Questionnaire sent to ${p}`:"Link created — email could not be queued",w.data.emailQueued?"success":"info"),c({url:w.data.url,token_expiry:w.data.expires,recipient_email:w.data.recipient_email,emailQueued:w.data.emailQueued,guid:w.data.guid})}catch(x){g.textContent=x.message||"Something went wrong. Please try again.",d.disabled=!1,d.innerHTML=v}})}function c(d){const g=d.recipient_email?"Sent":"Link created",f=d.emailQueued===!1?"<strong>The email could not be queued.</strong> Share the link below directly instead:":d.recipient_email?`Emailed to <strong>${D(d.recipient_email)}</strong>. The link is also below — handy if it bounces, or to share via text or chat:`:"Share this link with your client — email, text, chat:";i.innerHTML=`
      <div class="qm-status" data-status="DRAFT"><span class="material-symbols-outlined" aria-hidden="true">hourglass_top</span> ${g} — awaiting response${d.token_expiry?`, link expires ${D($t(d.token_expiry))}`:""}</div>
      <p class="client-modal__hint">${f}</p>
      <div class="client-modal__linkrow">
        <input class="client-modal__input" id="qm-link" type="text" readonly value="${D(d.url||"")}" />
      ...
      </div>`;const p=i.querySelector("#qm-link");i.querySelector("#qm-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(p.value),i.querySelector("#qm-copy").textContent="Copied!"}catch{p.select()}}),i.querySelector('[data-act="done"]')?.addEventListener("click",s);const v=i.querySelector('[data-act="cancel-q"]');v?.addEventListener("click",async()=>{if(!window.confirm("Cancel this questionnaire? The link will stop working immediately. This cannot be undone — you would need to send a new one."))return;v.disabled=!0;const x=v.innerHTML;v.innerHTML="Cancelling…";try{const w=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(d.guid)}/cancel`,{method:"POST"}),$=await w.json().catch(()=>({}));if(!w.ok||!$.ok)throw new Error($.error||$.message||`Failed (HTTP ${w.status})`);Ze("Questionnaire cancelled","success"),u({...d,status:"CANCELLED",cancelled_tz:new Date().toISOString()})}catch(w){i.querySelector("#qm-cancel-error").textContent=w.message||"Something went wrong. Please try again.",v.disabled=!1,v.innerHTML=x}})}function u(d){i.innerHTML=`
      <div class="qm-status" data-status="CANCELLED"><span class="material-symbols-outlined" aria-hidden="true">block</span> Cancelled${d.cancelled_tz?` ${D($t(d.cancelled_tz))}`:""}${d.cancelled_by_email?` by ${D(d.cancelled_by_email)}`:""}</div>
      <p class="client-modal__sub">This link was revoked and no longer works.${d.recipient_email?` It had been emailed to <strong>${D(d.recipient_email)}</strong>.`:""}</p>
      <p class="client-modal__error" id="qm-error"></p>
      <div class="client-modal__actions">
      ...
      </div>`,i.querySelector('[data-act="done"]')?.addEventListener("click",s),i.querySelector('[data-act="resend"]')?.addEventListener("click",()=>l())}function b(d,g=!1){const f=d.editability||{editable:d.status==="SUBMITTED"&&!d.locked_tz,reason:d.locked_tz?"finalized":null,deadline:null},p=!!f.editable,v=!p&&d.status==="SUBMITTED"?f.reason==="finalized"?`<div class="qm-status" data-status="LOCKED"><span class="material-symbols-outlined" aria-hidden="true">lock</span> Finalized${d.locked_tz?` ${D($t(d.locked_tz))}`:""}${d.locked_by_email?` by ${D(d.locked_by_email)}`:""} — no further edits.</div>`:`<div class="qm-status" data-status="LOCKED"><span class="material-symbols-outlined" aria-hidden="true">lock_clock</span> Editing closed${f.deadline?` ${D($t(f.deadline))}`:""} — a response locks 14 days after it is submitted.</div>`:"",x=p&&f.deadline?`<p class="client-modal__sub qm-editable-hint">You can edit these answers until ${D($t(f.deadline))}.</p>`:"";i.innerHTML=`
      <div class="qm-status" data-status="SUBMITTED"><span class="material-symbols-outlined" aria-hidden="true">task_alt</span> Submitted ${d.submitted_tz?D($t(d.submitted_tz)):""}</div>
      ${v}
      ${Jn(d)}
      <form id="qm-form">
        ${Xn(d,g?{renderAnswer:yd}:{})}
      </form>
      ${g?"":x}
      <p class="client-modal__error" id="qm-error"></p>
      <div class="client-modal__actions">
        ${g?`<button class="client-modal__btn client-modal__btn--ghost" type="button" data-act="cancel-edit">Cancel</button>
             ...
             ${p?'<button class="client-modal__btn client-modal__btn--primary" type="button" data-act="edit"><span class="material-symbols-outlined" aria-hidden="true">edit</span> Edit answers</button>':""}`}
      </div>`,i.querySelector('[data-act="done"]')?.addEventListener("click",s),i.querySelector('[data-act="cancel-edit"]')?.addEventListener("click",()=>b(d,!1)),i.querySelector('[data-act="edit"]')?.addEventListener("click",()=>b(d,!0));const w=i.querySelector('[data-act="save"]');w?.addEventListener("click",async()=>{const $=xr(i);w.disabled=!0;const O=w.innerHTML;w.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';let U;try{U=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(d.guid)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({answers:$})});const I=await U.json().catch(()=>({}));if(!U.ok||!I.ok)throw new Error(I.error||I.message||`Failed (HTTP ${U.status})`);Ze("Answers updated","success");const X=await(await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(d.guid)}`)).json().catch(()=>({}));b(X.ok?X.data:{...d,answers:$},!1)}catch(I){if(U&&U.status===423){Ze(I.message||"This questionnaire is now locked.","info");const X=await(await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(d.guid)}`)).json().catch(()=>({}));b(X.ok?X.data:d,!1);return}i.querySelector("#qm-error").textContent=I.message||"Something went wrong. Please try again.",w.disabled=!1,w.innerHTML=O}})}try{const d=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse?owner_guid=${encodeURIComponent(e)}`),g=await d.json().catch(()=>({}));if(!d.ok||!g.ok)throw new Error(g.error||`HTTP ${d.status}`);const f=(g.data||[])[0]||null;if(!f){l();return}if(f.status==="DRAFT"){c(f);return}if(f.status==="CANCELLED"){u(f);return}const p=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(f.guid)}`),v=await p.json().catch(()=>({}));if(!p.ok||!v.ok)throw new Error(v.error||`HTTP ${p.status}`);b(v.data)}catch(d){console.warn("[clients] questionnaire load failed:",d),i.innerHTML=`<p class="client-modal__error">Could not load questionnaire status. ${D(d.message||"")}</p>`}}const lf={render:wl,init:xl},cf=Object.freeze(Object.defineProperty({__proto__:null,default:lf,init:xl,openInviteModal:kl,render:wl},Symbol.toStringTag,{value:"Module"})),Ws="managed_client";let Ys=!1;const df={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},xe=e=>String(e??"").replace(/[&<>"']/g,t=>df[t]),Ks=(e,t="info")=>{try{m.publish(h.UI_TOAST,{message:e,type:t})}catch{}},pf=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function uf(){const e=E.getActiveOrg();let t=e&&e.channel!==Ws?e:null;if(!t){const n=E.getMemberships().find(o=>o.channel!==Ws);n&&(t={guid:n.orgGuid,channel:n.channel,memberRole:n.memberRole})}if(!t)return null;const a=E.getMemberships().find(n=>n.orgGuid===t.guid)?.name;return{...t,name:a}}function mf(e){return Object.values(Wt).filter(t=>kc(e,t.value)).sort((t,a)=>a.rank-t.rank)}function gf(){if(Ys)return;const e=document.createElement("style");e.id="m5t-team-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ys=!0}function Ua(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function hf(e){const t=e.member_role||"member";return`
    <div class="team-row">
      <span class="team-avatar">${xe(pf(e.name||e.email))}</span>
      <span class="team-main">
        <div class="team-name">${xe(e.name||e.email)}${e.verified?"":' · <span style="color:var(--color-text-subtle,#6C7C9A);font-weight:400;">pending verification</span>'}</div>
        <div class="team-email" title="${xe(e.email)}">${xe(e.email)}</div>
      </span>
      <span class="team-role" data-role="${xe(t)}">${xe(Wt[t]?.label||t)}</span>
    </div>`}function Al(){return gf(),`
    ...
    </div>`}async function Sl(){const e=uf(),t=document.getElementById("team-invite-btn");if(!e){t&&(t.style.display="none"),document.getElementById("team-body").innerHTML=Ua("info","Team management is available for agency and workspace accounts.");return}t?.addEventListener("click",()=>ff(e)),await fo(e)}async function fo(e){const t=document.getElementById("team-body"),a=document.getElementById("team-count");if(t)try{const n=E.getConfig?.().BASE_URL||"",[o,s]=await Promise.all([fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/members`),fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/invites`)]),[r,i]=await Promise.all([o.json().catch(()=>({})),s.json().catch(()=>({}))]);if(!o.ok||!s.ok)throw new Error(`Failed to load team (members: ${o.status}, invites: ${s.status})`);const l=r.members||[],c=i.invites||[],u=c.length?`
      <div class="team-pending">
        <div class="team-pending__label">Pending invites</div>
        ${c.map(b=>`
          <div class="team-pending__row">
            <span class="team-pending__email" title="${xe(b.email)}">${xe(b.email)}${b.expired?" · expired":""}</span>
            <button class="team-modal__btn team-modal__btn--ghost team-copy" type="button" data-url="${xe(b.inviteUrl)}">Copy link</button>
          </div>`).join("")}
      </div>`:"";t.innerHTML=u+(l.length?`<div class="team-list">${l.map(hf).join("")}</div>`:Ua("group","No members yet.")),a&&(a.textContent=`${l.length} member${l.length===1?"":"s"}`),t.querySelectorAll(".team-copy").forEach(b=>b.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(b.dataset.url),b.textContent="Copied!",setTimeout(()=>{b.textContent="Copy link"},1500)}catch{}}))}catch(n){console.warn("[team] load failed:",n),t.innerHTML=Ua("error","Couldn’t load the team. Please try again.")}}function ff(e){const t=mf(e.memberRole);if(!t.length){Ks("You don’t have permission to invite teammates.","error");return}const a=document.createElement("div");a.className="team-modal-scrim";const n=document.createElement("div");n.className="team-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    ...
    <div class="team-modal__body" id="team-invite-body">
      <p class="team-modal__sub">They'll get a link to set a password and join <strong>${xe(e.name||"your workspace")}</strong>.</p>
      ...
      <select class="team-modal__select" id="tm-role">
        ${t.map(l=>`<option value="${l.value}"${l.value==="member"?" selected":""}>${xe(l.label)}</option>`).join("")}
      </select>
    ...
    </div>`,document.body.appendChild(a),document.body.appendChild(n),requestAnimationFrame(()=>{a.classList.add("open"),n.classList.add("open")});const o=()=>{a.classList.remove("open"),n.classList.remove("open"),document.removeEventListener("keydown",s),setTimeout(()=>{a.remove(),n.remove()},200)},s=l=>{l.key==="Escape"&&o()};document.addEventListener("keydown",s),a.addEventListener("click",o),n.querySelector(".team-modal__close")?.addEventListener("click",o),n.querySelector('[data-act="cancel"]')?.addEventListener("click",o),n.querySelector("#tm-email")?.focus();const r=n.querySelector("#tm-error"),i=n.querySelector('[data-act="send"]');i?.addEventListener("click",async()=>{const l=(n.querySelector("#tm-email").value||"").trim(),c=(n.querySelector("#tm-first").value||"").trim(),u=(n.querySelector("#tm-last").value||"").trim(),b=n.querySelector("#tm-role").value;if(r.textContent="",!l||!c||!u){r.textContent="Email, first, and last name are required.";return}i.disabled=!0;const d=i.innerHTML;i.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Sending…';try{const g=E.getConfig?.().BASE_URL||"",f=await fetch(`${g}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/invite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l,first:c,last:u,member_role:b})}),p=await f.json().catch(()=>({}));if(!f.ok||!p.ok){const x=f.status===409?"A user with that email already exists.":f.status===403?p.message||"You are not authorized to invite this role.":p.message||p.error||`Failed (HTTP ${f.status})`;throw new Error(x)}Ks(`Invite created for ${l}`,"success"),n.querySelector("#team-invite-body").innerHTML=`
        <div class="team-modal__result">
          <span class="material-symbols-outlined" aria-hidden="true" style="font-size:40px;color:var(--color-success,#009473);">mark_email_read</span>
          <p>${p.emailQueued?`An invite email is on its way to <strong>${xe(l)}</strong>.`:`Invite created for <strong>${xe(l)}</strong>.`}</p>
          <p class="team-modal__sub">Or share this link directly:</p>
          <div class="team-modal__linkrow">
            <input class="team-modal__input" id="tm-link" type="text" readonly value="${xe(p.inviteUrl)}" />
