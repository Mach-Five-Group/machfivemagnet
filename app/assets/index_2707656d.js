var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t,n)=>()=>{if(n)throw n[0];try{return e&&(t=e(e=0)),t}catch(e){throw n=[e],e}},s=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),c=(e,n)=>{let r={};for(var i in e)t(r,i,{get:e[i],enumerable:!0});return n||t(r,Symbol.toStringTag,{value:`Module`}),r},l=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},u=(n,r,o)=>(o=n==null?{}:e(i(n)),l(r||!n||!n.__esModule||!a.call(n,`default`)?t(o,`default`,{value:n,enumerable:!0}):o,n));(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var d=s(((e,t)=>{(function(n,r){typeof e==`object`&&typeof t==`object`?t.exports=r():typeof define==`function`&&define.amd?define(`Navigo`,[],r):typeof e==`object`?e.Navigo=r():n.Navigo=r()})(typeof self<`u`?self:e,(function(){return function(){var e={407:function(e,t,n){n.d(t,{default:function(){return de}});var r=/([:*])(\w+)/g,i=/\*/g,a=/\/\?/g;function o(e){return e===void 0&&(e=`/`),h()?location.pathname+location.search+location.hash:e}function s(e){return e.replace(/\/+$/,``).replace(/^\/+/,``)}function c(e){return typeof e==`string`}function l(e){return e&&e.indexOf(`#`)>=0&&e.split(`#`).pop()||``}function u(e){var t=s(e).split(/\?(.*)?$/);return[s(t[0]),t.slice(1).join(``)]}function d(e){for(var t={},n=e.split(`&`),r=0;r<n.length;r++){var i=n[r].split(`=`);if(i[0]!==``){var a=decodeURIComponent(i[0]);t[a]?(Array.isArray(t[a])||(t[a]=[t[a]]),t[a].push(decodeURIComponent(i[1]||``))):t[a]=decodeURIComponent(i[1]||``)}}return t}function f(e,t){var n,o=u(s(e.currentLocationPath)),f=o[0],p=o[1],m=p===``?null:d(p),h=[];if(c(t.path)){if(n=`(?:/^|^)`+s(t.path).replace(r,(function(e,t,n){return h.push(n),`([^/]+)`})).replace(i,`?(?:.*)`).replace(a,`/?([^/]+|)`)+`$`,s(t.path)===``&&s(f)===``)return{url:f,queryString:p,hashString:l(e.to),route:t,data:null,params:m}}else n=t.path;var g=new RegExp(n,``),_=f.match(g);if(_){var v=c(t.path)?function(e,t){return t.length===0?null:e?e.slice(1,e.length).reduce((function(e,n,r){return e===null&&(e={}),e[t[r]]=decodeURIComponent(n),e}),null):null}(_,h):_.groups?_.groups:_.slice(1);return{url:s(f.replace(RegExp(`^`+e.instance.root),``)),queryString:p,hashString:l(e.to),route:t,data:v,params:m}}return!1}function p(){return!(typeof window>`u`||!window.history||!window.history.pushState)}function m(e,t){return e[t]===void 0||!0===e[t]}function h(){return typeof window<`u`}function g(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter((function(e){return e})).forEach((function(e){[`before`,`after`,`already`,`leave`].forEach((function(n){e[n]&&(t[n]||(t[n]=[]),t[n].push(e[n]))}))})),t}function _(e,t,n){var r=t||{},i=0;(function t(){e[i]?Array.isArray(e[i])?(e.splice.apply(e,[i,1].concat(e[i][0](r)?e[i][1]:e[i][2])),t()):e[i](r,(function(e){e===void 0||!0===e?(i+=1,t()):n&&n(r)})):n&&n(r)})()}function v(e,t){e.currentLocationPath===void 0&&(e.currentLocationPath=e.to=o(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function y(e,t){for(var n=0;n<e.instance.routes.length;n++){var r=f(e,e.instance.routes[n]);if(r&&(e.matches||=[],e.matches.push(r),e.resolveOptions.strategy===`ONE`))return void t()}t()}function ee(e,t){e.navigateOptions&&(e.navigateOptions.shouldResolve!==void 0&&console.warn(`"shouldResolve" is deprecated. Please check the documentation.`),e.navigateOptions.silent!==void 0&&console.warn(`"silent" is deprecated. Please check the documentation.`)),t()}function b(e,t){!0===e.navigateOptions.force?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}_.if=function(e,t,n){return Array.isArray(t)||(t=[t]),Array.isArray(n)||(n=[n]),[e,t,n]};var x=h(),te=p();function ne(e,t){if(m(e.navigateOptions,`updateBrowserURL`)){var n=(`/`+e.to).replace(/\/\//g,`/`),r=x&&e.resolveOptions&&!0===e.resolveOptions.hash;te?(history[e.navigateOptions.historyAPIMethod||`pushState`](e.navigateOptions.stateObj||{},e.navigateOptions.title||``,r?`#`+n:n),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout((function(){if(!r){var t=location.hash;location.hash=``,location.hash=t}e.instance.__freezeListening=!1}),1))):x&&(window.location.href=e.to)}t()}function S(e,t){var n=e.instance;n.lastResolved()?_(n.lastResolved().map((function(t){return function(n,r){if(t.route.hooks&&t.route.hooks.leave){var i=!1,a=e.instance.matchLocation(t.route.path,e.currentLocationPath,!1);i=t.route.path===`*`?!(e.matches&&e.matches.find((function(e){return t.route.path===e.route.path}))):!a,m(e.navigateOptions,`callHooks`)&&i?_(t.route.hooks.leave.map((function(t){return function(n,r){return t((function(t){!1===t?e.instance.__markAsClean(e):r()}),e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}})).concat([function(){return r()}])):r()}else r()}})),{},(function(){return t()})):t()}function re(e,t){m(e.navigateOptions,`updateState`)&&e.instance._setCurrent(e.matches),t()}var ie=[function(e,t){var n=e.instance.lastResolved();if(n&&n[0]&&n[0].route===e.match.route&&n[0].url===e.match.url&&n[0].queryString===e.match.queryString)return n.forEach((function(t){t.route.hooks&&t.route.hooks.already&&m(e.navigateOptions,`callHooks`)&&t.route.hooks.already.forEach((function(t){return t(e.match)}))})),void t(!1);t()},function(e,t){e.match.route.hooks&&e.match.route.hooks.before&&m(e.navigateOptions,`callHooks`)?_(e.match.route.hooks.before.map((function(t){return function(n,r){return t((function(t){!1===t?e.instance.__markAsClean(e):r()}),e.match)}})).concat([function(){return t()}])):t()},function(e,t){m(e.navigateOptions,`callHandler`)&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()},function(e,t){e.match.route.hooks&&e.match.route.hooks.after&&m(e.navigateOptions,`callHooks`)&&e.match.route.hooks.after.forEach((function(t){return t(e.match)})),t()}],ae=[S,function(e,t){var n=e.instance._notFoundRoute;if(n){e.notFoundHandled=!0;var r=u(e.currentLocationPath),i=r[0],a=r[1],o=l(e.to);n.path=s(i);var c={url:n.path,queryString:a,hashString:o,data:null,route:n,params:a===``?null:d(a)};e.matches=[c],e.match=c}t()},_.if((function(e){return e.notFoundHandled}),ie.concat([re]),[function(e,t){e.resolveOptions&&!1!==e.resolveOptions.noMatchWarning&&e.resolveOptions.noMatchWarning!==void 0||console.warn(`Navigo: "`+e.currentLocationPath+`" didn't match any of the registered routes.`),t()},function(e,t){e.instance._setCurrent(null),t()}])];function oe(){return(oe=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}function se(e,t){var n=0;S(e,(function r(){n===e.matches.length?re(e,t):_(ie,oe({},e,{match:e.matches[n]}),(function(){n+=1,r()}))}))}function ce(e){e.instance.__markAsClean(e)}function le(){return(le=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}var ue=`[data-navigo]`;function de(e,t){var n,r=t||{strategy:`ONE`,hash:!1,noMatchWarning:!1,linksSelector:ue},i=this,a=`/`,m=null,x=[],te=!1,S=p(),re=h();function ie(e){return e.indexOf(`#`)>=0&&(e=!0===r.hash?e.split(`#`)[1]||`/`:e.split(`#`)[0]),e}function oe(e){return s(a+`/`+s(e))}function de(e,t,n,r){return e=c(e)?oe(e):e,{name:r||s(String(e)),path:e,handler:t,hooks:g(n)}}function fe(e,t){if(!i.__dirty){i.__dirty=!0,e=e?s(a)+`/`+s(e):void 0;var n={instance:i,to:e,currentLocationPath:e,navigateOptions:{},resolveOptions:le({},r,t)};return _([v,y,_.if((function(e){var t=e.matches;return t&&t.length>0}),se,ae)],n,ce),!!n.matches&&n.matches}i.__waiting.push((function(){return i.resolve(e,t)}))}function pe(e,t){if(i.__dirty)i.__waiting.push((function(){return i.navigate(e,t)}));else{i.__dirty=!0,e=s(a)+`/`+s(e);var n={instance:i,to:e,navigateOptions:t||{},resolveOptions:t&&t.resolveOptions?t.resolveOptions:r,currentLocationPath:ie(e)};_([ee,b,y,_.if((function(e){var t=e.matches;return t&&t.length>0}),se,ae),ne,ce],n,ce)}}function me(){if(re)return(re?[].slice.call(document.querySelectorAll(r.linksSelector||ue)):[]).forEach((function(e){e.getAttribute(`data-navigo`)!==`false`&&e.getAttribute(`target`)!==`_blank`?e.hasListenerAttached||(e.hasListenerAttached=!0,e.navigoHandler=function(t){if((t.ctrlKey||t.metaKey)&&t.target.tagName.toLowerCase()===`a`)return!1;var n=e.getAttribute(`href`);if(n==null)return!1;if(n.match(/^(http|https)/)&&typeof URL<`u`)try{var r=new URL(n);n=r.pathname+r.search}catch{}var a=function(e){if(!e)return{};var t,n=e.split(`,`),r={};return n.forEach((function(e){var n=e.split(`:`).map((function(e){return e.replace(/(^ +| +$)/g,``)}));switch(n[0]){case`historyAPIMethod`:r.historyAPIMethod=n[1];break;case`resolveOptionsStrategy`:t||={},t.strategy=n[1];break;case`resolveOptionsHash`:t||={},t.hash=n[1]===`true`;break;case`updateBrowserURL`:case`callHandler`:case`updateState`:case`force`:r[n[0]]=n[1]===`true`}})),t&&(r.resolveOptions=t),r}(e.getAttribute(`data-navigo-options`));te||(t.preventDefault(),t.stopPropagation(),i.navigate(s(n),a))},e.addEventListener(`click`,e.navigoHandler)):e.hasListenerAttached&&e.removeEventListener(`click`,e.navigoHandler)})),i}function he(e,t,n){var r=x.find((function(t){return t.name===e})),i=null;if(r){if(i=r.path,t)for(var o in t)i=i.replace(`:`+o,t[o]);i=i.match(/^\//)?i:`/`+i}return i&&n&&!n.includeRoot&&(i=i.replace(RegExp(`^/`+a),``)),i}function ge(e){var t=u(s(e)),r=t[0],i=t[1],a=i===``?null:d(i);return{url:r,queryString:i,hashString:l(e),route:de(r,(function(){}),[n],r),data:null,params:a}}function _e(e,t,n){return typeof t==`string`&&(t=ve(t)),t?(t.hooks[e]||(t.hooks[e]=[]),t.hooks[e].push(n),function(){t.hooks[e]=t.hooks[e].filter((function(e){return e!==n}))}):(console.warn(`Route doesn't exists: `+t),function(){})}function ve(e){return typeof e==`string`?x.find((function(t){return t.name===oe(e)})):x.find((function(t){return t.handler===e}))}e?a=s(e):console.warn(`Navigo requires a root path in its constructor. If not provided will use "/" as default.`),this.root=a,this.routes=x,this.destroyed=te,this.current=m,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=function(e){e.instance.__dirty=!1,e.instance.__waiting.length>0&&e.instance.__waiting.shift()()},this.on=function(e,t,r){var i=this;return typeof e!=`object`||e instanceof RegExp?(typeof e==`function`&&(r=t,t=e,e=a),x.push(de(e,t,[n,r])),this):(Object.keys(e).forEach((function(t){if(typeof e[t]==`function`)i.on(t,e[t]);else{var r=e[t],a=r.uses,o=r.as,s=r.hooks;x.push(de(t,a,[n,s],o))}})),this)},this.off=function(e){return this.routes=x=x.filter((function(t){return c(e)?s(t.path)!==s(e):typeof e==`function`?e!==t.handler:String(t.path)!==String(e)})),this},this.resolve=fe,this.navigate=pe,this.navigateByName=function(e,t,n){var r=he(e,t);return r!==null&&(pe(r.replace(RegExp(`^/?`+a),``),n),!0)},this.destroy=function(){this.routes=x=[],S&&window.removeEventListener(`popstate`,this.__popstateListener),this.destroyed=te=!0},this.notFound=function(e,t){return i._notFoundRoute=de(`*`,e,[n,t],`__NOT_FOUND__`),this},this.updatePageLinks=me,this.link=function(e){return`/`+a+`/`+s(e)},this.hooks=function(e){return n=e,this},this.extractGETParameters=function(e){return u(ie(e))},this.lastResolved=function(){return m},this.generate=he,this.getLinkPath=function(e){return e.getAttribute(`href`)},this.match=function(e){var t={instance:i,currentLocationPath:e,to:e,navigateOptions:{},resolveOptions:r};return y(t,(function(){})),!!t.matches&&t.matches},this.matchLocation=function(e,t,n){t===void 0||n!==void 0&&!n||(t=oe(t));var r={instance:i,to:t,currentLocationPath:t};return v(r,(function(){})),typeof e==`string`&&(e=n===void 0||n?oe(e):e),f(r,{name:String(e),path:e,handler:function(){},hooks:{}})||!1},this.getCurrentLocation=function(){return ge(s(o(a)).replace(RegExp(`^`+a),``))},this.addBeforeHook=_e.bind(this,`before`),this.addAfterHook=_e.bind(this,`after`),this.addAlreadyHook=_e.bind(this,`already`),this.addLeaveHook=_e.bind(this,`leave`),this.getRoute=ve,this._pathToMatchObject=ge,this._clean=s,this._checkForAHash=ie,this._setCurrent=function(e){return m=i.current=e},function(){S&&(this.__popstateListener=function(){i.__freezeListening||fe()},window.addEventListener(`popstate`,this.__popstateListener))}.call(this),me.call(this)}}},t={};function n(r){if(t[r])return t[r].exports;var i=t[r]={exports:{}};return e[r](i,i.exports,n),i.exports}return n.d=function(e,t){for(var r in t)n.o(t,r)&&!n.o(e,r)&&Object.defineProperty(e,r,{enumerable:!0,get:t[r]})},n.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},n(407)}().default}))})),f=s(((e,t)=>{(function(n,r){var i={};n.PubSub?(i=n.PubSub,console.warn(`PubSub already loaded, using existing version`)):(n.PubSub=i,r(i)),typeof e==`object`?(t!==void 0&&t.exports&&(e=t.exports=i),e.PubSub=i,t.exports=e=i):typeof define==`function`&&define.amd&&define(function(){return i})})(typeof window==`object`&&window||e||global,function(e){var t={},n=-1,r=`*`;function i(e){for(var t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!0;return!1}function a(e){return function(){throw e}}function o(e,t,n){try{e(t,n)}catch(e){setTimeout(a(e),0)}}function s(e,t,n){e(t,n)}function c(e,n,r,i){var a=t[n],c=i?s:o,l;if(Object.prototype.hasOwnProperty.call(t,n))for(l in a)Object.prototype.hasOwnProperty.call(a,l)&&c(a[l],e,r)}function l(e,t,n){return function(){var i=String(e),a=i.lastIndexOf(`.`);for(c(e,e,t,n);a!==-1;)i=i.substr(0,a),a=i.lastIndexOf(`.`),c(e,i,t,n);c(e,r,t,n)}}function u(e){var n=String(e);return!!(Object.prototype.hasOwnProperty.call(t,n)&&i(t[n]))}function d(e){for(var t=String(e),n=u(t)||u(r),i=t.lastIndexOf(`.`);!n&&i!==-1;)t=t.substr(0,i),i=t.lastIndexOf(`.`),n=u(t);return n}function f(e,t,n,r){e=typeof e==`symbol`?e.toString():e;var i=l(e,t,r);return d(e)?(n===!0?i():setTimeout(i,0),!0):!1}e.publish=function(t,n){return f(t,n,!1,e.immediateExceptions)},e.publishSync=function(t,n){return f(t,n,!0,e.immediateExceptions)},e.subscribe=function(e,r){if(typeof r!=`function`)return!1;e=typeof e==`symbol`?e.toString():e,Object.prototype.hasOwnProperty.call(t,e)||(t[e]={});var i=`uid_`+String(++n);return t[e][i]=r,i},e.subscribeAll=function(t){return e.subscribe(r,t)},e.subscribeOnce=function(t,n){var r=e.subscribe(t,function(){e.unsubscribe(r),n.apply(this,arguments)});return e},e.clearAllSubscriptions=function(){t={}},e.clearSubscriptions=function(e){for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0&&delete t[n]},e.countSubscriptions=function(e){var n,r,i=0;for(n in t)if(Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0){for(r in t[n])i++;break}return i},e.getSubscriptions=function(e){var n,r=[];for(n in t)Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0&&r.push(n);return r},e.unsubscribe=function(n){var r=typeof n==`string`&&(Object.prototype.hasOwnProperty.call(t,n)||function(e){for(var n in t)if(Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0)return!0;return!1}(n)),i=!r&&typeof n==`string`,a=typeof n==`function`,o=!1,s,c,l;if(r){e.clearSubscriptions(n);return}for(s in t)if(Object.prototype.hasOwnProperty.call(t,s)){if(c=t[s],i&&c[n]){delete c[n],o=n;break}if(a)for(l in c)Object.prototype.hasOwnProperty.call(c,l)&&c[l]===n&&(delete c[l],o=!0)}return o}})})),p,m=o((()=>{p=Object.freeze({APP:`APP`,APP_READY:`APP.READY`,APP_ERROR:`APP.ERROR`,APP_SIGNOUT:`APP.SIGNOUT`,APP_AUTH:`APP.AUTH`,APP_USER_LOADED:`APP.USER.LOADED`,ROUTE_NAV:`ROUTE.NAV.GO`,ROUTE_NAV_BEFORE:`ROUTE.NAV.BEFORE`,ROUTE_NAV_AFTER:`ROUTE.NAV.AFTER`,ROUTE_NAV_ERROR:`ROUTE.NAV.ERROR`,AUTH_SIGNIN:`AUTH.SIGNIN.GO`,AUTH_SIGNIN_SUCCESS:`AUTH.SIGNIN.SUCCESS`,AUTH_SIGNIN_FAIL:`AUTH.SIGNIN.FAIL`,AUTH_SIGNUP:`AUTH.SIGNUP.GO`,AUTH_SIGNUP_SUCCESS:`AUTH.SIGNUP.SUCCESS`,AUTH_SIGNUP_FAIL:`AUTH.SIGNUP.FAIL`,AUTH_VERIFY_LINK:`AUTH.VERIFY.LINK`,AUTH_SIGNOUT:`AUTH.SIGNOUT.GO`,AUTH_SIGNOUT_SUCCESS:`AUTH.SIGNOUT.SUCCESS`,AUTH_FORGOT:`AUTH.FORGOT.GO`,AUTH_FORGOT_SUCCESS:`AUTH.FORGOT.SUCCESS`,AUTH_RESETHASH:`AUTH.RESETHASH.GO`,AUTH_RESETHASH_SUCCESS:`AUTH.RESETHASH.SUCCESS`,AUTH_RESETHASH_NAV:`AUTH.RESETHASH.NAV`,AUTH_TOKEN_EXPIRED:`AUTH.TOKEN.EXPIRED`,AUTH_TOKEN_INVALID:`AUTH.TOKEN.INVALID`,AUTH_SCOPE_LOADED:`AUTH.SCOPE.LOADED`,M5T_PRIMARY_NAV:`M5T_PRIMARY_NAV`,M5T_PRIMARY_NAV_LOGO_TAP:`M5T_PRIMARY_NAV.LOGO_TAP`,M5T_PRIMARY_NAV_HOVER:`M5T_PRIMARY_NAV.HOVER`,M5T_PRIMARY_NAV_TAP:`M5T_PRIMARY_NAV.TAP`,M5T_PRIMARY_NAV_DOUBLE_TAP:`M5T_PRIMARY_NAV.DOUBLE_TAP`,M5T_PRIMARY_NAV_LONG_TAP:`M5T_PRIMARY_NAV.LONG_TAP`,M5T_SIDE_NAV:`M5T_SIDE_NAV`,M5T_SIDE_NAV_TAP:`M5T_SIDE_NAV.TAP`,M5T_SIDE_NAV_COLLAPSE:`M5T_SIDE_NAV.COLLAPSE`,M5T_SIDE_NAV_LOGO_TAP:`M5T_SIDE_NAV.LOGO_TAP`,M5T_SIDE_NAV_ORG_SWITCH:`M5T_SIDE_NAV.ORG_SWITCH`,M5T_SIDE_NAV_FOOTER_ACTION:`M5T_SIDE_NAV.FOOTER_ACTION`,UI_LOADING_START:`UI.LOADING.START`,UI_LOADING_END:`UI.LOADING.END`,UI_TOAST:`UI.TOAST`,UI_MODAL_OPEN:`UI.MODAL.OPEN`,UI_MODAL_CLOSE:`UI.MODAL.CLOSE`,UI_THEME_CHANGED:`UI.THEME.CHANGED`,UI_WELCOME_BACK_CLICKED:`UI.WELCOME_BACK_CLICKED`,DATA_REFRESH:`DATA.REFRESH`,DATA_UPDATE:`DATA.UPDATE`,DATA_ERROR:`DATA.ERROR`,I18N:`I18N`,I18N_SET_LANG:`I18N.SET_LANG`,CONVERSATION:`CONVERSATION`,CONVERSATION_PROMPT:`CONVERSATION.PROMPT`,CONVERSATION_PROMPT_AGENT_CANVAS:`CONVERSATION.PROMPT.AGENT_CANVAS`,CONVERSATION_PROMPT_AGENT:`CONVERSATION.PROMPT.AGENT`,CONVERSATION_PROMPT_CANVAS:`CONVERSATION.PROMPT.CANVAS`,CONVERSATION_PROMPT_STAGE:`CONVERSATION.PROMPT.STAGE`,CONVERSATION_RESPONSE:`CONVERSATION.RESPONSE`,CONVERSATION_RESPONSE_CANVAS:`CONVERSATION.RESPONSE.CANVAS`,CONVERSATION_RESPONSE_WORKFLOW:`CONVERSATION.RESPONSE.WORKFLOW`,CANVAS:`CANVAS`,CANVAS_DO_SCROLL:`CANVAS.DO.SCROLL`,MESSAGE:`MESSAGE`,MESSAGE_CREATE:`MESSAGE.CREATE`,MESSAGE_CREATED:`MESSAGE.CREATED`,MESSAGE_EDIT:`MESSAGE.EDIT`,MESSAGE_UPDATED:`MESSAGE.UPDATED`,MESSAGE_DELETE:`MESSAGE.DELETE`,MESSAGE_DELETED:`MESSAGE.DELETED`,MESSAGE_REFRESH:`MESSAGE.REFRESH`})}));function h(e,t=null){if(e in v)return v[e];if(typeof process<`u`&&{}[e]){let t={}[e];return t===`true`?!0:t===`false`?!1:isNaN(t)?t:Number(t)}if({BASE_URL:`./`,DEV:!1,MODE:`production`,PROD:!0,SSR:!1,VITE_API_BASE_URL:`http://localhost:3333`}[e]){let t={BASE_URL:`./`,DEV:!1,MODE:`production`,PROD:!0,SSR:!1,VITE_API_BASE_URL:`http://localhost:3333`}[e];return t===`true`?!0:t===`false`?!1:isNaN(t)?t:Number(t)}return t}function g(e){return h(e,!1)===!0}function _(){return{...v}}var v,y=o((()=>{v=Object.freeze({FF_SSE_LS_SESSION_USER:`mvv_session_user`,FF_SSE_LS_TOKEN:`mvv`,FF_SSE_LS_THEME:`mvv_theme`,FF_SSE_UI_DARK_MODE:!0,FF_SSE_UI_ANIMATIONS:!0,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:`main_carousel_nav`,FF_CLIENT_LS_SESSION_ENTITY:`sse_entity`,FF_CLIENT_LS_DEEP_LINK:`sse_deeplink`,FF_CLIENT_ROUTE_SIGNIN:`signin_route`,FF_CLIENT_ROUTE_SIGNUP:`signup_route`,FF_CLIENT_ROUTE_HOME:`home_route`,FF_CLIENT_ROUTE_RESET_HASH:`resethash_route`,FF_CLIENT_ROUTE_RESET_FORGOT:`resetforgot_route`,FF_CLIENT_ROUTE_SIGNOUT:`signout_route`,FF_CLIENT_ROUTE_ERROR:`error_route`,FF_CLIENT_ROUTE_VERF_LINK:`verf_link_route`,FF_CLIENT_ROUTE_OFFLINE:`offline_route`,FF_CLIENT_PROTECTED_ROUTES:[`home_route`,`resethash_route`,`signout_route`,`user_management_route`],FF_CLIENT_ENDPOINT_SIGNIN:`/m5t/v5/acctEntity/signin`,FF_CLIENT_ENDPOINT_SIGNOUT:`/m5t/v5/acctEntity/signout`,FF_CLIENT_ENDPOINT_SIGNUP:`/m5t/v5/acctEntity/`,FF_CLIENT_ENDPOINT_RESET_HASH:`/m5t/v5/acctEntity/resetHash`,FF_CLIENT_ENDPOINT_RESET_FORGOT:`/m5t/v5/acctEntity/resetforgot`,FF_CLIENT_ENDPOINT_PING:`/ping`,FF_CLIENT_ENDPOINT_METER:`/m5t/v5/coreMeter/`,FF_CLIENT_METER_DEEP_LINK:`deep_link_access`,FF_CLIENT_METER_SIGNOUT_CLIENT:`signout_client_initiated`,FF_CLIENT_METER_SIGNOUT_SERVER:`signout_server_initiated`,FF_CLIENT_METER_PING_SUCCESS:`ping_auth_success`,FF_CLIENT_METER_PING_FAILURE:`ping_auth_failure`,FF_SSE_I18N_PRODUCT:`SSE`,FF_SSE_I18N_WHITELABEL:`M5T`,FF_SSE_I18N_LANG:`en`,FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:`mvv_user_lang`,FF_SSE_LS_WHITELABEL:`mvv_whitelabel`,FF_API_RATELIMIT_SIGNIN_ENFORCE:!0,FF_API_RATELIMIT_SIGNIN_IP_LIMIT:20,FF_API_RATELIMIT_SIGNIN_EMAIL_LIMIT:10,FF_API_RATELIMIT_FORGOT_ENFORCE:!0,FF_API_RATELIMIT_FORGOT_IP_LIMIT:15,FF_API_RATELIMIT_FORGOT_EMAIL_LIMIT:5,FF_API_RATELIMIT_CAPTURE_ENFORCE:!0,FF_API_RATELIMIT_CAPTURE_LIMIT:30,FF_API_RATELIMIT_EVENT_ENFORCE:!0,FF_API_RATELIMIT_EVENT_LIMIT:600,FF_API_RATELIMIT_CSP_PING_ENFORCE:!0,FF_API_RATELIMIT_CSP_PING_LIMIT:30,FF_API_RATELIMIT_WEBAUTHN_AUTH_ENFORCE:!0,FF_API_RATELIMIT_WEBAUTHN_AUTH_IP_LIMIT:20,FF_API_RATELIMIT_INTEGRATIONS_ENFORCE:!0,FF_API_RATELIMIT_INTEGRATIONS_LIMIT:60,FF_API_RATELIMIT_QUESTIONNAIRE_ENFORCE:!0,FF_API_RATELIMIT_QUESTIONNAIRE_LIMIT:30,FF_API_RATELIMIT_DELIVERABLE_ENFORCE:!0,FF_API_RATELIMIT_DELIVERABLE_LIMIT:30,FF_API_RATELIMIT_PAIRING_ENFORCE:!0,FF_API_RATELIMIT_PAIRING_LIMIT:20,FF_API_RATELIMIT_SITE_OPS_ENFORCE:!0,FF_API_RATELIMIT_SITE_OPS_LIMIT:120,FF_API_RATELIMIT_AUTHENTICATED_ENFORCE:!0,FF_API_RATELIMIT_AUTHENTICATED_LIMIT:600,FF_API_MAGNET_REQUIRE_ORIGIN_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_ENFORCE:!0,FF_API_RATELIMIT_GLOBAL_LIMIT:2e3}),typeof module<`u`&&module.exports&&(module.exports={FEATURE_FLAGS:v,getFlag:h,isEnabled:g,getAllFlags:_})})),ee=u(d(),1),b=u(f(),1);m(),y();var x={success:{border:`var(--color-success, #009473)`,bg:`var(--color-success-soft, rgba(0,148,115,0.10))`,icon:`check_circle`},danger:{border:`var(--color-danger, #DD4124)`,bg:`var(--color-danger-soft, rgba(221,65,36,0.09))`,icon:`error`},error:{border:`var(--color-danger, #DD4124)`,bg:`var(--color-danger-soft, rgba(221,65,36,0.09))`,icon:`error`},warning:{border:`var(--color-warning, #D97706)`,bg:`var(--color-warning-soft, #FEF3C7)`,icon:`warning`},info:{border:`var(--color-info, #0D9488)`,bg:`var(--color-info-soft, #CCFBF1)`,icon:`info`}},te=4500,ne=220,S=null,re=!1;function ie(){if(re)return;let e=document.createElement(`style`);e.id=`m5t-toast-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Pn=!0}function jn(){let e=new URLSearchParams(window.location.search||``),t=e.get(`uid`)||``,n=e.get(`token`)||``;if(!t||!n){let e=window.location.hash||``,r=e.includes(`?`)?e.slice(e.indexOf(`?`)+1):``,i=new URLSearchParams(r);if(t=t||i.get(`uid`)||``,n=n||i.get(`token`)||``,!t||!n){let r=e.replace(/^#\/?/,``).split(`?`)[0].split(`/`).filter(Boolean);t=t||r[1]||``,n=n||r[2]||``}}try{return{uid:decodeURIComponent(t),token:decodeURIComponent(n)}}catch{return{uid:t,token:n}}}function Mn(){return An(),`
    ...
    </a>`}var qn,Jn,Yn,Xn=o((()=>{Rn(),Bn(),Hn(),Wn(),qn=`https://www.machfivemarketing.com`,Jn=Un,Yn=Vn}));function k(e){if(!e)return``;try{return new Date(e).toLocaleString([],{dateStyle:`medium`,timeStyle:`short`})}catch{return String(e)}}function Zn(e,t={}){let n=t[e.id];if(e.type===`checkbox_group`){let e=Array.isArray(n)?n:[];return e.length?ir(e.join(`, `)):``}return n?ir(n):``}function Qn(e,{emptyLabel:t=`(blank)`,renderAnswer:n=null}={}){let r=e?.questionnaire?.sections||[],i=e?.answers||{};return r.length?r.map(e=>`
  ...
  `,document.head.appendChild(e),nr(),xr=!0}function dr(){return E.getConfig?.().BASE_URL||``}function fr(e){let t=`qf-${e.id}`;if(e.type===`checkbox_group`){let n=Array.isArray(e.options)?e.options:[];return`
    ...
    <div class="qf-page"><div class="qf-card">
      ...
      <p class="qf-sub">${t.submitted_tz?`Submitted ${A(k(t.submitted_tz))}.`:`Submitted.`} Here is what you sent.</p>
      <div class="qf-note qf-note--locked">
        <span class="material-symbols-outlined" aria-hidden="true">lock</span>
        <span>${A(_r(t))} To change anything now, contact your account manager.</span>
      </div>
      ${tr(t)}
      ${Qn(t,{emptyLabel:`Left blank`})}
         ...
         <span>You already submitted this${t.submitted_tz?` on ${A(k(t.submitted_tz))}`:``}.${s?` You can make changes until <strong>${A(k(s))}</strong>.`:``}</span>
       </div>`:``;e.innerHTML=`
    <div class="qf-page"><div class="qf-card">
      <img class="qf-brand" src="${Yn}" alt="Mach Five Marketing" height="34" />
      <h1>${A(t.questionnaire?.name||`Kickoff Questionnaire`)}</h1>
  ...
  `,document.head.appendChild(e),nr(),Yr=!0}function Fr(){return E.getConfig?.().BASE_URL||``}function j(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}function Ir(e,t){let n=t?.[e.id];return Array.isArray(n)?n.length>0:!!(n&&String(n).trim())}function Lr(e,t){let n=(e.questions||[]).filter(e=>Xr(e)&&Ir(e,t));return n.length?`<div class="dlf-plan">${n.map(e=>`
    <div class="dlf-plan__item">
      <div class="dlf-plan__label">${j(e.label)}</div>
    ...
    <div class="qm-qa">
      <div class="qm-qa__q">${j(e.label)}</div>
    ...
    <div class="dlf-page"><div class="dlf-card">
      ...
      ${n.map(e=>`
        <div class="dlf-section">
         ...
         <span class="material-symbols-outlined" aria-hidden="true">edit_note</span>
         <span>You already submitted this${t.submitted_tz?` on ${j(k(t.submitted_tz))}`:``}.${c?` You can make changes until <strong>${j(k(c))}</strong>.`:``}</span>
       </div>`:``;e.innerHTML=`
    <div class="dlf-page"><div class="dlf-card">
      <img class="dlf-brand" src="${Yn}" alt="Mach Five Marketing" height="34" />
      <h1>${j(t.template?.name||`Your Plan`)}</h1>
      <p class="dlf-sub">${j(l)}</p>
      ${u}
      <div class="dlf-progress">
        ...
        <div class="dlf-dots" role="group" aria-label="Sections">
          ${a.map((e,t)=>`<button type="button" class="dlf-dot" data-step="${t}" aria-label="${j(e.title)}"></button>`).join(``)}
        </div>
      </div>
    ...
    <div class="dlf-page"><div class="dlf-card"><div class="dlf-state">
      ...
      <div class="dlf-note dlf-note--done">
        <span class="material-symbols-outlined" aria-hidden="true">schedule</span>
        <span>Need to change something? This same link keeps working${j(r)}. Keep the email we sent you and open it again any time before then.</span>
      </div>
      <button class="dlf-btn" type="button" id="dlf-again">Make another change</button>
    </div></div></div>`,document.getElementById(`dlf-again`)?.addEventListener(`click`,()=>{Ur()})}var Yr,Xr,Zr,Qr=o((()=>{D(),_e(),Xn(),or(),Mr(),cr(),Yr=!1,Xr=e=>e.audience===`am`,Zr={render:Hr,init:Ur}})),$r=c({init:()=>ti,render:()=>ei});function ei(){return`
  ...
  `}function ti(){console.log(`[SplashRoute] Initialized - checking authentication state in 3.6 seconds...`),setTimeout(()=>{let e=localStorage.getItem(v.FF_SSE_LS_TOKEN),t=localStorage.getItem(`mvv_ts`);console.log(`[SplashRoute] localStorage check:`,{hasMvvToken:!!e,hasMvvTs:!!t});let n=document.getElementById(`splash-loader`),r=document.getElementById(`splash-actions`);e?(console.log(`[SplashRoute] Auth token found → HOME`),ni.default.publish(p.ROUTE_NAV,{route:`home`})):t?(console.log(`[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN`),ni.default.publish(p.ROUTE_NAV,{route:`signin`})):(console.log(`[SplashRoute] New user (no session history) → Showing buttons`),n&&(n.style.display=`none`),r&&(r.style.display=`flex`),document.querySelectorAll(`[data-route]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-route`);console.log(`[SplashRoute] Button clicked - navigating to: ${t}`),ni.default.publish(p.ROUTE_NAV,{route:t})})}))},4e3)}var ni,ri=o((()=>{ni=u(f(),1),Xn(),m(),y()}));function ii(e,t){typeof neodigmToast<`u`&&neodigmToast.q(t,`danger`),typeof neodigmUtils<`u`?neodigmUtils.shake(`#${e.id}`):(e.classList.add(`shake`),setTimeout(()=>e.classList.remove(`shake`),300)),e.focus()}function ai(e,t){return e?oi.test(e)?!0:(ii(t,O.get(`validation_email_invalid`)),!1):(ii(t,O.get(`validation_email_required`)),!1)}var oi,si=o((()=>{Lt(),oi=/^[^\s@]+@[^\s@]+\.[^\s@]+$/})),ci=c({init:()=>ui,render:()=>li});function li(){return`
  ...
  `}function xi(){console.log(`[SignupRoute] Initialized`);let e=document.getElementById(`signupForm`),t=e.querySelector(`button[type="submit"]`);Si(`togglePassword`,`password`,`eyeIcon`),Si(`toggleConfirmPassword`,`confirmPassword`,`eyeIconConfirm`),document.querySelector(`.auth-switch a[href="#/signin"]`)?.addEventListener(`click`,e=>{e.preventDefault(),console.log(`[SignupRoute] Sign in link clicked - navigating to signin`),Ei.default.publish(p.ROUTE_NAV,{route:`signin`})}),e.addEventListener(`submit`,async e=>{e.preventDefault();let n=document.getElementById(`first`).value.trim(),r=document.getElementById(`last`).value.trim(),i=document.getElementById(`email`).value.trim(),a=document.getElementById(`company`).value.trim(),o=document.getElementById(`phone`).value.trim(),s=document.getElementById(`password`).value,c=document.getElementById(`confirmPassword`).value,l=document.getElementById(`first`),u=document.getElementById(`last`),d=document.getElementById(`email`),f=document.getElementById(`password`),p=document.getElementById(`confirmPassword`);if(!Ci(n,l,O.get(`validation_first_name_required`))||!Ci(r,u,O.get(`validation_last_name_required`))||!ai(i,d)||!wi(s,f))return;if(s!==c){ii(p,O.get(`validation_password_mismatch`));return}let m=document.getElementById(`acceptTerms`);if(!m.checked){ii(m,`Please accept the Terms of Service and Privacy Policy to continue.`);return}t.disabled=!0,t.textContent=O.get(`loading_creating_account`),await Ti(n,r,i,a,o,s)})}function Si(e,t,n){let r=document.getElementById(e),i=document.getElementById(t),a=document.getElementById(n);!r||!i||!a||r.addEventListener(`click`,()=>{let e=i.type===`password`;i.type=e?`text`:`password`,e?a.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:a.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function Ci(e,t,n){return e?!0:(ii(t,n),!1)}function wi(e,t){if(!e)return ii(t,O.get(`validation_password_required`)),!1;let n=gi(e);return n.length>0?(ii(t,_i(n)),!1):!0}async function Ti(e,t,n,r,i,a){let o=document.querySelector(`button[type="submit"]`);try{let s={email:n,password:a,first:e,last:t};r&&(s.company=r),i&&(s.phone=i),s.terms_accepted=!0,s.legal_version=Di;let c=await E.doSignup(s);if(c.ok)Ei.default.publish(p.AUTH_SIGNUP_SUCCESS,{email:n}),typeof mvvLegit<`u`&&mvvLegit.doUNVERF();else{let e=c.error||c.message||O.get(`error_signup_failed`);typeof neodigmToast<`u`&&neodigmToast.q(e,`danger`),o.disabled=!1,o.textContent=(O.get(`create_account`)||`Create account`).toUpperCase(),Ei.default.publish(p.AUTH_SIGNUP_FAIL,{message:e})}}catch(e){console.error(`[SignupRoute] Sign up error:`,e),typeof neodigmToast<`u`&&neodigmToast.q(e.message||O.get(`error_network`),`danger`),o.disabled=!1,o.textContent=(O.get(`create_account`)||`Create account`).toUpperCase(),Ei.default.publish(p.AUTH_SIGNUP_FAIL,{message:e.message})}}var Ei,Di,Oi=o((()=>{Ei=u(f(),1),Xn(),m(),D(),vi(),Lt(),si(),Di=`2026-07-15`})),ki=c({init:()=>ji,render:()=>Ai});function Ai(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Gn()}
  ...
  `}function Bi(){console.log(`[ForgotRoute] Initialized`);let e=document.getElementById(`forgot-form`),t=document.getElementById(`email`);e?.addEventListener(`submit`,async e=>{e.preventDefault();let n=t.value.trim();ai(n,t)&&await Vi(n)})}async function Vi(e){let t=document.querySelector(`.btn`);t.disabled=!0,t.textContent=`SENDING...`;try{let n=await Ii.forgotPassword(e);n.ok&&n.data.ok?(typeof neodigmToast<`u`&&neodigmToast.q(O.get(`success_reset_link_sent`),`success`),Hi.default.publish(p.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate(`/verf-link`)},2e3)):(typeof neodigmToast<`u`&&neodigmToast.q(n.data.error||O.get(`error_signin_failed`),`danger`),t.disabled=!1,t.textContent=(O.get(`send_reset_link`)||`Send reset link`).toUpperCase())}catch(e){console.error(`[ForgotRoute] Forgot password error:`,e),typeof neodigmToast<`u`&&neodigmToast.q(e.message||O.get(`error_network`),`danger`),t.disabled=!1,t.textContent=(O.get(`send_reset_link`)||`Send reset link`).toUpperCase()}}var Hi,Ui=o((()=>{Hi=u(f(),1),Xn(),m(),Li(),Lt(),si()})),Wi=c({init:()=>Ki,render:()=>Gi});function Gi(){let e=E.getEntity()?.email||``;return`
    <div class="auth-container">
      <div class="auth-left">
        ${Gn(`#/home`)}
  ...
  `}function Ki(){console.log(`[ResethashRoute] Initialized`);let e=document.getElementById(`resethash-form`),t=e.querySelector(`button[type="submit"]`);qi(`toggleNewPassword`,`new-password`,`eyeIconNew`),qi(`toggleConfirmPassword`,`confirm-password`,`eyeIconConfirm`),e?.addEventListener(`submit`,async n=>{n.preventDefault();let r=e.email.value.trim(),i=e.newPassword.value,a=e.confirmPassword.value,o=document.getElementById(`new-password`),s=document.getElementById(`confirm-password`);if(!i){ii(o,O.get(`validation_new_password_required`));return}let c=gi(i);if(c.length>0){ii(o,_i(c));return}if(!a){ii(s,O.get(`validation_new_password_required`));return}if(i!==a){ii(s,O.get(`validation_password_mismatch`));return}t.disabled=!0,t.textContent=O.get(`loading_resetting_password`);try{let e=await E.doResetHash(r,i);e.ok?(typeof neodigmToast<`u`&&neodigmToast.q(O.get(`success_password_reset`),`success`),Ji.default.publish(p.AUTH_RESETHASH_SUCCESS,{email:r})):(ii(o,e.error||O.get(`error_signin_failed`)),t.disabled=!1,t.textContent=(O.get(`update_password`)||`Update password`).toUpperCase())}catch(e){console.error(`[ResethashRoute] Reset password error:`,e),ii(o,e.message||O.get(`error_network`)),t.disabled=!1,t.textContent=(O.get(`update_password`)||`Update password`).toUpperCase()}})}function qi(e,t,n){let r=document.getElementById(e),i=document.getElementById(t),a=document.getElementById(n);!r||!i||!a||r.addEventListener(`click`,()=>{let e=i.type===`password`;i.type=e?`text`:`password`,e?a.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:a.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}var Ji,Yi=o((()=>{Ji=u(f(),1),Xn(),m(),D(),vi(),Lt(),si()}));function Xi(){if(oa)return;let e=document.createElement(`style`);e.id=`m5t-portfolio-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),oa=!0}async function Zi(e,{days:t=30}={}){let n=new Date,r=sa(new Date(n.getTime()-(t-1)*864e5)),i=sa(n),a=await fetch(`${e}/m5t/v5/dashboard/stats?from=${r}&to=${i}&group_by=owner`);if(!a.ok)throw Error(`HTTP ${a.status}`);let o=await a.json();if(!o.ok)throw Error(`stats not ok`);return o.by_owner||[]}function Qi(e,t){let n=e;return`<div class="dash-clients-scroll"><table class="dash-clients">
    ...
    </div>`}async function na(e,t,{emptyMsg:n}={}){let r=document.getElementById(`pf-picker-body`);if(r)try{let i=await Zi(e);if(!i.length){r.innerHTML=ca(`groups`,n||`No client orgs yet. Create one under Clients first.`);return}r.innerHTML=Qi(i,t),ea(r)}catch(e){console.warn(`[portfolio] picker load failed:`,e),r.innerHTML=ca(`error`,`Could not load your clients. Please refresh.`)}}function ra(){let e={};return E.getManagedClients().forEach(t=>{e[t.orgGuid]=t.name}),E.getMemberships().forEach(t=>{t.orgGuid&&!e[t.orgGuid]&&(e[t.orgGuid]=t.name||``)}),e}var M,ia,aa,oa,sa,ca,la,ua=o((()=>{D(),Zt(),M=()=>E.getManagedClients().length>0&&!E.getStoredActiveOrg(),ia=e=>String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]),aa={reseller_org:`Your org`,managed_client:`Client`,saas_org:`Org`},oa=!1,sa=e=>e.toISOString().slice(0,10),ca=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,la=e=>e?`<span class="pf-client-chip">${ia(e)}</span>`:``}));function da(e,t){ha.set(e,t)}function fa(e){if(!ha.has(e))return null;let t=ha.get(e);return ha.delete(e),t}function pa(e){return ha.has(e)?ha.get(e):null}var ma,ha,ga=o((()=>{ma=Object.freeze({MAGNET_TEMPLATE:`magnet_template`,LEADS_SEARCH:`leads_search`,LEADS_DAY:`leads_day`}),ha=new Map}));function _a({icon:e,label:t,valueId:n,value:r=`—`,subId:i,sub:a=``,href:o,trendId:s}={}){let c=o?`a`:`div`;return`
  ...
  </${c}>`}var va,ya,ba=o((()=>{va={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},ya=e=>String(e??``).replace(/[&<>"']/g,e=>va[e])}));function xa(e){if(e<=0)return 1;let t=10**Math.floor(Math.log10(e)),n=e/t;return(n<=1?1:n<=2?2:n<=5?5:10)*t}function Sa(){if(ka)return;let e=document.createElement(`style`);e.id=`m5c-chart-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),ka=!0}function Ca({rows:e=[],xLabel:t=()=>``,left:n,right:r,ariaLabel:i=`Chart`,activatable:a=()=>!1,pointLabel:o=()=>``,hitData:s=()=>({})}){let c=e.length||1,l=n.fmt||Oa,u=r.fmt||Oa,d=xa(Math.max(1,...e.map(e=>n.value(e)||0))),f=xa(Math.max(1,...e.map(e=>r.value(e)||0))),p=738/c,m=Math.min(22,p*.55),h=e=>56+p*(e+.5),g=e=>266-e/d*248,_=e=>266-e/f*248,v=[0,.5,1].map(e=>{let t=266-e*248;return`<line x1="56" y1="${t.toFixed(1)}" x2="794" y2="${t.toFixed(1)}" class="m5c-grid"/><text x="48" y="${(t+3.5).toFixed(1)}" text-anchor="end" class="m5c-ax">${Da(l(d*e))}</text><text x="802" y="${(t+3.5).toFixed(1)}" text-anchor="start" class="m5c-ax">${Da(u(f*e))}</text>`}).join(``),y=e.map((e,t)=>{let r=g(n.value(e)||0);return`<rect class="m5c-bar" data-i="${t}" x="${(h(t)-m/2).toFixed(1)}" y="${r.toFixed(1)}" width="${m.toFixed(1)}" height="${Math.max(0,266-r).toFixed(1)}" rx="3"/>`}).join(``),ee=e.map((e,t)=>`${h(t).toFixed(1)},${_(r.value(e)||0).toFixed(1)}`).join(` `),b=c>1?`<polyline class="m5c-line" points="${ee}" fill="none" stroke-width="2.5"/>`:``,x=e.map((e,t)=>`<circle class="m5c-dot" data-i="${t}" cx="${h(t).toFixed(1)}" cy="${_(r.value(e)||0).toFixed(1)}" r="3.2"/>`).join(``),te=Math.max(1,Math.ceil(c/6)),ne=e.map((e,n)=>n%te===0||n===c-1?`<text x="${h(n).toFixed(1)}" y="288" text-anchor="middle" class="m5c-ax">${Da(t(e,n))}</text>`:``).join(``),S=e.map((e,t)=>{let n=!!a(e),r=Object.entries(s(e)||{}).map(([e,t])=>` data-${Da(e)}="${Da(t)}"`).join(``);return`<rect class="m5c-hit" data-i="${t}" data-activatable="${n}" tabindex="0" role="button" aria-label="${Da(o(e,t))}"${r} x="${(56+p*t).toFixed(1)}" y="18" width="${p.toFixed(1)}" height="${248 .toFixed(1)}" fill="transparent"/>`}).join(``);return`
    <div class="m5c-legend">
      <span><i class="m5c-sw m5c-sw--1"></i>${Da(n.label)}</span>
      <span><i class="m5c-sw m5c-sw--2"></i>${Da(r.label)}</span>
    </div>
    <div class="m5c-wrap">
      <svg class="m5c-chart" viewBox="0 0 840 300" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${Da(i)}">
        ${v}<line class="m5c-crosshair" x1="0" y1="18" x2="0" y2="266" pointer-events="none"/>${y}${b}${x}${ne}${S}
      </svg>
      <div class="m5c-tip" role="status" hidden></div>
    </div>`}function wa(){try{return!window.matchMedia||window.matchMedia(`(hover: hover)`).matches}catch{return!0}}function Ta(e,{rows:t=[],tipHTML:n,onActivate:r}={}){if(!e?.addEventListener||typeof n!=`function`)return()=>{};let i=()=>e.querySelector(`.m5c-wrap`),a=()=>e.querySelector(`.m5c-tip`),o=e=>{e.querySelectorAll(`.m5c-bar--on, .m5c-dot--on, .m5c-hit--on`).forEach(e=>e.classList.remove(`m5c-bar--on`,`m5c-dot--on`,`m5c-hit--on`)),e.querySelector(`.m5c-crosshair`)?.classList.remove(`m5c-crosshair--on`)},s=(e,t,n)=>{o(e),e.querySelector(`.m5c-bar[data-i="${t}"]`)?.classList.add(`m5c-bar--on`),e.querySelector(`.m5c-dot[data-i="${t}"]`)?.classList.add(`m5c-dot--on`),n.classList.add(`m5c-hit--on`);let r=e.querySelector(`.m5c-crosshair`);if(r){let e=Number(n.getAttribute(`x`))+Number(n.getAttribute(`width`))/2;r.setAttribute(`x1`,e),r.setAttribute(`x2`,e),r.classList.add(`m5c-crosshair--on`)}},c=(e,r)=>{let o=i(),c=a(),l=t[e];if(!o||!c||!l||!r)return;c.innerHTML=n(l,e);let u=r.getBoundingClientRect(),d=o.getBoundingClientRect(),f=u.left-d.left+u.width/2,p=(c.offsetWidth||0)/2;p&&(f=Math.min(Math.max(f,p+4),Math.max(p+4,d.width-p-4))),c.style.left=`${f}px`,c.style.top=`${u.top-d.top}px`,c.hidden=!1,s(o,e,r)},l=()=>{let e=i(),t=a();t&&(t.hidden=!0),e&&o(e)},u=t=>{let n=t.target.closest?.(`.m5c-hit`);return n&&e.contains(n)?n:null},d=e=>Number(e?.dataset?.i),f=e=>{let n=d(e),i=t[n];!i||e.dataset.activatable!==`true`||typeof r!=`function`||r(i,n)},p=e=>{let t=u(e);t&&c(d(t),t)},m=t=>{let n=t.relatedTarget;n&&e.contains(n)&&n.closest?.(`.m5c-hit`)||l()},h=e=>{let t=u(e);if(!t)return;let n=t.classList.contains(`m5c-hit--on`);c(d(t),t),!(!wa()&&!n)&&f(t)},g=e=>{let t=u(e);t&&c(d(t),t)},_=t=>{let n=t.relatedTarget;n&&e.contains(n)&&n.closest?.(`.m5c-hit`)||l()},v=t=>{let n=u(t);if(!n)return;let r=[...e.querySelectorAll(`.m5c-hit`)],i=r.indexOf(n),a=e=>{let n=r[Math.max(0,Math.min(r.length-1,e))];n&&(t.preventDefault(),n.focus?.(),c(d(n),n))};switch(t.key){case`Enter`:case` `:case`Spacebar`:t.preventDefault(),f(n);break;case`ArrowRight`:a(i+1);break;case`ArrowLeft`:a(i-1);break;case`Home`:a(0);break;case`End`:a(r.length-1);break;case`Escape`:l(),n.blur?.()}};return e.addEventListener(`mouseover`,p),e.addEventListener(`mouseout`,m),e.addEventListener(`click`,h),e.addEventListener(`focusin`,g),e.addEventListener(`focusout`,_),e.addEventListener(`keydown`,v),()=>{e.removeEventListener(`mouseover`,p),e.removeEventListener(`mouseout`,m),e.removeEventListener(`click`,h),e.removeEventListener(`focusin`,g),e.removeEventListener(`focusout`,_),e.removeEventListener(`keydown`,v)}}var Ea,Da,Oa,ka,Aa=o((()=>{Ea={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Da=e=>String(e??``).replace(/[&<>"']/g,e=>Ea[e]),Oa=e=>{let t=Math.round(e);return t>=1e3?`${(t/1e3).toFixed(t%1e3==0?0:1)}k`:String(t)},ka=!1})),ja=c({default:()=>to,init:()=>La,render:()=>Ia,statCard:()=>_a,svgTrendChart:()=>Ha,wireTrendTooltip:()=>Wa});function Ma(e){let t=e.created?.created_tz;if(!t)return``;try{return new Date(t).toLocaleDateString([],{month:`short`,day:`numeric`})}catch{return``}}function Na(e){try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return``}}function Pa(){if(Sa(),Ya)return;let e=document.createElement(`style`);e.id=`m5t-dash-recent-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Ya=!0}function Fa(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${Ka(Ja(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${Ka(qa(e))}</span>
      <span class="recent-lead__sub">${Ka(e.email||e.phone||``)}</span>
    </span>
    <span class="m5t-badge recent-lead__badge" data-s="${Ka(e.status)}">${Ka(e.status)}</span>
    <span class="recent-lead__time">${Ka(Ma(e))}</span>
  </a>`}function Ia(){Pa(),Xi();let e=M();return`
    <div class="page-shell" data-section="home">
      ...
      <div class="dashboard-card dashboard-card--lead">
        ...
        <div class="card-body" id="dash-portfolio">${Ga(`hourglass_empty`,`Loading…`)}</div>
      </div>`:``}
      ...
      <div class="charts-section">
        ${Xa(`show_chart`,`Opens & Leads`,`dash-trend`,{wide:!0,controls:!0})}
        <div class="charts-grid">
          ${Xa(`filter_alt`,`Completion Funnel`,`dash-funnel`)}
          ${Xa(`source`,`Top Campaigns`,`dash-campaigns`)}
          ${Xa(`touch_app`,`CTA Usage`,`dash-routes`,{full:!0})}
        </div>
      </div>
      ...
      <div class="content-grid">
        ...
        <div class="dashboard-card">
          ...
          <div class="card-body" id="recent-leads-body">
            ${Ga(`hourglass_empty`,`Loading leads…`)}
          </div>
        </div>
      </div>
    </div>`}async function La(){let e=E.getConfig?.().BASE_URL||``;document.getElementById(`dash-periods`)?.addEventListener(`click`,t=>{let n=t.target.closest(`button[data-days]`);n&&(Za=Number(n.dataset.days)||30,document.querySelectorAll(`#dash-periods .chart-period-btn`).forEach(e=>e.classList.toggle(`active`,Number(e.dataset.days)===Za)),Ra(e))}),document.getElementById(`dash-campaigns`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-campaign]`);t&&da(ma.LEADS_SEARCH,t.dataset.campaign)}),await Promise.all([Ra(e),Va(e)])}async function Ra(e){let t=new Date,n=eo(new Date(t.getTime()-(Za-1)*864e5)),r=eo(t),i=M(),a;try{let t=await fetch(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${r}${i?`&group_by=owner`:``}`);if(!t.ok)throw Error(`HTTP ${t.status}`);if(a=await t.json(),!a.ok)throw Error(`stats not ok`)}catch(e){console.warn(`[dashboard] stats fetch failed:`,e),[`stat-active-magnets`,`stat-opens`,`stat-leads`,`stat-completion`].forEach(e=>Qa(e,`—`)),[`stat-active-magnets-sub`,`stat-opens-sub`,`stat-leads-sub`,`stat-completion-sub`].forEach(e=>Qa(e,`Unavailable`));let t=document.getElementById(`stat-leads-trend`);t&&(t.className=`stat-trend`,t.innerHTML=``),[`dash-trend`,`dash-funnel`,`dash-campaigns`,`dash-routes`,`dash-interactions`,`dash-portfolio`].forEach(e=>$a(e,Ga(`error`,`Could not load. Please refresh.`)));return}i&&za(a.by_owner||[]),Qa(`stat-active-magnets`,N(a.magnets.active)),Qa(`stat-active-magnets-sub`,a.magnets.total>a.magnets.active?`${N(a.magnets.total-a.magnets.active)} paused`:a.magnets.active?`All running`:`No magnets yet`);let o=a.funnel||{};Qa(`stat-opens`,o.opens?N(o.opens):`—`),Qa(`stat-opens-sub`,o.opens?o.engagement_rate==null?`${N(o.engaged)} engaged`:`${o.engagement_rate}% engage`:`No opens in this range yet`);let s=a.leads||{};Qa(`stat-leads`,N(s.total));let c=(s.this_week||0)-(s.prev_week||0);Qa(`stat-leads-sub`,s.total?`${N(s.this_week)} this week`:`No leads yet`);let l=document.getElementById(`stat-leads-trend`);if(l){if((s.prev_week||0)>0){let e=c>0?`positive`:c<0?`negative`:`neutral`,t=c>0?`trending_up`:c<0?`trending_down`:`trending_flat`;l.className=`stat-trend ${e}`,l.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">${t}</span>${c>0?`+`:``}${N(c)}`}else l.className=`stat-trend`,l.innerHTML=``}Qa(`stat-completion`,o.completion_rate==null?`—`:`${o.completion_rate}%`),Qa(`stat-completion-sub`,o.opens?`${N(o.completions)} completed of ${N(o.opens)} opens`:`Appears once magnets get opened`);let u=a.by_day||[],d=u.some(e=>e.opens||e.leads);$a(`dash-trend`,d?Ha(u):Ga(`show_chart`,`No activity in this range yet. Opens and leads chart here as visitors engage your magnets.`)),d&&Wa(u),$a(`dash-funnel`,o.opens?Ba(o):Ga(`filter_alt`,`The funnel fills in once your magnets record opens.`));let f=a.top_campaigns||[];$a(`dash-campaigns`,f.length?`<div class="dash-list">${f.map(e=>`
        <a class="dash-list__row dash-list__row--link" href="#/leads" data-campaign="${Ka(e.campaign)}" title="Show the leads from ${Ka(e.campaign)}">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">campaign</span></span>
          <span class="dash-list__main">${Ka(e.campaign)}</span>
        ...
        </a>`).join(``)}</div>`:Ga(`source`,`No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here.`));{let e=document.getElementById(`dash-campaigns`)?.querySelector(`.dash-list`);e&&Yt(e,{rowSelector:`.dash-list__row`,noun:`campaigns`})}let p={book:[`event`,`Book`],chat:[`chat`,`Chat`],call:[`phone_in_talk`,`Call`],email:[`mail`,`Email`],support:[`support_agent`,`Support`]},m=Object.entries(o.routes||{}).sort((e,t)=>t[1]-e[1]),h=m.length?m[0][1]:0;$a(`dash-routes`,m.length?`<div class="dash-funnel">${m.map(([e,t])=>{let[n,r]=p[e]||[`touch_app`,e];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${n}</span> ${Ka(r)}</span><span class="dash-funnel__val">${N(t)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${h?Math.max(4,Math.round(t/h*100)):0}%"></div></div>
        </div>`}).join(``)}</div>`:Ga(`touch_app`,`CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar.`));let g={open:[`visibility`,`Magnet opened`],engage:[`touch_app`,`Visitor engaged`],route:[`alt_route`,`Picked a channel`],complete:[`check_circle`,`Completed: lead captured`]},_=a.recent_events||[];$a(`dash-interactions`,_.length?`<div class="dash-list">${_.map(e=>{let[t,n]=g[e.event]||[`sensors`,e.event];return`<div class="dash-list__row">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">${t}</span></span>
          <span class="dash-list__main">${n}${e.event===`route`&&e.detail?` · ${Ka(e.detail)}`:``}</span>
          ${e.display_mode?`<span class="dash-list__mode">${Ka(e.display_mode)}</span>`:``}
          <span class="dash-list__time">${Ka(Na(e.at))}</span>
        </div>`}).join(``)}</div>`:Ga(`sensors`,`No interactions yet. They'll stream in as visitors engage your magnets.`));{let e=document.getElementById(`dash-interactions`)?.querySelector(`.dash-list`);e&&Yt(e,{rowSelector:`.dash-list__row`,noun:`interactions`})}}function za(e){let t=document.getElementById(`dash-portfolio`);if(!t)return;if(!e.length){t.innerHTML=Ga(`groups`,`No client orgs yet. Create one under Clients to see its numbers here.`);return}let n=e.some(e=>e.ad),r=e=>{let t=(e.leads.this_week||0)-(e.leads.prev_week||0);return!e.leads.this_week&&!e.leads.prev_week?``:` <span class="${t>=0?`dc-delta-up`:`dc-delta-down`}">(${t>=0?`+`:``}${N(t)})</span>`};t.innerHTML=Qi(e,[{h:`Magnets`,td:e=>`${N(e.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${N(e.magnets.total)}</span>`},{h:`Leads · wk`,td:e=>`${N(e.leads.this_week)}${r(e)}`},{h:`Leads · total`,td:e=>N(e.leads.total)},{h:`Opens`,td:e=>N(e.opens)},{h:`Compl.`,td:e=>e.completion_rate==null?`—`:`${e.completion_rate}%`},...e.some(e=>e.ab_tests?.running||e.ab_tests?.completed)?[{h:`A/B`,td:e=>e.ab_tests?.running?`${N(e.ab_tests.running)} <span class="dc-sub">running</span>`:e.ab_tests?.completed?`${N(e.ab_tests.completed)} <span class="dc-sub">done</span>`:`—`}]:[],...e.some(e=>e.booked)?[{h:`Booked`,td:e=>e.booked?N(e.booked):`—`}]:[],...e.some(e=>e.called)?[{h:`Called`,td:e=>e.called?N(e.called):`—`}]:[],...n?[{h:`Spend`,td:e=>e.ad?`$${N(e.ad.spend)}`:`—`},{h:`CPL`,td:e=>e.ad?.cost_per_lead==null?`—`:`$${N(e.ad.cost_per_lead)}`}]:[]]),ea(t)}function Ba(e){let t=[[`Opened`,e.opens,``],[`Engaged`,e.engaged,` dash-funnel__bar--mid`],[`Completed`,e.completions,` dash-funnel__bar--end`],...e.booked?[[`Booked`,e.booked,` dash-funnel__bar--end`]]:[],...e.called?[[`Called`,e.called,` dash-funnel__bar--end`]]:[]],n=Math.max(1,e.opens||0),r=e=>Math.min(100,Math.round((e||0)/n*100));return`<div class="dash-funnel">${t.map(([e,t,n])=>`
    <div class="dash-funnel__row">
    ...
    </div>`).join(``)}</div>`}async function Va(e){let t=document.getElementById(`recent-leads-body`);if(t)try{let n=await fetch(`${e}/m5t/v5/m5mLead?limit=5`);if(!n.ok)throw Error(`HTTP ${n.status}`);let r=await n.json(),i=(Array.isArray(r?.data)?r.data:[]).filter(e=>![`DELETED`,`ARCHIVED`].includes(e.status));t.innerHTML=i.length?i.slice(0,5).map(Fa).join(``):Ga(`contacts`,`No leads captured yet. Publish a magnet to start collecting.`)}catch(e){console.warn(`[dashboard] Leads fetch failed:`,e),t.innerHTML=Ga(`error`,`Could not load recent leads.`)}}function Ha(e){return Ca({rows:e,xLabel:e=>String(e.date||``).slice(5),left:{value:e=>e.opens||0,label:`Magnet Opens`},right:{value:e=>e.leads||0,label:`Leads`},ariaLabel:`Magnet opens versus leads over time`,activatable:e=>Number(e.leads||0)>0,pointLabel:e=>`${Ua(e.date)}: ${N(e.opens||0)} opens, ${N(e.leads||0)} leads`,hitData:e=>({day:e.date,leads:Number(e.leads||0)})})}function Ua(e){try{return new Date(`${e}T00:00:00`).toLocaleDateString(void 0,{month:`short`,day:`numeric`,year:`numeric`})}catch{return e}}function Wa(e){let t=document.getElementById(`dash-trend`);return t?Ta(t,{rows:e,tipHTML:e=>`
      <div class="m5c-tip__title">${Ua(e.date)}</div>
      ...
      ${Number(e.leads||0)>0?`<div class="m5c-tip__go">Open these leads →</div>`:``}`,onActivate:e=>{da(ma.LEADS_DAY,e.date),window.location.hash=`#/leads`}}):()=>{}}var Ga,Ka,N,qa,Ja,Ya,Xa,Za,Qa,$a,eo,to,no=o((()=>{D(),ua(),ga(),ba(),Aa(),Zt(),Ga=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Ka=e=>String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]),N=e=>Number(e||0).toLocaleString(),qa=e=>[e.first_name,e.last_name].filter(Boolean).join(` `).trim()||e.email||`(no name)`,Ja=e=>(qa(e).split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``)||`?`).toUpperCase(),Ya=!1,Xa=(e,t,n,{wide:r=!1,full:i=!1,controls:a=!1}={})=>`
  <div class="dashboard-card${r?` chart-card-wide`:``}${i?` chart-card-full`:``}">
    ...
    <div class="card-body" id="${n}">${Ga(`hourglass_empty`,`Loading…`)}</div>
  </div>`,Za=30,Qa=(e,t)=>{let n=document.getElementById(e);n&&(n.textContent=t)},$a=(e,t)=>{let n=document.getElementById(e);n&&(n.innerHTML=t)},eo=e=>e.toISOString().slice(0,10),to={render:Ia,init:La}})),ro=c({init:()=>ao,render:()=>io});function io(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Gn(`#/home`)}
  ...
  `}function ao(){console.log(`[SignoutRoute] Initialized`);let e=document.getElementById(`confirm-signout-btn`);e?.addEventListener(`click`,async()=>{e.disabled=!0,e.textContent=`SIGNING OUT...`,console.log(`[SignoutRoute] User confirmed signout`),await E.doSignout()})}var oo=o((()=>{D(),Xn()})),so=c({default:()=>po,init:()=>uo,render:()=>lo});function co(){if(fo)return;let e=document.createElement(`style`);e.id=`m5t-section-page-styles`,e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),fo=!0}function lo({title:e=`Section`,icon:t=`widgets`,name:n=``}={}){return co(),`
    ...
    </section>`}function uo(){}var fo,po,mo=o((()=>{fo=!1,po={render:lo,init:uo}})),ho=c({default:()=>Lo,init:()=>So,render:()=>xo});function go(){if(Fo)return;let e=document.createElement(`style`);e.id=`m5t-settings-general-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Fo=!0}function _o(){try{return Rt.getAvailableLanguages()||[]}catch{return[]}}function vo(){let e=_o(),t=e.includes(v.FF_SSE_I18N_LANG)?v.FF_SSE_I18N_LANG:e[0]||v.FF_SSE_I18N_LANG;try{let n=localStorage.getItem(v.FF_SSE_LS_USER_LANG);return n&&e.includes(n)?n:t}catch{return t}}function yo(e){try{let t=new Intl.DisplayNames([e],{type:`language`}).of(e);if(t&&t!==e)return t.charAt(0).toUpperCase()+t.slice(1)}catch{}return e}function bo(){let e=_n(),t=_o(),n=t.length>1;if(!e&&!n)return``;let r=vo();return`
        ...
        <div class="settings-item" id="gen-lang-item">
          ...
          <div class="settings-item__control">
            <select class="settings-select" id="gen-lang" aria-label="Language">
              ${t.map(e=>`<option value="${Ao(e)}" ${e===r?`selected`:``}>${Ao(yo(e))}</option>`).join(``)}
            </select>
          </div>
        </div>`:``}
      </div>
    </div>`}function xo(){return go(),`
    <div class="page-shell" data-section="settings-general">
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ...
          <div id="gen-profile-body">${Io(`hourglass_empty`,`Loading…`)}</div>
        </div>
      </div>
    ...
    </div>`}async function So(){Do(),await wo()}function Co(e){return`
    <div class="settings-grid-2">
      <div class="settings-field">
        <label class="settings-label" for="gen-first">First name</label>
        <input class="settings-input" id="gen-first" type="text" autocomplete="given-name" value="${Ao(e.first)}" />
        <p class="settings-error" id="gen-first-error" role="alert" hidden></p>
      </div>
      <div class="settings-field">
        <label class="settings-label" for="gen-last">Last name</label>
        <input class="settings-input" id="gen-last" type="text" autocomplete="family-name" value="${Ao(e.last)}" />
        <p class="settings-error" id="gen-last-error" role="alert" hidden></p>
      </div>
    </div>
    <div class="settings-field">
      <label class="settings-label" for="gen-company">Company</label>
      <input class="settings-input" id="gen-company" type="text" autocomplete="organization" value="${Ao(e.company)}" />
    </div>
    <div class="settings-field">
      <label class="settings-label" for="gen-phone">Phone</label>
      <input class="settings-input" id="gen-phone" type="tel" autocomplete="tel" value="${Ao(e.phone)}" />
    </div>
    <div class="settings-field">
      <label class="settings-label" for="gen-email">Sign-in email</label>
      <input class="settings-input" id="gen-email" type="email" value="${Ao(e.email)}" readonly />
    ...
    </div>`}async function wo(){let e=document.getElementById(`gen-profile-body`);if(e){try{let e=await fetch(No()),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok||!t.data)throw Error(t.error||`Failed to load`);Po.profile=t.data}catch(t){console.warn(`[settings-general] profile load failed:`,t),e.innerHTML=Io(`error`,`Could not load your profile. Please try again.`);return}e.innerHTML=Co(Po.profile),e.querySelector(`#gen-save`)?.addEventListener(`click`,Eo)}}function To(e,t){let n=document.getElementById(`${e}-error`);n&&(n.textContent=t||``,n.hidden=!t);let r=document.getElementById(e);r&&r.setAttribute(`aria-invalid`,t?`true`:`false`)}async function Eo(){let e=document.getElementById(`gen-save`),t=e=>(document.getElementById(e)?.value??``).trim(),n={first:t(`gen-first`),last:t(`gen-last`),company:t(`gen-company`),phone:t(`gen-phone`)};if(To(`gen-first`,n.first?``:`First name is required.`),To(`gen-last`,n.last?``:`Last name is required.`),!(!n.first||!n.last)){e&&(e.disabled=!0);try{let e=await fetch(No(),{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify(n)}),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(t.error||`Could not save.`);t.data&&(Po.profile=t.data),jo(`Profile updated.`,`success`)}catch(e){console.warn(`[settings-general] profile save failed:`,e),jo(e.message||`Could not save.`,`error`)}finally{e&&(e.disabled=!1)}}}function Do(){let e=document.getElementById(`gen-dark`);if(e){e.addEventListener(`change`,()=>{Tn(e.checked?`dark`:`light`),e.checked=wn()===`dark`});let t=Oo.default.subscribe(p.UI_THEME_CHANGED,()=>{if(!e.isConnected){Oo.default.unsubscribe(t);return}e.checked=wn()===`dark`})}let t=document.getElementById(`gen-lang`);t&&t.addEventListener(`change`,()=>{try{Rt.setLanguage(t.value)}catch(e){console.warn(`[settings-general] setLanguage failed:`,e)}})}var Oo,ko,Ao,jo,Mo,No,Po,Fo,Io,Lo,Ro=o((()=>{D(),Oo=u(f(),1),m(),y(),On(),xn(),ko={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Ao=e=>String(e??``).replace(/[&<>"']/g,e=>ko[e]),jo=(e,t=`info`)=>{try{Oo.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Mo=()=>E.getConfig?.().BASE_URL||``,No=()=>`${Mo()}/m5t/v5/acctEntity/profile`,Po={profile:null},Fo=!1,Io=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Lo={render:xo,init:So}})),zo=c({default:()=>ms,init:()=>Ho,render:()=>Vo});function Bo(){if(ds)return;let e=document.createElement(`style`);e.id=`m5t-workspace-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),ds=!0}function Vo(){Bo();let e=as[ls()];return`
    <div class="page-shell" data-section="settings-workspace">
      <div class="page-header">
        <div class="page-header-text">
          <div class="ws-title-row">
            <h1 class="page-title">Workspace</h1>
            ${e?`<span class="m5t-chip">${es(e)}</span>`:``}
          </div>
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ${ps(`apartment`,`Organization`,`Name and details.`)}
          <div id="ws-org-body">${fs(`hourglass_empty`,`Loading…`)}</div>
        </div>
      </div>

      <div class="dashboard-card" id="ws-team-card" style="margin-top:24px; display:none">
        <div class="card-body">
          ${ps(`group`,`Team`,`Who has access.`)}
          <div id="ws-team-body"></div>
        </div>
      </div>
    </div>`}async function Ho(){ss.org=null,await Uo(),await Jo()}async function Uo(){let e=document.getElementById(`ws-org-body`);if(!e)return;let t=cs();if(!t){e.innerHTML=fs(`apartment`,`No workspace on this account yet.`);return}try{let e=await fetch(`${ns()}/m5t/v5/acctGroup`),n=await e.json().catch(()=>({}));if(!e.ok||!n.ok)throw Error(n.error||`Failed (HTTP ${e.status})`);if(ss.org=(n.data||[]).find(e=>e.guid===t)||null,!ss.org)throw Error(`Org row not in scope`)}catch(t){console.warn(`[settings-workspace] load failed:`,t),e.innerHTML=fs(`error`,`Could not load your workspace. Please try again.`);return}Go()}function Wo(){let e=as[ls()]||``,t=ss.org?.created?.created_tz,n=``;if(t){let e=new Date(t);Number.isNaN(e.getTime())||(n=`Created ${e.toLocaleDateString()}`)}let r=[e,n].filter(Boolean);return r.length?`<p class="settings-help">${es(r.join(` · `))}</p>`:``}function Go(){let e=document.getElementById(`ws-org-body`);if(!e)return;let t=ss.org||{};if(!us()){let n=ls()===is?`<div class="settings-note"><span class="material-symbols-outlined" aria-hidden="true">info</span> This workspace is managed for you.</div>`:``;e.innerHTML=`
      <div class="settings-item">
        <div class="settings-item__info">
          <div class="settings-item__title">Organization name</div>
          <div class="settings-item__desc">${es(t.caption||`Not set`)}</div>
        </div>
      </div>
      <div class="settings-item">
        <div class="settings-item__info">
          <div class="settings-item__title">Description</div>
          <div class="settings-item__desc">${es(t.description||`Not set`)}</div>
        </div>
      </div>
      ${n}
      <div style="margin-top:12px">${Wo()}</div>`;return}e.innerHTML=`
    <div class="settings-field">
      <label class="settings-label" for="ws-name">Organization name</label>
      <input class="settings-input" id="ws-name" type="text" required value="${es(t.caption||``)}" />
    </div>
    <div class="settings-field">
      <label class="settings-label" for="ws-desc">Description</label>
      <textarea class="settings-input" id="ws-desc" rows="2">${es(t.description||``)}</textarea>
    </div>
    <p class="settings-error" id="ws-org-error"></p>
    <div class="settings-save-row">
      ${Wo()}
      <button class="btn btn-primary" type="button" id="ws-save">Save</button>
    </div>`,document.getElementById(`ws-save`)?.addEventListener(`click`,Ko)}async function Ko(){let e=document.getElementById(`ws-save`),t=document.getElementById(`ws-org-error`),n=(document.getElementById(`ws-name`)?.value||``).trim(),r=(document.getElementById(`ws-desc`)?.value||``).trim();if(t&&(t.textContent=``),!n){t&&(t.textContent=`Organization name is required.`);return}e&&(e.disabled=!0);try{let e=await fetch(`${ns()}/m5t/v5/acctGroup/${encodeURIComponent(ss.org.id)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({caption:n,description:r})}),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(t.message||t.error||`Failed (HTTP ${e.status})`);ss.org={...ss.org,caption:n,description:r},ts(`Workspace updated.`,`success`)}catch(t){console.warn(`[settings-workspace] save failed:`,t),ts(t.message||`Could not save`,`danger`),e&&(e.disabled=!1);return}e&&(e.disabled=!1);try{await E.fetchScope?.()}catch(e){console.warn(`[settings-workspace] fetchScope after save failed:`,e)}}function qo(){document.getElementById(`ws-team-card`)?.remove()}async function Jo(){let e=document.getElementById(`ws-team-card`);if(!e)return;let t=cs();if(!t||!us()){qo();return}let n=[],r=[];try{let[e,i]=await Promise.all([fetch(`${ns()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/members`),fetch(`${ns()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/invites`)]);if(e.status===403||i.status===403){qo();return}let[a,o]=await Promise.all([e.json().catch(()=>({})),i.json().catch(()=>({}))]);if(!e.ok||!i.ok)throw Error(`members: ${e.status}, invites: ${i.status}`);n=a.members||[],r=o.invites||[]}catch(t){console.warn(`[settings-workspace] team load failed:`,t),e.style.display=``;let n=document.getElementById(`ws-team-body`);n&&(n.innerHTML=fs(`error`,`Could not load your team. Please try again.`));return}Zo(n,r)}function Yo(e){if(!e.length)return``;let t=e.slice(0,os),n=e.length-t.length;return`
    <div class="ws-avatars">
      ${t.map(e=>`<span class="ws-avatar" title="${es(e.name||e.email)}">${es(rs(e.name||e.email))}</span>`).join(``)}
      ${n>0?`<span class="ws-avatar ws-avatar--more">+${n}</span>`:``}
    </div>`}function Xo(e,t){let n=`${e.length} member${e.length===1?``:`s`}`;return t.length?`${n} · ${t.length} pending invite${t.length===1?``:`s`}`:n}function Zo(e,t){let n=document.getElementById(`ws-team-card`),r=document.getElementById(`ws-team-body`);if(!n||!r)return;n.style.display=``;let i=ls()!==is;r.innerHTML=`
    ${Yo(e)}
    <p class="ws-counts">${es(Xo(e,t))}</p>
    ${i?`<div class="ws-team-actions"><a class="btn btn-secondary" href="#/team">Manage team</a></div>`:``}`}var Qo,$o,es,ts,ns,rs,is,as,os,ss,cs,ls,us,ds,fs,ps,ms,hs=o((()=>{D(),Qo=u(f(),1),m(),$o={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},es=e=>String(e??``).replace(/[&<>"']/g,e=>$o[e]),ts=(e,t=`info`)=>{try{Qo.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},ns=()=>E.getConfig?.().BASE_URL||``,rs=e=>String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``).toUpperCase()||`?`,is=`managed_client`,as={reseller_org:`Your organization`,managed_client:`Client workspace`,saas_org:`Organization`},os=6,ss={org:null},cs=()=>E.getActiveOrg()?.guid||E.getMemberships()[0]?.orgGuid||null,ls=()=>E.getActiveOrg()?.channel||E.getMemberships()[0]?.channel||null,us=()=>E.getCapabilities().includes(`manage_team`),ds=!1,fs=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,ps=(e,t,n)=>`
  <div class="settings-section__head">
  ...
  </div>`,ms={render:Vo,init:Ho}})),gs=c({default:()=>zs,init:()=>ys,render:()=>vs});function _s(){if(Ls)return;let e=document.createElement(`style`);e.id=`m5t-notif-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Ls=!0}function vs(){return _s(),Xi(),M()?ta({section:`settings-notifications`,title:`Notifications`,description:`Pick a client to manage their lead alerts.`}):`
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Email sent the moment a magnet captures a lead. Up to ${Ps} recipients per magnet.</p>
            </div>
          </div>
          <div id="ntf-body">${Rs(`hourglass_empty`,`Loading…`)}</div>
        </div>
      </div>
    ...
    </div>`}async function ys(){if(M()){let e=e=>Number(e||0).toLocaleString();return na(Ms(),[{h:`Magnets`,td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:`Leads · wk`,td:t=>e(t.leads.this_week)}],{emptyMsg:`No client orgs yet. Create one under Clients first.`})}await Promise.all([Cs(),bs()])}async function bs(){let e=Is();if(e)try{let t=await fetch(`${Ms()}/m5t/v5/acctGroup/${encodeURIComponent(e)}/webhook`);if(t.status===403){Fs.webhookAllowed=!1;return}let n=await t.json().catch(()=>({}));if(!n.ok)return;Fs.webhook=n.webhook,Ss()}catch{}}function xs(e){try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return``}}function Ss(){let e=document.getElementById(`ntf-wh-card`),t=document.getElementById(`ntf-wh-body`);if(!e||!t)return;e.style.display=``;let n=Fs.webhook,r=n?.last_delivery;t.innerHTML=`
    <div class="ntf-wh">
      <div class="settings-field" style="margin-bottom:0">
        <label class="settings-label" for="ntf-wh-url">Webhook URL</label>
        <input class="ntf-input" id="ntf-wh-url" type="url" placeholder="https://hooks.zapier.com/hooks/catch/…" value="${As(n?.uri||``)}" />
      </div>
      <div class="settings-field" style="margin-bottom:0">
      ...
      <div class="ntf-wh__row">
        ...
        <span class="ntf-wh__status">${r?r.ok?`Last delivery: <span class="ok">delivered</span> ${As(xs(r.tz))}`:`Last delivery: <span class="bad">failed</span> ${As(xs(r.tz))} (${As(r.error||``)})`:``}</span>
      </div>
    </div>`,t.querySelector(`#ntf-wh-save`)?.addEventListener(`click`,async()=>{let e=t.querySelector(`#ntf-wh-url`)?.value.trim()||``,n=t.querySelector(`#ntf-wh-secret`)?.value??``,r={uri:e};n.trim()!==``&&(r.secret=n.trim());try{let t=await fetch(`${Ms()}/m5t/v5/acctGroup/${encodeURIComponent(Is())}/webhook`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify(r)}),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.error||`Failed (HTTP ${t.status})`);Fs.webhook=n.webhook,js(e?`Webhook saved`:`Webhook removed`,`success`),Ss()}catch(e){js(e.message||`Could not save`,`danger`)}}),t.querySelector(`#ntf-wh-test`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0;try{let e=await fetch(`${Ms()}/m5t/v5/acctGroup/${encodeURIComponent(Is())}/webhook-test`,{method:`POST`}),t=await e.json().catch(()=>({}));e.ok&&t.ok?js(`Test delivery sent`,`success`):js(t.error||`Could not deliver the test`,`danger`)}catch{js(`Could not deliver the test`,`danger`)}finally{t.disabled=!1}try{await bs()}catch(e){console.warn(`[notifications] loadWebhook refresh failed:`,e)}})}async function Cs(){let e=document.getElementById(`ntf-body`);if(e){try{let e=await(await fetch(`${Ms()}/m5t/v5/magnets`)).json().catch(()=>({}));if(!e.ok)throw Error(e.message||`Failed to load`);Fs.magnets=(e.magnets||[]).filter(e=>e.status!==`ARCHIVED`),Fs.canManage=!!e.canManage}catch(t){console.warn(`[notifications] load failed:`,t),e.innerHTML=Rs(`error`,`Could not load your magnets. Please try again.`);return}Ts()}}function ws(e){let t=Array.isArray(e.notify_emails)?e.notify_emails:[],n=t.length>0;return`
    <div class="ntf-row" data-guid="${As(e.guid)}">
      <div class="ntf-magnet">
        <div class="ntf-name" title="${As(e.name)}">${As(e.name)}</div>
        <div class="ntf-meta">${As((e.domains||[]).join(`, `)||e.status)}</div>
      ...
      <div class="ntf-config">
        ${t.length?`<div class="ntf-chips">${t.map(e=>`
              <span class="ntf-chip">${As(e)}${Fs.canManage?`<button type="button" data-remove="${As(e)}" aria-label="Remove ${As(e)}">&times;</button>`:``}</span>`).join(``)}</div>`:`<div class="ntf-none">No alert emails.</div>`}
        ${Fs.canManage?`
        <div class="ntf-addrow">
          <input class="ntf-input" type="email" placeholder="name@business.com" aria-label="Add alert email" ${t.length>=Ps?`disabled`:``} />
          <button class="ntf-btn" type="button" data-add ${t.length>=Ps?`disabled`:``}>
    ...
    </div>`}function Ts(){let e=document.getElementById(`ntf-body`);if(e){if(!Fs.magnets.length){e.innerHTML=Rs(`widgets`,`No magnets yet. Create one under Your Magnets first.`);return}e.innerHTML=Fs.magnets.map(ws).join(``),Yt(e,{rowSelector:`.ntf-row`,noun:`magnets`}),e.querySelectorAll(`.ntf-row`).forEach(e=>{let t=e.dataset.guid,n=e.querySelector(`.ntf-input`),r=()=>{let e=(n?.value||``).trim().toLowerCase();if(!e)return;if(!Ns(e)){js(`That does not look like an email address`,`danger`);return}let r=[...Fs.magnets.find(e=>e.guid===t).notify_emails||[]];if(r.includes(e)){js(`Already added`,`info`);return}if(r.length>=Ps){js(`Up to ${Ps} emails per magnet`,`info`);return}Es(t,[...r,e])};e.querySelector(`[data-add]`)?.addEventListener(`click`,r),n?.addEventListener(`keydown`,e=>{e.key===`Enter`&&r()}),e.querySelectorAll(`[data-remove]`).forEach(e=>e.addEventListener(`click`,()=>{let n=Fs.magnets.find(e=>e.guid===t);Es(t,(n.notify_emails||[]).filter(t=>t!==e.dataset.remove))})),e.querySelector(`[data-test]`)?.addEventListener(`click`,()=>Ds(t,e.querySelector(`[data-test]`)))})}}async function Es(e,t){try{let n=await fetch(`${Ms()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({notify_emails:t})}),r=await n.json().catch(()=>({}));if(!n.ok||!r.ok)throw Error(r.error||r.message||`Failed (HTTP ${n.status})`);let i=Fs.magnets.find(t=>t.guid===e);i&&(i.notify_emails=t),js(`Alert emails updated`,`success`)}catch(e){console.warn(`[notifications] save failed:`,e),js(e.message||`Could not save`,`danger`);return}try{Ts()}catch(e){console.error(`[notifications] renderBody after save failed:`,e)}}async function Ds(e,t){t&&(t.disabled=!0);try{let t=await fetch(`${Ms()}/m5t/v5/magnets/${encodeURIComponent(e)}/notify-test`,{method:`POST`}),n=await t.json().catch(()=>({}));t.ok&&n.ok?js(`Test alert sent`,`success`):js(n.error||`Could not send the test`,`danger`)}catch{js(`Could not send the test`,`danger`)}finally{t&&(t.disabled=!1)}}var Os,ks,As,js,Ms,Ns,Ps,Fs,Is,Ls,Rs,zs,Bs=o((()=>{D(),Xe(),Os=u(f(),1),m(),ua(),Zt(),ks={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},As=e=>String(e??``).replace(/[&<>"']/g,e=>ks[e]),js=(e,t=`info`)=>{try{Os.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Ms=()=>E.getConfig?.().BASE_URL||``,Ns=e=>Ce(e),Ps=5,Fs={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},Is=()=>E.getActiveOrg()?.guid||E.getMemberships()[0]?.orgGuid||null,Ls=!1,Rs=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,zs={render:vs,init:ys}}));function Vs({label:e=``,content:t=``,size:n=``,onClose:r=null}={}){let i=document.activeElement,a=document.createElement(`div`);a.className=`m5t-modal-scrim`,a.innerHTML=`
    <div class="m5t-modal${n===`wide`?` m5t-modal--wide`:``}" role="dialog" aria-modal="true" aria-label="${Hs(e)}" tabindex="-1">
    ...
    </span>`}function Qs(e,t){let n=_c(),r=e?.[t]||[];return r.find(e=>e.owner_guid===n)||r[0]||null}function $s(e,t,n){return e.connect&&!n?`unavailable`:t?t.connect_status===`ACTIVE`?`connected`:`broken`:`idle`}function ec(e,t){return e===`unavailable`?`<span class="intg-state">Not available yet</span>`:e===`idle`?`<span class="intg-state">Not connected</span>`:e===`connected`?`<span class="intg-state on"><span class="material-symbols-outlined" aria-hidden="true">check</span>Connected</span>`:`<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>${P(t?.connect_status===`NEEDS_REAUTH`?`Reconnect needed`:`Connection error`)}</span>`}async function tc(){let e=await fetch(`${F()}/m5t/v5/integrations`);if(e.status===403)return{denied:!0};let t=await e.json();if(!t.ok)throw Error(t.error||`load failed`);return{providers:t.data.providers,configured:t.data.configured}}async function nc(e){if(!xc.busy){xc.busy=!0;try{let t=await(await fetch(`${F()}/m5t/v5/integrations/${e.slug}/connect`)).json();if(!t.ok||!t.data?.url)throw Error(t.error||`connect failed`);window.location.href=t.data.url}catch(t){gc(t.message||e.connect.fallbackError,`error`),xc.busy=!1}}}async function rc(e,{refresh:t}={}){if(xc.busy)return;xc.busy=!0;let n=document.getElementById(e.card.ids.sync);n&&(n.disabled=!0);try{let t=await(await fetch(`${F()}/m5t/v5/integrations/${e.slug}/sync`,{method:`POST`})).json();if(!t.ok)throw Error(t.error||`sync failed`);let n=(t.data?.connections?.[0]?.[e.sync.itemsField]||[]).filter(e=>e.error).length;gc(n?e.sync.failedToast(n):`Metrics synced.`,n?`warning`:`success`)}catch{gc(`Sync failed.`,`error`)}finally{xc.busy=!1,n&&(n.disabled=!1),t?.()}}async function ic(e,{refresh:t}={}){if(xc.busy)return;xc.busy=!0;let n=!1;try{n=await Gs({title:`Disconnect ${e.label}?`,message:e.disconnect.confirm,confirmLabel:`Disconnect`,danger:!0})}finally{n||(xc.busy=!1)}if(n)try{let t=await(await fetch(`${F()}/m5t/v5/integrations/${e.slug}`,{method:`DELETE`})).json().catch(()=>({}));if(!t.ok)throw Error(t.error||`disconnect failed`);gc(e.disconnect.toast,`success`)}catch{gc(`Disconnect failed.`,`error`)}finally{xc.busy=!1,t?.()}}async function ac(e,{refresh:t}={}){let n=e.picker,r=document.getElementById(e.card.ids.panel);if(r){r.style.display=``,r.innerHTML=bc(n.loading);try{let r=await(await fetch(`${F()}/m5t/v5/integrations/${e.slug}/${n.path}`)).json();if(!r.ok)throw Error(r.error||`load failed`);oc(e,r.data[n.itemsField]||[],new Set(r.data.linked||[]),{refresh:t})}catch{r.innerHTML=bc(n.loadError,`error`)}}}function oc(e,t,n,{refresh:r}={}){let i=e.picker,a=document.getElementById(e.card.ids.panel);if(!a)return;let o=t.map(e=>{let t=i.rowDisabled(e),r=i.rowBadge(e),a=n.has(e.id)&&!t;return`
    ...
    </div>`,document.getElementById(i.ids.cancel)?.addEventListener(`click`,()=>{a.style.display=`none`}),document.getElementById(i.ids.save)?.addEventListener(`click`,()=>sc(e,{refresh:r}))}async function sc(e,{refresh:t}={}){let n=e.picker,r=document.getElementById(e.card.ids.panel),i=[...r?.querySelectorAll(`input[data-${n.dataAttr}]:checked`)||[]].map(e=>e.dataset[n.datasetKey]),a=document.getElementById(n.ids.save);a&&(a.disabled=!0);try{let a=await(await fetch(`${F()}/m5t/v5/integrations/${e.slug}/${n.path}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({[n.saveField]:i})})).json();if(!a.ok)throw Error(a.error||`save failed`);gc(n.savedToast(a.data.linked),`success`),r&&(r.style.display=`none`),t?.()}catch{gc(n.saveError,`error`),a&&(a.disabled=!1)}}function cc({refresh:e,replaceKey:t=!1}={}){let n=document.getElementById(wc.callrail.card.ids.setup);n&&(n.style.display=``,n.innerHTML=`
    <div class="intg-picker">
    ...
    </div>`,document.getElementById(`intg-r-cancel`)?.addEventListener(`click`,()=>{n.style.display=`none`}),document.getElementById(`intg-r-continue`)?.addEventListener(`click`,()=>lc({refresh:e})),document.getElementById(`intg-r-key`)?.focus())}async function lc({refresh:e}={}){let t=document.getElementById(`intg-r-continue`),n=document.getElementById(`intg-r-key`)?.value.trim()||``,r=document.getElementById(`intg-r-pickers`);if(!n){Dc(`Paste an API key first.`);return}if(r&&!r.hidden)return dc(n,{refresh:e});t&&(t.disabled=!0),Dc(`Checking the key with CallRail…`);try{let e=await(await fetch(`${F()}/m5t/v5/integrations/callrail/validate`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({api_key:n})})).json();if(!e.ok){Dc(e.error||`CallRail rejected that key.`);return}let i=e.data.accounts||[],a=document.getElementById(`intg-r-account`);a&&(a.innerHTML=i.map(e=>`<option value="${P(e.id)}">${P(e.name)}</option>`).join(``),a.onchange=()=>uc(n,a.value)),r&&(r.hidden=!1),t&&(t.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">save</span>Save`),Dc(``),await uc(n,i[0]?.id)}catch{Dc(`Could not reach CallRail. Try again.`)}finally{t&&(t.disabled=!1)}}async function uc(e,t){let n=document.getElementById(`intg-r-company`);if(!(!n||!t)){n.innerHTML=`<option value="">Loading companies…</option>`;try{let r=await(await fetch(`${F()}/m5t/v5/integrations/callrail/companies`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({api_key:e,account_id:t})})).json(),i=r.ok&&r.data.companies||[];n.innerHTML=i.length?i.map(e=>`<option value="${P(e.id)}">${P(e.name)}</option>`).join(``):`<option value="">No active companies in this account</option>`}catch{n.innerHTML=`<option value="">Could not load companies</option>`}}}async function dc(e,{refresh:t}={}){let n=document.getElementById(`intg-r-continue`),r=document.getElementById(`intg-r-account`)?.value||``,i=document.getElementById(`intg-r-company`)?.value||``;if(!i){Dc(`Pick the company this workspace tracks.`);return}n&&(n.disabled=!0),Dc(`Connecting…`);try{let n=await(await fetch(`${F()}/m5t/v5/integrations/callrail`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({api_key:e,account_id:r,company_id:i})})).json();if(!n.ok)throw Error(n.error||`connect failed`);gc(n.data?.webhook_state===`active`?`CallRail connected. Call sync is on.`:`CallRail connected. Call sync setup needs attention; see below.`,`success`),t?.()}catch{Dc(`Could not connect. Check the key and try again.`),n&&(n.disabled=!1)}}async function fc({refresh:e}={}){if(xc.busy)return;xc.busy=!0;let t=document.getElementById(wc.callrail.card.ids.sync);t&&(t.disabled=!0);try{let e=await(await fetch(`${F()}/m5t/v5/integrations/callrail/sync?days=7`,{method:`POST`})).json();if(!e.ok)throw Error(e.error||`sync failed`);let t=e.data?.connections?.[0]||{};gc(t.error?`Sync finished with errors.`:`Sync done. ${t.processed||0} new call${(t.processed||0)===1?``:`s`} recorded.`,t.error?`warning`:`success`)}catch{gc(`Sync failed.`,`error`)}finally{xc.busy=!1,t&&(t.disabled=!1),e?.()}}function pc(){if(Oc)return;let e=document.createElement(`style`);e.id=`m5t-intg-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Oc=!0}var mc,hc,P,gc,F,_c,vc,yc,bc,xc,Sc,Cc,wc,Tc,Ec,Dc,Oc,kc=o((()=>{D(),mc=u(f(),1),m(),Js(),hc={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},P=e=>String(e??``).replace(/[&<>"']/g,e=>hc[e]),gc=(e,t=`info`)=>{try{mc.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},F=()=>E.getConfig?.().BASE_URL||``,_c=()=>E.getActiveOrg()?.guid||E.getMemberships()[0]?.orgGuid||null,vc=()=>E.getCapabilities().includes(`manage_magnets`),yc=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,bc=(e,t=``)=>`<div class="intg-alert ${t}"><span class="material-symbols-outlined" aria-hidden="true">${t===`error`?`error`:`info`}</span><span>${e}</span></div>`,xc={busy:!1},Sc=null,Cc={google_ads:{what:`See ad spend lined up next to the leads it generated, so you know which campaigns are actually working.`,steps:[`Click Connect and sign in with a Google account that has access to your Ads accounts.`,`Choose which ad accounts should feed reporting.`,`Metrics refresh automatically once a day. Click Sync now any time for an immediate pull.`]},calendly:{what:`Let visitors book directly from a magnet conversation, and get notified the moment they do.`,steps:[`Click Connect and authorize your Calendly account.`,`Turn on Calendly booking for any magnet’s Book action, under Magnets.`,`Confirmed and canceled bookings sync back to the lead automatically. Webhooks need a paid Calendly plan; a free plan still lets visitors book, just without the automatic lead sync.`]},callrail:{what:`Every tracked phone call becomes a lead automatically, complete with recording and source.`,steps:[`In CallRail, go to Integrations, then Data access, then API keys, and create a key. Read-only works for calls; Allow Writes lets us set up call sync automatically.`,`Paste the key here and pick the account and company this workspace tracks.`,`Calls start landing in your Leads inbox within minutes.`]},google_analytics:{what:`See how visitors reach your site and behave once they get there. Sessions, pageviews, and engagement, right alongside the leads your magnets capture.`,steps:[`Click Connect and sign in with a Google account that has access to your GA4 property.`,`Choose which GA4 properties should feed reporting.`,`Metrics refresh automatically once a day. Click Sync now any time for an immediate pull.`]}},wc={google_ads:{slug:`google_ads`,urlSlug:`google-ads`,label:`Google Ads`,logo:`integrations/google-ads.svg`,connect:{fallbackError:`Could not start the Google connection.`},disconnect:{confirm:`Daily metric refreshes stop until reconnected.`,toast:`Google Ads disconnected.`},card:{tint:`primary`,icon:`ads_click`,sub:`Spend and clicks beside your leads.`,ids:{connect:`intg-g-connect`,choose:`intg-g-accounts`,sync:`intg-g-sync`,disconnect:`intg-g-disconnect`,panel:`intg-g-picker`},chooseLabel:`Choose accounts`,idleDesc:`Connect a Google account with access to your ad accounts. Spend lines up against your magnet leads in Ad performance.`,brokenDesc:`The connection stopped working. Reconnect to resume daily metric refreshes.`,reachDesc:e=>`This connection can reach <b>${e}</b> ad account${e===1?``:`s`}. Choose which ones feed reporting; metrics refresh daily in Ad performance.`,noneDesc:`Connected, but no ad accounts are reachable from this Google account. Reconnect with an account that has Google Ads access.`,reachableCount:e=>e?.customer_ids?.length||0},picker:{path:`accounts`,itemsField:`accounts`,saveField:`customer_ids`,dataAttr:`intg-acct`,datasetKey:`intgAcct`,ids:{cancel:`intg-picker-cancel`,save:`intg-picker-save`},loading:`Loading your ad accounts…`,loadError:`Could not load your ad accounts. Try again, or reconnect if this keeps happening.`,heading:`Accounts that feed reporting`,emptyMsg:`No ad accounts are reachable from this Google account.`,namePrefix:`Account `,rowDisabled:e=>!!(e.manager||e.error),rowBadge:e=>e.manager?`Manager`:e.error?`Unavailable`:e.currency||``,savedToast:e=>`${e} account${e===1?``:`s`} linked. First sync is running.`,saveError:`Could not save account selection.`},sync:{itemsField:`accounts`,failedToast:e=>`Sync finished with ${e} account error${e===1?``:`s`}.`}},google_analytics:{slug:`google_analytics`,urlSlug:`google-analytics`,label:`Google Analytics`,logo:`integrations/google-analytics.svg`,connect:{fallbackError:`Could not start the Google Analytics connection.`},disconnect:{confirm:`Daily metric refreshes stop until reconnected.`,toast:`Google Analytics disconnected.`},card:{tint:`success`,icon:`monitoring`,sub:`Traffic and engagement beside your leads.`,ids:{connect:`intg-a-connect`,choose:`intg-a-properties`,sync:`intg-a-sync`,disconnect:`intg-a-disconnect`,panel:`intg-a-picker`},chooseLabel:`Choose properties`,idleDesc:`Connect a Google account with access to your GA4 property. Traffic and engagement line up against your magnet leads.`,brokenDesc:`The connection stopped working. Reconnect to resume daily metric refreshes.`,reachDesc:e=>`This connection can reach <b>${e}</b> GA4 propert${e===1?`y`:`ies`}. Choose which ones feed reporting; metrics refresh daily.`,noneDesc:`Connected, but no GA4 properties are reachable from this Google account. Reconnect with an account that has Analytics access.`,reachableCount:e=>e?.properties?.length||0},picker:{path:`properties`,itemsField:`properties`,saveField:`property_ids`,dataAttr:`intg-prop`,datasetKey:`intgProp`,ids:{cancel:`intg-a-picker-cancel`,save:`intg-a-picker-save`},loading:`Loading your GA4 properties…`,loadError:`Could not load your GA4 properties. Try again, or reconnect if this keeps happening.`,heading:`Properties that feed reporting`,emptyMsg:`No GA4 properties are reachable from this Google account.`,namePrefix:`Property `,rowDisabled:()=>!1,rowBadge:e=>e.account||``,savedToast:e=>`${e} propert${e===1?`y`:`ies`} linked. First sync is running.`,saveError:`Could not save property selection.`},sync:{itemsField:`properties`,failedToast:e=>`Sync finished with ${e} property error${e===1?``:`s`}.`}},calendly:{slug:`calendly`,urlSlug:`calendly`,label:`Calendly`,logo:`integrations/calendly.svg`,connect:{fallbackError:`Could not start the Calendly connection.`},disconnect:{confirm:`Magnet booking falls back to the built-in scheduler and booking sync stops.`,toast:`Calendly disconnected.`},card:{tint:`accent`,icon:`event`,sub:`Bookings on your magnets.`,ids:{connect:`intg-c-connect`,disconnect:`intg-c-disconnect`},idleDesc:`Connect Calendly and your magnets book real meetings: the Book button opens your calendar in the conversation, and confirmed bookings land on the lead automatically.`,brokenDesc:`The connection stopped working. Reconnect to resume booking sync.`}},callrail:{slug:`callrail`,urlSlug:`callrail`,label:`CallRail`,logo:`integrations/callrail.svg`,disconnect:{confirm:`Calls stop landing in your Leads inbox.`,toast:`CallRail disconnected.`},card:{tint:`info`,icon:`call`,sub:`Calls in your leads inbox.`,ids:{connect:`intg-r-connect`,sync:`intg-r-sync`,disconnect:`intg-r-disconnect`,setup:`intg-r-setup`},idleDesc:`Paste a CallRail API key and tracked phone calls land in your Leads inbox, with the caller, source, and recording on the lead.`,brokenDesc:`The connection stopped working. Reconnect with a current CallRail API key.`}}},Tc=[{label:`HubSpot`,logo:`integrations/hubspot.svg`,icon:`hub`,sub:`Leads into your CRM.`},{label:`Zapier`,logo:`integrations/zapier.svg`,icon:`bolt`,sub:`Anything into anything.`}],Ec=Object.fromEntries(Object.values(wc).map(e=>[e.urlSlug,e.slug])),Dc=e=>{let t=document.getElementById(`intg-r-status`);t&&(t.textContent=e)},Oc=!1})),Ac=c({default:()=>Bc,init:()=>Mc,render:()=>jc});function jc(){return pc(),Xi(),M()?ta({section:`settings-integrations`,title:`Integrations`,description:`Pick a client to manage their connections.`}):`
    <div class="page-shell" data-section="settings-integrations">
      ...
      <div id="intg-body">
        <div class="dashboard-card intg-card"><div class="card-body">${yc(`hourglass_empty`,`Loading…`)}</div></div>
      </div>
    </div>`}async function Mc(){if(M()){let e=e=>Number(e||0).toLocaleString();return na(F(),[{h:`Magnets`,td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:`Leads · wk`,td:t=>e(t.leads.this_week)}],{emptyMsg:`No client orgs yet. Create one under Clients first.`})}Nc()||await Pc()}function Nc(){try{let e=new URLSearchParams(window.location.search),t=e.get(`connected`),n=e.get(`error`)?e.get(`provider`)||`google_ads`:null,r=null;if(t&&Object.hasOwn(zc,t))gc(`${zc[t]} connected.`,`success`),Ys({slug:t,connected:!0}),r=Object.hasOwn(wc,t)?wc[t]:null;else if(n){let t=Object.hasOwn(zc,n)?zc[n]:n;gc(`${t} connection failed (${e.get(`error`)}).`,`error`),r=Object.hasOwn(wc,n)?wc[n]:null}else return!1;return window.history.replaceState(null,``,window.location.pathname+window.location.hash),r?(window.router?.navigate(`/settings/integrations/${r.urlSlug}`),!0):!1}catch{return!1}}async function Pc(){let e=document.getElementById(`intg-body`);try{let{denied:t,providers:n,configured:r}=await tc();if(t){e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${yc(`lock`,`Integrations are managed by workspace admins.`)}</div></div>`);return}e&&(e.innerHTML=Rc(n,r))}catch{e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${yc(`error`,`Could not load integrations.`)}</div></div>`)}}function Fc(e,t,n){let r=$s(e,t,n);return`
    ...
    </div>`}function Rc(e,t){return`<div class="intg-grid">${Object.values(wc).map(n=>Fc(n,Qs(e,n.slug),!!t?.[n.slug])).join(``)}${Tc.length?`<div class="intg-grid__soon-label">Coming soon</div>${Tc.map(Lc).join(``)}`:``}</div>`}var zc,Bc,Vc=o((()=>{kc(),ua(),zc=Object.fromEntries(Object.values(wc).filter(e=>e.connect).map(e=>[e.slug,e.label])),Bc={render:jc,init:Mc}})),Hc=c({default:()=>il,init:()=>Wc,render:()=>Uc});function Uc({provider:e}={}){pc(),Xi();let t=Ec[e];if(!t||M())return`<div class="page-shell"></div>`;let n=wc[t];return I.provider=n,`
    <div class="page-shell" data-section="settings-integrations">
    ...
    </div>`}async function Wc({provider:e}={}){let t=Ec[e];if(!t||M()){window.router?.navigate(`/settings/integrations`,{historyAPIMethod:`replaceState`});return}await Gc();let n=Xs();n?.connected&&n.slug===t&&I.provider?.picker&&vc()&&ac(I.provider,{refresh:Gc})}async function Gc(){let e=document.getElementById(`intg-detail`);if(!(!e||!I.provider))try{let{denied:t,providers:n,configured:r}=await tc();if(t){e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${yc(`lock`,`Integrations are managed by workspace admins.`)}</div></div>`;return}I.conn=Qs(n,I.provider.slug),I.configured=!!r?.[I.provider.slug],I.status=$s(I.provider,I.conn,I.configured),e.innerHTML=Kc(),el()}catch{e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${yc(`error`,`Could not load this integration.`)}</div></div>`}}function Kc(){let e=I.provider;return[Jc(e),Yc(e),Xc(e),Qc(e),$c(e)].filter(Boolean).join(``)}function qc(e){let t=I.conn?.external_account||{};if(I.status!==`connected`)return e.card.sub;if(e.slug===`calendly`){let e=[t.name,t.email&&`(${t.email})`].filter(Boolean).join(` `);return e?`Connected as ${e}.`:`Connected.`}if(e.slug===`callrail`){let e=[t.account_name,t.company_name].filter(Boolean).join(` · `);return e?`Connected to ${e}.`:`Connected.`}let n=e.card.reachableCount(t);return n?`${n} reachable ${e.slug===`google_analytics`?n===1?`property`:`properties`:n===1?`account`:`accounts`}.`:`Connected.`}function Jc(e){let t=``;vc()&&(e.connect&&(I.status===`idle`||I.status===`broken`)&&I.configured&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${I.status===`broken`?`Reconnect`:`Connect`}</button>`),e.slug===`callrail`&&I.status!==`connected`&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${I.status===`broken`?`Reconnect`:`Connect`}</button>`));let n;return n=I.status===`unavailable`?`${e.label} is being set up for this platform.`:I.status===`broken`?e.card.brokenDesc:I.status===`idle`?vc()?e.card.idleDesc:e.card.sub:qc(e),`
    ...
    </div>`}function Yc(e){let t=Cc[e.slug];return t?I.status===`connected`||I.status===`unavailable`||!vc()?`
      <div class="dashboard-card intg-card">
        <div class="card-body">
    ...
    <div class="dashboard-card intg-card">
    ...
    </div>`:``}function Xc(e){if(I.status!==`connected`)return``;let t=vc();if(e.picker){let n=e.card.reachableCount(I.conn?.external_account);return`
      <div class="dashboard-card intg-card">
        <div class="card-body">
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-g-convactions">${bc(`Loading conversion actions…`)}</div>
        </div>
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-c-events">${bc(`Loading event types…`)}</div>
        </div>
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-r-trackers">${bc(`Loading tracking numbers…`)}</div>
          <div class="intg-actions" style="justify-content:flex-start;margin-top:12px">
            <button type="button" class="intg-btn" id="${e.card.ids.sync}"><span class="material-symbols-outlined" aria-hidden="true">sync</span>Sync now</button>
      ...
      </div>`:``}function Zc(e){if(!e)return``;try{return new Date(e).toLocaleDateString([],{month:`short`,day:`numeric`,year:`numeric`})}catch{return String(e).slice(0,10)}}function Qc(e){if(!I.conn)return``;let t=I.conn.webhook||{},n=[];n.push([`Status`,I.status===`connected`?`Active`:I.conn.connect_status===`NEEDS_REAUTH`?`Needs reconnecting`:`Error`]),e.slug===`calendly`&&(n.push([`Booking sync`,t.state===`active`?`On`:`Off (paid Calendly plan required)`]),t.last_received_tz&&n.push([`Last booking received`,Zc(t.last_received_tz)])),e.slug===`callrail`&&(n.push([`Call sync`,t.state===`active`?`On`:`Needs attention`]),t.cookie_capture&&n.push([`Session capture`,t.cookie_capture===`active`?`On`:`Needs attention`]),t.last_received_tz&&n.push([`Last call received`,Zc(t.last_received_tz)])),I.conn.created?.created_tz&&n.push([`Connected on`,Zc(I.conn.created.created_tz)]);let r=e.slug===`calendly`&&I.status===`connected`&&t.state!==`active`?bc(`Booking sync is off: webhooks need a paid Calendly plan. Visitors can still book in the magnet; bookings just will not appear on the lead automatically. Reconnect after upgrading to turn it on.`,`error`):e.slug===`callrail`&&I.status===`connected`&&t.state!==`active`?bc(`Automatic call sync could not be set up in CallRail. Calls still arrive via the daily sweep and Sync now. Reconnect to retry the setup.`,`error`):``;return`
    <div class="dashboard-card intg-card">
      <div class="card-body">
    ...
    </div>`}function $c(e){return I.status!==`connected`&&I.status!==`broken`||!vc()?``:`
    <div class="dashboard-card intg-card settings-danger">
    ...
    </div>`}function el(){let e=I.provider;if(!e)return;let t=Gc;e.connect&&document.getElementById(e.card.ids.connect)?.addEventListener(`click`,()=>nc(e)),e.slug===`callrail`&&(document.getElementById(e.card.ids.connect)?.addEventListener(`click`,()=>cc({refresh:t})),document.getElementById(`intg-r-replace`)?.addEventListener(`click`,()=>cc({refresh:t,replaceKey:!0})),document.getElementById(e.card.ids.sync)?.addEventListener(`click`,()=>fc({refresh:t})),I.status===`connected`&&vc()&&rl()),e.picker&&(document.getElementById(e.card.ids.choose)?.addEventListener(`click`,()=>ac(e,{refresh:t})),document.getElementById(e.card.ids.sync)?.addEventListener(`click`,()=>rc(e,{refresh:t}))),e.slug===`google_ads`&&I.status===`connected`&&vc()&&tl(),e.slug===`calendly`&&I.status===`connected`&&vc()&&nl(),document.getElementById(e.card.ids.disconnect)?.addEventListener(`click`,()=>ic(e,{refresh:t}))}async function tl(){let e=document.getElementById(`intg-g-convactions`);if(e)try{let t=await(await fetch(`${F()}/m5t/v5/integrations/google_ads/conversion_actions`)).json();if(!t.ok)throw Error(t.error||`load failed`);let n=t.data.actions||[],r=new Set(t.data.selected||[]);if(!n.length){e.innerHTML=bc(`No enabled conversion actions in the linked accounts.`);return}e.innerHTML=`
      ...
      </div>`,Yt(e.querySelector(`.intg-ca-list`),{rowSelector:`.intg-ca-row`,noun:`actions`}),document.getElementById(`intg-g-ca-save`)?.addEventListener(`click`,async()=>{let t=document.getElementById(`intg-g-ca-save`),n=[...e.querySelectorAll(`input[type="checkbox"]:checked`)].map(e=>e.value);t.disabled=!0;try{let e=await(await fetch(`${F()}/m5t/v5/integrations/google_ads/conversion_actions`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({conversion_action_ids:n})})).json();if(!e.ok)throw Error(e.error||`save failed`);gc(n.length?`Counting ${n.length} conversion action${n.length===1?``:`s`} in reporting.`:`Conversion counting turned off.`,`success`)}catch(e){gc(e.message||`Could not save the selection.`,`error`)}finally{t.disabled=!1}})}catch{e.innerHTML=bc(`Could not load conversion actions. If this keeps happening, reconnect.`,`error`)}}async function nl(){let e=document.getElementById(`intg-c-events`);if(e)try{let t=await(await fetch(`${F()}/m5t/v5/integrations/calendly/event_types`)).json();if(!t.ok)throw Error(t.error||`load failed`);let n=t.data.event_types||[],r=t.data.scheduling_url?`<div class="intg-ev"><span class="intg-ev__name">Full scheduling page</span><span class="intg-ev__meta">${P(t.data.scheduling_url)}</span></div>`:``;e.innerHTML=n.length||r?`${r}${n.map(e=>`
          <div class="intg-ev">
            <span class="intg-ev__name">${P(e.name)}</span>
            <span class="intg-ev__meta">${e.duration?`${P(String(e.duration))} min`:``}</span>
          </div>`).join(``)}`:bc(`No active event types on this Calendly account.`),Yt(e,{rowSelector:`.intg-ev`,noun:`event types`})}catch{e.innerHTML=bc(`Could not load event types. If this keeps happening, reconnect.`,`error`)}}async function rl(){let e=document.getElementById(`intg-r-trackers`);if(e)try{let t=await(await fetch(`${F()}/m5t/v5/integrations/callrail/trackers`)).json();if(!t.ok)throw Error(t.error||`load failed`);let n=t.data.trackers||[];e.innerHTML=n.length?n.map(e=>`
          <div class="intg-ev">
            <span class="intg-ev__name">${P(e.name)}</span>
            <span class="intg-ev__meta">${P(e.number)}${e.type===`session`?` · number pool`:``}</span>
          </div>`).join(``):bc(`No active tracking numbers in this company yet. Create one in CallRail and it appears here.`),Yt(e,{rowSelector:`.intg-ev`,noun:`numbers`})}catch{e.innerHTML=bc(`Could not load tracking numbers.`,`error`)}}var I,il,al=o((()=>{kc(),ua(),Zt(),I={provider:null,conn:null,configured:!1,status:`idle`},il={render:Uc,init:Wc}})),ol=c({default:()=>kl,init:()=>ll,render:()=>cl});function sl(){if(Tl)return;let e=document.createElement(`style`);e.id=`m5t-security-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Tl=!0}function cl(){return sl(),`
    <div class="page-shell" data-section="settings-security">
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Signing in as ${xl(_l())}. You stay signed in on this device after a change.</p>
            </div>
          </div>
          <div class="settings-grid-2">
            <div class="settings-field">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="pk-body">${El(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function ll(){document.getElementById(`pw-save`)?.addEventListener(`click`,vl);let e=document.getElementById(`pk-add-btn`);e&&window.PublicKeyCredential&&(e.style.display=``,e.addEventListener(`click`,hl)),await ul()}async function ul(){let e=document.getElementById(`pk-body`);if(e){try{let e=await fetch(`${Cl()}/m5t/v5/webauthn`),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(t.error||`Failed to load`);wl.passkeys=t.passkeys||[],wl.loaded=!0}catch(t){console.warn(`[settings-security] load failed:`,t),e.innerHTML=El(`error`,`Could not load your passkeys. Please try again.`);return}pl()}}function dl(e){if(!e)return null;try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return null}}function fl(e){let t=dl(e.last_used_time),n=e.created?.created_tz,r=dl(n),i=[e.device_type===`multiDevice`?`Syncs across devices`:`This device only`,t?`Last used ${t}`:`Never used to sign in yet`,r?`Added ${r}`:null].filter(Boolean).join(` · `);return`
    ...
    </div>`}function pl(){let e=document.getElementById(`pk-body`);if(e){if(!window.PublicKeyCredential){e.innerHTML=`<p class="pk-unsupported">This browser doesn't support passkeys. Your password sign-in still works as usual.</p>`;return}if(!wl.passkeys.length){e.innerHTML=El(`passkey`,`No passkeys yet. Add one for a faster, phishing-resistant sign-in.`);return}e.innerHTML=wl.passkeys.map(fl).join(``),Yt(e,{rowSelector:`.pk-row`,noun:`passkeys`}),e.querySelectorAll(`[data-remove]`).forEach(e=>{e.addEventListener(`click`,()=>gl(e.dataset.remove,e))})}}function ml(){try{let e=navigator.userAgent||``,t=/iPhone/.test(e)?`iPhone`:/iPad/.test(e)?`iPad`:/Android/.test(e)?`Android`:/Mac OS X/.test(e)?`Mac`:/Windows/.test(e)?`Windows`:/Linux/.test(e)?`Linux`:`device`,n=/Edg\//.test(e)?`Edge`:/Chrome\//.test(e)?`Chrome`:/Firefox\//.test(e)?`Firefox`:/Safari\//.test(e)?`Safari`:``;return n?`${n} on ${t}`:t}catch{return`Passkey`}}async function hl(){let e=document.getElementById(`pk-add-btn`);e&&(e.disabled=!0);try{let{startRegistration:e}=await w(async()=>{let{startRegistration:e}=await Promise.resolve().then(()=>(Ft(),Pt));return{startRegistration:e}},void 0,import.meta.url),t=await fetch(`${Cl()}/m5t/v5/webauthn/register/options`,{method:`POST`}),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.error||`Could not start passkey registration`);let r;try{r=await e({optionsJSON:n.options})}catch(e){if(e?.name===`NotAllowedError`)return;throw e}let i=await fetch(`${Cl()}/m5t/v5/webauthn/register/verify`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({response:r,deviceLabel:ml()})}),a=await i.json().catch(()=>({}));if(!i.ok||!a.ok)throw Error(a.error||`Could not register this passkey`);Sl(`Passkey added`,`success`),await ul()}catch(e){console.warn(`[settings-security] addPasskey failed:`,e),Sl(e.message||`Could not add a passkey`,`danger`)}finally{e&&(e.disabled=!1)}}async function gl(e,t){if(await Gs({title:`Remove this passkey?`,message:`You can always add it back later.`,confirmLabel:`Remove`,danger:!0})){t&&(t.disabled=!0);try{let t=await fetch(`${Cl()}/m5t/v5/webauthn/${encodeURIComponent(e)}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.error||`Could not remove this passkey`);wl.passkeys=wl.passkeys.filter(t=>t.guid!==e),Sl(`Passkey removed`,`success`),pl()}catch(e){console.warn(`[settings-security] removePasskey failed:`,e),Sl(e.message||`Could not remove this passkey`,`danger`),t&&(t.disabled=!1)}}}function _l(){try{return E.getScope()?.entity?.email||E.getEntity?.()?.email||`your account`}catch{return`your account`}}async function vl(){let e=document.getElementById(`pw-new`),t=document.getElementById(`pw-confirm`),n=document.getElementById(`pw-save`),r=e?.value||``,i=t?.value||``,a=gi(r);if(a.length){Dl(`Password needs: ${Ol(a)}.`);return}if(r!==i){Dl(`Passwords do not match.`);return}Dl(``),n&&(n.disabled=!0);try{let n=await fetch(`${Cl()}/m5t/v5/acctEntity/resetHash`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({password:r})}),i=await n.json().catch(()=>({}));if(!n.ok||!i.ok)throw Error(i.error||`Could not update your password`);Sl(`Password updated`,`success`),e&&(e.value=``),t&&(t.value=``)}catch(e){Dl(e.message||`Could not update your password.`)}finally{n&&(n.disabled=!1)}}var yl,bl,xl,Sl,Cl,wl,Tl,El,Dl,Ol,kl,Al=o((()=>{D(),yl=u(f(),1),m(),Js(),vi(),Zt(),et(),bl={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},xl=e=>String(e??``).replace(/[&<>"']/g,e=>bl[e]),Sl=(e,t=`info`)=>{try{yl.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Cl=()=>E.getConfig?.().BASE_URL||``,wl={passkeys:[],loaded:!1},Tl=!1,El=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Dl=e=>{let t=document.getElementById(`pw-error`);t&&(t.textContent=e||``,t.hidden=!e)},Ol=e=>e.length<=1?String(e[0]??``):e.length===2?`${e[0]} and ${e[1]}`:`${e.slice(0,-1).join(`, `)}, and ${e[e.length-1]}`,kl={render:cl,init:ll}})),jl=c({default:()=>$l,init:()=>zl,render:()=>Rl});function Ml(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(` `).trim()||e.email)||null}function Nl(e){return(e.split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``)||`?`).toUpperCase()}function Pl(e){try{return new Date(e).toLocaleString([],{month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`})}catch{return``}}function Fl(e){try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return``}}function Il(e){return e==null?`—`:e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,`0`)}s`}function Ll(){if(Xl)return;let e=document.createElement(`style`);e.id=`m5t-convs-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Xl=!0}function Rl(){return Ll(),Xi(),`
    <div class="page-shell" data-section="conversations">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="convs-body">
          ${Zl(`hourglass_empty`,`Loading journeys…`)}
        </div>
      </div>
    </div>`}async function zl(){await Bl()}async function Bl(){let e=document.getElementById(`convs-body`);if(e){try{let[e,t]=await Promise.all([fetch(`${Kl()}/m5t/v5/conversations`),fetch(`${Kl()}/m5t/v5/magnets`).catch(()=>null)]),n=await e.json().catch(()=>({}));if(!n.ok)throw Error(n.message||`Failed to load`);if(R.conversations=n.conversations||[],R.counts=n.counts||{},R.book=M(),t){let e=await t.json().catch(()=>({}));R.magnetNames={},R.magnetOwnerNames={};let n=R.book?ra():{};(e.magnets||[]).forEach(e=>{R.magnetNames[e.guid]=e.name,R.book&&(R.magnetOwnerNames[e.guid]=e.owner_name||n[e.owner_guid]||``)})}}catch(t){console.warn(`[conversations] load failed:`,t),e.innerHTML=Zl(`error`,`Could not load journeys. Please try again.`);return}Ul()}}function Vl(){return R.filter===`ALL`?R.conversations:R.conversations.filter(e=>e.status===R.filter)}function Hl(e){let t=Ml(e.lead),n=R.magnetNames[e.magnet_guid]||`—`,r=Jl[e.status]||Jl.ABANDONED,i=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,a=(e.routes||[]).map(e=>Yl[e]||e).join(`, `);return`
    <tr class="convs-row" data-session="${L(e.session)}">
      <td>
        <span class="convs-who">
          <span class="convs-ava${t?``:` anon`}">${t?L(Nl(t)):`<span class="material-symbols-outlined" style="font-size:16px">person_off</span>`}</span>
      ...
      ${R.book?`<td>${la(R.magnetOwnerNames[e.magnet_guid]||``)||`<span class="convs-muted">—</span>`}</td>`:``}
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${L(Pl(e.started_at))}">${L(Fl(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${L(Il(e.duration_s))}</td>
    </tr>`}function Ul(){let e=document.getElementById(`convs-body`);if(!e)return;if(!R.conversations.length){e.innerHTML=Zl(`route`,`No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.`);return}let t=Vl();e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${[[`ALL`,`All`],[`COMPLETED`,`Completed`],[`IN_PROGRESS`,`In progress`],[`ABANDONED`,`Abandoned`]].map(([e,t])=>`<button data-filter="${e}" class="${R.filter===e?`active`:``}">${t}${e!==`ALL`&&R.counts[e]?` (${ql(R.counts[e])})`:``}</button>`).join(``)}
      </div>
      <span class="convs-count">${ql(t.length)} of ${ql(R.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(Hl).join(``)||`<tr><td colspan="${R.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${R.filter.toLowerCase().replace(`_`,` `)} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`;let n=e.querySelector(`#convs-tbody`);n&&Yt(n,{rowSelector:`tr.convs-row`,noun:`journeys`,controlHost:e.querySelector(`.convs-tablewrap`)||n.parentElement}),e.querySelector(`.convs-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(R.filter=t.dataset.filter,Ul())}),e.querySelector(`#convs-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`.convs-row`);t&&Wl(t.dataset.session)})}async function Wl(e){let t=R.conversations.find(t=>t.session===e);if(!t)return;let n=null;try{n=await(await fetch(`${Kl()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),n?.ok||(n=null)}catch{n=null}let r=Ml(t.lead),i=R.magnetNames[t.magnet_guid]||`—`,a=(n?.events||[]).filter((e,t,n)=>e.event!==`step`||!(n[t+1]&&n[t+1].event===`step`)).map(e=>`
    <div class="convs-tl__item${e.event===`complete`?` done`:``}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${L((Ql[e.event]||(()=>e.event))(e.detail))}</div>
      <div class="convs-tl__time">${L(Pl(e.at))}${e.variant?` · Variant ${L(e.variant)}`:``}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      ...
      <div class="convs-drawer__body">
        ${r?`<a class="convs-drawer__lead" href="#/leads">
              <span class="convs-ava">${L(Nl(r))}</span>
        ...
        <div class="convs-sub" style="margin-bottom:6px">${L(i)} · ${L(Il(t.duration_s))}${t.variant?` · Variant ${L(t.variant)}`:``}</div>
        ${a?`<div class="convs-tl">${a}</div>`:Zl(`timeline`,`No timeline available for this journey.`)}
      </div>
    </aside>`,document.body.appendChild(o),requestAnimationFrame(()=>{o.classList.add(`open`),o.querySelector(`.convs-drawer`).classList.add(`open`)});let s=()=>{o.classList.remove(`open`),setTimeout(()=>o.remove(),220)};o.querySelector(`.convs-drawer__close`).addEventListener(`click`,s),o.addEventListener(`click`,e=>{e.target===o&&s()})}var Gl,L,Kl,ql,R,Jl,Yl,Xl,Zl,Ql,$l,eu=o((()=>{D(),ua(),Zt(),Gl={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},L=e=>String(e??``).replace(/[&<>"']/g,e=>Gl[e]),Kl=()=>E.getConfig?.().BASE_URL||``,ql=e=>Number(e||0).toLocaleString(),R={conversations:[],counts:{},magnetNames:{},filter:`ALL`,book:!1,magnetOwnerNames:{}},Jl={COMPLETED:{label:`Completed`,icon:`check_circle`},IN_PROGRESS:{label:`In progress`,icon:`pending`},ABANDONED:{label:`Abandoned`,icon:`highlight_off`}},Yl={book:`Book`,chat:`Chat`,call:`Call`,email:`Email`,support:`Support`},Xl=!1,Zl=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Ql={open:()=>`Opened the magnet`,engage:e=>`First interaction${e?`: ${Yl[e]||e}`:``}`,route:e=>`Picked ${Yl[e]||e||`a channel`}`,step:e=>`Reached step ${e||``}`,complete:()=>`Completed: lead captured`},$l={render:Rl,init:zl}})),tu=c({default:()=>Tu,init:()=>iu,render:()=>ru});function nu(){if(Cu)return;let e=document.createElement(`style`);e.id=`m5t-abt-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Cu=!0}function ru(){return M()?ta({section:`ab-testing`,title:`A/B Testing`,description:`Pick a client to view their experiments.`}):(nu(),`
    ...
    </div>`)}async function iu(){if(M())return na(yu(),[{h:`Running`,td:e=>bu(e.ab_tests?.running)},{h:`Completed`,td:e=>bu(e.ab_tests?.completed)},{h:`Compl. %`,td:e=>e.completion_rate==null?`—`:`${e.completion_rate}%`}],{emptyMsg:`No client orgs yet. Experiments appear per client once you have one.`});let e=document.getElementById(`abt-body`);try{let e=new Date,t=new Date(e.getTime()-76896e5).toISOString().slice(0,10),n=e.toISOString().slice(0,10),[r,i]=await Promise.all([fetch(`${yu()}/m5t/v5/magnets`),fetch(`${yu()}/m5t/v5/magnets/stats?from=${t}&to=${n}`)]),a=await r.json().catch(()=>({}));if(!a.ok)throw Error(a.message||`Failed to load`);xu.magnets=a.magnets||[],xu.canManage=!!a.canManage;let o=await i.json().catch(()=>({}));xu.stats=o?.stats||{}}catch(t){console.warn(`[ab-testing] load failed:`,t),e&&(e.innerHTML=wu(`error`,`Could not load your tests. Please try again.`));return}au()}function au(){let e=document.getElementById(`abt-body`);if(!e)return;let t=xu.magnets.filter(e=>e.ab?.enabled),n=xu.magnets.filter(e=>!e.ab?.enabled&&e.ab?.declared);if(!t.length&&!n.length){e.innerHTML=wu(`science`,`No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.`);return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(uu).join(``)}`:``)+(n.length?`<div class="abt-sect">Completed Tests</div>${n.map(du).join(``)}`:``),Yt(e,{rowSelector:`.abt-card`,noun:`tests`}),e.querySelectorAll(`[data-declare]`).forEach(e=>e.addEventListener(`click`,()=>fu(e.dataset.declare,e.dataset.winner)))}function ou(e){let t=xu.stats[e.guid]?.variants||{};return{A:{opens:0,engaged:0,completions:0,rate:null,...t.A||{}},B:{opens:0,engaged:0,completions:0,rate:null,...t.B||{}}}}function su(e){let t=Object.keys(e?.b||{}).map(e=>Su[e]||e);return t.length?`Changes: ${t.join(`, `)}`:``}function cu(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function lu(e,t,n,r,i,a){return`
    <div class="abt-variant${i?` leader`:``}">
      <div class="abt-vhead"><span class="abt-vname">${_u(e)}</span><span class="abt-vtag${i?` win`:``}">${_u(t)}</span></div>
      ${n?`<div class="abt-vdesc">${_u(n)}</div>`:``}
    ...
    </div>`}function uu(e){let t=e.ab,{A:n,B:r}=ou(e),i=(r.rate??-1)>(n.rate??-1)?`B`:(n.rate??-1)>(r.rate??-1)?`A`:null,a=i&&n.rate!=null&&r.rate!=null?`+${Math.round(Math.abs(r.rate-n.rate)*10)/10}%`:``,o=pu(n,r),s=t.started_tz?cu(t.started_tz):null,c=(n.opens||0)+(r.opens||0),l=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
        <h2 class="abt-name">${_u(e.name)}</h2>
        <span class="abt-status running"><span class="pulse-dot"></span>Running</span>
        <div class="abt-actions">
          ${xu.canManage&&i?`<button class="btn btn-primary" type="button" data-declare="${_u(e.guid)}" data-winner="${i}"><span class="material-symbols-outlined" aria-hidden="true">emoji_events</span>Declare Winner</button>`:``}
        </div>
      </div>
      <div class="abt-meta">
      ...
      <div class="abt-compare">
        ${lu(`Variant A`,`Control`,`The magnet as configured`,n,i===`A`,i===`A`?a:``)}
        <div class="abt-vs">VS</div>
        ${lu(`Variant B`,i===`B`?`Leading`:`Challenger`,su(t),r,i===`B`,i===`B`?a:``)}
      </div>
      <div class="abt-sig">
    ...
    <div class="abt-card">
      ...
      <div class="abt-summary">
        <span><span class="k">Winner:</span><span class="v">Variant ${_u(t.winner)}</span></span>
    ...
    </div>`}async function fu(e,t){let n=xu.magnets.find(t=>t.guid===e);if(n&&window.confirm(`Declare Variant ${t} the winner for “${n.name}”?\n\n${t===`B`?`Variant B’s changes become the magnet’s configuration for everyone.`:`The magnet keeps its current configuration.`} The experiment ends and moves to Completed.`)){try{let n=await(await fetch(`${yu()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!n.ok)throw Error(n.message||`Declare failed`);vu(`Variant ${t} declared the winner`,`success`)}catch(e){vu(e.message||`Could not declare a winner`,`danger`);return}try{await iu()}catch(e){console.warn(`[ab-testing] refresh after declare failed:`,e)}}}function pu(e,t){let n=e.opens||0,r=t.opens||0,i=e.completions||0,a=t.completions||0;if(n<30||r<30||i+a<5)return null;let o=i/n,s=a/r,c=(i+a)/(n+r),l=Math.sqrt(c*(1-c)*(1/n+1/r));if(!l)return null;let u=Math.abs(s-o)/l;return Math.round(2*(mu(u)-.5)*1e3)/10}function mu(e){let t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}var hu,gu,_u,vu,yu,bu,xu,Su,Cu,wu,Tu,Eu=o((()=>{D(),hu=u(f(),1),m(),ua(),Zt(),gu={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},_u=e=>String(e??``).replace(/[&<>"']/g,e=>gu[e]),vu=(e,t=`info`)=>{try{hu.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},yu=()=>E.getConfig?.().BASE_URL||``,bu=e=>Number(e||0).toLocaleString(),xu={magnets:[],stats:{},canManage:!1},Su={mag_title:`header title`,mag_subtitle:`subtitle`,mag_welcome:`welcome message`,mag_theme_color:`color`,mag_launcher_label:`launcher label`},Cu=!1,wu=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Tu={render:ru,init:iu}}));function Du(e,t){let n={};return Object.keys(e&&typeof e==`object`?e:{}).forEach(r=>{t.includes(r)||(n[r]=e[r])}),Object.keys(n).length?n:null}function Ou(e){return Du(e,gd)}function ku(e,t){let n=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||``).trim());return n?`rgba(${parseInt(n[1],16)},${parseInt(n[2],16)},${parseInt(n[3],16)},${t})`:`rgba(0,114,186,${t})`}function Au(){if(yd)return;let e=document.createElement(`style`);e.id=`m5t-flow-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),yd=!0}function ju(e=`single_select`){return{_uid:Ad(),id:``,step_type:e,step_prompts:[``],step_options:ud(e)?[{label:``,goto:``,icon:``},{label:``,goto:``,icon:``}]:[],step_columns:md(e)?[md(e)]:[],step_description:``,step_config:fd(e)?hd():null}}function Mu(e){return(Array.isArray(e)?e:[]).map(e=>({_uid:Ad(),id:e.id==null?``:String(e.id),step_type:od[e.step_type]?e.step_type:`single_select`,step_prompts:Array.isArray(e.step_prompts)?e.step_prompts.map(String):[],step_options:(Array.isArray(e.step_options)?e.step_options:[]).map(e=>({label:e&&e.label!=null?String(e.label):``,goto:e&&e.goto!=null?String(e.goto):``,icon:e&&e.icon!=null?String(e.icon):``})),step_columns:Array.isArray(e.step_columns)?e.step_columns.map(String):[],step_description:e.step_description==null?``:String(e.step_description),step_config:fd(e.step_type)?{...hd(),...e.step_config&&typeof e.step_config==`object`?e.step_config:{}}:e.step_config&&typeof e.step_config==`object`?{...e.step_config}:null}))}function Nu(){return[{_uid:Ad(),id:``,step_type:`text`,step_prompts:[`Great, and your name?`],step_options:[],step_columns:[`first_name`],step_description:``,step_config:null},{_uid:Ad(),id:``,step_type:`email`,step_prompts:[`The best email to reach you?`],step_options:[],step_columns:[`email`],step_description:``,step_config:null}]}function Pu(e,t){if(e===`book`)return[{_uid:Ad(),id:``,step_type:`scheduler`,step_prompts:[`When works best for you?`],step_options:[],step_columns:[],step_description:``,step_config:hd()},...Nu()];if(e===`support`){let e=(t.actions||[]).find(e=>e&&e.type===`support`),n=e&&e.config&&Array.isArray(e.config.options)?e.config.options:[],r=n.length?n.map(e=>({label:e&&e.label||String(e),goto:``,icon:e&&e.icon||``})):[`Sales enquiry`,`Support`,`Billing`,`Something else`].map(e=>({label:e,goto:``,icon:``}));return[{_uid:Ad(),id:``,step_type:`multi_select`,step_prompts:[`How can we help you today?`],step_options:r,step_columns:[],step_description:`Select all that apply`,step_config:null},...Nu()]}return[ju(`single_select`)]}function Fu(e,t){let n=Mu(e===`chat`?t.steps:t.routes&&t.routes[e]);return n.length?n:e===`chat`?[ju(`single_select`)]:Pu(e,t)}function Iu(e){ud(e.step_type)?e.step_options.length||(e.step_options=[{label:``,goto:``,icon:``},{label:``,goto:``,icon:``}]):e.step_options=[],dd(e.step_type)?!e.step_columns.length&&md(e.step_type)&&(e.step_columns=[md(e.step_type)]):e.step_columns=[],e.step_config=fd(e.step_type)?{...hd(),...e.step_config||{}}:Ou(e.step_config)}function Lu(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${z(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${vd.map(([t,n])=>`<option value="${z(t)}"${t===e.icon?` selected`:``}>${z(n)}</option>`).join(``)}</select>
  ...
  </div>`}function Ru(e){let t=sd.map(t=>`<option value="${t}"${t===e.step_type?` selected`:``}>${z(ld(t).label)}</option>`).join(``),n=e.step_options.length<=1;return`<div class="flow-node__body">
...
`))}</textarea>
    ...
    <select class="mag-modal__select flow-f-field">
      ...
      ${Be.map(t=>`<option value="${z(t.value)}"${t.value===e.step_columns[0]?` selected`:``}>${z(t.label)}</option>`).join(``)}
    </select>
    ...
    <div class="flow-opts">${e.step_options.map(e=>Lu(e,n)).join(``)}</div>
  ...
  </div>`}function zu(e){let t=e.step_prompts.find(e=>String(e).trim()!==``)||``,n=t?`<div class="flow-node__prompt">“${z(t)}”</div>`:`<div class="flow-node__prompt is-empty">${e.step_type===`message`?`No message yet`:`No question yet`}</div>`,r=``;if(ud(e.step_type)){let t=e.step_options.map(e=>String(e.label).trim()).filter(Boolean);t.length&&(r=`<div class="flow-node__chips">${t.slice(0,4).map(e=>`<span class="flow-node__chip">${z(e)}</span>`).join(``)}${t.length>4?`<span class="flow-node__chip">+${t.length-4}</span>`:``}</div>`)}else if(dd(e.step_type)&&e.step_columns[0]){let t=Be.find(t=>t.value===e.step_columns[0])?.label||e.step_columns[0];r=`<div class="flow-node__meta">Saves to <b>${z(t)}</b></div>`}else if(pd(e.step_type)&&e.step_config?.terminal){let t=String(e.step_config?.cta?.label||``).trim();r=`<div class="flow-node__meta">Ends the conversation${t?` — link: <b>${z(t)}</b>`:``}</div>`}return`<div class="flow-node__preview">${n}${r}</div>`}function Bu(e,t,n){let r=ld(e.step_type),i=e._uid===bd,a=`--nc:${r.color};--nct:${ku(r.color,.14)}`;return`<div class="flow-node${i?` flow-node--open`:``}" data-uid="${e._uid}" style="${a}"${i?``:` draggable="true"`}>
    ...
    ${i?Ru(e):zu(e)}
  </div>`}function Vu(){let e=document.getElementById(`flow-nodes`);if(!e)return;let t=B.length,n=[`<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>`,jd];B.forEach((e,r)=>{n.push(Bu(e,r,t)),r<t-1&&n.push(jd)}),e.innerHTML=n.join(``)}function Hu(){let e=document.querySelector(`.flow-node--open`);if(!e)return;let t=B.find(t=>t._uid===e.dataset.uid);if(!t)return;let n=e.querySelector(`.flow-f-type`);n&&(t.step_type=n.value);let r=e.querySelector(`.flow-f-prompts`);r&&(t.step_prompts=r.value.split(`
`));let i=e.querySelector(`.flow-f-field`);if(t.step_columns=i&&i.value.trim()?[i.value.trim()]:[],ud(t.step_type)){let n=t.step_options,r=[];e.querySelectorAll(`.flow-opt`).forEach((e,t)=>{r.push({label:e.querySelector(`.flow-o-label`)?.value??``,icon:e.querySelector(`.flow-o-icon`)?.value??``,goto:n[t]&&n[t].goto||``})}),t.step_options=r}else t.step_options=[];if(fd(t.step_type)){let n=e.querySelector(`.flow-f-mtlabel`),r=e.querySelector(`.flow-f-start`),i=e.querySelector(`.flow-f-end`),a=e.querySelector(`.flow-f-mins`);t.step_config={...t.step_config||hd(),...n?{meeting_label:n.value.trim()}:{},...r&&r.value?{start:r.value}:{},...i&&i.value?{end:i.value}:{},...a?{mins:parseInt(a.value,10)||30}:{}}}else if(pd(t.step_type)){let n=e.querySelector(`.flow-f-terminal`);if(n){let r=e.querySelector(`.flow-f-cta-label`),i=e.querySelector(`.flow-f-cta-url`),a=Du(t.step_config,_d)||{};t.step_config=n.checked?{...a,terminal:!0,cta:{label:r?r.value:``,url:i?i.value:``}}:Du(t.step_config,_d)}}else t.step_config=Ou(t.step_config)}function Uu(){document.querySelectorAll(`.flow-node.drop-before, .flow-node.drop-after`).forEach(e=>e.classList.remove(`drop-before`,`drop-after`))}function Wu(){Uu(),document.querySelectorAll(`.flow-node.dragging`).forEach(e=>e.classList.remove(`dragging`)),Sd=null,Cd=null}function Gu(e=B){if(!e.length)return{message:`Add at least one step.`,uid:null,field:null};for(let t=0;t<e.length;t++){let n=e[t],r=t+1,i=(e,t=null)=>({message:e,uid:n._uid,field:t});if(!n.step_prompts.some(e=>String(e).trim()!==``))return i(`Step ${r}: add what the magnet should say.`,`prompts`);if(ud(n.step_type)&&!n.step_options.some(e=>String(e.label).trim()!==``))return i(`Step ${r}: add at least one choice.`,`options`);if(dd(n.step_type)&&!n.step_columns.length)return i(`Step ${r}: choose which field this answer saves to.`,`field`);if(pd(n.step_type)&&n.step_config?.terminal){let e=String(n.step_config.cta?.label||``).trim(),t=String(n.step_config.cta?.url||``).trim();if(!!e!=!!t)return i(`Step ${r}: fill in both the link label and URL, or leave both blank.`,`cta`)}}return null}function Ku(e){if(!e)return;let t=e.querySelector(`.flow-f-cta-label`),n=e.querySelector(`.flow-f-cta-url`);if(!t||!n)return;let r=t.value.trim()!==``,i=n.value.trim()!==``,a=r||i,o=r!==i;e.querySelectorAll(`.flow-cta-req`).forEach(e=>{e.textContent=a?`required`:`optional`,e.classList.toggle(`flow-sub--req`,a)}),t.classList.toggle(`flow-f-invalid`,o&&!r),n.classList.toggle(`flow-f-invalid`,o&&!i);let s=e.querySelector(`.flow-cta-warn`);s&&(s.hidden=!o)}function qu(e=B){let t=0;return e.forEach(e=>{let n=parseInt(e.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(e=>{let n=e.id&&String(e.id).trim()?String(e.id):String(++t),r=ud(e.step_type)?e.step_options.map(e=>{let t={label:String(e.label).trim(),goto:String(e.goto||``)};return e.icon&&(t.icon=String(e.icon)),t}).filter(e=>e.label!==``):[],i={id:n,step_type:e.step_type,step_prompts:e.step_prompts.map(e=>String(e)).filter(e=>e.trim()!==``),step_options:r,step_columns:e.step_columns.slice(),step_description:e.step_description||``};if(fd(e.step_type))e.step_config&&(i.step_config={...hd(),...e.step_config});else if(e.step_config&&Object.keys(e.step_config).length){let t={...e.step_config};if(pd(e.step_type)&&t.terminal){let e=String(t.cta?.label??``).trim(),n=String(t.cta?.url??``).trim();e&&n?t.cta={label:e,url:n}:delete t.cta}i.step_config=t}return i})}function Ju(e,t,n){Au(),Dd=t,Od=typeof n==`function`?n:null,kd=t?.modified_tz||``,Ed=[`chat`,...[`book`,`support`].filter(e=>(t.actions||[]).some(t=>t&&t.type===e))],Td={chat:Fu(`chat`,t)},wd=`chat`,B=Td.chat,bd=B.length===1?B[0]._uid:null,Sd=null,Cd=null,e.innerHTML=`
    ...
    ${Ed.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${Ed.map(e=>`<option value="${e}">${z(cd[e]||e)}</option>`).join(``)}</select></div>`:``}
...
<body>
  ...
  <\/script>
  <script>${n}<\/script>
</body></html>`}function Ld(){if(Hd)return;let e=document.createElement(`style`);e.id=`m5t-preview-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Hd=!0}function Rd(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function zd(e){let t=e.querySelector(`[data-pv-info]`),n=e.querySelector(`[data-pv-info-pop]`);t&&n&&t.addEventListener(`click`,()=>{n.hidden=!n.hidden})}function Bd(e,t){Ld(),e.innerHTML=`
    <div class="pv-pane">
      ...
      ${Rd(`Live render of the real widget. Capture is disabled, so no test leads.`)}
    </div>`,zd(e);let n=e.querySelector(`.pv-pane__frame`),r=e.querySelector(`.pv-pane__badge`),i=null,a=0;n.addEventListener(`load`,()=>{let e=(typeof performance<`u`?performance.now():Date.now())-a;clearTimeout(i),e<450?i=setTimeout(()=>{r.hidden=!0},450-e):r.hidden=!0});let o=()=>{let e;try{e=Id(t())}catch{return}a=typeof performance<`u`?performance.now():Date.now(),r.hidden=!1,n.srcdoc=e,clearTimeout(i),i=setTimeout(()=>{r.hidden=!0},1500)};return e.querySelector(`.pv-pane__seg`).addEventListener(`click`,t=>{let r=t.target.closest(`button[data-device]`);!r||r.dataset.device===n.dataset.device||(e.querySelectorAll(`.pv-pane__seg button`).forEach(e=>e.classList.toggle(`is-on`,e===r)),n.dataset.device=r.dataset.device)}),o(),{refresh:o,destroy(){clearTimeout(i)}}}function Vd(e){Ld();let t=`desktop`,n=document.createElement(`div`);n.className=`pv-scrim`,n.innerHTML=`
    <div class="pv-modal" role="dialog" aria-modal="true" aria-label="Magnet preview">
      ...
      <div class="pv-body">
        <div>
          ...
          ${Rd(`Live render of the actual widget. Capture is disabled, so no test leads are created.`)}
        </div>
      </div>
    </div>`,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add(`open`)),zd(n);let r=n.querySelector(`.pv-frame`),i=n.querySelector(`.pv-stage`),a=()=>{try{r.srcdoc=Id(e())}catch{}};a();let o=()=>{n.classList.remove(`open`),setTimeout(()=>n.remove(),180)};return n.querySelector(`[data-x="close"]`).addEventListener(`click`,o),n.querySelector(`[data-x="refresh"]`).addEventListener(`click`,a),n.addEventListener(`click`,e=>{e.target===n&&o()}),n.querySelector(`.pv-seg`).addEventListener(`click`,e=>{let r=e.target.closest(`button[data-device]`);!r||r.dataset.device===t||(t=r.dataset.device,n.querySelectorAll(`.pv-seg button`).forEach(e=>e.classList.toggle(`is-on`,e.dataset.device===t)),i.dataset.device=t,a())}),{close:o,rebuild:a}}var Hd,Ud=o((()=>{Pd(),Hd=!1}));function Wd(e){let t=[];for(let n of e.steps||[])for(let e of n.step_columns||[])e&&!t.includes(e)&&t.push(e);return t}function Gd(e){let t=(e.steps||[])[0]||{},n=(t.step_prompts||[])[0]||``,r=``;return t.step_type===`single_select`||t.step_type===`multi_select`?r=(t.step_options||[]).slice(0,3).map(e=>`<span class="mag-tpl-pv__btn">${ef(e?.label)}</span>`).join(``):rf[t.step_type]?r=`<span class="mag-tpl-pv__input">${ef(rf[t.step_type])}</span>`:t.step_type===`scheduler`&&(r=`<span class="mag-tpl-pv__cal"><span class="material-symbols-outlined" aria-hidden="true">calendar_month</span>Pick a time</span>`),`<div class="mag-tpl-card__preview" aria-hidden="true"><span class="mag-tpl-pv__bubble">${ef(n)}</span>${r}</div>`}function Kd(e,{detail:t=!1,gallery:n=!1,canUse:r=!0}={}){let i=t?Wd(e):[],a=n?` mag-tpl-card--gallery`:``,o=n?` data-cat="${ef(e.category||``)}"`:``,s=n&&e.featured?`<span class="m5t-badge m5t-badge--featured m5t-featured-corner">Most popular</span>`:``,c=n?Gd(e):``,l=n&&(e.tags||[]).length?`<div class="m5t-chip-row mag-tpl-card__tags">${e.tags.map(e=>`<span class="m5t-chip">${ef(e)}</span>`).join(``)}</div>`:``,u=r?`<button class="mag-tpl-card__btn" type="button" data-tpl="${e.id}">
    ...
    </div>`}function qd(e){da(ma.MAGNET_TEMPLATE,{id:e,at:Date.now()})}function Jd(e){if(!e)return null;if(typeof e==`string`)return nf.find(t=>t.id===e)||null;let{id:t,at:n}=e;return typeof n==`number`&&Date.now()-n>=af?null:nf.find(e=>e.id===t)||null}function Yd(){return Jd(fa(ma.MAGNET_TEMPLATE))}function Xd(){return Jd(pa(ma.MAGNET_TEMPLATE))}function Zd(){if(of)return;let e=document.createElement(`style`);e.id=`m5t-mag-template-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),of=!0}function Qd(e){Zd();let t=document.createElement(`div`);t.className=`mag-modal-scrim mag-tpl-modal`,t.innerHTML=`
    ...
    <label><input type="radio" name="${H(e)}" value="${H(n.value)}"${n.value===t?` checked`:``}>
      ...
      </select>`}else if(n.kind===`value`)a=`<input class="mag-modal__input mag-cta__val" type="text" placeholder="${H(n.placeholder)}" value="${H(t?.value||``)}"${i}>`;else if(n.kind===`book`){let e=t?.config?.meeting_label||t?.value||``,n=t?.config?.source===`calendly`,r=n&&t?.config?.calendly_url||``,o=n?t?.config?.event_name||`Saved Calendly event`:``;a=`
      ...
      <input class="mag-modal__input mag-cta__val" type="text" placeholder="Meeting label (e.g. 15 minute call), or paste a booking link" value="${H(e)}"${i}${n?` hidden`:``}>
      <select class="mag-modal__select mag-cta__calevent" data-saved="${H(r)}" data-saved-name="${H(o)}"${i}${n?``:` hidden`}>
        ${r?`<option value="${H(r)}" selected>${H(o)}</option>`:``}
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${n.kind}">
    ...
    ${o}
  </div>`}function xf(){if(Tp)return;let e=document.createElement(`style`);e.id=`m5t-magnets-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Tp=!0}function Sf(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Cf(e){let t=V.stats[e];if(!t||!t.opens&&!t.leads)return`<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>`;let n=e=>Number(e||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function wf(e){let t=V.install[e.guid];if(!t)return``;let n=t.unrecognized||[],r=(t.traffic?.opens||0)>0,i=e.can_manage===!0,a=n.length?`
    ...
    ${s}
    ${l}
  </div>`}async function Tf(){await Promise.all(V.magnets.map(async e=>{try{let t=await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity`)).json().catch(()=>({}));if(!t.ok)return;V.install[e.guid]=t,qf(e)}catch(t){console.warn(`[magnets] install activity failed:`,e.guid,t)}}))}function Ef(e){return e?e.status===`REVOKED`||e.status===`PENDING`&&e.codeLive===!1:!1}function Df(e,t){let n=t.status===`PENDING`&&t.codeLive===!1,r=(n?Bp.EXPIRED:Bp[t.status])||{label:t.status,icon:`help`,tone:`off`},i=t.lastSeen?new Date(t.lastSeen).toLocaleString():``,a=t.host?H(t.host):n||t.status===`REVOKED`?`Code was never used`:`Waiting for a site to use this code`,o=[t.siteName?H(t.siteName):``,i?`last seen ${H(i)}`:``].filter(Boolean).join(` — `);return`
    <div class="mag-conn__row" data-conn="${H(t.guid)}" data-state="${r.tone}">
      ...
      ${e.can_manage===!0?Ef(t)?`<button class="mag-btn" data-action="clear-connection" data-guid="${H(e.guid)}" data-conn="${H(t.guid)}"
    ...
    </div>`}function Of(e){let t=V.pairing[e.guid];if(!t)return``;if(t.error)return`<div class="mag-conn__code" data-state="error">
  ...
  </div>`}function kf(e){let t=V.connections[e.guid];if(!t)return``;if(t.failed)return`<div class="mag-conn">
    ...
    </div>`;let n=t.connections||[],r=n.filter(t=>t.status!==`PENDING`||e.can_manage===!0),i=n.filter(e=>e.status===`ACTIVE`).length,a=Of(e),o=r.filter(e=>!Ef(e)),s=r.filter(e=>Ef(e)),c=o.length?o.map(t=>Df(e,t)).join(``):`<p class="mag-install__hint">No sites connected yet. On WordPress, connecting a site pairs it without pasting the snippet by hand.</p>`,l=s.length?`
  ...
  </div>`}function Af(e){let t=document.querySelector(`.mag-card[data-guid="${CSS.escape(e.guid)}"] .mag-conn-slot`);t&&(t.innerHTML=kf(e))}async function jf(e){let t=await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/connections`)).json().catch(()=>({}));if(!t.ok)throw Error(t.error||`Could not load connected sites`);return t}async function Mf(){await Promise.all(V.magnets.map(async e=>{try{V.connections[e.guid]=await jf(e)}catch(t){console.warn(`[magnets] connections failed:`,e.guid,t),V.connections[e.guid]={failed:!0}}Af(e)}))}function Nf(){V.pairTimer&&(clearInterval(V.pairTimer),V.pairTimer=null)}function Pf(){Nf()}function Ff(e){return!!document.querySelector(`.mag-card[data-guid="${CSS.escape(e)}"] .mag-conn-slot`)}function If(){if(V.pairTimer)return;let e=0;V.pairTimer=setInterval(async()=>{for(let e of Object.keys(V.pairing))Ff(e)||delete V.pairing[e];let t=Object.keys(V.pairing);if(!t.length){Nf();return}if(!t.some(e=>{let t=V.pairing[e];return!t.connected&&!t.error&&t.expiresAt-Date.now()>0})){t.forEach(e=>{let t=V.magnets.find(t=>t.guid===e);t&&Af(t)}),Nf();return}e+=1e3;let n=e>=zp;n&&(e=0);for(let e of t){let t=V.magnets.find(t=>t.guid===e),r=V.pairing[e];if(!t||!r)continue;let i=r.expiresAt-Date.now()<=0;if(n&&!r.connected&&!r.error&&!i)try{let n=await jf(t);V.connections[e]=n;let i=(n.connections||[]).find(e=>e.guid===r.connectionGuid&&e.status===`ACTIVE`);i&&(V.pairing[e]={connected:!0,connectionGuid:r.connectionGuid,connectedHost:i.host},U(`${i.host||`Your site`} connected`,`success`))}catch{}Af(t)}},1e3)}async function Lf(e){try{let t=await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/pairing-code`,{method:`POST`,headers:{"Content-Type":`application/json`},body:`{}`}),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok){V.pairing[e.guid]={error:n.message||n.error||`Could not generate a pairing code`},Af(e);return}V.pairing[e.guid]={code:n.pairingCode,connectionGuid:n.connectionGuid,expiresAt:new Date(n.expiresAt).getTime()};try{V.connections[e.guid]=await jf(e)}catch{}Af(e),If()}catch{V.pairing[e.guid]={error:`Could not reach the server. Try again.`},Af(e)}}async function Rf(e){let t=V.pairing[e.guid]?.code;if(t)try{await navigator.clipboard.writeText(t),U(`Pairing code copied`,`success`)}catch{U(`Copy failed — select the code and copy it manually`,`danger`)}}async function zf(e,t,n){if(window.confirm(`Clear the record for ${n||`this connection`}?\n\nIt is removed from this list for good. This only tidies up the history — the site is already disconnected, so nothing about access changes.`))try{let n=await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/connections/${encodeURIComponent(t)}`,{method:`DELETE`}),r=await n.json().catch(()=>({}));if(!n.ok||!r.ok){U(r.message||r.error||`Could not clear that record`,`danger`);return}U(`Record cleared`,`success`);try{V.connections[e.guid]=await jf(e)}catch{}Af(e)}catch{U(`Could not reach the server`,`danger`)}}async function Bf(e,t){let n=(V.connections[e.guid]?.connections||[]).find(e=>e.guid===t),r=n?.status===`PENDING`,i=r?`Cancel this pairing code?`:`Disconnect ${n?.host||`this site`}?`,a=r?`The code stops working immediately.`:`Its key stops working immediately and the plugin will show as disconnected. The domain stays on the allow-list — remove it separately if you want the magnet off that site.`;if(window.confirm(`${i}\n\n${a}`))try{let n=await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/connections/${encodeURIComponent(t)}/revoke`,{method:`POST`,headers:{"Content-Type":`application/json`},body:`{}`}),i=await n.json().catch(()=>({}));if(!n.ok||!i.ok){U(i.message||i.error||`Could not disconnect`,`danger`);return}V.pairing[e.guid]?.connectionGuid===t&&delete V.pairing[e.guid],U(r?`Pairing code cancelled`:`Site disconnected`,`success`);try{V.connections[e.guid]=await jf(e)}catch{}Af(e)}catch{U(`Could not reach the server`,`danger`)}}function Vf(e){if(e.status===`DRAFT`)return`draft`;if(e.status!==`ENABLED`)return`off`;let t=V.install[e.guid];return t?(t.traffic?.opens||0)>0?`live`:(t.unrecognized||[]).length?`seen`:`quiet`:`unknown`}function Hf(e){let t=Vf(e);if(t===`draft`)return`<span class="material-symbols-outlined" aria-hidden="true">edit_note</span>Not live yet`;if(t===`off`)return`<span class="material-symbols-outlined" aria-hidden="true">pause_circle</span>Disabled`;if(t===`unknown`)return``;let n=V.install[e.guid];if(t===`live`){let e=n.traffic?.last_open_at?new Date(n.traffic.last_open_at):null,t=e&&e.toDateString()===new Date().toDateString(),r=e?t?e.toLocaleTimeString([],{hour:`numeric`,minute:`2-digit`}):e.toLocaleDateString():``;return`<span class="material-symbols-outlined" aria-hidden="true">check_circle</span>Live${r?` &middot; ${H(r)}`:``}`}return t===`seen`?`<span class="material-symbols-outlined" aria-hidden="true">travel_explore</span>Unrecognised domain`:`<span class="material-symbols-outlined" aria-hidden="true">help</span>Not seen in ${Number(n.window_days||30)} days`}function Uf(e){let t=V.owners.length>1||E.getMemberships().length>1,n=(e.domains||[]).filter(Boolean),r=e.can_manage===!0,i=Vf(e),a=Hf(e),o=V.detailOpen[e.guid]===!0,s=[n.length?n.join(`, `):`No domains set. Add yours to go live.`,t&&e.owner_name?e.owner_name:``].filter(Boolean).join(` · `);return`
    <div class="mag-card" data-guid="${H(e.guid)}">
      <div class="mag-line">
        ...
        <div class="mag-id">
          <div class="mag-id__line">
            ...
            <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${jp[e.display_mode]||`chat`}</span>${H(Ap[e.display_mode]||`Chat bubble`)}</span>
          ...
          <div class="mag-sub" title="${H(s)}">${H(s)}</div>
        </div>
        <div class="mag-right">
          <button class="mag-health" type="button" data-action="install-toggle" data-guid="${H(e.guid)}" data-live="${i}" ${a?``:`hidden`} title="Install and health detail">${a}</button>
          ${Cf(e.guid)}
          <div class="mag-rowactions">
            ...
            <button class="mag-btn" data-action="install-toggle" data-guid="${H(e.guid)}" aria-expanded="${o}" aria-controls="mag-detail-${H(e.guid)}"><span class="material-symbols-outlined" aria-hidden="true">${o?`expand_less`:`expand_more`}</span>Install</button>
      ...
      <div class="mag-detail" id="mag-detail-${H(e.guid)}" ${o?``:`hidden`}>
        <div class="mag-embed">
          <input type="text" readonly value="${H(Dp(e.guid))}" aria-label="Embed snippet">
        ...
        <div class="mag-install-slot">${wf(e)}</div>
        <div class="mag-conn-slot">${kf(e)}</div>
      </div>
    </div>`}function Wf(e,t){let n=typeof t==`boolean`?t:V.detailOpen[e]!==!0;V.detailOpen[e]=n;let r=document.querySelector(`.mag-card[data-guid="${CSS.escape(e)}"]`);if(!r)return;let i=r.querySelector(`.mag-detail`);i&&(i.hidden=!n);let a=r.querySelector(`[data-action="install-toggle"][aria-controls]`);if(a){a.setAttribute(`aria-expanded`,String(n));let e=a.querySelector(`.material-symbols-outlined`);e&&(e.textContent=n?`expand_less`:`expand_more`)}}function Gf(){Vp||(Vp=!0,document.addEventListener(`click`,e=>{e.target.closest?.(`.mag-more-wrap`)||Kf()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Kf()}))}function Kf(e){document.querySelectorAll(`.mag-menu`).forEach(t=>{if(t===e)return;t.hidden=!0;let n=t.parentElement?.querySelector(`[data-action="menu"]`);n&&n.setAttribute(`aria-expanded`,`false`)})}function qf(e){let t=document.querySelector(`.mag-card[data-guid="${CSS.escape(e.guid)}"]`);if(!t)return;let n=t.querySelector(`.mag-install-slot`);n&&(n.innerHTML=wf(e));let r=Vf(e),i=t.querySelector(`.mag-dot`);i&&(i.dataset.live=r);let a=t.querySelector(`.mag-health`);if(a){let t=Hf(e);a.innerHTML=t,a.dataset.live=r,a.hidden=!t}(r===`quiet`||r===`seen`)&&V.detailOpen[e.guid]===void 0&&Wf(e.guid,!0)}function Jf(){return M()?ta({section:`magnets`,title:`Your Magnets`,description:`Pick a client to view and manage their magnets.`}):(xf(),`
    <div class="page-shell" data-section="magnets">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="mag-body">
          ${Sf(`hourglass_empty`,`Loading magnets…`)}
        </div>
      </div>
    </div>`)}async function Yf(){if(M()){let e=Xd();if(e){let t=document.querySelector(`.page-shell .page-header-text .page-description`);t&&(t.textContent=`Template picked: ${e.name}. Choose the client to build it for.`)}let t=e=>Number(e||0).toLocaleString();return na(W(),[{h:`Magnets`,td:e=>`${t(e.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${t(e.magnets.total)}</span>`},{h:`Leads · wk`,td:e=>t(e.leads.this_week)},{h:`Leads · total`,td:e=>t(e.leads.total)}],{emptyMsg:`No client orgs yet. Create one under Clients, then provision its magnets here.`})}Lp=null,Rp=null,document.getElementById(`mag-new-btn`)?.addEventListener(`click`,rp),document.getElementById(`mag-template-btn`)?.addEventListener(`click`,ap),document.getElementById(`mag-body`)?.addEventListener(`click`,op),Gf(),await Zf();let e=Yd();e&&V.canProvision&&ip(e)}function Xf(e){e&&(e.innerHTML=`<div class="mag-grid">${V.magnets.map(Uf).join(``)}</div>`,Yt(e.querySelector(`.mag-grid`),{rowSelector:`.mag-card`,noun:`magnets`}))}async function Zf(){let e=document.getElementById(`mag-body`);if(!e)return;try{let[e,t]=await Promise.all([fetch(`${W()}/m5t/v5/magnets`),fetch(`${W()}/m5t/v5/magnets/stats`).catch(()=>null)]),n=await e.json().catch(()=>({}));if(!n.ok)throw Error(n.message||`Failed to load`);V.magnets=n.magnets||[],V.owners=n.owners||[],V.canProvision=!!n.canProvision,V.canManage=!!n.canManage,V.primaryOrgGuid=n.primaryOrgGuid||null;let r=t?await t.json().catch(()=>({})):{};V.stats=r?.stats||{}}catch{e.innerHTML=Sf(`error`,`Could not load your magnets. Please try again.`);return}let t=document.getElementById(`mag-new-btn`);t&&(t.style.display=V.canProvision?``:`none`);let n=document.getElementById(`mag-template-btn`);if(n&&(n.style.display=V.canProvision?``:`none`),!V.magnets.length){e.innerHTML=Sf(`widgets`,V.canProvision?`No magnets yet. Click “New magnet” to create your first.`:`No magnets yet.`);return}Xf(e),Tf(),Mf()}async function Qf(e){let t={"Content-Type":`application/json`,"Idempotency-Key":crypto.randomUUID()},n={status:`DRAFT`};e&&(n.owner_guid=e);let r=await fetch(`${W()}/m5t/v5/magnets`,{method:`POST`,headers:t,body:JSON.stringify(n)}),i={};try{i=await r.json()}catch{}if(!r.ok||!i.ok)throw Error(i.message||`Could not start a new magnet (${r.status})`);return i.magnet}async function $f(e,t){let n=await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({name:t.name,...t.appearance,steps:t.steps})}),r={};try{r=await n.json()}catch{}if(!n.ok||!r.ok)throw Error(r.message||`Could not apply the ${t.name} template (${n.status})`)}async function ep(e,t){let n=document.getElementById(`mag-new-btn`),r=document.getElementById(`mag-template-btn`);n&&(n.disabled=!0),r&&(r.disabled=!0);let i=null;try{let n=await Qf(e);i=n.guid,t?(await $f(n.guid,t),await Zf(),n=V.magnets.find(e=>e.guid===n.guid)||n):(V.magnets=[n,...V.magnets],Xf(document.getElementById(`mag-body`))),Cp(n,void 0,{freshDraft:!0})}catch(e){i&&fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(i)}`,{method:`DELETE`}).catch(()=>{}),U(e.message||`Could not start a new magnet`,`danger`)}finally{n&&(n.disabled=!1),r&&(r.disabled=!1)}}function tp(e){let t=document.createElement(`div`);t.className=`mag-modal-scrim`,t.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="Choose client" style="max-width:420px">
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add(`open`),t.querySelector(`.mag-modal`).classList.add(`open`)});let n=()=>{t.classList.remove(`open`),setTimeout(()=>t.remove(),180),document.removeEventListener(`keydown`,r)};function r(e){e.key===`Escape`&&(e.preventDefault(),n())}document.addEventListener(`keydown`,r),t.querySelector(`.mag-modal__close`).addEventListener(`click`,n),t.querySelector(`[data-x="cancel"]`).addEventListener(`click`,n),t.querySelector(`[data-x="continue"]`).addEventListener(`click`,()=>{let r=t.querySelector(`#mag-owner-pick`).value;n(),ep(r,e)})}function np(){return V.owners.length===1?V.owners[0].guid:null}function rp(){if(V.owners.length>1){tp();return}ep(np())}function ip(e){if(V.owners.length>1){tp(e);return}ep(np(),e)}function ap(){Qd(ip)}function op(e){let t=e.target.closest(`[data-action]`);if(!t){Kf();return}let n=t.dataset.guid,r=V.magnets.find(e=>e.guid===n),i=t.dataset.action;if(i===`menu`){let e=t.parentElement?.querySelector(`.mag-menu`);if(!e)return;let n=e.hidden;Kf(e),e.hidden=!n,t.setAttribute(`aria-expanded`,String(n));return}if(Kf(),i===`install-toggle`)return Wf(n);if(i===`copy`)return sp(n);if(r){if(i===`preview`)return Vd(()=>Fd(r));if(i===`funnel`)return lp(r);if(i===`edit`)return Cp(r);if(i===`flow`)return Cp(r,`flow`);if(i===`allow-domain`)return up(r,t.dataset.domain);if(i===`dismiss-domain`)return dp(r,t.dataset.domain);if(i===`restore-domain`)return fp(r,t.dataset.domain);if(i===`pair-start`)return Lf(r);if(i===`copy-code`)return Rf(r);if(i===`revoke-connection`)return Bf(r,t.dataset.conn);if(i===`clear-connection`)return zf(r,t.dataset.conn,t.dataset.label);if(i===`toggle`)return mp(r);if(i===`delete`)return hp(r)}}async function sp(e){try{await navigator.clipboard.writeText(Dp(e)),U(`Embed snippet copied`,`success`)}catch{U(`Copy failed`,`danger`)}}function cp(e){let t=Number(e?.total_steps)||0,n={};if((Array.isArray(e?.funnel)?e.funnel:[]).forEach(e=>{n[e.position]=Number(e.reached)||0}),!t||!Object.keys(n).length)return`<p class="mag-modal__hint" style="margin:0">No step activity yet in this window. As visitors answer questions, drop-off by step will appear here.</p>`;let r=Math.max(1,n[1]||0),i=[];for(let e=1;e<=t;e++){let a=n[e]||0,o=Math.min(100,Math.round(a/r*100));i.push(`
      ...
      </div>`)}return`<div class="mag-funnel">${i.join(``)}</div>`}async function lp(e){let t=document.createElement(`div`);t.className=`mag-modal-scrim`,t.innerHTML=`
    <div class="mag-modal mag-funnel-modal" role="dialog" aria-modal="true" aria-label="Step funnel for ${H(e.name)}">
      ...
      <div class="mag-modal__body" style="padding:20px">
        ...
        <div id="mag-funnel-body">${Sf(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add(`open`),t.querySelector(`.mag-modal`).classList.add(`open`)});let n=()=>{t.classList.remove(`open`),setTimeout(()=>t.remove(),180),document.removeEventListener(`keydown`,r)};function r(e){e.key===`Escape`&&(e.preventDefault(),n())}document.addEventListener(`keydown`,r),t.querySelector(`.mag-modal__close`).addEventListener(`click`,n),t.addEventListener(`click`,e=>{e.target===t&&n()});let i=t.querySelector(`#mag-funnel-body`);try{let t=await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/step-funnel`),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.message||`Failed (${t.status})`);i.innerHTML=cp(n)}catch{i.innerHTML=`<p class="mag-modal__hint" style="margin:0">Could not load the funnel. Please try again.</p>`}}async function up(e,t){let n=String(t||``).trim().toLowerCase();if(!n||!window.confirm(`Allow ${n} to load this magnet?\n\nOnly do this for a site you recognise — anyone can put this magnet's embed code on a page.`))return;let r=[...new Set([...(e.domains||[]).filter(Boolean),n])];try{if(!(await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({domains:r})})).json().catch(()=>({}))).ok)throw Error();U(`${n} allowed`,`success`)}catch{U(`Could not allow that domain`,`danger`);return}try{await Zf()}catch(e){console.warn(`[magnets] refresh after allow-domain failed:`,e)}}async function dp(e,t){let n=String(t||``).trim().toLowerCase();if(!n)return;let r=n.split(`.`),i=r.length>2?r.slice(-2).join(`.`):null,a=n;i&&window.confirm(`Hide ${n} from this list?\n\nOK — hide every domain under ${i} too (covers preview/staging URLs that change every deploy).\nCancel — hide only ${n}.`)&&(a=i);try{if(!(await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity/dismiss`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({domain:a})})).json().catch(()=>({}))).ok)throw Error();U(`${a} hidden from this list`,`success`)}catch{U(`Could not dismiss that domain`,`danger`);return}await pp(e)}async function fp(e,t){let n=String(t||``).trim().toLowerCase();if(n){try{if(!(await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity/restore`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({domain:n})})).json().catch(()=>({}))).ok)throw Error();U(`${n} will show again`,`success`)}catch{U(`Could not restore that domain`,`danger`);return}await pp(e)}}async function pp(e){try{let t=await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity`)).json().catch(()=>({}));if(!t.ok)return;V.install[e.guid]=t,qf(e)}catch(e){console.warn(`[magnets] install refresh failed:`,e)}}async function mp(e){if(e.status===`DRAFT`){U(`Open Edit and Save to publish a draft magnet.`,`info`);return}let t=e.status===`ENABLED`?`DISABLED`:`ENABLED`;try{if(!(await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw Error();U(t===`ENABLED`?`Magnet enabled`:`Magnet disabled`,`success`)}catch{U(`Update failed`,`danger`);return}try{await Zf()}catch(e){console.warn(`[magnets] refresh after status toggle failed:`,e)}}async function hp(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`)){try{if(!(await(await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:`DELETE`})).json().catch(()=>({}))).ok)throw Error();U(`Magnet deleted`,`success`)}catch{U(`Delete failed`,`danger`);return}try{await Zf()}catch(e){console.warn(`[magnets] refresh after delete failed:`,e)}}}function gp(e){let t=[];e.querySelectorAll(`.mag-cta`).forEach(e=>{if(!e.querySelector(`.mag-cta__on`).checked)return;let n=e.dataset.type,r=e.dataset.kind,i=e.querySelector(`.mag-cta__val`),a=i?i.value.trim():``;if(r===`value`){if(n===`call`&&e.querySelector(`.mag-cta__callsrc`)?.value===`callrail`){let r=e.querySelector(`.mag-cta__crtracker`),i=r?.value||``,a=r?.selectedOptions?.[0];i&&t.push({type:n,value:i,config:{source:`callrail`,...a?.dataset?.trackerId?{tracker_id:a.dataset.trackerId}:{},...a?.dataset?.trackerName?{tracker_name:a.dataset.trackerName}:{}}})}else a&&t.push({type:n,value:a})}else if(r===`book`){if(e.querySelector(`.mag-cta__booksrc`)?.value===`calendly`){let r=e.querySelector(`.mag-cta__calevent`),i=r?.value||``,a=(r?.selectedOptions?.[0]?.textContent||``).trim();t.push({type:n,config:{source:`calendly`,...i?{calendly_url:i}:{},...i&&a?{event_name:a}:{}}})}else{let e={type:n};a&&(/^https?:\/\//i.test(a)?e.value=a:e.config={meeting_label:a}),t.push(e)}}else if(r===`support`){let r=(e.querySelector(`.mag-cta__opts`)?.value||``).split(`
`).map(e=>e.trim()).filter(Boolean).map(e=>({label:e})),i={type:n};r.length&&(i.config={options:r}),t.push(i)}else t.push({type:n})});let n={display_mode:e.querySelector(`input[name="mag-display"]:checked`)?.value||`chat`,trigger:ff(e),theme_mode:e.querySelector(`input[name="mag-theme"]:checked`)?.value||`auto`,title:e.querySelector(`#mag-f-title`).value.trim(),theme_color:e.querySelector(`#mag-f-color`).value,subtitle:e.querySelector(`#mag-f-subtitle`).value,launcher_label:e.querySelector(`#mag-f-launcher`).value.trim(),logo_url:e.querySelector(`#mag-f-logo`).value.trim(),logo_fit:e.querySelector(`#mag-f-logo-fit`)?.value===`contain`?`contain`:`cover`,summary:e.querySelector(`#mag-f-summary`).checked,summary_heading:e.querySelector(`#mag-f-summary-heading`).value.trim(),home:e.querySelector(`#mag-f-home`).checked,welcome:e.querySelector(`#mag-f-welcome`).value,ab:xp(e),actions:t,font:e.querySelector(`#mag-f-font`).value.trim(),theme_vars:yp(e),inline_width:e.querySelector(`#mag-f-inline-w`).value.trim(),inline_height:e.querySelector(`#mag-f-inline-h`).value.trim(),hide_launcher:e.querySelector(`#mag-f-hide-launcher`).checked,input_placeholder:e.querySelector(`#mag-f-input-ph`).value,summary_confirm_label:e.querySelector(`#mag-f-summary-confirm`).value.trim(),success_title:e.querySelector(`#mag-f-success-title`).value.trim(),success_text:e.querySelector(`#mag-f-success-text`).value,success_cta:bp(e)};return n.trigger===void 0&&delete n.trigger,n}function _p(e){return new Promise((t,n)=>{let r=new Image,i=new FileReader;i.onerror=()=>n(Error(`Could not read that file.`)),i.onload=()=>{r.onerror=()=>n(Error(`That file isn’t a readable image.`)),r.onload=()=>{let e=Math.min(1,Hp/Math.max(r.naturalWidth,r.naturalHeight)),n=Math.max(1,Math.round(r.naturalWidth*e)),i=Math.max(1,Math.round(r.naturalHeight*e)),a=document.createElement(`canvas`);a.width=n,a.height=i,a.getContext(`2d`).drawImage(r,0,0,n,i),t(a.toDataURL(`image/png`))},r.src=i.result},i.readAsDataURL(e)})}function vp(e,t){let n=e.querySelector(`#mag-logo-drop`);if(!n)return;let r=e.querySelector(`#mag-f-logo-file`),i=e.querySelector(`#mag-logo-browse`),a=e.querySelector(`#mag-logo-remove`),o=e.querySelector(`#mag-logo-preview`),s=e.querySelector(`#mag-logo-status`),c=e.querySelector(`#mag-f-logo`),l=(e,t)=>{s.textContent=e,s.style.color=t?`var(--color-danger, #DD4124)`:``},u=e=>{o.innerHTML=e?`<img src="${H(e)}" alt="">`:`<span class="material-symbols-outlined" aria-hidden="true">image</span>`,a.hidden=!e},d=e=>{c.value=e,c.dispatchEvent(new Event(`input`,{bubbles:!0})),c.dispatchEvent(new Event(`change`,{bubbles:!0}))};async function f(e){if(!Up.has(e.type)){l(`PNG, JPEG, GIF, or WEBP only.`,!0);return}if(e.size>Wp){l(`That file is too large (8MB max before resizing).`,!0);return}l(`Uploading…`,!1);try{let n=await _p(e),r=await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({image:n})}),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok)throw Error(i.error||`Upload failed (${r.status})`);let a=`${W()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;d(a),u(a),l(`Logo updated.`,!1)}catch(e){l(e.message||`Upload failed.`,!0)}}r.addEventListener(`change`,()=>{r.files[0]&&f(r.files[0]),r.value=``}),n.addEventListener(`click`,e=>{e.target===a||a.contains(e.target)||e.target!==i&&r.click()}),i.addEventListener(`click`,()=>r.click()),[`dragenter`,`dragover`].forEach(e=>n.addEventListener(e,e=>{e.preventDefault(),n.classList.add(`is-dragover`)})),[`dragleave`,`drop`].forEach(e=>n.addEventListener(e,e=>{e.preventDefault(),n.classList.remove(`is-dragover`)})),n.addEventListener(`drop`,e=>{let t=e.dataTransfer?.files?.[0];t&&f(t)}),a.addEventListener(`click`,async e=>{e.stopPropagation(),l(`Removing…`,!1);try{let e=await fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:`DELETE`}),n=await e.json().catch(()=>({}));if(!e.ok||!n.ok)throw Error(n.error||`Remove failed (${e.status})`);d(``),u(``),l(`Logo removed.`,!1)}catch(e){l(e.message||`Remove failed.`,!0)}})}function yp(e){return e.querySelector(`#mag-f-surface-on`)?.checked?{surface:e.querySelector(`#mag-f-sv-surface`).value,surface_2:e.querySelector(`#mag-f-sv-surface2`).value,border:e.querySelector(`#mag-f-sv-border`).value,text:e.querySelector(`#mag-f-sv-text`).value,text_sub:e.querySelector(`#mag-f-sv-textsub`).value}:{}}function bp(e){let t=e.querySelector(`#mag-f-success-cta-label`).value.trim(),n=e.querySelector(`#mag-f-success-cta-url`).value.trim();return t&&n?{label:t,url:n}:{}}function xp(e){let t={},n=e.querySelector(`#mag-f-ab-title`)?.value.trim(),r=e.querySelector(`#mag-f-ab-welcome`)?.value.trim(),i=e.querySelector(`#mag-f-ab-color`)?.value||``,a=e.querySelector(`#mag-f-color`)?.value||``;return n&&(t.title=n),r&&(t.welcome=r),i&&i.toLowerCase()!==a.toLowerCase()&&(t.theme_color=i),{enabled:!!e.querySelector(`#mag-f-ab`)?.checked,split:Number(e.querySelector(`#mag-f-ab-split`)?.value)||50,b:t}}function Sp(e){let t=String(e||``),n=new Set(Gp.flatMap(e=>e.opts.map(([e])=>e))),r=e=>e===t?` selected`:``,i=`<option value=""${t===``?` selected`:``}>System default</option>`;t&&!n.has(t)&&(i+=`<option value="${H(t)}" selected>Current: ${H(t)}</option>`);for(let e of Gp)i+=`<optgroup label="${H(e.label)}">`+e.opts.map(([e,t])=>`<option value="${H(e)}"${r(e)}>${H(t)}</option>`).join(``)+`</optgroup>`;return i}function Cp(e,t,n={}){let{freshDraft:r=!1}=n,i=!!e,a=i?null:crypto.randomUUID(),o=!i&&V.owners.length>1,s=e?.display_mode||`chat`,c=e?.theme_mode||`auto`,l={};(e?.actions||[]).forEach(e=>{e&&e.type&&(l[e.type]=e)});let u=!i||!!e.home,d=i?e.subtitle==null?``:e.subtitle:`Typically replies in a few minutes`,f=e?.theme_vars&&typeof e.theme_vars==`object`?e.theme_vars:{},m=Object.keys(f).length>0,h=(e,t)=>H(/^#[0-9a-fA-F]{6}$/.test(f[e]||``)?f[e]:t),g=document.createElement(`div`);g.className=`mag-modal-scrim`,g.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${i?`Edit magnet`:`New magnet`}">
      ...
      <div class="mag-modal__main">
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${Pp.map(t=>`<option value="${t.value}"${lf(e)===t.value?` selected`:``}>${H(t.label)}</option>`).join(``)}
          <option value="__per_device"${lf(e)===`__per_device`?` selected`:``}>Per device&hellip;</option>
        </select>
        <div class="mag-perdev" id="mag-f-perdev"${lf(e)===`__per_device`?``:` hidden`}>
          <div class="mag-perdev__row">
            ...
            <select class="mag-modal__select" id="mag-f-trigger-desktop">
              ${Pp.map(t=>`<option value="${t.value}"${uf(e,`desktop`)===t.value?` selected`:``}>${H(t.label)}</option>`).join(``)}
            </select>
          </div>
          <div class="mag-perdev__row">
            <label class="mag-modal__label" for="mag-f-trigger-mobile">Mobile</label>
            <select class="mag-modal__select" id="mag-f-trigger-mobile">
              ${Pp.map(t=>`<option value="${t.value}"${uf(e,`mobile`)===t.value?` selected`:``}>${H(t.label)}</option>`).join(``)}
            </select>
          </div>
    ...
    </div>`,document.body.appendChild(g),requestAnimationFrame(()=>{g.classList.add(`open`),g.querySelector(`.mag-modal`).classList.add(`open`)});let _=[...g.querySelectorAll(`.mag-modal__navitem`)],v=[...g.querySelectorAll(`.mag-tab`)],y=e=>{_.forEach(t=>t.classList.toggle(`is-active`,t.dataset.tab===e)),v.forEach(t=>{t.hidden=t.dataset.tab!==e}),g.querySelector(`.mag-modal__body`).scrollTop=0};_.forEach(e=>e.addEventListener(`click`,()=>y(e.dataset.tab)));let ee=()=>Fd({...e,...gp(g),...i?{steps:nd()}:{}}),b=g.querySelector(`#mag-preview-pane`),x=()=>window.matchMedia(`(min-width: 1200px)`).matches,te=null,ne=()=>{if(!te&&x())try{te=Bd(b,ee)}catch{}},S=null,re=()=>{x()&&(ne(),te&&(clearTimeout(S),S=setTimeout(()=>{try{te.refresh()}catch{}},300)))},ie=window.matchMedia(`(min-width: 1200px)`),ae=()=>{x()&&(ne(),re())};ie.addEventListener(`change`,ae);let oe=!1,se=!1,ce=g.querySelector(`#mag-f-dirty`),le=e=>{oe=e,ce&&(ce.hidden=!e)},ue=g.querySelector(`.mag-modal__main`);ue.addEventListener(`input`,()=>le(!0)),ue.addEventListener(`change`,()=>{le(!0),df(g),re()}),df(g),g.querySelector(`#mag-f-color`)?.addEventListener(`input`,()=>{le(!0),re()});let de=e=>{oe&&(e.preventDefault(),e.returnValue=``)};window.addEventListener(`beforeunload`,de);let fe=!0,pe=wp.default.subscribe(p.ROUTE_NAV_BEFORE,()=>{if(fe){if(oe&&!confirm(`Discard your changes to this magnet?`)){window.router?.navigate(`/magnets`);return}me()}}),me=()=>{r&&!se&&e&&e.status===`DRAFT`&&(fetch(`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:`DELETE`}).catch(()=>{}),V.magnets=V.magnets.filter(t=>t.guid!==e.guid),Xf(document.getElementById(`mag-body`))),fe=!1,window.removeEventListener(`beforeunload`,de),wp.default.unsubscribe(pe),clearTimeout(S),ie.removeEventListener(`change`,ae),te&&te.destroy&&te.destroy(),g.classList.remove(`open`),setTimeout(()=>g.remove(),180),document.removeEventListener(`keydown`,ge)},he=()=>{oe&&!confirm(`Discard your changes to this magnet?`)||me()};function ge(e){e.key===`Escape`&&(e.preventDefault(),he())}document.addEventListener(`keydown`,ge),g.querySelector(`.mag-modal__close`).addEventListener(`click`,he),g.querySelector(`[data-x="cancel"]`).addEventListener(`click`,he),g.querySelector(`[data-close-modal]`)?.addEventListener(`click`,he),g.querySelector(`#mag-f-name`).focus();let _e=g.querySelector(`#mag-flow-panel`);i?Ju(_e,e,()=>{le(!0),re()}):_e.innerHTML=`<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>`,vp(g,e),t&&y(t),ne(),g.querySelectorAll(`.mag-cta`).forEach(e=>{let t=e.querySelector(`.mag-cta__on`),n=e.querySelector(`.mag-cta__val`),r=e.querySelector(`.mag-cta__opts`),i=e.querySelectorAll(`.mag-cta__booksrc, .mag-cta__calevent, .mag-cta__callsrc, .mag-cta__crtracker`);t.addEventListener(`change`,()=>{n&&(n.disabled=!t.checked),r&&(r.disabled=!t.checked),i.forEach(e=>{e.disabled=!t.checked}),t.checked&&(n||r)?.focus()}),n&&n.addEventListener(`input`,()=>{n.value.trim()&&!t.checked&&(t.checked=!0,r&&(r.disabled=!1))})}),g.querySelectorAll(`.mag-cta[data-kind="book"]`).forEach(e=>{let t=e.querySelector(`.mag-cta__booksrc`),n=e.querySelector(`.mag-cta__val`),r=e.querySelector(`.mag-cta__calevent`);if(!t||!r)return;let i=()=>{let e=t.value===`calendly`;n.hidden=e,r.hidden=!e,e&&!r.dataset.listed&&(r.dataset.listed=`1`,gf(r))};t.addEventListener(`change`,()=>{let t=e.querySelector(`.mag-cta__on`);t.checked||(t.checked=!0,t.dispatchEvent(new Event(`change`))),i()}),i()}),g.querySelectorAll(`.mag-cta[data-type="call"]`).forEach(e=>{let t=e.querySelector(`.mag-cta__callsrc`),n=e.querySelector(`.mag-cta__val`),r=e.querySelector(`.mag-cta__crtracker`);if(!t||!r)return;let i=()=>{let e=t.value===`callrail`;n.hidden=e,r.hidden=!e,e&&!r.dataset.listed&&(r.dataset.listed=`1`,vf(r))};t.addEventListener(`change`,()=>{let t=e.querySelector(`.mag-cta__on`);t.checked||(t.checked=!0,t.dispatchEvent(new Event(`change`))),i()}),i()});let ve=g.querySelector(`#mag-f-surface-on`),ye=g.querySelector(`#mag-f-surface`);ve.addEventListener(`change`,()=>ye.hidden=!ve.checked);let be=g.querySelector(`#mag-f-inline-size`);g.querySelectorAll(`input[name="mag-display"]`).forEach(e=>e.addEventListener(`change`,()=>{be.hidden=g.querySelector(`input[name="mag-display"]:checked`)?.value!==`inline`})),g.querySelector(`[data-x="preview"]`)?.addEventListener(`click`,()=>Vd(()=>Fd({...e,...gp(g),...i?{steps:nd()}:{}}))),g.querySelector(`[data-x="save"]`).addEventListener(`click`,async t=>{let n=t.currentTarget,r=g.querySelector(`#mag-f-error`),s=g.querySelector(`#mag-f-name`).value.trim();if(!s){y(`basics`),r.textContent=`Please give your magnet a name.`;return}let c=g.querySelector(`#mag-f-domains`).value.split(`,`).map(e=>e.trim()).filter(Boolean),l=``;if(g.querySelectorAll(`.mag-cta`).forEach(e=>{let t=e.querySelector(`.mag-cta__on`).checked;if(e.dataset.kind===`book`){let n=e.querySelector(`.mag-cta__booksrc`)?.value===`calendly`;t&&n&&!e.querySelector(`.mag-cta__calevent`)?.value&&(l||=`Pick a Calendly event for the Book button, or switch it back to the built-in scheduler.`);return}if(e.dataset.kind!==`value`)return;if(e.dataset.type===`call`&&e.querySelector(`.mag-cta__callsrc`)?.value===`callrail`){t&&!e.querySelector(`.mag-cta__crtracker`)?.value&&(l||=`Pick a CallRail tracking number for the Call button, or switch it back to a phone number.`);return}let n=e.querySelector(`.mag-cta__val`).value.trim();t&&!n&&(l||=`Add a target for the ${Fp[e.dataset.type].label} button, or uncheck it.`)}),l){y(`welcome`),r.textContent=l;return}let u=xp(g);if(u.enabled&&!Object.keys(u.b).length){y(`ab`),r.textContent=`Give variant B at least one change (title, welcome, or color), or untick the A/B test.`;return}if(i){let e=Qu();if(e){y(`flow`),r.textContent=e.message,$u(e.route,e.message,{uid:e.uid,field:e.field});return}}let d={name:s,domains:c,...gp(g)};o&&(d.owner_guid=g.querySelector(`#mag-f-owner`).value);let f=i&&e.status===`DRAFT`;f&&(d.status=`ENABLED`),n.disabled=!0,r.textContent=``;try{let t=i?`${W()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${W()}/m5t/v5/magnets`,n={"Content-Type":`application/json`};a&&(n[`Idempotency-Key`]=a);let r=await fetch(t,{method:i?`PATCH`:`POST`,headers:n,body:JSON.stringify(d)}),o={};try{o=await r.json()}catch{}if(!r.ok||!o.ok)throw Error(o.message||`Save failed (${r.status})`);i&&await td(e.guid),U(f||!i?`Magnet created`:`Magnet updated`,`success`),se=!0,me(),await Zf()}catch(e){n.disabled=!1,r.textContent=e.message||`Something went wrong.`}})}var wp,Tp,V,Ep,H,U,W,Dp,Op,kp,Ap,jp,Mp,Np,Pp,Fp,Ip,Lp,Rp,zp,Bp,Vp,Hp,Up,Wp,Gp,Kp=o((()=>{D(),wp=u(f(),1),m(),Md(),Ud(),ua(),sf(),Zt(),Tp=!1,V={magnets:[],owners:[],canProvision:!1,canManage:!1,primaryOrgGuid:null,stats:{},install:{},connections:{},pairing:{},pairTimer:null,detailOpen:{}},Ep={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},H=e=>String(e??``).replace(/[&<>"']/g,e=>Ep[e]),U=(e,t=`info`)=>{try{wp.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},W=()=>E.getConfig?.().BASE_URL||``,Dp=e=>`<script src="${W()}/m5t/v5/coreSnippet?appguid=${e}" async><\/script>`,Op=()=>`<details class="mag-csp-note">
...
</details>`,kp=e=>{let t=H(Dp(e));return`<details class="mag-guide">
...
/&gt;</code></pre>
...
</details>`},Ap={chat:`Chat bubble`,right_slide:`Slide-in panel`,modal:`Modal`,inline:`Inline`},jp={chat:`chat`,right_slide:`vertical_split`,modal:`web_asset`,inline:`view_agenda`},Mp=[{value:`inline`,icon:`view_agenda`,label:`Inline`},{value:`chat`,icon:`chat`,label:`Chat`},{value:`right_slide`,icon:`vertical_split`,label:`Slide`},{value:`modal`,icon:`web_asset`,label:`Modal`}],Np=[{value:`auto`,icon:`brightness_auto`,label:`Auto`},{value:`sync`,icon:`sync`,label:`Sync`},{value:`light`,icon:`light_mode`,label:`Light`},{value:`dark`,icon:`dark_mode`,label:`Dark`}],Pp=[{value:`on_load`,label:`Immediately on page load`},{value:`on_8_seconds`,label:`After 8 seconds`},{value:`on_scroll_80_percent`,label:`At 80% scroll depth`},{value:`on_exit_intent`,label:`On exit intent (mouse leaves the page)`},{value:`none`,label:`Manual only (visitor clicks the launcher)`}],Fp={book:{label:`Book`,icon:`event`,kind:`book`},chat:{label:`Chat`,icon:`chat`,kind:`flow`},call:{label:`Call`,icon:`phone`,kind:`value`,placeholder:`Phone number`},email:{label:`Email`,icon:`mail`,kind:`value`,placeholder:`Email address`},support:{label:`Support`,icon:`support_agent`,kind:`support`}},Ip=[`book`,`chat`,`call`,`email`,`support`],Lp=null,Rp=null,zp=5e3,Bp={ACTIVE:{label:`Connected`,icon:`check_circle`,tone:`live`},PENDING:{label:`Waiting to connect`,icon:`hourglass_empty`,tone:`pending`},REVOKED:{label:`Disconnected`,icon:`link_off`,tone:`off`},EXPIRED:{label:`Expired`,icon:`timer_off`,tone:`off`}},Vp=!1,Hp=512,Up=new Set([`image/png`,`image/jpeg`,`image/gif`,`image/webp`]),Wp=8388608,Gp=[{label:`Web fonts (loaded for you)`,opts:[[`Inter, sans-serif`,`Inter`],[`Poppins, sans-serif`,`Poppins`],[`Montserrat, sans-serif`,`Montserrat`],[`Roboto, sans-serif`,`Roboto`],[`"Open Sans", sans-serif`,`Open Sans`],[`Lato, sans-serif`,`Lato`],[`Nunito, sans-serif`,`Nunito`],[`Raleway, sans-serif`,`Raleway`],[`"Work Sans", sans-serif`,`Work Sans`],[`Oswald, sans-serif`,`Oswald`],[`Merriweather, serif`,`Merriweather (serif)`]]},{label:`System / always available`,opts:[[`system-ui, sans-serif`,`System UI`],[`Georgia, serif`,`Georgia (serif)`],[`"Times New Roman", Times, serif`,`Times (serif)`],[`Arial, Helvetica, sans-serif`,`Arial / Helvetica`],[`Verdana, Geneva, sans-serif`,`Verdana`],[`"Courier New", monospace`,`Courier (mono)`]]}]})),qp=c({default:()=>im,init:()=>Zp,render:()=>Xp});function Jp(){let e=new Map;for(let t of nf)e.set(t.category,(e.get(t.category)||0)+1);return Object.keys(tf).filter(t=>e.has(t)).map(t=>[t,e.get(t)])}function Yp(){if(Zd(),rm)return;let e=document.createElement(`style`);e.id=`m5t-templates-page-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),rm=!0}function Xp(){Yp();let e=tm();return`
    <div class="page-shell" data-section="templates">
      ...
      <div class="m5t-chip-row tpl-filters" id="tpl-filters" role="group" aria-label="Filter templates by category">
        ${nm(`all`,`All`,nf.length,`true`)}
        ${Jp().map(([e,t])=>nm(e,tf[e],t,`false`)).join(``)}
      </div>

      <div class="mag-tpl-grid mag-tpl-grid--page" id="tpl-grid">
        ${nf.map(t=>Kd(t,{detail:!0,gallery:!0,canUse:e})).join(``)}
      </div>
    </div>`}function Zp(){let e=document.getElementById(`tpl-grid`);document.getElementById(`tpl-filters`)?.addEventListener(`click`,t=>{let n=t.target.closest(`[data-cat]`);if(!n)return;n.parentElement.querySelectorAll(`[data-cat]`).forEach(e=>{e.setAttribute(`aria-pressed`,String(e===n))});let r=n.dataset.cat;e?.querySelectorAll(`.mag-tpl-card`).forEach(e=>{e.hidden=r!==`all`&&e.dataset.cat!==r})}),e?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-preview]`);if(t){let e=nf.find(e=>e.id===t.dataset.preview);e&&Vd(()=>Fd({...e.appearance,steps:e.steps,name:e.name}));return}let n=e.target.closest(`[data-tpl]`);n&&(qd(n.dataset.tpl),window.location.hash=`#/magnets`)})}var Qp,$p,em,tm,nm,rm,im,am=o((()=>{D(),Ud(),sf(),Qp={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},$p=e=>String(e??``).replace(/[&<>"']/g,e=>Qp[e]),em=[`provision_magnets`,`manage_magnets`],tm=()=>E.getCapabilities().some(e=>em.includes(e)),nm=(e,t,n,r)=>`<button class="m5t-chip--filter" type="button" data-cat="${$p(e)}" aria-pressed="${r}">${$p(t)}<span class="m5t-chip__count">${n}</span></button>`,rm=!1,im={render:Xp,init:Zp}})),om=c({default:()=>jm,init:()=>fm,render:()=>dm});function sm(){if(nr(),Om)return;let e=document.createElement(`style`);e.id=`m5t-questionnaires-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Om=!0}function cm(){return Dm.clients.map(e=>{let t=Dm.responses.filter(t=>t.owner_guid===e.guid),n=t[0]||null;return{guid:e.guid,name:e.caption||e.name||e.guid,latest:n,earlier:Math.max(0,t.length-1),status:n?n.status:`NOT_SENT`}})}function lm(){let e=Dm.search.trim().toLowerCase();return cm().filter(t=>(Dm.filter===`ALL`||t.status===Dm.filter)&&(!e||t.name.toLowerCase().includes(e)))}function um(e){let t=e.status===`SUBMITTED`,n=e.status===`SUBMITTED`?`<button class="qz-act" type="button" data-act="open" data-guid="${xm(e.latest.guid)}">Read answers</button>`:e.status===`DRAFT`?`<button class="qz-act" type="button" data-act="copy" data-url="${xm(e.latest.url||``)}">Copy link</button>`:`<a class="qz-act" href="#/clients">Go to client</a>`;return`<tr class="qz-row${t?` qz-row--open`:``}"${t?` data-open-guid="${xm(e.latest.guid)}"`:``}>
    <td><span class="qz-client">${xm(e.name)}</span>${e.earlier?`<span class="qz-earlier">${e.earlier} earlier</span>`:``}</td>
    <td><span class="qz-badge" data-s="${xm(e.status)}">${xm(Em[e.status]||e.status)}</span></td>
    <td class="qz-when">${xm(Am(e,`created_tz`))}</td>
    <td class="qz-when">${xm(Am(e,`submitted_tz`))}</td>
    <td class="qz-actcell">${n}</td>
  </tr>`}function dm(){return sm(),`
    <div class="page-shell" data-section="questionnaires">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="qz-body">${km(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function fm(){await pm()}async function pm(){let e=document.getElementById(`qz-body`);if(e){try{let[e,t]=await Promise.all([fetch(`${Sm()}/m5t/v5/acctGroup`),fetch(`${Sm()}/m5t/v5/m5mQuestionnaireResponse`)]),n=await e.json().catch(()=>({})),r=await t.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(`load failed`);Dm.clients=(n.data||[]).filter(e=>e.class===wm&&![`DELETED`,`ARCHIVED`].includes(e.status)).sort((e,t)=>String(e.caption||``).localeCompare(String(t.caption||``))),Dm.responses=r.data||[]}catch{e.innerHTML=km(`error`,`Could not load questionnaires. Please try again.`);return}hm()}}function mm(){let e=document.getElementById(`qz-tbody`);e&&Yt(e,{rowSelector:`tr.qz-row`,noun:`clients`,controlHost:e.closest(`.qz-tablewrap`)||e.parentElement})}function hm(){let e=document.getElementById(`qz-body`);if(!e)return;if(!Dm.clients.length){e.innerHTML=km(`groups`,`No clients yet. Add a client first, then send them a kickoff questionnaire.`);return}let t=cm(),n={ALL:t.length};Tm.slice(1).forEach(([e])=>{n[e]=t.filter(t=>t.status===e).length});let r=lm();e.innerHTML=`
    <div class="qz-bar">
      <div class="qz-filter">
        ${Tm.map(([e,t])=>`<button data-filter="${e}" class="${Dm.filter===e?`active`:``}">${xm(t)}${n[e]?`<span class="qz-pillnum">${n[e]}</span>`:``}</button>`).join(``)}
      </div>
      <span class="qz-searchwrap">
        <span class="material-symbols-outlined" aria-hidden="true">search</span>
        <input class="qz-search" id="qz-search" type="search" placeholder="Search clients" value="${xm(Dm.search)}" aria-label="Search clients" />
      </span>
    ...
    <div class="qz-tablewrap">
      <table class="qz-table">
        ...
        <tbody id="qz-tbody">${r.length?r.map(um).join(``):`<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">${Dm.search.trim()?`No clients match your search.`:`No clients with status “${xm(Em[Dm.filter]||Dm.filter)}”.`}</div></td></tr>`}</tbody>
      </table>
    </div>`,mm(),e.querySelector(`.qz-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(Dm.filter=t.dataset.filter,hm())}),e.querySelector(`#qz-search`)?.addEventListener(`input`,e=>{Dm.search=e.target.value,gm()}),e.querySelector(`#qz-tbody`)?.addEventListener(`click`,_m)}function gm(){let e=document.getElementById(`qz-tbody`);if(!e)return;let t=lm();e.innerHTML=t.length?t.map(um).join(``):`<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">No clients match your search.</div></td></tr>`,mm();let n=document.querySelector(`.qz-count`);n&&(n.textContent=`${t.length} of ${cm().length}`)}function _m(e){let t=e.target.closest(`[data-act="copy"]`);if(t){e.stopPropagation();let n=t.dataset.url;if(!n){Cm(`No link on this questionnaire yet.`,`warning`);return}navigator.clipboard?.writeText(n).then(()=>{t.textContent=`Copied!`,setTimeout(()=>{t.textContent=`Copy link`},1500)},()=>Cm(`Could not copy the link.`,`error`));return}let n=e.target.closest(`[data-act="open"]`),r=e.target.closest(`[data-open-guid]`),i=n?.dataset.guid||r?.dataset.openGuid;i&&vm(i)}async function vm(e){Dm.openGuid=e;let t=document.createElement(`div`);t.className=`qz-drawer-scrim`;let n=document.createElement(`aside`);n.className=`qz-drawer`,n.setAttribute(`role`,`dialog`),n.setAttribute(`aria-label`,`Questionnaire answers`),n.innerHTML=`
    ...
    <div class="qz-drawer__body" id="qz-dbody">${km(`hourglass_empty`,`Loading answers…`)}</div>`,document.body.append(t,n),requestAnimationFrame(()=>{t.classList.add(`open`),n.classList.add(`open`)});let r=()=>{Dm.openGuid=null,t.classList.remove(`open`),n.classList.remove(`open`),setTimeout(()=>{t.remove(),n.remove()},220),document.removeEventListener(`keydown`,i)};function i(e){e.key===`Escape`&&(e.preventDefault(),r())}document.addEventListener(`keydown`,i),t.addEventListener(`click`,r),n.querySelector(`.qz-drawer__close`).addEventListener(`click`,r);try{let t=await fetch(`${Sm()}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e)}`),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`load failed`);let i=r.data||{},a=Dm.clients.find(e=>e.guid===i.owner_guid)?.caption||`Client`;n.querySelector(`#qz-dtitle`).textContent=a;let o=i.submitted_tz?`Submitted ${k(i.submitted_tz)}`:`Not yet submitted`;n.querySelector(`#qz-dsub`).textContent=i.locked_tz?`${o} · Finalized`:o,n.querySelector(`#qz-dbody`).innerHTML=tr(i)+Qn(i,{emptyLabel:`Not answered`})}catch{n.querySelector(`#qz-dbody`).innerHTML=km(`error`,`Could not load these answers. Please try again.`)}}var ym,bm,xm,Sm,Cm,wm,Tm,Em,Dm,Om,km,Am,jm,Mm=o((()=>{D(),ym=u(f(),1),m(),or(),Zt(),bm={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},xm=e=>String(e??``).replace(/[&<>"']/g,e=>bm[e]),Sm=()=>E.getConfig?.().BASE_URL||``,Cm=(e,t=`info`)=>{try{ym.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},wm=`managed_client`,Tm=[[`ALL`,`All`],[`NOT_SENT`,`Not sent`],[`DRAFT`,`Awaiting response`],[`SUBMITTED`,`Submitted`],[`CANCELLED`,`Cancelled`]],Em=Object.fromEntries(Tm),Dm={clients:[],responses:[],filter:`ALL`,search:``,openGuid:null},Om=!1,km=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Am=(e,t)=>e?.latest?.[t]?k(e.latest[t]):`—`,jm={render:dm,init:fm}})),Nm=c({default:()=>ph,init:()=>zm,render:()=>Rm});function Pm(){if(nr(),lh)return;let e=document.createElement(`style`);e.id=`m5t-deliverables-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),lh=!0}function Fm(){let e=q.search.trim().toLowerCase();return q.rows.filter(t=>(q.filter===`ALL`||t.status===q.filter)&&(!e||String(t.owner_name||``).toLowerCase().includes(e)))}function Im(e){return e.status===`DRAFT`?`<button class="dz-act" type="button" data-act="open" data-guid="${G(e.guid)}">Edit</button>`:e.status===`SENT`?`<button class="dz-act" type="button" data-act="copy" data-url="${G(e.url||``)}">Copy link</button>`:e.status===`SUBMITTED`?`<button class="dz-act" type="button" data-act="open" data-guid="${G(e.guid)}">Read review</button>`:`<span class="dz-when">—</span>`}function Lm(e){let t=e.status!==`CANCELLED`;return`<tr class="dz-row${t?` dz-row--open`:``}"${t?` data-open-guid="${G(e.guid)}"`:``}>
    ...
    <td><span class="dz-badge" data-s="${G(e.status)}">${G(ch[e.status]||e.status)}</span></td>
    <td class="dz-when">${e.sent_tz?G(k(e.sent_tz)):`—`}</td>
    <td class="dz-when">${e.submitted_tz?G(k(e.submitted_tz)):`—`}</td>
    <td class="dz-actcell">${Im(e)}</td>
  </tr>`}function Rm(){return Pm(),`
    <div class="page-shell" data-section="deliverables">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="dz-body">${uh(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function zm(){document.getElementById(`dz-new`)?.addEventListener(`click`,Km),await Bm()}async function Bm(){let e=document.getElementById(`dz-body`);if(e){try{let[e,t,n]=await Promise.all([fetch(`${ah()}/m5t/v5/m5mDeliverable`),fetch(`${ah()}/m5t/v5/acctGroup`),fetch(`${ah()}/m5t/v5/m5mDeliverable/templates`)]),r=await e.json().catch(()=>({})),i=await t.json().catch(()=>({})),a=await n.json().catch(()=>({}));if(!e.ok||!t.ok||!n.ok)throw Error(`load failed`);q.rows=r.data||[],q.clients=(i.data||[]).filter(e=>e.class===oh&&![`DELETED`,`ARCHIVED`].includes(e.status)).sort((e,t)=>String(e.caption||``).localeCompare(String(t.caption||``))),q.templates=a.data||[]}catch{e.innerHTML=uh(`error`,`Could not load deliverables. Please try again.`);return}Hm()}}function Vm(){let e=document.getElementById(`dz-tbody`);e&&Yt(e,{rowSelector:`tr.dz-row`,noun:`deliverables`,controlHost:e.closest(`.dz-tablewrap`)||e.parentElement})}function Hm(){let e=document.getElementById(`dz-body`);if(!e)return;if(!q.clients.length&&!q.rows.length){e.innerHTML=uh(`groups`,`No clients yet. Add a client first, then author their first deliverable.`);return}if(!q.rows.length){e.innerHTML=uh(`approval`,`No deliverables yet. Author the first one with New deliverable.`);return}let t={ALL:q.rows.length};sh.slice(1).forEach(([e])=>{t[e]=q.rows.filter(t=>t.status===e).length});let n=Fm();e.innerHTML=`
    <div class="dz-bar">
      <div class="dz-filter">
        ${sh.map(([e,n])=>`<button data-filter="${e}" class="${q.filter===e?`active`:``}">${G(n)}${t[e]?`<span class="dz-pillnum">${t[e]}</span>`:``}</button>`).join(``)}
      </div>
    ...
    <div class="dz-tablewrap">
      <table class="dz-table">
        ...
        <tbody id="dz-tbody">${n.length?n.map(Lm).join(``):`<tr><td colspan="6"><div class="dz-when" style="padding:14px 4px">${q.search.trim()?`No deliverables match your search.`:`No deliverables with status “${G(ch[q.filter]||q.filter)}”.`}</div></td></tr>`}</tbody>
      </table>
    </div>`,Vm(),e.querySelector(`.dz-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(q.filter=t.dataset.filter,Hm())}),e.querySelector(`#dz-search`)?.addEventListener(`input`,e=>{q.search=e.target.value,Um()}),e.querySelector(`#dz-tbody`)?.addEventListener(`click`,Wm)}function Um(){let e=document.getElementById(`dz-tbody`);if(!e)return;let t=Fm();e.innerHTML=t.length?t.map(Lm).join(``):`<tr><td colspan="6"><div class="dz-when" style="padding:14px 4px">No deliverables match your search.</div></td></tr>`,Vm();let n=document.querySelector(`.dz-count`);n&&(n.textContent=`${t.length} of ${q.rows.length}`)}function Wm(e){let t=e.target.closest(`[data-act="copy"]`);if(t){e.stopPropagation();let n=t.dataset.url;if(!n){K(`No link on this deliverable yet.`,`warning`);return}navigator.clipboard?.writeText(n).then(()=>{t.textContent=`Copied!`,setTimeout(()=>{t.textContent=`Copy link`},1500)},()=>K(`Could not copy the link.`,`error`));return}let n=e.target.closest(`[data-act="open"]`),r=e.target.closest(`[data-open-guid]`),i=n?.dataset.guid||r?.dataset.openGuid;i&&nh(i)}function Gm(e){let t=document.createElement(`div`);t.className=`dz-drawer-scrim`;let n=document.createElement(`aside`);n.className=`dz-drawer`,n.setAttribute(`role`,`dialog`),n.setAttribute(`aria-label`,e),n.innerHTML=`
    ...
    <div class="qm-qa" data-question-id="${G(e.id)}" data-question-type="${G(e.type)}">
      ...
      </div>`}function Ym(e,t){let n=(e.questions||[]).filter(e=>e.audience===`am`),r=n.filter(e=>!e.group).map(e=>qm(e,t)).join(``),i=wr(e);if(i){let n=Tr(e).filter(e=>e.audience===`am`);if(!n.length)return r;let a=Or(e,t);for(let e=1;e<=a;e++){let a=Er(n,i,e);r+=Jm(a,fh(a,`${i}${e}`),t)}let o=fh(Er(n,i,a+1),`${i}${a+1}`);return r+=`<button class="dz-btn--ghost dz-addblock" type="button" data-repeat="${G(i)}" data-section-id="${G(e.id)}">+ Add ${G(o)}</button>`,r}let a=[...new Set(n.filter(e=>e.group).map(e=>e.group))];if(!a.length)return r;let o=null;return r+=a.map((e,r)=>{let i=n.filter(t=>t.group===e),a=fh(i,e),s=r===0||dh(i,t);return!s&&o===null&&(o={key:e,heading:a}),Jm(i,a,t,{hidden:!s})}).join(``),r+=`<button class="dz-btn--ghost dz-addblock" type="button"${o?``:` hidden`}>${o?`+ Add ${G(o.heading)}`:``}</button>`,r}function Xm(e,t){let n=(e?.sections||[]).filter(e=>(e.questions||[]).some(e=>e.audience===`am`)),r=n.length>1;return`
    ${r?`
    ...
    ${r?`
      ...
      </div>`:``}).join(``)}function $m(e,t){if(!t)return``;let n=(e?.sections||[]).flatMap(e=>(e.questions||[]).filter(e=>e.audience!==`am`)).map(e=>({q:e,val:Zn(e,t.answers||{})})).filter(({val:e})=>e);return`
    <div class="dz-feedback">
      <p class="dz-feedback__title">Round ${G(t.round)} feedback${t.submitted_tz?` · returned ${G(k(t.submitted_tz))}`:``}</p>
      ${n.length?n.map(({q:e,val:t})=>`
        <div class="qm-qa">
          <div class="qm-qa__q">${G(e.label)}</div>
          <div class="qm-qa__a">${t}</div>
        </div>`).join(``):`<div class="qm-qa__a qm-qa__a--empty">Returned without feedback.</div>`}
    </div>`}function eh(e,t){let n=Array.isArray(t)&&t.length?t[t.length-1]:null;return n?$m(e,n):``}function th(e,t){return(Array.isArray(t)?t.slice().reverse():[]).map(t=>$m(e,t)).join(``)}async function nh(e){let{drawer:t,close:n}=Gm(`Deliverable`),r=t.querySelector(`#dz-dbody`),i=t.querySelector(`#dz-dfoot`),a;try{let t=await fetch(`${ah()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}`),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.error||`load failed`);a=n.data||{}}catch{r.innerHTML=uh(`error`,`Could not load this deliverable. Please try again.`);return}let o=q.rows.find(t=>t.guid===e)?.owner_name||q.clients.find(e=>e.guid===a.owner_guid)?.caption||`Client`;t.querySelector(`#dz-dtitle`).textContent=`${o} · ${a.template?.name||`Deliverable`}`;let s=a.status===`DRAFT`||a.status===`SENT`,c=Number(a.revision)>1?` · Rev ${a.revision}`:``,l=a.status===`SUBMITTED`?`Returned ${a.submitted_tz?k(a.submitted_tz):``}${a.locked_tz?` · Finalized`:``}${c}`:a.status===`SENT`?`Sent ${a.sent_tz?k(a.sent_tz):``} to ${a.recipient_email||``} · awaiting approval${c}`:`${ch[a.status]||a.status}${c}`;if(t.querySelector(`#dz-dsub`).textContent=l,!s){r.innerHTML=tr(a)+Qm(a.template,a.content||{},a.answers||{})+th(a.template,a.rounds),a.status===`SUBMITTED`&&!a.locked_tz?(i.innerHTML=`<button class="dz-btn" type="button" id="dz-revise">Revise plan</button>
        <span class="dz-note" style="margin:0">Archives this review and reopens authoring. The client approves the revised plan on a fresh link.</span>`,i.querySelector(`#dz-revise`).addEventListener(`click`,async t=>{let r=t.target;r.disabled=!0;try{let t=await fetch(`${ah()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}/revise`,{method:`POST`}),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`revise failed`);K(`Reopened for revision. The last review is pinned above the form.`,`success`),n(),await Bm(),nh(e)}catch(e){K(e.message||`Could not revise.`,`error`),r.disabled=!1}})):i.innerHTML=``;return}r.innerHTML=`
    ${eh(a.template,a.rounds)}
    ${a.url?`
    ...
    <div id="dz-author-form">${Xm(a.template,a.content||{})}</div>`,i.innerHTML=`
    ...
    <button class="dz-btn--ghost dz-btn--danger" type="button" id="dz-cancel">Cancel deliverable</button>`,r.querySelector(`#dz-copylink`)?.addEventListener(`click`,e=>{let t=r.querySelector(`.dz-linkrow input`);navigator.clipboard?.writeText(t?.value||``).then(()=>{e.target.textContent=`Copied!`,setTimeout(()=>{e.target.textContent=`Copy link`},1500)},()=>K(`Could not copy the link.`,`error`))});let u=async()=>{let t=er(r.querySelector(`#dz-author-form`)),i=await fetch(`${ah()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({content:t})}),a=await i.json().catch(()=>({}));if(!i.ok||!a.ok){if(i.status===409)return K(a.error||`This deliverable is no longer editable.`,`warning`),n(),await Bm(),!1;throw Error(a.error||`save failed`)}return!0};Zm(r.querySelector(`#dz-author-form`),a.template,()=>{u().catch(()=>K(`Autosave failed. Use Save draft.`,`warning`))}),i.querySelector(`#dz-preview`).addEventListener(`click`,async e=>{let t=e.target.closest(`button`);if(!a.url){K(`No link available for this deliverable.`,`warning`);return}t.disabled=!0;try{await u()&&window.open(a.url,`_blank`)}catch(e){K(e.message||`Could not save before previewing.`,`error`)}t.disabled=!1}),i.querySelector(`#dz-save`).addEventListener(`click`,async e=>{let t=e.target;t.disabled=!0;try{await u()&&K(`Draft saved.`,`success`)}catch(e){K(e.message||`Could not save.`,`error`)}t.disabled=!1}),i.querySelector(`#dz-send`).addEventListener(`click`,async t=>{let r=t.target,a=(i.querySelector(`#dz-email`)?.value||``).trim();if(!a){K(`Enter the recipient email first.`,`warning`);return}r.disabled=!0;try{if(!await u())return;let t=await fetch(`${ah()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}/send`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({recipient_email:a})}),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`send failed`);K(r.data?.emailQueued?`Sent. ${a} will receive the review link.`:`Link created, but the email could not be queued. Copy the link and send it yourself.`,r.data?.emailQueued?`success`:`warning`),n(),await Bm()}catch(e){K(e.message||`Could not send.`,`error`),r.disabled=!1}}),i.querySelector(`#dz-cancel`).addEventListener(`click`,async t=>{let r=t.target;r.disabled=!0;try{let t=await fetch(`${ah()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}/cancel`,{method:`POST`}),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`cancel failed`);K(`Deliverable cancelled. Its link no longer works.`,`info`),n(),await Bm()}catch(e){K(e.message||`Could not cancel.`,`error`),r.disabled=!1}})}var rh,ih,G,ah,K,oh,sh,ch,q,lh,uh,dh,fh,ph,mh=o((()=>{D(),rh=u(f(),1),m(),or(),Mr(),Zt(),ih={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},G=e=>String(e??``).replace(/[&<>"']/g,e=>ih[e]),ah=()=>E.getConfig?.().BASE_URL||``,K=(e,t=`info`)=>{try{rh.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},oh=`managed_client`,sh=[[`ALL`,`All`],[`DRAFT`,`In progress`],[`SENT`,`Awaiting approval`],[`SUBMITTED`,`Returned`],[`CANCELLED`,`Cancelled`]],ch=Object.fromEntries(sh),q={rows:[],clients:[],templates:[],filter:`ALL`,search:``},lh=!1,uh=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,dh=(e,t)=>e.some(e=>{let n=t?.[e.id];return Array.isArray(n)?n.length>0:!!(n&&String(n).trim())}),fh=(e,t)=>{let n=String(e[0]?.label||``).match(/^(.+?):\s/);return n?n[1]:t.toUpperCase()},ph={render:Rm,init:zm}})),hh=c({default:()=>Dh,init:()=>xh,render:()=>bh});function gh(e){return e.status===`SENT`?{key:`PENDING`,label:`Pending your review`}:e.status===`SUBMITTED`&&e.signed?{key:`APPROVED`,label:`Approved`}:e.status===`SUBMITTED`?{key:`RETURNED`,label:`Returned with edits`}:null}function _h(){if(nr(),Th)return;let e=document.createElement(`style`);e.id=`m5t-deliverables-client-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Th=!0}function vh(e,t){return!e.url&&t.key===`PENDING`?``:t.key===`PENDING`?`<button class="dc-act" type="button" data-url="${Ch(e.url)}">Review</button>`:t.key!==`APPROVED`&&e.url&&e.editability?.editable?`<button class="dc-act" type="button" data-url="${Ch(e.url)}">Update your review</button>`:``}function yh(e){let t=gh(e);return`<tr>
    <td><span class="dc-name">${Ch(e.template_name||e.kind||`Deliverable`)}</span>${Number(e.revision)>1?`<span class="dc-when" style="margin-left:6px">Rev ${Ch(e.revision)}</span>`:``}</td>
    <td><span class="dc-badge" data-s="${Ch(t.key)}">${Ch(t.label)}</span></td>
    <td class="dc-when">${e.sent_tz?Ch(k(e.sent_tz)):`—`}</td>
    <td class="dc-when">${e.submitted_tz?Ch(k(e.submitted_tz)):`—`}</td>
    <td class="dc-actcell">${vh(e,t)}</td>
  </tr>`}function bh(){return _h(),`
    <div class="page-shell" data-section="deliverables-client">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="dc-body">${Eh(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function xh(){let e=document.getElementById(`dc-body`);if(!e)return;let t;try{let e=await fetch(`${wh()}/m5t/v5/m5mDeliverable`),n=await e.json().catch(()=>({}));if(!e.ok||!n.ok)throw Error(`load failed`);t=(n.data||[]).filter(e=>gh(e))}catch{e.innerHTML=Eh(`error`,`Could not load your deliverables. Please try again.`);return}if(!t.length){e.innerHTML=Eh(`approval`,`Nothing to review right now.`);return}e.innerHTML=`
    <div class="dc-tablewrap">
      <table class="dc-table">
        <thead><tr><th>Deliverable</th><th>Status</th><th>Received</th><th>Returned</th><th></th></tr></thead>
        <tbody id="dc-tbody">${t.map(yh).join(``)}</tbody>
      </table>
    </div>`,e.querySelector(`#dc-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-url]`);t?.dataset.url&&window.open(t.dataset.url,`_blank`)})}var Sh,Ch,wh,Th,Eh,Dh,Oh=o((()=>{D(),or(),Sh={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Ch=e=>String(e??``).replace(/[&<>"']/g,e=>Sh[e]),wh=()=>E.getConfig?.().BASE_URL||``,Th=!1,Eh=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Dh={render:bh,init:xh}})),kh=c({init:()=>Bh,render:()=>zh});function Ah(e){let t=sg(e);if(!t)return``;try{return new Date(t).toLocaleDateString([],{month:`short`,day:`numeric`,year:`numeric`})}catch{return``}}function jh(e){let t=sg(e);if(!t)return``;try{let n=Date.now()-new Date(t).getTime();if(n<0)return Ah(e);let r=n/36e5;return r<1?`${Math.max(1,Math.floor(n/6e4))}m ago`:r<24?`${Math.floor(r)}h ago`:r<48?`Yesterday`:Ah(e)}catch{return Ah(e)}}function Mh(){if($h)return;let e=document.createElement(`style`);e.id=`m5t-leads-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),$h=!0}function Nh(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Ph(e){return`<select class="leads-status" data-id="${Y(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${tg.map(t=>`<option value="${t}" ${e.status===t?`selected`:``}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join(``)}
  </select>`}function Fh(e){let t=J.magnetNames[e.magnet_guid]||e.lead_source||`—`,n=e.phone?String(e.phone).replace(/[^\d+]/g,``):``;return`
    <tr class="leads-row${String(e.id)===J.selectedId?` selected`:``}" data-id="${Y(e.id)}" tabindex="0" role="button" aria-label="Open lead ${Y(ag(e))}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${Y(og(e))}</span>
          <span><span class="leads-name">${Y(ag(e))}</span>${e.company?`<span class="leads-sub">${Y(e.company)}</span>`:``}</span>
        </span>
      </td>
      ${J.book?`<td>${la(J.ownerNames[e.owner_guid]||``)||`<span class="leads-muted">—</span>`}</td>`:``}
      <td>
      ...
      <td>${J.canManage?Ph(e):`<span class="leads-badge" data-s="${Y(e.status)}">${Y(e.status)}</span>`}</td>
      <td class="num leads-muted" style="white-space:nowrap" title="${Y(Ah(e))}">${cg(e)?`<span class="leads-fresh" title="Captured in the last 24 hours"></span>`:``}${Y(jh(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}function Ih(e){let t=J.search.trim().toLowerCase();if(!t)return!0;let n=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,J.magnetNames[e.magnet_guid],J.book?J.ownerNames[e.owner_guid]:``,e.utm_campaign,e.utm_source].filter(Boolean).join(` `).toLowerCase();return t.split(/\s+/).every(e=>n.includes(e))}function Lh(){return J.leads.filter(e=>(J.filter===`ALL`||e.status===J.filter)&&lg(e)&&Ih(e)&&ug(e))}function Rh(){if(!J.day)return``;let e=J.day;try{e=new Date(`${J.day}T00:00:00Z`).toLocaleDateString([],{month:`short`,day:`numeric`,year:`numeric`,timeZone:`UTC`})}catch{}return`<button class="leads-daychip" type="button" id="leads-dayclear" title="Show every day again">
  ...
  </button>`}function zh(){Mh(),Xi();let e=M();return`
    <div class="page-shell" data-section="leads">
      ...
      <div class="dashboard-card" style="margin-bottom:24px">
        ...
        <div class="card-body" id="pf-picker-body">${Nh(`hourglass_empty`,`Loading…`)}</div>
      </div>`:``}
      <div class="page-header">
        <div class="page-header-text">
      ...
      <div class="leads-layout">
        <div class="dashboard-card">
          <div class="card-body" id="leads-body">
            ${Nh(`hourglass_empty`,`Loading leads…`)}
          </div>
        </div>
        <aside class="dashboard-card leads-panel" aria-label="Lead detail">
          <div class="card-body" id="leads-panel-body">${dg()}</div>
        </aside>
      </div>
    </div>`}async function Bh(){document.getElementById(`leads-export`)?.addEventListener(`click`,Zh);let e=fa(ma.LEADS_SEARCH),t=fa(ma.LEADS_DAY);if((e||t)&&(J.search=e||``,J.day=t||``,J.filter=`ALL`,J.clientFilter=`ALL`,J.shown=eg),M()){let e=e=>Number(e||0).toLocaleString();na(ig(),[{h:`Leads · wk`,td:t=>e(t.leads.this_week)},{h:`Leads · total`,td:t=>e(t.leads.total)},{h:`Compl.`,td:e=>e.completion_rate==null?`—`:`${e.completion_rate}%`}],{emptyMsg:`No client orgs yet. Create one under Clients first.`})}await Vh()}async function Vh(){let e=document.getElementById(`leads-body`);if(e){try{let[e,t]=await Promise.all([fetch(`${ig()}/m5t/v5/m5mLead`),fetch(`${ig()}/m5t/v5/magnets`).catch(()=>null)]),n=await e.json().catch(()=>({}));if(!n.ok)throw Error(n.message||`Failed to load`);if(J.leads=(n.data||[]).filter(e=>![`DELETED`,`ARCHIVED`].includes(e.status)),J.total=Number.isFinite(n.total)?n.total:J.leads.length,J.truncated=J.total>(n.data||[]).length,J.book=M(),J.ownerNames=J.book?ra():{},t){let e=await t.json().catch(()=>({}));J.magnetNames={},(e.magnets||[]).forEach(e=>{J.magnetNames[e.guid]=e.name,e.owner_guid&&e.owner_name&&!J.ownerNames[e.owner_guid]&&(J.ownerNames[e.owner_guid]=e.owner_name)}),J.canManage=!!e.canManage}}catch{e.innerHTML=Nh(`error`,`Could not load your leads. Please try again.`);return}Hh()}}function Hh(){let e=document.getElementById(`leads-body`),t=document.getElementById(`leads-export`);if(!e)return;if(t&&(t.style.display=J.leads.length?``:`none`),!J.leads.length){e.innerHTML=Nh(`inbox`,`No leads captured yet. Publish a magnet and share it to start collecting.`),Yh();return}let n=J.leads.filter(lg),r={ALL:n.length};tg.forEach(e=>{r[e]=n.filter(t=>t.status===e).length});let i=J.book?[...new Set(J.leads.map(e=>e.owner_guid).filter(Boolean))].map(e=>({guid:e,name:J.ownerNames[e]||e})).sort((e,t)=>e.name.localeCompare(t.name)):[];e.innerHTML=`
    <div class="leads-bar">
      <div class="leads-filter">
        ${[`ALL`,...tg].map(e=>`<button data-filter="${e}" class="${J.filter===e?`active`:``}">${e===`ALL`?`All`:e[0]+e.slice(1).toLowerCase()}${r[e]?`<span class="leads-pillnum">${r[e]}</span>`:``}</button>`).join(``)}
      </div>
      ${J.book&&i.length>1?`
    ...
    <div id="leads-tablezone"></div>`,e.querySelector(`.leads-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(J.filter=t.dataset.filter,J.shown=eg,Hh())}),e.querySelector(`#leads-clientsel`)?.addEventListener(`change`,e=>{J.clientFilter=e.target.value,J.shown=eg,Hh()}),e.querySelector(`#leads-dayclear`)?.addEventListener(`click`,()=>{J.day=``,J.shown=eg,Hh()}),e.querySelector(`#leads-search`)?.addEventListener(`input`,e=>{J.search=e.target.value,J.shown=eg,Uh()}),Uh()}function Uh(){let e=document.getElementById(`leads-tablezone`),t=document.getElementById(`leads-countlbl`);if(!e)return;let n=Lh(),r=n.slice(0,J.shown),i=J.book?8:7;t&&(t.textContent=`${n.length} of ${J.leads.length}`),e.innerHTML=`
    <div class="leads-tablewrap">
      <table class="leads-table${J.book?` leads-table--book`:``}">
        ...
        <tbody id="leads-tbody">${r.map(Fh).join(``)||`<tr><td colspan="${i}"><div class="leads-muted" style="padding:14px 4px">${J.search.trim()?`No leads match your search.`:`No ${J.filter.toLowerCase()} leads.`}</div></td></tr>`}</tbody>
      </table>
    </div>
    ${Jt({total:n.length,shown:J.shown,noun:`leads`})}
    ${J.truncated?`<div class="leads-muted" style="padding:10px 4px">Showing your ${J.leads.length.toLocaleString()} most recent leads of ${J.total.toLocaleString()}. Search and filters cover these; older leads aren't included yet.</div>`:``}`,e.querySelector(`[data-action="list-expand"]`)?.addEventListener(`click`,()=>{J.shown+=25,Uh()}),e.querySelector(`#leads-tbody`)?.addEventListener(`change`,Wh),e.querySelector(`#leads-tbody`)?.addEventListener(`click`,e=>{if(e.target.closest(`.leads-status, a.leads-contactlink`))return;let t=e.target.closest(`.leads-row`);t&&Gh(t.dataset.id)}),e.querySelector(`#leads-tbody`)?.addEventListener(`keydown`,e=>{if(e.key!==`Enter`&&e.key!==` `)return;let t=e.target.closest(`.leads-row`);t&&e.target===t&&(e.preventDefault(),Gh(t.dataset.id))})}async function Wh(e){let t=e.target.closest(`.leads-status`);if(!t)return;let n=t.dataset.id,r=J.leads.find(e=>String(e.id)===String(n)),i=t.value,a=r?.status;try{if(!(await(await fetch(`${ig()}/m5t/v5/m5mLead/${encodeURIComponent(n)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:i})})).json().catch(()=>({}))).ok)throw Error();r&&(r.status=i),rg(`Marked ${i[0]}${i.slice(1).toLowerCase()}`,`success`)}catch{t.value=a||`NEW`,rg(`Could not update status`,`danger`);return}try{String(n)===J.selectedId&&Yh(),J.filter!==`ALL`&&Hh()}catch(e){console.warn(`[leads] re-render after status change failed:`,e)}}function Gh(e){J.selectedId=String(e),document.querySelectorAll(`.leads-row`).forEach(e=>e.classList.toggle(`selected`,e.dataset.id===J.selectedId)),Yh()}function Kh(e,t){let n=Array.isArray(e.tags)?e.tags:[];for(let e=n.length-1;e>=0;e--)if(n[e]&&n[e].tag===t&&n[e].value!=null)return String(n[e].value);return``}function qh(e){let t=Kh(e,`appointment_start`);if(!t)return null;let n=Kh(e,`appointment_status`)||`booked`,r=Kh(e,`appointment_timezone`),i=Kh(e,`appointment_event_type`),a=new Date(t),o=t;if(!Number.isNaN(a.getTime())){let e={weekday:`short`,month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`};try{o=new Intl.DateTimeFormat(void 0,r?{...e,timeZone:r}:e).format(a)}catch{o=new Intl.DateTimeFormat(void 0,e).format(a)}}return{when:o,status:n,type:i,start:t}}function Jh(e){let t=Array.isArray(e.tags)?e.tags:[],n=null;for(let e of t)if(!(!e||!e.tag)){if(e.tag===`callrail_call_id`){n={};continue}n&&e.tag.indexOf(`call_`)===0&&e.value!=null&&(n[e.tag]=String(e.value))}if(!n||!n.call_started)return null;let r=n.call_started,i=new Date(r),a=r;Number.isNaN(i.getTime())||(a=new Intl.DateTimeFormat(void 0,{weekday:`short`,month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`}).format(i));let o=Number(n.call_duration)||0,s=o?o<60?`${o}s`:`${Math.floor(o/60)}m ${o%60}s`:``;return{when:a,dur:s,source:n.call_source||``,answered:n.call_answered||``,recording:n.call_recording_player||``,started:r}}function Yh(){let e=document.getElementById(`leads-panel-body`);if(!e)return;let t=J.leads.find(e=>String(e.id)===J.selectedId),n=document.querySelector(`.leads-layout`);if(n&&(n.dataset.hasSelection=t?`true`:`false`),!t){e.innerHTML=dg();return}let r=J.magnetNames[t.magnet_guid]||t.lead_source||`—`,i=qh(t),[a,o]=i?pg[i.status]||pg.booked:[``,``],s=Jh(t),c=(e,t)=>t?`<div class="leads-det__field"><span class="leads-det__k">${Y(e)}</span><span class="leads-det__v">${Y(t)}</span></div>`:``;e.innerHTML=`
    <div class="leads-det__head">
      <span class="leads-avatar leads-det__ava">${Y(og(t))}</span>
      <div>
        <div class="leads-det__name">${Y(ag(t))}</div>
    ...
    ${J.canManage?`
      ...
      </div>`:``}`,e.querySelector(`[data-action="delete-lead"]`)?.addEventListener(`click`,Xh)}async function Xh(e){let t=e.currentTarget?.dataset?.id,n=J.leads.find(e=>String(e.id)===String(t));if(!n)return;let r=ag(n);if(!window.confirm(`Remove ${r} from your leads?\n\nThis takes the lead out of your dashboard, lists and exports. The record is kept in our system, and this address can be captured again if they come back through one of your magnets.`))return;let i=e.currentTarget;i.disabled=!0;try{let e=await fetch(`${ig()}/m5t/v5/m5mLead/${encodeURIComponent(t)}`,{method:`DELETE`}),n=await e.json().catch(()=>({}));if(!e.ok||!n.ok)throw Error(n.error||`HTTP ${e.status}`);J.leads=J.leads.filter(e=>String(e.id)!==String(t)),J.selectedId=null,rg(`${r} removed`,`success`),Hh()}catch{i.disabled=!1,rg(`Could not remove that lead. Please try again.`,`danger`)}}function Zh(){let e=Lh();if(!e.length){rg(`Nothing to export`,`info`);return}let t=[`first_name`,`last_name`,`email`,`phone`,`company`,`product_interest`,`lead_source`,`utm_source`,`utm_medium`,`utm_campaign`,`gclid`,`status`],n=e=>`"${String(e??``).replace(/"/g,`""`)}"`,r=[[...J.book?[`client`]:[],...t,`magnet`,`captured`,`appointment`,`last_call`].join(`,`)];for(let i of e){let e=qh(i),a=Jh(i);r.push([...J.book?[n(J.ownerNames[i.owner_guid]||``)]:[],...t.map(e=>n(i[e])),n(J.magnetNames[i.magnet_guid]||i.lead_source||``),n(Ah(i)),n(e?`${e.start} (${e.status})`:``),n(a?`${a.started} (${a.answered===`no`?`missed`:`answered`})`:``)].join(`,`))}let i=new Blob([r.join(`
`)],{type:`text/csv`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.href=a,o.download=`leads-${J.filter.toLowerCase()}.csv`,document.body.appendChild(o),o.click(),o.remove(),URL.revokeObjectURL(a),rg(`Exported ${e.length} lead${e.length===1?``:`s`}`,`success`)}var Qh,$h,J,eg,tg,ng,Y,rg,ig,ag,og,sg,cg,lg,ug,dg,fg,pg,mg=o((()=>{D(),Qh=u(f(),1),m(),ua(),ga(),Zt(),$h=!1,J={leads:[],magnetNames:{},filter:`ALL`,canManage:!1,book:!1,ownerNames:{},clientFilter:`ALL`,search:``,shown:25,selectedId:null,day:``,total:0,truncated:!1},eg=25,tg=[`NEW`,`WORKING`,`QUALIFIED`,`UNQUALIFIED`,`CONVERTED`,`EXPORTED`],ng={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Y=e=>String(e??``).replace(/[&<>"']/g,e=>ng[e]),rg=(e,t=`info`)=>{try{Qh.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},ig=()=>E.getConfig?.().BASE_URL||``,ag=e=>[e.first_name,e.last_name].filter(Boolean).join(` `).trim()||e.email||`(no name)`,og=e=>(ag(e).split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``)||`?`).toUpperCase(),sg=e=>e.created?.created_tz||``,cg=e=>{let t=sg(e);if(!t)return!1;try{return Date.now()-new Date(t).getTime()<864e5}catch{return!1}},lg=e=>J.clientFilter===`ALL`||e.owner_guid===J.clientFilter,ug=e=>!J.day||sg(e).slice(0,10)===J.day,dg=()=>Nh(`touch_app`,`Click to see lead information.`),fg=()=>`
  <colgroup>
    <col style="width:22%">
  ...
  </colgroup>`,pg={booked:[`QUALIFIED`,`Booked`],rescheduled:[`WORKING`,`Rescheduled`],canceled:[`CANCELED`,`Canceled`]}})),hg=c({init:()=>xg,render:()=>bg,tableHTML:()=>yg});function gg(){if(jg)return;let e=document.createElement(`style`);e.id=`m5t-analytics-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),jg=!0}function _g(e,t){let n=t>0?Math.round(e/t*100):0,r=`${Tg(e)} of ${Tg(t)} leads for the busiest magnet`;return`<svg class="anl-bar" width="72" height="8" viewBox="0 0 72 8" role="img"
      aria-label="${Dg(r)}">
      <title>${Dg(r)}</title>
    ...
    </svg>`}function vg(e,t,n){let r=Ng[e.status]?`<span class="anl-chip">${Dg(Ng[e.status])}</span>`:``,i=n&&e.owner_name?`<span class="anl-sub">${Dg(e.owner_name)}</span>`:``,a=e.ab_tests&&(e.ab_tests.running||e.ab_tests.completed)?`${Tg(e.ab_tests.running)} / ${Tg(e.ab_tests.completed)}`:`—`;return`<tr data-guid="${Dg(e.magnet_guid)}">
    <td><a class="anl-name" href="#/magnets">${Dg(e.name)}</a>${r}${i}</td>
    <td>${_g(Number(e.leads?.window||0),t)}</td>
    <td>${Tg(e.leads?.window)}</td>
    <td>${Tg(e.opens)}</td>
    <td>${Og(e.engagement_rate)}</td>
    <td>${Og(e.completion_rate)}</td>
    <td>${Og(e.lead_rate)}</td>
    <td>${a}</td>
    ...
    <tbody>${e.map(e=>vg(e,n,t)).join(``)}</tbody>
  </table></div>`}function bg(){return M()?ta({section:`analytics`,title:`Analytics`,description:`Pick a client to see how their magnets are performing.`}):(gg(),`
    ...
    </div>`)}async function xg(){if(M())return na(Cg(),[{h:`Leads`,td:e=>Tg(e.leads.window??e.leads.total)},{h:`Opens`,td:e=>Tg(e.opens)},{h:`Completed`,td:e=>Og(e.completion_rate)}]);gg(),await Sg();let e=document.getElementById(`anl-periods`);e&&e.addEventListener(`click`,t=>{let n=t.target.closest(`.chart-period-btn`);n&&(Ag=Number(n.dataset.days)||30,e.querySelectorAll(`.chart-period-btn`).forEach(e=>{e.classList.toggle(`active`,Number(e.dataset.days)===Ag)}),Sg())})}async function Sg(){let e=document.getElementById(`anl-body`),t=document.getElementById(`anl-range`);if(!e)return;e.innerHTML=Mg(`hourglass_empty`,`Loading magnet performance…`);let n=new Date,r=wg(n),i=wg(new Date(n.getTime()-(Ag-1)*864e5));t&&(t.textContent=`${i} → ${r}`);let a;try{let e=await fetch(`${Cg()}/m5t/v5/dashboard/stats?from=${i}&to=${r}&group_by=magnet`);if(a=await e.json(),!e.ok||!a?.ok)throw Error(a?.error||`HTTP ${e.status}`)}catch(t){e.innerHTML=Mg(`cloud_off`,`Could not load analytics. Refresh to try again.`),console.error(`[analytics] load failed:`,t);return}let o=(e,t)=>{let n=document.getElementById(e);n&&(n.textContent=t)};o(`anl-leads`,Tg(a.by_day?.reduce((e,t)=>e+Number(t.leads||0),0))),o(`anl-opens`,Tg(a.funnel?.opens)),o(`anl-completion`,Og(a.funnel?.completion_rate)),o(`anl-active`,Tg(a.magnets?.active));let s=Array.isArray(a.by_magnet)?a.by_magnet:[];if(!s.length){e.innerHTML=Mg(`widgets`,`No magnets yet. Create one and its numbers will show up here.`);return}let c=s.some(e=>Number(e.opens||0)>0||Number(e.leads?.window||0)>0),l=new Set(s.map(e=>e.owner_guid)).size>1;e.innerHTML=(a.by_magnet_truncated?`<p class="anl-warn">Showing the top ${s.length} magnets by leads. You have more than that, so this list is not complete.</p>`:``)+(c?``:`<p class="anl-warn">No opens or leads for any magnet in this period. Try a longer range.</p>`)+yg(s,l);let u=e.querySelector(`.anl-table tbody`);u&&Yt(u,{rowSelector:`tr`,noun:`magnets`,controlHost:e.querySelector(`.anl-wrap`)||e})}var Cg,wg,Tg,Eg,Dg,Og,kg,Ag,jg,Mg,Ng,Pg=o((()=>{D(),ua(),ba(),Zt(),Cg=()=>E.getConfig?.().BASE_URL||``,wg=e=>e.toISOString().slice(0,10),Tg=e=>Number(e||0).toLocaleString(),Eg={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Dg=e=>String(e??``).replace(/[&<>"']/g,e=>Eg[e]),Og=e=>e==null?`—`:`${e}%`,kg=[{d:7,label:`7 Days`},{d:30,label:`30 Days`},{d:90,label:`90 Days`}],Ag=30,jg=!1,Mg=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Ng={DRAFT:`Draft`,DISABLED:`Paused`}})),Fg=c({default:()=>n_,init:()=>Rg,render:()=>Lg});function Ig(){if(Sa(),Qg)return;let e=document.createElement(`style`);e.id=`m5t-adperf-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Qg=!0}function Lg(){return M()?ta({section:`ad-performance`,title:`Ad Performance`,description:`Pick a client to view their spend and lead performance.`}):(Ig(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${e_.map(e=>`<button class="chart-period-btn${e.d===t_?` active`:``}" type="button" data-days="${e.d}">${e.label}</button>`).join(``)}
        </div>
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-body">
          ${$g(`hourglass_empty`,`Loading ad performance…`)}
        </div>
      </div>
    ...
    </div>`)}async function Rg(){if(M()){let e=e=>Number(e||0).toLocaleString();return na(Kg(),[{h:`Spend`,td:t=>t.ad?`$${e(t.ad.spend)}`:`—`},{h:`Clicks`,td:t=>t.ad?e(t.ad.clicks):`—`},{h:`Leads`,td:t=>e(t.leads.window??t.leads.total)},{h:`CPL`,td:t=>t.ad?.cost_per_lead==null?`—`:`$${e(t.ad.cost_per_lead)}`}],{emptyMsg:`No client orgs yet. Connect a client ad account to see spend here.`})}let e=document.getElementById(`adperf-periods`);e?.addEventListener(`click`,t=>{let n=t.target.closest(`button[data-days]`);n&&(t_=Number(n.dataset.days)||30,e.querySelectorAll(`.chart-period-btn`).forEach(e=>e.classList.toggle(`active`,Number(e.dataset.days)===t_)),zg())}),document.getElementById(`adperf-sources`)?.addEventListener(`click`,e=>{let t=e.target.closest(`tr[data-campaign]`);t&&(da(ma.LEADS_SEARCH,t.dataset.campaign),!e.target.closest(`a`)&&(window.location.hash=`#/leads`))}),await zg()}async function zg(){let e=Kg(),t=document.getElementById(`adperf-body`),n=document.getElementById(`adperf-range`),r=new Date,i=qg(r),a=qg(new Date(r.getTime()-(t_-1)*864e5));n&&(n.textContent=`${a} → ${i}`);let o,s=[],c=null,l=null,u=null;try{let[t,n,r,d,f]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${a}&to=${i}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${a}&to=${i}`),tc().catch(()=>null),fetch(`${e}/m5t/v5/coreAdMetrics/conversions?from=${a}&to=${i}`).then(e=>e.json()).catch(()=>null)]);if(!t.ok)throw Error(`HTTP ${t.status}`);o=await t.json(),s=((await n.json().catch(()=>({})))?.data||[]).filter(e=>e.status!==`DELETED`),c=await r.json().catch(()=>null),l=d,u=f}catch(e){console.warn(`[ad-performance] load failed:`,e),t&&(t.innerHTML=$g(`error`,`Could not load ad performance. Please try again.`));return}Bg(l,s),Vg(u);let d=o.totals||{};if(Ug(`adperf-spend`,Jg(d.spend)),Ug(`adperf-clicks`,Yg(d.clicks)),Ug(`adperf-leads`,Yg(d.magnet_leads)),Ug(`adperf-cpl`,Jg(d.cost_per_lead)),Hg(c),!s.length){t.innerHTML=$g(`link_off`,`No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.`);return}if(!o.connected){t.innerHTML=$g(`cloud_sync`,`Account connected. No ad data for this range yet. Metrics appear here once they sync.`);return}let f=o.rows||[];t.innerHTML=Wg(f),Gg(f)}function Bg(e,t){let n=document.getElementById(`adperf-conn`);if(!n)return;if(!e||e.denied){n.innerHTML=``;return}let r=wc.google_ads,i=Qs(e.providers,`google_ads`),a=$s(r,i,!!e.configured?.google_ads),o=vc()?` <a href="#/settings/integrations/${r.urlSlug}">Manage</a>`:``;if(a===`connected`||a===`broken`){pc(),n.innerHTML=`<span>Google Ads</span> ${ec(a,i)}${o}`;return}if(t.length){n.innerHTML=`<span>Google Ads</span> <span>${t.length} associated account${t.length===1?``:`s`}</span>`;return}n.innerHTML=``}function Vg(e){let t=document.getElementById(`adperf-conv-card`),n=document.getElementById(`adperf-conv-body`),r=document.getElementById(`adperf-stats`),i=document.getElementById(`adperf-conv-stat`);if(i&&i.remove(),!t||!n)return;if(!e?.ok||!e.has_selection){t.style.display=`none`;return}if(r){let t=document.createElement(`div`);t.innerHTML=_a({icon:`flag`,label:`Ads Conversions`,value:Yg(e.totals?.conversions),sub:`Reported by Google Ads`,href:`#/settings/integrations/google-ads`});let n=t.firstElementChild;n.id=`adperf-conv-stat`,r.appendChild(n)}let a=e.actions||[];if(t.style.display=``,!a.length){n.innerHTML=$g(`search_off`,`No conversions in this range for the selected actions.`);return}let o=a.some(e=>e.value>0);n.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${a.map(e=>`
          <tr>
            <td>${Zg(e.name||e.id)}</td>
            <td class="adperf-src-sub">${Zg(String(e.category||``).toLowerCase().replace(/_/g,` `)||`—`)}</td>
            <td class="num"><b>${Yg(e.conversions)}</b></td>
            ${o?`<td class="num">${Jg(e.value)}</td>`:``}
          </tr>`).join(``)}
        </tbody>
      </table>
    </div>
    <p class="adperf-note">Counted actions are chosen on the Google Ads integration page. These are Google's own numbers and may overlap magnet leads, so they are never added together.</p>`}function Hg(e){let t=document.getElementById(`adperf-sources`),n=document.getElementById(`adperf-src-summary`);if(!t)return;let r=e&&Array.isArray(e.rows)?e.rows:[];if(!r.length){n&&(n.textContent=``),t.innerHTML=$g(`search_off`,`No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.`);return}let i=e.total_leads||r.reduce((e,t)=>e+(t.leads||0),0),a=e.tracked_leads||0;n&&(n.textContent=`${Yg(a)} of ${Yg(i)} leads tagged to a source`);let o=e=>e.campaign&&e.campaign!==`(none)`?Zg(e.campaign):e.source&&e.source!==`(direct)`?Zg(e.source):`<span class="adperf-src-untracked">Untracked / direct</span>`,s=e=>e.campaign&&e.campaign!==`(none)`?e.campaign:e.source&&e.source!==`(direct)`?e.source:``;t.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${r.map(e=>{let t=s(e);return`
          <tr${t?` data-campaign="${Zg(t)}" class="adperf-srcrow--link"`:``}>
            <td>${t?`<a class="adperf-srclink" href="#/leads" title="Show the leads from ${Zg(t)}">${o(e)}</a>`:o(e)}</td>
            <td class="adperf-src-sub">${Zg(e.source||`—`)}${e.medium?` · ${Zg(e.medium)}`:``}</td>
            <td class="num">${e.paid_clicks?Yg(e.paid_clicks):`<span class="adperf-src-sub">—</span>`}</td>
            <td class="num"><b>${Yg(e.leads)}</b></td>
          </tr>`}).join(``)}
        </tbody>
      </table>
    </div>`;let c=t.querySelector(`.adperf-srctable tbody`);c&&Yt(c,{rowSelector:`tr`,noun:`sources`,controlHost:t.querySelector(`.adperf-srcwrap`)||t})}function Ug(e,t){let n=document.getElementById(e);n&&(n.textContent=t)}function Wg(e){return Ca({rows:e,xLabel:e=>String(e.date||``).slice(5),left:{value:e=>e.spend||0,label:`Ad Spend`,fmt:e=>`$${Oa(e)}`},right:{value:e=>e.magnet_leads||0,label:`Magnet Leads`},ariaLabel:`Ad spend versus magnet leads over time`,pointLabel:e=>`${e.date}: ${Jg(e.spend||0)} spend, ${Yg(e.magnet_leads||0)} leads`,hitData:e=>({day:e.date})})}function Gg(e){let t=document.getElementById(`adperf-body`);return t?Ta(t,{rows:e,tipHTML:e=>`
      <div class="m5c-tip__title">${Zg(String(e.date||``))}</div>
      <div class="m5c-tip__row"><i class="m5c-sw m5c-sw--1"></i>${Jg(e.spend||0)} spend</div>
      <div class="m5c-tip__row"><i class="m5c-sw m5c-sw--2"></i>${Yg(e.magnet_leads||0)} leads</div>`}):()=>{}}var Kg,qg,Jg,Yg,Xg,Zg,Qg,$g,e_,t_,n_,r_=o((()=>{D(),ua(),kc(),ba(),Aa(),Zt(),ga(),Kg=()=>E.getConfig?.().BASE_URL||``,qg=e=>e.toISOString().slice(0,10),Jg=e=>e==null?`—`:`$`+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),Yg=e=>Number(e||0).toLocaleString(),Xg={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Zg=e=>String(e??``).replace(/[&<>"']/g,e=>Xg[e]),Qg=!1,$g=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,e_=[{d:7,label:`7 Days`},{d:30,label:`30 Days`},{d:90,label:`90 Days`}],t_=30,n_={render:Lg,init:Rg}})),i_=c({default:()=>T_,init:()=>s_,parseBookingCsv:()=>v_,render:()=>o_});function a_(){if(S_)return;let e=document.createElement(`style`);e.id=`m5t-adacct-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),S_=!0}function o_(){return M()?ta({section:`ad-accounts`,title:`Ad Accounts`,description:`Pick a client to see their connected ad accounts.`}):(a_(),pc(),`
    ...
    </div>`)}async function s_(){if(M()){let e=e=>Number(e||0).toLocaleString();return na(F(),[{h:`Spend`,td:t=>t.ad?`$${e(t.ad.spend)}`:`—`},{h:`Leads`,td:t=>e(t.leads.window??t.leads.total)},{h:`CPL`,td:t=>t.ad?.cost_per_lead==null?`—`:`$${e(t.ad.cost_per_lead)}`}],{emptyMsg:`No client orgs yet. Connect a client ad account to see it here.`})}await c_()}async function c_(){let[e,t,n]=await Promise.all([tc().catch(()=>null),fetch(`${F()}/m5t/v5/coreAdAccount`).then(e=>e.json()).catch(()=>null),fetch(`${F()}/m5t/v5/coreAdMetrics/conversions`).then(e=>e.json()).catch(()=>null)]);l_(e,n),u_(t),d_(t)}function l_(e,t){let n=document.getElementById(`adacct-conn`);if(!n)return;let r=wc.google_ads;if(!e||e.denied){n.innerHTML=yc(`link_off`,`Connection status is not available for your role.`);return}let i=Qs(e.providers,`google_ads`),a=$s(r,i,!!e.configured?.google_ads),o=i?.external_account||{},s=r.card.reachableCount(o),c;c=a===`connected`?s?`${s} reachable account${s===1?``:`s`}.`:`Connected.`:a===`broken`?r.card.brokenDesc:a===`unavailable`?`Google Ads is being set up for this platform.`:vc()?`Not connected yet. Connect from Settings to pull spend and clicks.`:`Not connected yet.`;let l=vc()&&a!==`unavailable`?`<a class="adacct-manage" href="#/settings/integrations/${r.urlSlug}"><span class="material-symbols-outlined" aria-hidden="true">${a===`idle`?`link`:`settings`}</span>${a===`idle`?`Connect`:`Manage`}</a>`:``,u=``;if(t?.ok&&t.has_selection){let e=(t.actions||[]).map(e=>e.name||e.id),n=(t.selected_ids||[]).length-e.length;u=`
    ...
    <div class="adacct-conn">
      ...
      <div class="adacct-conn__titles">
        <span class="adacct-conn__name">${P(r.label)} ${ec(a,i)}</span>
        <span class="adacct-conn__sub">${P(c)}</span>
      </div>
      <span class="adacct-conn__spacer"></span>
      ${l}
    </div>
    ${u}`}function u_(e){let t=document.getElementById(`adacct-list`),n=document.getElementById(`adacct-count`);if(!t)return;if(!e||e.ok===!1){t.innerHTML=yc(`error`,`Could not load ad accounts. Please try again.`);return}let r=(e.data||[]).filter(e=>e.status!==`DELETED`),i=!!e.canConnect;if(n&&(n.textContent=r.length?`${r.length} account${r.length===1?``:`s`}`:``),!r.length){t.innerHTML=yc(`link_off`,i?`No ad accounts associated yet.`:`No ad accounts yet. Your agency connects these for you.`)+(i?`<p class="adacct-note">Associate a client's Customer ID from the <a href="#/clients">Clients page</a>.</p>`:``);return}t.innerHTML=`
    <div class="adacct-wrap">
      <table class="adacct-table">
        <thead><tr><th>Platform</th><th>Customer ID</th><th>Status</th></tr></thead>
        <tbody>${r.map(e=>`
          <tr>
            <td>${P(b_[e.provider]||e.provider)}</td>
            <td class="adacct-cid">${P(x_(e.external_customer_id))}</td>
            <td><span class="m5t-badge" data-tone="${e.status===`ACTIVE`?`success`:`warning`}">${P(e.status===`ACTIVE`?`Active`:e.status)}</span></td>
          </tr>`).join(``)}
        </tbody>
      </table>
    </div>
    ${i?`<p class="adacct-note">Associations are managed per client from the <a href="#/clients">Clients page</a>.</p>`:``}`;let a=t.querySelector(`.adacct-table tbody`);a&&Yt(a,{rowSelector:`tr`,noun:`accounts`,controlHost:t.querySelector(`.adacct-wrap`)||t})}function d_(e){let t=document.getElementById(`adacct-offline`);if(t){if(!e?.canConnect){t.style.display=`none`;return}t.style.display=``,document.getElementById(`adacct-oc-dl`)?.addEventListener(`click`,g_),document.getElementById(`adacct-oc-up`)?.addEventListener(`click`,h_),document.getElementById(`adacct-mc-file`)?.addEventListener(`change`,__),f_()}}async function f_(){C_=[];try{let e=await(await fetch(`${F()}/m5t/v5/integrations/google_ads/conversion_actions`)).json();if(!e.ok)return;let t=e.data.actions||[];if(C_=t.filter(e=>e.type===`UPLOAD_CLICKS`&&(e.account_ids||[]).length),!C_.length){if(t.length){let e=document.getElementById(`adacct-oc-result`);e&&(e.textContent=`Direct upload needs an import type conversion action in Google Ads. The CSV works either way.`)}return}let n=document.getElementById(`adacct-oc-target`);n&&(n.innerHTML=C_.map(e=>`<option value="${P(e.id)}">${P(e.name||e.id)}</option>`).join(``)),document.getElementById(`adacct-oc-target-wrap`)?.style.setProperty(`display`,``),document.getElementById(`adacct-oc-up`)?.style.setProperty(`display`,``)}catch{}}function p_(){let e=document.getElementById(`adacct-oc-target`)?.value;return C_.find(t=>t.id===e)||C_[0]||null}async function m_(e,t){let n=p_();if(!n){t&&(t.textContent=`Pick an upload target first.`);return}let r=document.getElementById(`adacct-oc-value`)?.value,i=r!==``&&r!=null&&Number.isFinite(Number(r))?Number(r):null;t&&(t.textContent=`Uploading ${e.length} conversion${e.length===1?``:`s`}…`);try{let r=await(await fetch(`${F()}/m5t/v5/integrations/google_ads/upload_conversions`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({customer_id:n.account_ids[0],conversion_action_id:n.id,rows:e.map(e=>i==null?e:{...e,value:i})})})).json();if(!r.ok)throw Error(r.error||`upload failed`);let a=[`${r.data.uploaded} uploaded to Google Ads.`];r.data.failed&&a.push(`${r.data.failed} rejected${r.data.errors?.[0]?`: ${r.data.errors[0]}`:`.`}`),t&&(t.textContent=a.join(` `))}catch(e){t&&(t.textContent=e.message===`upload failed`?`Upload failed. Please try again.`:`Upload failed: ${e.message}`)}}async function h_(){let e=document.getElementById(`adacct-oc-result`),t=Number(document.getElementById(`adacct-oc-days`)?.value)||90,n=[...document.querySelectorAll(`#adacct-oc-statuses input:checked`)].map(e=>e.value);if(!n.length){e&&(e.textContent=`Pick at least one status.`);return}let r=e=>e.toISOString().slice(0,10),i=r(new Date),a=r(new Date(Date.now()-(t-1)*864e5)),o=new URLSearchParams({from:a,to:i,statuses:n.join(`,`),format:`json`});try{let t=await(await fetch(`${F()}/m5t/v5/coreAdMetrics/offline-conversions.csv?${o}`)).json();if(!t.ok)throw Error();if(!t.rows.length){e&&(e.textContent=`No leads with a click id in that window.`);return}await m_(t.rows,e)}catch{e&&(e.textContent=`Upload failed. Please try again.`)}}async function g_(){let e=document.getElementById(`adacct-oc-result`),t=Number(document.getElementById(`adacct-oc-days`)?.value)||90,n=[...document.querySelectorAll(`#adacct-oc-statuses input:checked`)].map(e=>e.value);if(!n.length){e&&(e.textContent=`Pick at least one status.`);return}let r=document.getElementById(`adacct-oc-name`)?.value?.trim()||`M5M magnet lead`,i=document.getElementById(`adacct-oc-value`)?.value,a=e=>e.toISOString().slice(0,10),o=a(new Date),s=a(new Date(Date.now()-(t-1)*864e5)),c=new URLSearchParams({from:s,to:o,statuses:n.join(`,`),name:r});i!==``&&i!=null&&Number.isFinite(Number(i))&&c.set(`value`,i),e&&(e.textContent=`Building the export…`);try{let t=await fetch(`${F()}/m5t/v5/coreAdMetrics/offline-conversions.csv?${c}`);if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.text(),r=Math.max(0,n.trim().split(`
`).length-1);y_(n,`google-ads-conversions-${s}-to-${o}.csv`),e&&(e.textContent=r?`${r} conversion${r===1?``:`s`} in the file.`:`No leads with a click id in that window. The file has headers only.`)}catch{e&&(e.textContent=`Export failed. Please try again.`)}}async function __(e){let t=document.getElementById(`adacct-mc-result`),n=e.target.files?.[0];if(!n)return;let r=v_(await n.text());if(!r.length){t&&(t.textContent=`No usable rows found. The CSV needs an email or phone column.`);return}t&&(t.textContent=`Matching ${r.length} row${r.length===1?``:`s`}…`);try{let e=await(await fetch(`${F()}/m5t/v5/coreAdMetrics/offline-conversions/match`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({rows:r})})).json();if(!e.ok)throw Error(e.error||`match failed`);let n=[`${e.matched_count} of ${r.length} rows matched a magnet lead with a click id.`];if(e.unmatched_count&&n.push(`${e.unmatched_count} had no matching lead.`),e.no_click_count&&n.push(`${e.no_click_count} matched a lead without a click id.`),!e.matched_count){t&&(t.textContent=n.join(` `));return}let i=document.getElementById(`adacct-oc-name`)?.value?.trim()||`M5M magnet lead`,a=document.getElementById(`adacct-oc-value`)?.value,o=a!==``&&a!=null&&Number.isFinite(Number(a))?Number(a):``,s=e=>`"${String(e??``).replace(/"/g,`""`)}"`,c=[`Google Click ID,Conversion Name,Conversion Time,Conversion Value,Conversion Currency`,...e.matched.map(e=>[s(e.gclid),s(i),s(e.time),o,``].join(`,`))].join(`\r
`)+`\r
`;if(w_=e.matched.map(e=>({gclid:e.gclid,time:e.time})),t){t.innerHTML=``;let e=document.createElement(`span`);e.textContent=n.join(` `)+` `;let r=document.createElement(`button`);if(r.type=`button`,r.className=`adacct-manage`,r.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">download</span>Download matched CSV`,r.addEventListener(`click`,()=>y_(c,`google-ads-conversions-matched-${new Date().toISOString().slice(0,10)}.csv`)),t.append(e,r),C_.length){let e=document.createElement(`button`);e.type=`button`,e.className=`adacct-manage`,e.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">cloud_upload</span>Upload to Google Ads`,e.addEventListener(`click`,()=>m_(w_,t)),t.append(` `,e)}}}catch{t&&(t.textContent=`Matching failed. Please try again.`)}finally{e.target.value=``}}function v_(e){let t=[],n=[],r=``,i=!1;for(let a=0;a<e.length;a++){let o=e[a];i?o===`"`&&e[a+1]===`"`?(r+=`"`,a++):o===`"`?i=!1:r+=o:o===`"`?i=!0:o===`,`?(n.push(r),r=``):o===`
`||o===`\r`?(o===`\r`&&e[a+1]===`
`&&a++,n.push(r),r=``,n.some(e=>e.trim()!==``)&&t.push(n),n=[]):r+=o}if(n.push(r),n.some(e=>e.trim()!==``)&&t.push(n),t.length<2)return[];let a=t[0].map(e=>e.trim().toLowerCase()),o=a.findIndex(e=>/e-?mail/.test(e)),s=a.findIndex(e=>/phone|mobile|tel/.test(e)),c=a.findIndex(e=>/date|time|booked|appointment|start/.test(e));return o<0&&s<0?[]:t.slice(1).map(e=>({email:o>=0?(e[o]||``).trim():``,phone:s>=0?(e[s]||``).trim():``,at:c>=0?(e[c]||``).trim():``})).filter(e=>e.email||e.phone).slice(0,5e3)}function y_(e,t){let n=new Blob([e],{type:`text/csv;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,document.body.appendChild(i),i.click(),i.remove(),setTimeout(()=>URL.revokeObjectURL(r),4e3)}var b_,x_,S_,C_,w_,T_,E_=o((()=>{ua(),Zt(),kc(),b_={google_ads:`Google Ads`,google_lsa:`Local Services Ads`},x_=e=>{let t=String(e||``).replace(/\D/g,``);return t.length===10?`${t.slice(0,3)}-${t.slice(3,6)}-${t.slice(6)}`:String(e||``)},S_=!1,C_=[],w_=null,T_={render:o_,init:s_}})),D_=c({default:()=>Y_,init:()=>F_,openInviteModal:()=>z_,render:()=>P_});function O_(e,t=`info`){try{H_.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}}function k_(){let e=E.getActiveOrg();if(e&&e.channel===U_)return{guid:e.guid,name:e.name};let t=E.getMemberships().find(e=>e.channel===U_);return t?{guid:t.orgGuid,name:t.name}:null}function A_(e){let t=e?.created_tz;if(!t)return``;let n=new Date(t);return Number.isNaN(n.getTime())?``:n.toLocaleDateString(void 0,{year:`numeric`,month:`short`,day:`numeric`})}function j_(){if(G_)return;let e=document.createElement(`style`);e.id=`m5t-clients-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),nr(),G_=!0}function M_(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function N_(e){let t=e.caption||e.guid,n=e.status||`ENABLED`;return`
    <div class="client-row">
      <span class="client-row__avatar">${X(q_(t))}</span>
      <span class="client-row__main">
        <div class="client-row__name" title="${X(t)}">${X(t)}</div>
        <div class="client-row__meta">Added ${X(A_(e.created))||`—`}</div>
      </span>
    ...
    <div class="page-shell" data-section="clients">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="clients-body">
          ${M_(`hourglass_empty`,`Loading clients…`)}
        </div>
      </div>
    </div>`}async function F_(){let e=k_();document.getElementById(`clients-add-btn`)?.addEventListener(`click`,()=>L_(e)),await I_(e)}async function I_(e){let t=document.getElementById(`clients-body`),n=document.getElementById(`clients-count`);if(t){if(!e?.guid){t.innerHTML=M_(`info`,`Client provisioning is available to reseller / agency accounts.`),n&&(n.textContent=``);return}try{let r=E.getConfig?.().BASE_URL||``,i=await fetch(`${r}/m5t/v5/acctGroup`);if(!i.ok)throw Error(`HTTP ${i.status}`);let a=await i.json(),o=(Array.isArray(a?.data)?a.data:[]).filter(t=>t.class===W_&&(!t.parent||t.parent===e.guid));if(!o.length){t.innerHTML=M_(`group_off`,`No clients yet. Add your first client to start managing magnets on their behalf.`),n&&(n.textContent=``);return}t.innerHTML=`<div class="client-list">${o.map(N_).join(``)}</div>`,Yt(t.querySelector(`.client-list`),{rowSelector:`.client-row`,noun:`clients`}),n&&(n.textContent=`${o.length} client${o.length===1?``:`s`}`),t.querySelectorAll(`.client-card__invite`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.action===`adaccounts`?R_(e.dataset.clientGuid,e.dataset.clientName):e.dataset.action===`questionnaire`?V_(e.dataset.clientGuid,e.dataset.clientName):z_(e.dataset.clientGuid,e.dataset.clientName)})})}catch(e){console.warn(`[clients] load failed:`,e),t.innerHTML=M_(`error`,`Couldn’t load clients. Please try again.`),n&&(n.textContent=``)}}}function L_(e){if(!e?.guid){O_(`Only reseller / agency accounts can add clients.`,`error`);return}let t=document.createElement(`div`);t.className=`client-modal-scrim`;let n=document.createElement(`div`);n.className=`client-modal`,n.setAttribute(`role`,`dialog`),n.setAttribute(`aria-modal`,`true`),n.innerHTML=`
    ...
    <div class="client-modal__body" id="qm-body">${M_(`hourglass_empty`,`Loading…`)}</div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add(`open`),i.classList.add(`open`)});let a=()=>{r.classList.remove(`open`),i.classList.remove(`open`),document.removeEventListener(`keydown`,o),setTimeout(()=>{r.remove(),i.remove()},200)},o=e=>{e.key===`Escape`&&a()};document.addEventListener(`keydown`,o),r.addEventListener(`click`,a),i.querySelector(`.client-modal__close`)?.addEventListener(`click`,a);let s=i.querySelector(`#qm-body`);function c(){s.innerHTML=`
      ...
      </div>`,s.querySelector(`[data-act="done"]`)?.addEventListener(`click`,a),s.querySelector(`[data-act="resend"]`)?.addEventListener(`click`,()=>c())}function d(e,t=!1){let r=e.editability||{editable:e.status===`SUBMITTED`&&!e.locked_tz,reason:e.locked_tz?`finalized`:null,deadline:null},i=!!r.editable,o=!i&&e.status===`SUBMITTED`?r.reason===`finalized`?`<div class="qm-status" data-status="LOCKED"><span class="material-symbols-outlined" aria-hidden="true">lock</span> Finalized${e.locked_tz?` ${X(B_(e.locked_tz))}`:``}${e.locked_by_email?` by ${X(e.locked_by_email)}`:``} — no further edits.</div>`:`<div class="qm-status" data-status="LOCKED"><span class="material-symbols-outlined" aria-hidden="true">lock_clock</span> Editing closed${r.deadline?` ${X(B_(r.deadline))}`:``} — a response locks 14 days after it is submitted.</div>`:``,c=i&&r.deadline?`<p class="client-modal__sub qm-editable-hint">You can edit these answers until ${X(B_(r.deadline))}.</p>`:``;s.innerHTML=`
      <div class="qm-status" data-status="SUBMITTED"><span class="material-symbols-outlined" aria-hidden="true">task_alt</span> Submitted ${e.submitted_tz?X(B_(e.submitted_tz)):``}</div>
      ${o}
      ${tr(e)}
      <form id="qm-form">
      ...
      </div>`,s.querySelector(`[data-act="done"]`)?.addEventListener(`click`,a),s.querySelector(`[data-act="cancel-edit"]`)?.addEventListener(`click`,()=>d(e,!1)),s.querySelector(`[data-act="edit"]`)?.addEventListener(`click`,()=>d(e,!0));let l=s.querySelector(`[data-act="save"]`);l?.addEventListener(`click`,async()=>{let t=er(s);l.disabled=!0;let r=l.innerHTML;l.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…`;let i;try{i=await fetch(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e.guid)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({answers:t})});let r=await i.json().catch(()=>({}));if(!i.ok||!r.ok)throw Error(r.error||r.message||`Failed (HTTP ${i.status})`);O_(`Answers updated`,`success`);let a=await(await fetch(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e.guid)}`)).json().catch(()=>({}));d(a.ok?a.data:{...e,answers:t},!1)}catch(t){if(i&&i.status===423){O_(t.message||`This questionnaire is now locked.`,`info`);let r=await(await fetch(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e.guid)}`)).json().catch(()=>({}));d(r.ok?r.data:e,!1);return}s.querySelector(`#qm-error`).textContent=t.message||`Something went wrong. Please try again.`,l.disabled=!1,l.innerHTML=r}})}try{let t=await fetch(`${n}/m5t/v5/m5mQuestionnaireResponse?owner_guid=${encodeURIComponent(e)}`),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`HTTP ${t.status}`);let i=(r.data||[])[0]||null;if(!i){c();return}if(i.status===`DRAFT`){l(i);return}if(i.status===`CANCELLED`){u(i);return}let a=await fetch(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(i.guid)}`),o=await a.json().catch(()=>({}));if(!a.ok||!o.ok)throw Error(o.error||`HTTP ${a.status}`);d(o.data)}catch(e){console.warn(`[clients] questionnaire load failed:`,e),s.innerHTML=`<p class="client-modal__error">Could not load questionnaire status. ${X(e.message||``)}</p>`}}var H_,U_,W_,G_,K_,X,q_,J_,Y_,X_=o((()=>{D(),Xe(),H_=u(f(),1),m(),Zt(),or(),U_=`reseller_org`,W_=`managed_client`,G_=!1,K_={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},X=e=>String(e??``).replace(/[&<>"']/g,e=>K_[e]),q_=e=>String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``).toUpperCase()||`?`,J_=e=>String(e||``).replace(/[^0-9]/g,``),Y_={render:P_,init:F_}})),Z_=c({default:()=>gv,init:()=>ov,loadTeam:()=>sv,render:()=>av});function Q_(){let e=E.getActiveOrg(),t=e&&e.channel!==uv?e:null;if(!t){let e=E.getMemberships().find(e=>e.channel!==uv);e&&(t={guid:e.orgGuid,channel:e.channel,memberRole:e.memberRole})}if(!t)return null;let n=E.getMemberships().find(e=>e.orgGuid===t.guid)?.name;return{...t,name:n}}function $_(e){return Object.values(Pe).filter(t=>Ne(e,t.value)).sort((e,t)=>t.rank-e.rank)}function ev(){if(dv)return;let e=document.createElement(`style`);e.id=`m5t-team-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),dv=!0}function tv(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function nv(e,t,n){let r=e.member_role||`member`,i=e.entity_guid&&e.entity_guid===E.getEntity?.()?.guid,a=n&&!i&&$_(t.memberRole).some(e=>e.value===r);return`
    <div class="team-row">
      <span class="team-avatar">${pv(hv(e.name||e.email))}</span>
      <span class="team-main">
        <div class="team-name">${pv(e.name||e.email)}${e.verified?``:` · <span style="color:var(--color-text-subtle,#6C7C9A);font-weight:400;">pending verification</span>`}</div>
        <div class="team-email" title="${pv(e.email)}">${pv(e.email)}</div>
      </span>
      <span class="team-role" data-role="${pv(r)}">${pv(Pe[r]?.label||r)}</span>
      ${a?`<button class="team-modal__btn team-modal__btn--ghost team-remove" type="button" data-id="${pv(e.id)}" data-name="${pv(e.name||e.email)}">Remove</button>`:``}
    </div>`}async function rv(e,t){let{uid:n,email:r}=e.dataset;if(window.confirm(`Revoke the invitation for ${r}?\n\nThe invitation link stops working immediately, including any copy already sent. You can invite this address again afterwards.`)){e.disabled=!0;try{let e=E.getConfig?.().BASE_URL||``,i=await fetch(`${e}/m5t/v5/acctGroup/${encodeURIComponent(t.guid)}/invites/${encodeURIComponent(n)}`,{method:`DELETE`}),a=await i.json().catch(()=>({}));if(!i.ok||!a.ok)throw Error(a.message||a.error||`HTTP ${i.status}`);mv(`Invitation for ${r} revoked`,`success`)}catch(t){e.disabled=!1,mv(t.message||`Could not revoke that invitation.`,`error`);return}try{await sv(t)}catch{}}}async function iv(e,t){let{id:n,name:r}=e.dataset;if(window.confirm(`Remove ${r} from the team?\n\nThey lose access to this workspace immediately. Their account itself is not deleted, and you can invite them again later.`)){e.disabled=!0;try{let e=E.getConfig?.().BASE_URL||``,t=await fetch(`${e}/m5t/v5/acctGroupMember/${encodeURIComponent(n)}`,{method:`DELETE`}),i=await t.json().catch(()=>({}));if(!t.ok||!i.ok)throw Error(i.message||i.error||`HTTP ${t.status}`);mv(`${r} removed from the team`,`success`)}catch(t){e.disabled=!1,mv(t.message||`Could not remove that member.`,`error`);return}try{await sv(t)}catch{}}}function av(){return ev(),`
    <div class="page-shell" data-section="team">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="team-body">
          ${tv(`hourglass_empty`,`Loading team…`)}
        </div>
      </div>
    </div>`}async function ov(){let e=Q_(),t=document.getElementById(`team-invite-btn`);if(!e){t&&(t.style.display=`none`),document.getElementById(`team-body`).innerHTML=tv(`info`,`Team management is available for agency and workspace accounts.`);return}t?.addEventListener(`click`,()=>cv(e)),await sv(e)}async function sv(e){let t=document.getElementById(`team-body`),n=document.getElementById(`team-count`);if(t)try{let r=E.getConfig?.().BASE_URL||``,[i,a]=await Promise.all([fetch(`${r}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/members`),fetch(`${r}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/invites`)]),[o,s]=await Promise.all([i.json().catch(()=>({})),a.json().catch(()=>({}))]);if(!i.ok||!a.ok)throw Error(`Failed to load team (members: ${i.status}, invites: ${a.status})`);let c=o.members||[],l=s.invites||[],u=$_(e.memberRole).length>0;t.innerHTML=(l.length?`
      <div class="team-pending">
        <div class="team-pending__label">Pending invites</div>
        ${l.map(e=>`
          <div class="team-pending__row">
            <span class="team-pending__email" title="${pv(e.email)}">${pv(e.email)}${e.expired?` · expired`:``}</span>
            <button class="team-modal__btn team-modal__btn--ghost team-copy" type="button" data-url="${pv(e.inviteUrl)}">Copy link</button>
            ${u?`<button class="team-modal__btn team-modal__btn--ghost team-revoke" type="button" data-uid="${pv(e.uid)}" data-email="${pv(e.email)}">Revoke</button>`:``}
          </div>`).join(``)}
      </div>`:``)+(c.length?`<div class="team-list">${c.map(t=>nv(t,e,u)).join(``)}</div>`:tv(`group`,`No members yet.`)),n&&(n.textContent=`${c.length} member${c.length===1?``:`s`}`),t.querySelectorAll(`.team-copy`).forEach(e=>e.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(e.dataset.url),e.textContent=`Copied!`,setTimeout(()=>{e.textContent=`Copy link`},1500)}catch{}})),t.querySelectorAll(`.team-revoke`).forEach(t=>t.addEventListener(`click`,()=>rv(t,e))),t.querySelectorAll(`.team-remove`).forEach(t=>t.addEventListener(`click`,()=>iv(t,e)))}catch(e){console.warn(`[team] load failed:`,e),t.innerHTML=tv(`error`,`Couldn’t load the team. Please try again.`)}}function cv(e){let t=$_(e.memberRole);if(!t.length){mv(`You don’t have permission to invite teammates.`,`error`);return}let n=document.createElement(`div`);n.className=`team-modal-scrim`;let r=document.createElement(`div`);r.className=`team-modal`,r.setAttribute(`role`,`dialog`),r.setAttribute(`aria-modal`,`true`),r.innerHTML=`
    ...
    <div class="team-modal__body" id="team-invite-body">
      <p class="team-modal__sub">They'll get a link to set a password and join <strong>${pv(e.name||`your workspace`)}</strong>.</p>
      ...
      <select class="team-modal__select" id="tm-role">
        ${t.map(e=>`<option value="${e.value}"${e.value===`member`?` selected`:``}>${pv(e.label)}</option>`).join(``)}
      </select>
      ...
      <div class="team-modal__actions">
        ...
        </div>`;let u=r.querySelector(`#tm-link`);r.querySelector(`#tm-copy`)?.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(u.value),r.querySelector(`#tm-copy`).textContent=`Copied!`}catch{u.select()}}),r.querySelector(`[data-act="done"]`)?.addEventListener(`click`,()=>{i(),sv(e)})}catch(e){console.warn(`[team] invite failed:`,e),o.textContent=e.message||`Something went wrong. Please try again.`,s.disabled=!1,s.innerHTML=l}})}var lv,uv,dv,fv,pv,mv,hv,gv,_v=o((()=>{D(),lv=u(f(),1),m(),Xe(),uv=`managed_client`,dv=!1,fv={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},pv=e=>String(e??``).replace(/[&<>"']/g,e=>fv[e]),mv=(e,t=`info`)=>{try{lv.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},hv=e=>String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``).toUpperCase()||`?`,gv={render:av,init:ov}}));m(),Se(),D(),zt(),y(),xn(),On(),et(),window.m5t=Object.create(null),window.m5t.pubsub=b.default,console.log(`StreamSyncEngage SaaS Client - Starting...`),console.log(`Environment:`,`production`),console.log(`Document readyState:`,document.readyState),console.log(`window.mvvLegit:`,typeof window.mvvLegit),console.log(`globalThis.mvvLegit:`,typeof globalThis.mvvLegit);try{console.log(`mvvLegit (direct):`,typeof mvvLegit)}catch(e){console.log(`mvvLegit (direct): ReferenceError -`,e.message)}var vv=Object.keys(window).filter(e=>e.toLowerCase().includes(`mvv`)||e.toLowerCase().includes(`neodigm`)||e.toLowerCase().includes(`legit`));console.log(`Possible Neodigm globals:`,vv);var Z=new ee.default(`/`,{hash:!0});window.router=Z;function Q(e){let t=e?`${e.replace(/-/g,`_`)}_route`:`splash_route`;return console.log(`[Router] Checking access: ${e} -> ${t}`),mvvLegit.isRouteAllowed(t)?!0:(console.warn(`[Router] Access denied to route: ${t}`),b.default.publish(p.UI_TOAST,{message:`Please sign in to access this page`,type:`warning`}),!1)}function $(e){console.log(`[Router] Navigating to:`,e),Z.navigate(`/${e}`)}var yv=new Set([`splash`,`signin`,`signup`,`forgot`,`resethash`,`verf-link`,`accept-invite`,`signout`]),bv={},xv={},Sv=null,Cv={admin:{caption:`Platform Admin`,icon:`shield_person`},reseller:{caption:`Reseller`,icon:`handshake`},managed:{caption:`Managed`,icon:`visibility`},self_serve:{caption:`Self-Serve`,icon:`rocket_launch`}},wv=`__portfolio__`;function Tv(){try{Z._setCurrent(null)}catch{}Z.resolve()}function Ev(){let e=document.getElementById(`m5t-side-nav`);if(!e)return;let t=!E.getScope()&&E.isAuthenticated(),n=E.getCapabilities(),r=E.getUiMode(),i=Wt.getSideNav(n,{uiMode:r});bv={},xv={};let a=e=>{e.route&&(bv[e.route]={sectionToken:e.token,childToken:null,children:e.children||null},Array.isArray(e.children)&&e.children.forEach(t=>{t.route&&(xv[t.token]=t.route,bv[t.route]={sectionToken:e.token,childToken:t.token,children:e.children})}))},o=e=>e.forEach(e=>{e.group&&Array.isArray(e.items)?o(e.items):a(e)});o(i);let s=E.getMemberships(),c=E.getActiveOrg(),l=E.getManagedClients(),u=E.getStoredActiveOrg(),d=l.length?[{guid:wv,name:`Portfolio (all clients)`},...s.map(e=>({guid:e.orgGuid,name:e.name||e.channel,channel:e.channel,group:`Your organization`})),...l.map(e=>({guid:e.orgGuid,name:e.name||e.orgGuid,channel:e.channel,group:`Clients`}))]:s.map(e=>({guid:e.orgGuid,name:e.name||e.channel,channel:e.channel}));e.setState({buttons:i,orgs:d,activeOrg:l.length?u||wv:c?.guid||null,footerBadge:Cv[r]||null,loading:t}),Ov(),Sv&&kv(Sv)}var Dv=e=>String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]);function Ov(){let e=document.getElementById(`app-content`);if(!e)return;let t=document.getElementById(`org-context-banner`);t||(t=document.createElement(`div`),t.id=`org-context-banner`,e.insertBefore(t,e.firstChild),fn(t));let n=E.getActiveOrg(),r=E.isPreviewingAsClient(),i=!!n?.viaSubtree&&!!Sv&&!yv.has(Sv);if(t.hidden=!i,!i){t.innerHTML=``;return}let a=Dv(n.name||`Client`);t.innerHTML=`
    <style>
    ...
    <div class="ocb" role="status">
    ...
    </div>`,t.querySelector(`[data-ocb="preview"]`)?.addEventListener(`click`,()=>{E.setPreviewAsClient(!E.isPreviewingAsClient()),Tv()}),t.querySelector(`[data-ocb="portfolio"]`)?.addEventListener(`click`,()=>{E.setPreviewAsClient(!1),E.setActiveOrg(null)})}function kv(e){let t=document.getElementById(`m5t-side-nav`),n=bv[`/${e}`]||bv[e]||null;t?.setActiveToken(n?.sectionToken||null),Av(n)}function Av(e){let t=document.getElementById(`m5t-sub-nav`),n=document.getElementById(`app-shell`);if(!t)return;let r=e?.children;t.hidden=!1,r&&r.length>1?(t.updateButtons(r.map(t=>({token:t.token,caption:t.caption,enabled:!0,selected:t.token===e.childToken}))),n?.classList.add(`has-sub-nav`)):(t.updateButtons([]),n?.classList.remove(`has-sub-nav`))}function jv(){let e=Rt.getAvailableLanguages&&Rt.getAvailableLanguages()||[];if(e.length<2){b.default.publish(p.UI_TOAST,{message:`Only one language is available`,type:`info`});return}let t=localStorage.getItem(v.FF_SSE_LS_USER_LANG)||v.FF_SSE_I18N_LANG||e[0],n=e[(e.indexOf(t)+1)%e.length];Rt.setLanguage(n),b.default.publish(p.UI_TOAST,{message:`Language: ${n}`,type:`info`})}function Mv(){document.documentElement.classList.toggle(`ff-no-animations`,yn())}function Nv(){let e=document.getElementById(`m5t-side-nav`);if(!e)return;Wt.setAppToken(`client-saas`),bn(e),document.getElementById(`app-shell`)?.classList.toggle(`nav-collapsed`,e.getAttribute(`data-collapsed`)===`true`),e.addEventListener(`nav-select`,e=>{let t=e.detail?.route;t&&Z.navigate(t.startsWith(`/`)?t:`/${t}`)}),e.addEventListener(`logo-click`,()=>Z.navigate(`/home`)),e.addEventListener(`nav-collapse`,e=>{document.getElementById(`app-shell`)?.classList.toggle(`nav-collapsed`,!!e.detail?.collapsed)}),e.addEventListener(`org-switch`,e=>{let t=e.detail?.orgGuid;t&&E.setActiveOrg(t===wv?null:t)}),e.addEventListener(`footer-action`,e=>{switch(e.detail?.action){case`account`:Z.navigate(`/settings`);break;case`signout`:Z.navigate(`/signout`);break;case`lang`:jv();break;case`theme`:En()}}),document.getElementById(`m5t-sub-nav`)?.addEventListener(`nav-select`,e=>{let t=xv[e.detail?.token];t&&Z.navigate(t)}),document.addEventListener(`language-changed`,()=>Ev()),Ev(),b.default.subscribe(p.AUTH_SCOPE_LOADED,()=>Ev());let t=()=>{let e=E.getScope();return[e?.uiMode,e?.activeOrg?.guid,(e?.managedClients||[]).length,(e?.capabilities||[]).join(`,`),E.getStoredActiveOrg()].join(`|`)},n=t();b.default.subscribe(p.AUTH_SCOPE_LOADED,()=>{let e=t();e!==n&&(n=e,Sv&&!yv.has(Sv)&&Tv())})}function Pv(e){Sv=e;let t=document.getElementById(`m5t-side-nav`),n=document.getElementById(`app-shell`);if(!t||!n)return;let r=!yv.has(e);if(t.hidden=!r,n.classList.toggle(`has-side-nav`,r),cn(r),r)kv(e);else{let e=document.getElementById(`m5t-sub-nav`);e&&(e.hidden=!0),n.classList.remove(`has-sub-nav`)}Ov()}b.default.subscribe(p.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&(qt(t.route),Pv(t.route))});var Fv=()=>{console.log(`[Router] Route: splash`),b.default.publish(p.ROUTE_NAV_BEFORE,{route:`splash`});let e=ve()?.name;w(e===`invite`?()=>Promise.resolve().then(()=>(In(),kn)):e===`questionnaire`?()=>Promise.resolve().then(()=>(Cr(),lr)):e===`deliverable`?()=>Promise.resolve().then(()=>(Qr(),Nr)):()=>Promise.resolve().then(()=>(ri(),$r)),void 0,import.meta.url).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`splash`})}).catch(e=>{console.error(`[Router] Error loading splash route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`splash`,error:e})})};Z.on(`/`,Fv),Z.on(`/splash`,Fv),Z.on(`/signin`,()=>{console.log(`[Router] Route: /signin`),b.default.publish(p.ROUTE_NAV_BEFORE,{route:`signin`}),w(()=>Promise.resolve().then(()=>(hi(),ci)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`signin`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading signin route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`signin`,error:e})})}),Z.on(`/signup`,()=>{console.log(`[Router] Route: /signup`),b.default.publish(p.ROUTE_NAV_BEFORE,{route:`signup`}),w(()=>Promise.resolve().then(()=>(Oi(),yi)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`signup`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading signup route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`signup`,error:e})})}),Z.on(`/verf-link`,()=>{console.log(`[Router] Route: /verf-link`),b.default.publish(p.ROUTE_NAV_BEFORE,{route:`verf-link`}),w(()=>Promise.resolve().then(()=>(Mi(),ki)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`verf-link`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading verf-link route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`verf-link`,error:e})})}),Z.on(`/forgot`,()=>{console.log(`[Router] Route: /forgot`),b.default.publish(p.ROUTE_NAV_BEFORE,{route:`forgot`}),w(()=>Promise.resolve().then(()=>(Ui(),Ri)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`forgot`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading forgot route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`forgot`,error:e})})}),Z.on(`/resethash`,()=>{if(console.log(`[Router] Route: /resethash`),!Q(`resethash`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`resethash`}),w(()=>Promise.resolve().then(()=>(Yi(),Wi)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`resethash`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading resethash route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`resethash`,error:e})})}),Z.on(`/home`,()=>{if(console.log(`[Router] Route: /home`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`home`}),w(()=>Promise.resolve().then(()=>(no(),ja)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`home`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading home route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`home`,error:e})})}),Z.on(`/signout`,()=>{if(console.log(`[Router] Route: /signout`),!Q(`signout`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`signout`}),w(()=>Promise.resolve().then(()=>(oo(),ro)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`signout`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading signout route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`signout`,error:e})})}),[{path:`/billing`,name:`billing`,title:`Billing`,icon:`receipt_long`},{path:`/magnets/drafts`,name:`magnets/drafts`,title:`Magnets · Drafts`,icon:`widgets`},{path:`/magnets/archived`,name:`magnets/archived`,title:`Magnets · Archived`,icon:`widgets`},{path:`/analytics/conversions`,name:`analytics/conversions`,title:`Analytics · Conversions`,icon:`monitoring`}].forEach(({path:e,name:t,title:n,icon:r})=>{Z.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:t}),w(()=>Promise.resolve().then(()=>(mo(),so)).then(e=>{let i=document.getElementById(`app`);i.innerHTML=e.render({title:n,icon:r,name:t}),e.init&&e.init({name:t}),b.default.publish(p.ROUTE_NAV_AFTER,{route:t})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading section route (${t}):`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:t,error:e})})})}),Z.on(`/settings`,()=>{if(console.log(`[Router] Route: /settings`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings`}),w(()=>Promise.resolve().then(()=>(Ro(),ho)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`settings`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-general route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`settings`,error:e})})}),Z.on(`/settings/workspace`,()=>{if(console.log(`[Router] Route: /settings/workspace`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/workspace`}),w(()=>Promise.resolve().then(()=>(hs(),zo)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/workspace`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-workspace route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/workspace`,error:e})})}),Z.on(`/settings/notifications`,()=>{if(console.log(`[Router] Route: /settings/notifications`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/notifications`}),w(()=>Promise.resolve().then(()=>(Bs(),gs)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/notifications`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-notifications route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/notifications`,error:e})})}),Z.on(`/settings/integrations`,()=>{if(console.log(`[Router] Route: /settings/integrations`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/integrations`}),w(()=>Promise.resolve().then(()=>(Vc(),Ac)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/integrations`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-integrations route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/integrations`,error:e})})}),Z.on(`/settings/integrations/:provider`,e=>{let t=e?.data?.provider||``;if(console.log(`[Router] Route: /settings/integrations/`+t),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/integrations`}),w(()=>Promise.resolve().then(()=>(al(),Hc)).then(e=>{let n=document.getElementById(`app`);n.innerHTML=e.render({provider:t}),e.init&&e.init({provider:t}),b.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/integrations`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading integration detail route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/integrations`,error:e})})}),Z.on(`/settings/security`,()=>{if(console.log(`[Router] Route: /settings/security`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/security`}),w(()=>Promise.resolve().then(()=>(Al(),ol)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/security`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-security route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/security`,error:e})})}),Z.on(`/conversations`,()=>{if(console.log(`[Router] Route: /conversations`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`conversations`}),w(()=>Promise.resolve().then(()=>(eu(),jl)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`conversations`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading conversations route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`conversations`,error:e})})}),Z.on(`/ab-testing`,()=>{if(console.log(`[Router] Route: /ab-testing`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`ab-testing`}),w(()=>Promise.resolve().then(()=>(Eu(),tu)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`ab-testing`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading ab-testing route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`ab-testing`,error:e})})}),Z.on(`/magnets`,()=>{if(console.log(`[Router] Route: /magnets`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`magnets`}),w(()=>Promise.resolve().then(()=>(Kp(),cf)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`magnets`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading magnets route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`magnets`,error:e})})}),Z.on(`/templates`,()=>{if(console.log(`[Router] Route: /templates`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`templates`}),w(()=>Promise.resolve().then(()=>(am(),qp)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`templates`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading templates route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`templates`,error:e})})}),Z.on(`/questionnaires`,()=>{if(console.log(`[Router] Route: /questionnaires`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`questionnaires`}),w(()=>Promise.resolve().then(()=>(Mm(),om)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`questionnaires`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading questionnaires route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`questionnaires`,error:e})})}),Z.on(`/deliverables`,()=>{if(console.log(`[Router] Route: /deliverables`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`deliverables`});let e=E.getUiMode?.();w(e===`reseller`||e===`admin`?()=>Promise.resolve().then(()=>(mh(),Nm)):()=>Promise.resolve().then(()=>(Oh(),hh)),void 0,import.meta.url).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`deliverables`})}).catch(e=>{console.error(`[Router] Error loading deliverables route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`deliverables`,error:e})})}),Z.on(`/leads`,()=>{if(console.log(`[Router] Route: /leads`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`leads`}),w(()=>Promise.resolve().then(()=>(mg(),kh)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`leads`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading leads route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`leads`,error:e})})}),Z.on(`/analytics`,()=>{if(console.log(`[Router] Route: /analytics`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`analytics`}),w(()=>Promise.resolve().then(()=>(Pg(),hg)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`analytics`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading analytics route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`analytics`,error:e})})}),Z.on(`/analytics/ad-performance`,()=>{if(console.log(`[Router] Route: /analytics/ad-performance`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`analytics/ad-performance`}),w(()=>Promise.resolve().then(()=>(r_(),Fg)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`analytics/ad-performance`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading ad-performance route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`analytics/ad-performance`,error:e})})}),Z.on(`/ad-accounts`,()=>{if(console.log(`[Router] Route: /ad-accounts`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`ad-accounts`}),w(()=>Promise.resolve().then(()=>(E_(),i_)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`ad-accounts`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading ad-accounts route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`ad-accounts`,error:e})})}),Z.on(`/clients`,()=>{if(console.log(`[Router] Route: /clients`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`clients`}),w(()=>Promise.resolve().then(()=>(X_(),D_)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`clients`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading clients route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`clients`,error:e})})}),Z.on(`/team`,()=>{if(console.log(`[Router] Route: /team`),!Q(`home`)){$(`signin`);return}b.default.publish(p.ROUTE_NAV_BEFORE,{route:`team`}),w(()=>Promise.resolve().then(()=>(_v(),Z_)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),b.default.publish(p.ROUTE_NAV_AFTER,{route:`team`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading team route:`,e),b.default.publish(p.ROUTE_NAV_ERROR,{route:`team`,error:e})})}),Z.notFound(()=>{console.log(`[Router] Route not found - redirecting to splash`),$(`splash`)}),b.default.subscribe(p.ROUTE_NAV,(e,t)=>{console.log(`[Router] ROUTE_NAV event received:`,t),t?.route&&$(t.route)});function Iv(){console.log(`[App] Waiting for Neodigm 55 library...`);let e=0,t=setInterval(()=>{e++,e%10==0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<`u`,neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<`u`?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(t),Lv()):e>=100&&(clearInterval(t),console.error(`[App] Failed to load Neodigm 55 library after 10 seconds`),console.error(`[App] Check browser console for CORS or network errors`),document.getElementById(`app`).innerHTML=`
      ...
      `,b.default.publish(p.APP_ERROR,{message:`Failed to load authentication library`}))},100)}document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,Iv):Iv();async function Lv(){if(console.log(`[App] Neodigm 55 loaded, initializing...`),Cn(),Mv(),ce(),Rt.initialize(),console.log(`[App] I18n Controller initialized`),!await E.init({BASE_URL:`https://machfivemagnet-saas.onrender.com`,navigateFunction:e=>{console.log(`[AuthController] Navigation requested:`,e),$(e)}})){console.error(`[App] AuthController initialization failed`);return}let e=E.getEntity();e&&(console.log(`[App] Session restored for:`,e.email),b.default.publish(p.APP_USER_LOADED,{entity:e}),E.isAuthenticated()&&(localStorage.getItem(E.CONFIG.LS_KEYS.ACTIVE_ORG)?await E.fetchScope():E.fetchScope())),b.default.publish(p.APP_READY,{timestamp:new Date().toISOString(),sessionUser:e}),Nv(),gn(),Z.resolve(),window.AuthController=E,window.I18nController=Rt,window.MachVive=Bt,console.log(`[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)`)}b.default.subscribe(p.ROUTE_NAV_AFTER,(e,t)=>{Rt!==void 0&&Rt.refresh&&setTimeout(()=>{Rt.refresh()},100)});
