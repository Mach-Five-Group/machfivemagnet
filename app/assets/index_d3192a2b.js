(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const ls="modulepreload",cs=function(e){return"/"+e},Pa={},X=function(t,a,n){let o=Promise.resolve();if(a&&a.length>0){let l=function(c){return Promise.all(c.map(h=>Promise.resolve(h).then(w=>({status:"fulfilled",value:w}),w=>({status:"rejected",reason:w}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),i=r?.nonce||r?.getAttribute("nonce");o=l(a.map(c=>{if(c=cs(c),c in Pa)return;Pa[c]=!0;const h=c.endsWith(".css"),w=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${w}`))return;const y=document.createElement("link");if(y.rel=h?"stylesheet":ls,h||(y.as="script"),y.crossOrigin="",y.href=c,i&&y.setAttribute("nonce",i),document.head.appendChild(y),h)return new Promise((u,x)=>{y.addEventListener("load",u),y.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${c}`)))})}))}function s(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return o.then(r=>{for(const i of r||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})};var ds=/([:*])(\w+)/g,ps="([^/]+)",us=/\*/g,ms="?(?:.*)",gs=/\/\?/g,hs="/?([^/]+|)",fs="(?:/^|^)",vs="";function Hn(e){return e===void 0&&(e="/"),wa()?location.pathname+location.search+location.hash:e}function G(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function It(e){return typeof e=="string"}function _s(e){return typeof e=="function"}function $t(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function bs(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(a,n,o){return a===null&&(a={}),a[t[o]]=decodeURIComponent(n),a},null)}function Lt(e){var t=G(e).split(/\?(.*)?$/);return[G(t[0]),t.slice(1).join("")]}function ya(e){for(var t={},a=e.split("&"),n=0;n<a.length;n++){var o=a[n].split("=");if(o[0]!==""){var s=decodeURIComponent(o[0]);t[s]?(Array.isArray(t[s])||(t[s]=[t[s]]),t[s].push(decodeURIComponent(o[1]||""))):t[s]=decodeURIComponent(o[1]||"")}}return t}function zn(e,t){var a=Lt(G(e.currentLocationPath)),n=a[0],o=a[1],s=o===""?null:ya(o),r=[],i;if(It(t.path)){if(i=fs+G(t.path).replace(ds,function(w,y,u){return r.push(u),ps}).replace(us,ms).replace(gs,hs)+"$",G(t.path)===""&&G(n)==="")return{url:n,queryString:o,hashString:$t(e.to),route:t,data:null,params:s}}else i=t.path;var l=new RegExp(i,vs),c=n.match(l);if(c){var h=It(t.path)?bs(c,r):c.groups?c.groups:c.slice(1);return{url:G(n.replace(new RegExp("^"+e.instance.root),"")),queryString:o,hashString:$t(e.to),route:t,data:h,params:s}}return!1}function Gn(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function je(e,t){return typeof e[t]>"u"||e[t]===!0}function ys(e){if(!e)return{};var t=e.split(","),a={},n;return t.forEach(function(o){var s=o.split(":").map(function(r){return r.replace(/(^ +| +$)/g,"")});switch(s[0]){case"historyAPIMethod":a.historyAPIMethod=s[1];break;case"resolveOptionsStrategy":n||(n={}),n.strategy=s[1];break;case"resolveOptionsHash":n||(n={}),n.hash=s[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":a[s[0]]=s[1]==="true";break}}),n&&(a.resolveOptions=n),a}function wa(){return typeof window<"u"}function ws(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(a){return a}).forEach(function(a){["before","after","already","leave"].forEach(function(n){a[n]&&(t[n]||(t[n]=[]),t[n].push(a[n]))})}),t}function ke(e,t,a){var n=t||{},o=0;(function s(){if(!e[o]){a&&a(n);return}Array.isArray(e[o])?(e.splice.apply(e,[o,1].concat(e[o][0](n)?e[o][1]:e[o][2])),s()):e[o](n,function(r){typeof r>"u"||r===!0?(o+=1,s()):a&&a(n)})})()}ke.if=function(e,t,a){return Array.isArray(t)||(t=[t]),Array.isArray(a)||(a=[a]),[e,t,a]};function Da(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=Hn(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function Kt(e,t){for(var a=0;a<e.instance.routes.length;a++){var n=e.instance.routes[a],o=zn(e,n);if(o&&(e.matches||(e.matches=[]),e.matches.push(o),e.resolveOptions.strategy==="ONE")){t();return}}t()}function xs(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function Es(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var Ba=wa(),Ss=Gn();function As(e,t){if(je(e.navigateOptions,"updateBrowserURL")){var a=("/"+e.to).replace(/\/\//g,"/"),n=Ba&&e.resolveOptions&&e.resolveOptions.hash===!0;Ss?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",n?"#"+a:a),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!n){var o=location.hash;location.hash="",location.hash=o}e.instance.__freezeListening=!1},1))):Ba&&(window.location.href=e.to)}t()}function Vn(e,t){var a=e.instance;if(!a.lastResolved()){t();return}ke(a.lastResolved().map(function(n){return function(o,s){if(!n.route.hooks||!n.route.hooks.leave){s();return}var r=!1,i=e.instance.matchLocation(n.route.path,e.currentLocationPath,!1);if(n.route.path!=="*")r=!i;else{var l=e.matches?e.matches.find(function(c){return n.route.path===c.route.path}):!1;r=!l}if(je(e.navigateOptions,"callHooks")&&r){ke(n.route.hooks.leave.map(function(c){return function(h,w){return c(function(y){y===!1?e.instance.__markAsClean(e):w()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return s()}]));return}else s()}}),{},function(){return t()})}function ks(e,t){e.match.route.hooks&&e.match.route.hooks.before&&je(e.navigateOptions,"callHooks")?ke(e.match.route.hooks.before.map(function(a){return function(o,s){return a(function(r){r===!1?e.instance.__markAsClean(e):s()},e.match)}}).concat([function(){return t()}])):t()}function Cs(e,t){je(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function Ts(e,t){e.match.route.hooks&&e.match.route.hooks.after&&je(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(a){return a(e.match)}),t()}function Is(e,t){var a=e.instance.lastResolved();if(a&&a[0]&&a[0].route===e.match.route&&a[0].url===e.match.url&&a[0].queryString===e.match.queryString){a.forEach(function(n){n.route.hooks&&n.route.hooks.already&&je(e.navigateOptions,"callHooks")&&n.route.hooks.already.forEach(function(o){return o(e.match)})}),t(!1);return}t()}function $s(e,t){var a=e.instance._notFoundRoute;if(a){e.notFoundHandled=!0;var n=Lt(e.currentLocationPath),o=n[0],s=n[1],r=$t(e.to);a.path=G(o);var i={url:a.path,queryString:s,hashString:r,data:null,route:a,params:s!==""?ya(s):null};e.matches=[i],e.match=i}t()}function Ls(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function Ns(e,t){e.instance._setCurrent(null),t()}function qn(e,t){je(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var jn=[Is,ks,Cs,Ts],Ua=[Vn,$s,ke.if(function(e){var t=e.notFoundHandled;return t},jn.concat([qn]),[Ls,Ns])];function oa(){return oa=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},oa.apply(this,arguments)}function Ha(e,t){var a=0;function n(){if(a===e.matches.length){qn(e,t);return}ke(jn,oa({},e,{match:e.matches[a]}),function(){a+=1,n()})}Vn(e,n)}function Xt(e){e.instance.__markAsClean(e)}function sa(){return sa=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},sa.apply(this,arguments)}var za="[data-navigo]";function Os(e,t){var a=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:za},n=this,o="/",s=null,r=[],i=!1,l,c=Gn(),h=wa();e?o=G(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function w(g){return g.indexOf("#")>=0&&(a.hash===!0?g=g.split("#")[1]||"/":g=g.split("#")[0]),g}function y(g){return G(o+"/"+G(g))}function u(g,A,N,B){return g=It(g)?y(g):g,{name:B||G(String(g)),path:g,handler:A,hooks:ws(N)}}function x(g,A,N){var B=this;return typeof g=="object"&&!(g instanceof RegExp)?(Object.keys(g).forEach(function(v){if(typeof g[v]=="function")B.on(v,g[v]);else{var $=g[v],q=$.uses,j=$.as,_e=$.hooks;r.push(u(v,q,[l,_e],j))}}),this):(typeof g=="function"&&(N=A,A=g,g=o),r.push(u(g,A,[l,N])),this)}function m(g,A){if(n.__dirty){n.__waiting.push(function(){return n.resolve(g,A)});return}else n.__dirty=!0;g=g?G(o)+"/"+G(g):void 0;var N={instance:n,to:g,currentLocationPath:g,navigateOptions:{},resolveOptions:sa({},a,A)};return ke([Da,Kt,ke.if(function(B){var v=B.matches;return v&&v.length>0},Ha,Ua)],N,Xt),N.matches?N.matches:!1}function f(g,A){if(n.__dirty){n.__waiting.push(function(){return n.navigate(g,A)});return}else n.__dirty=!0;g=G(o)+"/"+G(g);var N={instance:n,to:g,navigateOptions:A||{},resolveOptions:A&&A.resolveOptions?A.resolveOptions:a,currentLocationPath:w(g)};ke([xs,Es,Kt,ke.if(function(B){var v=B.matches;return v&&v.length>0},Ha,Ua),As,Xt],N,Xt)}function _(g,A,N){var B=Te(g,A);return B!==null?(f(B.replace(new RegExp("^/?"+o),""),N),!0):!1}function C(g){return this.routes=r=r.filter(function(A){return It(g)?G(A.path)!==G(g):_s(g)?g!==A.handler:String(A.path)!==String(g)}),this}function L(){c&&(this.__popstateListener=function(){n.__freezeListening||m()},window.addEventListener("popstate",this.__popstateListener))}function M(){this.routes=r=[],c&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=i=!0}function ee(g,A){return n._notFoundRoute=u("*",g,[l,A],"__NOT_FOUND__"),this}function Q(){if(h)return se().forEach(function(g){if(g.getAttribute("data-navigo")==="false"||g.getAttribute("target")==="_blank"){g.hasListenerAttached&&g.removeEventListener("click",g.navigoHandler);return}g.hasListenerAttached||(g.hasListenerAttached=!0,g.navigoHandler=function(A){if((A.ctrlKey||A.metaKey)&&A.target.tagName.toLowerCase()==="a")return!1;var N=g.getAttribute("href");if(typeof N>"u"||N===null)return!1;if(N.match(/^(http|https)/)&&typeof URL<"u")try{var B=new URL(N);N=B.pathname+B.search}catch{}var v=ys(g.getAttribute("data-navigo-options"));i||(A.preventDefault(),A.stopPropagation(),n.navigate(G(N),v))},g.addEventListener("click",g.navigoHandler))}),n}function se(){return h?[].slice.call(document.querySelectorAll(a.linksSelector||za)):[]}function ye(g){return"/"+o+"/"+G(g)}function fe(g){return l=g,this}function we(){return s}function Te(g,A,N){var B=r.find(function(q){return q.name===g}),v=null;if(B){if(v=B.path,A)for(var $ in A)v=v.replace(":"+$,A[$]);v=v.match(/^\//)?v:"/"+v}return v&&N&&!N.includeRoot&&(v=v.replace(new RegExp("^/"+o),"")),v}function k(g){return g.getAttribute("href")}function R(g){var A=Lt(G(g)),N=A[0],B=A[1],v=B===""?null:ya(B),$=$t(g),q=u(N,function(){},[l],N);return{url:N,queryString:B,hashString:$,route:q,data:null,params:v}}function xe(){return R(G(Hn(o)).replace(new RegExp("^"+o),""))}function ft(g){var A={instance:n,currentLocationPath:g,to:g,resolveOptions:a};return Kt(A,function(){}),A.matches?A.matches:!1}function Yt(g,A,N){typeof A<"u"&&(typeof N>"u"||N)&&(A=y(A));var B={instance:n,to:A,currentLocationPath:A};Da(B,function(){}),typeof g=="string"&&(g=typeof N>"u"||N?y(g):g);var v=zn(B,{name:String(g),path:g,handler:function(){},hooks:{}});return v||!1}function Ne(g,A,N){return typeof A=="string"&&(A=De(A)),A?(A.hooks[g]||(A.hooks[g]=[]),A.hooks[g].push(N),function(){A.hooks[g]=A.hooks[g].filter(function(B){return B!==N})}):(console.warn("Route doesn't exists: "+A),function(){})}function De(g){return typeof g=="string"?r.find(function(A){return A.name===y(g)}):r.find(function(A){return A.handler===g})}function vt(g){g.instance.__dirty=!1,g.instance.__waiting.length>0&&g.instance.__waiting.shift()()}this.root=o,this.routes=r,this.destroyed=i,this.current=s,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=vt,this.on=x,this.off=C,this.resolve=m,this.navigate=f,this.navigateByName=_,this.destroy=M,this.notFound=ee,this.updatePageLinks=Q,this.link=ye,this.hooks=fe,this.extractGETParameters=function(g){return Lt(w(g))},this.lastResolved=we,this.generate=Te,this.getLinkPath=k,this.match=ft,this.matchLocation=Yt,this.getCurrentLocation=xe,this.addBeforeHook=Ne.bind(this,"before"),this.addAfterHook=Ne.bind(this,"after"),this.addAlreadyHook=Ne.bind(this,"already"),this.addLeaveHook=Ne.bind(this,"leave"),this.getRoute=De,this._pathToMatchObject=R,this._clean=G,this._checkForAHash=w,this._setCurrent=function(g){return s=n.current=g},L.call(this),Q.call(this)}var Rs=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Ms(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var lt={exports:{}},Fs=lt.exports,Ga;function Ps(){return Ga||(Ga=1,(function(e,t){(function(a,n){var o={};a.PubSub?(o=a.PubSub,console.warn("PubSub already loaded, using existing version")):(a.PubSub=o,n(o)),e!==void 0&&e.exports&&(t=e.exports=o),t.PubSub=o,e.exports=t=o})(typeof window=="object"&&window||Fs||Rs,function(a){var n={},o=-1,s="*";function r(m){var f;for(f in m)if(Object.prototype.hasOwnProperty.call(m,f))return!0;return!1}function i(m){return function(){throw m}}function l(m,f,_){try{m(f,_)}catch(C){setTimeout(i(C),0)}}function c(m,f,_){m(f,_)}function h(m,f,_,C){var L=n[f],M=C?c:l,ee;if(Object.prototype.hasOwnProperty.call(n,f))for(ee in L)Object.prototype.hasOwnProperty.call(L,ee)&&M(L[ee],m,_)}function w(m,f,_){return function(){var L=String(m),M=L.lastIndexOf(".");for(h(m,m,f,_);M!==-1;)L=L.substr(0,M),M=L.lastIndexOf("."),h(m,L,f,_);h(m,s,f,_)}}function y(m){var f=String(m),_=!!(Object.prototype.hasOwnProperty.call(n,f)&&r(n[f]));return _}function u(m){for(var f=String(m),_=y(f)||y(s),C=f.lastIndexOf(".");!_&&C!==-1;)f=f.substr(0,C),C=f.lastIndexOf("."),_=y(f);return _}function x(m,f,_,C){m=typeof m=="symbol"?m.toString():m;var L=w(m,f,C),M=u(m);return M?(_===!0?L():setTimeout(L,0),!0):!1}a.publish=function(m,f){return x(m,f,!1,a.immediateExceptions)},a.publishSync=function(m,f){return x(m,f,!0,a.immediateExceptions)},a.subscribe=function(m,f){if(typeof f!="function")return!1;m=typeof m=="symbol"?m.toString():m,Object.prototype.hasOwnProperty.call(n,m)||(n[m]={});var _="uid_"+String(++o);return n[m][_]=f,_},a.subscribeAll=function(m){return a.subscribe(s,m)},a.subscribeOnce=function(m,f){var _=a.subscribe(m,function(){a.unsubscribe(_),f.apply(this,arguments)});return a},a.clearAllSubscriptions=function(){n={}},a.clearSubscriptions=function(f){var _;for(_ in n)Object.prototype.hasOwnProperty.call(n,_)&&_.indexOf(f)===0&&delete n[_]},a.countSubscriptions=function(f){var _,C,L=0;for(_ in n)if(Object.prototype.hasOwnProperty.call(n,_)&&_.indexOf(f)===0){for(C in n[_])L++;break}return L},a.getSubscriptions=function(f){var _,C=[];for(_ in n)Object.prototype.hasOwnProperty.call(n,_)&&_.indexOf(f)===0&&C.push(_);return C},a.unsubscribe=function(m){var f=function(ye){var fe;for(fe in n)if(Object.prototype.hasOwnProperty.call(n,fe)&&fe.indexOf(ye)===0)return!0;return!1},_=typeof m=="string"&&(Object.prototype.hasOwnProperty.call(n,m)||f(m)),C=!_&&typeof m=="string",L=typeof m=="function",M=!1,ee,Q,se;if(_){a.clearSubscriptions(m);return}for(ee in n)if(Object.prototype.hasOwnProperty.call(n,ee)){if(Q=n[ee],C&&Q[m]){delete Q[m],M=m;break}if(L)for(se in Q)Object.prototype.hasOwnProperty.call(Q,se)&&Q[se]===m&&(delete Q[se],M=!0)}return M}})})(lt,lt.exports)),lt.exports}var Ds=Ps();const d=Ms(Ds),p=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV.GO",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN.GO",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP.GO",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT.GO",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT.GO",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH.GO",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",AUTH_SCOPE_LOADED:"AUTH.SCOPE.LOADED",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",M5T_SIDE_NAV:"M5T_SIDE_NAV",M5T_SIDE_NAV_TAP:"M5T_SIDE_NAV.TAP",M5T_SIDE_NAV_COLLAPSE:"M5T_SIDE_NAV.COLLAPSE",M5T_SIDE_NAV_LOGO_TAP:"M5T_SIDE_NAV.LOGO_TAP",M5T_SIDE_NAV_ORG_SWITCH:"M5T_SIDE_NAV.ORG_SWITCH",M5T_SIDE_NAV_FOOTER_ACTION:"M5T_SIDE_NAV.FOOTER_ACTION",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL",MESSAGE:"MESSAGE",MESSAGE_CREATE:"MESSAGE.CREATE",MESSAGE_CREATED:"MESSAGE.CREATED",MESSAGE_EDIT:"MESSAGE.EDIT",MESSAGE_UPDATED:"MESSAGE.UPDATED",MESSAGE_DELETE:"MESSAGE.DELETE",MESSAGE_DELETED:"MESSAGE.DELETED",MESSAGE_REFRESH:"MESSAGE.REFRESH"}),Qt={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://machfivemagnet-saas.onrender.com"};var Zt={};const U=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_USER_PREFS:"mvv_user_prefs",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_LS_LAST_ROUTE:"mvv_last_route",FF_SSE_API_DEBUG_LOGGING:!1,FF_SSE_API_TIMEOUT:3e4,FF_SSE_API_MAX_RETRIES:3,FF_SSE_API_CACHE_ENABLED:!0,FF_SSE_AUTH_TOKEN_EXPIRY_HOURS:6,FF_SSE_AUTH_AUTO_REFRESH:!1,FF_SSE_AUTH_SESSION_WARNING_MINUTES:5,FF_SSE_AUTH_REMEMBER_ME:!0,FF_SSE_AUTH_MAX_LOGIN_ATTEMPTS:5,FF_SSE_UI_TOAST_ENABLED:!0,FF_SSE_UI_TOAST_DURATION:5e3,FF_SSE_UI_LOADING_SPINNERS:!0,FF_SSE_UI_DARK_MODE:!1,FF_SSE_UI_ANIMATIONS:!0,FF_SSE_FEATURE_SIGNUP_ENABLED:!0,FF_SSE_FEATURE_PASSWORD_RESET_ENABLED:!0,FF_SSE_FEATURE_EMAIL_VERIFICATION_ENABLED:!0,FF_SSE_FEATURE_PROFILE_EDIT_ENABLED:!0,FF_SSE_FEATURE_ANALYTICS_ENABLED:!1,FF_SSE_CACHE_TTL_MS:3e5,FF_SSE_COMPRESSION_ENABLED:!0,FF_SSE_MAX_PAYLOAD_SIZE_MB:50,FF_SSE_DEBUG_VERBOSE:!1,FF_SSE_DEBUG_REDUX_DEVTOOLS:!1,FF_SSE_DEBUG_PERFORMANCE:!1,FF_SSE_DEBUG_BYPASS_AUTH:!1,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_BUILD_MODE:"LOCAL",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel",FF_API_RATELIMIT_SIGNIN_ENFORCE:!1,FF_API_RATELIMIT_SIGNIN_IP_LIMIT:20,FF_API_RATELIMIT_SIGNIN_EMAIL_LIMIT:10,FF_API_RATELIMIT_FORGOT_ENFORCE:!1,FF_API_RATELIMIT_FORGOT_IP_LIMIT:15,FF_API_RATELIMIT_FORGOT_EMAIL_LIMIT:5,FF_API_RATELIMIT_CAPTURE_ENFORCE:!1,FF_API_RATELIMIT_CAPTURE_LIMIT:30,FF_API_RATELIMIT_EVENT_ENFORCE:!1,FF_API_RATELIMIT_EVENT_LIMIT:600,FF_API_RATELIMIT_AUTHENTICATED_ENFORCE:!1,FF_API_RATELIMIT_AUTHENTICATED_LIMIT:600,FF_API_MAGNET_REQUIRE_ORIGIN_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_LIMIT:2e3});function Wn(e,t=null){if(e in U)return U[e];if(typeof process<"u"&&Zt&&Zt[e]){const a=Zt[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}if(typeof import.meta<"u"&&Qt&&Qt[e]){const a=Qt[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}return t}function Bs(e){return Wn(e,!1)===!0}function Us(){return{...U}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:U,getFlag:Wn,isEnabled:Bs,getAllFlags:Us});const Va={success:{border:"var(--color-success, #009473)",bg:"var(--color-success-soft, rgba(0,148,115,0.10))",icon:"check_circle"},danger:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},error:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},warning:{border:"var(--color-warning-ink, #7a5e00)",bg:"var(--color-warning-tint, rgba(245,223,77,0.16))",icon:"warning"},info:{border:"var(--color-info, #7BC4C4)",bg:"var(--color-info-soft, rgba(123,196,196,0.12))",icon:"info"}},Hs=4500,ra=220;let Ie=null,qa=!1;function zs(){if(qa)return;const e=document.createElement("style");e.id="m5t-toast-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),qa=!0}function Gs(){return Ie&&document.body.contains(Ie)||(Ie=document.createElement("div"),Ie.className="m5t-toast-stack",Ie.setAttribute("role","status"),Ie.setAttribute("aria-live","polite"),document.body.appendChild(Ie)),Ie}function Vs(e){const t=e&&e.message;if(!t)return;zs();const a=Va[e.type]||Va.info,n=document.createElement("div");n.className="m5t-toast",n.style.borderColor=a.border,n.style.background=a.bg,n.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true" style="color:${a.border}">${a.icon}</span><span class="m5t-toast__msg"></span><button type="button" class="m5t-toast__close" aria-label="Dismiss"><span class="material-symbols-outlined" aria-hidden="true">close</span></button>`,n.querySelector(".m5t-toast__msg").textContent=String(t),Gs().appendChild(n),requestAnimationFrame(()=>n.classList.add("is-in"));let s=!1;const r=()=>{s||(s=!0,clearTimeout(i),n.classList.remove("is-in"),n.classList.add("is-out"),setTimeout(()=>n.remove(),ra))},i=setTimeout(r,Hs);n.querySelector(".m5t-toast__close").addEventListener("click",r)}function qs(){const e=t=>a=>{const n=a.detail?.pubsubTopic;n&&d.publish(n,a.detail)};document.addEventListener("nav-select",e()),document.addEventListener("logo-click",e()),document.addEventListener("nav-hover",e()),document.addEventListener("nav-double-tap",e()),document.addEventListener("nav-long-tap",e()),document.addEventListener("message-sent",e())}function js(){console.log("[AppEvents] Initializing event listeners..."),d.subscribe(p.APP_READY,(a,n)=>{console.log("[AppEvents] APP_READY:",n)}),d.subscribe(p.APP_ERROR,(a,n)=>{console.error("[AppEvents] APP_ERROR:",n)}),d.subscribe(p.APP_SIGNOUT,(a,n)=>{console.log("[AppEvents] APP_SIGNOUT:",n)}),d.subscribe(p.ROUTE_NAV_BEFORE,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",n),d.publish(p.UI_LOADING_START)}),d.subscribe(p.ROUTE_NAV_AFTER,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",n),d.publish(p.UI_LOADING_END)}),d.subscribe(p.ROUTE_NAV_ERROR,(a,n)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",n),d.publish(p.APP_ERROR,{message:"Navigation error",details:n})}),d.subscribe(p.AUTH_SIGNIN_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",n)}),d.subscribe(p.AUTH_SIGNIN_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",n),d.publish(p.UI_TOAST,{message:n.message||"Sign in failed",type:"danger"})}),d.subscribe(p.AUTH_SIGNUP_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",n),d.publish(p.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"}),d.publish(p.AUTH_VERIFY_LINK)}),d.subscribe(p.AUTH_VERIFY_LINK,(a,n)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),d.subscribe(p.AUTH_SIGNUP_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",n),d.publish(p.UI_TOAST,{message:n.message||"Sign up failed",type:"danger"})}),d.subscribe(p.AUTH_SIGNOUT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",n),d.publish(p.UI_TOAST,{message:"Signed out successfully",type:"info"})}),d.subscribe(p.AUTH_SIGNUP,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),d.subscribe(p.AUTH_FORGOT,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),d.subscribe(p.AUTH_FORGOT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",n),d.publish(p.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),d.subscribe(p.AUTH_RESETHASH_NAV,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),d.subscribe(p.AUTH_RESETHASH_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",n),d.publish(p.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),d.subscribe(p.AUTH_TOKEN_EXPIRED,(a,n)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",n),d.publish(p.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),d.subscribe(p.I18N_SET_LANG,(a,n)=>{console.log("[AppEvents] I18N_SET_LANG:",n);const{langCode:o}=n;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),d.publish(p.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(s){console.error("[AppEvents] Error changing language:",s),d.publish(p.UI_TOAST,{message:`Failed to change language: ${s.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),d.subscribe("CONVERSATION.PROMPT",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",n.message),ea(n.message,"user",n.timestamp),d.publish(p.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Agent prompt (no implementation):",n.message);break;case"AGENT_CANVAS":console.log("[AppEvents] Display message in canvas:",n.message),ea(n.message,"user",n.timestamp),d.publish(p.CANVAS_DO_SCROLL);break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),d.subscribe("CONVERSATION.RESPONSE",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",n.message),ea(n.message,"assistant",n.timestamp,n.streaming);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),d.subscribe(p.UI_LOADING_START,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),d.subscribe(p.UI_LOADING_END,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),d.subscribe(p.UI_TOAST,(a,n)=>{Vs(n)}),d.subscribe(p.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const a="0.1",n=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${a} 8/9/2026, 10:17:35 AM|© ${n} Mach Five Tech`,"night")}),qs(),d.subscribe("M5T_PRIMARY_NAV",(a,n)=>{const o=a.split(".")[1];switch(o){case"TAP":e(n);break;case"LOGO_TAP":t();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function e(a){const{token:n,level:o,primaryToken:s}=a;switch(n){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),d.publish(p.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${n}`,{primaryToken:s});break}}function t(a){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 8/9/2026, 10:17:35 AM|© ${o} Mach Five Tech`,"night",5e3)}d.subscribe(p.AUTH_SIGNOUT,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(U.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function ea(e,t="user",a=null,n=!1){const o=document.getElementById("chat-messages");if(!o){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}if(a||(a=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})),n&&t==="assistant"){const r=o.firstElementChild;if(r&&r.tagName.toLowerCase()==="m5t-chat-response"){r.setAttribute("message",e),console.log(`[AppEvents] Updated streaming ${t} bubble (${e.length} chars)`);return}}let s;t==="user"||t==="prompt"?s=document.createElement("m5t-chat-prompt"):s=document.createElement("m5t-chat-response"),s.setAttribute("message",e),s.setAttribute("timestamp",a),o.prepend(s),console.log(`[AppEvents] Added ${t} bubble to canvas (${e.length} chars)`)}function Yn(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("uid")&&t.get("token"))}const Ws=Object.freeze({admin_root_role:{value:100,desc:"Administrator superuser infrastructure architecture"},admin_business_role:{value:90,desc:"Administrator financial oversight"},admin_support_role:{value:80,desc:"Administrator maintenance and configuration"},admin_readonly_role:{value:70,desc:"Administrator information help desk"},client_tier_4_role:{value:40,desc:"Client paid tier 4 - Partner"},client_tier_3_role:{value:30,desc:"Client paid tier 3"},client_tier_2_role:{value:20,desc:"Client paid tier 2"},client_tier_1_role:{value:10,desc:"Client paid tier 1"},client_standard_role:{value:0,desc:"Client free tier 0"}});function Ys(e){return Ws[e]||null}function Js(e){return e>=50}const dt=Object.freeze({owner:{value:"owner",rank:30,label:"Owner"},admin:{value:"admin",rank:20,label:"Admin"},member:{value:"member",rank:10,label:"Member"},viewer:{value:"viewer",rank:0,label:"Viewer"}}),Ks=Object.freeze({VIEW_DASHBOARD:"view_dashboard",VIEW_MAGNETS:"view_magnets",PROVISION_MAGNETS:"provision_magnets",MANAGE_MAGNETS:"manage_magnets",VIEW_CONVERSATIONS:"view_conversations",VIEW_STATS:"view_stats",VIEW_AD_METRICS:"view_ad_metrics",CONNECT_AD_ACCOUNTS:"connect_ad_accounts",CREATE_CLIENT_ACCOUNTS:"create_client_accounts",MANAGE_TEAM:"manage_team",VIEW_BILLING:"view_billing",MANAGE_BILLING:"manage_billing"}),T=Ks,Jn=Object.freeze(Object.values(T)),Be=Object.freeze([T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS]),Xs=Object.freeze({reseller_org:{owner:Jn,admin:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.CREATE_CLIENT_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING],member:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS],viewer:Be},managed_client:{owner:[...Be,T.VIEW_BILLING],admin:[...Be,T.VIEW_BILLING],member:Be,viewer:Be},saas_org:{owner:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING,T.MANAGE_BILLING],admin:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING],member:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS],viewer:Be}});function Qs(e){const t=Ys(e);return!!t&&Js(t.value)}function Zs({entityClass:e,orgChannel:t,memberRole:a}={}){if(Qs(e))return e==="admin_readonly_role"?[...Be,T.VIEW_BILLING]:[...Jn];const n=Xs[t],o=n&&n[a];return o?[...o]:[]}function er(e,t){const a=dt[e]?.rank??-1,n=dt[t]?.rank??1/0;return a>=dt.admin.rank&&a>=n}const xa=[{value:"name",label:"Full name (splits into first + last automatically)"},{value:"first_name",label:"First name"},{value:"last_name",label:"Last name"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"mobile",label:"Mobile phone"},{value:"company",label:"Company"},{value:"title",label:"Job title"},{value:"city",label:"City"},{value:"state",label:"State / province"},{value:"product_interest",label:"Product interest"},{value:"lead_source",label:"Lead source"},{value:"rating",label:"Rating (Hot / Warm / Cold)"},{value:"description",label:"Notes / description"}];new Set(xa.map(e=>e.value));const Ea=[{value:"single_select",label:"Multiple choice"},{value:"multi_select",label:"Select all"},{value:"scheduler",label:"Scheduler"},{value:"text",label:"Short text"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"message",label:"Message"}];new Set(Ea.map(e=>e.value));class S{static CONFIG={BASE_URL:"https://machfivemagnet-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink",SCOPE:"sse_session_scope",ACTIVE_ORG:"sse_active_org",REMEMBERED_EMAIL:"sse_remembered_email"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",ME:"/m5t/v5/acctEntity/me",PING:"/ping"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#o=null;static#a=null;static#n=!1;static#s=null;static#i=null;static async init({BASE_URL:t,navigateFunction:a,customConfig:n={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(a&&typeof a=="function")this.#i=a;else throw new Error("navigateFunction is required and must be a function");return t&&(this.CONFIG.BASE_URL=t),n&&Object.keys(n).length>0&&(this.CONFIG={...this.CONFIG,...n}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#m(),this.#p(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#p(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((t=null)=>{if(t){if(Yn()&&(t==="splash"||t==="signin")){console.log("[AuthController] Ignoring mvvLegit redirect to",t,"— keeping invitee on accept-invite");return}console.log("[AuthController] mvvLegit navigation to:",t),this.#r(t)}}).setOnState((t=null)=>{if(t)switch(console.log("[AuthController] Auth state changed:",t),t){case"AUTH":case 4:this.#_();break;case"UNAUTH":case 1:this.#b();break;case"UNVERF":case 2:this.#y();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#r(t){if(!this.#i){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",t);const a=t.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",a),this.#i(a)}static#l(){if(window.__m5tActiveOrgFetch)return;const t=window.fetch.bind(window);window.fetch=(a,n)=>{try{const o=typeof a=="string"?a:a?.url||"",s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);if(s&&o.startsWith(this.CONFIG.BASE_URL)){const r=new Headers(n&&n.headers||(a instanceof Request?a.headers:void 0));r.set("X-Active-Org",s),n={...n||{},headers:r}}}catch{}return t(a,n)},window.__m5tActiveOrgFetch=!0,console.log("[AuthController] Active-org fetch header installed")}static#m(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);t&&(this.#o=JSON.parse(t),console.log("[AuthController] Entity state loaded:",this.#o?.email))}catch(t){console.error("[AuthController] Error loading entity state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#o=null}this.#s=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.SCOPE);t&&(this.#a=JSON.parse(t),console.log("[AuthController] Scope state loaded (cached):",this.#a?.uiMode))}catch(t){console.error("[AuthController] Error loading scope state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE),this.#a=null}}static#c(t){try{this.#o=t,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(t)),console.log("[AuthController] Entity state saved")}catch(a){console.error("[AuthController] Error saving entity state:",a)}}static#d(){this.#o=null,this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#u)}catch{}}static getEntity(){return this.#o}static#v(t){try{this.#a=t,localStorage.setItem(this.CONFIG.LS_KEYS.SCOPE,JSON.stringify(t))}catch(a){console.error("[AuthController] Error saving scope state:",a)}}static async fetchScope(){if(typeof mvvLegit>"u"||!this.isAuthenticated())return console.log("[AuthController] fetchScope skipped — not authenticated"),this.#a;if(this.#n)return this.#a;this.#n=!0;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),a=t?`?org=${encodeURIComponent(t)}`:"",n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.ME}${a}`);if(n.status===401||n.status===403)return console.warn("[AuthController] /me unauthorized — signing out"),this.doSignout(!0),null;if(!n.ok)return console.warn(`[AuthController] /me failed (${n.status}) — using cached scope`),this.#a;const o=await n.json();if(!o?.ok)return console.warn("[AuthController] /me returned not-ok — using cached scope"),this.#a;try{const s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);s&&o.activeOrg?.guid!==s&&(console.warn(`[AuthController] Stored active org not honored by /me${o.activeOrgError?" (activeOrgError)":""} — clearing`),localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG))}catch{}return this.#v(o),d.publish(p.AUTH_SCOPE_LOADED,o),console.log(`[AuthController] Scope loaded: ${o.uiMode} (${o.memberships?.length||0} org(s), ${o.managedClients?.length||0} client(s))`),o}catch(t){return console.error("[AuthController] fetchScope error:",t),this.#a}finally{this.#n=!1}}static async setActiveOrg(t){try{t?localStorage.setItem(this.CONFIG.LS_KEYS.ACTIVE_ORG,t):localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}return this.fetchScope()}static getScope(){return this.#a}static getCapabilities(){return this.isPreviewingAsClient()?Zs({orgChannel:"managed_client",memberRole:"owner"}):this.#a?.capabilities||[]}static getUiMode(){return this.isPreviewingAsClient()?"managed":this.#a?.uiMode||"self_serve"}static getActiveOrg(){return this.#a?.activeOrg||null}static getMemberships(){return this.#a?.memberships||[]}static getManagedClients(){return this.#a?.managedClients||[]}static getStoredActiveOrg(){try{return localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{return null}}static#u="m5m_preview_as_client";static isPreviewingAsClient(){try{return sessionStorage.getItem(this.#u)==="1"&&!!this.#a?.activeOrg?.viaSubtree}catch{return!1}}static setPreviewAsClient(t){try{t?sessionStorage.setItem(this.#u,"1"):sessionStorage.removeItem(this.#u)}catch{}this.#a&&d.publish(p.AUTH_SCOPE_LOADED,this.#a)}static async doSignin(t,a){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a})}),o=await n.json();if(n.status===303)return console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#c(o.entity)),setTimeout(()=>{this.#r(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o};if(n.ok&&o.accessToken){console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#c(o.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#u)}catch{}return this.fetchScope(),console.log("[AuthController] Explicitly navigating to home"),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}}return{ok:!1,error:o.error||"Sign in failed",data:o}}catch(n){return console.error("[AuthController] Signin error:",n),{ok:!1,error:n.message}}}static async doSignout(t=!1){console.log("[AuthController] doSignout called, serverInitiated:",t);try{const a=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!a),!t&&a){const n=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(a)}`;if(console.log("[AuthController] Sending signout beacon to:",n),navigator.sendBeacon){const o=navigator.sendBeacon(n);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else a||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#d(),console.log("[AuthController] Stopping auth ping..."),this.#h(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(a){console.error("[AuthController] Signout error:",a),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(t){try{const a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await a.json();return a.ok&&n.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#c(n.entity),{ok:!0,data:n}):{ok:!1,error:n.error||"Sign up failed",data:n}}catch(a){return console.error("[AuthController] Signup error:",a),{ok:!1,error:a.message}}}static async doResetHash(t,a){try{const n=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a,modified_by:t})}),s=await o.json();return o.ok&&s.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:s}):{ok:!1,error:s.error||"Password reset failed",data:s}}catch(n){return console.error("[AuthController] Reset password error:",n),{ok:!1,error:n.message}}}static#g(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#f()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#h(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#f(){try{const t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);t.ok?console.log("[AuthController] Ping success"):(t.status===401||t.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(t){console.error("[AuthController] Ping error:",t)}}static setDeepLinkGuid(t){this.#s=t,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,t),console.log("[AuthController] Deep-link GUID stored:",t)}static getDeepLinkGuid(){return this.#s}static clearDeepLink(){this.#s=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#_(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.fetchScope()}static#b(){console.log("[AuthController] User unauthenticated"),this.#h()}static#y(){console.log("[AuthController] User unverified")}static getAuthState(){try{const t=mvvLegit.getConf()?.LSKEY||"mvv",a=localStorage.getItem(t);if(!a)return"UNAUTH";if(typeof LZString>"u")return null;const n=LZString.decompressFromUTF16(a),s=JSON.parse(n)?.state;return s===1?"UNAUTH":s===2?"UNVERF":s===4?"AUTH":s===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(t){this.#r(t)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#f()}}class I{static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",remember_email:"Remember my email",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_dashboard:"Dashboard",nav_dashboard_tagline:"Overview of your activity",nav_magnets:"Your Magnets",nav_magnets_tagline:"Manage your conversational magnets",nav_templates:"Templates",nav_templates_tagline:"Start from a magnet template",nav_conversations:"Conversations",nav_conversations_tagline:"Captured lead conversations",nav_ab_testing:"A/B Testing",nav_ab_testing_tagline:"Experiment and optimize",nav_analytics:"Analytics",nav_analytics_tagline:"Performance and ad metrics",nav_ad_accounts:"Ad Accounts",nav_ad_accounts_tagline:"Connect advertising accounts",nav_clients:"Clients",nav_clients_tagline:"Manage your client accounts",nav_team:"Team",nav_team_tagline:"Invite and manage teammates",nav_billing:"Billing",nav_billing_tagline:"Plan, usage, and invoices",nav_settings:"Settings",nav_settings_tagline:"Account and workspace settings",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Rollers",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",remember_email:"Recordar mi correo electrónico",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Rollers",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",remember_email:"记住我的邮箱",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"滚动器",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:t,product:a,whitelabel:n,lang:o}){t&&(this.#t.buildMode=t),a&&(this.#t.product=a),n&&(this.#t.whitelabel=n),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{let l=this.#e[o]?.[s]?.[r]?.[i]?.[t],c=o;return!l&&o!=="LOCAL"&&(l=this.#e.LOCAL?.[s]?.[r]?.[i]?.[t],c="LOCAL (fallback)"),l?(c==="LOCAL (fallback)"&&console.warn(`[MicrocopyManager] Token '${t}' missing from ${o} — served from LOCAL instead. Backfill ${o}'s block if this is intentionally different copy.`),Array.isArray(l)?l[Math.floor(Math.random()*l.length)]:l):(console.warn(`[MicrocopyManager] Token not found: ${t} (${o}/${s}/${r}/${i}, LOCAL fallback also missing it)`),null)}catch(l){return console.error(`[MicrocopyManager] Error retrieving token: ${t}`,l),null}}static getAll(t={}){const a={...this.#t,...t},{buildMode:n,product:o,whitelabel:s,lang:r}=a;try{return this.#e[n]?.[o]?.[s]?.[r]||null}catch(i){return console.error("[MicrocopyManager] Error retrieving all tokens",i),null}}static has(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return!!this.#e[o]?.[s]?.[r]?.[i]?.[t]}catch{return!1}}static getAvailableLanguages(){const{buildMode:t,product:a,whitelabel:n}=this.#t;try{return Object.keys(this.#e[t]?.[a]?.[n]||{})}catch{return[]}}static update(t,a,n={}){const o={...this.#t,...n},{buildMode:s,product:r,whitelabel:i,lang:l}=o;try{return this.#e[s]||(this.#e[s]={}),this.#e[s][r]||(this.#e[s][r]={}),this.#e[s][r][i]||(this.#e[s][r][i]={}),this.#e[s][r][i][l]||(this.#e[s][r][i][l]={}),this.#e[s][r][i][l][t]=a,!0}catch(c){return console.error(`[MicrocopyManager] Error updating token: ${t}`,c),!1}}static delete(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return delete this.#e[o]?.[s]?.[r]?.[i]?.[t],!0}catch(l){return console.error(`[MicrocopyManager] Error deleting token: ${t}`,l),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(t){try{return this.#e=t,!0}catch(a){return console.error("[MicrocopyManager] Error importing data",a),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:I});class Ce{static#e=!1;static#t=null;static#o=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const t=this.#n();I.setContext(t),console.log("[I18nController] Initialized with context:",t),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#s(),this.#p(),this.#e=!0,this.refresh()}static#a(t){const a={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},n=t.toLowerCase();return a[n]||"DEV"}static#n(){const a=this.#a("production"),n=localStorage.getItem(U.FF_SSE_LS_WHITELABEL)||U.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(U.FF_SSE_LS_USER_LANG)||U.FF_SSE_I18N_LANG;return{buildMode:a,product:U.FF_SSE_I18N_PRODUCT,whitelabel:n,lang:o}}static#s(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((t,a,n)=>{U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",n),this.#t=n,setTimeout(()=>{this.refresh()},U.FF_SSE_I18N_APPLY_DELAY_MS)},U.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#i())}static#i(){setInterval(()=>{const a=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");a&&a!==this.#t&&(this.#t=a,this.refresh())},500)}static#p(){this.#o||(this.#o=new MutationObserver(t=>{let a=!1;for(const n of t){for(const o of n.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){a=!0;break}if(a)break}a&&(U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#o.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#r(document.body),this.#l(document.body),U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#r(t){const a=t.querySelectorAll("[data-meta-copywrite-i118n]");U.FF_SSE_I18N_DEBUG&&a.length>0&&console.log(`[I18nController] Processing ${a.length} elements`),a.forEach(n=>{try{const o=n.getAttribute("data-meta-copywrite-i118n"),s=JSON.parse(o);if(!s.token){console.warn("[I18nController] Missing token in config:",s);return}const r=s.attribute||"textContent",i=I.get(s.token);if(i===null){console.warn(`[I18nController] Microcopy not found for token: ${s.token}`);return}r==="textContent"?n.textContent=i:r==="innerHTML"?n.innerHTML=i:n.setAttribute(r,i),U.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${i}" to ${r} for token: ${s.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,n)}})}static#l(t){t.querySelectorAll("*").forEach(n=>{n.shadowRoot&&(this.#r(n.shadowRoot),this.#l(n.shadowRoot))})}static setLanguage(t){const a=I.getAvailableLanguages();if(!a.includes(t)){console.error(`[I18nController] Language not available: ${t}. Available:`,a);return}localStorage.setItem(U.FF_SSE_LS_USER_LANG,t),I.setContext({lang:t}),console.log("[I18nController] Language changed to:",t);const n=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:t}});document.dispatchEvent(n),this.refresh()}static setWhitelabel(t){localStorage.setItem(U.FF_SSE_LS_WHITELABEL,t),I.setContext({whitelabel:t}),U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",t),this.refresh()}static getLanguage(){return I.getContext().lang}static getAvailableLanguages(){return I.getAvailableLanguages()}static getContext(){return I.getContext()}static destroy(){this.#o&&(this.#o.disconnect(),this.#o=null),this.#e=!1,this.#t=null,U.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{Ce.initialize()}):Ce.initialize());class Sa{static _initialized=!1;static _debug=!1;static init(t={}){if(this._initialized)return console.warn("[MachVive] Already initialized, skipping duplicate initialization"),this;if(this._debug=t.debug||!1,!window.mvvSSEther)return console.error("[MachVive] mvvSSEther not found - cannot initialize bridge"),console.error("[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()"),this;console.log("[MachVive] Initializing SSE to PubSub bridge...");const a=n=>{this._handleSSEMessage(n)};return window.mvvSSEther.onmessage(a),this._initialized=!0,console.log("[MachVive] ✓ SSE to PubSub bridge initialized successfully"),console.log("[MachVive] ✓ Bound callback to mvvSSEther.onmessage"),this}static _handleSSEMessage(t){try{this._debug&&console.log("[MachVive] SSE message received:",t);const a=t?.data;if(!a){this._debug&&console.log("[MachVive] No data in message, skipping");return}const n=a.data||a.package||a;if(!n){this._debug&&console.log("[MachVive] No package found in message, skipping");return}let o=n.cfg;const s=n.msg;if(this._debug&&(console.log("[MachVive] cfg (raw):",o,"type:",typeof o,"length:",o?.length),console.log("[MachVive] msg (raw):",s)),typeof o=="string"){if(o.trim()===""){this._debug&&console.log("[MachVive] cfg is empty string, skipping");return}try{o=JSON.parse(o),console.log("[MachVive] cfg (parsed):",o)}catch(i){console.warn("[MachVive] Failed to parse cfg as JSON:",{cfg:o,cfgLength:o.length,error:i.message});return}}else if(!o){this._debug&&console.log("[MachVive] cfg is empty/null, skipping");return}const r=o?.topic;if(!r){this._debug&&console.log("[MachVive] No topic found in cfg, skipping");return}if(console.log("[MachVive] Extracted topic:",r),!this._isValidTopic(r)){console.warn(`[MachVive] Topic '${r}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(r,s,t,a)}catch(a){console.error("[MachVive] Error handling SSE message:",a)}}static _isValidTopic(t){return!p||!p.hasOwnProperty(t)?(console.warn(`[MachVive] Topic '${t}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(t,a,n,o){try{if(!window.PubSub&&typeof PubSub>"u"){console.error("[MachVive] PubSub not available");return}const s=window.PubSub||PubSub,r={message:a,metadata:{source:"sse",sseEventId:n.id,timestamp:n.timestamp,appGuid:o.app_guid,channelGuid:o.channel_guid,eventAction:o.event_action,status:o.status,class:o.class,raw:o}};console.log(`[MachVive] Publishing to topic '${t}':`,r);const i=p[t];console.log(`[MachVive] AppBroadcast.${t} = '${i}'`),s.publish(i,r),console.log(`[MachVive] ✓ Published SSE message to topic: ${t}`)}catch(s){console.error(`[MachVive] Error publishing to topic '${t}':`,s)}}static debug(t){return this._debug=t,console.log(`[MachVive] Debug mode ${t?"enabled":"disabled"}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log("[MachVive] Reset complete"),this}}typeof module<"u"&&module.exports&&(module.exports=Sa);typeof window<"u"&&(window.MachVive=Sa);const ja="m5t_sidenav_collapsed",tr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};class ar extends HTMLElement{static get observedAttributes(){return["data-active-token","data-collapsed"]}constructor(){super(),this.attachShadow({mode:"open"}),this.items=[],this.orgs=[],this.activeOrgGuid=null,this.activeToken=null,this.footerBadge=null,this.loading=!1,this.lastFocus=null}#e=null;#t=t=>{if(this.getAttribute("data-open")==="true"){if(t.key==="Escape"){t.preventDefault(),this.closeDrawer();return}if(t.key==="Tab"){const a=this.#c();if(a.length<2)return;const n=a[0],o=a[a.length-1],s=this.shadowRoot.activeElement;t.shiftKey&&s===n?(t.preventDefault(),o.focus()):!t.shiftKey&&s===o&&(t.preventDefault(),n.focus())}}};#o=()=>{this.closeDrawer(),this.#d()};connectedCallback(){if(!this.hasAttribute("data-collapsed"))try{localStorage.getItem(ja)==="true"&&this.setAttribute("data-collapsed","true")}catch{}this.activeToken=this.getAttribute("data-active-token")||null,this.render(),this.#l(),this.addEventListener("keydown",this.#t),this.#e=window.matchMedia("(max-width: 768px)"),this.#e.addEventListener("change",this.#o),this.#d()}disconnectedCallback(){this.removeEventListener("keydown",this.#t),this.#e?.removeEventListener("change",this.#o)}attributeChangedCallback(t,a,n){a===n||!this.shadowRoot||(t==="data-active-token"?(this.activeToken=n,this.#m()):t==="data-collapsed"&&this.shadowRoot.firstChild&&(this.render(),this.#l()))}setState({buttons:t,orgs:a,activeOrg:n,footerBadge:o,loading:s}={}){t!==void 0&&(this.items=Array.isArray(t)?t:this.#a(t)||[]),a!==void 0&&(this.orgs=Array.isArray(a)?a:this.#a(a)||[]),n!==void 0&&(this.activeOrgGuid=n||null),o!==void 0&&(this.footerBadge=o||null),s!==void 0&&(this.loading=!!s),this.shadowRoot&&(this.render(),this.#l())}setButtons(t){this.setState({buttons:t})}setOrgs(t){this.setState({orgs:t})}setActiveOrgGuid(t){this.setState({activeOrg:t})}setFooterBadge(t){this.setState({footerBadge:t})}setActiveToken(t){this.activeToken=t||null,this.#m()}toggleCollapsed(t){const a=typeof t=="boolean"?t:this.getAttribute("data-collapsed")!=="true";this.setAttribute("data-collapsed",String(a));try{localStorage.setItem(ja,String(a))}catch{}this.dispatchEvent(new CustomEvent("nav-collapse",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_SIDE_NAV.COLLAPSE",collapsed:a,timestamp:Date.now()}}))}openDrawer(){this.lastFocus=this.shadowRoot.activeElement||document.activeElement,this.setAttribute("data-open","true"),this.shadowRoot.querySelector(".hamburger")?.setAttribute("aria-expanded","true"),this.#d(),(this.#c()[0]||this.shadowRoot.querySelector(".sidenav"))?.focus?.()}closeDrawer(){if(this.getAttribute("data-open")!=="true")return;this.removeAttribute("data-open");const t=this.shadowRoot.querySelector(".hamburger");t?.setAttribute("aria-expanded","false"),this.#d(),t&&this.#e?.matches?t.focus():this.lastFocus?.focus?.()}toggleDrawer(){this.getAttribute("data-open")==="true"?this.closeDrawer():this.openDrawer()}#a(t){try{return t?JSON.parse(t):null}catch(a){return console.error("[M5TSideNav] bad JSON:",a),null}}#n(t){return String(t??"").replace(/[&<>"']/g,a=>tr[a])}#s(t){return t?`<span class="ms" aria-hidden="true">${this.#n(t)}</span>`:""}#i(t){if(!t||!t.token)return"";const a=t.token===this.activeToken,n=t.route||"#",o=n.startsWith("#")?n:`#${n}`,s=typeof t.count=="number"&&t.count>0?`<span class="badge">${t.count}</span>`:"";return`
    ...
    <div class="ocb" role="status">
    ...
    </div>`,t.querySelector('[data-ocb="preview"]')?.addEventListener("click",()=>{S.setPreviewAsClient(!S.isPreviewingAsClient()),Kn()}),t.querySelector('[data-ocb="portfolio"]')?.addEventListener("click",()=>{S.setPreviewAsClient(!1),S.setActiveOrg(null)})}function Qn(e){const t=document.getElementById("m5t-side-nav"),a=pt[`/${e}`]||pt[e]||null;t?.setActiveToken(a?.sectionToken||null),ir(a)}function ir(e){const t=document.getElementById("m5t-sub-nav"),a=document.getElementById("app-shell");if(!t)return;const n=e?.children;t.hidden=!1,n&&n.length>1?(t.updateButtons(n.map(o=>({token:o.token,caption:o.caption,enabled:!0,selected:o.token===e.childToken}))),a?.classList.add("has-sub-nav")):(t.updateButtons([]),a?.classList.remove("has-sub-nav"))}function lr(){const e=Ce.getAvailableLanguages&&Ce.getAvailableLanguages()||[];if(e.length<2){d.publish(p.UI_TOAST,{message:"Only one language is available",type:"info"});return}const t=localStorage.getItem(U.FF_SSE_LS_USER_LANG)||U.FF_SSE_I18N_LANG||e[0],a=e[(e.indexOf(t)+1)%e.length];Ce.setLanguage(a),d.publish(p.UI_TOAST,{message:`Language: ${a}`,type:"info"})}function Zn(e){document.documentElement.setAttribute("data-theme",e)}function cr(){const e=localStorage.getItem(U.FF_SSE_LS_THEME),t=e==="dark"||e==="light"?e:window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light";Zn(t)}function dr(){const e=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";Zn(e),localStorage.setItem(U.FF_SSE_LS_THEME,e),d.publish(p.UI_TOAST,{message:e==="dark"?"Dark mode on":"Dark mode off",type:"info"})}function pr(){const e=document.getElementById("m5t-side-nav");if(!e)return;Vt.setAppToken("client-saas"),document.getElementById("app-shell")?.classList.toggle("nav-collapsed",e.getAttribute("data-collapsed")==="true"),e.addEventListener("nav-select",o=>{const s=o.detail?.route;s&&D.navigate(s.startsWith("/")?s:`/${s}`)}),e.addEventListener("logo-click",()=>D.navigate("/home")),e.addEventListener("nav-collapse",o=>{document.getElementById("app-shell")?.classList.toggle("nav-collapsed",!!o.detail?.collapsed)}),e.addEventListener("org-switch",o=>{const s=o.detail?.orgGuid;s&&S.setActiveOrg(s===la?null:s)}),e.addEventListener("footer-action",o=>{switch(o.detail?.action){case"account":D.navigate("/settings");break;case"signout":D.navigate("/signout");break;case"lang":lr();break;case"theme":dr();break}}),document.getElementById("m5t-sub-nav")?.addEventListener("nav-select",o=>{const s=ia[o.detail?.token];s&&D.navigate(s)}),document.addEventListener("language-changed",()=>ta()),ta(),d.subscribe(p.AUTH_SCOPE_LOADED,()=>ta());const a=()=>{const o=S.getScope();return[o?.uiMode,o?.activeOrg?.guid,(o?.managedClients||[]).length,(o?.capabilities||[]).join(","),S.getStoredActiveOrg()].join("|")};let n=a();d.subscribe(p.AUTH_SCOPE_LOADED,()=>{const o=a();o!==n&&(n=o,Ge&&!Aa.has(Ge)&&Kn())})}function ur(e){Ge=e;const t=document.getElementById("m5t-side-nav"),a=document.getElementById("app-shell");if(!t||!a)return;const n=!Aa.has(e);if(t.hidden=!n,a.classList.toggle("has-side-nav",n),n)Qn(e);else{const o=document.getElementById("m5t-sub-nav");o&&(o.hidden=!0),a.classList.remove("has-sub-nav")}Xn()}d.subscribe(p.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&ur(t.route)});const eo=()=>{console.log("[Router] Route: splash"),d.publish(p.ROUTE_NAV_BEFORE,{route:"splash"});const e=Yn();X(e?()=>Promise.resolve().then(()=>_r):()=>Promise.resolve().then(()=>wr),void 0).then(a=>{const n=document.getElementById("app");n.innerHTML=a.render(),a.init&&a.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"splash"})}).catch(a=>{console.error("[Router] Error loading splash route:",a),d.publish(p.ROUTE_NAV_ERROR,{route:"splash",error:a})})};D.on("/",eo);D.on("/splash",eo);D.on("/signin",()=>{console.log("[Router] Route: /signin"),d.publish(p.ROUTE_NAV_BEFORE,{route:"signin"}),X(()=>Promise.resolve().then(()=>Cr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"signin"})}).catch(e=>{console.error("[Router] Error loading signin route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"signin",error:e})})});D.on("/signup",()=>{console.log("[Router] Route: /signup"),d.publish(p.ROUTE_NAV_BEFORE,{route:"signup"}),X(()=>Promise.resolve().then(()=>Or),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"signup"})}).catch(e=>{console.error("[Router] Error loading signup route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"signup",error:e})})});D.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),d.publish(p.ROUTE_NAV_BEFORE,{route:"verf-link"}),X(()=>Promise.resolve().then(()=>Fr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(e=>{console.error("[Router] Error loading verf-link route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"verf-link",error:e})})});D.on("/forgot",()=>{console.log("[Router] Route: /forgot"),d.publish(p.ROUTE_NAV_BEFORE,{route:"forgot"}),X(()=>Promise.resolve().then(()=>Gr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(e=>{console.error("[Router] Error loading forgot route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"forgot",error:e})})});D.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!he("resethash")){oe("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"resethash"}),X(()=>Promise.resolve().then(()=>jr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(e=>{console.error("[Router] Error loading resethash route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"resethash",error:e})})});D.on("/home",()=>{if(console.log("[Router] Route: /home"),!he("home")){oe("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"home"}),X(()=>Promise.resolve().then(()=>ri),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"home"})}).catch(e=>{console.error("[Router] Error loading home route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"home",error:e})})});D.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!he("signout")){oe("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"signout"}),X(()=>Promise.resolve().then(()=>ci),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"signout"})}).catch(e=>{console.error("[Router] Error loading signout route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"signout",error:e})})});const mr=[{path:"/templates",name:"templates",title:"Templates",icon:"content_copy"},{path:"/analytics",name:"analytics",title:"Analytics",icon:"monitoring"},{path:"/ad-accounts",name:"ad-accounts",title:"Ad Accounts",icon:"ads_click"},{path:"/billing",name:"billing",title:"Billing",icon:"receipt_long"},{path:"/settings",name:"settings",title:"Settings",icon:"settings"},{path:"/magnets/drafts",name:"magnets/drafts",title:"Magnets · Drafts",icon:"widgets"},{path:"/magnets/archived",name:"magnets/archived",title:"Magnets · Archived",icon:"widgets"},{path:"/analytics/conversions",name:"analytics/conversions",title:"Analytics · Conversions",icon:"monitoring"},{path:"/settings/workspace",name:"settings/workspace",title:"Settings · Workspace",icon:"settings"},{path:"/settings/integrations",name:"settings/integrations",title:"Settings · Integrations",icon:"settings"},{path:"/settings/security",name:"settings/security",title:"Settings · Security",icon:"settings"}];mr.forEach(({path:e,name:t,title:a,icon:n})=>{D.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!he("home")){oe("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:t}),X(()=>Promise.resolve().then(()=>ui),void 0).then(o=>{const s=document.getElementById("app");s.innerHTML=o.render({title:a,icon:n,name:t}),o.init&&o.init({name:t}),d.publish(p.ROUTE_NAV_AFTER,{route:t})}).catch(o=>{console.error(`[Router] Error loading section route (${t}):`,o),d.publish(p.ROUTE_NAV_ERROR,{route:t,error:o})})})});D.on("/settings/notifications",()=>{if(console.log("[Router] Route: /settings/notifications"),!he("home")){oe("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"settings/notifications"}),X(()=>Promise.resolve().then(()=>yi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"settings/notifications"})}).catch(e=>{console.error("[Router] Error loading settings-notifications route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"settings/notifications",error:e})})});D.on("/settings/integrations",()=>{if(console.log("[Router] Route: /settings/integrations"),!he("home")){oe("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),X(()=>Promise.resolve().then(()=>zi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(e=>{console.error("[Router] Error loading settings-integrations route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"settings/integrations",error:e})})});D.on("/conversations",()=>{if(console.log("[Router] Route: /conversations"),!he("home")){oe("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"conversations"}),X(()=>Promise.resolve().then(()=>Qi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"conversations"})}).catch(e=>{console.error("[Router] Error loading conversations route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"conversations",error:e})})});D.on("/ab-testing",()=>{if(console.log("[Router] Route: /ab-testing"),!he("home")){oe("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"ab-testing"}),X(()=>Promise.resolve().then(()=>ul),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"ab-testing"})}).catch(e=>{console.error("[Router] Error loading ab-testing route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"ab-testing",error:e})})});D.on("/magnets",()=>{if(console.log("[Router] Route: /magnets"),!he("home")){oe("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"magnets"}),X(()=>Promise.resolve().then(()=>mc),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"magnets"})}).catch(e=>{console.error("[Router] Error loading magnets route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"magnets",error:e})})});D.on("/leads",()=>{if(console.log("[Router] Route: /leads"),!he("home")){oe("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"leads"}),X(()=>Promise.resolve().then(()=>Cc),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"leads"})}).catch(e=>{console.error("[Router] Error loading leads route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"leads",error:e})})});D.on("/analytics/ad-performance",()=>{if(console.log("[Router] Route: /analytics/ad-performance"),!he("home")){oe("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"analytics/ad-performance"}),X(()=>Promise.resolve().then(()=>Rc),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"analytics/ad-performance"})}).catch(e=>{console.error("[Router] Error loading ad-performance route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"analytics/ad-performance",error:e})})});D.on("/clients",()=>{if(console.log("[Router] Route: /clients"),!he("home")){oe("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"clients"}),X(()=>Promise.resolve().then(()=>qc),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"clients"})}).catch(e=>{console.error("[Router] Error loading clients route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"clients",error:e})})});D.on("/team",()=>{if(console.log("[Router] Route: /team"),!he("home")){oe("signin");return}d.publish(p.ROUTE_NAV_BEFORE,{route:"team"}),X(()=>Promise.resolve().then(()=>ed),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),d.publish(p.ROUTE_NAV_AFTER,{route:"team"})}).catch(e=>{console.error("[Router] Error loading team route:",e),d.publish(p.ROUTE_NAV_ERROR,{route:"team",error:e})})});D.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),oe("splash")});d.subscribe(p.ROUTE_NAV,(e,t)=>{console.log("[Router] ROUTE_NAV event received:",t),t?.route&&oe(t.route)});function Wa(){console.log("[App] Waiting for Neodigm 55 library...");let e=0;const t=100,a=setInterval(()=>{e++,e%10===0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(a),gr()):e>=t&&(clearInterval(a),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
      ...
      `,d.publish(p.APP_ERROR,{message:"Failed to load authentication library"}))},100)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Wa):Wa();async function gr(){if(console.log("[App] Neodigm 55 loaded, initializing..."),cr(),js(),Ce.initialize(),console.log("[App] I18n Controller initialized"),!await S.init({BASE_URL:"https://machfivemagnet-saas.onrender.com",navigateFunction:a=>{console.log("[AuthController] Navigation requested:",a),oe(a)}})){console.error("[App] AuthController initialization failed");return}const t=S.getEntity();t&&(console.log("[App] Session restored for:",t.email),d.publish(p.APP_USER_LOADED,{entity:t}),S.isAuthenticated()&&S.fetchScope()),d.publish(p.APP_READY,{timestamp:new Date().toISOString(),sessionUser:t}),pr(),D.resolve(),window.AuthController=S,window.I18nController=Ce,window.MachVive=Sa,console.log("[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)")}d.subscribe(p.ROUTE_NAV_AFTER,(e,t)=>{typeof Ce<"u"&&Ce.refresh&&setTimeout(()=>{Ce.refresh()},100)});let Ya=!1;function hr(){if(Ya)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
    .accept-invite-page {
  ...
  `,document.head.appendChild(e),Ya=!0}function fr(){const e=new URLSearchParams(window.location.search||"");let t=e.get("uid")||"",a=e.get("token")||"";if(!t||!a){const n=window.location.hash||"",o=n.includes("?")?n.slice(n.indexOf("?")+1):"",s=new URLSearchParams(o);if(t=t||s.get("uid")||"",a=a||s.get("token")||"",!t||!a){const r=n.replace(/^#\/?/,"").split("?")[0].split("/").filter(Boolean);t=t||r[1]||"",a=a||r[2]||""}}try{return{uid:decodeURIComponent(t),token:decodeURIComponent(a)}}catch{return{uid:t,token:a}}}function to(){return hr(),`
    ...
    </div>`}function ao(){const{uid:e,token:t}=fr(),a=document.getElementById("accept-invite-form"),n=document.getElementById("ai-pass"),o=document.getElementById("ai-confirm"),s=document.getElementById("ai-submit"),r=document.getElementById("ai-msg");if(!a)return;const i=(l,c="error")=>{r.textContent=l,r.className=`accept-invite-msg ${c}`};if(!e||!t){i("This invitation link is invalid or incomplete. Please use the link from your email."),s.disabled=!0;return}a.addEventListener("submit",async l=>{l.preventDefault();const c=n.value||"",h=o.value||"";if(c.length<8){i("Password must be at least 8 characters.");return}if(c!==h){i("Passwords do not match.");return}s.disabled=!0,i("Setting up your account…","ok");try{const w=S.getConfig?.().BASE_URL||"",y=await fetch(`${w}/m5t/v5/acctEntity/acceptInvite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({uid:e,token:t,password:c})}),u=await y.json().catch(()=>({}));if(!y.ok||!u.ok){const m=y.status===410?"This invitation has expired. Ask for a new one.":y.status===409?"This invitation has already been used. Try signing in.":u.error||`Could not accept the invitation (HTTP ${y.status}).`;i(m),s.disabled=!1;return}try{window.history.replaceState({},"",window.location.pathname+window.location.hash)}catch{}i("Welcome! Signing you in…","ok"),(await S.doSignin(u.entity.email,c))?.ok||(i("Your account is ready. Please sign in.","ok"),setTimeout(()=>{window.location.hash="#/signin"},1200))}catch(w){console.error("[accept-invite] error:",w),i("Something went wrong. Please try again."),s.disabled=!1}})}const vr={render:to,init:ao},_r=Object.freeze(Object.defineProperty({__proto__:null,default:vr,init:ao,render:to},Symbol.toStringTag,{value:"Module"}));function br(){return`
  ...
  `}function yr(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const e=localStorage.getItem(U.FF_SSE_LS_TOKEN),t=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!e,hasMvvTs:!!t});const a=document.getElementById("splash-loader"),n=document.getElementById("splash-actions");e?(console.log("[SplashRoute] Auth token found → HOME"),d.publish(p.ROUTE_NAV,{route:"home"})):t?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),d.publish(p.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),a&&(a.style.display="none"),n&&(n.style.display="flex"),document.querySelectorAll("[data-route]").forEach(s=>{s.addEventListener("click",()=>{const r=s.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${r}`),d.publish(p.ROUTE_NAV,{route:r})})}))},4e3)}const wr=Object.freeze(Object.defineProperty({__proto__:null,init:yr,render:br},Symbol.toStringTag,{value:"Module"}));function re(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}const xr=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;function ka(e,t){return e?xr.test(e)?!0:(re(t,I.get("validation_email_invalid")),!1):(re(t,I.get("validation_email_required")),!1)}function Er(){return`
  ...
  `}function Sr(){console.log("[SigninRoute] Initialized");const e=document.getElementById("loginForm"),t=document.getElementById("email"),a=document.getElementById("password"),n=document.getElementById("togglePassword"),o=document.getElementById("rememberEmail"),s=localStorage.getItem(S.CONFIG.LS_KEYS.REMEMBERED_EMAIL);s&&t&&o&&(t.value=s,o.checked=!0,a?.focus()),n?.addEventListener("click",()=>{const i=a.type==="password"?"text":"password";a.type=i}),e?.addEventListener("submit",async i=>{i.preventDefault();const l=t.value.trim(),c=a.value;ka(l,t)&&Ar(c,a)&&(o?.checked?localStorage.setItem(S.CONFIG.LS_KEYS.REMEMBERED_EMAIL,l):localStorage.removeItem(S.CONFIG.LS_KEYS.REMEMBERED_EMAIL),await kr(l,c))}),document.getElementById("link--uc__underline")?.addEventListener("click",i=>{i.preventDefault(),d.publish(p.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",i=>{i.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),d.publish(p.ROUTE_NAV,{route:"signup"})})}function Ar(e,t){return e?e.length<10?(re(t,I.get("validation_password_min_length")),!1):!0:(re(t,I.get("validation_password_required")),!1)}async function kr(e,t){const a=document.querySelector(".btn");a.disabled=!0,a.textContent=I.get("loading_signing_in");try{const n=await S.doSignin(e,t);n.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(I.get("success_welcome_back"),"success"),d.publish(p.AUTH_SIGNIN_SUCCESS,{entity:S.getEntity()})):n.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q(I.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(n.error||I.get("error_signin_failed"),"danger"),a.disabled=!1,a.textContent=(I.get("sign_in")||"Sign in").toUpperCase())}catch(n){console.error("[SigninRoute] Sign in error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||I.get("error_network"),"danger"),a.disabled=!1,a.textContent=(I.get("sign_in")||"Sign in").toUpperCase(),d.publish(p.AUTH_SIGNIN_FAIL,{message:n.message})}}const Cr=Object.freeze(Object.defineProperty({__proto__:null,init:Sr,render:Er},Symbol.toStringTag,{value:"Module"}));function no(e){const t=[];return e.length<12&&t.push("at least 12 characters"),e.length>1024&&t.push("at most 1024 characters"),/[a-z]/.test(e)||t.push("1 lowercase"),/[A-Z]/.test(e)||t.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(e)||t.push("1 special character"),/[^\x00-\x7F]/.test(e)&&t.push("ASCII characters only"),t}function oo(e){return e.length===0?"":e.includes("ASCII characters only")?"Password cannot contain emoji|or special unicode characters":e.includes("at least 10 characters")?"Password must have at least|10 characters":"Password must have: Uppercase,|Lowercase, and Special Character"}const Tr="2026-07-15";function Ir(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function $r(){console.log("[SignupRoute] Initialized");const e=document.getElementById("signupForm"),t=e.querySelector('button[type="submit"]');Ja("togglePassword","password","eyeIcon"),Ja("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),d.publish(p.ROUTE_NAV,{route:"signin"})}),e.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),s=document.getElementById("last").value.trim(),r=document.getElementById("email").value.trim(),i=document.getElementById("company").value.trim(),l=document.getElementById("phone").value.trim(),c=document.getElementById("password").value,h=document.getElementById("confirmPassword").value,w=document.getElementById("first"),y=document.getElementById("last"),u=document.getElementById("email"),x=document.getElementById("password"),m=document.getElementById("confirmPassword");if(!Ka(o,w,I.get("validation_first_name_required"))||!Ka(s,y,I.get("validation_last_name_required"))||!ka(r,u)||!Lr(c,x))return;if(c!==h){re(m,I.get("validation_password_mismatch"));return}const f=document.getElementById("acceptTerms");if(!f.checked){re(f,"Please accept the Terms of Service and Privacy Policy to continue.");return}t.disabled=!0,t.textContent=I.get("loading_creating_account"),await Nr(o,s,r,i,l,c)})}function Ja(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function Ka(e,t,a){return e?!0:(re(t,a),!1)}function Lr(e,t){if(!e)return re(t,I.get("validation_password_required")),!1;const a=no(e);return a.length>0?(re(t,oo(a)),!1):!0}async function Nr(e,t,a,n,o,s){const r=document.querySelector('button[type="submit"]');try{const i={email:a,password:s,first:e,last:t};n&&(i.company=n),o&&(i.phone=o),i.terms_accepted=!0,i.legal_version=Tr;const l=await S.doSignup(i);if(l.ok)d.publish(p.AUTH_SIGNUP_SUCCESS,{email:a}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const c=l.error||l.message||I.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(c,"danger"),r.disabled=!1,r.textContent=(I.get("create_account")||"Create account").toUpperCase(),d.publish(p.AUTH_SIGNUP_FAIL,{message:c})}}catch(i){console.error("[SignupRoute] Sign up error:",i),typeof neodigmToast<"u"&&neodigmToast.q(i.message||I.get("error_network"),"danger"),r.disabled=!1,r.textContent=(I.get("create_account")||"Create account").toUpperCase(),d.publish(p.AUTH_SIGNUP_FAIL,{message:i.message})}}const Or=Object.freeze(Object.defineProperty({__proto__:null,init:$r,render:Ir},Symbol.toStringTag,{value:"Module"}));function Rr(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function Hr(){console.log("[ForgotRoute] Initialized");const e=document.getElementById("forgot-form"),t=document.getElementById("email");e?.addEventListener("submit",async a=>{a.preventDefault();const n=t.value.trim();ka(n,t)&&await zr(n)})}async function zr(e){const t=document.querySelector(".btn");t.disabled=!0,t.textContent="SENDING...";try{const a=await Br.forgotPassword(e);a.ok&&a.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q(I.get("success_reset_link_sent"),"success"),d.publish(p.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(a.data.error||I.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=(I.get("send_reset_link")||"Send reset link").toUpperCase())}catch(a){console.error("[ForgotRoute] Forgot password error:",a),typeof neodigmToast<"u"&&neodigmToast.q(a.message||I.get("error_network"),"danger"),t.disabled=!1,t.textContent=(I.get("send_reset_link")||"Send reset link").toUpperCase()}}const Gr=Object.freeze(Object.defineProperty({__proto__:null,init:Hr,render:Ur},Symbol.toStringTag,{value:"Module"}));function Vr(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function qr(){console.log("[ResethashRoute] Initialized");const e=document.getElementById("resethash-form"),t=e.querySelector('button[type="submit"]');Xa("toggleNewPassword","new-password","eyeIconNew"),Xa("toggleConfirmPassword","confirm-password","eyeIconConfirm"),e?.addEventListener("submit",async a=>{a.preventDefault();const n=e.email.value.trim(),o=e.newPassword.value,s=e.confirmPassword.value,r=document.getElementById("new-password"),i=document.getElementById("confirm-password");if(!o){re(r,I.get("validation_new_password_required"));return}const l=no(o);if(l.length>0){re(r,oo(l));return}if(!s){re(i,I.get("validation_new_password_required"));return}if(o!==s){re(i,I.get("validation_password_mismatch"));return}t.disabled=!0,t.textContent=I.get("loading_resetting_password");try{const c=await S.doResetHash(n,o);c.ok?(typeof neodigmToast<"u"&&neodigmToast.q(I.get("success_password_reset"),"success"),d.publish(p.AUTH_RESETHASH_SUCCESS,{email:n})):(re(r,c.error||I.get("error_signin_failed")),t.disabled=!1,t.textContent=(I.get("update_password")||"Update password").toUpperCase())}catch(c){console.error("[ResethashRoute] Reset password error:",c),re(r,c.message||I.get("error_network")),t.disabled=!1,t.textContent=(I.get("update_password")||"Update password").toUpperCase()}})}function Xa(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}const jr=Object.freeze(Object.defineProperty({__proto__:null,init:qr,render:Vr},Symbol.toStringTag,{value:"Module"})),te=()=>S.getManagedClients().length>0&&!S.getStoredActiveOrg(),Me=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),Wr={reseller_org:"Your org",managed_client:"Client",saas_org:"Org"};let Qa=!1;function nt(){if(Qa)return;const e=document.createElement("style");e.id="m5t-portfolio-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Qa=!0}const Za=e=>e.toISOString().slice(0,10);async function Yr(e,{days:t=30}={}){const a=new Date,n=Za(new Date(a.getTime()-(t-1)*864e5)),o=Za(a),s=await fetch(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${o}&group_by=owner`);if(!s.ok)throw new Error(`HTTP ${s.status}`);const r=await s.json();if(!r.ok)throw new Error("stats not ok");return r.by_owner||[]}function so(e,t){return`<div class="dash-clients-scroll"><table class="dash-clients">
    <thead><tr>
      <th>Client</th>${t.map(a=>`<th>${a.h}</th>`).join("")}<th></th>
    </tr></thead>
    <tbody>${e.map(a=>`
      <tr data-org="${Me(a.owner_guid)}" tabindex="0" role="button"
          aria-label="Open ${Me(a.name||"client")}">
        <td><span class="dc-name">${Me(a.name||a.owner_guid)}
          <span class="dc-chip">${Me(Wr[a.channel]||a.channel||"")}</span></span></td>
        ${t.map(n=>`<td>${n.td(a)}</td>`).join("")}
        <td><span class="dc-view">View →</span></td>
      </tr>`).join("")}</tbody>
  </table></div>`}function Jr(e){let t=e.querySelector(".pf-access-error");t||(t=document.createElement("div"),t.className="pf-access-error",e.prepend(t)),t.textContent="You don't have direct access to manage this org. Use the admin console to act on its behalf."}function ro(e){if(!e)return;const t=async a=>{const n=a?.dataset?.org;if(!n)return;(await S.setActiveOrg(n))?.activeOrgError&&Jr(e)};e.querySelectorAll("tbody tr[data-org]").forEach(a=>{a.addEventListener("click",()=>t(a)),a.addEventListener("keydown",n=>{(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),t(a))})})}const ca=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function gt({section:e,title:t,description:a}){return nt(),`
    <div class="page-shell" data-section="${Me(e)}">
      <div class="page-header">
        <div class="page-header-text">
          <h1 class="page-title">${Me(t)}</h1>
          <p class="page-description">${Me(a)}</p>
        </div>
      </div>
    ...
    </div>`}async function ot(e,t,{emptyMsg:a}={}){const n=document.getElementById("pf-picker-body");if(n)try{const o=await Yr(e);if(!o.length){n.innerHTML=ca("groups",a||"No client orgs yet. Create one under Clients first.");return}n.innerHTML=so(o,t),ro(n)}catch(o){console.warn("[portfolio] picker load failed:",o),n.innerHTML=ca("error","Could not load your clients. Please refresh.")}}function io(){const e={};return S.getManagedClients().forEach(t=>{e[t.orgGuid]=t.name}),S.getMemberships().forEach(t=>{t.orgGuid&&!e[t.orgGuid]&&(e[t.orgGuid]=t.name||"")}),e}const lo=e=>e?`<span class="pf-client-chip">${Me(e)}</span>`:"",pe=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,ue=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),W=e=>Number(e||0).toLocaleString(),co=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",Kr=e=>(co(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function Xr(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric"})}catch{return""}}function Qr(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}let en=!1;function Zr(){if(en)return;const e=document.createElement("style");e.id="m5t-dash-recent-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),en=!0}function ei(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${ue(Kr(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${ue(co(e))}</span>
      <span class="recent-lead__sub">${ue(e.email||e.phone||"")}</span>
    </span>
    <span class="recent-lead__badge" data-s="${ue(e.status)}">${ue(e.status)}</span>
    <span class="recent-lead__time">${ue(Xr(e))}</span>
  </a>`}const ct=({icon:e,label:t,valueId:a,value:n="—",subId:o,sub:s="",href:r})=>{const i=r?"a":"div",l=r?` href="${ue(r)}" class="stat-card stat-card--link"`:' class="stat-card"';return`
  <${i}${l}>
  ...
  </${i}>`},_t=(e,t,a,{wide:n=!1,full:o=!1,controls:s=!1}={})=>`
  <div class="dashboard-card${n?" chart-card-wide":""}${o?" chart-card-full":""}">
    ...
    <div class="card-body" id="${a}">${pe("hourglass_empty","Loading…")}</div>
  </div>`;let da=30;function po(){Zr(),nt();const e=te();return`
    <div class="page-shell" data-section="home">
      ...
      <div class="dashboard-card" style="margin-bottom:24px">
        ...
        <div class="card-body" id="dash-portfolio">${pe("hourglass_empty","Loading…")}</div>
      </div>`:""}

      <div class="stats-grid">
        ${ct({icon:"widgets",label:"Active Magnets",valueId:"stat-active-magnets",subId:"stat-active-magnets-sub",sub:"Loading…",href:"#/magnets"})}
        ${ct({icon:"ads_click",label:"Magnet Opens",valueId:"stat-opens",subId:"stat-opens-sub",sub:"Loading…"})}
        ${ct({icon:"person_add",label:"Leads Captured",valueId:"stat-leads",subId:"stat-leads-sub",sub:"Loading…"})}
        ${ct({icon:"check_circle",label:"Completion Rate",valueId:"stat-completion",subId:"stat-completion-sub",sub:"Loading…"})}
      </div>

      <div class="charts-section">
        ${_t("show_chart","Opens & Leads","dash-trend",{wide:!0,controls:!0})}
        <div class="charts-grid">
          ${_t("filter_alt","Completion Funnel","dash-funnel")}
          ${_t("source","Top Campaigns","dash-campaigns")}
          ${_t("touch_app","CTA Usage","dash-routes",{full:!0})}
        </div>
      </div>
      ...
      <div class="content-grid">
        ...
        <div class="dashboard-card">
          ...
          <div class="card-body" id="recent-leads-body">
            ${pe("hourglass_empty","Loading leads…")}
          </div>
        </div>
      </div>
    </div>`}async function uo(){const e=S.getConfig?.().BASE_URL||"";document.getElementById("dash-periods")?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(da=Number(a.dataset.days)||30,document.querySelectorAll("#dash-periods .chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===da)),an(e))}),await Promise.all([an(e),ni(e)])}const Ee=(e,t)=>{const a=document.getElementById(e);a&&(a.textContent=t)},Je=(e,t)=>{const a=document.getElementById(e);a&&(a.innerHTML=t)},tn=e=>e.toISOString().slice(0,10);async function an(e){const t=new Date,a=tn(new Date(t.getTime()-(da-1)*864e5)),n=tn(t),o=te();let s;try{const C=await fetch(`${e}/m5t/v5/dashboard/stats?from=${a}&to=${n}${o?"&group_by=owner":""}`);if(!C.ok)throw new Error(`HTTP ${C.status}`);if(s=await C.json(),!s.ok)throw new Error("stats not ok")}catch(_){console.warn("[dashboard] stats fetch failed:",_),["stat-active-magnets","stat-opens","stat-leads","stat-completion"].forEach(C=>Ee(C,"—")),["stat-active-magnets-sub","stat-opens-sub","stat-leads-sub","stat-completion-sub"].forEach(C=>Ee(C,"Unavailable")),["dash-trend","dash-funnel","dash-campaigns","dash-routes","dash-interactions","dash-portfolio"].forEach(C=>Je(C,pe("error","Could not load. Please refresh.")));return}o&&ti(s.by_owner||[]),Ee("stat-active-magnets",W(s.magnets.active)),Ee("stat-active-magnets-sub",s.magnets.total>s.magnets.active?`${W(s.magnets.total-s.magnets.active)} paused`:s.magnets.active?"All running":"No magnets yet");const r=s.funnel||{};Ee("stat-opens",r.opens?W(r.opens):"—"),Ee("stat-opens-sub",r.opens?r.engagement_rate!=null?`${r.engagement_rate}% engage`:`${W(r.engaged)} engaged`:"No opens in this range yet");const i=s.leads||{};Ee("stat-leads",W(i.total));const l=(i.this_week||0)-(i.prev_week||0);Ee("stat-leads-sub",i.total?`${W(i.this_week)} this week (${l>=0?"+":""}${W(l)} vs last)`:"No leads yet"),Ee("stat-completion",r.completion_rate!=null?`${r.completion_rate}%`:"—"),Ee("stat-completion-sub",r.opens?`${W(r.completions)} completed of ${W(r.opens)} opens`:"Appears once magnets get opened");const c=s.by_day||[],h=c.some(_=>_.opens||_.leads);Je("dash-trend",h?oi(c):pe("show_chart","No activity in this range yet. Opens and leads chart here as visitors engage your magnets.")),Je("dash-funnel",r.opens?ai(r):pe("filter_alt","The funnel fills in once your magnets record opens."));const w=s.top_campaigns||[];Je("dash-campaigns",w.length?`<div class="dash-list">${w.map(_=>`
        <div class="dash-list__row">
          ...
          <span class="dash-list__main" title="${ue(_.campaign)}">${ue(_.campaign)}</span>
          <span class="dash-list__num">${W(_.leads)}</span>
        </div>`).join("")}</div>`:pe("source","No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here."));const y={book:["event","Book"],chat:["chat","Chat"],call:["phone_in_talk","Call"],email:["mail","Email"],support:["support_agent","Support"]},u=Object.entries(r.routes||{}).sort((_,C)=>C[1]-_[1]),x=u.length?u[0][1]:0;Je("dash-routes",u.length?`<div class="dash-funnel">${u.map(([_,C])=>{const[L,M]=y[_]||["touch_app",_];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${L}</span> ${ue(M)}</span><span class="dash-funnel__val">${W(C)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${x?Math.max(4,Math.round(C/x*100)):0}%"></div></div>
        </div>`}).join("")}</div>`:pe("touch_app","CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar."));const m={open:["visibility","Magnet opened"],engage:["touch_app","Visitor engaged"],route:["alt_route","Picked a channel"],complete:["check_circle","Completed: lead captured"]},f=s.recent_events||[];Je("dash-interactions",f.length?`<div class="dash-list">${f.map(_=>{const[C,L]=m[_.event]||["sensors",_.event],M=_.event==="route"&&_.detail?` · ${ue(_.detail)}`:"";return`<div class="dash-list__row">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">${C}</span></span>
          <span class="dash-list__main">${L}${M}</span>
          ${_.display_mode?`<span class="dash-list__mode">${ue(_.display_mode)}</span>`:""}
          <span class="dash-list__time">${ue(Qr(_.at))}</span>
        </div>`}).join("")}</div>`:pe("sensors","No interactions yet. They'll stream in as visitors engage your magnets."))}function ti(e){const t=document.getElementById("dash-portfolio");if(!t)return;if(!e.length){t.innerHTML=pe("groups","No client orgs yet. Create one under Clients to see its numbers here.");return}const a=e.some(s=>s.ad),n=s=>{const r=(s.leads.this_week||0)-(s.leads.prev_week||0);return!s.leads.this_week&&!s.leads.prev_week?"":` <span class="${r>=0?"dc-delta-up":"dc-delta-down"}">(${r>=0?"+":""}${W(r)})</span>`},o=[{h:"Magnets",td:s=>`${W(s.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${W(s.magnets.total)}</span>`},{h:"Leads · wk",td:s=>`${W(s.leads.this_week)}${n(s)}`},{h:"Leads · total",td:s=>W(s.leads.total)},{h:"Opens",td:s=>W(s.opens)},{h:"Compl.",td:s=>s.completion_rate!=null?`${s.completion_rate}%`:"—"},...e.some(s=>s.booked)?[{h:"Booked",td:s=>s.booked?W(s.booked):"—"}]:[],...e.some(s=>s.called)?[{h:"Called",td:s=>s.called?W(s.called):"—"}]:[],...a?[{h:"Spend",td:s=>s.ad?`$${W(s.ad.spend)}`:"—"},{h:"CPL",td:s=>s.ad?.cost_per_lead!=null?`$${W(s.ad.cost_per_lead)}`:"—"}]:[]];t.innerHTML=so(e,o),ro(t)}function ai(e){const t=[["Opened",e.opens,""],["Engaged",e.engaged," dash-funnel__bar--mid"],["Completed",e.completions," dash-funnel__bar--end"],...e.booked?[["Booked",e.booked," dash-funnel__bar--end"]]:[],...e.called?[["Called",e.called," dash-funnel__bar--end"]]:[]],a=Math.max(1,e.opens||0),n=o=>Math.min(100,Math.round((o||0)/a*100));return`<div class="dash-funnel">${t.map(([o,s,r])=>`
    ...
    </div>`).join("")}</div>`}async function ni(e){const t=document.getElementById("recent-leads-body");if(t)try{const a=await fetch(`${e}/m5t/v5/m5mLead`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json(),o=(Array.isArray(n?.data)?n.data:[]).filter(s=>!["DELETED","ARCHIVED"].includes(s.status));t.innerHTML=o.length?o.slice(0,5).map(ei).join(""):pe("contacts","No leads captured yet. Publish a magnet to start collecting.")}catch(a){console.warn("[dashboard] Leads fetch failed:",a),t.innerHTML=pe("error","Could not load recent leads.")}}function nn(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}const on=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e));function oi(e){const u=e.length||1,x=nn(Math.max(1,...e.map(k=>k.opens||0))),m=nn(Math.max(1,...e.map(k=>k.leads||0))),f=748/u,_=Math.min(22,f*.55),C=k=>46+f*(k+.5),L=k=>266-k/x*248,M=k=>266-k/m*248,ee=[0,.5,1].map(k=>{const R=266-k*248;return`<line x1="46" y1="${R.toFixed(1)}" x2="794" y2="${R.toFixed(1)}" stroke="#EAF0F7"/><text x="38" y="${(R+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${on(x*k)}</text><text x="802" y="${(R+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${on(m*k)}</text>`}).join(""),Q=e.map((k,R)=>{const xe=L(k.opens||0);return`<rect x="${(C(R)-_/2).toFixed(1)}" y="${xe.toFixed(1)}" width="${_.toFixed(1)}" height="${Math.max(0,266-xe).toFixed(1)}" rx="3" fill="#0072BA" opacity="0.85"><title>${k.date}: ${k.opens} opens</title></rect>`}).join(""),se=e.map((k,R)=>`${C(R).toFixed(1)},${M(k.leads||0).toFixed(1)}`).join(" "),ye=u>1?`<polyline points="${se}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",fe=e.map((k,R)=>`<circle cx="${C(R).toFixed(1)}" cy="${M(k.leads||0).toFixed(1)}" r="3.2" fill="#009473"><title>${k.date}: ${k.leads} leads</title></circle>`).join(""),we=Math.max(1,Math.ceil(u/6)),Te=e.map((k,R)=>R%we===0||R===u-1?`<text x="${C(R).toFixed(1)}" y="288" text-anchor="middle" class="dash-ax">${k.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="dash-chart" viewBox="0 0 840 300" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Magnet opens versus leads over time">
      ${ee}${Q}${ye}${fe}${Te}
    </svg>`}const si={render:po,init:uo},ri=Object.freeze(Object.defineProperty({__proto__:null,default:si,init:uo,render:po,statCard:ct},Symbol.toStringTag,{value:"Module"}));function ii(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/home" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function li(){console.log("[SignoutRoute] Initialized");const e=document.getElementById("confirm-signout-btn");e?.addEventListener("click",async()=>{e.disabled=!0,e.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await S.doSignout()})}const ci=Object.freeze(Object.defineProperty({__proto__:null,init:li,render:ii},Symbol.toStringTag,{value:"Module"}));let sn=!1;function di(){if(sn)return;const e=document.createElement("style");e.id="m5t-section-page-styles",e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),sn=!0}function mo({title:e="Section",icon:t="widgets",name:a=""}={}){return di(),`
    ...
    </section>`}function go(){}const pi={render:mo,init:go},ui=Object.freeze(Object.defineProperty({__proto__:null,default:pi,init:go,render:mo},Symbol.toStringTag,{value:"Module"})),mi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},be=e=>String(e??"").replace(/[&<>"']/g,t=>mi[t]),me=(e,t="info")=>{try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Ve=()=>S.getConfig?.().BASE_URL||"",gi=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,Nt=5,le={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},pa=()=>S.getActiveOrg()?.guid||S.getMemberships()[0]?.orgGuid||null;let rn=!1;function hi(){if(rn)return;const e=document.createElement("style");e.id="m5t-notif-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),rn=!0}const Ca=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function ho(){return hi(),nt(),te()?gt({section:"settings-notifications",title:"Notifications",description:"Pick a client to manage their lead alerts."}):`
    <div class="page-shell" data-section="settings-notifications">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="ntf-body">${Ca("hourglass_empty","Loading…")}</div>
      </div>
    ...
    </div>`}async function fo(){if(te()){const e=t=>Number(t||0).toLocaleString();return ot(Ve(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Promise.all([fi(),vo()])}async function vo(){const e=pa();if(e)try{const t=await fetch(`${Ve()}/m5t/v5/acctGroup/${encodeURIComponent(e)}/webhook`);if(t.status===403){le.webhookAllowed=!1;return}const a=await t.json().catch(()=>({}));if(!a.ok)return;le.webhook=a.webhook,_o()}catch{}}function ln(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function _o(){const e=document.getElementById("ntf-wh-card"),t=document.getElementById("ntf-wh-body");if(!e||!t)return;e.style.display="";const a=le.webhook,n=a?.last_delivery;t.innerHTML=`
    <div class="ntf-wh">
      ...
      <input class="ntf-input" id="ntf-wh-url" type="url" placeholder="https://hooks.zapier.com/hooks/catch/…" value="${be(a?.uri||"")}" />
      ...
      <div class="ntf-wh__row">
        ...
        <span class="ntf-wh__status">${n?n.ok?`Last delivery: <span class="ok">delivered</span> ${be(ln(n.tz))}`:`Last delivery: <span class="bad">failed</span> ${be(ln(n.tz))} (${be(n.error||"")})`:""}</span>
      </div>
    </div>`,t.querySelector("#ntf-wh-save")?.addEventListener("click",async()=>{const o=t.querySelector("#ntf-wh-url")?.value.trim()||"",s=t.querySelector("#ntf-wh-secret")?.value??"",r={uri:o};s.trim()!==""&&(r.secret=s.trim());try{const i=await fetch(`${Ve()}/m5t/v5/acctGroup/${encodeURIComponent(pa())}/webhook`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),l=await i.json().catch(()=>({}));if(!i.ok||!l.ok)throw new Error(l.error||`Failed (HTTP ${i.status})`);le.webhook=l.webhook,me(o?"Webhook saved":"Webhook removed","success"),_o()}catch(i){me(i.message||"Could not save","danger")}}),t.querySelector("#ntf-wh-test")?.addEventListener("click",async o=>{const s=o.currentTarget;s.disabled=!0;try{const r=await fetch(`${Ve()}/m5t/v5/acctGroup/${encodeURIComponent(pa())}/webhook-test`,{method:"POST"}),i=await r.json().catch(()=>({}));r.ok&&i.ok?me("Test delivery sent","success"):me(i.error||"Could not deliver the test","danger")}catch{me("Could not deliver the test","danger")}finally{s.disabled=!1}try{await vo()}catch(r){console.warn("[notifications] loadWebhook refresh failed:",r)}})}async function fi(){const e=document.getElementById("ntf-body");if(e){try{const a=await(await fetch(`${Ve()}/m5t/v5/magnets`)).json().catch(()=>({}));if(!a.ok)throw new Error(a.message||"Failed to load");le.magnets=(a.magnets||[]).filter(n=>n.status!=="ARCHIVED"),le.canManage=!!a.canManage}catch(t){console.warn("[notifications] load failed:",t),e.innerHTML=Ca("error","Could not load your magnets. Please try again.");return}bo()}}function vi(e){const t=Array.isArray(e.notify_emails)?e.notify_emails:[],a=t.length>0;return`
    <div class="ntf-row" data-guid="${be(e.guid)}">
      <div class="ntf-magnet">
        <div class="ntf-name" title="${be(e.name)}">${be(e.name)}</div>
        <div class="ntf-meta">${be((e.domains||[]).join(", ")||e.status)}</div>
      ...
      <div class="ntf-config">
        ${t.length?`<div class="ntf-chips">${t.map(n=>`
              <span class="ntf-chip">${be(n)}${le.canManage?`<button type="button" data-remove="${be(n)}" aria-label="Remove ${be(n)}">&times;</button>`:""}</span>`).join("")}</div>`:'<div class="ntf-none">No alert emails.</div>'}
        ${le.canManage?`
        <div class="ntf-addrow">
          <input class="ntf-input" type="email" placeholder="name@business.com" aria-label="Add alert email" ${t.length>=Nt?"disabled":""} />
          <button class="ntf-btn" type="button" data-add ${t.length>=Nt?"disabled":""}>
    ...
    </div>`}function bo(){const e=document.getElementById("ntf-body");if(e){if(!le.magnets.length){e.innerHTML=Ca("widgets","No magnets yet. Create one under Your Magnets first.");return}e.innerHTML=le.magnets.map(vi).join(""),e.querySelectorAll(".ntf-row").forEach(t=>{const a=t.dataset.guid,n=t.querySelector(".ntf-input"),o=()=>{const s=(n?.value||"").trim().toLowerCase();if(!s)return;if(!gi.test(s)){me("That does not look like an email address","danger");return}const i=[...le.magnets.find(l=>l.guid===a).notify_emails||[]];if(i.includes(s)){me("Already added","info");return}if(i.length>=Nt){me(`Up to ${Nt} emails per magnet`,"info");return}cn(a,[...i,s])};t.querySelector("[data-add]")?.addEventListener("click",o),n?.addEventListener("keydown",s=>{s.key==="Enter"&&o()}),t.querySelectorAll("[data-remove]").forEach(s=>s.addEventListener("click",()=>{const r=le.magnets.find(i=>i.guid===a);cn(a,(r.notify_emails||[]).filter(i=>i!==s.dataset.remove))})),t.querySelector("[data-test]")?.addEventListener("click",()=>_i(a,t.querySelector("[data-test]")))})}}async function cn(e,t){try{const a=await fetch(`${Ve()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({notify_emails:t})}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||n.message||`Failed (HTTP ${a.status})`);const o=le.magnets.find(s=>s.guid===e);o&&(o.notify_emails=t),me("Alert emails updated","success")}catch(a){console.warn("[notifications] save failed:",a),me(a.message||"Could not save","danger");return}try{bo()}catch(a){console.error("[notifications] renderBody after save failed:",a)}}async function _i(e,t){t&&(t.disabled=!0);try{const a=await fetch(`${Ve()}/m5t/v5/magnets/${encodeURIComponent(e)}/notify-test`,{method:"POST"}),n=await a.json().catch(()=>({}));a.ok&&n.ok?me("Test alert sent","success"):me(n.error||"Could not send the test","danger")}catch{me("Could not send the test","danger")}finally{t&&(t.disabled=!1)}}const bi={render:ho,init:fo},yi=Object.freeze(Object.defineProperty({__proto__:null,default:bi,init:fo,render:ho},Symbol.toStringTag,{value:"Module"})),wi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ce=e=>String(e??"").replace(/[&<>"']/g,t=>wi[t]),Z=(e,t="info")=>{try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}},de=()=>S.getConfig?.().BASE_URL||"",P={providers:null,configured:null,denied:!1,busy:!1,autoOpenPicker:!1},Ta=()=>S.getActiveOrg()?.guid||S.getMemberships()[0]?.orgGuid||null;let dn=!1;function xi(){if(dn)return;const e=document.createElement("style");e.id="m5t-intg-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),dn=!0}const ua=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,et=(e,t="")=>`<div class="intg-alert ${t}"><span class="material-symbols-outlined" aria-hidden="true">${t==="error"?"error":"info"}</span><span>${e}</span></div>`;function Ei(){return xi(),nt(),te()?gt({section:"settings-integrations",title:"Integrations",description:"Pick a client to manage their connections."}):`
    <div class="page-shell" data-section="settings-integrations">
      ...
      <div id="intg-body">
        ...
        <button type="button" class="intg-btn danger" id="intg-g-disconnect"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`):(o=`<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>${ce(a.connect_status==="NEEDS_REAUTH"?"Reconnect needed":"Connection error")}</span>`,s="The connection stopped working. Reconnect to resume daily metric refreshes.",r=`
    ...
    </div>`}function Ci(){const e=Ta(),t=P.providers?.calendly||[],a=t.find(l=>l.owner_guid===e)||t[0]||null,n=!!P.configured?.calendly;let o='<span class="intg-state">Not connected</span>',s="Connect Calendly and your magnets book real meetings: the Book button opens your calendar in the conversation, and confirmed bookings land on the lead automatically.",r="",i="";if(!n)o='<span class="intg-state">Not available yet</span>',s="Calendly booking is being set up for this platform.";else if(!a)r='<button type="button" class="intg-btn primary" id="intg-c-connect"><span class="material-symbols-outlined" aria-hidden="true">link</span>Connect</button>';else{const l=a.external_account||{};if(a.connect_status==="ACTIVE"){o='<span class="intg-state on"><span class="material-symbols-outlined" aria-hidden="true">check</span>Connected</span>',s=`Connected as <b>${[l.name,l.email&&`(${l.email})`].filter(Boolean).map(ce).join(" ")||"your Calendly account"}</b>. Turn on Calendly booking per magnet under Magnets, in the Book call-to-action.`,r=`
        <button type="button" class="intg-btn danger" id="intg-c-disconnect"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`;const w=a.webhook||{};if(w.state==="active"){const y=w.last_received_tz?` Last booking received ${ce(String(w.last_received_tz).slice(0,10))}.`:"";i=et(`Booking sync is on. Confirmed and canceled meetings update the lead automatically.${y}`)}else i=et("Booking sync is off: webhooks need a paid Calendly plan. Visitors can still book in the magnet; bookings just will not appear on the lead automatically. Reconnect after upgrading to turn it on.","error")}else o=`<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>${ce(a.connect_status==="NEEDS_REAUTH"?"Reconnect needed":"Connection error")}</span>`,s="The connection stopped working. Reconnect to resume booking sync.",r=`
    ...
    <div class="dashboard-card intg-card">
      <div class="card-body">
        ...
        <button type="button" class="intg-btn danger" id="intg-r-disconnect"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`;const h=a.webhook||{};if(h.state==="active"){const w=h.last_received_tz?` Last call received ${ce(String(h.last_received_tz).slice(0,10))}.`:"";r=et(`Call sync is on. New calls appear within minutes; a daily sweep catches anything missed.${w}`)}else r=et("Automatic call sync could not be set up in CallRail. Calls still arrive via the daily sweep and Sync now. Reconnect to retry the setup.","error")}else n='<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>Connection error</span>',o="The connection stopped working. Reconnect with a current CallRail API key.",s=`
    ...
    </div>`}function Ii(){const e=document.getElementById("intg-body");e&&(e.innerHTML=ki()+Ci()+Ti(),document.getElementById("intg-g-connect")?.addEventListener("click",Ni),document.getElementById("intg-g-sync")?.addEventListener("click",Oi),document.getElementById("intg-g-disconnect")?.addEventListener("click",Ri),document.getElementById("intg-g-accounts")?.addEventListener("click",pn),document.getElementById("intg-c-connect")?.addEventListener("click",Mi),document.getElementById("intg-c-disconnect")?.addEventListener("click",Fi),document.getElementById("intg-r-connect")?.addEventListener("click",Pi),document.getElementById("intg-r-sync")?.addEventListener("click",Ui),document.getElementById("intg-r-disconnect")?.addEventListener("click",Hi),P.autoOpenPicker&&(P.autoOpenPicker=!1,document.getElementById("intg-g-accounts")&&pn()))}async function pn(){const e=document.getElementById("intg-g-picker");if(e){e.style.display="",e.innerHTML=et("Loading your ad accounts…");try{const a=await(await fetch(`${de()}/m5t/v5/integrations/google_ads/accounts`)).json();if(!a.ok)throw new Error(a.error||"load failed");$i(a.data.accounts||[],new Set(a.data.linked||[]))}catch{e.innerHTML=et("Could not load your ad accounts. Try again, or reconnect if this keeps happening.","error")}}}function $i(e,t){const a=document.getElementById("intg-g-picker");if(!a)return;const n=e.map(o=>{const s=o.manager||o.error,r=o.manager?"Manager":o.error?"Unavailable":o.currency||"",i=t.has(o.id)&&!s;return`
      <label class="intg-acct${s?" disabled":""}">
        <input type="checkbox" data-intg-acct="${ce(o.id)}" ${i?"checked":""} ${s?"disabled":""}>
        <span style="min-width:0">
          <span class="intg-acct__name">${ce(o.name||"Account "+o.id)}</span>
          <div class="intg-acct__id">${ce(o.id)}</div>
        </span>
        ${r?`<span class="intg-acct__badge">${ce(r)}</span>`:"<span></span>"}
    ...
    </div>`,document.getElementById("intg-picker-cancel")?.addEventListener("click",()=>{a.style.display="none"}),document.getElementById("intg-picker-save")?.addEventListener("click",Li)}async function Li(){const e=document.getElementById("intg-g-picker"),t=[...e?.querySelectorAll("input[data-intg-acct]:checked")||[]].map(n=>n.dataset.intgAcct),a=document.getElementById("intg-picker-save");a&&(a.disabled=!0);try{const o=await(await fetch(`${de()}/m5t/v5/integrations/google_ads/accounts`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({customer_ids:t})})).json();if(!o.ok)throw new Error(o.error||"save failed");Z(`${o.data.linked} account${o.data.linked===1?"":"s"} linked. First sync is running.`,"success"),e&&(e.style.display="none"),Pe()}catch{Z("Could not save account selection.","error"),a&&(a.disabled=!1)}}async function Ni(){if(!P.busy){P.busy=!0;try{const t=await(await fetch(`${de()}/m5t/v5/integrations/google_ads/connect`)).json();if(!t.ok||!t.data?.url)throw new Error(t.error||"connect failed");window.location.href=t.data.url}catch{Z("Could not start the Google connection.","error"),P.busy=!1}}}async function Oi(){if(P.busy)return;P.busy=!0;const e=document.getElementById("intg-g-sync");e&&(e.disabled=!0);try{const a=await(await fetch(`${de()}/m5t/v5/integrations/google_ads/sync`,{method:"POST"})).json();if(!a.ok)throw new Error(a.error||"sync failed");const o=(a.data?.connections?.[0]?.accounts||[]).filter(s=>s.error).length;Z(o?`Sync finished with ${o} account error${o===1?"":"s"}.`:"Metrics synced.",o?"warning":"success")}catch{Z("Sync failed.","error")}finally{P.busy=!1,e&&(e.disabled=!1),Pe()}}async function Ri(){if(!P.busy&&window.confirm("Disconnect Google Ads? Daily metric refreshes stop until reconnected.")){P.busy=!0;try{const t=await(await fetch(`${de()}/m5t/v5/integrations/google_ads`,{method:"DELETE"})).json().catch(()=>({}));if(!t.ok)throw new Error(t.error||"disconnect failed");Z("Google Ads disconnected.","success")}catch{Z("Disconnect failed.","error")}finally{P.busy=!1,Pe()}}}async function Mi(){if(!P.busy){P.busy=!0;try{const t=await(await fetch(`${de()}/m5t/v5/integrations/calendly/connect`)).json();if(!t.ok||!t.data?.url)throw new Error(t.error||"connect failed");window.location.href=t.data.url}catch{Z("Could not start the Calendly connection.","error"),P.busy=!1}}}async function Fi(){if(!P.busy&&window.confirm("Disconnect Calendly? Magnet booking falls back to the built-in scheduler and booking sync stops.")){P.busy=!0;try{const t=await(await fetch(`${de()}/m5t/v5/integrations/calendly`,{method:"DELETE"})).json().catch(()=>({}));if(!t.ok)throw new Error(t.error||"disconnect failed");Z("Calendly disconnected.","success")}catch{Z("Disconnect failed.","error")}finally{P.busy=!1,Pe()}}}function Pi(){const e=document.getElementById("intg-r-setup");e&&(e.style.display="",e.innerHTML=`
    <div class="intg-picker">
    ...
    </div>`,document.getElementById("intg-r-cancel")?.addEventListener("click",()=>{e.style.display="none"}),document.getElementById("intg-r-continue")?.addEventListener("click",Di),document.getElementById("intg-r-key")?.focus())}const Re=e=>{const t=document.getElementById("intg-r-status");t&&(t.textContent=e)};async function Di(){const e=document.getElementById("intg-r-continue"),t=document.getElementById("intg-r-key")?.value.trim()||"",a=document.getElementById("intg-r-pickers");if(!t){Re("Paste an API key first.");return}if(a&&!a.hidden)return Bi(t);e&&(e.disabled=!0),Re("Checking the key with CallRail…");try{const o=await(await fetch(`${de()}/m5t/v5/integrations/callrail/validate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:t})})).json();if(!o.ok){Re(o.error||"CallRail rejected that key.");return}const s=o.data.accounts||[],r=document.getElementById("intg-r-account");r&&(r.innerHTML=s.map(i=>`<option value="${ce(i.id)}">${ce(i.name)}</option>`).join(""),r.onchange=()=>un(t,r.value)),a&&(a.hidden=!1),e&&(e.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">save</span>Save'),Re(""),await un(t,s[0]?.id)}catch{Re("Could not reach CallRail. Try again.")}finally{e&&(e.disabled=!1)}}async function un(e,t){const a=document.getElementById("intg-r-company");if(!(!a||!t)){a.innerHTML='<option value="">Loading companies…</option>';try{const o=await(await fetch(`${de()}/m5t/v5/integrations/callrail/companies`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:t})})).json(),s=o.ok?o.data.companies||[]:[];a.innerHTML=s.length?s.map(r=>`<option value="${ce(r.id)}">${ce(r.name)}</option>`).join(""):'<option value="">No active companies in this account</option>'}catch{a.innerHTML='<option value="">Could not load companies</option>'}}}async function Bi(e){const t=document.getElementById("intg-r-continue"),a=document.getElementById("intg-r-account")?.value||"",n=document.getElementById("intg-r-company")?.value||"";if(!n){Re("Pick the company this workspace tracks.");return}t&&(t.disabled=!0),Re("Connecting…");try{const s=await(await fetch(`${de()}/m5t/v5/integrations/callrail`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:a,company_id:n})})).json();if(!s.ok)throw new Error(s.error||"connect failed");Z(s.data?.webhook_state==="active"?"CallRail connected. Call sync is on.":"CallRail connected. Call sync setup needs attention; see the card.","success"),Pe()}catch{Re("Could not connect. Check the key and try again."),t&&(t.disabled=!1)}}async function Ui(){if(P.busy)return;P.busy=!0;const e=document.getElementById("intg-r-sync");e&&(e.disabled=!0);try{const a=await(await fetch(`${de()}/m5t/v5/integrations/callrail/sync?days=7`,{method:"POST"})).json();if(!a.ok)throw new Error(a.error||"sync failed");const n=a.data?.connections?.[0]||{};Z(n.error?"Sync finished with errors.":`Sync done. ${n.processed||0} new call${(n.processed||0)===1?"":"s"} recorded.`,n.error?"warning":"success")}catch{Z("Sync failed.","error")}finally{P.busy=!1,e&&(e.disabled=!1),Pe()}}async function Hi(){if(!P.busy&&window.confirm("Disconnect CallRail? Calls stop landing in your Leads inbox.")){P.busy=!0;try{const t=await(await fetch(`${de()}/m5t/v5/integrations/callrail`,{method:"DELETE"})).json().catch(()=>({}));if(!t.ok)throw new Error(t.error||"disconnect failed");Z("CallRail disconnected.","success")}catch{Z("Disconnect failed.","error")}finally{P.busy=!1,Pe()}}}const zi=Object.freeze(Object.defineProperty({__proto__:null,init:Si,render:Ei},Symbol.toStringTag,{value:"Module"})),Gi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},K=e=>String(e??"").replace(/[&<>"']/g,t=>Gi[t]),ma=()=>S.getConfig?.().BASE_URL||"",aa=e=>Number(e||0).toLocaleString(),H={conversations:[],counts:{},magnetNames:{},filter:"ALL",book:!1,magnetOwnerNames:{}},mn={COMPLETED:{label:"Completed",icon:"check_circle"},IN_PROGRESS:{label:"In progress",icon:"pending"},ABANDONED:{label:"Abandoned",icon:"highlight_off"}},ga={book:"Book",chat:"Chat",call:"Call",email:"Email",support:"Support"};function yo(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email)||null}function wo(e){return(e.split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase()}function xo(e){try{return new Date(e).toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return""}}function Vi(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function Eo(e){return e==null?"—":e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,"0")}s`}let gn=!1;function qi(){if(gn)return;const e=document.createElement("style");e.id="m5t-convs-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),gn=!0}const qt=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function So(){return qi(),nt(),`
    <div class="page-shell" data-section="conversations">
      <div class="page-header">
        <div class="page-header-text">
          <h1 class="page-title">Conversations</h1>
          <p class="page-description">${te()?"All conversations across your clients.":"Every visitor journey through your magnets: completed, in progress, or abandoned."}</p>
        </div>
      </div>
      <div class="dashboard-card">
        <div class="card-body" id="convs-body">
          ${qt("hourglass_empty","Loading journeys…")}
        </div>
      </div>
    </div>`}async function Ao(){await ji()}async function ji(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${ma()}/m5t/v5/conversations`),fetch(`${ma()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(H.conversations=n.conversations||[],H.counts=n.counts||{},H.book=te(),a){const o=await a.json().catch(()=>({}));H.magnetNames={},H.magnetOwnerNames={};const s=H.book?io():{};(o.magnets||[]).forEach(r=>{H.magnetNames[r.guid]=r.name,H.book&&(H.magnetOwnerNames[r.guid]=r.owner_name||s[r.owner_guid]||"")})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=qt("error","Could not load journeys. Please try again.");return}ko()}}function Wi(){return H.filter==="ALL"?H.conversations:H.conversations.filter(e=>e.status===H.filter)}function Yi(e){const t=yo(e.lead),a=H.magnetNames[e.magnet_guid]||"—",n=mn[e.status]||mn.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,s=(e.routes||[]).map(r=>ga[r]||r).join(", ");return`
    <tr class="convs-row" data-session="${K(e.session)}">
      <td>
        <span class="convs-who">
          <span class="convs-ava${t?"":" anon"}">${t?K(wo(t)):'<span class="material-symbols-outlined" style="font-size:16px">person_off</span>'}</span>
          <span><span class="convs-name">${t?K(t):'<span class="convs-muted">Anonymous visitor</span>'}</span>
            ${e.lead?.email?`<div class="convs-sub">${K(e.lead.email)}</div>`:s?`<div class="convs-sub">Picked: ${K(s)}</div>`:""}</span>
        </span>
      </td>
      ${H.book?`<td>${lo(H.magnetOwnerNames[e.magnet_guid]||"")||'<span class="convs-muted">—</span>'}</td>`:""}
      <td><span class="convs-sub">${K(a)}</span></td>
      <td><span class="convs-badge" data-s="${K(e.status)}"><span class="material-symbols-outlined" aria-hidden="true">${n.icon}</span>${n.label}</span></td>
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${K(xo(e.started_at))}">${K(Vi(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${K(Eo(e.duration_s))}</td>
    </tr>`}function ko(){const e=document.getElementById("convs-body");if(!e)return;if(!H.conversations.length){e.innerHTML=qt("route","No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.");return}const t=Wi(),a=[["ALL","All"],["COMPLETED","Completed"],["IN_PROGRESS","In progress"],["ABANDONED","Abandoned"]];e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${a.map(([n,o])=>`<button data-filter="${n}" class="${H.filter===n?"active":""}">${o}${n!=="ALL"&&H.counts[n]?` (${aa(H.counts[n])})`:""}</button>`).join("")}
      </div>
      <span class="convs-count">${aa(t.length)} of ${aa(H.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(Yi).join("")||`<tr><td colspan="${H.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${H.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(H.filter=o.dataset.filter,ko())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&Ki(o.dataset.session)})}const Ji={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${ga[e]||e}`:""}`,route:e=>`Picked ${ga[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function Ki(e){const t=H.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${ma()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=yo(t.lead),o=H.magnetNames[t.magnet_guid]||"—",r=(a?.events||[]).filter((c,h,w)=>c.event!=="step"||!(w[h+1]&&w[h+1].event==="step")).map(c=>`
    <div class="convs-tl__item${c.event==="complete"?" done":""}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${K((Ji[c.event]||(()=>c.event))(c.detail))}</div>
      <div class="convs-tl__time">${K(xo(c.at))}${c.variant?` · Variant ${K(c.variant)}`:""}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      <div class="convs-drawer__head">
        <span class="convs-drawer__title">${n?K(n):"Anonymous visitor"}</span>
      ...
      <div class="convs-drawer__body">
        ${n?`<a class="convs-drawer__lead" href="#/leads">
              <span class="convs-ava">${K(wo(n))}</span>
              <span><div class="convs-name">${K(n)}</div><div class="convs-sub">${K(t.lead?.email||t.lead?.phone||"")}</div></span>
        ...
        <div class="convs-sub" style="margin-bottom:6px">${K(o)} · ${K(Eo(t.duration_s))}${t.variant?` · Variant ${K(t.variant)}`:""}</div>
        ${r?`<div class="convs-tl">${r}</div>`:qt("timeline","No timeline available for this journey.")}
      </div>
    </aside>`,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("open"),i.querySelector(".convs-drawer").classList.add("open")});const l=()=>{i.classList.remove("open"),setTimeout(()=>i.remove(),220)};i.querySelector(".convs-drawer__close").addEventListener("click",l),i.addEventListener("click",c=>{c.target===i&&l()})}const Xi={render:So,init:Ao},Qi=Object.freeze(Object.defineProperty({__proto__:null,default:Xi,init:Ao,render:So},Symbol.toStringTag,{value:"Module"})),Zi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ze=e=>String(e??"").replace(/[&<>"']/g,t=>Zi[t]),hn=(e,t="info")=>{try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Et=()=>S.getConfig?.().BASE_URL||"",tt=e=>Number(e||0).toLocaleString(),Fe={magnets:[],stats:{},canManage:!1},el={mag_title:"header title",mag_subtitle:"subtitle",mag_welcome:"welcome message",mag_theme_color:"color",mag_launcher_label:"launcher label"};let fn=!1;function tl(){if(fn)return;const e=document.createElement("style");e.id="m5t-abt-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),fn=!0}const Ia=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Co(){return te()?gt({section:"ab-testing",title:"A/B Testing",description:"Pick a client to view their experiments."}):(tl(),`
    <div class="page-shell" data-section="ab-testing">
      ...
      <div id="abt-body">${Ia("hourglass_empty","Loading tests…")}</div>
    </div>`)}async function $a(){if(te())return ot(Et(),[{h:"Running",td:t=>tt(t.ab_tests?.running)},{h:"Completed",td:t=>tt(t.ab_tests?.completed)},{h:"Compl. %",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Experiments appear per client once you have one."});const e=document.getElementById("abt-body");try{const t=new Date,a=new Date(t.getTime()-89*864e5).toISOString().slice(0,10),n=t.toISOString().slice(0,10),[o,s]=await Promise.all([fetch(`${Et()}/m5t/v5/magnets`),fetch(`${Et()}/m5t/v5/magnets/stats?from=${a}&to=${n}`)]),r=await o.json().catch(()=>({}));if(!r.ok)throw new Error(r.message||"Failed to load");Fe.magnets=r.magnets||[],Fe.canManage=!!r.canManage;const i=await s.json().catch(()=>({}));Fe.stats=i?.stats||{}}catch(t){console.warn("[ab-testing] load failed:",t),e&&(e.innerHTML=Ia("error","Could not load your tests. Please try again."));return}al()}function al(){const e=document.getElementById("abt-body");if(!e)return;const t=Fe.magnets.filter(n=>n.ab?.enabled),a=Fe.magnets.filter(n=>!n.ab?.enabled&&n.ab?.declared);if(!t.length&&!a.length){e.innerHTML=Ia("science","No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.");return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(rl).join("")}`:"")+(a.length?`<div class="abt-sect">Completed Tests</div>${a.map(il).join("")}`:""),e.querySelectorAll("[data-declare]").forEach(n=>n.addEventListener("click",()=>ll(n.dataset.declare,n.dataset.winner)))}function nl(e){const t=Fe.stats[e.guid]?.variants||{},a={opens:0,engaged:0,completions:0,rate:null,...t.A||{}},n={opens:0,engaged:0,completions:0,rate:null,...t.B||{}};return{A:a,B:n}}function ol(e){const t=Object.keys(e?.b||{}).map(a=>el[a]||a);return t.length?`Changes: ${t.join(", ")}`:""}function sl(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function vn(e,t,a,n,o,s){return`
    <div class="abt-variant${o?" leader":""}">
      <div class="abt-vhead"><span class="abt-vname">${ze(e)}</span><span class="abt-vtag${o?" win":""}">${ze(t)}</span></div>
      ${a?`<div class="abt-vdesc">${ze(a)}</div>`:""}
    ...
    </div>`}function rl(e){const t=e.ab,{A:a,B:n}=nl(e),o=(n.rate??-1)>(a.rate??-1)?"B":(a.rate??-1)>(n.rate??-1)?"A":null,s=o&&a.rate!=null&&n.rate!=null?`+${Math.round(Math.abs(n.rate-a.rate)*10)/10}%`:"",r=cl(a,n),i=t.started_tz?sl(t.started_tz):null,l=(a.opens||0)+(n.opens||0),c=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
        <h2 class="abt-name">${ze(e.name)}</h2>
        <span class="abt-status running"><span class="pulse-dot"></span>Running</span>
        <div class="abt-actions">
          ${Fe.canManage&&o?`<button class="btn btn-primary" type="button" data-declare="${ze(e.guid)}" data-winner="${o}"><span class="material-symbols-outlined" aria-hidden="true">emoji_events</span>Declare Winner</button>`:""}
        </div>
      </div>
      <div class="abt-meta">
      ...
      <div class="abt-compare">
        ...
        ${vn("Variant B",o==="B"?"Leading":"Challenger",ol(t),n,o==="B",o==="B"?s:"")}
      </div>
      <div class="abt-sig">
    ...
    <div class="abt-card">
      ...
      <div class="abt-summary">
        <span><span class="k">Winner:</span><span class="v">Variant ${ze(t.winner)}</span></span>
    ...
    </div>`}async function ll(e,t){const a=Fe.magnets.find(n=>n.guid===e);if(a&&window.confirm(`Declare Variant ${t} the winner for “${a.name}”?

${t==="B"?"Variant B’s changes become the magnet’s configuration for everyone.":"The magnet keeps its current configuration."} The experiment ends and moves to Completed.`)){try{const o=await(await fetch(`${Et()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Declare failed");hn(`Variant ${t} declared the winner`,"success")}catch(n){hn(n.message||"Could not declare a winner","danger");return}try{await $a()}catch(n){console.warn("[ab-testing] refresh after declare failed:",n)}}}function cl(e,t){const a=e.opens||0,n=t.opens||0,o=e.completions||0,s=t.completions||0;if(a<30||n<30||o+s<5)return null;const r=o/a,i=s/n,l=(o+s)/(a+n),c=Math.sqrt(l*(1-l)*(1/a+1/n));if(!c)return null;const h=Math.abs(i-r)/c;return Math.round(2*(dl(h)-.5)*1e3)/10}function dl(e){const t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}const pl={render:Co,init:$a},ul=Object.freeze(Object.defineProperty({__proto__:null,default:pl,init:$a,render:Co},Symbol.toStringTag,{value:"Module"})),ml={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ae=e=>String(e??"").replace(/[&<>"']/g,t=>ml[t]),To=()=>S.getConfig?.().BASE_URL||"",gl={single_select:{icon:"quiz",color:"#0072BA"},multi_select:{icon:"checklist",color:"#0E6BA8"},scheduler:{icon:"event",color:"#915E8B"},text:{icon:"short_text",color:"#5B54C6"},email:{icon:"mail",color:"#0E8F86"},phone:{icon:"call",color:"#2E8B57"},message:{icon:"chat",color:"#B4791F"}},Ot={};Ea.forEach(e=>{Ot[e.value]={label:e.label,...gl[e.value]||{icon:"quiz",color:"#0072BA"}}});const Io=Ea.map(e=>e.value),$o={chat:"Chat / default",book:"Book (scheduler)",support:"Support (intake)"},La=e=>Ot[e]||Ot.single_select,We=e=>e==="single_select"||e==="multi_select",jt=e=>e!=="message",ht=e=>e==="scheduler",Rt=e=>e==="email"?"email":e==="phone"?"phone":"",qe=()=>({meeting_label:"",start:"09:00",end:"17:00",mins:30,days:14}),hl=[["","No icon"],["event","Calendar"],["schedule","Clock"],["mail","Email"],["sms","Text"],["phone","Phone"],["chat","Chat"],["description","Document"],["help","Question"],["place","Location"],["person","Person"],["bolt","Quick"],["check_circle","Check"],["star","Star"],["home","Home"],["build","Service"]];function fl(e,t){const a=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||"").trim());return a?`rgba(${parseInt(a[1],16)},${parseInt(a[2],16)},${parseInt(a[3],16)},${t})`:`rgba(0,114,186,${t})`}let _n=!1;function vl(){if(_n)return;const e=document.createElement("style");e.id="m5t-flow-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),_n=!0}let F=[],Se=null,_l=0,Oe=null,Ue=null,He="chat",ge={},St=[],Lo=null,ha=null,At="";const at=()=>"f"+ ++_l;function Na(e="single_select"){return{_uid:at(),id:"",step_type:e,step_prompts:[""],step_options:We(e)?[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]:[],step_columns:Rt(e)?[Rt(e)]:[],step_description:"",step_config:ht(e)?qe():null}}function bl(e){return(Array.isArray(e)?e:[]).map(t=>({_uid:at(),id:t.id!=null?String(t.id):"",step_type:Ot[t.step_type]?t.step_type:"single_select",step_prompts:Array.isArray(t.step_prompts)?t.step_prompts.map(String):[],step_options:(Array.isArray(t.step_options)?t.step_options:[]).map(a=>({label:a&&a.label!=null?String(a.label):"",goto:a&&a.goto!=null?String(a.goto):"",icon:a&&a.icon!=null?String(a.icon):""})),step_columns:Array.isArray(t.step_columns)?t.step_columns.map(String):[],step_description:t.step_description!=null?String(t.step_description):"",step_config:t.step_config&&typeof t.step_config=="object"?{...qe(),...t.step_config}:t.step_type==="scheduler"?qe():null}))}function bn(){return[{_uid:at(),id:"",step_type:"text",step_prompts:["Great, and your name?"],step_options:[],step_columns:["first_name"],step_description:"",step_config:null},{_uid:at(),id:"",step_type:"email",step_prompts:["The best email to reach you?"],step_options:[],step_columns:["email"],step_description:"",step_config:null}]}function yl(e,t){if(e==="book")return[{_uid:at(),id:"",step_type:"scheduler",step_prompts:["When works best for you?"],step_options:[],step_columns:[],step_description:"",step_config:qe()},...bn()];if(e==="support"){const a=(t.actions||[]).find(s=>s&&s.type==="support"),n=a&&a.config&&Array.isArray(a.config.options)?a.config.options:[],o=n.length?n.map(s=>({label:s&&s.label||String(s),goto:"",icon:s&&s.icon||""})):["Sales enquiry","Support","Billing","Something else"].map(s=>({label:s,goto:"",icon:""}));return[{_uid:at(),id:"",step_type:"multi_select",step_prompts:["How can we help you today?"],step_options:o,step_columns:[],step_description:"Select all that apply",step_config:null},...bn()]}return[Na("single_select")]}function No(e,t){const a=e==="chat"?t.steps:t.routes&&t.routes[e],n=bl(a);return n.length?n:e==="chat"?[Na("single_select")]:yl(e,t)}function wl(e){We(e.step_type)?e.step_options.length||(e.step_options=[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]):e.step_options=[],jt(e.step_type)?!e.step_columns.length&&Rt(e.step_type)&&(e.step_columns=[Rt(e.step_type)]):e.step_columns=[],e.step_config=ht(e.step_type)?e.step_config||qe():null}function xl(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${ae(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${hl.map(([a,n])=>`<option value="${ae(a)}"${a===e.icon?" selected":""}>${ae(n)}</option>`).join("")}</select>
  ...
  </div>`}function El(e){const t=Io.map(n=>`<option value="${n}"${n===e.step_type?" selected":""}>${ae(La(n).label)}</option>`).join(""),a=e.step_options.length<=1;return`<div class="flow-node__body">
    ...
    <textarea class="mag-modal__input flow-f-prompts" rows="2" placeholder="${e.step_type==="message"?"Thanks! One moment…":"What can we help you with?"}">${ae(e.step_prompts.join(`
`))}</textarea>
    ...
    <select class="mag-modal__select flow-f-field">
      ...
      ${xa.map(n=>`<option value="${ae(n.value)}"${n.value===e.step_columns[0]?" selected":""}>${ae(n.label)}</option>`).join("")}
    </select>
    ...
    <div class="flow-opts">${e.step_options.map(n=>xl(n,a)).join("")}</div>
    ...
    <input class="mag-modal__input flow-f-mtlabel" type="text" value="${ae(e.step_config?.meeting_label||"")}" placeholder="e.g. 15 minute call">
    <div class="mag-modal__row" style="margin-top:8px">
      <div><label class="mag-modal__label">From</label><input class="mag-modal__input flow-f-start" type="time" value="${ae(e.step_config?.start||"09:00")}"></div>
      <div><label class="mag-modal__label">To</label><input class="mag-modal__input flow-f-end" type="time" value="${ae(e.step_config?.end||"17:00")}"></div>
  ...
  </div>`}function Sl(e){const t=e.step_prompts.find(o=>String(o).trim()!=="")||"",a=t?`<div class="flow-node__prompt">“${ae(t)}”</div>`:`<div class="flow-node__prompt is-empty">${e.step_type==="message"?"No message yet":"No question yet"}</div>`;let n="";if(We(e.step_type)){const o=e.step_options.map(s=>String(s.label).trim()).filter(Boolean);if(o.length){const s=o.slice(0,4).map(i=>`<span class="flow-node__chip">${ae(i)}</span>`).join(""),r=o.length>4?`<span class="flow-node__chip">+${o.length-4}</span>`:"";n=`<div class="flow-node__chips">${s}${r}</div>`}}else if(jt(e.step_type)&&e.step_columns[0]){const o=xa.find(s=>s.value===e.step_columns[0])?.label||e.step_columns[0];n=`<div class="flow-node__meta">Saves to <b>${ae(o)}</b></div>`}return`<div class="flow-node__preview">${a}${n}</div>`}function Al(e,t,a){const n=La(e.step_type),o=e._uid===Se,s=`--nc:${n.color};--nct:${fl(n.color,.14)}`;return`<div class="flow-node${o?" flow-node--open":""}" data-uid="${e._uid}" style="${s}"${o?"":' draggable="true"'}>
    <div class="flow-node__hd">
      ...
      <span class="flow-node__type">${ae(n.label)}</span>
    ...
    ${o?El(e):Sl(e)}
  </div>`}const yn='<div class="flow-conn"><span class="flow-conn__line"></span><span class="material-symbols-outlined" aria-hidden="true">expand_more</span></div>';function ve(){const e=document.getElementById("flow-nodes");if(!e)return;const t=F.length,a=['<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>',yn];F.forEach((n,o)=>{a.push(Al(n,o,t)),o<t-1&&a.push(yn)}),e.innerHTML=a.join("")}function Ae(){const e=document.querySelector(".flow-node--open");if(!e)return;const t=F.find(s=>s._uid===e.dataset.uid);if(!t)return;const a=e.querySelector(".flow-f-type");a&&(t.step_type=a.value);const n=e.querySelector(".flow-f-prompts");n&&(t.step_prompts=n.value.split(`
`));const o=e.querySelector(".flow-f-field");if(t.step_columns=o&&o.value.trim()?[o.value.trim()]:[],We(t.step_type)){const s=t.step_options,r=[];e.querySelectorAll(".flow-opt").forEach((i,l)=>{r.push({label:i.querySelector(".flow-o-label")?.value??"",icon:i.querySelector(".flow-o-icon")?.value??"",goto:s[l]&&s[l].goto||""})}),t.step_options=r}else t.step_options=[];if(ht(t.step_type)){const s=e.querySelector(".flow-f-mtlabel"),r=e.querySelector(".flow-f-start"),i=e.querySelector(".flow-f-end"),l=e.querySelector(".flow-f-mins");t.step_config={...t.step_config||qe(),...s?{meeting_label:s.value.trim()}:{},...r&&r.value?{start:r.value}:{},...i&&i.value?{end:i.value}:{},...l?{mins:parseInt(l.value,10)||30}:{}}}else t.step_config=null}function Oo(){document.querySelectorAll(".flow-node.drop-before, .flow-node.drop-after").forEach(e=>e.classList.remove("drop-before","drop-after"))}function it(){Oo(),document.querySelectorAll(".flow-node.dragging").forEach(e=>e.classList.remove("dragging")),Oe=null,Ue=null}function kl(e=F){if(!e.length)return"Add at least one step.";for(let t=0;t<e.length;t++){const a=e[t],n=t+1;if(!a.step_prompts.some(o=>String(o).trim()!==""))return`Step ${n}: add what the magnet should say.`;if(We(a.step_type)&&!a.step_options.some(o=>String(o.label).trim()!==""))return`Step ${n}: add at least one choice.`;if(jt(a.step_type)&&!a.step_columns.length)return`Step ${n}: choose which field this answer saves to.`}return""}function fa(e=F){let t=0;return e.forEach(a=>{const n=parseInt(a.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(a=>{const n=a.id&&String(a.id).trim()?String(a.id):String(++t),o=We(a.step_type)?a.step_options.map(r=>{const i={label:String(r.label).trim(),goto:String(r.goto||"")};return r.icon&&(i.icon=String(r.icon)),i}).filter(r=>r.label!==""):[],s={id:n,step_type:a.step_type,step_prompts:a.step_prompts.map(r=>String(r)).filter(r=>r.trim()!==""),step_options:o,step_columns:a.step_columns.slice(),step_description:a.step_description||""};return ht(a.step_type)&&a.step_config&&(s.step_config={...qe(),...a.step_config}),s})}function Cl(e,t,a){vl(),Lo=t,ha=typeof a=="function"?a:null,At=t?.modified_tz||"",St=["chat",...["book","support"].filter(n=>(t.actions||[]).some(o=>o&&o.type===n))],ge={chat:No("chat",t)},He="chat",F=ge.chat,Se=F.length===1?F[0]._uid:null,Oe=null,Ue=null,e.innerHTML=`
    ...
    ${St.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${St.map(n=>`<option value="${n}">${ae($o[n]||n)}</option>`).join("")}</select></div>`:""}
...
<body>
  ...
  <\/script>
  <script>${a}<\/script>
</body></html>`}let xn=!1;function Mo(){if(xn)return;const e=document.createElement("style");e.id="m5t-preview-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),xn=!0}function Fo(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function Po(e){const t=e.querySelector("[data-pv-info]"),a=e.querySelector("[data-pv-info-pop]");t&&a&&t.addEventListener("click",()=>{a.hidden=!a.hidden})}function Rl(e,t){Mo(),e.innerHTML=`
    <div class="pv-pane">
      ...
      ${Fo("Live render of the real widget. Capture is disabled, so no test leads.")}
    </div>`,Po(e);const a=e.querySelector(".pv-pane__frame"),n=e.querySelector(".pv-pane__badge");let o=null,s=0;const r=450,i=()=>{const c=(typeof performance<"u"?performance.now():Date.now())-s;clearTimeout(o),c<r?o=setTimeout(()=>{n.hidden=!0},r-c):n.hidden=!0};a.addEventListener("load",i);const l=()=>{let c;try{c=Ro(t())}catch{return}s=typeof performance<"u"?performance.now():Date.now(),n.hidden=!1,a.srcdoc=c,clearTimeout(o),o=setTimeout(()=>{n.hidden=!0},1500)};return e.querySelector(".pv-pane__seg").addEventListener("click",c=>{const h=c.target.closest("button[data-device]");!h||h.dataset.device===a.dataset.device||(e.querySelectorAll(".pv-pane__seg button").forEach(w=>w.classList.toggle("is-on",w===h)),a.dataset.device=h.dataset.device)}),l(),{refresh:l,destroy(){clearTimeout(o)}}}function Do(e){Mo();let t="desktop";const a=document.createElement("div");a.className="pv-scrim",a.innerHTML=`
    <div class="pv-modal" role="dialog" aria-modal="true" aria-label="Magnet preview">
      ...
      <div class="pv-body">
        <div>
          ...
          ${Fo("Live render of the actual widget. Capture is disabled, so no test leads are created.")}
        </div>
      </div>
    </div>`,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("open")),Po(a);const n=a.querySelector(".pv-frame"),o=a.querySelector(".pv-stage"),s=()=>{try{n.srcdoc=Ro(e())}catch{}};s();const r=()=>{a.classList.remove("open"),setTimeout(()=>a.remove(),180)};return a.querySelector('[data-x="close"]').addEventListener("click",r),a.querySelector('[data-x="refresh"]').addEventListener("click",s),a.addEventListener("click",i=>{i.target===a&&r()}),a.querySelector(".pv-seg").addEventListener("click",i=>{const l=i.target.closest("button[data-device]");!l||l.dataset.device===t||(t=l.dataset.device,a.querySelectorAll(".pv-seg button").forEach(c=>c.classList.toggle("is-on",c.dataset.device===t)),o.dataset.device=t,s())}),{close:r,rebuild:s}}let En=!1;const V={magnets:[],owners:[],canProvision:!1,canManage:!1,primaryOrgGuid:null,stats:{}},Ml={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},b=e=>String(e??"").replace(/[&<>"']/g,t=>Ml[t]),Le=(e,t="info")=>{try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}},ne=()=>S.getConfig?.().BASE_URL||"",Bo=e=>`<script src="${ne()}/m5t/v5/coreSnippet?appguid=${e}" async><\/script>`,Uo=()=>`<details class="mag-csp-note">
  ...
  <div class="mag-csp-note__body">
    <p>A strict CSP can silently block the widget — it just never appears, no visible error. Allowlist <code>${b(ne())}</code> under all three directives:</p>
    <ul>
...
</details>`,Fl={chat:"Chat bubble",right_slide:"Slide-in panel",modal:"Modal",inline:"Inline"},Pl={chat:"chat",right_slide:"vertical_split",modal:"web_asset",inline:"view_agenda"},Dl=[{value:"inline",icon:"view_agenda",label:"Inline"},{value:"chat",icon:"chat",label:"Chat"},{value:"right_slide",icon:"vertical_split",label:"Slide"},{value:"modal",icon:"web_asset",label:"Modal"}],Bl=[{value:"auto",icon:"brightness_auto",label:"Auto"},{value:"light",icon:"light_mode",label:"Light"},{value:"dark",icon:"dark_mode",label:"Dark"}],Ul=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],Ho={book:{label:"Book",icon:"event",kind:"book"},chat:{label:"Chat",icon:"chat",kind:"flow"},call:{label:"Call",icon:"phone",kind:"value",placeholder:"Phone number"},email:{label:"Email",icon:"mail",kind:"value",placeholder:"Email address"},support:{label:"Support",icon:"support_agent",kind:"support"}},Hl=["book","chat","call","email","support"];let kt=null;async function zl(){if(kt)return kt;let e;try{const t=await fetch(`${ne()}/m5t/v5/integrations/calendly/event_types`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.event_types||[],scheduling_url:a.data.scheduling_url||""}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(kt=e),e}async function Gl(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved Calendly event";e.innerHTML=`<option value="${b(t)}">${t?b(a):"Loading event types"}</option>`;const n=await zl();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${b(t)}" selected>${b(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect Calendly under Settings, Integrations first":"Could not load event types"}</option>`;return}const o=[];n.scheduling_url&&o.push({url:n.scheduling_url,label:"Full scheduling page (visitor picks the event)"}),n.list.forEach(s=>o.push({url:s.scheduling_url,label:s.duration?`${s.name} (${s.duration} min)`:s.name})),t&&!o.some(s=>s.url===t)&&o.unshift({url:t,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${b(s.url)}"${s.url===(t||o[0].url)?" selected":""}>${b(s.label)}</option>`).join(""):'<option value="">No active event types</option>'}let Ct=null;async function Vl(){if(Ct)return Ct;let e;try{const t=await fetch(`${ne()}/m5t/v5/integrations/callrail/trackers`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.trackers||[]}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(Ct=e),e}async function ql(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved tracking number";e.innerHTML=`<option value="${b(t)}">${t?b(a):"Loading tracking numbers"}</option>`;const n=await Vl();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${b(t)}" selected>${b(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect CallRail under Settings, Integrations first":"Could not load tracking numbers"}</option>`;return}const o=n.list.map(s=>({number:s.number,id:s.id,name:s.name,label:`${s.name} · ${s.number}${s.type==="session"?" (number pool)":""}`}));t&&!o.some(s=>s.number===t)&&o.unshift({number:t,id:e.dataset.savedId||"",name:a,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${b(s.number)}" data-tracker-id="${b(s.id)}" data-tracker-name="${b(s.name)}"${s.number===(t||o[0].number)?" selected":""}>${b(s.label)}</option>`).join(""):'<option value="">No active tracking numbers in this company</option>'}function Sn(e,t,a){return`<div class="mag-seg" role="radiogroup" aria-label="${b(e)}">${a.map(n=>`
    <label><input type="radio" name="${b(e)}" value="${b(n.value)}"${n.value===t?" checked":""}>
      <span><span class="material-symbols-outlined" aria-hidden="true">${b(n.icon)}</span>${b(n.label)}</span></label>`).join("")}</div>`}function jl(e,t){const a=Ho[e],n=!!t,o=n?"":" disabled";let s="";if(a.kind==="value"&&e==="call"){const i=t?.config?.source==="callrail",l=i&&t?.value||"",c=i?t?.config?.tracker_name||"Saved tracking number":"";s=`
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${a.kind}">
    ...
    ${r}
  </div>`}function Wl(){if(En)return;const e=document.createElement("style");e.id="m5t-magnets-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),En=!0}function Mt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Yl(e){const t=V.stats[e];if(!t||!t.opens&&!t.leads)return'<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>';const a=n=>Number(n||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function zo(e){const t=V.owners.length>1||S.getMemberships().length>1,a=(e.domains||[]).filter(Boolean),n=V.canManage;return`
    <div class="mag-card" data-guid="${b(e.guid)}">
      ...
      <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${Pl[e.display_mode]||"chat"}</span>${b(Fl[e.display_mode]||"Chat bubble")}${e.ab?.enabled?'&nbsp;&nbsp;<span class="mag-ab-chip"><span class="material-symbols-outlined" aria-hidden="true">science</span>A/B</span>':""}${(e.notify_emails||[]).length?`&nbsp;&nbsp;<a class="mag-alert-chip" href="#/settings/notifications" title="Lead alerts to ${(e.notify_emails||[]).length} email${(e.notify_emails||[]).length===1?"":"s"}. Manage in Settings."><span class="material-symbols-outlined" aria-hidden="true">notifications_active</span>${(e.notify_emails||[]).length}</a>`:""}</span>
      ${Yl(e.guid)}
      <div class="mag-domains">${a.length?a.map(o=>b(o)).join(", "):"<span>No domains set. Add yours to go live.</span>"}</div>
      <div class="mag-embed">
        <input type="text" readonly value="${b(Bo(e.guid))}" aria-label="Embed snippet">
    ...
    </div>`}function Jl(){return te()?gt({section:"magnets",title:"Your Magnets",description:"Pick a client to view and manage their magnets."}):(Wl(),`
    <div class="page-shell" data-section="magnets">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="mag-body">
          ${Mt("hourglass_empty","Loading magnets…")}
        </div>
      </div>
    </div>`)}async function Kl(){if(te()){const t=a=>Number(a||0).toLocaleString();return ot(ne(),[{h:"Magnets",td:a=>`${t(a.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${t(a.magnets.total)}</span>`},{h:"Leads · wk",td:a=>t(a.leads.this_week)},{h:"Leads · total",td:a=>t(a.leads.total)}],{emptyMsg:"No client orgs yet. Create one under Clients, then provision its magnets here."})}kt=null,Ct=null,document.getElementById("mag-new-btn")?.addEventListener("click",Zl),document.getElementById("mag-body")?.addEventListener("click",ec),await Wt()}async function Wt(){const e=document.getElementById("mag-body");if(!e)return;try{const[a,n]=await Promise.all([fetch(`${ne()}/m5t/v5/magnets`),fetch(`${ne()}/m5t/v5/magnets/stats`).catch(()=>null)]),o=await a.json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Failed to load");V.magnets=o.magnets||[],V.owners=o.owners||[],V.canProvision=!!o.canProvision,V.canManage=!!o.canManage,V.primaryOrgGuid=o.primaryOrgGuid||null;const s=n?await n.json().catch(()=>({})):{};V.stats=s?.stats||{}}catch{e.innerHTML=Mt("error","Could not load your magnets. Please try again.");return}const t=document.getElementById("mag-new-btn");if(t&&(t.style.display=V.canProvision?"":"none"),!V.magnets.length){e.innerHTML=Mt("widgets",V.canProvision?"No magnets yet. Click “New magnet” to create your first.":"No magnets yet.");return}e.innerHTML=`<div class="mag-grid">${V.magnets.map(zo).join("")}</div>`}async function Xl(e){const t={"Content-Type":"application/json","Idempotency-Key":crypto.randomUUID()},a={status:"DRAFT"};e&&(a.owner_guid=e);const n=await fetch(`${ne()}/m5t/v5/magnets`,{method:"POST",headers:t,body:JSON.stringify(a)});let o={};try{o=await n.json()}catch{}if(!n.ok||!o.ok)throw new Error(o.message||`Could not start a new magnet (${n.status})`);return o.magnet}async function Go(e){const t=document.getElementById("mag-new-btn");t&&(t.disabled=!0);try{const a=await Xl(e);V.magnets=[a,...V.magnets];const n=document.getElementById("mag-body");n&&(n.innerHTML=`<div class="mag-grid">${V.magnets.map(zo).join("")}</div>`),Ft(a)}catch(a){Le(a.message||"Could not start a new magnet","danger")}finally{t&&(t.disabled=!1)}}function Ql(){const e=document.createElement("div");e.className="mag-modal-scrim",e.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="Choose client" style="max-width:420px">
      ...
      <div class="mag-modal__body" style="padding:20px">
        ...
        <select class="mag-modal__select" id="mag-owner-pick">
          ${V.owners.map(n=>`<option value="${b(n.guid)}"${n.guid===V.primaryOrgGuid?" selected":""}>${b(n.name||n.guid)}</option>`).join("")}
        </select>
    ...
    </div>`,document.body.appendChild(e),requestAnimationFrame(()=>{e.classList.add("open"),e.querySelector(".mag-modal").classList.add("open")});const t=()=>{e.classList.remove("open"),setTimeout(()=>e.remove(),180),document.removeEventListener("keydown",a)};function a(n){n.key==="Escape"&&(n.preventDefault(),t())}document.addEventListener("keydown",a),e.querySelector(".mag-modal__close").addEventListener("click",t),e.querySelector('[data-x="cancel"]').addEventListener("click",t),e.querySelector('[data-x="continue"]').addEventListener("click",()=>{const n=e.querySelector("#mag-owner-pick").value;t(),Go(n)})}function Zl(){if(V.owners.length>1){Ql();return}Go(null)}function ec(e){const t=e.target.closest("[data-action]");if(!t)return;const a=t.dataset.guid,n=V.magnets.find(s=>s.guid===a),o=t.dataset.action;if(o==="copy")return tc(a);if(n){if(o==="preview")return Do(()=>va(n));if(o==="funnel")return ac(n);if(o==="edit")return Ft(n);if(o==="flow")return Ft(n,"flow");if(o==="toggle")return nc(n);if(o==="delete")return oc(n)}}async function tc(e){try{await navigator.clipboard.writeText(Bo(e)),Le("Embed snippet copied","success")}catch{Le("Copy failed","danger")}}function Vo(e){const t=Number(e?.total_steps)||0,a={};if((Array.isArray(e?.funnel)?e.funnel:[]).forEach(s=>{a[s.position]=Number(s.reached)||0}),!t||!Object.keys(a).length)return'<p class="mag-modal__hint" style="margin:0">No step activity yet in this window. As visitors answer questions, drop-off by step will appear here.</p>';const n=Math.max(1,a[1]||0),o=[];for(let s=1;s<=t;s++){const r=a[s]||0,i=Math.min(100,Math.round(r/n*100));o.push(`
      ...
      </div>`)}return`<div class="mag-funnel">${o.join("")}</div>`}async function ac(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal mag-funnel-modal" role="dialog" aria-modal="true" aria-label="Step funnel for ${b(e.name)}">
      ...
      <div class="mag-modal__body" style="padding:20px">
        ...
        <div id="mag-funnel-body">${Mt("hourglass_empty","Loading…")}</div>
      </div>
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(s){s.key==="Escape"&&(s.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.addEventListener("click",s=>{s.target===t&&a()});const o=t.querySelector("#mag-funnel-body");try{const s=await fetch(`${ne()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/step-funnel`),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.message||`Failed (${s.status})`);o.innerHTML=Vo(r)}catch{o.innerHTML='<p class="mag-modal__hint" style="margin:0">Could not load the funnel. Please try again.</p>'}}async function nc(e){if(e.status==="DRAFT"){Le("Open Edit and Save to publish a draft magnet.","info");return}const t=e.status==="ENABLED"?"DISABLED":"ENABLED";try{if(!(await(await fetch(`${ne()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw new Error;Le(t==="ENABLED"?"Magnet enabled":"Magnet disabled","success")}catch{Le("Update failed","danger");return}try{await Wt()}catch(a){console.warn("[magnets] refresh after status toggle failed:",a)}}async function oc(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`)){try{if(!(await(await fetch(`${ne()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"})).json().catch(()=>({}))).ok)throw new Error;Le("Magnet deleted","success")}catch{Le("Delete failed","danger");return}try{await Wt()}catch(t){console.warn("[magnets] refresh after delete failed:",t)}}}function na(e){const t=[];return e.querySelectorAll(".mag-cta").forEach(a=>{if(!a.querySelector(".mag-cta__on").checked)return;const n=a.dataset.type,o=a.dataset.kind,s=a.querySelector(".mag-cta__val"),r=s?s.value.trim():"";if(o==="value")if(n==="call"&&a.querySelector(".mag-cta__callsrc")?.value==="callrail"){const i=a.querySelector(".mag-cta__crtracker"),l=i?.value||"",c=i?.selectedOptions?.[0];l&&t.push({type:n,value:l,config:{source:"callrail",...c?.dataset?.trackerId?{tracker_id:c.dataset.trackerId}:{},...c?.dataset?.trackerName?{tracker_name:c.dataset.trackerName}:{}}})}else r&&t.push({type:n,value:r});else if(o==="book")if(a.querySelector(".mag-cta__booksrc")?.value==="calendly"){const i=a.querySelector(".mag-cta__calevent"),l=i?.value||"",c=(i?.selectedOptions?.[0]?.textContent||"").trim();t.push({type:n,config:{source:"calendly",...l?{calendly_url:l}:{},...l&&c?{event_name:c}:{}}})}else{const i={type:n};r&&(/^https?:\/\//i.test(r)?i.value=r:i.config={meeting_label:r}),t.push(i)}else if(o==="support"){const i=(a.querySelector(".mag-cta__opts")?.value||"").split(`
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:qo(e),actions:t,font:e.querySelector("#mag-f-font").value.trim(),theme_vars:dc(e),inline_width:e.querySelector("#mag-f-inline-w").value.trim(),inline_height:e.querySelector("#mag-f-inline-h").value.trim(),hide_launcher:e.querySelector("#mag-f-hide-launcher").checked,input_placeholder:e.querySelector("#mag-f-input-ph").value,summary_confirm_label:e.querySelector("#mag-f-summary-confirm").value.trim(),success_title:e.querySelector("#mag-f-success-title").value.trim(),success_text:e.querySelector("#mag-f-success-text").value,success_cta:pc(e)}}const sc=512,rc=new Set(["image/png","image/jpeg","image/gif","image/webp"]),ic=8*1024*1024;function lc(e){return new Promise((t,a)=>{const n=new Image,o=new FileReader;o.onerror=()=>a(new Error("Could not read that file.")),o.onload=()=>{n.onerror=()=>a(new Error("That file isn’t a readable image.")),n.onload=()=>{const s=Math.min(1,sc/Math.max(n.naturalWidth,n.naturalHeight)),r=Math.max(1,Math.round(n.naturalWidth*s)),i=Math.max(1,Math.round(n.naturalHeight*s)),l=document.createElement("canvas");l.width=r,l.height=i,l.getContext("2d").drawImage(n,0,0,r,i),t(l.toDataURL("image/png"))},n.src=o.result},o.readAsDataURL(e)})}function cc(e,t){const a=e.querySelector("#mag-logo-drop");if(!a)return;const n=e.querySelector("#mag-f-logo-file"),o=e.querySelector("#mag-logo-browse"),s=e.querySelector("#mag-logo-remove"),r=e.querySelector("#mag-logo-preview"),i=e.querySelector("#mag-logo-status"),l=e.querySelector("#mag-f-logo"),c=(u,x)=>{i.textContent=u,i.style.color=x?"var(--color-danger, #DD4124)":""},h=u=>{r.innerHTML=u?`<img src="${b(u)}" alt="">`:'<span class="material-symbols-outlined" aria-hidden="true">image</span>',s.hidden=!u},w=u=>{l.value=u,l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))};async function y(u){if(!rc.has(u.type)){c("PNG, JPEG, GIF, or WEBP only.",!0);return}if(u.size>ic){c("That file is too large (8MB max before resizing).",!0);return}c("Uploading…",!1);try{const x=await lc(u),m=await fetch(`${ne()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({image:x})}),f=await m.json().catch(()=>({}));if(!m.ok||!f.ok)throw new Error(f.error||`Upload failed (${m.status})`);const _=`${ne()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;w(_),h(_),c("Logo updated.",!1)}catch(x){c(x.message||"Upload failed.",!0)}}n.addEventListener("change",()=>{n.files[0]&&y(n.files[0]),n.value=""}),a.addEventListener("click",u=>{u.target===s||s.contains(u.target)||u.target!==o&&n.click()}),o.addEventListener("click",()=>n.click()),["dragenter","dragover"].forEach(u=>a.addEventListener(u,x=>{x.preventDefault(),a.classList.add("is-dragover")})),["dragleave","drop"].forEach(u=>a.addEventListener(u,x=>{x.preventDefault(),a.classList.remove("is-dragover")})),a.addEventListener("drop",u=>{const x=u.dataTransfer?.files?.[0];x&&y(x)}),s.addEventListener("click",async u=>{u.stopPropagation(),c("Removing…",!1);try{const x=await fetch(`${ne()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"DELETE"}),m=await x.json().catch(()=>({}));if(!x.ok||!m.ok)throw new Error(m.error||`Remove failed (${x.status})`);w(""),h(""),c("Logo removed.",!1)}catch(x){c(x.message||"Remove failed.",!0)}})}function dc(e){return e.querySelector("#mag-f-surface-on")?.checked?{surface:e.querySelector("#mag-f-sv-surface").value,surface_2:e.querySelector("#mag-f-sv-surface2").value,border:e.querySelector("#mag-f-sv-border").value,text:e.querySelector("#mag-f-sv-text").value,text_sub:e.querySelector("#mag-f-sv-textsub").value}:{}}function pc(e){const t=e.querySelector("#mag-f-success-cta-label").value.trim(),a=e.querySelector("#mag-f-success-cta-url").value.trim();return t&&a?{label:t,url:a}:{}}function qo(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",s=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==s.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}const An=[{label:"Web fonts (loaded for you)",opts:[["Inter, sans-serif","Inter"],["Poppins, sans-serif","Poppins"],["Montserrat, sans-serif","Montserrat"],["Roboto, sans-serif","Roboto"],['"Open Sans", sans-serif',"Open Sans"],["Lato, sans-serif","Lato"],["Nunito, sans-serif","Nunito"],["Raleway, sans-serif","Raleway"],['"Work Sans", sans-serif',"Work Sans"],["Oswald, sans-serif","Oswald"],["Merriweather, serif","Merriweather (serif)"]]},{label:"System / always available",opts:[["system-ui, sans-serif","System UI"],["Georgia, serif","Georgia (serif)"],['"Times New Roman", Times, serif',"Times (serif)"],["Arial, Helvetica, sans-serif","Arial / Helvetica"],["Verdana, Geneva, sans-serif","Verdana"],['"Courier New", monospace',"Courier (mono)"]]}];function uc(e){const t=String(e||""),a=new Set(An.flatMap(s=>s.opts.map(([r])=>r))),n=s=>s===t?" selected":"";let o=`<option value=""${t===""?" selected":""}>System default</option>`;t&&!a.has(t)&&(o+=`<option value="${b(t)}" selected>Current: ${b(t)}</option>`);for(const s of An)o+=`<optgroup label="${b(s.label)}">`+s.opts.map(([r,i])=>`<option value="${b(r)}"${n(r)}>${b(i)}</option>`).join("")+"</optgroup>";return o}function Ft(e,t){const a=!!e,n=a?null:crypto.randomUUID(),o=!a&&V.owners.length>1,s=e?.display_mode||"chat",r=e?.theme_mode||"auto",i={};(e?.actions||[]).forEach(v=>{v&&v.type&&(i[v.type]=v)});const l=a?!!e.home:!0,c=a?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",h=e?.theme_vars&&typeof e.theme_vars=="object"?e.theme_vars:{},w=Object.keys(h).length>0,y=(v,$)=>b(/^#[0-9a-fA-F]{6}$/.test(h[v]||"")?h[v]:$),u=document.createElement("div");u.className="mag-modal-scrim",u.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${a?"Edit magnet":"New magnet"}">
      ...
      <div class="mag-modal__main">
        ...
        <select class="mag-modal__select" id="mag-f-owner">
          ${V.owners.map(v=>`<option value="${b(v.guid)}"${v.guid===V.primaryOrgGuid?" selected":""}>${b(v.name||v.guid)}</option>`).join("")}
        </select>`:""}
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${Ul.map(v=>`<option value="${v.value}"${(e?e.trigger||"none":"on_load")===v.value?" selected":""}>${b(v.label)}</option>`).join("")}
        </select>
        ...
        <div class="mag-modal__sec">
          ...
          <select class="mag-modal__select" id="mag-f-font">${uc(e?.font||"")}</select>
        ...
        <div class="mag-modal__sec">
          ...
          <select class="mag-modal__select" id="mag-f-ab-split">
            ${[25,50,75].map(v=>`<option value="${v}"${(e?.ab?.split||50)===v?" selected":""}>${v}% see B / ${100-v}% see A</option>`).join("")}
          </select>
        </div>
          </section>
    ...
    </div>`,document.body.appendChild(u),requestAnimationFrame(()=>{u.classList.add("open"),u.querySelector(".mag-modal").classList.add("open")});const x=[...u.querySelectorAll(".mag-modal__navitem")],m=[...u.querySelectorAll(".mag-tab")],f=v=>{x.forEach($=>$.classList.toggle("is-active",$.dataset.tab===v)),m.forEach($=>{$.hidden=$.dataset.tab!==v}),u.querySelector(".mag-modal__body").scrollTop=0};x.forEach(v=>v.addEventListener("click",()=>f(v.dataset.tab)));const _=()=>va({...e,...na(u),...a?{steps:wn()}:{}}),C=u.querySelector("#mag-preview-pane"),L=()=>window.matchMedia("(min-width: 1200px)").matches;let M=null;const ee=()=>{if(!M&&L())try{M=Rl(C,_)}catch{}};let Q=null;const se=()=>{L()&&(ee(),M&&(clearTimeout(Q),Q=setTimeout(()=>{try{M.refresh()}catch{}},300)))},ye=window.matchMedia("(min-width: 1200px)"),fe=()=>{L()&&(ee(),se())};ye.addEventListener("change",fe);let we=!1;const Te=u.querySelector("#mag-f-dirty"),k=v=>{we=v,Te&&(Te.hidden=!v)},R=u.querySelector(".mag-modal__main");R.addEventListener("input",()=>k(!0)),R.addEventListener("change",()=>{k(!0),se()}),u.querySelector("#mag-f-color")?.addEventListener("input",()=>{k(!0),se()});const xe=v=>{we&&(v.preventDefault(),v.returnValue="")};window.addEventListener("beforeunload",xe);let ft=!0;const Yt=d.subscribe(p.ROUTE_NAV_BEFORE,()=>{if(ft){if(we&&!confirm("Discard your changes to this magnet?")){window.router?.navigate("/magnets");return}Ne()}}),Ne=()=>{ft=!1,window.removeEventListener("beforeunload",xe),d.unsubscribe(Yt),clearTimeout(Q),ye.removeEventListener("change",fe),M&&M.destroy&&M.destroy(),u.classList.remove("open"),setTimeout(()=>u.remove(),180),document.removeEventListener("keydown",vt)},De=()=>{we&&!confirm("Discard your changes to this magnet?")||Ne()};function vt(v){v.key==="Escape"&&(v.preventDefault(),De())}document.addEventListener("keydown",vt),u.querySelector(".mag-modal__close").addEventListener("click",De),u.querySelector('[data-x="cancel"]').addEventListener("click",De),u.querySelector("[data-close-modal]")?.addEventListener("click",De),u.querySelector("#mag-f-name").focus();const g=u.querySelector("#mag-flow-panel");a?Cl(g,e,()=>{k(!0),se()}):g.innerHTML='<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>',cc(u,e),t&&f(t),ee(),u.querySelectorAll(".mag-cta").forEach(v=>{const $=v.querySelector(".mag-cta__on"),q=v.querySelector(".mag-cta__val"),j=v.querySelector(".mag-cta__opts"),_e=v.querySelectorAll(".mag-cta__booksrc, .mag-cta__calevent, .mag-cta__callsrc, .mag-cta__crtracker");$.addEventListener("change",()=>{q&&(q.disabled=!$.checked),j&&(j.disabled=!$.checked),_e.forEach(z=>{z.disabled=!$.checked}),$.checked&&(q||j)?.focus()}),q&&q.addEventListener("input",()=>{q.value.trim()&&!$.checked&&($.checked=!0,j&&(j.disabled=!1))})}),u.querySelectorAll('.mag-cta[data-kind="book"]').forEach(v=>{const $=v.querySelector(".mag-cta__booksrc"),q=v.querySelector(".mag-cta__val"),j=v.querySelector(".mag-cta__calevent");if(!$||!j)return;const _e=()=>{const z=$.value==="calendly";q.hidden=z,j.hidden=!z,z&&!j.dataset.listed&&(j.dataset.listed="1",Gl(j))};$.addEventListener("change",()=>{const z=v.querySelector(".mag-cta__on");z.checked||(z.checked=!0,z.dispatchEvent(new Event("change"))),_e()}),_e()}),u.querySelectorAll('.mag-cta[data-type="call"]').forEach(v=>{const $=v.querySelector(".mag-cta__callsrc"),q=v.querySelector(".mag-cta__val"),j=v.querySelector(".mag-cta__crtracker");if(!$||!j)return;const _e=()=>{const z=$.value==="callrail";q.hidden=z,j.hidden=!z,z&&!j.dataset.listed&&(j.dataset.listed="1",ql(j))};$.addEventListener("change",()=>{const z=v.querySelector(".mag-cta__on");z.checked||(z.checked=!0,z.dispatchEvent(new Event("change"))),_e()}),_e()});const A=u.querySelector("#mag-f-surface-on"),N=u.querySelector("#mag-f-surface");A.addEventListener("change",()=>N.hidden=!A.checked);const B=u.querySelector("#mag-f-inline-size");u.querySelectorAll('input[name="mag-display"]').forEach(v=>v.addEventListener("change",()=>{B.hidden=u.querySelector('input[name="mag-display"]:checked')?.value!=="inline"})),u.querySelector('[data-x="preview"]')?.addEventListener("click",()=>Do(()=>va({...e,...na(u),...a?{steps:wn()}:{}}))),u.querySelector('[data-x="save"]').addEventListener("click",async v=>{const $=v.currentTarget,q=u.querySelector("#mag-f-error"),j=u.querySelector("#mag-f-name").value.trim();if(!j){f("basics"),q.textContent="Please give your magnet a name.";return}const _e=u.querySelector("#mag-f-domains").value.split(",").map(J=>J.trim()).filter(Boolean);let z="";if(u.querySelectorAll(".mag-cta").forEach(J=>{const Ye=J.querySelector(".mag-cta__on").checked;if(J.dataset.kind==="book"){const rt=J.querySelector(".mag-cta__booksrc")?.value==="calendly";Ye&&rt&&!J.querySelector(".mag-cta__calevent")?.value&&(z=z||"Pick a Calendly event for the Book button, or switch it back to the built-in scheduler.");return}if(J.dataset.kind!=="value")return;if(J.dataset.type==="call"&&J.querySelector(".mag-cta__callsrc")?.value==="callrail"){Ye&&!J.querySelector(".mag-cta__crtracker")?.value&&(z=z||"Pick a CallRail tracking number for the Call button, or switch it back to a phone number.");return}const st=J.querySelector(".mag-cta__val").value.trim();Ye&&!st&&(z=z||`Add a target for the ${Ho[J.dataset.type].label} button, or uncheck it.`)}),z){f("welcome"),q.textContent=z;return}const Ma=qo(u);if(Ma.enabled&&!Object.keys(Ma.b).length){f("ab"),q.textContent="Give variant B at least one change (title, welcome, or color), or untick the A/B test.";return}if(a){const J=Il();if(J){f("flow"),$l(J.route,J.message);return}}const Jt={name:j,domains:_e,...na(u)};o&&(Jt.owner_guid=u.querySelector("#mag-f-owner").value);const Fa=a&&e.status==="DRAFT";Fa&&(Jt.status="ENABLED"),$.disabled=!0,q.textContent="";try{const J=a?`${ne()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${ne()}/m5t/v5/magnets`,Ye={"Content-Type":"application/json"};n&&(Ye["Idempotency-Key"]=n);const st=await fetch(J,{method:a?"PATCH":"POST",headers:Ye,body:JSON.stringify(Jt)});let rt={};try{rt=await st.json()}catch{}if(!st.ok||!rt.ok)throw new Error(rt.message||`Save failed (${st.status})`);a&&await Nl(e.guid),Le(Fa||!a?"Magnet created":"Magnet updated","success"),Ne(),await Wt()}catch(J){$.disabled=!1,q.textContent=J.message||"Something went wrong."}})}const mc=Object.freeze(Object.defineProperty({__proto__:null,cspNoteHTML:Uo,init:Kl,openModal:Ft,render:Jl,stepFunnelHTML:Vo},Symbol.toStringTag,{value:"Module"}));let kn=!1;const E={leads:[],magnetNames:{},filter:"ALL",canManage:!1,book:!1,ownerNames:{},clientFilter:"ALL",search:"",shown:100,selectedId:null},ut=100,_a=["NEW","WORKING","QUALIFIED","UNQUALIFIED","CONVERTED","EXPORTED"],gc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},O=e=>String(e??"").replace(/[&<>"']/g,t=>gc[t]),Pt=(e,t="info")=>{try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Dt=()=>S.getConfig?.().BASE_URL||"",Bt=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",jo=e=>(Bt(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase(),Oa=e=>e.created?.created_tz||"";function Qe(e){const t=Oa(e);if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric"})}catch{return""}}function hc(e){const t=Oa(e);if(!t)return"";try{const a=Date.now()-new Date(t).getTime();if(a<0)return Qe(e);const n=a/36e5;return n<1?`${Math.max(1,Math.floor(a/6e4))}m ago`:n<24?`${Math.floor(n)}h ago`:n<48?"Yesterday":Qe(e)}catch{return Qe(e)}}const fc=e=>{const t=Oa(e);if(!t)return!1;try{return Date.now()-new Date(t).getTime()<24*36e5}catch{return!1}};function vc(){if(kn)return;const e=document.createElement("style");e.id="m5t-leads-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),kn=!0}function mt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function _c(e){return`<select class="leads-status" data-id="${O(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${_a.map(t=>`<option value="${t}" ${e.status===t?"selected":""}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join("")}
  </select>`}function bc(e){const t=E.magnetNames[e.magnet_guid]||e.lead_source||"—",a=e.phone?String(e.phone).replace(/[^\d+]/g,""):"";return`
    <tr class="leads-row${String(e.id)===E.selectedId?" selected":""}" data-id="${O(e.id)}" tabindex="0" role="button" aria-label="Open lead ${O(Bt(e))}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${O(jo(e))}</span>
          <span><span class="leads-name">${O(Bt(e))}</span>${e.company?`<span class="leads-sub">${O(e.company)}</span>`:""}</span>
        </span>
      </td>
      ${E.book?`<td>${lo(E.ownerNames[e.owner_guid]||"")||'<span class="leads-muted">—</span>'}</td>`:""}
      <td>
      ...
      <td>${E.canManage?_c(e):`<span class="leads-badge" data-s="${O(e.status)}">${O(e.status)}</span>`}</td>
      <td class="num leads-muted" style="white-space:nowrap" title="${O(Qe(e))}">${fc(e)?'<span class="leads-fresh" title="Captured in the last 24 hours"></span>':""}${O(hc(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}const Wo=e=>E.clientFilter==="ALL"||e.owner_guid===E.clientFilter;function yc(e){const t=E.search.trim().toLowerCase();if(!t)return!0;const a=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,E.magnetNames[e.magnet_guid],E.book?E.ownerNames[e.owner_guid]:""].filter(Boolean).join(" ").toLowerCase();return t.split(/\s+/).every(n=>a.includes(n))}function Yo(){return E.leads.filter(e=>(E.filter==="ALL"||e.status===E.filter)&&Wo(e)&&yc(e))}const Jo=()=>mt("touch_app","Click to see lead information.");function wc(){vc(),nt();const e=te();return`
    <div class="page-shell" data-section="leads">
      ...
      <div class="dashboard-card" style="margin-bottom:24px">
        ...
        <div class="card-body" id="pf-picker-body">${mt("hourglass_empty","Loading…")}</div>
      </div>`:""}
      <div class="page-header">
        <div class="page-header-text">
      ...
      <div class="leads-layout">
        <div class="dashboard-card">
          <div class="card-body" id="leads-body">
            ${mt("hourglass_empty","Loading leads…")}
          </div>
        </div>
        <aside class="dashboard-card leads-panel" aria-label="Lead detail">
          <div class="card-body" id="leads-panel-body">${Jo()}</div>
        </aside>
      </div>
    </div>`}async function xc(){if(document.getElementById("leads-export")?.addEventListener("click",kc),te()){const e=t=>Number(t||0).toLocaleString();ot(Dt(),[{h:"Leads · wk",td:t=>e(t.leads.this_week)},{h:"Leads · total",td:t=>e(t.leads.total)},{h:"Compl.",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Ec()}async function Ec(){const e=document.getElementById("leads-body");if(e){try{const[t,a]=await Promise.all([fetch(`${Dt()}/m5t/v5/m5mLead`),fetch(`${Dt()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(E.leads=(n.data||[]).filter(o=>!["DELETED","ARCHIVED"].includes(o.status)),E.book=te(),E.ownerNames=E.book?io():{},a){const o=await a.json().catch(()=>({}));E.magnetNames={},(o.magnets||[]).forEach(s=>{E.magnetNames[s.guid]=s.name,s.owner_guid&&s.owner_name&&!E.ownerNames[s.owner_guid]&&(E.ownerNames[s.owner_guid]=s.owner_name)}),E.canManage=!!o.canManage}}catch{e.innerHTML=mt("error","Could not load your leads. Please try again.");return}Ut()}}const Sc=()=>`
  <colgroup>
    <col style="width:23%">
  ...
  </colgroup>`;function Ut(){const e=document.getElementById("leads-body"),t=document.getElementById("leads-export");if(!e)return;if(t&&(t.style.display=E.leads.length?"":"none"),!E.leads.length){e.innerHTML=mt("inbox","No leads captured yet. Publish a magnet and share it to start collecting.");return}const a=E.leads.filter(Wo),n={ALL:a.length};_a.forEach(s=>{n[s]=a.filter(r=>r.status===s).length});const o=E.book?[...new Set(E.leads.map(s=>s.owner_guid).filter(Boolean))].map(s=>({guid:s,name:E.ownerNames[s]||s})).sort((s,r)=>s.name.localeCompare(r.name)):[];e.innerHTML=`
    <div class="leads-bar">
      <div class="leads-filter">
        ${["ALL",..._a].map(s=>`<button data-filter="${s}" class="${E.filter===s?"active":""}">${s==="ALL"?"All":s[0]+s.slice(1).toLowerCase()}${n[s]?`<span class="leads-pillnum">${n[s]}</span>`:""}</button>`).join("")}
      </div>
      ${E.book&&o.length>1?`
      <select class="leads-clientsel" id="leads-clientsel" aria-label="Filter by client">
        <option value="ALL">All clients</option>
        ${o.map(s=>`<option value="${O(s.guid)}" ${E.clientFilter===s.guid?"selected":""}>${O(s.name)}</option>`).join("")}
      </select>`:""}
      <span class="leads-searchwrap">
        <span class="material-symbols-outlined" aria-hidden="true">search</span>
        <input class="leads-search" id="leads-search" type="search" placeholder="Search leads" value="${O(E.search)}" aria-label="Search leads" />
      </span>
      <span class="leads-count" id="leads-countlbl"></span>
    </div>
    <div id="leads-tablezone"></div>`,e.querySelector(".leads-filter")?.addEventListener("click",s=>{const r=s.target.closest("[data-filter]");r&&(E.filter=r.dataset.filter,E.shown=ut,Ut())}),e.querySelector("#leads-clientsel")?.addEventListener("change",s=>{E.clientFilter=s.target.value,E.shown=ut,Ut()}),e.querySelector("#leads-search")?.addEventListener("input",s=>{E.search=s.target.value,E.shown=ut,ba()}),ba()}function ba(){const e=document.getElementById("leads-tablezone"),t=document.getElementById("leads-countlbl");if(!e)return;const a=Yo(),n=a.slice(0,E.shown),o=E.book?8:7;t&&(t.textContent=`${a.length} of ${E.leads.length}`),e.innerHTML=`
    <div class="leads-tablewrap">
      <table class="leads-table">
        ...
        <tbody id="leads-tbody">${n.map(bc).join("")||`<tr><td colspan="${o}"><div class="leads-muted" style="padding:14px 4px">${E.search.trim()?"No leads match your search.":`No ${E.filter.toLowerCase()} leads.`}</div></td></tr>`}</tbody>
      </table>
    </div>
    ${a.length>E.shown?`<button class="leads-more" type="button" id="leads-more">Show ${Math.min(ut,a.length-E.shown)} more (${a.length-E.shown} remaining)</button>`:""}`,e.querySelector("#leads-more")?.addEventListener("click",()=>{E.shown+=ut,ba()}),e.querySelector("#leads-tbody")?.addEventListener("change",Ac),e.querySelector("#leads-tbody")?.addEventListener("click",s=>{if(s.target.closest(".leads-status, a.leads-contactlink"))return;const r=s.target.closest(".leads-row");r&&Cn(r.dataset.id)}),e.querySelector("#leads-tbody")?.addEventListener("keydown",s=>{if(s.key!=="Enter"&&s.key!==" ")return;const r=s.target.closest(".leads-row");r&&s.target===r&&(s.preventDefault(),Cn(r.dataset.id))})}async function Ac(e){const t=e.target.closest(".leads-status");if(!t)return;const a=t.dataset.id,n=E.leads.find(r=>String(r.id)===String(a)),o=t.value,s=n?.status;try{if(!(await(await fetch(`${Dt()}/m5t/v5/m5mLead/${encodeURIComponent(a)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:o})})).json().catch(()=>({}))).ok)throw new Error;n&&(n.status=o),Pt(`Marked ${o[0]}${o.slice(1).toLowerCase()}`,"success")}catch{t.value=s||"NEW",Pt("Could not update status","danger");return}try{String(a)===E.selectedId&&Qo(),E.filter!=="ALL"&&Ut()}catch(r){console.warn("[leads] re-render after status change failed:",r)}}function Cn(e){E.selectedId=String(e),document.querySelectorAll(".leads-row").forEach(t=>t.classList.toggle("selected",t.dataset.id===E.selectedId)),Qo()}function bt(e,t){const a=Array.isArray(e.tags)?e.tags:[];for(let n=a.length-1;n>=0;n--)if(a[n]&&a[n].tag===t&&a[n].value!=null)return String(a[n].value);return""}function Ko(e){const t=bt(e,"appointment_start");if(!t)return null;const a=bt(e,"appointment_status")||"booked",n=bt(e,"appointment_timezone"),o=bt(e,"appointment_event_type"),s=new Date(t);let r=t;if(!Number.isNaN(s.getTime())){const i={weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"};try{r=new Intl.DateTimeFormat(void 0,n?{...i,timeZone:n}:i).format(s)}catch{r=new Intl.DateTimeFormat(void 0,i).format(s)}}return{when:r,status:a,type:o,start:t}}const Tn={booked:["QUALIFIED","Booked"],rescheduled:["WORKING","Rescheduled"],canceled:["CANCELED","Canceled"]};function Xo(e){const t=Array.isArray(e.tags)?e.tags:[];let a=null;for(const l of t)if(!(!l||!l.tag)){if(l.tag==="callrail_call_id"){a={};continue}a&&l.tag.indexOf("call_")===0&&l.value!=null&&(a[l.tag]=String(l.value))}if(!a||!a.call_started)return null;const n=a.call_started,o=new Date(n);let s=n;Number.isNaN(o.getTime())||(s=new Intl.DateTimeFormat(void 0,{weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"}).format(o));const r=Number(a.call_duration)||0,i=r?r<60?`${r}s`:`${Math.floor(r/60)}m ${r%60}s`:"";return{when:s,dur:i,source:a.call_source||"",answered:a.call_answered||"",recording:a.call_recording_player||"",started:n}}function Qo(){const e=document.getElementById("leads-panel-body");if(!e)return;const t=E.leads.find(l=>String(l.id)===E.selectedId);if(!t){e.innerHTML=Jo();return}const a=E.magnetNames[t.magnet_guid]||t.lead_source||"—",n=Ko(t),[o,s]=n?Tn[n.status]||Tn.booked:["",""],r=Xo(t),i=(l,c)=>c?`<div class="leads-det__field"><span class="leads-det__k">${O(l)}</span><span class="leads-det__v">${O(c)}</span></div>`:"";e.innerHTML=`
    <div class="leads-det__head">
      <span class="leads-avatar leads-det__ava">${O(jo(t))}</span>
      <div>
        <div class="leads-det__name">${O(Bt(t))}</div>
    ...
    ${t.description?`<div class="leads-det__notes">${O(t.description)}</div>`:""}`}function kc(){const e=Yo();if(!e.length){Pt("Nothing to export","info");return}const t=["first_name","last_name","email","phone","company","product_interest","lead_source","utm_source","utm_medium","utm_campaign","gclid","status"],a=l=>`"${String(l??"").replace(/"/g,'""')}"`,o=[[...E.book?["client"]:[],...t,"magnet","captured","appointment","last_call"].join(",")];for(const l of e){const c=Ko(l),h=Xo(l);o.push([...E.book?[a(E.ownerNames[l.owner_guid]||"")]:[],...t.map(w=>a(l[w])),a(E.magnetNames[l.magnet_guid]||l.lead_source||""),a(Qe(l)),a(c?`${c.start} (${c.status})`:""),a(h?`${h.started} (${h.answered==="no"?"missed":"answered"})`:"")].join(","))}const s=new Blob([o.join(`
`)],{type:"text/csv"}),r=URL.createObjectURL(s),i=document.createElement("a");i.href=r,i.download=`leads-${E.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r),Pt(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const Cc=Object.freeze(Object.defineProperty({__proto__:null,init:xc,render:wc},Symbol.toStringTag,{value:"Module"})),Zo=()=>S.getConfig?.().BASE_URL||"",In=e=>e.toISOString().slice(0,10),$n=e=>e==null?"—":"$"+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),Xe=e=>Number(e||0).toLocaleString(),Tc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},yt=e=>String(e??"").replace(/[&<>"']/g,t=>Tc[t]);let Ln=!1;function Ic(){if(Ln)return;const e=document.createElement("style");e.id="m5t-adperf-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ln=!0}const Ze=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,wt=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
  ...
  </div>`,$c=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let Ht=30;function es(){return te()?gt({section:"ad-performance",title:"Ad Performance",description:"Pick a client to view their spend and lead performance."}):(Ic(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${$c.map(e=>`<button class="chart-period-btn${e.d===Ht?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-body">
          ${Ze("hourglass_empty","Loading ad performance…")}
        </div>
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-sources">
          ${Ze("hourglass_empty","Loading…")}
        </div>
      </div>
    </div>`)}async function ts(){if(te()){const t=a=>Number(a||0).toLocaleString();return ot(Zo(),[{h:"Spend",td:a=>a.ad?`$${t(a.ad.spend)}`:"—"},{h:"Clicks",td:a=>a.ad?t(a.ad.clicks):"—"},{h:"Leads",td:a=>t(a.leads.window??a.leads.total)},{h:"CPL",td:a=>a.ad?.cost_per_lead!=null?`$${t(a.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see spend here."})}const e=document.getElementById("adperf-periods");e?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(Ht=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===Ht)),Nn())}),await Nn()}async function Nn(){const e=Zo(),t=document.getElementById("adperf-body"),a=document.getElementById("adperf-range"),n=new Date,o=In(n),s=In(new Date(n.getTime()-(Ht-1)*864e5));a&&(a.textContent=`${s} → ${o}`);let r,i=[],l=null;try{const[h,w,y]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${s}&to=${o}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${s}&to=${o}`)]);if(!h.ok)throw new Error(`HTTP ${h.status}`);r=await h.json(),i=((await w.json().catch(()=>({})))?.data||[]).filter(x=>x.status!=="DELETED"),l=await y.json().catch(()=>null)}catch(h){console.warn("[ad-performance] load failed:",h),t&&(t.innerHTML=Ze("error","Could not load ad performance. Please try again."));return}const c=r.totals||{};if(xt("adperf-spend",$n(c.spend)),xt("adperf-clicks",Xe(c.clicks)),xt("adperf-leads",Xe(c.magnet_leads)),xt("adperf-cpl",$n(c.cost_per_lead)),Lc(l),!i.length){t.innerHTML=Ze("link_off","No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.");return}if(!r.connected){t.innerHTML=Ze("cloud_sync","Account connected. No ad data for this range yet. Metrics appear here once they sync.");return}t.innerHTML=Nc(r.rows||[])}function Lc(e){const t=document.getElementById("adperf-sources"),a=document.getElementById("adperf-src-summary");if(!t)return;const n=e&&Array.isArray(e.rows)?e.rows:[];if(!n.length){a&&(a.textContent=""),t.innerHTML=Ze("search_off","No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.");return}const o=e.total_leads||n.reduce((i,l)=>i+(l.leads||0),0),s=e.tracked_leads||0;a&&(a.textContent=`${Xe(s)} of ${Xe(o)} leads tagged to a source`);const r=i=>i.campaign&&i.campaign!=="(none)"?yt(i.campaign):i.source&&i.source!=="(direct)"?yt(i.source):'<span class="adperf-src-untracked">Untracked / direct</span>';t.innerHTML=`
    ...
    </div>`}function xt(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}function On(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}function Rn(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e)}function Nc(e){const u=e.length||1,x=On(Math.max(1,...e.map(k=>k.spend||0))),m=On(Math.max(1,...e.map(k=>k.magnet_leads||0))),f=738/u,_=Math.min(24,f*.55),C=k=>56+f*(k+.5),L=k=>304-k/x*282,M=k=>304-k/m*282,ee=[0,.25,.5,.75,1].map(k=>{const R=304-k*282;return`<line x1="56" y1="${R.toFixed(1)}" x2="794" y2="${R.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${(R+3.5).toFixed(1)}" text-anchor="end" class="ax">$${Rn(x*k)}</text><text x="802" y="${(R+3.5).toFixed(1)}" text-anchor="start" class="ax">${Rn(m*k)}</text>`}).join(""),Q=e.map((k,R)=>{const xe=L(k.spend||0);return`<rect x="${(C(R)-_/2).toFixed(1)}" y="${xe.toFixed(1)}" width="${_.toFixed(1)}" height="${Math.max(0,304-xe).toFixed(1)}" rx="3" fill="#0072BA"><title>${k.date}: $${k.spend} spend</title></rect>`}).join(""),se=e.map((k,R)=>`${C(R).toFixed(1)},${M(k.magnet_leads||0).toFixed(1)}`).join(" "),ye=u>1?`<polyline points="${se}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",fe=e.map((k,R)=>`<circle cx="${C(R).toFixed(1)}" cy="${M(k.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${k.date}: ${k.magnet_leads} leads</title></circle>`).join(""),we=Math.max(1,Math.ceil(u/6)),Te=e.map((k,R)=>R%we===0||R===u-1?`<text x="${C(R).toFixed(1)}" y="326" text-anchor="middle" class="ax">${k.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="adperf-chart" viewBox="0 0 840 340" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Ad spend versus magnet leads over time">
      ${ee}${Q}${ye}${fe}${Te}
    </svg>`}const Oc={render:es,init:ts},Rc=Object.freeze(Object.defineProperty({__proto__:null,default:Oc,init:ts,render:es},Symbol.toStringTag,{value:"Module"})),Mn="reseller_org",as="managed_client";let Fn=!1;const Mc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Y=e=>String(e??"").replace(/[&<>"']/g,t=>Mc[t]);function zt(e,t="info"){try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}}function Fc(){const e=S.getActiveOrg();if(e&&e.channel===Mn)return{guid:e.guid,name:e.name};const t=S.getMemberships().find(a=>a.channel===Mn);return t?{guid:t.orgGuid,name:t.name}:null}function Pc(e){const t=e?.created_tz;if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function Dc(){if(Fn)return;const e=document.createElement("style");e.id="m5t-clients-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Fn=!0}const Bc=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Tt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Uc(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
    <div class="client-row">
      <span class="client-row__avatar">${Y(Bc(t))}</span>
      <span class="client-row__main">
        <div class="client-row__name" title="${Y(t)}">${Y(t)}</div>
        <div class="client-row__meta">Added ${Y(Pc(e.created))||"—"}</div>
      </span>
    ...
    </div>`}async function os(){const e=Fc();document.getElementById("clients-add-btn")?.addEventListener("click",()=>Hc(e)),await ss(e)}async function ss(e){const t=document.getElementById("clients-body"),a=document.getElementById("clients-count");if(t){if(!e?.guid){t.innerHTML=Tt("info","Client provisioning is available to reseller / agency accounts."),a&&(a.textContent="");return}try{const n=S.getConfig?.().BASE_URL||"",o=await fetch(`${n}/m5t/v5/acctGroup`);if(!o.ok)throw new Error(`HTTP ${o.status}`);const s=await o.json(),i=(Array.isArray(s?.data)?s.data:[]).filter(l=>l.class===as&&(!l.parent||l.parent===e.guid));if(!i.length){t.innerHTML=Tt("group_off","No clients yet. Add your first client to start managing magnets on their behalf."),a&&(a.textContent="");return}t.innerHTML=`<div class="client-list">${i.map(Uc).join("")}</div>`,a&&(a.textContent=`${i.length} client${i.length===1?"":"s"}`),t.querySelectorAll(".client-card__invite").forEach(l=>{l.addEventListener("click",()=>{l.dataset.action==="adaccounts"?zc(l.dataset.clientGuid,l.dataset.clientName):Gc(l.dataset.clientGuid,l.dataset.clientName)})})}catch(n){console.warn("[clients] load failed:",n),t.innerHTML=Tt("error","Couldn’t load clients. Please try again."),a&&(a.textContent="")}}}function Hc(e){if(!e?.guid){zt("Only reseller / agency accounts can add clients.","error");return}const t=document.createElement("div");t.className="client-modal-scrim";const a=document.createElement("div");a.className="client-modal",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),document.body.appendChild(a),requestAnimationFrame(()=>{t.classList.add("open"),a.classList.add("open")});const n=a.querySelector("#client-name-input"),o=a.querySelector("#client-modal-error"),s=a.querySelector('[data-act="create"]');n?.focus();const r=()=>{t.classList.remove("open"),a.classList.remove("open"),document.removeEventListener("keydown",i),setTimeout(()=>{t.remove(),a.remove()},200)},i=c=>{c.key==="Escape"&&r()};document.addEventListener("keydown",i),t.addEventListener("click",r),a.querySelector(".client-modal__close")?.addEventListener("click",r),a.querySelector('[data-act="cancel"]')?.addEventListener("click",r);const l=async()=>{const c=(n?.value||"").trim();if(o.textContent="",!c){o.textContent="Please enter a client name.",n?.focus();return}s.disabled=!0;const h=s.innerHTML;s.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Adding…';try{const w=S.getConfig?.().BASE_URL||"",y=await fetch(`${w}/m5t/v5/acctGroup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({class:as,caption:c,parent:e.guid})}),u=await y.json().catch(()=>({}));if(!y.ok||!u?.ok){const x=y.status===403?"You are not authorized to add a client here.":u?.message||u?.error||`Failed (HTTP ${y.status})`;throw new Error(x)}zt(`Added client “${c}”`,"success"),r(),await ss(e)}catch(w){console.warn("[clients] create failed:",w),o.textContent=w.message||"Something went wrong. Please try again.",s.disabled=!1,s.innerHTML=h}};s?.addEventListener("click",l),n?.addEventListener("keydown",c=>{c.key==="Enter"&&l()})}const Pn=e=>String(e||"").replace(/[^0-9]/g,"");async function zc(e,t){const a=S.getConfig?.().BASE_URL||"",n={};try{const x=await fetch(`${a}/m5t/v5/coreAdAccount?owner_guid=${encodeURIComponent(e)}`),m=await x.json().catch(()=>({}));if(!x.ok)throw new Error(`Failed to load ad accounts (${x.status})`);(m?.data||[]).forEach(f=>{n[f.provider]=f})}catch(x){console.warn("[clients] ad-accounts prefill failed:",x)}const o=n.google_ads,s=n.google_lsa,r=document.createElement("div");r.className="client-modal-scrim";const i=document.createElement("div");i.className="client-modal",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.innerHTML=`
    <div class="client-modal__head">
    ...
    </div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add("open"),i.classList.add("open")});const l=i.querySelector("#aa-error"),c=i.querySelector('[data-act="save"]'),h=()=>{r.classList.remove("open"),i.classList.remove("open"),document.removeEventListener("keydown",w),setTimeout(()=>{r.remove(),i.remove()},200)},w=x=>{x.key==="Escape"&&h()};document.addEventListener("keydown",w),r.addEventListener("click",h),i.querySelector(".client-modal__close")?.addEventListener("click",h),i.querySelector('[data-act="cancel"]')?.addEventListener("click",h);const y=(x,m,f)=>{const _=`${a}/m5t/v5/coreAdAccount`;return m&&!f?fetch(_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,provider:x,external_customer_id:m})}):m&&f&&m!==f.external_customer_id?fetch(`${_}/${encodeURIComponent(f.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({external_customer_id:m})}):!m&&f?fetch(`${_}/${encodeURIComponent(f.guid)}`,{method:"DELETE"}):null},u=async()=>{l.textContent="";const x=Pn(i.querySelector("#aa-gads").value),m=Pn(i.querySelector("#aa-lsa").value),f=[y("google_ads",x,o),y("google_lsa",m,s)].filter(Boolean);if(!f.length){h();return}c.disabled=!0;const _=c.innerHTML;c.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const C=await Promise.all(f);for(const L of C)if(!L.ok){const M=await L.json().catch(()=>({}));throw new Error(L.status===403?"You are not authorized to connect accounts for this client.":M?.error||M?.message||`Failed (HTTP ${L.status})`)}zt("Ad accounts updated","success"),h()}catch(C){l.textContent=C.message||"Something went wrong. Please try again.",c.disabled=!1,c.innerHTML=_}};c?.addEventListener("click",u)}function Gc(e,t){if(!e)return;const a=document.createElement("div");a.className="client-modal-scrim";const n=document.createElement("div");n.className="client-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="invite-body">
      ...
      <div class="client-modal__actions">
    ...
    </div>`,document.body.appendChild(a),document.body.appendChild(n),requestAnimationFrame(()=>{a.classList.add("open"),n.classList.add("open")});const o=()=>{a.classList.remove("open"),n.classList.remove("open"),document.removeEventListener("keydown",s),setTimeout(()=>{a.remove(),n.remove()},200)},s=h=>{h.key==="Escape"&&o()};document.addEventListener("keydown",s),a.addEventListener("click",o),n.querySelector(".client-modal__close")?.addEventListener("click",o),n.querySelector('[data-act="cancel"]')?.addEventListener("click",o);const r=n.querySelector("#inv-email"),i=n.querySelector("#inv-error"),l=n.querySelector('[data-act="send"]');r?.focus();const c=h=>h.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(h.dataset.url),h.textContent="Copied!",setTimeout(()=>{h.textContent="Copy link"},1500)}catch{}});(async function(){const w=n.querySelector("#invite-pending");if(w)try{const y=S.getConfig?.().BASE_URL||"",u=await fetch(`${y}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invites`),x=await u.json().catch(()=>({})),m=u.ok&&x.ok&&Array.isArray(x.invites)?x.invites:[];if(!m.length){w.innerHTML="";return}w.innerHTML=`
        <div class="invite-pending">
          <div class="invite-pending__label">Pending invites</div>
          ${m.map(f=>`
            <div class="invite-pending__row">
              <span class="invite-pending__email${f.expired?" expired":""}" title="${Y(f.email)}">${Y(f.email)}${f.expired?" · expired":""}</span>
              <button class="client-modal__btn client-modal__btn--ghost invite-pending__copy" type="button" data-url="${Y(f.inviteUrl)}">Copy link</button>
            </div>`).join("")}
        </div>`,w.querySelectorAll(".invite-pending__copy").forEach(c)}catch{w.innerHTML=""}})(),l?.addEventListener("click",async()=>{const h=(n.querySelector("#inv-email").value||"").trim(),w=(n.querySelector("#inv-first").value||"").trim(),y=(n.querySelector("#inv-last").value||"").trim();if(i.textContent="",!h||!w||!y){i.textContent="Email, first, and last name are required.";return}l.disabled=!0;const u=l.innerHTML;l.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Sending…';try{const x=S.getConfig?.().BASE_URL||"",m=await fetch(`${x}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:h,first:w,last:y})}),f=await m.json().catch(()=>({}));if(!m.ok||!f.ok){const C=m.status===409?"A user with that email already exists.":m.status===403?"You are not authorized to invite for this client.":f.message||f.error||`Failed (HTTP ${m.status})`;throw new Error(C)}zt(`Invite created for ${h}`,"success"),n.querySelector("#invite-body").innerHTML=`
        <div class="client-modal__result">
          ...
          <p>${f.emailQueued?`An invite email is on its way to <strong>${Y(h)}</strong>.`:`Invite created for <strong>${Y(h)}</strong>.`}</p>
          ...
          <div class="client-modal__linkrow">
            <input class="client-modal__input" id="inv-link" type="text" readonly value="${Y(f.inviteUrl)}" />
        ...
        </div>`;const _=n.querySelector("#inv-link");n.querySelector("#inv-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(_.value),n.querySelector("#inv-copy").textContent="Copied!"}catch{_.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",o)}catch(x){console.warn("[clients] invite failed:",x),i.textContent=x.message||"Something went wrong. Please try again.",l.disabled=!1,l.innerHTML=u}})}const Vc={render:ns,init:os},qc=Object.freeze(Object.defineProperty({__proto__:null,default:Vc,init:os,render:ns},Symbol.toStringTag,{value:"Module"})),Dn="managed_client";let Bn=!1;const jc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ie=e=>String(e??"").replace(/[&<>"']/g,t=>jc[t]),Un=(e,t="info")=>{try{d.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Wc=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Yc(){const e=S.getActiveOrg();let t=e&&e.channel!==Dn?e:null;if(!t){const n=S.getMemberships().find(o=>o.channel!==Dn);n&&(t={guid:n.orgGuid,channel:n.channel,memberRole:n.memberRole})}if(!t)return null;const a=S.getMemberships().find(n=>n.orgGuid===t.guid)?.name;return{...t,name:a}}function Jc(e){return Object.values(dt).filter(t=>er(e,t.value)).sort((t,a)=>a.rank-t.rank)}function Kc(){if(Bn)return;const e=document.createElement("style");e.id="m5t-team-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Bn=!0}function Gt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Xc(e){const t=e.member_role||"member";return`
    <div class="team-row">
      <span class="team-avatar">${ie(Wc(e.name||e.email))}</span>
      <span class="team-main">
        <div class="team-name">${ie(e.name||e.email)}${e.verified?"":' · <span style="color:var(--color-text-subtle,#6C7C9A);font-weight:400;">pending verification</span>'}</div>
        <div class="team-email" title="${ie(e.email)}">${ie(e.email)}</div>
      </span>
      <span class="team-role" data-role="${ie(t)}">${ie(dt[t]?.label||t)}</span>
    </div>`}function rs(){return Kc(),`
    <div class="page-shell" data-section="team">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="team-body">
          ${Gt("hourglass_empty","Loading team…")}
        </div>
      </div>
    </div>`}async function is(){const e=Yc(),t=document.getElementById("team-invite-btn");if(!e){t&&(t.style.display="none"),document.getElementById("team-body").innerHTML=Gt("info","Team management is available for agency and workspace accounts.");return}t?.addEventListener("click",()=>Qc(e)),await Ra(e)}async function Ra(e){const t=document.getElementById("team-body"),a=document.getElementById("team-count");if(t)try{const n=S.getConfig?.().BASE_URL||"",[o,s]=await Promise.all([fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/members`),fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/invites`)]),[r,i]=await Promise.all([o.json().catch(()=>({})),s.json().catch(()=>({}))]);if(!o.ok||!s.ok)throw new Error(`Failed to load team (members: ${o.status}, invites: ${s.status})`);const l=r.members||[],c=i.invites||[],h=c.length?`
      <div class="team-pending">
        <div class="team-pending__label">Pending invites</div>
        ${c.map(w=>`
          <div class="team-pending__row">
            <span class="team-pending__email" title="${ie(w.email)}">${ie(w.email)}${w.expired?" · expired":""}</span>
            <button class="team-modal__btn team-modal__btn--ghost team-copy" type="button" data-url="${ie(w.inviteUrl)}">Copy link</button>
          </div>`).join("")}
      </div>`:"";t.innerHTML=h+(l.length?`<div class="team-list">${l.map(Xc).join("")}</div>`:Gt("group","No members yet.")),a&&(a.textContent=`${l.length} member${l.length===1?"":"s"}`),t.querySelectorAll(".team-copy").forEach(w=>w.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(w.dataset.url),w.textContent="Copied!",setTimeout(()=>{w.textContent="Copy link"},1500)}catch{}}))}catch(n){console.warn("[team] load failed:",n),t.innerHTML=Gt("error","Couldn’t load the team. Please try again.")}}function Qc(e){const t=Jc(e.memberRole);if(!t.length){Un("You don’t have permission to invite teammates.","error");return}const a=document.createElement("div");a.className="team-modal-scrim";const n=document.createElement("div");n.className="team-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    ...
    <div class="team-modal__body" id="team-invite-body">
      <p class="team-modal__sub">They'll get a link to set a password and join <strong>${ie(e.name||"your workspace")}</strong>.</p>
      ...
      <select class="team-modal__select" id="tm-role">
        ${t.map(l=>`<option value="${l.value}"${l.value==="member"?" selected":""}>${ie(l.label)}</option>`).join("")}
      </select>
      ...
      <div class="team-modal__actions">
        ...
        </div>`;const f=n.querySelector("#tm-link");n.querySelector("#tm-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(f.value),n.querySelector("#tm-copy").textContent="Copied!"}catch{f.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",()=>{o(),Ra(e)})}catch(u){console.warn("[team] invite failed:",u),r.textContent=u.message||"Something went wrong. Please try again.",i.disabled=!1,i.innerHTML=y}})}const Zc={render:rs,init:is},ed=Object.freeze(Object.defineProperty({__proto__:null,default:Zc,init:is,loadTeam:Ra,render:rs},Symbol.toStringTag,{value:"Module"}));
