(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const wl="modulepreload",xl=function(e,t){return new URL(e,t).href},vo={},W=function(t,a,n){let o=Promise.resolve();if(a&&a.length>0){let c=function(g){return Promise.all(g.map(b=>Promise.resolve(b).then(d=>({status:"fulfilled",value:d}),d=>({status:"rejected",reason:d}))))};const r=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");o=c(a.map(g=>{if(g=xl(g,n),g in vo)return;vo[g]=!0;const b=g.endsWith(".css"),d=b?'[rel="stylesheet"]':"";if(n)for(let f=r.length-1;f>=0;f--){const p=r[f];if(p.href===g&&(!b||p.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${g}"]${d}`))return;const m=document.createElement("link");if(m.rel=b?"stylesheet":wl,b||(m.as="script"),m.crossOrigin="",m.href=g,l&&m.setAttribute("nonce",l),document.head.appendChild(m),b)return new Promise((f,p)=>{m.addEventListener("load",f),m.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${g}`)))})}))}function s(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return o.then(r=>{for(const i of r||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})};var El=/([:*])(\w+)/g,kl="([^/]+)",Al=/\*/g,Sl="?(?:.*)",Cl=/\/\?/g,Tl="/?([^/]+|)",$l="(?:/^|^)",Ll="";function Ws(e){return e===void 0&&(e="/"),Un()?location.pathname+location.search+location.hash:e}function se(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function Aa(e){return typeof e=="string"}function Il(e){return typeof e=="function"}function Sa(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function Rl(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(a,n,o){return a===null&&(a={}),a[t[o]]=decodeURIComponent(n),a},null)}function Ca(e){var t=se(e).split(/\?(.*)?$/);return[se(t[0]),t.slice(1).join("")]}function qn(e){for(var t={},a=e.split("&"),n=0;n<a.length;n++){var o=a[n].split("=");if(o[0]!==""){var s=decodeURIComponent(o[0]);t[s]?(Array.isArray(t[s])||(t[s]=[t[s]]),t[s].push(decodeURIComponent(o[1]||""))):t[s]=decodeURIComponent(o[1]||"")}}return t}function Ys(e,t){var a=Ca(se(e.currentLocationPath)),n=a[0],o=a[1],s=o===""?null:qn(o),r=[],i;if(Aa(t.path)){if(i=$l+se(t.path).replace(El,function(b,d,m){return r.push(m),kl}).replace(Al,Sl).replace(Cl,Tl)+"$",se(t.path)===""&&se(n)==="")return{url:n,queryString:o,hashString:Sa(e.to),route:t,data:null,params:s}}else i=t.path;var l=new RegExp(i,Ll),c=n.match(l);if(c){var g=Aa(t.path)?Rl(c,r):c.groups?c.groups:c.slice(1);return{url:se(n.replace(new RegExp("^"+e.instance.root),"")),queryString:o,hashString:Sa(e.to),route:t,data:g,params:s}}return!1}function Ks(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function _t(e,t){return typeof e[t]>"u"||e[t]===!0}function Nl(e){if(!e)return{};var t=e.split(","),a={},n;return t.forEach(function(o){var s=o.split(":").map(function(r){return r.replace(/(^ +| +$)/g,"")});switch(s[0]){case"historyAPIMethod":a.historyAPIMethod=s[1];break;case"resolveOptionsStrategy":n||(n={}),n.strategy=s[1];break;case"resolveOptionsHash":n||(n={}),n.hash=s[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":a[s[0]]=s[1]==="true";break}}),n&&(a.resolveOptions=n),a}function Un(){return typeof window<"u"}function Ol(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(a){return a}).forEach(function(a){["before","after","already","leave"].forEach(function(n){a[n]&&(t[n]||(t[n]=[]),t[n].push(a[n]))})}),t}function ze(e,t,a){var n=t||{},o=0;(function s(){if(!e[o]){a&&a(n);return}Array.isArray(e[o])?(e.splice.apply(e,[o,1].concat(e[o][0](n)?e[o][1]:e[o][2])),s()):e[o](n,function(r){typeof r>"u"||r===!0?(o+=1,s()):a&&a(n)})})()}ze.if=function(e,t,a){return Array.isArray(t)||(t=[t]),Array.isArray(a)||(a=[a]),[e,t,a]};function bo(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=Ws(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function tn(e,t){for(var a=0;a<e.instance.routes.length;a++){var n=e.instance.routes[a],o=Ys(e,n);if(o&&(e.matches||(e.matches=[]),e.matches.push(o),e.resolveOptions.strategy==="ONE")){t();return}}t()}function Ml(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function Pl(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var _o=Un(),Fl=Ks();function Dl(e,t){if(_t(e.navigateOptions,"updateBrowserURL")){var a=("/"+e.to).replace(/\/\//g,"/"),n=_o&&e.resolveOptions&&e.resolveOptions.hash===!0;Fl?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",n?"#"+a:a),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!n){var o=location.hash;location.hash="",location.hash=o}e.instance.__freezeListening=!1},1))):_o&&(window.location.href=e.to)}t()}function Js(e,t){var a=e.instance;if(!a.lastResolved()){t();return}ze(a.lastResolved().map(function(n){return function(o,s){if(!n.route.hooks||!n.route.hooks.leave){s();return}var r=!1,i=e.instance.matchLocation(n.route.path,e.currentLocationPath,!1);if(n.route.path!=="*")r=!i;else{var l=e.matches?e.matches.find(function(c){return n.route.path===c.route.path}):!1;r=!l}if(_t(e.navigateOptions,"callHooks")&&r){ze(n.route.hooks.leave.map(function(c){return function(g,b){return c(function(d){d===!1?e.instance.__markAsClean(e):b()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return s()}]));return}else s()}}),{},function(){return t()})}function Bl(e,t){e.match.route.hooks&&e.match.route.hooks.before&&_t(e.navigateOptions,"callHooks")?ze(e.match.route.hooks.before.map(function(a){return function(o,s){return a(function(r){r===!1?e.instance.__markAsClean(e):s()},e.match)}}).concat([function(){return t()}])):t()}function ql(e,t){_t(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function Ul(e,t){e.match.route.hooks&&e.match.route.hooks.after&&_t(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(a){return a(e.match)}),t()}function zl(e,t){var a=e.instance.lastResolved();if(a&&a[0]&&a[0].route===e.match.route&&a[0].url===e.match.url&&a[0].queryString===e.match.queryString){a.forEach(function(n){n.route.hooks&&n.route.hooks.already&&_t(e.navigateOptions,"callHooks")&&n.route.hooks.already.forEach(function(o){return o(e.match)})}),t(!1);return}t()}function Hl(e,t){var a=e.instance._notFoundRoute;if(a){e.notFoundHandled=!0;var n=Ca(e.currentLocationPath),o=n[0],s=n[1],r=Sa(e.to);a.path=se(o);var i={url:a.path,queryString:s,hashString:r,data:null,route:a,params:s!==""?qn(s):null};e.matches=[i],e.match=i}t()}function jl(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function Gl(e,t){e.instance._setCurrent(null),t()}function Qs(e,t){_t(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var Xs=[zl,Bl,ql,Ul],yo=[Js,Hl,ze.if(function(e){var t=e.notFoundHandled;return t},Xs.concat([Qs]),[jl,Gl])];function fn(){return fn=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},fn.apply(this,arguments)}function wo(e,t){var a=0;function n(){if(a===e.matches.length){Qs(e,t);return}ze(Xs,fn({},e,{match:e.matches[a]}),function(){a+=1,n()})}Js(e,n)}function an(e){e.instance.__markAsClean(e)}function vn(){return vn=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},vn.apply(this,arguments)}var xo="[data-navigo]";function Vl(e,t){var a=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:xo},n=this,o="/",s=null,r=[],i=!1,l,c=Ks(),g=Un();e?o=se(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function b(_){return _.indexOf("#")>=0&&(a.hash===!0?_=_.split("#")[1]||"/":_=_.split("#")[0]),_}function d(_){return se(o+"/"+se(_))}function m(_,A,M,Y){return _=Aa(_)?d(_):_,{name:Y||se(String(_)),path:_,handler:A,hooks:Ol(M)}}function f(_,A,M){var Y=this;return typeof _=="object"&&!(_ instanceof RegExp)?(Object.keys(_).forEach(function(z){if(typeof _[z]=="function")Y.on(z,_[z]);else{var Le=_[z],rt=Le.uses,S=Le.as,V=Le.hooks;r.push(m(z,rt,[l,V],S))}}),this):(typeof _=="function"&&(M=A,A=_,_=o),r.push(m(_,A,[l,M])),this)}function p(_,A){if(n.__dirty){n.__waiting.push(function(){return n.resolve(_,A)});return}else n.__dirty=!0;_=_?se(o)+"/"+se(_):void 0;var M={instance:n,to:_,currentLocationPath:_,navigateOptions:{},resolveOptions:vn({},a,A)};return ze([bo,tn,ze.if(function(Y){var z=Y.matches;return z&&z.length>0},wo,yo)],M,an),M.matches?M.matches:!1}function v(_,A){if(n.__dirty){n.__waiting.push(function(){return n.navigate(_,A)});return}else n.__dirty=!0;_=se(o)+"/"+se(_);var M={instance:n,to:_,navigateOptions:A||{},resolveOptions:A&&A.resolveOptions?A.resolveOptions:a,currentLocationPath:b(_)};ze([Ml,Pl,tn,ze.if(function(Y){var z=Y.matches;return z&&z.length>0},wo,yo),Dl,an],M,an)}function x(_,A,M){var Y=me(_,A);return Y!==null?(v(Y.replace(new RegExp("^/?"+o),""),M),!0):!1}function y(_){return this.routes=r=r.filter(function(A){return Aa(_)?se(A.path)!==se(_):Il(_)?_!==A.handler:String(A.path)!==String(_)}),this}function T(){c&&(this.__popstateListener=function(){n.__freezeListening||p()},window.addEventListener("popstate",this.__popstateListener))}function N(){this.routes=r=[],c&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=i=!0}function U(_,A){return n._notFoundRoute=m("*",_,[l,A],"__NOT_FOUND__"),this}function L(){if(g)return j().forEach(function(_){if(_.getAttribute("data-navigo")==="false"||_.getAttribute("target")==="_blank"){_.hasListenerAttached&&_.removeEventListener("click",_.navigoHandler);return}_.hasListenerAttached||(_.hasListenerAttached=!0,_.navigoHandler=function(A){if((A.ctrlKey||A.metaKey)&&A.target.tagName.toLowerCase()==="a")return!1;var M=_.getAttribute("href");if(typeof M>"u"||M===null)return!1;if(M.match(/^(http|https)/)&&typeof URL<"u")try{var Y=new URL(M);M=Y.pathname+Y.search}catch{}var z=Nl(_.getAttribute("data-navigo-options"));i||(A.preventDefault(),A.stopPropagation(),n.navigate(se(M),z))},_.addEventListener("click",_.navigoHandler))}),n}function j(){return g?[].slice.call(document.querySelectorAll(a.linksSelector||xo)):[]}function K(_){return"/"+o+"/"+se(_)}function J(_){return l=_,this}function ae(){return s}function me(_,A,M){var Y=r.find(function(rt){return rt.name===_}),z=null;if(Y){if(z=Y.path,A)for(var Le in A)z=z.replace(":"+Le,A[Le]);z=z.match(/^\//)?z:"/"+z}return z&&M&&!M.includeRoot&&(z=z.replace(new RegExp("^/"+o),"")),z}function D(_){return _.getAttribute("href")}function le(_){var A=Ca(se(_)),M=A[0],Y=A[1],z=Y===""?null:qn(Y),Le=Sa(_),rt=m(M,function(){},[l],M);return{url:M,queryString:Y,hashString:Le,route:rt,data:null,params:z}}function H(){return le(se(Ws(o)).replace(new RegExp("^"+o),""))}function Z(_){var A={instance:n,currentLocationPath:_,to:_,resolveOptions:a};return tn(A,function(){}),A.matches?A.matches:!1}function ot(_,A,M){typeof A<"u"&&(typeof M>"u"||M)&&(A=d(A));var Y={instance:n,to:A,currentLocationPath:A};bo(Y,function(){}),typeof _=="string"&&(_=typeof M>"u"||M?d(_):_);var z=Ys(Y,{name:String(_),path:_,handler:function(){},hooks:{}});return z||!1}function st(_,A,M){return typeof A=="string"&&(A=Bt(A)),A?(A.hooks[_]||(A.hooks[_]=[]),A.hooks[_].push(M),function(){A.hooks[_]=A.hooks[_].filter(function(Y){return Y!==M})}):(console.warn("Route doesn't exists: "+A),function(){})}function Bt(_){return typeof _=="string"?r.find(function(A){return A.name===d(_)}):r.find(function(A){return A.handler===_})}function Za(_){_.instance.__dirty=!1,_.instance.__waiting.length>0&&_.instance.__waiting.shift()()}this.root=o,this.routes=r,this.destroyed=i,this.current=s,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=Za,this.on=f,this.off=y,this.resolve=p,this.navigate=v,this.navigateByName=x,this.destroy=N,this.notFound=U,this.updatePageLinks=L,this.link=K,this.hooks=J,this.extractGETParameters=function(_){return Ca(b(_))},this.lastResolved=ae,this.generate=me,this.getLinkPath=D,this.match=Z,this.matchLocation=ot,this.getCurrentLocation=H,this.addBeforeHook=st.bind(this,"before"),this.addAfterHook=st.bind(this,"after"),this.addAlreadyHook=st.bind(this,"already"),this.addLeaveHook=st.bind(this,"leave"),this.getRoute=Bt,this._pathToMatchObject=le,this._clean=se,this._checkForAHash=b,this._setCurrent=function(_){return s=n.current=_},T.call(this),L.call(this)}var Wl=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Yl(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Ht={exports:{}},Kl=Ht.exports,Eo;function Jl(){return Eo||(Eo=1,(function(e,t){(function(a,n){var o={};a.PubSub?(o=a.PubSub,console.warn("PubSub already loaded, using existing version")):(a.PubSub=o,n(o)),e!==void 0&&e.exports&&(t=e.exports=o),t.PubSub=o,e.exports=t=o})(typeof window=="object"&&window||Kl||Wl,function(a){var n={},o=-1,s="*";function r(p){var v;for(v in p)if(Object.prototype.hasOwnProperty.call(p,v))return!0;return!1}function i(p){return function(){throw p}}function l(p,v,x){try{p(v,x)}catch(y){setTimeout(i(y),0)}}function c(p,v,x){p(v,x)}function g(p,v,x,y){var T=n[v],N=y?c:l,U;if(Object.prototype.hasOwnProperty.call(n,v))for(U in T)Object.prototype.hasOwnProperty.call(T,U)&&N(T[U],p,x)}function b(p,v,x){return function(){var T=String(p),N=T.lastIndexOf(".");for(g(p,p,v,x);N!==-1;)T=T.substr(0,N),N=T.lastIndexOf("."),g(p,T,v,x);g(p,s,v,x)}}function d(p){var v=String(p),x=!!(Object.prototype.hasOwnProperty.call(n,v)&&r(n[v]));return x}function m(p){for(var v=String(p),x=d(v)||d(s),y=v.lastIndexOf(".");!x&&y!==-1;)v=v.substr(0,y),y=v.lastIndexOf("."),x=d(v);return x}function f(p,v,x,y){p=typeof p=="symbol"?p.toString():p;var T=b(p,v,y),N=m(p);return N?(x===!0?T():setTimeout(T,0),!0):!1}a.publish=function(p,v){return f(p,v,!1,a.immediateExceptions)},a.publishSync=function(p,v){return f(p,v,!0,a.immediateExceptions)},a.subscribe=function(p,v){if(typeof v!="function")return!1;p=typeof p=="symbol"?p.toString():p,Object.prototype.hasOwnProperty.call(n,p)||(n[p]={});var x="uid_"+String(++o);return n[p][x]=v,x},a.subscribeAll=function(p){return a.subscribe(s,p)},a.subscribeOnce=function(p,v){var x=a.subscribe(p,function(){a.unsubscribe(x),v.apply(this,arguments)});return a},a.clearAllSubscriptions=function(){n={}},a.clearSubscriptions=function(v){var x;for(x in n)Object.prototype.hasOwnProperty.call(n,x)&&x.indexOf(v)===0&&delete n[x]},a.countSubscriptions=function(v){var x,y,T=0;for(x in n)if(Object.prototype.hasOwnProperty.call(n,x)&&x.indexOf(v)===0){for(y in n[x])T++;break}return T},a.getSubscriptions=function(v){var x,y=[];for(x in n)Object.prototype.hasOwnProperty.call(n,x)&&x.indexOf(v)===0&&y.push(x);return y},a.unsubscribe=function(p){var v=function(K){var J;for(J in n)if(Object.prototype.hasOwnProperty.call(n,J)&&J.indexOf(K)===0)return!0;return!1},x=typeof p=="string"&&(Object.prototype.hasOwnProperty.call(n,p)||v(p)),y=!x&&typeof p=="string",T=typeof p=="function",N=!1,U,L,j;if(x){a.clearSubscriptions(p);return}for(U in n)if(Object.prototype.hasOwnProperty.call(n,U)){if(L=n[U],y&&L[p]){delete L[p],N=p;break}if(T)for(j in L)Object.prototype.hasOwnProperty.call(L,j)&&L[j]===p&&(delete L[j],N=!0)}return N}})})(Ht,Ht.exports)),Ht.exports}var Ql=Jl();const u=Yl(Ql),h=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV.GO",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN.GO",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP.GO",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT.GO",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT.GO",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH.GO",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",AUTH_SCOPE_LOADED:"AUTH.SCOPE.LOADED",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",M5T_SIDE_NAV:"M5T_SIDE_NAV",M5T_SIDE_NAV_TAP:"M5T_SIDE_NAV.TAP",M5T_SIDE_NAV_COLLAPSE:"M5T_SIDE_NAV.COLLAPSE",M5T_SIDE_NAV_LOGO_TAP:"M5T_SIDE_NAV.LOGO_TAP",M5T_SIDE_NAV_ORG_SWITCH:"M5T_SIDE_NAV.ORG_SWITCH",M5T_SIDE_NAV_FOOTER_ACTION:"M5T_SIDE_NAV.FOOTER_ACTION",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_THEME_CHANGED:"UI.THEME.CHANGED",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL",MESSAGE:"MESSAGE",MESSAGE_CREATE:"MESSAGE.CREATE",MESSAGE_CREATED:"MESSAGE.CREATED",MESSAGE_EDIT:"MESSAGE.EDIT",MESSAGE_UPDATED:"MESSAGE.UPDATED",MESSAGE_DELETE:"MESSAGE.DELETE",MESSAGE_DELETED:"MESSAGE.DELETED",MESSAGE_REFRESH:"MESSAGE.REFRESH"}),nn={BASE_URL:"./",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://machfivemagnet-saas.onrender.com"};var on={};const G=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_UI_DARK_MODE:!0,FF_SSE_UI_ANIMATIONS:!0,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel",FF_API_RATELIMIT_SIGNIN_ENFORCE:!1,FF_API_RATELIMIT_SIGNIN_IP_LIMIT:20,FF_API_RATELIMIT_SIGNIN_EMAIL_LIMIT:10,FF_API_RATELIMIT_FORGOT_ENFORCE:!1,FF_API_RATELIMIT_FORGOT_IP_LIMIT:15,FF_API_RATELIMIT_FORGOT_EMAIL_LIMIT:5,FF_API_RATELIMIT_CAPTURE_ENFORCE:!1,FF_API_RATELIMIT_CAPTURE_LIMIT:30,FF_API_RATELIMIT_EVENT_ENFORCE:!1,FF_API_RATELIMIT_EVENT_LIMIT:600,FF_API_RATELIMIT_CSP_PING_ENFORCE:!1,FF_API_RATELIMIT_CSP_PING_LIMIT:30,FF_API_RATELIMIT_WEBAUTHN_AUTH_ENFORCE:!1,FF_API_RATELIMIT_WEBAUTHN_AUTH_IP_LIMIT:20,FF_API_RATELIMIT_INTEGRATIONS_ENFORCE:!1,FF_API_RATELIMIT_INTEGRATIONS_LIMIT:60,FF_API_RATELIMIT_QUESTIONNAIRE_ENFORCE:!1,FF_API_RATELIMIT_QUESTIONNAIRE_LIMIT:30,FF_API_RATELIMIT_PAIRING_ENFORCE:!1,FF_API_RATELIMIT_PAIRING_LIMIT:20,FF_API_RATELIMIT_SITE_OPS_ENFORCE:!1,FF_API_RATELIMIT_SITE_OPS_LIMIT:120,FF_API_RATELIMIT_AUTHENTICATED_ENFORCE:!1,FF_API_RATELIMIT_AUTHENTICATED_LIMIT:600,FF_API_MAGNET_REQUIRE_ORIGIN_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_LIMIT:2e3});function Zs(e,t=null){if(e in G)return G[e];if(typeof process<"u"&&on&&on[e]){const a=on[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}if(typeof import.meta<"u"&&nn&&nn[e]){const a=nn[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}return t}function zn(e){return Zs(e,!1)===!0}function Xl(){return{...G}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:G,getFlag:Zs,isEnabled:zn,getAllFlags:Xl});const ko={success:{border:"var(--color-success, #009473)",bg:"var(--color-success-soft, rgba(0,148,115,0.10))",icon:"check_circle"},danger:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},error:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},warning:{border:"var(--color-warning, #D97706)",bg:"var(--color-warning-soft, #FEF3C7)",icon:"warning"},info:{border:"var(--color-info, #0D9488)",bg:"var(--color-info-soft, #CCFBF1)",icon:"info"}},Zl=4500,bn=220;let je=null,Ao=!1;function ec(){if(Ao)return;const e=document.createElement("style");e.id="m5t-toast-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ao=!0}function tc(){return je&&document.body.contains(je)||(je=document.createElement("div"),je.className="m5t-toast-stack",je.setAttribute("role","status"),je.setAttribute("aria-live","polite"),document.body.appendChild(je)),je}function ac(e){const t=e&&e.message;if(!t)return;ec();const a=ko[e.type]||ko.info,n=document.createElement("div");n.className="m5t-toast",n.style.borderColor=a.border,n.style.background=a.bg,n.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true" style="color:${a.border}">${a.icon}</span><span class="m5t-toast__msg"></span><button type="button" class="m5t-toast__close" aria-label="Dismiss"><span class="material-symbols-outlined" aria-hidden="true">close</span></button>`,n.querySelector(".m5t-toast__msg").textContent=String(t),tc().appendChild(n),requestAnimationFrame(()=>n.classList.add("is-in"));let s=!1;const r=()=>{s||(s=!0,clearTimeout(i),n.classList.remove("is-in"),n.classList.add("is-out"),setTimeout(()=>n.remove(),bn))},i=setTimeout(r,Zl);n.querySelector(".m5t-toast__close").addEventListener("click",r)}function nc(){const e=t=>a=>{const n=a.detail?.pubsubTopic;n&&u.publish(n,a.detail)};document.addEventListener("nav-select",e()),document.addEventListener("logo-click",e()),document.addEventListener("nav-hover",e()),document.addEventListener("nav-double-tap",e()),document.addEventListener("nav-long-tap",e()),document.addEventListener("message-sent",e())}function oc(){console.log("[AppEvents] Initializing event listeners..."),u.subscribe(h.APP_READY,(a,n)=>{console.log("[AppEvents] APP_READY:",n)}),u.subscribe(h.APP_ERROR,(a,n)=>{console.error("[AppEvents] APP_ERROR:",n)}),u.subscribe(h.APP_SIGNOUT,(a,n)=>{console.log("[AppEvents] APP_SIGNOUT:",n)}),u.subscribe(h.ROUTE_NAV_BEFORE,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",n),u.publish(h.UI_LOADING_START)}),u.subscribe(h.ROUTE_NAV_AFTER,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",n),u.publish(h.UI_LOADING_END)}),u.subscribe(h.ROUTE_NAV_ERROR,(a,n)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",n),u.publish(h.APP_ERROR,{message:"Navigation error",details:n})}),u.subscribe(h.AUTH_SIGNIN_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",n)}),u.subscribe(h.AUTH_SIGNIN_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",n),u.publish(h.UI_TOAST,{message:n.message||"Sign in failed",type:"danger"})}),u.subscribe(h.AUTH_SIGNUP_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",n),u.publish(h.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"}),u.publish(h.AUTH_VERIFY_LINK)}),u.subscribe(h.AUTH_VERIFY_LINK,(a,n)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),u.subscribe(h.AUTH_SIGNUP_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",n),u.publish(h.UI_TOAST,{message:n.message||"Sign up failed",type:"danger"})}),u.subscribe(h.AUTH_SIGNOUT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",n),u.publish(h.UI_TOAST,{message:"Signed out successfully",type:"info"})}),u.subscribe(h.AUTH_SIGNUP,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),u.subscribe(h.AUTH_FORGOT,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),u.subscribe(h.AUTH_FORGOT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",n),u.publish(h.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),u.subscribe(h.AUTH_RESETHASH_NAV,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),u.subscribe(h.AUTH_RESETHASH_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",n),u.publish(h.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),u.subscribe(h.AUTH_TOKEN_EXPIRED,(a,n)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",n),u.publish(h.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),u.subscribe(h.I18N_SET_LANG,(a,n)=>{console.log("[AppEvents] I18N_SET_LANG:",n);const{langCode:o}=n;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),u.publish(h.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(s){console.error("[AppEvents] Error changing language:",s),u.publish(h.UI_TOAST,{message:`Failed to change language: ${s.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),u.subscribe("CONVERSATION.PROMPT",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",n.message),sn(n.message,"user",n.timestamp),u.publish(h.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Agent prompt (no implementation):",n.message);break;case"AGENT_CANVAS":console.log("[AppEvents] Display message in canvas:",n.message),sn(n.message,"user",n.timestamp),u.publish(h.CANVAS_DO_SCROLL);break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),u.subscribe("CONVERSATION.RESPONSE",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",n.message),sn(n.message,"assistant",n.timestamp,n.streaming);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),u.subscribe(h.UI_LOADING_START,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),u.subscribe(h.UI_LOADING_END,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),u.subscribe(h.UI_TOAST,(a,n)=>{ac(n)}),u.subscribe(h.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const a="0.1",n=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${a} 8/13/2026, 11:03:30 PM|© ${n} Mach Five Tech`,"night")}),nc(),u.subscribe("M5T_PRIMARY_NAV",(a,n)=>{const o=a.split(".")[1];switch(o){case"TAP":e(n);break;case"LOGO_TAP":t();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function e(a){const{token:n,level:o,primaryToken:s}=a;switch(n){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),u.publish(h.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${n}`,{primaryToken:s});break}}function t(a){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 8/13/2026, 11:03:30 PM|© ${o} Mach Five Tech`,"night",5e3)}u.subscribe(h.AUTH_SIGNOUT,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(G.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function sn(e,t="user",a=null,n=!1){const o=document.getElementById("chat-messages");if(!o){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}if(a||(a=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})),n&&t==="assistant"){const r=o.firstElementChild;if(r&&r.tagName.toLowerCase()==="m5t-chat-response"){r.setAttribute("message",e),console.log(`[AppEvents] Updated streaming ${t} bubble (${e.length} chars)`);return}}let s;t==="user"||t==="prompt"?s=document.createElement("m5t-chat-prompt"):s=document.createElement("m5t-chat-response"),s.setAttribute("message",e),s.setAttribute("timestamp",a),o.prepend(s),console.log(`[AppEvents] Added ${t} bubble to canvas (${e.length} chars)`)}function sc(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("uid")&&t.get("token"))}function rc(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("qr")&&t.get("token"))}function ic(e=window.location.search){const t=new URLSearchParams(e||""),a=t.get("qr"),n=t.get("token");return a&&n?{guid:a,token:n}:null}const lc=Object.freeze([Object.freeze({name:"invite",matches:sc}),Object.freeze({name:"questionnaire",matches:rc})]);function er(e=window.location.search){return lc.find(t=>t.matches(e))||null}function cc(e=window.location.search){return er(e)!==null}function dc(e,t=window.location.search){return cc(t)}const pc=Object.freeze({admin_root_role:{value:100,label:"Administrator",desc:"Mach Five platform staff — full access across every organization"},client_standard_role:{value:0,label:"Client",desc:"Everyone else — what they can do comes from their organization membership, not this class"}});function uc(e){return pc[e]||null}function mc(e){return e>=50}const Vt=Object.freeze({owner:{value:"owner",rank:30,label:"Owner"},admin:{value:"admin",rank:20,label:"Admin"},member:{value:"member",rank:10,label:"Member"},viewer:{value:"viewer",rank:0,label:"Viewer"}}),gc=Object.freeze({VIEW_DASHBOARD:"view_dashboard",VIEW_MAGNETS:"view_magnets",PROVISION_MAGNETS:"provision_magnets",MANAGE_MAGNETS:"manage_magnets",VIEW_CONVERSATIONS:"view_conversations",VIEW_STATS:"view_stats",VIEW_AD_METRICS:"view_ad_metrics",CONNECT_AD_ACCOUNTS:"connect_ad_accounts",CREATE_CLIENT_ACCOUNTS:"create_client_accounts",MANAGE_TEAM:"manage_team",VIEW_BILLING:"view_billing",MANAGE_BILLING:"manage_billing"}),C=gc,tr=Object.freeze(Object.values(C)),At=Object.freeze([C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS]);Object.freeze([C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.CONNECT_AD_ACCOUNTS,C.CREATE_CLIENT_ACCOUNTS,C.MANAGE_TEAM,C.MANAGE_BILLING]);Object.freeze([C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS,C.VIEW_BILLING]);const hc=Object.freeze({reseller_org:{owner:tr,admin:[C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS,C.CONNECT_AD_ACCOUNTS,C.CREATE_CLIENT_ACCOUNTS,C.MANAGE_TEAM,C.VIEW_BILLING],member:[C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS],viewer:At},managed_client:{owner:[...At,C.VIEW_BILLING],admin:[...At,C.VIEW_BILLING],member:At,viewer:At},saas_org:{owner:[C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS,C.CONNECT_AD_ACCOUNTS,C.MANAGE_TEAM,C.VIEW_BILLING,C.MANAGE_BILLING],admin:[C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS,C.VIEW_AD_METRICS,C.CONNECT_AD_ACCOUNTS,C.MANAGE_TEAM,C.VIEW_BILLING],member:[C.VIEW_DASHBOARD,C.VIEW_MAGNETS,C.PROVISION_MAGNETS,C.MANAGE_MAGNETS,C.VIEW_CONVERSATIONS,C.VIEW_STATS],viewer:At}});function fc(e){const t=uc(e);return!!t&&mc(t.value)}function vc({entityClass:e,orgChannel:t,memberRole:a}={}){if(fc(e))return[...tr];const n=hc[t],o=n&&n[a];return o?[...o]:[]}function bc(e,t){const a=Vt[e]?.rank??-1,n=Vt[t]?.rank??1/0;return a>=Vt.admin.rank&&a>=n}const Hn=[{value:"name",label:"Full name (splits into first + last automatically)"},{value:"first_name",label:"First name"},{value:"last_name",label:"Last name"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"mobile",label:"Mobile phone"},{value:"company",label:"Company"},{value:"title",label:"Job title"},{value:"city",label:"City"},{value:"state",label:"State / province"},{value:"product_interest",label:"Product interest"},{value:"lead_source",label:"Lead source"},{value:"rating",label:"Rating (Hot / Warm / Cold)"},{value:"description",label:"Notes / description"},{value:"salutation",label:"Salutation (Mr. / Ms. / Dr.)"},{value:"street",label:"Street address"},{value:"zip",label:"Postal / ZIP code"},{value:"country",label:"Country"},{value:"url",label:"Website URL"},{value:"industry",label:"Industry"},{value:"annual_revenue",label:"Annual revenue (number)"},{value:"employees",label:"Number of employees (whole number)"},{value:"is_primary",label:"Primary contact (Yes / No)"},{value:"current_generators",label:"Current generator(s)"},{value:"number_of_locations",label:"Number of locations (whole number)"}];new Set(Hn.map(e=>e.value));const jn=[{value:"single_select",label:"Multiple choice"},{value:"multi_select",label:"Select all"},{value:"scheduler",label:"Scheduler"},{value:"text",label:"Short text"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"message",label:"Message"}];new Set(jn.map(e=>e.value));const _c=[{value:"inline",label:"Inline"},{value:"chat",label:"Chat"},{value:"right_slide",label:"Slide"},{value:"modal",label:"Modal"}],yc=[{value:"auto",label:"Auto"},{value:"light",label:"Light"},{value:"dark",label:"Dark"}],wc=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],xc=[{value:"book",label:"Book"},{value:"call",label:"Call"},{value:"email",label:"Email"},{value:"chat",label:"Chat"},{value:"support",label:"Support"}];_c.map(e=>e.value);yc.map(e=>e.value);wc.map(e=>e.value);xc.map(e=>e.value);class E{static CONFIG={BASE_URL:"https://machfivemagnet-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink",SCOPE:"sse_session_scope",ACTIVE_ORG:"sse_active_org",REMEMBERED_EMAIL:"sse_remembered_email"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",ME:"/m5t/v5/acctEntity/me",PING:"/ping",WEBAUTHN_AUTH_OPTIONS:"/m5t/v5/webauthn/authenticate/options",WEBAUTHN_AUTH_VERIFY:"/m5t/v5/webauthn/authenticate/verify"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#o=null;static#a=null;static#n=null;static#s=null;static#i=null;static async init({BASE_URL:t,navigateFunction:a,customConfig:n={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(a&&typeof a=="function")this.#i=a;else throw new Error("navigateFunction is required and must be a function");return t&&(this.CONFIG.BASE_URL=t),n&&Object.keys(n).length>0&&(this.CONFIG={...this.CONFIG,...n}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#m(),this.#u(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#u(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((t=null)=>{if(t){if(dc()){console.log("[AuthController] Ignoring mvvLegit redirect to",t,"— keeping visitor on their public landing page");return}console.log("[AuthController] mvvLegit navigation to:",t),this.#r(t)}}).setOnState((t=null)=>{if(t)switch(console.log("[AuthController] Auth state changed:",t),t){case"AUTH":case 4:this.#_();break;case"UNAUTH":case 1:this.#y();break;case"UNVERF":case 2:this.#w();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#r(t){if(!this.#i){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",t);const a=t.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",a),this.#i(a)}static#l(){if(window.__m5tActiveOrgFetch)return;const t=window.fetch.bind(window);window.fetch=(a,n)=>{try{const o=typeof a=="string"?a:a?.url||"",s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);if(s&&o.startsWith(this.CONFIG.BASE_URL)){const r=new Headers(n&&n.headers||(a instanceof Request?a.headers:void 0));r.set("X-Active-Org",s),n={...n||{},headers:r}}}catch{}return t(a,n)},window.__m5tActiveOrgFetch=!0,console.log("[AuthController] Active-org fetch header installed")}static#m(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);t&&(this.#o=JSON.parse(t),console.log("[AuthController] Entity state loaded; hasEmail:",!!this.#o?.email))}catch(t){console.error("[AuthController] Error loading entity state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#o=null}this.#s=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.SCOPE);t&&(this.#a=JSON.parse(t),console.log("[AuthController] Scope state loaded (cached):",this.#a?.uiMode))}catch(t){console.error("[AuthController] Error loading scope state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE),this.#a=null}}static#c(t){try{this.#o=t,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(t)),console.log("[AuthController] Entity state saved")}catch(a){console.error("[AuthController] Error saving entity state:",a)}}static#d(){this.#o=null,this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}}static getEntity(){return this.#o}static#v(t){try{this.#a=t,localStorage.setItem(this.CONFIG.LS_KEYS.SCOPE,JSON.stringify(t))}catch(a){console.error("[AuthController] Error saving scope state:",a)}}static async fetchScope(){return typeof mvvLegit>"u"||!this.isAuthenticated()?(console.log("[AuthController] fetchScope skipped — not authenticated"),this.#a):this.#n?this.#n:(this.#n=this.#b().finally(()=>{this.#n=null}),this.#n)}static async#b(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),a=t?`?org=${encodeURIComponent(t)}`:"",n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.ME}${a}`);if(n.status===401||n.status===403)return console.warn("[AuthController] /me unauthorized — signing out"),this.doSignout(!0),null;if(!n.ok)return console.warn(`[AuthController] /me failed (${n.status}) — using cached scope`),this.#a;const o=await n.json();if(!o?.ok)return console.warn("[AuthController] /me returned not-ok — using cached scope"),this.#a;try{const s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);s&&o.activeOrg?.guid!==s&&(console.warn(`[AuthController] Stored active org not honored by /me${o.activeOrgError?" (activeOrgError)":""} — clearing`),localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG))}catch{}return this.#v(o),u.publish(h.AUTH_SCOPE_LOADED,o),console.log(`[AuthController] Scope loaded: ${o.uiMode} (${o.memberships?.length||0} org(s), ${o.managedClients?.length||0} client(s))`),o}catch(t){return console.error("[AuthController] fetchScope error:",t),this.#a}}static async setActiveOrg(t){try{t?localStorage.setItem(this.CONFIG.LS_KEYS.ACTIVE_ORG,t):localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}return this.fetchScope()}static getScope(){return this.#a}static getCapabilities(){return this.isPreviewingAsClient()?vc({orgChannel:"managed_client",memberRole:"owner"}):this.#a?.capabilities||[]}static getUiMode(){return this.isPreviewingAsClient()?"managed":this.#a?.uiMode||"self_serve"}static getActiveOrg(){return this.#a?.activeOrg||null}static getMemberships(){return this.#a?.memberships||[]}static getManagedClients(){return this.#a?.managedClients||[]}static getStoredActiveOrg(){try{return localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{return null}}static#p="m5m_preview_as_client";static isPreviewingAsClient(){try{return sessionStorage.getItem(this.#p)==="1"&&!!this.#a?.activeOrg?.viaSubtree}catch{return!1}}static setPreviewAsClient(t){try{t?sessionStorage.setItem(this.#p,"1"):sessionStorage.removeItem(this.#p)}catch{}this.#a&&u.publish(h.AUTH_SCOPE_LOADED,this.#a)}static async doSignin(t,a){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a})}),o=await n.json();if(n.status===303)return console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#c(o.entity)),setTimeout(()=>{this.#r(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o};if(n.ok&&o.accessToken){console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#c(o.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),console.log("[AuthController] Explicitly navigating to home"),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}}return{ok:!1,error:o.error||"Sign in failed",data:o}}catch(n){return console.error("[AuthController] Signin error:",n),{ok:!1,error:n.message}}}static async doPasskeySignin(){if(!window.PublicKeyCredential)return{ok:!1,error:"Passkeys are not supported in this browser"};try{const{startAuthentication:t}=await W(async()=>{const{startAuthentication:i}=await Promise.resolve().then(()=>mr);return{startAuthentication:i}},void 0,import.meta.url),a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_OPTIONS}`,{method:"POST"}),n=await a.json();if(!a.ok||!n.ok)return{ok:!1,error:n.error||"Could not start passkey sign-in"};let o;try{o=await t({optionsJSON:n.options})}catch(i){const l=i?.name==="NotAllowedError";return l||console.error("[AuthController] Passkey ceremony error:",i),{ok:!1,canceled:l,error:l?"Passkey sign-in was canceled":i.message||"Passkey sign-in failed"}}const s=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_VERIFY}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o})}),r=await s.json();if(!s.ok||!r.ok||!r.accessToken)return{ok:!1,error:r.error||"Passkey sign-in failed",data:r};mvvLegit.doSignin(r.accessToken),this.#c(r.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:r}}catch(t){return console.error("[AuthController] Passkey signin error:",t),{ok:!1,error:t.message}}}static async doSignout(t=!1){console.log("[AuthController] doSignout called, serverInitiated:",t);try{const a=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!a),!t&&a){const n=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(a)}`;if(console.log("[AuthController] Sending signout beacon to:",n),navigator.sendBeacon){const o=navigator.sendBeacon(n);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else a||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#d(),console.log("[AuthController] Stopping auth ping..."),this.#h(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(a){console.error("[AuthController] Signout error:",a),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(t){try{const a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await a.json();return a.ok&&n.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#c(n.entity),{ok:!0,data:n}):{ok:!1,error:n.error||"Sign up failed",data:n}}catch(a){return console.error("[AuthController] Signup error:",a),{ok:!1,error:a.message}}}static async doResetHash(t,a){try{const n=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a,modified_by:t})}),s=await o.json();return o.ok&&s.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:s}):{ok:!1,error:s.error||"Password reset failed",data:s}}catch(n){return console.error("[AuthController] Reset password error:",n),{ok:!1,error:n.message}}}static#g(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#f()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#h(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#f(){try{const t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);t.ok?console.log("[AuthController] Ping success"):(t.status===401||t.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(t){console.error("[AuthController] Ping error:",t)}}static setDeepLinkGuid(t){this.#s=t,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,t),console.log("[AuthController] Deep-link GUID stored:",t)}static getDeepLinkGuid(){return this.#s}static clearDeepLink(){this.#s=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#_(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),queueMicrotask(()=>this.fetchScope())}static#y(){console.log("[AuthController] User unauthenticated"),this.#h()}static#w(){console.log("[AuthController] User unverified")}static getAuthState(){try{const t=mvvLegit.getConf()?.LSKEY||"mvv",a=localStorage.getItem(t);if(!a)return"UNAUTH";if(typeof LZString>"u")return null;const n=LZString.decompressFromUTF16(a),s=JSON.parse(n)?.state;return s===1?"UNAUTH":s===2?"UNVERF":s===4?"AUTH":s===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(t){this.#r(t)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#f()}}class ${static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",remember_email:"Remember my email",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_dashboard:"Dashboard",nav_dashboard_tagline:"Overview of your activity",nav_magnets:"Your Magnets",nav_magnets_tagline:"Manage your conversational magnets",nav_templates:"Templates",nav_templates_tagline:"Start from a magnet template",nav_conversations:"Conversations",nav_conversations_tagline:"Captured lead conversations",nav_ab_testing:"A/B Testing",nav_ab_testing_tagline:"Experiment and optimize",nav_analytics:"Analytics",nav_analytics_tagline:"Performance and ad metrics",nav_ad_accounts:"Ad Accounts",nav_ad_accounts_tagline:"Connect advertising accounts",nav_clients:"Clients",nav_clients_tagline:"Manage your client accounts",nav_team:"Team",nav_team_tagline:"Invite and manage teammates",nav_billing:"Billing",nav_billing_tagline:"Plan, usage, and invoices",nav_settings:"Settings",nav_settings_tagline:"Account and workspace settings",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Magnet Builder",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",remember_email:"Recordar mi correo electrónico",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Magnet Builder",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",remember_email:"记住我的邮箱",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"Magnet Builder",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:t,product:a,whitelabel:n,lang:o}){t&&(this.#t.buildMode=t),a&&(this.#t.product=a),n&&(this.#t.whitelabel=n),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{let l=this.#e[o]?.[s]?.[r]?.[i]?.[t],c=o;return!l&&o!=="LOCAL"&&(l=this.#e.LOCAL?.[s]?.[r]?.[i]?.[t],c="LOCAL (fallback)"),l?(c==="LOCAL (fallback)"&&console.warn(`[MicrocopyManager] Token '${t}' missing from ${o} — served from LOCAL instead. Backfill ${o}'s block if this is intentionally different copy.`),Array.isArray(l)?l[Math.floor(Math.random()*l.length)]:l):(console.warn(`[MicrocopyManager] Token not found: ${t} (${o}/${s}/${r}/${i}, LOCAL fallback also missing it)`),null)}catch(l){return console.error(`[MicrocopyManager] Error retrieving token: ${t}`,l),null}}static getAll(t={}){const a={...this.#t,...t},{buildMode:n,product:o,whitelabel:s,lang:r}=a;try{return this.#e[n]?.[o]?.[s]?.[r]||null}catch(i){return console.error("[MicrocopyManager] Error retrieving all tokens",i),null}}static has(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return!!this.#e[o]?.[s]?.[r]?.[i]?.[t]}catch{return!1}}static getAvailableLanguages(){const{buildMode:t,product:a,whitelabel:n}=this.#t;try{return Object.keys(this.#e[t]?.[a]?.[n]||{})}catch{return[]}}static update(t,a,n={}){const o={...this.#t,...n},{buildMode:s,product:r,whitelabel:i,lang:l}=o;try{return this.#e[s]||(this.#e[s]={}),this.#e[s][r]||(this.#e[s][r]={}),this.#e[s][r][i]||(this.#e[s][r][i]={}),this.#e[s][r][i][l]||(this.#e[s][r][i][l]={}),this.#e[s][r][i][l][t]=a,!0}catch(c){return console.error(`[MicrocopyManager] Error updating token: ${t}`,c),!1}}static delete(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return delete this.#e[o]?.[s]?.[r]?.[i]?.[t],!0}catch(l){return console.error(`[MicrocopyManager] Error deleting token: ${t}`,l),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(t){try{return this.#e=t,!0}catch(a){return console.error("[MicrocopyManager] Error importing data",a),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:$});class Ne{static#e=!1;static#t=null;static#o=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const t=this.#n();$.setContext(t),console.log("[I18nController] Initialized with context:",t),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#s(),this.#u(),this.#e=!0,this.refresh()}static#a(t){const a={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},n=t.toLowerCase();return a[n]||"DEV"}static#n(){const a=this.#a("production"),n=localStorage.getItem(G.FF_SSE_LS_WHITELABEL)||G.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(G.FF_SSE_LS_USER_LANG)||G.FF_SSE_I18N_LANG;return{buildMode:a,product:G.FF_SSE_I18N_PRODUCT,whitelabel:n,lang:o}}static#s(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((t,a,n)=>{G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",n),this.#t=n,setTimeout(()=>{this.refresh()},G.FF_SSE_I18N_APPLY_DELAY_MS)},G.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#i())}static#i(){setInterval(()=>{const a=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");a&&a!==this.#t&&(this.#t=a,this.refresh())},500)}static#u(){this.#o||(this.#o=new MutationObserver(t=>{let a=!1;for(const n of t){for(const o of n.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){a=!0;break}if(a)break}a&&(G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#o.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#r(document.body),this.#l(document.body),G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#r(t){const a=t.querySelectorAll("[data-meta-copywrite-i118n]");G.FF_SSE_I18N_DEBUG&&a.length>0&&console.log(`[I18nController] Processing ${a.length} elements`),a.forEach(n=>{try{const o=n.getAttribute("data-meta-copywrite-i118n"),s=JSON.parse(o);if(!s.token){console.warn("[I18nController] Missing token in config:",s);return}const r=s.attribute||"textContent",i=$.get(s.token);if(i===null){console.warn(`[I18nController] Microcopy not found for token: ${s.token}`);return}r==="textContent"?n.textContent=i:r==="innerHTML"?n.innerHTML=i:n.setAttribute(r,i),G.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${i}" to ${r} for token: ${s.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,n)}})}static#l(t){t.querySelectorAll("*").forEach(n=>{n.shadowRoot&&(this.#r(n.shadowRoot),this.#l(n.shadowRoot))})}static setLanguage(t){const a=$.getAvailableLanguages();if(!a.includes(t)){console.error(`[I18nController] Language not available: ${t}. Available:`,a);return}localStorage.setItem(G.FF_SSE_LS_USER_LANG,t),$.setContext({lang:t}),console.log("[I18nController] Language changed to:",t);const n=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:t}});document.dispatchEvent(n),this.refresh()}static setWhitelabel(t){localStorage.setItem(G.FF_SSE_LS_WHITELABEL,t),$.setContext({whitelabel:t}),G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",t),this.refresh()}static getLanguage(){return $.getContext().lang}static getAvailableLanguages(){return $.getAvailableLanguages()}static getContext(){return $.getContext()}static destroy(){this.#o&&(this.#o.disconnect(),this.#o=null),this.#e=!1,this.#t=null,G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{Ne.initialize()}):Ne.initialize());class Gn{static _initialized=!1;static _debug=!1;static init(t={}){if(this._initialized)return console.warn("[MachVive] Already initialized, skipping duplicate initialization"),this;if(this._debug=t.debug||!1,!window.mvvSSEther)return console.error("[MachVive] mvvSSEther not found - cannot initialize bridge"),console.error("[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()"),this;console.log("[MachVive] Initializing SSE to PubSub bridge...");const a=n=>{this._handleSSEMessage(n)};return window.mvvSSEther.onmessage(a),this._initialized=!0,console.log("[MachVive] ✓ SSE to PubSub bridge initialized successfully"),console.log("[MachVive] ✓ Bound callback to mvvSSEther.onmessage"),this}static _handleSSEMessage(t){try{this._debug&&console.log("[MachVive] SSE message received:",t);const a=t?.data;if(!a){this._debug&&console.log("[MachVive] No data in message, skipping");return}const n=a.data||a.package||a;if(!n){this._debug&&console.log("[MachVive] No package found in message, skipping");return}let o=n.cfg;const s=n.msg;if(this._debug&&(console.log("[MachVive] cfg (raw):",o,"type:",typeof o,"length:",o?.length),console.log("[MachVive] msg (raw):",s)),typeof o=="string"){if(o.trim()===""){this._debug&&console.log("[MachVive] cfg is empty string, skipping");return}try{o=JSON.parse(o),console.log("[MachVive] cfg (parsed):",o)}catch(i){console.warn("[MachVive] Failed to parse cfg as JSON:",{cfg:o,cfgLength:o.length,error:i.message});return}}else if(!o){this._debug&&console.log("[MachVive] cfg is empty/null, skipping");return}const r=o?.topic;if(!r){this._debug&&console.log("[MachVive] No topic found in cfg, skipping");return}if(console.log("[MachVive] Extracted topic:",r),!this._isValidTopic(r)){console.warn(`[MachVive] Topic '${r}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(r,s,t,a)}catch(a){console.error("[MachVive] Error handling SSE message:",a)}}static _isValidTopic(t){return!h||!h.hasOwnProperty(t)?(console.warn(`[MachVive] Topic '${t}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(t,a,n,o){try{if(!window.PubSub&&typeof PubSub>"u"){console.error("[MachVive] PubSub not available");return}const s=window.PubSub||PubSub,r={message:a,metadata:{source:"sse",sseEventId:n.id,timestamp:n.timestamp,appGuid:o.app_guid,channelGuid:o.channel_guid,eventAction:o.event_action,status:o.status,class:o.class,raw:o}};console.log(`[MachVive] Publishing to topic '${t}':`,r);const i=h[t];console.log(`[MachVive] AppBroadcast.${t} = '${i}'`),s.publish(i,r),console.log(`[MachVive] ✓ Published SSE message to topic: ${t}`)}catch(s){console.error(`[MachVive] Error publishing to topic '${t}':`,s)}}static debug(t){return this._debug=t,console.log(`[MachVive] Debug mode ${t?"enabled":"disabled"}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log("[MachVive] Reset complete"),this}}typeof module<"u"&&module.exports&&(module.exports=Gn);typeof window<"u"&&(window.MachVive=Gn);const So="m5t_sidenav_collapsed",Ec={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};class kc extends HTMLElement{static get observedAttributes(){return["data-active-token","data-collapsed"]}constructor(){super(),this.attachShadow({mode:"open"}),this.items=[],this.orgs=[],this.activeOrgGuid=null,this.activeToken=null,this.footerBadge=null,this.loading=!1,this.lastFocus=null}#e=null;#t=t=>{if(this.getAttribute("data-open")==="true"){if(t.key==="Escape"){t.preventDefault(),this.closeDrawer();return}if(t.key==="Tab"){const a=this.#c();if(a.length<2)return;const n=a[0],o=a[a.length-1],s=this.shadowRoot.activeElement;t.shiftKey&&s===n?(t.preventDefault(),o.focus()):!t.shiftKey&&s===o&&(t.preventDefault(),n.focus())}}};#o=()=>{this.closeDrawer(),this.#d()};connectedCallback(){if(!this.hasAttribute("data-collapsed"))try{localStorage.getItem(So)==="true"&&this.setAttribute("data-collapsed","true")}catch{}this.activeToken=this.getAttribute("data-active-token")||null,this.render(),this.#l(),this.addEventListener("keydown",this.#t),this.#e=window.matchMedia("(max-width: 768px)"),this.#e.addEventListener("change",this.#o),this.#d()}disconnectedCallback(){this.removeEventListener("keydown",this.#t),this.#e?.removeEventListener("change",this.#o)}attributeChangedCallback(t,a,n){a===n||!this.shadowRoot||(t==="data-active-token"?(this.activeToken=n,this.#m()):t==="data-collapsed"&&this.shadowRoot.firstChild&&(this.render(),this.#l()))}setState({buttons:t,orgs:a,activeOrg:n,footerBadge:o,loading:s}={}){t!==void 0&&(this.items=Array.isArray(t)?t:this.#a(t)||[]),a!==void 0&&(this.orgs=Array.isArray(a)?a:this.#a(a)||[]),n!==void 0&&(this.activeOrgGuid=n||null),o!==void 0&&(this.footerBadge=o||null),s!==void 0&&(this.loading=!!s),this.shadowRoot&&(this.render(),this.#l())}setButtons(t){this.setState({buttons:t})}setOrgs(t){this.setState({orgs:t})}setActiveOrgGuid(t){this.setState({activeOrg:t})}setFooterBadge(t){this.setState({footerBadge:t})}setActiveToken(t){this.activeToken=t||null,this.#m()}toggleCollapsed(t){const a=typeof t=="boolean"?t:this.getAttribute("data-collapsed")!=="true";this.setAttribute("data-collapsed",String(a));try{localStorage.setItem(So,String(a))}catch{}this.dispatchEvent(new CustomEvent("nav-collapse",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_SIDE_NAV.COLLAPSE",collapsed:a,timestamp:Date.now()}}))}openDrawer(){this.lastFocus=this.shadowRoot.activeElement||document.activeElement,this.setAttribute("data-open","true"),this.shadowRoot.querySelector(".hamburger")?.setAttribute("aria-expanded","true"),this.#d(),(this.#c()[0]||this.shadowRoot.querySelector(".sidenav"))?.focus?.()}closeDrawer(){if(this.getAttribute("data-open")!=="true")return;this.removeAttribute("data-open");const t=this.shadowRoot.querySelector(".hamburger");t?.setAttribute("aria-expanded","false"),this.#d(),t&&this.#e?.matches?t.focus():this.lastFocus?.focus?.()}toggleDrawer(){this.getAttribute("data-open")==="true"?this.closeDrawer():this.openDrawer()}#a(t){try{return t?JSON.parse(t):null}catch(a){return console.error("[M5TSideNav] bad JSON:",a),null}}#n(t){return String(t??"").replace(/[&<>"']/g,a=>Ec[a])}#s(t){return t?`<span class="ms" aria-hidden="true">${this.#n(t)}</span>`:""}#i(t){if(!t||!t.token)return"";const a=t.token===this.activeToken,n=t.route||"#",o=n.startsWith("#")?n:`#${n}`,s=typeof t.count=="number"&&t.count>0?`<span class="badge">${t.count}</span>`:"";return`
  ...
  </div>`}const Lc='<div class="m5t-notif-skel"><span></span><span></span><span></span></div>'.repeat(3),rn=e=>e.dataset.open==="true",_n=(e,t)=>{e.dataset.open=t?"true":"false"};function Ic(e){const t=document.getElementById("m5t-notif-bell");if(t&&(t.hidden=!e),!e){const a=document.getElementById("m5t-notif-panel");a&&_n(a,!1)}}const Rc=14;let ln=null,cn=null;function Nc(e){if(typeof ResizeObserver>"u"||!e)return;const t=document.getElementById("m5t-notif-bell"),a=document.getElementById("m5t-notif-bell-btn");if(!t||!a)return;const n=()=>{const o=e.hidden?null:e.querySelector(".ocb-btn");if(!o){t.style.top=`${Rc}px`;return}const s=a.getBoundingClientRect().height;if(!s)return;const r=o.getBoundingClientRect();t.style.top=`${Math.round(r.top+(r.height-s)/2)}px`};ln?.disconnect(),ln=new ResizeObserver(n),ln.observe(e),cn?.disconnect(),cn=new MutationObserver(n),cn.observe(t,{attributes:!0,attributeFilter:["hidden"]}),n()}let Co=null,ia=null,la=null;function Oc(){const e=document.getElementById("m5t-notif-bell-btn"),t=document.getElementById("m5t-notif-badge"),a=document.getElementById("m5t-notif-panel");if(!e||!t||!a)return;const n=d=>{t.textContent=d>99?"99+":String(d),t.hidden=!d},o=async()=>{try{const d=await fetch(`${St()}/m5t/v5/notifications/unread-count`),m=await d.json().catch(()=>({}));d.ok&&m.ok&&n(m.count||0)}catch{}},s=50,r=d=>{if(d.length>=s){o();return}n(d.filter(m=>!m.read).length)},i=(d="")=>`<div class="m5t-notif-head">Notifications${d?`<span class="m5t-notif-head__actions">${d}</span>`:""}</div>`,l=()=>{a.querySelectorAll(".m5t-notif-item, .m5t-notif-empty").forEach(d=>d.remove()),a.querySelector(".m5t-notif-head__actions")?.remove(),a.insertAdjacentHTML("beforeend",'<div class="m5t-notif-empty">You’re all caught up.</div>')},c=async()=>{a.innerHTML=i()+Lc;try{const d=await fetch(`${St()}/m5t/v5/notifications`),m=await d.json().catch(()=>({}));if(!d.ok||!m.ok)throw new Error;const f=m.notifications||[],p=[f.some(v=>!v.read)?'<button class="m5t-notif-markall" type="button">Mark all read</button>':"",f.length?'<button class="m5t-notif-clearall" type="button">Clear all</button>':""].join("");a.innerHTML=i(p)+(f.length?f.map($c).join(""):'<div class="m5t-notif-empty">You’re all caught up.</div>'),r(f)}catch{a.innerHTML=i()+'<div class="m5t-notif-empty">Could not load. Try again.</div>'}},g=()=>{_n(a,!1),e.setAttribute("aria-expanded","false")},b=async()=>{_n(a,!0),e.setAttribute("aria-expanded","true"),await c()};e.addEventListener("click",d=>{d.stopPropagation(),rn(a)?g():b()}),la&&document.removeEventListener("visibilitychange",la),la=()=>{document.visibilityState==="visible"&&o()},document.addEventListener("visibilitychange",la),ia&&document.removeEventListener("click",ia),ia=d=>{rn(a)&&!a.contains(d.target)&&d.target!==e&&g()},document.addEventListener("click",ia),document.addEventListener("keydown",d=>{d.key==="Escape"&&rn(a)&&(g(),e.focus())}),a.addEventListener("click",async d=>{const m=d.target.closest("[data-dismiss]");if(m){d.preventDefault(),d.stopPropagation();const x=m.closest(".m5t-notif-item"),y=m.dataset.dismiss,T=x?.dataset.read==="false";x?.setAttribute("data-leaving","true");try{await fetch(`${St()}/m5t/v5/notifications/${encodeURIComponent(y)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:"DISMISSED"})})}catch{}setTimeout(()=>{x?.remove(),a.querySelector(".m5t-notif-item")||l()},180),T&&o();return}const f=d.target.closest(".m5t-notif-clearall");if(f){d.preventDefault(),f.disabled=!0,a.querySelectorAll(".m5t-notif-item").forEach(x=>x.setAttribute("data-leaving","true"));try{await fetch(`${St()}/m5t/v5/notifications/dismiss-all`,{method:"PATCH"})}catch{}setTimeout(l,180),o();return}const p=d.target.closest(".m5t-notif-item");if(p&&p.dataset.read==="false"){const x=p.dataset.guid;p.dataset.read="true";try{await fetch(`${St()}/m5t/v5/notifications/${encodeURIComponent(x)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({read:!0})}),o()}catch{}return}const v=d.target.closest(".m5t-notif-markall");if(v){d.preventDefault(),a.querySelectorAll(".m5t-notif-item").forEach(x=>{x.dataset.read="true"}),v.remove();try{await fetch(`${St()}/m5t/v5/notifications/read-all`,{method:"PATCH"})}catch{}o()}}),o(),clearInterval(Co),Co=setInterval(o,Cc)}function za(){return zn("FF_SSE_UI_DARK_MODE")}function Mc(e=za()){return e&&localStorage.getItem(G.FF_SSE_LS_THEME)==="dark"?"dark":"light"}function Pc(e=zn("FF_SSE_UI_ANIMATIONS")){return!e}function Fc(e,t=za()){!e||t||e.shadowRoot?.querySelector('.footer-action[data-action="theme"]')?.remove()}function ar(e){document.documentElement.setAttribute("data-theme",e)}function Dc(){ar(Mc())}function Xt(){return document.documentElement.getAttribute("data-theme")==="dark"?"dark":"light"}function nr(e,{quiet:t=!1}={}){if(!za())return;const a=e==="dark"?"dark":"light";a!==Xt()&&(ar(a),localStorage.setItem(G.FF_SSE_LS_THEME,a),t||u.publish(h.UI_TOAST,{message:a==="dark"?"Dark mode on":"Dark mode off",type:"info"}),u.publish(h.UI_THEME_CHANGED,{theme:a}))}function Bc(){nr(Xt()==="dark"?"light":"dark")}window.m5t=Object.create(null);window.m5t.pubsub=u;console.log("StreamSyncEngage SaaS Client - Starting...");console.log("Environment:","production");console.log("Document readyState:",document.readyState);console.log("window.mvvLegit:",typeof window.mvvLegit);console.log("globalThis.mvvLegit:",typeof globalThis.mvvLegit);try{console.log("mvvLegit (direct):",typeof mvvLegit)}catch(e){console.log("mvvLegit (direct): ReferenceError -",e.message)}const qc=Object.keys(window).filter(e=>e.toLowerCase().includes("mvv")||e.toLowerCase().includes("neodigm")||e.toLowerCase().includes("legit"));console.log("Possible Neodigm globals:",qc);const O=new Vl("/",{hash:!0});window.router=O;function ce(e){const t=e?`${e.replace(/-/g,"_")}_route`:"splash_route";return console.log(`[Router] Checking access: ${e} -> ${t}`),mvvLegit.isRouteAllowed(t)?!0:(console.warn(`[Router] Access denied to route: ${t}`),u.publish(h.UI_TOAST,{message:"Please sign in to access this page",type:"warning"}),!1)}function ne(e){console.log("[Router] Navigating to:",e),O.navigate(`/${e}`)}const Vn=new Set(["splash","signin","signup","forgot","resethash","verf-link","accept-invite","signout"]);let Wt={},yn={},ft=null;const Uc={admin:{caption:"Platform Admin",icon:"shield_person"},reseller:{caption:"Reseller",icon:"handshake"},managed:{caption:"Managed",icon:"visibility"},self_serve:{caption:"Self-Serve",icon:"rocket_launch"}},wn="__portfolio__";function or(){try{O._setCurrent(null)}catch{}O.resolve()}function dn(){const e=document.getElementById("m5t-side-nav");if(!e)return;const t=!E.getScope()&&E.isAuthenticated(),a=E.getCapabilities(),n=E.getUiMode(),o=Ua.getSideNav(a,{uiMode:n});Wt={},yn={};const s=d=>{d.route&&(Wt[d.route]={sectionToken:d.token,childToken:null,children:d.children||null},Array.isArray(d.children)&&d.children.forEach(m=>{m.route&&(yn[m.token]=m.route,Wt[m.route]={sectionToken:d.token,childToken:m.token,children:d.children})}))},r=d=>d.forEach(m=>{m.group&&Array.isArray(m.items)?r(m.items):s(m)});r(o);const i=E.getMemberships(),l=E.getActiveOrg(),c=E.getManagedClients(),g=E.getStoredActiveOrg(),b=c.length?[{guid:wn,name:"Portfolio (all clients)"},...i.map(d=>({guid:d.orgGuid,name:d.name||d.channel,channel:d.channel,group:"Your organization"})),...c.map(d=>({guid:d.orgGuid,name:d.name||d.orgGuid,channel:d.channel,group:"Clients"}))]:i.map(d=>({guid:d.orgGuid,name:d.name||d.channel,channel:d.channel}));e.setState({buttons:o,orgs:b,activeOrg:c.length?g||wn:l?.guid||null,footerBadge:Uc[n]||null,loading:t}),sr(),ft&&rr(ft)}const zc=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]);function sr(){const e=document.getElementById("app-content");if(!e)return;let t=document.getElementById("org-context-banner");t||(t=document.createElement("div"),t.id="org-context-banner",e.insertBefore(t,e.firstChild),Nc(t));const a=E.getActiveOrg(),n=E.isPreviewingAsClient(),o=!!a?.viaSubtree&&!!ft&&!Vn.has(ft);if(t.hidden=!o,!o){t.innerHTML="";return}const s=zc(a.name||"Client");t.innerHTML=`
    <style>
    ...
    <div class="ocb" role="status">
    ...
    </div>`,t.querySelector('[data-ocb="preview"]')?.addEventListener("click",()=>{E.setPreviewAsClient(!E.isPreviewingAsClient()),or()}),t.querySelector('[data-ocb="portfolio"]')?.addEventListener("click",()=>{E.setPreviewAsClient(!1),E.setActiveOrg(null)})}function rr(e){const t=document.getElementById("m5t-side-nav"),a=Wt[`/${e}`]||Wt[e]||null;t?.setActiveToken(a?.sectionToken||null),Hc(a)}function Hc(e){const t=document.getElementById("m5t-sub-nav"),a=document.getElementById("app-shell");if(!t)return;const n=e?.children;t.hidden=!1,n&&n.length>1?(t.updateButtons(n.map(o=>({token:o.token,caption:o.caption,enabled:!0,selected:o.token===e.childToken}))),a?.classList.add("has-sub-nav")):(t.updateButtons([]),a?.classList.remove("has-sub-nav"))}function jc(){const e=Ne.getAvailableLanguages&&Ne.getAvailableLanguages()||[];if(e.length<2){u.publish(h.UI_TOAST,{message:"Only one language is available",type:"info"});return}const t=localStorage.getItem(G.FF_SSE_LS_USER_LANG)||G.FF_SSE_I18N_LANG||e[0],a=e[(e.indexOf(t)+1)%e.length];Ne.setLanguage(a),u.publish(h.UI_TOAST,{message:`Language: ${a}`,type:"info"})}function Gc(){document.documentElement.classList.toggle("ff-no-animations",Pc())}function Vc(){const e=document.getElementById("m5t-side-nav");if(!e)return;Ua.setAppToken("client-saas"),Fc(e),document.getElementById("app-shell")?.classList.toggle("nav-collapsed",e.getAttribute("data-collapsed")==="true"),e.addEventListener("nav-select",o=>{const s=o.detail?.route;s&&O.navigate(s.startsWith("/")?s:`/${s}`)}),e.addEventListener("logo-click",()=>O.navigate("/home")),e.addEventListener("nav-collapse",o=>{document.getElementById("app-shell")?.classList.toggle("nav-collapsed",!!o.detail?.collapsed)}),e.addEventListener("org-switch",o=>{const s=o.detail?.orgGuid;s&&E.setActiveOrg(s===wn?null:s)}),e.addEventListener("footer-action",o=>{switch(o.detail?.action){case"account":O.navigate("/settings");break;case"signout":O.navigate("/signout");break;case"lang":jc();break;case"theme":Bc();break}}),document.getElementById("m5t-sub-nav")?.addEventListener("nav-select",o=>{const s=yn[o.detail?.token];s&&O.navigate(s)}),document.addEventListener("language-changed",()=>dn()),dn(),u.subscribe(h.AUTH_SCOPE_LOADED,()=>dn());const a=()=>{const o=E.getScope();return[o?.uiMode,o?.activeOrg?.guid,(o?.managedClients||[]).length,(o?.capabilities||[]).join(","),E.getStoredActiveOrg()].join("|")};let n=a();u.subscribe(h.AUTH_SCOPE_LOADED,()=>{const o=a();o!==n&&(n=o,ft&&!Vn.has(ft)&&or())})}function Wc(e){ft=e;const t=document.getElementById("m5t-side-nav"),a=document.getElementById("app-shell");if(!t||!a)return;const n=!Vn.has(e);if(t.hidden=!n,a.classList.toggle("has-side-nav",n),Ic(n),n)rr(e);else{const o=document.getElementById("m5t-sub-nav");o&&(o.hidden=!0),a.classList.remove("has-sub-nav")}sr()}u.subscribe(h.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&Wc(t.route)});const ir=()=>{console.log("[Router] Route: splash"),u.publish(h.ROUTE_NAV_BEFORE,{route:"splash"});const e=er()?.name;(e==="invite"?W(()=>Promise.resolve().then(()=>rd),void 0,import.meta.url):e==="questionnaire"?W(()=>Promise.resolve().then(()=>kd),void 0,import.meta.url):W(()=>Promise.resolve().then(()=>Cd),void 0,import.meta.url)).then(a=>{const n=document.getElementById("app");n.innerHTML=a.render(),a.init&&a.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"splash"})}).catch(a=>{console.error("[Router] Error loading splash route:",a),u.publish(h.ROUTE_NAV_ERROR,{route:"splash",error:a})})};O.on("/",ir);O.on("/splash",ir);O.on("/signin",()=>{console.log("[Router] Route: /signin"),u.publish(h.ROUTE_NAV_BEFORE,{route:"signin"}),W(()=>Promise.resolve().then(()=>Od),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"signin"})}).catch(e=>{console.error("[Router] Error loading signin route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"signin",error:e})})});O.on("/signup",()=>{console.log("[Router] Route: /signup"),u.publish(h.ROUTE_NAV_BEFORE,{route:"signup"}),W(()=>Promise.resolve().then(()=>qd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"signup"})}).catch(e=>{console.error("[Router] Error loading signup route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"signup",error:e})})});O.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),u.publish(h.ROUTE_NAV_BEFORE,{route:"verf-link"}),W(()=>Promise.resolve().then(()=>Hd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(e=>{console.error("[Router] Error loading verf-link route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"verf-link",error:e})})});O.on("/forgot",()=>{console.log("[Router] Route: /forgot"),u.publish(h.ROUTE_NAV_BEFORE,{route:"forgot"}),W(()=>Promise.resolve().then(()=>Jd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(e=>{console.error("[Router] Error loading forgot route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"forgot",error:e})})});O.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!ce("resethash")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"resethash"}),W(()=>Promise.resolve().then(()=>Zd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(e=>{console.error("[Router] Error loading resethash route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"resethash",error:e})})});O.on("/home",()=>{if(console.log("[Router] Route: /home"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"home"}),W(()=>Promise.resolve().then(()=>gp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"home"})}).catch(e=>{console.error("[Router] Error loading home route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"home",error:e})})});O.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!ce("signout")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"signout"}),W(()=>Promise.resolve().then(()=>vp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"signout"})}).catch(e=>{console.error("[Router] Error loading signout route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"signout",error:e})})});const Yc=[{path:"/ad-accounts",name:"ad-accounts",title:"Ad Accounts",icon:"ads_click"},{path:"/billing",name:"billing",title:"Billing",icon:"receipt_long"},{path:"/magnets/drafts",name:"magnets/drafts",title:"Magnets · Drafts",icon:"widgets"},{path:"/magnets/archived",name:"magnets/archived",title:"Magnets · Archived",icon:"widgets"},{path:"/analytics/conversions",name:"analytics/conversions",title:"Analytics · Conversions",icon:"monitoring"}];Yc.forEach(({path:e,name:t,title:a,icon:n})=>{O.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:t}),W(()=>Promise.resolve().then(()=>yp),void 0,import.meta.url).then(o=>{const s=document.getElementById("app");s.innerHTML=o.render({title:a,icon:n,name:t}),o.init&&o.init({name:t}),u.publish(h.ROUTE_NAV_AFTER,{route:t})}).catch(o=>{console.error(`[Router] Error loading section route (${t}):`,o),u.publish(h.ROUTE_NAV_ERROR,{route:t,error:o})})})});O.on("/settings",()=>{if(console.log("[Router] Route: /settings"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"settings"}),W(()=>Promise.resolve().then(()=>Rp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"settings"})}).catch(e=>{console.error("[Router] Error loading settings-general route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"settings",error:e})})});O.on("/settings/workspace",()=>{if(console.log("[Router] Route: /settings/workspace"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"settings/workspace"}),W(()=>Promise.resolve().then(()=>Gp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"settings/workspace"})}).catch(e=>{console.error("[Router] Error loading settings-workspace route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"settings/workspace",error:e})})});O.on("/settings/notifications",()=>{if(console.log("[Router] Route: /settings/notifications"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"settings/notifications"}),W(()=>Promise.resolve().then(()=>Zp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"settings/notifications"})}).catch(e=>{console.error("[Router] Error loading settings-notifications route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"settings/notifications",error:e})})});O.on("/settings/integrations",()=>{if(console.log("[Router] Route: /settings/integrations"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),W(()=>Promise.resolve().then(()=>Eu),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(e=>{console.error("[Router] Error loading settings-integrations route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"settings/integrations",error:e})})});O.on("/settings/integrations/:provider",e=>{const t=e?.data?.provider||"";if(console.log("[Router] Route: /settings/integrations/"+t),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),W(()=>Promise.resolve().then(()=>Pu),void 0,import.meta.url).then(a=>{const n=document.getElementById("app");n.innerHTML=a.render({provider:t}),a.init&&a.init({provider:t}),u.publish(h.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(a=>{console.error("[Router] Error loading integration detail route:",a),u.publish(h.ROUTE_NAV_ERROR,{route:"settings/integrations",error:a})})});O.on("/settings/security",()=>{if(console.log("[Router] Route: /settings/security"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"settings/security"}),W(()=>Promise.resolve().then(()=>Wu),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"settings/security"})}).catch(e=>{console.error("[Router] Error loading settings-security route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"settings/security",error:e})})});O.on("/conversations",()=>{if(console.log("[Router] Route: /conversations"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"conversations"}),W(()=>Promise.resolve().then(()=>nm),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"conversations"})}).catch(e=>{console.error("[Router] Error loading conversations route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"conversations",error:e})})});O.on("/ab-testing",()=>{if(console.log("[Router] Route: /ab-testing"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"ab-testing"}),W(()=>Promise.resolve().then(()=>vm),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"ab-testing"})}).catch(e=>{console.error("[Router] Error loading ab-testing route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"ab-testing",error:e})})});O.on("/magnets",()=>{if(console.log("[Router] Route: /magnets"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"magnets"}),W(()=>Promise.resolve().then(()=>Cg),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"magnets"})}).catch(e=>{console.error("[Router] Error loading magnets route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"magnets",error:e})})});O.on("/templates",()=>{if(console.log("[Router] Route: /templates"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"templates"}),W(()=>Promise.resolve().then(()=>Og),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"templates"})}).catch(e=>{console.error("[Router] Error loading templates route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"templates",error:e})})});O.on("/questionnaires",()=>{if(console.log("[Router] Route: /questionnaires"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"questionnaires"}),W(()=>Promise.resolve().then(()=>Hg),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"questionnaires"})}).catch(e=>{console.error("[Router] Error loading questionnaires route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"questionnaires",error:e})})});O.on("/leads",()=>{if(console.log("[Router] Route: /leads"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"leads"}),W(()=>Promise.resolve().then(()=>sh),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"leads"})}).catch(e=>{console.error("[Router] Error loading leads route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"leads",error:e})})});O.on("/analytics",()=>{if(console.log("[Router] Route: /analytics"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"analytics"}),W(()=>Promise.resolve().then(()=>uh),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"analytics"})}).catch(e=>{console.error("[Router] Error loading analytics route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"analytics",error:e})})});O.on("/analytics/ad-performance",()=>{if(console.log("[Router] Route: /analytics/ad-performance"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"analytics/ad-performance"}),W(()=>Promise.resolve().then(()=>wh),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"analytics/ad-performance"})}).catch(e=>{console.error("[Router] Error loading ad-performance route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"analytics/ad-performance",error:e})})});O.on("/ad-accounts",()=>{if(console.log("[Router] Route: /ad-accounts"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"ad-accounts"}),W(()=>Promise.resolve().then(()=>Mh),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"ad-accounts"})}).catch(e=>{console.error("[Router] Error loading ad-accounts route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"ad-accounts",error:e})})});O.on("/clients",()=>{if(console.log("[Router] Route: /clients"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"clients"}),W(()=>Promise.resolve().then(()=>Vh),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"clients"})}).catch(e=>{console.error("[Router] Error loading clients route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"clients",error:e})})});O.on("/team",()=>{if(console.log("[Router] Route: /team"),!ce("home")){ne("signin");return}u.publish(h.ROUTE_NAV_BEFORE,{route:"team"}),W(()=>Promise.resolve().then(()=>tf),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(h.ROUTE_NAV_AFTER,{route:"team"})}).catch(e=>{console.error("[Router] Error loading team route:",e),u.publish(h.ROUTE_NAV_ERROR,{route:"team",error:e})})});O.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),ne("splash")});u.subscribe(h.ROUTE_NAV,(e,t)=>{console.log("[Router] ROUTE_NAV event received:",t),t?.route&&ne(t.route)});function To(){console.log("[App] Waiting for Neodigm 55 library...");let e=0;const t=100,a=setInterval(()=>{e++,e%10===0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(a),Kc()):e>=t&&(clearInterval(a),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
      ...
      `,u.publish(h.APP_ERROR,{message:"Failed to load authentication library"}))},100)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",To):To();async function Kc(){if(console.log("[App] Neodigm 55 loaded, initializing..."),Dc(),Gc(),oc(),Ne.initialize(),console.log("[App] I18n Controller initialized"),!await E.init({BASE_URL:"https://machfivemagnet-saas.onrender.com",navigateFunction:a=>{console.log("[AuthController] Navigation requested:",a),ne(a)}})){console.error("[App] AuthController initialization failed");return}const t=E.getEntity();t&&(console.log("[App] Session restored for:",t.email),u.publish(h.APP_USER_LOADED,{entity:t}),E.isAuthenticated()&&(localStorage.getItem(E.CONFIG.LS_KEYS.ACTIVE_ORG)?await E.fetchScope():E.fetchScope())),u.publish(h.APP_READY,{timestamp:new Date().toISOString(),sessionUser:t}),Vc(),Oc(),O.resolve(),window.AuthController=E,window.I18nController=Ne,window.MachVive=Gn,console.log("[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)")}u.subscribe(h.ROUTE_NAV_AFTER,(e,t)=>{typeof Ne<"u"&&Ne.refresh&&setTimeout(()=>{Ne.refresh()},100)});function Fe(e){const t=new Uint8Array(e);let a="";for(const o of t)a+=String.fromCharCode(o);return btoa(a).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"")}function Zt(e){const t=e.replace(/-/g,"+").replace(/_/g,"/"),a=(4-t.length%4)%4,n=t.padEnd(t.length+a,"="),o=atob(n),s=new ArrayBuffer(o.length),r=new Uint8Array(s);for(let i=0;i<o.length;i++)r[i]=o.charCodeAt(i);return s}function sa(){return lr.stubThis(globalThis?.PublicKeyCredential!==void 0&&typeof globalThis.PublicKeyCredential=="function")}const lr={stubThis:e=>e};function cr(e){const{id:t}=e;return{...e,id:Zt(t),transports:e.transports}}function dr(e){return e==="localhost"||/^((xn--[a-z0-9-]+|[a-z0-9]+(-[a-z0-9]+)*)\.)+([a-z]{2,}|xn--[a-z0-9-]+)$/i.test(e)}class he extends Error{constructor({message:t,code:a,cause:n,name:o}){super(t,{cause:n}),Object.defineProperty(this,"code",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),this.name=o??n.name,this.code=a}}function Jc({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new he({message:"Registration ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else if(e.name==="ConstraintError"){if(a.authenticatorSelection?.requireResidentKey===!0)return new he({message:"Discoverable credentials were required but no available authenticator supported it",code:"ERROR_AUTHENTICATOR_MISSING_DISCOVERABLE_CREDENTIAL_SUPPORT",cause:e});if(t.mediation==="conditional"&&a.authenticatorSelection?.userVerification==="required")return new he({message:"User verification was required during automatic registration but it could not be performed",code:"ERROR_AUTO_REGISTER_USER_VERIFICATION_FAILURE",cause:e});if(a.authenticatorSelection?.userVerification==="required")return new he({message:"User verification was required but no available authenticator supported it",code:"ERROR_AUTHENTICATOR_MISSING_USER_VERIFICATION_SUPPORT",cause:e})}else{if(e.name==="InvalidStateError")return new he({message:"The authenticator was previously registered",code:"ERROR_AUTHENTICATOR_PREVIOUSLY_REGISTERED",cause:e});if(e.name==="NotAllowedError")return new he({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="NotSupportedError")return a.pubKeyCredParams.filter(o=>o.type==="public-key").length===0?new he({message:'No entry in pubKeyCredParams was of type "public-key"',code:"ERROR_MALFORMED_PUBKEYCREDPARAMS",cause:e}):new he({message:"No available authenticator supported any of the specified pubKeyCredParams algorithms",code:"ERROR_AUTHENTICATOR_NO_SUPPORTED_PUBKEYCREDPARAMS_ALG",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if(dr(n)){if(a.rp.id!==n)return new he({message:`The RP ID "${a.rp.id}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new he({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="TypeError"){if(a.user.id.byteLength<1||a.user.id.byteLength>64)return new he({message:"User ID was not between 1 and 64 characters",code:"ERROR_INVALID_USER_ID_LENGTH",cause:e})}else if(e.name==="UnknownError")return new he({message:"The authenticator was unable to process the specified options, or could not create a new credential",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}class Qc{constructor(){Object.defineProperty(this,"controller",{enumerable:!0,configurable:!0,writable:!0,value:void 0})}createNewAbortSignal(){if(this.controller){const a=new Error("Cancelling existing WebAuthn API call for new one");a.name="AbortError",this.controller.abort(a)}const t=new AbortController;return this.controller=t,t.signal}cancelCeremony(){if(this.controller){const t=new Error("Manually cancelling existing WebAuthn API call");t.name="AbortError",this.controller.abort(t),this.controller=void 0}}}const Wn=new Qc,Xc=["cross-platform","platform"];function pr(e){if(e&&!(Xc.indexOf(e)<0))return e}async function Zc(e){!e.optionsJSON&&e.challenge&&(console.warn("startRegistration() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useAutoRegister:a=!1}=e;if(!sa())throw new Error("WebAuthn is not supported in this browser");const n={...t,challenge:Zt(t.challenge),user:{...t.user,id:Zt(t.user.id)},excludeCredentials:t.excludeCredentials?.map(cr)},o={};a&&(o.mediation="conditional"),o.publicKey=n,o.signal=Wn.createNewAbortSignal();let s;try{s=await navigator.credentials.create(o)}catch(f){throw Jc({error:f,options:o})}if(!s)throw new Error("Registration was not completed");const{id:r,rawId:i,response:l,type:c}=s;let g;typeof l.getTransports=="function"&&(g=l.getTransports());let b;if(typeof l.getPublicKeyAlgorithm=="function")try{b=l.getPublicKeyAlgorithm()}catch(f){pn("getPublicKeyAlgorithm()",f)}let d;if(typeof l.getPublicKey=="function")try{const f=l.getPublicKey();f!==null&&(d=Fe(f))}catch(f){pn("getPublicKey()",f)}let m;if(typeof l.getAuthenticatorData=="function")try{m=Fe(l.getAuthenticatorData())}catch(f){pn("getAuthenticatorData()",f)}return{id:r,rawId:Fe(i),response:{attestationObject:Fe(l.attestationObject),clientDataJSON:Fe(l.clientDataJSON),transports:g,publicKeyAlgorithm:b,publicKey:d,authenticatorData:m},type:c,clientExtensionResults:s.getClientExtensionResults(),authenticatorAttachment:pr(s.authenticatorAttachment)}}function pn(e,t){console.warn(`The browser extension that intercepted this WebAuthn API call incorrectly implemented ${e}. You should report this error to them.
`,t)}function ur(){if(!sa())return va.stubThis(new Promise(t=>t(!1)));const e=globalThis.PublicKeyCredential;return e?.isConditionalMediationAvailable===void 0?va.stubThis(new Promise(t=>t(!1))):va.stubThis(e.isConditionalMediationAvailable())}const va={stubThis:e=>e};function ed({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new he({message:"Authentication ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else{if(e.name==="NotAllowedError")return new he({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if(dr(n)){if(a.rpId!==n)return new he({message:`The RP ID "${a.rpId}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new he({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="UnknownError")return new he({message:"The authenticator was unable to process the specified options, or could not create a new assertion signature",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}async function td(e){!e.optionsJSON&&e.challenge&&(console.warn("startAuthentication() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useBrowserAutofill:a=!1,verifyBrowserAutofillInput:n=!0}=e;if(!sa())throw new Error("WebAuthn is not supported in this browser");let o;t.allowCredentials?.length!==0&&(o=t.allowCredentials?.map(cr));const s={...t,challenge:Zt(t.challenge),allowCredentials:o},r={};if(a){if(!await ur())throw Error("Browser does not support WebAuthn autofill");if(document.querySelectorAll("input[autocomplete$='webauthn']").length<1&&n)throw Error('No <input> with "webauthn" as the only or last value in its `autocomplete` attribute was detected');r.mediation="conditional",s.allowCredentials=[]}r.publicKey=s,r.signal=Wn.createNewAbortSignal();let i;try{i=await navigator.credentials.get(r)}catch(m){throw ed({error:m,options:r})}if(!i)throw new Error("Authentication was not completed");const{id:l,rawId:c,response:g,type:b}=i;let d;return g.userHandle&&(d=Fe(g.userHandle)),{id:l,rawId:Fe(c),response:{authenticatorData:Fe(g.authenticatorData),clientDataJSON:Fe(g.clientDataJSON),signature:Fe(g.signature),userHandle:d},type:b,clientExtensionResults:i.getClientExtensionResults(),authenticatorAttachment:pr(i.authenticatorAttachment)}}function ad(){return sa()?PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable():new Promise(e=>e(!1))}const mr=Object.freeze(Object.defineProperty({__proto__:null,WebAuthnAbortService:Wn,WebAuthnError:he,_browserSupportsWebAuthnAutofillInternals:va,_browserSupportsWebAuthnInternals:lr,base64URLStringToBuffer:Zt,browserSupportsWebAuthn:sa,browserSupportsWebAuthnAutofill:ur,bufferToBase64URLString:Fe,platformAuthenticatorIsAvailable:ad,startAuthentication:td,startRegistration:Zc},Symbol.toStringTag,{value:"Module"}));let $o=!1;function nd(){if($o)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
    .accept-invite-page {
  ...
  `,document.head.appendChild(e),$o=!0}function od(){const e=new URLSearchParams(window.location.search||"");let t=e.get("uid")||"",a=e.get("token")||"";if(!t||!a){const n=window.location.hash||"",o=n.includes("?")?n.slice(n.indexOf("?")+1):"",s=new URLSearchParams(o);if(t=t||s.get("uid")||"",a=a||s.get("token")||"",!t||!a){const r=n.replace(/^#\/?/,"").split("?")[0].split("/").filter(Boolean);t=t||r[1]||"",a=a||r[2]||""}}try{return{uid:decodeURIComponent(t),token:decodeURIComponent(a)}}catch{return{uid:t,token:a}}}function gr(){return nd(),`
    ...
    </div>`}function hr(){const{uid:e,token:t}=od(),a=document.getElementById("accept-invite-form"),n=document.getElementById("ai-first"),o=document.getElementById("ai-last"),s=document.getElementById("ai-pass"),r=document.getElementById("ai-confirm"),i=document.getElementById("ai-submit"),l=document.getElementById("ai-msg");if(!a)return;const c=(g,b="error")=>{l.textContent=g,l.className=`accept-invite-msg ${b}`};if(!e||!t){c("This invitation link is invalid or incomplete. Please use the link from your email."),i.disabled=!0;return}a.addEventListener("submit",async g=>{g.preventDefault();const b=(n.value||"").trim(),d=(o.value||"").trim(),m=s.value||"",f=r.value||"";if(!b||!d){c("Please enter your first and last name.");return}if(m.length<8){c("Password must be at least 8 characters.");return}if(m!==f){c("Passwords do not match.");return}i.disabled=!0,c("Setting up your account…","ok");try{const p=E.getConfig?.().BASE_URL||"",v=await fetch(`${p}/m5t/v5/acctEntity/acceptInvite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({uid:e,token:t,password:m,first:b,last:d})}),x=await v.json().catch(()=>({}));if(!v.ok||!x.ok){const T=v.status===410?"This invitation has expired. Ask for a new one.":v.status===409?"This invitation has already been used. Try signing in.":x.error||`Could not accept the invitation (HTTP ${v.status}).`;c(T),i.disabled=!1;return}try{window.history.replaceState({},"",window.location.pathname+window.location.hash)}catch{}c("Welcome! Signing you in…","ok"),(await E.doSignin(x.entity.email,m))?.ok||(c("Your account is ready. Please sign in.","ok"),setTimeout(()=>{window.location.hash="#/signin"},1200))}catch(p){console.error("[accept-invite] error:",p),c("Something went wrong. Please try again."),i.disabled=!1}})}const sd={render:gr,init:hr},rd=Object.freeze(Object.defineProperty({__proto__:null,default:sd,init:hr,render:gr},Symbol.toStringTag,{value:"Module"})),id=""+new URL("mfm-lockup-white.png",import.meta.url).href,ld=""+new URL("mfm-lockup-black.png",import.meta.url).href,cd=""+new URL("mfm-lockup-color.png",import.meta.url).href,fr=""+new URL("m5mag-lockup.png",import.meta.url).href,dd="https://www.machfivemarketing.com",pd=fr,vr=cd;function Mt(e="#/splash"){return`
        <a class="auth-brand" href="${e}" aria-label="Mach Five Magnet">
          <img src="${fr}" alt="Mach Five Magnet" height="42" />
        </a>`}function yt(e="panel"){const t=e==="light";return`
    <a class="auth-cobrand${t?" auth-cobrand--light":""}" href="${dd}"
       target="_blank" rel="noopener" aria-label="From Mach Five Marketing">
      <span class="auth-cobrand__label">From</span>
      <img class="auth-cobrand__logo" src="${t?ld:id}"
           alt="Mach Five Marketing" height="26" loading="lazy" />
    </a>`}const ud={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ye=e=>String(e??"").replace(/[&<>"']/g,t=>ud[t]);function Ye(e){if(!e)return"";try{return new Date(e).toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}catch{return String(e)}}function md(e,t={}){const a=t[e.id];if(e.type==="checkbox_group"){const n=Array.isArray(a)?a:[];return n.length?ye(n.join(", ")):""}return a?ye(a):""}function Yn(e,{emptyLabel:t="(blank)",renderAnswer:a=null}={}){const n=e?.questionnaire?.sections||[],o=e?.answers||{};return n.length?n.map(s=>`
    <div class="qm-section">
      <h3>${ye(s.title)}</h3>
      ${(s.questions||[]).map(r=>`
        <div class="qm-qa" data-question-id="${ye(r.id)}" data-question-type="${ye(r.type)}">
          <div class="qm-qa__q">${ye(r.label)}</div>
          <div class="qm-qa__a">${a?a(r,o):md(r,o)||`<span class="qm-qa__a--empty">${ye(t)}</span>`}</div>
        </div>`).join("")}
    </div>`).join(""):'<p class="qm-qa__a qm-qa__a--empty">This questionnaire has no questions.</p>'}function gd(e,t={}){const a=t[e.id];if(e.type==="checkbox_group"){const n=Array.isArray(a)?a:[];return`<div class="qm-checkbox-group">${(Array.isArray(e.options)?e.options:[]).map(s=>`
      <label><input type="checkbox" value="${ye(s)}" ${n.includes(s)?"checked":""}/> ${ye(s)}</label>`).join("")}</div>`}return e.type==="textarea"?`<textarea>${ye(a||"")}</textarea>`:`<input type="text" value="${ye(a||"")}" />`}function br(e){const t={};return e&&e.querySelectorAll("[data-question-id]").forEach(a=>{const n=a.dataset.questionId;if(a.dataset.questionType==="checkbox_group"){const o=[...a.querySelectorAll('input[type="checkbox"]:checked')].map(s=>s.value);o.length&&(t[n]=o)}else{const o=(a.querySelector("input,textarea")?.value||"").trim();o&&(t[n]=o)}}),t}function Kn(e){const t=e?.recipient_email?`<p class="qm-recipient">Sent to ${ye(e.recipient_email)}</p>`:"",a=e?.last_edited_tz?`<p class="qm-edited-marker">Last edited by ${ye(e.last_edited_by_email||"a team member")} on ${ye(Ye(e.last_edited_tz))}</p>`:"",n=e?.client_edited_tz?`<p class="qm-edited-marker">Updated by the client on ${ye(Ye(e.client_edited_tz))}</p>`:"";return t+a+n}let Lo=!1;function Jn(){if(Lo)return;const e=document.createElement("style");e.id="m5t-questionnaire-answer-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Lo=!0}const hd=""+new URL("auth-hero-sketch.jpg",import.meta.url).href;let Io=!1;function fd(){if(Io)return;const e=document.createElement("style");e.id="m5t-questionnaire-fill-styles",e.textContent=`
    .qf-page {
    ...
    .qf-page::before {
      ...
      background: url("${hd}") center / cover no-repeat;
  ...
  `,document.head.appendChild(e),Jn(),Io=!0}function _r(){return E.getConfig?.().BASE_URL||""}function vd(e){const t=`qf-${e.id}`;if(e.type==="checkbox_group"){const a=Array.isArray(e.options)?e.options:[];return`
    ...
    </div></div></div>`}function yr(){return fd(),`<div id="qf-root">${ba("hourglass_top","Loading your questionnaire…","One moment.")}</div>`}async function Ha(){const e=document.getElementById("qf-root");if(!e)return;const t=ic();if(!t){e.innerHTML=ba("error","Invalid link","This link is missing required information. Please use the link exactly as sent.");return}let a;try{const o=await fetch(`${_r()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(t.guid)}?token=${encodeURIComponent(t.token)}`),s=await o.json().catch(()=>({}));if(!o.ok||!s.ok){const r=o.status===404?s.error||"This link is invalid or has expired.":"Something went wrong loading your questionnaire. Please try again shortly.";e.innerHTML=ba("error","Cannot open this questionnaire",r);return}a=s.data}catch(o){console.error("[questionnaire-fill] load error:",o),e.innerHTML=ba("wifi_off","Connection problem","Could not reach the server. Please check your connection and try again.");return}const n=bd(a);if(n==="locked"){yd(e,a);return}wd(e,a,t,n)}function bd(e){return e.status!=="SUBMITTED"?"fill":(e.editability||{editable:!e.locked_tz}).editable?"edit":"locked"}function _d(e){const t=e.editability||{};return t.reason==="finalized"?"Your account manager has finalised these answers, so they can no longer be changed here.":`Answers can be changed for 14 days after they are submitted.${t.deadline?` The window closed on ${Ye(t.deadline)}.`:""}`}function yd(e,t){e.innerHTML=`
    <div class="qf-page"><div class="qf-card">
      <img class="qf-brand" src="${vr}" alt="Mach Five Marketing" height="34" />
      ...
      <div class="qf-note qf-note--locked">
        ...
        <span>${ue(_d(t))} To change anything now, contact your account manager.</span>
      </div>
      ${Kn(t)}
      ${Yn(t,{emptyLabel:"Left blank"})}
    </div></div>`}function wd(e,t,a,n){const o=n==="edit",s=t.questionnaire?.sections||[],r=t.answers||{},i=t.editability?.deadline,l=o?"Change anything you need to, then save. Everything you sent before is already filled in.":"Answer what applies. If a question doesn't apply to your business, leave it blank.",c=o?`<div class="qf-note">
    ...
    </div></div>`;const g=[...e.querySelectorAll(".qf-section[data-step]")],b=[...e.querySelectorAll(".qf-dot")],d=document.getElementById("qf-back"),m=document.getElementById("qf-next"),f=document.getElementById("qf-submit"),p=document.getElementById("qf-progress-label");let v=0;function x(L,j=1){v=Math.max(0,Math.min(s.length-1,L)),g.forEach((J,ae)=>{J.hidden=ae!==v,J.classList.remove("qf-enter")});const K=g[v];K&&(K.style.setProperty("--qf-dx",`${j>=0?14:-14}px`),K.offsetWidth,K.classList.add("qf-enter")),b.forEach((J,ae)=>{ae===v?J.setAttribute("aria-current","step"):J.removeAttribute("aria-current")}),p&&(p.textContent=`Section ${v+1} of ${s.length}`),d.style.visibility=v===0?"hidden":"",m.style.display=v===s.length-1?"none":"",f.style.display=v===s.length-1?"":"none",e.querySelector(".qf-card")?.scrollIntoView({block:"start"})}d.addEventListener("click",()=>x(v-1,-1)),m.addEventListener("click",()=>x(v+1,1)),b.forEach(L=>L.addEventListener("click",()=>{const j=Number(L.dataset.step)||0;x(j,j>=v?1:-1)})),x(0),e.querySelectorAll("[data-question-id]").forEach(L=>{const j=L.dataset.questionId,K=L.dataset.questionType,J=r[j];if(J!=null)if(K==="checkbox_group"){const ae=Array.isArray(J)?J:[];L.querySelectorAll('input[type="checkbox"]').forEach(me=>{me.checked=ae.includes(me.value)})}else{const ae=L.querySelector("input,textarea");ae&&(ae.value=J)}});const y=document.getElementById("qf-form"),T=document.getElementById("qf-submit"),N=document.getElementById("qf-msg"),U=(L,j="error")=>{N.textContent=L,N.className=`qf-msg ${j}`};y.addEventListener("submit",async L=>{L.preventDefault();const j=br(e),K=`${_r()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(a.guid)}`,J=o?`${K}?token=${encodeURIComponent(a.token)}`:`${K}/submit?token=${encodeURIComponent(a.token)}`;T.disabled=!0,U(o?"Saving…":"Submitting…","ok");let ae;try{ae=await fetch(J,{method:o?"PUT":"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({answers:j})});const me=await ae.json().catch(()=>({}));if(!ae.ok||!me.ok){if(ae.status===423){U(me.error||"These answers are now locked.","error"),await Ha();return}const D=ae.status===409?o?"This questionnaire is not open for changes.":"This questionnaire has already been submitted.":ae.status===404?"This link is invalid or has expired.":me.error||`Could not ${o?"save":"submit"} (HTTP ${ae.status}).`;U(D),T.disabled=!1;return}xd(e,o,me.data?.editability?.deadline)}catch(me){console.error(`[questionnaire-fill] ${o?"edit":"submit"} error:`,me),U("Something went wrong. Please try again."),T.disabled=!1}})}function xd(e,t,a){const n=a?` until ${Ye(a)}`:"";e.innerHTML=`
    <div class="qf-page"><div class="qf-card"><div class="qf-state">
    ...
    </div></div></div>`,document.getElementById("qf-again")?.addEventListener("click",()=>{Ha()})}const Ed={render:yr,init:Ha},kd=Object.freeze(Object.defineProperty({__proto__:null,default:Ed,init:Ha,render:yr},Symbol.toStringTag,{value:"Module"}));function Ad(){return`
    <div class="auth-container splash">
      <div class="auth-left">
        <div class="splash-content">
          <h1 class="splash-mark"><img src="${pd}" alt="Mach Five Magnet" height="88" /></h1>
  ...
  `}function Sd(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const e=localStorage.getItem(G.FF_SSE_LS_TOKEN),t=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!e,hasMvvTs:!!t});const a=document.getElementById("splash-loader"),n=document.getElementById("splash-actions");e?(console.log("[SplashRoute] Auth token found → HOME"),u.publish(h.ROUTE_NAV,{route:"home"})):t?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),u.publish(h.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),a&&(a.style.display="none"),n&&(n.style.display="flex"),document.querySelectorAll("[data-route]").forEach(s=>{s.addEventListener("click",()=>{const r=s.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${r}`),u.publish(h.ROUTE_NAV,{route:r})})}))},4e3)}const Cd=Object.freeze(Object.defineProperty({__proto__:null,init:Sd,render:Ad},Symbol.toStringTag,{value:"Module"}));function _e(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}const Td=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;function Qn(e,t){return e?Td.test(e)?!0:(_e(t,$.get("validation_email_invalid")),!1):(_e(t,$.get("validation_email_required")),!1)}function $d(){return`
  ...
  `}function Ld(){console.log("[SigninRoute] Initialized");const e=document.getElementById("loginForm"),t=document.getElementById("email"),a=document.getElementById("password"),n=document.getElementById("togglePassword"),o=document.getElementById("rememberEmail"),s=localStorage.getItem(E.CONFIG.LS_KEYS.REMEMBERED_EMAIL);s&&t&&o&&(t.value=s,o.checked=!0,a?.focus()),n?.addEventListener("click",()=>{const g=a.type==="password"?"text":"password";a.type=g});const r=document.getElementById("passkeySigninBtn"),i=document.getElementById("passkeyDivider"),l=document.getElementById("passkeyHint");window.PublicKeyCredential&&r&&i&&(r.style.display="",i.style.display="",l&&(r.title=l.textContent),r.addEventListener("click",()=>Nd())),e?.addEventListener("submit",async g=>{g.preventDefault();const b=t.value.trim(),d=a.value;Qn(b,t)&&Id(d,a)&&(o?.checked?localStorage.setItem(E.CONFIG.LS_KEYS.REMEMBERED_EMAIL,b):localStorage.removeItem(E.CONFIG.LS_KEYS.REMEMBERED_EMAIL),await Rd(b,d))}),document.getElementById("link--uc__underline")?.addEventListener("click",g=>{g.preventDefault(),u.publish(h.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",g=>{g.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),u.publish(h.ROUTE_NAV,{route:"signup"})})}function Id(e,t){return e?e.length<10?(_e(t,$.get("validation_password_min_length")),!1):!0:(_e(t,$.get("validation_password_required")),!1)}async function Rd(e,t){const a=document.querySelector(".btn");a.disabled=!0,a.textContent=$.get("loading_signing_in");try{const n=await E.doSignin(e,t);n.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q($.get("success_welcome_back"),"success"),u.publish(h.AUTH_SIGNIN_SUCCESS,{entity:E.getEntity()})):n.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q($.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(n.error||$.get("error_signin_failed"),"danger"),a.disabled=!1,a.textContent=($.get("sign_in")||"Sign in").toUpperCase())}catch(n){console.error("[SigninRoute] Sign in error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||$.get("error_network"),"danger"),a.disabled=!1,a.textContent=($.get("sign_in")||"Sign in").toUpperCase(),u.publish(h.AUTH_SIGNIN_FAIL,{message:n.message})}}async function Nd(){const e=document.getElementById("passkeySigninBtn");e.disabled=!0;try{const t=await E.doPasskeySignin();t.ok?(console.log("[SigninRoute] Passkey signin successful"),typeof neodigmToast<"u"&&neodigmToast.q($.get("success_welcome_back"),"success"),u.publish(h.AUTH_SIGNIN_SUCCESS,{entity:E.getEntity()})):document.getElementById("passkeyHint")?.style.removeProperty("display"),!t.ok&&!t.canceled&&typeof neodigmToast<"u"&&neodigmToast.q(t.error||$.get("error_signin_failed"),"danger")}catch(t){console.error("[SigninRoute] Passkey signin error:",t),typeof neodigmToast<"u"&&neodigmToast.q(t.message||$.get("error_network"),"danger")}finally{e.disabled=!1}}const Od=Object.freeze(Object.defineProperty({__proto__:null,init:Ld,render:$d},Symbol.toStringTag,{value:"Module"}));function Xn(e){const t=[];return e.length<12&&t.push("at least 12 characters"),e.length>1024&&t.push("at most 1024 characters"),/[a-z]/.test(e)||t.push("1 lowercase"),/[A-Z]/.test(e)||t.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(e)||t.push("1 special character"),/[^\x00-\x7F]/.test(e)&&t.push("ASCII characters only"),t}function wr(e){if(e.length===0)return"";if(e.includes("ASCII characters only"))return"Password cannot contain emoji|or special unicode characters";const t=e.find(a=>/^at (?:least|most) \d+ characters$/.test(a));return t?`Password must have ${t.replace(/ (\d+ characters)$/,"|$1")}`:"Password must have: Uppercase,|Lowercase, and Special Character"}const Md="2026-07-15";function Pd(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Mt()}
  ...
  `}function Fd(){console.log("[SignupRoute] Initialized");const e=document.getElementById("signupForm"),t=e.querySelector('button[type="submit"]');Ro("togglePassword","password","eyeIcon"),Ro("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),u.publish(h.ROUTE_NAV,{route:"signin"})}),e.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),s=document.getElementById("last").value.trim(),r=document.getElementById("email").value.trim(),i=document.getElementById("company").value.trim(),l=document.getElementById("phone").value.trim(),c=document.getElementById("password").value,g=document.getElementById("confirmPassword").value,b=document.getElementById("first"),d=document.getElementById("last"),m=document.getElementById("email"),f=document.getElementById("password"),p=document.getElementById("confirmPassword");if(!No(o,b,$.get("validation_first_name_required"))||!No(s,d,$.get("validation_last_name_required"))||!Qn(r,m)||!Dd(c,f))return;if(c!==g){_e(p,$.get("validation_password_mismatch"));return}const v=document.getElementById("acceptTerms");if(!v.checked){_e(v,"Please accept the Terms of Service and Privacy Policy to continue.");return}t.disabled=!0,t.textContent=$.get("loading_creating_account"),await Bd(o,s,r,i,l,c)})}function Ro(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function No(e,t,a){return e?!0:(_e(t,a),!1)}function Dd(e,t){if(!e)return _e(t,$.get("validation_password_required")),!1;const a=Xn(e);return a.length>0?(_e(t,wr(a)),!1):!0}async function Bd(e,t,a,n,o,s){const r=document.querySelector('button[type="submit"]');try{const i={email:a,password:s,first:e,last:t};n&&(i.company=n),o&&(i.phone=o),i.terms_accepted=!0,i.legal_version=Md;const l=await E.doSignup(i);if(l.ok)u.publish(h.AUTH_SIGNUP_SUCCESS,{email:a}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const c=l.error||l.message||$.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(c,"danger"),r.disabled=!1,r.textContent=($.get("create_account")||"Create account").toUpperCase(),u.publish(h.AUTH_SIGNUP_FAIL,{message:c})}}catch(i){console.error("[SignupRoute] Sign up error:",i),typeof neodigmToast<"u"&&neodigmToast.q(i.message||$.get("error_network"),"danger"),r.disabled=!1,r.textContent=($.get("create_account")||"Create account").toUpperCase(),u.publish(h.AUTH_SIGNUP_FAIL,{message:i.message})}}const qd=Object.freeze(Object.defineProperty({__proto__:null,init:Fd,render:Pd},Symbol.toStringTag,{value:"Module"}));function Ud(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Mt()}
  ...
  `}function Yd(){console.log("[ForgotRoute] Initialized");const e=document.getElementById("forgot-form"),t=document.getElementById("email");e?.addEventListener("submit",async a=>{a.preventDefault();const n=t.value.trim();Qn(n,t)&&await Kd(n)})}async function Kd(e){const t=document.querySelector(".btn");t.disabled=!0,t.textContent="SENDING...";try{const a=await Vd.forgotPassword(e);a.ok&&a.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q($.get("success_reset_link_sent"),"success"),u.publish(h.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(a.data.error||$.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=($.get("send_reset_link")||"Send reset link").toUpperCase())}catch(a){console.error("[ForgotRoute] Forgot password error:",a),typeof neodigmToast<"u"&&neodigmToast.q(a.message||$.get("error_network"),"danger"),t.disabled=!1,t.textContent=($.get("send_reset_link")||"Send reset link").toUpperCase()}}const Jd=Object.freeze(Object.defineProperty({__proto__:null,init:Yd,render:Wd},Symbol.toStringTag,{value:"Module"}));function Qd(){const t=E.getEntity()?.email||"";return`
    <div class="auth-container">
      <div class="auth-left">
        ${Mt("#/home")}
  ...
  `}function Xd(){console.log("[ResethashRoute] Initialized");const e=document.getElementById("resethash-form"),t=e.querySelector('button[type="submit"]');Oo("toggleNewPassword","new-password","eyeIconNew"),Oo("toggleConfirmPassword","confirm-password","eyeIconConfirm"),e?.addEventListener("submit",async a=>{a.preventDefault();const n=e.email.value.trim(),o=e.newPassword.value,s=e.confirmPassword.value,r=document.getElementById("new-password"),i=document.getElementById("confirm-password");if(!o){_e(r,$.get("validation_new_password_required"));return}const l=Xn(o);if(l.length>0){_e(r,wr(l));return}if(!s){_e(i,$.get("validation_new_password_required"));return}if(o!==s){_e(i,$.get("validation_password_mismatch"));return}t.disabled=!0,t.textContent=$.get("loading_resetting_password");try{const c=await E.doResetHash(n,o);c.ok?(typeof neodigmToast<"u"&&neodigmToast.q($.get("success_password_reset"),"success"),u.publish(h.AUTH_RESETHASH_SUCCESS,{email:n})):(_e(r,c.error||$.get("error_signin_failed")),t.disabled=!1,t.textContent=($.get("update_password")||"Update password").toUpperCase())}catch(c){console.error("[ResethashRoute] Reset password error:",c),_e(r,c.message||$.get("error_network")),t.disabled=!1,t.textContent=($.get("update_password")||"Update password").toUpperCase()}})}function Oo(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}const Zd=Object.freeze(Object.defineProperty({__proto__:null,init:Xd,render:Qd},Symbol.toStringTag,{value:"Module"})),ie=()=>E.getManagedClients().length>0&&!E.getStoredActiveOrg(),Qe=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),ep={reseller_org:"Your org",managed_client:"Client",saas_org:"Org"};let Mo=!1;function wt(){if(Mo)return;const e=document.createElement("style");e.id="m5t-portfolio-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Mo=!0}const Po=e=>e.toISOString().slice(0,10);async function tp(e,{days:t=30}={}){const a=new Date,n=Po(new Date(a.getTime()-(t-1)*864e5)),o=Po(a),s=await fetch(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${o}&group_by=owner`);if(!s.ok)throw new Error(`HTTP ${s.status}`);const r=await s.json();if(!r.ok)throw new Error("stats not ok");return r.by_owner||[]}function xr(e,t){return`<div class="dash-clients-scroll"><table class="dash-clients">
    <thead><tr>
    ...
    </div>`}async function nt(e,t,{emptyMsg:a}={}){const n=document.getElementById("pf-picker-body");if(n)try{const o=await tp(e);if(!o.length){n.innerHTML=xn("groups",a||"No client orgs yet. Create one under Clients first.");return}n.innerHTML=xr(o,t),Er(n)}catch(o){console.warn("[portfolio] picker load failed:",o),n.innerHTML=xn("error","Could not load your clients. Please refresh.")}}function kr(){const e={};return E.getManagedClients().forEach(t=>{e[t.orgGuid]=t.name}),E.getMemberships().forEach(t=>{t.orgGuid&&!e[t.orgGuid]&&(e[t.orgGuid]=t.name||"")}),e}const Ar=e=>e?`<span class="pf-client-chip">${Qe(e)}</span>`:"",vt=Object.freeze({MAGNET_TEMPLATE:"magnet_template",LEADS_SEARCH:"leads_search",LEADS_DAY:"leads_day"}),Lt=new Map;function Zn(e,t){Lt.set(e,t)}function En(e){if(!Lt.has(e))return null;const t=Lt.get(e);return Lt.delete(e),t}function np(e){return Lt.has(e)?Lt.get(e):null}const Ae=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,be=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),te=e=>Number(e||0).toLocaleString(),Sr=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",op=e=>(Sr(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function sp(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric"})}catch{return""}}function rp(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}let Fo=!1;function ip(){if(Fo)return;const e=document.createElement("style");e.id="m5t-dash-recent-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Fo=!0}function lp(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${be(op(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${be(Sr(e))}</span>
    ...
    <span class="recent-lead__time">${be(sp(e))}</span>
  ...
  <div class="dashboard-card${n?" chart-card-wide":""}${o?" chart-card-full":""}">
  ...
  </div>`;let kn=30;function Cr(){ip(),wt();const e=ie();return`
    <div class="page-shell" data-section="home">
      ...
      <div class="content-grid">
    ...
    </div>`}async function Tr(){const e=E.getConfig?.().BASE_URL||"";document.getElementById("dash-periods")?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(kn=Number(a.dataset.days)||30,document.querySelectorAll("#dash-periods .chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===kn)),Bo(e))}),document.getElementById("dash-campaigns")?.addEventListener("click",t=>{const a=t.target.closest("[data-campaign]");a&&Zn(vt.LEADS_SEARCH,a.dataset.campaign)}),await Promise.all([Bo(e),up(e)])}const Be=(e,t)=>{const a=document.getElementById(e);a&&(a.textContent=t)},Ct=(e,t)=>{const a=document.getElementById(e);a&&(a.innerHTML=t)},Do=e=>e.toISOString().slice(0,10),cp=()=>typeof window.matchMedia=="function"?window.matchMedia("(hover: hover)").matches:!0;async function Bo(e){const t=new Date,a=Do(new Date(t.getTime()-(kn-1)*864e5)),n=Do(t),o=ie();let s;try{const T=await fetch(`${e}/m5t/v5/dashboard/stats?from=${a}&to=${n}${o?"&group_by=owner":""}`);if(!T.ok)throw new Error(`HTTP ${T.status}`);if(s=await T.json(),!s.ok)throw new Error("stats not ok")}catch(y){console.warn("[dashboard] stats fetch failed:",y),["stat-active-magnets","stat-opens","stat-leads","stat-completion"].forEach(N=>Be(N,"—")),["stat-active-magnets-sub","stat-opens-sub","stat-leads-sub","stat-completion-sub"].forEach(N=>Be(N,"Unavailable"));const T=document.getElementById("stat-leads-trend");T&&(T.className="stat-trend",T.innerHTML=""),["dash-trend","dash-funnel","dash-campaigns","dash-routes","dash-interactions","dash-portfolio"].forEach(N=>Ct(N,Ae("error","Could not load. Please refresh.")));return}o&&dp(s.by_owner||[]),Be("stat-active-magnets",te(s.magnets.active)),Be("stat-active-magnets-sub",s.magnets.total>s.magnets.active?`${te(s.magnets.total-s.magnets.active)} paused`:s.magnets.active?"All running":"No magnets yet");const r=s.funnel||{};Be("stat-opens",r.opens?te(r.opens):"—"),Be("stat-opens-sub",r.opens?r.engagement_rate!=null?`${r.engagement_rate}% engage`:`${te(r.engaged)} engaged`:"No opens in this range yet");const i=s.leads||{};Be("stat-leads",te(i.total));const l=(i.this_week||0)-(i.prev_week||0);Be("stat-leads-sub",i.total?`${te(i.this_week)} this week`:"No leads yet");const c=document.getElementById("stat-leads-trend");if(c)if((i.prev_week||0)>0){const y=l>0?"positive":l<0?"negative":"neutral",T=l>0?"trending_up":l<0?"trending_down":"trending_flat";c.className=`stat-trend ${y}`,c.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">${T}</span>${l>0?"+":""}${te(l)}`}else c.className="stat-trend",c.innerHTML="";Be("stat-completion",r.completion_rate!=null?`${r.completion_rate}%`:"—"),Be("stat-completion-sub",r.opens?`${te(r.completions)} completed of ${te(r.opens)} opens`:"Appears once magnets get opened");const g=s.by_day||[],b=g.some(y=>y.opens||y.leads);Ct("dash-trend",b?$r(g):Ae("show_chart","No activity in this range yet. Opens and leads chart here as visitors engage your magnets.")),b&&Lr(g),Ct("dash-funnel",r.opens?pp(r):Ae("filter_alt","The funnel fills in once your magnets record opens."));const d=s.top_campaigns||[];Ct("dash-campaigns",d.length?`<div class="dash-list">${d.map(y=>`
        <a class="dash-list__row dash-list__row--link" href="#/leads" data-campaign="${be(y.campaign)}" title="Show the leads from ${be(y.campaign)}">
          ...
          <span class="dash-list__num">${te(y.leads)}</span>
          <span class="dash-list__go material-symbols-outlined" aria-hidden="true">chevron_right</span>
        </a>`).join("")}</div>`:Ae("source","No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here."));const m={book:["event","Book"],chat:["chat","Chat"],call:["phone_in_talk","Call"],email:["mail","Email"],support:["support_agent","Support"]},f=Object.entries(r.routes||{}).sort((y,T)=>T[1]-y[1]),p=f.length?f[0][1]:0;Ct("dash-routes",f.length?`<div class="dash-funnel">${f.map(([y,T])=>{const[N,U]=m[y]||["touch_app",y];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${N}</span> ${be(U)}</span><span class="dash-funnel__val">${te(T)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${p?Math.max(4,Math.round(T/p*100)):0}%"></div></div>
        </div>`}).join("")}</div>`:Ae("touch_app","CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar."));const v={open:["visibility","Magnet opened"],engage:["touch_app","Visitor engaged"],route:["alt_route","Picked a channel"],complete:["check_circle","Completed: lead captured"]},x=s.recent_events||[];Ct("dash-interactions",x.length?`<div class="dash-list">${x.map(y=>{const[T,N]=v[y.event]||["sensors",y.event],U=y.event==="route"&&y.detail?` · ${be(y.detail)}`:"";return`<div class="dash-list__row">
    ...
    </div>`).join("")}</div>`}async function up(e){const t=document.getElementById("recent-leads-body");if(t)try{const a=await fetch(`${e}/m5t/v5/m5mLead`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json(),o=(Array.isArray(n?.data)?n.data:[]).filter(s=>!["DELETED","ARCHIVED"].includes(s.status));t.innerHTML=o.length?o.slice(0,5).map(lp).join(""):Ae("contacts","No leads captured yet. Publish a magnet to start collecting.")}catch(a){console.warn("[dashboard] Leads fetch failed:",a),t.innerHTML=Ae("error","Could not load recent leads.")}}function qo(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}const Uo=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e));function $r(e){const m=e.length||1,f=qo(Math.max(1,...e.map(H=>H.opens||0))),p=qo(Math.max(1,...e.map(H=>H.leads||0))),v=748/m,x=Math.min(22,v*.55),y=H=>46+v*(H+.5),T=H=>266-H/f*248,N=H=>266-H/p*248,U=[0,.5,1].map(H=>{const Z=266-H*248;return`<line x1="46" y1="${Z.toFixed(1)}" x2="794" y2="${Z.toFixed(1)}" class="dash-grid"/><text x="38" y="${(Z+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${Uo(f*H)}</text><text x="802" y="${(Z+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${Uo(p*H)}</text>`}).join(""),L=e.map((H,Z)=>{const ot=T(H.opens||0);return`<rect class="dash-bar" data-i="${Z}" x="${(y(Z)-x/2).toFixed(1)}" y="${ot.toFixed(1)}" width="${x.toFixed(1)}" height="${Math.max(0,266-ot).toFixed(1)}" rx="3"/>`}).join(""),j=e.map((H,Z)=>`${y(Z).toFixed(1)},${N(H.leads||0).toFixed(1)}`).join(" "),K=m>1?`<polyline class="dash-line" points="${j}" fill="none" stroke-width="2.5"/>`:"",J=e.map((H,Z)=>`<circle class="dash-dot" data-i="${Z}" cx="${y(Z).toFixed(1)}" cy="${N(H.leads||0).toFixed(1)}" r="3.2"/>`).join(""),ae='<line class="dash-crosshair" x1="0" y1="18" x2="0" y2="266" pointer-events="none"/>',me=Math.max(1,Math.ceil(m/6)),D=e.map((H,Z)=>Z%me===0||Z===m-1?`<text x="${y(Z).toFixed(1)}" y="288" text-anchor="middle" class="dash-ax">${H.date.slice(5)}</text>`:"").join(""),le=e.map((H,Z)=>`<rect class="dash-hit" data-i="${Z}" data-day="${be(H.date)}" data-leads="${Number(H.leads||0)}" x="${(46+v*Z).toFixed(1)}" y="18" width="${v.toFixed(1)}" height="${248 .toFixed(1)}" fill="transparent"/>`).join("");return`
    ...
    <div class="dash-chart-wrap">
      ...
      ${Number(b.leads||0)>0?'<div class="dash-chart-tip__go">Click to see them →</div>':""}`;const d=g.getBoundingClientRect(),m=t.getBoundingClientRect();a.style.left=`${d.left-m.left+d.width/2}px`,a.style.top=`${d.top-m.top}px`,a.hidden=!1,r(c,g)},l=()=>{a.hidden=!0,s()};t.querySelectorAll(".dash-hit").forEach(c=>{const g=Number(c.dataset.i);c.addEventListener("mouseenter",()=>i(g,c)),c.addEventListener("mousemove",()=>i(g,c)),c.addEventListener("mouseleave",l),c.addEventListener("click",()=>{const b=c.classList.contains("dash-hit--on");i(g,c),Number(c.dataset.leads||0)&&(!cp()&&!b||(Zn(vt.LEADS_DAY,c.dataset.day),window.location.hash="#/leads"))})})}const mp={render:Cr,init:Tr},gp=Object.freeze(Object.defineProperty({__proto__:null,default:mp,init:Tr,render:Cr,statCard:jt,svgTrendChart:$r,wireTrendTooltip:Lr},Symbol.toStringTag,{value:"Module"}));function hp(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Mt("#/home")}
  ...
  `}function fp(){console.log("[SignoutRoute] Initialized");const e=document.getElementById("confirm-signout-btn");e?.addEventListener("click",async()=>{e.disabled=!0,e.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await E.doSignout()})}const vp=Object.freeze(Object.defineProperty({__proto__:null,init:fp,render:hp},Symbol.toStringTag,{value:"Module"}));let zo=!1;function bp(){if(zo)return;const e=document.createElement("style");e.id="m5t-section-page-styles",e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),zo=!0}function Ir({title:e="Section",icon:t="widgets",name:a=""}={}){return bp(),`
    ...
    </section>`}function Rr(){}const _p={render:Ir,init:Rr},yp=Object.freeze(Object.defineProperty({__proto__:null,default:_p,init:Rr,render:Ir},Symbol.toStringTag,{value:"Module"})),wp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ct=e=>String(e??"").replace(/[&<>"']/g,t=>wp[t]),Ho=(e,t="info")=>{try{u.publish(h.UI_TOAST,{message:e,type:t})}catch{}},xp=()=>E.getConfig?.().BASE_URL||"",Nr=()=>`${xp()}/m5t/v5/acctEntity/profile`,An={profile:null};let jo=!1;function Ep(){if(jo)return;const e=document.createElement("style");e.id="m5t-settings-general-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),jo=!0}const Or=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Mr(){try{return Ne.getAvailableLanguages()||[]}catch{return[]}}function kp(){const e=Mr(),t=e.includes(G.FF_SSE_I18N_LANG)?G.FF_SSE_I18N_LANG:e[0]||G.FF_SSE_I18N_LANG;try{const a=localStorage.getItem(G.FF_SSE_LS_USER_LANG);return a&&e.includes(a)?a:t}catch{return t}}function Ap(e){try{const t=new Intl.DisplayNames([e],{type:"language"}).of(e);if(t&&t!==e)return t.charAt(0).toUpperCase()+t.slice(1)}catch{}return e}function Sp(){const e=za(),t=Mr(),a=t.length>1;if(!e&&!a)return"";const n=kp();return`
        ...
        <div class="settings-item" id="gen-lang-item">
          ...
          <div class="settings-item__control">
            <select class="settings-select" id="gen-lang" aria-label="Language">
              ${t.map(o=>`<option value="${ct(o)}" ${o===n?"selected":""}>${ct(Ap(o))}</option>`).join("")}
            </select>
          </div>
        </div>`:""}
      </div>
    </div>`}function Pr(){return Ep(),`
    <div class="page-shell" data-section="settings-general">
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ...
          <div id="gen-profile-body">${Or("hourglass_empty","Loading…")}</div>
        </div>
      </div>
    ...
    </div>`}async function Fr(){Lp(),await Tp()}function Cp(e){return`
    ...
    </div>`}async function Tp(){const e=document.getElementById("gen-profile-body");if(e){try{const t=await fetch(Nr()),a=await t.json().catch(()=>({}));if(!t.ok||!a.ok||!a.data)throw new Error(a.error||"Failed to load");An.profile=a.data}catch(t){console.warn("[settings-general] profile load failed:",t),e.innerHTML=Or("error","Could not load your profile. Please try again.");return}e.innerHTML=Cp(An.profile),e.querySelector("#gen-save")?.addEventListener("click",$p)}}function Go(e,t){const a=document.getElementById(`${e}-error`);a&&(a.textContent=t||"",a.hidden=!t);const n=document.getElementById(e);n&&n.setAttribute("aria-invalid",t?"true":"false")}async function $p(){const e=document.getElementById("gen-save"),t=n=>(document.getElementById(n)?.value??"").trim(),a={first:t("gen-first"),last:t("gen-last"),company:t("gen-company"),phone:t("gen-phone")};if(Go("gen-first",a.first?"":"First name is required."),Go("gen-last",a.last?"":"Last name is required."),!(!a.first||!a.last)){e&&(e.disabled=!0);try{const n=await fetch(Nr(),{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}),o=await n.json().catch(()=>({}));if(!n.ok||!o.ok)throw new Error(o.error||"Could not save.");o.data&&(An.profile=o.data),Ho("Profile updated.","success")}catch(n){console.warn("[settings-general] profile save failed:",n),Ho(n.message||"Could not save.","error")}finally{e&&(e.disabled=!1)}}}function Lp(){const e=document.getElementById("gen-dark");if(e){e.addEventListener("change",()=>{nr(e.checked?"dark":"light"),e.checked=Xt()==="dark"});const a=u.subscribe(h.UI_THEME_CHANGED,()=>{if(!e.isConnected){u.unsubscribe(a);return}e.checked=Xt()==="dark"})}const t=document.getElementById("gen-lang");t&&t.addEventListener("change",()=>{try{Ne.setLanguage(t.value)}catch(a){console.warn("[settings-general] setLanguage failed:",a)}})}const Ip={render:Pr,init:Fr},Rp=Object.freeze(Object.defineProperty({__proto__:null,default:Ip,init:Fr,render:Pr},Symbol.toStringTag,{value:"Module"})),Np={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ve=e=>String(e??"").replace(/[&<>"']/g,t=>Np[t]),Vo=(e,t="info")=>{try{u.publish(h.UI_TOAST,{message:e,type:t})}catch{}},Ta=()=>E.getConfig?.().BASE_URL||"",Op=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?",Dr="managed_client",Br={reseller_org:"Your organization",managed_client:"Client workspace",saas_org:"Organization"},Mp=6,et={org:null},qr=()=>E.getActiveOrg()?.guid||E.getMemberships()[0]?.orgGuid||null,ja=()=>E.getActiveOrg()?.channel||E.getMemberships()[0]?.channel||null,Ur=()=>E.getCapabilities().includes("manage_team");let Wo=!1;function Pp(){if(Wo)return;const e=document.createElement("style");e.id="m5t-workspace-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Wo=!0}const $a=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Yo=(e,t,a)=>`
  <div class="settings-section__head">
  ...
  </div>`;function zr(){Pp();const e=Br[ja()];return`
    <div class="page-shell" data-section="settings-workspace">
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ${Yo("apartment","Organization","Name and details.")}
      ...
      <div class="dashboard-card" id="ws-team-card" style="margin-top:24px; display:none">
        <div class="card-body">
          ${Yo("group","Team","Who has access.")}
          <div id="ws-team-body"></div>
        </div>
      </div>
    </div>`}async function Hr(){et.org=null,await Fp(),await qp()}async function Fp(){const e=document.getElementById("ws-org-body");if(!e)return;const t=qr();if(!t){e.innerHTML=$a("apartment","No workspace on this account yet.");return}try{const a=await fetch(`${Ta()}/m5t/v5/acctGroup`),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||`Failed (HTTP ${a.status})`);if(et.org=(n.data||[]).find(o=>o.guid===t)||null,!et.org)throw new Error("Org row not in scope")}catch(a){console.warn("[settings-workspace] load failed:",a),e.innerHTML=$a("error","Could not load your workspace. Please try again.");return}Dp()}function Ko(){const e=Br[ja()]||"",t=et.org?.created?.created_tz;let a="";if(t){const o=new Date(t);Number.isNaN(o.getTime())||(a=`Created ${o.toLocaleDateString()}`)}const n=[e,a].filter(Boolean);return n.length?`<p class="settings-help">${Ve(n.join(" · "))}</p>`:""}function Dp(){const e=document.getElementById("ws-org-body");if(!e)return;const t=et.org||{};if(!Ur()){const a=ja()===Dr?'<div class="settings-note"><span class="material-symbols-outlined" aria-hidden="true">info</span> This workspace is managed for you.</div>':"";e.innerHTML=`
      ...
      ${a}
      <div style="margin-top:12px">${Ko()}</div>`;return}e.innerHTML=`
    <div class="settings-field">
    ...
    </div>`,document.getElementById("ws-save")?.addEventListener("click",Bp)}async function Bp(){const e=document.getElementById("ws-save"),t=document.getElementById("ws-org-error"),a=(document.getElementById("ws-name")?.value||"").trim(),n=(document.getElementById("ws-desc")?.value||"").trim();if(t&&(t.textContent=""),!a){t&&(t.textContent="Organization name is required.");return}e&&(e.disabled=!0);try{const o=await fetch(`${Ta()}/m5t/v5/acctGroup/${encodeURIComponent(et.org.id)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({caption:a,description:n})}),s=await o.json().catch(()=>({}));if(!o.ok||!s.ok)throw new Error(s.message||s.error||`Failed (HTTP ${o.status})`);et.org={...et.org,caption:a,description:n},Vo("Workspace updated.","success")}catch(o){console.warn("[settings-workspace] save failed:",o),Vo(o.message||"Could not save","danger"),e&&(e.disabled=!1);return}e&&(e.disabled=!1);try{await E.fetchScope?.()}catch(o){console.warn("[settings-workspace] fetchScope after save failed:",o)}}function Jo(){document.getElementById("ws-team-card")?.remove()}async function qp(){const e=document.getElementById("ws-team-card");if(!e)return;const t=qr();if(!t||!Ur()){Jo();return}let a=[],n=[];try{const[o,s]=await Promise.all([fetch(`${Ta()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/members`),fetch(`${Ta()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/invites`)]);if(o.status===403||s.status===403){Jo();return}const[r,i]=await Promise.all([o.json().catch(()=>({})),s.json().catch(()=>({}))]);if(!o.ok||!s.ok)throw new Error(`members: ${o.status}, invites: ${s.status}`);a=r.members||[],n=i.invites||[]}catch(o){console.warn("[settings-workspace] team load failed:",o),e.style.display="";const s=document.getElementById("ws-team-body");s&&(s.innerHTML=$a("error","Could not load your team. Please try again."));return}Hp(a,n)}function Up(e){if(!e.length)return"";const t=e.slice(0,Mp),a=e.length-t.length;return`
    <div class="ws-avatars">
      ${t.map(n=>`<span class="ws-avatar" title="${Ve(n.name||n.email)}">${Ve(Op(n.name||n.email))}</span>`).join("")}
      ${a>0?`<span class="ws-avatar ws-avatar--more">+${a}</span>`:""}
    </div>`}function zp(e,t){const a=`${e.length} member${e.length===1?"":"s"}`;return t.length?`${a} · ${t.length} pending invite${t.length===1?"":"s"}`:a}function Hp(e,t){const a=document.getElementById("ws-team-card"),n=document.getElementById("ws-team-body");if(!a||!n)return;a.style.display="";const o=ja()!==Dr;n.innerHTML=`
    ${Up(e)}
    <p class="ws-counts">${Ve(zp(e,t))}</p>
    ${o?'<div class="ws-team-actions"><a class="btn btn-secondary" href="#/team">Manage team</a></div>':""}`}const jp={render:zr,init:Hr},Gp=Object.freeze(Object.defineProperty({__proto__:null,default:jp,init:Hr,render:zr},Symbol.toStringTag,{value:"Module"})),Vp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Pe=e=>String(e??"").replace(/[&<>"']/g,t=>Vp[t]),Se=(e,t="info")=>{try{u.publish(h.UI_TOAST,{message:e,type:t})}catch{}},bt=()=>E.getConfig?.().BASE_URL||"",Wp=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,ea=5,Ee={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},Sn=()=>E.getActiveOrg()?.guid||E.getMemberships()[0]?.orgGuid||null;let Qo=!1;function Yp(){if(Qo)return;const e=document.createElement("style");e.id="m5t-notif-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Qo=!0}const eo=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function jr(){return Yp(),wt(),ie()?xt({section:"settings-notifications",title:"Notifications",description:"Pick a client to manage their lead alerts."}):`
    ...
    </div>`}async function Gr(){if(ie()){const e=t=>Number(t||0).toLocaleString();return nt(bt(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Promise.all([Kp(),Vr()])}async function Vr(){const e=Sn();if(e)try{const t=await fetch(`${bt()}/m5t/v5/acctGroup/${encodeURIComponent(e)}/webhook`);if(t.status===403){Ee.webhookAllowed=!1;return}const a=await t.json().catch(()=>({}));if(!a.ok)return;Ee.webhook=a.webhook,Wr()}catch{}}function Xo(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function Wr(){const e=document.getElementById("ntf-wh-card"),t=document.getElementById("ntf-wh-body");if(!e||!t)return;e.style.display="";const a=Ee.webhook,n=a?.last_delivery;t.innerHTML=`
    <div class="ntf-wh">
      ...
      <div class="ntf-wh__row">
        ...
        <span class="ntf-wh__status">${n?n.ok?`Last delivery: <span class="ok">delivered</span> ${Pe(Xo(n.tz))}`:`Last delivery: <span class="bad">failed</span> ${Pe(Xo(n.tz))} (${Pe(n.error||"")})`:""}</span>
      </div>
    </div>`,t.querySelector("#ntf-wh-save")?.addEventListener("click",async()=>{const o=t.querySelector("#ntf-wh-url")?.value.trim()||"",s=t.querySelector("#ntf-wh-secret")?.value??"",r={uri:o};s.trim()!==""&&(r.secret=s.trim());try{const i=await fetch(`${bt()}/m5t/v5/acctGroup/${encodeURIComponent(Sn())}/webhook`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),l=await i.json().catch(()=>({}));if(!i.ok||!l.ok)throw new Error(l.error||`Failed (HTTP ${i.status})`);Ee.webhook=l.webhook,Se(o?"Webhook saved":"Webhook removed","success"),Wr()}catch(i){Se(i.message||"Could not save","danger")}}),t.querySelector("#ntf-wh-test")?.addEventListener("click",async o=>{const s=o.currentTarget;s.disabled=!0;try{const r=await fetch(`${bt()}/m5t/v5/acctGroup/${encodeURIComponent(Sn())}/webhook-test`,{method:"POST"}),i=await r.json().catch(()=>({}));r.ok&&i.ok?Se("Test delivery sent","success"):Se(i.error||"Could not deliver the test","danger")}catch{Se("Could not deliver the test","danger")}finally{s.disabled=!1}try{await Vr()}catch(r){console.warn("[notifications] loadWebhook refresh failed:",r)}})}async function Kp(){const e=document.getElementById("ntf-body");if(e){try{const a=await(await fetch(`${bt()}/m5t/v5/magnets`)).json().catch(()=>({}));if(!a.ok)throw new Error(a.message||"Failed to load");Ee.magnets=(a.magnets||[]).filter(n=>n.status!=="ARCHIVED"),Ee.canManage=!!a.canManage}catch(t){console.warn("[notifications] load failed:",t),e.innerHTML=eo("error","Could not load your magnets. Please try again.");return}Yr()}}function Jp(e){const t=Array.isArray(e.notify_emails)?e.notify_emails:[],a=t.length>0;return`
    ...
    </div>`}function Yr(){const e=document.getElementById("ntf-body");if(e){if(!Ee.magnets.length){e.innerHTML=eo("widgets","No magnets yet. Create one under Your Magnets first.");return}e.innerHTML=Ee.magnets.map(Jp).join(""),e.querySelectorAll(".ntf-row").forEach(t=>{const a=t.dataset.guid,n=t.querySelector(".ntf-input"),o=()=>{const s=(n?.value||"").trim().toLowerCase();if(!s)return;if(!Wp.test(s)){Se("That does not look like an email address","danger");return}const i=[...Ee.magnets.find(l=>l.guid===a).notify_emails||[]];if(i.includes(s)){Se("Already added","info");return}if(i.length>=ea){Se(`Up to ${ea} emails per magnet`,"info");return}Zo(a,[...i,s])};t.querySelector("[data-add]")?.addEventListener("click",o),n?.addEventListener("keydown",s=>{s.key==="Enter"&&o()}),t.querySelectorAll("[data-remove]").forEach(s=>s.addEventListener("click",()=>{const r=Ee.magnets.find(i=>i.guid===a);Zo(a,(r.notify_emails||[]).filter(i=>i!==s.dataset.remove))})),t.querySelector("[data-test]")?.addEventListener("click",()=>Qp(a,t.querySelector("[data-test]")))})}}async function Zo(e,t){try{const a=await fetch(`${bt()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({notify_emails:t})}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||n.message||`Failed (HTTP ${a.status})`);const o=Ee.magnets.find(s=>s.guid===e);o&&(o.notify_emails=t),Se("Alert emails updated","success")}catch(a){console.warn("[notifications] save failed:",a),Se(a.message||"Could not save","danger");return}try{Yr()}catch(a){console.error("[notifications] renderBody after save failed:",a)}}async function Qp(e,t){t&&(t.disabled=!0);try{const a=await fetch(`${bt()}/m5t/v5/magnets/${encodeURIComponent(e)}/notify-test`,{method:"POST"}),n=await a.json().catch(()=>({}));a.ok&&n.ok?Se("Test alert sent","success"):Se(n.error||"Could not send the test","danger")}catch{Se("Could not send the test","danger")}finally{t&&(t.disabled=!1)}}const Xp={render:jr,init:Gr},Zp=Object.freeze(Object.defineProperty({__proto__:null,default:Xp,init:Gr,render:jr},Symbol.toStringTag,{value:"Module"}));function eu({label:e="",content:t="",size:a="",onClose:n=null}={}){const o=document.activeElement,s=document.createElement("div");s.className="m5t-modal-scrim",s.innerHTML=`
    <div class="m5t-modal${a==="wide"?" m5t-modal--wide":""}" role="dialog" aria-modal="true" aria-label="${tu(e)}" tabindex="-1">
    ...
    </div>`,document.getElementById(o.ids.cancel)?.addEventListener("click",()=>{s.style.display="none"}),document.getElementById(o.ids.save)?.addEventListener("click",()=>uu(e,{refresh:n}))}async function uu(e,{refresh:t}={}){const a=e.picker,n=document.getElementById(e.card.ids.panel),o=[...n?.querySelectorAll(`input[data-${a.dataAttr}]:checked`)||[]].map(r=>r.dataset[a.datasetKey]),s=document.getElementById(a.ids.save);s&&(s.disabled=!0);try{const i=await(await fetch(`${re()}/m5t/v5/integrations/${e.slug}/${a.path}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({[a.saveField]:o})})).json();if(!i.ok)throw new Error(i.error||"save failed");ke(a.savedToast(i.data.linked),"success"),n&&(n.style.display="none"),t?.()}catch{ke(a.saveError,"error"),s&&(s.disabled=!1)}}function ts({refresh:e,replaceKey:t=!1}={}){const a=document.getElementById(Re.callrail.card.ids.setup);a&&(a.style.display="",a.innerHTML=`
    <div class="intg-picker">
  ...
  `,document.head.appendChild(e),ns=!0}function Xr(){return Ka(),wt(),ie()?xt({section:"settings-integrations",title:"Integrations",description:"Pick a client to manage their connections."}):`
    ...
    </div>`}async function Zr(){if(ie()){const e=t=>Number(t||0).toLocaleString();return nt(re(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}fu()||await vu()}const da=Object.fromEntries(Object.values(Re).filter(e=>e.connect).map(e=>[e.slug,e.label]));function fu(){try{const e=new URLSearchParams(window.location.search),t=e.get("connected"),a=e.get("error")?e.get("provider")||"google_ads":null;let n=null;if(t&&Object.hasOwn(da,t))ke(`${da[t]} connected.`,"success"),su({slug:t,connected:!0}),n=Object.hasOwn(Re,t)?Re[t]:null;else if(a){const o=Object.hasOwn(da,a)?da[a]:a;ke(`${o} connection failed (${e.get("error")}).`,"error"),n=Object.hasOwn(Re,a)?Re[a]:null}else return!1;return window.history.replaceState(null,"",window.location.pathname+window.location.hash),n?(window.router?.navigate(`/settings/integrations/${n.urlSlug}`),!0):!1}catch{return!1}}async function vu(){const e=document.getElementById("intg-body");try{const{denied:t,providers:a,configured:n}=await Ya();if(t){e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${De("lock","Integrations are managed by workspace admins.")}</div></div>`);return}e&&(e.innerHTML=wu(a,n))}catch{e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${De("error","Could not load integrations.")}</div></div>`)}}function bu(e,t,a){const n=Va(e,t,a);return`
    ...
    </div>`}function wu(e,t){const a=Object.values(Re).map(o=>bu(o,Ga(e,o.slug),!!t?.[o.slug])).join(""),n=es.length?`<div class="intg-grid__soon-label">Coming soon</div>${es.map(yu).join("")}`:"";return`<div class="intg-grid">${a}${n}</div>`}const xu={render:Xr,init:Zr},Eu=Object.freeze(Object.defineProperty({__proto__:null,default:xu,init:Zr,render:Xr},Symbol.toStringTag,{value:"Module"})),I={provider:null,conn:null,configured:!1,status:"idle"};function ei({provider:e}={}){Ka(),wt();const t=Jr[e];if(!t||ie())return'<div class="page-shell"></div>';const a=Re[t];return I.provider=a,`
    <div class="page-shell" data-section="settings-integrations">
    ...
    </div>`}async function ti({provider:e}={}){const t=Jr[e];if(!t||ie()){window.router?.navigate("/settings/integrations",{historyAPIMethod:"replaceState"});return}await Tn();const a=ru();a?.connected&&a.slug===t&&I.provider?.picker&&Oe()&&Qr(I.provider,{refresh:Tn})}async function Tn(){const e=document.getElementById("intg-detail");if(!(!e||!I.provider))try{const{denied:t,providers:a,configured:n}=await Ya();if(t){e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${De("lock","Integrations are managed by workspace admins.")}</div></div>`;return}I.conn=Ga(a,I.provider.slug),I.configured=!!n?.[I.provider.slug],I.status=Va(I.provider,I.conn,I.configured),e.innerHTML=ku(),Iu()}catch{e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${De("error","Could not load this integration.")}</div></div>`}}function ku(){const e=I.provider;return[Su(e),Cu(e),Tu(e),$u(e),Lu(e)].filter(Boolean).join("")}function Au(e){const t=I.conn?.external_account||{};if(I.status!=="connected")return e.card.sub;if(e.slug==="calendly"){const n=[t.name,t.email&&`(${t.email})`].filter(Boolean).join(" ");return n?`Connected as ${n}.`:"Connected."}if(e.slug==="callrail"){const n=[t.account_name,t.company_name].filter(Boolean).join(" · ");return n?`Connected to ${n}.`:"Connected."}const a=e.card.reachableCount(t);return a?`${a} reachable ${e.slug==="google_analytics"?a===1?"property":"properties":a===1?"account":"accounts"}.`:"Connected."}function Su(e){let t="";Oe()&&(e.connect&&(I.status==="idle"||I.status==="broken")&&I.configured&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${I.status==="broken"?"Reconnect":"Connect"}</button>`),e.slug==="callrail"&&I.status!=="connected"&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${I.status==="broken"?"Reconnect":"Connect"}</button>`));let a;return I.status==="unavailable"?a=`${e.label} is being set up for this platform.`:I.status==="broken"?a=e.card.brokenDesc:I.status==="idle"?a=Oe()?e.card.idleDesc:e.card.sub:a=Au(e),`
    ...
    </div>`}function Cu(e){const t=iu[e.slug];if(!t)return"";if(I.status==="connected"||I.status==="unavailable"||!Oe())return`
      <div class="dashboard-card intg-card">
        <div class="card-body">
    ...
    </div>`}function Tu(e){if(I.status!=="connected")return"";const t=Oe();if(e.picker){const a=e.card.reachableCount(I.conn?.external_account);return`
      <div class="dashboard-card intg-card">
        <div class="card-body">
    ...
    </div>`}function Lu(e){return I.status!=="connected"&&I.status!=="broken"||!Oe()?"":`
    ...
    </div>`}function Iu(){const e=I.provider;if(!e)return;const t=Tn;e.connect&&document.getElementById(e.card.ids.connect)?.addEventListener("click",()=>lu(e)),e.slug==="callrail"&&(document.getElementById(e.card.ids.connect)?.addEventListener("click",()=>ts({refresh:t})),document.getElementById("intg-r-replace")?.addEventListener("click",()=>ts({refresh:t,replaceKey:!0})),document.getElementById(e.card.ids.sync)?.addEventListener("click",()=>hu({refresh:t})),I.status==="connected"&&Oe()&&Ou()),e.picker&&(document.getElementById(e.card.ids.choose)?.addEventListener("click",()=>Qr(e,{refresh:t})),document.getElementById(e.card.ids.sync)?.addEventListener("click",()=>cu(e,{refresh:t}))),e.slug==="google_ads"&&I.status==="connected"&&Oe()&&Ru(),e.slug==="calendly"&&I.status==="connected"&&Oe()&&Nu(),document.getElementById(e.card.ids.disconnect)?.addEventListener("click",()=>du(e,{refresh:t}))}async function Ru(){const e=document.getElementById("intg-g-convactions");if(e)try{const a=await(await fetch(`${re()}/m5t/v5/integrations/google_ads/conversion_actions`)).json();if(!a.ok)throw new Error(a.error||"load failed");const n=a.data.actions||[],o=new Set(a.data.selected||[]);if(!n.length){e.innerHTML=Te("No enabled conversion actions in the linked accounts.");return}e.innerHTML=`
  ...
  `,document.head.appendChild(e),os=!0}const ao=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function ai(){return Du(),`
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Signing in as ${Gt(Hu())}. You stay signed in on this device after a change.</p>
            </div>
          </div>
          <div class="settings-grid-2">
            <div class="settings-field">
    ...
    </div>`}async function ni(){document.getElementById("pw-save")?.addEventListener("click",Gu);const e=document.getElementById("pk-add-btn");e&&window.PublicKeyCredential&&(e.style.display="",e.addEventListener("click",Uu)),await oi()}async function oi(){const e=document.getElementById("pk-body");if(e){try{const t=await fetch(`${aa()}/m5t/v5/webauthn`),a=await t.json().catch(()=>({}));if(!t.ok||!a.ok)throw new Error(a.error||"Failed to load");Rt.passkeys=a.passkeys||[],Rt.loaded=!0}catch(t){console.warn("[settings-security] load failed:",t),e.innerHTML=ao("error","Could not load your passkeys. Please try again.");return}si()}}function ss(e){if(!e)return null;try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return null}}function Bu(e){const t=ss(e.last_used_time),a=e.created?.created_tz,n=ss(a),o=[e.device_type==="multiDevice"?"Syncs across devices":"This device only",t?`Last used ${t}`:"Never used to sign in yet",n?`Added ${n}`:null].filter(Boolean).join(" · ");return`
    ...
    </div>`}function si(){const e=document.getElementById("pk-body");if(e){if(!window.PublicKeyCredential){e.innerHTML=`<p class="pk-unsupported">This browser doesn't support passkeys. Your password sign-in still works as usual.</p>`;return}if(!Rt.passkeys.length){e.innerHTML=ao("passkey","No passkeys yet. Add one for a faster, phishing-resistant sign-in.");return}e.innerHTML=Rt.passkeys.map(Bu).join(""),e.querySelectorAll("[data-remove]").forEach(t=>{t.addEventListener("click",()=>zu(t.dataset.remove,t))})}}function qu(){try{const e=navigator.userAgent||"",t=/iPhone/.test(e)?"iPhone":/iPad/.test(e)?"iPad":/Android/.test(e)?"Android":/Mac OS X/.test(e)?"Mac":/Windows/.test(e)?"Windows":/Linux/.test(e)?"Linux":"device",a=/Edg\//.test(e)?"Edge":/Chrome\//.test(e)?"Chrome":/Firefox\//.test(e)?"Firefox":/Safari\//.test(e)?"Safari":"";return a?`${a} on ${t}`:t}catch{return"Passkey"}}async function Uu(){const e=document.getElementById("pk-add-btn");e&&(e.disabled=!0);try{const{startRegistration:t}=await W(async()=>{const{startRegistration:i}=await Promise.resolve().then(()=>mr);return{startRegistration:i}},void 0,import.meta.url),a=await fetch(`${aa()}/m5t/v5/webauthn/register/options`,{method:"POST"}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||"Could not start passkey registration");let o;try{o=await t({optionsJSON:n.options})}catch(i){if(i?.name==="NotAllowedError")return;throw i}const s=await fetch(`${aa()}/m5t/v5/webauthn/register/verify`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o,deviceLabel:qu()})}),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.error||"Could not register this passkey");ta("Passkey added","success"),await oi()}catch(t){console.warn("[settings-security] addPasskey failed:",t),ta(t.message||"Could not add a passkey","danger")}finally{e&&(e.disabled=!1)}}async function zu(e,t){if(await Kr({title:"Remove this passkey?",message:"You can always add it back later.",confirmLabel:"Remove",danger:!0})){t&&(t.disabled=!0);try{const n=await fetch(`${aa()}/m5t/v5/webauthn/${encodeURIComponent(e)}`,{method:"DELETE"}),o=await n.json().catch(()=>({}));if(!n.ok||!o.ok)throw new Error(o.error||"Could not remove this passkey");Rt.passkeys=Rt.passkeys.filter(s=>s.guid!==e),ta("Passkey removed","success"),si()}catch(n){console.warn("[settings-security] removePasskey failed:",n),ta(n.message||"Could not remove this passkey","danger"),t&&(t.disabled=!1)}}}function Hu(){try{return E.getScope()?.entity?.email||E.getEntity?.()?.email||"your account"}catch{return"your account"}}const pa=e=>{const t=document.getElementById("pw-error");t&&(t.textContent=e||"",t.hidden=!e)},ju=e=>e.length<=1?String(e[0]??""):e.length===2?`${e[0]} and ${e[1]}`:`${e.slice(0,-1).join(", ")}, and ${e[e.length-1]}`;async function Gu(){const e=document.getElementById("pw-new"),t=document.getElementById("pw-confirm"),a=document.getElementById("pw-save"),n=e?.value||"",o=t?.value||"",s=Xn(n);if(s.length){pa(`Password needs: ${ju(s)}.`);return}if(n!==o){pa("Passwords do not match.");return}pa(""),a&&(a.disabled=!0);try{const r=await fetch(`${aa()}/m5t/v5/acctEntity/resetHash`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({password:n})}),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok)throw new Error(i.error||"Could not update your password");ta("Password updated","success"),e&&(e.value=""),t&&(t.value="")}catch(r){pa(r.message||"Could not update your password.")}finally{a&&(a.disabled=!1)}}const Vu={render:ai,init:ni},Wu=Object.freeze(Object.defineProperty({__proto__:null,default:Vu,init:ni,render:ai},Symbol.toStringTag,{value:"Module"})),Yu={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},pe=e=>String(e??"").replace(/[&<>"']/g,t=>Yu[t]),$n=()=>E.getConfig?.().BASE_URL||"",gn=e=>Number(e||0).toLocaleString(),Q={conversations:[],counts:{},magnetNames:{},filter:"ALL",book:!1,magnetOwnerNames:{}},rs={COMPLETED:{label:"Completed",icon:"check_circle"},IN_PROGRESS:{label:"In progress",icon:"pending"},ABANDONED:{label:"Abandoned",icon:"highlight_off"}},Ln={book:"Book",chat:"Chat",call:"Call",email:"Email",support:"Support"};function ri(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email)||null}function ii(e){return(e.split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase()}function li(e){try{return new Date(e).toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return""}}function Ku(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function ci(e){return e==null?"—":e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,"0")}s`}let is=!1;function Ju(){if(is)return;const e=document.createElement("style");e.id="m5t-convs-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),is=!0}const Ja=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function di(){return Ju(),wt(),`
    ...
    </div>`}async function pi(){await Qu()}async function Qu(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${$n()}/m5t/v5/conversations`),fetch(`${$n()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(Q.conversations=n.conversations||[],Q.counts=n.counts||{},Q.book=ie(),a){const o=await a.json().catch(()=>({}));Q.magnetNames={},Q.magnetOwnerNames={};const s=Q.book?kr():{};(o.magnets||[]).forEach(r=>{Q.magnetNames[r.guid]=r.name,Q.book&&(Q.magnetOwnerNames[r.guid]=r.owner_name||s[r.owner_guid]||"")})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=Ja("error","Could not load journeys. Please try again.");return}ui()}}function Xu(){return Q.filter==="ALL"?Q.conversations:Q.conversations.filter(e=>e.status===Q.filter)}function Zu(e){const t=ri(e.lead),a=Q.magnetNames[e.magnet_guid]||"—",n=rs[e.status]||rs.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,s=(e.routes||[]).map(r=>Ln[r]||r).join(", ");return`
    <tr class="convs-row" data-session="${pe(e.session)}">
      <td>
        <span class="convs-who">
          <span class="convs-ava${t?"":" anon"}">${t?pe(ii(t)):'<span class="material-symbols-outlined" style="font-size:16px">person_off</span>'}</span>
      ...
      ${Q.book?`<td>${Ar(Q.magnetOwnerNames[e.magnet_guid]||"")||'<span class="convs-muted">—</span>'}</td>`:""}
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${pe(li(e.started_at))}">${pe(Ku(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${pe(ci(e.duration_s))}</td>
    </tr>`}function ui(){const e=document.getElementById("convs-body");if(!e)return;if(!Q.conversations.length){e.innerHTML=Ja("route","No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.");return}const t=Xu(),a=[["ALL","All"],["COMPLETED","Completed"],["IN_PROGRESS","In progress"],["ABANDONED","Abandoned"]];e.innerHTML=`
    <div class="convs-bar">
    ...
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(Zu).join("")||`<tr><td colspan="${Q.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${Q.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(Q.filter=o.dataset.filter,ui())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&tm(o.dataset.session)})}const em={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${Ln[e]||e}`:""}`,route:e=>`Picked ${Ln[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function tm(e){const t=Q.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${$n()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=ri(t.lead),o=Q.magnetNames[t.magnet_guid]||"—",r=(a?.events||[]).filter((c,g,b)=>c.event!=="step"||!(b[g+1]&&b[g+1].event==="step")).map(c=>`
    <div class="convs-tl__item${c.event==="complete"?" done":""}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${pe((em[c.event]||(()=>c.event))(c.detail))}</div>
      <div class="convs-tl__time">${pe(li(c.at))}${c.variant?` · Variant ${pe(c.variant)}`:""}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      ...
      <div class="convs-drawer__body">
        ${n?`<a class="convs-drawer__lead" href="#/leads">
              <span class="convs-ava">${pe(ii(n))}</span>
        ...
        <div class="convs-sub" style="margin-bottom:6px">${pe(o)} · ${pe(ci(t.duration_s))}${t.variant?` · Variant ${pe(t.variant)}`:""}</div>
        ${r?`<div class="convs-tl">${r}</div>`:Ja("timeline","No timeline available for this journey.")}
      </div>
    </aside>`,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("open"),i.querySelector(".convs-drawer").classList.add("open")});const l=()=>{i.classList.remove("open"),setTimeout(()=>i.remove(),220)};i.querySelector(".convs-drawer__close").addEventListener("click",l),i.addEventListener("click",c=>{c.target===i&&l()})}const am={render:di,init:pi},nm=Object.freeze(Object.defineProperty({__proto__:null,default:am,init:pi,render:di},Symbol.toStringTag,{value:"Module"})),om={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},gt=e=>String(e??"").replace(/[&<>"']/g,t=>om[t]),ls=(e,t="info")=>{try{u.publish(h.UI_TOAST,{message:e,type:t})}catch{}},_a=()=>E.getConfig?.().BASE_URL||"",Nt=e=>Number(e||0).toLocaleString(),tt={magnets:[],stats:{},canManage:!1},sm={mag_title:"header title",mag_subtitle:"subtitle",mag_welcome:"welcome message",mag_theme_color:"color",mag_launcher_label:"launcher label"};let cs=!1;function rm(){if(cs)return;const e=document.createElement("style");e.id="m5t-abt-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),cs=!0}const no=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function mi(){return ie()?xt({section:"ab-testing",title:"A/B Testing",description:"Pick a client to view their experiments."}):(rm(),`
    ...
    </div>`)}async function oo(){if(ie())return nt(_a(),[{h:"Running",td:t=>Nt(t.ab_tests?.running)},{h:"Completed",td:t=>Nt(t.ab_tests?.completed)},{h:"Compl. %",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Experiments appear per client once you have one."});const e=document.getElementById("abt-body");try{const t=new Date,a=new Date(t.getTime()-89*864e5).toISOString().slice(0,10),n=t.toISOString().slice(0,10),[o,s]=await Promise.all([fetch(`${_a()}/m5t/v5/magnets`),fetch(`${_a()}/m5t/v5/magnets/stats?from=${a}&to=${n}`)]),r=await o.json().catch(()=>({}));if(!r.ok)throw new Error(r.message||"Failed to load");tt.magnets=r.magnets||[],tt.canManage=!!r.canManage;const i=await s.json().catch(()=>({}));tt.stats=i?.stats||{}}catch(t){console.warn("[ab-testing] load failed:",t),e&&(e.innerHTML=no("error","Could not load your tests. Please try again."));return}im()}function im(){const e=document.getElementById("abt-body");if(!e)return;const t=tt.magnets.filter(n=>n.ab?.enabled),a=tt.magnets.filter(n=>!n.ab?.enabled&&n.ab?.declared);if(!t.length&&!a.length){e.innerHTML=no("science","No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.");return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(pm).join("")}`:"")+(a.length?`<div class="abt-sect">Completed Tests</div>${a.map(um).join("")}`:""),e.querySelectorAll("[data-declare]").forEach(n=>n.addEventListener("click",()=>mm(n.dataset.declare,n.dataset.winner)))}function lm(e){const t=tt.stats[e.guid]?.variants||{},a={opens:0,engaged:0,completions:0,rate:null,...t.A||{}},n={opens:0,engaged:0,completions:0,rate:null,...t.B||{}};return{A:a,B:n}}function cm(e){const t=Object.keys(e?.b||{}).map(a=>sm[a]||a);return t.length?`Changes: ${t.join(", ")}`:""}function dm(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function ds(e,t,a,n,o,s){return`
    ...
    </div>`}function pm(e){const t=e.ab,{A:a,B:n}=lm(e),o=(n.rate??-1)>(a.rate??-1)?"B":(a.rate??-1)>(n.rate??-1)?"A":null,s=o&&a.rate!=null&&n.rate!=null?`+${Math.round(Math.abs(n.rate-a.rate)*10)/10}%`:"",r=gm(a,n),i=t.started_tz?dm(t.started_tz):null,l=(a.opens||0)+(n.opens||0),c=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
      ...
      <div class="abt-compare">
        ${ds("Variant A","Control","The magnet as configured",a,o==="A",o==="A"?s:"")}
        <div class="abt-vs">VS</div>
        ${ds("Variant B",o==="B"?"Leading":"Challenger",cm(t),n,o==="B",o==="B"?s:"")}
      </div>
      <div class="abt-sig">
    ...
    </div>`}async function mm(e,t){const a=tt.magnets.find(n=>n.guid===e);if(a&&window.confirm(`Declare Variant ${t} the winner for “${a.name}”?

${t==="B"?"Variant B’s changes become the magnet’s configuration for everyone.":"The magnet keeps its current configuration."} The experiment ends and moves to Completed.`)){try{const o=await(await fetch(`${_a()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Declare failed");ls(`Variant ${t} declared the winner`,"success")}catch(n){ls(n.message||"Could not declare a winner","danger");return}try{await oo()}catch(n){console.warn("[ab-testing] refresh after declare failed:",n)}}}function gm(e,t){const a=e.opens||0,n=t.opens||0,o=e.completions||0,s=t.completions||0;if(a<30||n<30||o+s<5)return null;const r=o/a,i=s/n,l=(o+s)/(a+n),c=Math.sqrt(l*(1-l)*(1/a+1/n));if(!c)return null;const g=Math.abs(i-r)/c;return Math.round(2*(hm(g)-.5)*1e3)/10}function hm(e){const t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}const fm={render:mi,init:oo},vm=Object.freeze(Object.defineProperty({__proto__:null,default:fm,init:oo,render:mi},Symbol.toStringTag,{value:"Module"})),bm={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ge=e=>String(e??"").replace(/[&<>"']/g,t=>bm[t]),gi=()=>E.getConfig?.().BASE_URL||"",_m={single_select:{icon:"quiz",color:"#0072BA",darkColor:"#38BDF8"},multi_select:{icon:"checklist",color:"#0E6BA8",darkColor:"#22D3EE"},scheduler:{icon:"event",color:"#915E8B",darkColor:"#E879F9"},text:{icon:"short_text",color:"#5B54C6",darkColor:"#A78BFA"},email:{icon:"mail",color:"#0E8F86",darkColor:"#2DD4BF"},phone:{icon:"call",color:"#2E8B57",darkColor:"#4ADE80"},message:{icon:"chat",color:"#B4791F",darkColor:"#FBBF24"}},La={};jn.forEach(e=>{La[e.value]={label:e.label,..._m[e.value]||{icon:"quiz",color:"#0072BA",darkColor:"#38BDF8"}}});const hi=jn.map(e=>e.value),fi={chat:"Chat / default",book:"Book (scheduler)",support:"Support (intake)"},so=e=>{const t=La[e]||La.single_select;return document.documentElement.getAttribute("data-theme")==="dark"?{...t,color:t.darkColor}:t},Et=e=>e==="single_select"||e==="multi_select",Qa=e=>e!=="message",Pt=e=>e==="scheduler",ra=e=>e==="message",Ia=e=>e==="email"?"email":e==="phone"?"phone":"",Ft=()=>({meeting_label:"",start:"09:00",end:"17:00",mins:30,days:14}),ym=["meeting_label","start","end","mins","days"],ps=["terminal","cta"];function In(e,t){const a={};return Object.keys(e&&typeof e=="object"?e:{}).forEach(n=>{t.includes(n)||(a[n]=e[n])}),Object.keys(a).length?a:null}function vi(e){return In(e,ym)}const wm=[["","No icon"],["event","Calendar"],["schedule","Clock"],["mail","Email"],["sms","Text"],["phone","Phone"],["chat","Chat"],["description","Document"],["help","Question"],["place","Location"],["person","Person"],["bolt","Quick"],["check_circle","Check"],["star","Star"],["home","Home"],["build","Service"]];function xm(e,t){const a=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||"").trim());return a?`rgba(${parseInt(a[1],16)},${parseInt(a[2],16)},${parseInt(a[3],16)},${t})`:`rgba(0,114,186,${t})`}let us=!1;function Em(){if(us)return;const e=document.createElement("style");e.id="m5t-flow-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),us=!0}let B=[],qe=null,km=0,Ke=null,dt=null,pt="chat",$e={},ya=[],bi=null,Rn=null,wa="";const Ot=()=>"f"+ ++km;function ro(e="single_select"){return{_uid:Ot(),id:"",step_type:e,step_prompts:[""],step_options:Et(e)?[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]:[],step_columns:Ia(e)?[Ia(e)]:[],step_description:"",step_config:Pt(e)?Ft():null}}function Am(e){return(Array.isArray(e)?e:[]).map(t=>({_uid:Ot(),id:t.id!=null?String(t.id):"",step_type:La[t.step_type]?t.step_type:"single_select",step_prompts:Array.isArray(t.step_prompts)?t.step_prompts.map(String):[],step_options:(Array.isArray(t.step_options)?t.step_options:[]).map(a=>({label:a&&a.label!=null?String(a.label):"",goto:a&&a.goto!=null?String(a.goto):"",icon:a&&a.icon!=null?String(a.icon):""})),step_columns:Array.isArray(t.step_columns)?t.step_columns.map(String):[],step_description:t.step_description!=null?String(t.step_description):"",step_config:Pt(t.step_type)?{...Ft(),...t.step_config&&typeof t.step_config=="object"?t.step_config:{}}:t.step_config&&typeof t.step_config=="object"?{...t.step_config}:null}))}function ms(){return[{_uid:Ot(),id:"",step_type:"text",step_prompts:["Great, and your name?"],step_options:[],step_columns:["first_name"],step_description:"",step_config:null},{_uid:Ot(),id:"",step_type:"email",step_prompts:["The best email to reach you?"],step_options:[],step_columns:["email"],step_description:"",step_config:null}]}function Sm(e,t){if(e==="book")return[{_uid:Ot(),id:"",step_type:"scheduler",step_prompts:["When works best for you?"],step_options:[],step_columns:[],step_description:"",step_config:Ft()},...ms()];if(e==="support"){const a=(t.actions||[]).find(s=>s&&s.type==="support"),n=a&&a.config&&Array.isArray(a.config.options)?a.config.options:[],o=n.length?n.map(s=>({label:s&&s.label||String(s),goto:"",icon:s&&s.icon||""})):["Sales enquiry","Support","Billing","Something else"].map(s=>({label:s,goto:"",icon:""}));return[{_uid:Ot(),id:"",step_type:"multi_select",step_prompts:["How can we help you today?"],step_options:o,step_columns:[],step_description:"Select all that apply",step_config:null},...ms()]}return[ro("single_select")]}function _i(e,t){const a=e==="chat"?t.steps:t.routes&&t.routes[e],n=Am(a);return n.length?n:e==="chat"?[ro("single_select")]:Sm(e,t)}function Cm(e){Et(e.step_type)?e.step_options.length||(e.step_options=[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]):e.step_options=[],Qa(e.step_type)?!e.step_columns.length&&Ia(e.step_type)&&(e.step_columns=[Ia(e.step_type)]):e.step_columns=[],e.step_config=Pt(e.step_type)?{...Ft(),...e.step_config||{}}:vi(e.step_config)}function Tm(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${ge(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${wm.map(([a,n])=>`<option value="${ge(a)}"${a===e.icon?" selected":""}>${ge(n)}</option>`).join("")}</select>
  ...
  </div>`}function $m(e){const t=hi.map(n=>`<option value="${n}"${n===e.step_type?" selected":""}>${ge(so(n).label)}</option>`).join(""),a=e.step_options.length<=1;return`<div class="flow-node__body">
...
`))}</textarea>
    ...
    <div class="flow-opts">${e.step_options.map(n=>Tm(n,a)).join("")}</div>
...
`));const o=e.querySelector(".flow-f-field");if(t.step_columns=o&&o.value.trim()?[o.value.trim()]:[],Et(t.step_type)){const s=t.step_options,r=[];e.querySelectorAll(".flow-opt").forEach((i,l)=>{r.push({label:i.querySelector(".flow-o-label")?.value??"",icon:i.querySelector(".flow-o-icon")?.value??"",goto:s[l]&&s[l].goto||""})}),t.step_options=r}else t.step_options=[];if(Pt(t.step_type)){const s=e.querySelector(".flow-f-mtlabel"),r=e.querySelector(".flow-f-start"),i=e.querySelector(".flow-f-end"),l=e.querySelector(".flow-f-mins");t.step_config={...t.step_config||Ft(),...s?{meeting_label:s.value.trim()}:{},...r&&r.value?{start:r.value}:{},...i&&i.value?{end:i.value}:{},...l?{mins:parseInt(l.value,10)||30}:{}}}else if(ra(t.step_type)){const s=e.querySelector(".flow-f-terminal");if(s){const r=e.querySelector(".flow-f-cta-label"),i=e.querySelector(".flow-f-cta-url"),l=In(t.step_config,ps)||{};t.step_config=s.checked?{...l,terminal:!0,cta:{label:r?r.value:"",url:i?i.value:""}}:In(t.step_config,ps)}}else t.step_config=vi(t.step_config)}function yi(){document.querySelectorAll(".flow-node.drop-before, .flow-node.drop-after").forEach(e=>e.classList.remove("drop-before","drop-after"))}function zt(){yi(),document.querySelectorAll(".flow-node.dragging").forEach(e=>e.classList.remove("dragging")),Ke=null,dt=null}function Rm(e=B){if(!e.length)return{message:"Add at least one step.",uid:null,field:null};for(let t=0;t<e.length;t++){const a=e[t],n=t+1,o=(s,r=null)=>({message:s,uid:a._uid,field:r});if(!a.step_prompts.some(s=>String(s).trim()!==""))return o(`Step ${n}: add what the magnet should say.`,"prompts");if(Et(a.step_type)&&!a.step_options.some(s=>String(s.label).trim()!==""))return o(`Step ${n}: add at least one choice.`,"options");if(Qa(a.step_type)&&!a.step_columns.length)return o(`Step ${n}: choose which field this answer saves to.`,"field");if(ra(a.step_type)&&a.step_config?.terminal){const s=String(a.step_config.cta?.label||"").trim(),r=String(a.step_config.cta?.url||"").trim();if(!!s!=!!r)return o(`Step ${n}: fill in both the link label and URL, or leave both blank.`,"cta")}}return null}function wi(e){if(!e)return;const t=e.querySelector(".flow-f-cta-label"),a=e.querySelector(".flow-f-cta-url");if(!t||!a)return;const n=t.value.trim()!=="",o=a.value.trim()!=="",s=n||o,r=n!==o;e.querySelectorAll(".flow-cta-req").forEach(l=>{l.textContent=s?"required":"optional",l.classList.toggle("flow-sub--req",s)}),t.classList.toggle("flow-f-invalid",r&&!n),a.classList.toggle("flow-f-invalid",r&&!o);const i=e.querySelector(".flow-cta-warn");i&&(i.hidden=!r)}function Nn(e=B){let t=0;return e.forEach(a=>{const n=parseInt(a.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(a=>{const n=a.id&&String(a.id).trim()?String(a.id):String(++t),o=Et(a.step_type)?a.step_options.map(r=>{const i={label:String(r.label).trim(),goto:String(r.goto||"")};return r.icon&&(i.icon=String(r.icon)),i}).filter(r=>r.label!==""):[],s={id:n,step_type:a.step_type,step_prompts:a.step_prompts.map(r=>String(r)).filter(r=>r.trim()!==""),step_options:o,step_columns:a.step_columns.slice(),step_description:a.step_description||""};if(Pt(a.step_type))a.step_config&&(s.step_config={...Ft(),...a.step_config});else if(a.step_config&&Object.keys(a.step_config).length){const r={...a.step_config};if(ra(a.step_type)&&r.terminal){const i=String(r.cta?.label??"").trim(),l=String(r.cta?.url??"").trim();i&&l?r.cta={label:i,url:l}:delete r.cta}s.step_config=r}return s})}function Nm(e,t,a){Em(),bi=t,Rn=typeof a=="function"?a:null,wa=t?.modified_tz||"",ya=["chat",...["book","support"].filter(n=>(t.actions||[]).some(o=>o&&o.type===n))],$e={chat:_i("chat",t)},pt="chat",B=$e.chat,qe=B.length===1?B[0]._uid:null,Ke=null,dt=null,e.innerHTML=`
    ...
    ${ya.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${ya.map(n=>`<option value="${n}">${ge(fi[n]||n)}</option>`).join("")}</select></div>`:""}
...
<body>
  ...
  <\/script>
  <script>${a}<\/script>
</body></html>`}let fs=!1;function Ei(){if(fs)return;const e=document.createElement("style");e.id="m5t-preview-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),fs=!0}function ki(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function Ai(e){const t=e.querySelector("[data-pv-info]"),a=e.querySelector("[data-pv-info-pop]");t&&a&&t.addEventListener("click",()=>{a.hidden=!a.hidden})}function qm(e,t){Ei(),e.innerHTML=`
    <div class="pv-pane">
      ...
      ${ki("Live render of the real widget. Capture is disabled, so no test leads.")}
    </div>`,Ai(e);const a=e.querySelector(".pv-pane__frame"),n=e.querySelector(".pv-pane__badge");let o=null,s=0;const r=450,i=()=>{const c=(typeof performance<"u"?performance.now():Date.now())-s;clearTimeout(o),c<r?o=setTimeout(()=>{n.hidden=!0},r-c):n.hidden=!0};a.addEventListener("load",i);const l=()=>{let c;try{c=xi(t())}catch{return}s=typeof performance<"u"?performance.now():Date.now(),n.hidden=!1,a.srcdoc=c,clearTimeout(o),o=setTimeout(()=>{n.hidden=!0},1500)};return e.querySelector(".pv-pane__seg").addEventListener("click",c=>{const g=c.target.closest("button[data-device]");!g||g.dataset.device===a.dataset.device||(e.querySelectorAll(".pv-pane__seg button").forEach(b=>b.classList.toggle("is-on",b===g)),a.dataset.device=g.dataset.device)}),l(),{refresh:l,destroy(){clearTimeout(o)}}}function io(e){Ei();let t="desktop";const a=document.createElement("div");a.className="pv-scrim",a.innerHTML=`
    ...
    </div>`}const jm=300*1e3;function Gm(e){Zn(vt.MAGNET_TEMPLATE,{id:e,at:Date.now()})}function Ti(e){if(!e)return null;if(typeof e=="string")return at.find(n=>n.id===e)||null;const{id:t,at:a}=e;return typeof a=="number"&&Date.now()-a>=jm?null:at.find(n=>n.id===t)||null}function Vm(){return Ti(En(vt.MAGNET_TEMPLATE))}function Wm(){return Ti(np(vt.MAGNET_TEMPLATE))}let bs=!1;function $i(){if(bs)return;const e=document.createElement("style");e.id="m5t-mag-template-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),bs=!0}function Ym(e){$i();const t=document.createElement("div");t.className="mag-modal-scrim mag-tpl-modal",t.innerHTML=`
  ...
  <div class="mag-csp-note__body">
    <p>A strict CSP can silently block the widget — it just never appears, no visible error. Allowlist <code>${w(X())}</code> under all three directives. Copy-paste ready for your CSP header/meta tag:</p>
    <pre class="mag-csp-note__snippet"><code>script-src 'self' ${w(X())};
connect-src 'self' ${w(X())};
img-src 'self' ${w(X())};</code></pre>
    <ul>
...
</details>`,Ri={chat:"Chat bubble",right_slide:"Slide-in panel",modal:"Modal",inline:"Inline"},Jm={chat:"chat",right_slide:"vertical_split",modal:"web_asset",inline:"view_agenda"},Ni=[{value:"inline",icon:"view_agenda",label:"Inline"},{value:"chat",icon:"chat",label:"Chat"},{value:"right_slide",icon:"vertical_split",label:"Slide"},{value:"modal",icon:"web_asset",label:"Modal"}],Oi=[{value:"auto",icon:"brightness_auto",label:"Auto"},{value:"light",icon:"light_mode",label:"Light"},{value:"dark",icon:"dark_mode",label:"Dark"}],Mi=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],lo={book:{label:"Book",icon:"event",kind:"book"},chat:{label:"Chat",icon:"chat",kind:"flow"},call:{label:"Call",icon:"phone",kind:"value",placeholder:"Phone number"},email:{label:"Email",icon:"mail",kind:"value",placeholder:"Email address"},support:{label:"Support",icon:"support_agent",kind:"support"}},Pi=["book","chat","call","email","support"];let xa=null;async function Qm(){if(xa)return xa;let e;try{const t=await fetch(`${X()}/m5t/v5/integrations/calendly/event_types`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.event_types||[],scheduling_url:a.data.scheduling_url||""}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(xa=e),e}async function Xm(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved Calendly event";e.innerHTML=`<option value="${w(t)}">${t?w(a):"Loading event types"}</option>`;const n=await Qm();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${w(t)}" selected>${w(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect Calendly under Settings, Integrations first":"Could not load event types"}</option>`;return}const o=[];n.scheduling_url&&o.push({url:n.scheduling_url,label:"Full scheduling page (visitor picks the event)"}),n.list.forEach(s=>o.push({url:s.scheduling_url,label:s.duration?`${s.name} (${s.duration} min)`:s.name})),t&&!o.some(s=>s.url===t)&&o.unshift({url:t,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${w(s.url)}"${s.url===(t||o[0].url)?" selected":""}>${w(s.label)}</option>`).join(""):'<option value="">No active event types</option>'}let Ea=null;async function Zm(){if(Ea)return Ea;let e;try{const t=await fetch(`${X()}/m5t/v5/integrations/callrail/trackers`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.trackers||[]}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(Ea=e),e}async function eg(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved tracking number";e.innerHTML=`<option value="${w(t)}">${t?w(a):"Loading tracking numbers"}</option>`;const n=await Zm();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${w(t)}" selected>${w(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect CallRail under Settings, Integrations first":"Could not load tracking numbers"}</option>`;return}const o=n.list.map(s=>({number:s.number,id:s.id,name:s.name,label:`${s.name} · ${s.number}${s.type==="session"?" (number pool)":""}`}));t&&!o.some(s=>s.number===t)&&o.unshift({number:t,id:e.dataset.savedId||"",name:a,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${w(s.number)}" data-tracker-id="${w(s.id)}" data-tracker-name="${w(s.name)}"${s.number===(t||o[0].number)?" selected":""}>${w(s.label)}</option>`).join(""):'<option value="">No active tracking numbers in this company</option>'}function ys(e,t,a){return`<div class="mag-seg" role="radiogroup" aria-label="${w(e)}">${a.map(n=>`
    <label><input type="radio" name="${w(e)}" value="${w(n.value)}"${n.value===t?" checked":""}>
      <span><span class="material-symbols-outlined" aria-hidden="true">${w(n.icon)}</span>${w(n.label)}</span></label>`).join("")}</div>`}function tg(e,t){const a=lo[e],n=!!t,o=n?"":" disabled";let s="";if(a.kind==="value"&&e==="call"){const i=t?.config?.source==="callrail",l=i&&t?.value||"",c=i?t?.config?.tracker_name||"Saved tracking number":"";s=`
      ...
      </select>`}else if(a.kind==="value")s=`<input class="mag-modal__input mag-cta__val" type="text" placeholder="${w(a.placeholder)}" value="${w(t?.value||"")}"${o}>`;else if(a.kind==="book"){const i=t?.config?.meeting_label||t?.value||"",l=t?.config?.source==="calendly",c=l&&t?.config?.calendly_url||"",g=l?t?.config?.event_name||"Saved Calendly event":"";s=`
      ...
      <select class="mag-modal__select mag-cta__calevent" data-saved="${w(c)}" data-saved-name="${w(g)}"${o}${l?"":" hidden"}>
        ${c?`<option value="${w(c)}" selected>${w(g)}</option>`:""}
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${a.kind}">
    ...
    ${r}
  </div>`}function ag(){if(_s)return;const e=document.createElement("style");e.id="m5t-magnets-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),_s=!0}function Na(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function ng(e){const t=q.stats[e];if(!t||!t.opens&&!t.leads)return'<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>';const a=n=>Number(n||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function co(e){const t=q.install[e.guid];if(!t)return"";const a=t.unrecognized||[],n=(t.traffic?.opens||0)>0,o=q.canManage,s=a.length?`
    <div class="mag-install__seen">
      ...
      ${a.map(l=>`
        <div class="mag-install__row">
          <span class="mag-install__dom" title="${w(l.domain)}">${w(l.domain)}</span>
          <span class="mag-install__hits">${Number(l.hits||0).toLocaleString()}&times;</span>
          ${o?`<button class="mag-btn" data-action="allow-domain" data-guid="${w(e.guid)}" data-domain="${w(l.domain)}">Allow</button>
          <button class="mag-btn" data-action="dismiss-domain" data-guid="${w(e.guid)}" data-domain="${w(l.domain)}" title="Stop showing this domain">Dismiss</button>`:""}
        </div>`).join("")}
    ...
    <details class="mag-install__dismissed">
      ...
      ${r.map(l=>`
        <div class="mag-install__row">
          <span class="mag-install__dom" title="${w(l)}">${w(l)}</span>
          ${o?`<button class="mag-btn" data-action="restore-domain" data-guid="${w(e.guid)}" data-domain="${w(l)}">Restore</button>`:""}
        </div>`).join("")}
    ...
    ${i}
  </div>`}async function og(){await Promise.all(q.magnets.map(async e=>{try{const a=await(await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity`)).json().catch(()=>({}));if(!a.ok)return;q.install[e.guid]=a;const n=document.querySelector(`.mag-card[data-guid="${CSS.escape(e.guid)}"] .mag-install-slot`);n&&(n.innerHTML=co(e))}catch(t){console.warn("[magnets] install activity failed:",e.guid,t)}}))}function po(e){const t=q.owners.length>1||E.getMemberships().length>1,a=(e.domains||[]).filter(Boolean),n=q.canManage;return`
    <div class="mag-card" data-guid="${w(e.guid)}">
      ...
      <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${Jm[e.display_mode]||"chat"}</span>${w(Ri[e.display_mode]||"Chat bubble")}${e.ab?.enabled?'&nbsp;&nbsp;<span class="mag-ab-chip"><span class="material-symbols-outlined" aria-hidden="true">science</span>A/B</span>':""}${(e.notify_emails||[]).length?`&nbsp;&nbsp;<a class="mag-alert-chip" href="#/settings/notifications" title="Lead alerts to ${(e.notify_emails||[]).length} email${(e.notify_emails||[]).length===1?"":"s"}. Manage in Settings."><span class="material-symbols-outlined" aria-hidden="true">notifications_active</span>${(e.notify_emails||[]).length}</a>`:""}</span>
      ${ng(e.guid)}
      <div class="mag-domains">${a.length?a.map(o=>w(o)).join(", "):"<span>No domains set. Add yours to go live.</span>"}</div>
      <div class="mag-install-slot">${co(e)}</div>
      <div class="mag-embed">
        <input type="text" readonly value="${w(Li(e.guid))}" aria-label="Embed snippet">
    ...
    </div>`}function sg(){return ie()?xt({section:"magnets",title:"Your Magnets",description:"Pick a client to view and manage their magnets."}):(ag(),`
    ...
    </div>`)}async function rg(){if(ie()){const a=Wm();if(a){const o=document.querySelector(".page-shell .page-header-text .page-description");o&&(o.textContent=`Template picked: ${a.name}. Choose the client to build it for.`)}const n=o=>Number(o||0).toLocaleString();return nt(X(),[{h:"Magnets",td:o=>`${n(o.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${n(o.magnets.total)}</span>`},{h:"Leads · wk",td:o=>n(o.leads.this_week)},{h:"Leads · total",td:o=>n(o.leads.total)}],{emptyMsg:"No client orgs yet. Create one under Clients, then provision its magnets here."})}xa=null,Ea=null,document.getElementById("mag-new-btn")?.addEventListener("click",cg),document.getElementById("mag-template-btn")?.addEventListener("click",dg),document.getElementById("mag-body")?.addEventListener("click",pg),await Dt();const t=Vm();t&&q.canProvision&&Di(t)}async function Dt(){const e=document.getElementById("mag-body");if(!e)return;try{const[n,o]=await Promise.all([fetch(`${X()}/m5t/v5/magnets`),fetch(`${X()}/m5t/v5/magnets/stats`).catch(()=>null)]),s=await n.json().catch(()=>({}));if(!s.ok)throw new Error(s.message||"Failed to load");q.magnets=s.magnets||[],q.owners=s.owners||[],q.canProvision=!!s.canProvision,q.canManage=!!s.canManage,q.primaryOrgGuid=s.primaryOrgGuid||null;const r=o?await o.json().catch(()=>({})):{};q.stats=r?.stats||{}}catch{e.innerHTML=Na("error","Could not load your magnets. Please try again.");return}const t=document.getElementById("mag-new-btn");t&&(t.style.display=q.canProvision?"":"none");const a=document.getElementById("mag-template-btn");if(a&&(a.style.display=q.canProvision?"":"none"),!q.magnets.length){e.innerHTML=Na("widgets",q.canProvision?"No magnets yet. Click “New magnet” to create your first.":"No magnets yet.");return}e.innerHTML=`<div class="mag-grid">${q.magnets.map(po).join("")}</div>`,og()}async function ig(e){const t={"Content-Type":"application/json","Idempotency-Key":crypto.randomUUID()},a={status:"DRAFT"};e&&(a.owner_guid=e);const n=await fetch(`${X()}/m5t/v5/magnets`,{method:"POST",headers:t,body:JSON.stringify(a)});let o={};try{o=await n.json()}catch{}if(!n.ok||!o.ok)throw new Error(o.message||`Could not start a new magnet (${n.status})`);return o.magnet}async function lg(e,t){const a=await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t.name,...t.appearance,steps:t.steps})});let n={};try{n=await a.json()}catch{}if(!a.ok||!n.ok)throw new Error(n.message||`Could not apply the ${t.name} template (${a.status})`)}async function uo(e,t){const a=document.getElementById("mag-new-btn"),n=document.getElementById("mag-template-btn");a&&(a.disabled=!0),n&&(n.disabled=!0);let o=null;try{let s=await ig(e);if(o=s.guid,t)await lg(s.guid,t),await Dt(),s=q.magnets.find(r=>r.guid===s.guid)||s;else{q.magnets=[s,...q.magnets];const r=document.getElementById("mag-body");r&&(r.innerHTML=`<div class="mag-grid">${q.magnets.map(po).join("")}</div>`)}Oa(s,void 0,{freshDraft:!0})}catch(s){o&&fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(o)}`,{method:"DELETE"}).catch(()=>{}),we(s.message||"Could not start a new magnet","danger")}finally{a&&(a.disabled=!1),n&&(n.disabled=!1)}}function Fi(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="Choose client" style="max-width:420px">
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(o){o.key==="Escape"&&(o.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.querySelector('[data-x="cancel"]').addEventListener("click",a),t.querySelector('[data-x="continue"]').addEventListener("click",()=>{const o=t.querySelector("#mag-owner-pick").value;a(),uo(o,e)})}function cg(){if(q.owners.length>1){Fi();return}uo(null)}function Di(e){if(q.owners.length>1){Fi(e);return}uo(null,e)}function dg(){Ym(Di)}function pg(e){const t=e.target.closest("[data-action]");if(!t)return;const a=t.dataset.guid,n=q.magnets.find(s=>s.guid===a),o=t.dataset.action;if(o==="copy")return ug(a);if(n){if(o==="preview")return io(()=>Ra(n));if(o==="funnel")return mg(n);if(o==="edit")return Oa(n);if(o==="flow")return Oa(n,"flow");if(o==="allow-domain")return gg(n,t.dataset.domain);if(o==="dismiss-domain")return hg(n,t.dataset.domain);if(o==="restore-domain")return fg(n,t.dataset.domain);if(o==="toggle")return vg(n);if(o==="delete")return bg(n)}}async function ug(e){try{await navigator.clipboard.writeText(Li(e)),we("Embed snippet copied","success")}catch{we("Copy failed","danger")}}function Bi(e){const t=Number(e?.total_steps)||0,a={};if((Array.isArray(e?.funnel)?e.funnel:[]).forEach(s=>{a[s.position]=Number(s.reached)||0}),!t||!Object.keys(a).length)return'<p class="mag-modal__hint" style="margin:0">No step activity yet in this window. As visitors answer questions, drop-off by step will appear here.</p>';const n=Math.max(1,a[1]||0),o=[];for(let s=1;s<=t;s++){const r=a[s]||0,i=Math.min(100,Math.round(r/n*100));o.push(`
      ...
      </div>`)}return`<div class="mag-funnel">${o.join("")}</div>`}async function mg(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(s){s.key==="Escape"&&(s.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.addEventListener("click",s=>{s.target===t&&a()});const o=t.querySelector("#mag-funnel-body");try{const s=await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/step-funnel`),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.message||`Failed (${s.status})`);o.innerHTML=Bi(r)}catch{o.innerHTML='<p class="mag-modal__hint" style="margin:0">Could not load the funnel. Please try again.</p>'}}async function gg(e,t){const a=String(t||"").trim().toLowerCase();if(!a||!window.confirm(`Allow ${a} to load this magnet?

Only do this for a site you recognise — anyone can put this magnet's embed code on a page.`))return;const n=[...new Set([...(e.domains||[]).filter(Boolean),a])];try{if(!(await(await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({domains:n})})).json().catch(()=>({}))).ok)throw new Error;we(`${a} allowed`,"success")}catch{we("Could not allow that domain","danger");return}try{await Dt()}catch(o){console.warn("[magnets] refresh after allow-domain failed:",o)}}async function hg(e,t){const a=String(t||"").trim().toLowerCase();if(!a)return;const n=a.split("."),o=n.length>2?n.slice(-2).join("."):null;let s=a;o&&window.confirm(`Hide ${a} from this list?

OK — hide every domain under ${o} too (covers preview/staging URLs that change every deploy).
Cancel — hide only ${a}.`)&&(s=o);try{if(!(await(await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity/dismiss`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({domain:s})})).json().catch(()=>({}))).ok)throw new Error;we(`${s} hidden from this list`,"success")}catch{we("Could not dismiss that domain","danger");return}await qi(e)}async function fg(e,t){const a=String(t||"").trim().toLowerCase();if(a){try{if(!(await(await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity/restore`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({domain:a})})).json().catch(()=>({}))).ok)throw new Error;we(`${a} will show again`,"success")}catch{we("Could not restore that domain","danger");return}await qi(e)}}async function qi(e){try{const a=await(await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity`)).json().catch(()=>({}));if(!a.ok)return;q.install[e.guid]=a;const n=document.querySelector(`.mag-card[data-guid="${CSS.escape(e.guid)}"] .mag-install-slot`);n&&(n.innerHTML=co(e))}catch(t){console.warn("[magnets] install refresh failed:",t)}}async function vg(e){if(e.status==="DRAFT"){we("Open Edit and Save to publish a draft magnet.","info");return}const t=e.status==="ENABLED"?"DISABLED":"ENABLED";try{if(!(await(await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw new Error;we(t==="ENABLED"?"Magnet enabled":"Magnet disabled","success")}catch{we("Update failed","danger");return}try{await Dt()}catch(a){console.warn("[magnets] refresh after status toggle failed:",a)}}async function bg(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`)){try{if(!(await(await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"})).json().catch(()=>({}))).ok)throw new Error;we("Magnet deleted","success")}catch{we("Delete failed","danger");return}try{await Dt()}catch(t){console.warn("[magnets] refresh after delete failed:",t)}}}function hn(e){const t=[];return e.querySelectorAll(".mag-cta").forEach(a=>{if(!a.querySelector(".mag-cta__on").checked)return;const n=a.dataset.type,o=a.dataset.kind,s=a.querySelector(".mag-cta__val"),r=s?s.value.trim():"";if(o==="value")if(n==="call"&&a.querySelector(".mag-cta__callsrc")?.value==="callrail"){const i=a.querySelector(".mag-cta__crtracker"),l=i?.value||"",c=i?.selectedOptions?.[0];l&&t.push({type:n,value:l,config:{source:"callrail",...c?.dataset?.trackerId?{tracker_id:c.dataset.trackerId}:{},...c?.dataset?.trackerName?{tracker_name:c.dataset.trackerName}:{}}})}else r&&t.push({type:n,value:r});else if(o==="book")if(a.querySelector(".mag-cta__booksrc")?.value==="calendly"){const i=a.querySelector(".mag-cta__calevent"),l=i?.value||"",c=(i?.selectedOptions?.[0]?.textContent||"").trim();t.push({type:n,config:{source:"calendly",...l?{calendly_url:l}:{},...l&&c?{event_name:c}:{}}})}else{const i={type:n};r&&(/^https?:\/\//i.test(r)?i.value=r:i.config={meeting_label:r}),t.push(i)}else if(o==="support"){const i=(a.querySelector(".mag-cta__opts")?.value||"").split(`
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:Ui(e),actions:t,font:e.querySelector("#mag-f-font").value.trim(),theme_vars:kg(e),inline_width:e.querySelector("#mag-f-inline-w").value.trim(),inline_height:e.querySelector("#mag-f-inline-h").value.trim(),hide_launcher:e.querySelector("#mag-f-hide-launcher").checked,input_placeholder:e.querySelector("#mag-f-input-ph").value,summary_confirm_label:e.querySelector("#mag-f-summary-confirm").value.trim(),success_title:e.querySelector("#mag-f-success-title").value.trim(),success_text:e.querySelector("#mag-f-success-text").value,success_cta:Ag(e)}}const _g=512,yg=new Set(["image/png","image/jpeg","image/gif","image/webp"]),wg=8*1024*1024;function xg(e){return new Promise((t,a)=>{const n=new Image,o=new FileReader;o.onerror=()=>a(new Error("Could not read that file.")),o.onload=()=>{n.onerror=()=>a(new Error("That file isn’t a readable image.")),n.onload=()=>{const s=Math.min(1,_g/Math.max(n.naturalWidth,n.naturalHeight)),r=Math.max(1,Math.round(n.naturalWidth*s)),i=Math.max(1,Math.round(n.naturalHeight*s)),l=document.createElement("canvas");l.width=r,l.height=i,l.getContext("2d").drawImage(n,0,0,r,i),t(l.toDataURL("image/png"))},n.src=o.result},o.readAsDataURL(e)})}function Eg(e,t){const a=e.querySelector("#mag-logo-drop");if(!a)return;const n=e.querySelector("#mag-f-logo-file"),o=e.querySelector("#mag-logo-browse"),s=e.querySelector("#mag-logo-remove"),r=e.querySelector("#mag-logo-preview"),i=e.querySelector("#mag-logo-status"),l=e.querySelector("#mag-f-logo"),c=(m,f)=>{i.textContent=m,i.style.color=f?"var(--color-danger, #DD4124)":""},g=m=>{r.innerHTML=m?`<img src="${w(m)}" alt="">`:'<span class="material-symbols-outlined" aria-hidden="true">image</span>',s.hidden=!m},b=m=>{l.value=m,l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))};async function d(m){if(!yg.has(m.type)){c("PNG, JPEG, GIF, or WEBP only.",!0);return}if(m.size>wg){c("That file is too large (8MB max before resizing).",!0);return}c("Uploading…",!1);try{const f=await xg(m),p=await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({image:f})}),v=await p.json().catch(()=>({}));if(!p.ok||!v.ok)throw new Error(v.error||`Upload failed (${p.status})`);const x=`${X()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;b(x),g(x),c("Logo updated.",!1)}catch(f){c(f.message||"Upload failed.",!0)}}n.addEventListener("change",()=>{n.files[0]&&d(n.files[0]),n.value=""}),a.addEventListener("click",m=>{m.target===s||s.contains(m.target)||m.target!==o&&n.click()}),o.addEventListener("click",()=>n.click()),["dragenter","dragover"].forEach(m=>a.addEventListener(m,f=>{f.preventDefault(),a.classList.add("is-dragover")})),["dragleave","drop"].forEach(m=>a.addEventListener(m,f=>{f.preventDefault(),a.classList.remove("is-dragover")})),a.addEventListener("drop",m=>{const f=m.dataTransfer?.files?.[0];f&&d(f)}),s.addEventListener("click",async m=>{m.stopPropagation(),c("Removing…",!1);try{const f=await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"DELETE"}),p=await f.json().catch(()=>({}));if(!f.ok||!p.ok)throw new Error(p.error||`Remove failed (${f.status})`);b(""),g(""),c("Logo removed.",!1)}catch(f){c(f.message||"Remove failed.",!0)}})}function kg(e){return e.querySelector("#mag-f-surface-on")?.checked?{surface:e.querySelector("#mag-f-sv-surface").value,surface_2:e.querySelector("#mag-f-sv-surface2").value,border:e.querySelector("#mag-f-sv-border").value,text:e.querySelector("#mag-f-sv-text").value,text_sub:e.querySelector("#mag-f-sv-textsub").value}:{}}function Ag(e){const t=e.querySelector("#mag-f-success-cta-label").value.trim(),a=e.querySelector("#mag-f-success-cta-url").value.trim();return t&&a?{label:t,url:a}:{}}function Ui(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",s=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==s.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}const On=[{label:"Web fonts (loaded for you)",opts:[["Inter, sans-serif","Inter"],["Poppins, sans-serif","Poppins"],["Montserrat, sans-serif","Montserrat"],["Roboto, sans-serif","Roboto"],['"Open Sans", sans-serif',"Open Sans"],["Lato, sans-serif","Lato"],["Nunito, sans-serif","Nunito"],["Raleway, sans-serif","Raleway"],['"Work Sans", sans-serif',"Work Sans"],["Oswald, sans-serif","Oswald"],["Merriweather, serif","Merriweather (serif)"]]},{label:"System / always available",opts:[["system-ui, sans-serif","System UI"],["Georgia, serif","Georgia (serif)"],['"Times New Roman", Times, serif',"Times (serif)"],["Arial, Helvetica, sans-serif","Arial / Helvetica"],["Verdana, Geneva, sans-serif","Verdana"],['"Courier New", monospace',"Courier (mono)"]]}];function Sg(e){const t=String(e||""),a=new Set(On.flatMap(s=>s.opts.map(([r])=>r))),n=s=>s===t?" selected":"";let o=`<option value=""${t===""?" selected":""}>System default</option>`;t&&!a.has(t)&&(o+=`<option value="${w(t)}" selected>Current: ${w(t)}</option>`);for(const s of On)o+=`<optgroup label="${w(s.label)}">`+s.opts.map(([r,i])=>`<option value="${w(r)}"${n(r)}>${w(i)}</option>`).join("")+"</optgroup>";return o}function Oa(e,t,a={}){const{freshDraft:n=!1}=a,o=!!e,s=o?null:crypto.randomUUID(),r=!o&&q.owners.length>1,i=e?.display_mode||"chat",l=e?.theme_mode||"auto",c={};(e?.actions||[]).forEach(S=>{S&&S.type&&(c[S.type]=S)});const g=o?!!e.home:!0,b=o?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",d=e?.theme_vars&&typeof e.theme_vars=="object"?e.theme_vars:{},m=Object.keys(d).length>0,f=(S,V)=>w(/^#[0-9a-fA-F]{6}$/.test(d[S]||"")?d[S]:V),p=document.createElement("div");p.className="mag-modal-scrim",p.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${o?"Edit magnet":"New magnet"}">
      ...
      <div class="mag-modal__main">
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${Mi.map(S=>`<option value="${S.value}"${(e?e.trigger||"none":"on_load")===S.value?" selected":""}>${w(S.label)}</option>`).join("")}
        </select>
        ...
        <div class="mag-modal__sec">
          ...
          <input class="mag-modal__input" id="mag-f-subtitle" type="text" placeholder="Typically replies in a few minutes" value="${w(b)}">
          ...
          <select class="mag-modal__select" id="mag-f-font">${Sg(e?.font||"")}</select>
    ...
    </div>`,document.body.appendChild(p),requestAnimationFrame(()=>{p.classList.add("open"),p.querySelector(".mag-modal").classList.add("open")});const v=[...p.querySelectorAll(".mag-modal__navitem")],x=[...p.querySelectorAll(".mag-tab")],y=S=>{v.forEach(V=>V.classList.toggle("is-active",V.dataset.tab===S)),x.forEach(V=>{V.hidden=V.dataset.tab!==S}),p.querySelector(".mag-modal__body").scrollTop=0};v.forEach(S=>S.addEventListener("click",()=>y(S.dataset.tab)));const T=()=>Ra({...e,...hn(p),...o?{steps:hs()}:{}}),N=p.querySelector("#mag-preview-pane"),U=()=>window.matchMedia("(min-width: 1200px)").matches;let L=null;const j=()=>{if(!L&&U())try{L=qm(N,T)}catch{}};let K=null;const J=()=>{U()&&(j(),L&&(clearTimeout(K),K=setTimeout(()=>{try{L.refresh()}catch{}},300)))},ae=window.matchMedia("(min-width: 1200px)"),me=()=>{U()&&(j(),J())};ae.addEventListener("change",me);let D=!1,le=!1;const H=p.querySelector("#mag-f-dirty"),Z=S=>{D=S,H&&(H.hidden=!S)},ot=p.querySelector(".mag-modal__main");ot.addEventListener("input",()=>Z(!0)),ot.addEventListener("change",()=>{Z(!0),J()}),p.querySelector("#mag-f-color")?.addEventListener("input",()=>{Z(!0),J()});const st=S=>{D&&(S.preventDefault(),S.returnValue="")};window.addEventListener("beforeunload",st);let Bt=!0;const Za=u.subscribe(h.ROUTE_NAV_BEFORE,()=>{if(Bt){if(D&&!confirm("Discard your changes to this magnet?")){window.router?.navigate("/magnets");return}_()}}),_=()=>{if(n&&!le&&e&&e.status==="DRAFT"){fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"}).catch(()=>{}),q.magnets=q.magnets.filter(V=>V.guid!==e.guid);const S=document.getElementById("mag-body");S&&(S.innerHTML=`<div class="mag-grid">${q.magnets.map(po).join("")}</div>`)}Bt=!1,window.removeEventListener("beforeunload",st),u.unsubscribe(Za),clearTimeout(K),ae.removeEventListener("change",me),L&&L.destroy&&L.destroy(),p.classList.remove("open"),setTimeout(()=>p.remove(),180),document.removeEventListener("keydown",M)},A=()=>{D&&!confirm("Discard your changes to this magnet?")||_()};function M(S){S.key==="Escape"&&(S.preventDefault(),A())}document.addEventListener("keydown",M),p.querySelector(".mag-modal__close").addEventListener("click",A),p.querySelector('[data-x="cancel"]').addEventListener("click",A),p.querySelector("[data-close-modal]")?.addEventListener("click",A),p.querySelector("#mag-f-name").focus();const Y=p.querySelector("#mag-flow-panel");o?Nm(Y,e,()=>{Z(!0),J()}):Y.innerHTML='<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>',Eg(p,e),t&&y(t),j(),p.querySelectorAll(".mag-cta").forEach(S=>{const V=S.querySelector(".mag-cta__on"),ve=S.querySelector(".mag-cta__val"),de=S.querySelector(".mag-cta__opts"),He=S.querySelectorAll(".mag-cta__booksrc, .mag-cta__calevent, .mag-cta__callsrc, .mag-cta__crtracker");V.addEventListener("change",()=>{ve&&(ve.disabled=!V.checked),de&&(de.disabled=!V.checked),He.forEach(ee=>{ee.disabled=!V.checked}),V.checked&&(ve||de)?.focus()}),ve&&ve.addEventListener("input",()=>{ve.value.trim()&&!V.checked&&(V.checked=!0,de&&(de.disabled=!1))})}),p.querySelectorAll('.mag-cta[data-kind="book"]').forEach(S=>{const V=S.querySelector(".mag-cta__booksrc"),ve=S.querySelector(".mag-cta__val"),de=S.querySelector(".mag-cta__calevent");if(!V||!de)return;const He=()=>{const ee=V.value==="calendly";ve.hidden=ee,de.hidden=!ee,ee&&!de.dataset.listed&&(de.dataset.listed="1",Xm(de))};V.addEventListener("change",()=>{const ee=S.querySelector(".mag-cta__on");ee.checked||(ee.checked=!0,ee.dispatchEvent(new Event("change"))),He()}),He()}),p.querySelectorAll('.mag-cta[data-type="call"]').forEach(S=>{const V=S.querySelector(".mag-cta__callsrc"),ve=S.querySelector(".mag-cta__val"),de=S.querySelector(".mag-cta__crtracker");if(!V||!de)return;const He=()=>{const ee=V.value==="callrail";ve.hidden=ee,de.hidden=!ee,ee&&!de.dataset.listed&&(de.dataset.listed="1",eg(de))};V.addEventListener("change",()=>{const ee=S.querySelector(".mag-cta__on");ee.checked||(ee.checked=!0,ee.dispatchEvent(new Event("change"))),He()}),He()});const z=p.querySelector("#mag-f-surface-on"),Le=p.querySelector("#mag-f-surface");z.addEventListener("change",()=>Le.hidden=!z.checked);const rt=p.querySelector("#mag-f-inline-size");p.querySelectorAll('input[name="mag-display"]').forEach(S=>S.addEventListener("change",()=>{rt.hidden=p.querySelector('input[name="mag-display"]:checked')?.value!=="inline"})),p.querySelector('[data-x="preview"]')?.addEventListener("click",()=>io(()=>Ra({...e,...hn(p),...o?{steps:hs()}:{}}))),p.querySelector('[data-x="save"]').addEventListener("click",async S=>{const V=S.currentTarget,ve=p.querySelector("#mag-f-error"),de=p.querySelector("#mag-f-name").value.trim();if(!de){y("basics"),ve.textContent="Please give your magnet a name.";return}const He=p.querySelector("#mag-f-domains").value.split(",").map(oe=>oe.trim()).filter(Boolean);let ee="";if(p.querySelectorAll(".mag-cta").forEach(oe=>{const kt=oe.querySelector(".mag-cta__on").checked;if(oe.dataset.kind==="book"){const Ut=oe.querySelector(".mag-cta__booksrc")?.value==="calendly";kt&&Ut&&!oe.querySelector(".mag-cta__calevent")?.value&&(ee=ee||"Pick a Calendly event for the Book button, or switch it back to the built-in scheduler.");return}if(oe.dataset.kind!=="value")return;if(oe.dataset.type==="call"&&oe.querySelector(".mag-cta__callsrc")?.value==="callrail"){kt&&!oe.querySelector(".mag-cta__crtracker")?.value&&(ee=ee||"Pick a CallRail tracking number for the Call button, or switch it back to a phone number.");return}const qt=oe.querySelector(".mag-cta__val").value.trim();kt&&!qt&&(ee=ee||`Add a target for the ${lo[oe.dataset.type].label} button, or uncheck it.`)}),ee){y("welcome"),ve.textContent=ee;return}const ho=Ui(p);if(ho.enabled&&!Object.keys(ho.b).length){y("ab"),ve.textContent="Give variant B at least one change (title, welcome, or color), or untick the A/B test.";return}if(o){const oe=Mm();if(oe){y("flow"),ve.textContent=oe.message,Pm(oe.route,oe.message,{uid:oe.uid,field:oe.field});return}}const en={name:de,domains:He,...hn(p)};r&&(en.owner_guid=p.querySelector("#mag-f-owner").value);const fo=o&&e.status==="DRAFT";fo&&(en.status="ENABLED"),V.disabled=!0,ve.textContent="";try{const oe=o?`${X()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${X()}/m5t/v5/magnets`,kt={"Content-Type":"application/json"};s&&(kt["Idempotency-Key"]=s);const qt=await fetch(oe,{method:o?"PATCH":"POST",headers:kt,body:JSON.stringify(en)});let Ut={};try{Ut=await qt.json()}catch{}if(!qt.ok||!Ut.ok)throw new Error(Ut.message||`Save failed (${qt.status})`);o&&await Dm(e.guid),we(fo||!o?"Magnet created":"Magnet updated","success"),le=!0,_(),await Dt()}catch(oe){V.disabled=!1,ve.textContent=oe.message||"Something went wrong."}})}const Cg=Object.freeze(Object.defineProperty({__proto__:null,CTA_META:lo,CTA_ORDER:Pi,DISPLAY_OPTS:Ni,FONT_GROUPS:On,MODE_LABEL:Ri,THEME_OPTS:Oi,TRIGGER_OPTS:Mi,cspNoteHTML:Ii,init:rg,openModal:Oa,render:sg,stepFunnelHTML:Bi},Symbol.toStringTag,{value:"Module"})),Tg={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ws=e=>String(e??"").replace(/[&<>"']/g,t=>Tg[t]),$g=["provision_magnets","manage_magnets"],Lg=()=>E.getCapabilities().some(e=>$g.includes(e));function Ig(){const e=new Map;for(const t of at)e.set(t.category,(e.get(t.category)||0)+1);return Object.keys(Si).filter(t=>e.has(t)).map(t=>[t,e.get(t)])}const xs=(e,t,a,n)=>`<button class="m5t-chip--filter" type="button" data-cat="${ws(e)}" aria-pressed="${n}">${ws(t)}<span class="m5t-chip__count">${a}</span></button>`;let Es=!1;function Rg(){if($i(),Es)return;const e=document.createElement("style");e.id="m5t-templates-page-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Es=!0}function zi(){Rg();const e=Lg();return`
    <div class="page-shell" data-section="templates">
      ...
      <div class="m5t-chip-row tpl-filters" id="tpl-filters" role="group" aria-label="Filter templates by category">
        ${xs("all","All",at.length,"true")}
        ${Ig().map(([t,a])=>xs(t,Si[t],a,"false")).join("")}
      </div>

      <div class="mag-tpl-grid mag-tpl-grid--page" id="tpl-grid">
        ${at.map(t=>Ci(t,{detail:!0,gallery:!0,canUse:e})).join("")}
      </div>
    </div>`}function Hi(){const e=document.getElementById("tpl-grid");document.getElementById("tpl-filters")?.addEventListener("click",t=>{const a=t.target.closest("[data-cat]");if(!a)return;a.parentElement.querySelectorAll("[data-cat]").forEach(o=>{o.setAttribute("aria-pressed",String(o===a))});const n=a.dataset.cat;e?.querySelectorAll(".mag-tpl-card").forEach(o=>{o.hidden=!(n==="all"||o.dataset.cat===n)})}),e?.addEventListener("click",t=>{const a=t.target.closest("[data-preview]");if(a){const o=at.find(s=>s.id===a.dataset.preview);o&&io(()=>Ra({...o.appearance,steps:o.steps,name:o.name}));return}const n=t.target.closest("[data-tpl]");n&&(Gm(n.dataset.tpl),window.location.hash="#/magnets")})}const Ng={render:zi,init:Hi},Og=Object.freeze(Object.defineProperty({__proto__:null,default:Ng,init:Hi,render:zi},Symbol.toStringTag,{value:"Module"})),Mg={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Me=e=>String(e??"").replace(/[&<>"']/g,t=>Mg[t]),Mn=()=>E.getConfig?.().BASE_URL||"",ks=(e,t="info")=>{try{u.publish(h.UI_TOAST,{message:e,type:t})}catch{}},Pg="managed_client",Pn=[["ALL","All"],["NOT_SENT","Not sent"],["DRAFT","Awaiting response"],["SUBMITTED","Submitted"],["CANCELLED","Cancelled"]],ji=Object.fromEntries(Pn),fe={clients:[],responses:[],filter:"ALL",search:"",openGuid:null};let As=!1;function Fg(){if(Jn(),As)return;const e=document.createElement("style");e.id="m5t-questionnaires-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),As=!0}const na=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function mo(){return fe.clients.map(e=>{const t=fe.responses.filter(n=>n.owner_guid===e.guid),a=t[0]||null;return{guid:e.guid,name:e.caption||e.name||e.guid,latest:a,earlier:Math.max(0,t.length-1),status:a?a.status:"NOT_SENT"}})}function Gi(){const e=fe.search.trim().toLowerCase();return mo().filter(t=>(fe.filter==="ALL"||t.status===fe.filter)&&(!e||t.name.toLowerCase().includes(e)))}const Ss=(e,t)=>e?.latest?.[t]?Ye(e.latest[t]):"—";function Vi(e){const t=e.status==="SUBMITTED",a=e.status==="SUBMITTED"?`<button class="qz-act" type="button" data-act="open" data-guid="${Me(e.latest.guid)}">Read answers</button>`:e.status==="DRAFT"?`<button class="qz-act" type="button" data-act="copy" data-url="${Me(e.latest.url||"")}">Copy link</button>`:'<a class="qz-act" href="#/clients">Go to client</a>';return`<tr class="${t?"qz-row--open":""}"${t?` data-open-guid="${Me(e.latest.guid)}"`:""}>
    ...
    <td class="qz-when">${Me(Ss(e,"created_tz"))}</td>
    <td class="qz-when">${Me(Ss(e,"submitted_tz"))}</td>
    <td class="qz-actcell">${a}</td>
  </tr>`}function Wi(){return Fg(),`
    ...
    </div>`}async function Yi(){await Dg()}async function Dg(){const e=document.getElementById("qz-body");if(e){try{const[t,a]=await Promise.all([fetch(`${Mn()}/m5t/v5/acctGroup`),fetch(`${Mn()}/m5t/v5/m5mQuestionnaireResponse`)]),n=await t.json().catch(()=>({})),o=await a.json().catch(()=>({}));if(!t.ok||!a.ok)throw new Error("load failed");fe.clients=(n.data||[]).filter(s=>s.class===Pg&&!["DELETED","ARCHIVED"].includes(s.status)).sort((s,r)=>String(s.caption||"").localeCompare(String(r.caption||""))),fe.responses=o.data||[]}catch{e.innerHTML=na("error","Could not load questionnaires. Please try again.");return}Ki()}}function Ki(){const e=document.getElementById("qz-body");if(!e)return;if(!fe.clients.length){e.innerHTML=na("groups","No clients yet. Add a client first, then send them a kickoff questionnaire.");return}const t=mo(),a={ALL:t.length};Pn.slice(1).forEach(([o])=>{a[o]=t.filter(s=>s.status===o).length});const n=Gi();e.innerHTML=`
    <div class="qz-bar">
      <div class="qz-filter">
        ${Pn.map(([o,s])=>`<button data-filter="${o}" class="${fe.filter===o?"active":""}">${Me(s)}${a[o]?`<span class="qz-pillnum">${a[o]}</span>`:""}</button>`).join("")}
      </div>
      <span class="qz-searchwrap">
        <span class="material-symbols-outlined" aria-hidden="true">search</span>
        <input class="qz-search" id="qz-search" type="search" placeholder="Search clients" value="${Me(fe.search)}" aria-label="Search clients" />
      </span>
    ...
    <div class="qz-tablewrap">
      <table class="qz-table">
        ...
        <tbody id="qz-tbody">${n.length?n.map(Vi).join(""):`<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">${fe.search.trim()?"No clients match your search.":`No clients with status “${Me(ji[fe.filter]||fe.filter)}”.`}</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".qz-filter")?.addEventListener("click",o=>{const s=o.target.closest("[data-filter]");s&&(fe.filter=s.dataset.filter,Ki())}),e.querySelector("#qz-search")?.addEventListener("input",o=>{fe.search=o.target.value,Bg()}),e.querySelector("#qz-tbody")?.addEventListener("click",qg)}function Bg(){const e=document.getElementById("qz-tbody");if(!e)return;const t=Gi();e.innerHTML=t.length?t.map(Vi).join(""):'<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">No clients match your search.</div></td></tr>';const a=document.querySelector(".qz-count");a&&(a.textContent=`${t.length} of ${mo().length}`)}function qg(e){const t=e.target.closest('[data-act="copy"]');if(t){e.stopPropagation();const s=t.dataset.url;if(!s){ks("No link on this questionnaire yet.","warning");return}navigator.clipboard?.writeText(s).then(()=>{t.textContent="Copied!",setTimeout(()=>{t.textContent="Copy link"},1500)},()=>ks("Could not copy the link.","error"));return}const a=e.target.closest('[data-act="open"]'),n=e.target.closest("[data-open-guid]"),o=a?.dataset.guid||n?.dataset.openGuid;o&&Ug(o)}async function Ug(e){fe.openGuid=e;const t=document.createElement("div");t.className="qz-drawer-scrim";const a=document.createElement("aside");a.className="qz-drawer",a.setAttribute("role","dialog"),a.setAttribute("aria-label","Questionnaire answers"),a.innerHTML=`
  ...
  `,document.head.appendChild(e),Cs=!0}function oa(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Yg(e){return`<select class="leads-status" data-id="${P(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${Fn.map(t=>`<option value="${t}" ${e.status===t?"selected":""}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join("")}
  </select>`}function Kg(e){const t=k.magnetNames[e.magnet_guid]||e.lead_source||"—",a=e.phone?String(e.phone).replace(/[^\d+]/g,""):"";return`
    <tr class="leads-row${String(e.id)===k.selectedId?" selected":""}" data-id="${P(e.id)}" tabindex="0" role="button" aria-label="Open lead ${P(Fa(e))}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${P(Ji(e))}</span>
          <span><span class="leads-name">${P(Fa(e))}</span>${e.company?`<span class="leads-sub">${P(e.company)}</span>`:""}</span>
        </span>
      </td>
      ${k.book?`<td>${Ar(k.ownerNames[e.owner_guid]||"")||'<span class="leads-muted">—</span>'}</td>`:""}
      <td>
      ...
      <td>${k.canManage?Yg(e):`<span class="leads-badge" data-s="${P(e.status)}">${P(e.status)}</span>`}</td>
      <td class="num leads-muted" style="white-space:nowrap" title="${P(It(e))}">${Vg(e)?'<span class="leads-fresh" title="Captured in the last 24 hours"></span>':""}${P(Gg(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}const Qi=e=>k.clientFilter==="ALL"||e.owner_guid===k.clientFilter;function Jg(e){const t=k.search.trim().toLowerCase();if(!t)return!0;const a=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,k.magnetNames[e.magnet_guid],k.book?k.ownerNames[e.owner_guid]:"",e.utm_campaign,e.utm_source].filter(Boolean).join(" ").toLowerCase();return t.split(/\s+/).every(n=>a.includes(n))}const Qg=e=>!k.day||Xa(e).slice(0,10)===k.day;function Xi(){return k.leads.filter(e=>(k.filter==="ALL"||e.status===k.filter)&&Qi(e)&&Jg(e)&&Qg(e))}function Xg(){if(!k.day)return"";let e=k.day;try{e=new Date(`${k.day}T00:00:00Z`).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric",timeZone:"UTC"})}catch{}return`<button class="leads-daychip" type="button" id="leads-dayclear" title="Show every day again">
  ...
  </button>`}const Zi=()=>oa("touch_app","Click to see lead information.");function Zg(){Wg(),wt();const e=ie();return`
    <div class="page-shell" data-section="leads">
      ...
      <div class="leads-layout">
        ...
        <aside class="dashboard-card leads-panel" aria-label="Lead detail">
          <div class="card-body" id="leads-panel-body">${Zi()}</div>
        </aside>
      </div>
    </div>`}async function eh(){document.getElementById("leads-export")?.addEventListener("click",oh);const e=En(vt.LEADS_SEARCH),t=En(vt.LEADS_DAY);if((e||t)&&(k.search=e||"",k.day=t||"",k.filter="ALL",k.clientFilter="ALL",k.shown=ut),ie()){const a=n=>Number(n||0).toLocaleString();nt(Pa(),[{h:"Leads · wk",td:n=>a(n.leads.this_week)},{h:"Leads · total",td:n=>a(n.leads.total)},{h:"Compl.",td:n=>n.completion_rate!=null?`${n.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await th()}async function th(){const e=document.getElementById("leads-body");if(e){try{const[t,a]=await Promise.all([fetch(`${Pa()}/m5t/v5/m5mLead`),fetch(`${Pa()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(k.leads=(n.data||[]).filter(o=>!["DELETED","ARCHIVED"].includes(o.status)),k.book=ie(),k.ownerNames=k.book?kr():{},a){const o=await a.json().catch(()=>({}));k.magnetNames={},(o.magnets||[]).forEach(s=>{k.magnetNames[s.guid]=s.name,s.owner_guid&&s.owner_name&&!k.ownerNames[s.owner_guid]&&(k.ownerNames[s.owner_guid]=s.owner_name)}),k.canManage=!!o.canManage}}catch{e.innerHTML=oa("error","Could not load your leads. Please try again.");return}Kt()}}const ah=()=>`
  <colgroup>
    <col style="width:22%">
    ...
    <div id="leads-tablezone"></div>`,e.querySelector(".leads-filter")?.addEventListener("click",s=>{const r=s.target.closest("[data-filter]");r&&(k.filter=r.dataset.filter,k.shown=ut,Kt())}),e.querySelector("#leads-clientsel")?.addEventListener("change",s=>{k.clientFilter=s.target.value,k.shown=ut,Kt()}),e.querySelector("#leads-dayclear")?.addEventListener("click",()=>{k.day="",k.shown=ut,Kt()}),e.querySelector("#leads-search")?.addEventListener("input",s=>{k.search=s.target.value,k.shown=ut,Dn()}),Dn()}function Dn(){const e=document.getElementById("leads-tablezone"),t=document.getElementById("leads-countlbl");if(!e)return;const a=Xi(),n=a.slice(0,k.shown),o=k.book?8:7;t&&(t.textContent=`${a.length} of ${k.leads.length}`),e.innerHTML=`
    <div class="leads-tablewrap">
      <table class="leads-table${k.book?" leads-table--book":""}">
        ...
        <tbody id="leads-tbody">${n.map(Kg).join("")||`<tr><td colspan="${o}"><div class="leads-muted" style="padding:14px 4px">${k.search.trim()?"No leads match your search.":`No ${k.filter.toLowerCase()} leads.`}</div></td></tr>`}</tbody>
      </table>
    </div>
    ${a.length>k.shown?`<button class="leads-more" type="button" id="leads-more">Show ${Math.min(ut,a.length-k.shown)} more (${a.length-k.shown} remaining)</button>`:""}`,e.querySelector("#leads-more")?.addEventListener("click",()=>{k.shown+=ut,Dn()}),e.querySelector("#leads-tbody")?.addEventListener("change",nh),e.querySelector("#leads-tbody")?.addEventListener("click",s=>{if(s.target.closest(".leads-status, a.leads-contactlink"))return;const r=s.target.closest(".leads-row");r&&Ts(r.dataset.id)}),e.querySelector("#leads-tbody")?.addEventListener("keydown",s=>{if(s.key!=="Enter"&&s.key!==" ")return;const r=s.target.closest(".leads-row");r&&s.target===r&&(s.preventDefault(),Ts(r.dataset.id))})}async function nh(e){const t=e.target.closest(".leads-status");if(!t)return;const a=t.dataset.id,n=k.leads.find(r=>String(r.id)===String(a)),o=t.value,s=n?.status;try{if(!(await(await fetch(`${Pa()}/m5t/v5/m5mLead/${encodeURIComponent(a)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:o})})).json().catch(()=>({}))).ok)throw new Error;n&&(n.status=o),Ma(`Marked ${o[0]}${o.slice(1).toLowerCase()}`,"success")}catch{t.value=s||"NEW",Ma("Could not update status","danger");return}try{String(a)===k.selectedId&&al(),k.filter!=="ALL"&&Kt()}catch(r){console.warn("[leads] re-render after status change failed:",r)}}function Ts(e){k.selectedId=String(e),document.querySelectorAll(".leads-row").forEach(t=>t.classList.toggle("selected",t.dataset.id===k.selectedId)),al()}function ua(e,t){const a=Array.isArray(e.tags)?e.tags:[];for(let n=a.length-1;n>=0;n--)if(a[n]&&a[n].tag===t&&a[n].value!=null)return String(a[n].value);return""}function el(e){const t=ua(e,"appointment_start");if(!t)return null;const a=ua(e,"appointment_status")||"booked",n=ua(e,"appointment_timezone"),o=ua(e,"appointment_event_type"),s=new Date(t);let r=t;if(!Number.isNaN(s.getTime())){const i={weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"};try{r=new Intl.DateTimeFormat(void 0,n?{...i,timeZone:n}:i).format(s)}catch{r=new Intl.DateTimeFormat(void 0,i).format(s)}}return{when:r,status:a,type:o,start:t}}const $s={booked:["QUALIFIED","Booked"],rescheduled:["WORKING","Rescheduled"],canceled:["CANCELED","Canceled"]};function tl(e){const t=Array.isArray(e.tags)?e.tags:[];let a=null;for(const l of t)if(!(!l||!l.tag)){if(l.tag==="callrail_call_id"){a={};continue}a&&l.tag.indexOf("call_")===0&&l.value!=null&&(a[l.tag]=String(l.value))}if(!a||!a.call_started)return null;const n=a.call_started,o=new Date(n);let s=n;Number.isNaN(o.getTime())||(s=new Intl.DateTimeFormat(void 0,{weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"}).format(o));const r=Number(a.call_duration)||0,i=r?r<60?`${r}s`:`${Math.floor(r/60)}m ${r%60}s`:"";return{when:s,dur:i,source:a.call_source||"",answered:a.call_answered||"",recording:a.call_recording_player||"",started:n}}function al(){const e=document.getElementById("leads-panel-body");if(!e)return;const t=k.leads.find(l=>String(l.id)===k.selectedId);if(!t){e.innerHTML=Zi();return}const a=k.magnetNames[t.magnet_guid]||t.lead_source||"—",n=el(t),[o,s]=n?$s[n.status]||$s.booked:["",""],r=tl(t),i=(l,c)=>c?`<div class="leads-det__field"><span class="leads-det__k">${P(l)}</span><span class="leads-det__v">${P(c)}</span></div>`:"";e.innerHTML=`
    <div class="leads-det__head">
      <span class="leads-avatar leads-det__ava">${P(Ji(t))}</span>
      <div>
    ...
    ${t.description?`<div class="leads-det__notes">${P(t.description)}</div>`:""}`}function oh(){const e=Xi();if(!e.length){Ma("Nothing to export","info");return}const t=["first_name","last_name","email","phone","company","product_interest","lead_source","utm_source","utm_medium","utm_campaign","gclid","status"],a=l=>`"${String(l??"").replace(/"/g,'""')}"`,o=[[...k.book?["client"]:[],...t,"magnet","captured","appointment","last_call"].join(",")];for(const l of e){const c=el(l),g=tl(l);o.push([...k.book?[a(k.ownerNames[l.owner_guid]||"")]:[],...t.map(b=>a(l[b])),a(k.magnetNames[l.magnet_guid]||l.lead_source||""),a(It(l)),a(c?`${c.start} (${c.status})`:""),a(g?`${g.started} (${g.answered==="no"?"missed":"answered"})`:"")].join(","))}const s=new Blob([o.join(`
`)],{type:"text/csv"}),r=URL.createObjectURL(s),i=document.createElement("a");i.href=r,i.download=`leads-${k.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r),Ma(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const sh=Object.freeze(Object.defineProperty({__proto__:null,init:eh,render:Zg},Symbol.toStringTag,{value:"Module"})),nl=()=>E.getConfig?.().BASE_URL||"",Ls=e=>e.toISOString().slice(0,10),We=e=>Number(e||0).toLocaleString(),rh={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ma=e=>String(e??"").replace(/[&<>"']/g,t=>rh[t]),Jt=e=>e==null?"—":`${e}%`,ih=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let Da=30,Is=!1;function ol(){if(Is)return;const e=document.createElement("style");e.id="m5t-analytics-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Is=!0}const ka=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,ga=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
  ...
  </div>`;function lh(e,t){const a=t>0?Math.round(e/t*100):0;return`<svg class="anl-bar" width="72" height="8" viewBox="0 0 72 8" role="img"
    ...
    <td>${s}</td>
  </tr>`}function sl(e,t){const a=e.reduce((n,o)=>Math.max(n,Number(o.leads?.window||0)),0);return`<div class="anl-wrap"><table class="anl-table">
    <thead><tr>
  ...
  </table></div>`}function dh(){return ie()?xt({section:"analytics",title:"Analytics",description:"Pick a client to see how their magnets are performing."}):(ol(),`
    <div class="page-shell" data-section="analytics">
      <div class="page-header">
        ...
        <div class="chart-controls" id="anl-periods">
          ${ih.map(e=>`<button class="chart-period-btn${e.d===Da?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>
    ...
    </div>`)}async function ph(){if(ie())return nt(nl(),[{h:"Leads",td:t=>We(t.leads.window??t.leads.total)},{h:"Opens",td:t=>We(t.opens)},{h:"Completed",td:t=>Jt(t.completion_rate)}]);ol(),await Ns();const e=document.getElementById("anl-periods");e&&e.addEventListener("click",t=>{const a=t.target.closest(".chart-period-btn");a&&(Da=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>{n.classList.toggle("active",Number(n.dataset.days)===Da)}),Ns())})}async function Ns(){const e=document.getElementById("anl-body"),t=document.getElementById("anl-range");if(!e)return;e.innerHTML=ka("hourglass_empty","Loading magnet performance…");const a=new Date,n=Ls(a),o=Ls(new Date(a.getTime()-(Da-1)*864e5));t&&(t.textContent=`${o} → ${n}`);let s;try{const d=await fetch(`${nl()}/m5t/v5/dashboard/stats?from=${o}&to=${n}&group_by=magnet`);if(s=await d.json(),!d.ok||!s?.ok)throw new Error(s?.error||`HTTP ${d.status}`)}catch(d){e.innerHTML=ka("cloud_off","Could not load analytics. Refresh to try again."),console.error("[analytics] load failed:",d);return}const r=(d,m)=>{const f=document.getElementById(d);f&&(f.textContent=m)};r("anl-leads",We(s.by_day?.reduce((d,m)=>d+Number(m.leads||0),0))),r("anl-opens",We(s.funnel?.opens)),r("anl-completion",Jt(s.funnel?.completion_rate)),r("anl-active",We(s.magnets?.active));const i=Array.isArray(s.by_magnet)?s.by_magnet:[];if(!i.length){e.innerHTML=ka("widgets","No magnets yet. Create one and its numbers will show up here.");return}const l=i.some(d=>Number(d.opens||0)>0||Number(d.leads?.window||0)>0),c=new Set(i.map(d=>d.owner_guid)).size>1,g=s.by_magnet_truncated?`<p class="anl-warn">Showing the top ${i.length} magnets by leads. You have more than that, so this list is not complete.</p>`:"",b=l?"":'<p class="anl-warn">No opens or leads for any magnet in this period. Try a longer range.</p>';e.innerHTML=g+b+sl(i,c)}const uh=Object.freeze(Object.defineProperty({__proto__:null,init:ph,render:dh,tableHTML:sl},Symbol.toStringTag,{value:"Module"})),rl=()=>E.getConfig?.().BASE_URL||"",Os=e=>e.toISOString().slice(0,10),Bn=e=>e==null?"—":"$"+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),Xe=e=>Number(e||0).toLocaleString(),mh={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},$t=e=>String(e??"").replace(/[&<>"']/g,t=>mh[t]);let Ms=!1;function gh(){if(Ms)return;const e=document.createElement("style");e.id="m5t-adperf-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ms=!0}const ht=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,ha=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
    ...
    <div class="stat-value" id="${a}">${n}</div>
  </div>`,hh=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let Ba=30;function il(){return ie()?xt({section:"ad-performance",title:"Ad Performance",description:"Pick a client to view their spend and lead performance."}):(gh(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${hh.map(e=>`<button class="chart-period-btn${e.d===Ba?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>
    ...
    </div>`)}async function ll(){if(ie()){const t=a=>Number(a||0).toLocaleString();return nt(rl(),[{h:"Spend",td:a=>a.ad?`$${t(a.ad.spend)}`:"—"},{h:"Clicks",td:a=>a.ad?t(a.ad.clicks):"—"},{h:"Leads",td:a=>t(a.leads.window??a.leads.total)},{h:"CPL",td:a=>a.ad?.cost_per_lead!=null?`$${t(a.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see spend here."})}const e=document.getElementById("adperf-periods");e?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(Ba=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===Ba)),Ps())}),await Ps()}async function Ps(){const e=rl(),t=document.getElementById("adperf-body"),a=document.getElementById("adperf-range"),n=new Date,o=Os(n),s=Os(new Date(n.getTime()-(Ba-1)*864e5));a&&(a.textContent=`${s} → ${o}`);let r,i=[],l=null,c=null,g=null;try{const[d,m,f,p,v]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${s}&to=${o}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${s}&to=${o}`),Ya().catch(()=>null),fetch(`${e}/m5t/v5/coreAdMetrics/conversions?from=${s}&to=${o}`).then(y=>y.json()).catch(()=>null)]);if(!d.ok)throw new Error(`HTTP ${d.status}`);r=await d.json(),i=((await m.json().catch(()=>({})))?.data||[]).filter(y=>y.status!=="DELETED"),l=await f.json().catch(()=>null),c=p,g=v}catch(d){console.warn("[ad-performance] load failed:",d),t&&(t.innerHTML=ht("error","Could not load ad performance. Please try again."));return}fh(c,i),vh(g);const b=r.totals||{};if(fa("adperf-spend",Bn(b.spend)),fa("adperf-clicks",Xe(b.clicks)),fa("adperf-leads",Xe(b.magnet_leads)),fa("adperf-cpl",Bn(b.cost_per_lead)),bh(l),!i.length){t.innerHTML=ht("link_off","No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.");return}if(!r.connected){t.innerHTML=ht("cloud_sync","Account connected. No ad data for this range yet. Metrics appear here once they sync.");return}t.innerHTML=_h(r.rows||[])}function fh(e,t){const a=document.getElementById("adperf-conn");if(!a)return;if(!e||e.denied){a.innerHTML="";return}const n=Re.google_ads,o=Ga(e.providers,"google_ads"),s=Va(n,o,!!e.configured?.google_ads),r=Oe()?` <a href="#/settings/integrations/${n.urlSlug}">Manage</a>`:"";if(s==="connected"||s==="broken"){Ka(),a.innerHTML=`<span>Google Ads</span> ${Wa(s,o)}${r}`;return}if(t.length){a.innerHTML=`<span>Google Ads</span> <span>${t.length} associated account${t.length===1?"":"s"}</span>`;return}a.innerHTML=""}function vh(e){const t=document.getElementById("adperf-conv-card"),a=document.getElementById("adperf-conv-body"),n=document.getElementById("adperf-stats"),o=document.getElementById("adperf-conv-stat");if(o&&o.remove(),!t||!a)return;if(!e?.ok||!e.has_selection){t.style.display="none";return}if(n){const i=document.createElement("div");i.className="stat-card",i.id="adperf-conv-stat",i.innerHTML=`
      <div class="stat-header">
    ...
    <p class="adperf-note">Counted actions are chosen on the Google Ads integration page. These are Google's own numbers and may overlap magnet leads, so they are never added together.</p>`}function bh(e){const t=document.getElementById("adperf-sources"),a=document.getElementById("adperf-src-summary");if(!t)return;const n=e&&Array.isArray(e.rows)?e.rows:[];if(!n.length){a&&(a.textContent=""),t.innerHTML=ht("search_off","No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.");return}const o=e.total_leads||n.reduce((i,l)=>i+(l.leads||0),0),s=e.tracked_leads||0;a&&(a.textContent=`${Xe(s)} of ${Xe(o)} leads tagged to a source`);const r=i=>i.campaign&&i.campaign!=="(none)"?$t(i.campaign):i.source&&i.source!=="(direct)"?$t(i.source):'<span class="adperf-src-untracked">Untracked / direct</span>';t.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
    ...
    </div>`}function fa(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}function Fs(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}function Ds(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e)}function _h(e){const m=e.length||1,f=Fs(Math.max(1,...e.map(D=>D.spend||0))),p=Fs(Math.max(1,...e.map(D=>D.magnet_leads||0))),v=738/m,x=Math.min(24,v*.55),y=D=>56+v*(D+.5),T=D=>304-D/f*282,N=D=>304-D/p*282,U=[0,.25,.5,.75,1].map(D=>{const le=304-D*282;return`<line x1="56" y1="${le.toFixed(1)}" x2="794" y2="${le.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${(le+3.5).toFixed(1)}" text-anchor="end" class="ax">$${Ds(f*D)}</text><text x="802" y="${(le+3.5).toFixed(1)}" text-anchor="start" class="ax">${Ds(p*D)}</text>`}).join(""),L=e.map((D,le)=>{const H=T(D.spend||0);return`<rect x="${(y(le)-x/2).toFixed(1)}" y="${H.toFixed(1)}" width="${x.toFixed(1)}" height="${Math.max(0,304-H).toFixed(1)}" rx="3" fill="#0072BA"><title>${D.date}: $${D.spend} spend</title></rect>`}).join(""),j=e.map((D,le)=>`${y(le).toFixed(1)},${N(D.magnet_leads||0).toFixed(1)}`).join(" "),K=m>1?`<polyline points="${j}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",J=e.map((D,le)=>`<circle cx="${y(le).toFixed(1)}" cy="${N(D.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${D.date}: ${D.magnet_leads} leads</title></circle>`).join(""),ae=Math.max(1,Math.ceil(m/6)),me=e.map((D,le)=>le%ae===0||le===m-1?`<text x="${y(le).toFixed(1)}" y="326" text-anchor="middle" class="ax">${D.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="adperf-chart" viewBox="0 0 840 340" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Ad spend versus magnet leads over time">
      ${U}${L}${K}${J}${me}
    </svg>`}const yh={render:il,init:ll},wh=Object.freeze(Object.defineProperty({__proto__:null,default:yh,init:ll,render:il},Symbol.toStringTag,{value:"Module"})),xh={google_ads:"Google Ads",google_lsa:"Local Services Ads"},Eh=e=>{const t=String(e||"").replace(/\D/g,"");return t.length===10?`${t.slice(0,3)}-${t.slice(3,6)}-${t.slice(6)}`:String(e||"")};let Bs=!1;function kh(){if(Bs)return;const e=document.createElement("style");e.id="m5t-adacct-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Bs=!0}function cl(){return ie()?xt({section:"ad-accounts",title:"Ad Accounts",description:"Pick a client to see their connected ad accounts."}):(kh(),Ka(),`
    ...
    </div>`)}async function dl(){if(ie()){const e=t=>Number(t||0).toLocaleString();return nt(re(),[{h:"Spend",td:t=>t.ad?`$${e(t.ad.spend)}`:"—"},{h:"Leads",td:t=>e(t.leads.window??t.leads.total)},{h:"CPL",td:t=>t.ad?.cost_per_lead!=null?`$${e(t.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see it here."})}await Ah()}async function Ah(){const[e,t,a]=await Promise.all([Ya().catch(()=>null),fetch(`${re()}/m5t/v5/coreAdAccount`).then(n=>n.json()).catch(()=>null),fetch(`${re()}/m5t/v5/coreAdMetrics/conversions`).then(n=>n.json()).catch(()=>null)]);Sh(e,a),Ch(t),Th(t)}function Sh(e,t){const a=document.getElementById("adacct-conn");if(!a)return;const n=Re.google_ads;if(!e||e.denied){a.innerHTML=De("link_off","Connection status is not available for your role.");return}const o=Ga(e.providers,"google_ads"),s=Va(n,o,!!e.configured?.google_ads),r=o?.external_account||{},i=n.card.reachableCount(r);let l;s==="connected"?l=i?`${i} reachable account${i===1?"":"s"}.`:"Connected.":s==="broken"?l=n.card.brokenDesc:s==="unavailable"?l="Google Ads is being set up for this platform.":l=Oe()?"Not connected yet. Connect from Settings to pull spend and clicks.":"Not connected yet.";const c=Oe()&&s!=="unavailable"?`<a class="adacct-manage" href="#/settings/integrations/${n.urlSlug}"><span class="material-symbols-outlined" aria-hidden="true">${s==="idle"?"link":"settings"}</span>${s==="idle"?"Connect":"Manage"}</a>`:"";let g="";if(t?.ok&&t.has_selection){const b=(t.actions||[]).map(m=>m.name||m.id),d=(t.selected_ids||[]).length-b.length;g=`
...
`&&c++,a.push(n),n="",a.some(b=>b.trim()!=="")&&t.push(a),a=[]):n+=g}if(a.push(n),a.some(c=>c.trim()!=="")&&t.push(a),t.length<2)return[];const s=t[0].map(c=>c.trim().toLowerCase()),r=s.findIndex(c=>/e-?mail/.test(c)),i=s.findIndex(c=>/phone|mobile|tel/.test(c)),l=s.findIndex(c=>/date|time|booked|appointment|start/.test(c));return r<0&&i<0?[]:t.slice(1).map(c=>({email:r>=0?(c[r]||"").trim():"",phone:i>=0?(c[i]||"").trim():"",at:l>=0?(c[l]||"").trim():""})).filter(c=>c.email||c.phone).slice(0,5e3)}function ml(e,t){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),o=document.createElement("a");o.href=n,o.download=t,document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(n),4e3)}const Oh={render:cl,init:dl},Mh=Object.freeze(Object.defineProperty({__proto__:null,default:Oh,init:dl,parseBookingCsv:ul,render:cl},Symbol.toStringTag,{value:"Module"})),Us="reseller_org",gl="managed_client";let zs=!1;const Ph={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},F=e=>String(e??"").replace(/[&<>"']/g,t=>Ph[t]);function Ze(e,t="info"){try{u.publish(h.UI_TOAST,{message:e,type:t})}catch{}}function Fh(){const e=E.getActiveOrg();if(e&&e.channel===Us)return{guid:e.guid,name:e.name};const t=E.getMemberships().find(a=>a.channel===Us);return t?{guid:t.orgGuid,name:t.name}:null}function Dh(e){const t=e?.created_tz;if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function Bh(){if(zs)return;const e=document.createElement("style");e.id="m5t-clients-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Jn(),zs=!0}const qh=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Qt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Uh(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
    <div class="client-row">
      <span class="client-row__avatar">${F(qh(t))}</span>
      <span class="client-row__main">
        <div class="client-row__name" title="${F(t)}">${F(t)}</div>
        <div class="client-row__meta">Added ${F(Dh(e.created))||"—"}</div>
      </span>
    ...
    </div>`}async function fl(){const e=Fh();document.getElementById("clients-add-btn")?.addEventListener("click",()=>zh(e)),await vl(e)}async function vl(e){const t=document.getElementById("clients-body"),a=document.getElementById("clients-count");if(t){if(!e?.guid){t.innerHTML=Qt("info","Client provisioning is available to reseller / agency accounts."),a&&(a.textContent="");return}try{const n=E.getConfig?.().BASE_URL||"",o=await fetch(`${n}/m5t/v5/acctGroup`);if(!o.ok)throw new Error(`HTTP ${o.status}`);const s=await o.json(),i=(Array.isArray(s?.data)?s.data:[]).filter(l=>l.class===gl&&(!l.parent||l.parent===e.guid));if(!i.length){t.innerHTML=Qt("group_off","No clients yet. Add your first client to start managing magnets on their behalf."),a&&(a.textContent="");return}t.innerHTML=`<div class="client-list">${i.map(Uh).join("")}</div>`,a&&(a.textContent=`${i.length} client${i.length===1?"":"s"}`),t.querySelectorAll(".client-card__invite").forEach(l=>{l.addEventListener("click",()=>{l.dataset.action==="adaccounts"?Hh(l.dataset.clientGuid,l.dataset.clientName):l.dataset.action==="questionnaire"?jh(l.dataset.clientGuid,l.dataset.clientName):bl(l.dataset.clientGuid,l.dataset.clientName)})})}catch(n){console.warn("[clients] load failed:",n),t.innerHTML=Qt("error","Couldn’t load clients. Please try again."),a&&(a.textContent="")}}}function zh(e){if(!e?.guid){Ze("Only reseller / agency accounts can add clients.","error");return}const t=document.createElement("div");t.className="client-modal-scrim";const a=document.createElement("div");a.className="client-modal",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
    ...
    </div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add("open"),i.classList.add("open")});const l=i.querySelector("#aa-error"),c=i.querySelector('[data-act="save"]'),g=()=>{r.classList.remove("open"),i.classList.remove("open"),document.removeEventListener("keydown",b),setTimeout(()=>{r.remove(),i.remove()},200)},b=f=>{f.key==="Escape"&&g()};document.addEventListener("keydown",b),r.addEventListener("click",g),i.querySelector(".client-modal__close")?.addEventListener("click",g),i.querySelector('[data-act="cancel"]')?.addEventListener("click",g);const d=(f,p,v)=>{const x=`${a}/m5t/v5/coreAdAccount`;return p&&!v?fetch(x,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,provider:f,external_customer_id:p})}):p&&v&&p!==v.external_customer_id?fetch(`${x}/${encodeURIComponent(v.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({external_customer_id:p})}):!p&&v?fetch(`${x}/${encodeURIComponent(v.guid)}`,{method:"DELETE"}):null},m=async()=>{l.textContent="";const f=Hs(i.querySelector("#aa-gads").value),p=Hs(i.querySelector("#aa-lsa").value),v=[d("google_ads",f,o),d("google_lsa",p,s)].filter(Boolean);if(!v.length){g();return}c.disabled=!0;const x=c.innerHTML;c.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const y=await Promise.all(v);for(const T of y)if(!T.ok){const N=await T.json().catch(()=>({}));throw new Error(T.status===403?"You are not authorized to connect accounts for this client.":N?.error||N?.message||`Failed (HTTP ${T.status})`)}Ze("Ad accounts updated","success"),g()}catch(y){l.textContent=y.message||"Something went wrong. Please try again.",c.disabled=!1,c.innerHTML=x}};c?.addEventListener("click",m)}function bl(e,t){if(!e)return;const a=document.createElement("div");a.className="client-modal-scrim";const n=document.createElement("div");n.className="client-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="qm-body">${Qt("hourglass_empty","Loading…")}</div>`,document.body.appendChild(n),document.body.appendChild(o),requestAnimationFrame(()=>{n.classList.add("open"),o.classList.add("open")});const s=()=>{n.classList.remove("open"),o.classList.remove("open"),document.removeEventListener("keydown",r),setTimeout(()=>{n.remove(),o.remove()},200)},r=d=>{d.key==="Escape"&&s()};document.addEventListener("keydown",r),n.addEventListener("click",s),o.querySelector(".client-modal__close")?.addEventListener("click",s);const i=o.querySelector("#qm-body");function l(){i.innerHTML=`
      ...
      </div>`,i.querySelector('[data-act="done"]')?.addEventListener("click",s),i.querySelector('[data-act="resend"]')?.addEventListener("click",()=>l())}function b(d,m=!1){const f=d.editability||{editable:d.status==="SUBMITTED"&&!d.locked_tz,reason:d.locked_tz?"finalized":null,deadline:null},p=!!f.editable,v=!p&&d.status==="SUBMITTED"?f.reason==="finalized"?`<div class="qm-status" data-status="LOCKED"><span class="material-symbols-outlined" aria-hidden="true">lock</span> Finalized${d.locked_tz?` ${F(Tt(d.locked_tz))}`:""}${d.locked_by_email?` by ${F(d.locked_by_email)}`:""} — no further edits.</div>`:`<div class="qm-status" data-status="LOCKED"><span class="material-symbols-outlined" aria-hidden="true">lock_clock</span> Editing closed${f.deadline?` ${F(Tt(f.deadline))}`:""} — a response locks 14 days after it is submitted.</div>`:"",x=p&&f.deadline?`<p class="client-modal__sub qm-editable-hint">You can edit these answers until ${F(Tt(f.deadline))}.</p>`:"";i.innerHTML=`
  ...
  `,document.head.appendChild(e),Gs=!0}function qa(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Xh(e){const t=e.member_role||"member";return`
    <div class="team-row">
      <span class="team-avatar">${xe(Yh(e.name||e.email))}</span>
      ...
      <span class="team-role" data-role="${xe(t)}">${xe(Vt[t]?.label||t)}</span>
    </div>`}function _l(){return Qh(),`
