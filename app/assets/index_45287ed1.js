...
<body>
  ...
  `,document.head.appendChild(e),hs=!0}function Ei(e){return`<div class="pv-hintwrap">
    ...
    </div>`}const zm=300*1e3;function Hm(e){Zn(vt.MAGNET_TEMPLATE,{id:e,at:Date.now()})}function Ci(e){if(!e)return null;if(typeof e=="string")return at.find(n=>n.id===e)||null;const{id:t,at:a}=e;return typeof a=="number"&&Date.now()-a>=zm?null:at.find(n=>n.id===t)||null}function jm(){return Ci(En(vt.MAGNET_TEMPLATE))}function Gm(){return Ci(tp(vt.MAGNET_TEMPLATE))}let vs=!1;function Ti(){if(vs)return;const e=document.createElement("style");e.id="m5t-mag-template-styles",e.textContent=`
