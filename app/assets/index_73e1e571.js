(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const ml="modulepreload",gl=function(e,t){return new URL(e,t).href},co={},V=function(t,a,n){let o=Promise.resolve();if(a&&a.length>0){let c=function(h){return Promise.all(h.map(v=>Promise.resolve(v).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};const r=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");o=c(a.map(h=>{if(h=gl(h,n),h in co)return;co[h]=!0;const v=h.endsWith(".css"),m=v?'[rel="stylesheet"]':"";if(n)for(let f=r.length-1;f>=0;f--){const d=r[f];if(d.href===h&&(!v||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${h}"]${m}`))return;const p=document.createElement("link");if(p.rel=v?"stylesheet":ml,v||(p.as="script"),p.crossOrigin="",p.href=h,l&&p.setAttribute("nonce",l),document.head.appendChild(p),v)return new Promise((f,d)=>{p.addEventListener("load",f),p.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${h}`)))})}))}function s(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return o.then(r=>{for(const i of r||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})};var hl=/([:*])(\w+)/g,fl="([^/]+)",vl=/\*/g,bl="?(?:.*)",_l=/\/\?/g,yl="/?([^/]+|)",wl="(?:/^|^)",xl="";function Us(e){return e===void 0&&(e="/"),Fn()?location.pathname+location.search+location.hash:e}function ee(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function wa(e){return typeof e=="string"}function El(e){return typeof e=="function"}function xa(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function kl(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(a,n,o){return a===null&&(a={}),a[t[o]]=decodeURIComponent(n),a},null)}function Ea(e){var t=ee(e).split(/\?(.*)?$/);return[ee(t[0]),t.slice(1).join("")]}function Pn(e){for(var t={},a=e.split("&"),n=0;n<a.length;n++){var o=a[n].split("=");if(o[0]!==""){var s=decodeURIComponent(o[0]);t[s]?(Array.isArray(t[s])||(t[s]=[t[s]]),t[s].push(decodeURIComponent(o[1]||""))):t[s]=decodeURIComponent(o[1]||"")}}return t}function zs(e,t){var a=Ea(ee(e.currentLocationPath)),n=a[0],o=a[1],s=o===""?null:Pn(o),r=[],i;if(wa(t.path)){if(i=wl+ee(t.path).replace(hl,function(v,m,p){return r.push(p),fl}).replace(vl,bl).replace(_l,yl)+"$",ee(t.path)===""&&ee(n)==="")return{url:n,queryString:o,hashString:xa(e.to),route:t,data:null,params:s}}else i=t.path;var l=new RegExp(i,xl),c=n.match(l);if(c){var h=wa(t.path)?kl(c,r):c.groups?c.groups:c.slice(1);return{url:ee(n.replace(new RegExp("^"+e.instance.root),"")),queryString:o,hashString:xa(e.to),route:t,data:h,params:s}}return!1}function Hs(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function _t(e,t){return typeof e[t]>"u"||e[t]===!0}function Al(e){if(!e)return{};var t=e.split(","),a={},n;return t.forEach(function(o){var s=o.split(":").map(function(r){return r.replace(/(^ +| +$)/g,"")});switch(s[0]){case"historyAPIMethod":a.historyAPIMethod=s[1];break;case"resolveOptionsStrategy":n||(n={}),n.strategy=s[1];break;case"resolveOptionsHash":n||(n={}),n.hash=s[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":a[s[0]]=s[1]==="true";break}}),n&&(a.resolveOptions=n),a}function Fn(){return typeof window<"u"}function Sl(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(a){return a}).forEach(function(a){["before","after","already","leave"].forEach(function(n){a[n]&&(t[n]||(t[n]=[]),t[n].push(a[n]))})}),t}function Be(e,t,a){var n=t||{},o=0;(function s(){if(!e[o]){a&&a(n);return}Array.isArray(e[o])?(e.splice.apply(e,[o,1].concat(e[o][0](n)?e[o][1]:e[o][2])),s()):e[o](n,function(r){typeof r>"u"||r===!0?(o+=1,s()):a&&a(n)})})()}Be.if=function(e,t,a){return Array.isArray(t)||(t=[t]),Array.isArray(a)||(a=[a]),[e,t,a]};function po(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=Us(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function Ja(e,t){for(var a=0;a<e.instance.routes.length;a++){var n=e.instance.routes[a],o=zs(e,n);if(o&&(e.matches||(e.matches=[]),e.matches.push(o),e.resolveOptions.strategy==="ONE")){t();return}}t()}function Cl(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function Tl(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var uo=Fn(),$l=Hs();function Ll(e,t){if(_t(e.navigateOptions,"updateBrowserURL")){var a=("/"+e.to).replace(/\/\//g,"/"),n=uo&&e.resolveOptions&&e.resolveOptions.hash===!0;$l?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",n?"#"+a:a),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!n){var o=location.hash;location.hash="",location.hash=o}e.instance.__freezeListening=!1},1))):uo&&(window.location.href=e.to)}t()}function js(e,t){var a=e.instance;if(!a.lastResolved()){t();return}Be(a.lastResolved().map(function(n){return function(o,s){if(!n.route.hooks||!n.route.hooks.leave){s();return}var r=!1,i=e.instance.matchLocation(n.route.path,e.currentLocationPath,!1);if(n.route.path!=="*")r=!i;else{var l=e.matches?e.matches.find(function(c){return n.route.path===c.route.path}):!1;r=!l}if(_t(e.navigateOptions,"callHooks")&&r){Be(n.route.hooks.leave.map(function(c){return function(h,v){return c(function(m){m===!1?e.instance.__markAsClean(e):v()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return s()}]));return}else s()}}),{},function(){return t()})}function Il(e,t){e.match.route.hooks&&e.match.route.hooks.before&&_t(e.navigateOptions,"callHooks")?Be(e.match.route.hooks.before.map(function(a){return function(o,s){return a(function(r){r===!1?e.instance.__markAsClean(e):s()},e.match)}}).concat([function(){return t()}])):t()}function Rl(e,t){_t(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function Nl(e,t){e.match.route.hooks&&e.match.route.hooks.after&&_t(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(a){return a(e.match)}),t()}function Ol(e,t){var a=e.instance.lastResolved();if(a&&a[0]&&a[0].route===e.match.route&&a[0].url===e.match.url&&a[0].queryString===e.match.queryString){a.forEach(function(n){n.route.hooks&&n.route.hooks.already&&_t(e.navigateOptions,"callHooks")&&n.route.hooks.already.forEach(function(o){return o(e.match)})}),t(!1);return}t()}function Ml(e,t){var a=e.instance._notFoundRoute;if(a){e.notFoundHandled=!0;var n=Ea(e.currentLocationPath),o=n[0],s=n[1],r=xa(e.to);a.path=ee(o);var i={url:a.path,queryString:s,hashString:r,data:null,route:a,params:s!==""?Pn(s):null};e.matches=[i],e.match=i}t()}function Pl(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function Fl(e,t){e.instance._setCurrent(null),t()}function Gs(e,t){_t(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var Vs=[Ol,Il,Rl,Nl],mo=[js,Ml,Be.if(function(e){var t=e.notFoundHandled;return t},Vs.concat([Gs]),[Pl,Fl])];function un(){return un=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},un.apply(this,arguments)}function go(e,t){var a=0;function n(){if(a===e.matches.length){Gs(e,t);return}Be(Vs,un({},e,{match:e.matches[a]}),function(){a+=1,n()})}js(e,n)}function Qa(e){e.instance.__markAsClean(e)}function mn(){return mn=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},mn.apply(this,arguments)}var ho="[data-navigo]";function Dl(e,t){var a=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:ho},n=this,o="/",s=null,r=[],i=!1,l,c=Hs(),h=Fn();e?o=ee(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function v(w){return w.indexOf("#")>=0&&(a.hash===!0?w=w.split("#")[1]||"/":w=w.split("#")[0]),w}function m(w){return ee(o+"/"+ee(w))}function p(w,S,M,W){return w=wa(w)?m(w):w,{name:W||ee(String(w)),path:w,handler:S,hooks:Sl(M)}}function f(w,S,M){var W=this;return typeof w=="object"&&!(w instanceof RegExp)?(Object.keys(w).forEach(function(U){if(typeof w[U]=="function")W.on(U,w[U]);else{var ke=w[U],ot=ke.uses,C=ke.as,j=ke.hooks;r.push(p(U,ot,[l,j],C))}}),this):(typeof w=="function"&&(M=S,S=w,w=o),r.push(p(w,S,[l,M])),this)}function d(w,S){if(n.__dirty){n.__waiting.push(function(){return n.resolve(w,S)});return}else n.__dirty=!0;w=w?ee(o)+"/"+ee(w):void 0;var M={instance:n,to:w,currentLocationPath:w,navigateOptions:{},resolveOptions:mn({},a,S)};return Be([po,Ja,Be.if(function(W){var U=W.matches;return U&&U.length>0},go,mo)],M,Qa),M.matches?M.matches:!1}function b(w,S){if(n.__dirty){n.__waiting.push(function(){return n.navigate(w,S)});return}else n.__dirty=!0;w=ee(o)+"/"+ee(w);var M={instance:n,to:w,navigateOptions:S||{},resolveOptions:S&&S.resolveOptions?S.resolveOptions:a,currentLocationPath:v(w)};Be([Cl,Tl,Ja,Be.if(function(W){var U=W.matches;return U&&U.length>0},go,mo),Ll,Qa],M,Qa)}function _(w,S,M){var W=qe(w,S);return W!==null?(b(W.replace(new RegExp("^/?"+o),""),M),!0):!1}function y(w){return this.routes=r=r.filter(function(S){return wa(w)?ee(S.path)!==ee(w):El(w)?w!==S.handler:String(S.path)!==String(w)}),this}function x(){c&&(this.__popstateListener=function(){n.__freezeListening||d()},window.addEventListener("popstate",this.__popstateListener))}function T(){this.routes=r=[],c&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=i=!0}function N(w,S){return n._notFoundRoute=p("*",w,[l,S],"__NOT_FOUND__"),this}function q(){if(h)return ue().forEach(function(w){if(w.getAttribute("data-navigo")==="false"||w.getAttribute("target")==="_blank"){w.hasListenerAttached&&w.removeEventListener("click",w.navigoHandler);return}w.hasListenerAttached||(w.hasListenerAttached=!0,w.navigoHandler=function(S){if((S.ctrlKey||S.metaKey)&&S.target.tagName.toLowerCase()==="a")return!1;var M=w.getAttribute("href");if(typeof M>"u"||M===null)return!1;if(M.match(/^(http|https)/)&&typeof URL<"u")try{var W=new URL(M);M=W.pathname+W.search}catch{}var U=Al(w.getAttribute("data-navigo-options"));i||(S.preventDefault(),S.stopPropagation(),n.navigate(ee(M),U))},w.addEventListener("click",w.navigoHandler))}),n}function ue(){return h?[].slice.call(document.querySelectorAll(a.linksSelector||ho)):[]}function $e(w){return"/"+o+"/"+ee(w)}function he(w){return l=w,this}function We(){return s}function qe(w,S,M){var W=r.find(function(ot){return ot.name===w}),U=null;if(W){if(U=W.path,S)for(var ke in S)U=U.replace(":"+ke,S[ke]);U=U.match(/^\//)?U:"/"+U}return U&&M&&!M.includeRoot&&(U=U.replace(new RegExp("^/"+o),"")),U}function B(w){return w.getAttribute("href")}function ne(w){var S=Ea(ee(w)),M=S[0],W=S[1],U=W===""?null:Pn(W),ke=xa(w),ot=p(M,function(){},[l],M);return{url:M,queryString:W,hashString:ke,route:ot,data:null,params:U}}function z(){return ne(ee(Us(o)).replace(new RegExp("^"+o),""))}function K(w){var S={instance:n,currentLocationPath:w,to:w,resolveOptions:a};return Ja(S,function(){}),S.matches?S.matches:!1}function at(w,S,M){typeof S<"u"&&(typeof M>"u"||M)&&(S=m(S));var W={instance:n,to:S,currentLocationPath:S};po(W,function(){}),typeof w=="string"&&(w=typeof M>"u"||M?m(w):w);var U=zs(W,{name:String(w),path:w,handler:function(){},hooks:{}});return U||!1}function nt(w,S,M){return typeof S=="string"&&(S=Ot(S)),S?(S.hooks[w]||(S.hooks[w]=[]),S.hooks[w].push(M),function(){S.hooks[w]=S.hooks[w].filter(function(W){return W!==M})}):(console.warn("Route doesn't exists: "+S),function(){})}function Ot(w){return typeof w=="string"?r.find(function(S){return S.name===m(w)}):r.find(function(S){return S.handler===w})}function Ya(w){w.instance.__dirty=!1,w.instance.__waiting.length>0&&w.instance.__waiting.shift()()}this.root=o,this.routes=r,this.destroyed=i,this.current=s,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=Ya,this.on=f,this.off=y,this.resolve=d,this.navigate=b,this.navigateByName=_,this.destroy=T,this.notFound=N,this.updatePageLinks=q,this.link=$e,this.hooks=he,this.extractGETParameters=function(w){return Ea(v(w))},this.lastResolved=We,this.generate=qe,this.getLinkPath=B,this.match=K,this.matchLocation=at,this.getCurrentLocation=z,this.addBeforeHook=nt.bind(this,"before"),this.addAfterHook=nt.bind(this,"after"),this.addAlreadyHook=nt.bind(this,"already"),this.addLeaveHook=nt.bind(this,"leave"),this.getRoute=Ot,this._pathToMatchObject=ne,this._clean=ee,this._checkForAHash=v,this._setCurrent=function(w){return s=n.current=w},x.call(this),q.call(this)}var Bl=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function ql(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Dt={exports:{}},Ul=Dt.exports,fo;function zl(){return fo||(fo=1,(function(e,t){(function(a,n){var o={};a.PubSub?(o=a.PubSub,console.warn("PubSub already loaded, using existing version")):(a.PubSub=o,n(o)),e!==void 0&&e.exports&&(t=e.exports=o),t.PubSub=o,e.exports=t=o})(typeof window=="object"&&window||Ul||Bl,function(a){var n={},o=-1,s="*";function r(d){var b;for(b in d)if(Object.prototype.hasOwnProperty.call(d,b))return!0;return!1}function i(d){return function(){throw d}}function l(d,b,_){try{d(b,_)}catch(y){setTimeout(i(y),0)}}function c(d,b,_){d(b,_)}function h(d,b,_,y){var x=n[b],T=y?c:l,N;if(Object.prototype.hasOwnProperty.call(n,b))for(N in x)Object.prototype.hasOwnProperty.call(x,N)&&T(x[N],d,_)}function v(d,b,_){return function(){var x=String(d),T=x.lastIndexOf(".");for(h(d,d,b,_);T!==-1;)x=x.substr(0,T),T=x.lastIndexOf("."),h(d,x,b,_);h(d,s,b,_)}}function m(d){var b=String(d),_=!!(Object.prototype.hasOwnProperty.call(n,b)&&r(n[b]));return _}function p(d){for(var b=String(d),_=m(b)||m(s),y=b.lastIndexOf(".");!_&&y!==-1;)b=b.substr(0,y),y=b.lastIndexOf("."),_=m(b);return _}function f(d,b,_,y){d=typeof d=="symbol"?d.toString():d;var x=v(d,b,y),T=p(d);return T?(_===!0?x():setTimeout(x,0),!0):!1}a.publish=function(d,b){return f(d,b,!1,a.immediateExceptions)},a.publishSync=function(d,b){return f(d,b,!0,a.immediateExceptions)},a.subscribe=function(d,b){if(typeof b!="function")return!1;d=typeof d=="symbol"?d.toString():d,Object.prototype.hasOwnProperty.call(n,d)||(n[d]={});var _="uid_"+String(++o);return n[d][_]=b,_},a.subscribeAll=function(d){return a.subscribe(s,d)},a.subscribeOnce=function(d,b){var _=a.subscribe(d,function(){a.unsubscribe(_),b.apply(this,arguments)});return a},a.clearAllSubscriptions=function(){n={}},a.clearSubscriptions=function(b){var _;for(_ in n)Object.prototype.hasOwnProperty.call(n,_)&&_.indexOf(b)===0&&delete n[_]},a.countSubscriptions=function(b){var _,y,x=0;for(_ in n)if(Object.prototype.hasOwnProperty.call(n,_)&&_.indexOf(b)===0){for(y in n[_])x++;break}return x},a.getSubscriptions=function(b){var _,y=[];for(_ in n)Object.prototype.hasOwnProperty.call(n,_)&&_.indexOf(b)===0&&y.push(_);return y},a.unsubscribe=function(d){var b=function($e){var he;for(he in n)if(Object.prototype.hasOwnProperty.call(n,he)&&he.indexOf($e)===0)return!0;return!1},_=typeof d=="string"&&(Object.prototype.hasOwnProperty.call(n,d)||b(d)),y=!_&&typeof d=="string",x=typeof d=="function",T=!1,N,q,ue;if(_){a.clearSubscriptions(d);return}for(N in n)if(Object.prototype.hasOwnProperty.call(n,N)){if(q=n[N],y&&q[d]){delete q[d],T=d;break}if(x)for(ue in q)Object.prototype.hasOwnProperty.call(q,ue)&&q[ue]===d&&(delete q[ue],T=!0)}return T}})})(Dt,Dt.exports)),Dt.exports}var Hl=zl();const u=ql(Hl),g=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV.GO",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN.GO",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP.GO",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT.GO",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT.GO",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH.GO",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",AUTH_SCOPE_LOADED:"AUTH.SCOPE.LOADED",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",M5T_SIDE_NAV:"M5T_SIDE_NAV",M5T_SIDE_NAV_TAP:"M5T_SIDE_NAV.TAP",M5T_SIDE_NAV_COLLAPSE:"M5T_SIDE_NAV.COLLAPSE",M5T_SIDE_NAV_LOGO_TAP:"M5T_SIDE_NAV.LOGO_TAP",M5T_SIDE_NAV_ORG_SWITCH:"M5T_SIDE_NAV.ORG_SWITCH",M5T_SIDE_NAV_FOOTER_ACTION:"M5T_SIDE_NAV.FOOTER_ACTION",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_THEME_CHANGED:"UI.THEME.CHANGED",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL",MESSAGE:"MESSAGE",MESSAGE_CREATE:"MESSAGE.CREATE",MESSAGE_CREATED:"MESSAGE.CREATED",MESSAGE_EDIT:"MESSAGE.EDIT",MESSAGE_UPDATED:"MESSAGE.UPDATED",MESSAGE_DELETE:"MESSAGE.DELETE",MESSAGE_DELETED:"MESSAGE.DELETED",MESSAGE_REFRESH:"MESSAGE.REFRESH"}),Xa={BASE_URL:"./",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://machfivemagnet-saas.onrender.com"};var Za={};const H=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_UI_DARK_MODE:!0,FF_SSE_UI_ANIMATIONS:!0,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel",FF_API_RATELIMIT_SIGNIN_ENFORCE:!1,FF_API_RATELIMIT_SIGNIN_IP_LIMIT:20,FF_API_RATELIMIT_SIGNIN_EMAIL_LIMIT:10,FF_API_RATELIMIT_FORGOT_ENFORCE:!1,FF_API_RATELIMIT_FORGOT_IP_LIMIT:15,FF_API_RATELIMIT_FORGOT_EMAIL_LIMIT:5,FF_API_RATELIMIT_CAPTURE_ENFORCE:!1,FF_API_RATELIMIT_CAPTURE_LIMIT:30,FF_API_RATELIMIT_EVENT_ENFORCE:!1,FF_API_RATELIMIT_EVENT_LIMIT:600,FF_API_RATELIMIT_CSP_PING_ENFORCE:!1,FF_API_RATELIMIT_CSP_PING_LIMIT:30,FF_API_RATELIMIT_WEBAUTHN_AUTH_ENFORCE:!1,FF_API_RATELIMIT_WEBAUTHN_AUTH_IP_LIMIT:20,FF_API_RATELIMIT_INTEGRATIONS_ENFORCE:!1,FF_API_RATELIMIT_INTEGRATIONS_LIMIT:60,FF_API_RATELIMIT_QUESTIONNAIRE_ENFORCE:!1,FF_API_RATELIMIT_QUESTIONNAIRE_LIMIT:30,FF_API_RATELIMIT_AUTHENTICATED_ENFORCE:!1,FF_API_RATELIMIT_AUTHENTICATED_LIMIT:600,FF_API_MAGNET_REQUIRE_ORIGIN_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_LIMIT:2e3});function Ws(e,t=null){if(e in H)return H[e];if(typeof process<"u"&&Za&&Za[e]){const a=Za[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}if(typeof import.meta<"u"&&Xa&&Xa[e]){const a=Xa[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}return t}function Dn(e){return Ws(e,!1)===!0}function jl(){return{...H}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:H,getFlag:Ws,isEnabled:Dn,getAllFlags:jl});const vo={success:{border:"var(--color-success, #009473)",bg:"var(--color-success-soft, rgba(0,148,115,0.10))",icon:"check_circle"},danger:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},error:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},warning:{border:"var(--color-warning, #D97706)",bg:"var(--color-warning-soft, #FEF3C7)",icon:"warning"},info:{border:"var(--color-info, #0D9488)",bg:"var(--color-info-soft, #CCFBF1)",icon:"info"}},Gl=4500,gn=220;let ze=null,bo=!1;function Vl(){if(bo)return;const e=document.createElement("style");e.id="m5t-toast-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),bo=!0}function Wl(){return ze&&document.body.contains(ze)||(ze=document.createElement("div"),ze.className="m5t-toast-stack",ze.setAttribute("role","status"),ze.setAttribute("aria-live","polite"),document.body.appendChild(ze)),ze}function Yl(e){const t=e&&e.message;if(!t)return;Vl();const a=vo[e.type]||vo.info,n=document.createElement("div");n.className="m5t-toast",n.style.borderColor=a.border,n.style.background=a.bg,n.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true" style="color:${a.border}">${a.icon}</span><span class="m5t-toast__msg"></span><button type="button" class="m5t-toast__close" aria-label="Dismiss"><span class="material-symbols-outlined" aria-hidden="true">close</span></button>`,n.querySelector(".m5t-toast__msg").textContent=String(t),Wl().appendChild(n),requestAnimationFrame(()=>n.classList.add("is-in"));let s=!1;const r=()=>{s||(s=!0,clearTimeout(i),n.classList.remove("is-in"),n.classList.add("is-out"),setTimeout(()=>n.remove(),gn))},i=setTimeout(r,Gl);n.querySelector(".m5t-toast__close").addEventListener("click",r)}function Kl(){const e=t=>a=>{const n=a.detail?.pubsubTopic;n&&u.publish(n,a.detail)};document.addEventListener("nav-select",e()),document.addEventListener("logo-click",e()),document.addEventListener("nav-hover",e()),document.addEventListener("nav-double-tap",e()),document.addEventListener("nav-long-tap",e()),document.addEventListener("message-sent",e())}function Jl(){console.log("[AppEvents] Initializing event listeners..."),u.subscribe(g.APP_READY,(a,n)=>{console.log("[AppEvents] APP_READY:",n)}),u.subscribe(g.APP_ERROR,(a,n)=>{console.error("[AppEvents] APP_ERROR:",n)}),u.subscribe(g.APP_SIGNOUT,(a,n)=>{console.log("[AppEvents] APP_SIGNOUT:",n)}),u.subscribe(g.ROUTE_NAV_BEFORE,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",n),u.publish(g.UI_LOADING_START)}),u.subscribe(g.ROUTE_NAV_AFTER,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",n),u.publish(g.UI_LOADING_END)}),u.subscribe(g.ROUTE_NAV_ERROR,(a,n)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",n),u.publish(g.APP_ERROR,{message:"Navigation error",details:n})}),u.subscribe(g.AUTH_SIGNIN_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",n)}),u.subscribe(g.AUTH_SIGNIN_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",n),u.publish(g.UI_TOAST,{message:n.message||"Sign in failed",type:"danger"})}),u.subscribe(g.AUTH_SIGNUP_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",n),u.publish(g.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"}),u.publish(g.AUTH_VERIFY_LINK)}),u.subscribe(g.AUTH_VERIFY_LINK,(a,n)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),u.subscribe(g.AUTH_SIGNUP_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",n),u.publish(g.UI_TOAST,{message:n.message||"Sign up failed",type:"danger"})}),u.subscribe(g.AUTH_SIGNOUT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",n),u.publish(g.UI_TOAST,{message:"Signed out successfully",type:"info"})}),u.subscribe(g.AUTH_SIGNUP,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),u.subscribe(g.AUTH_FORGOT,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),u.subscribe(g.AUTH_FORGOT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",n),u.publish(g.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),u.subscribe(g.AUTH_RESETHASH_NAV,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),u.subscribe(g.AUTH_RESETHASH_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",n),u.publish(g.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),u.subscribe(g.AUTH_TOKEN_EXPIRED,(a,n)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",n),u.publish(g.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),u.subscribe(g.I18N_SET_LANG,(a,n)=>{console.log("[AppEvents] I18N_SET_LANG:",n);const{langCode:o}=n;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),u.publish(g.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(s){console.error("[AppEvents] Error changing language:",s),u.publish(g.UI_TOAST,{message:`Failed to change language: ${s.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),u.subscribe("CONVERSATION.PROMPT",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",n.message),en(n.message,"user",n.timestamp),u.publish(g.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Agent prompt (no implementation):",n.message);break;case"AGENT_CANVAS":console.log("[AppEvents] Display message in canvas:",n.message),en(n.message,"user",n.timestamp),u.publish(g.CANVAS_DO_SCROLL);break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),u.subscribe("CONVERSATION.RESPONSE",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",n.message),en(n.message,"assistant",n.timestamp,n.streaming);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),u.subscribe(g.UI_LOADING_START,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),u.subscribe(g.UI_LOADING_END,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),u.subscribe(g.UI_TOAST,(a,n)=>{Yl(n)}),u.subscribe(g.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const a="0.1",n=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${a} 8/12/2026, 10:44:11 AM|© ${n} Mach Five Tech`,"night")}),Kl(),u.subscribe("M5T_PRIMARY_NAV",(a,n)=>{const o=a.split(".")[1];switch(o){case"TAP":e(n);break;case"LOGO_TAP":t();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function e(a){const{token:n,level:o,primaryToken:s}=a;switch(n){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),u.publish(g.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${n}`,{primaryToken:s});break}}function t(a){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 8/12/2026, 10:44:11 AM|© ${o} Mach Five Tech`,"night",5e3)}u.subscribe(g.AUTH_SIGNOUT,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(H.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function en(e,t="user",a=null,n=!1){const o=document.getElementById("chat-messages");if(!o){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}if(a||(a=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})),n&&t==="assistant"){const r=o.firstElementChild;if(r&&r.tagName.toLowerCase()==="m5t-chat-response"){r.setAttribute("message",e),console.log(`[AppEvents] Updated streaming ${t} bubble (${e.length} chars)`);return}}let s;t==="user"||t==="prompt"?s=document.createElement("m5t-chat-prompt"):s=document.createElement("m5t-chat-response"),s.setAttribute("message",e),s.setAttribute("timestamp",a),o.prepend(s),console.log(`[AppEvents] Added ${t} bubble to canvas (${e.length} chars)`)}function Ql(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("uid")&&t.get("token"))}function Xl(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("qr")&&t.get("token"))}function Zl(e=window.location.search){const t=new URLSearchParams(e||""),a=t.get("qr"),n=t.get("token");return a&&n?{guid:a,token:n}:null}const ec=Object.freeze([Object.freeze({name:"invite",matches:Ql}),Object.freeze({name:"questionnaire",matches:Xl})]);function Ys(e=window.location.search){return ec.find(t=>t.matches(e))||null}function tc(e=window.location.search){return Ys(e)!==null}const ac=e=>String(e||"").replace(/_route$/,"").replace(/_/g,"-");function nc(e,t=window.location.search){const a=ac(e);return tc(t)&&(a==="splash"||a==="signin")}const oc=Object.freeze({admin_root_role:{value:100,desc:"Administrator superuser infrastructure architecture"},admin_business_role:{value:90,desc:"Administrator financial oversight"},admin_support_role:{value:80,desc:"Administrator maintenance and configuration"},admin_readonly_role:{value:70,desc:"Administrator information help desk"},client_tier_4_role:{value:40,desc:"Client paid tier 4 - Partner"},client_tier_3_role:{value:30,desc:"Client paid tier 3"},client_tier_2_role:{value:20,desc:"Client paid tier 2"},client_tier_1_role:{value:10,desc:"Client paid tier 1"},client_standard_role:{value:0,desc:"Client free tier 0"}});function sc(e){return oc[e]||null}function rc(e){return e>=50}const zt=Object.freeze({owner:{value:"owner",rank:30,label:"Owner"},admin:{value:"admin",rank:20,label:"Admin"},member:{value:"member",rank:10,label:"Member"},viewer:{value:"viewer",rank:0,label:"Viewer"}}),ic=Object.freeze({VIEW_DASHBOARD:"view_dashboard",VIEW_MAGNETS:"view_magnets",PROVISION_MAGNETS:"provision_magnets",MANAGE_MAGNETS:"manage_magnets",VIEW_CONVERSATIONS:"view_conversations",VIEW_STATS:"view_stats",VIEW_AD_METRICS:"view_ad_metrics",CONNECT_AD_ACCOUNTS:"connect_ad_accounts",CREATE_CLIENT_ACCOUNTS:"create_client_accounts",MANAGE_TEAM:"manage_team",VIEW_BILLING:"view_billing",MANAGE_BILLING:"manage_billing"}),$=ic,Ks=Object.freeze(Object.values($)),it=Object.freeze([$.VIEW_DASHBOARD,$.VIEW_MAGNETS,$.VIEW_CONVERSATIONS,$.VIEW_STATS,$.VIEW_AD_METRICS]),lc=Object.freeze({reseller_org:{owner:Ks,admin:[$.VIEW_DASHBOARD,$.VIEW_MAGNETS,$.PROVISION_MAGNETS,$.MANAGE_MAGNETS,$.VIEW_CONVERSATIONS,$.VIEW_STATS,$.VIEW_AD_METRICS,$.CONNECT_AD_ACCOUNTS,$.CREATE_CLIENT_ACCOUNTS,$.MANAGE_TEAM,$.VIEW_BILLING],member:[$.VIEW_DASHBOARD,$.VIEW_MAGNETS,$.PROVISION_MAGNETS,$.MANAGE_MAGNETS,$.VIEW_CONVERSATIONS,$.VIEW_STATS,$.VIEW_AD_METRICS],viewer:it},managed_client:{owner:[...it,$.VIEW_BILLING],admin:[...it,$.VIEW_BILLING],member:it,viewer:it},saas_org:{owner:[$.VIEW_DASHBOARD,$.VIEW_MAGNETS,$.PROVISION_MAGNETS,$.MANAGE_MAGNETS,$.VIEW_CONVERSATIONS,$.VIEW_STATS,$.VIEW_AD_METRICS,$.CONNECT_AD_ACCOUNTS,$.MANAGE_TEAM,$.VIEW_BILLING,$.MANAGE_BILLING],admin:[$.VIEW_DASHBOARD,$.VIEW_MAGNETS,$.PROVISION_MAGNETS,$.MANAGE_MAGNETS,$.VIEW_CONVERSATIONS,$.VIEW_STATS,$.VIEW_AD_METRICS,$.CONNECT_AD_ACCOUNTS,$.MANAGE_TEAM,$.VIEW_BILLING],member:[$.VIEW_DASHBOARD,$.VIEW_MAGNETS,$.PROVISION_MAGNETS,$.MANAGE_MAGNETS,$.VIEW_CONVERSATIONS,$.VIEW_STATS],viewer:it}});function cc(e){const t=sc(e);return!!t&&rc(t.value)}function dc({entityClass:e,orgChannel:t,memberRole:a}={}){if(cc(e))return e==="admin_readonly_role"?[...it,$.VIEW_BILLING]:[...Ks];const n=lc[t],o=n&&n[a];return o?[...o]:[]}function pc(e,t){const a=zt[e]?.rank??-1,n=zt[t]?.rank??1/0;return a>=zt.admin.rank&&a>=n}const Bn=[{value:"name",label:"Full name (splits into first + last automatically)"},{value:"first_name",label:"First name"},{value:"last_name",label:"Last name"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"mobile",label:"Mobile phone"},{value:"company",label:"Company"},{value:"title",label:"Job title"},{value:"city",label:"City"},{value:"state",label:"State / province"},{value:"product_interest",label:"Product interest"},{value:"lead_source",label:"Lead source"},{value:"rating",label:"Rating (Hot / Warm / Cold)"},{value:"description",label:"Notes / description"},{value:"salutation",label:"Salutation (Mr. / Ms. / Dr.)"},{value:"street",label:"Street address"},{value:"zip",label:"Postal / ZIP code"},{value:"country",label:"Country"},{value:"url",label:"Website URL"},{value:"industry",label:"Industry"},{value:"annual_revenue",label:"Annual revenue (number)"},{value:"employees",label:"Number of employees (whole number)"},{value:"is_primary",label:"Primary contact (Yes / No)"},{value:"current_generators",label:"Current generator(s)"},{value:"number_of_locations",label:"Number of locations (whole number)"}];new Set(Bn.map(e=>e.value));const qn=[{value:"single_select",label:"Multiple choice"},{value:"multi_select",label:"Select all"},{value:"scheduler",label:"Scheduler"},{value:"text",label:"Short text"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"message",label:"Message"}];new Set(qn.map(e=>e.value));const uc=[{value:"inline",label:"Inline"},{value:"chat",label:"Chat"},{value:"right_slide",label:"Slide"},{value:"modal",label:"Modal"}],mc=[{value:"auto",label:"Auto"},{value:"light",label:"Light"},{value:"dark",label:"Dark"}],gc=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],hc=[{value:"book",label:"Book"},{value:"call",label:"Call"},{value:"email",label:"Email"},{value:"chat",label:"Chat"},{value:"support",label:"Support"}];uc.map(e=>e.value);mc.map(e=>e.value);gc.map(e=>e.value);hc.map(e=>e.value);class k{static CONFIG={BASE_URL:"https://machfivemagnet-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink",SCOPE:"sse_session_scope",ACTIVE_ORG:"sse_active_org",REMEMBERED_EMAIL:"sse_remembered_email"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",ME:"/m5t/v5/acctEntity/me",PING:"/ping",WEBAUTHN_AUTH_OPTIONS:"/m5t/v5/webauthn/authenticate/options",WEBAUTHN_AUTH_VERIFY:"/m5t/v5/webauthn/authenticate/verify"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#o=null;static#a=null;static#n=null;static#s=null;static#i=null;static async init({BASE_URL:t,navigateFunction:a,customConfig:n={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(a&&typeof a=="function")this.#i=a;else throw new Error("navigateFunction is required and must be a function");return t&&(this.CONFIG.BASE_URL=t),n&&Object.keys(n).length>0&&(this.CONFIG={...this.CONFIG,...n}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#m(),this.#u(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#u(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((t=null)=>{if(t){if(nc(t)){console.log("[AuthController] Ignoring mvvLegit redirect to",t,"— keeping visitor on their public landing page");return}console.log("[AuthController] mvvLegit navigation to:",t),this.#r(t)}}).setOnState((t=null)=>{if(t)switch(console.log("[AuthController] Auth state changed:",t),t){case"AUTH":case 4:this.#_();break;case"UNAUTH":case 1:this.#y();break;case"UNVERF":case 2:this.#w();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#r(t){if(!this.#i){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",t);const a=t.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",a),this.#i(a)}static#l(){if(window.__m5tActiveOrgFetch)return;const t=window.fetch.bind(window);window.fetch=(a,n)=>{try{const o=typeof a=="string"?a:a?.url||"",s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);if(s&&o.startsWith(this.CONFIG.BASE_URL)){const r=new Headers(n&&n.headers||(a instanceof Request?a.headers:void 0));r.set("X-Active-Org",s),n={...n||{},headers:r}}}catch{}return t(a,n)},window.__m5tActiveOrgFetch=!0,console.log("[AuthController] Active-org fetch header installed")}static#m(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);t&&(this.#o=JSON.parse(t),console.log("[AuthController] Entity state loaded; hasEmail:",!!this.#o?.email))}catch(t){console.error("[AuthController] Error loading entity state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#o=null}this.#s=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.SCOPE);t&&(this.#a=JSON.parse(t),console.log("[AuthController] Scope state loaded (cached):",this.#a?.uiMode))}catch(t){console.error("[AuthController] Error loading scope state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE),this.#a=null}}static#c(t){try{this.#o=t,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(t)),console.log("[AuthController] Entity state saved")}catch(a){console.error("[AuthController] Error saving entity state:",a)}}static#d(){this.#o=null,this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}}static getEntity(){return this.#o}static#v(t){try{this.#a=t,localStorage.setItem(this.CONFIG.LS_KEYS.SCOPE,JSON.stringify(t))}catch(a){console.error("[AuthController] Error saving scope state:",a)}}static async fetchScope(){return typeof mvvLegit>"u"||!this.isAuthenticated()?(console.log("[AuthController] fetchScope skipped — not authenticated"),this.#a):this.#n?this.#n:(this.#n=this.#b().finally(()=>{this.#n=null}),this.#n)}static async#b(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),a=t?`?org=${encodeURIComponent(t)}`:"",n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.ME}${a}`);if(n.status===401||n.status===403)return console.warn("[AuthController] /me unauthorized — signing out"),this.doSignout(!0),null;if(!n.ok)return console.warn(`[AuthController] /me failed (${n.status}) — using cached scope`),this.#a;const o=await n.json();if(!o?.ok)return console.warn("[AuthController] /me returned not-ok — using cached scope"),this.#a;try{const s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);s&&o.activeOrg?.guid!==s&&(console.warn(`[AuthController] Stored active org not honored by /me${o.activeOrgError?" (activeOrgError)":""} — clearing`),localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG))}catch{}return this.#v(o),u.publish(g.AUTH_SCOPE_LOADED,o),console.log(`[AuthController] Scope loaded: ${o.uiMode} (${o.memberships?.length||0} org(s), ${o.managedClients?.length||0} client(s))`),o}catch(t){return console.error("[AuthController] fetchScope error:",t),this.#a}}static async setActiveOrg(t){try{t?localStorage.setItem(this.CONFIG.LS_KEYS.ACTIVE_ORG,t):localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}return this.fetchScope()}static getScope(){return this.#a}static getCapabilities(){return this.isPreviewingAsClient()?dc({orgChannel:"managed_client",memberRole:"owner"}):this.#a?.capabilities||[]}static getUiMode(){return this.isPreviewingAsClient()?"managed":this.#a?.uiMode||"self_serve"}static getActiveOrg(){return this.#a?.activeOrg||null}static getMemberships(){return this.#a?.memberships||[]}static getManagedClients(){return this.#a?.managedClients||[]}static getStoredActiveOrg(){try{return localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{return null}}static#p="m5m_preview_as_client";static isPreviewingAsClient(){try{return sessionStorage.getItem(this.#p)==="1"&&!!this.#a?.activeOrg?.viaSubtree}catch{return!1}}static setPreviewAsClient(t){try{t?sessionStorage.setItem(this.#p,"1"):sessionStorage.removeItem(this.#p)}catch{}this.#a&&u.publish(g.AUTH_SCOPE_LOADED,this.#a)}static async doSignin(t,a){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a})}),o=await n.json();if(n.status===303)return console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#c(o.entity)),setTimeout(()=>{this.#r(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o};if(n.ok&&o.accessToken){console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#c(o.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),console.log("[AuthController] Explicitly navigating to home"),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}}return{ok:!1,error:o.error||"Sign in failed",data:o}}catch(n){return console.error("[AuthController] Signin error:",n),{ok:!1,error:n.message}}}static async doPasskeySignin(){if(!window.PublicKeyCredential)return{ok:!1,error:"Passkeys are not supported in this browser"};try{const{startAuthentication:t}=await V(async()=>{const{startAuthentication:i}=await Promise.resolve().then(()=>ir);return{startAuthentication:i}},void 0,import.meta.url),a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_OPTIONS}`,{method:"POST"}),n=await a.json();if(!a.ok||!n.ok)return{ok:!1,error:n.error||"Could not start passkey sign-in"};let o;try{o=await t({optionsJSON:n.options})}catch(i){const l=i?.name==="NotAllowedError";return l||console.error("[AuthController] Passkey ceremony error:",i),{ok:!1,canceled:l,error:l?"Passkey sign-in was canceled":i.message||"Passkey sign-in failed"}}const s=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_VERIFY}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o})}),r=await s.json();if(!s.ok||!r.ok||!r.accessToken)return{ok:!1,error:r.error||"Passkey sign-in failed",data:r};mvvLegit.doSignin(r.accessToken),this.#c(r.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:r}}catch(t){return console.error("[AuthController] Passkey signin error:",t),{ok:!1,error:t.message}}}static async doSignout(t=!1){console.log("[AuthController] doSignout called, serverInitiated:",t);try{const a=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!a),!t&&a){const n=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(a)}`;if(console.log("[AuthController] Sending signout beacon to:",n),navigator.sendBeacon){const o=navigator.sendBeacon(n);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else a||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#d(),console.log("[AuthController] Stopping auth ping..."),this.#h(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(a){console.error("[AuthController] Signout error:",a),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(t){try{const a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await a.json();return a.ok&&n.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#c(n.entity),{ok:!0,data:n}):{ok:!1,error:n.error||"Sign up failed",data:n}}catch(a){return console.error("[AuthController] Signup error:",a),{ok:!1,error:a.message}}}static async doResetHash(t,a){try{const n=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a,modified_by:t})}),s=await o.json();return o.ok&&s.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:s}):{ok:!1,error:s.error||"Password reset failed",data:s}}catch(n){return console.error("[AuthController] Reset password error:",n),{ok:!1,error:n.message}}}static#g(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#f()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#h(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#f(){try{const t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);t.ok?console.log("[AuthController] Ping success"):(t.status===401||t.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(t){console.error("[AuthController] Ping error:",t)}}static setDeepLinkGuid(t){this.#s=t,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,t),console.log("[AuthController] Deep-link GUID stored:",t)}static getDeepLinkGuid(){return this.#s}static clearDeepLink(){this.#s=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#_(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),queueMicrotask(()=>this.fetchScope())}static#y(){console.log("[AuthController] User unauthenticated"),this.#h()}static#w(){console.log("[AuthController] User unverified")}static getAuthState(){try{const t=mvvLegit.getConf()?.LSKEY||"mvv",a=localStorage.getItem(t);if(!a)return"UNAUTH";if(typeof LZString>"u")return null;const n=LZString.decompressFromUTF16(a),s=JSON.parse(n)?.state;return s===1?"UNAUTH":s===2?"UNVERF":s===4?"AUTH":s===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(t){this.#r(t)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#f()}}class L{static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",remember_email:"Remember my email",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_dashboard:"Dashboard",nav_dashboard_tagline:"Overview of your activity",nav_magnets:"Your Magnets",nav_magnets_tagline:"Manage your conversational magnets",nav_templates:"Templates",nav_templates_tagline:"Start from a magnet template",nav_conversations:"Conversations",nav_conversations_tagline:"Captured lead conversations",nav_ab_testing:"A/B Testing",nav_ab_testing_tagline:"Experiment and optimize",nav_analytics:"Analytics",nav_analytics_tagline:"Performance and ad metrics",nav_ad_accounts:"Ad Accounts",nav_ad_accounts_tagline:"Connect advertising accounts",nav_clients:"Clients",nav_clients_tagline:"Manage your client accounts",nav_team:"Team",nav_team_tagline:"Invite and manage teammates",nav_billing:"Billing",nav_billing_tagline:"Plan, usage, and invoices",nav_settings:"Settings",nav_settings_tagline:"Account and workspace settings",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Rollers",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",remember_email:"Recordar mi correo electrónico",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Rollers",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",remember_email:"记住我的邮箱",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"滚动器",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:t,product:a,whitelabel:n,lang:o}){t&&(this.#t.buildMode=t),a&&(this.#t.product=a),n&&(this.#t.whitelabel=n),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{let l=this.#e[o]?.[s]?.[r]?.[i]?.[t],c=o;return!l&&o!=="LOCAL"&&(l=this.#e.LOCAL?.[s]?.[r]?.[i]?.[t],c="LOCAL (fallback)"),l?(c==="LOCAL (fallback)"&&console.warn(`[MicrocopyManager] Token '${t}' missing from ${o} — served from LOCAL instead. Backfill ${o}'s block if this is intentionally different copy.`),Array.isArray(l)?l[Math.floor(Math.random()*l.length)]:l):(console.warn(`[MicrocopyManager] Token not found: ${t} (${o}/${s}/${r}/${i}, LOCAL fallback also missing it)`),null)}catch(l){return console.error(`[MicrocopyManager] Error retrieving token: ${t}`,l),null}}static getAll(t={}){const a={...this.#t,...t},{buildMode:n,product:o,whitelabel:s,lang:r}=a;try{return this.#e[n]?.[o]?.[s]?.[r]||null}catch(i){return console.error("[MicrocopyManager] Error retrieving all tokens",i),null}}static has(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return!!this.#e[o]?.[s]?.[r]?.[i]?.[t]}catch{return!1}}static getAvailableLanguages(){const{buildMode:t,product:a,whitelabel:n}=this.#t;try{return Object.keys(this.#e[t]?.[a]?.[n]||{})}catch{return[]}}static update(t,a,n={}){const o={...this.#t,...n},{buildMode:s,product:r,whitelabel:i,lang:l}=o;try{return this.#e[s]||(this.#e[s]={}),this.#e[s][r]||(this.#e[s][r]={}),this.#e[s][r][i]||(this.#e[s][r][i]={}),this.#e[s][r][i][l]||(this.#e[s][r][i][l]={}),this.#e[s][r][i][l][t]=a,!0}catch(c){return console.error(`[MicrocopyManager] Error updating token: ${t}`,c),!1}}static delete(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return delete this.#e[o]?.[s]?.[r]?.[i]?.[t],!0}catch(l){return console.error(`[MicrocopyManager] Error deleting token: ${t}`,l),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(t){try{return this.#e=t,!0}catch(a){return console.error("[MicrocopyManager] Error importing data",a),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:L});class Ce{static#e=!1;static#t=null;static#o=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const t=this.#n();L.setContext(t),console.log("[I18nController] Initialized with context:",t),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#s(),this.#u(),this.#e=!0,this.refresh()}static#a(t){const a={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},n=t.toLowerCase();return a[n]||"DEV"}static#n(){const a=this.#a("production"),n=localStorage.getItem(H.FF_SSE_LS_WHITELABEL)||H.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(H.FF_SSE_LS_USER_LANG)||H.FF_SSE_I18N_LANG;return{buildMode:a,product:H.FF_SSE_I18N_PRODUCT,whitelabel:n,lang:o}}static#s(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((t,a,n)=>{H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",n),this.#t=n,setTimeout(()=>{this.refresh()},H.FF_SSE_I18N_APPLY_DELAY_MS)},H.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#i())}static#i(){setInterval(()=>{const a=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");a&&a!==this.#t&&(this.#t=a,this.refresh())},500)}static#u(){this.#o||(this.#o=new MutationObserver(t=>{let a=!1;for(const n of t){for(const o of n.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){a=!0;break}if(a)break}a&&(H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#o.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#r(document.body),this.#l(document.body),H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#r(t){const a=t.querySelectorAll("[data-meta-copywrite-i118n]");H.FF_SSE_I18N_DEBUG&&a.length>0&&console.log(`[I18nController] Processing ${a.length} elements`),a.forEach(n=>{try{const o=n.getAttribute("data-meta-copywrite-i118n"),s=JSON.parse(o);if(!s.token){console.warn("[I18nController] Missing token in config:",s);return}const r=s.attribute||"textContent",i=L.get(s.token);if(i===null){console.warn(`[I18nController] Microcopy not found for token: ${s.token}`);return}r==="textContent"?n.textContent=i:r==="innerHTML"?n.innerHTML=i:n.setAttribute(r,i),H.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${i}" to ${r} for token: ${s.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,n)}})}static#l(t){t.querySelectorAll("*").forEach(n=>{n.shadowRoot&&(this.#r(n.shadowRoot),this.#l(n.shadowRoot))})}static setLanguage(t){const a=L.getAvailableLanguages();if(!a.includes(t)){console.error(`[I18nController] Language not available: ${t}. Available:`,a);return}localStorage.setItem(H.FF_SSE_LS_USER_LANG,t),L.setContext({lang:t}),console.log("[I18nController] Language changed to:",t);const n=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:t}});document.dispatchEvent(n),this.refresh()}static setWhitelabel(t){localStorage.setItem(H.FF_SSE_LS_WHITELABEL,t),L.setContext({whitelabel:t}),H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",t),this.refresh()}static getLanguage(){return L.getContext().lang}static getAvailableLanguages(){return L.getAvailableLanguages()}static getContext(){return L.getContext()}static destroy(){this.#o&&(this.#o.disconnect(),this.#o=null),this.#e=!1,this.#t=null,H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{Ce.initialize()}):Ce.initialize());class Un{static _initialized=!1;static _debug=!1;static init(t={}){if(this._initialized)return console.warn("[MachVive] Already initialized, skipping duplicate initialization"),this;if(this._debug=t.debug||!1,!window.mvvSSEther)return console.error("[MachVive] mvvSSEther not found - cannot initialize bridge"),console.error("[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()"),this;console.log("[MachVive] Initializing SSE to PubSub bridge...");const a=n=>{this._handleSSEMessage(n)};return window.mvvSSEther.onmessage(a),this._initialized=!0,console.log("[MachVive] ✓ SSE to PubSub bridge initialized successfully"),console.log("[MachVive] ✓ Bound callback to mvvSSEther.onmessage"),this}static _handleSSEMessage(t){try{this._debug&&console.log("[MachVive] SSE message received:",t);const a=t?.data;if(!a){this._debug&&console.log("[MachVive] No data in message, skipping");return}const n=a.data||a.package||a;if(!n){this._debug&&console.log("[MachVive] No package found in message, skipping");return}let o=n.cfg;const s=n.msg;if(this._debug&&(console.log("[MachVive] cfg (raw):",o,"type:",typeof o,"length:",o?.length),console.log("[MachVive] msg (raw):",s)),typeof o=="string"){if(o.trim()===""){this._debug&&console.log("[MachVive] cfg is empty string, skipping");return}try{o=JSON.parse(o),console.log("[MachVive] cfg (parsed):",o)}catch(i){console.warn("[MachVive] Failed to parse cfg as JSON:",{cfg:o,cfgLength:o.length,error:i.message});return}}else if(!o){this._debug&&console.log("[MachVive] cfg is empty/null, skipping");return}const r=o?.topic;if(!r){this._debug&&console.log("[MachVive] No topic found in cfg, skipping");return}if(console.log("[MachVive] Extracted topic:",r),!this._isValidTopic(r)){console.warn(`[MachVive] Topic '${r}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(r,s,t,a)}catch(a){console.error("[MachVive] Error handling SSE message:",a)}}static _isValidTopic(t){return!g||!g.hasOwnProperty(t)?(console.warn(`[MachVive] Topic '${t}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(t,a,n,o){try{if(!window.PubSub&&typeof PubSub>"u"){console.error("[MachVive] PubSub not available");return}const s=window.PubSub||PubSub,r={message:a,metadata:{source:"sse",sseEventId:n.id,timestamp:n.timestamp,appGuid:o.app_guid,channelGuid:o.channel_guid,eventAction:o.event_action,status:o.status,class:o.class,raw:o}};console.log(`[MachVive] Publishing to topic '${t}':`,r);const i=g[t];console.log(`[MachVive] AppBroadcast.${t} = '${i}'`),s.publish(i,r),console.log(`[MachVive] ✓ Published SSE message to topic: ${t}`)}catch(s){console.error(`[MachVive] Error publishing to topic '${t}':`,s)}}static debug(t){return this._debug=t,console.log(`[MachVive] Debug mode ${t?"enabled":"disabled"}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log("[MachVive] Reset complete"),this}}typeof module<"u"&&module.exports&&(module.exports=Un);typeof window<"u"&&(window.MachVive=Un);const _o="m5t_sidenav_collapsed",fc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};class vc extends HTMLElement{static get observedAttributes(){return["data-active-token","data-collapsed"]}constructor(){super(),this.attachShadow({mode:"open"}),this.items=[],this.orgs=[],this.activeOrgGuid=null,this.activeToken=null,this.footerBadge=null,this.loading=!1,this.lastFocus=null}#e=null;#t=t=>{if(this.getAttribute("data-open")==="true"){if(t.key==="Escape"){t.preventDefault(),this.closeDrawer();return}if(t.key==="Tab"){const a=this.#c();if(a.length<2)return;const n=a[0],o=a[a.length-1],s=this.shadowRoot.activeElement;t.shiftKey&&s===n?(t.preventDefault(),o.focus()):!t.shiftKey&&s===o&&(t.preventDefault(),n.focus())}}};#o=()=>{this.closeDrawer(),this.#d()};connectedCallback(){if(!this.hasAttribute("data-collapsed"))try{localStorage.getItem(_o)==="true"&&this.setAttribute("data-collapsed","true")}catch{}this.activeToken=this.getAttribute("data-active-token")||null,this.render(),this.#l(),this.addEventListener("keydown",this.#t),this.#e=window.matchMedia("(max-width: 768px)"),this.#e.addEventListener("change",this.#o),this.#d()}disconnectedCallback(){this.removeEventListener("keydown",this.#t),this.#e?.removeEventListener("change",this.#o)}attributeChangedCallback(t,a,n){a===n||!this.shadowRoot||(t==="data-active-token"?(this.activeToken=n,this.#m()):t==="data-collapsed"&&this.shadowRoot.firstChild&&(this.render(),this.#l()))}setState({buttons:t,orgs:a,activeOrg:n,footerBadge:o,loading:s}={}){t!==void 0&&(this.items=Array.isArray(t)?t:this.#a(t)||[]),a!==void 0&&(this.orgs=Array.isArray(a)?a:this.#a(a)||[]),n!==void 0&&(this.activeOrgGuid=n||null),o!==void 0&&(this.footerBadge=o||null),s!==void 0&&(this.loading=!!s),this.shadowRoot&&(this.render(),this.#l())}setButtons(t){this.setState({buttons:t})}setOrgs(t){this.setState({orgs:t})}setActiveOrgGuid(t){this.setState({activeOrg:t})}setFooterBadge(t){this.setState({footerBadge:t})}setActiveToken(t){this.activeToken=t||null,this.#m()}toggleCollapsed(t){const a=typeof t=="boolean"?t:this.getAttribute("data-collapsed")!=="true";this.setAttribute("data-collapsed",String(a));try{localStorage.setItem(_o,String(a))}catch{}this.dispatchEvent(new CustomEvent("nav-collapse",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_SIDE_NAV.COLLAPSE",collapsed:a,timestamp:Date.now()}}))}openDrawer(){this.lastFocus=this.shadowRoot.activeElement||document.activeElement,this.setAttribute("data-open","true"),this.shadowRoot.querySelector(".hamburger")?.setAttribute("aria-expanded","true"),this.#d(),(this.#c()[0]||this.shadowRoot.querySelector(".sidenav"))?.focus?.()}closeDrawer(){if(this.getAttribute("data-open")!=="true")return;this.removeAttribute("data-open");const t=this.shadowRoot.querySelector(".hamburger");t?.setAttribute("aria-expanded","false"),this.#d(),t&&this.#e?.matches?t.focus():this.lastFocus?.focus?.()}toggleDrawer(){this.getAttribute("data-open")==="true"?this.closeDrawer():this.openDrawer()}#a(t){try{return t?JSON.parse(t):null}catch(a){return console.error("[M5TSideNav] bad JSON:",a),null}}#n(t){return String(t??"").replace(/[&<>"']/g,a=>fc[a])}#s(t){return t?`<span class="ms" aria-hidden="true">${this.#n(t)}</span>`:""}#i(t){if(!t||!t.token)return"";const a=t.token===this.activeToken,n=t.route||"#",o=n.startsWith("#")?n:`#${n}`,s=typeof t.count=="number"&&t.count>0?`<span class="badge">${t.count}</span>`:"";return`
  ...
  </div>`}const Ec='<div class="m5t-notif-skel"><span></span><span></span><span></span></div>'.repeat(3),tn=e=>e.dataset.open==="true",hn=(e,t)=>{e.dataset.open=t?"true":"false"};function kc(e){const t=document.getElementById("m5t-notif-bell");if(t&&(t.hidden=!e),!e){const a=document.getElementById("m5t-notif-panel");a&&hn(a,!1)}}const Ac=14;let an=null,nn=null;function Sc(e){if(typeof ResizeObserver>"u"||!e)return;const t=document.getElementById("m5t-notif-bell"),a=document.getElementById("m5t-notif-bell-btn");if(!t||!a)return;const n=()=>{const o=e.hidden?null:e.querySelector(".ocb-btn");if(!o){t.style.top=`${Ac}px`;return}const s=a.getBoundingClientRect().height;if(!s)return;const r=o.getBoundingClientRect();t.style.top=`${Math.round(r.top+(r.height-s)/2)}px`};an?.disconnect(),an=new ResizeObserver(n),an.observe(e),nn?.disconnect(),nn=new MutationObserver(n),nn.observe(t,{attributes:!0,attributeFilter:["hidden"]}),n()}let yo=null,oa=null,sa=null;function Cc(){const e=document.getElementById("m5t-notif-bell-btn"),t=document.getElementById("m5t-notif-badge"),a=document.getElementById("m5t-notif-panel");if(!e||!t||!a)return;const n=m=>{t.textContent=m>99?"99+":String(m),t.hidden=!m},o=async()=>{try{const m=await fetch(`${kt()}/m5t/v5/notifications/unread-count`),p=await m.json().catch(()=>({}));m.ok&&p.ok&&n(p.count||0)}catch{}},s=50,r=m=>{if(m.length>=s){o();return}n(m.filter(p=>!p.read).length)},i=(m="")=>`<div class="m5t-notif-head">Notifications${m?`<span class="m5t-notif-head__actions">${m}</span>`:""}</div>`,l=()=>{a.querySelectorAll(".m5t-notif-item, .m5t-notif-empty").forEach(m=>m.remove()),a.querySelector(".m5t-notif-head__actions")?.remove(),a.insertAdjacentHTML("beforeend",'<div class="m5t-notif-empty">You’re all caught up.</div>')},c=async()=>{a.innerHTML=i()+Ec;try{const m=await fetch(`${kt()}/m5t/v5/notifications`),p=await m.json().catch(()=>({}));if(!m.ok||!p.ok)throw new Error;const f=p.notifications||[],d=[f.some(b=>!b.read)?'<button class="m5t-notif-markall" type="button">Mark all read</button>':"",f.length?'<button class="m5t-notif-clearall" type="button">Clear all</button>':""].join("");a.innerHTML=i(d)+(f.length?f.map(xc).join(""):'<div class="m5t-notif-empty">You’re all caught up.</div>'),r(f)}catch{a.innerHTML=i()+'<div class="m5t-notif-empty">Could not load. Try again.</div>'}},h=()=>{hn(a,!1),e.setAttribute("aria-expanded","false")},v=async()=>{hn(a,!0),e.setAttribute("aria-expanded","true"),await c()};e.addEventListener("click",m=>{m.stopPropagation(),tn(a)?h():v()}),sa&&document.removeEventListener("visibilitychange",sa),sa=()=>{document.visibilityState==="visible"&&o()},document.addEventListener("visibilitychange",sa),oa&&document.removeEventListener("click",oa),oa=m=>{tn(a)&&!a.contains(m.target)&&m.target!==e&&h()},document.addEventListener("click",oa),document.addEventListener("keydown",m=>{m.key==="Escape"&&tn(a)&&(h(),e.focus())}),a.addEventListener("click",async m=>{const p=m.target.closest("[data-dismiss]");if(p){m.preventDefault(),m.stopPropagation();const _=p.closest(".m5t-notif-item"),y=p.dataset.dismiss,x=_?.dataset.read==="false";_?.setAttribute("data-leaving","true");try{await fetch(`${kt()}/m5t/v5/notifications/${encodeURIComponent(y)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:"DISMISSED"})})}catch{}setTimeout(()=>{_?.remove(),a.querySelector(".m5t-notif-item")||l()},180),x&&o();return}const f=m.target.closest(".m5t-notif-clearall");if(f){m.preventDefault(),f.disabled=!0,a.querySelectorAll(".m5t-notif-item").forEach(_=>_.setAttribute("data-leaving","true"));try{await fetch(`${kt()}/m5t/v5/notifications/dismiss-all`,{method:"PATCH"})}catch{}setTimeout(l,180),o();return}const d=m.target.closest(".m5t-notif-item");if(d&&d.dataset.read==="false"){const _=d.dataset.guid;d.dataset.read="true";try{await fetch(`${kt()}/m5t/v5/notifications/${encodeURIComponent(_)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({read:!0})}),o()}catch{}return}const b=m.target.closest(".m5t-notif-markall");if(b){m.preventDefault(),a.querySelectorAll(".m5t-notif-item").forEach(_=>{_.dataset.read="true"}),b.remove();try{await fetch(`${kt()}/m5t/v5/notifications/read-all`,{method:"PATCH"})}catch{}o()}}),o(),clearInterval(yo),yo=setInterval(o,yc)}function Da(){return Dn("FF_SSE_UI_DARK_MODE")}function Tc(e=Da()){return e&&localStorage.getItem(H.FF_SSE_LS_THEME)==="dark"?"dark":"light"}function $c(e=Dn("FF_SSE_UI_ANIMATIONS")){return!e}function Lc(e,t=Da()){!e||t||e.shadowRoot?.querySelector('.footer-action[data-action="theme"]')?.remove()}function Js(e){document.documentElement.setAttribute("data-theme",e)}function Ic(){Js(Tc())}function Yt(){return document.documentElement.getAttribute("data-theme")==="dark"?"dark":"light"}function Qs(e,{quiet:t=!1}={}){if(!Da())return;const a=e==="dark"?"dark":"light";a!==Yt()&&(Js(a),localStorage.setItem(H.FF_SSE_LS_THEME,a),t||u.publish(g.UI_TOAST,{message:a==="dark"?"Dark mode on":"Dark mode off",type:"info"}),u.publish(g.UI_THEME_CHANGED,{theme:a}))}function Rc(){Qs(Yt()==="dark"?"light":"dark")}window.m5t=Object.create(null);window.m5t.pubsub=u;console.log("StreamSyncEngage SaaS Client - Starting...");console.log("Environment:","production");console.log("Document readyState:",document.readyState);console.log("window.mvvLegit:",typeof window.mvvLegit);console.log("globalThis.mvvLegit:",typeof globalThis.mvvLegit);try{console.log("mvvLegit (direct):",typeof mvvLegit)}catch(e){console.log("mvvLegit (direct): ReferenceError -",e.message)}const Nc=Object.keys(window).filter(e=>e.toLowerCase().includes("mvv")||e.toLowerCase().includes("neodigm")||e.toLowerCase().includes("legit"));console.log("Possible Neodigm globals:",Nc);const O=new Dl("/",{hash:!0});window.router=O;function se(e){const t=e?`${e.replace(/-/g,"_")}_route`:"splash_route";return console.log(`[Router] Checking access: ${e} -> ${t}`),mvvLegit.isRouteAllowed(t)?!0:(console.warn(`[Router] Access denied to route: ${t}`),u.publish(g.UI_TOAST,{message:"Please sign in to access this page",type:"warning"}),!1)}function X(e){console.log("[Router] Navigating to:",e),O.navigate(`/${e}`)}const zn=new Set(["splash","signin","signup","forgot","resethash","verf-link","accept-invite","signout"]);let Ht={},fn={},ft=null;const Oc={admin:{caption:"Platform Admin",icon:"shield_person"},reseller:{caption:"Reseller",icon:"handshake"},managed:{caption:"Managed",icon:"visibility"},self_serve:{caption:"Self-Serve",icon:"rocket_launch"}},vn="__portfolio__";function Xs(){try{O._setCurrent(null)}catch{}O.resolve()}function on(){const e=document.getElementById("m5t-side-nav");if(!e)return;const t=!k.getScope()&&k.isAuthenticated(),a=k.getCapabilities(),n=k.getUiMode(),o=Fa.getSideNav(a,{uiMode:n});Ht={},fn={};const s=m=>{m.route&&(Ht[m.route]={sectionToken:m.token,childToken:null,children:m.children||null},Array.isArray(m.children)&&m.children.forEach(p=>{p.route&&(fn[p.token]=p.route,Ht[p.route]={sectionToken:m.token,childToken:p.token,children:m.children})}))},r=m=>m.forEach(p=>{p.group&&Array.isArray(p.items)?r(p.items):s(p)});r(o);const i=k.getMemberships(),l=k.getActiveOrg(),c=k.getManagedClients(),h=k.getStoredActiveOrg(),v=c.length?[{guid:vn,name:"Portfolio (all clients)"},...i.map(m=>({guid:m.orgGuid,name:m.name||m.channel,channel:m.channel,group:"Your organization"})),...c.map(m=>({guid:m.orgGuid,name:m.name||m.orgGuid,channel:m.channel,group:"Clients"}))]:i.map(m=>({guid:m.orgGuid,name:m.name||m.channel,channel:m.channel}));e.setState({buttons:o,orgs:v,activeOrg:c.length?h||vn:l?.guid||null,footerBadge:Oc[n]||null,loading:t}),Zs(),ft&&er(ft)}const Mc=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]);function Zs(){const e=document.getElementById("app-content");if(!e)return;let t=document.getElementById("org-context-banner");t||(t=document.createElement("div"),t.id="org-context-banner",e.insertBefore(t,e.firstChild),Sc(t));const a=k.getActiveOrg(),n=k.isPreviewingAsClient(),o=!!a?.viaSubtree&&!!ft&&!zn.has(ft);if(t.hidden=!o,!o){t.innerHTML="";return}const s=Mc(a.name||"Client");t.innerHTML=`
    <style>
    ...
    </div>`,t.querySelector('[data-ocb="preview"]')?.addEventListener("click",()=>{k.setPreviewAsClient(!k.isPreviewingAsClient()),Xs()}),t.querySelector('[data-ocb="portfolio"]')?.addEventListener("click",()=>{k.setPreviewAsClient(!1),k.setActiveOrg(null)})}function er(e){const t=document.getElementById("m5t-side-nav"),a=Ht[`/${e}`]||Ht[e]||null;t?.setActiveToken(a?.sectionToken||null),Pc(a)}function Pc(e){const t=document.getElementById("m5t-sub-nav"),a=document.getElementById("app-shell");if(!t)return;const n=e?.children;t.hidden=!1,n&&n.length>1?(t.updateButtons(n.map(o=>({token:o.token,caption:o.caption,enabled:!0,selected:o.token===e.childToken}))),a?.classList.add("has-sub-nav")):(t.updateButtons([]),a?.classList.remove("has-sub-nav"))}function Fc(){const e=Ce.getAvailableLanguages&&Ce.getAvailableLanguages()||[];if(e.length<2){u.publish(g.UI_TOAST,{message:"Only one language is available",type:"info"});return}const t=localStorage.getItem(H.FF_SSE_LS_USER_LANG)||H.FF_SSE_I18N_LANG||e[0],a=e[(e.indexOf(t)+1)%e.length];Ce.setLanguage(a),u.publish(g.UI_TOAST,{message:`Language: ${a}`,type:"info"})}function Dc(){document.documentElement.classList.toggle("ff-no-animations",$c())}function Bc(){const e=document.getElementById("m5t-side-nav");if(!e)return;Fa.setAppToken("client-saas"),Lc(e),document.getElementById("app-shell")?.classList.toggle("nav-collapsed",e.getAttribute("data-collapsed")==="true"),e.addEventListener("nav-select",o=>{const s=o.detail?.route;s&&O.navigate(s.startsWith("/")?s:`/${s}`)}),e.addEventListener("logo-click",()=>O.navigate("/home")),e.addEventListener("nav-collapse",o=>{document.getElementById("app-shell")?.classList.toggle("nav-collapsed",!!o.detail?.collapsed)}),e.addEventListener("org-switch",o=>{const s=o.detail?.orgGuid;s&&k.setActiveOrg(s===vn?null:s)}),e.addEventListener("footer-action",o=>{switch(o.detail?.action){case"account":O.navigate("/settings");break;case"signout":O.navigate("/signout");break;case"lang":Fc();break;case"theme":Rc();break}}),document.getElementById("m5t-sub-nav")?.addEventListener("nav-select",o=>{const s=fn[o.detail?.token];s&&O.navigate(s)}),document.addEventListener("language-changed",()=>on()),on(),u.subscribe(g.AUTH_SCOPE_LOADED,()=>on());const a=()=>{const o=k.getScope();return[o?.uiMode,o?.activeOrg?.guid,(o?.managedClients||[]).length,(o?.capabilities||[]).join(","),k.getStoredActiveOrg()].join("|")};let n=a();u.subscribe(g.AUTH_SCOPE_LOADED,()=>{const o=a();o!==n&&(n=o,ft&&!zn.has(ft)&&Xs())})}function qc(e){ft=e;const t=document.getElementById("m5t-side-nav"),a=document.getElementById("app-shell");if(!t||!a)return;const n=!zn.has(e);if(t.hidden=!n,a.classList.toggle("has-side-nav",n),kc(n),n)er(e);else{const o=document.getElementById("m5t-sub-nav");o&&(o.hidden=!0),a.classList.remove("has-sub-nav")}Zs()}u.subscribe(g.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&qc(t.route)});const tr=()=>{console.log("[Router] Route: splash"),u.publish(g.ROUTE_NAV_BEFORE,{route:"splash"});const e=Ys()?.name;(e==="invite"?V(()=>Promise.resolve().then(()=>Zc),void 0,import.meta.url):e==="questionnaire"?V(()=>Promise.resolve().then(()=>od),void 0,import.meta.url):V(()=>Promise.resolve().then(()=>id),void 0,import.meta.url)).then(a=>{const n=document.getElementById("app");n.innerHTML=a.render(),a.init&&a.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"splash"})}).catch(a=>{console.error("[Router] Error loading splash route:",a),u.publish(g.ROUTE_NAV_ERROR,{route:"splash",error:a})})};O.on("/",tr);O.on("/splash",tr);O.on("/signin",()=>{console.log("[Router] Route: /signin"),u.publish(g.ROUTE_NAV_BEFORE,{route:"signin"}),V(()=>Promise.resolve().then(()=>gd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"signin"})}).catch(e=>{console.error("[Router] Error loading signin route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"signin",error:e})})});O.on("/signup",()=>{console.log("[Router] Route: /signup"),u.publish(g.ROUTE_NAV_BEFORE,{route:"signup"}),V(()=>Promise.resolve().then(()=>yd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"signup"})}).catch(e=>{console.error("[Router] Error loading signup route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"signup",error:e})})});O.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),u.publish(g.ROUTE_NAV_BEFORE,{route:"verf-link"}),V(()=>Promise.resolve().then(()=>Ed),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(e=>{console.error("[Router] Error loading verf-link route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"verf-link",error:e})})});O.on("/forgot",()=>{console.log("[Router] Route: /forgot"),u.publish(g.ROUTE_NAV_BEFORE,{route:"forgot"}),V(()=>Promise.resolve().then(()=>Ld),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(e=>{console.error("[Router] Error loading forgot route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"forgot",error:e})})});O.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!se("resethash")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"resethash"}),V(()=>Promise.resolve().then(()=>Nd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(e=>{console.error("[Router] Error loading resethash route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"resethash",error:e})})});O.on("/home",()=>{if(console.log("[Router] Route: /home"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"home"}),V(()=>Promise.resolve().then(()=>Yd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"home"})}).catch(e=>{console.error("[Router] Error loading home route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"home",error:e})})});O.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!se("signout")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"signout"}),V(()=>Promise.resolve().then(()=>Qd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"signout"})}).catch(e=>{console.error("[Router] Error loading signout route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"signout",error:e})})});const Uc=[{path:"/ad-accounts",name:"ad-accounts",title:"Ad Accounts",icon:"ads_click"},{path:"/billing",name:"billing",title:"Billing",icon:"receipt_long"},{path:"/magnets/drafts",name:"magnets/drafts",title:"Magnets · Drafts",icon:"widgets"},{path:"/magnets/archived",name:"magnets/archived",title:"Magnets · Archived",icon:"widgets"},{path:"/analytics/conversions",name:"analytics/conversions",title:"Analytics · Conversions",icon:"monitoring"}];Uc.forEach(({path:e,name:t,title:a,icon:n})=>{O.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:t}),V(()=>Promise.resolve().then(()=>ep),void 0,import.meta.url).then(o=>{const s=document.getElementById("app");s.innerHTML=o.render({title:a,icon:n,name:t}),o.init&&o.init({name:t}),u.publish(g.ROUTE_NAV_AFTER,{route:t})}).catch(o=>{console.error(`[Router] Error loading section route (${t}):`,o),u.publish(g.ROUTE_NAV_ERROR,{route:t,error:o})})})});O.on("/settings",()=>{if(console.log("[Router] Route: /settings"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"settings"}),V(()=>Promise.resolve().then(()=>up),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"settings"})}).catch(e=>{console.error("[Router] Error loading settings-general route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"settings",error:e})})});O.on("/settings/workspace",()=>{if(console.log("[Router] Route: /settings/workspace"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"settings/workspace"}),V(()=>Promise.resolve().then(()=>Ap),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"settings/workspace"})}).catch(e=>{console.error("[Router] Error loading settings-workspace route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"settings/workspace",error:e})})});O.on("/settings/notifications",()=>{if(console.log("[Router] Route: /settings/notifications"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"settings/notifications"}),V(()=>Promise.resolve().then(()=>Np),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"settings/notifications"})}).catch(e=>{console.error("[Router] Error loading settings-notifications route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"settings/notifications",error:e})})});O.on("/settings/integrations",()=>{if(console.log("[Router] Route: /settings/integrations"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),V(()=>Promise.resolve().then(()=>nu),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(e=>{console.error("[Router] Error loading settings-integrations route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"settings/integrations",error:e})})});O.on("/settings/integrations/:provider",e=>{const t=e?.data?.provider||"";if(console.log("[Router] Route: /settings/integrations/"+t),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),V(()=>Promise.resolve().then(()=>fu),void 0,import.meta.url).then(a=>{const n=document.getElementById("app");n.innerHTML=a.render({provider:t}),a.init&&a.init({provider:t}),u.publish(g.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(a=>{console.error("[Router] Error loading integration detail route:",a),u.publish(g.ROUTE_NAV_ERROR,{route:"settings/integrations",error:a})})});O.on("/settings/security",()=>{if(console.log("[Router] Route: /settings/security"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"settings/security"}),V(()=>Promise.resolve().then(()=>Cu),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"settings/security"})}).catch(e=>{console.error("[Router] Error loading settings-security route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"settings/security",error:e})})});O.on("/conversations",()=>{if(console.log("[Router] Route: /conversations"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"conversations"}),V(()=>Promise.resolve().then(()=>Fu),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"conversations"})}).catch(e=>{console.error("[Router] Error loading conversations route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"conversations",error:e})})});O.on("/ab-testing",()=>{if(console.log("[Router] Route: /ab-testing"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"ab-testing"}),V(()=>Promise.resolve().then(()=>Qu),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"ab-testing"})}).catch(e=>{console.error("[Router] Error loading ab-testing route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"ab-testing",error:e})})});O.on("/magnets",()=>{if(console.log("[Router] Route: /magnets"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"magnets"}),V(()=>Promise.resolve().then(()=>ng),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"magnets"})}).catch(e=>{console.error("[Router] Error loading magnets route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"magnets",error:e})})});O.on("/templates",()=>{if(console.log("[Router] Route: /templates"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"templates"}),V(()=>Promise.resolve().then(()=>dg),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"templates"})}).catch(e=>{console.error("[Router] Error loading templates route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"templates",error:e})})});O.on("/questionnaires",()=>{if(console.log("[Router] Route: /questionnaires"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"questionnaires"}),V(()=>Promise.resolve().then(()=>wg),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"questionnaires"})}).catch(e=>{console.error("[Router] Error loading questionnaires route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"questionnaires",error:e})})});O.on("/leads",()=>{if(console.log("[Router] Route: /leads"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"leads"}),V(()=>Promise.resolve().then(()=>Fg),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"leads"})}).catch(e=>{console.error("[Router] Error loading leads route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"leads",error:e})})});O.on("/analytics",()=>{if(console.log("[Router] Route: /analytics"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"analytics"}),V(()=>Promise.resolve().then(()=>jg),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"analytics"})}).catch(e=>{console.error("[Router] Error loading analytics route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"analytics",error:e})})});O.on("/analytics/ad-performance",()=>{if(console.log("[Router] Route: /analytics/ad-performance"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"analytics/ad-performance"}),V(()=>Promise.resolve().then(()=>Zg),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"analytics/ad-performance"})}).catch(e=>{console.error("[Router] Error loading ad-performance route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"analytics/ad-performance",error:e})})});O.on("/ad-accounts",()=>{if(console.log("[Router] Route: /ad-accounts"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"ad-accounts"}),V(()=>Promise.resolve().then(()=>mh),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"ad-accounts"})}).catch(e=>{console.error("[Router] Error loading ad-accounts route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"ad-accounts",error:e})})});O.on("/clients",()=>{if(console.log("[Router] Route: /clients"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"clients"}),V(()=>Promise.resolve().then(()=>Ah),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"clients"})}).catch(e=>{console.error("[Router] Error loading clients route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"clients",error:e})})});O.on("/team",()=>{if(console.log("[Router] Route: /team"),!se("home")){X("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"team"}),V(()=>Promise.resolve().then(()=>Oh),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"team"})}).catch(e=>{console.error("[Router] Error loading team route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"team",error:e})})});O.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),X("splash")});u.subscribe(g.ROUTE_NAV,(e,t)=>{console.log("[Router] ROUTE_NAV event received:",t),t?.route&&X(t.route)});function wo(){console.log("[App] Waiting for Neodigm 55 library...");let e=0;const t=100,a=setInterval(()=>{e++,e%10===0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(a),zc()):e>=t&&(clearInterval(a),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
...
`,t)}function rr(){if(!ta())return ga.stubThis(new Promise(t=>t(!1)));const e=globalThis.PublicKeyCredential;return e?.isConditionalMediationAvailable===void 0?ga.stubThis(new Promise(t=>t(!1))):ga.stubThis(e.isConditionalMediationAvailable())}const ga={stubThis:e=>e};function Wc({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new ce({message:"Authentication ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else{if(e.name==="NotAllowedError")return new ce({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if(or(n)){if(a.rpId!==n)return new ce({message:`The RP ID "${a.rpId}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new ce({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="UnknownError")return new ce({message:"The authenticator was unable to process the specified options, or could not create a new assertion signature",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}async function Yc(e){!e.optionsJSON&&e.challenge&&(console.warn("startAuthentication() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useBrowserAutofill:a=!1,verifyBrowserAutofillInput:n=!0}=e;if(!ta())throw new Error("WebAuthn is not supported in this browser");let o;t.allowCredentials?.length!==0&&(o=t.allowCredentials?.map(nr));const s={...t,challenge:Kt(t.challenge),allowCredentials:o},r={};if(a){if(!await rr())throw Error("Browser does not support WebAuthn autofill");if(document.querySelectorAll("input[autocomplete$='webauthn']").length<1&&n)throw Error('No <input> with "webauthn" as the only or last value in its `autocomplete` attribute was detected');r.mediation="conditional",s.allowCredentials=[]}r.publicKey=s,r.signal=Hn.createNewAbortSignal();let i;try{i=await navigator.credentials.get(r)}catch(p){throw Wc({error:p,options:r})}if(!i)throw new Error("Authentication was not completed");const{id:l,rawId:c,response:h,type:v}=i;let m;return h.userHandle&&(m=Re(h.userHandle)),{id:l,rawId:Re(c),response:{authenticatorData:Re(h.authenticatorData),clientDataJSON:Re(h.clientDataJSON),signature:Re(h.signature),userHandle:m},type:v,clientExtensionResults:i.getClientExtensionResults(),authenticatorAttachment:sr(i.authenticatorAttachment)}}function Kc(){return ta()?PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable():new Promise(e=>e(!1))}const ir=Object.freeze(Object.defineProperty({__proto__:null,WebAuthnAbortService:Hn,WebAuthnError:ce,_browserSupportsWebAuthnAutofillInternals:ga,_browserSupportsWebAuthnInternals:ar,base64URLStringToBuffer:Kt,browserSupportsWebAuthn:ta,browserSupportsWebAuthnAutofill:rr,bufferToBase64URLString:Re,platformAuthenticatorIsAvailable:Kc,startAuthentication:Yc,startRegistration:Vc},Symbol.toStringTag,{value:"Module"}));let xo=!1;function Jc(){if(xo)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),xo=!0}function Qc(){const e=new URLSearchParams(window.location.search||"");let t=e.get("uid")||"",a=e.get("token")||"";if(!t||!a){const n=window.location.hash||"",o=n.includes("?")?n.slice(n.indexOf("?")+1):"",s=new URLSearchParams(o);if(t=t||s.get("uid")||"",a=a||s.get("token")||"",!t||!a){const r=n.replace(/^#\/?/,"").split("?")[0].split("/").filter(Boolean);t=t||r[1]||"",a=a||r[2]||""}}try{return{uid:decodeURIComponent(t),token:decodeURIComponent(a)}}catch{return{uid:t,token:a}}}function lr(){return Jc(),`
    ...
    </div>`}function cr(){const{uid:e,token:t}=Qc(),a=document.getElementById("accept-invite-form"),n=document.getElementById("ai-pass"),o=document.getElementById("ai-confirm"),s=document.getElementById("ai-submit"),r=document.getElementById("ai-msg");if(!a)return;const i=(l,c="error")=>{r.textContent=l,r.className=`accept-invite-msg ${c}`};if(!e||!t){i("This invitation link is invalid or incomplete. Please use the link from your email."),s.disabled=!0;return}a.addEventListener("submit",async l=>{l.preventDefault();const c=n.value||"",h=o.value||"";if(c.length<8){i("Password must be at least 8 characters.");return}if(c!==h){i("Passwords do not match.");return}s.disabled=!0,i("Setting up your account…","ok");try{const v=k.getConfig?.().BASE_URL||"",m=await fetch(`${v}/m5t/v5/acctEntity/acceptInvite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({uid:e,token:t,password:c})}),p=await m.json().catch(()=>({}));if(!m.ok||!p.ok){const d=m.status===410?"This invitation has expired. Ask for a new one.":m.status===409?"This invitation has already been used. Try signing in.":p.error||`Could not accept the invitation (HTTP ${m.status}).`;i(d),s.disabled=!1;return}try{window.history.replaceState({},"",window.location.pathname+window.location.hash)}catch{}i("Welcome! Signing you in…","ok"),(await k.doSignin(p.entity.email,c))?.ok||(i("Your account is ready. Please sign in.","ok"),setTimeout(()=>{window.location.hash="#/signin"},1200))}catch(v){console.error("[accept-invite] error:",v),i("Something went wrong. Please try again."),s.disabled=!1}})}const Xc={render:lr,init:cr},Zc=Object.freeze(Object.defineProperty({__proto__:null,default:Xc,init:cr,render:lr},Symbol.toStringTag,{value:"Module"})),ed=""+new URL("auth-hero-sketch.jpg",import.meta.url).href;let Eo=!1;function td(){if(Eo)return;const e=document.createElement("style");e.id="m5t-questionnaire-fill-styles",e.textContent=`
    .qf-page {
      min-height: 100vh; padding: 32px 20px 64px; position: relative;
      background: var(--color-surface, #F4F7FB); color: var(--color-text, #0B1220);
      color-scheme: light; font-family: var(--font-body, 'Inter', system-ui, sans-serif);
    }
    /* The marketing hero sketch behind the card - the page is light-ground,
       exactly the ground the sketch was drawn on, so it needs no blending:
       just a whisper of opacity. fixed = it holds still while the form scrolls. */
    .qf-page::before {
  ...
  `,document.head.appendChild(e),Eo=!0}function ko(){return k.getConfig?.().BASE_URL||""}function ad(e){const t=`qf-${e.id}`;if(e.type==="checkbox_group"){const a=Array.isArray(e.options)?e.options:[];return`
    ...
    </div>`}function Fe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Bt(e,t,a){return`
    <div class="qf-page"><div class="qf-card"><div class="qf-state">
      <span class="material-symbols-outlined">${e}</span>
      <h1>${Fe(t)}</h1>
      <p class="qf-sub">${Fe(a)}</p>
    </div></div></div>`}function dr(){return td(),`<div id="qf-root">${Bt("hourglass_top","Loading your questionnaire…","One moment.")}</div>`}async function pr(){const e=document.getElementById("qf-root");if(!e)return;const t=Zl();if(!t){e.innerHTML=Bt("error","Invalid link","This link is missing required information. Please use the link exactly as sent.");return}let a;try{const _=await fetch(`${ko()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(t.guid)}?token=${encodeURIComponent(t.token)}`),y=await _.json().catch(()=>({}));if(!_.ok||!y.ok){const x=_.status===404?y.error||"This link is invalid or has expired.":"Something went wrong loading your questionnaire. Please try again shortly.";e.innerHTML=Bt("error","Cannot open this questionnaire",x);return}a=y.data}catch(_){console.error("[questionnaire-fill] load error:",_),e.innerHTML=Bt("wifi_off","Connection problem","Could not reach the server. Please check your connection and try again.");return}const n=a.questionnaire?.sections||[],o=a.answers||{};e.innerHTML=`
    <div class="qf-page"><div class="qf-card">
      ...
      <div class="qf-progress">
        ...
        <div class="qf-dots" role="group" aria-label="Sections">
          ${n.map((_,y)=>`<button type="button" class="qf-dot" data-step="${y}" aria-label="${Fe(_.title)}"></button>`).join("")}
        </div>
      </div>
    ...
    </div></div>`;const s=[...e.querySelectorAll(".qf-section[data-step]")],r=[...e.querySelectorAll(".qf-dot")],i=document.getElementById("qf-back"),l=document.getElementById("qf-next"),c=document.getElementById("qf-submit"),h=document.getElementById("qf-progress-label");let v=0;function m(_,y=1){v=Math.max(0,Math.min(n.length-1,_)),s.forEach((T,N)=>{T.hidden=N!==v,T.classList.remove("qf-enter")});const x=s[v];x&&(x.style.setProperty("--qf-dx",`${y>=0?14:-14}px`),x.offsetWidth,x.classList.add("qf-enter")),r.forEach((T,N)=>{N===v?T.setAttribute("aria-current","step"):T.removeAttribute("aria-current")}),h&&(h.textContent=`Section ${v+1} of ${n.length}`),i.style.visibility=v===0?"hidden":"",l.style.display=v===n.length-1?"none":"",c.style.display=v===n.length-1?"":"none",e.querySelector(".qf-card")?.scrollIntoView({block:"start"})}i.addEventListener("click",()=>m(v-1,-1)),l.addEventListener("click",()=>m(v+1,1)),r.forEach(_=>_.addEventListener("click",()=>{const y=Number(_.dataset.step)||0;m(y,y>=v?1:-1)})),m(0),e.querySelectorAll("[data-question-id]").forEach(_=>{const y=_.dataset.questionId,x=_.dataset.questionType,T=o[y];if(T!=null)if(x==="checkbox_group"){const N=Array.isArray(T)?T:[];_.querySelectorAll('input[type="checkbox"]').forEach(q=>{q.checked=N.includes(q.value)})}else{const N=_.querySelector("input,textarea");N&&(N.value=T)}});const p=document.getElementById("qf-form"),f=document.getElementById("qf-submit"),d=document.getElementById("qf-msg"),b=(_,y="error")=>{d.textContent=_,d.className=`qf-msg ${y}`};p.addEventListener("submit",async _=>{_.preventDefault();const y={};e.querySelectorAll("[data-question-id]").forEach(x=>{const T=x.dataset.questionId;if(x.dataset.questionType==="checkbox_group"){const q=[...x.querySelectorAll('input[type="checkbox"]:checked')].map(ue=>ue.value);q.length&&(y[T]=q)}else{const q=(x.querySelector("input,textarea")?.value||"").trim();q&&(y[T]=q)}}),f.disabled=!0,b("Submitting…","ok");try{const x=await fetch(`${ko()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(t.guid)}/submit?token=${encodeURIComponent(t.token)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({answers:y})}),T=await x.json().catch(()=>({}));if(!x.ok||!T.ok){const N=x.status===409?"This questionnaire has already been submitted.":x.status===404?"This link is invalid or has expired.":T.error||`Could not submit (HTTP ${x.status}).`;b(N),f.disabled=!1;return}e.innerHTML=Bt("check_circle","Thank you!","Your answers have been submitted. Your account manager will be in touch.")}catch(x){console.error("[questionnaire-fill] submit error:",x),b("Something went wrong. Please try again."),f.disabled=!1}})}const nd={render:dr,init:pr},od=Object.freeze(Object.defineProperty({__proto__:null,default:nd,init:pr,render:dr},Symbol.toStringTag,{value:"Module"}));function sd(){return`
  ...
  `}function rd(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const e=localStorage.getItem(H.FF_SSE_LS_TOKEN),t=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!e,hasMvvTs:!!t});const a=document.getElementById("splash-loader"),n=document.getElementById("splash-actions");e?(console.log("[SplashRoute] Auth token found → HOME"),u.publish(g.ROUTE_NAV,{route:"home"})):t?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),u.publish(g.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),a&&(a.style.display="none"),n&&(n.style.display="flex"),document.querySelectorAll("[data-route]").forEach(s=>{s.addEventListener("click",()=>{const r=s.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${r}`),u.publish(g.ROUTE_NAV,{route:r})})}))},4e3)}const id=Object.freeze(Object.defineProperty({__proto__:null,init:rd,render:sd},Symbol.toStringTag,{value:"Module"}));function ge(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}const ld=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;function jn(e,t){return e?ld.test(e)?!0:(ge(t,L.get("validation_email_invalid")),!1):(ge(t,L.get("validation_email_required")),!1)}function cd(){return`
  ...
  `}function dd(){console.log("[SigninRoute] Initialized");const e=document.getElementById("loginForm"),t=document.getElementById("email"),a=document.getElementById("password"),n=document.getElementById("togglePassword"),o=document.getElementById("rememberEmail"),s=localStorage.getItem(k.CONFIG.LS_KEYS.REMEMBERED_EMAIL);s&&t&&o&&(t.value=s,o.checked=!0,a?.focus()),n?.addEventListener("click",()=>{const h=a.type==="password"?"text":"password";a.type=h});const r=document.getElementById("passkeySigninBtn"),i=document.getElementById("passkeyDivider"),l=document.getElementById("passkeyHint");window.PublicKeyCredential&&r&&i&&(r.style.display="",i.style.display="",l&&(l.style.display=""),r.addEventListener("click",()=>md())),e?.addEventListener("submit",async h=>{h.preventDefault();const v=t.value.trim(),m=a.value;jn(v,t)&&pd(m,a)&&(o?.checked?localStorage.setItem(k.CONFIG.LS_KEYS.REMEMBERED_EMAIL,v):localStorage.removeItem(k.CONFIG.LS_KEYS.REMEMBERED_EMAIL),await ud(v,m))}),document.getElementById("link--uc__underline")?.addEventListener("click",h=>{h.preventDefault(),u.publish(g.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",h=>{h.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),u.publish(g.ROUTE_NAV,{route:"signup"})})}function pd(e,t){return e?e.length<10?(ge(t,L.get("validation_password_min_length")),!1):!0:(ge(t,L.get("validation_password_required")),!1)}async function ud(e,t){const a=document.querySelector(".btn");a.disabled=!0,a.textContent=L.get("loading_signing_in");try{const n=await k.doSignin(e,t);n.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(L.get("success_welcome_back"),"success"),u.publish(g.AUTH_SIGNIN_SUCCESS,{entity:k.getEntity()})):n.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q(L.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(n.error||L.get("error_signin_failed"),"danger"),a.disabled=!1,a.textContent=(L.get("sign_in")||"Sign in").toUpperCase())}catch(n){console.error("[SigninRoute] Sign in error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||L.get("error_network"),"danger"),a.disabled=!1,a.textContent=(L.get("sign_in")||"Sign in").toUpperCase(),u.publish(g.AUTH_SIGNIN_FAIL,{message:n.message})}}async function md(){const e=document.getElementById("passkeySigninBtn");e.disabled=!0;try{const t=await k.doPasskeySignin();t.ok?(console.log("[SigninRoute] Passkey signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(L.get("success_welcome_back"),"success"),u.publish(g.AUTH_SIGNIN_SUCCESS,{entity:k.getEntity()})):t.canceled||typeof neodigmToast<"u"&&neodigmToast.q(t.error||L.get("error_signin_failed"),"danger")}catch(t){console.error("[SigninRoute] Passkey signin error:",t),typeof neodigmToast<"u"&&neodigmToast.q(t.message||L.get("error_network"),"danger")}finally{e.disabled=!1}}const gd=Object.freeze(Object.defineProperty({__proto__:null,init:dd,render:cd},Symbol.toStringTag,{value:"Module"}));function Gn(e){const t=[];return e.length<12&&t.push("at least 12 characters"),e.length>1024&&t.push("at most 1024 characters"),/[a-z]/.test(e)||t.push("1 lowercase"),/[A-Z]/.test(e)||t.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(e)||t.push("1 special character"),/[^\x00-\x7F]/.test(e)&&t.push("ASCII characters only"),t}function ur(e){if(e.length===0)return"";if(e.includes("ASCII characters only"))return"Password cannot contain emoji|or special unicode characters";const t=e.find(a=>/^at (?:least|most) \d+ characters$/.test(a));return t?`Password must have ${t.replace(/ (\d+ characters)$/,"|$1")}`:"Password must have: Uppercase,|Lowercase, and Special Character"}const hd="2026-07-15";function fd(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function vd(){console.log("[SignupRoute] Initialized");const e=document.getElementById("signupForm"),t=e.querySelector('button[type="submit"]');Ao("togglePassword","password","eyeIcon"),Ao("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),u.publish(g.ROUTE_NAV,{route:"signin"})}),e.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),s=document.getElementById("last").value.trim(),r=document.getElementById("email").value.trim(),i=document.getElementById("company").value.trim(),l=document.getElementById("phone").value.trim(),c=document.getElementById("password").value,h=document.getElementById("confirmPassword").value,v=document.getElementById("first"),m=document.getElementById("last"),p=document.getElementById("email"),f=document.getElementById("password"),d=document.getElementById("confirmPassword");if(!So(o,v,L.get("validation_first_name_required"))||!So(s,m,L.get("validation_last_name_required"))||!jn(r,p)||!bd(c,f))return;if(c!==h){ge(d,L.get("validation_password_mismatch"));return}const b=document.getElementById("acceptTerms");if(!b.checked){ge(b,"Please accept the Terms of Service and Privacy Policy to continue.");return}t.disabled=!0,t.textContent=L.get("loading_creating_account"),await _d(o,s,r,i,l,c)})}function Ao(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function So(e,t,a){return e?!0:(ge(t,a),!1)}function bd(e,t){if(!e)return ge(t,L.get("validation_password_required")),!1;const a=Gn(e);return a.length>0?(ge(t,ur(a)),!1):!0}async function _d(e,t,a,n,o,s){const r=document.querySelector('button[type="submit"]');try{const i={email:a,password:s,first:e,last:t};n&&(i.company=n),o&&(i.phone=o),i.terms_accepted=!0,i.legal_version=hd;const l=await k.doSignup(i);if(l.ok)u.publish(g.AUTH_SIGNUP_SUCCESS,{email:a}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const c=l.error||l.message||L.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(c,"danger"),r.disabled=!1,r.textContent=(L.get("create_account")||"Create account").toUpperCase(),u.publish(g.AUTH_SIGNUP_FAIL,{message:c})}}catch(i){console.error("[SignupRoute] Sign up error:",i),typeof neodigmToast<"u"&&neodigmToast.q(i.message||L.get("error_network"),"danger"),r.disabled=!1,r.textContent=(L.get("create_account")||"Create account").toUpperCase(),u.publish(g.AUTH_SIGNUP_FAIL,{message:i.message})}}const yd=Object.freeze(Object.defineProperty({__proto__:null,init:vd,render:fd},Symbol.toStringTag,{value:"Module"}));function wd(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function xd(){console.log("[VerfLinkRoute] Initialized");const e=7200,t=Date.now(),a=document.getElementById("countdown-display");function n(){const s=Date.now()-t,r=Math.floor(s/1e3),i=Math.max(0,e-r),l=Math.floor(i/3600),c=Math.floor(i%3600/60),h=i%60,v=`${String(l).padStart(2,"0")}:${String(c).padStart(2,"0")}:${String(h).padStart(2,"0")}`;a&&(a.textContent=v,i<600&&(a.style.color="#ef4444",a.style.textShadow=`
          0 0 10px rgba(239, 68, 68, 0.9),
          0 0 20px rgba(239, 68, 68, 0.7),
          0 0 30px rgba(239, 68, 68, 0.5)
        `),i===0&&(a.style.color="#7f1d1d",a.style.textShadow="none")),i===0&&(clearInterval(o),console.log("[VerfLinkRoute] Countdown expired"),window.neodigmWired4Sound&&window.neodigmWired4Sound.sound(14),setTimeout(()=>{window.router&&window.router.navigate("/splash")},600))}n();const o=setInterval(n,1e3);window.addEventListener("beforeunload",()=>{clearInterval(o)})}const Ed=Object.freeze(Object.defineProperty({__proto__:null,init:xd,render:wd},Symbol.toStringTag,{value:"Module"})),kd="https://machfivemagnet-saas.onrender.com";class Ad{constructor(){this.baseUrl=kd}async request(t,a={}){const n=`${this.baseUrl}${t}`,o={"Content-Type":"application/json",...a.headers};try{const s=await fetch(n,{...a,headers:o});if(s.status===401||s.status===403){u.publish(g.AUTH_TOKEN_EXPIRED,{status:s.status,endpoint:t});const i=await s.json().catch(()=>({}));throw new Error(i.error||"Authentication failed")}const r=await s.json();return{ok:s.ok,status:s.status,data:r}}catch(s){throw console.error("API Request Error:",s),u.publish(g.APP_ERROR,{message:s.message,endpoint:t}),s}}async get(t){return this.request(t,{method:"GET"})}async post(t,a){return this.request(t,{method:"POST",body:JSON.stringify(a)})}async put(t,a){return this.request(t,{method:"PUT",body:JSON.stringify(a)})}async delete(t){return this.request(t,{method:"DELETE"})}async signin(t,a){return this.post("/api/acctEntity/signin",{email:t,hash:a})}async signup(t){return this.post("/api/acctEntity/signup",t)}async signout(){return this.post("/api/acctEntity/signout",{})}async forgotPassword(t){return this.get(`/m5t/v5/acctEntity/forgot?CODE=${encodeURIComponent(t)}`)}async resetHash(t,a){return this.post("/api/acctEntity/resethash",{email:t,hash:a})}async verifyAccount(t){return this.get(`/api/acctEntity/verify?CODE=${t}`)}async getAccounts(){return this.get("/api/acctEntity")}async getAccount(t){return this.get(`/api/acctEntity/${t}`)}async updateAccount(t,a){return this.put(`/api/acctEntity/${t}`,a)}async deleteAccount(t){return this.delete(`/api/acctEntity/${t}`)}async ping(){return this.get("/ping")}}const Sd=new Ad;function Cd(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function Td(){console.log("[ForgotRoute] Initialized");const e=document.getElementById("forgot-form"),t=document.getElementById("email");e?.addEventListener("submit",async a=>{a.preventDefault();const n=t.value.trim();jn(n,t)&&await $d(n)})}async function $d(e){const t=document.querySelector(".btn");t.disabled=!0,t.textContent="SENDING...";try{const a=await Sd.forgotPassword(e);a.ok&&a.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q(L.get("success_reset_link_sent"),"success"),u.publish(g.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(a.data.error||L.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=(L.get("send_reset_link")||"Send reset link").toUpperCase())}catch(a){console.error("[ForgotRoute] Forgot password error:",a),typeof neodigmToast<"u"&&neodigmToast.q(a.message||L.get("error_network"),"danger"),t.disabled=!1,t.textContent=(L.get("send_reset_link")||"Send reset link").toUpperCase()}}const Ld=Object.freeze(Object.defineProperty({__proto__:null,init:Td,render:Cd},Symbol.toStringTag,{value:"Module"}));function Id(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function Rd(){console.log("[ResethashRoute] Initialized");const e=document.getElementById("resethash-form"),t=e.querySelector('button[type="submit"]');Co("toggleNewPassword","new-password","eyeIconNew"),Co("toggleConfirmPassword","confirm-password","eyeIconConfirm"),e?.addEventListener("submit",async a=>{a.preventDefault();const n=e.email.value.trim(),o=e.newPassword.value,s=e.confirmPassword.value,r=document.getElementById("new-password"),i=document.getElementById("confirm-password");if(!o){ge(r,L.get("validation_new_password_required"));return}const l=Gn(o);if(l.length>0){ge(r,ur(l));return}if(!s){ge(i,L.get("validation_new_password_required"));return}if(o!==s){ge(i,L.get("validation_password_mismatch"));return}t.disabled=!0,t.textContent=L.get("loading_resetting_password");try{const c=await k.doResetHash(n,o);c.ok?(typeof neodigmToast<"u"&&neodigmToast.q(L.get("success_password_reset"),"success"),u.publish(g.AUTH_RESETHASH_SUCCESS,{email:n})):(ge(r,c.error||L.get("error_signin_failed")),t.disabled=!1,t.textContent=(L.get("update_password")||"Update password").toUpperCase())}catch(c){console.error("[ResethashRoute] Reset password error:",c),ge(r,c.message||L.get("error_network")),t.disabled=!1,t.textContent=(L.get("update_password")||"Update password").toUpperCase()}})}function Co(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}const Nd=Object.freeze(Object.defineProperty({__proto__:null,init:Rd,render:Id},Symbol.toStringTag,{value:"Module"})),ae=()=>k.getManagedClients().length>0&&!k.getStoredActiveOrg(),Je=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),Od={reseller_org:"Your org",managed_client:"Client",saas_org:"Org"};let To=!1;function yt(){if(To)return;const e=document.createElement("style");e.id="m5t-portfolio-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),To=!0}const $o=e=>e.toISOString().slice(0,10);async function Md(e,{days:t=30}={}){const a=new Date,n=$o(new Date(a.getTime()-(t-1)*864e5)),o=$o(a),s=await fetch(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${o}&group_by=owner`);if(!s.ok)throw new Error(`HTTP ${s.status}`);const r=await s.json();if(!r.ok)throw new Error("stats not ok");return r.by_owner||[]}function mr(e,t){return`<div class="dash-clients-scroll"><table class="dash-clients">
    ...
    </div>`}async function tt(e,t,{emptyMsg:a}={}){const n=document.getElementById("pf-picker-body");if(n)try{const o=await Md(e);if(!o.length){n.innerHTML=bn("groups",a||"No client orgs yet. Create one under Clients first.");return}n.innerHTML=mr(o,t),gr(n)}catch(o){console.warn("[portfolio] picker load failed:",o),n.innerHTML=bn("error","Could not load your clients. Please refresh.")}}function hr(){const e={};return k.getManagedClients().forEach(t=>{e[t.orgGuid]=t.name}),k.getMemberships().forEach(t=>{t.orgGuid&&!e[t.orgGuid]&&(e[t.orgGuid]=t.name||"")}),e}const fr=e=>e?`<span class="pf-client-chip">${Je(e)}</span>`:"",vt=Object.freeze({MAGNET_TEMPLATE:"magnet_template",LEADS_SEARCH:"leads_search",LEADS_DAY:"leads_day"}),Ct=new Map;function Vn(e,t){Ct.set(e,t)}function _n(e){if(!Ct.has(e))return null;const t=Ct.get(e);return Ct.delete(e),t}function Fd(e){return Ct.has(e)?Ct.get(e):null}const _e=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,me=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),Q=e=>Number(e||0).toLocaleString(),vr=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",Dd=e=>(vr(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function Bd(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric"})}catch{return""}}function qd(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}let Lo=!1;function Ud(){if(Lo)return;const e=document.createElement("style");e.id="m5t-dash-recent-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Lo=!0}function zd(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${me(Dd(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${me(vr(e))}</span>
      <span class="recent-lead__sub">${me(e.email||e.phone||"")}</span>
    </span>
    <span class="m5t-badge recent-lead__badge" data-s="${me(e.status)}">${me(e.status)}</span>
    <span class="recent-lead__time">${me(Bd(e))}</span>
  </a>`}const qt=({icon:e,label:t,valueId:a,value:n="—",subId:o,sub:s="",href:r,trendId:i})=>{const l=r?"a":"div",c=r?` href="${me(r)}" class="stat-card stat-card--link"`:' class="stat-card"';return`
  <${l}${c}>
  ...
  <div class="dashboard-card${n?" chart-card-wide":""}${o?" chart-card-full":""}">
  ...
  </div>`;let yn=30;function br(){Ud(),yt();const e=ae();return`
    ...
    </div>`}async function _r(){const e=k.getConfig?.().BASE_URL||"";document.getElementById("dash-periods")?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(yn=Number(a.dataset.days)||30,document.querySelectorAll("#dash-periods .chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===yn)),Ro(e))}),document.getElementById("dash-campaigns")?.addEventListener("click",t=>{const a=t.target.closest("[data-campaign]");a&&Vn(vt.LEADS_SEARCH,a.dataset.campaign)}),await Promise.all([Ro(e),Vd(e)])}const Oe=(e,t)=>{const a=document.getElementById(e);a&&(a.textContent=t)},At=(e,t)=>{const a=document.getElementById(e);a&&(a.innerHTML=t)},Io=e=>e.toISOString().slice(0,10),Hd=()=>typeof window.matchMedia=="function"?window.matchMedia("(hover: hover)").matches:!0;async function Ro(e){const t=new Date,a=Io(new Date(t.getTime()-(yn-1)*864e5)),n=Io(t),o=ae();let s;try{const x=await fetch(`${e}/m5t/v5/dashboard/stats?from=${a}&to=${n}${o?"&group_by=owner":""}`);if(!x.ok)throw new Error(`HTTP ${x.status}`);if(s=await x.json(),!s.ok)throw new Error("stats not ok")}catch(y){console.warn("[dashboard] stats fetch failed:",y),["stat-active-magnets","stat-opens","stat-leads","stat-completion"].forEach(T=>Oe(T,"—")),["stat-active-magnets-sub","stat-opens-sub","stat-leads-sub","stat-completion-sub"].forEach(T=>Oe(T,"Unavailable"));const x=document.getElementById("stat-leads-trend");x&&(x.className="stat-trend",x.innerHTML=""),["dash-trend","dash-funnel","dash-campaigns","dash-routes","dash-interactions","dash-portfolio"].forEach(T=>At(T,_e("error","Could not load. Please refresh.")));return}o&&jd(s.by_owner||[]),Oe("stat-active-magnets",Q(s.magnets.active)),Oe("stat-active-magnets-sub",s.magnets.total>s.magnets.active?`${Q(s.magnets.total-s.magnets.active)} paused`:s.magnets.active?"All running":"No magnets yet");const r=s.funnel||{};Oe("stat-opens",r.opens?Q(r.opens):"—"),Oe("stat-opens-sub",r.opens?r.engagement_rate!=null?`${r.engagement_rate}% engage`:`${Q(r.engaged)} engaged`:"No opens in this range yet");const i=s.leads||{};Oe("stat-leads",Q(i.total));const l=(i.this_week||0)-(i.prev_week||0);Oe("stat-leads-sub",i.total?`${Q(i.this_week)} this week`:"No leads yet");const c=document.getElementById("stat-leads-trend");if(c)if((i.prev_week||0)>0){const y=l>0?"positive":l<0?"negative":"neutral",x=l>0?"trending_up":l<0?"trending_down":"trending_flat";c.className=`stat-trend ${y}`,c.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">${x}</span>${l>0?"+":""}${Q(l)}`}else c.className="stat-trend",c.innerHTML="";Oe("stat-completion",r.completion_rate!=null?`${r.completion_rate}%`:"—"),Oe("stat-completion-sub",r.opens?`${Q(r.completions)} completed of ${Q(r.opens)} opens`:"Appears once magnets get opened");const h=s.by_day||[],v=h.some(y=>y.opens||y.leads);At("dash-trend",v?yr(h):_e("show_chart","No activity in this range yet. Opens and leads chart here as visitors engage your magnets.")),v&&wr(h),At("dash-funnel",r.opens?Gd(r):_e("filter_alt","The funnel fills in once your magnets record opens."));const m=s.top_campaigns||[];At("dash-campaigns",m.length?`<div class="dash-list">${m.map(y=>`
        <a class="dash-list__row dash-list__row--link" href="#/leads" data-campaign="${me(y.campaign)}" title="Show the leads from ${me(y.campaign)}">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">campaign</span></span>
          <span class="dash-list__main">${me(y.campaign)}</span>
          <span class="dash-list__num">${Q(y.leads)}</span>
          <span class="dash-list__go material-symbols-outlined" aria-hidden="true">chevron_right</span>
        </a>`).join("")}</div>`:_e("source","No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here."));const p={book:["event","Book"],chat:["chat","Chat"],call:["phone_in_talk","Call"],email:["mail","Email"],support:["support_agent","Support"]},f=Object.entries(r.routes||{}).sort((y,x)=>x[1]-y[1]),d=f.length?f[0][1]:0;At("dash-routes",f.length?`<div class="dash-funnel">${f.map(([y,x])=>{const[T,N]=p[y]||["touch_app",y];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${T}</span> ${me(N)}</span><span class="dash-funnel__val">${Q(x)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${d?Math.max(4,Math.round(x/d*100)):0}%"></div></div>
        </div>`}).join("")}</div>`:_e("touch_app","CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar."));const b={open:["visibility","Magnet opened"],engage:["touch_app","Visitor engaged"],route:["alt_route","Picked a channel"],complete:["check_circle","Completed: lead captured"]},_=s.recent_events||[];At("dash-interactions",_.length?`<div class="dash-list">${_.map(y=>{const[x,T]=b[y.event]||["sensors",y.event],N=y.event==="route"&&y.detail?` · ${me(y.detail)}`:"";return`<div class="dash-list__row">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">${x}</span></span>
          <span class="dash-list__main">${T}${N}</span>
          ${y.display_mode?`<span class="dash-list__mode">${me(y.display_mode)}</span>`:""}
          <span class="dash-list__time">${me(qd(y.at))}</span>
        </div>`}).join("")}</div>`:_e("sensors","No interactions yet. They'll stream in as visitors engage your magnets."))}function jd(e){const t=document.getElementById("dash-portfolio");if(!t)return;if(!e.length){t.innerHTML=_e("groups","No client orgs yet. Create one under Clients to see its numbers here.");return}const a=e.some(s=>s.ad),n=s=>{const r=(s.leads.this_week||0)-(s.leads.prev_week||0);return!s.leads.this_week&&!s.leads.prev_week?"":` <span class="${r>=0?"dc-delta-up":"dc-delta-down"}">(${r>=0?"+":""}${Q(r)})</span>`},o=[{h:"Magnets",td:s=>`${Q(s.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${Q(s.magnets.total)}</span>`},{h:"Leads · wk",td:s=>`${Q(s.leads.this_week)}${n(s)}`},{h:"Leads · total",td:s=>Q(s.leads.total)},{h:"Opens",td:s=>Q(s.opens)},{h:"Compl.",td:s=>s.completion_rate!=null?`${s.completion_rate}%`:"—"},...e.some(s=>s.ab_tests?.running||s.ab_tests?.completed)?[{h:"A/B",td:s=>s.ab_tests?.running?`${Q(s.ab_tests.running)} <span class="dc-sub">running</span>`:s.ab_tests?.completed?`${Q(s.ab_tests.completed)} <span class="dc-sub">done</span>`:"—"}]:[],...e.some(s=>s.booked)?[{h:"Booked",td:s=>s.booked?Q(s.booked):"—"}]:[],...e.some(s=>s.called)?[{h:"Called",td:s=>s.called?Q(s.called):"—"}]:[],...a?[{h:"Spend",td:s=>s.ad?`$${Q(s.ad.spend)}`:"—"},{h:"CPL",td:s=>s.ad?.cost_per_lead!=null?`$${Q(s.ad.cost_per_lead)}`:"—"}]:[]];t.innerHTML=mr(e,o),gr(t)}function Gd(e){const t=[["Opened",e.opens,""],["Engaged",e.engaged," dash-funnel__bar--mid"],["Completed",e.completions," dash-funnel__bar--end"],...e.booked?[["Booked",e.booked," dash-funnel__bar--end"]]:[],...e.called?[["Called",e.called," dash-funnel__bar--end"]]:[]],a=Math.max(1,e.opens||0),n=o=>Math.min(100,Math.round((o||0)/a*100));return`<div class="dash-funnel">${t.map(([o,s,r])=>`
    ...
    </div>`).join("")}</div>`}async function Vd(e){const t=document.getElementById("recent-leads-body");if(t)try{const a=await fetch(`${e}/m5t/v5/m5mLead`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json(),o=(Array.isArray(n?.data)?n.data:[]).filter(s=>!["DELETED","ARCHIVED"].includes(s.status));t.innerHTML=o.length?o.slice(0,5).map(zd).join(""):_e("contacts","No leads captured yet. Publish a magnet to start collecting.")}catch(a){console.warn("[dashboard] Leads fetch failed:",a),t.innerHTML=_e("error","Could not load recent leads.")}}function No(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}const Oo=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e));function yr(e){const p=e.length||1,f=No(Math.max(1,...e.map(z=>z.opens||0))),d=No(Math.max(1,...e.map(z=>z.leads||0))),b=748/p,_=Math.min(22,b*.55),y=z=>46+b*(z+.5),x=z=>266-z/f*248,T=z=>266-z/d*248,N=[0,.5,1].map(z=>{const K=266-z*248;return`<line x1="46" y1="${K.toFixed(1)}" x2="794" y2="${K.toFixed(1)}" class="dash-grid"/><text x="38" y="${(K+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${Oo(f*z)}</text><text x="802" y="${(K+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${Oo(d*z)}</text>`}).join(""),q=e.map((z,K)=>{const at=x(z.opens||0);return`<rect class="dash-bar" data-i="${K}" x="${(y(K)-_/2).toFixed(1)}" y="${at.toFixed(1)}" width="${_.toFixed(1)}" height="${Math.max(0,266-at).toFixed(1)}" rx="3"/>`}).join(""),ue=e.map((z,K)=>`${y(K).toFixed(1)},${T(z.leads||0).toFixed(1)}`).join(" "),$e=p>1?`<polyline class="dash-line" points="${ue}" fill="none" stroke-width="2.5"/>`:"",he=e.map((z,K)=>`<circle class="dash-dot" data-i="${K}" cx="${y(K).toFixed(1)}" cy="${T(z.leads||0).toFixed(1)}" r="3.2"/>`).join(""),We='<line class="dash-crosshair" x1="0" y1="18" x2="0" y2="266" pointer-events="none"/>',qe=Math.max(1,Math.ceil(p/6)),B=e.map((z,K)=>K%qe===0||K===p-1?`<text x="${y(K).toFixed(1)}" y="288" text-anchor="middle" class="dash-ax">${z.date.slice(5)}</text>`:"").join(""),ne=e.map((z,K)=>`<rect class="dash-hit" data-i="${K}" data-day="${me(z.date)}" data-leads="${Number(z.leads||0)}" x="${(46+b*K).toFixed(1)}" y="18" width="${b.toFixed(1)}" height="${248 .toFixed(1)}" fill="transparent"/>`).join("");return`
    ...
    </div>`}function wr(e){const t=document.querySelector("#dash-trend .dash-chart-wrap"),a=document.querySelector("#dash-trend .dash-chart-tip");if(!t||!a)return;const n=c=>{try{return new Date(`${c}T00:00:00`).toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}catch{return c}},o=t.querySelector(".dash-crosshair"),s=()=>{t.querySelectorAll(".dash-bar--on, .dash-dot--on, .dash-hit--on").forEach(c=>c.classList.remove("dash-bar--on","dash-dot--on","dash-hit--on")),o&&o.classList.remove("dash-crosshair--on")},r=(c,h)=>{if(s(),t.querySelector(`.dash-bar[data-i="${c}"]`)?.classList.add("dash-bar--on"),t.querySelector(`.dash-dot[data-i="${c}"]`)?.classList.add("dash-dot--on"),h.classList.add("dash-hit--on"),o){const v=Number(h.getAttribute("x"))+Number(h.getAttribute("width"))/2;o.setAttribute("x1",v),o.setAttribute("x2",v),o.classList.add("dash-crosshair--on")}},i=(c,h)=>{const v=e[c];if(!v)return;a.innerHTML=`
      <div class="dash-chart-tip__date">${n(v.date)}</div>
      <div class="dash-chart-tip__row"><i class="dash-sw dash-sw--1"></i>${Q(v.opens||0)} opens</div>
      <div class="dash-chart-tip__row"><i class="dash-sw dash-sw--2"></i>${Q(v.leads||0)} leads</div>
      ${Number(v.leads||0)>0?'<div class="dash-chart-tip__go">Click to see them →</div>':""}`;const m=h.getBoundingClientRect(),p=t.getBoundingClientRect();a.style.left=`${m.left-p.left+m.width/2}px`,a.style.top=`${m.top-p.top}px`,a.hidden=!1,r(c,h)},l=()=>{a.hidden=!0,s()};t.querySelectorAll(".dash-hit").forEach(c=>{const h=Number(c.dataset.i);c.addEventListener("mouseenter",()=>i(h,c)),c.addEventListener("mousemove",()=>i(h,c)),c.addEventListener("mouseleave",l),c.addEventListener("click",()=>{const v=c.classList.contains("dash-hit--on");i(h,c),Number(c.dataset.leads||0)&&(!Hd()&&!v||(Vn(vt.LEADS_DAY,c.dataset.day),window.location.hash="#/leads"))})})}const Wd={render:br,init:_r},Yd=Object.freeze(Object.defineProperty({__proto__:null,default:Wd,init:_r,render:br,statCard:qt,svgTrendChart:yr,wireTrendTooltip:wr},Symbol.toStringTag,{value:"Module"}));function Kd(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/home" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function Jd(){console.log("[SignoutRoute] Initialized");const e=document.getElementById("confirm-signout-btn");e?.addEventListener("click",async()=>{e.disabled=!0,e.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await k.doSignout()})}const Qd=Object.freeze(Object.defineProperty({__proto__:null,init:Jd,render:Kd},Symbol.toStringTag,{value:"Module"}));let Mo=!1;function Xd(){if(Mo)return;const e=document.createElement("style");e.id="m5t-section-page-styles",e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),Mo=!0}function xr({title:e="Section",icon:t="widgets",name:a=""}={}){return Xd(),`
    ...
    </section>`}function Er(){}const Zd={render:xr,init:Er},ep=Object.freeze(Object.defineProperty({__proto__:null,default:Zd,init:Er,render:xr},Symbol.toStringTag,{value:"Module"})),tp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},lt=e=>String(e??"").replace(/[&<>"']/g,t=>tp[t]),Po=(e,t="info")=>{try{u.publish(g.UI_TOAST,{message:e,type:t})}catch{}},ap=()=>k.getConfig?.().BASE_URL||"",kr=()=>`${ap()}/m5t/v5/acctEntity/profile`,wn={profile:null};let Fo=!1;function np(){if(Fo)return;const e=document.createElement("style");e.id="m5t-settings-general-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Fo=!0}const Ar=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Sr(){try{return Ce.getAvailableLanguages()||[]}catch{return[]}}function op(){const e=Sr(),t=e.includes(H.FF_SSE_I18N_LANG)?H.FF_SSE_I18N_LANG:e[0]||H.FF_SSE_I18N_LANG;try{const a=localStorage.getItem(H.FF_SSE_LS_USER_LANG);return a&&e.includes(a)?a:t}catch{return t}}function sp(e){try{const t=new Intl.DisplayNames([e],{type:"language"}).of(e);if(t&&t!==e)return t.charAt(0).toUpperCase()+t.slice(1)}catch{}return e}function rp(){const e=Da(),t=Sr(),a=t.length>1;if(!e&&!a)return"";const n=op();return`
        ...
        <div class="settings-item" id="gen-lang-item">
          ...
          <div class="settings-item__control">
            <select class="settings-select" id="gen-lang" aria-label="Language">
              ${t.map(o=>`<option value="${lt(o)}" ${o===n?"selected":""}>${lt(sp(o))}</option>`).join("")}
            </select>
          </div>
        </div>`:""}
      </div>
    </div>`}function Cr(){return np(),`
    <div class="page-shell" data-section="settings-general">
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ...
          <div id="gen-profile-body">${Ar("hourglass_empty","Loading…")}</div>
        </div>
      </div>
    ...
    </div>`}async function Tr(){dp(),await lp()}function ip(e){return`
    ...
    </div>`}async function lp(){const e=document.getElementById("gen-profile-body");if(e){try{const t=await fetch(kr()),a=await t.json().catch(()=>({}));if(!t.ok||!a.ok||!a.data)throw new Error(a.error||"Failed to load");wn.profile=a.data}catch(t){console.warn("[settings-general] profile load failed:",t),e.innerHTML=Ar("error","Could not load your profile. Please try again.");return}e.innerHTML=ip(wn.profile),e.querySelector("#gen-save")?.addEventListener("click",cp)}}function Do(e,t){const a=document.getElementById(`${e}-error`);a&&(a.textContent=t||"",a.hidden=!t);const n=document.getElementById(e);n&&n.setAttribute("aria-invalid",t?"true":"false")}async function cp(){const e=document.getElementById("gen-save"),t=n=>(document.getElementById(n)?.value??"").trim(),a={first:t("gen-first"),last:t("gen-last"),company:t("gen-company"),phone:t("gen-phone")};if(Do("gen-first",a.first?"":"First name is required."),Do("gen-last",a.last?"":"Last name is required."),!(!a.first||!a.last)){e&&(e.disabled=!0);try{const n=await fetch(kr(),{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}),o=await n.json().catch(()=>({}));if(!n.ok||!o.ok)throw new Error(o.error||"Could not save.");o.data&&(wn.profile=o.data),Po("Profile updated.","success")}catch(n){console.warn("[settings-general] profile save failed:",n),Po(n.message||"Could not save.","error")}finally{e&&(e.disabled=!1)}}}function dp(){const e=document.getElementById("gen-dark");if(e){e.addEventListener("change",()=>{Qs(e.checked?"dark":"light"),e.checked=Yt()==="dark"});const a=u.subscribe(g.UI_THEME_CHANGED,()=>{if(!e.isConnected){u.unsubscribe(a);return}e.checked=Yt()==="dark"})}const t=document.getElementById("gen-lang");t&&t.addEventListener("change",()=>{try{Ce.setLanguage(t.value)}catch(a){console.warn("[settings-general] setLanguage failed:",a)}})}const pp={render:Cr,init:Tr},up=Object.freeze(Object.defineProperty({__proto__:null,default:pp,init:Tr,render:Cr},Symbol.toStringTag,{value:"Module"})),mp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},je=e=>String(e??"").replace(/[&<>"']/g,t=>mp[t]),Bo=(e,t="info")=>{try{u.publish(g.UI_TOAST,{message:e,type:t})}catch{}},ka=()=>k.getConfig?.().BASE_URL||"",gp=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?",$r="managed_client",Lr={reseller_org:"Your organization",managed_client:"Client workspace",saas_org:"Organization"},hp=6,Xe={org:null},Ir=()=>k.getActiveOrg()?.guid||k.getMemberships()[0]?.orgGuid||null,Ba=()=>k.getActiveOrg()?.channel||k.getMemberships()[0]?.channel||null,Rr=()=>k.getCapabilities().includes("manage_team");let qo=!1;function fp(){if(qo)return;const e=document.createElement("style");e.id="m5t-workspace-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),qo=!0}const Aa=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Uo=(e,t,a)=>`
  <div class="settings-section__head">
  ...
  </div>`;function Nr(){fp();const e=Lr[Ba()];return`
    <div class="page-shell" data-section="settings-workspace">
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ...
          <div id="ws-org-body">${Aa("hourglass_empty","Loading…")}</div>
        </div>
      </div>
    ...
    </div>`}async function Or(){Xe.org=null,await vp(),await yp()}async function vp(){const e=document.getElementById("ws-org-body");if(!e)return;const t=Ir();if(!t){e.innerHTML=Aa("apartment","No workspace on this account yet.");return}try{const a=await fetch(`${ka()}/m5t/v5/acctGroup`),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||`Failed (HTTP ${a.status})`);if(Xe.org=(n.data||[]).find(o=>o.guid===t)||null,!Xe.org)throw new Error("Org row not in scope")}catch(a){console.warn("[settings-workspace] load failed:",a),e.innerHTML=Aa("error","Could not load your workspace. Please try again.");return}bp()}function zo(){const e=Lr[Ba()]||"",t=Xe.org?.created?.created_tz;let a="";if(t){const o=new Date(t);Number.isNaN(o.getTime())||(a=`Created ${o.toLocaleDateString()}`)}const n=[e,a].filter(Boolean);return n.length?`<p class="settings-help">${je(n.join(" · "))}</p>`:""}function bp(){const e=document.getElementById("ws-org-body");if(!e)return;const t=Xe.org||{};if(!Rr()){const a=Ba()===$r?'<div class="settings-note"><span class="material-symbols-outlined" aria-hidden="true">info</span> This workspace is managed for you.</div>':"";e.innerHTML=`
    ...
    </div>`,document.getElementById("ws-save")?.addEventListener("click",_p)}async function _p(){const e=document.getElementById("ws-save"),t=document.getElementById("ws-org-error"),a=(document.getElementById("ws-name")?.value||"").trim(),n=(document.getElementById("ws-desc")?.value||"").trim();if(t&&(t.textContent=""),!a){t&&(t.textContent="Organization name is required.");return}e&&(e.disabled=!0);try{const o=await fetch(`${ka()}/m5t/v5/acctGroup/${encodeURIComponent(Xe.org.id)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({caption:a,description:n})}),s=await o.json().catch(()=>({}));if(!o.ok||!s.ok)throw new Error(s.message||s.error||`Failed (HTTP ${o.status})`);Xe.org={...Xe.org,caption:a,description:n},Bo("Workspace updated.","success")}catch(o){console.warn("[settings-workspace] save failed:",o),Bo(o.message||"Could not save","danger"),e&&(e.disabled=!1);return}e&&(e.disabled=!1);try{await k.fetchScope?.()}catch(o){console.warn("[settings-workspace] fetchScope after save failed:",o)}}function Ho(){document.getElementById("ws-team-card")?.remove()}async function yp(){const e=document.getElementById("ws-team-card");if(!e)return;const t=Ir();if(!t||!Rr()){Ho();return}let a=[],n=[];try{const[o,s]=await Promise.all([fetch(`${ka()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/members`),fetch(`${ka()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/invites`)]);if(o.status===403||s.status===403){Ho();return}const[r,i]=await Promise.all([o.json().catch(()=>({})),s.json().catch(()=>({}))]);if(!o.ok||!s.ok)throw new Error(`members: ${o.status}, invites: ${s.status}`);a=r.members||[],n=i.invites||[]}catch(o){console.warn("[settings-workspace] team load failed:",o),e.style.display="";const s=document.getElementById("ws-team-body");s&&(s.innerHTML=Aa("error","Could not load your team. Please try again."));return}Ep(a,n)}function wp(e){if(!e.length)return"";const t=e.slice(0,hp),a=e.length-t.length;return`
    <div class="ws-avatars">
      ${t.map(n=>`<span class="ws-avatar" title="${je(n.name||n.email)}">${je(gp(n.name||n.email))}</span>`).join("")}
      ${a>0?`<span class="ws-avatar ws-avatar--more">+${a}</span>`:""}
    </div>`}function xp(e,t){const a=`${e.length} member${e.length===1?"":"s"}`;return t.length?`${a} · ${t.length} pending invite${t.length===1?"":"s"}`:a}function Ep(e,t){const a=document.getElementById("ws-team-card"),n=document.getElementById("ws-team-body");if(!a||!n)return;a.style.display="";const o=Ba()!==$r;n.innerHTML=`
    ${wp(e)}
    <p class="ws-counts">${je(xp(e,t))}</p>
    ${o?'<div class="ws-team-actions"><a class="btn btn-secondary" href="#/team">Manage team</a></div>':""}`}const kp={render:Nr,init:Or},Ap=Object.freeze(Object.defineProperty({__proto__:null,default:kp,init:Or,render:Nr},Symbol.toStringTag,{value:"Module"})),Sp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ie=e=>String(e??"").replace(/[&<>"']/g,t=>Sp[t]),ye=(e,t="info")=>{try{u.publish(g.UI_TOAST,{message:e,type:t})}catch{}},bt=()=>k.getConfig?.().BASE_URL||"",Cp=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,Jt=5,ve={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},xn=()=>k.getActiveOrg()?.guid||k.getMemberships()[0]?.orgGuid||null;let jo=!1;function Tp(){if(jo)return;const e=document.createElement("style");e.id="m5t-notif-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),jo=!0}const Wn=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Mr(){return Tp(),yt(),ae()?wt({section:"settings-notifications",title:"Notifications",description:"Pick a client to manage their lead alerts."}):`
    ...
    </div>`,s.querySelector(".m5t-modal__title").textContent=e;const r=s.querySelector(".m5t-modal"),i=s.querySelector(".m5t-modal__body");t instanceof Element?i.appendChild(t):i.innerHTML=String(t);let l=!1;const c=p=>{if(l)return;l=!0,document.removeEventListener("keydown",m,!0),s.classList.remove("open");const f=()=>{s.remove();try{o?.focus?.()}catch{}n&&n(p)};document.documentElement.classList.contains("ff-no-animations")||window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches?f():setTimeout(f,180)},h='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',v=p=>{for(let f=p;f&&f!==s;f=f.parentElement)if(f.hidden||f.style?.display==="none"||f.style?.visibility==="hidden")return!1;return!0},m=p=>{if(p.key==="Escape"){p.stopPropagation(),c(void 0);return}if(p.key!=="Tab"||l)return;const f=[...r.querySelectorAll(h)].filter(v);if(!f.length){p.preventDefault(),r.focus();return}const d=f[0],b=f[f.length-1],_=document.activeElement;if(!r.contains(_)){p.preventDefault(),(p.shiftKey?b:d).focus();return}p.shiftKey&&_===d?(p.preventDefault(),b.focus()):!p.shiftKey&&_===b&&(p.preventDefault(),d.focus())};return s.addEventListener("click",p=>{p.target===s&&c(void 0)}),s.querySelector(".m5t-modal__close").addEventListener("click",()=>c(void 0)),document.addEventListener("keydown",m,!0),document.body.appendChild(s),r.contains(document.activeElement)||r.focus(),requestAnimationFrame(()=>s.classList.add("open")),{el:s,close:c}}function Mp(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const Pp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},rn=e=>String(e??"").replace(/[&<>"']/g,t=>Pp[t]);function qr({title:e="Are you sure?",message:t="",confirmLabel:a="Confirm",cancelLabel:n="Cancel",danger:o=!1}={}){return new Promise(s=>{let r=!1;const i=h=>{r||(r=!0,s(h))},l=document.createElement("div");l.innerHTML=`
  ...
  `,document.head.appendChild(e),Jo=!0}function Hr(){return ja(),yt(),ae()?wt({section:"settings-integrations",title:"Integrations",description:"Pick a client to manage their connections."}):`
    ...
    </div>`}async function jr(){if(ae()){const e=t=>Number(t||0).toLocaleString();return tt(te(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}Jp()||await Qp()}const ia=Object.fromEntries(Object.values(Se).filter(e=>e.connect).map(e=>[e.slug,e.label]));function Jp(){try{const e=new URLSearchParams(window.location.search),t=e.get("connected"),a=e.get("error")?e.get("provider")||"google_ads":null;let n=null;if(t&&Object.hasOwn(ia,t))be(`${ia[t]} connected.`,"success"),Bp({slug:t,connected:!0}),n=Object.hasOwn(Se,t)?Se[t]:null;else if(a){const o=Object.hasOwn(ia,a)?ia[a]:a;be(`${o} connection failed (${e.get("error")}).`,"error"),n=Object.hasOwn(Se,a)?Se[a]:null}else return!1;return window.history.replaceState(null,"",window.location.pathname+window.location.hash),n?(window.router?.navigate(`/settings/integrations/${n.urlSlug}`),!0):!1}catch{return!1}}async function Qp(){const e=document.getElementById("intg-body");try{const{denied:t,providers:a,configured:n}=await Ha();if(t){e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ne("lock","Integrations are managed by workspace admins.")}</div></div>`);return}e&&(e.innerHTML=tu(a,n))}catch{e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ne("error","Could not load integrations.")}</div></div>`)}}function Xp(e,t,a){const n=Ua(e,t,a);return`
    ...
    </div>`}function tu(e,t){const a=Object.values(Se).map(o=>Xp(o,qa(e,o.slug),!!t?.[o.slug])).join(""),n=Wo.length?`<div class="intg-grid__soon-label">Coming soon</div>${Wo.map(eu).join("")}`:"";return`<div class="intg-grid">${a}${n}</div>`}const au={render:Hr,init:jr},nu=Object.freeze(Object.defineProperty({__proto__:null,default:au,init:jr,render:Hr},Symbol.toStringTag,{value:"Module"})),I={provider:null,conn:null,configured:!1,status:"idle"};function Gr({provider:e}={}){ja(),yt();const t=Ur[e];if(!t||ae())return'<div class="page-shell"></div>';const a=Se[t];return I.provider=a,`
    <div class="page-shell" data-section="settings-integrations">
    ...
    </div>`}async function Vr({provider:e}={}){const t=Ur[e];if(!t||ae()){window.router?.navigate("/settings/integrations",{historyAPIMethod:"replaceState"});return}await kn();const a=qp();a?.connected&&a.slug===t&&I.provider?.picker&&Te()&&zr(I.provider,{refresh:kn})}async function kn(){const e=document.getElementById("intg-detail");if(!(!e||!I.provider))try{const{denied:t,providers:a,configured:n}=await Ha();if(t){e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ne("lock","Integrations are managed by workspace admins.")}</div></div>`;return}I.conn=qa(a,I.provider.slug),I.configured=!!n?.[I.provider.slug],I.status=Ua(I.provider,I.conn,I.configured),e.innerHTML=ou(),pu()}catch{e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ne("error","Could not load this integration.")}</div></div>`}}function ou(){const e=I.provider;return[ru(e),iu(e),lu(e),cu(e),du(e)].filter(Boolean).join("")}function su(e){const t=I.conn?.external_account||{};if(I.status!=="connected")return e.card.sub;if(e.slug==="calendly"){const n=[t.name,t.email&&`(${t.email})`].filter(Boolean).join(" ");return n?`Connected as ${n}.`:"Connected."}if(e.slug==="callrail"){const n=[t.account_name,t.company_name].filter(Boolean).join(" · ");return n?`Connected to ${n}.`:"Connected."}const a=e.card.reachableCount(t);return a?`${a} reachable ${e.slug==="google_analytics"?a===1?"property":"properties":a===1?"account":"accounts"}.`:"Connected."}function ru(e){let t="";Te()&&(e.connect&&(I.status==="idle"||I.status==="broken")&&I.configured&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${I.status==="broken"?"Reconnect":"Connect"}</button>`),e.slug==="callrail"&&I.status!=="connected"&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${I.status==="broken"?"Reconnect":"Connect"}</button>`));let a;return I.status==="unavailable"?a=`${e.label} is being set up for this platform.`:I.status==="broken"?a=e.card.brokenDesc:I.status==="idle"?a=Te()?e.card.idleDesc:e.card.sub:a=su(e),`
    ...
    </div>`}function iu(e){const t=Up[e.slug];if(!t)return"";if(I.status==="connected"||I.status==="unavailable"||!Te())return`
      <div class="dashboard-card intg-card">
        <div class="card-body">
    ...
    </div>`}function lu(e){if(I.status!=="connected")return"";const t=Te();if(e.picker){const a=e.card.reachableCount(I.conn?.external_account);return`
      <div class="dashboard-card intg-card">
        <div class="card-body">
    ...
    </div>`}function du(e){return I.status!=="connected"&&I.status!=="broken"||!Te()?"":`
    ...
    </div>`}function pu(){const e=I.provider;if(!e)return;const t=kn;e.connect&&document.getElementById(e.card.ids.connect)?.addEventListener("click",()=>zp(e)),e.slug==="callrail"&&(document.getElementById(e.card.ids.connect)?.addEventListener("click",()=>Yo({refresh:t})),document.getElementById("intg-r-replace")?.addEventListener("click",()=>Yo({refresh:t,replaceKey:!0})),document.getElementById(e.card.ids.sync)?.addEventListener("click",()=>Kp({refresh:t})),I.status==="connected"&&Te()&&gu()),e.picker&&(document.getElementById(e.card.ids.choose)?.addEventListener("click",()=>zr(e,{refresh:t})),document.getElementById(e.card.ids.sync)?.addEventListener("click",()=>Hp(e,{refresh:t}))),e.slug==="google_ads"&&I.status==="connected"&&Te()&&uu(),e.slug==="calendly"&&I.status==="connected"&&Te()&&mu(),document.getElementById(e.card.ids.disconnect)?.addEventListener("click",()=>jp(e,{refresh:t}))}async function uu(){const e=document.getElementById("intg-g-convactions");if(e)try{const a=await(await fetch(`${te()}/m5t/v5/integrations/google_ads/conversion_actions`)).json();if(!a.ok)throw new Error(a.error||"load failed");const n=a.data.actions||[],o=new Set(a.data.selected||[]);if(!n.length){e.innerHTML=xe("No enabled conversion actions in the linked accounts.");return}e.innerHTML=`
  ...
  `,document.head.appendChild(e),Qo=!0}const Kn=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Wr(){return bu(),`
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Signing in as ${Ut(Eu())}. You stay signed in on this device after a change.</p>
            </div>
          </div>
          <div class="settings-grid-2">
            <div class="settings-field">
    ...
    </div>`}async function Yr(){document.getElementById("pw-save")?.addEventListener("click",Au);const e=document.getElementById("pk-add-btn");e&&window.PublicKeyCredential&&(e.style.display="",e.addEventListener("click",wu)),await Kr()}async function Kr(){const e=document.getElementById("pk-body");if(e){try{const t=await fetch(`${Xt()}/m5t/v5/webauthn`),a=await t.json().catch(()=>({}));if(!t.ok||!a.ok)throw new Error(a.error||"Failed to load");$t.passkeys=a.passkeys||[],$t.loaded=!0}catch(t){console.warn("[settings-security] load failed:",t),e.innerHTML=Kn("error","Could not load your passkeys. Please try again.");return}Jr()}}function Xo(e){if(!e)return null;try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return null}}function _u(e){const t=Xo(e.last_used_time),a=e.created?.created_tz,n=Xo(a),o=[e.device_type==="multiDevice"?"Syncs across devices":"This device only",t?`Last used ${t}`:"Never used to sign in yet",n?`Added ${n}`:null].filter(Boolean).join(" · ");return`
    ...
    </div>`}function Jr(){const e=document.getElementById("pk-body");if(e){if(!window.PublicKeyCredential){e.innerHTML=`<p class="pk-unsupported">This browser doesn't support passkeys. Your password sign-in still works as usual.</p>`;return}if(!$t.passkeys.length){e.innerHTML=Kn("passkey","No passkeys yet. Add one for a faster, phishing-resistant sign-in.");return}e.innerHTML=$t.passkeys.map(_u).join(""),e.querySelectorAll("[data-remove]").forEach(t=>{t.addEventListener("click",()=>xu(t.dataset.remove,t))})}}function yu(){try{const e=navigator.userAgent||"",t=/iPhone/.test(e)?"iPhone":/iPad/.test(e)?"iPad":/Android/.test(e)?"Android":/Mac OS X/.test(e)?"Mac":/Windows/.test(e)?"Windows":/Linux/.test(e)?"Linux":"device",a=/Edg\//.test(e)?"Edge":/Chrome\//.test(e)?"Chrome":/Firefox\//.test(e)?"Firefox":/Safari\//.test(e)?"Safari":"";return a?`${a} on ${t}`:t}catch{return"Passkey"}}async function wu(){const e=document.getElementById("pk-add-btn");e&&(e.disabled=!0);try{const{startRegistration:t}=await V(async()=>{const{startRegistration:i}=await Promise.resolve().then(()=>ir);return{startRegistration:i}},void 0,import.meta.url),a=await fetch(`${Xt()}/m5t/v5/webauthn/register/options`,{method:"POST"}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||"Could not start passkey registration");let o;try{o=await t({optionsJSON:n.options})}catch(i){if(i?.name==="NotAllowedError")return;throw i}const s=await fetch(`${Xt()}/m5t/v5/webauthn/register/verify`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o,deviceLabel:yu()})}),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.error||"Could not register this passkey");Qt("Passkey added","success"),await Kr()}catch(t){console.warn("[settings-security] addPasskey failed:",t),Qt(t.message||"Could not add a passkey","danger")}finally{e&&(e.disabled=!1)}}async function xu(e,t){if(await qr({title:"Remove this passkey?",message:"You can always add it back later.",confirmLabel:"Remove",danger:!0})){t&&(t.disabled=!0);try{const n=await fetch(`${Xt()}/m5t/v5/webauthn/${encodeURIComponent(e)}`,{method:"DELETE"}),o=await n.json().catch(()=>({}));if(!n.ok||!o.ok)throw new Error(o.error||"Could not remove this passkey");$t.passkeys=$t.passkeys.filter(s=>s.guid!==e),Qt("Passkey removed","success"),Jr()}catch(n){console.warn("[settings-security] removePasskey failed:",n),Qt(n.message||"Could not remove this passkey","danger"),t&&(t.disabled=!1)}}}function Eu(){try{return k.getScope()?.entity?.email||k.getEntity?.()?.email||"your account"}catch{return"your account"}}const la=e=>{const t=document.getElementById("pw-error");t&&(t.textContent=e||"",t.hidden=!e)},ku=e=>e.length<=1?String(e[0]??""):e.length===2?`${e[0]} and ${e[1]}`:`${e.slice(0,-1).join(", ")}, and ${e[e.length-1]}`;async function Au(){const e=document.getElementById("pw-new"),t=document.getElementById("pw-confirm"),a=document.getElementById("pw-save"),n=e?.value||"",o=t?.value||"",s=Gn(n);if(s.length){la(`Password needs: ${ku(s)}.`);return}if(n!==o){la("Passwords do not match.");return}la(""),a&&(a.disabled=!0);try{const r=await fetch(`${Xt()}/m5t/v5/acctEntity/resetHash`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({password:n})}),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok)throw new Error(i.error||"Could not update your password");Qt("Password updated","success"),e&&(e.value=""),t&&(t.value="")}catch(r){la(r.message||"Could not update your password.")}finally{a&&(a.disabled=!1)}}const Su={render:Wr,init:Yr},Cu=Object.freeze(Object.defineProperty({__proto__:null,default:Su,init:Yr,render:Wr},Symbol.toStringTag,{value:"Module"})),Tu={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ie=e=>String(e??"").replace(/[&<>"']/g,t=>Tu[t]),An=()=>k.getConfig?.().BASE_URL||"",cn=e=>Number(e||0).toLocaleString(),Y={conversations:[],counts:{},magnetNames:{},filter:"ALL",book:!1,magnetOwnerNames:{}},Zo={COMPLETED:{label:"Completed",icon:"check_circle"},IN_PROGRESS:{label:"In progress",icon:"pending"},ABANDONED:{label:"Abandoned",icon:"highlight_off"}},Sn={book:"Book",chat:"Chat",call:"Call",email:"Email",support:"Support"};function Qr(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email)||null}function Xr(e){return(e.split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase()}function Zr(e){try{return new Date(e).toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return""}}function $u(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function ei(e){return e==null?"—":e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,"0")}s`}let es=!1;function Lu(){if(es)return;const e=document.createElement("style");e.id="m5t-convs-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),es=!0}const Ga=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function ti(){return Lu(),yt(),`
    ...
    </div>`}async function ai(){await Iu()}async function Iu(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${An()}/m5t/v5/conversations`),fetch(`${An()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(Y.conversations=n.conversations||[],Y.counts=n.counts||{},Y.book=ae(),a){const o=await a.json().catch(()=>({}));Y.magnetNames={},Y.magnetOwnerNames={};const s=Y.book?hr():{};(o.magnets||[]).forEach(r=>{Y.magnetNames[r.guid]=r.name,Y.book&&(Y.magnetOwnerNames[r.guid]=r.owner_name||s[r.owner_guid]||"")})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=Ga("error","Could not load journeys. Please try again.");return}ni()}}function Ru(){return Y.filter==="ALL"?Y.conversations:Y.conversations.filter(e=>e.status===Y.filter)}function Nu(e){const t=Qr(e.lead),a=Y.magnetNames[e.magnet_guid]||"—",n=Zo[e.status]||Zo.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,s=(e.routes||[]).map(r=>Sn[r]||r).join(", ");return`
    <tr class="convs-row" data-session="${ie(e.session)}">
      ...
      ${Y.book?`<td>${fr(Y.magnetOwnerNames[e.magnet_guid]||"")||'<span class="convs-muted">—</span>'}</td>`:""}
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${ie(Zr(e.started_at))}">${ie($u(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${ie(ei(e.duration_s))}</td>
    </tr>`}function ni(){const e=document.getElementById("convs-body");if(!e)return;if(!Y.conversations.length){e.innerHTML=Ga("route","No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.");return}const t=Ru(),a=[["ALL","All"],["COMPLETED","Completed"],["IN_PROGRESS","In progress"],["ABANDONED","Abandoned"]];e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${a.map(([n,o])=>`<button data-filter="${n}" class="${Y.filter===n?"active":""}">${o}${n!=="ALL"&&Y.counts[n]?` (${cn(Y.counts[n])})`:""}</button>`).join("")}
      </div>
      <span class="convs-count">${cn(t.length)} of ${cn(Y.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(Nu).join("")||`<tr><td colspan="${Y.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${Y.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(Y.filter=o.dataset.filter,ni())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&Mu(o.dataset.session)})}const Ou={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${Sn[e]||e}`:""}`,route:e=>`Picked ${Sn[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function Mu(e){const t=Y.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${An()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=Qr(t.lead),o=Y.magnetNames[t.magnet_guid]||"—",r=(a?.events||[]).filter((c,h,v)=>c.event!=="step"||!(v[h+1]&&v[h+1].event==="step")).map(c=>`
    <div class="convs-tl__item${c.event==="complete"?" done":""}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${ie((Ou[c.event]||(()=>c.event))(c.detail))}</div>
    ...
    </aside>`,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("open"),i.querySelector(".convs-drawer").classList.add("open")});const l=()=>{i.classList.remove("open"),setTimeout(()=>i.remove(),220)};i.querySelector(".convs-drawer__close").addEventListener("click",l),i.addEventListener("click",c=>{c.target===i&&l()})}const Pu={render:ti,init:ai},Fu=Object.freeze(Object.defineProperty({__proto__:null,default:Pu,init:ai,render:ti},Symbol.toStringTag,{value:"Module"})),Du={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},mt=e=>String(e??"").replace(/[&<>"']/g,t=>Du[t]),ts=(e,t="info")=>{try{u.publish(g.UI_TOAST,{message:e,type:t})}catch{}},ha=()=>k.getConfig?.().BASE_URL||"",Lt=e=>Number(e||0).toLocaleString(),Ze={magnets:[],stats:{},canManage:!1},Bu={mag_title:"header title",mag_subtitle:"subtitle",mag_welcome:"welcome message",mag_theme_color:"color",mag_launcher_label:"launcher label"};let as=!1;function qu(){if(as)return;const e=document.createElement("style");e.id="m5t-abt-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),as=!0}const Jn=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function oi(){return ae()?wt({section:"ab-testing",title:"A/B Testing",description:"Pick a client to view their experiments."}):(qu(),`
    ...
    </div>`}function Gu(e){const t=e.ab,{A:a,B:n}=zu(e),o=(n.rate??-1)>(a.rate??-1)?"B":(a.rate??-1)>(n.rate??-1)?"A":null,s=o&&a.rate!=null&&n.rate!=null?`+${Math.round(Math.abs(n.rate-a.rate)*10)/10}%`:"",r=Yu(a,n),i=t.started_tz?ju(t.started_tz):null,l=(a.opens||0)+(n.opens||0),c=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
      ...
      <div class="abt-compare">
        ...
        ${ns("Variant B",o==="B"?"Leading":"Challenger",Hu(t),n,o==="B",o==="B"?s:"")}
      </div>
      <div class="abt-sig">
    ...
    </div>`}async function Wu(e,t){const a=Ze.magnets.find(n=>n.guid===e);if(a&&window.confirm(`Declare Variant ${t} the winner for “${a.name}”?

${t==="B"?"Variant B’s changes become the magnet’s configuration for everyone.":"The magnet keeps its current configuration."} The experiment ends and moves to Completed.`)){try{const o=await(await fetch(`${ha()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Declare failed");ts(`Variant ${t} declared the winner`,"success")}catch(n){ts(n.message||"Could not declare a winner","danger");return}try{await Qn()}catch(n){console.warn("[ab-testing] refresh after declare failed:",n)}}}function Yu(e,t){const a=e.opens||0,n=t.opens||0,o=e.completions||0,s=t.completions||0;if(a<30||n<30||o+s<5)return null;const r=o/a,i=s/n,l=(o+s)/(a+n),c=Math.sqrt(l*(1-l)*(1/a+1/n));if(!c)return null;const h=Math.abs(i-r)/c;return Math.round(2*(Ku(h)-.5)*1e3)/10}function Ku(e){const t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}const Ju={render:oi,init:Qn},Qu=Object.freeze(Object.defineProperty({__proto__:null,default:Ju,init:Qn,render:oi},Symbol.toStringTag,{value:"Module"})),Xu={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},le=e=>String(e??"").replace(/[&<>"']/g,t=>Xu[t]),si=()=>k.getConfig?.().BASE_URL||"",Zu={single_select:{icon:"quiz",color:"#0072BA",darkColor:"#38BDF8"},multi_select:{icon:"checklist",color:"#0E6BA8",darkColor:"#22D3EE"},scheduler:{icon:"event",color:"#915E8B",darkColor:"#E879F9"},text:{icon:"short_text",color:"#5B54C6",darkColor:"#A78BFA"},email:{icon:"mail",color:"#0E8F86",darkColor:"#2DD4BF"},phone:{icon:"call",color:"#2E8B57",darkColor:"#4ADE80"},message:{icon:"chat",color:"#B4791F",darkColor:"#FBBF24"}},Sa={};qn.forEach(e=>{Sa[e.value]={label:e.label,...Zu[e.value]||{icon:"quiz",color:"#0072BA",darkColor:"#38BDF8"}}});const ri=qn.map(e=>e.value),ii={chat:"Chat / default",book:"Book (scheduler)",support:"Support (intake)"},Xn=e=>{const t=Sa[e]||Sa.single_select;return document.documentElement.getAttribute("data-theme")==="dark"?{...t,color:t.darkColor}:t},xt=e=>e==="single_select"||e==="multi_select",Va=e=>e!=="message",Rt=e=>e==="scheduler",aa=e=>e==="message",Ca=e=>e==="email"?"email":e==="phone"?"phone":"",Nt=()=>({meeting_label:"",start:"09:00",end:"17:00",mins:30,days:14}),em=["meeting_label","start","end","mins","days"],os=["terminal","cta"];function Cn(e,t){const a={};return Object.keys(e&&typeof e=="object"?e:{}).forEach(n=>{t.includes(n)||(a[n]=e[n])}),Object.keys(a).length?a:null}function li(e){return Cn(e,em)}const tm=[["","No icon"],["event","Calendar"],["schedule","Clock"],["mail","Email"],["sms","Text"],["phone","Phone"],["chat","Chat"],["description","Document"],["help","Question"],["place","Location"],["person","Person"],["bolt","Quick"],["check_circle","Check"],["star","Star"],["home","Home"],["build","Service"]];function am(e,t){const a=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||"").trim());return a?`rgba(${parseInt(a[1],16)},${parseInt(a[2],16)},${parseInt(a[3],16)},${t})`:`rgba(0,114,186,${t})`}let ss=!1;function nm(){if(ss)return;const e=document.createElement("style");e.id="m5t-flow-styles",e.textContent=`
  ...
  </div>`}function cm(e){const t=ri.map(n=>`<option value="${n}"${n===e.step_type?" selected":""}>${le(Xn(n).label)}</option>`).join(""),a=e.step_options.length<=1;return`<div class="flow-node__body">
...
`))}</textarea>
    ...
    <div class="flow-opts">${e.step_options.map(n=>lm(n,a)).join("")}</div>
...
<body>
  ...
  `,document.head.appendChild(e),cs=!0}function hi(e){return`<div class="pv-hintwrap">
  ...
  </div>`}function fi(e){const t=e.querySelector("[data-pv-info]"),a=e.querySelector("[data-pv-info-pop]");t&&a&&t.addEventListener("click",()=>{a.hidden=!a.hidden})}function ym(e,t){gi(),e.innerHTML=`
    <div class="pv-pane">
    ...
    <div class="mag-tpl-card${s}"${r}>${i}${l}
      ...
      ${a?`<div class="mag-tpl-card__actions">${h}${v}</div>`:h}
    </div>`}const km=300*1e3;function Am(e){Vn(vt.MAGNET_TEMPLATE,{id:e,at:Date.now()})}function _i(e){if(!e)return null;if(typeof e=="string")return et.find(n=>n.id===e)||null;const{id:t,at:a}=e;return typeof a=="number"&&Date.now()-a>=km?null:et.find(n=>n.id===t)||null}function Sm(){return _i(_n(vt.MAGNET_TEMPLATE))}function Cm(){return _i(Fd(vt.MAGNET_TEMPLATE))}let ps=!1;function yi(){if(ps)return;const e=document.createElement("style");e.id="m5t-mag-template-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ps=!0}function Tm(e){yi();const t=document.createElement("div");t.className="mag-modal-scrim mag-tpl-modal",t.innerHTML=`
  ...
  <div class="mag-csp-note__body">
    <p>A strict CSP can silently block the widget — it just never appears, no visible error. Allowlist <code>${E(oe())}</code> under all three directives. Copy-paste ready for your CSP header/meta tag:</p>
    <pre class="mag-csp-note__snippet"><code>script-src 'self' ${E(oe())};
connect-src 'self' ${E(oe())};
img-src 'self' ${E(oe())};</code></pre>
    <ul>
...
</details>`,Ei={chat:"Chat bubble",right_slide:"Slide-in panel",modal:"Modal",inline:"Inline"},Lm={chat:"chat",right_slide:"vertical_split",modal:"web_asset",inline:"view_agenda"},ki=[{value:"inline",icon:"view_agenda",label:"Inline"},{value:"chat",icon:"chat",label:"Chat"},{value:"right_slide",icon:"vertical_split",label:"Slide"},{value:"modal",icon:"web_asset",label:"Modal"}],Ai=[{value:"auto",icon:"brightness_auto",label:"Auto"},{value:"light",icon:"light_mode",label:"Light"},{value:"dark",icon:"dark_mode",label:"Dark"}],Si=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],to={book:{label:"Book",icon:"event",kind:"book"},chat:{label:"Chat",icon:"chat",kind:"flow"},call:{label:"Call",icon:"phone",kind:"value",placeholder:"Phone number"},email:{label:"Email",icon:"mail",kind:"value",placeholder:"Email address"},support:{label:"Support",icon:"support_agent",kind:"support"}},Ci=["book","chat","call","email","support"];let ba=null;async function Im(){if(ba)return ba;let e;try{const t=await fetch(`${oe()}/m5t/v5/integrations/calendly/event_types`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.event_types||[],scheduling_url:a.data.scheduling_url||""}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(ba=e),e}async function Rm(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved Calendly event";e.innerHTML=`<option value="${E(t)}">${t?E(a):"Loading event types"}</option>`;const n=await Im();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${E(t)}" selected>${E(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect Calendly under Settings, Integrations first":"Could not load event types"}</option>`;return}const o=[];n.scheduling_url&&o.push({url:n.scheduling_url,label:"Full scheduling page (visitor picks the event)"}),n.list.forEach(s=>o.push({url:s.scheduling_url,label:s.duration?`${s.name} (${s.duration} min)`:s.name})),t&&!o.some(s=>s.url===t)&&o.unshift({url:t,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${E(s.url)}"${s.url===(t||o[0].url)?" selected":""}>${E(s.label)}</option>`).join(""):'<option value="">No active event types</option>'}let _a=null;async function Nm(){if(_a)return _a;let e;try{const t=await fetch(`${oe()}/m5t/v5/integrations/callrail/trackers`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.trackers||[]}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(_a=e),e}async function Om(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved tracking number";e.innerHTML=`<option value="${E(t)}">${t?E(a):"Loading tracking numbers"}</option>`;const n=await Nm();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${E(t)}" selected>${E(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect CallRail under Settings, Integrations first":"Could not load tracking numbers"}</option>`;return}const o=n.list.map(s=>({number:s.number,id:s.id,name:s.name,label:`${s.name} · ${s.number}${s.type==="session"?" (number pool)":""}`}));t&&!o.some(s=>s.number===t)&&o.unshift({number:t,id:e.dataset.savedId||"",name:a,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${E(s.number)}" data-tracker-id="${E(s.id)}" data-tracker-name="${E(s.name)}"${s.number===(t||o[0].number)?" selected":""}>${E(s.label)}</option>`).join(""):'<option value="">No active tracking numbers in this company</option>'}function ms(e,t,a){return`<div class="mag-seg" role="radiogroup" aria-label="${E(e)}">${a.map(n=>`
    <label><input type="radio" name="${E(e)}" value="${E(n.value)}"${n.value===t?" checked":""}>
      <span><span class="material-symbols-outlined" aria-hidden="true">${E(n.icon)}</span>${E(n.label)}</span></label>`).join("")}</div>`}function Mm(e,t){const a=to[e],n=!!t,o=n?"":" disabled";let s="";if(a.kind==="value"&&e==="call"){const i=t?.config?.source==="callrail",l=i&&t?.value||"",c=i?t?.config?.tracker_name||"Saved tracking number":"";s=`
      ...
      </select>`}else if(a.kind==="value")s=`<input class="mag-modal__input mag-cta__val" type="text" placeholder="${E(a.placeholder)}" value="${E(t?.value||"")}"${o}>`;else if(a.kind==="book"){const i=t?.config?.meeting_label||t?.value||"",l=t?.config?.source==="calendly",c=l&&t?.config?.calendly_url||"",h=l?t?.config?.event_name||"Saved Calendly event":"";s=`
      ...
      <select class="mag-modal__select mag-cta__calevent" data-saved="${E(c)}" data-saved-name="${E(h)}"${o}${l?"":" hidden"}>
        ${c?`<option value="${E(c)}" selected>${E(h)}</option>`:""}
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${a.kind}">
    ...
    ${r}
  </div>`}function Pm(){if(us)return;const e=document.createElement("style");e.id="m5t-magnets-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),us=!0}function $a(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Fm(e){const t=G.stats[e];if(!t||!t.opens&&!t.leads)return'<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>';const a=n=>Number(n||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function ao(e){const t=G.owners.length>1||k.getMemberships().length>1,a=(e.domains||[]).filter(Boolean),n=G.canManage;return`
    <div class="mag-card" data-guid="${E(e.guid)}">
      ...
      <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${Lm[e.display_mode]||"chat"}</span>${E(Ei[e.display_mode]||"Chat bubble")}${e.ab?.enabled?'&nbsp;&nbsp;<span class="mag-ab-chip"><span class="material-symbols-outlined" aria-hidden="true">science</span>A/B</span>':""}${(e.notify_emails||[]).length?`&nbsp;&nbsp;<a class="mag-alert-chip" href="#/settings/notifications" title="Lead alerts to ${(e.notify_emails||[]).length} email${(e.notify_emails||[]).length===1?"":"s"}. Manage in Settings."><span class="material-symbols-outlined" aria-hidden="true">notifications_active</span>${(e.notify_emails||[]).length}</a>`:""}</span>
      ${Fm(e.guid)}
      <div class="mag-domains">${a.length?a.map(o=>E(o)).join(", "):"<span>No domains set. Add yours to go live.</span>"}</div>
      <div class="mag-embed">
        <input type="text" readonly value="${E(wi(e.guid))}" aria-label="Embed snippet">
    ...
    </div>`}function Dm(){return ae()?wt({section:"magnets",title:"Your Magnets",description:"Pick a client to view and manage their magnets."}):(Pm(),`
    ...
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="Choose client" style="max-width:420px">
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(o){o.key==="Escape"&&(o.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.querySelector('[data-x="cancel"]').addEventListener("click",a),t.querySelector('[data-x="continue"]').addEventListener("click",()=>{const o=t.querySelector("#mag-owner-pick").value;a(),no(o,e)})}function zm(){if(G.owners.length>1){Ti();return}no(null)}function $i(e){if(G.owners.length>1){Ti(e);return}no(null,e)}function Hm(){Tm($i)}function jm(e){const t=e.target.closest("[data-action]");if(!t)return;const a=t.dataset.guid,n=G.magnets.find(s=>s.guid===a),o=t.dataset.action;if(o==="copy")return Gm(a);if(n){if(o==="preview")return eo(()=>Ta(n));if(o==="funnel")return Vm(n);if(o==="edit")return La(n);if(o==="flow")return La(n,"flow");if(o==="toggle")return Wm(n);if(o==="delete")return Ym(n)}}async function Gm(e){try{await navigator.clipboard.writeText(wi(e)),Ve("Embed snippet copied","success")}catch{Ve("Copy failed","danger")}}function Li(e){const t=Number(e?.total_steps)||0,a={};if((Array.isArray(e?.funnel)?e.funnel:[]).forEach(s=>{a[s.position]=Number(s.reached)||0}),!t||!Object.keys(a).length)return'<p class="mag-modal__hint" style="margin:0">No step activity yet in this window. As visitors answer questions, drop-off by step will appear here.</p>';const n=Math.max(1,a[1]||0),o=[];for(let s=1;s<=t;s++){const r=a[s]||0,i=Math.min(100,Math.round(r/n*100));o.push(`
      ...
      </div>`)}return`<div class="mag-funnel">${o.join("")}</div>`}async function Vm(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
...
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:Ii(e),actions:t,font:e.querySelector("#mag-f-font").value.trim(),theme_vars:eg(e),inline_width:e.querySelector("#mag-f-inline-w").value.trim(),inline_height:e.querySelector("#mag-f-inline-h").value.trim(),hide_launcher:e.querySelector("#mag-f-hide-launcher").checked,input_placeholder:e.querySelector("#mag-f-input-ph").value,summary_confirm_label:e.querySelector("#mag-f-summary-confirm").value.trim(),success_title:e.querySelector("#mag-f-success-title").value.trim(),success_text:e.querySelector("#mag-f-success-text").value,success_cta:tg(e)}}const Km=512,Jm=new Set(["image/png","image/jpeg","image/gif","image/webp"]),Qm=8*1024*1024;function Xm(e){return new Promise((t,a)=>{const n=new Image,o=new FileReader;o.onerror=()=>a(new Error("Could not read that file.")),o.onload=()=>{n.onerror=()=>a(new Error("That file isn’t a readable image.")),n.onload=()=>{const s=Math.min(1,Km/Math.max(n.naturalWidth,n.naturalHeight)),r=Math.max(1,Math.round(n.naturalWidth*s)),i=Math.max(1,Math.round(n.naturalHeight*s)),l=document.createElement("canvas");l.width=r,l.height=i,l.getContext("2d").drawImage(n,0,0,r,i),t(l.toDataURL("image/png"))},n.src=o.result},o.readAsDataURL(e)})}function Zm(e,t){const a=e.querySelector("#mag-logo-drop");if(!a)return;const n=e.querySelector("#mag-f-logo-file"),o=e.querySelector("#mag-logo-browse"),s=e.querySelector("#mag-logo-remove"),r=e.querySelector("#mag-logo-preview"),i=e.querySelector("#mag-logo-status"),l=e.querySelector("#mag-f-logo"),c=(p,f)=>{i.textContent=p,i.style.color=f?"var(--color-danger, #DD4124)":""},h=p=>{r.innerHTML=p?`<img src="${E(p)}" alt="">`:'<span class="material-symbols-outlined" aria-hidden="true">image</span>',s.hidden=!p},v=p=>{l.value=p,l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))};async function m(p){if(!Jm.has(p.type)){c("PNG, JPEG, GIF, or WEBP only.",!0);return}if(p.size>Qm){c("That file is too large (8MB max before resizing).",!0);return}c("Uploading…",!1);try{const f=await Xm(p),d=await fetch(`${oe()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({image:f})}),b=await d.json().catch(()=>({}));if(!d.ok||!b.ok)throw new Error(b.error||`Upload failed (${d.status})`);const _=`${oe()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;v(_),h(_),c("Logo updated.",!1)}catch(f){c(f.message||"Upload failed.",!0)}}n.addEventListener("change",()=>{n.files[0]&&m(n.files[0]),n.value=""}),a.addEventListener("click",p=>{p.target===s||s.contains(p.target)||p.target!==o&&n.click()}),o.addEventListener("click",()=>n.click()),["dragenter","dragover"].forEach(p=>a.addEventListener(p,f=>{f.preventDefault(),a.classList.add("is-dragover")})),["dragleave","drop"].forEach(p=>a.addEventListener(p,f=>{f.preventDefault(),a.classList.remove("is-dragover")})),a.addEventListener("drop",p=>{const f=p.dataTransfer?.files?.[0];f&&m(f)}),s.addEventListener("click",async p=>{p.stopPropagation(),c("Removing…",!1);try{const f=await fetch(`${oe()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"DELETE"}),d=await f.json().catch(()=>({}));if(!f.ok||!d.ok)throw new Error(d.error||`Remove failed (${f.status})`);v(""),h(""),c("Logo removed.",!1)}catch(f){c(f.message||"Remove failed.",!0)}})}function eg(e){return e.querySelector("#mag-f-surface-on")?.checked?{surface:e.querySelector("#mag-f-sv-surface").value,surface_2:e.querySelector("#mag-f-sv-surface2").value,border:e.querySelector("#mag-f-sv-border").value,text:e.querySelector("#mag-f-sv-text").value,text_sub:e.querySelector("#mag-f-sv-textsub").value}:{}}function tg(e){const t=e.querySelector("#mag-f-success-cta-label").value.trim(),a=e.querySelector("#mag-f-success-cta-url").value.trim();return t&&a?{label:t,url:a}:{}}function Ii(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",s=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==s.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}const Ln=[{label:"Web fonts (loaded for you)",opts:[["Inter, sans-serif","Inter"],["Poppins, sans-serif","Poppins"],["Montserrat, sans-serif","Montserrat"],["Roboto, sans-serif","Roboto"],['"Open Sans", sans-serif',"Open Sans"],["Lato, sans-serif","Lato"],["Nunito, sans-serif","Nunito"],["Raleway, sans-serif","Raleway"],['"Work Sans", sans-serif',"Work Sans"],["Oswald, sans-serif","Oswald"],["Merriweather, serif","Merriweather (serif)"]]},{label:"System / always available",opts:[["system-ui, sans-serif","System UI"],["Georgia, serif","Georgia (serif)"],['"Times New Roman", Times, serif',"Times (serif)"],["Arial, Helvetica, sans-serif","Arial / Helvetica"],["Verdana, Geneva, sans-serif","Verdana"],['"Courier New", monospace',"Courier (mono)"]]}];function ag(e){const t=String(e||""),a=new Set(Ln.flatMap(s=>s.opts.map(([r])=>r))),n=s=>s===t?" selected":"";let o=`<option value=""${t===""?" selected":""}>System default</option>`;t&&!a.has(t)&&(o+=`<option value="${E(t)}" selected>Current: ${E(t)}</option>`);for(const s of Ln)o+=`<optgroup label="${E(s.label)}">`+s.opts.map(([r,i])=>`<option value="${E(r)}"${n(r)}>${E(i)}</option>`).join("")+"</optgroup>";return o}function La(e,t,a={}){const{freshDraft:n=!1}=a,o=!!e,s=o?null:crypto.randomUUID(),r=!o&&G.owners.length>1,i=e?.display_mode||"chat",l=e?.theme_mode||"auto",c={};(e?.actions||[]).forEach(C=>{C&&C.type&&(c[C.type]=C)});const h=o?!!e.home:!0,v=o?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",m=e?.theme_vars&&typeof e.theme_vars=="object"?e.theme_vars:{},p=Object.keys(m).length>0,f=(C,j)=>E(/^#[0-9a-fA-F]{6}$/.test(m[C]||"")?m[C]:j),d=document.createElement("div");d.className="mag-modal-scrim",d.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${o?"Edit magnet":"New magnet"}">
      ...
      <div class="mag-modal__main">
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${Si.map(C=>`<option value="${C.value}"${(e?e.trigger||"none":"on_load")===C.value?" selected":""}>${E(C.label)}</option>`).join("")}
        </select>
        ...
        <div class="mag-modal__sec">
          ...
          <select class="mag-modal__select" id="mag-f-font">${ag(e?.font||"")}</select>
          ...
          <div class="mag-tog-row" style="margin-top:12px">
            <input type="checkbox" id="mag-f-surface-on"${p?" checked":""}>
            <label for="mag-f-surface-on">Custom surface colors (match a branded dark or light page)</label>
          </div>
          <div id="mag-f-surface" class="mag-surface-grid"${p?"":" hidden"}>
        ...
        <div class="mag-modal__sec">
          ...
          <div class="mag-tog-row">
            <input type="checkbox" id="mag-f-home"${h?" checked":""}>
    ...
    </div>`,document.body.appendChild(d),requestAnimationFrame(()=>{d.classList.add("open"),d.querySelector(".mag-modal").classList.add("open")});const b=[...d.querySelectorAll(".mag-modal__navitem")],_=[...d.querySelectorAll(".mag-tab")],y=C=>{b.forEach(j=>j.classList.toggle("is-active",j.dataset.tab===C)),_.forEach(j=>{j.hidden=j.dataset.tab!==C}),d.querySelector(".mag-modal__body").scrollTop=0};b.forEach(C=>C.addEventListener("click",()=>y(C.dataset.tab)));const x=()=>Ta({...e,...dn(d),...o?{steps:ls()}:{}}),T=d.querySelector("#mag-preview-pane"),N=()=>window.matchMedia("(min-width: 1200px)").matches;let q=null;const ue=()=>{if(!q&&N())try{q=ym(T,x)}catch{}};let $e=null;const he=()=>{N()&&(ue(),q&&(clearTimeout($e),$e=setTimeout(()=>{try{q.refresh()}catch{}},300)))},We=window.matchMedia("(min-width: 1200px)"),qe=()=>{N()&&(ue(),he())};We.addEventListener("change",qe);let B=!1,ne=!1;const z=d.querySelector("#mag-f-dirty"),K=C=>{B=C,z&&(z.hidden=!C)},at=d.querySelector(".mag-modal__main");at.addEventListener("input",()=>K(!0)),at.addEventListener("change",()=>{K(!0),he()}),d.querySelector("#mag-f-color")?.addEventListener("input",()=>{K(!0),he()});const nt=C=>{B&&(C.preventDefault(),C.returnValue="")};window.addEventListener("beforeunload",nt);let Ot=!0;const Ya=u.subscribe(g.ROUTE_NAV_BEFORE,()=>{if(Ot){if(B&&!confirm("Discard your changes to this magnet?")){window.router?.navigate("/magnets");return}w()}}),w=()=>{if(n&&!ne&&e&&e.status==="DRAFT"){fetch(`${oe()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"}).catch(()=>{}),G.magnets=G.magnets.filter(j=>j.guid!==e.guid);const C=document.getElementById("mag-body");C&&(C.innerHTML=`<div class="mag-grid">${G.magnets.map(ao).join("")}</div>`)}Ot=!1,window.removeEventListener("beforeunload",nt),u.unsubscribe(Ya),clearTimeout($e),We.removeEventListener("change",qe),q&&q.destroy&&q.destroy(),d.classList.remove("open"),setTimeout(()=>d.remove(),180),document.removeEventListener("keydown",M)},S=()=>{B&&!confirm("Discard your changes to this magnet?")||w()};function M(C){C.key==="Escape"&&(C.preventDefault(),S())}document.addEventListener("keydown",M),d.querySelector(".mag-modal__close").addEventListener("click",S),d.querySelector('[data-x="cancel"]').addEventListener("click",S),d.querySelector("[data-close-modal]")?.addEventListener("click",S),d.querySelector("#mag-f-name").focus();const W=d.querySelector("#mag-flow-panel");o?mm(W,e,()=>{K(!0),he()}):W.innerHTML='<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>',Zm(d,e),t&&y(t),ue(),d.querySelectorAll(".mag-cta").forEach(C=>{const j=C.querySelector(".mag-cta__on"),pe=C.querySelector(".mag-cta__val"),re=C.querySelector(".mag-cta__opts"),Ue=C.querySelectorAll(".mag-cta__booksrc, .mag-cta__calevent, .mag-cta__callsrc, .mag-cta__crtracker");j.addEventListener("change",()=>{pe&&(pe.disabled=!j.checked),re&&(re.disabled=!j.checked),Ue.forEach(J=>{J.disabled=!j.checked}),j.checked&&(pe||re)?.focus()}),pe&&pe.addEventListener("input",()=>{pe.value.trim()&&!j.checked&&(j.checked=!0,re&&(re.disabled=!1))})}),d.querySelectorAll('.mag-cta[data-kind="book"]').forEach(C=>{const j=C.querySelector(".mag-cta__booksrc"),pe=C.querySelector(".mag-cta__val"),re=C.querySelector(".mag-cta__calevent");if(!j||!re)return;const Ue=()=>{const J=j.value==="calendly";pe.hidden=J,re.hidden=!J,J&&!re.dataset.listed&&(re.dataset.listed="1",Rm(re))};j.addEventListener("change",()=>{const J=C.querySelector(".mag-cta__on");J.checked||(J.checked=!0,J.dispatchEvent(new Event("change"))),Ue()}),Ue()}),d.querySelectorAll('.mag-cta[data-type="call"]').forEach(C=>{const j=C.querySelector(".mag-cta__callsrc"),pe=C.querySelector(".mag-cta__val"),re=C.querySelector(".mag-cta__crtracker");if(!j||!re)return;const Ue=()=>{const J=j.value==="callrail";pe.hidden=J,re.hidden=!J,J&&!re.dataset.listed&&(re.dataset.listed="1",Om(re))};j.addEventListener("change",()=>{const J=C.querySelector(".mag-cta__on");J.checked||(J.checked=!0,J.dispatchEvent(new Event("change"))),Ue()}),Ue()});const U=d.querySelector("#mag-f-surface-on"),ke=d.querySelector("#mag-f-surface");U.addEventListener("change",()=>ke.hidden=!U.checked);const ot=d.querySelector("#mag-f-inline-size");d.querySelectorAll('input[name="mag-display"]').forEach(C=>C.addEventListener("change",()=>{ot.hidden=d.querySelector('input[name="mag-display"]:checked')?.value!=="inline"})),d.querySelector('[data-x="preview"]')?.addEventListener("click",()=>eo(()=>Ta({...e,...dn(d),...o?{steps:ls()}:{}}))),d.querySelector('[data-x="save"]').addEventListener("click",async C=>{const j=C.currentTarget,pe=d.querySelector("#mag-f-error"),re=d.querySelector("#mag-f-name").value.trim();if(!re){y("basics"),pe.textContent="Please give your magnet a name.";return}const Ue=d.querySelector("#mag-f-domains").value.split(",").map(Z=>Z.trim()).filter(Boolean);let J="";if(d.querySelectorAll(".mag-cta").forEach(Z=>{const Et=Z.querySelector(".mag-cta__on").checked;if(Z.dataset.kind==="book"){const Pt=Z.querySelector(".mag-cta__booksrc")?.value==="calendly";Et&&Pt&&!Z.querySelector(".mag-cta__calevent")?.value&&(J=J||"Pick a Calendly event for the Book button, or switch it back to the built-in scheduler.");return}if(Z.dataset.kind!=="value")return;if(Z.dataset.type==="call"&&Z.querySelector(".mag-cta__callsrc")?.value==="callrail"){Et&&!Z.querySelector(".mag-cta__crtracker")?.value&&(J=J||"Pick a CallRail tracking number for the Call button, or switch it back to a phone number.");return}const Mt=Z.querySelector(".mag-cta__val").value.trim();Et&&!Mt&&(J=J||`Add a target for the ${to[Z.dataset.type].label} button, or uncheck it.`)}),J){y("welcome"),pe.textContent=J;return}const io=Ii(d);if(io.enabled&&!Object.keys(io.b).length){y("ab"),pe.textContent="Give variant B at least one change (title, welcome, or color), or untick the A/B test.";return}if(o){const Z=hm();if(Z){y("flow"),pe.textContent=Z.message,fm(Z.route,Z.message,{uid:Z.uid,field:Z.field});return}}const Ka={name:re,domains:Ue,...dn(d)};r&&(Ka.owner_guid=d.querySelector("#mag-f-owner").value);const lo=o&&e.status==="DRAFT";lo&&(Ka.status="ENABLED"),j.disabled=!0,pe.textContent="";try{const Z=o?`${oe()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${oe()}/m5t/v5/magnets`,Et={"Content-Type":"application/json"};s&&(Et["Idempotency-Key"]=s);const Mt=await fetch(Z,{method:o?"PATCH":"POST",headers:Et,body:JSON.stringify(Ka)});let Pt={};try{Pt=await Mt.json()}catch{}if(!Mt.ok||!Pt.ok)throw new Error(Pt.message||`Save failed (${Mt.status})`);o&&await bm(e.guid),Ve(lo||!o?"Magnet created":"Magnet updated","success"),ne=!0,w(),await na()}catch(Z){j.disabled=!1,pe.textContent=Z.message||"Something went wrong."}})}const ng=Object.freeze(Object.defineProperty({__proto__:null,CTA_META:to,CTA_ORDER:Ci,DISPLAY_OPTS:ki,FONT_GROUPS:Ln,MODE_LABEL:Ei,THEME_OPTS:Ai,TRIGGER_OPTS:Si,cspNoteHTML:xi,init:Bm,openModal:La,render:Dm,stepFunnelHTML:Li},Symbol.toStringTag,{value:"Module"})),og={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},gs=e=>String(e??"").replace(/[&<>"']/g,t=>og[t]),sg=["provision_magnets","manage_magnets"],rg=()=>k.getCapabilities().some(e=>sg.includes(e));function ig(){const e=new Map;for(const t of et)e.set(t.category,(e.get(t.category)||0)+1);return Object.keys(vi).filter(t=>e.has(t)).map(t=>[t,e.get(t)])}const hs=(e,t,a,n)=>`<button class="m5t-chip--filter" type="button" data-cat="${gs(e)}" aria-pressed="${n}">${gs(t)}<span class="m5t-chip__count">${a}</span></button>`;let fs=!1;function lg(){if(yi(),fs)return;const e=document.createElement("style");e.id="m5t-templates-page-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),fs=!0}function Ri(){lg();const e=rg();return`
    <div class="page-shell" data-section="templates">
      ...
      <div class="m5t-chip-row tpl-filters" id="tpl-filters" role="group" aria-label="Filter templates by category">
        ...
        ${ig().map(([t,a])=>hs(t,vi[t],a,"false")).join("")}
      </div>

      <div class="mag-tpl-grid mag-tpl-grid--page" id="tpl-grid">
        ${et.map(t=>bi(t,{detail:!0,gallery:!0,canUse:e})).join("")}
      </div>
    </div>`}function Ni(){const e=document.getElementById("tpl-grid");document.getElementById("tpl-filters")?.addEventListener("click",t=>{const a=t.target.closest("[data-cat]");if(!a)return;a.parentElement.querySelectorAll("[data-cat]").forEach(o=>{o.setAttribute("aria-pressed",String(o===a))});const n=a.dataset.cat;e?.querySelectorAll(".mag-tpl-card").forEach(o=>{o.hidden=!(n==="all"||o.dataset.cat===n)})}),e?.addEventListener("click",t=>{const a=t.target.closest("[data-preview]");if(a){const o=et.find(s=>s.id===a.dataset.preview);o&&eo(()=>Ta({...o.appearance,steps:o.steps,name:o.name}));return}const n=t.target.closest("[data-tpl]");n&&(Am(n.dataset.tpl),window.location.hash="#/magnets")})}const cg={render:Ri,init:Ni},dg=Object.freeze(Object.defineProperty({__proto__:null,default:cg,init:Ni,render:Ri},Symbol.toStringTag,{value:"Module"})),pg={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},De=e=>String(e??"").replace(/[&<>"']/g,t=>pg[t]);function oo(e){if(!e)return"";try{return new Date(e).toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}catch{return String(e)}}function ug(e,t={}){const a=t[e.id];if(e.type==="checkbox_group"){const n=Array.isArray(a)?a:[];return n.length?De(n.join(", ")):""}return a?De(a):""}function Oi(e,{emptyLabel:t="(blank)",renderAnswer:a=null}={}){const n=e?.questionnaire?.sections||[],o=e?.answers||{};return n.length?n.map(s=>`
    <div class="qm-section">
      <h3>${De(s.title)}</h3>
      ${(s.questions||[]).map(r=>`
        <div class="qm-qa" data-question-id="${De(r.id)}" data-question-type="${De(r.type)}">
          <div class="qm-qa__q">${De(r.label)}</div>
          <div class="qm-qa__a">${a?a(r,o):ug(r,o)||`<span class="qm-qa__a--empty">${De(t)}</span>`}</div>
        </div>`).join("")}
    </div>`).join(""):'<p class="qm-qa__a qm-qa__a--empty">This questionnaire has no questions.</p>'}function Mi(e){const t=e?.recipient_email?`<p class="qm-recipient">Sent to ${De(e.recipient_email)}</p>`:"",a=e?.last_edited_tz?`<p class="qm-edited-marker">Last edited by ${De(e.last_edited_by_email||"a team member")} on ${De(oo(e.last_edited_tz))}</p>`:"";return t+a}let vs=!1;function Pi(){if(vs)return;const e=document.createElement("style");e.id="m5t-questionnaire-answer-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),vs=!0}const mg={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Le=e=>String(e??"").replace(/[&<>"']/g,t=>mg[t]),In=()=>k.getConfig?.().BASE_URL||"",bs=(e,t="info")=>{try{u.publish(g.UI_TOAST,{message:e,type:t})}catch{}},gg="managed_client",Rn=[["ALL","All"],["NOT_SENT","Not sent"],["DRAFT","Awaiting response"],["SUBMITTED","Submitted"],["CANCELLED","Cancelled"]],Fi=Object.fromEntries(Rn),de={clients:[],responses:[],filter:"ALL",search:"",openGuid:null};let _s=!1;function hg(){if(Pi(),_s)return;const e=document.createElement("style");e.id="m5t-questionnaires-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),_s=!0}const Zt=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function so(){return de.clients.map(e=>{const t=de.responses.filter(n=>n.owner_guid===e.guid),a=t[0]||null;return{guid:e.guid,name:e.caption||e.name||e.guid,latest:a,earlier:Math.max(0,t.length-1),status:a?a.status:"NOT_SENT"}})}function Di(){const e=de.search.trim().toLowerCase();return so().filter(t=>(de.filter==="ALL"||t.status===de.filter)&&(!e||t.name.toLowerCase().includes(e)))}const ys=(e,t)=>e?.latest?.[t]?oo(e.latest[t]):"—";function Bi(e){const t=e.status==="SUBMITTED",a=e.status==="SUBMITTED"?`<button class="qz-act" type="button" data-act="open" data-guid="${Le(e.latest.guid)}">Read answers</button>`:e.status==="DRAFT"?`<button class="qz-act" type="button" data-act="copy" data-url="${Le(e.latest.url||"")}">Copy link</button>`:'<a class="qz-act" href="#/clients">Go to client</a>';return`<tr class="${t?"qz-row--open":""}"${t?` data-open-guid="${Le(e.latest.guid)}"`:""}>
    ...
    </div>`}async function Ui(){await fg()}async function fg(){const e=document.getElementById("qz-body");if(e){try{const[t,a]=await Promise.all([fetch(`${In()}/m5t/v5/acctGroup`),fetch(`${In()}/m5t/v5/m5mQuestionnaireResponse`)]),n=await t.json().catch(()=>({})),o=await a.json().catch(()=>({}));if(!t.ok||!a.ok)throw new Error("load failed");de.clients=(n.data||[]).filter(s=>s.class===gg&&!["DELETED","ARCHIVED"].includes(s.status)).sort((s,r)=>String(s.caption||"").localeCompare(String(r.caption||""))),de.responses=o.data||[]}catch{e.innerHTML=Zt("error","Could not load questionnaires. Please try again.");return}zi()}}function zi(){const e=document.getElementById("qz-body");if(!e)return;if(!de.clients.length){e.innerHTML=Zt("groups","No clients yet. Add a client first, then send them a kickoff questionnaire.");return}const t=so(),a={ALL:t.length};Rn.slice(1).forEach(([o])=>{a[o]=t.filter(s=>s.status===o).length});const n=Di();e.innerHTML=`
    <div class="qz-bar">
      <div class="qz-filter">
    ...
    </div>`,e.querySelector(".qz-filter")?.addEventListener("click",o=>{const s=o.target.closest("[data-filter]");s&&(de.filter=s.dataset.filter,zi())}),e.querySelector("#qz-search")?.addEventListener("input",o=>{de.search=o.target.value,vg()}),e.querySelector("#qz-tbody")?.addEventListener("click",bg)}function vg(){const e=document.getElementById("qz-tbody");if(!e)return;const t=Di();e.innerHTML=t.length?t.map(Bi).join(""):'<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">No clients match your search.</div></td></tr>';const a=document.querySelector(".qz-count");a&&(a.textContent=`${t.length} of ${so().length}`)}function bg(e){const t=e.target.closest('[data-act="copy"]');if(t){e.stopPropagation();const s=t.dataset.url;if(!s){bs("No link on this questionnaire yet.","warning");return}navigator.clipboard?.writeText(s).then(()=>{t.textContent="Copied!",setTimeout(()=>{t.textContent="Copy link"},1500)},()=>bs("Could not copy the link.","error"));return}const a=e.target.closest('[data-act="open"]'),n=e.target.closest("[data-open-guid]"),o=a?.dataset.guid||n?.dataset.openGuid;o&&_g(o)}async function _g(e){de.openGuid=e;const t=document.createElement("div");t.className="qz-drawer-scrim";const a=document.createElement("aside");a.className="qz-drawer",a.setAttribute("role","dialog"),a.setAttribute("aria-label","Questionnaire answers"),a.innerHTML=`
  ...
  `,document.head.appendChild(e),ws=!0}function ea(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Sg(e){return`<select class="leads-status" data-id="${P(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${Nn.map(t=>`<option value="${t}" ${e.status===t?"selected":""}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join("")}
  </select>`}function Cg(e){const t=A.magnetNames[e.magnet_guid]||e.lead_source||"—",a=e.phone?String(e.phone).replace(/[^\d+]/g,""):"";return`
    <tr class="leads-row${String(e.id)===A.selectedId?" selected":""}" data-id="${P(e.id)}" tabindex="0" role="button" aria-label="Open lead ${P(Na(e))}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${P(Hi(e))}</span>
          <span><span class="leads-name">${P(Na(e))}</span>${e.company?`<span class="leads-sub">${P(e.company)}</span>`:""}</span>
        </span>
      </td>
      ...
      <td>${A.canManage?Sg(e):`<span class="leads-badge" data-s="${P(e.status)}">${P(e.status)}</span>`}</td>
      <td class="num leads-muted" style="white-space:nowrap" title="${P(Tt(e))}">${kg(e)?'<span class="leads-fresh" title="Captured in the last 24 hours"></span>':""}${P(Eg(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}const ji=e=>A.clientFilter==="ALL"||e.owner_guid===A.clientFilter;function Tg(e){const t=A.search.trim().toLowerCase();if(!t)return!0;const a=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,A.magnetNames[e.magnet_guid],A.book?A.ownerNames[e.owner_guid]:"",e.utm_campaign,e.utm_source].filter(Boolean).join(" ").toLowerCase();return t.split(/\s+/).every(n=>a.includes(n))}const $g=e=>!A.day||Wa(e).slice(0,10)===A.day;function Gi(){return A.leads.filter(e=>(A.filter==="ALL"||e.status===A.filter)&&ji(e)&&Tg(e)&&$g(e))}function Lg(){if(!A.day)return"";let e=A.day;try{e=new Date(`${A.day}T00:00:00Z`).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric",timeZone:"UTC"})}catch{}return`<button class="leads-daychip" type="button" id="leads-dayclear" title="Show every day again">
  ...
  </button>`}const Vi=()=>ea("touch_app","Click to see lead information.");function Ig(){Ag(),yt();const e=ae();return`
  ...
  <colgroup>
    ...
    <div class="leads-bar">
      ...
      <select class="leads-clientsel" id="leads-clientsel" aria-label="Filter by client">
        ...
        ${o.map(s=>`<option value="${P(s.guid)}" ${A.clientFilter===s.guid?"selected":""}>${P(s.name)}</option>`).join("")}
      </select>`:""}
      ${Lg()}
      <span class="leads-searchwrap">
        <span class="material-symbols-outlined" aria-hidden="true">search</span>
        <input class="leads-search" id="leads-search" type="search" placeholder="Search leads" value="${P(A.search)}" aria-label="Search leads" />
      </span>
    ...
    ${t.description?`<div class="leads-det__notes">${P(t.description)}</div>`:""}`}function Pg(){const e=Gi();if(!e.length){Ia("Nothing to export","info");return}const t=["first_name","last_name","email","phone","company","product_interest","lead_source","utm_source","utm_medium","utm_campaign","gclid","status"],a=l=>`"${String(l??"").replace(/"/g,'""')}"`,o=[[...A.book?["client"]:[],...t,"magnet","captured","appointment","last_call"].join(",")];for(const l of e){const c=Wi(l),h=Yi(l);o.push([...A.book?[a(A.ownerNames[l.owner_guid]||"")]:[],...t.map(v=>a(l[v])),a(A.magnetNames[l.magnet_guid]||l.lead_source||""),a(Tt(l)),a(c?`${c.start} (${c.status})`:""),a(h?`${h.started} (${h.answered==="no"?"missed":"answered"})`:"")].join(","))}const s=new Blob([o.join(`
`)],{type:"text/csv"}),r=URL.createObjectURL(s),i=document.createElement("a");i.href=r,i.download=`leads-${A.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r),Ia(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const Fg=Object.freeze(Object.defineProperty({__proto__:null,init:Rg,render:Ig},Symbol.toStringTag,{value:"Module"})),Ji=()=>k.getConfig?.().BASE_URL||"",ks=e=>e.toISOString().slice(0,10),Ge=e=>Number(e||0).toLocaleString(),Dg={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},da=e=>String(e??"").replace(/[&<>"']/g,t=>Dg[t]),Vt=e=>e==null?"—":`${e}%`,Bg=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let Oa=30,As=!1;function Qi(){if(As)return;const e=document.createElement("style");e.id="m5t-analytics-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),As=!0}const ya=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,pa=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
  ...
  </div>`;function qg(e,t){const a=t>0?Math.round(e/t*100):0;return`<svg class="anl-bar" width="72" height="8" viewBox="0 0 72 8" role="img"
    ...
    <tbody>${e.map(n=>Ug(n,a,t)).join("")}</tbody>
  </table></div>`}function zg(){return ae()?wt({section:"analytics",title:"Analytics",description:"Pick a client to see how their magnets are performing."}):(Qi(),`
    <div class="page-shell" data-section="analytics">
      <div class="page-header">
        ...
        <div class="chart-controls" id="anl-periods">
          ${Bg.map(e=>`<button class="chart-period-btn${e.d===Oa?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>
    ...
    </div>`)}async function Hg(){if(ae())return tt(Ji(),[{h:"Leads",td:t=>Ge(t.leads.window??t.leads.total)},{h:"Opens",td:t=>Ge(t.opens)},{h:"Completed",td:t=>Vt(t.completion_rate)}]);Qi(),await Cs();const e=document.getElementById("anl-periods");e&&e.addEventListener("click",t=>{const a=t.target.closest(".chart-period-btn");a&&(Oa=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>{n.classList.toggle("active",Number(n.dataset.days)===Oa)}),Cs())})}async function Cs(){const e=document.getElementById("anl-body"),t=document.getElementById("anl-range");if(!e)return;e.innerHTML=ya("hourglass_empty","Loading magnet performance…");const a=new Date,n=ks(a),o=ks(new Date(a.getTime()-(Oa-1)*864e5));t&&(t.textContent=`${o} → ${n}`);let s;try{const m=await fetch(`${Ji()}/m5t/v5/dashboard/stats?from=${o}&to=${n}&group_by=magnet`);if(s=await m.json(),!m.ok||!s?.ok)throw new Error(s?.error||`HTTP ${m.status}`)}catch(m){e.innerHTML=ya("cloud_off","Could not load analytics. Refresh to try again."),console.error("[analytics] load failed:",m);return}const r=(m,p)=>{const f=document.getElementById(m);f&&(f.textContent=p)};r("anl-leads",Ge(s.by_day?.reduce((m,p)=>m+Number(p.leads||0),0))),r("anl-opens",Ge(s.funnel?.opens)),r("anl-completion",Vt(s.funnel?.completion_rate)),r("anl-active",Ge(s.magnets?.active));const i=Array.isArray(s.by_magnet)?s.by_magnet:[];if(!i.length){e.innerHTML=ya("widgets","No magnets yet. Create one and its numbers will show up here.");return}const l=i.some(m=>Number(m.opens||0)>0||Number(m.leads?.window||0)>0),c=new Set(i.map(m=>m.owner_guid)).size>1,h=s.by_magnet_truncated?`<p class="anl-warn">Showing the top ${i.length} magnets by leads. You have more than that, so this list is not complete.</p>`:"",v=l?"":'<p class="anl-warn">No opens or leads for any magnet in this period. Try a longer range.</p>';e.innerHTML=h+v+Xi(i,c)}const jg=Object.freeze(Object.defineProperty({__proto__:null,init:Hg,render:zg,tableHTML:Xi},Symbol.toStringTag,{value:"Module"})),Zi=()=>k.getConfig?.().BASE_URL||"",Ts=e=>e.toISOString().slice(0,10),Mn=e=>e==null?"—":"$"+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),Qe=e=>Number(e||0).toLocaleString(),Gg={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},St=e=>String(e??"").replace(/[&<>"']/g,t=>Gg[t]);let $s=!1;function Vg(){if($s)return;const e=document.createElement("style");e.id="m5t-adperf-styles",e.textContent=`
  ...
  <div class="stat-card">
    ...
    <div class="stat-value" id="${a}">${n}</div>
  </div>`,Wg=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let Ma=30;function el(){return ae()?wt({section:"ad-performance",title:"Ad Performance",description:"Pick a client to view their spend and lead performance."}):(Vg(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${Wg.map(e=>`<button class="chart-period-btn${e.d===Ma?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>
    ...
    </div>`)}async function tl(){if(ae()){const t=a=>Number(a||0).toLocaleString();return tt(Zi(),[{h:"Spend",td:a=>a.ad?`$${t(a.ad.spend)}`:"—"},{h:"Clicks",td:a=>a.ad?t(a.ad.clicks):"—"},{h:"Leads",td:a=>t(a.leads.window??a.leads.total)},{h:"CPL",td:a=>a.ad?.cost_per_lead!=null?`$${t(a.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see spend here."})}const e=document.getElementById("adperf-periods");e?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(Ma=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===Ma)),Ls())}),await Ls()}async function Ls(){const e=Zi(),t=document.getElementById("adperf-body"),a=document.getElementById("adperf-range"),n=new Date,o=Ts(n),s=Ts(new Date(n.getTime()-(Ma-1)*864e5));a&&(a.textContent=`${s} → ${o}`);let r,i=[],l=null,c=null,h=null;try{const[m,p,f,d,b]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${s}&to=${o}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${s}&to=${o}`),Ha().catch(()=>null),fetch(`${e}/m5t/v5/coreAdMetrics/conversions?from=${s}&to=${o}`).then(y=>y.json()).catch(()=>null)]);if(!m.ok)throw new Error(`HTTP ${m.status}`);r=await m.json(),i=((await p.json().catch(()=>({})))?.data||[]).filter(y=>y.status!=="DELETED"),l=await f.json().catch(()=>null),c=d,h=b}catch(m){console.warn("[ad-performance] load failed:",m),t&&(t.innerHTML=gt("error","Could not load ad performance. Please try again."));return}Yg(c,i),Kg(h);const v=r.totals||{};if(ma("adperf-spend",Mn(v.spend)),ma("adperf-clicks",Qe(v.clicks)),ma("adperf-leads",Qe(v.magnet_leads)),ma("adperf-cpl",Mn(v.cost_per_lead)),Jg(l),!i.length){t.innerHTML=gt("link_off","No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.");return}if(!r.connected){t.innerHTML=gt("cloud_sync","Account connected. No ad data for this range yet. Metrics appear here once they sync.");return}t.innerHTML=Qg(r.rows||[])}function Yg(e,t){const a=document.getElementById("adperf-conn");if(!a)return;if(!e||e.denied){a.innerHTML="";return}const n=Se.google_ads,o=qa(e.providers,"google_ads"),s=Ua(n,o,!!e.configured?.google_ads),r=Te()?` <a href="#/settings/integrations/${n.urlSlug}">Manage</a>`:"";if(s==="connected"||s==="broken"){ja(),a.innerHTML=`<span>Google Ads</span> ${za(s,o)}${r}`;return}if(t.length){a.innerHTML=`<span>Google Ads</span> <span>${t.length} associated account${t.length===1?"":"s"}</span>`;return}a.innerHTML=""}function Kg(e){const t=document.getElementById("adperf-conv-card"),a=document.getElementById("adperf-conv-body"),n=document.getElementById("adperf-stats"),o=document.getElementById("adperf-conv-stat");if(o&&o.remove(),!t||!a)return;if(!e?.ok||!e.has_selection){t.style.display="none";return}if(n){const i=document.createElement("div");i.className="stat-card",i.id="adperf-conv-stat",i.innerHTML=`
      <div class="stat-header">
    ...
    </div>`}function ma(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}function Is(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}function Rs(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e)}function Qg(e){const p=e.length||1,f=Is(Math.max(1,...e.map(B=>B.spend||0))),d=Is(Math.max(1,...e.map(B=>B.magnet_leads||0))),b=738/p,_=Math.min(24,b*.55),y=B=>56+b*(B+.5),x=B=>304-B/f*282,T=B=>304-B/d*282,N=[0,.25,.5,.75,1].map(B=>{const ne=304-B*282;return`<line x1="56" y1="${ne.toFixed(1)}" x2="794" y2="${ne.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${(ne+3.5).toFixed(1)}" text-anchor="end" class="ax">$${Rs(f*B)}</text><text x="802" y="${(ne+3.5).toFixed(1)}" text-anchor="start" class="ax">${Rs(d*B)}</text>`}).join(""),q=e.map((B,ne)=>{const z=x(B.spend||0);return`<rect x="${(y(ne)-_/2).toFixed(1)}" y="${z.toFixed(1)}" width="${_.toFixed(1)}" height="${Math.max(0,304-z).toFixed(1)}" rx="3" fill="#0072BA"><title>${B.date}: $${B.spend} spend</title></rect>`}).join(""),ue=e.map((B,ne)=>`${y(ne).toFixed(1)},${T(B.magnet_leads||0).toFixed(1)}`).join(" "),$e=p>1?`<polyline points="${ue}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",he=e.map((B,ne)=>`<circle cx="${y(ne).toFixed(1)}" cy="${T(B.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${B.date}: ${B.magnet_leads} leads</title></circle>`).join(""),We=Math.max(1,Math.ceil(p/6)),qe=e.map((B,ne)=>ne%We===0||ne===p-1?`<text x="${y(ne).toFixed(1)}" y="326" text-anchor="middle" class="ax">${B.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="adperf-chart" viewBox="0 0 840 340" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Ad spend versus magnet leads over time">
      ${N}${q}${$e}${he}${qe}
    </svg>`}const Xg={render:el,init:tl},Zg=Object.freeze(Object.defineProperty({__proto__:null,default:Xg,init:tl,render:el},Symbol.toStringTag,{value:"Module"})),eh={google_ads:"Google Ads",google_lsa:"Local Services Ads"},th=e=>{const t=String(e||"").replace(/\D/g,"");return t.length===10?`${t.slice(0,3)}-${t.slice(3,6)}-${t.slice(6)}`:String(e||"")};let Ns=!1;function ah(){if(Ns)return;const e=document.createElement("style");e.id="m5t-adacct-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ns=!0}function al(){return ae()?wt({section:"ad-accounts",title:"Ad Accounts",description:"Pick a client to see their connected ad accounts."}):(ah(),ja(),`
...
`&&c++,a.push(n),n="",a.some(v=>v.trim()!=="")&&t.push(a),a=[]):n+=h}if(a.push(n),a.some(c=>c.trim()!=="")&&t.push(a),t.length<2)return[];const s=t[0].map(c=>c.trim().toLowerCase()),r=s.findIndex(c=>/e-?mail/.test(c)),i=s.findIndex(c=>/phone|mobile|tel/.test(c)),l=s.findIndex(c=>/date|time|booked|appointment|start/.test(c));return r<0&&i<0?[]:t.slice(1).map(c=>({email:r>=0?(c[r]||"").trim():"",phone:i>=0?(c[i]||"").trim():"",at:l>=0?(c[l]||"").trim():""})).filter(c=>c.email||c.phone).slice(0,5e3)}function rl(e,t){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),o=document.createElement("a");o.href=n,o.download=t,document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(n),4e3)}const uh={render:al,init:nl},mh=Object.freeze(Object.defineProperty({__proto__:null,default:uh,init:nl,parseBookingCsv:sl,render:al},Symbol.toStringTag,{value:"Module"})),Ms="reseller_org",il="managed_client";let Ps=!1;const gh={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},F=e=>String(e??"").replace(/[&<>"']/g,t=>gh[t]);function ht(e,t="info"){try{u.publish(g.UI_TOAST,{message:e,type:t})}catch{}}function hh(){const e=k.getActiveOrg();if(e&&e.channel===Ms)return{guid:e.guid,name:e.name};const t=k.getMemberships().find(a=>a.channel===Ms);return t?{guid:t.orgGuid,name:t.name}:null}function fh(e){const t=e?.created_tz;if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function vh(){if(Ps)return;const e=document.createElement("style");e.id="m5t-clients-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Pi(),Ps=!0}const bh=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Wt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function _h(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
    <div class="client-row">
      <span class="client-row__avatar">${F(bh(t))}</span>
      <span class="client-row__main">
        <div class="client-row__name" title="${F(t)}">${F(t)}</div>
        <div class="client-row__meta">Added ${F(fh(e.created))||"—"}</div>
      </span>
    ...
    </div>`}async function cl(){const e=hh();document.getElementById("clients-add-btn")?.addEventListener("click",()=>yh(e)),await dl(e)}async function dl(e){const t=document.getElementById("clients-body"),a=document.getElementById("clients-count");if(t){if(!e?.guid){t.innerHTML=Wt("info","Client provisioning is available to reseller / agency accounts."),a&&(a.textContent="");return}try{const n=k.getConfig?.().BASE_URL||"",o=await fetch(`${n}/m5t/v5/acctGroup`);if(!o.ok)throw new Error(`HTTP ${o.status}`);const s=await o.json(),i=(Array.isArray(s?.data)?s.data:[]).filter(l=>l.class===il&&(!l.parent||l.parent===e.guid));if(!i.length){t.innerHTML=Wt("group_off","No clients yet. Add your first client to start managing magnets on their behalf."),a&&(a.textContent="");return}t.innerHTML=`<div class="client-list">${i.map(_h).join("")}</div>`,a&&(a.textContent=`${i.length} client${i.length===1?"":"s"}`),t.querySelectorAll(".client-card__invite").forEach(l=>{l.addEventListener("click",()=>{l.dataset.action==="adaccounts"?wh(l.dataset.clientGuid,l.dataset.clientName):l.dataset.action==="questionnaire"?Eh(l.dataset.clientGuid,l.dataset.clientName):xh(l.dataset.clientGuid,l.dataset.clientName)})})}catch(n){console.warn("[clients] load failed:",n),t.innerHTML=Wt("error","Couldn’t load clients. Please try again."),a&&(a.textContent="")}}}function yh(e){if(!e?.guid){ht("Only reseller / agency accounts can add clients.","error");return}const t=document.createElement("div");t.className="client-modal-scrim";const a=document.createElement("div");a.className="client-modal",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),document.body.appendChild(a),requestAnimationFrame(()=>{t.classList.add("open"),a.classList.add("open")});const n=a.querySelector("#client-name-input"),o=a.querySelector("#client-modal-error"),s=a.querySelector('[data-act="create"]');n?.focus();const r=()=>{t.classList.remove("open"),a.classList.remove("open"),document.removeEventListener("keydown",i),setTimeout(()=>{t.remove(),a.remove()},200)},i=c=>{c.key==="Escape"&&r()};document.addEventListener("keydown",i),t.addEventListener("click",r),a.querySelector(".client-modal__close")?.addEventListener("click",r),a.querySelector('[data-act="cancel"]')?.addEventListener("click",r);const l=async()=>{const c=(n?.value||"").trim();if(o.textContent="",!c){o.textContent="Please enter a client name.",n?.focus();return}s.disabled=!0;const h=s.innerHTML;s.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Adding…';try{const v=k.getConfig?.().BASE_URL||"",m=await fetch(`${v}/m5t/v5/acctGroup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({class:il,caption:c,parent:e.guid})}),p=await m.json().catch(()=>({}));if(!m.ok||!p?.ok){const f=m.status===403?"You are not authorized to add a client here.":p?.message||p?.error||`Failed (HTTP ${m.status})`;throw new Error(f)}ht(`Added client “${c}”`,"success"),r(),await dl(e)}catch(v){console.warn("[clients] create failed:",v),o.textContent=v.message||"Something went wrong. Please try again.",s.disabled=!1,s.innerHTML=h}};s?.addEventListener("click",l),n?.addEventListener("keydown",c=>{c.key==="Enter"&&l()})}const Fs=e=>String(e||"").replace(/[^0-9]/g,"");async function wh(e,t){const a=k.getConfig?.().BASE_URL||"",n={};try{const f=await fetch(`${a}/m5t/v5/coreAdAccount?owner_guid=${encodeURIComponent(e)}`),d=await f.json().catch(()=>({}));if(!f.ok)throw new Error(`Failed to load ad accounts (${f.status})`);(d?.data||[]).forEach(b=>{n[b.provider]=b})}catch(f){console.warn("[clients] ad-accounts prefill failed:",f)}const o=n.google_ads,s=n.google_lsa,r=document.createElement("div");r.className="client-modal-scrim";const i=document.createElement("div");i.className="client-modal",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.innerHTML=`
    <div class="client-modal__head">
    ...
    </div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add("open"),i.classList.add("open")});const l=i.querySelector("#aa-error"),c=i.querySelector('[data-act="save"]'),h=()=>{r.classList.remove("open"),i.classList.remove("open"),document.removeEventListener("keydown",v),setTimeout(()=>{r.remove(),i.remove()},200)},v=f=>{f.key==="Escape"&&h()};document.addEventListener("keydown",v),r.addEventListener("click",h),i.querySelector(".client-modal__close")?.addEventListener("click",h),i.querySelector('[data-act="cancel"]')?.addEventListener("click",h);const m=(f,d,b)=>{const _=`${a}/m5t/v5/coreAdAccount`;return d&&!b?fetch(_,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,provider:f,external_customer_id:d})}):d&&b&&d!==b.external_customer_id?fetch(`${_}/${encodeURIComponent(b.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({external_customer_id:d})}):!d&&b?fetch(`${_}/${encodeURIComponent(b.guid)}`,{method:"DELETE"}):null},p=async()=>{l.textContent="";const f=Fs(i.querySelector("#aa-gads").value),d=Fs(i.querySelector("#aa-lsa").value),b=[m("google_ads",f,o),m("google_lsa",d,s)].filter(Boolean);if(!b.length){h();return}c.disabled=!0;const _=c.innerHTML;c.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const y=await Promise.all(b);for(const x of y)if(!x.ok){const T=await x.json().catch(()=>({}));throw new Error(x.status===403?"You are not authorized to connect accounts for this client.":T?.error||T?.message||`Failed (HTTP ${x.status})`)}ht("Ad accounts updated","success"),h()}catch(y){l.textContent=y.message||"Something went wrong. Please try again.",c.disabled=!1,c.innerHTML=_}};c?.addEventListener("click",p)}function xh(e,t){if(!e)return;const a=document.createElement("div");a.className="client-modal-scrim";const n=document.createElement("div");n.className="client-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="invite-body">
      ...
      <div class="client-modal__actions">
    ...
    </div>`,document.body.appendChild(a),document.body.appendChild(n),requestAnimationFrame(()=>{a.classList.add("open"),n.classList.add("open")});const o=()=>{a.classList.remove("open"),n.classList.remove("open"),document.removeEventListener("keydown",s),setTimeout(()=>{a.remove(),n.remove()},200)},s=h=>{h.key==="Escape"&&o()};document.addEventListener("keydown",s),a.addEventListener("click",o),n.querySelector(".client-modal__close")?.addEventListener("click",o),n.querySelector('[data-act="cancel"]')?.addEventListener("click",o);const r=n.querySelector("#inv-email"),i=n.querySelector("#inv-error"),l=n.querySelector('[data-act="send"]');r?.focus();const c=h=>h.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(h.dataset.url),h.textContent="Copied!",setTimeout(()=>{h.textContent="Copy link"},1500)}catch{}});(async function(){const v=n.querySelector("#invite-pending");if(v)try{const m=k.getConfig?.().BASE_URL||"",p=await fetch(`${m}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invites`),f=await p.json().catch(()=>({})),d=p.ok&&f.ok&&Array.isArray(f.invites)?f.invites:[];if(!d.length){v.innerHTML="";return}v.innerHTML=`
        <div class="invite-pending">
          <div class="invite-pending__label">Pending invites</div>
          ${d.map(b=>`
            <div class="invite-pending__row">
              <span class="invite-pending__email${b.expired?" expired":""}" title="${F(b.email)}">${F(b.email)}${b.expired?" · expired":""}</span>
              <button class="client-modal__btn client-modal__btn--ghost invite-pending__copy" type="button" data-url="${F(b.inviteUrl)}">Copy link</button>
            </div>`).join("")}
        </div>`,v.querySelectorAll(".invite-pending__copy").forEach(c)}catch{v.innerHTML=""}})(),l?.addEventListener("click",async()=>{const h=(n.querySelector("#inv-email").value||"").trim(),v=(n.querySelector("#inv-first").value||"").trim(),m=(n.querySelector("#inv-last").value||"").trim();if(i.textContent="",!h||!v||!m){i.textContent="Email, first, and last name are required.";return}l.disabled=!0;const p=l.innerHTML;l.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Sending…';try{const f=k.getConfig?.().BASE_URL||"",d=await fetch(`${f}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:h,first:v,last:m})}),b=await d.json().catch(()=>({}));if(!d.ok||!b.ok){const y=d.status===409?"A user with that email already exists.":d.status===403?"You are not authorized to invite for this client.":b.message||b.error||`Failed (HTTP ${d.status})`;throw new Error(y)}ht(`Invite created for ${h}`,"success"),n.querySelector("#invite-body").innerHTML=`
        <div class="client-modal__result">
          ...
          <p>${b.emailQueued?`An invite email is on its way to <strong>${F(h)}</strong>.`:`Invite created for <strong>${F(h)}</strong>.`}</p>
          ...
          <div class="client-modal__linkrow">
            <input class="client-modal__input" id="inv-link" type="text" readonly value="${F(b.inviteUrl)}" />
        ...
        </div>`;const _=n.querySelector("#inv-link");n.querySelector("#inv-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(_.value),n.querySelector("#inv-copy").textContent="Copied!"}catch{_.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",o)}catch(f){console.warn("[clients] invite failed:",f),i.textContent=f.message||"Something went wrong. Please try again.",l.disabled=!1,l.innerHTML=p}})}function pn(e){if(!e)return"";const t=new Date(e);return Number.isNaN(t.getTime())?"":t.toLocaleString(void 0,{year:"numeric",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}async function Eh(e,t){if(!e)return;const a=k.getConfig?.().BASE_URL||"",n=document.createElement("div");n.className="client-modal-scrim";const o=document.createElement("div");o.className="client-modal",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),o.innerHTML=`
    <div class="client-modal__head">
      <span class="client-modal__title">Kickoff Questionnaire: ${F(t)}</span>
      <button class="client-modal__close" type="button" aria-label="Close">&times;</button>
    </div>
    <div class="client-modal__body" id="qm-body">${Wt("hourglass_empty","Loading…")}</div>`,document.body.appendChild(n),document.body.appendChild(o),requestAnimationFrame(()=>{n.classList.add("open"),o.classList.add("open")});const s=()=>{n.classList.remove("open"),o.classList.remove("open"),document.removeEventListener("keydown",r),setTimeout(()=>{n.remove(),o.remove()},200)},r=p=>{p.key==="Escape"&&s()};document.addEventListener("keydown",r),n.addEventListener("click",s),o.querySelector(".client-modal__close")?.addEventListener("click",s);const i=o.querySelector("#qm-body");function l(){i.innerHTML=`
      <p class="client-modal__sub">Send a Client Kickoff Questionnaire to <strong>${F(t)}</strong>. They fill it out directly in their browser — no account needed. The link expires in 7 days.</p>
      ...
      </div>`,i.querySelector('[data-act="cancel"]')?.addEventListener("click",s);const p=i.querySelector('[data-act="send"]'),f=i.querySelector("#qm-error"),d=i.querySelector("#qm-email");d?.focus(),p?.addEventListener("click",async()=>{const b=(d?.value||"").trim();if(f.textContent="",!b){f.textContent="Enter the email address to send this to.",d?.focus();return}if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(b)){f.textContent="That does not look like a valid email address.",d?.focus();return}p.disabled=!0;const _=p.innerHTML;p.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Sending…';try{const y=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,recipient_email:b})}),x=await y.json().catch(()=>({}));if(!y.ok||!x.ok)throw new Error(x.error||x.message||`Failed (HTTP ${y.status})`);ht(x.data.emailQueued?`Questionnaire sent to ${b}`:"Link created — email could not be queued",x.data.emailQueued?"success":"info"),c({url:x.data.url,token_expiry:x.data.expires,recipient_email:x.data.recipient_email,emailQueued:x.data.emailQueued,guid:x.data.guid})}catch(y){f.textContent=y.message||"Something went wrong. Please try again.",p.disabled=!1,p.innerHTML=_}})}function c(p){const f=p.recipient_email?"Sent":"Link created",d=p.emailQueued===!1?"<strong>The email could not be queued.</strong> Share the link below directly instead:":p.recipient_email?`Emailed to <strong>${F(p.recipient_email)}</strong>. The link is also below — handy if it bounces, or to share via text or chat:`:"Share this link with your client — email, text, chat:";i.innerHTML=`
      <div class="qm-status" data-status="DRAFT"><span class="material-symbols-outlined" aria-hidden="true">hourglass_top</span> ${f} — awaiting response${p.token_expiry?`, link expires ${F(pn(p.token_expiry))}`:""}</div>
      <p class="client-modal__hint">${d}</p>
      <div class="client-modal__linkrow">
        <input class="client-modal__input" id="qm-link" type="text" readonly value="${F(p.url||"")}" />
      ...
      </div>`;const b=i.querySelector("#qm-link");i.querySelector("#qm-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(b.value),i.querySelector("#qm-copy").textContent="Copied!"}catch{b.select()}}),i.querySelector('[data-act="done"]')?.addEventListener("click",s);const _=i.querySelector('[data-act="cancel-q"]');_?.addEventListener("click",async()=>{if(!window.confirm("Cancel this questionnaire? The link will stop working immediately. This cannot be undone — you would need to send a new one."))return;_.disabled=!0;const y=_.innerHTML;_.innerHTML="Cancelling…";try{const x=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(p.guid)}/cancel`,{method:"POST"}),T=await x.json().catch(()=>({}));if(!x.ok||!T.ok)throw new Error(T.error||T.message||`Failed (HTTP ${x.status})`);ht("Questionnaire cancelled","success"),h({...p,status:"CANCELLED",cancelled_tz:new Date().toISOString()})}catch(x){i.querySelector("#qm-cancel-error").textContent=x.message||"Something went wrong. Please try again.",_.disabled=!1,_.innerHTML=y}})}function h(p){i.innerHTML=`
      <div class="qm-status" data-status="CANCELLED"><span class="material-symbols-outlined" aria-hidden="true">block</span> Cancelled${p.cancelled_tz?` ${F(pn(p.cancelled_tz))}`:""}${p.cancelled_by_email?` by ${F(p.cancelled_by_email)}`:""}</div>
      <p class="client-modal__sub">This link was revoked and no longer works.${p.recipient_email?` It had been emailed to <strong>${F(p.recipient_email)}</strong>.`:""}</p>
      <p class="client-modal__error" id="qm-error"></p>
      <div class="client-modal__actions">
      ...
      </div>`,i.querySelector('[data-act="done"]')?.addEventListener("click",s),i.querySelector('[data-act="resend"]')?.addEventListener("click",()=>l())}function v(p,f){const d=f[p.id];if(p.type==="checkbox_group"){const b=Array.isArray(d)?d:[];return`<div class="qm-checkbox-group">${(Array.isArray(p.options)?p.options:[]).map(y=>`
        <label><input type="checkbox" value="${F(y)}" ${b.includes(y)?"checked":""}/> ${F(y)}</label>`).join("")}</div>`}return p.type==="textarea"?`<textarea>${F(d||"")}</textarea>`:`<input type="text" value="${F(d||"")}" />`}function m(p,f=!1){i.innerHTML=`
      <div class="qm-status" data-status="SUBMITTED"><span class="material-symbols-outlined" aria-hidden="true">task_alt</span> Submitted ${p.submitted_tz?F(pn(p.submitted_tz)):""}</div>
      ${Mi(p)}
      <form id="qm-form">
        ${Oi(p,f?{renderAnswer:v}:{})}
      </form>
      <p class="client-modal__error" id="qm-error"></p>
      <div class="client-modal__actions">
      ...
      </div>`,i.querySelector('[data-act="done"]')?.addEventListener("click",s),i.querySelector('[data-act="cancel-edit"]')?.addEventListener("click",()=>m(p,!1)),i.querySelector('[data-act="edit"]')?.addEventListener("click",()=>m(p,!0));const d=i.querySelector('[data-act="save"]');d?.addEventListener("click",async()=>{const b={};i.querySelectorAll("[data-question-id]").forEach(y=>{const x=y.dataset.questionId;if(y.dataset.questionType==="checkbox_group"){const N=[...y.querySelectorAll('input[type="checkbox"]:checked')].map(q=>q.value);N.length&&(b[x]=N)}else{const N=(y.querySelector("input,textarea")?.value||"").trim();N&&(b[x]=N)}}),d.disabled=!0;const _=d.innerHTML;d.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const y=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(p.guid)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({answers:b})}),x=await y.json().catch(()=>({}));if(!y.ok||!x.ok)throw new Error(x.error||x.message||`Failed (HTTP ${y.status})`);ht("Answers updated","success");const N=await(await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(p.guid)}`)).json().catch(()=>({}));m(N.ok?N.data:{...p,answers:b},!1)}catch(y){i.querySelector("#qm-error").textContent=y.message||"Something went wrong. Please try again.",d.disabled=!1,d.innerHTML=_}})}try{const p=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse?owner_guid=${encodeURIComponent(e)}`),f=await p.json().catch(()=>({}));if(!p.ok||!f.ok)throw new Error(f.error||`HTTP ${p.status}`);const d=(f.data||[])[0]||null;if(!d){l();return}if(d.status==="DRAFT"){c(d);return}if(d.status==="CANCELLED"){h(d);return}const b=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(d.guid)}`),_=await b.json().catch(()=>({}));if(!b.ok||!_.ok)throw new Error(_.error||`HTTP ${b.status}`);m(_.data)}catch(p){console.warn("[clients] questionnaire load failed:",p),i.innerHTML=`<p class="client-modal__error">Could not load questionnaire status. ${F(p.message||"")}</p>`}}const kh={render:ll,init:cl},Ah=Object.freeze(Object.defineProperty({__proto__:null,default:kh,init:cl,render:ll},Symbol.toStringTag,{value:"Module"})),Ds="managed_client";let Bs=!1;const Sh={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},fe=e=>String(e??"").replace(/[&<>"']/g,t=>Sh[t]),qs=(e,t="info")=>{try{u.publish(g.UI_TOAST,{message:e,type:t})}catch{}},Ch=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Th(){const e=k.getActiveOrg();let t=e&&e.channel!==Ds?e:null;if(!t){const n=k.getMemberships().find(o=>o.channel!==Ds);n&&(t={guid:n.orgGuid,channel:n.channel,memberRole:n.memberRole})}if(!t)return null;const a=k.getMemberships().find(n=>n.orgGuid===t.guid)?.name;return{...t,name:a}}function $h(e){return Object.values(zt).filter(t=>pc(e,t.value)).sort((t,a)=>a.rank-t.rank)}function Lh(){if(Bs)return;const e=document.createElement("style");e.id="m5t-team-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Bs=!0}function Pa(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Ih(e){const t=e.member_role||"member";return`
    <div class="team-row">
      <span class="team-avatar">${fe(Ch(e.name||e.email))}</span>
