var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t,n)=>()=>{if(n)throw n[0];try{return e&&(t=e(e=0)),t}catch(e){throw n=[e],e}},s=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),c=(e,n)=>{let r={};for(var i in e)t(r,i,{get:e[i],enumerable:!0});return n||t(r,Symbol.toStringTag,{value:`Module`}),r},l=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},u=(n,r,o)=>(o=n==null?{}:e(i(n)),l(r||!n||!n.__esModule||!a.call(n,`default`)?t(o,`default`,{value:n,enumerable:!0}):o,n));(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var d=s(((e,t)=>{(function(n,r){typeof e==`object`&&typeof t==`object`?t.exports=r():typeof define==`function`&&define.amd?define(`Navigo`,[],r):typeof e==`object`?e.Navigo=r():n.Navigo=r()})(typeof self<`u`?self:e,(function(){return function(){var e={407:function(e,t,n){n.d(t,{default:function(){return pe}});var r=/([:*])(\w+)/g,i=/\*/g,a=/\/\?/g;function o(e){return e===void 0&&(e=`/`),ee()?location.pathname+location.search+location.hash:e}function s(e){return e.replace(/\/+$/,``).replace(/^\/+/,``)}function c(e){return typeof e==`string`}function l(e){return e&&e.indexOf(`#`)>=0&&e.split(`#`).pop()||``}function u(e){var t=s(e).split(/\?(.*)?$/);return[s(t[0]),t.slice(1).join(``)]}function d(e){for(var t={},n=e.split(`&`),r=0;r<n.length;r++){var i=n[r].split(`=`);if(i[0]!==``){var a=decodeURIComponent(i[0]);t[a]?(Array.isArray(t[a])||(t[a]=[t[a]]),t[a].push(decodeURIComponent(i[1]||``))):t[a]=decodeURIComponent(i[1]||``)}}return t}function f(e,t){var n,o=u(s(e.currentLocationPath)),f=o[0],p=o[1],m=p===``?null:d(p),ee=[];if(c(t.path)){if(n=`(?:/^|^)`+s(t.path).replace(r,(function(e,t,n){return ee.push(n),`([^/]+)`})).replace(i,`?(?:.*)`).replace(a,`/?([^/]+|)`)+`$`,s(t.path)===``&&s(f)===``)return{url:f,queryString:p,hashString:l(e.to),route:t,data:null,params:m}}else n=t.path;var h=new RegExp(n,``),g=f.match(h);if(g){var _=c(t.path)?function(e,t){return t.length===0?null:e?e.slice(1,e.length).reduce((function(e,n,r){return e===null&&(e={}),e[t[r]]=decodeURIComponent(n),e}),null):null}(g,ee):g.groups?g.groups:g.slice(1);return{url:s(f.replace(RegExp(`^`+e.instance.root),``)),queryString:p,hashString:l(e.to),route:t,data:_,params:m}}return!1}function p(){return!(typeof window>`u`||!window.history||!window.history.pushState)}function m(e,t){return e[t]===void 0||!0===e[t]}function ee(){return typeof window<`u`}function h(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter((function(e){return e})).forEach((function(e){[`before`,`after`,`already`,`leave`].forEach((function(n){e[n]&&(t[n]||(t[n]=[]),t[n].push(e[n]))}))})),t}function g(e,t,n){var r=t||{},i=0;(function t(){e[i]?Array.isArray(e[i])?(e.splice.apply(e,[i,1].concat(e[i][0](r)?e[i][1]:e[i][2])),t()):e[i](r,(function(e){e===void 0||!0===e?(i+=1,t()):n&&n(r)})):n&&n(r)})()}function _(e,t){e.currentLocationPath===void 0&&(e.currentLocationPath=e.to=o(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function v(e,t){for(var n=0;n<e.instance.routes.length;n++){var r=f(e,e.instance.routes[n]);if(r&&(e.matches||=[],e.matches.push(r),e.resolveOptions.strategy===`ONE`))return void t()}t()}function te(e,t){e.navigateOptions&&(e.navigateOptions.shouldResolve!==void 0&&console.warn(`"shouldResolve" is deprecated. Please check the documentation.`),e.navigateOptions.silent!==void 0&&console.warn(`"silent" is deprecated. Please check the documentation.`)),t()}function y(e,t){!0===e.navigateOptions.force?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}g.if=function(e,t,n){return Array.isArray(t)||(t=[t]),Array.isArray(n)||(n=[n]),[e,t,n]};var b=ee(),ne=p();function re(e,t){if(m(e.navigateOptions,`updateBrowserURL`)){var n=(`/`+e.to).replace(/\/\//g,`/`),r=b&&e.resolveOptions&&!0===e.resolveOptions.hash;ne?(history[e.navigateOptions.historyAPIMethod||`pushState`](e.navigateOptions.stateObj||{},e.navigateOptions.title||``,r?`#`+n:n),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout((function(){if(!r){var t=location.hash;location.hash=``,location.hash=t}e.instance.__freezeListening=!1}),1))):b&&(window.location.href=e.to)}t()}function ie(e,t){var n=e.instance;n.lastResolved()?g(n.lastResolved().map((function(t){return function(n,r){if(t.route.hooks&&t.route.hooks.leave){var i=!1,a=e.instance.matchLocation(t.route.path,e.currentLocationPath,!1);i=t.route.path===`*`?!(e.matches&&e.matches.find((function(e){return t.route.path===e.route.path}))):!a,m(e.navigateOptions,`callHooks`)&&i?g(t.route.hooks.leave.map((function(t){return function(n,r){return t((function(t){!1===t?e.instance.__markAsClean(e):r()}),e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}})).concat([function(){return r()}])):r()}else r()}})),{},(function(){return t()})):t()}function ae(e,t){m(e.navigateOptions,`updateState`)&&e.instance._setCurrent(e.matches),t()}var oe=[function(e,t){var n=e.instance.lastResolved();if(n&&n[0]&&n[0].route===e.match.route&&n[0].url===e.match.url&&n[0].queryString===e.match.queryString)return n.forEach((function(t){t.route.hooks&&t.route.hooks.already&&m(e.navigateOptions,`callHooks`)&&t.route.hooks.already.forEach((function(t){return t(e.match)}))})),void t(!1);t()},function(e,t){e.match.route.hooks&&e.match.route.hooks.before&&m(e.navigateOptions,`callHooks`)?g(e.match.route.hooks.before.map((function(t){return function(n,r){return t((function(t){!1===t?e.instance.__markAsClean(e):r()}),e.match)}})).concat([function(){return t()}])):t()},function(e,t){m(e.navigateOptions,`callHandler`)&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()},function(e,t){e.match.route.hooks&&e.match.route.hooks.after&&m(e.navigateOptions,`callHooks`)&&e.match.route.hooks.after.forEach((function(t){return t(e.match)})),t()}],se=[ie,function(e,t){var n=e.instance._notFoundRoute;if(n){e.notFoundHandled=!0;var r=u(e.currentLocationPath),i=r[0],a=r[1],o=l(e.to);n.path=s(i);var c={url:n.path,queryString:a,hashString:o,data:null,route:n,params:a===``?null:d(a)};e.matches=[c],e.match=c}t()},g.if((function(e){return e.notFoundHandled}),oe.concat([ae]),[function(e,t){e.resolveOptions&&!1!==e.resolveOptions.noMatchWarning&&e.resolveOptions.noMatchWarning!==void 0||console.warn(`Navigo: "`+e.currentLocationPath+`" didn't match any of the registered routes.`),t()},function(e,t){e.instance._setCurrent(null),t()}])];function ce(){return(ce=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}function le(e,t){var n=0;ie(e,(function r(){n===e.matches.length?ae(e,t):g(oe,ce({},e,{match:e.matches[n]}),(function(){n+=1,r()}))}))}function ue(e){e.instance.__markAsClean(e)}function de(){return(de=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}var fe=`[data-navigo]`;function pe(e,t){var n,r=t||{strategy:`ONE`,hash:!1,noMatchWarning:!1,linksSelector:fe},i=this,a=`/`,m=null,b=[],ne=!1,ie=p(),ae=ee();function oe(e){return e.indexOf(`#`)>=0&&(e=!0===r.hash?e.split(`#`)[1]||`/`:e.split(`#`)[0]),e}function ce(e){return s(a+`/`+s(e))}function pe(e,t,n,r){return e=c(e)?ce(e):e,{name:r||s(String(e)),path:e,handler:t,hooks:h(n)}}function me(e,t){if(!i.__dirty){i.__dirty=!0,e=e?s(a)+`/`+s(e):void 0;var n={instance:i,to:e,currentLocationPath:e,navigateOptions:{},resolveOptions:de({},r,t)};return g([_,v,g.if((function(e){var t=e.matches;return t&&t.length>0}),le,se)],n,ue),!!n.matches&&n.matches}i.__waiting.push((function(){return i.resolve(e,t)}))}function he(e,t){if(i.__dirty)i.__waiting.push((function(){return i.navigate(e,t)}));else{i.__dirty=!0,e=s(a)+`/`+s(e);var n={instance:i,to:e,navigateOptions:t||{},resolveOptions:t&&t.resolveOptions?t.resolveOptions:r,currentLocationPath:oe(e)};g([te,y,v,g.if((function(e){var t=e.matches;return t&&t.length>0}),le,se),re,ue],n,ue)}}function ge(){if(ae)return(ae?[].slice.call(document.querySelectorAll(r.linksSelector||fe)):[]).forEach((function(e){e.getAttribute(`data-navigo`)!==`false`&&e.getAttribute(`target`)!==`_blank`?e.hasListenerAttached||(e.hasListenerAttached=!0,e.navigoHandler=function(t){if((t.ctrlKey||t.metaKey)&&t.target.tagName.toLowerCase()===`a`)return!1;var n=e.getAttribute(`href`);if(n==null)return!1;if(n.match(/^(http|https)/)&&typeof URL<`u`)try{var r=new URL(n);n=r.pathname+r.search}catch{}var a=function(e){if(!e)return{};var t,n=e.split(`,`),r={};return n.forEach((function(e){var n=e.split(`:`).map((function(e){return e.replace(/(^ +| +$)/g,``)}));switch(n[0]){case`historyAPIMethod`:r.historyAPIMethod=n[1];break;case`resolveOptionsStrategy`:t||={},t.strategy=n[1];break;case`resolveOptionsHash`:t||={},t.hash=n[1]===`true`;break;case`updateBrowserURL`:case`callHandler`:case`updateState`:case`force`:r[n[0]]=n[1]===`true`}})),t&&(r.resolveOptions=t),r}(e.getAttribute(`data-navigo-options`));ne||(t.preventDefault(),t.stopPropagation(),i.navigate(s(n),a))},e.addEventListener(`click`,e.navigoHandler)):e.hasListenerAttached&&e.removeEventListener(`click`,e.navigoHandler)})),i}function _e(e,t,n){var r=b.find((function(t){return t.name===e})),i=null;if(r){if(i=r.path,t)for(var o in t)i=i.replace(`:`+o,t[o]);i=i.match(/^\//)?i:`/`+i}return i&&n&&!n.includeRoot&&(i=i.replace(RegExp(`^/`+a),``)),i}function ve(e){var t=u(s(e)),r=t[0],i=t[1],a=i===``?null:d(i);return{url:r,queryString:i,hashString:l(e),route:pe(r,(function(){}),[n],r),data:null,params:a}}function ye(e,t,n){return typeof t==`string`&&(t=be(t)),t?(t.hooks[e]||(t.hooks[e]=[]),t.hooks[e].push(n),function(){t.hooks[e]=t.hooks[e].filter((function(e){return e!==n}))}):(console.warn(`Route doesn't exists: `+t),function(){})}function be(e){return typeof e==`string`?b.find((function(t){return t.name===ce(e)})):b.find((function(t){return t.handler===e}))}e?a=s(e):console.warn(`Navigo requires a root path in its constructor. If not provided will use "/" as default.`),this.root=a,this.routes=b,this.destroyed=ne,this.current=m,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=function(e){e.instance.__dirty=!1,e.instance.__waiting.length>0&&e.instance.__waiting.shift()()},this.on=function(e,t,r){var i=this;return typeof e!=`object`||e instanceof RegExp?(typeof e==`function`&&(r=t,t=e,e=a),b.push(pe(e,t,[n,r])),this):(Object.keys(e).forEach((function(t){if(typeof e[t]==`function`)i.on(t,e[t]);else{var r=e[t],a=r.uses,o=r.as,s=r.hooks;b.push(pe(t,a,[n,s],o))}})),this)},this.off=function(e){return this.routes=b=b.filter((function(t){return c(e)?s(t.path)!==s(e):typeof e==`function`?e!==t.handler:String(t.path)!==String(e)})),this},this.resolve=me,this.navigate=he,this.navigateByName=function(e,t,n){var r=_e(e,t);return r!==null&&(he(r.replace(RegExp(`^/?`+a),``),n),!0)},this.destroy=function(){this.routes=b=[],ie&&window.removeEventListener(`popstate`,this.__popstateListener),this.destroyed=ne=!0},this.notFound=function(e,t){return i._notFoundRoute=pe(`*`,e,[n,t],`__NOT_FOUND__`),this},this.updatePageLinks=ge,this.link=function(e){return`/`+a+`/`+s(e)},this.hooks=function(e){return n=e,this},this.extractGETParameters=function(e){return u(oe(e))},this.lastResolved=function(){return m},this.generate=_e,this.getLinkPath=function(e){return e.getAttribute(`href`)},this.match=function(e){var t={instance:i,currentLocationPath:e,to:e,navigateOptions:{},resolveOptions:r};return v(t,(function(){})),!!t.matches&&t.matches},this.matchLocation=function(e,t,n){t===void 0||n!==void 0&&!n||(t=ce(t));var r={instance:i,to:t,currentLocationPath:t};return _(r,(function(){})),typeof e==`string`&&(e=n===void 0||n?ce(e):e),f(r,{name:String(e),path:e,handler:function(){},hooks:{}})||!1},this.getCurrentLocation=function(){return ve(s(o(a)).replace(RegExp(`^`+a),``))},this.addBeforeHook=ye.bind(this,`before`),this.addAfterHook=ye.bind(this,`after`),this.addAlreadyHook=ye.bind(this,`already`),this.addLeaveHook=ye.bind(this,`leave`),this.getRoute=be,this._pathToMatchObject=ve,this._clean=s,this._checkForAHash=oe,this._setCurrent=function(e){return m=i.current=e},function(){ie&&(this.__popstateListener=function(){i.__freezeListening||me()},window.addEventListener(`popstate`,this.__popstateListener))}.call(this),ge.call(this)}}},t={};function n(r){if(t[r])return t[r].exports;var i=t[r]={exports:{}};return e[r](i,i.exports,n),i.exports}return n.d=function(e,t){for(var r in t)n.o(t,r)&&!n.o(e,r)&&Object.defineProperty(e,r,{enumerable:!0,get:t[r]})},n.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},n(407)}().default}))})),f=s(((e,t)=>{(function(n,r){var i={};n.PubSub?(i=n.PubSub,console.warn(`PubSub already loaded, using existing version`)):(n.PubSub=i,r(i)),typeof e==`object`?(t!==void 0&&t.exports&&(e=t.exports=i),e.PubSub=i,t.exports=e=i):typeof define==`function`&&define.amd&&define(function(){return i})})(typeof window==`object`&&window||e||global,function(e){var t={},n=-1,r=`*`;function i(e){for(var t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!0;return!1}function a(e){return function(){throw e}}function o(e,t,n){try{e(t,n)}catch(e){setTimeout(a(e),0)}}function s(e,t,n){e(t,n)}function c(e,n,r,i){var a=t[n],c=i?s:o,l;if(Object.prototype.hasOwnProperty.call(t,n))for(l in a)Object.prototype.hasOwnProperty.call(a,l)&&c(a[l],e,r)}function l(e,t,n){return function(){var i=String(e),a=i.lastIndexOf(`.`);for(c(e,e,t,n);a!==-1;)i=i.substr(0,a),a=i.lastIndexOf(`.`),c(e,i,t,n);c(e,r,t,n)}}function u(e){var n=String(e);return!!(Object.prototype.hasOwnProperty.call(t,n)&&i(t[n]))}function d(e){for(var t=String(e),n=u(t)||u(r),i=t.lastIndexOf(`.`);!n&&i!==-1;)t=t.substr(0,i),i=t.lastIndexOf(`.`),n=u(t);return n}function f(e,t,n,r){e=typeof e==`symbol`?e.toString():e;var i=l(e,t,r);return d(e)?(n===!0?i():setTimeout(i,0),!0):!1}e.publish=function(t,n){return f(t,n,!1,e.immediateExceptions)},e.publishSync=function(t,n){return f(t,n,!0,e.immediateExceptions)},e.subscribe=function(e,r){if(typeof r!=`function`)return!1;e=typeof e==`symbol`?e.toString():e,Object.prototype.hasOwnProperty.call(t,e)||(t[e]={});var i=`uid_`+String(++n);return t[e][i]=r,i},e.subscribeAll=function(t){return e.subscribe(r,t)},e.subscribeOnce=function(t,n){var r=e.subscribe(t,function(){e.unsubscribe(r),n.apply(this,arguments)});return e},e.clearAllSubscriptions=function(){t={}},e.clearSubscriptions=function(e){for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0&&delete t[n]},e.countSubscriptions=function(e){var n,r,i=0;for(n in t)if(Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0){for(r in t[n])i++;break}return i},e.getSubscriptions=function(e){var n,r=[];for(n in t)Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0&&r.push(n);return r},e.unsubscribe=function(n){var r=typeof n==`string`&&(Object.prototype.hasOwnProperty.call(t,n)||function(e){for(var n in t)if(Object.prototype.hasOwnProperty.call(t,n)&&n.indexOf(e)===0)return!0;return!1}(n)),i=!r&&typeof n==`string`,a=typeof n==`function`,o=!1,s,c,l;if(r){e.clearSubscriptions(n);return}for(s in t)if(Object.prototype.hasOwnProperty.call(t,s)){if(c=t[s],i&&c[n]){delete c[n],o=n;break}if(a)for(l in c)Object.prototype.hasOwnProperty.call(c,l)&&c[l]===n&&(delete c[l],o=!0)}return o}})})),p,m=o((()=>{p=Object.freeze({APP:`APP`,APP_READY:`APP.READY`,APP_ERROR:`APP.ERROR`,APP_SIGNOUT:`APP.SIGNOUT`,APP_AUTH:`APP.AUTH`,APP_USER_LOADED:`APP.USER.LOADED`,ROUTE_NAV:`ROUTE.NAV.GO`,ROUTE_NAV_BEFORE:`ROUTE.NAV.BEFORE`,ROUTE_NAV_AFTER:`ROUTE.NAV.AFTER`,ROUTE_NAV_ERROR:`ROUTE.NAV.ERROR`,AUTH_SIGNIN:`AUTH.SIGNIN.GO`,AUTH_SIGNIN_SUCCESS:`AUTH.SIGNIN.SUCCESS`,AUTH_SIGNIN_FAIL:`AUTH.SIGNIN.FAIL`,AUTH_SIGNUP:`AUTH.SIGNUP.GO`,AUTH_SIGNUP_SUCCESS:`AUTH.SIGNUP.SUCCESS`,AUTH_SIGNUP_FAIL:`AUTH.SIGNUP.FAIL`,AUTH_VERIFY_LINK:`AUTH.VERIFY.LINK`,AUTH_SIGNOUT:`AUTH.SIGNOUT.GO`,AUTH_SIGNOUT_SUCCESS:`AUTH.SIGNOUT.SUCCESS`,AUTH_FORGOT:`AUTH.FORGOT.GO`,AUTH_FORGOT_SUCCESS:`AUTH.FORGOT.SUCCESS`,AUTH_RESETHASH:`AUTH.RESETHASH.GO`,AUTH_RESETHASH_SUCCESS:`AUTH.RESETHASH.SUCCESS`,AUTH_RESETHASH_NAV:`AUTH.RESETHASH.NAV`,AUTH_TOKEN_EXPIRED:`AUTH.TOKEN.EXPIRED`,AUTH_TOKEN_INVALID:`AUTH.TOKEN.INVALID`,AUTH_SCOPE_LOADED:`AUTH.SCOPE.LOADED`,M5T_PRIMARY_NAV:`M5T_PRIMARY_NAV`,M5T_PRIMARY_NAV_LOGO_TAP:`M5T_PRIMARY_NAV.LOGO_TAP`,M5T_PRIMARY_NAV_HOVER:`M5T_PRIMARY_NAV.HOVER`,M5T_PRIMARY_NAV_TAP:`M5T_PRIMARY_NAV.TAP`,M5T_PRIMARY_NAV_DOUBLE_TAP:`M5T_PRIMARY_NAV.DOUBLE_TAP`,M5T_PRIMARY_NAV_LONG_TAP:`M5T_PRIMARY_NAV.LONG_TAP`,M5T_SIDE_NAV:`M5T_SIDE_NAV`,M5T_SIDE_NAV_TAP:`M5T_SIDE_NAV.TAP`,M5T_SIDE_NAV_COLLAPSE:`M5T_SIDE_NAV.COLLAPSE`,M5T_SIDE_NAV_LOGO_TAP:`M5T_SIDE_NAV.LOGO_TAP`,M5T_SIDE_NAV_ORG_SWITCH:`M5T_SIDE_NAV.ORG_SWITCH`,M5T_SIDE_NAV_FOOTER_ACTION:`M5T_SIDE_NAV.FOOTER_ACTION`,UI_LOADING_START:`UI.LOADING.START`,UI_LOADING_END:`UI.LOADING.END`,UI_TOAST:`UI.TOAST`,UI_MODAL_OPEN:`UI.MODAL.OPEN`,UI_MODAL_CLOSE:`UI.MODAL.CLOSE`,UI_THEME_CHANGED:`UI.THEME.CHANGED`,UI_WELCOME_BACK_CLICKED:`UI.WELCOME_BACK_CLICKED`,DATA_REFRESH:`DATA.REFRESH`,DATA_UPDATE:`DATA.UPDATE`,DATA_ERROR:`DATA.ERROR`,I18N:`I18N`,I18N_SET_LANG:`I18N.SET_LANG`,CONVERSATION:`CONVERSATION`,CONVERSATION_PROMPT:`CONVERSATION.PROMPT`,CONVERSATION_PROMPT_AGENT_CANVAS:`CONVERSATION.PROMPT.AGENT_CANVAS`,CONVERSATION_PROMPT_AGENT:`CONVERSATION.PROMPT.AGENT`,CONVERSATION_PROMPT_CANVAS:`CONVERSATION.PROMPT.CANVAS`,CONVERSATION_PROMPT_STAGE:`CONVERSATION.PROMPT.STAGE`,CONVERSATION_RESPONSE:`CONVERSATION.RESPONSE`,CONVERSATION_RESPONSE_CANVAS:`CONVERSATION.RESPONSE.CANVAS`,CONVERSATION_RESPONSE_WORKFLOW:`CONVERSATION.RESPONSE.WORKFLOW`,CANVAS:`CANVAS`,CANVAS_DO_SCROLL:`CANVAS.DO.SCROLL`,MESSAGE:`MESSAGE`,MESSAGE_CREATE:`MESSAGE.CREATE`,MESSAGE_CREATED:`MESSAGE.CREATED`,MESSAGE_EDIT:`MESSAGE.EDIT`,MESSAGE_UPDATED:`MESSAGE.UPDATED`,MESSAGE_DELETE:`MESSAGE.DELETE`,MESSAGE_DELETED:`MESSAGE.DELETED`,MESSAGE_REFRESH:`MESSAGE.REFRESH`})}));function ee(e,t=null){if(e in _)return _[e];if(typeof process<`u`&&{}[e]){let t={}[e];return t===`true`?!0:t===`false`?!1:isNaN(t)?t:Number(t)}if({BASE_URL:`./`,DEV:!1,MODE:`production`,PROD:!0,SSR:!1,VITE_API_BASE_URL:`http://localhost:3333`}[e]){let t={BASE_URL:`./`,DEV:!1,MODE:`production`,PROD:!0,SSR:!1,VITE_API_BASE_URL:`http://localhost:3333`}[e];return t===`true`?!0:t===`false`?!1:isNaN(t)?t:Number(t)}return t}function h(e){return ee(e,!1)===!0}function g(){return{..._}}var _,v=o((()=>{_=Object.freeze({FF_SSE_LS_SESSION_USER:`mvv_session_user`,FF_SSE_LS_TOKEN:`mvv`,FF_SSE_LS_THEME:`mvv_theme`,FF_SSE_UI_DARK_MODE:!0,FF_SSE_UI_ANIMATIONS:!0,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:`main_carousel_nav`,FF_CLIENT_LS_SESSION_ENTITY:`sse_entity`,FF_CLIENT_LS_DEEP_LINK:`sse_deeplink`,FF_CLIENT_ROUTE_SIGNIN:`signin_route`,FF_CLIENT_ROUTE_SIGNUP:`signup_route`,FF_CLIENT_ROUTE_HOME:`home_route`,FF_CLIENT_ROUTE_RESET_HASH:`resethash_route`,FF_CLIENT_ROUTE_RESET_FORGOT:`resetforgot_route`,FF_CLIENT_ROUTE_SIGNOUT:`signout_route`,FF_CLIENT_ROUTE_ERROR:`error_route`,FF_CLIENT_ROUTE_VERF_LINK:`verf_link_route`,FF_CLIENT_ROUTE_OFFLINE:`offline_route`,FF_CLIENT_PROTECTED_ROUTES:[`home_route`,`resethash_route`,`signout_route`,`user_management_route`],FF_CLIENT_ENDPOINT_SIGNIN:`/m5t/v5/acctEntity/signin`,FF_CLIENT_ENDPOINT_SIGNOUT:`/m5t/v5/acctEntity/signout`,FF_CLIENT_ENDPOINT_SIGNUP:`/m5t/v5/acctEntity/`,FF_CLIENT_ENDPOINT_RESET_HASH:`/m5t/v5/acctEntity/resetHash`,FF_CLIENT_ENDPOINT_RESET_FORGOT:`/m5t/v5/acctEntity/resetforgot`,FF_CLIENT_ENDPOINT_PING:`/ping`,FF_CLIENT_ENDPOINT_METER:`/m5t/v5/coreMeter/`,FF_CLIENT_METER_DEEP_LINK:`deep_link_access`,FF_CLIENT_METER_SIGNOUT_CLIENT:`signout_client_initiated`,FF_CLIENT_METER_SIGNOUT_SERVER:`signout_server_initiated`,FF_CLIENT_METER_PING_SUCCESS:`ping_auth_success`,FF_CLIENT_METER_PING_FAILURE:`ping_auth_failure`,FF_SSE_I18N_PRODUCT:`SSE`,FF_SSE_I18N_WHITELABEL:`M5T`,FF_SSE_I18N_LANG:`en`,FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:`mvv_user_lang`,FF_SSE_LS_WHITELABEL:`mvv_whitelabel`,FF_API_RATELIMIT_SIGNIN_ENFORCE:!0,FF_API_RATELIMIT_SIGNIN_IP_LIMIT:20,FF_API_RATELIMIT_SIGNIN_EMAIL_LIMIT:10,FF_API_RATELIMIT_FORGOT_ENFORCE:!0,FF_API_RATELIMIT_FORGOT_IP_LIMIT:15,FF_API_RATELIMIT_FORGOT_EMAIL_LIMIT:5,FF_API_RATELIMIT_CAPTURE_ENFORCE:!0,FF_API_RATELIMIT_CAPTURE_LIMIT:30,FF_API_RATELIMIT_EVENT_ENFORCE:!0,FF_API_RATELIMIT_EVENT_LIMIT:600,FF_API_RATELIMIT_CSP_PING_ENFORCE:!0,FF_API_RATELIMIT_CSP_PING_LIMIT:30,FF_API_RATELIMIT_WEBAUTHN_AUTH_ENFORCE:!0,FF_API_RATELIMIT_WEBAUTHN_AUTH_IP_LIMIT:20,FF_API_RATELIMIT_INTEGRATIONS_ENFORCE:!0,FF_API_RATELIMIT_INTEGRATIONS_LIMIT:60,FF_API_RATELIMIT_QUESTIONNAIRE_ENFORCE:!0,FF_API_RATELIMIT_QUESTIONNAIRE_LIMIT:30,FF_API_RATELIMIT_DELIVERABLE_ENFORCE:!0,FF_API_RATELIMIT_DELIVERABLE_LIMIT:30,FF_API_RATELIMIT_PAIRING_ENFORCE:!0,FF_API_RATELIMIT_PAIRING_LIMIT:20,FF_API_RATELIMIT_SITE_OPS_ENFORCE:!0,FF_API_RATELIMIT_SITE_OPS_LIMIT:120,FF_API_RATELIMIT_AUTHENTICATED_ENFORCE:!0,FF_API_RATELIMIT_AUTHENTICATED_LIMIT:600,FF_API_MAGNET_REQUIRE_ORIGIN_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_ENFORCE:!0,FF_API_RATELIMIT_GLOBAL_LIMIT:2e3}),typeof module<`u`&&module.exports&&(module.exports={FEATURE_FLAGS:_,getFlag:ee,isEnabled:h,getAllFlags:g})})),te=u(d(),1),y=u(f(),1);m(),v();var b={success:{border:`var(--color-success, #009473)`,bg:`var(--color-success-soft, rgba(0,148,115,0.10))`,icon:`check_circle`},danger:{border:`var(--color-danger, #DD4124)`,bg:`var(--color-danger-soft, rgba(221,65,36,0.09))`,icon:`error`},error:{border:`var(--color-danger, #DD4124)`,bg:`var(--color-danger-soft, rgba(221,65,36,0.09))`,icon:`error`},warning:{border:`var(--color-warning, #D97706)`,bg:`var(--color-warning-soft, #FEF3C7)`,icon:`warning`},info:{border:`var(--color-info, #0D9488)`,bg:`var(--color-info-soft, #CCFBF1)`,icon:`info`}},ne=4500,re=220,ie=null,ae=!1;function oe(){if(ae)return;let e=document.createElement(`style`);e.id=`m5t-toast-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Pn=!0}function jn(){let e=new URLSearchParams(window.location.search||``),t=e.get(`uid`)||``,n=e.get(`token`)||``;if(!t||!n){let e=window.location.hash||``,r=e.includes(`?`)?e.slice(e.indexOf(`?`)+1):``,i=new URLSearchParams(r);if(t=t||i.get(`uid`)||``,n=n||i.get(`token`)||``,!t||!n){let r=e.replace(/^#\/?/,``).split(`?`)[0].split(`/`).filter(Boolean);t=t||r[1]||``,n=n||r[2]||``}}try{return{uid:decodeURIComponent(t),token:decodeURIComponent(n)}}catch{return{uid:t,token:n}}}function Mn(){return An(),`
    ...
    </div>`}function Nn(){let{uid:e,token:t}=jn(),n=document.getElementById(`accept-invite-form`),r=document.getElementById(`ai-first`),i=document.getElementById(`ai-last`),a=document.getElementById(`ai-pass`),o=document.getElementById(`ai-confirm`),s=document.getElementById(`ai-submit`),c=document.getElementById(`ai-msg`);if(!n)return;let l=(e,t=`error`)=>{c.textContent=e,c.className=`accept-invite-msg ${t}`};if(!e||!t){l(`This invitation link is invalid or incomplete. Please use the link from your email.`),s.disabled=!0;return}n.addEventListener(`submit`,async n=>{n.preventDefault();let c=(r.value||``).trim(),u=(i.value||``).trim(),d=a.value||``,f=o.value||``;if(!c||!u){l(`Please enter your first and last name.`);return}if(d.length<8){l(`Password must be at least 8 characters.`);return}if(d!==f){l(`Passwords do not match.`);return}s.disabled=!0,l(`Setting up your account…`,`ok`);try{let n=w.getConfig?.().BASE_URL||``,r=await fetch(`${n}/m5t/v5/acctEntity/acceptInvite`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({uid:e,token:t,password:d,first:c,last:u})}),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok){let e=r.status===410?`This invitation has expired. Ask for a new one.`:r.status===409?`This invitation has already been used. Try signing in.`:i.error||`Could not accept the invitation (HTTP ${r.status}).`;l(e),s.disabled=!1;return}try{window.history.replaceState({},``,window.location.pathname+window.location.hash)}catch{}l(`Welcome! Signing you in…`,`ok`),(await w.doSignin(i.entity.email,d))?.ok||(l(`Your account is ready. Please sign in.`,`ok`),setTimeout(()=>{window.location.hash=`#/signin`},1200))}catch(e){console.error(`[accept-invite] error:`,e),l(`Something went wrong. Please try again.`),s.disabled=!1}})}var Pn,Fn,In=o((()=>{T(),Pn=!1,Fn={render:Mn,init:Nn}})),Ln,Rn=o((()=>{Ln=``+new URL(`mfm-lockup-white.png`,import.meta.url).href})),zn,Bn=o((()=>{zn=``+new URL(`mfm-lockup-black.png`,import.meta.url).href})),Vn,Hn=o((()=>{Vn=``+new URL(`mfm-lockup-color.png`,import.meta.url).href})),Un,Wn=o((()=>{Un=``+new URL(`m5mag-lockup.png`,import.meta.url).href}));function Gn(e=`#/splash`){return`
        <a class="auth-brand" href="${e}" aria-label="Mach Five Magnet">
          <img src="${Un}" alt="Mach Five Magnet" height="42" />
        </a>`}function Kn(e=`panel`){let t=e===`light`;return`
    <a class="auth-cobrand${t?` auth-cobrand--light`:``}" href="${qn}"
       target="_blank" rel="noopener" aria-label="From Mach Five Marketing">
      <span class="auth-cobrand__label">From</span>
      <img class="auth-cobrand__logo" src="${t?zn:Ln}"
           alt="Mach Five Marketing" height="26" loading="lazy" />
    </a>`}var qn,Jn,Yn,Xn=o((()=>{Rn(),Bn(),Hn(),Wn(),qn=`https://www.machfivemarketing.com`,Jn=Un,Yn=Vn}));function D(e){if(!e)return``;try{return new Date(e).toLocaleString([],{dateStyle:`medium`,timeStyle:`short`})}catch{return String(e)}}function Zn(e,t={}){let n=t[e.id];if(e.type===`checkbox_group`){let e=Array.isArray(n)?n:[];return e.length?ir(e.join(`, `)):``}return n?ir(n):``}function Qn(e,{emptyLabel:t=`(blank)`,renderAnswer:n=null}={}){let r=e?.questionnaire?.sections||[],i=e?.answers||{};return r.length?r.map(e=>`
    <div class="qm-section">
      <h3>${ir(e.title)}</h3>
      ${(e.questions||[]).map(e=>`
        <div class="qm-qa" data-question-id="${ir(e.id)}" data-question-type="${ir(e.type)}">
          <div class="qm-qa__q">${ir(e.label)}</div>
          <div class="qm-qa__a">${n?n(e,i):Zn(e,i)||`<span class="qm-qa__a--empty">${ir(t)}</span>`}</div>
        </div>`).join(``)}
    </div>`).join(``):`<p class="qm-qa__a qm-qa__a--empty">This questionnaire has no questions.</p>`}function $n(e,t={}){let n=t[e.id];if(e.type===`checkbox_group`){let t=Array.isArray(n)?n:[];return`<div class="qm-checkbox-group">${(Array.isArray(e.options)?e.options:[]).map(e=>`
      <label><input type="checkbox" value="${ir(e)}" ${t.includes(e)?`checked`:``}/> ${ir(e)}</label>`).join(``)}</div>`}return e.type===`textarea`?`<textarea>${ir(n||``)}</textarea>`:`<input type="text" value="${ir(n||``)}" />`}function er(e){let t={};return e&&e.querySelectorAll(`[data-question-id]`).forEach(e=>{let n=e.dataset.questionId;if(e.dataset.questionType===`checkbox_group`){let r=[...e.querySelectorAll(`input[type="checkbox"]:checked`)].map(e=>e.value);r.length&&(t[n]=r)}else{let r=(e.querySelector(`input,textarea`)?.value||``).trim();r&&(t[n]=r)}}),t}function tr(e){let t=e?.recipient_email?`<p class="qm-recipient">Sent to ${ir(e.recipient_email)}</p>`:``,n=e?.last_edited_tz?`<p class="qm-edited-marker">Last edited by ${ir(e.last_edited_by_email||`a team member`)} on ${ir(D(e.last_edited_tz))}</p>`:``,r=e?.client_edited_tz?`<p class="qm-edited-marker">Updated by the client on ${ir(D(e.client_edited_tz))}</p>`:``;return t+n+r}function nr(){if(ar)return;let e=document.createElement(`style`);e.id=`m5t-questionnaire-answer-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),ar=!0}var rr,ir,ar,or=o((()=>{rr={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},ir=e=>String(e??``).replace(/[&<>"']/g,e=>rr[e]),ar=!1})),sr,cr=o((()=>{sr=``+new URL(`auth-hero-sketch.jpg`,import.meta.url).href})),lr=c({default:()=>Sr,init:()=>hr,render:()=>mr});function ur(){if(xr)return;let e=document.createElement(`style`);e.id=`m5t-questionnaire-fill-styles`,e.textContent=`
    .qf-page {
    ...
    .qf-page::before {
      ...
      background: url("${sr}") center / cover no-repeat;
  ...
  `,document.head.appendChild(e),nr(),xr=!0}function dr(){return w.getConfig?.().BASE_URL||``}function fr(e){let t=`qf-${e.id}`;if(e.type===`checkbox_group`){let n=Array.isArray(e.options)?e.options:[];return`
    ...
    </div>`}function O(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}function pr(e,t,n){return`
    <div class="qf-page"><div class="qf-card"><div class="qf-state">
      <span class="material-symbols-outlined">${e}</span>
      <h1>${O(t)}</h1>
      <p class="qf-sub">${O(n)}</p>
    </div></div></div>`}function mr(){return ur(),`<div id="qf-root">${pr(`hourglass_top`,`Loading your questionnaire…`,`One moment.`)}</div>`}async function hr(){let e=document.getElementById(`qf-root`);if(!e)return;let t=he();if(!t){e.innerHTML=pr(`error`,`Invalid link`,`This link is missing required information. Please use the link exactly as sent.`);return}let n;try{let r=await fetch(`${dr()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(t.guid)}?token=${encodeURIComponent(t.token)}`),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok){e.innerHTML=pr(`error`,`Cannot open this questionnaire`,r.status===404?i.error||`This link is invalid or has expired.`:`Something went wrong loading your questionnaire. Please try again shortly.`);return}n=i.data}catch(t){console.error(`[questionnaire-fill] load error:`,t),e.innerHTML=pr(`wifi_off`,`Connection problem`,`Could not reach the server. Please check your connection and try again.`);return}let r=gr(n);if(r===`locked`){vr(e,n);return}yr(e,n,t,r)}function gr(e){return e.status===`SUBMITTED`?(e.editability||{editable:!e.locked_tz}).editable?`edit`:`locked`:`fill`}function _r(e){let t=e.editability||{};return t.reason===`finalized`?`Your account manager has finalised these answers, so they can no longer be changed here.`:`Answers can be changed for 14 days after they are submitted.${t.deadline?` The window closed on ${D(t.deadline)}.`:``}`}function vr(e,t){e.innerHTML=`
    <div class="qf-page"><div class="qf-card">
      <img class="qf-brand" src="${Yn}" alt="Mach Five Marketing" height="34" />
      ...
      <div class="qf-note qf-note--locked">
        ...
        <span>${O(_r(t))} To change anything now, contact your account manager.</span>
      </div>
      ${tr(t)}
      ${Qn(t,{emptyLabel:`Left blank`})}
    </div></div>`}function yr(e,t,n,r){let i=r===`edit`,a=t.questionnaire?.sections||[],o=t.answers||{},s=t.editability?.deadline,c=i?`Change anything you need to, then save. Everything you sent before is already filled in.`:`Answer what applies. If a question doesn't apply to your business, leave it blank.`,l=i?`<div class="qf-note">
    ...
    </div></div></div>`,document.getElementById(`qf-again`)?.addEventListener(`click`,()=>{hr()})}var xr,Sr,Cr=o((()=>{T(),ge(),Xn(),or(),cr(),xr=!1,Sr={render:mr,init:hr}}));function wr(e){return e&&typeof e.repeat==`string`&&e.repeat?e.repeat:null}function Tr(e){let t=wr(e);return t?(e.questions||[]).filter(e=>e.group===`${t}1`):[]}function Er(e,t,n){return(e||[]).map(e=>({...e,id:e.id.replace(`_${t}1_`,`_${t}${n}_`),group:`${t}${n}`,label:String(e.label||``).replace(/\b1\b/,String(n))}))}function Dr(e,t){return RegExp(`^${Ar(e).replace(`_${t}1_`,`_${t}(\\d+)_`)}$`)}function Or(e,...t){let n=wr(e);if(!n)return 0;let r=Tr(e).filter(e=>e.id&&e.id.includes(`_${n}1_`)).map(e=>Dr(e.id,n)),i=1;for(let e of t)for(let t of Object.keys(e||{}))for(let e of r){let n=t.match(e);n&&(i=Math.max(i,parseInt(n[1],10)))}return Math.min(i,jr)}function kr(e,...t){return(Array.isArray(e)?e:[]).map(e=>{let n=wr(e);if(!n)return e;let r=Tr(e);if(!r.length)return e;let i=(e.questions||[]).filter(e=>e.group!==`${n}1`),a=Or(e,...t),o=[];for(let e=1;e<=a;e++)o.push(...Er(r,n,e));return{...e,questions:[...o,...i]}})}var Ar,jr,Mr=o((()=>{Ar=e=>e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),jr=200})),Nr=c({default:()=>Zr,init:()=>Ur,render:()=>Hr});function Pr(){if(Yr)return;let e=document.createElement(`style`);e.id=`m5t-deliverable-fill-styles`,e.textContent=`
    .dlf-page {
  ...
  `,document.head.appendChild(e),nr(),Yr=!0}function Fr(){return w.getConfig?.().BASE_URL||``}function k(e){return String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}function Ir(e,t){let n=t?.[e.id];return Array.isArray(n)?n.length>0:!!(n&&String(n).trim())}function Lr(e,t){let n=(e.questions||[]).filter(e=>Xr(e)&&Ir(e,t));return n.length?`<div class="dlf-plan">${n.map(e=>`
    <div class="dlf-plan__item">
      <div class="dlf-plan__label">${k(e.label)}</div>
      <div class="dlf-plan__value">${Zn(e,t)}</div>
    </div>`).join(``)}</div>`:``}function Rr(e){let t=`dlf-${e.id}`;if(e.type===`checkbox_group`){let n=Array.isArray(e.options)?e.options:[];return`
    ...
    <div class="dlf-field" data-question-id="${e.id}" data-question-type="text">
      ...
      ${e.help?`<p class="dlf-help">${k(e.help)}</p>`:``}
      <input type="text" id="${t}" />
    </div>`}function zr(e,t){return`
    <div class="qm-qa">
      <div class="qm-qa__q">${k(e.label)}</div>
      <div class="qm-qa__a">${Zn(e,t)||`<span class="qm-qa__a--empty">Left blank</span>`}</div>
    </div>`}function Br(e,t,{readOnly:n=!1,answers:r={}}={}){let i=(e.questions||[]).filter(e=>!Xr(e)),a=Lr(e,t),o=i.map(e=>n?zr(e,r):Rr(e)).join(``);return`
    ...
    </div></div></div>`}function Hr(){return Pr(),`<div id="dlf-root">${Vr(`hourglass_top`,`Loading your plan…`,`One moment.`)}</div>`}async function Ur(){let e=document.getElementById(`dlf-root`);if(!e)return;let t=ve();if(!t){e.innerHTML=Vr(`error`,`Invalid link`,`This link is missing required information. Please use the link exactly as sent.`);return}let n;try{let r=await fetch(`${Fr()}/m5t/v5/m5mDeliverable/public/${encodeURIComponent(t.guid)}?token=${encodeURIComponent(t.token)}`),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok){e.innerHTML=Vr(`error`,`Cannot open this plan`,r.status===404?i.error||`This link is invalid or has expired.`:`Something went wrong loading your plan. Please try again shortly.`);return}n=i.data}catch(t){console.error(`[deliverable-fill] load error:`,t),e.innerHTML=Vr(`wifi_off`,`Connection problem`,`Could not reach the server. Please check your connection and try again.`);return}let r=Wr(n);if(r===`locked`){Kr(e,n);return}qr(e,n,t,r)}function Wr(e){return e.status===`SUBMITTED`?(e.editability||{editable:!e.locked_tz}).editable?`edit`:`locked`:`fill`}function Gr(e){let t=e.editability||{};return t.reason===`finalized`?`Your account manager has finalised this plan, so the review can no longer be changed here.`:`A review can be changed for 14 days after it is submitted.${t.deadline?` The window closed on ${D(t.deadline)}.`:``}`}function Kr(e,t){let n=kr(t.template?.sections||[],t.content,t.answers);e.innerHTML=`
    <div class="dlf-page"><div class="dlf-card">
      <img class="dlf-brand" src="${Yn}" alt="Mach Five Marketing" height="34" />
    ...
    </div></div>`;let d=[...e.querySelectorAll(`.dlf-section[data-step]`)],f=[...e.querySelectorAll(`.dlf-dot`)],p=document.getElementById(`dlf-back`),m=document.getElementById(`dlf-next`),ee=document.getElementById(`dlf-submit`),h=document.getElementById(`dlf-progress-label`),g=0;function _(t,n=1){g=Math.max(0,Math.min(a.length-1,t)),d.forEach((e,t)=>{e.hidden=t!==g,e.classList.remove(`dlf-enter`)});let r=d[g];r&&(r.style.setProperty(`--dlf-dx`,`${n>=0?14:-14}px`),r.offsetWidth,r.classList.add(`dlf-enter`)),f.forEach((e,t)=>{t===g?e.setAttribute(`aria-current`,`step`):e.removeAttribute(`aria-current`)}),h&&(h.textContent=`Section ${g+1} of ${a.length}`),p.style.visibility=g===0?`hidden`:``,m.style.display=g===a.length-1?`none`:``,ee&&(ee.style.display=g===a.length-1?``:`none`),e.querySelector(`.dlf-card`)?.scrollIntoView({block:`start`})}p.addEventListener(`click`,()=>_(g-1,-1)),m.addEventListener(`click`,()=>_(g+1,1)),f.forEach(e=>e.addEventListener(`click`,()=>{let t=Number(e.dataset.step)||0;_(t,t>=g?1:-1)})),_(0),e.querySelectorAll(`[data-question-id]`).forEach(e=>{let t=e.dataset.questionId,n=e.dataset.questionType,r=o[t];if(r!=null){if(n===`checkbox_group`){let t=Array.isArray(r)?r:[];e.querySelectorAll(`input[type="checkbox"]`).forEach(e=>{e.checked=t.includes(e.value)})}else{let t=e.querySelector(`input,textarea`);t&&(t.value=r)}}});let v=`I have edits`,te=[...e.querySelectorAll(`.dlf-field[data-question-type="checkbox_group"]`)].filter(e=>{let t=[...e.querySelectorAll(`input[type="checkbox"]`)].map(e=>e.value);return t.includes(`Approved`)&&t.includes(v)}),y=e.querySelector(`.dlf-field[data-question-id="cl_sign_approve"]`),b=()=>{let e=!1;if(te.forEach(t=>{let n=t.closest(`.dlf-section`),r=[...t.querySelectorAll(`input:checked`)].map(e=>e.value).includes(v);r&&(e=!0),n?.querySelectorAll(`.dlf-field`).forEach(e=>{e!==t&&(e.classList.toggle(`dlf-gated`,!r),e.querySelectorAll(`input,textarea`).forEach(e=>{e.disabled=!r}))})}),y&&te.length){y.classList.toggle(`dlf-gated`,e),y.querySelectorAll(`input`).forEach(t=>{t.disabled=e,e&&(t.checked=!1)});let t=y.closest(`.dlf-section`),n=t?.querySelector(`#dlf-edits-note`);!n&&t&&(n=document.createElement(`div`),n.id=`dlf-edits-note`,n.className=`dlf-note`,n.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">forward_to_inbox</span><span>You marked sections with edits, so approval is off for this round. Use <strong>Send back with edits</strong> below and your account manager will follow up with a revised plan.</span>`,t.insertBefore(n,t.querySelector(`.dlf-field`))),n&&(n.hidden=!e);let r=document.getElementById(`dlf-submit`);r&&(r.textContent=i?`Save changes`:e?`Send back with edits`:`Submit review`)}};te.forEach(e=>{e.querySelectorAll(`input[type="checkbox"]`).forEach(t=>{t.addEventListener(`change`,()=>{t.checked&&e.querySelectorAll(`input[type="checkbox"]`).forEach(e=>{e!==t&&(e.checked=!1)}),b()})})}),te.length&&b();let ne=document.getElementById(`dlf-form`),re=document.getElementById(`dlf-submit`),ie=document.getElementById(`dlf-msg`),ae=(e,t=`error`)=>{ie.textContent=e,ie.className=`dlf-msg ${t}`};ne.addEventListener(`submit`,async r=>{if(r.preventDefault(),te.length){let e=te.find(e=>!e.querySelector(`input:checked`));if(e){_(Number(e.closest(`.dlf-section`)?.dataset.step)||0),ae(`Mark each section Approved or I have edits.`);return}if(!te.some(e=>[...e.querySelectorAll(`input:checked`)].some(e=>e.value===v))&&y&&!y.querySelector(`input:checked`)){_(a.length-1),ae(`To approve the plan, check I approve this plan.`);return}}let o=er(e),s=`${Fr()}/m5t/v5/m5mDeliverable/public/${encodeURIComponent(n.guid)}`,c=i?`${s}?token=${encodeURIComponent(n.token)}`:`${s}/submit?token=${encodeURIComponent(n.token)}`;re.disabled=!0,ae(i?`Saving…`:`Submitting…`,`ok`);let l;try{l=await fetch(c,{method:i?`PUT`:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(i?{answers:o}:{answers:o,content_fingerprint:t.content_fingerprint||``})});let n=await l.json().catch(()=>({}));if(!l.ok||!n.ok){if(l.status===423){ae(n.error||`This review is now locked.`,`error`),await Ur();return}if(l.status===409&&n.reason===`content_changed`){await Ur();let e=document.getElementById(`dlf-msg`);e&&(e.textContent=n.error||`This plan was updated after you opened it. Review the latest version and submit again.`,e.className=`dlf-msg error`);return}let e=l.status===409?i?`This plan is not open for changes.`:`This plan has already been submitted.`:l.status===404?`This link is invalid or has expired.`:n.error||`Could not ${i?`save`:`submit`} (HTTP ${l.status}).`;ae(e),re.disabled=!1;return}Jr(e,i,n.data?.editability?.deadline)}catch(e){console.error(`[deliverable-fill] ${i?`edit`:`submit`} error:`,e),ae(`Something went wrong. Please try again.`),re.disabled=!1}})}function Jr(e,t,n){let r=n?` until ${D(n)}`:``;e.innerHTML=`
    <div class="dlf-page"><div class="dlf-card"><div class="dlf-state">
      <span class="material-symbols-outlined">check_circle</span>
      <h1>${t?`Changes saved`:`Thank you`}</h1>
    ...
    </div></div></div>`,document.getElementById(`dlf-again`)?.addEventListener(`click`,()=>{Ur()})}var Yr,Xr,Zr,Qr=o((()=>{T(),ye(),Xn(),or(),Mr(),cr(),Yr=!1,Xr=e=>e.audience===`am`,Zr={render:Hr,init:Ur}})),$r=c({init:()=>ti,render:()=>ei});function ei(){return`
    <div class="auth-container splash">
      <div class="auth-left">
        <div class="splash-content">
          <h1 class="splash-mark"><img src="${Jn}" alt="Mach Five Magnet" height="88" /></h1>
  ...
  `}function ti(){console.log(`[SplashRoute] Initialized - checking authentication state in 3.6 seconds...`),setTimeout(()=>{let e=localStorage.getItem(_.FF_SSE_LS_TOKEN),t=localStorage.getItem(`mvv_ts`);console.log(`[SplashRoute] localStorage check:`,{hasMvvToken:!!e,hasMvvTs:!!t});let n=document.getElementById(`splash-loader`),r=document.getElementById(`splash-actions`);e?(console.log(`[SplashRoute] Auth token found → HOME`),ni.default.publish(p.ROUTE_NAV,{route:`home`})):t?(console.log(`[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN`),ni.default.publish(p.ROUTE_NAV,{route:`signin`})):(console.log(`[SplashRoute] New user (no session history) → Showing buttons`),n&&(n.style.display=`none`),r&&(r.style.display=`flex`),document.querySelectorAll(`[data-route]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-route`);console.log(`[SplashRoute] Button clicked - navigating to: ${t}`),ni.default.publish(p.ROUTE_NAV,{route:t})})}))},4e3)}var ni,ri=o((()=>{ni=u(f(),1),Xn(),m(),v()}));function ii(e,t){typeof neodigmToast<`u`&&neodigmToast.q(t,`danger`),typeof neodigmUtils<`u`?neodigmUtils.shake(`#${e.id}`):(e.classList.add(`shake`),setTimeout(()=>e.classList.remove(`shake`),300)),e.focus()}function ai(e,t){return e?oi.test(e)?!0:(ii(t,E.get(`validation_email_invalid`)),!1):(ii(t,E.get(`validation_email_required`)),!1)}var oi,si=o((()=>{zt(),oi=/^[^\s@]+@[^\s@]+\.[^\s@]+$/})),ci=c({init:()=>ui,render:()=>li});function li(){return`
  ...
  `}function ui(){console.log(`[SigninRoute] Initialized`);let e=document.getElementById(`loginForm`),t=document.getElementById(`email`),n=document.getElementById(`password`),r=document.getElementById(`togglePassword`),i=document.getElementById(`rememberEmail`),a=localStorage.getItem(w.CONFIG.LS_KEYS.REMEMBERED_EMAIL);a&&t&&i&&(t.value=a,i.checked=!0,n?.focus()),r?.addEventListener(`click`,()=>{let e=n.type===`password`?`text`:`password`;n.type=e});let o=document.getElementById(`passkeySigninBtn`),s=document.getElementById(`passkeyDivider`),c=document.getElementById(`passkeyHint`);window.PublicKeyCredential&&o&&s&&(o.style.display=``,s.style.display=``,c&&(o.title=c.textContent),o.addEventListener(`click`,()=>pi())),e?.addEventListener(`submit`,async e=>{e.preventDefault();let r=t.value.trim(),a=n.value;ai(r,t)&&di(a,n)&&(i?.checked?localStorage.setItem(w.CONFIG.LS_KEYS.REMEMBERED_EMAIL,r):localStorage.removeItem(w.CONFIG.LS_KEYS.REMEMBERED_EMAIL),await fi(r,a))}),document.getElementById(`link--uc__underline`)?.addEventListener(`click`,e=>{e.preventDefault(),mi.default.publish(p.AUTH_FORGOT)}),document.querySelector(`.auth-switch a[href="#/signup"]`)?.addEventListener(`click`,e=>{e.preventDefault(),console.log(`[SigninRoute] Sign up link clicked - navigating to signup`),mi.default.publish(p.ROUTE_NAV,{route:`signup`})})}function di(e,t){return e?e.length<10?(ii(t,E.get(`validation_password_min_length`)),!1):!0:(ii(t,E.get(`validation_password_required`)),!1)}async function fi(e,t){let n=document.querySelector(`.btn`);n.disabled=!0,n.textContent=E.get(`loading_signing_in`);try{let r=await w.doSignin(e,t);r.ok?(console.log(`[SigninRoute] Signin successful`),typeof neodigmToast<`u`&&neodigmToast.q(E.get(`success_welcome_back`),`success`),mi.default.publish(p.AUTH_SIGNIN_SUCCESS,{entity:w.getEntity()})):r.resetRequired?(console.log(`[SigninRoute] Password reset required`),typeof neodigmToast<`u`&&neodigmToast.q(E.get(`error_password_reset_required`),`warning`)):(typeof neodigmToast<`u`&&neodigmToast.q(r.error||E.get(`error_signin_failed`),`danger`),n.disabled=!1,n.textContent=(E.get(`sign_in`)||`Sign in`).toUpperCase())}catch(e){console.error(`[SigninRoute] Sign in error:`,e),typeof neodigmToast<`u`&&neodigmToast.q(e.message||E.get(`error_network`),`danger`),n.disabled=!1,n.textContent=(E.get(`sign_in`)||`Sign in`).toUpperCase(),mi.default.publish(p.AUTH_SIGNIN_FAIL,{message:e.message})}}async function pi(){let e=document.getElementById(`passkeySigninBtn`);e.disabled=!0;try{let e=await w.doPasskeySignin();e.ok?(console.log(`[SigninRoute] Passkey signin successful`),typeof neodigmToast<`u`&&neodigmToast.q(E.get(`success_welcome_back`),`success`),mi.default.publish(p.AUTH_SIGNIN_SUCCESS,{entity:w.getEntity()})):document.getElementById(`passkeyHint`)?.style.removeProperty(`display`),!e.ok&&!e.canceled&&typeof neodigmToast<`u`&&neodigmToast.q(e.error||E.get(`error_signin_failed`),`danger`)}catch(e){console.error(`[SigninRoute] Passkey signin error:`,e),typeof neodigmToast<`u`&&neodigmToast.q(e.message||E.get(`error_network`),`danger`)}finally{e.disabled=!1}}var mi,hi=o((()=>{mi=u(f(),1),Xn(),m(),T(),zt(),si()}));function gi(e){let t=[];return e.length<12&&t.push(`at least 12 characters`),e.length>1024&&t.push(`at most 1024 characters`),/[a-z]/.test(e)||t.push(`1 lowercase`),/[A-Z]/.test(e)||t.push(`1 uppercase`),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(e)||t.push(`1 special character`),/[^\x00-\x7F]/.test(e)&&t.push(`ASCII characters only`),t}function _i(e){if(e.length===0)return``;if(e.includes(`ASCII characters only`))return`Password cannot contain emoji|or special unicode characters`;let t=e.find(e=>/^at (?:least|most) \d+ characters$/.test(e));return t?`Password must have ${t.replace(/ (\d+ characters)$/,`|$1`)}`:`Password must have: Uppercase,|Lowercase, and Special Character`}var vi=o((()=>{})),yi=c({init:()=>xi,render:()=>bi});function bi(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Gn()}
  ...
  `}function xi(){console.log(`[SignupRoute] Initialized`);let e=document.getElementById(`signupForm`),t=e.querySelector(`button[type="submit"]`);Si(`togglePassword`,`password`,`eyeIcon`),Si(`toggleConfirmPassword`,`confirmPassword`,`eyeIconConfirm`),document.querySelector(`.auth-switch a[href="#/signin"]`)?.addEventListener(`click`,e=>{e.preventDefault(),console.log(`[SignupRoute] Sign in link clicked - navigating to signin`),Ei.default.publish(p.ROUTE_NAV,{route:`signin`})}),e.addEventListener(`submit`,async e=>{e.preventDefault();let n=document.getElementById(`first`).value.trim(),r=document.getElementById(`last`).value.trim(),i=document.getElementById(`email`).value.trim(),a=document.getElementById(`company`).value.trim(),o=document.getElementById(`phone`).value.trim(),s=document.getElementById(`password`).value,c=document.getElementById(`confirmPassword`).value,l=document.getElementById(`first`),u=document.getElementById(`last`),d=document.getElementById(`email`),f=document.getElementById(`password`),p=document.getElementById(`confirmPassword`);if(!Ci(n,l,E.get(`validation_first_name_required`))||!Ci(r,u,E.get(`validation_last_name_required`))||!ai(i,d)||!wi(s,f))return;if(s!==c){ii(p,E.get(`validation_password_mismatch`));return}let m=document.getElementById(`acceptTerms`);if(!m.checked){ii(m,`Please accept the Terms of Service and Privacy Policy to continue.`);return}t.disabled=!0,t.textContent=E.get(`loading_creating_account`),await Ti(n,r,i,a,o,s)})}function Si(e,t,n){let r=document.getElementById(e),i=document.getElementById(t),a=document.getElementById(n);!r||!i||!a||r.addEventListener(`click`,()=>{let e=i.type===`password`;i.type=e?`text`:`password`,e?a.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:a.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function Ci(e,t,n){return e?!0:(ii(t,n),!1)}function wi(e,t){if(!e)return ii(t,E.get(`validation_password_required`)),!1;let n=gi(e);return n.length>0?(ii(t,_i(n)),!1):!0}async function Ti(e,t,n,r,i,a){let o=document.querySelector(`button[type="submit"]`);try{let s={email:n,password:a,first:e,last:t};r&&(s.company=r),i&&(s.phone=i),s.terms_accepted=!0,s.legal_version=Di;let c=await w.doSignup(s);if(c.ok)Ei.default.publish(p.AUTH_SIGNUP_SUCCESS,{email:n}),typeof mvvLegit<`u`&&mvvLegit.doUNVERF();else{let e=c.error||c.message||E.get(`error_signup_failed`);typeof neodigmToast<`u`&&neodigmToast.q(e,`danger`),o.disabled=!1,o.textContent=(E.get(`create_account`)||`Create account`).toUpperCase(),Ei.default.publish(p.AUTH_SIGNUP_FAIL,{message:e})}}catch(e){console.error(`[SignupRoute] Sign up error:`,e),typeof neodigmToast<`u`&&neodigmToast.q(e.message||E.get(`error_network`),`danger`),o.disabled=!1,o.textContent=(E.get(`create_account`)||`Create account`).toUpperCase(),Ei.default.publish(p.AUTH_SIGNUP_FAIL,{message:e.message})}}var Ei,Di,Oi=o((()=>{Ei=u(f(),1),Xn(),m(),T(),vi(),zt(),si(),Di=`2026-07-15`})),ki=c({init:()=>ji,render:()=>Ai});function Ai(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Gn()}
  ...
  `}function ji(){console.log(`[VerfLinkRoute] Initialized`);let e=Date.now(),t=document.getElementById(`countdown-display`);function n(){let n=Date.now()-e,i=Math.floor(n/1e3),a=Math.max(0,7200-i),o=Math.floor(a/3600),s=Math.floor(a%3600/60),c=a%60,l=`${String(o).padStart(2,`0`)}:${String(s).padStart(2,`0`)}:${String(c).padStart(2,`0`)}`;t&&(t.textContent=l,a<600&&(t.style.color=`#ef4444`,t.style.textShadow=`
          0 0 10px rgba(239, 68, 68, 0.9),
          0 0 20px rgba(239, 68, 68, 0.7),
          0 0 30px rgba(239, 68, 68, 0.5)
        `),a===0&&(t.style.color=`#7f1d1d`,t.style.textShadow=`none`)),a===0&&(clearInterval(r),console.log(`[VerfLinkRoute] Countdown expired`),window.neodigmWired4Sound&&window.neodigmWired4Sound.sound(14),setTimeout(()=>{window.router&&window.router.navigate(`/splash`)},600))}n();let r=setInterval(n,1e3);window.addEventListener(`beforeunload`,()=>{clearInterval(r)})}var Mi=o((()=>{Xn()})),Ni,Pi,Fi,Ii,Li=o((()=>{Ni=u(f(),1),m(),Pi=`https://machfivemagnet-saas.onrender.com`,Fi=class{constructor(){this.baseUrl=Pi}async request(e,t={}){let n=`${this.baseUrl}${e}`,r={"Content-Type":`application/json`,...t.headers};try{let i=await fetch(n,{...t,headers:r});if(i.status===401||i.status===403){Ni.default.publish(p.AUTH_TOKEN_EXPIRED,{status:i.status,endpoint:e});let t=await i.json().catch(()=>({}));throw Error(t.error||`Authentication failed`)}let a=await i.json();return{ok:i.ok,status:i.status,data:a}}catch(t){throw console.error(`API Request Error:`,t),Ni.default.publish(p.APP_ERROR,{message:t.message,endpoint:e}),t}}async get(e){return this.request(e,{method:`GET`})}async post(e,t){return this.request(e,{method:`POST`,body:JSON.stringify(t)})}async put(e,t){return this.request(e,{method:`PUT`,body:JSON.stringify(t)})}async delete(e){return this.request(e,{method:`DELETE`})}async signin(e,t){return this.post(`/api/acctEntity/signin`,{email:e,hash:t})}async signup(e){return this.post(`/api/acctEntity/signup`,e)}async signout(){return this.post(`/api/acctEntity/signout`,{})}async forgotPassword(e){return this.get(`/m5t/v5/acctEntity/forgot?CODE=${encodeURIComponent(e)}`)}async resetHash(e,t){return this.post(`/api/acctEntity/resethash`,{email:e,hash:t})}async verifyAccount(e){return this.get(`/api/acctEntity/verify?CODE=${e}`)}async getAccounts(){return this.get(`/api/acctEntity`)}async getAccount(e){return this.get(`/api/acctEntity/${e}`)}async updateAccount(e,t){return this.put(`/api/acctEntity/${e}`,t)}async deleteAccount(e){return this.delete(`/api/acctEntity/${e}`)}async ping(){return this.get(`/ping`)}},Ii=new Fi})),Ri=c({init:()=>Bi,render:()=>zi});function zi(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Gn(`#/signin`)}
  ...
  `}function Bi(){console.log(`[ForgotRoute] Initialized`);let e=document.getElementById(`forgot-form`),t=document.getElementById(`email`);e?.addEventListener(`submit`,async e=>{e.preventDefault();let n=t.value.trim();ai(n,t)&&await Vi(n)})}async function Vi(e){let t=document.querySelector(`.btn`);t.disabled=!0,t.textContent=`SENDING...`;try{let n=await Ii.forgotPassword(e);n.ok&&n.data.ok?(typeof neodigmToast<`u`&&neodigmToast.q(E.get(`success_reset_link_sent`),`success`),Hi.default.publish(p.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate(`/verf-link`)},2e3)):(typeof neodigmToast<`u`&&neodigmToast.q(n.data.error||E.get(`error_signin_failed`),`danger`),t.disabled=!1,t.textContent=(E.get(`send_reset_link`)||`Send reset link`).toUpperCase())}catch(e){console.error(`[ForgotRoute] Forgot password error:`,e),typeof neodigmToast<`u`&&neodigmToast.q(e.message||E.get(`error_network`),`danger`),t.disabled=!1,t.textContent=(E.get(`send_reset_link`)||`Send reset link`).toUpperCase()}}var Hi,Ui=o((()=>{Hi=u(f(),1),Xn(),m(),Li(),zt(),si()})),Wi=c({init:()=>Ki,render:()=>Gi});function Gi(){let e=w.getEntity()?.email||``;return`
    <div class="auth-container">
      <div class="auth-left">
        ${Gn(`#/home`)}
  ...
  `}function Ki(){console.log(`[ResethashRoute] Initialized`);let e=document.getElementById(`resethash-form`),t=e.querySelector(`button[type="submit"]`);qi(`toggleNewPassword`,`new-password`,`eyeIconNew`),qi(`toggleConfirmPassword`,`confirm-password`,`eyeIconConfirm`),e?.addEventListener(`submit`,async n=>{n.preventDefault();let r=e.email.value.trim(),i=e.newPassword.value,a=e.confirmPassword.value,o=document.getElementById(`new-password`),s=document.getElementById(`confirm-password`);if(!i){ii(o,E.get(`validation_new_password_required`));return}let c=gi(i);if(c.length>0){ii(o,_i(c));return}if(!a){ii(s,E.get(`validation_new_password_required`));return}if(i!==a){ii(s,E.get(`validation_password_mismatch`));return}t.disabled=!0,t.textContent=E.get(`loading_resetting_password`);try{let e=await w.doResetHash(r,i);e.ok?(typeof neodigmToast<`u`&&neodigmToast.q(E.get(`success_password_reset`),`success`),Ji.default.publish(p.AUTH_RESETHASH_SUCCESS,{email:r})):(ii(o,e.error||E.get(`error_signin_failed`)),t.disabled=!1,t.textContent=(E.get(`update_password`)||`Update password`).toUpperCase())}catch(e){console.error(`[ResethashRoute] Reset password error:`,e),ii(o,e.message||E.get(`error_network`)),t.disabled=!1,t.textContent=(E.get(`update_password`)||`Update password`).toUpperCase()}})}function qi(e,t,n){let r=document.getElementById(e),i=document.getElementById(t),a=document.getElementById(n);!r||!i||!a||r.addEventListener(`click`,()=>{let e=i.type===`password`;i.type=e?`text`:`password`,e?a.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:a.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}var Ji,Yi=o((()=>{Ji=u(f(),1),Xn(),m(),T(),vi(),zt(),si()}));function Xi(){if(oa)return;let e=document.createElement(`style`);e.id=`m5t-portfolio-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),oa=!0}async function Zi(e,{days:t=30}={}){let n=new Date,r=sa(new Date(n.getTime()-(t-1)*864e5)),i=sa(n),a=await fetch(`${e}/m5t/v5/dashboard/stats?from=${r}&to=${i}&group_by=owner`);if(!a.ok)throw Error(`HTTP ${a.status}`);let o=await a.json();if(!o.ok)throw Error(`stats not ok`);return o.by_owner||[]}function Qi(e,t){let n=e;return`<div class="dash-clients-scroll"><table class="dash-clients">
    <thead><tr>
      <th>Client</th>${t.map(e=>`<th>${e.h}</th>`).join(``)}<th></th>
    </tr></thead>
    <tbody>${n.map(e=>`
      <tr data-org="${ia(e.owner_guid)}" tabindex="0" role="button"
          aria-label="Open ${ia(e.name||`client`)}">
        <td><span class="dc-name">${ia(e.name||e.owner_guid)}
          <span class="dc-chip">${ia(aa[e.channel]||e.channel||``)}</span></span></td>
        ${t.map(t=>`<td>${t.td(e)}</td>`).join(``)}
        <td><span class="dc-view">View →</span></td>
      </tr>`).join(``)}</tbody>
  </table></div>`}function $i(e){let t=e.querySelector(`.pf-access-error`);t||(t=document.createElement(`div`),t.className=`pf-access-error`,e.prepend(t)),t.textContent=`You don't have direct access to manage this org. Use the admin console to act on its behalf.`}function ea(e){if(!e)return;Yt(e.querySelector(`.dash-clients tbody`)||e,{rowSelector:`tr[data-org]`,noun:`clients`,controlHost:e.querySelector(`.dash-clients-scroll`)||e});let t=async t=>{let n=t?.dataset?.org;n&&(await w.setActiveOrg(n))?.activeOrgError&&$i(e)};e.querySelectorAll(`tbody tr[data-org]`).forEach(e=>{e.addEventListener(`click`,()=>t(e)),e.addEventListener(`keydown`,n=>{(n.key===`Enter`||n.key===` `)&&(n.preventDefault(),t(e))})})}function ta({section:e,title:t,description:n}){return Xi(),`
    <div class="page-shell" data-section="${ia(e)}">
      <div class="page-header">
        <div class="page-header-text">
          <h1 class="page-title">${ia(t)}</h1>
          <p class="page-description">${ia(n)}</p>
        </div>
      </div>
      <div class="dashboard-card">
        ...
        <div class="card-body" id="pf-picker-body">${ca(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function na(e,t,{emptyMsg:n}={}){let r=document.getElementById(`pf-picker-body`);if(r)try{let i=await Zi(e);if(!i.length){r.innerHTML=ca(`groups`,n||`No client orgs yet. Create one under Clients first.`);return}r.innerHTML=Qi(i,t),ea(r)}catch(e){console.warn(`[portfolio] picker load failed:`,e),r.innerHTML=ca(`error`,`Could not load your clients. Please refresh.`)}}function ra(){let e={};return w.getManagedClients().forEach(t=>{e[t.orgGuid]=t.name}),w.getMemberships().forEach(t=>{t.orgGuid&&!e[t.orgGuid]&&(e[t.orgGuid]=t.name||``)}),e}var A,ia,aa,oa,sa,ca,la,ua=o((()=>{T(),Zt(),A=()=>w.getManagedClients().length>0&&!w.getStoredActiveOrg(),ia=e=>String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]),aa={reseller_org:`Your org`,managed_client:`Client`,saas_org:`Org`},oa=!1,sa=e=>e.toISOString().slice(0,10),ca=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,la=e=>e?`<span class="pf-client-chip">${ia(e)}</span>`:``}));function da(e,t){ha.set(e,t)}function fa(e){if(!ha.has(e))return null;let t=ha.get(e);return ha.delete(e),t}function pa(e){return ha.has(e)?ha.get(e):null}var ma,ha,ga=o((()=>{ma=Object.freeze({MAGNET_TEMPLATE:`magnet_template`,LEADS_SEARCH:`leads_search`,LEADS_DAY:`leads_day`}),ha=new Map}));function _a({icon:e,label:t,valueId:n,value:r=`—`,subId:i,sub:a=``,href:o,trendId:s}={}){let c=o?`a`:`div`;return`
  <${c}${o?` href="${ya(o)}" class="stat-card stat-card--link"`:` class="stat-card"`}>
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${ya(e)}</span>
      <span class="stat-label">${ya(t)}</span>
      ${o?`<span class="stat-go material-symbols-outlined" aria-hidden="true">north_east</span>`:``}
    </div>
    <div class="stat-value"${n?` id="${ya(n)}"`:``}>${r}</div>
    <div class="stat-change">${s?`<span class="stat-trend" id="${ya(s)}"></span>`:``}<span class="stat-sublabel"${i?` id="${ya(i)}"`:``}>${a}</span></div>
  </${c}>`}var va,ya,ba=o((()=>{va={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},ya=e=>String(e??``).replace(/[&<>"']/g,e=>va[e])})),xa=c({default:()=>qa,init:()=>Da,render:()=>Ea,statCard:()=>_a,svgTrendChart:()=>Na,wireTrendTooltip:()=>Pa});function Sa(e){let t=e.created?.created_tz;if(!t)return``;try{return new Date(t).toLocaleDateString([],{month:`short`,day:`numeric`})}catch{return``}}function Ca(e){try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return``}}function wa(){if(za)return;let e=document.createElement(`style`);e.id=`m5t-dash-recent-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),za=!0}function Ta(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${Ia(Ra(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${Ia(La(e))}</span>
      <span class="recent-lead__sub">${Ia(e.email||e.phone||``)}</span>
    </span>
    <span class="m5t-badge recent-lead__badge" data-s="${Ia(e.status)}">${Ia(e.status)}</span>
    <span class="recent-lead__time">${Ia(Sa(e))}</span>
  </a>`}function Ea(){wa(),Xi();let e=A();return`
    <div class="page-shell" data-section="home">
      ...
      <div class="dashboard-card dashboard-card--lead">
        ...
        <div class="card-body" id="dash-portfolio">${Fa(`hourglass_empty`,`Loading…`)}</div>
      </div>`:``}

      <div class="stats-grid">
        ${_a({icon:`widgets`,label:`Active Magnets`,valueId:`stat-active-magnets`,subId:`stat-active-magnets-sub`,sub:`Loading…`,href:`#/magnets`})}
        ${_a({icon:`ads_click`,label:`Magnet Opens`,valueId:`stat-opens`,subId:`stat-opens-sub`,sub:`Loading…`,href:`#/analytics`})}
        ${_a({icon:`person_add`,label:`Leads Captured`,valueId:`stat-leads`,subId:`stat-leads-sub`,sub:`Loading…`,href:`#/leads`,trendId:`stat-leads-trend`})}
        ${_a({icon:`check_circle`,label:`Completion Rate`,valueId:`stat-completion`,subId:`stat-completion-sub`,sub:`Loading…`,href:`#/analytics`})}
      </div>

      <div class="charts-section">
        ${Ba(`show_chart`,`Opens & Leads`,`dash-trend`,{wide:!0,controls:!0})}
        <div class="charts-grid">
          ${Ba(`filter_alt`,`Completion Funnel`,`dash-funnel`)}
          ${Ba(`source`,`Top Campaigns`,`dash-campaigns`)}
          ${Ba(`touch_app`,`CTA Usage`,`dash-routes`,{full:!0})}
        </div>
      </div>
      ...
      <div class="content-grid">
        ...
        <div class="dashboard-card">
          ...
          <div class="card-body" id="recent-leads-body">
            ${Fa(`hourglass_empty`,`Loading leads…`)}
          </div>
        </div>
      </div>
    </div>`}async function Da(){let e=w.getConfig?.().BASE_URL||``;document.getElementById(`dash-periods`)?.addEventListener(`click`,t=>{let n=t.target.closest(`button[data-days]`);n&&(Va=Number(n.dataset.days)||30,document.querySelectorAll(`#dash-periods .chart-period-btn`).forEach(e=>e.classList.toggle(`active`,Number(e.dataset.days)===Va)),Oa(e))}),document.getElementById(`dash-campaigns`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-campaign]`);t&&da(ma.LEADS_SEARCH,t.dataset.campaign)}),await Promise.all([Oa(e),ja(e)])}async function Oa(e){let t=new Date,n=Wa(new Date(t.getTime()-(Va-1)*864e5)),r=Wa(t),i=A(),a;try{let t=await fetch(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${r}${i?`&group_by=owner`:``}`);if(!t.ok)throw Error(`HTTP ${t.status}`);if(a=await t.json(),!a.ok)throw Error(`stats not ok`)}catch(e){console.warn(`[dashboard] stats fetch failed:`,e),[`stat-active-magnets`,`stat-opens`,`stat-leads`,`stat-completion`].forEach(e=>Ha(e,`—`)),[`stat-active-magnets-sub`,`stat-opens-sub`,`stat-leads-sub`,`stat-completion-sub`].forEach(e=>Ha(e,`Unavailable`));let t=document.getElementById(`stat-leads-trend`);t&&(t.className=`stat-trend`,t.innerHTML=``),[`dash-trend`,`dash-funnel`,`dash-campaigns`,`dash-routes`,`dash-interactions`,`dash-portfolio`].forEach(e=>Ua(e,Fa(`error`,`Could not load. Please refresh.`)));return}i&&ka(a.by_owner||[]),Ha(`stat-active-magnets`,j(a.magnets.active)),Ha(`stat-active-magnets-sub`,a.magnets.total>a.magnets.active?`${j(a.magnets.total-a.magnets.active)} paused`:a.magnets.active?`All running`:`No magnets yet`);let o=a.funnel||{};Ha(`stat-opens`,o.opens?j(o.opens):`—`),Ha(`stat-opens-sub`,o.opens?o.engagement_rate==null?`${j(o.engaged)} engaged`:`${o.engagement_rate}% engage`:`No opens in this range yet`);let s=a.leads||{};Ha(`stat-leads`,j(s.total));let c=(s.this_week||0)-(s.prev_week||0);Ha(`stat-leads-sub`,s.total?`${j(s.this_week)} this week`:`No leads yet`);let l=document.getElementById(`stat-leads-trend`);if(l){if((s.prev_week||0)>0){let e=c>0?`positive`:c<0?`negative`:`neutral`,t=c>0?`trending_up`:c<0?`trending_down`:`trending_flat`;l.className=`stat-trend ${e}`,l.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">${t}</span>${c>0?`+`:``}${j(c)}`}else l.className=`stat-trend`,l.innerHTML=``}Ha(`stat-completion`,o.completion_rate==null?`—`:`${o.completion_rate}%`),Ha(`stat-completion-sub`,o.opens?`${j(o.completions)} completed of ${j(o.opens)} opens`:`Appears once magnets get opened`);let u=a.by_day||[],d=u.some(e=>e.opens||e.leads);Ua(`dash-trend`,d?Na(u):Fa(`show_chart`,`No activity in this range yet. Opens and leads chart here as visitors engage your magnets.`)),d&&Pa(u),Ua(`dash-funnel`,o.opens?Aa(o):Fa(`filter_alt`,`The funnel fills in once your magnets record opens.`));let f=a.top_campaigns||[];Ua(`dash-campaigns`,f.length?`<div class="dash-list">${f.map(e=>`
        <a class="dash-list__row dash-list__row--link" href="#/leads" data-campaign="${Ia(e.campaign)}" title="Show the leads from ${Ia(e.campaign)}">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">campaign</span></span>
          <span class="dash-list__main">${Ia(e.campaign)}</span>
        ...
        </a>`).join(``)}</div>`:Fa(`source`,`No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here.`));{let e=document.getElementById(`dash-campaigns`)?.querySelector(`.dash-list`);e&&Yt(e,{rowSelector:`.dash-list__row`,noun:`campaigns`})}let p={book:[`event`,`Book`],chat:[`chat`,`Chat`],call:[`phone_in_talk`,`Call`],email:[`mail`,`Email`],support:[`support_agent`,`Support`]},m=Object.entries(o.routes||{}).sort((e,t)=>t[1]-e[1]),ee=m.length?m[0][1]:0;Ua(`dash-routes`,m.length?`<div class="dash-funnel">${m.map(([e,t])=>{let[n,r]=p[e]||[`touch_app`,e];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${n}</span> ${Ia(r)}</span><span class="dash-funnel__val">${j(t)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${ee?Math.max(4,Math.round(t/ee*100)):0}%"></div></div>
        </div>`}).join(``)}</div>`:Fa(`touch_app`,`CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar.`));let h={open:[`visibility`,`Magnet opened`],engage:[`touch_app`,`Visitor engaged`],route:[`alt_route`,`Picked a channel`],complete:[`check_circle`,`Completed: lead captured`]},g=a.recent_events||[];Ua(`dash-interactions`,g.length?`<div class="dash-list">${g.map(e=>{let[t,n]=h[e.event]||[`sensors`,e.event];return`<div class="dash-list__row">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">${t}</span></span>
          <span class="dash-list__main">${n}${e.event===`route`&&e.detail?` · ${Ia(e.detail)}`:``}</span>
          ${e.display_mode?`<span class="dash-list__mode">${Ia(e.display_mode)}</span>`:``}
          <span class="dash-list__time">${Ia(Ca(e.at))}</span>
        </div>`}).join(``)}</div>`:Fa(`sensors`,`No interactions yet. They'll stream in as visitors engage your magnets.`));{let e=document.getElementById(`dash-interactions`)?.querySelector(`.dash-list`);e&&Yt(e,{rowSelector:`.dash-list__row`,noun:`interactions`})}}function ka(e){let t=document.getElementById(`dash-portfolio`);if(!t)return;if(!e.length){t.innerHTML=Fa(`groups`,`No client orgs yet. Create one under Clients to see its numbers here.`);return}let n=e.some(e=>e.ad),r=e=>{let t=(e.leads.this_week||0)-(e.leads.prev_week||0);return!e.leads.this_week&&!e.leads.prev_week?``:` <span class="${t>=0?`dc-delta-up`:`dc-delta-down`}">(${t>=0?`+`:``}${j(t)})</span>`};t.innerHTML=Qi(e,[{h:`Magnets`,td:e=>`${j(e.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${j(e.magnets.total)}</span>`},{h:`Leads · wk`,td:e=>`${j(e.leads.this_week)}${r(e)}`},{h:`Leads · total`,td:e=>j(e.leads.total)},{h:`Opens`,td:e=>j(e.opens)},{h:`Compl.`,td:e=>e.completion_rate==null?`—`:`${e.completion_rate}%`},...e.some(e=>e.ab_tests?.running||e.ab_tests?.completed)?[{h:`A/B`,td:e=>e.ab_tests?.running?`${j(e.ab_tests.running)} <span class="dc-sub">running</span>`:e.ab_tests?.completed?`${j(e.ab_tests.completed)} <span class="dc-sub">done</span>`:`—`}]:[],...e.some(e=>e.booked)?[{h:`Booked`,td:e=>e.booked?j(e.booked):`—`}]:[],...e.some(e=>e.called)?[{h:`Called`,td:e=>e.called?j(e.called):`—`}]:[],...n?[{h:`Spend`,td:e=>e.ad?`$${j(e.ad.spend)}`:`—`},{h:`CPL`,td:e=>e.ad?.cost_per_lead==null?`—`:`$${j(e.ad.cost_per_lead)}`}]:[]]),ea(t)}function Aa(e){let t=[[`Opened`,e.opens,``],[`Engaged`,e.engaged,` dash-funnel__bar--mid`],[`Completed`,e.completions,` dash-funnel__bar--end`],...e.booked?[[`Booked`,e.booked,` dash-funnel__bar--end`]]:[],...e.called?[[`Called`,e.called,` dash-funnel__bar--end`]]:[]],n=Math.max(1,e.opens||0),r=e=>Math.min(100,Math.round((e||0)/n*100));return`<div class="dash-funnel">${t.map(([e,t,n])=>`
    ...
    </div>`).join(``)}</div>`}async function ja(e){let t=document.getElementById(`recent-leads-body`);if(t)try{let n=await fetch(`${e}/m5t/v5/m5mLead?limit=5`);if(!n.ok)throw Error(`HTTP ${n.status}`);let r=await n.json(),i=(Array.isArray(r?.data)?r.data:[]).filter(e=>![`DELETED`,`ARCHIVED`].includes(e.status));t.innerHTML=i.length?i.slice(0,5).map(Ta).join(``):Fa(`contacts`,`No leads captured yet. Publish a magnet to start collecting.`)}catch(e){console.warn(`[dashboard] Leads fetch failed:`,e),t.innerHTML=Fa(`error`,`Could not load recent leads.`)}}function Ma(e){if(e<=0)return 1;let t=10**Math.floor(Math.log10(e)),n=e/t;return(n<=1?1:n<=2?2:n<=5?5:10)*t}function Na(e){let t=e.length||1,n=Ma(Math.max(1,...e.map(e=>e.opens||0))),r=Ma(Math.max(1,...e.map(e=>e.leads||0))),i=748/t,a=Math.min(22,i*.55),o=e=>46+i*(e+.5),s=e=>266-e/n*248,c=e=>266-e/r*248,l=[0,.5,1].map(e=>{let t=266-e*248;return`<line x1="46" y1="${t.toFixed(1)}" x2="794" y2="${t.toFixed(1)}" class="dash-grid"/><text x="38" y="${(t+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${Ka(n*e)}</text><text x="802" y="${(t+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${Ka(r*e)}</text>`}).join(``),u=e.map((e,t)=>{let n=s(e.opens||0);return`<rect class="dash-bar" data-i="${t}" x="${(o(t)-a/2).toFixed(1)}" y="${n.toFixed(1)}" width="${a.toFixed(1)}" height="${Math.max(0,266-n).toFixed(1)}" rx="3"/>`}).join(``),d=e.map((e,t)=>`${o(t).toFixed(1)},${c(e.leads||0).toFixed(1)}`).join(` `),f=t>1?`<polyline class="dash-line" points="${d}" fill="none" stroke-width="2.5"/>`:``,p=e.map((e,t)=>`<circle class="dash-dot" data-i="${t}" cx="${o(t).toFixed(1)}" cy="${c(e.leads||0).toFixed(1)}" r="3.2"/>`).join(``),m=Math.max(1,Math.ceil(t/6));return`
  ...
  <div class="dashboard-card${r?` chart-card-wide`:``}${i?` chart-card-full`:``}">
    ...
    <div class="card-body" id="${n}">${Fa(`hourglass_empty`,`Loading…`)}</div>
  </div>`,Va=30,Ha=(e,t)=>{let n=document.getElementById(e);n&&(n.textContent=t)},Ua=(e,t)=>{let n=document.getElementById(e);n&&(n.innerHTML=t)},Wa=e=>e.toISOString().slice(0,10),Ga=()=>typeof window.matchMedia!=`function`||window.matchMedia(`(hover: hover)`).matches,Ka=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3==0?0:1)+`k`:String(e)),qa={render:Ea,init:Da}})),Ya=c({init:()=>Za,render:()=>Xa});function Xa(){return`
    <div class="auth-container">
      <div class="auth-left">
        ${Gn(`#/home`)}
  ...
  `}function Za(){console.log(`[SignoutRoute] Initialized`);let e=document.getElementById(`confirm-signout-btn`);e?.addEventListener(`click`,async()=>{e.disabled=!0,e.textContent=`SIGNING OUT...`,console.log(`[SignoutRoute] User confirmed signout`),await w.doSignout()})}var Qa=o((()=>{T(),Xn()})),$a=c({default:()=>io,init:()=>no,render:()=>to});function eo(){if(ro)return;let e=document.createElement(`style`);e.id=`m5t-section-page-styles`,e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),ro=!0}function to({title:e=`Section`,icon:t=`widgets`,name:n=``}={}){return eo(),`
    ...
    </section>`}function no(){}var ro,io,ao=o((()=>{ro=!1,io={render:to,init:no}})),oo=c({default:()=>ko,init:()=>mo,render:()=>po});function so(){if(Do)return;let e=document.createElement(`style`);e.id=`m5t-settings-general-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Do=!0}function co(){try{return Bt.getAvailableLanguages()||[]}catch{return[]}}function lo(){let e=co(),t=e.includes(_.FF_SSE_I18N_LANG)?_.FF_SSE_I18N_LANG:e[0]||_.FF_SSE_I18N_LANG;try{let n=localStorage.getItem(_.FF_SSE_LS_USER_LANG);return n&&e.includes(n)?n:t}catch{return t}}function uo(e){try{let t=new Intl.DisplayNames([e],{type:`language`}).of(e);if(t&&t!==e)return t.charAt(0).toUpperCase()+t.slice(1)}catch{}return e}function fo(){let e=_n(),t=co(),n=t.length>1;if(!e&&!n)return``;let r=lo();return`
        ...
        <div class="settings-item" id="gen-dark-item">
          ...
          <div class="settings-item__control">
            <label class="m5t-switch">
              <input type="checkbox" role="switch" id="gen-dark" aria-label="Dark mode" ${wn()===`dark`?`checked`:``} />
        ...
        <div class="settings-item" id="gen-lang-item">
          ...
          <div class="settings-item__control">
            <select class="settings-select" id="gen-lang" aria-label="Language">
              ${t.map(e=>`<option value="${So(e)}" ${e===r?`selected`:``}>${So(uo(e))}</option>`).join(``)}
            </select>
          </div>
        </div>`:``}
      </div>
    </div>`}function po(){return so(),`
    <div class="page-shell" data-section="settings-general">
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ...
          <div id="gen-profile-body">${Oo(`hourglass_empty`,`Loading…`)}</div>
        </div>
      </div>
    ...
    </div>`}async function mo(){yo(),await go()}function ho(e){return`
    <div class="settings-grid-2">
      <div class="settings-field">
        <label class="settings-label" for="gen-first">First name</label>
        <input class="settings-input" id="gen-first" type="text" autocomplete="given-name" value="${So(e.first)}" />
        <p class="settings-error" id="gen-first-error" role="alert" hidden></p>
      </div>
      <div class="settings-field">
        <label class="settings-label" for="gen-last">Last name</label>
        <input class="settings-input" id="gen-last" type="text" autocomplete="family-name" value="${So(e.last)}" />
        <p class="settings-error" id="gen-last-error" role="alert" hidden></p>
      </div>
    </div>
    <div class="settings-field">
      <label class="settings-label" for="gen-company">Company</label>
      <input class="settings-input" id="gen-company" type="text" autocomplete="organization" value="${So(e.company)}" />
    </div>
    <div class="settings-field">
      <label class="settings-label" for="gen-phone">Phone</label>
      <input class="settings-input" id="gen-phone" type="tel" autocomplete="tel" value="${So(e.phone)}" />
    </div>
    <div class="settings-field">
      <label class="settings-label" for="gen-email">Sign-in email</label>
      <input class="settings-input" id="gen-email" type="email" value="${So(e.email)}" readonly />
    ...
    </div>`}async function go(){let e=document.getElementById(`gen-profile-body`);if(e){try{let e=await fetch(To()),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok||!t.data)throw Error(t.error||`Failed to load`);Eo.profile=t.data}catch(t){console.warn(`[settings-general] profile load failed:`,t),e.innerHTML=Oo(`error`,`Could not load your profile. Please try again.`);return}e.innerHTML=ho(Eo.profile),e.querySelector(`#gen-save`)?.addEventListener(`click`,vo)}}function _o(e,t){let n=document.getElementById(`${e}-error`);n&&(n.textContent=t||``,n.hidden=!t);let r=document.getElementById(e);r&&r.setAttribute(`aria-invalid`,t?`true`:`false`)}async function vo(){let e=document.getElementById(`gen-save`),t=e=>(document.getElementById(e)?.value??``).trim(),n={first:t(`gen-first`),last:t(`gen-last`),company:t(`gen-company`),phone:t(`gen-phone`)};if(_o(`gen-first`,n.first?``:`First name is required.`),_o(`gen-last`,n.last?``:`Last name is required.`),!(!n.first||!n.last)){e&&(e.disabled=!0);try{let e=await fetch(To(),{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify(n)}),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(t.error||`Could not save.`);t.data&&(Eo.profile=t.data),Co(`Profile updated.`,`success`)}catch(e){console.warn(`[settings-general] profile save failed:`,e),Co(e.message||`Could not save.`,`error`)}finally{e&&(e.disabled=!1)}}}function yo(){let e=document.getElementById(`gen-dark`);if(e){e.addEventListener(`change`,()=>{Tn(e.checked?`dark`:`light`),e.checked=wn()===`dark`});let t=bo.default.subscribe(p.UI_THEME_CHANGED,()=>{if(!e.isConnected){bo.default.unsubscribe(t);return}e.checked=wn()===`dark`})}let t=document.getElementById(`gen-lang`);t&&t.addEventListener(`change`,()=>{try{Bt.setLanguage(t.value)}catch(e){console.warn(`[settings-general] setLanguage failed:`,e)}})}var bo,xo,So,Co,wo,To,Eo,Do,Oo,ko,Ao=o((()=>{T(),bo=u(f(),1),m(),v(),On(),xn(),xo={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},So=e=>String(e??``).replace(/[&<>"']/g,e=>xo[e]),Co=(e,t=`info`)=>{try{bo.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},wo=()=>w.getConfig?.().BASE_URL||``,To=()=>`${wo()}/m5t/v5/acctEntity/profile`,Eo={profile:null},Do=!1,Oo=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,ko={render:po,init:mo}})),jo=c({default:()=>os,init:()=>Po,render:()=>No});function Mo(){if(rs)return;let e=document.createElement(`style`);e.id=`m5t-workspace-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),rs=!0}function No(){Mo();let e=Zo[ts()];return`
    <div class="page-shell" data-section="settings-workspace">
      <div class="page-header">
        <div class="page-header-text">
          <div class="ws-title-row">
            <h1 class="page-title">Workspace</h1>
            ${e?`<span class="m5t-chip">${Ko(e)}</span>`:``}
          </div>
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ${as(`apartment`,`Organization`,`Name and details.`)}
          <div id="ws-org-body">${is(`hourglass_empty`,`Loading…`)}</div>
        </div>
      </div>

      <div class="dashboard-card" id="ws-team-card" style="margin-top:24px; display:none">
        <div class="card-body">
          ${as(`group`,`Team`,`Who has access.`)}
          <div id="ws-team-body"></div>
        </div>
      </div>
    </div>`}async function Po(){$o.org=null,await Fo(),await Bo()}async function Fo(){let e=document.getElementById(`ws-org-body`);if(!e)return;let t=es();if(!t){e.innerHTML=is(`apartment`,`No workspace on this account yet.`);return}try{let e=await fetch(`${Jo()}/m5t/v5/acctGroup`),n=await e.json().catch(()=>({}));if(!e.ok||!n.ok)throw Error(n.error||`Failed (HTTP ${e.status})`);if($o.org=(n.data||[]).find(e=>e.guid===t)||null,!$o.org)throw Error(`Org row not in scope`)}catch(t){console.warn(`[settings-workspace] load failed:`,t),e.innerHTML=is(`error`,`Could not load your workspace. Please try again.`);return}Lo()}function Io(){let e=Zo[ts()]||``,t=$o.org?.created?.created_tz,n=``;if(t){let e=new Date(t);Number.isNaN(e.getTime())||(n=`Created ${e.toLocaleDateString()}`)}let r=[e,n].filter(Boolean);return r.length?`<p class="settings-help">${Ko(r.join(` · `))}</p>`:``}function Lo(){let e=document.getElementById(`ws-org-body`);if(!e)return;let t=$o.org||{};if(!ns()){let n=ts()===Xo?`<div class="settings-note"><span class="material-symbols-outlined" aria-hidden="true">info</span> This workspace is managed for you.</div>`:``;e.innerHTML=`
      <div class="settings-item">
        <div class="settings-item__info">
          <div class="settings-item__title">Organization name</div>
          <div class="settings-item__desc">${Ko(t.caption||`Not set`)}</div>
        </div>
      </div>
      <div class="settings-item">
        <div class="settings-item__info">
          <div class="settings-item__title">Description</div>
          <div class="settings-item__desc">${Ko(t.description||`Not set`)}</div>
        </div>
      </div>
      ${n}
      <div style="margin-top:12px">${Io()}</div>`;return}e.innerHTML=`
    <div class="settings-field">
      <label class="settings-label" for="ws-name">Organization name</label>
      <input class="settings-input" id="ws-name" type="text" required value="${Ko(t.caption||``)}" />
    </div>
    <div class="settings-field">
      <label class="settings-label" for="ws-desc">Description</label>
      <textarea class="settings-input" id="ws-desc" rows="2">${Ko(t.description||``)}</textarea>
    </div>
    <p class="settings-error" id="ws-org-error"></p>
    <div class="settings-save-row">
      ${Io()}
      <button class="btn btn-primary" type="button" id="ws-save">Save</button>
    </div>`,document.getElementById(`ws-save`)?.addEventListener(`click`,Ro)}async function Ro(){let e=document.getElementById(`ws-save`),t=document.getElementById(`ws-org-error`),n=(document.getElementById(`ws-name`)?.value||``).trim(),r=(document.getElementById(`ws-desc`)?.value||``).trim();if(t&&(t.textContent=``),!n){t&&(t.textContent=`Organization name is required.`);return}e&&(e.disabled=!0);try{let e=await fetch(`${Jo()}/m5t/v5/acctGroup/${encodeURIComponent($o.org.id)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({caption:n,description:r})}),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(t.message||t.error||`Failed (HTTP ${e.status})`);$o.org={...$o.org,caption:n,description:r},qo(`Workspace updated.`,`success`)}catch(t){console.warn(`[settings-workspace] save failed:`,t),qo(t.message||`Could not save`,`danger`),e&&(e.disabled=!1);return}e&&(e.disabled=!1);try{await w.fetchScope?.()}catch(e){console.warn(`[settings-workspace] fetchScope after save failed:`,e)}}function zo(){document.getElementById(`ws-team-card`)?.remove()}async function Bo(){let e=document.getElementById(`ws-team-card`);if(!e)return;let t=es();if(!t||!ns()){zo();return}let n=[],r=[];try{let[e,i]=await Promise.all([fetch(`${Jo()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/members`),fetch(`${Jo()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/invites`)]);if(e.status===403||i.status===403){zo();return}let[a,o]=await Promise.all([e.json().catch(()=>({})),i.json().catch(()=>({}))]);if(!e.ok||!i.ok)throw Error(`members: ${e.status}, invites: ${i.status}`);n=a.members||[],r=o.invites||[]}catch(t){console.warn(`[settings-workspace] team load failed:`,t),e.style.display=``;let n=document.getElementById(`ws-team-body`);n&&(n.innerHTML=is(`error`,`Could not load your team. Please try again.`));return}Uo(n,r)}function Vo(e){if(!e.length)return``;let t=e.slice(0,Qo),n=e.length-t.length;return`
    <div class="ws-avatars">
      ${t.map(e=>`<span class="ws-avatar" title="${Ko(e.name||e.email)}">${Ko(Yo(e.name||e.email))}</span>`).join(``)}
      ${n>0?`<span class="ws-avatar ws-avatar--more">+${n}</span>`:``}
    </div>`}function Ho(e,t){let n=`${e.length} member${e.length===1?``:`s`}`;return t.length?`${n} · ${t.length} pending invite${t.length===1?``:`s`}`:n}function Uo(e,t){let n=document.getElementById(`ws-team-card`),r=document.getElementById(`ws-team-body`);if(!n||!r)return;n.style.display=``;let i=ts()!==Xo;r.innerHTML=`
    ${Vo(e)}
    <p class="ws-counts">${Ko(Ho(e,t))}</p>
    ${i?`<div class="ws-team-actions"><a class="btn btn-secondary" href="#/team">Manage team</a></div>`:``}`}var Wo,Go,Ko,qo,Jo,Yo,Xo,Zo,Qo,$o,es,ts,ns,rs,is,as,os,ss=o((()=>{T(),Wo=u(f(),1),m(),Go={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Ko=e=>String(e??``).replace(/[&<>"']/g,e=>Go[e]),qo=(e,t=`info`)=>{try{Wo.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Jo=()=>w.getConfig?.().BASE_URL||``,Yo=e=>String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``).toUpperCase()||`?`,Xo=`managed_client`,Zo={reseller_org:`Your organization`,managed_client:`Client workspace`,saas_org:`Organization`},Qo=6,$o={org:null},es=()=>w.getActiveOrg()?.guid||w.getMemberships()[0]?.orgGuid||null,ts=()=>w.getActiveOrg()?.channel||w.getMemberships()[0]?.channel||null,ns=()=>w.getCapabilities().includes(`manage_team`),rs=!1,is=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,as=(e,t,n)=>`
  <div class="settings-section__head">
  ...
  </div>`,os={render:No,init:Po}})),cs=c({default:()=>js,init:()=>ds,render:()=>us});function ls(){if(ks)return;let e=document.createElement(`style`);e.id=`m5t-notif-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),ks=!0}function us(){return ls(),Xi(),A()?ta({section:`settings-notifications`,title:`Notifications`,description:`Pick a client to manage their lead alerts.`}):`
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Email sent the moment a magnet captures a lead. Up to ${Es} recipients per magnet.</p>
            </div>
          </div>
          <div id="ntf-body">${As(`hourglass_empty`,`Loading…`)}</div>
        </div>
      </div>
    ...
    </div>`}async function ds(){if(A()){let e=e=>Number(e||0).toLocaleString();return na(ws(),[{h:`Magnets`,td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:`Leads · wk`,td:t=>e(t.leads.this_week)}],{emptyMsg:`No client orgs yet. Create one under Clients first.`})}await Promise.all([hs(),fs()])}async function fs(){let e=Os();if(e)try{let t=await fetch(`${ws()}/m5t/v5/acctGroup/${encodeURIComponent(e)}/webhook`);if(t.status===403){Ds.webhookAllowed=!1;return}let n=await t.json().catch(()=>({}));if(!n.ok)return;Ds.webhook=n.webhook,ms()}catch{}}function ps(e){try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return``}}function ms(){let e=document.getElementById(`ntf-wh-card`),t=document.getElementById(`ntf-wh-body`);if(!e||!t)return;e.style.display=``;let n=Ds.webhook,r=n?.last_delivery;t.innerHTML=`
    <div class="ntf-wh">
      <div class="settings-field" style="margin-bottom:0">
        <label class="settings-label" for="ntf-wh-url">Webhook URL</label>
        <input class="ntf-input" id="ntf-wh-url" type="url" placeholder="https://hooks.zapier.com/hooks/catch/…" value="${Ss(n?.uri||``)}" />
      </div>
      <div class="settings-field" style="margin-bottom:0">
      ...
      <div class="ntf-wh__row">
        ...
        <span class="ntf-wh__status">${r?r.ok?`Last delivery: <span class="ok">delivered</span> ${Ss(ps(r.tz))}`:`Last delivery: <span class="bad">failed</span> ${Ss(ps(r.tz))} (${Ss(r.error||``)})`:``}</span>
      </div>
    </div>`,t.querySelector(`#ntf-wh-save`)?.addEventListener(`click`,async()=>{let e=t.querySelector(`#ntf-wh-url`)?.value.trim()||``,n=t.querySelector(`#ntf-wh-secret`)?.value??``,r={uri:e};n.trim()!==``&&(r.secret=n.trim());try{let t=await fetch(`${ws()}/m5t/v5/acctGroup/${encodeURIComponent(Os())}/webhook`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify(r)}),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.error||`Failed (HTTP ${t.status})`);Ds.webhook=n.webhook,Cs(e?`Webhook saved`:`Webhook removed`,`success`),ms()}catch(e){Cs(e.message||`Could not save`,`danger`)}}),t.querySelector(`#ntf-wh-test`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0;try{let e=await fetch(`${ws()}/m5t/v5/acctGroup/${encodeURIComponent(Os())}/webhook-test`,{method:`POST`}),t=await e.json().catch(()=>({}));e.ok&&t.ok?Cs(`Test delivery sent`,`success`):Cs(t.error||`Could not deliver the test`,`danger`)}catch{Cs(`Could not deliver the test`,`danger`)}finally{t.disabled=!1}try{await fs()}catch(e){console.warn(`[notifications] loadWebhook refresh failed:`,e)}})}async function hs(){let e=document.getElementById(`ntf-body`);if(e){try{let e=await(await fetch(`${ws()}/m5t/v5/magnets`)).json().catch(()=>({}));if(!e.ok)throw Error(e.message||`Failed to load`);Ds.magnets=(e.magnets||[]).filter(e=>e.status!==`ARCHIVED`),Ds.canManage=!!e.canManage}catch(t){console.warn(`[notifications] load failed:`,t),e.innerHTML=As(`error`,`Could not load your magnets. Please try again.`);return}_s()}}function gs(e){let t=Array.isArray(e.notify_emails)?e.notify_emails:[],n=t.length>0;return`
    <div class="ntf-row" data-guid="${Ss(e.guid)}">
      <div class="ntf-magnet">
        <div class="ntf-name" title="${Ss(e.name)}">${Ss(e.name)}</div>
        <div class="ntf-meta">${Ss((e.domains||[]).join(`, `)||e.status)}</div>
      ...
      <div class="ntf-config">
        ${t.length?`<div class="ntf-chips">${t.map(e=>`
              <span class="ntf-chip">${Ss(e)}${Ds.canManage?`<button type="button" data-remove="${Ss(e)}" aria-label="Remove ${Ss(e)}">&times;</button>`:``}</span>`).join(``)}</div>`:`<div class="ntf-none">No alert emails.</div>`}
        ${Ds.canManage?`
        <div class="ntf-addrow">
          <input class="ntf-input" type="email" placeholder="name@business.com" aria-label="Add alert email" ${t.length>=Es?`disabled`:``} />
          <button class="ntf-btn" type="button" data-add ${t.length>=Es?`disabled`:``}>
    ...
    </div>`}function _s(){let e=document.getElementById(`ntf-body`);if(e){if(!Ds.magnets.length){e.innerHTML=As(`widgets`,`No magnets yet. Create one under Your Magnets first.`);return}e.innerHTML=Ds.magnets.map(gs).join(``),Yt(e,{rowSelector:`.ntf-row`,noun:`magnets`}),e.querySelectorAll(`.ntf-row`).forEach(e=>{let t=e.dataset.guid,n=e.querySelector(`.ntf-input`),r=()=>{let e=(n?.value||``).trim().toLowerCase();if(!e)return;if(!Ts(e)){Cs(`That does not look like an email address`,`danger`);return}let r=[...Ds.magnets.find(e=>e.guid===t).notify_emails||[]];if(r.includes(e)){Cs(`Already added`,`info`);return}if(r.length>=Es){Cs(`Up to ${Es} emails per magnet`,`info`);return}vs(t,[...r,e])};e.querySelector(`[data-add]`)?.addEventListener(`click`,r),n?.addEventListener(`keydown`,e=>{e.key===`Enter`&&r()}),e.querySelectorAll(`[data-remove]`).forEach(e=>e.addEventListener(`click`,()=>{let n=Ds.magnets.find(e=>e.guid===t);vs(t,(n.notify_emails||[]).filter(t=>t!==e.dataset.remove))})),e.querySelector(`[data-test]`)?.addEventListener(`click`,()=>ys(t,e.querySelector(`[data-test]`)))})}}async function vs(e,t){try{let n=await fetch(`${ws()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({notify_emails:t})}),r=await n.json().catch(()=>({}));if(!n.ok||!r.ok)throw Error(r.error||r.message||`Failed (HTTP ${n.status})`);let i=Ds.magnets.find(t=>t.guid===e);i&&(i.notify_emails=t),Cs(`Alert emails updated`,`success`)}catch(e){console.warn(`[notifications] save failed:`,e),Cs(e.message||`Could not save`,`danger`);return}try{_s()}catch(e){console.error(`[notifications] renderBody after save failed:`,e)}}async function ys(e,t){t&&(t.disabled=!0);try{let t=await fetch(`${ws()}/m5t/v5/magnets/${encodeURIComponent(e)}/notify-test`,{method:`POST`}),n=await t.json().catch(()=>({}));t.ok&&n.ok?Cs(`Test alert sent`,`success`):Cs(n.error||`Could not send the test`,`danger`)}catch{Cs(`Could not send the test`,`danger`)}finally{t&&(t.disabled=!1)}}var bs,xs,Ss,Cs,ws,Ts,Es,Ds,Os,ks,As,js,Ms=o((()=>{T(),Qe(),bs=u(f(),1),m(),ua(),Zt(),xs={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Ss=e=>String(e??``).replace(/[&<>"']/g,e=>xs[e]),Cs=(e,t=`info`)=>{try{bs.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},ws=()=>w.getConfig?.().BASE_URL||``,Ts=e=>Te(e),Es=5,Ds={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},Os=()=>w.getActiveOrg()?.guid||w.getMemberships()[0]?.orgGuid||null,ks=!1,As=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,js={render:us,init:ds}}));function Ns({label:e=``,content:t=``,size:n=``,onClose:r=null}={}){let i=document.activeElement,a=document.createElement(`div`);a.className=`m5t-modal-scrim`,a.innerHTML=`
    <div class="m5t-modal${n===`wide`?` m5t-modal--wide`:``}" role="dialog" aria-modal="true" aria-label="${Ps(e)}" tabindex="-1">
    ...
    </span>`}function Ws(e,t){let n=lc(),r=e?.[t]||[];return r.find(e=>e.owner_guid===n)||r[0]||null}function Gs(e,t,n){return e.connect&&!n?`unavailable`:t?t.connect_status===`ACTIVE`?`connected`:`broken`:`idle`}function Ks(e,t){return e===`unavailable`?`<span class="intg-state">Not available yet</span>`:e===`idle`?`<span class="intg-state">Not connected</span>`:e===`connected`?`<span class="intg-state on"><span class="material-symbols-outlined" aria-hidden="true">check</span>Connected</span>`:`<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>${M(t?.connect_status===`NEEDS_REAUTH`?`Reconnect needed`:`Connection error`)}</span>`}async function qs(){let e=await fetch(`${N()}/m5t/v5/integrations`);if(e.status===403)return{denied:!0};let t=await e.json();if(!t.ok)throw Error(t.error||`load failed`);return{providers:t.data.providers,configured:t.data.configured}}async function Js(e){if(!pc.busy){pc.busy=!0;try{let t=await(await fetch(`${N()}/m5t/v5/integrations/${e.slug}/connect`)).json();if(!t.ok||!t.data?.url)throw Error(t.error||`connect failed`);window.location.href=t.data.url}catch(t){cc(t.message||e.connect.fallbackError,`error`),pc.busy=!1}}}async function Ys(e,{refresh:t}={}){if(pc.busy)return;pc.busy=!0;let n=document.getElementById(e.card.ids.sync);n&&(n.disabled=!0);try{let t=await(await fetch(`${N()}/m5t/v5/integrations/${e.slug}/sync`,{method:`POST`})).json();if(!t.ok)throw Error(t.error||`sync failed`);let n=(t.data?.connections?.[0]?.[e.sync.itemsField]||[]).filter(e=>e.error).length;cc(n?e.sync.failedToast(n):`Metrics synced.`,n?`warning`:`success`)}catch{cc(`Sync failed.`,`error`)}finally{pc.busy=!1,n&&(n.disabled=!1),t?.()}}async function Xs(e,{refresh:t}={}){if(pc.busy)return;pc.busy=!0;let n=!1;try{n=await Ls({title:`Disconnect ${e.label}?`,message:e.disconnect.confirm,confirmLabel:`Disconnect`,danger:!0})}finally{n||(pc.busy=!1)}if(n)try{let t=await(await fetch(`${N()}/m5t/v5/integrations/${e.slug}`,{method:`DELETE`})).json().catch(()=>({}));if(!t.ok)throw Error(t.error||`disconnect failed`);cc(e.disconnect.toast,`success`)}catch{cc(`Disconnect failed.`,`error`)}finally{pc.busy=!1,t?.()}}async function Zs(e,{refresh:t}={}){let n=e.picker,r=document.getElementById(e.card.ids.panel);if(r){r.style.display=``,r.innerHTML=fc(n.loading);try{let r=await(await fetch(`${N()}/m5t/v5/integrations/${e.slug}/${n.path}`)).json();if(!r.ok)throw Error(r.error||`load failed`);Qs(e,r.data[n.itemsField]||[],new Set(r.data.linked||[]),{refresh:t})}catch{r.innerHTML=fc(n.loadError,`error`)}}}function Qs(e,t,n,{refresh:r}={}){let i=e.picker,a=document.getElementById(e.card.ids.panel);if(!a)return;let o=t.map(e=>{let t=i.rowDisabled(e),r=i.rowBadge(e),a=n.has(e.id)&&!t;return`
    ...
    </div>`,document.getElementById(i.ids.cancel)?.addEventListener(`click`,()=>{a.style.display=`none`}),document.getElementById(i.ids.save)?.addEventListener(`click`,()=>$s(e,{refresh:r}))}async function $s(e,{refresh:t}={}){let n=e.picker,r=document.getElementById(e.card.ids.panel),i=[...r?.querySelectorAll(`input[data-${n.dataAttr}]:checked`)||[]].map(e=>e.dataset[n.datasetKey]),a=document.getElementById(n.ids.save);a&&(a.disabled=!0);try{let a=await(await fetch(`${N()}/m5t/v5/integrations/${e.slug}/${n.path}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({[n.saveField]:i})})).json();if(!a.ok)throw Error(a.error||`save failed`);cc(n.savedToast(a.data.linked),`success`),r&&(r.style.display=`none`),t?.()}catch{cc(n.saveError,`error`),a&&(a.disabled=!1)}}function ec({refresh:e,replaceKey:t=!1}={}){let n=document.getElementById(gc.callrail.card.ids.setup);n&&(n.style.display=``,n.innerHTML=`
    <div class="intg-picker">
    ...
    </div>`,document.getElementById(`intg-r-cancel`)?.addEventListener(`click`,()=>{n.style.display=`none`}),document.getElementById(`intg-r-continue`)?.addEventListener(`click`,()=>tc({refresh:e})),document.getElementById(`intg-r-key`)?.focus())}async function tc({refresh:e}={}){let t=document.getElementById(`intg-r-continue`),n=document.getElementById(`intg-r-key`)?.value.trim()||``,r=document.getElementById(`intg-r-pickers`);if(!n){yc(`Paste an API key first.`);return}if(r&&!r.hidden)return rc(n,{refresh:e});t&&(t.disabled=!0),yc(`Checking the key with CallRail…`);try{let e=await(await fetch(`${N()}/m5t/v5/integrations/callrail/validate`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({api_key:n})})).json();if(!e.ok){yc(e.error||`CallRail rejected that key.`);return}let i=e.data.accounts||[],a=document.getElementById(`intg-r-account`);a&&(a.innerHTML=i.map(e=>`<option value="${M(e.id)}">${M(e.name)}</option>`).join(``),a.onchange=()=>nc(n,a.value)),r&&(r.hidden=!1),t&&(t.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">save</span>Save`),yc(``),await nc(n,i[0]?.id)}catch{yc(`Could not reach CallRail. Try again.`)}finally{t&&(t.disabled=!1)}}async function nc(e,t){let n=document.getElementById(`intg-r-company`);if(!(!n||!t)){n.innerHTML=`<option value="">Loading companies…</option>`;try{let r=await(await fetch(`${N()}/m5t/v5/integrations/callrail/companies`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({api_key:e,account_id:t})})).json(),i=r.ok&&r.data.companies||[];n.innerHTML=i.length?i.map(e=>`<option value="${M(e.id)}">${M(e.name)}</option>`).join(``):`<option value="">No active companies in this account</option>`}catch{n.innerHTML=`<option value="">Could not load companies</option>`}}}async function rc(e,{refresh:t}={}){let n=document.getElementById(`intg-r-continue`),r=document.getElementById(`intg-r-account`)?.value||``,i=document.getElementById(`intg-r-company`)?.value||``;if(!i){yc(`Pick the company this workspace tracks.`);return}n&&(n.disabled=!0),yc(`Connecting…`);try{let n=await(await fetch(`${N()}/m5t/v5/integrations/callrail`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({api_key:e,account_id:r,company_id:i})})).json();if(!n.ok)throw Error(n.error||`connect failed`);cc(n.data?.webhook_state===`active`?`CallRail connected. Call sync is on.`:`CallRail connected. Call sync setup needs attention; see below.`,`success`),t?.()}catch{yc(`Could not connect. Check the key and try again.`),n&&(n.disabled=!1)}}async function ic({refresh:e}={}){if(pc.busy)return;pc.busy=!0;let t=document.getElementById(gc.callrail.card.ids.sync);t&&(t.disabled=!0);try{let e=await(await fetch(`${N()}/m5t/v5/integrations/callrail/sync?days=7`,{method:`POST`})).json();if(!e.ok)throw Error(e.error||`sync failed`);let t=e.data?.connections?.[0]||{};cc(t.error?`Sync finished with errors.`:`Sync done. ${t.processed||0} new call${(t.processed||0)===1?``:`s`} recorded.`,t.error?`warning`:`success`)}catch{cc(`Sync failed.`,`error`)}finally{pc.busy=!1,t&&(t.disabled=!1),e?.()}}function ac(){if(bc)return;let e=document.createElement(`style`);e.id=`m5t-intg-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),bc=!0}var oc,sc,M,cc,N,lc,uc,dc,fc,pc,mc,hc,gc,_c,vc,yc,bc,xc=o((()=>{T(),oc=u(f(),1),m(),Bs(),sc={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},M=e=>String(e??``).replace(/[&<>"']/g,e=>sc[e]),cc=(e,t=`info`)=>{try{oc.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},N=()=>w.getConfig?.().BASE_URL||``,lc=()=>w.getActiveOrg()?.guid||w.getMemberships()[0]?.orgGuid||null,uc=()=>w.getCapabilities().includes(`manage_magnets`),dc=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,fc=(e,t=``)=>`<div class="intg-alert ${t}"><span class="material-symbols-outlined" aria-hidden="true">${t===`error`?`error`:`info`}</span><span>${e}</span></div>`,pc={busy:!1},mc=null,hc={google_ads:{what:`See ad spend lined up next to the leads it generated, so you know which campaigns are actually working.`,steps:[`Click Connect and sign in with a Google account that has access to your Ads accounts.`,`Choose which ad accounts should feed reporting.`,`Metrics refresh automatically once a day. Click Sync now any time for an immediate pull.`]},calendly:{what:`Let visitors book directly from a magnet conversation, and get notified the moment they do.`,steps:[`Click Connect and authorize your Calendly account.`,`Turn on Calendly booking for any magnet’s Book action, under Magnets.`,`Confirmed and canceled bookings sync back to the lead automatically. Webhooks need a paid Calendly plan; a free plan still lets visitors book, just without the automatic lead sync.`]},callrail:{what:`Every tracked phone call becomes a lead automatically, complete with recording and source.`,steps:[`In CallRail, go to Integrations, then Data access, then API keys, and create a key. Read-only works for calls; Allow Writes lets us set up call sync automatically.`,`Paste the key here and pick the account and company this workspace tracks.`,`Calls start landing in your Leads inbox within minutes.`]},google_analytics:{what:`See how visitors reach your site and behave once they get there. Sessions, pageviews, and engagement, right alongside the leads your magnets capture.`,steps:[`Click Connect and sign in with a Google account that has access to your GA4 property.`,`Choose which GA4 properties should feed reporting.`,`Metrics refresh automatically once a day. Click Sync now any time for an immediate pull.`]}},gc={google_ads:{slug:`google_ads`,urlSlug:`google-ads`,label:`Google Ads`,logo:`integrations/google-ads.svg`,connect:{fallbackError:`Could not start the Google connection.`},disconnect:{confirm:`Daily metric refreshes stop until reconnected.`,toast:`Google Ads disconnected.`},card:{tint:`primary`,icon:`ads_click`,sub:`Spend and clicks beside your leads.`,ids:{connect:`intg-g-connect`,choose:`intg-g-accounts`,sync:`intg-g-sync`,disconnect:`intg-g-disconnect`,panel:`intg-g-picker`},chooseLabel:`Choose accounts`,idleDesc:`Connect a Google account with access to your ad accounts. Spend lines up against your magnet leads in Ad performance.`,brokenDesc:`The connection stopped working. Reconnect to resume daily metric refreshes.`,reachDesc:e=>`This connection can reach <b>${e}</b> ad account${e===1?``:`s`}. Choose which ones feed reporting; metrics refresh daily in Ad performance.`,noneDesc:`Connected, but no ad accounts are reachable from this Google account. Reconnect with an account that has Google Ads access.`,reachableCount:e=>e?.customer_ids?.length||0},picker:{path:`accounts`,itemsField:`accounts`,saveField:`customer_ids`,dataAttr:`intg-acct`,datasetKey:`intgAcct`,ids:{cancel:`intg-picker-cancel`,save:`intg-picker-save`},loading:`Loading your ad accounts…`,loadError:`Could not load your ad accounts. Try again, or reconnect if this keeps happening.`,heading:`Accounts that feed reporting`,emptyMsg:`No ad accounts are reachable from this Google account.`,namePrefix:`Account `,rowDisabled:e=>!!(e.manager||e.error),rowBadge:e=>e.manager?`Manager`:e.error?`Unavailable`:e.currency||``,savedToast:e=>`${e} account${e===1?``:`s`} linked. First sync is running.`,saveError:`Could not save account selection.`},sync:{itemsField:`accounts`,failedToast:e=>`Sync finished with ${e} account error${e===1?``:`s`}.`}},google_analytics:{slug:`google_analytics`,urlSlug:`google-analytics`,label:`Google Analytics`,logo:`integrations/google-analytics.svg`,connect:{fallbackError:`Could not start the Google Analytics connection.`},disconnect:{confirm:`Daily metric refreshes stop until reconnected.`,toast:`Google Analytics disconnected.`},card:{tint:`success`,icon:`monitoring`,sub:`Traffic and engagement beside your leads.`,ids:{connect:`intg-a-connect`,choose:`intg-a-properties`,sync:`intg-a-sync`,disconnect:`intg-a-disconnect`,panel:`intg-a-picker`},chooseLabel:`Choose properties`,idleDesc:`Connect a Google account with access to your GA4 property. Traffic and engagement line up against your magnet leads.`,brokenDesc:`The connection stopped working. Reconnect to resume daily metric refreshes.`,reachDesc:e=>`This connection can reach <b>${e}</b> GA4 propert${e===1?`y`:`ies`}. Choose which ones feed reporting; metrics refresh daily.`,noneDesc:`Connected, but no GA4 properties are reachable from this Google account. Reconnect with an account that has Analytics access.`,reachableCount:e=>e?.properties?.length||0},picker:{path:`properties`,itemsField:`properties`,saveField:`property_ids`,dataAttr:`intg-prop`,datasetKey:`intgProp`,ids:{cancel:`intg-a-picker-cancel`,save:`intg-a-picker-save`},loading:`Loading your GA4 properties…`,loadError:`Could not load your GA4 properties. Try again, or reconnect if this keeps happening.`,heading:`Properties that feed reporting`,emptyMsg:`No GA4 properties are reachable from this Google account.`,namePrefix:`Property `,rowDisabled:()=>!1,rowBadge:e=>e.account||``,savedToast:e=>`${e} propert${e===1?`y`:`ies`} linked. First sync is running.`,saveError:`Could not save property selection.`},sync:{itemsField:`properties`,failedToast:e=>`Sync finished with ${e} property error${e===1?``:`s`}.`}},calendly:{slug:`calendly`,urlSlug:`calendly`,label:`Calendly`,logo:`integrations/calendly.svg`,connect:{fallbackError:`Could not start the Calendly connection.`},disconnect:{confirm:`Magnet booking falls back to the built-in scheduler and booking sync stops.`,toast:`Calendly disconnected.`},card:{tint:`accent`,icon:`event`,sub:`Bookings on your magnets.`,ids:{connect:`intg-c-connect`,disconnect:`intg-c-disconnect`},idleDesc:`Connect Calendly and your magnets book real meetings: the Book button opens your calendar in the conversation, and confirmed bookings land on the lead automatically.`,brokenDesc:`The connection stopped working. Reconnect to resume booking sync.`}},callrail:{slug:`callrail`,urlSlug:`callrail`,label:`CallRail`,logo:`integrations/callrail.svg`,disconnect:{confirm:`Calls stop landing in your Leads inbox.`,toast:`CallRail disconnected.`},card:{tint:`info`,icon:`call`,sub:`Calls in your leads inbox.`,ids:{connect:`intg-r-connect`,sync:`intg-r-sync`,disconnect:`intg-r-disconnect`,setup:`intg-r-setup`},idleDesc:`Paste a CallRail API key and tracked phone calls land in your Leads inbox, with the caller, source, and recording on the lead.`,brokenDesc:`The connection stopped working. Reconnect with a current CallRail API key.`}}},_c=[{label:`HubSpot`,logo:`integrations/hubspot.svg`,icon:`hub`,sub:`Leads into your CRM.`},{label:`Zapier`,logo:`integrations/zapier.svg`,icon:`bolt`,sub:`Anything into anything.`}],vc=Object.fromEntries(Object.values(gc).map(e=>[e.urlSlug,e.slug])),yc=e=>{let t=document.getElementById(`intg-r-status`);t&&(t.textContent=e)},bc=!1})),Sc=c({default:()=>Mc,init:()=>wc,render:()=>Cc});function Cc(){return ac(),Xi(),A()?ta({section:`settings-integrations`,title:`Integrations`,description:`Pick a client to manage their connections.`}):`
    <div class="page-shell" data-section="settings-integrations">
      ...
      <div id="intg-body">
        <div class="dashboard-card intg-card"><div class="card-body">${dc(`hourglass_empty`,`Loading…`)}</div></div>
      </div>
    </div>`}async function wc(){if(A()){let e=e=>Number(e||0).toLocaleString();return na(N(),[{h:`Magnets`,td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:`Leads · wk`,td:t=>e(t.leads.this_week)}],{emptyMsg:`No client orgs yet. Create one under Clients first.`})}Tc()||await Ec()}function Tc(){try{let e=new URLSearchParams(window.location.search),t=e.get(`connected`),n=e.get(`error`)?e.get(`provider`)||`google_ads`:null,r=null;if(t&&Object.hasOwn(jc,t))cc(`${jc[t]} connected.`,`success`),Vs({slug:t,connected:!0}),r=Object.hasOwn(gc,t)?gc[t]:null;else if(n){let t=Object.hasOwn(jc,n)?jc[n]:n;cc(`${t} connection failed (${e.get(`error`)}).`,`error`),r=Object.hasOwn(gc,n)?gc[n]:null}else return!1;return window.history.replaceState(null,``,window.location.pathname+window.location.hash),r?(window.router?.navigate(`/settings/integrations/${r.urlSlug}`),!0):!1}catch{return!1}}async function Ec(){let e=document.getElementById(`intg-body`);try{let{denied:t,providers:n,configured:r}=await qs();if(t){e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${dc(`lock`,`Integrations are managed by workspace admins.`)}</div></div>`);return}e&&(e.innerHTML=Ac(n,r))}catch{e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${dc(`error`,`Could not load integrations.`)}</div></div>`)}}function Dc(e,t,n){let r=Gs(e,t,n);return`
    ...
    </div>`}function Ac(e,t){return`<div class="intg-grid">${Object.values(gc).map(n=>Dc(n,Ws(e,n.slug),!!t?.[n.slug])).join(``)}${_c.length?`<div class="intg-grid__soon-label">Coming soon</div>${_c.map(kc).join(``)}`:``}</div>`}var jc,Mc,Nc=o((()=>{xc(),ua(),jc=Object.fromEntries(Object.values(gc).filter(e=>e.connect).map(e=>[e.slug,e.label])),Mc={render:Cc,init:wc}})),Pc=c({default:()=>Xc,init:()=>Ic,render:()=>Fc});function Fc({provider:e}={}){ac(),Xi();let t=vc[e];if(!t||A())return`<div class="page-shell"></div>`;let n=gc[t];return P.provider=n,`
    <div class="page-shell" data-section="settings-integrations">
    ...
    </div>`}async function Ic({provider:e}={}){let t=vc[e];if(!t||A()){window.router?.navigate(`/settings/integrations`,{historyAPIMethod:`replaceState`});return}await Lc();let n=Hs();n?.connected&&n.slug===t&&P.provider?.picker&&uc()&&Zs(P.provider,{refresh:Lc})}async function Lc(){let e=document.getElementById(`intg-detail`);if(!(!e||!P.provider))try{let{denied:t,providers:n,configured:r}=await qs();if(t){e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${dc(`lock`,`Integrations are managed by workspace admins.`)}</div></div>`;return}P.conn=Ws(n,P.provider.slug),P.configured=!!r?.[P.provider.slug],P.status=Gs(P.provider,P.conn,P.configured),e.innerHTML=Rc(),Kc()}catch{e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${dc(`error`,`Could not load this integration.`)}</div></div>`}}function Rc(){let e=P.provider;return[Bc(e),Vc(e),Hc(e),Wc(e),Gc(e)].filter(Boolean).join(``)}function zc(e){let t=P.conn?.external_account||{};if(P.status!==`connected`)return e.card.sub;if(e.slug===`calendly`){let e=[t.name,t.email&&`(${t.email})`].filter(Boolean).join(` `);return e?`Connected as ${e}.`:`Connected.`}if(e.slug===`callrail`){let e=[t.account_name,t.company_name].filter(Boolean).join(` · `);return e?`Connected to ${e}.`:`Connected.`}let n=e.card.reachableCount(t);return n?`${n} reachable ${e.slug===`google_analytics`?n===1?`property`:`properties`:n===1?`account`:`accounts`}.`:`Connected.`}function Bc(e){let t=``;uc()&&(e.connect&&(P.status===`idle`||P.status===`broken`)&&P.configured&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${P.status===`broken`?`Reconnect`:`Connect`}</button>`),e.slug===`callrail`&&P.status!==`connected`&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${P.status===`broken`?`Reconnect`:`Connect`}</button>`));let n;return n=P.status===`unavailable`?`${e.label} is being set up for this platform.`:P.status===`broken`?e.card.brokenDesc:P.status===`idle`?uc()?e.card.idleDesc:e.card.sub:zc(e),`
    <div class="dashboard-card intg-card">
      <div class="card-body">
        ...
        ${e.slug===`callrail`&&P.status!==`connected`?`<div id="${e.card.ids.setup}" style="display:none"></div>`:``}
      </div>
    </div>`}function Vc(e){let t=hc[e.slug];return t?P.status===`connected`||P.status===`unavailable`||!uc()?`
      <div class="dashboard-card intg-card">
        <div class="card-body">
    ...
    <div class="dashboard-card intg-card">
    ...
    </div>`:``}function Hc(e){if(P.status!==`connected`)return``;let t=uc();if(e.picker){let n=e.card.reachableCount(P.conn?.external_account);return`
      <div class="dashboard-card intg-card">
        <div class="card-body">
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-g-convactions">${fc(`Loading conversion actions…`)}</div>
        </div>
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-c-events">${fc(`Loading event types…`)}</div>
        </div>
      ...
      <div class="dashboard-card intg-card">
        <div class="card-body">
          ...
          <div id="intg-r-trackers">${fc(`Loading tracking numbers…`)}</div>
          <div class="intg-actions" style="justify-content:flex-start;margin-top:12px">
            <button type="button" class="intg-btn" id="${e.card.ids.sync}"><span class="material-symbols-outlined" aria-hidden="true">sync</span>Sync now</button>
      ...
      </div>`:``}function Uc(e){if(!e)return``;try{return new Date(e).toLocaleDateString([],{month:`short`,day:`numeric`,year:`numeric`})}catch{return String(e).slice(0,10)}}function Wc(e){if(!P.conn)return``;let t=P.conn.webhook||{},n=[];n.push([`Status`,P.status===`connected`?`Active`:P.conn.connect_status===`NEEDS_REAUTH`?`Needs reconnecting`:`Error`]),e.slug===`calendly`&&(n.push([`Booking sync`,t.state===`active`?`On`:`Off (paid Calendly plan required)`]),t.last_received_tz&&n.push([`Last booking received`,Uc(t.last_received_tz)])),e.slug===`callrail`&&(n.push([`Call sync`,t.state===`active`?`On`:`Needs attention`]),t.cookie_capture&&n.push([`Session capture`,t.cookie_capture===`active`?`On`:`Needs attention`]),t.last_received_tz&&n.push([`Last call received`,Uc(t.last_received_tz)])),P.conn.created?.created_tz&&n.push([`Connected on`,Uc(P.conn.created.created_tz)]);let r=e.slug===`calendly`&&P.status===`connected`&&t.state!==`active`?fc(`Booking sync is off: webhooks need a paid Calendly plan. Visitors can still book in the magnet; bookings just will not appear on the lead automatically. Reconnect after upgrading to turn it on.`,`error`):e.slug===`callrail`&&P.status===`connected`&&t.state!==`active`?fc(`Automatic call sync could not be set up in CallRail. Calls still arrive via the daily sweep and Sync now. Reconnect to retry the setup.`,`error`):``;return`
    <div class="dashboard-card intg-card">
      <div class="card-body">
    ...
    </div>`}function Gc(e){return P.status!==`connected`&&P.status!==`broken`||!uc()?``:`
    <div class="dashboard-card intg-card settings-danger">
    ...
    </div>`}function Kc(){let e=P.provider;if(!e)return;let t=Lc;e.connect&&document.getElementById(e.card.ids.connect)?.addEventListener(`click`,()=>Js(e)),e.slug===`callrail`&&(document.getElementById(e.card.ids.connect)?.addEventListener(`click`,()=>ec({refresh:t})),document.getElementById(`intg-r-replace`)?.addEventListener(`click`,()=>ec({refresh:t,replaceKey:!0})),document.getElementById(e.card.ids.sync)?.addEventListener(`click`,()=>ic({refresh:t})),P.status===`connected`&&uc()&&Yc()),e.picker&&(document.getElementById(e.card.ids.choose)?.addEventListener(`click`,()=>Zs(e,{refresh:t})),document.getElementById(e.card.ids.sync)?.addEventListener(`click`,()=>Ys(e,{refresh:t}))),e.slug===`google_ads`&&P.status===`connected`&&uc()&&qc(),e.slug===`calendly`&&P.status===`connected`&&uc()&&Jc(),document.getElementById(e.card.ids.disconnect)?.addEventListener(`click`,()=>Xs(e,{refresh:t}))}async function qc(){let e=document.getElementById(`intg-g-convactions`);if(e)try{let t=await(await fetch(`${N()}/m5t/v5/integrations/google_ads/conversion_actions`)).json();if(!t.ok)throw Error(t.error||`load failed`);let n=t.data.actions||[],r=new Set(t.data.selected||[]);if(!n.length){e.innerHTML=fc(`No enabled conversion actions in the linked accounts.`);return}e.innerHTML=`
      ...
      </div>`,Yt(e.querySelector(`.intg-ca-list`),{rowSelector:`.intg-ca-row`,noun:`actions`}),document.getElementById(`intg-g-ca-save`)?.addEventListener(`click`,async()=>{let t=document.getElementById(`intg-g-ca-save`),n=[...e.querySelectorAll(`input[type="checkbox"]:checked`)].map(e=>e.value);t.disabled=!0;try{let e=await(await fetch(`${N()}/m5t/v5/integrations/google_ads/conversion_actions`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({conversion_action_ids:n})})).json();if(!e.ok)throw Error(e.error||`save failed`);cc(n.length?`Counting ${n.length} conversion action${n.length===1?``:`s`} in reporting.`:`Conversion counting turned off.`,`success`)}catch(e){cc(e.message||`Could not save the selection.`,`error`)}finally{t.disabled=!1}})}catch{e.innerHTML=fc(`Could not load conversion actions. If this keeps happening, reconnect.`,`error`)}}async function Jc(){let e=document.getElementById(`intg-c-events`);if(e)try{let t=await(await fetch(`${N()}/m5t/v5/integrations/calendly/event_types`)).json();if(!t.ok)throw Error(t.error||`load failed`);let n=t.data.event_types||[],r=t.data.scheduling_url?`<div class="intg-ev"><span class="intg-ev__name">Full scheduling page</span><span class="intg-ev__meta">${M(t.data.scheduling_url)}</span></div>`:``;e.innerHTML=n.length||r?`${r}${n.map(e=>`
          <div class="intg-ev">
            <span class="intg-ev__name">${M(e.name)}</span>
            <span class="intg-ev__meta">${e.duration?`${M(String(e.duration))} min`:``}</span>
          </div>`).join(``)}`:fc(`No active event types on this Calendly account.`),Yt(e,{rowSelector:`.intg-ev`,noun:`event types`})}catch{e.innerHTML=fc(`Could not load event types. If this keeps happening, reconnect.`,`error`)}}async function Yc(){let e=document.getElementById(`intg-r-trackers`);if(e)try{let t=await(await fetch(`${N()}/m5t/v5/integrations/callrail/trackers`)).json();if(!t.ok)throw Error(t.error||`load failed`);let n=t.data.trackers||[];e.innerHTML=n.length?n.map(e=>`
          <div class="intg-ev">
            <span class="intg-ev__name">${M(e.name)}</span>
            <span class="intg-ev__meta">${M(e.number)}${e.type===`session`?` · number pool`:``}</span>
          </div>`).join(``):fc(`No active tracking numbers in this company yet. Create one in CallRail and it appears here.`),Yt(e,{rowSelector:`.intg-ev`,noun:`numbers`})}catch{e.innerHTML=fc(`Could not load tracking numbers.`,`error`)}}var P,Xc,Zc=o((()=>{xc(),ua(),Zt(),P={provider:null,conn:null,configured:!1,status:`idle`},Xc={render:Fc,init:Ic}})),Qc=c({default:()=>xl,init:()=>tl,render:()=>el});function $c(){if(_l)return;let e=document.createElement(`style`);e.id=`m5t-security-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),_l=!0}function el(){return $c(),`
    <div class="page-shell" data-section="settings-security">
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Signing in as ${pl(ll())}. You stay signed in on this device after a change.</p>
            </div>
          </div>
          <div class="settings-grid-2">
            <div class="settings-field">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="pk-body">${vl(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function tl(){document.getElementById(`pw-save`)?.addEventListener(`click`,ul);let e=document.getElementById(`pk-add-btn`);e&&window.PublicKeyCredential&&(e.style.display=``,e.addEventListener(`click`,sl)),await nl()}async function nl(){let e=document.getElementById(`pk-body`);if(e){try{let e=await fetch(`${hl()}/m5t/v5/webauthn`),t=await e.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(t.error||`Failed to load`);gl.passkeys=t.passkeys||[],gl.loaded=!0}catch(t){console.warn(`[settings-security] load failed:`,t),e.innerHTML=vl(`error`,`Could not load your passkeys. Please try again.`);return}al()}}function rl(e){if(!e)return null;try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return null}}function il(e){let t=rl(e.last_used_time),n=e.created?.created_tz,r=rl(n),i=[e.device_type===`multiDevice`?`Syncs across devices`:`This device only`,t?`Last used ${t}`:`Never used to sign in yet`,r?`Added ${r}`:null].filter(Boolean).join(` · `);return`
    <div class="pk-row" data-guid="${pl(e.guid)}">
      <span class="pk-icon"><span class="material-symbols-outlined" aria-hidden="true">passkey</span></span>
      <div class="pk-info">
        <div class="pk-name">${pl(e.device_label||`Passkey`)}</div>
        <div class="pk-meta">${pl(i)}</div>
      </div>
      <button class="pk-btn pk-btn--danger" type="button" data-remove="${pl(e.guid)}">
        <span class="material-symbols-outlined" aria-hidden="true">delete</span> Remove
      </button>
    </div>`}function al(){let e=document.getElementById(`pk-body`);if(e){if(!window.PublicKeyCredential){e.innerHTML=`<p class="pk-unsupported">This browser doesn't support passkeys. Your password sign-in still works as usual.</p>`;return}if(!gl.passkeys.length){e.innerHTML=vl(`passkey`,`No passkeys yet. Add one for a faster, phishing-resistant sign-in.`);return}e.innerHTML=gl.passkeys.map(il).join(``),Yt(e,{rowSelector:`.pk-row`,noun:`passkeys`}),e.querySelectorAll(`[data-remove]`).forEach(e=>{e.addEventListener(`click`,()=>cl(e.dataset.remove,e))})}}function ol(){try{let e=navigator.userAgent||``,t=/iPhone/.test(e)?`iPhone`:/iPad/.test(e)?`iPad`:/Android/.test(e)?`Android`:/Mac OS X/.test(e)?`Mac`:/Windows/.test(e)?`Windows`:/Linux/.test(e)?`Linux`:`device`,n=/Edg\//.test(e)?`Edge`:/Chrome\//.test(e)?`Chrome`:/Firefox\//.test(e)?`Firefox`:/Safari\//.test(e)?`Safari`:``;return n?`${n} on ${t}`:t}catch{return`Passkey`}}async function sl(){let e=document.getElementById(`pk-add-btn`);e&&(e.disabled=!0);try{let{startRegistration:e}=await S(async()=>{let{startRegistration:e}=await Promise.resolve().then(()=>(Lt(),It));return{startRegistration:e}},void 0,import.meta.url),t=await fetch(`${hl()}/m5t/v5/webauthn/register/options`,{method:`POST`}),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.error||`Could not start passkey registration`);let r;try{r=await e({optionsJSON:n.options})}catch(e){if(e?.name===`NotAllowedError`)return;throw e}let i=await fetch(`${hl()}/m5t/v5/webauthn/register/verify`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({response:r,deviceLabel:ol()})}),a=await i.json().catch(()=>({}));if(!i.ok||!a.ok)throw Error(a.error||`Could not register this passkey`);ml(`Passkey added`,`success`),await nl()}catch(e){console.warn(`[settings-security] addPasskey failed:`,e),ml(e.message||`Could not add a passkey`,`danger`)}finally{e&&(e.disabled=!1)}}async function cl(e,t){if(await Ls({title:`Remove this passkey?`,message:`You can always add it back later.`,confirmLabel:`Remove`,danger:!0})){t&&(t.disabled=!0);try{let t=await fetch(`${hl()}/m5t/v5/webauthn/${encodeURIComponent(e)}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.error||`Could not remove this passkey`);gl.passkeys=gl.passkeys.filter(t=>t.guid!==e),ml(`Passkey removed`,`success`),al()}catch(e){console.warn(`[settings-security] removePasskey failed:`,e),ml(e.message||`Could not remove this passkey`,`danger`),t&&(t.disabled=!1)}}}function ll(){try{return w.getScope()?.entity?.email||w.getEntity?.()?.email||`your account`}catch{return`your account`}}async function ul(){let e=document.getElementById(`pw-new`),t=document.getElementById(`pw-confirm`),n=document.getElementById(`pw-save`),r=e?.value||``,i=t?.value||``,a=gi(r);if(a.length){yl(`Password needs: ${bl(a)}.`);return}if(r!==i){yl(`Passwords do not match.`);return}yl(``),n&&(n.disabled=!0);try{let n=await fetch(`${hl()}/m5t/v5/acctEntity/resetHash`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({password:r})}),i=await n.json().catch(()=>({}));if(!n.ok||!i.ok)throw Error(i.error||`Could not update your password`);ml(`Password updated`,`success`),e&&(e.value=``),t&&(t.value=``)}catch(e){yl(e.message||`Could not update your password.`)}finally{n&&(n.disabled=!1)}}var dl,fl,pl,ml,hl,gl,_l,vl,yl,bl,xl,Sl=o((()=>{T(),dl=u(f(),1),m(),Bs(),vi(),Zt(),nt(),fl={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},pl=e=>String(e??``).replace(/[&<>"']/g,e=>fl[e]),ml=(e,t=`info`)=>{try{dl.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},hl=()=>w.getConfig?.().BASE_URL||``,gl={passkeys:[],loaded:!1},_l=!1,vl=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,yl=e=>{let t=document.getElementById(`pw-error`);t&&(t.textContent=e||``,t.hidden=!e)},bl=e=>e.length<=1?String(e[0]??``):e.length===2?`${e[0]} and ${e[1]}`:`${e.slice(0,-1).join(`, `)}, and ${e[e.length-1]}`,xl={render:el,init:tl}})),Cl=c({default:()=>Gl,init:()=>jl,render:()=>Al});function wl(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(` `).trim()||e.email)||null}function Tl(e){return(e.split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``)||`?`).toUpperCase()}function El(e){try{return new Date(e).toLocaleString([],{month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`})}catch{return``}}function Dl(e){try{let t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?`just now`:t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return``}}function Ol(e){return e==null?`—`:e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,`0`)}s`}function kl(){if(Hl)return;let e=document.createElement(`style`);e.id=`m5t-convs-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Hl=!0}function Al(){return kl(),Xi(),`
    <div class="page-shell" data-section="conversations">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="convs-body">
          ${Ul(`hourglass_empty`,`Loading journeys…`)}
        </div>
      </div>
    </div>`}async function jl(){await Ml()}async function Ml(){let e=document.getElementById(`convs-body`);if(e){try{let[e,t]=await Promise.all([fetch(`${Rl()}/m5t/v5/conversations`),fetch(`${Rl()}/m5t/v5/magnets`).catch(()=>null)]),n=await e.json().catch(()=>({}));if(!n.ok)throw Error(n.message||`Failed to load`);if(I.conversations=n.conversations||[],I.counts=n.counts||{},I.book=A(),t){let e=await t.json().catch(()=>({}));I.magnetNames={},I.magnetOwnerNames={};let n=I.book?ra():{};(e.magnets||[]).forEach(e=>{I.magnetNames[e.guid]=e.name,I.book&&(I.magnetOwnerNames[e.guid]=e.owner_name||n[e.owner_guid]||``)})}}catch(t){console.warn(`[conversations] load failed:`,t),e.innerHTML=Ul(`error`,`Could not load journeys. Please try again.`);return}Fl()}}function Nl(){return I.filter===`ALL`?I.conversations:I.conversations.filter(e=>e.status===I.filter)}function Pl(e){let t=wl(e.lead),n=I.magnetNames[e.magnet_guid]||`—`,r=Bl[e.status]||Bl.ABANDONED,i=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,a=(e.routes||[]).map(e=>Vl[e]||e).join(`, `);return`
    <tr class="convs-row" data-session="${F(e.session)}">
      <td>
        <span class="convs-who">
          <span class="convs-ava${t?``:` anon`}">${t?F(Tl(t)):`<span class="material-symbols-outlined" style="font-size:16px">person_off</span>`}</span>
          <span><span class="convs-name">${t?F(t):`<span class="convs-muted">Anonymous visitor</span>`}</span>
            ${e.lead?.email?`<div class="convs-sub">${F(e.lead.email)}</div>`:a?`<div class="convs-sub">Picked: ${F(a)}</div>`:``}</span>
        </span>
      </td>
      ${I.book?`<td>${la(I.magnetOwnerNames[e.magnet_guid]||``)||`<span class="convs-muted">—</span>`}</td>`:``}
      <td><span class="convs-sub">${F(n)}</span></td>
      <td><span class="convs-badge" data-s="${F(e.status)}"><span class="material-symbols-outlined" aria-hidden="true">${r.icon}</span>${r.label}</span></td>
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${F(El(e.started_at))}">${F(Dl(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${F(Ol(e.duration_s))}</td>
    </tr>`}function Fl(){let e=document.getElementById(`convs-body`);if(!e)return;if(!I.conversations.length){e.innerHTML=Ul(`route`,`No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.`);return}let t=Nl();e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${[[`ALL`,`All`],[`COMPLETED`,`Completed`],[`IN_PROGRESS`,`In progress`],[`ABANDONED`,`Abandoned`]].map(([e,t])=>`<button data-filter="${e}" class="${I.filter===e?`active`:``}">${t}${e!==`ALL`&&I.counts[e]?` (${zl(I.counts[e])})`:``}</button>`).join(``)}
      </div>
      <span class="convs-count">${zl(t.length)} of ${zl(I.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        <thead><tr><th>Visitor</th>${I.book?`<th>Client</th>`:``}<th>Magnet</th><th>Status</th><th>Progress</th><th>Started</th><th>Duration</th></tr></thead>
        <tbody id="convs-tbody">${t.map(Pl).join(``)||`<tr><td colspan="${I.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${I.filter.toLowerCase().replace(`_`,` `)} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`;let n=e.querySelector(`#convs-tbody`);n&&Yt(n,{rowSelector:`tr.convs-row`,noun:`journeys`,controlHost:e.querySelector(`.convs-tablewrap`)||n.parentElement}),e.querySelector(`.convs-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(I.filter=t.dataset.filter,Fl())}),e.querySelector(`#convs-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`.convs-row`);t&&Il(t.dataset.session)})}async function Il(e){let t=I.conversations.find(t=>t.session===e);if(!t)return;let n=null;try{n=await(await fetch(`${Rl()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),n?.ok||(n=null)}catch{n=null}let r=wl(t.lead),i=I.magnetNames[t.magnet_guid]||`—`,a=(n?.events||[]).filter((e,t,n)=>e.event!==`step`||!(n[t+1]&&n[t+1].event===`step`)).map(e=>`
    <div class="convs-tl__item${e.event===`complete`?` done`:``}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${F((Wl[e.event]||(()=>e.event))(e.detail))}</div>
      <div class="convs-tl__time">${F(El(e.at))}${e.variant?` · Variant ${F(e.variant)}`:``}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      <div class="convs-drawer__head">
        <span class="convs-drawer__title">${r?F(r):`Anonymous visitor`}</span>
      ...
      <div class="convs-drawer__body">
        ${r?`<a class="convs-drawer__lead" href="#/leads">
              <span class="convs-ava">${F(Tl(r))}</span>
              <span><div class="convs-name">${F(r)}</div><div class="convs-sub">${F(t.lead?.email||t.lead?.phone||``)}</div></span>
        ...
        <div class="convs-sub" style="margin-bottom:6px">${F(i)} · ${F(Ol(t.duration_s))}${t.variant?` · Variant ${F(t.variant)}`:``}</div>
        ${a?`<div class="convs-tl">${a}</div>`:Ul(`timeline`,`No timeline available for this journey.`)}
      </div>
    </aside>`,document.body.appendChild(o),requestAnimationFrame(()=>{o.classList.add(`open`),o.querySelector(`.convs-drawer`).classList.add(`open`)});let s=()=>{o.classList.remove(`open`),setTimeout(()=>o.remove(),220)};o.querySelector(`.convs-drawer__close`).addEventListener(`click`,s),o.addEventListener(`click`,e=>{e.target===o&&s()})}var Ll,F,Rl,zl,I,Bl,Vl,Hl,Ul,Wl,Gl,Kl=o((()=>{T(),ua(),Zt(),Ll={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},F=e=>String(e??``).replace(/[&<>"']/g,e=>Ll[e]),Rl=()=>w.getConfig?.().BASE_URL||``,zl=e=>Number(e||0).toLocaleString(),I={conversations:[],counts:{},magnetNames:{},filter:`ALL`,book:!1,magnetOwnerNames:{}},Bl={COMPLETED:{label:`Completed`,icon:`check_circle`},IN_PROGRESS:{label:`In progress`,icon:`pending`},ABANDONED:{label:`Abandoned`,icon:`highlight_off`}},Vl={book:`Book`,chat:`Chat`,call:`Call`,email:`Email`,support:`Support`},Hl=!1,Ul=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Wl={open:()=>`Opened the magnet`,engage:e=>`First interaction${e?`: ${Vl[e]||e}`:``}`,route:e=>`Picked ${Vl[e]||e||`a channel`}`,step:e=>`Reached step ${e||``}`,complete:()=>`Completed: lead captured`},Gl={render:Al,init:jl}})),ql=c({default:()=>_u,init:()=>Xl,render:()=>Yl});function Jl(){if(hu)return;let e=document.createElement(`style`);e.id=`m5t-abt-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),hu=!0}function Yl(){return A()?ta({section:`ab-testing`,title:`A/B Testing`,description:`Pick a client to view their experiments.`}):(Jl(),`
    <div class="page-shell" data-section="ab-testing">
      ...
      <div id="abt-body">${gu(`hourglass_empty`,`Loading tests…`)}</div>
    </div>`)}async function Xl(){if(A())return na(du(),[{h:`Running`,td:e=>fu(e.ab_tests?.running)},{h:`Completed`,td:e=>fu(e.ab_tests?.completed)},{h:`Compl. %`,td:e=>e.completion_rate==null?`—`:`${e.completion_rate}%`}],{emptyMsg:`No client orgs yet. Experiments appear per client once you have one.`});let e=document.getElementById(`abt-body`);try{let e=new Date,t=new Date(e.getTime()-76896e5).toISOString().slice(0,10),n=e.toISOString().slice(0,10),[r,i]=await Promise.all([fetch(`${du()}/m5t/v5/magnets`),fetch(`${du()}/m5t/v5/magnets/stats?from=${t}&to=${n}`)]),a=await r.json().catch(()=>({}));if(!a.ok)throw Error(a.message||`Failed to load`);pu.magnets=a.magnets||[],pu.canManage=!!a.canManage;let o=await i.json().catch(()=>({}));pu.stats=o?.stats||{}}catch(t){console.warn(`[ab-testing] load failed:`,t),e&&(e.innerHTML=gu(`error`,`Could not load your tests. Please try again.`));return}Zl()}function Zl(){let e=document.getElementById(`abt-body`);if(!e)return;let t=pu.magnets.filter(e=>e.ab?.enabled),n=pu.magnets.filter(e=>!e.ab?.enabled&&e.ab?.declared);if(!t.length&&!n.length){e.innerHTML=gu(`science`,`No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.`);return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(nu).join(``)}`:``)+(n.length?`<div class="abt-sect">Completed Tests</div>${n.map(ru).join(``)}`:``),Yt(e,{rowSelector:`.abt-card`,noun:`tests`}),e.querySelectorAll(`[data-declare]`).forEach(e=>e.addEventListener(`click`,()=>iu(e.dataset.declare,e.dataset.winner)))}function Ql(e){let t=pu.stats[e.guid]?.variants||{};return{A:{opens:0,engaged:0,completions:0,rate:null,...t.A||{}},B:{opens:0,engaged:0,completions:0,rate:null,...t.B||{}}}}function $l(e){let t=Object.keys(e?.b||{}).map(e=>mu[e]||e);return t.length?`Changes: ${t.join(`, `)}`:``}function eu(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function tu(e,t,n,r,i,a){return`
    <div class="abt-variant${i?` leader`:``}">
      ...
      <div class="abt-mrow"><span class="k">Visitors</span><span class="v">${fu(r.opens)}</span></div>
      <div class="abt-mrow"><span class="k">Completions</span><span class="v">${fu(r.completions)}</span></div>
    ...
    </div>`}function nu(e){let t=e.ab,{A:n,B:r}=Ql(e),i=(r.rate??-1)>(n.rate??-1)?`B`:(n.rate??-1)>(r.rate??-1)?`A`:null,a=i&&n.rate!=null&&r.rate!=null?`+${Math.round(Math.abs(r.rate-n.rate)*10)/10}%`:``,o=au(n,r),s=t.started_tz?eu(t.started_tz):null,c=(n.opens||0)+(r.opens||0),l=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
        <h2 class="abt-name">${lu(e.name)}</h2>
        <span class="abt-status running"><span class="pulse-dot"></span>Running</span>
        <div class="abt-actions">
          ${pu.canManage&&i?`<button class="btn btn-primary" type="button" data-declare="${lu(e.guid)}" data-winner="${i}"><span class="material-symbols-outlined" aria-hidden="true">emoji_events</span>Declare Winner</button>`:``}
        </div>
      </div>
      <div class="abt-meta">
        ${s==null?``:`<span><span class="material-symbols-outlined" aria-hidden="true">schedule</span>Started ${s===0?`today`:`${s} day${s===1?``:`s`} ago`}</span>`}
        <span><span class="material-symbols-outlined" aria-hidden="true">visibility</span>${fu(c)} total visitors</span>
      ...
      <div class="abt-compare">
        ${tu(`Variant A`,`Control`,`The magnet as configured`,n,i===`A`,i===`A`?a:``)}
        <div class="abt-vs">VS</div>
        ${tu(`Variant B`,i===`B`?`Leading`:`Challenger`,$l(t),r,i===`B`,i===`B`?a:``)}
      </div>
      <div class="abt-sig">
    ...
    <div class="abt-card">
      ...
      <div class="abt-summary">
        ...
        <span><span class="k">Total Visitors:</span><span class="v">${fu(o)}</span></span>
      </div>
    </div>`}async function iu(e,t){let n=pu.magnets.find(t=>t.guid===e);if(n&&window.confirm(`Declare Variant ${t} the winner for “${n.name}”?\n\n${t===`B`?`Variant B’s changes become the magnet’s configuration for everyone.`:`The magnet keeps its current configuration.`} The experiment ends and moves to Completed.`)){try{let n=await(await fetch(`${du()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!n.ok)throw Error(n.message||`Declare failed`);uu(`Variant ${t} declared the winner`,`success`)}catch(e){uu(e.message||`Could not declare a winner`,`danger`);return}try{await Xl()}catch(e){console.warn(`[ab-testing] refresh after declare failed:`,e)}}}function au(e,t){let n=e.opens||0,r=t.opens||0,i=e.completions||0,a=t.completions||0;if(n<30||r<30||i+a<5)return null;let o=i/n,s=a/r,c=(i+a)/(n+r),l=Math.sqrt(c*(1-c)*(1/n+1/r));if(!l)return null;let u=Math.abs(s-o)/l;return Math.round(2*(ou(u)-.5)*1e3)/10}function ou(e){let t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}var su,cu,lu,uu,du,fu,pu,mu,hu,gu,_u,vu=o((()=>{T(),su=u(f(),1),m(),ua(),Zt(),cu={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},lu=e=>String(e??``).replace(/[&<>"']/g,e=>cu[e]),uu=(e,t=`info`)=>{try{su.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},du=()=>w.getConfig?.().BASE_URL||``,fu=e=>Number(e||0).toLocaleString(),pu={magnets:[],stats:{},canManage:!1},mu={mag_title:`header title`,mag_subtitle:`subtitle`,mag_welcome:`welcome message`,mag_theme_color:`color`,mag_launcher_label:`launcher label`},hu=!1,gu=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,_u={render:Yl,init:Xl}}));function yu(e,t){let n={};return Object.keys(e&&typeof e==`object`?e:{}).forEach(r=>{t.includes(r)||(n[r]=e[r])}),Object.keys(n).length?n:null}function bu(e){return yu(e,cd)}function xu(e,t){let n=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||``).trim());return n?`rgba(${parseInt(n[1],16)},${parseInt(n[2],16)},${parseInt(n[3],16)},${t})`:`rgba(0,114,186,${t})`}function Su(){if(dd)return;let e=document.createElement(`style`);e.id=`m5t-flow-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),dd=!0}function Cu(e=`single_select`){return{_uid:Sd(),id:``,step_type:e,step_prompts:[``],step_options:nd(e)?[{label:``,goto:``,icon:``},{label:``,goto:``,icon:``}]:[],step_columns:od(e)?[od(e)]:[],step_description:``,step_config:id(e)?sd():null}}function wu(e){return(Array.isArray(e)?e:[]).map(e=>({_uid:Sd(),id:e.id==null?``:String(e.id),step_type:Qu[e.step_type]?e.step_type:`single_select`,step_prompts:Array.isArray(e.step_prompts)?e.step_prompts.map(String):[],step_options:(Array.isArray(e.step_options)?e.step_options:[]).map(e=>({label:e&&e.label!=null?String(e.label):``,goto:e&&e.goto!=null?String(e.goto):``,icon:e&&e.icon!=null?String(e.icon):``})),step_columns:Array.isArray(e.step_columns)?e.step_columns.map(String):[],step_description:e.step_description==null?``:String(e.step_description),step_config:id(e.step_type)?{...sd(),...e.step_config&&typeof e.step_config==`object`?e.step_config:{}}:e.step_config&&typeof e.step_config==`object`?{...e.step_config}:null}))}function Tu(){return[{_uid:Sd(),id:``,step_type:`text`,step_prompts:[`Great, and your name?`],step_options:[],step_columns:[`first_name`],step_description:``,step_config:null},{_uid:Sd(),id:``,step_type:`email`,step_prompts:[`The best email to reach you?`],step_options:[],step_columns:[`email`],step_description:``,step_config:null}]}function Eu(e,t){if(e===`book`)return[{_uid:Sd(),id:``,step_type:`scheduler`,step_prompts:[`When works best for you?`],step_options:[],step_columns:[],step_description:``,step_config:sd()},...Tu()];if(e===`support`){let e=(t.actions||[]).find(e=>e&&e.type===`support`),n=e&&e.config&&Array.isArray(e.config.options)?e.config.options:[],r=n.length?n.map(e=>({label:e&&e.label||String(e),goto:``,icon:e&&e.icon||``})):[`Sales enquiry`,`Support`,`Billing`,`Something else`].map(e=>({label:e,goto:``,icon:``}));return[{_uid:Sd(),id:``,step_type:`multi_select`,step_prompts:[`How can we help you today?`],step_options:r,step_columns:[],step_description:`Select all that apply`,step_config:null},...Tu()]}return[Cu(`single_select`)]}function Du(e,t){let n=wu(e===`chat`?t.steps:t.routes&&t.routes[e]);return n.length?n:e===`chat`?[Cu(`single_select`)]:Eu(e,t)}function Ou(e){nd(e.step_type)?e.step_options.length||(e.step_options=[{label:``,goto:``,icon:``},{label:``,goto:``,icon:``}]):e.step_options=[],rd(e.step_type)?!e.step_columns.length&&od(e.step_type)&&(e.step_columns=[od(e.step_type)]):e.step_columns=[],e.step_config=id(e.step_type)?{...sd(),...e.step_config||{}}:bu(e.step_config)}function ku(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${L(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${ud.map(([t,n])=>`<option value="${L(t)}"${t===e.icon?` selected`:``}>${L(n)}</option>`).join(``)}</select>
  ...
  </div>`}function Au(e){let t=$u.map(t=>`<option value="${t}"${t===e.step_type?` selected`:``}>${L(td(t).label)}</option>`).join(``),n=e.step_options.length<=1;return`<div class="flow-node__body">
    ...
    <textarea class="mag-modal__input flow-f-prompts" rows="2" placeholder="${e.step_type===`message`?`Thanks! One moment…`:`What can we help you with?`}">${L(e.step_prompts.join(`
`))}</textarea>
    ...
    <input class="mag-modal__input flow-f-cta-label" type="text" value="${L(e.step_config?.cta?.label||``)}" placeholder="e.g. Visit our site">
    <label class="mag-modal__label">Link URL <span class="flow-sub flow-cta-req">optional</span></label>
    <input class="mag-modal__input flow-f-cta-url" type="url" value="${L(e.step_config?.cta?.url||``)}" placeholder="https://example.com">
    ...
    <select class="mag-modal__select flow-f-field">
      ...
      ${He.map(t=>`<option value="${L(t.value)}"${t.value===e.step_columns[0]?` selected`:``}>${L(t.label)}</option>`).join(``)}
    </select>
    ...
    <div class="flow-opts">${e.step_options.map(e=>ku(e,n)).join(``)}</div>
    ...
    <input class="mag-modal__input flow-f-mtlabel" type="text" value="${L(e.step_config?.meeting_label||``)}" placeholder="e.g. 15 minute call">
    <div class="mag-modal__row" style="margin-top:8px">
      <div><label class="mag-modal__label">From</label><input class="mag-modal__input flow-f-start" type="time" value="${L(e.step_config?.start||`09:00`)}"></div>
      <div><label class="mag-modal__label">To</label><input class="mag-modal__input flow-f-end" type="time" value="${L(e.step_config?.end||`17:00`)}"></div>
  ...
  </div>`}function ju(e){let t=e.step_prompts.find(e=>String(e).trim()!==``)||``,n=t?`<div class="flow-node__prompt">“${L(t)}”</div>`:`<div class="flow-node__prompt is-empty">${e.step_type===`message`?`No message yet`:`No question yet`}</div>`,r=``;if(nd(e.step_type)){let t=e.step_options.map(e=>String(e.label).trim()).filter(Boolean);t.length&&(r=`<div class="flow-node__chips">${t.slice(0,4).map(e=>`<span class="flow-node__chip">${L(e)}</span>`).join(``)}${t.length>4?`<span class="flow-node__chip">+${t.length-4}</span>`:``}</div>`)}else if(rd(e.step_type)&&e.step_columns[0]){let t=He.find(t=>t.value===e.step_columns[0])?.label||e.step_columns[0];r=`<div class="flow-node__meta">Saves to <b>${L(t)}</b></div>`}else if(ad(e.step_type)&&e.step_config?.terminal){let t=String(e.step_config?.cta?.label||``).trim();r=`<div class="flow-node__meta">Ends the conversation${t?` — link: <b>${L(t)}</b>`:``}</div>`}return`<div class="flow-node__preview">${n}${r}</div>`}function Mu(e,t,n){let r=td(e.step_type),i=e._uid===fd,a=`--nc:${r.color};--nct:${xu(r.color,.14)}`;return`<div class="flow-node${i?` flow-node--open`:``}" data-uid="${e._uid}" style="${a}"${i?``:` draggable="true"`}>
    <div class="flow-node__hd">
      ...
      <span class="flow-node__type">${L(r.label)}</span>
    ...
    ${i?Au(e):ju(e)}
  </div>`}function Nu(){let e=document.getElementById(`flow-nodes`);if(!e)return;let t=R.length,n=[`<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>`,Cd];R.forEach((e,r)=>{n.push(Mu(e,r,t)),r<t-1&&n.push(Cd)}),e.innerHTML=n.join(``)}function Pu(){let e=document.querySelector(`.flow-node--open`);if(!e)return;let t=R.find(t=>t._uid===e.dataset.uid);if(!t)return;let n=e.querySelector(`.flow-f-type`);n&&(t.step_type=n.value);let r=e.querySelector(`.flow-f-prompts`);r&&(t.step_prompts=r.value.split(`
`));let i=e.querySelector(`.flow-f-field`);if(t.step_columns=i&&i.value.trim()?[i.value.trim()]:[],nd(t.step_type)){let n=t.step_options,r=[];e.querySelectorAll(`.flow-opt`).forEach((e,t)=>{r.push({label:e.querySelector(`.flow-o-label`)?.value??``,icon:e.querySelector(`.flow-o-icon`)?.value??``,goto:n[t]&&n[t].goto||``})}),t.step_options=r}else t.step_options=[];if(id(t.step_type)){let n=e.querySelector(`.flow-f-mtlabel`),r=e.querySelector(`.flow-f-start`),i=e.querySelector(`.flow-f-end`),a=e.querySelector(`.flow-f-mins`);t.step_config={...t.step_config||sd(),...n?{meeting_label:n.value.trim()}:{},...r&&r.value?{start:r.value}:{},...i&&i.value?{end:i.value}:{},...a?{mins:parseInt(a.value,10)||30}:{}}}else if(ad(t.step_type)){let n=e.querySelector(`.flow-f-terminal`);if(n){let r=e.querySelector(`.flow-f-cta-label`),i=e.querySelector(`.flow-f-cta-url`),a=yu(t.step_config,ld)||{};t.step_config=n.checked?{...a,terminal:!0,cta:{label:r?r.value:``,url:i?i.value:``}}:yu(t.step_config,ld)}}else t.step_config=bu(t.step_config)}function Fu(){document.querySelectorAll(`.flow-node.drop-before, .flow-node.drop-after`).forEach(e=>e.classList.remove(`drop-before`,`drop-after`))}function Iu(){Fu(),document.querySelectorAll(`.flow-node.dragging`).forEach(e=>e.classList.remove(`dragging`)),md=null,hd=null}function Lu(e=R){if(!e.length)return{message:`Add at least one step.`,uid:null,field:null};for(let t=0;t<e.length;t++){let n=e[t],r=t+1,i=(e,t=null)=>({message:e,uid:n._uid,field:t});if(!n.step_prompts.some(e=>String(e).trim()!==``))return i(`Step ${r}: add what the magnet should say.`,`prompts`);if(nd(n.step_type)&&!n.step_options.some(e=>String(e.label).trim()!==``))return i(`Step ${r}: add at least one choice.`,`options`);if(rd(n.step_type)&&!n.step_columns.length)return i(`Step ${r}: choose which field this answer saves to.`,`field`);if(ad(n.step_type)&&n.step_config?.terminal){let e=String(n.step_config.cta?.label||``).trim(),t=String(n.step_config.cta?.url||``).trim();if(!!e!=!!t)return i(`Step ${r}: fill in both the link label and URL, or leave both blank.`,`cta`)}}return null}function Ru(e){if(!e)return;let t=e.querySelector(`.flow-f-cta-label`),n=e.querySelector(`.flow-f-cta-url`);if(!t||!n)return;let r=t.value.trim()!==``,i=n.value.trim()!==``,a=r||i,o=r!==i;e.querySelectorAll(`.flow-cta-req`).forEach(e=>{e.textContent=a?`required`:`optional`,e.classList.toggle(`flow-sub--req`,a)}),t.classList.toggle(`flow-f-invalid`,o&&!r),n.classList.toggle(`flow-f-invalid`,o&&!i);let s=e.querySelector(`.flow-cta-warn`);s&&(s.hidden=!o)}function zu(e=R){let t=0;return e.forEach(e=>{let n=parseInt(e.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(e=>{let n=e.id&&String(e.id).trim()?String(e.id):String(++t),r=nd(e.step_type)?e.step_options.map(e=>{let t={label:String(e.label).trim(),goto:String(e.goto||``)};return e.icon&&(t.icon=String(e.icon)),t}).filter(e=>e.label!==``):[],i={id:n,step_type:e.step_type,step_prompts:e.step_prompts.map(e=>String(e)).filter(e=>e.trim()!==``),step_options:r,step_columns:e.step_columns.slice(),step_description:e.step_description||``};if(id(e.step_type))e.step_config&&(i.step_config={...sd(),...e.step_config});else if(e.step_config&&Object.keys(e.step_config).length){let t={...e.step_config};if(ad(e.step_type)&&t.terminal){let e=String(t.cta?.label??``).trim(),n=String(t.cta?.url??``).trim();e&&n?t.cta={label:e,url:n}:delete t.cta}i.step_config=t}return i})}function Bu(e,t,n){Su(),yd=t,bd=typeof n==`function`?n:null,xd=t?.modified_tz||``,vd=[`chat`,...[`book`,`support`].filter(e=>(t.actions||[]).some(t=>t&&t.type===e))],_d={chat:Du(`chat`,t)},gd=`chat`,R=_d.chat,fd=R.length===1?R[0]._uid:null,md=null,hd=null,e.innerHTML=`
    ...
    ${vd.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${vd.map(e=>`<option value="${e}">${L(ed[e]||e)}</option>`).join(``)}</select></div>`:``}
...
<body>
  ...
  <\/script>
  <script>${n}<\/script>
</body></html>`}function kd(){if(Pd)return;let e=document.createElement(`style`);e.id=`m5t-preview-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Pd=!0}function Ad(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function jd(e){let t=e.querySelector(`[data-pv-info]`),n=e.querySelector(`[data-pv-info-pop]`);t&&n&&t.addEventListener(`click`,()=>{n.hidden=!n.hidden})}function Md(e,t){kd(),e.innerHTML=`
    <div class="pv-pane">
    ...
    <div class="pv-modal" role="dialog" aria-modal="true" aria-label="Magnet preview">
      ...
      <div class="pv-body">
        <div>
          ...
          ${Ad(`Live render of the actual widget. Capture is disabled, so no test leads are created.`)}
        </div>
      </div>
    </div>`,document.body.appendChild(n),requestAnimationFrame(()=>n.classList.add(`open`)),jd(n);let r=n.querySelector(`.pv-frame`),i=n.querySelector(`.pv-stage`),a=()=>{try{r.srcdoc=Od(e())}catch{}};a();let o=()=>{n.classList.remove(`open`),setTimeout(()=>n.remove(),180)};return n.querySelector(`[data-x="close"]`).addEventListener(`click`,o),n.querySelector(`[data-x="refresh"]`).addEventListener(`click`,a),n.addEventListener(`click`,e=>{e.target===n&&o()}),n.querySelector(`.pv-seg`).addEventListener(`click`,e=>{let r=e.target.closest(`button[data-device]`);!r||r.dataset.device===t||(t=r.dataset.device,n.querySelectorAll(`.pv-seg button`).forEach(e=>e.classList.toggle(`is-on`,e.dataset.device===t)),i.dataset.device=t,a())}),{close:o,rebuild:a}}var Pd,Fd=o((()=>{Ed(),Pd=!1}));function Id(e){let t=[];for(let n of e.steps||[])for(let e of n.step_columns||[])e&&!t.includes(e)&&t.push(e);return t}function Ld(e){let t=(e.steps||[])[0]||{},n=(t.step_prompts||[])[0]||``,r=``;return t.step_type===`single_select`||t.step_type===`multi_select`?r=(t.step_options||[]).slice(0,3).map(e=>`<span class="mag-tpl-pv__btn">${Kd(e?.label)}</span>`).join(``):Yd[t.step_type]?r=`<span class="mag-tpl-pv__input">${Kd(Yd[t.step_type])}</span>`:t.step_type===`scheduler`&&(r=`<span class="mag-tpl-pv__cal"><span class="material-symbols-outlined" aria-hidden="true">calendar_month</span>Pick a time</span>`),`<div class="mag-tpl-card__preview" aria-hidden="true"><span class="mag-tpl-pv__bubble">${Kd(n)}</span>${r}</div>`}function Rd(e,{detail:t=!1,gallery:n=!1,canUse:r=!0}={}){let i=t?Id(e):[],a=n?` mag-tpl-card--gallery`:``,o=n?` data-cat="${Kd(e.category||``)}"`:``,s=n&&e.featured?`<span class="m5t-badge m5t-badge--featured m5t-featured-corner">Most popular</span>`:``,c=n?Ld(e):``,l=n&&(e.tags||[]).length?`<div class="m5t-chip-row mag-tpl-card__tags">${e.tags.map(e=>`<span class="m5t-chip">${Kd(e)}</span>`).join(``)}</div>`:``,u=r?`<button class="mag-tpl-card__btn" type="button" data-tpl="${e.id}">
    ...
    </div>`}function zd(e){da(ma.MAGNET_TEMPLATE,{id:e,at:Date.now()})}function Bd(e){if(!e)return null;if(typeof e==`string`)return Jd.find(t=>t.id===e)||null;let{id:t,at:n}=e;return typeof n==`number`&&Date.now()-n>=Xd?null:Jd.find(e=>e.id===t)||null}function Vd(){return Bd(fa(ma.MAGNET_TEMPLATE))}function Hd(){return Bd(pa(ma.MAGNET_TEMPLATE))}function Ud(){if(Zd)return;let e=document.createElement(`style`);e.id=`m5t-mag-template-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Zd=!0}function Wd(e){Ud();let t=document.createElement(`div`);t.className=`mag-modal-scrim mag-tpl-modal`,t.innerHTML=`
    ...
    <label><input type="radio" name="${B(e)}" value="${B(n.value)}"${n.value===t?` checked`:``}>
      ...
      <input class="mag-modal__input mag-cta__val" type="text" placeholder="${B(n.placeholder)}" value="${B(e?``:t?.value||``)}"${i}${e?` hidden`:``}>
      <select class="mag-modal__select mag-cta__crtracker" data-saved="${B(r)}" data-saved-name="${B(o)}" data-saved-id="${B(e&&t?.config?.tracker_id||``)}"${i}${e?``:` hidden`}>
        ${r?`<option value="${B(r)}" selected>${B(o)}</option>`:``}
      </select>`}else if(n.kind===`value`)a=`<input class="mag-modal__input mag-cta__val" type="text" placeholder="${B(n.placeholder)}" value="${B(t?.value||``)}"${i}>`;else if(n.kind===`book`){let e=t?.config?.meeting_label||t?.value||``,n=t?.config?.source===`calendly`,r=n&&t?.config?.calendly_url||``,o=n?t?.config?.event_name||`Saved Calendly event`:``;a=`
      ...
      <input class="mag-modal__input mag-cta__val" type="text" placeholder="Meeting label (e.g. 15 minute call), or paste a booking link" value="${B(e)}"${i}${n?` hidden`:``}>
      <select class="mag-modal__select mag-cta__calevent" data-saved="${B(r)}" data-saved-name="${B(o)}"${i}${n?``:` hidden`}>
        ${r?`<option value="${B(r)}" selected>${B(o)}</option>`:``}
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${n.kind}">
    ...
    ${o}
  </div>`}function pf(){if(_p)return;let e=document.createElement(`style`);e.id=`m5t-magnets-styles`,e.textContent=`
    ...
    .page-shell .mag-grid { display: flex; flex-direction: column; border: 1px solid var(--color-border, #D4DCE8); border-radius: var(--radius-lg, 16px); background: var(--color-bg, #fff); overflow: visible; }
    .page-shell .mag-card { padding: 13px 16px; border-bottom: 1px solid var(--color-border, #D4DCE8); }
    .page-shell .mag-card:last-child { border-bottom: 0; }
    .page-shell .mag-line { display: flex; align-items: center; gap: 12px; flex-wrap: wrap; }
    ...
    .page-shell .mag-id { flex: 1 1 240px; min-width: 0; display: flex; flex-direction: column; gap: 2px; }
    .page-shell .mag-id__line { display: flex; align-items: center; gap: 8px; min-width: 0; }
    .page-shell .mag-name { font-weight: 700; font-size: 0.94rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    .page-shell .mag-sub { font-size: 0.74rem; color: var(--color-text-subtle, #6C7C9A); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    .page-shell .mag-right { display: flex; align-items: center; gap: 14px; margin-left: auto; flex-wrap: wrap; }
    .page-shell .mag-health { appearance: none; border: 0; background: none; cursor: pointer; font: inherit; font-size: 0.76rem; display: inline-flex; align-items: center; gap: 5px; color: var(--color-text-muted, #4A5A78); padding: 4px 7px; border-radius: 8px; white-space: nowrap; }
    .page-shell .mag-health:hover { background: var(--color-surface, #F4F7FB); }
    .page-shell .mag-health[data-live="live"] { color: var(--color-success, #009473); font-weight: 600; }
    .page-shell .mag-health[data-live="seen"] { color: #B45309; font-weight: 600; }
    .page-shell .mag-health .material-symbols-outlined { font-size: 16px; }
    .page-shell .mag-health[hidden] { display: none; }
    .page-shell .mag-rowactions { display: flex; align-items: center; gap: 6px; }
    ...
    .page-shell .mag-menu__item { appearance: none; border: 0; background: none; cursor: pointer; font: inherit; font-size: 0.78rem; font-weight: 600; text-align: left; display: flex; align-items: center; gap: 8px; padding: 7px 10px; border-radius: 7px; color: var(--color-text, #0B1220); }
    ...
    .page-shell .mag-detail { margin: 11px 0 2px 22px; padding: 12px 14px; border: 1px solid var(--color-border, #D4DCE8); background: var(--color-surface, #F4F7FB); border-radius: 12px; display: flex; flex-direction: column; gap: 10px; }
    .page-shell .mag-detail[hidden] { display: none; }
    .page-shell .mag-detail .mag-embed input { background: var(--color-bg, #fff); }
    @media (max-width: 720px) { .page-shell .mag-right { margin-left: 22px; width: 100%; justify-content: space-between; } .page-shell .mag-detail { margin-left: 0; } }
  ...
  `,document.head.appendChild(e),_p=!0}function mf(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function hf(e){let t=z.stats[e];if(!t||!t.opens&&!t.leads)return`<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>`;let n=e=>Number(e||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function gf(e){let t=z.install[e.guid];if(!t)return``;let n=t.unrecognized||[],r=(t.traffic?.opens||0)>0,i=e.can_manage===!0,a=n.length?`
    <div class="mag-install__seen">
      ...
      ${n.map(t=>`
        <div class="mag-install__row">
          <span class="mag-install__dom" title="${B(t.domain)}">${B(t.domain)}</span>
          <span class="mag-install__hits">${Number(t.hits||0).toLocaleString()}&times;</span>
          ${i?`<button class="mag-btn" data-action="allow-domain" data-guid="${B(e.guid)}" data-domain="${B(t.domain)}">Allow</button>
          <button class="mag-btn" data-action="dismiss-domain" data-guid="${B(e.guid)}" data-domain="${B(t.domain)}" title="Stop showing this domain">Dismiss</button>`:``}
        </div>`).join(``)}
    ...
    <details class="mag-install__dismissed">
      ...
      ${c.map(t=>`
        <div class="mag-install__row">
          <span class="mag-install__dom" title="${B(t)}">${B(t)}</span>
          ${i?`<button class="mag-btn" data-action="restore-domain" data-guid="${B(e.guid)}" data-domain="${B(t)}">Restore</button>`:``}
        </div>`).join(``)}
    ...
    ${s}
    ${l}
  </div>`}async function _f(){await Promise.all(z.magnets.map(async e=>{try{let t=await(await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity`)).json().catch(()=>({}));if(!t.ok)return;z.install[e.guid]=t,zf(e)}catch(t){console.warn(`[magnets] install activity failed:`,e.guid,t)}}))}function vf(e){return e?e.status===`REVOKED`||e.status===`PENDING`&&e.codeLive===!1:!1}function yf(e,t){let n=t.status===`PENDING`&&t.codeLive===!1,r=(n?Mp.EXPIRED:Mp[t.status])||{label:t.status,icon:`help`,tone:`off`},i=t.lastSeen?new Date(t.lastSeen).toLocaleString():``,a=t.host?B(t.host):n||t.status===`REVOKED`?`Code was never used`:`Waiting for a site to use this code`,o=[t.siteName?B(t.siteName):``,i?`last seen ${B(i)}`:``].filter(Boolean).join(` — `);return`
    <div class="mag-conn__row" data-conn="${B(t.guid)}" data-state="${r.tone}">
      ...
      <span class="mag-conn__status">${B(r.label)}</span>
      ${e.can_manage===!0?vf(t)?`<button class="mag-btn" data-action="clear-connection" data-guid="${B(e.guid)}" data-conn="${B(t.guid)}"
                   data-label="${B(t.host||`this unused code`)}"
                   title="Remove this finished record from the list">
             Clear
           </button>`:`<button class="mag-btn" data-action="revoke-connection" data-guid="${B(e.guid)}" data-conn="${B(t.guid)}"
    ...
    </div>`}function bf(e){let t=z.pairing[e.guid];if(!t)return``;if(t.error)return`<div class="mag-conn__code" data-state="error">
      <p class="mag-install__hint">${B(t.error)}</p>
      <button class="mag-btn" data-action="pair-start" data-guid="${B(e.guid)}">Try again</button>
      ...
      <div class="mag-conn__hd"><span class="material-symbols-outlined" aria-hidden="true">check_circle</span>
        Connected${t.connectedHost?` — ${B(t.connectedHost)}`:``}</div>
      ...
      <button class="mag-btn mag-btn--primary" data-action="pair-start" data-guid="${B(e.guid)}">Generate a new code</button>
    ...
    <div class="mag-conn__codebox">
      <code data-x="code">${B(t.code)}</code>
      <button class="mag-btn" data-action="copy-code" data-guid="${B(e.guid)}" title="Copy pairing code">
  ...
  </div>`}function xf(e){let t=z.connections[e.guid];if(!t)return``;if(t.failed)return`<div class="mag-conn">
    ...
    </div>`;let n=t.connections||[],r=n.filter(t=>t.status!==`PENDING`||e.can_manage===!0),i=n.filter(e=>e.status===`ACTIVE`).length,a=bf(e),o=r.filter(e=>!vf(e)),s=r.filter(e=>vf(e)),c=o.length?o.map(t=>yf(e,t)).join(``):`<p class="mag-install__hint">No sites connected yet. On WordPress, connecting a site pairs it without pasting the snippet by hand.</p>`,l=s.length?`
    ...
    ${a}
    ${e.can_manage===!0&&!a?`
      <button class="mag-btn" data-action="pair-start" data-guid="${B(e.guid)}">
        <span class="material-symbols-outlined" aria-hidden="true">add_link</span>Connect a WordPress site
      </button>`:``}
  </div>`}function Sf(e){let t=document.querySelector(`.mag-card[data-guid="${CSS.escape(e.guid)}"] .mag-conn-slot`);t&&(t.innerHTML=xf(e))}async function Cf(e){let t=await(await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/connections`)).json().catch(()=>({}));if(!t.ok)throw Error(t.error||`Could not load connected sites`);return t}async function wf(){await Promise.all(z.magnets.map(async e=>{try{z.connections[e.guid]=await Cf(e)}catch(t){console.warn(`[magnets] connections failed:`,e.guid,t),z.connections[e.guid]={failed:!0}}Sf(e)}))}function Tf(){z.pairTimer&&(clearInterval(z.pairTimer),z.pairTimer=null)}function Ef(){Tf()}function Df(e){return!!document.querySelector(`.mag-card[data-guid="${CSS.escape(e)}"] .mag-conn-slot`)}function Of(){if(z.pairTimer)return;let e=0;z.pairTimer=setInterval(async()=>{for(let e of Object.keys(z.pairing))Df(e)||delete z.pairing[e];let t=Object.keys(z.pairing);if(!t.length){Tf();return}if(!t.some(e=>{let t=z.pairing[e];return!t.connected&&!t.error&&t.expiresAt-Date.now()>0})){t.forEach(e=>{let t=z.magnets.find(t=>t.guid===e);t&&Sf(t)}),Tf();return}e+=1e3;let n=e>=jp;n&&(e=0);for(let e of t){let t=z.magnets.find(t=>t.guid===e),r=z.pairing[e];if(!t||!r)continue;let i=r.expiresAt-Date.now()<=0;if(n&&!r.connected&&!r.error&&!i)try{let n=await Cf(t);z.connections[e]=n;let i=(n.connections||[]).find(e=>e.guid===r.connectionGuid&&e.status===`ACTIVE`);i&&(z.pairing[e]={connected:!0,connectionGuid:r.connectionGuid,connectedHost:i.host},V(`${i.host||`Your site`} connected`,`success`))}catch{}Sf(t)}},1e3)}async function kf(e){try{let t=await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/pairing-code`,{method:`POST`,headers:{"Content-Type":`application/json`},body:`{}`}),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok){z.pairing[e.guid]={error:n.message||n.error||`Could not generate a pairing code`},Sf(e);return}z.pairing[e.guid]={code:n.pairingCode,connectionGuid:n.connectionGuid,expiresAt:new Date(n.expiresAt).getTime()};try{z.connections[e.guid]=await Cf(e)}catch{}Sf(e),Of()}catch{z.pairing[e.guid]={error:`Could not reach the server. Try again.`},Sf(e)}}async function Af(e){let t=z.pairing[e.guid]?.code;if(t)try{await navigator.clipboard.writeText(t),V(`Pairing code copied`,`success`)}catch{V(`Copy failed — select the code and copy it manually`,`danger`)}}async function jf(e,t,n){if(window.confirm(`Clear the record for ${n||`this connection`}?\n\nIt is removed from this list for good. This only tidies up the history — the site is already disconnected, so nothing about access changes.`))try{let n=await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/connections/${encodeURIComponent(t)}`,{method:`DELETE`}),r=await n.json().catch(()=>({}));if(!n.ok||!r.ok){V(r.message||r.error||`Could not clear that record`,`danger`);return}V(`Record cleared`,`success`);try{z.connections[e.guid]=await Cf(e)}catch{}Sf(e)}catch{V(`Could not reach the server`,`danger`)}}async function Mf(e,t){let n=(z.connections[e.guid]?.connections||[]).find(e=>e.guid===t),r=n?.status===`PENDING`,i=r?`Cancel this pairing code?`:`Disconnect ${n?.host||`this site`}?`,a=r?`The code stops working immediately.`:`Its key stops working immediately and the plugin will show as disconnected. The domain stays on the allow-list — remove it separately if you want the magnet off that site.`;if(window.confirm(`${i}\n\n${a}`))try{let n=await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/connections/${encodeURIComponent(t)}/revoke`,{method:`POST`,headers:{"Content-Type":`application/json`},body:`{}`}),i=await n.json().catch(()=>({}));if(!n.ok||!i.ok){V(i.message||i.error||`Could not disconnect`,`danger`);return}z.pairing[e.guid]?.connectionGuid===t&&delete z.pairing[e.guid],V(r?`Pairing code cancelled`:`Site disconnected`,`success`);try{z.connections[e.guid]=await Cf(e)}catch{}Sf(e)}catch{V(`Could not reach the server`,`danger`)}}function Nf(e){if(e.status===`DRAFT`)return`draft`;if(e.status!==`ENABLED`)return`off`;let t=z.install[e.guid];return t?(t.traffic?.opens||0)>0?`live`:(t.unrecognized||[]).length?`seen`:`quiet`:`unknown`}function Pf(e){let t=Nf(e);if(t===`draft`)return`<span class="material-symbols-outlined" aria-hidden="true">edit_note</span>Not live yet`;if(t===`off`)return`<span class="material-symbols-outlined" aria-hidden="true">pause_circle</span>Disabled`;if(t===`unknown`)return``;let n=z.install[e.guid];if(t===`live`){let e=n.traffic?.last_open_at?new Date(n.traffic.last_open_at):null,t=e&&e.toDateString()===new Date().toDateString(),r=e?t?e.toLocaleTimeString([],{hour:`numeric`,minute:`2-digit`}):e.toLocaleDateString():``;return`<span class="material-symbols-outlined" aria-hidden="true">check_circle</span>Live${r?` &middot; ${B(r)}`:``}`}return t===`seen`?`<span class="material-symbols-outlined" aria-hidden="true">travel_explore</span>Unrecognised domain`:`<span class="material-symbols-outlined" aria-hidden="true">help</span>Not seen in ${Number(n.window_days||30)} days`}function Ff(e){let t=z.owners.length>1||w.getMemberships().length>1,n=(e.domains||[]).filter(Boolean),r=e.can_manage===!0,i=Nf(e),a=Pf(e),o=z.detailOpen[e.guid]===!0,s=[n.length?n.join(`, `):`No domains set. Add yours to go live.`,t&&e.owner_name?e.owner_name:``].filter(Boolean).join(` · `);return`
    <div class="mag-card" data-guid="${B(e.guid)}">
      <div class="mag-line">
        <span class="mag-dot" data-live="${i}" aria-hidden="true"></span>
        <div class="mag-id">
          <div class="mag-id__line">
            <span class="mag-name" title="${B(e.name)}">${B(e.name)}</span>
            <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${Cp[e.display_mode]||`chat`}</span>${B(Sp[e.display_mode]||`Chat bubble`)}</span>
            ...
            ${e.status===`ENABLED`?``:`<span class="mag-badge" data-s="${B(e.status)}">${B(e.status)}</span>`}
          </div>
          <div class="mag-sub" title="${B(s)}">${B(s)}</div>
        </div>
        <div class="mag-right">
          <button class="mag-health" type="button" data-action="install-toggle" data-guid="${B(e.guid)}" data-live="${i}" ${a?``:`hidden`} title="Install and health detail">${a}</button>
          ${hf(e.guid)}
          <div class="mag-rowactions">
            ${r?`<button class="mag-btn mag-btn--primary" data-action="edit" data-guid="${B(e.guid)}"><span class="material-symbols-outlined" aria-hidden="true">tune</span>Edit</button>`:``}
            <button class="mag-btn" data-action="install-toggle" data-guid="${B(e.guid)}" aria-expanded="${o}" aria-controls="mag-detail-${B(e.guid)}"><span class="material-symbols-outlined" aria-hidden="true">${o?`expand_less`:`expand_more`}</span>Install</button>
            <div class="mag-more-wrap">
              <button class="mag-btn" data-action="menu" data-guid="${B(e.guid)}" aria-haspopup="true" aria-expanded="false" title="More actions"><span class="material-symbols-outlined" aria-hidden="true">more_horiz</span></button>
              <div class="mag-menu" hidden role="menu">
                <button class="mag-menu__item" role="menuitem" data-action="preview" data-guid="${B(e.guid)}"><span class="material-symbols-outlined" aria-hidden="true">visibility</span>Preview</button>
                <button class="mag-menu__item" role="menuitem" data-action="funnel" data-guid="${B(e.guid)}" title="Which question loses the most visitors"><span class="material-symbols-outlined" aria-hidden="true">filter_alt</span>Funnel</button>
                ${r?`
                <button class="mag-menu__item" role="menuitem" data-action="flow" data-guid="${B(e.guid)}" title="Edit the conversation flow"><span class="material-symbols-outlined" aria-hidden="true">account_tree</span>Flow</button>
                ${e.status===`DRAFT`?``:`
                <button class="mag-menu__item" role="menuitem" data-action="toggle" data-guid="${B(e.guid)}">${e.status===`ENABLED`?`<span class="material-symbols-outlined" aria-hidden="true">pause</span>Disable`:`<span class="material-symbols-outlined" aria-hidden="true">play_arrow</span>Enable`}</button>`}
                <button class="mag-menu__item danger" role="menuitem" data-action="delete" data-guid="${B(e.guid)}"><span class="material-symbols-outlined" aria-hidden="true">delete</span>Delete</button>`:``}
              </div>
            </div>
          </div>
        </div>
      </div>
      <div class="mag-detail" id="mag-detail-${B(e.guid)}" ${o?``:`hidden`}>
        <div class="mag-embed">
          <input type="text" readonly value="${B(yp(e.guid))}" aria-label="Embed snippet">
        ...
        <div class="mag-install-slot">${gf(e)}</div>
        <div class="mag-conn-slot">${xf(e)}</div>
      </div>
    </div>`}function If(e,t){let n=typeof t==`boolean`?t:z.detailOpen[e]!==!0;z.detailOpen[e]=n;let r=document.querySelector(`.mag-card[data-guid="${CSS.escape(e)}"]`);if(!r)return;let i=r.querySelector(`.mag-detail`);i&&(i.hidden=!n);let a=r.querySelector(`[data-action="install-toggle"][aria-controls]`);if(a){a.setAttribute(`aria-expanded`,String(n));let e=a.querySelector(`.material-symbols-outlined`);e&&(e.textContent=n?`expand_less`:`expand_more`)}}function Lf(){Np||(Np=!0,document.addEventListener(`click`,e=>{e.target.closest?.(`.mag-more-wrap`)||Rf()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&Rf()}))}function Rf(e){document.querySelectorAll(`.mag-menu`).forEach(t=>{if(t===e)return;t.hidden=!0;let n=t.parentElement?.querySelector(`[data-action="menu"]`);n&&n.setAttribute(`aria-expanded`,`false`)})}function zf(e){let t=document.querySelector(`.mag-card[data-guid="${CSS.escape(e.guid)}"]`);if(!t)return;let n=t.querySelector(`.mag-install-slot`);n&&(n.innerHTML=gf(e));let r=Nf(e),i=t.querySelector(`.mag-dot`);i&&(i.dataset.live=r);let a=t.querySelector(`.mag-health`);if(a){let t=Pf(e);a.innerHTML=t,a.dataset.live=r,a.hidden=!t}(r===`quiet`||r===`seen`)&&z.detailOpen[e.guid]===void 0&&If(e.guid,!0)}function Bf(){return A()?ta({section:`magnets`,title:`Your Magnets`,description:`Pick a client to view and manage their magnets.`}):(pf(),`
    <div class="page-shell" data-section="magnets">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="mag-body">
          ${mf(`hourglass_empty`,`Loading magnets…`)}
        </div>
      </div>
    </div>`)}async function Vf(){if(A()){let e=Hd();if(e){let t=document.querySelector(`.page-shell .page-header-text .page-description`);t&&(t.textContent=`Template picked: ${e.name}. Choose the client to build it for.`)}let t=e=>Number(e||0).toLocaleString();return na(H(),[{h:`Magnets`,td:e=>`${t(e.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${t(e.magnets.total)}</span>`},{h:`Leads · wk`,td:e=>t(e.leads.this_week)},{h:`Leads · total`,td:e=>t(e.leads.total)}],{emptyMsg:`No client orgs yet. Create one under Clients, then provision its magnets here.`})}kp=null,Ap=null,document.getElementById(`mag-new-btn`)?.addEventListener(`click`,Yf),document.getElementById(`mag-template-btn`)?.addEventListener(`click`,Zf),document.getElementById(`mag-body`)?.addEventListener(`click`,Qf),Lf(),await Uf();let e=Vd();e&&z.canProvision&&Xf(e)}function Hf(e){e&&(e.innerHTML=`<div class="mag-grid">${z.magnets.map(Ff).join(``)}</div>`,Yt(e.querySelector(`.mag-grid`),{rowSelector:`.mag-card`,noun:`magnets`}))}async function Uf(){let e=document.getElementById(`mag-body`);if(!e)return;try{let[e,t]=await Promise.all([fetch(`${H()}/m5t/v5/magnets`),fetch(`${H()}/m5t/v5/magnets/stats`).catch(()=>null)]),n=await e.json().catch(()=>({}));if(!n.ok)throw Error(n.message||`Failed to load`);z.magnets=n.magnets||[],z.owners=n.owners||[],z.canProvision=!!n.canProvision,z.canManage=!!n.canManage,z.primaryOrgGuid=n.primaryOrgGuid||null;let r=t?await t.json().catch(()=>({})):{};z.stats=r?.stats||{}}catch{e.innerHTML=mf(`error`,`Could not load your magnets. Please try again.`);return}let t=document.getElementById(`mag-new-btn`);t&&(t.style.display=z.canProvision?``:`none`);let n=document.getElementById(`mag-template-btn`);if(n&&(n.style.display=z.canProvision?``:`none`),!z.magnets.length){e.innerHTML=mf(`widgets`,z.canProvision?`No magnets yet. Click “New magnet” to create your first.`:`No magnets yet.`);return}Hf(e),_f(),wf()}async function Wf(e){let t={"Content-Type":`application/json`,"Idempotency-Key":crypto.randomUUID()},n={status:`DRAFT`};e&&(n.owner_guid=e);let r=await fetch(`${H()}/m5t/v5/magnets`,{method:`POST`,headers:t,body:JSON.stringify(n)}),i={};try{i=await r.json()}catch{}if(!r.ok||!i.ok)throw Error(i.message||`Could not start a new magnet (${r.status})`);return i.magnet}async function Gf(e,t){let n=await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({name:t.name,...t.appearance,steps:t.steps})}),r={};try{r=await n.json()}catch{}if(!n.ok||!r.ok)throw Error(r.message||`Could not apply the ${t.name} template (${n.status})`)}async function Kf(e,t){let n=document.getElementById(`mag-new-btn`),r=document.getElementById(`mag-template-btn`);n&&(n.disabled=!0),r&&(r.disabled=!0);let i=null;try{let n=await Wf(e);i=n.guid,t?(await Gf(n.guid,t),await Uf(),n=z.magnets.find(e=>e.guid===n.guid)||n):(z.magnets=[n,...z.magnets],Hf(document.getElementById(`mag-body`))),hp(n,void 0,{freshDraft:!0})}catch(e){i&&fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(i)}`,{method:`DELETE`}).catch(()=>{}),V(e.message||`Could not start a new magnet`,`danger`)}finally{n&&(n.disabled=!1),r&&(r.disabled=!1)}}function qf(e){let t=document.createElement(`div`);t.className=`mag-modal-scrim`,t.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="Choose client" style="max-width:420px">
      <div class="mag-modal__head">
        <span class="mag-modal__title">${e?`New magnet from “${B(e.name)}”`:`New magnet`}</span>
        <button class="mag-modal__close" type="button" aria-label="Close">&times;</button>
      </div>
      <div class="mag-modal__body" style="padding:20px">
        ...
        <select class="mag-modal__select" id="mag-owner-pick">
          ${z.owners.map(e=>`<option value="${B(e.guid)}"${e.guid===z.primaryOrgGuid?` selected`:``}>${B(e.name||e.guid)}</option>`).join(``)}
        </select>
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add(`open`),t.querySelector(`.mag-modal`).classList.add(`open`)});let n=()=>{t.classList.remove(`open`),setTimeout(()=>t.remove(),180),document.removeEventListener(`keydown`,r)};function r(e){e.key===`Escape`&&(e.preventDefault(),n())}document.addEventListener(`keydown`,r),t.querySelector(`.mag-modal__close`).addEventListener(`click`,n),t.querySelector(`[data-x="cancel"]`).addEventListener(`click`,n),t.querySelector(`[data-x="continue"]`).addEventListener(`click`,()=>{let r=t.querySelector(`#mag-owner-pick`).value;n(),Kf(r,e)})}function Jf(){return z.owners.length===1?z.owners[0].guid:null}function Yf(){if(z.owners.length>1){qf();return}Kf(Jf())}function Xf(e){if(z.owners.length>1){qf(e);return}Kf(Jf(),e)}function Zf(){Wd(Xf)}function Qf(e){let t=e.target.closest(`[data-action]`);if(!t){Rf();return}let n=t.dataset.guid,r=z.magnets.find(e=>e.guid===n),i=t.dataset.action;if(i===`menu`){let e=t.parentElement?.querySelector(`.mag-menu`);if(!e)return;let n=e.hidden;Rf(e),e.hidden=!n,t.setAttribute(`aria-expanded`,String(n));return}if(Rf(),i===`install-toggle`)return If(n);if(i===`copy`)return $f(n);if(r){if(i===`preview`)return Nd(()=>Dd(r));if(i===`funnel`)return tp(r);if(i===`edit`)return hp(r);if(i===`flow`)return hp(r,`flow`);if(i===`allow-domain`)return np(r,t.dataset.domain);if(i===`dismiss-domain`)return rp(r,t.dataset.domain);if(i===`restore-domain`)return ip(r,t.dataset.domain);if(i===`pair-start`)return kf(r);if(i===`copy-code`)return Af(r);if(i===`revoke-connection`)return Mf(r,t.dataset.conn);if(i===`clear-connection`)return jf(r,t.dataset.conn,t.dataset.label);if(i===`toggle`)return op(r);if(i===`delete`)return sp(r)}}async function $f(e){try{await navigator.clipboard.writeText(yp(e)),V(`Embed snippet copied`,`success`)}catch{V(`Copy failed`,`danger`)}}function ep(e){let t=Number(e?.total_steps)||0,n={};if((Array.isArray(e?.funnel)?e.funnel:[]).forEach(e=>{n[e.position]=Number(e.reached)||0}),!t||!Object.keys(n).length)return`<p class="mag-modal__hint" style="margin:0">No step activity yet in this window. As visitors answer questions, drop-off by step will appear here.</p>`;let r=Math.max(1,n[1]||0),i=[];for(let e=1;e<=t;e++){let a=n[e]||0,o=Math.min(100,Math.round(a/r*100));i.push(`
      ...
      </div>`)}return`<div class="mag-funnel">${i.join(``)}</div>`}async function tp(e){let t=document.createElement(`div`);t.className=`mag-modal-scrim`,t.innerHTML=`
    <div class="mag-modal mag-funnel-modal" role="dialog" aria-modal="true" aria-label="Step funnel for ${B(e.name)}">
      <div class="mag-modal__head">
        <span class="mag-modal__title">Step funnel — ${B(e.name)}</span>
        <button class="mag-modal__close" type="button" aria-label="Close">&times;</button>
      </div>
      <div class="mag-modal__body" style="padding:20px">
        ...
        <div id="mag-funnel-body">${mf(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add(`open`),t.querySelector(`.mag-modal`).classList.add(`open`)});let n=()=>{t.classList.remove(`open`),setTimeout(()=>t.remove(),180),document.removeEventListener(`keydown`,r)};function r(e){e.key===`Escape`&&(e.preventDefault(),n())}document.addEventListener(`keydown`,r),t.querySelector(`.mag-modal__close`).addEventListener(`click`,n),t.addEventListener(`click`,e=>{e.target===t&&n()});let i=t.querySelector(`#mag-funnel-body`);try{let t=await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/step-funnel`),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.message||`Failed (${t.status})`);i.innerHTML=ep(n)}catch{i.innerHTML=`<p class="mag-modal__hint" style="margin:0">Could not load the funnel. Please try again.</p>`}}async function np(e,t){let n=String(t||``).trim().toLowerCase();if(!n||!window.confirm(`Allow ${n} to load this magnet?\n\nOnly do this for a site you recognise — anyone can put this magnet's embed code on a page.`))return;let r=[...new Set([...(e.domains||[]).filter(Boolean),n])];try{if(!(await(await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({domains:r})})).json().catch(()=>({}))).ok)throw Error();V(`${n} allowed`,`success`)}catch{V(`Could not allow that domain`,`danger`);return}try{await Uf()}catch(e){console.warn(`[magnets] refresh after allow-domain failed:`,e)}}async function rp(e,t){let n=String(t||``).trim().toLowerCase();if(!n)return;let r=n.split(`.`),i=r.length>2?r.slice(-2).join(`.`):null,a=n;i&&window.confirm(`Hide ${n} from this list?\n\nOK — hide every domain under ${i} too (covers preview/staging URLs that change every deploy).\nCancel — hide only ${n}.`)&&(a=i);try{if(!(await(await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity/dismiss`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({domain:a})})).json().catch(()=>({}))).ok)throw Error();V(`${a} hidden from this list`,`success`)}catch{V(`Could not dismiss that domain`,`danger`);return}await ap(e)}async function ip(e,t){let n=String(t||``).trim().toLowerCase();if(n){try{if(!(await(await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity/restore`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({domain:n})})).json().catch(()=>({}))).ok)throw Error();V(`${n} will show again`,`success`)}catch{V(`Could not restore that domain`,`danger`);return}await ap(e)}}async function ap(e){try{let t=await(await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/install-activity`)).json().catch(()=>({}));if(!t.ok)return;z.install[e.guid]=t,zf(e)}catch(e){console.warn(`[magnets] install refresh failed:`,e)}}async function op(e){if(e.status===`DRAFT`){V(`Open Edit and Save to publish a draft magnet.`,`info`);return}let t=e.status===`ENABLED`?`DISABLED`:`ENABLED`;try{if(!(await(await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw Error();V(t===`ENABLED`?`Magnet enabled`:`Magnet disabled`,`success`)}catch{V(`Update failed`,`danger`);return}try{await Uf()}catch(e){console.warn(`[magnets] refresh after status toggle failed:`,e)}}async function sp(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`)){try{if(!(await(await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:`DELETE`})).json().catch(()=>({}))).ok)throw Error();V(`Magnet deleted`,`success`)}catch{V(`Delete failed`,`danger`);return}try{await Uf()}catch(e){console.warn(`[magnets] refresh after delete failed:`,e)}}}function cp(e){let t=[];e.querySelectorAll(`.mag-cta`).forEach(e=>{if(!e.querySelector(`.mag-cta__on`).checked)return;let n=e.dataset.type,r=e.dataset.kind,i=e.querySelector(`.mag-cta__val`),a=i?i.value.trim():``;if(r===`value`){if(n===`call`&&e.querySelector(`.mag-cta__callsrc`)?.value===`callrail`){let r=e.querySelector(`.mag-cta__crtracker`),i=r?.value||``,a=r?.selectedOptions?.[0];i&&t.push({type:n,value:i,config:{source:`callrail`,...a?.dataset?.trackerId?{tracker_id:a.dataset.trackerId}:{},...a?.dataset?.trackerName?{tracker_name:a.dataset.trackerName}:{}}})}else a&&t.push({type:n,value:a})}else if(r===`book`){if(e.querySelector(`.mag-cta__booksrc`)?.value===`calendly`){let r=e.querySelector(`.mag-cta__calevent`),i=r?.value||``,a=(r?.selectedOptions?.[0]?.textContent||``).trim();t.push({type:n,config:{source:`calendly`,...i?{calendly_url:i}:{},...i&&a?{event_name:a}:{}}})}else{let e={type:n};a&&(/^https?:\/\//i.test(a)?e.value=a:e.config={meeting_label:a}),t.push(e)}}else if(r===`support`){let r=(e.querySelector(`.mag-cta__opts`)?.value||``).split(`
`).map(e=>e.trim()).filter(Boolean).map(e=>({label:e})),i={type:n};r.length&&(i.config={options:r}),t.push(i)}else t.push({type:n})});let n={display_mode:e.querySelector(`input[name="mag-display"]:checked`)?.value||`chat`,trigger:rf(e),theme_mode:e.querySelector(`input[name="mag-theme"]:checked`)?.value||`auto`,title:e.querySelector(`#mag-f-title`).value.trim(),theme_color:e.querySelector(`#mag-f-color`).value,subtitle:e.querySelector(`#mag-f-subtitle`).value,launcher_label:e.querySelector(`#mag-f-launcher`).value.trim(),logo_url:e.querySelector(`#mag-f-logo`).value.trim(),logo_fit:e.querySelector(`#mag-f-logo-fit`)?.value===`contain`?`contain`:`cover`,summary:e.querySelector(`#mag-f-summary`).checked,summary_heading:e.querySelector(`#mag-f-summary-heading`).value.trim(),home:e.querySelector(`#mag-f-home`).checked,welcome:e.querySelector(`#mag-f-welcome`).value,ab:pp(e),actions:t,font:e.querySelector(`#mag-f-font`).value.trim(),theme_vars:dp(e),inline_width:e.querySelector(`#mag-f-inline-w`).value.trim(),inline_height:e.querySelector(`#mag-f-inline-h`).value.trim(),hide_launcher:e.querySelector(`#mag-f-hide-launcher`).checked,input_placeholder:e.querySelector(`#mag-f-input-ph`).value,summary_confirm_label:e.querySelector(`#mag-f-summary-confirm`).value.trim(),success_title:e.querySelector(`#mag-f-success-title`).value.trim(),success_text:e.querySelector(`#mag-f-success-text`).value,success_cta:fp(e)};return n.trigger===void 0&&delete n.trigger,n}function lp(e){return new Promise((t,n)=>{let r=new Image,i=new FileReader;i.onerror=()=>n(Error(`Could not read that file.`)),i.onload=()=>{r.onerror=()=>n(Error(`That file isn’t a readable image.`)),r.onload=()=>{let e=Math.min(1,Pp/Math.max(r.naturalWidth,r.naturalHeight)),n=Math.max(1,Math.round(r.naturalWidth*e)),i=Math.max(1,Math.round(r.naturalHeight*e)),a=document.createElement(`canvas`);a.width=n,a.height=i,a.getContext(`2d`).drawImage(r,0,0,n,i),t(a.toDataURL(`image/png`))},r.src=i.result},i.readAsDataURL(e)})}function up(e,t){let n=e.querySelector(`#mag-logo-drop`);if(!n)return;let r=e.querySelector(`#mag-f-logo-file`),i=e.querySelector(`#mag-logo-browse`),a=e.querySelector(`#mag-logo-remove`),o=e.querySelector(`#mag-logo-preview`),s=e.querySelector(`#mag-logo-status`),c=e.querySelector(`#mag-f-logo`),l=(e,t)=>{s.textContent=e,s.style.color=t?`var(--color-danger, #DD4124)`:``},u=e=>{o.innerHTML=e?`<img src="${B(e)}" alt="">`:`<span class="material-symbols-outlined" aria-hidden="true">image</span>`,a.hidden=!e},d=e=>{c.value=e,c.dispatchEvent(new Event(`input`,{bubbles:!0})),c.dispatchEvent(new Event(`change`,{bubbles:!0}))};async function f(e){if(!Fp.has(e.type)){l(`PNG, JPEG, GIF, or WEBP only.`,!0);return}if(e.size>Ip){l(`That file is too large (8MB max before resizing).`,!0);return}l(`Uploading…`,!1);try{let n=await lp(e),r=await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({image:n})}),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok)throw Error(i.error||`Upload failed (${r.status})`);let a=`${H()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;d(a),u(a),l(`Logo updated.`,!1)}catch(e){l(e.message||`Upload failed.`,!0)}}r.addEventListener(`change`,()=>{r.files[0]&&f(r.files[0]),r.value=``}),n.addEventListener(`click`,e=>{e.target===a||a.contains(e.target)||e.target!==i&&r.click()}),i.addEventListener(`click`,()=>r.click()),[`dragenter`,`dragover`].forEach(e=>n.addEventListener(e,e=>{e.preventDefault(),n.classList.add(`is-dragover`)})),[`dragleave`,`drop`].forEach(e=>n.addEventListener(e,e=>{e.preventDefault(),n.classList.remove(`is-dragover`)})),n.addEventListener(`drop`,e=>{let t=e.dataTransfer?.files?.[0];t&&f(t)}),a.addEventListener(`click`,async e=>{e.stopPropagation(),l(`Removing…`,!1);try{let e=await fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:`DELETE`}),n=await e.json().catch(()=>({}));if(!e.ok||!n.ok)throw Error(n.error||`Remove failed (${e.status})`);d(``),u(``),l(`Logo removed.`,!1)}catch(e){l(e.message||`Remove failed.`,!0)}})}function dp(e){return e.querySelector(`#mag-f-surface-on`)?.checked?{surface:e.querySelector(`#mag-f-sv-surface`).value,surface_2:e.querySelector(`#mag-f-sv-surface2`).value,border:e.querySelector(`#mag-f-sv-border`).value,text:e.querySelector(`#mag-f-sv-text`).value,text_sub:e.querySelector(`#mag-f-sv-textsub`).value}:{}}function fp(e){let t=e.querySelector(`#mag-f-success-cta-label`).value.trim(),n=e.querySelector(`#mag-f-success-cta-url`).value.trim();return t&&n?{label:t,url:n}:{}}function pp(e){let t={},n=e.querySelector(`#mag-f-ab-title`)?.value.trim(),r=e.querySelector(`#mag-f-ab-welcome`)?.value.trim(),i=e.querySelector(`#mag-f-ab-color`)?.value||``,a=e.querySelector(`#mag-f-color`)?.value||``;return n&&(t.title=n),r&&(t.welcome=r),i&&i.toLowerCase()!==a.toLowerCase()&&(t.theme_color=i),{enabled:!!e.querySelector(`#mag-f-ab`)?.checked,split:Number(e.querySelector(`#mag-f-ab-split`)?.value)||50,b:t}}function mp(e){let t=String(e||``),n=new Set(Lp.flatMap(e=>e.opts.map(([e])=>e))),r=e=>e===t?` selected`:``,i=`<option value=""${t===``?` selected`:``}>System default</option>`;t&&!n.has(t)&&(i+=`<option value="${B(t)}" selected>Current: ${B(t)}</option>`);for(let e of Lp)i+=`<optgroup label="${B(e.label)}">`+e.opts.map(([e,t])=>`<option value="${B(e)}"${r(e)}>${B(t)}</option>`).join(``)+`</optgroup>`;return i}function hp(e,t,n={}){let{freshDraft:r=!1}=n,i=!!e,a=i?null:crypto.randomUUID(),o=!i&&z.owners.length>1,s=e?.display_mode||`chat`,c=e?.theme_mode||`auto`,l={};(e?.actions||[]).forEach(e=>{e&&e.type&&(l[e.type]=e)});let u=!i||!!e.home,d=i?e.subtitle==null?``:e.subtitle:`Typically replies in a few minutes`,f=e?.theme_vars&&typeof e.theme_vars==`object`?e.theme_vars:{},m=Object.keys(f).length>0,ee=(e,t)=>B(/^#[0-9a-fA-F]{6}$/.test(f[e]||``)?f[e]:t),h=document.createElement(`div`);h.className=`mag-modal-scrim`,h.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${i?`Edit magnet`:`New magnet`}">
      ...
      <div class="mag-modal__main">
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${Ep.map(t=>`<option value="${t.value}"${ef(e)===t.value?` selected`:``}>${B(t.label)}</option>`).join(``)}
          <option value="__per_device"${ef(e)===`__per_device`?` selected`:``}>Per device&hellip;</option>
        </select>
        <div class="mag-perdev" id="mag-f-perdev"${ef(e)===`__per_device`?``:` hidden`}>
          <div class="mag-perdev__row">
            ...
            <select class="mag-modal__select" id="mag-f-trigger-desktop">
              ${Ep.map(t=>`<option value="${t.value}"${tf(e,`desktop`)===t.value?` selected`:``}>${B(t.label)}</option>`).join(``)}
            </select>
          </div>
          <div class="mag-perdev__row">
            <label class="mag-modal__label" for="mag-f-trigger-mobile">Mobile</label>
            <select class="mag-modal__select" id="mag-f-trigger-mobile">
              ${Ep.map(t=>`<option value="${t.value}"${tf(e,`mobile`)===t.value?` selected`:``}>${B(t.label)}</option>`).join(``)}
            </select>
          </div>
        ...
        <div class="mag-modal__sec">
          ...
          <input class="mag-modal__input" id="mag-f-subtitle" type="text" placeholder="Typically replies in a few minutes" value="${B(d)}">
    ...
    </div>`,document.body.appendChild(h),requestAnimationFrame(()=>{h.classList.add(`open`),h.querySelector(`.mag-modal`).classList.add(`open`)});let g=[...h.querySelectorAll(`.mag-modal__navitem`)],_=[...h.querySelectorAll(`.mag-tab`)],v=e=>{g.forEach(t=>t.classList.toggle(`is-active`,t.dataset.tab===e)),_.forEach(t=>{t.hidden=t.dataset.tab!==e}),h.querySelector(`.mag-modal__body`).scrollTop=0};g.forEach(e=>e.addEventListener(`click`,()=>v(e.dataset.tab)));let te=()=>Dd({...e,...cp(h),...i?{steps:Ju()}:{}}),y=h.querySelector(`#mag-preview-pane`),b=()=>window.matchMedia(`(min-width: 1200px)`).matches,ne=null,re=()=>{if(!ne&&b())try{ne=Md(y,te)}catch{}},ie=null,ae=()=>{b()&&(re(),ne&&(clearTimeout(ie),ie=setTimeout(()=>{try{ne.refresh()}catch{}},300)))},oe=window.matchMedia(`(min-width: 1200px)`),se=()=>{b()&&(re(),ae())};oe.addEventListener(`change`,se);let ce=!1,le=!1,ue=h.querySelector(`#mag-f-dirty`),de=e=>{ce=e,ue&&(ue.hidden=!e)},fe=h.querySelector(`.mag-modal__main`);fe.addEventListener(`input`,()=>de(!0)),fe.addEventListener(`change`,()=>{de(!0),nf(h),ae()}),nf(h),h.querySelector(`#mag-f-color`)?.addEventListener(`input`,()=>{de(!0),ae()});let pe=e=>{ce&&(e.preventDefault(),e.returnValue=``)};window.addEventListener(`beforeunload`,pe);let me=!0,he=gp.default.subscribe(p.ROUTE_NAV_BEFORE,()=>{if(me){if(ce&&!confirm(`Discard your changes to this magnet?`)){window.router?.navigate(`/magnets`);return}ge()}}),ge=()=>{r&&!le&&e&&e.status===`DRAFT`&&(fetch(`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:`DELETE`}).catch(()=>{}),z.magnets=z.magnets.filter(t=>t.guid!==e.guid),Hf(document.getElementById(`mag-body`))),me=!1,window.removeEventListener(`beforeunload`,pe),gp.default.unsubscribe(he),clearTimeout(ie),oe.removeEventListener(`change`,se),ne&&ne.destroy&&ne.destroy(),h.classList.remove(`open`),setTimeout(()=>h.remove(),180),document.removeEventListener(`keydown`,ve)},_e=()=>{ce&&!confirm(`Discard your changes to this magnet?`)||ge()};function ve(e){e.key===`Escape`&&(e.preventDefault(),_e())}document.addEventListener(`keydown`,ve),h.querySelector(`.mag-modal__close`).addEventListener(`click`,_e),h.querySelector(`[data-x="cancel"]`).addEventListener(`click`,_e),h.querySelector(`[data-close-modal]`)?.addEventListener(`click`,_e),h.querySelector(`#mag-f-name`).focus();let ye=h.querySelector(`#mag-flow-panel`);i?Bu(ye,e,()=>{de(!0),ae()}):ye.innerHTML=`<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>`,up(h,e),t&&v(t),re(),h.querySelectorAll(`.mag-cta`).forEach(e=>{let t=e.querySelector(`.mag-cta__on`),n=e.querySelector(`.mag-cta__val`),r=e.querySelector(`.mag-cta__opts`),i=e.querySelectorAll(`.mag-cta__booksrc, .mag-cta__calevent, .mag-cta__callsrc, .mag-cta__crtracker`);t.addEventListener(`change`,()=>{n&&(n.disabled=!t.checked),r&&(r.disabled=!t.checked),i.forEach(e=>{e.disabled=!t.checked}),t.checked&&(n||r)?.focus()}),n&&n.addEventListener(`input`,()=>{n.value.trim()&&!t.checked&&(t.checked=!0,r&&(r.disabled=!1))})}),h.querySelectorAll(`.mag-cta[data-kind="book"]`).forEach(e=>{let t=e.querySelector(`.mag-cta__booksrc`),n=e.querySelector(`.mag-cta__val`),r=e.querySelector(`.mag-cta__calevent`);if(!t||!r)return;let i=()=>{let e=t.value===`calendly`;n.hidden=e,r.hidden=!e,e&&!r.dataset.listed&&(r.dataset.listed=`1`,cf(r))};t.addEventListener(`change`,()=>{let t=e.querySelector(`.mag-cta__on`);t.checked||(t.checked=!0,t.dispatchEvent(new Event(`change`))),i()}),i()}),h.querySelectorAll(`.mag-cta[data-type="call"]`).forEach(e=>{let t=e.querySelector(`.mag-cta__callsrc`),n=e.querySelector(`.mag-cta__val`),r=e.querySelector(`.mag-cta__crtracker`);if(!t||!r)return;let i=()=>{let e=t.value===`callrail`;n.hidden=e,r.hidden=!e,e&&!r.dataset.listed&&(r.dataset.listed=`1`,uf(r))};t.addEventListener(`change`,()=>{let t=e.querySelector(`.mag-cta__on`);t.checked||(t.checked=!0,t.dispatchEvent(new Event(`change`))),i()}),i()});let be=h.querySelector(`#mag-f-surface-on`),xe=h.querySelector(`#mag-f-surface`);be.addEventListener(`change`,()=>xe.hidden=!be.checked);let Se=h.querySelector(`#mag-f-inline-size`);h.querySelectorAll(`input[name="mag-display"]`).forEach(e=>e.addEventListener(`change`,()=>{Se.hidden=h.querySelector(`input[name="mag-display"]:checked`)?.value!==`inline`})),h.querySelector(`[data-x="preview"]`)?.addEventListener(`click`,()=>Nd(()=>Dd({...e,...cp(h),...i?{steps:Ju()}:{}}))),h.querySelector(`[data-x="save"]`).addEventListener(`click`,async t=>{let n=t.currentTarget,r=h.querySelector(`#mag-f-error`),s=h.querySelector(`#mag-f-name`).value.trim();if(!s){v(`basics`),r.textContent=`Please give your magnet a name.`;return}let c=h.querySelector(`#mag-f-domains`).value.split(`,`).map(e=>e.trim()).filter(Boolean),l=``;if(h.querySelectorAll(`.mag-cta`).forEach(e=>{let t=e.querySelector(`.mag-cta__on`).checked;if(e.dataset.kind===`book`){let n=e.querySelector(`.mag-cta__booksrc`)?.value===`calendly`;t&&n&&!e.querySelector(`.mag-cta__calevent`)?.value&&(l||=`Pick a Calendly event for the Book button, or switch it back to the built-in scheduler.`);return}if(e.dataset.kind!==`value`)return;if(e.dataset.type===`call`&&e.querySelector(`.mag-cta__callsrc`)?.value===`callrail`){t&&!e.querySelector(`.mag-cta__crtracker`)?.value&&(l||=`Pick a CallRail tracking number for the Call button, or switch it back to a phone number.`);return}let n=e.querySelector(`.mag-cta__val`).value.trim();t&&!n&&(l||=`Add a target for the ${Dp[e.dataset.type].label} button, or uncheck it.`)}),l){v(`welcome`),r.textContent=l;return}let u=pp(h);if(u.enabled&&!Object.keys(u.b).length){v(`ab`),r.textContent=`Give variant B at least one change (title, welcome, or color), or untick the A/B test.`;return}if(i){let e=Wu();if(e){v(`flow`),r.textContent=e.message,Gu(e.route,e.message,{uid:e.uid,field:e.field});return}}let d={name:s,domains:c,...cp(h)};o&&(d.owner_guid=h.querySelector(`#mag-f-owner`).value);let f=i&&e.status===`DRAFT`;f&&(d.status=`ENABLED`),n.disabled=!0,r.textContent=``;try{let t=i?`${H()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${H()}/m5t/v5/magnets`,n={"Content-Type":`application/json`};a&&(n[`Idempotency-Key`]=a);let r=await fetch(t,{method:i?`PATCH`:`POST`,headers:n,body:JSON.stringify(d)}),o={};try{o=await r.json()}catch{}if(!r.ok||!o.ok)throw Error(o.message||`Save failed (${r.status})`);i&&await qu(e.guid),V(f||!i?`Magnet created`:`Magnet updated`,`success`),le=!0,ge(),await Uf()}catch(e){n.disabled=!1,r.textContent=e.message||`Something went wrong.`}})}var gp,_p,z,vp,B,V,H,yp,bp,xp,Sp,Cp,wp,Tp,Ep,Dp,Op,kp,Ap,jp,Mp,Np,Pp,Fp,Ip,Lp,Rp=o((()=>{T(),gp=u(f(),1),m(),wd(),Fd(),ua(),Qd(),Zt(),_p=!1,z={magnets:[],owners:[],canProvision:!1,canManage:!1,primaryOrgGuid:null,stats:{},install:{},connections:{},pairing:{},pairTimer:null,detailOpen:{}},vp={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},B=e=>String(e??``).replace(/[&<>"']/g,e=>vp[e]),V=(e,t=`info`)=>{try{gp.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},H=()=>w.getConfig?.().BASE_URL||``,yp=e=>`<script src="${H()}/m5t/v5/coreSnippet?appguid=${e}" async><\/script>`,bp=()=>`<details class="mag-csp-note">
  ...
  <div class="mag-csp-note__body">
    <p>A strict CSP can silently block the widget — it just never appears, no visible error. Allowlist <code>${B(H())}</code> under all three directives. Copy-paste ready for your CSP header/meta tag:</p>
    <pre class="mag-csp-note__snippet"><code>script-src 'self' ${B(H())};
connect-src 'self' ${B(H())};
img-src 'self' ${B(H())};</code></pre>
    <ul>
...
</details>`,xp=e=>{let t=B(yp(e));return`<details class="mag-guide">
...
&lt;Script
  src="${B(H())}/m5t/v5/coreSnippet?appguid=${B(e)}"
...
/&gt;</code></pre>
...
</details>`},Sp={chat:`Chat bubble`,right_slide:`Slide-in panel`,modal:`Modal`,inline:`Inline`},Cp={chat:`chat`,right_slide:`vertical_split`,modal:`web_asset`,inline:`view_agenda`},wp=[{value:`inline`,icon:`view_agenda`,label:`Inline`},{value:`chat`,icon:`chat`,label:`Chat`},{value:`right_slide`,icon:`vertical_split`,label:`Slide`},{value:`modal`,icon:`web_asset`,label:`Modal`}],Tp=[{value:`auto`,icon:`brightness_auto`,label:`Auto`},{value:`sync`,icon:`sync`,label:`Sync`},{value:`light`,icon:`light_mode`,label:`Light`},{value:`dark`,icon:`dark_mode`,label:`Dark`}],Ep=[{value:`on_load`,label:`Immediately on page load`},{value:`on_8_seconds`,label:`After 8 seconds`},{value:`on_scroll_80_percent`,label:`At 80% scroll depth`},{value:`on_exit_intent`,label:`On exit intent (mouse leaves the page)`},{value:`none`,label:`Manual only (visitor clicks the launcher)`}],Dp={book:{label:`Book`,icon:`event`,kind:`book`},chat:{label:`Chat`,icon:`chat`,kind:`flow`},call:{label:`Call`,icon:`phone`,kind:`value`,placeholder:`Phone number`},email:{label:`Email`,icon:`mail`,kind:`value`,placeholder:`Email address`},support:{label:`Support`,icon:`support_agent`,kind:`support`}},Op=[`book`,`chat`,`call`,`email`,`support`],kp=null,Ap=null,jp=5e3,Mp={ACTIVE:{label:`Connected`,icon:`check_circle`,tone:`live`},PENDING:{label:`Waiting to connect`,icon:`hourglass_empty`,tone:`pending`},REVOKED:{label:`Disconnected`,icon:`link_off`,tone:`off`},EXPIRED:{label:`Expired`,icon:`timer_off`,tone:`off`}},Np=!1,Pp=512,Fp=new Set([`image/png`,`image/jpeg`,`image/gif`,`image/webp`]),Ip=8388608,Lp=[{label:`Web fonts (loaded for you)`,opts:[[`Inter, sans-serif`,`Inter`],[`Poppins, sans-serif`,`Poppins`],[`Montserrat, sans-serif`,`Montserrat`],[`Roboto, sans-serif`,`Roboto`],[`"Open Sans", sans-serif`,`Open Sans`],[`Lato, sans-serif`,`Lato`],[`Nunito, sans-serif`,`Nunito`],[`Raleway, sans-serif`,`Raleway`],[`"Work Sans", sans-serif`,`Work Sans`],[`Oswald, sans-serif`,`Oswald`],[`Merriweather, serif`,`Merriweather (serif)`]]},{label:`System / always available`,opts:[[`system-ui, sans-serif`,`System UI`],[`Georgia, serif`,`Georgia (serif)`],[`"Times New Roman", Times, serif`,`Times (serif)`],[`Arial, Helvetica, sans-serif`,`Arial / Helvetica`],[`Verdana, Geneva, sans-serif`,`Verdana`],[`"Courier New", monospace`,`Courier (mono)`]]}]})),zp=c({default:()=>Xp,init:()=>Up,render:()=>Hp});function Bp(){let e=new Map;for(let t of Jd)e.set(t.category,(e.get(t.category)||0)+1);return Object.keys(qd).filter(t=>e.has(t)).map(t=>[t,e.get(t)])}function Vp(){if(Ud(),Yp)return;let e=document.createElement(`style`);e.id=`m5t-templates-page-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Yp=!0}function Hp(){Vp();let e=qp();return`
    <div class="page-shell" data-section="templates">
      ...
      <div class="m5t-chip-row tpl-filters" id="tpl-filters" role="group" aria-label="Filter templates by category">
        ${Jp(`all`,`All`,Jd.length,`true`)}
        ${Bp().map(([e,t])=>Jp(e,qd[e],t,`false`)).join(``)}
      </div>

      <div class="mag-tpl-grid mag-tpl-grid--page" id="tpl-grid">
        ${Jd.map(t=>Rd(t,{detail:!0,gallery:!0,canUse:e})).join(``)}
      </div>
    </div>`}function Up(){let e=document.getElementById(`tpl-grid`);document.getElementById(`tpl-filters`)?.addEventListener(`click`,t=>{let n=t.target.closest(`[data-cat]`);if(!n)return;n.parentElement.querySelectorAll(`[data-cat]`).forEach(e=>{e.setAttribute(`aria-pressed`,String(e===n))});let r=n.dataset.cat;e?.querySelectorAll(`.mag-tpl-card`).forEach(e=>{e.hidden=r!==`all`&&e.dataset.cat!==r})}),e?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-preview]`);if(t){let e=Jd.find(e=>e.id===t.dataset.preview);e&&Nd(()=>Dd({...e.appearance,steps:e.steps,name:e.name}));return}let n=e.target.closest(`[data-tpl]`);n&&(zd(n.dataset.tpl),window.location.hash=`#/magnets`)})}var Wp,Gp,Kp,qp,Jp,Yp,Xp,Zp=o((()=>{T(),Fd(),Qd(),Wp={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Gp=e=>String(e??``).replace(/[&<>"']/g,e=>Wp[e]),Kp=[`provision_magnets`,`manage_magnets`],qp=()=>w.getCapabilities().some(e=>Kp.includes(e)),Jp=(e,t,n,r)=>`<button class="m5t-chip--filter" type="button" data-cat="${Gp(e)}" aria-pressed="${r}">${Gp(t)}<span class="m5t-chip__count">${n}</span></button>`,Yp=!1,Xp={render:Hp,init:Up}})),Qp=c({default:()=>Sm,init:()=>im,render:()=>rm});function $p(){if(nr(),ym)return;let e=document.createElement(`style`);e.id=`m5t-questionnaires-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),ym=!0}function em(){return U.clients.map(e=>{let t=U.responses.filter(t=>t.owner_guid===e.guid),n=t[0]||null;return{guid:e.guid,name:e.caption||e.name||e.guid,latest:n,earlier:Math.max(0,t.length-1),status:n?n.status:`NOT_SENT`}})}function tm(){let e=U.search.trim().toLowerCase();return em().filter(t=>(U.filter===`ALL`||t.status===U.filter)&&(!e||t.name.toLowerCase().includes(e)))}function nm(e){let t=e.status===`SUBMITTED`,n=e.status===`SUBMITTED`?`<button class="qz-act" type="button" data-act="open" data-guid="${pm(e.latest.guid)}">Read answers</button>`:e.status===`DRAFT`?`<button class="qz-act" type="button" data-act="copy" data-url="${pm(e.latest.url||``)}">Copy link</button>`:`<a class="qz-act" href="#/clients">Go to client</a>`;return`<tr class="qz-row${t?` qz-row--open`:``}"${t?` data-open-guid="${pm(e.latest.guid)}"`:``}>
    <td><span class="qz-client">${pm(e.name)}</span>${e.earlier?`<span class="qz-earlier">${e.earlier} earlier</span>`:``}</td>
    <td><span class="qz-badge" data-s="${pm(e.status)}">${pm(vm[e.status]||e.status)}</span></td>
    <td class="qz-when">${pm(xm(e,`created_tz`))}</td>
    <td class="qz-when">${pm(xm(e,`submitted_tz`))}</td>
    <td class="qz-actcell">${n}</td>
  </tr>`}function rm(){return $p(),`
    <div class="page-shell" data-section="questionnaires">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="qz-body">${bm(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function im(){await am()}async function am(){let e=document.getElementById(`qz-body`);if(e){try{let[e,t]=await Promise.all([fetch(`${mm()}/m5t/v5/acctGroup`),fetch(`${mm()}/m5t/v5/m5mQuestionnaireResponse`)]),n=await e.json().catch(()=>({})),r=await t.json().catch(()=>({}));if(!e.ok||!t.ok)throw Error(`load failed`);U.clients=(n.data||[]).filter(e=>e.class===gm&&![`DELETED`,`ARCHIVED`].includes(e.status)).sort((e,t)=>String(e.caption||``).localeCompare(String(t.caption||``))),U.responses=r.data||[]}catch{e.innerHTML=bm(`error`,`Could not load questionnaires. Please try again.`);return}sm()}}function om(){let e=document.getElementById(`qz-tbody`);e&&Yt(e,{rowSelector:`tr.qz-row`,noun:`clients`,controlHost:e.closest(`.qz-tablewrap`)||e.parentElement})}function sm(){let e=document.getElementById(`qz-body`);if(!e)return;if(!U.clients.length){e.innerHTML=bm(`groups`,`No clients yet. Add a client first, then send them a kickoff questionnaire.`);return}let t=em(),n={ALL:t.length};_m.slice(1).forEach(([e])=>{n[e]=t.filter(t=>t.status===e).length});let r=tm();e.innerHTML=`
    <div class="qz-bar">
      <div class="qz-filter">
        ${_m.map(([e,t])=>`<button data-filter="${e}" class="${U.filter===e?`active`:``}">${pm(t)}${n[e]?`<span class="qz-pillnum">${n[e]}</span>`:``}</button>`).join(``)}
      </div>
      <span class="qz-searchwrap">
        <span class="material-symbols-outlined" aria-hidden="true">search</span>
        <input class="qz-search" id="qz-search" type="search" placeholder="Search clients" value="${pm(U.search)}" aria-label="Search clients" />
      </span>
    ...
    <div class="qz-tablewrap">
      <table class="qz-table">
        ...
        <tbody id="qz-tbody">${r.length?r.map(nm).join(``):`<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">${U.search.trim()?`No clients match your search.`:`No clients with status “${pm(vm[U.filter]||U.filter)}”.`}</div></td></tr>`}</tbody>
      </table>
    </div>`,om(),e.querySelector(`.qz-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(U.filter=t.dataset.filter,sm())}),e.querySelector(`#qz-search`)?.addEventListener(`input`,e=>{U.search=e.target.value,cm()}),e.querySelector(`#qz-tbody`)?.addEventListener(`click`,lm)}function cm(){let e=document.getElementById(`qz-tbody`);if(!e)return;let t=tm();e.innerHTML=t.length?t.map(nm).join(``):`<tr><td colspan="5"><div class="qz-when" style="padding:14px 4px">No clients match your search.</div></td></tr>`,om();let n=document.querySelector(`.qz-count`);n&&(n.textContent=`${t.length} of ${em().length}`)}function lm(e){let t=e.target.closest(`[data-act="copy"]`);if(t){e.stopPropagation();let n=t.dataset.url;if(!n){hm(`No link on this questionnaire yet.`,`warning`);return}navigator.clipboard?.writeText(n).then(()=>{t.textContent=`Copied!`,setTimeout(()=>{t.textContent=`Copy link`},1500)},()=>hm(`Could not copy the link.`,`error`));return}let n=e.target.closest(`[data-act="open"]`),r=e.target.closest(`[data-open-guid]`),i=n?.dataset.guid||r?.dataset.openGuid;i&&um(i)}async function um(e){U.openGuid=e;let t=document.createElement(`div`);t.className=`qz-drawer-scrim`;let n=document.createElement(`aside`);n.className=`qz-drawer`,n.setAttribute(`role`,`dialog`),n.setAttribute(`aria-label`,`Questionnaire answers`),n.innerHTML=`
    ...
    <div class="qz-drawer__body" id="qz-dbody">${bm(`hourglass_empty`,`Loading answers…`)}</div>`,document.body.append(t,n),requestAnimationFrame(()=>{t.classList.add(`open`),n.classList.add(`open`)});let r=()=>{U.openGuid=null,t.classList.remove(`open`),n.classList.remove(`open`),setTimeout(()=>{t.remove(),n.remove()},220),document.removeEventListener(`keydown`,i)};function i(e){e.key===`Escape`&&(e.preventDefault(),r())}document.addEventListener(`keydown`,i),t.addEventListener(`click`,r),n.querySelector(`.qz-drawer__close`).addEventListener(`click`,r);try{let t=await fetch(`${mm()}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e)}`),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`load failed`);let i=r.data||{},a=U.clients.find(e=>e.guid===i.owner_guid)?.caption||`Client`;n.querySelector(`#qz-dtitle`).textContent=a;let o=i.submitted_tz?`Submitted ${D(i.submitted_tz)}`:`Not yet submitted`;n.querySelector(`#qz-dsub`).textContent=i.locked_tz?`${o} · Finalized`:o,n.querySelector(`#qz-dbody`).innerHTML=tr(i)+Qn(i,{emptyLabel:`Not answered`})}catch{n.querySelector(`#qz-dbody`).innerHTML=bm(`error`,`Could not load these answers. Please try again.`)}}var dm,fm,pm,mm,hm,gm,_m,vm,U,ym,bm,xm,Sm,Cm=o((()=>{T(),dm=u(f(),1),m(),or(),Zt(),fm={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},pm=e=>String(e??``).replace(/[&<>"']/g,e=>fm[e]),mm=()=>w.getConfig?.().BASE_URL||``,hm=(e,t=`info`)=>{try{dm.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},gm=`managed_client`,_m=[[`ALL`,`All`],[`NOT_SENT`,`Not sent`],[`DRAFT`,`Awaiting response`],[`SUBMITTED`,`Submitted`],[`CANCELLED`,`Cancelled`]],vm=Object.fromEntries(_m),U={clients:[],responses:[],filter:`ALL`,search:``,openGuid:null},ym=!1,bm=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,xm=(e,t)=>e?.latest?.[t]?D(e.latest[t]):`—`,Sm={render:rm,init:im}})),wm=c({default:()=>ih,init:()=>Am,render:()=>km});function Tm(){if(nr(),eh)return;let e=document.createElement(`style`);e.id=`m5t-deliverables-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),eh=!0}function Em(){let e=K.search.trim().toLowerCase();return K.rows.filter(t=>(K.filter===`ALL`||t.status===K.filter)&&(!e||String(t.owner_name||``).toLowerCase().includes(e)))}function Dm(e){return e.status===`DRAFT`?`<button class="dz-act" type="button" data-act="open" data-guid="${W(e.guid)}">Edit</button>`:e.status===`SENT`?`<button class="dz-act" type="button" data-act="copy" data-url="${W(e.url||``)}">Copy link</button>`:e.status===`SUBMITTED`?`<button class="dz-act" type="button" data-act="open" data-guid="${W(e.guid)}">Read review</button>`:`<span class="dz-when">—</span>`}function Om(e){let t=e.status!==`CANCELLED`;return`<tr class="dz-row${t?` dz-row--open`:``}"${t?` data-open-guid="${W(e.guid)}"`:``}>
    ...
    <td><span class="dz-badge" data-s="${W(e.status)}">${W($m[e.status]||e.status)}</span></td>
    <td class="dz-when">${e.sent_tz?W(D(e.sent_tz)):`—`}</td>
    <td class="dz-when">${e.submitted_tz?W(D(e.submitted_tz)):`—`}</td>
    <td class="dz-actcell">${Dm(e)}</td>
  </tr>`}function km(){return Tm(),`
    <div class="page-shell" data-section="deliverables">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="dz-body">${th(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function Am(){document.getElementById(`dz-new`)?.addEventListener(`click`,Lm),await jm()}async function jm(){let e=document.getElementById(`dz-body`);if(e){try{let[e,t,n]=await Promise.all([fetch(`${Xm()}/m5t/v5/m5mDeliverable`),fetch(`${Xm()}/m5t/v5/acctGroup`),fetch(`${Xm()}/m5t/v5/m5mDeliverable/templates`)]),r=await e.json().catch(()=>({})),i=await t.json().catch(()=>({})),a=await n.json().catch(()=>({}));if(!e.ok||!t.ok||!n.ok)throw Error(`load failed`);K.rows=r.data||[],K.clients=(i.data||[]).filter(e=>e.class===Zm&&![`DELETED`,`ARCHIVED`].includes(e.status)).sort((e,t)=>String(e.caption||``).localeCompare(String(t.caption||``))),K.templates=a.data||[]}catch{e.innerHTML=th(`error`,`Could not load deliverables. Please try again.`);return}Nm()}}function Mm(){let e=document.getElementById(`dz-tbody`);e&&Yt(e,{rowSelector:`tr.dz-row`,noun:`deliverables`,controlHost:e.closest(`.dz-tablewrap`)||e.parentElement})}function Nm(){let e=document.getElementById(`dz-body`);if(!e)return;if(!K.clients.length&&!K.rows.length){e.innerHTML=th(`groups`,`No clients yet. Add a client first, then author their first deliverable.`);return}if(!K.rows.length){e.innerHTML=th(`approval`,`No deliverables yet. Author the first one with New deliverable.`);return}let t={ALL:K.rows.length};Qm.slice(1).forEach(([e])=>{t[e]=K.rows.filter(t=>t.status===e).length});let n=Em();e.innerHTML=`
    <div class="dz-bar">
      <div class="dz-filter">
        ${Qm.map(([e,n])=>`<button data-filter="${e}" class="${K.filter===e?`active`:``}">${W(n)}${t[e]?`<span class="dz-pillnum">${t[e]}</span>`:``}</button>`).join(``)}
      </div>
    ...
    <div class="dz-tablewrap">
      <table class="dz-table">
        ...
        <tbody id="dz-tbody">${n.length?n.map(Om).join(``):`<tr><td colspan="6"><div class="dz-when" style="padding:14px 4px">${K.search.trim()?`No deliverables match your search.`:`No deliverables with status “${W($m[K.filter]||K.filter)}”.`}</div></td></tr>`}</tbody>
      </table>
    </div>`,Mm(),e.querySelector(`.dz-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(K.filter=t.dataset.filter,Nm())}),e.querySelector(`#dz-search`)?.addEventListener(`input`,e=>{K.search=e.target.value,Pm()}),e.querySelector(`#dz-tbody`)?.addEventListener(`click`,Fm)}function Pm(){let e=document.getElementById(`dz-tbody`);if(!e)return;let t=Em();e.innerHTML=t.length?t.map(Om).join(``):`<tr><td colspan="6"><div class="dz-when" style="padding:14px 4px">No deliverables match your search.</div></td></tr>`,Mm();let n=document.querySelector(`.dz-count`);n&&(n.textContent=`${t.length} of ${K.rows.length}`)}function Fm(e){let t=e.target.closest(`[data-act="copy"]`);if(t){e.stopPropagation();let n=t.dataset.url;if(!n){G(`No link on this deliverable yet.`,`warning`);return}navigator.clipboard?.writeText(n).then(()=>{t.textContent=`Copied!`,setTimeout(()=>{t.textContent=`Copy link`},1500)},()=>G(`Could not copy the link.`,`error`));return}let n=e.target.closest(`[data-act="open"]`),r=e.target.closest(`[data-open-guid]`),i=n?.dataset.guid||r?.dataset.openGuid;i&&qm(i)}function Im(e){let t=document.createElement(`div`);t.className=`dz-drawer-scrim`;let n=document.createElement(`aside`);n.className=`dz-drawer`,n.setAttribute(`role`,`dialog`),n.setAttribute(`aria-label`,e),n.innerHTML=`
    ...
    <div class="qm-qa" data-question-id="${W(e.id)}" data-question-type="${W(e.type)}">
      ...
      <div class="qm-qa__a">${$n(e,t)}</div>
    </div>`}function zm(e,t,n,{hidden:r=!1}={}){let i=`${t}: `,a=e[0]?.group||``;return`
      <div class="dz-cblock" data-group="${W(a)}" data-heading="${W(t)}"${r?` hidden`:``}>
        <h4 class="dz-cblock__title">${W(t)}</h4>
        ${e.map(e=>Rm(e,n,e.label.startsWith(i)?e.label.slice(i.length):e.label)).join(``)}
      </div>`}function Bm(e,t){let n=(e.questions||[]).filter(e=>e.audience===`am`),r=n.filter(e=>!e.group).map(e=>Rm(e,t)).join(``),i=wr(e);if(i){let n=Tr(e).filter(e=>e.audience===`am`);if(!n.length)return r;let a=Or(e,t);for(let e=1;e<=a;e++){let a=Er(n,i,e);r+=zm(a,rh(a,`${i}${e}`),t)}let o=rh(Er(n,i,a+1),`${i}${a+1}`);return r+=`<button class="dz-btn--ghost dz-addblock" type="button" data-repeat="${W(i)}" data-section-id="${W(e.id)}">+ Add ${W(o)}</button>`,r}let a=[...new Set(n.filter(e=>e.group).map(e=>e.group))];if(!a.length)return r;let o=null;return r+=a.map((e,r)=>{let i=n.filter(t=>t.group===e),a=rh(i,e),s=r===0||nh(i,t);return!s&&o===null&&(o={key:e,heading:a}),zm(i,a,t,{hidden:!s})}).join(``),r+=`<button class="dz-btn--ghost dz-addblock" type="button"${o?``:` hidden`}>${o?`+ Add ${W(o.heading)}`:``}</button>`,r}function Vm(e,t){let n=(e?.sections||[]).filter(e=>(e.questions||[]).some(e=>e.audience===`am`)),r=n.length>1;return`
    ${r?`
    ...
    ${r?`
      ...
      </div>`:``}`}function Hm(e,t,n){e.querySelectorAll(`.dz-addblock`).forEach(e=>{e.addEventListener(`click`,()=>{let n=e.parentElement;if(e.dataset.repeat){let r=Tr((t?.sections||[]).find(t=>t.id===e.dataset.sectionId)).filter(e=>e.audience===`am`);if(!r.length)return;let i=e.dataset.repeat,a=n.querySelectorAll(`.dz-cblock`).length+1,o=Er(r,i,a);e.insertAdjacentHTML(`beforebegin`,zm(o,rh(o,`${i}${a}`),{}));let s=Er(r,i,a+1);e.textContent=`+ Add ${rh(s,`${i}${a+1}`)}`;return}let r=[...n.querySelectorAll(`.dz-cblock[hidden]`)],i=r[0];i&&(i.hidden=!1);let a=r[1];a?e.textContent=`+ Add ${a.dataset.heading}`:e.hidden=!0})});let r=[...e.querySelectorAll(`.dz-step`)];if(r.length<=1)return;let i=[...e.querySelectorAll(`.dz-dot`)],a=e.querySelector(`#dz-step-label`),o=e.querySelector(`#dz-step-back`),s=e.querySelector(`#dz-step-next`),c=e.querySelector(`#dz-step-prev`),l=e.querySelector(`#dz-step-fwd`),u=0,d=t=>{u=Math.max(0,Math.min(r.length-1,t)),r.forEach((e,t)=>{e.hidden=t!==u}),i.forEach((e,t)=>{t===u?e.setAttribute(`aria-current`,`step`):e.removeAttribute(`aria-current`)}),a&&(a.textContent=`Step ${u+1} of ${r.length} · ${r[u].querySelector(`h3`)?.textContent||``}`),o.style.visibility=u===0?`hidden`:``,s.style.visibility=u===r.length-1?`hidden`:``,c&&(c.disabled=u===0),l&&(l.disabled=u===r.length-1),e.scrollIntoView?.({block:`start`})},f=e=>{d(e),n?.()};o.addEventListener(`click`,()=>f(u-1)),s.addEventListener(`click`,()=>f(u+1)),c?.addEventListener(`click`,()=>f(u-1)),l?.addEventListener(`click`,()=>f(u+1)),i.forEach(e=>e.addEventListener(`click`,()=>f(Number(e.dataset.step)||0))),d(0)}function Um(e,t,n){return kr(e?.sections||[],t,n).map(e=>{let r=(e.questions||[]).filter(e=>{if(e.audience!==`am`)return!0;let n=t?.[e.id];return Array.isArray(n)?n.length>0:!!(n&&String(n).trim())});return r.length?`
      <div class="qm-section">
        <h3>${W(e.title)}</h3>
        ${r.map(e=>`
          <div class="qm-qa">
            <div class="qm-qa__q">${W(e.label)}</div>
            <div class="qm-qa__a">${e.audience===`am`?Zn(e,t):Zn(e,n)||`<span class="qm-qa__a--empty">Left blank</span>`}</div>
          </div>`).join(``)}
      </div>`:``}).join(``)}function Wm(e,t){if(!t)return``;let n=(e?.sections||[]).flatMap(e=>(e.questions||[]).filter(e=>e.audience!==`am`)).map(e=>({q:e,val:Zn(e,t.answers||{})})).filter(({val:e})=>e);return`
    ...
    </div>`}function Gm(e,t){let n=Array.isArray(t)&&t.length?t[t.length-1]:null;return n?Wm(e,n):``}function Km(e,t){return(Array.isArray(t)?t.slice().reverse():[]).map(t=>Wm(e,t)).join(``)}async function qm(e){let{drawer:t,close:n}=Im(`Deliverable`),r=t.querySelector(`#dz-dbody`),i=t.querySelector(`#dz-dfoot`),a;try{let t=await fetch(`${Xm()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}`),n=await t.json().catch(()=>({}));if(!t.ok||!n.ok)throw Error(n.error||`load failed`);a=n.data||{}}catch{r.innerHTML=th(`error`,`Could not load this deliverable. Please try again.`);return}let o=K.rows.find(t=>t.guid===e)?.owner_name||K.clients.find(e=>e.guid===a.owner_guid)?.caption||`Client`;t.querySelector(`#dz-dtitle`).textContent=`${o} · ${a.template?.name||`Deliverable`}`;let s=a.status===`DRAFT`||a.status===`SENT`,c=Number(a.revision)>1?` · Rev ${a.revision}`:``,l=a.status===`SUBMITTED`?`Returned ${a.submitted_tz?D(a.submitted_tz):``}${a.locked_tz?` · Finalized`:``}${c}`:a.status===`SENT`?`Sent ${a.sent_tz?D(a.sent_tz):``} to ${a.recipient_email||``} · awaiting approval${c}`:`${$m[a.status]||a.status}${c}`;if(t.querySelector(`#dz-dsub`).textContent=l,!s){r.innerHTML=tr(a)+Um(a.template,a.content||{},a.answers||{})+Km(a.template,a.rounds),a.status===`SUBMITTED`&&!a.locked_tz?(i.innerHTML=`<button class="dz-btn" type="button" id="dz-revise">Revise plan</button>
        <span class="dz-note" style="margin:0">Archives this review and reopens authoring. The client approves the revised plan on a fresh link.</span>`,i.querySelector(`#dz-revise`).addEventListener(`click`,async t=>{let r=t.target;r.disabled=!0;try{let t=await fetch(`${Xm()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}/revise`,{method:`POST`}),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`revise failed`);G(`Reopened for revision. The last review is pinned above the form.`,`success`),n(),await jm(),qm(e)}catch(e){G(e.message||`Could not revise.`,`error`),r.disabled=!1}})):i.innerHTML=``;return}r.innerHTML=`
    ${Gm(a.template,a.rounds)}
    ${a.url?`
    ...
    <div id="dz-author-form">${Vm(a.template,a.content||{})}</div>`,i.innerHTML=`
    ...
    <button class="dz-btn--ghost dz-btn--danger" type="button" id="dz-cancel">Cancel deliverable</button>`,r.querySelector(`#dz-copylink`)?.addEventListener(`click`,e=>{let t=r.querySelector(`.dz-linkrow input`);navigator.clipboard?.writeText(t?.value||``).then(()=>{e.target.textContent=`Copied!`,setTimeout(()=>{e.target.textContent=`Copy link`},1500)},()=>G(`Could not copy the link.`,`error`))});let u=async()=>{let t=er(r.querySelector(`#dz-author-form`)),i=await fetch(`${Xm()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({content:t})}),a=await i.json().catch(()=>({}));if(!i.ok||!a.ok){if(i.status===409)return G(a.error||`This deliverable is no longer editable.`,`warning`),n(),await jm(),!1;throw Error(a.error||`save failed`)}return!0};Hm(r.querySelector(`#dz-author-form`),a.template,()=>{u().catch(()=>G(`Autosave failed. Use Save draft.`,`warning`))}),i.querySelector(`#dz-preview`).addEventListener(`click`,async e=>{let t=e.target.closest(`button`);if(!a.url){G(`No link available for this deliverable.`,`warning`);return}t.disabled=!0;try{await u()&&window.open(a.url,`_blank`)}catch(e){G(e.message||`Could not save before previewing.`,`error`)}t.disabled=!1}),i.querySelector(`#dz-save`).addEventListener(`click`,async e=>{let t=e.target;t.disabled=!0;try{await u()&&G(`Draft saved.`,`success`)}catch(e){G(e.message||`Could not save.`,`error`)}t.disabled=!1}),i.querySelector(`#dz-send`).addEventListener(`click`,async t=>{let r=t.target,a=(i.querySelector(`#dz-email`)?.value||``).trim();if(!a){G(`Enter the recipient email first.`,`warning`);return}r.disabled=!0;try{if(!await u())return;let t=await fetch(`${Xm()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}/send`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({recipient_email:a})}),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`send failed`);G(r.data?.emailQueued?`Sent. ${a} will receive the review link.`:`Link created, but the email could not be queued. Copy the link and send it yourself.`,r.data?.emailQueued?`success`:`warning`),n(),await jm()}catch(e){G(e.message||`Could not send.`,`error`),r.disabled=!1}}),i.querySelector(`#dz-cancel`).addEventListener(`click`,async t=>{let r=t.target;r.disabled=!0;try{let t=await fetch(`${Xm()}/m5t/v5/m5mDeliverable/${encodeURIComponent(e)}/cancel`,{method:`POST`}),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`cancel failed`);G(`Deliverable cancelled. Its link no longer works.`,`info`),n(),await jm()}catch(e){G(e.message||`Could not cancel.`,`error`),r.disabled=!1}})}var Jm,Ym,W,Xm,G,Zm,Qm,$m,K,eh,th,nh,rh,ih,ah=o((()=>{T(),Jm=u(f(),1),m(),or(),Mr(),Zt(),Ym={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},W=e=>String(e??``).replace(/[&<>"']/g,e=>Ym[e]),Xm=()=>w.getConfig?.().BASE_URL||``,G=(e,t=`info`)=>{try{Jm.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Zm=`managed_client`,Qm=[[`ALL`,`All`],[`DRAFT`,`In progress`],[`SENT`,`Awaiting approval`],[`SUBMITTED`,`Returned`],[`CANCELLED`,`Cancelled`]],$m=Object.fromEntries(Qm),K={rows:[],clients:[],templates:[],filter:`ALL`,search:``},eh=!1,th=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,nh=(e,t)=>e.some(e=>{let n=t?.[e.id];return Array.isArray(n)?n.length>0:!!(n&&String(n).trim())}),rh=(e,t)=>{let n=String(e[0]?.label||``).match(/^(.+?):\s/);return n?n[1]:t.toUpperCase()},ih={render:km,init:Am}})),oh=c({default:()=>vh,init:()=>fh,render:()=>dh});function sh(e){return e.status===`SENT`?{key:`PENDING`,label:`Pending your review`}:e.status===`SUBMITTED`&&e.signed?{key:`APPROVED`,label:`Approved`}:e.status===`SUBMITTED`?{key:`RETURNED`,label:`Returned with edits`}:null}function ch(){if(nr(),gh)return;let e=document.createElement(`style`);e.id=`m5t-deliverables-client-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),gh=!0}function lh(e,t){return!e.url&&t.key===`PENDING`?``:t.key===`PENDING`?`<button class="dc-act" type="button" data-url="${mh(e.url)}">Review</button>`:t.key!==`APPROVED`&&e.url&&e.editability?.editable?`<button class="dc-act" type="button" data-url="${mh(e.url)}">Update your review</button>`:``}function uh(e){let t=sh(e);return`<tr>
    <td><span class="dc-name">${mh(e.template_name||e.kind||`Deliverable`)}</span>${Number(e.revision)>1?`<span class="dc-when" style="margin-left:6px">Rev ${mh(e.revision)}</span>`:``}</td>
    <td><span class="dc-badge" data-s="${mh(t.key)}">${mh(t.label)}</span></td>
    <td class="dc-when">${e.sent_tz?mh(D(e.sent_tz)):`—`}</td>
    <td class="dc-when">${e.submitted_tz?mh(D(e.submitted_tz)):`—`}</td>
    <td class="dc-actcell">${lh(e,t)}</td>
  </tr>`}function dh(){return ch(),`
    <div class="page-shell" data-section="deliverables-client">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="dc-body">${_h(`hourglass_empty`,`Loading…`)}</div>
      </div>
    </div>`}async function fh(){let e=document.getElementById(`dc-body`);if(!e)return;let t;try{let e=await fetch(`${hh()}/m5t/v5/m5mDeliverable`),n=await e.json().catch(()=>({}));if(!e.ok||!n.ok)throw Error(`load failed`);t=(n.data||[]).filter(e=>sh(e))}catch{e.innerHTML=_h(`error`,`Could not load your deliverables. Please try again.`);return}if(!t.length){e.innerHTML=_h(`approval`,`Nothing to review right now.`);return}e.innerHTML=`
    <div class="dc-tablewrap">
      <table class="dc-table">
        <thead><tr><th>Deliverable</th><th>Status</th><th>Received</th><th>Returned</th><th></th></tr></thead>
        <tbody id="dc-tbody">${t.map(uh).join(``)}</tbody>
      </table>
    </div>`,e.querySelector(`#dc-tbody`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-url]`);t?.dataset.url&&window.open(t.dataset.url,`_blank`)})}var ph,mh,hh,gh,_h,vh,yh=o((()=>{T(),or(),ph={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},mh=e=>String(e??``).replace(/[&<>"']/g,e=>ph[e]),hh=()=>w.getConfig?.().BASE_URL||``,gh=!1,_h=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,vh={render:dh,init:fh}})),bh=c({init:()=>jh,render:()=>Ah});function xh(e){let t=Qh(e);if(!t)return``;try{return new Date(t).toLocaleDateString([],{month:`short`,day:`numeric`,year:`numeric`})}catch{return``}}function Sh(e){let t=Qh(e);if(!t)return``;try{let n=Date.now()-new Date(t).getTime();if(n<0)return xh(e);let r=n/36e5;return r<1?`${Math.max(1,Math.floor(n/6e4))}m ago`:r<24?`${Math.floor(r)}h ago`:r<48?`Yesterday`:xh(e)}catch{return xh(e)}}function Ch(){if(Wh)return;let e=document.createElement(`style`);e.id=`m5t-leads-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Wh=!0}function wh(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Th(e){return`<select class="leads-status" data-id="${J(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${Kh.map(t=>`<option value="${t}" ${e.status===t?`selected`:``}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join(``)}
  </select>`}function Eh(e){let t=q.magnetNames[e.magnet_guid]||e.lead_source||`—`,n=e.phone?String(e.phone).replace(/[^\d+]/g,``):``;return`
    <tr class="leads-row${String(e.id)===q.selectedId?` selected`:``}" data-id="${J(e.id)}" tabindex="0" role="button" aria-label="Open lead ${J(Xh(e))}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${J(Zh(e))}</span>
          <span><span class="leads-name">${J(Xh(e))}</span>${e.company?`<span class="leads-sub">${J(e.company)}</span>`:``}</span>
        </span>
      </td>
      ${q.book?`<td>${la(q.ownerNames[e.owner_guid]||``)||`<span class="leads-muted">—</span>`}</td>`:``}
      <td>
      ...
      <td>${q.canManage?Th(e):`<span class="leads-badge" data-s="${J(e.status)}">${J(e.status)}</span>`}</td>
      <td class="num leads-muted" style="white-space:nowrap" title="${J(xh(e))}">${$h(e)?`<span class="leads-fresh" title="Captured in the last 24 hours"></span>`:``}${J(Sh(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}function Dh(e){let t=q.search.trim().toLowerCase();if(!t)return!0;let n=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,q.magnetNames[e.magnet_guid],q.book?q.ownerNames[e.owner_guid]:``,e.utm_campaign,e.utm_source].filter(Boolean).join(` `).toLowerCase();return t.split(/\s+/).every(e=>n.includes(e))}function Oh(){return q.leads.filter(e=>(q.filter===`ALL`||e.status===q.filter)&&eg(e)&&Dh(e)&&tg(e))}function kh(){if(!q.day)return``;let e=q.day;try{e=new Date(`${q.day}T00:00:00Z`).toLocaleDateString([],{month:`short`,day:`numeric`,year:`numeric`,timeZone:`UTC`})}catch{}return`<button class="leads-daychip" type="button" id="leads-dayclear" title="Show every day again">
  ...
  </button>`}function Ah(){Ch(),Xi();let e=A();return`
    <div class="page-shell" data-section="leads">
      ...
      <div class="dashboard-card" style="margin-bottom:24px">
        ...
        <div class="card-body" id="pf-picker-body">${wh(`hourglass_empty`,`Loading…`)}</div>
      </div>`:``}
      <div class="page-header">
        <div class="page-header-text">
      ...
      <div class="leads-layout">
        <div class="dashboard-card">
          <div class="card-body" id="leads-body">
            ${wh(`hourglass_empty`,`Loading leads…`)}
          </div>
        </div>
        <aside class="dashboard-card leads-panel" aria-label="Lead detail">
          <div class="card-body" id="leads-panel-body">${ng()}</div>
        </aside>
      </div>
    </div>`}async function jh(){document.getElementById(`leads-export`)?.addEventListener(`click`,Hh);let e=fa(ma.LEADS_SEARCH),t=fa(ma.LEADS_DAY);if((e||t)&&(q.search=e||``,q.day=t||``,q.filter=`ALL`,q.clientFilter=`ALL`,q.shown=Gh),A()){let e=e=>Number(e||0).toLocaleString();na(Yh(),[{h:`Leads · wk`,td:t=>e(t.leads.this_week)},{h:`Leads · total`,td:t=>e(t.leads.total)},{h:`Compl.`,td:e=>e.completion_rate==null?`—`:`${e.completion_rate}%`}],{emptyMsg:`No client orgs yet. Create one under Clients first.`})}await Mh()}async function Mh(){let e=document.getElementById(`leads-body`);if(e){try{let[e,t]=await Promise.all([fetch(`${Yh()}/m5t/v5/m5mLead`),fetch(`${Yh()}/m5t/v5/magnets`).catch(()=>null)]),n=await e.json().catch(()=>({}));if(!n.ok)throw Error(n.message||`Failed to load`);if(q.leads=(n.data||[]).filter(e=>![`DELETED`,`ARCHIVED`].includes(e.status)),q.total=Number.isFinite(n.total)?n.total:q.leads.length,q.truncated=q.total>(n.data||[]).length,q.book=A(),q.ownerNames=q.book?ra():{},t){let e=await t.json().catch(()=>({}));q.magnetNames={},(e.magnets||[]).forEach(e=>{q.magnetNames[e.guid]=e.name,e.owner_guid&&e.owner_name&&!q.ownerNames[e.owner_guid]&&(q.ownerNames[e.owner_guid]=e.owner_name)}),q.canManage=!!e.canManage}}catch{e.innerHTML=wh(`error`,`Could not load your leads. Please try again.`);return}Nh()}}function Nh(){let e=document.getElementById(`leads-body`),t=document.getElementById(`leads-export`);if(!e)return;if(t&&(t.style.display=q.leads.length?``:`none`),!q.leads.length){e.innerHTML=wh(`inbox`,`No leads captured yet. Publish a magnet and share it to start collecting.`),Bh();return}let n=q.leads.filter(eg),r={ALL:n.length};Kh.forEach(e=>{r[e]=n.filter(t=>t.status===e).length});let i=q.book?[...new Set(q.leads.map(e=>e.owner_guid).filter(Boolean))].map(e=>({guid:e,name:q.ownerNames[e]||e})).sort((e,t)=>e.name.localeCompare(t.name)):[];e.innerHTML=`
    <div class="leads-bar">
      <div class="leads-filter">
        ${[`ALL`,...Kh].map(e=>`<button data-filter="${e}" class="${q.filter===e?`active`:``}">${e===`ALL`?`All`:e[0]+e.slice(1).toLowerCase()}${r[e]?`<span class="leads-pillnum">${r[e]}</span>`:``}</button>`).join(``)}
      </div>
      ${q.book&&i.length>1?`
    ...
    <div id="leads-tablezone"></div>`,e.querySelector(`.leads-filter`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-filter]`);t&&(q.filter=t.dataset.filter,q.shown=Gh,Nh())}),e.querySelector(`#leads-clientsel`)?.addEventListener(`change`,e=>{q.clientFilter=e.target.value,q.shown=Gh,Nh()}),e.querySelector(`#leads-dayclear`)?.addEventListener(`click`,()=>{q.day=``,q.shown=Gh,Nh()}),e.querySelector(`#leads-search`)?.addEventListener(`input`,e=>{q.search=e.target.value,q.shown=Gh,Ph()}),Ph()}function Ph(){let e=document.getElementById(`leads-tablezone`),t=document.getElementById(`leads-countlbl`);if(!e)return;let n=Oh(),r=n.slice(0,q.shown),i=q.book?8:7;t&&(t.textContent=`${n.length} of ${q.leads.length}`),e.innerHTML=`
    <div class="leads-tablewrap">
      <table class="leads-table${q.book?` leads-table--book`:``}">
        ...
        <tbody id="leads-tbody">${r.map(Eh).join(``)||`<tr><td colspan="${i}"><div class="leads-muted" style="padding:14px 4px">${q.search.trim()?`No leads match your search.`:`No ${q.filter.toLowerCase()} leads.`}</div></td></tr>`}</tbody>
      </table>
    </div>
    ${Jt({total:n.length,shown:q.shown,noun:`leads`})}
    ${q.truncated?`<div class="leads-muted" style="padding:10px 4px">Showing your ${q.leads.length.toLocaleString()} most recent leads of ${q.total.toLocaleString()}. Search and filters cover these; older leads aren't included yet.</div>`:``}`,e.querySelector(`[data-action="list-expand"]`)?.addEventListener(`click`,()=>{q.shown+=25,Ph()}),e.querySelector(`#leads-tbody`)?.addEventListener(`change`,Fh),e.querySelector(`#leads-tbody`)?.addEventListener(`click`,e=>{if(e.target.closest(`.leads-status, a.leads-contactlink`))return;let t=e.target.closest(`.leads-row`);t&&Ih(t.dataset.id)}),e.querySelector(`#leads-tbody`)?.addEventListener(`keydown`,e=>{if(e.key!==`Enter`&&e.key!==` `)return;let t=e.target.closest(`.leads-row`);t&&e.target===t&&(e.preventDefault(),Ih(t.dataset.id))})}async function Fh(e){let t=e.target.closest(`.leads-status`);if(!t)return;let n=t.dataset.id,r=q.leads.find(e=>String(e.id)===String(n)),i=t.value,a=r?.status;try{if(!(await(await fetch(`${Yh()}/m5t/v5/m5mLead/${encodeURIComponent(n)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:i})})).json().catch(()=>({}))).ok)throw Error();r&&(r.status=i),Jh(`Marked ${i[0]}${i.slice(1).toLowerCase()}`,`success`)}catch{t.value=a||`NEW`,Jh(`Could not update status`,`danger`);return}try{String(n)===q.selectedId&&Bh(),q.filter!==`ALL`&&Nh()}catch(e){console.warn(`[leads] re-render after status change failed:`,e)}}function Ih(e){q.selectedId=String(e),document.querySelectorAll(`.leads-row`).forEach(e=>e.classList.toggle(`selected`,e.dataset.id===q.selectedId)),Bh()}function Lh(e,t){let n=Array.isArray(e.tags)?e.tags:[];for(let e=n.length-1;e>=0;e--)if(n[e]&&n[e].tag===t&&n[e].value!=null)return String(n[e].value);return``}function Rh(e){let t=Lh(e,`appointment_start`);if(!t)return null;let n=Lh(e,`appointment_status`)||`booked`,r=Lh(e,`appointment_timezone`),i=Lh(e,`appointment_event_type`),a=new Date(t),o=t;if(!Number.isNaN(a.getTime())){let e={weekday:`short`,month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`};try{o=new Intl.DateTimeFormat(void 0,r?{...e,timeZone:r}:e).format(a)}catch{o=new Intl.DateTimeFormat(void 0,e).format(a)}}return{when:o,status:n,type:i,start:t}}function zh(e){let t=Array.isArray(e.tags)?e.tags:[],n=null;for(let e of t)if(!(!e||!e.tag)){if(e.tag===`callrail_call_id`){n={};continue}n&&e.tag.indexOf(`call_`)===0&&e.value!=null&&(n[e.tag]=String(e.value))}if(!n||!n.call_started)return null;let r=n.call_started,i=new Date(r),a=r;Number.isNaN(i.getTime())||(a=new Intl.DateTimeFormat(void 0,{weekday:`short`,month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`}).format(i));let o=Number(n.call_duration)||0,s=o?o<60?`${o}s`:`${Math.floor(o/60)}m ${o%60}s`:``;return{when:a,dur:s,source:n.call_source||``,answered:n.call_answered||``,recording:n.call_recording_player||``,started:r}}function Bh(){let e=document.getElementById(`leads-panel-body`);if(!e)return;let t=q.leads.find(e=>String(e.id)===q.selectedId),n=document.querySelector(`.leads-layout`);if(n&&(n.dataset.hasSelection=t?`true`:`false`),!t){e.innerHTML=ng();return}let r=q.magnetNames[t.magnet_guid]||t.lead_source||`—`,i=Rh(t),[a,o]=i?ig[i.status]||ig.booked:[``,``],s=zh(t),c=(e,t)=>t?`<div class="leads-det__field"><span class="leads-det__k">${J(e)}</span><span class="leads-det__v">${J(t)}</span></div>`:``;e.innerHTML=`
    <div class="leads-det__head">
      <span class="leads-avatar leads-det__ava">${J(Zh(t))}</span>
      <div>
        <div class="leads-det__name">${J(Xh(t))}</div>
    ...
    ${q.canManage?`
      ...
      </div>`:``}`,e.querySelector(`[data-action="delete-lead"]`)?.addEventListener(`click`,Vh)}async function Vh(e){let t=e.currentTarget?.dataset?.id,n=q.leads.find(e=>String(e.id)===String(t));if(!n)return;let r=Xh(n);if(!window.confirm(`Remove ${r} from your leads?\n\nThis takes the lead out of your dashboard, lists and exports. The record is kept in our system, and this address can be captured again if they come back through one of your magnets.`))return;let i=e.currentTarget;i.disabled=!0;try{let e=await fetch(`${Yh()}/m5t/v5/m5mLead/${encodeURIComponent(t)}`,{method:`DELETE`}),n=await e.json().catch(()=>({}));if(!e.ok||!n.ok)throw Error(n.error||`HTTP ${e.status}`);q.leads=q.leads.filter(e=>String(e.id)!==String(t)),q.selectedId=null,Jh(`${r} removed`,`success`),Nh()}catch{i.disabled=!1,Jh(`Could not remove that lead. Please try again.`,`danger`)}}function Hh(){let e=Oh();if(!e.length){Jh(`Nothing to export`,`info`);return}let t=[`first_name`,`last_name`,`email`,`phone`,`company`,`product_interest`,`lead_source`,`utm_source`,`utm_medium`,`utm_campaign`,`gclid`,`status`],n=e=>`"${String(e??``).replace(/"/g,`""`)}"`,r=[[...q.book?[`client`]:[],...t,`magnet`,`captured`,`appointment`,`last_call`].join(`,`)];for(let i of e){let e=Rh(i),a=zh(i);r.push([...q.book?[n(q.ownerNames[i.owner_guid]||``)]:[],...t.map(e=>n(i[e])),n(q.magnetNames[i.magnet_guid]||i.lead_source||``),n(xh(i)),n(e?`${e.start} (${e.status})`:``),n(a?`${a.started} (${a.answered===`no`?`missed`:`answered`})`:``)].join(`,`))}let i=new Blob([r.join(`
`)],{type:`text/csv`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.href=a,o.download=`leads-${q.filter.toLowerCase()}.csv`,document.body.appendChild(o),o.click(),o.remove(),URL.revokeObjectURL(a),Jh(`Exported ${e.length} lead${e.length===1?``:`s`}`,`success`)}var Uh,Wh,q,Gh,Kh,qh,J,Jh,Yh,Xh,Zh,Qh,$h,eg,tg,ng,rg,ig,ag=o((()=>{T(),Uh=u(f(),1),m(),ua(),ga(),Zt(),Wh=!1,q={leads:[],magnetNames:{},filter:`ALL`,canManage:!1,book:!1,ownerNames:{},clientFilter:`ALL`,search:``,shown:25,selectedId:null,day:``,total:0,truncated:!1},Gh=25,Kh=[`NEW`,`WORKING`,`QUALIFIED`,`UNQUALIFIED`,`CONVERTED`,`EXPORTED`],qh={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},J=e=>String(e??``).replace(/[&<>"']/g,e=>qh[e]),Jh=(e,t=`info`)=>{try{Uh.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},Yh=()=>w.getConfig?.().BASE_URL||``,Xh=e=>[e.first_name,e.last_name].filter(Boolean).join(` `).trim()||e.email||`(no name)`,Zh=e=>(Xh(e).split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``)||`?`).toUpperCase(),Qh=e=>e.created?.created_tz||``,$h=e=>{let t=Qh(e);if(!t)return!1;try{return Date.now()-new Date(t).getTime()<864e5}catch{return!1}},eg=e=>q.clientFilter===`ALL`||e.owner_guid===q.clientFilter,tg=e=>!q.day||Qh(e).slice(0,10)===q.day,ng=()=>wh(`touch_app`,`Click to see lead information.`),rg=()=>`
  <colgroup>
    <col style="width:22%">
  ...
  </colgroup>`,ig={booked:[`QUALIFIED`,`Booked`],rescheduled:[`WORKING`,`Rescheduled`],canceled:[`CANCELED`,`Canceled`]}})),og=c({init:()=>fg,render:()=>dg,tableHTML:()=>ug});function sg(){if(Sg)return;let e=document.createElement(`style`);e.id=`m5t-analytics-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Sg=!0}function cg(e,t){let n=t>0?Math.round(e/t*100):0;return`<svg class="anl-bar" width="72" height="8" viewBox="0 0 72 8" role="img"
    ...
    </svg>`}function lg(e,t,n){let r=wg[e.status]?`<span class="anl-chip">${vg(wg[e.status])}</span>`:``,i=n&&e.owner_name?`<span class="anl-sub">${vg(e.owner_name)}</span>`:``,a=e.ab_tests&&(e.ab_tests.running||e.ab_tests.completed)?`${gg(e.ab_tests.running)} / ${gg(e.ab_tests.completed)}`:`—`;return`<tr data-guid="${vg(e.magnet_guid)}">
    <td><a class="anl-name" href="#/magnets">${vg(e.name)}</a>${r}${i}</td>
    <td>${cg(Number(e.leads?.window||0),t)}</td>
    <td>${gg(e.leads?.window)}</td>
    <td>${gg(e.opens)}</td>
    <td>${yg(e.engagement_rate)}</td>
    <td>${yg(e.completion_rate)}</td>
    <td>${yg(e.lead_rate)}</td>
    <td>${a}</td>
  </tr>`}function ug(e,t){let n=e.reduce((e,t)=>Math.max(e,Number(t.leads?.window||0)),0);return`<div class="anl-wrap"><table class="anl-table">
    <thead><tr>
      <th>Magnet</th><th></th><th>Leads</th><th>Opens</th>
      <th>Engaged</th><th>Completed</th><th>Leads / Open</th><th>A/B run / done</th>
    </tr></thead>
    <tbody>${e.map(e=>lg(e,n,t)).join(``)}</tbody>
  </table></div>`}function dg(){return A()?ta({section:`analytics`,title:`Analytics`,description:`Pick a client to see how their magnets are performing.`}):(sg(),`
    <div class="page-shell" data-section="analytics">
      <div class="page-header">
        ...
        <div class="chart-controls" id="anl-periods">
          ${bg.map(e=>`<button class="chart-period-btn${e.d===xg?` active`:``}" type="button" data-days="${e.d}">${e.label}</button>`).join(``)}
        </div>
      </div>

      <div class="stats-grid">
        ${_a({icon:`person_add`,label:`Leads`,valueId:`anl-leads`,href:`#/leads`})}
        ${_a({icon:`visibility`,label:`Opens`,valueId:`anl-opens`})}
        ${_a({icon:`task_alt`,label:`Completion Rate`,valueId:`anl-completion`,href:`#/conversations`})}
        ${_a({icon:`widgets`,label:`Active Magnets`,valueId:`anl-active`,href:`#/magnets`})}
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="anl-body">
          ${Cg(`hourglass_empty`,`Loading magnet performance…`)}
        </div>
      </div>
    ...
    </div>`)}async function fg(){if(A())return na(mg(),[{h:`Leads`,td:e=>gg(e.leads.window??e.leads.total)},{h:`Opens`,td:e=>gg(e.opens)},{h:`Completed`,td:e=>yg(e.completion_rate)}]);sg(),await pg();let e=document.getElementById(`anl-periods`);e&&e.addEventListener(`click`,t=>{let n=t.target.closest(`.chart-period-btn`);n&&(xg=Number(n.dataset.days)||30,e.querySelectorAll(`.chart-period-btn`).forEach(e=>{e.classList.toggle(`active`,Number(e.dataset.days)===xg)}),pg())})}async function pg(){let e=document.getElementById(`anl-body`),t=document.getElementById(`anl-range`);if(!e)return;e.innerHTML=Cg(`hourglass_empty`,`Loading magnet performance…`);let n=new Date,r=hg(n),i=hg(new Date(n.getTime()-(xg-1)*864e5));t&&(t.textContent=`${i} → ${r}`);let a;try{let e=await fetch(`${mg()}/m5t/v5/dashboard/stats?from=${i}&to=${r}&group_by=magnet`);if(a=await e.json(),!e.ok||!a?.ok)throw Error(a?.error||`HTTP ${e.status}`)}catch(t){e.innerHTML=Cg(`cloud_off`,`Could not load analytics. Refresh to try again.`),console.error(`[analytics] load failed:`,t);return}let o=(e,t)=>{let n=document.getElementById(e);n&&(n.textContent=t)};o(`anl-leads`,gg(a.by_day?.reduce((e,t)=>e+Number(t.leads||0),0))),o(`anl-opens`,gg(a.funnel?.opens)),o(`anl-completion`,yg(a.funnel?.completion_rate)),o(`anl-active`,gg(a.magnets?.active));let s=Array.isArray(a.by_magnet)?a.by_magnet:[];if(!s.length){e.innerHTML=Cg(`widgets`,`No magnets yet. Create one and its numbers will show up here.`);return}let c=s.some(e=>Number(e.opens||0)>0||Number(e.leads?.window||0)>0),l=new Set(s.map(e=>e.owner_guid)).size>1;e.innerHTML=(a.by_magnet_truncated?`<p class="anl-warn">Showing the top ${s.length} magnets by leads. You have more than that, so this list is not complete.</p>`:``)+(c?``:`<p class="anl-warn">No opens or leads for any magnet in this period. Try a longer range.</p>`)+ug(s,l);let u=e.querySelector(`.anl-table tbody`);u&&Yt(u,{rowSelector:`tr`,noun:`magnets`,controlHost:e.querySelector(`.anl-wrap`)||e})}var mg,hg,gg,_g,vg,yg,bg,xg,Sg,Cg,wg,Tg=o((()=>{T(),ua(),ba(),Zt(),mg=()=>w.getConfig?.().BASE_URL||``,hg=e=>e.toISOString().slice(0,10),gg=e=>Number(e||0).toLocaleString(),_g={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},vg=e=>String(e??``).replace(/[&<>"']/g,e=>_g[e]),yg=e=>e==null?`—`:`${e}%`,bg=[{d:7,label:`7 Days`},{d:30,label:`30 Days`},{d:90,label:`90 Days`}],xg=30,Sg=!1,Cg=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,wg={DRAFT:`Draft`,DISABLED:`Paused`}})),Eg=c({default:()=>Jg,init:()=>kg,render:()=>Og});function Dg(){if(Wg)return;let e=document.createElement(`style`);e.id=`m5t-adperf-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),Wg=!0}function Og(){return A()?ta({section:`ad-performance`,title:`Ad Performance`,description:`Pick a client to view their spend and lead performance.`}):(Dg(),`
    <div class="page-shell" data-section="ad-performance">
      ...
      <div class="stats-grid" id="adperf-stats">
        ${_a({icon:`payments`,label:`Ad Spend`,valueId:`adperf-spend`,href:`#/ad-accounts`})}
        ${_a({icon:`ads_click`,label:`Clicks`,valueId:`adperf-clicks`,href:`#/ad-accounts`})}
        ${_a({icon:`person_add`,label:`Magnet Leads`,valueId:`adperf-leads`,href:`#/leads`})}
        ${_a({icon:`request_quote`,label:`Cost / Lead`,valueId:`adperf-cpl`})}
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-body">
          ${Gg(`hourglass_empty`,`Loading ad performance…`)}
        </div>
      </div>
    ...
    </div>`)}async function kg(){if(A()){let e=e=>Number(e||0).toLocaleString();return na(Rg(),[{h:`Spend`,td:t=>t.ad?`$${e(t.ad.spend)}`:`—`},{h:`Clicks`,td:t=>t.ad?e(t.ad.clicks):`—`},{h:`Leads`,td:t=>e(t.leads.window??t.leads.total)},{h:`CPL`,td:t=>t.ad?.cost_per_lead==null?`—`:`$${e(t.ad.cost_per_lead)}`}],{emptyMsg:`No client orgs yet. Connect a client ad account to see spend here.`})}let e=document.getElementById(`adperf-periods`);e?.addEventListener(`click`,t=>{let n=t.target.closest(`button[data-days]`);n&&(qg=Number(n.dataset.days)||30,e.querySelectorAll(`.chart-period-btn`).forEach(e=>e.classList.toggle(`active`,Number(e.dataset.days)===qg)),Ag())}),await Ag()}async function Ag(){let e=Rg(),t=document.getElementById(`adperf-body`),n=document.getElementById(`adperf-range`),r=new Date,i=zg(r),a=zg(new Date(r.getTime()-(qg-1)*864e5));n&&(n.textContent=`${a} → ${i}`);let o,s=[],c=null,l=null,u=null;try{let[t,n,r,d,f]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${a}&to=${i}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${a}&to=${i}`),qs().catch(()=>null),fetch(`${e}/m5t/v5/coreAdMetrics/conversions?from=${a}&to=${i}`).then(e=>e.json()).catch(()=>null)]);if(!t.ok)throw Error(`HTTP ${t.status}`);o=await t.json(),s=((await n.json().catch(()=>({})))?.data||[]).filter(e=>e.status!==`DELETED`),c=await r.json().catch(()=>null),l=d,u=f}catch(e){console.warn(`[ad-performance] load failed:`,e),t&&(t.innerHTML=Gg(`error`,`Could not load ad performance. Please try again.`));return}jg(l,s),Mg(u);let d=o.totals||{};if(Pg(`adperf-spend`,Bg(d.spend)),Pg(`adperf-clicks`,Vg(d.clicks)),Pg(`adperf-leads`,Vg(d.magnet_leads)),Pg(`adperf-cpl`,Bg(d.cost_per_lead)),Ng(c),!s.length){t.innerHTML=Gg(`link_off`,`No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.`);return}if(!o.connected){t.innerHTML=Gg(`cloud_sync`,`Account connected. No ad data for this range yet. Metrics appear here once they sync.`);return}t.innerHTML=Lg(o.rows||[])}function jg(e,t){let n=document.getElementById(`adperf-conn`);if(!n)return;if(!e||e.denied){n.innerHTML=``;return}let r=gc.google_ads,i=Ws(e.providers,`google_ads`),a=Gs(r,i,!!e.configured?.google_ads),o=uc()?` <a href="#/settings/integrations/${r.urlSlug}">Manage</a>`:``;if(a===`connected`||a===`broken`){ac(),n.innerHTML=`<span>Google Ads</span> ${Ks(a,i)}${o}`;return}if(t.length){n.innerHTML=`<span>Google Ads</span> <span>${t.length} associated account${t.length===1?``:`s`}</span>`;return}n.innerHTML=``}function Mg(e){let t=document.getElementById(`adperf-conv-card`),n=document.getElementById(`adperf-conv-body`),r=document.getElementById(`adperf-stats`),i=document.getElementById(`adperf-conv-stat`);if(i&&i.remove(),!t||!n)return;if(!e?.ok||!e.has_selection){t.style.display=`none`;return}if(r){let t=document.createElement(`div`);t.innerHTML=_a({icon:`flag`,label:`Ads Conversions`,value:Vg(e.totals?.conversions),sub:`Reported by Google Ads`,href:`#/settings/integrations/google-ads`});let n=t.firstElementChild;n.id=`adperf-conv-stat`,r.appendChild(n)}let a=e.actions||[];if(t.style.display=``,!a.length){n.innerHTML=Gg(`search_off`,`No conversions in this range for the selected actions.`);return}let o=a.some(e=>e.value>0);n.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${a.map(e=>`
          <tr>
            <td>${Ug(e.name||e.id)}</td>
            <td class="adperf-src-sub">${Ug(String(e.category||``).toLowerCase().replace(/_/g,` `)||`—`)}</td>
            <td class="num"><b>${Vg(e.conversions)}</b></td>
            ${o?`<td class="num">${Bg(e.value)}</td>`:``}
          </tr>`).join(``)}
        </tbody>
      </table>
    </div>
    <p class="adperf-note">Counted actions are chosen on the Google Ads integration page. These are Google's own numbers and may overlap magnet leads, so they are never added together.</p>`}function Ng(e){let t=document.getElementById(`adperf-sources`),n=document.getElementById(`adperf-src-summary`);if(!t)return;let r=e&&Array.isArray(e.rows)?e.rows:[];if(!r.length){n&&(n.textContent=``),t.innerHTML=Gg(`search_off`,`No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.`);return}let i=e.total_leads||r.reduce((e,t)=>e+(t.leads||0),0),a=e.tracked_leads||0;n&&(n.textContent=`${Vg(a)} of ${Vg(i)} leads tagged to a source`);let o=e=>e.campaign&&e.campaign!==`(none)`?Ug(e.campaign):e.source&&e.source!==`(direct)`?Ug(e.source):`<span class="adperf-src-untracked">Untracked / direct</span>`;t.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${r.map(e=>`
          <tr>
            <td>${o(e)}</td>
            <td class="adperf-src-sub">${Ug(e.source||`—`)}${e.medium?` · ${Ug(e.medium)}`:``}</td>
            <td class="num">${e.paid_clicks?Vg(e.paid_clicks):`<span class="adperf-src-sub">—</span>`}</td>
            <td class="num"><b>${Vg(e.leads)}</b></td>
          </tr>`).join(``)}
        </tbody>
      </table>
    </div>`;let s=t.querySelector(`.adperf-srctable tbody`);s&&Yt(s,{rowSelector:`tr`,noun:`sources`,controlHost:t.querySelector(`.adperf-srcwrap`)||t})}function Pg(e,t){let n=document.getElementById(e);n&&(n.textContent=t)}function Fg(e){if(e<=0)return 1;let t=10**Math.floor(Math.log10(e)),n=e/t;return(n<=1?1:n<=2?2:n<=5?5:10)*t}function Ig(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3==0?0:1)+`k`:String(e)}function Lg(e){let t=e.length||1,n=Fg(Math.max(1,...e.map(e=>e.spend||0))),r=Fg(Math.max(1,...e.map(e=>e.magnet_leads||0))),i=738/t,a=Math.min(24,i*.55),o=e=>56+i*(e+.5),s=e=>304-e/n*282,c=e=>304-e/r*282,l=[0,.25,.5,.75,1].map(e=>{let t=304-e*282;return`<line x1="56" y1="${t.toFixed(1)}" x2="794" y2="${t.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${(t+3.5).toFixed(1)}" text-anchor="end" class="ax">$${Ig(n*e)}</text><text x="802" y="${(t+3.5).toFixed(1)}" text-anchor="start" class="ax">${Ig(r*e)}</text>`}).join(``),u=e.map((e,t)=>{let n=s(e.spend||0);return`<rect x="${(o(t)-a/2).toFixed(1)}" y="${n.toFixed(1)}" width="${a.toFixed(1)}" height="${Math.max(0,304-n).toFixed(1)}" rx="3" fill="#0072BA"><title>${e.date}: $${e.spend} spend</title></rect>`}).join(``),d=e.map((e,t)=>`${o(t).toFixed(1)},${c(e.magnet_leads||0).toFixed(1)}`).join(` `),f=t>1?`<polyline points="${d}" fill="none" stroke="#009473" stroke-width="2.5"/>`:``,p=e.map((e,t)=>`<circle cx="${o(t).toFixed(1)}" cy="${c(e.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${e.date}: ${e.magnet_leads} leads</title></circle>`).join(``),m=Math.max(1,Math.ceil(t/6));return`
    ...
    </svg>`}var Rg,zg,Bg,Vg,Hg,Ug,Wg,Gg,Kg,qg,Jg,Yg=o((()=>{T(),ua(),xc(),ba(),Zt(),Rg=()=>w.getConfig?.().BASE_URL||``,zg=e=>e.toISOString().slice(0,10),Bg=e=>e==null?`—`:`$`+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),Vg=e=>Number(e||0).toLocaleString(),Hg={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Ug=e=>String(e??``).replace(/[&<>"']/g,e=>Hg[e]),Wg=!1,Gg=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Kg=[{d:7,label:`7 Days`},{d:30,label:`30 Days`},{d:90,label:`90 Days`}],qg=30,Jg={render:Og,init:kg}})),Xg=c({default:()=>__,init:()=>$g,parseBookingCsv:()=>u_,render:()=>Qg});function Zg(){if(m_)return;let e=document.createElement(`style`);e.id=`m5t-adacct-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),m_=!0}function Qg(){return A()?ta({section:`ad-accounts`,title:`Ad Accounts`,description:`Pick a client to see their connected ad accounts.`}):(Zg(),ac(),`
    ...
    </div>`)}async function $g(){if(A()){let e=e=>Number(e||0).toLocaleString();return na(N(),[{h:`Spend`,td:t=>t.ad?`$${e(t.ad.spend)}`:`—`},{h:`Leads`,td:t=>e(t.leads.window??t.leads.total)},{h:`CPL`,td:t=>t.ad?.cost_per_lead==null?`—`:`$${e(t.ad.cost_per_lead)}`}],{emptyMsg:`No client orgs yet. Connect a client ad account to see it here.`})}await e_()}async function e_(){let[e,t,n]=await Promise.all([qs().catch(()=>null),fetch(`${N()}/m5t/v5/coreAdAccount`).then(e=>e.json()).catch(()=>null),fetch(`${N()}/m5t/v5/coreAdMetrics/conversions`).then(e=>e.json()).catch(()=>null)]);t_(e,n),n_(t),r_(t)}function t_(e,t){let n=document.getElementById(`adacct-conn`);if(!n)return;let r=gc.google_ads;if(!e||e.denied){n.innerHTML=dc(`link_off`,`Connection status is not available for your role.`);return}let i=Ws(e.providers,`google_ads`),a=Gs(r,i,!!e.configured?.google_ads),o=i?.external_account||{},s=r.card.reachableCount(o),c;c=a===`connected`?s?`${s} reachable account${s===1?``:`s`}.`:`Connected.`:a===`broken`?r.card.brokenDesc:a===`unavailable`?`Google Ads is being set up for this platform.`:uc()?`Not connected yet. Connect from Settings to pull spend and clicks.`:`Not connected yet.`;let l=uc()&&a!==`unavailable`?`<a class="adacct-manage" href="#/settings/integrations/${r.urlSlug}"><span class="material-symbols-outlined" aria-hidden="true">${a===`idle`?`link`:`settings`}</span>${a===`idle`?`Connect`:`Manage`}</a>`:``,u=``;if(t?.ok&&t.has_selection){let e=(t.actions||[]).map(e=>e.name||e.id),n=(t.selected_ids||[]).length-e.length;u=`
    ...
    <div class="adacct-conn">
      ...
      <div class="adacct-conn__titles">
        <span class="adacct-conn__name">${M(r.label)} ${Ks(a,i)}</span>
        <span class="adacct-conn__sub">${M(c)}</span>
      </div>
      <span class="adacct-conn__spacer"></span>
      ${l}
    </div>
    ${u}`}function n_(e){let t=document.getElementById(`adacct-list`),n=document.getElementById(`adacct-count`);if(!t)return;if(!e||e.ok===!1){t.innerHTML=dc(`error`,`Could not load ad accounts. Please try again.`);return}let r=(e.data||[]).filter(e=>e.status!==`DELETED`),i=!!e.canConnect;if(n&&(n.textContent=r.length?`${r.length} account${r.length===1?``:`s`}`:``),!r.length){t.innerHTML=dc(`link_off`,i?`No ad accounts associated yet.`:`No ad accounts yet. Your agency connects these for you.`)+(i?`<p class="adacct-note">Associate a client's Customer ID from the <a href="#/clients">Clients page</a>.</p>`:``);return}t.innerHTML=`
    <div class="adacct-wrap">
      <table class="adacct-table">
        <thead><tr><th>Platform</th><th>Customer ID</th><th>Status</th></tr></thead>
        <tbody>${r.map(e=>`
          <tr>
            <td>${M(f_[e.provider]||e.provider)}</td>
            <td class="adacct-cid">${M(p_(e.external_customer_id))}</td>
            <td><span class="m5t-badge" data-tone="${e.status===`ACTIVE`?`success`:`warning`}">${M(e.status===`ACTIVE`?`Active`:e.status)}</span></td>
          </tr>`).join(``)}
        </tbody>
      </table>
    </div>
    ${i?`<p class="adacct-note">Associations are managed per client from the <a href="#/clients">Clients page</a>.</p>`:``}`;let a=t.querySelector(`.adacct-table tbody`);a&&Yt(a,{rowSelector:`tr`,noun:`accounts`,controlHost:t.querySelector(`.adacct-wrap`)||t})}function r_(e){let t=document.getElementById(`adacct-offline`);if(t){if(!e?.canConnect){t.style.display=`none`;return}t.style.display=``,document.getElementById(`adacct-oc-dl`)?.addEventListener(`click`,c_),document.getElementById(`adacct-oc-up`)?.addEventListener(`click`,s_),document.getElementById(`adacct-mc-file`)?.addEventListener(`change`,l_),i_()}}async function i_(){h_=[];try{let e=await(await fetch(`${N()}/m5t/v5/integrations/google_ads/conversion_actions`)).json();if(!e.ok)return;let t=e.data.actions||[];if(h_=t.filter(e=>e.type===`UPLOAD_CLICKS`&&(e.account_ids||[]).length),!h_.length){if(t.length){let e=document.getElementById(`adacct-oc-result`);e&&(e.textContent=`Direct upload needs an import type conversion action in Google Ads. The CSV works either way.`)}return}let n=document.getElementById(`adacct-oc-target`);n&&(n.innerHTML=h_.map(e=>`<option value="${M(e.id)}">${M(e.name||e.id)}</option>`).join(``)),document.getElementById(`adacct-oc-target-wrap`)?.style.setProperty(`display`,``),document.getElementById(`adacct-oc-up`)?.style.setProperty(`display`,``)}catch{}}function a_(){let e=document.getElementById(`adacct-oc-target`)?.value;return h_.find(t=>t.id===e)||h_[0]||null}async function o_(e,t){let n=a_();if(!n){t&&(t.textContent=`Pick an upload target first.`);return}let r=document.getElementById(`adacct-oc-value`)?.value,i=r!==``&&r!=null&&Number.isFinite(Number(r))?Number(r):null;t&&(t.textContent=`Uploading ${e.length} conversion${e.length===1?``:`s`}…`);try{let r=await(await fetch(`${N()}/m5t/v5/integrations/google_ads/upload_conversions`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({customer_id:n.account_ids[0],conversion_action_id:n.id,rows:e.map(e=>i==null?e:{...e,value:i})})})).json();if(!r.ok)throw Error(r.error||`upload failed`);let a=[`${r.data.uploaded} uploaded to Google Ads.`];r.data.failed&&a.push(`${r.data.failed} rejected${r.data.errors?.[0]?`: ${r.data.errors[0]}`:`.`}`),t&&(t.textContent=a.join(` `))}catch(e){t&&(t.textContent=e.message===`upload failed`?`Upload failed. Please try again.`:`Upload failed: ${e.message}`)}}async function s_(){let e=document.getElementById(`adacct-oc-result`),t=Number(document.getElementById(`adacct-oc-days`)?.value)||90,n=[...document.querySelectorAll(`#adacct-oc-statuses input:checked`)].map(e=>e.value);if(!n.length){e&&(e.textContent=`Pick at least one status.`);return}let r=e=>e.toISOString().slice(0,10),i=r(new Date),a=r(new Date(Date.now()-(t-1)*864e5)),o=new URLSearchParams({from:a,to:i,statuses:n.join(`,`),format:`json`});try{let t=await(await fetch(`${N()}/m5t/v5/coreAdMetrics/offline-conversions.csv?${o}`)).json();if(!t.ok)throw Error();if(!t.rows.length){e&&(e.textContent=`No leads with a click id in that window.`);return}await o_(t.rows,e)}catch{e&&(e.textContent=`Upload failed. Please try again.`)}}async function c_(){let e=document.getElementById(`adacct-oc-result`),t=Number(document.getElementById(`adacct-oc-days`)?.value)||90,n=[...document.querySelectorAll(`#adacct-oc-statuses input:checked`)].map(e=>e.value);if(!n.length){e&&(e.textContent=`Pick at least one status.`);return}let r=document.getElementById(`adacct-oc-name`)?.value?.trim()||`M5M magnet lead`,i=document.getElementById(`adacct-oc-value`)?.value,a=e=>e.toISOString().slice(0,10),o=a(new Date),s=a(new Date(Date.now()-(t-1)*864e5)),c=new URLSearchParams({from:s,to:o,statuses:n.join(`,`),name:r});i!==``&&i!=null&&Number.isFinite(Number(i))&&c.set(`value`,i),e&&(e.textContent=`Building the export…`);try{let t=await fetch(`${N()}/m5t/v5/coreAdMetrics/offline-conversions.csv?${c}`);if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.text(),r=Math.max(0,n.trim().split(`
`).length-1);d_(n,`google-ads-conversions-${s}-to-${o}.csv`),e&&(e.textContent=r?`${r} conversion${r===1?``:`s`} in the file.`:`No leads with a click id in that window. The file has headers only.`)}catch{e&&(e.textContent=`Export failed. Please try again.`)}}async function l_(e){let t=document.getElementById(`adacct-mc-result`),n=e.target.files?.[0];if(!n)return;let r=u_(await n.text());if(!r.length){t&&(t.textContent=`No usable rows found. The CSV needs an email or phone column.`);return}t&&(t.textContent=`Matching ${r.length} row${r.length===1?``:`s`}…`);try{let e=await(await fetch(`${N()}/m5t/v5/coreAdMetrics/offline-conversions/match`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({rows:r})})).json();if(!e.ok)throw Error(e.error||`match failed`);let n=[`${e.matched_count} of ${r.length} rows matched a magnet lead with a click id.`];if(e.unmatched_count&&n.push(`${e.unmatched_count} had no matching lead.`),e.no_click_count&&n.push(`${e.no_click_count} matched a lead without a click id.`),!e.matched_count){t&&(t.textContent=n.join(` `));return}let i=document.getElementById(`adacct-oc-name`)?.value?.trim()||`M5M magnet lead`,a=document.getElementById(`adacct-oc-value`)?.value,o=a!==``&&a!=null&&Number.isFinite(Number(a))?Number(a):``,s=e=>`"${String(e??``).replace(/"/g,`""`)}"`,c=[`Google Click ID,Conversion Name,Conversion Time,Conversion Value,Conversion Currency`,...e.matched.map(e=>[s(e.gclid),s(i),s(e.time),o,``].join(`,`))].join(`\r
`)+`\r
`;if(g_=e.matched.map(e=>({gclid:e.gclid,time:e.time})),t){t.innerHTML=``;let e=document.createElement(`span`);e.textContent=n.join(` `)+` `;let r=document.createElement(`button`);if(r.type=`button`,r.className=`adacct-manage`,r.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">download</span>Download matched CSV`,r.addEventListener(`click`,()=>d_(c,`google-ads-conversions-matched-${new Date().toISOString().slice(0,10)}.csv`)),t.append(e,r),h_.length){let e=document.createElement(`button`);e.type=`button`,e.className=`adacct-manage`,e.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">cloud_upload</span>Upload to Google Ads`,e.addEventListener(`click`,()=>o_(g_,t)),t.append(` `,e)}}}catch{t&&(t.textContent=`Matching failed. Please try again.`)}finally{e.target.value=``}}function u_(e){let t=[],n=[],r=``,i=!1;for(let a=0;a<e.length;a++){let o=e[a];i?o===`"`&&e[a+1]===`"`?(r+=`"`,a++):o===`"`?i=!1:r+=o:o===`"`?i=!0:o===`,`?(n.push(r),r=``):o===`
`||o===`\r`?(o===`\r`&&e[a+1]===`
`&&a++,n.push(r),r=``,n.some(e=>e.trim()!==``)&&t.push(n),n=[]):r+=o}if(n.push(r),n.some(e=>e.trim()!==``)&&t.push(n),t.length<2)return[];let a=t[0].map(e=>e.trim().toLowerCase()),o=a.findIndex(e=>/e-?mail/.test(e)),s=a.findIndex(e=>/phone|mobile|tel/.test(e)),c=a.findIndex(e=>/date|time|booked|appointment|start/.test(e));return o<0&&s<0?[]:t.slice(1).map(e=>({email:o>=0?(e[o]||``).trim():``,phone:s>=0?(e[s]||``).trim():``,at:c>=0?(e[c]||``).trim():``})).filter(e=>e.email||e.phone).slice(0,5e3)}function d_(e,t){let n=new Blob([e],{type:`text/csv;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,document.body.appendChild(i),i.click(),i.remove(),setTimeout(()=>URL.revokeObjectURL(r),4e3)}var f_,p_,m_,h_,g_,__,v_=o((()=>{ua(),Zt(),xc(),f_={google_ads:`Google Ads`,google_lsa:`Local Services Ads`},p_=e=>{let t=String(e||``).replace(/\D/g,``);return t.length===10?`${t.slice(0,3)}-${t.slice(3,6)}-${t.slice(6)}`:String(e||``)},m_=!1,h_=[],g_=null,__={render:Qg,init:$g}})),y_=c({default:()=>V_,init:()=>D_,openInviteModal:()=>j_,render:()=>E_});function b_(e,t=`info`){try{P_.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}}function x_(){let e=w.getActiveOrg();if(e&&e.channel===F_)return{guid:e.guid,name:e.name};let t=w.getMemberships().find(e=>e.channel===F_);return t?{guid:t.orgGuid,name:t.name}:null}function S_(e){let t=e?.created_tz;if(!t)return``;let n=new Date(t);return Number.isNaN(n.getTime())?``:n.toLocaleDateString(void 0,{year:`numeric`,month:`short`,day:`numeric`})}function C_(){if(L_)return;let e=document.createElement(`style`);e.id=`m5t-clients-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),nr(),L_=!0}function w_(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function T_(e){let t=e.caption||e.guid,n=e.status||`ENABLED`;return`
    <div class="client-row">
      <span class="client-row__avatar">${Y(z_(t))}</span>
      <span class="client-row__main">
        <div class="client-row__name" title="${Y(t)}">${Y(t)}</div>
        <div class="client-row__meta">Added ${Y(S_(e.created))||`—`}</div>
      </span>
    ...
    <div class="page-shell" data-section="clients">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="clients-body">
          ${w_(`hourglass_empty`,`Loading clients…`)}
        </div>
      </div>
    </div>`}async function D_(){let e=x_();document.getElementById(`clients-add-btn`)?.addEventListener(`click`,()=>k_(e)),await O_(e)}async function O_(e){let t=document.getElementById(`clients-body`),n=document.getElementById(`clients-count`);if(t){if(!e?.guid){t.innerHTML=w_(`info`,`Client provisioning is available to reseller / agency accounts.`),n&&(n.textContent=``);return}try{let r=w.getConfig?.().BASE_URL||``,i=await fetch(`${r}/m5t/v5/acctGroup`);if(!i.ok)throw Error(`HTTP ${i.status}`);let a=await i.json(),o=(Array.isArray(a?.data)?a.data:[]).filter(t=>t.class===I_&&(!t.parent||t.parent===e.guid));if(!o.length){t.innerHTML=w_(`group_off`,`No clients yet. Add your first client to start managing magnets on their behalf.`),n&&(n.textContent=``);return}t.innerHTML=`<div class="client-list">${o.map(T_).join(``)}</div>`,Yt(t.querySelector(`.client-list`),{rowSelector:`.client-row`,noun:`clients`}),n&&(n.textContent=`${o.length} client${o.length===1?``:`s`}`),t.querySelectorAll(`.client-card__invite`).forEach(e=>{e.addEventListener(`click`,()=>{e.dataset.action===`adaccounts`?A_(e.dataset.clientGuid,e.dataset.clientName):e.dataset.action===`questionnaire`?N_(e.dataset.clientGuid,e.dataset.clientName):j_(e.dataset.clientGuid,e.dataset.clientName)})})}catch(e){console.warn(`[clients] load failed:`,e),t.innerHTML=w_(`error`,`Couldn’t load clients. Please try again.`),n&&(n.textContent=``)}}}function k_(e){if(!e?.guid){b_(`Only reseller / agency accounts can add clients.`,`error`);return}let t=document.createElement(`div`);t.className=`client-modal-scrim`;let n=document.createElement(`div`);n.className=`client-modal`,n.setAttribute(`role`,`dialog`),n.setAttribute(`aria-modal`,`true`),n.innerHTML=`
    ...
    <div class="client-modal__body" id="qm-body">${w_(`hourglass_empty`,`Loading…`)}</div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add(`open`),i.classList.add(`open`)});let a=()=>{r.classList.remove(`open`),i.classList.remove(`open`),document.removeEventListener(`keydown`,o),setTimeout(()=>{r.remove(),i.remove()},200)},o=e=>{e.key===`Escape`&&a()};document.addEventListener(`keydown`,o),r.addEventListener(`click`,a),i.querySelector(`.client-modal__close`)?.addEventListener(`click`,a);let s=i.querySelector(`#qm-body`);function c(){s.innerHTML=`
      ...
      </div>`,s.querySelector(`[data-act="done"]`)?.addEventListener(`click`,a),s.querySelector(`[data-act="resend"]`)?.addEventListener(`click`,()=>c())}function d(e,t=!1){let r=e.editability||{editable:e.status===`SUBMITTED`&&!e.locked_tz,reason:e.locked_tz?`finalized`:null,deadline:null},i=!!r.editable,o=!i&&e.status===`SUBMITTED`?r.reason===`finalized`?`<div class="qm-status" data-status="LOCKED"><span class="material-symbols-outlined" aria-hidden="true">lock</span> Finalized${e.locked_tz?` ${Y(M_(e.locked_tz))}`:``}${e.locked_by_email?` by ${Y(e.locked_by_email)}`:``} — no further edits.</div>`:`<div class="qm-status" data-status="LOCKED"><span class="material-symbols-outlined" aria-hidden="true">lock_clock</span> Editing closed${r.deadline?` ${Y(M_(r.deadline))}`:``} — a response locks 14 days after it is submitted.</div>`:``,c=i&&r.deadline?`<p class="client-modal__sub qm-editable-hint">You can edit these answers until ${Y(M_(r.deadline))}.</p>`:``;s.innerHTML=`
      <div class="qm-status" data-status="SUBMITTED"><span class="material-symbols-outlined" aria-hidden="true">task_alt</span> Submitted ${e.submitted_tz?Y(M_(e.submitted_tz)):``}</div>
      ${o}
      ${tr(e)}
      <form id="qm-form">
        ${Qn(e,t?{renderAnswer:$n}:{})}
      </form>
      ${t?``:c}
      <p class="client-modal__error" id="qm-error"></p>
      <div class="client-modal__actions">
      ...
      </div>`,s.querySelector(`[data-act="done"]`)?.addEventListener(`click`,a),s.querySelector(`[data-act="cancel-edit"]`)?.addEventListener(`click`,()=>d(e,!1)),s.querySelector(`[data-act="edit"]`)?.addEventListener(`click`,()=>d(e,!0));let l=s.querySelector(`[data-act="save"]`);l?.addEventListener(`click`,async()=>{let t=er(s);l.disabled=!0;let r=l.innerHTML;l.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…`;let i;try{i=await fetch(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e.guid)}`,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify({answers:t})});let r=await i.json().catch(()=>({}));if(!i.ok||!r.ok)throw Error(r.error||r.message||`Failed (HTTP ${i.status})`);b_(`Answers updated`,`success`);let a=await(await fetch(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e.guid)}`)).json().catch(()=>({}));d(a.ok?a.data:{...e,answers:t},!1)}catch(t){if(i&&i.status===423){b_(t.message||`This questionnaire is now locked.`,`info`);let r=await(await fetch(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(e.guid)}`)).json().catch(()=>({}));d(r.ok?r.data:e,!1);return}s.querySelector(`#qm-error`).textContent=t.message||`Something went wrong. Please try again.`,l.disabled=!1,l.innerHTML=r}})}try{let t=await fetch(`${n}/m5t/v5/m5mQuestionnaireResponse?owner_guid=${encodeURIComponent(e)}`),r=await t.json().catch(()=>({}));if(!t.ok||!r.ok)throw Error(r.error||`HTTP ${t.status}`);let i=(r.data||[])[0]||null;if(!i){c();return}if(i.status===`DRAFT`){l(i);return}if(i.status===`CANCELLED`){u(i);return}let a=await fetch(`${n}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(i.guid)}`),o=await a.json().catch(()=>({}));if(!a.ok||!o.ok)throw Error(o.error||`HTTP ${a.status}`);d(o.data)}catch(e){console.warn(`[clients] questionnaire load failed:`,e),s.innerHTML=`<p class="client-modal__error">Could not load questionnaire status. ${Y(e.message||``)}</p>`}}var P_,F_,I_,L_,R_,Y,z_,B_,V_,H_=o((()=>{T(),Qe(),P_=u(f(),1),m(),Zt(),or(),F_=`reseller_org`,I_=`managed_client`,L_=!1,R_={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Y=e=>String(e??``).replace(/[&<>"']/g,e=>R_[e]),z_=e=>String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``).toUpperCase()||`?`,B_=e=>String(e||``).replace(/[^0-9]/g,``),V_={render:E_,init:D_}})),U_=c({default:()=>sv,init:()=>Q_,loadTeam:()=>$_,render:()=>Z_});function W_(){let e=w.getActiveOrg(),t=e&&e.channel!==nv?e:null;if(!t){let e=w.getMemberships().find(e=>e.channel!==nv);e&&(t={guid:e.orgGuid,channel:e.channel,memberRole:e.memberRole})}if(!t)return null;let n=w.getMemberships().find(e=>e.orgGuid===t.guid)?.name;return{...t,name:n}}function G_(e){return Object.values(Ie).filter(t=>Fe(e,t.value)).sort((e,t)=>t.rank-e.rank)}function K_(){if(rv)return;let e=document.createElement(`style`);e.id=`m5t-team-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e),rv=!0}function q_(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function J_(e,t,n){let r=e.member_role||`member`,i=e.entity_guid&&e.entity_guid===w.getEntity?.()?.guid,a=n&&!i&&G_(t.memberRole).some(e=>e.value===r);return`
    <div class="team-row">
      <span class="team-avatar">${X(ov(e.name||e.email))}</span>
      ...
      <span class="team-role" data-role="${X(r)}">${X(Ie[r]?.label||r)}</span>
    ...
    </div>`}async function Y_(e,t){let{uid:n,email:r}=e.dataset;if(window.confirm(`Revoke the invitation for ${r}?\n\nThe invitation link stops working immediately, including any copy already sent. You can invite this address again afterwards.`)){e.disabled=!0;try{let e=w.getConfig?.().BASE_URL||``,i=await fetch(`${e}/m5t/v5/acctGroup/${encodeURIComponent(t.guid)}/invites/${encodeURIComponent(n)}`,{method:`DELETE`}),a=await i.json().catch(()=>({}));if(!i.ok||!a.ok)throw Error(a.message||a.error||`HTTP ${i.status}`);av(`Invitation for ${r} revoked`,`success`)}catch(t){e.disabled=!1,av(t.message||`Could not revoke that invitation.`,`error`);return}try{await $_(t)}catch{}}}async function X_(e,t){let{id:n,name:r}=e.dataset;if(window.confirm(`Remove ${r} from the team?\n\nThey lose access to this workspace immediately. Their account itself is not deleted, and you can invite them again later.`)){e.disabled=!0;try{let e=w.getConfig?.().BASE_URL||``,t=await fetch(`${e}/m5t/v5/acctGroupMember/${encodeURIComponent(n)}`,{method:`DELETE`}),i=await t.json().catch(()=>({}));if(!t.ok||!i.ok)throw Error(i.message||i.error||`HTTP ${t.status}`);av(`${r} removed from the team`,`success`)}catch(t){e.disabled=!1,av(t.message||`Could not remove that member.`,`error`);return}try{await $_(t)}catch{}}}function Z_(){return K_(),`
    <div class="page-shell" data-section="team">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="team-body">
          ${q_(`hourglass_empty`,`Loading team…`)}
        </div>
      </div>
    </div>`}async function Q_(){let e=W_(),t=document.getElementById(`team-invite-btn`);if(!e){t&&(t.style.display=`none`),document.getElementById(`team-body`).innerHTML=q_(`info`,`Team management is available for agency and workspace accounts.`);return}t?.addEventListener(`click`,()=>ev(e)),await $_(e)}async function $_(e){let t=document.getElementById(`team-body`),n=document.getElementById(`team-count`);if(t)try{let r=w.getConfig?.().BASE_URL||``,[i,a]=await Promise.all([fetch(`${r}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/members`),fetch(`${r}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/invites`)]),[o,s]=await Promise.all([i.json().catch(()=>({})),a.json().catch(()=>({}))]);if(!i.ok||!a.ok)throw Error(`Failed to load team (members: ${i.status}, invites: ${a.status})`);let c=o.members||[],l=s.invites||[],u=G_(e.memberRole).length>0;t.innerHTML=(l.length?`
    ...
    <div class="team-modal__body" id="team-invite-body">
      ...
      <div class="team-modal__actions">
        ...
        </div>`;let u=r.querySelector(`#tm-link`);r.querySelector(`#tm-copy`)?.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(u.value),r.querySelector(`#tm-copy`).textContent=`Copied!`}catch{u.select()}}),r.querySelector(`[data-act="done"]`)?.addEventListener(`click`,()=>{i(),$_(e)})}catch(e){console.warn(`[team] invite failed:`,e),o.textContent=e.message||`Something went wrong. Please try again.`,s.disabled=!1,s.innerHTML=l}})}var tv,nv,rv,iv,X,av,ov,sv,cv=o((()=>{T(),tv=u(f(),1),m(),Qe(),nv=`managed_client`,rv=!1,iv={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},X=e=>String(e??``).replace(/[&<>"']/g,e=>iv[e]),av=(e,t=`info`)=>{try{tv.default.publish(p.UI_TOAST,{message:e,type:t})}catch{}},ov=e=>String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]||``).join(``).toUpperCase()||`?`,sv={render:Z_,init:Q_}}));m(),we(),T(),Vt(),v(),xn(),On(),nt(),window.m5t=Object.create(null),window.m5t.pubsub=y.default,console.log(`StreamSyncEngage SaaS Client - Starting...`),console.log(`Environment:`,`production`),console.log(`Document readyState:`,document.readyState),console.log(`window.mvvLegit:`,typeof window.mvvLegit),console.log(`globalThis.mvvLegit:`,typeof globalThis.mvvLegit);try{console.log(`mvvLegit (direct):`,typeof mvvLegit)}catch(e){console.log(`mvvLegit (direct): ReferenceError -`,e.message)}var lv=Object.keys(window).filter(e=>e.toLowerCase().includes(`mvv`)||e.toLowerCase().includes(`neodigm`)||e.toLowerCase().includes(`legit`));console.log(`Possible Neodigm globals:`,lv);var Z=new te.default(`/`,{hash:!0});window.router=Z;function Q(e){let t=e?`${e.replace(/-/g,`_`)}_route`:`splash_route`;return console.log(`[Router] Checking access: ${e} -> ${t}`),mvvLegit.isRouteAllowed(t)?!0:(console.warn(`[Router] Access denied to route: ${t}`),y.default.publish(p.UI_TOAST,{message:`Please sign in to access this page`,type:`warning`}),!1)}function $(e){console.log(`[Router] Navigating to:`,e),Z.navigate(`/${e}`)}var uv=new Set([`splash`,`signin`,`signup`,`forgot`,`resethash`,`verf-link`,`accept-invite`,`signout`]),dv={},fv={},pv=null,mv={admin:{caption:`Platform Admin`,icon:`shield_person`},reseller:{caption:`Reseller`,icon:`handshake`},managed:{caption:`Managed`,icon:`visibility`},self_serve:{caption:`Self-Serve`,icon:`rocket_launch`}},hv=`__portfolio__`;function gv(){try{Z._setCurrent(null)}catch{}Z.resolve()}function _v(){let e=document.getElementById(`m5t-side-nav`);if(!e)return;let t=!w.getScope()&&w.isAuthenticated(),n=w.getCapabilities(),r=w.getUiMode(),i=Kt.getSideNav(n,{uiMode:r});dv={},fv={};let a=e=>{e.route&&(dv[e.route]={sectionToken:e.token,childToken:null,children:e.children||null},Array.isArray(e.children)&&e.children.forEach(t=>{t.route&&(fv[t.token]=t.route,dv[t.route]={sectionToken:e.token,childToken:t.token,children:e.children})}))},o=e=>e.forEach(e=>{e.group&&Array.isArray(e.items)?o(e.items):a(e)});o(i);let s=w.getMemberships(),c=w.getActiveOrg(),l=w.getManagedClients(),u=w.getStoredActiveOrg(),d=l.length?[{guid:hv,name:`Portfolio (all clients)`},...s.map(e=>({guid:e.orgGuid,name:e.name||e.channel,channel:e.channel,group:`Your organization`})),...l.map(e=>({guid:e.orgGuid,name:e.name||e.orgGuid,channel:e.channel,group:`Clients`}))]:s.map(e=>({guid:e.orgGuid,name:e.name||e.channel,channel:e.channel}));e.setState({buttons:i,orgs:d,activeOrg:l.length?u||hv:c?.guid||null,footerBadge:mv[r]||null,loading:t}),yv(),pv&&bv(pv)}var vv=e=>String(e??``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]);function yv(){let e=document.getElementById(`app-content`);if(!e)return;let t=document.getElementById(`org-context-banner`);t||(t=document.createElement(`div`),t.id=`org-context-banner`,e.insertBefore(t,e.firstChild),fn(t));let n=w.getActiveOrg(),r=w.isPreviewingAsClient(),i=!!n?.viaSubtree&&!!pv&&!uv.has(pv);if(t.hidden=!i,!i){t.innerHTML=``;return}let a=vv(n.name||`Client`);t.innerHTML=`
    <style>
    ...
    <div class="ocb" role="status">
    ...
    </div>`,t.querySelector(`[data-ocb="preview"]`)?.addEventListener(`click`,()=>{w.setPreviewAsClient(!w.isPreviewingAsClient()),gv()}),t.querySelector(`[data-ocb="portfolio"]`)?.addEventListener(`click`,()=>{w.setPreviewAsClient(!1),w.setActiveOrg(null)})}function bv(e){let t=document.getElementById(`m5t-side-nav`),n=dv[`/${e}`]||dv[e]||null;t?.setActiveToken(n?.sectionToken||null),xv(n)}function xv(e){let t=document.getElementById(`m5t-sub-nav`),n=document.getElementById(`app-shell`);if(!t)return;let r=e?.children;t.hidden=!1,r&&r.length>1?(t.updateButtons(r.map(t=>({token:t.token,caption:t.caption,enabled:!0,selected:t.token===e.childToken}))),n?.classList.add(`has-sub-nav`)):(t.updateButtons([]),n?.classList.remove(`has-sub-nav`))}function Sv(){let e=Bt.getAvailableLanguages&&Bt.getAvailableLanguages()||[];if(e.length<2){y.default.publish(p.UI_TOAST,{message:`Only one language is available`,type:`info`});return}let t=localStorage.getItem(_.FF_SSE_LS_USER_LANG)||_.FF_SSE_I18N_LANG||e[0],n=e[(e.indexOf(t)+1)%e.length];Bt.setLanguage(n),y.default.publish(p.UI_TOAST,{message:`Language: ${n}`,type:`info`})}function Cv(){document.documentElement.classList.toggle(`ff-no-animations`,yn())}function wv(){let e=document.getElementById(`m5t-side-nav`);if(!e)return;Kt.setAppToken(`client-saas`),bn(e),document.getElementById(`app-shell`)?.classList.toggle(`nav-collapsed`,e.getAttribute(`data-collapsed`)===`true`),e.addEventListener(`nav-select`,e=>{let t=e.detail?.route;t&&Z.navigate(t.startsWith(`/`)?t:`/${t}`)}),e.addEventListener(`logo-click`,()=>Z.navigate(`/home`)),e.addEventListener(`nav-collapse`,e=>{document.getElementById(`app-shell`)?.classList.toggle(`nav-collapsed`,!!e.detail?.collapsed)}),e.addEventListener(`org-switch`,e=>{let t=e.detail?.orgGuid;t&&w.setActiveOrg(t===hv?null:t)}),e.addEventListener(`footer-action`,e=>{switch(e.detail?.action){case`account`:Z.navigate(`/settings`);break;case`signout`:Z.navigate(`/signout`);break;case`lang`:Sv();break;case`theme`:En()}}),document.getElementById(`m5t-sub-nav`)?.addEventListener(`nav-select`,e=>{let t=fv[e.detail?.token];t&&Z.navigate(t)}),document.addEventListener(`language-changed`,()=>_v()),_v(),y.default.subscribe(p.AUTH_SCOPE_LOADED,()=>_v());let t=()=>{let e=w.getScope();return[e?.uiMode,e?.activeOrg?.guid,(e?.managedClients||[]).length,(e?.capabilities||[]).join(`,`),w.getStoredActiveOrg()].join(`|`)},n=t();y.default.subscribe(p.AUTH_SCOPE_LOADED,()=>{let e=t();e!==n&&(n=e,pv&&!uv.has(pv)&&gv())})}function Tv(e){pv=e;let t=document.getElementById(`m5t-side-nav`),n=document.getElementById(`app-shell`);if(!t||!n)return;let r=!uv.has(e);if(t.hidden=!r,n.classList.toggle(`has-side-nav`,r),cn(r),r)bv(e);else{let e=document.getElementById(`m5t-sub-nav`);e&&(e.hidden=!0),n.classList.remove(`has-sub-nav`)}yv()}y.default.subscribe(p.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&Tv(t.route)});var Ev=()=>{console.log(`[Router] Route: splash`),y.default.publish(p.ROUTE_NAV_BEFORE,{route:`splash`});let e=be()?.name;S(e===`invite`?()=>Promise.resolve().then(()=>(In(),kn)):e===`questionnaire`?()=>Promise.resolve().then(()=>(Cr(),lr)):e===`deliverable`?()=>Promise.resolve().then(()=>(Qr(),Nr)):()=>Promise.resolve().then(()=>(ri(),$r)),void 0,import.meta.url).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`splash`})}).catch(e=>{console.error(`[Router] Error loading splash route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`splash`,error:e})})};Z.on(`/`,Ev),Z.on(`/splash`,Ev),Z.on(`/signin`,()=>{console.log(`[Router] Route: /signin`),y.default.publish(p.ROUTE_NAV_BEFORE,{route:`signin`}),S(()=>Promise.resolve().then(()=>(hi(),ci)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`signin`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading signin route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`signin`,error:e})})}),Z.on(`/signup`,()=>{console.log(`[Router] Route: /signup`),y.default.publish(p.ROUTE_NAV_BEFORE,{route:`signup`}),S(()=>Promise.resolve().then(()=>(Oi(),yi)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`signup`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading signup route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`signup`,error:e})})}),Z.on(`/verf-link`,()=>{console.log(`[Router] Route: /verf-link`),y.default.publish(p.ROUTE_NAV_BEFORE,{route:`verf-link`}),S(()=>Promise.resolve().then(()=>(Mi(),ki)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`verf-link`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading verf-link route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`verf-link`,error:e})})}),Z.on(`/forgot`,()=>{console.log(`[Router] Route: /forgot`),y.default.publish(p.ROUTE_NAV_BEFORE,{route:`forgot`}),S(()=>Promise.resolve().then(()=>(Ui(),Ri)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`forgot`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading forgot route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`forgot`,error:e})})}),Z.on(`/resethash`,()=>{if(console.log(`[Router] Route: /resethash`),!Q(`resethash`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`resethash`}),S(()=>Promise.resolve().then(()=>(Yi(),Wi)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`resethash`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading resethash route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`resethash`,error:e})})}),Z.on(`/home`,()=>{if(console.log(`[Router] Route: /home`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`home`}),S(()=>Promise.resolve().then(()=>(Ja(),xa)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`home`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading home route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`home`,error:e})})}),Z.on(`/signout`,()=>{if(console.log(`[Router] Route: /signout`),!Q(`signout`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`signout`}),S(()=>Promise.resolve().then(()=>(Qa(),Ya)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`signout`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading signout route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`signout`,error:e})})}),[{path:`/billing`,name:`billing`,title:`Billing`,icon:`receipt_long`},{path:`/magnets/drafts`,name:`magnets/drafts`,title:`Magnets · Drafts`,icon:`widgets`},{path:`/magnets/archived`,name:`magnets/archived`,title:`Magnets · Archived`,icon:`widgets`},{path:`/analytics/conversions`,name:`analytics/conversions`,title:`Analytics · Conversions`,icon:`monitoring`}].forEach(({path:e,name:t,title:n,icon:r})=>{Z.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:t}),S(()=>Promise.resolve().then(()=>(ao(),$a)).then(e=>{let i=document.getElementById(`app`);i.innerHTML=e.render({title:n,icon:r,name:t}),e.init&&e.init({name:t}),y.default.publish(p.ROUTE_NAV_AFTER,{route:t})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading section route (${t}):`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:t,error:e})})})}),Z.on(`/settings`,()=>{if(console.log(`[Router] Route: /settings`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings`}),S(()=>Promise.resolve().then(()=>(Ao(),oo)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`settings`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-general route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`settings`,error:e})})}),Z.on(`/settings/workspace`,()=>{if(console.log(`[Router] Route: /settings/workspace`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/workspace`}),S(()=>Promise.resolve().then(()=>(ss(),jo)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/workspace`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-workspace route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/workspace`,error:e})})}),Z.on(`/settings/notifications`,()=>{if(console.log(`[Router] Route: /settings/notifications`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/notifications`}),S(()=>Promise.resolve().then(()=>(Ms(),cs)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/notifications`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-notifications route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/notifications`,error:e})})}),Z.on(`/settings/integrations`,()=>{if(console.log(`[Router] Route: /settings/integrations`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/integrations`}),S(()=>Promise.resolve().then(()=>(Nc(),Sc)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/integrations`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-integrations route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/integrations`,error:e})})}),Z.on(`/settings/integrations/:provider`,e=>{let t=e?.data?.provider||``;if(console.log(`[Router] Route: /settings/integrations/`+t),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/integrations`}),S(()=>Promise.resolve().then(()=>(Zc(),Pc)).then(e=>{let n=document.getElementById(`app`);n.innerHTML=e.render({provider:t}),e.init&&e.init({provider:t}),y.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/integrations`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading integration detail route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/integrations`,error:e})})}),Z.on(`/settings/security`,()=>{if(console.log(`[Router] Route: /settings/security`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`settings/security`}),S(()=>Promise.resolve().then(()=>(Sl(),Qc)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`settings/security`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading settings-security route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`settings/security`,error:e})})}),Z.on(`/conversations`,()=>{if(console.log(`[Router] Route: /conversations`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`conversations`}),S(()=>Promise.resolve().then(()=>(Kl(),Cl)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`conversations`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading conversations route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`conversations`,error:e})})}),Z.on(`/ab-testing`,()=>{if(console.log(`[Router] Route: /ab-testing`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`ab-testing`}),S(()=>Promise.resolve().then(()=>(vu(),ql)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`ab-testing`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading ab-testing route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`ab-testing`,error:e})})}),Z.on(`/magnets`,()=>{if(console.log(`[Router] Route: /magnets`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`magnets`}),S(()=>Promise.resolve().then(()=>(Rp(),$d)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`magnets`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading magnets route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`magnets`,error:e})})}),Z.on(`/templates`,()=>{if(console.log(`[Router] Route: /templates`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`templates`}),S(()=>Promise.resolve().then(()=>(Zp(),zp)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`templates`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading templates route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`templates`,error:e})})}),Z.on(`/questionnaires`,()=>{if(console.log(`[Router] Route: /questionnaires`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`questionnaires`}),S(()=>Promise.resolve().then(()=>(Cm(),Qp)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`questionnaires`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading questionnaires route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`questionnaires`,error:e})})}),Z.on(`/deliverables`,()=>{if(console.log(`[Router] Route: /deliverables`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`deliverables`});let e=w.getUiMode?.();S(e===`reseller`||e===`admin`?()=>Promise.resolve().then(()=>(ah(),wm)):()=>Promise.resolve().then(()=>(yh(),oh)),void 0,import.meta.url).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`deliverables`})}).catch(e=>{console.error(`[Router] Error loading deliverables route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`deliverables`,error:e})})}),Z.on(`/leads`,()=>{if(console.log(`[Router] Route: /leads`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`leads`}),S(()=>Promise.resolve().then(()=>(ag(),bh)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`leads`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading leads route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`leads`,error:e})})}),Z.on(`/analytics`,()=>{if(console.log(`[Router] Route: /analytics`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`analytics`}),S(()=>Promise.resolve().then(()=>(Tg(),og)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`analytics`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading analytics route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`analytics`,error:e})})}),Z.on(`/analytics/ad-performance`,()=>{if(console.log(`[Router] Route: /analytics/ad-performance`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`analytics/ad-performance`}),S(()=>Promise.resolve().then(()=>(Yg(),Eg)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`analytics/ad-performance`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading ad-performance route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`analytics/ad-performance`,error:e})})}),Z.on(`/ad-accounts`,()=>{if(console.log(`[Router] Route: /ad-accounts`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`ad-accounts`}),S(()=>Promise.resolve().then(()=>(v_(),Xg)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`ad-accounts`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading ad-accounts route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`ad-accounts`,error:e})})}),Z.on(`/clients`,()=>{if(console.log(`[Router] Route: /clients`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`clients`}),S(()=>Promise.resolve().then(()=>(H_(),y_)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`clients`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading clients route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`clients`,error:e})})}),Z.on(`/team`,()=>{if(console.log(`[Router] Route: /team`),!Q(`home`)){$(`signin`);return}y.default.publish(p.ROUTE_NAV_BEFORE,{route:`team`}),S(()=>Promise.resolve().then(()=>(cv(),U_)).then(e=>{let t=document.getElementById(`app`);t.innerHTML=e.render(),e.init&&e.init(),y.default.publish(p.ROUTE_NAV_AFTER,{route:`team`})}),void 0,import.meta.url).catch(e=>{console.error(`[Router] Error loading team route:`,e),y.default.publish(p.ROUTE_NAV_ERROR,{route:`team`,error:e})})}),Z.notFound(()=>{console.log(`[Router] Route not found - redirecting to splash`),$(`splash`)}),y.default.subscribe(p.ROUTE_NAV,(e,t)=>{console.log(`[Router] ROUTE_NAV event received:`,t),t?.route&&$(t.route)});function Dv(){console.log(`[App] Waiting for Neodigm 55 library...`);let e=0,t=setInterval(()=>{e++,e%10==0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<`u`,neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<`u`?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(t),Ov()):e>=100&&(clearInterval(t),console.error(`[App] Failed to load Neodigm 55 library after 10 seconds`),console.error(`[App] Check browser console for CORS or network errors`),document.getElementById(`app`).innerHTML=`
      ...
      `,y.default.publish(p.APP_ERROR,{message:`Failed to load authentication library`}))},100)}document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,Dv):Dv();async function Ov(){if(console.log(`[App] Neodigm 55 loaded, initializing...`),Cn(),Cv(),ue(),Bt.initialize(),console.log(`[App] I18n Controller initialized`),!await w.init({BASE_URL:`https://machfivemagnet-saas.onrender.com`,navigateFunction:e=>{console.log(`[AuthController] Navigation requested:`,e),$(e)}})){console.error(`[App] AuthController initialization failed`);return}let e=w.getEntity();e&&(console.log(`[App] Session restored for:`,e.email),y.default.publish(p.APP_USER_LOADED,{entity:e}),w.isAuthenticated()&&(localStorage.getItem(w.CONFIG.LS_KEYS.ACTIVE_ORG)?await w.fetchScope():w.fetchScope())),y.default.publish(p.APP_READY,{timestamp:new Date().toISOString(),sessionUser:e}),wv(),gn(),Z.resolve(),window.AuthController=w,window.I18nController=Bt,window.MachVive=Ht,console.log(`[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)`)}y.default.subscribe(p.ROUTE_NAV_AFTER,(e,t)=>{Bt!==void 0&&Bt.refresh&&setTimeout(()=>{Bt.refresh()},100)});
