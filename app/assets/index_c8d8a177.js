(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const Vs="modulepreload",js=function(e){return"/"+e},on={},K=function(t,a,n){let o=Promise.resolve();if(a&&a.length>0){let l=function(c){return Promise.all(c.map(m=>Promise.resolve(m).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),i=r?.nonce||r?.getAttribute("nonce");o=l(a.map(c=>{if(c=js(c),c in on)return;on[c]=!0;const m=c.endsWith(".css"),f=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${f}`))return;const _=document.createElement("link");if(_.rel=m?"stylesheet":Vs,m||(_.as="script"),_.crossOrigin="",_.href=c,i&&_.setAttribute("nonce",i),document.head.appendChild(_),m)return new Promise((v,w)=>{_.addEventListener("load",v),_.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${c}`)))})}))}function s(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return o.then(r=>{for(const i of r||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})};var Ws=/([:*])(\w+)/g,Ys="([^/]+)",Js=/\*/g,Ks="?(?:.*)",Xs=/\/\?/g,Qs="/?([^/]+|)",Zs="(?:/^|^)",er="";function go(e){return e===void 0&&(e="/"),Pa()?location.pathname+location.search+location.hash:e}function W(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function zt(e){return typeof e=="string"}function tr(e){return typeof e=="function"}function Gt(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function ar(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(a,n,o){return a===null&&(a={}),a[t[o]]=decodeURIComponent(n),a},null)}function qt(e){var t=W(e).split(/\?(.*)?$/);return[W(t[0]),t.slice(1).join("")]}function Ma(e){for(var t={},a=e.split("&"),n=0;n<a.length;n++){var o=a[n].split("=");if(o[0]!==""){var s=decodeURIComponent(o[0]);t[s]?(Array.isArray(t[s])||(t[s]=[t[s]]),t[s].push(decodeURIComponent(o[1]||""))):t[s]=decodeURIComponent(o[1]||"")}}return t}function ho(e,t){var a=qt(W(e.currentLocationPath)),n=a[0],o=a[1],s=o===""?null:Ma(o),r=[],i;if(zt(t.path)){if(i=Zs+W(t.path).replace(Ws,function(f,_,v){return r.push(v),Ys}).replace(Js,Ks).replace(Xs,Qs)+"$",W(t.path)===""&&W(n)==="")return{url:n,queryString:o,hashString:Gt(e.to),route:t,data:null,params:s}}else i=t.path;var l=new RegExp(i,er),c=n.match(l);if(c){var m=zt(t.path)?ar(c,r):c.groups?c.groups:c.slice(1);return{url:W(n.replace(new RegExp("^"+e.instance.root),"")),queryString:o,hashString:Gt(e.to),route:t,data:m,params:s}}return!1}function fo(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function Xe(e,t){return typeof e[t]>"u"||e[t]===!0}function nr(e){if(!e)return{};var t=e.split(","),a={},n;return t.forEach(function(o){var s=o.split(":").map(function(r){return r.replace(/(^ +| +$)/g,"")});switch(s[0]){case"historyAPIMethod":a.historyAPIMethod=s[1];break;case"resolveOptionsStrategy":n||(n={}),n.strategy=s[1];break;case"resolveOptionsHash":n||(n={}),n.hash=s[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":a[s[0]]=s[1]==="true";break}}),n&&(a.resolveOptions=n),a}function Pa(){return typeof window<"u"}function or(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(a){return a}).forEach(function(a){["before","after","already","leave"].forEach(function(n){a[n]&&(t[n]||(t[n]=[]),t[n].push(a[n]))})}),t}function Ce(e,t,a){var n=t||{},o=0;(function s(){if(!e[o]){a&&a(n);return}Array.isArray(e[o])?(e.splice.apply(e,[o,1].concat(e[o][0](n)?e[o][1]:e[o][2])),s()):e[o](n,function(r){typeof r>"u"||r===!0?(o+=1,s()):a&&a(n)})})()}Ce.if=function(e,t,a){return Array.isArray(t)||(t=[t]),Array.isArray(a)||(a=[a]),[e,t,a]};function sn(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=go(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function da(e,t){for(var a=0;a<e.instance.routes.length;a++){var n=e.instance.routes[a],o=ho(e,n);if(o&&(e.matches||(e.matches=[]),e.matches.push(o),e.resolveOptions.strategy==="ONE")){t();return}}t()}function sr(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function rr(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var rn=Pa(),ir=fo();function lr(e,t){if(Xe(e.navigateOptions,"updateBrowserURL")){var a=("/"+e.to).replace(/\/\//g,"/"),n=rn&&e.resolveOptions&&e.resolveOptions.hash===!0;ir?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",n?"#"+a:a),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!n){var o=location.hash;location.hash="",location.hash=o}e.instance.__freezeListening=!1},1))):rn&&(window.location.href=e.to)}t()}function vo(e,t){var a=e.instance;if(!a.lastResolved()){t();return}Ce(a.lastResolved().map(function(n){return function(o,s){if(!n.route.hooks||!n.route.hooks.leave){s();return}var r=!1,i=e.instance.matchLocation(n.route.path,e.currentLocationPath,!1);if(n.route.path!=="*")r=!i;else{var l=e.matches?e.matches.find(function(c){return n.route.path===c.route.path}):!1;r=!l}if(Xe(e.navigateOptions,"callHooks")&&r){Ce(n.route.hooks.leave.map(function(c){return function(m,f){return c(function(_){_===!1?e.instance.__markAsClean(e):f()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return s()}]));return}else s()}}),{},function(){return t()})}function cr(e,t){e.match.route.hooks&&e.match.route.hooks.before&&Xe(e.navigateOptions,"callHooks")?Ce(e.match.route.hooks.before.map(function(a){return function(o,s){return a(function(r){r===!1?e.instance.__markAsClean(e):s()},e.match)}}).concat([function(){return t()}])):t()}function dr(e,t){Xe(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function pr(e,t){e.match.route.hooks&&e.match.route.hooks.after&&Xe(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(a){return a(e.match)}),t()}function ur(e,t){var a=e.instance.lastResolved();if(a&&a[0]&&a[0].route===e.match.route&&a[0].url===e.match.url&&a[0].queryString===e.match.queryString){a.forEach(function(n){n.route.hooks&&n.route.hooks.already&&Xe(e.navigateOptions,"callHooks")&&n.route.hooks.already.forEach(function(o){return o(e.match)})}),t(!1);return}t()}function mr(e,t){var a=e.instance._notFoundRoute;if(a){e.notFoundHandled=!0;var n=qt(e.currentLocationPath),o=n[0],s=n[1],r=Gt(e.to);a.path=W(o);var i={url:a.path,queryString:s,hashString:r,data:null,route:a,params:s!==""?Ma(s):null};e.matches=[i],e.match=i}t()}function gr(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function hr(e,t){e.instance._setCurrent(null),t()}function bo(e,t){Xe(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var _o=[ur,cr,dr,pr],ln=[vo,mr,Ce.if(function(e){var t=e.notFoundHandled;return t},_o.concat([bo]),[gr,hr])];function _a(){return _a=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},_a.apply(this,arguments)}function cn(e,t){var a=0;function n(){if(a===e.matches.length){bo(e,t);return}Ce(_o,_a({},e,{match:e.matches[a]}),function(){a+=1,n()})}vo(e,n)}function pa(e){e.instance.__markAsClean(e)}function ya(){return ya=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},ya.apply(this,arguments)}var dn="[data-navigo]";function fr(e,t){var a=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:dn},n=this,o="/",s=null,r=[],i=!1,l,c=fo(),m=Pa();e?o=W(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function f(g){return g.indexOf("#")>=0&&(a.hash===!0?g=g.split("#")[1]||"/":g=g.split("#")[0]),g}function _(g){return W(o+"/"+W(g))}function v(g,E,$,H){return g=zt(g)?_(g):g,{name:H||W(String(g)),path:g,handler:E,hooks:or($)}}function w(g,E,$){var H=this;return typeof g=="object"&&!(g instanceof RegExp)?(Object.keys(g).forEach(function(M){if(typeof g[M]=="function")H.on(M,g[M]);else{var ye=g[M],Ge=ye.uses,A=ye.as,D=ye.hooks;r.push(v(M,Ge,[l,D],A))}}),this):(typeof g=="function"&&($=E,E=g,g=o),r.push(v(g,E,[l,$])),this)}function d(g,E){if(n.__dirty){n.__waiting.push(function(){return n.resolve(g,E)});return}else n.__dirty=!0;g=g?W(o)+"/"+W(g):void 0;var $={instance:n,to:g,currentLocationPath:g,navigateOptions:{},resolveOptions:ya({},a,E)};return Ce([sn,da,Ce.if(function(H){var M=H.matches;return M&&M.length>0},cn,ln)],$,pa),$.matches?$.matches:!1}function h(g,E){if(n.__dirty){n.__waiting.push(function(){return n.navigate(g,E)});return}else n.__dirty=!0;g=W(o)+"/"+W(g);var $={instance:n,to:g,navigateOptions:E||{},resolveOptions:E&&E.resolveOptions?E.resolveOptions:a,currentLocationPath:f(g)};Ce([sr,rr,da,Ce.if(function(H){var M=H.matches;return M&&M.length>0},cn,ln),lr,pa],$,pa)}function y(g,E,$){var H=$e(g,E);return H!==null?(h(H.replace(new RegExp("^/?"+o),""),$),!0):!1}function k(g){return this.routes=r=r.filter(function(E){return zt(g)?W(E.path)!==W(g):tr(g)?g!==E.handler:String(E.path)!==String(g)}),this}function R(){c&&(this.__popstateListener=function(){n.__freezeListening||d()},window.addEventListener("popstate",this.__popstateListener))}function U(){this.routes=r=[],c&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=i=!0}function ne(g,E){return n._notFoundRoute=v("*",g,[l,E],"__NOT_FOUND__"),this}function Y(){if(m)return ce().forEach(function(g){if(g.getAttribute("data-navigo")==="false"||g.getAttribute("target")==="_blank"){g.hasListenerAttached&&g.removeEventListener("click",g.navigoHandler);return}g.hasListenerAttached||(g.hasListenerAttached=!0,g.navigoHandler=function(E){if((E.ctrlKey||E.metaKey)&&E.target.tagName.toLowerCase()==="a")return!1;var $=g.getAttribute("href");if(typeof $>"u"||$===null)return!1;if($.match(/^(http|https)/)&&typeof URL<"u")try{var H=new URL($);$=H.pathname+H.search}catch{}var M=nr(g.getAttribute("data-navigo-options"));i||(E.preventDefault(),E.stopPropagation(),n.navigate(W($),M))},g.addEventListener("click",g.navigoHandler))}),n}function ce(){return m?[].slice.call(document.querySelectorAll(a.linksSelector||dn)):[]}function xe(g){return"/"+o+"/"+W(g)}function de(g){return l=g,this}function Pe(){return s}function $e(g,E,$){var H=r.find(function(Ge){return Ge.name===g}),M=null;if(H){if(M=H.path,E)for(var ye in E)M=M.replace(":"+ye,E[ye]);M=M.match(/^\//)?M:"/"+M}return M&&$&&!$.includeRoot&&(M=M.replace(new RegExp("^/"+o),"")),M}function N(g){return g.getAttribute("href")}function I(g){var E=qt(W(g)),$=E[0],H=E[1],M=H===""?null:Ma(H),ye=Gt(g),Ge=v($,function(){},[l],$);return{url:$,queryString:H,hashString:ye,route:Ge,data:null,params:M}}function V(){return I(W(go(o)).replace(new RegExp("^"+o),""))}function Le(g){var E={instance:n,currentLocationPath:g,to:g,resolveOptions:a};return da(E,function(){}),E.matches?E.matches:!1}function Tt(g,E,$){typeof E<"u"&&(typeof $>"u"||$)&&(E=_(E));var H={instance:n,to:E,currentLocationPath:E};sn(H,function(){}),typeof g=="string"&&(g=typeof $>"u"||$?_(g):g);var M=ho(H,{name:String(g),path:g,handler:function(){},hooks:{}});return M||!1}function ze(g,E,$){return typeof E=="string"&&(E=pt(E)),E?(E.hooks[g]||(E.hooks[g]=[]),E.hooks[g].push($),function(){E.hooks[g]=E.hooks[g].filter(function(H){return H!==$})}):(console.warn("Route doesn't exists: "+E),function(){})}function pt(g){return typeof g=="string"?r.find(function(E){return E.name===_(g)}):r.find(function(E){return E.handler===g})}function la(g){g.instance.__dirty=!1,g.instance.__waiting.length>0&&g.instance.__waiting.shift()()}this.root=o,this.routes=r,this.destroyed=i,this.current=s,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=la,this.on=w,this.off=k,this.resolve=d,this.navigate=h,this.navigateByName=y,this.destroy=U,this.notFound=ne,this.updatePageLinks=Y,this.link=xe,this.hooks=de,this.extractGETParameters=function(g){return qt(f(g))},this.lastResolved=Pe,this.generate=$e,this.getLinkPath=N,this.match=Le,this.matchLocation=Tt,this.getCurrentLocation=V,this.addBeforeHook=ze.bind(this,"before"),this.addAfterHook=ze.bind(this,"after"),this.addAlreadyHook=ze.bind(this,"already"),this.addLeaveHook=ze.bind(this,"leave"),this.getRoute=pt,this._pathToMatchObject=I,this._clean=W,this._checkForAHash=f,this._setCurrent=function(g){return s=n.current=g},R.call(this),Y.call(this)}var vr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function br(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var ft={exports:{}},_r=ft.exports,pn;function yr(){return pn||(pn=1,(function(e,t){(function(a,n){var o={};a.PubSub?(o=a.PubSub,console.warn("PubSub already loaded, using existing version")):(a.PubSub=o,n(o)),e!==void 0&&e.exports&&(t=e.exports=o),t.PubSub=o,e.exports=t=o})(typeof window=="object"&&window||_r||vr,function(a){var n={},o=-1,s="*";function r(d){var h;for(h in d)if(Object.prototype.hasOwnProperty.call(d,h))return!0;return!1}function i(d){return function(){throw d}}function l(d,h,y){try{d(h,y)}catch(k){setTimeout(i(k),0)}}function c(d,h,y){d(h,y)}function m(d,h,y,k){var R=n[h],U=k?c:l,ne;if(Object.prototype.hasOwnProperty.call(n,h))for(ne in R)Object.prototype.hasOwnProperty.call(R,ne)&&U(R[ne],d,y)}function f(d,h,y){return function(){var R=String(d),U=R.lastIndexOf(".");for(m(d,d,h,y);U!==-1;)R=R.substr(0,U),U=R.lastIndexOf("."),m(d,R,h,y);m(d,s,h,y)}}function _(d){var h=String(d),y=!!(Object.prototype.hasOwnProperty.call(n,h)&&r(n[h]));return y}function v(d){for(var h=String(d),y=_(h)||_(s),k=h.lastIndexOf(".");!y&&k!==-1;)h=h.substr(0,k),k=h.lastIndexOf("."),y=_(h);return y}function w(d,h,y,k){d=typeof d=="symbol"?d.toString():d;var R=f(d,h,k),U=v(d);return U?(y===!0?R():setTimeout(R,0),!0):!1}a.publish=function(d,h){return w(d,h,!1,a.immediateExceptions)},a.publishSync=function(d,h){return w(d,h,!0,a.immediateExceptions)},a.subscribe=function(d,h){if(typeof h!="function")return!1;d=typeof d=="symbol"?d.toString():d,Object.prototype.hasOwnProperty.call(n,d)||(n[d]={});var y="uid_"+String(++o);return n[d][y]=h,y},a.subscribeAll=function(d){return a.subscribe(s,d)},a.subscribeOnce=function(d,h){var y=a.subscribe(d,function(){a.unsubscribe(y),h.apply(this,arguments)});return a},a.clearAllSubscriptions=function(){n={}},a.clearSubscriptions=function(h){var y;for(y in n)Object.prototype.hasOwnProperty.call(n,y)&&y.indexOf(h)===0&&delete n[y]},a.countSubscriptions=function(h){var y,k,R=0;for(y in n)if(Object.prototype.hasOwnProperty.call(n,y)&&y.indexOf(h)===0){for(k in n[y])R++;break}return R},a.getSubscriptions=function(h){var y,k=[];for(y in n)Object.prototype.hasOwnProperty.call(n,y)&&y.indexOf(h)===0&&k.push(y);return k},a.unsubscribe=function(d){var h=function(xe){var de;for(de in n)if(Object.prototype.hasOwnProperty.call(n,de)&&de.indexOf(xe)===0)return!0;return!1},y=typeof d=="string"&&(Object.prototype.hasOwnProperty.call(n,d)||h(d)),k=!y&&typeof d=="string",R=typeof d=="function",U=!1,ne,Y,ce;if(y){a.clearSubscriptions(d);return}for(ne in n)if(Object.prototype.hasOwnProperty.call(n,ne)){if(Y=n[ne],k&&Y[d]){delete Y[d],U=d;break}if(R)for(ce in Y)Object.prototype.hasOwnProperty.call(Y,ce)&&Y[ce]===d&&(delete Y[ce],U=!0)}return U}})})(ft,ft.exports)),ft.exports}var wr=yr();const p=br(wr),u=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV.GO",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN.GO",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP.GO",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT.GO",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT.GO",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH.GO",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",AUTH_SCOPE_LOADED:"AUTH.SCOPE.LOADED",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",M5T_SIDE_NAV:"M5T_SIDE_NAV",M5T_SIDE_NAV_TAP:"M5T_SIDE_NAV.TAP",M5T_SIDE_NAV_COLLAPSE:"M5T_SIDE_NAV.COLLAPSE",M5T_SIDE_NAV_LOGO_TAP:"M5T_SIDE_NAV.LOGO_TAP",M5T_SIDE_NAV_ORG_SWITCH:"M5T_SIDE_NAV.ORG_SWITCH",M5T_SIDE_NAV_FOOTER_ACTION:"M5T_SIDE_NAV.FOOTER_ACTION",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL",MESSAGE:"MESSAGE",MESSAGE_CREATE:"MESSAGE.CREATE",MESSAGE_CREATED:"MESSAGE.CREATED",MESSAGE_EDIT:"MESSAGE.EDIT",MESSAGE_UPDATED:"MESSAGE.UPDATED",MESSAGE_DELETE:"MESSAGE.DELETE",MESSAGE_DELETED:"MESSAGE.DELETED",MESSAGE_REFRESH:"MESSAGE.REFRESH"}),ua={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://machfivemagnet-saas.onrender.com"};var ma={};const z=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_USER_PREFS:"mvv_user_prefs",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_LS_LAST_ROUTE:"mvv_last_route",FF_SSE_API_DEBUG_LOGGING:!1,FF_SSE_API_TIMEOUT:3e4,FF_SSE_API_MAX_RETRIES:3,FF_SSE_API_CACHE_ENABLED:!0,FF_SSE_AUTH_TOKEN_EXPIRY_HOURS:6,FF_SSE_AUTH_AUTO_REFRESH:!1,FF_SSE_AUTH_SESSION_WARNING_MINUTES:5,FF_SSE_AUTH_REMEMBER_ME:!0,FF_SSE_AUTH_MAX_LOGIN_ATTEMPTS:5,FF_SSE_UI_DARK_MODE:!0,FF_SSE_UI_ANIMATIONS:!0,FF_SSE_FEATURE_SIGNUP_ENABLED:!0,FF_SSE_FEATURE_PASSWORD_RESET_ENABLED:!0,FF_SSE_FEATURE_EMAIL_VERIFICATION_ENABLED:!0,FF_SSE_FEATURE_PROFILE_EDIT_ENABLED:!0,FF_SSE_FEATURE_ANALYTICS_ENABLED:!1,FF_SSE_CACHE_TTL_MS:3e5,FF_SSE_COMPRESSION_ENABLED:!0,FF_SSE_MAX_PAYLOAD_SIZE_MB:50,FF_SSE_DEBUG_VERBOSE:!1,FF_SSE_DEBUG_REDUX_DEVTOOLS:!1,FF_SSE_DEBUG_PERFORMANCE:!1,FF_SSE_DEBUG_BYPASS_AUTH:!1,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_BUILD_MODE:"LOCAL",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel",FF_API_RATELIMIT_SIGNIN_ENFORCE:!1,FF_API_RATELIMIT_SIGNIN_IP_LIMIT:20,FF_API_RATELIMIT_SIGNIN_EMAIL_LIMIT:10,FF_API_RATELIMIT_FORGOT_ENFORCE:!1,FF_API_RATELIMIT_FORGOT_IP_LIMIT:15,FF_API_RATELIMIT_FORGOT_EMAIL_LIMIT:5,FF_API_RATELIMIT_CAPTURE_ENFORCE:!1,FF_API_RATELIMIT_CAPTURE_LIMIT:30,FF_API_RATELIMIT_EVENT_ENFORCE:!1,FF_API_RATELIMIT_EVENT_LIMIT:600,FF_API_RATELIMIT_CSP_PING_ENFORCE:!1,FF_API_RATELIMIT_CSP_PING_LIMIT:30,FF_API_RATELIMIT_WEBAUTHN_AUTH_ENFORCE:!1,FF_API_RATELIMIT_WEBAUTHN_AUTH_IP_LIMIT:20,FF_API_RATELIMIT_AUTHENTICATED_ENFORCE:!1,FF_API_RATELIMIT_AUTHENTICATED_LIMIT:600,FF_API_MAGNET_REQUIRE_ORIGIN_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_LIMIT:2e3});function yo(e,t=null){if(e in z)return z[e];if(typeof process<"u"&&ma&&ma[e]){const a=ma[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}if(typeof import.meta<"u"&&ua&&ua[e]){const a=ua[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}return t}function Fa(e){return yo(e,!1)===!0}function xr(){return{...z}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:z,getFlag:yo,isEnabled:Fa,getAllFlags:xr});const un={success:{border:"var(--color-success, #009473)",bg:"var(--color-success-soft, rgba(0,148,115,0.10))",icon:"check_circle"},danger:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},error:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},warning:{border:"var(--color-warning-ink, #7a5e00)",bg:"var(--color-warning-tint, rgba(245,223,77,0.16))",icon:"warning"},info:{border:"var(--color-info, #7BC4C4)",bg:"var(--color-info-soft, rgba(123,196,196,0.12))",icon:"info"}},Er=4500,wa=220;let Ne=null,mn=!1;function Ar(){if(mn)return;const e=document.createElement("style");e.id="m5t-toast-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),mn=!0}function Sr(){return Ne&&document.body.contains(Ne)||(Ne=document.createElement("div"),Ne.className="m5t-toast-stack",Ne.setAttribute("role","status"),Ne.setAttribute("aria-live","polite"),document.body.appendChild(Ne)),Ne}function kr(e){const t=e&&e.message;if(!t)return;Ar();const a=un[e.type]||un.info,n=document.createElement("div");n.className="m5t-toast",n.style.borderColor=a.border,n.style.background=a.bg,n.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true" style="color:${a.border}">${a.icon}</span><span class="m5t-toast__msg"></span><button type="button" class="m5t-toast__close" aria-label="Dismiss"><span class="material-symbols-outlined" aria-hidden="true">close</span></button>`,n.querySelector(".m5t-toast__msg").textContent=String(t),Sr().appendChild(n),requestAnimationFrame(()=>n.classList.add("is-in"));let s=!1;const r=()=>{s||(s=!0,clearTimeout(i),n.classList.remove("is-in"),n.classList.add("is-out"),setTimeout(()=>n.remove(),wa))},i=setTimeout(r,Er);n.querySelector(".m5t-toast__close").addEventListener("click",r)}function Tr(){const e=t=>a=>{const n=a.detail?.pubsubTopic;n&&p.publish(n,a.detail)};document.addEventListener("nav-select",e()),document.addEventListener("logo-click",e()),document.addEventListener("nav-hover",e()),document.addEventListener("nav-double-tap",e()),document.addEventListener("nav-long-tap",e()),document.addEventListener("message-sent",e())}function Cr(){console.log("[AppEvents] Initializing event listeners..."),p.subscribe(u.APP_READY,(a,n)=>{console.log("[AppEvents] APP_READY:",n)}),p.subscribe(u.APP_ERROR,(a,n)=>{console.error("[AppEvents] APP_ERROR:",n)}),p.subscribe(u.APP_SIGNOUT,(a,n)=>{console.log("[AppEvents] APP_SIGNOUT:",n)}),p.subscribe(u.ROUTE_NAV_BEFORE,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",n),p.publish(u.UI_LOADING_START)}),p.subscribe(u.ROUTE_NAV_AFTER,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",n),p.publish(u.UI_LOADING_END)}),p.subscribe(u.ROUTE_NAV_ERROR,(a,n)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",n),p.publish(u.APP_ERROR,{message:"Navigation error",details:n})}),p.subscribe(u.AUTH_SIGNIN_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",n)}),p.subscribe(u.AUTH_SIGNIN_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",n),p.publish(u.UI_TOAST,{message:n.message||"Sign in failed",type:"danger"})}),p.subscribe(u.AUTH_SIGNUP_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",n),p.publish(u.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"}),p.publish(u.AUTH_VERIFY_LINK)}),p.subscribe(u.AUTH_VERIFY_LINK,(a,n)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),p.subscribe(u.AUTH_SIGNUP_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",n),p.publish(u.UI_TOAST,{message:n.message||"Sign up failed",type:"danger"})}),p.subscribe(u.AUTH_SIGNOUT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",n),p.publish(u.UI_TOAST,{message:"Signed out successfully",type:"info"})}),p.subscribe(u.AUTH_SIGNUP,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),p.subscribe(u.AUTH_FORGOT,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),p.subscribe(u.AUTH_FORGOT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",n),p.publish(u.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),p.subscribe(u.AUTH_RESETHASH_NAV,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),p.subscribe(u.AUTH_RESETHASH_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",n),p.publish(u.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),p.subscribe(u.AUTH_TOKEN_EXPIRED,(a,n)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",n),p.publish(u.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),p.subscribe(u.I18N_SET_LANG,(a,n)=>{console.log("[AppEvents] I18N_SET_LANG:",n);const{langCode:o}=n;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),p.publish(u.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(s){console.error("[AppEvents] Error changing language:",s),p.publish(u.UI_TOAST,{message:`Failed to change language: ${s.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),p.subscribe("CONVERSATION.PROMPT",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",n.message),ga(n.message,"user",n.timestamp),p.publish(u.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Agent prompt (no implementation):",n.message);break;case"AGENT_CANVAS":console.log("[AppEvents] Display message in canvas:",n.message),ga(n.message,"user",n.timestamp),p.publish(u.CANVAS_DO_SCROLL);break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),p.subscribe("CONVERSATION.RESPONSE",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",n.message),ga(n.message,"assistant",n.timestamp,n.streaming);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),p.subscribe(u.UI_LOADING_START,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),p.subscribe(u.UI_LOADING_END,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),p.subscribe(u.UI_TOAST,(a,n)=>{kr(n)}),p.subscribe(u.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const a="0.1",n=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${a} 8/9/2026, 8:44:22 PM|© ${n} Mach Five Tech`,"night")}),Tr(),p.subscribe("M5T_PRIMARY_NAV",(a,n)=>{const o=a.split(".")[1];switch(o){case"TAP":e(n);break;case"LOGO_TAP":t();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function e(a){const{token:n,level:o,primaryToken:s}=a;switch(n){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),p.publish(u.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${n}`,{primaryToken:s});break}}function t(a){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 8/9/2026, 8:44:22 PM|© ${o} Mach Five Tech`,"night",5e3)}p.subscribe(u.AUTH_SIGNOUT,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(z.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function ga(e,t="user",a=null,n=!1){const o=document.getElementById("chat-messages");if(!o){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}if(a||(a=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})),n&&t==="assistant"){const r=o.firstElementChild;if(r&&r.tagName.toLowerCase()==="m5t-chat-response"){r.setAttribute("message",e),console.log(`[AppEvents] Updated streaming ${t} bubble (${e.length} chars)`);return}}let s;t==="user"||t==="prompt"?s=document.createElement("m5t-chat-prompt"):s=document.createElement("m5t-chat-response"),s.setAttribute("message",e),s.setAttribute("timestamp",a),o.prepend(s),console.log(`[AppEvents] Added ${t} bubble to canvas (${e.length} chars)`)}function wo(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("uid")&&t.get("token"))}const Ir=Object.freeze({admin_root_role:{value:100,desc:"Administrator superuser infrastructure architecture"},admin_business_role:{value:90,desc:"Administrator financial oversight"},admin_support_role:{value:80,desc:"Administrator maintenance and configuration"},admin_readonly_role:{value:70,desc:"Administrator information help desk"},client_tier_4_role:{value:40,desc:"Client paid tier 4 - Partner"},client_tier_3_role:{value:30,desc:"Client paid tier 3"},client_tier_2_role:{value:20,desc:"Client paid tier 2"},client_tier_1_role:{value:10,desc:"Client paid tier 1"},client_standard_role:{value:0,desc:"Client free tier 0"}});function $r(e){return Ir[e]||null}function Lr(e){return e>=50}const bt=Object.freeze({owner:{value:"owner",rank:30,label:"Owner"},admin:{value:"admin",rank:20,label:"Admin"},member:{value:"member",rank:10,label:"Member"},viewer:{value:"viewer",rank:0,label:"Viewer"}}),Rr=Object.freeze({VIEW_DASHBOARD:"view_dashboard",VIEW_MAGNETS:"view_magnets",PROVISION_MAGNETS:"provision_magnets",MANAGE_MAGNETS:"manage_magnets",VIEW_CONVERSATIONS:"view_conversations",VIEW_STATS:"view_stats",VIEW_AD_METRICS:"view_ad_metrics",CONNECT_AD_ACCOUNTS:"connect_ad_accounts",CREATE_CLIENT_ACCOUNTS:"create_client_accounts",MANAGE_TEAM:"manage_team",VIEW_BILLING:"view_billing",MANAGE_BILLING:"manage_billing"}),T=Rr,xo=Object.freeze(Object.values(T)),qe=Object.freeze([T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS]),Nr=Object.freeze({reseller_org:{owner:xo,admin:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.CREATE_CLIENT_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING],member:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS],viewer:qe},managed_client:{owner:[...qe,T.VIEW_BILLING],admin:[...qe,T.VIEW_BILLING],member:qe,viewer:qe},saas_org:{owner:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING,T.MANAGE_BILLING],admin:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING],member:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS],viewer:qe}});function Or(e){const t=$r(e);return!!t&&Lr(t.value)}function Mr({entityClass:e,orgChannel:t,memberRole:a}={}){if(Or(e))return e==="admin_readonly_role"?[...qe,T.VIEW_BILLING]:[...xo];const n=Nr[t],o=n&&n[a];return o?[...o]:[]}function Pr(e,t){const a=bt[e]?.rank??-1,n=bt[t]?.rank??1/0;return a>=bt.admin.rank&&a>=n}const Da=[{value:"name",label:"Full name (splits into first + last automatically)"},{value:"first_name",label:"First name"},{value:"last_name",label:"Last name"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"mobile",label:"Mobile phone"},{value:"company",label:"Company"},{value:"title",label:"Job title"},{value:"city",label:"City"},{value:"state",label:"State / province"},{value:"product_interest",label:"Product interest"},{value:"lead_source",label:"Lead source"},{value:"rating",label:"Rating (Hot / Warm / Cold)"},{value:"description",label:"Notes / description"}];new Set(Da.map(e=>e.value));const Ba=[{value:"single_select",label:"Multiple choice"},{value:"multi_select",label:"Select all"},{value:"scheduler",label:"Scheduler"},{value:"text",label:"Short text"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"message",label:"Message"}];new Set(Ba.map(e=>e.value));class x{static CONFIG={BASE_URL:"https://machfivemagnet-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink",SCOPE:"sse_session_scope",ACTIVE_ORG:"sse_active_org",REMEMBERED_EMAIL:"sse_remembered_email"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",ME:"/m5t/v5/acctEntity/me",PING:"/ping",WEBAUTHN_AUTH_OPTIONS:"/m5t/v5/webauthn/authenticate/options",WEBAUTHN_AUTH_VERIFY:"/m5t/v5/webauthn/authenticate/verify"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#o=null;static#a=null;static#n=!1;static#s=null;static#i=null;static async init({BASE_URL:t,navigateFunction:a,customConfig:n={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(a&&typeof a=="function")this.#i=a;else throw new Error("navigateFunction is required and must be a function");return t&&(this.CONFIG.BASE_URL=t),n&&Object.keys(n).length>0&&(this.CONFIG={...this.CONFIG,...n}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#m(),this.#u(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#u(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((t=null)=>{if(t){if(wo()&&(t==="splash"||t==="signin")){console.log("[AuthController] Ignoring mvvLegit redirect to",t,"— keeping invitee on accept-invite");return}console.log("[AuthController] mvvLegit navigation to:",t),this.#r(t)}}).setOnState((t=null)=>{if(t)switch(console.log("[AuthController] Auth state changed:",t),t){case"AUTH":case 4:this.#b();break;case"UNAUTH":case 1:this.#_();break;case"UNVERF":case 2:this.#y();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#r(t){if(!this.#i){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",t);const a=t.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",a),this.#i(a)}static#l(){if(window.__m5tActiveOrgFetch)return;const t=window.fetch.bind(window);window.fetch=(a,n)=>{try{const o=typeof a=="string"?a:a?.url||"",s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);if(s&&o.startsWith(this.CONFIG.BASE_URL)){const r=new Headers(n&&n.headers||(a instanceof Request?a.headers:void 0));r.set("X-Active-Org",s),n={...n||{},headers:r}}}catch{}return t(a,n)},window.__m5tActiveOrgFetch=!0,console.log("[AuthController] Active-org fetch header installed")}static#m(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);t&&(this.#o=JSON.parse(t),console.log("[AuthController] Entity state loaded:",this.#o?.email))}catch(t){console.error("[AuthController] Error loading entity state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#o=null}this.#s=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.SCOPE);t&&(this.#a=JSON.parse(t),console.log("[AuthController] Scope state loaded (cached):",this.#a?.uiMode))}catch(t){console.error("[AuthController] Error loading scope state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE),this.#a=null}}static#c(t){try{this.#o=t,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(t)),console.log("[AuthController] Entity state saved")}catch(a){console.error("[AuthController] Error saving entity state:",a)}}static#d(){this.#o=null,this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}}static getEntity(){return this.#o}static#v(t){try{this.#a=t,localStorage.setItem(this.CONFIG.LS_KEYS.SCOPE,JSON.stringify(t))}catch(a){console.error("[AuthController] Error saving scope state:",a)}}static async fetchScope(){if(typeof mvvLegit>"u"||!this.isAuthenticated())return console.log("[AuthController] fetchScope skipped — not authenticated"),this.#a;if(this.#n)return this.#a;this.#n=!0;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),a=t?`?org=${encodeURIComponent(t)}`:"",n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.ME}${a}`);if(n.status===401||n.status===403)return console.warn("[AuthController] /me unauthorized — signing out"),this.doSignout(!0),null;if(!n.ok)return console.warn(`[AuthController] /me failed (${n.status}) — using cached scope`),this.#a;const o=await n.json();if(!o?.ok)return console.warn("[AuthController] /me returned not-ok — using cached scope"),this.#a;try{const s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);s&&o.activeOrg?.guid!==s&&(console.warn(`[AuthController] Stored active org not honored by /me${o.activeOrgError?" (activeOrgError)":""} — clearing`),localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG))}catch{}return this.#v(o),p.publish(u.AUTH_SCOPE_LOADED,o),console.log(`[AuthController] Scope loaded: ${o.uiMode} (${o.memberships?.length||0} org(s), ${o.managedClients?.length||0} client(s))`),o}catch(t){return console.error("[AuthController] fetchScope error:",t),this.#a}finally{this.#n=!1}}static async setActiveOrg(t){try{t?localStorage.setItem(this.CONFIG.LS_KEYS.ACTIVE_ORG,t):localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}return this.fetchScope()}static getScope(){return this.#a}static getCapabilities(){return this.isPreviewingAsClient()?Mr({orgChannel:"managed_client",memberRole:"owner"}):this.#a?.capabilities||[]}static getUiMode(){return this.isPreviewingAsClient()?"managed":this.#a?.uiMode||"self_serve"}static getActiveOrg(){return this.#a?.activeOrg||null}static getMemberships(){return this.#a?.memberships||[]}static getManagedClients(){return this.#a?.managedClients||[]}static getStoredActiveOrg(){try{return localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{return null}}static#p="m5m_preview_as_client";static isPreviewingAsClient(){try{return sessionStorage.getItem(this.#p)==="1"&&!!this.#a?.activeOrg?.viaSubtree}catch{return!1}}static setPreviewAsClient(t){try{t?sessionStorage.setItem(this.#p,"1"):sessionStorage.removeItem(this.#p)}catch{}this.#a&&p.publish(u.AUTH_SCOPE_LOADED,this.#a)}static async doSignin(t,a){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a})}),o=await n.json();if(n.status===303)return console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#c(o.entity)),setTimeout(()=>{this.#r(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o};if(n.ok&&o.accessToken){console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#c(o.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),console.log("[AuthController] Explicitly navigating to home"),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}}return{ok:!1,error:o.error||"Sign in failed",data:o}}catch(n){return console.error("[AuthController] Signin error:",n),{ok:!1,error:n.message}}}static async doPasskeySignin(){if(!window.PublicKeyCredential)return{ok:!1,error:"Passkeys are not supported in this browser"};try{const{startAuthentication:t}=await K(async()=>{const{startAuthentication:i}=await Promise.resolve().then(()=>No);return{startAuthentication:i}},void 0),a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_OPTIONS}`,{method:"POST"}),n=await a.json();if(!a.ok||!n.ok)return{ok:!1,error:n.error||"Could not start passkey sign-in"};let o;try{o=await t({optionsJSON:n.options})}catch(i){const l=i?.name==="NotAllowedError";return l||console.error("[AuthController] Passkey ceremony error:",i),{ok:!1,canceled:l,error:l?"Passkey sign-in was canceled":i.message||"Passkey sign-in failed"}}const s=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_VERIFY}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o})}),r=await s.json();if(!s.ok||!r.ok||!r.accessToken)return{ok:!1,error:r.error||"Passkey sign-in failed",data:r};mvvLegit.doSignin(r.accessToken),this.#c(r.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:r}}catch(t){return console.error("[AuthController] Passkey signin error:",t),{ok:!1,error:t.message}}}static async doSignout(t=!1){console.log("[AuthController] doSignout called, serverInitiated:",t);try{const a=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!a),!t&&a){const n=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(a)}`;if(console.log("[AuthController] Sending signout beacon to:",n),navigator.sendBeacon){const o=navigator.sendBeacon(n);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else a||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#d(),console.log("[AuthController] Stopping auth ping..."),this.#h(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(a){console.error("[AuthController] Signout error:",a),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(t){try{const a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await a.json();return a.ok&&n.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#c(n.entity),{ok:!0,data:n}):{ok:!1,error:n.error||"Sign up failed",data:n}}catch(a){return console.error("[AuthController] Signup error:",a),{ok:!1,error:a.message}}}static async doResetHash(t,a){try{const n=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a,modified_by:t})}),s=await o.json();return o.ok&&s.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:s}):{ok:!1,error:s.error||"Password reset failed",data:s}}catch(n){return console.error("[AuthController] Reset password error:",n),{ok:!1,error:n.message}}}static#g(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#f()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#h(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#f(){try{const t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);t.ok?console.log("[AuthController] Ping success"):(t.status===401||t.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(t){console.error("[AuthController] Ping error:",t)}}static setDeepLinkGuid(t){this.#s=t,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,t),console.log("[AuthController] Deep-link GUID stored:",t)}static getDeepLinkGuid(){return this.#s}static clearDeepLink(){this.#s=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#b(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.fetchScope()}static#_(){console.log("[AuthController] User unauthenticated"),this.#h()}static#y(){console.log("[AuthController] User unverified")}static getAuthState(){try{const t=mvvLegit.getConf()?.LSKEY||"mvv",a=localStorage.getItem(t);if(!a)return"UNAUTH";if(typeof LZString>"u")return null;const n=LZString.decompressFromUTF16(a),s=JSON.parse(n)?.state;return s===1?"UNAUTH":s===2?"UNVERF":s===4?"AUTH":s===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(t){this.#r(t)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#f()}}class C{static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",remember_email:"Remember my email",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_dashboard:"Dashboard",nav_dashboard_tagline:"Overview of your activity",nav_magnets:"Your Magnets",nav_magnets_tagline:"Manage your conversational magnets",nav_templates:"Templates",nav_templates_tagline:"Start from a magnet template",nav_conversations:"Conversations",nav_conversations_tagline:"Captured lead conversations",nav_ab_testing:"A/B Testing",nav_ab_testing_tagline:"Experiment and optimize",nav_analytics:"Analytics",nav_analytics_tagline:"Performance and ad metrics",nav_ad_accounts:"Ad Accounts",nav_ad_accounts_tagline:"Connect advertising accounts",nav_clients:"Clients",nav_clients_tagline:"Manage your client accounts",nav_team:"Team",nav_team_tagline:"Invite and manage teammates",nav_billing:"Billing",nav_billing_tagline:"Plan, usage, and invoices",nav_settings:"Settings",nav_settings_tagline:"Account and workspace settings",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Rollers",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",remember_email:"Recordar mi correo electrónico",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Rollers",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",remember_email:"记住我的邮箱",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"滚动器",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:t,product:a,whitelabel:n,lang:o}){t&&(this.#t.buildMode=t),a&&(this.#t.product=a),n&&(this.#t.whitelabel=n),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{let l=this.#e[o]?.[s]?.[r]?.[i]?.[t],c=o;return!l&&o!=="LOCAL"&&(l=this.#e.LOCAL?.[s]?.[r]?.[i]?.[t],c="LOCAL (fallback)"),l?(c==="LOCAL (fallback)"&&console.warn(`[MicrocopyManager] Token '${t}' missing from ${o} — served from LOCAL instead. Backfill ${o}'s block if this is intentionally different copy.`),Array.isArray(l)?l[Math.floor(Math.random()*l.length)]:l):(console.warn(`[MicrocopyManager] Token not found: ${t} (${o}/${s}/${r}/${i}, LOCAL fallback also missing it)`),null)}catch(l){return console.error(`[MicrocopyManager] Error retrieving token: ${t}`,l),null}}static getAll(t={}){const a={...this.#t,...t},{buildMode:n,product:o,whitelabel:s,lang:r}=a;try{return this.#e[n]?.[o]?.[s]?.[r]||null}catch(i){return console.error("[MicrocopyManager] Error retrieving all tokens",i),null}}static has(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return!!this.#e[o]?.[s]?.[r]?.[i]?.[t]}catch{return!1}}static getAvailableLanguages(){const{buildMode:t,product:a,whitelabel:n}=this.#t;try{return Object.keys(this.#e[t]?.[a]?.[n]||{})}catch{return[]}}static update(t,a,n={}){const o={...this.#t,...n},{buildMode:s,product:r,whitelabel:i,lang:l}=o;try{return this.#e[s]||(this.#e[s]={}),this.#e[s][r]||(this.#e[s][r]={}),this.#e[s][r][i]||(this.#e[s][r][i]={}),this.#e[s][r][i][l]||(this.#e[s][r][i][l]={}),this.#e[s][r][i][l][t]=a,!0}catch(c){return console.error(`[MicrocopyManager] Error updating token: ${t}`,c),!1}}static delete(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return delete this.#e[o]?.[s]?.[r]?.[i]?.[t],!0}catch(l){return console.error(`[MicrocopyManager] Error deleting token: ${t}`,l),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(t){try{return this.#e=t,!0}catch(a){return console.error("[MicrocopyManager] Error importing data",a),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:C});class Ie{static#e=!1;static#t=null;static#o=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const t=this.#n();C.setContext(t),console.log("[I18nController] Initialized with context:",t),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#s(),this.#u(),this.#e=!0,this.refresh()}static#a(t){const a={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},n=t.toLowerCase();return a[n]||"DEV"}static#n(){const a=this.#a("production"),n=localStorage.getItem(z.FF_SSE_LS_WHITELABEL)||z.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(z.FF_SSE_LS_USER_LANG)||z.FF_SSE_I18N_LANG;return{buildMode:a,product:z.FF_SSE_I18N_PRODUCT,whitelabel:n,lang:o}}static#s(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((t,a,n)=>{z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",n),this.#t=n,setTimeout(()=>{this.refresh()},z.FF_SSE_I18N_APPLY_DELAY_MS)},z.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#i())}static#i(){setInterval(()=>{const a=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");a&&a!==this.#t&&(this.#t=a,this.refresh())},500)}static#u(){this.#o||(this.#o=new MutationObserver(t=>{let a=!1;for(const n of t){for(const o of n.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){a=!0;break}if(a)break}a&&(z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#o.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#r(document.body),this.#l(document.body),z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#r(t){const a=t.querySelectorAll("[data-meta-copywrite-i118n]");z.FF_SSE_I18N_DEBUG&&a.length>0&&console.log(`[I18nController] Processing ${a.length} elements`),a.forEach(n=>{try{const o=n.getAttribute("data-meta-copywrite-i118n"),s=JSON.parse(o);if(!s.token){console.warn("[I18nController] Missing token in config:",s);return}const r=s.attribute||"textContent",i=C.get(s.token);if(i===null){console.warn(`[I18nController] Microcopy not found for token: ${s.token}`);return}r==="textContent"?n.textContent=i:r==="innerHTML"?n.innerHTML=i:n.setAttribute(r,i),z.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${i}" to ${r} for token: ${s.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,n)}})}static#l(t){t.querySelectorAll("*").forEach(n=>{n.shadowRoot&&(this.#r(n.shadowRoot),this.#l(n.shadowRoot))})}static setLanguage(t){const a=C.getAvailableLanguages();if(!a.includes(t)){console.error(`[I18nController] Language not available: ${t}. Available:`,a);return}localStorage.setItem(z.FF_SSE_LS_USER_LANG,t),C.setContext({lang:t}),console.log("[I18nController] Language changed to:",t);const n=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:t}});document.dispatchEvent(n),this.refresh()}static setWhitelabel(t){localStorage.setItem(z.FF_SSE_LS_WHITELABEL,t),C.setContext({whitelabel:t}),z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",t),this.refresh()}static getLanguage(){return C.getContext().lang}static getAvailableLanguages(){return C.getAvailableLanguages()}static getContext(){return C.getContext()}static destroy(){this.#o&&(this.#o.disconnect(),this.#o=null),this.#e=!1,this.#t=null,z.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{Ie.initialize()}):Ie.initialize());class Ua{static _initialized=!1;static _debug=!1;static init(t={}){if(this._initialized)return console.warn("[MachVive] Already initialized, skipping duplicate initialization"),this;if(this._debug=t.debug||!1,!window.mvvSSEther)return console.error("[MachVive] mvvSSEther not found - cannot initialize bridge"),console.error("[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()"),this;console.log("[MachVive] Initializing SSE to PubSub bridge...");const a=n=>{this._handleSSEMessage(n)};return window.mvvSSEther.onmessage(a),this._initialized=!0,console.log("[MachVive] ✓ SSE to PubSub bridge initialized successfully"),console.log("[MachVive] ✓ Bound callback to mvvSSEther.onmessage"),this}static _handleSSEMessage(t){try{this._debug&&console.log("[MachVive] SSE message received:",t);const a=t?.data;if(!a){this._debug&&console.log("[MachVive] No data in message, skipping");return}const n=a.data||a.package||a;if(!n){this._debug&&console.log("[MachVive] No package found in message, skipping");return}let o=n.cfg;const s=n.msg;if(this._debug&&(console.log("[MachVive] cfg (raw):",o,"type:",typeof o,"length:",o?.length),console.log("[MachVive] msg (raw):",s)),typeof o=="string"){if(o.trim()===""){this._debug&&console.log("[MachVive] cfg is empty string, skipping");return}try{o=JSON.parse(o),console.log("[MachVive] cfg (parsed):",o)}catch(i){console.warn("[MachVive] Failed to parse cfg as JSON:",{cfg:o,cfgLength:o.length,error:i.message});return}}else if(!o){this._debug&&console.log("[MachVive] cfg is empty/null, skipping");return}const r=o?.topic;if(!r){this._debug&&console.log("[MachVive] No topic found in cfg, skipping");return}if(console.log("[MachVive] Extracted topic:",r),!this._isValidTopic(r)){console.warn(`[MachVive] Topic '${r}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(r,s,t,a)}catch(a){console.error("[MachVive] Error handling SSE message:",a)}}static _isValidTopic(t){return!u||!u.hasOwnProperty(t)?(console.warn(`[MachVive] Topic '${t}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(t,a,n,o){try{if(!window.PubSub&&typeof PubSub>"u"){console.error("[MachVive] PubSub not available");return}const s=window.PubSub||PubSub,r={message:a,metadata:{source:"sse",sseEventId:n.id,timestamp:n.timestamp,appGuid:o.app_guid,channelGuid:o.channel_guid,eventAction:o.event_action,status:o.status,class:o.class,raw:o}};console.log(`[MachVive] Publishing to topic '${t}':`,r);const i=u[t];console.log(`[MachVive] AppBroadcast.${t} = '${i}'`),s.publish(i,r),console.log(`[MachVive] ✓ Published SSE message to topic: ${t}`)}catch(s){console.error(`[MachVive] Error publishing to topic '${t}':`,s)}}static debug(t){return this._debug=t,console.log(`[MachVive] Debug mode ${t?"enabled":"disabled"}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log("[MachVive] Reset complete"),this}}typeof module<"u"&&module.exports&&(module.exports=Ua);typeof window<"u"&&(window.MachVive=Ua);const gn="m5t_sidenav_collapsed",Fr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};class Dr extends HTMLElement{static get observedAttributes(){return["data-active-token","data-collapsed"]}constructor(){super(),this.attachShadow({mode:"open"}),this.items=[],this.orgs=[],this.activeOrgGuid=null,this.activeToken=null,this.footerBadge=null,this.loading=!1,this.lastFocus=null}#e=null;#t=t=>{if(this.getAttribute("data-open")==="true"){if(t.key==="Escape"){t.preventDefault(),this.closeDrawer();return}if(t.key==="Tab"){const a=this.#c();if(a.length<2)return;const n=a[0],o=a[a.length-1],s=this.shadowRoot.activeElement;t.shiftKey&&s===n?(t.preventDefault(),o.focus()):!t.shiftKey&&s===o&&(t.preventDefault(),n.focus())}}};#o=()=>{this.closeDrawer(),this.#d()};connectedCallback(){if(!this.hasAttribute("data-collapsed"))try{localStorage.getItem(gn)==="true"&&this.setAttribute("data-collapsed","true")}catch{}this.activeToken=this.getAttribute("data-active-token")||null,this.render(),this.#l(),this.addEventListener("keydown",this.#t),this.#e=window.matchMedia("(max-width: 768px)"),this.#e.addEventListener("change",this.#o),this.#d()}disconnectedCallback(){this.removeEventListener("keydown",this.#t),this.#e?.removeEventListener("change",this.#o)}attributeChangedCallback(t,a,n){a===n||!this.shadowRoot||(t==="data-active-token"?(this.activeToken=n,this.#m()):t==="data-collapsed"&&this.shadowRoot.firstChild&&(this.render(),this.#l()))}setState({buttons:t,orgs:a,activeOrg:n,footerBadge:o,loading:s}={}){t!==void 0&&(this.items=Array.isArray(t)?t:this.#a(t)||[]),a!==void 0&&(this.orgs=Array.isArray(a)?a:this.#a(a)||[]),n!==void 0&&(this.activeOrgGuid=n||null),o!==void 0&&(this.footerBadge=o||null),s!==void 0&&(this.loading=!!s),this.shadowRoot&&(this.render(),this.#l())}setButtons(t){this.setState({buttons:t})}setOrgs(t){this.setState({orgs:t})}setActiveOrgGuid(t){this.setState({activeOrg:t})}setFooterBadge(t){this.setState({footerBadge:t})}setActiveToken(t){this.activeToken=t||null,this.#m()}toggleCollapsed(t){const a=typeof t=="boolean"?t:this.getAttribute("data-collapsed")!=="true";this.setAttribute("data-collapsed",String(a));try{localStorage.setItem(gn,String(a))}catch{}this.dispatchEvent(new CustomEvent("nav-collapse",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_SIDE_NAV.COLLAPSE",collapsed:a,timestamp:Date.now()}}))}openDrawer(){this.lastFocus=this.shadowRoot.activeElement||document.activeElement,this.setAttribute("data-open","true"),this.shadowRoot.querySelector(".hamburger")?.setAttribute("aria-expanded","true"),this.#d(),(this.#c()[0]||this.shadowRoot.querySelector(".sidenav"))?.focus?.()}closeDrawer(){if(this.getAttribute("data-open")!=="true")return;this.removeAttribute("data-open");const t=this.shadowRoot.querySelector(".hamburger");t?.setAttribute("aria-expanded","false"),this.#d(),t&&this.#e?.matches?t.focus():this.lastFocus?.focus?.()}toggleDrawer(){this.getAttribute("data-open")==="true"?this.closeDrawer():this.openDrawer()}#a(t){try{return t?JSON.parse(t):null}catch(a){return console.error("[M5TSideNav] bad JSON:",a),null}}#n(t){return String(t??"").replace(/[&<>"']/g,a=>Fr[a])}#s(t){return t?`<span class="ms" aria-hidden="true">${this.#n(t)}</span>`:""}#i(t){if(!t||!t.token)return"";const a=t.token===this.activeToken,n=t.route||"#",o=n.startsWith("#")?n:`#${n}`,s=typeof t.count=="number"&&t.count>0?`<span class="badge">${t.count}</span>`:"";return`
    ...
    `}attachEventListeners(){this.shadowRoot.querySelectorAll(".nav-button").forEach(n=>{const o=n.getAttribute("data-token"),s=n.getAttribute("data-level");n.addEventListener("click",r=>{o&&!r.currentTarget.disabled&&!this.longTapFired&&(s==="primary"?this.selectPrimaryButton(o):this.selectSecondaryButton(o)),this.longTapFired=!1}),n.addEventListener("dblclick",r=>{if(o&&!r.currentTarget.disabled){const i=this.getButtonData(o,s);console.log("[M5TPrimaryNav] Button double-clicked:",o),this.dispatchEvent(new CustomEvent("nav-double-tap",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.DOUBLE_TAP",token:o,level:s,caption:i.caption,tagline:i.tagline,timestamp:Date.now()}}))}}),n.addEventListener("mouseenter",r=>{if(o&&!r.currentTarget.disabled){const i=this.getButtonData(o,s);this.dispatchEvent(new CustomEvent("nav-hover",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.HOVER",token:o,level:s,caption:i.caption,tagline:i.tagline,action:"enter",timestamp:Date.now()}}))}}),n.addEventListener("mouseleave",r=>{if(o&&!r.currentTarget.disabled){const i=this.getButtonData(o,s);this.dispatchEvent(new CustomEvent("nav-hover",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.HOVER",token:o,level:s,caption:i.caption,tagline:i.tagline,action:"leave",timestamp:Date.now()}}))}}),n.addEventListener("mousedown",r=>{o&&!r.currentTarget.disabled&&(this.longTapActive=!0,this.longTapFired=!1,this.longTapTimer=setTimeout(()=>{const i=this.getButtonData(o,s);console.log("[M5TPrimaryNav] Button long-tap:",o),this.longTapFired=!0,this.dispatchEvent(new CustomEvent("nav-long-tap",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.LONG_TAP",token:o,level:s,caption:i.caption,tagline:i.tagline,timestamp:Date.now()}}))},this.longTapDelay))}),n.addEventListener("mouseup",r=>{this.longTapTimer&&(clearTimeout(this.longTapTimer),this.longTapTimer=null),this.longTapActive=!1}),n.addEventListener("mouseleave",r=>{this.longTapTimer&&(clearTimeout(this.longTapTimer),this.longTapTimer=null),this.longTapActive=!1})});const a=this.shadowRoot.querySelector(".logo");a&&a.addEventListener("click",()=>{console.log("[M5TPrimaryNav] Logo clicked"),this.logoTopic&&window.m5t?.pubsub?(console.log(`[M5TPrimaryNav] Publishing to topic: ${this.logoTopic}`),window.m5t.pubsub.publish(this.logoTopic,{timestamp:Date.now()})):this.logoTopic&&!window.m5t?.pubsub&&console.warn("[M5TPrimaryNav] Logo topic configured but window.m5t.pubsub not found"),this.dispatchEvent(new CustomEvent("logo-click",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.LOGO_TAP",timestamp:Date.now()}}))})}selectPrimaryButton(t){const a=this.buttons.find(o=>o.token===t),n=this.getButtonData(t,"primary");this.dispatchEvent(new CustomEvent("nav-select",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.TAP",token:t,level:"primary",caption:n.caption,tagline:n.tagline,hasSecondary:(a?.secondary?.length||0)>0,timestamp:Date.now()}})),this.selectedPrimaryToken!==t&&(this.selectedPrimaryToken=t,this.render(),this.attachEventListeners())}selectSecondaryButton(t){const a=this.getButtonData(t,"secondary");this.dispatchEvent(new CustomEvent("nav-select",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.TAP",token:t,primaryToken:this.selectedPrimaryToken,level:"secondary",caption:a.caption,tagline:a.tagline,timestamp:Date.now()}}))}updateButtons(t){this.setAttribute("data-buttons",JSON.stringify(t)),this.parseButtons(),this.render(),this.attachEventListeners()}updateCount(t,a,n="primary"){let o;n==="primary"?o=this.buttons.find(s=>s.token===t):o=this.getSecondaryButtons().find(r=>r.token===t),o&&(o.count=a,this.render(),this.attachEventListeners())}getSelection(){return{primary:this.selectedPrimaryToken,secondary:null}}}customElements.define("m5t-primary-nav",Br);const Ct=()=>x.getConfig?.().BASE_URL||"",Ur={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},gt=e=>String(e??"").replace(/[&<>"']/g,t=>Ur[t]),Hr=300*1e3;function zr(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function Gr(e){const t=e.link?"a":"div",a=e.link?` href="${gt(e.link)}"`:"";return`<${t} class="m5t-notif-item" data-guid="${gt(e.guid)}" data-read="${e.read}"${a} role="menuitem">
    <div class="m5t-notif-title">${gt(e.title)}</div>
    ${e.body?`<div class="m5t-notif-body">${gt(e.body)}</div>`:""}
    <div class="m5t-notif-time">${gt(zr(e.created_tz))}</div>
  </${t}>`}function qr(e){const t=document.getElementById("m5t-notif-bell");if(t&&(t.hidden=!e),!e){const a=document.getElementById("m5t-notif-panel");a&&(a.hidden=!0)}}let hn=null;function Vr(){const e=document.getElementById("m5t-notif-bell-btn"),t=document.getElementById("m5t-notif-badge"),a=document.getElementById("m5t-notif-panel");if(!e||!t||!a)return;const n=l=>{t.textContent=l>99?"99+":String(l),t.hidden=!l},o=async()=>{try{const l=await fetch(`${Ct()}/m5t/v5/notifications/unread-count`),c=await l.json().catch(()=>({}));l.ok&&c.ok&&n(c.count||0)}catch{}},s=async()=>{a.innerHTML='<div class="m5t-notif-head">Notifications</div><div class="m5t-notif-empty">Loading…</div>';try{const l=await fetch(`${Ct()}/m5t/v5/notifications`),c=await l.json().catch(()=>({}));if(!l.ok||!c.ok)throw new Error;const m=c.notifications||[];a.innerHTML=`
        <div class="m5t-notif-head">
          Notifications
          ${m.some(f=>!f.read)?'<button class="m5t-notif-markall" type="button">Mark all read</button>':""}
        </div>
        ${m.length?m.map(Gr).join(""):'<div class="m5t-notif-empty">You’re all caught up.</div>'}`}catch{a.innerHTML='<div class="m5t-notif-head">Notifications</div><div class="m5t-notif-empty">Could not load. Try again.</div>'}},r=()=>{a.hidden=!0,e.setAttribute("aria-expanded","false")},i=async()=>{a.hidden=!1,e.setAttribute("aria-expanded","true"),await s()};e.addEventListener("click",l=>{l.stopPropagation(),a.hidden?i():r()}),document.addEventListener("click",l=>{!a.hidden&&!a.contains(l.target)&&l.target!==e&&r()}),a.addEventListener("click",async l=>{const c=l.target.closest(".m5t-notif-item");if(c&&c.dataset.read==="false"){const f=c.dataset.guid;c.dataset.read="true";try{await fetch(`${Ct()}/m5t/v5/notifications/${encodeURIComponent(f)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({read:!0})}),o()}catch{}return}const m=l.target.closest(".m5t-notif-markall");if(m){l.preventDefault(),a.querySelectorAll(".m5t-notif-item").forEach(f=>{f.dataset.read="true"}),m.remove();try{await fetch(`${Ct()}/m5t/v5/notifications/read-all`,{method:"PATCH"})}catch{}o()}}),o(),clearInterval(hn),hn=setInterval(o,Hr)}function Ha(){return Fa("FF_SSE_UI_DARK_MODE")}function jr(e=Ha()){return e&&localStorage.getItem(z.FF_SSE_LS_THEME)==="dark"?"dark":"light"}function Wr(e=Fa("FF_SSE_UI_ANIMATIONS")){return!e}function Yr(e,t=Ha()){!e||t||e.shadowRoot?.querySelector('.footer-action[data-action="theme"]')?.remove()}window.m5t=Object.create(null);window.m5t.pubsub=p;console.log("StreamSyncEngage SaaS Client - Starting...");console.log("Environment:","production");console.log("Document readyState:",document.readyState);console.log("window.mvvLegit:",typeof window.mvvLegit);console.log("globalThis.mvvLegit:",typeof globalThis.mvvLegit);try{console.log("mvvLegit (direct):",typeof mvvLegit)}catch(e){console.log("mvvLegit (direct): ReferenceError -",e.message)}const Jr=Object.keys(window).filter(e=>e.toLowerCase().includes("mvv")||e.toLowerCase().includes("neodigm")||e.toLowerCase().includes("legit"));console.log("Possible Neodigm globals:",Jr);const F=new fr("/",{hash:!0});window.router=F;function ge(e){const t=e?`${e.replace(/-/g,"_")}_route`:"splash_route";return console.log(`[Router] Checking access: ${e} -> ${t}`),mvvLegit.isRouteAllowed(t)?!0:(console.warn(`[Router] Access denied to route: ${t}`),p.publish(u.UI_TOAST,{message:"Please sign in to access this page",type:"warning"}),!1)}function oe(e){console.log("[Router] Navigating to:",e),F.navigate(`/${e}`)}const za=new Set(["splash","signin","signup","forgot","resethash","verf-link","accept-invite","signout"]);let _t={},xa={},Ye=null;const Kr={admin:{caption:"Platform Admin",icon:"shield_person"},reseller:{caption:"Reseller",icon:"handshake"},managed:{caption:"Managed",icon:"visibility"},self_serve:{caption:"Self-Serve",icon:"rocket_launch"}},Ea="__portfolio__";function Eo(){try{F._setCurrent(null)}catch{}F.resolve()}function ha(){const e=document.getElementById("m5t-side-nav");if(!e)return;const t=!x.getScope()&&x.isAuthenticated(),a=x.getCapabilities(),n=x.getUiMode(),o=sa.getSideNav(a,{uiMode:n});_t={},xa={};const s=_=>{_.route&&(_t[_.route]={sectionToken:_.token,childToken:null,children:_.children||null},Array.isArray(_.children)&&_.children.forEach(v=>{v.route&&(xa[v.token]=v.route,_t[v.route]={sectionToken:_.token,childToken:v.token,children:_.children})}))},r=_=>_.forEach(v=>{v.group&&Array.isArray(v.items)?r(v.items):s(v)});r(o);const i=x.getMemberships(),l=x.getActiveOrg(),c=x.getManagedClients(),m=x.getStoredActiveOrg(),f=c.length?[{guid:Ea,name:"Portfolio (all clients)"},...i.map(_=>({guid:_.orgGuid,name:_.name||_.channel,channel:_.channel,group:"Your organization"})),...c.map(_=>({guid:_.orgGuid,name:_.name||_.orgGuid,channel:_.channel,group:"Clients"}))]:i.map(_=>({guid:_.orgGuid,name:_.name||_.channel,channel:_.channel}));e.setState({buttons:o,orgs:f,activeOrg:c.length?m||Ea:l?.guid||null,footerBadge:Kr[n]||null,loading:t}),Ao(),Ye&&So(Ye)}const Xr=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]);function Ao(){const e=document.getElementById("app-content");if(!e)return;let t=document.getElementById("org-context-banner");t||(t=document.createElement("div"),t.id="org-context-banner",e.insertBefore(t,e.firstChild));const a=x.getActiveOrg(),n=x.isPreviewingAsClient(),o=!!a?.viaSubtree&&!!Ye&&!za.has(Ye);if(t.hidden=!o,!o){t.innerHTML="";return}const s=Xr(a.name||"Client");t.innerHTML=`
    <style>
    ...
    <div class="ocb" role="status">
    ...
    </div>`,t.querySelector('[data-ocb="preview"]')?.addEventListener("click",()=>{x.setPreviewAsClient(!x.isPreviewingAsClient()),Eo()}),t.querySelector('[data-ocb="portfolio"]')?.addEventListener("click",()=>{x.setPreviewAsClient(!1),x.setActiveOrg(null)})}function So(e){const t=document.getElementById("m5t-side-nav"),a=_t[`/${e}`]||_t[e]||null;t?.setActiveToken(a?.sectionToken||null),Qr(a)}function Qr(e){const t=document.getElementById("m5t-sub-nav"),a=document.getElementById("app-shell");if(!t)return;const n=e?.children;t.hidden=!1,n&&n.length>1?(t.updateButtons(n.map(o=>({token:o.token,caption:o.caption,enabled:!0,selected:o.token===e.childToken}))),a?.classList.add("has-sub-nav")):(t.updateButtons([]),a?.classList.remove("has-sub-nav"))}function Zr(){const e=Ie.getAvailableLanguages&&Ie.getAvailableLanguages()||[];if(e.length<2){p.publish(u.UI_TOAST,{message:"Only one language is available",type:"info"});return}const t=localStorage.getItem(z.FF_SSE_LS_USER_LANG)||z.FF_SSE_I18N_LANG||e[0],a=e[(e.indexOf(t)+1)%e.length];Ie.setLanguage(a),p.publish(u.UI_TOAST,{message:`Language: ${a}`,type:"info"})}function ko(e){document.documentElement.setAttribute("data-theme",e)}function ei(){ko(jr())}function ti(){if(!Ha())return;const e=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";ko(e),localStorage.setItem(z.FF_SSE_LS_THEME,e),p.publish(u.UI_TOAST,{message:e==="dark"?"Dark mode on":"Dark mode off",type:"info"})}function ai(){document.documentElement.classList.toggle("ff-no-animations",Wr())}function ni(){const e=document.getElementById("m5t-side-nav");if(!e)return;sa.setAppToken("client-saas"),Yr(e),document.getElementById("app-shell")?.classList.toggle("nav-collapsed",e.getAttribute("data-collapsed")==="true"),e.addEventListener("nav-select",o=>{const s=o.detail?.route;s&&F.navigate(s.startsWith("/")?s:`/${s}`)}),e.addEventListener("logo-click",()=>F.navigate("/home")),e.addEventListener("nav-collapse",o=>{document.getElementById("app-shell")?.classList.toggle("nav-collapsed",!!o.detail?.collapsed)}),e.addEventListener("org-switch",o=>{const s=o.detail?.orgGuid;s&&x.setActiveOrg(s===Ea?null:s)}),e.addEventListener("footer-action",o=>{switch(o.detail?.action){case"account":F.navigate("/settings");break;case"signout":F.navigate("/signout");break;case"lang":Zr();break;case"theme":ti();break}}),document.getElementById("m5t-sub-nav")?.addEventListener("nav-select",o=>{const s=xa[o.detail?.token];s&&F.navigate(s)}),document.addEventListener("language-changed",()=>ha()),ha(),p.subscribe(u.AUTH_SCOPE_LOADED,()=>ha());const a=()=>{const o=x.getScope();return[o?.uiMode,o?.activeOrg?.guid,(o?.managedClients||[]).length,(o?.capabilities||[]).join(","),x.getStoredActiveOrg()].join("|")};let n=a();p.subscribe(u.AUTH_SCOPE_LOADED,()=>{const o=a();o!==n&&(n=o,Ye&&!za.has(Ye)&&Eo())})}function oi(e){Ye=e;const t=document.getElementById("m5t-side-nav"),a=document.getElementById("app-shell");if(!t||!a)return;const n=!za.has(e);if(t.hidden=!n,a.classList.toggle("has-side-nav",n),qr(n),n)So(e);else{const o=document.getElementById("m5t-sub-nav");o&&(o.hidden=!0),a.classList.remove("has-sub-nav")}Ao()}p.subscribe(u.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&oi(t.route)});const To=()=>{console.log("[Router] Route: splash"),p.publish(u.ROUTE_NAV_BEFORE,{route:"splash"});const e=wo();K(e?()=>Promise.resolve().then(()=>vi):()=>Promise.resolve().then(()=>yi),void 0).then(a=>{const n=document.getElementById("app");n.innerHTML=a.render(),a.init&&a.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"splash"})}).catch(a=>{console.error("[Router] Error loading splash route:",a),p.publish(u.ROUTE_NAV_ERROR,{route:"splash",error:a})})};F.on("/",To);F.on("/splash",To);F.on("/signin",()=>{console.log("[Router] Route: /signin"),p.publish(u.ROUTE_NAV_BEFORE,{route:"signin"}),K(()=>Promise.resolve().then(()=>Ti),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"signin"})}).catch(e=>{console.error("[Router] Error loading signin route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"signin",error:e})})});F.on("/signup",()=>{console.log("[Router] Route: /signup"),p.publish(u.ROUTE_NAV_BEFORE,{route:"signup"}),K(()=>Promise.resolve().then(()=>Ni),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"signup"})}).catch(e=>{console.error("[Router] Error loading signup route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"signup",error:e})})});F.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),p.publish(u.ROUTE_NAV_BEFORE,{route:"verf-link"}),K(()=>Promise.resolve().then(()=>Pi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(e=>{console.error("[Router] Error loading verf-link route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"verf-link",error:e})})});F.on("/forgot",()=>{console.log("[Router] Route: /forgot"),p.publish(u.ROUTE_NAV_BEFORE,{route:"forgot"}),K(()=>Promise.resolve().then(()=>Gi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(e=>{console.error("[Router] Error loading forgot route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"forgot",error:e})})});F.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!ge("resethash")){oe("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"resethash"}),K(()=>Promise.resolve().then(()=>ji),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(e=>{console.error("[Router] Error loading resethash route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"resethash",error:e})})});F.on("/home",()=>{if(console.log("[Router] Route: /home"),!ge("home")){oe("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"home"}),K(()=>Promise.resolve().then(()=>sl),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"home"})}).catch(e=>{console.error("[Router] Error loading home route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"home",error:e})})});F.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!ge("signout")){oe("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"signout"}),K(()=>Promise.resolve().then(()=>ll),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"signout"})}).catch(e=>{console.error("[Router] Error loading signout route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"signout",error:e})})});const si=[{path:"/templates",name:"templates",title:"Templates",icon:"content_copy"},{path:"/analytics",name:"analytics",title:"Analytics",icon:"monitoring"},{path:"/ad-accounts",name:"ad-accounts",title:"Ad Accounts",icon:"ads_click"},{path:"/billing",name:"billing",title:"Billing",icon:"receipt_long"},{path:"/settings",name:"settings",title:"Settings",icon:"settings"},{path:"/magnets/drafts",name:"magnets/drafts",title:"Magnets · Drafts",icon:"widgets"},{path:"/magnets/archived",name:"magnets/archived",title:"Magnets · Archived",icon:"widgets"},{path:"/analytics/conversions",name:"analytics/conversions",title:"Analytics · Conversions",icon:"monitoring"},{path:"/settings/workspace",name:"settings/workspace",title:"Settings · Workspace",icon:"settings"},{path:"/settings/integrations",name:"settings/integrations",title:"Settings · Integrations",icon:"settings"}];si.forEach(({path:e,name:t,title:a,icon:n})=>{F.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!ge("home")){oe("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:t}),K(()=>Promise.resolve().then(()=>pl),void 0).then(o=>{const s=document.getElementById("app");s.innerHTML=o.render({title:a,icon:n,name:t}),o.init&&o.init({name:t}),p.publish(u.ROUTE_NAV_AFTER,{route:t})}).catch(o=>{console.error(`[Router] Error loading section route (${t}):`,o),p.publish(u.ROUTE_NAV_ERROR,{route:t,error:o})})})});F.on("/settings/notifications",()=>{if(console.log("[Router] Route: /settings/notifications"),!ge("home")){oe("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"settings/notifications"}),K(()=>Promise.resolve().then(()=>_l),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"settings/notifications"})}).catch(e=>{console.error("[Router] Error loading settings-notifications route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"settings/notifications",error:e})})});F.on("/settings/integrations",()=>{if(console.log("[Router] Route: /settings/integrations"),!ge("home")){oe("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),K(()=>Promise.resolve().then(()=>Hl),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(e=>{console.error("[Router] Error loading settings-integrations route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"settings/integrations",error:e})})});F.on("/settings/security",()=>{if(console.log("[Router] Route: /settings/security"),!ge("home")){oe("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"settings/security"}),K(()=>Promise.resolve().then(()=>Jl),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"settings/security"})}).catch(e=>{console.error("[Router] Error loading settings-security route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"settings/security",error:e})})});F.on("/conversations",()=>{if(console.log("[Router] Route: /conversations"),!ge("home")){oe("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"conversations"}),K(()=>Promise.resolve().then(()=>sc),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"conversations"})}).catch(e=>{console.error("[Router] Error loading conversations route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"conversations",error:e})})});F.on("/ab-testing",()=>{if(console.log("[Router] Route: /ab-testing"),!ge("home")){oe("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"ab-testing"}),K(()=>Promise.resolve().then(()=>_c),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"ab-testing"})}).catch(e=>{console.error("[Router] Error loading ab-testing route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"ab-testing",error:e})})});F.on("/magnets",()=>{if(console.log("[Router] Route: /magnets"),!ge("home")){oe("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"magnets"}),K(()=>Promise.resolve().then(()=>Ed),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"magnets"})}).catch(e=>{console.error("[Router] Error loading magnets route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"magnets",error:e})})});F.on("/leads",()=>{if(console.log("[Router] Route: /leads"),!ge("home")){oe("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"leads"}),K(()=>Promise.resolve().then(()=>Fd),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"leads"})}).catch(e=>{console.error("[Router] Error loading leads route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"leads",error:e})})});F.on("/analytics/ad-performance",()=>{if(console.log("[Router] Route: /analytics/ad-performance"),!ge("home")){oe("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"analytics/ad-performance"}),K(()=>Promise.resolve().then(()=>qd),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"analytics/ad-performance"})}).catch(e=>{console.error("[Router] Error loading ad-performance route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"analytics/ad-performance",error:e})})});F.on("/clients",()=>{if(console.log("[Router] Route: /clients"),!ge("home")){oe("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"clients"}),K(()=>Promise.resolve().then(()=>tp),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"clients"})}).catch(e=>{console.error("[Router] Error loading clients route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"clients",error:e})})});F.on("/team",()=>{if(console.log("[Router] Route: /team"),!ge("home")){oe("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"team"}),K(()=>Promise.resolve().then(()=>dp),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"team"})}).catch(e=>{console.error("[Router] Error loading team route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"team",error:e})})});F.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),oe("splash")});p.subscribe(u.ROUTE_NAV,(e,t)=>{console.log("[Router] ROUTE_NAV event received:",t),t?.route&&oe(t.route)});function fn(){console.log("[App] Waiting for Neodigm 55 library...");let e=0;const t=100,a=setInterval(()=>{e++,e%10===0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(a),ri()):e>=t&&(clearInterval(a),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
      ...
      `,p.publish(u.APP_ERROR,{message:"Failed to load authentication library"}))},100)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",fn):fn();async function ri(){if(console.log("[App] Neodigm 55 loaded, initializing..."),ei(),ai(),Cr(),Ie.initialize(),console.log("[App] I18n Controller initialized"),!await x.init({BASE_URL:"https://machfivemagnet-saas.onrender.com",navigateFunction:a=>{console.log("[AuthController] Navigation requested:",a),oe(a)}})){console.error("[App] AuthController initialization failed");return}const t=x.getEntity();t&&(console.log("[App] Session restored for:",t.email),p.publish(u.APP_USER_LOADED,{entity:t}),x.isAuthenticated()&&x.fetchScope()),p.publish(u.APP_READY,{timestamp:new Date().toISOString(),sessionUser:t}),ni(),Vr(),F.resolve(),window.AuthController=x,window.I18nController=Ie,window.MachVive=Ua,console.log("[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)")}p.subscribe(u.ROUTE_NAV_AFTER,(e,t)=>{typeof Ie<"u"&&Ie.refresh&&setTimeout(()=>{Ie.refresh()},100)});function Ae(e){const t=new Uint8Array(e);let a="";for(const o of t)a+=String.fromCharCode(o);return btoa(a).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"")}function wt(e){const t=e.replace(/-/g,"+").replace(/_/g,"/"),a=(4-t.length%4)%4,n=t.padEnd(t.length+a,"="),o=atob(n),s=new ArrayBuffer(o.length),r=new Uint8Array(s);for(let i=0;i<o.length;i++)r[i]=o.charCodeAt(i);return s}function Et(){return Co.stubThis(globalThis?.PublicKeyCredential!==void 0&&typeof globalThis.PublicKeyCredential=="function")}const Co={stubThis:e=>e};function Io(e){const{id:t}=e;return{...e,id:wt(t),transports:e.transports}}function $o(e){return e==="localhost"||/^((xn--[a-z0-9-]+|[a-z0-9]+(-[a-z0-9]+)*)\.)+([a-z]{2,}|xn--[a-z0-9-]+)$/i.test(e)}class te extends Error{constructor({message:t,code:a,cause:n,name:o}){super(t,{cause:n}),Object.defineProperty(this,"code",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),this.name=o??n.name,this.code=a}}function ii({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new te({message:"Registration ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else if(e.name==="ConstraintError"){if(a.authenticatorSelection?.requireResidentKey===!0)return new te({message:"Discoverable credentials were required but no available authenticator supported it",code:"ERROR_AUTHENTICATOR_MISSING_DISCOVERABLE_CREDENTIAL_SUPPORT",cause:e});if(t.mediation==="conditional"&&a.authenticatorSelection?.userVerification==="required")return new te({message:"User verification was required during automatic registration but it could not be performed",code:"ERROR_AUTO_REGISTER_USER_VERIFICATION_FAILURE",cause:e});if(a.authenticatorSelection?.userVerification==="required")return new te({message:"User verification was required but no available authenticator supported it",code:"ERROR_AUTHENTICATOR_MISSING_USER_VERIFICATION_SUPPORT",cause:e})}else{if(e.name==="InvalidStateError")return new te({message:"The authenticator was previously registered",code:"ERROR_AUTHENTICATOR_PREVIOUSLY_REGISTERED",cause:e});if(e.name==="NotAllowedError")return new te({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="NotSupportedError")return a.pubKeyCredParams.filter(o=>o.type==="public-key").length===0?new te({message:'No entry in pubKeyCredParams was of type "public-key"',code:"ERROR_MALFORMED_PUBKEYCREDPARAMS",cause:e}):new te({message:"No available authenticator supported any of the specified pubKeyCredParams algorithms",code:"ERROR_AUTHENTICATOR_NO_SUPPORTED_PUBKEYCREDPARAMS_ALG",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if($o(n)){if(a.rp.id!==n)return new te({message:`The RP ID "${a.rp.id}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new te({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="TypeError"){if(a.user.id.byteLength<1||a.user.id.byteLength>64)return new te({message:"User ID was not between 1 and 64 characters",code:"ERROR_INVALID_USER_ID_LENGTH",cause:e})}else if(e.name==="UnknownError")return new te({message:"The authenticator was unable to process the specified options, or could not create a new credential",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}class li{constructor(){Object.defineProperty(this,"controller",{enumerable:!0,configurable:!0,writable:!0,value:void 0})}createNewAbortSignal(){if(this.controller){const a=new Error("Cancelling existing WebAuthn API call for new one");a.name="AbortError",this.controller.abort(a)}const t=new AbortController;return this.controller=t,t.signal}cancelCeremony(){if(this.controller){const t=new Error("Manually cancelling existing WebAuthn API call");t.name="AbortError",this.controller.abort(t),this.controller=void 0}}}const Ga=new li,ci=["cross-platform","platform"];function Lo(e){if(e&&!(ci.indexOf(e)<0))return e}async function di(e){!e.optionsJSON&&e.challenge&&(console.warn("startRegistration() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useAutoRegister:a=!1}=e;if(!Et())throw new Error("WebAuthn is not supported in this browser");const n={...t,challenge:wt(t.challenge),user:{...t.user,id:wt(t.user.id)},excludeCredentials:t.excludeCredentials?.map(Io)},o={};a&&(o.mediation="conditional"),o.publicKey=n,o.signal=Ga.createNewAbortSignal();let s;try{s=await navigator.credentials.create(o)}catch(w){throw ii({error:w,options:o})}if(!s)throw new Error("Registration was not completed");const{id:r,rawId:i,response:l,type:c}=s;let m;typeof l.getTransports=="function"&&(m=l.getTransports());let f;if(typeof l.getPublicKeyAlgorithm=="function")try{f=l.getPublicKeyAlgorithm()}catch(w){fa("getPublicKeyAlgorithm()",w)}let _;if(typeof l.getPublicKey=="function")try{const w=l.getPublicKey();w!==null&&(_=Ae(w))}catch(w){fa("getPublicKey()",w)}let v;if(typeof l.getAuthenticatorData=="function")try{v=Ae(l.getAuthenticatorData())}catch(w){fa("getAuthenticatorData()",w)}return{id:r,rawId:Ae(i),response:{attestationObject:Ae(l.attestationObject),clientDataJSON:Ae(l.clientDataJSON),transports:m,publicKeyAlgorithm:f,publicKey:_,authenticatorData:v},type:c,clientExtensionResults:s.getClientExtensionResults(),authenticatorAttachment:Lo(s.authenticatorAttachment)}}function fa(e,t){console.warn(`The browser extension that intercepted this WebAuthn API call incorrectly implemented ${e}. You should report this error to them.
`,t)}function Ro(){if(!Et())return Mt.stubThis(new Promise(t=>t(!1)));const e=globalThis.PublicKeyCredential;return e?.isConditionalMediationAvailable===void 0?Mt.stubThis(new Promise(t=>t(!1))):Mt.stubThis(e.isConditionalMediationAvailable())}const Mt={stubThis:e=>e};function pi({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new te({message:"Authentication ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else{if(e.name==="NotAllowedError")return new te({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if($o(n)){if(a.rpId!==n)return new te({message:`The RP ID "${a.rpId}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new te({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="UnknownError")return new te({message:"The authenticator was unable to process the specified options, or could not create a new assertion signature",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}async function ui(e){!e.optionsJSON&&e.challenge&&(console.warn("startAuthentication() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useBrowserAutofill:a=!1,verifyBrowserAutofillInput:n=!0}=e;if(!Et())throw new Error("WebAuthn is not supported in this browser");let o;t.allowCredentials?.length!==0&&(o=t.allowCredentials?.map(Io));const s={...t,challenge:wt(t.challenge),allowCredentials:o},r={};if(a){if(!await Ro())throw Error("Browser does not support WebAuthn autofill");if(document.querySelectorAll("input[autocomplete$='webauthn']").length<1&&n)throw Error('No <input> with "webauthn" as the only or last value in its `autocomplete` attribute was detected');r.mediation="conditional",s.allowCredentials=[]}r.publicKey=s,r.signal=Ga.createNewAbortSignal();let i;try{i=await navigator.credentials.get(r)}catch(v){throw pi({error:v,options:r})}if(!i)throw new Error("Authentication was not completed");const{id:l,rawId:c,response:m,type:f}=i;let _;return m.userHandle&&(_=Ae(m.userHandle)),{id:l,rawId:Ae(c),response:{authenticatorData:Ae(m.authenticatorData),clientDataJSON:Ae(m.clientDataJSON),signature:Ae(m.signature),userHandle:_},type:f,clientExtensionResults:i.getClientExtensionResults(),authenticatorAttachment:Lo(i.authenticatorAttachment)}}function mi(){return Et()?PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable():new Promise(e=>e(!1))}const No=Object.freeze(Object.defineProperty({__proto__:null,WebAuthnAbortService:Ga,WebAuthnError:te,_browserSupportsWebAuthnAutofillInternals:Mt,_browserSupportsWebAuthnInternals:Co,base64URLStringToBuffer:wt,browserSupportsWebAuthn:Et,browserSupportsWebAuthnAutofill:Ro,bufferToBase64URLString:Ae,platformAuthenticatorIsAvailable:mi,startAuthentication:ui,startRegistration:di},Symbol.toStringTag,{value:"Module"}));let vn=!1;function gi(){if(vn)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
    .accept-invite-page {
  ...
  `}function _i(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const e=localStorage.getItem(z.FF_SSE_LS_TOKEN),t=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!e,hasMvvTs:!!t});const a=document.getElementById("splash-loader"),n=document.getElementById("splash-actions");e?(console.log("[SplashRoute] Auth token found → HOME"),p.publish(u.ROUTE_NAV,{route:"home"})):t?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),p.publish(u.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),a&&(a.style.display="none"),n&&(n.style.display="flex"),document.querySelectorAll("[data-route]").forEach(s=>{s.addEventListener("click",()=>{const r=s.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${r}`),p.publish(u.ROUTE_NAV,{route:r})})}))},4e3)}const yi=Object.freeze(Object.defineProperty({__proto__:null,init:_i,render:bi},Symbol.toStringTag,{value:"Module"}));function le(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}const wi=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;function qa(e,t){return e?wi.test(e)?!0:(le(t,C.get("validation_email_invalid")),!1):(le(t,C.get("validation_email_required")),!1)}function xi(){return`
  ...
  `}function Ei(){console.log("[SigninRoute] Initialized");const e=document.getElementById("loginForm"),t=document.getElementById("email"),a=document.getElementById("password"),n=document.getElementById("togglePassword"),o=document.getElementById("rememberEmail"),s=localStorage.getItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL);s&&t&&o&&(t.value=s,o.checked=!0,a?.focus()),n?.addEventListener("click",()=>{const c=a.type==="password"?"text":"password";a.type=c});const r=document.getElementById("passkeySigninBtn"),i=document.getElementById("passkeyDivider");window.PublicKeyCredential&&r&&i&&(r.style.display="",i.style.display="",r.addEventListener("click",()=>ki())),e?.addEventListener("submit",async c=>{c.preventDefault();const m=t.value.trim(),f=a.value;qa(m,t)&&Ai(f,a)&&(o?.checked?localStorage.setItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL,m):localStorage.removeItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL),await Si(m,f))}),document.getElementById("link--uc__underline")?.addEventListener("click",c=>{c.preventDefault(),p.publish(u.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",c=>{c.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),p.publish(u.ROUTE_NAV,{route:"signup"})})}function Ai(e,t){return e?e.length<10?(le(t,C.get("validation_password_min_length")),!1):!0:(le(t,C.get("validation_password_required")),!1)}async function Si(e,t){const a=document.querySelector(".btn");a.disabled=!0,a.textContent=C.get("loading_signing_in");try{const n=await x.doSignin(e,t);n.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(C.get("success_welcome_back"),"success"),p.publish(u.AUTH_SIGNIN_SUCCESS,{entity:x.getEntity()})):n.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q(C.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(n.error||C.get("error_signin_failed"),"danger"),a.disabled=!1,a.textContent=(C.get("sign_in")||"Sign in").toUpperCase())}catch(n){console.error("[SigninRoute] Sign in error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||C.get("error_network"),"danger"),a.disabled=!1,a.textContent=(C.get("sign_in")||"Sign in").toUpperCase(),p.publish(u.AUTH_SIGNIN_FAIL,{message:n.message})}}async function ki(){const e=document.getElementById("passkeySigninBtn");e.disabled=!0;try{const t=await x.doPasskeySignin();t.ok?(console.log("[SigninRoute] Passkey signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(C.get("success_welcome_back"),"success"),p.publish(u.AUTH_SIGNIN_SUCCESS,{entity:x.getEntity()})):t.canceled||typeof neodigmToast<"u"&&neodigmToast.q(t.error||C.get("error_signin_failed"),"danger")}catch(t){console.error("[SigninRoute] Passkey signin error:",t),typeof neodigmToast<"u"&&neodigmToast.q(t.message||C.get("error_network"),"danger")}finally{e.disabled=!1}}const Ti=Object.freeze(Object.defineProperty({__proto__:null,init:Ei,render:xi},Symbol.toStringTag,{value:"Module"}));function Po(e){const t=[];return e.length<12&&t.push("at least 12 characters"),e.length>1024&&t.push("at most 1024 characters"),/[a-z]/.test(e)||t.push("1 lowercase"),/[A-Z]/.test(e)||t.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(e)||t.push("1 special character"),/[^\x00-\x7F]/.test(e)&&t.push("ASCII characters only"),t}function Fo(e){return e.length===0?"":e.includes("ASCII characters only")?"Password cannot contain emoji|or special unicode characters":e.includes("at least 10 characters")?"Password must have at least|10 characters":"Password must have: Uppercase,|Lowercase, and Special Character"}const Ci="2026-07-15";function Ii(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function $i(){console.log("[SignupRoute] Initialized");const e=document.getElementById("signupForm"),t=e.querySelector('button[type="submit"]');bn("togglePassword","password","eyeIcon"),bn("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),p.publish(u.ROUTE_NAV,{route:"signin"})}),e.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),s=document.getElementById("last").value.trim(),r=document.getElementById("email").value.trim(),i=document.getElementById("company").value.trim(),l=document.getElementById("phone").value.trim(),c=document.getElementById("password").value,m=document.getElementById("confirmPassword").value,f=document.getElementById("first"),_=document.getElementById("last"),v=document.getElementById("email"),w=document.getElementById("password"),d=document.getElementById("confirmPassword");if(!_n(o,f,C.get("validation_first_name_required"))||!_n(s,_,C.get("validation_last_name_required"))||!qa(r,v)||!Li(c,w))return;if(c!==m){le(d,C.get("validation_password_mismatch"));return}const h=document.getElementById("acceptTerms");if(!h.checked){le(h,"Please accept the Terms of Service and Privacy Policy to continue.");return}t.disabled=!0,t.textContent=C.get("loading_creating_account"),await Ri(o,s,r,i,l,c)})}function bn(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function _n(e,t,a){return e?!0:(le(t,a),!1)}function Li(e,t){if(!e)return le(t,C.get("validation_password_required")),!1;const a=Po(e);return a.length>0?(le(t,Fo(a)),!1):!0}async function Ri(e,t,a,n,o,s){const r=document.querySelector('button[type="submit"]');try{const i={email:a,password:s,first:e,last:t};n&&(i.company=n),o&&(i.phone=o),i.terms_accepted=!0,i.legal_version=Ci;const l=await x.doSignup(i);if(l.ok)p.publish(u.AUTH_SIGNUP_SUCCESS,{email:a}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const c=l.error||l.message||C.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(c,"danger"),r.disabled=!1,r.textContent=(C.get("create_account")||"Create account").toUpperCase(),p.publish(u.AUTH_SIGNUP_FAIL,{message:c})}}catch(i){console.error("[SignupRoute] Sign up error:",i),typeof neodigmToast<"u"&&neodigmToast.q(i.message||C.get("error_network"),"danger"),r.disabled=!1,r.textContent=(C.get("create_account")||"Create account").toUpperCase(),p.publish(u.AUTH_SIGNUP_FAIL,{message:i.message})}}const Ni=Object.freeze(Object.defineProperty({__proto__:null,init:$i,render:Ii},Symbol.toStringTag,{value:"Module"}));function Oi(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function Mi(){console.log("[VerfLinkRoute] Initialized");const e=7200,t=Date.now(),a=document.getElementById("countdown-display");function n(){const s=Date.now()-t,r=Math.floor(s/1e3),i=Math.max(0,e-r),l=Math.floor(i/3600),c=Math.floor(i%3600/60),m=i%60,f=`${String(l).padStart(2,"0")}:${String(c).padStart(2,"0")}:${String(m).padStart(2,"0")}`;a&&(a.textContent=f,i<600&&(a.style.color="#ef4444",a.style.textShadow=`
          0 0 10px rgba(239, 68, 68, 0.9),
          0 0 20px rgba(239, 68, 68, 0.7),
          0 0 30px rgba(239, 68, 68, 0.5)
        `),i===0&&(a.style.color="#7f1d1d",a.style.textShadow="none")),i===0&&(clearInterval(o),console.log("[VerfLinkRoute] Countdown expired"),window.neodigmWired4Sound&&window.neodigmWired4Sound.sound(14),setTimeout(()=>{window.router&&window.router.navigate("/splash")},600))}n();const o=setInterval(n,1e3);window.addEventListener("beforeunload",()=>{clearInterval(o)})}const Pi=Object.freeze(Object.defineProperty({__proto__:null,init:Mi,render:Oi},Symbol.toStringTag,{value:"Module"})),Fi="https://machfivemagnet-saas.onrender.com";class Di{constructor(){this.baseUrl=Fi}async request(t,a={}){const n=`${this.baseUrl}${t}`,o={"Content-Type":"application/json",...a.headers};try{const s=await fetch(n,{...a,headers:o});if(s.status===401||s.status===403){p.publish(u.AUTH_TOKEN_EXPIRED,{status:s.status,endpoint:t});const i=await s.json().catch(()=>({}));throw new Error(i.error||"Authentication failed")}const r=await s.json();return{ok:s.ok,status:s.status,data:r}}catch(s){throw console.error("API Request Error:",s),p.publish(u.APP_ERROR,{message:s.message,endpoint:t}),s}}async get(t){return this.request(t,{method:"GET"})}async post(t,a){return this.request(t,{method:"POST",body:JSON.stringify(a)})}async put(t,a){return this.request(t,{method:"PUT",body:JSON.stringify(a)})}async delete(t){return this.request(t,{method:"DELETE"})}async signin(t,a){return this.post("/api/acctEntity/signin",{email:t,hash:a})}async signup(t){return this.post("/api/acctEntity/signup",t)}async signout(){return this.post("/api/acctEntity/signout",{})}async forgotPassword(t){return this.get(`/m5t/v5/acctEntity/forgot?CODE=${encodeURIComponent(t)}`)}async resetHash(t,a){return this.post("/api/acctEntity/resethash",{email:t,hash:a})}async verifyAccount(t){return this.get(`/api/acctEntity/verify?CODE=${t}`)}async getAccounts(){return this.get("/api/acctEntity")}async getAccount(t){return this.get(`/api/acctEntity/${t}`)}async updateAccount(t,a){return this.put(`/api/acctEntity/${t}`,a)}async deleteAccount(t){return this.delete(`/api/acctEntity/${t}`)}async ping(){return this.get("/ping")}}const Bi=new Di;function Ui(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function Hi(){console.log("[ForgotRoute] Initialized");const e=document.getElementById("forgot-form"),t=document.getElementById("email");e?.addEventListener("submit",async a=>{a.preventDefault();const n=t.value.trim();qa(n,t)&&await zi(n)})}async function zi(e){const t=document.querySelector(".btn");t.disabled=!0,t.textContent="SENDING...";try{const a=await Bi.forgotPassword(e);a.ok&&a.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q(C.get("success_reset_link_sent"),"success"),p.publish(u.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(a.data.error||C.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=(C.get("send_reset_link")||"Send reset link").toUpperCase())}catch(a){console.error("[ForgotRoute] Forgot password error:",a),typeof neodigmToast<"u"&&neodigmToast.q(a.message||C.get("error_network"),"danger"),t.disabled=!1,t.textContent=(C.get("send_reset_link")||"Send reset link").toUpperCase()}}const Gi=Object.freeze(Object.defineProperty({__proto__:null,init:Hi,render:Ui},Symbol.toStringTag,{value:"Module"}));function qi(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function Vi(){console.log("[ResethashRoute] Initialized");const e=document.getElementById("resethash-form"),t=e.querySelector('button[type="submit"]');yn("toggleNewPassword","new-password","eyeIconNew"),yn("toggleConfirmPassword","confirm-password","eyeIconConfirm"),e?.addEventListener("submit",async a=>{a.preventDefault();const n=e.email.value.trim(),o=e.newPassword.value,s=e.confirmPassword.value,r=document.getElementById("new-password"),i=document.getElementById("confirm-password");if(!o){le(r,C.get("validation_new_password_required"));return}const l=Po(o);if(l.length>0){le(r,Fo(l));return}if(!s){le(i,C.get("validation_new_password_required"));return}if(o!==s){le(i,C.get("validation_password_mismatch"));return}t.disabled=!0,t.textContent=C.get("loading_resetting_password");try{const c=await x.doResetHash(n,o);c.ok?(typeof neodigmToast<"u"&&neodigmToast.q(C.get("success_password_reset"),"success"),p.publish(u.AUTH_RESETHASH_SUCCESS,{email:n})):(le(r,c.error||C.get("error_signin_failed")),t.disabled=!1,t.textContent=(C.get("update_password")||"Update password").toUpperCase())}catch(c){console.error("[ResethashRoute] Reset password error:",c),le(r,c.message||C.get("error_network")),t.disabled=!1,t.textContent=(C.get("update_password")||"Update password").toUpperCase()}})}function yn(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}const ji=Object.freeze(Object.defineProperty({__proto__:null,init:Vi,render:qi},Symbol.toStringTag,{value:"Module"})),se=()=>x.getManagedClients().length>0&&!x.getStoredActiveOrg(),Be=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),Wi={reseller_org:"Your org",managed_client:"Client",saas_org:"Org"};let wn=!1;function ct(){if(wn)return;const e=document.createElement("style");e.id="m5t-portfolio-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),wn=!0}const xn=e=>e.toISOString().slice(0,10);async function Yi(e,{days:t=30}={}){const a=new Date,n=xn(new Date(a.getTime()-(t-1)*864e5)),o=xn(a),s=await fetch(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${o}&group_by=owner`);if(!s.ok)throw new Error(`HTTP ${s.status}`);const r=await s.json();if(!r.ok)throw new Error("stats not ok");return r.by_owner||[]}function Do(e,t){return`<div class="dash-clients-scroll"><table class="dash-clients">
    <thead><tr>
      <th>Client</th>${t.map(a=>`<th>${a.h}</th>`).join("")}<th></th>
    </tr></thead>
    <tbody>${e.map(a=>`
      <tr data-org="${Be(a.owner_guid)}" tabindex="0" role="button"
          aria-label="Open ${Be(a.name||"client")}">
        <td><span class="dc-name">${Be(a.name||a.owner_guid)}
          <span class="dc-chip">${Be(Wi[a.channel]||a.channel||"")}</span></span></td>
        ${t.map(n=>`<td>${n.td(a)}</td>`).join("")}
        <td><span class="dc-view">View →</span></td>
      </tr>`).join("")}</tbody>
  </table></div>`}function Ji(e){let t=e.querySelector(".pf-access-error");t||(t=document.createElement("div"),t.className="pf-access-error",e.prepend(t)),t.textContent="You don't have direct access to manage this org. Use the admin console to act on its behalf."}function Bo(e){if(!e)return;const t=async a=>{const n=a?.dataset?.org;if(!n)return;(await x.setActiveOrg(n))?.activeOrgError&&Ji(e)};e.querySelectorAll("tbody tr[data-org]").forEach(a=>{a.addEventListener("click",()=>t(a)),a.addEventListener("keydown",n=>{(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),t(a))})})}const Aa=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function At({section:e,title:t,description:a}){return ct(),`
    <div class="page-shell" data-section="${Be(e)}">
      <div class="page-header">
        <div class="page-header-text">
          <h1 class="page-title">${Be(t)}</h1>
          <p class="page-description">${Be(a)}</p>
        </div>
      </div>
    ...
    </div>`}async function dt(e,t,{emptyMsg:a}={}){const n=document.getElementById("pf-picker-body");if(n)try{const o=await Yi(e);if(!o.length){n.innerHTML=Aa("groups",a||"No client orgs yet. Create one under Clients first.");return}n.innerHTML=Do(o,t),Bo(n)}catch(o){console.warn("[portfolio] picker load failed:",o),n.innerHTML=Aa("error","Could not load your clients. Please refresh.")}}function Uo(){const e={};return x.getManagedClients().forEach(t=>{e[t.orgGuid]=t.name}),x.getMemberships().forEach(t=>{t.orgGuid&&!e[t.orgGuid]&&(e[t.orgGuid]=t.name||"")}),e}const Ho=e=>e?`<span class="pf-client-chip">${Be(e)}</span>`:"",fe=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,ve=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),j=e=>Number(e||0).toLocaleString(),zo=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",Ki=e=>(zo(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function Xi(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric"})}catch{return""}}function Qi(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}let En=!1;function Zi(){if(En)return;const e=document.createElement("style");e.id="m5t-dash-recent-styles",e.textContent=`
    ...
    .page-shell .dash-chart-tip { position:absolute; transform:translate(-50%,-100%) translateY(-8px); pointer-events:none; z-index:5; background:var(--color-text,#0B1220); color:#fff; padding:8px 10px; border-radius:8px; font-size:0.78rem; line-height:1.5; white-space:nowrap; box-shadow:var(--shadow-md,0 8px 24px rgba(11,18,32,0.18)); }
  ...
  `,document.head.appendChild(e),En=!0}function el(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${ve(Ki(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${ve(zo(e))}</span>
      <span class="recent-lead__sub">${ve(e.email||e.phone||"")}</span>
    </span>
    <span class="recent-lead__badge" data-s="${ve(e.status)}">${ve(e.status)}</span>
    <span class="recent-lead__time">${ve(Xi(e))}</span>
  </a>`}const vt=({icon:e,label:t,valueId:a,value:n="—",subId:o,sub:s="",href:r})=>{const i=r?"a":"div",l=r?` href="${ve(r)}" class="stat-card stat-card--link"`:' class="stat-card"';return`
  <${i}${l}>
  ...
  </${i}>`},It=(e,t,a,{wide:n=!1,full:o=!1,controls:s=!1}={})=>`
  <div class="dashboard-card${n?" chart-card-wide":""}${o?" chart-card-full":""}">
  ...
  </div>`;let Sa=30;function Go(){Zi(),ct();const e=se();return`
    <div class="page-shell" data-section="home">
      ...
      <div class="stats-grid">
        ${vt({icon:"widgets",label:"Active Magnets",valueId:"stat-active-magnets",subId:"stat-active-magnets-sub",sub:"Loading…",href:"#/magnets"})}
        ${vt({icon:"ads_click",label:"Magnet Opens",valueId:"stat-opens",subId:"stat-opens-sub",sub:"Loading…"})}
        ${vt({icon:"person_add",label:"Leads Captured",valueId:"stat-leads",subId:"stat-leads-sub",sub:"Loading…"})}
        ${vt({icon:"check_circle",label:"Completion Rate",valueId:"stat-completion",subId:"stat-completion-sub",sub:"Loading…"})}
      </div>
      ...
      <div class="content-grid">
    ...
    </div>`}async function qo(){const e=x.getConfig?.().BASE_URL||"";document.getElementById("dash-periods")?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(Sa=Number(a.dataset.days)||30,document.querySelectorAll("#dash-periods .chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===Sa)),Sn(e))}),await Promise.all([Sn(e),nl(e)])}const Se=(e,t)=>{const a=document.getElementById(e);a&&(a.textContent=t)},et=(e,t)=>{const a=document.getElementById(e);a&&(a.innerHTML=t)},An=e=>e.toISOString().slice(0,10);async function Sn(e){const t=new Date,a=An(new Date(t.getTime()-(Sa-1)*864e5)),n=An(t),o=se();let s;try{const k=await fetch(`${e}/m5t/v5/dashboard/stats?from=${a}&to=${n}${o?"&group_by=owner":""}`);if(!k.ok)throw new Error(`HTTP ${k.status}`);if(s=await k.json(),!s.ok)throw new Error("stats not ok")}catch(y){console.warn("[dashboard] stats fetch failed:",y),["stat-active-magnets","stat-opens","stat-leads","stat-completion"].forEach(k=>Se(k,"—")),["stat-active-magnets-sub","stat-opens-sub","stat-leads-sub","stat-completion-sub"].forEach(k=>Se(k,"Unavailable")),["dash-trend","dash-funnel","dash-campaigns","dash-routes","dash-interactions","dash-portfolio"].forEach(k=>et(k,fe("error","Could not load. Please refresh.")));return}o&&tl(s.by_owner||[]),Se("stat-active-magnets",j(s.magnets.active)),Se("stat-active-magnets-sub",s.magnets.total>s.magnets.active?`${j(s.magnets.total-s.magnets.active)} paused`:s.magnets.active?"All running":"No magnets yet");const r=s.funnel||{};Se("stat-opens",r.opens?j(r.opens):"—"),Se("stat-opens-sub",r.opens?r.engagement_rate!=null?`${r.engagement_rate}% engage`:`${j(r.engaged)} engaged`:"No opens in this range yet");const i=s.leads||{};Se("stat-leads",j(i.total));const l=(i.this_week||0)-(i.prev_week||0);Se("stat-leads-sub",i.total?`${j(i.this_week)} this week (${l>=0?"+":""}${j(l)} vs last)`:"No leads yet"),Se("stat-completion",r.completion_rate!=null?`${r.completion_rate}%`:"—"),Se("stat-completion-sub",r.opens?`${j(r.completions)} completed of ${j(r.opens)} opens`:"Appears once magnets get opened");const c=s.by_day||[],m=c.some(y=>y.opens||y.leads);et("dash-trend",m?Vo(c):fe("show_chart","No activity in this range yet. Opens and leads chart here as visitors engage your magnets.")),m&&jo(c),et("dash-funnel",r.opens?al(r):fe("filter_alt","The funnel fills in once your magnets record opens."));const f=s.top_campaigns||[];et("dash-campaigns",f.length?`<div class="dash-list">${f.map(y=>`
        <div class="dash-list__row">
          ...
          <span class="dash-list__main" title="${ve(y.campaign)}">${ve(y.campaign)}</span>
          <span class="dash-list__num">${j(y.leads)}</span>
        </div>`).join("")}</div>`:fe("source","No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here."));const _={book:["event","Book"],chat:["chat","Chat"],call:["phone_in_talk","Call"],email:["mail","Email"],support:["support_agent","Support"]},v=Object.entries(r.routes||{}).sort((y,k)=>k[1]-y[1]),w=v.length?v[0][1]:0;et("dash-routes",v.length?`<div class="dash-funnel">${v.map(([y,k])=>{const[R,U]=_[y]||["touch_app",y];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${R}</span> ${ve(U)}</span><span class="dash-funnel__val">${j(k)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${w?Math.max(4,Math.round(k/w*100)):0}%"></div></div>
        </div>`}).join("")}</div>`:fe("touch_app","CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar."));const d={open:["visibility","Magnet opened"],engage:["touch_app","Visitor engaged"],route:["alt_route","Picked a channel"],complete:["check_circle","Completed: lead captured"]},h=s.recent_events||[];et("dash-interactions",h.length?`<div class="dash-list">${h.map(y=>{const[k,R]=d[y.event]||["sensors",y.event],U=y.event==="route"&&y.detail?` · ${ve(y.detail)}`:"";return`<div class="dash-list__row">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">${k}</span></span>
          <span class="dash-list__main">${R}${U}</span>
          ${y.display_mode?`<span class="dash-list__mode">${ve(y.display_mode)}</span>`:""}
          <span class="dash-list__time">${ve(Qi(y.at))}</span>
        </div>`}).join("")}</div>`:fe("sensors","No interactions yet. They'll stream in as visitors engage your magnets."))}function tl(e){const t=document.getElementById("dash-portfolio");if(!t)return;if(!e.length){t.innerHTML=fe("groups","No client orgs yet. Create one under Clients to see its numbers here.");return}const a=e.some(s=>s.ad),n=s=>{const r=(s.leads.this_week||0)-(s.leads.prev_week||0);return!s.leads.this_week&&!s.leads.prev_week?"":` <span class="${r>=0?"dc-delta-up":"dc-delta-down"}">(${r>=0?"+":""}${j(r)})</span>`},o=[{h:"Magnets",td:s=>`${j(s.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${j(s.magnets.total)}</span>`},{h:"Leads · wk",td:s=>`${j(s.leads.this_week)}${n(s)}`},{h:"Leads · total",td:s=>j(s.leads.total)},{h:"Opens",td:s=>j(s.opens)},{h:"Compl.",td:s=>s.completion_rate!=null?`${s.completion_rate}%`:"—"},...e.some(s=>s.booked)?[{h:"Booked",td:s=>s.booked?j(s.booked):"—"}]:[],...e.some(s=>s.called)?[{h:"Called",td:s=>s.called?j(s.called):"—"}]:[],...a?[{h:"Spend",td:s=>s.ad?`$${j(s.ad.spend)}`:"—"},{h:"CPL",td:s=>s.ad?.cost_per_lead!=null?`$${j(s.ad.cost_per_lead)}`:"—"}]:[]];t.innerHTML=Do(e,o),Bo(t)}function al(e){const t=[["Opened",e.opens,""],["Engaged",e.engaged," dash-funnel__bar--mid"],["Completed",e.completions," dash-funnel__bar--end"],...e.booked?[["Booked",e.booked," dash-funnel__bar--end"]]:[],...e.called?[["Called",e.called," dash-funnel__bar--end"]]:[]],a=Math.max(1,e.opens||0),n=o=>Math.min(100,Math.round((o||0)/a*100));return`<div class="dash-funnel">${t.map(([o,s,r])=>`
    ...
    </div>`).join("")}</div>`}async function nl(e){const t=document.getElementById("recent-leads-body");if(t)try{const a=await fetch(`${e}/m5t/v5/m5mLead`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json(),o=(Array.isArray(n?.data)?n.data:[]).filter(s=>!["DELETED","ARCHIVED"].includes(s.status));t.innerHTML=o.length?o.slice(0,5).map(el).join(""):fe("contacts","No leads captured yet. Publish a magnet to start collecting.")}catch(a){console.warn("[dashboard] Leads fetch failed:",a),t.innerHTML=fe("error","Could not load recent leads.")}}function kn(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}const Tn=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e));function Vo(e){const v=e.length||1,w=kn(Math.max(1,...e.map(I=>I.opens||0))),d=kn(Math.max(1,...e.map(I=>I.leads||0))),h=748/v,y=Math.min(22,h*.55),k=I=>46+h*(I+.5),R=I=>266-I/w*248,U=I=>266-I/d*248,ne=[0,.5,1].map(I=>{const V=266-I*248;return`<line x1="46" y1="${V.toFixed(1)}" x2="794" y2="${V.toFixed(1)}" stroke="#EAF0F7"/><text x="38" y="${(V+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${Tn(w*I)}</text><text x="802" y="${(V+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${Tn(d*I)}</text>`}).join(""),Y=e.map((I,V)=>{const Le=R(I.opens||0);return`<rect x="${(k(V)-y/2).toFixed(1)}" y="${Le.toFixed(1)}" width="${y.toFixed(1)}" height="${Math.max(0,266-Le).toFixed(1)}" rx="3" fill="#0072BA" opacity="0.85"/>`}).join(""),ce=e.map((I,V)=>`${k(V).toFixed(1)},${U(I.leads||0).toFixed(1)}`).join(" "),xe=v>1?`<polyline points="${ce}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",de=e.map((I,V)=>`<circle cx="${k(V).toFixed(1)}" cy="${U(I.leads||0).toFixed(1)}" r="3.2" fill="#009473"/>`).join(""),Pe=Math.max(1,Math.ceil(v/6)),$e=e.map((I,V)=>V%Pe===0||V===v-1?`<text x="${k(V).toFixed(1)}" y="288" text-anchor="middle" class="dash-ax">${I.date.slice(5)}</text>`:"").join(""),N=e.map((I,V)=>`<rect class="dash-hit" data-i="${V}" x="${(46+h*V).toFixed(1)}" y="18" width="${h.toFixed(1)}" height="${248 .toFixed(1)}" fill="transparent"/>`).join("");return`
    ...
    </div>`}function jo(e){const t=document.querySelector("#dash-trend .dash-chart-wrap"),a=document.querySelector("#dash-trend .dash-chart-tip");if(!t||!a)return;const n=s=>{try{return new Date(`${s}T00:00:00`).toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}catch{return s}},o=(s,r)=>{const i=e[s];if(!i)return;a.innerHTML=`
      <div class="dash-chart-tip__date">${n(i.date)}</div>
      <div class="dash-chart-tip__row"><i style="background:#0072BA"></i>${j(i.opens||0)} opens</div>
      <div class="dash-chart-tip__row"><i style="background:#009473"></i>${j(i.leads||0)} leads</div>`;const l=r.getBoundingClientRect(),c=t.getBoundingClientRect();a.style.left=`${l.left-c.left+l.width/2}px`,a.style.top=`${l.top-c.top}px`,a.hidden=!1};t.querySelectorAll(".dash-hit").forEach(s=>{const r=Number(s.dataset.i);s.addEventListener("mouseenter",()=>o(r,s)),s.addEventListener("mousemove",()=>o(r,s)),s.addEventListener("mouseleave",()=>{a.hidden=!0}),s.addEventListener("click",()=>o(r,s))})}const ol={render:Go,init:qo},sl=Object.freeze(Object.defineProperty({__proto__:null,default:ol,init:qo,render:Go,statCard:vt,svgTrendChart:Vo,wireTrendTooltip:jo},Symbol.toStringTag,{value:"Module"}));function rl(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/home" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function il(){console.log("[SignoutRoute] Initialized");const e=document.getElementById("confirm-signout-btn");e?.addEventListener("click",async()=>{e.disabled=!0,e.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await x.doSignout()})}const ll=Object.freeze(Object.defineProperty({__proto__:null,init:il,render:rl},Symbol.toStringTag,{value:"Module"}));let Cn=!1;function cl(){if(Cn)return;const e=document.createElement("style");e.id="m5t-section-page-styles",e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),Cn=!0}function Wo({title:e="Section",icon:t="widgets",name:a=""}={}){return cl(),`
    ...
    </section>`}function Yo(){}const dl={render:Wo,init:Yo},pl=Object.freeze(Object.defineProperty({__proto__:null,default:dl,init:Yo,render:Wo},Symbol.toStringTag,{value:"Module"})),ul={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ee=e=>String(e??"").replace(/[&<>"']/g,t=>ul[t]),be=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},Je=()=>x.getConfig?.().BASE_URL||"",ml=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,Vt=5,ue={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},ka=()=>x.getActiveOrg()?.guid||x.getMemberships()[0]?.orgGuid||null;let In=!1;function gl(){if(In)return;const e=document.createElement("style");e.id="m5t-notif-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),In=!0}const Va=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Jo(){return gl(),ct(),se()?At({section:"settings-notifications",title:"Notifications",description:"Pick a client to manage their lead alerts."}):`
    <div class="page-shell" data-section="settings-notifications">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="ntf-body">${Va("hourglass_empty","Loading…")}</div>
      </div>
    ...
    </div>`}async function Ko(){if(se()){const e=t=>Number(t||0).toLocaleString();return dt(Je(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Promise.all([hl(),Xo()])}async function Xo(){const e=ka();if(e)try{const t=await fetch(`${Je()}/m5t/v5/acctGroup/${encodeURIComponent(e)}/webhook`);if(t.status===403){ue.webhookAllowed=!1;return}const a=await t.json().catch(()=>({}));if(!a.ok)return;ue.webhook=a.webhook,Qo()}catch{}}function $n(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function Qo(){const e=document.getElementById("ntf-wh-card"),t=document.getElementById("ntf-wh-body");if(!e||!t)return;e.style.display="";const a=ue.webhook,n=a?.last_delivery;t.innerHTML=`
    <div class="ntf-wh">
      ...
      <input class="ntf-input" id="ntf-wh-url" type="url" placeholder="https://hooks.zapier.com/hooks/catch/…" value="${Ee(a?.uri||"")}" />
      ...
      <div class="ntf-wh__row">
        ...
        <span class="ntf-wh__status">${n?n.ok?`Last delivery: <span class="ok">delivered</span> ${Ee($n(n.tz))}`:`Last delivery: <span class="bad">failed</span> ${Ee($n(n.tz))} (${Ee(n.error||"")})`:""}</span>
      </div>
    </div>`,t.querySelector("#ntf-wh-save")?.addEventListener("click",async()=>{const o=t.querySelector("#ntf-wh-url")?.value.trim()||"",s=t.querySelector("#ntf-wh-secret")?.value??"",r={uri:o};s.trim()!==""&&(r.secret=s.trim());try{const i=await fetch(`${Je()}/m5t/v5/acctGroup/${encodeURIComponent(ka())}/webhook`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),l=await i.json().catch(()=>({}));if(!i.ok||!l.ok)throw new Error(l.error||`Failed (HTTP ${i.status})`);ue.webhook=l.webhook,be(o?"Webhook saved":"Webhook removed","success"),Qo()}catch(i){be(i.message||"Could not save","danger")}}),t.querySelector("#ntf-wh-test")?.addEventListener("click",async o=>{const s=o.currentTarget;s.disabled=!0;try{const r=await fetch(`${Je()}/m5t/v5/acctGroup/${encodeURIComponent(ka())}/webhook-test`,{method:"POST"}),i=await r.json().catch(()=>({}));r.ok&&i.ok?be("Test delivery sent","success"):be(i.error||"Could not deliver the test","danger")}catch{be("Could not deliver the test","danger")}finally{s.disabled=!1}try{await Xo()}catch(r){console.warn("[notifications] loadWebhook refresh failed:",r)}})}async function hl(){const e=document.getElementById("ntf-body");if(e){try{const a=await(await fetch(`${Je()}/m5t/v5/magnets`)).json().catch(()=>({}));if(!a.ok)throw new Error(a.message||"Failed to load");ue.magnets=(a.magnets||[]).filter(n=>n.status!=="ARCHIVED"),ue.canManage=!!a.canManage}catch(t){console.warn("[notifications] load failed:",t),e.innerHTML=Va("error","Could not load your magnets. Please try again.");return}Zo()}}function fl(e){const t=Array.isArray(e.notify_emails)?e.notify_emails:[],a=t.length>0;return`
    <div class="ntf-row" data-guid="${Ee(e.guid)}">
      <div class="ntf-magnet">
        <div class="ntf-name" title="${Ee(e.name)}">${Ee(e.name)}</div>
        <div class="ntf-meta">${Ee((e.domains||[]).join(", ")||e.status)}</div>
      ...
      <div class="ntf-config">
        ${t.length?`<div class="ntf-chips">${t.map(n=>`
              <span class="ntf-chip">${Ee(n)}${ue.canManage?`<button type="button" data-remove="${Ee(n)}" aria-label="Remove ${Ee(n)}">&times;</button>`:""}</span>`).join("")}</div>`:'<div class="ntf-none">No alert emails.</div>'}
        ${ue.canManage?`
        <div class="ntf-addrow">
          <input class="ntf-input" type="email" placeholder="name@business.com" aria-label="Add alert email" ${t.length>=Vt?"disabled":""} />
          <button class="ntf-btn" type="button" data-add ${t.length>=Vt?"disabled":""}>
    ...
    </div>`}function Zo(){const e=document.getElementById("ntf-body");if(e){if(!ue.magnets.length){e.innerHTML=Va("widgets","No magnets yet. Create one under Your Magnets first.");return}e.innerHTML=ue.magnets.map(fl).join(""),e.querySelectorAll(".ntf-row").forEach(t=>{const a=t.dataset.guid,n=t.querySelector(".ntf-input"),o=()=>{const s=(n?.value||"").trim().toLowerCase();if(!s)return;if(!ml.test(s)){be("That does not look like an email address","danger");return}const i=[...ue.magnets.find(l=>l.guid===a).notify_emails||[]];if(i.includes(s)){be("Already added","info");return}if(i.length>=Vt){be(`Up to ${Vt} emails per magnet`,"info");return}Ln(a,[...i,s])};t.querySelector("[data-add]")?.addEventListener("click",o),n?.addEventListener("keydown",s=>{s.key==="Enter"&&o()}),t.querySelectorAll("[data-remove]").forEach(s=>s.addEventListener("click",()=>{const r=ue.magnets.find(i=>i.guid===a);Ln(a,(r.notify_emails||[]).filter(i=>i!==s.dataset.remove))})),t.querySelector("[data-test]")?.addEventListener("click",()=>vl(a,t.querySelector("[data-test]")))})}}async function Ln(e,t){try{const a=await fetch(`${Je()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({notify_emails:t})}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||n.message||`Failed (HTTP ${a.status})`);const o=ue.magnets.find(s=>s.guid===e);o&&(o.notify_emails=t),be("Alert emails updated","success")}catch(a){console.warn("[notifications] save failed:",a),be(a.message||"Could not save","danger");return}try{Zo()}catch(a){console.error("[notifications] renderBody after save failed:",a)}}async function vl(e,t){t&&(t.disabled=!0);try{const a=await fetch(`${Je()}/m5t/v5/magnets/${encodeURIComponent(e)}/notify-test`,{method:"POST"}),n=await a.json().catch(()=>({}));a.ok&&n.ok?be("Test alert sent","success"):be(n.error||"Could not send the test","danger")}catch{be("Could not send the test","danger")}finally{t&&(t.disabled=!1)}}const bl={render:Jo,init:Ko},_l=Object.freeze(Object.defineProperty({__proto__:null,default:bl,init:Ko,render:Jo},Symbol.toStringTag,{value:"Module"})),yl={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},me=e=>String(e??"").replace(/[&<>"']/g,t=>yl[t]),ae=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},he=()=>x.getConfig?.().BASE_URL||"",P={providers:null,configured:null,denied:!1,busy:!1,autoOpenPicker:!1},ja=()=>x.getActiveOrg()?.guid||x.getMemberships()[0]?.orgGuid||null;let Rn=!1;function wl(){if(Rn)return;const e=document.createElement("style");e.id="m5t-intg-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Rn=!0}const Ta=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,st=(e,t="")=>`<div class="intg-alert ${t}"><span class="material-symbols-outlined" aria-hidden="true">${t==="error"?"error":"info"}</span><span>${e}</span></div>`;function xl(){return wl(),ct(),se()?At({section:"settings-integrations",title:"Integrations",description:"Pick a client to manage their connections."}):`
    <div class="page-shell" data-section="settings-integrations">
      ...
      <div id="intg-body">
        <div class="dashboard-card intg-card"><div class="card-body">${Ta("hourglass_empty","Loading…")}</div></div>
      </div>
    </div>`}async function El(){if(se()){const e=t=>Number(t||0).toLocaleString();return dt(he(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}Al(),await He()}function Al(){try{const e=new URLSearchParams(window.location.search),t=e.get("provider")==="calendly"?"Calendly":"Google Ads";if(e.get("connected")==="google_ads")ae("Google Ads connected.","success"),P.autoOpenPicker=!0;else if(e.get("connected")==="calendly")ae("Calendly connected.","success");else if(e.get("error"))ae(`${t} connection failed (${e.get("error")}).`,"error");else return;window.history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}}async function He(){const e=document.getElementById("intg-body");try{const t=await fetch(`${he()}/m5t/v5/integrations`);if(t.status===403){P.denied=!0,e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ta("lock","Integrations are managed by workspace admins.")}</div></div>`);return}const a=await t.json();if(!a.ok)throw new Error(a.error||"load failed");P.providers=a.data.providers,P.configured=a.data.configured,Cl()}catch{e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ta("error","Could not load integrations.")}</div></div>`)}}function Sl(){const e=ja(),t=P.providers?.google_ads||[],a=t.find(i=>i.owner_guid===e)||t[0]||null,n=!!P.configured?.google_ads;let o='<span class="intg-state">Not connected</span>',s="Connect a Google account with access to your ad accounts. Spend lines up against your magnet leads in Ad performance.",r="";if(!n)o='<span class="intg-state">Not available yet</span>',s="Google Ads reporting is being set up for this platform.";else if(!a)r='<button type="button" class="intg-btn primary" id="intg-g-connect"><span class="material-symbols-outlined" aria-hidden="true">link</span>Connect</button>';else{const i=a.external_account?.customer_ids?.length||0;a.connect_status==="ACTIVE"?(o='<span class="intg-state on"><span class="material-symbols-outlined" aria-hidden="true">check</span>Connected</span>',s=i?`This connection can reach <b>${i}</b> ad account${i===1?"":"s"}. Choose which ones feed reporting; metrics refresh daily in Ad performance.`:"Connected, but no ad accounts are reachable from this Google account. Reconnect with an account that has Google Ads access.",r=`
        ...
        <button type="button" class="intg-btn danger" id="intg-g-disconnect"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`):(o=`<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>${me(a.connect_status==="NEEDS_REAUTH"?"Reconnect needed":"Connection error")}</span>`,s="The connection stopped working. Reconnect to resume daily metric refreshes.",r=`
    ...
    <div class="dashboard-card intg-card">
      <div class="card-body">
        ...
        <button type="button" class="intg-btn danger" id="intg-r-disconnect"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`;const m=a.webhook||{};if(m.state==="active"){const f=m.last_received_tz?` Last call received ${me(String(m.last_received_tz).slice(0,10))}.`:"";r=st(`Call sync is on. New calls appear within minutes; a daily sweep catches anything missed.${f}`)}else r=st("Automatic call sync could not be set up in CallRail. Calls still arrive via the daily sweep and Sync now. Reconnect to retry the setup.","error")}else n='<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>Connection error</span>',o="The connection stopped working. Reconnect with a current CallRail API key.",s=`
    ...
    </div>`}function Cl(){const e=document.getElementById("intg-body");e&&(e.innerHTML=Sl()+kl()+Tl(),document.getElementById("intg-g-connect")?.addEventListener("click",Ll),document.getElementById("intg-g-sync")?.addEventListener("click",Rl),document.getElementById("intg-g-disconnect")?.addEventListener("click",Nl),document.getElementById("intg-g-accounts")?.addEventListener("click",Nn),document.getElementById("intg-c-connect")?.addEventListener("click",Ol),document.getElementById("intg-c-disconnect")?.addEventListener("click",Ml),document.getElementById("intg-r-connect")?.addEventListener("click",Pl),document.getElementById("intg-r-sync")?.addEventListener("click",Bl),document.getElementById("intg-r-disconnect")?.addEventListener("click",Ul),P.autoOpenPicker&&(P.autoOpenPicker=!1,document.getElementById("intg-g-accounts")&&Nn()))}async function Nn(){const e=document.getElementById("intg-g-picker");if(e){e.style.display="",e.innerHTML=st("Loading your ad accounts…");try{const a=await(await fetch(`${he()}/m5t/v5/integrations/google_ads/accounts`)).json();if(!a.ok)throw new Error(a.error||"load failed");Il(a.data.accounts||[],new Set(a.data.linked||[]))}catch{e.innerHTML=st("Could not load your ad accounts. Try again, or reconnect if this keeps happening.","error")}}}function Il(e,t){const a=document.getElementById("intg-g-picker");if(!a)return;const n=e.map(o=>{const s=o.manager||o.error,r=o.manager?"Manager":o.error?"Unavailable":o.currency||"",i=t.has(o.id)&&!s;return`
      <label class="intg-acct${s?" disabled":""}">
        <input type="checkbox" data-intg-acct="${me(o.id)}" ${i?"checked":""} ${s?"disabled":""}>
        <span style="min-width:0">
          <span class="intg-acct__name">${me(o.name||"Account "+o.id)}</span>
          <div class="intg-acct__id">${me(o.id)}</div>
        </span>
        ${r?`<span class="intg-acct__badge">${me(r)}</span>`:"<span></span>"}
    ...
    </div>`,document.getElementById("intg-picker-cancel")?.addEventListener("click",()=>{a.style.display="none"}),document.getElementById("intg-picker-save")?.addEventListener("click",$l)}async function $l(){const e=document.getElementById("intg-g-picker"),t=[...e?.querySelectorAll("input[data-intg-acct]:checked")||[]].map(n=>n.dataset.intgAcct),a=document.getElementById("intg-picker-save");a&&(a.disabled=!0);try{const o=await(await fetch(`${he()}/m5t/v5/integrations/google_ads/accounts`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({customer_ids:t})})).json();if(!o.ok)throw new Error(o.error||"save failed");ae(`${o.data.linked} account${o.data.linked===1?"":"s"} linked. First sync is running.`,"success"),e&&(e.style.display="none"),He()}catch{ae("Could not save account selection.","error"),a&&(a.disabled=!1)}}async function Ll(){if(!P.busy){P.busy=!0;try{const t=await(await fetch(`${he()}/m5t/v5/integrations/google_ads/connect`)).json();if(!t.ok||!t.data?.url)throw new Error(t.error||"connect failed");window.location.href=t.data.url}catch{ae("Could not start the Google connection.","error"),P.busy=!1}}}async function Rl(){if(P.busy)return;P.busy=!0;const e=document.getElementById("intg-g-sync");e&&(e.disabled=!0);try{const a=await(await fetch(`${he()}/m5t/v5/integrations/google_ads/sync`,{method:"POST"})).json();if(!a.ok)throw new Error(a.error||"sync failed");const o=(a.data?.connections?.[0]?.accounts||[]).filter(s=>s.error).length;ae(o?`Sync finished with ${o} account error${o===1?"":"s"}.`:"Metrics synced.",o?"warning":"success")}catch{ae("Sync failed.","error")}finally{P.busy=!1,e&&(e.disabled=!1),He()}}async function Nl(){if(!P.busy&&window.confirm("Disconnect Google Ads? Daily metric refreshes stop until reconnected.")){P.busy=!0;try{const t=await(await fetch(`${he()}/m5t/v5/integrations/google_ads`,{method:"DELETE"})).json().catch(()=>({}));if(!t.ok)throw new Error(t.error||"disconnect failed");ae("Google Ads disconnected.","success")}catch{ae("Disconnect failed.","error")}finally{P.busy=!1,He()}}}async function Ol(){if(!P.busy){P.busy=!0;try{const t=await(await fetch(`${he()}/m5t/v5/integrations/calendly/connect`)).json();if(!t.ok||!t.data?.url)throw new Error(t.error||"connect failed");window.location.href=t.data.url}catch{ae("Could not start the Calendly connection.","error"),P.busy=!1}}}async function Ml(){if(!P.busy&&window.confirm("Disconnect Calendly? Magnet booking falls back to the built-in scheduler and booking sync stops.")){P.busy=!0;try{const t=await(await fetch(`${he()}/m5t/v5/integrations/calendly`,{method:"DELETE"})).json().catch(()=>({}));if(!t.ok)throw new Error(t.error||"disconnect failed");ae("Calendly disconnected.","success")}catch{ae("Disconnect failed.","error")}finally{P.busy=!1,He()}}}function Pl(){const e=document.getElementById("intg-r-setup");e&&(e.style.display="",e.innerHTML=`
    <div class="intg-picker">
    ...
    </div>`,document.getElementById("intg-r-cancel")?.addEventListener("click",()=>{e.style.display="none"}),document.getElementById("intg-r-continue")?.addEventListener("click",Fl),document.getElementById("intg-r-key")?.focus())}const De=e=>{const t=document.getElementById("intg-r-status");t&&(t.textContent=e)};async function Fl(){const e=document.getElementById("intg-r-continue"),t=document.getElementById("intg-r-key")?.value.trim()||"",a=document.getElementById("intg-r-pickers");if(!t){De("Paste an API key first.");return}if(a&&!a.hidden)return Dl(t);e&&(e.disabled=!0),De("Checking the key with CallRail…");try{const o=await(await fetch(`${he()}/m5t/v5/integrations/callrail/validate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:t})})).json();if(!o.ok){De(o.error||"CallRail rejected that key.");return}const s=o.data.accounts||[],r=document.getElementById("intg-r-account");r&&(r.innerHTML=s.map(i=>`<option value="${me(i.id)}">${me(i.name)}</option>`).join(""),r.onchange=()=>On(t,r.value)),a&&(a.hidden=!1),e&&(e.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">save</span>Save'),De(""),await On(t,s[0]?.id)}catch{De("Could not reach CallRail. Try again.")}finally{e&&(e.disabled=!1)}}async function On(e,t){const a=document.getElementById("intg-r-company");if(!(!a||!t)){a.innerHTML='<option value="">Loading companies…</option>';try{const o=await(await fetch(`${he()}/m5t/v5/integrations/callrail/companies`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:t})})).json(),s=o.ok?o.data.companies||[]:[];a.innerHTML=s.length?s.map(r=>`<option value="${me(r.id)}">${me(r.name)}</option>`).join(""):'<option value="">No active companies in this account</option>'}catch{a.innerHTML='<option value="">Could not load companies</option>'}}}async function Dl(e){const t=document.getElementById("intg-r-continue"),a=document.getElementById("intg-r-account")?.value||"",n=document.getElementById("intg-r-company")?.value||"";if(!n){De("Pick the company this workspace tracks.");return}t&&(t.disabled=!0),De("Connecting…");try{const s=await(await fetch(`${he()}/m5t/v5/integrations/callrail`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:a,company_id:n})})).json();if(!s.ok)throw new Error(s.error||"connect failed");ae(s.data?.webhook_state==="active"?"CallRail connected. Call sync is on.":"CallRail connected. Call sync setup needs attention; see the card.","success"),He()}catch{De("Could not connect. Check the key and try again."),t&&(t.disabled=!1)}}async function Bl(){if(P.busy)return;P.busy=!0;const e=document.getElementById("intg-r-sync");e&&(e.disabled=!0);try{const a=await(await fetch(`${he()}/m5t/v5/integrations/callrail/sync?days=7`,{method:"POST"})).json();if(!a.ok)throw new Error(a.error||"sync failed");const n=a.data?.connections?.[0]||{};ae(n.error?"Sync finished with errors.":`Sync done. ${n.processed||0} new call${(n.processed||0)===1?"":"s"} recorded.`,n.error?"warning":"success")}catch{ae("Sync failed.","error")}finally{P.busy=!1,e&&(e.disabled=!1),He()}}async function Ul(){if(!P.busy&&window.confirm("Disconnect CallRail? Calls stop landing in your Leads inbox.")){P.busy=!0;try{const t=await(await fetch(`${he()}/m5t/v5/integrations/callrail`,{method:"DELETE"})).json().catch(()=>({}));if(!t.ok)throw new Error(t.error||"disconnect failed");ae("CallRail disconnected.","success")}catch{ae("Disconnect failed.","error")}finally{P.busy=!1,He()}}}const Hl=Object.freeze(Object.defineProperty({__proto__:null,init:El,render:xl},Symbol.toStringTag,{value:"Module"})),zl={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},$t=e=>String(e??"").replace(/[&<>"']/g,t=>zl[t]),jt=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},Wt=()=>x.getConfig?.().BASE_URL||"",rt={passkeys:[],loaded:!1};let Mn=!1;function Gl(){if(Mn)return;const e=document.createElement("style");e.id="m5t-security-styles",e.textContent=`
    ...
    .page-shell .pk-icon { flex: 0 0 auto; width: 38px; height: 38px; border-radius: 10px; display: inline-flex; align-items: center; justify-content: center; background: var(--color-accent-soft, #EEF4FF); color: var(--color-primary-600, #0072BA); }
    ...
    .page-shell .pk-btn { appearance: none; border: 1px solid var(--color-border, #D4DCE8); background: var(--color-bg, #fff); cursor: pointer; font: inherit; font-size: 0.8rem; font-weight: 600; color: var(--color-primary-600, #0072BA); padding: 7px 13px; border-radius: 10px; display: inline-flex; align-items: center; gap: 5px; }
  ...
  `,document.head.appendChild(e),Mn=!0}const Wa=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function es(){return Gl(),`
    <div class="page-shell" data-section="settings-security">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="pk-body">${Wa("hourglass_empty","Loading…")}</div>
      </div>
    </div>`}async function ts(){const e=document.getElementById("pk-add-btn");e&&window.PublicKeyCredential&&(e.style.display="",e.addEventListener("click",jl)),await as()}async function as(){const e=document.getElementById("pk-body");if(e){try{const t=await fetch(`${Wt()}/m5t/v5/webauthn`),a=await t.json().catch(()=>({}));if(!t.ok||!a.ok)throw new Error(a.error||"Failed to load");rt.passkeys=a.passkeys||[],rt.loaded=!0}catch(t){console.warn("[settings-security] load failed:",t),e.innerHTML=Wa("error","Could not load your passkeys. Please try again.");return}ns()}}function Pn(e){if(!e)return null;try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return null}}function ql(e){const t=Pn(e.last_used_time),a=e.created?.created_tz,n=Pn(a),o=[e.device_type==="multiDevice"?"Syncs across devices":"This device only",t?`Last used ${t}`:"Never used to sign in yet",n?`Added ${n}`:null].filter(Boolean).join(" · ");return`
    <div class="pk-row" data-guid="${$t(e.guid)}">
      <span class="pk-icon"><span class="material-symbols-outlined" aria-hidden="true">passkey</span></span>
      <div class="pk-info">
        <div class="pk-name">${$t(e.device_label||"Passkey")}</div>
        <div class="pk-meta">${$t(o)}</div>
      </div>
      <button class="pk-btn pk-btn--danger" type="button" data-remove="${$t(e.guid)}">
        <span class="material-symbols-outlined" aria-hidden="true">delete</span> Remove
      </button>
    </div>`}function ns(){const e=document.getElementById("pk-body");if(e){if(!window.PublicKeyCredential){e.innerHTML=`<p class="pk-unsupported">This browser doesn't support passkeys. Your password sign-in still works as usual.</p>`;return}if(!rt.passkeys.length){e.innerHTML=Wa("passkey","No passkeys yet. Add one for a faster, phishing-resistant sign-in.");return}e.innerHTML=rt.passkeys.map(ql).join(""),e.querySelectorAll("[data-remove]").forEach(t=>{t.addEventListener("click",()=>Wl(t.dataset.remove,t))})}}function Vl(){try{const e=navigator.userAgent||"",t=/iPhone/.test(e)?"iPhone":/iPad/.test(e)?"iPad":/Android/.test(e)?"Android":/Mac OS X/.test(e)?"Mac":/Windows/.test(e)?"Windows":/Linux/.test(e)?"Linux":"device",a=/Edg\//.test(e)?"Edge":/Chrome\//.test(e)?"Chrome":/Firefox\//.test(e)?"Firefox":/Safari\//.test(e)?"Safari":"";return a?`${a} on ${t}`:t}catch{return"Passkey"}}async function jl(){const e=document.getElementById("pk-add-btn");e&&(e.disabled=!0);try{const{startRegistration:t}=await K(async()=>{const{startRegistration:i}=await Promise.resolve().then(()=>No);return{startRegistration:i}},void 0),a=await fetch(`${Wt()}/m5t/v5/webauthn/register/options`,{method:"POST"}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||"Could not start passkey registration");let o;try{o=await t({optionsJSON:n.options})}catch(i){if(i?.name==="NotAllowedError")return;throw i}const s=await fetch(`${Wt()}/m5t/v5/webauthn/register/verify`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o,deviceLabel:Vl()})}),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.error||"Could not register this passkey");jt("Passkey added","success"),await as()}catch(t){console.warn("[settings-security] addPasskey failed:",t),jt(t.message||"Could not add a passkey","danger")}finally{e&&(e.disabled=!1)}}async function Wl(e,t){if(confirm("Remove this passkey? You can always add it back later.")){t&&(t.disabled=!0);try{const a=await fetch(`${Wt()}/m5t/v5/webauthn/${encodeURIComponent(e)}`,{method:"DELETE"}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||"Could not remove this passkey");rt.passkeys=rt.passkeys.filter(o=>o.guid!==e),jt("Passkey removed","success"),ns()}catch(a){console.warn("[settings-security] removePasskey failed:",a),jt(a.message||"Could not remove this passkey","danger"),t&&(t.disabled=!1)}}}const Yl={render:es,init:ts},Jl=Object.freeze(Object.defineProperty({__proto__:null,default:Yl,init:ts,render:es},Symbol.toStringTag,{value:"Module"})),Kl={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ee=e=>String(e??"").replace(/[&<>"']/g,t=>Kl[t]),Ca=()=>x.getConfig?.().BASE_URL||"",va=e=>Number(e||0).toLocaleString(),G={conversations:[],counts:{},magnetNames:{},filter:"ALL",book:!1,magnetOwnerNames:{}},Fn={COMPLETED:{label:"Completed",icon:"check_circle"},IN_PROGRESS:{label:"In progress",icon:"pending"},ABANDONED:{label:"Abandoned",icon:"highlight_off"}},Ia={book:"Book",chat:"Chat",call:"Call",email:"Email",support:"Support"};function os(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email)||null}function ss(e){return(e.split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase()}function rs(e){try{return new Date(e).toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return""}}function Xl(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function is(e){return e==null?"—":e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,"0")}s`}let Dn=!1;function Ql(){if(Dn)return;const e=document.createElement("style");e.id="m5t-convs-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Dn=!0}const ra=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function ls(){return Ql(),ct(),`
    <div class="page-shell" data-section="conversations">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="convs-body">
          ${ra("hourglass_empty","Loading journeys…")}
        </div>
      </div>
    </div>`}async function cs(){await Zl()}async function Zl(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${Ca()}/m5t/v5/conversations`),fetch(`${Ca()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(G.conversations=n.conversations||[],G.counts=n.counts||{},G.book=se(),a){const o=await a.json().catch(()=>({}));G.magnetNames={},G.magnetOwnerNames={};const s=G.book?Uo():{};(o.magnets||[]).forEach(r=>{G.magnetNames[r.guid]=r.name,G.book&&(G.magnetOwnerNames[r.guid]=r.owner_name||s[r.owner_guid]||"")})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=ra("error","Could not load journeys. Please try again.");return}ds()}}function ec(){return G.filter==="ALL"?G.conversations:G.conversations.filter(e=>e.status===G.filter)}function tc(e){const t=os(e.lead),a=G.magnetNames[e.magnet_guid]||"—",n=Fn[e.status]||Fn.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,s=(e.routes||[]).map(r=>Ia[r]||r).join(", ");return`
    <tr class="convs-row" data-session="${ee(e.session)}">
      <td>
        <span class="convs-who">
          <span class="convs-ava${t?"":" anon"}">${t?ee(ss(t)):'<span class="material-symbols-outlined" style="font-size:16px">person_off</span>'}</span>
          <span><span class="convs-name">${t?ee(t):'<span class="convs-muted">Anonymous visitor</span>'}</span>
            ${e.lead?.email?`<div class="convs-sub">${ee(e.lead.email)}</div>`:s?`<div class="convs-sub">Picked: ${ee(s)}</div>`:""}</span>
        </span>
      </td>
      ${G.book?`<td>${Ho(G.magnetOwnerNames[e.magnet_guid]||"")||'<span class="convs-muted">—</span>'}</td>`:""}
      <td><span class="convs-sub">${ee(a)}</span></td>
      <td><span class="convs-badge" data-s="${ee(e.status)}"><span class="material-symbols-outlined" aria-hidden="true">${n.icon}</span>${n.label}</span></td>
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${ee(rs(e.started_at))}">${ee(Xl(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${ee(is(e.duration_s))}</td>
    </tr>`}function ds(){const e=document.getElementById("convs-body");if(!e)return;if(!G.conversations.length){e.innerHTML=ra("route","No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.");return}const t=ec(),a=[["ALL","All"],["COMPLETED","Completed"],["IN_PROGRESS","In progress"],["ABANDONED","Abandoned"]];e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${a.map(([n,o])=>`<button data-filter="${n}" class="${G.filter===n?"active":""}">${o}${n!=="ALL"&&G.counts[n]?` (${va(G.counts[n])})`:""}</button>`).join("")}
      </div>
      <span class="convs-count">${va(t.length)} of ${va(G.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(tc).join("")||`<tr><td colspan="${G.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${G.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(G.filter=o.dataset.filter,ds())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&nc(o.dataset.session)})}const ac={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${Ia[e]||e}`:""}`,route:e=>`Picked ${Ia[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function nc(e){const t=G.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${Ca()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=os(t.lead),o=G.magnetNames[t.magnet_guid]||"—",r=(a?.events||[]).filter((c,m,f)=>c.event!=="step"||!(f[m+1]&&f[m+1].event==="step")).map(c=>`
    <div class="convs-tl__item${c.event==="complete"?" done":""}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${ee((ac[c.event]||(()=>c.event))(c.detail))}</div>
      <div class="convs-tl__time">${ee(rs(c.at))}${c.variant?` · Variant ${ee(c.variant)}`:""}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      <div class="convs-drawer__head">
        <span class="convs-drawer__title">${n?ee(n):"Anonymous visitor"}</span>
      ...
      <div class="convs-drawer__body">
        ${n?`<a class="convs-drawer__lead" href="#/leads">
              <span class="convs-ava">${ee(ss(n))}</span>
              <span><div class="convs-name">${ee(n)}</div><div class="convs-sub">${ee(t.lead?.email||t.lead?.phone||"")}</div></span>
        ...
        <div class="convs-sub" style="margin-bottom:6px">${ee(o)} · ${ee(is(t.duration_s))}${t.variant?` · Variant ${ee(t.variant)}`:""}</div>
        ${r?`<div class="convs-tl">${r}</div>`:ra("timeline","No timeline available for this journey.")}
      </div>
    </aside>`,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("open"),i.querySelector(".convs-drawer").classList.add("open")});const l=()=>{i.classList.remove("open"),setTimeout(()=>i.remove(),220)};i.querySelector(".convs-drawer__close").addEventListener("click",l),i.addEventListener("click",c=>{c.target===i&&l()})}const oc={render:ls,init:cs},sc=Object.freeze(Object.defineProperty({__proto__:null,default:oc,init:cs,render:ls},Symbol.toStringTag,{value:"Module"})),rc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},We=e=>String(e??"").replace(/[&<>"']/g,t=>rc[t]),Bn=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},Pt=()=>x.getConfig?.().BASE_URL||"",it=e=>Number(e||0).toLocaleString(),Ue={magnets:[],stats:{},canManage:!1},ic={mag_title:"header title",mag_subtitle:"subtitle",mag_welcome:"welcome message",mag_theme_color:"color",mag_launcher_label:"launcher label"};let Un=!1;function lc(){if(Un)return;const e=document.createElement("style");e.id="m5t-abt-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Un=!0}const Ya=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function ps(){return se()?At({section:"ab-testing",title:"A/B Testing",description:"Pick a client to view their experiments."}):(lc(),`
    <div class="page-shell" data-section="ab-testing">
      ...
      <div id="abt-body">${Ya("hourglass_empty","Loading tests…")}</div>
    </div>`)}async function Ja(){if(se())return dt(Pt(),[{h:"Running",td:t=>it(t.ab_tests?.running)},{h:"Completed",td:t=>it(t.ab_tests?.completed)},{h:"Compl. %",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Experiments appear per client once you have one."});const e=document.getElementById("abt-body");try{const t=new Date,a=new Date(t.getTime()-89*864e5).toISOString().slice(0,10),n=t.toISOString().slice(0,10),[o,s]=await Promise.all([fetch(`${Pt()}/m5t/v5/magnets`),fetch(`${Pt()}/m5t/v5/magnets/stats?from=${a}&to=${n}`)]),r=await o.json().catch(()=>({}));if(!r.ok)throw new Error(r.message||"Failed to load");Ue.magnets=r.magnets||[],Ue.canManage=!!r.canManage;const i=await s.json().catch(()=>({}));Ue.stats=i?.stats||{}}catch(t){console.warn("[ab-testing] load failed:",t),e&&(e.innerHTML=Ya("error","Could not load your tests. Please try again."));return}cc()}function cc(){const e=document.getElementById("abt-body");if(!e)return;const t=Ue.magnets.filter(n=>n.ab?.enabled),a=Ue.magnets.filter(n=>!n.ab?.enabled&&n.ab?.declared);if(!t.length&&!a.length){e.innerHTML=Ya("science","No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.");return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(mc).join("")}`:"")+(a.length?`<div class="abt-sect">Completed Tests</div>${a.map(gc).join("")}`:""),e.querySelectorAll("[data-declare]").forEach(n=>n.addEventListener("click",()=>hc(n.dataset.declare,n.dataset.winner)))}function dc(e){const t=Ue.stats[e.guid]?.variants||{},a={opens:0,engaged:0,completions:0,rate:null,...t.A||{}},n={opens:0,engaged:0,completions:0,rate:null,...t.B||{}};return{A:a,B:n}}function pc(e){const t=Object.keys(e?.b||{}).map(a=>ic[a]||a);return t.length?`Changes: ${t.join(", ")}`:""}function uc(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function Hn(e,t,a,n,o,s){return`
    <div class="abt-variant${o?" leader":""}">
      <div class="abt-vhead"><span class="abt-vname">${We(e)}</span><span class="abt-vtag${o?" win":""}">${We(t)}</span></div>
      ${a?`<div class="abt-vdesc">${We(a)}</div>`:""}
    ...
    </div>`}function mc(e){const t=e.ab,{A:a,B:n}=dc(e),o=(n.rate??-1)>(a.rate??-1)?"B":(a.rate??-1)>(n.rate??-1)?"A":null,s=o&&a.rate!=null&&n.rate!=null?`+${Math.round(Math.abs(n.rate-a.rate)*10)/10}%`:"",r=fc(a,n),i=t.started_tz?uc(t.started_tz):null,l=(a.opens||0)+(n.opens||0),c=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
        <h2 class="abt-name">${We(e.name)}</h2>
        <span class="abt-status running"><span class="pulse-dot"></span>Running</span>
        <div class="abt-actions">
          ${Ue.canManage&&o?`<button class="btn btn-primary" type="button" data-declare="${We(e.guid)}" data-winner="${o}"><span class="material-symbols-outlined" aria-hidden="true">emoji_events</span>Declare Winner</button>`:""}
        </div>
      </div>
      <div class="abt-meta">
      ...
      <div class="abt-compare">
        ${Hn("Variant A","Control","The magnet as configured",a,o==="A",o==="A"?s:"")}
        <div class="abt-vs">VS</div>
        ${Hn("Variant B",o==="B"?"Leading":"Challenger",pc(t),n,o==="B",o==="B"?s:"")}
      </div>
      <div class="abt-sig">
    ...
    <div class="abt-card">
      ...
      <div class="abt-summary">
        <span><span class="k">Winner:</span><span class="v">Variant ${We(t.winner)}</span></span>
    ...
    </div>`}async function hc(e,t){const a=Ue.magnets.find(n=>n.guid===e);if(a&&window.confirm(`Declare Variant ${t} the winner for “${a.name}”?

${t==="B"?"Variant B’s changes become the magnet’s configuration for everyone.":"The magnet keeps its current configuration."} The experiment ends and moves to Completed.`)){try{const o=await(await fetch(`${Pt()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Declare failed");Bn(`Variant ${t} declared the winner`,"success")}catch(n){Bn(n.message||"Could not declare a winner","danger");return}try{await Ja()}catch(n){console.warn("[ab-testing] refresh after declare failed:",n)}}}function fc(e,t){const a=e.opens||0,n=t.opens||0,o=e.completions||0,s=t.completions||0;if(a<30||n<30||o+s<5)return null;const r=o/a,i=s/n,l=(o+s)/(a+n),c=Math.sqrt(l*(1-l)*(1/a+1/n));if(!c)return null;const m=Math.abs(i-r)/c;return Math.round(2*(vc(m)-.5)*1e3)/10}function vc(e){const t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}const bc={render:ps,init:Ja},_c=Object.freeze(Object.defineProperty({__proto__:null,default:bc,init:Ja,render:ps},Symbol.toStringTag,{value:"Module"})),yc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ie=e=>String(e??"").replace(/[&<>"']/g,t=>yc[t]),us=()=>x.getConfig?.().BASE_URL||"",wc={single_select:{icon:"quiz",color:"#0072BA"},multi_select:{icon:"checklist",color:"#0E6BA8"},scheduler:{icon:"event",color:"#915E8B"},text:{icon:"short_text",color:"#5B54C6"},email:{icon:"mail",color:"#0E8F86"},phone:{icon:"call",color:"#2E8B57"},message:{icon:"chat",color:"#B4791F"}},Yt={};Ba.forEach(e=>{Yt[e.value]={label:e.label,...wc[e.value]||{icon:"quiz",color:"#0072BA"}}});const ms=Ba.map(e=>e.value),gs={chat:"Chat / default",book:"Book (scheduler)",support:"Support (intake)"},Ka=e=>Yt[e]||Yt.single_select,Qe=e=>e==="single_select"||e==="multi_select",ia=e=>e!=="message",St=e=>e==="scheduler",Jt=e=>e==="email"?"email":e==="phone"?"phone":"",Ke=()=>({meeting_label:"",start:"09:00",end:"17:00",mins:30,days:14}),xc=[["","No icon"],["event","Calendar"],["schedule","Clock"],["mail","Email"],["sms","Text"],["phone","Phone"],["chat","Chat"],["description","Document"],["help","Question"],["place","Location"],["person","Person"],["bolt","Quick"],["check_circle","Check"],["star","Star"],["home","Home"],["build","Service"]];function Ec(e,t){const a=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||"").trim());return a?`rgba(${parseInt(a[1],16)},${parseInt(a[2],16)},${parseInt(a[3],16)},${t})`:`rgba(0,114,186,${t})`}let zn=!1;function Ac(){if(zn)return;const e=document.createElement("style");e.id="m5t-flow-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),zn=!0}let O=[],ke=null,Sc=0,Fe=null,Ve=null,je="chat",_e={},Ft=[],hs=null,$a=null,Dt="";const lt=()=>"f"+ ++Sc;function Xa(e="single_select"){return{_uid:lt(),id:"",step_type:e,step_prompts:[""],step_options:Qe(e)?[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]:[],step_columns:Jt(e)?[Jt(e)]:[],step_description:"",step_config:St(e)?Ke():null}}function kc(e){return(Array.isArray(e)?e:[]).map(t=>({_uid:lt(),id:t.id!=null?String(t.id):"",step_type:Yt[t.step_type]?t.step_type:"single_select",step_prompts:Array.isArray(t.step_prompts)?t.step_prompts.map(String):[],step_options:(Array.isArray(t.step_options)?t.step_options:[]).map(a=>({label:a&&a.label!=null?String(a.label):"",goto:a&&a.goto!=null?String(a.goto):"",icon:a&&a.icon!=null?String(a.icon):""})),step_columns:Array.isArray(t.step_columns)?t.step_columns.map(String):[],step_description:t.step_description!=null?String(t.step_description):"",step_config:t.step_config&&typeof t.step_config=="object"?{...Ke(),...t.step_config}:t.step_type==="scheduler"?Ke():null}))}function Gn(){return[{_uid:lt(),id:"",step_type:"text",step_prompts:["Great, and your name?"],step_options:[],step_columns:["first_name"],step_description:"",step_config:null},{_uid:lt(),id:"",step_type:"email",step_prompts:["The best email to reach you?"],step_options:[],step_columns:["email"],step_description:"",step_config:null}]}function Tc(e,t){if(e==="book")return[{_uid:lt(),id:"",step_type:"scheduler",step_prompts:["When works best for you?"],step_options:[],step_columns:[],step_description:"",step_config:Ke()},...Gn()];if(e==="support"){const a=(t.actions||[]).find(s=>s&&s.type==="support"),n=a&&a.config&&Array.isArray(a.config.options)?a.config.options:[],o=n.length?n.map(s=>({label:s&&s.label||String(s),goto:"",icon:s&&s.icon||""})):["Sales enquiry","Support","Billing","Something else"].map(s=>({label:s,goto:"",icon:""}));return[{_uid:lt(),id:"",step_type:"multi_select",step_prompts:["How can we help you today?"],step_options:o,step_columns:[],step_description:"Select all that apply",step_config:null},...Gn()]}return[Xa("single_select")]}function fs(e,t){const a=e==="chat"?t.steps:t.routes&&t.routes[e],n=kc(a);return n.length?n:e==="chat"?[Xa("single_select")]:Tc(e,t)}function Cc(e){Qe(e.step_type)?e.step_options.length||(e.step_options=[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]):e.step_options=[],ia(e.step_type)?!e.step_columns.length&&Jt(e.step_type)&&(e.step_columns=[Jt(e.step_type)]):e.step_columns=[],e.step_config=St(e.step_type)?e.step_config||Ke():null}function Ic(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${ie(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${xc.map(([a,n])=>`<option value="${ie(a)}"${a===e.icon?" selected":""}>${ie(n)}</option>`).join("")}</select>
  ...
  </div>`}function $c(e){const t=ms.map(n=>`<option value="${n}"${n===e.step_type?" selected":""}>${ie(Ka(n).label)}</option>`).join(""),a=e.step_options.length<=1;return`<div class="flow-node__body">
    ...
    <textarea class="mag-modal__input flow-f-prompts" rows="2" placeholder="${e.step_type==="message"?"Thanks! One moment…":"What can we help you with?"}">${ie(e.step_prompts.join(`
`))}</textarea>
    ...
    <select class="mag-modal__select flow-f-field">
      ...
      ${Da.map(n=>`<option value="${ie(n.value)}"${n.value===e.step_columns[0]?" selected":""}>${ie(n.label)}</option>`).join("")}
    </select>
    ...
    <div class="flow-opts">${e.step_options.map(n=>Ic(n,a)).join("")}</div>
    ...
    <input class="mag-modal__input flow-f-mtlabel" type="text" value="${ie(e.step_config?.meeting_label||"")}" placeholder="e.g. 15 minute call">
    <div class="mag-modal__row" style="margin-top:8px">
      <div><label class="mag-modal__label">From</label><input class="mag-modal__input flow-f-start" type="time" value="${ie(e.step_config?.start||"09:00")}"></div>
      <div><label class="mag-modal__label">To</label><input class="mag-modal__input flow-f-end" type="time" value="${ie(e.step_config?.end||"17:00")}"></div>
  ...
  </div>`}function Lc(e){const t=e.step_prompts.find(o=>String(o).trim()!=="")||"",a=t?`<div class="flow-node__prompt">“${ie(t)}”</div>`:`<div class="flow-node__prompt is-empty">${e.step_type==="message"?"No message yet":"No question yet"}</div>`;let n="";if(Qe(e.step_type)){const o=e.step_options.map(s=>String(s.label).trim()).filter(Boolean);if(o.length){const s=o.slice(0,4).map(i=>`<span class="flow-node__chip">${ie(i)}</span>`).join(""),r=o.length>4?`<span class="flow-node__chip">+${o.length-4}</span>`:"";n=`<div class="flow-node__chips">${s}${r}</div>`}}else if(ia(e.step_type)&&e.step_columns[0]){const o=Da.find(s=>s.value===e.step_columns[0])?.label||e.step_columns[0];n=`<div class="flow-node__meta">Saves to <b>${ie(o)}</b></div>`}return`<div class="flow-node__preview">${a}${n}</div>`}function Rc(e,t,a){const n=Ka(e.step_type),o=e._uid===ke,s=`--nc:${n.color};--nct:${Ec(n.color,.14)}`;return`<div class="flow-node${o?" flow-node--open":""}" data-uid="${e._uid}" style="${s}"${o?"":' draggable="true"'}>
    <div class="flow-node__hd">
      ...
      <span class="flow-node__type">${ie(n.label)}</span>
    ...
    ${o?$c(e):Lc(e)}
  </div>`}const qn='<div class="flow-conn"><span class="flow-conn__line"></span><span class="material-symbols-outlined" aria-hidden="true">expand_more</span></div>';function we(){const e=document.getElementById("flow-nodes");if(!e)return;const t=O.length,a=['<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>',qn];O.forEach((n,o)=>{a.push(Rc(n,o,t)),o<t-1&&a.push(qn)}),e.innerHTML=a.join("")}function Te(){const e=document.querySelector(".flow-node--open");if(!e)return;const t=O.find(s=>s._uid===e.dataset.uid);if(!t)return;const a=e.querySelector(".flow-f-type");a&&(t.step_type=a.value);const n=e.querySelector(".flow-f-prompts");n&&(t.step_prompts=n.value.split(`
`));const o=e.querySelector(".flow-f-field");if(t.step_columns=o&&o.value.trim()?[o.value.trim()]:[],Qe(t.step_type)){const s=t.step_options,r=[];e.querySelectorAll(".flow-opt").forEach((i,l)=>{r.push({label:i.querySelector(".flow-o-label")?.value??"",icon:i.querySelector(".flow-o-icon")?.value??"",goto:s[l]&&s[l].goto||""})}),t.step_options=r}else t.step_options=[];if(St(t.step_type)){const s=e.querySelector(".flow-f-mtlabel"),r=e.querySelector(".flow-f-start"),i=e.querySelector(".flow-f-end"),l=e.querySelector(".flow-f-mins");t.step_config={...t.step_config||Ke(),...s?{meeting_label:s.value.trim()}:{},...r&&r.value?{start:r.value}:{},...i&&i.value?{end:i.value}:{},...l?{mins:parseInt(l.value,10)||30}:{}}}else t.step_config=null}function vs(){document.querySelectorAll(".flow-node.drop-before, .flow-node.drop-after").forEach(e=>e.classList.remove("drop-before","drop-after"))}function ht(){vs(),document.querySelectorAll(".flow-node.dragging").forEach(e=>e.classList.remove("dragging")),Fe=null,Ve=null}function Nc(e=O){if(!e.length)return"Add at least one step.";for(let t=0;t<e.length;t++){const a=e[t],n=t+1;if(!a.step_prompts.some(o=>String(o).trim()!==""))return`Step ${n}: add what the magnet should say.`;if(Qe(a.step_type)&&!a.step_options.some(o=>String(o.label).trim()!==""))return`Step ${n}: add at least one choice.`;if(ia(a.step_type)&&!a.step_columns.length)return`Step ${n}: choose which field this answer saves to.`}return""}function La(e=O){let t=0;return e.forEach(a=>{const n=parseInt(a.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(a=>{const n=a.id&&String(a.id).trim()?String(a.id):String(++t),o=Qe(a.step_type)?a.step_options.map(r=>{const i={label:String(r.label).trim(),goto:String(r.goto||"")};return r.icon&&(i.icon=String(r.icon)),i}).filter(r=>r.label!==""):[],s={id:n,step_type:a.step_type,step_prompts:a.step_prompts.map(r=>String(r)).filter(r=>r.trim()!==""),step_options:o,step_columns:a.step_columns.slice(),step_description:a.step_description||""};return St(a.step_type)&&a.step_config&&(s.step_config={...Ke(),...a.step_config}),s})}function Oc(e,t,a){Ac(),hs=t,$a=typeof a=="function"?a:null,Dt=t?.modified_tz||"",Ft=["chat",...["book","support"].filter(n=>(t.actions||[]).some(o=>o&&o.type===n))],_e={chat:fs("chat",t)},je="chat",O=_e.chat,ke=O.length===1?O[0]._uid:null,Fe=null,Ve=null,e.innerHTML=`
    ...
    ${Ft.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${Ft.map(n=>`<option value="${n}">${ie(gs[n]||n)}</option>`).join("")}</select></div>`:""}
...
<body>
  ...
  <\/script>
  <script>${a}<\/script>
</body></html>`}let jn=!1;function _s(){if(jn)return;const e=document.createElement("style");e.id="m5t-preview-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),jn=!0}function ys(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function ws(e){const t=e.querySelector("[data-pv-info]"),a=e.querySelector("[data-pv-info-pop]");t&&a&&t.addEventListener("click",()=>{a.hidden=!a.hidden})}function Hc(e,t){_s(),e.innerHTML=`
    <div class="pv-pane">
      ...
      ${ys("Live render of the real widget. Capture is disabled, so no test leads.")}
    </div>`,ws(e);const a=e.querySelector(".pv-pane__frame"),n=e.querySelector(".pv-pane__badge");let o=null,s=0;const r=450,i=()=>{const c=(typeof performance<"u"?performance.now():Date.now())-s;clearTimeout(o),c<r?o=setTimeout(()=>{n.hidden=!0},r-c):n.hidden=!0};a.addEventListener("load",i);const l=()=>{let c;try{c=bs(t())}catch{return}s=typeof performance<"u"?performance.now():Date.now(),n.hidden=!1,a.srcdoc=c,clearTimeout(o),o=setTimeout(()=>{n.hidden=!0},1500)};return e.querySelector(".pv-pane__seg").addEventListener("click",c=>{const m=c.target.closest("button[data-device]");!m||m.dataset.device===a.dataset.device||(e.querySelectorAll(".pv-pane__seg button").forEach(f=>f.classList.toggle("is-on",f===m)),a.dataset.device=m.dataset.device)}),l(),{refresh:l,destroy(){clearTimeout(o)}}}function xs(e){_s();let t="desktop";const a=document.createElement("div");a.className="pv-scrim",a.innerHTML=`
    ...
    .mag-tpl-card__icon { width: 42px; height: 42px; border-radius: 10px; display: inline-flex; align-items: center; justify-content: center; background: var(--color-accent-soft, #EEF4FF); color: var(--color-primary-600, #0072BA); }
    ...
    .mag-tpl-card__btn { align-self: flex-start; appearance: none; border: 1px solid var(--color-primary-600, #0072BA); background: transparent; color: var(--color-primary-600, #0072BA); cursor: pointer; font: inherit; font-size: 0.82rem; font-weight: 600; padding: 7px 13px; border-radius: 10px; display: inline-flex; align-items: center; gap: 5px; }
    .mag-tpl-card__btn:hover { background: var(--color-accent-soft, #EEF4FF); }
    .mag-tpl-card__btn[disabled] { opacity: 0.55; cursor: default; }
  `,document.head.appendChild(e),Yn=!0}function Gc(e){zc();const t=document.createElement("div");t.className="mag-modal-scrim mag-tpl-modal",t.innerHTML=`
        ...
        <div class="mag-tpl-grid">
          ${Wn.map(o=>`
            <div class="mag-tpl-card">
              <span class="mag-tpl-card__icon"><span class="material-symbols-outlined" aria-hidden="true">${o.icon}</span></span>
              <span class="mag-tpl-card__name">${o.name}</span>
              <p class="mag-tpl-card__desc">${o.description}</p>
              <button class="mag-tpl-card__btn" type="button" data-tpl="${o.id}">
                <span class="material-symbols-outlined" aria-hidden="true">arrow_forward</span>Use this template
              </button>
            </div>`).join("")}
        </div>
      </div>
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(o){o.key==="Escape"&&(o.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.querySelectorAll("[data-tpl]").forEach(o=>{o.addEventListener("click",()=>{const s=Wn.find(r=>r.id===o.dataset.tpl);s&&(t.querySelectorAll("[data-tpl]").forEach(r=>{r.disabled=!0}),a(),e(s))})})}let Jn=!1;const B={magnets:[],owners:[],canProvision:!1,canManage:!1,primaryOrgGuid:null,stats:{}},qc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},b=e=>String(e??"").replace(/[&<>"']/g,t=>qc[t]),Me=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},J=()=>x.getConfig?.().BASE_URL||"",Es=e=>`<script src="${J()}/m5t/v5/coreSnippet?appguid=${e}" async><\/script>`,As=()=>`<details class="mag-csp-note" open>
  ...
  <div class="mag-csp-note__body">
    <p>A strict CSP can silently block the widget — it just never appears, no visible error. Allowlist <code>${b(J())}</code> under all three directives. Copy-paste ready for your CSP header/meta tag:</p>
    <pre class="mag-csp-note__snippet"><code>script-src 'self' ${b(J())};
connect-src 'self' ${b(J())};
img-src 'self' ${b(J())};</code></pre>
    <ul>
...
</details>`,Vc={chat:"Chat bubble",right_slide:"Slide-in panel",modal:"Modal",inline:"Inline"},jc={chat:"chat",right_slide:"vertical_split",modal:"web_asset",inline:"view_agenda"},Wc=[{value:"inline",icon:"view_agenda",label:"Inline"},{value:"chat",icon:"chat",label:"Chat"},{value:"right_slide",icon:"vertical_split",label:"Slide"},{value:"modal",icon:"web_asset",label:"Modal"}],Yc=[{value:"auto",icon:"brightness_auto",label:"Auto"},{value:"light",icon:"light_mode",label:"Light"},{value:"dark",icon:"dark_mode",label:"Dark"}],Jc=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],Ss={book:{label:"Book",icon:"event",kind:"book"},chat:{label:"Chat",icon:"chat",kind:"flow"},call:{label:"Call",icon:"phone",kind:"value",placeholder:"Phone number"},email:{label:"Email",icon:"mail",kind:"value",placeholder:"Email address"},support:{label:"Support",icon:"support_agent",kind:"support"}},Kc=["book","chat","call","email","support"];let Bt=null;async function Xc(){if(Bt)return Bt;let e;try{const t=await fetch(`${J()}/m5t/v5/integrations/calendly/event_types`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.event_types||[],scheduling_url:a.data.scheduling_url||""}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(Bt=e),e}async function Qc(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved Calendly event";e.innerHTML=`<option value="${b(t)}">${t?b(a):"Loading event types"}</option>`;const n=await Xc();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${b(t)}" selected>${b(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect Calendly under Settings, Integrations first":"Could not load event types"}</option>`;return}const o=[];n.scheduling_url&&o.push({url:n.scheduling_url,label:"Full scheduling page (visitor picks the event)"}),n.list.forEach(s=>o.push({url:s.scheduling_url,label:s.duration?`${s.name} (${s.duration} min)`:s.name})),t&&!o.some(s=>s.url===t)&&o.unshift({url:t,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${b(s.url)}"${s.url===(t||o[0].url)?" selected":""}>${b(s.label)}</option>`).join(""):'<option value="">No active event types</option>'}let Ut=null;async function Zc(){if(Ut)return Ut;let e;try{const t=await fetch(`${J()}/m5t/v5/integrations/callrail/trackers`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.trackers||[]}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(Ut=e),e}async function ed(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved tracking number";e.innerHTML=`<option value="${b(t)}">${t?b(a):"Loading tracking numbers"}</option>`;const n=await Zc();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${b(t)}" selected>${b(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect CallRail under Settings, Integrations first":"Could not load tracking numbers"}</option>`;return}const o=n.list.map(s=>({number:s.number,id:s.id,name:s.name,label:`${s.name} · ${s.number}${s.type==="session"?" (number pool)":""}`}));t&&!o.some(s=>s.number===t)&&o.unshift({number:t,id:e.dataset.savedId||"",name:a,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${b(s.number)}" data-tracker-id="${b(s.id)}" data-tracker-name="${b(s.name)}"${s.number===(t||o[0].number)?" selected":""}>${b(s.label)}</option>`).join(""):'<option value="">No active tracking numbers in this company</option>'}function Kn(e,t,a){return`<div class="mag-seg" role="radiogroup" aria-label="${b(e)}">${a.map(n=>`
    <label><input type="radio" name="${b(e)}" value="${b(n.value)}"${n.value===t?" checked":""}>
      <span><span class="material-symbols-outlined" aria-hidden="true">${b(n.icon)}</span>${b(n.label)}</span></label>`).join("")}</div>`}function td(e,t){const a=Ss[e],n=!!t,o=n?"":" disabled";let s="";if(a.kind==="value"&&e==="call"){const i=t?.config?.source==="callrail",l=i&&t?.value||"",c=i?t?.config?.tracker_name||"Saved tracking number":"";s=`
      ...
      </select>`}else if(a.kind==="value")s=`<input class="mag-modal__input mag-cta__val" type="text" placeholder="${b(a.placeholder)}" value="${b(t?.value||"")}"${o}>`;else if(a.kind==="book"){const i=t?.config?.meeting_label||t?.value||"",l=t?.config?.source==="calendly",c=l&&t?.config?.calendly_url||"",m=l?t?.config?.event_name||"Saved Calendly event":"";s=`
      ...
      <select class="mag-modal__select mag-cta__calevent" data-saved="${b(c)}" data-saved-name="${b(m)}"${o}${l?"":" hidden"}>
        ${c?`<option value="${b(c)}" selected>${b(m)}</option>`:""}
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${a.kind}">
    ...
    ${r}
  </div>`}function ad(){if(Jn)return;const e=document.createElement("style");e.id="m5t-magnets-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Jn=!0}function Kt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function nd(e){const t=B.stats[e];if(!t||!t.opens&&!t.leads)return'<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>';const a=n=>Number(n||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function Qa(e){const t=B.owners.length>1||x.getMemberships().length>1,a=(e.domains||[]).filter(Boolean),n=B.canManage;return`
    <div class="mag-card" data-guid="${b(e.guid)}">
      ...
      <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${jc[e.display_mode]||"chat"}</span>${b(Vc[e.display_mode]||"Chat bubble")}${e.ab?.enabled?'&nbsp;&nbsp;<span class="mag-ab-chip"><span class="material-symbols-outlined" aria-hidden="true">science</span>A/B</span>':""}${(e.notify_emails||[]).length?`&nbsp;&nbsp;<a class="mag-alert-chip" href="#/settings/notifications" title="Lead alerts to ${(e.notify_emails||[]).length} email${(e.notify_emails||[]).length===1?"":"s"}. Manage in Settings."><span class="material-symbols-outlined" aria-hidden="true">notifications_active</span>${(e.notify_emails||[]).length}</a>`:""}</span>
      ${nd(e.guid)}
      <div class="mag-domains">${a.length?a.map(o=>b(o)).join(", "):"<span>No domains set. Add yours to go live.</span>"}</div>
      <div class="mag-embed">
        <input type="text" readonly value="${b(Es(e.guid))}" aria-label="Embed snippet">
    ...
    </div>`}function od(){return se()?At({section:"magnets",title:"Your Magnets",description:"Pick a client to view and manage their magnets."}):(ad(),`
    <div class="page-shell" data-section="magnets">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="mag-body">
          ${Kt("hourglass_empty","Loading magnets…")}
        </div>
      </div>
    </div>`)}async function sd(){if(se()){const t=a=>Number(a||0).toLocaleString();return dt(J(),[{h:"Magnets",td:a=>`${t(a.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${t(a.magnets.total)}</span>`},{h:"Leads · wk",td:a=>t(a.leads.this_week)},{h:"Leads · total",td:a=>t(a.leads.total)}],{emptyMsg:"No client orgs yet. Create one under Clients, then provision its magnets here."})}Bt=null,Ut=null,document.getElementById("mag-new-btn")?.addEventListener("click",ld),document.getElementById("mag-template-btn")?.addEventListener("click",cd),document.getElementById("mag-body")?.addEventListener("click",dd),await kt()}async function kt(){const e=document.getElementById("mag-body");if(!e)return;try{const[n,o]=await Promise.all([fetch(`${J()}/m5t/v5/magnets`),fetch(`${J()}/m5t/v5/magnets/stats`).catch(()=>null)]),s=await n.json().catch(()=>({}));if(!s.ok)throw new Error(s.message||"Failed to load");B.magnets=s.magnets||[],B.owners=s.owners||[],B.canProvision=!!s.canProvision,B.canManage=!!s.canManage,B.primaryOrgGuid=s.primaryOrgGuid||null;const r=o?await o.json().catch(()=>({})):{};B.stats=r?.stats||{}}catch{e.innerHTML=Kt("error","Could not load your magnets. Please try again.");return}const t=document.getElementById("mag-new-btn");t&&(t.style.display=B.canProvision?"":"none");const a=document.getElementById("mag-template-btn");if(a&&(a.style.display=B.canProvision?"":"none"),!B.magnets.length){e.innerHTML=Kt("widgets",B.canProvision?"No magnets yet. Click “New magnet” to create your first.":"No magnets yet.");return}e.innerHTML=`<div class="mag-grid">${B.magnets.map(Qa).join("")}</div>`}async function rd(e){const t={"Content-Type":"application/json","Idempotency-Key":crypto.randomUUID()},a={status:"DRAFT"};e&&(a.owner_guid=e);const n=await fetch(`${J()}/m5t/v5/magnets`,{method:"POST",headers:t,body:JSON.stringify(a)});let o={};try{o=await n.json()}catch{}if(!n.ok||!o.ok)throw new Error(o.message||`Could not start a new magnet (${n.status})`);return o.magnet}async function id(e,t){const a=await fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t.name,...t.appearance,steps:t.steps})});let n={};try{n=await a.json()}catch{}if(!a.ok||!n.ok)throw new Error(n.message||`Could not apply the ${t.name} template (${a.status})`)}async function Za(e,t){const a=document.getElementById("mag-new-btn"),n=document.getElementById("mag-template-btn");a&&(a.disabled=!0),n&&(n.disabled=!0);let o=null;try{let s=await rd(e);if(o=s.guid,t)await id(s.guid,t),await kt(),s=B.magnets.find(r=>r.guid===s.guid)||s;else{B.magnets=[s,...B.magnets];const r=document.getElementById("mag-body");r&&(r.innerHTML=`<div class="mag-grid">${B.magnets.map(Qa).join("")}</div>`)}Xt(s,void 0,{freshDraft:!0})}catch(s){o&&fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(o)}`,{method:"DELETE"}).catch(()=>{}),Me(s.message||"Could not start a new magnet","danger")}finally{a&&(a.disabled=!1),n&&(n.disabled=!1)}}function ks(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="Choose client" style="max-width:420px">
      ...
      <div class="mag-modal__body" style="padding:20px">
        ...
        <select class="mag-modal__select" id="mag-owner-pick">
          ${B.owners.map(o=>`<option value="${b(o.guid)}"${o.guid===B.primaryOrgGuid?" selected":""}>${b(o.name||o.guid)}</option>`).join("")}
        </select>
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(o){o.key==="Escape"&&(o.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.querySelector('[data-x="cancel"]').addEventListener("click",a),t.querySelector('[data-x="continue"]').addEventListener("click",()=>{const o=t.querySelector("#mag-owner-pick").value;a(),Za(o,e)})}function ld(){if(B.owners.length>1){ks();return}Za(null)}function cd(){Gc(e=>{if(B.owners.length>1){ks(e);return}Za(null,e)})}function dd(e){const t=e.target.closest("[data-action]");if(!t)return;const a=t.dataset.guid,n=B.magnets.find(s=>s.guid===a),o=t.dataset.action;if(o==="copy")return pd(a);if(n){if(o==="preview")return xs(()=>Ra(n));if(o==="funnel")return ud(n);if(o==="edit")return Xt(n);if(o==="flow")return Xt(n,"flow");if(o==="toggle")return md(n);if(o==="delete")return gd(n)}}async function pd(e){try{await navigator.clipboard.writeText(Es(e)),Me("Embed snippet copied","success")}catch{Me("Copy failed","danger")}}function Ts(e){const t=Number(e?.total_steps)||0,a={};if((Array.isArray(e?.funnel)?e.funnel:[]).forEach(s=>{a[s.position]=Number(s.reached)||0}),!t||!Object.keys(a).length)return'<p class="mag-modal__hint" style="margin:0">No step activity yet in this window. As visitors answer questions, drop-off by step will appear here.</p>';const n=Math.max(1,a[1]||0),o=[];for(let s=1;s<=t;s++){const r=a[s]||0,i=Math.min(100,Math.round(r/n*100));o.push(`
      ...
      </div>`)}return`<div class="mag-funnel">${o.join("")}</div>`}async function ud(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal mag-funnel-modal" role="dialog" aria-modal="true" aria-label="Step funnel for ${b(e.name)}">
      ...
      <div class="mag-modal__body" style="padding:20px">
        ...
        <div id="mag-funnel-body">${Kt("hourglass_empty","Loading…")}</div>
      </div>
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(s){s.key==="Escape"&&(s.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.addEventListener("click",s=>{s.target===t&&a()});const o=t.querySelector("#mag-funnel-body");try{const s=await fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/step-funnel`),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.message||`Failed (${s.status})`);o.innerHTML=Ts(r)}catch{o.innerHTML='<p class="mag-modal__hint" style="margin:0">Could not load the funnel. Please try again.</p>'}}async function md(e){if(e.status==="DRAFT"){Me("Open Edit and Save to publish a draft magnet.","info");return}const t=e.status==="ENABLED"?"DISABLED":"ENABLED";try{if(!(await(await fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw new Error;Me(t==="ENABLED"?"Magnet enabled":"Magnet disabled","success")}catch{Me("Update failed","danger");return}try{await kt()}catch(a){console.warn("[magnets] refresh after status toggle failed:",a)}}async function gd(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`)){try{if(!(await(await fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"})).json().catch(()=>({}))).ok)throw new Error;Me("Magnet deleted","success")}catch{Me("Delete failed","danger");return}try{await kt()}catch(t){console.warn("[magnets] refresh after delete failed:",t)}}}function ba(e){const t=[];return e.querySelectorAll(".mag-cta").forEach(a=>{if(!a.querySelector(".mag-cta__on").checked)return;const n=a.dataset.type,o=a.dataset.kind,s=a.querySelector(".mag-cta__val"),r=s?s.value.trim():"";if(o==="value")if(n==="call"&&a.querySelector(".mag-cta__callsrc")?.value==="callrail"){const i=a.querySelector(".mag-cta__crtracker"),l=i?.value||"",c=i?.selectedOptions?.[0];l&&t.push({type:n,value:l,config:{source:"callrail",...c?.dataset?.trackerId?{tracker_id:c.dataset.trackerId}:{},...c?.dataset?.trackerName?{tracker_name:c.dataset.trackerName}:{}}})}else r&&t.push({type:n,value:r});else if(o==="book")if(a.querySelector(".mag-cta__booksrc")?.value==="calendly"){const i=a.querySelector(".mag-cta__calevent"),l=i?.value||"",c=(i?.selectedOptions?.[0]?.textContent||"").trim();t.push({type:n,config:{source:"calendly",...l?{calendly_url:l}:{},...l&&c?{event_name:c}:{}}})}else{const i={type:n};r&&(/^https?:\/\//i.test(r)?i.value=r:i.config={meeting_label:r}),t.push(i)}else if(o==="support"){const i=(a.querySelector(".mag-cta__opts")?.value||"").split(`
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:Cs(e),actions:t,font:e.querySelector("#mag-f-font").value.trim(),theme_vars:yd(e),inline_width:e.querySelector("#mag-f-inline-w").value.trim(),inline_height:e.querySelector("#mag-f-inline-h").value.trim(),hide_launcher:e.querySelector("#mag-f-hide-launcher").checked,input_placeholder:e.querySelector("#mag-f-input-ph").value,summary_confirm_label:e.querySelector("#mag-f-summary-confirm").value.trim(),success_title:e.querySelector("#mag-f-success-title").value.trim(),success_text:e.querySelector("#mag-f-success-text").value,success_cta:wd(e)}}const hd=512,fd=new Set(["image/png","image/jpeg","image/gif","image/webp"]),vd=8*1024*1024;function bd(e){return new Promise((t,a)=>{const n=new Image,o=new FileReader;o.onerror=()=>a(new Error("Could not read that file.")),o.onload=()=>{n.onerror=()=>a(new Error("That file isn’t a readable image.")),n.onload=()=>{const s=Math.min(1,hd/Math.max(n.naturalWidth,n.naturalHeight)),r=Math.max(1,Math.round(n.naturalWidth*s)),i=Math.max(1,Math.round(n.naturalHeight*s)),l=document.createElement("canvas");l.width=r,l.height=i,l.getContext("2d").drawImage(n,0,0,r,i),t(l.toDataURL("image/png"))},n.src=o.result},o.readAsDataURL(e)})}function _d(e,t){const a=e.querySelector("#mag-logo-drop");if(!a)return;const n=e.querySelector("#mag-f-logo-file"),o=e.querySelector("#mag-logo-browse"),s=e.querySelector("#mag-logo-remove"),r=e.querySelector("#mag-logo-preview"),i=e.querySelector("#mag-logo-status"),l=e.querySelector("#mag-f-logo"),c=(v,w)=>{i.textContent=v,i.style.color=w?"var(--color-danger, #DD4124)":""},m=v=>{r.innerHTML=v?`<img src="${b(v)}" alt="">`:'<span class="material-symbols-outlined" aria-hidden="true">image</span>',s.hidden=!v},f=v=>{l.value=v,l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))};async function _(v){if(!fd.has(v.type)){c("PNG, JPEG, GIF, or WEBP only.",!0);return}if(v.size>vd){c("That file is too large (8MB max before resizing).",!0);return}c("Uploading…",!1);try{const w=await bd(v),d=await fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({image:w})}),h=await d.json().catch(()=>({}));if(!d.ok||!h.ok)throw new Error(h.error||`Upload failed (${d.status})`);const y=`${J()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;f(y),m(y),c("Logo updated.",!1)}catch(w){c(w.message||"Upload failed.",!0)}}n.addEventListener("change",()=>{n.files[0]&&_(n.files[0]),n.value=""}),a.addEventListener("click",v=>{v.target===s||s.contains(v.target)||v.target!==o&&n.click()}),o.addEventListener("click",()=>n.click()),["dragenter","dragover"].forEach(v=>a.addEventListener(v,w=>{w.preventDefault(),a.classList.add("is-dragover")})),["dragleave","drop"].forEach(v=>a.addEventListener(v,w=>{w.preventDefault(),a.classList.remove("is-dragover")})),a.addEventListener("drop",v=>{const w=v.dataTransfer?.files?.[0];w&&_(w)}),s.addEventListener("click",async v=>{v.stopPropagation(),c("Removing…",!1);try{const w=await fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"DELETE"}),d=await w.json().catch(()=>({}));if(!w.ok||!d.ok)throw new Error(d.error||`Remove failed (${w.status})`);f(""),m(""),c("Logo removed.",!1)}catch(w){c(w.message||"Remove failed.",!0)}})}function yd(e){return e.querySelector("#mag-f-surface-on")?.checked?{surface:e.querySelector("#mag-f-sv-surface").value,surface_2:e.querySelector("#mag-f-sv-surface2").value,border:e.querySelector("#mag-f-sv-border").value,text:e.querySelector("#mag-f-sv-text").value,text_sub:e.querySelector("#mag-f-sv-textsub").value}:{}}function wd(e){const t=e.querySelector("#mag-f-success-cta-label").value.trim(),a=e.querySelector("#mag-f-success-cta-url").value.trim();return t&&a?{label:t,url:a}:{}}function Cs(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",s=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==s.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}const Xn=[{label:"Web fonts (loaded for you)",opts:[["Inter, sans-serif","Inter"],["Poppins, sans-serif","Poppins"],["Montserrat, sans-serif","Montserrat"],["Roboto, sans-serif","Roboto"],['"Open Sans", sans-serif',"Open Sans"],["Lato, sans-serif","Lato"],["Nunito, sans-serif","Nunito"],["Raleway, sans-serif","Raleway"],['"Work Sans", sans-serif',"Work Sans"],["Oswald, sans-serif","Oswald"],["Merriweather, serif","Merriweather (serif)"]]},{label:"System / always available",opts:[["system-ui, sans-serif","System UI"],["Georgia, serif","Georgia (serif)"],['"Times New Roman", Times, serif',"Times (serif)"],["Arial, Helvetica, sans-serif","Arial / Helvetica"],["Verdana, Geneva, sans-serif","Verdana"],['"Courier New", monospace',"Courier (mono)"]]}];function xd(e){const t=String(e||""),a=new Set(Xn.flatMap(s=>s.opts.map(([r])=>r))),n=s=>s===t?" selected":"";let o=`<option value=""${t===""?" selected":""}>System default</option>`;t&&!a.has(t)&&(o+=`<option value="${b(t)}" selected>Current: ${b(t)}</option>`);for(const s of Xn)o+=`<optgroup label="${b(s.label)}">`+s.opts.map(([r,i])=>`<option value="${b(r)}"${n(r)}>${b(i)}</option>`).join("")+"</optgroup>";return o}function Xt(e,t,a={}){const{freshDraft:n=!1}=a,o=!!e,s=o?null:crypto.randomUUID(),r=!o&&B.owners.length>1,i=e?.display_mode||"chat",l=e?.theme_mode||"auto",c={};(e?.actions||[]).forEach(A=>{A&&A.type&&(c[A.type]=A)});const m=o?!!e.home:!0,f=o?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",_=e?.theme_vars&&typeof e.theme_vars=="object"?e.theme_vars:{},v=Object.keys(_).length>0,w=(A,D)=>b(/^#[0-9a-fA-F]{6}$/.test(_[A]||"")?_[A]:D),d=document.createElement("div");d.className="mag-modal-scrim",d.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${o?"Edit magnet":"New magnet"}">
      ...
      <div class="mag-modal__main">
        ...
        <select class="mag-modal__select" id="mag-f-owner">
          ${B.owners.map(A=>`<option value="${b(A.guid)}"${A.guid===B.primaryOrgGuid?" selected":""}>${b(A.name||A.guid)}</option>`).join("")}
        </select>`:""}
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${Jc.map(A=>`<option value="${A.value}"${(e?e.trigger||"none":"on_load")===A.value?" selected":""}>${b(A.label)}</option>`).join("")}
        </select>
        ...
        <div class="mag-modal__sec">
          ...
          <input class="mag-modal__input" id="mag-f-subtitle" type="text" placeholder="Typically replies in a few minutes" value="${b(f)}">
          ...
          <select class="mag-modal__select" id="mag-f-font">${xd(e?.font||"")}</select>
          ...
          <div id="mag-f-surface" class="mag-surface-grid"${v?"":" hidden"}>
            <div><label class="mag-modal__label" for="mag-f-sv-surface">Background</label><input class="mag-modal__color" id="mag-f-sv-surface" type="color" value="${w("surface","#141414")}"></div>
            <div><label class="mag-modal__label" for="mag-f-sv-surface2">Panel / raised</label><input class="mag-modal__color" id="mag-f-sv-surface2" type="color" value="${w("surface_2","#1e1e1e")}"></div>
            <div><label class="mag-modal__label" for="mag-f-sv-border">Border</label><input class="mag-modal__color" id="mag-f-sv-border" type="color" value="${w("border","#2a2a2a")}"></div>
            <div><label class="mag-modal__label" for="mag-f-sv-text">Text</label><input class="mag-modal__color" id="mag-f-sv-text" type="color" value="${w("text","#ffffff")}"></div>
            <div><label class="mag-modal__label" for="mag-f-sv-textsub">Muted text</label><input class="mag-modal__color" id="mag-f-sv-textsub" type="color" value="${w("text_sub","#a8a8a8")}"></div>
          </div>
    ...
    </div>`,document.body.appendChild(d),requestAnimationFrame(()=>{d.classList.add("open"),d.querySelector(".mag-modal").classList.add("open")});const h=[...d.querySelectorAll(".mag-modal__navitem")],y=[...d.querySelectorAll(".mag-tab")],k=A=>{h.forEach(D=>D.classList.toggle("is-active",D.dataset.tab===A)),y.forEach(D=>{D.hidden=D.dataset.tab!==A}),d.querySelector(".mag-modal__body").scrollTop=0};h.forEach(A=>A.addEventListener("click",()=>k(A.dataset.tab)));const R=()=>Ra({...e,...ba(d),...o?{steps:Vn()}:{}}),U=d.querySelector("#mag-preview-pane"),ne=()=>window.matchMedia("(min-width: 1200px)").matches;let Y=null;const ce=()=>{if(!Y&&ne())try{Y=Hc(U,R)}catch{}};let xe=null;const de=()=>{ne()&&(ce(),Y&&(clearTimeout(xe),xe=setTimeout(()=>{try{Y.refresh()}catch{}},300)))},Pe=window.matchMedia("(min-width: 1200px)"),$e=()=>{ne()&&(ce(),de())};Pe.addEventListener("change",$e);let N=!1,I=!1;const V=d.querySelector("#mag-f-dirty"),Le=A=>{N=A,V&&(V.hidden=!A)},Tt=d.querySelector(".mag-modal__main");Tt.addEventListener("input",()=>Le(!0)),Tt.addEventListener("change",()=>{Le(!0),de()}),d.querySelector("#mag-f-color")?.addEventListener("input",()=>{Le(!0),de()});const ze=A=>{N&&(A.preventDefault(),A.returnValue="")};window.addEventListener("beforeunload",ze);let pt=!0;const la=p.subscribe(u.ROUTE_NAV_BEFORE,()=>{if(pt){if(N&&!confirm("Discard your changes to this magnet?")){window.router?.navigate("/magnets");return}g()}}),g=()=>{if(n&&!I&&e&&e.status==="DRAFT"){fetch(`${J()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"}).catch(()=>{}),B.magnets=B.magnets.filter(D=>D.guid!==e.guid);const A=document.getElementById("mag-body");A&&(A.innerHTML=`<div class="mag-grid">${B.magnets.map(Qa).join("")}</div>`)}pt=!1,window.removeEventListener("beforeunload",ze),p.unsubscribe(la),clearTimeout(xe),Pe.removeEventListener("change",$e),Y&&Y.destroy&&Y.destroy(),d.classList.remove("open"),setTimeout(()=>d.remove(),180),document.removeEventListener("keydown",$)},E=()=>{N&&!confirm("Discard your changes to this magnet?")||g()};function $(A){A.key==="Escape"&&(A.preventDefault(),E())}document.addEventListener("keydown",$),d.querySelector(".mag-modal__close").addEventListener("click",E),d.querySelector('[data-x="cancel"]').addEventListener("click",E),d.querySelector("[data-close-modal]")?.addEventListener("click",E),d.querySelector("#mag-f-name").focus();const H=d.querySelector("#mag-flow-panel");o?Oc(H,e,()=>{Le(!0),de()}):H.innerHTML='<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>',_d(d,e),t&&k(t),ce(),d.querySelectorAll(".mag-cta").forEach(A=>{const D=A.querySelector(".mag-cta__on"),re=A.querySelector(".mag-cta__val"),Q=A.querySelector(".mag-cta__opts"),Re=A.querySelectorAll(".mag-cta__booksrc, .mag-cta__calevent, .mag-cta__callsrc, .mag-cta__crtracker");D.addEventListener("change",()=>{re&&(re.disabled=!D.checked),Q&&(Q.disabled=!D.checked),Re.forEach(q=>{q.disabled=!D.checked}),D.checked&&(re||Q)?.focus()}),re&&re.addEventListener("input",()=>{re.value.trim()&&!D.checked&&(D.checked=!0,Q&&(Q.disabled=!1))})}),d.querySelectorAll('.mag-cta[data-kind="book"]').forEach(A=>{const D=A.querySelector(".mag-cta__booksrc"),re=A.querySelector(".mag-cta__val"),Q=A.querySelector(".mag-cta__calevent");if(!D||!Q)return;const Re=()=>{const q=D.value==="calendly";re.hidden=q,Q.hidden=!q,q&&!Q.dataset.listed&&(Q.dataset.listed="1",Qc(Q))};D.addEventListener("change",()=>{const q=A.querySelector(".mag-cta__on");q.checked||(q.checked=!0,q.dispatchEvent(new Event("change"))),Re()}),Re()}),d.querySelectorAll('.mag-cta[data-type="call"]').forEach(A=>{const D=A.querySelector(".mag-cta__callsrc"),re=A.querySelector(".mag-cta__val"),Q=A.querySelector(".mag-cta__crtracker");if(!D||!Q)return;const Re=()=>{const q=D.value==="callrail";re.hidden=q,Q.hidden=!q,q&&!Q.dataset.listed&&(Q.dataset.listed="1",ed(Q))};D.addEventListener("change",()=>{const q=A.querySelector(".mag-cta__on");q.checked||(q.checked=!0,q.dispatchEvent(new Event("change"))),Re()}),Re()});const M=d.querySelector("#mag-f-surface-on"),ye=d.querySelector("#mag-f-surface");M.addEventListener("change",()=>ye.hidden=!M.checked);const Ge=d.querySelector("#mag-f-inline-size");d.querySelectorAll('input[name="mag-display"]').forEach(A=>A.addEventListener("change",()=>{Ge.hidden=d.querySelector('input[name="mag-display"]:checked')?.value!=="inline"})),d.querySelector('[data-x="preview"]')?.addEventListener("click",()=>xs(()=>Ra({...e,...ba(d),...o?{steps:Vn()}:{}}))),d.querySelector('[data-x="save"]').addEventListener("click",async A=>{const D=A.currentTarget,re=d.querySelector("#mag-f-error"),Q=d.querySelector("#mag-f-name").value.trim();if(!Q){k("basics"),re.textContent="Please give your magnet a name.";return}const Re=d.querySelector("#mag-f-domains").value.split(",").map(Z=>Z.trim()).filter(Boolean);let q="";if(d.querySelectorAll(".mag-cta").forEach(Z=>{const Ze=Z.querySelector(".mag-cta__on").checked;if(Z.dataset.kind==="book"){const mt=Z.querySelector(".mag-cta__booksrc")?.value==="calendly";Ze&&mt&&!Z.querySelector(".mag-cta__calevent")?.value&&(q=q||"Pick a Calendly event for the Book button, or switch it back to the built-in scheduler.");return}if(Z.dataset.kind!=="value")return;if(Z.dataset.type==="call"&&Z.querySelector(".mag-cta__callsrc")?.value==="callrail"){Ze&&!Z.querySelector(".mag-cta__crtracker")?.value&&(q=q||"Pick a CallRail tracking number for the Call button, or switch it back to a phone number.");return}const ut=Z.querySelector(".mag-cta__val").value.trim();Ze&&!ut&&(q=q||`Add a target for the ${Ss[Z.dataset.type].label} button, or uncheck it.`)}),q){k("welcome"),re.textContent=q;return}const an=Cs(d);if(an.enabled&&!Object.keys(an.b).length){k("ab"),re.textContent="Give variant B at least one change (title, welcome, or color), or untick the A/B test.";return}if(o){const Z=Pc();if(Z){k("flow"),Fc(Z.route,Z.message);return}}const ca={name:Q,domains:Re,...ba(d)};r&&(ca.owner_guid=d.querySelector("#mag-f-owner").value);const nn=o&&e.status==="DRAFT";nn&&(ca.status="ENABLED"),D.disabled=!0,re.textContent="";try{const Z=o?`${J()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${J()}/m5t/v5/magnets`,Ze={"Content-Type":"application/json"};s&&(Ze["Idempotency-Key"]=s);const ut=await fetch(Z,{method:o?"PATCH":"POST",headers:Ze,body:JSON.stringify(ca)});let mt={};try{mt=await ut.json()}catch{}if(!ut.ok||!mt.ok)throw new Error(mt.message||`Save failed (${ut.status})`);o&&await Bc(e.guid),Me(nn||!o?"Magnet created":"Magnet updated","success"),I=!0,g(),await kt()}catch(Z){D.disabled=!1,re.textContent=Z.message||"Something went wrong."}})}const Ed=Object.freeze(Object.defineProperty({__proto__:null,cspNoteHTML:As,init:sd,openModal:Xt,render:od,stepFunnelHTML:Ts},Symbol.toStringTag,{value:"Module"}));let Qn=!1;const S={leads:[],magnetNames:{},filter:"ALL",canManage:!1,book:!1,ownerNames:{},clientFilter:"ALL",search:"",shown:100,selectedId:null},yt=100,Na=["NEW","WORKING","QUALIFIED","UNQUALIFIED","CONVERTED","EXPORTED"],Ad={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},L=e=>String(e??"").replace(/[&<>"']/g,t=>Ad[t]),Qt=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},Zt=()=>x.getConfig?.().BASE_URL||"",ea=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",Is=e=>(ea(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase(),en=e=>e.created?.created_tz||"";function nt(e){const t=en(e);if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric"})}catch{return""}}function Sd(e){const t=en(e);if(!t)return"";try{const a=Date.now()-new Date(t).getTime();if(a<0)return nt(e);const n=a/36e5;return n<1?`${Math.max(1,Math.floor(a/6e4))}m ago`:n<24?`${Math.floor(n)}h ago`:n<48?"Yesterday":nt(e)}catch{return nt(e)}}const kd=e=>{const t=en(e);if(!t)return!1;try{return Date.now()-new Date(t).getTime()<24*36e5}catch{return!1}};function Td(){if(Qn)return;const e=document.createElement("style");e.id="m5t-leads-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Qn=!0}function xt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Cd(e){return`<select class="leads-status" data-id="${L(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${Na.map(t=>`<option value="${t}" ${e.status===t?"selected":""}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join("")}
  </select>`}function Id(e){const t=S.magnetNames[e.magnet_guid]||e.lead_source||"—",a=e.phone?String(e.phone).replace(/[^\d+]/g,""):"";return`
    <tr class="leads-row${String(e.id)===S.selectedId?" selected":""}" data-id="${L(e.id)}" tabindex="0" role="button" aria-label="Open lead ${L(ea(e))}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${L(Is(e))}</span>
          <span><span class="leads-name">${L(ea(e))}</span>${e.company?`<span class="leads-sub">${L(e.company)}</span>`:""}</span>
        </span>
      </td>
      ${S.book?`<td>${Ho(S.ownerNames[e.owner_guid]||"")||'<span class="leads-muted">—</span>'}</td>`:""}
      <td>
        ${e.email?`<a class="leads-contactlink" href="mailto:${L(e.email)}" title="Email ${L(e.email)}">${L(e.email)}</a>`:'<span class="leads-muted">—</span>'}
        ${e.phone?`<a class="leads-contactlink leads-sub" href="tel:${L(a)}" title="Call ${L(e.phone)}">${L(e.phone)}</a>`:""}
      </td>
      <td>${e.product_interest?L(e.product_interest):'<span class="leads-muted">—</span>'}</td>
      <td><span class="leads-sub">${L(t)}</span>${e.utm_campaign||e.utm_source?`<span class="leads-sub" title="Campaign / source">${L(e.utm_campaign||e.utm_source)}${e.gclid?' <span class="leads-badge" data-s="QUALIFIED" style="font-size:0.58rem;padding:1px 6px">Ads</span>':""}</span>`:""}</td>
      <td>${S.canManage?Cd(e):`<span class="leads-badge" data-s="${L(e.status)}">${L(e.status)}</span>`}</td>
      <td class="num leads-muted" style="white-space:nowrap" title="${L(nt(e))}">${kd(e)?'<span class="leads-fresh" title="Captured in the last 24 hours"></span>':""}${L(Sd(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}const $s=e=>S.clientFilter==="ALL"||e.owner_guid===S.clientFilter;function $d(e){const t=S.search.trim().toLowerCase();if(!t)return!0;const a=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,S.magnetNames[e.magnet_guid],S.book?S.ownerNames[e.owner_guid]:""].filter(Boolean).join(" ").toLowerCase();return t.split(/\s+/).every(n=>a.includes(n))}function Ls(){return S.leads.filter(e=>(S.filter==="ALL"||e.status===S.filter)&&$s(e)&&$d(e))}const Rs=()=>xt("touch_app","Click to see lead information.");function Ld(){Td(),ct();const e=se();return`
    <div class="page-shell" data-section="leads">
      ...
      <div class="leads-layout">
        ...
        <aside class="dashboard-card leads-panel" aria-label="Lead detail">
          <div class="card-body" id="leads-panel-body">${Rs()}</div>
        </aside>
      </div>
    </div>`}async function Rd(){if(document.getElementById("leads-export")?.addEventListener("click",Pd),se()){const e=t=>Number(t||0).toLocaleString();dt(Zt(),[{h:"Leads · wk",td:t=>e(t.leads.this_week)},{h:"Leads · total",td:t=>e(t.leads.total)},{h:"Compl.",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Nd()}async function Nd(){const e=document.getElementById("leads-body");if(e){try{const[t,a]=await Promise.all([fetch(`${Zt()}/m5t/v5/m5mLead`),fetch(`${Zt()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(S.leads=(n.data||[]).filter(o=>!["DELETED","ARCHIVED"].includes(o.status)),S.book=se(),S.ownerNames=S.book?Uo():{},a){const o=await a.json().catch(()=>({}));S.magnetNames={},(o.magnets||[]).forEach(s=>{S.magnetNames[s.guid]=s.name,s.owner_guid&&s.owner_name&&!S.ownerNames[s.owner_guid]&&(S.ownerNames[s.owner_guid]=s.owner_name)}),S.canManage=!!o.canManage}}catch{e.innerHTML=xt("error","Could not load your leads. Please try again.");return}ta()}}const Od=()=>`
  <colgroup>
    <col style="width:23%">
  ...
  </colgroup>`;function ta(){const e=document.getElementById("leads-body"),t=document.getElementById("leads-export");if(!e)return;if(t&&(t.style.display=S.leads.length?"":"none"),!S.leads.length){e.innerHTML=xt("inbox","No leads captured yet. Publish a magnet and share it to start collecting.");return}const a=S.leads.filter($s),n={ALL:a.length};Na.forEach(s=>{n[s]=a.filter(r=>r.status===s).length});const o=S.book?[...new Set(S.leads.map(s=>s.owner_guid).filter(Boolean))].map(s=>({guid:s,name:S.ownerNames[s]||s})).sort((s,r)=>s.name.localeCompare(r.name)):[];e.innerHTML=`
    <div class="leads-bar">
      <div class="leads-filter">
        ${["ALL",...Na].map(s=>`<button data-filter="${s}" class="${S.filter===s?"active":""}">${s==="ALL"?"All":s[0]+s.slice(1).toLowerCase()}${n[s]?`<span class="leads-pillnum">${n[s]}</span>`:""}</button>`).join("")}
      </div>
      ${S.book&&o.length>1?`
      <select class="leads-clientsel" id="leads-clientsel" aria-label="Filter by client">
        <option value="ALL">All clients</option>
        ${o.map(s=>`<option value="${L(s.guid)}" ${S.clientFilter===s.guid?"selected":""}>${L(s.name)}</option>`).join("")}
      </select>`:""}
      <span class="leads-searchwrap">
        <span class="material-symbols-outlined" aria-hidden="true">search</span>
        <input class="leads-search" id="leads-search" type="search" placeholder="Search leads" value="${L(S.search)}" aria-label="Search leads" />
      </span>
      <span class="leads-count" id="leads-countlbl"></span>
    </div>
    <div id="leads-tablezone"></div>`,e.querySelector(".leads-filter")?.addEventListener("click",s=>{const r=s.target.closest("[data-filter]");r&&(S.filter=r.dataset.filter,S.shown=yt,ta())}),e.querySelector("#leads-clientsel")?.addEventListener("change",s=>{S.clientFilter=s.target.value,S.shown=yt,ta()}),e.querySelector("#leads-search")?.addEventListener("input",s=>{S.search=s.target.value,S.shown=yt,Oa()}),Oa()}function Oa(){const e=document.getElementById("leads-tablezone"),t=document.getElementById("leads-countlbl");if(!e)return;const a=Ls(),n=a.slice(0,S.shown),o=S.book?8:7;t&&(t.textContent=`${a.length} of ${S.leads.length}`),e.innerHTML=`
    <div class="leads-tablewrap">
      <table class="leads-table">
        ...
        <tbody id="leads-tbody">${n.map(Id).join("")||`<tr><td colspan="${o}"><div class="leads-muted" style="padding:14px 4px">${S.search.trim()?"No leads match your search.":`No ${S.filter.toLowerCase()} leads.`}</div></td></tr>`}</tbody>
      </table>
    </div>
    ${a.length>S.shown?`<button class="leads-more" type="button" id="leads-more">Show ${Math.min(yt,a.length-S.shown)} more (${a.length-S.shown} remaining)</button>`:""}`,e.querySelector("#leads-more")?.addEventListener("click",()=>{S.shown+=yt,Oa()}),e.querySelector("#leads-tbody")?.addEventListener("change",Md),e.querySelector("#leads-tbody")?.addEventListener("click",s=>{if(s.target.closest(".leads-status, a.leads-contactlink"))return;const r=s.target.closest(".leads-row");r&&Zn(r.dataset.id)}),e.querySelector("#leads-tbody")?.addEventListener("keydown",s=>{if(s.key!=="Enter"&&s.key!==" ")return;const r=s.target.closest(".leads-row");r&&s.target===r&&(s.preventDefault(),Zn(r.dataset.id))})}async function Md(e){const t=e.target.closest(".leads-status");if(!t)return;const a=t.dataset.id,n=S.leads.find(r=>String(r.id)===String(a)),o=t.value,s=n?.status;try{if(!(await(await fetch(`${Zt()}/m5t/v5/m5mLead/${encodeURIComponent(a)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:o})})).json().catch(()=>({}))).ok)throw new Error;n&&(n.status=o),Qt(`Marked ${o[0]}${o.slice(1).toLowerCase()}`,"success")}catch{t.value=s||"NEW",Qt("Could not update status","danger");return}try{String(a)===S.selectedId&&Ms(),S.filter!=="ALL"&&ta()}catch(r){console.warn("[leads] re-render after status change failed:",r)}}function Zn(e){S.selectedId=String(e),document.querySelectorAll(".leads-row").forEach(t=>t.classList.toggle("selected",t.dataset.id===S.selectedId)),Ms()}function Lt(e,t){const a=Array.isArray(e.tags)?e.tags:[];for(let n=a.length-1;n>=0;n--)if(a[n]&&a[n].tag===t&&a[n].value!=null)return String(a[n].value);return""}function Ns(e){const t=Lt(e,"appointment_start");if(!t)return null;const a=Lt(e,"appointment_status")||"booked",n=Lt(e,"appointment_timezone"),o=Lt(e,"appointment_event_type"),s=new Date(t);let r=t;if(!Number.isNaN(s.getTime())){const i={weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"};try{r=new Intl.DateTimeFormat(void 0,n?{...i,timeZone:n}:i).format(s)}catch{r=new Intl.DateTimeFormat(void 0,i).format(s)}}return{when:r,status:a,type:o,start:t}}const eo={booked:["QUALIFIED","Booked"],rescheduled:["WORKING","Rescheduled"],canceled:["CANCELED","Canceled"]};function Os(e){const t=Array.isArray(e.tags)?e.tags:[];let a=null;for(const l of t)if(!(!l||!l.tag)){if(l.tag==="callrail_call_id"){a={};continue}a&&l.tag.indexOf("call_")===0&&l.value!=null&&(a[l.tag]=String(l.value))}if(!a||!a.call_started)return null;const n=a.call_started,o=new Date(n);let s=n;Number.isNaN(o.getTime())||(s=new Intl.DateTimeFormat(void 0,{weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"}).format(o));const r=Number(a.call_duration)||0,i=r?r<60?`${r}s`:`${Math.floor(r/60)}m ${r%60}s`:"";return{when:s,dur:i,source:a.call_source||"",answered:a.call_answered||"",recording:a.call_recording_player||"",started:n}}function Ms(){const e=document.getElementById("leads-panel-body");if(!e)return;const t=S.leads.find(l=>String(l.id)===S.selectedId);if(!t){e.innerHTML=Rs();return}const a=S.magnetNames[t.magnet_guid]||t.lead_source||"—",n=Ns(t),[o,s]=n?eo[n.status]||eo.booked:["",""],r=Os(t),i=(l,c)=>c?`<div class="leads-det__field"><span class="leads-det__k">${L(l)}</span><span class="leads-det__v">${L(c)}</span></div>`:"";e.innerHTML=`
    <div class="leads-det__head">
      <span class="leads-avatar leads-det__ava">${L(Is(t))}</span>
      <div>
        <div class="leads-det__name">${L(ea(t))}</div>
        <span class="leads-badge" data-s="${L(t.status)}">${L(t.status)}</span>
      </div>
    </div>
    <div class="leads-det__contact">
      ${t.email?`<a class="leads-det__cbtn" href="mailto:${L(t.email)}"><span class="material-symbols-outlined" aria-hidden="true">mail</span>Email</a>`:""}
      ${t.phone?`<a class="leads-det__cbtn" href="tel:${L(String(t.phone).replace(/[^\d+]/g,""))}"><span class="material-symbols-outlined" aria-hidden="true">call</span>Call</a>`:""}
    </div>
    ${i("Email",t.email)}
    ${i("Phone",t.phone)}
    ${i("Mobile",t.mobile)}
    ...
    ${i("Magnet",a)}
    ${i("Captured",nt(t))}
    ${n?`<div class="leads-det__field"><span class="leads-det__k">Appointment</span><span class="leads-det__v">${L([n.when,n.type].filter(Boolean).join(" · "))} <span class="leads-badge" data-s="${L(o)}">${L(s)}</span></span></div>`:""}
    ${r?`<div class="leads-det__field"><span class="leads-det__k">Last call</span><span class="leads-det__v">${L([r.when,r.dur,r.source].filter(Boolean).join(" · "))} <span class="leads-badge" data-s="${r.answered==="no"?"WORKING":"QUALIFIED"}">${r.answered==="no"?"Missed":"Answered"}</span>${r.recording&&/^https:\/\//i.test(r.recording)?` <a href="${L(r.recording)}" target="_blank" rel="noopener">Recording</a>`:""}</span></div>`:""}
    ...
    ${t.description?`<div class="leads-det__notes">${L(t.description)}</div>`:""}`}function Pd(){const e=Ls();if(!e.length){Qt("Nothing to export","info");return}const t=["first_name","last_name","email","phone","company","product_interest","lead_source","utm_source","utm_medium","utm_campaign","gclid","status"],a=l=>`"${String(l??"").replace(/"/g,'""')}"`,o=[[...S.book?["client"]:[],...t,"magnet","captured","appointment","last_call"].join(",")];for(const l of e){const c=Ns(l),m=Os(l);o.push([...S.book?[a(S.ownerNames[l.owner_guid]||"")]:[],...t.map(f=>a(l[f])),a(S.magnetNames[l.magnet_guid]||l.lead_source||""),a(nt(l)),a(c?`${c.start} (${c.status})`:""),a(m?`${m.started} (${m.answered==="no"?"missed":"answered"})`:"")].join(","))}const s=new Blob([o.join(`
`)],{type:"text/csv"}),r=URL.createObjectURL(s),i=document.createElement("a");i.href=r,i.download=`leads-${S.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r),Qt(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const Fd=Object.freeze(Object.defineProperty({__proto__:null,init:Rd,render:Ld},Symbol.toStringTag,{value:"Module"})),Ps=()=>x.getConfig?.().BASE_URL||"",to=e=>e.toISOString().slice(0,10),ao=e=>e==null?"—":"$"+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),at=e=>Number(e||0).toLocaleString(),Dd={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Rt=e=>String(e??"").replace(/[&<>"']/g,t=>Dd[t]);let no=!1;function Bd(){if(no)return;const e=document.createElement("style");e.id="m5t-adperf-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),no=!0}const ot=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Nt=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
  ...
  </div>`,Ud=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let aa=30;function Fs(){return se()?At({section:"ad-performance",title:"Ad Performance",description:"Pick a client to view their spend and lead performance."}):(Bd(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${Ud.map(e=>`<button class="chart-period-btn${e.d===aa?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>

      <div class="stats-grid">
        ${Nt("payments","Ad Spend","adperf-spend")}
        ${Nt("ads_click","Clicks","adperf-clicks")}
        ${Nt("person_add","Magnet Leads","adperf-leads")}
        ${Nt("request_quote","Cost / Lead","adperf-cpl")}
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-body">
          ${ot("hourglass_empty","Loading ad performance…")}
        </div>
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-sources">
          ${ot("hourglass_empty","Loading…")}
        </div>
      </div>
    </div>`)}async function Ds(){if(se()){const t=a=>Number(a||0).toLocaleString();return dt(Ps(),[{h:"Spend",td:a=>a.ad?`$${t(a.ad.spend)}`:"—"},{h:"Clicks",td:a=>a.ad?t(a.ad.clicks):"—"},{h:"Leads",td:a=>t(a.leads.window??a.leads.total)},{h:"CPL",td:a=>a.ad?.cost_per_lead!=null?`$${t(a.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see spend here."})}const e=document.getElementById("adperf-periods");e?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(aa=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===aa)),oo())}),await oo()}async function oo(){const e=Ps(),t=document.getElementById("adperf-body"),a=document.getElementById("adperf-range"),n=new Date,o=to(n),s=to(new Date(n.getTime()-(aa-1)*864e5));a&&(a.textContent=`${s} → ${o}`);let r,i=[],l=null;try{const[m,f,_]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${s}&to=${o}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${s}&to=${o}`)]);if(!m.ok)throw new Error(`HTTP ${m.status}`);r=await m.json(),i=((await f.json().catch(()=>({})))?.data||[]).filter(w=>w.status!=="DELETED"),l=await _.json().catch(()=>null)}catch(m){console.warn("[ad-performance] load failed:",m),t&&(t.innerHTML=ot("error","Could not load ad performance. Please try again."));return}const c=r.totals||{};if(Ot("adperf-spend",ao(c.spend)),Ot("adperf-clicks",at(c.clicks)),Ot("adperf-leads",at(c.magnet_leads)),Ot("adperf-cpl",ao(c.cost_per_lead)),Hd(l),!i.length){t.innerHTML=ot("link_off","No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.");return}if(!r.connected){t.innerHTML=ot("cloud_sync","Account connected. No ad data for this range yet. Metrics appear here once they sync.");return}t.innerHTML=zd(r.rows||[])}function Hd(e){const t=document.getElementById("adperf-sources"),a=document.getElementById("adperf-src-summary");if(!t)return;const n=e&&Array.isArray(e.rows)?e.rows:[];if(!n.length){a&&(a.textContent=""),t.innerHTML=ot("search_off","No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.");return}const o=e.total_leads||n.reduce((i,l)=>i+(l.leads||0),0),s=e.tracked_leads||0;a&&(a.textContent=`${at(s)} of ${at(o)} leads tagged to a source`);const r=i=>i.campaign&&i.campaign!=="(none)"?Rt(i.campaign):i.source&&i.source!=="(direct)"?Rt(i.source):'<span class="adperf-src-untracked">Untracked / direct</span>';t.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${n.map(i=>`
          <tr>
            <td>${r(i)}</td>
            <td class="adperf-src-sub">${Rt(i.source||"—")}${i.medium?` · ${Rt(i.medium)}`:""}</td>
            <td class="num">${i.paid_clicks?at(i.paid_clicks):'<span class="adperf-src-sub">—</span>'}</td>
            <td class="num"><b>${at(i.leads)}</b></td>
          </tr>`).join("")}
        </tbody>
      </table>
    </div>`}function Ot(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}function so(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}function ro(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e)}function zd(e){const v=e.length||1,w=so(Math.max(1,...e.map(N=>N.spend||0))),d=so(Math.max(1,...e.map(N=>N.magnet_leads||0))),h=738/v,y=Math.min(24,h*.55),k=N=>56+h*(N+.5),R=N=>304-N/w*282,U=N=>304-N/d*282,ne=[0,.25,.5,.75,1].map(N=>{const I=304-N*282;return`<line x1="56" y1="${I.toFixed(1)}" x2="794" y2="${I.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${(I+3.5).toFixed(1)}" text-anchor="end" class="ax">$${ro(w*N)}</text><text x="802" y="${(I+3.5).toFixed(1)}" text-anchor="start" class="ax">${ro(d*N)}</text>`}).join(""),Y=e.map((N,I)=>{const V=R(N.spend||0);return`<rect x="${(k(I)-y/2).toFixed(1)}" y="${V.toFixed(1)}" width="${y.toFixed(1)}" height="${Math.max(0,304-V).toFixed(1)}" rx="3" fill="#0072BA"><title>${N.date}: $${N.spend} spend</title></rect>`}).join(""),ce=e.map((N,I)=>`${k(I).toFixed(1)},${U(N.magnet_leads||0).toFixed(1)}`).join(" "),xe=v>1?`<polyline points="${ce}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",de=e.map((N,I)=>`<circle cx="${k(I).toFixed(1)}" cy="${U(N.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${N.date}: ${N.magnet_leads} leads</title></circle>`).join(""),Pe=Math.max(1,Math.ceil(v/6)),$e=e.map((N,I)=>I%Pe===0||I===v-1?`<text x="${k(I).toFixed(1)}" y="326" text-anchor="middle" class="ax">${N.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="adperf-chart" viewBox="0 0 840 340" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Ad spend versus magnet leads over time">
      ${ne}${Y}${xe}${de}${$e}
    </svg>`}const Gd={render:Fs,init:Ds},qd=Object.freeze(Object.defineProperty({__proto__:null,default:Gd,init:Ds,render:Fs},Symbol.toStringTag,{value:"Module"})),io="reseller_org",Bs="managed_client";let lo=!1;const Vd={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},X=e=>String(e??"").replace(/[&<>"']/g,t=>Vd[t]);function na(e,t="info"){try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}}function jd(){const e=x.getActiveOrg();if(e&&e.channel===io)return{guid:e.guid,name:e.name};const t=x.getMemberships().find(a=>a.channel===io);return t?{guid:t.orgGuid,name:t.name}:null}function Wd(e){const t=e?.created_tz;if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function Yd(){if(lo)return;const e=document.createElement("style");e.id="m5t-clients-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),lo=!0}const Jd=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Ht(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Kd(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
    <div class="client-row">
      <span class="client-row__avatar">${X(Jd(t))}</span>
      <span class="client-row__main">
        <div class="client-row__name" title="${X(t)}">${X(t)}</div>
        <div class="client-row__meta">Added ${X(Wd(e.created))||"—"}</div>
      </span>
      <span class="client-row__status" data-status="${X(a)}">${X(a)}</span>
    ...
    <div class="page-shell" data-section="clients">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="clients-body">
          ${Ht("hourglass_empty","Loading clients…")}
        </div>
      </div>
    </div>`}async function Hs(){const e=jd();document.getElementById("clients-add-btn")?.addEventListener("click",()=>Xd(e)),await zs(e)}async function zs(e){const t=document.getElementById("clients-body"),a=document.getElementById("clients-count");if(t){if(!e?.guid){t.innerHTML=Ht("info","Client provisioning is available to reseller / agency accounts."),a&&(a.textContent="");return}try{const n=x.getConfig?.().BASE_URL||"",o=await fetch(`${n}/m5t/v5/acctGroup`);if(!o.ok)throw new Error(`HTTP ${o.status}`);const s=await o.json(),i=(Array.isArray(s?.data)?s.data:[]).filter(l=>l.class===Bs&&(!l.parent||l.parent===e.guid));if(!i.length){t.innerHTML=Ht("group_off","No clients yet. Add your first client to start managing magnets on their behalf."),a&&(a.textContent="");return}t.innerHTML=`<div class="client-list">${i.map(Kd).join("")}</div>`,a&&(a.textContent=`${i.length} client${i.length===1?"":"s"}`),t.querySelectorAll(".client-card__invite").forEach(l=>{l.addEventListener("click",()=>{l.dataset.action==="adaccounts"?Qd(l.dataset.clientGuid,l.dataset.clientName):Zd(l.dataset.clientGuid,l.dataset.clientName)})})}catch(n){console.warn("[clients] load failed:",n),t.innerHTML=Ht("error","Couldn’t load clients. Please try again."),a&&(a.textContent="")}}}function Xd(e){if(!e?.guid){na("Only reseller / agency accounts can add clients.","error");return}const t=document.createElement("div");t.className="client-modal-scrim";const a=document.createElement("div");a.className="client-modal",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),document.body.appendChild(a),requestAnimationFrame(()=>{t.classList.add("open"),a.classList.add("open")});const n=a.querySelector("#client-name-input"),o=a.querySelector("#client-modal-error"),s=a.querySelector('[data-act="create"]');n?.focus();const r=()=>{t.classList.remove("open"),a.classList.remove("open"),document.removeEventListener("keydown",i),setTimeout(()=>{t.remove(),a.remove()},200)},i=c=>{c.key==="Escape"&&r()};document.addEventListener("keydown",i),t.addEventListener("click",r),a.querySelector(".client-modal__close")?.addEventListener("click",r),a.querySelector('[data-act="cancel"]')?.addEventListener("click",r);const l=async()=>{const c=(n?.value||"").trim();if(o.textContent="",!c){o.textContent="Please enter a client name.",n?.focus();return}s.disabled=!0;const m=s.innerHTML;s.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Adding…';try{const f=x.getConfig?.().BASE_URL||"",_=await fetch(`${f}/m5t/v5/acctGroup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({class:Bs,caption:c,parent:e.guid})}),v=await _.json().catch(()=>({}));if(!_.ok||!v?.ok){const w=_.status===403?"You are not authorized to add a client here.":v?.message||v?.error||`Failed (HTTP ${_.status})`;throw new Error(w)}na(`Added client “${c}”`,"success"),r(),await zs(e)}catch(f){console.warn("[clients] create failed:",f),o.textContent=f.message||"Something went wrong. Please try again.",s.disabled=!1,s.innerHTML=m}};s?.addEventListener("click",l),n?.addEventListener("keydown",c=>{c.key==="Enter"&&l()})}const co=e=>String(e||"").replace(/[^0-9]/g,"");async function Qd(e,t){const a=x.getConfig?.().BASE_URL||"",n={};try{const w=await fetch(`${a}/m5t/v5/coreAdAccount?owner_guid=${encodeURIComponent(e)}`),d=await w.json().catch(()=>({}));if(!w.ok)throw new Error(`Failed to load ad accounts (${w.status})`);(d?.data||[]).forEach(h=>{n[h.provider]=h})}catch(w){console.warn("[clients] ad-accounts prefill failed:",w)}const o=n.google_ads,s=n.google_lsa,r=document.createElement("div");r.className="client-modal-scrim";const i=document.createElement("div");i.className="client-modal",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body">
      ...
      <input class="client-modal__input" id="aa-gads" type="text" inputmode="numeric" placeholder="123-456-7890" autocomplete="off" value="${X(o?.external_customer_id||"")}" />
      ...
      <input class="client-modal__input" id="aa-lsa" type="text" inputmode="numeric" placeholder="Optional" autocomplete="off" value="${X(s?.external_customer_id||"")}" />
    ...
    </div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add("open"),i.classList.add("open")});const l=i.querySelector("#aa-error"),c=i.querySelector('[data-act="save"]'),m=()=>{r.classList.remove("open"),i.classList.remove("open"),document.removeEventListener("keydown",f),setTimeout(()=>{r.remove(),i.remove()},200)},f=w=>{w.key==="Escape"&&m()};document.addEventListener("keydown",f),r.addEventListener("click",m),i.querySelector(".client-modal__close")?.addEventListener("click",m),i.querySelector('[data-act="cancel"]')?.addEventListener("click",m);const _=(w,d,h)=>{const y=`${a}/m5t/v5/coreAdAccount`;return d&&!h?fetch(y,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,provider:w,external_customer_id:d})}):d&&h&&d!==h.external_customer_id?fetch(`${y}/${encodeURIComponent(h.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({external_customer_id:d})}):!d&&h?fetch(`${y}/${encodeURIComponent(h.guid)}`,{method:"DELETE"}):null},v=async()=>{l.textContent="";const w=co(i.querySelector("#aa-gads").value),d=co(i.querySelector("#aa-lsa").value),h=[_("google_ads",w,o),_("google_lsa",d,s)].filter(Boolean);if(!h.length){m();return}c.disabled=!0;const y=c.innerHTML;c.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const k=await Promise.all(h);for(const R of k)if(!R.ok){const U=await R.json().catch(()=>({}));throw new Error(R.status===403?"You are not authorized to connect accounts for this client.":U?.error||U?.message||`Failed (HTTP ${R.status})`)}na("Ad accounts updated","success"),m()}catch(k){l.textContent=k.message||"Something went wrong. Please try again.",c.disabled=!1,c.innerHTML=y}};c?.addEventListener("click",v)}function Zd(e,t){if(!e)return;const a=document.createElement("div");a.className="client-modal-scrim";const n=document.createElement("div");n.className="client-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="invite-body">
      ...
      <div class="client-modal__actions">
    ...
    </div>`,document.body.appendChild(a),document.body.appendChild(n),requestAnimationFrame(()=>{a.classList.add("open"),n.classList.add("open")});const o=()=>{a.classList.remove("open"),n.classList.remove("open"),document.removeEventListener("keydown",s),setTimeout(()=>{a.remove(),n.remove()},200)},s=m=>{m.key==="Escape"&&o()};document.addEventListener("keydown",s),a.addEventListener("click",o),n.querySelector(".client-modal__close")?.addEventListener("click",o),n.querySelector('[data-act="cancel"]')?.addEventListener("click",o);const r=n.querySelector("#inv-email"),i=n.querySelector("#inv-error"),l=n.querySelector('[data-act="send"]');r?.focus();const c=m=>m.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(m.dataset.url),m.textContent="Copied!",setTimeout(()=>{m.textContent="Copy link"},1500)}catch{}});(async function(){const f=n.querySelector("#invite-pending");if(f)try{const _=x.getConfig?.().BASE_URL||"",v=await fetch(`${_}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invites`),w=await v.json().catch(()=>({})),d=v.ok&&w.ok&&Array.isArray(w.invites)?w.invites:[];if(!d.length){f.innerHTML="";return}f.innerHTML=`
        <div class="invite-pending">
          <div class="invite-pending__label">Pending invites</div>
          ${d.map(h=>`
            <div class="invite-pending__row">
              <span class="invite-pending__email${h.expired?" expired":""}" title="${X(h.email)}">${X(h.email)}${h.expired?" · expired":""}</span>
              <button class="client-modal__btn client-modal__btn--ghost invite-pending__copy" type="button" data-url="${X(h.inviteUrl)}">Copy link</button>
            </div>`).join("")}
        </div>`,f.querySelectorAll(".invite-pending__copy").forEach(c)}catch{f.innerHTML=""}})(),l?.addEventListener("click",async()=>{const m=(n.querySelector("#inv-email").value||"").trim(),f=(n.querySelector("#inv-first").value||"").trim(),_=(n.querySelector("#inv-last").value||"").trim();if(i.textContent="",!m||!f||!_){i.textContent="Email, first, and last name are required.";return}l.disabled=!0;const v=l.innerHTML;l.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Sending…';try{const w=x.getConfig?.().BASE_URL||"",d=await fetch(`${w}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:m,first:f,last:_})}),h=await d.json().catch(()=>({}));if(!d.ok||!h.ok){const k=d.status===409?"A user with that email already exists.":d.status===403?"You are not authorized to invite for this client.":h.message||h.error||`Failed (HTTP ${d.status})`;throw new Error(k)}na(`Invite created for ${m}`,"success"),n.querySelector("#invite-body").innerHTML=`
        <div class="client-modal__result">
          ...
          <p>${h.emailQueued?`An invite email is on its way to <strong>${X(m)}</strong>.`:`Invite created for <strong>${X(m)}</strong>.`}</p>
          ...
          <div class="client-modal__linkrow">
            <input class="client-modal__input" id="inv-link" type="text" readonly value="${X(h.inviteUrl)}" />
        ...
        </div>`;const y=n.querySelector("#inv-link");n.querySelector("#inv-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(y.value),n.querySelector("#inv-copy").textContent="Copied!"}catch{y.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",o)}catch(w){console.warn("[clients] invite failed:",w),i.textContent=w.message||"Something went wrong. Please try again.",l.disabled=!1,l.innerHTML=v}})}const ep={render:Us,init:Hs},tp=Object.freeze(Object.defineProperty({__proto__:null,default:ep,init:Hs,render:Us},Symbol.toStringTag,{value:"Module"})),po="managed_client";let uo=!1;const ap={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},pe=e=>String(e??"").replace(/[&<>"']/g,t=>ap[t]),mo=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},np=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function op(){const e=x.getActiveOrg();let t=e&&e.channel!==po?e:null;if(!t){const n=x.getMemberships().find(o=>o.channel!==po);n&&(t={guid:n.orgGuid,channel:n.channel,memberRole:n.memberRole})}if(!t)return null;const a=x.getMemberships().find(n=>n.orgGuid===t.guid)?.name;return{...t,name:a}}function sp(e){return Object.values(bt).filter(t=>Pr(e,t.value)).sort((t,a)=>a.rank-t.rank)}function rp(){if(uo)return;const e=document.createElement("style");e.id="m5t-team-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),uo=!0}function oa(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function ip(e){const t=e.member_role||"member";return`
    <div class="team-row">
      <span class="team-avatar">${pe(np(e.name||e.email))}</span>
      <span class="team-main">
        <div class="team-name">${pe(e.name||e.email)}${e.verified?"":' · <span style="color:var(--color-text-subtle,#6C7C9A);font-weight:400;">pending verification</span>'}</div>
        <div class="team-email" title="${pe(e.email)}">${pe(e.email)}</div>
      </span>
      <span class="team-role" data-role="${pe(t)}">${pe(bt[t]?.label||t)}</span>
    </div>`}function Gs(){return rp(),`
    ...
    <div class="team-modal__body" id="team-invite-body">
      <p class="team-modal__sub">They'll get a link to set a password and join <strong>${pe(e.name||"your workspace")}</strong>.</p>
      ...
      <select class="team-modal__select" id="tm-role">
        ${t.map(l=>`<option value="${l.value}"${l.value==="member"?" selected":""}>${pe(l.label)}</option>`).join("")}
      </select>
