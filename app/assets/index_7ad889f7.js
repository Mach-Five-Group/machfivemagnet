(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const Ti="modulepreload",Ci=function(e,t){return new URL(e,t).href},jn={},W=function(t,a,n){let o=Promise.resolve();if(a&&a.length>0){let c=function(d){return Promise.all(d.map(f=>Promise.resolve(f).then(v=>({status:"fulfilled",value:v}),v=>({status:"rejected",reason:v}))))};const r=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");o=c(a.map(d=>{if(d=Ci(d,n),d in jn)return;jn[d]=!0;const f=d.endsWith(".css"),v=f?'[rel="stylesheet"]':"";if(n)for(let u=r.length-1;u>=0;u--){const p=r[u];if(p.href===d&&(!f||p.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${d}"]${v}`))return;const h=document.createElement("link");if(h.rel=f?"stylesheet":Ti,f||(h.as="script"),h.crossOrigin="",h.href=d,l&&h.setAttribute("nonce",l),document.head.appendChild(h),f)return new Promise((u,p)=>{h.addEventListener("load",u),h.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${d}`)))})}))}function s(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return o.then(r=>{for(const i of r||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})};var $i=/([:*])(\w+)/g,Li="([^/]+)",Ii=/\*/g,Ri="?(?:.*)",Ni=/\/\?/g,Oi="/?([^/]+|)",Mi="(?:/^|^)",Pi="";function gs(e){return e===void 0&&(e="/"),wn()?location.pathname+location.search+location.hash:e}function ee(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function da(e){return typeof e=="string"}function Fi(e){return typeof e=="function"}function pa(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function Di(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(a,n,o){return a===null&&(a={}),a[t[o]]=decodeURIComponent(n),a},null)}function ua(e){var t=ee(e).split(/\?(.*)?$/);return[ee(t[0]),t.slice(1).join("")]}function yn(e){for(var t={},a=e.split("&"),n=0;n<a.length;n++){var o=a[n].split("=");if(o[0]!==""){var s=decodeURIComponent(o[0]);t[s]?(Array.isArray(t[s])||(t[s]=[t[s]]),t[s].push(decodeURIComponent(o[1]||""))):t[s]=decodeURIComponent(o[1]||"")}}return t}function hs(e,t){var a=ua(ee(e.currentLocationPath)),n=a[0],o=a[1],s=o===""?null:yn(o),r=[],i;if(da(t.path)){if(i=Mi+ee(t.path).replace($i,function(f,v,h){return r.push(h),Li}).replace(Ii,Ri).replace(Ni,Oi)+"$",ee(t.path)===""&&ee(n)==="")return{url:n,queryString:o,hashString:pa(e.to),route:t,data:null,params:s}}else i=t.path;var l=new RegExp(i,Pi),c=n.match(l);if(c){var d=da(t.path)?Di(c,r):c.groups?c.groups:c.slice(1);return{url:ee(n.replace(new RegExp("^"+e.instance.root),"")),queryString:o,hashString:pa(e.to),route:t,data:d,params:s}}return!1}function fs(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function mt(e,t){return typeof e[t]>"u"||e[t]===!0}function Bi(e){if(!e)return{};var t=e.split(","),a={},n;return t.forEach(function(o){var s=o.split(":").map(function(r){return r.replace(/(^ +| +$)/g,"")});switch(s[0]){case"historyAPIMethod":a.historyAPIMethod=s[1];break;case"resolveOptionsStrategy":n||(n={}),n.strategy=s[1];break;case"resolveOptionsHash":n||(n={}),n.hash=s[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":a[s[0]]=s[1]==="true";break}}),n&&(a.resolveOptions=n),a}function wn(){return typeof window<"u"}function Ui(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(a){return a}).forEach(function(a){["before","after","already","leave"].forEach(function(n){a[n]&&(t[n]||(t[n]=[]),t[n].push(a[n]))})}),t}function Fe(e,t,a){var n=t||{},o=0;(function s(){if(!e[o]){a&&a(n);return}Array.isArray(e[o])?(e.splice.apply(e,[o,1].concat(e[o][0](n)?e[o][1]:e[o][2])),s()):e[o](n,function(r){typeof r>"u"||r===!0?(o+=1,s()):a&&a(n)})})()}Fe.if=function(e,t,a){return Array.isArray(t)||(t=[t]),Array.isArray(a)||(a=[a]),[e,t,a]};function Vn(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=gs(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function Da(e,t){for(var a=0;a<e.instance.routes.length;a++){var n=e.instance.routes[a],o=hs(e,n);if(o&&(e.matches||(e.matches=[]),e.matches.push(o),e.resolveOptions.strategy==="ONE")){t();return}}t()}function Hi(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function qi(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var Wn=wn(),zi=fs();function Gi(e,t){if(mt(e.navigateOptions,"updateBrowserURL")){var a=("/"+e.to).replace(/\/\//g,"/"),n=Wn&&e.resolveOptions&&e.resolveOptions.hash===!0;zi?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",n?"#"+a:a),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!n){var o=location.hash;location.hash="",location.hash=o}e.instance.__freezeListening=!1},1))):Wn&&(window.location.href=e.to)}t()}function vs(e,t){var a=e.instance;if(!a.lastResolved()){t();return}Fe(a.lastResolved().map(function(n){return function(o,s){if(!n.route.hooks||!n.route.hooks.leave){s();return}var r=!1,i=e.instance.matchLocation(n.route.path,e.currentLocationPath,!1);if(n.route.path!=="*")r=!i;else{var l=e.matches?e.matches.find(function(c){return n.route.path===c.route.path}):!1;r=!l}if(mt(e.navigateOptions,"callHooks")&&r){Fe(n.route.hooks.leave.map(function(c){return function(d,f){return c(function(v){v===!1?e.instance.__markAsClean(e):f()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return s()}]));return}else s()}}),{},function(){return t()})}function ji(e,t){e.match.route.hooks&&e.match.route.hooks.before&&mt(e.navigateOptions,"callHooks")?Fe(e.match.route.hooks.before.map(function(a){return function(o,s){return a(function(r){r===!1?e.instance.__markAsClean(e):s()},e.match)}}).concat([function(){return t()}])):t()}function Vi(e,t){mt(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function Wi(e,t){e.match.route.hooks&&e.match.route.hooks.after&&mt(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(a){return a(e.match)}),t()}function Yi(e,t){var a=e.instance.lastResolved();if(a&&a[0]&&a[0].route===e.match.route&&a[0].url===e.match.url&&a[0].queryString===e.match.queryString){a.forEach(function(n){n.route.hooks&&n.route.hooks.already&&mt(e.navigateOptions,"callHooks")&&n.route.hooks.already.forEach(function(o){return o(e.match)})}),t(!1);return}t()}function Ji(e,t){var a=e.instance._notFoundRoute;if(a){e.notFoundHandled=!0;var n=ua(e.currentLocationPath),o=n[0],s=n[1],r=pa(e.to);a.path=ee(o);var i={url:a.path,queryString:s,hashString:r,data:null,route:a,params:s!==""?yn(s):null};e.matches=[i],e.match=i}t()}function Ki(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function Qi(e,t){e.instance._setCurrent(null),t()}function bs(e,t){mt(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var _s=[Yi,ji,Vi,Wi],Yn=[vs,Ji,Fe.if(function(e){var t=e.notFoundHandled;return t},_s.concat([bs]),[Ki,Qi])];function Qa(){return Qa=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},Qa.apply(this,arguments)}function Jn(e,t){var a=0;function n(){if(a===e.matches.length){bs(e,t);return}Fe(_s,Qa({},e,{match:e.matches[a]}),function(){a+=1,n()})}vs(e,n)}function Ba(e){e.instance.__markAsClean(e)}function Xa(){return Xa=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},Xa.apply(this,arguments)}var Kn="[data-navigo]";function Xi(e,t){var a=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:Kn},n=this,o="/",s=null,r=[],i=!1,l,c=fs(),d=wn();e?o=ee(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function f(_){return _.indexOf("#")>=0&&(a.hash===!0?_=_.split("#")[1]||"/":_=_.split("#")[0]),_}function v(_){return ee(o+"/"+ee(_))}function h(_,S,O,V){return _=da(_)?v(_):_,{name:V||ee(String(_)),path:_,handler:S,hooks:Ui(O)}}function u(_,S,O){var V=this;return typeof _=="object"&&!(_ instanceof RegExp)?(Object.keys(_).forEach(function(B){if(typeof _[B]=="function")V.on(B,_[B]);else{var Ae=_[B],Ze=Ae.uses,T=Ae.as,z=Ae.hooks;r.push(h(B,Ze,[l,z],T))}}),this):(typeof _=="function"&&(O=S,S=_,_=o),r.push(h(_,S,[l,O])),this)}function p(_,S){if(n.__dirty){n.__waiting.push(function(){return n.resolve(_,S)});return}else n.__dirty=!0;_=_?ee(o)+"/"+ee(_):void 0;var O={instance:n,to:_,currentLocationPath:_,navigateOptions:{},resolveOptions:Xa({},a,S)};return Fe([Vn,Da,Fe.if(function(V){var B=V.matches;return B&&B.length>0},Jn,Yn)],O,Ba),O.matches?O.matches:!1}function b(_,S){if(n.__dirty){n.__waiting.push(function(){return n.navigate(_,S)});return}else n.__dirty=!0;_=ee(o)+"/"+ee(_);var O={instance:n,to:_,navigateOptions:S||{},resolveOptions:S&&S.resolveOptions?S.resolveOptions:a,currentLocationPath:f(_)};Fe([Hi,qi,Da,Fe.if(function(V){var B=V.matches;return B&&B.length>0},Jn,Yn),Gi,Ba],O,Ba)}function y(_,S,O){var V=Le(_,S);return V!==null?(b(V.replace(new RegExp("^/?"+o),""),O),!0):!1}function E(_){return this.routes=r=r.filter(function(S){return da(_)?ee(S.path)!==ee(_):Fi(_)?_!==S.handler:String(S.path)!==String(_)}),this}function A(){c&&(this.__popstateListener=function(){n.__freezeListening||p()},window.addEventListener("popstate",this.__popstateListener))}function C(){this.routes=r=[],c&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=i=!0}function j(_,S){return n._notFoundRoute=h("*",_,[l,S],"__NOT_FOUND__"),this}function q(){if(d)return X().forEach(function(_){if(_.getAttribute("data-navigo")==="false"||_.getAttribute("target")==="_blank"){_.hasListenerAttached&&_.removeEventListener("click",_.navigoHandler);return}_.hasListenerAttached||(_.hasListenerAttached=!0,_.navigoHandler=function(S){if((S.ctrlKey||S.metaKey)&&S.target.tagName.toLowerCase()==="a")return!1;var O=_.getAttribute("href");if(typeof O>"u"||O===null)return!1;if(O.match(/^(http|https)/)&&typeof URL<"u")try{var V=new URL(O);O=V.pathname+V.search}catch{}var B=Bi(_.getAttribute("data-navigo-options"));i||(S.preventDefault(),S.stopPropagation(),n.navigate(ee(O),B))},_.addEventListener("click",_.navigoHandler))}),n}function X(){return d?[].slice.call(document.querySelectorAll(a.linksSelector||Kn)):[]}function de(_){return"/"+o+"/"+ee(_)}function ge(_){return l=_,this}function ue(){return s}function Le(_,S,O){var V=r.find(function(Ze){return Ze.name===_}),B=null;if(V){if(B=V.path,S)for(var Ae in S)B=B.replace(":"+Ae,S[Ae]);B=B.match(/^\//)?B:"/"+B}return B&&O&&!O.includeRoot&&(B=B.replace(new RegExp("^/"+o),"")),B}function D(_){return _.getAttribute("href")}function te(_){var S=ua(ee(_)),O=S[0],V=S[1],B=V===""?null:yn(V),Ae=pa(_),Ze=h(O,function(){},[l],O);return{url:O,queryString:V,hashString:Ae,route:Ze,data:null,params:B}}function U(){return te(ee(gs(o)).replace(new RegExp("^"+o),""))}function J(_){var S={instance:n,currentLocationPath:_,to:_,resolveOptions:a};return Da(S,function(){}),S.matches?S.matches:!1}function Qe(_,S,O){typeof S<"u"&&(typeof O>"u"||O)&&(S=v(S));var V={instance:n,to:S,currentLocationPath:S};Vn(V,function(){}),typeof _=="string"&&(_=typeof O>"u"||O?v(_):_);var B=hs(V,{name:String(_),path:_,handler:function(){},hooks:{}});return B||!1}function Xe(_,S,O){return typeof S=="string"&&(S=$t(S)),S?(S.hooks[_]||(S.hooks[_]=[]),S.hooks[_].push(O),function(){S.hooks[_]=S.hooks[_].filter(function(V){return V!==O})}):(console.warn("Route doesn't exists: "+S),function(){})}function $t(_){return typeof _=="string"?r.find(function(S){return S.name===v(_)}):r.find(function(S){return S.handler===_})}function Pa(_){_.instance.__dirty=!1,_.instance.__waiting.length>0&&_.instance.__waiting.shift()()}this.root=o,this.routes=r,this.destroyed=i,this.current=s,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=Pa,this.on=u,this.off=E,this.resolve=p,this.navigate=b,this.navigateByName=y,this.destroy=C,this.notFound=j,this.updatePageLinks=q,this.link=de,this.hooks=ge,this.extractGETParameters=function(_){return ua(f(_))},this.lastResolved=ue,this.generate=Le,this.getLinkPath=D,this.match=J,this.matchLocation=Qe,this.getCurrentLocation=U,this.addBeforeHook=Xe.bind(this,"before"),this.addAfterHook=Xe.bind(this,"after"),this.addAlreadyHook=Xe.bind(this,"already"),this.addLeaveHook=Xe.bind(this,"leave"),this.getRoute=$t,this._pathToMatchObject=te,this._clean=ee,this._checkForAHash=f,this._setCurrent=function(_){return s=n.current=_},A.call(this),q.call(this)}var Zi=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function el(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Nt={exports:{}},tl=Nt.exports,Qn;function al(){return Qn||(Qn=1,(function(e,t){(function(a,n){var o={};a.PubSub?(o=a.PubSub,console.warn("PubSub already loaded, using existing version")):(a.PubSub=o,n(o)),e!==void 0&&e.exports&&(t=e.exports=o),t.PubSub=o,e.exports=t=o})(typeof window=="object"&&window||tl||Zi,function(a){var n={},o=-1,s="*";function r(p){var b;for(b in p)if(Object.prototype.hasOwnProperty.call(p,b))return!0;return!1}function i(p){return function(){throw p}}function l(p,b,y){try{p(b,y)}catch(E){setTimeout(i(E),0)}}function c(p,b,y){p(b,y)}function d(p,b,y,E){var A=n[b],C=E?c:l,j;if(Object.prototype.hasOwnProperty.call(n,b))for(j in A)Object.prototype.hasOwnProperty.call(A,j)&&C(A[j],p,y)}function f(p,b,y){return function(){var A=String(p),C=A.lastIndexOf(".");for(d(p,p,b,y);C!==-1;)A=A.substr(0,C),C=A.lastIndexOf("."),d(p,A,b,y);d(p,s,b,y)}}function v(p){var b=String(p),y=!!(Object.prototype.hasOwnProperty.call(n,b)&&r(n[b]));return y}function h(p){for(var b=String(p),y=v(b)||v(s),E=b.lastIndexOf(".");!y&&E!==-1;)b=b.substr(0,E),E=b.lastIndexOf("."),y=v(b);return y}function u(p,b,y,E){p=typeof p=="symbol"?p.toString():p;var A=f(p,b,E),C=h(p);return C?(y===!0?A():setTimeout(A,0),!0):!1}a.publish=function(p,b){return u(p,b,!1,a.immediateExceptions)},a.publishSync=function(p,b){return u(p,b,!0,a.immediateExceptions)},a.subscribe=function(p,b){if(typeof b!="function")return!1;p=typeof p=="symbol"?p.toString():p,Object.prototype.hasOwnProperty.call(n,p)||(n[p]={});var y="uid_"+String(++o);return n[p][y]=b,y},a.subscribeAll=function(p){return a.subscribe(s,p)},a.subscribeOnce=function(p,b){var y=a.subscribe(p,function(){a.unsubscribe(y),b.apply(this,arguments)});return a},a.clearAllSubscriptions=function(){n={}},a.clearSubscriptions=function(b){var y;for(y in n)Object.prototype.hasOwnProperty.call(n,y)&&y.indexOf(b)===0&&delete n[y]},a.countSubscriptions=function(b){var y,E,A=0;for(y in n)if(Object.prototype.hasOwnProperty.call(n,y)&&y.indexOf(b)===0){for(E in n[y])A++;break}return A},a.getSubscriptions=function(b){var y,E=[];for(y in n)Object.prototype.hasOwnProperty.call(n,y)&&y.indexOf(b)===0&&E.push(y);return E},a.unsubscribe=function(p){var b=function(de){var ge;for(ge in n)if(Object.prototype.hasOwnProperty.call(n,ge)&&ge.indexOf(de)===0)return!0;return!1},y=typeof p=="string"&&(Object.prototype.hasOwnProperty.call(n,p)||b(p)),E=!y&&typeof p=="string",A=typeof p=="function",C=!1,j,q,X;if(y){a.clearSubscriptions(p);return}for(j in n)if(Object.prototype.hasOwnProperty.call(n,j)){if(q=n[j],E&&q[p]){delete q[p],C=p;break}if(A)for(X in q)Object.prototype.hasOwnProperty.call(q,X)&&q[X]===p&&(delete q[X],C=!0)}return C}})})(Nt,Nt.exports)),Nt.exports}var nl=al();const m=el(nl),g=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV.GO",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN.GO",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP.GO",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT.GO",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT.GO",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH.GO",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",AUTH_SCOPE_LOADED:"AUTH.SCOPE.LOADED",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",M5T_SIDE_NAV:"M5T_SIDE_NAV",M5T_SIDE_NAV_TAP:"M5T_SIDE_NAV.TAP",M5T_SIDE_NAV_COLLAPSE:"M5T_SIDE_NAV.COLLAPSE",M5T_SIDE_NAV_LOGO_TAP:"M5T_SIDE_NAV.LOGO_TAP",M5T_SIDE_NAV_ORG_SWITCH:"M5T_SIDE_NAV.ORG_SWITCH",M5T_SIDE_NAV_FOOTER_ACTION:"M5T_SIDE_NAV.FOOTER_ACTION",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_THEME_CHANGED:"UI.THEME.CHANGED",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL",MESSAGE:"MESSAGE",MESSAGE_CREATE:"MESSAGE.CREATE",MESSAGE_CREATED:"MESSAGE.CREATED",MESSAGE_EDIT:"MESSAGE.EDIT",MESSAGE_UPDATED:"MESSAGE.UPDATED",MESSAGE_DELETE:"MESSAGE.DELETE",MESSAGE_DELETED:"MESSAGE.DELETED",MESSAGE_REFRESH:"MESSAGE.REFRESH"}),Ua={BASE_URL:"./",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://machfivemagnet-saas.onrender.com"};var Ha={};const H=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_UI_DARK_MODE:!0,FF_SSE_UI_ANIMATIONS:!0,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel",FF_API_RATELIMIT_SIGNIN_ENFORCE:!1,FF_API_RATELIMIT_SIGNIN_IP_LIMIT:20,FF_API_RATELIMIT_SIGNIN_EMAIL_LIMIT:10,FF_API_RATELIMIT_FORGOT_ENFORCE:!1,FF_API_RATELIMIT_FORGOT_IP_LIMIT:15,FF_API_RATELIMIT_FORGOT_EMAIL_LIMIT:5,FF_API_RATELIMIT_CAPTURE_ENFORCE:!1,FF_API_RATELIMIT_CAPTURE_LIMIT:30,FF_API_RATELIMIT_EVENT_ENFORCE:!1,FF_API_RATELIMIT_EVENT_LIMIT:600,FF_API_RATELIMIT_CSP_PING_ENFORCE:!1,FF_API_RATELIMIT_CSP_PING_LIMIT:30,FF_API_RATELIMIT_WEBAUTHN_AUTH_ENFORCE:!1,FF_API_RATELIMIT_WEBAUTHN_AUTH_IP_LIMIT:20,FF_API_RATELIMIT_INTEGRATIONS_ENFORCE:!1,FF_API_RATELIMIT_INTEGRATIONS_LIMIT:60,FF_API_RATELIMIT_QUESTIONNAIRE_ENFORCE:!1,FF_API_RATELIMIT_QUESTIONNAIRE_LIMIT:30,FF_API_RATELIMIT_AUTHENTICATED_ENFORCE:!1,FF_API_RATELIMIT_AUTHENTICATED_LIMIT:600,FF_API_MAGNET_REQUIRE_ORIGIN_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_LIMIT:2e3});function ys(e,t=null){if(e in H)return H[e];if(typeof process<"u"&&Ha&&Ha[e]){const a=Ha[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}if(typeof import.meta<"u"&&Ua&&Ua[e]){const a=Ua[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}return t}function xn(e){return ys(e,!1)===!0}function ol(){return{...H}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:H,getFlag:ys,isEnabled:xn,getAllFlags:ol});const Xn={success:{border:"var(--color-success, #009473)",bg:"var(--color-success-soft, rgba(0,148,115,0.10))",icon:"check_circle"},danger:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},error:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},warning:{border:"var(--color-warning, #D97706)",bg:"var(--color-warning-soft, #FEF3C7)",icon:"warning"},info:{border:"var(--color-info, #0D9488)",bg:"var(--color-info-soft, #CCFBF1)",icon:"info"}},sl=4500,Za=220;let Be=null,Zn=!1;function rl(){if(Zn)return;const e=document.createElement("style");e.id="m5t-toast-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Zn=!0}function il(){return Be&&document.body.contains(Be)||(Be=document.createElement("div"),Be.className="m5t-toast-stack",Be.setAttribute("role","status"),Be.setAttribute("aria-live","polite"),document.body.appendChild(Be)),Be}function ll(e){const t=e&&e.message;if(!t)return;rl();const a=Xn[e.type]||Xn.info,n=document.createElement("div");n.className="m5t-toast",n.style.borderColor=a.border,n.style.background=a.bg,n.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true" style="color:${a.border}">${a.icon}</span><span class="m5t-toast__msg"></span><button type="button" class="m5t-toast__close" aria-label="Dismiss"><span class="material-symbols-outlined" aria-hidden="true">close</span></button>`,n.querySelector(".m5t-toast__msg").textContent=String(t),il().appendChild(n),requestAnimationFrame(()=>n.classList.add("is-in"));let s=!1;const r=()=>{s||(s=!0,clearTimeout(i),n.classList.remove("is-in"),n.classList.add("is-out"),setTimeout(()=>n.remove(),Za))},i=setTimeout(r,sl);n.querySelector(".m5t-toast__close").addEventListener("click",r)}function cl(){const e=t=>a=>{const n=a.detail?.pubsubTopic;n&&m.publish(n,a.detail)};document.addEventListener("nav-select",e()),document.addEventListener("logo-click",e()),document.addEventListener("nav-hover",e()),document.addEventListener("nav-double-tap",e()),document.addEventListener("nav-long-tap",e()),document.addEventListener("message-sent",e())}function dl(){console.log("[AppEvents] Initializing event listeners..."),m.subscribe(g.APP_READY,(a,n)=>{console.log("[AppEvents] APP_READY:",n)}),m.subscribe(g.APP_ERROR,(a,n)=>{console.error("[AppEvents] APP_ERROR:",n)}),m.subscribe(g.APP_SIGNOUT,(a,n)=>{console.log("[AppEvents] APP_SIGNOUT:",n)}),m.subscribe(g.ROUTE_NAV_BEFORE,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",n),m.publish(g.UI_LOADING_START)}),m.subscribe(g.ROUTE_NAV_AFTER,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",n),m.publish(g.UI_LOADING_END)}),m.subscribe(g.ROUTE_NAV_ERROR,(a,n)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",n),m.publish(g.APP_ERROR,{message:"Navigation error",details:n})}),m.subscribe(g.AUTH_SIGNIN_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",n)}),m.subscribe(g.AUTH_SIGNIN_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",n),m.publish(g.UI_TOAST,{message:n.message||"Sign in failed",type:"danger"})}),m.subscribe(g.AUTH_SIGNUP_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",n),m.publish(g.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"}),m.publish(g.AUTH_VERIFY_LINK)}),m.subscribe(g.AUTH_VERIFY_LINK,(a,n)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),m.subscribe(g.AUTH_SIGNUP_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",n),m.publish(g.UI_TOAST,{message:n.message||"Sign up failed",type:"danger"})}),m.subscribe(g.AUTH_SIGNOUT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",n),m.publish(g.UI_TOAST,{message:"Signed out successfully",type:"info"})}),m.subscribe(g.AUTH_SIGNUP,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),m.subscribe(g.AUTH_FORGOT,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),m.subscribe(g.AUTH_FORGOT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",n),m.publish(g.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),m.subscribe(g.AUTH_RESETHASH_NAV,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),m.subscribe(g.AUTH_RESETHASH_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",n),m.publish(g.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),m.subscribe(g.AUTH_TOKEN_EXPIRED,(a,n)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",n),m.publish(g.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),m.subscribe(g.I18N_SET_LANG,(a,n)=>{console.log("[AppEvents] I18N_SET_LANG:",n);const{langCode:o}=n;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),m.publish(g.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(s){console.error("[AppEvents] Error changing language:",s),m.publish(g.UI_TOAST,{message:`Failed to change language: ${s.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),m.subscribe("CONVERSATION.PROMPT",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",n.message),qa(n.message,"user",n.timestamp),m.publish(g.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Agent prompt (no implementation):",n.message);break;case"AGENT_CANVAS":console.log("[AppEvents] Display message in canvas:",n.message),qa(n.message,"user",n.timestamp),m.publish(g.CANVAS_DO_SCROLL);break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),m.subscribe("CONVERSATION.RESPONSE",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",n.message),qa(n.message,"assistant",n.timestamp,n.streaming);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),m.subscribe(g.UI_LOADING_START,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),m.subscribe(g.UI_LOADING_END,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),m.subscribe(g.UI_TOAST,(a,n)=>{ll(n)}),m.subscribe(g.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const a="0.1",n=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${a} 8/11/2026, 3:01:12 PM|© ${n} Mach Five Tech`,"night")}),cl(),m.subscribe("M5T_PRIMARY_NAV",(a,n)=>{const o=a.split(".")[1];switch(o){case"TAP":e(n);break;case"LOGO_TAP":t();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function e(a){const{token:n,level:o,primaryToken:s}=a;switch(n){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),m.publish(g.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${n}`,{primaryToken:s});break}}function t(a){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 8/11/2026, 3:01:12 PM|© ${o} Mach Five Tech`,"night",5e3)}m.subscribe(g.AUTH_SIGNOUT,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(H.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function qa(e,t="user",a=null,n=!1){const o=document.getElementById("chat-messages");if(!o){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}if(a||(a=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})),n&&t==="assistant"){const r=o.firstElementChild;if(r&&r.tagName.toLowerCase()==="m5t-chat-response"){r.setAttribute("message",e),console.log(`[AppEvents] Updated streaming ${t} bubble (${e.length} chars)`);return}}let s;t==="user"||t==="prompt"?s=document.createElement("m5t-chat-prompt"):s=document.createElement("m5t-chat-response"),s.setAttribute("message",e),s.setAttribute("timestamp",a),o.prepend(s),console.log(`[AppEvents] Added ${t} bubble to canvas (${e.length} chars)`)}function ws(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("uid")&&t.get("token"))}function pl(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("qr")&&t.get("token"))}function ul(e=window.location.search){const t=new URLSearchParams(e||""),a=t.get("qr"),n=t.get("token");return a&&n?{guid:a,token:n}:null}const ml=Object.freeze({admin_root_role:{value:100,desc:"Administrator superuser infrastructure architecture"},admin_business_role:{value:90,desc:"Administrator financial oversight"},admin_support_role:{value:80,desc:"Administrator maintenance and configuration"},admin_readonly_role:{value:70,desc:"Administrator information help desk"},client_tier_4_role:{value:40,desc:"Client paid tier 4 - Partner"},client_tier_3_role:{value:30,desc:"Client paid tier 3"},client_tier_2_role:{value:20,desc:"Client paid tier 2"},client_tier_1_role:{value:10,desc:"Client paid tier 1"},client_standard_role:{value:0,desc:"Client free tier 0"}});function gl(e){return ml[e]||null}function hl(e){return e>=50}const Ft=Object.freeze({owner:{value:"owner",rank:30,label:"Owner"},admin:{value:"admin",rank:20,label:"Admin"},member:{value:"member",rank:10,label:"Member"},viewer:{value:"viewer",rank:0,label:"Viewer"}}),fl=Object.freeze({VIEW_DASHBOARD:"view_dashboard",VIEW_MAGNETS:"view_magnets",PROVISION_MAGNETS:"provision_magnets",MANAGE_MAGNETS:"manage_magnets",VIEW_CONVERSATIONS:"view_conversations",VIEW_STATS:"view_stats",VIEW_AD_METRICS:"view_ad_metrics",CONNECT_AD_ACCOUNTS:"connect_ad_accounts",CREATE_CLIENT_ACCOUNTS:"create_client_accounts",MANAGE_TEAM:"manage_team",VIEW_BILLING:"view_billing",MANAGE_BILLING:"manage_billing"}),$=fl,xs=Object.freeze(Object.values($)),at=Object.freeze([$.VIEW_DASHBOARD,$.VIEW_MAGNETS,$.VIEW_CONVERSATIONS,$.VIEW_STATS,$.VIEW_AD_METRICS]),vl=Object.freeze({reseller_org:{owner:xs,admin:[$.VIEW_DASHBOARD,$.VIEW_MAGNETS,$.PROVISION_MAGNETS,$.MANAGE_MAGNETS,$.VIEW_CONVERSATIONS,$.VIEW_STATS,$.VIEW_AD_METRICS,$.CONNECT_AD_ACCOUNTS,$.CREATE_CLIENT_ACCOUNTS,$.MANAGE_TEAM,$.VIEW_BILLING],member:[$.VIEW_DASHBOARD,$.VIEW_MAGNETS,$.PROVISION_MAGNETS,$.MANAGE_MAGNETS,$.VIEW_CONVERSATIONS,$.VIEW_STATS,$.VIEW_AD_METRICS],viewer:at},managed_client:{owner:[...at,$.VIEW_BILLING],admin:[...at,$.VIEW_BILLING],member:at,viewer:at},saas_org:{owner:[$.VIEW_DASHBOARD,$.VIEW_MAGNETS,$.PROVISION_MAGNETS,$.MANAGE_MAGNETS,$.VIEW_CONVERSATIONS,$.VIEW_STATS,$.VIEW_AD_METRICS,$.CONNECT_AD_ACCOUNTS,$.MANAGE_TEAM,$.VIEW_BILLING,$.MANAGE_BILLING],admin:[$.VIEW_DASHBOARD,$.VIEW_MAGNETS,$.PROVISION_MAGNETS,$.MANAGE_MAGNETS,$.VIEW_CONVERSATIONS,$.VIEW_STATS,$.VIEW_AD_METRICS,$.CONNECT_AD_ACCOUNTS,$.MANAGE_TEAM,$.VIEW_BILLING],member:[$.VIEW_DASHBOARD,$.VIEW_MAGNETS,$.PROVISION_MAGNETS,$.MANAGE_MAGNETS,$.VIEW_CONVERSATIONS,$.VIEW_STATS],viewer:at}});function bl(e){const t=gl(e);return!!t&&hl(t.value)}function _l({entityClass:e,orgChannel:t,memberRole:a}={}){if(bl(e))return e==="admin_readonly_role"?[...at,$.VIEW_BILLING]:[...xs];const n=vl[t],o=n&&n[a];return o?[...o]:[]}function yl(e,t){const a=Ft[e]?.rank??-1,n=Ft[t]?.rank??1/0;return a>=Ft.admin.rank&&a>=n}const En=[{value:"name",label:"Full name (splits into first + last automatically)"},{value:"first_name",label:"First name"},{value:"last_name",label:"Last name"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"mobile",label:"Mobile phone"},{value:"company",label:"Company"},{value:"title",label:"Job title"},{value:"city",label:"City"},{value:"state",label:"State / province"},{value:"product_interest",label:"Product interest"},{value:"lead_source",label:"Lead source"},{value:"rating",label:"Rating (Hot / Warm / Cold)"},{value:"description",label:"Notes / description"},{value:"salutation",label:"Salutation (Mr. / Ms. / Dr.)"},{value:"street",label:"Street address"},{value:"zip",label:"Postal / ZIP code"},{value:"country",label:"Country"},{value:"url",label:"Website URL"},{value:"industry",label:"Industry"},{value:"annual_revenue",label:"Annual revenue (number)"},{value:"employees",label:"Number of employees (whole number)"},{value:"is_primary",label:"Primary contact (Yes / No)"},{value:"current_generators",label:"Current generator(s)"},{value:"number_of_locations",label:"Number of locations (whole number)"}];new Set(En.map(e=>e.value));const kn=[{value:"single_select",label:"Multiple choice"},{value:"multi_select",label:"Select all"},{value:"scheduler",label:"Scheduler"},{value:"text",label:"Short text"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"message",label:"Message"}];new Set(kn.map(e=>e.value));const wl=[{value:"inline",label:"Inline"},{value:"chat",label:"Chat"},{value:"right_slide",label:"Slide"},{value:"modal",label:"Modal"}],xl=[{value:"auto",label:"Auto"},{value:"light",label:"Light"},{value:"dark",label:"Dark"}],El=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],kl=[{value:"book",label:"Book"},{value:"call",label:"Call"},{value:"email",label:"Email"},{value:"chat",label:"Chat"},{value:"support",label:"Support"}];wl.map(e=>e.value);xl.map(e=>e.value);El.map(e=>e.value);kl.map(e=>e.value);class x{static CONFIG={BASE_URL:"https://machfivemagnet-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink",SCOPE:"sse_session_scope",ACTIVE_ORG:"sse_active_org",REMEMBERED_EMAIL:"sse_remembered_email"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",ME:"/m5t/v5/acctEntity/me",PING:"/ping",WEBAUTHN_AUTH_OPTIONS:"/m5t/v5/webauthn/authenticate/options",WEBAUTHN_AUTH_VERIFY:"/m5t/v5/webauthn/authenticate/verify"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#o=null;static#a=null;static#n=null;static#s=null;static#i=null;static async init({BASE_URL:t,navigateFunction:a,customConfig:n={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(a&&typeof a=="function")this.#i=a;else throw new Error("navigateFunction is required and must be a function");return t&&(this.CONFIG.BASE_URL=t),n&&Object.keys(n).length>0&&(this.CONFIG={...this.CONFIG,...n}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#m(),this.#u(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#u(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((t=null)=>{if(t){if(ws()&&(t==="splash"||t==="signin")){console.log("[AuthController] Ignoring mvvLegit redirect to",t,"— keeping invitee on accept-invite");return}console.log("[AuthController] mvvLegit navigation to:",t),this.#r(t)}}).setOnState((t=null)=>{if(t)switch(console.log("[AuthController] Auth state changed:",t),t){case"AUTH":case 4:this.#_();break;case"UNAUTH":case 1:this.#y();break;case"UNVERF":case 2:this.#w();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#r(t){if(!this.#i){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",t);const a=t.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",a),this.#i(a)}static#l(){if(window.__m5tActiveOrgFetch)return;const t=window.fetch.bind(window);window.fetch=(a,n)=>{try{const o=typeof a=="string"?a:a?.url||"",s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);if(s&&o.startsWith(this.CONFIG.BASE_URL)){const r=new Headers(n&&n.headers||(a instanceof Request?a.headers:void 0));r.set("X-Active-Org",s),n={...n||{},headers:r}}}catch{}return t(a,n)},window.__m5tActiveOrgFetch=!0,console.log("[AuthController] Active-org fetch header installed")}static#m(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);t&&(this.#o=JSON.parse(t),console.log("[AuthController] Entity state loaded; hasEmail:",!!this.#o?.email))}catch(t){console.error("[AuthController] Error loading entity state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#o=null}this.#s=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.SCOPE);t&&(this.#a=JSON.parse(t),console.log("[AuthController] Scope state loaded (cached):",this.#a?.uiMode))}catch(t){console.error("[AuthController] Error loading scope state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE),this.#a=null}}static#c(t){try{this.#o=t,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(t)),console.log("[AuthController] Entity state saved")}catch(a){console.error("[AuthController] Error saving entity state:",a)}}static#d(){this.#o=null,this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}}static getEntity(){return this.#o}static#v(t){try{this.#a=t,localStorage.setItem(this.CONFIG.LS_KEYS.SCOPE,JSON.stringify(t))}catch(a){console.error("[AuthController] Error saving scope state:",a)}}static async fetchScope(){return typeof mvvLegit>"u"||!this.isAuthenticated()?(console.log("[AuthController] fetchScope skipped — not authenticated"),this.#a):this.#n?this.#n:(this.#n=this.#b().finally(()=>{this.#n=null}),this.#n)}static async#b(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),a=t?`?org=${encodeURIComponent(t)}`:"",n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.ME}${a}`);if(n.status===401||n.status===403)return console.warn("[AuthController] /me unauthorized — signing out"),this.doSignout(!0),null;if(!n.ok)return console.warn(`[AuthController] /me failed (${n.status}) — using cached scope`),this.#a;const o=await n.json();if(!o?.ok)return console.warn("[AuthController] /me returned not-ok — using cached scope"),this.#a;try{const s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);s&&o.activeOrg?.guid!==s&&(console.warn(`[AuthController] Stored active org not honored by /me${o.activeOrgError?" (activeOrgError)":""} — clearing`),localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG))}catch{}return this.#v(o),m.publish(g.AUTH_SCOPE_LOADED,o),console.log(`[AuthController] Scope loaded: ${o.uiMode} (${o.memberships?.length||0} org(s), ${o.managedClients?.length||0} client(s))`),o}catch(t){return console.error("[AuthController] fetchScope error:",t),this.#a}}static async setActiveOrg(t){try{t?localStorage.setItem(this.CONFIG.LS_KEYS.ACTIVE_ORG,t):localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}return this.fetchScope()}static getScope(){return this.#a}static getCapabilities(){return this.isPreviewingAsClient()?_l({orgChannel:"managed_client",memberRole:"owner"}):this.#a?.capabilities||[]}static getUiMode(){return this.isPreviewingAsClient()?"managed":this.#a?.uiMode||"self_serve"}static getActiveOrg(){return this.#a?.activeOrg||null}static getMemberships(){return this.#a?.memberships||[]}static getManagedClients(){return this.#a?.managedClients||[]}static getStoredActiveOrg(){try{return localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{return null}}static#p="m5m_preview_as_client";static isPreviewingAsClient(){try{return sessionStorage.getItem(this.#p)==="1"&&!!this.#a?.activeOrg?.viaSubtree}catch{return!1}}static setPreviewAsClient(t){try{t?sessionStorage.setItem(this.#p,"1"):sessionStorage.removeItem(this.#p)}catch{}this.#a&&m.publish(g.AUTH_SCOPE_LOADED,this.#a)}static async doSignin(t,a){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a})}),o=await n.json();if(n.status===303)return console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#c(o.entity)),setTimeout(()=>{this.#r(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o};if(n.ok&&o.accessToken){console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#c(o.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),console.log("[AuthController] Explicitly navigating to home"),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}}return{ok:!1,error:o.error||"Sign in failed",data:o}}catch(n){return console.error("[AuthController] Signin error:",n),{ok:!1,error:n.message}}}static async doPasskeySignin(){if(!window.PublicKeyCredential)return{ok:!1,error:"Passkeys are not supported in this browser"};try{const{startAuthentication:t}=await W(async()=>{const{startAuthentication:i}=await Promise.resolve().then(()=>Os);return{startAuthentication:i}},void 0,import.meta.url),a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_OPTIONS}`,{method:"POST"}),n=await a.json();if(!a.ok||!n.ok)return{ok:!1,error:n.error||"Could not start passkey sign-in"};let o;try{o=await t({optionsJSON:n.options})}catch(i){const l=i?.name==="NotAllowedError";return l||console.error("[AuthController] Passkey ceremony error:",i),{ok:!1,canceled:l,error:l?"Passkey sign-in was canceled":i.message||"Passkey sign-in failed"}}const s=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_VERIFY}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o})}),r=await s.json();if(!s.ok||!r.ok||!r.accessToken)return{ok:!1,error:r.error||"Passkey sign-in failed",data:r};mvvLegit.doSignin(r.accessToken),this.#c(r.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:r}}catch(t){return console.error("[AuthController] Passkey signin error:",t),{ok:!1,error:t.message}}}static async doSignout(t=!1){console.log("[AuthController] doSignout called, serverInitiated:",t);try{const a=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!a),!t&&a){const n=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(a)}`;if(console.log("[AuthController] Sending signout beacon to:",n),navigator.sendBeacon){const o=navigator.sendBeacon(n);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else a||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#d(),console.log("[AuthController] Stopping auth ping..."),this.#h(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(a){console.error("[AuthController] Signout error:",a),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(t){try{const a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await a.json();return a.ok&&n.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#c(n.entity),{ok:!0,data:n}):{ok:!1,error:n.error||"Sign up failed",data:n}}catch(a){return console.error("[AuthController] Signup error:",a),{ok:!1,error:a.message}}}static async doResetHash(t,a){try{const n=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a,modified_by:t})}),s=await o.json();return o.ok&&s.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:s}):{ok:!1,error:s.error||"Password reset failed",data:s}}catch(n){return console.error("[AuthController] Reset password error:",n),{ok:!1,error:n.message}}}static#g(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#f()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#h(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#f(){try{const t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);t.ok?console.log("[AuthController] Ping success"):(t.status===401||t.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(t){console.error("[AuthController] Ping error:",t)}}static setDeepLinkGuid(t){this.#s=t,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,t),console.log("[AuthController] Deep-link GUID stored:",t)}static getDeepLinkGuid(){return this.#s}static clearDeepLink(){this.#s=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#_(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),queueMicrotask(()=>this.fetchScope())}static#y(){console.log("[AuthController] User unauthenticated"),this.#h()}static#w(){console.log("[AuthController] User unverified")}static getAuthState(){try{const t=mvvLegit.getConf()?.LSKEY||"mvv",a=localStorage.getItem(t);if(!a)return"UNAUTH";if(typeof LZString>"u")return null;const n=LZString.decompressFromUTF16(a),s=JSON.parse(n)?.state;return s===1?"UNAUTH":s===2?"UNVERF":s===4?"AUTH":s===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(t){this.#r(t)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#f()}}class L{static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",remember_email:"Remember my email",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_dashboard:"Dashboard",nav_dashboard_tagline:"Overview of your activity",nav_magnets:"Your Magnets",nav_magnets_tagline:"Manage your conversational magnets",nav_templates:"Templates",nav_templates_tagline:"Start from a magnet template",nav_conversations:"Conversations",nav_conversations_tagline:"Captured lead conversations",nav_ab_testing:"A/B Testing",nav_ab_testing_tagline:"Experiment and optimize",nav_analytics:"Analytics",nav_analytics_tagline:"Performance and ad metrics",nav_ad_accounts:"Ad Accounts",nav_ad_accounts_tagline:"Connect advertising accounts",nav_clients:"Clients",nav_clients_tagline:"Manage your client accounts",nav_team:"Team",nav_team_tagline:"Invite and manage teammates",nav_billing:"Billing",nav_billing_tagline:"Plan, usage, and invoices",nav_settings:"Settings",nav_settings_tagline:"Account and workspace settings",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Rollers",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",remember_email:"Recordar mi correo electrónico",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Rollers",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",remember_email:"记住我的邮箱",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"滚动器",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:t,product:a,whitelabel:n,lang:o}){t&&(this.#t.buildMode=t),a&&(this.#t.product=a),n&&(this.#t.whitelabel=n),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{let l=this.#e[o]?.[s]?.[r]?.[i]?.[t],c=o;return!l&&o!=="LOCAL"&&(l=this.#e.LOCAL?.[s]?.[r]?.[i]?.[t],c="LOCAL (fallback)"),l?(c==="LOCAL (fallback)"&&console.warn(`[MicrocopyManager] Token '${t}' missing from ${o} — served from LOCAL instead. Backfill ${o}'s block if this is intentionally different copy.`),Array.isArray(l)?l[Math.floor(Math.random()*l.length)]:l):(console.warn(`[MicrocopyManager] Token not found: ${t} (${o}/${s}/${r}/${i}, LOCAL fallback also missing it)`),null)}catch(l){return console.error(`[MicrocopyManager] Error retrieving token: ${t}`,l),null}}static getAll(t={}){const a={...this.#t,...t},{buildMode:n,product:o,whitelabel:s,lang:r}=a;try{return this.#e[n]?.[o]?.[s]?.[r]||null}catch(i){return console.error("[MicrocopyManager] Error retrieving all tokens",i),null}}static has(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return!!this.#e[o]?.[s]?.[r]?.[i]?.[t]}catch{return!1}}static getAvailableLanguages(){const{buildMode:t,product:a,whitelabel:n}=this.#t;try{return Object.keys(this.#e[t]?.[a]?.[n]||{})}catch{return[]}}static update(t,a,n={}){const o={...this.#t,...n},{buildMode:s,product:r,whitelabel:i,lang:l}=o;try{return this.#e[s]||(this.#e[s]={}),this.#e[s][r]||(this.#e[s][r]={}),this.#e[s][r][i]||(this.#e[s][r][i]={}),this.#e[s][r][i][l]||(this.#e[s][r][i][l]={}),this.#e[s][r][i][l][t]=a,!0}catch(c){return console.error(`[MicrocopyManager] Error updating token: ${t}`,c),!1}}static delete(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return delete this.#e[o]?.[s]?.[r]?.[i]?.[t],!0}catch(l){return console.error(`[MicrocopyManager] Error deleting token: ${t}`,l),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(t){try{return this.#e=t,!0}catch(a){return console.error("[MicrocopyManager] Error importing data",a),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:L});class Ce{static#e=!1;static#t=null;static#o=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const t=this.#n();L.setContext(t),console.log("[I18nController] Initialized with context:",t),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#s(),this.#u(),this.#e=!0,this.refresh()}static#a(t){const a={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},n=t.toLowerCase();return a[n]||"DEV"}static#n(){const a=this.#a("production"),n=localStorage.getItem(H.FF_SSE_LS_WHITELABEL)||H.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(H.FF_SSE_LS_USER_LANG)||H.FF_SSE_I18N_LANG;return{buildMode:a,product:H.FF_SSE_I18N_PRODUCT,whitelabel:n,lang:o}}static#s(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((t,a,n)=>{H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",n),this.#t=n,setTimeout(()=>{this.refresh()},H.FF_SSE_I18N_APPLY_DELAY_MS)},H.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#i())}static#i(){setInterval(()=>{const a=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");a&&a!==this.#t&&(this.#t=a,this.refresh())},500)}static#u(){this.#o||(this.#o=new MutationObserver(t=>{let a=!1;for(const n of t){for(const o of n.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){a=!0;break}if(a)break}a&&(H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#o.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#r(document.body),this.#l(document.body),H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#r(t){const a=t.querySelectorAll("[data-meta-copywrite-i118n]");H.FF_SSE_I18N_DEBUG&&a.length>0&&console.log(`[I18nController] Processing ${a.length} elements`),a.forEach(n=>{try{const o=n.getAttribute("data-meta-copywrite-i118n"),s=JSON.parse(o);if(!s.token){console.warn("[I18nController] Missing token in config:",s);return}const r=s.attribute||"textContent",i=L.get(s.token);if(i===null){console.warn(`[I18nController] Microcopy not found for token: ${s.token}`);return}r==="textContent"?n.textContent=i:r==="innerHTML"?n.innerHTML=i:n.setAttribute(r,i),H.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${i}" to ${r} for token: ${s.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,n)}})}static#l(t){t.querySelectorAll("*").forEach(n=>{n.shadowRoot&&(this.#r(n.shadowRoot),this.#l(n.shadowRoot))})}static setLanguage(t){const a=L.getAvailableLanguages();if(!a.includes(t)){console.error(`[I18nController] Language not available: ${t}. Available:`,a);return}localStorage.setItem(H.FF_SSE_LS_USER_LANG,t),L.setContext({lang:t}),console.log("[I18nController] Language changed to:",t);const n=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:t}});document.dispatchEvent(n),this.refresh()}static setWhitelabel(t){localStorage.setItem(H.FF_SSE_LS_WHITELABEL,t),L.setContext({whitelabel:t}),H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",t),this.refresh()}static getLanguage(){return L.getContext().lang}static getAvailableLanguages(){return L.getAvailableLanguages()}static getContext(){return L.getContext()}static destroy(){this.#o&&(this.#o.disconnect(),this.#o=null),this.#e=!1,this.#t=null,H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{Ce.initialize()}):Ce.initialize());class An{static _initialized=!1;static _debug=!1;static init(t={}){if(this._initialized)return console.warn("[MachVive] Already initialized, skipping duplicate initialization"),this;if(this._debug=t.debug||!1,!window.mvvSSEther)return console.error("[MachVive] mvvSSEther not found - cannot initialize bridge"),console.error("[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()"),this;console.log("[MachVive] Initializing SSE to PubSub bridge...");const a=n=>{this._handleSSEMessage(n)};return window.mvvSSEther.onmessage(a),this._initialized=!0,console.log("[MachVive] ✓ SSE to PubSub bridge initialized successfully"),console.log("[MachVive] ✓ Bound callback to mvvSSEther.onmessage"),this}static _handleSSEMessage(t){try{this._debug&&console.log("[MachVive] SSE message received:",t);const a=t?.data;if(!a){this._debug&&console.log("[MachVive] No data in message, skipping");return}const n=a.data||a.package||a;if(!n){this._debug&&console.log("[MachVive] No package found in message, skipping");return}let o=n.cfg;const s=n.msg;if(this._debug&&(console.log("[MachVive] cfg (raw):",o,"type:",typeof o,"length:",o?.length),console.log("[MachVive] msg (raw):",s)),typeof o=="string"){if(o.trim()===""){this._debug&&console.log("[MachVive] cfg is empty string, skipping");return}try{o=JSON.parse(o),console.log("[MachVive] cfg (parsed):",o)}catch(i){console.warn("[MachVive] Failed to parse cfg as JSON:",{cfg:o,cfgLength:o.length,error:i.message});return}}else if(!o){this._debug&&console.log("[MachVive] cfg is empty/null, skipping");return}const r=o?.topic;if(!r){this._debug&&console.log("[MachVive] No topic found in cfg, skipping");return}if(console.log("[MachVive] Extracted topic:",r),!this._isValidTopic(r)){console.warn(`[MachVive] Topic '${r}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(r,s,t,a)}catch(a){console.error("[MachVive] Error handling SSE message:",a)}}static _isValidTopic(t){return!g||!g.hasOwnProperty(t)?(console.warn(`[MachVive] Topic '${t}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(t,a,n,o){try{if(!window.PubSub&&typeof PubSub>"u"){console.error("[MachVive] PubSub not available");return}const s=window.PubSub||PubSub,r={message:a,metadata:{source:"sse",sseEventId:n.id,timestamp:n.timestamp,appGuid:o.app_guid,channelGuid:o.channel_guid,eventAction:o.event_action,status:o.status,class:o.class,raw:o}};console.log(`[MachVive] Publishing to topic '${t}':`,r);const i=g[t];console.log(`[MachVive] AppBroadcast.${t} = '${i}'`),s.publish(i,r),console.log(`[MachVive] ✓ Published SSE message to topic: ${t}`)}catch(s){console.error(`[MachVive] Error publishing to topic '${t}':`,s)}}static debug(t){return this._debug=t,console.log(`[MachVive] Debug mode ${t?"enabled":"disabled"}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log("[MachVive] Reset complete"),this}}typeof module<"u"&&module.exports&&(module.exports=An);typeof window<"u"&&(window.MachVive=An);const eo="m5t_sidenav_collapsed",Al={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};class Sl extends HTMLElement{static get observedAttributes(){return["data-active-token","data-collapsed"]}constructor(){super(),this.attachShadow({mode:"open"}),this.items=[],this.orgs=[],this.activeOrgGuid=null,this.activeToken=null,this.footerBadge=null,this.loading=!1,this.lastFocus=null}#e=null;#t=t=>{if(this.getAttribute("data-open")==="true"){if(t.key==="Escape"){t.preventDefault(),this.closeDrawer();return}if(t.key==="Tab"){const a=this.#c();if(a.length<2)return;const n=a[0],o=a[a.length-1],s=this.shadowRoot.activeElement;t.shiftKey&&s===n?(t.preventDefault(),o.focus()):!t.shiftKey&&s===o&&(t.preventDefault(),n.focus())}}};#o=()=>{this.closeDrawer(),this.#d()};connectedCallback(){if(!this.hasAttribute("data-collapsed"))try{localStorage.getItem(eo)==="true"&&this.setAttribute("data-collapsed","true")}catch{}this.activeToken=this.getAttribute("data-active-token")||null,this.render(),this.#l(),this.addEventListener("keydown",this.#t),this.#e=window.matchMedia("(max-width: 768px)"),this.#e.addEventListener("change",this.#o),this.#d()}disconnectedCallback(){this.removeEventListener("keydown",this.#t),this.#e?.removeEventListener("change",this.#o)}attributeChangedCallback(t,a,n){a===n||!this.shadowRoot||(t==="data-active-token"?(this.activeToken=n,this.#m()):t==="data-collapsed"&&this.shadowRoot.firstChild&&(this.render(),this.#l()))}setState({buttons:t,orgs:a,activeOrg:n,footerBadge:o,loading:s}={}){t!==void 0&&(this.items=Array.isArray(t)?t:this.#a(t)||[]),a!==void 0&&(this.orgs=Array.isArray(a)?a:this.#a(a)||[]),n!==void 0&&(this.activeOrgGuid=n||null),o!==void 0&&(this.footerBadge=o||null),s!==void 0&&(this.loading=!!s),this.shadowRoot&&(this.render(),this.#l())}setButtons(t){this.setState({buttons:t})}setOrgs(t){this.setState({orgs:t})}setActiveOrgGuid(t){this.setState({activeOrg:t})}setFooterBadge(t){this.setState({footerBadge:t})}setActiveToken(t){this.activeToken=t||null,this.#m()}toggleCollapsed(t){const a=typeof t=="boolean"?t:this.getAttribute("data-collapsed")!=="true";this.setAttribute("data-collapsed",String(a));try{localStorage.setItem(eo,String(a))}catch{}this.dispatchEvent(new CustomEvent("nav-collapse",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_SIDE_NAV.COLLAPSE",collapsed:a,timestamp:Date.now()}}))}openDrawer(){this.lastFocus=this.shadowRoot.activeElement||document.activeElement,this.setAttribute("data-open","true"),this.shadowRoot.querySelector(".hamburger")?.setAttribute("aria-expanded","true"),this.#d(),(this.#c()[0]||this.shadowRoot.querySelector(".sidenav"))?.focus?.()}closeDrawer(){if(this.getAttribute("data-open")!=="true")return;this.removeAttribute("data-open");const t=this.shadowRoot.querySelector(".hamburger");t?.setAttribute("aria-expanded","false"),this.#d(),t&&this.#e?.matches?t.focus():this.lastFocus?.focus?.()}toggleDrawer(){this.getAttribute("data-open")==="true"?this.closeDrawer():this.openDrawer()}#a(t){try{return t?JSON.parse(t):null}catch(a){return console.error("[M5TSideNav] bad JSON:",a),null}}#n(t){return String(t??"").replace(/[&<>"']/g,a=>Al[a])}#s(t){return t?`<span class="ms" aria-hidden="true">${this.#n(t)}</span>`:""}#i(t){if(!t||!t.token)return"";const a=t.token===this.activeToken,n=t.route||"#",o=n.startsWith("#")?n:`#${n}`,s=typeof t.count=="number"&&t.count>0?`<span class="badge">${t.count}</span>`:"";return`
  ...
  </div>`}const Rl='<div class="m5t-notif-skel"><span></span><span></span><span></span></div>'.repeat(3),za=e=>e.dataset.open==="true",en=(e,t)=>{e.dataset.open=t?"true":"false"};function Nl(e){const t=document.getElementById("m5t-notif-bell");if(t&&(t.hidden=!e),!e){const a=document.getElementById("m5t-notif-panel");a&&en(a,!1)}}const Ol=14;let Ga=null;function Ml(e){if(typeof ResizeObserver>"u"||!e)return;const t=document.getElementById("m5t-notif-bell"),a=document.getElementById("m5t-notif-bell-btn");if(!t||!a)return;const n=()=>{const o=e.hidden?null:e.querySelector(".ocb-btn");if(o){const s=o.getBoundingClientRect(),r=a.getBoundingClientRect().height;t.style.top=`${Math.round(s.top+(s.height-r)/2)}px`}else t.style.top=`${Ol}px`};Ga?.disconnect(),Ga=new ResizeObserver(n),Ga.observe(e),n()}let to=null;function Pl(){const e=document.getElementById("m5t-notif-bell-btn"),t=document.getElementById("m5t-notif-badge"),a=document.getElementById("m5t-notif-panel");if(!e||!t||!a)return;const n=d=>{t.textContent=d>99?"99+":String(d),t.hidden=!d},o=async()=>{try{const d=await fetch(`${bt()}/m5t/v5/notifications/unread-count`),f=await d.json().catch(()=>({}));d.ok&&f.ok&&n(f.count||0)}catch{}},s=(d="")=>`<div class="m5t-notif-head">Notifications${d?`<span class="m5t-notif-head__actions">${d}</span>`:""}</div>`,r=()=>{a.querySelectorAll(".m5t-notif-item, .m5t-notif-empty").forEach(d=>d.remove()),a.querySelector(".m5t-notif-head__actions")?.remove(),a.insertAdjacentHTML("beforeend",'<div class="m5t-notif-empty">You’re all caught up.</div>')},i=async()=>{a.innerHTML=s()+Rl;try{const d=await fetch(`${bt()}/m5t/v5/notifications`),f=await d.json().catch(()=>({}));if(!d.ok||!f.ok)throw new Error;const v=f.notifications||[],h=[v.some(u=>!u.read)?'<button class="m5t-notif-markall" type="button">Mark all read</button>':"",v.length?'<button class="m5t-notif-clearall" type="button">Clear all</button>':""].join("");a.innerHTML=s(h)+(v.length?v.map(Il).join(""):'<div class="m5t-notif-empty">You’re all caught up.</div>')}catch{a.innerHTML=s()+'<div class="m5t-notif-empty">Could not load. Try again.</div>'}},l=()=>{en(a,!1),e.setAttribute("aria-expanded","false")},c=async()=>{en(a,!0),e.setAttribute("aria-expanded","true"),await i()};e.addEventListener("click",d=>{d.stopPropagation(),za(a)?l():c()}),document.addEventListener("click",d=>{za(a)&&!a.contains(d.target)&&d.target!==e&&l()}),document.addEventListener("keydown",d=>{d.key==="Escape"&&za(a)&&(l(),e.focus())}),a.addEventListener("click",async d=>{const f=d.target.closest("[data-dismiss]");if(f){d.preventDefault(),d.stopPropagation();const p=f.closest(".m5t-notif-item"),b=f.dataset.dismiss,y=p?.dataset.read==="false";p?.setAttribute("data-leaving","true");try{await fetch(`${bt()}/m5t/v5/notifications/${encodeURIComponent(b)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:"DISMISSED"})})}catch{}setTimeout(()=>{p?.remove(),a.querySelector(".m5t-notif-item")||r()},180),y&&o();return}const v=d.target.closest(".m5t-notif-clearall");if(v){d.preventDefault(),v.disabled=!0,a.querySelectorAll(".m5t-notif-item").forEach(p=>p.setAttribute("data-leaving","true"));try{await fetch(`${bt()}/m5t/v5/notifications/dismiss-all`,{method:"PATCH"})}catch{}setTimeout(r,180),o();return}const h=d.target.closest(".m5t-notif-item");if(h&&h.dataset.read==="false"){const p=h.dataset.guid;h.dataset.read="true";try{await fetch(`${bt()}/m5t/v5/notifications/${encodeURIComponent(p)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({read:!0})}),o()}catch{}return}const u=d.target.closest(".m5t-notif-markall");if(u){d.preventDefault(),a.querySelectorAll(".m5t-notif-item").forEach(p=>{p.dataset.read="true"}),u.remove();try{await fetch(`${bt()}/m5t/v5/notifications/read-all`,{method:"PATCH"})}catch{}o()}}),o(),clearInterval(to),to=setInterval(o,$l)}function Sa(){return xn("FF_SSE_UI_DARK_MODE")}function Fl(e=Sa()){return e&&localStorage.getItem(H.FF_SSE_LS_THEME)==="dark"?"dark":"light"}function Dl(e=xn("FF_SSE_UI_ANIMATIONS")){return!e}function Bl(e,t=Sa()){!e||t||e.shadowRoot?.querySelector('.footer-action[data-action="theme"]')?.remove()}function Es(e){document.documentElement.setAttribute("data-theme",e)}function Ul(){Es(Fl())}function qt(){return document.documentElement.getAttribute("data-theme")==="dark"?"dark":"light"}function ks(e,{quiet:t=!1}={}){if(!Sa())return;const a=e==="dark"?"dark":"light";a!==qt()&&(Es(a),localStorage.setItem(H.FF_SSE_LS_THEME,a),t||m.publish(g.UI_TOAST,{message:a==="dark"?"Dark mode on":"Dark mode off",type:"info"}),m.publish(g.UI_THEME_CHANGED,{theme:a}))}function Hl(){ks(qt()==="dark"?"light":"dark")}window.m5t=Object.create(null);window.m5t.pubsub=m;console.log("StreamSyncEngage SaaS Client - Starting...");console.log("Environment:","production");console.log("Document readyState:",document.readyState);console.log("window.mvvLegit:",typeof window.mvvLegit);console.log("globalThis.mvvLegit:",typeof globalThis.mvvLegit);try{console.log("mvvLegit (direct):",typeof mvvLegit)}catch(e){console.log("mvvLegit (direct): ReferenceError -",e.message)}const ql=Object.keys(window).filter(e=>e.toLowerCase().includes("mvv")||e.toLowerCase().includes("neodigm")||e.toLowerCase().includes("legit"));console.log("Possible Neodigm globals:",ql);const P=new Xi("/",{hash:!0});window.router=P;function ce(e){const t=e?`${e.replace(/-/g,"_")}_route`:"splash_route";return console.log(`[Router] Checking access: ${e} -> ${t}`),mvvLegit.isRouteAllowed(t)?!0:(console.warn(`[Router] Access denied to route: ${t}`),m.publish(g.UI_TOAST,{message:"Please sign in to access this page",type:"warning"}),!1)}function ne(e){console.log("[Router] Navigating to:",e),P.navigate(`/${e}`)}const Sn=new Set(["splash","signin","signup","forgot","resethash","verf-link","accept-invite","signout"]);let Dt={},tn={},dt=null;const zl={admin:{caption:"Platform Admin",icon:"shield_person"},reseller:{caption:"Reseller",icon:"handshake"},managed:{caption:"Managed",icon:"visibility"},self_serve:{caption:"Self-Serve",icon:"rocket_launch"}},an="__portfolio__";function As(){try{P._setCurrent(null)}catch{}P.resolve()}function ja(){const e=document.getElementById("m5t-side-nav");if(!e)return;const t=!x.getScope()&&x.isAuthenticated(),a=x.getCapabilities(),n=x.getUiMode(),o=Aa.getSideNav(a,{uiMode:n});Dt={},tn={};const s=v=>{v.route&&(Dt[v.route]={sectionToken:v.token,childToken:null,children:v.children||null},Array.isArray(v.children)&&v.children.forEach(h=>{h.route&&(tn[h.token]=h.route,Dt[h.route]={sectionToken:v.token,childToken:h.token,children:v.children})}))},r=v=>v.forEach(h=>{h.group&&Array.isArray(h.items)?r(h.items):s(h)});r(o);const i=x.getMemberships(),l=x.getActiveOrg(),c=x.getManagedClients(),d=x.getStoredActiveOrg(),f=c.length?[{guid:an,name:"Portfolio (all clients)"},...i.map(v=>({guid:v.orgGuid,name:v.name||v.channel,channel:v.channel,group:"Your organization"})),...c.map(v=>({guid:v.orgGuid,name:v.name||v.orgGuid,channel:v.channel,group:"Clients"}))]:i.map(v=>({guid:v.orgGuid,name:v.name||v.channel,channel:v.channel}));e.setState({buttons:o,orgs:f,activeOrg:c.length?d||an:l?.guid||null,footerBadge:zl[n]||null,loading:t}),Ss(),dt&&Ts(dt)}const Gl=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]);function Ss(){const e=document.getElementById("app-content");if(!e)return;let t=document.getElementById("org-context-banner");t||(t=document.createElement("div"),t.id="org-context-banner",e.insertBefore(t,e.firstChild),Ml(t));const a=x.getActiveOrg(),n=x.isPreviewingAsClient(),o=!!a?.viaSubtree&&!!dt&&!Sn.has(dt);if(t.hidden=!o,!o){t.innerHTML="";return}const s=Gl(a.name||"Client");t.innerHTML=`
    <style>
    ...
    <div class="ocb" role="status">
    ...
    </div>`,t.querySelector('[data-ocb="preview"]')?.addEventListener("click",()=>{x.setPreviewAsClient(!x.isPreviewingAsClient()),As()}),t.querySelector('[data-ocb="portfolio"]')?.addEventListener("click",()=>{x.setPreviewAsClient(!1),x.setActiveOrg(null)})}function Ts(e){const t=document.getElementById("m5t-side-nav"),a=Dt[`/${e}`]||Dt[e]||null;t?.setActiveToken(a?.sectionToken||null),jl(a)}function jl(e){const t=document.getElementById("m5t-sub-nav"),a=document.getElementById("app-shell");if(!t)return;const n=e?.children;t.hidden=!1,n&&n.length>1?(t.updateButtons(n.map(o=>({token:o.token,caption:o.caption,enabled:!0,selected:o.token===e.childToken}))),a?.classList.add("has-sub-nav")):(t.updateButtons([]),a?.classList.remove("has-sub-nav"))}function Vl(){const e=Ce.getAvailableLanguages&&Ce.getAvailableLanguages()||[];if(e.length<2){m.publish(g.UI_TOAST,{message:"Only one language is available",type:"info"});return}const t=localStorage.getItem(H.FF_SSE_LS_USER_LANG)||H.FF_SSE_I18N_LANG||e[0],a=e[(e.indexOf(t)+1)%e.length];Ce.setLanguage(a),m.publish(g.UI_TOAST,{message:`Language: ${a}`,type:"info"})}function Wl(){document.documentElement.classList.toggle("ff-no-animations",Dl())}function Yl(){const e=document.getElementById("m5t-side-nav");if(!e)return;Aa.setAppToken("client-saas"),Bl(e),document.getElementById("app-shell")?.classList.toggle("nav-collapsed",e.getAttribute("data-collapsed")==="true"),e.addEventListener("nav-select",o=>{const s=o.detail?.route;s&&P.navigate(s.startsWith("/")?s:`/${s}`)}),e.addEventListener("logo-click",()=>P.navigate("/home")),e.addEventListener("nav-collapse",o=>{document.getElementById("app-shell")?.classList.toggle("nav-collapsed",!!o.detail?.collapsed)}),e.addEventListener("org-switch",o=>{const s=o.detail?.orgGuid;s&&x.setActiveOrg(s===an?null:s)}),e.addEventListener("footer-action",o=>{switch(o.detail?.action){case"account":P.navigate("/settings");break;case"signout":P.navigate("/signout");break;case"lang":Vl();break;case"theme":Hl();break}}),document.getElementById("m5t-sub-nav")?.addEventListener("nav-select",o=>{const s=tn[o.detail?.token];s&&P.navigate(s)}),document.addEventListener("language-changed",()=>ja()),ja(),m.subscribe(g.AUTH_SCOPE_LOADED,()=>ja());const a=()=>{const o=x.getScope();return[o?.uiMode,o?.activeOrg?.guid,(o?.managedClients||[]).length,(o?.capabilities||[]).join(","),x.getStoredActiveOrg()].join("|")};let n=a();m.subscribe(g.AUTH_SCOPE_LOADED,()=>{const o=a();o!==n&&(n=o,dt&&!Sn.has(dt)&&As())})}function Jl(e){dt=e;const t=document.getElementById("m5t-side-nav"),a=document.getElementById("app-shell");if(!t||!a)return;const n=!Sn.has(e);if(t.hidden=!n,a.classList.toggle("has-side-nav",n),Nl(n),n)Ts(e);else{const o=document.getElementById("m5t-sub-nav");o&&(o.hidden=!0),a.classList.remove("has-sub-nav")}Ss()}m.subscribe(g.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&Jl(t.route)});const Cs=()=>{console.log("[Router] Route: splash"),m.publish(g.ROUTE_NAV_BEFORE,{route:"splash"});const e=ws(),t=!e&&pl();(e?W(()=>Promise.resolve().then(()=>lc),void 0,import.meta.url):t?W(()=>Promise.resolve().then(()=>uc),void 0,import.meta.url):W(()=>Promise.resolve().then(()=>hc),void 0,import.meta.url)).then(n=>{const o=document.getElementById("app");o.innerHTML=n.render(),n.init&&n.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"splash"})}).catch(n=>{console.error("[Router] Error loading splash route:",n),m.publish(g.ROUTE_NAV_ERROR,{route:"splash",error:n})})};P.on("/",Cs);P.on("/splash",Cs);P.on("/signin",()=>{console.log("[Router] Route: /signin"),m.publish(g.ROUTE_NAV_BEFORE,{route:"signin"}),W(()=>Promise.resolve().then(()=>xc),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"signin"})}).catch(e=>{console.error("[Router] Error loading signin route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"signin",error:e})})});P.on("/signup",()=>{console.log("[Router] Route: /signup"),m.publish(g.ROUTE_NAV_BEFORE,{route:"signup"}),W(()=>Promise.resolve().then(()=>Cc),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"signup"})}).catch(e=>{console.error("[Router] Error loading signup route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"signup",error:e})})});P.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),m.publish(g.ROUTE_NAV_BEFORE,{route:"verf-link"}),W(()=>Promise.resolve().then(()=>Ic),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(e=>{console.error("[Router] Error loading verf-link route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"verf-link",error:e})})});P.on("/forgot",()=>{console.log("[Router] Route: /forgot"),m.publish(g.ROUTE_NAV_BEFORE,{route:"forgot"}),W(()=>Promise.resolve().then(()=>Dc),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(e=>{console.error("[Router] Error loading forgot route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"forgot",error:e})})});P.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!ce("resethash")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"resethash"}),W(()=>Promise.resolve().then(()=>Hc),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(e=>{console.error("[Router] Error loading resethash route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"resethash",error:e})})});P.on("/home",()=>{if(console.log("[Router] Route: /home"),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"home"}),W(()=>Promise.resolve().then(()=>ad),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"home"})}).catch(e=>{console.error("[Router] Error loading home route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"home",error:e})})});P.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!ce("signout")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"signout"}),W(()=>Promise.resolve().then(()=>sd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"signout"})}).catch(e=>{console.error("[Router] Error loading signout route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"signout",error:e})})});const Kl=[{path:"/analytics",name:"analytics",title:"Analytics",icon:"monitoring"},{path:"/billing",name:"billing",title:"Billing",icon:"receipt_long"},{path:"/magnets/drafts",name:"magnets/drafts",title:"Magnets · Drafts",icon:"widgets"},{path:"/magnets/archived",name:"magnets/archived",title:"Magnets · Archived",icon:"widgets"},{path:"/analytics/conversions",name:"analytics/conversions",title:"Analytics · Conversions",icon:"monitoring"}];Kl.forEach(({path:e,name:t,title:a,icon:n})=>{P.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:t}),W(()=>Promise.resolve().then(()=>ld),void 0,import.meta.url).then(o=>{const s=document.getElementById("app");s.innerHTML=o.render({title:a,icon:n,name:t}),o.init&&o.init({name:t}),m.publish(g.ROUTE_NAV_AFTER,{route:t})}).catch(o=>{console.error(`[Router] Error loading section route (${t}):`,o),m.publish(g.ROUTE_NAV_ERROR,{route:t,error:o})})})});P.on("/settings",()=>{if(console.log("[Router] Route: /settings"),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"settings"}),W(()=>Promise.resolve().then(()=>yd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"settings"})}).catch(e=>{console.error("[Router] Error loading settings-general route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"settings",error:e})})});P.on("/settings/workspace",()=>{if(console.log("[Router] Route: /settings/workspace"),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"settings/workspace"}),W(()=>Promise.resolve().then(()=>Nd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"settings/workspace"})}).catch(e=>{console.error("[Router] Error loading settings-workspace route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"settings/workspace",error:e})})});P.on("/settings/notifications",()=>{if(console.log("[Router] Route: /settings/notifications"),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"settings/notifications"}),W(()=>Promise.resolve().then(()=>Hd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"settings/notifications"})}).catch(e=>{console.error("[Router] Error loading settings-notifications route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"settings/notifications",error:e})})});P.on("/settings/integrations",()=>{if(console.log("[Router] Route: /settings/integrations"),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),W(()=>Promise.resolve().then(()=>pp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(e=>{console.error("[Router] Error loading settings-integrations route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"settings/integrations",error:e})})});P.on("/settings/integrations/:provider",e=>{const t=e?.data?.provider||"";if(console.log("[Router] Route: /settings/integrations/"+t),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),W(()=>Promise.resolve().then(()=>kp),void 0,import.meta.url).then(a=>{const n=document.getElementById("app");n.innerHTML=a.render({provider:t}),a.init&&a.init({provider:t}),m.publish(g.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(a=>{console.error("[Router] Error loading integration detail route:",a),m.publish(g.ROUTE_NAV_ERROR,{route:"settings/integrations",error:a})})});P.on("/settings/security",()=>{if(console.log("[Router] Route: /settings/security"),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"settings/security"}),W(()=>Promise.resolve().then(()=>Mp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"settings/security"})}).catch(e=>{console.error("[Router] Error loading settings-security route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"settings/security",error:e})})});P.on("/conversations",()=>{if(console.log("[Router] Route: /conversations"),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"conversations"}),W(()=>Promise.resolve().then(()=>jp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"conversations"})}).catch(e=>{console.error("[Router] Error loading conversations route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"conversations",error:e})})});P.on("/ab-testing",()=>{if(console.log("[Router] Route: /ab-testing"),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"ab-testing"}),W(()=>Promise.resolve().then(()=>su),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"ab-testing"})}).catch(e=>{console.error("[Router] Error loading ab-testing route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"ab-testing",error:e})})});P.on("/magnets",()=>{if(console.log("[Router] Route: /magnets"),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"magnets"}),W(()=>Promise.resolve().then(()=>pm),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"magnets"})}).catch(e=>{console.error("[Router] Error loading magnets route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"magnets",error:e})})});P.on("/templates",()=>{if(console.log("[Router] Route: /templates"),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"templates"}),W(()=>Promise.resolve().then(()=>bm),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"templates"})}).catch(e=>{console.error("[Router] Error loading templates route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"templates",error:e})})});P.on("/leads",()=>{if(console.log("[Router] Route: /leads"),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"leads"}),W(()=>Promise.resolve().then(()=>Om),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"leads"})}).catch(e=>{console.error("[Router] Error loading leads route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"leads",error:e})})});P.on("/analytics/ad-performance",()=>{if(console.log("[Router] Route: /analytics/ad-performance"),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"analytics/ad-performance"}),W(()=>Promise.resolve().then(()=>zm),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"analytics/ad-performance"})}).catch(e=>{console.error("[Router] Error loading ad-performance route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"analytics/ad-performance",error:e})})});P.on("/ad-accounts",()=>{if(console.log("[Router] Route: /ad-accounts"),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"ad-accounts"}),W(()=>Promise.resolve().then(()=>eg),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"ad-accounts"})}).catch(e=>{console.error("[Router] Error loading ad-accounts route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"ad-accounts",error:e})})});P.on("/clients",()=>{if(console.log("[Router] Route: /clients"),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"clients"}),W(()=>Promise.resolve().then(()=>ug),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"clients"})}).catch(e=>{console.error("[Router] Error loading clients route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"clients",error:e})})});P.on("/team",()=>{if(console.log("[Router] Route: /team"),!ce("home")){ne("signin");return}m.publish(g.ROUTE_NAV_BEFORE,{route:"team"}),W(()=>Promise.resolve().then(()=>wg),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),m.publish(g.ROUTE_NAV_AFTER,{route:"team"})}).catch(e=>{console.error("[Router] Error loading team route:",e),m.publish(g.ROUTE_NAV_ERROR,{route:"team",error:e})})});P.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),ne("splash")});m.subscribe(g.ROUTE_NAV,(e,t)=>{console.log("[Router] ROUTE_NAV event received:",t),t?.route&&ne(t.route)});function ao(){console.log("[App] Waiting for Neodigm 55 library...");let e=0;const t=100,a=setInterval(()=>{e++,e%10===0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(a),Ql()):e>=t&&(clearInterval(a),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
      ...
      `,m.publish(g.APP_ERROR,{message:"Failed to load authentication library"}))},100)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ao):ao();async function Ql(){if(console.log("[App] Neodigm 55 loaded, initializing..."),Ul(),Wl(),dl(),Ce.initialize(),console.log("[App] I18n Controller initialized"),!await x.init({BASE_URL:"https://machfivemagnet-saas.onrender.com",navigateFunction:a=>{console.log("[AuthController] Navigation requested:",a),ne(a)}})){console.error("[App] AuthController initialization failed");return}const t=x.getEntity();t&&(console.log("[App] Session restored for:",t.email),m.publish(g.APP_USER_LOADED,{entity:t}),x.isAuthenticated()&&(localStorage.getItem(x.CONFIG.LS_KEYS.ACTIVE_ORG)?await x.fetchScope():x.fetchScope())),m.publish(g.APP_READY,{timestamp:new Date().toISOString(),sessionUser:t}),Yl(),Pl(),P.resolve(),window.AuthController=x,window.I18nController=Ce,window.MachVive=An,console.log("[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)")}m.subscribe(g.ROUTE_NAV_AFTER,(e,t)=>{typeof Ce<"u"&&Ce.refresh&&setTimeout(()=>{Ce.refresh()},100)});function Re(e){const t=new Uint8Array(e);let a="";for(const o of t)a+=String.fromCharCode(o);return btoa(a).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"")}function zt(e){const t=e.replace(/-/g,"+").replace(/_/g,"/"),a=(4-t.length%4)%4,n=t.padEnd(t.length+a,"="),o=atob(n),s=new ArrayBuffer(o.length),r=new Uint8Array(s);for(let i=0;i<o.length;i++)r[i]=o.charCodeAt(i);return s}function Yt(){return $s.stubThis(globalThis?.PublicKeyCredential!==void 0&&typeof globalThis.PublicKeyCredential=="function")}const $s={stubThis:e=>e};function Ls(e){const{id:t}=e;return{...e,id:zt(t),transports:e.transports}}function Is(e){return e==="localhost"||/^((xn--[a-z0-9-]+|[a-z0-9]+(-[a-z0-9]+)*)\.)+([a-z]{2,}|xn--[a-z0-9-]+)$/i.test(e)}class pe extends Error{constructor({message:t,code:a,cause:n,name:o}){super(t,{cause:n}),Object.defineProperty(this,"code",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),this.name=o??n.name,this.code=a}}function Xl({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new pe({message:"Registration ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else if(e.name==="ConstraintError"){if(a.authenticatorSelection?.requireResidentKey===!0)return new pe({message:"Discoverable credentials were required but no available authenticator supported it",code:"ERROR_AUTHENTICATOR_MISSING_DISCOVERABLE_CREDENTIAL_SUPPORT",cause:e});if(t.mediation==="conditional"&&a.authenticatorSelection?.userVerification==="required")return new pe({message:"User verification was required during automatic registration but it could not be performed",code:"ERROR_AUTO_REGISTER_USER_VERIFICATION_FAILURE",cause:e});if(a.authenticatorSelection?.userVerification==="required")return new pe({message:"User verification was required but no available authenticator supported it",code:"ERROR_AUTHENTICATOR_MISSING_USER_VERIFICATION_SUPPORT",cause:e})}else{if(e.name==="InvalidStateError")return new pe({message:"The authenticator was previously registered",code:"ERROR_AUTHENTICATOR_PREVIOUSLY_REGISTERED",cause:e});if(e.name==="NotAllowedError")return new pe({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="NotSupportedError")return a.pubKeyCredParams.filter(o=>o.type==="public-key").length===0?new pe({message:'No entry in pubKeyCredParams was of type "public-key"',code:"ERROR_MALFORMED_PUBKEYCREDPARAMS",cause:e}):new pe({message:"No available authenticator supported any of the specified pubKeyCredParams algorithms",code:"ERROR_AUTHENTICATOR_NO_SUPPORTED_PUBKEYCREDPARAMS_ALG",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if(Is(n)){if(a.rp.id!==n)return new pe({message:`The RP ID "${a.rp.id}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new pe({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="TypeError"){if(a.user.id.byteLength<1||a.user.id.byteLength>64)return new pe({message:"User ID was not between 1 and 64 characters",code:"ERROR_INVALID_USER_ID_LENGTH",cause:e})}else if(e.name==="UnknownError")return new pe({message:"The authenticator was unable to process the specified options, or could not create a new credential",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}class Zl{constructor(){Object.defineProperty(this,"controller",{enumerable:!0,configurable:!0,writable:!0,value:void 0})}createNewAbortSignal(){if(this.controller){const a=new Error("Cancelling existing WebAuthn API call for new one");a.name="AbortError",this.controller.abort(a)}const t=new AbortController;return this.controller=t,t.signal}cancelCeremony(){if(this.controller){const t=new Error("Manually cancelling existing WebAuthn API call");t.name="AbortError",this.controller.abort(t),this.controller=void 0}}}const Tn=new Zl,ec=["cross-platform","platform"];function Rs(e){if(e&&!(ec.indexOf(e)<0))return e}async function tc(e){!e.optionsJSON&&e.challenge&&(console.warn("startRegistration() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useAutoRegister:a=!1}=e;if(!Yt())throw new Error("WebAuthn is not supported in this browser");const n={...t,challenge:zt(t.challenge),user:{...t.user,id:zt(t.user.id)},excludeCredentials:t.excludeCredentials?.map(Ls)},o={};a&&(o.mediation="conditional"),o.publicKey=n,o.signal=Tn.createNewAbortSignal();let s;try{s=await navigator.credentials.create(o)}catch(u){throw Xl({error:u,options:o})}if(!s)throw new Error("Registration was not completed");const{id:r,rawId:i,response:l,type:c}=s;let d;typeof l.getTransports=="function"&&(d=l.getTransports());let f;if(typeof l.getPublicKeyAlgorithm=="function")try{f=l.getPublicKeyAlgorithm()}catch(u){Va("getPublicKeyAlgorithm()",u)}let v;if(typeof l.getPublicKey=="function")try{const u=l.getPublicKey();u!==null&&(v=Re(u))}catch(u){Va("getPublicKey()",u)}let h;if(typeof l.getAuthenticatorData=="function")try{h=Re(l.getAuthenticatorData())}catch(u){Va("getAuthenticatorData()",u)}return{id:r,rawId:Re(i),response:{attestationObject:Re(l.attestationObject),clientDataJSON:Re(l.clientDataJSON),transports:d,publicKeyAlgorithm:f,publicKey:v,authenticatorData:h},type:c,clientExtensionResults:s.getClientExtensionResults(),authenticatorAttachment:Rs(s.authenticatorAttachment)}}function Va(e,t){console.warn(`The browser extension that intercepted this WebAuthn API call incorrectly implemented ${e}. You should report this error to them.
`,t)}function Ns(){if(!Yt())return oa.stubThis(new Promise(t=>t(!1)));const e=globalThis.PublicKeyCredential;return e?.isConditionalMediationAvailable===void 0?oa.stubThis(new Promise(t=>t(!1))):oa.stubThis(e.isConditionalMediationAvailable())}const oa={stubThis:e=>e};function ac({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new pe({message:"Authentication ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else{if(e.name==="NotAllowedError")return new pe({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if(Is(n)){if(a.rpId!==n)return new pe({message:`The RP ID "${a.rpId}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new pe({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="UnknownError")return new pe({message:"The authenticator was unable to process the specified options, or could not create a new assertion signature",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}async function nc(e){!e.optionsJSON&&e.challenge&&(console.warn("startAuthentication() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useBrowserAutofill:a=!1,verifyBrowserAutofillInput:n=!0}=e;if(!Yt())throw new Error("WebAuthn is not supported in this browser");let o;t.allowCredentials?.length!==0&&(o=t.allowCredentials?.map(Ls));const s={...t,challenge:zt(t.challenge),allowCredentials:o},r={};if(a){if(!await Ns())throw Error("Browser does not support WebAuthn autofill");if(document.querySelectorAll("input[autocomplete$='webauthn']").length<1&&n)throw Error('No <input> with "webauthn" as the only or last value in its `autocomplete` attribute was detected');r.mediation="conditional",s.allowCredentials=[]}r.publicKey=s,r.signal=Tn.createNewAbortSignal();let i;try{i=await navigator.credentials.get(r)}catch(h){throw ac({error:h,options:r})}if(!i)throw new Error("Authentication was not completed");const{id:l,rawId:c,response:d,type:f}=i;let v;return d.userHandle&&(v=Re(d.userHandle)),{id:l,rawId:Re(c),response:{authenticatorData:Re(d.authenticatorData),clientDataJSON:Re(d.clientDataJSON),signature:Re(d.signature),userHandle:v},type:f,clientExtensionResults:i.getClientExtensionResults(),authenticatorAttachment:Rs(i.authenticatorAttachment)}}function oc(){return Yt()?PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable():new Promise(e=>e(!1))}const Os=Object.freeze(Object.defineProperty({__proto__:null,WebAuthnAbortService:Tn,WebAuthnError:pe,_browserSupportsWebAuthnAutofillInternals:oa,_browserSupportsWebAuthnInternals:$s,base64URLStringToBuffer:zt,browserSupportsWebAuthn:Yt,browserSupportsWebAuthnAutofill:Ns,bufferToBase64URLString:Re,platformAuthenticatorIsAvailable:oc,startAuthentication:nc,startRegistration:tc},Symbol.toStringTag,{value:"Module"}));let no=!1;function sc(){if(no)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
    .accept-invite-page {
  ...
  `,document.head.appendChild(e),oo=!0}function so(){return x.getConfig?.().BASE_URL||""}function dc(e){const t=`qf-${e.id}`;if(e.type==="checkbox_group"){const a=Array.isArray(e.options)?e.options:[];return`
    ...
    </div>`}function He(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ot(e,t,a){return`
    <div class="qf-page"><div class="qf-card"><div class="qf-state">
      <span class="material-symbols-outlined">${e}</span>
      <h1>${He(t)}</h1>
      <p class="qf-sub">${He(a)}</p>
    </div></div></div>`}function Fs(){return cc(),`<div id="qf-root">${Ot("hourglass_top","Loading your questionnaire…","One moment.")}</div>`}async function Ds(){const e=document.getElementById("qf-root");if(!e)return;const t=ul();if(!t){e.innerHTML=Ot("error","Invalid link","This link is missing required information. Please use the link exactly as sent.");return}let a;try{const c=await fetch(`${so()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(t.guid)}?token=${encodeURIComponent(t.token)}`),d=await c.json().catch(()=>({}));if(!c.ok||!d.ok){const f=c.status===404?d.error||"This link is invalid or has expired.":"Something went wrong loading your questionnaire. Please try again shortly.";e.innerHTML=Ot("error","Cannot open this questionnaire",f);return}a=d.data}catch(c){console.error("[questionnaire-fill] load error:",c),e.innerHTML=Ot("wifi_off","Connection problem","Could not reach the server. Please check your connection and try again.");return}const n=a.questionnaire?.sections||[],o=a.answers||{};e.innerHTML=`
  ...
  `}function gc(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const e=localStorage.getItem(H.FF_SSE_LS_TOKEN),t=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!e,hasMvvTs:!!t});const a=document.getElementById("splash-loader"),n=document.getElementById("splash-actions");e?(console.log("[SplashRoute] Auth token found → HOME"),m.publish(g.ROUTE_NAV,{route:"home"})):t?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),m.publish(g.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),a&&(a.style.display="none"),n&&(n.style.display="flex"),document.querySelectorAll("[data-route]").forEach(s=>{s.addEventListener("click",()=>{const r=s.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${r}`),m.publish(g.ROUTE_NAV,{route:r})})}))},4e3)}const hc=Object.freeze(Object.defineProperty({__proto__:null,init:gc,render:mc},Symbol.toStringTag,{value:"Module"}));function fe(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}const fc=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;function Cn(e,t){return e?fc.test(e)?!0:(fe(t,L.get("validation_email_invalid")),!1):(fe(t,L.get("validation_email_required")),!1)}function vc(){return`
  ...
  `}function bc(){console.log("[SigninRoute] Initialized");const e=document.getElementById("loginForm"),t=document.getElementById("email"),a=document.getElementById("password"),n=document.getElementById("togglePassword"),o=document.getElementById("rememberEmail"),s=localStorage.getItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL);s&&t&&o&&(t.value=s,o.checked=!0,a?.focus()),n?.addEventListener("click",()=>{const d=a.type==="password"?"text":"password";a.type=d});const r=document.getElementById("passkeySigninBtn"),i=document.getElementById("passkeyDivider"),l=document.getElementById("passkeyHint");window.PublicKeyCredential&&r&&i&&(r.style.display="",i.style.display="",l&&(l.style.display=""),r.addEventListener("click",()=>wc())),e?.addEventListener("submit",async d=>{d.preventDefault();const f=t.value.trim(),v=a.value;Cn(f,t)&&_c(v,a)&&(o?.checked?localStorage.setItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL,f):localStorage.removeItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL),await yc(f,v))}),document.getElementById("link--uc__underline")?.addEventListener("click",d=>{d.preventDefault(),m.publish(g.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",d=>{d.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),m.publish(g.ROUTE_NAV,{route:"signup"})})}function _c(e,t){return e?e.length<10?(fe(t,L.get("validation_password_min_length")),!1):!0:(fe(t,L.get("validation_password_required")),!1)}async function yc(e,t){const a=document.querySelector(".btn");a.disabled=!0,a.textContent=L.get("loading_signing_in");try{const n=await x.doSignin(e,t);n.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(L.get("success_welcome_back"),"success"),m.publish(g.AUTH_SIGNIN_SUCCESS,{entity:x.getEntity()})):n.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q(L.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(n.error||L.get("error_signin_failed"),"danger"),a.disabled=!1,a.textContent=(L.get("sign_in")||"Sign in").toUpperCase())}catch(n){console.error("[SigninRoute] Sign in error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||L.get("error_network"),"danger"),a.disabled=!1,a.textContent=(L.get("sign_in")||"Sign in").toUpperCase(),m.publish(g.AUTH_SIGNIN_FAIL,{message:n.message})}}async function wc(){const e=document.getElementById("passkeySigninBtn");e.disabled=!0;try{const t=await x.doPasskeySignin();t.ok?(console.log("[SigninRoute] Passkey signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(L.get("success_welcome_back"),"success"),m.publish(g.AUTH_SIGNIN_SUCCESS,{entity:x.getEntity()})):t.canceled||typeof neodigmToast<"u"&&neodigmToast.q(t.error||L.get("error_signin_failed"),"danger")}catch(t){console.error("[SigninRoute] Passkey signin error:",t),typeof neodigmToast<"u"&&neodigmToast.q(t.message||L.get("error_network"),"danger")}finally{e.disabled=!1}}const xc=Object.freeze(Object.defineProperty({__proto__:null,init:bc,render:vc},Symbol.toStringTag,{value:"Module"}));function $n(e){const t=[];return e.length<12&&t.push("at least 12 characters"),e.length>1024&&t.push("at most 1024 characters"),/[a-z]/.test(e)||t.push("1 lowercase"),/[A-Z]/.test(e)||t.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(e)||t.push("1 special character"),/[^\x00-\x7F]/.test(e)&&t.push("ASCII characters only"),t}function Bs(e){if(e.length===0)return"";if(e.includes("ASCII characters only"))return"Password cannot contain emoji|or special unicode characters";const t=e.find(a=>/^at (?:least|most) \d+ characters$/.test(a));return t?`Password must have ${t.replace(/ (\d+ characters)$/,"|$1")}`:"Password must have: Uppercase,|Lowercase, and Special Character"}const Ec="2026-07-15";function kc(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function Pc(){console.log("[ForgotRoute] Initialized");const e=document.getElementById("forgot-form"),t=document.getElementById("email");e?.addEventListener("submit",async a=>{a.preventDefault();const n=t.value.trim();Cn(n,t)&&await Fc(n)})}async function Fc(e){const t=document.querySelector(".btn");t.disabled=!0,t.textContent="SENDING...";try{const a=await Oc.forgotPassword(e);a.ok&&a.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q(L.get("success_reset_link_sent"),"success"),m.publish(g.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(a.data.error||L.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=(L.get("send_reset_link")||"Send reset link").toUpperCase())}catch(a){console.error("[ForgotRoute] Forgot password error:",a),typeof neodigmToast<"u"&&neodigmToast.q(a.message||L.get("error_network"),"danger"),t.disabled=!1,t.textContent=(L.get("send_reset_link")||"Send reset link").toUpperCase()}}const Dc=Object.freeze(Object.defineProperty({__proto__:null,init:Pc,render:Mc},Symbol.toStringTag,{value:"Module"}));function Bc(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function Uc(){console.log("[ResethashRoute] Initialized");const e=document.getElementById("resethash-form"),t=e.querySelector('button[type="submit"]');lo("toggleNewPassword","new-password","eyeIconNew"),lo("toggleConfirmPassword","confirm-password","eyeIconConfirm"),e?.addEventListener("submit",async a=>{a.preventDefault();const n=e.email.value.trim(),o=e.newPassword.value,s=e.confirmPassword.value,r=document.getElementById("new-password"),i=document.getElementById("confirm-password");if(!o){fe(r,L.get("validation_new_password_required"));return}const l=$n(o);if(l.length>0){fe(r,Bs(l));return}if(!s){fe(i,L.get("validation_new_password_required"));return}if(o!==s){fe(i,L.get("validation_password_mismatch"));return}t.disabled=!0,t.textContent=L.get("loading_resetting_password");try{const c=await x.doResetHash(n,o);c.ok?(typeof neodigmToast<"u"&&neodigmToast.q(L.get("success_password_reset"),"success"),m.publish(g.AUTH_RESETHASH_SUCCESS,{email:n})):(fe(r,c.error||L.get("error_signin_failed")),t.disabled=!1,t.textContent=(L.get("update_password")||"Update password").toUpperCase())}catch(c){console.error("[ResethashRoute] Reset password error:",c),fe(r,c.message||L.get("error_network")),t.disabled=!1,t.textContent=(L.get("update_password")||"Update password").toUpperCase()}})}function lo(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}const Hc=Object.freeze(Object.defineProperty({__proto__:null,init:Uc,render:Bc},Symbol.toStringTag,{value:"Module"})),oe=()=>x.getManagedClients().length>0&&!x.getStoredActiveOrg(),Ve=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),qc={reseller_org:"Your org",managed_client:"Client",saas_org:"Org"};let co=!1;function gt(){if(co)return;const e=document.createElement("style");e.id="m5t-portfolio-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),co=!0}const po=e=>e.toISOString().slice(0,10);async function zc(e,{days:t=30}={}){const a=new Date,n=po(new Date(a.getTime()-(t-1)*864e5)),o=po(a),s=await fetch(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${o}&group_by=owner`);if(!s.ok)throw new Error(`HTTP ${s.status}`);const r=await s.json();if(!r.ok)throw new Error("stats not ok");return r.by_owner||[]}function Us(e,t){return`<div class="dash-clients-scroll"><table class="dash-clients">
    <thead><tr>
    ...
    <tbody>${e.map(a=>`
      <tr data-org="${Ve(a.owner_guid)}" tabindex="0" role="button"
        ...
        <td><span class="dc-name">${Ve(a.name||a.owner_guid)}
          <span class="dc-chip">${Ve(qc[a.channel]||a.channel||"")}</span></span></td>
        ${t.map(n=>`<td>${n.td(a)}</td>`).join("")}
        <td><span class="dc-view">View →</span></td>
      </tr>`).join("")}</tbody>
  </table></div>`}function Gc(e){let t=e.querySelector(".pf-access-error");t||(t=document.createElement("div"),t.className="pf-access-error",e.prepend(t)),t.textContent="You don't have direct access to manage this org. Use the admin console to act on its behalf."}function Hs(e){if(!e)return;const t=async a=>{const n=a?.dataset?.org;if(!n)return;(await x.setActiveOrg(n))?.activeOrgError&&Gc(e)};e.querySelectorAll("tbody tr[data-org]").forEach(a=>{a.addEventListener("click",()=>t(a)),a.addEventListener("keydown",n=>{(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),t(a))})})}const nn=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function St({section:e,title:t,description:a}){return gt(),`
    <div class="page-shell" data-section="${Ve(e)}">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="pf-picker-body">${nn("hourglass_empty","Loading…")}</div>
      </div>
    </div>`}async function ht(e,t,{emptyMsg:a}={}){const n=document.getElementById("pf-picker-body");if(n)try{const o=await zc(e);if(!o.length){n.innerHTML=nn("groups",a||"No client orgs yet. Create one under Clients first.");return}n.innerHTML=Us(o,t),Hs(n)}catch(o){console.warn("[portfolio] picker load failed:",o),n.innerHTML=nn("error","Could not load your clients. Please refresh.")}}function qs(){const e={};return x.getManagedClients().forEach(t=>{e[t.orgGuid]=t.name}),x.getMemberships().forEach(t=>{t.orgGuid&&!e[t.orgGuid]&&(e[t.orgGuid]=t.name||"")}),e}const zs=e=>e?`<span class="pf-client-chip">${Ve(e)}</span>`:"",pt=Object.freeze({MAGNET_TEMPLATE:"magnet_template",LEADS_SEARCH:"leads_search",LEADS_DAY:"leads_day"}),wt=new Map;function Ln(e,t){wt.set(e,t)}function on(e){if(!wt.has(e))return null;const t=wt.get(e);return wt.delete(e),t}function jc(e){return wt.has(e)?wt.get(e):null}const ye=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,he=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),Q=e=>Number(e||0).toLocaleString(),Gs=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",Vc=e=>(Gs(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function Wc(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric"})}catch{return""}}function Yc(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}let uo=!1;function Jc(){if(uo)return;const e=document.createElement("style");e.id="m5t-dash-recent-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),uo=!0}function Kc(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${he(Vc(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${he(Gs(e))}</span>
    ...
    <span class="recent-lead__time">${he(Wc(e))}</span>
  </a>`}const Mt=({icon:e,label:t,valueId:a,value:n="—",subId:o,sub:s="",href:r,trendId:i})=>{const l=r?"a":"div",c=r?` href="${he(r)}" class="stat-card stat-card--link"`:' class="stat-card"';return`
  <${l}${c}>
  ...
  </${l}>`},Qt=(e,t,a,{wide:n=!1,full:o=!1,controls:s=!1}={})=>`
  <div class="dashboard-card${n?" chart-card-wide":""}${o?" chart-card-full":""}">
  ...
  </div>`;let sn=30;function js(){Jc(),gt();const e=oe();return`
    <div class="page-shell" data-section="home">
      ...
      <div class="stats-grid">
        ...
        ${Mt({icon:"person_add",label:"Leads Captured",valueId:"stat-leads",subId:"stat-leads-sub",sub:"Loading…",href:"#/leads",trendId:"stat-leads-trend"})}
        ${Mt({icon:"check_circle",label:"Completion Rate",valueId:"stat-completion",subId:"stat-completion-sub",sub:"Loading…"})}
      </div>

      <div class="charts-section">
        ${Qt("show_chart","Opens & Leads","dash-trend",{wide:!0,controls:!0})}
        <div class="charts-grid">
          ${Qt("filter_alt","Completion Funnel","dash-funnel")}
          ${Qt("source","Top Campaigns","dash-campaigns")}
          ${Qt("touch_app","CTA Usage","dash-routes",{full:!0})}
        </div>
      </div>
    ...
    </div>`).join("")}</div>`}async function ed(e){const t=document.getElementById("recent-leads-body");if(t)try{const a=await fetch(`${e}/m5t/v5/m5mLead`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json(),o=(Array.isArray(n?.data)?n.data:[]).filter(s=>!["DELETED","ARCHIVED"].includes(s.status));t.innerHTML=o.length?o.slice(0,5).map(Kc).join(""):ye("contacts","No leads captured yet. Publish a magnet to start collecting.")}catch(a){console.warn("[dashboard] Leads fetch failed:",a),t.innerHTML=ye("error","Could not load recent leads.")}}function ho(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}const fo=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e));function Ws(e){const h=e.length||1,u=ho(Math.max(1,...e.map(U=>U.opens||0))),p=ho(Math.max(1,...e.map(U=>U.leads||0))),b=748/h,y=Math.min(22,b*.55),E=U=>46+b*(U+.5),A=U=>266-U/u*248,C=U=>266-U/p*248,j=[0,.5,1].map(U=>{const J=266-U*248;return`<line x1="46" y1="${J.toFixed(1)}" x2="794" y2="${J.toFixed(1)}" class="dash-grid"/><text x="38" y="${(J+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${fo(u*U)}</text><text x="802" y="${(J+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${fo(p*U)}</text>`}).join(""),q=e.map((U,J)=>{const Qe=A(U.opens||0);return`<rect class="dash-bar" data-i="${J}" x="${(E(J)-y/2).toFixed(1)}" y="${Qe.toFixed(1)}" width="${y.toFixed(1)}" height="${Math.max(0,266-Qe).toFixed(1)}" rx="3"/>`}).join(""),X=e.map((U,J)=>`${E(J).toFixed(1)},${C(U.leads||0).toFixed(1)}`).join(" "),de=h>1?`<polyline class="dash-line" points="${X}" fill="none" stroke-width="2.5"/>`:"",ge=e.map((U,J)=>`<circle class="dash-dot" data-i="${J}" cx="${E(J).toFixed(1)}" cy="${C(U.leads||0).toFixed(1)}" r="3.2"/>`).join(""),ue='<line class="dash-crosshair" x1="0" y1="18" x2="0" y2="266" pointer-events="none"/>',Le=Math.max(1,Math.ceil(h/6)),D=e.map((U,J)=>J%Le===0||J===h-1?`<text x="${E(J).toFixed(1)}" y="288" text-anchor="middle" class="dash-ax">${U.date.slice(5)}</text>`:"").join(""),te=e.map((U,J)=>`<rect class="dash-hit" data-i="${J}" data-day="${he(U.date)}" data-leads="${Number(U.leads||0)}" x="${(46+b*J).toFixed(1)}" y="18" width="${b.toFixed(1)}" height="${248 .toFixed(1)}" fill="transparent"/>`).join("");return`
  ...
  `}function od(){console.log("[SignoutRoute] Initialized");const e=document.getElementById("confirm-signout-btn");e?.addEventListener("click",async()=>{e.disabled=!0,e.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await x.doSignout()})}const sd=Object.freeze(Object.defineProperty({__proto__:null,init:od,render:nd},Symbol.toStringTag,{value:"Module"}));let vo=!1;function rd(){if(vo)return;const e=document.createElement("style");e.id="m5t-section-page-styles",e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),vo=!0}function Js({title:e="Section",icon:t="widgets",name:a=""}={}){return rd(),`
    ...
    </section>`}function Ks(){}const id={render:Js,init:Ks},ld=Object.freeze(Object.defineProperty({__proto__:null,default:id,init:Ks,render:Js},Symbol.toStringTag,{value:"Module"})),cd={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},nt=e=>String(e??"").replace(/[&<>"']/g,t=>cd[t]),bo=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},dd=()=>x.getConfig?.().BASE_URL||"",Qs=()=>`${dd()}/m5t/v5/acctEntity/profile`,rn={profile:null};let _o=!1;function pd(){if(_o)return;const e=document.createElement("style");e.id="m5t-settings-general-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),_o=!0}const Xs=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Zs(){try{return Ce.getAvailableLanguages()||[]}catch{return[]}}function ud(){const e=Zs(),t=e.includes(H.FF_SSE_I18N_LANG)?H.FF_SSE_I18N_LANG:e[0]||H.FF_SSE_I18N_LANG;try{const a=localStorage.getItem(H.FF_SSE_LS_USER_LANG);return a&&e.includes(a)?a:t}catch{return t}}function md(e){try{const t=new Intl.DisplayNames([e],{type:"language"}).of(e);if(t&&t!==e)return t.charAt(0).toUpperCase()+t.slice(1)}catch{}return e}function gd(){const e=Sa(),t=Zs(),a=t.length>1;if(!e&&!a)return"";const n=ud();return`
        ...
        <div class="settings-item" id="gen-lang-item">
          ...
          <div class="settings-item__control">
            <select class="settings-select" id="gen-lang" aria-label="Language">
              ${t.map(o=>`<option value="${nt(o)}" ${o===n?"selected":""}>${nt(md(o))}</option>`).join("")}
            </select>
          </div>
        </div>`:""}
      </div>
    </div>`}function er(){return pd(),`
    <div class="page-shell" data-section="settings-general">
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ...
          <div id="gen-profile-body">${Xs("hourglass_empty","Loading…")}</div>
        </div>
      </div>
    ...
    </div>`}async function tr(){bd(),await fd()}function hd(e){return`
    ...
    </div>`}async function fd(){const e=document.getElementById("gen-profile-body");if(e){try{const t=await fetch(Qs()),a=await t.json().catch(()=>({}));if(!t.ok||!a.ok||!a.data)throw new Error(a.error||"Failed to load");rn.profile=a.data}catch(t){console.warn("[settings-general] profile load failed:",t),e.innerHTML=Xs("error","Could not load your profile. Please try again.");return}e.innerHTML=hd(rn.profile),e.querySelector("#gen-save")?.addEventListener("click",vd)}}function yo(e,t){const a=document.getElementById(`${e}-error`);a&&(a.textContent=t||"",a.hidden=!t);const n=document.getElementById(e);n&&n.setAttribute("aria-invalid",t?"true":"false")}async function vd(){const e=document.getElementById("gen-save"),t=n=>(document.getElementById(n)?.value??"").trim(),a={first:t("gen-first"),last:t("gen-last"),company:t("gen-company"),phone:t("gen-phone")};if(yo("gen-first",a.first?"":"First name is required."),yo("gen-last",a.last?"":"Last name is required."),!(!a.first||!a.last)){e&&(e.disabled=!0);try{const n=await fetch(Qs(),{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}),o=await n.json().catch(()=>({}));if(!n.ok||!o.ok)throw new Error(o.error||"Could not save.");o.data&&(rn.profile=o.data),bo("Profile updated.","success")}catch(n){console.warn("[settings-general] profile save failed:",n),bo(n.message||"Could not save.","error")}finally{e&&(e.disabled=!1)}}}function bd(){const e=document.getElementById("gen-dark");if(e){e.addEventListener("change",()=>{ks(e.checked?"dark":"light"),e.checked=qt()==="dark"});const a=m.subscribe(g.UI_THEME_CHANGED,()=>{if(!e.isConnected){m.unsubscribe(a);return}e.checked=qt()==="dark"})}const t=document.getElementById("gen-lang");t&&t.addEventListener("change",()=>{try{Ce.setLanguage(t.value)}catch(a){console.warn("[settings-general] setLanguage failed:",a)}})}const _d={render:er,init:tr},yd=Object.freeze(Object.defineProperty({__proto__:null,default:_d,init:tr,render:er},Symbol.toStringTag,{value:"Module"})),wd={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},qe=e=>String(e??"").replace(/[&<>"']/g,t=>wd[t]),wo=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},ma=()=>x.getConfig?.().BASE_URL||"",xd=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?",ar="managed_client",nr={reseller_org:"Your organization",managed_client:"Client workspace",saas_org:"Organization"},Ed=6,Ye={org:null},or=()=>x.getActiveOrg()?.guid||x.getMemberships()[0]?.orgGuid||null,Ta=()=>x.getActiveOrg()?.channel||x.getMemberships()[0]?.channel||null,sr=()=>x.getCapabilities().includes("manage_team");let xo=!1;function kd(){if(xo)return;const e=document.createElement("style");e.id="m5t-workspace-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),xo=!0}const ga=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Eo=(e,t,a)=>`
  <div class="settings-section__head">
  ...
  </div>`;function rr(){kd();const e=nr[Ta()];return`
    <div class="page-shell" data-section="settings-workspace">
      ...
      <div class="dashboard-card">
        <div class="card-body">
          ${Eo("apartment","Organization","Name and details.")}
          <div id="ws-org-body">${ga("hourglass_empty","Loading…")}</div>
        </div>
      </div>

      <div class="dashboard-card" id="ws-team-card" style="margin-top:24px; display:none">
        <div class="card-body">
          ${Eo("group","Team","Who has access.")}
          <div id="ws-team-body"></div>
        </div>
      </div>
    </div>`}async function ir(){Ye.org=null,await Ad(),await Cd()}async function Ad(){const e=document.getElementById("ws-org-body");if(!e)return;const t=or();if(!t){e.innerHTML=ga("apartment","No workspace on this account yet.");return}try{const a=await fetch(`${ma()}/m5t/v5/acctGroup`),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||`Failed (HTTP ${a.status})`);if(Ye.org=(n.data||[]).find(o=>o.guid===t)||null,!Ye.org)throw new Error("Org row not in scope")}catch(a){console.warn("[settings-workspace] load failed:",a),e.innerHTML=ga("error","Could not load your workspace. Please try again.");return}Sd()}function ko(){const e=nr[Ta()]||"",t=Ye.org?.created?.created_tz;let a="";if(t){const o=new Date(t);Number.isNaN(o.getTime())||(a=`Created ${o.toLocaleDateString()}`)}const n=[e,a].filter(Boolean);return n.length?`<p class="settings-help">${qe(n.join(" · "))}</p>`:""}function Sd(){const e=document.getElementById("ws-org-body");if(!e)return;const t=Ye.org||{};if(!sr()){const a=Ta()===ar?'<div class="settings-note"><span class="material-symbols-outlined" aria-hidden="true">info</span> This workspace is managed for you.</div>':"";e.innerHTML=`
    ...
    </div>`,document.getElementById("ws-save")?.addEventListener("click",Td)}async function Td(){const e=document.getElementById("ws-save"),t=document.getElementById("ws-org-error"),a=(document.getElementById("ws-name")?.value||"").trim(),n=(document.getElementById("ws-desc")?.value||"").trim();if(t&&(t.textContent=""),!a){t&&(t.textContent="Organization name is required.");return}e&&(e.disabled=!0);try{const o=await fetch(`${ma()}/m5t/v5/acctGroup/${encodeURIComponent(Ye.org.id)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({caption:a,description:n})}),s=await o.json().catch(()=>({}));if(!o.ok||!s.ok)throw new Error(s.message||s.error||`Failed (HTTP ${o.status})`);Ye.org={...Ye.org,caption:a,description:n},wo("Workspace updated.","success")}catch(o){console.warn("[settings-workspace] save failed:",o),wo(o.message||"Could not save","danger"),e&&(e.disabled=!1);return}e&&(e.disabled=!1);try{await x.fetchScope?.()}catch(o){console.warn("[settings-workspace] fetchScope after save failed:",o)}}function Ao(){document.getElementById("ws-team-card")?.remove()}async function Cd(){const e=document.getElementById("ws-team-card");if(!e)return;const t=or();if(!t||!sr()){Ao();return}let a=[],n=[];try{const[o,s]=await Promise.all([fetch(`${ma()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/members`),fetch(`${ma()}/m5t/v5/acctGroup/${encodeURIComponent(t)}/invites`)]);if(o.status===403||s.status===403){Ao();return}const[r,i]=await Promise.all([o.json().catch(()=>({})),s.json().catch(()=>({}))]);if(!o.ok||!s.ok)throw new Error(`members: ${o.status}, invites: ${s.status}`);a=r.members||[],n=i.invites||[]}catch(o){console.warn("[settings-workspace] team load failed:",o),e.style.display="";const s=document.getElementById("ws-team-body");s&&(s.innerHTML=ga("error","Could not load your team. Please try again."));return}Id(a,n)}function $d(e){if(!e.length)return"";const t=e.slice(0,Ed),a=e.length-t.length;return`
    <div class="ws-avatars">
      ${t.map(n=>`<span class="ws-avatar" title="${qe(n.name||n.email)}">${qe(xd(n.name||n.email))}</span>`).join("")}
      ${a>0?`<span class="ws-avatar ws-avatar--more">+${a}</span>`:""}
    </div>`}function Ld(e,t){const a=`${e.length} member${e.length===1?"":"s"}`;return t.length?`${a} · ${t.length} pending invite${t.length===1?"":"s"}`:a}function Id(e,t){const a=document.getElementById("ws-team-card"),n=document.getElementById("ws-team-body");if(!a||!n)return;a.style.display="";const o=Ta()!==ar;n.innerHTML=`
    ${$d(e)}
    <p class="ws-counts">${qe(Ld(e,t))}</p>
    ${o?'<div class="ws-team-actions"><a class="btn btn-secondary" href="#/team">Manage team</a></div>':""}`}const Rd={render:rr,init:ir},Nd=Object.freeze(Object.defineProperty({__proto__:null,default:Rd,init:ir,render:rr},Symbol.toStringTag,{value:"Module"})),Od={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ie=e=>String(e??"").replace(/[&<>"']/g,t=>Od[t]),we=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},ut=()=>x.getConfig?.().BASE_URL||"",Md=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,Gt=5,be={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},ln=()=>x.getActiveOrg()?.guid||x.getMemberships()[0]?.orgGuid||null;let So=!1;function Pd(){if(So)return;const e=document.createElement("style");e.id="m5t-notif-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),So=!0}const In=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function lr(){return Pd(),gt(),oe()?St({section:"settings-notifications",title:"Notifications",description:"Pick a client to manage their lead alerts."}):`
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Email sent the moment a magnet captures a lead. Up to ${Gt} recipients per magnet.</p>
            </div>
          </div>
          <div id="ntf-body">${In("hourglass_empty","Loading…")}</div>
        </div>
      </div>
    ...
    </div>`}async function cr(){if(oe()){const e=t=>Number(t||0).toLocaleString();return ht(ut(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Promise.all([Fd(),dr()])}async function dr(){const e=ln();if(e)try{const t=await fetch(`${ut()}/m5t/v5/acctGroup/${encodeURIComponent(e)}/webhook`);if(t.status===403){be.webhookAllowed=!1;return}const a=await t.json().catch(()=>({}));if(!a.ok)return;be.webhook=a.webhook,pr()}catch{}}function To(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function pr(){const e=document.getElementById("ntf-wh-card"),t=document.getElementById("ntf-wh-body");if(!e||!t)return;e.style.display="";const a=be.webhook,n=a?.last_delivery;t.innerHTML=`
    <div class="ntf-wh">
    ...
    </div>`,t.querySelector("#ntf-wh-save")?.addEventListener("click",async()=>{const o=t.querySelector("#ntf-wh-url")?.value.trim()||"",s=t.querySelector("#ntf-wh-secret")?.value??"",r={uri:o};s.trim()!==""&&(r.secret=s.trim());try{const i=await fetch(`${ut()}/m5t/v5/acctGroup/${encodeURIComponent(ln())}/webhook`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),l=await i.json().catch(()=>({}));if(!i.ok||!l.ok)throw new Error(l.error||`Failed (HTTP ${i.status})`);be.webhook=l.webhook,we(o?"Webhook saved":"Webhook removed","success"),pr()}catch(i){we(i.message||"Could not save","danger")}}),t.querySelector("#ntf-wh-test")?.addEventListener("click",async o=>{const s=o.currentTarget;s.disabled=!0;try{const r=await fetch(`${ut()}/m5t/v5/acctGroup/${encodeURIComponent(ln())}/webhook-test`,{method:"POST"}),i=await r.json().catch(()=>({}));r.ok&&i.ok?we("Test delivery sent","success"):we(i.error||"Could not deliver the test","danger")}catch{we("Could not deliver the test","danger")}finally{s.disabled=!1}try{await dr()}catch(r){console.warn("[notifications] loadWebhook refresh failed:",r)}})}async function Fd(){const e=document.getElementById("ntf-body");if(e){try{const a=await(await fetch(`${ut()}/m5t/v5/magnets`)).json().catch(()=>({}));if(!a.ok)throw new Error(a.message||"Failed to load");be.magnets=(a.magnets||[]).filter(n=>n.status!=="ARCHIVED"),be.canManage=!!a.canManage}catch(t){console.warn("[notifications] load failed:",t),e.innerHTML=In("error","Could not load your magnets. Please try again.");return}ur()}}function Dd(e){const t=Array.isArray(e.notify_emails)?e.notify_emails:[],a=t.length>0;return`
    <div class="ntf-row" data-guid="${Ie(e.guid)}">
      ...
      <div class="ntf-config">
        ...
        <div class="ntf-addrow">
          <input class="ntf-input" type="email" placeholder="name@business.com" aria-label="Add alert email" ${t.length>=Gt?"disabled":""} />
          <button class="ntf-btn" type="button" data-add ${t.length>=Gt?"disabled":""}>
    ...
    </div>`}function ur(){const e=document.getElementById("ntf-body");if(e){if(!be.magnets.length){e.innerHTML=In("widgets","No magnets yet. Create one under Your Magnets first.");return}e.innerHTML=be.magnets.map(Dd).join(""),e.querySelectorAll(".ntf-row").forEach(t=>{const a=t.dataset.guid,n=t.querySelector(".ntf-input"),o=()=>{const s=(n?.value||"").trim().toLowerCase();if(!s)return;if(!Md.test(s)){we("That does not look like an email address","danger");return}const i=[...be.magnets.find(l=>l.guid===a).notify_emails||[]];if(i.includes(s)){we("Already added","info");return}if(i.length>=Gt){we(`Up to ${Gt} emails per magnet`,"info");return}Co(a,[...i,s])};t.querySelector("[data-add]")?.addEventListener("click",o),n?.addEventListener("keydown",s=>{s.key==="Enter"&&o()}),t.querySelectorAll("[data-remove]").forEach(s=>s.addEventListener("click",()=>{const r=be.magnets.find(i=>i.guid===a);Co(a,(r.notify_emails||[]).filter(i=>i!==s.dataset.remove))})),t.querySelector("[data-test]")?.addEventListener("click",()=>Bd(a,t.querySelector("[data-test]")))})}}async function Co(e,t){try{const a=await fetch(`${ut()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({notify_emails:t})}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||n.message||`Failed (HTTP ${a.status})`);const o=be.magnets.find(s=>s.guid===e);o&&(o.notify_emails=t),we("Alert emails updated","success")}catch(a){console.warn("[notifications] save failed:",a),we(a.message||"Could not save","danger");return}try{ur()}catch(a){console.error("[notifications] renderBody after save failed:",a)}}async function Bd(e,t){t&&(t.disabled=!0);try{const a=await fetch(`${ut()}/m5t/v5/magnets/${encodeURIComponent(e)}/notify-test`,{method:"POST"}),n=await a.json().catch(()=>({}));a.ok&&n.ok?we("Test alert sent","success"):we(n.error||"Could not send the test","danger")}catch{we("Could not send the test","danger")}finally{t&&(t.disabled=!1)}}const Ud={render:lr,init:cr},Hd=Object.freeze(Object.defineProperty({__proto__:null,default:Ud,init:cr,render:lr},Symbol.toStringTag,{value:"Module"}));function qd({label:e="",content:t="",size:a="",onClose:n=null}={}){const o=document.activeElement,s=document.createElement("div");s.className="m5t-modal-scrim",s.innerHTML=`
    <div class="m5t-modal${a==="wide"?" m5t-modal--wide":""}" role="dialog" aria-modal="true" aria-label="${zd(e)}" tabindex="-1">
    ...
    </span>`}function Ca(e,t){const a=Vd(),n=e?.[t]||[];return n.find(o=>o.owner_guid===a)||n[0]||null}function $a(e,t,a){return e.connect&&!a?"unavailable":t?t.connect_status==="ACTIVE"?"connected":"broken":"idle"}function La(e,t){return e==="unavailable"?'<span class="intg-state">Not available yet</span>':e==="idle"?'<span class="intg-state">Not connected</span>':e==="connected"?'<span class="intg-state on"><span class="material-symbols-outlined" aria-hidden="true">check</span>Connected</span>':`<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>${N(t?.connect_status==="NEEDS_REAUTH"?"Reconnect needed":"Connection error")}</span>`}async function Ia(){const e=await fetch(`${ie()}/m5t/v5/integrations`);if(e.status===403)return{denied:!0};const t=await e.json();if(!t.ok)throw new Error(t.error||"load failed");return{providers:t.data.providers,configured:t.data.configured}}async function Kd(e){if(!xe.busy){xe.busy=!0;try{const a=await(await fetch(`${ie()}/m5t/v5/integrations/${e.slug}/connect`)).json();if(!a.ok||!a.data?.url)throw new Error(a.error||"connect failed");window.location.href=a.data.url}catch(t){_e(t.message||e.connect.fallbackError,"error"),xe.busy=!1}}}async function Qd(e,{refresh:t}={}){if(xe.busy)return;xe.busy=!0;const a=document.getElementById(e.card.ids.sync);a&&(a.disabled=!0);try{const o=await(await fetch(`${ie()}/m5t/v5/integrations/${e.slug}/sync`,{method:"POST"})).json();if(!o.ok)throw new Error(o.error||"sync failed");const r=(o.data?.connections?.[0]?.[e.sync.itemsField]||[]).filter(i=>i.error).length;_e(r?e.sync.failedToast(r):"Metrics synced.",r?"warning":"success")}catch{_e("Sync failed.","error")}finally{xe.busy=!1,a&&(a.disabled=!1),t?.()}}async function Xd(e,{refresh:t}={}){if(xe.busy)return;xe.busy=!0;let a=!1;try{a=await mr({title:`Disconnect ${e.label}?`,message:e.disconnect.confirm,confirmLabel:"Disconnect",danger:!0})}finally{a||(xe.busy=!1)}if(a)try{const o=await(await fetch(`${ie()}/m5t/v5/integrations/${e.slug}`,{method:"DELETE"})).json().catch(()=>({}));if(!o.ok)throw new Error(o.error||"disconnect failed");_e(e.disconnect.toast,"success")}catch{_e("Disconnect failed.","error")}finally{xe.busy=!1,t?.()}}async function hr(e,{refresh:t}={}){const a=e.picker,n=document.getElementById(e.card.ids.panel);if(n){n.style.display="",n.innerHTML=Ee(a.loading);try{const s=await(await fetch(`${ie()}/m5t/v5/integrations/${e.slug}/${a.path}`)).json();if(!s.ok)throw new Error(s.error||"load failed");Zd(e,s.data[a.itemsField]||[],new Set(s.data.linked||[]),{refresh:t})}catch{n.innerHTML=Ee(a.loadError,"error")}}}function Zd(e,t,a,{refresh:n}={}){const o=e.picker,s=document.getElementById(e.card.ids.panel);if(!s)return;const r=t.map(i=>{const l=o.rowDisabled(i),c=o.rowBadge(i),d=a.has(i.id)&&!l;return`
    ...
    </div>`,document.getElementById(o.ids.cancel)?.addEventListener("click",()=>{s.style.display="none"}),document.getElementById(o.ids.save)?.addEventListener("click",()=>ep(e,{refresh:n}))}async function ep(e,{refresh:t}={}){const a=e.picker,n=document.getElementById(e.card.ids.panel),o=[...n?.querySelectorAll(`input[data-${a.dataAttr}]:checked`)||[]].map(r=>r.dataset[a.datasetKey]),s=document.getElementById(a.ids.save);s&&(s.disabled=!0);try{const i=await(await fetch(`${ie()}/m5t/v5/integrations/${e.slug}/${a.path}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({[a.saveField]:o})})).json();if(!i.ok)throw new Error(i.error||"save failed");_e(a.savedToast(i.data.linked),"success"),n&&(n.style.display="none"),t?.()}catch{_e(a.saveError,"error"),s&&(s.disabled=!1)}}function Lo({refresh:e,replaceKey:t=!1}={}){const a=document.getElementById(Te.callrail.card.ids.setup);a&&(a.style.display="",a.innerHTML=`
    <div class="intg-picker">
    ...
    </div>`,document.getElementById("intg-r-cancel")?.addEventListener("click",()=>{a.style.display="none"}),document.getElementById("intg-r-continue")?.addEventListener("click",()=>tp({refresh:e})),document.getElementById("intg-r-key")?.focus())}const je=e=>{const t=document.getElementById("intg-r-status");t&&(t.textContent=e)};async function tp({refresh:e}={}){const t=document.getElementById("intg-r-continue"),a=document.getElementById("intg-r-key")?.value.trim()||"",n=document.getElementById("intg-r-pickers");if(!a){je("Paste an API key first.");return}if(n&&!n.hidden)return ap(a,{refresh:e});t&&(t.disabled=!0),je("Checking the key with CallRail…");try{const s=await(await fetch(`${ie()}/m5t/v5/integrations/callrail/validate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:a})})).json();if(!s.ok){je(s.error||"CallRail rejected that key.");return}const r=s.data.accounts||[],i=document.getElementById("intg-r-account");i&&(i.innerHTML=r.map(l=>`<option value="${N(l.id)}">${N(l.name)}</option>`).join(""),i.onchange=()=>Io(a,i.value)),n&&(n.hidden=!1),t&&(t.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">save</span>Save'),je(""),await Io(a,r[0]?.id)}catch{je("Could not reach CallRail. Try again.")}finally{t&&(t.disabled=!1)}}async function Io(e,t){const a=document.getElementById("intg-r-company");if(!(!a||!t)){a.innerHTML='<option value="">Loading companies…</option>';try{const o=await(await fetch(`${ie()}/m5t/v5/integrations/callrail/companies`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:t})})).json(),s=o.ok?o.data.companies||[]:[];a.innerHTML=s.length?s.map(r=>`<option value="${N(r.id)}">${N(r.name)}</option>`).join(""):'<option value="">No active companies in this account</option>'}catch{a.innerHTML='<option value="">Could not load companies</option>'}}}async function ap(e,{refresh:t}={}){const a=document.getElementById("intg-r-continue"),n=document.getElementById("intg-r-account")?.value||"",o=document.getElementById("intg-r-company")?.value||"";if(!o){je("Pick the company this workspace tracks.");return}a&&(a.disabled=!0),je("Connecting…");try{const r=await(await fetch(`${ie()}/m5t/v5/integrations/callrail`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:n,company_id:o})})).json();if(!r.ok)throw new Error(r.error||"connect failed");_e(r.data?.webhook_state==="active"?"CallRail connected. Call sync is on.":"CallRail connected. Call sync setup needs attention; see below.","success"),t?.()}catch{je("Could not connect. Check the key and try again."),a&&(a.disabled=!1)}}async function np({refresh:e}={}){if(xe.busy)return;xe.busy=!0;const t=document.getElementById(Te.callrail.card.ids.sync);t&&(t.disabled=!0);try{const n=await(await fetch(`${ie()}/m5t/v5/integrations/callrail/sync?days=7`,{method:"POST"})).json();if(!n.ok)throw new Error(n.error||"sync failed");const o=n.data?.connections?.[0]||{};_e(o.error?"Sync finished with errors.":`Sync done. ${o.processed||0} new call${(o.processed||0)===1?"":"s"} recorded.`,o.error?"warning":"success")}catch{_e("Sync failed.","error")}finally{xe.busy=!1,t&&(t.disabled=!1),e?.()}}let Ro=!1;function Ra(){if(Ro)return;const e=document.createElement("style");e.id="m5t-intg-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ro=!0}function fr(){return Ra(),gt(),oe()?St({section:"settings-integrations",title:"Integrations",description:"Pick a client to manage their connections."}):`
    ...
    </div>`}async function vr(){if(oe()){const e=t=>Number(t||0).toLocaleString();return ht(ie(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}op()||await sp()}const Xt=Object.fromEntries(Object.values(Te).filter(e=>e.connect).map(e=>[e.slug,e.label]));function op(){try{const e=new URLSearchParams(window.location.search),t=e.get("connected"),a=e.get("error")?e.get("provider")||"google_ads":null;let n=null;if(t&&Object.hasOwn(Xt,t))_e(`${Xt[t]} connected.`,"success"),Wd({slug:t,connected:!0}),n=Object.hasOwn(Te,t)?Te[t]:null;else if(a){const o=Object.hasOwn(Xt,a)?Xt[a]:a;_e(`${o} connection failed (${e.get("error")}).`,"error"),n=Object.hasOwn(Te,a)?Te[a]:null}else return!1;return window.history.replaceState(null,"",window.location.pathname+window.location.hash),n?(window.router?.navigate(`/settings/integrations/${n.urlSlug}`),!0):!1}catch{return!1}}async function sp(){const e=document.getElementById("intg-body");try{const{denied:t,providers:a,configured:n}=await Ia();if(t){e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ne("lock","Integrations are managed by workspace admins.")}</div></div>`);return}e&&(e.innerHTML=cp(a,n))}catch{e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ne("error","Could not load integrations.")}</div></div>`)}}function rp(e,t,a){const n=$a(e,t,a);return`
    ...
    </div>`}function cp(e,t){const a=Object.values(Te).map(o=>rp(o,Ca(e,o.slug),!!t?.[o.slug])).join(""),n=$o.length?`<div class="intg-grid__soon-label">Coming soon</div>${$o.map(lp).join("")}`:"";return`<div class="intg-grid">${a}${n}</div>`}const dp={render:fr,init:vr},pp=Object.freeze(Object.defineProperty({__proto__:null,default:dp,init:vr,render:fr},Symbol.toStringTag,{value:"Module"})),R={provider:null,conn:null,configured:!1,status:"idle"};function br({provider:e}={}){Ra(),gt();const t=gr[e];if(!t||oe())return'<div class="page-shell"></div>';const a=Te[t];return R.provider=a,`
    <div class="page-shell" data-section="settings-integrations">
    ...
    </div>`}async function _r({provider:e}={}){const t=gr[e];if(!t||oe()){window.router?.navigate("/settings/integrations",{historyAPIMethod:"replaceState"});return}await dn();const a=Yd();a?.connected&&a.slug===t&&R.provider?.picker&&$e()&&hr(R.provider,{refresh:dn})}async function dn(){const e=document.getElementById("intg-detail");if(!(!e||!R.provider))try{const{denied:t,providers:a,configured:n}=await Ia();if(t){e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ne("lock","Integrations are managed by workspace admins.")}</div></div>`;return}R.conn=Ca(a,R.provider.slug),R.configured=!!n?.[R.provider.slug],R.status=$a(R.provider,R.conn,R.configured),e.innerHTML=up(),_p()}catch{e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Ne("error","Could not load this integration.")}</div></div>`}}function up(){const e=R.provider;return[gp(e),hp(e),fp(e),vp(e),bp(e)].filter(Boolean).join("")}function mp(e){const t=R.conn?.external_account||{};if(R.status!=="connected")return e.card.sub;if(e.slug==="calendly"){const n=[t.name,t.email&&`(${t.email})`].filter(Boolean).join(" ");return n?`Connected as ${n}.`:"Connected."}if(e.slug==="callrail"){const n=[t.account_name,t.company_name].filter(Boolean).join(" · ");return n?`Connected to ${n}.`:"Connected."}const a=e.card.reachableCount(t);return a?`${a} reachable ${e.slug==="google_analytics"?a===1?"property":"properties":a===1?"account":"accounts"}.`:"Connected."}function gp(e){let t="";$e()&&(e.connect&&(R.status==="idle"||R.status==="broken")&&R.configured&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${R.status==="broken"?"Reconnect":"Connect"}</button>`),e.slug==="callrail"&&R.status!=="connected"&&(t=`<button type="button" class="intg-btn primary" id="${e.card.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>${R.status==="broken"?"Reconnect":"Connect"}</button>`));let a;return R.status==="unavailable"?a=`${e.label} is being set up for this platform.`:R.status==="broken"?a=e.card.brokenDesc:R.status==="idle"?a=$e()?e.card.idleDesc:e.card.sub:a=mp(e),`
    ...
    </div>`}function hp(e){const t=Jd[e.slug];if(!t)return"";if(R.status==="connected"||R.status==="unavailable"||!$e())return`
      <div class="dashboard-card intg-card">
        <div class="card-body">
    ...
    </div>`}function fp(e){if(R.status!=="connected")return"";const t=$e();if(e.picker){const a=e.card.reachableCount(R.conn?.external_account);return`
      <div class="dashboard-card intg-card">
        <div class="card-body">
    ...
    </div>`}function bp(e){return R.status!=="connected"&&R.status!=="broken"||!$e()?"":`
    ...
    </div>`}function _p(){const e=R.provider;if(!e)return;const t=dn;e.connect&&document.getElementById(e.card.ids.connect)?.addEventListener("click",()=>Kd(e)),e.slug==="callrail"&&(document.getElementById(e.card.ids.connect)?.addEventListener("click",()=>Lo({refresh:t})),document.getElementById("intg-r-replace")?.addEventListener("click",()=>Lo({refresh:t,replaceKey:!0})),document.getElementById(e.card.ids.sync)?.addEventListener("click",()=>np({refresh:t})),R.status==="connected"&&$e()&&xp()),e.picker&&(document.getElementById(e.card.ids.choose)?.addEventListener("click",()=>hr(e,{refresh:t})),document.getElementById(e.card.ids.sync)?.addEventListener("click",()=>Qd(e,{refresh:t}))),e.slug==="google_ads"&&R.status==="connected"&&$e()&&yp(),e.slug==="calendly"&&R.status==="connected"&&$e()&&wp(),document.getElementById(e.card.ids.disconnect)?.addEventListener("click",()=>Xd(e,{refresh:t}))}async function yp(){const e=document.getElementById("intg-g-convactions");if(e)try{const a=await(await fetch(`${ie()}/m5t/v5/integrations/google_ads/conversion_actions`)).json();if(!a.ok)throw new Error(a.error||"load failed");const n=a.data.actions||[],o=new Set(a.data.selected||[]);if(!n.length){e.innerHTML=Ee("No enabled conversion actions in the linked accounts.");return}e.innerHTML=`
  ...
  `,document.head.appendChild(e),No=!0}const Nn=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function yr(){return Sp(),`
        ...
        <div class="card-body">
          <div class="settings-section__head">
            ...
            <div>
              ...
              <p class="settings-section__desc">Signing in as ${Pt(Ip())}. You stay signed in on this device after a change.</p>
            </div>
          </div>
          <div class="settings-grid-2">
            <div class="settings-field">
    ...
    </div>`}async function wr(){document.getElementById("pw-save")?.addEventListener("click",Np);const e=document.getElementById("pk-add-btn");e&&window.PublicKeyCredential&&(e.style.display="",e.addEventListener("click",$p)),await xr()}async function xr(){const e=document.getElementById("pk-body");if(e){try{const t=await fetch(`${Vt()}/m5t/v5/webauthn`),a=await t.json().catch(()=>({}));if(!t.ok||!a.ok)throw new Error(a.error||"Failed to load");Et.passkeys=a.passkeys||[],Et.loaded=!0}catch(t){console.warn("[settings-security] load failed:",t),e.innerHTML=Nn("error","Could not load your passkeys. Please try again.");return}Er()}}function Oo(e){if(!e)return null;try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return null}}function Tp(e){const t=Oo(e.last_used_time),a=e.created?.created_tz,n=Oo(a),o=[e.device_type==="multiDevice"?"Syncs across devices":"This device only",t?`Last used ${t}`:"Never used to sign in yet",n?`Added ${n}`:null].filter(Boolean).join(" · ");return`
    ...
    </div>`}function Er(){const e=document.getElementById("pk-body");if(e){if(!window.PublicKeyCredential){e.innerHTML=`<p class="pk-unsupported">This browser doesn't support passkeys. Your password sign-in still works as usual.</p>`;return}if(!Et.passkeys.length){e.innerHTML=Nn("passkey","No passkeys yet. Add one for a faster, phishing-resistant sign-in.");return}e.innerHTML=Et.passkeys.map(Tp).join(""),e.querySelectorAll("[data-remove]").forEach(t=>{t.addEventListener("click",()=>Lp(t.dataset.remove,t))})}}function Cp(){try{const e=navigator.userAgent||"",t=/iPhone/.test(e)?"iPhone":/iPad/.test(e)?"iPad":/Android/.test(e)?"Android":/Mac OS X/.test(e)?"Mac":/Windows/.test(e)?"Windows":/Linux/.test(e)?"Linux":"device",a=/Edg\//.test(e)?"Edge":/Chrome\//.test(e)?"Chrome":/Firefox\//.test(e)?"Firefox":/Safari\//.test(e)?"Safari":"";return a?`${a} on ${t}`:t}catch{return"Passkey"}}async function $p(){const e=document.getElementById("pk-add-btn");e&&(e.disabled=!0);try{const{startRegistration:t}=await W(async()=>{const{startRegistration:i}=await Promise.resolve().then(()=>Os);return{startRegistration:i}},void 0,import.meta.url),a=await fetch(`${Vt()}/m5t/v5/webauthn/register/options`,{method:"POST"}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||"Could not start passkey registration");let o;try{o=await t({optionsJSON:n.options})}catch(i){if(i?.name==="NotAllowedError")return;throw i}const s=await fetch(`${Vt()}/m5t/v5/webauthn/register/verify`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o,deviceLabel:Cp()})}),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.error||"Could not register this passkey");jt("Passkey added","success"),await xr()}catch(t){console.warn("[settings-security] addPasskey failed:",t),jt(t.message||"Could not add a passkey","danger")}finally{e&&(e.disabled=!1)}}async function Lp(e,t){if(await mr({title:"Remove this passkey?",message:"You can always add it back later.",confirmLabel:"Remove",danger:!0})){t&&(t.disabled=!0);try{const n=await fetch(`${Vt()}/m5t/v5/webauthn/${encodeURIComponent(e)}`,{method:"DELETE"}),o=await n.json().catch(()=>({}));if(!n.ok||!o.ok)throw new Error(o.error||"Could not remove this passkey");Et.passkeys=Et.passkeys.filter(s=>s.guid!==e),jt("Passkey removed","success"),Er()}catch(n){console.warn("[settings-security] removePasskey failed:",n),jt(n.message||"Could not remove this passkey","danger"),t&&(t.disabled=!1)}}}function Ip(){try{return x.getScope()?.entity?.email||x.getEntity?.()?.email||"your account"}catch{return"your account"}}const Zt=e=>{const t=document.getElementById("pw-error");t&&(t.textContent=e||"",t.hidden=!e)},Rp=e=>e.length<=1?String(e[0]??""):e.length===2?`${e[0]} and ${e[1]}`:`${e.slice(0,-1).join(", ")}, and ${e[e.length-1]}`;async function Np(){const e=document.getElementById("pw-new"),t=document.getElementById("pw-confirm"),a=document.getElementById("pw-save"),n=e?.value||"",o=t?.value||"",s=$n(n);if(s.length){Zt(`Password needs: ${Rp(s)}.`);return}if(n!==o){Zt("Passwords do not match.");return}Zt(""),a&&(a.disabled=!0);try{const r=await fetch(`${Vt()}/m5t/v5/acctEntity/resetHash`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({password:n})}),i=await r.json().catch(()=>({}));if(!r.ok||!i.ok)throw new Error(i.error||"Could not update your password");jt("Password updated","success"),e&&(e.value=""),t&&(t.value="")}catch(r){Zt(r.message||"Could not update your password.")}finally{a&&(a.disabled=!1)}}const Op={render:yr,init:wr},Mp=Object.freeze(Object.defineProperty({__proto__:null,default:Op,init:wr,render:yr},Symbol.toStringTag,{value:"Module"})),Pp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},re=e=>String(e??"").replace(/[&<>"']/g,t=>Pp[t]),pn=()=>x.getConfig?.().BASE_URL||"",Ja=e=>Number(e||0).toLocaleString(),Y={conversations:[],counts:{},magnetNames:{},filter:"ALL",book:!1,magnetOwnerNames:{}},Mo={COMPLETED:{label:"Completed",icon:"check_circle"},IN_PROGRESS:{label:"In progress",icon:"pending"},ABANDONED:{label:"Abandoned",icon:"highlight_off"}},un={book:"Book",chat:"Chat",call:"Call",email:"Email",support:"Support"};function kr(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email)||null}function Ar(e){return(e.split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase()}function Sr(e){try{return new Date(e).toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return""}}function Fp(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function Tr(e){return e==null?"—":e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,"0")}s`}let Po=!1;function Dp(){if(Po)return;const e=document.createElement("style");e.id="m5t-convs-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Po=!0}const Na=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Cr(){return Dp(),gt(),`
    <div class="page-shell" data-section="conversations">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="convs-body">
          ${Na("hourglass_empty","Loading journeys…")}
        </div>
      </div>
    </div>`}async function $r(){await Bp()}async function Bp(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${pn()}/m5t/v5/conversations`),fetch(`${pn()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(Y.conversations=n.conversations||[],Y.counts=n.counts||{},Y.book=oe(),a){const o=await a.json().catch(()=>({}));Y.magnetNames={},Y.magnetOwnerNames={};const s=Y.book?qs():{};(o.magnets||[]).forEach(r=>{Y.magnetNames[r.guid]=r.name,Y.book&&(Y.magnetOwnerNames[r.guid]=r.owner_name||s[r.owner_guid]||"")})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=Na("error","Could not load journeys. Please try again.");return}Lr()}}function Up(){return Y.filter==="ALL"?Y.conversations:Y.conversations.filter(e=>e.status===Y.filter)}function Hp(e){const t=kr(e.lead),a=Y.magnetNames[e.magnet_guid]||"—",n=Mo[e.status]||Mo.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,s=(e.routes||[]).map(r=>un[r]||r).join(", ");return`
    <tr class="convs-row" data-session="${re(e.session)}">
      <td>
        <span class="convs-who">
          <span class="convs-ava${t?"":" anon"}">${t?re(Ar(t)):'<span class="material-symbols-outlined" style="font-size:16px">person_off</span>'}</span>
      ...
      ${Y.book?`<td>${zs(Y.magnetOwnerNames[e.magnet_guid]||"")||'<span class="convs-muted">—</span>'}</td>`:""}
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${re(Sr(e.started_at))}">${re(Fp(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${re(Tr(e.duration_s))}</td>
    </tr>`}function Lr(){const e=document.getElementById("convs-body");if(!e)return;if(!Y.conversations.length){e.innerHTML=Na("route","No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.");return}const t=Up(),a=[["ALL","All"],["COMPLETED","Completed"],["IN_PROGRESS","In progress"],["ABANDONED","Abandoned"]];e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${a.map(([n,o])=>`<button data-filter="${n}" class="${Y.filter===n?"active":""}">${o}${n!=="ALL"&&Y.counts[n]?` (${Ja(Y.counts[n])})`:""}</button>`).join("")}
      </div>
      <span class="convs-count">${Ja(t.length)} of ${Ja(Y.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(Hp).join("")||`<tr><td colspan="${Y.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${Y.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(Y.filter=o.dataset.filter,Lr())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&zp(o.dataset.session)})}const qp={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${un[e]||e}`:""}`,route:e=>`Picked ${un[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function zp(e){const t=Y.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${pn()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=kr(t.lead),o=Y.magnetNames[t.magnet_guid]||"—",r=(a?.events||[]).filter((c,d,f)=>c.event!=="step"||!(f[d+1]&&f[d+1].event==="step")).map(c=>`
    <div class="convs-tl__item${c.event==="complete"?" done":""}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${re((qp[c.event]||(()=>c.event))(c.detail))}</div>
      <div class="convs-tl__time">${re(Sr(c.at))}${c.variant?` · Variant ${re(c.variant)}`:""}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      ...
      <div class="convs-drawer__body">
        ${n?`<a class="convs-drawer__lead" href="#/leads">
              <span class="convs-ava">${re(Ar(n))}</span>
        ...
        <div class="convs-sub" style="margin-bottom:6px">${re(o)} · ${re(Tr(t.duration_s))}${t.variant?` · Variant ${re(t.variant)}`:""}</div>
        ${r?`<div class="convs-tl">${r}</div>`:Na("timeline","No timeline available for this journey.")}
      </div>
    </aside>`,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("open"),i.querySelector(".convs-drawer").classList.add("open")});const l=()=>{i.classList.remove("open"),setTimeout(()=>i.remove(),220)};i.querySelector(".convs-drawer__close").addEventListener("click",l),i.addEventListener("click",c=>{c.target===i&&l()})}const Gp={render:Cr,init:$r},jp=Object.freeze(Object.defineProperty({__proto__:null,default:Gp,init:$r,render:Cr},Symbol.toStringTag,{value:"Module"})),Vp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},it=e=>String(e??"").replace(/[&<>"']/g,t=>Vp[t]),Fo=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},sa=()=>x.getConfig?.().BASE_URL||"",kt=e=>Number(e||0).toLocaleString(),Je={magnets:[],stats:{},canManage:!1},Wp={mag_title:"header title",mag_subtitle:"subtitle",mag_welcome:"welcome message",mag_theme_color:"color",mag_launcher_label:"launcher label"};let Do=!1;function Yp(){if(Do)return;const e=document.createElement("style");e.id="m5t-abt-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Do=!0}const On=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Ir(){return oe()?St({section:"ab-testing",title:"A/B Testing",description:"Pick a client to view their experiments."}):(Yp(),`
    ...
    </div>`)}async function Mn(){if(oe())return ht(sa(),[{h:"Running",td:t=>kt(t.ab_tests?.running)},{h:"Completed",td:t=>kt(t.ab_tests?.completed)},{h:"Compl. %",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Experiments appear per client once you have one."});const e=document.getElementById("abt-body");try{const t=new Date,a=new Date(t.getTime()-89*864e5).toISOString().slice(0,10),n=t.toISOString().slice(0,10),[o,s]=await Promise.all([fetch(`${sa()}/m5t/v5/magnets`),fetch(`${sa()}/m5t/v5/magnets/stats?from=${a}&to=${n}`)]),r=await o.json().catch(()=>({}));if(!r.ok)throw new Error(r.message||"Failed to load");Je.magnets=r.magnets||[],Je.canManage=!!r.canManage;const i=await s.json().catch(()=>({}));Je.stats=i?.stats||{}}catch(t){console.warn("[ab-testing] load failed:",t),e&&(e.innerHTML=On("error","Could not load your tests. Please try again."));return}Jp()}function Jp(){const e=document.getElementById("abt-body");if(!e)return;const t=Je.magnets.filter(n=>n.ab?.enabled),a=Je.magnets.filter(n=>!n.ab?.enabled&&n.ab?.declared);if(!t.length&&!a.length){e.innerHTML=On("science","No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.");return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(Zp).join("")}`:"")+(a.length?`<div class="abt-sect">Completed Tests</div>${a.map(eu).join("")}`:""),e.querySelectorAll("[data-declare]").forEach(n=>n.addEventListener("click",()=>tu(n.dataset.declare,n.dataset.winner)))}function Kp(e){const t=Je.stats[e.guid]?.variants||{},a={opens:0,engaged:0,completions:0,rate:null,...t.A||{}},n={opens:0,engaged:0,completions:0,rate:null,...t.B||{}};return{A:a,B:n}}function Qp(e){const t=Object.keys(e?.b||{}).map(a=>Wp[a]||a);return t.length?`Changes: ${t.join(", ")}`:""}function Xp(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function Bo(e,t,a,n,o,s){return`
    <div class="abt-variant${o?" leader":""}">
      <div class="abt-vhead"><span class="abt-vname">${it(e)}</span><span class="abt-vtag${o?" win":""}">${it(t)}</span></div>
      ${a?`<div class="abt-vdesc">${it(a)}</div>`:""}
      <div class="abt-mrow"><span class="k">Visitors</span><span class="v">${kt(n.opens)}</span></div>
      <div class="abt-mrow"><span class="k">Completions</span><span class="v">${kt(n.completions)}</span></div>
    ...
    </div>`}function Zp(e){const t=e.ab,{A:a,B:n}=Kp(e),o=(n.rate??-1)>(a.rate??-1)?"B":(a.rate??-1)>(n.rate??-1)?"A":null,s=o&&a.rate!=null&&n.rate!=null?`+${Math.round(Math.abs(n.rate-a.rate)*10)/10}%`:"",r=au(a,n),i=t.started_tz?Xp(t.started_tz):null,l=(a.opens||0)+(n.opens||0),c=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
        <h2 class="abt-name">${it(e.name)}</h2>
        <span class="abt-status running"><span class="pulse-dot"></span>Running</span>
        <div class="abt-actions">
          ${Je.canManage&&o?`<button class="btn btn-primary" type="button" data-declare="${it(e.guid)}" data-winner="${o}"><span class="material-symbols-outlined" aria-hidden="true">emoji_events</span>Declare Winner</button>`:""}
        </div>
      </div>
      <div class="abt-meta">
        ${i!=null?`<span><span class="material-symbols-outlined" aria-hidden="true">schedule</span>Started ${i===0?"today":`${i} day${i===1?"":"s"} ago`}</span>`:""}
        <span><span class="material-symbols-outlined" aria-hidden="true">visibility</span>${kt(l)} total visitors</span>
      ...
      <div class="abt-compare">
        ${Bo("Variant A","Control","The magnet as configured",a,o==="A",o==="A"?s:"")}
        <div class="abt-vs">VS</div>
        ${Bo("Variant B",o==="B"?"Leading":"Challenger",Qp(t),n,o==="B",o==="B"?s:"")}
      </div>
      <div class="abt-sig">
    ...
    <div class="abt-card">
      ...
      <div class="abt-summary">
        <span><span class="k">Winner:</span><span class="v">Variant ${it(t.winner)}</span></span>
        ...
        <span><span class="k">Total Visitors:</span><span class="v">${kt(r)}</span></span>
      </div>
    </div>`}async function tu(e,t){const a=Je.magnets.find(n=>n.guid===e);if(a&&window.confirm(`Declare Variant ${t} the winner for “${a.name}”?

${t==="B"?"Variant B’s changes become the magnet’s configuration for everyone.":"The magnet keeps its current configuration."} The experiment ends and moves to Completed.`)){try{const o=await(await fetch(`${sa()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Declare failed");Fo(`Variant ${t} declared the winner`,"success")}catch(n){Fo(n.message||"Could not declare a winner","danger");return}try{await Mn()}catch(n){console.warn("[ab-testing] refresh after declare failed:",n)}}}function au(e,t){const a=e.opens||0,n=t.opens||0,o=e.completions||0,s=t.completions||0;if(a<30||n<30||o+s<5)return null;const r=o/a,i=s/n,l=(o+s)/(a+n),c=Math.sqrt(l*(1-l)*(1/a+1/n));if(!c)return null;const d=Math.abs(i-r)/c;return Math.round(2*(nu(d)-.5)*1e3)/10}function nu(e){const t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}const ou={render:Ir,init:Mn},su=Object.freeze(Object.defineProperty({__proto__:null,default:ou,init:Mn,render:Ir},Symbol.toStringTag,{value:"Module"})),ru={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},le=e=>String(e??"").replace(/[&<>"']/g,t=>ru[t]),Rr=()=>x.getConfig?.().BASE_URL||"",iu={single_select:{icon:"quiz",color:"#0072BA",darkColor:"#38BDF8"},multi_select:{icon:"checklist",color:"#0E6BA8",darkColor:"#22D3EE"},scheduler:{icon:"event",color:"#915E8B",darkColor:"#E879F9"},text:{icon:"short_text",color:"#5B54C6",darkColor:"#A78BFA"},email:{icon:"mail",color:"#0E8F86",darkColor:"#2DD4BF"},phone:{icon:"call",color:"#2E8B57",darkColor:"#4ADE80"},message:{icon:"chat",color:"#B4791F",darkColor:"#FBBF24"}},ha={};kn.forEach(e=>{ha[e.value]={label:e.label,...iu[e.value]||{icon:"quiz",color:"#0072BA",darkColor:"#38BDF8"}}});const Nr=kn.map(e=>e.value),Or={chat:"Chat / default",book:"Book (scheduler)",support:"Support (intake)"},Pn=e=>{const t=ha[e]||ha.single_select;return document.documentElement.getAttribute("data-theme")==="dark"?{...t,color:t.darkColor}:t},ft=e=>e==="single_select"||e==="multi_select",Oa=e=>e!=="message",Tt=e=>e==="scheduler",Jt=e=>e==="message",fa=e=>e==="email"?"email":e==="phone"?"phone":"",Ct=()=>({meeting_label:"",start:"09:00",end:"17:00",mins:30,days:14}),lu=["meeting_label","start","end","mins","days"],Uo=["terminal","cta"];function mn(e,t){const a={};return Object.keys(e&&typeof e=="object"?e:{}).forEach(n=>{t.includes(n)||(a[n]=e[n])}),Object.keys(a).length?a:null}function Mr(e){return mn(e,lu)}const cu=[["","No icon"],["event","Calendar"],["schedule","Clock"],["mail","Email"],["sms","Text"],["phone","Phone"],["chat","Chat"],["description","Document"],["help","Question"],["place","Location"],["person","Person"],["bolt","Quick"],["check_circle","Check"],["star","Star"],["home","Home"],["build","Service"]];function du(e,t){const a=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||"").trim());return a?`rgba(${parseInt(a[1],16)},${parseInt(a[2],16)},${parseInt(a[3],16)},${t})`:`rgba(0,114,186,${t})`}let Ho=!1;function pu(){if(Ho)return;const e=document.createElement("style");e.id="m5t-flow-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Ho=!0}let F=[],Me=null,uu=0,Ge=null,ot=null,st="chat",ke={},ra=[],Pr=null,gn=null,ia="";const At=()=>"f"+ ++uu;function Fn(e="single_select"){return{_uid:At(),id:"",step_type:e,step_prompts:[""],step_options:ft(e)?[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]:[],step_columns:fa(e)?[fa(e)]:[],step_description:"",step_config:Tt(e)?Ct():null}}function mu(e){return(Array.isArray(e)?e:[]).map(t=>({_uid:At(),id:t.id!=null?String(t.id):"",step_type:ha[t.step_type]?t.step_type:"single_select",step_prompts:Array.isArray(t.step_prompts)?t.step_prompts.map(String):[],step_options:(Array.isArray(t.step_options)?t.step_options:[]).map(a=>({label:a&&a.label!=null?String(a.label):"",goto:a&&a.goto!=null?String(a.goto):"",icon:a&&a.icon!=null?String(a.icon):""})),step_columns:Array.isArray(t.step_columns)?t.step_columns.map(String):[],step_description:t.step_description!=null?String(t.step_description):"",step_config:Tt(t.step_type)?{...Ct(),...t.step_config&&typeof t.step_config=="object"?t.step_config:{}}:t.step_config&&typeof t.step_config=="object"?{...t.step_config}:null}))}function qo(){return[{_uid:At(),id:"",step_type:"text",step_prompts:["Great, and your name?"],step_options:[],step_columns:["first_name"],step_description:"",step_config:null},{_uid:At(),id:"",step_type:"email",step_prompts:["The best email to reach you?"],step_options:[],step_columns:["email"],step_description:"",step_config:null}]}function gu(e,t){if(e==="book")return[{_uid:At(),id:"",step_type:"scheduler",step_prompts:["When works best for you?"],step_options:[],step_columns:[],step_description:"",step_config:Ct()},...qo()];if(e==="support"){const a=(t.actions||[]).find(s=>s&&s.type==="support"),n=a&&a.config&&Array.isArray(a.config.options)?a.config.options:[],o=n.length?n.map(s=>({label:s&&s.label||String(s),goto:"",icon:s&&s.icon||""})):["Sales enquiry","Support","Billing","Something else"].map(s=>({label:s,goto:"",icon:""}));return[{_uid:At(),id:"",step_type:"multi_select",step_prompts:["How can we help you today?"],step_options:o,step_columns:[],step_description:"Select all that apply",step_config:null},...qo()]}return[Fn("single_select")]}function Fr(e,t){const a=e==="chat"?t.steps:t.routes&&t.routes[e],n=mu(a);return n.length?n:e==="chat"?[Fn("single_select")]:gu(e,t)}function hu(e){ft(e.step_type)?e.step_options.length||(e.step_options=[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]):e.step_options=[],Oa(e.step_type)?!e.step_columns.length&&fa(e.step_type)&&(e.step_columns=[fa(e.step_type)]):e.step_columns=[],e.step_config=Tt(e.step_type)?{...Ct(),...e.step_config||{}}:Mr(e.step_config)}function fu(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${le(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${cu.map(([a,n])=>`<option value="${le(a)}"${a===e.icon?" selected":""}>${le(n)}</option>`).join("")}</select>
  ...
  </div>`}function vu(e){const t=Nr.map(n=>`<option value="${n}"${n===e.step_type?" selected":""}>${le(Pn(n).label)}</option>`).join(""),a=e.step_options.length<=1;return`<div class="flow-node__body">
...
`))}</textarea>
    ...
    <select class="mag-modal__select flow-f-field">
      ...
      ${En.map(n=>`<option value="${le(n.value)}"${n.value===e.step_columns[0]?" selected":""}>${le(n.label)}</option>`).join("")}
    </select>
    ...
    <div class="flow-opts">${e.step_options.map(n=>fu(n,a)).join("")}</div>
  ...
  </div>`}function bu(e){const t=e.step_prompts.find(o=>String(o).trim()!=="")||"",a=t?`<div class="flow-node__prompt">“${le(t)}”</div>`:`<div class="flow-node__prompt is-empty">${e.step_type==="message"?"No message yet":"No question yet"}</div>`;let n="";if(ft(e.step_type)){const o=e.step_options.map(s=>String(s.label).trim()).filter(Boolean);if(o.length){const s=o.slice(0,4).map(i=>`<span class="flow-node__chip">${le(i)}</span>`).join(""),r=o.length>4?`<span class="flow-node__chip">+${o.length-4}</span>`:"";n=`<div class="flow-node__chips">${s}${r}</div>`}}else if(Oa(e.step_type)&&e.step_columns[0]){const o=En.find(s=>s.value===e.step_columns[0])?.label||e.step_columns[0];n=`<div class="flow-node__meta">Saves to <b>${le(o)}</b></div>`}else if(Jt(e.step_type)&&e.step_config?.terminal){const o=String(e.step_config?.cta?.label||"").trim();n=`<div class="flow-node__meta">Ends the conversation${o?` — link: <b>${le(o)}</b>`:""}</div>`}return`<div class="flow-node__preview">${a}${n}</div>`}function _u(e,t,a){const n=Pn(e.step_type),o=e._uid===Me,s=`--nc:${n.color};--nct:${du(n.color,.14)}`;return`<div class="flow-node${o?" flow-node--open":""}" data-uid="${e._uid}" style="${s}"${o?"":' draggable="true"'}>
    ...
    ${o?vu(e):bu(e)}
  </div>`}const zo='<div class="flow-conn"><span class="flow-conn__line"></span><span class="material-symbols-outlined" aria-hidden="true">expand_more</span></div>';function Se(){const e=document.getElementById("flow-nodes");if(!e)return;const t=F.length,a=['<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>',zo];F.forEach((n,o)=>{a.push(_u(n,o,t)),o<t-1&&a.push(zo)}),e.innerHTML=a.join("")}function Pe(){const e=document.querySelector(".flow-node--open");if(!e)return;const t=F.find(s=>s._uid===e.dataset.uid);if(!t)return;const a=e.querySelector(".flow-f-type");a&&(t.step_type=a.value);const n=e.querySelector(".flow-f-prompts");n&&(t.step_prompts=n.value.split(`
`));const o=e.querySelector(".flow-f-field");if(t.step_columns=o&&o.value.trim()?[o.value.trim()]:[],ft(t.step_type)){const s=t.step_options,r=[];e.querySelectorAll(".flow-opt").forEach((i,l)=>{r.push({label:i.querySelector(".flow-o-label")?.value??"",icon:i.querySelector(".flow-o-icon")?.value??"",goto:s[l]&&s[l].goto||""})}),t.step_options=r}else t.step_options=[];if(Tt(t.step_type)){const s=e.querySelector(".flow-f-mtlabel"),r=e.querySelector(".flow-f-start"),i=e.querySelector(".flow-f-end"),l=e.querySelector(".flow-f-mins");t.step_config={...t.step_config||Ct(),...s?{meeting_label:s.value.trim()}:{},...r&&r.value?{start:r.value}:{},...i&&i.value?{end:i.value}:{},...l?{mins:parseInt(l.value,10)||30}:{}}}else if(Jt(t.step_type)){const s=e.querySelector(".flow-f-terminal");if(s){const r=e.querySelector(".flow-f-cta-label"),i=e.querySelector(".flow-f-cta-url"),l=mn(t.step_config,Uo)||{};t.step_config=s.checked?{...l,terminal:!0,cta:{label:r?r.value:"",url:i?i.value:""}}:mn(t.step_config,Uo)}}else t.step_config=Mr(t.step_config)}function Dr(){document.querySelectorAll(".flow-node.drop-before, .flow-node.drop-after").forEach(e=>e.classList.remove("drop-before","drop-after"))}function Rt(){Dr(),document.querySelectorAll(".flow-node.dragging").forEach(e=>e.classList.remove("dragging")),Ge=null,ot=null}function yu(e=F){if(!e.length)return{message:"Add at least one step.",uid:null,field:null};for(let t=0;t<e.length;t++){const a=e[t],n=t+1,o=(s,r=null)=>({message:s,uid:a._uid,field:r});if(!a.step_prompts.some(s=>String(s).trim()!==""))return o(`Step ${n}: add what the magnet should say.`,"prompts");if(ft(a.step_type)&&!a.step_options.some(s=>String(s.label).trim()!==""))return o(`Step ${n}: add at least one choice.`,"options");if(Oa(a.step_type)&&!a.step_columns.length)return o(`Step ${n}: choose which field this answer saves to.`,"field");if(Jt(a.step_type)&&a.step_config?.terminal){const s=String(a.step_config.cta?.label||"").trim(),r=String(a.step_config.cta?.url||"").trim();if(!!s!=!!r)return o(`Step ${n}: fill in both the link label and URL, or leave both blank.`,"cta")}}return null}function Br(e){if(!e)return;const t=e.querySelector(".flow-f-cta-label"),a=e.querySelector(".flow-f-cta-url");if(!t||!a)return;const n=t.value.trim()!=="",o=a.value.trim()!=="",s=n||o,r=n!==o;e.querySelectorAll(".flow-cta-req").forEach(l=>{l.textContent=s?"required":"optional",l.classList.toggle("flow-sub--req",s)}),t.classList.toggle("flow-f-invalid",r&&!n),a.classList.toggle("flow-f-invalid",r&&!o);const i=e.querySelector(".flow-cta-warn");i&&(i.hidden=!r)}function hn(e=F){let t=0;return e.forEach(a=>{const n=parseInt(a.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(a=>{const n=a.id&&String(a.id).trim()?String(a.id):String(++t),o=ft(a.step_type)?a.step_options.map(r=>{const i={label:String(r.label).trim(),goto:String(r.goto||"")};return r.icon&&(i.icon=String(r.icon)),i}).filter(r=>r.label!==""):[],s={id:n,step_type:a.step_type,step_prompts:a.step_prompts.map(r=>String(r)).filter(r=>r.trim()!==""),step_options:o,step_columns:a.step_columns.slice(),step_description:a.step_description||""};if(Tt(a.step_type))a.step_config&&(s.step_config={...Ct(),...a.step_config});else if(a.step_config&&Object.keys(a.step_config).length){const r={...a.step_config};if(Jt(a.step_type)&&r.terminal){const i=String(r.cta?.label??"").trim(),l=String(r.cta?.url??"").trim();i&&l?r.cta={label:i,url:l}:delete r.cta}s.step_config=r}return s})}function wu(e,t,a){pu(),Pr=t,gn=typeof a=="function"?a:null,ia=t?.modified_tz||"",ra=["chat",...["book","support"].filter(n=>(t.actions||[]).some(o=>o&&o.type===n))],ke={chat:Fr("chat",t)},st="chat",F=ke.chat,Me=F.length===1?F[0]._uid:null,Ge=null,ot=null,e.innerHTML=`
    ...
    ${ra.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${ra.map(n=>`<option value="${n}">${le(Or[n]||n)}</option>`).join("")}</select></div>`:""}
...
<body>
  ...
  <\/script>
  <script>${a}<\/script>
</body></html>`}let jo=!1;function Hr(){if(jo)return;const e=document.createElement("style");e.id="m5t-preview-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),jo=!0}function qr(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function zr(e){const t=e.querySelector("[data-pv-info]"),a=e.querySelector("[data-pv-info-pop]");t&&a&&t.addEventListener("click",()=>{a.hidden=!a.hidden})}function Cu(e,t){Hr(),e.innerHTML=`
    <div class="pv-pane">
      ...
      ${qr("Live render of the real widget. Capture is disabled, so no test leads.")}
    </div>`,zr(e);const a=e.querySelector(".pv-pane__frame"),n=e.querySelector(".pv-pane__badge");let o=null,s=0;const r=450,i=()=>{const c=(typeof performance<"u"?performance.now():Date.now())-s;clearTimeout(o),c<r?o=setTimeout(()=>{n.hidden=!0},r-c):n.hidden=!0};a.addEventListener("load",i);const l=()=>{let c;try{c=Ur(t())}catch{return}s=typeof performance<"u"?performance.now():Date.now(),n.hidden=!1,a.srcdoc=c,clearTimeout(o),o=setTimeout(()=>{n.hidden=!0},1500)};return e.querySelector(".pv-pane__seg").addEventListener("click",c=>{const d=c.target.closest("button[data-device]");!d||d.dataset.device===a.dataset.device||(e.querySelectorAll(".pv-pane__seg button").forEach(f=>f.classList.toggle("is-on",f===d)),a.dataset.device=d.dataset.device)}),l(),{refresh:l,destroy(){clearTimeout(o)}}}function Dn(e){Hr();let t="desktop";const a=document.createElement("div");a.className="pv-scrim",a.innerHTML=`
    ...
    </div>`}const Ru=300*1e3;function Nu(e){Ln(pt.MAGNET_TEMPLATE,{id:e,at:Date.now()})}function Vr(e){if(!e)return null;if(typeof e=="string")return Ke.find(n=>n.id===e)||null;const{id:t,at:a}=e;return typeof a=="number"&&Date.now()-a>=Ru?null:Ke.find(n=>n.id===t)||null}function Ou(){return Vr(on(pt.MAGNET_TEMPLATE))}function Mu(){return Vr(jc(pt.MAGNET_TEMPLATE))}let Wo=!1;function Wr(){if(Wo)return;const e=document.createElement("style");e.id="m5t-mag-template-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Wo=!0}function Pu(e){Wr();const t=document.createElement("div");t.className="mag-modal-scrim mag-tpl-modal",t.innerHTML=`
  ...
  <div class="mag-csp-note__body">
    <p>A strict CSP can silently block the widget — it just never appears, no visible error. Allowlist <code>${w(ae())}</code> under all three directives. Copy-paste ready for your CSP header/meta tag:</p>
    <pre class="mag-csp-note__snippet"><code>script-src 'self' ${w(ae())};
connect-src 'self' ${w(ae())};
img-src 'self' ${w(ae())};</code></pre>
    <ul>
...
</details>`,Kr={chat:"Chat bubble",right_slide:"Slide-in panel",modal:"Modal",inline:"Inline"},Du={chat:"chat",right_slide:"vertical_split",modal:"web_asset",inline:"view_agenda"},Qr=[{value:"inline",icon:"view_agenda",label:"Inline"},{value:"chat",icon:"chat",label:"Chat"},{value:"right_slide",icon:"vertical_split",label:"Slide"},{value:"modal",icon:"web_asset",label:"Modal"}],Xr=[{value:"auto",icon:"brightness_auto",label:"Auto"},{value:"light",icon:"light_mode",label:"Light"},{value:"dark",icon:"dark_mode",label:"Dark"}],Zr=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],Bn={book:{label:"Book",icon:"event",kind:"book"},chat:{label:"Chat",icon:"chat",kind:"flow"},call:{label:"Call",icon:"phone",kind:"value",placeholder:"Phone number"},email:{label:"Email",icon:"mail",kind:"value",placeholder:"Email address"},support:{label:"Support",icon:"support_agent",kind:"support"}},ei=["book","chat","call","email","support"];let la=null;async function Bu(){if(la)return la;let e;try{const t=await fetch(`${ae()}/m5t/v5/integrations/calendly/event_types`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.event_types||[],scheduling_url:a.data.scheduling_url||""}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(la=e),e}async function Uu(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved Calendly event";e.innerHTML=`<option value="${w(t)}">${t?w(a):"Loading event types"}</option>`;const n=await Bu();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${w(t)}" selected>${w(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect Calendly under Settings, Integrations first":"Could not load event types"}</option>`;return}const o=[];n.scheduling_url&&o.push({url:n.scheduling_url,label:"Full scheduling page (visitor picks the event)"}),n.list.forEach(s=>o.push({url:s.scheduling_url,label:s.duration?`${s.name} (${s.duration} min)`:s.name})),t&&!o.some(s=>s.url===t)&&o.unshift({url:t,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${w(s.url)}"${s.url===(t||o[0].url)?" selected":""}>${w(s.label)}</option>`).join(""):'<option value="">No active event types</option>'}let ca=null;async function Hu(){if(ca)return ca;let e;try{const t=await fetch(`${ae()}/m5t/v5/integrations/callrail/trackers`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.trackers||[]}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(ca=e),e}async function qu(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved tracking number";e.innerHTML=`<option value="${w(t)}">${t?w(a):"Loading tracking numbers"}</option>`;const n=await Hu();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${w(t)}" selected>${w(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect CallRail under Settings, Integrations first":"Could not load tracking numbers"}</option>`;return}const o=n.list.map(s=>({number:s.number,id:s.id,name:s.name,label:`${s.name} · ${s.number}${s.type==="session"?" (number pool)":""}`}));t&&!o.some(s=>s.number===t)&&o.unshift({number:t,id:e.dataset.savedId||"",name:a,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${w(s.number)}" data-tracker-id="${w(s.id)}" data-tracker-name="${w(s.name)}"${s.number===(t||o[0].number)?" selected":""}>${w(s.label)}</option>`).join(""):'<option value="">No active tracking numbers in this company</option>'}function Jo(e,t,a){return`<div class="mag-seg" role="radiogroup" aria-label="${w(e)}">${a.map(n=>`
    <label><input type="radio" name="${w(e)}" value="${w(n.value)}"${n.value===t?" checked":""}>
      <span><span class="material-symbols-outlined" aria-hidden="true">${w(n.icon)}</span>${w(n.label)}</span></label>`).join("")}</div>`}function zu(e,t){const a=Bn[e],n=!!t,o=n?"":" disabled";let s="";if(a.kind==="value"&&e==="call"){const i=t?.config?.source==="callrail",l=i&&t?.value||"",c=i?t?.config?.tracker_name||"Saved tracking number":"";s=`
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${a.kind}">
    ...
    ${r}
  </div>`}function Gu(){if(Yo)return;const e=document.createElement("style");e.id="m5t-magnets-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Yo=!0}function ba(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function ju(e){const t=G.stats[e];if(!t||!t.opens&&!t.leads)return'<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>';const a=n=>Number(n||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function Un(e){const t=G.owners.length>1||x.getMemberships().length>1,a=(e.domains||[]).filter(Boolean),n=G.canManage;return`
    <div class="mag-card" data-guid="${w(e.guid)}">
      ...
      <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${Du[e.display_mode]||"chat"}</span>${w(Kr[e.display_mode]||"Chat bubble")}${e.ab?.enabled?'&nbsp;&nbsp;<span class="mag-ab-chip"><span class="material-symbols-outlined" aria-hidden="true">science</span>A/B</span>':""}${(e.notify_emails||[]).length?`&nbsp;&nbsp;<a class="mag-alert-chip" href="#/settings/notifications" title="Lead alerts to ${(e.notify_emails||[]).length} email${(e.notify_emails||[]).length===1?"":"s"}. Manage in Settings."><span class="material-symbols-outlined" aria-hidden="true">notifications_active</span>${(e.notify_emails||[]).length}</a>`:""}</span>
      ${ju(e.guid)}
      <div class="mag-domains">${a.length?a.map(o=>w(o)).join(", "):"<span>No domains set. Add yours to go live.</span>"}</div>
      <div class="mag-embed">
        <input type="text" readonly value="${w(Yr(e.guid))}" aria-label="Embed snippet">
    ...
    </div>`}function Vu(){return oe()?St({section:"magnets",title:"Your Magnets",description:"Pick a client to view and manage their magnets."}):(Gu(),`
    <div class="page-shell" data-section="magnets">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="mag-body">
          ${ba("hourglass_empty","Loading magnets…")}
        </div>
      </div>
    </div>`)}async function Wu(){if(oe()){const a=Mu();if(a){const o=document.querySelector(".page-shell .page-header-text .page-description");o&&(o.textContent=`Template picked: ${a.name}. Choose the client to build it for.`)}const n=o=>Number(o||0).toLocaleString();return ht(ae(),[{h:"Magnets",td:o=>`${n(o.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${n(o.magnets.total)}</span>`},{h:"Leads · wk",td:o=>n(o.leads.this_week)},{h:"Leads · total",td:o=>n(o.leads.total)}],{emptyMsg:"No client orgs yet. Create one under Clients, then provision its magnets here."})}la=null,ca=null,document.getElementById("mag-new-btn")?.addEventListener("click",Ku),document.getElementById("mag-template-btn")?.addEventListener("click",Qu),document.getElementById("mag-body")?.addEventListener("click",Xu),await Kt();const t=Ou();t&&G.canProvision&&ai(t)}async function Kt(){const e=document.getElementById("mag-body");if(!e)return;try{const[n,o]=await Promise.all([fetch(`${ae()}/m5t/v5/magnets`),fetch(`${ae()}/m5t/v5/magnets/stats`).catch(()=>null)]),s=await n.json().catch(()=>({}));if(!s.ok)throw new Error(s.message||"Failed to load");G.magnets=s.magnets||[],G.owners=s.owners||[],G.canProvision=!!s.canProvision,G.canManage=!!s.canManage,G.primaryOrgGuid=s.primaryOrgGuid||null;const r=o?await o.json().catch(()=>({})):{};G.stats=r?.stats||{}}catch{e.innerHTML=ba("error","Could not load your magnets. Please try again.");return}const t=document.getElementById("mag-new-btn");t&&(t.style.display=G.canProvision?"":"none");const a=document.getElementById("mag-template-btn");if(a&&(a.style.display=G.canProvision?"":"none"),!G.magnets.length){e.innerHTML=ba("widgets",G.canProvision?"No magnets yet. Click “New magnet” to create your first.":"No magnets yet.");return}e.innerHTML=`<div class="mag-grid">${G.magnets.map(Un).join("")}</div>`}async function Yu(e){const t={"Content-Type":"application/json","Idempotency-Key":crypto.randomUUID()},a={status:"DRAFT"};e&&(a.owner_guid=e);const n=await fetch(`${ae()}/m5t/v5/magnets`,{method:"POST",headers:t,body:JSON.stringify(a)});let o={};try{o=await n.json()}catch{}if(!n.ok||!o.ok)throw new Error(o.message||`Could not start a new magnet (${n.status})`);return o.magnet}async function Ju(e,t){const a=await fetch(`${ae()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t.name,...t.appearance,steps:t.steps})});let n={};try{n=await a.json()}catch{}if(!a.ok||!n.ok)throw new Error(n.message||`Could not apply the ${t.name} template (${a.status})`)}async function Hn(e,t){const a=document.getElementById("mag-new-btn"),n=document.getElementById("mag-template-btn");a&&(a.disabled=!0),n&&(n.disabled=!0);let o=null;try{let s=await Yu(e);if(o=s.guid,t)await Ju(s.guid,t),await Kt(),s=G.magnets.find(r=>r.guid===s.guid)||s;else{G.magnets=[s,...G.magnets];const r=document.getElementById("mag-body");r&&(r.innerHTML=`<div class="mag-grid">${G.magnets.map(Un).join("")}</div>`)}_a(s,void 0,{freshDraft:!0})}catch(s){o&&fetch(`${ae()}/m5t/v5/magnets/${encodeURIComponent(o)}`,{method:"DELETE"}).catch(()=>{}),ze(s.message||"Could not start a new magnet","danger")}finally{a&&(a.disabled=!1),n&&(n.disabled=!1)}}function ti(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="Choose client" style="max-width:420px">
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(o){o.key==="Escape"&&(o.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.querySelector('[data-x="cancel"]').addEventListener("click",a),t.querySelector('[data-x="continue"]').addEventListener("click",()=>{const o=t.querySelector("#mag-owner-pick").value;a(),Hn(o,e)})}function Ku(){if(G.owners.length>1){ti();return}Hn(null)}function ai(e){if(G.owners.length>1){ti(e);return}Hn(null,e)}function Qu(){Pu(ai)}function Xu(e){const t=e.target.closest("[data-action]");if(!t)return;const a=t.dataset.guid,n=G.magnets.find(s=>s.guid===a),o=t.dataset.action;if(o==="copy")return Zu(a);if(n){if(o==="preview")return Dn(()=>va(n));if(o==="funnel")return em(n);if(o==="edit")return _a(n);if(o==="flow")return _a(n,"flow");if(o==="toggle")return tm(n);if(o==="delete")return am(n)}}async function Zu(e){try{await navigator.clipboard.writeText(Yr(e)),ze("Embed snippet copied","success")}catch{ze("Copy failed","danger")}}function ni(e){const t=Number(e?.total_steps)||0,a={};if((Array.isArray(e?.funnel)?e.funnel:[]).forEach(s=>{a[s.position]=Number(s.reached)||0}),!t||!Object.keys(a).length)return'<p class="mag-modal__hint" style="margin:0">No step activity yet in this window. As visitors answer questions, drop-off by step will appear here.</p>';const n=Math.max(1,a[1]||0),o=[];for(let s=1;s<=t;s++){const r=a[s]||0,i=Math.min(100,Math.round(r/n*100));o.push(`
      ...
      </div>`)}return`<div class="mag-funnel">${o.join("")}</div>`}async function em(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal mag-funnel-modal" role="dialog" aria-modal="true" aria-label="Step funnel for ${w(e.name)}">
      ...
      <div class="mag-modal__body" style="padding:20px">
        ...
        <div id="mag-funnel-body">${ba("hourglass_empty","Loading…")}</div>
      </div>
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(s){s.key==="Escape"&&(s.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.addEventListener("click",s=>{s.target===t&&a()});const o=t.querySelector("#mag-funnel-body");try{const s=await fetch(`${ae()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/step-funnel`),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.message||`Failed (${s.status})`);o.innerHTML=ni(r)}catch{o.innerHTML='<p class="mag-modal__hint" style="margin:0">Could not load the funnel. Please try again.</p>'}}async function tm(e){if(e.status==="DRAFT"){ze("Open Edit and Save to publish a draft magnet.","info");return}const t=e.status==="ENABLED"?"DISABLED":"ENABLED";try{if(!(await(await fetch(`${ae()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw new Error;ze(t==="ENABLED"?"Magnet enabled":"Magnet disabled","success")}catch{ze("Update failed","danger");return}try{await Kt()}catch(a){console.warn("[magnets] refresh after status toggle failed:",a)}}async function am(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`)){try{if(!(await(await fetch(`${ae()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"})).json().catch(()=>({}))).ok)throw new Error;ze("Magnet deleted","success")}catch{ze("Delete failed","danger");return}try{await Kt()}catch(t){console.warn("[magnets] refresh after delete failed:",t)}}}function Ka(e){const t=[];return e.querySelectorAll(".mag-cta").forEach(a=>{if(!a.querySelector(".mag-cta__on").checked)return;const n=a.dataset.type,o=a.dataset.kind,s=a.querySelector(".mag-cta__val"),r=s?s.value.trim():"";if(o==="value")if(n==="call"&&a.querySelector(".mag-cta__callsrc")?.value==="callrail"){const i=a.querySelector(".mag-cta__crtracker"),l=i?.value||"",c=i?.selectedOptions?.[0];l&&t.push({type:n,value:l,config:{source:"callrail",...c?.dataset?.trackerId?{tracker_id:c.dataset.trackerId}:{},...c?.dataset?.trackerName?{tracker_name:c.dataset.trackerName}:{}}})}else r&&t.push({type:n,value:r});else if(o==="book")if(a.querySelector(".mag-cta__booksrc")?.value==="calendly"){const i=a.querySelector(".mag-cta__calevent"),l=i?.value||"",c=(i?.selectedOptions?.[0]?.textContent||"").trim();t.push({type:n,config:{source:"calendly",...l?{calendly_url:l}:{},...l&&c?{event_name:c}:{}}})}else{const i={type:n};r&&(/^https?:\/\//i.test(r)?i.value=r:i.config={meeting_label:r}),t.push(i)}else if(o==="support"){const i=(a.querySelector(".mag-cta__opts")?.value||"").split(`
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:oi(e),actions:t,font:e.querySelector("#mag-f-font").value.trim(),theme_vars:lm(e),inline_width:e.querySelector("#mag-f-inline-w").value.trim(),inline_height:e.querySelector("#mag-f-inline-h").value.trim(),hide_launcher:e.querySelector("#mag-f-hide-launcher").checked,input_placeholder:e.querySelector("#mag-f-input-ph").value,summary_confirm_label:e.querySelector("#mag-f-summary-confirm").value.trim(),success_title:e.querySelector("#mag-f-success-title").value.trim(),success_text:e.querySelector("#mag-f-success-text").value,success_cta:cm(e)}}const nm=512,om=new Set(["image/png","image/jpeg","image/gif","image/webp"]),sm=8*1024*1024;function rm(e){return new Promise((t,a)=>{const n=new Image,o=new FileReader;o.onerror=()=>a(new Error("Could not read that file.")),o.onload=()=>{n.onerror=()=>a(new Error("That file isn’t a readable image.")),n.onload=()=>{const s=Math.min(1,nm/Math.max(n.naturalWidth,n.naturalHeight)),r=Math.max(1,Math.round(n.naturalWidth*s)),i=Math.max(1,Math.round(n.naturalHeight*s)),l=document.createElement("canvas");l.width=r,l.height=i,l.getContext("2d").drawImage(n,0,0,r,i),t(l.toDataURL("image/png"))},n.src=o.result},o.readAsDataURL(e)})}function im(e,t){const a=e.querySelector("#mag-logo-drop");if(!a)return;const n=e.querySelector("#mag-f-logo-file"),o=e.querySelector("#mag-logo-browse"),s=e.querySelector("#mag-logo-remove"),r=e.querySelector("#mag-logo-preview"),i=e.querySelector("#mag-logo-status"),l=e.querySelector("#mag-f-logo"),c=(h,u)=>{i.textContent=h,i.style.color=u?"var(--color-danger, #DD4124)":""},d=h=>{r.innerHTML=h?`<img src="${w(h)}" alt="">`:'<span class="material-symbols-outlined" aria-hidden="true">image</span>',s.hidden=!h},f=h=>{l.value=h,l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))};async function v(h){if(!om.has(h.type)){c("PNG, JPEG, GIF, or WEBP only.",!0);return}if(h.size>sm){c("That file is too large (8MB max before resizing).",!0);return}c("Uploading…",!1);try{const u=await rm(h),p=await fetch(`${ae()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({image:u})}),b=await p.json().catch(()=>({}));if(!p.ok||!b.ok)throw new Error(b.error||`Upload failed (${p.status})`);const y=`${ae()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;f(y),d(y),c("Logo updated.",!1)}catch(u){c(u.message||"Upload failed.",!0)}}n.addEventListener("change",()=>{n.files[0]&&v(n.files[0]),n.value=""}),a.addEventListener("click",h=>{h.target===s||s.contains(h.target)||h.target!==o&&n.click()}),o.addEventListener("click",()=>n.click()),["dragenter","dragover"].forEach(h=>a.addEventListener(h,u=>{u.preventDefault(),a.classList.add("is-dragover")})),["dragleave","drop"].forEach(h=>a.addEventListener(h,u=>{u.preventDefault(),a.classList.remove("is-dragover")})),a.addEventListener("drop",h=>{const u=h.dataTransfer?.files?.[0];u&&v(u)}),s.addEventListener("click",async h=>{h.stopPropagation(),c("Removing…",!1);try{const u=await fetch(`${ae()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"DELETE"}),p=await u.json().catch(()=>({}));if(!u.ok||!p.ok)throw new Error(p.error||`Remove failed (${u.status})`);f(""),d(""),c("Logo removed.",!1)}catch(u){c(u.message||"Remove failed.",!0)}})}function lm(e){return e.querySelector("#mag-f-surface-on")?.checked?{surface:e.querySelector("#mag-f-sv-surface").value,surface_2:e.querySelector("#mag-f-sv-surface2").value,border:e.querySelector("#mag-f-sv-border").value,text:e.querySelector("#mag-f-sv-text").value,text_sub:e.querySelector("#mag-f-sv-textsub").value}:{}}function cm(e){const t=e.querySelector("#mag-f-success-cta-label").value.trim(),a=e.querySelector("#mag-f-success-cta-url").value.trim();return t&&a?{label:t,url:a}:{}}function oi(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",s=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==s.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}const fn=[{label:"Web fonts (loaded for you)",opts:[["Inter, sans-serif","Inter"],["Poppins, sans-serif","Poppins"],["Montserrat, sans-serif","Montserrat"],["Roboto, sans-serif","Roboto"],['"Open Sans", sans-serif',"Open Sans"],["Lato, sans-serif","Lato"],["Nunito, sans-serif","Nunito"],["Raleway, sans-serif","Raleway"],['"Work Sans", sans-serif',"Work Sans"],["Oswald, sans-serif","Oswald"],["Merriweather, serif","Merriweather (serif)"]]},{label:"System / always available",opts:[["system-ui, sans-serif","System UI"],["Georgia, serif","Georgia (serif)"],['"Times New Roman", Times, serif',"Times (serif)"],["Arial, Helvetica, sans-serif","Arial / Helvetica"],["Verdana, Geneva, sans-serif","Verdana"],['"Courier New", monospace',"Courier (mono)"]]}];function dm(e){const t=String(e||""),a=new Set(fn.flatMap(s=>s.opts.map(([r])=>r))),n=s=>s===t?" selected":"";let o=`<option value=""${t===""?" selected":""}>System default</option>`;t&&!a.has(t)&&(o+=`<option value="${w(t)}" selected>Current: ${w(t)}</option>`);for(const s of fn)o+=`<optgroup label="${w(s.label)}">`+s.opts.map(([r,i])=>`<option value="${w(r)}"${n(r)}>${w(i)}</option>`).join("")+"</optgroup>";return o}function _a(e,t,a={}){const{freshDraft:n=!1}=a,o=!!e,s=o?null:crypto.randomUUID(),r=!o&&G.owners.length>1,i=e?.display_mode||"chat",l=e?.theme_mode||"auto",c={};(e?.actions||[]).forEach(T=>{T&&T.type&&(c[T.type]=T)});const d=o?!!e.home:!0,f=o?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",v=e?.theme_vars&&typeof e.theme_vars=="object"?e.theme_vars:{},h=Object.keys(v).length>0,u=(T,z)=>w(/^#[0-9a-fA-F]{6}$/.test(v[T]||"")?v[T]:z),p=document.createElement("div");p.className="mag-modal-scrim",p.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${o?"Edit magnet":"New magnet"}">
      ...
      <div class="mag-modal__main">
        ...
        <select class="mag-modal__select" id="mag-f-owner">
          ${G.owners.map(T=>`<option value="${w(T.guid)}"${T.guid===G.primaryOrgGuid?" selected":""}>${w(T.name||T.guid)}</option>`).join("")}
        </select>`:""}
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${Zr.map(T=>`<option value="${T.value}"${(e?e.trigger||"none":"on_load")===T.value?" selected":""}>${w(T.label)}</option>`).join("")}
        </select>
        ...
        <div class="mag-modal__sec">
          ...
          <select class="mag-modal__select" id="mag-f-font">${dm(e?.font||"")}</select>
    ...
    </div>`,document.body.appendChild(p),requestAnimationFrame(()=>{p.classList.add("open"),p.querySelector(".mag-modal").classList.add("open")});const b=[...p.querySelectorAll(".mag-modal__navitem")],y=[...p.querySelectorAll(".mag-tab")],E=T=>{b.forEach(z=>z.classList.toggle("is-active",z.dataset.tab===T)),y.forEach(z=>{z.hidden=z.dataset.tab!==T}),p.querySelector(".mag-modal__body").scrollTop=0};b.forEach(T=>T.addEventListener("click",()=>E(T.dataset.tab)));const A=()=>va({...e,...Ka(p),...o?{steps:Go()}:{}}),C=p.querySelector("#mag-preview-pane"),j=()=>window.matchMedia("(min-width: 1200px)").matches;let q=null;const X=()=>{if(!q&&j())try{q=Cu(C,A)}catch{}};let de=null;const ge=()=>{j()&&(X(),q&&(clearTimeout(de),de=setTimeout(()=>{try{q.refresh()}catch{}},300)))},ue=window.matchMedia("(min-width: 1200px)"),Le=()=>{j()&&(X(),ge())};ue.addEventListener("change",Le);let D=!1,te=!1;const U=p.querySelector("#mag-f-dirty"),J=T=>{D=T,U&&(U.hidden=!T)},Qe=p.querySelector(".mag-modal__main");Qe.addEventListener("input",()=>J(!0)),Qe.addEventListener("change",()=>{J(!0),ge()}),p.querySelector("#mag-f-color")?.addEventListener("input",()=>{J(!0),ge()});const Xe=T=>{D&&(T.preventDefault(),T.returnValue="")};window.addEventListener("beforeunload",Xe);let $t=!0;const Pa=m.subscribe(g.ROUTE_NAV_BEFORE,()=>{if($t){if(D&&!confirm("Discard your changes to this magnet?")){window.router?.navigate("/magnets");return}_()}}),_=()=>{if(n&&!te&&e&&e.status==="DRAFT"){fetch(`${ae()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"}).catch(()=>{}),G.magnets=G.magnets.filter(z=>z.guid!==e.guid);const T=document.getElementById("mag-body");T&&(T.innerHTML=`<div class="mag-grid">${G.magnets.map(Un).join("")}</div>`)}$t=!1,window.removeEventListener("beforeunload",Xe),m.unsubscribe(Pa),clearTimeout(de),ue.removeEventListener("change",Le),q&&q.destroy&&q.destroy(),p.classList.remove("open"),setTimeout(()=>p.remove(),180),document.removeEventListener("keydown",O)},S=()=>{D&&!confirm("Discard your changes to this magnet?")||_()};function O(T){T.key==="Escape"&&(T.preventDefault(),S())}document.addEventListener("keydown",O),p.querySelector(".mag-modal__close").addEventListener("click",S),p.querySelector('[data-x="cancel"]').addEventListener("click",S),p.querySelector("[data-close-modal]")?.addEventListener("click",S),p.querySelector("#mag-f-name").focus();const V=p.querySelector("#mag-flow-panel");o?wu(V,e,()=>{J(!0),ge()}):V.innerHTML='<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>',im(p,e),t&&E(t),X(),p.querySelectorAll(".mag-cta").forEach(T=>{const z=T.querySelector(".mag-cta__on"),me=T.querySelector(".mag-cta__val"),se=T.querySelector(".mag-cta__opts"),De=T.querySelectorAll(".mag-cta__booksrc, .mag-cta__calevent, .mag-cta__callsrc, .mag-cta__crtracker");z.addEventListener("change",()=>{me&&(me.disabled=!z.checked),se&&(se.disabled=!z.checked),De.forEach(K=>{K.disabled=!z.checked}),z.checked&&(me||se)?.focus()}),me&&me.addEventListener("input",()=>{me.value.trim()&&!z.checked&&(z.checked=!0,se&&(se.disabled=!1))})}),p.querySelectorAll('.mag-cta[data-kind="book"]').forEach(T=>{const z=T.querySelector(".mag-cta__booksrc"),me=T.querySelector(".mag-cta__val"),se=T.querySelector(".mag-cta__calevent");if(!z||!se)return;const De=()=>{const K=z.value==="calendly";me.hidden=K,se.hidden=!K,K&&!se.dataset.listed&&(se.dataset.listed="1",Uu(se))};z.addEventListener("change",()=>{const K=T.querySelector(".mag-cta__on");K.checked||(K.checked=!0,K.dispatchEvent(new Event("change"))),De()}),De()}),p.querySelectorAll('.mag-cta[data-type="call"]').forEach(T=>{const z=T.querySelector(".mag-cta__callsrc"),me=T.querySelector(".mag-cta__val"),se=T.querySelector(".mag-cta__crtracker");if(!z||!se)return;const De=()=>{const K=z.value==="callrail";me.hidden=K,se.hidden=!K,K&&!se.dataset.listed&&(se.dataset.listed="1",qu(se))};z.addEventListener("change",()=>{const K=T.querySelector(".mag-cta__on");K.checked||(K.checked=!0,K.dispatchEvent(new Event("change"))),De()}),De()});const B=p.querySelector("#mag-f-surface-on"),Ae=p.querySelector("#mag-f-surface");B.addEventListener("change",()=>Ae.hidden=!B.checked);const Ze=p.querySelector("#mag-f-inline-size");p.querySelectorAll('input[name="mag-display"]').forEach(T=>T.addEventListener("change",()=>{Ze.hidden=p.querySelector('input[name="mag-display"]:checked')?.value!=="inline"})),p.querySelector('[data-x="preview"]')?.addEventListener("click",()=>Dn(()=>va({...e,...Ka(p),...o?{steps:Go()}:{}}))),p.querySelector('[data-x="save"]').addEventListener("click",async T=>{const z=T.currentTarget,me=p.querySelector("#mag-f-error"),se=p.querySelector("#mag-f-name").value.trim();if(!se){E("basics"),me.textContent="Please give your magnet a name.";return}const De=p.querySelector("#mag-f-domains").value.split(",").map(Z=>Z.trim()).filter(Boolean);let K="";if(p.querySelectorAll(".mag-cta").forEach(Z=>{const vt=Z.querySelector(".mag-cta__on").checked;if(Z.dataset.kind==="book"){const It=Z.querySelector(".mag-cta__booksrc")?.value==="calendly";vt&&It&&!Z.querySelector(".mag-cta__calevent")?.value&&(K=K||"Pick a Calendly event for the Book button, or switch it back to the built-in scheduler.");return}if(Z.dataset.kind!=="value")return;if(Z.dataset.type==="call"&&Z.querySelector(".mag-cta__callsrc")?.value==="callrail"){vt&&!Z.querySelector(".mag-cta__crtracker")?.value&&(K=K||"Pick a CallRail tracking number for the Call button, or switch it back to a phone number.");return}const Lt=Z.querySelector(".mag-cta__val").value.trim();vt&&!Lt&&(K=K||`Add a target for the ${Bn[Z.dataset.type].label} button, or uncheck it.`)}),K){E("welcome"),me.textContent=K;return}const zn=oi(p);if(zn.enabled&&!Object.keys(zn.b).length){E("ab"),me.textContent="Give variant B at least one change (title, welcome, or color), or untick the A/B test.";return}if(o){const Z=Eu();if(Z){E("flow"),me.textContent=Z.message,ku(Z.route,Z.message,{uid:Z.uid,field:Z.field});return}}const Fa={name:se,domains:De,...Ka(p)};r&&(Fa.owner_guid=p.querySelector("#mag-f-owner").value);const Gn=o&&e.status==="DRAFT";Gn&&(Fa.status="ENABLED"),z.disabled=!0,me.textContent="";try{const Z=o?`${ae()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${ae()}/m5t/v5/magnets`,vt={"Content-Type":"application/json"};s&&(vt["Idempotency-Key"]=s);const Lt=await fetch(Z,{method:o?"PATCH":"POST",headers:vt,body:JSON.stringify(Fa)});let It={};try{It=await Lt.json()}catch{}if(!Lt.ok||!It.ok)throw new Error(It.message||`Save failed (${Lt.status})`);o&&await Su(e.guid),ze(Gn||!o?"Magnet created":"Magnet updated","success"),te=!0,_(),await Kt()}catch(Z){z.disabled=!1,me.textContent=Z.message||"Something went wrong."}})}const pm=Object.freeze(Object.defineProperty({__proto__:null,CTA_META:Bn,CTA_ORDER:ei,DISPLAY_OPTS:Qr,FONT_GROUPS:fn,MODE_LABEL:Kr,THEME_OPTS:Xr,TRIGGER_OPTS:Zr,cspNoteHTML:Jr,init:Wu,openModal:_a,render:Vu,stepFunnelHTML:ni},Symbol.toStringTag,{value:"Module"})),um={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ko=e=>String(e??"").replace(/[&<>"']/g,t=>um[t]),mm=["provision_magnets","manage_magnets"],gm=()=>x.getCapabilities().some(e=>mm.includes(e));function hm(){const e=new Map;for(const t of Ke)e.set(t.category,(e.get(t.category)||0)+1);return Object.keys(Gr).filter(t=>e.has(t)).map(t=>[t,e.get(t)])}const Qo=(e,t,a,n)=>`<button class="m5t-chip--filter" type="button" data-cat="${Ko(e)}" aria-pressed="${n}">${Ko(t)}<span class="m5t-chip__count">${a}</span></button>`;let Xo=!1;function fm(){if(Wr(),Xo)return;const e=document.createElement("style");e.id="m5t-templates-page-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Xo=!0}function si(){fm();const e=gm();return`
    <div class="page-shell" data-section="templates">
      ...
      <div class="m5t-chip-row tpl-filters" id="tpl-filters" role="group" aria-label="Filter templates by category">
        ${Qo("all","All",Ke.length,"true")}
        ${hm().map(([t,a])=>Qo(t,Gr[t],a,"false")).join("")}
      </div>

      <div class="mag-tpl-grid mag-tpl-grid--page" id="tpl-grid">
        ${Ke.map(t=>jr(t,{detail:!0,gallery:!0,canUse:e})).join("")}
      </div>
    </div>`}function ri(){const e=document.getElementById("tpl-grid");document.getElementById("tpl-filters")?.addEventListener("click",t=>{const a=t.target.closest("[data-cat]");if(!a)return;a.parentElement.querySelectorAll("[data-cat]").forEach(o=>{o.setAttribute("aria-pressed",String(o===a))});const n=a.dataset.cat;e?.querySelectorAll(".mag-tpl-card").forEach(o=>{o.hidden=!(n==="all"||o.dataset.cat===n)})}),e?.addEventListener("click",t=>{const a=t.target.closest("[data-preview]");if(a){const o=Ke.find(s=>s.id===a.dataset.preview);o&&Dn(()=>va({...o.appearance,steps:o.steps,name:o.name}));return}const n=t.target.closest("[data-tpl]");n&&(Nu(n.dataset.tpl),window.location.hash="#/magnets")})}const vm={render:si,init:ri},bm=Object.freeze(Object.defineProperty({__proto__:null,default:vm,init:ri,render:si},Symbol.toStringTag,{value:"Module"}));let Zo=!1;const k={leads:[],magnetNames:{},filter:"ALL",canManage:!1,book:!1,ownerNames:{},clientFilter:"ALL",search:"",shown:100,selectedId:null,day:""},rt=100,vn=["NEW","WORKING","QUALIFIED","UNQUALIFIED","CONVERTED","EXPORTED"],_m={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},M=e=>String(e??"").replace(/[&<>"']/g,t=>_m[t]),ya=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},wa=()=>x.getConfig?.().BASE_URL||"",xa=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",ii=e=>(xa(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase(),Ma=e=>e.created?.created_tz||"";function xt(e){const t=Ma(e);if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric"})}catch{return""}}function ym(e){const t=Ma(e);if(!t)return"";try{const a=Date.now()-new Date(t).getTime();if(a<0)return xt(e);const n=a/36e5;return n<1?`${Math.max(1,Math.floor(a/6e4))}m ago`:n<24?`${Math.floor(n)}h ago`:n<48?"Yesterday":xt(e)}catch{return xt(e)}}const wm=e=>{const t=Ma(e);if(!t)return!1;try{return Date.now()-new Date(t).getTime()<24*36e5}catch{return!1}};function xm(){if(Zo)return;const e=document.createElement("style");e.id="m5t-leads-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Zo=!0}function Wt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Em(e){return`<select class="leads-status" data-id="${M(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${vn.map(t=>`<option value="${t}" ${e.status===t?"selected":""}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join("")}
  </select>`}function km(e){const t=k.magnetNames[e.magnet_guid]||e.lead_source||"—",a=e.phone?String(e.phone).replace(/[^\d+]/g,""):"";return`
    <tr class="leads-row${String(e.id)===k.selectedId?" selected":""}" data-id="${M(e.id)}" tabindex="0" role="button" aria-label="Open lead ${M(xa(e))}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${M(ii(e))}</span>
          <span><span class="leads-name">${M(xa(e))}</span>${e.company?`<span class="leads-sub">${M(e.company)}</span>`:""}</span>
        </span>
      </td>
      ${k.book?`<td>${zs(k.ownerNames[e.owner_guid]||"")||'<span class="leads-muted">—</span>'}</td>`:""}
      <td>
      ...
      <td>${k.canManage?Em(e):`<span class="leads-badge" data-s="${M(e.status)}">${M(e.status)}</span>`}</td>
      <td class="num leads-muted" style="white-space:nowrap" title="${M(xt(e))}">${wm(e)?'<span class="leads-fresh" title="Captured in the last 24 hours"></span>':""}${M(ym(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}const li=e=>k.clientFilter==="ALL"||e.owner_guid===k.clientFilter;function Am(e){const t=k.search.trim().toLowerCase();if(!t)return!0;const a=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,k.magnetNames[e.magnet_guid],k.book?k.ownerNames[e.owner_guid]:"",e.utm_campaign,e.utm_source].filter(Boolean).join(" ").toLowerCase();return t.split(/\s+/).every(n=>a.includes(n))}const Sm=e=>!k.day||Ma(e).slice(0,10)===k.day;function ci(){return k.leads.filter(e=>(k.filter==="ALL"||e.status===k.filter)&&li(e)&&Am(e)&&Sm(e))}function Tm(){if(!k.day)return"";let e=k.day;try{e=new Date(`${k.day}T00:00:00Z`).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric",timeZone:"UTC"})}catch{}return`<button class="leads-daychip" type="button" id="leads-dayclear" title="Show every day again">
  ...
  </button>`}const di=()=>Wt("touch_app","Click to see lead information.");function Cm(){xm(),gt();const e=oe();return`
    <div class="page-shell" data-section="leads">
      ...
      <div class="dashboard-card" style="margin-bottom:24px">
        ...
        <div class="card-body" id="pf-picker-body">${Wt("hourglass_empty","Loading…")}</div>
      </div>`:""}
      <div class="page-header">
        <div class="page-header-text">
      ...
      <div class="leads-layout">
        ...
        <aside class="dashboard-card leads-panel" aria-label="Lead detail">
          <div class="card-body" id="leads-panel-body">${di()}</div>
        </aside>
      </div>
    </div>`}async function $m(){document.getElementById("leads-export")?.addEventListener("click",Nm);const e=on(pt.LEADS_SEARCH),t=on(pt.LEADS_DAY);if((e||t)&&(k.search=e||"",k.day=t||"",k.filter="ALL",k.clientFilter="ALL",k.shown=rt),oe()){const a=n=>Number(n||0).toLocaleString();ht(wa(),[{h:"Leads · wk",td:n=>a(n.leads.this_week)},{h:"Leads · total",td:n=>a(n.leads.total)},{h:"Compl.",td:n=>n.completion_rate!=null?`${n.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Lm()}async function Lm(){const e=document.getElementById("leads-body");if(e){try{const[t,a]=await Promise.all([fetch(`${wa()}/m5t/v5/m5mLead`),fetch(`${wa()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(k.leads=(n.data||[]).filter(o=>!["DELETED","ARCHIVED"].includes(o.status)),k.book=oe(),k.ownerNames=k.book?qs():{},a){const o=await a.json().catch(()=>({}));k.magnetNames={},(o.magnets||[]).forEach(s=>{k.magnetNames[s.guid]=s.name,s.owner_guid&&s.owner_name&&!k.ownerNames[s.owner_guid]&&(k.ownerNames[s.owner_guid]=s.owner_name)}),k.canManage=!!o.canManage}}catch{e.innerHTML=Wt("error","Could not load your leads. Please try again.");return}Ut()}}const Im=()=>`
  <colgroup>
    <col style="width:22%">
  ...
  </colgroup>`;function Ut(){const e=document.getElementById("leads-body"),t=document.getElementById("leads-export");if(!e)return;if(t&&(t.style.display=k.leads.length?"":"none"),!k.leads.length){e.innerHTML=Wt("inbox","No leads captured yet. Publish a magnet and share it to start collecting.");return}const a=k.leads.filter(li),n={ALL:a.length};vn.forEach(s=>{n[s]=a.filter(r=>r.status===s).length});const o=k.book?[...new Set(k.leads.map(s=>s.owner_guid).filter(Boolean))].map(s=>({guid:s,name:k.ownerNames[s]||s})).sort((s,r)=>s.name.localeCompare(r.name)):[];e.innerHTML=`
    <div class="leads-bar">
      <div class="leads-filter">
        ${["ALL",...vn].map(s=>`<button data-filter="${s}" class="${k.filter===s?"active":""}">${s==="ALL"?"All":s[0]+s.slice(1).toLowerCase()}${n[s]?`<span class="leads-pillnum">${n[s]}</span>`:""}</button>`).join("")}
      </div>
      ${k.book&&o.length>1?`
    ...
    <div id="leads-tablezone"></div>`,e.querySelector(".leads-filter")?.addEventListener("click",s=>{const r=s.target.closest("[data-filter]");r&&(k.filter=r.dataset.filter,k.shown=rt,Ut())}),e.querySelector("#leads-clientsel")?.addEventListener("change",s=>{k.clientFilter=s.target.value,k.shown=rt,Ut()}),e.querySelector("#leads-dayclear")?.addEventListener("click",()=>{k.day="",k.shown=rt,Ut()}),e.querySelector("#leads-search")?.addEventListener("input",s=>{k.search=s.target.value,k.shown=rt,bn()}),bn()}function bn(){const e=document.getElementById("leads-tablezone"),t=document.getElementById("leads-countlbl");if(!e)return;const a=ci(),n=a.slice(0,k.shown),o=k.book?8:7;t&&(t.textContent=`${a.length} of ${k.leads.length}`),e.innerHTML=`
    <div class="leads-tablewrap">
      <table class="leads-table${k.book?" leads-table--book":""}">
        ...
        <tbody id="leads-tbody">${n.map(km).join("")||`<tr><td colspan="${o}"><div class="leads-muted" style="padding:14px 4px">${k.search.trim()?"No leads match your search.":`No ${k.filter.toLowerCase()} leads.`}</div></td></tr>`}</tbody>
      </table>
    </div>
    ${a.length>k.shown?`<button class="leads-more" type="button" id="leads-more">Show ${Math.min(rt,a.length-k.shown)} more (${a.length-k.shown} remaining)</button>`:""}`,e.querySelector("#leads-more")?.addEventListener("click",()=>{k.shown+=rt,bn()}),e.querySelector("#leads-tbody")?.addEventListener("change",Rm),e.querySelector("#leads-tbody")?.addEventListener("click",s=>{if(s.target.closest(".leads-status, a.leads-contactlink"))return;const r=s.target.closest(".leads-row");r&&es(r.dataset.id)}),e.querySelector("#leads-tbody")?.addEventListener("keydown",s=>{if(s.key!=="Enter"&&s.key!==" ")return;const r=s.target.closest(".leads-row");r&&s.target===r&&(s.preventDefault(),es(r.dataset.id))})}async function Rm(e){const t=e.target.closest(".leads-status");if(!t)return;const a=t.dataset.id,n=k.leads.find(r=>String(r.id)===String(a)),o=t.value,s=n?.status;try{if(!(await(await fetch(`${wa()}/m5t/v5/m5mLead/${encodeURIComponent(a)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:o})})).json().catch(()=>({}))).ok)throw new Error;n&&(n.status=o),ya(`Marked ${o[0]}${o.slice(1).toLowerCase()}`,"success")}catch{t.value=s||"NEW",ya("Could not update status","danger");return}try{String(a)===k.selectedId&&mi(),k.filter!=="ALL"&&Ut()}catch(r){console.warn("[leads] re-render after status change failed:",r)}}function es(e){k.selectedId=String(e),document.querySelectorAll(".leads-row").forEach(t=>t.classList.toggle("selected",t.dataset.id===k.selectedId)),mi()}function ea(e,t){const a=Array.isArray(e.tags)?e.tags:[];for(let n=a.length-1;n>=0;n--)if(a[n]&&a[n].tag===t&&a[n].value!=null)return String(a[n].value);return""}function pi(e){const t=ea(e,"appointment_start");if(!t)return null;const a=ea(e,"appointment_status")||"booked",n=ea(e,"appointment_timezone"),o=ea(e,"appointment_event_type"),s=new Date(t);let r=t;if(!Number.isNaN(s.getTime())){const i={weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"};try{r=new Intl.DateTimeFormat(void 0,n?{...i,timeZone:n}:i).format(s)}catch{r=new Intl.DateTimeFormat(void 0,i).format(s)}}return{when:r,status:a,type:o,start:t}}const ts={booked:["QUALIFIED","Booked"],rescheduled:["WORKING","Rescheduled"],canceled:["CANCELED","Canceled"]};function ui(e){const t=Array.isArray(e.tags)?e.tags:[];let a=null;for(const l of t)if(!(!l||!l.tag)){if(l.tag==="callrail_call_id"){a={};continue}a&&l.tag.indexOf("call_")===0&&l.value!=null&&(a[l.tag]=String(l.value))}if(!a||!a.call_started)return null;const n=a.call_started,o=new Date(n);let s=n;Number.isNaN(o.getTime())||(s=new Intl.DateTimeFormat(void 0,{weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"}).format(o));const r=Number(a.call_duration)||0,i=r?r<60?`${r}s`:`${Math.floor(r/60)}m ${r%60}s`:"";return{when:s,dur:i,source:a.call_source||"",answered:a.call_answered||"",recording:a.call_recording_player||"",started:n}}function mi(){const e=document.getElementById("leads-panel-body");if(!e)return;const t=k.leads.find(l=>String(l.id)===k.selectedId);if(!t){e.innerHTML=di();return}const a=k.magnetNames[t.magnet_guid]||t.lead_source||"—",n=pi(t),[o,s]=n?ts[n.status]||ts.booked:["",""],r=ui(t),i=(l,c)=>c?`<div class="leads-det__field"><span class="leads-det__k">${M(l)}</span><span class="leads-det__v">${M(c)}</span></div>`:"";e.innerHTML=`
    <div class="leads-det__head">
      <span class="leads-avatar leads-det__ava">${M(ii(t))}</span>
      <div>
        <div class="leads-det__name">${M(xa(t))}</div>
    ...
    ${t.description?`<div class="leads-det__notes">${M(t.description)}</div>`:""}`}function Nm(){const e=ci();if(!e.length){ya("Nothing to export","info");return}const t=["first_name","last_name","email","phone","company","product_interest","lead_source","utm_source","utm_medium","utm_campaign","gclid","status"],a=l=>`"${String(l??"").replace(/"/g,'""')}"`,o=[[...k.book?["client"]:[],...t,"magnet","captured","appointment","last_call"].join(",")];for(const l of e){const c=pi(l),d=ui(l);o.push([...k.book?[a(k.ownerNames[l.owner_guid]||"")]:[],...t.map(f=>a(l[f])),a(k.magnetNames[l.magnet_guid]||l.lead_source||""),a(xt(l)),a(c?`${c.start} (${c.status})`:""),a(d?`${d.started} (${d.answered==="no"?"missed":"answered"})`:"")].join(","))}const s=new Blob([o.join(`
`)],{type:"text/csv"}),r=URL.createObjectURL(s),i=document.createElement("a");i.href=r,i.download=`leads-${k.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r),ya(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const Om=Object.freeze(Object.defineProperty({__proto__:null,init:$m,render:Cm},Symbol.toStringTag,{value:"Module"})),gi=()=>x.getConfig?.().BASE_URL||"",as=e=>e.toISOString().slice(0,10),_n=e=>e==null?"—":"$"+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),We=e=>Number(e||0).toLocaleString(),Mm={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},yt=e=>String(e??"").replace(/[&<>"']/g,t=>Mm[t]);let ns=!1;function Pm(){if(ns)return;const e=document.createElement("style");e.id="m5t-adperf-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ns=!0}const lt=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,ta=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
  ...
  </div>`,Fm=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let Ea=30;function hi(){return oe()?St({section:"ad-performance",title:"Ad Performance",description:"Pick a client to view their spend and lead performance."}):(Pm(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${Fm.map(e=>`<button class="chart-period-btn${e.d===Ea?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>

      <div class="stats-grid" id="adperf-stats">
        ${ta("payments","Ad Spend","adperf-spend")}
        ${ta("ads_click","Clicks","adperf-clicks")}
        ${ta("person_add","Magnet Leads","adperf-leads")}
        ${ta("request_quote","Cost / Lead","adperf-cpl")}
      </div>
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="adperf-body">
          ${lt("hourglass_empty","Loading ad performance…")}
        </div>
      </div>
    ...
    </div>`)}async function fi(){if(oe()){const t=a=>Number(a||0).toLocaleString();return ht(gi(),[{h:"Spend",td:a=>a.ad?`$${t(a.ad.spend)}`:"—"},{h:"Clicks",td:a=>a.ad?t(a.ad.clicks):"—"},{h:"Leads",td:a=>t(a.leads.window??a.leads.total)},{h:"CPL",td:a=>a.ad?.cost_per_lead!=null?`$${t(a.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see spend here."})}const e=document.getElementById("adperf-periods");e?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(Ea=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===Ea)),os())}),await os()}async function os(){const e=gi(),t=document.getElementById("adperf-body"),a=document.getElementById("adperf-range"),n=new Date,o=as(n),s=as(new Date(n.getTime()-(Ea-1)*864e5));a&&(a.textContent=`${s} → ${o}`);let r,i=[],l=null,c=null,d=null;try{const[v,h,u,p,b]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${s}&to=${o}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${s}&to=${o}`),Ia().catch(()=>null),fetch(`${e}/m5t/v5/coreAdMetrics/conversions?from=${s}&to=${o}`).then(E=>E.json()).catch(()=>null)]);if(!v.ok)throw new Error(`HTTP ${v.status}`);r=await v.json(),i=((await h.json().catch(()=>({})))?.data||[]).filter(E=>E.status!=="DELETED"),l=await u.json().catch(()=>null),c=p,d=b}catch(v){console.warn("[ad-performance] load failed:",v),t&&(t.innerHTML=lt("error","Could not load ad performance. Please try again."));return}Dm(c,i),Bm(d);const f=r.totals||{};if(aa("adperf-spend",_n(f.spend)),aa("adperf-clicks",We(f.clicks)),aa("adperf-leads",We(f.magnet_leads)),aa("adperf-cpl",_n(f.cost_per_lead)),Um(l),!i.length){t.innerHTML=lt("link_off","No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.");return}if(!r.connected){t.innerHTML=lt("cloud_sync","Account connected. No ad data for this range yet. Metrics appear here once they sync.");return}t.innerHTML=Hm(r.rows||[])}function Dm(e,t){const a=document.getElementById("adperf-conn");if(!a)return;if(!e||e.denied){a.innerHTML="";return}const n=Te.google_ads,o=Ca(e.providers,"google_ads"),s=$a(n,o,!!e.configured?.google_ads),r=$e()?` <a href="#/settings/integrations/${n.urlSlug}">Manage</a>`:"";if(s==="connected"||s==="broken"){Ra(),a.innerHTML=`<span>Google Ads</span> ${La(s,o)}${r}`;return}if(t.length){a.innerHTML=`<span>Google Ads</span> <span>${t.length} associated account${t.length===1?"":"s"}</span>`;return}a.innerHTML=""}function Bm(e){const t=document.getElementById("adperf-conv-card"),a=document.getElementById("adperf-conv-body"),n=document.getElementById("adperf-stats"),o=document.getElementById("adperf-conv-stat");if(o&&o.remove(),!t||!a)return;if(!e?.ok||!e.has_selection){t.style.display="none";return}if(n){const i=document.createElement("div");i.className="stat-card",i.id="adperf-conv-stat",i.innerHTML=`
      <div class="stat-header">
      ...
      <div class="stat-change"><span class="stat-sublabel">Reported by Google Ads</span></div>`,n.appendChild(i)}const s=e.actions||[];if(t.style.display="",!s.length){a.innerHTML=lt("search_off","No conversions in this range for the selected actions.");return}const r=s.some(i=>i.value>0);a.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${s.map(i=>`
          <tr>
            <td>${yt(i.name||i.id)}</td>
            <td class="adperf-src-sub">${yt(String(i.category||"").toLowerCase().replace(/_/g," ")||"—")}</td>
            <td class="num"><b>${We(i.conversions)}</b></td>
            ${r?`<td class="num">${_n(i.value)}</td>`:""}
          </tr>`).join("")}
        </tbody>
      </table>
    </div>
    <p class="adperf-note">Counted actions are chosen on the Google Ads integration page. These are Google's own numbers and may overlap magnet leads, so they are never added together.</p>`}function Um(e){const t=document.getElementById("adperf-sources"),a=document.getElementById("adperf-src-summary");if(!t)return;const n=e&&Array.isArray(e.rows)?e.rows:[];if(!n.length){a&&(a.textContent=""),t.innerHTML=lt("search_off","No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.");return}const o=e.total_leads||n.reduce((i,l)=>i+(l.leads||0),0),s=e.tracked_leads||0;a&&(a.textContent=`${We(s)} of ${We(o)} leads tagged to a source`);const r=i=>i.campaign&&i.campaign!=="(none)"?yt(i.campaign):i.source&&i.source!=="(direct)"?yt(i.source):'<span class="adperf-src-untracked">Untracked / direct</span>';t.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${n.map(i=>`
          <tr>
            <td>${r(i)}</td>
            <td class="adperf-src-sub">${yt(i.source||"—")}${i.medium?` · ${yt(i.medium)}`:""}</td>
            <td class="num">${i.paid_clicks?We(i.paid_clicks):'<span class="adperf-src-sub">—</span>'}</td>
            <td class="num"><b>${We(i.leads)}</b></td>
          </tr>`).join("")}
        </tbody>
      </table>
    </div>`}function aa(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}function ss(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}function rs(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e)}function Hm(e){const h=e.length||1,u=ss(Math.max(1,...e.map(D=>D.spend||0))),p=ss(Math.max(1,...e.map(D=>D.magnet_leads||0))),b=738/h,y=Math.min(24,b*.55),E=D=>56+b*(D+.5),A=D=>304-D/u*282,C=D=>304-D/p*282,j=[0,.25,.5,.75,1].map(D=>{const te=304-D*282;return`<line x1="56" y1="${te.toFixed(1)}" x2="794" y2="${te.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${(te+3.5).toFixed(1)}" text-anchor="end" class="ax">$${rs(u*D)}</text><text x="802" y="${(te+3.5).toFixed(1)}" text-anchor="start" class="ax">${rs(p*D)}</text>`}).join(""),q=e.map((D,te)=>{const U=A(D.spend||0);return`<rect x="${(E(te)-y/2).toFixed(1)}" y="${U.toFixed(1)}" width="${y.toFixed(1)}" height="${Math.max(0,304-U).toFixed(1)}" rx="3" fill="#0072BA"><title>${D.date}: $${D.spend} spend</title></rect>`}).join(""),X=e.map((D,te)=>`${E(te).toFixed(1)},${C(D.magnet_leads||0).toFixed(1)}`).join(" "),de=h>1?`<polyline points="${X}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",ge=e.map((D,te)=>`<circle cx="${E(te).toFixed(1)}" cy="${C(D.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${D.date}: ${D.magnet_leads} leads</title></circle>`).join(""),ue=Math.max(1,Math.ceil(h/6)),Le=e.map((D,te)=>te%ue===0||te===h-1?`<text x="${E(te).toFixed(1)}" y="326" text-anchor="middle" class="ax">${D.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="adperf-chart" viewBox="0 0 840 340" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Ad spend versus magnet leads over time">
      ${j}${q}${de}${ge}${Le}
    </svg>`}const qm={render:hi,init:fi},zm=Object.freeze(Object.defineProperty({__proto__:null,default:qm,init:fi,render:hi},Symbol.toStringTag,{value:"Module"})),Gm={google_ads:"Google Ads",google_lsa:"Local Services Ads"},jm=e=>{const t=String(e||"").replace(/\D/g,"");return t.length===10?`${t.slice(0,3)}-${t.slice(3,6)}-${t.slice(6)}`:String(e||"")};let is=!1;function Vm(){if(is)return;const e=document.createElement("style");e.id="m5t-adacct-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),is=!0}function vi(){return oe()?St({section:"ad-accounts",title:"Ad Accounts",description:"Pick a client to see their connected ad accounts."}):(Vm(),Ra(),`
    ...
    </div>`)}async function bi(){if(oe()){const e=t=>Number(t||0).toLocaleString();return ht(ie(),[{h:"Spend",td:t=>t.ad?`$${e(t.ad.spend)}`:"—"},{h:"Leads",td:t=>e(t.leads.window??t.leads.total)},{h:"CPL",td:t=>t.ad?.cost_per_lead!=null?`$${e(t.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see it here."})}await Wm()}async function Wm(){const[e,t,a]=await Promise.all([Ia().catch(()=>null),fetch(`${ie()}/m5t/v5/coreAdAccount`).then(n=>n.json()).catch(()=>null),fetch(`${ie()}/m5t/v5/coreAdMetrics/conversions`).then(n=>n.json()).catch(()=>null)]);Ym(e,a),Jm(t),Km(t)}function Ym(e,t){const a=document.getElementById("adacct-conn");if(!a)return;const n=Te.google_ads;if(!e||e.denied){a.innerHTML=Ne("link_off","Connection status is not available for your role.");return}const o=Ca(e.providers,"google_ads"),s=$a(n,o,!!e.configured?.google_ads),r=o?.external_account||{},i=n.card.reachableCount(r);let l;s==="connected"?l=i?`${i} reachable account${i===1?"":"s"}.`:"Connected.":s==="broken"?l=n.card.brokenDesc:s==="unavailable"?l="Google Ads is being set up for this platform.":l=$e()?"Not connected yet. Connect from Settings to pull spend and clicks.":"Not connected yet.";const c=$e()&&s!=="unavailable"?`<a class="adacct-manage" href="#/settings/integrations/${n.urlSlug}"><span class="material-symbols-outlined" aria-hidden="true">${s==="idle"?"link":"settings"}</span>${s==="idle"?"Connect":"Manage"}</a>`:"";let d="";if(t?.ok&&t.has_selection){const f=(t.actions||[]).map(h=>h.name||h.id),v=(t.selected_ids||[]).length-f.length;d=`
...
`&&c++,a.push(n),n="",a.some(f=>f.trim()!=="")&&t.push(a),a=[]):n+=d}if(a.push(n),a.some(c=>c.trim()!=="")&&t.push(a),t.length<2)return[];const s=t[0].map(c=>c.trim().toLowerCase()),r=s.findIndex(c=>/e-?mail/.test(c)),i=s.findIndex(c=>/phone|mobile|tel/.test(c)),l=s.findIndex(c=>/date|time|booked|appointment|start/.test(c));return r<0&&i<0?[]:t.slice(1).map(c=>({email:r>=0?(c[r]||"").trim():"",phone:i>=0?(c[i]||"").trim():"",at:l>=0?(c[l]||"").trim():""})).filter(c=>c.email||c.phone).slice(0,5e3)}function yi(e,t){const a=new Blob([e],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(a),o=document.createElement("a");o.href=n,o.download=t,document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(n),4e3)}const Zm={render:vi,init:bi},eg=Object.freeze(Object.defineProperty({__proto__:null,default:Zm,init:bi,parseBookingCsv:_i,render:vi},Symbol.toStringTag,{value:"Module"})),ls="reseller_org",wi="managed_client";let cs=!1;const tg={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},I=e=>String(e??"").replace(/[&<>"']/g,t=>tg[t]);function ct(e,t="info"){try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}}function ag(){const e=x.getActiveOrg();if(e&&e.channel===ls)return{guid:e.guid,name:e.name};const t=x.getMemberships().find(a=>a.channel===ls);return t?{guid:t.orgGuid,name:t.name}:null}function ng(e){const t=e?.created_tz;if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function og(){if(cs)return;const e=document.createElement("style");e.id="m5t-clients-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),cs=!0}const sg=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Ht(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function rg(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
    <div class="client-row">
      <span class="client-row__avatar">${I(sg(t))}</span>
      <span class="client-row__main">
        <div class="client-row__name" title="${I(t)}">${I(t)}</div>
        <div class="client-row__meta">Added ${I(ng(e.created))||"—"}</div>
      </span>
    ...
    </div>`}async function Ei(){const e=ag();document.getElementById("clients-add-btn")?.addEventListener("click",()=>ig(e)),await ki(e)}async function ki(e){const t=document.getElementById("clients-body"),a=document.getElementById("clients-count");if(t){if(!e?.guid){t.innerHTML=Ht("info","Client provisioning is available to reseller / agency accounts."),a&&(a.textContent="");return}try{const n=x.getConfig?.().BASE_URL||"",o=await fetch(`${n}/m5t/v5/acctGroup`);if(!o.ok)throw new Error(`HTTP ${o.status}`);const s=await o.json(),i=(Array.isArray(s?.data)?s.data:[]).filter(l=>l.class===wi&&(!l.parent||l.parent===e.guid));if(!i.length){t.innerHTML=Ht("group_off","No clients yet. Add your first client to start managing magnets on their behalf."),a&&(a.textContent="");return}t.innerHTML=`<div class="client-list">${i.map(rg).join("")}</div>`,a&&(a.textContent=`${i.length} client${i.length===1?"":"s"}`),t.querySelectorAll(".client-card__invite").forEach(l=>{l.addEventListener("click",()=>{l.dataset.action==="adaccounts"?lg(l.dataset.clientGuid,l.dataset.clientName):l.dataset.action==="questionnaire"?dg(l.dataset.clientGuid,l.dataset.clientName):cg(l.dataset.clientGuid,l.dataset.clientName)})})}catch(n){console.warn("[clients] load failed:",n),t.innerHTML=Ht("error","Couldn’t load clients. Please try again."),a&&(a.textContent="")}}}function ig(e){if(!e?.guid){ct("Only reseller / agency accounts can add clients.","error");return}const t=document.createElement("div");t.className="client-modal-scrim";const a=document.createElement("div");a.className="client-modal",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
    ...
    </div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add("open"),i.classList.add("open")});const l=i.querySelector("#aa-error"),c=i.querySelector('[data-act="save"]'),d=()=>{r.classList.remove("open"),i.classList.remove("open"),document.removeEventListener("keydown",f),setTimeout(()=>{r.remove(),i.remove()},200)},f=u=>{u.key==="Escape"&&d()};document.addEventListener("keydown",f),r.addEventListener("click",d),i.querySelector(".client-modal__close")?.addEventListener("click",d),i.querySelector('[data-act="cancel"]')?.addEventListener("click",d);const v=(u,p,b)=>{const y=`${a}/m5t/v5/coreAdAccount`;return p&&!b?fetch(y,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,provider:u,external_customer_id:p})}):p&&b&&p!==b.external_customer_id?fetch(`${y}/${encodeURIComponent(b.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({external_customer_id:p})}):!p&&b?fetch(`${y}/${encodeURIComponent(b.guid)}`,{method:"DELETE"}):null},h=async()=>{l.textContent="";const u=ds(i.querySelector("#aa-gads").value),p=ds(i.querySelector("#aa-lsa").value),b=[v("google_ads",u,o),v("google_lsa",p,s)].filter(Boolean);if(!b.length){d();return}c.disabled=!0;const y=c.innerHTML;c.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const E=await Promise.all(b);for(const A of E)if(!A.ok){const C=await A.json().catch(()=>({}));throw new Error(A.status===403?"You are not authorized to connect accounts for this client.":C?.error||C?.message||`Failed (HTTP ${A.status})`)}ct("Ad accounts updated","success"),d()}catch(E){l.textContent=E.message||"Something went wrong. Please try again.",c.disabled=!1,c.innerHTML=y}};c?.addEventListener("click",h)}function cg(e,t){if(!e)return;const a=document.createElement("div");a.className="client-modal-scrim";const n=document.createElement("div");n.className="client-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="qm-body">${Ht("hourglass_empty","Loading…")}</div>`,document.body.appendChild(n),document.body.appendChild(o),requestAnimationFrame(()=>{n.classList.add("open"),o.classList.add("open")});const s=()=>{n.classList.remove("open"),o.classList.remove("open"),document.removeEventListener("keydown",r),setTimeout(()=>{n.remove(),o.remove()},200)},r=u=>{u.key==="Escape"&&s()};document.addEventListener("keydown",r),n.addEventListener("click",s),o.querySelector(".client-modal__close")?.addEventListener("click",s);const i=o.querySelector("#qm-body");function l(){i.innerHTML=`
      ...
      </div>`,i.querySelector('[data-act="done"]')?.addEventListener("click",s),i.querySelector('[data-act="cancel-edit"]')?.addEventListener("click",()=>h(u,!1)),i.querySelector('[data-act="edit"]')?.addEventListener("click",()=>h(u,!0));const C=i.querySelector('[data-act="save"]');C?.addEventListener("click",async()=>{const j={};i.querySelectorAll("[data-question-id]").forEach(X=>{const de=X.dataset.questionId;if(X.dataset.questionType==="checkbox_group"){const ue=[...X.querySelectorAll('input[type="checkbox"]:checked')].map(Le=>Le.value);ue.length&&(j[de]=ue)}else{const ue=(X.querySelector("input,textarea")?.value||"").trim();ue&&(j[de]=ue)}}),C.disabled=!0;const q=C.innerHTML;C.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const X=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(u.guid)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({answers:j})}),de=await X.json().catch(()=>({}));if(!X.ok||!de.ok)throw new Error(de.error||de.message||`Failed (HTTP ${X.status})`);ct("Answers updated","success");const ue=await(await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(u.guid)}`)).json().catch(()=>({}));h(ue.ok?ue.data:{...u,answers:j},!1)}catch(X){i.querySelector("#qm-error").textContent=X.message||"Something went wrong. Please try again.",C.disabled=!1,C.innerHTML=q}})}try{const u=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse?owner_guid=${encodeURIComponent(e)}`),p=await u.json().catch(()=>({}));if(!u.ok||!p.ok)throw new Error(p.error||`HTTP ${u.status}`);const b=(p.data||[])[0]||null;if(!b){l();return}if(b.status==="DRAFT"){c(b);return}if(b.status==="CANCELLED"){d(b);return}const y=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(b.guid)}`),E=await y.json().catch(()=>({}));if(!y.ok||!E.ok)throw new Error(E.error||`HTTP ${y.status}`);h(E.data)}catch(u){console.warn("[clients] questionnaire load failed:",u),i.innerHTML=`<p class="client-modal__error">Could not load questionnaire status. ${I(u.message||"")}</p>`}}const pg={render:xi,init:Ei},ug=Object.freeze(Object.defineProperty({__proto__:null,default:pg,init:Ei,render:xi},Symbol.toStringTag,{value:"Module"})),ps="managed_client";let us=!1;const mg={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ve=e=>String(e??"").replace(/[&<>"']/g,t=>mg[t]),ms=(e,t="info")=>{try{m.publish(g.UI_TOAST,{message:e,type:t})}catch{}},gg=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function hg(){const e=x.getActiveOrg();let t=e&&e.channel!==ps?e:null;if(!t){const n=x.getMemberships().find(o=>o.channel!==ps);n&&(t={guid:n.orgGuid,channel:n.channel,memberRole:n.memberRole})}if(!t)return null;const a=x.getMemberships().find(n=>n.orgGuid===t.guid)?.name;return{...t,name:a}}function fg(e){return Object.values(Ft).filter(t=>yl(e,t.value)).sort((t,a)=>a.rank-t.rank)}function vg(){if(us)return;const e=document.createElement("style");e.id="m5t-team-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),us=!0}function ka(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function bg(e){const t=e.member_role||"member";return`
    <div class="team-row">
      <span class="team-avatar">${ve(gg(e.name||e.email))}</span>
      ...
      <span class="team-role" data-role="${ve(t)}">${ve(Ft[t]?.label||t)}</span>
    </div>`}function Ai(){return vg(),`
    <div class="page-shell" data-section="team">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="team-body">
          ${ka("hourglass_empty","Loading team…")}
        </div>
      </div>
    </div>`}async function Si(){const e=hg(),t=document.getElementById("team-invite-btn");if(!e){t&&(t.style.display="none"),document.getElementById("team-body").innerHTML=ka("info","Team management is available for agency and workspace accounts.");return}t?.addEventListener("click",()=>_g(e)),await qn(e)}async function qn(e){const t=document.getElementById("team-body"),a=document.getElementById("team-count");if(t)try{const n=x.getConfig?.().BASE_URL||"",[o,s]=await Promise.all([fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/members`),fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/invites`)]),[r,i]=await Promise.all([o.json().catch(()=>({})),s.json().catch(()=>({}))]);if(!o.ok||!s.ok)throw new Error(`Failed to load team (members: ${o.status}, invites: ${s.status})`);const l=r.members||[],c=i.invites||[],d=c.length?`
    ...
    <div class="team-modal__body" id="team-invite-body">
      ...
      <div class="team-modal__actions">
        ...
        </div>`;const b=n.querySelector("#tm-link");n.querySelector("#tm-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(b.value),n.querySelector("#tm-copy").textContent="Copied!"}catch{b.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",()=>{o(),qn(e)})}catch(h){console.warn("[team] invite failed:",h),r.textContent=h.message||"Something went wrong. Please try again.",i.disabled=!1,i.innerHTML=v}})}const yg={render:Ai,init:Si},wg=Object.freeze(Object.defineProperty({__proto__:null,default:yg,init:Si,loadTeam:qn,render:Ai},Symbol.toStringTag,{value:"Module"}));
