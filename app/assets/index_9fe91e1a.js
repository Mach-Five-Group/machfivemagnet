(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const ur="modulepreload",mr=function(e,t){return new URL(e,t).href},fn={},Q=function(t,a,n){let o=Promise.resolve();if(a&&a.length>0){let c=function(m){return Promise.all(m.map(h=>Promise.resolve(h).then(b=>({status:"fulfilled",value:b}),b=>({status:"rejected",reason:b}))))};const r=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");o=c(a.map(m=>{if(m=mr(m,n),m in fn)return;fn[m]=!0;const h=m.endsWith(".css"),b=h?'[rel="stylesheet"]':"";if(n)for(let f=r.length-1;f>=0;f--){const d=r[f];if(d.href===m&&(!h||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${m}"]${b}`))return;const p=document.createElement("link");if(p.rel=h?"stylesheet":ur,h||(p.as="script"),p.crossOrigin="",p.href=m,l&&p.setAttribute("nonce",l),document.head.appendChild(p),h)return new Promise((f,d)=>{p.addEventListener("load",f),p.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${m}`)))})}))}function s(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return o.then(r=>{for(const i of r||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})};var gr=/([:*])(\w+)/g,hr="([^/]+)",fr=/\*/g,vr="?(?:.*)",br=/\/\?/g,_r="/?([^/]+|)",yr="(?:/^|^)",wr="";function To(e){return e===void 0&&(e="/"),Ga()?location.pathname+location.search+location.hash:e}function K(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function Vt(e){return typeof e=="string"}function xr(e){return typeof e=="function"}function Wt(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function Er(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(a,n,o){return a===null&&(a={}),a[t[o]]=decodeURIComponent(n),a},null)}function Yt(e){var t=K(e).split(/\?(.*)?$/);return[K(t[0]),t.slice(1).join("")]}function za(e){for(var t={},a=e.split("&"),n=0;n<a.length;n++){var o=a[n].split("=");if(o[0]!==""){var s=decodeURIComponent(o[0]);t[s]?(Array.isArray(t[s])||(t[s]=[t[s]]),t[s].push(decodeURIComponent(o[1]||""))):t[s]=decodeURIComponent(o[1]||"")}}return t}function Co(e,t){var a=Yt(K(e.currentLocationPath)),n=a[0],o=a[1],s=o===""?null:za(o),r=[],i;if(Vt(t.path)){if(i=yr+K(t.path).replace(gr,function(h,b,p){return r.push(p),hr}).replace(fr,vr).replace(br,_r)+"$",K(t.path)===""&&K(n)==="")return{url:n,queryString:o,hashString:Wt(e.to),route:t,data:null,params:s}}else i=t.path;var l=new RegExp(i,wr),c=n.match(l);if(c){var m=Vt(t.path)?Er(c,r):c.groups?c.groups:c.slice(1);return{url:K(n.replace(new RegExp("^"+e.instance.root),"")),queryString:o,hashString:Wt(e.to),route:t,data:m,params:s}}return!1}function $o(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function Xe(e,t){return typeof e[t]>"u"||e[t]===!0}function Ar(e){if(!e)return{};var t=e.split(","),a={},n;return t.forEach(function(o){var s=o.split(":").map(function(r){return r.replace(/(^ +| +$)/g,"")});switch(s[0]){case"historyAPIMethod":a.historyAPIMethod=s[1];break;case"resolveOptionsStrategy":n||(n={}),n.strategy=s[1];break;case"resolveOptionsHash":n||(n={}),n.hash=s[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":a[s[0]]=s[1]==="true";break}}),n&&(a.resolveOptions=n),a}function Ga(){return typeof window<"u"}function kr(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(a){return a}).forEach(function(a){["before","after","already","leave"].forEach(function(n){a[n]&&(t[n]||(t[n]=[]),t[n].push(a[n]))})}),t}function $e(e,t,a){var n=t||{},o=0;(function s(){if(!e[o]){a&&a(n);return}Array.isArray(e[o])?(e.splice.apply(e,[o,1].concat(e[o][0](n)?e[o][1]:e[o][2])),s()):e[o](n,function(r){typeof r>"u"||r===!0?(o+=1,s()):a&&a(n)})})()}$e.if=function(e,t,a){return Array.isArray(t)||(t=[t]),Array.isArray(a)||(a=[a]),[e,t,a]};function vn(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=To(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function ma(e,t){for(var a=0;a<e.instance.routes.length;a++){var n=e.instance.routes[a],o=Co(e,n);if(o&&(e.matches||(e.matches=[]),e.matches.push(o),e.resolveOptions.strategy==="ONE")){t();return}}t()}function Sr(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function Tr(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var bn=Ga(),Cr=$o();function $r(e,t){if(Xe(e.navigateOptions,"updateBrowserURL")){var a=("/"+e.to).replace(/\/\//g,"/"),n=bn&&e.resolveOptions&&e.resolveOptions.hash===!0;Cr?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",n?"#"+a:a),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!n){var o=location.hash;location.hash="",location.hash=o}e.instance.__freezeListening=!1},1))):bn&&(window.location.href=e.to)}t()}function Io(e,t){var a=e.instance;if(!a.lastResolved()){t();return}$e(a.lastResolved().map(function(n){return function(o,s){if(!n.route.hooks||!n.route.hooks.leave){s();return}var r=!1,i=e.instance.matchLocation(n.route.path,e.currentLocationPath,!1);if(n.route.path!=="*")r=!i;else{var l=e.matches?e.matches.find(function(c){return n.route.path===c.route.path}):!1;r=!l}if(Xe(e.navigateOptions,"callHooks")&&r){$e(n.route.hooks.leave.map(function(c){return function(m,h){return c(function(b){b===!1?e.instance.__markAsClean(e):h()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return s()}]));return}else s()}}),{},function(){return t()})}function Ir(e,t){e.match.route.hooks&&e.match.route.hooks.before&&Xe(e.navigateOptions,"callHooks")?$e(e.match.route.hooks.before.map(function(a){return function(o,s){return a(function(r){r===!1?e.instance.__markAsClean(e):s()},e.match)}}).concat([function(){return t()}])):t()}function Lr(e,t){Xe(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function Rr(e,t){e.match.route.hooks&&e.match.route.hooks.after&&Xe(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(a){return a(e.match)}),t()}function Nr(e,t){var a=e.instance.lastResolved();if(a&&a[0]&&a[0].route===e.match.route&&a[0].url===e.match.url&&a[0].queryString===e.match.queryString){a.forEach(function(n){n.route.hooks&&n.route.hooks.already&&Xe(e.navigateOptions,"callHooks")&&n.route.hooks.already.forEach(function(o){return o(e.match)})}),t(!1);return}t()}function Or(e,t){var a=e.instance._notFoundRoute;if(a){e.notFoundHandled=!0;var n=Yt(e.currentLocationPath),o=n[0],s=n[1],r=Wt(e.to);a.path=K(o);var i={url:a.path,queryString:s,hashString:r,data:null,route:a,params:s!==""?za(s):null};e.matches=[i],e.match=i}t()}function Mr(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function Pr(e,t){e.instance._setCurrent(null),t()}function Lo(e,t){Xe(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var Ro=[Nr,Ir,Lr,Rr],_n=[Io,Or,$e.if(function(e){var t=e.notFoundHandled;return t},Ro.concat([Lo]),[Mr,Pr])];function ka(){return ka=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},ka.apply(this,arguments)}function yn(e,t){var a=0;function n(){if(a===e.matches.length){Lo(e,t);return}$e(Ro,ka({},e,{match:e.matches[a]}),function(){a+=1,n()})}Io(e,n)}function ga(e){e.instance.__markAsClean(e)}function Sa(){return Sa=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},Sa.apply(this,arguments)}var wn="[data-navigo]";function Fr(e,t){var a=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:wn},n=this,o="/",s=null,r=[],i=!1,l,c=$o(),m=Ga();e?o=K(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function h(_){return _.indexOf("#")>=0&&(a.hash===!0?_=_.split("#")[1]||"/":_=_.split("#")[0]),_}function b(_){return K(o+"/"+K(_))}function p(_,A,R,z){return _=Vt(_)?b(_):_,{name:z||K(String(_)),path:_,handler:A,hooks:kr(R)}}function f(_,A,R){var z=this;return typeof _=="object"&&!(_ instanceof RegExp)?(Object.keys(_).forEach(function(F){if(typeof _[F]=="function")z.on(F,_[F]);else{var _e=_[F],Ge=_e.uses,k=_e.as,B=_e.hooks;r.push(p(F,Ge,[l,B],k))}}),this):(typeof _=="function"&&(R=A,A=_,_=o),r.push(p(_,A,[l,R])),this)}function d(_,A){if(n.__dirty){n.__waiting.push(function(){return n.resolve(_,A)});return}else n.__dirty=!0;_=_?K(o)+"/"+K(_):void 0;var R={instance:n,to:_,currentLocationPath:_,navigateOptions:{},resolveOptions:Sa({},a,A)};return $e([vn,ma,$e.if(function(z){var F=z.matches;return F&&F.length>0},yn,_n)],R,ga),R.matches?R.matches:!1}function v(_,A){if(n.__dirty){n.__waiting.push(function(){return n.navigate(_,A)});return}else n.__dirty=!0;_=K(o)+"/"+K(_);var R={instance:n,to:_,navigateOptions:A||{},resolveOptions:A&&A.resolveOptions?A.resolveOptions:a,currentLocationPath:h(_)};$e([Sr,Tr,ma,$e.if(function(z){var F=z.matches;return F&&F.length>0},yn,_n),$r,ga],R,ga)}function y(_,A,R){var z=Le(_,A);return z!==null?(v(z.replace(new RegExp("^/?"+o),""),R),!0):!1}function E(_){return this.routes=r=r.filter(function(A){return Vt(_)?K(A.path)!==K(_):xr(_)?_!==A.handler:String(A.path)!==String(_)}),this}function I(){c&&(this.__popstateListener=function(){n.__freezeListening||d()},window.addEventListener("popstate",this.__popstateListener))}function N(){this.routes=r=[],c&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=i=!0}function H(_,A){return n._notFoundRoute=p("*",_,[l,A],"__NOT_FOUND__"),this}function U(){if(m)return ie().forEach(function(_){if(_.getAttribute("data-navigo")==="false"||_.getAttribute("target")==="_blank"){_.hasListenerAttached&&_.removeEventListener("click",_.navigoHandler);return}_.hasListenerAttached||(_.hasListenerAttached=!0,_.navigoHandler=function(A){if((A.ctrlKey||A.metaKey)&&A.target.tagName.toLowerCase()==="a")return!1;var R=_.getAttribute("href");if(typeof R>"u"||R===null)return!1;if(R.match(/^(http|https)/)&&typeof URL<"u")try{var z=new URL(R);R=z.pathname+z.search}catch{}var F=Ar(_.getAttribute("data-navigo-options"));i||(A.preventDefault(),A.stopPropagation(),n.navigate(K(R),F))},_.addEventListener("click",_.navigoHandler))}),n}function ie(){return m?[].slice.call(document.querySelectorAll(a.linksSelector||wn)):[]}function Z(_){return"/"+o+"/"+K(_)}function le(_){return l=_,this}function De(){return s}function Le(_,A,R){var z=r.find(function(Ge){return Ge.name===_}),F=null;if(z){if(F=z.path,A)for(var _e in A)F=F.replace(":"+_e,A[_e]);F=F.match(/^\//)?F:"/"+F}return F&&R&&!R.includeRoot&&(F=F.replace(new RegExp("^/"+o),"")),F}function M(_){return _.getAttribute("href")}function $(_){var A=Yt(K(_)),R=A[0],z=A[1],F=z===""?null:za(z),_e=Wt(_),Ge=p(R,function(){},[l],R);return{url:R,queryString:z,hashString:_e,route:Ge,data:null,params:F}}function W(){return $(K(To(o)).replace(new RegExp("^"+o),""))}function Re(_){var A={instance:n,currentLocationPath:_,to:_,resolveOptions:a};return ma(A,function(){}),A.matches?A.matches:!1}function Rt(_,A,R){typeof A<"u"&&(typeof R>"u"||R)&&(A=b(A));var z={instance:n,to:A,currentLocationPath:A};vn(z,function(){}),typeof _=="string"&&(_=typeof R>"u"||R?b(_):_);var F=Co(z,{name:String(_),path:_,handler:function(){},hooks:{}});return F||!1}function ze(_,A,R){return typeof A=="string"&&(A=gt(A)),A?(A.hooks[_]||(A.hooks[_]=[]),A.hooks[_].push(R),function(){A.hooks[_]=A.hooks[_].filter(function(z){return z!==R})}):(console.warn("Route doesn't exists: "+A),function(){})}function gt(_){return typeof _=="string"?r.find(function(A){return A.name===b(_)}):r.find(function(A){return A.handler===_})}function pa(_){_.instance.__dirty=!1,_.instance.__waiting.length>0&&_.instance.__waiting.shift()()}this.root=o,this.routes=r,this.destroyed=i,this.current=s,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=pa,this.on=f,this.off=E,this.resolve=d,this.navigate=v,this.navigateByName=y,this.destroy=N,this.notFound=H,this.updatePageLinks=U,this.link=Z,this.hooks=le,this.extractGETParameters=function(_){return Yt(h(_))},this.lastResolved=De,this.generate=Le,this.getLinkPath=M,this.match=Re,this.matchLocation=Rt,this.getCurrentLocation=W,this.addBeforeHook=ze.bind(this,"before"),this.addAfterHook=ze.bind(this,"after"),this.addAlreadyHook=ze.bind(this,"already"),this.addLeaveHook=ze.bind(this,"leave"),this.getRoute=gt,this._pathToMatchObject=$,this._clean=K,this._checkForAHash=h,this._setCurrent=function(_){return s=n.current=_},I.call(this),U.call(this)}var Dr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Br(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var _t={exports:{}},Ur=_t.exports,xn;function qr(){return xn||(xn=1,(function(e,t){(function(a,n){var o={};a.PubSub?(o=a.PubSub,console.warn("PubSub already loaded, using existing version")):(a.PubSub=o,n(o)),e!==void 0&&e.exports&&(t=e.exports=o),t.PubSub=o,e.exports=t=o})(typeof window=="object"&&window||Ur||Dr,function(a){var n={},o=-1,s="*";function r(d){var v;for(v in d)if(Object.prototype.hasOwnProperty.call(d,v))return!0;return!1}function i(d){return function(){throw d}}function l(d,v,y){try{d(v,y)}catch(E){setTimeout(i(E),0)}}function c(d,v,y){d(v,y)}function m(d,v,y,E){var I=n[v],N=E?c:l,H;if(Object.prototype.hasOwnProperty.call(n,v))for(H in I)Object.prototype.hasOwnProperty.call(I,H)&&N(I[H],d,y)}function h(d,v,y){return function(){var I=String(d),N=I.lastIndexOf(".");for(m(d,d,v,y);N!==-1;)I=I.substr(0,N),N=I.lastIndexOf("."),m(d,I,v,y);m(d,s,v,y)}}function b(d){var v=String(d),y=!!(Object.prototype.hasOwnProperty.call(n,v)&&r(n[v]));return y}function p(d){for(var v=String(d),y=b(v)||b(s),E=v.lastIndexOf(".");!y&&E!==-1;)v=v.substr(0,E),E=v.lastIndexOf("."),y=b(v);return y}function f(d,v,y,E){d=typeof d=="symbol"?d.toString():d;var I=h(d,v,E),N=p(d);return N?(y===!0?I():setTimeout(I,0),!0):!1}a.publish=function(d,v){return f(d,v,!1,a.immediateExceptions)},a.publishSync=function(d,v){return f(d,v,!0,a.immediateExceptions)},a.subscribe=function(d,v){if(typeof v!="function")return!1;d=typeof d=="symbol"?d.toString():d,Object.prototype.hasOwnProperty.call(n,d)||(n[d]={});var y="uid_"+String(++o);return n[d][y]=v,y},a.subscribeAll=function(d){return a.subscribe(s,d)},a.subscribeOnce=function(d,v){var y=a.subscribe(d,function(){a.unsubscribe(y),v.apply(this,arguments)});return a},a.clearAllSubscriptions=function(){n={}},a.clearSubscriptions=function(v){var y;for(y in n)Object.prototype.hasOwnProperty.call(n,y)&&y.indexOf(v)===0&&delete n[y]},a.countSubscriptions=function(v){var y,E,I=0;for(y in n)if(Object.prototype.hasOwnProperty.call(n,y)&&y.indexOf(v)===0){for(E in n[y])I++;break}return I},a.getSubscriptions=function(v){var y,E=[];for(y in n)Object.prototype.hasOwnProperty.call(n,y)&&y.indexOf(v)===0&&E.push(y);return E},a.unsubscribe=function(d){var v=function(Z){var le;for(le in n)if(Object.prototype.hasOwnProperty.call(n,le)&&le.indexOf(Z)===0)return!0;return!1},y=typeof d=="string"&&(Object.prototype.hasOwnProperty.call(n,d)||v(d)),E=!y&&typeof d=="string",I=typeof d=="function",N=!1,H,U,ie;if(y){a.clearSubscriptions(d);return}for(H in n)if(Object.prototype.hasOwnProperty.call(n,H)){if(U=n[H],E&&U[d]){delete U[d],N=d;break}if(I)for(ie in U)Object.prototype.hasOwnProperty.call(U,ie)&&U[ie]===d&&(delete U[ie],N=!0)}return N}})})(_t,_t.exports)),_t.exports}var Hr=qr();const u=Br(Hr),g=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV.GO",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN.GO",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP.GO",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT.GO",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT.GO",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH.GO",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",AUTH_SCOPE_LOADED:"AUTH.SCOPE.LOADED",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",M5T_SIDE_NAV:"M5T_SIDE_NAV",M5T_SIDE_NAV_TAP:"M5T_SIDE_NAV.TAP",M5T_SIDE_NAV_COLLAPSE:"M5T_SIDE_NAV.COLLAPSE",M5T_SIDE_NAV_LOGO_TAP:"M5T_SIDE_NAV.LOGO_TAP",M5T_SIDE_NAV_ORG_SWITCH:"M5T_SIDE_NAV.ORG_SWITCH",M5T_SIDE_NAV_FOOTER_ACTION:"M5T_SIDE_NAV.FOOTER_ACTION",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL",MESSAGE:"MESSAGE",MESSAGE_CREATE:"MESSAGE.CREATE",MESSAGE_CREATED:"MESSAGE.CREATED",MESSAGE_EDIT:"MESSAGE.EDIT",MESSAGE_UPDATED:"MESSAGE.UPDATED",MESSAGE_DELETE:"MESSAGE.DELETE",MESSAGE_DELETED:"MESSAGE.DELETED",MESSAGE_REFRESH:"MESSAGE.REFRESH"}),ha={BASE_URL:"./",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://machfivemagnet-saas.onrender.com"};var fa={};const G=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_UI_DARK_MODE:!0,FF_SSE_UI_ANIMATIONS:!0,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel",FF_API_RATELIMIT_SIGNIN_ENFORCE:!1,FF_API_RATELIMIT_SIGNIN_IP_LIMIT:20,FF_API_RATELIMIT_SIGNIN_EMAIL_LIMIT:10,FF_API_RATELIMIT_FORGOT_ENFORCE:!1,FF_API_RATELIMIT_FORGOT_IP_LIMIT:15,FF_API_RATELIMIT_FORGOT_EMAIL_LIMIT:5,FF_API_RATELIMIT_CAPTURE_ENFORCE:!1,FF_API_RATELIMIT_CAPTURE_LIMIT:30,FF_API_RATELIMIT_EVENT_ENFORCE:!1,FF_API_RATELIMIT_EVENT_LIMIT:600,FF_API_RATELIMIT_CSP_PING_ENFORCE:!1,FF_API_RATELIMIT_CSP_PING_LIMIT:30,FF_API_RATELIMIT_WEBAUTHN_AUTH_ENFORCE:!1,FF_API_RATELIMIT_WEBAUTHN_AUTH_IP_LIMIT:20,FF_API_RATELIMIT_INTEGRATIONS_ENFORCE:!1,FF_API_RATELIMIT_INTEGRATIONS_LIMIT:60,FF_API_RATELIMIT_QUESTIONNAIRE_ENFORCE:!1,FF_API_RATELIMIT_QUESTIONNAIRE_LIMIT:30,FF_API_RATELIMIT_AUTHENTICATED_ENFORCE:!1,FF_API_RATELIMIT_AUTHENTICATED_LIMIT:600,FF_API_MAGNET_REQUIRE_ORIGIN_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_LIMIT:2e3});function No(e,t=null){if(e in G)return G[e];if(typeof process<"u"&&fa&&fa[e]){const a=fa[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}if(typeof import.meta<"u"&&ha&&ha[e]){const a=ha[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}return t}function ja(e){return No(e,!1)===!0}function zr(){return{...G}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:G,getFlag:No,isEnabled:ja,getAllFlags:zr});const En={success:{border:"var(--color-success, #009473)",bg:"var(--color-success-soft, rgba(0,148,115,0.10))",icon:"check_circle"},danger:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},error:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},warning:{border:"var(--color-warning, #D97706)",bg:"var(--color-warning-soft, #FEF3C7)",icon:"warning"},info:{border:"var(--color-info, #0D9488)",bg:"var(--color-info-soft, #CCFBF1)",icon:"info"}},Gr=4500,Ta=220;let Oe=null,An=!1;function jr(){if(An)return;const e=document.createElement("style");e.id="m5t-toast-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),An=!0}function Vr(){return Oe&&document.body.contains(Oe)||(Oe=document.createElement("div"),Oe.className="m5t-toast-stack",Oe.setAttribute("role","status"),Oe.setAttribute("aria-live","polite"),document.body.appendChild(Oe)),Oe}function Wr(e){const t=e&&e.message;if(!t)return;jr();const a=En[e.type]||En.info,n=document.createElement("div");n.className="m5t-toast",n.style.borderColor=a.border,n.style.background=a.bg,n.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true" style="color:${a.border}">${a.icon}</span><span class="m5t-toast__msg"></span><button type="button" class="m5t-toast__close" aria-label="Dismiss"><span class="material-symbols-outlined" aria-hidden="true">close</span></button>`,n.querySelector(".m5t-toast__msg").textContent=String(t),Vr().appendChild(n),requestAnimationFrame(()=>n.classList.add("is-in"));let s=!1;const r=()=>{s||(s=!0,clearTimeout(i),n.classList.remove("is-in"),n.classList.add("is-out"),setTimeout(()=>n.remove(),Ta))},i=setTimeout(r,Gr);n.querySelector(".m5t-toast__close").addEventListener("click",r)}function Yr(){const e=t=>a=>{const n=a.detail?.pubsubTopic;n&&u.publish(n,a.detail)};document.addEventListener("nav-select",e()),document.addEventListener("logo-click",e()),document.addEventListener("nav-hover",e()),document.addEventListener("nav-double-tap",e()),document.addEventListener("nav-long-tap",e()),document.addEventListener("message-sent",e())}function Jr(){console.log("[AppEvents] Initializing event listeners..."),u.subscribe(g.APP_READY,(a,n)=>{console.log("[AppEvents] APP_READY:",n)}),u.subscribe(g.APP_ERROR,(a,n)=>{console.error("[AppEvents] APP_ERROR:",n)}),u.subscribe(g.APP_SIGNOUT,(a,n)=>{console.log("[AppEvents] APP_SIGNOUT:",n)}),u.subscribe(g.ROUTE_NAV_BEFORE,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",n),u.publish(g.UI_LOADING_START)}),u.subscribe(g.ROUTE_NAV_AFTER,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",n),u.publish(g.UI_LOADING_END)}),u.subscribe(g.ROUTE_NAV_ERROR,(a,n)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",n),u.publish(g.APP_ERROR,{message:"Navigation error",details:n})}),u.subscribe(g.AUTH_SIGNIN_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",n)}),u.subscribe(g.AUTH_SIGNIN_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",n),u.publish(g.UI_TOAST,{message:n.message||"Sign in failed",type:"danger"})}),u.subscribe(g.AUTH_SIGNUP_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",n),u.publish(g.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"}),u.publish(g.AUTH_VERIFY_LINK)}),u.subscribe(g.AUTH_VERIFY_LINK,(a,n)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),u.subscribe(g.AUTH_SIGNUP_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",n),u.publish(g.UI_TOAST,{message:n.message||"Sign up failed",type:"danger"})}),u.subscribe(g.AUTH_SIGNOUT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",n),u.publish(g.UI_TOAST,{message:"Signed out successfully",type:"info"})}),u.subscribe(g.AUTH_SIGNUP,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),u.subscribe(g.AUTH_FORGOT,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),u.subscribe(g.AUTH_FORGOT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",n),u.publish(g.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),u.subscribe(g.AUTH_RESETHASH_NAV,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),u.subscribe(g.AUTH_RESETHASH_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",n),u.publish(g.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),u.subscribe(g.AUTH_TOKEN_EXPIRED,(a,n)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",n),u.publish(g.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),u.subscribe(g.I18N_SET_LANG,(a,n)=>{console.log("[AppEvents] I18N_SET_LANG:",n);const{langCode:o}=n;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),u.publish(g.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(s){console.error("[AppEvents] Error changing language:",s),u.publish(g.UI_TOAST,{message:`Failed to change language: ${s.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),u.subscribe("CONVERSATION.PROMPT",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",n.message),va(n.message,"user",n.timestamp),u.publish(g.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Agent prompt (no implementation):",n.message);break;case"AGENT_CANVAS":console.log("[AppEvents] Display message in canvas:",n.message),va(n.message,"user",n.timestamp),u.publish(g.CANVAS_DO_SCROLL);break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),u.subscribe("CONVERSATION.RESPONSE",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",n.message),va(n.message,"assistant",n.timestamp,n.streaming);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),u.subscribe(g.UI_LOADING_START,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),u.subscribe(g.UI_LOADING_END,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),u.subscribe(g.UI_TOAST,(a,n)=>{Wr(n)}),u.subscribe(g.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const a="0.1",n=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${a} 8/10/2026, 8:19:47 PM|© ${n} Mach Five Tech`,"night")}),Yr(),u.subscribe("M5T_PRIMARY_NAV",(a,n)=>{const o=a.split(".")[1];switch(o){case"TAP":e(n);break;case"LOGO_TAP":t();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function e(a){const{token:n,level:o,primaryToken:s}=a;switch(n){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),u.publish(g.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${n}`,{primaryToken:s});break}}function t(a){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 8/10/2026, 8:19:47 PM|© ${o} Mach Five Tech`,"night",5e3)}u.subscribe(g.AUTH_SIGNOUT,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(G.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function va(e,t="user",a=null,n=!1){const o=document.getElementById("chat-messages");if(!o){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}if(a||(a=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})),n&&t==="assistant"){const r=o.firstElementChild;if(r&&r.tagName.toLowerCase()==="m5t-chat-response"){r.setAttribute("message",e),console.log(`[AppEvents] Updated streaming ${t} bubble (${e.length} chars)`);return}}let s;t==="user"||t==="prompt"?s=document.createElement("m5t-chat-prompt"):s=document.createElement("m5t-chat-response"),s.setAttribute("message",e),s.setAttribute("timestamp",a),o.prepend(s),console.log(`[AppEvents] Added ${t} bubble to canvas (${e.length} chars)`)}function Oo(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("uid")&&t.get("token"))}function Kr(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("qr")&&t.get("token"))}function Qr(e=window.location.search){const t=new URLSearchParams(e||""),a=t.get("qr"),n=t.get("token");return a&&n?{guid:a,token:n}:null}const Xr=Object.freeze({admin_root_role:{value:100,desc:"Administrator superuser infrastructure architecture"},admin_business_role:{value:90,desc:"Administrator financial oversight"},admin_support_role:{value:80,desc:"Administrator maintenance and configuration"},admin_readonly_role:{value:70,desc:"Administrator information help desk"},client_tier_4_role:{value:40,desc:"Client paid tier 4 - Partner"},client_tier_3_role:{value:30,desc:"Client paid tier 3"},client_tier_2_role:{value:20,desc:"Client paid tier 2"},client_tier_1_role:{value:10,desc:"Client paid tier 1"},client_standard_role:{value:0,desc:"Client free tier 0"}});function Zr(e){return Xr[e]||null}function ei(e){return e>=50}const xt=Object.freeze({owner:{value:"owner",rank:30,label:"Owner"},admin:{value:"admin",rank:20,label:"Admin"},member:{value:"member",rank:10,label:"Member"},viewer:{value:"viewer",rank:0,label:"Viewer"}}),ti=Object.freeze({VIEW_DASHBOARD:"view_dashboard",VIEW_MAGNETS:"view_magnets",PROVISION_MAGNETS:"provision_magnets",MANAGE_MAGNETS:"manage_magnets",VIEW_CONVERSATIONS:"view_conversations",VIEW_STATS:"view_stats",VIEW_AD_METRICS:"view_ad_metrics",CONNECT_AD_ACCOUNTS:"connect_ad_accounts",CREATE_CLIENT_ACCOUNTS:"create_client_accounts",MANAGE_TEAM:"manage_team",VIEW_BILLING:"view_billing",MANAGE_BILLING:"manage_billing"}),T=ti,Mo=Object.freeze(Object.values(T)),je=Object.freeze([T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS]),ai=Object.freeze({reseller_org:{owner:Mo,admin:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.CREATE_CLIENT_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING],member:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS],viewer:je},managed_client:{owner:[...je,T.VIEW_BILLING],admin:[...je,T.VIEW_BILLING],member:je,viewer:je},saas_org:{owner:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING,T.MANAGE_BILLING],admin:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING],member:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS],viewer:je}});function ni(e){const t=Zr(e);return!!t&&ei(t.value)}function oi({entityClass:e,orgChannel:t,memberRole:a}={}){if(ni(e))return e==="admin_readonly_role"?[...je,T.VIEW_BILLING]:[...Mo];const n=ai[t],o=n&&n[a];return o?[...o]:[]}function si(e,t){const a=xt[e]?.rank??-1,n=xt[t]?.rank??1/0;return a>=xt.admin.rank&&a>=n}const Va=[{value:"name",label:"Full name (splits into first + last automatically)"},{value:"first_name",label:"First name"},{value:"last_name",label:"Last name"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"mobile",label:"Mobile phone"},{value:"company",label:"Company"},{value:"title",label:"Job title"},{value:"city",label:"City"},{value:"state",label:"State / province"},{value:"product_interest",label:"Product interest"},{value:"lead_source",label:"Lead source"},{value:"rating",label:"Rating (Hot / Warm / Cold)"},{value:"description",label:"Notes / description"},{value:"salutation",label:"Salutation (Mr. / Ms. / Dr.)"},{value:"street",label:"Street address"},{value:"zip",label:"Postal / ZIP code"},{value:"country",label:"Country"},{value:"url",label:"Website URL"},{value:"industry",label:"Industry"},{value:"annual_revenue",label:"Annual revenue (number)"},{value:"employees",label:"Number of employees (whole number)"},{value:"is_primary",label:"Primary contact (Yes / No)"},{value:"current_generators",label:"Current generator(s)"},{value:"number_of_locations",label:"Number of locations (whole number)"}];new Set(Va.map(e=>e.value));const Wa=[{value:"single_select",label:"Multiple choice"},{value:"multi_select",label:"Select all"},{value:"scheduler",label:"Scheduler"},{value:"text",label:"Short text"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"message",label:"Message"}];new Set(Wa.map(e=>e.value));const ri=[{value:"inline",label:"Inline"},{value:"chat",label:"Chat"},{value:"right_slide",label:"Slide"},{value:"modal",label:"Modal"}],ii=[{value:"auto",label:"Auto"},{value:"light",label:"Light"},{value:"dark",label:"Dark"}],li=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],ci=[{value:"book",label:"Book"},{value:"call",label:"Call"},{value:"email",label:"Email"},{value:"chat",label:"Chat"},{value:"support",label:"Support"}];ri.map(e=>e.value);ii.map(e=>e.value);li.map(e=>e.value);ci.map(e=>e.value);class x{static CONFIG={BASE_URL:"https://machfivemagnet-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink",SCOPE:"sse_session_scope",ACTIVE_ORG:"sse_active_org",REMEMBERED_EMAIL:"sse_remembered_email"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",ME:"/m5t/v5/acctEntity/me",PING:"/ping",WEBAUTHN_AUTH_OPTIONS:"/m5t/v5/webauthn/authenticate/options",WEBAUTHN_AUTH_VERIFY:"/m5t/v5/webauthn/authenticate/verify"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#o=null;static#a=null;static#n=null;static#s=null;static#i=null;static async init({BASE_URL:t,navigateFunction:a,customConfig:n={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(a&&typeof a=="function")this.#i=a;else throw new Error("navigateFunction is required and must be a function");return t&&(this.CONFIG.BASE_URL=t),n&&Object.keys(n).length>0&&(this.CONFIG={...this.CONFIG,...n}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#m(),this.#u(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#u(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((t=null)=>{if(t){if(Oo()&&(t==="splash"||t==="signin")){console.log("[AuthController] Ignoring mvvLegit redirect to",t,"— keeping invitee on accept-invite");return}console.log("[AuthController] mvvLegit navigation to:",t),this.#r(t)}}).setOnState((t=null)=>{if(t)switch(console.log("[AuthController] Auth state changed:",t),t){case"AUTH":case 4:this.#_();break;case"UNAUTH":case 1:this.#y();break;case"UNVERF":case 2:this.#w();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#r(t){if(!this.#i){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",t);const a=t.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",a),this.#i(a)}static#l(){if(window.__m5tActiveOrgFetch)return;const t=window.fetch.bind(window);window.fetch=(a,n)=>{try{const o=typeof a=="string"?a:a?.url||"",s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);if(s&&o.startsWith(this.CONFIG.BASE_URL)){const r=new Headers(n&&n.headers||(a instanceof Request?a.headers:void 0));r.set("X-Active-Org",s),n={...n||{},headers:r}}}catch{}return t(a,n)},window.__m5tActiveOrgFetch=!0,console.log("[AuthController] Active-org fetch header installed")}static#m(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);t&&(this.#o=JSON.parse(t),console.log("[AuthController] Entity state loaded; hasEmail:",!!this.#o?.email))}catch(t){console.error("[AuthController] Error loading entity state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#o=null}this.#s=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.SCOPE);t&&(this.#a=JSON.parse(t),console.log("[AuthController] Scope state loaded (cached):",this.#a?.uiMode))}catch(t){console.error("[AuthController] Error loading scope state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE),this.#a=null}}static#c(t){try{this.#o=t,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(t)),console.log("[AuthController] Entity state saved")}catch(a){console.error("[AuthController] Error saving entity state:",a)}}static#d(){this.#o=null,this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}}static getEntity(){return this.#o}static#v(t){try{this.#a=t,localStorage.setItem(this.CONFIG.LS_KEYS.SCOPE,JSON.stringify(t))}catch(a){console.error("[AuthController] Error saving scope state:",a)}}static async fetchScope(){return typeof mvvLegit>"u"||!this.isAuthenticated()?(console.log("[AuthController] fetchScope skipped — not authenticated"),this.#a):this.#n?this.#n:(this.#n=this.#b().finally(()=>{this.#n=null}),this.#n)}static async#b(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),a=t?`?org=${encodeURIComponent(t)}`:"",n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.ME}${a}`);if(n.status===401||n.status===403)return console.warn("[AuthController] /me unauthorized — signing out"),this.doSignout(!0),null;if(!n.ok)return console.warn(`[AuthController] /me failed (${n.status}) — using cached scope`),this.#a;const o=await n.json();if(!o?.ok)return console.warn("[AuthController] /me returned not-ok — using cached scope"),this.#a;try{const s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);s&&o.activeOrg?.guid!==s&&(console.warn(`[AuthController] Stored active org not honored by /me${o.activeOrgError?" (activeOrgError)":""} — clearing`),localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG))}catch{}return this.#v(o),u.publish(g.AUTH_SCOPE_LOADED,o),console.log(`[AuthController] Scope loaded: ${o.uiMode} (${o.memberships?.length||0} org(s), ${o.managedClients?.length||0} client(s))`),o}catch(t){return console.error("[AuthController] fetchScope error:",t),this.#a}}static async setActiveOrg(t){try{t?localStorage.setItem(this.CONFIG.LS_KEYS.ACTIVE_ORG,t):localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}return this.fetchScope()}static getScope(){return this.#a}static getCapabilities(){return this.isPreviewingAsClient()?oi({orgChannel:"managed_client",memberRole:"owner"}):this.#a?.capabilities||[]}static getUiMode(){return this.isPreviewingAsClient()?"managed":this.#a?.uiMode||"self_serve"}static getActiveOrg(){return this.#a?.activeOrg||null}static getMemberships(){return this.#a?.memberships||[]}static getManagedClients(){return this.#a?.managedClients||[]}static getStoredActiveOrg(){try{return localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{return null}}static#p="m5m_preview_as_client";static isPreviewingAsClient(){try{return sessionStorage.getItem(this.#p)==="1"&&!!this.#a?.activeOrg?.viaSubtree}catch{return!1}}static setPreviewAsClient(t){try{t?sessionStorage.setItem(this.#p,"1"):sessionStorage.removeItem(this.#p)}catch{}this.#a&&u.publish(g.AUTH_SCOPE_LOADED,this.#a)}static async doSignin(t,a){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a})}),o=await n.json();if(n.status===303)return console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#c(o.entity)),setTimeout(()=>{this.#r(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o};if(n.ok&&o.accessToken){console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#c(o.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),console.log("[AuthController] Explicitly navigating to home"),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}}return{ok:!1,error:o.error||"Sign in failed",data:o}}catch(n){return console.error("[AuthController] Signin error:",n),{ok:!1,error:n.message}}}static async doPasskeySignin(){if(!window.PublicKeyCredential)return{ok:!1,error:"Passkeys are not supported in this browser"};try{const{startAuthentication:t}=await Q(async()=>{const{startAuthentication:i}=await Promise.resolve().then(()=>Vo);return{startAuthentication:i}},void 0,import.meta.url),a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_OPTIONS}`,{method:"POST"}),n=await a.json();if(!a.ok||!n.ok)return{ok:!1,error:n.error||"Could not start passkey sign-in"};let o;try{o=await t({optionsJSON:n.options})}catch(i){const l=i?.name==="NotAllowedError";return l||console.error("[AuthController] Passkey ceremony error:",i),{ok:!1,canceled:l,error:l?"Passkey sign-in was canceled":i.message||"Passkey sign-in failed"}}const s=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.WEBAUTHN_AUTH_VERIFY}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o})}),r=await s.json();if(!s.ok||!r.ok||!r.accessToken)return{ok:!1,error:r.error||"Passkey sign-in failed",data:r};mvvLegit.doSignin(r.accessToken),this.#c(r.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#p)}catch{}return this.fetchScope(),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:r}}catch(t){return console.error("[AuthController] Passkey signin error:",t),{ok:!1,error:t.message}}}static async doSignout(t=!1){console.log("[AuthController] doSignout called, serverInitiated:",t);try{const a=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!a),!t&&a){const n=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(a)}`;if(console.log("[AuthController] Sending signout beacon to:",n),navigator.sendBeacon){const o=navigator.sendBeacon(n);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else a||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#d(),console.log("[AuthController] Stopping auth ping..."),this.#h(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(a){console.error("[AuthController] Signout error:",a),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(t){try{const a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await a.json();return a.ok&&n.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#c(n.entity),{ok:!0,data:n}):{ok:!1,error:n.error||"Sign up failed",data:n}}catch(a){return console.error("[AuthController] Signup error:",a),{ok:!1,error:a.message}}}static async doResetHash(t,a){try{const n=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a,modified_by:t})}),s=await o.json();return o.ok&&s.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:s}):{ok:!1,error:s.error||"Password reset failed",data:s}}catch(n){return console.error("[AuthController] Reset password error:",n),{ok:!1,error:n.message}}}static#g(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#f()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#h(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#f(){try{const t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);t.ok?console.log("[AuthController] Ping success"):(t.status===401||t.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(t){console.error("[AuthController] Ping error:",t)}}static setDeepLinkGuid(t){this.#s=t,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,t),console.log("[AuthController] Deep-link GUID stored:",t)}static getDeepLinkGuid(){return this.#s}static clearDeepLink(){this.#s=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#_(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),queueMicrotask(()=>this.fetchScope())}static#y(){console.log("[AuthController] User unauthenticated"),this.#h()}static#w(){console.log("[AuthController] User unverified")}static getAuthState(){try{const t=mvvLegit.getConf()?.LSKEY||"mvv",a=localStorage.getItem(t);if(!a)return"UNAUTH";if(typeof LZString>"u")return null;const n=LZString.decompressFromUTF16(a),s=JSON.parse(n)?.state;return s===1?"UNAUTH":s===2?"UNVERF":s===4?"AUTH":s===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(t){this.#r(t)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#f()}}class C{static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",remember_email:"Remember my email",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_dashboard:"Dashboard",nav_dashboard_tagline:"Overview of your activity",nav_magnets:"Your Magnets",nav_magnets_tagline:"Manage your conversational magnets",nav_templates:"Templates",nav_templates_tagline:"Start from a magnet template",nav_conversations:"Conversations",nav_conversations_tagline:"Captured lead conversations",nav_ab_testing:"A/B Testing",nav_ab_testing_tagline:"Experiment and optimize",nav_analytics:"Analytics",nav_analytics_tagline:"Performance and ad metrics",nav_ad_accounts:"Ad Accounts",nav_ad_accounts_tagline:"Connect advertising accounts",nav_clients:"Clients",nav_clients_tagline:"Manage your client accounts",nav_team:"Team",nav_team_tagline:"Invite and manage teammates",nav_billing:"Billing",nav_billing_tagline:"Plan, usage, and invoices",nav_settings:"Settings",nav_settings_tagline:"Account and workspace settings",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Rollers",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",remember_email:"Recordar mi correo electrónico",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Rollers",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",remember_email:"记住我的邮箱",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"滚动器",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:t,product:a,whitelabel:n,lang:o}){t&&(this.#t.buildMode=t),a&&(this.#t.product=a),n&&(this.#t.whitelabel=n),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{let l=this.#e[o]?.[s]?.[r]?.[i]?.[t],c=o;return!l&&o!=="LOCAL"&&(l=this.#e.LOCAL?.[s]?.[r]?.[i]?.[t],c="LOCAL (fallback)"),l?(c==="LOCAL (fallback)"&&console.warn(`[MicrocopyManager] Token '${t}' missing from ${o} — served from LOCAL instead. Backfill ${o}'s block if this is intentionally different copy.`),Array.isArray(l)?l[Math.floor(Math.random()*l.length)]:l):(console.warn(`[MicrocopyManager] Token not found: ${t} (${o}/${s}/${r}/${i}, LOCAL fallback also missing it)`),null)}catch(l){return console.error(`[MicrocopyManager] Error retrieving token: ${t}`,l),null}}static getAll(t={}){const a={...this.#t,...t},{buildMode:n,product:o,whitelabel:s,lang:r}=a;try{return this.#e[n]?.[o]?.[s]?.[r]||null}catch(i){return console.error("[MicrocopyManager] Error retrieving all tokens",i),null}}static has(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return!!this.#e[o]?.[s]?.[r]?.[i]?.[t]}catch{return!1}}static getAvailableLanguages(){const{buildMode:t,product:a,whitelabel:n}=this.#t;try{return Object.keys(this.#e[t]?.[a]?.[n]||{})}catch{return[]}}static update(t,a,n={}){const o={...this.#t,...n},{buildMode:s,product:r,whitelabel:i,lang:l}=o;try{return this.#e[s]||(this.#e[s]={}),this.#e[s][r]||(this.#e[s][r]={}),this.#e[s][r][i]||(this.#e[s][r][i]={}),this.#e[s][r][i][l]||(this.#e[s][r][i][l]={}),this.#e[s][r][i][l][t]=a,!0}catch(c){return console.error(`[MicrocopyManager] Error updating token: ${t}`,c),!1}}static delete(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return delete this.#e[o]?.[s]?.[r]?.[i]?.[t],!0}catch(l){return console.error(`[MicrocopyManager] Error deleting token: ${t}`,l),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(t){try{return this.#e=t,!0}catch(a){return console.error("[MicrocopyManager] Error importing data",a),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:C});class Ie{static#e=!1;static#t=null;static#o=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const t=this.#n();C.setContext(t),console.log("[I18nController] Initialized with context:",t),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#s(),this.#u(),this.#e=!0,this.refresh()}static#a(t){const a={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},n=t.toLowerCase();return a[n]||"DEV"}static#n(){const a=this.#a("production"),n=localStorage.getItem(G.FF_SSE_LS_WHITELABEL)||G.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(G.FF_SSE_LS_USER_LANG)||G.FF_SSE_I18N_LANG;return{buildMode:a,product:G.FF_SSE_I18N_PRODUCT,whitelabel:n,lang:o}}static#s(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((t,a,n)=>{G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",n),this.#t=n,setTimeout(()=>{this.refresh()},G.FF_SSE_I18N_APPLY_DELAY_MS)},G.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#i())}static#i(){setInterval(()=>{const a=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");a&&a!==this.#t&&(this.#t=a,this.refresh())},500)}static#u(){this.#o||(this.#o=new MutationObserver(t=>{let a=!1;for(const n of t){for(const o of n.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){a=!0;break}if(a)break}a&&(G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#o.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#r(document.body),this.#l(document.body),G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#r(t){const a=t.querySelectorAll("[data-meta-copywrite-i118n]");G.FF_SSE_I18N_DEBUG&&a.length>0&&console.log(`[I18nController] Processing ${a.length} elements`),a.forEach(n=>{try{const o=n.getAttribute("data-meta-copywrite-i118n"),s=JSON.parse(o);if(!s.token){console.warn("[I18nController] Missing token in config:",s);return}const r=s.attribute||"textContent",i=C.get(s.token);if(i===null){console.warn(`[I18nController] Microcopy not found for token: ${s.token}`);return}r==="textContent"?n.textContent=i:r==="innerHTML"?n.innerHTML=i:n.setAttribute(r,i),G.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${i}" to ${r} for token: ${s.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,n)}})}static#l(t){t.querySelectorAll("*").forEach(n=>{n.shadowRoot&&(this.#r(n.shadowRoot),this.#l(n.shadowRoot))})}static setLanguage(t){const a=C.getAvailableLanguages();if(!a.includes(t)){console.error(`[I18nController] Language not available: ${t}. Available:`,a);return}localStorage.setItem(G.FF_SSE_LS_USER_LANG,t),C.setContext({lang:t}),console.log("[I18nController] Language changed to:",t);const n=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:t}});document.dispatchEvent(n),this.refresh()}static setWhitelabel(t){localStorage.setItem(G.FF_SSE_LS_WHITELABEL,t),C.setContext({whitelabel:t}),G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",t),this.refresh()}static getLanguage(){return C.getContext().lang}static getAvailableLanguages(){return C.getAvailableLanguages()}static getContext(){return C.getContext()}static destroy(){this.#o&&(this.#o.disconnect(),this.#o=null),this.#e=!1,this.#t=null,G.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{Ie.initialize()}):Ie.initialize());class Ya{static _initialized=!1;static _debug=!1;static init(t={}){if(this._initialized)return console.warn("[MachVive] Already initialized, skipping duplicate initialization"),this;if(this._debug=t.debug||!1,!window.mvvSSEther)return console.error("[MachVive] mvvSSEther not found - cannot initialize bridge"),console.error("[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()"),this;console.log("[MachVive] Initializing SSE to PubSub bridge...");const a=n=>{this._handleSSEMessage(n)};return window.mvvSSEther.onmessage(a),this._initialized=!0,console.log("[MachVive] ✓ SSE to PubSub bridge initialized successfully"),console.log("[MachVive] ✓ Bound callback to mvvSSEther.onmessage"),this}static _handleSSEMessage(t){try{this._debug&&console.log("[MachVive] SSE message received:",t);const a=t?.data;if(!a){this._debug&&console.log("[MachVive] No data in message, skipping");return}const n=a.data||a.package||a;if(!n){this._debug&&console.log("[MachVive] No package found in message, skipping");return}let o=n.cfg;const s=n.msg;if(this._debug&&(console.log("[MachVive] cfg (raw):",o,"type:",typeof o,"length:",o?.length),console.log("[MachVive] msg (raw):",s)),typeof o=="string"){if(o.trim()===""){this._debug&&console.log("[MachVive] cfg is empty string, skipping");return}try{o=JSON.parse(o),console.log("[MachVive] cfg (parsed):",o)}catch(i){console.warn("[MachVive] Failed to parse cfg as JSON:",{cfg:o,cfgLength:o.length,error:i.message});return}}else if(!o){this._debug&&console.log("[MachVive] cfg is empty/null, skipping");return}const r=o?.topic;if(!r){this._debug&&console.log("[MachVive] No topic found in cfg, skipping");return}if(console.log("[MachVive] Extracted topic:",r),!this._isValidTopic(r)){console.warn(`[MachVive] Topic '${r}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(r,s,t,a)}catch(a){console.error("[MachVive] Error handling SSE message:",a)}}static _isValidTopic(t){return!g||!g.hasOwnProperty(t)?(console.warn(`[MachVive] Topic '${t}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(t,a,n,o){try{if(!window.PubSub&&typeof PubSub>"u"){console.error("[MachVive] PubSub not available");return}const s=window.PubSub||PubSub,r={message:a,metadata:{source:"sse",sseEventId:n.id,timestamp:n.timestamp,appGuid:o.app_guid,channelGuid:o.channel_guid,eventAction:o.event_action,status:o.status,class:o.class,raw:o}};console.log(`[MachVive] Publishing to topic '${t}':`,r);const i=g[t];console.log(`[MachVive] AppBroadcast.${t} = '${i}'`),s.publish(i,r),console.log(`[MachVive] ✓ Published SSE message to topic: ${t}`)}catch(s){console.error(`[MachVive] Error publishing to topic '${t}':`,s)}}static debug(t){return this._debug=t,console.log(`[MachVive] Debug mode ${t?"enabled":"disabled"}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log("[MachVive] Reset complete"),this}}typeof module<"u"&&module.exports&&(module.exports=Ya);typeof window<"u"&&(window.MachVive=Ya);const kn="m5t_sidenav_collapsed",di={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};class pi extends HTMLElement{static get observedAttributes(){return["data-active-token","data-collapsed"]}constructor(){super(),this.attachShadow({mode:"open"}),this.items=[],this.orgs=[],this.activeOrgGuid=null,this.activeToken=null,this.footerBadge=null,this.loading=!1,this.lastFocus=null}#e=null;#t=t=>{if(this.getAttribute("data-open")==="true"){if(t.key==="Escape"){t.preventDefault(),this.closeDrawer();return}if(t.key==="Tab"){const a=this.#c();if(a.length<2)return;const n=a[0],o=a[a.length-1],s=this.shadowRoot.activeElement;t.shiftKey&&s===n?(t.preventDefault(),o.focus()):!t.shiftKey&&s===o&&(t.preventDefault(),n.focus())}}};#o=()=>{this.closeDrawer(),this.#d()};connectedCallback(){if(!this.hasAttribute("data-collapsed"))try{localStorage.getItem(kn)==="true"&&this.setAttribute("data-collapsed","true")}catch{}this.activeToken=this.getAttribute("data-active-token")||null,this.render(),this.#l(),this.addEventListener("keydown",this.#t),this.#e=window.matchMedia("(max-width: 768px)"),this.#e.addEventListener("change",this.#o),this.#d()}disconnectedCallback(){this.removeEventListener("keydown",this.#t),this.#e?.removeEventListener("change",this.#o)}attributeChangedCallback(t,a,n){a===n||!this.shadowRoot||(t==="data-active-token"?(this.activeToken=n,this.#m()):t==="data-collapsed"&&this.shadowRoot.firstChild&&(this.render(),this.#l()))}setState({buttons:t,orgs:a,activeOrg:n,footerBadge:o,loading:s}={}){t!==void 0&&(this.items=Array.isArray(t)?t:this.#a(t)||[]),a!==void 0&&(this.orgs=Array.isArray(a)?a:this.#a(a)||[]),n!==void 0&&(this.activeOrgGuid=n||null),o!==void 0&&(this.footerBadge=o||null),s!==void 0&&(this.loading=!!s),this.shadowRoot&&(this.render(),this.#l())}setButtons(t){this.setState({buttons:t})}setOrgs(t){this.setState({orgs:t})}setActiveOrgGuid(t){this.setState({activeOrg:t})}setFooterBadge(t){this.setState({footerBadge:t})}setActiveToken(t){this.activeToken=t||null,this.#m()}toggleCollapsed(t){const a=typeof t=="boolean"?t:this.getAttribute("data-collapsed")!=="true";this.setAttribute("data-collapsed",String(a));try{localStorage.setItem(kn,String(a))}catch{}this.dispatchEvent(new CustomEvent("nav-collapse",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_SIDE_NAV.COLLAPSE",collapsed:a,timestamp:Date.now()}}))}openDrawer(){this.lastFocus=this.shadowRoot.activeElement||document.activeElement,this.setAttribute("data-open","true"),this.shadowRoot.querySelector(".hamburger")?.setAttribute("aria-expanded","true"),this.#d(),(this.#c()[0]||this.shadowRoot.querySelector(".sidenav"))?.focus?.()}closeDrawer(){if(this.getAttribute("data-open")!=="true")return;this.removeAttribute("data-open");const t=this.shadowRoot.querySelector(".hamburger");t?.setAttribute("aria-expanded","false"),this.#d(),t&&this.#e?.matches?t.focus():this.lastFocus?.focus?.()}toggleDrawer(){this.getAttribute("data-open")==="true"?this.closeDrawer():this.openDrawer()}#a(t){try{return t?JSON.parse(t):null}catch(a){return console.error("[M5TSideNav] bad JSON:",a),null}}#n(t){return String(t??"").replace(/[&<>"']/g,a=>di[a])}#s(t){return t?`<span class="ms" aria-hidden="true">${this.#n(t)}</span>`:""}#i(t){if(!t||!t.token)return"";const a=t.token===this.activeToken,n=t.route||"#",o=n.startsWith("#")?n:`#${n}`,s=typeof t.count=="number"&&t.count>0?`<span class="badge">${t.count}</span>`:"";return`
    ...
    `}attachEventListeners(){this.shadowRoot.querySelectorAll(".nav-button").forEach(n=>{const o=n.getAttribute("data-token"),s=n.getAttribute("data-level");n.addEventListener("click",r=>{o&&!r.currentTarget.disabled&&!this.longTapFired&&(s==="primary"?this.selectPrimaryButton(o):this.selectSecondaryButton(o)),this.longTapFired=!1}),n.addEventListener("dblclick",r=>{if(o&&!r.currentTarget.disabled){const i=this.getButtonData(o,s);console.log("[M5TPrimaryNav] Button double-clicked:",o),this.dispatchEvent(new CustomEvent("nav-double-tap",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.DOUBLE_TAP",token:o,level:s,caption:i.caption,tagline:i.tagline,timestamp:Date.now()}}))}}),n.addEventListener("mouseenter",r=>{if(o&&!r.currentTarget.disabled){const i=this.getButtonData(o,s);this.dispatchEvent(new CustomEvent("nav-hover",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.HOVER",token:o,level:s,caption:i.caption,tagline:i.tagline,action:"enter",timestamp:Date.now()}}))}}),n.addEventListener("mouseleave",r=>{if(o&&!r.currentTarget.disabled){const i=this.getButtonData(o,s);this.dispatchEvent(new CustomEvent("nav-hover",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.HOVER",token:o,level:s,caption:i.caption,tagline:i.tagline,action:"leave",timestamp:Date.now()}}))}}),n.addEventListener("mousedown",r=>{o&&!r.currentTarget.disabled&&(this.longTapActive=!0,this.longTapFired=!1,this.longTapTimer=setTimeout(()=>{const i=this.getButtonData(o,s);console.log("[M5TPrimaryNav] Button long-tap:",o),this.longTapFired=!0,this.dispatchEvent(new CustomEvent("nav-long-tap",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.LONG_TAP",token:o,level:s,caption:i.caption,tagline:i.tagline,timestamp:Date.now()}}))},this.longTapDelay))}),n.addEventListener("mouseup",r=>{this.longTapTimer&&(clearTimeout(this.longTapTimer),this.longTapTimer=null),this.longTapActive=!1}),n.addEventListener("mouseleave",r=>{this.longTapTimer&&(clearTimeout(this.longTapTimer),this.longTapTimer=null),this.longTapActive=!1})});const a=this.shadowRoot.querySelector(".logo");a&&a.addEventListener("click",()=>{console.log("[M5TPrimaryNav] Logo clicked"),this.logoTopic&&window.m5t?.pubsub?(console.log(`[M5TPrimaryNav] Publishing to topic: ${this.logoTopic}`),window.m5t.pubsub.publish(this.logoTopic,{timestamp:Date.now()})):this.logoTopic&&!window.m5t?.pubsub&&console.warn("[M5TPrimaryNav] Logo topic configured but window.m5t.pubsub not found"),this.dispatchEvent(new CustomEvent("logo-click",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.LOGO_TAP",timestamp:Date.now()}}))})}selectPrimaryButton(t){const a=this.buttons.find(o=>o.token===t),n=this.getButtonData(t,"primary");this.dispatchEvent(new CustomEvent("nav-select",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.TAP",token:t,level:"primary",caption:n.caption,tagline:n.tagline,hasSecondary:(a?.secondary?.length||0)>0,timestamp:Date.now()}})),this.selectedPrimaryToken!==t&&(this.selectedPrimaryToken=t,this.render(),this.attachEventListeners())}selectSecondaryButton(t){const a=this.getButtonData(t,"secondary");this.dispatchEvent(new CustomEvent("nav-select",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_PRIMARY_NAV.TAP",token:t,primaryToken:this.selectedPrimaryToken,level:"secondary",caption:a.caption,tagline:a.tagline,timestamp:Date.now()}}))}updateButtons(t){this.setAttribute("data-buttons",JSON.stringify(t)),this.parseButtons(),this.render(),this.attachEventListeners()}updateCount(t,a,n="primary"){let o;n==="primary"?o=this.buttons.find(s=>s.token===t):o=this.getSecondaryButtons().find(r=>r.token===t),o&&(o.count=a,this.render(),this.attachEventListeners())}getSelection(){return{primary:this.selectedPrimaryToken,secondary:null}}}customElements.define("m5t-primary-nav",ui);const Nt=()=>x.getConfig?.().BASE_URL||"",mi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},vt=e=>String(e??"").replace(/[&<>"']/g,t=>mi[t]),gi=300*1e3;function hi(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function fi(e){const t=e.link?"a":"div",a=e.link?` href="${vt(e.link)}"`:"";return`<${t} class="m5t-notif-item" data-guid="${vt(e.guid)}" data-read="${e.read}"${a} role="menuitem">
    <div class="m5t-notif-title">${vt(e.title)}</div>
    ${e.body?`<div class="m5t-notif-body">${vt(e.body)}</div>`:""}
    <div class="m5t-notif-time">${vt(hi(e.created_tz))}</div>
  </${t}>`}function vi(e){const t=document.getElementById("m5t-notif-bell");if(t&&(t.hidden=!e),!e){const a=document.getElementById("m5t-notif-panel");a&&(a.hidden=!0)}}const bi=14;let ba=null;function _i(e){if(typeof ResizeObserver>"u"||!e)return;const t=document.getElementById("m5t-notif-bell"),a=document.getElementById("m5t-notif-bell-btn");if(!t||!a)return;const n=()=>{const o=e.hidden?null:e.querySelector(".ocb-btn");if(o){const s=o.getBoundingClientRect(),r=a.getBoundingClientRect().height;t.style.top=`${Math.round(s.top+(s.height-r)/2)}px`}else t.style.top=`${bi}px`};ba?.disconnect(),ba=new ResizeObserver(n),ba.observe(e),n()}let Sn=null;function yi(){const e=document.getElementById("m5t-notif-bell-btn"),t=document.getElementById("m5t-notif-badge"),a=document.getElementById("m5t-notif-panel");if(!e||!t||!a)return;const n=l=>{t.textContent=l>99?"99+":String(l),t.hidden=!l},o=async()=>{try{const l=await fetch(`${Nt()}/m5t/v5/notifications/unread-count`),c=await l.json().catch(()=>({}));l.ok&&c.ok&&n(c.count||0)}catch{}},s=async()=>{a.innerHTML='<div class="m5t-notif-head">Notifications</div><div class="m5t-notif-empty">Loading…</div>';try{const l=await fetch(`${Nt()}/m5t/v5/notifications`),c=await l.json().catch(()=>({}));if(!l.ok||!c.ok)throw new Error;const m=c.notifications||[];a.innerHTML=`
        <div class="m5t-notif-head">
          Notifications
          ${m.some(h=>!h.read)?'<button class="m5t-notif-markall" type="button">Mark all read</button>':""}
        </div>
        ${m.length?m.map(fi).join(""):'<div class="m5t-notif-empty">You’re all caught up.</div>'}`}catch{a.innerHTML='<div class="m5t-notif-head">Notifications</div><div class="m5t-notif-empty">Could not load. Try again.</div>'}},r=()=>{a.hidden=!0,e.setAttribute("aria-expanded","false")},i=async()=>{a.hidden=!1,e.setAttribute("aria-expanded","true"),await s()};e.addEventListener("click",l=>{l.stopPropagation(),a.hidden?i():r()}),document.addEventListener("click",l=>{!a.hidden&&!a.contains(l.target)&&l.target!==e&&r()}),a.addEventListener("click",async l=>{const c=l.target.closest(".m5t-notif-item");if(c&&c.dataset.read==="false"){const h=c.dataset.guid;c.dataset.read="true";try{await fetch(`${Nt()}/m5t/v5/notifications/${encodeURIComponent(h)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({read:!0})}),o()}catch{}return}const m=l.target.closest(".m5t-notif-markall");if(m){l.preventDefault(),a.querySelectorAll(".m5t-notif-item").forEach(h=>{h.dataset.read="true"}),m.remove();try{await fetch(`${Nt()}/m5t/v5/notifications/read-all`,{method:"PATCH"})}catch{}o()}}),o(),clearInterval(Sn),Sn=setInterval(o,gi)}function Ja(){return ja("FF_SSE_UI_DARK_MODE")}function wi(e=Ja()){return e&&localStorage.getItem(G.FF_SSE_LS_THEME)==="dark"?"dark":"light"}function xi(e=ja("FF_SSE_UI_ANIMATIONS")){return!e}function Ei(e,t=Ja()){!e||t||e.shadowRoot?.querySelector('.footer-action[data-action="theme"]')?.remove()}window.m5t=Object.create(null);window.m5t.pubsub=u;console.log("StreamSyncEngage SaaS Client - Starting...");console.log("Environment:","production");console.log("Document readyState:",document.readyState);console.log("window.mvvLegit:",typeof window.mvvLegit);console.log("globalThis.mvvLegit:",typeof globalThis.mvvLegit);try{console.log("mvvLegit (direct):",typeof mvvLegit)}catch(e){console.log("mvvLegit (direct): ReferenceError -",e.message)}const Ai=Object.keys(window).filter(e=>e.toLowerCase().includes("mvv")||e.toLowerCase().includes("neodigm")||e.toLowerCase().includes("legit"));console.log("Possible Neodigm globals:",Ai);const D=new Fr("/",{hash:!0});window.router=D;function ge(e){const t=e?`${e.replace(/-/g,"_")}_route`:"splash_route";return console.log(`[Router] Checking access: ${e} -> ${t}`),mvvLegit.isRouteAllowed(t)?!0:(console.warn(`[Router] Access denied to route: ${t}`),u.publish(g.UI_TOAST,{message:"Please sign in to access this page",type:"warning"}),!1)}function se(e){console.log("[Router] Navigating to:",e),D.navigate(`/${e}`)}const Ka=new Set(["splash","signin","signup","forgot","resethash","verf-link","accept-invite","signout"]);let Et={},Ca={},Je=null;const ki={admin:{caption:"Platform Admin",icon:"shield_person"},reseller:{caption:"Reseller",icon:"handshake"},managed:{caption:"Managed",icon:"visibility"},self_serve:{caption:"Self-Serve",icon:"rocket_launch"}},$a="__portfolio__";function Po(){try{D._setCurrent(null)}catch{}D.resolve()}function _a(){const e=document.getElementById("m5t-side-nav");if(!e)return;const t=!x.getScope()&&x.isAuthenticated(),a=x.getCapabilities(),n=x.getUiMode(),o=la.getSideNav(a,{uiMode:n});Et={},Ca={};const s=b=>{b.route&&(Et[b.route]={sectionToken:b.token,childToken:null,children:b.children||null},Array.isArray(b.children)&&b.children.forEach(p=>{p.route&&(Ca[p.token]=p.route,Et[p.route]={sectionToken:b.token,childToken:p.token,children:b.children})}))},r=b=>b.forEach(p=>{p.group&&Array.isArray(p.items)?r(p.items):s(p)});r(o);const i=x.getMemberships(),l=x.getActiveOrg(),c=x.getManagedClients(),m=x.getStoredActiveOrg(),h=c.length?[{guid:$a,name:"Portfolio (all clients)"},...i.map(b=>({guid:b.orgGuid,name:b.name||b.channel,channel:b.channel,group:"Your organization"})),...c.map(b=>({guid:b.orgGuid,name:b.name||b.orgGuid,channel:b.channel,group:"Clients"}))]:i.map(b=>({guid:b.orgGuid,name:b.name||b.channel,channel:b.channel}));e.setState({buttons:o,orgs:h,activeOrg:c.length?m||$a:l?.guid||null,footerBadge:ki[n]||null,loading:t}),Fo(),Je&&Do(Je)}const Si=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]);function Fo(){const e=document.getElementById("app-content");if(!e)return;let t=document.getElementById("org-context-banner");t||(t=document.createElement("div"),t.id="org-context-banner",e.insertBefore(t,e.firstChild),_i(t));const a=x.getActiveOrg(),n=x.isPreviewingAsClient(),o=!!a?.viaSubtree&&!!Je&&!Ka.has(Je);if(t.hidden=!o,!o){t.innerHTML="";return}const s=Si(a.name||"Client");t.innerHTML=`
    <style>
    ...
    <div class="ocb" role="status">
    ...
    </div>`,t.querySelector('[data-ocb="preview"]')?.addEventListener("click",()=>{x.setPreviewAsClient(!x.isPreviewingAsClient()),Po()}),t.querySelector('[data-ocb="portfolio"]')?.addEventListener("click",()=>{x.setPreviewAsClient(!1),x.setActiveOrg(null)})}function Do(e){const t=document.getElementById("m5t-side-nav"),a=Et[`/${e}`]||Et[e]||null;t?.setActiveToken(a?.sectionToken||null),Ti(a)}function Ti(e){const t=document.getElementById("m5t-sub-nav"),a=document.getElementById("app-shell");if(!t)return;const n=e?.children;t.hidden=!1,n&&n.length>1?(t.updateButtons(n.map(o=>({token:o.token,caption:o.caption,enabled:!0,selected:o.token===e.childToken}))),a?.classList.add("has-sub-nav")):(t.updateButtons([]),a?.classList.remove("has-sub-nav"))}function Ci(){const e=Ie.getAvailableLanguages&&Ie.getAvailableLanguages()||[];if(e.length<2){u.publish(g.UI_TOAST,{message:"Only one language is available",type:"info"});return}const t=localStorage.getItem(G.FF_SSE_LS_USER_LANG)||G.FF_SSE_I18N_LANG||e[0],a=e[(e.indexOf(t)+1)%e.length];Ie.setLanguage(a),u.publish(g.UI_TOAST,{message:`Language: ${a}`,type:"info"})}function Bo(e){document.documentElement.setAttribute("data-theme",e)}function $i(){Bo(wi())}function Ii(){if(!Ja())return;const e=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";Bo(e),localStorage.setItem(G.FF_SSE_LS_THEME,e),u.publish(g.UI_TOAST,{message:e==="dark"?"Dark mode on":"Dark mode off",type:"info"})}function Li(){document.documentElement.classList.toggle("ff-no-animations",xi())}function Ri(){const e=document.getElementById("m5t-side-nav");if(!e)return;la.setAppToken("client-saas"),Ei(e),document.getElementById("app-shell")?.classList.toggle("nav-collapsed",e.getAttribute("data-collapsed")==="true"),e.addEventListener("nav-select",o=>{const s=o.detail?.route;s&&D.navigate(s.startsWith("/")?s:`/${s}`)}),e.addEventListener("logo-click",()=>D.navigate("/home")),e.addEventListener("nav-collapse",o=>{document.getElementById("app-shell")?.classList.toggle("nav-collapsed",!!o.detail?.collapsed)}),e.addEventListener("org-switch",o=>{const s=o.detail?.orgGuid;s&&x.setActiveOrg(s===$a?null:s)}),e.addEventListener("footer-action",o=>{switch(o.detail?.action){case"account":D.navigate("/settings");break;case"signout":D.navigate("/signout");break;case"lang":Ci();break;case"theme":Ii();break}}),document.getElementById("m5t-sub-nav")?.addEventListener("nav-select",o=>{const s=Ca[o.detail?.token];s&&D.navigate(s)}),document.addEventListener("language-changed",()=>_a()),_a(),u.subscribe(g.AUTH_SCOPE_LOADED,()=>_a());const a=()=>{const o=x.getScope();return[o?.uiMode,o?.activeOrg?.guid,(o?.managedClients||[]).length,(o?.capabilities||[]).join(","),x.getStoredActiveOrg()].join("|")};let n=a();u.subscribe(g.AUTH_SCOPE_LOADED,()=>{const o=a();o!==n&&(n=o,Je&&!Ka.has(Je)&&Po())})}function Ni(e){Je=e;const t=document.getElementById("m5t-side-nav"),a=document.getElementById("app-shell");if(!t||!a)return;const n=!Ka.has(e);if(t.hidden=!n,a.classList.toggle("has-side-nav",n),vi(n),n)Do(e);else{const o=document.getElementById("m5t-sub-nav");o&&(o.hidden=!0),a.classList.remove("has-sub-nav")}Fo()}u.subscribe(g.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&Ni(t.route)});const Uo=()=>{console.log("[Router] Route: splash"),u.publish(g.ROUTE_NAV_BEFORE,{route:"splash"});const e=Oo(),t=!e&&Kr();(e?Q(()=>Promise.resolve().then(()=>Vi),void 0,import.meta.url):t?Q(()=>Promise.resolve().then(()=>Ki),void 0,import.meta.url):Q(()=>Promise.resolve().then(()=>Zi),void 0,import.meta.url)).then(n=>{const o=document.getElementById("app");o.innerHTML=n.render(),n.init&&n.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"splash"})}).catch(n=>{console.error("[Router] Error loading splash route:",n),u.publish(g.ROUTE_NAV_ERROR,{route:"splash",error:n})})};D.on("/",Uo);D.on("/splash",Uo);D.on("/signin",()=>{console.log("[Router] Route: /signin"),u.publish(g.ROUTE_NAV_BEFORE,{route:"signin"}),Q(()=>Promise.resolve().then(()=>rl),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"signin"})}).catch(e=>{console.error("[Router] Error loading signin route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"signin",error:e})})});D.on("/signup",()=>{console.log("[Router] Route: /signup"),u.publish(g.ROUTE_NAV_BEFORE,{route:"signup"}),Q(()=>Promise.resolve().then(()=>ul),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"signup"})}).catch(e=>{console.error("[Router] Error loading signup route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"signup",error:e})})});D.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),u.publish(g.ROUTE_NAV_BEFORE,{route:"verf-link"}),Q(()=>Promise.resolve().then(()=>hl),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(e=>{console.error("[Router] Error loading verf-link route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"verf-link",error:e})})});D.on("/forgot",()=>{console.log("[Router] Route: /forgot"),u.publish(g.ROUTE_NAV_BEFORE,{route:"forgot"}),Q(()=>Promise.resolve().then(()=>xl),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(e=>{console.error("[Router] Error loading forgot route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"forgot",error:e})})});D.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!ge("resethash")){se("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"resethash"}),Q(()=>Promise.resolve().then(()=>kl),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(e=>{console.error("[Router] Error loading resethash route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"resethash",error:e})})});D.on("/home",()=>{if(console.log("[Router] Route: /home"),!ge("home")){se("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"home"}),Q(()=>Promise.resolve().then(()=>Dl),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"home"})}).catch(e=>{console.error("[Router] Error loading home route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"home",error:e})})});D.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!ge("signout")){se("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"signout"}),Q(()=>Promise.resolve().then(()=>ql),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"signout"})}).catch(e=>{console.error("[Router] Error loading signout route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"signout",error:e})})});const Oi=[{path:"/templates",name:"templates",title:"Templates",icon:"content_copy"},{path:"/analytics",name:"analytics",title:"Analytics",icon:"monitoring"},{path:"/ad-accounts",name:"ad-accounts",title:"Ad Accounts",icon:"ads_click"},{path:"/billing",name:"billing",title:"Billing",icon:"receipt_long"},{path:"/settings",name:"settings",title:"Settings",icon:"settings"},{path:"/magnets/drafts",name:"magnets/drafts",title:"Magnets · Drafts",icon:"widgets"},{path:"/magnets/archived",name:"magnets/archived",title:"Magnets · Archived",icon:"widgets"},{path:"/analytics/conversions",name:"analytics/conversions",title:"Analytics · Conversions",icon:"monitoring"},{path:"/settings/workspace",name:"settings/workspace",title:"Settings · Workspace",icon:"settings"},{path:"/settings/integrations",name:"settings/integrations",title:"Settings · Integrations",icon:"settings"}];Oi.forEach(({path:e,name:t,title:a,icon:n})=>{D.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!ge("home")){se("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:t}),Q(()=>Promise.resolve().then(()=>Gl),void 0,import.meta.url).then(o=>{const s=document.getElementById("app");s.innerHTML=o.render({title:a,icon:n,name:t}),o.init&&o.init({name:t}),u.publish(g.ROUTE_NAV_AFTER,{route:t})}).catch(o=>{console.error(`[Router] Error loading section route (${t}):`,o),u.publish(g.ROUTE_NAV_ERROR,{route:t,error:o})})})});D.on("/settings/notifications",()=>{if(console.log("[Router] Route: /settings/notifications"),!ge("home")){se("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"settings/notifications"}),Q(()=>Promise.resolve().then(()=>Xl),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"settings/notifications"})}).catch(e=>{console.error("[Router] Error loading settings-notifications route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"settings/notifications",error:e})})});D.on("/settings/integrations",()=>{if(console.log("[Router] Route: /settings/integrations"),!ge("home")){se("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),Q(()=>Promise.resolve().then(()=>hc),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(e=>{console.error("[Router] Error loading settings-integrations route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"settings/integrations",error:e})})});D.on("/settings/security",()=>{if(console.log("[Router] Route: /settings/security"),!ge("home")){se("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"settings/security"}),Q(()=>Promise.resolve().then(()=>Ec),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"settings/security"})}).catch(e=>{console.error("[Router] Error loading settings-security route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"settings/security",error:e})})});D.on("/conversations",()=>{if(console.log("[Router] Route: /conversations"),!ge("home")){se("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"conversations"}),Q(()=>Promise.resolve().then(()=>Nc),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"conversations"})}).catch(e=>{console.error("[Router] Error loading conversations route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"conversations",error:e})})});D.on("/ab-testing",()=>{if(console.log("[Router] Route: /ab-testing"),!ge("home")){se("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"ab-testing"}),Q(()=>Promise.resolve().then(()=>Wc),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"ab-testing"})}).catch(e=>{console.error("[Router] Error loading ab-testing route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"ab-testing",error:e})})});D.on("/magnets",()=>{if(console.log("[Router] Route: /magnets"),!ge("home")){se("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"magnets"}),Q(()=>Promise.resolve().then(()=>Vd),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"magnets"})}).catch(e=>{console.error("[Router] Error loading magnets route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"magnets",error:e})})});D.on("/leads",()=>{if(console.log("[Router] Route: /leads"),!ge("home")){se("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"leads"}),Q(()=>Promise.resolve().then(()=>rp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"leads"})}).catch(e=>{console.error("[Router] Error loading leads route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"leads",error:e})})});D.on("/analytics/ad-performance",()=>{if(console.log("[Router] Route: /analytics/ad-performance"),!ge("home")){se("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"analytics/ad-performance"}),Q(()=>Promise.resolve().then(()=>mp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"analytics/ad-performance"})}).catch(e=>{console.error("[Router] Error loading ad-performance route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"analytics/ad-performance",error:e})})});D.on("/clients",()=>{if(console.log("[Router] Route: /clients"),!ge("home")){se("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"clients"}),Q(()=>Promise.resolve().then(()=>kp),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"clients"})}).catch(e=>{console.error("[Router] Error loading clients route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"clients",error:e})})});D.on("/team",()=>{if(console.log("[Router] Route: /team"),!ge("home")){se("signin");return}u.publish(g.ROUTE_NAV_BEFORE,{route:"team"}),Q(()=>Promise.resolve().then(()=>Op),void 0,import.meta.url).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),u.publish(g.ROUTE_NAV_AFTER,{route:"team"})}).catch(e=>{console.error("[Router] Error loading team route:",e),u.publish(g.ROUTE_NAV_ERROR,{route:"team",error:e})})});D.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),se("splash")});u.subscribe(g.ROUTE_NAV,(e,t)=>{console.log("[Router] ROUTE_NAV event received:",t),t?.route&&se(t.route)});function Tn(){console.log("[App] Waiting for Neodigm 55 library...");let e=0;const t=100,a=setInterval(()=>{e++,e%10===0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(a),Mi()):e>=t&&(clearInterval(a),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
      ...
      `,u.publish(g.APP_ERROR,{message:"Failed to load authentication library"}))},100)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Tn):Tn();async function Mi(){if(console.log("[App] Neodigm 55 loaded, initializing..."),$i(),Li(),Jr(),Ie.initialize(),console.log("[App] I18n Controller initialized"),!await x.init({BASE_URL:"https://machfivemagnet-saas.onrender.com",navigateFunction:a=>{console.log("[AuthController] Navigation requested:",a),se(a)}})){console.error("[App] AuthController initialization failed");return}const t=x.getEntity();t&&(console.log("[App] Session restored for:",t.email),u.publish(g.APP_USER_LOADED,{entity:t}),x.isAuthenticated()&&(localStorage.getItem(x.CONFIG.LS_KEYS.ACTIVE_ORG)?await x.fetchScope():x.fetchScope())),u.publish(g.APP_READY,{timestamp:new Date().toISOString(),sessionUser:t}),Ri(),yi(),D.resolve(),window.AuthController=x,window.I18nController=Ie,window.MachVive=Ya,console.log("[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)")}u.subscribe(g.ROUTE_NAV_AFTER,(e,t)=>{typeof Ie<"u"&&Ie.refresh&&setTimeout(()=>{Ie.refresh()},100)});function Ee(e){const t=new Uint8Array(e);let a="";for(const o of t)a+=String.fromCharCode(o);return btoa(a).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"")}function St(e){const t=e.replace(/-/g,"+").replace(/_/g,"/"),a=(4-t.length%4)%4,n=t.padEnd(t.length+a,"="),o=atob(n),s=new ArrayBuffer(o.length),r=new Uint8Array(s);for(let i=0;i<o.length;i++)r[i]=o.charCodeAt(i);return s}function Ct(){return qo.stubThis(globalThis?.PublicKeyCredential!==void 0&&typeof globalThis.PublicKeyCredential=="function")}const qo={stubThis:e=>e};function Ho(e){const{id:t}=e;return{...e,id:St(t),transports:e.transports}}function zo(e){return e==="localhost"||/^((xn--[a-z0-9-]+|[a-z0-9]+(-[a-z0-9]+)*)\.)+([a-z]{2,}|xn--[a-z0-9-]+)$/i.test(e)}class ne extends Error{constructor({message:t,code:a,cause:n,name:o}){super(t,{cause:n}),Object.defineProperty(this,"code",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),this.name=o??n.name,this.code=a}}function Pi({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new ne({message:"Registration ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else if(e.name==="ConstraintError"){if(a.authenticatorSelection?.requireResidentKey===!0)return new ne({message:"Discoverable credentials were required but no available authenticator supported it",code:"ERROR_AUTHENTICATOR_MISSING_DISCOVERABLE_CREDENTIAL_SUPPORT",cause:e});if(t.mediation==="conditional"&&a.authenticatorSelection?.userVerification==="required")return new ne({message:"User verification was required during automatic registration but it could not be performed",code:"ERROR_AUTO_REGISTER_USER_VERIFICATION_FAILURE",cause:e});if(a.authenticatorSelection?.userVerification==="required")return new ne({message:"User verification was required but no available authenticator supported it",code:"ERROR_AUTHENTICATOR_MISSING_USER_VERIFICATION_SUPPORT",cause:e})}else{if(e.name==="InvalidStateError")return new ne({message:"The authenticator was previously registered",code:"ERROR_AUTHENTICATOR_PREVIOUSLY_REGISTERED",cause:e});if(e.name==="NotAllowedError")return new ne({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="NotSupportedError")return a.pubKeyCredParams.filter(o=>o.type==="public-key").length===0?new ne({message:'No entry in pubKeyCredParams was of type "public-key"',code:"ERROR_MALFORMED_PUBKEYCREDPARAMS",cause:e}):new ne({message:"No available authenticator supported any of the specified pubKeyCredParams algorithms",code:"ERROR_AUTHENTICATOR_NO_SUPPORTED_PUBKEYCREDPARAMS_ALG",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if(zo(n)){if(a.rp.id!==n)return new ne({message:`The RP ID "${a.rp.id}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new ne({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="TypeError"){if(a.user.id.byteLength<1||a.user.id.byteLength>64)return new ne({message:"User ID was not between 1 and 64 characters",code:"ERROR_INVALID_USER_ID_LENGTH",cause:e})}else if(e.name==="UnknownError")return new ne({message:"The authenticator was unable to process the specified options, or could not create a new credential",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}class Fi{constructor(){Object.defineProperty(this,"controller",{enumerable:!0,configurable:!0,writable:!0,value:void 0})}createNewAbortSignal(){if(this.controller){const a=new Error("Cancelling existing WebAuthn API call for new one");a.name="AbortError",this.controller.abort(a)}const t=new AbortController;return this.controller=t,t.signal}cancelCeremony(){if(this.controller){const t=new Error("Manually cancelling existing WebAuthn API call");t.name="AbortError",this.controller.abort(t),this.controller=void 0}}}const Qa=new Fi,Di=["cross-platform","platform"];function Go(e){if(e&&!(Di.indexOf(e)<0))return e}async function Bi(e){!e.optionsJSON&&e.challenge&&(console.warn("startRegistration() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useAutoRegister:a=!1}=e;if(!Ct())throw new Error("WebAuthn is not supported in this browser");const n={...t,challenge:St(t.challenge),user:{...t.user,id:St(t.user.id)},excludeCredentials:t.excludeCredentials?.map(Ho)},o={};a&&(o.mediation="conditional"),o.publicKey=n,o.signal=Qa.createNewAbortSignal();let s;try{s=await navigator.credentials.create(o)}catch(f){throw Pi({error:f,options:o})}if(!s)throw new Error("Registration was not completed");const{id:r,rawId:i,response:l,type:c}=s;let m;typeof l.getTransports=="function"&&(m=l.getTransports());let h;if(typeof l.getPublicKeyAlgorithm=="function")try{h=l.getPublicKeyAlgorithm()}catch(f){ya("getPublicKeyAlgorithm()",f)}let b;if(typeof l.getPublicKey=="function")try{const f=l.getPublicKey();f!==null&&(b=Ee(f))}catch(f){ya("getPublicKey()",f)}let p;if(typeof l.getAuthenticatorData=="function")try{p=Ee(l.getAuthenticatorData())}catch(f){ya("getAuthenticatorData()",f)}return{id:r,rawId:Ee(i),response:{attestationObject:Ee(l.attestationObject),clientDataJSON:Ee(l.clientDataJSON),transports:m,publicKeyAlgorithm:h,publicKey:b,authenticatorData:p},type:c,clientExtensionResults:s.getClientExtensionResults(),authenticatorAttachment:Go(s.authenticatorAttachment)}}function ya(e,t){console.warn(`The browser extension that intercepted this WebAuthn API call incorrectly implemented ${e}. You should report this error to them.
`,t)}function jo(){if(!Ct())return Ut.stubThis(new Promise(t=>t(!1)));const e=globalThis.PublicKeyCredential;return e?.isConditionalMediationAvailable===void 0?Ut.stubThis(new Promise(t=>t(!1))):Ut.stubThis(e.isConditionalMediationAvailable())}const Ut={stubThis:e=>e};function Ui({error:e,options:t}){const{publicKey:a}=t;if(!a)throw Error("options was missing required publicKey property");if(e.name==="AbortError"){if(t.signal instanceof AbortSignal)return new ne({message:"Authentication ceremony was sent an abort signal",code:"ERROR_CEREMONY_ABORTED",cause:e})}else{if(e.name==="NotAllowedError")return new ne({message:e.message,code:"ERROR_PASSTHROUGH_SEE_CAUSE_PROPERTY",cause:e});if(e.name==="SecurityError"){const n=globalThis.location.hostname;if(zo(n)){if(a.rpId!==n)return new ne({message:`The RP ID "${a.rpId}" is invalid for this domain`,code:"ERROR_INVALID_RP_ID",cause:e})}else return new ne({message:`${globalThis.location.hostname} is an invalid domain`,code:"ERROR_INVALID_DOMAIN",cause:e})}else if(e.name==="UnknownError")return new ne({message:"The authenticator was unable to process the specified options, or could not create a new assertion signature",code:"ERROR_AUTHENTICATOR_GENERAL_ERROR",cause:e})}return e}async function qi(e){!e.optionsJSON&&e.challenge&&(console.warn("startAuthentication() was not called correctly. It will try to continue with the provided options, but this call should be refactored to use the expected call structure instead. See https://simplewebauthn.dev/docs/packages/browser#typeerror-cannot-read-properties-of-undefined-reading-challenge for more information."),e={optionsJSON:e});const{optionsJSON:t,useBrowserAutofill:a=!1,verifyBrowserAutofillInput:n=!0}=e;if(!Ct())throw new Error("WebAuthn is not supported in this browser");let o;t.allowCredentials?.length!==0&&(o=t.allowCredentials?.map(Ho));const s={...t,challenge:St(t.challenge),allowCredentials:o},r={};if(a){if(!await jo())throw Error("Browser does not support WebAuthn autofill");if(document.querySelectorAll("input[autocomplete$='webauthn']").length<1&&n)throw Error('No <input> with "webauthn" as the only or last value in its `autocomplete` attribute was detected');r.mediation="conditional",s.allowCredentials=[]}r.publicKey=s,r.signal=Qa.createNewAbortSignal();let i;try{i=await navigator.credentials.get(r)}catch(p){throw Ui({error:p,options:r})}if(!i)throw new Error("Authentication was not completed");const{id:l,rawId:c,response:m,type:h}=i;let b;return m.userHandle&&(b=Ee(m.userHandle)),{id:l,rawId:Ee(c),response:{authenticatorData:Ee(m.authenticatorData),clientDataJSON:Ee(m.clientDataJSON),signature:Ee(m.signature),userHandle:b},type:h,clientExtensionResults:i.getClientExtensionResults(),authenticatorAttachment:Go(i.authenticatorAttachment)}}function Hi(){return Ct()?PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable():new Promise(e=>e(!1))}const Vo=Object.freeze(Object.defineProperty({__proto__:null,WebAuthnAbortService:Qa,WebAuthnError:ne,_browserSupportsWebAuthnAutofillInternals:Ut,_browserSupportsWebAuthnInternals:qo,base64URLStringToBuffer:St,browserSupportsWebAuthn:Ct,browserSupportsWebAuthnAutofill:jo,bufferToBase64URLString:Ee,platformAuthenticatorIsAvailable:Hi,startAuthentication:qi,startRegistration:Bi},Symbol.toStringTag,{value:"Module"}));let Cn=!1;function zi(){if(Cn)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
    .accept-invite-page {
  ...
  `,document.head.appendChild(e),$n=!0}function In(){return x.getConfig?.().BASE_URL||""}function Yi(e){const t=`qf-${e.id}`;if(e.type==="checkbox_group"){const a=Array.isArray(e.options)?e.options:[];return`
    ...
    </div>`}function Pe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function yt(e,t,a){return`
    <div class="qf-page"><div class="qf-card"><div class="qf-state">
      <span class="material-symbols-outlined">${e}</span>
      <h1>${Pe(t)}</h1>
      <p class="qf-sub">${Pe(a)}</p>
    </div></div></div>`}function Jo(){return Wi(),`<div id="qf-root">${yt("hourglass_top","Loading your questionnaire…","One moment.")}</div>`}async function Ko(){const e=document.getElementById("qf-root");if(!e)return;const t=Qr();if(!t){e.innerHTML=yt("error","Invalid link","This link is missing required information. Please use the link exactly as sent.");return}let a;try{const c=await fetch(`${In()}/m5t/v5/m5mQuestionnaireResponse/public/${encodeURIComponent(t.guid)}?token=${encodeURIComponent(t.token)}`),m=await c.json().catch(()=>({}));if(!c.ok||!m.ok){const h=c.status===404?m.error||"This link is invalid or has expired.":"Something went wrong loading your questionnaire. Please try again shortly.";e.innerHTML=yt("error","Cannot open this questionnaire",h);return}a=m.data}catch(c){console.error("[questionnaire-fill] load error:",c),e.innerHTML=yt("wifi_off","Connection problem","Could not reach the server. Please check your connection and try again.");return}const n=a.questionnaire?.sections||[],o=a.answers||{};e.innerHTML=`
  ...
  `}function Xi(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const e=localStorage.getItem(G.FF_SSE_LS_TOKEN),t=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!e,hasMvvTs:!!t});const a=document.getElementById("splash-loader"),n=document.getElementById("splash-actions");e?(console.log("[SplashRoute] Auth token found → HOME"),u.publish(g.ROUTE_NAV,{route:"home"})):t?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),u.publish(g.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),a&&(a.style.display="none"),n&&(n.style.display="flex"),document.querySelectorAll("[data-route]").forEach(s=>{s.addEventListener("click",()=>{const r=s.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${r}`),u.publish(g.ROUTE_NAV,{route:r})})}))},4e3)}const Zi=Object.freeze(Object.defineProperty({__proto__:null,init:Xi,render:Qi},Symbol.toStringTag,{value:"Module"}));function pe(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}const el=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;function Xa(e,t){return e?el.test(e)?!0:(pe(t,C.get("validation_email_invalid")),!1):(pe(t,C.get("validation_email_required")),!1)}function tl(){return`
  ...
  `}function al(){console.log("[SigninRoute] Initialized");const e=document.getElementById("loginForm"),t=document.getElementById("email"),a=document.getElementById("password"),n=document.getElementById("togglePassword"),o=document.getElementById("rememberEmail"),s=localStorage.getItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL);s&&t&&o&&(t.value=s,o.checked=!0,a?.focus()),n?.addEventListener("click",()=>{const m=a.type==="password"?"text":"password";a.type=m});const r=document.getElementById("passkeySigninBtn"),i=document.getElementById("passkeyDivider"),l=document.getElementById("passkeyHint");window.PublicKeyCredential&&r&&i&&(r.style.display="",i.style.display="",l&&(l.style.display=""),r.addEventListener("click",()=>sl())),e?.addEventListener("submit",async m=>{m.preventDefault();const h=t.value.trim(),b=a.value;Xa(h,t)&&nl(b,a)&&(o?.checked?localStorage.setItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL,h):localStorage.removeItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL),await ol(h,b))}),document.getElementById("link--uc__underline")?.addEventListener("click",m=>{m.preventDefault(),u.publish(g.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",m=>{m.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),u.publish(g.ROUTE_NAV,{route:"signup"})})}function nl(e,t){return e?e.length<10?(pe(t,C.get("validation_password_min_length")),!1):!0:(pe(t,C.get("validation_password_required")),!1)}async function ol(e,t){const a=document.querySelector(".btn");a.disabled=!0,a.textContent=C.get("loading_signing_in");try{const n=await x.doSignin(e,t);n.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(C.get("success_welcome_back"),"success"),u.publish(g.AUTH_SIGNIN_SUCCESS,{entity:x.getEntity()})):n.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q(C.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(n.error||C.get("error_signin_failed"),"danger"),a.disabled=!1,a.textContent=(C.get("sign_in")||"Sign in").toUpperCase())}catch(n){console.error("[SigninRoute] Sign in error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||C.get("error_network"),"danger"),a.disabled=!1,a.textContent=(C.get("sign_in")||"Sign in").toUpperCase(),u.publish(g.AUTH_SIGNIN_FAIL,{message:n.message})}}async function sl(){const e=document.getElementById("passkeySigninBtn");e.disabled=!0;try{const t=await x.doPasskeySignin();t.ok?(console.log("[SigninRoute] Passkey signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(C.get("success_welcome_back"),"success"),u.publish(g.AUTH_SIGNIN_SUCCESS,{entity:x.getEntity()})):t.canceled||typeof neodigmToast<"u"&&neodigmToast.q(t.error||C.get("error_signin_failed"),"danger")}catch(t){console.error("[SigninRoute] Passkey signin error:",t),typeof neodigmToast<"u"&&neodigmToast.q(t.message||C.get("error_network"),"danger")}finally{e.disabled=!1}}const rl=Object.freeze(Object.defineProperty({__proto__:null,init:al,render:tl},Symbol.toStringTag,{value:"Module"}));function Qo(e){const t=[];return e.length<12&&t.push("at least 12 characters"),e.length>1024&&t.push("at most 1024 characters"),/[a-z]/.test(e)||t.push("1 lowercase"),/[A-Z]/.test(e)||t.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(e)||t.push("1 special character"),/[^\x00-\x7F]/.test(e)&&t.push("ASCII characters only"),t}function Xo(e){return e.length===0?"":e.includes("ASCII characters only")?"Password cannot contain emoji|or special unicode characters":e.includes("at least 10 characters")?"Password must have at least|10 characters":"Password must have: Uppercase,|Lowercase, and Special Character"}const il="2026-07-15";function ll(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function cl(){console.log("[SignupRoute] Initialized");const e=document.getElementById("signupForm"),t=e.querySelector('button[type="submit"]');Ln("togglePassword","password","eyeIcon"),Ln("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),u.publish(g.ROUTE_NAV,{route:"signin"})}),e.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),s=document.getElementById("last").value.trim(),r=document.getElementById("email").value.trim(),i=document.getElementById("company").value.trim(),l=document.getElementById("phone").value.trim(),c=document.getElementById("password").value,m=document.getElementById("confirmPassword").value,h=document.getElementById("first"),b=document.getElementById("last"),p=document.getElementById("email"),f=document.getElementById("password"),d=document.getElementById("confirmPassword");if(!Rn(o,h,C.get("validation_first_name_required"))||!Rn(s,b,C.get("validation_last_name_required"))||!Xa(r,p)||!dl(c,f))return;if(c!==m){pe(d,C.get("validation_password_mismatch"));return}const v=document.getElementById("acceptTerms");if(!v.checked){pe(v,"Please accept the Terms of Service and Privacy Policy to continue.");return}t.disabled=!0,t.textContent=C.get("loading_creating_account"),await pl(o,s,r,i,l,c)})}function Ln(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function Rn(e,t,a){return e?!0:(pe(t,a),!1)}function dl(e,t){if(!e)return pe(t,C.get("validation_password_required")),!1;const a=Qo(e);return a.length>0?(pe(t,Xo(a)),!1):!0}async function pl(e,t,a,n,o,s){const r=document.querySelector('button[type="submit"]');try{const i={email:a,password:s,first:e,last:t};n&&(i.company=n),o&&(i.phone=o),i.terms_accepted=!0,i.legal_version=il;const l=await x.doSignup(i);if(l.ok)u.publish(g.AUTH_SIGNUP_SUCCESS,{email:a}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const c=l.error||l.message||C.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(c,"danger"),r.disabled=!1,r.textContent=(C.get("create_account")||"Create account").toUpperCase(),u.publish(g.AUTH_SIGNUP_FAIL,{message:c})}}catch(i){console.error("[SignupRoute] Sign up error:",i),typeof neodigmToast<"u"&&neodigmToast.q(i.message||C.get("error_network"),"danger"),r.disabled=!1,r.textContent=(C.get("create_account")||"Create account").toUpperCase(),u.publish(g.AUTH_SIGNUP_FAIL,{message:i.message})}}const ul=Object.freeze(Object.defineProperty({__proto__:null,init:cl,render:ll},Symbol.toStringTag,{value:"Module"}));function ml(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function yl(){console.log("[ForgotRoute] Initialized");const e=document.getElementById("forgot-form"),t=document.getElementById("email");e?.addEventListener("submit",async a=>{a.preventDefault();const n=t.value.trim();Xa(n,t)&&await wl(n)})}async function wl(e){const t=document.querySelector(".btn");t.disabled=!0,t.textContent="SENDING...";try{const a=await bl.forgotPassword(e);a.ok&&a.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q(C.get("success_reset_link_sent"),"success"),u.publish(g.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(a.data.error||C.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=(C.get("send_reset_link")||"Send reset link").toUpperCase())}catch(a){console.error("[ForgotRoute] Forgot password error:",a),typeof neodigmToast<"u"&&neodigmToast.q(a.message||C.get("error_network"),"danger"),t.disabled=!1,t.textContent=(C.get("send_reset_link")||"Send reset link").toUpperCase()}}const xl=Object.freeze(Object.defineProperty({__proto__:null,init:yl,render:_l},Symbol.toStringTag,{value:"Module"}));function El(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function Al(){console.log("[ResethashRoute] Initialized");const e=document.getElementById("resethash-form"),t=e.querySelector('button[type="submit"]');Nn("toggleNewPassword","new-password","eyeIconNew"),Nn("toggleConfirmPassword","confirm-password","eyeIconConfirm"),e?.addEventListener("submit",async a=>{a.preventDefault();const n=e.email.value.trim(),o=e.newPassword.value,s=e.confirmPassword.value,r=document.getElementById("new-password"),i=document.getElementById("confirm-password");if(!o){pe(r,C.get("validation_new_password_required"));return}const l=Qo(o);if(l.length>0){pe(r,Xo(l));return}if(!s){pe(i,C.get("validation_new_password_required"));return}if(o!==s){pe(i,C.get("validation_password_mismatch"));return}t.disabled=!0,t.textContent=C.get("loading_resetting_password");try{const c=await x.doResetHash(n,o);c.ok?(typeof neodigmToast<"u"&&neodigmToast.q(C.get("success_password_reset"),"success"),u.publish(g.AUTH_RESETHASH_SUCCESS,{email:n})):(pe(r,c.error||C.get("error_signin_failed")),t.disabled=!1,t.textContent=(C.get("update_password")||"Update password").toUpperCase())}catch(c){console.error("[ResethashRoute] Reset password error:",c),pe(r,c.message||C.get("error_network")),t.disabled=!1,t.textContent=(C.get("update_password")||"Update password").toUpperCase()}})}function Nn(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}const kl=Object.freeze(Object.defineProperty({__proto__:null,init:Al,render:El},Symbol.toStringTag,{value:"Module"})),re=()=>x.getManagedClients().length>0&&!x.getStoredActiveOrg(),qe=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),Sl={reseller_org:"Your org",managed_client:"Client",saas_org:"Org"};let On=!1;function pt(){if(On)return;const e=document.createElement("style");e.id="m5t-portfolio-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),On=!0}const Mn=e=>e.toISOString().slice(0,10);async function Tl(e,{days:t=30}={}){const a=new Date,n=Mn(new Date(a.getTime()-(t-1)*864e5)),o=Mn(a),s=await fetch(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${o}&group_by=owner`);if(!s.ok)throw new Error(`HTTP ${s.status}`);const r=await s.json();if(!r.ok)throw new Error("stats not ok");return r.by_owner||[]}function Zo(e,t){return`<div class="dash-clients-scroll"><table class="dash-clients">
    ...
    <tbody>${e.map(a=>`
      <tr data-org="${qe(a.owner_guid)}" tabindex="0" role="button"
        ...
        <td><span class="dc-name">${qe(a.name||a.owner_guid)}
          <span class="dc-chip">${qe(Sl[a.channel]||a.channel||"")}</span></span></td>
        ${t.map(n=>`<td>${n.td(a)}</td>`).join("")}
        <td><span class="dc-view">View →</span></td>
      </tr>`).join("")}</tbody>
  </table></div>`}function Cl(e){let t=e.querySelector(".pf-access-error");t||(t=document.createElement("div"),t.className="pf-access-error",e.prepend(t)),t.textContent="You don't have direct access to manage this org. Use the admin console to act on its behalf."}function es(e){if(!e)return;const t=async a=>{const n=a?.dataset?.org;if(!n)return;(await x.setActiveOrg(n))?.activeOrgError&&Cl(e)};e.querySelectorAll("tbody tr[data-org]").forEach(a=>{a.addEventListener("click",()=>t(a)),a.addEventListener("keydown",n=>{(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),t(a))})})}const Ia=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function $t({section:e,title:t,description:a}){return pt(),`
    <div class="page-shell" data-section="${qe(e)}">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="pf-picker-body">${Ia("hourglass_empty","Loading…")}</div>
      </div>
    </div>`}async function ut(e,t,{emptyMsg:a}={}){const n=document.getElementById("pf-picker-body");if(n)try{const o=await Tl(e);if(!o.length){n.innerHTML=Ia("groups",a||"No client orgs yet. Create one under Clients first.");return}n.innerHTML=Zo(o,t),es(n)}catch(o){console.warn("[portfolio] picker load failed:",o),n.innerHTML=Ia("error","Could not load your clients. Please refresh.")}}function ts(){const e={};return x.getManagedClients().forEach(t=>{e[t.orgGuid]=t.name}),x.getMemberships().forEach(t=>{t.orgGuid&&!e[t.orgGuid]&&(e[t.orgGuid]=t.name||"")}),e}const as=e=>e?`<span class="pf-client-chip">${qe(e)}</span>`:"",he=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,fe=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),Y=e=>Number(e||0).toLocaleString(),ns=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",$l=e=>(ns(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function Il(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric"})}catch{return""}}function Ll(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}let Pn=!1;function Rl(){if(Pn)return;const e=document.createElement("style");e.id="m5t-dash-recent-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Pn=!0}function Nl(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${fe($l(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${fe(ns(e))}</span>
      <span class="recent-lead__sub">${fe(e.email||e.phone||"")}</span>
    </span>
    <span class="recent-lead__badge" data-s="${fe(e.status)}">${fe(e.status)}</span>
    <span class="recent-lead__time">${fe(Il(e))}</span>
  </a>`}const wt=({icon:e,label:t,valueId:a,value:n="—",subId:o,sub:s="",href:r})=>{const i=r?"a":"div",l=r?` href="${fe(r)}" class="stat-card stat-card--link"`:' class="stat-card"';return`
  <${i}${l}>
  ...
  </${i}>`},Ot=(e,t,a,{wide:n=!1,full:o=!1,controls:s=!1}={})=>`
  <div class="dashboard-card${n?" chart-card-wide":""}${o?" chart-card-full":""}">
    ...
    <div class="card-body" id="${a}">${he("hourglass_empty","Loading…")}</div>
  </div>`;let La=30;function os(){Rl(),pt();const e=re();return`
    <div class="page-shell" data-section="home">
      ...
      <div class="dashboard-card" style="margin-bottom:24px">
        ...
        <div class="card-body" id="dash-portfolio">${he("hourglass_empty","Loading…")}</div>
      </div>`:""}

      <div class="stats-grid">
        ${wt({icon:"widgets",label:"Active Magnets",valueId:"stat-active-magnets",subId:"stat-active-magnets-sub",sub:"Loading…",href:"#/magnets"})}
        ${wt({icon:"ads_click",label:"Magnet Opens",valueId:"stat-opens",subId:"stat-opens-sub",sub:"Loading…"})}
        ${wt({icon:"person_add",label:"Leads Captured",valueId:"stat-leads",subId:"stat-leads-sub",sub:"Loading…"})}
        ${wt({icon:"check_circle",label:"Completion Rate",valueId:"stat-completion",subId:"stat-completion-sub",sub:"Loading…"})}
      </div>

      <div class="charts-section">
        ${Ot("show_chart","Opens & Leads","dash-trend",{wide:!0,controls:!0})}
        <div class="charts-grid">
          ${Ot("filter_alt","Completion Funnel","dash-funnel")}
          ${Ot("source","Top Campaigns","dash-campaigns")}
          ${Ot("touch_app","CTA Usage","dash-routes",{full:!0})}
        </div>
      </div>
      ...
      <div class="content-grid">
        ...
        <div class="dashboard-card">
          ...
          <div class="card-body" id="recent-leads-body">
            ${he("hourglass_empty","Loading leads…")}
          </div>
        </div>
      </div>
    </div>`}async function ss(){const e=x.getConfig?.().BASE_URL||"";document.getElementById("dash-periods")?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(La=Number(a.dataset.days)||30,document.querySelectorAll("#dash-periods .chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===La)),Dn(e))}),await Promise.all([Dn(e),Pl(e)])}const ke=(e,t)=>{const a=document.getElementById(e);a&&(a.textContent=t)},tt=(e,t)=>{const a=document.getElementById(e);a&&(a.innerHTML=t)},Fn=e=>e.toISOString().slice(0,10);async function Dn(e){const t=new Date,a=Fn(new Date(t.getTime()-(La-1)*864e5)),n=Fn(t),o=re();let s;try{const E=await fetch(`${e}/m5t/v5/dashboard/stats?from=${a}&to=${n}${o?"&group_by=owner":""}`);if(!E.ok)throw new Error(`HTTP ${E.status}`);if(s=await E.json(),!s.ok)throw new Error("stats not ok")}catch(y){console.warn("[dashboard] stats fetch failed:",y),["stat-active-magnets","stat-opens","stat-leads","stat-completion"].forEach(E=>ke(E,"—")),["stat-active-magnets-sub","stat-opens-sub","stat-leads-sub","stat-completion-sub"].forEach(E=>ke(E,"Unavailable")),["dash-trend","dash-funnel","dash-campaigns","dash-routes","dash-interactions","dash-portfolio"].forEach(E=>tt(E,he("error","Could not load. Please refresh.")));return}o&&Ol(s.by_owner||[]),ke("stat-active-magnets",Y(s.magnets.active)),ke("stat-active-magnets-sub",s.magnets.total>s.magnets.active?`${Y(s.magnets.total-s.magnets.active)} paused`:s.magnets.active?"All running":"No magnets yet");const r=s.funnel||{};ke("stat-opens",r.opens?Y(r.opens):"—"),ke("stat-opens-sub",r.opens?r.engagement_rate!=null?`${r.engagement_rate}% engage`:`${Y(r.engaged)} engaged`:"No opens in this range yet");const i=s.leads||{};ke("stat-leads",Y(i.total));const l=(i.this_week||0)-(i.prev_week||0);ke("stat-leads-sub",i.total?`${Y(i.this_week)} this week (${l>=0?"+":""}${Y(l)} vs last)`:"No leads yet"),ke("stat-completion",r.completion_rate!=null?`${r.completion_rate}%`:"—"),ke("stat-completion-sub",r.opens?`${Y(r.completions)} completed of ${Y(r.opens)} opens`:"Appears once magnets get opened");const c=s.by_day||[],m=c.some(y=>y.opens||y.leads);tt("dash-trend",m?rs(c):he("show_chart","No activity in this range yet. Opens and leads chart here as visitors engage your magnets.")),m&&is(c),tt("dash-funnel",r.opens?Ml(r):he("filter_alt","The funnel fills in once your magnets record opens."));const h=s.top_campaigns||[];tt("dash-campaigns",h.length?`<div class="dash-list">${h.map(y=>`
        <div class="dash-list__row">
          ...
          <span class="dash-list__main" title="${fe(y.campaign)}">${fe(y.campaign)}</span>
          <span class="dash-list__num">${Y(y.leads)}</span>
        </div>`).join("")}</div>`:he("source","No tagged campaigns yet. Leads arriving with ?utm_campaign=… rank here."));const b={book:["event","Book"],chat:["chat","Chat"],call:["phone_in_talk","Call"],email:["mail","Email"],support:["support_agent","Support"]},p=Object.entries(r.routes||{}).sort((y,E)=>E[1]-y[1]),f=p.length?p[0][1]:0;tt("dash-routes",p.length?`<div class="dash-funnel">${p.map(([y,E])=>{const[I,N]=b[y]||["touch_app",y];return`<div class="dash-funnel__row">
          <div class="dash-funnel__meta"><span class="dash-funnel__label"><span class="material-symbols-outlined" aria-hidden="true" style="font-size:15px;vertical-align:-3px">${I}</span> ${fe(N)}</span><span class="dash-funnel__val">${Y(E)}</span></div>
          <div class="dash-funnel__track"><div class="dash-funnel__bar" style="width:${f?Math.max(4,Math.round(E/f*100)):0}%"></div></div>
        </div>`}).join("")}</div>`:he("touch_app","CTA taps (Book, Chat, Call, Support) rank here once visitors use the action bar."));const d={open:["visibility","Magnet opened"],engage:["touch_app","Visitor engaged"],route:["alt_route","Picked a channel"],complete:["check_circle","Completed: lead captured"]},v=s.recent_events||[];tt("dash-interactions",v.length?`<div class="dash-list">${v.map(y=>{const[E,I]=d[y.event]||["sensors",y.event],N=y.event==="route"&&y.detail?` · ${fe(y.detail)}`:"";return`<div class="dash-list__row">
          <span class="dash-list__ico"><span class="material-symbols-outlined" aria-hidden="true">${E}</span></span>
          <span class="dash-list__main">${I}${N}</span>
          ${y.display_mode?`<span class="dash-list__mode">${fe(y.display_mode)}</span>`:""}
          <span class="dash-list__time">${fe(Ll(y.at))}</span>
        </div>`}).join("")}</div>`:he("sensors","No interactions yet. They'll stream in as visitors engage your magnets."))}function Ol(e){const t=document.getElementById("dash-portfolio");if(!t)return;if(!e.length){t.innerHTML=he("groups","No client orgs yet. Create one under Clients to see its numbers here.");return}const a=e.some(s=>s.ad),n=s=>{const r=(s.leads.this_week||0)-(s.leads.prev_week||0);return!s.leads.this_week&&!s.leads.prev_week?"":` <span class="${r>=0?"dc-delta-up":"dc-delta-down"}">(${r>=0?"+":""}${Y(r)})</span>`},o=[{h:"Magnets",td:s=>`${Y(s.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${Y(s.magnets.total)}</span>`},{h:"Leads · wk",td:s=>`${Y(s.leads.this_week)}${n(s)}`},{h:"Leads · total",td:s=>Y(s.leads.total)},{h:"Opens",td:s=>Y(s.opens)},{h:"Compl.",td:s=>s.completion_rate!=null?`${s.completion_rate}%`:"—"},...e.some(s=>s.booked)?[{h:"Booked",td:s=>s.booked?Y(s.booked):"—"}]:[],...e.some(s=>s.called)?[{h:"Called",td:s=>s.called?Y(s.called):"—"}]:[],...a?[{h:"Spend",td:s=>s.ad?`$${Y(s.ad.spend)}`:"—"},{h:"CPL",td:s=>s.ad?.cost_per_lead!=null?`$${Y(s.ad.cost_per_lead)}`:"—"}]:[]];t.innerHTML=Zo(e,o),es(t)}function Ml(e){const t=[["Opened",e.opens,""],["Engaged",e.engaged," dash-funnel__bar--mid"],["Completed",e.completions," dash-funnel__bar--end"],...e.booked?[["Booked",e.booked," dash-funnel__bar--end"]]:[],...e.called?[["Called",e.called," dash-funnel__bar--end"]]:[]],a=Math.max(1,e.opens||0),n=o=>Math.min(100,Math.round((o||0)/a*100));return`<div class="dash-funnel">${t.map(([o,s,r])=>`
    <div class="dash-funnel__row">
      <div class="dash-funnel__meta">
        <span class="dash-funnel__label">${o}</span>
        <span class="dash-funnel__val">${Y(s)} <span class="dash-funnel__pct">${n(s)}%</span></span>
      </div>
      <div class="dash-funnel__track"><div class="dash-funnel__bar${r}" style="width:${Math.max(2,n(s))}%"></div></div>
    </div>`).join("")}</div>`}async function Pl(e){const t=document.getElementById("recent-leads-body");if(t)try{const a=await fetch(`${e}/m5t/v5/m5mLead`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json(),o=(Array.isArray(n?.data)?n.data:[]).filter(s=>!["DELETED","ARCHIVED"].includes(s.status));t.innerHTML=o.length?o.slice(0,5).map(Nl).join(""):he("contacts","No leads captured yet. Publish a magnet to start collecting.")}catch(a){console.warn("[dashboard] Leads fetch failed:",a),t.innerHTML=he("error","Could not load recent leads.")}}function Bn(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}const Un=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e));function rs(e){const p=e.length||1,f=Bn(Math.max(1,...e.map($=>$.opens||0))),d=Bn(Math.max(1,...e.map($=>$.leads||0))),v=748/p,y=Math.min(22,v*.55),E=$=>46+v*($+.5),I=$=>266-$/f*248,N=$=>266-$/d*248,H=[0,.5,1].map($=>{const W=266-$*248;return`<line x1="46" y1="${W.toFixed(1)}" x2="794" y2="${W.toFixed(1)}" stroke="#EAF0F7"/><text x="38" y="${(W+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${Un(f*$)}</text><text x="802" y="${(W+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${Un(d*$)}</text>`}).join(""),U=e.map(($,W)=>{const Re=I($.opens||0);return`<rect x="${(E(W)-y/2).toFixed(1)}" y="${Re.toFixed(1)}" width="${y.toFixed(1)}" height="${Math.max(0,266-Re).toFixed(1)}" rx="3" fill="#0072BA" opacity="0.85"/>`}).join(""),ie=e.map(($,W)=>`${E(W).toFixed(1)},${N($.leads||0).toFixed(1)}`).join(" "),Z=p>1?`<polyline points="${ie}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",le=e.map(($,W)=>`<circle cx="${E(W).toFixed(1)}" cy="${N($.leads||0).toFixed(1)}" r="3.2" fill="#009473"/>`).join(""),De=Math.max(1,Math.ceil(p/6)),Le=e.map(($,W)=>W%De===0||W===p-1?`<text x="${E(W).toFixed(1)}" y="288" text-anchor="middle" class="dash-ax">${$.date.slice(5)}</text>`:"").join(""),M=e.map(($,W)=>`<rect class="dash-hit" data-i="${W}" x="${(46+v*W).toFixed(1)}" y="18" width="${v.toFixed(1)}" height="${248 .toFixed(1)}" fill="transparent"/>`).join("");return`
    ...
    </div>`}function is(e){const t=document.querySelector("#dash-trend .dash-chart-wrap"),a=document.querySelector("#dash-trend .dash-chart-tip");if(!t||!a)return;const n=s=>{try{return new Date(`${s}T00:00:00`).toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}catch{return s}},o=(s,r)=>{const i=e[s];if(!i)return;a.innerHTML=`
      <div class="dash-chart-tip__date">${n(i.date)}</div>
      <div class="dash-chart-tip__row"><i style="background:#0072BA"></i>${Y(i.opens||0)} opens</div>
      <div class="dash-chart-tip__row"><i style="background:#009473"></i>${Y(i.leads||0)} leads</div>`;const l=r.getBoundingClientRect(),c=t.getBoundingClientRect();a.style.left=`${l.left-c.left+l.width/2}px`,a.style.top=`${l.top-c.top}px`,a.hidden=!1};t.querySelectorAll(".dash-hit").forEach(s=>{const r=Number(s.dataset.i);s.addEventListener("mouseenter",()=>o(r,s)),s.addEventListener("mousemove",()=>o(r,s)),s.addEventListener("mouseleave",()=>{a.hidden=!0}),s.addEventListener("click",()=>o(r,s))})}const Fl={render:os,init:ss},Dl=Object.freeze(Object.defineProperty({__proto__:null,default:Fl,init:ss,render:os,statCard:wt,svgTrendChart:rs,wireTrendTooltip:is},Symbol.toStringTag,{value:"Module"}));function Bl(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/home" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function Ul(){console.log("[SignoutRoute] Initialized");const e=document.getElementById("confirm-signout-btn");e?.addEventListener("click",async()=>{e.disabled=!0,e.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await x.doSignout()})}const ql=Object.freeze(Object.defineProperty({__proto__:null,init:Ul,render:Bl},Symbol.toStringTag,{value:"Module"}));let qn=!1;function Hl(){if(qn)return;const e=document.createElement("style");e.id="m5t-section-page-styles",e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),qn=!0}function ls({title:e="Section",icon:t="widgets",name:a=""}={}){return Hl(),`
    ...
    </section>`}function cs(){}const zl={render:ls,init:cs},Gl=Object.freeze(Object.defineProperty({__proto__:null,default:zl,init:cs,render:ls},Symbol.toStringTag,{value:"Module"})),jl={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},xe=e=>String(e??"").replace(/[&<>"']/g,t=>jl[t]),ve=(e,t="info")=>{try{u.publish(g.UI_TOAST,{message:e,type:t})}catch{}},Ke=()=>x.getConfig?.().BASE_URL||"",Vl=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,Jt=5,me={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},Ra=()=>x.getActiveOrg()?.guid||x.getMemberships()[0]?.orgGuid||null;let Hn=!1;function Wl(){if(Hn)return;const e=document.createElement("style");e.id="m5t-notif-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Hn=!0}const Za=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function ds(){return Wl(),pt(),re()?$t({section:"settings-notifications",title:"Notifications",description:"Pick a client to manage their lead alerts."}):`
    <div class="page-shell" data-section="settings-notifications">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="ntf-body">${Za("hourglass_empty","Loading…")}</div>
      </div>
    ...
    </div>`}async function ps(){if(re()){const e=t=>Number(t||0).toLocaleString();return ut(Ke(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Promise.all([Yl(),us()])}async function us(){const e=Ra();if(e)try{const t=await fetch(`${Ke()}/m5t/v5/acctGroup/${encodeURIComponent(e)}/webhook`);if(t.status===403){me.webhookAllowed=!1;return}const a=await t.json().catch(()=>({}));if(!a.ok)return;me.webhook=a.webhook,ms()}catch{}}function zn(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function ms(){const e=document.getElementById("ntf-wh-card"),t=document.getElementById("ntf-wh-body");if(!e||!t)return;e.style.display="";const a=me.webhook,n=a?.last_delivery;t.innerHTML=`
    <div class="ntf-wh">
      ...
      <div class="ntf-wh__row">
        ...
        <span class="ntf-wh__status">${n?n.ok?`Last delivery: <span class="ok">delivered</span> ${xe(zn(n.tz))}`:`Last delivery: <span class="bad">failed</span> ${xe(zn(n.tz))} (${xe(n.error||"")})`:""}</span>
      </div>
    </div>`,t.querySelector("#ntf-wh-save")?.addEventListener("click",async()=>{const o=t.querySelector("#ntf-wh-url")?.value.trim()||"",s=t.querySelector("#ntf-wh-secret")?.value??"",r={uri:o};s.trim()!==""&&(r.secret=s.trim());try{const i=await fetch(`${Ke()}/m5t/v5/acctGroup/${encodeURIComponent(Ra())}/webhook`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),l=await i.json().catch(()=>({}));if(!i.ok||!l.ok)throw new Error(l.error||`Failed (HTTP ${i.status})`);me.webhook=l.webhook,ve(o?"Webhook saved":"Webhook removed","success"),ms()}catch(i){ve(i.message||"Could not save","danger")}}),t.querySelector("#ntf-wh-test")?.addEventListener("click",async o=>{const s=o.currentTarget;s.disabled=!0;try{const r=await fetch(`${Ke()}/m5t/v5/acctGroup/${encodeURIComponent(Ra())}/webhook-test`,{method:"POST"}),i=await r.json().catch(()=>({}));r.ok&&i.ok?ve("Test delivery sent","success"):ve(i.error||"Could not deliver the test","danger")}catch{ve("Could not deliver the test","danger")}finally{s.disabled=!1}try{await us()}catch(r){console.warn("[notifications] loadWebhook refresh failed:",r)}})}async function Yl(){const e=document.getElementById("ntf-body");if(e){try{const a=await(await fetch(`${Ke()}/m5t/v5/magnets`)).json().catch(()=>({}));if(!a.ok)throw new Error(a.message||"Failed to load");me.magnets=(a.magnets||[]).filter(n=>n.status!=="ARCHIVED"),me.canManage=!!a.canManage}catch(t){console.warn("[notifications] load failed:",t),e.innerHTML=Za("error","Could not load your magnets. Please try again.");return}gs()}}function Jl(e){const t=Array.isArray(e.notify_emails)?e.notify_emails:[],a=t.length>0;return`
    <div class="ntf-row" data-guid="${xe(e.guid)}">
      ...
      <div class="ntf-config">
        ${t.length?`<div class="ntf-chips">${t.map(n=>`
              <span class="ntf-chip">${xe(n)}${me.canManage?`<button type="button" data-remove="${xe(n)}" aria-label="Remove ${xe(n)}">&times;</button>`:""}</span>`).join("")}</div>`:'<div class="ntf-none">No alert emails.</div>'}
        ${me.canManage?`
    ...
    </div>`}function gs(){const e=document.getElementById("ntf-body");if(e){if(!me.magnets.length){e.innerHTML=Za("widgets","No magnets yet. Create one under Your Magnets first.");return}e.innerHTML=me.magnets.map(Jl).join(""),e.querySelectorAll(".ntf-row").forEach(t=>{const a=t.dataset.guid,n=t.querySelector(".ntf-input"),o=()=>{const s=(n?.value||"").trim().toLowerCase();if(!s)return;if(!Vl.test(s)){ve("That does not look like an email address","danger");return}const i=[...me.magnets.find(l=>l.guid===a).notify_emails||[]];if(i.includes(s)){ve("Already added","info");return}if(i.length>=Jt){ve(`Up to ${Jt} emails per magnet`,"info");return}Gn(a,[...i,s])};t.querySelector("[data-add]")?.addEventListener("click",o),n?.addEventListener("keydown",s=>{s.key==="Enter"&&o()}),t.querySelectorAll("[data-remove]").forEach(s=>s.addEventListener("click",()=>{const r=me.magnets.find(i=>i.guid===a);Gn(a,(r.notify_emails||[]).filter(i=>i!==s.dataset.remove))})),t.querySelector("[data-test]")?.addEventListener("click",()=>Kl(a,t.querySelector("[data-test]")))})}}async function Gn(e,t){try{const a=await fetch(`${Ke()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({notify_emails:t})}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||n.message||`Failed (HTTP ${a.status})`);const o=me.magnets.find(s=>s.guid===e);o&&(o.notify_emails=t),ve("Alert emails updated","success")}catch(a){console.warn("[notifications] save failed:",a),ve(a.message||"Could not save","danger");return}try{gs()}catch(a){console.error("[notifications] renderBody after save failed:",a)}}async function Kl(e,t){t&&(t.disabled=!0);try{const a=await fetch(`${Ke()}/m5t/v5/magnets/${encodeURIComponent(e)}/notify-test`,{method:"POST"}),n=await a.json().catch(()=>({}));a.ok&&n.ok?ve("Test alert sent","success"):ve(n.error||"Could not send the test","danger")}catch{ve("Could not send the test","danger")}finally{t&&(t.disabled=!1)}}const Ql={render:ds,init:ps},Xl=Object.freeze(Object.defineProperty({__proto__:null,default:Ql,init:ps,render:ds},Symbol.toStringTag,{value:"Module"})),Zl={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},oe=e=>String(e??"").replace(/[&<>"']/g,t=>Zl[t]),we=(e,t="info")=>{try{u.publish(g.UI_TOAST,{message:e,type:t})}catch{}},Ae=()=>x.getConfig?.().BASE_URL||"",J={providers:null,configured:null,denied:!1,busy:!1,autoOpenPicker:!1},en=()=>x.getActiveOrg()?.guid||x.getMemberships()[0]?.orgGuid||null;let jn=!1;function ec(){if(jn)return;const e=document.createElement("style");e.id="m5t-intg-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),jn=!0}const Na=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,rt=(e,t="")=>`<div class="intg-alert ${t}"><span class="material-symbols-outlined" aria-hidden="true">${t==="error"?"error":"info"}</span><span>${e}</span></div>`,tc={google_ads:{what:"See ad spend lined up next to the leads it generated, so you know which campaigns are actually working.",steps:["Click Connect and sign in with a Google account that has access to your Ads accounts.","Choose which ad accounts should feed reporting.","Metrics refresh automatically once a day — or click Sync now for an immediate pull."]},calendly:{what:"Let visitors book directly from a magnet conversation, and get notified the moment they do.",steps:["Click Connect and authorize your Calendly account.","Turn on Calendly booking for any magnet’s Book action, under Magnets.","Confirmed and canceled bookings sync back to the lead automatically. Webhooks need a paid Calendly plan — a free plan still lets visitors book, just without the automatic lead sync."]},callrail:{what:"Every tracked phone call becomes a lead automatically, complete with recording and source.",steps:["In CallRail, go to Integrations, then Data access, then API keys, and create a key. Read-only works for calls; Allow Writes lets us set up call sync automatically.","Paste the key here and pick the account and company this workspace tracks.","Calls start landing in your Leads inbox within minutes."]},google_analytics:{what:"See how visitors reach your site and behave once they get there — sessions, pageviews, and engagement — right alongside the leads your magnets capture.",steps:["Click Connect and sign in with a Google account that has access to your GA4 property.","Choose which GA4 properties should feed reporting.","Metrics refresh automatically once a day — or click Sync now for an immediate pull."]}},tn=e=>{const t=tc[e];return t?`
      ...
      <div class="card-body">
        <div class="intg-head">
          ...
          <div class="intg-title-wrap">
            <div class="intg-name-row"><span class="intg-name">${oe(a)}</span>${o}</div>
            <div class="intg-sub">${oe(n)}</div>
          </div>
    ...
    </div>`}function ac(){return ec(),pt(),re()?$t({section:"settings-integrations",title:"Integrations",description:"Pick a client to manage their connections."}):`
    <div class="page-shell" data-section="settings-integrations">
      ...
      <div id="intg-body">
        <div class="dashboard-card intg-card"><div class="card-body">${Na("hourglass_empty","Loading…")}</div></div>
      </div>
    </div>`}async function nc(){if(re()){const e=t=>Number(t||0).toLocaleString();return ut(Ae(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}oc(),await mt()}const wa=Object.fromEntries(Object.values(Se).filter(e=>e.connect).map(e=>[e.slug,e.label]));function oc(){try{const e=new URLSearchParams(window.location.search),t=e.get("connected"),a=e.get("error")?e.get("provider")||"google_ads":null;if(t&&wa[t])we(`${wa[t]} connected.`,"success"),Se[t]?.picker&&(J.autoOpenPicker=t);else if(a)we(`${wa[a]||a} connection failed (${e.get("error")}).`,"error");else return;window.history.replaceState(null,"",window.location.pathname+window.location.hash)}catch{}}async function mt(){const e=document.getElementById("intg-body");try{const t=await fetch(`${Ae()}/m5t/v5/integrations`);if(t.status===403){J.denied=!0,e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Na("lock","Integrations are managed by workspace admins.")}</div></div>`);return}const a=await t.json();if(!a.ok)throw new Error(a.error||"load failed");J.providers=a.data.providers,J.configured=a.data.configured,ic()}catch{e&&(e.innerHTML=`<div class="dashboard-card intg-card"><div class="card-body">${Na("error","Could not load integrations.")}</div></div>`)}}function Vn(e){const t=e.card,a=en(),n=J.providers?.[e.slug]||[],o=n.find(c=>c.owner_guid===a)||n[0]||null,s=!!J.configured?.[e.slug];let r='<span class="intg-state">Not connected</span>',i=t.idleDesc,l="";if(!s)r='<span class="intg-state">Not available yet</span>',i=`${e.label} reporting is being set up for this platform.`;else if(!o)l=`<button type="button" class="intg-btn primary" id="${t.ids.connect}"><span class="material-symbols-outlined" aria-hidden="true">link</span>Connect</button>`;else{const c=t.reachableCount(o.external_account);o.connect_status==="ACTIVE"?(r='<span class="intg-state on"><span class="material-symbols-outlined" aria-hidden="true">check</span>Connected</span>',i=c?t.reachDesc(c):t.noneDesc,l=`
        ...
        <button type="button" class="intg-btn danger" id="${t.ids.disconnect}"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`):(r=`<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>${oe(o.connect_status==="NEEDS_REAUTH"?"Reconnect needed":"Connection error")}</span>`,i="The connection stopped working. Reconnect to resume daily metric refreshes.",l=`
        ...
        <button type="button" class="intg-btn danger" id="${t.ids.disconnect}"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`)}return an({tint:t.tint,icon:t.icon,name:e.label,sub:t.sub,pill:r,actions:l,desc:i,walkthrough:tn(e.slug),bodyExtra:`<div id="${t.ids.panel}" style="display:none"></div>`})}function sc(){const e=en(),t=J.providers?.calendly||[],a=t.find(l=>l.owner_guid===e)||t[0]||null,n=!!J.configured?.calendly;let o='<span class="intg-state">Not connected</span>',s="Connect Calendly and your magnets book real meetings: the Book button opens your calendar in the conversation, and confirmed bookings land on the lead automatically.",r="",i="";if(!n)o='<span class="intg-state">Not available yet</span>',s="Calendly booking is being set up for this platform.";else if(!a)r='<button type="button" class="intg-btn primary" id="intg-c-connect"><span class="material-symbols-outlined" aria-hidden="true">link</span>Connect</button>';else{const l=a.external_account||{};if(a.connect_status==="ACTIVE"){o='<span class="intg-state on"><span class="material-symbols-outlined" aria-hidden="true">check</span>Connected</span>',s=`Connected as <b>${[l.name,l.email&&`(${l.email})`].filter(Boolean).map(oe).join(" ")||"your Calendly account"}</b>. Turn on Calendly booking per magnet under Magnets, in the Book call-to-action.`,r=`
        <button type="button" class="intg-btn danger" id="intg-c-disconnect"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`;const h=a.webhook||{};if(h.state==="active"){const b=h.last_received_tz?` Last booking received ${oe(String(h.last_received_tz).slice(0,10))}.`:"";i=rt(`Booking sync is on. Confirmed and canceled meetings update the lead automatically.${b}`)}else i=rt("Booking sync is off: webhooks need a paid Calendly plan. Visitors can still book in the magnet; bookings just will not appear on the lead automatically. Reconnect after upgrading to turn it on.","error")}else o=`<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>${oe(a.connect_status==="NEEDS_REAUTH"?"Reconnect needed":"Connection error")}</span>`,s="The connection stopped working. Reconnect to resume booking sync.",r=`
        ...
        <button type="button" class="intg-btn danger" id="intg-c-disconnect"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`}return an({tint:"accent",icon:"event",name:"Calendly",sub:"Bookings on your magnets.",pill:o,actions:r,desc:s,extra:i,walkthrough:tn("calendly")})}function rc(){const e=en(),t=J.providers?.callrail||[],a=t.find(i=>i.owner_guid===e)||t[0]||null;let n='<span class="intg-state">Not connected</span>',o="Paste a CallRail API key and tracked phone calls land in your Leads inbox, with the caller, source, and recording on the lead.",s="",r="";if(!a)s='<button type="button" class="intg-btn primary" id="intg-r-connect"><span class="material-symbols-outlined" aria-hidden="true">link</span>Connect</button>';else{const i=a.external_account||{};if(a.connect_status==="ACTIVE"){n='<span class="intg-state on"><span class="material-symbols-outlined" aria-hidden="true">check</span>Connected</span>',o=`Connected to <b>${[i.account_name,i.company_name].filter(Boolean).map(oe).join(" · ")||"your CallRail account"}</b>. Tracked calls arrive as leads with source and recording attached.`,s=`
        ...
        <button type="button" class="intg-btn danger" id="intg-r-disconnect"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`;const m=a.webhook||{};if(m.state==="active"){const h=m.last_received_tz?` Last call received ${oe(String(m.last_received_tz).slice(0,10))}.`:"";r=rt(`Call sync is on. New calls appear within minutes; a daily sweep catches anything missed.${h}`)}else r=rt("Automatic call sync could not be set up in CallRail. Calls still arrive via the daily sweep and Sync now. Reconnect to retry the setup.","error")}else n='<span class="intg-state warn"><span class="material-symbols-outlined" aria-hidden="true">priority_high</span>Connection error</span>',o="The connection stopped working. Reconnect with a current CallRail API key.",s=`
        ...
        <button type="button" class="intg-btn danger" id="intg-r-disconnect"><span class="material-symbols-outlined" aria-hidden="true">link_off</span>Disconnect</button>`}return an({tint:"info",icon:"call",name:"CallRail",sub:"Calls in your leads inbox.",pill:n,actions:s,desc:o,extra:r,walkthrough:tn("callrail"),bodyExtra:'<div id="intg-r-setup" style="display:none"></div>'})}function Wn(e){const t=e.card.ids;document.getElementById(t.connect)?.addEventListener("click",()=>fs(e)),document.getElementById(t.sync)?.addEventListener("click",()=>dc(e)),document.getElementById(t.disconnect)?.addEventListener("click",()=>Oa(e)),document.getElementById(t.choose)?.addEventListener("click",()=>hs(e))}function ic(){const e=document.getElementById("intg-body");if(!e)return;e.innerHTML=Vn(Se.google_ads)+sc()+rc()+Vn(Se.google_analytics),Wn(Se.google_ads),document.getElementById("intg-c-connect")?.addEventListener("click",()=>fs(Se.calendly)),document.getElementById("intg-c-disconnect")?.addEventListener("click",()=>Oa(Se.calendly)),document.getElementById("intg-r-connect")?.addEventListener("click",pc),document.getElementById("intg-r-sync")?.addEventListener("click",gc),document.getElementById("intg-r-disconnect")?.addEventListener("click",()=>Oa(Se.callrail)),Wn(Se.google_analytics);const t=J.autoOpenPicker?Se[J.autoOpenPicker]:null;t?.picker&&document.getElementById(t.card.ids.choose)&&hs(t),J.autoOpenPicker=!1}async function hs(e){const t=e.picker,a=document.getElementById(e.card.ids.panel);if(a){a.style.display="",a.innerHTML=rt(t.loading);try{const o=await(await fetch(`${Ae()}/m5t/v5/integrations/${e.slug}/${t.path}`)).json();if(!o.ok)throw new Error(o.error||"load failed");lc(e,o.data[t.itemsField]||[],new Set(o.data.linked||[]))}catch{a.innerHTML=rt(t.loadError,"error")}}}function lc(e,t,a){const n=e.picker,o=document.getElementById(e.card.ids.panel);if(!o)return;const s=t.map(r=>{const i=n.rowDisabled(r),l=n.rowBadge(r),c=a.has(r.id)&&!i;return`
      <label class="intg-acct${i?" disabled":""}">
        <input type="checkbox" data-${n.dataAttr}="${oe(r.id)}" ${c?"checked":""} ${i?"disabled":""}>
        <span style="min-width:0">
          <span class="intg-acct__name">${oe(r.name||n.namePrefix+r.id)}</span>
          <div class="intg-acct__id">${oe(r.id)}</div>
        </span>
        ${l?`<span class="intg-acct__badge">${oe(l)}</span>`:"<span></span>"}
    ...
    </div>`,document.getElementById(n.ids.cancel)?.addEventListener("click",()=>{o.style.display="none"}),document.getElementById(n.ids.save)?.addEventListener("click",()=>cc(e))}async function cc(e){const t=e.picker,a=document.getElementById(e.card.ids.panel),n=[...a?.querySelectorAll(`input[data-${t.dataAttr}]:checked`)||[]].map(s=>s.dataset[t.datasetKey]),o=document.getElementById(t.ids.save);o&&(o.disabled=!0);try{const r=await(await fetch(`${Ae()}/m5t/v5/integrations/${e.slug}/${t.path}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({[t.saveField]:n})})).json();if(!r.ok)throw new Error(r.error||"save failed");we(t.savedToast(r.data.linked),"success"),a&&(a.style.display="none"),mt()}catch{we(t.saveError,"error"),o&&(o.disabled=!1)}}async function fs(e){if(!J.busy){J.busy=!0;try{const a=await(await fetch(`${Ae()}/m5t/v5/integrations/${e.slug}/connect`)).json();if(!a.ok||!a.data?.url)throw new Error(a.error||"connect failed");window.location.href=a.data.url}catch(t){we(t.message||e.connect.fallbackError,"error"),J.busy=!1}}}async function dc(e){if(J.busy)return;J.busy=!0;const t=document.getElementById(e.card.ids.sync);t&&(t.disabled=!0);try{const n=await(await fetch(`${Ae()}/m5t/v5/integrations/${e.slug}/sync`,{method:"POST"})).json();if(!n.ok)throw new Error(n.error||"sync failed");const s=(n.data?.connections?.[0]?.[e.sync.itemsField]||[]).filter(r=>r.error).length;we(s?e.sync.failedToast(s):"Metrics synced.",s?"warning":"success")}catch{we("Sync failed.","error")}finally{J.busy=!1,t&&(t.disabled=!1),mt()}}async function Oa(e){if(!J.busy&&window.confirm(e.disconnect.confirm)){J.busy=!0;try{const a=await(await fetch(`${Ae()}/m5t/v5/integrations/${e.slug}`,{method:"DELETE"})).json().catch(()=>({}));if(!a.ok)throw new Error(a.error||"disconnect failed");we(e.disconnect.toast,"success")}catch{we("Disconnect failed.","error")}finally{J.busy=!1,mt()}}}function pc(){const e=document.getElementById("intg-r-setup");e&&(e.style.display="",e.innerHTML=`
    <div class="intg-picker">
    ...
    </div>`,document.getElementById("intg-r-cancel")?.addEventListener("click",()=>{e.style.display="none"}),document.getElementById("intg-r-continue")?.addEventListener("click",uc),document.getElementById("intg-r-key")?.focus())}const Ue=e=>{const t=document.getElementById("intg-r-status");t&&(t.textContent=e)};async function uc(){const e=document.getElementById("intg-r-continue"),t=document.getElementById("intg-r-key")?.value.trim()||"",a=document.getElementById("intg-r-pickers");if(!t){Ue("Paste an API key first.");return}if(a&&!a.hidden)return mc(t);e&&(e.disabled=!0),Ue("Checking the key with CallRail…");try{const o=await(await fetch(`${Ae()}/m5t/v5/integrations/callrail/validate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:t})})).json();if(!o.ok){Ue(o.error||"CallRail rejected that key.");return}const s=o.data.accounts||[],r=document.getElementById("intg-r-account");r&&(r.innerHTML=s.map(i=>`<option value="${oe(i.id)}">${oe(i.name)}</option>`).join(""),r.onchange=()=>Yn(t,r.value)),a&&(a.hidden=!1),e&&(e.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">save</span>Save'),Ue(""),await Yn(t,s[0]?.id)}catch{Ue("Could not reach CallRail. Try again.")}finally{e&&(e.disabled=!1)}}async function Yn(e,t){const a=document.getElementById("intg-r-company");if(!(!a||!t)){a.innerHTML='<option value="">Loading companies…</option>';try{const o=await(await fetch(`${Ae()}/m5t/v5/integrations/callrail/companies`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:t})})).json(),s=o.ok?o.data.companies||[]:[];a.innerHTML=s.length?s.map(r=>`<option value="${oe(r.id)}">${oe(r.name)}</option>`).join(""):'<option value="">No active companies in this account</option>'}catch{a.innerHTML='<option value="">Could not load companies</option>'}}}async function mc(e){const t=document.getElementById("intg-r-continue"),a=document.getElementById("intg-r-account")?.value||"",n=document.getElementById("intg-r-company")?.value||"";if(!n){Ue("Pick the company this workspace tracks.");return}t&&(t.disabled=!0),Ue("Connecting…");try{const s=await(await fetch(`${Ae()}/m5t/v5/integrations/callrail`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:a,company_id:n})})).json();if(!s.ok)throw new Error(s.error||"connect failed");we(s.data?.webhook_state==="active"?"CallRail connected. Call sync is on.":"CallRail connected. Call sync setup needs attention; see the card.","success"),mt()}catch{Ue("Could not connect. Check the key and try again."),t&&(t.disabled=!1)}}async function gc(){if(J.busy)return;J.busy=!0;const e=document.getElementById("intg-r-sync");e&&(e.disabled=!0);try{const a=await(await fetch(`${Ae()}/m5t/v5/integrations/callrail/sync?days=7`,{method:"POST"})).json();if(!a.ok)throw new Error(a.error||"sync failed");const n=a.data?.connections?.[0]||{};we(n.error?"Sync finished with errors.":`Sync done. ${n.processed||0} new call${(n.processed||0)===1?"":"s"} recorded.`,n.error?"warning":"success")}catch{we("Sync failed.","error")}finally{J.busy=!1,e&&(e.disabled=!1),mt()}}const hc=Object.freeze(Object.defineProperty({__proto__:null,init:nc,render:ac},Symbol.toStringTag,{value:"Module"})),fc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Mt=e=>String(e??"").replace(/[&<>"']/g,t=>fc[t]),Kt=(e,t="info")=>{try{u.publish(g.UI_TOAST,{message:e,type:t})}catch{}},Qt=()=>x.getConfig?.().BASE_URL||"",it={passkeys:[],loaded:!1};let Jn=!1;function vc(){if(Jn)return;const e=document.createElement("style");e.id="m5t-security-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Jn=!0}const nn=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function vs(){return vc(),`
    <div class="page-shell" data-section="settings-security">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="pk-body">${nn("hourglass_empty","Loading…")}</div>
      </div>
    </div>`}async function bs(){const e=document.getElementById("pk-add-btn");e&&window.PublicKeyCredential&&(e.style.display="",e.addEventListener("click",yc)),await _s()}async function _s(){const e=document.getElementById("pk-body");if(e){try{const t=await fetch(`${Qt()}/m5t/v5/webauthn`),a=await t.json().catch(()=>({}));if(!t.ok||!a.ok)throw new Error(a.error||"Failed to load");it.passkeys=a.passkeys||[],it.loaded=!0}catch(t){console.warn("[settings-security] load failed:",t),e.innerHTML=nn("error","Could not load your passkeys. Please try again.");return}ys()}}function Kn(e){if(!e)return null;try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return null}}function bc(e){const t=Kn(e.last_used_time),a=e.created?.created_tz,n=Kn(a),o=[e.device_type==="multiDevice"?"Syncs across devices":"This device only",t?`Last used ${t}`:"Never used to sign in yet",n?`Added ${n}`:null].filter(Boolean).join(" · ");return`
    <div class="pk-row" data-guid="${Mt(e.guid)}">
      <span class="pk-icon"><span class="material-symbols-outlined" aria-hidden="true">passkey</span></span>
      <div class="pk-info">
        <div class="pk-name">${Mt(e.device_label||"Passkey")}</div>
        <div class="pk-meta">${Mt(o)}</div>
      </div>
      <button class="pk-btn pk-btn--danger" type="button" data-remove="${Mt(e.guid)}">
        <span class="material-symbols-outlined" aria-hidden="true">delete</span> Remove
      </button>
    </div>`}function ys(){const e=document.getElementById("pk-body");if(e){if(!window.PublicKeyCredential){e.innerHTML=`<p class="pk-unsupported">This browser doesn't support passkeys. Your password sign-in still works as usual.</p>`;return}if(!it.passkeys.length){e.innerHTML=nn("passkey","No passkeys yet. Add one for a faster, phishing-resistant sign-in.");return}e.innerHTML=it.passkeys.map(bc).join(""),e.querySelectorAll("[data-remove]").forEach(t=>{t.addEventListener("click",()=>wc(t.dataset.remove,t))})}}function _c(){try{const e=navigator.userAgent||"",t=/iPhone/.test(e)?"iPhone":/iPad/.test(e)?"iPad":/Android/.test(e)?"Android":/Mac OS X/.test(e)?"Mac":/Windows/.test(e)?"Windows":/Linux/.test(e)?"Linux":"device",a=/Edg\//.test(e)?"Edge":/Chrome\//.test(e)?"Chrome":/Firefox\//.test(e)?"Firefox":/Safari\//.test(e)?"Safari":"";return a?`${a} on ${t}`:t}catch{return"Passkey"}}async function yc(){const e=document.getElementById("pk-add-btn");e&&(e.disabled=!0);try{const{startRegistration:t}=await Q(async()=>{const{startRegistration:i}=await Promise.resolve().then(()=>Vo);return{startRegistration:i}},void 0,import.meta.url),a=await fetch(`${Qt()}/m5t/v5/webauthn/register/options`,{method:"POST"}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||"Could not start passkey registration");let o;try{o=await t({optionsJSON:n.options})}catch(i){if(i?.name==="NotAllowedError")return;throw i}const s=await fetch(`${Qt()}/m5t/v5/webauthn/register/verify`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({response:o,deviceLabel:_c()})}),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.error||"Could not register this passkey");Kt("Passkey added","success"),await _s()}catch(t){console.warn("[settings-security] addPasskey failed:",t),Kt(t.message||"Could not add a passkey","danger")}finally{e&&(e.disabled=!1)}}async function wc(e,t){if(confirm("Remove this passkey? You can always add it back later.")){t&&(t.disabled=!0);try{const a=await fetch(`${Qt()}/m5t/v5/webauthn/${encodeURIComponent(e)}`,{method:"DELETE"}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||"Could not remove this passkey");it.passkeys=it.passkeys.filter(o=>o.guid!==e),Kt("Passkey removed","success"),ys()}catch(a){console.warn("[settings-security] removePasskey failed:",a),Kt(a.message||"Could not remove this passkey","danger"),t&&(t.disabled=!1)}}}const xc={render:vs,init:bs},Ec=Object.freeze(Object.defineProperty({__proto__:null,default:xc,init:bs,render:vs},Symbol.toStringTag,{value:"Module"})),Ac={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ae=e=>String(e??"").replace(/[&<>"']/g,t=>Ac[t]),Ma=()=>x.getConfig?.().BASE_URL||"",xa=e=>Number(e||0).toLocaleString(),j={conversations:[],counts:{},magnetNames:{},filter:"ALL",book:!1,magnetOwnerNames:{}},Qn={COMPLETED:{label:"Completed",icon:"check_circle"},IN_PROGRESS:{label:"In progress",icon:"pending"},ABANDONED:{label:"Abandoned",icon:"highlight_off"}},Pa={book:"Book",chat:"Chat",call:"Call",email:"Email",support:"Support"};function ws(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email)||null}function xs(e){return(e.split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase()}function Es(e){try{return new Date(e).toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return""}}function kc(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function As(e){return e==null?"—":e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,"0")}s`}let Xn=!1;function Sc(){if(Xn)return;const e=document.createElement("style");e.id="m5t-convs-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Xn=!0}const ca=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function ks(){return Sc(),pt(),`
    ...
    </div>`}async function Ss(){await Tc()}async function Tc(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${Ma()}/m5t/v5/conversations`),fetch(`${Ma()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(j.conversations=n.conversations||[],j.counts=n.counts||{},j.book=re(),a){const o=await a.json().catch(()=>({}));j.magnetNames={},j.magnetOwnerNames={};const s=j.book?ts():{};(o.magnets||[]).forEach(r=>{j.magnetNames[r.guid]=r.name,j.book&&(j.magnetOwnerNames[r.guid]=r.owner_name||s[r.owner_guid]||"")})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=ca("error","Could not load journeys. Please try again.");return}Ts()}}function Cc(){return j.filter==="ALL"?j.conversations:j.conversations.filter(e=>e.status===j.filter)}function $c(e){const t=ws(e.lead),a=j.magnetNames[e.magnet_guid]||"—",n=Qn[e.status]||Qn.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,s=(e.routes||[]).map(r=>Pa[r]||r).join(", ");return`
    <tr class="convs-row" data-session="${ae(e.session)}">
      <td>
        <span class="convs-who">
          <span class="convs-ava${t?"":" anon"}">${t?ae(xs(t)):'<span class="material-symbols-outlined" style="font-size:16px">person_off</span>'}</span>
      ...
      ${j.book?`<td>${as(j.magnetOwnerNames[e.magnet_guid]||"")||'<span class="convs-muted">—</span>'}</td>`:""}
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${ae(Es(e.started_at))}">${ae(kc(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${ae(As(e.duration_s))}</td>
    </tr>`}function Ts(){const e=document.getElementById("convs-body");if(!e)return;if(!j.conversations.length){e.innerHTML=ca("route","No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.");return}const t=Cc(),a=[["ALL","All"],["COMPLETED","Completed"],["IN_PROGRESS","In progress"],["ABANDONED","Abandoned"]];e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${a.map(([n,o])=>`<button data-filter="${n}" class="${j.filter===n?"active":""}">${o}${n!=="ALL"&&j.counts[n]?` (${xa(j.counts[n])})`:""}</button>`).join("")}
      </div>
      <span class="convs-count">${xa(t.length)} of ${xa(j.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map($c).join("")||`<tr><td colspan="${j.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${j.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(j.filter=o.dataset.filter,Ts())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&Lc(o.dataset.session)})}const Ic={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${Pa[e]||e}`:""}`,route:e=>`Picked ${Pa[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function Lc(e){const t=j.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${Ma()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=ws(t.lead),o=j.magnetNames[t.magnet_guid]||"—",r=(a?.events||[]).filter((c,m,h)=>c.event!=="step"||!(h[m+1]&&h[m+1].event==="step")).map(c=>`
    <div class="convs-tl__item${c.event==="complete"?" done":""}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${ae((Ic[c.event]||(()=>c.event))(c.detail))}</div>
      <div class="convs-tl__time">${ae(Es(c.at))}${c.variant?` · Variant ${ae(c.variant)}`:""}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      ...
      <div class="convs-drawer__body">
        ${n?`<a class="convs-drawer__lead" href="#/leads">
              <span class="convs-ava">${ae(xs(n))}</span>
        ...
        <div class="convs-sub" style="margin-bottom:6px">${ae(o)} · ${ae(As(t.duration_s))}${t.variant?` · Variant ${ae(t.variant)}`:""}</div>
        ${r?`<div class="convs-tl">${r}</div>`:ca("timeline","No timeline available for this journey.")}
      </div>
    </aside>`,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("open"),i.querySelector(".convs-drawer").classList.add("open")});const l=()=>{i.classList.remove("open"),setTimeout(()=>i.remove(),220)};i.querySelector(".convs-drawer__close").addEventListener("click",l),i.addEventListener("click",c=>{c.target===i&&l()})}const Rc={render:ks,init:Ss},Nc=Object.freeze(Object.defineProperty({__proto__:null,default:Rc,init:Ss,render:ks},Symbol.toStringTag,{value:"Module"})),Oc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ye=e=>String(e??"").replace(/[&<>"']/g,t=>Oc[t]),Zn=(e,t="info")=>{try{u.publish(g.UI_TOAST,{message:e,type:t})}catch{}},qt=()=>x.getConfig?.().BASE_URL||"",lt=e=>Number(e||0).toLocaleString(),He={magnets:[],stats:{},canManage:!1},Mc={mag_title:"header title",mag_subtitle:"subtitle",mag_welcome:"welcome message",mag_theme_color:"color",mag_launcher_label:"launcher label"};let eo=!1;function Pc(){if(eo)return;const e=document.createElement("style");e.id="m5t-abt-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),eo=!0}const on=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Cs(){return re()?$t({section:"ab-testing",title:"A/B Testing",description:"Pick a client to view their experiments."}):(Pc(),`
    <div class="page-shell" data-section="ab-testing">
      ...
      <div id="abt-body">${on("hourglass_empty","Loading tests…")}</div>
    </div>`)}async function sn(){if(re())return ut(qt(),[{h:"Running",td:t=>lt(t.ab_tests?.running)},{h:"Completed",td:t=>lt(t.ab_tests?.completed)},{h:"Compl. %",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Experiments appear per client once you have one."});const e=document.getElementById("abt-body");try{const t=new Date,a=new Date(t.getTime()-89*864e5).toISOString().slice(0,10),n=t.toISOString().slice(0,10),[o,s]=await Promise.all([fetch(`${qt()}/m5t/v5/magnets`),fetch(`${qt()}/m5t/v5/magnets/stats?from=${a}&to=${n}`)]),r=await o.json().catch(()=>({}));if(!r.ok)throw new Error(r.message||"Failed to load");He.magnets=r.magnets||[],He.canManage=!!r.canManage;const i=await s.json().catch(()=>({}));He.stats=i?.stats||{}}catch(t){console.warn("[ab-testing] load failed:",t),e&&(e.innerHTML=on("error","Could not load your tests. Please try again."));return}Fc()}function Fc(){const e=document.getElementById("abt-body");if(!e)return;const t=He.magnets.filter(n=>n.ab?.enabled),a=He.magnets.filter(n=>!n.ab?.enabled&&n.ab?.declared);if(!t.length&&!a.length){e.innerHTML=on("science","No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.");return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(qc).join("")}`:"")+(a.length?`<div class="abt-sect">Completed Tests</div>${a.map(Hc).join("")}`:""),e.querySelectorAll("[data-declare]").forEach(n=>n.addEventListener("click",()=>zc(n.dataset.declare,n.dataset.winner)))}function Dc(e){const t=He.stats[e.guid]?.variants||{},a={opens:0,engaged:0,completions:0,rate:null,...t.A||{}},n={opens:0,engaged:0,completions:0,rate:null,...t.B||{}};return{A:a,B:n}}function Bc(e){const t=Object.keys(e?.b||{}).map(a=>Mc[a]||a);return t.length?`Changes: ${t.join(", ")}`:""}function Uc(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function to(e,t,a,n,o,s){return`
    ...
    </div>`}function qc(e){const t=e.ab,{A:a,B:n}=Dc(e),o=(n.rate??-1)>(a.rate??-1)?"B":(a.rate??-1)>(n.rate??-1)?"A":null,s=o&&a.rate!=null&&n.rate!=null?`+${Math.round(Math.abs(n.rate-a.rate)*10)/10}%`:"",r=Gc(a,n),i=t.started_tz?Uc(t.started_tz):null,l=(a.opens||0)+(n.opens||0),c=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
      ...
      <div class="abt-compare">
        ${to("Variant A","Control","The magnet as configured",a,o==="A",o==="A"?s:"")}
        <div class="abt-vs">VS</div>
        ${to("Variant B",o==="B"?"Leading":"Challenger",Bc(t),n,o==="B",o==="B"?s:"")}
      </div>
      <div class="abt-sig">
    ...
    </div>`}async function zc(e,t){const a=He.magnets.find(n=>n.guid===e);if(a&&window.confirm(`Declare Variant ${t} the winner for “${a.name}”?

${t==="B"?"Variant B’s changes become the magnet’s configuration for everyone.":"The magnet keeps its current configuration."} The experiment ends and moves to Completed.`)){try{const o=await(await fetch(`${qt()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Declare failed");Zn(`Variant ${t} declared the winner`,"success")}catch(n){Zn(n.message||"Could not declare a winner","danger");return}try{await sn()}catch(n){console.warn("[ab-testing] refresh after declare failed:",n)}}}function Gc(e,t){const a=e.opens||0,n=t.opens||0,o=e.completions||0,s=t.completions||0;if(a<30||n<30||o+s<5)return null;const r=o/a,i=s/n,l=(o+s)/(a+n),c=Math.sqrt(l*(1-l)*(1/a+1/n));if(!c)return null;const m=Math.abs(i-r)/c;return Math.round(2*(jc(m)-.5)*1e3)/10}function jc(e){const t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}const Vc={render:Cs,init:sn},Wc=Object.freeze(Object.defineProperty({__proto__:null,default:Vc,init:sn,render:Cs},Symbol.toStringTag,{value:"Module"})),Yc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},de=e=>String(e??"").replace(/[&<>"']/g,t=>Yc[t]),$s=()=>x.getConfig?.().BASE_URL||"",Jc={single_select:{icon:"quiz",color:"#0072BA",darkColor:"#38BDF8"},multi_select:{icon:"checklist",color:"#0E6BA8",darkColor:"#22D3EE"},scheduler:{icon:"event",color:"#915E8B",darkColor:"#E879F9"},text:{icon:"short_text",color:"#5B54C6",darkColor:"#A78BFA"},email:{icon:"mail",color:"#0E8F86",darkColor:"#2DD4BF"},phone:{icon:"call",color:"#2E8B57",darkColor:"#4ADE80"},message:{icon:"chat",color:"#B4791F",darkColor:"#FBBF24"}},Xt={};Wa.forEach(e=>{Xt[e.value]={label:e.label,...Jc[e.value]||{icon:"quiz",color:"#0072BA",darkColor:"#38BDF8"}}});const Is=Wa.map(e=>e.value),Ls={chat:"Chat / default",book:"Book (scheduler)",support:"Support (intake)"},rn=e=>{const t=Xt[e]||Xt.single_select;return document.documentElement.getAttribute("data-theme")==="dark"?{...t,color:t.darkColor}:t},Ze=e=>e==="single_select"||e==="multi_select",da=e=>e!=="message",It=e=>e==="scheduler",Zt=e=>e==="email"?"email":e==="phone"?"phone":"",Qe=()=>({meeting_label:"",start:"09:00",end:"17:00",mins:30,days:14}),Kc=[["","No icon"],["event","Calendar"],["schedule","Clock"],["mail","Email"],["sms","Text"],["phone","Phone"],["chat","Chat"],["description","Document"],["help","Question"],["place","Location"],["person","Person"],["bolt","Quick"],["check_circle","Check"],["star","Star"],["home","Home"],["build","Service"]];function Qc(e,t){const a=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||"").trim());return a?`rgba(${parseInt(a[1],16)},${parseInt(a[2],16)},${parseInt(a[3],16)},${t})`:`rgba(0,114,186,${t})`}let ao=!1;function Xc(){if(ao)return;const e=document.createElement("style");e.id="m5t-flow-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ao=!0}let P=[],Te=null,Zc=0,Be=null,Ve=null,We="chat",be={},Ht=[],Rs=null,Fa=null,zt="";const ct=()=>"f"+ ++Zc;function ln(e="single_select"){return{_uid:ct(),id:"",step_type:e,step_prompts:[""],step_options:Ze(e)?[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]:[],step_columns:Zt(e)?[Zt(e)]:[],step_description:"",step_config:It(e)?Qe():null}}function ed(e){return(Array.isArray(e)?e:[]).map(t=>({_uid:ct(),id:t.id!=null?String(t.id):"",step_type:Xt[t.step_type]?t.step_type:"single_select",step_prompts:Array.isArray(t.step_prompts)?t.step_prompts.map(String):[],step_options:(Array.isArray(t.step_options)?t.step_options:[]).map(a=>({label:a&&a.label!=null?String(a.label):"",goto:a&&a.goto!=null?String(a.goto):"",icon:a&&a.icon!=null?String(a.icon):""})),step_columns:Array.isArray(t.step_columns)?t.step_columns.map(String):[],step_description:t.step_description!=null?String(t.step_description):"",step_config:t.step_config&&typeof t.step_config=="object"?{...Qe(),...t.step_config}:t.step_type==="scheduler"?Qe():null}))}function no(){return[{_uid:ct(),id:"",step_type:"text",step_prompts:["Great, and your name?"],step_options:[],step_columns:["first_name"],step_description:"",step_config:null},{_uid:ct(),id:"",step_type:"email",step_prompts:["The best email to reach you?"],step_options:[],step_columns:["email"],step_description:"",step_config:null}]}function td(e,t){if(e==="book")return[{_uid:ct(),id:"",step_type:"scheduler",step_prompts:["When works best for you?"],step_options:[],step_columns:[],step_description:"",step_config:Qe()},...no()];if(e==="support"){const a=(t.actions||[]).find(s=>s&&s.type==="support"),n=a&&a.config&&Array.isArray(a.config.options)?a.config.options:[],o=n.length?n.map(s=>({label:s&&s.label||String(s),goto:"",icon:s&&s.icon||""})):["Sales enquiry","Support","Billing","Something else"].map(s=>({label:s,goto:"",icon:""}));return[{_uid:ct(),id:"",step_type:"multi_select",step_prompts:["How can we help you today?"],step_options:o,step_columns:[],step_description:"Select all that apply",step_config:null},...no()]}return[ln("single_select")]}function Ns(e,t){const a=e==="chat"?t.steps:t.routes&&t.routes[e],n=ed(a);return n.length?n:e==="chat"?[ln("single_select")]:td(e,t)}function ad(e){Ze(e.step_type)?e.step_options.length||(e.step_options=[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]):e.step_options=[],da(e.step_type)?!e.step_columns.length&&Zt(e.step_type)&&(e.step_columns=[Zt(e.step_type)]):e.step_columns=[],e.step_config=It(e.step_type)?e.step_config||Qe():null}function nd(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${de(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${Kc.map(([a,n])=>`<option value="${de(a)}"${a===e.icon?" selected":""}>${de(n)}</option>`).join("")}</select>
  ...
  </div>`}function od(e){const t=Is.map(n=>`<option value="${n}"${n===e.step_type?" selected":""}>${de(rn(n).label)}</option>`).join(""),a=e.step_options.length<=1;return`<div class="flow-node__body">
...
`))}</textarea>
    ...
    <select class="mag-modal__select flow-f-field">
      ...
      ${Va.map(n=>`<option value="${de(n.value)}"${n.value===e.step_columns[0]?" selected":""}>${de(n.label)}</option>`).join("")}
    </select>
    ...
    <div class="flow-opts">${e.step_options.map(n=>nd(n,a)).join("")}</div>
  ...
  </div>`}function sd(e){const t=e.step_prompts.find(o=>String(o).trim()!=="")||"",a=t?`<div class="flow-node__prompt">“${de(t)}”</div>`:`<div class="flow-node__prompt is-empty">${e.step_type==="message"?"No message yet":"No question yet"}</div>`;let n="";if(Ze(e.step_type)){const o=e.step_options.map(s=>String(s.label).trim()).filter(Boolean);if(o.length){const s=o.slice(0,4).map(i=>`<span class="flow-node__chip">${de(i)}</span>`).join(""),r=o.length>4?`<span class="flow-node__chip">+${o.length-4}</span>`:"";n=`<div class="flow-node__chips">${s}${r}</div>`}}else if(da(e.step_type)&&e.step_columns[0]){const o=Va.find(s=>s.value===e.step_columns[0])?.label||e.step_columns[0];n=`<div class="flow-node__meta">Saves to <b>${de(o)}</b></div>`}return`<div class="flow-node__preview">${a}${n}</div>`}function rd(e,t,a){const n=rn(e.step_type),o=e._uid===Te,s=`--nc:${n.color};--nct:${Qc(n.color,.14)}`;return`<div class="flow-node${o?" flow-node--open":""}" data-uid="${e._uid}" style="${s}"${o?"":' draggable="true"'}>
    ...
    ${o?od(e):sd(e)}
  </div>`}const oo='<div class="flow-conn"><span class="flow-conn__line"></span><span class="material-symbols-outlined" aria-hidden="true">expand_more</span></div>';function ye(){const e=document.getElementById("flow-nodes");if(!e)return;const t=P.length,a=['<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>',oo];P.forEach((n,o)=>{a.push(rd(n,o,t)),o<t-1&&a.push(oo)}),e.innerHTML=a.join("")}function Ce(){const e=document.querySelector(".flow-node--open");if(!e)return;const t=P.find(s=>s._uid===e.dataset.uid);if(!t)return;const a=e.querySelector(".flow-f-type");a&&(t.step_type=a.value);const n=e.querySelector(".flow-f-prompts");n&&(t.step_prompts=n.value.split(`
`));const o=e.querySelector(".flow-f-field");if(t.step_columns=o&&o.value.trim()?[o.value.trim()]:[],Ze(t.step_type)){const s=t.step_options,r=[];e.querySelectorAll(".flow-opt").forEach((i,l)=>{r.push({label:i.querySelector(".flow-o-label")?.value??"",icon:i.querySelector(".flow-o-icon")?.value??"",goto:s[l]&&s[l].goto||""})}),t.step_options=r}else t.step_options=[];if(It(t.step_type)){const s=e.querySelector(".flow-f-mtlabel"),r=e.querySelector(".flow-f-start"),i=e.querySelector(".flow-f-end"),l=e.querySelector(".flow-f-mins");t.step_config={...t.step_config||Qe(),...s?{meeting_label:s.value.trim()}:{},...r&&r.value?{start:r.value}:{},...i&&i.value?{end:i.value}:{},...l?{mins:parseInt(l.value,10)||30}:{}}}else t.step_config=null}function Os(){document.querySelectorAll(".flow-node.drop-before, .flow-node.drop-after").forEach(e=>e.classList.remove("drop-before","drop-after"))}function bt(){Os(),document.querySelectorAll(".flow-node.dragging").forEach(e=>e.classList.remove("dragging")),Be=null,Ve=null}function id(e=P){if(!e.length)return"Add at least one step.";for(let t=0;t<e.length;t++){const a=e[t],n=t+1;if(!a.step_prompts.some(o=>String(o).trim()!==""))return`Step ${n}: add what the magnet should say.`;if(Ze(a.step_type)&&!a.step_options.some(o=>String(o.label).trim()!==""))return`Step ${n}: add at least one choice.`;if(da(a.step_type)&&!a.step_columns.length)return`Step ${n}: choose which field this answer saves to.`}return""}function Da(e=P){let t=0;return e.forEach(a=>{const n=parseInt(a.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(a=>{const n=a.id&&String(a.id).trim()?String(a.id):String(++t),o=Ze(a.step_type)?a.step_options.map(r=>{const i={label:String(r.label).trim(),goto:String(r.goto||"")};return r.icon&&(i.icon=String(r.icon)),i}).filter(r=>r.label!==""):[],s={id:n,step_type:a.step_type,step_prompts:a.step_prompts.map(r=>String(r)).filter(r=>r.trim()!==""),step_options:o,step_columns:a.step_columns.slice(),step_description:a.step_description||""};return It(a.step_type)&&a.step_config&&(s.step_config={...Qe(),...a.step_config}),s})}function ld(e,t,a){Xc(),Rs=t,Fa=typeof a=="function"?a:null,zt=t?.modified_tz||"",Ht=["chat",...["book","support"].filter(n=>(t.actions||[]).some(o=>o&&o.type===n))],be={chat:Ns("chat",t)},We="chat",P=be.chat,Te=P.length===1?P[0]._uid:null,Be=null,Ve=null,e.innerHTML=`
    ...
    ${Ht.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${Ht.map(n=>`<option value="${n}">${de(Ls[n]||n)}</option>`).join("")}</select></div>`:""}
...
<body>
  ...
  <\/script>
  <script>${a}<\/script>
</body></html>`}let ro=!1;function Ps(){if(ro)return;const e=document.createElement("style");e.id="m5t-preview-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ro=!0}function Fs(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function Ds(e){const t=e.querySelector("[data-pv-info]"),a=e.querySelector("[data-pv-info-pop]");t&&a&&t.addEventListener("click",()=>{a.hidden=!a.hidden})}function hd(e,t){Ps(),e.innerHTML=`
    <div class="pv-pane">
      ...
      ${Fs("Live render of the real widget. Capture is disabled, so no test leads.")}
    </div>`,Ds(e);const a=e.querySelector(".pv-pane__frame"),n=e.querySelector(".pv-pane__badge");let o=null,s=0;const r=450,i=()=>{const c=(typeof performance<"u"?performance.now():Date.now())-s;clearTimeout(o),c<r?o=setTimeout(()=>{n.hidden=!0},r-c):n.hidden=!0};a.addEventListener("load",i);const l=()=>{let c;try{c=Ms(t())}catch{return}s=typeof performance<"u"?performance.now():Date.now(),n.hidden=!1,a.srcdoc=c,clearTimeout(o),o=setTimeout(()=>{n.hidden=!0},1500)};return e.querySelector(".pv-pane__seg").addEventListener("click",c=>{const m=c.target.closest("button[data-device]");!m||m.dataset.device===a.dataset.device||(e.querySelectorAll(".pv-pane__seg button").forEach(h=>h.classList.toggle("is-on",h===m)),a.dataset.device=m.dataset.device)}),l(),{refresh:l,destroy(){clearTimeout(o)}}}function Bs(e){Ps();let t="desktop";const a=document.createElement("div");a.className="pv-scrim",a.innerHTML=`
  ...
  `,document.head.appendChild(e),lo=!0}function vd(e){fd();const t=document.createElement("div");t.className="mag-modal-scrim mag-tpl-modal",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(o){o.key==="Escape"&&(o.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.querySelectorAll("[data-tpl]").forEach(o=>{o.addEventListener("click",()=>{const s=io.find(r=>r.id===o.dataset.tpl);s&&(t.querySelectorAll("[data-tpl]").forEach(r=>{r.disabled=!0}),a(),e(s))})})}let co=!1;const q={magnets:[],owners:[],canProvision:!1,canManage:!1,primaryOrgGuid:null,stats:{}},bd={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},w=e=>String(e??"").replace(/[&<>"']/g,t=>bd[t]),Fe=(e,t="info")=>{try{u.publish(g.UI_TOAST,{message:e,type:t})}catch{}},X=()=>x.getConfig?.().BASE_URL||"",Us=e=>`<script src="${X()}/m5t/v5/coreSnippet?appguid=${e}" async><\/script>`,qs=()=>`<details class="mag-csp-note" open>
...
</details>`,Hs={chat:"Chat bubble",right_slide:"Slide-in panel",modal:"Modal",inline:"Inline"},_d={chat:"chat",right_slide:"vertical_split",modal:"web_asset",inline:"view_agenda"},zs=[{value:"inline",icon:"view_agenda",label:"Inline"},{value:"chat",icon:"chat",label:"Chat"},{value:"right_slide",icon:"vertical_split",label:"Slide"},{value:"modal",icon:"web_asset",label:"Modal"}],Gs=[{value:"auto",icon:"brightness_auto",label:"Auto"},{value:"light",icon:"light_mode",label:"Light"},{value:"dark",icon:"dark_mode",label:"Dark"}],js=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],cn={book:{label:"Book",icon:"event",kind:"book"},chat:{label:"Chat",icon:"chat",kind:"flow"},call:{label:"Call",icon:"phone",kind:"value",placeholder:"Phone number"},email:{label:"Email",icon:"mail",kind:"value",placeholder:"Email address"},support:{label:"Support",icon:"support_agent",kind:"support"}},Vs=["book","chat","call","email","support"];let Gt=null;async function yd(){if(Gt)return Gt;let e;try{const t=await fetch(`${X()}/m5t/v5/integrations/calendly/event_types`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.event_types||[],scheduling_url:a.data.scheduling_url||""}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(Gt=e),e}async function wd(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved Calendly event";e.innerHTML=`<option value="${w(t)}">${t?w(a):"Loading event types"}</option>`;const n=await yd();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${w(t)}" selected>${w(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect Calendly under Settings, Integrations first":"Could not load event types"}</option>`;return}const o=[];n.scheduling_url&&o.push({url:n.scheduling_url,label:"Full scheduling page (visitor picks the event)"}),n.list.forEach(s=>o.push({url:s.scheduling_url,label:s.duration?`${s.name} (${s.duration} min)`:s.name})),t&&!o.some(s=>s.url===t)&&o.unshift({url:t,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${w(s.url)}"${s.url===(t||o[0].url)?" selected":""}>${w(s.label)}</option>`).join(""):'<option value="">No active event types</option>'}let jt=null;async function xd(){if(jt)return jt;let e;try{const t=await fetch(`${X()}/m5t/v5/integrations/callrail/trackers`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.trackers||[]}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(jt=e),e}async function Ed(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved tracking number";e.innerHTML=`<option value="${w(t)}">${t?w(a):"Loading tracking numbers"}</option>`;const n=await xd();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${w(t)}" selected>${w(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect CallRail under Settings, Integrations first":"Could not load tracking numbers"}</option>`;return}const o=n.list.map(s=>({number:s.number,id:s.id,name:s.name,label:`${s.name} · ${s.number}${s.type==="session"?" (number pool)":""}`}));t&&!o.some(s=>s.number===t)&&o.unshift({number:t,id:e.dataset.savedId||"",name:a,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${w(s.number)}" data-tracker-id="${w(s.id)}" data-tracker-name="${w(s.name)}"${s.number===(t||o[0].number)?" selected":""}>${w(s.label)}</option>`).join(""):'<option value="">No active tracking numbers in this company</option>'}function po(e,t,a){return`<div class="mag-seg" role="radiogroup" aria-label="${w(e)}">${a.map(n=>`
    <label><input type="radio" name="${w(e)}" value="${w(n.value)}"${n.value===t?" checked":""}>
      <span><span class="material-symbols-outlined" aria-hidden="true">${w(n.icon)}</span>${w(n.label)}</span></label>`).join("")}</div>`}function Ad(e,t){const a=cn[e],n=!!t,o=n?"":" disabled";let s="";if(a.kind==="value"&&e==="call"){const i=t?.config?.source==="callrail",l=i&&t?.value||"",c=i?t?.config?.tracker_name||"Saved tracking number":"";s=`
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${a.kind}">
    ...
    ${r}
  </div>`}function kd(){if(co)return;const e=document.createElement("style");e.id="m5t-magnets-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),co=!0}function ea(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Sd(e){const t=q.stats[e];if(!t||!t.opens&&!t.leads)return'<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>';const a=n=>Number(n||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function dn(e){const t=q.owners.length>1||x.getMemberships().length>1,a=(e.domains||[]).filter(Boolean),n=q.canManage;return`
    <div class="mag-card" data-guid="${w(e.guid)}">
      ...
      <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${_d[e.display_mode]||"chat"}</span>${w(Hs[e.display_mode]||"Chat bubble")}${e.ab?.enabled?'&nbsp;&nbsp;<span class="mag-ab-chip"><span class="material-symbols-outlined" aria-hidden="true">science</span>A/B</span>':""}${(e.notify_emails||[]).length?`&nbsp;&nbsp;<a class="mag-alert-chip" href="#/settings/notifications" title="Lead alerts to ${(e.notify_emails||[]).length} email${(e.notify_emails||[]).length===1?"":"s"}. Manage in Settings."><span class="material-symbols-outlined" aria-hidden="true">notifications_active</span>${(e.notify_emails||[]).length}</a>`:""}</span>
      ${Sd(e.guid)}
      <div class="mag-domains">${a.length?a.map(o=>w(o)).join(", "):"<span>No domains set. Add yours to go live.</span>"}</div>
      <div class="mag-embed">
        <input type="text" readonly value="${w(Us(e.guid))}" aria-label="Embed snippet">
    ...
    </div>`}function Td(){return re()?$t({section:"magnets",title:"Your Magnets",description:"Pick a client to view and manage their magnets."}):(kd(),`
    ...
    </div>`)}async function Cd(){if(re()){const t=a=>Number(a||0).toLocaleString();return ut(X(),[{h:"Magnets",td:a=>`${t(a.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${t(a.magnets.total)}</span>`},{h:"Leads · wk",td:a=>t(a.leads.this_week)},{h:"Leads · total",td:a=>t(a.leads.total)}],{emptyMsg:"No client orgs yet. Create one under Clients, then provision its magnets here."})}Gt=null,jt=null,document.getElementById("mag-new-btn")?.addEventListener("click",Ld),document.getElementById("mag-template-btn")?.addEventListener("click",Rd),document.getElementById("mag-body")?.addEventListener("click",Nd),await Lt()}async function Lt(){const e=document.getElementById("mag-body");if(!e)return;try{const[n,o]=await Promise.all([fetch(`${X()}/m5t/v5/magnets`),fetch(`${X()}/m5t/v5/magnets/stats`).catch(()=>null)]),s=await n.json().catch(()=>({}));if(!s.ok)throw new Error(s.message||"Failed to load");q.magnets=s.magnets||[],q.owners=s.owners||[],q.canProvision=!!s.canProvision,q.canManage=!!s.canManage,q.primaryOrgGuid=s.primaryOrgGuid||null;const r=o?await o.json().catch(()=>({})):{};q.stats=r?.stats||{}}catch{e.innerHTML=ea("error","Could not load your magnets. Please try again.");return}const t=document.getElementById("mag-new-btn");t&&(t.style.display=q.canProvision?"":"none");const a=document.getElementById("mag-template-btn");if(a&&(a.style.display=q.canProvision?"":"none"),!q.magnets.length){e.innerHTML=ea("widgets",q.canProvision?"No magnets yet. Click “New magnet” to create your first.":"No magnets yet.");return}e.innerHTML=`<div class="mag-grid">${q.magnets.map(dn).join("")}</div>`}async function $d(e){const t={"Content-Type":"application/json","Idempotency-Key":crypto.randomUUID()},a={status:"DRAFT"};e&&(a.owner_guid=e);const n=await fetch(`${X()}/m5t/v5/magnets`,{method:"POST",headers:t,body:JSON.stringify(a)});let o={};try{o=await n.json()}catch{}if(!n.ok||!o.ok)throw new Error(o.message||`Could not start a new magnet (${n.status})`);return o.magnet}async function Id(e,t){const a=await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t.name,...t.appearance,steps:t.steps})});let n={};try{n=await a.json()}catch{}if(!a.ok||!n.ok)throw new Error(n.message||`Could not apply the ${t.name} template (${a.status})`)}async function pn(e,t){const a=document.getElementById("mag-new-btn"),n=document.getElementById("mag-template-btn");a&&(a.disabled=!0),n&&(n.disabled=!0);let o=null;try{let s=await $d(e);if(o=s.guid,t)await Id(s.guid,t),await Lt(),s=q.magnets.find(r=>r.guid===s.guid)||s;else{q.magnets=[s,...q.magnets];const r=document.getElementById("mag-body");r&&(r.innerHTML=`<div class="mag-grid">${q.magnets.map(dn).join("")}</div>`)}ta(s,void 0,{freshDraft:!0})}catch(s){o&&fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(o)}`,{method:"DELETE"}).catch(()=>{}),Fe(s.message||"Could not start a new magnet","danger")}finally{a&&(a.disabled=!1),n&&(n.disabled=!1)}}function Ws(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="Choose client" style="max-width:420px">
    ...
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(o){o.key==="Escape"&&(o.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.querySelector('[data-x="cancel"]').addEventListener("click",a),t.querySelector('[data-x="continue"]').addEventListener("click",()=>{const o=t.querySelector("#mag-owner-pick").value;a(),pn(o,e)})}function Ld(){if(q.owners.length>1){Ws();return}pn(null)}function Rd(){vd(e=>{if(q.owners.length>1){Ws(e);return}pn(null,e)})}function Nd(e){const t=e.target.closest("[data-action]");if(!t)return;const a=t.dataset.guid,n=q.magnets.find(s=>s.guid===a),o=t.dataset.action;if(o==="copy")return Od(a);if(n){if(o==="preview")return Bs(()=>Ba(n));if(o==="funnel")return Md(n);if(o==="edit")return ta(n);if(o==="flow")return ta(n,"flow");if(o==="toggle")return Pd(n);if(o==="delete")return Fd(n)}}async function Od(e){try{await navigator.clipboard.writeText(Us(e)),Fe("Embed snippet copied","success")}catch{Fe("Copy failed","danger")}}function Ys(e){const t=Number(e?.total_steps)||0,a={};if((Array.isArray(e?.funnel)?e.funnel:[]).forEach(s=>{a[s.position]=Number(s.reached)||0}),!t||!Object.keys(a).length)return'<p class="mag-modal__hint" style="margin:0">No step activity yet in this window. As visitors answer questions, drop-off by step will appear here.</p>';const n=Math.max(1,a[1]||0),o=[];for(let s=1;s<=t;s++){const r=a[s]||0,i=Math.min(100,Math.round(r/n*100));o.push(`
      ...
      </div>`)}return`<div class="mag-funnel">${o.join("")}</div>`}async function Md(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal mag-funnel-modal" role="dialog" aria-modal="true" aria-label="Step funnel for ${w(e.name)}">
      ...
      <div class="mag-modal__body" style="padding:20px">
        ...
        <div id="mag-funnel-body">${ea("hourglass_empty","Loading…")}</div>
      </div>
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(s){s.key==="Escape"&&(s.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.addEventListener("click",s=>{s.target===t&&a()});const o=t.querySelector("#mag-funnel-body");try{const s=await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/step-funnel`),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.message||`Failed (${s.status})`);o.innerHTML=Ys(r)}catch{o.innerHTML='<p class="mag-modal__hint" style="margin:0">Could not load the funnel. Please try again.</p>'}}async function Pd(e){if(e.status==="DRAFT"){Fe("Open Edit and Save to publish a draft magnet.","info");return}const t=e.status==="ENABLED"?"DISABLED":"ENABLED";try{if(!(await(await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw new Error;Fe(t==="ENABLED"?"Magnet enabled":"Magnet disabled","success")}catch{Fe("Update failed","danger");return}try{await Lt()}catch(a){console.warn("[magnets] refresh after status toggle failed:",a)}}async function Fd(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`)){try{if(!(await(await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"})).json().catch(()=>({}))).ok)throw new Error;Fe("Magnet deleted","success")}catch{Fe("Delete failed","danger");return}try{await Lt()}catch(t){console.warn("[magnets] refresh after delete failed:",t)}}}function Ea(e){const t=[];return e.querySelectorAll(".mag-cta").forEach(a=>{if(!a.querySelector(".mag-cta__on").checked)return;const n=a.dataset.type,o=a.dataset.kind,s=a.querySelector(".mag-cta__val"),r=s?s.value.trim():"";if(o==="value")if(n==="call"&&a.querySelector(".mag-cta__callsrc")?.value==="callrail"){const i=a.querySelector(".mag-cta__crtracker"),l=i?.value||"",c=i?.selectedOptions?.[0];l&&t.push({type:n,value:l,config:{source:"callrail",...c?.dataset?.trackerId?{tracker_id:c.dataset.trackerId}:{},...c?.dataset?.trackerName?{tracker_name:c.dataset.trackerName}:{}}})}else r&&t.push({type:n,value:r});else if(o==="book")if(a.querySelector(".mag-cta__booksrc")?.value==="calendly"){const i=a.querySelector(".mag-cta__calevent"),l=i?.value||"",c=(i?.selectedOptions?.[0]?.textContent||"").trim();t.push({type:n,config:{source:"calendly",...l?{calendly_url:l}:{},...l&&c?{event_name:c}:{}}})}else{const i={type:n};r&&(/^https?:\/\//i.test(r)?i.value=r:i.config={meeting_label:r}),t.push(i)}else if(o==="support"){const i=(a.querySelector(".mag-cta__opts")?.value||"").split(`
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:Js(e),actions:t,font:e.querySelector("#mag-f-font").value.trim(),theme_vars:zd(e),inline_width:e.querySelector("#mag-f-inline-w").value.trim(),inline_height:e.querySelector("#mag-f-inline-h").value.trim(),hide_launcher:e.querySelector("#mag-f-hide-launcher").checked,input_placeholder:e.querySelector("#mag-f-input-ph").value,summary_confirm_label:e.querySelector("#mag-f-summary-confirm").value.trim(),success_title:e.querySelector("#mag-f-success-title").value.trim(),success_text:e.querySelector("#mag-f-success-text").value,success_cta:Gd(e)}}const Dd=512,Bd=new Set(["image/png","image/jpeg","image/gif","image/webp"]),Ud=8*1024*1024;function qd(e){return new Promise((t,a)=>{const n=new Image,o=new FileReader;o.onerror=()=>a(new Error("Could not read that file.")),o.onload=()=>{n.onerror=()=>a(new Error("That file isn’t a readable image.")),n.onload=()=>{const s=Math.min(1,Dd/Math.max(n.naturalWidth,n.naturalHeight)),r=Math.max(1,Math.round(n.naturalWidth*s)),i=Math.max(1,Math.round(n.naturalHeight*s)),l=document.createElement("canvas");l.width=r,l.height=i,l.getContext("2d").drawImage(n,0,0,r,i),t(l.toDataURL("image/png"))},n.src=o.result},o.readAsDataURL(e)})}function Hd(e,t){const a=e.querySelector("#mag-logo-drop");if(!a)return;const n=e.querySelector("#mag-f-logo-file"),o=e.querySelector("#mag-logo-browse"),s=e.querySelector("#mag-logo-remove"),r=e.querySelector("#mag-logo-preview"),i=e.querySelector("#mag-logo-status"),l=e.querySelector("#mag-f-logo"),c=(p,f)=>{i.textContent=p,i.style.color=f?"var(--color-danger, #DD4124)":""},m=p=>{r.innerHTML=p?`<img src="${w(p)}" alt="">`:'<span class="material-symbols-outlined" aria-hidden="true">image</span>',s.hidden=!p},h=p=>{l.value=p,l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))};async function b(p){if(!Bd.has(p.type)){c("PNG, JPEG, GIF, or WEBP only.",!0);return}if(p.size>Ud){c("That file is too large (8MB max before resizing).",!0);return}c("Uploading…",!1);try{const f=await qd(p),d=await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({image:f})}),v=await d.json().catch(()=>({}));if(!d.ok||!v.ok)throw new Error(v.error||`Upload failed (${d.status})`);const y=`${X()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;h(y),m(y),c("Logo updated.",!1)}catch(f){c(f.message||"Upload failed.",!0)}}n.addEventListener("change",()=>{n.files[0]&&b(n.files[0]),n.value=""}),a.addEventListener("click",p=>{p.target===s||s.contains(p.target)||p.target!==o&&n.click()}),o.addEventListener("click",()=>n.click()),["dragenter","dragover"].forEach(p=>a.addEventListener(p,f=>{f.preventDefault(),a.classList.add("is-dragover")})),["dragleave","drop"].forEach(p=>a.addEventListener(p,f=>{f.preventDefault(),a.classList.remove("is-dragover")})),a.addEventListener("drop",p=>{const f=p.dataTransfer?.files?.[0];f&&b(f)}),s.addEventListener("click",async p=>{p.stopPropagation(),c("Removing…",!1);try{const f=await fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"DELETE"}),d=await f.json().catch(()=>({}));if(!f.ok||!d.ok)throw new Error(d.error||`Remove failed (${f.status})`);h(""),m(""),c("Logo removed.",!1)}catch(f){c(f.message||"Remove failed.",!0)}})}function zd(e){return e.querySelector("#mag-f-surface-on")?.checked?{surface:e.querySelector("#mag-f-sv-surface").value,surface_2:e.querySelector("#mag-f-sv-surface2").value,border:e.querySelector("#mag-f-sv-border").value,text:e.querySelector("#mag-f-sv-text").value,text_sub:e.querySelector("#mag-f-sv-textsub").value}:{}}function Gd(e){const t=e.querySelector("#mag-f-success-cta-label").value.trim(),a=e.querySelector("#mag-f-success-cta-url").value.trim();return t&&a?{label:t,url:a}:{}}function Js(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",s=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==s.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}const Ua=[{label:"Web fonts (loaded for you)",opts:[["Inter, sans-serif","Inter"],["Poppins, sans-serif","Poppins"],["Montserrat, sans-serif","Montserrat"],["Roboto, sans-serif","Roboto"],['"Open Sans", sans-serif',"Open Sans"],["Lato, sans-serif","Lato"],["Nunito, sans-serif","Nunito"],["Raleway, sans-serif","Raleway"],['"Work Sans", sans-serif',"Work Sans"],["Oswald, sans-serif","Oswald"],["Merriweather, serif","Merriweather (serif)"]]},{label:"System / always available",opts:[["system-ui, sans-serif","System UI"],["Georgia, serif","Georgia (serif)"],['"Times New Roman", Times, serif',"Times (serif)"],["Arial, Helvetica, sans-serif","Arial / Helvetica"],["Verdana, Geneva, sans-serif","Verdana"],['"Courier New", monospace',"Courier (mono)"]]}];function jd(e){const t=String(e||""),a=new Set(Ua.flatMap(s=>s.opts.map(([r])=>r))),n=s=>s===t?" selected":"";let o=`<option value=""${t===""?" selected":""}>System default</option>`;t&&!a.has(t)&&(o+=`<option value="${w(t)}" selected>Current: ${w(t)}</option>`);for(const s of Ua)o+=`<optgroup label="${w(s.label)}">`+s.opts.map(([r,i])=>`<option value="${w(r)}"${n(r)}>${w(i)}</option>`).join("")+"</optgroup>";return o}function ta(e,t,a={}){const{freshDraft:n=!1}=a,o=!!e,s=o?null:crypto.randomUUID(),r=!o&&q.owners.length>1,i=e?.display_mode||"chat",l=e?.theme_mode||"auto",c={};(e?.actions||[]).forEach(k=>{k&&k.type&&(c[k.type]=k)});const m=o?!!e.home:!0,h=o?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",b=e?.theme_vars&&typeof e.theme_vars=="object"?e.theme_vars:{},p=Object.keys(b).length>0,f=(k,B)=>w(/^#[0-9a-fA-F]{6}$/.test(b[k]||"")?b[k]:B),d=document.createElement("div");d.className="mag-modal-scrim",d.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${o?"Edit magnet":"New magnet"}">
      ...
      <div class="mag-modal__main">
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${js.map(k=>`<option value="${k.value}"${(e?e.trigger||"none":"on_load")===k.value?" selected":""}>${w(k.label)}</option>`).join("")}
        </select>
        ...
        <div class="mag-modal__sec">
          ...
          <select class="mag-modal__select" id="mag-f-font">${jd(e?.font||"")}</select>
    ...
    </div>`,document.body.appendChild(d),requestAnimationFrame(()=>{d.classList.add("open"),d.querySelector(".mag-modal").classList.add("open")});const v=[...d.querySelectorAll(".mag-modal__navitem")],y=[...d.querySelectorAll(".mag-tab")],E=k=>{v.forEach(B=>B.classList.toggle("is-active",B.dataset.tab===k)),y.forEach(B=>{B.hidden=B.dataset.tab!==k}),d.querySelector(".mag-modal__body").scrollTop=0};v.forEach(k=>k.addEventListener("click",()=>E(k.dataset.tab)));const I=()=>Ba({...e,...Ea(d),...o?{steps:so()}:{}}),N=d.querySelector("#mag-preview-pane"),H=()=>window.matchMedia("(min-width: 1200px)").matches;let U=null;const ie=()=>{if(!U&&H())try{U=hd(N,I)}catch{}};let Z=null;const le=()=>{H()&&(ie(),U&&(clearTimeout(Z),Z=setTimeout(()=>{try{U.refresh()}catch{}},300)))},De=window.matchMedia("(min-width: 1200px)"),Le=()=>{H()&&(ie(),le())};De.addEventListener("change",Le);let M=!1,$=!1;const W=d.querySelector("#mag-f-dirty"),Re=k=>{M=k,W&&(W.hidden=!k)},Rt=d.querySelector(".mag-modal__main");Rt.addEventListener("input",()=>Re(!0)),Rt.addEventListener("change",()=>{Re(!0),le()}),d.querySelector("#mag-f-color")?.addEventListener("input",()=>{Re(!0),le()});const ze=k=>{M&&(k.preventDefault(),k.returnValue="")};window.addEventListener("beforeunload",ze);let gt=!0;const pa=u.subscribe(g.ROUTE_NAV_BEFORE,()=>{if(gt){if(M&&!confirm("Discard your changes to this magnet?")){window.router?.navigate("/magnets");return}_()}}),_=()=>{if(n&&!$&&e&&e.status==="DRAFT"){fetch(`${X()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"}).catch(()=>{}),q.magnets=q.magnets.filter(B=>B.guid!==e.guid);const k=document.getElementById("mag-body");k&&(k.innerHTML=`<div class="mag-grid">${q.magnets.map(dn).join("")}</div>`)}gt=!1,window.removeEventListener("beforeunload",ze),u.unsubscribe(pa),clearTimeout(Z),De.removeEventListener("change",Le),U&&U.destroy&&U.destroy(),d.classList.remove("open"),setTimeout(()=>d.remove(),180),document.removeEventListener("keydown",R)},A=()=>{M&&!confirm("Discard your changes to this magnet?")||_()};function R(k){k.key==="Escape"&&(k.preventDefault(),A())}document.addEventListener("keydown",R),d.querySelector(".mag-modal__close").addEventListener("click",A),d.querySelector('[data-x="cancel"]').addEventListener("click",A),d.querySelector("[data-close-modal]")?.addEventListener("click",A),d.querySelector("#mag-f-name").focus();const z=d.querySelector("#mag-flow-panel");o?ld(z,e,()=>{Re(!0),le()}):z.innerHTML='<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>',Hd(d,e),t&&E(t),ie(),d.querySelectorAll(".mag-cta").forEach(k=>{const B=k.querySelector(".mag-cta__on"),ce=k.querySelector(".mag-cta__val"),ee=k.querySelector(".mag-cta__opts"),Ne=k.querySelectorAll(".mag-cta__booksrc, .mag-cta__calevent, .mag-cta__callsrc, .mag-cta__crtracker");B.addEventListener("change",()=>{ce&&(ce.disabled=!B.checked),ee&&(ee.disabled=!B.checked),Ne.forEach(V=>{V.disabled=!B.checked}),B.checked&&(ce||ee)?.focus()}),ce&&ce.addEventListener("input",()=>{ce.value.trim()&&!B.checked&&(B.checked=!0,ee&&(ee.disabled=!1))})}),d.querySelectorAll('.mag-cta[data-kind="book"]').forEach(k=>{const B=k.querySelector(".mag-cta__booksrc"),ce=k.querySelector(".mag-cta__val"),ee=k.querySelector(".mag-cta__calevent");if(!B||!ee)return;const Ne=()=>{const V=B.value==="calendly";ce.hidden=V,ee.hidden=!V,V&&!ee.dataset.listed&&(ee.dataset.listed="1",wd(ee))};B.addEventListener("change",()=>{const V=k.querySelector(".mag-cta__on");V.checked||(V.checked=!0,V.dispatchEvent(new Event("change"))),Ne()}),Ne()}),d.querySelectorAll('.mag-cta[data-type="call"]').forEach(k=>{const B=k.querySelector(".mag-cta__callsrc"),ce=k.querySelector(".mag-cta__val"),ee=k.querySelector(".mag-cta__crtracker");if(!B||!ee)return;const Ne=()=>{const V=B.value==="callrail";ce.hidden=V,ee.hidden=!V,V&&!ee.dataset.listed&&(ee.dataset.listed="1",Ed(ee))};B.addEventListener("change",()=>{const V=k.querySelector(".mag-cta__on");V.checked||(V.checked=!0,V.dispatchEvent(new Event("change"))),Ne()}),Ne()});const F=d.querySelector("#mag-f-surface-on"),_e=d.querySelector("#mag-f-surface");F.addEventListener("change",()=>_e.hidden=!F.checked);const Ge=d.querySelector("#mag-f-inline-size");d.querySelectorAll('input[name="mag-display"]').forEach(k=>k.addEventListener("change",()=>{Ge.hidden=d.querySelector('input[name="mag-display"]:checked')?.value!=="inline"})),d.querySelector('[data-x="preview"]')?.addEventListener("click",()=>Bs(()=>Ba({...e,...Ea(d),...o?{steps:so()}:{}}))),d.querySelector('[data-x="save"]').addEventListener("click",async k=>{const B=k.currentTarget,ce=d.querySelector("#mag-f-error"),ee=d.querySelector("#mag-f-name").value.trim();if(!ee){E("basics"),ce.textContent="Please give your magnet a name.";return}const Ne=d.querySelector("#mag-f-domains").value.split(",").map(te=>te.trim()).filter(Boolean);let V="";if(d.querySelectorAll(".mag-cta").forEach(te=>{const et=te.querySelector(".mag-cta__on").checked;if(te.dataset.kind==="book"){const ft=te.querySelector(".mag-cta__booksrc")?.value==="calendly";et&&ft&&!te.querySelector(".mag-cta__calevent")?.value&&(V=V||"Pick a Calendly event for the Book button, or switch it back to the built-in scheduler.");return}if(te.dataset.kind!=="value")return;if(te.dataset.type==="call"&&te.querySelector(".mag-cta__callsrc")?.value==="callrail"){et&&!te.querySelector(".mag-cta__crtracker")?.value&&(V=V||"Pick a CallRail tracking number for the Call button, or switch it back to a phone number.");return}const ht=te.querySelector(".mag-cta__val").value.trim();et&&!ht&&(V=V||`Add a target for the ${cn[te.dataset.type].label} button, or uncheck it.`)}),V){E("welcome"),ce.textContent=V;return}const gn=Js(d);if(gn.enabled&&!Object.keys(gn.b).length){E("ab"),ce.textContent="Give variant B at least one change (title, welcome, or color), or untick the A/B test.";return}if(o){const te=dd();if(te){E("flow"),pd(te.route,te.message);return}}const ua={name:ee,domains:Ne,...Ea(d)};r&&(ua.owner_guid=d.querySelector("#mag-f-owner").value);const hn=o&&e.status==="DRAFT";hn&&(ua.status="ENABLED"),B.disabled=!0,ce.textContent="";try{const te=o?`${X()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${X()}/m5t/v5/magnets`,et={"Content-Type":"application/json"};s&&(et["Idempotency-Key"]=s);const ht=await fetch(te,{method:o?"PATCH":"POST",headers:et,body:JSON.stringify(ua)});let ft={};try{ft=await ht.json()}catch{}if(!ht.ok||!ft.ok)throw new Error(ft.message||`Save failed (${ht.status})`);o&&await md(e.guid),Fe(hn||!o?"Magnet created":"Magnet updated","success"),$=!0,_(),await Lt()}catch(te){B.disabled=!1,ce.textContent=te.message||"Something went wrong."}})}const Vd=Object.freeze(Object.defineProperty({__proto__:null,CTA_META:cn,CTA_ORDER:Vs,DISPLAY_OPTS:zs,FONT_GROUPS:Ua,MODE_LABEL:Hs,THEME_OPTS:Gs,TRIGGER_OPTS:js,cspNoteHTML:qs,init:Cd,openModal:ta,render:Td,stepFunnelHTML:Ys},Symbol.toStringTag,{value:"Module"}));let uo=!1;const S={leads:[],magnetNames:{},filter:"ALL",canManage:!1,book:!1,ownerNames:{},clientFilter:"ALL",search:"",shown:100,selectedId:null},At=100,qa=["NEW","WORKING","QUALIFIED","UNQUALIFIED","CONVERTED","EXPORTED"],Wd={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},O=e=>String(e??"").replace(/[&<>"']/g,t=>Wd[t]),aa=(e,t="info")=>{try{u.publish(g.UI_TOAST,{message:e,type:t})}catch{}},na=()=>x.getConfig?.().BASE_URL||"",oa=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",Ks=e=>(oa(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase(),un=e=>e.created?.created_tz||"";function ot(e){const t=un(e);if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric"})}catch{return""}}function Yd(e){const t=un(e);if(!t)return"";try{const a=Date.now()-new Date(t).getTime();if(a<0)return ot(e);const n=a/36e5;return n<1?`${Math.max(1,Math.floor(a/6e4))}m ago`:n<24?`${Math.floor(n)}h ago`:n<48?"Yesterday":ot(e)}catch{return ot(e)}}const Jd=e=>{const t=un(e);if(!t)return!1;try{return Date.now()-new Date(t).getTime()<24*36e5}catch{return!1}};function Kd(){if(uo)return;const e=document.createElement("style");e.id="m5t-leads-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),uo=!0}function Tt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Qd(e){return`<select class="leads-status" data-id="${O(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${qa.map(t=>`<option value="${t}" ${e.status===t?"selected":""}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join("")}
  </select>`}function Xd(e){const t=S.magnetNames[e.magnet_guid]||e.lead_source||"—",a=e.phone?String(e.phone).replace(/[^\d+]/g,""):"";return`
    <tr class="leads-row${String(e.id)===S.selectedId?" selected":""}" data-id="${O(e.id)}" tabindex="0" role="button" aria-label="Open lead ${O(oa(e))}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${O(Ks(e))}</span>
          <span><span class="leads-name">${O(oa(e))}</span>${e.company?`<span class="leads-sub">${O(e.company)}</span>`:""}</span>
        </span>
      </td>
      ${S.book?`<td>${as(S.ownerNames[e.owner_guid]||"")||'<span class="leads-muted">—</span>'}</td>`:""}
      <td>
      ...
      <td>${S.canManage?Qd(e):`<span class="leads-badge" data-s="${O(e.status)}">${O(e.status)}</span>`}</td>
      <td class="num leads-muted" style="white-space:nowrap" title="${O(ot(e))}">${Jd(e)?'<span class="leads-fresh" title="Captured in the last 24 hours"></span>':""}${O(Yd(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}const Qs=e=>S.clientFilter==="ALL"||e.owner_guid===S.clientFilter;function Zd(e){const t=S.search.trim().toLowerCase();if(!t)return!0;const a=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,S.magnetNames[e.magnet_guid],S.book?S.ownerNames[e.owner_guid]:""].filter(Boolean).join(" ").toLowerCase();return t.split(/\s+/).every(n=>a.includes(n))}function Xs(){return S.leads.filter(e=>(S.filter==="ALL"||e.status===S.filter)&&Qs(e)&&Zd(e))}const Zs=()=>Tt("touch_app","Click to see lead information.");function ep(){Kd(),pt();const e=re();return`
    <div class="page-shell" data-section="leads">
      ...
      <div class="dashboard-card" style="margin-bottom:24px">
        ...
        <div class="card-body" id="pf-picker-body">${Tt("hourglass_empty","Loading…")}</div>
      </div>`:""}
      <div class="page-header">
        <div class="page-header-text">
      ...
      <div class="leads-layout">
        <div class="dashboard-card">
          <div class="card-body" id="leads-body">
            ${Tt("hourglass_empty","Loading leads…")}
          </div>
        </div>
        <aside class="dashboard-card leads-panel" aria-label="Lead detail">
          <div class="card-body" id="leads-panel-body">${Zs()}</div>
        </aside>
      </div>
    </div>`}async function tp(){if(document.getElementById("leads-export")?.addEventListener("click",sp),re()){const e=t=>Number(t||0).toLocaleString();ut(na(),[{h:"Leads · wk",td:t=>e(t.leads.this_week)},{h:"Leads · total",td:t=>e(t.leads.total)},{h:"Compl.",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await ap()}async function ap(){const e=document.getElementById("leads-body");if(e){try{const[t,a]=await Promise.all([fetch(`${na()}/m5t/v5/m5mLead`),fetch(`${na()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(S.leads=(n.data||[]).filter(o=>!["DELETED","ARCHIVED"].includes(o.status)),S.book=re(),S.ownerNames=S.book?ts():{},a){const o=await a.json().catch(()=>({}));S.magnetNames={},(o.magnets||[]).forEach(s=>{S.magnetNames[s.guid]=s.name,s.owner_guid&&s.owner_name&&!S.ownerNames[s.owner_guid]&&(S.ownerNames[s.owner_guid]=s.owner_name)}),S.canManage=!!o.canManage}}catch{e.innerHTML=Tt("error","Could not load your leads. Please try again.");return}sa()}}const np=()=>`
  <colgroup>
    <col style="width:23%">
  ...
  </colgroup>`;function sa(){const e=document.getElementById("leads-body"),t=document.getElementById("leads-export");if(!e)return;if(t&&(t.style.display=S.leads.length?"":"none"),!S.leads.length){e.innerHTML=Tt("inbox","No leads captured yet. Publish a magnet and share it to start collecting.");return}const a=S.leads.filter(Qs),n={ALL:a.length};qa.forEach(s=>{n[s]=a.filter(r=>r.status===s).length});const o=S.book?[...new Set(S.leads.map(s=>s.owner_guid).filter(Boolean))].map(s=>({guid:s,name:S.ownerNames[s]||s})).sort((s,r)=>s.name.localeCompare(r.name)):[];e.innerHTML=`
    <div class="leads-bar">
      <div class="leads-filter">
        ${["ALL",...qa].map(s=>`<button data-filter="${s}" class="${S.filter===s?"active":""}">${s==="ALL"?"All":s[0]+s.slice(1).toLowerCase()}${n[s]?`<span class="leads-pillnum">${n[s]}</span>`:""}</button>`).join("")}
      </div>
      ${S.book&&o.length>1?`
      <select class="leads-clientsel" id="leads-clientsel" aria-label="Filter by client">
        <option value="ALL">All clients</option>
        ${o.map(s=>`<option value="${O(s.guid)}" ${S.clientFilter===s.guid?"selected":""}>${O(s.name)}</option>`).join("")}
      </select>`:""}
      <span class="leads-searchwrap">
        <span class="material-symbols-outlined" aria-hidden="true">search</span>
        <input class="leads-search" id="leads-search" type="search" placeholder="Search leads" value="${O(S.search)}" aria-label="Search leads" />
      </span>
      <span class="leads-count" id="leads-countlbl"></span>
    </div>
    <div id="leads-tablezone"></div>`,e.querySelector(".leads-filter")?.addEventListener("click",s=>{const r=s.target.closest("[data-filter]");r&&(S.filter=r.dataset.filter,S.shown=At,sa())}),e.querySelector("#leads-clientsel")?.addEventListener("change",s=>{S.clientFilter=s.target.value,S.shown=At,sa()}),e.querySelector("#leads-search")?.addEventListener("input",s=>{S.search=s.target.value,S.shown=At,Ha()}),Ha()}function Ha(){const e=document.getElementById("leads-tablezone"),t=document.getElementById("leads-countlbl");if(!e)return;const a=Xs(),n=a.slice(0,S.shown),o=S.book?8:7;t&&(t.textContent=`${a.length} of ${S.leads.length}`),e.innerHTML=`
    <div class="leads-tablewrap">
      <table class="leads-table">
        ...
        <tbody id="leads-tbody">${n.map(Xd).join("")||`<tr><td colspan="${o}"><div class="leads-muted" style="padding:14px 4px">${S.search.trim()?"No leads match your search.":`No ${S.filter.toLowerCase()} leads.`}</div></td></tr>`}</tbody>
      </table>
    </div>
    ${a.length>S.shown?`<button class="leads-more" type="button" id="leads-more">Show ${Math.min(At,a.length-S.shown)} more (${a.length-S.shown} remaining)</button>`:""}`,e.querySelector("#leads-more")?.addEventListener("click",()=>{S.shown+=At,Ha()}),e.querySelector("#leads-tbody")?.addEventListener("change",op),e.querySelector("#leads-tbody")?.addEventListener("click",s=>{if(s.target.closest(".leads-status, a.leads-contactlink"))return;const r=s.target.closest(".leads-row");r&&mo(r.dataset.id)}),e.querySelector("#leads-tbody")?.addEventListener("keydown",s=>{if(s.key!=="Enter"&&s.key!==" ")return;const r=s.target.closest(".leads-row");r&&s.target===r&&(s.preventDefault(),mo(r.dataset.id))})}async function op(e){const t=e.target.closest(".leads-status");if(!t)return;const a=t.dataset.id,n=S.leads.find(r=>String(r.id)===String(a)),o=t.value,s=n?.status;try{if(!(await(await fetch(`${na()}/m5t/v5/m5mLead/${encodeURIComponent(a)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:o})})).json().catch(()=>({}))).ok)throw new Error;n&&(n.status=o),aa(`Marked ${o[0]}${o.slice(1).toLowerCase()}`,"success")}catch{t.value=s||"NEW",aa("Could not update status","danger");return}try{String(a)===S.selectedId&&ar(),S.filter!=="ALL"&&sa()}catch(r){console.warn("[leads] re-render after status change failed:",r)}}function mo(e){S.selectedId=String(e),document.querySelectorAll(".leads-row").forEach(t=>t.classList.toggle("selected",t.dataset.id===S.selectedId)),ar()}function Pt(e,t){const a=Array.isArray(e.tags)?e.tags:[];for(let n=a.length-1;n>=0;n--)if(a[n]&&a[n].tag===t&&a[n].value!=null)return String(a[n].value);return""}function er(e){const t=Pt(e,"appointment_start");if(!t)return null;const a=Pt(e,"appointment_status")||"booked",n=Pt(e,"appointment_timezone"),o=Pt(e,"appointment_event_type"),s=new Date(t);let r=t;if(!Number.isNaN(s.getTime())){const i={weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"};try{r=new Intl.DateTimeFormat(void 0,n?{...i,timeZone:n}:i).format(s)}catch{r=new Intl.DateTimeFormat(void 0,i).format(s)}}return{when:r,status:a,type:o,start:t}}const go={booked:["QUALIFIED","Booked"],rescheduled:["WORKING","Rescheduled"],canceled:["CANCELED","Canceled"]};function tr(e){const t=Array.isArray(e.tags)?e.tags:[];let a=null;for(const l of t)if(!(!l||!l.tag)){if(l.tag==="callrail_call_id"){a={};continue}a&&l.tag.indexOf("call_")===0&&l.value!=null&&(a[l.tag]=String(l.value))}if(!a||!a.call_started)return null;const n=a.call_started,o=new Date(n);let s=n;Number.isNaN(o.getTime())||(s=new Intl.DateTimeFormat(void 0,{weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"}).format(o));const r=Number(a.call_duration)||0,i=r?r<60?`${r}s`:`${Math.floor(r/60)}m ${r%60}s`:"";return{when:s,dur:i,source:a.call_source||"",answered:a.call_answered||"",recording:a.call_recording_player||"",started:n}}function ar(){const e=document.getElementById("leads-panel-body");if(!e)return;const t=S.leads.find(l=>String(l.id)===S.selectedId);if(!t){e.innerHTML=Zs();return}const a=S.magnetNames[t.magnet_guid]||t.lead_source||"—",n=er(t),[o,s]=n?go[n.status]||go.booked:["",""],r=tr(t),i=(l,c)=>c?`<div class="leads-det__field"><span class="leads-det__k">${O(l)}</span><span class="leads-det__v">${O(c)}</span></div>`:"";e.innerHTML=`
    <div class="leads-det__head">
      <span class="leads-avatar leads-det__ava">${O(Ks(t))}</span>
      <div>
        <div class="leads-det__name">${O(oa(t))}</div>
    ...
    ${t.description?`<div class="leads-det__notes">${O(t.description)}</div>`:""}`}function sp(){const e=Xs();if(!e.length){aa("Nothing to export","info");return}const t=["first_name","last_name","email","phone","company","product_interest","lead_source","utm_source","utm_medium","utm_campaign","gclid","status"],a=l=>`"${String(l??"").replace(/"/g,'""')}"`,o=[[...S.book?["client"]:[],...t,"magnet","captured","appointment","last_call"].join(",")];for(const l of e){const c=er(l),m=tr(l);o.push([...S.book?[a(S.ownerNames[l.owner_guid]||"")]:[],...t.map(h=>a(l[h])),a(S.magnetNames[l.magnet_guid]||l.lead_source||""),a(ot(l)),a(c?`${c.start} (${c.status})`:""),a(m?`${m.started} (${m.answered==="no"?"missed":"answered"})`:"")].join(","))}const s=new Blob([o.join(`
`)],{type:"text/csv"}),r=URL.createObjectURL(s),i=document.createElement("a");i.href=r,i.download=`leads-${S.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r),aa(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const rp=Object.freeze(Object.defineProperty({__proto__:null,init:tp,render:ep},Symbol.toStringTag,{value:"Module"})),nr=()=>x.getConfig?.().BASE_URL||"",ho=e=>e.toISOString().slice(0,10),fo=e=>e==null?"—":"$"+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),nt=e=>Number(e||0).toLocaleString(),ip={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ft=e=>String(e??"").replace(/[&<>"']/g,t=>ip[t]);let vo=!1;function lp(){if(vo)return;const e=document.createElement("style");e.id="m5t-adperf-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),vo=!0}const st=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,Dt=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
  ...
  </div>`,cp=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let ra=30;function or(){return re()?$t({section:"ad-performance",title:"Ad Performance",description:"Pick a client to view their spend and lead performance."}):(lp(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${cp.map(e=>`<button class="chart-period-btn${e.d===ra?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>

      <div class="stats-grid">
        ${Dt("payments","Ad Spend","adperf-spend")}
        ${Dt("ads_click","Clicks","adperf-clicks")}
        ${Dt("person_add","Magnet Leads","adperf-leads")}
        ${Dt("request_quote","Cost / Lead","adperf-cpl")}
      </div>
    ...
    </div>`)}async function sr(){if(re()){const t=a=>Number(a||0).toLocaleString();return ut(nr(),[{h:"Spend",td:a=>a.ad?`$${t(a.ad.spend)}`:"—"},{h:"Clicks",td:a=>a.ad?t(a.ad.clicks):"—"},{h:"Leads",td:a=>t(a.leads.window??a.leads.total)},{h:"CPL",td:a=>a.ad?.cost_per_lead!=null?`$${t(a.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see spend here."})}const e=document.getElementById("adperf-periods");e?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(ra=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===ra)),bo())}),await bo()}async function bo(){const e=nr(),t=document.getElementById("adperf-body"),a=document.getElementById("adperf-range"),n=new Date,o=ho(n),s=ho(new Date(n.getTime()-(ra-1)*864e5));a&&(a.textContent=`${s} → ${o}`);let r,i=[],l=null;try{const[m,h,b]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${s}&to=${o}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${s}&to=${o}`)]);if(!m.ok)throw new Error(`HTTP ${m.status}`);r=await m.json(),i=((await h.json().catch(()=>({})))?.data||[]).filter(f=>f.status!=="DELETED"),l=await b.json().catch(()=>null)}catch(m){console.warn("[ad-performance] load failed:",m),t&&(t.innerHTML=st("error","Could not load ad performance. Please try again."));return}const c=r.totals||{};if(Bt("adperf-spend",fo(c.spend)),Bt("adperf-clicks",nt(c.clicks)),Bt("adperf-leads",nt(c.magnet_leads)),Bt("adperf-cpl",fo(c.cost_per_lead)),dp(l),!i.length){t.innerHTML=st("link_off","No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.");return}if(!r.connected){t.innerHTML=st("cloud_sync","Account connected. No ad data for this range yet. Metrics appear here once they sync.");return}t.innerHTML=pp(r.rows||[])}function dp(e){const t=document.getElementById("adperf-sources"),a=document.getElementById("adperf-src-summary");if(!t)return;const n=e&&Array.isArray(e.rows)?e.rows:[];if(!n.length){a&&(a.textContent=""),t.innerHTML=st("search_off","No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.");return}const o=e.total_leads||n.reduce((i,l)=>i+(l.leads||0),0),s=e.tracked_leads||0;a&&(a.textContent=`${nt(s)} of ${nt(o)} leads tagged to a source`);const r=i=>i.campaign&&i.campaign!=="(none)"?Ft(i.campaign):i.source&&i.source!=="(direct)"?Ft(i.source):'<span class="adperf-src-untracked">Untracked / direct</span>';t.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${n.map(i=>`
          <tr>
            <td>${r(i)}</td>
            <td class="adperf-src-sub">${Ft(i.source||"—")}${i.medium?` · ${Ft(i.medium)}`:""}</td>
            <td class="num">${i.paid_clicks?nt(i.paid_clicks):'<span class="adperf-src-sub">—</span>'}</td>
            <td class="num"><b>${nt(i.leads)}</b></td>
          </tr>`).join("")}
        </tbody>
      </table>
    </div>`}function Bt(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}function _o(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}function yo(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e)}function pp(e){const p=e.length||1,f=_o(Math.max(1,...e.map(M=>M.spend||0))),d=_o(Math.max(1,...e.map(M=>M.magnet_leads||0))),v=738/p,y=Math.min(24,v*.55),E=M=>56+v*(M+.5),I=M=>304-M/f*282,N=M=>304-M/d*282,H=[0,.25,.5,.75,1].map(M=>{const $=304-M*282;return`<line x1="56" y1="${$.toFixed(1)}" x2="794" y2="${$.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${($+3.5).toFixed(1)}" text-anchor="end" class="ax">$${yo(f*M)}</text><text x="802" y="${($+3.5).toFixed(1)}" text-anchor="start" class="ax">${yo(d*M)}</text>`}).join(""),U=e.map((M,$)=>{const W=I(M.spend||0);return`<rect x="${(E($)-y/2).toFixed(1)}" y="${W.toFixed(1)}" width="${y.toFixed(1)}" height="${Math.max(0,304-W).toFixed(1)}" rx="3" fill="#0072BA"><title>${M.date}: $${M.spend} spend</title></rect>`}).join(""),ie=e.map((M,$)=>`${E($).toFixed(1)},${N(M.magnet_leads||0).toFixed(1)}`).join(" "),Z=p>1?`<polyline points="${ie}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",le=e.map((M,$)=>`<circle cx="${E($).toFixed(1)}" cy="${N(M.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${M.date}: ${M.magnet_leads} leads</title></circle>`).join(""),De=Math.max(1,Math.ceil(p/6)),Le=e.map((M,$)=>$%De===0||$===p-1?`<text x="${E($).toFixed(1)}" y="326" text-anchor="middle" class="ax">${M.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="adperf-chart" viewBox="0 0 840 340" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Ad spend versus magnet leads over time">
      ${H}${U}${Z}${le}${Le}
    </svg>`}const up={render:or,init:sr},mp=Object.freeze(Object.defineProperty({__proto__:null,default:up,init:sr,render:or},Symbol.toStringTag,{value:"Module"})),wo="reseller_org",rr="managed_client";let xo=!1;const gp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},L=e=>String(e??"").replace(/[&<>"']/g,t=>gp[t]);function dt(e,t="info"){try{u.publish(g.UI_TOAST,{message:e,type:t})}catch{}}function hp(){const e=x.getActiveOrg();if(e&&e.channel===wo)return{guid:e.guid,name:e.name};const t=x.getMemberships().find(a=>a.channel===wo);return t?{guid:t.orgGuid,name:t.name}:null}function fp(e){const t=e?.created_tz;if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function vp(){if(xo)return;const e=document.createElement("style");e.id="m5t-clients-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),xo=!0}const bp=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function kt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function _p(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
    ...
    </div>`}async function lr(){const e=hp();document.getElementById("clients-add-btn")?.addEventListener("click",()=>yp(e)),await cr(e)}async function cr(e){const t=document.getElementById("clients-body"),a=document.getElementById("clients-count");if(t){if(!e?.guid){t.innerHTML=kt("info","Client provisioning is available to reseller / agency accounts."),a&&(a.textContent="");return}try{const n=x.getConfig?.().BASE_URL||"",o=await fetch(`${n}/m5t/v5/acctGroup`);if(!o.ok)throw new Error(`HTTP ${o.status}`);const s=await o.json(),i=(Array.isArray(s?.data)?s.data:[]).filter(l=>l.class===rr&&(!l.parent||l.parent===e.guid));if(!i.length){t.innerHTML=kt("group_off","No clients yet. Add your first client to start managing magnets on their behalf."),a&&(a.textContent="");return}t.innerHTML=`<div class="client-list">${i.map(_p).join("")}</div>`,a&&(a.textContent=`${i.length} client${i.length===1?"":"s"}`),t.querySelectorAll(".client-card__invite").forEach(l=>{l.addEventListener("click",()=>{l.dataset.action==="adaccounts"?wp(l.dataset.clientGuid,l.dataset.clientName):l.dataset.action==="questionnaire"?Ep(l.dataset.clientGuid,l.dataset.clientName):xp(l.dataset.clientGuid,l.dataset.clientName)})})}catch(n){console.warn("[clients] load failed:",n),t.innerHTML=kt("error","Couldn’t load clients. Please try again."),a&&(a.textContent="")}}}function yp(e){if(!e?.guid){dt("Only reseller / agency accounts can add clients.","error");return}const t=document.createElement("div");t.className="client-modal-scrim";const a=document.createElement("div");a.className="client-modal",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
    ...
    </div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add("open"),i.classList.add("open")});const l=i.querySelector("#aa-error"),c=i.querySelector('[data-act="save"]'),m=()=>{r.classList.remove("open"),i.classList.remove("open"),document.removeEventListener("keydown",h),setTimeout(()=>{r.remove(),i.remove()},200)},h=f=>{f.key==="Escape"&&m()};document.addEventListener("keydown",h),r.addEventListener("click",m),i.querySelector(".client-modal__close")?.addEventListener("click",m),i.querySelector('[data-act="cancel"]')?.addEventListener("click",m);const b=(f,d,v)=>{const y=`${a}/m5t/v5/coreAdAccount`;return d&&!v?fetch(y,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,provider:f,external_customer_id:d})}):d&&v&&d!==v.external_customer_id?fetch(`${y}/${encodeURIComponent(v.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({external_customer_id:d})}):!d&&v?fetch(`${y}/${encodeURIComponent(v.guid)}`,{method:"DELETE"}):null},p=async()=>{l.textContent="";const f=Eo(i.querySelector("#aa-gads").value),d=Eo(i.querySelector("#aa-lsa").value),v=[b("google_ads",f,o),b("google_lsa",d,s)].filter(Boolean);if(!v.length){m();return}c.disabled=!0;const y=c.innerHTML;c.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const E=await Promise.all(v);for(const I of E)if(!I.ok){const N=await I.json().catch(()=>({}));throw new Error(I.status===403?"You are not authorized to connect accounts for this client.":N?.error||N?.message||`Failed (HTTP ${I.status})`)}dt("Ad accounts updated","success"),m()}catch(E){l.textContent=E.message||"Something went wrong. Please try again.",c.disabled=!1,c.innerHTML=y}};c?.addEventListener("click",p)}function xp(e,t){if(!e)return;const a=document.createElement("div");a.className="client-modal-scrim";const n=document.createElement("div");n.className="client-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="invite-body">
      ...
      <div class="client-modal__actions">
        ...
        <div class="client-modal__result">
          ...
          <p>${v.emailQueued?`An invite email is on its way to <strong>${L(m)}</strong>.`:`Invite created for <strong>${L(m)}</strong>.`}</p>
        ...
        </div>`;const y=n.querySelector("#inv-link");n.querySelector("#inv-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(y.value),n.querySelector("#inv-copy").textContent="Copied!"}catch{y.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",o)}catch(f){console.warn("[clients] invite failed:",f),i.textContent=f.message||"Something went wrong. Please try again.",l.disabled=!1,l.innerHTML=p}})}function Aa(e){if(!e)return"";const t=new Date(e);return Number.isNaN(t.getTime())?"":t.toLocaleString(void 0,{year:"numeric",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}async function Ep(e,t){if(!e)return;const a=x.getConfig?.().BASE_URL||"",n=document.createElement("div");n.className="client-modal-scrim";const o=document.createElement("div");o.className="client-modal",o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),o.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="qm-body">${kt("hourglass_empty","Loading…")}</div>`,document.body.appendChild(n),document.body.appendChild(o),requestAnimationFrame(()=>{n.classList.add("open"),o.classList.add("open")});const s=()=>{n.classList.remove("open"),o.classList.remove("open"),document.removeEventListener("keydown",r),setTimeout(()=>{n.remove(),o.remove()},200)},r=p=>{p.key==="Escape"&&s()};document.addEventListener("keydown",r),n.addEventListener("click",s),o.querySelector(".client-modal__close")?.addEventListener("click",s);const i=o.querySelector("#qm-body");function l(){i.innerHTML=`
      <p class="client-modal__sub">Create a Client Kickoff Questionnaire link for <strong>${L(t)}</strong>. They fill it out directly in their browser — no account needed. The link expires in 7 days.</p>
      <p class="client-modal__sub"><strong>Nothing is emailed automatically.</strong> You'll get a link to copy and share with your client yourself.</p>
      <p class="client-modal__error" id="qm-error"></p>
      <div class="client-modal__actions">
        <button class="client-modal__btn client-modal__btn--ghost" type="button" data-act="cancel">Cancel</button>
        <button class="client-modal__btn client-modal__btn--primary" type="button" data-act="send"><span class="material-symbols-outlined" aria-hidden="true">link</span> Create link</button>
      </div>`,i.querySelector('[data-act="cancel"]')?.addEventListener("click",s);const p=i.querySelector('[data-act="send"]'),f=i.querySelector("#qm-error");p?.addEventListener("click",async()=>{p.disabled=!0;const d=p.innerHTML;p.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Sending…';try{const v=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e})}),y=await v.json().catch(()=>({}));if(!v.ok||!y.ok)throw new Error(y.error||y.message||`Failed (HTTP ${v.status})`);dt("Questionnaire link created","success"),c({url:y.data.url,token_expiry:y.data.expires})}catch(v){f.textContent=v.message||"Something went wrong. Please try again.",p.disabled=!1,p.innerHTML=d}})}function c(p){i.innerHTML=`
      <div class="qm-status" data-status="DRAFT"><span class="material-symbols-outlined" aria-hidden="true">hourglass_top</span> Link created — not yet submitted${p.token_expiry?`, expires ${L(Aa(p.token_expiry))}`:""}</div>
      <p class="client-modal__hint"><strong>Nothing was sent automatically.</strong> Copy this link and share it with your client however you like — email, text, chat:</p>
      <div class="client-modal__linkrow">
        <input class="client-modal__input" id="qm-link" type="text" readonly value="${L(p.url||"")}" />
        <button class="client-modal__btn client-modal__btn--primary" type="button" id="qm-copy">Copy</button>
      </div>
      <div class="client-modal__actions"><button class="client-modal__btn client-modal__btn--ghost" type="button" data-act="done">Done</button></div>`;const f=i.querySelector("#qm-link");i.querySelector("#qm-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(f.value),i.querySelector("#qm-copy").textContent="Copied!"}catch{f.select()}}),i.querySelector('[data-act="done"]')?.addEventListener("click",s)}function m(p,f){const d=f[p.id];if(p.type==="checkbox_group"){const v=Array.isArray(d)?d:[];return v.length?L(v.join(", ")):""}return d?L(d):""}function h(p,f){const d=f[p.id];if(p.type==="checkbox_group"){const v=Array.isArray(d)?d:[];return`<div class="qm-checkbox-group">${(Array.isArray(p.options)?p.options:[]).map(E=>`
        <label><input type="checkbox" value="${L(E)}" ${v.includes(E)?"checked":""}/> ${L(E)}</label>`).join("")}</div>`}return p.type==="textarea"?`<textarea>${L(d||"")}</textarea>`:`<input type="text" value="${L(d||"")}" />`}function b(p,f=!1){const d=p.questionnaire?.sections||[],v=p.answers||{},y=p.last_edited_tz?`<p class="qm-edited-marker">Last edited by ${L(p.last_edited_by_email||"a team member")} on ${L(Aa(p.last_edited_tz))}</p>`:"";i.innerHTML=`
      <div class="qm-status" data-status="SUBMITTED"><span class="material-symbols-outlined" aria-hidden="true">task_alt</span> Submitted ${p.submitted_tz?L(Aa(p.submitted_tz)):""}</div>
      ${y}
      <form id="qm-form">
        ${d.map(I=>`
          <div class="qm-section">
            <h3>${L(I.title)}</h3>
            ${(I.questions||[]).map(N=>`
              <div class="qm-qa" data-question-id="${L(N.id)}" data-question-type="${L(N.type)}">
                <div class="qm-qa__q">${L(N.label)}</div>
                <div class="qm-qa__a">${f?h(N,v):m(N,v)||'<span class="qm-qa__a--empty">(blank)</span>'}</div>
              </div>`).join("")}
          </div>`).join("")}
      </form>
      <p class="client-modal__error" id="qm-error"></p>
      ...
      </div>`,i.querySelector('[data-act="done"]')?.addEventListener("click",s),i.querySelector('[data-act="cancel-edit"]')?.addEventListener("click",()=>b(p,!1)),i.querySelector('[data-act="edit"]')?.addEventListener("click",()=>b(p,!0));const E=i.querySelector('[data-act="save"]');E?.addEventListener("click",async()=>{const I={};i.querySelectorAll("[data-question-id]").forEach(H=>{const U=H.dataset.questionId;if(H.dataset.questionType==="checkbox_group"){const Z=[...H.querySelectorAll('input[type="checkbox"]:checked')].map(le=>le.value);Z.length&&(I[U]=Z)}else{const Z=(H.querySelector("input,textarea")?.value||"").trim();Z&&(I[U]=Z)}}),E.disabled=!0;const N=E.innerHTML;E.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const H=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(p.guid)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({answers:I})}),U=await H.json().catch(()=>({}));if(!H.ok||!U.ok)throw new Error(U.error||U.message||`Failed (HTTP ${H.status})`);dt("Answers updated","success");const Z=await(await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(p.guid)}`)).json().catch(()=>({}));b(Z.ok?Z.data:{...p,answers:I},!1)}catch(H){i.querySelector("#qm-error").textContent=H.message||"Something went wrong. Please try again.",E.disabled=!1,E.innerHTML=N}})}try{const p=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse?owner_guid=${encodeURIComponent(e)}`),f=await p.json().catch(()=>({}));if(!p.ok||!f.ok)throw new Error(f.error||`HTTP ${p.status}`);const d=(f.data||[])[0]||null;if(!d){l();return}if(d.status==="DRAFT"){c(d);return}const v=await fetch(`${a}/m5t/v5/m5mQuestionnaireResponse/${encodeURIComponent(d.guid)}`),y=await v.json().catch(()=>({}));if(!v.ok||!y.ok)throw new Error(y.error||`HTTP ${v.status}`);b(y.data)}catch(p){console.warn("[clients] questionnaire load failed:",p),i.innerHTML=`<p class="client-modal__error">Could not load questionnaire status. ${L(p.message||"")}</p>`}}const Ap={render:ir,init:lr},kp=Object.freeze(Object.defineProperty({__proto__:null,default:Ap,init:lr,render:ir},Symbol.toStringTag,{value:"Module"})),Ao="managed_client";let ko=!1;const Sp={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ue=e=>String(e??"").replace(/[&<>"']/g,t=>Sp[t]),So=(e,t="info")=>{try{u.publish(g.UI_TOAST,{message:e,type:t})}catch{}},Tp=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Cp(){const e=x.getActiveOrg();let t=e&&e.channel!==Ao?e:null;if(!t){const n=x.getMemberships().find(o=>o.channel!==Ao);n&&(t={guid:n.orgGuid,channel:n.channel,memberRole:n.memberRole})}if(!t)return null;const a=x.getMemberships().find(n=>n.orgGuid===t.guid)?.name;return{...t,name:a}}function $p(e){return Object.values(xt).filter(t=>si(e,t.value)).sort((t,a)=>a.rank-t.rank)}function Ip(){if(ko)return;const e=document.createElement("style");e.id="m5t-team-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ko=!0}function ia(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Lp(e){const t=e.member_role||"member";return`
    <div class="team-row">
      <span class="team-avatar">${ue(Tp(e.name||e.email))}</span>
      ...
      <span class="team-role" data-role="${ue(t)}">${ue(xt[t]?.label||t)}</span>
    </div>`}function dr(){return Ip(),`
    <div class="page-shell" data-section="team">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="team-body">
          ${ia("hourglass_empty","Loading team…")}
        </div>
      </div>
    </div>`}async function pr(){const e=Cp(),t=document.getElementById("team-invite-btn");if(!e){t&&(t.style.display="none"),document.getElementById("team-body").innerHTML=ia("info","Team management is available for agency and workspace accounts.");return}t?.addEventListener("click",()=>Rp(e)),await mn(e)}async function mn(e){const t=document.getElementById("team-body"),a=document.getElementById("team-count");if(t)try{const n=x.getConfig?.().BASE_URL||"",[o,s]=await Promise.all([fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/members`),fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/invites`)]),[r,i]=await Promise.all([o.json().catch(()=>({})),s.json().catch(()=>({}))]);if(!o.ok||!s.ok)throw new Error(`Failed to load team (members: ${o.status}, invites: ${s.status})`);const l=r.members||[],c=i.invites||[],m=c.length?`
    ...
    <div class="team-modal__body" id="team-invite-body">
      ...
      <div class="team-modal__actions">
        ...
        </div>`;const v=n.querySelector("#tm-link");n.querySelector("#tm-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(v.value),n.querySelector("#tm-copy").textContent="Copied!"}catch{v.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",()=>{o(),mn(e)})}catch(p){console.warn("[team] invite failed:",p),r.textContent=p.message||"Something went wrong. Please try again.",i.disabled=!1,i.innerHTML=b}})}const Np={render:dr,init:pr},Op=Object.freeze(Object.defineProperty({__proto__:null,default:Np,init:pr,loadTeam:mn,render:dr},Symbol.toStringTag,{value:"Module"}));
