(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const fs="modulepreload",vs=function(e){return"/"+e},Ga={},ee=function(t,a,n){let o=Promise.resolve();if(a&&a.length>0){let l=function(c){return Promise.all(c.map(g=>Promise.resolve(g).then(b=>({status:"fulfilled",value:b}),b=>({status:"rejected",reason:b}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),i=r?.nonce||r?.getAttribute("nonce");o=l(a.map(c=>{if(c=vs(c),c in Ga)return;Ga[c]=!0;const g=c.endsWith(".css"),b=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${b}`))return;const y=document.createElement("link");if(y.rel=g?"stylesheet":fs,g||(y.as="script"),y.crossOrigin="",y.href=c,i&&y.setAttribute("nonce",i),document.head.appendChild(y),g)return new Promise((_,w)=>{y.addEventListener("load",_),y.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${c}`)))})}))}function s(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return o.then(r=>{for(const i of r||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})};var _s=/([:*])(\w+)/g,bs="([^/]+)",ys=/\*/g,ws="?(?:.*)",xs=/\/\?/g,Es="/?([^/]+|)",Ss="(?:/^|^)",As="";function Yn(e){return e===void 0&&(e="/"),ka()?location.pathname+location.search+location.hash:e}function W(e){return e.replace(/\/+$/,"").replace(/^\/+/,"")}function Rt(e){return typeof e=="string"}function ks(e){return typeof e=="function"}function Mt(e){return e&&e.indexOf("#")>=0&&e.split("#").pop()||""}function Ts(e,t){return t.length===0||!e?null:e.slice(1,e.length).reduce(function(a,n,o){return a===null&&(a={}),a[t[o]]=decodeURIComponent(n),a},null)}function Ft(e){var t=W(e).split(/\?(.*)?$/);return[W(t[0]),t.slice(1).join("")]}function Aa(e){for(var t={},a=e.split("&"),n=0;n<a.length;n++){var o=a[n].split("=");if(o[0]!==""){var s=decodeURIComponent(o[0]);t[s]?(Array.isArray(t[s])||(t[s]=[t[s]]),t[s].push(decodeURIComponent(o[1]||""))):t[s]=decodeURIComponent(o[1]||"")}}return t}function Jn(e,t){var a=Ft(W(e.currentLocationPath)),n=a[0],o=a[1],s=o===""?null:Aa(o),r=[],i;if(Rt(t.path)){if(i=Ss+W(t.path).replace(_s,function(b,y,_){return r.push(_),bs}).replace(ys,ws).replace(xs,Es)+"$",W(t.path)===""&&W(n)==="")return{url:n,queryString:o,hashString:Mt(e.to),route:t,data:null,params:s}}else i=t.path;var l=new RegExp(i,As),c=n.match(l);if(c){var g=Rt(t.path)?Ts(c,r):c.groups?c.groups:c.slice(1);return{url:W(n.replace(new RegExp("^"+e.instance.root),"")),queryString:o,hashString:Mt(e.to),route:t,data:g,params:s}}return!1}function Kn(){return!!(typeof window<"u"&&window.history&&window.history.pushState)}function Je(e,t){return typeof e[t]>"u"||e[t]===!0}function Cs(e){if(!e)return{};var t=e.split(","),a={},n;return t.forEach(function(o){var s=o.split(":").map(function(r){return r.replace(/(^ +| +$)/g,"")});switch(s[0]){case"historyAPIMethod":a.historyAPIMethod=s[1];break;case"resolveOptionsStrategy":n||(n={}),n.strategy=s[1];break;case"resolveOptionsHash":n||(n={}),n.hash=s[1]==="true";break;case"updateBrowserURL":case"callHandler":case"updateState":case"force":a[s[0]]=s[1]==="true";break}}),n&&(a.resolveOptions=n),a}function ka(){return typeof window<"u"}function Is(e,t){return e===void 0&&(e=[]),t===void 0&&(t={}),e.filter(function(a){return a}).forEach(function(a){["before","after","already","leave"].forEach(function(n){a[n]&&(t[n]||(t[n]=[]),t[n].push(a[n]))})}),t}function ke(e,t,a){var n=t||{},o=0;(function s(){if(!e[o]){a&&a(n);return}Array.isArray(e[o])?(e.splice.apply(e,[o,1].concat(e[o][0](n)?e[o][1]:e[o][2])),s()):e[o](n,function(r){typeof r>"u"||r===!0?(o+=1,s()):a&&a(n)})})()}ke.if=function(e,t,a){return Array.isArray(t)||(t=[t]),Array.isArray(a)||(a=[a]),[e,t,a]};function qa(e,t){typeof e.currentLocationPath>"u"&&(e.currentLocationPath=e.to=Yn(e.instance.root)),e.currentLocationPath=e.instance._checkForAHash(e.currentLocationPath),t()}function ta(e,t){for(var a=0;a<e.instance.routes.length;a++){var n=e.instance.routes[a],o=Jn(e,n);if(o&&(e.matches||(e.matches=[]),e.matches.push(o),e.resolveOptions.strategy==="ONE")){t();return}}t()}function $s(e,t){e.navigateOptions&&(typeof e.navigateOptions.shouldResolve<"u"&&console.warn('"shouldResolve" is deprecated. Please check the documentation.'),typeof e.navigateOptions.silent<"u"&&console.warn('"silent" is deprecated. Please check the documentation.')),t()}function Ls(e,t){e.navigateOptions.force===!0?(e.instance._setCurrent([e.instance._pathToMatchObject(e.to)]),t(!1)):t()}var Va=ka(),Ns=Kn();function Os(e,t){if(Je(e.navigateOptions,"updateBrowserURL")){var a=("/"+e.to).replace(/\/\//g,"/"),n=Va&&e.resolveOptions&&e.resolveOptions.hash===!0;Ns?(history[e.navigateOptions.historyAPIMethod||"pushState"](e.navigateOptions.stateObj||{},e.navigateOptions.title||"",n?"#"+a:a),location&&location.hash&&(e.instance.__freezeListening=!0,setTimeout(function(){if(!n){var o=location.hash;location.hash="",location.hash=o}e.instance.__freezeListening=!1},1))):Va&&(window.location.href=e.to)}t()}function Xn(e,t){var a=e.instance;if(!a.lastResolved()){t();return}ke(a.lastResolved().map(function(n){return function(o,s){if(!n.route.hooks||!n.route.hooks.leave){s();return}var r=!1,i=e.instance.matchLocation(n.route.path,e.currentLocationPath,!1);if(n.route.path!=="*")r=!i;else{var l=e.matches?e.matches.find(function(c){return n.route.path===c.route.path}):!1;r=!l}if(Je(e.navigateOptions,"callHooks")&&r){ke(n.route.hooks.leave.map(function(c){return function(g,b){return c(function(y){y===!1?e.instance.__markAsClean(e):b()},e.matches&&e.matches.length>0?e.matches.length===1?e.matches[0]:e.matches:void 0)}}).concat([function(){return s()}]));return}else s()}}),{},function(){return t()})}function Rs(e,t){e.match.route.hooks&&e.match.route.hooks.before&&Je(e.navigateOptions,"callHooks")?ke(e.match.route.hooks.before.map(function(a){return function(o,s){return a(function(r){r===!1?e.instance.__markAsClean(e):s()},e.match)}}).concat([function(){return t()}])):t()}function Ms(e,t){Je(e.navigateOptions,"callHandler")&&e.match.route.handler(e.match),e.instance.updatePageLinks(),t()}function Fs(e,t){e.match.route.hooks&&e.match.route.hooks.after&&Je(e.navigateOptions,"callHooks")&&e.match.route.hooks.after.forEach(function(a){return a(e.match)}),t()}function Ps(e,t){var a=e.instance.lastResolved();if(a&&a[0]&&a[0].route===e.match.route&&a[0].url===e.match.url&&a[0].queryString===e.match.queryString){a.forEach(function(n){n.route.hooks&&n.route.hooks.already&&Je(e.navigateOptions,"callHooks")&&n.route.hooks.already.forEach(function(o){return o(e.match)})}),t(!1);return}t()}function Ds(e,t){var a=e.instance._notFoundRoute;if(a){e.notFoundHandled=!0;var n=Ft(e.currentLocationPath),o=n[0],s=n[1],r=Mt(e.to);a.path=W(o);var i={url:a.path,queryString:s,hashString:r,data:null,route:a,params:s!==""?Aa(s):null};e.matches=[i],e.match=i}t()}function Bs(e,t){(!e.resolveOptions||e.resolveOptions.noMatchWarning===!1||typeof e.resolveOptions.noMatchWarning>"u")&&console.warn('Navigo: "'+e.currentLocationPath+`" didn't match any of the registered routes.`),t()}function Us(e,t){e.instance._setCurrent(null),t()}function Qn(e,t){Je(e.navigateOptions,"updateState")&&e.instance._setCurrent(e.matches),t()}var Zn=[Ps,Rs,Ms,Fs],ja=[Xn,Ds,ke.if(function(e){var t=e.notFoundHandled;return t},Zn.concat([Qn]),[Bs,Us])];function ca(){return ca=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},ca.apply(this,arguments)}function Wa(e,t){var a=0;function n(){if(a===e.matches.length){Qn(e,t);return}ke(Zn,ca({},e,{match:e.matches[a]}),function(){a+=1,n()})}Xn(e,n)}function aa(e){e.instance.__markAsClean(e)}function da(){return da=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},da.apply(this,arguments)}var Ya="[data-navigo]";function Hs(e,t){var a=t||{strategy:"ONE",hash:!1,noMatchWarning:!1,linksSelector:Ya},n=this,o="/",s=null,r=[],i=!1,l,c=Kn(),g=ka();e?o=W(e):console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');function b(m){return m.indexOf("#")>=0&&(a.hash===!0?m=m.split("#")[1]||"/":m=m.split("#")[0]),m}function y(m){return W(o+"/"+W(m))}function _(m,E,$,U){return m=Rt(m)?y(m):m,{name:U||W(String(m)),path:m,handler:E,hooks:Is($)}}function w(m,E,$){var U=this;return typeof m=="object"&&!(m instanceof RegExp)?(Object.keys(m).forEach(function(M){if(typeof m[M]=="function")U.on(M,m[M]);else{var be=m[M],He=be.uses,S=be.as,P=be.hooks;r.push(_(M,He,[l,P],S))}}),this):(typeof m=="function"&&($=E,E=m,m=o),r.push(_(m,E,[l,$])),this)}function d(m,E){if(n.__dirty){n.__waiting.push(function(){return n.resolve(m,E)});return}else n.__dirty=!0;m=m?W(o)+"/"+W(m):void 0;var $={instance:n,to:m,currentLocationPath:m,navigateOptions:{},resolveOptions:da({},a,E)};return ke([qa,ta,ke.if(function(U){var M=U.matches;return M&&M.length>0},Wa,ja)],$,aa),$.matches?$.matches:!1}function h(m,E){if(n.__dirty){n.__waiting.push(function(){return n.navigate(m,E)});return}else n.__dirty=!0;m=W(o)+"/"+W(m);var $={instance:n,to:m,navigateOptions:E||{},resolveOptions:E&&E.resolveOptions?E.resolveOptions:a,currentLocationPath:b(m)};ke([$s,Ls,ta,ke.if(function(U){var M=U.matches;return M&&M.length>0},Wa,ja),Os,aa],$,aa)}function v(m,E,$){var U=Ce(m,E);return U!==null?(h(U.replace(new RegExp("^/?"+o),""),$),!0):!1}function k(m){return this.routes=r=r.filter(function(E){return Rt(m)?W(E.path)!==W(m):ks(m)?m!==E.handler:String(E.path)!==String(m)}),this}function N(){c&&(this.__popstateListener=function(){n.__freezeListening||d()},window.addEventListener("popstate",this.__popstateListener))}function B(){this.routes=r=[],c&&window.removeEventListener("popstate",this.__popstateListener),this.destroyed=i=!0}function ae(m,E){return n._notFoundRoute=_("*",m,[l,E],"__NOT_FOUND__"),this}function Y(){if(g)return le().forEach(function(m){if(m.getAttribute("data-navigo")==="false"||m.getAttribute("target")==="_blank"){m.hasListenerAttached&&m.removeEventListener("click",m.navigoHandler);return}m.hasListenerAttached||(m.hasListenerAttached=!0,m.navigoHandler=function(E){if((E.ctrlKey||E.metaKey)&&E.target.tagName.toLowerCase()==="a")return!1;var $=m.getAttribute("href");if(typeof $>"u"||$===null)return!1;if($.match(/^(http|https)/)&&typeof URL<"u")try{var U=new URL($);$=U.pathname+U.search}catch{}var M=Cs(m.getAttribute("data-navigo-options"));i||(E.preventDefault(),E.stopPropagation(),n.navigate(W($),M))},m.addEventListener("click",m.navigoHandler))}),n}function le(){return g?[].slice.call(document.querySelectorAll(a.linksSelector||Ya)):[]}function we(m){return"/"+o+"/"+W(m)}function ce(m){return l=m,this}function Re(){return s}function Ce(m,E,$){var U=r.find(function(He){return He.name===m}),M=null;if(U){if(M=U.path,E)for(var be in E)M=M.replace(":"+be,E[be]);M=M.match(/^\//)?M:"/"+M}return M&&$&&!$.includeRoot&&(M=M.replace(new RegExp("^/"+o),"")),M}function O(m){return m.getAttribute("href")}function I(m){var E=Ft(W(m)),$=E[0],U=E[1],M=U===""?null:Aa(U),be=Mt(m),He=_($,function(){},[l],$);return{url:$,queryString:U,hashString:be,route:He,data:null,params:M}}function V(){return I(W(Yn(o)).replace(new RegExp("^"+o),""))}function Ie(m){var E={instance:n,currentLocationPath:m,to:m,resolveOptions:a};return ta(E,function(){}),E.matches?E.matches:!1}function wt(m,E,$){typeof E<"u"&&(typeof $>"u"||$)&&(E=y(E));var U={instance:n,to:E,currentLocationPath:E};qa(U,function(){}),typeof m=="string"&&(m=typeof $>"u"||$?y(m):m);var M=Jn(U,{name:String(m),path:m,handler:function(){},hooks:{}});return M||!1}function Ue(m,E,$){return typeof E=="string"&&(E=lt(E)),E?(E.hooks[m]||(E.hooks[m]=[]),E.hooks[m].push($),function(){E.hooks[m]=E.hooks[m].filter(function(U){return U!==$})}):(console.warn("Route doesn't exists: "+E),function(){})}function lt(m){return typeof m=="string"?r.find(function(E){return E.name===y(m)}):r.find(function(E){return E.handler===m})}function Zt(m){m.instance.__dirty=!1,m.instance.__waiting.length>0&&m.instance.__waiting.shift()()}this.root=o,this.routes=r,this.destroyed=i,this.current=s,this.__freezeListening=!1,this.__waiting=[],this.__dirty=!1,this.__markAsClean=Zt,this.on=w,this.off=k,this.resolve=d,this.navigate=h,this.navigateByName=v,this.destroy=B,this.notFound=ae,this.updatePageLinks=Y,this.link=we,this.hooks=ce,this.extractGETParameters=function(m){return Ft(b(m))},this.lastResolved=Re,this.generate=Ce,this.getLinkPath=O,this.match=Ie,this.matchLocation=wt,this.getCurrentLocation=V,this.addBeforeHook=Ue.bind(this,"before"),this.addAfterHook=Ue.bind(this,"after"),this.addAlreadyHook=Ue.bind(this,"already"),this.addLeaveHook=Ue.bind(this,"leave"),this.getRoute=lt,this._pathToMatchObject=I,this._clean=W,this._checkForAHash=b,this._setCurrent=function(m){return s=n.current=m},N.call(this),Y.call(this)}var zs=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Gs(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var mt={exports:{}},qs=mt.exports,Ja;function Vs(){return Ja||(Ja=1,(function(e,t){(function(a,n){var o={};a.PubSub?(o=a.PubSub,console.warn("PubSub already loaded, using existing version")):(a.PubSub=o,n(o)),e!==void 0&&e.exports&&(t=e.exports=o),t.PubSub=o,e.exports=t=o})(typeof window=="object"&&window||qs||zs,function(a){var n={},o=-1,s="*";function r(d){var h;for(h in d)if(Object.prototype.hasOwnProperty.call(d,h))return!0;return!1}function i(d){return function(){throw d}}function l(d,h,v){try{d(h,v)}catch(k){setTimeout(i(k),0)}}function c(d,h,v){d(h,v)}function g(d,h,v,k){var N=n[h],B=k?c:l,ae;if(Object.prototype.hasOwnProperty.call(n,h))for(ae in N)Object.prototype.hasOwnProperty.call(N,ae)&&B(N[ae],d,v)}function b(d,h,v){return function(){var N=String(d),B=N.lastIndexOf(".");for(g(d,d,h,v);B!==-1;)N=N.substr(0,B),B=N.lastIndexOf("."),g(d,N,h,v);g(d,s,h,v)}}function y(d){var h=String(d),v=!!(Object.prototype.hasOwnProperty.call(n,h)&&r(n[h]));return v}function _(d){for(var h=String(d),v=y(h)||y(s),k=h.lastIndexOf(".");!v&&k!==-1;)h=h.substr(0,k),k=h.lastIndexOf("."),v=y(h);return v}function w(d,h,v,k){d=typeof d=="symbol"?d.toString():d;var N=b(d,h,k),B=_(d);return B?(v===!0?N():setTimeout(N,0),!0):!1}a.publish=function(d,h){return w(d,h,!1,a.immediateExceptions)},a.publishSync=function(d,h){return w(d,h,!0,a.immediateExceptions)},a.subscribe=function(d,h){if(typeof h!="function")return!1;d=typeof d=="symbol"?d.toString():d,Object.prototype.hasOwnProperty.call(n,d)||(n[d]={});var v="uid_"+String(++o);return n[d][v]=h,v},a.subscribeAll=function(d){return a.subscribe(s,d)},a.subscribeOnce=function(d,h){var v=a.subscribe(d,function(){a.unsubscribe(v),h.apply(this,arguments)});return a},a.clearAllSubscriptions=function(){n={}},a.clearSubscriptions=function(h){var v;for(v in n)Object.prototype.hasOwnProperty.call(n,v)&&v.indexOf(h)===0&&delete n[v]},a.countSubscriptions=function(h){var v,k,N=0;for(v in n)if(Object.prototype.hasOwnProperty.call(n,v)&&v.indexOf(h)===0){for(k in n[v])N++;break}return N},a.getSubscriptions=function(h){var v,k=[];for(v in n)Object.prototype.hasOwnProperty.call(n,v)&&v.indexOf(h)===0&&k.push(v);return k},a.unsubscribe=function(d){var h=function(we){var ce;for(ce in n)if(Object.prototype.hasOwnProperty.call(n,ce)&&ce.indexOf(we)===0)return!0;return!1},v=typeof d=="string"&&(Object.prototype.hasOwnProperty.call(n,d)||h(d)),k=!v&&typeof d=="string",N=typeof d=="function",B=!1,ae,Y,le;if(v){a.clearSubscriptions(d);return}for(ae in n)if(Object.prototype.hasOwnProperty.call(n,ae)){if(Y=n[ae],k&&Y[d]){delete Y[d],B=d;break}if(N)for(le in Y)Object.prototype.hasOwnProperty.call(Y,le)&&Y[le]===d&&(delete Y[le],B=!0)}return B}})})(mt,mt.exports)),mt.exports}var js=Vs();const p=Gs(js),u=Object.freeze({APP:"APP",APP_READY:"APP.READY",APP_ERROR:"APP.ERROR",APP_SIGNOUT:"APP.SIGNOUT",APP_AUTH:"APP.AUTH",APP_USER_LOADED:"APP.USER.LOADED",ROUTE_NAV:"ROUTE.NAV.GO",ROUTE_NAV_BEFORE:"ROUTE.NAV.BEFORE",ROUTE_NAV_AFTER:"ROUTE.NAV.AFTER",ROUTE_NAV_ERROR:"ROUTE.NAV.ERROR",AUTH_SIGNIN:"AUTH.SIGNIN.GO",AUTH_SIGNIN_SUCCESS:"AUTH.SIGNIN.SUCCESS",AUTH_SIGNIN_FAIL:"AUTH.SIGNIN.FAIL",AUTH_SIGNUP:"AUTH.SIGNUP.GO",AUTH_SIGNUP_SUCCESS:"AUTH.SIGNUP.SUCCESS",AUTH_SIGNUP_FAIL:"AUTH.SIGNUP.FAIL",AUTH_VERIFY_LINK:"AUTH.VERIFY.LINK",AUTH_SIGNOUT:"AUTH.SIGNOUT.GO",AUTH_SIGNOUT_SUCCESS:"AUTH.SIGNOUT.SUCCESS",AUTH_FORGOT:"AUTH.FORGOT.GO",AUTH_FORGOT_SUCCESS:"AUTH.FORGOT.SUCCESS",AUTH_RESETHASH:"AUTH.RESETHASH.GO",AUTH_RESETHASH_SUCCESS:"AUTH.RESETHASH.SUCCESS",AUTH_RESETHASH_NAV:"AUTH.RESETHASH.NAV",AUTH_TOKEN_EXPIRED:"AUTH.TOKEN.EXPIRED",AUTH_TOKEN_INVALID:"AUTH.TOKEN.INVALID",AUTH_SCOPE_LOADED:"AUTH.SCOPE.LOADED",M5T_PRIMARY_NAV:"M5T_PRIMARY_NAV",M5T_PRIMARY_NAV_LOGO_TAP:"M5T_PRIMARY_NAV.LOGO_TAP",M5T_PRIMARY_NAV_HOVER:"M5T_PRIMARY_NAV.HOVER",M5T_PRIMARY_NAV_TAP:"M5T_PRIMARY_NAV.TAP",M5T_PRIMARY_NAV_DOUBLE_TAP:"M5T_PRIMARY_NAV.DOUBLE_TAP",M5T_PRIMARY_NAV_LONG_TAP:"M5T_PRIMARY_NAV.LONG_TAP",M5T_SIDE_NAV:"M5T_SIDE_NAV",M5T_SIDE_NAV_TAP:"M5T_SIDE_NAV.TAP",M5T_SIDE_NAV_COLLAPSE:"M5T_SIDE_NAV.COLLAPSE",M5T_SIDE_NAV_LOGO_TAP:"M5T_SIDE_NAV.LOGO_TAP",M5T_SIDE_NAV_ORG_SWITCH:"M5T_SIDE_NAV.ORG_SWITCH",M5T_SIDE_NAV_FOOTER_ACTION:"M5T_SIDE_NAV.FOOTER_ACTION",UI_LOADING_START:"UI.LOADING.START",UI_LOADING_END:"UI.LOADING.END",UI_TOAST:"UI.TOAST",UI_MODAL_OPEN:"UI.MODAL.OPEN",UI_MODAL_CLOSE:"UI.MODAL.CLOSE",UI_WELCOME_BACK_CLICKED:"UI.WELCOME_BACK_CLICKED",DATA_REFRESH:"DATA.REFRESH",DATA_UPDATE:"DATA.UPDATE",DATA_ERROR:"DATA.ERROR",I18N:"I18N",I18N_SET_LANG:"I18N.SET_LANG",CONVERSATION:"CONVERSATION",CONVERSATION_PROMPT:"CONVERSATION.PROMPT",CONVERSATION_PROMPT_AGENT_CANVAS:"CONVERSATION.PROMPT.AGENT_CANVAS",CONVERSATION_PROMPT_AGENT:"CONVERSATION.PROMPT.AGENT",CONVERSATION_PROMPT_CANVAS:"CONVERSATION.PROMPT.CANVAS",CONVERSATION_PROMPT_STAGE:"CONVERSATION.PROMPT.STAGE",CONVERSATION_RESPONSE:"CONVERSATION.RESPONSE",CONVERSATION_RESPONSE_CANVAS:"CONVERSATION.RESPONSE.CANVAS",CONVERSATION_RESPONSE_WORKFLOW:"CONVERSATION.RESPONSE.WORKFLOW",CANVAS:"CANVAS",CANVAS_DO_SCROLL:"CANVAS.DO.SCROLL",MESSAGE:"MESSAGE",MESSAGE_CREATE:"MESSAGE.CREATE",MESSAGE_CREATED:"MESSAGE.CREATED",MESSAGE_EDIT:"MESSAGE.EDIT",MESSAGE_UPDATED:"MESSAGE.UPDATED",MESSAGE_DELETE:"MESSAGE.DELETE",MESSAGE_DELETED:"MESSAGE.DELETED",MESSAGE_REFRESH:"MESSAGE.REFRESH"}),na={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_API_BASE_URL:"https://machfivemagnet-saas.onrender.com"};var oa={};const H=Object.freeze({FF_SSE_LS_SESSION_USER:"mvv_session_user",FF_SSE_LS_TOKEN:"mvv",FF_SSE_LS_USER_PREFS:"mvv_user_prefs",FF_SSE_LS_THEME:"mvv_theme",FF_SSE_LS_LAST_ROUTE:"mvv_last_route",FF_SSE_API_DEBUG_LOGGING:!1,FF_SSE_API_TIMEOUT:3e4,FF_SSE_API_MAX_RETRIES:3,FF_SSE_API_CACHE_ENABLED:!0,FF_SSE_AUTH_TOKEN_EXPIRY_HOURS:6,FF_SSE_AUTH_AUTO_REFRESH:!1,FF_SSE_AUTH_SESSION_WARNING_MINUTES:5,FF_SSE_AUTH_REMEMBER_ME:!0,FF_SSE_AUTH_MAX_LOGIN_ATTEMPTS:5,FF_SSE_UI_TOAST_ENABLED:!0,FF_SSE_UI_TOAST_DURATION:5e3,FF_SSE_UI_LOADING_SPINNERS:!0,FF_SSE_UI_DARK_MODE:!1,FF_SSE_UI_ANIMATIONS:!0,FF_SSE_FEATURE_SIGNUP_ENABLED:!0,FF_SSE_FEATURE_PASSWORD_RESET_ENABLED:!0,FF_SSE_FEATURE_EMAIL_VERIFICATION_ENABLED:!0,FF_SSE_FEATURE_PROFILE_EDIT_ENABLED:!0,FF_SSE_FEATURE_ANALYTICS_ENABLED:!1,FF_SSE_CACHE_TTL_MS:3e5,FF_SSE_COMPRESSION_ENABLED:!0,FF_SSE_MAX_PAYLOAD_SIZE_MB:50,FF_SSE_DEBUG_VERBOSE:!1,FF_SSE_DEBUG_REDUX_DEVTOOLS:!1,FF_SSE_DEBUG_PERFORMANCE:!1,FF_SSE_DEBUG_BYPASS_AUTH:!1,FF_CLIENT_AUTH_PING_MS:144e4,FF_CLIENT_CAROUSEL_ID:"main_carousel_nav",FF_CLIENT_LS_SESSION_ENTITY:"sse_entity",FF_CLIENT_LS_DEEP_LINK:"sse_deeplink",FF_CLIENT_ROUTE_SIGNIN:"signin_route",FF_CLIENT_ROUTE_SIGNUP:"signup_route",FF_CLIENT_ROUTE_HOME:"home_route",FF_CLIENT_ROUTE_RESET_HASH:"resethash_route",FF_CLIENT_ROUTE_RESET_FORGOT:"resetforgot_route",FF_CLIENT_ROUTE_SIGNOUT:"signout_route",FF_CLIENT_ROUTE_ERROR:"error_route",FF_CLIENT_ROUTE_VERF_LINK:"verf_link_route",FF_CLIENT_ROUTE_OFFLINE:"offline_route",FF_CLIENT_PROTECTED_ROUTES:["home_route","resethash_route","signout_route","user_management_route"],FF_CLIENT_ENDPOINT_SIGNIN:"/m5t/v5/acctEntity/signin",FF_CLIENT_ENDPOINT_SIGNOUT:"/m5t/v5/acctEntity/signout",FF_CLIENT_ENDPOINT_SIGNUP:"/m5t/v5/acctEntity/",FF_CLIENT_ENDPOINT_RESET_HASH:"/m5t/v5/acctEntity/resetHash",FF_CLIENT_ENDPOINT_RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",FF_CLIENT_ENDPOINT_PING:"/ping",FF_CLIENT_ENDPOINT_METER:"/m5t/v5/coreMeter/",FF_CLIENT_METER_DEEP_LINK:"deep_link_access",FF_CLIENT_METER_SIGNOUT_CLIENT:"signout_client_initiated",FF_CLIENT_METER_SIGNOUT_SERVER:"signout_server_initiated",FF_CLIENT_METER_PING_SUCCESS:"ping_auth_success",FF_CLIENT_METER_PING_FAILURE:"ping_auth_failure",FF_SSE_I18N_BUILD_MODE:"LOCAL",FF_SSE_I18N_PRODUCT:"SSE",FF_SSE_I18N_WHITELABEL:"M5T",FF_SSE_I18N_LANG:"en",FF_SSE_I18N_APPLY_DELAY_MS:100,FF_SSE_I18N_DEBUG:!1,FF_SSE_LS_USER_LANG:"mvv_user_lang",FF_SSE_LS_WHITELABEL:"mvv_whitelabel",FF_API_RATELIMIT_SIGNIN_ENFORCE:!1,FF_API_RATELIMIT_SIGNIN_IP_LIMIT:20,FF_API_RATELIMIT_SIGNIN_EMAIL_LIMIT:10,FF_API_RATELIMIT_FORGOT_ENFORCE:!1,FF_API_RATELIMIT_FORGOT_IP_LIMIT:15,FF_API_RATELIMIT_FORGOT_EMAIL_LIMIT:5,FF_API_RATELIMIT_CAPTURE_ENFORCE:!1,FF_API_RATELIMIT_CAPTURE_LIMIT:30,FF_API_RATELIMIT_EVENT_ENFORCE:!1,FF_API_RATELIMIT_EVENT_LIMIT:600,FF_API_RATELIMIT_AUTHENTICATED_ENFORCE:!1,FF_API_RATELIMIT_AUTHENTICATED_LIMIT:600,FF_API_MAGNET_REQUIRE_ORIGIN_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_ENFORCE:!1,FF_API_RATELIMIT_GLOBAL_LIMIT:2e3});function eo(e,t=null){if(e in H)return H[e];if(typeof process<"u"&&oa&&oa[e]){const a=oa[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}if(typeof import.meta<"u"&&na&&na[e]){const a=na[e];return a==="true"?!0:a==="false"?!1:isNaN(a)?a:Number(a)}return t}function Ws(e){return eo(e,!1)===!0}function Ys(){return{...H}}typeof module<"u"&&module.exports&&(module.exports={FEATURE_FLAGS:H,getFlag:eo,isEnabled:Ws,getAllFlags:Ys});const Ka={success:{border:"var(--color-success, #009473)",bg:"var(--color-success-soft, rgba(0,148,115,0.10))",icon:"check_circle"},danger:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},error:{border:"var(--color-danger, #DD4124)",bg:"var(--color-danger-soft, rgba(221,65,36,0.09))",icon:"error"},warning:{border:"var(--color-warning-ink, #7a5e00)",bg:"var(--color-warning-tint, rgba(245,223,77,0.16))",icon:"warning"},info:{border:"var(--color-info, #7BC4C4)",bg:"var(--color-info-soft, rgba(123,196,196,0.12))",icon:"info"}},Js=4500,pa=220;let Le=null,Xa=!1;function Ks(){if(Xa)return;const e=document.createElement("style");e.id="m5t-toast-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Xa=!0}function Xs(){return Le&&document.body.contains(Le)||(Le=document.createElement("div"),Le.className="m5t-toast-stack",Le.setAttribute("role","status"),Le.setAttribute("aria-live","polite"),document.body.appendChild(Le)),Le}function Qs(e){const t=e&&e.message;if(!t)return;Ks();const a=Ka[e.type]||Ka.info,n=document.createElement("div");n.className="m5t-toast",n.style.borderColor=a.border,n.style.background=a.bg,n.innerHTML=`<span class="material-symbols-outlined" aria-hidden="true" style="color:${a.border}">${a.icon}</span><span class="m5t-toast__msg"></span><button type="button" class="m5t-toast__close" aria-label="Dismiss"><span class="material-symbols-outlined" aria-hidden="true">close</span></button>`,n.querySelector(".m5t-toast__msg").textContent=String(t),Xs().appendChild(n),requestAnimationFrame(()=>n.classList.add("is-in"));let s=!1;const r=()=>{s||(s=!0,clearTimeout(i),n.classList.remove("is-in"),n.classList.add("is-out"),setTimeout(()=>n.remove(),pa))},i=setTimeout(r,Js);n.querySelector(".m5t-toast__close").addEventListener("click",r)}function Zs(){const e=t=>a=>{const n=a.detail?.pubsubTopic;n&&p.publish(n,a.detail)};document.addEventListener("nav-select",e()),document.addEventListener("logo-click",e()),document.addEventListener("nav-hover",e()),document.addEventListener("nav-double-tap",e()),document.addEventListener("nav-long-tap",e()),document.addEventListener("message-sent",e())}function er(){console.log("[AppEvents] Initializing event listeners..."),p.subscribe(u.APP_READY,(a,n)=>{console.log("[AppEvents] APP_READY:",n)}),p.subscribe(u.APP_ERROR,(a,n)=>{console.error("[AppEvents] APP_ERROR:",n)}),p.subscribe(u.APP_SIGNOUT,(a,n)=>{console.log("[AppEvents] APP_SIGNOUT:",n)}),p.subscribe(u.ROUTE_NAV_BEFORE,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_BEFORE:",n),p.publish(u.UI_LOADING_START)}),p.subscribe(u.ROUTE_NAV_AFTER,(a,n)=>{console.log("[AppEvents] ROUTE_NAV_AFTER:",n),p.publish(u.UI_LOADING_END)}),p.subscribe(u.ROUTE_NAV_ERROR,(a,n)=>{console.error("[AppEvents] ROUTE_NAV_ERROR:",n),p.publish(u.APP_ERROR,{message:"Navigation error",details:n})}),p.subscribe(u.AUTH_SIGNIN_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNIN_SUCCESS:",n)}),p.subscribe(u.AUTH_SIGNIN_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNIN_FAIL:",n),p.publish(u.UI_TOAST,{message:n.message||"Sign in failed",type:"danger"})}),p.subscribe(u.AUTH_SIGNUP_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP_SUCCESS:",n),p.publish(u.UI_TOAST,{message:"Account created! Please check your email to verify.",type:"success"}),p.publish(u.AUTH_VERIFY_LINK)}),p.subscribe(u.AUTH_VERIFY_LINK,(a,n)=>{console.log("[AppEvents] AUTH_VERIFY_LINK: Navigating to verf-link route"),window.router&&window.router.navigate("/verf-link")}),p.subscribe(u.AUTH_SIGNUP_FAIL,(a,n)=>{console.error("[AppEvents] AUTH_SIGNUP_FAIL:",n),p.publish(u.UI_TOAST,{message:n.message||"Sign up failed",type:"danger"})}),p.subscribe(u.AUTH_SIGNOUT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT_SUCCESS:",n),p.publish(u.UI_TOAST,{message:"Signed out successfully",type:"info"})}),p.subscribe(u.AUTH_SIGNUP,(a,n)=>{console.log("[AppEvents] AUTH_SIGNUP: Navigating to signup route"),window.router&&window.router.navigate("/signup")}),p.subscribe(u.AUTH_FORGOT,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT: Navigating to forgot route"),window.router&&window.router.navigate("/forgot")}),p.subscribe(u.AUTH_FORGOT_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_FORGOT_SUCCESS:",n),p.publish(u.UI_TOAST,{message:"Password reset email sent!",type:"success"})}),p.subscribe(u.AUTH_RESETHASH_NAV,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_NAV: Navigating to resethash route"),window.router&&window.router.navigate("/resethash")}),p.subscribe(u.AUTH_RESETHASH_SUCCESS,(a,n)=>{console.log("[AppEvents] AUTH_RESETHASH_SUCCESS:",n),p.publish(u.UI_TOAST,{message:"Password reset successfully! Please sign in.",type:"success"})}),p.subscribe(u.AUTH_TOKEN_EXPIRED,(a,n)=>{console.warn("[AppEvents] AUTH_TOKEN_EXPIRED:",n),p.publish(u.UI_TOAST,{message:"Session expired. Please sign in again.",type:"warning"})}),p.subscribe(u.I18N_SET_LANG,(a,n)=>{console.log("[AppEvents] I18N_SET_LANG:",n);const{langCode:o}=n;if(!o){console.error("[AppEvents] No langCode provided in I18N_SET_LANG event");return}if(window.I18nController&&typeof window.I18nController.setLanguage=="function")try{window.I18nController.setLanguage(o),console.log("[AppEvents] Language changed successfully to:",o),p.publish(u.UI_TOAST,{message:`Language changed to ${o}`,type:"success"})}catch(s){console.error("[AppEvents] Error changing language:",s),p.publish(u.UI_TOAST,{message:`Failed to change language: ${s.message}`,type:"danger"})}else console.error("[AppEvents] I18nController not available")}),p.subscribe("CONVERSATION.PROMPT",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.PROMPT.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.PROMPT received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display prompt in canvas:",n.message),sa(n.message,"user",n.timestamp),p.publish(u.CANVAS_DO_SCROLL);break;case"AGENT":console.log("[AppEvents] Agent prompt (no implementation):",n.message);break;case"AGENT_CANVAS":console.log("[AppEvents] Display message in canvas:",n.message),sa(n.message,"user",n.timestamp),p.publish(u.CANVAS_DO_SCROLL);break;case"STAGE":console.log("[AppEvents] Stage prompt for editing:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.PROMPT sub-topic: ${o}`);break}}),p.subscribe("CONVERSATION.RESPONSE",(a,n)=>{const o=a.split(".")[2];if(console.log(`[AppEvents] CONVERSATION.RESPONSE.${o}:`,n),!n||!n.message){console.warn("[AppEvents] CONVERSATION.RESPONSE received without message data");return}switch(o){case"CANVAS":console.log("[AppEvents] Display response in canvas:",n.message),sa(n.message,"assistant",n.timestamp,n.streaming);break;case"WORKFLOW":console.log("[AppEvents] Send response to workflow engine:",n.message);break;default:console.log(`[AppEvents] Unhandled CONVERSATION.RESPONSE sub-topic: ${o}`);break}}),p.subscribe(u.UI_LOADING_START,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.add("active")}),p.subscribe(u.UI_LOADING_END,(a,n)=>{const o=document.getElementById("app-loader");o&&o.classList.remove("active")}),p.subscribe(u.UI_TOAST,(a,n)=>{Qs(n)}),p.subscribe(u.UI_WELCOME_BACK_CLICKED,()=>{console.log("[AppEvents] UI_WELCOME_BACK_CLICKED");const a="0.1",n=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`${a} 8/9/2026, 12:31:45 PM|© ${n} Mach Five Tech`,"night")}),Zs(),p.subscribe("M5T_PRIMARY_NAV",(a,n)=>{const o=a.split(".")[1];switch(o){case"TAP":e(n);break;case"LOGO_TAP":t();break;case"HOVER":break;case"DOUBLE_TAP":break;case"LONG_TAP":break;default:console.log(`[AppEvents] Unhandled M5T_PRIMARY_NAV sub-topic: ${o}`);break}});function e(a){const{token:n,level:o,primaryToken:s}=a;switch(n){case"RESET_PASSWORD":console.log("[AppEvents] Password reset requested"),p.publish(u.AUTH_RESETHASH_NAV);break;case"SIGN_OUT":console.log("[AppEvents] Sign out requested"),window.router&&window.router.navigate("/signout");break;default:console.log(`[AppEvents] Navigation: ${o} -> ${n}`,{primaryToken:s});break}}function t(a){const o=new Date().getFullYear();typeof neodigmToast<"u"&&neodigmToast.q(`0.1 8/9/2026, 12:31:45 PM|© ${o} Mach Five Tech`,"night",5e3)}p.subscribe(u.AUTH_SIGNOUT,(a,n)=>{console.log("[AppEvents] AUTH_SIGNOUT: Clearing session_user from localStorage"),localStorage.removeItem(H.FF_SSE_LS_SESSION_USER)}),console.log("[AppEvents] Event listeners initialized")}function sa(e,t="user",a=null,n=!1){const o=document.getElementById("chat-messages");if(!o){console.warn("[AppEvents] chat-messages element not found - may not be on home route");return}if(a||(a=new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})),n&&t==="assistant"){const r=o.firstElementChild;if(r&&r.tagName.toLowerCase()==="m5t-chat-response"){r.setAttribute("message",e),console.log(`[AppEvents] Updated streaming ${t} bubble (${e.length} chars)`);return}}let s;t==="user"||t==="prompt"?s=document.createElement("m5t-chat-prompt"):s=document.createElement("m5t-chat-response"),s.setAttribute("message",e),s.setAttribute("timestamp",a),o.prepend(s),console.log(`[AppEvents] Added ${t} bubble to canvas (${e.length} chars)`)}function to(e=window.location.search){const t=new URLSearchParams(e||"");return!!(t.get("uid")&&t.get("token"))}const tr=Object.freeze({admin_root_role:{value:100,desc:"Administrator superuser infrastructure architecture"},admin_business_role:{value:90,desc:"Administrator financial oversight"},admin_support_role:{value:80,desc:"Administrator maintenance and configuration"},admin_readonly_role:{value:70,desc:"Administrator information help desk"},client_tier_4_role:{value:40,desc:"Client paid tier 4 - Partner"},client_tier_3_role:{value:30,desc:"Client paid tier 3"},client_tier_2_role:{value:20,desc:"Client paid tier 2"},client_tier_1_role:{value:10,desc:"Client paid tier 1"},client_standard_role:{value:0,desc:"Client free tier 0"}});function ar(e){return tr[e]||null}function nr(e){return e>=50}const ht=Object.freeze({owner:{value:"owner",rank:30,label:"Owner"},admin:{value:"admin",rank:20,label:"Admin"},member:{value:"member",rank:10,label:"Member"},viewer:{value:"viewer",rank:0,label:"Viewer"}}),or=Object.freeze({VIEW_DASHBOARD:"view_dashboard",VIEW_MAGNETS:"view_magnets",PROVISION_MAGNETS:"provision_magnets",MANAGE_MAGNETS:"manage_magnets",VIEW_CONVERSATIONS:"view_conversations",VIEW_STATS:"view_stats",VIEW_AD_METRICS:"view_ad_metrics",CONNECT_AD_ACCOUNTS:"connect_ad_accounts",CREATE_CLIENT_ACCOUNTS:"create_client_accounts",MANAGE_TEAM:"manage_team",VIEW_BILLING:"view_billing",MANAGE_BILLING:"manage_billing"}),T=or,ao=Object.freeze(Object.values(T)),ze=Object.freeze([T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS]),sr=Object.freeze({reseller_org:{owner:ao,admin:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.CREATE_CLIENT_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING],member:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS],viewer:ze},managed_client:{owner:[...ze,T.VIEW_BILLING],admin:[...ze,T.VIEW_BILLING],member:ze,viewer:ze},saas_org:{owner:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING,T.MANAGE_BILLING],admin:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS,T.VIEW_AD_METRICS,T.CONNECT_AD_ACCOUNTS,T.MANAGE_TEAM,T.VIEW_BILLING],member:[T.VIEW_DASHBOARD,T.VIEW_MAGNETS,T.PROVISION_MAGNETS,T.MANAGE_MAGNETS,T.VIEW_CONVERSATIONS,T.VIEW_STATS],viewer:ze}});function rr(e){const t=ar(e);return!!t&&nr(t.value)}function ir({entityClass:e,orgChannel:t,memberRole:a}={}){if(rr(e))return e==="admin_readonly_role"?[...ze,T.VIEW_BILLING]:[...ao];const n=sr[t],o=n&&n[a];return o?[...o]:[]}function lr(e,t){const a=ht[e]?.rank??-1,n=ht[t]?.rank??1/0;return a>=ht.admin.rank&&a>=n}const Ta=[{value:"name",label:"Full name (splits into first + last automatically)"},{value:"first_name",label:"First name"},{value:"last_name",label:"Last name"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"mobile",label:"Mobile phone"},{value:"company",label:"Company"},{value:"title",label:"Job title"},{value:"city",label:"City"},{value:"state",label:"State / province"},{value:"product_interest",label:"Product interest"},{value:"lead_source",label:"Lead source"},{value:"rating",label:"Rating (Hot / Warm / Cold)"},{value:"description",label:"Notes / description"}];new Set(Ta.map(e=>e.value));const Ca=[{value:"single_select",label:"Multiple choice"},{value:"multi_select",label:"Select all"},{value:"scheduler",label:"Scheduler"},{value:"text",label:"Short text"},{value:"email",label:"Email"},{value:"phone",label:"Phone"},{value:"message",label:"Message"}];new Set(Ca.map(e=>e.value));class x{static CONFIG={BASE_URL:"https://machfivemagnet-saas.onrender.com",FF_AUTH_PING_MS:144e4,LS_KEYS:{ENTITY:"sse_session_user",DEEP_LINK:"sse_deeplink",SCOPE:"sse_session_scope",ACTIVE_ORG:"sse_active_org",REMEMBERED_EMAIL:"sse_remembered_email"},ROUTES:{SIGNIN:"signin",SIGNUP:"signup",HOME:"home",RESET_HASH:"resethash",FORGOT:"forgot",SPLASH:"splash"},PROTECTED_ROUTES:["home","resethash"],ENDPOINTS:{SIGNIN:"/m5t/v5/acctEntity/signin",SIGNOUT:"/m5t/v5/acctEntity/signout",SIGNUP:"/m5t/v5/acctEntity/",RESET_HASH:"/m5t/v5/acctEntity/resetHash",RESET_FORGOT:"/m5t/v5/acctEntity/resetforgot",ME:"/m5t/v5/acctEntity/me",PING:"/ping"},METER_CAPTIONS:{DEEP_LINK:"deep_link_access",SIGNOUT_CLIENT:"signout_client_initiated",SIGNOUT_SERVER:"signout_server_initiated",PING_SUCCESS:"ping_auth_success",PING_FAILURE:"ping_auth_failure"}};static#e=!1;static#t=null;static#o=null;static#a=null;static#n=!1;static#s=null;static#i=null;static async init({BASE_URL:t,navigateFunction:a,customConfig:n={}}={}){if(this.#e)return console.warn("[AuthController] Already initialized"),!0;try{if(a&&typeof a=="function")this.#i=a;else throw new Error("navigateFunction is required and must be a function");return t&&(this.CONFIG.BASE_URL=t),n&&Object.keys(n).length>0&&(this.CONFIG={...this.CONFIG,...n}),console.log("[AuthController] Initializing with config:",{BASE_URL:this.CONFIG.BASE_URL,PING_INTERVAL:this.CONFIG.FF_AUTH_PING_MS}),this.#m(),this.#p(),this.#l(),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.#e=!0,console.log("[AuthController] Initialized successfully"),!0}catch(o){return console.error("[AuthController] Initialization failed:",o),!1}}static#p(){if(typeof mvvLegit>"u"||!mvvLegit)throw new Error("mvvLegit is not available. Ensure neodigm55 library is loaded.");mvvLegit.setNavConroller((t=null)=>{if(t){if(to()&&(t==="splash"||t==="signin")){console.log("[AuthController] Ignoring mvvLegit redirect to",t,"— keeping invitee on accept-invite");return}console.log("[AuthController] mvvLegit navigation to:",t),this.#r(t)}}).setOnState((t=null)=>{if(t)switch(console.log("[AuthController] Auth state changed:",t),t){case"AUTH":case 4:this.#_();break;case"UNAUTH":case 1:this.#b();break;case"UNVERF":case 2:this.#y();break}}).init({BASE:this.CONFIG.BASE_URL}),console.log("[AuthController] mvvLegit initialized")}static#r(t){if(!this.#i){console.error("[AuthController] Navigate function not set");return}console.log("[AuthController] #navigate called with:",t);const a=t.replace(/_route$/,"").replace(/_/g,"-");console.log("[AuthController] Navigating to path:",a),this.#i(a)}static#l(){if(window.__m5tActiveOrgFetch)return;const t=window.fetch.bind(window);window.fetch=(a,n)=>{try{const o=typeof a=="string"?a:a?.url||"",s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);if(s&&o.startsWith(this.CONFIG.BASE_URL)){const r=new Headers(n&&n.headers||(a instanceof Request?a.headers:void 0));r.set("X-Active-Org",s),n={...n||{},headers:r}}}catch{}return t(a,n)},window.__m5tActiveOrgFetch=!0,console.log("[AuthController] Active-org fetch header installed")}static#m(){try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ENTITY);t&&(this.#o=JSON.parse(t),console.log("[AuthController] Entity state loaded:",this.#o?.email))}catch(t){console.error("[AuthController] Error loading entity state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),this.#o=null}this.#s=localStorage.getItem(this.CONFIG.LS_KEYS.DEEP_LINK)||null;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.SCOPE);t&&(this.#a=JSON.parse(t),console.log("[AuthController] Scope state loaded (cached):",this.#a?.uiMode))}catch(t){console.error("[AuthController] Error loading scope state:",t),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE),this.#a=null}}static#c(t){try{this.#o=t,localStorage.setItem(this.CONFIG.LS_KEYS.ENTITY,JSON.stringify(t)),console.log("[AuthController] Entity state saved")}catch(a){console.error("[AuthController] Error saving entity state:",a)}}static#d(){this.#o=null,this.#a=null,localStorage.removeItem(this.CONFIG.LS_KEYS.ENTITY),localStorage.removeItem(this.CONFIG.LS_KEYS.SCOPE);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#u)}catch{}}static getEntity(){return this.#o}static#v(t){try{this.#a=t,localStorage.setItem(this.CONFIG.LS_KEYS.SCOPE,JSON.stringify(t))}catch(a){console.error("[AuthController] Error saving scope state:",a)}}static async fetchScope(){if(typeof mvvLegit>"u"||!this.isAuthenticated())return console.log("[AuthController] fetchScope skipped — not authenticated"),this.#a;if(this.#n)return this.#a;this.#n=!0;try{const t=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),a=t?`?org=${encodeURIComponent(t)}`:"",n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.ME}${a}`);if(n.status===401||n.status===403)return console.warn("[AuthController] /me unauthorized — signing out"),this.doSignout(!0),null;if(!n.ok)return console.warn(`[AuthController] /me failed (${n.status}) — using cached scope`),this.#a;const o=await n.json();if(!o?.ok)return console.warn("[AuthController] /me returned not-ok — using cached scope"),this.#a;try{const s=localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG);s&&o.activeOrg?.guid!==s&&(console.warn(`[AuthController] Stored active org not honored by /me${o.activeOrgError?" (activeOrgError)":""} — clearing`),localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG))}catch{}return this.#v(o),p.publish(u.AUTH_SCOPE_LOADED,o),console.log(`[AuthController] Scope loaded: ${o.uiMode} (${o.memberships?.length||0} org(s), ${o.managedClients?.length||0} client(s))`),o}catch(t){return console.error("[AuthController] fetchScope error:",t),this.#a}finally{this.#n=!1}}static async setActiveOrg(t){try{t?localStorage.setItem(this.CONFIG.LS_KEYS.ACTIVE_ORG,t):localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{}return this.fetchScope()}static getScope(){return this.#a}static getCapabilities(){return this.isPreviewingAsClient()?ir({orgChannel:"managed_client",memberRole:"owner"}):this.#a?.capabilities||[]}static getUiMode(){return this.isPreviewingAsClient()?"managed":this.#a?.uiMode||"self_serve"}static getActiveOrg(){return this.#a?.activeOrg||null}static getMemberships(){return this.#a?.memberships||[]}static getManagedClients(){return this.#a?.managedClients||[]}static getStoredActiveOrg(){try{return localStorage.getItem(this.CONFIG.LS_KEYS.ACTIVE_ORG)}catch{return null}}static#u="m5m_preview_as_client";static isPreviewingAsClient(){try{return sessionStorage.getItem(this.#u)==="1"&&!!this.#a?.activeOrg?.viaSubtree}catch{return!1}}static setPreviewAsClient(t){try{t?sessionStorage.setItem(this.#u,"1"):sessionStorage.removeItem(this.#u)}catch{}this.#a&&p.publish(u.AUTH_SCOPE_LOADED,this.#a)}static async doSignin(t,a){try{const n=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNIN}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a})}),o=await n.json();if(n.status===303)return console.warn("[AuthController] Password reset required"),o.accessToken&&(mvvLegit.doSignin(o.accessToken),this.#c(o.entity)),setTimeout(()=>{this.#r(this.CONFIG.ROUTES.RESET_HASH)},1500),{ok:!1,resetRequired:!0,data:o};if(n.ok&&o.accessToken){console.log("[AuthController] Signin successful, calling mvvLegit.doSignin()"),mvvLegit.doSignin(o.accessToken),this.#c(o.entity);try{localStorage.removeItem(this.CONFIG.LS_KEYS.ACTIVE_ORG),sessionStorage.removeItem(this.#u)}catch{}return this.fetchScope(),console.log("[AuthController] Explicitly navigating to home"),this.#r(this.CONFIG.ROUTES.HOME),{ok:!0,data:o}}return{ok:!1,error:o.error||"Sign in failed",data:o}}catch(n){return console.error("[AuthController] Signin error:",n),{ok:!1,error:n.message}}}static async doSignout(t=!1){console.log("[AuthController] doSignout called, serverInitiated:",t);try{const a=mvvLegit.getConf()?.token;if(console.log("[AuthController] Token exists:",!!a),!t&&a){const n=`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNOUT}?token=${encodeURIComponent(a)}`;if(console.log("[AuthController] Sending signout beacon to:",n),navigator.sendBeacon){const o=navigator.sendBeacon(n);console.log("[AuthController] Beacon sent:",o),o||console.warn("[AuthController] Beacon failed - browser may be blocking it")}else console.warn("[AuthController] navigator.sendBeacon not supported, signout not metered")}else a||console.warn("[AuthController] No token found for signout request");console.log("[AuthController] Clearing mvvLegit state..."),mvvLegit.doSignout(),console.log("[AuthController] Setting signout timestamp..."),localStorage.setItem("mvv_ts",Date.now().toString()),console.log("[AuthController] Clearing entity state..."),this.#d(),console.log("[AuthController] Stopping auth ping..."),this.#h(),setTimeout(()=>{console.log("[AuthController] Performing hard refresh..."),typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}catch(a){console.error("[AuthController] Signout error:",a),setTimeout(()=>{typeof neodigmUtils<"u"&&neodigmUtils.hardReload?neodigmUtils.hardReload():window.location.reload()},500)}}static async doSignup(t){try{const a=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.SIGNUP}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await a.json();return a.ok&&n.accessToken?(console.log("[AuthController] Signup successful - user needs to verify email"),this.#c(n.entity),{ok:!0,data:n}):{ok:!1,error:n.error||"Sign up failed",data:n}}catch(a){return console.error("[AuthController] Signup error:",a),{ok:!1,error:a.message}}}static async doResetHash(t,a){try{const n=mvvLegit.getConf()?.token,o=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.RESET_HASH}`,{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({email:t,password:a,modified_by:t})}),s=await o.json();return o.ok&&s.ok?(console.log("[AuthController] Password reset successful"),await this.doSignout(),{ok:!0,data:s}):{ok:!1,error:s.error||"Password reset failed",data:s}}catch(n){return console.error("[AuthController] Reset password error:",n),{ok:!1,error:n.message}}}static#g(){this.#t&&(console.log("[AuthController] Clearing existing ping interval"),clearInterval(this.#t)),this.#t=setInterval(()=>{console.log(`[AuthController] ⏰ Ping interval fired at ${new Date().toLocaleTimeString()}`),this.#f()},this.CONFIG.FF_AUTH_PING_MS),console.log(`[AuthController] Auth ping started (${this.CONFIG.FF_AUTH_PING_MS}ms) - interval ID: ${this.#t}`),console.log(`[AuthController] Next ping scheduled for: ${new Date(Date.now()+this.CONFIG.FF_AUTH_PING_MS).toLocaleTimeString()}`)}static#h(){this.#t&&(clearInterval(this.#t),this.#t=null,console.log("[AuthController] Auth ping stopped"))}static async#f(){try{const t=await fetch(`${this.CONFIG.BASE_URL}${this.CONFIG.ENDPOINTS.PING}`);t.ok?console.log("[AuthController] Ping success"):(t.status===401||t.status===403)&&(console.warn("[AuthController] Auth ping failed - signing out"),this.doSignout(!0))}catch(t){console.error("[AuthController] Ping error:",t)}}static setDeepLinkGuid(t){this.#s=t,localStorage.setItem(this.CONFIG.LS_KEYS.DEEP_LINK,t),console.log("[AuthController] Deep-link GUID stored:",t)}static getDeepLinkGuid(){return this.#s}static clearDeepLink(){this.#s=null,localStorage.removeItem(this.CONFIG.LS_KEYS.DEEP_LINK)}static#_(){console.log("[AuthController] User authenticated"),this.CONFIG.FF_AUTH_PING_MS>0&&this.#g(),this.fetchScope()}static#b(){console.log("[AuthController] User unauthenticated"),this.#h()}static#y(){console.log("[AuthController] User unverified")}static getAuthState(){try{const t=mvvLegit.getConf()?.LSKEY||"mvv",a=localStorage.getItem(t);if(!a)return"UNAUTH";if(typeof LZString>"u")return null;const n=LZString.decompressFromUTF16(a),s=JSON.parse(n)?.state;return s===1?"UNAUTH":s===2?"UNVERF":s===4?"AUTH":s===5?"FORGOT":null}catch{return null}}static isAuthenticated(){return this.getAuthState()==="AUTH"}static getConfig(){return this.CONFIG}static navigateTo(t){this.#r(t)}static isPingActive(){return this.#t!==null}static async triggerPingNow(){console.log("[AuthController] DEBUG: Manually triggering ping..."),await this.#f()}}class C{static#e={LOCAL:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",enter_email_and_password:"Enter email and password",sign_in:"Sign in",forgot_password:"Forgot password?",remember_email:"Remember my email",dont_have_an_account:"START YOUR FREE ACCOUNT",sign_up:"Sign up",please_enter_your_details_to_get_started:"Please enter your details to get started",already_have_an_account:"Already have an account?",log_in:"Log in",name:"Name",enter_your_name:"Enter your name",first_name:"First name",last_name:"Last name",company:"Company",phone:"Phone",confirm_password:"Confirm password",create_account:"Create account",home:"Home",dashboard:"Dashboard",correspondence:"Correspondence",settings:"Settings",sign_out:"Sign out",reset_password:"Reset password",new_password:"New password",confirm_new_password:"Confirm new password",enter_new_password:"Enter new password",enter_company_name:"Enter your company name",enter_phone_number:"Enter your phone number",reenter_password:"Re-enter your password",update_password:"Update password",update_your_password:"Update your account password",are_you_sure_sign_out:"Are you sure you want to sign out?",enter_email_for_reset:"Please enter your email to receive a password reset link",send_reset_link:"Send reset link",remember_password:"Remember your password?",cancel:"Cancel",save:"Save",delete:"Delete",edit:"Edit",loading:"Loading...",error:"Error",success:"Success",refresh:"Refresh",search:"Search",filter:"Filter",sort:"Sort",view:"View",close:"Close",submit:"Submit",back:"Back",next:"Next",previous:"Previous",confirm:"Confirm",yes:"Yes",no:"No",ok:"OK",validation_email_required:"Please enter your email",validation_email_invalid:"Please enter a valid email address",validation_password_required:"Please enter your password",validation_password_min_length:"Password must be at least 10 characters",validation_password_mismatch:"Passwords do not match",validation_first_name_required:"Please enter your first name",validation_last_name_required:"Please enter your last name",validation_new_password_required:"Please enter a new password",success_welcome_back:"Welcome back!",success_password_reset:"Password reset successfully",success_signed_out:"Signed out successfully",success_reset_link_sent:"Password reset link sent!|Please check your email",error_signin_failed:"Sign in failed",error_signup_failed:"Sign up failed",error_network:"Network error - please try again",error_password_reset_required:"Password reset required - redirecting...",loading_signing_in:"SIGNING IN...",loading_creating_account:"Creating account...",loading_resetting_password:"Resetting password...",nav_home:"Home",nav_home_tagline:"Dashboard and overview",nav_home_apps:"My Apps",nav_home_apps_tagline:"Your applications and integrations",nav_home_dash:"Dashboard",nav_home_dash_tagline:"Main dashboard and analytics",nav_engagements:"Engagements",nav_engagements_tagline:"Customer engagement tools and interactions",nav_develop:"Develop",nav_develop_tagline:"Development tools and resources",nav_profile:"Profile",nav_profile_tagline:"Account settings and preferences",nav_engagements_surveys:"Surveys",nav_engagements_surveys_tagline:"Create and manage customer surveys",nav_engagements_thumbs:"Feedback",nav_engagements_thumbs_tagline:"Collect thumbs up/down feedback",nav_engagements_voicemail:"Voicemail",nav_engagements_voicemail_tagline:"Voice message collection",nav_engagements_guidedtours:"Guided Tours",nav_engagements_guidedtours_tagline:"Interactive product tours",nav_engagements_slideshows:"Slideshows",nav_engagements_slideshows_tagline:"Content slideshows and presentations",nav_engagements_abtests:"A/B Tests",nav_engagements_abtests_tagline:"A/B testing campaigns",nav_engagements_questionnaires:"Questionnaires",nav_engagements_questionnaires_tagline:"Detailed questionnaires and forms",nav_develop_documentation:"Documentation",nav_develop_documentation_tagline:"API and product documentation",nav_develop_devtools:"Dev Tools",nav_develop_devtools_tagline:"Developer tools and utilities",nav_develop_kbase:"Knowledge Base",nav_develop_kbase_tagline:"Technical knowledge base and articles",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Hackathon events and challenges",nav_develop_partner:"Partner",nav_develop_partner_tagline:"Partner program and integrations",nav_develop_certification:"Certification",nav_develop_certification_tagline:"Developer certification programs",nav_profile_aboutme:"About Me",nav_profile_aboutme_tagline:"View and edit your personal information",nav_profile_badges:"Badges",nav_profile_badges_tagline:"View your earned badges and achievements",nav_profile_language:"Language",nav_profile_language_tagline:"Manage language settings and preferences",nav_reset_password:"Reset Password",nav_reset_password_tagline:"Change your account password",nav_sign_out:"Sign Out",nav_sign_out_tagline:"Sign out of your account",nav_account:"Account",nav_account_tagline:"Account management and support",nav_account_contact:"Contact",nav_account_contact_tagline:"Contact support and sales",nav_account_pricetier:"Price Tier",nav_account_pricetier_tagline:"View and manage pricing plans",nav_account_helpfaq:"Help & FAQ",nav_account_helpfaq_tagline:"Frequently asked questions and help",nav_account_team:"Team",nav_account_team_tagline:"Manage team members and permissions",nav_account_terms:"Terms",nav_account_terms_tagline:"Terms of service and legal agreements",nav_dashboard:"Dashboard",nav_dashboard_tagline:"Overview of your activity",nav_magnets:"Your Magnets",nav_magnets_tagline:"Manage your conversational magnets",nav_templates:"Templates",nav_templates_tagline:"Start from a magnet template",nav_conversations:"Conversations",nav_conversations_tagline:"Captured lead conversations",nav_ab_testing:"A/B Testing",nav_ab_testing_tagline:"Experiment and optimize",nav_analytics:"Analytics",nav_analytics_tagline:"Performance and ad metrics",nav_ad_accounts:"Ad Accounts",nav_ad_accounts_tagline:"Connect advertising accounts",nav_clients:"Clients",nav_clients_tagline:"Manage your client accounts",nav_team:"Team",nav_team_tagline:"Invite and manage teammates",nav_billing:"Billing",nav_billing_tagline:"Plan, usage, and invoices",nav_settings:"Settings",nav_settings_tagline:"Account and workspace settings",nav_home:"Home",nav_home_tagline:"Admin console home dashboard",nav_entities:"Entities",nav_entities_tagline:"Entity and account management",nav_accounts:"Accounts",nav_accounts_tagline:"User account management",nav_groups:"Groups",nav_groups_tagline:"Group and role management",nav_invoices:"Invoices",nav_invoices_tagline:"Invoice and billing management",nav_ab_tests:"A/B Tests",nav_ab_tests_tagline:"A/B testing campaigns",nav_feedback:"Feedback",nav_feedback_tagline:"User feedback collection",nav_guided_tours:"Guided Tours",nav_guided_tours_tagline:"Interactive product tours",nav_questionnaires:"Questionnaires",nav_questionnaires_tagline:"Detailed questionnaires and forms",nav_slideshows:"Slideshows",nav_slideshows_tagline:"Content slideshows and presentations",nav_surveys:"Surveys",nav_surveys_tagline:"Survey campaigns and analytics",nav_voicemail:"Voicemail",nav_voicemail_tagline:"Voice message management",nav_ethercards:"EtherCards",nav_ethercards_tagline:"EtherCards platform management",nav_apps:"Apps",nav_apps_tagline:"Application management",nav_channels:"Channels",nav_channels_tagline:"Communication channels",nav_messages:"Messages",nav_messages_tagline:"Message management and templates",nav_content:"Content",nav_content_tagline:"Content and asset management",nav_rss:"RSS",nav_rss_tagline:"RSS feed management and syndication",nav_core_assets:"Core Assets",nav_core_assets_tagline:"Manage core application assets and resources",nav_deeplinks:"Deeplinks",nav_deeplinks_tagline:"Deep link management and tracking",nav_snippets:"Snippets",nav_snippets_tagline:"Code and content snippet management",nav_rollers:"Rollers",nav_rollers_tagline:"Rolling deployments and version management",nav_support:"Support",nav_support_tagline:"Support and monitoring tools",nav_dialog:"Dialog",nav_dialog_tagline:"Dialog and modal management",nav_meter:"Meter",nav_meter_tagline:"Usage metering and analytics",nav_metadata:"Metadata",nav_metadata_tagline:"Metadata and configuration",nav_i18n:"I18N",nav_i18n_tagline:"Internationalization maintenance",nav_meta_maint:"Meta Maint",nav_meta_maint_tagline:"Metadata maintenance and configuration",nav_silos:"Silos",nav_silos_tagline:"Data silo management",nav_cache:"Cache",nav_cache_tagline:"Cache management and statistics",nav_lifecycle:"Lifecycle",nav_lifecycle_tagline:"Data lifecycle and retention policies",nav_notifications:"Notifications",nav_notifications_tagline:"Notification management",nav_bell_drawer:"Bell Drawer",nav_bell_drawer_tagline:"Notification drawer configuration",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Webhook configuration and monitoring",nav_language:"Language",nav_language_tagline:"Change language preferences"},es:{welcome_back:"Bienvenido de nuevo",please_enter_your_details:"Por favor ingrese sus datos",email:"Correo electrónico",enter_your_email:"Ingrese su correo electrónico",password:"Contraseña",enter_your_password:"Ingrese su contraseña",enter_email_and_password:"Ingrese correo y contraseña",sign_in:"Iniciar sesión",forgot_password:"¿Olvidó su contraseña?",remember_email:"Recordar mi correo electrónico",dont_have_an_account:"¿No tiene una cuenta?",sign_up:"Registrarse",please_enter_your_details_to_get_started:"Ingrese sus datos para comenzar",already_have_an_account:"¿Ya tiene una cuenta?",log_in:"Iniciar sesión",name:"Nombre",enter_your_name:"Ingrese su nombre",first_name:"Nombre",last_name:"Apellido",company:"Empresa",phone:"Teléfono",confirm_password:"Confirmar contraseña",create_account:"Crear cuenta",home:"Inicio",dashboard:"Panel",correspondence:"Correspondencia",settings:"Configuración",sign_out:"Cerrar sesión",reset_password:"Restablecer contraseña",new_password:"Nueva contraseña",confirm_new_password:"Confirmar nueva contraseña",enter_new_password:"Ingrese nueva contraseña",enter_company_name:"Ingrese el nombre de su empresa",enter_phone_number:"Ingrese su número de teléfono",reenter_password:"Vuelva a ingresar su contraseña",update_password:"Actualizar contraseña",update_your_password:"Actualice la contraseña de su cuenta",are_you_sure_sign_out:"¿Está seguro de que desea cerrar sesión?",enter_email_for_reset:"Ingrese su correo electrónico para recibir un enlace de restablecimiento de contraseña",send_reset_link:"Enviar enlace de restablecimiento",remember_password:"¿Recuerda su contraseña?",cancel:"Cancelar",save:"Guardar",delete:"Eliminar",edit:"Editar",loading:"Cargando...",error:"Error",success:"Éxito",refresh:"Actualizar",search:"Buscar",filter:"Filtrar",sort:"Ordenar",view:"Ver",close:"Cerrar",submit:"Enviar",back:"Atrás",next:"Siguiente",previous:"Anterior",confirm:"Confirmar",yes:"Sí",no:"No",ok:"OK",validation_email_required:"Por favor ingrese su correo electrónico",validation_email_invalid:"Por favor ingrese una dirección de correo válida",validation_password_required:"Por favor ingrese su contraseña",validation_password_min_length:"La contraseña debe tener al menos 10 caracteres",validation_password_mismatch:"Las contraseñas no coinciden",validation_first_name_required:"Por favor ingrese su nombre",validation_last_name_required:"Por favor ingrese su apellido",validation_new_password_required:"Por favor ingrese una nueva contraseña",success_welcome_back:"¡Bienvenido de nuevo!",success_password_reset:"Contraseña restablecida exitosamente",success_signed_out:"Sesión cerrada exitosamente",success_reset_link_sent:"¡Enlace de restablecimiento enviado!|Por favor revise su correo electrónico",error_signin_failed:"Error al iniciar sesión",error_signup_failed:"Error al registrarse",error_network:"Error de red - por favor intente de nuevo",error_password_reset_required:"Restablecimiento de contraseña requerido - redirigiendo...",loading_signing_in:"INICIANDO SESIÓN...",loading_creating_account:"Creando cuenta...",loading_resetting_password:"Restableciendo contraseña...",nav_home:"Inicio",nav_home_tagline:"Panel y resumen",nav_home_apps:"Mis Aplicaciones",nav_home_apps_tagline:"Sus aplicaciones e integraciones",nav_home_dash:"Panel",nav_home_dash_tagline:"Panel principal y análisis",nav_engagements:"Compromisos",nav_engagements_tagline:"Herramientas de interacción con clientes",nav_develop:"Desarrollar",nav_develop_tagline:"Herramientas y recursos de desarrollo",nav_profile:"Perfil",nav_profile_tagline:"Configuración y preferencias de cuenta",nav_engagements_surveys:"Encuestas",nav_engagements_surveys_tagline:"Crear y gestionar encuestas de clientes",nav_engagements_thumbs:"Retroalimentación",nav_engagements_thumbs_tagline:"Recopilar opiniones positivas y negativas",nav_engagements_voicemail:"Buzón de voz",nav_engagements_voicemail_tagline:"Recopilación de mensajes de voz",nav_engagements_guidedtours:"Recorridos guiados",nav_engagements_guidedtours_tagline:"Recorridos interactivos de productos",nav_engagements_slideshows:"Presentaciones",nav_engagements_slideshows_tagline:"Presentaciones y diapositivas de contenido",nav_engagements_abtests:"Pruebas A/B",nav_engagements_abtests_tagline:"Campañas de pruebas A/B",nav_engagements_questionnaires:"Cuestionarios",nav_engagements_questionnaires_tagline:"Cuestionarios y formularios detallados",nav_develop_documentation:"Documentación",nav_develop_documentation_tagline:"Documentación de API y productos",nav_develop_devtools:"Herramientas Dev",nav_develop_devtools_tagline:"Herramientas y utilidades de desarrollo",nav_develop_kbase:"Base de Conocimientos",nav_develop_kbase_tagline:"Base de conocimientos y artículos técnicos",nav_develop_hackathon:"Hackathon",nav_develop_hackathon_tagline:"Eventos y desafíos de hackathon",nav_develop_partner:"Socio",nav_develop_partner_tagline:"Programa de socios e integraciones",nav_develop_certification:"Certificación",nav_develop_certification_tagline:"Programas de certificación para desarrolladores",nav_profile_aboutme:"Sobre Mí",nav_profile_aboutme_tagline:"Ver y editar su información personal",nav_profile_badges:"Insignias",nav_profile_badges_tagline:"Ver sus insignias y logros obtenidos",nav_profile_language:"Idioma",nav_profile_language_tagline:"Gestionar configuración y preferencias de idioma",nav_reset_password:"Restablecer Contraseña",nav_reset_password_tagline:"Cambiar la contraseña de su cuenta",nav_sign_out:"Cerrar Sesión",nav_sign_out_tagline:"Cerrar sesión de su cuenta",nav_account:"Cuenta",nav_account_tagline:"Gestión de cuenta y soporte",nav_account_contact:"Contacto",nav_account_contact_tagline:"Contactar con soporte y ventas",nav_account_pricetier:"Nivel de Precio",nav_account_pricetier_tagline:"Ver y gestionar planes de precios",nav_account_helpfaq:"Ayuda y FAQ",nav_account_helpfaq_tagline:"Preguntas frecuentes y ayuda",nav_account_team:"Equipo",nav_account_team_tagline:"Gestionar miembros del equipo y permisos",nav_account_terms:"Términos",nav_account_terms_tagline:"Términos de servicio y acuerdos legales",nav_home:"Inicio",nav_home_tagline:"Panel de inicio de la consola de administración",nav_silo_audits:"Auditorías de Silo",nav_silo_audits_tagline:"Auditar e inspeccionar datos de silo",nav_cache:"Caché",nav_cache_tagline:"Gestión de caché y estadísticas",nav_cache_stats:"Estadísticas",nav_cache_stats_tagline:"Estadísticas de rendimiento de caché",nav_dialog_links:"Enlaces de Diálogo",nav_dialog_links_tagline:"Gestionar configuraciones de enlaces de diálogo y modal",nav_i18n_maint:"Mant. I18n",nav_i18n_maint_tagline:"Mantenimiento de internacionalización y gestión de microcopia",nav_meta_maint:"Mant. Meta",nav_meta_maint_tagline:"Mantenimiento de metadatos y configuración",nav_bell_drawer:"Cajón de Campana",nav_bell_drawer_tagline:"Gestión de notificaciones y configuración del cajón de campana",nav_meter:"Medidor",nav_meter_tagline:"Medición de uso y analíticas",nav_deeplinks:"Enlaces Profundos",nav_deeplinks_tagline:"Gestión y seguimiento de enlaces profundos",nav_rss:"RSS",nav_rss_tagline:"Gestión de feeds RSS y sindicación",nav_core_assets:"Activos Principales",nav_core_assets_tagline:"Gestionar activos y recursos principales de la aplicación",nav_web_hooks:"Web Hooks",nav_web_hooks_tagline:"Configuración y monitoreo de webhooks",nav_snippets:"Fragmentos",nav_snippets_tagline:"Gestión de fragmentos de código y contenido",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"Fragmentos y plantillas de consultas SQL",nav_snippets_js:"JS",nav_snippets_js_tagline:"Fragmentos de código JavaScript",nav_rollers:"Rollers",nav_rollers_tagline:"Despliegues progresivos y gestión de versiones",nav_rollers_primary_nav:"Nav Primaria",nav_rollers_primary_nav_tagline:"Configuración del roller de navegación primaria"},"zh-Hans":{welcome_back:"欢迎回来",please_enter_your_details:"请输入您的详细信息",email:"电子邮件",enter_your_email:"输入您的电子邮件",password:"密码",enter_your_password:"输入您的密码",enter_email_and_password:"输入邮箱和密码",sign_in:"登入",forgot_password:"忘记密码？",remember_email:"记住我的邮箱",dont_have_an_account:"没有账户？",sign_up:"报名",please_enter_your_details_to_get_started:"请输入您的详细信息以开始",already_have_an_account:"已有账户？",log_in:"登录",name:"姓名",enter_your_name:"输入您的姓名",first_name:"名字",last_name:"姓氏",company:"公司",phone:"电话",confirm_password:"确认密码",create_account:"创建账户",home:"首页",dashboard:"仪表板",correspondence:"信件",settings:"设置",sign_out:"登出",reset_password:"重置密码",new_password:"新密码",confirm_new_password:"确认新密码",enter_new_password:"输入新密码",enter_company_name:"输入您的公司名称",enter_phone_number:"输入您的电话号码",reenter_password:"重新输入您的密码",update_password:"更新密码",update_your_password:"更新您的账户密码",are_you_sure_sign_out:"您确定要登出吗？",enter_email_for_reset:"请输入您的电子邮件以接收密码重置链接",send_reset_link:"发送重置链接",remember_password:"记得您的密码？",cancel:"取消",save:"保存",delete:"删除",edit:"编辑",loading:"加载中...",error:"错误",success:"成功",refresh:"刷新",search:"搜索",filter:"筛选",sort:"排序",view:"查看",close:"关闭",submit:"提交",back:"返回",next:"下一个",previous:"上一个",confirm:"确认",yes:"是",no:"否",ok:"确定",validation_email_required:"请输入您的电子邮件",validation_email_invalid:"请输入有效的电子邮件地址",validation_password_required:"请输入您的密码",validation_password_min_length:"密码必须至少10个字符",validation_password_mismatch:"密码不匹配",validation_first_name_required:"请输入您的名字",validation_last_name_required:"请输入您的姓氏",validation_new_password_required:"请输入新密码",success_welcome_back:"欢迎回来！",success_password_reset:"密码重置成功",success_signed_out:"成功登出",success_reset_link_sent:"密码重置链接已发送！|请检查您的电子邮件",error_signin_failed:"登录失败",error_signup_failed:"注册失败",error_network:"网络错误 - 请重试",error_password_reset_required:"需要重置密码 - 正在重定向...",loading_signing_in:"正在登录...",loading_creating_account:"正在创建账户...",loading_resetting_password:"正在重置密码...",nav_home:"首页",nav_home_tagline:"仪表板和概览",nav_home_apps:"我的应用",nav_home_apps_tagline:"您的应用程序和集成",nav_home_dash:"仪表板",nav_home_dash_tagline:"主仪表板和分析",nav_engagements:"互动",nav_engagements_tagline:"客户互动工具和交互",nav_develop:"开发",nav_develop_tagline:"开发工具和资源",nav_profile:"个人资料",nav_profile_tagline:"账户设置和偏好",nav_engagements_surveys:"调查",nav_engagements_surveys_tagline:"创建和管理客户调查",nav_engagements_thumbs:"反馈",nav_engagements_thumbs_tagline:"收集赞成和反对意见",nav_engagements_voicemail:"语音信箱",nav_engagements_voicemail_tagline:"语音留言收集",nav_engagements_guidedtours:"引导式导览",nav_engagements_guidedtours_tagline:"交互式产品导览",nav_engagements_slideshows:"幻灯片",nav_engagements_slideshows_tagline:"内容幻灯片和演示",nav_engagements_abtests:"A/B测试",nav_engagements_abtests_tagline:"A/B测试活动",nav_engagements_questionnaires:"问卷",nav_engagements_questionnaires_tagline:"详细问卷和表单",nav_develop_documentation:"文档",nav_develop_documentation_tagline:"API和产品文档",nav_develop_devtools:"开发工具",nav_develop_devtools_tagline:"开发者工具和实用程序",nav_develop_kbase:"知识库",nav_develop_kbase_tagline:"技术知识库和文章",nav_develop_hackathon:"黑客马拉松",nav_develop_hackathon_tagline:"黑客马拉松活动和挑战",nav_develop_partner:"合作伙伴",nav_develop_partner_tagline:"合作伙伴计划和集成",nav_develop_certification:"认证",nav_develop_certification_tagline:"开发者认证计划",nav_profile_aboutme:"关于我",nav_profile_aboutme_tagline:"查看和编辑您的个人信息",nav_profile_badges:"徽章",nav_profile_badges_tagline:"查看您获得的徽章和成就",nav_profile_language:"语言",nav_profile_language_tagline:"管理语言设置和偏好",nav_reset_password:"重置密码",nav_reset_password_tagline:"更改您的账户密码",nav_sign_out:"登出",nav_sign_out_tagline:"退出您的账户",nav_account:"账户",nav_account_tagline:"账户管理和支持",nav_account_contact:"联系",nav_account_contact_tagline:"联系支持和销售",nav_account_pricetier:"价格等级",nav_account_pricetier_tagline:"查看和管理定价计划",nav_account_helpfaq:"帮助和常见问题",nav_account_helpfaq_tagline:"常见问题和帮助",nav_account_team:"团队",nav_account_team_tagline:"管理团队成员和权限",nav_account_terms:"条款",nav_account_terms_tagline:"服务条款和法律协议",nav_home:"主页",nav_home_tagline:"管理控制台主页仪表板",nav_silo_audits:"仓库审计",nav_silo_audits_tagline:"审计和检查仓库数据",nav_cache:"缓存",nav_cache_tagline:"缓存管理和统计",nav_cache_stats:"统计",nav_cache_stats_tagline:"缓存性能统计",nav_dialog_links:"对话框链接",nav_dialog_links_tagline:"管理对话框和模态链接配置",nav_i18n_maint:"国际化维护",nav_i18n_maint_tagline:"国际化维护和微文案管理",nav_meta_maint:"元数据维护",nav_meta_maint_tagline:"元数据维护和配置",nav_bell_drawer:"铃铛抽屉",nav_bell_drawer_tagline:"通知管理和铃铛抽屉配置",nav_meter:"计量器",nav_meter_tagline:"使用计量和分析",nav_deeplinks:"深层链接",nav_deeplinks_tagline:"深层链接管理和跟踪",nav_rss:"RSS",nav_rss_tagline:"RSS订阅源管理和联合",nav_core_assets:"核心资产",nav_core_assets_tagline:"管理核心应用程序资产和资源",nav_web_hooks:"网络钩子",nav_web_hooks_tagline:"Webhook配置和监控",nav_snippets:"代码片段",nav_snippets_tagline:"代码和内容片段管理",nav_snippets_sql:"SQL",nav_snippets_sql_tagline:"SQL查询片段和模板",nav_snippets_js:"JS",nav_snippets_js_tagline:"JavaScript代码片段",nav_rollers:"滚动器",nav_rollers_tagline:"滚动部署和版本管理",nav_rollers_primary_nav:"主导航",nav_rollers_primary_nav_tagline:"主导航滚动器配置"}}}},SIT:{SSE:{M5T:{en:{welcome_back:["Welcome back","Good to see you again","Hello again"],please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},UAT:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},QA:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}},PROD:{SSE:{M5T:{en:{welcome_back:"Welcome back",please_enter_your_details:"Please enter your details",email:"Email",enter_your_email:"Enter your email",password:"Password",enter_your_password:"Enter your password",sign_in:"Sign in"}}}}};static#t={buildMode:"DEV",product:"SSE",whitelabel:"M5T",lang:"en"};static setContext({buildMode:t,product:a,whitelabel:n,lang:o}){t&&(this.#t.buildMode=t),a&&(this.#t.product=a),n&&(this.#t.whitelabel=n),o&&(this.#t.lang=o)}static getContext(){return{...this.#t}}static get(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{let l=this.#e[o]?.[s]?.[r]?.[i]?.[t],c=o;return!l&&o!=="LOCAL"&&(l=this.#e.LOCAL?.[s]?.[r]?.[i]?.[t],c="LOCAL (fallback)"),l?(c==="LOCAL (fallback)"&&console.warn(`[MicrocopyManager] Token '${t}' missing from ${o} — served from LOCAL instead. Backfill ${o}'s block if this is intentionally different copy.`),Array.isArray(l)?l[Math.floor(Math.random()*l.length)]:l):(console.warn(`[MicrocopyManager] Token not found: ${t} (${o}/${s}/${r}/${i}, LOCAL fallback also missing it)`),null)}catch(l){return console.error(`[MicrocopyManager] Error retrieving token: ${t}`,l),null}}static getAll(t={}){const a={...this.#t,...t},{buildMode:n,product:o,whitelabel:s,lang:r}=a;try{return this.#e[n]?.[o]?.[s]?.[r]||null}catch(i){return console.error("[MicrocopyManager] Error retrieving all tokens",i),null}}static has(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return!!this.#e[o]?.[s]?.[r]?.[i]?.[t]}catch{return!1}}static getAvailableLanguages(){const{buildMode:t,product:a,whitelabel:n}=this.#t;try{return Object.keys(this.#e[t]?.[a]?.[n]||{})}catch{return[]}}static update(t,a,n={}){const o={...this.#t,...n},{buildMode:s,product:r,whitelabel:i,lang:l}=o;try{return this.#e[s]||(this.#e[s]={}),this.#e[s][r]||(this.#e[s][r]={}),this.#e[s][r][i]||(this.#e[s][r][i]={}),this.#e[s][r][i][l]||(this.#e[s][r][i][l]={}),this.#e[s][r][i][l][t]=a,!0}catch(c){return console.error(`[MicrocopyManager] Error updating token: ${t}`,c),!1}}static delete(t,a={}){const n={...this.#t,...a},{buildMode:o,product:s,whitelabel:r,lang:i}=n;try{return delete this.#e[o]?.[s]?.[r]?.[i]?.[t],!0}catch(l){return console.error(`[MicrocopyManager] Error deleting token: ${t}`,l),!1}}static exportData(){return JSON.parse(JSON.stringify(this.#e))}static importData(t){try{return this.#e=t,!0}catch(a){return console.error("[MicrocopyManager] Error importing data",a),!1}}}typeof module<"u"&&module.exports&&(module.exports={MicrocopyManager:C});class Te{static#e=!1;static#t=null;static#o=null;static initialize(){if(this.#e){console.warn("[I18nController] Already initialized");return}const t=this.#n();C.setContext(t),console.log("[I18nController] Initialized with context:",t),console.log("[I18nController] Available languages:",this.getAvailableLanguages()),H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Debug mode enabled"),this.#s(),this.#p(),this.#e=!0,this.refresh()}static#a(t){const a={development:"LOCAL",local:"LOCAL",dev:"DEV",sit:"SIT",qa:"QA",uat:"QA",production:"PROD",prod:"PROD"},n=t.toLowerCase();return a[n]||"DEV"}static#n(){const a=this.#a("production"),n=localStorage.getItem(H.FF_SSE_LS_WHITELABEL)||H.FF_SSE_I18N_WHITELABEL,o=localStorage.getItem(H.FF_SSE_LS_USER_LANG)||H.FF_SSE_I18N_LANG;return{buildMode:a,product:H.FF_SSE_I18N_PRODUCT,whitelabel:n,lang:o}}static#s(){typeof neodigmCarousel<"u"&&neodigmCarousel.setOnAfterNav?neodigmCarousel.setOnAfterNav((t,a,n)=>{H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Route changed:",n),this.#t=n,setTimeout(()=>{this.refresh()},H.FF_SSE_I18N_APPLY_DELAY_MS)},H.FF_CLIENT_CAROUSEL_ID):(console.warn("[I18nController] neodigmCarousel not found. Using fallback polling."),this.#i())}static#i(){setInterval(()=>{const a=document.querySelector("[data-n55-carousel-page-name]")?.getAttribute("data-n55-carousel-page-name");a&&a!==this.#t&&(this.#t=a,this.refresh())},500)}static#p(){this.#o||(this.#o=new MutationObserver(t=>{let a=!1;for(const n of t){for(const o of n.addedNodes)if(o.nodeType===Node.ELEMENT_NODE&&(o.hasAttribute("data-meta-copywrite-i118n")||o.querySelector("[data-meta-copywrite-i118n]"))){a=!0;break}if(a)break}a&&(H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] DOM mutation detected, refreshing i18n"),this.refresh())}),this.#o.observe(document.body,{childList:!0,subtree:!0}))}static refresh(){if(!this.#e){console.warn("[I18nController] Not initialized. Call initialize() first.");return}this.#r(document.body),this.#l(document.body),H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Refresh complete")}static#r(t){const a=t.querySelectorAll("[data-meta-copywrite-i118n]");H.FF_SSE_I18N_DEBUG&&a.length>0&&console.log(`[I18nController] Processing ${a.length} elements`),a.forEach(n=>{try{const o=n.getAttribute("data-meta-copywrite-i118n"),s=JSON.parse(o);if(!s.token){console.warn("[I18nController] Missing token in config:",s);return}const r=s.attribute||"textContent",i=C.get(s.token);if(i===null){console.warn(`[I18nController] Microcopy not found for token: ${s.token}`);return}r==="textContent"?n.textContent=i:r==="innerHTML"?n.innerHTML=i:n.setAttribute(r,i),H.FF_SSE_I18N_DEBUG&&console.log(`[I18nController] Applied "${i}" to ${r} for token: ${s.token}`)}catch(o){console.error("[I18nController] Error processing element:",o,n)}})}static#l(t){t.querySelectorAll("*").forEach(n=>{n.shadowRoot&&(this.#r(n.shadowRoot),this.#l(n.shadowRoot))})}static setLanguage(t){const a=C.getAvailableLanguages();if(!a.includes(t)){console.error(`[I18nController] Language not available: ${t}. Available:`,a);return}localStorage.setItem(H.FF_SSE_LS_USER_LANG,t),C.setContext({lang:t}),console.log("[I18nController] Language changed to:",t);const n=new CustomEvent("language-changed",{bubbles:!0,composed:!0,detail:{lang:t}});document.dispatchEvent(n),this.refresh()}static setWhitelabel(t){localStorage.setItem(H.FF_SSE_LS_WHITELABEL,t),C.setContext({whitelabel:t}),H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Whitelabel changed to:",t),this.refresh()}static getLanguage(){return C.getContext().lang}static getAvailableLanguages(){return C.getAvailableLanguages()}static getContext(){return C.getContext()}static destroy(){this.#o&&(this.#o.disconnect(),this.#o=null),this.#e=!1,this.#t=null,H.FF_SSE_I18N_DEBUG&&console.log("[I18nController] Destroyed")}}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{Te.initialize()}):Te.initialize());class Ia{static _initialized=!1;static _debug=!1;static init(t={}){if(this._initialized)return console.warn("[MachVive] Already initialized, skipping duplicate initialization"),this;if(this._debug=t.debug||!1,!window.mvvSSEther)return console.error("[MachVive] mvvSSEther not found - cannot initialize bridge"),console.error("[MachVive] Make sure mvvSSEther snippet is loaded before MachVive.init()"),this;console.log("[MachVive] Initializing SSE to PubSub bridge...");const a=n=>{this._handleSSEMessage(n)};return window.mvvSSEther.onmessage(a),this._initialized=!0,console.log("[MachVive] ✓ SSE to PubSub bridge initialized successfully"),console.log("[MachVive] ✓ Bound callback to mvvSSEther.onmessage"),this}static _handleSSEMessage(t){try{this._debug&&console.log("[MachVive] SSE message received:",t);const a=t?.data;if(!a){this._debug&&console.log("[MachVive] No data in message, skipping");return}const n=a.data||a.package||a;if(!n){this._debug&&console.log("[MachVive] No package found in message, skipping");return}let o=n.cfg;const s=n.msg;if(this._debug&&(console.log("[MachVive] cfg (raw):",o,"type:",typeof o,"length:",o?.length),console.log("[MachVive] msg (raw):",s)),typeof o=="string"){if(o.trim()===""){this._debug&&console.log("[MachVive] cfg is empty string, skipping");return}try{o=JSON.parse(o),console.log("[MachVive] cfg (parsed):",o)}catch(i){console.warn("[MachVive] Failed to parse cfg as JSON:",{cfg:o,cfgLength:o.length,error:i.message});return}}else if(!o){this._debug&&console.log("[MachVive] cfg is empty/null, skipping");return}const r=o?.topic;if(!r){this._debug&&console.log("[MachVive] No topic found in cfg, skipping");return}if(console.log("[MachVive] Extracted topic:",r),!this._isValidTopic(r)){console.warn(`[MachVive] Topic '${r}' not found in AppBroadcast, skipping`);return}this._publishToPubSub(r,s,t,a)}catch(a){console.error("[MachVive] Error handling SSE message:",a)}}static _isValidTopic(t){return!u||!u.hasOwnProperty(t)?(console.warn(`[MachVive] Topic '${t}' not found in AppBroadcast`),!1):!0}static _publishToPubSub(t,a,n,o){try{if(!window.PubSub&&typeof PubSub>"u"){console.error("[MachVive] PubSub not available");return}const s=window.PubSub||PubSub,r={message:a,metadata:{source:"sse",sseEventId:n.id,timestamp:n.timestamp,appGuid:o.app_guid,channelGuid:o.channel_guid,eventAction:o.event_action,status:o.status,class:o.class,raw:o}};console.log(`[MachVive] Publishing to topic '${t}':`,r);const i=u[t];console.log(`[MachVive] AppBroadcast.${t} = '${i}'`),s.publish(i,r),console.log(`[MachVive] ✓ Published SSE message to topic: ${t}`)}catch(s){console.error(`[MachVive] Error publishing to topic '${t}':`,s)}}static debug(t){return this._debug=t,console.log(`[MachVive] Debug mode ${t?"enabled":"disabled"}`),this}static isInitialized(){return this._initialized}static reset(){return this._initialized=!1,this._debug=!1,console.log("[MachVive] Reset complete"),this}}typeof module<"u"&&module.exports&&(module.exports=Ia);typeof window<"u"&&(window.MachVive=Ia);const Qa="m5t_sidenav_collapsed",cr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};class dr extends HTMLElement{static get observedAttributes(){return["data-active-token","data-collapsed"]}constructor(){super(),this.attachShadow({mode:"open"}),this.items=[],this.orgs=[],this.activeOrgGuid=null,this.activeToken=null,this.footerBadge=null,this.loading=!1,this.lastFocus=null}#e=null;#t=t=>{if(this.getAttribute("data-open")==="true"){if(t.key==="Escape"){t.preventDefault(),this.closeDrawer();return}if(t.key==="Tab"){const a=this.#c();if(a.length<2)return;const n=a[0],o=a[a.length-1],s=this.shadowRoot.activeElement;t.shiftKey&&s===n?(t.preventDefault(),o.focus()):!t.shiftKey&&s===o&&(t.preventDefault(),n.focus())}}};#o=()=>{this.closeDrawer(),this.#d()};connectedCallback(){if(!this.hasAttribute("data-collapsed"))try{localStorage.getItem(Qa)==="true"&&this.setAttribute("data-collapsed","true")}catch{}this.activeToken=this.getAttribute("data-active-token")||null,this.render(),this.#l(),this.addEventListener("keydown",this.#t),this.#e=window.matchMedia("(max-width: 768px)"),this.#e.addEventListener("change",this.#o),this.#d()}disconnectedCallback(){this.removeEventListener("keydown",this.#t),this.#e?.removeEventListener("change",this.#o)}attributeChangedCallback(t,a,n){a===n||!this.shadowRoot||(t==="data-active-token"?(this.activeToken=n,this.#m()):t==="data-collapsed"&&this.shadowRoot.firstChild&&(this.render(),this.#l()))}setState({buttons:t,orgs:a,activeOrg:n,footerBadge:o,loading:s}={}){t!==void 0&&(this.items=Array.isArray(t)?t:this.#a(t)||[]),a!==void 0&&(this.orgs=Array.isArray(a)?a:this.#a(a)||[]),n!==void 0&&(this.activeOrgGuid=n||null),o!==void 0&&(this.footerBadge=o||null),s!==void 0&&(this.loading=!!s),this.shadowRoot&&(this.render(),this.#l())}setButtons(t){this.setState({buttons:t})}setOrgs(t){this.setState({orgs:t})}setActiveOrgGuid(t){this.setState({activeOrg:t})}setFooterBadge(t){this.setState({footerBadge:t})}setActiveToken(t){this.activeToken=t||null,this.#m()}toggleCollapsed(t){const a=typeof t=="boolean"?t:this.getAttribute("data-collapsed")!=="true";this.setAttribute("data-collapsed",String(a));try{localStorage.setItem(Qa,String(a))}catch{}this.dispatchEvent(new CustomEvent("nav-collapse",{bubbles:!0,composed:!0,detail:{pubsubTopic:"M5T_SIDE_NAV.COLLAPSE",collapsed:a,timestamp:Date.now()}}))}openDrawer(){this.lastFocus=this.shadowRoot.activeElement||document.activeElement,this.setAttribute("data-open","true"),this.shadowRoot.querySelector(".hamburger")?.setAttribute("aria-expanded","true"),this.#d(),(this.#c()[0]||this.shadowRoot.querySelector(".sidenav"))?.focus?.()}closeDrawer(){if(this.getAttribute("data-open")!=="true")return;this.removeAttribute("data-open");const t=this.shadowRoot.querySelector(".hamburger");t?.setAttribute("aria-expanded","false"),this.#d(),t&&this.#e?.matches?t.focus():this.lastFocus?.focus?.()}toggleDrawer(){this.getAttribute("data-open")==="true"?this.closeDrawer():this.openDrawer()}#a(t){try{return t?JSON.parse(t):null}catch(a){return console.error("[M5TSideNav] bad JSON:",a),null}}#n(t){return String(t??"").replace(/[&<>"']/g,a=>cr[a])}#s(t){return t?`<span class="ms" aria-hidden="true">${this.#n(t)}</span>`:""}#i(t){if(!t||!t.token)return"";const a=t.token===this.activeToken,n=t.route||"#",o=n.startsWith("#")?n:`#${n}`,s=typeof t.count=="number"&&t.count>0?`<span class="badge">${t.count}</span>`:"";return`
    ...
    <div class="ocb" role="status">
    ...
    </div>`,t.querySelector('[data-ocb="preview"]')?.addEventListener("click",()=>{x.setPreviewAsClient(!x.isPreviewingAsClient()),no()}),t.querySelector('[data-ocb="portfolio"]')?.addEventListener("click",()=>{x.setPreviewAsClient(!1),x.setActiveOrg(null)})}function so(e){const t=document.getElementById("m5t-side-nav"),a=ft[`/${e}`]||ft[e]||null;t?.setActiveToken(a?.sectionToken||null),wr(a)}function wr(e){const t=document.getElementById("m5t-sub-nav"),a=document.getElementById("app-shell");if(!t)return;const n=e?.children;t.hidden=!1,n&&n.length>1?(t.updateButtons(n.map(o=>({token:o.token,caption:o.caption,enabled:!0,selected:o.token===e.childToken}))),a?.classList.add("has-sub-nav")):(t.updateButtons([]),a?.classList.remove("has-sub-nav"))}function xr(){const e=Te.getAvailableLanguages&&Te.getAvailableLanguages()||[];if(e.length<2){p.publish(u.UI_TOAST,{message:"Only one language is available",type:"info"});return}const t=localStorage.getItem(H.FF_SSE_LS_USER_LANG)||H.FF_SSE_I18N_LANG||e[0],a=e[(e.indexOf(t)+1)%e.length];Te.setLanguage(a),p.publish(u.UI_TOAST,{message:`Language: ${a}`,type:"info"})}function ro(e){document.documentElement.setAttribute("data-theme",e)}function Er(){const e=localStorage.getItem(H.FF_SSE_LS_THEME);ro(e==="dark"?"dark":"light")}function Sr(){const e=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";ro(e),localStorage.setItem(H.FF_SSE_LS_THEME,e),p.publish(u.UI_TOAST,{message:e==="dark"?"Dark mode on":"Dark mode off",type:"info"})}function Ar(){const e=document.getElementById("m5t-side-nav");if(!e)return;Jt.setAppToken("client-saas"),document.getElementById("app-shell")?.classList.toggle("nav-collapsed",e.getAttribute("data-collapsed")==="true"),e.addEventListener("nav-select",o=>{const s=o.detail?.route;s&&D.navigate(s.startsWith("/")?s:`/${s}`)}),e.addEventListener("logo-click",()=>D.navigate("/home")),e.addEventListener("nav-collapse",o=>{document.getElementById("app-shell")?.classList.toggle("nav-collapsed",!!o.detail?.collapsed)}),e.addEventListener("org-switch",o=>{const s=o.detail?.orgGuid;s&&x.setActiveOrg(s===ma?null:s)}),e.addEventListener("footer-action",o=>{switch(o.detail?.action){case"account":D.navigate("/settings");break;case"signout":D.navigate("/signout");break;case"lang":xr();break;case"theme":Sr();break}}),document.getElementById("m5t-sub-nav")?.addEventListener("nav-select",o=>{const s=ua[o.detail?.token];s&&D.navigate(s)}),document.addEventListener("language-changed",()=>ra()),ra(),p.subscribe(u.AUTH_SCOPE_LOADED,()=>ra());const a=()=>{const o=x.getScope();return[o?.uiMode,o?.activeOrg?.guid,(o?.managedClients||[]).length,(o?.capabilities||[]).join(","),x.getStoredActiveOrg()].join("|")};let n=a();p.subscribe(u.AUTH_SCOPE_LOADED,()=>{const o=a();o!==n&&(n=o,je&&!$a.has(je)&&no())})}function kr(e){je=e;const t=document.getElementById("m5t-side-nav"),a=document.getElementById("app-shell");if(!t||!a)return;const n=!$a.has(e);if(t.hidden=!n,a.classList.toggle("has-side-nav",n),fr(n),n)so(e);else{const o=document.getElementById("m5t-sub-nav");o&&(o.hidden=!0),a.classList.remove("has-sub-nav")}oo()}p.subscribe(u.ROUTE_NAV_AFTER,(e,t)=>{t?.route&&kr(t.route)});const io=()=>{console.log("[Router] Route: splash"),p.publish(u.ROUTE_NAV_BEFORE,{route:"splash"});const e=to();ee(e?()=>Promise.resolve().then(()=>Nr):()=>Promise.resolve().then(()=>Mr),void 0).then(a=>{const n=document.getElementById("app");n.innerHTML=a.render(),a.init&&a.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"splash"})}).catch(a=>{console.error("[Router] Error loading splash route:",a),p.publish(u.ROUTE_NAV_ERROR,{route:"splash",error:a})})};D.on("/",io);D.on("/splash",io);D.on("/signin",()=>{console.log("[Router] Route: /signin"),p.publish(u.ROUTE_NAV_BEFORE,{route:"signin"}),ee(()=>Promise.resolve().then(()=>Hr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"signin"})}).catch(e=>{console.error("[Router] Error loading signin route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"signin",error:e})})});D.on("/signup",()=>{console.log("[Router] Route: /signup"),p.publish(u.ROUTE_NAV_BEFORE,{route:"signup"}),ee(()=>Promise.resolve().then(()=>Wr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"signup"})}).catch(e=>{console.error("[Router] Error loading signup route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"signup",error:e})})});D.on("/verf-link",()=>{console.log("[Router] Route: /verf-link"),p.publish(u.ROUTE_NAV_BEFORE,{route:"verf-link"}),ee(()=>Promise.resolve().then(()=>Kr),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"verf-link"})}).catch(e=>{console.error("[Router] Error loading verf-link route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"verf-link",error:e})})});D.on("/forgot",()=>{console.log("[Router] Route: /forgot"),p.publish(u.ROUTE_NAV_BEFORE,{route:"forgot"}),ee(()=>Promise.resolve().then(()=>ni),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"forgot"})}).catch(e=>{console.error("[Router] Error loading forgot route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"forgot",error:e})})});D.on("/resethash",()=>{if(console.log("[Router] Route: /resethash"),!_e("resethash")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"resethash"}),ee(()=>Promise.resolve().then(()=>ri),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"resethash"})}).catch(e=>{console.error("[Router] Error loading resethash route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"resethash",error:e})})});D.on("/home",()=>{if(console.log("[Router] Route: /home"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"home"}),ee(()=>Promise.resolve().then(()=>bi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"home"})}).catch(e=>{console.error("[Router] Error loading home route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"home",error:e})})});D.on("/signout",()=>{if(console.log("[Router] Route: /signout"),!_e("signout")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"signout"}),ee(()=>Promise.resolve().then(()=>xi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"signout"})}).catch(e=>{console.error("[Router] Error loading signout route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"signout",error:e})})});const Tr=[{path:"/templates",name:"templates",title:"Templates",icon:"content_copy"},{path:"/analytics",name:"analytics",title:"Analytics",icon:"monitoring"},{path:"/ad-accounts",name:"ad-accounts",title:"Ad Accounts",icon:"ads_click"},{path:"/billing",name:"billing",title:"Billing",icon:"receipt_long"},{path:"/settings",name:"settings",title:"Settings",icon:"settings"},{path:"/magnets/drafts",name:"magnets/drafts",title:"Magnets · Drafts",icon:"widgets"},{path:"/magnets/archived",name:"magnets/archived",title:"Magnets · Archived",icon:"widgets"},{path:"/analytics/conversions",name:"analytics/conversions",title:"Analytics · Conversions",icon:"monitoring"},{path:"/settings/workspace",name:"settings/workspace",title:"Settings · Workspace",icon:"settings"},{path:"/settings/integrations",name:"settings/integrations",title:"Settings · Integrations",icon:"settings"},{path:"/settings/security",name:"settings/security",title:"Settings · Security",icon:"settings"}];Tr.forEach(({path:e,name:t,title:a,icon:n})=>{D.on(e,()=>{if(console.log(`[Router] Route: ${e}`),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:t}),ee(()=>Promise.resolve().then(()=>Ai),void 0).then(o=>{const s=document.getElementById("app");s.innerHTML=o.render({title:a,icon:n,name:t}),o.init&&o.init({name:t}),p.publish(u.ROUTE_NAV_AFTER,{route:t})}).catch(o=>{console.error(`[Router] Error loading section route (${t}):`,o),p.publish(u.ROUTE_NAV_ERROR,{route:t,error:o})})})});D.on("/settings/notifications",()=>{if(console.log("[Router] Route: /settings/notifications"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"settings/notifications"}),ee(()=>Promise.resolve().then(()=>Oi),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"settings/notifications"})}).catch(e=>{console.error("[Router] Error loading settings-notifications route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"settings/notifications",error:e})})});D.on("/settings/integrations",()=>{if(console.log("[Router] Route: /settings/integrations"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"settings/integrations"}),ee(()=>Promise.resolve().then(()=>tl),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"settings/integrations"})}).catch(e=>{console.error("[Router] Error loading settings-integrations route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"settings/integrations",error:e})})});D.on("/conversations",()=>{if(console.log("[Router] Route: /conversations"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"conversations"}),ee(()=>Promise.resolve().then(()=>pl),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"conversations"})}).catch(e=>{console.error("[Router] Error loading conversations route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"conversations",error:e})})});D.on("/ab-testing",()=>{if(console.log("[Router] Route: /ab-testing"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"ab-testing"}),ee(()=>Promise.resolve().then(()=>Al),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"ab-testing"})}).catch(e=>{console.error("[Router] Error loading ab-testing route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"ab-testing",error:e})})});D.on("/magnets",()=>{if(console.log("[Router] Route: /magnets"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"magnets"}),ee(()=>Promise.resolve().then(()=>kc),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"magnets"})}).catch(e=>{console.error("[Router] Error loading magnets route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"magnets",error:e})})});D.on("/leads",()=>{if(console.log("[Router] Route: /leads"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"leads"}),ee(()=>Promise.resolve().then(()=>Uc),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"leads"})}).catch(e=>{console.error("[Router] Error loading leads route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"leads",error:e})})});D.on("/analytics/ad-performance",()=>{if(console.log("[Router] Route: /analytics/ad-performance"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"analytics/ad-performance"}),ee(()=>Promise.resolve().then(()=>Wc),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"analytics/ad-performance"})}).catch(e=>{console.error("[Router] Error loading ad-performance route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"analytics/ad-performance",error:e})})});D.on("/clients",()=>{if(console.log("[Router] Route: /clients"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"clients"}),ee(()=>Promise.resolve().then(()=>od),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"clients"})}).catch(e=>{console.error("[Router] Error loading clients route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"clients",error:e})})});D.on("/team",()=>{if(console.log("[Router] Route: /team"),!_e("home")){re("signin");return}p.publish(u.ROUTE_NAV_BEFORE,{route:"team"}),ee(()=>Promise.resolve().then(()=>md),void 0).then(e=>{const t=document.getElementById("app");t.innerHTML=e.render(),e.init&&e.init(),p.publish(u.ROUTE_NAV_AFTER,{route:"team"})}).catch(e=>{console.error("[Router] Error loading team route:",e),p.publish(u.ROUTE_NAV_ERROR,{route:"team",error:e})})});D.notFound(()=>{console.log("[Router] Route not found - redirecting to splash"),re("splash")});p.subscribe(u.ROUTE_NAV,(e,t)=>{console.log("[Router] ROUTE_NAV event received:",t),t?.route&&re(t.route)});function en(){console.log("[App] Waiting for Neodigm 55 library...");let e=0;const t=100,a=setInterval(()=>{e++,e%10===0&&console.log(`[App] Still waiting... attempt ${e}/100`,{mvvLegitExists:typeof mvvLegit<"u",neodigmLoaded:window.__neodigmLoaded}),typeof mvvLegit<"u"?(console.log(`[App] Neodigm 55 loaded after ${e*100}ms`),clearInterval(a),Cr()):e>=t&&(clearInterval(a),console.error("[App] Failed to load Neodigm 55 library after 10 seconds"),console.error("[App] Check browser console for CORS or network errors"),document.getElementById("app").innerHTML=`
      ...
      `,p.publish(u.APP_ERROR,{message:"Failed to load authentication library"}))},100)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",en):en();async function Cr(){if(console.log("[App] Neodigm 55 loaded, initializing..."),Er(),er(),Te.initialize(),console.log("[App] I18n Controller initialized"),!await x.init({BASE_URL:"https://machfivemagnet-saas.onrender.com",navigateFunction:a=>{console.log("[AuthController] Navigation requested:",a),re(a)}})){console.error("[App] AuthController initialization failed");return}const t=x.getEntity();t&&(console.log("[App] Session restored for:",t.email),p.publish(u.APP_USER_LOADED,{entity:t}),x.isAuthenticated()&&x.fetchScope()),p.publish(u.APP_READY,{timestamp:new Date().toISOString(),sessionUser:t}),Ar(),vr(),D.resolve(),window.AuthController=x,window.I18nController=Te,window.MachVive=Ia,console.log("[App] StreamSyncEngage client initialized (AuthController, I18nController, MachVive available globally)")}p.subscribe(u.ROUTE_NAV_AFTER,(e,t)=>{typeof Te<"u"&&Te.refresh&&setTimeout(()=>{Te.refresh()},100)});let tn=!1;function Ir(){if(tn)return;const e=document.createElement("style");e.id="m5t-accept-invite-styles",e.textContent=`
    .accept-invite-page {
  ...
  `}function Rr(){console.log("[SplashRoute] Initialized - checking authentication state in 3.6 seconds..."),setTimeout(()=>{const e=localStorage.getItem(H.FF_SSE_LS_TOKEN),t=localStorage.getItem("mvv_ts");console.log("[SplashRoute] localStorage check:",{hasMvvToken:!!e,hasMvvTs:!!t});const a=document.getElementById("splash-loader"),n=document.getElementById("splash-actions");e?(console.log("[SplashRoute] Auth token found → HOME"),p.publish(u.ROUTE_NAV,{route:"home"})):t?(console.log("[SplashRoute] Previous session detected (mvv_ts exists) → SIGN IN"),p.publish(u.ROUTE_NAV,{route:"signin"})):(console.log("[SplashRoute] New user (no session history) → Showing buttons"),a&&(a.style.display="none"),n&&(n.style.display="flex"),document.querySelectorAll("[data-route]").forEach(s=>{s.addEventListener("click",()=>{const r=s.getAttribute("data-route");console.log(`[SplashRoute] Button clicked - navigating to: ${r}`),p.publish(u.ROUTE_NAV,{route:r})})}))},4e3)}const Mr=Object.freeze(Object.defineProperty({__proto__:null,init:Rr,render:Or},Symbol.toStringTag,{value:"Module"}));function ie(e,t){typeof neodigmToast<"u"&&neodigmToast.q(t,"danger"),typeof neodigmUtils<"u"?neodigmUtils.shake(`#${e.id}`):(e.classList.add("shake"),setTimeout(()=>e.classList.remove("shake"),300)),e.focus()}const Fr=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;function La(e,t){return e?Fr.test(e)?!0:(ie(t,C.get("validation_email_invalid")),!1):(ie(t,C.get("validation_email_required")),!1)}function Pr(){return`
  ...
  `}function Dr(){console.log("[SigninRoute] Initialized");const e=document.getElementById("loginForm"),t=document.getElementById("email"),a=document.getElementById("password"),n=document.getElementById("togglePassword"),o=document.getElementById("rememberEmail"),s=localStorage.getItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL);s&&t&&o&&(t.value=s,o.checked=!0,a?.focus()),n?.addEventListener("click",()=>{const i=a.type==="password"?"text":"password";a.type=i}),e?.addEventListener("submit",async i=>{i.preventDefault();const l=t.value.trim(),c=a.value;La(l,t)&&Br(c,a)&&(o?.checked?localStorage.setItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL,l):localStorage.removeItem(x.CONFIG.LS_KEYS.REMEMBERED_EMAIL),await Ur(l,c))}),document.getElementById("link--uc__underline")?.addEventListener("click",i=>{i.preventDefault(),p.publish(u.AUTH_FORGOT)}),document.querySelector('.auth-switch a[href="#/signup"]')?.addEventListener("click",i=>{i.preventDefault(),console.log("[SigninRoute] Sign up link clicked - navigating to signup"),p.publish(u.ROUTE_NAV,{route:"signup"})})}function Br(e,t){return e?e.length<10?(ie(t,C.get("validation_password_min_length")),!1):!0:(ie(t,C.get("validation_password_required")),!1)}async function Ur(e,t){const a=document.querySelector(".btn");a.disabled=!0,a.textContent=C.get("loading_signing_in");try{const n=await x.doSignin(e,t);n.ok?(console.log("[SigninRoute] Signin successful"),typeof neodigmToast<"u"&&neodigmToast.q(C.get("success_welcome_back"),"success"),p.publish(u.AUTH_SIGNIN_SUCCESS,{entity:x.getEntity()})):n.resetRequired?(console.log("[SigninRoute] Password reset required"),typeof neodigmToast<"u"&&neodigmToast.q(C.get("error_password_reset_required"),"warning")):(typeof neodigmToast<"u"&&neodigmToast.q(n.error||C.get("error_signin_failed"),"danger"),a.disabled=!1,a.textContent=(C.get("sign_in")||"Sign in").toUpperCase())}catch(n){console.error("[SigninRoute] Sign in error:",n),typeof neodigmToast<"u"&&neodigmToast.q(n.message||C.get("error_network"),"danger"),a.disabled=!1,a.textContent=(C.get("sign_in")||"Sign in").toUpperCase(),p.publish(u.AUTH_SIGNIN_FAIL,{message:n.message})}}const Hr=Object.freeze(Object.defineProperty({__proto__:null,init:Dr,render:Pr},Symbol.toStringTag,{value:"Module"}));function po(e){const t=[];return e.length<12&&t.push("at least 12 characters"),e.length>1024&&t.push("at most 1024 characters"),/[a-z]/.test(e)||t.push("1 lowercase"),/[A-Z]/.test(e)||t.push("1 uppercase"),/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(e)||t.push("1 special character"),/[^\x00-\x7F]/.test(e)&&t.push("ASCII characters only"),t}function uo(e){return e.length===0?"":e.includes("ASCII characters only")?"Password cannot contain emoji|or special unicode characters":e.includes("at least 10 characters")?"Password must have at least|10 characters":"Password must have: Uppercase,|Lowercase, and Special Character"}const zr="2026-07-15";function Gr(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function qr(){console.log("[SignupRoute] Initialized");const e=document.getElementById("signupForm"),t=e.querySelector('button[type="submit"]');an("togglePassword","password","eyeIcon"),an("toggleConfirmPassword","confirmPassword","eyeIconConfirm"),document.querySelector('.auth-switch a[href="#/signin"]')?.addEventListener("click",n=>{n.preventDefault(),console.log("[SignupRoute] Sign in link clicked - navigating to signin"),p.publish(u.ROUTE_NAV,{route:"signin"})}),e.addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("first").value.trim(),s=document.getElementById("last").value.trim(),r=document.getElementById("email").value.trim(),i=document.getElementById("company").value.trim(),l=document.getElementById("phone").value.trim(),c=document.getElementById("password").value,g=document.getElementById("confirmPassword").value,b=document.getElementById("first"),y=document.getElementById("last"),_=document.getElementById("email"),w=document.getElementById("password"),d=document.getElementById("confirmPassword");if(!nn(o,b,C.get("validation_first_name_required"))||!nn(s,y,C.get("validation_last_name_required"))||!La(r,_)||!Vr(c,w))return;if(c!==g){ie(d,C.get("validation_password_mismatch"));return}const h=document.getElementById("acceptTerms");if(!h.checked){ie(h,"Please accept the Terms of Service and Privacy Policy to continue.");return}t.disabled=!0,t.textContent=C.get("loading_creating_account"),await jr(o,s,r,i,l,c)})}function an(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}function nn(e,t,a){return e?!0:(ie(t,a),!1)}function Vr(e,t){if(!e)return ie(t,C.get("validation_password_required")),!1;const a=po(e);return a.length>0?(ie(t,uo(a)),!1):!0}async function jr(e,t,a,n,o,s){const r=document.querySelector('button[type="submit"]');try{const i={email:a,password:s,first:e,last:t};n&&(i.company=n),o&&(i.phone=o),i.terms_accepted=!0,i.legal_version=zr;const l=await x.doSignup(i);if(l.ok)p.publish(u.AUTH_SIGNUP_SUCCESS,{email:a}),typeof mvvLegit<"u"&&mvvLegit.doUNVERF();else{const c=l.error||l.message||C.get("error_signup_failed");typeof neodigmToast<"u"&&neodigmToast.q(c,"danger"),r.disabled=!1,r.textContent=(C.get("create_account")||"Create account").toUpperCase(),p.publish(u.AUTH_SIGNUP_FAIL,{message:c})}}catch(i){console.error("[SignupRoute] Sign up error:",i),typeof neodigmToast<"u"&&neodigmToast.q(i.message||C.get("error_network"),"danger"),r.disabled=!1,r.textContent=(C.get("create_account")||"Create account").toUpperCase(),p.publish(u.AUTH_SIGNUP_FAIL,{message:i.message})}}const Wr=Object.freeze(Object.defineProperty({__proto__:null,init:qr,render:Gr},Symbol.toStringTag,{value:"Module"}));function Yr(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/splash" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function ti(){console.log("[ForgotRoute] Initialized");const e=document.getElementById("forgot-form"),t=document.getElementById("email");e?.addEventListener("submit",async a=>{a.preventDefault();const n=t.value.trim();La(n,t)&&await ai(n)})}async function ai(e){const t=document.querySelector(".btn");t.disabled=!0,t.textContent="SENDING...";try{const a=await Zr.forgotPassword(e);a.ok&&a.data.ok?(typeof neodigmToast<"u"&&neodigmToast.q(C.get("success_reset_link_sent"),"success"),p.publish(u.AUTH_FORGOT_SUCCESS,{email:e}),setTimeout(()=>{window.router&&window.router.navigate("/verf-link")},2e3)):(typeof neodigmToast<"u"&&neodigmToast.q(a.data.error||C.get("error_signin_failed"),"danger"),t.disabled=!1,t.textContent=(C.get("send_reset_link")||"Send reset link").toUpperCase())}catch(a){console.error("[ForgotRoute] Forgot password error:",a),typeof neodigmToast<"u"&&neodigmToast.q(a.message||C.get("error_network"),"danger"),t.disabled=!1,t.textContent=(C.get("send_reset_link")||"Send reset link").toUpperCase()}}const ni=Object.freeze(Object.defineProperty({__proto__:null,init:ti,render:ei},Symbol.toStringTag,{value:"Module"}));function oi(){return`
    <div class="auth-container">
      <div class="auth-left">
  ...
  `}function si(){console.log("[ResethashRoute] Initialized");const e=document.getElementById("resethash-form"),t=e.querySelector('button[type="submit"]');on("toggleNewPassword","new-password","eyeIconNew"),on("toggleConfirmPassword","confirm-password","eyeIconConfirm"),e?.addEventListener("submit",async a=>{a.preventDefault();const n=e.email.value.trim(),o=e.newPassword.value,s=e.confirmPassword.value,r=document.getElementById("new-password"),i=document.getElementById("confirm-password");if(!o){ie(r,C.get("validation_new_password_required"));return}const l=po(o);if(l.length>0){ie(r,uo(l));return}if(!s){ie(i,C.get("validation_new_password_required"));return}if(o!==s){ie(i,C.get("validation_password_mismatch"));return}t.disabled=!0,t.textContent=C.get("loading_resetting_password");try{const c=await x.doResetHash(n,o);c.ok?(typeof neodigmToast<"u"&&neodigmToast.q(C.get("success_password_reset"),"success"),p.publish(u.AUTH_RESETHASH_SUCCESS,{email:n})):(ie(r,c.error||C.get("error_signin_failed")),t.disabled=!1,t.textContent=(C.get("update_password")||"Update password").toUpperCase())}catch(c){console.error("[ResethashRoute] Reset password error:",c),ie(r,c.message||C.get("error_network")),t.disabled=!1,t.textContent=(C.get("update_password")||"Update password").toUpperCase()}})}function on(e,t,a){const n=document.getElementById(e),o=document.getElementById(t),s=document.getElementById(a);!n||!o||!s||n.addEventListener("click",()=>{const r=o.type==="password";o.type=r?"text":"password",r?s.innerHTML=`
        <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
        <line x1="1" y1="1" x2="23" y2="23"></line>
      `:s.innerHTML=`
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
        <circle cx="12" cy="12" r="3"></circle>
      `})}const ri=Object.freeze(Object.defineProperty({__proto__:null,init:si,render:oi},Symbol.toStringTag,{value:"Module"})),ne=()=>x.getManagedClients().length>0&&!x.getStoredActiveOrg(),Pe=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),ii={reseller_org:"Your org",managed_client:"Client",saas_org:"Org"};let sn=!1;function rt(){if(sn)return;const e=document.createElement("style");e.id="m5t-portfolio-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),sn=!0}const rn=e=>e.toISOString().slice(0,10);async function li(e,{days:t=30}={}){const a=new Date,n=rn(new Date(a.getTime()-(t-1)*864e5)),o=rn(a),s=await fetch(`${e}/m5t/v5/dashboard/stats?from=${n}&to=${o}&group_by=owner`);if(!s.ok)throw new Error(`HTTP ${s.status}`);const r=await s.json();if(!r.ok)throw new Error("stats not ok");return r.by_owner||[]}function mo(e,t){return`<div class="dash-clients-scroll"><table class="dash-clients">
    <thead><tr>
    ...
    </div>`}async function it(e,t,{emptyMsg:a}={}){const n=document.getElementById("pf-picker-body");if(n)try{const o=await li(e);if(!o.length){n.innerHTML=ga("groups",a||"No client orgs yet. Create one under Clients first.");return}n.innerHTML=mo(o,t),go(n)}catch(o){console.warn("[portfolio] picker load failed:",o),n.innerHTML=ga("error","Could not load your clients. Please refresh.")}}function ho(){const e={};return x.getManagedClients().forEach(t=>{e[t.orgGuid]=t.name}),x.getMemberships().forEach(t=>{t.orgGuid&&!e[t.orgGuid]&&(e[t.orgGuid]=t.name||"")}),e}const fo=e=>e?`<span class="pf-client-chip">${Pe(e)}</span>`:"",ge=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,he=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),j=e=>Number(e||0).toLocaleString(),vo=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",di=e=>(vo(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase();function pi(e){const t=e.created?.created_tz;if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric"})}catch{return""}}function ui(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}let ln=!1;function mi(){if(ln)return;const e=document.createElement("style");e.id="m5t-dash-recent-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),ln=!0}function gi(e){return`<a class="recent-lead" href="#/leads">
    <span class="recent-lead__ava">${he(di(e))}</span>
    <span class="recent-lead__main">
      <span class="recent-lead__name">${he(vo(e))}</span>
      <span class="recent-lead__sub">${he(e.email||e.phone||"")}</span>
    </span>
    <span class="recent-lead__badge" data-s="${he(e.status)}">${he(e.status)}</span>
    <span class="recent-lead__time">${he(pi(e))}</span>
  ...
  </${i}>`},Et=(e,t,a,{wide:n=!1,full:o=!1,controls:s=!1}={})=>`
  <div class="dashboard-card${n?" chart-card-wide":""}${o?" chart-card-full":""}">
  ...
  </div>`;let ha=30;function _o(){mi(),rt();const e=ne();return`
    <div class="page-shell" data-section="home">
      ...
      <div class="charts-section">
        ${Et("show_chart","Opens & Leads","dash-trend",{wide:!0,controls:!0})}
        <div class="charts-grid">
          ${Et("filter_alt","Completion Funnel","dash-funnel")}
          ${Et("source","Top Campaigns","dash-campaigns")}
          ${Et("touch_app","CTA Usage","dash-routes",{full:!0})}
        </div>
      </div>
    ...
    </div>`).join("")}</div>`}async function vi(e){const t=document.getElementById("recent-leads-body");if(t)try{const a=await fetch(`${e}/m5t/v5/m5mLead`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json(),o=(Array.isArray(n?.data)?n.data:[]).filter(s=>!["DELETED","ARCHIVED"].includes(s.status));t.innerHTML=o.length?o.slice(0,5).map(gi).join(""):ge("contacts","No leads captured yet. Publish a magnet to start collecting.")}catch(a){console.warn("[dashboard] Leads fetch failed:",a),t.innerHTML=ge("error","Could not load recent leads.")}}function pn(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}const un=e=>(e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e));function yo(e){const _=e.length||1,w=pn(Math.max(1,...e.map(I=>I.opens||0))),d=pn(Math.max(1,...e.map(I=>I.leads||0))),h=748/_,v=Math.min(22,h*.55),k=I=>46+h*(I+.5),N=I=>266-I/w*248,B=I=>266-I/d*248,ae=[0,.5,1].map(I=>{const V=266-I*248;return`<line x1="46" y1="${V.toFixed(1)}" x2="794" y2="${V.toFixed(1)}" stroke="#EAF0F7"/><text x="38" y="${(V+3.5).toFixed(1)}" text-anchor="end" class="dash-ax">${un(w*I)}</text><text x="802" y="${(V+3.5).toFixed(1)}" text-anchor="start" class="dash-ax">${un(d*I)}</text>`}).join(""),Y=e.map((I,V)=>{const Ie=N(I.opens||0);return`<rect x="${(k(V)-v/2).toFixed(1)}" y="${Ie.toFixed(1)}" width="${v.toFixed(1)}" height="${Math.max(0,266-Ie).toFixed(1)}" rx="3" fill="#0072BA" opacity="0.85"/>`}).join(""),le=e.map((I,V)=>`${k(V).toFixed(1)},${B(I.leads||0).toFixed(1)}`).join(" "),we=_>1?`<polyline points="${le}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",ce=e.map((I,V)=>`<circle cx="${k(V).toFixed(1)}" cy="${B(I.leads||0).toFixed(1)}" r="3.2" fill="#009473"/>`).join(""),Re=Math.max(1,Math.ceil(_/6)),Ce=e.map((I,V)=>V%Re===0||V===_-1?`<text x="${k(V).toFixed(1)}" y="288" text-anchor="middle" class="dash-ax">${I.date.slice(5)}</text>`:"").join(""),O=e.map((I,V)=>`<rect class="dash-hit" data-i="${V}" x="${(46+h*V).toFixed(1)}" y="18" width="${h.toFixed(1)}" height="${248 .toFixed(1)}" fill="transparent"/>`).join("");return`
    ...
    <div class="dash-chart-wrap">
    ...
    </div>`}function wo(e){const t=document.querySelector("#dash-trend .dash-chart-wrap"),a=document.querySelector("#dash-trend .dash-chart-tip");if(!t||!a)return;const n=s=>{try{return new Date(`${s}T00:00:00`).toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}catch{return s}},o=(s,r)=>{const i=e[s];if(!i)return;a.innerHTML=`
      ...
      <div class="dash-chart-tip__row"><i style="background:#009473"></i>${j(i.leads||0)} leads</div>`;const l=r.getBoundingClientRect(),c=t.getBoundingClientRect();a.style.left=`${l.left-c.left+l.width/2}px`,a.style.top=`${l.top-c.top}px`,a.hidden=!1};t.querySelectorAll(".dash-hit").forEach(s=>{const r=Number(s.dataset.i);s.addEventListener("mouseenter",()=>o(r,s)),s.addEventListener("mousemove",()=>o(r,s)),s.addEventListener("mouseleave",()=>{a.hidden=!0}),s.addEventListener("click",()=>o(r,s))})}const _i={render:_o,init:bo},bi=Object.freeze(Object.defineProperty({__proto__:null,default:_i,init:bo,render:_o,statCard:gt,svgTrendChart:yo,wireTrendTooltip:wo},Symbol.toStringTag,{value:"Module"}));function yi(){return`
    <div class="auth-container">
      <div class="auth-left">
        <a class="auth-brand" href="#/home" aria-label="Mach Five Magnet">
          <img src="m5m-mark.svg" alt="" width="34" height="34" />
  ...
  `}function wi(){console.log("[SignoutRoute] Initialized");const e=document.getElementById("confirm-signout-btn");e?.addEventListener("click",async()=>{e.disabled=!0,e.textContent="SIGNING OUT...",console.log("[SignoutRoute] User confirmed signout"),await x.doSignout()})}const xi=Object.freeze(Object.defineProperty({__proto__:null,init:wi,render:yi},Symbol.toStringTag,{value:"Module"}));let mn=!1;function Ei(){if(mn)return;const e=document.createElement("style");e.id="m5t-section-page-styles",e.textContent=`
    .section-page {
      min-height: 100vh;
      display: grid;
      place-items: center;
  ...
  `,document.head.appendChild(e),mn=!0}function xo({title:e="Section",icon:t="widgets",name:a=""}={}){return Ei(),`
    ...
    </section>`}function Eo(){}const Si={render:xo,init:Eo},Ai=Object.freeze(Object.defineProperty({__proto__:null,default:Si,init:Eo,render:xo},Symbol.toStringTag,{value:"Module"})),ki={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},xe=e=>String(e??"").replace(/[&<>"']/g,t=>ki[t]),fe=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},We=()=>x.getConfig?.().BASE_URL||"",Ti=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,Pt=5,pe={magnets:[],canManage:!1,webhook:null,webhookAllowed:!0},fa=()=>x.getActiveOrg()?.guid||x.getMemberships()[0]?.orgGuid||null;let gn=!1;function Ci(){if(gn)return;const e=document.createElement("style");e.id="m5t-notif-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),gn=!0}const Na=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function So(){return Ci(),rt(),ne()?bt({section:"settings-notifications",title:"Notifications",description:"Pick a client to manage their lead alerts."}):`
    <div class="page-shell" data-section="settings-notifications">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="ntf-body">${Na("hourglass_empty","Loading…")}</div>
      </div>
    ...
    </div>`}async function Ao(){if(ne()){const e=t=>Number(t||0).toLocaleString();return it(We(),[{h:"Magnets",td:t=>`${e(t.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${e(t.magnets.total)}</span>`},{h:"Leads · wk",td:t=>e(t.leads.this_week)}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Promise.all([Ii(),ko()])}async function ko(){const e=fa();if(e)try{const t=await fetch(`${We()}/m5t/v5/acctGroup/${encodeURIComponent(e)}/webhook`);if(t.status===403){pe.webhookAllowed=!1;return}const a=await t.json().catch(()=>({}));if(!a.ok)return;pe.webhook=a.webhook,To()}catch{}}function hn(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function To(){const e=document.getElementById("ntf-wh-card"),t=document.getElementById("ntf-wh-body");if(!e||!t)return;e.style.display="";const a=pe.webhook,n=a?.last_delivery;t.innerHTML=`
    <div class="ntf-wh">
      ...
      <div class="ntf-wh__row">
        ...
        <span class="ntf-wh__status">${n?n.ok?`Last delivery: <span class="ok">delivered</span> ${xe(hn(n.tz))}`:`Last delivery: <span class="bad">failed</span> ${xe(hn(n.tz))} (${xe(n.error||"")})`:""}</span>
      </div>
    </div>`,t.querySelector("#ntf-wh-save")?.addEventListener("click",async()=>{const o=t.querySelector("#ntf-wh-url")?.value.trim()||"",s=t.querySelector("#ntf-wh-secret")?.value??"",r={uri:o};s.trim()!==""&&(r.secret=s.trim());try{const i=await fetch(`${We()}/m5t/v5/acctGroup/${encodeURIComponent(fa())}/webhook`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}),l=await i.json().catch(()=>({}));if(!i.ok||!l.ok)throw new Error(l.error||`Failed (HTTP ${i.status})`);pe.webhook=l.webhook,fe(o?"Webhook saved":"Webhook removed","success"),To()}catch(i){fe(i.message||"Could not save","danger")}}),t.querySelector("#ntf-wh-test")?.addEventListener("click",async o=>{const s=o.currentTarget;s.disabled=!0;try{const r=await fetch(`${We()}/m5t/v5/acctGroup/${encodeURIComponent(fa())}/webhook-test`,{method:"POST"}),i=await r.json().catch(()=>({}));r.ok&&i.ok?fe("Test delivery sent","success"):fe(i.error||"Could not deliver the test","danger")}catch{fe("Could not deliver the test","danger")}finally{s.disabled=!1}try{await ko()}catch(r){console.warn("[notifications] loadWebhook refresh failed:",r)}})}async function Ii(){const e=document.getElementById("ntf-body");if(e){try{const a=await(await fetch(`${We()}/m5t/v5/magnets`)).json().catch(()=>({}));if(!a.ok)throw new Error(a.message||"Failed to load");pe.magnets=(a.magnets||[]).filter(n=>n.status!=="ARCHIVED"),pe.canManage=!!a.canManage}catch(t){console.warn("[notifications] load failed:",t),e.innerHTML=Na("error","Could not load your magnets. Please try again.");return}Co()}}function $i(e){const t=Array.isArray(e.notify_emails)?e.notify_emails:[],a=t.length>0;return`
    <div class="ntf-row" data-guid="${xe(e.guid)}">
      ...
      <div class="ntf-config">
        ...
        <div class="ntf-addrow">
          <input class="ntf-input" type="email" placeholder="name@business.com" aria-label="Add alert email" ${t.length>=Pt?"disabled":""} />
          <button class="ntf-btn" type="button" data-add ${t.length>=Pt?"disabled":""}>
    ...
    </div>`}function Co(){const e=document.getElementById("ntf-body");if(e){if(!pe.magnets.length){e.innerHTML=Na("widgets","No magnets yet. Create one under Your Magnets first.");return}e.innerHTML=pe.magnets.map($i).join(""),e.querySelectorAll(".ntf-row").forEach(t=>{const a=t.dataset.guid,n=t.querySelector(".ntf-input"),o=()=>{const s=(n?.value||"").trim().toLowerCase();if(!s)return;if(!Ti.test(s)){fe("That does not look like an email address","danger");return}const i=[...pe.magnets.find(l=>l.guid===a).notify_emails||[]];if(i.includes(s)){fe("Already added","info");return}if(i.length>=Pt){fe(`Up to ${Pt} emails per magnet`,"info");return}fn(a,[...i,s])};t.querySelector("[data-add]")?.addEventListener("click",o),n?.addEventListener("keydown",s=>{s.key==="Enter"&&o()}),t.querySelectorAll("[data-remove]").forEach(s=>s.addEventListener("click",()=>{const r=pe.magnets.find(i=>i.guid===a);fn(a,(r.notify_emails||[]).filter(i=>i!==s.dataset.remove))})),t.querySelector("[data-test]")?.addEventListener("click",()=>Li(a,t.querySelector("[data-test]")))})}}async function fn(e,t){try{const a=await fetch(`${We()}/m5t/v5/magnets/${encodeURIComponent(e)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({notify_emails:t})}),n=await a.json().catch(()=>({}));if(!a.ok||!n.ok)throw new Error(n.error||n.message||`Failed (HTTP ${a.status})`);const o=pe.magnets.find(s=>s.guid===e);o&&(o.notify_emails=t),fe("Alert emails updated","success")}catch(a){console.warn("[notifications] save failed:",a),fe(a.message||"Could not save","danger");return}try{Co()}catch(a){console.error("[notifications] renderBody after save failed:",a)}}async function Li(e,t){t&&(t.disabled=!0);try{const a=await fetch(`${We()}/m5t/v5/magnets/${encodeURIComponent(e)}/notify-test`,{method:"POST"}),n=await a.json().catch(()=>({}));a.ok&&n.ok?fe("Test alert sent","success"):fe(n.error||"Could not send the test","danger")}catch{fe("Could not send the test","danger")}finally{t&&(t.disabled=!1)}}const Ni={render:So,init:Ao},Oi=Object.freeze(Object.defineProperty({__proto__:null,default:Ni,init:Ao,render:So},Symbol.toStringTag,{value:"Module"})),Ri={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ue=e=>String(e??"").replace(/[&<>"']/g,t=>Ri[t]),te=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},me=()=>x.getConfig?.().BASE_URL||"",F={providers:null,configured:null,denied:!1,busy:!1,autoOpenPicker:!1},Oa=()=>x.getActiveOrg()?.guid||x.getMemberships()[0]?.orgGuid||null;let vn=!1;function Mi(){if(vn)return;const e=document.createElement("style");e.id="m5t-intg-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),vn=!0}const va=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,nt=(e,t="")=>`<div class="intg-alert ${t}"><span class="material-symbols-outlined" aria-hidden="true">${t==="error"?"error":"info"}</span><span>${e}</span></div>`;function Fi(){return Mi(),rt(),ne()?bt({section:"settings-integrations",title:"Integrations",description:"Pick a client to manage their connections."}):`
    ...
    </div>`}function zi(){const e=document.getElementById("intg-body");e&&(e.innerHTML=Bi()+Ui()+Hi(),document.getElementById("intg-g-connect")?.addEventListener("click",Vi),document.getElementById("intg-g-sync")?.addEventListener("click",ji),document.getElementById("intg-g-disconnect")?.addEventListener("click",Wi),document.getElementById("intg-g-accounts")?.addEventListener("click",_n),document.getElementById("intg-c-connect")?.addEventListener("click",Yi),document.getElementById("intg-c-disconnect")?.addEventListener("click",Ji),document.getElementById("intg-r-connect")?.addEventListener("click",Ki),document.getElementById("intg-r-sync")?.addEventListener("click",Zi),document.getElementById("intg-r-disconnect")?.addEventListener("click",el),F.autoOpenPicker&&(F.autoOpenPicker=!1,document.getElementById("intg-g-accounts")&&_n()))}async function _n(){const e=document.getElementById("intg-g-picker");if(e){e.style.display="",e.innerHTML=nt("Loading your ad accounts…");try{const a=await(await fetch(`${me()}/m5t/v5/integrations/google_ads/accounts`)).json();if(!a.ok)throw new Error(a.error||"load failed");Gi(a.data.accounts||[],new Set(a.data.linked||[]))}catch{e.innerHTML=nt("Could not load your ad accounts. Try again, or reconnect if this keeps happening.","error")}}}function Gi(e,t){const a=document.getElementById("intg-g-picker");if(!a)return;const n=e.map(o=>{const s=o.manager||o.error,r=o.manager?"Manager":o.error?"Unavailable":o.currency||"",i=t.has(o.id)&&!s;return`
    ...
    </div>`,document.getElementById("intg-picker-cancel")?.addEventListener("click",()=>{a.style.display="none"}),document.getElementById("intg-picker-save")?.addEventListener("click",qi)}async function qi(){const e=document.getElementById("intg-g-picker"),t=[...e?.querySelectorAll("input[data-intg-acct]:checked")||[]].map(n=>n.dataset.intgAcct),a=document.getElementById("intg-picker-save");a&&(a.disabled=!0);try{const o=await(await fetch(`${me()}/m5t/v5/integrations/google_ads/accounts`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({customer_ids:t})})).json();if(!o.ok)throw new Error(o.error||"save failed");te(`${o.data.linked} account${o.data.linked===1?"":"s"} linked. First sync is running.`,"success"),e&&(e.style.display="none"),Be()}catch{te("Could not save account selection.","error"),a&&(a.disabled=!1)}}async function Vi(){if(!F.busy){F.busy=!0;try{const t=await(await fetch(`${me()}/m5t/v5/integrations/google_ads/connect`)).json();if(!t.ok||!t.data?.url)throw new Error(t.error||"connect failed");window.location.href=t.data.url}catch{te("Could not start the Google connection.","error"),F.busy=!1}}}async function ji(){if(F.busy)return;F.busy=!0;const e=document.getElementById("intg-g-sync");e&&(e.disabled=!0);try{const a=await(await fetch(`${me()}/m5t/v5/integrations/google_ads/sync`,{method:"POST"})).json();if(!a.ok)throw new Error(a.error||"sync failed");const o=(a.data?.connections?.[0]?.accounts||[]).filter(s=>s.error).length;te(o?`Sync finished with ${o} account error${o===1?"":"s"}.`:"Metrics synced.",o?"warning":"success")}catch{te("Sync failed.","error")}finally{F.busy=!1,e&&(e.disabled=!1),Be()}}async function Wi(){if(!F.busy&&window.confirm("Disconnect Google Ads? Daily metric refreshes stop until reconnected.")){F.busy=!0;try{const t=await(await fetch(`${me()}/m5t/v5/integrations/google_ads`,{method:"DELETE"})).json().catch(()=>({}));if(!t.ok)throw new Error(t.error||"disconnect failed");te("Google Ads disconnected.","success")}catch{te("Disconnect failed.","error")}finally{F.busy=!1,Be()}}}async function Yi(){if(!F.busy){F.busy=!0;try{const t=await(await fetch(`${me()}/m5t/v5/integrations/calendly/connect`)).json();if(!t.ok||!t.data?.url)throw new Error(t.error||"connect failed");window.location.href=t.data.url}catch{te("Could not start the Calendly connection.","error"),F.busy=!1}}}async function Ji(){if(!F.busy&&window.confirm("Disconnect Calendly? Magnet booking falls back to the built-in scheduler and booking sync stops.")){F.busy=!0;try{const t=await(await fetch(`${me()}/m5t/v5/integrations/calendly`,{method:"DELETE"})).json().catch(()=>({}));if(!t.ok)throw new Error(t.error||"disconnect failed");te("Calendly disconnected.","success")}catch{te("Disconnect failed.","error")}finally{F.busy=!1,Be()}}}function Ki(){const e=document.getElementById("intg-r-setup");e&&(e.style.display="",e.innerHTML=`
    <div class="intg-picker">
    ...
    </div>`,document.getElementById("intg-r-cancel")?.addEventListener("click",()=>{e.style.display="none"}),document.getElementById("intg-r-continue")?.addEventListener("click",Xi),document.getElementById("intg-r-key")?.focus())}const Fe=e=>{const t=document.getElementById("intg-r-status");t&&(t.textContent=e)};async function Xi(){const e=document.getElementById("intg-r-continue"),t=document.getElementById("intg-r-key")?.value.trim()||"",a=document.getElementById("intg-r-pickers");if(!t){Fe("Paste an API key first.");return}if(a&&!a.hidden)return Qi(t);e&&(e.disabled=!0),Fe("Checking the key with CallRail…");try{const o=await(await fetch(`${me()}/m5t/v5/integrations/callrail/validate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:t})})).json();if(!o.ok){Fe(o.error||"CallRail rejected that key.");return}const s=o.data.accounts||[],r=document.getElementById("intg-r-account");r&&(r.innerHTML=s.map(i=>`<option value="${ue(i.id)}">${ue(i.name)}</option>`).join(""),r.onchange=()=>bn(t,r.value)),a&&(a.hidden=!1),e&&(e.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">save</span>Save'),Fe(""),await bn(t,s[0]?.id)}catch{Fe("Could not reach CallRail. Try again.")}finally{e&&(e.disabled=!1)}}async function bn(e,t){const a=document.getElementById("intg-r-company");if(!(!a||!t)){a.innerHTML='<option value="">Loading companies…</option>';try{const o=await(await fetch(`${me()}/m5t/v5/integrations/callrail/companies`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:t})})).json(),s=o.ok?o.data.companies||[]:[];a.innerHTML=s.length?s.map(r=>`<option value="${ue(r.id)}">${ue(r.name)}</option>`).join(""):'<option value="">No active companies in this account</option>'}catch{a.innerHTML='<option value="">Could not load companies</option>'}}}async function Qi(e){const t=document.getElementById("intg-r-continue"),a=document.getElementById("intg-r-account")?.value||"",n=document.getElementById("intg-r-company")?.value||"";if(!n){Fe("Pick the company this workspace tracks.");return}t&&(t.disabled=!0),Fe("Connecting…");try{const s=await(await fetch(`${me()}/m5t/v5/integrations/callrail`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:e,account_id:a,company_id:n})})).json();if(!s.ok)throw new Error(s.error||"connect failed");te(s.data?.webhook_state==="active"?"CallRail connected. Call sync is on.":"CallRail connected. Call sync setup needs attention; see the card.","success"),Be()}catch{Fe("Could not connect. Check the key and try again."),t&&(t.disabled=!1)}}async function Zi(){if(F.busy)return;F.busy=!0;const e=document.getElementById("intg-r-sync");e&&(e.disabled=!0);try{const a=await(await fetch(`${me()}/m5t/v5/integrations/callrail/sync?days=7`,{method:"POST"})).json();if(!a.ok)throw new Error(a.error||"sync failed");const n=a.data?.connections?.[0]||{};te(n.error?"Sync finished with errors.":`Sync done. ${n.processed||0} new call${(n.processed||0)===1?"":"s"} recorded.`,n.error?"warning":"success")}catch{te("Sync failed.","error")}finally{F.busy=!1,e&&(e.disabled=!1),Be()}}async function el(){if(!F.busy&&window.confirm("Disconnect CallRail? Calls stop landing in your Leads inbox.")){F.busy=!0;try{const t=await(await fetch(`${me()}/m5t/v5/integrations/callrail`,{method:"DELETE"})).json().catch(()=>({}));if(!t.ok)throw new Error(t.error||"disconnect failed");te("CallRail disconnected.","success")}catch{te("Disconnect failed.","error")}finally{F.busy=!1,Be()}}}const tl=Object.freeze(Object.defineProperty({__proto__:null,init:Pi,render:Fi},Symbol.toStringTag,{value:"Module"})),al={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Q=e=>String(e??"").replace(/[&<>"']/g,t=>al[t]),_a=()=>x.getConfig?.().BASE_URL||"",ia=e=>Number(e||0).toLocaleString(),z={conversations:[],counts:{},magnetNames:{},filter:"ALL",book:!1,magnetOwnerNames:{}},yn={COMPLETED:{label:"Completed",icon:"check_circle"},IN_PROGRESS:{label:"In progress",icon:"pending"},ABANDONED:{label:"Abandoned",icon:"highlight_off"}},ba={book:"Book",chat:"Chat",call:"Call",email:"Email",support:"Support"};function Io(e){return e&&([e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email)||null}function $o(e){return(e.split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase()}function Lo(e){try{return new Date(e).toLocaleString([],{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return""}}function nl(e){try{const t=Math.max(0,(Date.now()-new Date(e).getTime())/1e3);return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}catch{return""}}function No(e){return e==null?"—":e<60?`${e}s`:`${Math.floor(e/60)}m ${String(e%60).padStart(2,"0")}s`}let wn=!1;function ol(){if(wn)return;const e=document.createElement("style");e.id="m5t-convs-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),wn=!0}const Kt=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Oo(){return ol(),rt(),`
    <div class="page-shell" data-section="conversations">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="convs-body">
          ${Kt("hourglass_empty","Loading journeys…")}
        </div>
      </div>
    </div>`}async function Ro(){await sl()}async function sl(){const e=document.getElementById("convs-body");if(e){try{const[t,a]=await Promise.all([fetch(`${_a()}/m5t/v5/conversations`),fetch(`${_a()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(z.conversations=n.conversations||[],z.counts=n.counts||{},z.book=ne(),a){const o=await a.json().catch(()=>({}));z.magnetNames={},z.magnetOwnerNames={};const s=z.book?ho():{};(o.magnets||[]).forEach(r=>{z.magnetNames[r.guid]=r.name,z.book&&(z.magnetOwnerNames[r.guid]=r.owner_name||s[r.owner_guid]||"")})}}catch(t){console.warn("[conversations] load failed:",t),e.innerHTML=Kt("error","Could not load journeys. Please try again.");return}Mo()}}function rl(){return z.filter==="ALL"?z.conversations:z.conversations.filter(e=>e.status===z.filter)}function il(e){const t=Io(e.lead),a=z.magnetNames[e.magnet_guid]||"—",n=yn[e.status]||yn.ABANDONED,o=e.steps_total?Math.min(100,Math.round((e.steps_reached||0)/e.steps_total*100)):null,s=(e.routes||[]).map(r=>ba[r]||r).join(", ");return`
    <tr class="convs-row" data-session="${Q(e.session)}">
      <td>
        <span class="convs-who">
          <span class="convs-ava${t?"":" anon"}">${t?Q($o(t)):'<span class="material-symbols-outlined" style="font-size:16px">person_off</span>'}</span>
          <span><span class="convs-name">${t?Q(t):'<span class="convs-muted">Anonymous visitor</span>'}</span>
            ${e.lead?.email?`<div class="convs-sub">${Q(e.lead.email)}</div>`:s?`<div class="convs-sub">Picked: ${Q(s)}</div>`:""}</span>
        </span>
      </td>
      ${z.book?`<td>${fo(z.magnetOwnerNames[e.magnet_guid]||"")||'<span class="convs-muted">—</span>'}</td>`:""}
      <td><span class="convs-sub">${Q(a)}</span></td>
      <td><span class="convs-badge" data-s="${Q(e.status)}"><span class="material-symbols-outlined" aria-hidden="true">${n.icon}</span>${n.label}</span></td>
      ...
      <td class="convs-muted" style="white-space:nowrap" title="${Q(Lo(e.started_at))}">${Q(nl(e.started_at))}</td>
      <td class="convs-muted" style="white-space:nowrap">${Q(No(e.duration_s))}</td>
    </tr>`}function Mo(){const e=document.getElementById("convs-body");if(!e)return;if(!z.conversations.length){e.innerHTML=Kt("route","No journeys yet. As visitors open your magnets, every session, completed or abandoned, appears here.");return}const t=rl(),a=[["ALL","All"],["COMPLETED","Completed"],["IN_PROGRESS","In progress"],["ABANDONED","Abandoned"]];e.innerHTML=`
    <div class="convs-bar">
      <div class="convs-filter">
        ${a.map(([n,o])=>`<button data-filter="${n}" class="${z.filter===n?"active":""}">${o}${n!=="ALL"&&z.counts[n]?` (${ia(z.counts[n])})`:""}</button>`).join("")}
      </div>
      <span class="convs-count">${ia(t.length)} of ${ia(z.conversations.length)} (30 days)</span>
    </div>
    <div class="convs-tablewrap">
      <table class="convs-table">
        ...
        <tbody id="convs-tbody">${t.map(il).join("")||`<tr><td colspan="${z.book?7:6}"><div class="convs-muted" style="padding:14px 4px">No ${z.filter.toLowerCase().replace("_"," ")} journeys.</div></td></tr>`}</tbody>
      </table>
    </div>`,e.querySelector(".convs-filter")?.addEventListener("click",n=>{const o=n.target.closest("[data-filter]");o&&(z.filter=o.dataset.filter,Mo())}),e.querySelector("#convs-tbody")?.addEventListener("click",n=>{const o=n.target.closest(".convs-row");o&&cl(o.dataset.session)})}const ll={open:()=>"Opened the magnet",engage:e=>`First interaction${e?`: ${ba[e]||e}`:""}`,route:e=>`Picked ${ba[e]||e||"a channel"}`,step:e=>`Reached step ${e||""}`,complete:()=>"Completed: lead captured"};async function cl(e){const t=z.conversations.find(c=>c.session===e);if(!t)return;let a=null;try{a=await(await fetch(`${_a()}/m5t/v5/conversations/${encodeURIComponent(e)}`)).json().catch(()=>null),a?.ok||(a=null)}catch{a=null}const n=Io(t.lead),o=z.magnetNames[t.magnet_guid]||"—",r=(a?.events||[]).filter((c,g,b)=>c.event!=="step"||!(b[g+1]&&b[g+1].event==="step")).map(c=>`
    <div class="convs-tl__item${c.event==="complete"?" done":""}">
      <span class="convs-tl__dot"></span>
      <div class="convs-tl__label">${Q((ll[c.event]||(()=>c.event))(c.detail))}</div>
      <div class="convs-tl__time">${Q(Lo(c.at))}${c.variant?` · Variant ${Q(c.variant)}`:""}</div>
    ...
    <aside class="convs-drawer" role="dialog" aria-modal="true" aria-label="Journey detail">
      <div class="convs-drawer__head">
        <span class="convs-drawer__title">${n?Q(n):"Anonymous visitor"}</span>
      ...
      <div class="convs-drawer__body">
        ${n?`<a class="convs-drawer__lead" href="#/leads">
              <span class="convs-ava">${Q($o(n))}</span>
              <span><div class="convs-name">${Q(n)}</div><div class="convs-sub">${Q(t.lead?.email||t.lead?.phone||"")}</div></span>
        ...
        <div class="convs-sub" style="margin-bottom:6px">${Q(o)} · ${Q(No(t.duration_s))}${t.variant?` · Variant ${Q(t.variant)}`:""}</div>
        ${r?`<div class="convs-tl">${r}</div>`:Kt("timeline","No timeline available for this journey.")}
      </div>
    </aside>`,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("open"),i.querySelector(".convs-drawer").classList.add("open")});const l=()=>{i.classList.remove("open"),setTimeout(()=>i.remove(),220)};i.querySelector(".convs-drawer__close").addEventListener("click",l),i.addEventListener("click",c=>{c.target===i&&l()})}const dl={render:Oo,init:Ro},pl=Object.freeze(Object.defineProperty({__proto__:null,default:dl,init:Ro,render:Oo},Symbol.toStringTag,{value:"Module"})),ul={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ve=e=>String(e??"").replace(/[&<>"']/g,t=>ul[t]),xn=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},Ct=()=>x.getConfig?.().BASE_URL||"",ot=e=>Number(e||0).toLocaleString(),De={magnets:[],stats:{},canManage:!1},ml={mag_title:"header title",mag_subtitle:"subtitle",mag_welcome:"welcome message",mag_theme_color:"color",mag_launcher_label:"launcher label"};let En=!1;function gl(){if(En)return;const e=document.createElement("style");e.id="m5t-abt-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),En=!0}const Ra=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`;function Fo(){return ne()?bt({section:"ab-testing",title:"A/B Testing",description:"Pick a client to view their experiments."}):(gl(),`
    <div class="page-shell" data-section="ab-testing">
      ...
      <div id="abt-body">${Ra("hourglass_empty","Loading tests…")}</div>
    </div>`)}async function Ma(){if(ne())return it(Ct(),[{h:"Running",td:t=>ot(t.ab_tests?.running)},{h:"Completed",td:t=>ot(t.ab_tests?.completed)},{h:"Compl. %",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Experiments appear per client once you have one."});const e=document.getElementById("abt-body");try{const t=new Date,a=new Date(t.getTime()-89*864e5).toISOString().slice(0,10),n=t.toISOString().slice(0,10),[o,s]=await Promise.all([fetch(`${Ct()}/m5t/v5/magnets`),fetch(`${Ct()}/m5t/v5/magnets/stats?from=${a}&to=${n}`)]),r=await o.json().catch(()=>({}));if(!r.ok)throw new Error(r.message||"Failed to load");De.magnets=r.magnets||[],De.canManage=!!r.canManage;const i=await s.json().catch(()=>({}));De.stats=i?.stats||{}}catch(t){console.warn("[ab-testing] load failed:",t),e&&(e.innerHTML=Ra("error","Could not load your tests. Please try again."));return}hl()}function hl(){const e=document.getElementById("abt-body");if(!e)return;const t=De.magnets.filter(n=>n.ab?.enabled),a=De.magnets.filter(n=>!n.ab?.enabled&&n.ab?.declared);if(!t.length&&!a.length){e.innerHTML=Ra("science","No experiments yet. Open a magnet on Your Magnets → Edit → “A/B experiment”, give variant B a change, and results appear here.");return}e.innerHTML=(t.length?`<div class="abt-sect">Running</div>${t.map(bl).join("")}`:"")+(a.length?`<div class="abt-sect">Completed Tests</div>${a.map(yl).join("")}`:""),e.querySelectorAll("[data-declare]").forEach(n=>n.addEventListener("click",()=>wl(n.dataset.declare,n.dataset.winner)))}function fl(e){const t=De.stats[e.guid]?.variants||{},a={opens:0,engaged:0,completions:0,rate:null,...t.A||{}},n={opens:0,engaged:0,completions:0,rate:null,...t.B||{}};return{A:a,B:n}}function vl(e){const t=Object.keys(e?.b||{}).map(a=>ml[a]||a);return t.length?`Changes: ${t.join(", ")}`:""}function _l(e){try{return Math.max(0,Math.floor((Date.now()-new Date(e).getTime())/864e5))}catch{return null}}function Sn(e,t,a,n,o,s){return`
    ...
    </div>`}function bl(e){const t=e.ab,{A:a,B:n}=fl(e),o=(n.rate??-1)>(a.rate??-1)?"B":(a.rate??-1)>(n.rate??-1)?"A":null,s=o&&a.rate!=null&&n.rate!=null?`+${Math.round(Math.abs(n.rate-a.rate)*10)/10}%`:"",r=xl(a,n),i=t.started_tz?_l(t.started_tz):null,l=(a.opens||0)+(n.opens||0),c=t.split||50;return`
    <div class="abt-card">
      <div class="abt-head">
      ...
      <div class="abt-compare">
        ${Sn("Variant A","Control","The magnet as configured",a,o==="A",o==="A"?s:"")}
        <div class="abt-vs">VS</div>
        ${Sn("Variant B",o==="B"?"Leading":"Challenger",vl(t),n,o==="B",o==="B"?s:"")}
      </div>
      <div class="abt-sig">
    ...
    </div>`}async function wl(e,t){const a=De.magnets.find(n=>n.guid===e);if(a&&window.confirm(`Declare Variant ${t} the winner for “${a.name}”?

${t==="B"?"Variant B’s changes become the magnet’s configuration for everyone.":"The magnet keeps its current configuration."} The experiment ends and moves to Completed.`)){try{const o=await(await fetch(`${Ct()}/m5t/v5/magnets/${encodeURIComponent(e)}/ab/declare`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({winner:t})})).json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Declare failed");xn(`Variant ${t} declared the winner`,"success")}catch(n){xn(n.message||"Could not declare a winner","danger");return}try{await Ma()}catch(n){console.warn("[ab-testing] refresh after declare failed:",n)}}}function xl(e,t){const a=e.opens||0,n=t.opens||0,o=e.completions||0,s=t.completions||0;if(a<30||n<30||o+s<5)return null;const r=o/a,i=s/n,l=(o+s)/(a+n),c=Math.sqrt(l*(1-l)*(1/a+1/n));if(!c)return null;const g=Math.abs(i-r)/c;return Math.round(2*(El(g)-.5)*1e3)/10}function El(e){const t=1/(1+.2316419*Math.abs(e)),n=.3989423*Math.exp(-e*e/2)*t*(.3193815+t*(-.3565638+t*(1.781478+t*(-1.821256+t*1.330274))));return e>0?1-n:n}const Sl={render:Fo,init:Ma},Al=Object.freeze(Object.defineProperty({__proto__:null,default:Sl,init:Ma,render:Fo},Symbol.toStringTag,{value:"Module"})),kl={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},se=e=>String(e??"").replace(/[&<>"']/g,t=>kl[t]),Po=()=>x.getConfig?.().BASE_URL||"",Tl={single_select:{icon:"quiz",color:"#0072BA"},multi_select:{icon:"checklist",color:"#0E6BA8"},scheduler:{icon:"event",color:"#915E8B"},text:{icon:"short_text",color:"#5B54C6"},email:{icon:"mail",color:"#0E8F86"},phone:{icon:"call",color:"#2E8B57"},message:{icon:"chat",color:"#B4791F"}},Dt={};Ca.forEach(e=>{Dt[e.value]={label:e.label,...Tl[e.value]||{icon:"quiz",color:"#0072BA"}}});const Do=Ca.map(e=>e.value),Bo={chat:"Chat / default",book:"Book (scheduler)",support:"Support (intake)"},Fa=e=>Dt[e]||Dt.single_select,Ke=e=>e==="single_select"||e==="multi_select",Xt=e=>e!=="message",yt=e=>e==="scheduler",Bt=e=>e==="email"?"email":e==="phone"?"phone":"",Ye=()=>({meeting_label:"",start:"09:00",end:"17:00",mins:30,days:14}),Cl=[["","No icon"],["event","Calendar"],["schedule","Clock"],["mail","Email"],["sms","Text"],["phone","Phone"],["chat","Chat"],["description","Document"],["help","Question"],["place","Location"],["person","Person"],["bolt","Quick"],["check_circle","Check"],["star","Star"],["home","Home"],["build","Service"]];function Il(e,t){const a=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(String(e||"").trim());return a?`rgba(${parseInt(a[1],16)},${parseInt(a[2],16)},${parseInt(a[3],16)},${t})`:`rgba(0,114,186,${t})`}let An=!1;function $l(){if(An)return;const e=document.createElement("style");e.id="m5t-flow-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),An=!0}let R=[],Se=null,Ll=0,Me=null,Ge=null,qe="chat",ve={},It=[],Uo=null,ya=null,$t="";const st=()=>"f"+ ++Ll;function Pa(e="single_select"){return{_uid:st(),id:"",step_type:e,step_prompts:[""],step_options:Ke(e)?[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]:[],step_columns:Bt(e)?[Bt(e)]:[],step_description:"",step_config:yt(e)?Ye():null}}function Nl(e){return(Array.isArray(e)?e:[]).map(t=>({_uid:st(),id:t.id!=null?String(t.id):"",step_type:Dt[t.step_type]?t.step_type:"single_select",step_prompts:Array.isArray(t.step_prompts)?t.step_prompts.map(String):[],step_options:(Array.isArray(t.step_options)?t.step_options:[]).map(a=>({label:a&&a.label!=null?String(a.label):"",goto:a&&a.goto!=null?String(a.goto):"",icon:a&&a.icon!=null?String(a.icon):""})),step_columns:Array.isArray(t.step_columns)?t.step_columns.map(String):[],step_description:t.step_description!=null?String(t.step_description):"",step_config:t.step_config&&typeof t.step_config=="object"?{...Ye(),...t.step_config}:t.step_type==="scheduler"?Ye():null}))}function kn(){return[{_uid:st(),id:"",step_type:"text",step_prompts:["Great, and your name?"],step_options:[],step_columns:["first_name"],step_description:"",step_config:null},{_uid:st(),id:"",step_type:"email",step_prompts:["The best email to reach you?"],step_options:[],step_columns:["email"],step_description:"",step_config:null}]}function Ol(e,t){if(e==="book")return[{_uid:st(),id:"",step_type:"scheduler",step_prompts:["When works best for you?"],step_options:[],step_columns:[],step_description:"",step_config:Ye()},...kn()];if(e==="support"){const a=(t.actions||[]).find(s=>s&&s.type==="support"),n=a&&a.config&&Array.isArray(a.config.options)?a.config.options:[],o=n.length?n.map(s=>({label:s&&s.label||String(s),goto:"",icon:s&&s.icon||""})):["Sales enquiry","Support","Billing","Something else"].map(s=>({label:s,goto:"",icon:""}));return[{_uid:st(),id:"",step_type:"multi_select",step_prompts:["How can we help you today?"],step_options:o,step_columns:[],step_description:"Select all that apply",step_config:null},...kn()]}return[Pa("single_select")]}function Ho(e,t){const a=e==="chat"?t.steps:t.routes&&t.routes[e],n=Nl(a);return n.length?n:e==="chat"?[Pa("single_select")]:Ol(e,t)}function Rl(e){Ke(e.step_type)?e.step_options.length||(e.step_options=[{label:"",goto:"",icon:""},{label:"",goto:"",icon:""}]):e.step_options=[],Xt(e.step_type)?!e.step_columns.length&&Bt(e.step_type)&&(e.step_columns=[Bt(e.step_type)]):e.step_columns=[],e.step_config=yt(e.step_type)?e.step_config||Ye():null}function Ml(e,t){return`<div class="flow-opt">
    <input class="mag-modal__input flow-o-label" type="text" value="${se(e.label)}" placeholder="Option label">
    <select class="mag-modal__select flow-o-icon" title="Icon">${Cl.map(([a,n])=>`<option value="${se(a)}"${a===e.icon?" selected":""}>${se(n)}</option>`).join("")}</select>
  ...
  </div>`}function Fl(e){const t=Do.map(n=>`<option value="${n}"${n===e.step_type?" selected":""}>${se(Fa(n).label)}</option>`).join(""),a=e.step_options.length<=1;return`<div class="flow-node__body">
...
`))}</textarea>
    ...
    <div class="flow-opts">${e.step_options.map(n=>Ml(n,a)).join("")}</div>
    ...
    ${o?Fl(e):Pl(e)}
  </div>`}const Tn='<div class="flow-conn"><span class="flow-conn__line"></span><span class="material-symbols-outlined" aria-hidden="true">expand_more</span></div>';function ye(){const e=document.getElementById("flow-nodes");if(!e)return;const t=R.length,a=['<div class="flow-start"><span class="material-symbols-outlined" aria-hidden="true">bolt</span> Conversation starts</div>',Tn];R.forEach((n,o)=>{a.push(Dl(n,o,t)),o<t-1&&a.push(Tn)}),e.innerHTML=a.join("")}function Ae(){const e=document.querySelector(".flow-node--open");if(!e)return;const t=R.find(s=>s._uid===e.dataset.uid);if(!t)return;const a=e.querySelector(".flow-f-type");a&&(t.step_type=a.value);const n=e.querySelector(".flow-f-prompts");n&&(t.step_prompts=n.value.split(`
`));const o=e.querySelector(".flow-f-field");if(t.step_columns=o&&o.value.trim()?[o.value.trim()]:[],Ke(t.step_type)){const s=t.step_options,r=[];e.querySelectorAll(".flow-opt").forEach((i,l)=>{r.push({label:i.querySelector(".flow-o-label")?.value??"",icon:i.querySelector(".flow-o-icon")?.value??"",goto:s[l]&&s[l].goto||""})}),t.step_options=r}else t.step_options=[];if(yt(t.step_type)){const s=e.querySelector(".flow-f-mtlabel"),r=e.querySelector(".flow-f-start"),i=e.querySelector(".flow-f-end"),l=e.querySelector(".flow-f-mins");t.step_config={...t.step_config||Ye(),...s?{meeting_label:s.value.trim()}:{},...r&&r.value?{start:r.value}:{},...i&&i.value?{end:i.value}:{},...l?{mins:parseInt(l.value,10)||30}:{}}}else t.step_config=null}function zo(){document.querySelectorAll(".flow-node.drop-before, .flow-node.drop-after").forEach(e=>e.classList.remove("drop-before","drop-after"))}function ut(){zo(),document.querySelectorAll(".flow-node.dragging").forEach(e=>e.classList.remove("dragging")),Me=null,Ge=null}function Bl(e=R){if(!e.length)return"Add at least one step.";for(let t=0;t<e.length;t++){const a=e[t],n=t+1;if(!a.step_prompts.some(o=>String(o).trim()!==""))return`Step ${n}: add what the magnet should say.`;if(Ke(a.step_type)&&!a.step_options.some(o=>String(o.label).trim()!==""))return`Step ${n}: add at least one choice.`;if(Xt(a.step_type)&&!a.step_columns.length)return`Step ${n}: choose which field this answer saves to.`}return""}function wa(e=R){let t=0;return e.forEach(a=>{const n=parseInt(a.id,10);!isNaN(n)&&n>t&&(t=n)}),e.map(a=>{const n=a.id&&String(a.id).trim()?String(a.id):String(++t),o=Ke(a.step_type)?a.step_options.map(r=>{const i={label:String(r.label).trim(),goto:String(r.goto||"")};return r.icon&&(i.icon=String(r.icon)),i}).filter(r=>r.label!==""):[],s={id:n,step_type:a.step_type,step_prompts:a.step_prompts.map(r=>String(r)).filter(r=>r.trim()!==""),step_options:o,step_columns:a.step_columns.slice(),step_description:a.step_description||""};return yt(a.step_type)&&a.step_config&&(s.step_config={...Ye(),...a.step_config}),s})}function Ul(e,t,a){$l(),Uo=t,ya=typeof a=="function"?a:null,$t=t?.modified_tz||"",It=["chat",...["book","support"].filter(n=>(t.actions||[]).some(o=>o&&o.type===n))],ve={chat:Ho("chat",t)},qe="chat",R=ve.chat,Se=R.length===1?R[0]._uid:null,Me=null,Ge=null,e.innerHTML=`
    ...
    ${It.length>1?`<div class="flow-routes"><span class="flow-routes__lbl">Editing flow</span><select class="mag-modal__select" id="flow-route">${It.map(n=>`<option value="${n}">${se(Bo[n]||n)}</option>`).join("")}</select></div>`:""}
...
<body>
  ...
  <\/script>
  <script>${a}<\/script>
</body></html>`}let In=!1;function qo(){if(In)return;const e=document.createElement("style");e.id="m5t-preview-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),In=!0}function Vo(e){return`<div class="pv-hintwrap">
    <p class="pv-hint">${e}</p>
  ...
  </div>`}function jo(e){const t=e.querySelector("[data-pv-info]"),a=e.querySelector("[data-pv-info-pop]");t&&a&&t.addEventListener("click",()=>{a.hidden=!a.hidden})}function Wl(e,t){qo(),e.innerHTML=`
    <div class="pv-pane">
      ...
      ${Vo("Live render of the real widget. Capture is disabled, so no test leads.")}
    </div>`,jo(e);const a=e.querySelector(".pv-pane__frame"),n=e.querySelector(".pv-pane__badge");let o=null,s=0;const r=450,i=()=>{const c=(typeof performance<"u"?performance.now():Date.now())-s;clearTimeout(o),c<r?o=setTimeout(()=>{n.hidden=!0},r-c):n.hidden=!0};a.addEventListener("load",i);const l=()=>{let c;try{c=Go(t())}catch{return}s=typeof performance<"u"?performance.now():Date.now(),n.hidden=!1,a.srcdoc=c,clearTimeout(o),o=setTimeout(()=>{n.hidden=!0},1500)};return e.querySelector(".pv-pane__seg").addEventListener("click",c=>{const g=c.target.closest("button[data-device]");!g||g.dataset.device===a.dataset.device||(e.querySelectorAll(".pv-pane__seg button").forEach(b=>b.classList.toggle("is-on",b===g)),a.dataset.device=g.dataset.device)}),l(),{refresh:l,destroy(){clearTimeout(o)}}}function Wo(e){qo();let t="desktop";const a=document.createElement("div");a.className="pv-scrim",a.innerHTML=`
    <div class="pv-modal" role="dialog" aria-modal="true" aria-label="Magnet preview">
      ...
      <div class="pv-body">
        <div>
          ...
          ${Vo("Live render of the actual widget. Capture is disabled, so no test leads are created.")}
        </div>
      </div>
    </div>`,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("open")),jo(a);const n=a.querySelector(".pv-frame"),o=a.querySelector(".pv-stage"),s=()=>{try{n.srcdoc=Go(e())}catch{}};s();const r=()=>{a.classList.remove("open"),setTimeout(()=>a.remove(),180)};return a.querySelector('[data-x="close"]').addEventListener("click",r),a.querySelector('[data-x="refresh"]').addEventListener("click",s),a.addEventListener("click",i=>{i.target===a&&r()}),a.querySelector(".pv-seg").addEventListener("click",i=>{const l=i.target.closest("button[data-device]");!l||l.dataset.device===t||(t=l.dataset.device,a.querySelectorAll(".pv-seg button").forEach(c=>c.classList.toggle("is-on",c.dataset.device===t)),o.dataset.device=t,s())}),{close:r,rebuild:s}}let $n=!1;const q={magnets:[],owners:[],canProvision:!1,canManage:!1,primaryOrgGuid:null,stats:{}},Yl={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},f=e=>String(e??"").replace(/[&<>"']/g,t=>Yl[t]),Oe=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},Z=()=>x.getConfig?.().BASE_URL||"",Yo=e=>`<script src="${Z()}/m5t/v5/coreSnippet?appguid=${e}" async><\/script>`,Jo=()=>`<details class="mag-csp-note" open>
  ...
  <div class="mag-csp-note__body">
    <p>A strict CSP can silently block the widget — it just never appears, no visible error. Allowlist <code>${f(Z())}</code> under all three directives. Copy-paste ready for your CSP header/meta tag:</p>
    <pre class="mag-csp-note__snippet"><code>script-src 'self' ${f(Z())};
connect-src 'self' ${f(Z())};
img-src 'self' ${f(Z())};</code></pre>
    <ul>
...
</details>`,Jl={chat:"Chat bubble",right_slide:"Slide-in panel",modal:"Modal",inline:"Inline"},Kl={chat:"chat",right_slide:"vertical_split",modal:"web_asset",inline:"view_agenda"},Xl=[{value:"inline",icon:"view_agenda",label:"Inline"},{value:"chat",icon:"chat",label:"Chat"},{value:"right_slide",icon:"vertical_split",label:"Slide"},{value:"modal",icon:"web_asset",label:"Modal"}],Ql=[{value:"auto",icon:"brightness_auto",label:"Auto"},{value:"light",icon:"light_mode",label:"Light"},{value:"dark",icon:"dark_mode",label:"Dark"}],Zl=[{value:"on_load",label:"Immediately on page load"},{value:"on_8_seconds",label:"After 8 seconds"},{value:"on_scroll_80_percent",label:"At 80% scroll depth"},{value:"on_exit_intent",label:"On exit intent (mouse leaves the page)"},{value:"none",label:"Manual only (visitor clicks the launcher)"}],Ko={book:{label:"Book",icon:"event",kind:"book"},chat:{label:"Chat",icon:"chat",kind:"flow"},call:{label:"Call",icon:"phone",kind:"value",placeholder:"Phone number"},email:{label:"Email",icon:"mail",kind:"value",placeholder:"Email address"},support:{label:"Support",icon:"support_agent",kind:"support"}},ec=["book","chat","call","email","support"];let Lt=null;async function tc(){if(Lt)return Lt;let e;try{const t=await fetch(`${Z()}/m5t/v5/integrations/calendly/event_types`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.event_types||[],scheduling_url:a.data.scheduling_url||""}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(Lt=e),e}async function ac(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved Calendly event";e.innerHTML=`<option value="${f(t)}">${t?f(a):"Loading event types"}</option>`;const n=await tc();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${f(t)}" selected>${f(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect Calendly under Settings, Integrations first":"Could not load event types"}</option>`;return}const o=[];n.scheduling_url&&o.push({url:n.scheduling_url,label:"Full scheduling page (visitor picks the event)"}),n.list.forEach(s=>o.push({url:s.scheduling_url,label:s.duration?`${s.name} (${s.duration} min)`:s.name})),t&&!o.some(s=>s.url===t)&&o.unshift({url:t,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${f(s.url)}"${s.url===(t||o[0].url)?" selected":""}>${f(s.label)}</option>`).join(""):'<option value="">No active event types</option>'}let Nt=null;async function nc(){if(Nt)return Nt;let e;try{const t=await fetch(`${Z()}/m5t/v5/integrations/callrail/trackers`),a=await t.json().catch(()=>({}));t.status===404?e={ok:!1,reason:"not_connected"}:a.ok?e={ok:!0,list:a.data.trackers||[]}:e={ok:!1,reason:"error"}}catch{e={ok:!1,reason:"error"}}return e.ok&&(Nt=e),e}async function oc(e){const t=e.dataset.saved||"",a=e.dataset.savedName||"Saved tracking number";e.innerHTML=`<option value="${f(t)}">${t?f(a):"Loading tracking numbers"}</option>`;const n=await nc();if(!n.ok){delete e.dataset.listed,e.innerHTML=t?`<option value="${f(t)}" selected>${f(a)}</option>`:`<option value="">${n.reason==="not_connected"?"Connect CallRail under Settings, Integrations first":"Could not load tracking numbers"}</option>`;return}const o=n.list.map(s=>({number:s.number,id:s.id,name:s.name,label:`${s.name} · ${s.number}${s.type==="session"?" (number pool)":""}`}));t&&!o.some(s=>s.number===t)&&o.unshift({number:t,id:e.dataset.savedId||"",name:a,label:a}),e.innerHTML=o.length?o.map(s=>`<option value="${f(s.number)}" data-tracker-id="${f(s.id)}" data-tracker-name="${f(s.name)}"${s.number===(t||o[0].number)?" selected":""}>${f(s.label)}</option>`).join(""):'<option value="">No active tracking numbers in this company</option>'}function Ln(e,t,a){return`<div class="mag-seg" role="radiogroup" aria-label="${f(e)}">${a.map(n=>`
    <label><input type="radio" name="${f(e)}" value="${f(n.value)}"${n.value===t?" checked":""}>
      <span><span class="material-symbols-outlined" aria-hidden="true">${f(n.icon)}</span>${f(n.label)}</span></label>`).join("")}</div>`}function sc(e,t){const a=Ko[e],n=!!t,o=n?"":" disabled";let s="";if(a.kind==="value"&&e==="call"){const i=t?.config?.source==="callrail",l=i&&t?.value||"",c=i?t?.config?.tracker_name||"Saved tracking number":"";s=`
...
`))}</textarea>`}return`<div class="mag-cta" data-type="${e}" data-kind="${a.kind}">
    ...
    ${r}
  </div>`}function rc(){if($n)return;const e=document.createElement("style");e.id="m5t-magnets-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),$n=!0}function Ut(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function ic(e){const t=q.stats[e];if(!t||!t.opens&&!t.leads)return'<div class="mag-stats"><span><span class="material-symbols-outlined" aria-hidden="true">monitoring</span>No activity yet (30d)</span></div>';const a=n=>Number(n||0).toLocaleString();return`<div class="mag-stats" title="Trailing 30 days">
  ...
  </div>`}function Da(e){const t=q.owners.length>1||x.getMemberships().length>1,a=(e.domains||[]).filter(Boolean),n=q.canManage;return`
    <div class="mag-card" data-guid="${f(e.guid)}">
      ...
      <span class="mag-mode"><span class="material-symbols-outlined" aria-hidden="true">${Kl[e.display_mode]||"chat"}</span>${f(Jl[e.display_mode]||"Chat bubble")}${e.ab?.enabled?'&nbsp;&nbsp;<span class="mag-ab-chip"><span class="material-symbols-outlined" aria-hidden="true">science</span>A/B</span>':""}${(e.notify_emails||[]).length?`&nbsp;&nbsp;<a class="mag-alert-chip" href="#/settings/notifications" title="Lead alerts to ${(e.notify_emails||[]).length} email${(e.notify_emails||[]).length===1?"":"s"}. Manage in Settings."><span class="material-symbols-outlined" aria-hidden="true">notifications_active</span>${(e.notify_emails||[]).length}</a>`:""}</span>
      ${ic(e.guid)}
      <div class="mag-domains">${a.length?a.map(o=>f(o)).join(", "):"<span>No domains set. Add yours to go live.</span>"}</div>
      <div class="mag-embed">
        <input type="text" readonly value="${f(Yo(e.guid))}" aria-label="Embed snippet">
    ...
    </div>`}function lc(){return ne()?bt({section:"magnets",title:"Your Magnets",description:"Pick a client to view and manage their magnets."}):(rc(),`
    <div class="page-shell" data-section="magnets">
      ...
      <div class="dashboard-card">
        <div class="card-body" id="mag-body">
          ${Ut("hourglass_empty","Loading magnets…")}
        </div>
      </div>
    </div>`)}async function cc(){if(ne()){const t=a=>Number(a||0).toLocaleString();return it(Z(),[{h:"Magnets",td:a=>`${t(a.magnets.active)}<span style="color:var(--color-text-subtle,#6C7C9A)">/${t(a.magnets.total)}</span>`},{h:"Leads · wk",td:a=>t(a.leads.this_week)},{h:"Leads · total",td:a=>t(a.leads.total)}],{emptyMsg:"No client orgs yet. Create one under Clients, then provision its magnets here."})}Lt=null,Nt=null,document.getElementById("mag-new-btn")?.addEventListener("click",uc),document.getElementById("mag-body")?.addEventListener("click",mc),await Qt()}async function Qt(){const e=document.getElementById("mag-body");if(!e)return;try{const[a,n]=await Promise.all([fetch(`${Z()}/m5t/v5/magnets`),fetch(`${Z()}/m5t/v5/magnets/stats`).catch(()=>null)]),o=await a.json().catch(()=>({}));if(!o.ok)throw new Error(o.message||"Failed to load");q.magnets=o.magnets||[],q.owners=o.owners||[],q.canProvision=!!o.canProvision,q.canManage=!!o.canManage,q.primaryOrgGuid=o.primaryOrgGuid||null;const s=n?await n.json().catch(()=>({})):{};q.stats=s?.stats||{}}catch{e.innerHTML=Ut("error","Could not load your magnets. Please try again.");return}const t=document.getElementById("mag-new-btn");if(t&&(t.style.display=q.canProvision?"":"none"),!q.magnets.length){e.innerHTML=Ut("widgets",q.canProvision?"No magnets yet. Click “New magnet” to create your first.":"No magnets yet.");return}e.innerHTML=`<div class="mag-grid">${q.magnets.map(Da).join("")}</div>`}async function dc(e){const t={"Content-Type":"application/json","Idempotency-Key":crypto.randomUUID()},a={status:"DRAFT"};e&&(a.owner_guid=e);const n=await fetch(`${Z()}/m5t/v5/magnets`,{method:"POST",headers:t,body:JSON.stringify(a)});let o={};try{o=await n.json()}catch{}if(!n.ok||!o.ok)throw new Error(o.message||`Could not start a new magnet (${n.status})`);return o.magnet}async function Xo(e){const t=document.getElementById("mag-new-btn");t&&(t.disabled=!0);try{const a=await dc(e);q.magnets=[a,...q.magnets];const n=document.getElementById("mag-body");n&&(n.innerHTML=`<div class="mag-grid">${q.magnets.map(Da).join("")}</div>`),Ht(a,void 0,{freshDraft:!0})}catch(a){Oe(a.message||"Could not start a new magnet","danger")}finally{t&&(t.disabled=!1)}}function pc(){const e=document.createElement("div");e.className="mag-modal-scrim",e.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="Choose client" style="max-width:420px">
      <div class="mag-modal__head">
        <span class="mag-modal__title">New magnet</span>
      ...
      <div class="mag-modal__body" style="padding:20px">
        ...
        <select class="mag-modal__select" id="mag-owner-pick">
          ${q.owners.map(n=>`<option value="${f(n.guid)}"${n.guid===q.primaryOrgGuid?" selected":""}>${f(n.name||n.guid)}</option>`).join("")}
        </select>
    ...
    </div>`,document.body.appendChild(e),requestAnimationFrame(()=>{e.classList.add("open"),e.querySelector(".mag-modal").classList.add("open")});const t=()=>{e.classList.remove("open"),setTimeout(()=>e.remove(),180),document.removeEventListener("keydown",a)};function a(n){n.key==="Escape"&&(n.preventDefault(),t())}document.addEventListener("keydown",a),e.querySelector(".mag-modal__close").addEventListener("click",t),e.querySelector('[data-x="cancel"]').addEventListener("click",t),e.querySelector('[data-x="continue"]').addEventListener("click",()=>{const n=e.querySelector("#mag-owner-pick").value;t(),Xo(n)})}function uc(){if(q.owners.length>1){pc();return}Xo(null)}function mc(e){const t=e.target.closest("[data-action]");if(!t)return;const a=t.dataset.guid,n=q.magnets.find(s=>s.guid===a),o=t.dataset.action;if(o==="copy")return gc(a);if(n){if(o==="preview")return Wo(()=>xa(n));if(o==="funnel")return hc(n);if(o==="edit")return Ht(n);if(o==="flow")return Ht(n,"flow");if(o==="toggle")return fc(n);if(o==="delete")return vc(n)}}async function gc(e){try{await navigator.clipboard.writeText(Yo(e)),Oe("Embed snippet copied","success")}catch{Oe("Copy failed","danger")}}function Qo(e){const t=Number(e?.total_steps)||0,a={};if((Array.isArray(e?.funnel)?e.funnel:[]).forEach(s=>{a[s.position]=Number(s.reached)||0}),!t||!Object.keys(a).length)return'<p class="mag-modal__hint" style="margin:0">No step activity yet in this window. As visitors answer questions, drop-off by step will appear here.</p>';const n=Math.max(1,a[1]||0),o=[];for(let s=1;s<=t;s++){const r=a[s]||0,i=Math.min(100,Math.round(r/n*100));o.push(`
      ...
      </div>`)}return`<div class="mag-funnel">${o.join("")}</div>`}async function hc(e){const t=document.createElement("div");t.className="mag-modal-scrim",t.innerHTML=`
    <div class="mag-modal mag-funnel-modal" role="dialog" aria-modal="true" aria-label="Step funnel for ${f(e.name)}">
      ...
      <div class="mag-modal__body" style="padding:20px">
        ...
        <div id="mag-funnel-body">${Ut("hourglass_empty","Loading…")}</div>
      </div>
    </div>`,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("open"),t.querySelector(".mag-modal").classList.add("open")});const a=()=>{t.classList.remove("open"),setTimeout(()=>t.remove(),180),document.removeEventListener("keydown",n)};function n(s){s.key==="Escape"&&(s.preventDefault(),a())}document.addEventListener("keydown",n),t.querySelector(".mag-modal__close").addEventListener("click",a),t.addEventListener("click",s=>{s.target===t&&a()});const o=t.querySelector("#mag-funnel-body");try{const s=await fetch(`${Z()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}/step-funnel`),r=await s.json().catch(()=>({}));if(!s.ok||!r.ok)throw new Error(r.message||`Failed (${s.status})`);o.innerHTML=Qo(r)}catch{o.innerHTML='<p class="mag-modal__hint" style="margin:0">Could not load the funnel. Please try again.</p>'}}async function fc(e){if(e.status==="DRAFT"){Oe("Open Edit and Save to publish a draft magnet.","info");return}const t=e.status==="ENABLED"?"DISABLED":"ENABLED";try{if(!(await(await fetch(`${Z()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:t})})).json().catch(()=>({}))).ok)throw new Error;Oe(t==="ENABLED"?"Magnet enabled":"Magnet disabled","success")}catch{Oe("Update failed","danger");return}try{await Qt()}catch(a){console.warn("[magnets] refresh after status toggle failed:",a)}}async function vc(e){if(window.confirm(`Delete “${e.name}”? Visitors will no longer see this magnet.`)){try{if(!(await(await fetch(`${Z()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"})).json().catch(()=>({}))).ok)throw new Error;Oe("Magnet deleted","success")}catch{Oe("Delete failed","danger");return}try{await Qt()}catch(t){console.warn("[magnets] refresh after delete failed:",t)}}}function la(e){const t=[];return e.querySelectorAll(".mag-cta").forEach(a=>{if(!a.querySelector(".mag-cta__on").checked)return;const n=a.dataset.type,o=a.dataset.kind,s=a.querySelector(".mag-cta__val"),r=s?s.value.trim():"";if(o==="value")if(n==="call"&&a.querySelector(".mag-cta__callsrc")?.value==="callrail"){const i=a.querySelector(".mag-cta__crtracker"),l=i?.value||"",c=i?.selectedOptions?.[0];l&&t.push({type:n,value:l,config:{source:"callrail",...c?.dataset?.trackerId?{tracker_id:c.dataset.trackerId}:{},...c?.dataset?.trackerName?{tracker_name:c.dataset.trackerName}:{}}})}else r&&t.push({type:n,value:r});else if(o==="book")if(a.querySelector(".mag-cta__booksrc")?.value==="calendly"){const i=a.querySelector(".mag-cta__calevent"),l=i?.value||"",c=(i?.selectedOptions?.[0]?.textContent||"").trim();t.push({type:n,config:{source:"calendly",...l?{calendly_url:l}:{},...l&&c?{event_name:c}:{}}})}else{const i={type:n};r&&(/^https?:\/\//i.test(r)?i.value=r:i.config={meeting_label:r}),t.push(i)}else if(o==="support"){const i=(a.querySelector(".mag-cta__opts")?.value||"").split(`
`).map(c=>c.trim()).filter(Boolean).map(c=>({label:c})),l={type:n};i.length&&(l.config={options:i}),t.push(l)}else t.push({type:n})}),{display_mode:e.querySelector('input[name="mag-display"]:checked')?.value||"chat",trigger:e.querySelector("#mag-f-trigger")?.value||"on_load",theme_mode:e.querySelector('input[name="mag-theme"]:checked')?.value||"auto",title:e.querySelector("#mag-f-title").value.trim(),theme_color:e.querySelector("#mag-f-color").value,subtitle:e.querySelector("#mag-f-subtitle").value,launcher_label:e.querySelector("#mag-f-launcher").value.trim(),logo_url:e.querySelector("#mag-f-logo").value.trim(),logo_fit:e.querySelector("#mag-f-logo-fit")?.value==="contain"?"contain":"cover",summary:e.querySelector("#mag-f-summary").checked,summary_heading:e.querySelector("#mag-f-summary-heading").value.trim(),home:e.querySelector("#mag-f-home").checked,welcome:e.querySelector("#mag-f-welcome").value,ab:Zo(e),actions:t,font:e.querySelector("#mag-f-font").value.trim(),theme_vars:Ec(e),inline_width:e.querySelector("#mag-f-inline-w").value.trim(),inline_height:e.querySelector("#mag-f-inline-h").value.trim(),hide_launcher:e.querySelector("#mag-f-hide-launcher").checked,input_placeholder:e.querySelector("#mag-f-input-ph").value,summary_confirm_label:e.querySelector("#mag-f-summary-confirm").value.trim(),success_title:e.querySelector("#mag-f-success-title").value.trim(),success_text:e.querySelector("#mag-f-success-text").value,success_cta:Sc(e)}}const _c=512,bc=new Set(["image/png","image/jpeg","image/gif","image/webp"]),yc=8*1024*1024;function wc(e){return new Promise((t,a)=>{const n=new Image,o=new FileReader;o.onerror=()=>a(new Error("Could not read that file.")),o.onload=()=>{n.onerror=()=>a(new Error("That file isn’t a readable image.")),n.onload=()=>{const s=Math.min(1,_c/Math.max(n.naturalWidth,n.naturalHeight)),r=Math.max(1,Math.round(n.naturalWidth*s)),i=Math.max(1,Math.round(n.naturalHeight*s)),l=document.createElement("canvas");l.width=r,l.height=i,l.getContext("2d").drawImage(n,0,0,r,i),t(l.toDataURL("image/png"))},n.src=o.result},o.readAsDataURL(e)})}function xc(e,t){const a=e.querySelector("#mag-logo-drop");if(!a)return;const n=e.querySelector("#mag-f-logo-file"),o=e.querySelector("#mag-logo-browse"),s=e.querySelector("#mag-logo-remove"),r=e.querySelector("#mag-logo-preview"),i=e.querySelector("#mag-logo-status"),l=e.querySelector("#mag-f-logo"),c=(_,w)=>{i.textContent=_,i.style.color=w?"var(--color-danger, #DD4124)":""},g=_=>{r.innerHTML=_?`<img src="${f(_)}" alt="">`:'<span class="material-symbols-outlined" aria-hidden="true">image</span>',s.hidden=!_},b=_=>{l.value=_,l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))};async function y(_){if(!bc.has(_.type)){c("PNG, JPEG, GIF, or WEBP only.",!0);return}if(_.size>yc){c("That file is too large (8MB max before resizing).",!0);return}c("Uploading…",!1);try{const w=await wc(_),d=await fetch(`${Z()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({image:w})}),h=await d.json().catch(()=>({}));if(!d.ok||!h.ok)throw new Error(h.error||`Upload failed (${d.status})`);const v=`${Z()}/m5t/v5/magnet/${encodeURIComponent(t.guid)}/logo?v=${Date.now()}`;b(v),g(v),c("Logo updated.",!1)}catch(w){c(w.message||"Upload failed.",!0)}}n.addEventListener("change",()=>{n.files[0]&&y(n.files[0]),n.value=""}),a.addEventListener("click",_=>{_.target===s||s.contains(_.target)||_.target!==o&&n.click()}),o.addEventListener("click",()=>n.click()),["dragenter","dragover"].forEach(_=>a.addEventListener(_,w=>{w.preventDefault(),a.classList.add("is-dragover")})),["dragleave","drop"].forEach(_=>a.addEventListener(_,w=>{w.preventDefault(),a.classList.remove("is-dragover")})),a.addEventListener("drop",_=>{const w=_.dataTransfer?.files?.[0];w&&y(w)}),s.addEventListener("click",async _=>{_.stopPropagation(),c("Removing…",!1);try{const w=await fetch(`${Z()}/m5t/v5/magnets/${encodeURIComponent(t.guid)}/logo`,{method:"DELETE"}),d=await w.json().catch(()=>({}));if(!w.ok||!d.ok)throw new Error(d.error||`Remove failed (${w.status})`);b(""),g(""),c("Logo removed.",!1)}catch(w){c(w.message||"Remove failed.",!0)}})}function Ec(e){return e.querySelector("#mag-f-surface-on")?.checked?{surface:e.querySelector("#mag-f-sv-surface").value,surface_2:e.querySelector("#mag-f-sv-surface2").value,border:e.querySelector("#mag-f-sv-border").value,text:e.querySelector("#mag-f-sv-text").value,text_sub:e.querySelector("#mag-f-sv-textsub").value}:{}}function Sc(e){const t=e.querySelector("#mag-f-success-cta-label").value.trim(),a=e.querySelector("#mag-f-success-cta-url").value.trim();return t&&a?{label:t,url:a}:{}}function Zo(e){const t={},a=e.querySelector("#mag-f-ab-title")?.value.trim(),n=e.querySelector("#mag-f-ab-welcome")?.value.trim(),o=e.querySelector("#mag-f-ab-color")?.value||"",s=e.querySelector("#mag-f-color")?.value||"";return a&&(t.title=a),n&&(t.welcome=n),o&&o.toLowerCase()!==s.toLowerCase()&&(t.theme_color=o),{enabled:!!e.querySelector("#mag-f-ab")?.checked,split:Number(e.querySelector("#mag-f-ab-split")?.value)||50,b:t}}const Nn=[{label:"Web fonts (loaded for you)",opts:[["Inter, sans-serif","Inter"],["Poppins, sans-serif","Poppins"],["Montserrat, sans-serif","Montserrat"],["Roboto, sans-serif","Roboto"],['"Open Sans", sans-serif',"Open Sans"],["Lato, sans-serif","Lato"],["Nunito, sans-serif","Nunito"],["Raleway, sans-serif","Raleway"],['"Work Sans", sans-serif',"Work Sans"],["Oswald, sans-serif","Oswald"],["Merriweather, serif","Merriweather (serif)"]]},{label:"System / always available",opts:[["system-ui, sans-serif","System UI"],["Georgia, serif","Georgia (serif)"],['"Times New Roman", Times, serif',"Times (serif)"],["Arial, Helvetica, sans-serif","Arial / Helvetica"],["Verdana, Geneva, sans-serif","Verdana"],['"Courier New", monospace',"Courier (mono)"]]}];function Ac(e){const t=String(e||""),a=new Set(Nn.flatMap(s=>s.opts.map(([r])=>r))),n=s=>s===t?" selected":"";let o=`<option value=""${t===""?" selected":""}>System default</option>`;t&&!a.has(t)&&(o+=`<option value="${f(t)}" selected>Current: ${f(t)}</option>`);for(const s of Nn)o+=`<optgroup label="${f(s.label)}">`+s.opts.map(([r,i])=>`<option value="${f(r)}"${n(r)}>${f(i)}</option>`).join("")+"</optgroup>";return o}function Ht(e,t,a={}){const{freshDraft:n=!1}=a,o=!!e,s=o?null:crypto.randomUUID(),r=!o&&q.owners.length>1,i=e?.display_mode||"chat",l=e?.theme_mode||"auto",c={};(e?.actions||[]).forEach(S=>{S&&S.type&&(c[S.type]=S)});const g=o?!!e.home:!0,b=o?e.subtitle!=null?e.subtitle:"":"Typically replies in a few minutes",y=e?.theme_vars&&typeof e.theme_vars=="object"?e.theme_vars:{},_=Object.keys(y).length>0,w=(S,P)=>f(/^#[0-9a-fA-F]{6}$/.test(y[S]||"")?y[S]:P),d=document.createElement("div");d.className="mag-modal-scrim",d.innerHTML=`
    <div class="mag-modal" role="dialog" aria-modal="true" aria-label="${o?"Edit magnet":"New magnet"}">
      ...
      <div class="mag-modal__main">
        ...
        <select class="mag-modal__select" id="mag-f-owner">
          ${q.owners.map(S=>`<option value="${f(S.guid)}"${S.guid===q.primaryOrgGuid?" selected":""}>${f(S.name||S.guid)}</option>`).join("")}
        </select>`:""}
        ...
        <select class="mag-modal__select" id="mag-f-trigger">
          ${Zl.map(S=>`<option value="${S.value}"${(e?e.trigger||"none":"on_load")===S.value?" selected":""}>${f(S.label)}</option>`).join("")}
        </select>
        ...
        <div class="mag-modal__sec">
          ...
          <select class="mag-modal__select" id="mag-f-font">${Ac(e?.font||"")}</select>
    ...
    </div>`,document.body.appendChild(d),requestAnimationFrame(()=>{d.classList.add("open"),d.querySelector(".mag-modal").classList.add("open")});const h=[...d.querySelectorAll(".mag-modal__navitem")],v=[...d.querySelectorAll(".mag-tab")],k=S=>{h.forEach(P=>P.classList.toggle("is-active",P.dataset.tab===S)),v.forEach(P=>{P.hidden=P.dataset.tab!==S}),d.querySelector(".mag-modal__body").scrollTop=0};h.forEach(S=>S.addEventListener("click",()=>k(S.dataset.tab)));const N=()=>xa({...e,...la(d),...o?{steps:Cn()}:{}}),B=d.querySelector("#mag-preview-pane"),ae=()=>window.matchMedia("(min-width: 1200px)").matches;let Y=null;const le=()=>{if(!Y&&ae())try{Y=Wl(B,N)}catch{}};let we=null;const ce=()=>{ae()&&(le(),Y&&(clearTimeout(we),we=setTimeout(()=>{try{Y.refresh()}catch{}},300)))},Re=window.matchMedia("(min-width: 1200px)"),Ce=()=>{ae()&&(le(),ce())};Re.addEventListener("change",Ce);let O=!1,I=!1;const V=d.querySelector("#mag-f-dirty"),Ie=S=>{O=S,V&&(V.hidden=!S)},wt=d.querySelector(".mag-modal__main");wt.addEventListener("input",()=>Ie(!0)),wt.addEventListener("change",()=>{Ie(!0),ce()}),d.querySelector("#mag-f-color")?.addEventListener("input",()=>{Ie(!0),ce()});const Ue=S=>{O&&(S.preventDefault(),S.returnValue="")};window.addEventListener("beforeunload",Ue);let lt=!0;const Zt=p.subscribe(u.ROUTE_NAV_BEFORE,()=>{if(lt){if(O&&!confirm("Discard your changes to this magnet?")){window.router?.navigate("/magnets");return}m()}}),m=()=>{if(n&&!I&&e&&e.status==="DRAFT"){fetch(`${Z()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`,{method:"DELETE"}).catch(()=>{}),q.magnets=q.magnets.filter(P=>P.guid!==e.guid);const S=document.getElementById("mag-body");S&&(S.innerHTML=`<div class="mag-grid">${q.magnets.map(Da).join("")}</div>`)}lt=!1,window.removeEventListener("beforeunload",Ue),p.unsubscribe(Zt),clearTimeout(we),Re.removeEventListener("change",Ce),Y&&Y.destroy&&Y.destroy(),d.classList.remove("open"),setTimeout(()=>d.remove(),180),document.removeEventListener("keydown",$)},E=()=>{O&&!confirm("Discard your changes to this magnet?")||m()};function $(S){S.key==="Escape"&&(S.preventDefault(),E())}document.addEventListener("keydown",$),d.querySelector(".mag-modal__close").addEventListener("click",E),d.querySelector('[data-x="cancel"]').addEventListener("click",E),d.querySelector("[data-close-modal]")?.addEventListener("click",E),d.querySelector("#mag-f-name").focus();const U=d.querySelector("#mag-flow-panel");o?Ul(U,e,()=>{Ie(!0),ce()}):U.innerHTML='<p class="mag-modal__hint" style="margin-top:0">Your new magnet starts with a simple starter conversation. Create it first, then reopen it here to build the flow.</p>',xc(d,e),t&&k(t),le(),d.querySelectorAll(".mag-cta").forEach(S=>{const P=S.querySelector(".mag-cta__on"),oe=S.querySelector(".mag-cta__val"),K=S.querySelector(".mag-cta__opts"),$e=S.querySelectorAll(".mag-cta__booksrc, .mag-cta__calevent, .mag-cta__callsrc, .mag-cta__crtracker");P.addEventListener("change",()=>{oe&&(oe.disabled=!P.checked),K&&(K.disabled=!P.checked),$e.forEach(G=>{G.disabled=!P.checked}),P.checked&&(oe||K)?.focus()}),oe&&oe.addEventListener("input",()=>{oe.value.trim()&&!P.checked&&(P.checked=!0,K&&(K.disabled=!1))})}),d.querySelectorAll('.mag-cta[data-kind="book"]').forEach(S=>{const P=S.querySelector(".mag-cta__booksrc"),oe=S.querySelector(".mag-cta__val"),K=S.querySelector(".mag-cta__calevent");if(!P||!K)return;const $e=()=>{const G=P.value==="calendly";oe.hidden=G,K.hidden=!G,G&&!K.dataset.listed&&(K.dataset.listed="1",ac(K))};P.addEventListener("change",()=>{const G=S.querySelector(".mag-cta__on");G.checked||(G.checked=!0,G.dispatchEvent(new Event("change"))),$e()}),$e()}),d.querySelectorAll('.mag-cta[data-type="call"]').forEach(S=>{const P=S.querySelector(".mag-cta__callsrc"),oe=S.querySelector(".mag-cta__val"),K=S.querySelector(".mag-cta__crtracker");if(!P||!K)return;const $e=()=>{const G=P.value==="callrail";oe.hidden=G,K.hidden=!G,G&&!K.dataset.listed&&(K.dataset.listed="1",oc(K))};P.addEventListener("change",()=>{const G=S.querySelector(".mag-cta__on");G.checked||(G.checked=!0,G.dispatchEvent(new Event("change"))),$e()}),$e()});const M=d.querySelector("#mag-f-surface-on"),be=d.querySelector("#mag-f-surface");M.addEventListener("change",()=>be.hidden=!M.checked);const He=d.querySelector("#mag-f-inline-size");d.querySelectorAll('input[name="mag-display"]').forEach(S=>S.addEventListener("change",()=>{He.hidden=d.querySelector('input[name="mag-display"]:checked')?.value!=="inline"})),d.querySelector('[data-x="preview"]')?.addEventListener("click",()=>Wo(()=>xa({...e,...la(d),...o?{steps:Cn()}:{}}))),d.querySelector('[data-x="save"]').addEventListener("click",async S=>{const P=S.currentTarget,oe=d.querySelector("#mag-f-error"),K=d.querySelector("#mag-f-name").value.trim();if(!K){k("basics"),oe.textContent="Please give your magnet a name.";return}const $e=d.querySelector("#mag-f-domains").value.split(",").map(X=>X.trim()).filter(Boolean);let G="";if(d.querySelectorAll(".mag-cta").forEach(X=>{const Xe=X.querySelector(".mag-cta__on").checked;if(X.dataset.kind==="book"){const dt=X.querySelector(".mag-cta__booksrc")?.value==="calendly";Xe&&dt&&!X.querySelector(".mag-cta__calevent")?.value&&(G=G||"Pick a Calendly event for the Book button, or switch it back to the built-in scheduler.");return}if(X.dataset.kind!=="value")return;if(X.dataset.type==="call"&&X.querySelector(".mag-cta__callsrc")?.value==="callrail"){Xe&&!X.querySelector(".mag-cta__crtracker")?.value&&(G=G||"Pick a CallRail tracking number for the Call button, or switch it back to a phone number.");return}const ct=X.querySelector(".mag-cta__val").value.trim();Xe&&!ct&&(G=G||`Add a target for the ${Ko[X.dataset.type].label} button, or uncheck it.`)}),G){k("welcome"),oe.textContent=G;return}const Ha=Zo(d);if(Ha.enabled&&!Object.keys(Ha.b).length){k("ab"),oe.textContent="Give variant B at least one change (title, welcome, or color), or untick the A/B test.";return}if(o){const X=zl();if(X){k("flow"),Gl(X.route,X.message);return}}const ea={name:K,domains:$e,...la(d)};r&&(ea.owner_guid=d.querySelector("#mag-f-owner").value);const za=o&&e.status==="DRAFT";za&&(ea.status="ENABLED"),P.disabled=!0,oe.textContent="";try{const X=o?`${Z()}/m5t/v5/magnets/${encodeURIComponent(e.guid)}`:`${Z()}/m5t/v5/magnets`,Xe={"Content-Type":"application/json"};s&&(Xe["Idempotency-Key"]=s);const ct=await fetch(X,{method:o?"PATCH":"POST",headers:Xe,body:JSON.stringify(ea)});let dt={};try{dt=await ct.json()}catch{}if(!ct.ok||!dt.ok)throw new Error(dt.message||`Save failed (${ct.status})`);o&&await Vl(e.guid),Oe(za||!o?"Magnet created":"Magnet updated","success"),I=!0,m(),await Qt()}catch(X){P.disabled=!1,oe.textContent=X.message||"Something went wrong."}})}const kc=Object.freeze(Object.defineProperty({__proto__:null,cspNoteHTML:Jo,init:cc,openModal:Ht,render:lc,stepFunnelHTML:Qo},Symbol.toStringTag,{value:"Module"}));let On=!1;const A={leads:[],magnetNames:{},filter:"ALL",canManage:!1,book:!1,ownerNames:{},clientFilter:"ALL",search:"",shown:100,selectedId:null},vt=100,Ea=["NEW","WORKING","QUALIFIED","UNQUALIFIED","CONVERTED","EXPORTED"],Tc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},L=e=>String(e??"").replace(/[&<>"']/g,t=>Tc[t]),zt=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},Gt=()=>x.getConfig?.().BASE_URL||"",qt=e=>[e.first_name,e.last_name].filter(Boolean).join(" ").trim()||e.email||"(no name)",es=e=>(qt(e).split(/\s+/).slice(0,2).map(t=>t[0]||"").join("")||"?").toUpperCase(),Ba=e=>e.created?.created_tz||"";function tt(e){const t=Ba(e);if(!t)return"";try{return new Date(t).toLocaleDateString([],{month:"short",day:"numeric",year:"numeric"})}catch{return""}}function Cc(e){const t=Ba(e);if(!t)return"";try{const a=Date.now()-new Date(t).getTime();if(a<0)return tt(e);const n=a/36e5;return n<1?`${Math.max(1,Math.floor(a/6e4))}m ago`:n<24?`${Math.floor(n)}h ago`:n<48?"Yesterday":tt(e)}catch{return tt(e)}}const Ic=e=>{const t=Ba(e);if(!t)return!1;try{return Date.now()-new Date(t).getTime()<24*36e5}catch{return!1}};function $c(){if(On)return;const e=document.createElement("style");e.id="m5t-leads-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),On=!0}function _t(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Lc(e){return`<select class="leads-status" data-id="${L(e.id)}" data-act="status" onclick="event.stopPropagation()">
    ${Ea.map(t=>`<option value="${t}" ${e.status===t?"selected":""}>${t[0]}${t.slice(1).toLowerCase()}</option>`).join("")}
  </select>`}function Nc(e){const t=A.magnetNames[e.magnet_guid]||e.lead_source||"—",a=e.phone?String(e.phone).replace(/[^\d+]/g,""):"";return`
    <tr class="leads-row${String(e.id)===A.selectedId?" selected":""}" data-id="${L(e.id)}" tabindex="0" role="button" aria-label="Open lead ${L(qt(e))}">
      <td>
        <span class="leads-who">
          <span class="leads-avatar">${L(es(e))}</span>
          <span><span class="leads-name">${L(qt(e))}</span>${e.company?`<span class="leads-sub">${L(e.company)}</span>`:""}</span>
        </span>
      </td>
      ${A.book?`<td>${fo(A.ownerNames[e.owner_guid]||"")||'<span class="leads-muted">—</span>'}</td>`:""}
      <td>
      ...
      <td>${A.canManage?Lc(e):`<span class="leads-badge" data-s="${L(e.status)}">${L(e.status)}</span>`}</td>
      <td class="num leads-muted" style="white-space:nowrap" title="${L(tt(e))}">${Ic(e)?'<span class="leads-fresh" title="Captured in the last 24 hours"></span>':""}${L(Cc(e))}</td>
      <td class="leads-open" aria-hidden="true"><span class="material-symbols-outlined">chevron_right</span></td>
    </tr>`}const ts=e=>A.clientFilter==="ALL"||e.owner_guid===A.clientFilter;function Oc(e){const t=A.search.trim().toLowerCase();if(!t)return!0;const a=[e.first_name,e.last_name,e.email,e.company,e.phone,e.product_interest,A.magnetNames[e.magnet_guid],A.book?A.ownerNames[e.owner_guid]:""].filter(Boolean).join(" ").toLowerCase();return t.split(/\s+/).every(n=>a.includes(n))}function as(){return A.leads.filter(e=>(A.filter==="ALL"||e.status===A.filter)&&ts(e)&&Oc(e))}const ns=()=>_t("touch_app","Click to see lead information.");function Rc(){$c(),rt();const e=ne();return`
    <div class="page-shell" data-section="leads">
      ...
      <div class="leads-layout">
        ...
        <aside class="dashboard-card leads-panel" aria-label="Lead detail">
          <div class="card-body" id="leads-panel-body">${ns()}</div>
        </aside>
      </div>
    </div>`}async function Mc(){if(document.getElementById("leads-export")?.addEventListener("click",Bc),ne()){const e=t=>Number(t||0).toLocaleString();it(Gt(),[{h:"Leads · wk",td:t=>e(t.leads.this_week)},{h:"Leads · total",td:t=>e(t.leads.total)},{h:"Compl.",td:t=>t.completion_rate!=null?`${t.completion_rate}%`:"—"}],{emptyMsg:"No client orgs yet. Create one under Clients first."})}await Fc()}async function Fc(){const e=document.getElementById("leads-body");if(e){try{const[t,a]=await Promise.all([fetch(`${Gt()}/m5t/v5/m5mLead`),fetch(`${Gt()}/m5t/v5/magnets`).catch(()=>null)]),n=await t.json().catch(()=>({}));if(!n.ok)throw new Error(n.message||"Failed to load");if(A.leads=(n.data||[]).filter(o=>!["DELETED","ARCHIVED"].includes(o.status)),A.book=ne(),A.ownerNames=A.book?ho():{},a){const o=await a.json().catch(()=>({}));A.magnetNames={},(o.magnets||[]).forEach(s=>{A.magnetNames[s.guid]=s.name,s.owner_guid&&s.owner_name&&!A.ownerNames[s.owner_guid]&&(A.ownerNames[s.owner_guid]=s.owner_name)}),A.canManage=!!o.canManage}}catch{e.innerHTML=_t("error","Could not load your leads. Please try again.");return}Vt()}}const Pc=()=>`
  <colgroup>
    <col style="width:23%">
  ...
  </colgroup>`;function Vt(){const e=document.getElementById("leads-body"),t=document.getElementById("leads-export");if(!e)return;if(t&&(t.style.display=A.leads.length?"":"none"),!A.leads.length){e.innerHTML=_t("inbox","No leads captured yet. Publish a magnet and share it to start collecting.");return}const a=A.leads.filter(ts),n={ALL:a.length};Ea.forEach(s=>{n[s]=a.filter(r=>r.status===s).length});const o=A.book?[...new Set(A.leads.map(s=>s.owner_guid).filter(Boolean))].map(s=>({guid:s,name:A.ownerNames[s]||s})).sort((s,r)=>s.name.localeCompare(r.name)):[];e.innerHTML=`
    <div class="leads-bar">
    ...
    <div id="leads-tablezone"></div>`,e.querySelector(".leads-filter")?.addEventListener("click",s=>{const r=s.target.closest("[data-filter]");r&&(A.filter=r.dataset.filter,A.shown=vt,Vt())}),e.querySelector("#leads-clientsel")?.addEventListener("change",s=>{A.clientFilter=s.target.value,A.shown=vt,Vt()}),e.querySelector("#leads-search")?.addEventListener("input",s=>{A.search=s.target.value,A.shown=vt,Sa()}),Sa()}function Sa(){const e=document.getElementById("leads-tablezone"),t=document.getElementById("leads-countlbl");if(!e)return;const a=as(),n=a.slice(0,A.shown),o=A.book?8:7;t&&(t.textContent=`${a.length} of ${A.leads.length}`),e.innerHTML=`
    <div class="leads-tablewrap">
      <table class="leads-table">
        ...
        <tbody id="leads-tbody">${n.map(Nc).join("")||`<tr><td colspan="${o}"><div class="leads-muted" style="padding:14px 4px">${A.search.trim()?"No leads match your search.":`No ${A.filter.toLowerCase()} leads.`}</div></td></tr>`}</tbody>
      </table>
    </div>
    ${a.length>A.shown?`<button class="leads-more" type="button" id="leads-more">Show ${Math.min(vt,a.length-A.shown)} more (${a.length-A.shown} remaining)</button>`:""}`,e.querySelector("#leads-more")?.addEventListener("click",()=>{A.shown+=vt,Sa()}),e.querySelector("#leads-tbody")?.addEventListener("change",Dc),e.querySelector("#leads-tbody")?.addEventListener("click",s=>{if(s.target.closest(".leads-status, a.leads-contactlink"))return;const r=s.target.closest(".leads-row");r&&Rn(r.dataset.id)}),e.querySelector("#leads-tbody")?.addEventListener("keydown",s=>{if(s.key!=="Enter"&&s.key!==" ")return;const r=s.target.closest(".leads-row");r&&s.target===r&&(s.preventDefault(),Rn(r.dataset.id))})}async function Dc(e){const t=e.target.closest(".leads-status");if(!t)return;const a=t.dataset.id,n=A.leads.find(r=>String(r.id)===String(a)),o=t.value,s=n?.status;try{if(!(await(await fetch(`${Gt()}/m5t/v5/m5mLead/${encodeURIComponent(a)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({status:o})})).json().catch(()=>({}))).ok)throw new Error;n&&(n.status=o),zt(`Marked ${o[0]}${o.slice(1).toLowerCase()}`,"success")}catch{t.value=s||"NEW",zt("Could not update status","danger");return}try{String(a)===A.selectedId&&rs(),A.filter!=="ALL"&&Vt()}catch(r){console.warn("[leads] re-render after status change failed:",r)}}function Rn(e){A.selectedId=String(e),document.querySelectorAll(".leads-row").forEach(t=>t.classList.toggle("selected",t.dataset.id===A.selectedId)),rs()}function St(e,t){const a=Array.isArray(e.tags)?e.tags:[];for(let n=a.length-1;n>=0;n--)if(a[n]&&a[n].tag===t&&a[n].value!=null)return String(a[n].value);return""}function os(e){const t=St(e,"appointment_start");if(!t)return null;const a=St(e,"appointment_status")||"booked",n=St(e,"appointment_timezone"),o=St(e,"appointment_event_type"),s=new Date(t);let r=t;if(!Number.isNaN(s.getTime())){const i={weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"};try{r=new Intl.DateTimeFormat(void 0,n?{...i,timeZone:n}:i).format(s)}catch{r=new Intl.DateTimeFormat(void 0,i).format(s)}}return{when:r,status:a,type:o,start:t}}const Mn={booked:["QUALIFIED","Booked"],rescheduled:["WORKING","Rescheduled"],canceled:["CANCELED","Canceled"]};function ss(e){const t=Array.isArray(e.tags)?e.tags:[];let a=null;for(const l of t)if(!(!l||!l.tag)){if(l.tag==="callrail_call_id"){a={};continue}a&&l.tag.indexOf("call_")===0&&l.value!=null&&(a[l.tag]=String(l.value))}if(!a||!a.call_started)return null;const n=a.call_started,o=new Date(n);let s=n;Number.isNaN(o.getTime())||(s=new Intl.DateTimeFormat(void 0,{weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit"}).format(o));const r=Number(a.call_duration)||0,i=r?r<60?`${r}s`:`${Math.floor(r/60)}m ${r%60}s`:"";return{when:s,dur:i,source:a.call_source||"",answered:a.call_answered||"",recording:a.call_recording_player||"",started:n}}function rs(){const e=document.getElementById("leads-panel-body");if(!e)return;const t=A.leads.find(l=>String(l.id)===A.selectedId);if(!t){e.innerHTML=ns();return}const a=A.magnetNames[t.magnet_guid]||t.lead_source||"—",n=os(t),[o,s]=n?Mn[n.status]||Mn.booked:["",""],r=ss(t),i=(l,c)=>c?`<div class="leads-det__field"><span class="leads-det__k">${L(l)}</span><span class="leads-det__v">${L(c)}</span></div>`:"";e.innerHTML=`
    <div class="leads-det__head">
      <span class="leads-avatar leads-det__ava">${L(es(t))}</span>
      <div>
        <div class="leads-det__name">${L(qt(t))}</div>
    ...
    ${t.description?`<div class="leads-det__notes">${L(t.description)}</div>`:""}`}function Bc(){const e=as();if(!e.length){zt("Nothing to export","info");return}const t=["first_name","last_name","email","phone","company","product_interest","lead_source","utm_source","utm_medium","utm_campaign","gclid","status"],a=l=>`"${String(l??"").replace(/"/g,'""')}"`,o=[[...A.book?["client"]:[],...t,"magnet","captured","appointment","last_call"].join(",")];for(const l of e){const c=os(l),g=ss(l);o.push([...A.book?[a(A.ownerNames[l.owner_guid]||"")]:[],...t.map(b=>a(l[b])),a(A.magnetNames[l.magnet_guid]||l.lead_source||""),a(tt(l)),a(c?`${c.start} (${c.status})`:""),a(g?`${g.started} (${g.answered==="no"?"missed":"answered"})`:"")].join(","))}const s=new Blob([o.join(`
`)],{type:"text/csv"}),r=URL.createObjectURL(s),i=document.createElement("a");i.href=r,i.download=`leads-${A.filter.toLowerCase()}.csv`,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r),zt(`Exported ${e.length} lead${e.length===1?"":"s"}`,"success")}const Uc=Object.freeze(Object.defineProperty({__proto__:null,init:Mc,render:Rc},Symbol.toStringTag,{value:"Module"})),is=()=>x.getConfig?.().BASE_URL||"",Fn=e=>e.toISOString().slice(0,10),Pn=e=>e==null?"—":"$"+Number(e).toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:2}),et=e=>Number(e||0).toLocaleString(),Hc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},At=e=>String(e??"").replace(/[&<>"']/g,t=>Hc[t]);let Dn=!1;function zc(){if(Dn)return;const e=document.createElement("style");e.id="m5t-adperf-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Dn=!0}const at=(e,t)=>`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`,kt=(e,t,a,n="—")=>`
  <div class="stat-card">
    <div class="stat-header">
      <span class="material-symbols-outlined stat-icon" aria-hidden="true">${e}</span>
      <span class="stat-label">${t}</span>
  ...
  </div>`,Gc=[{d:7,label:"7 Days"},{d:30,label:"30 Days"},{d:90,label:"90 Days"}];let jt=30;function ls(){return ne()?bt({section:"ad-performance",title:"Ad Performance",description:"Pick a client to view their spend and lead performance."}):(zc(),`
    <div class="page-shell" data-section="ad-performance">
      <div class="page-header">
        ...
        <div class="chart-controls" id="adperf-periods">
          ${Gc.map(e=>`<button class="chart-period-btn${e.d===jt?" active":""}" type="button" data-days="${e.d}">${e.label}</button>`).join("")}
        </div>
      </div>

      <div class="stats-grid">
        ${kt("payments","Ad Spend","adperf-spend")}
        ${kt("ads_click","Clicks","adperf-clicks")}
        ${kt("person_add","Magnet Leads","adperf-leads")}
        ${kt("request_quote","Cost / Lead","adperf-cpl")}
      </div>
    ...
    </div>`)}async function cs(){if(ne()){const t=a=>Number(a||0).toLocaleString();return it(is(),[{h:"Spend",td:a=>a.ad?`$${t(a.ad.spend)}`:"—"},{h:"Clicks",td:a=>a.ad?t(a.ad.clicks):"—"},{h:"Leads",td:a=>t(a.leads.window??a.leads.total)},{h:"CPL",td:a=>a.ad?.cost_per_lead!=null?`$${t(a.ad.cost_per_lead)}`:"—"}],{emptyMsg:"No client orgs yet. Connect a client ad account to see spend here."})}const e=document.getElementById("adperf-periods");e?.addEventListener("click",t=>{const a=t.target.closest("button[data-days]");a&&(jt=Number(a.dataset.days)||30,e.querySelectorAll(".chart-period-btn").forEach(n=>n.classList.toggle("active",Number(n.dataset.days)===jt)),Bn())}),await Bn()}async function Bn(){const e=is(),t=document.getElementById("adperf-body"),a=document.getElementById("adperf-range"),n=new Date,o=Fn(n),s=Fn(new Date(n.getTime()-(jt-1)*864e5));a&&(a.textContent=`${s} → ${o}`);let r,i=[],l=null;try{const[g,b,y]=await Promise.all([fetch(`${e}/m5t/v5/coreAdMetrics/overlay?from=${s}&to=${o}`),fetch(`${e}/m5t/v5/coreAdAccount`),fetch(`${e}/m5t/v5/coreAdMetrics/by-source?from=${s}&to=${o}`)]);if(!g.ok)throw new Error(`HTTP ${g.status}`);r=await g.json(),i=((await b.json().catch(()=>({})))?.data||[]).filter(w=>w.status!=="DELETED"),l=await y.json().catch(()=>null)}catch(g){console.warn("[ad-performance] load failed:",g),t&&(t.innerHTML=at("error","Could not load ad performance. Please try again."));return}const c=r.totals||{};if(Tt("adperf-spend",Pn(c.spend)),Tt("adperf-clicks",et(c.clicks)),Tt("adperf-leads",et(c.magnet_leads)),Tt("adperf-cpl",Pn(c.cost_per_lead)),qc(l),!i.length){t.innerHTML=at("link_off","No ad account connected yet. Your agency can connect Google Ads or Local Services Ads to see performance here.");return}if(!r.connected){t.innerHTML=at("cloud_sync","Account connected. No ad data for this range yet. Metrics appear here once they sync.");return}t.innerHTML=Vc(r.rows||[])}function qc(e){const t=document.getElementById("adperf-sources"),a=document.getElementById("adperf-src-summary");if(!t)return;const n=e&&Array.isArray(e.rows)?e.rows:[];if(!n.length){a&&(a.textContent=""),t.innerHTML=at("search_off","No leads in this range yet. Campaigns appear here as tagged leads (?utm_campaign=…) come in.");return}const o=e.total_leads||n.reduce((i,l)=>i+(l.leads||0),0),s=e.tracked_leads||0;a&&(a.textContent=`${et(s)} of ${et(o)} leads tagged to a source`);const r=i=>i.campaign&&i.campaign!=="(none)"?At(i.campaign):i.source&&i.source!=="(direct)"?At(i.source):'<span class="adperf-src-untracked">Untracked / direct</span>';t.innerHTML=`
    <div class="adperf-srcwrap">
      <table class="adperf-srctable">
        ...
        <tbody>${n.map(i=>`
          <tr>
            <td>${r(i)}</td>
            <td class="adperf-src-sub">${At(i.source||"—")}${i.medium?` · ${At(i.medium)}`:""}</td>
            <td class="num">${i.paid_clicks?et(i.paid_clicks):'<span class="adperf-src-sub">—</span>'}</td>
            <td class="num"><b>${et(i.leads)}</b></td>
          </tr>`).join("")}
        </tbody>
      </table>
    </div>`}function Tt(e,t){const a=document.getElementById(e);a&&(a.textContent=t)}function Un(e){if(e<=0)return 1;const t=Math.pow(10,Math.floor(Math.log10(e))),a=e/t;return(a<=1?1:a<=2?2:a<=5?5:10)*t}function Hn(e){return e=Math.round(e),e>=1e3?(e/1e3).toFixed(e%1e3===0?0:1)+"k":String(e)}function Vc(e){const _=e.length||1,w=Un(Math.max(1,...e.map(O=>O.spend||0))),d=Un(Math.max(1,...e.map(O=>O.magnet_leads||0))),h=738/_,v=Math.min(24,h*.55),k=O=>56+h*(O+.5),N=O=>304-O/w*282,B=O=>304-O/d*282,ae=[0,.25,.5,.75,1].map(O=>{const I=304-O*282;return`<line x1="56" y1="${I.toFixed(1)}" x2="794" y2="${I.toFixed(1)}" stroke="#EAF0F7"/><text x="48" y="${(I+3.5).toFixed(1)}" text-anchor="end" class="ax">$${Hn(w*O)}</text><text x="802" y="${(I+3.5).toFixed(1)}" text-anchor="start" class="ax">${Hn(d*O)}</text>`}).join(""),Y=e.map((O,I)=>{const V=N(O.spend||0);return`<rect x="${(k(I)-v/2).toFixed(1)}" y="${V.toFixed(1)}" width="${v.toFixed(1)}" height="${Math.max(0,304-V).toFixed(1)}" rx="3" fill="#0072BA"><title>${O.date}: $${O.spend} spend</title></rect>`}).join(""),le=e.map((O,I)=>`${k(I).toFixed(1)},${B(O.magnet_leads||0).toFixed(1)}`).join(" "),we=_>1?`<polyline points="${le}" fill="none" stroke="#009473" stroke-width="2.5"/>`:"",ce=e.map((O,I)=>`<circle cx="${k(I).toFixed(1)}" cy="${B(O.magnet_leads||0).toFixed(1)}" r="3.5" fill="#009473"><title>${O.date}: ${O.magnet_leads} leads</title></circle>`).join(""),Re=Math.max(1,Math.ceil(_/6)),Ce=e.map((O,I)=>I%Re===0||I===_-1?`<text x="${k(I).toFixed(1)}" y="326" text-anchor="middle" class="ax">${O.date.slice(5)}</text>`:"").join("");return`
    ...
    <svg class="adperf-chart" viewBox="0 0 840 340" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Ad spend versus magnet leads over time">
      ${ae}${Y}${we}${ce}${Ce}
    </svg>`}const jc={render:ls,init:cs},Wc=Object.freeze(Object.defineProperty({__proto__:null,default:jc,init:cs,render:ls},Symbol.toStringTag,{value:"Module"})),zn="reseller_org",ds="managed_client";let Gn=!1;const Yc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},J=e=>String(e??"").replace(/[&<>"']/g,t=>Yc[t]);function Wt(e,t="info"){try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}}function Jc(){const e=x.getActiveOrg();if(e&&e.channel===zn)return{guid:e.guid,name:e.name};const t=x.getMemberships().find(a=>a.channel===zn);return t?{guid:t.orgGuid,name:t.name}:null}function Kc(e){const t=e?.created_tz;if(!t)return"";const a=new Date(t);return Number.isNaN(a.getTime())?"":a.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}function Xc(){if(Gn)return;const e=document.createElement("style");e.id="m5t-clients-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),Gn=!0}const Qc=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function Ot(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function Zc(e){const t=e.caption||e.guid,a=e.status||"ENABLED";return`
    <div class="client-row">
      <span class="client-row__avatar">${J(Qc(t))}</span>
      <span class="client-row__main">
        <div class="client-row__name" title="${J(t)}">${J(t)}</div>
        <div class="client-row__meta">Added ${J(Kc(e.created))||"—"}</div>
      </span>
      <span class="client-row__status" data-status="${J(a)}">${J(a)}</span>
      <div class="client-row__btns">
        <button class="client-card__invite" type="button" data-action="invite" data-client-guid="${J(e.guid)}" data-client-name="${J(t)}">
        ...
        <button class="client-card__invite" type="button" data-action="adaccounts" data-client-guid="${J(e.guid)}" data-client-name="${J(t)}">
          <span class="material-symbols-outlined" aria-hidden="true">ads_click</span> Ad accounts
        </button>`:""}
      </div>
    </div>`}function ps(){return Xc(),`
    <div class="page-shell" data-section="clients">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="clients-body">
          ${Ot("hourglass_empty","Loading clients…")}
        </div>
      </div>
    </div>`}async function us(){const e=Jc();document.getElementById("clients-add-btn")?.addEventListener("click",()=>ed(e)),await ms(e)}async function ms(e){const t=document.getElementById("clients-body"),a=document.getElementById("clients-count");if(t){if(!e?.guid){t.innerHTML=Ot("info","Client provisioning is available to reseller / agency accounts."),a&&(a.textContent="");return}try{const n=x.getConfig?.().BASE_URL||"",o=await fetch(`${n}/m5t/v5/acctGroup`);if(!o.ok)throw new Error(`HTTP ${o.status}`);const s=await o.json(),i=(Array.isArray(s?.data)?s.data:[]).filter(l=>l.class===ds&&(!l.parent||l.parent===e.guid));if(!i.length){t.innerHTML=Ot("group_off","No clients yet. Add your first client to start managing magnets on their behalf."),a&&(a.textContent="");return}t.innerHTML=`<div class="client-list">${i.map(Zc).join("")}</div>`,a&&(a.textContent=`${i.length} client${i.length===1?"":"s"}`),t.querySelectorAll(".client-card__invite").forEach(l=>{l.addEventListener("click",()=>{l.dataset.action==="adaccounts"?td(l.dataset.clientGuid,l.dataset.clientName):ad(l.dataset.clientGuid,l.dataset.clientName)})})}catch(n){console.warn("[clients] load failed:",n),t.innerHTML=Ot("error","Couldn’t load clients. Please try again."),a&&(a.textContent="")}}}function ed(e){if(!e?.guid){Wt("Only reseller / agency accounts can add clients.","error");return}const t=document.createElement("div");t.className="client-modal-scrim";const a=document.createElement("div");a.className="client-modal",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.innerHTML=`
    ...
    <div class="client-modal__body">
      <p class="client-modal__sub">Creates a managed client under <strong>${J(e.name||"your agency")}</strong>. You'll manage their magnets and leads on their behalf.</p>
    ...
    <div class="client-modal__body">
      ...
      <input class="client-modal__input" id="aa-gads" type="text" inputmode="numeric" placeholder="123-456-7890" autocomplete="off" value="${J(o?.external_customer_id||"")}" />
      ...
      <input class="client-modal__input" id="aa-lsa" type="text" inputmode="numeric" placeholder="Optional" autocomplete="off" value="${J(s?.external_customer_id||"")}" />
    ...
    </div>`,document.body.appendChild(r),document.body.appendChild(i),requestAnimationFrame(()=>{r.classList.add("open"),i.classList.add("open")});const l=i.querySelector("#aa-error"),c=i.querySelector('[data-act="save"]'),g=()=>{r.classList.remove("open"),i.classList.remove("open"),document.removeEventListener("keydown",b),setTimeout(()=>{r.remove(),i.remove()},200)},b=w=>{w.key==="Escape"&&g()};document.addEventListener("keydown",b),r.addEventListener("click",g),i.querySelector(".client-modal__close")?.addEventListener("click",g),i.querySelector('[data-act="cancel"]')?.addEventListener("click",g);const y=(w,d,h)=>{const v=`${a}/m5t/v5/coreAdAccount`;return d&&!h?fetch(v,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({owner_guid:e,provider:w,external_customer_id:d})}):d&&h&&d!==h.external_customer_id?fetch(`${v}/${encodeURIComponent(h.guid)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({external_customer_id:d})}):!d&&h?fetch(`${v}/${encodeURIComponent(h.guid)}`,{method:"DELETE"}):null},_=async()=>{l.textContent="";const w=qn(i.querySelector("#aa-gads").value),d=qn(i.querySelector("#aa-lsa").value),h=[y("google_ads",w,o),y("google_lsa",d,s)].filter(Boolean);if(!h.length){g();return}c.disabled=!0;const v=c.innerHTML;c.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Saving…';try{const k=await Promise.all(h);for(const N of k)if(!N.ok){const B=await N.json().catch(()=>({}));throw new Error(N.status===403?"You are not authorized to connect accounts for this client.":B?.error||B?.message||`Failed (HTTP ${N.status})`)}Wt("Ad accounts updated","success"),g()}catch(k){l.textContent=k.message||"Something went wrong. Please try again.",c.disabled=!1,c.innerHTML=v}};c?.addEventListener("click",_)}function ad(e,t){if(!e)return;const a=document.createElement("div");a.className="client-modal-scrim";const n=document.createElement("div");n.className="client-modal",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
    <div class="client-modal__head">
    ...
    <div class="client-modal__body" id="invite-body">
      ...
      <p class="client-modal__sub">Invite someone at <strong>${J(t||"this client")}</strong> to a read-only login for their account.</p>
      ...
      <div class="client-modal__actions">
        ...
        <div class="invite-pending">
          ...
          ${d.map(h=>`
            <div class="invite-pending__row">
              <span class="invite-pending__email${h.expired?" expired":""}" title="${J(h.email)}">${J(h.email)}${h.expired?" · expired":""}</span>
              <button class="client-modal__btn client-modal__btn--ghost invite-pending__copy" type="button" data-url="${J(h.inviteUrl)}">Copy link</button>
            </div>`).join("")}
        </div>`,b.querySelectorAll(".invite-pending__copy").forEach(c)}catch{b.innerHTML=""}})(),l?.addEventListener("click",async()=>{const g=(n.querySelector("#inv-email").value||"").trim(),b=(n.querySelector("#inv-first").value||"").trim(),y=(n.querySelector("#inv-last").value||"").trim();if(i.textContent="",!g||!b||!y){i.textContent="Email, first, and last name are required.";return}l.disabled=!0;const _=l.innerHTML;l.innerHTML='<span class="material-symbols-outlined" aria-hidden="true">progress_activity</span> Sending…';try{const w=x.getConfig?.().BASE_URL||"",d=await fetch(`${w}/m5t/v5/acctGroup/${encodeURIComponent(e)}/invite`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:g,first:b,last:y})}),h=await d.json().catch(()=>({}));if(!d.ok||!h.ok){const k=d.status===409?"A user with that email already exists.":d.status===403?"You are not authorized to invite for this client.":h.message||h.error||`Failed (HTTP ${d.status})`;throw new Error(k)}Wt(`Invite created for ${g}`,"success"),n.querySelector("#invite-body").innerHTML=`
        <div class="client-modal__result">
          ...
          <p>${h.emailQueued?`An invite email is on its way to <strong>${J(g)}</strong>.`:`Invite created for <strong>${J(g)}</strong>.`}</p>
          ...
          <div class="client-modal__linkrow">
            <input class="client-modal__input" id="inv-link" type="text" readonly value="${J(h.inviteUrl)}" />
        ...
        </div>`;const v=n.querySelector("#inv-link");n.querySelector("#inv-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(v.value),n.querySelector("#inv-copy").textContent="Copied!"}catch{v.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",o)}catch(w){console.warn("[clients] invite failed:",w),i.textContent=w.message||"Something went wrong. Please try again.",l.disabled=!1,l.innerHTML=_}})}const nd={render:ps,init:us},od=Object.freeze(Object.defineProperty({__proto__:null,default:nd,init:us,render:ps},Symbol.toStringTag,{value:"Module"})),Vn="managed_client";let jn=!1;const sd={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},de=e=>String(e??"").replace(/[&<>"']/g,t=>sd[t]),Wn=(e,t="info")=>{try{p.publish(u.UI_TOAST,{message:e,type:t})}catch{}},rd=e=>String(e||"?").trim().split(/\s+/).slice(0,2).map(t=>t[0]||"").join("").toUpperCase()||"?";function id(){const e=x.getActiveOrg();let t=e&&e.channel!==Vn?e:null;if(!t){const n=x.getMemberships().find(o=>o.channel!==Vn);n&&(t={guid:n.orgGuid,channel:n.channel,memberRole:n.memberRole})}if(!t)return null;const a=x.getMemberships().find(n=>n.orgGuid===t.guid)?.name;return{...t,name:a}}function ld(e){return Object.values(ht).filter(t=>lr(e,t.value)).sort((t,a)=>a.rank-t.rank)}function cd(){if(jn)return;const e=document.createElement("style");e.id="m5t-team-styles",e.textContent=`
  ...
  `,document.head.appendChild(e),jn=!0}function Yt(e,t){return`<div class="m5t-empty"><span class="material-symbols-outlined" aria-hidden="true">${e}</span><p>${t}</p></div>`}function dd(e){const t=e.member_role||"member";return`
    <div class="team-row">
      <span class="team-avatar">${de(rd(e.name||e.email))}</span>
    ...
    <div class="page-shell" data-section="team">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-body" id="team-body">
          ${Yt("hourglass_empty","Loading team…")}
        </div>
      </div>
    </div>`}async function hs(){const e=id(),t=document.getElementById("team-invite-btn");if(!e){t&&(t.style.display="none"),document.getElementById("team-body").innerHTML=Yt("info","Team management is available for agency and workspace accounts.");return}t?.addEventListener("click",()=>pd(e)),await Ua(e)}async function Ua(e){const t=document.getElementById("team-body"),a=document.getElementById("team-count");if(t)try{const n=x.getConfig?.().BASE_URL||"",[o,s]=await Promise.all([fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/members`),fetch(`${n}/m5t/v5/acctGroup/${encodeURIComponent(e.guid)}/invites`)]),[r,i]=await Promise.all([o.json().catch(()=>({})),s.json().catch(()=>({}))]);if(!o.ok||!s.ok)throw new Error(`Failed to load team (members: ${o.status}, invites: ${s.status})`);const l=r.members||[],c=i.invites||[],g=c.length?`
    ...
    <div class="team-modal__body" id="team-invite-body">
      ...
      <div class="team-modal__actions">
        ...
        </div>`;const h=n.querySelector("#tm-link");n.querySelector("#tm-copy")?.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(h.value),n.querySelector("#tm-copy").textContent="Copied!"}catch{h.select()}}),n.querySelector('[data-act="done"]')?.addEventListener("click",()=>{o(),Ua(e)})}catch(_){console.warn("[team] invite failed:",_),r.textContent=_.message||"Something went wrong. Please try again.",i.disabled=!1,i.innerHTML=y}})}const ud={render:gs,init:hs},md=Object.freeze(Object.defineProperty({__proto__:null,default:ud,init:hs,loadTeam:Ua,render:gs},Symbol.toStringTag,{value:"Module"}));
